...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://www.omdbapi.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://www.omdbapi.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("getOMDb_Search", defaultConf);
    _serverIndices.insert("getOMDb_Search", 0);
}
...
void OAIDefaultApi::getOMDb_Search(const QString &r, const ::OpenAPI::OptionalParam<QString> &t, const ::OpenAPI::OptionalParam<QString> &i, const ::OpenAPI::OptionalParam<QString> &s, const ::OpenAPI::OptionalParam<qint32> &y, const ::OpenAPI::OptionalParam<QString> &type, const ::OpenAPI::OptionalParam<QString> &plot, const ::OpenAPI::OptionalParam<bool> &tomatoes, const ::OpenAPI::OptionalParam<qint32> &v, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["getOMDb_Search"][_serverIndices.value("getOMDb_Search")].URL()+"/");
    ...
    if (t.hasValue())
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "t", false);
    ...
    if (i.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "i", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("i")).append(querySuffix).append(QUrl::toPercentEncoding(i.stringValue()));
    }
    if (s.hasValue())
    {
        queryStyle = "";
    ...
    if (plot.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "plot", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");
    ...
    if (tomatoes.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "tomatoes", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("tomatoes")).append(querySuffix).append(QUrl::toPercentEncoding(tomatoes.stringValue()));
    }
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("r")).append(querySuffix).append(QUrl::toPercentEncoding(r));
    }
    if (v.hasValue())
    {
        queryStyle = "";
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "v", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("v")).append(querySuffix).append(QUrl::toPercentEncoding(v.stringValue()));
    }
    if (page.hasValue())
    {
        queryStyle = "";
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getOMDb_SearchCallback);
...
void OAIDefaultApi::getOMDb_SearchCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICombinedResult output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getOMDb_SearchSignal(output);
        Q_EMIT getOMDb_SearchSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getOMDb_SearchSignalE(output, error_type, error_str);
        Q_EMIT getOMDb_SearchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getOMDb_SearchSignalError(output, error_type, error_str);
        Q_EMIT getOMDb_SearchSignalErrorFull(worker, error_type, error_str);
    }
}
