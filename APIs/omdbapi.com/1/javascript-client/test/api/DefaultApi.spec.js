...
(function(root, factory) {
  ...
  describe('DefaultApi', function() {
    describe('getOMDbSearch', function() {
      it('should call getOMDbSearch successfully', function(done) {
        //uncomment below and update the code to test getOMDbSearch
        //instance.getOMDbSearch(function(error) {
