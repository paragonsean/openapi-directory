...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.trapstreet.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("addressGet", defaultConf);
    _serverIndices.insert("addressGet", 0);
}
...
void OAIDefaultApi::addressGet(const QString &address) {
    QString fullPath = QString(_serverConfigs["addressGet"][_serverIndices.value("addressGet")].URL()+"/{address}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::addressGetCallback);
...
void OAIDefaultApi::addressGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI__address__get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT addressGetSignal(output);
        Q_EMIT addressGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT addressGetSignalE(output, error_type, error_str);
        Q_EMIT addressGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT addressGetSignalError(output, error_type, error_str);
        Q_EMIT addressGetSignalErrorFull(worker, error_type, error_str);
    }
}
