...
public class FindFormByFormName404ResponseErrorsInner {
  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  private String message;

  public FindFormByFormName404ResponseErrorsInner() {
  }

  public FindFormByFormName404ResponseErrorsInner message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    FindFormByFormName404ResponseErrorsInner findFormByFormName404ResponseErrorsInner = (FindFormByFormName404ResponseErrorsInner) o;
    return Objects.equals(this.message, findFormByFormName404ResponseErrorsInner.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class FindFormByFormName404ResponseErrorsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FindFormByFormName404ResponseErrorsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FindFormByFormName404ResponseErrorsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FindFormByFormName404ResponseErrorsInner is not found in the empty JSON string", FindFormByFormName404ResponseErrorsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FindFormByFormName404ResponseErrorsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FindFormByFormName404ResponseErrorsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FindFormByFormName404ResponseErrorsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FindFormByFormName404ResponseErrorsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FindFormByFormName404ResponseErrorsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FindFormByFormName404ResponseErrorsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<FindFormByFormName404ResponseErrorsInner>() {
           @Override
           public void write(JsonWriter out, FindFormByFormName404ResponseErrorsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FindFormByFormName404ResponseErrorsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FindFormByFormName404ResponseErrorsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FindFormByFormName404ResponseErrorsInner
   * @throws IOException if the JSON string is invalid with respect to FindFormByFormName404ResponseErrorsInner
   */
  public static FindFormByFormName404ResponseErrorsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FindFormByFormName404ResponseErrorsInner.class);
  }

  /**
   * Convert an instance of FindFormByFormName404ResponseErrorsInner to an JSON string
   *
   * @return JSON string
   */
