...
public class FormsIndex {
  ...
  private FormsIndexAttributes attributes;
  ...
  public FormsIndex attributes(FormsIndexAttributes attributes) {
  ...
  public FormsIndexAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(FormsIndexAttributes attributes) {
    this.attributes = attributes;
  }


  public FormsIndex id(String id) {
    this.id = id;
    return this;
  }
  ...
  public FormsIndex type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FormsIndex formsIndex = (FormsIndex) o;
    return Objects.equals(this.attributes, formsIndex.attributes) &&
        Objects.equals(this.id, formsIndex.id) &&
        Objects.equals(this.type, formsIndex.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FormsIndex
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FormsIndex.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsIndex is not found in the empty JSON string", FormsIndex.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FormsIndex.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FormsIndex` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        FormsIndexAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsIndex.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsIndex' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsIndex> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsIndex.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsIndex>() {
           @Override
           public void write(JsonWriter out, FormsIndex value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FormsIndex read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FormsIndex given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FormsIndex
   * @throws IOException if the JSON string is invalid with respect to FormsIndex
   */
  public static FormsIndex fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsIndex.class);
  }

  /**
   * Convert an instance of FormsIndex to an JSON string
   *
   * @return JSON string
   */
