...
import org.openapitools.client.model.FormsIndex;
...
public class FindForms200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<FormsIndex> data = new ArrayList<>();

  public FindForms200Response() {
  }

  public FindForms200Response data(List<FormsIndex> data) {
    this.data = data;
    return this;
  }

  public FindForms200Response addDataItem(FormsIndex dataItem) {
    if (this.data == null) {
  ...
  public List<FormsIndex> getData() {
    return data;
  }

  public void setData(List<FormsIndex> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    FindForms200Response findForms200Response = (FindForms200Response) o;
    return Objects.equals(this.data, findForms200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class FindForms200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FindForms200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FindForms200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FindForms200Response is not found in the empty JSON string", FindForms200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FindForms200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FindForms200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FindForms200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        FormsIndex.validateJsonElement(jsonArraydata.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FindForms200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FindForms200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FindForms200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FindForms200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<FindForms200Response>() {
           @Override
           public void write(JsonWriter out, FindForms200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FindForms200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FindForms200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FindForms200Response
   * @throws IOException if the JSON string is invalid with respect to FindForms200Response
   */
  public static FindForms200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FindForms200Response.class);
  }

  /**
   * Convert an instance of FindForms200Response to an JSON string
   *
   * @return JSON string
   */
