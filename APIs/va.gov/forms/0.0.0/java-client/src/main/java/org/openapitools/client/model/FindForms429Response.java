...
public class FindForms429Response {
  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  private String message;

  public FindForms429Response() {
  }

  public FindForms429Response message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    FindForms429Response findForms429Response = (FindForms429Response) o;
    return Objects.equals(this.message, findForms429Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class FindForms429Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FindForms429Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FindForms429Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FindForms429Response is not found in the empty JSON string", FindForms429Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FindForms429Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FindForms429Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FindForms429Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FindForms429Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FindForms429Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FindForms429Response.class));

       return (TypeAdapter<T>) new TypeAdapter<FindForms429Response>() {
           @Override
           public void write(JsonWriter out, FindForms429Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FindForms429Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FindForms429Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FindForms429Response
   * @throws IOException if the JSON string is invalid with respect to FindForms429Response
   */
  public static FindForms429Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FindForms429Response.class);
  }

  /**
   * Convert an instance of FindForms429Response to an JSON string
   *
   * @return JSON string
   */
