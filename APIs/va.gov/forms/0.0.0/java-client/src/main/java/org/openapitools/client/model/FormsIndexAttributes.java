...
public class FormsIndexAttributes {
  ...
  public static final String SERIALIZED_NAME_LAST_SHA256_CHANGE = "last_sha256_change";
  @SerializedName(SERIALIZED_NAME_LAST_SHA256_CHANGE)
  private LocalDate lastSha256Change;
  ...
  public FormsIndexAttributes benefitCategories(List<FormShowAttributesBenefitCategoriesInner> benefitCategories) {
    this.benefitCategories = benefitCategories;
    return this;
  }

  public FormsIndexAttributes addBenefitCategoriesItem(FormShowAttributesBenefitCategoriesInner benefitCategoriesItem) {
  ...
  public FormsIndexAttributes deletedAt(OffsetDateTime deletedAt) {
  ...
  public FormsIndexAttributes firstIssuedOn(LocalDate firstIssuedOn) {
  ...
  public FormsIndexAttributes formDetailsUrl(String formDetailsUrl) {
  ...
  public FormsIndexAttributes formName(String formName) {
  ...
  public FormsIndexAttributes formToolIntro(String formToolIntro) {
  ...
  public FormsIndexAttributes formToolUrl(String formToolUrl) {
  ...
  public FormsIndexAttributes formType(String formType) {
  ...
  public FormsIndexAttributes formUsage(String formUsage) {
  ...
  public FormsIndexAttributes language(String language) {
  ...
  public FormsIndexAttributes lastRevisionOn(LocalDate lastRevisionOn) {
  ...
  public FormsIndexAttributes lastSha256Change(LocalDate lastSha256Change) {
   ...
   * @return lastSha256Change
   */
  @javax.annotation.Nullable
  public LocalDate getLastSha256Change() {
    return lastSha256Change;
  }

  public void setLastSha256Change(LocalDate lastSha256Change) {
    this.lastSha256Change = lastSha256Change;
  }


  public FormsIndexAttributes pages(Integer pages) {
    this.pages = pages;
    return this;
  }
  ...
  public FormsIndexAttributes relatedForms(List<String> relatedForms) {
    this.relatedForms = relatedForms;
    return this;
  }

  public FormsIndexAttributes addRelatedFormsItem(String relatedFormsItem) {
  ...
  public FormsIndexAttributes sha256(String sha256) {
    this.sha256 = sha256;
    return this;
  }
  ...
  public FormsIndexAttributes title(String title) {
    this.title = title;
    return this;
  }
  ...
  public FormsIndexAttributes url(String url) {
    this.url = url;
    return this;
  }
  ...
  public FormsIndexAttributes vaFormAdministration(String vaFormAdministration) {
  ...
  public FormsIndexAttributes validPdf(Boolean validPdf) {
  ...
  public boolean equals(Object o) {
    ...
    FormsIndexAttributes formsIndexAttributes = (FormsIndexAttributes) o;
    return Objects.equals(this.benefitCategories, formsIndexAttributes.benefitCategories) &&
        Objects.equals(this.deletedAt, formsIndexAttributes.deletedAt) &&
        Objects.equals(this.firstIssuedOn, formsIndexAttributes.firstIssuedOn) &&
        Objects.equals(this.formDetailsUrl, formsIndexAttributes.formDetailsUrl) &&
        Objects.equals(this.formName, formsIndexAttributes.formName) &&
        Objects.equals(this.formToolIntro, formsIndexAttributes.formToolIntro) &&
        Objects.equals(this.formToolUrl, formsIndexAttributes.formToolUrl) &&
        Objects.equals(this.formType, formsIndexAttributes.formType) &&
        Objects.equals(this.formUsage, formsIndexAttributes.formUsage) &&
        Objects.equals(this.language, formsIndexAttributes.language) &&
        Objects.equals(this.lastRevisionOn, formsIndexAttributes.lastRevisionOn) &&
        Objects.equals(this.lastSha256Change, formsIndexAttributes.lastSha256Change) &&
        Objects.equals(this.pages, formsIndexAttributes.pages) &&
        Objects.equals(this.relatedForms, formsIndexAttributes.relatedForms) &&
        Objects.equals(this.sha256, formsIndexAttributes.sha256) &&
        Objects.equals(this.title, formsIndexAttributes.title) &&
        Objects.equals(this.url, formsIndexAttributes.url) &&
        Objects.equals(this.vaFormAdministration, formsIndexAttributes.vaFormAdministration) &&
        Objects.equals(this.validPdf, formsIndexAttributes.validPdf);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(benefitCategories, deletedAt, firstIssuedOn, formDetailsUrl, formName, formToolIntro, formToolUrl, formType, formUsage, language, lastRevisionOn, lastSha256Change, pages, relatedForms, sha256, title, url, vaFormAdministration, validPdf);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsIndexAttributes {\n");
    ...
    sb.append("    lastSha256Change: ").append(toIndentedString(lastSha256Change)).append("\n");
  ...
  static {
    ...
    openapiFields.add("last_sha256_change");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FormsIndexAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FormsIndexAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FormsIndexAttributes is not found in the empty JSON string", FormsIndexAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FormsIndexAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FormsIndexAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FormsIndexAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FormsIndexAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FormsIndexAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FormsIndexAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<FormsIndexAttributes>() {
           @Override
           public void write(JsonWriter out, FormsIndexAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FormsIndexAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FormsIndexAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FormsIndexAttributes
   * @throws IOException if the JSON string is invalid with respect to FormsIndexAttributes
   */
  public static FormsIndexAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FormsIndexAttributes.class);
  }

  /**
   * Convert an instance of FormsIndexAttributes to an JSON string
   *
   * @return JSON string
   */
