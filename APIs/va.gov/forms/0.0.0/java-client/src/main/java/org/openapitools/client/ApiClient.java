...
public class ApiClient {
    ...
    private String basePath = "https://sandbox-api.va.gov/services/va_forms/v0";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sandbox-api.va.gov/services/va_forms/v0
