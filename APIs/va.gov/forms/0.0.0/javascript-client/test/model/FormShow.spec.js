...
(function(root, factory) {
  ...
  describe('FormShow', function() {
    it('should create an instance of FormShow', function() {
      // uncomment below and update the code to test FormShow
      //var instance = new VaForms.FormShow();
      //expect(instance).to.be.a(VaForms.FormShow);
    });
