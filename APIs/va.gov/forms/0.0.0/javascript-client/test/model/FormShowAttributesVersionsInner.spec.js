...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaForms.FormShowAttributesVersionsInner();
  });
  ...
  describe('FormShowAttributesVersionsInner', function() {
    it('should create an instance of FormShowAttributesVersionsInner', function() {
      // uncomment below and update the code to test FormShowAttributesVersionsInner
      //var instance = new VaForms.FormShowAttributesVersionsInner();
      //expect(instance).to.be.a(VaForms.FormShowAttributesVersionsInner);
    });

    it('should have the property revisionOn (base name: "revision_on")', function() {
      // uncomment below and update the code to test the property revisionOn
      //var instance = new VaForms.FormShowAttributesVersionsInner();
