...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaForms.FormShowAttributes();
  });
  ...
  describe('FormShowAttributes', function() {
    it('should create an instance of FormShowAttributes', function() {
      // uncomment below and update the code to test FormShowAttributes
      //var instance = new VaForms.FormShowAttributes();
      //expect(instance).to.be.a(VaForms.FormShowAttributes);
    });
