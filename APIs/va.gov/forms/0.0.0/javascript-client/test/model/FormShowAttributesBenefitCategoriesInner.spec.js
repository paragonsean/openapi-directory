...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaForms.FormShowAttributesBenefitCategoriesInner();
  });
  ...
  describe('FormShowAttributesBenefitCategoriesInner', function() {
    it('should create an instance of FormShowAttributesBenefitCategoriesInner', function() {
      // uncomment below and update the code to test FormShowAttributesBenefitCategoriesInner
      //var instance = new VaForms.FormShowAttributesBenefitCategoriesInner();
      //expect(instance).to.be.a(VaForms.FormShowAttributesBenefitCategoriesInner);
    });
