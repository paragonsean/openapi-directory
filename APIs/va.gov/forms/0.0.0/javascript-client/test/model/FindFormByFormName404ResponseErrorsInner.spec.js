...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaForms.FindFormByFormName404ResponseErrorsInner();
  });
  ...
  describe('FindFormByFormName404ResponseErrorsInner', function() {
    it('should create an instance of FindFormByFormName404ResponseErrorsInner', function() {
      // uncomment below and update the code to test FindFormByFormName404ResponseErrorsInner
      //var instance = new VaForms.FindFormByFormName404ResponseErrorsInner();
      //expect(instance).to.be.a(VaForms.FindFormByFormName404ResponseErrorsInner);
    });
