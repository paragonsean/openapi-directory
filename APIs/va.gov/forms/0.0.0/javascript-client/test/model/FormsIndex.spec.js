...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaForms.FormsIndex();
  });
  ...
  describe('FormsIndex', function() {
    it('should create an instance of FormsIndex', function() {
      // uncomment below and update the code to test FormsIndex
      //var instance = new VaForms.FormsIndex();
      //expect(instance).to.be.a(VaForms.FormsIndex);
    });
