...
(function(root, factory) {
  ...
  describe('FormsApi', function() {
    describe('findFormByFormName', function() {
      it('should call findFormByFormName successfully', function(done) {
        //uncomment below and update the code to test findFormByFormName
        //instance.findFormByFormName(function(error) {
    ...
    describe('findForms', function() {
      it('should call findForms successfully', function(done) {
        //uncomment below and update the code to test findForms
        //instance.findForms(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
