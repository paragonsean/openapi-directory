...
/**
 * The FormShowAttributesBenefitCategoriesInner model module.
 * @module model/FormShowAttributesBenefitCategoriesInner
 * @version 0.0.0
 */
class FormShowAttributesBenefitCategoriesInner {
    /**
     * Constructs a new <code>FormShowAttributesBenefitCategoriesInner</code>.
     * @alias module:model/FormShowAttributesBenefitCategoriesInner
     */
    constructor() { 
        
        FormShowAttributesBenefitCategoriesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FormShowAttributesBenefitCategoriesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormShowAttributesBenefitCategoriesInner} obj Optional instance to populate.
     * @return {module:model/FormShowAttributesBenefitCategoriesInner} The populated <code>FormShowAttributesBenefitCategoriesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormShowAttributesBenefitCategoriesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>FormShowAttributesBenefitCategoriesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormShowAttributesBenefitCategoriesInner</code>.
     */
 ...
 */
FormShowAttributesBenefitCategoriesInner.prototype['description'] = undefined;

/**
 * Name of the benefit category of the form
 * @member {String} name
 */
FormShowAttributesBenefitCategoriesInner.prototype['name'] = undefined;
...
export default FormShowAttributesBenefitCategoriesInner;
