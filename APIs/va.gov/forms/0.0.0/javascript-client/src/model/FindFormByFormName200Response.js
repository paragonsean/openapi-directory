...
/**
 * The FindFormByFormName200Response model module.
 * @module model/FindFormByFormName200Response
 * @version 0.0.0
 */
class FindFormByFormName200Response {
    /**
     * Constructs a new <code>FindFormByFormName200Response</code>.
     * @alias module:model/FindFormByFormName200Response
     * @param data {module:model/FormShow} 
     */
    constructor(data) { 
        
        FindFormByFormName200Response.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>FindFormByFormName200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FindFormByFormName200Response} obj Optional instance to populate.
     * @return {module:model/FindFormByFormName200Response} The populated <code>FindFormByFormName200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FindFormByFormName200Response();

            if (data.hasOwnProperty('data')) {
                obj['data'] = FormShow.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FindFormByFormName200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FindFormByFormName200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FindFormByFormName200Response.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          FormShow.validateJSON(data['data']);
        }
...
FindFormByFormName200Response.RequiredProperties = ["data"];

/**
 * @member {module:model/FormShow} data
 */
FindFormByFormName200Response.prototype['data'] = undefined;
...
export default FindFormByFormName200Response;
