...
/**
 * The FindForms429Response model module.
 * @module model/FindForms429Response
 * @version 0.0.0
 */
class FindForms429Response {
    /**
     * Constructs a new <code>FindForms429Response</code>.
     * @alias module:model/FindForms429Response
     */
    constructor() { 
        
        FindForms429Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FindForms429Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FindForms429Response} obj Optional instance to populate.
     * @return {module:model/FindForms429Response} The populated <code>FindForms429Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FindForms429Response();
    ...
    /**
     * Validates the JSON data with respect to <code>FindForms429Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FindForms429Response</code>.
     */
 ...
 */
FindForms429Response.prototype['message'] = undefined;
...
export default FindForms429Response;
