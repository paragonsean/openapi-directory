...
import FormShowAttributes from './FormShowAttributes';

/**
 * The FormShow model module.
 * @module model/FormShow
 * @version 0.0.0
 */
class FormShow {
    /**
     * Constructs a new <code>FormShow</code>.
     * Data for a particular VA form, including form version history.
     * @alias module:model/FormShow
     */
    constructor() { 
        
        FormShow.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FormShow</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormShow} obj Optional instance to populate.
     * @return {module:model/FormShow} The populated <code>FormShow</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormShow();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = FormShowAttributes.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FormShow</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormShow</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          FormShowAttributes.validateJSON(data['attributes']);
        }
...
/**
 * @member {module:model/FormShowAttributes} attributes
 */
FormShow.prototype['attributes'] = undefined;

/**
 * JSON API identifier
 * @member {String} id
 */
FormShow.prototype['id'] = undefined;

/**
 * JSON API type specification
 * @member {String} type
 */
FormShow.prototype['type'] = undefined;
