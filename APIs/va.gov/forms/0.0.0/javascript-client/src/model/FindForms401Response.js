...
/**
 * The FindForms401Response model module.
 * @module model/FindForms401Response
 * @version 0.0.0
 */
class FindForms401Response {
    /**
     * Constructs a new <code>FindForms401Response</code>.
     * @alias module:model/FindForms401Response
     */
    constructor() { 
        
        FindForms401Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FindForms401Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FindForms401Response} obj Optional instance to populate.
     * @return {module:model/FindForms401Response} The populated <code>FindForms401Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FindForms401Response();
    ...
    /**
     * Validates the JSON data with respect to <code>FindForms401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FindForms401Response</code>.
     */
 ...
 */
FindForms401Response.prototype['message'] = undefined;
...
export default FindForms401Response;
