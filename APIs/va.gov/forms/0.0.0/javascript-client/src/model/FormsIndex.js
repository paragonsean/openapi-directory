...
import FormsIndexAttributes from './FormsIndexAttributes';

/**
 * The FormsIndex model module.
 * @module model/FormsIndex
 * @version 0.0.0
 */
class FormsIndex {
    /**
     * Constructs a new <code>FormsIndex</code>.
     * A listing of available VA forms and their location.
     * @alias module:model/FormsIndex
     */
    constructor() { 
        
        FormsIndex.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FormsIndex</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormsIndex} obj Optional instance to populate.
     * @return {module:model/FormsIndex} The populated <code>FormsIndex</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormsIndex();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = FormsIndexAttributes.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FormsIndex</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormsIndex</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          FormsIndexAttributes.validateJSON(data['attributes']);
        }
...
/**
 * @member {module:model/FormsIndexAttributes} attributes
 */
FormsIndex.prototype['attributes'] = undefined;

/**
 * JSON API identifier
 * @member {String} id
 */
FormsIndex.prototype['id'] = undefined;

/**
 * JSON API type specification
 * @member {String} type
 */
FormsIndex.prototype['type'] = undefined;
