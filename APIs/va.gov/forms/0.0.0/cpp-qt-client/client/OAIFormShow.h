...
#ifndef OAIFormShow_H
#define OAIFormShow_H
...
namespace OpenAPI {
class OAIFormShow_attributes;

class OAIFormShow : public OAIObject {
public:
    OAIFormShow();
    OAIFormShow(QString json);
    ~OAIFormShow() override;
    ...
    OAIFormShow_attributes getAttributes() const;
    void setAttributes(const OAIFormShow_attributes &attributes);
...
private:
    ...
    OAIFormShow_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormShow)
