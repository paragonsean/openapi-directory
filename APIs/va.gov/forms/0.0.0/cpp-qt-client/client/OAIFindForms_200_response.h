...
/*
 * OAIFindForms_200_response.h
 *
 * 
 */

#ifndef OAIFindForms_200_response_H
#define OAIFindForms_200_response_H
...
class OAIFindForms_200_response : public OAIObject {
public:
    OAIFindForms_200_response();
    OAIFindForms_200_response(QString json);
    ~OAIFindForms_200_response() override;
    ...
    QList<OAIFormsIndex> getData() const;
    void setData(const QList<OAIFormsIndex> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFindForms_200_response)

#endif // OAIFindForms_200_response_H
