...
#ifndef OAIFormsIndex_H
#define OAIFormsIndex_H
...
namespace OpenAPI {
class OAIFormsIndex_attributes;

class OAIFormsIndex : public OAIObject {
public:
    OAIFormsIndex();
    OAIFormsIndex(QString json);
    ~OAIFormsIndex() override;
    ...
    OAIFormsIndex_attributes getAttributes() const;
    void setAttributes(const OAIFormsIndex_attributes &attributes);
...
private:
    ...
    OAIFormsIndex_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormsIndex)

#endif // OAIFormsIndex_H
