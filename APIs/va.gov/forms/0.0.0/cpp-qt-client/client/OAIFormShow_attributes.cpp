...
#include "OAIFormShow_attributes.h"
...
OAIFormShow_attributes::OAIFormShow_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormShow_attributes::OAIFormShow_attributes() {
    this->initializeModel();
}

OAIFormShow_attributes::~OAIFormShow_attributes() {}

void OAIFormShow_attributes::initializeModel() {
...
void OAIFormShow_attributes::fromJson(QString jsonString) {
...
void OAIFormShow_attributes::fromJsonObject(QJsonObject json) {
...
QString OAIFormShow_attributes::asJson() const {
...
QJsonObject OAIFormShow_attributes::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIFormShow_attributes_benefit_categories_inner> OAIFormShow_attributes::getBenefitCategories() const {
    return m_benefit_categories;
}
void OAIFormShow_attributes::setBenefitCategories(const QList<OAIFormShow_attributes_benefit_categories_inner> &benefit_categories) {
    m_benefit_categories = benefit_categories;
    m_benefit_categories_isSet = true;
}

bool OAIFormShow_attributes::is_benefit_categories_Set() const{
    return m_benefit_categories_isSet;
}

bool OAIFormShow_attributes::is_benefit_categories_Valid() const{
    return m_benefit_categories_isValid;
}

QDateTime OAIFormShow_attributes::getCreatedAt() const {
    return m_created_at;
}
void OAIFormShow_attributes::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIFormShow_attributes::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIFormShow_attributes::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIFormShow_attributes::getDeletedAt() const {
    return m_deleted_at;
}
void OAIFormShow_attributes::setDeletedAt(const QDateTime &deleted_at) {
    m_deleted_at = deleted_at;
    m_deleted_at_isSet = true;
}

bool OAIFormShow_attributes::is_deleted_at_Set() const{
    return m_deleted_at_isSet;
}

bool OAIFormShow_attributes::is_deleted_at_Valid() const{
    return m_deleted_at_isValid;
}

QDate OAIFormShow_attributes::getFirstIssuedOn() const {
    return m_first_issued_on;
}
void OAIFormShow_attributes::setFirstIssuedOn(const QDate &first_issued_on) {
    m_first_issued_on = first_issued_on;
    m_first_issued_on_isSet = true;
}

bool OAIFormShow_attributes::is_first_issued_on_Set() const{
    return m_first_issued_on_isSet;
}

bool OAIFormShow_attributes::is_first_issued_on_Valid() const{
    return m_first_issued_on_isValid;
}

QString OAIFormShow_attributes::getFormDetailsUrl() const {
    return m_form_details_url;
}
void OAIFormShow_attributes::setFormDetailsUrl(const QString &form_details_url) {
    m_form_details_url = form_details_url;
    m_form_details_url_isSet = true;
}

bool OAIFormShow_attributes::is_form_details_url_Set() const{
    return m_form_details_url_isSet;
}

bool OAIFormShow_attributes::is_form_details_url_Valid() const{
    return m_form_details_url_isValid;
}

QString OAIFormShow_attributes::getFormName() const {
    return m_form_name;
}
void OAIFormShow_attributes::setFormName(const QString &form_name) {
    m_form_name = form_name;
    m_form_name_isSet = true;
}

bool OAIFormShow_attributes::is_form_name_Set() const{
    return m_form_name_isSet;
}

bool OAIFormShow_attributes::is_form_name_Valid() const{
    return m_form_name_isValid;
}

QString OAIFormShow_attributes::getFormToolIntro() const {
    return m_form_tool_intro;
}
void OAIFormShow_attributes::setFormToolIntro(const QString &form_tool_intro) {
    m_form_tool_intro = form_tool_intro;
    m_form_tool_intro_isSet = true;
}

bool OAIFormShow_attributes::is_form_tool_intro_Set() const{
    return m_form_tool_intro_isSet;
}

bool OAIFormShow_attributes::is_form_tool_intro_Valid() const{
    return m_form_tool_intro_isValid;
}

QString OAIFormShow_attributes::getFormToolUrl() const {
    return m_form_tool_url;
}
void OAIFormShow_attributes::setFormToolUrl(const QString &form_tool_url) {
    m_form_tool_url = form_tool_url;
    m_form_tool_url_isSet = true;
}

bool OAIFormShow_attributes::is_form_tool_url_Set() const{
    return m_form_tool_url_isSet;
}

bool OAIFormShow_attributes::is_form_tool_url_Valid() const{
    return m_form_tool_url_isValid;
}

QString OAIFormShow_attributes::getFormType() const {
    return m_form_type;
}
void OAIFormShow_attributes::setFormType(const QString &form_type) {
    m_form_type = form_type;
    m_form_type_isSet = true;
}

bool OAIFormShow_attributes::is_form_type_Set() const{
    return m_form_type_isSet;
}

bool OAIFormShow_attributes::is_form_type_Valid() const{
    return m_form_type_isValid;
}

QString OAIFormShow_attributes::getFormUsage() const {
    return m_form_usage;
}
void OAIFormShow_attributes::setFormUsage(const QString &form_usage) {
    m_form_usage = form_usage;
    m_form_usage_isSet = true;
}

bool OAIFormShow_attributes::is_form_usage_Set() const{
    return m_form_usage_isSet;
}

bool OAIFormShow_attributes::is_form_usage_Valid() const{
    return m_form_usage_isValid;
}

QString OAIFormShow_attributes::getLanguage() const {
    return m_language;
}
void OAIFormShow_attributes::setLanguage(const QString &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIFormShow_attributes::is_language_Set() const{
    return m_language_isSet;
}

bool OAIFormShow_attributes::is_language_Valid() const{
    return m_language_isValid;
}

QDate OAIFormShow_attributes::getLastRevisionOn() const {
    return m_last_revision_on;
}
void OAIFormShow_attributes::setLastRevisionOn(const QDate &last_revision_on) {
    m_last_revision_on = last_revision_on;
    m_last_revision_on_isSet = true;
}

bool OAIFormShow_attributes::is_last_revision_on_Set() const{
    return m_last_revision_on_isSet;
}

bool OAIFormShow_attributes::is_last_revision_on_Valid() const{
    return m_last_revision_on_isValid;
}

qint32 OAIFormShow_attributes::getPages() const {
    return m_pages;
}
void OAIFormShow_attributes::setPages(const qint32 &pages) {
    m_pages = pages;
    m_pages_isSet = true;
}

bool OAIFormShow_attributes::is_pages_Set() const{
    return m_pages_isSet;
}

bool OAIFormShow_attributes::is_pages_Valid() const{
    return m_pages_isValid;
}

QList<QString> OAIFormShow_attributes::getRelatedForms() const {
    return m_related_forms;
}
void OAIFormShow_attributes::setRelatedForms(const QList<QString> &related_forms) {
    m_related_forms = related_forms;
    m_related_forms_isSet = true;
}

bool OAIFormShow_attributes::is_related_forms_Set() const{
    return m_related_forms_isSet;
}

bool OAIFormShow_attributes::is_related_forms_Valid() const{
    return m_related_forms_isValid;
}

QString OAIFormShow_attributes::getSha256() const {
    return m_sha256;
}
void OAIFormShow_attributes::setSha256(const QString &sha256) {
    m_sha256 = sha256;
    m_sha256_isSet = true;
}

bool OAIFormShow_attributes::is_sha256_Set() const{
    return m_sha256_isSet;
}

bool OAIFormShow_attributes::is_sha256_Valid() const{
    return m_sha256_isValid;
}

QString OAIFormShow_attributes::getTitle() const {
    return m_title;
}
void OAIFormShow_attributes::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIFormShow_attributes::is_title_Set() const{
    return m_title_isSet;
}

bool OAIFormShow_attributes::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIFormShow_attributes::getUrl() const {
    return m_url;
}
void OAIFormShow_attributes::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIFormShow_attributes::is_url_Set() const{
    return m_url_isSet;
}

bool OAIFormShow_attributes::is_url_Valid() const{
    return m_url_isValid;
}

QString OAIFormShow_attributes::getVaFormAdministration() const {
    return m_va_form_administration;
}
void OAIFormShow_attributes::setVaFormAdministration(const QString &va_form_administration) {
    m_va_form_administration = va_form_administration;
    m_va_form_administration_isSet = true;
}

bool OAIFormShow_attributes::is_va_form_administration_Set() const{
    return m_va_form_administration_isSet;
}

bool OAIFormShow_attributes::is_va_form_administration_Valid() const{
    return m_va_form_administration_isValid;
}

bool OAIFormShow_attributes::isValidPdf() const {
    return m_valid_pdf;
}
void OAIFormShow_attributes::setValidPdf(const bool &valid_pdf) {
    m_valid_pdf = valid_pdf;
    m_valid_pdf_isSet = true;
}

bool OAIFormShow_attributes::is_valid_pdf_Set() const{
    return m_valid_pdf_isSet;
}

bool OAIFormShow_attributes::is_valid_pdf_Valid() const{
    return m_valid_pdf_isValid;
}

QList<OAIFormShow_attributes_versions_inner> OAIFormShow_attributes::getVersions() const {
    return m_versions;
}
void OAIFormShow_attributes::setVersions(const QList<OAIFormShow_attributes_versions_inner> &versions) {
    m_versions = versions;
    m_versions_isSet = true;
}

bool OAIFormShow_attributes::is_versions_Set() const{
    return m_versions_isSet;
}

bool OAIFormShow_attributes::is_versions_Valid() const{
    return m_versions_isValid;
}

bool OAIFormShow_attributes::isSet() const {
...
bool OAIFormShow_attributes::isValid() const {
