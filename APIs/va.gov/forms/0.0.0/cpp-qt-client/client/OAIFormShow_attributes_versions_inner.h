...
/*
 * OAIFormShow_attributes_versions_inner.h
 *
 * 
 */

#ifndef OAIFormShow_attributes_versions_inner_H
#define OAIFormShow_attributes_versions_inner_H
...
class OAIFormShow_attributes_versions_inner : public OAIObject {
public:
    OAIFormShow_attributes_versions_inner();
    OAIFormShow_attributes_versions_inner(QString json);
    ~OAIFormShow_attributes_versions_inner() override;
    ...
    QDate getRevisionOn() const;
    void setRevisionOn(const QDate &revision_on);
    bool is_revision_on_Set() const;
    bool is_revision_on_Valid() const;
...
private:
    ...
    QDate m_revision_on;
    bool m_revision_on_isSet;
    bool m_revision_on_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormShow_attributes_versions_inner)

#endif // OAIFormShow_attributes_versions_inner_H
