...
/*
 * OAIFindFormByFormName_404_response.h
 *
 * 
 */

#ifndef OAIFindFormByFormName_404_response_H
#define OAIFindFormByFormName_404_response_H

#include <QJsonObject>

#include "OAIFindFormByFormName_404_response_errors_inner.h"
#include <QList>
...
namespace OpenAPI {
class OAIFindFormByFormName_404_response_errors_inner;

class OAIFindFormByFormName_404_response : public OAIObject {
public:
    OAIFindFormByFormName_404_response();
    OAIFindFormByFormName_404_response(QString json);
    ~OAIFindFormByFormName_404_response() override;
    ...
    QList<OAIFindFormByFormName_404_response_errors_inner> getErrors() const;
    void setErrors(const QList<OAIFindFormByFormName_404_response_errors_inner> &errors);
...
private:
    ...
    QList<OAIFindFormByFormName_404_response_errors_inner> m_errors;
    bool m_errors_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFindFormByFormName_404_response)

#endif // OAIFindFormByFormName_404_response_H
