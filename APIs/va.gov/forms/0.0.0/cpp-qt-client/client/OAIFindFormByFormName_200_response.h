...
/*
 * OAIFindFormByFormName_200_response.h
 *
 * 
 */

#ifndef OAIFindFormByFormName_200_response_H
#define OAIFindFormByFormName_200_response_H
...
class OAIFindFormByFormName_200_response : public OAIObject {
public:
    OAIFindFormByFormName_200_response();
    OAIFindFormByFormName_200_response(QString json);
    ~OAIFindFormByFormName_200_response() override;
    ...
    OAIFormShow getData() const;
    void setData(const OAIFormShow &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFindFormByFormName_200_response)

#endif // OAIFindFormByFormName_200_response_H
