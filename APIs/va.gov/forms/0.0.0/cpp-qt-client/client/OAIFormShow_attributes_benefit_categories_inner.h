...
/*
 * OAIFormShow_attributes_benefit_categories_inner.h
 *
 * 
 */

#ifndef OAIFormShow_attributes_benefit_categories_inner_H
#define OAIFormShow_attributes_benefit_categories_inner_H
...
class OAIFormShow_attributes_benefit_categories_inner : public OAIObject {
public:
    OAIFormShow_attributes_benefit_categories_inner();
    OAIFormShow_attributes_benefit_categories_inner(QString json);
    ~OAIFormShow_attributes_benefit_categories_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormShow_attributes_benefit_categories_inner)

#endif // OAIFormShow_attributes_benefit_categories_inner_H
