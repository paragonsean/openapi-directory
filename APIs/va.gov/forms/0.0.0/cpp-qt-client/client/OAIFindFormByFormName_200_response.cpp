...
OAIFindFormByFormName_200_response::OAIFindFormByFormName_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFindFormByFormName_200_response::OAIFindFormByFormName_200_response() {
    this->initializeModel();
}

OAIFindFormByFormName_200_response::~OAIFindFormByFormName_200_response() {}

void OAIFindFormByFormName_200_response::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIFindFormByFormName_200_response::fromJson(QString jsonString) {
...
void OAIFindFormByFormName_200_response::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIFindFormByFormName_200_response::asJson() const {
...
QJsonObject OAIFindFormByFormName_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIFormShow OAIFindFormByFormName_200_response::getData() const {
    return m_data;
}
void OAIFindFormByFormName_200_response::setData(const OAIFormShow &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIFindFormByFormName_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIFindFormByFormName_200_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIFindFormByFormName_200_response::isSet() const {
...
bool OAIFindFormByFormName_200_response::isValid() const {
