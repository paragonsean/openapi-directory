...
OAIFindForms_401_response::OAIFindForms_401_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFindForms_401_response::OAIFindForms_401_response() {
    this->initializeModel();
}

OAIFindForms_401_response::~OAIFindForms_401_response() {}

void OAIFindForms_401_response::initializeModel() {

    m_message_isSet = false;
    m_message_isValid = false;
}

void OAIFindForms_401_response::fromJson(QString jsonString) {
...
void OAIFindForms_401_response::fromJsonObject(QJsonObject json) {

    m_message_isValid = ::OpenAPI::fromJsonValue(m_message, json[QString("message")]);
    m_message_isSet = !json[QString("message")].isNull() && m_message_isValid;
}

QString OAIFindForms_401_response::asJson() const {
...
QJsonObject OAIFindForms_401_response::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIFindForms_401_response::getMessage() const {
    return m_message;
}
void OAIFindForms_401_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIFindForms_401_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAIFindForms_401_response::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIFindForms_401_response::isSet() const {
...
bool OAIFindForms_401_response::isValid() const {
