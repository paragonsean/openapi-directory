...
OAIFormsIndex::OAIFormsIndex(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormsIndex::OAIFormsIndex() {
    this->initializeModel();
}

OAIFormsIndex::~OAIFormsIndex() {}

void OAIFormsIndex::initializeModel() {
...
void OAIFormsIndex::fromJson(QString jsonString) {
...
void OAIFormsIndex::fromJsonObject(QJsonObject json) {
...
QString OAIFormsIndex::asJson() const {
...
QJsonObject OAIFormsIndex::asJsonObject() const {
    QJsonObject obj;
...
OAIFormsIndex_attributes OAIFormsIndex::getAttributes() const {
    return m_attributes;
}
void OAIFormsIndex::setAttributes(const OAIFormsIndex_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIFormsIndex::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIFormsIndex::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIFormsIndex::getId() const {
    return m_id;
}
void OAIFormsIndex::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFormsIndex::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFormsIndex::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIFormsIndex::getType() const {
    return m_type;
}
void OAIFormsIndex::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFormsIndex::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFormsIndex::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIFormsIndex::isSet() const {
...
bool OAIFormsIndex::isValid() const {
