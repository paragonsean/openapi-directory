...
OAIFindFormByFormName_404_response_errors_inner::OAIFindFormByFormName_404_response_errors_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFindFormByFormName_404_response_errors_inner::OAIFindFormByFormName_404_response_errors_inner() {
    this->initializeModel();
}

OAIFindFormByFormName_404_response_errors_inner::~OAIFindFormByFormName_404_response_errors_inner() {}

void OAIFindFormByFormName_404_response_errors_inner::initializeModel() {

    m_message_isSet = false;
    m_message_isValid = false;
}

void OAIFindFormByFormName_404_response_errors_inner::fromJson(QString jsonString) {
...
void OAIFindFormByFormName_404_response_errors_inner::fromJsonObject(QJsonObject json) {

    m_message_isValid = ::OpenAPI::fromJsonValue(m_message, json[QString("message")]);
    m_message_isSet = !json[QString("message")].isNull() && m_message_isValid;
}

QString OAIFindFormByFormName_404_response_errors_inner::asJson() const {
...
QJsonObject OAIFindFormByFormName_404_response_errors_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIFindFormByFormName_404_response_errors_inner::getMessage() const {
    return m_message;
}
void OAIFindFormByFormName_404_response_errors_inner::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIFindFormByFormName_404_response_errors_inner::is_message_Set() const{
    return m_message_isSet;
}

bool OAIFindFormByFormName_404_response_errors_inner::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIFindFormByFormName_404_response_errors_inner::isSet() const {
...
bool OAIFindFormByFormName_404_response_errors_inner::isValid() const {
