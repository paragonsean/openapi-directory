...
/*
 * OAIFormShow_attributes.h
 *
 * 
 */

#ifndef OAIFormShow_attributes_H
#define OAIFormShow_attributes_H
...
class OAIFormShow_attributes_versions_inner;

class OAIFormShow_attributes : public OAIObject {
public:
    OAIFormShow_attributes();
    OAIFormShow_attributes(QString json);
    ~OAIFormShow_attributes() override;
    ...
    QList<OAIFormShow_attributes_versions_inner> getVersions() const;
    void setVersions(const QList<OAIFormShow_attributes_versions_inner> &versions);
...
private:
    ...
    QList<OAIFormShow_attributes_versions_inner> m_versions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormShow_attributes)

#endif // OAIFormShow_attributes_H
