...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.VBADocumentsApi();
  });
  ...
  describe('VBADocumentsApi', function() {
    describe('getBenefitsDocumentUploadDownload', function() {
      it('should call getBenefitsDocumentUploadDownload successfully', function(done) {
        //uncomment below and update the code to test getBenefitsDocumentUploadDownload
        //instance.getBenefitsDocumentUploadDownload(function(error) {
    ...
    describe('getBenefitsDocumentUploadStatus', function() {
      it('should call getBenefitsDocumentUploadStatus successfully', function(done) {
        //uncomment below and update the code to test getBenefitsDocumentUploadStatus
        //instance.getBenefitsDocumentUploadStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getBenefitsDocumentUploadStatusReport', function() {
      it('should call getBenefitsDocumentUploadStatusReport successfully', function(done) {
        //uncomment below and update the code to test getBenefitsDocumentUploadStatusReport
        //instance.getBenefitsDocumentUploadStatusReport(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postBenefitsDocumentUpload', function() {
      it('should call postBenefitsDocumentUpload successfully', function(done) {
        //uncomment below and update the code to test postBenefitsDocumentUpload
        //instance.postBenefitsDocumentUpload(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postBenefitsDocumentUploadValidateDocument', function() {
      it('should call postBenefitsDocumentUploadValidateDocument successfully', function(done) {
        //uncomment below and update the code to test postBenefitsDocumentUploadValidateDocument
        //instance.postBenefitsDocumentUploadValidateDocument(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('putBenefitsDocumentUpload', function() {
      it('should call putBenefitsDocumentUpload successfully', function(done) {
        //uncomment below and update the code to test putBenefitsDocumentUpload
        //instance.putBenefitsDocumentUpload(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
