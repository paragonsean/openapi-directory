...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PutBenefitsDocumentUpload500Response();
  });
  ...
  describe('PutBenefitsDocumentUpload500Response', function() {
    it('should create an instance of PutBenefitsDocumentUpload500Response', function() {
      // uncomment below and update the code to test PutBenefitsDocumentUpload500Response
      //var instance = new BenefitsIntake.PutBenefitsDocumentUpload500Response();
      //expect(instance).to.be.a(BenefitsIntake.PutBenefitsDocumentUpload500Response);
    });
