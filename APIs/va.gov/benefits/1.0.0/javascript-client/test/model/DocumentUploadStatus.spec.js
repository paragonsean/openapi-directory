...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.DocumentUploadStatus();
  });
  ...
  describe('DocumentUploadStatus', function() {
    it('should create an instance of DocumentUploadStatus', function() {
      // uncomment below and update the code to test DocumentUploadStatus
      //var instance = new BenefitsIntake.DocumentUploadStatus();
      //expect(instance).to.be.a(BenefitsIntake.DocumentUploadStatus);
    });
