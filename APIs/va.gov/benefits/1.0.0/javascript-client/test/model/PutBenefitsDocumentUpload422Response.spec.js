...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PutBenefitsDocumentUpload422Response();
  });
  ...
  describe('PutBenefitsDocumentUpload422Response', function() {
    it('should create an instance of PutBenefitsDocumentUpload422Response', function() {
      // uncomment below and update the code to test PutBenefitsDocumentUpload422Response
      //var instance = new BenefitsIntake.PutBenefitsDocumentUpload422Response();
      //expect(instance).to.be.a(BenefitsIntake.PutBenefitsDocumentUpload422Response);
    });
