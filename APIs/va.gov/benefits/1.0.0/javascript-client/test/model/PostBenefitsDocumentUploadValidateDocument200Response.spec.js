...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200Response();
  });
  ...
  describe('PostBenefitsDocumentUploadValidateDocument200Response', function() {
    it('should create an instance of PostBenefitsDocumentUploadValidateDocument200Response', function() {
      // uncomment below and update the code to test PostBenefitsDocumentUploadValidateDocument200Response
      //var instance = new BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200Response();
      //expect(instance).to.be.a(BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200Response);
    });
