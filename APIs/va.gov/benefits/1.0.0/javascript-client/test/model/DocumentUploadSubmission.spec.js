...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.DocumentUploadSubmission();
  });
  ...
  describe('DocumentUploadSubmission', function() {
    it('should create an instance of DocumentUploadSubmission', function() {
      // uncomment below and update the code to test DocumentUploadSubmission
      //var instance = new BenefitsIntake.DocumentUploadSubmission();
      //expect(instance).to.be.a(BenefitsIntake.DocumentUploadSubmission);
    });
