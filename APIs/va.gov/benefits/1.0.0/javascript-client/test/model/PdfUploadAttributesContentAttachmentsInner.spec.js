...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PdfUploadAttributesContentAttachmentsInner();
  });
  ...
  describe('PdfUploadAttributesContentAttachmentsInner', function() {
    it('should create an instance of PdfUploadAttributesContentAttachmentsInner', function() {
      // uncomment below and update the code to test PdfUploadAttributesContentAttachmentsInner
      //var instance = new BenefitsIntake.PdfUploadAttributesContentAttachmentsInner();
      //expect(instance).to.be.a(BenefitsIntake.PdfUploadAttributesContentAttachmentsInner);
    });
