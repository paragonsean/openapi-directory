...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.DocumentUploadStatusAttributes();
  });
  ...
  describe('DocumentUploadStatusAttributes', function() {
    it('should create an instance of DocumentUploadStatusAttributes', function() {
      // uncomment below and update the code to test DocumentUploadStatusAttributes
      //var instance = new BenefitsIntake.DocumentUploadStatusAttributes();
      //expect(instance).to.be.a(BenefitsIntake.DocumentUploadStatusAttributes);
    });
    ...
    it('should have the property uploadedPdf (base name: "uploaded_pdf")', function() {
      // uncomment below and update the code to test the property uploadedPdf
      //var instance = new BenefitsIntake.DocumentUploadStatusAttributes();
      //expect(instance).to.be();
    });
