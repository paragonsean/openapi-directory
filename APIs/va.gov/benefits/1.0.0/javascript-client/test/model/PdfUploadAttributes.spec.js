...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PdfUploadAttributes();
  });
  ...
  describe('PdfUploadAttributes', function() {
    it('should create an instance of PdfUploadAttributes', function() {
      // uncomment below and update the code to test PdfUploadAttributes
      //var instance = new BenefitsIntake.PdfUploadAttributes();
      //expect(instance).to.be.a(BenefitsIntake.PdfUploadAttributes);
    });
    ...
    it('should have the property totalDocuments (base name: "total_documents")', function() {
      // uncomment below and update the code to test the property totalDocuments
      //var instance = new BenefitsIntake.PdfUploadAttributes();
      //expect(instance).to.be();
    });
