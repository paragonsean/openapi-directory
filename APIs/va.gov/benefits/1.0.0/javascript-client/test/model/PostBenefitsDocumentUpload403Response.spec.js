...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PostBenefitsDocumentUpload403Response();
  });
  ...
  describe('PostBenefitsDocumentUpload403Response', function() {
    it('should create an instance of PostBenefitsDocumentUpload403Response', function() {
      // uncomment below and update the code to test PostBenefitsDocumentUpload403Response
      //var instance = new BenefitsIntake.PostBenefitsDocumentUpload403Response();
      //expect(instance).to.be.a(BenefitsIntake.PostBenefitsDocumentUpload403Response);
    });
