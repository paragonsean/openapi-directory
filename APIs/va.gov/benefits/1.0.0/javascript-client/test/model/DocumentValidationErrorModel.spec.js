...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.DocumentValidationErrorModel();
  });
  ...
  describe('DocumentValidationErrorModel', function() {
    it('should create an instance of DocumentValidationErrorModel', function() {
      // uncomment below and update the code to test DocumentValidationErrorModel
      //var instance = new BenefitsIntake.DocumentValidationErrorModel();
      //expect(instance).to.be.a(BenefitsIntake.DocumentValidationErrorModel);
    });
