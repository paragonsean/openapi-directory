...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.GetBenefitsDocumentUploadStatus404Response();
  });
  ...
  describe('GetBenefitsDocumentUploadStatus404Response', function() {
    it('should create an instance of GetBenefitsDocumentUploadStatus404Response', function() {
      // uncomment below and update the code to test GetBenefitsDocumentUploadStatus404Response
      //var instance = new BenefitsIntake.GetBenefitsDocumentUploadStatus404Response();
      //expect(instance).to.be.a(BenefitsIntake.GetBenefitsDocumentUploadStatus404Response);
    });
