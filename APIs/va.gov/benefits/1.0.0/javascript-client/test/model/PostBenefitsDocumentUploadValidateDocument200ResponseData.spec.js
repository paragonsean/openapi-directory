...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200ResponseData();
  });
  ...
  describe('PostBenefitsDocumentUploadValidateDocument200ResponseData', function() {
    it('should create an instance of PostBenefitsDocumentUploadValidateDocument200ResponseData', function() {
      // uncomment below and update the code to test PostBenefitsDocumentUploadValidateDocument200ResponseData
      //var instance = new BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200ResponseData();
      //expect(instance).to.be.a(BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200ResponseData);
    });
