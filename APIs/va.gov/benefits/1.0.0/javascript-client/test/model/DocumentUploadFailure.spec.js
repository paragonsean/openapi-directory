...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.DocumentUploadFailure();
  });
  ...
  describe('DocumentUploadFailure', function() {
    it('should create an instance of DocumentUploadFailure', function() {
      // uncomment below and update the code to test DocumentUploadFailure
      //var instance = new BenefitsIntake.DocumentUploadFailure();
      //expect(instance).to.be.a(BenefitsIntake.DocumentUploadFailure);
    });
