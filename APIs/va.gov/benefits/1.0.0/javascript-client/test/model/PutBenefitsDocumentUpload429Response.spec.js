...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PutBenefitsDocumentUpload429Response();
  });
  ...
  describe('PutBenefitsDocumentUpload429Response', function() {
    it('should create an instance of PutBenefitsDocumentUpload429Response', function() {
      // uncomment below and update the code to test PutBenefitsDocumentUpload429Response
      //var instance = new BenefitsIntake.PutBenefitsDocumentUpload429Response();
      //expect(instance).to.be.a(BenefitsIntake.PutBenefitsDocumentUpload429Response);
    });
