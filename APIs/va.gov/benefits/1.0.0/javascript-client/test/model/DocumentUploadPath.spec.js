...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.DocumentUploadPath();
  });
  ...
  describe('DocumentUploadPath', function() {
    it('should create an instance of DocumentUploadPath', function() {
      // uncomment below and update the code to test DocumentUploadPath
      //var instance = new BenefitsIntake.DocumentUploadPath();
      //expect(instance).to.be.a(BenefitsIntake.DocumentUploadPath);
    });
