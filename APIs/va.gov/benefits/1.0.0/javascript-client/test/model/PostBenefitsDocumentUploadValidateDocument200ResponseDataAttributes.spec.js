...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.BenefitsIntake);
  }
}(this, function(expect, BenefitsIntake) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes();
  });
  ...
  describe('PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes', function() {
    it('should create an instance of PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes', function() {
      // uncomment below and update the code to test PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes
      //var instance = new BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes();
      //expect(instance).to.be.a(BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes);
    });
