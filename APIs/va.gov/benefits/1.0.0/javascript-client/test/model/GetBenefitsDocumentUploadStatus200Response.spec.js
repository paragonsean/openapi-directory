...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.GetBenefitsDocumentUploadStatus200Response();
  });
  ...
  describe('GetBenefitsDocumentUploadStatus200Response', function() {
    it('should create an instance of GetBenefitsDocumentUploadStatus200Response', function() {
      // uncomment below and update the code to test GetBenefitsDocumentUploadStatus200Response
      //var instance = new BenefitsIntake.GetBenefitsDocumentUploadStatus200Response();
      //expect(instance).to.be.a(BenefitsIntake.GetBenefitsDocumentUploadStatus200Response);
    });
