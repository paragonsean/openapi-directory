...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PostBenefitsDocumentUploadValidateDocument422Response();
  });
  ...
  describe('PostBenefitsDocumentUploadValidateDocument422Response', function() {
    it('should create an instance of PostBenefitsDocumentUploadValidateDocument422Response', function() {
      // uncomment below and update the code to test PostBenefitsDocumentUploadValidateDocument422Response
      //var instance = new BenefitsIntake.PostBenefitsDocumentUploadValidateDocument422Response();
      //expect(instance).to.be.a(BenefitsIntake.PostBenefitsDocumentUploadValidateDocument422Response);
    });
