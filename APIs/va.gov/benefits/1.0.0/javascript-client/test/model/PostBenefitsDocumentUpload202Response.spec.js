...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PostBenefitsDocumentUpload202Response();
  });
  ...
  describe('PostBenefitsDocumentUpload202Response', function() {
    it('should create an instance of PostBenefitsDocumentUpload202Response', function() {
      // uncomment below and update the code to test PostBenefitsDocumentUpload202Response
      //var instance = new BenefitsIntake.PostBenefitsDocumentUpload202Response();
      //expect(instance).to.be.a(BenefitsIntake.PostBenefitsDocumentUpload202Response);
    });
