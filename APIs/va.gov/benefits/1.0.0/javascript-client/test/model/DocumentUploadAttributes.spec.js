...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.DocumentUploadAttributes();
  });
  ...
  describe('DocumentUploadAttributes', function() {
    it('should create an instance of DocumentUploadAttributes', function() {
      // uncomment below and update the code to test DocumentUploadAttributes
      //var instance = new BenefitsIntake.DocumentUploadAttributes();
      //expect(instance).to.be.a(BenefitsIntake.DocumentUploadAttributes);
    });
