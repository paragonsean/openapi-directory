...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.DocumentUploadStatusGuidList();
  });
  ...
  describe('DocumentUploadStatusGuidList', function() {
    it('should create an instance of DocumentUploadStatusGuidList', function() {
      // uncomment below and update the code to test DocumentUploadStatusGuidList
      //var instance = new BenefitsIntake.DocumentUploadStatusGuidList();
      //expect(instance).to.be.a(BenefitsIntake.DocumentUploadStatusGuidList);
    });
