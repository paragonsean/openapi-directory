...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.DocumentUploadSubmissionAttributes();
  });
  ...
  describe('DocumentUploadSubmissionAttributes', function() {
    it('should create an instance of DocumentUploadSubmissionAttributes', function() {
      // uncomment below and update the code to test DocumentUploadSubmissionAttributes
      //var instance = new BenefitsIntake.DocumentUploadSubmissionAttributes();
      //expect(instance).to.be.a(BenefitsIntake.DocumentUploadSubmissionAttributes);
    });
