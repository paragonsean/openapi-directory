...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.GetBenefitsDocumentUploadStatusReport200Response();
  });
  ...
  describe('GetBenefitsDocumentUploadStatusReport200Response', function() {
    it('should create an instance of GetBenefitsDocumentUploadStatusReport200Response', function() {
      // uncomment below and update the code to test GetBenefitsDocumentUploadStatusReport200Response
      //var instance = new BenefitsIntake.GetBenefitsDocumentUploadStatusReport200Response();
      //expect(instance).to.be.a(BenefitsIntake.GetBenefitsDocumentUploadStatusReport200Response);
    });
