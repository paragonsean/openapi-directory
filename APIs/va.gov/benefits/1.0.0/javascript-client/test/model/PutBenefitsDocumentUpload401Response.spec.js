...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PutBenefitsDocumentUpload401Response();
  });
  ...
  describe('PutBenefitsDocumentUpload401Response', function() {
    it('should create an instance of PutBenefitsDocumentUpload401Response', function() {
      // uncomment below and update the code to test PutBenefitsDocumentUpload401Response
      //var instance = new BenefitsIntake.PutBenefitsDocumentUpload401Response();
      //expect(instance).to.be.a(BenefitsIntake.PutBenefitsDocumentUpload401Response);
    });
