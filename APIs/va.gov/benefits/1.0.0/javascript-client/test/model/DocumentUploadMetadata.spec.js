...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.DocumentUploadMetadata();
  });
  ...
  describe('DocumentUploadMetadata', function() {
    it('should create an instance of DocumentUploadMetadata', function() {
      ...
      //var instance = new BenefitsIntake.DocumentUploadMetadata();
      //expect(instance).to.be.a(BenefitsIntake.DocumentUploadMetadata);
    });
    ...
    it('should have the property veteranFirstName (base name: "veteranFirstName")', function() {
      // uncomment below and update the code to test the property veteranFirstName
      //var instance = new BenefitsIntake.DocumentUploadMetadata();
      //expect(instance).to.be();
    });

    it('should have the property veteranLastName (base name: "veteranLastName")', function() {
      // uncomment below and update the code to test the property veteranLastName
      //var instance = new BenefitsIntake.DocumentUploadMetadata();
      //expect(instance).to.be();
    });
