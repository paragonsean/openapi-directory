...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PdfUploadAttributesContent();
  });
  ...
  describe('PdfUploadAttributesContent', function() {
    it('should create an instance of PdfUploadAttributesContent', function() {
      // uncomment below and update the code to test PdfUploadAttributesContent
      //var instance = new BenefitsIntake.PdfUploadAttributesContent();
      //expect(instance).to.be.a(BenefitsIntake.PdfUploadAttributesContent);
    });
