...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BenefitsIntake.PdfDimensionAttributes();
  });
  ...
  describe('PdfDimensionAttributes', function() {
    it('should create an instance of PdfDimensionAttributes', function() {
      // uncomment below and update the code to test PdfDimensionAttributes
      //var instance = new BenefitsIntake.PdfDimensionAttributes();
      //expect(instance).to.be.a(BenefitsIntake.PdfDimensionAttributes);
    });
    ...
    it('should have the property oversizedPdf (base name: "oversized_pdf")', function() {
      // uncomment below and update the code to test the property oversizedPdf
      //var instance = new BenefitsIntake.PdfDimensionAttributes();
      //expect(instance).to.be();
    });
