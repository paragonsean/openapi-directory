# BenefitsIntake.DocumentUploadAttributes
...
**guid** | **String** | The document upload identifier | 
**location** | **String** | Location to which to PUT document Payload | [optional] 
**status** | **String** | Document upload status.  | 
**updatedAt** | **Date** | The last time the submission was updated | [optional] 
