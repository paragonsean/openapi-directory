...
BenefitsIntake - JavaScript client for benefits_intake
...
```shell
npm install benefits_intake --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your benefits_intake from, and run:
...
```javascript
var BenefitsIntake = require('benefits_intake');

var defaultClient = BenefitsIntake.ApiClient.instance;
...
var api = new BenefitsIntake.VBADocumentsApi()
var id = "6d8433c1-cd55-4c24-affd-f592287a7572"; // {String} ID as returned by a previous create upload request
...
api.getBenefitsDocumentUploadDownload(id, callback);
...
------------ | ------------- | ------------- | -------------
*BenefitsIntake.VBADocumentsApi* | [**getBenefitsDocumentUploadDownload**](docs/VBADocumentsApi.md#getBenefitsDocumentUploadDownload) | **GET** /uploads/{id}/download | Download zip of \&quot;what the server sees\&quot;
*BenefitsIntake.VBADocumentsApi* | [**getBenefitsDocumentUploadStatus**](docs/VBADocumentsApi.md#getBenefitsDocumentUploadStatus) | **GET** /uploads/{id} | Get status for a previous benefits document upload
*BenefitsIntake.VBADocumentsApi* | [**getBenefitsDocumentUploadStatusReport**](docs/VBADocumentsApi.md#getBenefitsDocumentUploadStatusReport) | **POST** /uploads/report | Get a bulk status report for a list of previous uploads
*BenefitsIntake.VBADocumentsApi* | [**postBenefitsDocumentUpload**](docs/VBADocumentsApi.md#postBenefitsDocumentUpload) | **POST** /uploads | Get a location for subsequent document upload PUT request
*BenefitsIntake.VBADocumentsApi* | [**postBenefitsDocumentUploadValidateDocument**](docs/VBADocumentsApi.md#postBenefitsDocumentUploadValidateDocument) | **POST** /uploads/validate_document | Validate an individual document against system file requirements
*BenefitsIntake.VBADocumentsApi* | [**putBenefitsDocumentUpload**](docs/VBADocumentsApi.md#putBenefitsDocumentUpload) | **PUT** /path | Accepts document upload.


## Documentation for Models

 - [BenefitsIntake.DocumentUploadAttributes](docs/DocumentUploadAttributes.md)
 - [BenefitsIntake.DocumentUploadFailure](docs/DocumentUploadFailure.md)
 - [BenefitsIntake.DocumentUploadMetadata](docs/DocumentUploadMetadata.md)
 - [BenefitsIntake.DocumentUploadPath](docs/DocumentUploadPath.md)
 - [BenefitsIntake.DocumentUploadStatus](docs/DocumentUploadStatus.md)
 - [BenefitsIntake.DocumentUploadStatusAttributes](docs/DocumentUploadStatusAttributes.md)
 - [BenefitsIntake.DocumentUploadStatusGuidList](docs/DocumentUploadStatusGuidList.md)
 - [BenefitsIntake.DocumentUploadSubmission](docs/DocumentUploadSubmission.md)
 - [BenefitsIntake.DocumentUploadSubmissionAttributes](docs/DocumentUploadSubmissionAttributes.md)
 - [BenefitsIntake.DocumentValidationErrorModel](docs/DocumentValidationErrorModel.md)
 - [BenefitsIntake.ErrorModel](docs/ErrorModel.md)
 - [BenefitsIntake.GetBenefitsDocumentUploadStatus200Response](docs/GetBenefitsDocumentUploadStatus200Response.md)
 - [BenefitsIntake.GetBenefitsDocumentUploadStatus404Response](docs/GetBenefitsDocumentUploadStatus404Response.md)
 - [BenefitsIntake.GetBenefitsDocumentUploadStatusReport200Response](docs/GetBenefitsDocumentUploadStatusReport200Response.md)
 - [BenefitsIntake.PdfDimensionAttributes](docs/PdfDimensionAttributes.md)
 - [BenefitsIntake.PdfUploadAttributes](docs/PdfUploadAttributes.md)
 - [BenefitsIntake.PdfUploadAttributesContent](docs/PdfUploadAttributesContent.md)
 - [BenefitsIntake.PdfUploadAttributesContentAttachmentsInner](docs/PdfUploadAttributesContentAttachmentsInner.md)
 - [BenefitsIntake.PostBenefitsDocumentUpload202Response](docs/PostBenefitsDocumentUpload202Response.md)
 - [BenefitsIntake.PostBenefitsDocumentUpload403Response](docs/PostBenefitsDocumentUpload403Response.md)
 - [BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200Response](docs/PostBenefitsDocumentUploadValidateDocument200Response.md)
 - [BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200ResponseData](docs/PostBenefitsDocumentUploadValidateDocument200ResponseData.md)
 - [BenefitsIntake.PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes](docs/PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.md)
 - [BenefitsIntake.PostBenefitsDocumentUploadValidateDocument422Response](docs/PostBenefitsDocumentUploadValidateDocument422Response.md)
 - [BenefitsIntake.PutBenefitsDocumentUpload401Response](docs/PutBenefitsDocumentUpload401Response.md)
 - [BenefitsIntake.PutBenefitsDocumentUpload422Response](docs/PutBenefitsDocumentUpload422Response.md)
 - [BenefitsIntake.PutBenefitsDocumentUpload429Response](docs/PutBenefitsDocumentUpload429Response.md)
 - [BenefitsIntake.PutBenefitsDocumentUpload500Response](docs/PutBenefitsDocumentUpload500Response.md)
