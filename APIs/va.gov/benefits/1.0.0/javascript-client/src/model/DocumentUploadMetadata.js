...
class DocumentUploadMetadata {
     ...
     * @param fileNumber {String} The Veteran's file number is exactly 9 digits with no alpha characters, hyphens, spaces or punctuation. In most cases, this is the Veteran's SSN but may also be an 8 digit BIRL number. If no file number has been established or if it is unknown, the application should use the Veteran's SSN and the file number will be associated with the submission later in the process. Incorrect file numbers can cause delays.
     * @param source {String} System, installation, or entity submitting the document
     * @param veteranFirstName {String} Veteran first name. Cannot be missing or empty or longer than 50 characters. Only upper/lower case letters, hyphens(-), spaces and forward-slash(/) allowed.
     * @param veteranLastName {String} Veteran last name. Cannot be missing or empty or longer than 50 characters. Only upper/lower case letters, hyphens(-), spaces and forward-slash(/) allowed.
     * @param zipCode {String} Veteran zip code. Either five digits (XXXXX) or five digits then four digits separated by a hyphen (XXXXX-XXXX). Use '00000' for Veterans with non-US addresses.
     */
    constructor(fileNumber, source, veteranFirstName, veteranLastName, zipCode) { 
        
        DocumentUploadMetadata.initialize(this, fileNumber, source, veteranFirstName, veteranLastName, zipCode);
    }
     ...
     */
    static initialize(obj, fileNumber, source, veteranFirstName, veteranLastName, zipCode) { 
        obj['fileNumber'] = fileNumber;
        obj['source'] = source;
        obj['veteranFirstName'] = veteranFirstName;
        obj['veteranLastName'] = veteranLastName;
        obj['zipCode'] = zipCode;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('businessLine')) {
                obj['businessLine'] = ApiClient.convertToType(data['businessLine'], 'String');
            }
            if (data.hasOwnProperty('docType')) {
                obj['docType'] = ApiClient.convertToType(data['docType'], 'String');
            }
            if (data.hasOwnProperty('fileNumber')) {
                obj['fileNumber'] = ApiClient.convertToType(data['fileNumber'], 'String');
            }
            if (data.hasOwnProperty('source')) {
                obj['source'] = ApiClient.convertToType(data['source'], 'String');
            }
            if (data.hasOwnProperty('veteranFirstName')) {
                obj['veteranFirstName'] = ApiClient.convertToType(data['veteranFirstName'], 'String');
            }
            if (data.hasOwnProperty('veteranLastName')) {
                obj['veteranLastName'] = ApiClient.convertToType(data['veteranLastName'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentUploadMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentUploadMetadata</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentUploadMetadata.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['businessLine'] && !(typeof data['businessLine'] === 'string' || data['businessLine'] instanceof String)) {
            throw new Error("Expected the field `businessLine` to be a primitive type in the JSON string but got " + data['businessLine']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['fileNumber'] && !(typeof data['fileNumber'] === 'string' || data['fileNumber'] instanceof String)) {
            throw new Error("Expected the field `fileNumber` to be a primitive type in the JSON string but got " + data['fileNumber']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['veteranFirstName'] && !(typeof data['veteranFirstName'] === 'string' || data['veteranFirstName'] instanceof String)) {
            throw new Error("Expected the field `veteranFirstName` to be a primitive type in the JSON string but got " + data['veteranFirstName']);
        }
        // ensure the json data is a string
        if (data['veteranLastName'] && !(typeof data['veteranLastName'] === 'string' || data['veteranLastName'] instanceof String)) {
            throw new Error("Expected the field `veteranLastName` to be a primitive type in the JSON string but got " + data['veteranLastName']);
        }
        // ensure the json data is a string
...
DocumentUploadMetadata.RequiredProperties = ["fileNumber", "source", "veteranFirstName", "veteranLastName", "zipCode"];
 ...
 * @member {module:model/DocumentUploadMetadata.BusinessLineEnum} businessLine
 */
DocumentUploadMetadata.prototype['businessLine'] = undefined;

/**
 * VBA form number of the document
 * @member {String} docType
 */
DocumentUploadMetadata.prototype['docType'] = undefined;

/**
 * The Veteran's file number is exactly 9 digits with no alpha characters, hyphens, spaces or punctuation. In most cases, this is the Veteran's SSN but may also be an 8 digit BIRL number. If no file number has been established or if it is unknown, the application should use the Veteran's SSN and the file number will be associated with the submission later in the process. Incorrect file numbers can cause delays.
 * @member {String} fileNumber
 */
DocumentUploadMetadata.prototype['fileNumber'] = undefined;

/**
 * System, installation, or entity submitting the document
 * @member {String} source
 */
DocumentUploadMetadata.prototype['source'] = undefined;
 ...
 * @member {String} veteranFirstName
 */
DocumentUploadMetadata.prototype['veteranFirstName'] = undefined;
 ...
 * @member {String} veteranLastName
 */
DocumentUploadMetadata.prototype['veteranLastName'] = undefined;
 ...
 */
DocumentUploadMetadata.prototype['zipCode'] = undefined;
...
/**
 * Allowed values for the <code>businessLine</code> property.
 * @enum {String}
 * @readonly
 */
DocumentUploadMetadata['BusinessLineEnum'] = {
