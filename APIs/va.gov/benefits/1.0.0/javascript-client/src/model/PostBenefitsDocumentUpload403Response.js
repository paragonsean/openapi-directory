...
/**
 * The PostBenefitsDocumentUpload403Response model module.
 * @module model/PostBenefitsDocumentUpload403Response
 * @version 1.0.0
 */
class PostBenefitsDocumentUpload403Response {
    /**
     * Constructs a new <code>PostBenefitsDocumentUpload403Response</code>.
     * @alias module:model/PostBenefitsDocumentUpload403Response
     */
    constructor() { 
        
        PostBenefitsDocumentUpload403Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostBenefitsDocumentUpload403Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostBenefitsDocumentUpload403Response} obj Optional instance to populate.
     * @return {module:model/PostBenefitsDocumentUpload403Response} The populated <code>PostBenefitsDocumentUpload403Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostBenefitsDocumentUpload403Response();
    ...
    /**
     * Validates the JSON data with respect to <code>PostBenefitsDocumentUpload403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostBenefitsDocumentUpload403Response</code>.
     */
 ...
 */
PostBenefitsDocumentUpload403Response.prototype['Message'] = undefined;
...
export default PostBenefitsDocumentUpload403Response;
