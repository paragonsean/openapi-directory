...
/**
 * The DocumentUploadStatus model module.
 * @module model/DocumentUploadStatus
 * @version 1.0.0
 */
class DocumentUploadStatus {
    /**
     * Constructs a new <code>DocumentUploadStatus</code>.
     * Status record for a previously initiated document submission.
     * @alias module:model/DocumentUploadStatus
     * @param attributes {module:model/DocumentUploadStatusAttributes} 
     * @param id {String} JSON API identifier
     * @param type {String} JSON API type specification
     */
    constructor(attributes, id, type) { 
        
        DocumentUploadStatus.initialize(this, attributes, id, type);
    }
    ...
    /**
     * Constructs a <code>DocumentUploadStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentUploadStatus} obj Optional instance to populate.
     * @return {module:model/DocumentUploadStatus} The populated <code>DocumentUploadStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentUploadStatus();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = DocumentUploadStatusAttributes.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentUploadStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentUploadStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentUploadStatus.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          DocumentUploadStatusAttributes.validateJSON(data['attributes']);
        }
...
DocumentUploadStatus.RequiredProperties = ["attributes", "id", "type"];

/**
 * @member {module:model/DocumentUploadStatusAttributes} attributes
 */
DocumentUploadStatus.prototype['attributes'] = undefined;

/**
 * JSON API identifier
 * @member {String} id
 */
DocumentUploadStatus.prototype['id'] = undefined;

/**
 * JSON API type specification
 * @member {String} type
 */
DocumentUploadStatus.prototype['type'] = undefined;
