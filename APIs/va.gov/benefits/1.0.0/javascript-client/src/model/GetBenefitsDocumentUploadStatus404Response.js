...
/**
 * The GetBenefitsDocumentUploadStatus404Response model module.
 * @module model/GetBenefitsDocumentUploadStatus404Response
 * @version 1.0.0
 */
class GetBenefitsDocumentUploadStatus404Response {
    /**
     * Constructs a new <code>GetBenefitsDocumentUploadStatus404Response</code>.
     * @alias module:model/GetBenefitsDocumentUploadStatus404Response
     */
    constructor() { 
        
        GetBenefitsDocumentUploadStatus404Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetBenefitsDocumentUploadStatus404Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBenefitsDocumentUploadStatus404Response} obj Optional instance to populate.
     * @return {module:model/GetBenefitsDocumentUploadStatus404Response} The populated <code>GetBenefitsDocumentUploadStatus404Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBenefitsDocumentUploadStatus404Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBenefitsDocumentUploadStatus404Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBenefitsDocumentUploadStatus404Response</code>.
     */
 ...
 * @member {String} code
 */
GetBenefitsDocumentUploadStatus404Response.prototype['code'] = undefined;

/**
 * Human readable error detail. Only present if status = \"error\"
 * @member {String} detail
 */
GetBenefitsDocumentUploadStatus404Response.prototype['detail'] = undefined;

/**
 * Unambiguous status code. Only present if status = \"error\"  * `DOC101` - Invalid multipart payload provided - not a multipart, or missing one or more required parts. * `DOC102` - Invalid metadata - not parseable as JSON, incorrect fields, etc. * `DOC103` - Invalid content - not parseable as PDF. Detail field will indicate which document or attachment part was affected. * `DOC104` - Upload rejected by upstream system. Processing failed and upload must be resubmitted. Detail field will indicate nature of rejection. * `DOC105` - Invalid or unknown id * `DOC106` - File size limit exceeded. Each document may be a maximum of 100MB. * `DOC107` - Empty payload. * `DOC108` - Maximum dimensions exceeded. Height and width must be less than 21 in x 21 in. * `DOC201` - Upload server error. * `DOC202` - Error during processing by upstream system. Processing failed and upload must be resubmitted. Detail field will provide additional details where available. 
 * @member {String} status
 */
GetBenefitsDocumentUploadStatus404Response.prototype['status'] = undefined;

/**
 * Human readable title description.
 * @member {String} title
 */
GetBenefitsDocumentUploadStatus404Response.prototype['title'] = undefined;
...
export default GetBenefitsDocumentUploadStatus404Response;
