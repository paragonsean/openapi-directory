...
/**
 * The DocumentUploadStatusAttributes model module.
 * @module model/DocumentUploadStatusAttributes
 * @version 1.0.0
 */
class DocumentUploadStatusAttributes {
    /**
     * Constructs a new <code>DocumentUploadStatusAttributes</code>.
     * @alias module:model/DocumentUploadStatusAttributes
     * @param guid {String} The document upload identifier
     * @param status {module:model/DocumentUploadStatusAttributes.StatusEnum} Document upload status. 
     */
    ...
    /**
     * Constructs a <code>DocumentUploadStatusAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentUploadStatusAttributes} obj Optional instance to populate.
     * @return {module:model/DocumentUploadStatusAttributes} The populated <code>DocumentUploadStatusAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentUploadStatusAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentUploadStatusAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentUploadStatusAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentUploadStatusAttributes.RequiredProperties) {
...
DocumentUploadStatusAttributes.RequiredProperties = ["guid", "status"];
 ...
 * @readonly
 */
DocumentUploadStatusAttributes['StatusEnum'] = {
...
export default DocumentUploadStatusAttributes;
