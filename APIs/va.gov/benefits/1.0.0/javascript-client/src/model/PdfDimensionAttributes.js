...
/**
 * The PdfDimensionAttributes model module.
 * @module model/PdfDimensionAttributes
 * @version 1.0.0
 */
class PdfDimensionAttributes {
    /**
     * Constructs a new <code>PdfDimensionAttributes</code>.
     * @alias module:model/PdfDimensionAttributes
     * @param height {Number} The document height
     * @param oversizedPdf {Boolean} Indicates if this is an oversized PDF (greater than 21x21)
     * @param width {Number} The document width
     */
    constructor(height, oversizedPdf, width) { 
        
        PdfDimensionAttributes.initialize(this, height, oversizedPdf, width);
    }
     ...
     */
    static initialize(obj, height, oversizedPdf, width) { 
        obj['height'] = height;
        obj['oversized_pdf'] = oversizedPdf;
        obj['width'] = width;
    }

    /**
     * Constructs a <code>PdfDimensionAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PdfDimensionAttributes} obj Optional instance to populate.
     * @return {module:model/PdfDimensionAttributes} The populated <code>PdfDimensionAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PdfDimensionAttributes();

            if (data.hasOwnProperty('height')) {
                obj['height'] = ApiClient.convertToType(data['height'], 'Number');
            }
            if (data.hasOwnProperty('oversized_pdf')) {
                obj['oversized_pdf'] = ApiClient.convertToType(data['oversized_pdf'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PdfDimensionAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PdfDimensionAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PdfDimensionAttributes.RequiredProperties) {
...
PdfDimensionAttributes.RequiredProperties = ["height", "oversized_pdf", "width"];

/**
 * The document height
 * @member {Number} height
 */
PdfDimensionAttributes.prototype['height'] = undefined;

/**
 * Indicates if this is an oversized PDF (greater than 21x21)
 * @member {Boolean} oversized_pdf
 */
PdfDimensionAttributes.prototype['oversized_pdf'] = undefined;

/**
 * The document width
 * @member {Number} width
 */
PdfDimensionAttributes.prototype['width'] = undefined;
...
export default PdfDimensionAttributes;
