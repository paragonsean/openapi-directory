...
/**
 * The DocumentUploadPath model module.
 * @module model/DocumentUploadPath
 * @version 1.0.0
 */
class DocumentUploadPath {
    /**
     * Constructs a new <code>DocumentUploadPath</code>.
     * Status record for a previously initiated document submission.
     * @alias module:model/DocumentUploadPath
     * @param attributes {module:model/DocumentUploadAttributes} 
     * @param id {String} JSON API identifier
     * @param type {String} JSON API type specification
     */
    constructor(attributes, id, type) { 
        
        DocumentUploadPath.initialize(this, attributes, id, type);
    }
    ...
    /**
     * Constructs a <code>DocumentUploadPath</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentUploadPath} obj Optional instance to populate.
     * @return {module:model/DocumentUploadPath} The populated <code>DocumentUploadPath</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentUploadPath();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = DocumentUploadAttributes.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentUploadPath</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentUploadPath</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentUploadPath.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          DocumentUploadAttributes.validateJSON(data['attributes']);
        }
...
DocumentUploadPath.RequiredProperties = ["attributes", "id", "type"];

/**
 * @member {module:model/DocumentUploadAttributes} attributes
 */
DocumentUploadPath.prototype['attributes'] = undefined;

/**
 * JSON API identifier
 * @member {String} id
 */
DocumentUploadPath.prototype['id'] = undefined;

/**
 * JSON API type specification
 * @member {String} type
 */
DocumentUploadPath.prototype['type'] = undefined;
...
export default DocumentUploadPath;
