...
/**
 * The PutBenefitsDocumentUpload422Response model module.
 * @module model/PutBenefitsDocumentUpload422Response
 * @version 1.0.0
 */
class PutBenefitsDocumentUpload422Response {
    /**
     * Constructs a new <code>PutBenefitsDocumentUpload422Response</code>.
     * @alias module:model/PutBenefitsDocumentUpload422Response
     * @param errors {Array.<module:model/ErrorModel>} 
     */
    constructor(errors) { 
        
        PutBenefitsDocumentUpload422Response.initialize(this, errors);
    }
    ...
    /**
     * Constructs a <code>PutBenefitsDocumentUpload422Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutBenefitsDocumentUpload422Response} obj Optional instance to populate.
     * @return {module:model/PutBenefitsDocumentUpload422Response} The populated <code>PutBenefitsDocumentUpload422Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutBenefitsDocumentUpload422Response();

            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [ErrorModel]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutBenefitsDocumentUpload422Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutBenefitsDocumentUpload422Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutBenefitsDocumentUpload422Response.RequiredProperties) {
...
PutBenefitsDocumentUpload422Response.RequiredProperties = ["errors"];

/**
 * @member {Array.<module:model/ErrorModel>} errors
 */
PutBenefitsDocumentUpload422Response.prototype['errors'] = undefined;
...
export default PutBenefitsDocumentUpload422Response;
