...
/**
 * The PutBenefitsDocumentUpload401Response model module.
 * @module model/PutBenefitsDocumentUpload401Response
 * @version 1.0.0
 */
class PutBenefitsDocumentUpload401Response {
    /**
     * Constructs a new <code>PutBenefitsDocumentUpload401Response</code>.
     * @alias module:model/PutBenefitsDocumentUpload401Response
     */
    constructor() { 
        
        PutBenefitsDocumentUpload401Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutBenefitsDocumentUpload401Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutBenefitsDocumentUpload401Response} obj Optional instance to populate.
     * @return {module:model/PutBenefitsDocumentUpload401Response} The populated <code>PutBenefitsDocumentUpload401Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutBenefitsDocumentUpload401Response();
    ...
    /**
     * Validates the JSON data with respect to <code>PutBenefitsDocumentUpload401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutBenefitsDocumentUpload401Response</code>.
     */
 ...
 */
PutBenefitsDocumentUpload401Response.prototype['Message'] = undefined;
...
export default PutBenefitsDocumentUpload401Response;
