...
/**
 * The DocumentUploadSubmissionAttributes model module.
 * @module model/DocumentUploadSubmissionAttributes
 * @version 1.0.0
 */
class DocumentUploadSubmissionAttributes {
    /**
     * Constructs a new <code>DocumentUploadSubmissionAttributes</code>.
     * @alias module:model/DocumentUploadSubmissionAttributes
     * @implements module:model/DocumentUploadStatusAttributes
     * @param guid {String} The document upload identifier
     * @param status {module:model/DocumentUploadSubmissionAttributes.StatusEnum} Document upload status. 
     */
    constructor(guid, status) { 
        DocumentUploadStatusAttributes.initialize(this, guid, status);
        DocumentUploadSubmissionAttributes.initialize(this, guid, status);
    }
     ...
     */
    static initialize(obj, guid, status) { 
        obj['guid'] = guid;
        obj['status'] = status;
    }

    /**
     * Constructs a <code>DocumentUploadSubmissionAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentUploadSubmissionAttributes} obj Optional instance to populate.
     * @return {module:model/DocumentUploadSubmissionAttributes} The populated <code>DocumentUploadSubmissionAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentUploadSubmissionAttributes();
            DocumentUploadStatusAttributes.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('uploaded_pdf')) {
                obj['uploaded_pdf'] = PdfUploadAttributes.constructFromObject(data['uploaded_pdf']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentUploadSubmissionAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentUploadSubmissionAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentUploadSubmissionAttributes.RequiredProperties) {
        ...
        if (data['uploaded_pdf']) { // data not null
          PdfUploadAttributes.validateJSON(data['uploaded_pdf']);
        }
...
DocumentUploadSubmissionAttributes.RequiredProperties = ["guid", "status"];
 ...
 * @member {String} code
 */
DocumentUploadSubmissionAttributes.prototype['code'] = undefined;

/**
 * Human readable error detail. Only present if status = \"error\"
 * @member {String} detail
 */
DocumentUploadSubmissionAttributes.prototype['detail'] = undefined;

/**
 * The document upload identifier
 * @member {String} guid
 */
DocumentUploadSubmissionAttributes.prototype['guid'] = undefined;

/**
 * Human readable error description. Only present if status = \"error\"
 * @member {String} message
 */
DocumentUploadSubmissionAttributes.prototype['message'] = undefined;

/**
 * Document upload status. 
 * @member {module:model/DocumentUploadSubmissionAttributes.StatusEnum} status
 */
DocumentUploadSubmissionAttributes.prototype['status'] = undefined;

/**
 * The last time the submission was updated
 * @member {Date} updated_at
 */
DocumentUploadSubmissionAttributes.prototype['updated_at'] = undefined;

/**
 * @member {module:model/PdfUploadAttributes} uploaded_pdf
 */
DocumentUploadSubmissionAttributes.prototype['uploaded_pdf'] = undefined;


// Implement DocumentUploadStatusAttributes interface:
/**
 * Unambiguous status code. Only present if status = \"error\"  * `DOC101` - Invalid multipart payload provided - not a multipart, or missing one or more required parts. * `DOC102` - Invalid metadata - not parseable as JSON, incorrect fields, etc. * `DOC103` - Invalid content - not parseable as PDF. Detail field will indicate which document or attachment part was affected. * `DOC104` - Upload rejected by upstream system. Processing failed and upload must be resubmitted. Detail field will indicate nature of rejection. * `DOC105` - Invalid or unknown id * `DOC106` - File size limit exceeded. Each document may be a maximum of 100MB. * `DOC107` - Empty payload. * `DOC108` - Maximum dimensions exceeded. Height and width must be less than 21 in x 21 in. * `DOC201` - Upload server error. * `DOC202` - Error during processing by upstream system. Processing failed and upload must be resubmitted. Detail field will provide additional details where available. 
 * @member {String} code
 */
DocumentUploadStatusAttributes.prototype['code'] = undefined;
/**
 * Human readable error detail. Only present if status = \"error\"
 * @member {String} detail
 */
DocumentUploadStatusAttributes.prototype['detail'] = undefined;
/**
 * The document upload identifier
 * @member {String} guid
 */
DocumentUploadStatusAttributes.prototype['guid'] = undefined;
/**
 * Human readable error description. Only present if status = \"error\"
 * @member {String} message
 */
DocumentUploadStatusAttributes.prototype['message'] = undefined;
/**
 * Document upload status. 
 * @member {module:model/DocumentUploadStatusAttributes.StatusEnum} status
 */
DocumentUploadStatusAttributes.prototype['status'] = undefined;
/**
 * The last time the submission was updated
 * @member {Date} updated_at
 */
DocumentUploadStatusAttributes.prototype['updated_at'] = undefined;
/**
 * @member {module:model/PdfUploadAttributes} uploaded_pdf
 */
DocumentUploadStatusAttributes.prototype['uploaded_pdf'] = undefined;
 ...
 * @readonly
 */
DocumentUploadSubmissionAttributes['StatusEnum'] = {
...
export default DocumentUploadSubmissionAttributes;
