...
class ErrorModel {
     ...
     * @param detail {String} A more detailed message about why an error occurred
     * @param status {Number} Standard HTTP Status returned with Error
     */
    constructor(detail, status) { 
        
        ErrorModel.initialize(this, detail, status);
    }
     ...
     */
    static initialize(obj, detail, status) { 
        obj['detail'] = detail;
        obj['status'] = status;
    }
...
ErrorModel.RequiredProperties = ["detail", "status"];
