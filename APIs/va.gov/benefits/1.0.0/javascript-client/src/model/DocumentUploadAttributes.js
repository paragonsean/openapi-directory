...
/**
 * The DocumentUploadAttributes model module.
 * @module model/DocumentUploadAttributes
 * @version 1.0.0
 */
class DocumentUploadAttributes {
    /**
     * Constructs a new <code>DocumentUploadAttributes</code>.
     * @alias module:model/DocumentUploadAttributes
     * @param guid {String} The document upload identifier
     * @param status {module:model/DocumentUploadAttributes.StatusEnum} Document upload status. 
     */
    constructor(guid, status) { 
        
        DocumentUploadAttributes.initialize(this, guid, status);
    }
    ...
    /**
     * Constructs a <code>DocumentUploadAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentUploadAttributes} obj Optional instance to populate.
     * @return {module:model/DocumentUploadAttributes} The populated <code>DocumentUploadAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentUploadAttributes();
            ...
            if (data.hasOwnProperty('uploaded_pdf')) {
                obj['uploaded_pdf'] = ApiClient.convertToType(data['uploaded_pdf'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentUploadAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentUploadAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentUploadAttributes.RequiredProperties) {
...
DocumentUploadAttributes.RequiredProperties = ["guid", "status"];
 ...
 * @member {String} code
 */
DocumentUploadAttributes.prototype['code'] = undefined;

/**
 * Human readable error detail. Only present if status = \"error\"
 * @member {String} detail
 */
DocumentUploadAttributes.prototype['detail'] = undefined;

/**
 * The document upload identifier
 * @member {String} guid
 */
DocumentUploadAttributes.prototype['guid'] = undefined;

/**
 * Location to which to PUT document Payload
 * @member {String} location
 */
DocumentUploadAttributes.prototype['location'] = undefined;

/**
 * Document upload status. 
 * @member {module:model/DocumentUploadAttributes.StatusEnum} status
 */
DocumentUploadAttributes.prototype['status'] = undefined;

/**
 * The last time the submission was updated
 * @member {Date} updated_at
 */
DocumentUploadAttributes.prototype['updated_at'] = undefined;

/**
 * Only populated after submission starts processing
 * @member {Object} uploaded_pdf
 */
DocumentUploadAttributes.prototype['uploaded_pdf'] = undefined;
 ...
 * @readonly
 */
DocumentUploadAttributes['StatusEnum'] = {
...
export default DocumentUploadAttributes;
