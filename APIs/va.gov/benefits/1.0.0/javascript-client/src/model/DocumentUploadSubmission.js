...
import DocumentUploadSubmissionAttributes from './DocumentUploadSubmissionAttributes';

/**
 * The DocumentUploadSubmission model module.
 * @module model/DocumentUploadSubmission
 * @version 1.0.0
 */
class DocumentUploadSubmission {
    /**
     * Constructs a new <code>DocumentUploadSubmission</code>.
     * Record of requested document submission. Includes the location to which the document payload is to be uploaded
     * @alias module:model/DocumentUploadSubmission
     * @param attributes {module:model/DocumentUploadSubmissionAttributes} 
     * @param id {String} JSON API Identifier
     * @param type {String} JSON API type specification
     */
    constructor(attributes, id, type) { 
        
        DocumentUploadSubmission.initialize(this, attributes, id, type);
    }
    ...
    /**
     * Constructs a <code>DocumentUploadSubmission</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentUploadSubmission} obj Optional instance to populate.
     * @return {module:model/DocumentUploadSubmission} The populated <code>DocumentUploadSubmission</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentUploadSubmission();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = DocumentUploadSubmissionAttributes.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentUploadSubmission</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentUploadSubmission</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentUploadSubmission.RequiredProperties) {
        ...
        if (data['attributes']) { // data not null
          DocumentUploadSubmissionAttributes.validateJSON(data['attributes']);
        }
...
DocumentUploadSubmission.RequiredProperties = ["attributes", "id", "type"];

/**
 * @member {module:model/DocumentUploadSubmissionAttributes} attributes
 */
DocumentUploadSubmission.prototype['attributes'] = undefined;

/**
 * JSON API Identifier
 * @member {String} id
 */
DocumentUploadSubmission.prototype['id'] = undefined;

/**
 * JSON API type specification
 * @member {String} type
 */
DocumentUploadSubmission.prototype['type'] = undefined;
...
export default DocumentUploadSubmission;
