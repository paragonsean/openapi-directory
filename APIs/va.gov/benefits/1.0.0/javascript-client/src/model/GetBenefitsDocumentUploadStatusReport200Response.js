...
/**
 * The GetBenefitsDocumentUploadStatusReport200Response model module.
 * @module model/GetBenefitsDocumentUploadStatusReport200Response
 * @version 1.0.0
 */
class GetBenefitsDocumentUploadStatusReport200Response {
    /**
     * Constructs a new <code>GetBenefitsDocumentUploadStatusReport200Response</code>.
     * @alias module:model/GetBenefitsDocumentUploadStatusReport200Response
     * @param data {Array.<module:model/DocumentUploadStatus>} 
     */
    constructor(data) { 
        
        GetBenefitsDocumentUploadStatusReport200Response.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>GetBenefitsDocumentUploadStatusReport200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBenefitsDocumentUploadStatusReport200Response} obj Optional instance to populate.
     * @return {module:model/GetBenefitsDocumentUploadStatusReport200Response} The populated <code>GetBenefitsDocumentUploadStatusReport200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBenefitsDocumentUploadStatusReport200Response();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [DocumentUploadStatus]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetBenefitsDocumentUploadStatusReport200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBenefitsDocumentUploadStatusReport200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetBenefitsDocumentUploadStatusReport200Response.RequiredProperties) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                DocumentUploadStatus.validateJSON(item);
            };
        }
...
GetBenefitsDocumentUploadStatusReport200Response.RequiredProperties = ["data"];

/**
 * @member {Array.<module:model/DocumentUploadStatus>} data
 */
GetBenefitsDocumentUploadStatusReport200Response.prototype['data'] = undefined;
...
export default GetBenefitsDocumentUploadStatusReport200Response;
