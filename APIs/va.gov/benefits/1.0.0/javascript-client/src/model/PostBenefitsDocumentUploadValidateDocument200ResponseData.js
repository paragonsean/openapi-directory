...
import PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes from './PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes';

/**
 * The PostBenefitsDocumentUploadValidateDocument200ResponseData model module.
 * @module model/PostBenefitsDocumentUploadValidateDocument200ResponseData
 * @version 1.0.0
 */
class PostBenefitsDocumentUploadValidateDocument200ResponseData {
    /**
     * Constructs a new <code>PostBenefitsDocumentUploadValidateDocument200ResponseData</code>.
     * @alias module:model/PostBenefitsDocumentUploadValidateDocument200ResponseData
     */
    constructor() { 
        
        PostBenefitsDocumentUploadValidateDocument200ResponseData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostBenefitsDocumentUploadValidateDocument200ResponseData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostBenefitsDocumentUploadValidateDocument200ResponseData} obj Optional instance to populate.
     * @return {module:model/PostBenefitsDocumentUploadValidateDocument200ResponseData} The populated <code>PostBenefitsDocumentUploadValidateDocument200ResponseData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostBenefitsDocumentUploadValidateDocument200ResponseData();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PostBenefitsDocumentUploadValidateDocument200ResponseData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostBenefitsDocumentUploadValidateDocument200ResponseData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.validateJSON(data['attributes']);
        }
...
/**
 * @member {module:model/PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes} attributes
 */
PostBenefitsDocumentUploadValidateDocument200ResponseData.prototype['attributes'] = undefined;

/**
 * schema type
 * @member {String} type
 */
PostBenefitsDocumentUploadValidateDocument200ResponseData.prototype['type'] = undefined;
...
export default PostBenefitsDocumentUploadValidateDocument200ResponseData;
