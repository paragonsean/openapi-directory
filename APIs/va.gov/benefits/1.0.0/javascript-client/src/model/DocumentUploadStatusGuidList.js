...
/**
 * The DocumentUploadStatusGuidList model module.
 * @module model/DocumentUploadStatusGuidList
 * @version 1.0.0
 */
class DocumentUploadStatusGuidList {
    /**
     * Constructs a new <code>DocumentUploadStatusGuidList</code>.
     * @alias module:model/DocumentUploadStatusGuidList
     * @param ids {Array.<String>} List of IDs for previous document upload submissions
     */
    constructor(ids) { 
        
        DocumentUploadStatusGuidList.initialize(this, ids);
    }
    ...
    /**
     * Constructs a <code>DocumentUploadStatusGuidList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentUploadStatusGuidList} obj Optional instance to populate.
     * @return {module:model/DocumentUploadStatusGuidList} The populated <code>DocumentUploadStatusGuidList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentUploadStatusGuidList();
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentUploadStatusGuidList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentUploadStatusGuidList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentUploadStatusGuidList.RequiredProperties) {
...
DocumentUploadStatusGuidList.RequiredProperties = ["ids"];

/**
 * List of IDs for previous document upload submissions
 * @member {Array.<String>} ids
 */
DocumentUploadStatusGuidList.prototype['ids'] = undefined;
...
export default DocumentUploadStatusGuidList;
