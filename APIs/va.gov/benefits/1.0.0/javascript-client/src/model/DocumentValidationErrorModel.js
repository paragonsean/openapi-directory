...
/**
 * The DocumentValidationErrorModel model module.
 * @module model/DocumentValidationErrorModel
 * @version 1.0.0
 */
class DocumentValidationErrorModel {
    /**
     * Constructs a new <code>DocumentValidationErrorModel</code>.
     * Error returned from the document validation endpoint.
     * @alias module:model/DocumentValidationErrorModel
     * @param detail {String} Error detail  Possible values: * Document was not provided * Document is not a PDF * Document exceeds the file size limit of 100 MB * Document exceeds the page size limit of 21 in. x 21 in. * Document is locked with a user password * Document is not a valid PDF 
     * @param status {String} HTTP error code
     * @param title {String} Error title
     */
    constructor(detail, status, title) { 
        
        DocumentValidationErrorModel.initialize(this, detail, status, title);
    }
    ...
    /**
     * Constructs a <code>DocumentValidationErrorModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentValidationErrorModel} obj Optional instance to populate.
     * @return {module:model/DocumentValidationErrorModel} The populated <code>DocumentValidationErrorModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentValidationErrorModel();
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentValidationErrorModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentValidationErrorModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DocumentValidationErrorModel.RequiredProperties) {
...
DocumentValidationErrorModel.RequiredProperties = ["detail", "status", "title"];
 ...
 */
DocumentValidationErrorModel.prototype['detail'] = undefined;

/**
 * HTTP error code
 * @member {String} status
 */
DocumentValidationErrorModel.prototype['status'] = undefined;

/**
 * Error title
 * @member {String} title
 */
DocumentValidationErrorModel.prototype['title'] = undefined;
...
export default DocumentValidationErrorModel;
