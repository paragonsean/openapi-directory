...
import DocumentUploadPath from './DocumentUploadPath';

/**
 * The PostBenefitsDocumentUpload202Response model module.
 * @module model/PostBenefitsDocumentUpload202Response
 * @version 1.0.0
 */
class PostBenefitsDocumentUpload202Response {
    /**
     * Constructs a new <code>PostBenefitsDocumentUpload202Response</code>.
     * @alias module:model/PostBenefitsDocumentUpload202Response
     * @param data {module:model/DocumentUploadPath} 
     */
    constructor(data) { 
        
        PostBenefitsDocumentUpload202Response.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>PostBenefitsDocumentUpload202Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostBenefitsDocumentUpload202Response} obj Optional instance to populate.
     * @return {module:model/PostBenefitsDocumentUpload202Response} The populated <code>PostBenefitsDocumentUpload202Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostBenefitsDocumentUpload202Response();

            if (data.hasOwnProperty('data')) {
                obj['data'] = DocumentUploadPath.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostBenefitsDocumentUpload202Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostBenefitsDocumentUpload202Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostBenefitsDocumentUpload202Response.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          DocumentUploadPath.validateJSON(data['data']);
        }
...
PostBenefitsDocumentUpload202Response.RequiredProperties = ["data"];

/**
 * @member {module:model/DocumentUploadPath} data
 */
PostBenefitsDocumentUpload202Response.prototype['data'] = undefined;
...
export default PostBenefitsDocumentUpload202Response;
