...
/**
 * The PutBenefitsDocumentUpload429Response model module.
 * @module model/PutBenefitsDocumentUpload429Response
 * @version 1.0.0
 */
class PutBenefitsDocumentUpload429Response {
    /**
     * Constructs a new <code>PutBenefitsDocumentUpload429Response</code>.
     * @alias module:model/PutBenefitsDocumentUpload429Response
     */
    constructor() { 
        
        PutBenefitsDocumentUpload429Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutBenefitsDocumentUpload429Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutBenefitsDocumentUpload429Response} obj Optional instance to populate.
     * @return {module:model/PutBenefitsDocumentUpload429Response} The populated <code>PutBenefitsDocumentUpload429Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutBenefitsDocumentUpload429Response();
    ...
    /**
     * Validates the JSON data with respect to <code>PutBenefitsDocumentUpload429Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutBenefitsDocumentUpload429Response</code>.
     */
 ...
 */
PutBenefitsDocumentUpload429Response.prototype['Message'] = undefined;
...
export default PutBenefitsDocumentUpload429Response;
