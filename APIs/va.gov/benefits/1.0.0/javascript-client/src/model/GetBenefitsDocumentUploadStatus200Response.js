...
/**
 * The GetBenefitsDocumentUploadStatus200Response model module.
 * @module model/GetBenefitsDocumentUploadStatus200Response
 * @version 1.0.0
 */
class GetBenefitsDocumentUploadStatus200Response {
    /**
     * Constructs a new <code>GetBenefitsDocumentUploadStatus200Response</code>.
     * @alias module:model/GetBenefitsDocumentUploadStatus200Response
     * @param data {module:model/DocumentUploadStatus} 
     */
    constructor(data) { 
        
        GetBenefitsDocumentUploadStatus200Response.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>GetBenefitsDocumentUploadStatus200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBenefitsDocumentUploadStatus200Response} obj Optional instance to populate.
     * @return {module:model/GetBenefitsDocumentUploadStatus200Response} The populated <code>GetBenefitsDocumentUploadStatus200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetBenefitsDocumentUploadStatus200Response();

            if (data.hasOwnProperty('data')) {
                obj['data'] = DocumentUploadStatus.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetBenefitsDocumentUploadStatus200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBenefitsDocumentUploadStatus200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetBenefitsDocumentUploadStatus200Response.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          DocumentUploadStatus.validateJSON(data['data']);
        }
...
GetBenefitsDocumentUploadStatus200Response.RequiredProperties = ["data"];

/**
 * @member {module:model/DocumentUploadStatus} data
 */
GetBenefitsDocumentUploadStatus200Response.prototype['data'] = undefined;
...
export default GetBenefitsDocumentUploadStatus200Response;
