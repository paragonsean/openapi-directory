...
import PdfUploadAttributesContent from './PdfUploadAttributesContent';

/**
 * The PdfUploadAttributes model module.
 * @module model/PdfUploadAttributes
 * @version 1.0.0
 */
class PdfUploadAttributes {
    /**
     * Constructs a new <code>PdfUploadAttributes</code>.
     * @alias module:model/PdfUploadAttributes
     * @param content {module:model/PdfUploadAttributesContent} 
     * @param totalDocuments {Number} The total number of documents contained in this upload
     * @param totalPages {Number} The total number of pages contained in this upload
     */
    constructor(content, totalDocuments, totalPages) { 
        
        PdfUploadAttributes.initialize(this, content, totalDocuments, totalPages);
    }
     ...
     */
    static initialize(obj, content, totalDocuments, totalPages) { 
        obj['content'] = content;
        obj['total_documents'] = totalDocuments;
        obj['total_pages'] = totalPages;
    }

    /**
     * Constructs a <code>PdfUploadAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PdfUploadAttributes} obj Optional instance to populate.
     * @return {module:model/PdfUploadAttributes} The populated <code>PdfUploadAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PdfUploadAttributes();

            if (data.hasOwnProperty('content')) {
                obj['content'] = PdfUploadAttributesContent.constructFromObject(data['content']);
            }
            if (data.hasOwnProperty('total_documents')) {
                obj['total_documents'] = ApiClient.convertToType(data['total_documents'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PdfUploadAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PdfUploadAttributes</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PdfUploadAttributes.RequiredProperties) {
        ...
        if (data['content']) { // data not null
          PdfUploadAttributesContent.validateJSON(data['content']);
        }
...
PdfUploadAttributes.RequiredProperties = ["content", "total_documents", "total_pages"];

/**
 * @member {module:model/PdfUploadAttributesContent} content
 */
PdfUploadAttributes.prototype['content'] = undefined;

/**
 * The total number of documents contained in this upload
 * @member {Number} total_documents
 */
PdfUploadAttributes.prototype['total_documents'] = undefined;

/**
 * The total number of pages contained in this upload
 * @member {Number} total_pages
 */
PdfUploadAttributes.prototype['total_pages'] = undefined;
...
export default PdfUploadAttributes;
