...
/**
 * The DocumentUploadFailure model module.
 * @module model/DocumentUploadFailure
 * @version 1.0.0
 */
class DocumentUploadFailure {
    /**
     * Constructs a new <code>DocumentUploadFailure</code>.
     * Document upload failed
     * @alias module:model/DocumentUploadFailure
     */
    constructor() { 
        
        DocumentUploadFailure.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentUploadFailure</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentUploadFailure} obj Optional instance to populate.
     * @return {module:model/DocumentUploadFailure} The populated <code>DocumentUploadFailure</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentUploadFailure();
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentUploadFailure</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentUploadFailure</code>.
     */
 ...
 * @member {String} Code
 */
DocumentUploadFailure.prototype['Code'] = undefined;

/**
 * Error detail
 * @member {String} Message
 */
DocumentUploadFailure.prototype['Message'] = undefined;
...
export default DocumentUploadFailure;
