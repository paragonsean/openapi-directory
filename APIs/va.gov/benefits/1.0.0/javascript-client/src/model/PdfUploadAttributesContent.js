...
import PdfUploadAttributesContentAttachmentsInner from './PdfUploadAttributesContentAttachmentsInner';

/**
 * The PdfUploadAttributesContent model module.
 * @module model/PdfUploadAttributesContent
 * @version 1.0.0
 */
class PdfUploadAttributesContent {
    /**
     * Constructs a new <code>PdfUploadAttributesContent</code>.
     * @alias module:model/PdfUploadAttributesContent
     */
    constructor() { 
        
        PdfUploadAttributesContent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PdfUploadAttributesContent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PdfUploadAttributesContent} obj Optional instance to populate.
     * @return {module:model/PdfUploadAttributesContent} The populated <code>PdfUploadAttributesContent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PdfUploadAttributesContent();

            if (data.hasOwnProperty('attachments')) {
                obj['attachments'] = ApiClient.convertToType(data['attachments'], [PdfUploadAttributesContentAttachmentsInner]);
            }
            if (data.hasOwnProperty('dimensions')) {
                obj['dimensions'] = PdfDimensionAttributes.constructFromObject(data['dimensions']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PdfUploadAttributesContent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PdfUploadAttributesContent</code>.
     */
    static validateJSON(data) {
        if (data['attachments']) { // data not null
            ...
            for (const item of data['attachments']) {
                PdfUploadAttributesContentAttachmentsInner.validateJSON(item);
            };
        }
        // validate the optional field `dimensions`
        if (data['dimensions']) { // data not null
          PdfDimensionAttributes.validateJSON(data['dimensions']);
        }
...
/**
 * @member {Array.<module:model/PdfUploadAttributesContentAttachmentsInner>} attachments
 */
PdfUploadAttributesContent.prototype['attachments'] = undefined;

/**
 * @member {module:model/PdfDimensionAttributes} dimensions
 */
PdfUploadAttributesContent.prototype['dimensions'] = undefined;

/**
 * The total number of pages solely in this PDF document
 * @member {Number} page_count
 */
PdfUploadAttributesContent.prototype['page_count'] = undefined;
...
export default PdfUploadAttributesContent;
