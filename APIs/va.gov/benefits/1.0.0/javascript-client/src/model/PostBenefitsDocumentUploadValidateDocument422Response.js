...
import DocumentValidationErrorModel from './DocumentValidationErrorModel';

/**
 * The PostBenefitsDocumentUploadValidateDocument422Response model module.
 * @module model/PostBenefitsDocumentUploadValidateDocument422Response
 * @version 1.0.0
 */
class PostBenefitsDocumentUploadValidateDocument422Response {
    /**
     * Constructs a new <code>PostBenefitsDocumentUploadValidateDocument422Response</code>.
     * @alias module:model/PostBenefitsDocumentUploadValidateDocument422Response
     * @param errors {Array.<module:model/DocumentValidationErrorModel>} 
     */
    constructor(errors) { 
        
        PostBenefitsDocumentUploadValidateDocument422Response.initialize(this, errors);
    }
    ...
    /**
     * Constructs a <code>PostBenefitsDocumentUploadValidateDocument422Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostBenefitsDocumentUploadValidateDocument422Response} obj Optional instance to populate.
     * @return {module:model/PostBenefitsDocumentUploadValidateDocument422Response} The populated <code>PostBenefitsDocumentUploadValidateDocument422Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostBenefitsDocumentUploadValidateDocument422Response();

            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [DocumentValidationErrorModel]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostBenefitsDocumentUploadValidateDocument422Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostBenefitsDocumentUploadValidateDocument422Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostBenefitsDocumentUploadValidateDocument422Response.RequiredProperties) {
        ...
        if (data['errors']) { // data not null
            ...
            for (const item of data['errors']) {
                DocumentValidationErrorModel.validateJSON(item);
            };
        }
...
PostBenefitsDocumentUploadValidateDocument422Response.RequiredProperties = ["errors"];

/**
 * @member {Array.<module:model/DocumentValidationErrorModel>} errors
 */
PostBenefitsDocumentUploadValidateDocument422Response.prototype['errors'] = undefined;
...
export default PostBenefitsDocumentUploadValidateDocument422Response;
