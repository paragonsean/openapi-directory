...
/**
 * The PdfUploadAttributesContentAttachmentsInner model module.
 * @module model/PdfUploadAttributesContentAttachmentsInner
 * @version 1.0.0
 */
class PdfUploadAttributesContentAttachmentsInner {
    /**
     * Constructs a new <code>PdfUploadAttributesContentAttachmentsInner</code>.
     * @alias module:model/PdfUploadAttributesContentAttachmentsInner
     */
    constructor() { 
        
        PdfUploadAttributesContentAttachmentsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PdfUploadAttributesContentAttachmentsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PdfUploadAttributesContentAttachmentsInner} obj Optional instance to populate.
     * @return {module:model/PdfUploadAttributesContentAttachmentsInner} The populated <code>PdfUploadAttributesContentAttachmentsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PdfUploadAttributesContentAttachmentsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>PdfUploadAttributesContentAttachmentsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PdfUploadAttributesContentAttachmentsInner</code>.
     */
 ...
 */
PdfUploadAttributesContentAttachmentsInner.prototype['dimensions'] = undefined;

/**
 * The number of pages in this attachment
 * @member {Number} page_count
 */
PdfUploadAttributesContentAttachmentsInner.prototype['page_count'] = undefined;
...
export default PdfUploadAttributesContentAttachmentsInner;
