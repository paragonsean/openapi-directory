...
import PostBenefitsDocumentUploadValidateDocument200ResponseData from './PostBenefitsDocumentUploadValidateDocument200ResponseData';

/**
 * The PostBenefitsDocumentUploadValidateDocument200Response model module.
 * @module model/PostBenefitsDocumentUploadValidateDocument200Response
 * @version 1.0.0
 */
class PostBenefitsDocumentUploadValidateDocument200Response {
    /**
     * Constructs a new <code>PostBenefitsDocumentUploadValidateDocument200Response</code>.
     * @alias module:model/PostBenefitsDocumentUploadValidateDocument200Response
     */
    constructor() { 
        
        PostBenefitsDocumentUploadValidateDocument200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostBenefitsDocumentUploadValidateDocument200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostBenefitsDocumentUploadValidateDocument200Response} obj Optional instance to populate.
     * @return {module:model/PostBenefitsDocumentUploadValidateDocument200Response} The populated <code>PostBenefitsDocumentUploadValidateDocument200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostBenefitsDocumentUploadValidateDocument200Response();

            if (data.hasOwnProperty('data')) {
                obj['data'] = PostBenefitsDocumentUploadValidateDocument200ResponseData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostBenefitsDocumentUploadValidateDocument200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostBenefitsDocumentUploadValidateDocument200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          PostBenefitsDocumentUploadValidateDocument200ResponseData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/PostBenefitsDocumentUploadValidateDocument200ResponseData} data
 */
PostBenefitsDocumentUploadValidateDocument200Response.prototype['data'] = undefined;
...
export default PostBenefitsDocumentUploadValidateDocument200Response;
