...
/**
 * The PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes model module.
 * @module model/PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes
 * @version 1.0.0
 */
class PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes {
    /**
     * Constructs a new <code>PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes</code>.
     * @alias module:model/PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes
     */
    constructor() { 
        
        PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes} obj Optional instance to populate.
     * @return {module:model/PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes} The populated <code>PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes</code>.
     */
 ...
 */
PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.prototype['status'] = undefined;
...
export default PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes;
