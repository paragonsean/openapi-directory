...
/*
 * OAIPutBenefitsDocumentUpload_422_response.h
 *
 * 
 */

#ifndef OAIPutBenefitsDocumentUpload_422_response_H
#define OAIPutBenefitsDocumentUpload_422_response_H
...
class OAIPutBenefitsDocumentUpload_422_response : public OAIObject {
public:
    OAIPutBenefitsDocumentUpload_422_response();
    OAIPutBenefitsDocumentUpload_422_response(QString json);
    ~OAIPutBenefitsDocumentUpload_422_response() override;
    ...
    QList<OAIErrorModel> getErrors() const;
    void setErrors(const QList<OAIErrorModel> &errors);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutBenefitsDocumentUpload_422_response)

#endif // OAIPutBenefitsDocumentUpload_422_response_H
