...
/*
 * OAIDocumentUploadStatusAttributes.h
 *
 * 
 */

#ifndef OAIDocumentUploadStatusAttributes_H
#define OAIDocumentUploadStatusAttributes_H

#include <QJsonObject>

#include "OAIPdfUploadAttributes.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAIPdfUploadAttributes;

class OAIDocumentUploadStatusAttributes : public OAIObject {
public:
    OAIDocumentUploadStatusAttributes();
    OAIDocumentUploadStatusAttributes(QString json);
    ~OAIDocumentUploadStatusAttributes() override;
    ...
    OAIPdfUploadAttributes getUploadedPdf() const;
    void setUploadedPdf(const OAIPdfUploadAttributes &uploaded_pdf);
    bool is_uploaded_pdf_Set() const;
    bool is_uploaded_pdf_Valid() const;
...
private:
    ...
    OAIPdfUploadAttributes m_uploaded_pdf;
    bool m_uploaded_pdf_isSet;
    bool m_uploaded_pdf_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDocumentUploadStatusAttributes)

#endif // OAIDocumentUploadStatusAttributes_H
