...
#include "OAIPostBenefitsDocumentUploadValidateDocument_422_response.h"
...
OAIPostBenefitsDocumentUploadValidateDocument_422_response::OAIPostBenefitsDocumentUploadValidateDocument_422_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostBenefitsDocumentUploadValidateDocument_422_response::OAIPostBenefitsDocumentUploadValidateDocument_422_response() {
    this->initializeModel();
}

OAIPostBenefitsDocumentUploadValidateDocument_422_response::~OAIPostBenefitsDocumentUploadValidateDocument_422_response() {}

void OAIPostBenefitsDocumentUploadValidateDocument_422_response::initializeModel() {

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIPostBenefitsDocumentUploadValidateDocument_422_response::fromJson(QString jsonString) {
...
void OAIPostBenefitsDocumentUploadValidateDocument_422_response::fromJsonObject(QJsonObject json) {

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIPostBenefitsDocumentUploadValidateDocument_422_response::asJson() const {
...
QJsonObject OAIPostBenefitsDocumentUploadValidateDocument_422_response::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIDocumentValidationErrorModel> OAIPostBenefitsDocumentUploadValidateDocument_422_response::getErrors() const {
    return m_errors;
}
void OAIPostBenefitsDocumentUploadValidateDocument_422_response::setErrors(const QList<OAIDocumentValidationErrorModel> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_422_response::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_422_response::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_422_response::isSet() const {
...
bool OAIPostBenefitsDocumentUploadValidateDocument_422_response::isValid() const {
