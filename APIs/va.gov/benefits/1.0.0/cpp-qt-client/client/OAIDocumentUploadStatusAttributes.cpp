...
#include "OAIDocumentUploadStatusAttributes.h"
...
OAIDocumentUploadStatusAttributes::OAIDocumentUploadStatusAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDocumentUploadStatusAttributes::OAIDocumentUploadStatusAttributes() {
    this->initializeModel();
}

OAIDocumentUploadStatusAttributes::~OAIDocumentUploadStatusAttributes() {}

void OAIDocumentUploadStatusAttributes::initializeModel() {
...
void OAIDocumentUploadStatusAttributes::fromJson(QString jsonString) {
...
void OAIDocumentUploadStatusAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIDocumentUploadStatusAttributes::asJson() const {
...
QJsonObject OAIDocumentUploadStatusAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIDocumentUploadStatusAttributes::getCode() const {
    return m_code;
}
void OAIDocumentUploadStatusAttributes::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIDocumentUploadStatusAttributes::is_code_Set() const{
    return m_code_isSet;
}

bool OAIDocumentUploadStatusAttributes::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIDocumentUploadStatusAttributes::getDetail() const {
    return m_detail;
}
void OAIDocumentUploadStatusAttributes::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIDocumentUploadStatusAttributes::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIDocumentUploadStatusAttributes::is_detail_Valid() const{
    return m_detail_isValid;
}

QString OAIDocumentUploadStatusAttributes::getGuid() const {
    return m_guid;
}
void OAIDocumentUploadStatusAttributes::setGuid(const QString &guid) {
    m_guid = guid;
    m_guid_isSet = true;
}

bool OAIDocumentUploadStatusAttributes::is_guid_Set() const{
    return m_guid_isSet;
}

bool OAIDocumentUploadStatusAttributes::is_guid_Valid() const{
    return m_guid_isValid;
}

QString OAIDocumentUploadStatusAttributes::getMessage() const {
    return m_message;
}
void OAIDocumentUploadStatusAttributes::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIDocumentUploadStatusAttributes::is_message_Set() const{
    return m_message_isSet;
}

bool OAIDocumentUploadStatusAttributes::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIDocumentUploadStatusAttributes::getStatus() const {
    return m_status;
}
void OAIDocumentUploadStatusAttributes::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDocumentUploadStatusAttributes::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDocumentUploadStatusAttributes::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIDocumentUploadStatusAttributes::getUpdatedAt() const {
    return m_updated_at;
}
void OAIDocumentUploadStatusAttributes::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIDocumentUploadStatusAttributes::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIDocumentUploadStatusAttributes::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

OAIPdfUploadAttributes OAIDocumentUploadStatusAttributes::getUploadedPdf() const {
    return m_uploaded_pdf;
}
void OAIDocumentUploadStatusAttributes::setUploadedPdf(const OAIPdfUploadAttributes &uploaded_pdf) {
    m_uploaded_pdf = uploaded_pdf;
    m_uploaded_pdf_isSet = true;
}

bool OAIDocumentUploadStatusAttributes::is_uploaded_pdf_Set() const{
    return m_uploaded_pdf_isSet;
}

bool OAIDocumentUploadStatusAttributes::is_uploaded_pdf_Valid() const{
    return m_uploaded_pdf_isValid;
}

bool OAIDocumentUploadStatusAttributes::isSet() const {
...
bool OAIDocumentUploadStatusAttributes::isValid() const {
