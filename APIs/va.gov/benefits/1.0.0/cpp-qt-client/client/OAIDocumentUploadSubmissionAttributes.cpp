...
#include "OAIDocumentUploadSubmissionAttributes.h"
...
OAIDocumentUploadSubmissionAttributes::OAIDocumentUploadSubmissionAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDocumentUploadSubmissionAttributes::OAIDocumentUploadSubmissionAttributes() {
    this->initializeModel();
}

OAIDocumentUploadSubmissionAttributes::~OAIDocumentUploadSubmissionAttributes() {}

void OAIDocumentUploadSubmissionAttributes::initializeModel() {
    ...
    m_uploaded_pdf_isSet = false;
    m_uploaded_pdf_isValid = false;
}

void OAIDocumentUploadSubmissionAttributes::fromJson(QString jsonString) {
...
void OAIDocumentUploadSubmissionAttributes::fromJsonObject(QJsonObject json) {
    ...
    m_uploaded_pdf_isValid = ::OpenAPI::fromJsonValue(m_uploaded_pdf, json[QString("uploaded_pdf")]);
    m_uploaded_pdf_isSet = !json[QString("uploaded_pdf")].isNull() && m_uploaded_pdf_isValid;
}

QString OAIDocumentUploadSubmissionAttributes::asJson() const {
...
QJsonObject OAIDocumentUploadSubmissionAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
    ...
    if (m_uploaded_pdf.isSet()) {
        obj.insert(QString("uploaded_pdf"), ::OpenAPI::toJsonValue(m_uploaded_pdf));
    }
    return obj;
}

QString OAIDocumentUploadSubmissionAttributes::getCode() const {
    return m_code;
}
void OAIDocumentUploadSubmissionAttributes::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIDocumentUploadSubmissionAttributes::is_code_Set() const{
    return m_code_isSet;
}

bool OAIDocumentUploadSubmissionAttributes::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIDocumentUploadSubmissionAttributes::getDetail() const {
    return m_detail;
}
void OAIDocumentUploadSubmissionAttributes::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIDocumentUploadSubmissionAttributes::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIDocumentUploadSubmissionAttributes::is_detail_Valid() const{
    return m_detail_isValid;
}

QString OAIDocumentUploadSubmissionAttributes::getGuid() const {
    return m_guid;
}
void OAIDocumentUploadSubmissionAttributes::setGuid(const QString &guid) {
    m_guid = guid;
    m_guid_isSet = true;
}

bool OAIDocumentUploadSubmissionAttributes::is_guid_Set() const{
    return m_guid_isSet;
}

bool OAIDocumentUploadSubmissionAttributes::is_guid_Valid() const{
    return m_guid_isValid;
}

QString OAIDocumentUploadSubmissionAttributes::getMessage() const {
    return m_message;
}
void OAIDocumentUploadSubmissionAttributes::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIDocumentUploadSubmissionAttributes::is_message_Set() const{
    return m_message_isSet;
}

bool OAIDocumentUploadSubmissionAttributes::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIDocumentUploadSubmissionAttributes::getStatus() const {
    return m_status;
}
void OAIDocumentUploadSubmissionAttributes::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDocumentUploadSubmissionAttributes::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDocumentUploadSubmissionAttributes::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIDocumentUploadSubmissionAttributes::getUpdatedAt() const {
    return m_updated_at;
}
void OAIDocumentUploadSubmissionAttributes::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIDocumentUploadSubmissionAttributes::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIDocumentUploadSubmissionAttributes::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

OAIPdfUploadAttributes OAIDocumentUploadSubmissionAttributes::getUploadedPdf() const {
    return m_uploaded_pdf;
}
void OAIDocumentUploadSubmissionAttributes::setUploadedPdf(const OAIPdfUploadAttributes &uploaded_pdf) {
    m_uploaded_pdf = uploaded_pdf;
    m_uploaded_pdf_isSet = true;
}

bool OAIDocumentUploadSubmissionAttributes::is_uploaded_pdf_Set() const{
    return m_uploaded_pdf_isSet;
}

bool OAIDocumentUploadSubmissionAttributes::is_uploaded_pdf_Valid() const{
    return m_uploaded_pdf_isValid;
}

bool OAIDocumentUploadSubmissionAttributes::isSet() const {
...
bool OAIDocumentUploadSubmissionAttributes::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_guid_isValid && m_status_isValid && true;
}
