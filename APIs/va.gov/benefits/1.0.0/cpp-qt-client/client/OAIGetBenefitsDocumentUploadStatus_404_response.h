...
/*
 * OAIGetBenefitsDocumentUploadStatus_404_response.h
 *
 * 
 */

#ifndef OAIGetBenefitsDocumentUploadStatus_404_response_H
#define OAIGetBenefitsDocumentUploadStatus_404_response_H
...
class OAIGetBenefitsDocumentUploadStatus_404_response : public OAIObject {
public:
    OAIGetBenefitsDocumentUploadStatus_404_response();
    OAIGetBenefitsDocumentUploadStatus_404_response(QString json);
    ~OAIGetBenefitsDocumentUploadStatus_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBenefitsDocumentUploadStatus_404_response)

#endif // OAIGetBenefitsDocumentUploadStatus_404_response_H
