...
#include "OAIPutBenefitsDocumentUpload_401_response.h"
...
OAIPutBenefitsDocumentUpload_401_response::OAIPutBenefitsDocumentUpload_401_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutBenefitsDocumentUpload_401_response::OAIPutBenefitsDocumentUpload_401_response() {
    this->initializeModel();
}

OAIPutBenefitsDocumentUpload_401_response::~OAIPutBenefitsDocumentUpload_401_response() {}

void OAIPutBenefitsDocumentUpload_401_response::initializeModel() {

    m_message_isSet = false;
    m_message_isValid = false;
}

void OAIPutBenefitsDocumentUpload_401_response::fromJson(QString jsonString) {
...
void OAIPutBenefitsDocumentUpload_401_response::fromJsonObject(QJsonObject json) {

    m_message_isValid = ::OpenAPI::fromJsonValue(m_message, json[QString("Message")]);
    m_message_isSet = !json[QString("Message")].isNull() && m_message_isValid;
}

QString OAIPutBenefitsDocumentUpload_401_response::asJson() const {
...
QJsonObject OAIPutBenefitsDocumentUpload_401_response::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIPutBenefitsDocumentUpload_401_response::getMessage() const {
    return m_message;
}
void OAIPutBenefitsDocumentUpload_401_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIPutBenefitsDocumentUpload_401_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAIPutBenefitsDocumentUpload_401_response::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIPutBenefitsDocumentUpload_401_response::isSet() const {
...
bool OAIPutBenefitsDocumentUpload_401_response::isValid() const {
