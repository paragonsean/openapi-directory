...
/*
 * OAIPutBenefitsDocumentUpload_500_response.h
 *
 * 
 */

#ifndef OAIPutBenefitsDocumentUpload_500_response_H
#define OAIPutBenefitsDocumentUpload_500_response_H
...
class OAIPutBenefitsDocumentUpload_500_response : public OAIObject {
public:
    OAIPutBenefitsDocumentUpload_500_response();
    OAIPutBenefitsDocumentUpload_500_response(QString json);
    ~OAIPutBenefitsDocumentUpload_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutBenefitsDocumentUpload_500_response)

#endif // OAIPutBenefitsDocumentUpload_500_response_H
