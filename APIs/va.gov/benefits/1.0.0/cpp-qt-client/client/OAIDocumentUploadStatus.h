...
/*
 * OAIDocumentUploadStatus.h
 *
 * Status record for a previously initiated document submission.
 */

#ifndef OAIDocumentUploadStatus_H
#define OAIDocumentUploadStatus_H
...
namespace OpenAPI {
class OAIDocumentUploadStatusAttributes;

class OAIDocumentUploadStatus : public OAIObject {
public:
    OAIDocumentUploadStatus();
    OAIDocumentUploadStatus(QString json);
    ~OAIDocumentUploadStatus() override;
    ...
    OAIDocumentUploadStatusAttributes getAttributes() const;
    void setAttributes(const OAIDocumentUploadStatusAttributes &attributes);
...
private:
    ...
    OAIDocumentUploadStatusAttributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentUploadStatus)

#endif // OAIDocumentUploadStatus_H
