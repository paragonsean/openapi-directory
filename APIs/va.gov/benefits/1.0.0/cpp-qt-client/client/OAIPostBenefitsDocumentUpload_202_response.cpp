...
#include "OAIPostBenefitsDocumentUpload_202_response.h"
...
OAIPostBenefitsDocumentUpload_202_response::OAIPostBenefitsDocumentUpload_202_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostBenefitsDocumentUpload_202_response::OAIPostBenefitsDocumentUpload_202_response() {
    this->initializeModel();
}

OAIPostBenefitsDocumentUpload_202_response::~OAIPostBenefitsDocumentUpload_202_response() {}

void OAIPostBenefitsDocumentUpload_202_response::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIPostBenefitsDocumentUpload_202_response::fromJson(QString jsonString) {
...
void OAIPostBenefitsDocumentUpload_202_response::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIPostBenefitsDocumentUpload_202_response::asJson() const {
...
QJsonObject OAIPostBenefitsDocumentUpload_202_response::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIDocumentUploadPath OAIPostBenefitsDocumentUpload_202_response::getData() const {
    return m_data;
}
void OAIPostBenefitsDocumentUpload_202_response::setData(const OAIDocumentUploadPath &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPostBenefitsDocumentUpload_202_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPostBenefitsDocumentUpload_202_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIPostBenefitsDocumentUpload_202_response::isSet() const {
...
bool OAIPostBenefitsDocumentUpload_202_response::isValid() const {
