...
/*
 * OAIPutBenefitsDocumentUpload_401_response.h
 *
 * 
 */

#ifndef OAIPutBenefitsDocumentUpload_401_response_H
#define OAIPutBenefitsDocumentUpload_401_response_H
...
class OAIPutBenefitsDocumentUpload_401_response : public OAIObject {
public:
    OAIPutBenefitsDocumentUpload_401_response();
    OAIPutBenefitsDocumentUpload_401_response(QString json);
    ~OAIPutBenefitsDocumentUpload_401_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutBenefitsDocumentUpload_401_response)

#endif // OAIPutBenefitsDocumentUpload_401_response_H
