...
#include "OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes.h"
...
OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes() {
    this->initializeModel();
}

OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::~OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes() {}

void OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::fromJson(QString jsonString) {
...
void OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;
}

QString OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::asJson() const {
...
QJsonObject OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::asJsonObject() const {
    QJsonObject obj;
    if (m_status_isSet) {
...
QString OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::getStatus() const {
    return m_status;
}
void OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::isSet() const {
...
bool OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes::isValid() const {
