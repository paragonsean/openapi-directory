...
/*
 * OAIPdfUploadAttributes_content.h
 *
 * 
 */

#ifndef OAIPdfUploadAttributes_content_H
#define OAIPdfUploadAttributes_content_H
...
namespace OpenAPI {
class OAIPdfUploadAttributes_content_attachments_inner;
class OAIPdfDimensionAttributes;

class OAIPdfUploadAttributes_content : public OAIObject {
public:
    OAIPdfUploadAttributes_content();
    OAIPdfUploadAttributes_content(QString json);
    ~OAIPdfUploadAttributes_content() override;
    ...
    QList<OAIPdfUploadAttributes_content_attachments_inner> getAttachments() const;
    void setAttachments(const QList<OAIPdfUploadAttributes_content_attachments_inner> &attachments);
...
private:
    ...
    QList<OAIPdfUploadAttributes_content_attachments_inner> m_attachments;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPdfUploadAttributes_content)

#endif // OAIPdfUploadAttributes_content_H
