...
/*
 * OAIGetBenefitsDocumentUploadStatus_200_response.h
 *
 * 
 */

#ifndef OAIGetBenefitsDocumentUploadStatus_200_response_H
#define OAIGetBenefitsDocumentUploadStatus_200_response_H
...
class OAIGetBenefitsDocumentUploadStatus_200_response : public OAIObject {
public:
    OAIGetBenefitsDocumentUploadStatus_200_response();
    OAIGetBenefitsDocumentUploadStatus_200_response(QString json);
    ~OAIGetBenefitsDocumentUploadStatus_200_response() override;
    ...
    OAIDocumentUploadStatus getData() const;
    void setData(const OAIDocumentUploadStatus &data);
...
private:
    ...
    OAIDocumentUploadStatus m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBenefitsDocumentUploadStatus_200_response)

#endif // OAIGetBenefitsDocumentUploadStatus_200_response_H
