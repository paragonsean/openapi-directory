...
/*
 * OAIPostBenefitsDocumentUploadValidateDocument_422_response.h
 *
 * 
 */

#ifndef OAIPostBenefitsDocumentUploadValidateDocument_422_response_H
#define OAIPostBenefitsDocumentUploadValidateDocument_422_response_H
...
namespace OpenAPI {
class OAIDocumentValidationErrorModel;

class OAIPostBenefitsDocumentUploadValidateDocument_422_response : public OAIObject {
public:
    OAIPostBenefitsDocumentUploadValidateDocument_422_response();
    OAIPostBenefitsDocumentUploadValidateDocument_422_response(QString json);
    ~OAIPostBenefitsDocumentUploadValidateDocument_422_response() override;
    ...
    QList<OAIDocumentValidationErrorModel> getErrors() const;
    void setErrors(const QList<OAIDocumentValidationErrorModel> &errors);
...
private:
    ...
    QList<OAIDocumentValidationErrorModel> m_errors;
    bool m_errors_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostBenefitsDocumentUploadValidateDocument_422_response)

#endif // OAIPostBenefitsDocumentUploadValidateDocument_422_response_H
