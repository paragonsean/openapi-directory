...
QString OAIErrorModel::getDetail() const {
    return m_detail;
}
void OAIErrorModel::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIErrorModel::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIErrorModel::is_detail_Valid() const{
    return m_detail_isValid;
}

qint32 OAIErrorModel::getStatus() const {
    return m_status;
}
void OAIErrorModel::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}
...
bool OAIErrorModel::isValid() const {
    ...
    return m_detail_isValid && m_status_isValid && true;
}
