...
/*
 * OAIPostBenefitsDocumentUploadValidateDocument_200_response.h
 *
 * 
 */

#ifndef OAIPostBenefitsDocumentUploadValidateDocument_200_response_H
#define OAIPostBenefitsDocumentUploadValidateDocument_200_response_H
...
namespace OpenAPI {
class OAIPostBenefitsDocumentUploadValidateDocument_200_response_data;

class OAIPostBenefitsDocumentUploadValidateDocument_200_response : public OAIObject {
public:
    OAIPostBenefitsDocumentUploadValidateDocument_200_response();
    OAIPostBenefitsDocumentUploadValidateDocument_200_response(QString json);
    ~OAIPostBenefitsDocumentUploadValidateDocument_200_response() override;
    ...
    OAIPostBenefitsDocumentUploadValidateDocument_200_response_data getData() const;
    void setData(const OAIPostBenefitsDocumentUploadValidateDocument_200_response_data &data);
...
private:
    ...
    OAIPostBenefitsDocumentUploadValidateDocument_200_response_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostBenefitsDocumentUploadValidateDocument_200_response)

#endif // OAIPostBenefitsDocumentUploadValidateDocument_200_response_H
