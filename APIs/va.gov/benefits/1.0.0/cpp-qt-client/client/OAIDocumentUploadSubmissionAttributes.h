...
/*
 * OAIDocumentUploadSubmissionAttributes.h
 *
 * 
 */

#ifndef OAIDocumentUploadSubmissionAttributes_H
#define OAIDocumentUploadSubmissionAttributes_H
...
class OAIDocumentUploadSubmissionAttributes : public OAIObject {
public:
    OAIDocumentUploadSubmissionAttributes();
    OAIDocumentUploadSubmissionAttributes(QString json);
    ~OAIDocumentUploadSubmissionAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentUploadSubmissionAttributes)

#endif // OAIDocumentUploadSubmissionAttributes_H
