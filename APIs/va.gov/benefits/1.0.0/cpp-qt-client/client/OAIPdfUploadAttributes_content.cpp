...
OAIPdfUploadAttributes_content::OAIPdfUploadAttributes_content(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPdfUploadAttributes_content::OAIPdfUploadAttributes_content() {
    this->initializeModel();
}

OAIPdfUploadAttributes_content::~OAIPdfUploadAttributes_content() {}

void OAIPdfUploadAttributes_content::initializeModel() {
...
void OAIPdfUploadAttributes_content::fromJson(QString jsonString) {
...
void OAIPdfUploadAttributes_content::fromJsonObject(QJsonObject json) {
...
QString OAIPdfUploadAttributes_content::asJson() const {
...
QJsonObject OAIPdfUploadAttributes_content::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIPdfUploadAttributes_content_attachments_inner> OAIPdfUploadAttributes_content::getAttachments() const {
    return m_attachments;
}
void OAIPdfUploadAttributes_content::setAttachments(const QList<OAIPdfUploadAttributes_content_attachments_inner> &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAIPdfUploadAttributes_content::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAIPdfUploadAttributes_content::is_attachments_Valid() const{
    return m_attachments_isValid;
}

OAIPdfDimensionAttributes OAIPdfUploadAttributes_content::getDimensions() const {
    return m_dimensions;
}
void OAIPdfUploadAttributes_content::setDimensions(const OAIPdfDimensionAttributes &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAIPdfUploadAttributes_content::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAIPdfUploadAttributes_content::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

qint32 OAIPdfUploadAttributes_content::getPageCount() const {
    return m_page_count;
}
void OAIPdfUploadAttributes_content::setPageCount(const qint32 &page_count) {
    m_page_count = page_count;
    m_page_count_isSet = true;
}

bool OAIPdfUploadAttributes_content::is_page_count_Set() const{
    return m_page_count_isSet;
}

bool OAIPdfUploadAttributes_content::is_page_count_Valid() const{
    return m_page_count_isValid;
}

bool OAIPdfUploadAttributes_content::isSet() const {
...
bool OAIPdfUploadAttributes_content::isValid() const {
