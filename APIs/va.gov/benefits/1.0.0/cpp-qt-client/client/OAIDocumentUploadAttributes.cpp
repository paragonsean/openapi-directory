...
OAIDocumentUploadAttributes::OAIDocumentUploadAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDocumentUploadAttributes::OAIDocumentUploadAttributes() {
    this->initializeModel();
}

OAIDocumentUploadAttributes::~OAIDocumentUploadAttributes() {}

void OAIDocumentUploadAttributes::initializeModel() {
...
void OAIDocumentUploadAttributes::fromJson(QString jsonString) {
...
void OAIDocumentUploadAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIDocumentUploadAttributes::asJson() const {
...
QJsonObject OAIDocumentUploadAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
    ...
    if (m_uploaded_pdf_isSet) {
        obj.insert(QString("uploaded_pdf"), ::OpenAPI::toJsonValue(m_uploaded_pdf));
    }
    return obj;
}

QString OAIDocumentUploadAttributes::getCode() const {
    return m_code;
}
void OAIDocumentUploadAttributes::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIDocumentUploadAttributes::is_code_Set() const{
    return m_code_isSet;
}

bool OAIDocumentUploadAttributes::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIDocumentUploadAttributes::getDetail() const {
    return m_detail;
}
void OAIDocumentUploadAttributes::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIDocumentUploadAttributes::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIDocumentUploadAttributes::is_detail_Valid() const{
    return m_detail_isValid;
}

QString OAIDocumentUploadAttributes::getGuid() const {
    return m_guid;
}
void OAIDocumentUploadAttributes::setGuid(const QString &guid) {
    m_guid = guid;
    m_guid_isSet = true;
}

bool OAIDocumentUploadAttributes::is_guid_Set() const{
    return m_guid_isSet;
}

bool OAIDocumentUploadAttributes::is_guid_Valid() const{
    return m_guid_isValid;
}

QString OAIDocumentUploadAttributes::getLocation() const {
    return m_location;
}
void OAIDocumentUploadAttributes::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIDocumentUploadAttributes::is_location_Set() const{
    return m_location_isSet;
}

bool OAIDocumentUploadAttributes::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIDocumentUploadAttributes::getStatus() const {
    return m_status;
}
void OAIDocumentUploadAttributes::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDocumentUploadAttributes::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDocumentUploadAttributes::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIDocumentUploadAttributes::getUpdatedAt() const {
    return m_updated_at;
}
void OAIDocumentUploadAttributes::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIDocumentUploadAttributes::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIDocumentUploadAttributes::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QJsonValue OAIDocumentUploadAttributes::getUploadedPdf() const {
    return m_uploaded_pdf;
}
void OAIDocumentUploadAttributes::setUploadedPdf(const QJsonValue &uploaded_pdf) {
    m_uploaded_pdf = uploaded_pdf;
    m_uploaded_pdf_isSet = true;
}

bool OAIDocumentUploadAttributes::is_uploaded_pdf_Set() const{
    return m_uploaded_pdf_isSet;
}

bool OAIDocumentUploadAttributes::is_uploaded_pdf_Valid() const{
    return m_uploaded_pdf_isValid;
}

bool OAIDocumentUploadAttributes::isSet() const {
...
bool OAIDocumentUploadAttributes::isValid() const {
