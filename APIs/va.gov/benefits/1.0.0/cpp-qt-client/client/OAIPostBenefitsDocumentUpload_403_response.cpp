...
#include "OAIPostBenefitsDocumentUpload_403_response.h"
...
OAIPostBenefitsDocumentUpload_403_response::OAIPostBenefitsDocumentUpload_403_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostBenefitsDocumentUpload_403_response::OAIPostBenefitsDocumentUpload_403_response() {
    this->initializeModel();
}

OAIPostBenefitsDocumentUpload_403_response::~OAIPostBenefitsDocumentUpload_403_response() {}

void OAIPostBenefitsDocumentUpload_403_response::initializeModel() {

    m_message_isSet = false;
    m_message_isValid = false;
}

void OAIPostBenefitsDocumentUpload_403_response::fromJson(QString jsonString) {
...
void OAIPostBenefitsDocumentUpload_403_response::fromJsonObject(QJsonObject json) {

    m_message_isValid = ::OpenAPI::fromJsonValue(m_message, json[QString("Message")]);
    m_message_isSet = !json[QString("Message")].isNull() && m_message_isValid;
}

QString OAIPostBenefitsDocumentUpload_403_response::asJson() const {
...
QJsonObject OAIPostBenefitsDocumentUpload_403_response::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIPostBenefitsDocumentUpload_403_response::getMessage() const {
    return m_message;
}
void OAIPostBenefitsDocumentUpload_403_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIPostBenefitsDocumentUpload_403_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAIPostBenefitsDocumentUpload_403_response::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIPostBenefitsDocumentUpload_403_response::isSet() const {
...
bool OAIPostBenefitsDocumentUpload_403_response::isValid() const {
