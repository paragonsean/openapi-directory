...
/*
 * OAIDocumentUploadAttributes.h
 *
 * 
 */

#ifndef OAIDocumentUploadAttributes_H
#define OAIDocumentUploadAttributes_H
...
class OAIDocumentUploadAttributes : public OAIObject {
public:
    OAIDocumentUploadAttributes();
    OAIDocumentUploadAttributes(QString json);
    ~OAIDocumentUploadAttributes() override;
    ...
    QJsonValue getUploadedPdf() const;
    void setUploadedPdf(const QJsonValue &uploaded_pdf);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentUploadAttributes)

#endif // OAIDocumentUploadAttributes_H
