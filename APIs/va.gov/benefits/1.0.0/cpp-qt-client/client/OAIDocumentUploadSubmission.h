...
namespace OpenAPI {
class OAIDocumentUploadSubmissionAttributes;

class OAIDocumentUploadSubmission : public OAIObject {
public:
    OAIDocumentUploadSubmission();
    OAIDocumentUploadSubmission(QString json);
    ~OAIDocumentUploadSubmission() override;
    ...
    OAIDocumentUploadSubmissionAttributes getAttributes() const;
    void setAttributes(const OAIDocumentUploadSubmissionAttributes &attributes);
...
private:
    ...
    OAIDocumentUploadSubmissionAttributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentUploadSubmission)

#endif // OAIDocumentUploadSubmission_H
