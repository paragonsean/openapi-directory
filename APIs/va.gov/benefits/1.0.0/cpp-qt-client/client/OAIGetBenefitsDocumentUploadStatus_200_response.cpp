...
#include "OAIGetBenefitsDocumentUploadStatus_200_response.h"
...
OAIGetBenefitsDocumentUploadStatus_200_response::OAIGetBenefitsDocumentUploadStatus_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetBenefitsDocumentUploadStatus_200_response::OAIGetBenefitsDocumentUploadStatus_200_response() {
    this->initializeModel();
}

OAIGetBenefitsDocumentUploadStatus_200_response::~OAIGetBenefitsDocumentUploadStatus_200_response() {}

void OAIGetBenefitsDocumentUploadStatus_200_response::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIGetBenefitsDocumentUploadStatus_200_response::fromJson(QString jsonString) {
...
void OAIGetBenefitsDocumentUploadStatus_200_response::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIGetBenefitsDocumentUploadStatus_200_response::asJson() const {
...
QJsonObject OAIGetBenefitsDocumentUploadStatus_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIDocumentUploadStatus OAIGetBenefitsDocumentUploadStatus_200_response::getData() const {
    return m_data;
}
void OAIGetBenefitsDocumentUploadStatus_200_response::setData(const OAIDocumentUploadStatus &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetBenefitsDocumentUploadStatus_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetBenefitsDocumentUploadStatus_200_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIGetBenefitsDocumentUploadStatus_200_response::isSet() const {
...
bool OAIGetBenefitsDocumentUploadStatus_200_response::isValid() const {
