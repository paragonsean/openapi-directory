...
/*
 * OAIDocumentUploadStatusGuidList.h
 *
 * 
 */

#ifndef OAIDocumentUploadStatusGuidList_H
#define OAIDocumentUploadStatusGuidList_H
...
class OAIDocumentUploadStatusGuidList : public OAIObject {
public:
    OAIDocumentUploadStatusGuidList();
    OAIDocumentUploadStatusGuidList(QString json);
    ~OAIDocumentUploadStatusGuidList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentUploadStatusGuidList)

#endif // OAIDocumentUploadStatusGuidList_H
