...
/*
 * OAIDocumentUploadPath.h
 *
 * Status record for a previously initiated document submission.
 */

#ifndef OAIDocumentUploadPath_H
#define OAIDocumentUploadPath_H

#include <QJsonObject>

#include "OAIDocumentUploadAttributes.h"
#include <QString>
...
namespace OpenAPI {
class OAIDocumentUploadAttributes;

class OAIDocumentUploadPath : public OAIObject {
public:
    OAIDocumentUploadPath();
    OAIDocumentUploadPath(QString json);
    ~OAIDocumentUploadPath() override;
    ...
    OAIDocumentUploadAttributes getAttributes() const;
    void setAttributes(const OAIDocumentUploadAttributes &attributes);
...
private:
    ...
    OAIDocumentUploadAttributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentUploadPath)

#endif // OAIDocumentUploadPath_H
