...
#include "OAIPutBenefitsDocumentUpload_422_response.h"
...
OAIPutBenefitsDocumentUpload_422_response::OAIPutBenefitsDocumentUpload_422_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutBenefitsDocumentUpload_422_response::OAIPutBenefitsDocumentUpload_422_response() {
    this->initializeModel();
}

OAIPutBenefitsDocumentUpload_422_response::~OAIPutBenefitsDocumentUpload_422_response() {}

void OAIPutBenefitsDocumentUpload_422_response::initializeModel() {

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIPutBenefitsDocumentUpload_422_response::fromJson(QString jsonString) {
...
void OAIPutBenefitsDocumentUpload_422_response::fromJsonObject(QJsonObject json) {

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIPutBenefitsDocumentUpload_422_response::asJson() const {
...
QJsonObject OAIPutBenefitsDocumentUpload_422_response::asJsonObject() const {
    QJsonObject obj;
    if (m_errors.size() > 0) {
...
QList<OAIErrorModel> OAIPutBenefitsDocumentUpload_422_response::getErrors() const {
    return m_errors;
}
void OAIPutBenefitsDocumentUpload_422_response::setErrors(const QList<OAIErrorModel> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIPutBenefitsDocumentUpload_422_response::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIPutBenefitsDocumentUpload_422_response::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIPutBenefitsDocumentUpload_422_response::isSet() const {
...
bool OAIPutBenefitsDocumentUpload_422_response::isValid() const {
