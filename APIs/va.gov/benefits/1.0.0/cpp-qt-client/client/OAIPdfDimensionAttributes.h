...
/*
 * OAIPdfDimensionAttributes.h
 *
 * 
 */

#ifndef OAIPdfDimensionAttributes_H
#define OAIPdfDimensionAttributes_H
...
class OAIPdfDimensionAttributes : public OAIObject {
public:
    OAIPdfDimensionAttributes();
    OAIPdfDimensionAttributes(QString json);
    ~OAIPdfDimensionAttributes() override;
    ...
    bool isOversizedPdf() const;
    void setOversizedPdf(const bool &oversized_pdf);
    bool is_oversized_pdf_Set() const;
    bool is_oversized_pdf_Valid() const;
...
private:
    ...
    bool m_oversized_pdf;
    bool m_oversized_pdf_isSet;
    bool m_oversized_pdf_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPdfDimensionAttributes)

#endif // OAIPdfDimensionAttributes_H
