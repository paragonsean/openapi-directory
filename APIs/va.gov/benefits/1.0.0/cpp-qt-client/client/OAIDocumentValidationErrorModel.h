...
/*
 * OAIDocumentValidationErrorModel.h
 *
 * Error returned from the document validation endpoint.
 */

#ifndef OAIDocumentValidationErrorModel_H
#define OAIDocumentValidationErrorModel_H
...
class OAIDocumentValidationErrorModel : public OAIObject {
public:
    OAIDocumentValidationErrorModel();
    OAIDocumentValidationErrorModel(QString json);
    ~OAIDocumentValidationErrorModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentValidationErrorModel)

#endif // OAIDocumentValidationErrorModel_H
