...
#include "OAIDocumentUploadPath.h"
...
OAIDocumentUploadPath::OAIDocumentUploadPath(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDocumentUploadPath::OAIDocumentUploadPath() {
    this->initializeModel();
}

OAIDocumentUploadPath::~OAIDocumentUploadPath() {}

void OAIDocumentUploadPath::initializeModel() {
...
void OAIDocumentUploadPath::fromJson(QString jsonString) {
...
void OAIDocumentUploadPath::fromJsonObject(QJsonObject json) {
...
QString OAIDocumentUploadPath::asJson() const {
...
QJsonObject OAIDocumentUploadPath::asJsonObject() const {
    QJsonObject obj;
...
OAIDocumentUploadAttributes OAIDocumentUploadPath::getAttributes() const {
    return m_attributes;
}
void OAIDocumentUploadPath::setAttributes(const OAIDocumentUploadAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIDocumentUploadPath::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIDocumentUploadPath::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIDocumentUploadPath::getId() const {
    return m_id;
}
void OAIDocumentUploadPath::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDocumentUploadPath::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDocumentUploadPath::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDocumentUploadPath::getType() const {
    return m_type;
}
void OAIDocumentUploadPath::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDocumentUploadPath::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDocumentUploadPath::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDocumentUploadPath::isSet() const {
...
bool OAIDocumentUploadPath::isValid() const {
