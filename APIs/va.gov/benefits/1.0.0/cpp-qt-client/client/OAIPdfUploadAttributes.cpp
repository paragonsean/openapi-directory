...
OAIPdfUploadAttributes::OAIPdfUploadAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPdfUploadAttributes::OAIPdfUploadAttributes() {
    this->initializeModel();
}

OAIPdfUploadAttributes::~OAIPdfUploadAttributes() {}

void OAIPdfUploadAttributes::initializeModel() {

    m_content_isSet = false;
    m_content_isValid = false;

    m_total_documents_isSet = false;
    m_total_documents_isValid = false;

    m_total_pages_isSet = false;
    m_total_pages_isValid = false;
}

void OAIPdfUploadAttributes::fromJson(QString jsonString) {
...
void OAIPdfUploadAttributes::fromJsonObject(QJsonObject json) {

    m_content_isValid = ::OpenAPI::fromJsonValue(m_content, json[QString("content")]);
    m_content_isSet = !json[QString("content")].isNull() && m_content_isValid;

    m_total_documents_isValid = ::OpenAPI::fromJsonValue(m_total_documents, json[QString("total_documents")]);
    m_total_documents_isSet = !json[QString("total_documents")].isNull() && m_total_documents_isValid;
...
QString OAIPdfUploadAttributes::asJson() const {
...
QJsonObject OAIPdfUploadAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_content.isSet()) {
        obj.insert(QString("content"), ::OpenAPI::toJsonValue(m_content));
    }
    if (m_total_documents_isSet) {
        obj.insert(QString("total_documents"), ::OpenAPI::toJsonValue(m_total_documents));
    }
...
OAIPdfUploadAttributes_content OAIPdfUploadAttributes::getContent() const {
    return m_content;
}
void OAIPdfUploadAttributes::setContent(const OAIPdfUploadAttributes_content &content) {
    m_content = content;
    m_content_isSet = true;
}

bool OAIPdfUploadAttributes::is_content_Set() const{
    return m_content_isSet;
}

bool OAIPdfUploadAttributes::is_content_Valid() const{
    return m_content_isValid;
}

qint32 OAIPdfUploadAttributes::getTotalDocuments() const {
    return m_total_documents;
}
void OAIPdfUploadAttributes::setTotalDocuments(const qint32 &total_documents) {
    m_total_documents = total_documents;
    m_total_documents_isSet = true;
}

bool OAIPdfUploadAttributes::is_total_documents_Set() const{
    return m_total_documents_isSet;
}

bool OAIPdfUploadAttributes::is_total_documents_Valid() const{
    return m_total_documents_isValid;
}

qint32 OAIPdfUploadAttributes::getTotalPages() const {
    return m_total_pages;
}
void OAIPdfUploadAttributes::setTotalPages(const qint32 &total_pages) {
    m_total_pages = total_pages;
    m_total_pages_isSet = true;
}

bool OAIPdfUploadAttributes::is_total_pages_Set() const{
    return m_total_pages_isSet;
}

bool OAIPdfUploadAttributes::is_total_pages_Valid() const{
    return m_total_pages_isValid;
}

bool OAIPdfUploadAttributes::isSet() const {
...
bool OAIPdfUploadAttributes::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_content_isValid && m_total_documents_isValid && m_total_pages_isValid && true;
}
