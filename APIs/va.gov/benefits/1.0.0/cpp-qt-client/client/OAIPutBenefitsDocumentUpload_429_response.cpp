...
#include "OAIPutBenefitsDocumentUpload_429_response.h"
...
OAIPutBenefitsDocumentUpload_429_response::OAIPutBenefitsDocumentUpload_429_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutBenefitsDocumentUpload_429_response::OAIPutBenefitsDocumentUpload_429_response() {
    this->initializeModel();
}

OAIPutBenefitsDocumentUpload_429_response::~OAIPutBenefitsDocumentUpload_429_response() {}

void OAIPutBenefitsDocumentUpload_429_response::initializeModel() {

    m_message_isSet = false;
    m_message_isValid = false;
}

void OAIPutBenefitsDocumentUpload_429_response::fromJson(QString jsonString) {
...
void OAIPutBenefitsDocumentUpload_429_response::fromJsonObject(QJsonObject json) {

    m_message_isValid = ::OpenAPI::fromJsonValue(m_message, json[QString("Message")]);
    m_message_isSet = !json[QString("Message")].isNull() && m_message_isValid;
}

QString OAIPutBenefitsDocumentUpload_429_response::asJson() const {
...
QJsonObject OAIPutBenefitsDocumentUpload_429_response::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIPutBenefitsDocumentUpload_429_response::getMessage() const {
    return m_message;
}
void OAIPutBenefitsDocumentUpload_429_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIPutBenefitsDocumentUpload_429_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAIPutBenefitsDocumentUpload_429_response::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIPutBenefitsDocumentUpload_429_response::isSet() const {
...
bool OAIPutBenefitsDocumentUpload_429_response::isValid() const {
