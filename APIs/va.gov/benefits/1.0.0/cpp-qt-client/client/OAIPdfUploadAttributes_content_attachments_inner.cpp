...
#include "OAIPdfUploadAttributes_content_attachments_inner.h"
...
OAIPdfUploadAttributes_content_attachments_inner::OAIPdfUploadAttributes_content_attachments_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPdfUploadAttributes_content_attachments_inner::OAIPdfUploadAttributes_content_attachments_inner() {
    this->initializeModel();
}

OAIPdfUploadAttributes_content_attachments_inner::~OAIPdfUploadAttributes_content_attachments_inner() {}

void OAIPdfUploadAttributes_content_attachments_inner::initializeModel() {
...
void OAIPdfUploadAttributes_content_attachments_inner::fromJson(QString jsonString) {
...
void OAIPdfUploadAttributes_content_attachments_inner::fromJsonObject(QJsonObject json) {
...
QString OAIPdfUploadAttributes_content_attachments_inner::asJson() const {
...
QJsonObject OAIPdfUploadAttributes_content_attachments_inner::asJsonObject() const {
    QJsonObject obj;
...
OAIPdfDimensionAttributes OAIPdfUploadAttributes_content_attachments_inner::getDimensions() const {
    return m_dimensions;
}
void OAIPdfUploadAttributes_content_attachments_inner::setDimensions(const OAIPdfDimensionAttributes &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAIPdfUploadAttributes_content_attachments_inner::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAIPdfUploadAttributes_content_attachments_inner::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

qint32 OAIPdfUploadAttributes_content_attachments_inner::getPageCount() const {
    return m_page_count;
}
void OAIPdfUploadAttributes_content_attachments_inner::setPageCount(const qint32 &page_count) {
    m_page_count = page_count;
    m_page_count_isSet = true;
}

bool OAIPdfUploadAttributes_content_attachments_inner::is_page_count_Set() const{
    return m_page_count_isSet;
}

bool OAIPdfUploadAttributes_content_attachments_inner::is_page_count_Valid() const{
    return m_page_count_isValid;
}

bool OAIPdfUploadAttributes_content_attachments_inner::isSet() const {
...
bool OAIPdfUploadAttributes_content_attachments_inner::isValid() const {
