...
#include "OAIDocumentUploadFailure.h"
...
OAIDocumentUploadFailure::OAIDocumentUploadFailure(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDocumentUploadFailure::OAIDocumentUploadFailure() {
    this->initializeModel();
}

OAIDocumentUploadFailure::~OAIDocumentUploadFailure() {}

void OAIDocumentUploadFailure::initializeModel() {
...
void OAIDocumentUploadFailure::fromJson(QString jsonString) {
...
void OAIDocumentUploadFailure::fromJsonObject(QJsonObject json) {
...
QString OAIDocumentUploadFailure::asJson() const {
...
QJsonObject OAIDocumentUploadFailure::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIDocumentUploadFailure::getCode() const {
    return m_code;
}
void OAIDocumentUploadFailure::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIDocumentUploadFailure::is_code_Set() const{
    return m_code_isSet;
}

bool OAIDocumentUploadFailure::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIDocumentUploadFailure::getMessage() const {
    return m_message;
}
void OAIDocumentUploadFailure::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIDocumentUploadFailure::is_message_Set() const{
    return m_message_isSet;
}

bool OAIDocumentUploadFailure::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIDocumentUploadFailure::isSet() const {
...
bool OAIDocumentUploadFailure::isValid() const {
