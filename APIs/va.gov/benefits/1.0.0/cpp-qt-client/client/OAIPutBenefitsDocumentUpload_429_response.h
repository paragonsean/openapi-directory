...
/*
 * OAIPutBenefitsDocumentUpload_429_response.h
 *
 * 
 */

#ifndef OAIPutBenefitsDocumentUpload_429_response_H
#define OAIPutBenefitsDocumentUpload_429_response_H
...
class OAIPutBenefitsDocumentUpload_429_response : public OAIObject {
public:
    OAIPutBenefitsDocumentUpload_429_response();
    OAIPutBenefitsDocumentUpload_429_response(QString json);
    ~OAIPutBenefitsDocumentUpload_429_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutBenefitsDocumentUpload_429_response)

#endif // OAIPutBenefitsDocumentUpload_429_response_H
