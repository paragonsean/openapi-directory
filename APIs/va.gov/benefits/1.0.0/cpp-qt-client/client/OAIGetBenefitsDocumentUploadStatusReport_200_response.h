...
/*
 * OAIGetBenefitsDocumentUploadStatusReport_200_response.h
 *
 * 
 */

#ifndef OAIGetBenefitsDocumentUploadStatusReport_200_response_H
#define OAIGetBenefitsDocumentUploadStatusReport_200_response_H
...
namespace OpenAPI {
class OAIDocumentUploadStatus;

class OAIGetBenefitsDocumentUploadStatusReport_200_response : public OAIObject {
public:
    OAIGetBenefitsDocumentUploadStatusReport_200_response();
    OAIGetBenefitsDocumentUploadStatusReport_200_response(QString json);
    ~OAIGetBenefitsDocumentUploadStatusReport_200_response() override;
    ...
    QList<OAIDocumentUploadStatus> getData() const;
    void setData(const QList<OAIDocumentUploadStatus> &data);
...
private:
    ...
    QList<OAIDocumentUploadStatus> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBenefitsDocumentUploadStatusReport_200_response)

#endif // OAIGetBenefitsDocumentUploadStatusReport_200_response_H
