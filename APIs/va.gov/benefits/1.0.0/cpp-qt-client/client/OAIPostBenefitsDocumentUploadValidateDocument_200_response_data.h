...
/*
 * OAIPostBenefitsDocumentUploadValidateDocument_200_response_data.h
 *
 * 
 */

#ifndef OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_H
#define OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_H
...
namespace OpenAPI {
class OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes;

class OAIPostBenefitsDocumentUploadValidateDocument_200_response_data : public OAIObject {
public:
    OAIPostBenefitsDocumentUploadValidateDocument_200_response_data();
    OAIPostBenefitsDocumentUploadValidateDocument_200_response_data(QString json);
    ~OAIPostBenefitsDocumentUploadValidateDocument_200_response_data() override;
    ...
    OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes getAttributes() const;
    void setAttributes(const OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes &attributes);
...
private:
    ...
    OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostBenefitsDocumentUploadValidateDocument_200_response_data)

#endif // OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_H
