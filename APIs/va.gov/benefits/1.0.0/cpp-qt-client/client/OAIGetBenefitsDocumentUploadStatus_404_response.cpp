...
OAIGetBenefitsDocumentUploadStatus_404_response::OAIGetBenefitsDocumentUploadStatus_404_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetBenefitsDocumentUploadStatus_404_response::OAIGetBenefitsDocumentUploadStatus_404_response() {
    this->initializeModel();
}

OAIGetBenefitsDocumentUploadStatus_404_response::~OAIGetBenefitsDocumentUploadStatus_404_response() {}

void OAIGetBenefitsDocumentUploadStatus_404_response::initializeModel() {
...
void OAIGetBenefitsDocumentUploadStatus_404_response::fromJson(QString jsonString) {
...
void OAIGetBenefitsDocumentUploadStatus_404_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetBenefitsDocumentUploadStatus_404_response::asJson() const {
...
QJsonObject OAIGetBenefitsDocumentUploadStatus_404_response::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIGetBenefitsDocumentUploadStatus_404_response::getCode() const {
    return m_code;
}
void OAIGetBenefitsDocumentUploadStatus_404_response::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIGetBenefitsDocumentUploadStatus_404_response::is_code_Set() const{
    return m_code_isSet;
}

bool OAIGetBenefitsDocumentUploadStatus_404_response::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIGetBenefitsDocumentUploadStatus_404_response::getDetail() const {
    return m_detail;
}
void OAIGetBenefitsDocumentUploadStatus_404_response::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIGetBenefitsDocumentUploadStatus_404_response::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIGetBenefitsDocumentUploadStatus_404_response::is_detail_Valid() const{
    return m_detail_isValid;
}

QString OAIGetBenefitsDocumentUploadStatus_404_response::getStatus() const {
    return m_status;
}
void OAIGetBenefitsDocumentUploadStatus_404_response::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetBenefitsDocumentUploadStatus_404_response::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetBenefitsDocumentUploadStatus_404_response::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIGetBenefitsDocumentUploadStatus_404_response::getTitle() const {
    return m_title;
}
void OAIGetBenefitsDocumentUploadStatus_404_response::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIGetBenefitsDocumentUploadStatus_404_response::is_title_Set() const{
    return m_title_isSet;
}

bool OAIGetBenefitsDocumentUploadStatus_404_response::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIGetBenefitsDocumentUploadStatus_404_response::isSet() const {
...
bool OAIGetBenefitsDocumentUploadStatus_404_response::isValid() const {
