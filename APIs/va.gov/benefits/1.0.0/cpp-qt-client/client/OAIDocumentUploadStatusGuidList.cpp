...
#include "OAIDocumentUploadStatusGuidList.h"
...
OAIDocumentUploadStatusGuidList::OAIDocumentUploadStatusGuidList(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDocumentUploadStatusGuidList::OAIDocumentUploadStatusGuidList() {
    this->initializeModel();
}

OAIDocumentUploadStatusGuidList::~OAIDocumentUploadStatusGuidList() {}

void OAIDocumentUploadStatusGuidList::initializeModel() {

    m_ids_isSet = false;
    m_ids_isValid = false;
}

void OAIDocumentUploadStatusGuidList::fromJson(QString jsonString) {
...
void OAIDocumentUploadStatusGuidList::fromJsonObject(QJsonObject json) {

    m_ids_isValid = ::OpenAPI::fromJsonValue(m_ids, json[QString("ids")]);
    m_ids_isSet = !json[QString("ids")].isNull() && m_ids_isValid;
}

QString OAIDocumentUploadStatusGuidList::asJson() const {
...
QJsonObject OAIDocumentUploadStatusGuidList::asJsonObject() const {
    QJsonObject obj;
    if (m_ids.size() > 0) {
...
QList<QString> OAIDocumentUploadStatusGuidList::getIds() const {
    return m_ids;
}
void OAIDocumentUploadStatusGuidList::setIds(const QList<QString> &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}

bool OAIDocumentUploadStatusGuidList::is_ids_Set() const{
    return m_ids_isSet;
}

bool OAIDocumentUploadStatusGuidList::is_ids_Valid() const{
    return m_ids_isValid;
}

bool OAIDocumentUploadStatusGuidList::isSet() const {
...
bool OAIDocumentUploadStatusGuidList::isValid() const {
