...
/*
 * OAIPdfUploadAttributes.h
 *
 * 
 */

#ifndef OAIPdfUploadAttributes_H
#define OAIPdfUploadAttributes_H

#include <QJsonObject>

#include "OAIPdfUploadAttributes_content.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPdfUploadAttributes_content;

class OAIPdfUploadAttributes : public OAIObject {
public:
    OAIPdfUploadAttributes();
    OAIPdfUploadAttributes(QString json);
    ~OAIPdfUploadAttributes() override;
    ...
    OAIPdfUploadAttributes_content getContent() const;
    void setContent(const OAIPdfUploadAttributes_content &content);
    bool is_content_Set() const;
    bool is_content_Valid() const;

    qint32 getTotalDocuments() const;
    void setTotalDocuments(const qint32 &total_documents);
    bool is_total_documents_Set() const;
    bool is_total_documents_Valid() const;
...
private:
    ...
    OAIPdfUploadAttributes_content m_content;
    bool m_content_isSet;
    bool m_content_isValid;

    qint32 m_total_documents;
    bool m_total_documents_isSet;
    bool m_total_documents_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPdfUploadAttributes)

#endif // OAIPdfUploadAttributes_H
