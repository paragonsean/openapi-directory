...
OAIPdfDimensionAttributes::OAIPdfDimensionAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPdfDimensionAttributes::OAIPdfDimensionAttributes() {
    this->initializeModel();
}

OAIPdfDimensionAttributes::~OAIPdfDimensionAttributes() {}

void OAIPdfDimensionAttributes::initializeModel() {

    m_height_isSet = false;
    m_height_isValid = false;

    m_oversized_pdf_isSet = false;
    m_oversized_pdf_isValid = false;

    m_width_isSet = false;
    m_width_isValid = false;
}

void OAIPdfDimensionAttributes::fromJson(QString jsonString) {
...
void OAIPdfDimensionAttributes::fromJsonObject(QJsonObject json) {

    m_height_isValid = ::OpenAPI::fromJsonValue(m_height, json[QString("height")]);
    m_height_isSet = !json[QString("height")].isNull() && m_height_isValid;

    m_oversized_pdf_isValid = ::OpenAPI::fromJsonValue(m_oversized_pdf, json[QString("oversized_pdf")]);
    m_oversized_pdf_isSet = !json[QString("oversized_pdf")].isNull() && m_oversized_pdf_isValid;

    m_width_isValid = ::OpenAPI::fromJsonValue(m_width, json[QString("width")]);
    m_width_isSet = !json[QString("width")].isNull() && m_width_isValid;
}

QString OAIPdfDimensionAttributes::asJson() const {
...
QJsonObject OAIPdfDimensionAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_height_isSet) {
        obj.insert(QString("height"), ::OpenAPI::toJsonValue(m_height));
    }
    if (m_oversized_pdf_isSet) {
        obj.insert(QString("oversized_pdf"), ::OpenAPI::toJsonValue(m_oversized_pdf));
    }
    if (m_width_isSet) {
...
qint32 OAIPdfDimensionAttributes::getHeight() const {
    return m_height;
}
void OAIPdfDimensionAttributes::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIPdfDimensionAttributes::is_height_Set() const{
    return m_height_isSet;
}

bool OAIPdfDimensionAttributes::is_height_Valid() const{
    return m_height_isValid;
}

bool OAIPdfDimensionAttributes::isOversizedPdf() const {
    return m_oversized_pdf;
}
void OAIPdfDimensionAttributes::setOversizedPdf(const bool &oversized_pdf) {
    m_oversized_pdf = oversized_pdf;
    m_oversized_pdf_isSet = true;
}

bool OAIPdfDimensionAttributes::is_oversized_pdf_Set() const{
    return m_oversized_pdf_isSet;
}

bool OAIPdfDimensionAttributes::is_oversized_pdf_Valid() const{
    return m_oversized_pdf_isValid;
}

qint32 OAIPdfDimensionAttributes::getWidth() const {
    return m_width;
}
void OAIPdfDimensionAttributes::setWidth(const qint32 &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIPdfDimensionAttributes::is_width_Set() const{
    return m_width_isSet;
}

bool OAIPdfDimensionAttributes::is_width_Valid() const{
    return m_width_isValid;
}

bool OAIPdfDimensionAttributes::isSet() const {
...
bool OAIPdfDimensionAttributes::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_height_isValid && m_oversized_pdf_isValid && m_width_isValid && true;
}
