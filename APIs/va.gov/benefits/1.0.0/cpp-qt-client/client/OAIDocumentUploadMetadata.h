...
/*
 * OAIDocumentUploadMetadata.h
 *
 * Identifying properties about the document payload being submitted
 */

#ifndef OAIDocumentUploadMetadata_H
#define OAIDocumentUploadMetadata_H
...
class OAIDocumentUploadMetadata : public OAIObject {
public:
    OAIDocumentUploadMetadata();
    OAIDocumentUploadMetadata(QString json);
    ~OAIDocumentUploadMetadata() override;
    ...
    QString getBusinessLine() const;
    void setBusinessLine(const QString &business_line);
    bool is_business_line_Set() const;
    bool is_business_line_Valid() const;
    ...
    QString getFileNumber() const;
    void setFileNumber(const QString &file_number);
    ...
    QString getVeteranFirstName() const;
    void setVeteranFirstName(const QString &veteran_first_name);
    bool is_veteran_first_name_Set() const;
    bool is_veteran_first_name_Valid() const;

    QString getVeteranLastName() const;
    void setVeteranLastName(const QString &veteran_last_name);
    bool is_veteran_last_name_Set() const;
    bool is_veteran_last_name_Valid() const;
...
private:
    ...
    QString m_business_line;
    bool m_business_line_isSet;
    bool m_business_line_isValid;

    QString m_doc_type;
    bool m_doc_type_isSet;
    bool m_doc_type_isValid;

    QString m_file_number;
    ...
    QString m_veteran_first_name;
    bool m_veteran_first_name_isSet;
    bool m_veteran_first_name_isValid;

    QString m_veteran_last_name;
    bool m_veteran_last_name_isSet;
    bool m_veteran_last_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentUploadMetadata)

#endif // OAIDocumentUploadMetadata_H
