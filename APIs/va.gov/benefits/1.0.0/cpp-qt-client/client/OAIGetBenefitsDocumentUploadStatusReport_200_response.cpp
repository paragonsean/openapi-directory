...
#include "OAIGetBenefitsDocumentUploadStatusReport_200_response.h"
...
OAIGetBenefitsDocumentUploadStatusReport_200_response::OAIGetBenefitsDocumentUploadStatusReport_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetBenefitsDocumentUploadStatusReport_200_response::OAIGetBenefitsDocumentUploadStatusReport_200_response() {
    this->initializeModel();
}

OAIGetBenefitsDocumentUploadStatusReport_200_response::~OAIGetBenefitsDocumentUploadStatusReport_200_response() {}

void OAIGetBenefitsDocumentUploadStatusReport_200_response::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIGetBenefitsDocumentUploadStatusReport_200_response::fromJson(QString jsonString) {
...
void OAIGetBenefitsDocumentUploadStatusReport_200_response::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIGetBenefitsDocumentUploadStatusReport_200_response::asJson() const {
...
QJsonObject OAIGetBenefitsDocumentUploadStatusReport_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIDocumentUploadStatus> OAIGetBenefitsDocumentUploadStatusReport_200_response::getData() const {
    return m_data;
}
void OAIGetBenefitsDocumentUploadStatusReport_200_response::setData(const QList<OAIDocumentUploadStatus> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetBenefitsDocumentUploadStatusReport_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetBenefitsDocumentUploadStatusReport_200_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIGetBenefitsDocumentUploadStatusReport_200_response::isSet() const {
...
bool OAIGetBenefitsDocumentUploadStatusReport_200_response::isValid() const {
