...
/*
 * OAIPostBenefitsDocumentUpload_202_response.h
 *
 * 
 */

#ifndef OAIPostBenefitsDocumentUpload_202_response_H
#define OAIPostBenefitsDocumentUpload_202_response_H
...
namespace OpenAPI {
class OAIDocumentUploadPath;

class OAIPostBenefitsDocumentUpload_202_response : public OAIObject {
public:
    OAIPostBenefitsDocumentUpload_202_response();
    OAIPostBenefitsDocumentUpload_202_response(QString json);
    ~OAIPostBenefitsDocumentUpload_202_response() override;
    ...
    OAIDocumentUploadPath getData() const;
    void setData(const OAIDocumentUploadPath &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostBenefitsDocumentUpload_202_response)

#endif // OAIPostBenefitsDocumentUpload_202_response_H
