...
/*
 * OAIDocumentUploadFailure.h
 *
 * Document upload failed
 */

#ifndef OAIDocumentUploadFailure_H
#define OAIDocumentUploadFailure_H
...
class OAIDocumentUploadFailure : public OAIObject {
public:
    OAIDocumentUploadFailure();
    OAIDocumentUploadFailure(QString json);
    ~OAIDocumentUploadFailure() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentUploadFailure)

#endif // OAIDocumentUploadFailure_H
