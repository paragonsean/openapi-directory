...
/*
 * OAIPdfUploadAttributes_content_attachments_inner.h
 *
 * 
 */

#ifndef OAIPdfUploadAttributes_content_attachments_inner_H
#define OAIPdfUploadAttributes_content_attachments_inner_H

#include <QJsonObject>

#include "OAIPdfDimensionAttributes.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPdfDimensionAttributes;

class OAIPdfUploadAttributes_content_attachments_inner : public OAIObject {
public:
    OAIPdfUploadAttributes_content_attachments_inner();
    OAIPdfUploadAttributes_content_attachments_inner(QString json);
    ~OAIPdfUploadAttributes_content_attachments_inner() override;
    ...
    OAIPdfDimensionAttributes getDimensions() const;
    void setDimensions(const OAIPdfDimensionAttributes &dimensions);
...
private:
    ...
    OAIPdfDimensionAttributes m_dimensions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPdfUploadAttributes_content_attachments_inner)

#endif // OAIPdfUploadAttributes_content_attachments_inner_H
