...
#include "OAIPostBenefitsDocumentUploadValidateDocument_200_response_data.h"
...
OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::OAIPostBenefitsDocumentUploadValidateDocument_200_response_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::OAIPostBenefitsDocumentUploadValidateDocument_200_response_data() {
    this->initializeModel();
}

OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::~OAIPostBenefitsDocumentUploadValidateDocument_200_response_data() {}

void OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::initializeModel() {
...
void OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::fromJson(QString jsonString) {
...
void OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::fromJsonObject(QJsonObject json) {
...
QString OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::asJson() const {
...
QJsonObject OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::asJsonObject() const {
    QJsonObject obj;
...
OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::getAttributes() const {
    return m_attributes;
}
void OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::setAttributes(const OAIPostBenefitsDocumentUploadValidateDocument_200_response_data_attributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::getType() const {
    return m_type;
}
void OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::isSet() const {
...
bool OAIPostBenefitsDocumentUploadValidateDocument_200_response_data::isValid() const {
