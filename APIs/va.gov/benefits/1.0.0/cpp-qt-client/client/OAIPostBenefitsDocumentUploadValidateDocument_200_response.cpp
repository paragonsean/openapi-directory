...
#include "OAIPostBenefitsDocumentUploadValidateDocument_200_response.h"
...
OAIPostBenefitsDocumentUploadValidateDocument_200_response::OAIPostBenefitsDocumentUploadValidateDocument_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostBenefitsDocumentUploadValidateDocument_200_response::OAIPostBenefitsDocumentUploadValidateDocument_200_response() {
    this->initializeModel();
}

OAIPostBenefitsDocumentUploadValidateDocument_200_response::~OAIPostBenefitsDocumentUploadValidateDocument_200_response() {}

void OAIPostBenefitsDocumentUploadValidateDocument_200_response::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIPostBenefitsDocumentUploadValidateDocument_200_response::fromJson(QString jsonString) {
...
void OAIPostBenefitsDocumentUploadValidateDocument_200_response::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIPostBenefitsDocumentUploadValidateDocument_200_response::asJson() const {
...
QJsonObject OAIPostBenefitsDocumentUploadValidateDocument_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIPostBenefitsDocumentUploadValidateDocument_200_response_data OAIPostBenefitsDocumentUploadValidateDocument_200_response::getData() const {
    return m_data;
}
void OAIPostBenefitsDocumentUploadValidateDocument_200_response::setData(const OAIPostBenefitsDocumentUploadValidateDocument_200_response_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIPostBenefitsDocumentUploadValidateDocument_200_response::isSet() const {
...
bool OAIPostBenefitsDocumentUploadValidateDocument_200_response::isValid() const {
