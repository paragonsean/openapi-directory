...
/*
 * OAIPostBenefitsDocumentUpload_403_response.h
 *
 * 
 */

#ifndef OAIPostBenefitsDocumentUpload_403_response_H
#define OAIPostBenefitsDocumentUpload_403_response_H
...
class OAIPostBenefitsDocumentUpload_403_response : public OAIObject {
public:
    OAIPostBenefitsDocumentUpload_403_response();
    OAIPostBenefitsDocumentUpload_403_response(QString json);
    ~OAIPostBenefitsDocumentUpload_403_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostBenefitsDocumentUpload_403_response)

#endif // OAIPostBenefitsDocumentUpload_403_response_H
