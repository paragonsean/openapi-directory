...
Benefits Intake
- API version: 1.0.0
  - Build date: 2024-10-12T12:31:24.906659-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*VbaDocumentsApi* | [**getBenefitsDocumentUploadDownload**](docs/VbaDocumentsApi.md#getBenefitsDocumentUploadDownload) | **GET** /uploads/{id}/download | Download zip of \&quot;what the server sees\&quot;
*VbaDocumentsApi* | [**getBenefitsDocumentUploadStatus**](docs/VbaDocumentsApi.md#getBenefitsDocumentUploadStatus) | **GET** /uploads/{id} | Get status for a previous benefits document upload
*VbaDocumentsApi* | [**getBenefitsDocumentUploadStatusReport**](docs/VbaDocumentsApi.md#getBenefitsDocumentUploadStatusReport) | **POST** /uploads/report | Get a bulk status report for a list of previous uploads
*VbaDocumentsApi* | [**postBenefitsDocumentUpload**](docs/VbaDocumentsApi.md#postBenefitsDocumentUpload) | **POST** /uploads | Get a location for subsequent document upload PUT request
*VbaDocumentsApi* | [**postBenefitsDocumentUploadValidateDocument**](docs/VbaDocumentsApi.md#postBenefitsDocumentUploadValidateDocument) | **POST** /uploads/validate_document | Validate an individual document against system file requirements
*VbaDocumentsApi* | [**putBenefitsDocumentUpload**](docs/VbaDocumentsApi.md#putBenefitsDocumentUpload) | **PUT** /path | Accepts document upload.


## Documentation for Models

 - [DocumentUploadAttributes](docs/DocumentUploadAttributes.md)
 - [DocumentUploadFailure](docs/DocumentUploadFailure.md)
 - [DocumentUploadMetadata](docs/DocumentUploadMetadata.md)
 - [DocumentUploadPath](docs/DocumentUploadPath.md)
 - [DocumentUploadStatus](docs/DocumentUploadStatus.md)
 - [DocumentUploadStatusAttributes](docs/DocumentUploadStatusAttributes.md)
 - [DocumentUploadStatusGuidList](docs/DocumentUploadStatusGuidList.md)
 - [DocumentUploadSubmission](docs/DocumentUploadSubmission.md)
 - [DocumentUploadSubmissionAttributes](docs/DocumentUploadSubmissionAttributes.md)
 - [DocumentValidationErrorModel](docs/DocumentValidationErrorModel.md)
 - [ErrorModel](docs/ErrorModel.md)
 - [GetBenefitsDocumentUploadStatus200Response](docs/GetBenefitsDocumentUploadStatus200Response.md)
 - [GetBenefitsDocumentUploadStatus404Response](docs/GetBenefitsDocumentUploadStatus404Response.md)
 - [GetBenefitsDocumentUploadStatusReport200Response](docs/GetBenefitsDocumentUploadStatusReport200Response.md)
 - [PdfDimensionAttributes](docs/PdfDimensionAttributes.md)
 - [PdfUploadAttributes](docs/PdfUploadAttributes.md)
 - [PdfUploadAttributesContent](docs/PdfUploadAttributesContent.md)
 - [PdfUploadAttributesContentAttachmentsInner](docs/PdfUploadAttributesContentAttachmentsInner.md)
 - [PostBenefitsDocumentUpload202Response](docs/PostBenefitsDocumentUpload202Response.md)
 - [PostBenefitsDocumentUpload403Response](docs/PostBenefitsDocumentUpload403Response.md)
 - [PostBenefitsDocumentUploadValidateDocument200Response](docs/PostBenefitsDocumentUploadValidateDocument200Response.md)
 - [PostBenefitsDocumentUploadValidateDocument200ResponseData](docs/PostBenefitsDocumentUploadValidateDocument200ResponseData.md)
 - [PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes](docs/PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.md)
 - [PostBenefitsDocumentUploadValidateDocument422Response](docs/PostBenefitsDocumentUploadValidateDocument422Response.md)
 - [PutBenefitsDocumentUpload401Response](docs/PutBenefitsDocumentUpload401Response.md)
 - [PutBenefitsDocumentUpload422Response](docs/PutBenefitsDocumentUpload422Response.md)
 - [PutBenefitsDocumentUpload429Response](docs/PutBenefitsDocumentUpload429Response.md)
 - [PutBenefitsDocumentUpload500Response](docs/PutBenefitsDocumentUpload500Response.md)
