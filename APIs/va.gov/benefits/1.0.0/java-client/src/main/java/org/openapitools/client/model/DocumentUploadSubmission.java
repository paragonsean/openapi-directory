...
public class DocumentUploadSubmission {
  ...
  private DocumentUploadSubmissionAttributes attributes;
  ...
  public DocumentUploadSubmission() {
  }

  public DocumentUploadSubmission attributes(DocumentUploadSubmissionAttributes attributes) {
  ...
  public DocumentUploadSubmissionAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(DocumentUploadSubmissionAttributes attributes) {
    this.attributes = attributes;
  }


  public DocumentUploadSubmission id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public DocumentUploadSubmission type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DocumentUploadSubmission documentUploadSubmission = (DocumentUploadSubmission) o;
    return Objects.equals(this.attributes, documentUploadSubmission.attributes) &&
        Objects.equals(this.id, documentUploadSubmission.id) &&
        Objects.equals(this.type, documentUploadSubmission.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentUploadSubmission {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentUploadSubmission
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentUploadSubmission.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentUploadSubmission is not found in the empty JSON string", DocumentUploadSubmission.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentUploadSubmission.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentUploadSubmission` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentUploadSubmission.openapiRequiredFields) {
      ...
      DocumentUploadSubmissionAttributes.validateJsonElement(jsonObj.get("attributes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentUploadSubmission.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentUploadSubmission' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentUploadSubmission> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentUploadSubmission.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentUploadSubmission>() {
           @Override
           public void write(JsonWriter out, DocumentUploadSubmission value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentUploadSubmission read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentUploadSubmission given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentUploadSubmission
   * @throws IOException if the JSON string is invalid with respect to DocumentUploadSubmission
   */
  public static DocumentUploadSubmission fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentUploadSubmission.class);
  }

  /**
   * Convert an instance of DocumentUploadSubmission to an JSON string
   *
   * @return JSON string
   */
