...
import org.openapitools.client.model.DocumentUploadStatus;
...
public class GetBenefitsDocumentUploadStatus200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private DocumentUploadStatus data;

  public GetBenefitsDocumentUploadStatus200Response() {
  }

  public GetBenefitsDocumentUploadStatus200Response data(DocumentUploadStatus data) {
    this.data = data;
    return this;
  }
  ...
  public DocumentUploadStatus getData() {
    return data;
  }

  public void setData(DocumentUploadStatus data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetBenefitsDocumentUploadStatus200Response getBenefitsDocumentUploadStatus200Response = (GetBenefitsDocumentUploadStatus200Response) o;
    return Objects.equals(this.data, getBenefitsDocumentUploadStatus200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBenefitsDocumentUploadStatus200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBenefitsDocumentUploadStatus200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBenefitsDocumentUploadStatus200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBenefitsDocumentUploadStatus200Response is not found in the empty JSON string", GetBenefitsDocumentUploadStatus200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBenefitsDocumentUploadStatus200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBenefitsDocumentUploadStatus200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetBenefitsDocumentUploadStatus200Response.openapiRequiredFields) {
      ...
      DocumentUploadStatus.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBenefitsDocumentUploadStatus200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBenefitsDocumentUploadStatus200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBenefitsDocumentUploadStatus200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBenefitsDocumentUploadStatus200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBenefitsDocumentUploadStatus200Response>() {
           @Override
           public void write(JsonWriter out, GetBenefitsDocumentUploadStatus200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBenefitsDocumentUploadStatus200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBenefitsDocumentUploadStatus200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBenefitsDocumentUploadStatus200Response
   * @throws IOException if the JSON string is invalid with respect to GetBenefitsDocumentUploadStatus200Response
   */
  public static GetBenefitsDocumentUploadStatus200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBenefitsDocumentUploadStatus200Response.class);
  }

  /**
   * Convert an instance of GetBenefitsDocumentUploadStatus200Response to an JSON string
   *
   * @return JSON string
   */
