...
import org.openapitools.client.model.DocumentUploadPath;
...
public class PostBenefitsDocumentUpload202Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private DocumentUploadPath data;

  public PostBenefitsDocumentUpload202Response() {
  }

  public PostBenefitsDocumentUpload202Response data(DocumentUploadPath data) {
    this.data = data;
    return this;
  }
  ...
  public DocumentUploadPath getData() {
    return data;
  }

  public void setData(DocumentUploadPath data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostBenefitsDocumentUpload202Response postBenefitsDocumentUpload202Response = (PostBenefitsDocumentUpload202Response) o;
    return Objects.equals(this.data, postBenefitsDocumentUpload202Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostBenefitsDocumentUpload202Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostBenefitsDocumentUpload202Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostBenefitsDocumentUpload202Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostBenefitsDocumentUpload202Response is not found in the empty JSON string", PostBenefitsDocumentUpload202Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostBenefitsDocumentUpload202Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostBenefitsDocumentUpload202Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostBenefitsDocumentUpload202Response.openapiRequiredFields) {
      ...
      DocumentUploadPath.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostBenefitsDocumentUpload202Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostBenefitsDocumentUpload202Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostBenefitsDocumentUpload202Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostBenefitsDocumentUpload202Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PostBenefitsDocumentUpload202Response>() {
           @Override
           public void write(JsonWriter out, PostBenefitsDocumentUpload202Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostBenefitsDocumentUpload202Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostBenefitsDocumentUpload202Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostBenefitsDocumentUpload202Response
   * @throws IOException if the JSON string is invalid with respect to PostBenefitsDocumentUpload202Response
   */
  public static PostBenefitsDocumentUpload202Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostBenefitsDocumentUpload202Response.class);
  }

  /**
   * Convert an instance of PostBenefitsDocumentUpload202Response to an JSON string
   *
   * @return JSON string
   */
