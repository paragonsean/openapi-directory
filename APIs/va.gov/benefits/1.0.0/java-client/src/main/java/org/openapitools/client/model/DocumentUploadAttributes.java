...
public class DocumentUploadAttributes {
  ...
  private Object uploadedPdf = null;

  public DocumentUploadAttributes() {
  }

  public DocumentUploadAttributes code(String code) {
    this.code = code;
    return this;
  }
  ...
  public DocumentUploadAttributes detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public DocumentUploadAttributes guid(UUID guid) {
    this.guid = guid;
    return this;
  }
  ...
  public DocumentUploadAttributes location(URI location) {
  ...
  public DocumentUploadAttributes status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DocumentUploadAttributes updatedAt(OffsetDateTime updatedAt) {
  ...
  public DocumentUploadAttributes uploadedPdf(Object uploadedPdf) {
   ...
   */
  @javax.annotation.Nullable
  public Object getUploadedPdf() {
    return uploadedPdf;
  }

  public void setUploadedPdf(Object uploadedPdf) {
    this.uploadedPdf = uploadedPdf;
  }
  ...
  public boolean equals(Object o) {
    ...
    DocumentUploadAttributes documentUploadAttributes = (DocumentUploadAttributes) o;
    return Objects.equals(this.code, documentUploadAttributes.code) &&
        Objects.equals(this.detail, documentUploadAttributes.detail) &&
        Objects.equals(this.guid, documentUploadAttributes.guid) &&
        Objects.equals(this.location, documentUploadAttributes.location) &&
        Objects.equals(this.status, documentUploadAttributes.status) &&
        Objects.equals(this.updatedAt, documentUploadAttributes.updatedAt) &&
        Objects.equals(this.uploadedPdf, documentUploadAttributes.uploadedPdf);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, detail, guid, location, status, updatedAt, uploadedPdf);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentUploadAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentUploadAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentUploadAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentUploadAttributes is not found in the empty JSON string", DocumentUploadAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentUploadAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentUploadAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentUploadAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentUploadAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentUploadAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentUploadAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentUploadAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentUploadAttributes>() {
           @Override
           public void write(JsonWriter out, DocumentUploadAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentUploadAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentUploadAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentUploadAttributes
   * @throws IOException if the JSON string is invalid with respect to DocumentUploadAttributes
   */
  public static DocumentUploadAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentUploadAttributes.class);
  }

  /**
   * Convert an instance of DocumentUploadAttributes to an JSON string
   *
   * @return JSON string
   */
