...
public class PdfDimensionAttributes {
  ...
  public static final String SERIALIZED_NAME_OVERSIZED_PDF = "oversized_pdf";
  @SerializedName(SERIALIZED_NAME_OVERSIZED_PDF)
  private Boolean oversizedPdf;

  public static final String SERIALIZED_NAME_WIDTH = "width";
  @SerializedName(SERIALIZED_NAME_WIDTH)
  private Integer width;

  public PdfDimensionAttributes() {
  }

  public PdfDimensionAttributes height(Integer height) {
    this.height = height;
    return this;
  }
  ...
  public PdfDimensionAttributes oversizedPdf(Boolean oversizedPdf) {
   ...
   */
  @javax.annotation.Nonnull
  public Boolean getOversizedPdf() {
    return oversizedPdf;
  }

  public void setOversizedPdf(Boolean oversizedPdf) {
    this.oversizedPdf = oversizedPdf;
  }


  public PdfDimensionAttributes width(Integer width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PdfDimensionAttributes pdfDimensionAttributes = (PdfDimensionAttributes) o;
    return Objects.equals(this.height, pdfDimensionAttributes.height) &&
        Objects.equals(this.oversizedPdf, pdfDimensionAttributes.oversizedPdf) &&
        Objects.equals(this.width, pdfDimensionAttributes.width);
  }

  @Override
  public int hashCode() {
    return Objects.hash(height, oversizedPdf, width);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PdfDimensionAttributes {\n");
    sb.append("    height: ").append(toIndentedString(height)).append("\n");
    sb.append("    oversizedPdf: ").append(toIndentedString(oversizedPdf)).append("\n");
  ...
  static {
    ...
    openapiFields.add("oversized_pdf");
    openapiFields.add("width");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("height");
    openapiRequiredFields.add("oversized_pdf");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PdfDimensionAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PdfDimensionAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PdfDimensionAttributes is not found in the empty JSON string", PdfDimensionAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PdfDimensionAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PdfDimensionAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PdfDimensionAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PdfDimensionAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PdfDimensionAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PdfDimensionAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PdfDimensionAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<PdfDimensionAttributes>() {
           @Override
           public void write(JsonWriter out, PdfDimensionAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PdfDimensionAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PdfDimensionAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PdfDimensionAttributes
   * @throws IOException if the JSON string is invalid with respect to PdfDimensionAttributes
   */
  public static PdfDimensionAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PdfDimensionAttributes.class);
  }

  /**
   * Convert an instance of PdfDimensionAttributes to an JSON string
   *
   * @return JSON string
   */
