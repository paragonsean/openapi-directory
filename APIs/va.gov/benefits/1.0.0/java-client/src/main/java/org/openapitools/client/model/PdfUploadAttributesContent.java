...
import org.openapitools.client.model.PdfUploadAttributesContentAttachmentsInner;
...
public class PdfUploadAttributesContent {
  ...
  private List<PdfUploadAttributesContentAttachmentsInner> attachments = new ArrayList<>();
  ...
  public PdfUploadAttributesContent attachments(List<PdfUploadAttributesContentAttachmentsInner> attachments) {
    this.attachments = attachments;
    return this;
  }

  public PdfUploadAttributesContent addAttachmentsItem(PdfUploadAttributesContentAttachmentsInner attachmentsItem) {
  ...
  public List<PdfUploadAttributesContentAttachmentsInner> getAttachments() {
    return attachments;
  }

  public void setAttachments(List<PdfUploadAttributesContentAttachmentsInner> attachments) {
    this.attachments = attachments;
  }


  public PdfUploadAttributesContent dimensions(PdfDimensionAttributes dimensions) {
  ...
  public PdfUploadAttributesContent pageCount(Integer pageCount) {
  ...
  public boolean equals(Object o) {
    ...
    PdfUploadAttributesContent pdfUploadAttributesContent = (PdfUploadAttributesContent) o;
    return Objects.equals(this.attachments, pdfUploadAttributesContent.attachments) &&
        Objects.equals(this.dimensions, pdfUploadAttributesContent.dimensions) &&
        Objects.equals(this.pageCount, pdfUploadAttributesContent.pageCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attachments, dimensions, pageCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PdfUploadAttributesContent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PdfUploadAttributesContent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PdfUploadAttributesContent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PdfUploadAttributesContent is not found in the empty JSON string", PdfUploadAttributesContent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PdfUploadAttributesContent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PdfUploadAttributesContent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("attachments") != null && !jsonObj.get("attachments").isJsonNull()) {
        ...
        if (jsonArrayattachments != null) {
          ...
          for (int i = 0; i < jsonArrayattachments.size(); i++) {
            PdfUploadAttributesContentAttachmentsInner.validateJsonElement(jsonArrayattachments.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PdfUploadAttributesContent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PdfUploadAttributesContent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PdfUploadAttributesContent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PdfUploadAttributesContent.class));

       return (TypeAdapter<T>) new TypeAdapter<PdfUploadAttributesContent>() {
           @Override
           public void write(JsonWriter out, PdfUploadAttributesContent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PdfUploadAttributesContent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PdfUploadAttributesContent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PdfUploadAttributesContent
   * @throws IOException if the JSON string is invalid with respect to PdfUploadAttributesContent
   */
  public static PdfUploadAttributesContent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PdfUploadAttributesContent.class);
  }

  /**
   * Convert an instance of PdfUploadAttributesContent to an JSON string
   *
   * @return JSON string
   */
