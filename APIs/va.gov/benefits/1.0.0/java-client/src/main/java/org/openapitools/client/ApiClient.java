...
public class ApiClient {
    ...
    private String basePath = "https://sandbox-api.va.gov/services/vba_documents/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sandbox-api.va.gov/services/vba_documents/v1
