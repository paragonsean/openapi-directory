...
public class DocumentUploadSubmissionAttributes {
  ...
  public DocumentUploadSubmissionAttributes() {
  }

  public DocumentUploadSubmissionAttributes code(String code) {
    this.code = code;
    return this;
  }
  ...
  public DocumentUploadSubmissionAttributes detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public DocumentUploadSubmissionAttributes guid(UUID guid) {
    this.guid = guid;
    return this;
  }
  ...
  public DocumentUploadSubmissionAttributes message(String message) {
  ...
  public DocumentUploadSubmissionAttributes status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DocumentUploadSubmissionAttributes updatedAt(OffsetDateTime updatedAt) {
  ...
  public DocumentUploadSubmissionAttributes uploadedPdf(PdfUploadAttributes uploadedPdf) {
  ...
  public boolean equals(Object o) {
    ...
    DocumentUploadSubmissionAttributes documentUploadSubmissionAttributes = (DocumentUploadSubmissionAttributes) o;
    return Objects.equals(this.code, documentUploadSubmissionAttributes.code) &&
        Objects.equals(this.detail, documentUploadSubmissionAttributes.detail) &&
        Objects.equals(this.guid, documentUploadSubmissionAttributes.guid) &&
        Objects.equals(this.message, documentUploadSubmissionAttributes.message) &&
        Objects.equals(this.status, documentUploadSubmissionAttributes.status) &&
        Objects.equals(this.updatedAt, documentUploadSubmissionAttributes.updatedAt) &&
        Objects.equals(this.uploadedPdf, documentUploadSubmissionAttributes.uploadedPdf);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentUploadSubmissionAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentUploadSubmissionAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentUploadSubmissionAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentUploadSubmissionAttributes is not found in the empty JSON string", DocumentUploadSubmissionAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentUploadSubmissionAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentUploadSubmissionAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentUploadSubmissionAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentUploadSubmissionAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentUploadSubmissionAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentUploadSubmissionAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentUploadSubmissionAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentUploadSubmissionAttributes>() {
           @Override
           public void write(JsonWriter out, DocumentUploadSubmissionAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentUploadSubmissionAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentUploadSubmissionAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentUploadSubmissionAttributes
   * @throws IOException if the JSON string is invalid with respect to DocumentUploadSubmissionAttributes
   */
  public static DocumentUploadSubmissionAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentUploadSubmissionAttributes.class);
  }

  /**
   * Convert an instance of DocumentUploadSubmissionAttributes to an JSON string
   *
   * @return JSON string
   */
