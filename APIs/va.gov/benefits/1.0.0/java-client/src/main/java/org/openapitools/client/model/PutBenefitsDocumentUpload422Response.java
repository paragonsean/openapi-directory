...
public class PutBenefitsDocumentUpload422Response {
  public static final String SERIALIZED_NAME_ERRORS = "errors";
  @SerializedName(SERIALIZED_NAME_ERRORS)
  private List<ErrorModel> errors = new ArrayList<>();

  public PutBenefitsDocumentUpload422Response() {
  }

  public PutBenefitsDocumentUpload422Response errors(List<ErrorModel> errors) {
    this.errors = errors;
    return this;
  }

  public PutBenefitsDocumentUpload422Response addErrorsItem(ErrorModel errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    PutBenefitsDocumentUpload422Response putBenefitsDocumentUpload422Response = (PutBenefitsDocumentUpload422Response) o;
    return Objects.equals(this.errors, putBenefitsDocumentUpload422Response.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutBenefitsDocumentUpload422Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutBenefitsDocumentUpload422Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutBenefitsDocumentUpload422Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutBenefitsDocumentUpload422Response is not found in the empty JSON string", PutBenefitsDocumentUpload422Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutBenefitsDocumentUpload422Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutBenefitsDocumentUpload422Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutBenefitsDocumentUpload422Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutBenefitsDocumentUpload422Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutBenefitsDocumentUpload422Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutBenefitsDocumentUpload422Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutBenefitsDocumentUpload422Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PutBenefitsDocumentUpload422Response>() {
           @Override
           public void write(JsonWriter out, PutBenefitsDocumentUpload422Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutBenefitsDocumentUpload422Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutBenefitsDocumentUpload422Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutBenefitsDocumentUpload422Response
   * @throws IOException if the JSON string is invalid with respect to PutBenefitsDocumentUpload422Response
   */
  public static PutBenefitsDocumentUpload422Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutBenefitsDocumentUpload422Response.class);
  }

  /**
   * Convert an instance of PutBenefitsDocumentUpload422Response to an JSON string
   *
   * @return JSON string
   */
