...
import org.openapitools.client.model.DocumentValidationErrorModel;
...
public class PostBenefitsDocumentUploadValidateDocument422Response {
  public static final String SERIALIZED_NAME_ERRORS = "errors";
  @SerializedName(SERIALIZED_NAME_ERRORS)
  private List<DocumentValidationErrorModel> errors = new ArrayList<>();

  public PostBenefitsDocumentUploadValidateDocument422Response() {
  }

  public PostBenefitsDocumentUploadValidateDocument422Response errors(List<DocumentValidationErrorModel> errors) {
    this.errors = errors;
    return this;
  }

  public PostBenefitsDocumentUploadValidateDocument422Response addErrorsItem(DocumentValidationErrorModel errorsItem) {
    if (this.errors == null) {
  ...
  public List<DocumentValidationErrorModel> getErrors() {
    return errors;
  }

  public void setErrors(List<DocumentValidationErrorModel> errors) {
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostBenefitsDocumentUploadValidateDocument422Response postBenefitsDocumentUploadValidateDocument422Response = (PostBenefitsDocumentUploadValidateDocument422Response) o;
    return Objects.equals(this.errors, postBenefitsDocumentUploadValidateDocument422Response.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostBenefitsDocumentUploadValidateDocument422Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostBenefitsDocumentUploadValidateDocument422Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostBenefitsDocumentUploadValidateDocument422Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostBenefitsDocumentUploadValidateDocument422Response is not found in the empty JSON string", PostBenefitsDocumentUploadValidateDocument422Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostBenefitsDocumentUploadValidateDocument422Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostBenefitsDocumentUploadValidateDocument422Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PostBenefitsDocumentUploadValidateDocument422Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayerrors.size(); i++) {
        DocumentValidationErrorModel.validateJsonElement(jsonArrayerrors.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostBenefitsDocumentUploadValidateDocument422Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostBenefitsDocumentUploadValidateDocument422Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostBenefitsDocumentUploadValidateDocument422Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostBenefitsDocumentUploadValidateDocument422Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PostBenefitsDocumentUploadValidateDocument422Response>() {
           @Override
           public void write(JsonWriter out, PostBenefitsDocumentUploadValidateDocument422Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostBenefitsDocumentUploadValidateDocument422Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostBenefitsDocumentUploadValidateDocument422Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostBenefitsDocumentUploadValidateDocument422Response
   * @throws IOException if the JSON string is invalid with respect to PostBenefitsDocumentUploadValidateDocument422Response
   */
  public static PostBenefitsDocumentUploadValidateDocument422Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostBenefitsDocumentUploadValidateDocument422Response.class);
  }

  /**
   * Convert an instance of PostBenefitsDocumentUploadValidateDocument422Response to an JSON string
   *
   * @return JSON string
   */
