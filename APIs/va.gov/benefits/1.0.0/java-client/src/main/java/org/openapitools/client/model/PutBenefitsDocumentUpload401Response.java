...
public class PutBenefitsDocumentUpload401Response {
  public static final String SERIALIZED_NAME_MESSAGE = "Message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  private String message;

  public PutBenefitsDocumentUpload401Response() {
  }

  public PutBenefitsDocumentUpload401Response message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    PutBenefitsDocumentUpload401Response putBenefitsDocumentUpload401Response = (PutBenefitsDocumentUpload401Response) o;
    return Objects.equals(this.message, putBenefitsDocumentUpload401Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutBenefitsDocumentUpload401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutBenefitsDocumentUpload401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutBenefitsDocumentUpload401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutBenefitsDocumentUpload401Response is not found in the empty JSON string", PutBenefitsDocumentUpload401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutBenefitsDocumentUpload401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutBenefitsDocumentUpload401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutBenefitsDocumentUpload401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutBenefitsDocumentUpload401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutBenefitsDocumentUpload401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutBenefitsDocumentUpload401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PutBenefitsDocumentUpload401Response>() {
           @Override
           public void write(JsonWriter out, PutBenefitsDocumentUpload401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutBenefitsDocumentUpload401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutBenefitsDocumentUpload401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutBenefitsDocumentUpload401Response
   * @throws IOException if the JSON string is invalid with respect to PutBenefitsDocumentUpload401Response
   */
  public static PutBenefitsDocumentUpload401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutBenefitsDocumentUpload401Response.class);
  }

  /**
   * Convert an instance of PutBenefitsDocumentUpload401Response to an JSON string
   *
   * @return JSON string
   */
