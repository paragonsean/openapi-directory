...
import org.openapitools.client.model.DocumentUploadAttributes;
...
public class DocumentUploadPath {
  ...
  private DocumentUploadAttributes attributes;
  ...
  public DocumentUploadPath() {
  }

  public DocumentUploadPath attributes(DocumentUploadAttributes attributes) {
  ...
  public DocumentUploadAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(DocumentUploadAttributes attributes) {
    this.attributes = attributes;
  }


  public DocumentUploadPath id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public DocumentUploadPath type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DocumentUploadPath documentUploadPath = (DocumentUploadPath) o;
    return Objects.equals(this.attributes, documentUploadPath.attributes) &&
        Objects.equals(this.id, documentUploadPath.id) &&
        Objects.equals(this.type, documentUploadPath.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentUploadPath {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentUploadPath
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentUploadPath.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentUploadPath is not found in the empty JSON string", DocumentUploadPath.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentUploadPath.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentUploadPath` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentUploadPath.openapiRequiredFields) {
      ...
      DocumentUploadAttributes.validateJsonElement(jsonObj.get("attributes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentUploadPath.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentUploadPath' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentUploadPath> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentUploadPath.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentUploadPath>() {
           @Override
           public void write(JsonWriter out, DocumentUploadPath value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentUploadPath read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentUploadPath given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentUploadPath
   * @throws IOException if the JSON string is invalid with respect to DocumentUploadPath
   */
  public static DocumentUploadPath fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentUploadPath.class);
  }

  /**
   * Convert an instance of DocumentUploadPath to an JSON string
   *
   * @return JSON string
   */
