...
public class DocumentUploadFailure {
  ...
  public DocumentUploadFailure code(String code) {
    this.code = code;
    return this;
  }
  ...
  public DocumentUploadFailure message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    DocumentUploadFailure documentUploadFailure = (DocumentUploadFailure) o;
    return Objects.equals(this.code, documentUploadFailure.code) &&
        Objects.equals(this.message, documentUploadFailure.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentUploadFailure {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentUploadFailure
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentUploadFailure.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentUploadFailure is not found in the empty JSON string", DocumentUploadFailure.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentUploadFailure.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentUploadFailure` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentUploadFailure.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentUploadFailure' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentUploadFailure> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentUploadFailure.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentUploadFailure>() {
           @Override
           public void write(JsonWriter out, DocumentUploadFailure value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentUploadFailure read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentUploadFailure given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentUploadFailure
   * @throws IOException if the JSON string is invalid with respect to DocumentUploadFailure
   */
  public static DocumentUploadFailure fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentUploadFailure.class);
  }

  /**
   * Convert an instance of DocumentUploadFailure to an JSON string
   *
   * @return JSON string
   */
