...
public class PostBenefitsDocumentUpload403Response {
  public static final String SERIALIZED_NAME_MESSAGE = "Message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  private String message;

  public PostBenefitsDocumentUpload403Response() {
  }

  public PostBenefitsDocumentUpload403Response message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    PostBenefitsDocumentUpload403Response postBenefitsDocumentUpload403Response = (PostBenefitsDocumentUpload403Response) o;
    return Objects.equals(this.message, postBenefitsDocumentUpload403Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostBenefitsDocumentUpload403Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostBenefitsDocumentUpload403Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostBenefitsDocumentUpload403Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostBenefitsDocumentUpload403Response is not found in the empty JSON string", PostBenefitsDocumentUpload403Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostBenefitsDocumentUpload403Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostBenefitsDocumentUpload403Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostBenefitsDocumentUpload403Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostBenefitsDocumentUpload403Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostBenefitsDocumentUpload403Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostBenefitsDocumentUpload403Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PostBenefitsDocumentUpload403Response>() {
           @Override
           public void write(JsonWriter out, PostBenefitsDocumentUpload403Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostBenefitsDocumentUpload403Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostBenefitsDocumentUpload403Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostBenefitsDocumentUpload403Response
   * @throws IOException if the JSON string is invalid with respect to PostBenefitsDocumentUpload403Response
   */
  public static PostBenefitsDocumentUpload403Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostBenefitsDocumentUpload403Response.class);
  }

  /**
   * Convert an instance of PostBenefitsDocumentUpload403Response to an JSON string
   *
   * @return JSON string
   */
