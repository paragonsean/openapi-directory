...
import org.openapitools.client.model.PostBenefitsDocumentUploadValidateDocument200ResponseData;
...
public class PostBenefitsDocumentUploadValidateDocument200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private PostBenefitsDocumentUploadValidateDocument200ResponseData data;

  public PostBenefitsDocumentUploadValidateDocument200Response() {
  }

  public PostBenefitsDocumentUploadValidateDocument200Response data(PostBenefitsDocumentUploadValidateDocument200ResponseData data) {
    this.data = data;
    return this;
  }
  ...
  public PostBenefitsDocumentUploadValidateDocument200ResponseData getData() {
    return data;
  }

  public void setData(PostBenefitsDocumentUploadValidateDocument200ResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostBenefitsDocumentUploadValidateDocument200Response postBenefitsDocumentUploadValidateDocument200Response = (PostBenefitsDocumentUploadValidateDocument200Response) o;
    return Objects.equals(this.data, postBenefitsDocumentUploadValidateDocument200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostBenefitsDocumentUploadValidateDocument200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostBenefitsDocumentUploadValidateDocument200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostBenefitsDocumentUploadValidateDocument200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostBenefitsDocumentUploadValidateDocument200Response is not found in the empty JSON string", PostBenefitsDocumentUploadValidateDocument200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostBenefitsDocumentUploadValidateDocument200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostBenefitsDocumentUploadValidateDocument200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        PostBenefitsDocumentUploadValidateDocument200ResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostBenefitsDocumentUploadValidateDocument200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostBenefitsDocumentUploadValidateDocument200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostBenefitsDocumentUploadValidateDocument200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostBenefitsDocumentUploadValidateDocument200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PostBenefitsDocumentUploadValidateDocument200Response>() {
           @Override
           public void write(JsonWriter out, PostBenefitsDocumentUploadValidateDocument200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostBenefitsDocumentUploadValidateDocument200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostBenefitsDocumentUploadValidateDocument200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostBenefitsDocumentUploadValidateDocument200Response
   * @throws IOException if the JSON string is invalid with respect to PostBenefitsDocumentUploadValidateDocument200Response
   */
  public static PostBenefitsDocumentUploadValidateDocument200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostBenefitsDocumentUploadValidateDocument200Response.class);
  }

  /**
   * Convert an instance of PostBenefitsDocumentUploadValidateDocument200Response to an JSON string
   *
   * @return JSON string
   */
