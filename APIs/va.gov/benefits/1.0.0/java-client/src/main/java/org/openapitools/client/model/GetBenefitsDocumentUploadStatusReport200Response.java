...
public class GetBenefitsDocumentUploadStatusReport200Response {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<DocumentUploadStatus> data = new ArrayList<>();

  public GetBenefitsDocumentUploadStatusReport200Response() {
  }

  public GetBenefitsDocumentUploadStatusReport200Response data(List<DocumentUploadStatus> data) {
    this.data = data;
    return this;
  }

  public GetBenefitsDocumentUploadStatusReport200Response addDataItem(DocumentUploadStatus dataItem) {
    if (this.data == null) {
  ...
  public List<DocumentUploadStatus> getData() {
    return data;
  }

  public void setData(List<DocumentUploadStatus> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetBenefitsDocumentUploadStatusReport200Response getBenefitsDocumentUploadStatusReport200Response = (GetBenefitsDocumentUploadStatusReport200Response) o;
    return Objects.equals(this.data, getBenefitsDocumentUploadStatusReport200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBenefitsDocumentUploadStatusReport200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBenefitsDocumentUploadStatusReport200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBenefitsDocumentUploadStatusReport200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBenefitsDocumentUploadStatusReport200Response is not found in the empty JSON string", GetBenefitsDocumentUploadStatusReport200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBenefitsDocumentUploadStatusReport200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBenefitsDocumentUploadStatusReport200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetBenefitsDocumentUploadStatusReport200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        DocumentUploadStatus.validateJsonElement(jsonArraydata.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBenefitsDocumentUploadStatusReport200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBenefitsDocumentUploadStatusReport200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBenefitsDocumentUploadStatusReport200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBenefitsDocumentUploadStatusReport200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBenefitsDocumentUploadStatusReport200Response>() {
           @Override
           public void write(JsonWriter out, GetBenefitsDocumentUploadStatusReport200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBenefitsDocumentUploadStatusReport200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBenefitsDocumentUploadStatusReport200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBenefitsDocumentUploadStatusReport200Response
   * @throws IOException if the JSON string is invalid with respect to GetBenefitsDocumentUploadStatusReport200Response
   */
  public static GetBenefitsDocumentUploadStatusReport200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBenefitsDocumentUploadStatusReport200Response.class);
  }

  /**
   * Convert an instance of GetBenefitsDocumentUploadStatusReport200Response to an JSON string
   *
   * @return JSON string
   */
