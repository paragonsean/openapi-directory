...
public class PdfUploadAttributes {
  ...
  private PdfUploadAttributesContent content;
  ...
  public PdfUploadAttributes() {
  }

  public PdfUploadAttributes content(PdfUploadAttributesContent content) {
  ...
  public PdfUploadAttributesContent getContent() {
    return content;
  }

  public void setContent(PdfUploadAttributesContent content) {
    this.content = content;
  }


  public PdfUploadAttributes totalDocuments(Integer totalDocuments) {
  ...
  public PdfUploadAttributes totalPages(Integer totalPages) {
  ...
  public boolean equals(Object o) {
    ...
    PdfUploadAttributes pdfUploadAttributes = (PdfUploadAttributes) o;
    return Objects.equals(this.content, pdfUploadAttributes.content) &&
        Objects.equals(this.totalDocuments, pdfUploadAttributes.totalDocuments) &&
        Objects.equals(this.totalPages, pdfUploadAttributes.totalPages);
  }

  @Override
  public int hashCode() {
    return Objects.hash(content, totalDocuments, totalPages);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PdfUploadAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PdfUploadAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PdfUploadAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PdfUploadAttributes is not found in the empty JSON string", PdfUploadAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PdfUploadAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PdfUploadAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PdfUploadAttributes.openapiRequiredFields) {
      ...
      PdfUploadAttributesContent.validateJsonElement(jsonObj.get("content"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PdfUploadAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PdfUploadAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PdfUploadAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PdfUploadAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<PdfUploadAttributes>() {
           @Override
           public void write(JsonWriter out, PdfUploadAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PdfUploadAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PdfUploadAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PdfUploadAttributes
   * @throws IOException if the JSON string is invalid with respect to PdfUploadAttributes
   */
  public static PdfUploadAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PdfUploadAttributes.class);
  }

  /**
   * Convert an instance of PdfUploadAttributes to an JSON string
   *
   * @return JSON string
   */
