...
import org.openapitools.client.model.PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes;
...
public class PostBenefitsDocumentUploadValidateDocument200ResponseData {
  public static final String SERIALIZED_NAME_ATTRIBUTES = "attributes";
  @SerializedName(SERIALIZED_NAME_ATTRIBUTES)
  private PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes attributes;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private String type;

  public PostBenefitsDocumentUploadValidateDocument200ResponseData() {
  }

  public PostBenefitsDocumentUploadValidateDocument200ResponseData attributes(PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes attributes) {
  ...
  public PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes attributes) {
    this.attributes = attributes;
  }


  public PostBenefitsDocumentUploadValidateDocument200ResponseData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostBenefitsDocumentUploadValidateDocument200ResponseData postBenefitsDocumentUploadValidateDocument200ResponseData = (PostBenefitsDocumentUploadValidateDocument200ResponseData) o;
    return Objects.equals(this.attributes, postBenefitsDocumentUploadValidateDocument200ResponseData.attributes) &&
        Objects.equals(this.type, postBenefitsDocumentUploadValidateDocument200ResponseData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostBenefitsDocumentUploadValidateDocument200ResponseData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostBenefitsDocumentUploadValidateDocument200ResponseData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostBenefitsDocumentUploadValidateDocument200ResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostBenefitsDocumentUploadValidateDocument200ResponseData is not found in the empty JSON string", PostBenefitsDocumentUploadValidateDocument200ResponseData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostBenefitsDocumentUploadValidateDocument200ResponseData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostBenefitsDocumentUploadValidateDocument200ResponseData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostBenefitsDocumentUploadValidateDocument200ResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostBenefitsDocumentUploadValidateDocument200ResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostBenefitsDocumentUploadValidateDocument200ResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostBenefitsDocumentUploadValidateDocument200ResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<PostBenefitsDocumentUploadValidateDocument200ResponseData>() {
           @Override
           public void write(JsonWriter out, PostBenefitsDocumentUploadValidateDocument200ResponseData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostBenefitsDocumentUploadValidateDocument200ResponseData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostBenefitsDocumentUploadValidateDocument200ResponseData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostBenefitsDocumentUploadValidateDocument200ResponseData
   * @throws IOException if the JSON string is invalid with respect to PostBenefitsDocumentUploadValidateDocument200ResponseData
   */
  public static PostBenefitsDocumentUploadValidateDocument200ResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostBenefitsDocumentUploadValidateDocument200ResponseData.class);
  }

  /**
   * Convert an instance of PostBenefitsDocumentUploadValidateDocument200ResponseData to an JSON string
   *
   * @return JSON string
   */
