...
public class PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes {
  public static final String SERIALIZED_NAME_STATUS = "status";
  @SerializedName(SERIALIZED_NAME_STATUS)
  private String status;

  public PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes() {
  }

  public PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes postBenefitsDocumentUploadValidateDocument200ResponseDataAttributes = (PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes) o;
    return Objects.equals(this.status, postBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes is not found in the empty JSON string", PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes>() {
           @Override
           public void write(JsonWriter out, PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes
   * @throws IOException if the JSON string is invalid with respect to PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes
   */
  public static PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes.class);
  }

  /**
   * Convert an instance of PostBenefitsDocumentUploadValidateDocument200ResponseDataAttributes to an JSON string
   *
   * @return JSON string
   */
