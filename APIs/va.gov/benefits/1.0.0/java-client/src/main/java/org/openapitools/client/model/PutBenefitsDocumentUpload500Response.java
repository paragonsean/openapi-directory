...
public class PutBenefitsDocumentUpload500Response {
  ...
  public PutBenefitsDocumentUpload500Response() {
  }

  public PutBenefitsDocumentUpload500Response code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PutBenefitsDocumentUpload500Response detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public PutBenefitsDocumentUpload500Response status(String status) {
    this.status = status;
    return this;
  }
  ...
  public PutBenefitsDocumentUpload500Response title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutBenefitsDocumentUpload500Response putBenefitsDocumentUpload500Response = (PutBenefitsDocumentUpload500Response) o;
    return Objects.equals(this.code, putBenefitsDocumentUpload500Response.code) &&
        Objects.equals(this.detail, putBenefitsDocumentUpload500Response.detail) &&
        Objects.equals(this.status, putBenefitsDocumentUpload500Response.status) &&
        Objects.equals(this.title, putBenefitsDocumentUpload500Response.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutBenefitsDocumentUpload500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutBenefitsDocumentUpload500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutBenefitsDocumentUpload500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutBenefitsDocumentUpload500Response is not found in the empty JSON string", PutBenefitsDocumentUpload500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutBenefitsDocumentUpload500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutBenefitsDocumentUpload500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutBenefitsDocumentUpload500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutBenefitsDocumentUpload500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutBenefitsDocumentUpload500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutBenefitsDocumentUpload500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PutBenefitsDocumentUpload500Response>() {
           @Override
           public void write(JsonWriter out, PutBenefitsDocumentUpload500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutBenefitsDocumentUpload500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutBenefitsDocumentUpload500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutBenefitsDocumentUpload500Response
   * @throws IOException if the JSON string is invalid with respect to PutBenefitsDocumentUpload500Response
   */
  public static PutBenefitsDocumentUpload500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutBenefitsDocumentUpload500Response.class);
  }

  /**
   * Convert an instance of PutBenefitsDocumentUpload500Response to an JSON string
   *
   * @return JSON string
   */
