...
import org.openapitools.client.model.DocumentUploadStatusAttributes;
...
public class DocumentUploadStatus {
  ...
  private DocumentUploadStatusAttributes attributes;
  ...
  public DocumentUploadStatus attributes(DocumentUploadStatusAttributes attributes) {
  ...
  public DocumentUploadStatusAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(DocumentUploadStatusAttributes attributes) {
    this.attributes = attributes;
  }


  public DocumentUploadStatus id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public DocumentUploadStatus type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DocumentUploadStatus documentUploadStatus = (DocumentUploadStatus) o;
    return Objects.equals(this.attributes, documentUploadStatus.attributes) &&
        Objects.equals(this.id, documentUploadStatus.id) &&
        Objects.equals(this.type, documentUploadStatus.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentUploadStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentUploadStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentUploadStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentUploadStatus is not found in the empty JSON string", DocumentUploadStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentUploadStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentUploadStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentUploadStatus.openapiRequiredFields) {
      ...
      DocumentUploadStatusAttributes.validateJsonElement(jsonObj.get("attributes"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentUploadStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentUploadStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentUploadStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentUploadStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentUploadStatus>() {
           @Override
           public void write(JsonWriter out, DocumentUploadStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentUploadStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentUploadStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentUploadStatus
   * @throws IOException if the JSON string is invalid with respect to DocumentUploadStatus
   */
  public static DocumentUploadStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentUploadStatus.class);
  }

  /**
   * Convert an instance of DocumentUploadStatus to an JSON string
   *
   * @return JSON string
   */
