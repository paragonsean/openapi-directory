...
public class DocumentUploadStatusGuidList {
  ...
  public DocumentUploadStatusGuidList() {
  }

  public DocumentUploadStatusGuidList ids(List<UUID> ids) {
    this.ids = ids;
    return this;
  }

  public DocumentUploadStatusGuidList addIdsItem(UUID idsItem) {
    if (this.ids == null) {
  ...
  public boolean equals(Object o) {
    ...
    DocumentUploadStatusGuidList documentUploadStatusGuidList = (DocumentUploadStatusGuidList) o;
    return Objects.equals(this.ids, documentUploadStatusGuidList.ids);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentUploadStatusGuidList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentUploadStatusGuidList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentUploadStatusGuidList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentUploadStatusGuidList is not found in the empty JSON string", DocumentUploadStatusGuidList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentUploadStatusGuidList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentUploadStatusGuidList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DocumentUploadStatusGuidList.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentUploadStatusGuidList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentUploadStatusGuidList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentUploadStatusGuidList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentUploadStatusGuidList.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentUploadStatusGuidList>() {
           @Override
           public void write(JsonWriter out, DocumentUploadStatusGuidList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentUploadStatusGuidList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentUploadStatusGuidList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentUploadStatusGuidList
   * @throws IOException if the JSON string is invalid with respect to DocumentUploadStatusGuidList
   */
  public static DocumentUploadStatusGuidList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentUploadStatusGuidList.class);
  }

  /**
   * Convert an instance of DocumentUploadStatusGuidList to an JSON string
   *
   * @return JSON string
   */
