...
public class PutBenefitsDocumentUpload429Response {
  public static final String SERIALIZED_NAME_MESSAGE = "Message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  private String message;

  public PutBenefitsDocumentUpload429Response() {
  }

  public PutBenefitsDocumentUpload429Response message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    PutBenefitsDocumentUpload429Response putBenefitsDocumentUpload429Response = (PutBenefitsDocumentUpload429Response) o;
    return Objects.equals(this.message, putBenefitsDocumentUpload429Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutBenefitsDocumentUpload429Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutBenefitsDocumentUpload429Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutBenefitsDocumentUpload429Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutBenefitsDocumentUpload429Response is not found in the empty JSON string", PutBenefitsDocumentUpload429Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutBenefitsDocumentUpload429Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutBenefitsDocumentUpload429Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutBenefitsDocumentUpload429Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutBenefitsDocumentUpload429Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutBenefitsDocumentUpload429Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutBenefitsDocumentUpload429Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PutBenefitsDocumentUpload429Response>() {
           @Override
           public void write(JsonWriter out, PutBenefitsDocumentUpload429Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutBenefitsDocumentUpload429Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutBenefitsDocumentUpload429Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutBenefitsDocumentUpload429Response
   * @throws IOException if the JSON string is invalid with respect to PutBenefitsDocumentUpload429Response
   */
  public static PutBenefitsDocumentUpload429Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutBenefitsDocumentUpload429Response.class);
  }

  /**
   * Convert an instance of PutBenefitsDocumentUpload429Response to an JSON string
   *
   * @return JSON string
   */
