...
/*
 * OAIVeteranStatusConfirmation.h
 *
 * Veteran status confirmation for an individual
 */

#ifndef OAIVeteranStatusConfirmation_H
#define OAIVeteranStatusConfirmation_H
...
class OAIVeteranStatusConfirmation : public OAIObject {
public:
    OAIVeteranStatusConfirmation();
    OAIVeteranStatusConfirmation(QString json);
    ~OAIVeteranStatusConfirmation() override;
    ...
    Q_DECL_DEPRECATED QString getVeteranStatus() const;
    Q_DECL_DEPRECATED void setVeteranStatus(const QString &veteran_status);
    Q_DECL_DEPRECATED bool is_veteran_status_Set() const;
    Q_DECL_DEPRECATED bool is_veteran_status_Valid() const;
...
private:
    ...
    QString m_veteran_status;
    bool m_veteran_status_isSet;
    bool m_veteran_status_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIVeteranStatusConfirmation)

#endif // OAIVeteranStatusConfirmation_H
