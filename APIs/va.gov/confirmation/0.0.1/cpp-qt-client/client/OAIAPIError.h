...
namespace OpenAPI {
class OAIAPIError_errors_inner;
...
public:
    ...
    QList<OAIAPIError_errors_inner> getErrors() const;
    void setErrors(const QList<OAIAPIError_errors_inner> &errors);
...
private:
    ...
    QList<OAIAPIError_errors_inner> m_errors;
    bool m_errors_isSet;
