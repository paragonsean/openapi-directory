...
/*
 * OAIAuthorizationError.h
 *
 * API Platform authorization (API token) error
 */

#ifndef OAIAuthorizationError_H
#define OAIAuthorizationError_H
...
class OAIAuthorizationError : public OAIObject {
public:
    OAIAuthorizationError();
    OAIAuthorizationError(QString json);
    ~OAIAuthorizationError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthorizationError)

#endif // OAIAuthorizationError_H
