...
OAIAuthorizationError::OAIAuthorizationError(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuthorizationError::OAIAuthorizationError() {
    this->initializeModel();
}

OAIAuthorizationError::~OAIAuthorizationError() {}

void OAIAuthorizationError::initializeModel() {

    m_message_isSet = false;
    m_message_isValid = false;
}

void OAIAuthorizationError::fromJson(QString jsonString) {
...
void OAIAuthorizationError::fromJsonObject(QJsonObject json) {

    m_message_isValid = ::OpenAPI::fromJsonValue(m_message, json[QString("message")]);
    m_message_isSet = !json[QString("message")].isNull() && m_message_isValid;
}

QString OAIAuthorizationError::asJson() const {
...
QJsonObject OAIAuthorizationError::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIAuthorizationError::getMessage() const {
    return m_message;
}
void OAIAuthorizationError::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIAuthorizationError::is_message_Set() const{
    return m_message_isSet;
}

bool OAIAuthorizationError::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIAuthorizationError::isSet() const {
...
bool OAIAuthorizationError::isValid() const {
