...
/*
 * OAIAPIError_errors_inner.h
 *
 * 
 */

#ifndef OAIAPIError_errors_inner_H
#define OAIAPIError_errors_inner_H
...
class OAIAPIError_errors_inner : public OAIObject {
public:
    OAIAPIError_errors_inner();
    OAIAPIError_errors_inner(QString json);
    ~OAIAPIError_errors_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPIError_errors_inner)

#endif // OAIAPIError_errors_inner_H
