...
import APIErrorErrorsInner from './APIErrorErrorsInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [APIErrorErrorsInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        if (data['errors']) { // data not null
            ...
            for (const item of data['errors']) {
                APIErrorErrorsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/APIErrorErrorsInner>} errors
 */
