...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeteranConfirmation.AuthorizationError();
  });
  ...
  describe('AuthorizationError', function() {
    it('should create an instance of AuthorizationError', function() {
      ...
      //var instance = new VeteranConfirmation.AuthorizationError();
      //expect(instance).to.be.a(VeteranConfirmation.AuthorizationError);
    });
