...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeteranConfirmation.VeteranStatusRequest();
  });
  ...
  describe('VeteranStatusRequest', function() {
    it('should create an instance of VeteranStatusRequest', function() {
      // uncomment below and update the code to test VeteranStatusRequest
      //var instance = new VeteranConfirmation.VeteranStatusRequest();
      //expect(instance).to.be.a(VeteranConfirmation.VeteranStatusRequest);
    });
