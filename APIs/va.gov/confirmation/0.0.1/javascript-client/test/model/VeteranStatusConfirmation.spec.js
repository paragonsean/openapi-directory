...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeteranConfirmation.VeteranStatusConfirmation();
  });
  ...
  describe('VeteranStatusConfirmation', function() {
    it('should create an instance of VeteranStatusConfirmation', function() {
      // uncomment below and update the code to test VeteranStatusConfirmation
      //var instance = new VeteranConfirmation.VeteranStatusConfirmation();
      //expect(instance).to.be.a(VeteranConfirmation.VeteranStatusConfirmation);
    });
