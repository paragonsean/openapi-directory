...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeteranConfirmation.VeteranConfirmationStatusApi();
  });
  ...
  describe('VeteranConfirmationStatusApi', function() {
    describe('getVeteranStatus', function() {
      it('should call getVeteranStatus successfully', function(done) {
        //uncomment below and update the code to test getVeteranStatus
        //instance.getVeteranStatus(function(error) {
