...
/**
 * API tests for VeteranConfirmationStatusApi
 */
@Disabled
public class VeteranConfirmationStatusApiTest {

    private final VeteranConfirmationStatusApi api = new VeteranConfirmationStatusApi();
     ...
     */
    @Test
    public void getVeteranStatusTest() throws ApiException {
        VeteranStatusRequest veteranStatusRequest = null;
        VeteranStatusConfirmation response = api.getVeteranStatus(veteranStatusRequest);
