...
/**
 * The Satisfaction model module.
 * @module model/Satisfaction
 * @version 0.0.1
 */
class Satisfaction {
    /**
     * Constructs a new <code>Satisfaction</code>.
     * Scores that indicate patient satisfaction at given facility per service.
     * @alias module:model/Satisfaction
     */
    constructor() { 
        
        Satisfaction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Satisfaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Satisfaction} obj Optional instance to populate.
     * @return {module:model/Satisfaction} The populated <code>Satisfaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Satisfaction();

            if (data.hasOwnProperty('effective_date')) {
                obj['effective_date'] = ApiClient.convertToType(data['effective_date'], 'Date');
            }
            if (data.hasOwnProperty('health')) {
                obj['health'] = PatientSatisfaction.constructFromObject(data['health']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Satisfaction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Satisfaction</code>.
     */
    static validateJSON(data) {
        // validate the optional field `health`
        if (data['health']) { // data not null
          PatientSatisfaction.validateJSON(data['health']);
        }
 ...
 */
Satisfaction.prototype['effective_date'] = undefined;

/**
 * @member {module:model/PatientSatisfaction} health
 */
Satisfaction.prototype['health'] = undefined;
