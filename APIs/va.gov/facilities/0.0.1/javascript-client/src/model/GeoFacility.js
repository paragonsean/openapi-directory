...
/**
 * The GeoFacility model module.
 * @module model/GeoFacility
 * @version 0.0.1
 */
class GeoFacility {
    /**
     * Constructs a new <code>GeoFacility</code>.
     * GeoJSON-complaint Feature object describing a VA Facility
     * @alias module:model/GeoFacility
     * @param geometry {module:model/Geometry} 
     * @param properties {module:model/Properties} 
     * @param type {module:model/GeoFacility.TypeEnum} Top level category describing the type of facility.
     */
    constructor(geometry, properties, type) { 
        
        GeoFacility.initialize(this, geometry, properties, type);
    }
    ...
    /**
     * Constructs a <code>GeoFacility</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GeoFacility} obj Optional instance to populate.
     * @return {module:model/GeoFacility} The populated <code>GeoFacility</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeoFacility();
    ...
    /**
     * Validates the JSON data with respect to <code>GeoFacility</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeoFacility</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GeoFacility.RequiredProperties) {
...
GeoFacility.RequiredProperties = ["geometry", "properties", "type"];

/**
 * @member {module:model/Geometry} geometry
 */
GeoFacility.prototype['geometry'] = undefined;

/**
 * @member {module:model/Properties} properties
 */
GeoFacility.prototype['properties'] = undefined;

/**
 * Top level category describing the type of facility.
 * @member {module:model/GeoFacility.TypeEnum} type
 */
GeoFacility.prototype['type'] = undefined;
