...
class Distance {
     ...
     * @param distance {Number} Distance to facility in decimal format.
     * @param id {String} Identifier of facility.
     */
    constructor(distance, id) { 
        
        Distance.initialize(this, distance, id);
    }
     ...
     */
    static initialize(obj, distance, id) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of Distance.RequiredProperties) {
...
Distance.RequiredProperties = ["distance", "id"];

/**
 * Distance to facility in decimal format.
 * @member {Number} distance
 */
Distance.prototype['distance'] = undefined;

/**
 * Identifier of facility.
 * @member {String} id
 */
Distance.prototype['id'] = undefined;
