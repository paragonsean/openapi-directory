...
/**
 * The GeoFacilitiesResponse model module.
 * @module model/GeoFacilitiesResponse
 * @version 0.0.1
 */
class GeoFacilitiesResponse {
    /**
     * Constructs a new <code>GeoFacilitiesResponse</code>.
     * GeoJSON API-compliant response object describing one or more VA facilities.
     * @alias module:model/GeoFacilitiesResponse
     * @param type {module:model/GeoFacilitiesResponse.TypeEnum} 
     */
    constructor(type) { 
        
        GeoFacilitiesResponse.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>GeoFacilitiesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GeoFacilitiesResponse} obj Optional instance to populate.
     * @return {module:model/GeoFacilitiesResponse} The populated <code>GeoFacilitiesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeoFacilitiesResponse();

            if (data.hasOwnProperty('features')) {
                obj['features'] = ApiClient.convertToType(data['features'], [GeoFacility]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GeoFacilitiesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeoFacilitiesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GeoFacilitiesResponse.RequiredProperties) {
...
GeoFacilitiesResponse.RequiredProperties = ["type"];

/**
 * @member {Array.<module:model/GeoFacility>} features
 */
GeoFacilitiesResponse.prototype['features'] = undefined;

/**
 * @member {module:model/GeoFacilitiesResponse.TypeEnum} type
 */
GeoFacilitiesResponse.prototype['type'] = undefined;
 ...
 * @readonly
 */
GeoFacilitiesResponse['TypeEnum'] = {
...
export default GeoFacilitiesResponse;
