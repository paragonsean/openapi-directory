...
class Addresses {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('physical')) {
                obj['physical'] = Address.constructFromObject(data['physical']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['physical']) { // data not null
          Address.validateJSON(data['physical']);
        }
 ...
 */
Addresses.prototype['mailing'] = undefined;

/**
 * @member {module:model/Address} physical
 */
Addresses.prototype['physical'] = undefined;
