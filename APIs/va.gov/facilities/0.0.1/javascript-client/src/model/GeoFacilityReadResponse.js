...
/**
 * The GeoFacilityReadResponse model module.
 * @module model/GeoFacilityReadResponse
 * @version 0.0.1
 */
class GeoFacilityReadResponse {
    /**
     * Constructs a new <code>GeoFacilityReadResponse</code>.
     * Response that contains GeoFacility data.
     * @alias module:model/GeoFacilityReadResponse
     * @param geometry {module:model/Geometry} 
     * @param properties {module:model/Properties} 
     * @param type {module:model/GeoFacilityReadResponse.TypeEnum} 
     */
    constructor(geometry, properties, type) { 
        
        GeoFacilityReadResponse.initialize(this, geometry, properties, type);
    }
    ...
    /**
     * Constructs a <code>GeoFacilityReadResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GeoFacilityReadResponse} obj Optional instance to populate.
     * @return {module:model/GeoFacilityReadResponse} The populated <code>GeoFacilityReadResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeoFacilityReadResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GeoFacilityReadResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GeoFacilityReadResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GeoFacilityReadResponse.RequiredProperties) {
...
GeoFacilityReadResponse.RequiredProperties = ["geometry", "properties", "type"];

/**
 * @member {module:model/Geometry} geometry
 */
GeoFacilityReadResponse.prototype['geometry'] = undefined;

/**
 * @member {module:model/Properties} properties
 */
GeoFacilityReadResponse.prototype['properties'] = undefined;

/**
 * @member {module:model/GeoFacilityReadResponse.TypeEnum} type
 */
GeoFacilityReadResponse.prototype['type'] = undefined;
 ...
 * @readonly
 */
GeoFacilityReadResponse['TypeEnum'] = {
...
export default GeoFacilityReadResponse;
