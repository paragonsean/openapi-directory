...
/**
 * The DetailedServiceEmailContact model module.
 * @module model/DetailedServiceEmailContact
 * @version 0.0.1
 */
class DetailedServiceEmailContact {
    /**
     * Constructs a new <code>DetailedServiceEmailContact</code>.
     * Email contact information for facility service.
     * @alias module:model/DetailedServiceEmailContact
     */
    constructor() { 
        
        DetailedServiceEmailContact.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DetailedServiceEmailContact</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DetailedServiceEmailContact} obj Optional instance to populate.
     * @return {module:model/DetailedServiceEmailContact} The populated <code>DetailedServiceEmailContact</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DetailedServiceEmailContact();

            if (data.hasOwnProperty('email_address')) {
                obj['email_address'] = ApiClient.convertToType(data['email_address'], 'String');
            }
            if (data.hasOwnProperty('email_label')) {
                obj['email_label'] = ApiClient.convertToType(data['email_label'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DetailedServiceEmailContact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DetailedServiceEmailContact</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['email_label'] && !(typeof data['email_label'] === 'string' || data['email_label'] instanceof String)) {
            throw new Error("Expected the field `email_label` to be a primitive type in the JSON string but got " + data['email_label']);
        }
 ...
 */
DetailedServiceEmailContact.prototype['email_address'] = undefined;

/**
 * Email address label.
 * @member {String} email_label
 */
DetailedServiceEmailContact.prototype['email_label'] = undefined;
...
export default DetailedServiceEmailContact;
