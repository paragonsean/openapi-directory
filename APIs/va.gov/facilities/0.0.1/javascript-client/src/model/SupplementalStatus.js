...
/**
 * The SupplementalStatus model module.
 * @module model/SupplementalStatus
 * @version 0.0.1
 */
class SupplementalStatus {
    /**
     * Constructs a new <code>SupplementalStatus</code>.
     * Supplemental status for VA facility.
     * @alias module:model/SupplementalStatus
     * @param id {String} Unique id for supplemental status.
     * @param label {String} Descriptive label for supplemental status.
     */
    constructor(id, label) { 
        
        SupplementalStatus.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>SupplementalStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SupplementalStatus} obj Optional instance to populate.
     * @return {module:model/SupplementalStatus} The populated <code>SupplementalStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SupplementalStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>SupplementalStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SupplementalStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SupplementalStatus.RequiredProperties) {
...
SupplementalStatus.RequiredProperties = ["id", "label"];

/**
 * Unique id for supplemental status.
 * @member {String} id
 */
SupplementalStatus.prototype['id'] = undefined;

/**
 * Descriptive label for supplemental status.
 * @member {String} label
 */
SupplementalStatus.prototype['label'] = undefined;
...
export default SupplementalStatus;
