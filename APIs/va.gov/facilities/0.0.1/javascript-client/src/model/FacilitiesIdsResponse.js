...
/**
 * The FacilitiesIdsResponse model module.
 * @module model/FacilitiesIdsResponse
 * @version 0.0.1
 */
class FacilitiesIdsResponse {
    /**
     * Constructs a new <code>FacilitiesIdsResponse</code>.
     * JSON API response for a query for facility ids.
     * @alias module:model/FacilitiesIdsResponse
     */
    constructor() { 
        
        FacilitiesIdsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FacilitiesIdsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FacilitiesIdsResponse} obj Optional instance to populate.
     * @return {module:model/FacilitiesIdsResponse} The populated <code>FacilitiesIdsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FacilitiesIdsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>FacilitiesIdsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FacilitiesIdsResponse</code>.
     */
 ...
 */
FacilitiesIdsResponse.prototype['data'] = undefined;
...
export default FacilitiesIdsResponse;
