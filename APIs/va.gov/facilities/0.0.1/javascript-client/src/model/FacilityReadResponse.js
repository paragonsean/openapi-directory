...
/**
 * The FacilityReadResponse model module.
 * @module model/FacilityReadResponse
 * @version 0.0.1
 */
class FacilityReadResponse {
    /**
     * Constructs a new <code>FacilityReadResponse</code>.
     * Response that contains facility data.
     * @alias module:model/FacilityReadResponse
     * @param data {module:model/Facility} 
     */
    constructor(data) { 
        
        FacilityReadResponse.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>FacilityReadResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FacilityReadResponse} obj Optional instance to populate.
     * @return {module:model/FacilityReadResponse} The populated <code>FacilityReadResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FacilityReadResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = Facility.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FacilityReadResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FacilityReadResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FacilityReadResponse.RequiredProperties) {
        ...
        if (data['data']) { // data not null
          Facility.validateJSON(data['data']);
        }
...
FacilityReadResponse.RequiredProperties = ["data"];

/**
 * @member {module:model/Facility} data
 */
FacilityReadResponse.prototype['data'] = undefined;
...
export default FacilityReadResponse;
