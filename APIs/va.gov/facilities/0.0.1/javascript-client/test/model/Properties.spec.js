...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.Properties();
  });
  ...
  describe('Properties', function() {
    it('should create an instance of Properties', function() {
      ...
      //var instance = new VaFacilities.Properties();
      //expect(instance).to.be.a(VaFacilities.Properties);
    });
    ...
    it('should have the property detailedServices (base name: "detailed_services")', function() {
      // uncomment below and update the code to test the property detailedServices
      //var instance = new VaFacilities.Properties();
      //expect(instance).to.be();
    });

    it('should have the property facilityType (base name: "facility_type")', function() {
      // uncomment below and update the code to test the property facilityType
      //var instance = new VaFacilities.Properties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property operationalHoursSpecialInstructions (base name: "operational_hours_special_instructions")', function() {
      // uncomment below and update the code to test the property operationalHoursSpecialInstructions
      //var instance = new VaFacilities.Properties();
      //expect(instance).to.be();
    });
    ...
    it('should have the property visn (base name: "visn")', function() {
      // uncomment below and update the code to test the property visn
      //var instance = new VaFacilities.Properties();
      //expect(instance).to.be();
    });

    it('should have the property waitTimes (base name: "wait_times")', function() {
      // uncomment below and update the code to test the property waitTimes
      //var instance = new VaFacilities.Properties();
      //expect(instance).to.be();
    });
