...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.FacilitiesMetadata();
  });
  ...
  describe('FacilitiesMetadata', function() {
    it('should create an instance of FacilitiesMetadata', function() {
      // uncomment below and update the code to test FacilitiesMetadata
      //var instance = new VaFacilities.FacilitiesMetadata();
      //expect(instance).to.be.a(VaFacilities.FacilitiesMetadata);
    });
