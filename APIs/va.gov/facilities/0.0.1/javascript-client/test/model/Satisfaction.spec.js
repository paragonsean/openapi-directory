...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.Satisfaction();
  });
  ...
  describe('Satisfaction', function() {
    it('should create an instance of Satisfaction', function() {
      // uncomment below and update the code to test Satisfaction
      //var instance = new VaFacilities.Satisfaction();
      //expect(instance).to.be.a(VaFacilities.Satisfaction);
    });
