...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.GeoFacility();
  });
  ...
  describe('GeoFacility', function() {
    it('should create an instance of GeoFacility', function() {
      // uncomment below and update the code to test GeoFacility
      //var instance = new VaFacilities.GeoFacility();
      //expect(instance).to.be.a(VaFacilities.GeoFacility);
    });
