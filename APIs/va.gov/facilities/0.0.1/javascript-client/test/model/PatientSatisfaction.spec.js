...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.PatientSatisfaction();
  });
  ...
  describe('PatientSatisfaction', function() {
    it('should create an instance of PatientSatisfaction', function() {
      // uncomment below and update the code to test PatientSatisfaction
      //var instance = new VaFacilities.PatientSatisfaction();
      //expect(instance).to.be.a(VaFacilities.PatientSatisfaction);
    });

    it('should have the property primaryCareRoutine (base name: "primary_care_routine")', function() {
      // uncomment below and update the code to test the property primaryCareRoutine
      //var instance = new VaFacilities.PatientSatisfaction();
      //expect(instance).to.be();
    });

    it('should have the property primaryCareUrgent (base name: "primary_care_urgent")', function() {
      // uncomment below and update the code to test the property primaryCareUrgent
      //var instance = new VaFacilities.PatientSatisfaction();
      //expect(instance).to.be();
    });

    it('should have the property specialtyCareRoutine (base name: "specialty_care_routine")', function() {
      // uncomment below and update the code to test the property specialtyCareRoutine
      //var instance = new VaFacilities.PatientSatisfaction();
      //expect(instance).to.be();
    });

    it('should have the property specialtyCareUrgent (base name: "specialty_care_urgent")', function() {
      // uncomment below and update the code to test the property specialtyCareUrgent
      //var instance = new VaFacilities.PatientSatisfaction();
      //expect(instance).to.be();
    });
