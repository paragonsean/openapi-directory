...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.FacilitiesResponse();
  });
  ...
  describe('FacilitiesResponse', function() {
    it('should create an instance of FacilitiesResponse', function() {
      // uncomment below and update the code to test FacilitiesResponse
      //var instance = new VaFacilities.FacilitiesResponse();
      //expect(instance).to.be.a(VaFacilities.FacilitiesResponse);
    });
