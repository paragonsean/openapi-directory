...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.WaitTimes();
  });
  ...
  describe('WaitTimes', function() {
    it('should create an instance of WaitTimes', function() {
      // uncomment below and update the code to test WaitTimes
      //var instance = new VaFacilities.WaitTimes();
      //expect(instance).to.be.a(VaFacilities.WaitTimes);
    });
