...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.FacilityReadResponse();
  });
  ...
  describe('FacilityReadResponse', function() {
    it('should create an instance of FacilityReadResponse', function() {
      // uncomment below and update the code to test FacilityReadResponse
      //var instance = new VaFacilities.FacilityReadResponse();
      //expect(instance).to.be.a(VaFacilities.FacilityReadResponse);
    });
