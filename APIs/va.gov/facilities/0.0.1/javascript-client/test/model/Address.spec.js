...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.Address();
  });
  ...
  describe('Address', function() {
    it('should create an instance of Address', function() {
      ...
      //var instance = new VaFacilities.Address();
      //expect(instance).to.be.a(VaFacilities.Address);
    });
    ...
    it('should have the property address3 (base name: "address_3")', function() {
