...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.FacilityAttributes();
  });
  ...
  describe('FacilityAttributes', function() {
    it('should create an instance of FacilityAttributes', function() {
      // uncomment below and update the code to test FacilityAttributes
      //var instance = new VaFacilities.FacilityAttributes();
      //expect(instance).to.be.a(VaFacilities.FacilityAttributes);
    });
