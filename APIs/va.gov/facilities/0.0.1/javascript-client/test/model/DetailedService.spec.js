...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.DetailedService();
  });
  ...
  describe('DetailedService', function() {
    it('should create an instance of DetailedService', function() {
      // uncomment below and update the code to test DetailedService
      //var instance = new VaFacilities.DetailedService();
      //expect(instance).to.be.a(VaFacilities.DetailedService);
    });

    it('should have the property appointmentLeadin (base name: "appointment_leadin")', function() {
      // uncomment below and update the code to test the property appointmentLeadin
      //var instance = new VaFacilities.DetailedService();
      //expect(instance).to.be();
    });

    it('should have the property appointmentPhones (base name: "appointment_phones")', function() {
      // uncomment below and update the code to test the property appointmentPhones
      //var instance = new VaFacilities.DetailedService();
      //expect(instance).to.be();
    });

    it('should have the property descriptionFacility (base name: "description_facility")', function() {
      // uncomment below and update the code to test the property descriptionFacility
      //var instance = new VaFacilities.DetailedService();
      //expect(instance).to.be();
    });
    ...
    it('should have the property onlineSchedulingAvailable (base name: "online_scheduling_available")', function() {
      // uncomment below and update the code to test the property onlineSchedulingAvailable
      //var instance = new VaFacilities.DetailedService();
      //expect(instance).to.be();
    });
    ...
    it('should have the property referralRequired (base name: "referral_required")', function() {
      // uncomment below and update the code to test the property referralRequired
      //var instance = new VaFacilities.DetailedService();
      //expect(instance).to.be();
    });
    ...
    it('should have the property serviceLocations (base name: "service_locations")', function() {
      // uncomment below and update the code to test the property serviceLocations
      //var instance = new VaFacilities.DetailedService();
      //expect(instance).to.be();
    });

    it('should have the property walkInsAccepted (base name: "walk_ins_accepted")', function() {
      // uncomment below and update the code to test the property walkInsAccepted
      //var instance = new VaFacilities.DetailedService();
      //expect(instance).to.be();
    });
