...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.FacilitiesIdsResponse();
  });
  ...
  describe('FacilitiesIdsResponse', function() {
    it('should create an instance of FacilitiesIdsResponse', function() {
      // uncomment below and update the code to test FacilitiesIdsResponse
      //var instance = new VaFacilities.FacilitiesIdsResponse();
      //expect(instance).to.be.a(VaFacilities.FacilitiesIdsResponse);
    });
