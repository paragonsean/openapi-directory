...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.DetailedServiceHours();
  });
  ...
  describe('DetailedServiceHours', function() {
    it('should create an instance of DetailedServiceHours', function() {
      // uncomment below and update the code to test DetailedServiceHours
      //var instance = new VaFacilities.DetailedServiceHours();
      //expect(instance).to.be.a(VaFacilities.DetailedServiceHours);
    });
