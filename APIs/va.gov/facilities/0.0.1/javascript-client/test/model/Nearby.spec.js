...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.Nearby();
  });
  ...
  describe('Nearby', function() {
    it('should create an instance of Nearby', function() {
      // uncomment below and update the code to test Nearby
      //var instance = new VaFacilities.Nearby();
      //expect(instance).to.be.a(VaFacilities.Nearby);
    });
