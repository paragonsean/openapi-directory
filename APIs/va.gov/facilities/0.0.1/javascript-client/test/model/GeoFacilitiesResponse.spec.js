...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.GeoFacilitiesResponse();
  });
  ...
  describe('GeoFacilitiesResponse', function() {
    it('should create an instance of GeoFacilitiesResponse', function() {
      // uncomment below and update the code to test GeoFacilitiesResponse
      //var instance = new VaFacilities.GeoFacilitiesResponse();
      //expect(instance).to.be.a(VaFacilities.GeoFacilitiesResponse);
    });
