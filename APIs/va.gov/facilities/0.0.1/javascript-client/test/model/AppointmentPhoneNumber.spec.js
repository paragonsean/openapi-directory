...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.AppointmentPhoneNumber();
  });
  ...
  describe('AppointmentPhoneNumber', function() {
    it('should create an instance of AppointmentPhoneNumber', function() {
      // uncomment below and update the code to test AppointmentPhoneNumber
      //var instance = new VaFacilities.AppointmentPhoneNumber();
      //expect(instance).to.be.a(VaFacilities.AppointmentPhoneNumber);
    });
