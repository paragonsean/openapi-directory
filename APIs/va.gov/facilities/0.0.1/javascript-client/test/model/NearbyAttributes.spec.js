...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.NearbyAttributes();
  });
  ...
  describe('NearbyAttributes', function() {
    it('should create an instance of NearbyAttributes', function() {
      // uncomment below and update the code to test NearbyAttributes
      //var instance = new VaFacilities.NearbyAttributes();
      //expect(instance).to.be.a(VaFacilities.NearbyAttributes);
    });
