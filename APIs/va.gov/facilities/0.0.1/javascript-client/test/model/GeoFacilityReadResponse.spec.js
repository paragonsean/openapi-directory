...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.GeoFacilityReadResponse();
  });
  ...
  describe('GeoFacilityReadResponse', function() {
    it('should create an instance of GeoFacilityReadResponse', function() {
      // uncomment below and update the code to test GeoFacilityReadResponse
      //var instance = new VaFacilities.GeoFacilityReadResponse();
      //expect(instance).to.be.a(VaFacilities.GeoFacilityReadResponse);
    });
