...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.OperatingStatus();
  });
  ...
  describe('OperatingStatus', function() {
    it('should create an instance of OperatingStatus', function() {
      // uncomment below and update the code to test OperatingStatus
      //var instance = new VaFacilities.OperatingStatus();
      //expect(instance).to.be.a(VaFacilities.OperatingStatus);
    });
    ...
    it('should have the property supplementalStatus (base name: "supplemental_status")', function() {
      // uncomment below and update the code to test the property supplementalStatus
      //var instance = new VaFacilities.OperatingStatus();
      //expect(instance).to.be();
    });
