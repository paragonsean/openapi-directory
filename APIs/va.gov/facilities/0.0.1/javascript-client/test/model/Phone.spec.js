...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.Phone();
  });
  ...
  describe('Phone', function() {
    it('should create an instance of Phone', function() {
      ...
      //var instance = new VaFacilities.Phone();
      //expect(instance).to.be.a(VaFacilities.Phone);
    });

    it('should have the property afterHours (base name: "after_hours")', function() {
      // uncomment below and update the code to test the property afterHours
      //var instance = new VaFacilities.Phone();
      //expect(instance).to.be();
    });

    it('should have the property enrollmentCoordinator (base name: "enrollment_coordinator")', function() {
      // uncomment below and update the code to test the property enrollmentCoordinator
      //var instance = new VaFacilities.Phone();
      //expect(instance).to.be();
    });
    ...
    it('should have the property healthConnect (base name: "health_connect")', function() {
      // uncomment below and update the code to test the property healthConnect
      //var instance = new VaFacilities.Phone();
      //expect(instance).to.be();
    });
    ...
    it('should have the property mentalHealthClinic (base name: "mental_health_clinic")', function() {
      // uncomment below and update the code to test the property mentalHealthClinic
      //var instance = new VaFacilities.Phone();
      //expect(instance).to.be();
    });

    it('should have the property patientAdvocate (base name: "patient_advocate")', function() {
      // uncomment below and update the code to test the property patientAdvocate
      //var instance = new VaFacilities.Phone();
      //expect(instance).to.be();
    });
