...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.DetailedServiceLocation();
  });
  ...
  describe('DetailedServiceLocation', function() {
    it('should create an instance of DetailedServiceLocation', function() {
      // uncomment below and update the code to test DetailedServiceLocation
      //var instance = new VaFacilities.DetailedServiceLocation();
      //expect(instance).to.be.a(VaFacilities.DetailedServiceLocation);
    });

    it('should have the property additionalHoursInfo (base name: "additional_hours_info")', function() {
      // uncomment below and update the code to test the property additionalHoursInfo
      //var instance = new VaFacilities.DetailedServiceLocation();
    ...
    it('should have the property emailContacts (base name: "email_contacts")', function() {
      // uncomment below and update the code to test the property emailContacts
      //var instance = new VaFacilities.DetailedServiceLocation();
      //expect(instance).to.be();
    });

    it('should have the property facilityServiceHours (base name: "facility_service_hours")', function() {
      // uncomment below and update the code to test the property facilityServiceHours
      //var instance = new VaFacilities.DetailedServiceLocation();
      //expect(instance).to.be();
    });

    it('should have the property serviceLocationAddress (base name: "service_location_address")', function() {
      // uncomment below and update the code to test the property serviceLocationAddress
      //var instance = new VaFacilities.DetailedServiceLocation();
      //expect(instance).to.be();
    });
