...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.PageLinks();
  });
  ...
  describe('PageLinks', function() {
    it('should create an instance of PageLinks', function() {
      // uncomment below and update the code to test PageLinks
      //var instance = new VaFacilities.PageLinks();
      //expect(instance).to.be.a(VaFacilities.PageLinks);
    });
