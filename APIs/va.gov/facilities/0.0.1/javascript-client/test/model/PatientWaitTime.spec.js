...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.PatientWaitTime();
  });
  ...
  describe('PatientWaitTime', function() {
    it('should create an instance of PatientWaitTime', function() {
      // uncomment below and update the code to test PatientWaitTime
      //var instance = new VaFacilities.PatientWaitTime();
      //expect(instance).to.be.a(VaFacilities.PatientWaitTime);
    });
