...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.DetailedServiceEmailContact();
  });
  ...
  describe('DetailedServiceEmailContact', function() {
    it('should create an instance of DetailedServiceEmailContact', function() {
      // uncomment below and update the code to test DetailedServiceEmailContact
      //var instance = new VaFacilities.DetailedServiceEmailContact();
      //expect(instance).to.be.a(VaFacilities.DetailedServiceEmailContact);
    });
    ...
    it('should have the property emailLabel (base name: "email_label")', function() {
      // uncomment below and update the code to test the property emailLabel
      //var instance = new VaFacilities.DetailedServiceEmailContact();
      //expect(instance).to.be();
    });
