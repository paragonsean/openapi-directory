...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.Meta();
  });
  ...
  describe('Meta', function() {
    it('should create an instance of Meta', function() {
      ...
      //var instance = new VaFacilities.Meta();
      //expect(instance).to.be.a(VaFacilities.Meta);
    });

    it('should have the property bandVersion (base name: "band_version")', function() {
      // uncomment below and update the code to test the property bandVersion
      //var instance = new VaFacilities.Meta();
