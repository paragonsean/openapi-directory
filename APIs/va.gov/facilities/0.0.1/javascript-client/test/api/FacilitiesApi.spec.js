...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaFacilities.FacilitiesApi();
  });
  ...
  describe('FacilitiesApi', function() {
    describe('getAllFacilities', function() {
      it('should call getAllFacilities successfully', function(done) {
        //uncomment below and update the code to test getAllFacilities
        //instance.getAllFacilities(function(error) {
    ...
    describe('getFacilitiesByLocation', function() {
      it('should call getFacilitiesByLocation successfully', function(done) {
        //uncomment below and update the code to test getFacilitiesByLocation
        //instance.getFacilitiesByLocation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getFacilityById', function() {
      it('should call getFacilityById successfully', function(done) {
        //uncomment below and update the code to test getFacilityById
        //instance.getFacilityById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getFacilityIds', function() {
      it('should call getFacilityIds successfully', function(done) {
        //uncomment below and update the code to test getFacilityIds
        //instance.getFacilityIds(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getNearbyFacilities', function() {
      it('should call getNearbyFacilities successfully', function(done) {
        //uncomment below and update the code to test getNearbyFacilities
        //instance.getNearbyFacilities(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
