...
#ifndef OAINearbyResponse_H
#define OAINearbyResponse_H
...
class OAINearbyResponse : public OAIObject {
public:
    OAINearbyResponse();
    OAINearbyResponse(QString json);
    ~OAINearbyResponse() override;
    ...
    QList<OAINearby> getData() const;
    void setData(const QList<OAINearby> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAINearbyResponse)

#endif // OAINearbyResponse_H
