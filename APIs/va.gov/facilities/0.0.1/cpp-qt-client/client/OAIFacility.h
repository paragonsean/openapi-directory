...
public:
    ...
    OAIFacilityAttributes getAttributes() const;
    void setAttributes(const OAIFacilityAttributes &attributes);
...
private:
    ...
    OAIFacilityAttributes m_attributes;
