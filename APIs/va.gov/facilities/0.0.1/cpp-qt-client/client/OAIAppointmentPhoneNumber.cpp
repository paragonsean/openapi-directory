...
OAIAppointmentPhoneNumber::OAIAppointmentPhoneNumber(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAppointmentPhoneNumber::OAIAppointmentPhoneNumber() {
    this->initializeModel();
}

OAIAppointmentPhoneNumber::~OAIAppointmentPhoneNumber() {}

void OAIAppointmentPhoneNumber::initializeModel() {
...
void OAIAppointmentPhoneNumber::fromJson(QString jsonString) {
...
void OAIAppointmentPhoneNumber::fromJsonObject(QJsonObject json) {
...
QString OAIAppointmentPhoneNumber::asJson() const {
...
QJsonObject OAIAppointmentPhoneNumber::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAppointmentPhoneNumber::getExtension() const {
    return m_extension;
}
void OAIAppointmentPhoneNumber::setExtension(const QString &extension) {
    m_extension = extension;
    m_extension_isSet = true;
}

bool OAIAppointmentPhoneNumber::is_extension_Set() const{
    return m_extension_isSet;
}

bool OAIAppointmentPhoneNumber::is_extension_Valid() const{
    return m_extension_isValid;
}

QString OAIAppointmentPhoneNumber::getLabel() const {
    return m_label;
}
void OAIAppointmentPhoneNumber::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIAppointmentPhoneNumber::is_label_Set() const{
    return m_label_isSet;
}

bool OAIAppointmentPhoneNumber::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIAppointmentPhoneNumber::getNumber() const {
    return m_number;
}
void OAIAppointmentPhoneNumber::setNumber(const QString &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIAppointmentPhoneNumber::is_number_Set() const{
    return m_number_isSet;
}

bool OAIAppointmentPhoneNumber::is_number_Valid() const{
    return m_number_isValid;
}

QString OAIAppointmentPhoneNumber::getType() const {
    return m_type;
}
void OAIAppointmentPhoneNumber::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAppointmentPhoneNumber::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAppointmentPhoneNumber::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAppointmentPhoneNumber::isSet() const {
...
bool OAIAppointmentPhoneNumber::isValid() const {
