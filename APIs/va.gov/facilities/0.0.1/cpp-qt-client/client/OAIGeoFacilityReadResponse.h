...
/*
 * OAIGeoFacilityReadResponse.h
 *
 * Response that contains GeoFacility data.
 */

#ifndef OAIGeoFacilityReadResponse_H
#define OAIGeoFacilityReadResponse_H
...
class OAIGeoFacilityReadResponse : public OAIObject {
public:
    OAIGeoFacilityReadResponse();
    OAIGeoFacilityReadResponse(QString json);
    ~OAIGeoFacilityReadResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoFacilityReadResponse)

#endif // OAIGeoFacilityReadResponse_H
