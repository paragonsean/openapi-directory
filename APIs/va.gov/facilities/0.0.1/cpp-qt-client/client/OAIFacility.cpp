...
OAIFacilityAttributes OAIFacility::getAttributes() const {
    return m_attributes;
}
void OAIFacility::setAttributes(const OAIFacilityAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIFacility::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIFacility::is_attributes_Valid() const{
