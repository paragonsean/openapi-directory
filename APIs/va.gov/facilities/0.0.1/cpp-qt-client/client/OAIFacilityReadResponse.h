...
/*
 * OAIFacilityReadResponse.h
 *
 * Response that contains facility data.
 */

#ifndef OAIFacilityReadResponse_H
#define OAIFacilityReadResponse_H
...
class OAIFacilityReadResponse : public OAIObject {
public:
    OAIFacilityReadResponse();
    OAIFacilityReadResponse(QString json);
    ~OAIFacilityReadResponse() override;
    ...
    OAIFacility getData() const;
    void setData(const OAIFacility &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFacilityReadResponse)

#endif // OAIFacilityReadResponse_H
