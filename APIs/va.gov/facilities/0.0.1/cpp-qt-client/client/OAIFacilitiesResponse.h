...
/*
 * OAIFacilitiesResponse.h
 *
 * JSON API-compliant response object describing one or more VA facilities
 */

#ifndef OAIFacilitiesResponse_H
#define OAIFacilitiesResponse_H
...
class OAIFacility;
class OAIPageLinks;
class OAIFacilitiesMetadata;

class OAIFacilitiesResponse : public OAIObject {
public:
    OAIFacilitiesResponse();
    OAIFacilitiesResponse(QString json);
    ~OAIFacilitiesResponse() override;
    ...
    QList<OAIFacility> getData() const;
    void setData(const QList<OAIFacility> &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIPageLinks getLinks() const;
    void setLinks(const OAIPageLinks &links);
    bool is_links_Set() const;
    bool is_links_Valid() const;

    OAIFacilitiesMetadata getMeta() const;
    void setMeta(const OAIFacilitiesMetadata &meta);
...
private:
    ...
    QList<OAIFacility> m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIPageLinks m_links;
    bool m_links_isSet;
    bool m_links_isValid;

    OAIFacilitiesMetadata m_meta;
    bool m_meta_isSet;
    bool m_meta_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIFacilitiesResponse)

#endif // OAIFacilitiesResponse_H
