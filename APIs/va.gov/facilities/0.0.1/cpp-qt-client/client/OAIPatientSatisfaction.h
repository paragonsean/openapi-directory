...
/*
 * OAIPatientSatisfaction.h
 *
 * Veteran-reported satisfaction score for health care services at VA health facilities.
 */

#ifndef OAIPatientSatisfaction_H
#define OAIPatientSatisfaction_H
...
class OAIPatientSatisfaction : public OAIObject {
public:
    OAIPatientSatisfaction();
    OAIPatientSatisfaction(QString json);
    ~OAIPatientSatisfaction() override;
    ...
    float getPrimaryCareRoutine() const;
    void setPrimaryCareRoutine(const float &primary_care_routine);
    bool is_primary_care_routine_Set() const;
    bool is_primary_care_routine_Valid() const;

    float getPrimaryCareUrgent() const;
    void setPrimaryCareUrgent(const float &primary_care_urgent);
    bool is_primary_care_urgent_Set() const;
    bool is_primary_care_urgent_Valid() const;

    float getSpecialtyCareRoutine() const;
    void setSpecialtyCareRoutine(const float &specialty_care_routine);
    bool is_specialty_care_routine_Set() const;
    bool is_specialty_care_routine_Valid() const;

    float getSpecialtyCareUrgent() const;
    void setSpecialtyCareUrgent(const float &specialty_care_urgent);
    bool is_specialty_care_urgent_Set() const;
    bool is_specialty_care_urgent_Valid() const;
...
private:
    ...
    float m_primary_care_routine;
    bool m_primary_care_routine_isSet;
    bool m_primary_care_routine_isValid;

    float m_primary_care_urgent;
    bool m_primary_care_urgent_isSet;
    bool m_primary_care_urgent_isValid;

    float m_specialty_care_routine;
    bool m_specialty_care_routine_isSet;
    bool m_specialty_care_routine_isValid;

    float m_specialty_care_urgent;
    bool m_specialty_care_urgent_isSet;
    bool m_specialty_care_urgent_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPatientSatisfaction)

#endif // OAIPatientSatisfaction_H
