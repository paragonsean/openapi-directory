...
/*
 * OAISupplementalStatus.h
 *
 * Supplemental status for VA facility.
 */

#ifndef OAISupplementalStatus_H
#define OAISupplementalStatus_H
...
class OAISupplementalStatus : public OAIObject {
public:
    OAISupplementalStatus();
    OAISupplementalStatus(QString json);
    ~OAISupplementalStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupplementalStatus)

#endif // OAISupplementalStatus_H
