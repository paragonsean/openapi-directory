...
#ifndef OAIWaitTimes_H
#define OAIWaitTimes_H
...
namespace OpenAPI {
class OAIPatientWaitTime;

class OAIWaitTimes : public OAIObject {
public:
    OAIWaitTimes();
    OAIWaitTimes(QString json);
    ~OAIWaitTimes() override;
    ...
    QList<OAIPatientWaitTime> getHealth() const;
    void setHealth(const QList<OAIPatientWaitTime> &health);
...
private:
    ...
    QList<OAIPatientWaitTime> m_health;
    bool m_health_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWaitTimes)

#endif // OAIWaitTimes_H
