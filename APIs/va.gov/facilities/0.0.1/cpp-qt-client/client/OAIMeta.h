...
public:
    ...
    QString getBandVersion() const;
    void setBandVersion(const QString &band_version);
    bool is_band_version_Set() const;
    bool is_band_version_Valid() const;
...
private:
    ...
    QString m_band_version;
    bool m_band_version_isSet;
    bool m_band_version_isValid;
};
