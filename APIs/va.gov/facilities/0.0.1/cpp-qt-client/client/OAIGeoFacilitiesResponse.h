...
/*
 * OAIGeoFacilitiesResponse.h
 *
 * GeoJSON API-compliant response object describing one or more VA facilities.
 */

#ifndef OAIGeoFacilitiesResponse_H
#define OAIGeoFacilitiesResponse_H
...
namespace OpenAPI {
class OAIGeoFacility;

class OAIGeoFacilitiesResponse : public OAIObject {
public:
    OAIGeoFacilitiesResponse();
    OAIGeoFacilitiesResponse(QString json);
    ~OAIGeoFacilitiesResponse() override;
    ...
    QList<OAIGeoFacility> getFeatures() const;
    void setFeatures(const QList<OAIGeoFacility> &features);
...
private:
    ...
    QList<OAIGeoFacility> m_features;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoFacilitiesResponse)

#endif // OAIGeoFacilitiesResponse_H
