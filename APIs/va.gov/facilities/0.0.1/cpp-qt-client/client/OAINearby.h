...
namespace OpenAPI {
class OAINearbyAttributes;

class OAINearby : public OAIObject {
public:
    OAINearby();
    OAINearby(QString json);
    ~OAINearby() override;
    ...
    OAINearbyAttributes getAttributes() const;
    void setAttributes(const OAINearbyAttributes &attributes);
...
private:
    ...
    OAINearbyAttributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAINearby)
