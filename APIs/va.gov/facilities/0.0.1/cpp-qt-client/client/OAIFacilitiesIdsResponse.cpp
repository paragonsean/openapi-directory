...
OAIFacilitiesIdsResponse::OAIFacilitiesIdsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFacilitiesIdsResponse::OAIFacilitiesIdsResponse() {
    this->initializeModel();
}

OAIFacilitiesIdsResponse::~OAIFacilitiesIdsResponse() {}

void OAIFacilitiesIdsResponse::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIFacilitiesIdsResponse::fromJson(QString jsonString) {
...
void OAIFacilitiesIdsResponse::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIFacilitiesIdsResponse::asJson() const {
...
QJsonObject OAIFacilitiesIdsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<QString> OAIFacilitiesIdsResponse::getData() const {
    return m_data;
}
void OAIFacilitiesIdsResponse::setData(const QList<QString> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIFacilitiesIdsResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIFacilitiesIdsResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIFacilitiesIdsResponse::isSet() const {
...
bool OAIFacilitiesIdsResponse::isValid() const {
