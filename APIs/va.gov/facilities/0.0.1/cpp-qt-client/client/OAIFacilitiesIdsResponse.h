...
/*
 * OAIFacilitiesIdsResponse.h
 *
 * JSON API response for a query for facility ids.
 */

#ifndef OAIFacilitiesIdsResponse_H
#define OAIFacilitiesIdsResponse_H
...
class OAIFacilitiesIdsResponse : public OAIObject {
public:
    OAIFacilitiesIdsResponse();
    OAIFacilitiesIdsResponse(QString json);
    ~OAIFacilitiesIdsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFacilitiesIdsResponse)

#endif // OAIFacilitiesIdsResponse_H
