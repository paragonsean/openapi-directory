...
void OAIMeta::initializeModel() {
    ...
    m_band_version_isSet = false;
    m_band_version_isValid = false;
}
...
void OAIMeta::fromJsonObject(QJsonObject json) {
    ...
    m_band_version_isValid = ::OpenAPI::fromJsonValue(m_band_version, json[QString("band_version")]);
    m_band_version_isSet = !json[QString("band_version")].isNull() && m_band_version_isValid;
}
...
QJsonObject OAIMeta::asJsonObject() const {
    QJsonObject obj;
    if (m_band_version_isSet) {
        obj.insert(QString("band_version"), ::OpenAPI::toJsonValue(m_band_version));
    }
    return obj;
}

QString OAIMeta::getBandVersion() const {
    return m_band_version;
}
void OAIMeta::setBandVersion(const QString &band_version) {
    m_band_version = band_version;
    m_band_version_isSet = true;
}

bool OAIMeta::is_band_version_Set() const{
    return m_band_version_isSet;
}

bool OAIMeta::is_band_version_Valid() const{
    return m_band_version_isValid;
}
