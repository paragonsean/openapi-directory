...
/*
 * OAIFacilityAttributes.h
 *
 * Details describing a facility.
 */

#ifndef OAIFacilityAttributes_H
#define OAIFacilityAttributes_H
...
class OAIFacilityAttributes : public OAIObject {
public:
    OAIFacilityAttributes();
    OAIFacilityAttributes(QString json);
    ~OAIFacilityAttributes() override;
    ...
    float getRLong() const;
    void setRLong(const float &r_long);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFacilityAttributes)

#endif // OAIFacilityAttributes_H
