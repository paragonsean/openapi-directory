...
public:
    ...
    OAIAddress getPhysical() const;
    void setPhysical(const OAIAddress &physical);
    bool is_physical_Set() const;
    bool is_physical_Valid() const;
...
private:
    ...
    OAIAddress m_physical;
    bool m_physical_isSet;
    bool m_physical_isValid;
};
