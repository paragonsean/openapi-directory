...
#ifndef OAIGeoFacility_H
#define OAIGeoFacility_H
...
class OAIGeoFacility : public OAIObject {
public:
    OAIGeoFacility();
    OAIGeoFacility(QString json);
    ~OAIGeoFacility() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoFacility)

#endif // OAIGeoFacility_H
