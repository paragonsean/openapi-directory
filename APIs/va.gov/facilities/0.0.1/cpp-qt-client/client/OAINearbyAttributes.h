...
/*
 * OAINearbyAttributes.h
 *
 * 
 */

#ifndef OAINearbyAttributes_H
#define OAINearbyAttributes_H
...
class OAINearbyAttributes : public OAIObject {
public:
    OAINearbyAttributes();
    OAINearbyAttributes(QString json);
    ~OAINearbyAttributes() override;
    ...
    qint32 getMaxTime() const;
    void setMaxTime(const qint32 &max_time);
    bool is_max_time_Set() const;
    bool is_max_time_Valid() const;

    qint32 getMinTime() const;
    void setMinTime(const qint32 &min_time);
    bool is_min_time_Set() const;
    bool is_min_time_Valid() const;
...
private:
    ...
    qint32 m_min_time;
    bool m_min_time_isSet;
    bool m_min_time_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAINearbyAttributes)

#endif // OAINearbyAttributes_H
