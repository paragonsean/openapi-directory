...
import org.openapitools.client.model.PatientSatisfaction;
...
public class Satisfaction {
  ...
  private PatientSatisfaction health;

  public Satisfaction() {
  }

  public Satisfaction effectiveDate(LocalDate effectiveDate) {
  ...
  public Satisfaction health(PatientSatisfaction health) {
    this.health = health;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PatientSatisfaction getHealth() {
    return health;
  }

  public void setHealth(PatientSatisfaction health) {
    this.health = health;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.effectiveDate, satisfaction.effectiveDate) &&
        Objects.equals(this.health, satisfaction.health);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Satisfaction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Satisfaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Satisfaction is not found in the empty JSON string", Satisfaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Satisfaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Satisfaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `health`
      if (jsonObj.get("health") != null && !jsonObj.get("health").isJsonNull()) {
        PatientSatisfaction.validateJsonElement(jsonObj.get("health"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Satisfaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Satisfaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Satisfaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Satisfaction.class));

       return (TypeAdapter<T>) new TypeAdapter<Satisfaction>() {
           @Override
           public void write(JsonWriter out, Satisfaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Satisfaction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Satisfaction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Satisfaction
   * @throws IOException if the JSON string is invalid with respect to Satisfaction
   */
  public static Satisfaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Satisfaction.class);
  }

  /**
   * Convert an instance of Satisfaction to an JSON string
   *
   * @return JSON string
   */
