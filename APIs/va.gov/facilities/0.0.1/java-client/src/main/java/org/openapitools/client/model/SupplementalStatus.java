...
public class SupplementalStatus {
  ...
  public SupplementalStatus id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SupplementalStatus label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SupplementalStatus supplementalStatus = (SupplementalStatus) o;
    return Objects.equals(this.id, supplementalStatus.id) &&
        Objects.equals(this.label, supplementalStatus.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupplementalStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupplementalStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupplementalStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupplementalStatus is not found in the empty JSON string", SupplementalStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupplementalStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupplementalStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SupplementalStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupplementalStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupplementalStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupplementalStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupplementalStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<SupplementalStatus>() {
           @Override
           public void write(JsonWriter out, SupplementalStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupplementalStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupplementalStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupplementalStatus
   * @throws IOException if the JSON string is invalid with respect to SupplementalStatus
   */
  public static SupplementalStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupplementalStatus.class);
  }

  /**
   * Convert an instance of SupplementalStatus to an JSON string
   *
   * @return JSON string
   */
