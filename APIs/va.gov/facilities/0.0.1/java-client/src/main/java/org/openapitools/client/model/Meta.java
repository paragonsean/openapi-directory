...
public class Meta {
  public static final String SERIALIZED_NAME_BAND_VERSION = "band_version";
  @SerializedName(SERIALIZED_NAME_BAND_VERSION)
  private String bandVersion;

  public Meta() {
  }

  public Meta bandVersion(String bandVersion) {
  ...
  public boolean equals(Object o) {
    ...
    Meta meta = (Meta) o;
    return Objects.equals(this.bandVersion, meta.bandVersion);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bandVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("    bandVersion: ").append(toIndentedString(bandVersion)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("band_version");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("band_version") != null && !jsonObj.get("band_version").isJsonNull()) && !jsonObj.get("band_version").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `band_version` to be a primitive type in the JSON string but got `%s`", jsonObj.get("band_version").toString()));
      }
  }
