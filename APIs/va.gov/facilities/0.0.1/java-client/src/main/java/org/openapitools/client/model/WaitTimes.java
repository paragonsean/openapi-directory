...
import org.openapitools.client.model.PatientWaitTime;
...
public class WaitTimes {
  ...
  private List<PatientWaitTime> health;

  public WaitTimes() {
  }

  public WaitTimes effectiveDate(LocalDate effectiveDate) {
  ...
  public WaitTimes health(List<PatientWaitTime> health) {
    this.health = health;
    return this;
  }

  public WaitTimes addHealthItem(PatientWaitTime healthItem) {
    if (this.health == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<PatientWaitTime> getHealth() {
    return health;
  }

  public void setHealth(List<PatientWaitTime> health) {
    this.health = health;
  }
  ...
  public boolean equals(Object o) {
    ...
    WaitTimes waitTimes = (WaitTimes) o;
    return Objects.equals(this.effectiveDate, waitTimes.effectiveDate) &&
        Objects.equals(this.health, waitTimes.health);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(effectiveDate, health);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WaitTimes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WaitTimes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WaitTimes is not found in the empty JSON string", WaitTimes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WaitTimes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WaitTimes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("health") != null && !jsonObj.get("health").isJsonNull()) {
        JsonArray jsonArrayhealth = jsonObj.getAsJsonArray("health");
        if (jsonArrayhealth != null) {
          // ensure the json data is an array
          if (!jsonObj.get("health").isJsonArray()) {
          ...
          for (int i = 0; i < jsonArrayhealth.size(); i++) {
            PatientWaitTime.validateJsonElement(jsonArrayhealth.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WaitTimes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WaitTimes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WaitTimes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WaitTimes.class));

       return (TypeAdapter<T>) new TypeAdapter<WaitTimes>() {
           @Override
           public void write(JsonWriter out, WaitTimes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WaitTimes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WaitTimes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WaitTimes
   * @throws IOException if the JSON string is invalid with respect to WaitTimes
   */
  public static WaitTimes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WaitTimes.class);
  }

  /**
   * Convert an instance of WaitTimes to an JSON string
   *
   * @return JSON string
   */
