...
public class ListEndUserTypeResponse {
  ...
  private List<NumbersV2RegulatoryComplianceEndUserType> endUserTypes = new ArrayList<>();
  ...
  public ListEndUserTypeResponse endUserTypes(List<NumbersV2RegulatoryComplianceEndUserType> endUserTypes) {
    this.endUserTypes = endUserTypes;
    return this;
  }

  public ListEndUserTypeResponse addEndUserTypesItem(NumbersV2RegulatoryComplianceEndUserType endUserTypesItem) {
  ...
  public List<NumbersV2RegulatoryComplianceEndUserType> getEndUserTypes() {
    return endUserTypes;
  }

  public void setEndUserTypes(List<NumbersV2RegulatoryComplianceEndUserType> endUserTypes) {
    this.endUserTypes = endUserTypes;
  }


  public ListEndUserTypeResponse meta(ListAuthorizationDocumentResponseMeta meta) {
    this.meta = meta;
    return this;
  }
      ...
      if (jsonObj.get("end_user_types") != null && !jsonObj.get("end_user_types").isJsonNull()) {
        ...
        if (jsonArrayendUserTypes != null) {
          ...
          for (int i = 0; i < jsonArrayendUserTypes.size(); i++) {
            NumbersV2RegulatoryComplianceEndUserType.validateJsonElement(jsonArrayendUserTypes.get(i));
          };
        }
      }
