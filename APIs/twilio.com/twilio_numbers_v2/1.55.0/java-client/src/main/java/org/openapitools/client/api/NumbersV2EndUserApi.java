...
public class NumbersV2EndUserApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public NumbersV2EndUserApi() {
        this(Configuration.getDefaultApiClient());
    }

    public NumbersV2EndUserApi(ApiClient apiClient) {
     ...
     */
    public okhttp3.Call createEndUserCall(String friendlyName, EndUserEnumType type, Object attributes, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2/RegulatoryCompliance/EndUsers";
    ...
    private okhttp3.Call createEndUserValidateBeforeCall(String friendlyName, EndUserEnumType type, Object attributes, final ApiCallback _callback) throws ApiException {
     ...
     */
    public NumbersV2RegulatoryComplianceEndUser createEndUser(String friendlyName, EndUserEnumType type, Object attributes) throws ApiException {
        ApiResponse<NumbersV2RegulatoryComplianceEndUser> localVarResp = createEndUserWithHttpInfo(friendlyName, type, attributes);
     ...
     * @param type  (required)
     * @param attributes The set of parameters that are the attributes of the End User resource which are derived End User Types. (optional)
     * @return ApiResponse&lt;NumbersV2RegulatoryComplianceEndUser&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<NumbersV2RegulatoryComplianceEndUser> createEndUserWithHttpInfo(String friendlyName, EndUserEnumType type, Object attributes) throws ApiException {
        okhttp3.Call localVarCall = createEndUserValidateBeforeCall(friendlyName, type, attributes, null);
        Type localVarReturnType = new TypeToken<NumbersV2RegulatoryComplianceEndUser>(){}.getType();
     ...
     */
    public okhttp3.Call createEndUserAsync(String friendlyName, EndUserEnumType type, Object attributes, final ApiCallback<NumbersV2RegulatoryComplianceEndUser> _callback) throws ApiException {
    ...
    public okhttp3.Call deleteEndUserCall(String sid, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/RegulatoryCompliance/EndUsers/{Sid}"
     ...
     */
    public NumbersV2RegulatoryComplianceEndUser fetchEndUser(String sid) throws ApiException {
        ApiResponse<NumbersV2RegulatoryComplianceEndUser> localVarResp = fetchEndUserWithHttpInfo(sid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NumbersV2RegulatoryComplianceEndUser> fetchEndUserWithHttpInfo(String sid) throws ApiException {
     ...
     */
    public okhttp3.Call fetchEndUserAsync(String sid, final ApiCallback<NumbersV2RegulatoryComplianceEndUser> _callback) throws ApiException {
     ...
     */
    public NumbersV2RegulatoryComplianceEndUser updateEndUser(String sid, Object attributes, String friendlyName) throws ApiException {
        ApiResponse<NumbersV2RegulatoryComplianceEndUser> localVarResp = updateEndUserWithHttpInfo(sid, attributes, friendlyName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NumbersV2RegulatoryComplianceEndUser> updateEndUserWithHttpInfo(String sid, Object attributes, String friendlyName) throws ApiException {
     ...
     */
    public okhttp3.Call updateEndUserAsync(String sid, Object attributes, String friendlyName, final ApiCallback<NumbersV2RegulatoryComplianceEndUser> _callback) throws ApiException {
