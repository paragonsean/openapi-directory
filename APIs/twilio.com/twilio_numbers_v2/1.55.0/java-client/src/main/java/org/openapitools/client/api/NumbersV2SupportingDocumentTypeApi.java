...
public class NumbersV2SupportingDocumentTypeApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public NumbersV2SupportingDocumentTypeApi() {
        this(Configuration.getDefaultApiClient());
    }

    public NumbersV2SupportingDocumentTypeApi(ApiClient apiClient) {
    ...
    public okhttp3.Call fetchSupportingDocumentTypeCall(String sid, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2/RegulatoryCompliance/SupportingDocumentTypes/{Sid}"
     ...
     */
    public NumbersV2RegulatoryComplianceSupportingDocumentType fetchSupportingDocumentType(String sid) throws ApiException {
        ApiResponse<NumbersV2RegulatoryComplianceSupportingDocumentType> localVarResp = fetchSupportingDocumentTypeWithHttpInfo(sid);
     ...
     * Fetch a specific Supporting Document Type Instance.
     * @param sid The unique string that identifies the Supporting Document Type resource. (required)
     * @return ApiResponse&lt;NumbersV2RegulatoryComplianceSupportingDocumentType&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<NumbersV2RegulatoryComplianceSupportingDocumentType> fetchSupportingDocumentTypeWithHttpInfo(String sid) throws ApiException {
        okhttp3.Call localVarCall = fetchSupportingDocumentTypeValidateBeforeCall(sid, null);
        Type localVarReturnType = new TypeToken<NumbersV2RegulatoryComplianceSupportingDocumentType>(){}.getType();
     ...
     */
    public okhttp3.Call fetchSupportingDocumentTypeAsync(String sid, final ApiCallback<NumbersV2RegulatoryComplianceSupportingDocumentType> _callback) throws ApiException {
    ...
    public okhttp3.Call listSupportingDocumentTypeCall(Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/RegulatoryCompliance/SupportingDocumentTypes";
