...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioNumbers.NumbersV2HostedNumberOrder();
  });
  ...
  describe('NumbersV2HostedNumberOrder', function() {
    it('should create an instance of NumbersV2HostedNumberOrder', function() {
      // uncomment below and update the code to test NumbersV2HostedNumberOrder
      //var instance = new TwilioNumbers.NumbersV2HostedNumberOrder();
      //expect(instance).to.be.a(TwilioNumbers.NumbersV2HostedNumberOrder);
    });
