...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioNumbers.NumbersV2RegulatoryComplianceSupportingDocument();
  });
  ...
  describe('NumbersV2RegulatoryComplianceSupportingDocument', function() {
    it('should create an instance of NumbersV2RegulatoryComplianceSupportingDocument', function() {
      // uncomment below and update the code to test NumbersV2RegulatoryComplianceSupportingDocument
      //var instance = new TwilioNumbers.NumbersV2RegulatoryComplianceSupportingDocument();
      //expect(instance).to.be.a(TwilioNumbers.NumbersV2RegulatoryComplianceSupportingDocument);
    });
