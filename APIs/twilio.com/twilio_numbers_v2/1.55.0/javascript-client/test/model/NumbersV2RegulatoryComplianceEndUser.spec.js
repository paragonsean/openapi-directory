...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioNumbers.NumbersV2RegulatoryComplianceEndUser();
  });
  ...
  describe('NumbersV2RegulatoryComplianceEndUser', function() {
    it('should create an instance of NumbersV2RegulatoryComplianceEndUser', function() {
      // uncomment below and update the code to test NumbersV2RegulatoryComplianceEndUser
      //var instance = new TwilioNumbers.NumbersV2RegulatoryComplianceEndUser();
      //expect(instance).to.be.a(TwilioNumbers.NumbersV2RegulatoryComplianceEndUser);
    });
