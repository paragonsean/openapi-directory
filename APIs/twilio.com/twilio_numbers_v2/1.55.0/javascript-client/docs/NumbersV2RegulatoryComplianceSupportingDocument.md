# TwilioNumbers.NumbersV2RegulatoryComplianceSupportingDocument
...
**attributes** | **Object** | The set of parameters that are the attributes of the Supporting Documents resource which are listed in the Supporting Document Types. | [optional] 
...
**mimeType** | **String** | The image type uploaded in the Supporting Document container. | [optional] 
**sid** | **String** | The unique string created by Twilio to identify the Supporting Document resource. | [optional] 
**status** | [**SupportingDocumentEnumStatus**](SupportingDocumentEnumStatus.md) |  | [optional] 
