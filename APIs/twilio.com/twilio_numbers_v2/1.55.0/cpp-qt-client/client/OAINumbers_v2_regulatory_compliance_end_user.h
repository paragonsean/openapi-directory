...
/*
 * OAINumbers_v2_regulatory_compliance_end_user.h
 *
 * 
 */

#ifndef OAINumbers_v2_regulatory_compliance_end_user_H
#define OAINumbers_v2_regulatory_compliance_end_user_H
...
class OAINumbers_v2_regulatory_compliance_end_user : public OAIObject {
public:
    OAINumbers_v2_regulatory_compliance_end_user();
    OAINumbers_v2_regulatory_compliance_end_user(QString json);
    ~OAINumbers_v2_regulatory_compliance_end_user() override;
    ...
    OAIEnd_user_enum_type getType() const;
    void setType(const OAIEnd_user_enum_type &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAINumbers_v2_regulatory_compliance_end_user)

#endif // OAINumbers_v2_regulatory_compliance_end_user_H
