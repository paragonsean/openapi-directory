...
/*
 * OAINumbers_v2_regulatory_compliance_bundle_replace_items.h
 *
 * 
 */

#ifndef OAINumbers_v2_regulatory_compliance_bundle_replace_items_H
#define OAINumbers_v2_regulatory_compliance_bundle_replace_items_H
...
class OAINumbers_v2_regulatory_compliance_bundle_replace_items : public OAIObject {
public:
    OAINumbers_v2_regulatory_compliance_bundle_replace_items();
    OAINumbers_v2_regulatory_compliance_bundle_replace_items(QString json);
    ~OAINumbers_v2_regulatory_compliance_bundle_replace_items() override;
    ...
    OAIReplace_items_enum_status getStatus() const;
    void setStatus(const OAIReplace_items_enum_status &status);
...
private:
    ...
    OAIReplace_items_enum_status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumbers_v2_regulatory_compliance_bundle_replace_items)

#endif // OAINumbers_v2_regulatory_compliance_bundle_replace_items_H
