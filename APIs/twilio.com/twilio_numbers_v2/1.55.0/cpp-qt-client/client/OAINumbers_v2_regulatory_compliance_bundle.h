...
/*
 * OAINumbers_v2_regulatory_compliance_bundle.h
 *
 * 
 */

#ifndef OAINumbers_v2_regulatory_compliance_bundle_H
#define OAINumbers_v2_regulatory_compliance_bundle_H
...
class OAINumbers_v2_regulatory_compliance_bundle : public OAIObject {
public:
    OAINumbers_v2_regulatory_compliance_bundle();
    OAINumbers_v2_regulatory_compliance_bundle(QString json);
    ~OAINumbers_v2_regulatory_compliance_bundle() override;
    ...
    OAIBundle_enum_status getStatus() const;
    void setStatus(const OAIBundle_enum_status &status);
...
private:
    ...
    OAIBundle_enum_status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumbers_v2_regulatory_compliance_bundle)

#endif // OAINumbers_v2_regulatory_compliance_bundle_H
