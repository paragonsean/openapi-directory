...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioMicrovisor.MicrovisorV1Device();
  });
  ...
  describe('MicrovisorV1Device', function() {
    it('should create an instance of MicrovisorV1Device', function() {
      // uncomment below and update the code to test MicrovisorV1Device
      //var instance = new TwilioMicrovisor.MicrovisorV1Device();
      //expect(instance).to.be.a(TwilioMicrovisor.MicrovisorV1Device);
    });
