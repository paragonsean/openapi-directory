...
/*
 * OAIMicrovisor_v1_device.h
 *
 * 
 */

#ifndef OAIMicrovisor_v1_device_H
#define OAIMicrovisor_v1_device_H
...
class OAIMicrovisor_v1_device : public OAIObject {
public:
    OAIMicrovisor_v1_device();
    OAIMicrovisor_v1_device(QString json);
    ~OAIMicrovisor_v1_device() override;
    ...
    QJsonValue getApp() const;
    void setApp(const QJsonValue &app);
    ...
    QJsonValue getLogging() const;
    void setLogging(const QJsonValue &logging);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMicrovisor_v1_device)

#endif // OAIMicrovisor_v1_device_H
