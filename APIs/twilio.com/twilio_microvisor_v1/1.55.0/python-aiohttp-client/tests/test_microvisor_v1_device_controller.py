...
async def test_fetch_device(client):
    """Test case for fetch_device
    ...
    response = await client.request(
        method='GET',
        path='/v1/Devices/{sid}'.format(sid='sid_example'),
        headers=headers,
        )
...
async def test_list_device(client):
