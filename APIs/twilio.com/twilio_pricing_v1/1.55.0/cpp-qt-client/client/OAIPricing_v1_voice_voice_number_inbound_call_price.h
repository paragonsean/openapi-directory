...
/*
 * OAIPricing_v1_voice_voice_number_inbound_call_price.h
 *
...
#ifndef OAIPricing_v1_voice_voice_number_inbound_call_price_H
#define OAIPricing_v1_voice_voice_number_inbound_call_price_H
...
class OAIPricing_v1_voice_voice_number_inbound_call_price : public OAIObject {
public:
    OAIPricing_v1_voice_voice_number_inbound_call_price();
    OAIPricing_v1_voice_voice_number_inbound_call_price(QString json);
    ~OAIPricing_v1_voice_voice_number_inbound_call_price() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPricing_v1_voice_voice_number_inbound_call_price)

#endif // OAIPricing_v1_voice_voice_number_inbound_call_price_H
