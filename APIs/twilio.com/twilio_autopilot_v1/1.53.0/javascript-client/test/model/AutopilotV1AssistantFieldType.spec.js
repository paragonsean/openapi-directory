...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioAutopilot.AutopilotV1AssistantFieldType();
  });
  ...
  describe('AutopilotV1AssistantFieldType', function() {
    it('should create an instance of AutopilotV1AssistantFieldType', function() {
      // uncomment below and update the code to test AutopilotV1AssistantFieldType
      //var instance = new TwilioAutopilot.AutopilotV1AssistantFieldType();
      //expect(instance).to.be.a(TwilioAutopilot.AutopilotV1AssistantFieldType);
    });
