...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioAutopilot.AutopilotV1AssistantTask();
  });
  ...
  describe('AutopilotV1AssistantTask', function() {
    it('should create an instance of AutopilotV1AssistantTask', function() {
      // uncomment below and update the code to test AutopilotV1AssistantTask
      //var instance = new TwilioAutopilot.AutopilotV1AssistantTask();
      //expect(instance).to.be.a(TwilioAutopilot.AutopilotV1AssistantTask);
    });
    ...
    it('should have the property actionsUrl (base name: "actions_url")', function() {
      // uncomment below and update the code to test the property actionsUrl
      //var instance = new TwilioAutopilot.AutopilotV1AssistantTask();
      //expect(instance).to.be();
    });
