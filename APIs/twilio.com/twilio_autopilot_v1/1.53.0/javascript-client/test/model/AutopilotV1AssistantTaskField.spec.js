...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioAutopilot.AutopilotV1AssistantTaskField();
  });
  ...
  describe('AutopilotV1AssistantTaskField', function() {
    it('should create an instance of AutopilotV1AssistantTaskField', function() {
      // uncomment below and update the code to test AutopilotV1AssistantTaskField
      //var instance = new TwilioAutopilot.AutopilotV1AssistantTaskField();
      //expect(instance).to.be.a(TwilioAutopilot.AutopilotV1AssistantTaskField);
    });
