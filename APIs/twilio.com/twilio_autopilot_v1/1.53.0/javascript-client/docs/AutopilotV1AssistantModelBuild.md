# TwilioAutopilot.AutopilotV1AssistantModelBuild
...
**buildDuration** | **Number** | The time in seconds it took to build the model. | [optional] 
...
**errorCode** | **Number** | If the &#x60;status&#x60; for the model build is &#x60;failed&#x60;, this value is a code to more information about the failure. This value will be null for all other statuses. See [error code dictionary](https://www.twilio.com/docs/api/errors) for a description of the error. | [optional] 
**sid** | **String** | The unique string that we created to identify the ModelBuild resource. | [optional] 
**status** | [**ModelBuildEnumStatus**](ModelBuildEnumStatus.md) |  | [optional] 
