# TwilioAutopilot.AutopilotV1AssistantFieldType

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountSid** | **String** | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the FieldType resource. | [optional] 
...
**sid** | **String** | The unique string that we created to identify the FieldType resource. | [optional] 
