...
/*
 * OAIAutopilot_v1_assistant_field_type.h
 *
 * 
 */

#ifndef OAIAutopilot_v1_assistant_field_type_H
#define OAIAutopilot_v1_assistant_field_type_H
...
class OAIAutopilot_v1_assistant_field_type : public OAIObject {
public:
    OAIAutopilot_v1_assistant_field_type();
    OAIAutopilot_v1_assistant_field_type(QString json);
    ~OAIAutopilot_v1_assistant_field_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutopilot_v1_assistant_field_type)

#endif // OAIAutopilot_v1_assistant_field_type_H
