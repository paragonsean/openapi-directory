...
/*
 * OAIAutopilot_v1_assistant_dialogue.h
 *
 * 
 */

#ifndef OAIAutopilot_v1_assistant_dialogue_H
#define OAIAutopilot_v1_assistant_dialogue_H
...
class OAIAutopilot_v1_assistant_dialogue : public OAIObject {
public:
    OAIAutopilot_v1_assistant_dialogue();
    OAIAutopilot_v1_assistant_dialogue(QString json);
    ~OAIAutopilot_v1_assistant_dialogue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutopilot_v1_assistant_dialogue)

#endif // OAIAutopilot_v1_assistant_dialogue_H
