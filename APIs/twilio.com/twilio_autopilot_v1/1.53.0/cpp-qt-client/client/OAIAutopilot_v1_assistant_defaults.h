...
/*
 * OAIAutopilot_v1_assistant_defaults.h
 *
 * 
 */

#ifndef OAIAutopilot_v1_assistant_defaults_H
#define OAIAutopilot_v1_assistant_defaults_H
...
class OAIAutopilot_v1_assistant_defaults : public OAIObject {
public:
    OAIAutopilot_v1_assistant_defaults();
    OAIAutopilot_v1_assistant_defaults(QString json);
    ~OAIAutopilot_v1_assistant_defaults() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutopilot_v1_assistant_defaults)

#endif // OAIAutopilot_v1_assistant_defaults_H
