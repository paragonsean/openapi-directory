...
/*
 * OAIAutopilot_v1_assistant_task.h
 *
 * 
 */

#ifndef OAIAutopilot_v1_assistant_task_H
#define OAIAutopilot_v1_assistant_task_H
...
class OAIAutopilot_v1_assistant_task : public OAIObject {
public:
    OAIAutopilot_v1_assistant_task();
    OAIAutopilot_v1_assistant_task(QString json);
    ~OAIAutopilot_v1_assistant_task() override;
    ...
    QString getActionsUrl() const;
    void setActionsUrl(const QString &actions_url);
    bool is_actions_url_Set() const;
    bool is_actions_url_Valid() const;
...
private:
    ...
    QString m_actions_url;
    bool m_actions_url_isSet;
    bool m_actions_url_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutopilot_v1_assistant_task)

#endif // OAIAutopilot_v1_assistant_task_H
