# TwilioStudio.StudioV1FlowEngagementStepStepContext

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountSid** | **String** | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the StepContext resource. | [optional] 
...
**stepSid** | **String** | The SID of the Step the context is associated with. | [optional] 
