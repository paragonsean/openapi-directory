...
import ExecutionEnumStatus from './ExecutionEnumStatus';

/**
 * The StudioV1FlowExecution model module.
 * @module model/StudioV1FlowExecution
 * @version 1.55.0
 */
class StudioV1FlowExecution {
    /**
     * Constructs a new <code>StudioV1FlowExecution</code>.
     * @alias module:model/StudioV1FlowExecution
     */
    constructor() { 
        
        StudioV1FlowExecution.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StudioV1FlowExecution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StudioV1FlowExecution} obj Optional instance to populate.
     * @return {module:model/StudioV1FlowExecution} The populated <code>StudioV1FlowExecution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StudioV1FlowExecution();
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = ExecutionEnumStatus.constructFromObject(data['status']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StudioV1FlowExecution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StudioV1FlowExecution</code>.
     */
 ...
 */
StudioV1FlowExecution.prototype['account_sid'] = undefined;
 ...
 */
StudioV1FlowExecution.prototype['contact_channel_address'] = undefined;

/**
 * The SID of the Contact.
 * @member {String} contact_sid
 */
StudioV1FlowExecution.prototype['contact_sid'] = undefined;

/**
 * The current state of the Flow's Execution. As a flow executes, we save its state in this context. We save data that your widgets can access as variables in configuration fields or in text areas as variable substitution.
 * @member {Object} context
 */
StudioV1FlowExecution.prototype['context'] = undefined;

/**
 * The date and time in GMT when the resource was created specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_created
 */
StudioV1FlowExecution.prototype['date_created'] = undefined;

/**
 * The date and time in GMT when the resource was last updated specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_updated
 */
StudioV1FlowExecution.prototype['date_updated'] = undefined;

/**
 * The SID of the Flow.
 * @member {String} flow_sid
 */
StudioV1FlowExecution.prototype['flow_sid'] = undefined;

/**
 * The URLs of nested resources.
 * @member {Object} links
 */
StudioV1FlowExecution.prototype['links'] = undefined;

/**
 * The unique string that we created to identify the Execution resource.
 * @member {String} sid
 */
StudioV1FlowExecution.prototype['sid'] = undefined;

/**
 * @member {module:model/ExecutionEnumStatus} status
 */
StudioV1FlowExecution.prototype['status'] = undefined;

/**
 * The absolute URL of the resource.
 * @member {String} url
 */
StudioV1FlowExecution.prototype['url'] = undefined;
...
export default StudioV1FlowExecution;
