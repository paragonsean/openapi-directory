...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioStudio.StudioV1Flow();
  });
  ...
  describe('StudioV1Flow', function() {
    it('should create an instance of StudioV1Flow', function() {
      // uncomment below and update the code to test StudioV1Flow
      //var instance = new TwilioStudio.StudioV1Flow();
      //expect(instance).to.be.a(TwilioStudio.StudioV1Flow);
    });
