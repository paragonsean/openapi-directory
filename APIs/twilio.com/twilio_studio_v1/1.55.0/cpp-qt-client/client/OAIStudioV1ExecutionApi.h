...
#ifndef OAI_OAIStudioV1ExecutionApi_H
#define OAI_OAIStudioV1ExecutionApi_H
...
class OAIStudioV1ExecutionApi : public QObject {
    Q_OBJECT

public:
    OAIStudioV1ExecutionApi(const int timeOut = 0);
    ~OAIStudioV1ExecutionApi();
...
Q_SIGNALS:
    ...
    void createExecutionSignal(OAIStudio_v1_flow_execution summary);
    void deleteExecutionSignal();
    void fetchExecutionSignal(OAIStudio_v1_flow_execution summary);
    void listExecutionSignal(OAIListExecutionResponse summary);
    void updateExecutionSignal(OAIStudio_v1_flow_execution summary);


    void createExecutionSignalFull(OAIHttpRequestWorker *worker, OAIStudio_v1_flow_execution summary);
    void deleteExecutionSignalFull(OAIHttpRequestWorker *worker);
    void fetchExecutionSignalFull(OAIHttpRequestWorker *worker, OAIStudio_v1_flow_execution summary);
    void listExecutionSignalFull(OAIHttpRequestWorker *worker, OAIListExecutionResponse summary);
    void updateExecutionSignalFull(OAIHttpRequestWorker *worker, OAIStudio_v1_flow_execution summary);

    Q_DECL_DEPRECATED_X("Use createExecutionSignalError() instead")
    void createExecutionSignalE(OAIStudio_v1_flow_execution summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createExecutionSignalError(OAIStudio_v1_flow_execution summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchExecutionSignalE(OAIStudio_v1_flow_execution summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchExecutionSignalError(OAIStudio_v1_flow_execution summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateExecutionSignalE(OAIStudio_v1_flow_execution summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateExecutionSignalError(OAIStudio_v1_flow_execution summary, QNetworkReply::NetworkError error_type, const QString &error_str);
