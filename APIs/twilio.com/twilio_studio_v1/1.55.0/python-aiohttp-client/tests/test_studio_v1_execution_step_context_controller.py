...
async def test_fetch_execution_step_context(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/Flows/{flow_sid}/Executions/{execution_sid}/Steps/{step_sid}/Context'.format(flow_sid='flow_sid_example', execution_sid='execution_sid_example', step_sid='step_sid_example'),
        headers=headers,
        )
