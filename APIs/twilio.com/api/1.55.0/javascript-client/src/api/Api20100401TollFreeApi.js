...
/**
* Api20100401TollFree service.
* @module api/Api20100401TollFreeApi
* @version 1.55.0
*/
export default class Api20100401TollFreeApi {

    /**
    * Constructs a new Api20100401TollFreeApi. 
    * @alias module:api/Api20100401TollFreeApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createIncomingPhoneNumberTollFree operation.
     * @callback module:api/Api20100401TollFreeApi~createIncomingPhoneNumberTollFreeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree} data The data returned by the service call.
     ...
     * @param {module:model/IncomingPhoneNumberTollFreeEnumEmergencyStatus} [emergencyStatus] 
     ...
     * @param {module:model/IncomingPhoneNumberTollFreeEnumVoiceReceiveMode} [voiceReceiveMode] 
     ...
     * @param {module:api/Api20100401TollFreeApi~createIncomingPhoneNumberTollFreeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree}
     */
    createIncomingPhoneNumberTollFree(accountSid, phoneNumber, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling createIncomingPhoneNumberTollFree");
      }
      // verify the required parameter 'phoneNumber' is set
      if (phoneNumber === undefined || phoneNumber === null) {
        throw new Error("Missing the required parameter 'phoneNumber' when calling createIncomingPhoneNumberTollFree");
      }
      ...
      let returnType = ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree;
      ...
      return this.apiClient.callApi(
        '/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/TollFree.json', 'POST',
    ...
    /**
     * Callback function to receive the result of the listAvailablePhoneNumberTollFree operation.
     * @callback module:api/Api20100401TollFreeApi~listAvailablePhoneNumberTollFreeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListAvailablePhoneNumberTollFreeResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/Api20100401TollFreeApi~listAvailablePhoneNumberTollFreeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListAvailablePhoneNumberTollFreeResponse}
     */
    listAvailablePhoneNumberTollFree(accountSid, countryCode, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling listAvailablePhoneNumberTollFree");
      }
      // verify the required parameter 'countryCode' is set
      if (countryCode === undefined || countryCode === null) {
        throw new Error("Missing the required parameter 'countryCode' when calling listAvailablePhoneNumberTollFree");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ListAvailablePhoneNumberTollFreeResponse;
      let basePaths = ['https://api.twilio.com'];
      let basePath = basePaths[0]; // by default use the first one in "servers" defined in OpenAPI
      if (typeof opts['_base_path_index'] !== 'undefined') {
        if (opts['_base_path_index']  >= basePaths.length || opts['_base_path_index'] <  0) {
      ...
      return this.apiClient.callApi(
        '/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/TollFree.json', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the listIncomingPhoneNumberTollFree operation.
     * @callback module:api/Api20100401TollFreeApi~listIncomingPhoneNumberTollFreeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListIncomingPhoneNumberTollFreeResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [page] The page index. This value is simply for client state.
     * @param {String} [pageToken] The page token. This is provided by the API.
     * @param {module:api/Api20100401TollFreeApi~listIncomingPhoneNumberTollFreeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListIncomingPhoneNumberTollFreeResponse}
     */
    listIncomingPhoneNumberTollFree(accountSid, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling listIncomingPhoneNumberTollFree");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ListIncomingPhoneNumberTollFreeResponse;
      let basePaths = ['https://api.twilio.com'];
      let basePath = basePaths[0]; // by default use the first one in "servers" defined in OpenAPI
      if (typeof opts['_base_path_index'] !== 'undefined') {
        if (opts['_base_path_index']  >= basePaths.length || opts['_base_path_index'] <  0) {
      ...
      return this.apiClient.callApi(
        '/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/TollFree.json', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath, callback
      );
    }
