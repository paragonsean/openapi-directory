...
/**
* Api20100401MachineToMachine service.
* @module api/Api20100401MachineToMachineApi
* @version 1.55.0
*/
export default class Api20100401MachineToMachineApi {

    /**
    * Constructs a new Api20100401MachineToMachineApi. 
    * @alias module:api/Api20100401MachineToMachineApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the listAvailablePhoneNumberMachineToMachine operation.
     * @callback module:api/Api20100401MachineToMachineApi~listAvailablePhoneNumberMachineToMachineCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListAvailablePhoneNumberMachineToMachineResponse} data The data returned by the service call.
     ...
     * @param {module:api/Api20100401MachineToMachineApi~listAvailablePhoneNumberMachineToMachineCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListAvailablePhoneNumberMachineToMachineResponse}
     */
    listAvailablePhoneNumberMachineToMachine(accountSid, countryCode, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling listAvailablePhoneNumberMachineToMachine");
      }
      // verify the required parameter 'countryCode' is set
      if (countryCode === undefined || countryCode === null) {
        throw new Error("Missing the required parameter 'countryCode' when calling listAvailablePhoneNumberMachineToMachine");
      }
      ...
      let returnType = ListAvailablePhoneNumberMachineToMachineResponse;
      ...
      return this.apiClient.callApi(
        '/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/MachineToMachine.json', 'GET',
