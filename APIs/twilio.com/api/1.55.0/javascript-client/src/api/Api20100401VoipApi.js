...
/**
* Api20100401Voip service.
* @module api/Api20100401VoipApi
* @version 1.55.0
*/
export default class Api20100401VoipApi {

    /**
    * Constructs a new Api20100401VoipApi. 
    * @alias module:api/Api20100401VoipApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the listAvailablePhoneNumberVoip operation.
     * @callback module:api/Api20100401VoipApi~listAvailablePhoneNumberVoipCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListAvailablePhoneNumberVoipResponse} data The data returned by the service call.
     ...
     * @param {module:api/Api20100401VoipApi~listAvailablePhoneNumberVoipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListAvailablePhoneNumberVoipResponse}
     */
    listAvailablePhoneNumberVoip(accountSid, countryCode, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling listAvailablePhoneNumberVoip");
      }
      // verify the required parameter 'countryCode' is set
      if (countryCode === undefined || countryCode === null) {
        throw new Error("Missing the required parameter 'countryCode' when calling listAvailablePhoneNumberVoip");
      }
      ...
      let returnType = ListAvailablePhoneNumberVoipResponse;
      ...
      return this.apiClient.callApi(
        '/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Voip.json', 'GET',
