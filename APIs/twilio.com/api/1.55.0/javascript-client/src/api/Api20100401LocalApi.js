...
/**
* Api20100401Local service.
* @module api/Api20100401LocalApi
* @version 1.55.0
*/
export default class Api20100401LocalApi {

    /**
    * Constructs a new Api20100401LocalApi. 
    * @alias module:api/Api20100401LocalApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createIncomingPhoneNumberLocal operation.
     * @callback module:api/Api20100401LocalApi~createIncomingPhoneNumberLocalCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal} data The data returned by the service call.
     ...
     * @param {module:model/IncomingPhoneNumberLocalEnumEmergencyStatus} [emergencyStatus] 
     ...
     * @param {module:model/IncomingPhoneNumberLocalEnumVoiceReceiveMode} [voiceReceiveMode] 
     ...
     * @param {module:api/Api20100401LocalApi~createIncomingPhoneNumberLocalCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal}
     */
    createIncomingPhoneNumberLocal(accountSid, phoneNumber, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling createIncomingPhoneNumberLocal");
      }
      // verify the required parameter 'phoneNumber' is set
      if (phoneNumber === undefined || phoneNumber === null) {
        throw new Error("Missing the required parameter 'phoneNumber' when calling createIncomingPhoneNumberLocal");
      }
      ...
      let returnType = ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal;
      ...
      return this.apiClient.callApi(
        '/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json', 'POST',
    ...
    /**
     * Callback function to receive the result of the listAvailablePhoneNumberLocal operation.
     * @callback module:api/Api20100401LocalApi~listAvailablePhoneNumberLocalCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListAvailablePhoneNumberLocalResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/Api20100401LocalApi~listAvailablePhoneNumberLocalCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListAvailablePhoneNumberLocalResponse}
     */
    listAvailablePhoneNumberLocal(accountSid, countryCode, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling listAvailablePhoneNumberLocal");
      }
      // verify the required parameter 'countryCode' is set
      if (countryCode === undefined || countryCode === null) {
        throw new Error("Missing the required parameter 'countryCode' when calling listAvailablePhoneNumberLocal");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ListAvailablePhoneNumberLocalResponse;
      let basePaths = ['https://api.twilio.com'];
      let basePath = basePaths[0]; // by default use the first one in "servers" defined in OpenAPI
      if (typeof opts['_base_path_index'] !== 'undefined') {
        if (opts['_base_path_index']  >= basePaths.length || opts['_base_path_index'] <  0) {
      ...
      return this.apiClient.callApi(
        '/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Local.json', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the listIncomingPhoneNumberLocal operation.
     * @callback module:api/Api20100401LocalApi~listIncomingPhoneNumberLocalCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListIncomingPhoneNumberLocalResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [page] The page index. This value is simply for client state.
     * @param {String} [pageToken] The page token. This is provided by the API.
     * @param {module:api/Api20100401LocalApi~listIncomingPhoneNumberLocalCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListIncomingPhoneNumberLocalResponse}
     */
    listIncomingPhoneNumberLocal(accountSid, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling listIncomingPhoneNumberLocal");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ListIncomingPhoneNumberLocalResponse;
      let basePaths = ['https://api.twilio.com'];
      let basePath = basePaths[0]; // by default use the first one in "servers" defined in OpenAPI
      if (typeof opts['_base_path_index'] !== 'undefined') {
        if (opts['_base_path_index']  >= basePaths.length || opts['_base_path_index'] <  0) {
      ...
      return this.apiClient.callApi(
        '/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath, callback
      );
    }
