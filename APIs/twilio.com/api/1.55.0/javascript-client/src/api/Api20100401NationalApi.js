...
/**
* Api20100401National service.
* @module api/Api20100401NationalApi
* @version 1.55.0
*/
export default class Api20100401NationalApi {

    /**
    * Constructs a new Api20100401NationalApi. 
    * @alias module:api/Api20100401NationalApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the listAvailablePhoneNumberNational operation.
     * @callback module:api/Api20100401NationalApi~listAvailablePhoneNumberNationalCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ListAvailablePhoneNumberNationalResponse} data The data returned by the service call.
     ...
     * @param {module:api/Api20100401NationalApi~listAvailablePhoneNumberNationalCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListAvailablePhoneNumberNationalResponse}
     */
    listAvailablePhoneNumberNational(accountSid, countryCode, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling listAvailablePhoneNumberNational");
      }
      // verify the required parameter 'countryCode' is set
      if (countryCode === undefined || countryCode === null) {
        throw new Error("Missing the required parameter 'countryCode' when calling listAvailablePhoneNumberNational");
      }
      ...
      let returnType = ListAvailablePhoneNumberNationalResponse;
      ...
      return this.apiClient.callApi(
        '/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/National.json', 'GET',
