...
/**
* Api20100401Siprec service.
* @module api/Api20100401SiprecApi
* @version 1.55.0
*/
export default class Api20100401SiprecApi {

    /**
    * Constructs a new Api20100401SiprecApi. 
    * @alias module:api/Api20100401SiprecApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createSiprec operation.
     * @callback module:api/Api20100401SiprecApi~createSiprecCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ApiV2010AccountCallSiprec} data The data returned by the service call.
     ...
     * @param {module:model/SiprecEnumTrack} [track] 
     * @param {module:api/Api20100401SiprecApi~createSiprecCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ApiV2010AccountCallSiprec}
     */
    createSiprec(accountSid, callSid, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling createSiprec");
      }
      // verify the required parameter 'callSid' is set
      if (callSid === undefined || callSid === null) {
        throw new Error("Missing the required parameter 'callSid' when calling createSiprec");
      }
      ...
      let returnType = ApiV2010AccountCallSiprec;
      ...
      return this.apiClient.callApi(
        '/2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Siprec.json', 'POST',
    ...
    /**
     * Callback function to receive the result of the updateSiprec operation.
     * @callback module:api/Api20100401SiprecApi~updateSiprecCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ApiV2010AccountCallSiprec} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/SiprecEnumUpdateStatus} status 
     * @param {module:api/Api20100401SiprecApi~updateSiprecCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ApiV2010AccountCallSiprec}
     */
    updateSiprec(accountSid, callSid, sid, status, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountSid' is set
      if (accountSid === undefined || accountSid === null) {
        throw new Error("Missing the required parameter 'accountSid' when calling updateSiprec");
      }
      // verify the required parameter 'callSid' is set
      if (callSid === undefined || callSid === null) {
        throw new Error("Missing the required parameter 'callSid' when calling updateSiprec");
      }
      // verify the required parameter 'sid' is set
      if (sid === undefined || sid === null) {
        throw new Error("Missing the required parameter 'sid' when calling updateSiprec");
      }
      // verify the required parameter 'status' is set
      if (status === undefined || status === null) {
        throw new Error("Missing the required parameter 'status' when calling updateSiprec");
      }
