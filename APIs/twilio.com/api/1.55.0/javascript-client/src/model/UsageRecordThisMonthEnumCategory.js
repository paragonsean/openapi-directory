...
/**
* Enum class UsageRecordThisMonthEnumCategory.
* @enum {}
* @readonly
*/
export default class UsageRecordThisMonthEnumCategory {
    ...
    /**
    * Returns a <code>UsageRecordThisMonthEnumCategory</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UsageRecordThisMonthEnumCategory} The enum <code>UsageRecordThisMonthEnumCategory</code> value.
    */
