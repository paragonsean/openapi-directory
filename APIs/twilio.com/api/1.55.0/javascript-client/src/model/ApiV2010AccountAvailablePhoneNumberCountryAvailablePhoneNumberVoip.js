...
/**
 * The ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip model module.
 * @module model/ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip
 * @version 1.55.0
 */
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip {
    /**
     * Constructs a new <code>ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip</code>.
     * @alias module:model/ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip
     */
    constructor() { 
        
        ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip} obj Optional instance to populate.
     * @return {module:model/ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip} The populated <code>ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip</code>.
     */
 ...
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['address_requirements'] = undefined;

/**
 * Whether the phone number is new to the Twilio platform. Can be: `true` or `false`.
 * @member {Boolean} beta
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['beta'] = undefined;

/**
 * @member {module:model/ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocalCapabilities} capabilities
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['capabilities'] = undefined;

/**
 * A formatted version of the phone number.
 * @member {String} friendly_name
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['friendly_name'] = undefined;

/**
 * The [ISO country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) of this phone number.
 * @member {String} iso_country
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['iso_country'] = undefined;
 ...
 * @member {String} lata
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['lata'] = undefined;

/**
 * The latitude of this phone number's location. Available for only phone numbers from the US and Canada.
 * @member {Number} latitude
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['latitude'] = undefined;

/**
 * The locality or city of this phone number's location.
 * @member {String} locality
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['locality'] = undefined;

/**
 * The longitude of this phone number's location. Available for only phone numbers from the US and Canada.
 * @member {Number} longitude
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['longitude'] = undefined;

/**
 * The phone number in [E.164](https://www.twilio.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number.
 * @member {String} phone_number
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['phone_number'] = undefined;

/**
 * The postal or ZIP code of this phone number's location. Available for only phone numbers from the US and Canada.
 * @member {String} postal_code
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['postal_code'] = undefined;
 ...
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['rate_center'] = undefined;
 ...
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip.prototype['region'] = undefined;
...
export default ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip;
