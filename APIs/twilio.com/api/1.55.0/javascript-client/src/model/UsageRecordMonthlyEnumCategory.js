...
/**
* Enum class UsageRecordMonthlyEnumCategory.
* @enum {}
* @readonly
*/
export default class UsageRecordMonthlyEnumCategory {
    ...
    /**
    * Returns a <code>UsageRecordMonthlyEnumCategory</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UsageRecordMonthlyEnumCategory} The enum <code>UsageRecordMonthlyEnumCategory</code> value.
    */
