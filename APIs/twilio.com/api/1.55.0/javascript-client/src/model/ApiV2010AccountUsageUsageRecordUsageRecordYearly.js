...
import UsageRecordYearlyEnumCategory from './UsageRecordYearlyEnumCategory';

/**
 * The ApiV2010AccountUsageUsageRecordUsageRecordYearly model module.
 * @module model/ApiV2010AccountUsageUsageRecordUsageRecordYearly
 * @version 1.55.0
 */
class ApiV2010AccountUsageUsageRecordUsageRecordYearly {
    /**
     * Constructs a new <code>ApiV2010AccountUsageUsageRecordUsageRecordYearly</code>.
     * @alias module:model/ApiV2010AccountUsageUsageRecordUsageRecordYearly
     */
    constructor() { 
        
        ApiV2010AccountUsageUsageRecordUsageRecordYearly.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2010AccountUsageUsageRecordUsageRecordYearly</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2010AccountUsageUsageRecordUsageRecordYearly} obj Optional instance to populate.
     * @return {module:model/ApiV2010AccountUsageUsageRecordUsageRecordYearly} The populated <code>ApiV2010AccountUsageUsageRecordUsageRecordYearly</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2010AccountUsageUsageRecordUsageRecordYearly();
            ...
            if (data.hasOwnProperty('category')) {
                obj['category'] = UsageRecordYearlyEnumCategory.constructFromObject(data['category']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2010AccountUsageUsageRecordUsageRecordYearly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2010AccountUsageUsageRecordUsageRecordYearly</code>.
     */
 ...
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['account_sid'] = undefined;

/**
 * The API version used to create the resource.
 * @member {String} api_version
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['api_version'] = undefined;

/**
 * Usage records up to date as of this timestamp, formatted as YYYY-MM-DDTHH:MM:SS+00:00. All timestamps are in GMT
 * @member {String} as_of
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['as_of'] = undefined;

/**
 * @member {module:model/UsageRecordYearlyEnumCategory} category
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['category'] = undefined;

/**
 * The number of usage events, such as the number of calls.
 * @member {String} count
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['count'] = undefined;

/**
 * The units in which `count` is measured, such as `calls` for calls or `messages` for SMS.
 * @member {String} count_unit
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['count_unit'] = undefined;

/**
 * A plain-language description of the usage category.
 * @member {String} description
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['description'] = undefined;
 ...
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['end_date'] = undefined;

/**
 * The total price of the usage in the currency specified in `price_unit` and associated with the account.
 * @member {Number} price
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['price'] = undefined;
 ...
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['price_unit'] = undefined;
 ...
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['start_date'] = undefined;
 ...
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['subresource_uris'] = undefined;

/**
 * The URI of the resource, relative to `https://api.twilio.com`.
 * @member {String} uri
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['uri'] = undefined;

/**
 * The amount used to bill usage and measured in units described in `usage_unit`.
 * @member {String} usage
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['usage'] = undefined;

/**
 * The units in which `usage` is measured, such as `minutes` for calls or `messages` for SMS.
 * @member {String} usage_unit
 */
ApiV2010AccountUsageUsageRecordUsageRecordYearly.prototype['usage_unit'] = undefined;
...
export default ApiV2010AccountUsageUsageRecordUsageRecordYearly;
