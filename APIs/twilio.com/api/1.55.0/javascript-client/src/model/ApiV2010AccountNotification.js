...
/**
 * The ApiV2010AccountNotification model module.
 * @module model/ApiV2010AccountNotification
 * @version 1.55.0
 */
class ApiV2010AccountNotification {
    /**
     * Constructs a new <code>ApiV2010AccountNotification</code>.
     * @alias module:model/ApiV2010AccountNotification
     */
    constructor() { 
        
        ApiV2010AccountNotification.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2010AccountNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2010AccountNotification} obj Optional instance to populate.
     * @return {module:model/ApiV2010AccountNotification} The populated <code>ApiV2010AccountNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2010AccountNotification();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2010AccountNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2010AccountNotification</code>.
     */
 ...
 */
ApiV2010AccountNotification.prototype['account_sid'] = undefined;
 ...
 */
ApiV2010AccountNotification.prototype['api_version'] = undefined;
 ...
 */
ApiV2010AccountNotification.prototype['call_sid'] = undefined;

/**
 * The date and time in GMT that the resource was created specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {String} date_created
 */
ApiV2010AccountNotification.prototype['date_created'] = undefined;

/**
 * The date and time in GMT that the resource was last updated specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {String} date_updated
 */
ApiV2010AccountNotification.prototype['date_updated'] = undefined;
 ...
 */
ApiV2010AccountNotification.prototype['error_code'] = undefined;

/**
 * An integer log level that corresponds to the type of notification: `0` is ERROR, `1` is WARNING.
 * @member {String} log
 */
ApiV2010AccountNotification.prototype['log'] = undefined;
 ...
 */
ApiV2010AccountNotification.prototype['message_date'] = undefined;

/**
 * The text of the notification.
 * @member {String} message_text
 */
ApiV2010AccountNotification.prototype['message_text'] = undefined;
 ...
 */
ApiV2010AccountNotification.prototype['more_info'] = undefined;
 ...
 * @member {module:model/ApiV2010AccountNotification.RequestMethodEnum} request_method
 */
ApiV2010AccountNotification.prototype['request_method'] = undefined;
 ...
 */
ApiV2010AccountNotification.prototype['request_url'] = undefined;

/**
 * The unique string that that we created to identify the Notification resource.
 * @member {String} sid
 */
ApiV2010AccountNotification.prototype['sid'] = undefined;

/**
 * The URI of the resource, relative to `https://api.twilio.com`.
 * @member {String} uri
 */
ApiV2010AccountNotification.prototype['uri'] = undefined;
 ...
 * @readonly
 */
ApiV2010AccountNotification['RequestMethodEnum'] = {
...
export default ApiV2010AccountNotification;
