...
/**
* Enum class UsageRecordYearlyEnumCategory.
* @enum {}
* @readonly
*/
export default class UsageRecordYearlyEnumCategory {
    ...
    /**
    * Returns a <code>UsageRecordYearlyEnumCategory</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UsageRecordYearlyEnumCategory} The enum <code>UsageRecordYearlyEnumCategory</code> value.
    */
