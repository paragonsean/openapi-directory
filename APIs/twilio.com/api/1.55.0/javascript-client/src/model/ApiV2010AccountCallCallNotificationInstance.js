...
/**
 * The ApiV2010AccountCallCallNotificationInstance model module.
 * @module model/ApiV2010AccountCallCallNotificationInstance
 * @version 1.55.0
 */
class ApiV2010AccountCallCallNotificationInstance {
    /**
     * Constructs a new <code>ApiV2010AccountCallCallNotificationInstance</code>.
     * @alias module:model/ApiV2010AccountCallCallNotificationInstance
     */
    constructor() { 
        
        ApiV2010AccountCallCallNotificationInstance.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2010AccountCallCallNotificationInstance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2010AccountCallCallNotificationInstance} obj Optional instance to populate.
     * @return {module:model/ApiV2010AccountCallCallNotificationInstance} The populated <code>ApiV2010AccountCallCallNotificationInstance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2010AccountCallCallNotificationInstance();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2010AccountCallCallNotificationInstance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2010AccountCallCallNotificationInstance</code>.
     */
 ...
 */
ApiV2010AccountCallCallNotificationInstance.prototype['account_sid'] = undefined;

/**
 * The API version used to create the Call Notification resource.
 * @member {String} api_version
 */
ApiV2010AccountCallCallNotificationInstance.prototype['api_version'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotificationInstance.prototype['call_sid'] = undefined;

/**
 * The date and time in GMT that the resource was created specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {String} date_created
 */
ApiV2010AccountCallCallNotificationInstance.prototype['date_created'] = undefined;

/**
 * The date and time in GMT that the resource was last updated specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {String} date_updated
 */
ApiV2010AccountCallCallNotificationInstance.prototype['date_updated'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotificationInstance.prototype['error_code'] = undefined;

/**
 * An integer log level that corresponds to the type of notification: `0` is ERROR, `1` is WARNING.
 * @member {String} log
 */
ApiV2010AccountCallCallNotificationInstance.prototype['log'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotificationInstance.prototype['message_date'] = undefined;

/**
 * The text of the notification.
 * @member {String} message_text
 */
ApiV2010AccountCallCallNotificationInstance.prototype['message_text'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotificationInstance.prototype['more_info'] = undefined;
 ...
 * @member {module:model/ApiV2010AccountCallCallNotificationInstance.RequestMethodEnum} request_method
 */
ApiV2010AccountCallCallNotificationInstance.prototype['request_method'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotificationInstance.prototype['request_url'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotificationInstance.prototype['request_variables'] = undefined;

/**
 * The HTTP body returned by your server.
 * @member {String} response_body
 */
ApiV2010AccountCallCallNotificationInstance.prototype['response_body'] = undefined;

/**
 * The HTTP headers returned by your server.
 * @member {String} response_headers
 */
ApiV2010AccountCallCallNotificationInstance.prototype['response_headers'] = undefined;

/**
 * The unique string that that we created to identify the Call Notification resource.
 * @member {String} sid
 */
ApiV2010AccountCallCallNotificationInstance.prototype['sid'] = undefined;

/**
 * The URI of the resource, relative to `https://api.twilio.com`.
 * @member {String} uri
 */
ApiV2010AccountCallCallNotificationInstance.prototype['uri'] = undefined;
 ...
 * @readonly
 */
ApiV2010AccountCallCallNotificationInstance['RequestMethodEnum'] = {
...
export default ApiV2010AccountCallCallNotificationInstance;
