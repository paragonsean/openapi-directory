...
/**
 * The ApiV2010AccountNewKey model module.
 * @module model/ApiV2010AccountNewKey
 * @version 1.55.0
 */
class ApiV2010AccountNewKey {
    /**
     * Constructs a new <code>ApiV2010AccountNewKey</code>.
     * @alias module:model/ApiV2010AccountNewKey
     */
    constructor() { 
        
        ApiV2010AccountNewKey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2010AccountNewKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2010AccountNewKey} obj Optional instance to populate.
     * @return {module:model/ApiV2010AccountNewKey} The populated <code>ApiV2010AccountNewKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2010AccountNewKey();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2010AccountNewKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2010AccountNewKey</code>.
     */
 ...
 */
ApiV2010AccountNewKey.prototype['date_created'] = undefined;
 ...
 */
ApiV2010AccountNewKey.prototype['date_updated'] = undefined;

/**
 * The string that you assigned to describe the resource.
 * @member {String} friendly_name
 */
ApiV2010AccountNewKey.prototype['friendly_name'] = undefined;
 ...
 */
ApiV2010AccountNewKey.prototype['secret'] = undefined;
 ...
 * @member {String} sid
 */
ApiV2010AccountNewKey.prototype['sid'] = undefined;
...
export default ApiV2010AccountNewKey;
