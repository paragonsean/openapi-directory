...
/**
 * The ApiV2010AccountSipSipCredentialList model module.
 * @module model/ApiV2010AccountSipSipCredentialList
 * @version 1.55.0
 */
class ApiV2010AccountSipSipCredentialList {
    /**
     * Constructs a new <code>ApiV2010AccountSipSipCredentialList</code>.
     * @alias module:model/ApiV2010AccountSipSipCredentialList
     */
    constructor() { 
        
        ApiV2010AccountSipSipCredentialList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2010AccountSipSipCredentialList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2010AccountSipSipCredentialList} obj Optional instance to populate.
     * @return {module:model/ApiV2010AccountSipSipCredentialList} The populated <code>ApiV2010AccountSipSipCredentialList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2010AccountSipSipCredentialList();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2010AccountSipSipCredentialList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2010AccountSipSipCredentialList</code>.
     */
 ...
 */
ApiV2010AccountSipSipCredentialList.prototype['account_sid'] = undefined;

/**
 * The date that this resource was created, given as GMT in [RFC 2822](https://www.php.net/manual/en/class.datetime.php#datetime.constants.rfc2822) format.
 * @member {String} date_created
 */
ApiV2010AccountSipSipCredentialList.prototype['date_created'] = undefined;

/**
 * The date that this resource was last updated, given as GMT in [RFC 2822](https://www.php.net/manual/en/class.datetime.php#datetime.constants.rfc2822) format.
 * @member {String} date_updated
 */
ApiV2010AccountSipSipCredentialList.prototype['date_updated'] = undefined;

/**
 * A human readable descriptive text that describes the CredentialList, up to 64 characters long.
 * @member {String} friendly_name
 */
ApiV2010AccountSipSipCredentialList.prototype['friendly_name'] = undefined;

/**
 * A 34 character string that uniquely identifies this resource.
 * @member {String} sid
 */
ApiV2010AccountSipSipCredentialList.prototype['sid'] = undefined;

/**
 * A list of credentials associated with this credential list.
 * @member {Object} subresource_uris
 */
ApiV2010AccountSipSipCredentialList.prototype['subresource_uris'] = undefined;

/**
 * The URI for this resource, relative to `https://api.twilio.com`.
 * @member {String} uri
 */
ApiV2010AccountSipSipCredentialList.prototype['uri'] = undefined;
...
export default ApiV2010AccountSipSipCredentialList;
