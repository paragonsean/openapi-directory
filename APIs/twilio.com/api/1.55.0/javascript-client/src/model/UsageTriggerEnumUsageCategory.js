...
/**
* Enum class UsageTriggerEnumUsageCategory.
* @enum {}
* @readonly
*/
export default class UsageTriggerEnumUsageCategory {
    ...
    /**
    * Returns a <code>UsageTriggerEnumUsageCategory</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UsageTriggerEnumUsageCategory} The enum <code>UsageTriggerEnumUsageCategory</code> value.
    */
