...
/**
 * The ApiV2010AccountKey model module.
 * @module model/ApiV2010AccountKey
 * @version 1.55.0
 */
class ApiV2010AccountKey {
    /**
     * Constructs a new <code>ApiV2010AccountKey</code>.
     * @alias module:model/ApiV2010AccountKey
     */
    constructor() { 
        
        ApiV2010AccountKey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2010AccountKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2010AccountKey} obj Optional instance to populate.
     * @return {module:model/ApiV2010AccountKey} The populated <code>ApiV2010AccountKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2010AccountKey();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2010AccountKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2010AccountKey</code>.
     */
 ...
 */
ApiV2010AccountKey.prototype['date_created'] = undefined;

/**
 * The date and time in GMT that the resource was last updated specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {String} date_updated
 */
ApiV2010AccountKey.prototype['date_updated'] = undefined;

/**
 * The string that you assigned to describe the resource.
 * @member {String} friendly_name
 */
ApiV2010AccountKey.prototype['friendly_name'] = undefined;

/**
 * The unique string that that we created to identify the Key resource.
 * @member {String} sid
 */
ApiV2010AccountKey.prototype['sid'] = undefined;
...
export default ApiV2010AccountKey;
