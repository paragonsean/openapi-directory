...
import UsageRecordEnumCategory from './UsageRecordEnumCategory';

/**
 * The ApiV2010AccountUsageUsageRecord model module.
 * @module model/ApiV2010AccountUsageUsageRecord
 * @version 1.55.0
 */
class ApiV2010AccountUsageUsageRecord {
    /**
     * Constructs a new <code>ApiV2010AccountUsageUsageRecord</code>.
     * @alias module:model/ApiV2010AccountUsageUsageRecord
     */
    constructor() { 
        
        ApiV2010AccountUsageUsageRecord.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2010AccountUsageUsageRecord</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2010AccountUsageUsageRecord} obj Optional instance to populate.
     * @return {module:model/ApiV2010AccountUsageUsageRecord} The populated <code>ApiV2010AccountUsageUsageRecord</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2010AccountUsageUsageRecord();
            ...
            if (data.hasOwnProperty('category')) {
                obj['category'] = UsageRecordEnumCategory.constructFromObject(data['category']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2010AccountUsageUsageRecord</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2010AccountUsageUsageRecord</code>.
     */
 ...
 */
ApiV2010AccountUsageUsageRecord.prototype['account_sid'] = undefined;

/**
 * The API version used to create the resource.
 * @member {String} api_version
 */
ApiV2010AccountUsageUsageRecord.prototype['api_version'] = undefined;

/**
 * Usage records up to date as of this timestamp, formatted as YYYY-MM-DDTHH:MM:SS+00:00. All timestamps are in GMT
 * @member {String} as_of
 */
ApiV2010AccountUsageUsageRecord.prototype['as_of'] = undefined;

/**
 * @member {module:model/UsageRecordEnumCategory} category
 */
ApiV2010AccountUsageUsageRecord.prototype['category'] = undefined;

/**
 * The number of usage events, such as the number of calls.
 * @member {String} count
 */
ApiV2010AccountUsageUsageRecord.prototype['count'] = undefined;

/**
 * The units in which `count` is measured, such as `calls` for calls or `messages` for SMS.
 * @member {String} count_unit
 */
ApiV2010AccountUsageUsageRecord.prototype['count_unit'] = undefined;

/**
 * A plain-language description of the usage category.
 * @member {String} description
 */
ApiV2010AccountUsageUsageRecord.prototype['description'] = undefined;
 ...
 */
ApiV2010AccountUsageUsageRecord.prototype['end_date'] = undefined;

/**
 * The total price of the usage in the currency specified in `price_unit` and associated with the account.
 * @member {Number} price
 */
ApiV2010AccountUsageUsageRecord.prototype['price'] = undefined;
 ...
 */
ApiV2010AccountUsageUsageRecord.prototype['price_unit'] = undefined;
 ...
 */
ApiV2010AccountUsageUsageRecord.prototype['start_date'] = undefined;
 ...
 */
ApiV2010AccountUsageUsageRecord.prototype['subresource_uris'] = undefined;

/**
 * The URI of the resource, relative to `https://api.twilio.com`.
 * @member {String} uri
 */
ApiV2010AccountUsageUsageRecord.prototype['uri'] = undefined;

/**
 * The amount used to bill usage and measured in units described in `usage_unit`.
 * @member {String} usage
 */
ApiV2010AccountUsageUsageRecord.prototype['usage'] = undefined;

/**
 * The units in which `usage` is measured, such as `minutes` for calls or `messages` for SMS.
 * @member {String} usage_unit
 */
ApiV2010AccountUsageUsageRecord.prototype['usage_unit'] = undefined;
...
export default ApiV2010AccountUsageUsageRecord;
