...
/**
* Enum class UsageRecordLastMonthEnumCategory.
* @enum {}
* @readonly
*/
export default class UsageRecordLastMonthEnumCategory {
    ...
    /**
    * Returns a <code>UsageRecordLastMonthEnumCategory</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UsageRecordLastMonthEnumCategory} The enum <code>UsageRecordLastMonthEnumCategory</code> value.
    */
