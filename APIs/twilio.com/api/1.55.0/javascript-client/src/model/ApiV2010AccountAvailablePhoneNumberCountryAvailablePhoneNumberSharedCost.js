...
/**
 * The ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost model module.
 * @module model/ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost
 * @version 1.55.0
 */
class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost {
    /**
     * Constructs a new <code>ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost</code>.
     * @alias module:model/ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost
     */
    constructor() { 
        
        ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost} obj Optional instance to populate.
     * @return {module:model/ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost} The populated <code>ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost</code>.
     */
 ...
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['address_requirements'] = undefined;

/**
 * Whether the phone number is new to the Twilio platform. Can be: `true` or `false`.
 * @member {Boolean} beta
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['beta'] = undefined;

/**
 * @member {module:model/ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocalCapabilities} capabilities
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['capabilities'] = undefined;

/**
 * A formatted version of the phone number.
 * @member {String} friendly_name
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['friendly_name'] = undefined;

/**
 * The [ISO country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) of this phone number.
 * @member {String} iso_country
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['iso_country'] = undefined;
 ...
 * @member {String} lata
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['lata'] = undefined;

/**
 * The latitude of this phone number's location. Available for only phone numbers from the US and Canada.
 * @member {Number} latitude
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['latitude'] = undefined;

/**
 * The locality or city of this phone number's location.
 * @member {String} locality
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['locality'] = undefined;

/**
 * The longitude of this phone number's location. Available for only phone numbers from the US and Canada.
 * @member {Number} longitude
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['longitude'] = undefined;

/**
 * The phone number in [E.164](https://www.twilio.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number.
 * @member {String} phone_number
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['phone_number'] = undefined;

/**
 * The postal or ZIP code of this phone number's location. Available for only phone numbers from the US and Canada.
 * @member {String} postal_code
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['postal_code'] = undefined;
 ...
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['rate_center'] = undefined;
 ...
 */
ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.prototype['region'] = undefined;
...
export default ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost;
