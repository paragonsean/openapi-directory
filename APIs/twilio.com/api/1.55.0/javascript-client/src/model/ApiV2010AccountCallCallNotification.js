...
/**
 * The ApiV2010AccountCallCallNotification model module.
 * @module model/ApiV2010AccountCallCallNotification
 * @version 1.55.0
 */
class ApiV2010AccountCallCallNotification {
    /**
     * Constructs a new <code>ApiV2010AccountCallCallNotification</code>.
     * @alias module:model/ApiV2010AccountCallCallNotification
     */
    constructor() { 
        
        ApiV2010AccountCallCallNotification.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2010AccountCallCallNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2010AccountCallCallNotification} obj Optional instance to populate.
     * @return {module:model/ApiV2010AccountCallCallNotification} The populated <code>ApiV2010AccountCallCallNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2010AccountCallCallNotification();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2010AccountCallCallNotification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2010AccountCallCallNotification</code>.
     */
 ...
 */
ApiV2010AccountCallCallNotification.prototype['account_sid'] = undefined;

/**
 * The API version used to create the Call Notification resource.
 * @member {String} api_version
 */
ApiV2010AccountCallCallNotification.prototype['api_version'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotification.prototype['call_sid'] = undefined;

/**
 * The date and time in GMT that the resource was created specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {String} date_created
 */
ApiV2010AccountCallCallNotification.prototype['date_created'] = undefined;

/**
 * The date and time in GMT that the resource was last updated specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {String} date_updated
 */
ApiV2010AccountCallCallNotification.prototype['date_updated'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotification.prototype['error_code'] = undefined;

/**
 * An integer log level that corresponds to the type of notification: `0` is ERROR, `1` is WARNING.
 * @member {String} log
 */
ApiV2010AccountCallCallNotification.prototype['log'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotification.prototype['message_date'] = undefined;

/**
 * The text of the notification.
 * @member {String} message_text
 */
ApiV2010AccountCallCallNotification.prototype['message_text'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotification.prototype['more_info'] = undefined;
 ...
 * @member {module:model/ApiV2010AccountCallCallNotification.RequestMethodEnum} request_method
 */
ApiV2010AccountCallCallNotification.prototype['request_method'] = undefined;
 ...
 */
ApiV2010AccountCallCallNotification.prototype['request_url'] = undefined;

/**
 * The unique string that that we created to identify the Call Notification resource.
 * @member {String} sid
 */
ApiV2010AccountCallCallNotification.prototype['sid'] = undefined;

/**
 * The URI of the resource, relative to `https://api.twilio.com`.
 * @member {String} uri
 */
ApiV2010AccountCallCallNotification.prototype['uri'] = undefined;
 ...
 * @readonly
 */
ApiV2010AccountCallCallNotification['RequestMethodEnum'] = {
...
export default ApiV2010AccountCallCallNotification;
