...
/**
* Enum class UsageRecordAllTimeEnumCategory.
* @enum {}
* @readonly
*/
export default class UsageRecordAllTimeEnumCategory {
    ...
    /**
    * Returns a <code>UsageRecordAllTimeEnumCategory</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UsageRecordAllTimeEnumCategory} The enum <code>UsageRecordAllTimeEnumCategory</code> value.
    */
