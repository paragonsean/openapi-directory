...
/**
* Enum class UsageRecordTodayEnumCategory.
* @enum {}
* @readonly
*/
export default class UsageRecordTodayEnumCategory {
    ...
    /**
    * Returns a <code>UsageRecordTodayEnumCategory</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UsageRecordTodayEnumCategory} The enum <code>UsageRecordTodayEnumCategory</code> value.
    */
