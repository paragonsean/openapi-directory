...
/**
* Enum class UsageRecordDailyEnumCategory.
* @enum {}
* @readonly
*/
export default class UsageRecordDailyEnumCategory {
    ...
    /**
    * Returns a <code>UsageRecordDailyEnumCategory</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UsageRecordDailyEnumCategory} The enum <code>UsageRecordDailyEnumCategory</code> value.
    */
