...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountSigningKey();
  });
  ...
  describe('ApiV2010AccountSigningKey', function() {
    it('should create an instance of ApiV2010AccountSigningKey', function() {
      // uncomment below and update the code to test ApiV2010AccountSigningKey
      //var instance = new TwilioApi.ApiV2010AccountSigningKey();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountSigningKey);
    });
