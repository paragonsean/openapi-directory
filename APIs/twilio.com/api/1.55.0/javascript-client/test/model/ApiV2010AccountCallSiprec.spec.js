...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountCallSiprec();
  });
  ...
  describe('ApiV2010AccountCallSiprec', function() {
    it('should create an instance of ApiV2010AccountCallSiprec', function() {
      // uncomment below and update the code to test ApiV2010AccountCallSiprec
      //var instance = new TwilioApi.ApiV2010AccountCallSiprec();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountCallSiprec);
    });
