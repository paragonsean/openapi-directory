...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountCallCallRecording();
  });
  ...
  describe('ApiV2010AccountCallCallRecording', function() {
    it('should create an instance of ApiV2010AccountCallCallRecording', function() {
      // uncomment below and update the code to test ApiV2010AccountCallCallRecording
      //var instance = new TwilioApi.ApiV2010AccountCallCallRecording();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountCallCallRecording);
    });
