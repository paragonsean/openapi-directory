...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountNotificationInstance();
  });
  ...
  describe('ApiV2010AccountNotificationInstance', function() {
    it('should create an instance of ApiV2010AccountNotificationInstance', function() {
      // uncomment below and update the code to test ApiV2010AccountNotificationInstance
      //var instance = new TwilioApi.ApiV2010AccountNotificationInstance();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountNotificationInstance);
    });
