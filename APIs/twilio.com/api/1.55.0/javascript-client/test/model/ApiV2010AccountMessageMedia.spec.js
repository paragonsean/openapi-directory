...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountMessageMedia();
  });
  ...
  describe('ApiV2010AccountMessageMedia', function() {
    it('should create an instance of ApiV2010AccountMessageMedia', function() {
      // uncomment below and update the code to test ApiV2010AccountMessageMedia
      //var instance = new TwilioApi.ApiV2010AccountMessageMedia();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountMessageMedia);
    });
    ...
    it('should have the property parentSid (base name: "parent_sid")', function() {
      // uncomment below and update the code to test the property parentSid
      //var instance = new TwilioApi.ApiV2010AccountMessageMedia();
      //expect(instance).to.be();
    });
