...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountKey();
  });
  ...
  describe('ApiV2010AccountKey', function() {
    it('should create an instance of ApiV2010AccountKey', function() {
      // uncomment below and update the code to test ApiV2010AccountKey
      //var instance = new TwilioApi.ApiV2010AccountKey();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountKey);
    });
