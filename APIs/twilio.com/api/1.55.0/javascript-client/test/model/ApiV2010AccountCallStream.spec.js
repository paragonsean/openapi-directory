...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountCallStream();
  });
  ...
  describe('ApiV2010AccountCallStream', function() {
    it('should create an instance of ApiV2010AccountCallStream', function() {
      // uncomment below and update the code to test ApiV2010AccountCallStream
      //var instance = new TwilioApi.ApiV2010AccountCallStream();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountCallStream);
    });
