...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010Account();
  });
  ...
  describe('ApiV2010Account', function() {
    it('should create an instance of ApiV2010Account', function() {
      // uncomment below and update the code to test ApiV2010Account
      //var instance = new TwilioApi.ApiV2010Account();
      //expect(instance).to.be.a(TwilioApi.ApiV2010Account);
    });
    ...
    it('should have the property ownerAccountSid (base name: "owner_account_sid")', function() {
      // uncomment below and update the code to test the property ownerAccountSid
      //var instance = new TwilioApi.ApiV2010Account();
      //expect(instance).to.be();
    });
