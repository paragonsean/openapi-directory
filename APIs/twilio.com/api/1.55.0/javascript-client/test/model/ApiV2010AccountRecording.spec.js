...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountRecording();
  });
  ...
  describe('ApiV2010AccountRecording', function() {
    it('should create an instance of ApiV2010AccountRecording', function() {
      // uncomment below and update the code to test ApiV2010AccountRecording
      //var instance = new TwilioApi.ApiV2010AccountRecording();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountRecording);
    });
