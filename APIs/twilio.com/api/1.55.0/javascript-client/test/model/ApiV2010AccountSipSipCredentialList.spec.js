...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountSipSipCredentialList();
  });
  ...
  describe('ApiV2010AccountSipSipCredentialList', function() {
    it('should create an instance of ApiV2010AccountSipSipCredentialList', function() {
      // uncomment below and update the code to test ApiV2010AccountSipSipCredentialList
      //var instance = new TwilioApi.ApiV2010AccountSipSipCredentialList();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountSipSipCredentialList);
    });
