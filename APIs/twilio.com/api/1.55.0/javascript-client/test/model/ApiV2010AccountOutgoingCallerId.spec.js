...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountOutgoingCallerId();
  });
  ...
  describe('ApiV2010AccountOutgoingCallerId', function() {
    it('should create an instance of ApiV2010AccountOutgoingCallerId', function() {
      // uncomment below and update the code to test ApiV2010AccountOutgoingCallerId
      //var instance = new TwilioApi.ApiV2010AccountOutgoingCallerId();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountOutgoingCallerId);
    });
