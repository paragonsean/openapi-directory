...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountQueue();
  });
  ...
  describe('ApiV2010AccountQueue', function() {
    it('should create an instance of ApiV2010AccountQueue', function() {
      // uncomment below and update the code to test ApiV2010AccountQueue
      //var instance = new TwilioApi.ApiV2010AccountQueue();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountQueue);
    });
    ...
    it('should have the property averageWaitTime (base name: "average_wait_time")', function() {
      // uncomment below and update the code to test the property averageWaitTime
      //var instance = new TwilioApi.ApiV2010AccountQueue();
      //expect(instance).to.be();
    });

    it('should have the property currentSize (base name: "current_size")', function() {
      // uncomment below and update the code to test the property currentSize
      //var instance = new TwilioApi.ApiV2010AccountQueue();
      //expect(instance).to.be();
    });
