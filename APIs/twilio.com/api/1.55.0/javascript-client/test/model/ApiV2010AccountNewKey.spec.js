...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioApi.ApiV2010AccountNewKey();
  });
  ...
  describe('ApiV2010AccountNewKey', function() {
    it('should create an instance of ApiV2010AccountNewKey', function() {
      // uncomment below and update the code to test ApiV2010AccountNewKey
      //var instance = new TwilioApi.ApiV2010AccountNewKey();
      //expect(instance).to.be.a(TwilioApi.ApiV2010AccountNewKey);
    });
