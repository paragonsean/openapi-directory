# TwilioApi.ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOn
...
**configuration** | **Object** | A JSON string that represents the current configuration of this Add-on installation. | [optional] 
...
**description** | **String** | A short description of the functionality that the Add-on provides. | [optional] 
