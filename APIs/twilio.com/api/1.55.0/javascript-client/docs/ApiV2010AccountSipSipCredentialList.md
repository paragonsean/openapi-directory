# TwilioApi.ApiV2010AccountSipSipCredentialList
...
**friendlyName** | **String** | A human readable descriptive text that describes the CredentialList, up to 64 characters long. | [optional] 
**sid** | **String** | A 34 character string that uniquely identifies this resource. | [optional] 
**subresourceUris** | **Object** | A list of credentials associated with this credential list. | [optional] 
