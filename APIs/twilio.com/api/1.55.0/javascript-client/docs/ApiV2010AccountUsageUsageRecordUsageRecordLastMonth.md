# TwilioApi.ApiV2010AccountUsageUsageRecordUsageRecordLastMonth
...
**category** | [**UsageRecordLastMonthEnumCategory**](UsageRecordLastMonthEnumCategory.md) |  | [optional] 
...
**endDate** | **Date** | The last date for which usage is included in the UsageRecord. The date is specified in GMT and formatted as &#x60;YYYY-MM-DD&#x60;. | [optional] 
**price** | **Number** | The total price of the usage in the currency specified in &#x60;price_unit&#x60; and associated with the account. | [optional] 
...
**startDate** | **Date** | The first date for which usage is included in this UsageRecord. The date is specified in GMT and formatted as &#x60;YYYY-MM-DD&#x60;. | [optional] 
