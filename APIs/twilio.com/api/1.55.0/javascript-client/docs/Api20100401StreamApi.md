# TwilioApi.Api20100401StreamApi

All URIs are relative to *https://api.twilio.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**createStream**](Api20100401StreamApi.md#createStream) | **POST** /2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Streams.json | 
[**updateStream**](Api20100401StreamApi.md#updateStream) | **POST** /2010-04-01/Accounts/{AccountSid}/Calls/{CallSid}/Streams/{Sid}.json | 



## createStream

> ApiV2010AccountCallStream createStream(accountSid, callSid, url, opts)
...
let apiInstance = new TwilioApi.Api20100401StreamApi();
let accountSid = "accountSid_example"; // String | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created this Stream resource.
let callSid = "callSid_example"; // String | The SID of the [Call](https://www.twilio.com/docs/voice/api/call-resource) the Stream resource is associated with.
let url = "url_example"; // String | Relative or absolute url where WebSocket connection will be established.
let opts = {
  'name': "name_example", // String | The user-specified name of this Stream, if one was given when the Stream was created. This may be used to stop the Stream.
  ...
  'track': "track_example" // StreamEnumTrack | 
};
apiInstance.createStream(accountSid, callSid, url, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **name** | **String**| The user-specified name of this Stream, if one was given when the Stream was created. This may be used to stop the Stream. | [optional] 
 ...
 **track** | **StreamEnumTrack**|  | [optional] 
...
> ApiV2010AccountCallStream updateStream(accountSid, callSid, sid, status)
...
let accountSid = "accountSid_example"; // String | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created this Stream resource.
let callSid = "callSid_example"; // String | The SID of the [Call](https://www.twilio.com/docs/voice/api/call-resource) the Stream resource is associated with.
let sid = "sid_example"; // String | The SID of the Stream resource, or the `name` used when creating the resource
let status = "status_example"; // StreamEnumUpdateStatus | 
apiInstance.updateStream(accountSid, callSid, sid, status, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
