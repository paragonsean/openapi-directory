# TwilioApi.Api20100401NationalApi
...
> ListAvailablePhoneNumberNationalResponse listAvailablePhoneNumberNational(accountSid, countryCode, opts)
...
let apiInstance = new TwilioApi.Api20100401NationalApi();
...
apiInstance.listAvailablePhoneNumberNational(accountSid, countryCode, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
