# TwilioApi.ApiV2010AccountIncomingPhoneNumber

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountSid** | **String** | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created this IncomingPhoneNumber resource. | [optional] 
**addressRequirements** | [**IncomingPhoneNumberEnumAddressRequirement**](IncomingPhoneNumberEnumAddressRequirement.md) |  | [optional] 
...
**emergencyAddressStatus** | [**IncomingPhoneNumberEnumEmergencyAddressStatus**](IncomingPhoneNumberEnumEmergencyAddressStatus.md) |  | [optional] 
**emergencyStatus** | [**IncomingPhoneNumberEnumEmergencyStatus**](IncomingPhoneNumberEnumEmergencyStatus.md) |  | [optional] 
...
**sid** | **String** | The unique string that that we created to identify this IncomingPhoneNumber resource. | [optional] 
...
**voiceReceiveMode** | [**IncomingPhoneNumberEnumVoiceReceiveMode**](IncomingPhoneNumberEnumVoiceReceiveMode.md) |  | [optional] 
