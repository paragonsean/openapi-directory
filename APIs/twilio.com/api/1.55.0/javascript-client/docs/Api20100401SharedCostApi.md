# TwilioApi.Api20100401SharedCostApi
...
> ListAvailablePhoneNumberSharedCostResponse listAvailablePhoneNumberSharedCost(accountSid, countryCode, opts)
...
let apiInstance = new TwilioApi.Api20100401SharedCostApi();
...
apiInstance.listAvailablePhoneNumberSharedCost(accountSid, countryCode, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
