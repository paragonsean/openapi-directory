# TwilioApi.Api20100401LocalApi

All URIs are relative to *https://api.twilio.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**createIncomingPhoneNumberLocal**](Api20100401LocalApi.md#createIncomingPhoneNumberLocal) | **POST** /2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json | 
[**listAvailablePhoneNumberLocal**](Api20100401LocalApi.md#listAvailablePhoneNumberLocal) | **GET** /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Local.json | 
[**listIncomingPhoneNumberLocal**](Api20100401LocalApi.md#listIncomingPhoneNumberLocal) | **GET** /2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json | 



## createIncomingPhoneNumberLocal

> ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal createIncomingPhoneNumberLocal(accountSid, phoneNumber, opts)
...
let apiInstance = new TwilioApi.Api20100401LocalApi();
...
let opts = {
  ...
  'emergencyStatus': "emergencyStatus_example", // IncomingPhoneNumberLocalEnumEmergencyStatus | 
  'friendlyName': "friendlyName_example", // String | A descriptive string that you created to describe the new phone number. It can be up to 64 characters long. By default, this is a formatted version of the phone number.
  ...
  'voiceReceiveMode': "voiceReceiveMode_example", // IncomingPhoneNumberLocalEnumVoiceReceiveMode | 
...
apiInstance.createIncomingPhoneNumberLocal(accountSid, phoneNumber, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **emergencyStatus** | **IncomingPhoneNumberLocalEnumEmergencyStatus**|  | [optional] 
 ...
 **voiceReceiveMode** | **IncomingPhoneNumberLocalEnumVoiceReceiveMode**|  | [optional] 
...
> ListAvailablePhoneNumberLocalResponse listAvailablePhoneNumberLocal(accountSid, countryCode, opts)
...
apiInstance.listAvailablePhoneNumberLocal(accountSid, countryCode, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListIncomingPhoneNumberLocalResponse listIncomingPhoneNumberLocal(accountSid, opts)
...
apiInstance.listIncomingPhoneNumberLocal(accountSid, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
