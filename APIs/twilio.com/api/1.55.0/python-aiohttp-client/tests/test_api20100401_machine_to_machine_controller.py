...
async def test_list_available_phone_number_machine_to_machine(client):
    ...
    response = await client.request(
        method='GET',
        path='/2010-04-01/Accounts/{account_sid}/AvailablePhoneNumbers/{country_code}/MachineToMachine.json'.format(account_sid='account_sid_example', country_code='country_code_example'),
        headers=headers,
        params=params,
        )
