...
async def create_sip_auth_calls_credential_list_mapping(request: web.Request, account_sid, domain_sid, credential_list_sid) -> web.Response:
...
async def delete_sip_auth_calls_credential_list_mapping(request: web.Request, account_sid, domain_sid, sid) -> web.Response:
...
async def fetch_sip_auth_calls_credential_list_mapping(request: web.Request, account_sid, domain_sid, sid) -> web.Response:
...
async def list_sip_auth_calls_credential_list_mapping(request: web.Request, account_sid, domain_sid, page_size=None, page=None, page_token=None) -> web.Response:
