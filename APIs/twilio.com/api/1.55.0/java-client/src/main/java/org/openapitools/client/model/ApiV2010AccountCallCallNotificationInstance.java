...
public class ApiV2010AccountCallCallNotificationInstance {
  ...
  public ApiV2010AccountCallCallNotificationInstance() {
  }

  public ApiV2010AccountCallCallNotificationInstance accountSid(String accountSid) {
  ...
  public ApiV2010AccountCallCallNotificationInstance apiVersion(String apiVersion) {
  ...
  public ApiV2010AccountCallCallNotificationInstance callSid(String callSid) {
  ...
  public ApiV2010AccountCallCallNotificationInstance dateCreated(String dateCreated) {
  ...
  public ApiV2010AccountCallCallNotificationInstance dateUpdated(String dateUpdated) {
  ...
  public ApiV2010AccountCallCallNotificationInstance errorCode(String errorCode) {
  ...
  public ApiV2010AccountCallCallNotificationInstance log(String log) {
    this.log = log;
    return this;
  }
  ...
  public ApiV2010AccountCallCallNotificationInstance messageDate(String messageDate) {
  ...
  public ApiV2010AccountCallCallNotificationInstance messageText(String messageText) {
  ...
  public ApiV2010AccountCallCallNotificationInstance moreInfo(URI moreInfo) {
  ...
  public ApiV2010AccountCallCallNotificationInstance requestMethod(RequestMethodEnum requestMethod) {
  ...
  public ApiV2010AccountCallCallNotificationInstance requestUrl(URI requestUrl) {
  ...
  public ApiV2010AccountCallCallNotificationInstance requestVariables(String requestVariables) {
  ...
  public ApiV2010AccountCallCallNotificationInstance responseBody(String responseBody) {
  ...
  public ApiV2010AccountCallCallNotificationInstance responseHeaders(String responseHeaders) {
  ...
  public ApiV2010AccountCallCallNotificationInstance sid(String sid) {
    this.sid = sid;
    return this;
  }
  ...
  public ApiV2010AccountCallCallNotificationInstance uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiV2010AccountCallCallNotificationInstance apiV2010AccountCallCallNotificationInstance = (ApiV2010AccountCallCallNotificationInstance) o;
    return Objects.equals(this.accountSid, apiV2010AccountCallCallNotificationInstance.accountSid) &&
        Objects.equals(this.apiVersion, apiV2010AccountCallCallNotificationInstance.apiVersion) &&
        Objects.equals(this.callSid, apiV2010AccountCallCallNotificationInstance.callSid) &&
        Objects.equals(this.dateCreated, apiV2010AccountCallCallNotificationInstance.dateCreated) &&
        Objects.equals(this.dateUpdated, apiV2010AccountCallCallNotificationInstance.dateUpdated) &&
        Objects.equals(this.errorCode, apiV2010AccountCallCallNotificationInstance.errorCode) &&
        Objects.equals(this.log, apiV2010AccountCallCallNotificationInstance.log) &&
        Objects.equals(this.messageDate, apiV2010AccountCallCallNotificationInstance.messageDate) &&
        Objects.equals(this.messageText, apiV2010AccountCallCallNotificationInstance.messageText) &&
        Objects.equals(this.moreInfo, apiV2010AccountCallCallNotificationInstance.moreInfo) &&
        Objects.equals(this.requestMethod, apiV2010AccountCallCallNotificationInstance.requestMethod) &&
        Objects.equals(this.requestUrl, apiV2010AccountCallCallNotificationInstance.requestUrl) &&
        Objects.equals(this.requestVariables, apiV2010AccountCallCallNotificationInstance.requestVariables) &&
        Objects.equals(this.responseBody, apiV2010AccountCallCallNotificationInstance.responseBody) &&
        Objects.equals(this.responseHeaders, apiV2010AccountCallCallNotificationInstance.responseHeaders) &&
        Objects.equals(this.sid, apiV2010AccountCallCallNotificationInstance.sid) &&
        Objects.equals(this.uri, apiV2010AccountCallCallNotificationInstance.uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiV2010AccountCallCallNotificationInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiV2010AccountCallCallNotificationInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiV2010AccountCallCallNotificationInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiV2010AccountCallCallNotificationInstance is not found in the empty JSON string", ApiV2010AccountCallCallNotificationInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiV2010AccountCallCallNotificationInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiV2010AccountCallCallNotificationInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiV2010AccountCallCallNotificationInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiV2010AccountCallCallNotificationInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiV2010AccountCallCallNotificationInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiV2010AccountCallCallNotificationInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiV2010AccountCallCallNotificationInstance>() {
           @Override
           public void write(JsonWriter out, ApiV2010AccountCallCallNotificationInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiV2010AccountCallCallNotificationInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiV2010AccountCallCallNotificationInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiV2010AccountCallCallNotificationInstance
   * @throws IOException if the JSON string is invalid with respect to ApiV2010AccountCallCallNotificationInstance
   */
  public static ApiV2010AccountCallCallNotificationInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiV2010AccountCallCallNotificationInstance.class);
  }

  /**
   * Convert an instance of ApiV2010AccountCallCallNotificationInstance to an JSON string
   *
   * @return JSON string
   */
