...
public class ListRecordingResponse {
  ...
  private List<ApiV2010AccountRecording> recordings = new ArrayList<>();
  ...
  public ListRecordingResponse end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public ListRecordingResponse firstPageUri(URI firstPageUri) {
  ...
  public ListRecordingResponse nextPageUri(URI nextPageUri) {
  ...
  public ListRecordingResponse page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  public ListRecordingResponse pageSize(Integer pageSize) {
  ...
  public ListRecordingResponse previousPageUri(URI previousPageUri) {
  ...
  public ListRecordingResponse recordings(List<ApiV2010AccountRecording> recordings) {
    this.recordings = recordings;
    return this;
  }

  public ListRecordingResponse addRecordingsItem(ApiV2010AccountRecording recordingsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApiV2010AccountRecording> getRecordings() {
    return recordings;
  }

  public void setRecordings(List<ApiV2010AccountRecording> recordings) {
    this.recordings = recordings;
  }


  public ListRecordingResponse start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public ListRecordingResponse uri(URI uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.end, listRecordingResponse.end) &&
        Objects.equals(this.firstPageUri, listRecordingResponse.firstPageUri) &&
        Objects.equals(this.nextPageUri, listRecordingResponse.nextPageUri) &&
        Objects.equals(this.page, listRecordingResponse.page) &&
        Objects.equals(this.pageSize, listRecordingResponse.pageSize) &&
        Objects.equals(this.previousPageUri, listRecordingResponse.previousPageUri) &&
        Objects.equals(this.recordings, listRecordingResponse.recordings) &&
        Objects.equals(this.start, listRecordingResponse.start) &&
        Objects.equals(this.uri, listRecordingResponse.uri);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, recordings, start, uri);
  }
      ...
      if (jsonObj.get("recordings") != null && !jsonObj.get("recordings").isJsonNull()) {
        ...
        if (jsonArrayrecordings != null) {
          ...
          for (int i = 0; i < jsonArrayrecordings.size(); i++) {
            ApiV2010AccountRecording.validateJsonElement(jsonArrayrecordings.get(i));
          };
        }
      }
