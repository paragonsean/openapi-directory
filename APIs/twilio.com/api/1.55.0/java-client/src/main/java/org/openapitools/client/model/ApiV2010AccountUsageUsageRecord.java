...
public class ApiV2010AccountUsageUsageRecord {
  ...
  private UsageRecordEnumCategory category;
  ...
  public ApiV2010AccountUsageUsageRecord accountSid(String accountSid) {
  ...
  public ApiV2010AccountUsageUsageRecord apiVersion(String apiVersion) {
  ...
  public ApiV2010AccountUsageUsageRecord asOf(String asOf) {
    this.asOf = asOf;
    return this;
  }
  ...
  public ApiV2010AccountUsageUsageRecord category(UsageRecordEnumCategory category) {
   ...
   */
  @javax.annotation.Nullable
  public UsageRecordEnumCategory getCategory() {
    return category;
  }

  public void setCategory(UsageRecordEnumCategory category) {
    this.category = category;
  }


  public ApiV2010AccountUsageUsageRecord count(String count) {
    this.count = count;
    return this;
  }
  ...
  public ApiV2010AccountUsageUsageRecord countUnit(String countUnit) {
  ...
  public ApiV2010AccountUsageUsageRecord description(String description) {
  ...
  public ApiV2010AccountUsageUsageRecord endDate(LocalDate endDate) {
  ...
  public ApiV2010AccountUsageUsageRecord price(BigDecimal price) {
    this.price = price;
    return this;
  }
  ...
  public ApiV2010AccountUsageUsageRecord priceUnit(String priceUnit) {
  ...
  public ApiV2010AccountUsageUsageRecord startDate(LocalDate startDate) {
  ...
  public ApiV2010AccountUsageUsageRecord subresourceUris(Object subresourceUris) {
  ...
  public ApiV2010AccountUsageUsageRecord uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public ApiV2010AccountUsageUsageRecord usage(String usage) {
    this.usage = usage;
    return this;
  }
  ...
  public ApiV2010AccountUsageUsageRecord usageUnit(String usageUnit) {
  ...
  public boolean equals(Object o) {
    ...
    ApiV2010AccountUsageUsageRecord apiV2010AccountUsageUsageRecord = (ApiV2010AccountUsageUsageRecord) o;
    return Objects.equals(this.accountSid, apiV2010AccountUsageUsageRecord.accountSid) &&
        Objects.equals(this.apiVersion, apiV2010AccountUsageUsageRecord.apiVersion) &&
        Objects.equals(this.asOf, apiV2010AccountUsageUsageRecord.asOf) &&
        Objects.equals(this.category, apiV2010AccountUsageUsageRecord.category) &&
        Objects.equals(this.count, apiV2010AccountUsageUsageRecord.count) &&
        Objects.equals(this.countUnit, apiV2010AccountUsageUsageRecord.countUnit) &&
        Objects.equals(this.description, apiV2010AccountUsageUsageRecord.description) &&
        Objects.equals(this.endDate, apiV2010AccountUsageUsageRecord.endDate) &&
        Objects.equals(this.price, apiV2010AccountUsageUsageRecord.price) &&
        Objects.equals(this.priceUnit, apiV2010AccountUsageUsageRecord.priceUnit) &&
        Objects.equals(this.startDate, apiV2010AccountUsageUsageRecord.startDate) &&
        Objects.equals(this.subresourceUris, apiV2010AccountUsageUsageRecord.subresourceUris) &&
        Objects.equals(this.uri, apiV2010AccountUsageUsageRecord.uri) &&
        Objects.equals(this.usage, apiV2010AccountUsageUsageRecord.usage) &&
        Objects.equals(this.usageUnit, apiV2010AccountUsageUsageRecord.usageUnit);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiV2010AccountUsageUsageRecord {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiV2010AccountUsageUsageRecord
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiV2010AccountUsageUsageRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiV2010AccountUsageUsageRecord is not found in the empty JSON string", ApiV2010AccountUsageUsageRecord.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiV2010AccountUsageUsageRecord.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiV2010AccountUsageUsageRecord` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("category") != null && !jsonObj.get("category").isJsonNull()) {
        UsageRecordEnumCategory.validateJsonElement(jsonObj.get("category"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiV2010AccountUsageUsageRecord.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiV2010AccountUsageUsageRecord' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiV2010AccountUsageUsageRecord> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiV2010AccountUsageUsageRecord.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiV2010AccountUsageUsageRecord>() {
           @Override
           public void write(JsonWriter out, ApiV2010AccountUsageUsageRecord value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiV2010AccountUsageUsageRecord read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiV2010AccountUsageUsageRecord given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiV2010AccountUsageUsageRecord
   * @throws IOException if the JSON string is invalid with respect to ApiV2010AccountUsageUsageRecord
   */
  public static ApiV2010AccountUsageUsageRecord fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiV2010AccountUsageUsageRecord.class);
  }

  /**
   * Convert an instance of ApiV2010AccountUsageUsageRecord to an JSON string
   *
   * @return JSON string
   */
