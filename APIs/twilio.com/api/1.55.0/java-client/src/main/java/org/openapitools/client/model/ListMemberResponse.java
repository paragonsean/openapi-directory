...
public class ListMemberResponse {
  ...
  public static final String SERIALIZED_NAME_QUEUE_MEMBERS = "queue_members";
  @SerializedName(SERIALIZED_NAME_QUEUE_MEMBERS)
  private List<ApiV2010AccountQueueMember> queueMembers = new ArrayList<>();
  ...
  public ListMemberResponse end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public ListMemberResponse firstPageUri(URI firstPageUri) {
  ...
  public ListMemberResponse nextPageUri(URI nextPageUri) {
  ...
  public ListMemberResponse page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  public ListMemberResponse pageSize(Integer pageSize) {
  ...
  public ListMemberResponse previousPageUri(URI previousPageUri) {
  ...
  public ListMemberResponse queueMembers(List<ApiV2010AccountQueueMember> queueMembers) {
    this.queueMembers = queueMembers;
    return this;
  }

  public ListMemberResponse addQueueMembersItem(ApiV2010AccountQueueMember queueMembersItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApiV2010AccountQueueMember> getQueueMembers() {
    return queueMembers;
  }

  public void setQueueMembers(List<ApiV2010AccountQueueMember> queueMembers) {
    this.queueMembers = queueMembers;
  }


  public ListMemberResponse start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public ListMemberResponse uri(URI uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.end, listMemberResponse.end) &&
        Objects.equals(this.firstPageUri, listMemberResponse.firstPageUri) &&
        Objects.equals(this.nextPageUri, listMemberResponse.nextPageUri) &&
        Objects.equals(this.page, listMemberResponse.page) &&
        Objects.equals(this.pageSize, listMemberResponse.pageSize) &&
        Objects.equals(this.previousPageUri, listMemberResponse.previousPageUri) &&
        Objects.equals(this.queueMembers, listMemberResponse.queueMembers) &&
        Objects.equals(this.start, listMemberResponse.start) &&
        Objects.equals(this.uri, listMemberResponse.uri);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, queueMembers, start, uri);
  }
  ...
  static {
    ...
    openapiFields.add("queue_members");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("queue_members") != null && !jsonObj.get("queue_members").isJsonNull()) {
        JsonArray jsonArrayqueueMembers = jsonObj.getAsJsonArray("queue_members");
        if (jsonArrayqueueMembers != null) {
          // ensure the json data is an array
          if (!jsonObj.get("queue_members").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `queue_members` to be an array in the JSON string but got `%s`", jsonObj.get("queue_members").toString()));
          }

          // validate the optional field `queue_members` (array)
          for (int i = 0; i < jsonArrayqueueMembers.size(); i++) {
            ApiV2010AccountQueueMember.validateJsonElement(jsonArrayqueueMembers.get(i));
          };
        }
      }
