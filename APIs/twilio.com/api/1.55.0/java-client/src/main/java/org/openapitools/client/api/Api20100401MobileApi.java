...
public class Api20100401MobileApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Api20100401MobileApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Api20100401MobileApi(ApiClient apiClient) {
    ...
    /**
     * Build call for createIncomingPhoneNumberMobile
     ...
     * @param friendlyName A descriptive string that you created to describe the new phone number. It can be up to 64 characters long. By default, the is a formatted version of the phone number. (optional)
     ...
     * @param smsApplicationSid The SID of the application that should handle SMS messages sent to the new phone number. If an &#x60;sms_application_sid&#x60; is present, we ignore all of the &#x60;sms_*_url&#x60; urls and use those of the application. (optional)
     ...
     */
    public okhttp3.Call createIncomingPhoneNumberMobileCall(String accountSid, String phoneNumber, String addressSid, String apiVersion, String bundleSid, String emergencyAddressSid, IncomingPhoneNumberMobileEnumEmergencyStatus emergencyStatus, String friendlyName, String identitySid, String smsApplicationSid, String smsFallbackMethod, URI smsFallbackUrl, String smsMethod, URI smsUrl, URI statusCallback, String statusCallbackMethod, String trunkSid, String voiceApplicationSid, Boolean voiceCallerIdLookup, String voiceFallbackMethod, URI voiceFallbackUrl, String voiceMethod, IncomingPhoneNumberMobileEnumVoiceReceiveMode voiceReceiveMode, URI voiceUrl, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json"
    ...
    private okhttp3.Call createIncomingPhoneNumberMobileValidateBeforeCall(String accountSid, String phoneNumber, String addressSid, String apiVersion, String bundleSid, String emergencyAddressSid, IncomingPhoneNumberMobileEnumEmergencyStatus emergencyStatus, String friendlyName, String identitySid, String smsApplicationSid, String smsFallbackMethod, URI smsFallbackUrl, String smsMethod, URI smsUrl, URI statusCallback, String statusCallbackMethod, String trunkSid, String voiceApplicationSid, Boolean voiceCallerIdLookup, String voiceFallbackMethod, URI voiceFallbackUrl, String voiceMethod, IncomingPhoneNumberMobileEnumVoiceReceiveMode voiceReceiveMode, URI voiceUrl, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountSid' is set
        if (accountSid == null) {
            throw new ApiException("Missing the required parameter 'accountSid' when calling createIncomingPhoneNumberMobile(Async)");
        }

        // verify the required parameter 'phoneNumber' is set
        if (phoneNumber == null) {
            throw new ApiException("Missing the required parameter 'phoneNumber' when calling createIncomingPhoneNumberMobile(Async)");
        }

        return createIncomingPhoneNumberMobileCall(accountSid, phoneNumber, addressSid, apiVersion, bundleSid, emergencyAddressSid, emergencyStatus, friendlyName, identitySid, smsApplicationSid, smsFallbackMethod, smsFallbackUrl, smsMethod, smsUrl, statusCallback, statusCallbackMethod, trunkSid, voiceApplicationSid, voiceCallerIdLookup, voiceFallbackMethod, voiceFallbackUrl, voiceMethod, voiceReceiveMode, voiceUrl, _callback);
     ...
     */
    public ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile createIncomingPhoneNumberMobile(String accountSid, String phoneNumber, String addressSid, String apiVersion, String bundleSid, String emergencyAddressSid, IncomingPhoneNumberMobileEnumEmergencyStatus emergencyStatus, String friendlyName, String identitySid, String smsApplicationSid, String smsFallbackMethod, URI smsFallbackUrl, String smsMethod, URI smsUrl, URI statusCallback, String statusCallbackMethod, String trunkSid, String voiceApplicationSid, Boolean voiceCallerIdLookup, String voiceFallbackMethod, URI voiceFallbackUrl, String voiceMethod, IncomingPhoneNumberMobileEnumVoiceReceiveMode voiceReceiveMode, URI voiceUrl) throws ApiException {
        ApiResponse<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile> localVarResp = createIncomingPhoneNumberMobileWithHttpInfo(accountSid, phoneNumber, addressSid, apiVersion, bundleSid, emergencyAddressSid, emergencyStatus, friendlyName, identitySid, smsApplicationSid, smsFallbackMethod, smsFallbackUrl, smsMethod, smsUrl, statusCallback, statusCallbackMethod, trunkSid, voiceApplicationSid, voiceCallerIdLookup, voiceFallbackMethod, voiceFallbackUrl, voiceMethod, voiceReceiveMode, voiceUrl);
     ...
     * @param voiceReceiveMode  (optional)
     * @param voiceUrl The URL that we should call to answer a call to the new phone number. The &#x60;voice_url&#x60; will not be called if a &#x60;voice_application_sid&#x60; or a &#x60;trunk_sid&#x60; is set. (optional)
     * @return ApiResponse&lt;ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile> createIncomingPhoneNumberMobileWithHttpInfo(String accountSid, String phoneNumber, String addressSid, String apiVersion, String bundleSid, String emergencyAddressSid, IncomingPhoneNumberMobileEnumEmergencyStatus emergencyStatus, String friendlyName, String identitySid, String smsApplicationSid, String smsFallbackMethod, URI smsFallbackUrl, String smsMethod, URI smsUrl, URI statusCallback, String statusCallbackMethod, String trunkSid, String voiceApplicationSid, Boolean voiceCallerIdLookup, String voiceFallbackMethod, URI voiceFallbackUrl, String voiceMethod, IncomingPhoneNumberMobileEnumVoiceReceiveMode voiceReceiveMode, URI voiceUrl) throws ApiException {
        okhttp3.Call localVarCall = createIncomingPhoneNumberMobileValidateBeforeCall(accountSid, phoneNumber, addressSid, apiVersion, bundleSid, emergencyAddressSid, emergencyStatus, friendlyName, identitySid, smsApplicationSid, smsFallbackMethod, smsFallbackUrl, smsMethod, smsUrl, statusCallback, statusCallbackMethod, trunkSid, voiceApplicationSid, voiceCallerIdLookup, voiceFallbackMethod, voiceFallbackUrl, voiceMethod, voiceReceiveMode, voiceUrl, null);
        Type localVarReturnType = new TypeToken<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile>(){}.getType();
     ...
     */
    public okhttp3.Call createIncomingPhoneNumberMobileAsync(String accountSid, String phoneNumber, String addressSid, String apiVersion, String bundleSid, String emergencyAddressSid, IncomingPhoneNumberMobileEnumEmergencyStatus emergencyStatus, String friendlyName, String identitySid, String smsApplicationSid, String smsFallbackMethod, URI smsFallbackUrl, String smsMethod, URI smsUrl, URI statusCallback, String statusCallbackMethod, String trunkSid, String voiceApplicationSid, Boolean voiceCallerIdLookup, String voiceFallbackMethod, URI voiceFallbackUrl, String voiceMethod, IncomingPhoneNumberMobileEnumVoiceReceiveMode voiceReceiveMode, URI voiceUrl, final ApiCallback<ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile> _callback) throws ApiException {
    ...
    /**
     * Build call for listAvailablePhoneNumberMobile
     ...
     */
    public okhttp3.Call listAvailablePhoneNumberMobileCall(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] { "https://api.twilio.com" };
        ...
        // create path and map variables
        String localVarPath = "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Mobile.json"
            .replace("{" + "AccountSid" + "}", localVarApiClient.escapeString(accountSid.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAvailablePhoneNumberMobileValidateBeforeCall(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountSid' is set
        if (accountSid == null) {
            throw new ApiException("Missing the required parameter 'accountSid' when calling listAvailablePhoneNumberMobile(Async)");
        }

        // verify the required parameter 'countryCode' is set
        if (countryCode == null) {
            throw new ApiException("Missing the required parameter 'countryCode' when calling listAvailablePhoneNumberMobile(Async)");
        }

        return listAvailablePhoneNumberMobileCall(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken, _callback);
     ...
     */
    public ListAvailablePhoneNumberMobileResponse listAvailablePhoneNumberMobile(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken) throws ApiException {
        ApiResponse<ListAvailablePhoneNumberMobileResponse> localVarResp = listAvailablePhoneNumberMobileWithHttpInfo(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken);
        return localVarResp.getData();
    }
     ...
     * @param page The page index. This value is simply for client state. (optional)
     * @param pageToken The page token. This is provided by the API. (optional)
     * @return ApiResponse&lt;ListAvailablePhoneNumberMobileResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListAvailablePhoneNumberMobileResponse> listAvailablePhoneNumberMobileWithHttpInfo(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken) throws ApiException {
        okhttp3.Call localVarCall = listAvailablePhoneNumberMobileValidateBeforeCall(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken, null);
        Type localVarReturnType = new TypeToken<ListAvailablePhoneNumberMobileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call listAvailablePhoneNumberMobileAsync(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken, final ApiCallback<ListAvailablePhoneNumberMobileResponse> _callback) throws ApiException {
    ...
    /**
     * Build call for listIncomingPhoneNumberMobile
     ...
     */
    public okhttp3.Call listIncomingPhoneNumberMobileCall(String accountSid, Boolean beta, String friendlyName, String phoneNumber, String origin, Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] { "https://api.twilio.com" };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listIncomingPhoneNumberMobileValidateBeforeCall(String accountSid, Boolean beta, String friendlyName, String phoneNumber, String origin, Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountSid' is set
        if (accountSid == null) {
            throw new ApiException("Missing the required parameter 'accountSid' when calling listIncomingPhoneNumberMobile(Async)");
        }

        return listIncomingPhoneNumberMobileCall(accountSid, beta, friendlyName, phoneNumber, origin, pageSize, page, pageToken, _callback);
     ...
     */
    public ListIncomingPhoneNumberMobileResponse listIncomingPhoneNumberMobile(String accountSid, Boolean beta, String friendlyName, String phoneNumber, String origin, Integer pageSize, Integer page, String pageToken) throws ApiException {
        ApiResponse<ListIncomingPhoneNumberMobileResponse> localVarResp = listIncomingPhoneNumberMobileWithHttpInfo(accountSid, beta, friendlyName, phoneNumber, origin, pageSize, page, pageToken);
        return localVarResp.getData();
    }
     ...
     * @param page The page index. This value is simply for client state. (optional)
     * @param pageToken The page token. This is provided by the API. (optional)
     * @return ApiResponse&lt;ListIncomingPhoneNumberMobileResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListIncomingPhoneNumberMobileResponse> listIncomingPhoneNumberMobileWithHttpInfo(String accountSid, Boolean beta, String friendlyName, String phoneNumber, String origin, Integer pageSize, Integer page, String pageToken) throws ApiException {
        okhttp3.Call localVarCall = listIncomingPhoneNumberMobileValidateBeforeCall(accountSid, beta, friendlyName, phoneNumber, origin, pageSize, page, pageToken, null);
        Type localVarReturnType = new TypeToken<ListIncomingPhoneNumberMobileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call listIncomingPhoneNumberMobileAsync(String accountSid, Boolean beta, String friendlyName, String phoneNumber, String origin, Integer pageSize, Integer page, String pageToken, final ApiCallback<ListIncomingPhoneNumberMobileResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listIncomingPhoneNumberMobileValidateBeforeCall(accountSid, beta, friendlyName, phoneNumber, origin, pageSize, page, pageToken, _callback);
        Type localVarReturnType = new TypeToken<ListIncomingPhoneNumberMobileResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
