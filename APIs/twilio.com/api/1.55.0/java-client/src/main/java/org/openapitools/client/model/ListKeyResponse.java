...
public class ListKeyResponse {
  ...
  private List<ApiV2010AccountKey> keys = new ArrayList<>();
  ...
  public ListKeyResponse() {
  }

  public ListKeyResponse end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public ListKeyResponse firstPageUri(URI firstPageUri) {
  ...
  public ListKeyResponse keys(List<ApiV2010AccountKey> keys) {
    this.keys = keys;
    return this;
  }

  public ListKeyResponse addKeysItem(ApiV2010AccountKey keysItem) {
    if (this.keys == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApiV2010AccountKey> getKeys() {
    return keys;
  }

  public void setKeys(List<ApiV2010AccountKey> keys) {
    this.keys = keys;
  }


  public ListKeyResponse nextPageUri(URI nextPageUri) {
  ...
  public ListKeyResponse page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  public ListKeyResponse pageSize(Integer pageSize) {
  ...
  public ListKeyResponse previousPageUri(URI previousPageUri) {
  ...
  public ListKeyResponse start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public ListKeyResponse uri(URI uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListKeyResponse listKeyResponse = (ListKeyResponse) o;
    return Objects.equals(this.end, listKeyResponse.end) &&
        Objects.equals(this.firstPageUri, listKeyResponse.firstPageUri) &&
        Objects.equals(this.keys, listKeyResponse.keys) &&
        Objects.equals(this.nextPageUri, listKeyResponse.nextPageUri) &&
        Objects.equals(this.page, listKeyResponse.page) &&
        Objects.equals(this.pageSize, listKeyResponse.pageSize) &&
        Objects.equals(this.previousPageUri, listKeyResponse.previousPageUri) &&
        Objects.equals(this.start, listKeyResponse.start) &&
        Objects.equals(this.uri, listKeyResponse.uri);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(end, firstPageUri, keys, nextPageUri, page, pageSize, previousPageUri, start, uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListKeyResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListKeyResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListKeyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListKeyResponse is not found in the empty JSON string", ListKeyResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListKeyResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListKeyResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("keys") != null && !jsonObj.get("keys").isJsonNull()) {
        ...
        if (jsonArraykeys != null) {
          ...
          for (int i = 0; i < jsonArraykeys.size(); i++) {
            ApiV2010AccountKey.validateJsonElement(jsonArraykeys.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListKeyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListKeyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListKeyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListKeyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListKeyResponse>() {
           @Override
           public void write(JsonWriter out, ListKeyResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListKeyResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListKeyResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListKeyResponse
   * @throws IOException if the JSON string is invalid with respect to ListKeyResponse
   */
  public static ListKeyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListKeyResponse.class);
  }

  /**
   * Convert an instance of ListKeyResponse to an JSON string
   *
   * @return JSON string
   */
