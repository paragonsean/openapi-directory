...
public class ListCallResponse {
  ...
  private List<ApiV2010AccountCall> calls = new ArrayList<>();
  ...
  public ListCallResponse() {
  }

  public ListCallResponse calls(List<ApiV2010AccountCall> calls) {
    this.calls = calls;
    return this;
  }

  public ListCallResponse addCallsItem(ApiV2010AccountCall callsItem) {
    if (this.calls == null) {
  ...
  public List<ApiV2010AccountCall> getCalls() {
    return calls;
  }

  public void setCalls(List<ApiV2010AccountCall> calls) {
    this.calls = calls;
  }


  public ListCallResponse end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public ListCallResponse firstPageUri(URI firstPageUri) {
  ...
  public ListCallResponse nextPageUri(URI nextPageUri) {
  ...
  public ListCallResponse page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  public ListCallResponse pageSize(Integer pageSize) {
  ...
  public ListCallResponse previousPageUri(URI previousPageUri) {
  ...
  public ListCallResponse start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public ListCallResponse uri(URI uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListCallResponse listCallResponse = (ListCallResponse) o;
    return Objects.equals(this.calls, listCallResponse.calls) &&
        Objects.equals(this.end, listCallResponse.end) &&
        Objects.equals(this.firstPageUri, listCallResponse.firstPageUri) &&
        Objects.equals(this.nextPageUri, listCallResponse.nextPageUri) &&
        Objects.equals(this.page, listCallResponse.page) &&
        Objects.equals(this.pageSize, listCallResponse.pageSize) &&
        Objects.equals(this.previousPageUri, listCallResponse.previousPageUri) &&
        Objects.equals(this.start, listCallResponse.start) &&
        Objects.equals(this.uri, listCallResponse.uri);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(calls, end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, start, uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListCallResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListCallResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListCallResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListCallResponse is not found in the empty JSON string", ListCallResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListCallResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListCallResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("calls") != null && !jsonObj.get("calls").isJsonNull()) {
        ...
        if (jsonArraycalls != null) {
          ...
          for (int i = 0; i < jsonArraycalls.size(); i++) {
            ApiV2010AccountCall.validateJsonElement(jsonArraycalls.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListCallResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListCallResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListCallResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListCallResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListCallResponse>() {
           @Override
           public void write(JsonWriter out, ListCallResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListCallResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListCallResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListCallResponse
   * @throws IOException if the JSON string is invalid with respect to ListCallResponse
   */
  public static ListCallResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCallResponse.class);
  }

  /**
   * Convert an instance of ListCallResponse to an JSON string
   *
   * @return JSON string
   */
