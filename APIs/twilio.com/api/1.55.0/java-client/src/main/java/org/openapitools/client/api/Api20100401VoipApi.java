...
public class Api20100401VoipApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Api20100401VoipApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Api20100401VoipApi(ApiClient apiClient) {
    ...
    /**
     * Build call for listAvailablePhoneNumberVoip
     ...
     */
    public okhttp3.Call listAvailablePhoneNumberVoipCall(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Voip.json"
    ...
    private okhttp3.Call listAvailablePhoneNumberVoipValidateBeforeCall(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountSid' is set
        if (accountSid == null) {
            throw new ApiException("Missing the required parameter 'accountSid' when calling listAvailablePhoneNumberVoip(Async)");
        }

        // verify the required parameter 'countryCode' is set
        if (countryCode == null) {
            throw new ApiException("Missing the required parameter 'countryCode' when calling listAvailablePhoneNumberVoip(Async)");
        }

        return listAvailablePhoneNumberVoipCall(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken, _callback);
    ...
    public ListAvailablePhoneNumberVoipResponse listAvailablePhoneNumberVoip(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken) throws ApiException {
        ApiResponse<ListAvailablePhoneNumberVoipResponse> localVarResp = listAvailablePhoneNumberVoipWithHttpInfo(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken);
     ...
     * @param page The page index. This value is simply for client state. (optional)
     * @param pageToken The page token. This is provided by the API. (optional)
     * @return ApiResponse&lt;ListAvailablePhoneNumberVoipResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListAvailablePhoneNumberVoipResponse> listAvailablePhoneNumberVoipWithHttpInfo(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken) throws ApiException {
        okhttp3.Call localVarCall = listAvailablePhoneNumberVoipValidateBeforeCall(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken, null);
        Type localVarReturnType = new TypeToken<ListAvailablePhoneNumberVoipResponse>(){}.getType();
     ...
     */
    public okhttp3.Call listAvailablePhoneNumberVoipAsync(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken, final ApiCallback<ListAvailablePhoneNumberVoipResponse> _callback) throws ApiException {
