...
public class Api20100401MachineToMachineApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public Api20100401MachineToMachineApi() {
        this(Configuration.getDefaultApiClient());
    }

    public Api20100401MachineToMachineApi(ApiClient apiClient) {
    ...
    /**
     * Build call for listAvailablePhoneNumberMachineToMachine
     ...
     */
    public okhttp3.Call listAvailablePhoneNumberMachineToMachineCall(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/MachineToMachine.json"
    ...
    private okhttp3.Call listAvailablePhoneNumberMachineToMachineValidateBeforeCall(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountSid' is set
        if (accountSid == null) {
            throw new ApiException("Missing the required parameter 'accountSid' when calling listAvailablePhoneNumberMachineToMachine(Async)");
        }

        // verify the required parameter 'countryCode' is set
        if (countryCode == null) {
            throw new ApiException("Missing the required parameter 'countryCode' when calling listAvailablePhoneNumberMachineToMachine(Async)");
        }

        return listAvailablePhoneNumberMachineToMachineCall(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken, _callback);
     ...
     */
    public ListAvailablePhoneNumberMachineToMachineResponse listAvailablePhoneNumberMachineToMachine(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken) throws ApiException {
        ApiResponse<ListAvailablePhoneNumberMachineToMachineResponse> localVarResp = listAvailablePhoneNumberMachineToMachineWithHttpInfo(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken);
     ...
     * @param page The page index. This value is simply for client state. (optional)
     * @param pageToken The page token. This is provided by the API. (optional)
     * @return ApiResponse&lt;ListAvailablePhoneNumberMachineToMachineResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListAvailablePhoneNumberMachineToMachineResponse> listAvailablePhoneNumberMachineToMachineWithHttpInfo(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken) throws ApiException {
        okhttp3.Call localVarCall = listAvailablePhoneNumberMachineToMachineValidateBeforeCall(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken, null);
        Type localVarReturnType = new TypeToken<ListAvailablePhoneNumberMachineToMachineResponse>(){}.getType();
     ...
     */
    public okhttp3.Call listAvailablePhoneNumberMachineToMachineAsync(String accountSid, String countryCode, Integer areaCode, String contains, Boolean smsEnabled, Boolean mmsEnabled, Boolean voiceEnabled, Boolean excludeAllAddressRequired, Boolean excludeLocalAddressRequired, Boolean excludeForeignAddressRequired, Boolean beta, String nearNumber, String nearLatLong, Integer distance, String inPostalCode, String inRegion, String inRateCenter, String inLata, String inLocality, Boolean faxEnabled, Integer pageSize, Integer page, String pageToken, final ApiCallback<ListAvailablePhoneNumberMachineToMachineResponse> _callback) throws ApiException {
