...
/**
 * Gets or Sets usage_record_enum_category
 */
@JsonAdapter(UsageRecordEnumCategory.Adapter.class)
public enum UsageRecordEnumCategory {
  ...
  UsageRecordEnumCategory(String value) {
    this.value = value;
  }
  ...
  public static UsageRecordEnumCategory fromValue(String value) {
    for (UsageRecordEnumCategory b : UsageRecordEnumCategory.values()) {
  ...
  public static class Adapter extends TypeAdapter<UsageRecordEnumCategory> {
    @Override
    public void write(final JsonWriter jsonWriter, final UsageRecordEnumCategory enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UsageRecordEnumCategory read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UsageRecordEnumCategory.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UsageRecordEnumCategory.fromValue(value);
  }
}
