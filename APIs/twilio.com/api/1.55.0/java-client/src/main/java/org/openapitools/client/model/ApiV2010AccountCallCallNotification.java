...
public class ApiV2010AccountCallCallNotification {
  ...
  public ApiV2010AccountCallCallNotification() {
  }

  public ApiV2010AccountCallCallNotification accountSid(String accountSid) {
  ...
  public ApiV2010AccountCallCallNotification apiVersion(String apiVersion) {
  ...
  public ApiV2010AccountCallCallNotification callSid(String callSid) {
  ...
  public ApiV2010AccountCallCallNotification dateCreated(String dateCreated) {
  ...
  public ApiV2010AccountCallCallNotification dateUpdated(String dateUpdated) {
  ...
  public ApiV2010AccountCallCallNotification errorCode(String errorCode) {
  ...
  public ApiV2010AccountCallCallNotification log(String log) {
    this.log = log;
    return this;
  }
  ...
  public ApiV2010AccountCallCallNotification messageDate(String messageDate) {
  ...
  public ApiV2010AccountCallCallNotification messageText(String messageText) {
  ...
  public ApiV2010AccountCallCallNotification moreInfo(URI moreInfo) {
  ...
  public ApiV2010AccountCallCallNotification requestMethod(RequestMethodEnum requestMethod) {
  ...
  public ApiV2010AccountCallCallNotification requestUrl(URI requestUrl) {
  ...
  public ApiV2010AccountCallCallNotification sid(String sid) {
    this.sid = sid;
    return this;
  }
  ...
  public ApiV2010AccountCallCallNotification uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiV2010AccountCallCallNotification apiV2010AccountCallCallNotification = (ApiV2010AccountCallCallNotification) o;
    return Objects.equals(this.accountSid, apiV2010AccountCallCallNotification.accountSid) &&
        Objects.equals(this.apiVersion, apiV2010AccountCallCallNotification.apiVersion) &&
        Objects.equals(this.callSid, apiV2010AccountCallCallNotification.callSid) &&
        Objects.equals(this.dateCreated, apiV2010AccountCallCallNotification.dateCreated) &&
        Objects.equals(this.dateUpdated, apiV2010AccountCallCallNotification.dateUpdated) &&
        Objects.equals(this.errorCode, apiV2010AccountCallCallNotification.errorCode) &&
        Objects.equals(this.log, apiV2010AccountCallCallNotification.log) &&
        Objects.equals(this.messageDate, apiV2010AccountCallCallNotification.messageDate) &&
        Objects.equals(this.messageText, apiV2010AccountCallCallNotification.messageText) &&
        Objects.equals(this.moreInfo, apiV2010AccountCallCallNotification.moreInfo) &&
        Objects.equals(this.requestMethod, apiV2010AccountCallCallNotification.requestMethod) &&
        Objects.equals(this.requestUrl, apiV2010AccountCallCallNotification.requestUrl) &&
        Objects.equals(this.sid, apiV2010AccountCallCallNotification.sid) &&
        Objects.equals(this.uri, apiV2010AccountCallCallNotification.uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiV2010AccountCallCallNotification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiV2010AccountCallCallNotification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiV2010AccountCallCallNotification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiV2010AccountCallCallNotification is not found in the empty JSON string", ApiV2010AccountCallCallNotification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiV2010AccountCallCallNotification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiV2010AccountCallCallNotification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiV2010AccountCallCallNotification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiV2010AccountCallCallNotification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiV2010AccountCallCallNotification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiV2010AccountCallCallNotification.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiV2010AccountCallCallNotification>() {
           @Override
           public void write(JsonWriter out, ApiV2010AccountCallCallNotification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiV2010AccountCallCallNotification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiV2010AccountCallCallNotification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiV2010AccountCallCallNotification
   * @throws IOException if the JSON string is invalid with respect to ApiV2010AccountCallCallNotification
   */
  public static ApiV2010AccountCallCallNotification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiV2010AccountCallCallNotification.class);
  }

  /**
   * Convert an instance of ApiV2010AccountCallCallNotification to an JSON string
   *
   * @return JSON string
   */
