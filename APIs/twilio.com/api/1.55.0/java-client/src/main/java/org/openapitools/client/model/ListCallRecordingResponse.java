...
public class ListCallRecordingResponse {
  ...
  private List<ApiV2010AccountCallCallRecording> recordings = new ArrayList<>();
  ...
  public ListCallRecordingResponse() {
  }

  public ListCallRecordingResponse end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public ListCallRecordingResponse firstPageUri(URI firstPageUri) {
  ...
  public ListCallRecordingResponse nextPageUri(URI nextPageUri) {
  ...
  public ListCallRecordingResponse page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  public ListCallRecordingResponse pageSize(Integer pageSize) {
  ...
  public ListCallRecordingResponse previousPageUri(URI previousPageUri) {
  ...
  public ListCallRecordingResponse recordings(List<ApiV2010AccountCallCallRecording> recordings) {
    this.recordings = recordings;
    return this;
  }

  public ListCallRecordingResponse addRecordingsItem(ApiV2010AccountCallCallRecording recordingsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApiV2010AccountCallCallRecording> getRecordings() {
    return recordings;
  }

  public void setRecordings(List<ApiV2010AccountCallCallRecording> recordings) {
    this.recordings = recordings;
  }


  public ListCallRecordingResponse start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public ListCallRecordingResponse uri(URI uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListCallRecordingResponse listCallRecordingResponse = (ListCallRecordingResponse) o;
    return Objects.equals(this.end, listCallRecordingResponse.end) &&
        Objects.equals(this.firstPageUri, listCallRecordingResponse.firstPageUri) &&
        Objects.equals(this.nextPageUri, listCallRecordingResponse.nextPageUri) &&
        Objects.equals(this.page, listCallRecordingResponse.page) &&
        Objects.equals(this.pageSize, listCallRecordingResponse.pageSize) &&
        Objects.equals(this.previousPageUri, listCallRecordingResponse.previousPageUri) &&
        Objects.equals(this.recordings, listCallRecordingResponse.recordings) &&
        Objects.equals(this.start, listCallRecordingResponse.start) &&
        Objects.equals(this.uri, listCallRecordingResponse.uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListCallRecordingResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListCallRecordingResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListCallRecordingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListCallRecordingResponse is not found in the empty JSON string", ListCallRecordingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListCallRecordingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListCallRecordingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("recordings") != null && !jsonObj.get("recordings").isJsonNull()) {
        ...
        if (jsonArrayrecordings != null) {
          ...
          for (int i = 0; i < jsonArrayrecordings.size(); i++) {
            ApiV2010AccountCallCallRecording.validateJsonElement(jsonArrayrecordings.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListCallRecordingResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListCallRecordingResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListCallRecordingResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListCallRecordingResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListCallRecordingResponse>() {
           @Override
           public void write(JsonWriter out, ListCallRecordingResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListCallRecordingResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListCallRecordingResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListCallRecordingResponse
   * @throws IOException if the JSON string is invalid with respect to ListCallRecordingResponse
   */
  public static ListCallRecordingResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCallRecordingResponse.class);
  }

  /**
   * Convert an instance of ListCallRecordingResponse to an JSON string
   *
   * @return JSON string
   */
