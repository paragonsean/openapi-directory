...
public class ApiV2010AccountNotificationInstance {
  ...
  public ApiV2010AccountNotificationInstance accountSid(String accountSid) {
  ...
  public ApiV2010AccountNotificationInstance apiVersion(String apiVersion) {
  ...
  public ApiV2010AccountNotificationInstance callSid(String callSid) {
  ...
  public ApiV2010AccountNotificationInstance dateCreated(String dateCreated) {
  ...
  public ApiV2010AccountNotificationInstance dateUpdated(String dateUpdated) {
  ...
  public ApiV2010AccountNotificationInstance errorCode(String errorCode) {
  ...
  public ApiV2010AccountNotificationInstance log(String log) {
    this.log = log;
    return this;
  }
  ...
  public ApiV2010AccountNotificationInstance messageDate(String messageDate) {
  ...
  public ApiV2010AccountNotificationInstance messageText(String messageText) {
  ...
  public ApiV2010AccountNotificationInstance moreInfo(URI moreInfo) {
  ...
  public ApiV2010AccountNotificationInstance requestMethod(RequestMethodEnum requestMethod) {
  ...
  public ApiV2010AccountNotificationInstance requestUrl(URI requestUrl) {
  ...
  public ApiV2010AccountNotificationInstance requestVariables(String requestVariables) {
  ...
  public ApiV2010AccountNotificationInstance responseBody(String responseBody) {
  ...
  public ApiV2010AccountNotificationInstance responseHeaders(String responseHeaders) {
  ...
  public ApiV2010AccountNotificationInstance sid(String sid) {
    this.sid = sid;
    return this;
  }
  ...
  public ApiV2010AccountNotificationInstance uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiV2010AccountNotificationInstance apiV2010AccountNotificationInstance = (ApiV2010AccountNotificationInstance) o;
    return Objects.equals(this.accountSid, apiV2010AccountNotificationInstance.accountSid) &&
        Objects.equals(this.apiVersion, apiV2010AccountNotificationInstance.apiVersion) &&
        Objects.equals(this.callSid, apiV2010AccountNotificationInstance.callSid) &&
        Objects.equals(this.dateCreated, apiV2010AccountNotificationInstance.dateCreated) &&
        Objects.equals(this.dateUpdated, apiV2010AccountNotificationInstance.dateUpdated) &&
        Objects.equals(this.errorCode, apiV2010AccountNotificationInstance.errorCode) &&
        Objects.equals(this.log, apiV2010AccountNotificationInstance.log) &&
        Objects.equals(this.messageDate, apiV2010AccountNotificationInstance.messageDate) &&
        Objects.equals(this.messageText, apiV2010AccountNotificationInstance.messageText) &&
        Objects.equals(this.moreInfo, apiV2010AccountNotificationInstance.moreInfo) &&
        Objects.equals(this.requestMethod, apiV2010AccountNotificationInstance.requestMethod) &&
        Objects.equals(this.requestUrl, apiV2010AccountNotificationInstance.requestUrl) &&
        Objects.equals(this.requestVariables, apiV2010AccountNotificationInstance.requestVariables) &&
        Objects.equals(this.responseBody, apiV2010AccountNotificationInstance.responseBody) &&
        Objects.equals(this.responseHeaders, apiV2010AccountNotificationInstance.responseHeaders) &&
        Objects.equals(this.sid, apiV2010AccountNotificationInstance.sid) &&
        Objects.equals(this.uri, apiV2010AccountNotificationInstance.uri);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiV2010AccountNotificationInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiV2010AccountNotificationInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiV2010AccountNotificationInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiV2010AccountNotificationInstance is not found in the empty JSON string", ApiV2010AccountNotificationInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiV2010AccountNotificationInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiV2010AccountNotificationInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiV2010AccountNotificationInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiV2010AccountNotificationInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiV2010AccountNotificationInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiV2010AccountNotificationInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiV2010AccountNotificationInstance>() {
           @Override
           public void write(JsonWriter out, ApiV2010AccountNotificationInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiV2010AccountNotificationInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiV2010AccountNotificationInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiV2010AccountNotificationInstance
   * @throws IOException if the JSON string is invalid with respect to ApiV2010AccountNotificationInstance
   */
  public static ApiV2010AccountNotificationInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiV2010AccountNotificationInstance.class);
  }

  /**
   * Convert an instance of ApiV2010AccountNotificationInstance to an JSON string
   *
   * @return JSON string
   */
