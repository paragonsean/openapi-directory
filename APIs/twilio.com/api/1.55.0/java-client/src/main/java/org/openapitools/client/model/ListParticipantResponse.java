...
public class ListParticipantResponse {
  ...
  private List<ApiV2010AccountConferenceParticipant> participants = new ArrayList<>();
  ...
  public ListParticipantResponse end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public ListParticipantResponse firstPageUri(URI firstPageUri) {
  ...
  public ListParticipantResponse nextPageUri(URI nextPageUri) {
  ...
  public ListParticipantResponse page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  public ListParticipantResponse pageSize(Integer pageSize) {
  ...
  public ListParticipantResponse participants(List<ApiV2010AccountConferenceParticipant> participants) {
    this.participants = participants;
    return this;
  }

  public ListParticipantResponse addParticipantsItem(ApiV2010AccountConferenceParticipant participantsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ApiV2010AccountConferenceParticipant> getParticipants() {
    return participants;
  }

  public void setParticipants(List<ApiV2010AccountConferenceParticipant> participants) {
    this.participants = participants;
  }


  public ListParticipantResponse previousPageUri(URI previousPageUri) {
  ...
  public ListParticipantResponse start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public ListParticipantResponse uri(URI uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.end, listParticipantResponse.end) &&
        Objects.equals(this.firstPageUri, listParticipantResponse.firstPageUri) &&
        Objects.equals(this.nextPageUri, listParticipantResponse.nextPageUri) &&
        Objects.equals(this.page, listParticipantResponse.page) &&
        Objects.equals(this.pageSize, listParticipantResponse.pageSize) &&
        Objects.equals(this.participants, listParticipantResponse.participants) &&
        Objects.equals(this.previousPageUri, listParticipantResponse.previousPageUri) &&
        Objects.equals(this.start, listParticipantResponse.start) &&
        Objects.equals(this.uri, listParticipantResponse.uri);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(end, firstPageUri, nextPageUri, page, pageSize, participants, previousPageUri, start, uri);
  }
      ...
      if (jsonObj.get("participants") != null && !jsonObj.get("participants").isJsonNull()) {
        ...
        if (jsonArrayparticipants != null) {
          ...
          for (int i = 0; i < jsonArrayparticipants.size(); i++) {
            ApiV2010AccountConferenceParticipant.validateJsonElement(jsonArrayparticipants.get(i));
          };
        }
      }
