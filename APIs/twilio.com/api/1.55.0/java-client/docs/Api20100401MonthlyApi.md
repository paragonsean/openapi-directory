...
<a id="listUsageRecordMonthly"></a>
# **listUsageRecordMonthly**
> ListUsageRecordMonthlyResponse listUsageRecordMonthly(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken)
...
import org.openapitools.client.api.Api20100401MonthlyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Api20100401MonthlyApi apiInstance = new Api20100401MonthlyApi(defaultClient);
    ...
    try {
      ListUsageRecordMonthlyResponse result = apiInstance.listUsageRecordMonthly(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Api20100401MonthlyApi#listUsageRecordMonthly");
