...
|------------ | ------------- | ------------- | -------------|
|**accountSid** | **String** | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Recording AddOnResult resource. |  [optional] |
...
|**dateCompleted** | **String** | The date and time in GMT that the result was completed specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format. |  [optional] |
...
|**sid** | **String** | The unique string that that we created to identify the Recording AddOnResult resource. |  [optional] |
|**status** | **RecordingAddOnResultEnumStatus** |  |  [optional] |
