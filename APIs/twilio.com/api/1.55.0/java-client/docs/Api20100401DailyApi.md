...
|------------- | ------------- | -------------|
| [**listUsageRecordDaily**](Api20100401DailyApi.md#listUsageRecordDaily) | **GET** /2010-04-01/Accounts/{AccountSid}/Usage/Records/Daily.json |  |


<a id="listUsageRecordDaily"></a>
# **listUsageRecordDaily**
> ListUsageRecordDailyResponse listUsageRecordDaily(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken)
...
import org.openapitools.client.api.Api20100401DailyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Api20100401DailyApi apiInstance = new Api20100401DailyApi(defaultClient);
    ...
    try {
      ListUsageRecordDailyResponse result = apiInstance.listUsageRecordDaily(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Api20100401DailyApi#listUsageRecordDaily");
