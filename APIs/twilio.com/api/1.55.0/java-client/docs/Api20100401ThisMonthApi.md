...
|------------- | ------------- | -------------|
| [**listUsageRecordThisMonth**](Api20100401ThisMonthApi.md#listUsageRecordThisMonth) | **GET** /2010-04-01/Accounts/{AccountSid}/Usage/Records/ThisMonth.json |  |


<a id="listUsageRecordThisMonth"></a>
# **listUsageRecordThisMonth**
> ListUsageRecordThisMonthResponse listUsageRecordThisMonth(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken)
...
import org.openapitools.client.api.Api20100401ThisMonthApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Api20100401ThisMonthApi apiInstance = new Api20100401ThisMonthApi(defaultClient);
    ...
    try {
      ListUsageRecordThisMonthResponse result = apiInstance.listUsageRecordThisMonth(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Api20100401ThisMonthApi#listUsageRecordThisMonth");
