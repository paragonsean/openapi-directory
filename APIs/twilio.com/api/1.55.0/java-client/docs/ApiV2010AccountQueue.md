...
|**averageWaitTime** | **Integer** |  The average wait time in seconds of the members in this queue. This is calculated at the time of the request. |  [optional] |
|**currentSize** | **Integer** | The number of calls currently in the queue. |  [optional] |
...
|**maxSize** | **Integer** |  The maximum number of calls that can be in the queue. The default is 1000 and the maximum is 5000. |  [optional] |
