...
|------------- | ------------- | -------------|
| [**listAvailablePhoneNumberSharedCost**](Api20100401SharedCostApi.md#listAvailablePhoneNumberSharedCost) | **GET** /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/SharedCost.json |  |


<a id="listAvailablePhoneNumberSharedCost"></a>
# **listAvailablePhoneNumberSharedCost**
> ListAvailablePhoneNumberSharedCostResponse listAvailablePhoneNumberSharedCost(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken)
...
import org.openapitools.client.api.Api20100401SharedCostApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Api20100401SharedCostApi apiInstance = new Api20100401SharedCostApi(defaultClient);
    ...
    try {
      ListAvailablePhoneNumberSharedCostResponse result = apiInstance.listAvailablePhoneNumberSharedCost(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Api20100401SharedCostApi#listAvailablePhoneNumberSharedCost");
