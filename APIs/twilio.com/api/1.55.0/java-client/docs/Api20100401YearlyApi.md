...
<a id="listUsageRecordYearly"></a>
# **listUsageRecordYearly**
> ListUsageRecordYearlyResponse listUsageRecordYearly(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken)
...
import org.openapitools.client.api.Api20100401YearlyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Api20100401YearlyApi apiInstance = new Api20100401YearlyApi(defaultClient);
    ...
    try {
      ListUsageRecordYearlyResponse result = apiInstance.listUsageRecordYearly(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Api20100401YearlyApi#listUsageRecordYearly");
