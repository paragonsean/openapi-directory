...
|------------- | ------------- | -------------|
| [**listUsageRecordYesterday**](Api20100401YesterdayApi.md#listUsageRecordYesterday) | **GET** /2010-04-01/Accounts/{AccountSid}/Usage/Records/Yesterday.json |  |


<a id="listUsageRecordYesterday"></a>
# **listUsageRecordYesterday**
> ListUsageRecordYesterdayResponse listUsageRecordYesterday(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken)
...
import org.openapitools.client.api.Api20100401YesterdayApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Api20100401YesterdayApi apiInstance = new Api20100401YesterdayApi(defaultClient);
    ...
    try {
      ListUsageRecordYesterdayResponse result = apiInstance.listUsageRecordYesterday(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Api20100401YesterdayApi#listUsageRecordYesterday");
