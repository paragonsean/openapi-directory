...
|------------ | ------------- | ------------- | -------------|
|**accountSid** | **String** | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Recording AddOnResult Payload resource. |  [optional] |
...
|**label** | **String** | The string provided by the vendor that describes the payload. |  [optional] |
...
|**sid** | **String** | The unique string that that we created to identify the Recording AddOnResult Payload resource. |  [optional] |
