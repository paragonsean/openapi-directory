...
|------------- | ------------- | -------------|
| [**listAvailablePhoneNumberVoip**](Api20100401VoipApi.md#listAvailablePhoneNumberVoip) | **GET** /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Voip.json |  |


<a id="listAvailablePhoneNumberVoip"></a>
...
import org.openapitools.client.api.Api20100401VoipApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Api20100401VoipApi apiInstance = new Api20100401VoipApi(defaultClient);
    ...
    try {
      ListAvailablePhoneNumberVoipResponse result = apiInstance.listAvailablePhoneNumberVoip(accountSid, countryCode, areaCode, contains, smsEnabled, mmsEnabled, voiceEnabled, excludeAllAddressRequired, excludeLocalAddressRequired, excludeForeignAddressRequired, beta, nearNumber, nearLatLong, distance, inPostalCode, inRegion, inRateCenter, inLata, inLocality, faxEnabled, pageSize, page, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Api20100401VoipApi#listAvailablePhoneNumberVoip");
