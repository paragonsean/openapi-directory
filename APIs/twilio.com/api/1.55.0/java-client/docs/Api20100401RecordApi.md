...
|------------- | ------------- | -------------|
| [**listUsageRecord**](Api20100401RecordApi.md#listUsageRecord) | **GET** /2010-04-01/Accounts/{AccountSid}/Usage/Records.json |  |


<a id="listUsageRecord"></a>
# **listUsageRecord**
> ListUsageRecordResponse listUsageRecord(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken)
...
import org.openapitools.client.api.Api20100401RecordApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Api20100401RecordApi apiInstance = new Api20100401RecordApi(defaultClient);
    ...
    try {
      ListUsageRecordResponse result = apiInstance.listUsageRecord(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Api20100401RecordApi#listUsageRecord");
