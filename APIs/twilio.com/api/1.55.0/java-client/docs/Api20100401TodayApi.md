...
|------------- | ------------- | -------------|
| [**listUsageRecordToday**](Api20100401TodayApi.md#listUsageRecordToday) | **GET** /2010-04-01/Accounts/{AccountSid}/Usage/Records/Today.json |  |


<a id="listUsageRecordToday"></a>
# **listUsageRecordToday**
> ListUsageRecordTodayResponse listUsageRecordToday(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken)
...
import org.openapitools.client.api.Api20100401TodayApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    Api20100401TodayApi apiInstance = new Api20100401TodayApi(defaultClient);
    ...
    try {
      ListUsageRecordTodayResponse result = apiInstance.listUsageRecordToday(accountSid, category, startDate, endDate, includeSubaccounts, pageSize, page, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Api20100401TodayApi#listUsageRecordToday");
