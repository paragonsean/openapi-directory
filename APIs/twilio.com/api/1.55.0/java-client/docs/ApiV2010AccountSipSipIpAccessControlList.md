...
|------------ | ------------- | ------------- | -------------|
|**accountSid** | **String** | The unique id of the [Account](https://www.twilio.com/docs/iam/api/account) that owns this resource. |  [optional] |
...
|**friendlyName** | **String** | A human readable descriptive text, up to 255 characters long. |  [optional] |
|**sid** | **String** | A 34 character string that uniquely identifies this resource. |  [optional] |
|**subresourceUris** | **Object** | A list of the IpAddress resources associated with this IP access control list resource. |  [optional] |
