...
/*
 * OAIApi_v2010_account_call_call_recording.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_call_call_recording_H
#define OAIApi_v2010_account_call_call_recording_H
...
class OAIApi_v2010_account_call_call_recording : public OAIObject {
public:
    OAIApi_v2010_account_call_call_recording();
    OAIApi_v2010_account_call_call_recording(QString json);
    ~OAIApi_v2010_account_call_call_recording() override;
    ...
    OAICall_recording_enum_source getSource() const;
    void setSource(const OAICall_recording_enum_source &source);
    ...
    OAICall_recording_enum_status getStatus() const;
    void setStatus(const OAICall_recording_enum_status &status);
...
private:
    ...
    OAICall_recording_enum_source m_source;
    bool m_source_isSet;
    ...
    OAICall_recording_enum_status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_call_call_recording)

#endif // OAIApi_v2010_account_call_call_recording_H
