...
/*
 * OAIApi_v2010_account_usage_usage_record.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_usage_usage_record_H
#define OAIApi_v2010_account_usage_usage_record_H
...
class OAIApi_v2010_account_usage_usage_record : public OAIObject {
public:
    OAIApi_v2010_account_usage_usage_record();
    OAIApi_v2010_account_usage_usage_record(QString json);
    ~OAIApi_v2010_account_usage_usage_record() override;
    ...
    OAIUsage_record_enum_category getCategory() const;
    void setCategory(const OAIUsage_record_enum_category &category);
...
private:
    ...
    OAIUsage_record_enum_category m_category;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_usage_usage_record)

#endif // OAIApi_v2010_account_usage_usage_record_H
