...
/*
 * OAIApi_v2010_account_usage_usage_record_usage_record_this_month.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_usage_usage_record_usage_record_this_month_H
#define OAIApi_v2010_account_usage_usage_record_usage_record_this_month_H
...
class OAIApi_v2010_account_usage_usage_record_usage_record_this_month : public OAIObject {
public:
    OAIApi_v2010_account_usage_usage_record_usage_record_this_month();
    OAIApi_v2010_account_usage_usage_record_usage_record_this_month(QString json);
    ~OAIApi_v2010_account_usage_usage_record_usage_record_this_month() override;
    ...
    OAIUsage_record_this_month_enum_category getCategory() const;
    void setCategory(const OAIUsage_record_this_month_enum_category &category);
...
private:
    ...
    OAIUsage_record_this_month_enum_category m_category;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_usage_usage_record_usage_record_this_month)

#endif // OAIApi_v2010_account_usage_usage_record_usage_record_this_month_H
