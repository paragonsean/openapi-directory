...
#include "OAIApi20100401LocalApi.h"
...
OAIApi20100401LocalApi::OAIApi20100401LocalApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIApi20100401LocalApi::~OAIApi20100401LocalApi() {
}

void OAIApi20100401LocalApi::initializeServerConfigs() {
    //Default server
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("createIncomingPhoneNumberLocal", serverConf);
    _serverIndices.insert("createIncomingPhoneNumberLocal", 0);
    serverConf.append(OAIServerConfiguration(
    QUrl("https://api.twilio.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("listAvailablePhoneNumberLocal", serverConf);
    _serverIndices.insert("listAvailablePhoneNumberLocal", 0);
    serverConf.append(OAIServerConfiguration(
    QUrl("https://api.twilio.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("listIncomingPhoneNumberLocal", serverConf);
    _serverIndices.insert("listIncomingPhoneNumberLocal", 0);
}
...
*/
int OAIApi20100401LocalApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIApi20100401LocalApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIApi20100401LocalApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIApi20100401LocalApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIApi20100401LocalApi::setUsername(const QString &username) {
    _username = username;
}

void OAIApi20100401LocalApi::setPassword(const QString &password) {
    _password = password;
}


void OAIApi20100401LocalApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIApi20100401LocalApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIApi20100401LocalApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIApi20100401LocalApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIApi20100401LocalApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIApi20100401LocalApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIApi20100401LocalApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIApi20100401LocalApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIApi20100401LocalApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIApi20100401LocalApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIApi20100401LocalApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIApi20100401LocalApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIApi20100401LocalApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIApi20100401LocalApi::createIncomingPhoneNumberLocal(const QString &account_sid, const QString &phone_number, const ::OpenAPI::OptionalParam<QString> &address_sid, const ::OpenAPI::OptionalParam<QString> &api_version, const ::OpenAPI::OptionalParam<QString> &bundle_sid, const ::OpenAPI::OptionalParam<QString> &emergency_address_sid, const ::OpenAPI::OptionalParam<OAIIncoming_phone_number_local_enum_emergency_status> &emergency_status, const ::OpenAPI::OptionalParam<QString> &friendly_name, const ::OpenAPI::OptionalParam<QString> &identity_sid, const ::OpenAPI::OptionalParam<QString> &sms_application_sid, const ::OpenAPI::OptionalParam<QString> &sms_fallback_method, const ::OpenAPI::OptionalParam<QString> &sms_fallback_url, const ::OpenAPI::OptionalParam<QString> &sms_method, const ::OpenAPI::OptionalParam<QString> &sms_url, const ::OpenAPI::OptionalParam<QString> &status_callback, const ::OpenAPI::OptionalParam<QString> &status_callback_method, const ::OpenAPI::OptionalParam<QString> &trunk_sid, const ::OpenAPI::OptionalParam<QString> &voice_application_sid, const ::OpenAPI::OptionalParam<bool> &voice_caller_id_lookup, const ::OpenAPI::OptionalParam<QString> &voice_fallback_method, const ::OpenAPI::OptionalParam<QString> &voice_fallback_url, const ::OpenAPI::OptionalParam<QString> &voice_method, const ::OpenAPI::OptionalParam<OAIIncoming_phone_number_local_enum_voice_receive_mode> &voice_receive_mode, const ::OpenAPI::OptionalParam<QString> &voice_url) {
    QString fullPath = QString(_serverConfigs["createIncomingPhoneNumberLocal"][_serverIndices.value("createIncomingPhoneNumberLocal")].URL()+"/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApi20100401LocalApi::createIncomingPhoneNumberLocalCallback);
    connect(this, &OAIApi20100401LocalApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIApi20100401LocalApi::createIncomingPhoneNumberLocalCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIApi_v2010_account_incoming_phone_number_incoming_phone_number_local output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createIncomingPhoneNumberLocalSignal(output);
        Q_EMIT createIncomingPhoneNumberLocalSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createIncomingPhoneNumberLocalSignalE(output, error_type, error_str);
        Q_EMIT createIncomingPhoneNumberLocalSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createIncomingPhoneNumberLocalSignalError(output, error_type, error_str);
        Q_EMIT createIncomingPhoneNumberLocalSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIApi20100401LocalApi::listAvailablePhoneNumberLocal(const QString &account_sid, const QString &country_code, const ::OpenAPI::OptionalParam<qint32> &area_code, const ::OpenAPI::OptionalParam<QString> &contains, const ::OpenAPI::OptionalParam<bool> &sms_enabled, const ::OpenAPI::OptionalParam<bool> &mms_enabled, const ::OpenAPI::OptionalParam<bool> &voice_enabled, const ::OpenAPI::OptionalParam<bool> &exclude_all_address_required, const ::OpenAPI::OptionalParam<bool> &exclude_local_address_required, const ::OpenAPI::OptionalParam<bool> &exclude_foreign_address_required, const ::OpenAPI::OptionalParam<bool> &beta, const ::OpenAPI::OptionalParam<QString> &near_number, const ::OpenAPI::OptionalParam<QString> &near_lat_long, const ::OpenAPI::OptionalParam<qint32> &distance, const ::OpenAPI::OptionalParam<QString> &in_postal_code, const ::OpenAPI::OptionalParam<QString> &in_region, const ::OpenAPI::OptionalParam<QString> &in_rate_center, const ::OpenAPI::OptionalParam<QString> &in_lata, const ::OpenAPI::OptionalParam<QString> &in_locality, const ::OpenAPI::OptionalParam<bool> &fax_enabled, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["listAvailablePhoneNumberLocal"][_serverIndices.value("listAvailablePhoneNumberLocal")].URL()+"/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Local.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApi20100401LocalApi::listAvailablePhoneNumberLocalCallback);
    connect(this, &OAIApi20100401LocalApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIApi20100401LocalApi::listAvailablePhoneNumberLocalCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIListAvailablePhoneNumberLocalResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listAvailablePhoneNumberLocalSignal(output);
        Q_EMIT listAvailablePhoneNumberLocalSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listAvailablePhoneNumberLocalSignalE(output, error_type, error_str);
        Q_EMIT listAvailablePhoneNumberLocalSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listAvailablePhoneNumberLocalSignalError(output, error_type, error_str);
        Q_EMIT listAvailablePhoneNumberLocalSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIApi20100401LocalApi::listIncomingPhoneNumberLocal(const QString &account_sid, const ::OpenAPI::OptionalParam<bool> &beta, const ::OpenAPI::OptionalParam<QString> &friendly_name, const ::OpenAPI::OptionalParam<QString> &phone_number, const ::OpenAPI::OptionalParam<QString> &origin, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["listIncomingPhoneNumberLocal"][_serverIndices.value("listIncomingPhoneNumberLocal")].URL()+"/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Local.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApi20100401LocalApi::listIncomingPhoneNumberLocalCallback);
    connect(this, &OAIApi20100401LocalApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIApi20100401LocalApi::listIncomingPhoneNumberLocalCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIListIncomingPhoneNumberLocalResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listIncomingPhoneNumberLocalSignal(output);
        Q_EMIT listIncomingPhoneNumberLocalSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listIncomingPhoneNumberLocalSignalE(output, error_type, error_str);
        Q_EMIT listIncomingPhoneNumberLocalSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listIncomingPhoneNumberLocalSignalError(output, error_type, error_str);
        Q_EMIT listIncomingPhoneNumberLocalSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIApi20100401LocalApi::tokenAvailable(){
