...
/*
 * OAIApi_v2010_account_conference_conference_recording.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_conference_conference_recording_H
#define OAIApi_v2010_account_conference_conference_recording_H
...
class OAIApi_v2010_account_conference_conference_recording : public OAIObject {
public:
    OAIApi_v2010_account_conference_conference_recording();
    OAIApi_v2010_account_conference_conference_recording(QString json);
    ~OAIApi_v2010_account_conference_conference_recording() override;
    ...
    OAIConference_recording_enum_source getSource() const;
    void setSource(const OAIConference_recording_enum_source &source);
    ...
    OAIConference_recording_enum_status getStatus() const;
    void setStatus(const OAIConference_recording_enum_status &status);
...
private:
    ...
    OAIConference_recording_enum_source m_source;
    bool m_source_isSet;
    ...
    OAIConference_recording_enum_status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_conference_conference_recording)

#endif // OAIApi_v2010_account_conference_conference_recording_H
