...
/*
 * OAIApi_v2010_account_call_siprec.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_call_siprec_H
#define OAIApi_v2010_account_call_siprec_H
...
class OAIApi_v2010_account_call_siprec : public OAIObject {
public:
    OAIApi_v2010_account_call_siprec();
    OAIApi_v2010_account_call_siprec(QString json);
    ~OAIApi_v2010_account_call_siprec() override;
    ...
    OAISiprec_enum_status getStatus() const;
    void setStatus(const OAISiprec_enum_status &status);
...
private:
    ...
    OAISiprec_enum_status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_call_siprec)

#endif // OAIApi_v2010_account_call_siprec_H
