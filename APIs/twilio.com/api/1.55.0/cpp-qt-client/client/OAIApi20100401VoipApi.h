...
#ifndef OAI_OAIApi20100401VoipApi_H
#define OAI_OAIApi20100401VoipApi_H
...
class OAIApi20100401VoipApi : public QObject {
    Q_OBJECT

public:
    OAIApi20100401VoipApi(const int timeOut = 0);
    ~OAIApi20100401VoipApi();
...
private:
    ...
    void listAvailablePhoneNumberVoipCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void listAvailablePhoneNumberVoipSignal(OAIListAvailablePhoneNumberVoipResponse summary);


    void listAvailablePhoneNumberVoipSignalFull(OAIHttpRequestWorker *worker, OAIListAvailablePhoneNumberVoipResponse summary);

    Q_DECL_DEPRECATED_X("Use listAvailablePhoneNumberVoipSignalError() instead")
    void listAvailablePhoneNumberVoipSignalE(OAIListAvailablePhoneNumberVoipResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listAvailablePhoneNumberVoipSignalError(OAIListAvailablePhoneNumberVoipResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use listAvailablePhoneNumberVoipSignalErrorFull() instead")
    void listAvailablePhoneNumberVoipSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void listAvailablePhoneNumberVoipSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
