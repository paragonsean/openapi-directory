...
#include "OAIApi20100401MobileApi.h"
...
OAIApi20100401MobileApi::OAIApi20100401MobileApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIApi20100401MobileApi::~OAIApi20100401MobileApi() {
}

void OAIApi20100401MobileApi::initializeServerConfigs() {
    //Default server
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("createIncomingPhoneNumberMobile", serverConf);
    _serverIndices.insert("createIncomingPhoneNumberMobile", 0);
    serverConf.append(OAIServerConfiguration(
    QUrl("https://api.twilio.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("listAvailablePhoneNumberMobile", serverConf);
    _serverIndices.insert("listAvailablePhoneNumberMobile", 0);
    serverConf.append(OAIServerConfiguration(
    QUrl("https://api.twilio.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("listIncomingPhoneNumberMobile", serverConf);
    _serverIndices.insert("listIncomingPhoneNumberMobile", 0);
}
...
*/
int OAIApi20100401MobileApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIApi20100401MobileApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIApi20100401MobileApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIApi20100401MobileApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIApi20100401MobileApi::setUsername(const QString &username) {
    _username = username;
}

void OAIApi20100401MobileApi::setPassword(const QString &password) {
    _password = password;
}


void OAIApi20100401MobileApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIApi20100401MobileApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIApi20100401MobileApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIApi20100401MobileApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIApi20100401MobileApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIApi20100401MobileApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIApi20100401MobileApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIApi20100401MobileApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIApi20100401MobileApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIApi20100401MobileApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIApi20100401MobileApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIApi20100401MobileApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIApi20100401MobileApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIApi20100401MobileApi::createIncomingPhoneNumberMobile(const QString &account_sid, const QString &phone_number, const ::OpenAPI::OptionalParam<QString> &address_sid, const ::OpenAPI::OptionalParam<QString> &api_version, const ::OpenAPI::OptionalParam<QString> &bundle_sid, const ::OpenAPI::OptionalParam<QString> &emergency_address_sid, const ::OpenAPI::OptionalParam<OAIIncoming_phone_number_mobile_enum_emergency_status> &emergency_status, const ::OpenAPI::OptionalParam<QString> &friendly_name, const ::OpenAPI::OptionalParam<QString> &identity_sid, const ::OpenAPI::OptionalParam<QString> &sms_application_sid, const ::OpenAPI::OptionalParam<QString> &sms_fallback_method, const ::OpenAPI::OptionalParam<QString> &sms_fallback_url, const ::OpenAPI::OptionalParam<QString> &sms_method, const ::OpenAPI::OptionalParam<QString> &sms_url, const ::OpenAPI::OptionalParam<QString> &status_callback, const ::OpenAPI::OptionalParam<QString> &status_callback_method, const ::OpenAPI::OptionalParam<QString> &trunk_sid, const ::OpenAPI::OptionalParam<QString> &voice_application_sid, const ::OpenAPI::OptionalParam<bool> &voice_caller_id_lookup, const ::OpenAPI::OptionalParam<QString> &voice_fallback_method, const ::OpenAPI::OptionalParam<QString> &voice_fallback_url, const ::OpenAPI::OptionalParam<QString> &voice_method, const ::OpenAPI::OptionalParam<OAIIncoming_phone_number_mobile_enum_voice_receive_mode> &voice_receive_mode, const ::OpenAPI::OptionalParam<QString> &voice_url) {
    QString fullPath = QString(_serverConfigs["createIncomingPhoneNumberMobile"][_serverIndices.value("createIncomingPhoneNumberMobile")].URL()+"/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApi20100401MobileApi::createIncomingPhoneNumberMobileCallback);
    connect(this, &OAIApi20100401MobileApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIApi20100401MobileApi::createIncomingPhoneNumberMobileCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIApi_v2010_account_incoming_phone_number_incoming_phone_number_mobile output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createIncomingPhoneNumberMobileSignal(output);
        Q_EMIT createIncomingPhoneNumberMobileSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createIncomingPhoneNumberMobileSignalE(output, error_type, error_str);
        Q_EMIT createIncomingPhoneNumberMobileSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createIncomingPhoneNumberMobileSignalError(output, error_type, error_str);
        Q_EMIT createIncomingPhoneNumberMobileSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIApi20100401MobileApi::listAvailablePhoneNumberMobile(const QString &account_sid, const QString &country_code, const ::OpenAPI::OptionalParam<qint32> &area_code, const ::OpenAPI::OptionalParam<QString> &contains, const ::OpenAPI::OptionalParam<bool> &sms_enabled, const ::OpenAPI::OptionalParam<bool> &mms_enabled, const ::OpenAPI::OptionalParam<bool> &voice_enabled, const ::OpenAPI::OptionalParam<bool> &exclude_all_address_required, const ::OpenAPI::OptionalParam<bool> &exclude_local_address_required, const ::OpenAPI::OptionalParam<bool> &exclude_foreign_address_required, const ::OpenAPI::OptionalParam<bool> &beta, const ::OpenAPI::OptionalParam<QString> &near_number, const ::OpenAPI::OptionalParam<QString> &near_lat_long, const ::OpenAPI::OptionalParam<qint32> &distance, const ::OpenAPI::OptionalParam<QString> &in_postal_code, const ::OpenAPI::OptionalParam<QString> &in_region, const ::OpenAPI::OptionalParam<QString> &in_rate_center, const ::OpenAPI::OptionalParam<QString> &in_lata, const ::OpenAPI::OptionalParam<QString> &in_locality, const ::OpenAPI::OptionalParam<bool> &fax_enabled, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["listAvailablePhoneNumberMobile"][_serverIndices.value("listAvailablePhoneNumberMobile")].URL()+"/2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/Mobile.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApi20100401MobileApi::listAvailablePhoneNumberMobileCallback);
    connect(this, &OAIApi20100401MobileApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIApi20100401MobileApi::listAvailablePhoneNumberMobileCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIListAvailablePhoneNumberMobileResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listAvailablePhoneNumberMobileSignal(output);
        Q_EMIT listAvailablePhoneNumberMobileSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listAvailablePhoneNumberMobileSignalE(output, error_type, error_str);
        Q_EMIT listAvailablePhoneNumberMobileSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listAvailablePhoneNumberMobileSignalError(output, error_type, error_str);
        Q_EMIT listAvailablePhoneNumberMobileSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIApi20100401MobileApi::listIncomingPhoneNumberMobile(const QString &account_sid, const ::OpenAPI::OptionalParam<bool> &beta, const ::OpenAPI::OptionalParam<QString> &friendly_name, const ::OpenAPI::OptionalParam<QString> &phone_number, const ::OpenAPI::OptionalParam<QString> &origin, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["listIncomingPhoneNumberMobile"][_serverIndices.value("listIncomingPhoneNumberMobile")].URL()+"/2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApi20100401MobileApi::listIncomingPhoneNumberMobileCallback);
    connect(this, &OAIApi20100401MobileApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIApi20100401MobileApi::listIncomingPhoneNumberMobileCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIListIncomingPhoneNumberMobileResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listIncomingPhoneNumberMobileSignal(output);
        Q_EMIT listIncomingPhoneNumberMobileSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listIncomingPhoneNumberMobileSignalE(output, error_type, error_str);
        Q_EMIT listIncomingPhoneNumberMobileSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listIncomingPhoneNumberMobileSignalError(output, error_type, error_str);
        Q_EMIT listIncomingPhoneNumberMobileSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIApi20100401MobileApi::tokenAvailable(){
