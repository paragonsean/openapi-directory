...
/*
 * OAIApi_v2010_account_usage_usage_record_usage_record_yearly.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_usage_usage_record_usage_record_yearly_H
#define OAIApi_v2010_account_usage_usage_record_usage_record_yearly_H
...
class OAIApi_v2010_account_usage_usage_record_usage_record_yearly : public OAIObject {
public:
    OAIApi_v2010_account_usage_usage_record_usage_record_yearly();
    OAIApi_v2010_account_usage_usage_record_usage_record_yearly(QString json);
    ~OAIApi_v2010_account_usage_usage_record_usage_record_yearly() override;
    ...
    OAIUsage_record_yearly_enum_category getCategory() const;
    void setCategory(const OAIUsage_record_yearly_enum_category &category);
...
private:
    ...
    OAIUsage_record_yearly_enum_category m_category;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_usage_usage_record_usage_record_yearly)

#endif // OAIApi_v2010_account_usage_usage_record_usage_record_yearly_H
