...
/*
 * OAIApi_v2010_account_usage_usage_record_usage_record_yesterday.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_usage_usage_record_usage_record_yesterday_H
#define OAIApi_v2010_account_usage_usage_record_usage_record_yesterday_H
...
class OAIApi_v2010_account_usage_usage_record_usage_record_yesterday : public OAIObject {
public:
    OAIApi_v2010_account_usage_usage_record_usage_record_yesterday();
    OAIApi_v2010_account_usage_usage_record_usage_record_yesterday(QString json);
    ~OAIApi_v2010_account_usage_usage_record_usage_record_yesterday() override;
    ...
    OAIUsage_record_yesterday_enum_category getCategory() const;
    void setCategory(const OAIUsage_record_yesterday_enum_category &category);
...
private:
    ...
    OAIUsage_record_yesterday_enum_category m_category;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_usage_usage_record_usage_record_yesterday)

#endif // OAIApi_v2010_account_usage_usage_record_usage_record_yesterday_H
