...
/*
 * OAIApi_v2010_account_usage_usage_record_usage_record_all_time.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_usage_usage_record_usage_record_all_time_H
#define OAIApi_v2010_account_usage_usage_record_usage_record_all_time_H
...
class OAIApi_v2010_account_usage_usage_record_usage_record_all_time : public OAIObject {
public:
    OAIApi_v2010_account_usage_usage_record_usage_record_all_time();
    OAIApi_v2010_account_usage_usage_record_usage_record_all_time(QString json);
    ~OAIApi_v2010_account_usage_usage_record_usage_record_all_time() override;
    ...
    OAIUsage_record_all_time_enum_category getCategory() const;
    void setCategory(const OAIUsage_record_all_time_enum_category &category);
...
private:
    ...
    OAIUsage_record_all_time_enum_category m_category;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_usage_usage_record_usage_record_all_time)

#endif // OAIApi_v2010_account_usage_usage_record_usage_record_all_time_H
