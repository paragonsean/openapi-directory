...
#ifndef OAI_OAIApi20100401SharedCostApi_H
#define OAI_OAIApi20100401SharedCostApi_H
...
class OAIApi20100401SharedCostApi : public QObject {
    Q_OBJECT

public:
    OAIApi20100401SharedCostApi(const int timeOut = 0);
    ~OAIApi20100401SharedCostApi();
...
private:
    ...
    void listAvailablePhoneNumberSharedCostCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void listAvailablePhoneNumberSharedCostSignal(OAIListAvailablePhoneNumberSharedCostResponse summary);


    void listAvailablePhoneNumberSharedCostSignalFull(OAIHttpRequestWorker *worker, OAIListAvailablePhoneNumberSharedCostResponse summary);

    Q_DECL_DEPRECATED_X("Use listAvailablePhoneNumberSharedCostSignalError() instead")
    void listAvailablePhoneNumberSharedCostSignalE(OAIListAvailablePhoneNumberSharedCostResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listAvailablePhoneNumberSharedCostSignalError(OAIListAvailablePhoneNumberSharedCostResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use listAvailablePhoneNumberSharedCostSignalErrorFull() instead")
    void listAvailablePhoneNumberSharedCostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void listAvailablePhoneNumberSharedCostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
