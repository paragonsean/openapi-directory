...
#ifndef OAI_OAIApi20100401NationalApi_H
#define OAI_OAIApi20100401NationalApi_H
...
class OAIApi20100401NationalApi : public QObject {
    Q_OBJECT

public:
    OAIApi20100401NationalApi(const int timeOut = 0);
    ~OAIApi20100401NationalApi();
...
private:
    ...
    void listAvailablePhoneNumberNationalCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void listAvailablePhoneNumberNationalSignal(OAIListAvailablePhoneNumberNationalResponse summary);


    void listAvailablePhoneNumberNationalSignalFull(OAIHttpRequestWorker *worker, OAIListAvailablePhoneNumberNationalResponse summary);

    Q_DECL_DEPRECATED_X("Use listAvailablePhoneNumberNationalSignalError() instead")
    void listAvailablePhoneNumberNationalSignalE(OAIListAvailablePhoneNumberNationalResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void listAvailablePhoneNumberNationalSignalError(OAIListAvailablePhoneNumberNationalResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use listAvailablePhoneNumberNationalSignalErrorFull() instead")
    void listAvailablePhoneNumberNationalSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void listAvailablePhoneNumberNationalSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
