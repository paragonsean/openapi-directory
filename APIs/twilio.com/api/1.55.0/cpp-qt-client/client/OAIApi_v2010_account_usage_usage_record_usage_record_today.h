...
/*
 * OAIApi_v2010_account_usage_usage_record_usage_record_today.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_usage_usage_record_usage_record_today_H
#define OAIApi_v2010_account_usage_usage_record_usage_record_today_H
...
class OAIApi_v2010_account_usage_usage_record_usage_record_today : public OAIObject {
public:
    OAIApi_v2010_account_usage_usage_record_usage_record_today();
    OAIApi_v2010_account_usage_usage_record_usage_record_today(QString json);
    ~OAIApi_v2010_account_usage_usage_record_usage_record_today() override;
    ...
    OAIUsage_record_today_enum_category getCategory() const;
    void setCategory(const OAIUsage_record_today_enum_category &category);
...
private:
    ...
    OAIUsage_record_today_enum_category m_category;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_usage_usage_record_usage_record_today)

#endif // OAIApi_v2010_account_usage_usage_record_usage_record_today_H
