...
/*
 * OAIApi_v2010_account_usage_usage_record_usage_record_daily.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_usage_usage_record_usage_record_daily_H
#define OAIApi_v2010_account_usage_usage_record_usage_record_daily_H
...
class OAIApi_v2010_account_usage_usage_record_usage_record_daily : public OAIObject {
public:
    OAIApi_v2010_account_usage_usage_record_usage_record_daily();
    OAIApi_v2010_account_usage_usage_record_usage_record_daily(QString json);
    ~OAIApi_v2010_account_usage_usage_record_usage_record_daily() override;
    ...
    OAIUsage_record_daily_enum_category getCategory() const;
    void setCategory(const OAIUsage_record_daily_enum_category &category);
...
private:
    ...
    OAIUsage_record_daily_enum_category m_category;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_usage_usage_record_usage_record_daily)

#endif // OAIApi_v2010_account_usage_usage_record_usage_record_daily_H
