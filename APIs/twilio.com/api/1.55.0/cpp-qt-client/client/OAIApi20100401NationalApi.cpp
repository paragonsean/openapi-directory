...
#include "OAIApi20100401NationalApi.h"
...
OAIApi20100401NationalApi::OAIApi20100401NationalApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIApi20100401NationalApi::~OAIApi20100401NationalApi() {
}

void OAIApi20100401NationalApi::initializeServerConfigs() {
    //Default server
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("listAvailablePhoneNumberNational", serverConf);
    _serverIndices.insert("listAvailablePhoneNumberNational", 0);
}
...
*/
int OAIApi20100401NationalApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIApi20100401NationalApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIApi20100401NationalApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIApi20100401NationalApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIApi20100401NationalApi::setUsername(const QString &username) {
    _username = username;
}

void OAIApi20100401NationalApi::setPassword(const QString &password) {
    _password = password;
}


void OAIApi20100401NationalApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIApi20100401NationalApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIApi20100401NationalApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIApi20100401NationalApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIApi20100401NationalApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIApi20100401NationalApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIApi20100401NationalApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIApi20100401NationalApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIApi20100401NationalApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIApi20100401NationalApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIApi20100401NationalApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIApi20100401NationalApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIApi20100401NationalApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIApi20100401NationalApi::listAvailablePhoneNumberNational(const QString &account_sid, const QString &country_code, const ::OpenAPI::OptionalParam<qint32> &area_code, const ::OpenAPI::OptionalParam<QString> &contains, const ::OpenAPI::OptionalParam<bool> &sms_enabled, const ::OpenAPI::OptionalParam<bool> &mms_enabled, const ::OpenAPI::OptionalParam<bool> &voice_enabled, const ::OpenAPI::OptionalParam<bool> &exclude_all_address_required, const ::OpenAPI::OptionalParam<bool> &exclude_local_address_required, const ::OpenAPI::OptionalParam<bool> &exclude_foreign_address_required, const ::OpenAPI::OptionalParam<bool> &beta, const ::OpenAPI::OptionalParam<QString> &near_number, const ::OpenAPI::OptionalParam<QString> &near_lat_long, const ::OpenAPI::OptionalParam<qint32> &distance, const ::OpenAPI::OptionalParam<QString> &in_postal_code, const ::OpenAPI::OptionalParam<QString> &in_region, const ::OpenAPI::OptionalParam<QString> &in_rate_center, const ::OpenAPI::OptionalParam<QString> &in_lata, const ::OpenAPI::OptionalParam<QString> &in_locality, const ::OpenAPI::OptionalParam<bool> &fax_enabled, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QString> &page_token) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApi20100401NationalApi::listAvailablePhoneNumberNationalCallback);
    connect(this, &OAIApi20100401NationalApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIApi20100401NationalApi::listAvailablePhoneNumberNationalCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListAvailablePhoneNumberNationalResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listAvailablePhoneNumberNationalSignal(output);
        Q_EMIT listAvailablePhoneNumberNationalSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listAvailablePhoneNumberNationalSignalE(output, error_type, error_str);
        Q_EMIT listAvailablePhoneNumberNationalSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listAvailablePhoneNumberNationalSignalError(output, error_type, error_str);
        Q_EMIT listAvailablePhoneNumberNationalSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIApi20100401NationalApi::tokenAvailable(){
