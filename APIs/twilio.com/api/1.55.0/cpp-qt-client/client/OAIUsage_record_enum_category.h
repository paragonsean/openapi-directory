...
/*
 * OAIUsage_record_enum_category.h
 *
 * 
 */

#ifndef OAIUsage_record_enum_category_H
#define OAIUsage_record_enum_category_H
...
class OAIUsage_record_enum_category : public OAIEnum {
public:
    OAIUsage_record_enum_category();
    OAIUsage_record_enum_category(QString json);
    ~OAIUsage_record_enum_category() override;
    ...
    enum class eOAIUsage_record_enum_category {
    ...
    OAIUsage_record_enum_category::eOAIUsage_record_enum_category getValue() const;
    void setValue(const OAIUsage_record_enum_category::eOAIUsage_record_enum_category& value);
...
private:
    ...
    eOAIUsage_record_enum_category m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsage_record_enum_category)

#endif // OAIUsage_record_enum_category_H
