...
/*
 * OAIApi_v2010_account_key.h
 *
 * 
 */

#ifndef OAIApi_v2010_account_key_H
#define OAIApi_v2010_account_key_H
...
class OAIApi_v2010_account_key : public OAIObject {
public:
    OAIApi_v2010_account_key();
    OAIApi_v2010_account_key(QString json);
    ~OAIApi_v2010_account_key() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApi_v2010_account_key)

#endif // OAIApi_v2010_account_key_H
