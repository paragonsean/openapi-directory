...
class MessagingV1LinkshorteningMessagingService(Model):
    ...
    def __init__(self, domain_sid: str=None, messaging_service_sid: str=None, url: str=None):
        """MessagingV1LinkshorteningMessagingService - a model defined in OpenAPI

        :param domain_sid: The domain_sid of this MessagingV1LinkshorteningMessagingService.
        :param messaging_service_sid: The messaging_service_sid of this MessagingV1LinkshorteningMessagingService.
        :param url: The url of this MessagingV1LinkshorteningMessagingService.
        """
        self.openapi_types = {
            'domain_sid': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MessagingV1LinkshorteningMessagingService':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The messaging.v1.linkshortening_messaging_service of this MessagingV1LinkshorteningMessagingService.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def domain_sid(self):
        """Gets the domain_sid of this MessagingV1LinkshorteningMessagingService.

        The unique string identifies the domain resource

        :return: The domain_sid of this MessagingV1LinkshorteningMessagingService.
        :rtype: str
        """
    ...
    def domain_sid(self, domain_sid):
        """Sets the domain_sid of this MessagingV1LinkshorteningMessagingService.
    ...
    def messaging_service_sid(self):
        """Gets the messaging_service_sid of this MessagingV1LinkshorteningMessagingService.

        The unique string that identifies the messaging service

        :return: The messaging_service_sid of this MessagingV1LinkshorteningMessagingService.
        :rtype: str
        """
    ...
    def messaging_service_sid(self, messaging_service_sid):
        """Sets the messaging_service_sid of this MessagingV1LinkshorteningMessagingService.
    ...
    @property
    def url(self):
        """Gets the url of this MessagingV1LinkshorteningMessagingService.


        :return: The url of this MessagingV1LinkshorteningMessagingService.
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this MessagingV1LinkshorteningMessagingService.
