...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioMessaging.MessagingV1DomainConfigApi();
  });
  ...
  describe('MessagingV1DomainConfigApi', function() {
    describe('fetchDomainConfig', function() {
      it('should call fetchDomainConfig successfully', function(done) {
        //uncomment below and update the code to test fetchDomainConfig
        //instance.fetchDomainConfig(function(error) {
