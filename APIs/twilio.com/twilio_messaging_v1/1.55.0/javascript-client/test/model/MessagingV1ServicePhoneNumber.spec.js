...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioMessaging.MessagingV1ServicePhoneNumber();
  });
  ...
  describe('MessagingV1ServicePhoneNumber', function() {
    it('should create an instance of MessagingV1ServicePhoneNumber', function() {
      // uncomment below and update the code to test MessagingV1ServicePhoneNumber
      //var instance = new TwilioMessaging.MessagingV1ServicePhoneNumber();
      //expect(instance).to.be.a(TwilioMessaging.MessagingV1ServicePhoneNumber);
    });
