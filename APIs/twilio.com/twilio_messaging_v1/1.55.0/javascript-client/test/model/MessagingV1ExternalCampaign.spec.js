...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioMessaging.MessagingV1ExternalCampaign();
  });
  ...
  describe('MessagingV1ExternalCampaign', function() {
    it('should create an instance of MessagingV1ExternalCampaign', function() {
      // uncomment below and update the code to test MessagingV1ExternalCampaign
      //var instance = new TwilioMessaging.MessagingV1ExternalCampaign();
      //expect(instance).to.be.a(TwilioMessaging.MessagingV1ExternalCampaign);
    });
