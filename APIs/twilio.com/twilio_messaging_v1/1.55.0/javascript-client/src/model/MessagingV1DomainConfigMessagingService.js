...
/**
 * The MessagingV1DomainConfigMessagingService model module.
 * @module model/MessagingV1DomainConfigMessagingService
 * @version 1.55.0
 */
class MessagingV1DomainConfigMessagingService {
    /**
     * Constructs a new <code>MessagingV1DomainConfigMessagingService</code>.
     * @alias module:model/MessagingV1DomainConfigMessagingService
     */
    constructor() { 
        
        MessagingV1DomainConfigMessagingService.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessagingV1DomainConfigMessagingService</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessagingV1DomainConfigMessagingService} obj Optional instance to populate.
     * @return {module:model/MessagingV1DomainConfigMessagingService} The populated <code>MessagingV1DomainConfigMessagingService</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessagingV1DomainConfigMessagingService();
    ...
    /**
     * Validates the JSON data with respect to <code>MessagingV1DomainConfigMessagingService</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessagingV1DomainConfigMessagingService</code>.
     */
 ...
 */
MessagingV1DomainConfigMessagingService.prototype['callback_url'] = undefined;

/**
 * The unique string that we created to identify the Domain config (prefix ZK).
 * @member {String} config_sid
 */
MessagingV1DomainConfigMessagingService.prototype['config_sid'] = undefined;
 ...
 */
MessagingV1DomainConfigMessagingService.prototype['continue_on_failure'] = undefined;

/**
 * Date this Domain Config was created.
 * @member {Date} date_created
 */
MessagingV1DomainConfigMessagingService.prototype['date_created'] = undefined;

/**
 * Date that this Domain Config was last updated.
 * @member {Date} date_updated
 */
MessagingV1DomainConfigMessagingService.prototype['date_updated'] = undefined;

/**
 * The unique string that we created to identify the Domain resource.
 * @member {String} domain_sid
 */
MessagingV1DomainConfigMessagingService.prototype['domain_sid'] = undefined;
 ...
 */
MessagingV1DomainConfigMessagingService.prototype['fallback_url'] = undefined;

/**
 * The unique string that identifies the messaging service
 * @member {String} messaging_service_sid
 */
MessagingV1DomainConfigMessagingService.prototype['messaging_service_sid'] = undefined;

/**
 * @member {String} url
 */
MessagingV1DomainConfigMessagingService.prototype['url'] = undefined;
...
export default MessagingV1DomainConfigMessagingService;
