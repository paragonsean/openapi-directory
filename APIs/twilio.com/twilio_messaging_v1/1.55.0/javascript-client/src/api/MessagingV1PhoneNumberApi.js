...
/**
* MessagingV1PhoneNumber service.
* @module api/MessagingV1PhoneNumberApi
* @version 1.55.0
*/
export default class MessagingV1PhoneNumberApi {

    /**
    * Constructs a new MessagingV1PhoneNumberApi. 
    * @alias module:api/MessagingV1PhoneNumberApi
    * @class
    ...
    */
     ...
     * @callback module:api/MessagingV1PhoneNumberApi~createPhoneNumberCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MessagingV1ServicePhoneNumber} data The data returned by the service call.
     ...
     * @param {module:api/MessagingV1PhoneNumberApi~createPhoneNumberCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MessagingV1ServicePhoneNumber}
     */
    createPhoneNumber(serviceSid, phoneNumberSid, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      if (phoneNumberSid === undefined || phoneNumberSid === null) {
        throw new Error("Missing the required parameter 'phoneNumberSid' when calling createPhoneNumber");
      }
      ...
      let returnType = MessagingV1ServicePhoneNumber;
     ...
     * @callback module:api/MessagingV1PhoneNumberApi~deletePhoneNumberCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MessagingV1PhoneNumberApi~deletePhoneNumberCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/MessagingV1PhoneNumberApi~fetchPhoneNumberCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MessagingV1ServicePhoneNumber} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MessagingV1PhoneNumberApi~fetchPhoneNumberCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MessagingV1ServicePhoneNumber}
     */
     ...
     * @callback module:api/MessagingV1PhoneNumberApi~listPhoneNumberCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MessagingV1PhoneNumberApi~listPhoneNumberCallback} callback The callback function, accepting three arguments: error, data, response
