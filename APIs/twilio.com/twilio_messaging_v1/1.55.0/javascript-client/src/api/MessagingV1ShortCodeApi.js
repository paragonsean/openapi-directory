...
/**
* MessagingV1ShortCode service.
* @module api/MessagingV1ShortCodeApi
* @version 1.55.0
*/
export default class MessagingV1ShortCodeApi {

    /**
    * Constructs a new MessagingV1ShortCodeApi. 
    * @alias module:api/MessagingV1ShortCodeApi
    * @class
    ...
    */
     ...
     * @callback module:api/MessagingV1ShortCodeApi~createShortCodeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MessagingV1ServiceShortCode} data The data returned by the service call.
     ...
     * @param {module:api/MessagingV1ShortCodeApi~createShortCodeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MessagingV1ServiceShortCode}
     */
    createShortCode(serviceSid, shortCodeSid, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      if (shortCodeSid === undefined || shortCodeSid === null) {
        throw new Error("Missing the required parameter 'shortCodeSid' when calling createShortCode");
      }
      ...
      let returnType = MessagingV1ServiceShortCode;
     ...
     * @callback module:api/MessagingV1ShortCodeApi~deleteShortCodeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MessagingV1ShortCodeApi~deleteShortCodeCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/MessagingV1ShortCodeApi~fetchShortCodeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MessagingV1ServiceShortCode} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MessagingV1ShortCodeApi~fetchShortCodeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MessagingV1ServiceShortCode}
     */
     ...
     * @callback module:api/MessagingV1ShortCodeApi~listShortCodeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MessagingV1ShortCodeApi~listShortCodeCallback} callback The callback function, accepting three arguments: error, data, response
