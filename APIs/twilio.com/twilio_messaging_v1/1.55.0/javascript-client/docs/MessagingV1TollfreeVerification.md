# TwilioMessaging.MessagingV1TollfreeVerification
...
**editExpiration** | **Date** | The date and time when the ability to edit a rejected verification expires. | [optional] 
**errorCode** | **Number** | The error code given when a Tollfree Verification has been rejected. | [optional] 
...
**optInType** | [**TollfreeVerificationEnumOptInType**](TollfreeVerificationEnumOptInType.md) |  | [optional] 
...
**rejectionReasons** | **[Object]** | A list of rejection reasons and codes describing why a Tollfree Verification has been rejected. | [optional] 
...
**status** | [**TollfreeVerificationEnumStatus**](TollfreeVerificationEnumStatus.md) |  | [optional] 
...
**url** | **String** | The absolute URL of the Tollfree Verification resource. | [optional] 
