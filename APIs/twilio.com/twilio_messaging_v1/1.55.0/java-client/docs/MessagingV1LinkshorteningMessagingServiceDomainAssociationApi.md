...
<a id="fetchLinkshorteningMessagingServiceDomainAssociation"></a>
...
import org.openapitools.client.api.MessagingV1LinkshorteningMessagingServiceDomainAssociationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    MessagingV1LinkshorteningMessagingServiceDomainAssociationApi apiInstance = new MessagingV1LinkshorteningMessagingServiceDomainAssociationApi(defaultClient);
    ...
    try {
      MessagingV1LinkshorteningMessagingServiceDomainAssociation result = apiInstance.fetchLinkshorteningMessagingServiceDomainAssociation(messagingServiceSid);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MessagingV1LinkshorteningMessagingServiceDomainAssociationApi#fetchLinkshorteningMessagingServiceDomainAssociation");
