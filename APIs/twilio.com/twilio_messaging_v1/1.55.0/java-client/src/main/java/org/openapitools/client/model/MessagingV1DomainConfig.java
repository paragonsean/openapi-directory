...
public class MessagingV1DomainConfig {
  ...
  public static final String SERIALIZED_NAME_DISABLE_HTTPS = "disable_https";
  @SerializedName(SERIALIZED_NAME_DISABLE_HTTPS)
  ...
  public MessagingV1DomainConfig callbackUrl(URI callbackUrl) {
  ...
  public MessagingV1DomainConfig configSid(String configSid) {
  ...
  public MessagingV1DomainConfig continueOnFailure(Boolean continueOnFailure) {
  ...
  public MessagingV1DomainConfig dateCreated(OffsetDateTime dateCreated) {
  ...
  public MessagingV1DomainConfig dateUpdated(OffsetDateTime dateUpdated) {
  ...
  public MessagingV1DomainConfig disableHttps(Boolean disableHttps) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getDisableHttps() {
    return disableHttps;
  }
  ...
  public MessagingV1DomainConfig domainSid(String domainSid) {
  ...
  public MessagingV1DomainConfig fallbackUrl(URI fallbackUrl) {
  ...
  public MessagingV1DomainConfig url(URI url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MessagingV1DomainConfig messagingV1DomainConfig = (MessagingV1DomainConfig) o;
    return Objects.equals(this.callbackUrl, messagingV1DomainConfig.callbackUrl) &&
        Objects.equals(this.configSid, messagingV1DomainConfig.configSid) &&
        Objects.equals(this.continueOnFailure, messagingV1DomainConfig.continueOnFailure) &&
        Objects.equals(this.dateCreated, messagingV1DomainConfig.dateCreated) &&
        Objects.equals(this.dateUpdated, messagingV1DomainConfig.dateUpdated) &&
        Objects.equals(this.disableHttps, messagingV1DomainConfig.disableHttps) &&
        Objects.equals(this.domainSid, messagingV1DomainConfig.domainSid) &&
        Objects.equals(this.fallbackUrl, messagingV1DomainConfig.fallbackUrl) &&
        Objects.equals(this.url, messagingV1DomainConfig.url);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(callbackUrl, configSid, continueOnFailure, dateCreated, dateUpdated, disableHttps, domainSid, fallbackUrl, url);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessagingV1DomainConfig {\n");
    ...
    sb.append("    disableHttps: ").append(toIndentedString(disableHttps)).append("\n");
  ...
  static {
    ...
    openapiFields.add("disable_https");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessagingV1DomainConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessagingV1DomainConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessagingV1DomainConfig is not found in the empty JSON string", MessagingV1DomainConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessagingV1DomainConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessagingV1DomainConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessagingV1DomainConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessagingV1DomainConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessagingV1DomainConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessagingV1DomainConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<MessagingV1DomainConfig>() {
           @Override
           public void write(JsonWriter out, MessagingV1DomainConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessagingV1DomainConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessagingV1DomainConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessagingV1DomainConfig
   * @throws IOException if the JSON string is invalid with respect to MessagingV1DomainConfig
   */
  public static MessagingV1DomainConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessagingV1DomainConfig.class);
  }

  /**
   * Convert an instance of MessagingV1DomainConfig to an JSON string
   *
   * @return JSON string
   */
