...
public class ListServiceResponse {
  ...
  private List<MessagingV1Service> services = new ArrayList<>();
  ...
  public ListServiceResponse services(List<MessagingV1Service> services) {
    this.services = services;
    return this;
  }

  public ListServiceResponse addServicesItem(MessagingV1Service servicesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<MessagingV1Service> getServices() {
    return services;
  }

  public void setServices(List<MessagingV1Service> services) {
    this.services = services;
  }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            MessagingV1Service.validateJsonElement(jsonArrayservices.get(i));
          };
        }
      }
  }
