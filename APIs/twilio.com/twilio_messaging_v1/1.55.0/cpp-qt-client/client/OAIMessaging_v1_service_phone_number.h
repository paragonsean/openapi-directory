...
/*
 * OAIMessaging_v1_service_phone_number.h
 *
 * 
 */

#ifndef OAIMessaging_v1_service_phone_number_H
#define OAIMessaging_v1_service_phone_number_H
...
class OAIMessaging_v1_service_phone_number : public OAIObject {
public:
    OAIMessaging_v1_service_phone_number();
    OAIMessaging_v1_service_phone_number(QString json);
    ~OAIMessaging_v1_service_phone_number() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessaging_v1_service_phone_number)

#endif // OAIMessaging_v1_service_phone_number_H
