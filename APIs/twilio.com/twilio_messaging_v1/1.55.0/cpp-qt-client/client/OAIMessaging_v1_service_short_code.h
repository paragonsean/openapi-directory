...
/*
 * OAIMessaging_v1_service_short_code.h
 *
 * 
 */

#ifndef OAIMessaging_v1_service_short_code_H
#define OAIMessaging_v1_service_short_code_H
...
class OAIMessaging_v1_service_short_code : public OAIObject {
public:
    OAIMessaging_v1_service_short_code();
    OAIMessaging_v1_service_short_code(QString json);
    ~OAIMessaging_v1_service_short_code() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessaging_v1_service_short_code)

#endif // OAIMessaging_v1_service_short_code_H
