...
#ifndef OAI_OAIMessagingV1PhoneNumberApi_H
#define OAI_OAIMessagingV1PhoneNumberApi_H
...
class OAIMessagingV1PhoneNumberApi : public QObject {
    Q_OBJECT

public:
    OAIMessagingV1PhoneNumberApi(const int timeOut = 0);
    ~OAIMessagingV1PhoneNumberApi();
    ...
    */
    virtual void createPhoneNumber(const QString &service_sid, const QString &phone_number_sid);
...
Q_SIGNALS:
    ...
    void createPhoneNumberSignal(OAIMessaging_v1_service_phone_number summary);
    void deletePhoneNumberSignal();
    void fetchPhoneNumberSignal(OAIMessaging_v1_service_phone_number summary);
    void listPhoneNumberSignal(OAIListPhoneNumberResponse summary);


    void createPhoneNumberSignalFull(OAIHttpRequestWorker *worker, OAIMessaging_v1_service_phone_number summary);
    void deletePhoneNumberSignalFull(OAIHttpRequestWorker *worker);
    void fetchPhoneNumberSignalFull(OAIHttpRequestWorker *worker, OAIMessaging_v1_service_phone_number summary);
    ...
    void createPhoneNumberSignalE(OAIMessaging_v1_service_phone_number summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createPhoneNumberSignalError(OAIMessaging_v1_service_phone_number summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchPhoneNumberSignalE(OAIMessaging_v1_service_phone_number summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchPhoneNumberSignalError(OAIMessaging_v1_service_phone_number summary, QNetworkReply::NetworkError error_type, const QString &error_str);
