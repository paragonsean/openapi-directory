...
/*
 * OAIConversations_v1_service_service_conversation_service_conversation_scoped_webhook.h
 *
 * 
 */

#ifndef OAIConversations_v1_service_service_conversation_service_conversation_scoped_webhook_H
#define OAIConversations_v1_service_service_conversation_service_conversation_scoped_webhook_H
...
class OAIConversations_v1_service_service_conversation_service_conversation_scoped_webhook : public OAIObject {
public:
    OAIConversations_v1_service_service_conversation_service_conversation_scoped_webhook();
    OAIConversations_v1_service_service_conversation_service_conversation_scoped_webhook(QString json);
    ~OAIConversations_v1_service_service_conversation_service_conversation_scoped_webhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_v1_service_service_conversation_service_conversation_scoped_webhook)

#endif // OAIConversations_v1_service_service_conversation_service_conversation_scoped_webhook_H
