...
/*
 * OAIConversations_v1_service.h
 *
 * 
 */

#ifndef OAIConversations_v1_service_H
#define OAIConversations_v1_service_H
...
class OAIConversations_v1_service : public OAIObject {
public:
    OAIConversations_v1_service();
    OAIConversations_v1_service(QString json);
    ~OAIConversations_v1_service() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_v1_service)

#endif // OAIConversations_v1_service_H
