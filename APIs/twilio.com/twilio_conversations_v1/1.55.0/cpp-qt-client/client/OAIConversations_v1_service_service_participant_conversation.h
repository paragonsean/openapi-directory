...
/*
 * OAIConversations_v1_service_service_participant_conversation.h
 *
 * 
 */

#ifndef OAIConversations_v1_service_service_participant_conversation_H
#define OAIConversations_v1_service_service_participant_conversation_H
...
class OAIConversations_v1_service_service_participant_conversation : public OAIObject {
public:
    OAIConversations_v1_service_service_participant_conversation();
    OAIConversations_v1_service_service_participant_conversation(QString json);
    ~OAIConversations_v1_service_service_participant_conversation() override;
    ...
    OAIService_participant_conversation_enum_state getConversationState() const;
    void setConversationState(const OAIService_participant_conversation_enum_state &conversation_state);
...
private:
    ...
    OAIService_participant_conversation_enum_state m_conversation_state;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_v1_service_service_participant_conversation)

#endif // OAIConversations_v1_service_service_participant_conversation_H
