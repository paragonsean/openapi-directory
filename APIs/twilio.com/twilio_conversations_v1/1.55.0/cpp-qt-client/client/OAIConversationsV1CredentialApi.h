...
#ifndef OAI_OAIConversationsV1CredentialApi_H
#define OAI_OAIConversationsV1CredentialApi_H
...
#include "OAICredential_enum_push_type.h"
...
class OAIConversationsV1CredentialApi : public QObject {
    Q_OBJECT

public:
    OAIConversationsV1CredentialApi(const int timeOut = 0);
    ~OAIConversationsV1CredentialApi();
    ...
    /**
    * @param[in]  type OAICredential_enum_push_type [required]
    ...
    */
    virtual void createCredential(const OAICredential_enum_push_type &type, const ::OpenAPI::OptionalParam<QString> &api_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &certificate = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &friendly_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &private_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &sandbox = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &secret = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  sandbox bool [optional]
    * @param[in]  secret QString [optional]
    * @param[in]  type OAICredential_enum_push_type [optional]
    */
    virtual void updateCredential(const QString &sid, const ::OpenAPI::OptionalParam<QString> &api_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &certificate = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &friendly_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &private_key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &sandbox = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &secret = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAICredential_enum_push_type> &type = ::OpenAPI::OptionalParam<OAICredential_enum_push_type>());
...
Q_SIGNALS:
    ...
    void createCredentialSignal(OAIConversations_v1_credential summary);
    void deleteCredentialSignal();
    void fetchCredentialSignal(OAIConversations_v1_credential summary);
    void listCredentialSignal(OAIListCredentialResponse summary);
    void updateCredentialSignal(OAIConversations_v1_credential summary);


    void createCredentialSignalFull(OAIHttpRequestWorker *worker, OAIConversations_v1_credential summary);
    void deleteCredentialSignalFull(OAIHttpRequestWorker *worker);
    void fetchCredentialSignalFull(OAIHttpRequestWorker *worker, OAIConversations_v1_credential summary);
    void listCredentialSignalFull(OAIHttpRequestWorker *worker, OAIListCredentialResponse summary);
    void updateCredentialSignalFull(OAIHttpRequestWorker *worker, OAIConversations_v1_credential summary);

    Q_DECL_DEPRECATED_X("Use createCredentialSignalError() instead")
    void createCredentialSignalE(OAIConversations_v1_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createCredentialSignalError(OAIConversations_v1_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchCredentialSignalE(OAIConversations_v1_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchCredentialSignalError(OAIConversations_v1_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateCredentialSignalE(OAIConversations_v1_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateCredentialSignalError(OAIConversations_v1_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
