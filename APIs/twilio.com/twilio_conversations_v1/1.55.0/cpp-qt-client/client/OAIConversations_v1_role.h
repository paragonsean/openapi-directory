...
/*
 * OAIConversations_v1_role.h
 *
 * 
 */

#ifndef OAIConversations_v1_role_H
#define OAIConversations_v1_role_H
...
class OAIConversations_v1_role : public OAIObject {
public:
    OAIConversations_v1_role();
    OAIConversations_v1_role(QString json);
    ~OAIConversations_v1_role() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_v1_role)

#endif // OAIConversations_v1_role_H
