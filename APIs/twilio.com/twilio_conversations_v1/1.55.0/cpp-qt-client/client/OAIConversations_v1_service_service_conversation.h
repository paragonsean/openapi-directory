...
/*
 * OAIConversations_v1_service_service_conversation.h
 *
 * 
 */

#ifndef OAIConversations_v1_service_service_conversation_H
#define OAIConversations_v1_service_service_conversation_H
...
class OAIConversations_v1_service_service_conversation : public OAIObject {
public:
    OAIConversations_v1_service_service_conversation();
    OAIConversations_v1_service_service_conversation(QString json);
    ~OAIConversations_v1_service_service_conversation() override;
    ...
    OAIService_conversation_enum_state getState() const;
    void setState(const OAIService_conversation_enum_state &state);
...
private:
    ...
    OAIService_conversation_enum_state m_state;
    bool m_state_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_v1_service_service_conversation)

#endif // OAIConversations_v1_service_service_conversation_H
