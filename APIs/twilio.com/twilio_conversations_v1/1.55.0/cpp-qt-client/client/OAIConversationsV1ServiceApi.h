...
#ifndef OAI_OAIConversationsV1ServiceApi_H
#define OAI_OAIConversationsV1ServiceApi_H
...
class OAIConversationsV1ServiceApi : public QObject {
    Q_OBJECT

public:
    OAIConversationsV1ServiceApi(const int timeOut = 0);
    ~OAIConversationsV1ServiceApi();
...
Q_SIGNALS:
    ...
    void createServiceSignal(OAIConversations_v1_service summary);
    void deleteServiceSignal();
    void fetchServiceSignal(OAIConversations_v1_service summary);
    void listServiceSignal(OAIListServiceResponse summary);


    void createServiceSignalFull(OAIHttpRequestWorker *worker, OAIConversations_v1_service summary);
    void deleteServiceSignalFull(OAIHttpRequestWorker *worker);
    void fetchServiceSignalFull(OAIHttpRequestWorker *worker, OAIConversations_v1_service summary);
    ...
    void createServiceSignalE(OAIConversations_v1_service summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createServiceSignalError(OAIConversations_v1_service summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchServiceSignalE(OAIConversations_v1_service summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchServiceSignalError(OAIConversations_v1_service summary, QNetworkReply::NetworkError error_type, const QString &error_str);
