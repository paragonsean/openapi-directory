...
/*
 * OAIConversations_v1_user.h
 *
 * 
 */

#ifndef OAIConversations_v1_user_H
#define OAIConversations_v1_user_H
...
class OAIConversations_v1_user : public OAIObject {
public:
    OAIConversations_v1_user();
    OAIConversations_v1_user(QString json);
    ~OAIConversations_v1_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_v1_user)

#endif // OAIConversations_v1_user_H
