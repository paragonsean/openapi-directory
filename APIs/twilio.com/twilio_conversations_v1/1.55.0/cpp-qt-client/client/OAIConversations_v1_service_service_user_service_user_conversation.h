...
/*
 * OAIConversations_v1_service_service_user_service_user_conversation.h
 *
 * 
 */

#ifndef OAIConversations_v1_service_service_user_service_user_conversation_H
#define OAIConversations_v1_service_service_user_service_user_conversation_H
...
class OAIConversations_v1_service_service_user_service_user_conversation : public OAIObject {
public:
    OAIConversations_v1_service_service_user_service_user_conversation();
    OAIConversations_v1_service_service_user_service_user_conversation(QString json);
    ~OAIConversations_v1_service_service_user_service_user_conversation() override;
    ...
    OAIService_user_conversation_enum_state getConversationState() const;
    void setConversationState(const OAIService_user_conversation_enum_state &conversation_state);
    ...
    OAIService_user_conversation_enum_notification_level getNotificationLevel() const;
    void setNotificationLevel(const OAIService_user_conversation_enum_notification_level &notification_level);
...
private:
    ...
    OAIService_user_conversation_enum_state m_conversation_state;
    ...
    OAIService_user_conversation_enum_notification_level m_notification_level;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_v1_service_service_user_service_user_conversation)

#endif // OAIConversations_v1_service_service_user_service_user_conversation_H
