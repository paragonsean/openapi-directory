...
import ConversationEnumState from './ConversationEnumState';

/**
 * The ConversationsV1Conversation model module.
 * @module model/ConversationsV1Conversation
 * @version 1.55.0
 */
class ConversationsV1Conversation {
    /**
     * Constructs a new <code>ConversationsV1Conversation</code>.
     * @alias module:model/ConversationsV1Conversation
     */
    constructor() { 
        
        ConversationsV1Conversation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConversationsV1Conversation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConversationsV1Conversation} obj Optional instance to populate.
     * @return {module:model/ConversationsV1Conversation} The populated <code>ConversationsV1Conversation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConversationsV1Conversation();
            ...
            if (data.hasOwnProperty('state')) {
                obj['state'] = ConversationEnumState.constructFromObject(data['state']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConversationsV1Conversation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversationsV1Conversation</code>.
     */
 ...
 */
ConversationsV1Conversation.prototype['account_sid'] = undefined;

/**
 * An optional string metadata field you can use to store any data you wish. The string value must contain structurally valid JSON if specified.  **Note** that if the attributes are not set \"{}\" will be returned.
 * @member {String} attributes
 */
ConversationsV1Conversation.prototype['attributes'] = undefined;

/**
 * @member {Object} bindings
 */
ConversationsV1Conversation.prototype['bindings'] = undefined;

/**
 * The unique ID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) this conversation belongs to.
 * @member {String} chat_service_sid
 */
ConversationsV1Conversation.prototype['chat_service_sid'] = undefined;

/**
 * The date that this resource was created.
 * @member {Date} date_created
 */
ConversationsV1Conversation.prototype['date_created'] = undefined;

/**
 * The date that this resource was last updated.
 * @member {Date} date_updated
 */
ConversationsV1Conversation.prototype['date_updated'] = undefined;

/**
 * The human-readable name of this conversation, limited to 256 characters. Optional.
 * @member {String} friendly_name
 */
ConversationsV1Conversation.prototype['friendly_name'] = undefined;
 ...
 * @member {Object} links
 */
ConversationsV1Conversation.prototype['links'] = undefined;
 ...
 */
ConversationsV1Conversation.prototype['messaging_service_sid'] = undefined;

/**
 * A 34 character string that uniquely identifies this resource.
 * @member {String} sid
 */
ConversationsV1Conversation.prototype['sid'] = undefined;

/**
 * @member {module:model/ConversationEnumState} state
 */
ConversationsV1Conversation.prototype['state'] = undefined;

/**
 * Timer date values representing state update for this conversation.
 * @member {Object} timers
 */
ConversationsV1Conversation.prototype['timers'] = undefined;

/**
 * An application-defined string that uniquely identifies the resource. It can be used to address the resource in place of the resource's `sid` in the URL.
 * @member {String} unique_name
 */
ConversationsV1Conversation.prototype['unique_name'] = undefined;

/**
 * An absolute API resource URL for this conversation.
 * @member {String} url
 */
ConversationsV1Conversation.prototype['url'] = undefined;
...
export default ConversationsV1Conversation;
