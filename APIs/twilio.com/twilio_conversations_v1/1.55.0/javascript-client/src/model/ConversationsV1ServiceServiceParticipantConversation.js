...
import ServiceParticipantConversationEnumState from './ServiceParticipantConversationEnumState';

/**
 * The ConversationsV1ServiceServiceParticipantConversation model module.
 * @module model/ConversationsV1ServiceServiceParticipantConversation
 * @version 1.55.0
 */
class ConversationsV1ServiceServiceParticipantConversation {
    /**
     * Constructs a new <code>ConversationsV1ServiceServiceParticipantConversation</code>.
     * @alias module:model/ConversationsV1ServiceServiceParticipantConversation
     */
    constructor() { 
        
        ConversationsV1ServiceServiceParticipantConversation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConversationsV1ServiceServiceParticipantConversation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConversationsV1ServiceServiceParticipantConversation} obj Optional instance to populate.
     * @return {module:model/ConversationsV1ServiceServiceParticipantConversation} The populated <code>ConversationsV1ServiceServiceParticipantConversation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConversationsV1ServiceServiceParticipantConversation();
            ...
            if (data.hasOwnProperty('conversation_state')) {
                obj['conversation_state'] = ServiceParticipantConversationEnumState.constructFromObject(data['conversation_state']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConversationsV1ServiceServiceParticipantConversation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversationsV1ServiceServiceParticipantConversation</code>.
     */
 ...
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['account_sid'] = undefined;

/**
 * The unique ID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) this conversation belongs to.
 * @member {String} chat_service_sid
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['chat_service_sid'] = undefined;

/**
 * An optional string metadata field you can use to store any data you wish. The string value must contain structurally valid JSON if specified.  **Note** that if the attributes are not set \"{}\" will be returned.
 * @member {String} conversation_attributes
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['conversation_attributes'] = undefined;

/**
 * Identity of the creator of this Conversation.
 * @member {String} conversation_created_by
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['conversation_created_by'] = undefined;

/**
 * The date that this conversation was created, given in ISO 8601 format.
 * @member {Date} conversation_date_created
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['conversation_date_created'] = undefined;

/**
 * The date that this conversation was last updated, given in ISO 8601 format.
 * @member {Date} conversation_date_updated
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['conversation_date_updated'] = undefined;

/**
 * The human-readable name of this conversation, limited to 256 characters. Optional.
 * @member {String} conversation_friendly_name
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['conversation_friendly_name'] = undefined;
 ...
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['conversation_sid'] = undefined;

/**
 * @member {module:model/ServiceParticipantConversationEnumState} conversation_state
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['conversation_state'] = undefined;

/**
 * Timer date values representing state update for this conversation.
 * @member {Object} conversation_timers
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['conversation_timers'] = undefined;

/**
 * An application-defined string that uniquely identifies the Conversation resource.
 * @member {String} conversation_unique_name
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['conversation_unique_name'] = undefined;
 ...
 * @member {Object} links
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['links'] = undefined;
 ...
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['participant_identity'] = undefined;
 ...
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['participant_messaging_binding'] = undefined;
 ...
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['participant_sid'] = undefined;
 ...
 */
ConversationsV1ServiceServiceParticipantConversation.prototype['participant_user_sid'] = undefined;
...
export default ConversationsV1ServiceServiceParticipantConversation;
