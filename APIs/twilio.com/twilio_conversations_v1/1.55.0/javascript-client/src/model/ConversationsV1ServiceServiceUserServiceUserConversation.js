...
import ServiceUserConversationEnumNotificationLevel from './ServiceUserConversationEnumNotificationLevel';
import ServiceUserConversationEnumState from './ServiceUserConversationEnumState';

/**
 * The ConversationsV1ServiceServiceUserServiceUserConversation model module.
 * @module model/ConversationsV1ServiceServiceUserServiceUserConversation
 * @version 1.55.0
 */
class ConversationsV1ServiceServiceUserServiceUserConversation {
    /**
     * Constructs a new <code>ConversationsV1ServiceServiceUserServiceUserConversation</code>.
     * @alias module:model/ConversationsV1ServiceServiceUserServiceUserConversation
     */
    constructor() { 
        
        ConversationsV1ServiceServiceUserServiceUserConversation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConversationsV1ServiceServiceUserServiceUserConversation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConversationsV1ServiceServiceUserServiceUserConversation} obj Optional instance to populate.
     * @return {module:model/ConversationsV1ServiceServiceUserServiceUserConversation} The populated <code>ConversationsV1ServiceServiceUserServiceUserConversation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConversationsV1ServiceServiceUserServiceUserConversation();
            ...
            if (data.hasOwnProperty('conversation_state')) {
                obj['conversation_state'] = ServiceUserConversationEnumState.constructFromObject(data['conversation_state']);
            }
            ...
            if (data.hasOwnProperty('notification_level')) {
                obj['notification_level'] = ServiceUserConversationEnumNotificationLevel.constructFromObject(data['notification_level']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConversationsV1ServiceServiceUserServiceUserConversation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversationsV1ServiceServiceUserServiceUserConversation</code>.
     */
 ...
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['account_sid'] = undefined;

/**
 * An optional string metadata field you can use to store any data you wish. The string value must contain structurally valid JSON if specified.  **Note** that if the attributes are not set \"{}\" will be returned.
 * @member {String} attributes
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['attributes'] = undefined;

/**
 * The unique ID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) this conversation belongs to.
 * @member {String} chat_service_sid
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['chat_service_sid'] = undefined;
 ...
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['conversation_sid'] = undefined;

/**
 * @member {module:model/ServiceUserConversationEnumState} conversation_state
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['conversation_state'] = undefined;

/**
 * Identity of the creator of this Conversation.
 * @member {String} created_by
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['created_by'] = undefined;

/**
 * The date that this conversation was created, given in ISO 8601 format.
 * @member {Date} date_created
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['date_created'] = undefined;

/**
 * The date that this conversation was last updated, given in ISO 8601 format.
 * @member {Date} date_updated
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['date_updated'] = undefined;

/**
 * The human-readable name of this conversation, limited to 256 characters. Optional.
 * @member {String} friendly_name
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['friendly_name'] = undefined;

/**
 * The index of the last Message in the Conversation that the Participant has read.
 * @member {Number} last_read_message_index
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['last_read_message_index'] = undefined;
 ...
 * @member {Object} links
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['links'] = undefined;

/**
 * @member {module:model/ServiceUserConversationEnumNotificationLevel} notification_level
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['notification_level'] = undefined;
 ...
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['participant_sid'] = undefined;

/**
 * Timer date values representing state update for this conversation.
 * @member {Object} timers
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['timers'] = undefined;
 ...
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['unique_name'] = undefined;

/**
 * The number of unread Messages in the Conversation for the Participant.
 * @member {Number} unread_messages_count
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['unread_messages_count'] = undefined;

/**
 * @member {String} url
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['url'] = undefined;
 ...
 */
ConversationsV1ServiceServiceUserServiceUserConversation.prototype['user_sid'] = undefined;
...
export default ConversationsV1ServiceServiceUserServiceUserConversation;
