...
/**
 * The ConversationsV1ServiceServiceUser model module.
 * @module model/ConversationsV1ServiceServiceUser
 * @version 1.55.0
 */
class ConversationsV1ServiceServiceUser {
    /**
     * Constructs a new <code>ConversationsV1ServiceServiceUser</code>.
     * @alias module:model/ConversationsV1ServiceServiceUser
     */
    constructor() { 
        
        ConversationsV1ServiceServiceUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConversationsV1ServiceServiceUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConversationsV1ServiceServiceUser} obj Optional instance to populate.
     * @return {module:model/ConversationsV1ServiceServiceUser} The populated <code>ConversationsV1ServiceServiceUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConversationsV1ServiceServiceUser();
    ...
    /**
     * Validates the JSON data with respect to <code>ConversationsV1ServiceServiceUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversationsV1ServiceServiceUser</code>.
     */
 ...
 */
ConversationsV1ServiceServiceUser.prototype['account_sid'] = undefined;
 ...
 */
ConversationsV1ServiceServiceUser.prototype['attributes'] = undefined;
 ...
 */
ConversationsV1ServiceServiceUser.prototype['chat_service_sid'] = undefined;

/**
 * The date and time in GMT when the resource was created specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_created
 */
ConversationsV1ServiceServiceUser.prototype['date_created'] = undefined;

/**
 * The date and time in GMT when the resource was last updated specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_updated
 */
ConversationsV1ServiceServiceUser.prototype['date_updated'] = undefined;

/**
 * The string that you assigned to describe the resource.
 * @member {String} friendly_name
 */
ConversationsV1ServiceServiceUser.prototype['friendly_name'] = undefined;
 ...
 */
ConversationsV1ServiceServiceUser.prototype['identity'] = undefined;
 ...
 */
ConversationsV1ServiceServiceUser.prototype['is_notifiable'] = undefined;
 ...
 */
ConversationsV1ServiceServiceUser.prototype['is_online'] = undefined;

/**
 * @member {Object} links
 */
ConversationsV1ServiceServiceUser.prototype['links'] = undefined;
 ...
 */
ConversationsV1ServiceServiceUser.prototype['role_sid'] = undefined;

/**
 * The unique string that we created to identify the User resource.
 * @member {String} sid
 */
ConversationsV1ServiceServiceUser.prototype['sid'] = undefined;

/**
 * An absolute API resource URL for this user.
 * @member {String} url
 */
ConversationsV1ServiceServiceUser.prototype['url'] = undefined;
...
export default ConversationsV1ServiceServiceUser;
