...
/**
 * The ConversationsV1ServiceServiceConversationServiceConversationMessage model module.
 * @module model/ConversationsV1ServiceServiceConversationServiceConversationMessage
 * @version 1.55.0
 */
class ConversationsV1ServiceServiceConversationServiceConversationMessage {
    /**
     * Constructs a new <code>ConversationsV1ServiceServiceConversationServiceConversationMessage</code>.
     * @alias module:model/ConversationsV1ServiceServiceConversationServiceConversationMessage
     */
    constructor() { 
        
        ConversationsV1ServiceServiceConversationServiceConversationMessage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConversationsV1ServiceServiceConversationServiceConversationMessage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConversationsV1ServiceServiceConversationServiceConversationMessage} obj Optional instance to populate.
     * @return {module:model/ConversationsV1ServiceServiceConversationServiceConversationMessage} The populated <code>ConversationsV1ServiceServiceConversationServiceConversationMessage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConversationsV1ServiceServiceConversationServiceConversationMessage();
    ...
    /**
     * Validates the JSON data with respect to <code>ConversationsV1ServiceServiceConversationServiceConversationMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversationsV1ServiceServiceConversationServiceConversationMessage</code>.
     */
 ...
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['account_sid'] = undefined;

/**
 * A string metadata field you can use to store any data you wish. The string value must contain structurally valid JSON if specified.  **Note** that if the attributes are not set \"{}\" will be returned.
 * @member {String} attributes
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['attributes'] = undefined;

/**
 * The channel specific identifier of the message's author. Defaults to `system`.
 * @member {String} author
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['author'] = undefined;

/**
 * The content of the message, can be up to 1,600 characters long.
 * @member {String} body
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['body'] = undefined;
 ...
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['chat_service_sid'] = undefined;

/**
 * The unique ID of the multi-channel [Rich Content](https://www.twilio.com/docs/content) template.
 * @member {String} content_sid
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['content_sid'] = undefined;
 ...
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['conversation_sid'] = undefined;

/**
 * The date that this resource was created.
 * @member {Date} date_created
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['date_created'] = undefined;

/**
 * The date that this resource was last updated. `null` if the message has not been edited.
 * @member {Date} date_updated
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['date_updated'] = undefined;

/**
 * An object that contains the summary of delivery statuses for the message to non-chat participants.
 * @member {Object} delivery
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['delivery'] = undefined;

/**
 * The index of the message within the [Conversation](https://www.twilio.com/docs/conversations/api/conversation-resource).
 * @member {Number} index
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['index'] = undefined;

/**
 * Contains an absolute API resource URL to access the delivery & read receipts of this message.
 * @member {Object} links
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['links'] = undefined;

/**
 * An array of objects that describe the Message's media, if the message contains media. Each object contains these fields: `content_type` with the MIME type of the media, `filename` with the name of the media, `sid` with the SID of the Media resource, and `size` with the media object's file size in bytes. If the Message has no media, this value is `null`.
 * @member {Array.<Object>} media
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['media'] = undefined;

/**
 * The unique ID of messages's author participant. Null in case of `system` sent message.
 * @member {String} participant_sid
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['participant_sid'] = undefined;

/**
 * A 34 character string that uniquely identifies this resource.
 * @member {String} sid
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['sid'] = undefined;

/**
 * An absolute API resource URL for this message.
 * @member {String} url
 */
ConversationsV1ServiceServiceConversationServiceConversationMessage.prototype['url'] = undefined;
...
export default ConversationsV1ServiceServiceConversationServiceConversationMessage;
