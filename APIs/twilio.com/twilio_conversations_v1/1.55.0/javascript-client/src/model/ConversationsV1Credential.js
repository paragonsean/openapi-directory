...
import CredentialEnumPushType from './CredentialEnumPushType';

/**
 * The ConversationsV1Credential model module.
 * @module model/ConversationsV1Credential
 * @version 1.55.0
 */
class ConversationsV1Credential {
    /**
     * Constructs a new <code>ConversationsV1Credential</code>.
     * @alias module:model/ConversationsV1Credential
     */
    constructor() { 
        
        ConversationsV1Credential.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConversationsV1Credential</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConversationsV1Credential} obj Optional instance to populate.
     * @return {module:model/ConversationsV1Credential} The populated <code>ConversationsV1Credential</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConversationsV1Credential();
            ...
            if (data.hasOwnProperty('type')) {
                obj['type'] = CredentialEnumPushType.constructFromObject(data['type']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConversationsV1Credential</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversationsV1Credential</code>.
     */
 ...
 */
ConversationsV1Credential.prototype['account_sid'] = undefined;

/**
 * The date that this resource was created.
 * @member {Date} date_created
 */
ConversationsV1Credential.prototype['date_created'] = undefined;

/**
 * The date that this resource was last updated.
 * @member {Date} date_updated
 */
ConversationsV1Credential.prototype['date_updated'] = undefined;

/**
 * The human-readable name of this credential, limited to 64 characters. Optional.
 * @member {String} friendly_name
 */
ConversationsV1Credential.prototype['friendly_name'] = undefined;

/**
 * [APN only] Whether to send the credential to sandbox APNs. Can be `true` to send to sandbox APNs or `false` to send to production.
 * @member {String} sandbox
 */
ConversationsV1Credential.prototype['sandbox'] = undefined;

/**
 * A 34 character string that uniquely identifies this resource.
 * @member {String} sid
 */
ConversationsV1Credential.prototype['sid'] = undefined;

/**
 * @member {module:model/CredentialEnumPushType} type
 */
ConversationsV1Credential.prototype['type'] = undefined;

/**
 * An absolute API resource URL for this credential.
 * @member {String} url
 */
ConversationsV1Credential.prototype['url'] = undefined;
...
export default ConversationsV1Credential;
