...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1ServiceServiceRole();
  });
  ...
  describe('ConversationsV1ServiceServiceRole', function() {
    it('should create an instance of ConversationsV1ServiceServiceRole', function() {
      // uncomment below and update the code to test ConversationsV1ServiceServiceRole
      //var instance = new TwilioConversations.ConversationsV1ServiceServiceRole();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1ServiceServiceRole);
    });
