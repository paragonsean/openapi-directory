...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1ConversationConversationScopedWebhook();
  });
  ...
  describe('ConversationsV1ConversationConversationScopedWebhook', function() {
    it('should create an instance of ConversationsV1ConversationConversationScopedWebhook', function() {
      // uncomment below and update the code to test ConversationsV1ConversationConversationScopedWebhook
      //var instance = new TwilioConversations.ConversationsV1ConversationConversationScopedWebhook();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1ConversationConversationScopedWebhook);
    });
