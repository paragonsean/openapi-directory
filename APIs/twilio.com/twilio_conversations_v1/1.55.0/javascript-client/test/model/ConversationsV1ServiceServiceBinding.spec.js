...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1ServiceServiceBinding();
  });
  ...
  describe('ConversationsV1ServiceServiceBinding', function() {
    it('should create an instance of ConversationsV1ServiceServiceBinding', function() {
      // uncomment below and update the code to test ConversationsV1ServiceServiceBinding
      //var instance = new TwilioConversations.ConversationsV1ServiceServiceBinding();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1ServiceServiceBinding);
    });
