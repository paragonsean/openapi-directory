...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1Service();
  });
  ...
  describe('ConversationsV1Service', function() {
    it('should create an instance of ConversationsV1Service', function() {
      // uncomment below and update the code to test ConversationsV1Service
      //var instance = new TwilioConversations.ConversationsV1Service();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1Service);
    });
