...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1Credential();
  });
  ...
  describe('ConversationsV1Credential', function() {
    it('should create an instance of ConversationsV1Credential', function() {
      // uncomment below and update the code to test ConversationsV1Credential
      //var instance = new TwilioConversations.ConversationsV1Credential();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1Credential);
    });
