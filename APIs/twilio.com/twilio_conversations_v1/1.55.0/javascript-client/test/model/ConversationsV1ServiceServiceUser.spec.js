...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1ServiceServiceUser();
  });
  ...
  describe('ConversationsV1ServiceServiceUser', function() {
    it('should create an instance of ConversationsV1ServiceServiceUser', function() {
      // uncomment below and update the code to test ConversationsV1ServiceServiceUser
      //var instance = new TwilioConversations.ConversationsV1ServiceServiceUser();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1ServiceServiceUser);
    });
