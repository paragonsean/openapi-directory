...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1Conversation();
  });
  ...
  describe('ConversationsV1Conversation', function() {
    it('should create an instance of ConversationsV1Conversation', function() {
      // uncomment below and update the code to test ConversationsV1Conversation
      //var instance = new TwilioConversations.ConversationsV1Conversation();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1Conversation);
    });
