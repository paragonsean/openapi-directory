...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1ConfigurationAddress();
  });
  ...
  describe('ConversationsV1ConfigurationAddress', function() {
    it('should create an instance of ConversationsV1ConfigurationAddress', function() {
      // uncomment below and update the code to test ConversationsV1ConfigurationAddress
      //var instance = new TwilioConversations.ConversationsV1ConfigurationAddress();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1ConfigurationAddress);
    });
    ...
    it('should have the property autoCreation (base name: "auto_creation")', function() {
      // uncomment below and update the code to test the property autoCreation
      //var instance = new TwilioConversations.ConversationsV1ConfigurationAddress();
      //expect(instance).to.be();
    });
