...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1User();
  });
  ...
  describe('ConversationsV1User', function() {
    it('should create an instance of ConversationsV1User', function() {
      // uncomment below and update the code to test ConversationsV1User
      //var instance = new TwilioConversations.ConversationsV1User();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1User);
    });
