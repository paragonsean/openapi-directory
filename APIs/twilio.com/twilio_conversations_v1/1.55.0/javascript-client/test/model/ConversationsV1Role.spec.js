...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1Role();
  });
  ...
  describe('ConversationsV1Role', function() {
    it('should create an instance of ConversationsV1Role', function() {
      // uncomment below and update the code to test ConversationsV1Role
      //var instance = new TwilioConversations.ConversationsV1Role();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1Role);
    });
