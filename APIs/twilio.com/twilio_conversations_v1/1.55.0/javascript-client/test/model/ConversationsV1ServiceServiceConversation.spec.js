...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioConversations.ConversationsV1ServiceServiceConversation();
  });
  ...
  describe('ConversationsV1ServiceServiceConversation', function() {
    it('should create an instance of ConversationsV1ServiceServiceConversation', function() {
      // uncomment below and update the code to test ConversationsV1ServiceServiceConversation
      //var instance = new TwilioConversations.ConversationsV1ServiceServiceConversation();
      //expect(instance).to.be.a(TwilioConversations.ConversationsV1ServiceServiceConversation);
    });
