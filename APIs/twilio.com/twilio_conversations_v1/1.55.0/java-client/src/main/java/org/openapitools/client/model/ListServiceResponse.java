...
public class ListServiceResponse {
  ...
  public ListServiceResponse meta(ListConfigurationAddressResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public ListServiceResponse services(List<ConversationsV1Service> services) {
    this.services = services;
    return this;
  }

  public ListServiceResponse addServicesItem(ConversationsV1Service servicesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ConversationsV1Service> getServices() {
    return services;
  }

  public void setServices(List<ConversationsV1Service> services) {
    this.services = services;
  }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            ConversationsV1Service.validateJsonElement(jsonArrayservices.get(i));
          };
        }
      }
  }
