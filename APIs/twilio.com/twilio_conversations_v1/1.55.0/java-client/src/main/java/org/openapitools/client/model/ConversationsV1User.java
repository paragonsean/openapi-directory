...
public class ConversationsV1User {
  ...
  public ConversationsV1User() {
  }

  public ConversationsV1User accountSid(String accountSid) {
  ...
  public ConversationsV1User attributes(String attributes) {
  ...
  public ConversationsV1User chatServiceSid(String chatServiceSid) {
  ...
  public ConversationsV1User dateCreated(OffsetDateTime dateCreated) {
  ...
  public ConversationsV1User dateUpdated(OffsetDateTime dateUpdated) {
  ...
  public ConversationsV1User friendlyName(String friendlyName) {
  ...
  public ConversationsV1User identity(String identity) {
  ...
  public ConversationsV1User isNotifiable(Boolean isNotifiable) {
  ...
  public ConversationsV1User isOnline(Boolean isOnline) {
  ...
  public ConversationsV1User links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public ConversationsV1User roleSid(String roleSid) {
  ...
  public ConversationsV1User sid(String sid) {
    this.sid = sid;
    return this;
  }
  ...
  public ConversationsV1User url(URI url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConversationsV1User conversationsV1User = (ConversationsV1User) o;
    return Objects.equals(this.accountSid, conversationsV1User.accountSid) &&
        Objects.equals(this.attributes, conversationsV1User.attributes) &&
        Objects.equals(this.chatServiceSid, conversationsV1User.chatServiceSid) &&
        Objects.equals(this.dateCreated, conversationsV1User.dateCreated) &&
        Objects.equals(this.dateUpdated, conversationsV1User.dateUpdated) &&
        Objects.equals(this.friendlyName, conversationsV1User.friendlyName) &&
        Objects.equals(this.identity, conversationsV1User.identity) &&
        Objects.equals(this.isNotifiable, conversationsV1User.isNotifiable) &&
        Objects.equals(this.isOnline, conversationsV1User.isOnline) &&
        Objects.equals(this.links, conversationsV1User.links) &&
        Objects.equals(this.roleSid, conversationsV1User.roleSid) &&
        Objects.equals(this.sid, conversationsV1User.sid) &&
        Objects.equals(this.url, conversationsV1User.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationsV1User {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConversationsV1User
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConversationsV1User.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConversationsV1User is not found in the empty JSON string", ConversationsV1User.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConversationsV1User.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConversationsV1User` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConversationsV1User.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConversationsV1User' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConversationsV1User> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConversationsV1User.class));

       return (TypeAdapter<T>) new TypeAdapter<ConversationsV1User>() {
           @Override
           public void write(JsonWriter out, ConversationsV1User value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConversationsV1User read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConversationsV1User given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConversationsV1User
   * @throws IOException if the JSON string is invalid with respect to ConversationsV1User
   */
  public static ConversationsV1User fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConversationsV1User.class);
  }

  /**
   * Convert an instance of ConversationsV1User to an JSON string
   *
   * @return JSON string
   */
