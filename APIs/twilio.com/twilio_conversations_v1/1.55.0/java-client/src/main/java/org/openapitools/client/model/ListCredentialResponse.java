...
public class ListCredentialResponse {
  ...
  private List<ConversationsV1Credential> credentials = new ArrayList<>();
  ...
  public ListCredentialResponse credentials(List<ConversationsV1Credential> credentials) {
    this.credentials = credentials;
    return this;
  }

  public ListCredentialResponse addCredentialsItem(ConversationsV1Credential credentialsItem) {
  ...
  public List<ConversationsV1Credential> getCredentials() {
    return credentials;
  }

  public void setCredentials(List<ConversationsV1Credential> credentials) {
    this.credentials = credentials;
  }


  public ListCredentialResponse meta(ListConfigurationAddressResponseMeta meta) {
    this.meta = meta;
    return this;
  }
      ...
      if (jsonObj.get("credentials") != null && !jsonObj.get("credentials").isJsonNull()) {
        ...
        if (jsonArraycredentials != null) {
          ...
          for (int i = 0; i < jsonArraycredentials.size(); i++) {
            ConversationsV1Credential.validateJsonElement(jsonArraycredentials.get(i));
          };
        }
      }
