...
public class ConversationsV1ParticipantConversation {
  ...
  private ParticipantConversationEnumState conversationState;
  ...
  public ConversationsV1ParticipantConversation accountSid(String accountSid) {
  ...
  public ConversationsV1ParticipantConversation chatServiceSid(String chatServiceSid) {
  ...
  public ConversationsV1ParticipantConversation conversationAttributes(String conversationAttributes) {
  ...
  public ConversationsV1ParticipantConversation conversationCreatedBy(String conversationCreatedBy) {
  ...
  public ConversationsV1ParticipantConversation conversationDateCreated(OffsetDateTime conversationDateCreated) {
  ...
  public ConversationsV1ParticipantConversation conversationDateUpdated(OffsetDateTime conversationDateUpdated) {
  ...
  public ConversationsV1ParticipantConversation conversationFriendlyName(String conversationFriendlyName) {
  ...
  public ConversationsV1ParticipantConversation conversationSid(String conversationSid) {
  ...
  public ConversationsV1ParticipantConversation conversationState(ParticipantConversationEnumState conversationState) {
   ...
   */
  @javax.annotation.Nullable
  public ParticipantConversationEnumState getConversationState() {
    return conversationState;
  }

  public void setConversationState(ParticipantConversationEnumState conversationState) {
    this.conversationState = conversationState;
  }


  public ConversationsV1ParticipantConversation conversationTimers(Object conversationTimers) {
  ...
  public ConversationsV1ParticipantConversation conversationUniqueName(String conversationUniqueName) {
  ...
  public ConversationsV1ParticipantConversation links(Object links) {
    this.links = links;
    return this;
  }
  ...
  public ConversationsV1ParticipantConversation participantIdentity(String participantIdentity) {
  ...
  public ConversationsV1ParticipantConversation participantMessagingBinding(Object participantMessagingBinding) {
  ...
  public ConversationsV1ParticipantConversation participantSid(String participantSid) {
  ...
  public ConversationsV1ParticipantConversation participantUserSid(String participantUserSid) {
  ...
  public boolean equals(Object o) {
    ...
    ConversationsV1ParticipantConversation conversationsV1ParticipantConversation = (ConversationsV1ParticipantConversation) o;
    return Objects.equals(this.accountSid, conversationsV1ParticipantConversation.accountSid) &&
        Objects.equals(this.chatServiceSid, conversationsV1ParticipantConversation.chatServiceSid) &&
        Objects.equals(this.conversationAttributes, conversationsV1ParticipantConversation.conversationAttributes) &&
        Objects.equals(this.conversationCreatedBy, conversationsV1ParticipantConversation.conversationCreatedBy) &&
        Objects.equals(this.conversationDateCreated, conversationsV1ParticipantConversation.conversationDateCreated) &&
        Objects.equals(this.conversationDateUpdated, conversationsV1ParticipantConversation.conversationDateUpdated) &&
        Objects.equals(this.conversationFriendlyName, conversationsV1ParticipantConversation.conversationFriendlyName) &&
        Objects.equals(this.conversationSid, conversationsV1ParticipantConversation.conversationSid) &&
        Objects.equals(this.conversationState, conversationsV1ParticipantConversation.conversationState) &&
        Objects.equals(this.conversationTimers, conversationsV1ParticipantConversation.conversationTimers) &&
        Objects.equals(this.conversationUniqueName, conversationsV1ParticipantConversation.conversationUniqueName) &&
        Objects.equals(this.links, conversationsV1ParticipantConversation.links) &&
        Objects.equals(this.participantIdentity, conversationsV1ParticipantConversation.participantIdentity) &&
        Objects.equals(this.participantMessagingBinding, conversationsV1ParticipantConversation.participantMessagingBinding) &&
        Objects.equals(this.participantSid, conversationsV1ParticipantConversation.participantSid) &&
        Objects.equals(this.participantUserSid, conversationsV1ParticipantConversation.participantUserSid);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationsV1ParticipantConversation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConversationsV1ParticipantConversation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConversationsV1ParticipantConversation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConversationsV1ParticipantConversation is not found in the empty JSON string", ConversationsV1ParticipantConversation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConversationsV1ParticipantConversation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConversationsV1ParticipantConversation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("conversation_state") != null && !jsonObj.get("conversation_state").isJsonNull()) {
        ParticipantConversationEnumState.validateJsonElement(jsonObj.get("conversation_state"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConversationsV1ParticipantConversation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConversationsV1ParticipantConversation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConversationsV1ParticipantConversation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConversationsV1ParticipantConversation.class));

       return (TypeAdapter<T>) new TypeAdapter<ConversationsV1ParticipantConversation>() {
           @Override
           public void write(JsonWriter out, ConversationsV1ParticipantConversation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConversationsV1ParticipantConversation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConversationsV1ParticipantConversation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConversationsV1ParticipantConversation
   * @throws IOException if the JSON string is invalid with respect to ConversationsV1ParticipantConversation
   */
  public static ConversationsV1ParticipantConversation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConversationsV1ParticipantConversation.class);
  }

  /**
   * Convert an instance of ConversationsV1ParticipantConversation to an JSON string
   *
   * @return JSON string
   */
