...
public class ListUserResponse {
  ...
  public ListUserResponse meta(ListConfigurationAddressResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public ListUserResponse users(List<ConversationsV1User> users) {
    this.users = users;
    return this;
  }

  public ListUserResponse addUsersItem(ConversationsV1User usersItem) {
    if (this.users == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ConversationsV1User> getUsers() {
    return users;
  }

  public void setUsers(List<ConversationsV1User> users) {
    this.users = users;
  }
      ...
      if (jsonObj.get("users") != null && !jsonObj.get("users").isJsonNull()) {
        ...
        if (jsonArrayusers != null) {
          ...
          for (int i = 0; i < jsonArrayusers.size(); i++) {
            ConversationsV1User.validateJsonElement(jsonArrayusers.get(i));
          };
        }
      }
  }
