...
@pytest.mark.skip("application/x-www-form-urlencoded not supported by Connexion")
async def test_create_service_role(client):
    """Test case for create_service_role
    ...
    data = {
        'friendly_name': 'friendly_name_example',
        'permission': ['permission_example'],
        'type': openapi_server.ServiceRoleEnumRoleType()
        }
    response = await client.request(
        method='POST',
        path='/v1/Services/{chat_service_sid}/Roles'.format(chat_service_sid='chat_service_sid_example'),
        headers=headers,
        data=data,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_role(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/Roles/{sid}'.format(sid='sid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_service_role(client):
    """Test case for delete_service_role
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/Services/{chat_service_sid}/Roles/{sid}'.format(chat_service_sid='chat_service_sid_example', sid='sid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_fetch_service_role(client):
    """Test case for fetch_service_role
...
async def test_list_service_role(client):
    """Test case for list_service_role
...
@pytest.mark.skip("application/x-www-form-urlencoded not supported by Connexion")
async def test_update_service_role(client):
    """Test case for update_service_role
