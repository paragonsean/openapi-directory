# TwilioLookups.LookupsV1PhoneNumberApi
...
> LookupsV1PhoneNumber fetchPhoneNumber(phoneNumber, opts)
...
let apiInstance = new TwilioLookups.LookupsV1PhoneNumberApi();
let phoneNumber = "phoneNumber_example"; // String | The phone number to lookup in [E.164](https://www.twilio.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number.
let opts = {
