...
/*
 * OAITrusthub_v1_customer_profile.h
 *
 * 
 */

#ifndef OAITrusthub_v1_customer_profile_H
#define OAITrusthub_v1_customer_profile_H
...
class OAITrusthub_v1_customer_profile : public OAIObject {
public:
    OAITrusthub_v1_customer_profile();
    OAITrusthub_v1_customer_profile(QString json);
    ~OAITrusthub_v1_customer_profile() override;
    ...
    OAICustomer_profile_enum_status getStatus() const;
    void setStatus(const OAICustomer_profile_enum_status &status);
...
private:
    ...
    OAICustomer_profile_enum_status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrusthub_v1_customer_profile)

#endif // OAITrusthub_v1_customer_profile_H
