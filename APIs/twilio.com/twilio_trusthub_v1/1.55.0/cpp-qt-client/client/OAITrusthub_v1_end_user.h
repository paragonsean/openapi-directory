...
/*
 * OAITrusthub_v1_end_user.h
 *
 * 
 */

#ifndef OAITrusthub_v1_end_user_H
#define OAITrusthub_v1_end_user_H
...
class OAITrusthub_v1_end_user : public OAIObject {
public:
    OAITrusthub_v1_end_user();
    OAITrusthub_v1_end_user(QString json);
    ~OAITrusthub_v1_end_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrusthub_v1_end_user)

#endif // OAITrusthub_v1_end_user_H
