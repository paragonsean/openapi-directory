...
#ifndef OAI_OAITrusthubV1SupportingDocumentApi_H
#define OAI_OAITrusthubV1SupportingDocumentApi_H
...
#include "OAITrusthub_v1_supporting_document.h"
#include <QString>
...
class OAITrusthubV1SupportingDocumentApi : public QObject {
    Q_OBJECT

public:
    OAITrusthubV1SupportingDocumentApi(const int timeOut = 0);
    ~OAITrusthubV1SupportingDocumentApi();
...
Q_SIGNALS:
    ...
    void createSupportingDocumentSignal(OAITrusthub_v1_supporting_document summary);
    void deleteSupportingDocumentSignal();
    void fetchSupportingDocumentSignal(OAITrusthub_v1_supporting_document summary);
    void listSupportingDocumentSignal(OAIListSupportingDocumentResponse summary);
    void updateSupportingDocumentSignal(OAITrusthub_v1_supporting_document summary);


    void createSupportingDocumentSignalFull(OAIHttpRequestWorker *worker, OAITrusthub_v1_supporting_document summary);
    void deleteSupportingDocumentSignalFull(OAIHttpRequestWorker *worker);
    void fetchSupportingDocumentSignalFull(OAIHttpRequestWorker *worker, OAITrusthub_v1_supporting_document summary);
    void listSupportingDocumentSignalFull(OAIHttpRequestWorker *worker, OAIListSupportingDocumentResponse summary);
    void updateSupportingDocumentSignalFull(OAIHttpRequestWorker *worker, OAITrusthub_v1_supporting_document summary);

    Q_DECL_DEPRECATED_X("Use createSupportingDocumentSignalError() instead")
    void createSupportingDocumentSignalE(OAITrusthub_v1_supporting_document summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createSupportingDocumentSignalError(OAITrusthub_v1_supporting_document summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchSupportingDocumentSignalE(OAITrusthub_v1_supporting_document summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchSupportingDocumentSignalError(OAITrusthub_v1_supporting_document summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateSupportingDocumentSignalE(OAITrusthub_v1_supporting_document summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateSupportingDocumentSignalError(OAITrusthub_v1_supporting_document summary, QNetworkReply::NetworkError error_type, const QString &error_str);
