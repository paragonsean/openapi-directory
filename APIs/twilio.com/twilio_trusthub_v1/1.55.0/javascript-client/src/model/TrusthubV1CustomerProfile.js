...
import CustomerProfileEnumStatus from './CustomerProfileEnumStatus';

/**
 * The TrusthubV1CustomerProfile model module.
 * @module model/TrusthubV1CustomerProfile
 * @version 1.55.0
 */
class TrusthubV1CustomerProfile {
    /**
     * Constructs a new <code>TrusthubV1CustomerProfile</code>.
     * @alias module:model/TrusthubV1CustomerProfile
     */
    constructor() { 
        
        TrusthubV1CustomerProfile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TrusthubV1CustomerProfile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrusthubV1CustomerProfile} obj Optional instance to populate.
     * @return {module:model/TrusthubV1CustomerProfile} The populated <code>TrusthubV1CustomerProfile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrusthubV1CustomerProfile();
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = CustomerProfileEnumStatus.constructFromObject(data['status']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TrusthubV1CustomerProfile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrusthubV1CustomerProfile</code>.
     */
 ...
 */
TrusthubV1CustomerProfile.prototype['account_sid'] = undefined;

/**
 * The date and time in GMT when the resource was created specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_created
 */
TrusthubV1CustomerProfile.prototype['date_created'] = undefined;

/**
 * The date and time in GMT when the resource was last updated specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_updated
 */
TrusthubV1CustomerProfile.prototype['date_updated'] = undefined;

/**
 * The email address that will receive updates when the Customer-Profile resource changes status.
 * @member {String} email
 */
TrusthubV1CustomerProfile.prototype['email'] = undefined;

/**
 * The string that you assigned to describe the resource.
 * @member {String} friendly_name
 */
TrusthubV1CustomerProfile.prototype['friendly_name'] = undefined;

/**
 * The URLs of the Assigned Items of the Customer-Profile resource.
 * @member {Object} links
 */
TrusthubV1CustomerProfile.prototype['links'] = undefined;

/**
 * The unique string of a policy that is associated to the Customer-Profile resource.
 * @member {String} policy_sid
 */
TrusthubV1CustomerProfile.prototype['policy_sid'] = undefined;

/**
 * The unique string that we created to identify the Customer-Profile resource.
 * @member {String} sid
 */
TrusthubV1CustomerProfile.prototype['sid'] = undefined;

/**
 * @member {module:model/CustomerProfileEnumStatus} status
 */
TrusthubV1CustomerProfile.prototype['status'] = undefined;

/**
 * The URL we call to inform your application of status changes.
 * @member {String} status_callback
 */
TrusthubV1CustomerProfile.prototype['status_callback'] = undefined;

/**
 * The absolute URL of the Customer-Profile resource.
 * @member {String} url
 */
TrusthubV1CustomerProfile.prototype['url'] = undefined;
 ...
 */
TrusthubV1CustomerProfile.prototype['valid_until'] = undefined;
...
export default TrusthubV1CustomerProfile;
