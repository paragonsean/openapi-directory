...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTrusthub.TrusthubV1CustomerProfile();
  });
  ...
  describe('TrusthubV1CustomerProfile', function() {
    it('should create an instance of TrusthubV1CustomerProfile', function() {
      // uncomment below and update the code to test TrusthubV1CustomerProfile
      //var instance = new TwilioTrusthub.TrusthubV1CustomerProfile();
      //expect(instance).to.be.a(TwilioTrusthub.TrusthubV1CustomerProfile);
    });
