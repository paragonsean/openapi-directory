...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTrusthub.TrusthubV1EndUser();
  });
  ...
  describe('TrusthubV1EndUser', function() {
    it('should create an instance of TrusthubV1EndUser', function() {
      // uncomment below and update the code to test TrusthubV1EndUser
      //var instance = new TwilioTrusthub.TrusthubV1EndUser();
      //expect(instance).to.be.a(TwilioTrusthub.TrusthubV1EndUser);
    });
