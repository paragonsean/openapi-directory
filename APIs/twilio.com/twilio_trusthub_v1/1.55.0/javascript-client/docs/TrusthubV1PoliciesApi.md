# TwilioTrusthub.TrusthubV1PoliciesApi
...
let apiInstance = new TwilioTrusthub.TrusthubV1PoliciesApi();
let sid = "sid_example"; // String | The unique string that identifies the Policy resource.
apiInstance.fetchPolicies(sid, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ListPoliciesResponse listPolicies(opts)
