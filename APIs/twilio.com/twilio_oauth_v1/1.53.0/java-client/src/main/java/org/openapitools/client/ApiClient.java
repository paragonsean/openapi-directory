...
public class ApiClient {
    ...
    private String basePath = "https://oauth.twilio.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.53.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://oauth.twilio.com
