# TwilioAccounts.AccountsV1CredentialCredentialPublicKey

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountSid** | **String** | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Credential that the PublicKey resource belongs to. | [optional] 
...
**sid** | **String** | The unique string that that we created to identify the PublicKey resource. | [optional] 
