...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioAccounts.AccountsV1AuthTokenPromotion();
  });
  ...
  describe('AccountsV1AuthTokenPromotion', function() {
    it('should create an instance of AccountsV1AuthTokenPromotion', function() {
      // uncomment below and update the code to test AccountsV1AuthTokenPromotion
      //var instance = new TwilioAccounts.AccountsV1AuthTokenPromotion();
      //expect(instance).to.be.a(TwilioAccounts.AccountsV1AuthTokenPromotion);
    });
