...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioAccounts.AccountsV1CredentialCredentialPublicKey();
  });
  ...
  describe('AccountsV1CredentialCredentialPublicKey', function() {
    it('should create an instance of AccountsV1CredentialCredentialPublicKey', function() {
      // uncomment below and update the code to test AccountsV1CredentialCredentialPublicKey
      //var instance = new TwilioAccounts.AccountsV1CredentialCredentialPublicKey();
      //expect(instance).to.be.a(TwilioAccounts.AccountsV1CredentialCredentialPublicKey);
    });
