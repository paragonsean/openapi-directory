...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioAccounts.AccountsV1CredentialCredentialAws();
  });
  ...
  describe('AccountsV1CredentialCredentialAws', function() {
    it('should create an instance of AccountsV1CredentialCredentialAws', function() {
      // uncomment below and update the code to test AccountsV1CredentialCredentialAws
      //var instance = new TwilioAccounts.AccountsV1CredentialCredentialAws();
      //expect(instance).to.be.a(TwilioAccounts.AccountsV1CredentialCredentialAws);
    });
