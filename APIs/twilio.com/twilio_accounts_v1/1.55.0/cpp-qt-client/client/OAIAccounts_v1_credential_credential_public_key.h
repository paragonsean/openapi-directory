...
/*
 * OAIAccounts_v1_credential_credential_public_key.h
 *
 * 
 */

#ifndef OAIAccounts_v1_credential_credential_public_key_H
#define OAIAccounts_v1_credential_credential_public_key_H
...
class OAIAccounts_v1_credential_credential_public_key : public OAIObject {
public:
    OAIAccounts_v1_credential_credential_public_key();
    OAIAccounts_v1_credential_credential_public_key(QString json);
    ~OAIAccounts_v1_credential_credential_public_key() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccounts_v1_credential_credential_public_key)

#endif // OAIAccounts_v1_credential_credential_public_key_H
