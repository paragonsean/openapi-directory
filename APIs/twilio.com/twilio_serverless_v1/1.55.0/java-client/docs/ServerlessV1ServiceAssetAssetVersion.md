...
|**dateCreated** | **OffsetDateTime** | The date and time in GMT when the Asset Version resource was created specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. |  [optional] |
...
|**url** | **URI** | The absolute URL of the Asset Version resource. |  [optional] |
|**visibility** | **AssetVersionEnumVisibility** |  |  [optional] |
