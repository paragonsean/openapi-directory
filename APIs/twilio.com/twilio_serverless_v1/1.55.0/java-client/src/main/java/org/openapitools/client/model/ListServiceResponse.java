...
public class ListServiceResponse {
  ...
  private List<ServerlessV1Service> services = new ArrayList<>();
  ...
  public ListServiceResponse services(List<ServerlessV1Service> services) {
    this.services = services;
    return this;
  }

  public ListServiceResponse addServicesItem(ServerlessV1Service servicesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ServerlessV1Service> getServices() {
    return services;
  }

  public void setServices(List<ServerlessV1Service> services) {
    this.services = services;
  }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            ServerlessV1Service.validateJsonElement(jsonArrayservices.get(i));
          };
        }
      }
  }
