...
/*
 * OAIServerless_v1_service_asset.h
 *
 * 
 */

#ifndef OAIServerless_v1_service_asset_H
#define OAIServerless_v1_service_asset_H
...
class OAIServerless_v1_service_asset : public OAIObject {
public:
    OAIServerless_v1_service_asset();
    OAIServerless_v1_service_asset(QString json);
    ~OAIServerless_v1_service_asset() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerless_v1_service_asset)

#endif // OAIServerless_v1_service_asset_H
