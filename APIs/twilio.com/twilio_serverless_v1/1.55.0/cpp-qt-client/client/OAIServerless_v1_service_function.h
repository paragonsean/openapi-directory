...
/*
 * OAIServerless_v1_service_function.h
 *
 * 
 */

#ifndef OAIServerless_v1_service_function_H
#define OAIServerless_v1_service_function_H
...
class OAIServerless_v1_service_function : public OAIObject {
public:
    OAIServerless_v1_service_function();
    OAIServerless_v1_service_function(QString json);
    ~OAIServerless_v1_service_function() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerless_v1_service_function)

#endif // OAIServerless_v1_service_function_H
