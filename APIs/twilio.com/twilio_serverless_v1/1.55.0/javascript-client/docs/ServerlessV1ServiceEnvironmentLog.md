# TwilioServerless.ServerlessV1ServiceEnvironmentLog
...
**dateCreated** | **Date** | The date and time in GMT when the Log resource was created specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. | [optional] 
...
**level** | [**LogEnumLevel**](LogEnumLevel.md) |  | [optional] 
