...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioServerless.ServerlessV1ServiceAsset();
  });
  ...
  describe('ServerlessV1ServiceAsset', function() {
    it('should create an instance of ServerlessV1ServiceAsset', function() {
      // uncomment below and update the code to test ServerlessV1ServiceAsset
      //var instance = new TwilioServerless.ServerlessV1ServiceAsset();
      //expect(instance).to.be.a(TwilioServerless.ServerlessV1ServiceAsset);
    });
