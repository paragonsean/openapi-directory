...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioServerless.ServerlessV1ServiceFunction();
  });
  ...
  describe('ServerlessV1ServiceFunction', function() {
    it('should create an instance of ServerlessV1ServiceFunction', function() {
      // uncomment below and update the code to test ServerlessV1ServiceFunction
      //var instance = new TwilioServerless.ServerlessV1ServiceFunction();
      //expect(instance).to.be.a(TwilioServerless.ServerlessV1ServiceFunction);
    });
