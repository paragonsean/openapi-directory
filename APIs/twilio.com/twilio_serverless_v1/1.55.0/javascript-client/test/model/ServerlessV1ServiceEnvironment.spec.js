...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioServerless.ServerlessV1ServiceEnvironment();
  });
  ...
  describe('ServerlessV1ServiceEnvironment', function() {
    it('should create an instance of ServerlessV1ServiceEnvironment', function() {
      // uncomment below and update the code to test ServerlessV1ServiceEnvironment
      //var instance = new TwilioServerless.ServerlessV1ServiceEnvironment();
      //expect(instance).to.be.a(TwilioServerless.ServerlessV1ServiceEnvironment);
    });
    ...
    it('should have the property domainSuffix (base name: "domain_suffix")', function() {
      // uncomment below and update the code to test the property domainSuffix
      //var instance = new TwilioServerless.ServerlessV1ServiceEnvironment();
      //expect(instance).to.be();
    });
