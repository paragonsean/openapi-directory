...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioVoice.VoiceV1ConnectionPolicy();
  });
  ...
  describe('VoiceV1ConnectionPolicy', function() {
    it('should create an instance of VoiceV1ConnectionPolicy', function() {
      // uncomment below and update the code to test VoiceV1ConnectionPolicy
      //var instance = new TwilioVoice.VoiceV1ConnectionPolicy();
      //expect(instance).to.be.a(TwilioVoice.VoiceV1ConnectionPolicy);
    });
