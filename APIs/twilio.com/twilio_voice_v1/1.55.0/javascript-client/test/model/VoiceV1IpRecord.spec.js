...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioVoice.VoiceV1IpRecord();
  });
  ...
  describe('VoiceV1IpRecord', function() {
    it('should create an instance of VoiceV1IpRecord', function() {
      // uncomment below and update the code to test VoiceV1IpRecord
      //var instance = new TwilioVoice.VoiceV1IpRecord();
      //expect(instance).to.be.a(TwilioVoice.VoiceV1IpRecord);
    });
    ...
    it('should have the property cidrPrefixLength (base name: "cidr_prefix_length")', function() {
      // uncomment below and update the code to test the property cidrPrefixLength
      //var instance = new TwilioVoice.VoiceV1IpRecord();
      //expect(instance).to.be();
    });
