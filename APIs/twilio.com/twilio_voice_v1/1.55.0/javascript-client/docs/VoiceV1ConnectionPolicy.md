# TwilioVoice.VoiceV1ConnectionPolicy

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountSid** | **String** | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Connection Policy resource. | [optional] 
...
**sid** | **String** | The unique string that we created to identify the Connection Policy resource. | [optional] 
