...
/**
 * The VoiceV1ConnectionPolicy model module.
 * @module model/VoiceV1ConnectionPolicy
 * @version 1.55.0
 */
class VoiceV1ConnectionPolicy {
    /**
     * Constructs a new <code>VoiceV1ConnectionPolicy</code>.
     * @alias module:model/VoiceV1ConnectionPolicy
     */
    constructor() { 
        
        VoiceV1ConnectionPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VoiceV1ConnectionPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VoiceV1ConnectionPolicy} obj Optional instance to populate.
     * @return {module:model/VoiceV1ConnectionPolicy} The populated <code>VoiceV1ConnectionPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VoiceV1ConnectionPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>VoiceV1ConnectionPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VoiceV1ConnectionPolicy</code>.
     */
 ...
 */
VoiceV1ConnectionPolicy.prototype['account_sid'] = undefined;

/**
 * The date and time in GMT when the resource was created specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {Date} date_created
 */
VoiceV1ConnectionPolicy.prototype['date_created'] = undefined;

/**
 * The date and time in GMT when the resource was last updated specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {Date} date_updated
 */
VoiceV1ConnectionPolicy.prototype['date_updated'] = undefined;

/**
 * The string that you assigned to describe the resource.
 * @member {String} friendly_name
 */
VoiceV1ConnectionPolicy.prototype['friendly_name'] = undefined;

/**
 * The URLs of related resources.
 * @member {Object} links
 */
VoiceV1ConnectionPolicy.prototype['links'] = undefined;

/**
 * The unique string that we created to identify the Connection Policy resource.
 * @member {String} sid
 */
VoiceV1ConnectionPolicy.prototype['sid'] = undefined;

/**
 * The absolute URL of the resource.
 * @member {String} url
 */
VoiceV1ConnectionPolicy.prototype['url'] = undefined;
...
export default VoiceV1ConnectionPolicy;
