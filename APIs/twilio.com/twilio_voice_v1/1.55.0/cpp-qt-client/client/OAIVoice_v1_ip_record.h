...
/*
 * OAIVoice_v1_ip_record.h
 *
 * 
 */

#ifndef OAIVoice_v1_ip_record_H
#define OAIVoice_v1_ip_record_H
...
class OAIVoice_v1_ip_record : public OAIObject {
public:
    OAIVoice_v1_ip_record();
    OAIVoice_v1_ip_record(QString json);
    ~OAIVoice_v1_ip_record() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVoice_v1_ip_record)

#endif // OAIVoice_v1_ip_record_H
