...
|**statusCallbackMethod** | [**StatusCallbackMethodEnum**](#StatusCallbackMethodEnum) | The HTTP method we use to call &#x60;status_callback_url&#x60;. Either &#x60;GET&#x60; or &#x60;POST&#x60;. |  [optional] |
|**statusCallbackUrl** | **URI** | The URL that we call to pass status parameters (such as call ended) to your application. |  [optional] |
...
|**voiceUrl** | **URI** | The URL we call using the &#x60;voice_method&#x60; when the BYOC Trunk receives a call. |  [optional] |
