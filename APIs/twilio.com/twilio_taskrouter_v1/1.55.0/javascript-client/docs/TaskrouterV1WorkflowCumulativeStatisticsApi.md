# TwilioTaskrouter.TaskrouterV1WorkflowCumulativeStatisticsApi
...
> TaskrouterV1WorkspaceWorkflowWorkflowCumulativeStatistics fetchWorkflowCumulativeStatistics(workspaceSid, workflowSid, opts)
...
let apiInstance = new TwilioTaskrouter.TaskrouterV1WorkflowCumulativeStatisticsApi();
...
apiInstance.fetchWorkflowCumulativeStatistics(workspaceSid, workflowSid, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
