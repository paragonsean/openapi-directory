# TwilioTaskrouter.TaskrouterV1WorkspaceStatisticsApi
...
> TaskrouterV1WorkspaceWorkspaceStatistics fetchWorkspaceStatistics(workspaceSid, opts)
...
let apiInstance = new TwilioTaskrouter.TaskrouterV1WorkspaceStatisticsApi();
...
apiInstance.fetchWorkspaceStatistics(workspaceSid, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
