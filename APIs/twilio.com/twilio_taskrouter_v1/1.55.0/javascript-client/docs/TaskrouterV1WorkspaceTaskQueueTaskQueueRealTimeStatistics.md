# TwilioTaskrouter.TaskrouterV1WorkspaceTaskQueueTaskQueueRealTimeStatistics
...
**activityStatistics** | **[Object]** | The number of current Workers by Activity. | [optional] 
**longestRelativeTaskAgeInQueue** | **Number** | The relative age in the TaskQueue for the longest waiting Task. Calculation is based on the time when the Task entered the TaskQueue. | [optional] 
...
**longestTaskWaitingAge** | **Number** | The age of the longest waiting Task. | [optional] 
...
**totalAvailableWorkers** | **Number** | The total number of Workers available for Tasks in the TaskQueue. | [optional] 
**totalEligibleWorkers** | **Number** | The total number of Workers eligible for Tasks in the TaskQueue, independent of their Activity state. | [optional] 
**totalTasks** | **Number** | The total number of Tasks. | [optional] 
