# TwilioTaskrouter.TaskrouterV1WorkspaceCumulativeStatisticsApi
...
> TaskrouterV1WorkspaceWorkspaceCumulativeStatistics fetchWorkspaceCumulativeStatistics(workspaceSid, opts)
...
let apiInstance = new TwilioTaskrouter.TaskrouterV1WorkspaceCumulativeStatisticsApi();
...
apiInstance.fetchWorkspaceCumulativeStatistics(workspaceSid, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
