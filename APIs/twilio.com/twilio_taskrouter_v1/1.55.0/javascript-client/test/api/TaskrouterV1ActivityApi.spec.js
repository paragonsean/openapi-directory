...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTaskrouter.TaskrouterV1ActivityApi();
  });
  ...
  describe('TaskrouterV1ActivityApi', function() {
    ...
    describe('fetchActivity', function() {
      it('should call fetchActivity successfully', function(done) {
        //uncomment below and update the code to test fetchActivity
        //instance.fetchActivity(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listActivity', function() {
      it('should call listActivity successfully', function(done) {
        //uncomment below and update the code to test listActivity
        //instance.listActivity(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
