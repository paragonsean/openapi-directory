...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTaskrouter.TaskrouterV1WorkspaceTaskChannel();
  });
  ...
  describe('TaskrouterV1WorkspaceTaskChannel', function() {
    it('should create an instance of TaskrouterV1WorkspaceTaskChannel', function() {
      // uncomment below and update the code to test TaskrouterV1WorkspaceTaskChannel
      //var instance = new TwilioTaskrouter.TaskrouterV1WorkspaceTaskChannel();
      //expect(instance).to.be.a(TwilioTaskrouter.TaskrouterV1WorkspaceTaskChannel);
    });
    ...
    it('should have the property channelOptimizedRouting (base name: "channel_optimized_routing")', function() {
      // uncomment below and update the code to test the property channelOptimizedRouting
      //var instance = new TwilioTaskrouter.TaskrouterV1WorkspaceTaskChannel();
      //expect(instance).to.be();
    });
