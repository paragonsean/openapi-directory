...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTaskrouter.TaskrouterV1WorkspaceWorker();
  });
  ...
  describe('TaskrouterV1WorkspaceWorker', function() {
    it('should create an instance of TaskrouterV1WorkspaceWorker', function() {
      // uncomment below and update the code to test TaskrouterV1WorkspaceWorker
      //var instance = new TwilioTaskrouter.TaskrouterV1WorkspaceWorker();
      //expect(instance).to.be.a(TwilioTaskrouter.TaskrouterV1WorkspaceWorker);
    });
    ...
    it('should have the property activitySid (base name: "activity_sid")', function() {
      // uncomment below and update the code to test the property activitySid
      //var instance = new TwilioTaskrouter.TaskrouterV1WorkspaceWorker();
      //expect(instance).to.be();
    });
    ...
    it('should have the property dateStatusChanged (base name: "date_status_changed")', function() {
      // uncomment below and update the code to test the property dateStatusChanged
      //var instance = new TwilioTaskrouter.TaskrouterV1WorkspaceWorker();
      //expect(instance).to.be();
    });
