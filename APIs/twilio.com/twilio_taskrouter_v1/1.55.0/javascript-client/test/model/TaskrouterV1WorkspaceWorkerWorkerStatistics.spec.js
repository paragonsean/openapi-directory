...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTaskrouter.TaskrouterV1WorkspaceWorkerWorkerStatistics();
  });
  ...
  describe('TaskrouterV1WorkspaceWorkerWorkerStatistics', function() {
    it('should create an instance of TaskrouterV1WorkspaceWorkerWorkerStatistics', function() {
      // uncomment below and update the code to test TaskrouterV1WorkspaceWorkerWorkerStatistics
      //var instance = new TwilioTaskrouter.TaskrouterV1WorkspaceWorkerWorkerStatistics();
      //expect(instance).to.be.a(TwilioTaskrouter.TaskrouterV1WorkspaceWorkerWorkerStatistics);
    });
