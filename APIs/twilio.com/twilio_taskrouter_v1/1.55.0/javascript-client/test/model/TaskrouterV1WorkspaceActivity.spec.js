...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTaskrouter.TaskrouterV1WorkspaceActivity();
  });
  ...
  describe('TaskrouterV1WorkspaceActivity', function() {
    it('should create an instance of TaskrouterV1WorkspaceActivity', function() {
      // uncomment below and update the code to test TaskrouterV1WorkspaceActivity
      //var instance = new TwilioTaskrouter.TaskrouterV1WorkspaceActivity();
      //expect(instance).to.be.a(TwilioTaskrouter.TaskrouterV1WorkspaceActivity);
    });
