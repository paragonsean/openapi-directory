...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTaskrouter.TaskrouterV1WorkspaceWorkflowWorkflowStatistics();
  });
  ...
  describe('TaskrouterV1WorkspaceWorkflowWorkflowStatistics', function() {
    it('should create an instance of TaskrouterV1WorkspaceWorkflowWorkflowStatistics', function() {
      // uncomment below and update the code to test TaskrouterV1WorkspaceWorkflowWorkflowStatistics
      //var instance = new TwilioTaskrouter.TaskrouterV1WorkspaceWorkflowWorkflowStatistics();
      //expect(instance).to.be.a(TwilioTaskrouter.TaskrouterV1WorkspaceWorkflowWorkflowStatistics);
    });
