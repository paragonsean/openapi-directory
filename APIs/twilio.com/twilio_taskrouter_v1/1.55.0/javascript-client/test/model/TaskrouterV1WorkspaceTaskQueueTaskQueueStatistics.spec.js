...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTaskrouter.TaskrouterV1WorkspaceTaskQueueTaskQueueStatistics();
  });
  ...
  describe('TaskrouterV1WorkspaceTaskQueueTaskQueueStatistics', function() {
    it('should create an instance of TaskrouterV1WorkspaceTaskQueueTaskQueueStatistics', function() {
      // uncomment below and update the code to test TaskrouterV1WorkspaceTaskQueueTaskQueueStatistics
      //var instance = new TwilioTaskrouter.TaskrouterV1WorkspaceTaskQueueTaskQueueStatistics();
      //expect(instance).to.be.a(TwilioTaskrouter.TaskrouterV1WorkspaceTaskQueueTaskQueueStatistics);
    });
