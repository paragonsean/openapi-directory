...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTaskrouter.TaskrouterV1WorkspaceWorkspaceStatistics();
  });
  ...
  describe('TaskrouterV1WorkspaceWorkspaceStatistics', function() {
    it('should create an instance of TaskrouterV1WorkspaceWorkspaceStatistics', function() {
      // uncomment below and update the code to test TaskrouterV1WorkspaceWorkspaceStatistics
      //var instance = new TwilioTaskrouter.TaskrouterV1WorkspaceWorkspaceStatistics();
      //expect(instance).to.be.a(TwilioTaskrouter.TaskrouterV1WorkspaceWorkspaceStatistics);
    });
