...
|**dateStatusChanged** | **OffsetDateTime** | The date and time in GMT of the last change to the Worker&#39;s activity specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. Used to calculate Workflow statistics. |  [optional] |
...
|**url** | **URI** | The absolute URL of the Worker resource. |  [optional] |
