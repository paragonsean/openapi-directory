...
<a id="fetchWorkspaceRealTimeStatistics"></a>
# **fetchWorkspaceRealTimeStatistics**
> TaskrouterV1WorkspaceWorkspaceRealTimeStatistics fetchWorkspaceRealTimeStatistics(workspaceSid, taskChannel)
...
import org.openapitools.client.api.TaskrouterV1WorkspaceRealTimeStatisticsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TaskrouterV1WorkspaceRealTimeStatisticsApi apiInstance = new TaskrouterV1WorkspaceRealTimeStatisticsApi(defaultClient);
    ...
    try {
      TaskrouterV1WorkspaceWorkspaceRealTimeStatistics result = apiInstance.fetchWorkspaceRealTimeStatistics(workspaceSid, taskChannel);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TaskrouterV1WorkspaceRealTimeStatisticsApi#fetchWorkspaceRealTimeStatistics");
