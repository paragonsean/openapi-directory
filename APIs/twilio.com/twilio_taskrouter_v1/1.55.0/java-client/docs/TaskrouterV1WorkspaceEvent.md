...
|**actorUrl** | **URI** | The absolute URL of the resource that triggered the event. |  [optional] |
...
|**eventDate** | **OffsetDateTime** | The time the event was sent, specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. |  [optional] |
|**eventDateMs** | **Long** | The time the event was sent in milliseconds. |  [optional] |
...
|**resourceUrl** | **URI** | The URL of the resource the event is most relevant to. |  [optional] |
...
|**url** | **URI** | The absolute URL of the Event resource. |  [optional] |
