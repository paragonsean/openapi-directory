...
async def test_fetch_task_queue_statistics(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/Workspaces/{workspace_sid}/TaskQueues/{task_queue_sid}/Statistics'.format(workspace_sid='workspace_sid_example', task_queue_sid='task_queue_sid_example'),
        headers=headers,
        params=params,
        )
