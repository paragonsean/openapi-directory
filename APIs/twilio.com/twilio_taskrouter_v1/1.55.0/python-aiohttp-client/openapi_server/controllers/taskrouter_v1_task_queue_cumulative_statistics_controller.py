...
async def fetch_task_queue_cumulative_statistics(request: web.Request, workspace_sid, task_queue_sid, end_date=None, minutes=None, start_date=None, task_channel=None, split_by_wait_time=None) -> web.Response:
