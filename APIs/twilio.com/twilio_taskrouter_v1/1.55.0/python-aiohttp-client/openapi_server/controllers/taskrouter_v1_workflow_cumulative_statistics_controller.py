...
async def fetch_workflow_cumulative_statistics(request: web.Request, workspace_sid, workflow_sid, end_date=None, minutes=None, start_date=None, task_channel=None, split_by_wait_time=None) -> web.Response:
