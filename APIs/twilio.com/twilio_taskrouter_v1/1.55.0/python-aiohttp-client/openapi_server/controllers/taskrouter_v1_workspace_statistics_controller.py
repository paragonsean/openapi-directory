...
async def fetch_workspace_statistics(request: web.Request, workspace_sid, minutes=None, start_date=None, end_date=None, task_channel=None, split_by_wait_time=None) -> web.Response:
