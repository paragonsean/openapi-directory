...
class ListEventResponse(Model):
    ...
    def __init__(self, events: List[TaskrouterV1WorkspaceEvent]=None, meta: ListWorkspaceResponseMeta=None):
        ...
        """
        self.openapi_types = {
            'events': List[TaskrouterV1WorkspaceEvent],
    ...
    def events(self):
        ...
        :rtype: List[TaskrouterV1WorkspaceEvent]
        """
        return self._events
    ...
    def events(self, events):
        ...
        :param events: The events of this ListEventResponse.
        :type events: List[TaskrouterV1WorkspaceEvent]
        """
