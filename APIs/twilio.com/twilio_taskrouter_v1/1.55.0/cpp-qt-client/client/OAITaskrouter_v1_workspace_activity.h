...
/*
 * OAITaskrouter_v1_workspace_activity.h
 *
 * 
 */

#ifndef OAITaskrouter_v1_workspace_activity_H
#define OAITaskrouter_v1_workspace_activity_H
...
class OAITaskrouter_v1_workspace_activity : public OAIObject {
public:
    OAITaskrouter_v1_workspace_activity();
    OAITaskrouter_v1_workspace_activity(QString json);
    ~OAITaskrouter_v1_workspace_activity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskrouter_v1_workspace_activity)

#endif // OAITaskrouter_v1_workspace_activity_H
