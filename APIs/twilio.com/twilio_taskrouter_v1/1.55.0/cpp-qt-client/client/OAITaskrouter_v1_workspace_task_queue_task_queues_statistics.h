...
/*
 * OAITaskrouter_v1_workspace_task_queue_task_queues_statistics.h
 *
 * 
 */

#ifndef OAITaskrouter_v1_workspace_task_queue_task_queues_statistics_H
#define OAITaskrouter_v1_workspace_task_queue_task_queues_statistics_H
...
class OAITaskrouter_v1_workspace_task_queue_task_queues_statistics : public OAIObject {
public:
    OAITaskrouter_v1_workspace_task_queue_task_queues_statistics();
    OAITaskrouter_v1_workspace_task_queue_task_queues_statistics(QString json);
    ~OAITaskrouter_v1_workspace_task_queue_task_queues_statistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskrouter_v1_workspace_task_queue_task_queues_statistics)

#endif // OAITaskrouter_v1_workspace_task_queue_task_queues_statistics_H
