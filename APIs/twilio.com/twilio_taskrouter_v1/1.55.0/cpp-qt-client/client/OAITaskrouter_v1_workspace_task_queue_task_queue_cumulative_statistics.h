...
/*
 * OAITaskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics.h
 *
 * 
 */

#ifndef OAITaskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics_H
#define OAITaskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics_H
...
class OAITaskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics : public OAIObject {
public:
    OAITaskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics();
    OAITaskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics(QString json);
    ~OAITaskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics() override;
    ...
    qint32 getTasksEntered() const;
    void setTasksEntered(const qint32 &tasks_entered);
    bool is_tasks_entered_Set() const;
    bool is_tasks_entered_Valid() const;
    ...
    QJsonValue getWaitDurationInQueueUntilAccepted() const;
    void setWaitDurationInQueueUntilAccepted(const QJsonValue &wait_duration_in_queue_until_accepted);
    bool is_wait_duration_in_queue_until_accepted_Set() const;
    bool is_wait_duration_in_queue_until_accepted_Valid() const;
...
private:
    ...
    qint32 m_tasks_entered;
    bool m_tasks_entered_isSet;
    bool m_tasks_entered_isValid;
    ...
    QJsonValue m_wait_duration_in_queue_until_accepted;
    bool m_wait_duration_in_queue_until_accepted_isSet;
    bool m_wait_duration_in_queue_until_accepted_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics)

#endif // OAITaskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics_H
