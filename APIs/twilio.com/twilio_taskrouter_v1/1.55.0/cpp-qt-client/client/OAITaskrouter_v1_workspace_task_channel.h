...
/*
 * OAITaskrouter_v1_workspace_task_channel.h
 *
 * 
 */

#ifndef OAITaskrouter_v1_workspace_task_channel_H
#define OAITaskrouter_v1_workspace_task_channel_H
...
class OAITaskrouter_v1_workspace_task_channel : public OAIObject {
public:
    OAITaskrouter_v1_workspace_task_channel();
    OAITaskrouter_v1_workspace_task_channel(QString json);
    ~OAITaskrouter_v1_workspace_task_channel() override;
    ...
    bool isChannelOptimizedRouting() const;
    void setChannelOptimizedRouting(const bool &channel_optimized_routing);
    bool is_channel_optimized_routing_Set() const;
    bool is_channel_optimized_routing_Valid() const;
...
private:
    ...
    bool m_channel_optimized_routing;
    bool m_channel_optimized_routing_isSet;
    bool m_channel_optimized_routing_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskrouter_v1_workspace_task_channel)

#endif // OAITaskrouter_v1_workspace_task_channel_H
