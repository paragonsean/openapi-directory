...
/*
 * OAITaskrouter_v1_workspace_workflow_workflow_statistics.h
 *
 * 
 */

#ifndef OAITaskrouter_v1_workspace_workflow_workflow_statistics_H
#define OAITaskrouter_v1_workspace_workflow_workflow_statistics_H
...
class OAITaskrouter_v1_workspace_workflow_workflow_statistics : public OAIObject {
public:
    OAITaskrouter_v1_workspace_workflow_workflow_statistics();
    OAITaskrouter_v1_workspace_workflow_workflow_statistics(QString json);
    ~OAITaskrouter_v1_workspace_workflow_workflow_statistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskrouter_v1_workspace_workflow_workflow_statistics)

#endif // OAITaskrouter_v1_workspace_workflow_workflow_statistics_H
