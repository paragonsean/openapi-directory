...
/*
 * OAITaskrouter_v1_workspace_worker_worker_statistics.h
 *
 * 
 */

#ifndef OAITaskrouter_v1_workspace_worker_worker_statistics_H
#define OAITaskrouter_v1_workspace_worker_worker_statistics_H
...
class OAITaskrouter_v1_workspace_worker_worker_statistics : public OAIObject {
public:
    OAITaskrouter_v1_workspace_worker_worker_statistics();
    OAITaskrouter_v1_workspace_worker_worker_statistics(QString json);
    ~OAITaskrouter_v1_workspace_worker_worker_statistics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskrouter_v1_workspace_worker_worker_statistics)

#endif // OAITaskrouter_v1_workspace_worker_worker_statistics_H
