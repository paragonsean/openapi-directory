...
public class ApiClient {
    ...
    private String basePath = "https://intelligence.twilio.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://intelligence.twilio.com",
    ...
    public ApiClient() {
        ...
        authentications.put("accountSid_authToken", new HttpBasicAuth());
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.55.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://intelligence.twilio.com
