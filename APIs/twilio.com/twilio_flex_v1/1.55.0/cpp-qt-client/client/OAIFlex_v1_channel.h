...
/*
 * OAIFlex_v1_channel.h
 *
 * 
 */

#ifndef OAIFlex_v1_channel_H
#define OAIFlex_v1_channel_H
...
class OAIFlex_v1_channel : public OAIObject {
public:
    OAIFlex_v1_channel();
    OAIFlex_v1_channel(QString json);
    ~OAIFlex_v1_channel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlex_v1_channel)

#endif // OAIFlex_v1_channel_H
