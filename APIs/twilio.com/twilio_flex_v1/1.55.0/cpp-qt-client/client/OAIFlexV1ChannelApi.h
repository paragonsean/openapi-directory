...
#ifndef OAI_OAIFlexV1ChannelApi_H
#define OAI_OAIFlexV1ChannelApi_H
...
class OAIFlexV1ChannelApi : public QObject {
    Q_OBJECT

public:
    OAIFlexV1ChannelApi(const int timeOut = 0);
    ~OAIFlexV1ChannelApi();
    ...
    * @param[in]  chat_user_friendly_name QString [required]
    ...
    * @param[in]  task_attributes QString [optional]
    * @param[in]  task_sid QString [optional]
    */
    virtual void createChannel(const QString &chat_friendly_name, const QString &chat_user_friendly_name, const QString &flex_flow_sid, const QString &identity, const ::OpenAPI::OptionalParam<QString> &chat_unique_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &long_lived = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &pre_engagement_data = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &target = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &task_attributes = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &task_sid = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  sid QString [required]
    */
    virtual void deleteChannel(const QString &sid);

    /**
    * @param[in]  sid QString [required]
    */
    virtual void fetchChannel(const QString &sid);
    ...
    */
    virtual void listChannel(const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &page_token = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void createChannelSignal(OAIFlex_v1_channel summary);
    void deleteChannelSignal();
    void fetchChannelSignal(OAIFlex_v1_channel summary);
    void listChannelSignal(OAIListChannelResponse summary);


    void createChannelSignalFull(OAIHttpRequestWorker *worker, OAIFlex_v1_channel summary);
    void deleteChannelSignalFull(OAIHttpRequestWorker *worker);
    void fetchChannelSignalFull(OAIHttpRequestWorker *worker, OAIFlex_v1_channel summary);
    ...
    void createChannelSignalE(OAIFlex_v1_channel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createChannelSignalError(OAIFlex_v1_channel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchChannelSignalE(OAIFlex_v1_channel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchChannelSignalError(OAIFlex_v1_channel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
