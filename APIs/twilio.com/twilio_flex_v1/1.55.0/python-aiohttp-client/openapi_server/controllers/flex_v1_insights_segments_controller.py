...
async def list_insights_segments(request: web.Request, authorization=None, segment_id=None, reservation_id=None, page_size=None, page=None, page_token=None) -> web.Response:
    """list_insights_segments
