...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioFlex.FlexV1WebChannel();
  });
  ...
  describe('FlexV1WebChannel', function() {
    it('should create an instance of FlexV1WebChannel', function() {
      // uncomment below and update the code to test FlexV1WebChannel
      //var instance = new TwilioFlex.FlexV1WebChannel();
      //expect(instance).to.be.a(TwilioFlex.FlexV1WebChannel);
    });
