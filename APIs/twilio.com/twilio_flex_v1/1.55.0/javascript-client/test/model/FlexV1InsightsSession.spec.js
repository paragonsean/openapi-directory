...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioFlex.FlexV1InsightsSession();
  });
  ...
  describe('FlexV1InsightsSession', function() {
    it('should create an instance of FlexV1InsightsSession', function() {
      // uncomment below and update the code to test FlexV1InsightsSession
      //var instance = new TwilioFlex.FlexV1InsightsSession();
      //expect(instance).to.be.a(TwilioFlex.FlexV1InsightsSession);
    });
