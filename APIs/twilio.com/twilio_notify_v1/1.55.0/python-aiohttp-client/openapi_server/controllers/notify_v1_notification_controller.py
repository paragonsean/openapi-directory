...
async def create_notification(request: web.Request, service_sid, action=None, alexa=None, apn=None, body=None, data=None, delivery_callback_url=None, facebook_messenger=None, fcm=None, gcm=None, identity=None, priority=None, segment=None, sms=None, sound=None, tag=None, title=None, to_binding=None, ttl=None) -> web.Response:
    """create_notification
    ...
    """
    alexa = object.from_dict(alexa)
    apn = object.from_dict(apn)
    data = object.from_dict(data)
    facebook_messenger = object.from_dict(facebook_messenger)
    fcm = object.from_dict(fcm)
    gcm = object.from_dict(gcm)
    sms = object.from_dict(sms)
