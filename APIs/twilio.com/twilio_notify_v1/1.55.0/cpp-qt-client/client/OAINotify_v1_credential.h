...
/*
 * OAINotify_v1_credential.h
 *
 * 
 */

#ifndef OAINotify_v1_credential_H
#define OAINotify_v1_credential_H
...
class OAINotify_v1_credential : public OAIObject {
public:
    OAINotify_v1_credential();
    OAINotify_v1_credential(QString json);
    ~OAINotify_v1_credential() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotify_v1_credential)

#endif // OAINotify_v1_credential_H
