...
/**
 * API tests for NotifyV1CredentialApi
 */
@Disabled
public class NotifyV1CredentialApiTest {

    private final NotifyV1CredentialApi api = new NotifyV1CredentialApi();
    ...
    public void createCredentialTest() throws ApiException {
        ...
        String secret = null;
        NotifyV1Credential response = api.createCredential(type, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
    ...
    public void fetchCredentialTest() throws ApiException {
        String sid = null;
        NotifyV1Credential response = api.fetchCredential(sid);
        // TODO: test validations
    }
    ...
    public void updateCredentialTest() throws ApiException {
        ...
        Boolean sandbox = null;
        String secret = null;
        NotifyV1Credential response = api.updateCredential(sid, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
        // TODO: test validations
    }
