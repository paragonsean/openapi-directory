...
public class ListServiceResponse {
  ...
  private List<NotifyV1Service> services = new ArrayList<>();
  ...
  public ListServiceResponse services(List<NotifyV1Service> services) {
   ...
   */
  @javax.annotation.Nullable
  public List<NotifyV1Service> getServices() {
    return services;
  }

  public void setServices(List<NotifyV1Service> services) {
    this.services = services;
  }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            NotifyV1Service.validateJsonElement(jsonArrayservices.get(i));
          };
        }
      }
  }
