...
public class ListCredentialResponse {
  ...
  private List<NotifyV1Credential> credentials = new ArrayList<>();
  ...
  public ListCredentialResponse credentials(List<NotifyV1Credential> credentials) {
  ...
  public List<NotifyV1Credential> getCredentials() {
    return credentials;
  }

  public void setCredentials(List<NotifyV1Credential> credentials) {
    this.credentials = credentials;
  }
      ...
      if (jsonObj.get("credentials") != null && !jsonObj.get("credentials").isJsonNull()) {
        ...
        if (jsonArraycredentials != null) {
          ...
          for (int i = 0; i < jsonArraycredentials.size(); i++) {
            NotifyV1Credential.validateJsonElement(jsonArraycredentials.get(i));
          };
        }
      }
