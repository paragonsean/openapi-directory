...
/**
 * The NotifyV1Credential model module.
 * @module model/NotifyV1Credential
 * @version 1.55.0
 */
class NotifyV1Credential {
    /**
     * Constructs a new <code>NotifyV1Credential</code>.
     * @alias module:model/NotifyV1Credential
     */
    constructor() { 
        
        NotifyV1Credential.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NotifyV1Credential</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotifyV1Credential} obj Optional instance to populate.
     * @return {module:model/NotifyV1Credential} The populated <code>NotifyV1Credential</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotifyV1Credential();
    ...
    /**
     * Validates the JSON data with respect to <code>NotifyV1Credential</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotifyV1Credential</code>.
     */
 ...
 */
NotifyV1Credential.prototype['account_sid'] = undefined;

/**
 * The date and time in GMT when the resource was created specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {Date} date_created
 */
NotifyV1Credential.prototype['date_created'] = undefined;

/**
 * The date and time in GMT when the resource was last updated specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {Date} date_updated
 */
NotifyV1Credential.prototype['date_updated'] = undefined;

/**
 * The string that you assigned to describe the resource.
 * @member {String} friendly_name
 */
NotifyV1Credential.prototype['friendly_name'] = undefined;

/**
 * [APN only] Whether to send the credential to sandbox APNs. Can be `true` to send to sandbox APNs or `false` to send to production.
 * @member {String} sandbox
 */
NotifyV1Credential.prototype['sandbox'] = undefined;

/**
 * The unique string that we created to identify the Credential resource.
 * @member {String} sid
 */
NotifyV1Credential.prototype['sid'] = undefined;

/**
 * @member {module:model/CredentialEnumPushService} type
 */
NotifyV1Credential.prototype['type'] = undefined;

/**
 * The absolute URL of the Credential resource.
 * @member {String} url
 */
NotifyV1Credential.prototype['url'] = undefined;
...
export default NotifyV1Credential;
