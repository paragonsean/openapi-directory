...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioNotify.NotifyV1Credential();
  });
  ...
  describe('NotifyV1Credential', function() {
    it('should create an instance of NotifyV1Credential', function() {
      // uncomment below and update the code to test NotifyV1Credential
      //var instance = new TwilioNotify.NotifyV1Credential();
      //expect(instance).to.be.a(TwilioNotify.NotifyV1Credential);
    });
