...
/**
* StudioV2Execution service.
* @module api/StudioV2ExecutionApi
* @version 1.55.0
*/
export default class StudioV2ExecutionApi {

    /**
    * Constructs a new StudioV2ExecutionApi. 
    * @alias module:api/StudioV2ExecutionApi
    * @class
    ...
    */
     ...
     * @callback module:api/StudioV2ExecutionApi~createExecutionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StudioV2FlowExecution} data The data returned by the service call.
     ...
     * @param {module:api/StudioV2ExecutionApi~createExecutionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StudioV2FlowExecution}
     */
    createExecution(flowSid, from, to, opts, callback) {
      ...
      let returnType = StudioV2FlowExecution;
      ...
      return this.apiClient.callApi(
        '/v2/Flows/{FlowSid}/Executions', 'POST',
     ...
     * @callback module:api/StudioV2ExecutionApi~deleteExecutionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/StudioV2ExecutionApi~deleteExecutionCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteExecution(flowSid, sid, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/Flows/{FlowSid}/Executions/{Sid}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath, callback
      );
    }
     ...
     * @callback module:api/StudioV2ExecutionApi~fetchExecutionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StudioV2FlowExecution} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/StudioV2ExecutionApi~fetchExecutionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StudioV2FlowExecution}
     */
    fetchExecution(flowSid, sid, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/Flows/{FlowSid}/Executions/{Sid}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath, callback
      );
    }
     ...
     * @callback module:api/StudioV2ExecutionApi~listExecutionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/StudioV2ExecutionApi~listExecutionCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    listExecution(flowSid, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/Flows/{FlowSid}/Executions', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath, callback
      );
    }
     ...
     * @callback module:api/StudioV2ExecutionApi~updateExecutionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StudioV2FlowExecution} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/StudioV2ExecutionApi~updateExecutionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StudioV2FlowExecution}
     */
    updateExecution(flowSid, sid, status, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/Flows/{FlowSid}/Executions/{Sid}', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath, callback
      );
    }
