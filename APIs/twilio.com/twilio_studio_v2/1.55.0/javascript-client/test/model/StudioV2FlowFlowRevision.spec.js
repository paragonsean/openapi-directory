...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioStudio.StudioV2FlowFlowRevision();
  });
  ...
  describe('StudioV2FlowFlowRevision', function() {
    it('should create an instance of StudioV2FlowFlowRevision', function() {
      // uncomment below and update the code to test StudioV2FlowFlowRevision
      //var instance = new TwilioStudio.StudioV2FlowFlowRevision();
      //expect(instance).to.be.a(TwilioStudio.StudioV2FlowFlowRevision);
    });
