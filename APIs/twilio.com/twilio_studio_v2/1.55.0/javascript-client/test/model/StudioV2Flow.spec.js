...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioStudio.StudioV2Flow();
  });
  ...
  describe('StudioV2Flow', function() {
    it('should create an instance of StudioV2Flow', function() {
      // uncomment below and update the code to test StudioV2Flow
      //var instance = new TwilioStudio.StudioV2Flow();
      //expect(instance).to.be.a(TwilioStudio.StudioV2Flow);
    });
