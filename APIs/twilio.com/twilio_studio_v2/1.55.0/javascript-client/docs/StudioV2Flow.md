...
**links** | **Object** | The URLs of the Flow&#39;s nested resources. | [optional] 
...
**status** | [**FlowEnumStatus**](FlowEnumStatus.md) |  | [optional] 
**url** | **String** | The absolute URL of the resource. | [optional] 
**valid** | **Boolean** | Boolean if the flow definition is valid. | [optional] 
**warnings** | **[Object]** | List of warnings in the flow definition. | [optional] 
