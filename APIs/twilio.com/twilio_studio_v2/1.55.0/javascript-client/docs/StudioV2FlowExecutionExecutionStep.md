# TwilioStudio.StudioV2FlowExecutionExecutionStep

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountSid** | **String** | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the ExecutionStep resource. | [optional] 
...
**executionSid** | **String** | The SID of the Step&#39;s Execution resource. | [optional] 
...
**sid** | **String** | The unique string that we created to identify the ExecutionStep resource. | [optional] 
