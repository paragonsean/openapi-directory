...
public class StudioV2ExecutionApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public StudioV2ExecutionApi() {
        this(Configuration.getDefaultApiClient());
    }

    public StudioV2ExecutionApi(ApiClient apiClient) {
    ...
    public okhttp3.Call createExecutionCall(String flowSid, String from, String to, Object parameters, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2/Flows/{FlowSid}/Executions"
     ...
     */
    public StudioV2FlowExecution createExecution(String flowSid, String from, String to, Object parameters) throws ApiException {
        ApiResponse<StudioV2FlowExecution> localVarResp = createExecutionWithHttpInfo(flowSid, from, to, parameters);
     ...
     * @param to The Contact phone number to start a Studio Flow Execution, available as variable &#x60;{{contact.channel.address}}&#x60;. (required)
     * @param parameters JSON data that will be added to the Flow&#39;s context and that can be accessed as variables inside your Flow. For example, if you pass in &#x60;Parameters&#x3D;{\\\&quot;name\\\&quot;:\\\&quot;Zeke\\\&quot;}&#x60;, a widget in your Flow can reference the variable &#x60;{{flow.data.name}}&#x60;, which returns \\\&quot;Zeke\\\&quot;. Note: the JSON value must explicitly be passed as a string, not as a hash object. Depending on your particular HTTP library, you may need to add quotes or URL encode the JSON string. (optional)
     * @return ApiResponse&lt;StudioV2FlowExecution&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<StudioV2FlowExecution> createExecutionWithHttpInfo(String flowSid, String from, String to, Object parameters) throws ApiException {
        okhttp3.Call localVarCall = createExecutionValidateBeforeCall(flowSid, from, to, parameters, null);
        Type localVarReturnType = new TypeToken<StudioV2FlowExecution>(){}.getType();
     ...
     */
    public okhttp3.Call createExecutionAsync(String flowSid, String from, String to, Object parameters, final ApiCallback<StudioV2FlowExecution> _callback) throws ApiException {
    ...
    public okhttp3.Call deleteExecutionCall(String flowSid, String sid, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/Flows/{FlowSid}/Executions/{Sid}"
            .replace("{" + "FlowSid" + "}", localVarApiClient.escapeString(flowSid.toString()))
     ...
     */
    public StudioV2FlowExecution fetchExecution(String flowSid, String sid) throws ApiException {
        ApiResponse<StudioV2FlowExecution> localVarResp = fetchExecutionWithHttpInfo(flowSid, sid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<StudioV2FlowExecution> fetchExecutionWithHttpInfo(String flowSid, String sid) throws ApiException {
     ...
     */
    public okhttp3.Call fetchExecutionAsync(String flowSid, String sid, final ApiCallback<StudioV2FlowExecution> _callback) throws ApiException {
     ...
     */
    public StudioV2FlowExecution updateExecution(String flowSid, String sid, ExecutionEnumStatus status) throws ApiException {
        ApiResponse<StudioV2FlowExecution> localVarResp = updateExecutionWithHttpInfo(flowSid, sid, status);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<StudioV2FlowExecution> updateExecutionWithHttpInfo(String flowSid, String sid, ExecutionEnumStatus status) throws ApiException {
     ...
     */
    public okhttp3.Call updateExecutionAsync(String flowSid, String sid, ExecutionEnumStatus status, final ApiCallback<StudioV2FlowExecution> _callback) throws ApiException {
