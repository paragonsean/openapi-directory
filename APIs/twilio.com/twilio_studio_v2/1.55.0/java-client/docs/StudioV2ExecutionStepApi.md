...
|------------- | ------------- | -------------|
| [**fetchExecutionStep**](StudioV2ExecutionStepApi.md#fetchExecutionStep) | **GET** /v2/Flows/{FlowSid}/Executions/{ExecutionSid}/Steps/{Sid} |  |
| [**listExecutionStep**](StudioV2ExecutionStepApi.md#listExecutionStep) | **GET** /v2/Flows/{FlowSid}/Executions/{ExecutionSid}/Steps |  |


<a id="fetchExecutionStep"></a>
# **fetchExecutionStep**
> StudioV2FlowExecutionExecutionStep fetchExecutionStep(flowSid, executionSid, sid)
...
import org.openapitools.client.api.StudioV2ExecutionStepApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    StudioV2ExecutionStepApi apiInstance = new StudioV2ExecutionStepApi(defaultClient);
    ...
    try {
      StudioV2FlowExecutionExecutionStep result = apiInstance.fetchExecutionStep(flowSid, executionSid, sid);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StudioV2ExecutionStepApi#fetchExecutionStep");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling StudioV2ExecutionStepApi#listExecutionStep");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
