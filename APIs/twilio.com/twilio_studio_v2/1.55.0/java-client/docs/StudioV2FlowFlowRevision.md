...
|**errors** | **List&lt;Object&gt;** | List of error in the flow definition. |  [optional] |
|**friendlyName** | **String** | The string that you assigned to describe the Flow. |  [optional] |
|**revision** | **Integer** | The latest revision number of the Flow&#39;s definition. |  [optional] |
|**sid** | **String** | The unique string that we created to identify the Flow resource. |  [optional] |
|**status** | **FlowRevisionEnumStatus** |  |  [optional] |
