...
async def list_hosted_numbers_dependent_hosted_number_order(request: web.Request, signing_document_sid, status=None, phone_number=None, incoming_phone_number_sid=None, friendly_name=None, unique_name=None, page_size=None, page=None, page_token=None) -> web.Response:
    """list_hosted_numbers_dependent_hosted_number_order
