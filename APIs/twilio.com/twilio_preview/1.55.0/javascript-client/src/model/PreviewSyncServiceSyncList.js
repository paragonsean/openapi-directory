...
/**
 * The PreviewSyncServiceSyncList model module.
 * @module model/PreviewSyncServiceSyncList
 * @version 1.55.0
 */
class PreviewSyncServiceSyncList {
    /**
     * Constructs a new <code>PreviewSyncServiceSyncList</code>.
     * @alias module:model/PreviewSyncServiceSyncList
     */
    constructor() { 
        
        PreviewSyncServiceSyncList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PreviewSyncServiceSyncList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PreviewSyncServiceSyncList} obj Optional instance to populate.
     * @return {module:model/PreviewSyncServiceSyncList} The populated <code>PreviewSyncServiceSyncList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PreviewSyncServiceSyncList();
    ...
    /**
     * Validates the JSON data with respect to <code>PreviewSyncServiceSyncList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PreviewSyncServiceSyncList</code>.
     */
 ...
 */
PreviewSyncServiceSyncList.prototype['account_sid'] = undefined;

/**
 * @member {String} created_by
 */
PreviewSyncServiceSyncList.prototype['created_by'] = undefined;

/**
 * @member {Date} date_created
 */
PreviewSyncServiceSyncList.prototype['date_created'] = undefined;

/**
 * @member {Date} date_updated
 */
PreviewSyncServiceSyncList.prototype['date_updated'] = undefined;

/**
 * @member {Object} links
 */
PreviewSyncServiceSyncList.prototype['links'] = undefined;

/**
 * @member {String} revision
 */
PreviewSyncServiceSyncList.prototype['revision'] = undefined;

/**
 * @member {String} service_sid
 */
PreviewSyncServiceSyncList.prototype['service_sid'] = undefined;

/**
 * @member {String} sid
 */
PreviewSyncServiceSyncList.prototype['sid'] = undefined;

/**
 * @member {String} unique_name
 */
PreviewSyncServiceSyncList.prototype['unique_name'] = undefined;

/**
 * @member {String} url
 */
PreviewSyncServiceSyncList.prototype['url'] = undefined;
...
export default PreviewSyncServiceSyncList;
