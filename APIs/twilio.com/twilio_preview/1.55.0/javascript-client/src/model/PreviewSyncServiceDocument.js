...
/**
 * The PreviewSyncServiceDocument model module.
 * @module model/PreviewSyncServiceDocument
 * @version 1.55.0
 */
class PreviewSyncServiceDocument {
    /**
     * Constructs a new <code>PreviewSyncServiceDocument</code>.
     * @alias module:model/PreviewSyncServiceDocument
     */
    constructor() { 
        
        PreviewSyncServiceDocument.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PreviewSyncServiceDocument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PreviewSyncServiceDocument} obj Optional instance to populate.
     * @return {module:model/PreviewSyncServiceDocument} The populated <code>PreviewSyncServiceDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PreviewSyncServiceDocument();
    ...
    /**
     * Validates the JSON data with respect to <code>PreviewSyncServiceDocument</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PreviewSyncServiceDocument</code>.
     */
 ...
 */
PreviewSyncServiceDocument.prototype['account_sid'] = undefined;

/**
 * @member {String} created_by
 */
PreviewSyncServiceDocument.prototype['created_by'] = undefined;

/**
 * @member {Object} data
 */
PreviewSyncServiceDocument.prototype['data'] = undefined;

/**
 * @member {Date} date_created
 */
PreviewSyncServiceDocument.prototype['date_created'] = undefined;

/**
 * @member {Date} date_updated
 */
PreviewSyncServiceDocument.prototype['date_updated'] = undefined;

/**
 * @member {Object} links
 */
PreviewSyncServiceDocument.prototype['links'] = undefined;

/**
 * @member {String} revision
 */
PreviewSyncServiceDocument.prototype['revision'] = undefined;

/**
 * @member {String} service_sid
 */
PreviewSyncServiceDocument.prototype['service_sid'] = undefined;

/**
 * @member {String} sid
 */
PreviewSyncServiceDocument.prototype['sid'] = undefined;

/**
 * @member {String} unique_name
 */
PreviewSyncServiceDocument.prototype['unique_name'] = undefined;

/**
 * @member {String} url
 */
PreviewSyncServiceDocument.prototype['url'] = undefined;
...
export default PreviewSyncServiceDocument;
