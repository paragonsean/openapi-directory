...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioPreview.PreviewDeployedDevicesFleet();
  });
  ...
  describe('PreviewDeployedDevicesFleet', function() {
    it('should create an instance of PreviewDeployedDevicesFleet', function() {
      // uncomment below and update the code to test PreviewDeployedDevicesFleet
      //var instance = new TwilioPreview.PreviewDeployedDevicesFleet();
      //expect(instance).to.be.a(TwilioPreview.PreviewDeployedDevicesFleet);
    });
    ...
    it('should have the property defaultDeploymentSid (base name: "default_deployment_sid")', function() {
      // uncomment below and update the code to test the property defaultDeploymentSid
      //var instance = new TwilioPreview.PreviewDeployedDevicesFleet();
      //expect(instance).to.be();
    });
