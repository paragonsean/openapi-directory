...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioPreview.PreviewSyncService();
  });
  ...
  describe('PreviewSyncService', function() {
    it('should create an instance of PreviewSyncService', function() {
      // uncomment below and update the code to test PreviewSyncService
      //var instance = new TwilioPreview.PreviewSyncService();
      //expect(instance).to.be.a(TwilioPreview.PreviewSyncService);
    });
