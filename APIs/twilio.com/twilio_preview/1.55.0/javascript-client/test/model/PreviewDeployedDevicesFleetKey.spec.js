...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioPreview.PreviewDeployedDevicesFleetKey();
  });
  ...
  describe('PreviewDeployedDevicesFleetKey', function() {
    it('should create an instance of PreviewDeployedDevicesFleetKey', function() {
      // uncomment below and update the code to test PreviewDeployedDevicesFleetKey
      //var instance = new TwilioPreview.PreviewDeployedDevicesFleetKey();
      //expect(instance).to.be.a(TwilioPreview.PreviewDeployedDevicesFleetKey);
    });
