...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioPreview.PreviewSyncServiceSyncMap();
  });
  ...
  describe('PreviewSyncServiceSyncMap', function() {
    it('should create an instance of PreviewSyncServiceSyncMap', function() {
      // uncomment below and update the code to test PreviewSyncServiceSyncMap
      //var instance = new TwilioPreview.PreviewSyncServiceSyncMap();
      //expect(instance).to.be.a(TwilioPreview.PreviewSyncServiceSyncMap);
    });
