...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioPreview.PreviewSyncServiceSyncMapSyncMapItem();
  });
  ...
  describe('PreviewSyncServiceSyncMapSyncMapItem', function() {
    it('should create an instance of PreviewSyncServiceSyncMapSyncMapItem', function() {
      // uncomment below and update the code to test PreviewSyncServiceSyncMapSyncMapItem
      //var instance = new TwilioPreview.PreviewSyncServiceSyncMapSyncMapItem();
      //expect(instance).to.be.a(TwilioPreview.PreviewSyncServiceSyncMapSyncMapItem);
    });
