...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioPreview.PreviewWirelessCommand();
  });
  ...
  describe('PreviewWirelessCommand', function() {
    it('should create an instance of PreviewWirelessCommand', function() {
      // uncomment below and update the code to test PreviewWirelessCommand
      //var instance = new TwilioPreview.PreviewWirelessCommand();
      //expect(instance).to.be.a(TwilioPreview.PreviewWirelessCommand);
    });
