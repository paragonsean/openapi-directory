...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioPreview.PreviewSyncServiceSyncList();
  });
  ...
  describe('PreviewSyncServiceSyncList', function() {
    it('should create an instance of PreviewSyncServiceSyncList', function() {
      // uncomment below and update the code to test PreviewSyncServiceSyncList
      //var instance = new TwilioPreview.PreviewSyncServiceSyncList();
      //expect(instance).to.be.a(TwilioPreview.PreviewSyncServiceSyncList);
    });
