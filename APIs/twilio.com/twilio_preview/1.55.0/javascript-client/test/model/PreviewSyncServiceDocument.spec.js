...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioPreview.PreviewSyncServiceDocument();
  });
  ...
  describe('PreviewSyncServiceDocument', function() {
    it('should create an instance of PreviewSyncServiceDocument', function() {
      // uncomment below and update the code to test PreviewSyncServiceDocument
      //var instance = new TwilioPreview.PreviewSyncServiceDocument();
      //expect(instance).to.be.a(TwilioPreview.PreviewSyncServiceDocument);
    });
