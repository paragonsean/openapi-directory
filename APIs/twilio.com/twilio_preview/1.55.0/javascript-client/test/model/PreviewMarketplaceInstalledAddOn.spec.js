...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioPreview.PreviewMarketplaceInstalledAddOn();
  });
  ...
  describe('PreviewMarketplaceInstalledAddOn', function() {
    it('should create an instance of PreviewMarketplaceInstalledAddOn', function() {
      // uncomment below and update the code to test PreviewMarketplaceInstalledAddOn
      //var instance = new TwilioPreview.PreviewMarketplaceInstalledAddOn();
      //expect(instance).to.be.a(TwilioPreview.PreviewMarketplaceInstalledAddOn);
    });
