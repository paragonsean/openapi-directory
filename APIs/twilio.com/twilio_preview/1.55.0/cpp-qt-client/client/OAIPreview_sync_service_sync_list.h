...
/*
 * OAIPreview_sync_service_sync_list.h
 *
 * 
 */

#ifndef OAIPreview_sync_service_sync_list_H
#define OAIPreview_sync_service_sync_list_H
...
class OAIPreview_sync_service_sync_list : public OAIObject {
public:
    OAIPreview_sync_service_sync_list();
    OAIPreview_sync_service_sync_list(QString json);
    ~OAIPreview_sync_service_sync_list() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPreview_sync_service_sync_list)

#endif // OAIPreview_sync_service_sync_list_H
