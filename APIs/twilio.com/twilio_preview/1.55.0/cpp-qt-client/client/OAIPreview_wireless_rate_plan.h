...
/*
 * OAIPreview_wireless_rate_plan.h
 *
 * 
 */

#ifndef OAIPreview_wireless_rate_plan_H
#define OAIPreview_wireless_rate_plan_H
...
class OAIPreview_wireless_rate_plan : public OAIObject {
public:
    OAIPreview_wireless_rate_plan();
    OAIPreview_wireless_rate_plan(QString json);
    ~OAIPreview_wireless_rate_plan() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPreview_wireless_rate_plan)

#endif // OAIPreview_wireless_rate_plan_H
