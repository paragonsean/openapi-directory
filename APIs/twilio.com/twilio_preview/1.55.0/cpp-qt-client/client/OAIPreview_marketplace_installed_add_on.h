...
/*
 * OAIPreview_marketplace_installed_add_on.h
 *
 * 
 */

#ifndef OAIPreview_marketplace_installed_add_on_H
#define OAIPreview_marketplace_installed_add_on_H
...
class OAIPreview_marketplace_installed_add_on : public OAIObject {
public:
    OAIPreview_marketplace_installed_add_on();
    OAIPreview_marketplace_installed_add_on(QString json);
    ~OAIPreview_marketplace_installed_add_on() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPreview_marketplace_installed_add_on)

#endif // OAIPreview_marketplace_installed_add_on_H
