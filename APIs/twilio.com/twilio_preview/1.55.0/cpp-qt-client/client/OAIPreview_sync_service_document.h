...
/*
 * OAIPreview_sync_service_document.h
 *
 * 
 */

#ifndef OAIPreview_sync_service_document_H
#define OAIPreview_sync_service_document_H
...
class OAIPreview_sync_service_document : public OAIObject {
public:
    OAIPreview_sync_service_document();
    OAIPreview_sync_service_document(QString json);
    ~OAIPreview_sync_service_document() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPreview_sync_service_document)

#endif // OAIPreview_sync_service_document_H
