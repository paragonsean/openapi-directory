...
/*
 * OAIPreview_deployed_devices_fleet.h
 *
 * 
 */

#ifndef OAIPreview_deployed_devices_fleet_H
#define OAIPreview_deployed_devices_fleet_H
...
class OAIPreview_deployed_devices_fleet : public OAIObject {
public:
    OAIPreview_deployed_devices_fleet();
    OAIPreview_deployed_devices_fleet(QString json);
    ~OAIPreview_deployed_devices_fleet() override;
    ...
    QString getDefaultDeploymentSid() const;
    void setDefaultDeploymentSid(const QString &default_deployment_sid);
    bool is_default_deployment_sid_Set() const;
    bool is_default_deployment_sid_Valid() const;
...
private:
    ...
    QString m_default_deployment_sid;
    bool m_default_deployment_sid_isSet;
    bool m_default_deployment_sid_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPreview_deployed_devices_fleet)

#endif // OAIPreview_deployed_devices_fleet_H
