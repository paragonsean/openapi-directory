...
async def fetch_trunking_country(request: web.Request, iso_country) -> web.Response:
...
async def list_trunking_country(request: web.Request, page_size=None, page=None, page_token=None) -> web.Response:
