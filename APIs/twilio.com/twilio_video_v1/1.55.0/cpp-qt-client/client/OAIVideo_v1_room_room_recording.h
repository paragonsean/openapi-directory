...
/*
 * OAIVideo_v1_room_room_recording.h
 *
 * 
 */

#ifndef OAIVideo_v1_room_room_recording_H
#define OAIVideo_v1_room_room_recording_H
...
class OAIVideo_v1_room_room_recording : public OAIObject {
public:
    OAIVideo_v1_room_room_recording();
    OAIVideo_v1_room_room_recording(QString json);
    ~OAIVideo_v1_room_room_recording() override;
    ...
    OAIRoom_recording_enum_codec getCodec() const;
    void setCodec(const OAIRoom_recording_enum_codec &codec);
    bool is_codec_Set() const;
    bool is_codec_Valid() const;

    OAIRoom_recording_enum_format getContainerFormat() const;
    void setContainerFormat(const OAIRoom_recording_enum_format &container_format);
    ...
    OAIRoom_recording_enum_status getStatus() const;
    void setStatus(const OAIRoom_recording_enum_status &status);
    ...
    OAIRoom_recording_enum_type getType() const;
    void setType(const OAIRoom_recording_enum_type &type);
...
private:
    ...
    OAIRoom_recording_enum_codec m_codec;
    bool m_codec_isSet;
    bool m_codec_isValid;

    OAIRoom_recording_enum_format m_container_format;
    ...
    OAIRoom_recording_enum_status m_status;
    bool m_status_isSet;
    ...
    OAIRoom_recording_enum_type m_type;
    bool m_type_isSet;
    bool m_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideo_v1_room_room_recording)

#endif // OAIVideo_v1_room_room_recording_H
