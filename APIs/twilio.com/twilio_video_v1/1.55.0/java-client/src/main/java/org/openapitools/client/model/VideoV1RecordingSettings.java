...
public class VideoV1RecordingSettings {
  ...
  public VideoV1RecordingSettings accountSid(String accountSid) {
  ...
  public VideoV1RecordingSettings awsCredentialsSid(String awsCredentialsSid) {
  ...
  public VideoV1RecordingSettings awsS3Url(URI awsS3Url) {
  ...
  public VideoV1RecordingSettings awsStorageEnabled(Boolean awsStorageEnabled) {
  ...
  public VideoV1RecordingSettings encryptionEnabled(Boolean encryptionEnabled) {
  ...
  public VideoV1RecordingSettings encryptionKeySid(String encryptionKeySid) {
  ...
  public VideoV1RecordingSettings friendlyName(String friendlyName) {
  ...
  public VideoV1RecordingSettings url(URI url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VideoV1RecordingSettings videoV1RecordingSettings = (VideoV1RecordingSettings) o;
    return Objects.equals(this.accountSid, videoV1RecordingSettings.accountSid) &&
        Objects.equals(this.awsCredentialsSid, videoV1RecordingSettings.awsCredentialsSid) &&
        Objects.equals(this.awsS3Url, videoV1RecordingSettings.awsS3Url) &&
        Objects.equals(this.awsStorageEnabled, videoV1RecordingSettings.awsStorageEnabled) &&
        Objects.equals(this.encryptionEnabled, videoV1RecordingSettings.encryptionEnabled) &&
        Objects.equals(this.encryptionKeySid, videoV1RecordingSettings.encryptionKeySid) &&
        Objects.equals(this.friendlyName, videoV1RecordingSettings.friendlyName) &&
        Objects.equals(this.url, videoV1RecordingSettings.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class VideoV1RecordingSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoV1RecordingSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoV1RecordingSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoV1RecordingSettings is not found in the empty JSON string", VideoV1RecordingSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VideoV1RecordingSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoV1RecordingSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoV1RecordingSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoV1RecordingSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoV1RecordingSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoV1RecordingSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoV1RecordingSettings>() {
           @Override
           public void write(JsonWriter out, VideoV1RecordingSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VideoV1RecordingSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VideoV1RecordingSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoV1RecordingSettings
   * @throws IOException if the JSON string is invalid with respect to VideoV1RecordingSettings
   */
  public static VideoV1RecordingSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoV1RecordingSettings.class);
  }

  /**
   * Convert an instance of VideoV1RecordingSettings to an JSON string
   *
   * @return JSON string
   */
