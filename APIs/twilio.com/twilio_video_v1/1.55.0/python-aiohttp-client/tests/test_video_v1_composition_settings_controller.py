...
async def test_create_composition_settings(client):
    """Test case for create_composition_settings
...
async def test_fetch_composition_settings(client):
    """Test case for fetch_composition_settings
