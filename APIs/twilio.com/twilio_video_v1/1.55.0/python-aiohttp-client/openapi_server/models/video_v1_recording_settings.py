...
class VideoV1RecordingSettings(Model):
    ...
    def __init__(self, account_sid: str=None, aws_credentials_sid: str=None, aws_s3_url: str=None, aws_storage_enabled: bool=None, encryption_enabled: bool=None, encryption_key_sid: str=None, friendly_name: str=None, url: str=None):
        """VideoV1RecordingSettings - a model defined in OpenAPI

        :param account_sid: The account_sid of this VideoV1RecordingSettings.
        :param aws_credentials_sid: The aws_credentials_sid of this VideoV1RecordingSettings.
        :param aws_s3_url: The aws_s3_url of this VideoV1RecordingSettings.
        :param aws_storage_enabled: The aws_storage_enabled of this VideoV1RecordingSettings.
        :param encryption_enabled: The encryption_enabled of this VideoV1RecordingSettings.
        :param encryption_key_sid: The encryption_key_sid of this VideoV1RecordingSettings.
        :param friendly_name: The friendly_name of this VideoV1RecordingSettings.
        :param url: The url of this VideoV1RecordingSettings.
        """
        self.openapi_types = {
            'account_sid': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'VideoV1RecordingSettings':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The video.v1.recording_settings of this VideoV1RecordingSettings.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_sid(self):
        """Gets the account_sid of this VideoV1RecordingSettings.

        The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the RecordingSettings resource.

        :return: The account_sid of this VideoV1RecordingSettings.
        :rtype: str
        """
    ...
    def account_sid(self, account_sid):
        """Sets the account_sid of this VideoV1RecordingSettings.
    ...
    def aws_credentials_sid(self):
        """Gets the aws_credentials_sid of this VideoV1RecordingSettings.

        The SID of the stored Credential resource.

        :return: The aws_credentials_sid of this VideoV1RecordingSettings.
        :rtype: str
        """
    ...
    def aws_credentials_sid(self, aws_credentials_sid):
        """Sets the aws_credentials_sid of this VideoV1RecordingSettings.
    ...
    @property
    def aws_s3_url(self):
        """Gets the aws_s3_url of this VideoV1RecordingSettings.
        ...
        :return: The aws_s3_url of this VideoV1RecordingSettings.
        :rtype: str
        """
    ...
    def aws_s3_url(self, aws_s3_url):
        """Sets the aws_s3_url of this VideoV1RecordingSettings.
    ...
    def aws_storage_enabled(self):
        """Gets the aws_storage_enabled of this VideoV1RecordingSettings.

        Whether all recordings are written to the `aws_s3_url`. When `false`, all recordings are stored in our cloud.

        :return: The aws_storage_enabled of this VideoV1RecordingSettings.
        :rtype: bool
        """
    ...
    def aws_storage_enabled(self, aws_storage_enabled):
        """Sets the aws_storage_enabled of this VideoV1RecordingSettings.
    ...
    def encryption_enabled(self):
        """Gets the encryption_enabled of this VideoV1RecordingSettings.

        Whether all recordings are stored in an encrypted form. The default is `false`.

        :return: The encryption_enabled of this VideoV1RecordingSettings.
        :rtype: bool
        """
    ...
    def encryption_enabled(self, encryption_enabled):
        """Sets the encryption_enabled of this VideoV1RecordingSettings.
    ...
    def encryption_key_sid(self):
        """Gets the encryption_key_sid of this VideoV1RecordingSettings.

        The SID of the Public Key resource used for encryption.

        :return: The encryption_key_sid of this VideoV1RecordingSettings.
        :rtype: str
        """
    ...
    def encryption_key_sid(self, encryption_key_sid):
        """Sets the encryption_key_sid of this VideoV1RecordingSettings.
    ...
    def friendly_name(self):
        """Gets the friendly_name of this VideoV1RecordingSettings.

        The string that you assigned to describe the resource and show the user in the console

        :return: The friendly_name of this VideoV1RecordingSettings.
        :rtype: str
        """
    ...
    def friendly_name(self, friendly_name):
        """Sets the friendly_name of this VideoV1RecordingSettings.
    ...
    @property
    def url(self):
        """Gets the url of this VideoV1RecordingSettings.

        The absolute URL of the resource.

        :return: The url of this VideoV1RecordingSettings.
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this VideoV1RecordingSettings.
