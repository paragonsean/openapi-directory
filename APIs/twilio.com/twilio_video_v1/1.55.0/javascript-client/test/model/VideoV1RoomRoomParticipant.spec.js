...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioVideo.VideoV1RoomRoomParticipant();
  });
  ...
  describe('VideoV1RoomRoomParticipant', function() {
    it('should create an instance of VideoV1RoomRoomParticipant', function() {
      // uncomment below and update the code to test VideoV1RoomRoomParticipant
      //var instance = new TwilioVideo.VideoV1RoomRoomParticipant();
      //expect(instance).to.be.a(TwilioVideo.VideoV1RoomRoomParticipant);
    });
