...
**codec** | [**RecordingEnumCodec**](RecordingEnumCodec.md) |  | [optional] 
**containerFormat** | [**RecordingEnumFormat**](RecordingEnumFormat.md) |  | [optional] 
...
**duration** | **Number** | The duration of the recording in seconds rounded to the nearest second. Sub-second tracks have a &#x60;Duration&#x60; property of 1 second | [optional] 
...
**statusCallback** | **String** | The URL called using the &#x60;status_callback_method&#x60; to send status information on every recording event. | [optional] 
...
**type** | [**RecordingEnumType**](RecordingEnumType.md) |  | [optional] 
