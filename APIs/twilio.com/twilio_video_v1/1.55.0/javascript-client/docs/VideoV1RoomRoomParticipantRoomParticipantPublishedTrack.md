# TwilioVideo.VideoV1RoomRoomParticipantRoomParticipantPublishedTrack
...
**enabled** | **Boolean** | Whether the track is enabled. | [optional] 
**kind** | [**RoomParticipantPublishedTrackEnumKind**](RoomParticipantPublishedTrackEnumKind.md) |  | [optional] 
**name** | **String** | The track name. Must be no more than 128 characters, and be unique among the participant&#39;s published tracks. | [optional] 
...
**sid** | **String** | The unique string that we created to identify the RoomParticipantPublishedTrack resource. | [optional] 
