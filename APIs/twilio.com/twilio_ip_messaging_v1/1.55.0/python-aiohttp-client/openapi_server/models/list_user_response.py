...
class ListUserResponse(Model):
    ...
    def __init__(self, meta: ListCredentialResponseMeta=None, users: List[IpMessagingV1ServiceUser]=None):
        ...
        self.openapi_types = {
            ...
            'users': List[IpMessagingV1ServiceUser]
        }
    ...
    def users(self):
        ...
        :rtype: List[IpMessagingV1ServiceUser]
        """
        return self._users
    ...
    def users(self, users):
        ...
        :param users: The users of this ListUserResponse.
        :type users: List[IpMessagingV1ServiceUser]
        """
