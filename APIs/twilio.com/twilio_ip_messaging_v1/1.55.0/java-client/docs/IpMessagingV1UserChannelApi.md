...
import org.openapitools.client.api.IpMessagingV1UserChannelApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    IpMessagingV1UserChannelApi apiInstance = new IpMessagingV1UserChannelApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling IpMessagingV1UserChannelApi#listUserChannel");
