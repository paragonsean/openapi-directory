...
/**
 * API tests for IpMessagingV1CredentialApi
 */
@Disabled
public class IpMessagingV1CredentialApiTest {

    private final IpMessagingV1CredentialApi api = new IpMessagingV1CredentialApi();
