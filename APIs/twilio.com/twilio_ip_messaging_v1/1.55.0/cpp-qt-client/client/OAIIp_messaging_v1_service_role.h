...
/*
 * OAIIp_messaging_v1_service_role.h
 *
 * 
 */

#ifndef OAIIp_messaging_v1_service_role_H
#define OAIIp_messaging_v1_service_role_H
...
class OAIIp_messaging_v1_service_role : public OAIObject {
public:
    OAIIp_messaging_v1_service_role();
    OAIIp_messaging_v1_service_role(QString json);
    ~OAIIp_messaging_v1_service_role() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIp_messaging_v1_service_role)

#endif // OAIIp_messaging_v1_service_role_H
