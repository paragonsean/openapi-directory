...
#ifndef OAI_OAIIpMessagingV1RoleApi_H
#define OAI_OAIIpMessagingV1RoleApi_H
...
class OAIIpMessagingV1RoleApi : public QObject {
    Q_OBJECT

public:
    OAIIpMessagingV1RoleApi(const int timeOut = 0);
    ~OAIIpMessagingV1RoleApi();
...
Q_SIGNALS:
    ...
    void createRoleSignal(OAIIp_messaging_v1_service_role summary);
    void deleteRoleSignal();
    void fetchRoleSignal(OAIIp_messaging_v1_service_role summary);
    void listRoleSignal(OAIListRoleResponse summary);
    void updateRoleSignal(OAIIp_messaging_v1_service_role summary);


    void createRoleSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_service_role summary);
    void deleteRoleSignalFull(OAIHttpRequestWorker *worker);
    void fetchRoleSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_service_role summary);
    void listRoleSignalFull(OAIHttpRequestWorker *worker, OAIListRoleResponse summary);
    void updateRoleSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_service_role summary);

    Q_DECL_DEPRECATED_X("Use createRoleSignalError() instead")
    void createRoleSignalE(OAIIp_messaging_v1_service_role summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createRoleSignalError(OAIIp_messaging_v1_service_role summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchRoleSignalE(OAIIp_messaging_v1_service_role summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchRoleSignalError(OAIIp_messaging_v1_service_role summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateRoleSignalE(OAIIp_messaging_v1_service_role summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateRoleSignalError(OAIIp_messaging_v1_service_role summary, QNetworkReply::NetworkError error_type, const QString &error_str);
