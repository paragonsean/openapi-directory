...
#ifndef OAI_OAIIpMessagingV1UserApi_H
#define OAI_OAIIpMessagingV1UserApi_H
...
class OAIIpMessagingV1UserApi : public QObject {
    Q_OBJECT

public:
    OAIIpMessagingV1UserApi(const int timeOut = 0);
    ~OAIIpMessagingV1UserApi();
    ...
    */
    virtual void createUser(const QString &service_sid, const QString &identity, const ::OpenAPI::OptionalParam<QString> &attributes = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &friendly_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &role_sid = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  role_sid QString [optional]
    */
    virtual void updateUser(const QString &service_sid, const QString &sid, const ::OpenAPI::OptionalParam<QString> &attributes = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &friendly_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &role_sid = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void createUserSignal(OAIIp_messaging_v1_service_user summary);
    void deleteUserSignal();
    void fetchUserSignal(OAIIp_messaging_v1_service_user summary);
    void listUserSignal(OAIListUserResponse summary);
    void updateUserSignal(OAIIp_messaging_v1_service_user summary);


    void createUserSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_service_user summary);
    void deleteUserSignalFull(OAIHttpRequestWorker *worker);
    void fetchUserSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_service_user summary);
    void listUserSignalFull(OAIHttpRequestWorker *worker, OAIListUserResponse summary);
    void updateUserSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_service_user summary);

    Q_DECL_DEPRECATED_X("Use createUserSignalError() instead")
    void createUserSignalE(OAIIp_messaging_v1_service_user summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createUserSignalError(OAIIp_messaging_v1_service_user summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchUserSignalE(OAIIp_messaging_v1_service_user summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchUserSignalError(OAIIp_messaging_v1_service_user summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateUserSignalE(OAIIp_messaging_v1_service_user summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateUserSignalError(OAIIp_messaging_v1_service_user summary, QNetworkReply::NetworkError error_type, const QString &error_str);
