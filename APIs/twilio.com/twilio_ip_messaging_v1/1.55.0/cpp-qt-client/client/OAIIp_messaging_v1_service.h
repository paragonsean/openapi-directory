...
/*
 * OAIIp_messaging_v1_service.h
 *
 * 
 */

#ifndef OAIIp_messaging_v1_service_H
#define OAIIp_messaging_v1_service_H
...
class OAIIp_messaging_v1_service : public OAIObject {
public:
    OAIIp_messaging_v1_service();
    OAIIp_messaging_v1_service(QString json);
    ~OAIIp_messaging_v1_service() override;
    ...
    QJsonValue getWebhooks() const;
    void setWebhooks(const QJsonValue &webhooks);
...
Q_DECLARE_METATYPE(OpenAPI::OAIIp_messaging_v1_service)

#endif // OAIIp_messaging_v1_service_H
