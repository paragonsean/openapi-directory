...
/*
 * OAIIp_messaging_v1_credential.h
 *
 * 
 */

#ifndef OAIIp_messaging_v1_credential_H
#define OAIIp_messaging_v1_credential_H
...
class OAIIp_messaging_v1_credential : public OAIObject {
public:
    OAIIp_messaging_v1_credential();
    OAIIp_messaging_v1_credential(QString json);
    ~OAIIp_messaging_v1_credential() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIp_messaging_v1_credential)

#endif // OAIIp_messaging_v1_credential_H
