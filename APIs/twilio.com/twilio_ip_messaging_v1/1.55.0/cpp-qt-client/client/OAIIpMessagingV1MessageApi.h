...
#ifndef OAI_OAIIpMessagingV1MessageApi_H
#define OAI_OAIIpMessagingV1MessageApi_H
...
class OAIIpMessagingV1MessageApi : public QObject {
    Q_OBJECT

public:
    OAIIpMessagingV1MessageApi(const int timeOut = 0);
    ~OAIIpMessagingV1MessageApi();
...
Q_SIGNALS:
    ...
    void createMessageSignal(OAIIp_messaging_v1_service_channel_message summary);
    void deleteMessageSignal();
    void fetchMessageSignal(OAIIp_messaging_v1_service_channel_message summary);
    void listMessageSignal(OAIListMessageResponse summary);
    void updateMessageSignal(OAIIp_messaging_v1_service_channel_message summary);


    void createMessageSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_service_channel_message summary);
    void deleteMessageSignalFull(OAIHttpRequestWorker *worker);
    void fetchMessageSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_service_channel_message summary);
    void listMessageSignalFull(OAIHttpRequestWorker *worker, OAIListMessageResponse summary);
    void updateMessageSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_service_channel_message summary);

    Q_DECL_DEPRECATED_X("Use createMessageSignalError() instead")
    void createMessageSignalE(OAIIp_messaging_v1_service_channel_message summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createMessageSignalError(OAIIp_messaging_v1_service_channel_message summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchMessageSignalE(OAIIp_messaging_v1_service_channel_message summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchMessageSignalError(OAIIp_messaging_v1_service_channel_message summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateMessageSignalE(OAIIp_messaging_v1_service_channel_message summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateMessageSignalError(OAIIp_messaging_v1_service_channel_message summary, QNetworkReply::NetworkError error_type, const QString &error_str);
