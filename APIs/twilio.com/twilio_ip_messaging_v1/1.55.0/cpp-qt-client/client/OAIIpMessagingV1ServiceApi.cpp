...
#include "OAIIpMessagingV1ServiceApi.h"
...
OAIIpMessagingV1ServiceApi::OAIIpMessagingV1ServiceApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIIpMessagingV1ServiceApi::~OAIIpMessagingV1ServiceApi() {
}

void OAIIpMessagingV1ServiceApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIIpMessagingV1ServiceApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIIpMessagingV1ServiceApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIIpMessagingV1ServiceApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIIpMessagingV1ServiceApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIIpMessagingV1ServiceApi::setUsername(const QString &username) {
    _username = username;
}

void OAIIpMessagingV1ServiceApi::setPassword(const QString &password) {
    _password = password;
}


void OAIIpMessagingV1ServiceApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIIpMessagingV1ServiceApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIIpMessagingV1ServiceApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIIpMessagingV1ServiceApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIIpMessagingV1ServiceApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIIpMessagingV1ServiceApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIIpMessagingV1ServiceApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIIpMessagingV1ServiceApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIIpMessagingV1ServiceApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIIpMessagingV1ServiceApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIIpMessagingV1ServiceApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIIpMessagingV1ServiceApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIIpMessagingV1ServiceApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIIpMessagingV1ServiceApi::createService(const QString &friendly_name) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIpMessagingV1ServiceApi::createServiceCallback);
    connect(this, &OAIIpMessagingV1ServiceApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIIpMessagingV1ServiceApi::createServiceCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIIp_messaging_v1_service output(QString(worker->response));
    worker->deleteLater();
...
void OAIIpMessagingV1ServiceApi::deleteService(const QString &sid) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIpMessagingV1ServiceApi::deleteServiceCallback);
    connect(this, &OAIIpMessagingV1ServiceApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIpMessagingV1ServiceApi::deleteServiceCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIIpMessagingV1ServiceApi::fetchService(const QString &sid) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIpMessagingV1ServiceApi::fetchServiceCallback);
    connect(this, &OAIIpMessagingV1ServiceApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIpMessagingV1ServiceApi::fetchServiceCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIIpMessagingV1ServiceApi::listService(const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QString> &page_token) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIpMessagingV1ServiceApi::listServiceCallback);
    connect(this, &OAIIpMessagingV1ServiceApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIpMessagingV1ServiceApi::listServiceCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIIpMessagingV1ServiceApi::updateService(const QString &sid, const ::OpenAPI::OptionalParam<qint32> &consumption_report_interval, const ::OpenAPI::OptionalParam<QString> &default_channel_creator_role_sid, const ::OpenAPI::OptionalParam<QString> &default_channel_role_sid, const ::OpenAPI::OptionalParam<QString> &default_service_role_sid, const ::OpenAPI::OptionalParam<QString> &friendly_name, const ::OpenAPI::OptionalParam<qint32> &limits_channel_members, const ::OpenAPI::OptionalParam<qint32> &limits_user_channels, const ::OpenAPI::OptionalParam<bool> &notifications_added_to_channel_enabled, const ::OpenAPI::OptionalParam<QString> &notifications_added_to_channel_template, const ::OpenAPI::OptionalParam<bool> &notifications_invited_to_channel_enabled, const ::OpenAPI::OptionalParam<QString> &notifications_invited_to_channel_template, const ::OpenAPI::OptionalParam<bool> &notifications_new_message_enabled, const ::OpenAPI::OptionalParam<QString> &notifications_new_message_template, const ::OpenAPI::OptionalParam<bool> &notifications_removed_from_channel_enabled, const ::OpenAPI::OptionalParam<QString> &notifications_removed_from_channel_template, const ::OpenAPI::OptionalParam<QString> &post_webhook_url, const ::OpenAPI::OptionalParam<QString> &pre_webhook_url, const ::OpenAPI::OptionalParam<bool> &reachability_enabled, const ::OpenAPI::OptionalParam<bool> &read_status_enabled, const ::OpenAPI::OptionalParam<qint32> &typing_indicator_timeout, const ::OpenAPI::OptionalParam<QList<QString>> &webhook_filters, const ::OpenAPI::OptionalParam<QString> &webhook_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_add_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_add_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_added_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_added_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_destroy_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_destroy_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_destroyed_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_destroyed_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_update_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_update_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_updated_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_channel_updated_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_member_add_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_member_add_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_member_added_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_member_added_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_member_remove_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_member_remove_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_member_removed_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_member_removed_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_remove_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_remove_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_removed_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_removed_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_send_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_send_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_sent_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_sent_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_update_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_update_url, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_updated_method, const ::OpenAPI::OptionalParam<QString> &webhooks_on_message_updated_url) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIpMessagingV1ServiceApi::updateServiceCallback);
    connect(this, &OAIIpMessagingV1ServiceApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIIpMessagingV1ServiceApi::updateServiceCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIIpMessagingV1ServiceApi::tokenAvailable(){
