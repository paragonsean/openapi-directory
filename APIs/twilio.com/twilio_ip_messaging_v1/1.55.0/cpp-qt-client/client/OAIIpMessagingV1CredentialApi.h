...
#ifndef OAI_OAIIpMessagingV1CredentialApi_H
#define OAI_OAIIpMessagingV1CredentialApi_H
...
class OAIIpMessagingV1CredentialApi : public QObject {
    Q_OBJECT

public:
    OAIIpMessagingV1CredentialApi(const int timeOut = 0);
    ~OAIIpMessagingV1CredentialApi();
...
Q_SIGNALS:
    ...
    void createCredentialSignal(OAIIp_messaging_v1_credential summary);
    void deleteCredentialSignal();
    void fetchCredentialSignal(OAIIp_messaging_v1_credential summary);
    void listCredentialSignal(OAIListCredentialResponse summary);
    void updateCredentialSignal(OAIIp_messaging_v1_credential summary);


    void createCredentialSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_credential summary);
    void deleteCredentialSignalFull(OAIHttpRequestWorker *worker);
    void fetchCredentialSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_credential summary);
    void listCredentialSignalFull(OAIHttpRequestWorker *worker, OAIListCredentialResponse summary);
    void updateCredentialSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v1_credential summary);

    Q_DECL_DEPRECATED_X("Use createCredentialSignalError() instead")
    void createCredentialSignalE(OAIIp_messaging_v1_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createCredentialSignalError(OAIIp_messaging_v1_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchCredentialSignalE(OAIIp_messaging_v1_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchCredentialSignalError(OAIIp_messaging_v1_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateCredentialSignalE(OAIIp_messaging_v1_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateCredentialSignalError(OAIIp_messaging_v1_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
