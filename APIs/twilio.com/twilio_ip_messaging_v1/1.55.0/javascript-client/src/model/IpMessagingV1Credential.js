...
/**
 * The IpMessagingV1Credential model module.
 * @module model/IpMessagingV1Credential
 * @version 1.55.0
 */
class IpMessagingV1Credential {
    /**
     * Constructs a new <code>IpMessagingV1Credential</code>.
     * @alias module:model/IpMessagingV1Credential
     */
    constructor() { 
        
        IpMessagingV1Credential.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IpMessagingV1Credential</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IpMessagingV1Credential} obj Optional instance to populate.
     * @return {module:model/IpMessagingV1Credential} The populated <code>IpMessagingV1Credential</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IpMessagingV1Credential();
    ...
    /**
     * Validates the JSON data with respect to <code>IpMessagingV1Credential</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IpMessagingV1Credential</code>.
     */
 ...
 */
IpMessagingV1Credential.prototype['account_sid'] = undefined;

/**
 * @member {Date} date_created
 */
IpMessagingV1Credential.prototype['date_created'] = undefined;

/**
 * @member {Date} date_updated
 */
IpMessagingV1Credential.prototype['date_updated'] = undefined;

/**
 * @member {String} friendly_name
 */
IpMessagingV1Credential.prototype['friendly_name'] = undefined;

/**
 * @member {String} sandbox
 */
IpMessagingV1Credential.prototype['sandbox'] = undefined;

/**
 * @member {String} sid
 */
IpMessagingV1Credential.prototype['sid'] = undefined;

/**
 * @member {module:model/CredentialEnumPushService} type
 */
IpMessagingV1Credential.prototype['type'] = undefined;

/**
 * @member {String} url
 */
IpMessagingV1Credential.prototype['url'] = undefined;
...
export default IpMessagingV1Credential;
