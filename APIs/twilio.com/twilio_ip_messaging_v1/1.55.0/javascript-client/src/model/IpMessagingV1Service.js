...
/**
 * The IpMessagingV1Service model module.
 * @module model/IpMessagingV1Service
 * @version 1.55.0
 */
class IpMessagingV1Service {
    /**
     * Constructs a new <code>IpMessagingV1Service</code>.
     * @alias module:model/IpMessagingV1Service
     */
    constructor() { 
        
        IpMessagingV1Service.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IpMessagingV1Service</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IpMessagingV1Service} obj Optional instance to populate.
     * @return {module:model/IpMessagingV1Service} The populated <code>IpMessagingV1Service</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IpMessagingV1Service();
    ...
    /**
     * Validates the JSON data with respect to <code>IpMessagingV1Service</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IpMessagingV1Service</code>.
     */
 ...
 */
IpMessagingV1Service.prototype['account_sid'] = undefined;

/**
 * @member {Number} consumption_report_interval
 */
IpMessagingV1Service.prototype['consumption_report_interval'] = undefined;

/**
 * @member {Date} date_created
 */
IpMessagingV1Service.prototype['date_created'] = undefined;

/**
 * @member {Date} date_updated
 */
IpMessagingV1Service.prototype['date_updated'] = undefined;

/**
 * @member {String} default_channel_creator_role_sid
 */
IpMessagingV1Service.prototype['default_channel_creator_role_sid'] = undefined;

/**
 * @member {String} default_channel_role_sid
 */
IpMessagingV1Service.prototype['default_channel_role_sid'] = undefined;

/**
 * @member {String} default_service_role_sid
 */
IpMessagingV1Service.prototype['default_service_role_sid'] = undefined;

/**
 * @member {String} friendly_name
 */
IpMessagingV1Service.prototype['friendly_name'] = undefined;

/**
 * @member {Object} limits
 */
IpMessagingV1Service.prototype['limits'] = undefined;

/**
 * @member {Object} links
 */
IpMessagingV1Service.prototype['links'] = undefined;

/**
 * @member {Object} notifications
 */
IpMessagingV1Service.prototype['notifications'] = undefined;

/**
 * @member {String} post_webhook_url
 */
IpMessagingV1Service.prototype['post_webhook_url'] = undefined;

/**
 * @member {String} pre_webhook_url
 */
IpMessagingV1Service.prototype['pre_webhook_url'] = undefined;

/**
 * @member {Boolean} reachability_enabled
 */
IpMessagingV1Service.prototype['reachability_enabled'] = undefined;

/**
 * @member {Boolean} read_status_enabled
 */
IpMessagingV1Service.prototype['read_status_enabled'] = undefined;

/**
 * @member {String} sid
 */
IpMessagingV1Service.prototype['sid'] = undefined;

/**
 * @member {Number} typing_indicator_timeout
 */
IpMessagingV1Service.prototype['typing_indicator_timeout'] = undefined;

/**
 * @member {String} url
 */
IpMessagingV1Service.prototype['url'] = undefined;

/**
 * @member {Array.<String>} webhook_filters
 */
IpMessagingV1Service.prototype['webhook_filters'] = undefined;

/**
 * @member {String} webhook_method
 */
IpMessagingV1Service.prototype['webhook_method'] = undefined;

/**
 * @member {Object} webhooks
 */
IpMessagingV1Service.prototype['webhooks'] = undefined;
...
export default IpMessagingV1Service;
