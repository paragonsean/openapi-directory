...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://ip-messaging.twilio.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://ip-messaging.twilio.com
         */
        ...
        this.authentications = {
            'accountSid_authToken': {type: 'basic'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.55.0/Javascript'
        };
