...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV1ServiceChannel();
  });
  ...
  describe('IpMessagingV1ServiceChannel', function() {
    it('should create an instance of IpMessagingV1ServiceChannel', function() {
      // uncomment below and update the code to test IpMessagingV1ServiceChannel
      //var instance = new TwilioIpMessaging.IpMessagingV1ServiceChannel();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV1ServiceChannel);
    });
