...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV1ServiceUser();
  });
  ...
  describe('IpMessagingV1ServiceUser', function() {
    it('should create an instance of IpMessagingV1ServiceUser', function() {
      // uncomment below and update the code to test IpMessagingV1ServiceUser
      //var instance = new TwilioIpMessaging.IpMessagingV1ServiceUser();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV1ServiceUser);
    });
