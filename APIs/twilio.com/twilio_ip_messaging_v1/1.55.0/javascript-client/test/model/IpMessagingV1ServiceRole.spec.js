...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV1ServiceRole();
  });
  ...
  describe('IpMessagingV1ServiceRole', function() {
    it('should create an instance of IpMessagingV1ServiceRole', function() {
      // uncomment below and update the code to test IpMessagingV1ServiceRole
      //var instance = new TwilioIpMessaging.IpMessagingV1ServiceRole();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV1ServiceRole);
    });
