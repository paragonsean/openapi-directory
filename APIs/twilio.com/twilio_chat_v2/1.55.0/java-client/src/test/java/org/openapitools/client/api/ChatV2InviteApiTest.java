...
/**
 * API tests for ChatV2InviteApi
 */
@Disabled
public class ChatV2InviteApiTest {

    private final ChatV2InviteApi api = new ChatV2InviteApi();
    ...
    public void createInviteTest() throws ApiException {
        ...
        String roleSid = null;
        ChatV2ServiceChannelInvite response = api.createInvite(serviceSid, channelSid, identity, roleSid);
    ...
    public void fetchInviteTest() throws ApiException {
        ...
        String channelSid = null;
        String sid = null;
        ChatV2ServiceChannelInvite response = api.fetchInvite(serviceSid, channelSid, sid);
        // TODO: test validations
    }
