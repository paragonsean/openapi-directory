...
/**
 * API tests for ChatV2CredentialApi
 */
@Disabled
public class ChatV2CredentialApiTest {

    private final ChatV2CredentialApi api = new ChatV2CredentialApi();
    ...
    public void createCredentialTest() throws ApiException {
        ...
        String secret = null;
        ChatV2Credential response = api.createCredential(type, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
    ...
    public void fetchCredentialTest() throws ApiException {
        String sid = null;
        ChatV2Credential response = api.fetchCredential(sid);
        // TODO: test validations
    }
    ...
    public void updateCredentialTest() throws ApiException {
        ...
        Boolean sandbox = null;
        String secret = null;
        ChatV2Credential response = api.updateCredential(sid, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
        // TODO: test validations
    }
