...
/**
 * API tests for ChatV2UserChannelApi
 */
@Disabled
public class ChatV2UserChannelApiTest {

    private final ChatV2UserChannelApi api = new ChatV2UserChannelApi();
    ...
    public void deleteUserChannelTest() throws ApiException {
        ...
        UserChannelEnumWebhookEnabledType xTwilioWebhookEnabled = null;
        api.deleteUserChannel(serviceSid, userSid, channelSid, xTwilioWebhookEnabled);
    ...
    public void fetchUserChannelTest() throws ApiException {
        ...
        String userSid = null;
        String channelSid = null;
        ChatV2ServiceUserUserChannel response = api.fetchUserChannel(serviceSid, userSid, channelSid);
        // TODO: test validations
    }
    ...
    public void updateUserChannelTest() throws ApiException {
        ...
        ChatV2ServiceUserUserChannel response = api.updateUserChannel(serviceSid, userSid, channelSid, lastConsumedMessageIndex, lastConsumptionTimestamp, notificationLevel);
        // TODO: test validations
    }
