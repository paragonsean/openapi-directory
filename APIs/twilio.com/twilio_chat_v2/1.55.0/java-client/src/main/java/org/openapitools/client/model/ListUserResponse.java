...
public class ListUserResponse {
  ...
  private List<ChatV2ServiceUser> users = new ArrayList<>();
  ...
  public ListUserResponse users(List<ChatV2ServiceUser> users) {
    this.users = users;
    return this;
  }

  public ListUserResponse addUsersItem(ChatV2ServiceUser usersItem) {
    if (this.users == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ChatV2ServiceUser> getUsers() {
    return users;
  }

  public void setUsers(List<ChatV2ServiceUser> users) {
    this.users = users;
  }
      ...
      if (jsonObj.get("users") != null && !jsonObj.get("users").isJsonNull()) {
        ...
        if (jsonArrayusers != null) {
          ...
          for (int i = 0; i < jsonArrayusers.size(); i++) {
            ChatV2ServiceUser.validateJsonElement(jsonArrayusers.get(i));
          };
        }
      }
  }
