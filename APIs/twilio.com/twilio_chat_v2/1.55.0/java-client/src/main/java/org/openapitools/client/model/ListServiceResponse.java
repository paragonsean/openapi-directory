...
public class ListServiceResponse {
  ...
  private List<ChatV2Service> services = new ArrayList<>();
  ...
  public ListServiceResponse services(List<ChatV2Service> services) {
    this.services = services;
    return this;
  }

  public ListServiceResponse addServicesItem(ChatV2Service servicesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ChatV2Service> getServices() {
    return services;
  }

  public void setServices(List<ChatV2Service> services) {
    this.services = services;
  }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            ChatV2Service.validateJsonElement(jsonArrayservices.get(i));
          };
        }
      }
  }
