...
public class ListCredentialResponse {
  ...
  private List<ChatV2Credential> credentials = new ArrayList<>();
  ...
  public ListCredentialResponse credentials(List<ChatV2Credential> credentials) {
    this.credentials = credentials;
    return this;
  }

  public ListCredentialResponse addCredentialsItem(ChatV2Credential credentialsItem) {
  ...
  public List<ChatV2Credential> getCredentials() {
    return credentials;
  }

  public void setCredentials(List<ChatV2Credential> credentials) {
    this.credentials = credentials;
  }
      ...
      if (jsonObj.get("credentials") != null && !jsonObj.get("credentials").isJsonNull()) {
        ...
        if (jsonArraycredentials != null) {
          ...
          for (int i = 0; i < jsonArraycredentials.size(); i++) {
            ChatV2Credential.validateJsonElement(jsonArraycredentials.get(i));
          };
        }
      }
