...
public class ChatV2CredentialApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ChatV2CredentialApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ChatV2CredentialApi(ApiClient apiClient) {
     ...
     */
    public ChatV2Credential createCredential(CredentialEnumPushService type, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
        ApiResponse<ChatV2Credential> localVarResp = createCredentialWithHttpInfo(type, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
     ...
     * @param sandbox [APN only] Whether to send the credential to sandbox APNs. Can be &#x60;true&#x60; to send to sandbox APNs or &#x60;false&#x60; to send to production. (optional)
     * @param secret [FCM only] The **Server key** of your project from the Firebase console, found under Settings / Cloud messaging. (optional)
     * @return ApiResponse&lt;ChatV2Credential&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ChatV2Credential> createCredentialWithHttpInfo(CredentialEnumPushService type, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ChatV2Credential>(){}.getType();
     ...
     */
    public okhttp3.Call createCredentialAsync(CredentialEnumPushService type, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret, final ApiCallback<ChatV2Credential> _callback) throws ApiException {
     ...
     * @param sid The SID of the Credential resource to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param sid The SID of the Credential resource to fetch. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public ChatV2Credential fetchCredential(String sid) throws ApiException {
        ApiResponse<ChatV2Credential> localVarResp = fetchCredentialWithHttpInfo(sid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChatV2Credential> fetchCredentialWithHttpInfo(String sid) throws ApiException {
     ...
     */
    public okhttp3.Call fetchCredentialAsync(String sid, final ApiCallback<ChatV2Credential> _callback) throws ApiException {
     ...
     * @param sid The SID of the Credential resource to update. (required)
     * @param apiKey [GCM only] The API key for the project that was obtained from the Google Developer console for your GCM Service application credential. (optional)
     * @param certificate [APN only] The URL encoded representation of the certificate. For example,  &#x60;-----BEGIN CERTIFICATE----- MIIFnTCCBIWgAwIBAgIIAjy9H849+E8wDQYJKoZIhvcNAQEF.....A&#x3D;&#x3D; -----END CERTIFICATE-----&#x60; (optional)
     ...
     */
    public ChatV2Credential updateCredential(String sid, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
        ApiResponse<ChatV2Credential> localVarResp = updateCredentialWithHttpInfo(sid, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChatV2Credential> updateCredentialWithHttpInfo(String sid, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
     ...
     */
    public okhttp3.Call updateCredentialAsync(String sid, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret, final ApiCallback<ChatV2Credential> _callback) throws ApiException {
