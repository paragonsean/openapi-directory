...
public class ChatV2ServiceUserUserBinding {
  ...
  public ChatV2ServiceUserUserBinding() {
  }

  public ChatV2ServiceUserUserBinding accountSid(String accountSid) {
  ...
  public ChatV2ServiceUserUserBinding bindingType(UserBindingEnumBindingType bindingType) {
  ...
  public ChatV2ServiceUserUserBinding credentialSid(String credentialSid) {
  ...
  public ChatV2ServiceUserUserBinding dateCreated(OffsetDateTime dateCreated) {
  ...
  public ChatV2ServiceUserUserBinding dateUpdated(OffsetDateTime dateUpdated) {
  ...
  public ChatV2ServiceUserUserBinding endpoint(String endpoint) {
  ...
  public ChatV2ServiceUserUserBinding identity(String identity) {
  ...
  public ChatV2ServiceUserUserBinding messageTypes(List<String> messageTypes) {
    this.messageTypes = messageTypes;
    return this;
  }

  public ChatV2ServiceUserUserBinding addMessageTypesItem(String messageTypesItem) {
  ...
  public ChatV2ServiceUserUserBinding serviceSid(String serviceSid) {
  ...
  public ChatV2ServiceUserUserBinding sid(String sid) {
    this.sid = sid;
    return this;
  }
  ...
  public ChatV2ServiceUserUserBinding url(URI url) {
    this.url = url;
    return this;
  }
  ...
  public ChatV2ServiceUserUserBinding userSid(String userSid) {
  ...
  public boolean equals(Object o) {
    ...
    ChatV2ServiceUserUserBinding chatV2ServiceUserUserBinding = (ChatV2ServiceUserUserBinding) o;
    return Objects.equals(this.accountSid, chatV2ServiceUserUserBinding.accountSid) &&
        Objects.equals(this.bindingType, chatV2ServiceUserUserBinding.bindingType) &&
        Objects.equals(this.credentialSid, chatV2ServiceUserUserBinding.credentialSid) &&
        Objects.equals(this.dateCreated, chatV2ServiceUserUserBinding.dateCreated) &&
        Objects.equals(this.dateUpdated, chatV2ServiceUserUserBinding.dateUpdated) &&
        Objects.equals(this.endpoint, chatV2ServiceUserUserBinding.endpoint) &&
        Objects.equals(this.identity, chatV2ServiceUserUserBinding.identity) &&
        Objects.equals(this.messageTypes, chatV2ServiceUserUserBinding.messageTypes) &&
        Objects.equals(this.serviceSid, chatV2ServiceUserUserBinding.serviceSid) &&
        Objects.equals(this.sid, chatV2ServiceUserUserBinding.sid) &&
        Objects.equals(this.url, chatV2ServiceUserUserBinding.url) &&
        Objects.equals(this.userSid, chatV2ServiceUserUserBinding.userSid);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChatV2ServiceUserUserBinding {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChatV2ServiceUserUserBinding
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatV2ServiceUserUserBinding.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChatV2ServiceUserUserBinding is not found in the empty JSON string", ChatV2ServiceUserUserBinding.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatV2ServiceUserUserBinding.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChatV2ServiceUserUserBinding` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChatV2ServiceUserUserBinding.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChatV2ServiceUserUserBinding' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChatV2ServiceUserUserBinding> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChatV2ServiceUserUserBinding.class));

       return (TypeAdapter<T>) new TypeAdapter<ChatV2ServiceUserUserBinding>() {
           @Override
           public void write(JsonWriter out, ChatV2ServiceUserUserBinding value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChatV2ServiceUserUserBinding read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChatV2ServiceUserUserBinding given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChatV2ServiceUserUserBinding
   * @throws IOException if the JSON string is invalid with respect to ChatV2ServiceUserUserBinding
   */
  public static ChatV2ServiceUserUserBinding fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChatV2ServiceUserUserBinding.class);
  }

  /**
   * Convert an instance of ChatV2ServiceUserUserBinding to an JSON string
   *
   * @return JSON string
   */
