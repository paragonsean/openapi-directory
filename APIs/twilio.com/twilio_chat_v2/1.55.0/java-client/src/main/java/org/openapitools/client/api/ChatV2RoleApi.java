...
public class ChatV2RoleApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ChatV2RoleApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ChatV2RoleApi(ApiClient apiClient) {
     ...
     * @param serviceSid The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to create the Role resource under. (required)
     ...
     */
    public ChatV2ServiceRole createRole(String serviceSid, String friendlyName, List<String> permission, RoleEnumRoleType type) throws ApiException {
        ApiResponse<ChatV2ServiceRole> localVarResp = createRoleWithHttpInfo(serviceSid, friendlyName, permission, type);
     ...
     * @param permission A permission that you grant to the new role. Only one permission can be granted per parameter. To assign more than one permission, repeat this parameter for each permission value. The values for this parameter depend on the role&#39;s &#x60;type&#x60;. (required)
     * @param type  (required)
     * @return ApiResponse&lt;ChatV2ServiceRole&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ChatV2ServiceRole> createRoleWithHttpInfo(String serviceSid, String friendlyName, List<String> permission, RoleEnumRoleType type) throws ApiException {
        okhttp3.Call localVarCall = createRoleValidateBeforeCall(serviceSid, friendlyName, permission, type, null);
        Type localVarReturnType = new TypeToken<ChatV2ServiceRole>(){}.getType();
     ...
     */
    public okhttp3.Call createRoleAsync(String serviceSid, String friendlyName, List<String> permission, RoleEnumRoleType type, final ApiCallback<ChatV2ServiceRole> _callback) throws ApiException {
     ...
     * @param serviceSid The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to delete the Role resource from. (required)
     ...
     * @param serviceSid The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to fetch the Role resource from. (required)
     ...
     */
    public ChatV2ServiceRole fetchRole(String serviceSid, String sid) throws ApiException {
        ApiResponse<ChatV2ServiceRole> localVarResp = fetchRoleWithHttpInfo(serviceSid, sid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChatV2ServiceRole> fetchRoleWithHttpInfo(String serviceSid, String sid) throws ApiException {
     ...
     */
    public okhttp3.Call fetchRoleAsync(String serviceSid, String sid, final ApiCallback<ChatV2ServiceRole> _callback) throws ApiException {
     ...
     * @param serviceSid The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to read the Role resources from. (required)
     ...
     * @param serviceSid The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to update the Role resource in. (required)
     ...
     */
    public ChatV2ServiceRole updateRole(String serviceSid, String sid, List<String> permission) throws ApiException {
        ApiResponse<ChatV2ServiceRole> localVarResp = updateRoleWithHttpInfo(serviceSid, sid, permission);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChatV2ServiceRole> updateRoleWithHttpInfo(String serviceSid, String sid, List<String> permission) throws ApiException {
     ...
     */
    public okhttp3.Call updateRoleAsync(String serviceSid, String sid, List<String> permission, final ApiCallback<ChatV2ServiceRole> _callback) throws ApiException {
