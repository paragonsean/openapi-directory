...
public class ChatV2InviteApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ChatV2InviteApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ChatV2InviteApi(ApiClient apiClient) {
     ...
     * @param serviceSid The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to create the Invite resource under. (required)
     * @param channelSid The SID of the [Channel](https://www.twilio.com/docs/chat/channels) the new Invite resource belongs to. This value can be the Channel resource&#39;s &#x60;sid&#x60; or &#x60;unique_name&#x60;. (required)
     ...
     * @param roleSid The SID of the [Role](https://www.twilio.com/docs/chat/rest/role-resource) assigned to the new member. (optional)
     ...
     */
    public ChatV2ServiceChannelInvite createInvite(String serviceSid, String channelSid, String identity, String roleSid) throws ApiException {
        ApiResponse<ChatV2ServiceChannelInvite> localVarResp = createInviteWithHttpInfo(serviceSid, channelSid, identity, roleSid);
     ...
     * @param identity The &#x60;identity&#x60; value that uniquely identifies the new resource&#39;s [User](https://www.twilio.com/docs/chat/rest/user-resource) within the [Service](https://www.twilio.com/docs/chat/rest/service-resource). See [access tokens](https://www.twilio.com/docs/chat/create-tokens) for more info. (required)
     * @param roleSid The SID of the [Role](https://www.twilio.com/docs/chat/rest/role-resource) assigned to the new member. (optional)
     * @return ApiResponse&lt;ChatV2ServiceChannelInvite&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ChatV2ServiceChannelInvite> createInviteWithHttpInfo(String serviceSid, String channelSid, String identity, String roleSid) throws ApiException {
        okhttp3.Call localVarCall = createInviteValidateBeforeCall(serviceSid, channelSid, identity, roleSid, null);
        Type localVarReturnType = new TypeToken<ChatV2ServiceChannelInvite>(){}.getType();
     ...
     */
    public okhttp3.Call createInviteAsync(String serviceSid, String channelSid, String identity, String roleSid, final ApiCallback<ChatV2ServiceChannelInvite> _callback) throws ApiException {
     ...
     * @param serviceSid The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to delete the Invite resource from. (required)
     * @param channelSid The SID of the [Channel](https://www.twilio.com/docs/chat/channels) the Invite resource to delete belongs to. This value can be the Channel resource&#39;s &#x60;sid&#x60; or &#x60;unique_name&#x60;. (required)
     * @param sid The SID of the Invite resource to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param serviceSid The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to fetch the Invite resource from. (required)
     * @param channelSid The SID of the [Channel](https://www.twilio.com/docs/chat/channels) the Invite resource to fetch belongs to. This value can be the Channel resource&#39;s &#x60;sid&#x60; or &#x60;unique_name&#x60;. (required)
     * @param sid The SID of the Invite resource to fetch. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public ChatV2ServiceChannelInvite fetchInvite(String serviceSid, String channelSid, String sid) throws ApiException {
        ApiResponse<ChatV2ServiceChannelInvite> localVarResp = fetchInviteWithHttpInfo(serviceSid, channelSid, sid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChatV2ServiceChannelInvite> fetchInviteWithHttpInfo(String serviceSid, String channelSid, String sid) throws ApiException {
     ...
     */
    public okhttp3.Call fetchInviteAsync(String serviceSid, String channelSid, String sid, final ApiCallback<ChatV2ServiceChannelInvite> _callback) throws ApiException {
     ...
     * @param serviceSid The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to read the Invite resources from. (required)
     * @param channelSid The SID of the [Channel](https://www.twilio.com/docs/chat/channels) the Invite resources to read belong to. This value can be the Channel resource&#39;s &#x60;sid&#x60; or &#x60;unique_name&#x60;. (required)
     * @param identity The [User](https://www.twilio.com/docs/chat/rest/user-resource)&#39;s &#x60;identity&#x60; value of the resources to read. See [access tokens](https://www.twilio.com/docs/chat/create-tokens) for more details. (optional)
