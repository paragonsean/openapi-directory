...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV2ServiceBinding();
  });
  ...
  describe('ChatV2ServiceBinding', function() {
    it('should create an instance of ChatV2ServiceBinding', function() {
      // uncomment below and update the code to test ChatV2ServiceBinding
      //var instance = new TwilioChat.ChatV2ServiceBinding();
      //expect(instance).to.be.a(TwilioChat.ChatV2ServiceBinding);
    });
