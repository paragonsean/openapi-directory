...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV2ServiceUser();
  });
  ...
  describe('ChatV2ServiceUser', function() {
    it('should create an instance of ChatV2ServiceUser', function() {
      // uncomment below and update the code to test ChatV2ServiceUser
      //var instance = new TwilioChat.ChatV2ServiceUser();
      //expect(instance).to.be.a(TwilioChat.ChatV2ServiceUser);
    });
