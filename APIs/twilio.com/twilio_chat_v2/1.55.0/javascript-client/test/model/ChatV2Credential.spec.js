...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV2Credential();
  });
  ...
  describe('ChatV2Credential', function() {
    it('should create an instance of ChatV2Credential', function() {
      // uncomment below and update the code to test ChatV2Credential
      //var instance = new TwilioChat.ChatV2Credential();
      //expect(instance).to.be.a(TwilioChat.ChatV2Credential);
    });
