...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV2ServiceChannelChannelWebhook();
  });
  ...
  describe('ChatV2ServiceChannelChannelWebhook', function() {
    it('should create an instance of ChatV2ServiceChannelChannelWebhook', function() {
      // uncomment below and update the code to test ChatV2ServiceChannelChannelWebhook
      //var instance = new TwilioChat.ChatV2ServiceChannelChannelWebhook();
      //expect(instance).to.be.a(TwilioChat.ChatV2ServiceChannelChannelWebhook);
    });
