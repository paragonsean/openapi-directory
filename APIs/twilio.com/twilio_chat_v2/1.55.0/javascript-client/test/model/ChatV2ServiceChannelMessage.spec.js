...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV2ServiceChannelMessage();
  });
  ...
  describe('ChatV2ServiceChannelMessage', function() {
    it('should create an instance of ChatV2ServiceChannelMessage', function() {
      // uncomment below and update the code to test ChatV2ServiceChannelMessage
      //var instance = new TwilioChat.ChatV2ServiceChannelMessage();
      //expect(instance).to.be.a(TwilioChat.ChatV2ServiceChannelMessage);
    });
