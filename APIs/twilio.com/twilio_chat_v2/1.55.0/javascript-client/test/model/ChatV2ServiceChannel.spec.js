...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV2ServiceChannel();
  });
  ...
  describe('ChatV2ServiceChannel', function() {
    it('should create an instance of ChatV2ServiceChannel', function() {
      // uncomment below and update the code to test ChatV2ServiceChannel
      //var instance = new TwilioChat.ChatV2ServiceChannel();
      //expect(instance).to.be.a(TwilioChat.ChatV2ServiceChannel);
    });
