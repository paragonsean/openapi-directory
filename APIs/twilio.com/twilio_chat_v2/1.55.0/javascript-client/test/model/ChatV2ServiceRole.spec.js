...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV2ServiceRole();
  });
  ...
  describe('ChatV2ServiceRole', function() {
    it('should create an instance of ChatV2ServiceRole', function() {
      // uncomment below and update the code to test ChatV2ServiceRole
      //var instance = new TwilioChat.ChatV2ServiceRole();
      //expect(instance).to.be.a(TwilioChat.ChatV2ServiceRole);
    });
