...
/**
 * The ChatV2Credential model module.
 * @module model/ChatV2Credential
 * @version 1.55.0
 */
class ChatV2Credential {
    /**
     * Constructs a new <code>ChatV2Credential</code>.
     * @alias module:model/ChatV2Credential
     */
    constructor() { 
        
        ChatV2Credential.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChatV2Credential</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChatV2Credential} obj Optional instance to populate.
     * @return {module:model/ChatV2Credential} The populated <code>ChatV2Credential</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChatV2Credential();
    ...
    /**
     * Validates the JSON data with respect to <code>ChatV2Credential</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChatV2Credential</code>.
     */
 ...
 */
ChatV2Credential.prototype['account_sid'] = undefined;

/**
 * The date and time in GMT when the resource was created specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_created
 */
ChatV2Credential.prototype['date_created'] = undefined;

/**
 * The date and time in GMT when the resource was last updated specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_updated
 */
ChatV2Credential.prototype['date_updated'] = undefined;

/**
 * The string that you assigned to describe the resource.
 * @member {String} friendly_name
 */
ChatV2Credential.prototype['friendly_name'] = undefined;

/**
 * [APN only] Whether to send the credential to sandbox APNs. Can be `true` to send to sandbox APNs or `false` to send to production.
 * @member {String} sandbox
 */
ChatV2Credential.prototype['sandbox'] = undefined;

/**
 * The unique string that we created to identify the Credential resource.
 * @member {String} sid
 */
ChatV2Credential.prototype['sid'] = undefined;

/**
 * @member {module:model/CredentialEnumPushService} type
 */
ChatV2Credential.prototype['type'] = undefined;

/**
 * The absolute URL of the Credential resource.
 * @member {String} url
 */
ChatV2Credential.prototype['url'] = undefined;
...
export default ChatV2Credential;
