...
/**
 * The ChatV2ServiceRole model module.
 * @module model/ChatV2ServiceRole
 * @version 1.55.0
 */
class ChatV2ServiceRole {
    /**
     * Constructs a new <code>ChatV2ServiceRole</code>.
     * @alias module:model/ChatV2ServiceRole
     */
    constructor() { 
        
        ChatV2ServiceRole.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChatV2ServiceRole</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChatV2ServiceRole} obj Optional instance to populate.
     * @return {module:model/ChatV2ServiceRole} The populated <code>ChatV2ServiceRole</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChatV2ServiceRole();
    ...
    /**
     * Validates the JSON data with respect to <code>ChatV2ServiceRole</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChatV2ServiceRole</code>.
     */
 ...
 */
ChatV2ServiceRole.prototype['account_sid'] = undefined;

/**
 * The date and time in GMT when the resource was created specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_created
 */
ChatV2ServiceRole.prototype['date_created'] = undefined;

/**
 * The date and time in GMT when the resource was last updated specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_updated
 */
ChatV2ServiceRole.prototype['date_updated'] = undefined;

/**
 * The string that you assigned to describe the resource.
 * @member {String} friendly_name
 */
ChatV2ServiceRole.prototype['friendly_name'] = undefined;

/**
 * An array of the permissions the role has been granted.
 * @member {Array.<String>} permissions
 */
ChatV2ServiceRole.prototype['permissions'] = undefined;
 ...
 */
ChatV2ServiceRole.prototype['service_sid'] = undefined;

/**
 * The unique string that we created to identify the Role resource.
 * @member {String} sid
 */
ChatV2ServiceRole.prototype['sid'] = undefined;

/**
 * @member {module:model/RoleEnumRoleType} type
 */
ChatV2ServiceRole.prototype['type'] = undefined;

/**
 * The absolute URL of the Role resource.
 * @member {String} url
 */
ChatV2ServiceRole.prototype['url'] = undefined;
...
export default ChatV2ServiceRole;
