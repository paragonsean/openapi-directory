...
class ListUserResponse(Model):
    ...
    def __init__(self, meta: ListCredentialResponseMeta=None, users: List[ChatV2ServiceUser]=None):
    ...
    def users(self, users):
        ...
        :param users: The users of this ListUserResponse.
        :type users: List[ChatV2ServiceUser]
        """
