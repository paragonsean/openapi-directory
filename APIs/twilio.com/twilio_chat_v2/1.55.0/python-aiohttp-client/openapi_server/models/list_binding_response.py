...
class ListBindingResponse(Model):
    ...
    def __init__(self, bindings: List[ChatV2ServiceBinding]=None, meta: ListCredentialResponseMeta=None):
        ...
        """
        self.openapi_types = {
            'bindings': List[ChatV2ServiceBinding],
    ...
    def bindings(self):
        ...
        :rtype: List[ChatV2ServiceBinding]
        """
    ...
    def bindings(self, bindings):
        ...
        :param bindings: The bindings of this ListBindingResponse.
        :type bindings: List[ChatV2ServiceBinding]
        """
