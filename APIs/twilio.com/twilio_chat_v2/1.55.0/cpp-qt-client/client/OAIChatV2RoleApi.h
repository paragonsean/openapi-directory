...
#ifndef OAI_OAIChatV2RoleApi_H
#define OAI_OAIChatV2RoleApi_H
...
class OAIChatV2RoleApi : public QObject {
    Q_OBJECT

public:
    OAIChatV2RoleApi(const int timeOut = 0);
    ~OAIChatV2RoleApi();
...
Q_SIGNALS:
    ...
    void createRoleSignal(OAIChat_v2_service_role summary);
    void deleteRoleSignal();
    void fetchRoleSignal(OAIChat_v2_service_role summary);
    void listRoleSignal(OAIListRoleResponse summary);
    void updateRoleSignal(OAIChat_v2_service_role summary);


    void createRoleSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_service_role summary);
    void deleteRoleSignalFull(OAIHttpRequestWorker *worker);
    void fetchRoleSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_service_role summary);
    void listRoleSignalFull(OAIHttpRequestWorker *worker, OAIListRoleResponse summary);
    void updateRoleSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_service_role summary);

    Q_DECL_DEPRECATED_X("Use createRoleSignalError() instead")
    void createRoleSignalE(OAIChat_v2_service_role summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createRoleSignalError(OAIChat_v2_service_role summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchRoleSignalE(OAIChat_v2_service_role summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchRoleSignalError(OAIChat_v2_service_role summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateRoleSignalE(OAIChat_v2_service_role summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateRoleSignalError(OAIChat_v2_service_role summary, QNetworkReply::NetworkError error_type, const QString &error_str);
