...
/*
 * OAIChat_v2_service_channel_member.h
 *
 * 
 */

#ifndef OAIChat_v2_service_channel_member_H
#define OAIChat_v2_service_channel_member_H
...
class OAIChat_v2_service_channel_member : public OAIObject {
public:
    OAIChat_v2_service_channel_member();
    OAIChat_v2_service_channel_member(QString json);
    ~OAIChat_v2_service_channel_member() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v2_service_channel_member)

#endif // OAIChat_v2_service_channel_member_H
