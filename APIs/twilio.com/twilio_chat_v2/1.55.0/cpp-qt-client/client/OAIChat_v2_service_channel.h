...
/*
 * OAIChat_v2_service_channel.h
 *
 * 
 */

#ifndef OAIChat_v2_service_channel_H
#define OAIChat_v2_service_channel_H
...
class OAIChat_v2_service_channel : public OAIObject {
public:
    OAIChat_v2_service_channel();
    OAIChat_v2_service_channel(QString json);
    ~OAIChat_v2_service_channel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v2_service_channel)

#endif // OAIChat_v2_service_channel_H
