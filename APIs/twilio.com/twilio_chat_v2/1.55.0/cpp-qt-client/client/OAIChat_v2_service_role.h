...
/*
 * OAIChat_v2_service_role.h
 *
 * 
 */

#ifndef OAIChat_v2_service_role_H
#define OAIChat_v2_service_role_H
...
class OAIChat_v2_service_role : public OAIObject {
public:
    OAIChat_v2_service_role();
    OAIChat_v2_service_role(QString json);
    ~OAIChat_v2_service_role() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v2_service_role)

#endif // OAIChat_v2_service_role_H
