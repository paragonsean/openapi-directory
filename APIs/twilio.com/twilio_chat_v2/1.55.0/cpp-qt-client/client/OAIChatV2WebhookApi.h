...
#ifndef OAI_OAIChatV2WebhookApi_H
#define OAI_OAIChatV2WebhookApi_H
...
class OAIChatV2WebhookApi : public QObject {
    Q_OBJECT

public:
    OAIChatV2WebhookApi(const int timeOut = 0);
    ~OAIChatV2WebhookApi();
...
Q_SIGNALS:
    ...
    void createChannelWebhookSignal(OAIChat_v2_service_channel_channel_webhook summary);
    void deleteChannelWebhookSignal();
    void fetchChannelWebhookSignal(OAIChat_v2_service_channel_channel_webhook summary);
    void listChannelWebhookSignal(OAIListChannelWebhookResponse summary);
    void updateChannelWebhookSignal(OAIChat_v2_service_channel_channel_webhook summary);


    void createChannelWebhookSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_service_channel_channel_webhook summary);
    void deleteChannelWebhookSignalFull(OAIHttpRequestWorker *worker);
    void fetchChannelWebhookSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_service_channel_channel_webhook summary);
    void listChannelWebhookSignalFull(OAIHttpRequestWorker *worker, OAIListChannelWebhookResponse summary);
    void updateChannelWebhookSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_service_channel_channel_webhook summary);

    Q_DECL_DEPRECATED_X("Use createChannelWebhookSignalError() instead")
    void createChannelWebhookSignalE(OAIChat_v2_service_channel_channel_webhook summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createChannelWebhookSignalError(OAIChat_v2_service_channel_channel_webhook summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchChannelWebhookSignalE(OAIChat_v2_service_channel_channel_webhook summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchChannelWebhookSignalError(OAIChat_v2_service_channel_channel_webhook summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateChannelWebhookSignalE(OAIChat_v2_service_channel_channel_webhook summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateChannelWebhookSignalError(OAIChat_v2_service_channel_channel_webhook summary, QNetworkReply::NetworkError error_type, const QString &error_str);
