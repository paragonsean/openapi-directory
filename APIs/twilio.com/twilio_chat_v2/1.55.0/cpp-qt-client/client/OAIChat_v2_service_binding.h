...
/*
 * OAIChat_v2_service_binding.h
 *
 * 
 */

#ifndef OAIChat_v2_service_binding_H
#define OAIChat_v2_service_binding_H
...
class OAIChat_v2_service_binding : public OAIObject {
public:
    OAIChat_v2_service_binding();
    OAIChat_v2_service_binding(QString json);
    ~OAIChat_v2_service_binding() override;
    ...
    OAIBinding_enum_binding_type getBindingType() const;
    void setBindingType(const OAIBinding_enum_binding_type &binding_type);
...
private:
    ...
    OAIBinding_enum_binding_type m_binding_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v2_service_binding)

#endif // OAIChat_v2_service_binding_H
