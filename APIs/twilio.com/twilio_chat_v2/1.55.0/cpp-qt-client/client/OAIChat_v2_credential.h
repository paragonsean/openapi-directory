...
/*
 * OAIChat_v2_credential.h
 *
 * 
 */

#ifndef OAIChat_v2_credential_H
#define OAIChat_v2_credential_H
...
class OAIChat_v2_credential : public OAIObject {
public:
    OAIChat_v2_credential();
    OAIChat_v2_credential(QString json);
    ~OAIChat_v2_credential() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v2_credential)

#endif // OAIChat_v2_credential_H
