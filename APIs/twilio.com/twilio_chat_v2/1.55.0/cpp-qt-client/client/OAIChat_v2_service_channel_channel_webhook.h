...
/*
 * OAIChat_v2_service_channel_channel_webhook.h
 *
 * 
 */

#ifndef OAIChat_v2_service_channel_channel_webhook_H
#define OAIChat_v2_service_channel_channel_webhook_H
...
class OAIChat_v2_service_channel_channel_webhook : public OAIObject {
public:
    OAIChat_v2_service_channel_channel_webhook();
    OAIChat_v2_service_channel_channel_webhook(QString json);
    ~OAIChat_v2_service_channel_channel_webhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v2_service_channel_channel_webhook)

#endif // OAIChat_v2_service_channel_channel_webhook_H
