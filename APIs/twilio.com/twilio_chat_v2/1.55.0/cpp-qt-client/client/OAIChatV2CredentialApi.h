...
#ifndef OAI_OAIChatV2CredentialApi_H
#define OAI_OAIChatV2CredentialApi_H
...
class OAIChatV2CredentialApi : public QObject {
    Q_OBJECT

public:
    OAIChatV2CredentialApi(const int timeOut = 0);
    ~OAIChatV2CredentialApi();
...
Q_SIGNALS:
    ...
    void createCredentialSignal(OAIChat_v2_credential summary);
    void deleteCredentialSignal();
    void fetchCredentialSignal(OAIChat_v2_credential summary);
    void listCredentialSignal(OAIListCredentialResponse summary);
    void updateCredentialSignal(OAIChat_v2_credential summary);


    void createCredentialSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_credential summary);
    void deleteCredentialSignalFull(OAIHttpRequestWorker *worker);
    void fetchCredentialSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_credential summary);
    void listCredentialSignalFull(OAIHttpRequestWorker *worker, OAIListCredentialResponse summary);
    void updateCredentialSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_credential summary);

    Q_DECL_DEPRECATED_X("Use createCredentialSignalError() instead")
    void createCredentialSignalE(OAIChat_v2_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createCredentialSignalError(OAIChat_v2_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchCredentialSignalE(OAIChat_v2_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchCredentialSignalError(OAIChat_v2_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateCredentialSignalE(OAIChat_v2_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateCredentialSignalError(OAIChat_v2_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
