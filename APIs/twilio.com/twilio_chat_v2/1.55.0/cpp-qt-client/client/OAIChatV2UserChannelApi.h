...
#ifndef OAI_OAIChatV2UserChannelApi_H
#define OAI_OAIChatV2UserChannelApi_H
...
#include "OAIUser_channel_enum_webhook_enabled_type.h"
#include <QString>
#include <QDateTime>
...
class OAIChatV2UserChannelApi : public QObject {
    Q_OBJECT

public:
    OAIChatV2UserChannelApi(const int timeOut = 0);
    ~OAIChatV2UserChannelApi();
    ...
    * @param[in]  x_twilio_webhook_enabled OAIUser_channel_enum_webhook_enabled_type [optional]
    */
    virtual void deleteUserChannel(const QString &service_sid, const QString &user_sid, const QString &channel_sid, const ::OpenAPI::OptionalParam<OAIUser_channel_enum_webhook_enabled_type> &x_twilio_webhook_enabled = ::OpenAPI::OptionalParam<OAIUser_channel_enum_webhook_enabled_type>());
...
Q_SIGNALS:
    ...
    void fetchUserChannelSignal(OAIChat_v2_service_user_user_channel summary);
    void listUserChannelSignal(OAIListUserChannelResponse summary);
    void updateUserChannelSignal(OAIChat_v2_service_user_user_channel summary);


    void deleteUserChannelSignalFull(OAIHttpRequestWorker *worker);
    void fetchUserChannelSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_service_user_user_channel summary);
    void listUserChannelSignalFull(OAIHttpRequestWorker *worker, OAIListUserChannelResponse summary);
    void updateUserChannelSignalFull(OAIHttpRequestWorker *worker, OAIChat_v2_service_user_user_channel summary);
    ...
    void fetchUserChannelSignalE(OAIChat_v2_service_user_user_channel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchUserChannelSignalError(OAIChat_v2_service_user_user_channel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateUserChannelSignalE(OAIChat_v2_service_user_user_channel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateUserChannelSignalError(OAIChat_v2_service_user_user_channel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
