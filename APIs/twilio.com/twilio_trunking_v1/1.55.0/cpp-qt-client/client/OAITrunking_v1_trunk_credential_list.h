...
/*
 * OAITrunking_v1_trunk_credential_list.h
 *
 * 
 */

#ifndef OAITrunking_v1_trunk_credential_list_H
#define OAITrunking_v1_trunk_credential_list_H
...
class OAITrunking_v1_trunk_credential_list : public OAIObject {
public:
    OAITrunking_v1_trunk_credential_list();
    OAITrunking_v1_trunk_credential_list(QString json);
    ~OAITrunking_v1_trunk_credential_list() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrunking_v1_trunk_credential_list)

#endif // OAITrunking_v1_trunk_credential_list_H
