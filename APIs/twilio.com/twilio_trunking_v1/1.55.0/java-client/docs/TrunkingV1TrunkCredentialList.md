...
|------------ | ------------- | ------------- | -------------|
|**accountSid** | **String** | The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the CredentialList resource. |  [optional] |
...
|**sid** | **String** | The unique string that we created to identify the CredentialList resource. |  [optional] |
