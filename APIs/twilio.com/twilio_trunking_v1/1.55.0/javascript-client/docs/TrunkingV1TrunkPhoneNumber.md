# TwilioTrunking.TrunkingV1TrunkPhoneNumber
...
**addressRequirements** | [**PhoneNumberEnumAddressRequirement**](PhoneNumberEnumAddressRequirement.md) |  | [optional] 
...
**smsFallbackUrl** | **String** | The URL that we call using the &#x60;sms_fallback_method&#x60; when an error occurs while retrieving or executing the TwiML from &#x60;sms_url&#x60;. | [optional] 
**smsMethod** | **String** | The HTTP method we use to call &#x60;sms_url&#x60;. Can be: &#x60;GET&#x60; or &#x60;POST&#x60;. | [optional] 
**smsUrl** | **String** | The URL we call using the &#x60;sms_method&#x60; when the phone number receives an incoming SMS message. | [optional] 
...
**voiceFallbackMethod** | **String** | The HTTP method that we use to call &#x60;voice_fallback_url&#x60;. Can be: &#x60;GET&#x60; or &#x60;POST&#x60;. | [optional] 
**voiceFallbackUrl** | **String** | The URL that we call using the &#x60;voice_fallback_method&#x60; when an error occurs retrieving or executing the TwiML requested by &#x60;url&#x60;. | [optional] 
**voiceMethod** | **String** | The HTTP method we use to call &#x60;voice_url&#x60;. Can be: &#x60;GET&#x60; or &#x60;POST&#x60;. | [optional] 
**voiceUrl** | **String** | The URL we call using the &#x60;voice_method&#x60; when the phone number receives a call. The &#x60;voice_url&#x60; is not be used if a &#x60;voice_application_sid&#x60; or a &#x60;trunk_sid&#x60; is set. | [optional] 
