...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioTrunking.TrunkingV1TrunkCredentialList();
  });
  ...
  describe('TrunkingV1TrunkCredentialList', function() {
    it('should create an instance of TrunkingV1TrunkCredentialList', function() {
      // uncomment below and update the code to test TrunkingV1TrunkCredentialList
      //var instance = new TwilioTrunking.TrunkingV1TrunkCredentialList();
      //expect(instance).to.be.a(TwilioTrunking.TrunkingV1TrunkCredentialList);
    });
