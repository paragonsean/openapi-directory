...
|**end** | **OffsetDateTime** | The date that the record ended, given as GMT in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format. |  [optional] |
...
|**lastUpdated** | **OffsetDateTime** | The date that the resource was last updated, given as GMT in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format. |  [optional] |
...
|**packetsDownloaded** | **Integer** | The number of packets downloaded by the device between the &#x60;start&#x60; time and when the Data Session was last updated. |  [optional] |
|**packetsUploaded** | **Integer** | The number of packets uploaded by the device between the &#x60;start&#x60; time and when the Data Session was last updated. |  [optional] |
...
|**start** | **OffsetDateTime** | The date that the Data Session started, given as GMT in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format. |  [optional] |
