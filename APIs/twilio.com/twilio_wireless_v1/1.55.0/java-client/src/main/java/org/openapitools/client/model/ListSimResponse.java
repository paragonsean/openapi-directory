...
public class ListSimResponse {
  ...
  private List<WirelessV1Sim> sims = new ArrayList<>();

  public ListSimResponse() {
  }

  public ListSimResponse meta(ListCommandResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public ListSimResponse sims(List<WirelessV1Sim> sims) {
    this.sims = sims;
    return this;
  }

  public ListSimResponse addSimsItem(WirelessV1Sim simsItem) {
    if (this.sims == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<WirelessV1Sim> getSims() {
    return sims;
  }

  public void setSims(List<WirelessV1Sim> sims) {
    this.sims = sims;
  }
      ...
      if (jsonObj.get("sims") != null && !jsonObj.get("sims").isJsonNull()) {
        ...
        if (jsonArraysims != null) {
          ...
          for (int i = 0; i < jsonArraysims.size(); i++) {
            WirelessV1Sim.validateJsonElement(jsonArraysims.get(i));
          };
        }
      }
  }
