...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioWireless.WirelessV1Command();
  });
  ...
  describe('WirelessV1Command', function() {
    it('should create an instance of WirelessV1Command', function() {
      // uncomment below and update the code to test WirelessV1Command
      //var instance = new TwilioWireless.WirelessV1Command();
      //expect(instance).to.be.a(TwilioWireless.WirelessV1Command);
    });
    ...
    it('should have the property commandMode (base name: "command_mode")', function() {
      // uncomment below and update the code to test the property commandMode
      //var instance = new TwilioWireless.WirelessV1Command();
      //expect(instance).to.be();
    });
    ...
    it('should have the property deliveryReceiptRequested (base name: "delivery_receipt_requested")', function() {
      // uncomment below and update the code to test the property deliveryReceiptRequested
      //var instance = new TwilioWireless.WirelessV1Command();
      //expect(instance).to.be();
    });
