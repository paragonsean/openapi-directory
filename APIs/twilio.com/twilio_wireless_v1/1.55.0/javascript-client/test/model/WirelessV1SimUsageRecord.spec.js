...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioWireless.WirelessV1SimUsageRecord();
  });
  ...
  describe('WirelessV1SimUsageRecord', function() {
    it('should create an instance of WirelessV1SimUsageRecord', function() {
      // uncomment below and update the code to test WirelessV1SimUsageRecord
      //var instance = new TwilioWireless.WirelessV1SimUsageRecord();
      //expect(instance).to.be.a(TwilioWireless.WirelessV1SimUsageRecord);
    });
