...
/**
 * The ChatV1Service model module.
 * @module model/ChatV1Service
 * @version 1.55.0
 */
class ChatV1Service {
    /**
     * Constructs a new <code>ChatV1Service</code>.
     * @alias module:model/ChatV1Service
     */
    constructor() { 
        
        ChatV1Service.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChatV1Service</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChatV1Service} obj Optional instance to populate.
     * @return {module:model/ChatV1Service} The populated <code>ChatV1Service</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChatV1Service();
    ...
    /**
     * Validates the JSON data with respect to <code>ChatV1Service</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChatV1Service</code>.
     */
 ...
 */
ChatV1Service.prototype['account_sid'] = undefined;

/**
 * DEPRECATED. The interval in seconds between consumption reports submission batches from client endpoints.
 * @member {Number} consumption_report_interval
 */
ChatV1Service.prototype['consumption_report_interval'] = undefined;
 ...
 */
ChatV1Service.prototype['date_created'] = undefined;
 ...
 */
ChatV1Service.prototype['date_updated'] = undefined;
 ...
 */
ChatV1Service.prototype['default_channel_creator_role_sid'] = undefined;
 ...
 */
ChatV1Service.prototype['default_channel_role_sid'] = undefined;
 ...
 */
ChatV1Service.prototype['default_service_role_sid'] = undefined;

/**
 * The string that you assigned to describe the resource.
 * @member {String} friendly_name
 */
ChatV1Service.prototype['friendly_name'] = undefined;

/**
 * An object that describes the limits of the service instance. The `limits` object contains  `channel_members` to describe the members/channel limit and `user_channels` to describe the channels/user limit. `channel_members` can be 1,000 or less, with a default of 250. `user_channels` can be 1,000 or less, with a default value of 100.
 * @member {Object} limits
 */
ChatV1Service.prototype['limits'] = undefined;
 ...
 * @member {Object} links
 */
ChatV1Service.prototype['links'] = undefined;
 ...
 */
ChatV1Service.prototype['notifications'] = undefined;
 ...
 */
ChatV1Service.prototype['post_webhook_url'] = undefined;
 ...
 */
ChatV1Service.prototype['pre_webhook_url'] = undefined;
 ...
 */
ChatV1Service.prototype['reachability_enabled'] = undefined;
 ...
 */
ChatV1Service.prototype['read_status_enabled'] = undefined;

/**
 * The unique string that we created to identify the Service resource.
 * @member {String} sid
 */
ChatV1Service.prototype['sid'] = undefined;

/**
 * How long in seconds after a `started typing` event until clients should assume that user is no longer typing, even if no `ended typing` message was received.  The default is 5 seconds.
 * @member {Number} typing_indicator_timeout
 */
ChatV1Service.prototype['typing_indicator_timeout'] = undefined;

/**
 * The absolute URL of the Service resource.
 * @member {String} url
 */
ChatV1Service.prototype['url'] = undefined;

/**
 * The list of WebHook events that are enabled for this Service instance. See [Webhook Events](https://www.twilio.com/docs/chat/webhook-events) for more details.
 * @member {Array.<String>} webhook_filters
 */
ChatV1Service.prototype['webhook_filters'] = undefined;
 ...
 */
ChatV1Service.prototype['webhook_method'] = undefined;

/**
 * An object that contains information about the webhooks configured for this service.
 * @member {Object} webhooks
 */
ChatV1Service.prototype['webhooks'] = undefined;
