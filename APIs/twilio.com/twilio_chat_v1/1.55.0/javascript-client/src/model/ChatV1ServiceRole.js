...
/**
 * The ChatV1ServiceRole model module.
 * @module model/ChatV1ServiceRole
 * @version 1.55.0
 */
class ChatV1ServiceRole {
    /**
     * Constructs a new <code>ChatV1ServiceRole</code>.
     * @alias module:model/ChatV1ServiceRole
     */
    constructor() { 
        
        ChatV1ServiceRole.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChatV1ServiceRole</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChatV1ServiceRole} obj Optional instance to populate.
     * @return {module:model/ChatV1ServiceRole} The populated <code>ChatV1ServiceRole</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChatV1ServiceRole();
    ...
    /**
     * Validates the JSON data with respect to <code>ChatV1ServiceRole</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChatV1ServiceRole</code>.
     */
 ...
 */
ChatV1ServiceRole.prototype['account_sid'] = undefined;
 ...
 */
ChatV1ServiceRole.prototype['date_created'] = undefined;
 ...
 */
ChatV1ServiceRole.prototype['date_updated'] = undefined;

/**
 * The string that you assigned to describe the resource.
 * @member {String} friendly_name
 */
ChatV1ServiceRole.prototype['friendly_name'] = undefined;

/**
 * An array of the permissions the role has been granted, formatted as a JSON string.
 * @member {Array.<String>} permissions
 */
ChatV1ServiceRole.prototype['permissions'] = undefined;
 ...
 */
ChatV1ServiceRole.prototype['service_sid'] = undefined;

/**
 * The unique string that we created to identify the Role resource.
 * @member {String} sid
 */
ChatV1ServiceRole.prototype['sid'] = undefined;

/**
 * @member {module:model/RoleEnumRoleType} type
 */
ChatV1ServiceRole.prototype['type'] = undefined;

/**
 * The absolute URL of the Role resource.
 * @member {String} url
 */
ChatV1ServiceRole.prototype['url'] = undefined;
...
export default ChatV1ServiceRole;
