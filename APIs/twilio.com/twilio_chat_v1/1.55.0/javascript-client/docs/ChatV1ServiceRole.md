# TwilioChat.ChatV1ServiceRole

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountSid** | **String** | The SID of the [Account](https://www.twilio.com/docs/api/rest/account) that created the Role resource. | [optional] 
...
**permissions** | **[String]** | An array of the permissions the role has been granted, formatted as a JSON string. | [optional] 
...
**type** | [**RoleEnumRoleType**](RoleEnumRoleType.md) |  | [optional] 
