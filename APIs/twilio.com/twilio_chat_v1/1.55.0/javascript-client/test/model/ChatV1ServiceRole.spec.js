...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV1ServiceRole();
  });
  ...
  describe('ChatV1ServiceRole', function() {
    it('should create an instance of ChatV1ServiceRole', function() {
      // uncomment below and update the code to test ChatV1ServiceRole
      //var instance = new TwilioChat.ChatV1ServiceRole();
      //expect(instance).to.be.a(TwilioChat.ChatV1ServiceRole);
    });
