...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV1ServiceChannelInvite();
  });
  ...
  describe('ChatV1ServiceChannelInvite', function() {
    it('should create an instance of ChatV1ServiceChannelInvite', function() {
      // uncomment below and update the code to test ChatV1ServiceChannelInvite
      //var instance = new TwilioChat.ChatV1ServiceChannelInvite();
      //expect(instance).to.be.a(TwilioChat.ChatV1ServiceChannelInvite);
    });
