...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV1ServiceUser();
  });
  ...
  describe('ChatV1ServiceUser', function() {
    it('should create an instance of ChatV1ServiceUser', function() {
      // uncomment below and update the code to test ChatV1ServiceUser
      //var instance = new TwilioChat.ChatV1ServiceUser();
      //expect(instance).to.be.a(TwilioChat.ChatV1ServiceUser);
    });
