...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV1Credential();
  });
  ...
  describe('ChatV1Credential', function() {
    it('should create an instance of ChatV1Credential', function() {
      // uncomment below and update the code to test ChatV1Credential
      //var instance = new TwilioChat.ChatV1Credential();
      //expect(instance).to.be.a(TwilioChat.ChatV1Credential);
    });
