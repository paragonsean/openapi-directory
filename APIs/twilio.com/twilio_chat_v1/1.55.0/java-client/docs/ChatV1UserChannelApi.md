...
import org.openapitools.client.api.ChatV1UserChannelApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ChatV1UserChannelApi apiInstance = new ChatV1UserChannelApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling ChatV1UserChannelApi#listUserChannel");
