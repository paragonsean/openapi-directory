...
public class ChatV1ChannelApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ChatV1ChannelApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ChatV1ChannelApi(ApiClient apiClient) {
     ...
     * @param friendlyName A descriptive string that you create to describe the new resource. It can be up to 64 characters long. (optional)
     * @param type  (optional)
     * @param uniqueName An application-defined string that uniquely identifies the resource. It can be used to address the resource in place of the resource&#39;s &#x60;sid&#x60; in the URL. This value must be 64 characters or less in length and be unique within the Service. (optional)
     ...
     */
    public ChatV1ServiceChannel createChannel(String serviceSid, String attributes, String friendlyName, ChannelEnumChannelType type, String uniqueName) throws ApiException {
        ApiResponse<ChatV1ServiceChannel> localVarResp = createChannelWithHttpInfo(serviceSid, attributes, friendlyName, type, uniqueName);
     ...
     * @param type  (optional)
     * @param uniqueName An application-defined string that uniquely identifies the resource. It can be used to address the resource in place of the resource&#39;s &#x60;sid&#x60; in the URL. This value must be 64 characters or less in length and be unique within the Service. (optional)
     * @return ApiResponse&lt;ChatV1ServiceChannel&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ChatV1ServiceChannel> createChannelWithHttpInfo(String serviceSid, String attributes, String friendlyName, ChannelEnumChannelType type, String uniqueName) throws ApiException {
        okhttp3.Call localVarCall = createChannelValidateBeforeCall(serviceSid, attributes, friendlyName, type, uniqueName, null);
        Type localVarReturnType = new TypeToken<ChatV1ServiceChannel>(){}.getType();
     ...
     */
    public okhttp3.Call createChannelAsync(String serviceSid, String attributes, String friendlyName, ChannelEnumChannelType type, String uniqueName, final ApiCallback<ChatV1ServiceChannel> _callback) throws ApiException {
     ...
     * @param sid The Twilio-provided string that uniquely identifies the Channel resource to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param sid The Twilio-provided string that uniquely identifies the Channel resource to fetch. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public ChatV1ServiceChannel fetchChannel(String serviceSid, String sid) throws ApiException {
        ApiResponse<ChatV1ServiceChannel> localVarResp = fetchChannelWithHttpInfo(serviceSid, sid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChatV1ServiceChannel> fetchChannelWithHttpInfo(String serviceSid, String sid) throws ApiException {
     ...
     */
    public okhttp3.Call fetchChannelAsync(String serviceSid, String sid, final ApiCallback<ChatV1ServiceChannel> _callback) throws ApiException {
     ...
     * @param type The visibility of the Channels to read. Can be: &#x60;public&#x60; or &#x60;private&#x60; and defaults to &#x60;public&#x60;. (optional)
     ...
     * @param sid The Twilio-provided string that uniquely identifies the Channel resource to update. (required)
     * @param attributes A valid JSON string that contains application-specific data. (optional)
     ...
     */
    public ChatV1ServiceChannel updateChannel(String serviceSid, String sid, String attributes, String friendlyName, String uniqueName) throws ApiException {
        ApiResponse<ChatV1ServiceChannel> localVarResp = updateChannelWithHttpInfo(serviceSid, sid, attributes, friendlyName, uniqueName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChatV1ServiceChannel> updateChannelWithHttpInfo(String serviceSid, String sid, String attributes, String friendlyName, String uniqueName) throws ApiException {
     ...
     */
    public okhttp3.Call updateChannelAsync(String serviceSid, String sid, String attributes, String friendlyName, String uniqueName, final ApiCallback<ChatV1ServiceChannel> _callback) throws ApiException {
