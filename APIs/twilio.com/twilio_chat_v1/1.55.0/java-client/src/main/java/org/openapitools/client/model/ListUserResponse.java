...
public class ListUserResponse {
  ...
  private List<ChatV1ServiceUser> users = new ArrayList<>();
  ...
  public ListUserResponse users(List<ChatV1ServiceUser> users) {
    this.users = users;
    return this;
  }

  public ListUserResponse addUsersItem(ChatV1ServiceUser usersItem) {
    if (this.users == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ChatV1ServiceUser> getUsers() {
    return users;
  }

  public void setUsers(List<ChatV1ServiceUser> users) {
    this.users = users;
  }
      ...
      if (jsonObj.get("users") != null && !jsonObj.get("users").isJsonNull()) {
        ...
        if (jsonArrayusers != null) {
          ...
          for (int i = 0; i < jsonArrayusers.size(); i++) {
            ChatV1ServiceUser.validateJsonElement(jsonArrayusers.get(i));
          };
        }
      }
  }
