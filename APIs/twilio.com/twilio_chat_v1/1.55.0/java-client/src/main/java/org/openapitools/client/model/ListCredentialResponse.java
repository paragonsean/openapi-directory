...
public class ListCredentialResponse {
  ...
  private List<ChatV1Credential> credentials = new ArrayList<>();
  ...
  public ListCredentialResponse credentials(List<ChatV1Credential> credentials) {
    this.credentials = credentials;
    return this;
  }

  public ListCredentialResponse addCredentialsItem(ChatV1Credential credentialsItem) {
  ...
  public List<ChatV1Credential> getCredentials() {
    return credentials;
  }

  public void setCredentials(List<ChatV1Credential> credentials) {
    this.credentials = credentials;
  }
      ...
      if (jsonObj.get("credentials") != null && !jsonObj.get("credentials").isJsonNull()) {
        ...
        if (jsonArraycredentials != null) {
          ...
          for (int i = 0; i < jsonArraycredentials.size(); i++) {
            ChatV1Credential.validateJsonElement(jsonArraycredentials.get(i));
          };
        }
      }
