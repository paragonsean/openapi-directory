...
public class ListServiceResponse {
  ...
  private List<ChatV1Service> services = new ArrayList<>();
  ...
  public ListServiceResponse services(List<ChatV1Service> services) {
    this.services = services;
    return this;
  }

  public ListServiceResponse addServicesItem(ChatV1Service servicesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ChatV1Service> getServices() {
    return services;
  }

  public void setServices(List<ChatV1Service> services) {
    this.services = services;
  }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            ChatV1Service.validateJsonElement(jsonArrayservices.get(i));
          };
        }
      }
  }
