...
public class ChatV1InviteApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ChatV1InviteApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ChatV1InviteApi(ApiClient apiClient) {
     ...
     * @param channelSid The SID of the [Channel](https://www.twilio.com/docs/api/chat/rest/channels) the new resource belongs to. (required)
     * @param identity The &#x60;identity&#x60; value that uniquely identifies the new resource&#39;s [User](https://www.twilio.com/docs/api/chat/rest/v1/user) within the [Service](https://www.twilio.com/docs/api/chat/rest/v1/service). See [access tokens](https://www.twilio.com/docs/api/chat/guides/create-tokens) for more info. (required)
     * @param roleSid The SID of the [Role](https://www.twilio.com/docs/api/chat/rest/roles) assigned to the new member. (optional)
     ...
     */
    public ChatV1ServiceChannelInvite createInvite(String serviceSid, String channelSid, String identity, String roleSid) throws ApiException {
        ApiResponse<ChatV1ServiceChannelInvite> localVarResp = createInviteWithHttpInfo(serviceSid, channelSid, identity, roleSid);
     ...
     * @param identity The &#x60;identity&#x60; value that uniquely identifies the new resource&#39;s [User](https://www.twilio.com/docs/api/chat/rest/v1/user) within the [Service](https://www.twilio.com/docs/api/chat/rest/v1/service). See [access tokens](https://www.twilio.com/docs/api/chat/guides/create-tokens) for more info. (required)
     * @param roleSid The SID of the [Role](https://www.twilio.com/docs/api/chat/rest/roles) assigned to the new member. (optional)
     * @return ApiResponse&lt;ChatV1ServiceChannelInvite&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ChatV1ServiceChannelInvite> createInviteWithHttpInfo(String serviceSid, String channelSid, String identity, String roleSid) throws ApiException {
        okhttp3.Call localVarCall = createInviteValidateBeforeCall(serviceSid, channelSid, identity, roleSid, null);
        Type localVarReturnType = new TypeToken<ChatV1ServiceChannelInvite>(){}.getType();
     ...
     */
    public okhttp3.Call createInviteAsync(String serviceSid, String channelSid, String identity, String roleSid, final ApiCallback<ChatV1ServiceChannelInvite> _callback) throws ApiException {
     ...
     * @param channelSid The SID of the [Channel](https://www.twilio.com/docs/api/chat/rest/channels) the resource to delete belongs to. (required)
     * @param sid The Twilio-provided string that uniquely identifies the Invite resource to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param channelSid The SID of the [Channel](https://www.twilio.com/docs/api/chat/rest/channels) the resource to fetch belongs to. (required)
     * @param sid The Twilio-provided string that uniquely identifies the Invite resource to fetch. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public ChatV1ServiceChannelInvite fetchInvite(String serviceSid, String channelSid, String sid) throws ApiException {
        ApiResponse<ChatV1ServiceChannelInvite> localVarResp = fetchInviteWithHttpInfo(serviceSid, channelSid, sid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChatV1ServiceChannelInvite> fetchInviteWithHttpInfo(String serviceSid, String channelSid, String sid) throws ApiException {
     ...
     */
    public okhttp3.Call fetchInviteAsync(String serviceSid, String channelSid, String sid, final ApiCallback<ChatV1ServiceChannelInvite> _callback) throws ApiException {
     ...
     * @param channelSid The SID of the [Channel](https://www.twilio.com/docs/api/chat/rest/channels) the resources to read belong to. (required)
