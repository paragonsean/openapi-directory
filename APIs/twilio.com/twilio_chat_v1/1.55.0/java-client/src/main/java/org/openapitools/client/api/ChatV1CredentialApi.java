...
public class ChatV1CredentialApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ChatV1CredentialApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ChatV1CredentialApi(ApiClient apiClient) {
     ...
     * @param certificate [APN only] The URL encoded representation of the certificate. For example,  &#x60;-----BEGIN CERTIFICATE----- MIIFnTCCBIWgAwIBAgIIAjy9H849+E8wDQYJKoZIhvcNAQEFBQAwgZYxCzAJBgNV.....A&#x3D;&#x3D; -----END CERTIFICATE-----&#x60; (optional)
     ...
     * @param privateKey [APN only] The URL encoded representation of the private key. For example, &#x60;-----BEGIN RSA PRIVATE KEY----- MIIEpQIBAAKCAQEAuyf/lNrH9ck8DmNyo3fGgvCI1l9s+cmBY3WIz+cUDqmxiieR. -----END RSA PRIVATE KEY-----&#x60; (optional)
     ...
     */
    public ChatV1Credential createCredential(CredentialEnumPushService type, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
        ApiResponse<ChatV1Credential> localVarResp = createCredentialWithHttpInfo(type, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
     ...
     * @param sandbox [APN only] Whether to send the credential to sandbox APNs. Can be &#x60;true&#x60; to send to sandbox APNs or &#x60;false&#x60; to send to production. (optional)
     * @param secret [FCM only] The **Server key** of your project from the Firebase console, found under Settings / Cloud messaging. (optional)
     * @return ApiResponse&lt;ChatV1Credential&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ChatV1Credential> createCredentialWithHttpInfo(CredentialEnumPushService type, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ChatV1Credential>(){}.getType();
     ...
     */
    public okhttp3.Call createCredentialAsync(CredentialEnumPushService type, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret, final ApiCallback<ChatV1Credential> _callback) throws ApiException {
     ...
     */
    public ChatV1Credential fetchCredential(String sid) throws ApiException {
        ApiResponse<ChatV1Credential> localVarResp = fetchCredentialWithHttpInfo(sid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChatV1Credential> fetchCredentialWithHttpInfo(String sid) throws ApiException {
     ...
     */
    public okhttp3.Call fetchCredentialAsync(String sid, final ApiCallback<ChatV1Credential> _callback) throws ApiException {
     ...
     */
    public ChatV1Credential updateCredential(String sid, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
        ApiResponse<ChatV1Credential> localVarResp = updateCredentialWithHttpInfo(sid, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ChatV1Credential> updateCredentialWithHttpInfo(String sid, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
     ...
     */
    public okhttp3.Call updateCredentialAsync(String sid, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret, final ApiCallback<ChatV1Credential> _callback) throws ApiException {
