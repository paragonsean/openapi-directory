...
/**
 * API tests for ChatV1ServiceApi
 */
@Disabled
public class ChatV1ServiceApiTest {

    private final ChatV1ServiceApi api = new ChatV1ServiceApi();
    ...
    public void createServiceTest() throws ApiException {
        ...
        ChatV1Service response = api.createService(friendlyName);
    ...
    public void fetchServiceTest() throws ApiException {
        String sid = null;
        ChatV1Service response = api.fetchService(sid);
        // TODO: test validations
    }
