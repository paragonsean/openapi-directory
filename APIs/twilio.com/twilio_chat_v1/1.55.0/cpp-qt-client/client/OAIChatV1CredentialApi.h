...
#ifndef OAI_OAIChatV1CredentialApi_H
#define OAI_OAIChatV1CredentialApi_H
...
class OAIChatV1CredentialApi : public QObject {
    Q_OBJECT

public:
    OAIChatV1CredentialApi(const int timeOut = 0);
    ~OAIChatV1CredentialApi();
...
Q_SIGNALS:
    ...
    void createCredentialSignal(OAIChat_v1_credential summary);
    void deleteCredentialSignal();
    void fetchCredentialSignal(OAIChat_v1_credential summary);
    void listCredentialSignal(OAIListCredentialResponse summary);
    void updateCredentialSignal(OAIChat_v1_credential summary);


    void createCredentialSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_credential summary);
    void deleteCredentialSignalFull(OAIHttpRequestWorker *worker);
    void fetchCredentialSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_credential summary);
    void listCredentialSignalFull(OAIHttpRequestWorker *worker, OAIListCredentialResponse summary);
    void updateCredentialSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_credential summary);

    Q_DECL_DEPRECATED_X("Use createCredentialSignalError() instead")
    void createCredentialSignalE(OAIChat_v1_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createCredentialSignalError(OAIChat_v1_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchCredentialSignalE(OAIChat_v1_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchCredentialSignalError(OAIChat_v1_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateCredentialSignalE(OAIChat_v1_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateCredentialSignalError(OAIChat_v1_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
