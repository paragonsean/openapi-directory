...
/*
 * OAIChat_v1_service_channel_member.h
 *
 * 
 */

#ifndef OAIChat_v1_service_channel_member_H
#define OAIChat_v1_service_channel_member_H
...
class OAIChat_v1_service_channel_member : public OAIObject {
public:
    OAIChat_v1_service_channel_member();
    OAIChat_v1_service_channel_member(QString json);
    ~OAIChat_v1_service_channel_member() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v1_service_channel_member)

#endif // OAIChat_v1_service_channel_member_H
