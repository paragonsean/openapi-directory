...
#ifndef OAI_OAIChatV1UserChannelApi_H
#define OAI_OAIChatV1UserChannelApi_H
...
class OAIChatV1UserChannelApi : public QObject {
    Q_OBJECT

public:
    OAIChatV1UserChannelApi(const int timeOut = 0);
    ~OAIChatV1UserChannelApi();
