...
/*
 * OAIChat_v1_service_channel.h
 *
 * 
 */

#ifndef OAIChat_v1_service_channel_H
#define OAIChat_v1_service_channel_H
...
class OAIChat_v1_service_channel : public OAIObject {
public:
    OAIChat_v1_service_channel();
    OAIChat_v1_service_channel(QString json);
    ~OAIChat_v1_service_channel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v1_service_channel)

#endif // OAIChat_v1_service_channel_H
