...
#ifndef OAI_OAIChatV1ChannelApi_H
#define OAI_OAIChatV1ChannelApi_H
...
class OAIChatV1ChannelApi : public QObject {
    Q_OBJECT

public:
    OAIChatV1ChannelApi(const int timeOut = 0);
    ~OAIChatV1ChannelApi();
...
Q_SIGNALS:
    ...
    void createChannelSignal(OAIChat_v1_service_channel summary);
    void deleteChannelSignal();
    void fetchChannelSignal(OAIChat_v1_service_channel summary);
    void listChannelSignal(OAIListChannelResponse summary);
    void updateChannelSignal(OAIChat_v1_service_channel summary);


    void createChannelSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_service_channel summary);
    void deleteChannelSignalFull(OAIHttpRequestWorker *worker);
    void fetchChannelSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_service_channel summary);
    void listChannelSignalFull(OAIHttpRequestWorker *worker, OAIListChannelResponse summary);
    void updateChannelSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_service_channel summary);

    Q_DECL_DEPRECATED_X("Use createChannelSignalError() instead")
    void createChannelSignalE(OAIChat_v1_service_channel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createChannelSignalError(OAIChat_v1_service_channel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchChannelSignalE(OAIChat_v1_service_channel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchChannelSignalError(OAIChat_v1_service_channel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateChannelSignalE(OAIChat_v1_service_channel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateChannelSignalError(OAIChat_v1_service_channel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
