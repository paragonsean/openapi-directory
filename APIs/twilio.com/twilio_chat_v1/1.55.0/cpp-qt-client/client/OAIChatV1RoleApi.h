...
#ifndef OAI_OAIChatV1RoleApi_H
#define OAI_OAIChatV1RoleApi_H
...
class OAIChatV1RoleApi : public QObject {
    Q_OBJECT

public:
    OAIChatV1RoleApi(const int timeOut = 0);
    ~OAIChatV1RoleApi();
...
Q_SIGNALS:
    ...
    void createRoleSignal(OAIChat_v1_service_role summary);
    void deleteRoleSignal();
    void fetchRoleSignal(OAIChat_v1_service_role summary);
    void listRoleSignal(OAIListRoleResponse summary);
    void updateRoleSignal(OAIChat_v1_service_role summary);


    void createRoleSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_service_role summary);
    void deleteRoleSignalFull(OAIHttpRequestWorker *worker);
    void fetchRoleSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_service_role summary);
    void listRoleSignalFull(OAIHttpRequestWorker *worker, OAIListRoleResponse summary);
    void updateRoleSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_service_role summary);

    Q_DECL_DEPRECATED_X("Use createRoleSignalError() instead")
    void createRoleSignalE(OAIChat_v1_service_role summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createRoleSignalError(OAIChat_v1_service_role summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchRoleSignalE(OAIChat_v1_service_role summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchRoleSignalError(OAIChat_v1_service_role summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateRoleSignalE(OAIChat_v1_service_role summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateRoleSignalError(OAIChat_v1_service_role summary, QNetworkReply::NetworkError error_type, const QString &error_str);
