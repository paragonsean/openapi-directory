...
#ifndef OAI_OAIChatV1UserApi_H
#define OAI_OAIChatV1UserApi_H
...
class OAIChatV1UserApi : public QObject {
    Q_OBJECT

public:
    OAIChatV1UserApi(const int timeOut = 0);
    ~OAIChatV1UserApi();
...
Q_SIGNALS:
    ...
    void createUserSignal(OAIChat_v1_service_user summary);
    void deleteUserSignal();
    void fetchUserSignal(OAIChat_v1_service_user summary);
    void listUserSignal(OAIListUserResponse summary);
    void updateUserSignal(OAIChat_v1_service_user summary);


    void createUserSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_service_user summary);
    void deleteUserSignalFull(OAIHttpRequestWorker *worker);
    void fetchUserSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_service_user summary);
    void listUserSignalFull(OAIHttpRequestWorker *worker, OAIListUserResponse summary);
    void updateUserSignalFull(OAIHttpRequestWorker *worker, OAIChat_v1_service_user summary);

    Q_DECL_DEPRECATED_X("Use createUserSignalError() instead")
    void createUserSignalE(OAIChat_v1_service_user summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createUserSignalError(OAIChat_v1_service_user summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchUserSignalE(OAIChat_v1_service_user summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchUserSignalError(OAIChat_v1_service_user summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateUserSignalE(OAIChat_v1_service_user summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateUserSignalError(OAIChat_v1_service_user summary, QNetworkReply::NetworkError error_type, const QString &error_str);
