...
/*
 * OAIChat_v1_service_channel_message.h
 *
 * 
 */

#ifndef OAIChat_v1_service_channel_message_H
#define OAIChat_v1_service_channel_message_H
...
class OAIChat_v1_service_channel_message : public OAIObject {
public:
    OAIChat_v1_service_channel_message();
    OAIChat_v1_service_channel_message(QString json);
    ~OAIChat_v1_service_channel_message() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v1_service_channel_message)

#endif // OAIChat_v1_service_channel_message_H
