...
/*
 * OAIChat_v1_service_channel_invite.h
 *
 * 
 */

#ifndef OAIChat_v1_service_channel_invite_H
#define OAIChat_v1_service_channel_invite_H
...
class OAIChat_v1_service_channel_invite : public OAIObject {
public:
    OAIChat_v1_service_channel_invite();
    OAIChat_v1_service_channel_invite(QString json);
    ~OAIChat_v1_service_channel_invite() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v1_service_channel_invite)

#endif // OAIChat_v1_service_channel_invite_H
