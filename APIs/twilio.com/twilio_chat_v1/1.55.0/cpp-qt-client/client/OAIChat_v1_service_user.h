...
/*
 * OAIChat_v1_service_user.h
 *
 * 
 */

#ifndef OAIChat_v1_service_user_H
#define OAIChat_v1_service_user_H
...
class OAIChat_v1_service_user : public OAIObject {
public:
    OAIChat_v1_service_user();
    OAIChat_v1_service_user(QString json);
    ~OAIChat_v1_service_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v1_service_user)

#endif // OAIChat_v1_service_user_H
