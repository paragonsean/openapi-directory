...
/*
 * OAIChat_v1_service.h
 *
 * 
 */

#ifndef OAIChat_v1_service_H
#define OAIChat_v1_service_H
...
class OAIChat_v1_service : public OAIObject {
public:
    OAIChat_v1_service();
    OAIChat_v1_service(QString json);
    ~OAIChat_v1_service() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChat_v1_service)

#endif // OAIChat_v1_service_H
