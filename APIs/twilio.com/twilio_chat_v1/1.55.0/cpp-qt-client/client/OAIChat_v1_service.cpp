...
OAIChat_v1_service::OAIChat_v1_service(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChat_v1_service::OAIChat_v1_service() {
    this->initializeModel();
}

OAIChat_v1_service::~OAIChat_v1_service() {}

void OAIChat_v1_service::initializeModel() {
...
void OAIChat_v1_service::fromJson(QString jsonString) {
...
void OAIChat_v1_service::fromJsonObject(QJsonObject json) {
...
QString OAIChat_v1_service::asJson() const {
...
QJsonObject OAIChat_v1_service::asJsonObject() const {
    QJsonObject obj;
...
QString OAIChat_v1_service::getAccountSid() const {
    return m_account_sid;
}
void OAIChat_v1_service::setAccountSid(const QString &account_sid) {
    m_account_sid = account_sid;
    m_account_sid_isSet = true;
}

bool OAIChat_v1_service::is_account_sid_Set() const{
    return m_account_sid_isSet;
}

bool OAIChat_v1_service::is_account_sid_Valid() const{
    return m_account_sid_isValid;
}

qint32 OAIChat_v1_service::getConsumptionReportInterval() const {
    return m_consumption_report_interval;
}
void OAIChat_v1_service::setConsumptionReportInterval(const qint32 &consumption_report_interval) {
    m_consumption_report_interval = consumption_report_interval;
    m_consumption_report_interval_isSet = true;
}

bool OAIChat_v1_service::is_consumption_report_interval_Set() const{
    return m_consumption_report_interval_isSet;
}

bool OAIChat_v1_service::is_consumption_report_interval_Valid() const{
    return m_consumption_report_interval_isValid;
}

QDateTime OAIChat_v1_service::getDateCreated() const {
    return m_date_created;
}
void OAIChat_v1_service::setDateCreated(const QDateTime &date_created) {
    m_date_created = date_created;
    m_date_created_isSet = true;
}

bool OAIChat_v1_service::is_date_created_Set() const{
    return m_date_created_isSet;
}

bool OAIChat_v1_service::is_date_created_Valid() const{
    return m_date_created_isValid;
}

QDateTime OAIChat_v1_service::getDateUpdated() const {
    return m_date_updated;
}
void OAIChat_v1_service::setDateUpdated(const QDateTime &date_updated) {
    m_date_updated = date_updated;
    m_date_updated_isSet = true;
}

bool OAIChat_v1_service::is_date_updated_Set() const{
    return m_date_updated_isSet;
}

bool OAIChat_v1_service::is_date_updated_Valid() const{
    return m_date_updated_isValid;
}

QString OAIChat_v1_service::getDefaultChannelCreatorRoleSid() const {
    return m_default_channel_creator_role_sid;
}
void OAIChat_v1_service::setDefaultChannelCreatorRoleSid(const QString &default_channel_creator_role_sid) {
    m_default_channel_creator_role_sid = default_channel_creator_role_sid;
    m_default_channel_creator_role_sid_isSet = true;
}

bool OAIChat_v1_service::is_default_channel_creator_role_sid_Set() const{
    return m_default_channel_creator_role_sid_isSet;
}

bool OAIChat_v1_service::is_default_channel_creator_role_sid_Valid() const{
    return m_default_channel_creator_role_sid_isValid;
}

QString OAIChat_v1_service::getDefaultChannelRoleSid() const {
    return m_default_channel_role_sid;
}
void OAIChat_v1_service::setDefaultChannelRoleSid(const QString &default_channel_role_sid) {
    m_default_channel_role_sid = default_channel_role_sid;
    m_default_channel_role_sid_isSet = true;
}

bool OAIChat_v1_service::is_default_channel_role_sid_Set() const{
    return m_default_channel_role_sid_isSet;
}

bool OAIChat_v1_service::is_default_channel_role_sid_Valid() const{
    return m_default_channel_role_sid_isValid;
}

QString OAIChat_v1_service::getDefaultServiceRoleSid() const {
    return m_default_service_role_sid;
}
void OAIChat_v1_service::setDefaultServiceRoleSid(const QString &default_service_role_sid) {
    m_default_service_role_sid = default_service_role_sid;
    m_default_service_role_sid_isSet = true;
}

bool OAIChat_v1_service::is_default_service_role_sid_Set() const{
    return m_default_service_role_sid_isSet;
}

bool OAIChat_v1_service::is_default_service_role_sid_Valid() const{
    return m_default_service_role_sid_isValid;
}

QString OAIChat_v1_service::getFriendlyName() const {
    return m_friendly_name;
}
void OAIChat_v1_service::setFriendlyName(const QString &friendly_name) {
    m_friendly_name = friendly_name;
    m_friendly_name_isSet = true;
}

bool OAIChat_v1_service::is_friendly_name_Set() const{
    return m_friendly_name_isSet;
}

bool OAIChat_v1_service::is_friendly_name_Valid() const{
    return m_friendly_name_isValid;
}

QJsonValue OAIChat_v1_service::getLimits() const {
    return m_limits;
}
void OAIChat_v1_service::setLimits(const QJsonValue &limits) {
    m_limits = limits;
    m_limits_isSet = true;
}

bool OAIChat_v1_service::is_limits_Set() const{
    return m_limits_isSet;
}

bool OAIChat_v1_service::is_limits_Valid() const{
    return m_limits_isValid;
}

OAIObject OAIChat_v1_service::getLinks() const {
    return m_links;
}
void OAIChat_v1_service::setLinks(const OAIObject &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIChat_v1_service::is_links_Set() const{
    return m_links_isSet;
}

bool OAIChat_v1_service::is_links_Valid() const{
    return m_links_isValid;
}

QJsonValue OAIChat_v1_service::getNotifications() const {
    return m_notifications;
}
void OAIChat_v1_service::setNotifications(const QJsonValue &notifications) {
    m_notifications = notifications;
    m_notifications_isSet = true;
}

bool OAIChat_v1_service::is_notifications_Set() const{
    return m_notifications_isSet;
}

bool OAIChat_v1_service::is_notifications_Valid() const{
    return m_notifications_isValid;
}

QString OAIChat_v1_service::getPostWebhookUrl() const {
    return m_post_webhook_url;
}
void OAIChat_v1_service::setPostWebhookUrl(const QString &post_webhook_url) {
    m_post_webhook_url = post_webhook_url;
    m_post_webhook_url_isSet = true;
}

bool OAIChat_v1_service::is_post_webhook_url_Set() const{
    return m_post_webhook_url_isSet;
}

bool OAIChat_v1_service::is_post_webhook_url_Valid() const{
    return m_post_webhook_url_isValid;
}

QString OAIChat_v1_service::getPreWebhookUrl() const {
    return m_pre_webhook_url;
}
void OAIChat_v1_service::setPreWebhookUrl(const QString &pre_webhook_url) {
    m_pre_webhook_url = pre_webhook_url;
    m_pre_webhook_url_isSet = true;
}

bool OAIChat_v1_service::is_pre_webhook_url_Set() const{
    return m_pre_webhook_url_isSet;
}

bool OAIChat_v1_service::is_pre_webhook_url_Valid() const{
    return m_pre_webhook_url_isValid;
}

bool OAIChat_v1_service::isReachabilityEnabled() const {
    return m_reachability_enabled;
}
void OAIChat_v1_service::setReachabilityEnabled(const bool &reachability_enabled) {
    m_reachability_enabled = reachability_enabled;
    m_reachability_enabled_isSet = true;
}

bool OAIChat_v1_service::is_reachability_enabled_Set() const{
    return m_reachability_enabled_isSet;
}

bool OAIChat_v1_service::is_reachability_enabled_Valid() const{
    return m_reachability_enabled_isValid;
}

bool OAIChat_v1_service::isReadStatusEnabled() const {
    return m_read_status_enabled;
}
void OAIChat_v1_service::setReadStatusEnabled(const bool &read_status_enabled) {
    m_read_status_enabled = read_status_enabled;
    m_read_status_enabled_isSet = true;
}

bool OAIChat_v1_service::is_read_status_enabled_Set() const{
    return m_read_status_enabled_isSet;
}

bool OAIChat_v1_service::is_read_status_enabled_Valid() const{
    return m_read_status_enabled_isValid;
}

QString OAIChat_v1_service::getSid() const {
    return m_sid;
}
void OAIChat_v1_service::setSid(const QString &sid) {
    m_sid = sid;
    m_sid_isSet = true;
}

bool OAIChat_v1_service::is_sid_Set() const{
    return m_sid_isSet;
}

bool OAIChat_v1_service::is_sid_Valid() const{
    return m_sid_isValid;
}

qint32 OAIChat_v1_service::getTypingIndicatorTimeout() const {
    return m_typing_indicator_timeout;
}
void OAIChat_v1_service::setTypingIndicatorTimeout(const qint32 &typing_indicator_timeout) {
    m_typing_indicator_timeout = typing_indicator_timeout;
    m_typing_indicator_timeout_isSet = true;
}

bool OAIChat_v1_service::is_typing_indicator_timeout_Set() const{
    return m_typing_indicator_timeout_isSet;
}

bool OAIChat_v1_service::is_typing_indicator_timeout_Valid() const{
    return m_typing_indicator_timeout_isValid;
}

QString OAIChat_v1_service::getUrl() const {
    return m_url;
}
void OAIChat_v1_service::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIChat_v1_service::is_url_Set() const{
    return m_url_isSet;
}

bool OAIChat_v1_service::is_url_Valid() const{
    return m_url_isValid;
}

QList<QString> OAIChat_v1_service::getWebhookFilters() const {
    return m_webhook_filters;
}
void OAIChat_v1_service::setWebhookFilters(const QList<QString> &webhook_filters) {
    m_webhook_filters = webhook_filters;
    m_webhook_filters_isSet = true;
}

bool OAIChat_v1_service::is_webhook_filters_Set() const{
    return m_webhook_filters_isSet;
}

bool OAIChat_v1_service::is_webhook_filters_Valid() const{
    return m_webhook_filters_isValid;
}

QString OAIChat_v1_service::getWebhookMethod() const {
    return m_webhook_method;
}
void OAIChat_v1_service::setWebhookMethod(const QString &webhook_method) {
    m_webhook_method = webhook_method;
    m_webhook_method_isSet = true;
}

bool OAIChat_v1_service::is_webhook_method_Set() const{
    return m_webhook_method_isSet;
}

bool OAIChat_v1_service::is_webhook_method_Valid() const{
    return m_webhook_method_isValid;
}

QJsonValue OAIChat_v1_service::getWebhooks() const {
    return m_webhooks;
}
void OAIChat_v1_service::setWebhooks(const QJsonValue &webhooks) {
    m_webhooks = webhooks;
    m_webhooks_isSet = true;
}

bool OAIChat_v1_service::is_webhooks_Set() const{
    return m_webhooks_isSet;
}

bool OAIChat_v1_service::is_webhooks_Valid() const{
    return m_webhooks_isValid;
}

bool OAIChat_v1_service::isSet() const {
...
bool OAIChat_v1_service::isValid() const {
