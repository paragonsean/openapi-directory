...
|**codecs** | **List&lt;VideoParticipantSummaryEnumCodec&gt;** | Codecs detected from the participant. Can be &#x60;VP8&#x60;, &#x60;H264&#x60;, or &#x60;VP9&#x60;. |  [optional] |
|**durationSec** | **Long** | Amount of time in seconds the participant was in the room. |  [optional] |
|**edgeLocation** | **VideoParticipantSummaryEnumEdgeLocation** |  |  [optional] |
...
|**errorCode** | **Integer** | Errors encountered by the participant. |  [optional] |
|**errorCodeUrl** | **String** | Twilio error code dictionary link. |  [optional] |
|**joinTime** | **OffsetDateTime** | When the participant joined the room. |  [optional] |
|**leaveTime** | **OffsetDateTime** | When the participant left the room. |  [optional] |
|**mediaRegion** | **VideoParticipantSummaryEnumTwilioRealm** |  |  [optional] |
...
|**status** | **VideoParticipantSummaryEnumRoomStatus** |  |  [optional] |
|**url** | **URI** | URL of the participant resource. |  [optional] |
