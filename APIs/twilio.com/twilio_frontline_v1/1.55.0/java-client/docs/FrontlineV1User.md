...
|**identity** | **String** | The application-defined string that uniquely identifies the resource&#39;s User. This value is often a username or an email address, and is case-sensitive. |  [optional] |
|**isAvailable** | **Boolean** | Whether the User is available for new conversations. Defaults to &#x60;false&#x60; for new users. |  [optional] |
