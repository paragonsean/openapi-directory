...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioContent.ContentV1Content();
  });
  ...
  describe('ContentV1Content', function() {
    it('should create an instance of ContentV1Content', function() {
      // uncomment below and update the code to test ContentV1Content
      //var instance = new TwilioContent.ContentV1Content();
      //expect(instance).to.be.a(TwilioContent.ContentV1Content);
    });
