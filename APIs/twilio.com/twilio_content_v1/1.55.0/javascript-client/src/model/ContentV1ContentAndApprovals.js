...
/**
 * The ContentV1ContentAndApprovals model module.
 * @module model/ContentV1ContentAndApprovals
 * @version 1.55.0
 */
class ContentV1ContentAndApprovals {
    /**
     * Constructs a new <code>ContentV1ContentAndApprovals</code>.
     * @alias module:model/ContentV1ContentAndApprovals
     */
    constructor() { 
        
        ContentV1ContentAndApprovals.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1ContentAndApprovals</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1ContentAndApprovals} obj Optional instance to populate.
     * @return {module:model/ContentV1ContentAndApprovals} The populated <code>ContentV1ContentAndApprovals</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1ContentAndApprovals();

            if (data.hasOwnProperty('account_sid')) {
                obj['account_sid'] = ApiClient.convertToType(data['account_sid'], 'String');
            }
            if (data.hasOwnProperty('approval_requests')) {
                obj['approval_requests'] = ApiClient.convertToType(data['approval_requests'], Object);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1ContentAndApprovals</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1ContentAndApprovals</code>.
     */
 ...
 */
ContentV1ContentAndApprovals.prototype['account_sid'] = undefined;

/**
 * The submitted information and approval request status of the Content resource.
 * @member {Object} approval_requests
 */
ContentV1ContentAndApprovals.prototype['approval_requests'] = undefined;

/**
 * The date and time in GMT that the resource was created specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {Date} date_created
 */
ContentV1ContentAndApprovals.prototype['date_created'] = undefined;

/**
 * The date and time in GMT that the resource was last updated specified in [RFC 2822](https://www.ietf.org/rfc/rfc2822.txt) format.
 * @member {Date} date_updated
 */
ContentV1ContentAndApprovals.prototype['date_updated'] = undefined;

/**
 * A string name used to describe the Content resource. Not visible to the end recipient.
 * @member {String} friendly_name
 */
ContentV1ContentAndApprovals.prototype['friendly_name'] = undefined;

/**
 * Two-letter (ISO 639-1) language code (e.g., en) identifying the language the Content resource is in.
 * @member {String} language
 */
ContentV1ContentAndApprovals.prototype['language'] = undefined;

/**
 * The unique string that that we created to identify the Content resource.
 * @member {String} sid
 */
ContentV1ContentAndApprovals.prototype['sid'] = undefined;

/**
 * The [Content types](https://www.twilio.com/docs/content/content-types-overview) (e.g. twilio/text) for this Content resource.
 * @member {Object} types
 */
ContentV1ContentAndApprovals.prototype['types'] = undefined;
 ...
 */
ContentV1ContentAndApprovals.prototype['variables'] = undefined;
...
export default ContentV1ContentAndApprovals;
