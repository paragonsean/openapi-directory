...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioChat.ChatV3Channel();
  });
  ...
  describe('ChatV3Channel', function() {
    it('should create an instance of ChatV3Channel', function() {
      // uncomment below and update the code to test ChatV3Channel
      //var instance = new TwilioChat.ChatV3Channel();
      //expect(instance).to.be.a(TwilioChat.ChatV3Channel);
    });
