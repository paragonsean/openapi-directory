...
async def test_create_short_code(client):
    """Test case for create_short_code
    ...
    response = await client.request(
        method='POST',
        path='/v1/Services/{service_sid}/ShortCodes'.format(service_sid='service_sid_example'),
        headers=headers,
        data=data,
        )
...
async def test_delete_short_code(client):
    """Test case for delete_short_code
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/Services/{service_sid}/ShortCodes/{sid}'.format(service_sid='service_sid_example', sid='sid_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
