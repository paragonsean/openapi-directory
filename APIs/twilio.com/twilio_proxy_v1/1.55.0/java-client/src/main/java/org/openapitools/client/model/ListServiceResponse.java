...
public class ListServiceResponse {
  ...
  private List<ProxyV1Service> services = new ArrayList<>();
  ...
  public ListServiceResponse services(List<ProxyV1Service> services) {
    this.services = services;
    return this;
  }

  public ListServiceResponse addServicesItem(ProxyV1Service servicesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ProxyV1Service> getServices() {
    return services;
  }

  public void setServices(List<ProxyV1Service> services) {
    this.services = services;
  }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            ProxyV1Service.validateJsonElement(jsonArrayservices.get(i));
          };
        }
      }
  }
