...
|**dateDeleted** | **OffsetDateTime** | The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date when the Participant was removed from the session. |  [optional] |
...
|**url** | **URI** | The absolute URL of the Participant resource. |  [optional] |
