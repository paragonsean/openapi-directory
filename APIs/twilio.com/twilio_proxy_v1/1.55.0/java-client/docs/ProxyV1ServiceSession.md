...
|**dateEnded** | **OffsetDateTime** | The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date when the Session ended. |  [optional] |
...
|**dateLastInteraction** | **OffsetDateTime** | The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date when the Session last had an interaction. |  [optional] |
|**dateStarted** | **OffsetDateTime** | The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date when the Session started. |  [optional] |
...
|**url** | **URI** | The absolute URL of the Session resource. |  [optional] |
