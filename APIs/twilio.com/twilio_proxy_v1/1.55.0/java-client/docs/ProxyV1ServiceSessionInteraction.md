...
|**dateCreated** | **OffsetDateTime** | The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date and time in GMT when the Interaction was created. |  [optional] |
...
|**inboundResourceStatus** | **InteractionEnumResourceStatus** |  |  [optional] |
...
|**inboundResourceUrl** | **URI** | The URL of the Twilio inbound resource |  [optional] |
...
|**outboundResourceStatus** | **InteractionEnumResourceStatus** |  |  [optional] |
...
|**outboundResourceUrl** | **URI** | The URL of the Twilio outbound resource. |  [optional] |
...
|**type** | **InteractionEnumType** |  |  [optional] |
|**url** | **URI** | The absolute URL of the Interaction resource. |  [optional] |
