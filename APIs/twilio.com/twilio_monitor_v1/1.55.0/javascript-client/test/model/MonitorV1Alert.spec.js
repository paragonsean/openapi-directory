...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioMonitor.MonitorV1Alert();
  });
  ...
  describe('MonitorV1Alert', function() {
    it('should create an instance of MonitorV1Alert', function() {
      // uncomment below and update the code to test MonitorV1Alert
      //var instance = new TwilioMonitor.MonitorV1Alert();
      //expect(instance).to.be.a(TwilioMonitor.MonitorV1Alert);
    });
