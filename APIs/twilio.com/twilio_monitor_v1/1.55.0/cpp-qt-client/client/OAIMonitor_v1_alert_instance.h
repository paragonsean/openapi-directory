...
/*
 * OAIMonitor_v1_alert_instance.h
 *
 * 
 */

#ifndef OAIMonitor_v1_alert_instance_H
#define OAIMonitor_v1_alert_instance_H
...
class OAIMonitor_v1_alert_instance : public OAIObject {
public:
    OAIMonitor_v1_alert_instance();
    OAIMonitor_v1_alert_instance(QString json);
    ~OAIMonitor_v1_alert_instance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitor_v1_alert_instance)

#endif // OAIMonitor_v1_alert_instance_H
