...
class ListEventResponse(Model):
    ...
    def __init__(self, events: List[MonitorV1Event]=None, meta: ListAlertResponseMeta=None):
    ...
    def events(self, events):
        ...
        :param events: The events of this ListEventResponse.
        :type events: List[MonitorV1Event]
        """
