...
|**eventDate** | **OffsetDateTime** | The date and time in GMT when the event was recorded specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. |  [optional] |
...
|**url** | **URI** | The absolute URL of the resource that was affected. Can be &#x60;null&#x60;. |  [optional] |
