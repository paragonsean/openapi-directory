...
/*
 * OAIBulkexports_v1_export_job.h
 *
 * 
 */

#ifndef OAIBulkexports_v1_export_job_H
#define OAIBulkexports_v1_export_job_H
...
class OAIBulkexports_v1_export_job : public OAIObject {
public:
    OAIBulkexports_v1_export_job();
    OAIBulkexports_v1_export_job(QString json);
    ~OAIBulkexports_v1_export_job() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBulkexports_v1_export_job)

#endif // OAIBulkexports_v1_export_job_H
