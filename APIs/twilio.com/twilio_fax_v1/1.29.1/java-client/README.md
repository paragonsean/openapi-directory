...
Twilio - Fax
- API version: 1.29.1
  - Build date: 2024-10-12T11:27:34.972096-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:1.29.1"
  }
```
...
* `target/openapi-java-client-1.29.1.jar`
* `target/lib/*.jar`
