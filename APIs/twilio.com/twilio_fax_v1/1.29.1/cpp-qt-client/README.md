...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::deleteFaxSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::deleteFaxSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString sid = create(); // QString | The Twilio-provided string that uniquely identifies the Fax resource to delete.
