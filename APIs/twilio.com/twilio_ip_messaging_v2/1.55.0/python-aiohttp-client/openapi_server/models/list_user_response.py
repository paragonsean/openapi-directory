...
class ListUserResponse(Model):
    ...
    def __init__(self, meta: ListCredentialResponseMeta=None, users: List[IpMessagingV2ServiceUser]=None):
        ...
        self.openapi_types = {
            ...
            'users': List[IpMessagingV2ServiceUser]
        }
    ...
    def users(self):
        ...
        :rtype: List[IpMessagingV2ServiceUser]
        """
        return self._users
    ...
    def users(self, users):
        ...
        :param users: The users of this ListUserResponse.
        :type users: List[IpMessagingV2ServiceUser]
        """
