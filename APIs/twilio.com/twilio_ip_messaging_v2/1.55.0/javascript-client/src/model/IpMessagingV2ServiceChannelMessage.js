...
/**
 * The IpMessagingV2ServiceChannelMessage model module.
 * @module model/IpMessagingV2ServiceChannelMessage
 * @version 1.55.0
 */
class IpMessagingV2ServiceChannelMessage {
    /**
     * Constructs a new <code>IpMessagingV2ServiceChannelMessage</code>.
     * @alias module:model/IpMessagingV2ServiceChannelMessage
     */
    constructor() { 
        
        IpMessagingV2ServiceChannelMessage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IpMessagingV2ServiceChannelMessage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IpMessagingV2ServiceChannelMessage} obj Optional instance to populate.
     * @return {module:model/IpMessagingV2ServiceChannelMessage} The populated <code>IpMessagingV2ServiceChannelMessage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IpMessagingV2ServiceChannelMessage();
    ...
    /**
     * Validates the JSON data with respect to <code>IpMessagingV2ServiceChannelMessage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IpMessagingV2ServiceChannelMessage</code>.
     */
 ...
 */
IpMessagingV2ServiceChannelMessage.prototype['account_sid'] = undefined;

/**
 * @member {String} attributes
 */
IpMessagingV2ServiceChannelMessage.prototype['attributes'] = undefined;

/**
 * @member {String} body
 */
IpMessagingV2ServiceChannelMessage.prototype['body'] = undefined;

/**
 * @member {String} channel_sid
 */
IpMessagingV2ServiceChannelMessage.prototype['channel_sid'] = undefined;

/**
 * @member {Date} date_created
 */
IpMessagingV2ServiceChannelMessage.prototype['date_created'] = undefined;

/**
 * @member {Date} date_updated
 */
IpMessagingV2ServiceChannelMessage.prototype['date_updated'] = undefined;

/**
 * @member {String} from
 */
IpMessagingV2ServiceChannelMessage.prototype['from'] = undefined;

/**
 * @member {Number} index
 */
IpMessagingV2ServiceChannelMessage.prototype['index'] = undefined;

/**
 * @member {String} last_updated_by
 */
IpMessagingV2ServiceChannelMessage.prototype['last_updated_by'] = undefined;

/**
 * @member {Object} media
 */
IpMessagingV2ServiceChannelMessage.prototype['media'] = undefined;

/**
 * @member {String} service_sid
 */
IpMessagingV2ServiceChannelMessage.prototype['service_sid'] = undefined;

/**
 * @member {String} sid
 */
IpMessagingV2ServiceChannelMessage.prototype['sid'] = undefined;

/**
 * @member {String} to
 */
IpMessagingV2ServiceChannelMessage.prototype['to'] = undefined;

/**
 * @member {String} type
 */
IpMessagingV2ServiceChannelMessage.prototype['type'] = undefined;

/**
 * @member {String} url
 */
IpMessagingV2ServiceChannelMessage.prototype['url'] = undefined;

/**
 * @member {Boolean} was_edited
 */
IpMessagingV2ServiceChannelMessage.prototype['was_edited'] = undefined;
...
export default IpMessagingV2ServiceChannelMessage;
