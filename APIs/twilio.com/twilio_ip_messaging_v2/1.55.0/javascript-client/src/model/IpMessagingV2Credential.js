...
/**
 * The IpMessagingV2Credential model module.
 * @module model/IpMessagingV2Credential
 * @version 1.55.0
 */
class IpMessagingV2Credential {
    /**
     * Constructs a new <code>IpMessagingV2Credential</code>.
     * @alias module:model/IpMessagingV2Credential
     */
    constructor() { 
        
        IpMessagingV2Credential.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IpMessagingV2Credential</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IpMessagingV2Credential} obj Optional instance to populate.
     * @return {module:model/IpMessagingV2Credential} The populated <code>IpMessagingV2Credential</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IpMessagingV2Credential();
    ...
    /**
     * Validates the JSON data with respect to <code>IpMessagingV2Credential</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IpMessagingV2Credential</code>.
     */
 ...
 */
IpMessagingV2Credential.prototype['account_sid'] = undefined;

/**
 * @member {Date} date_created
 */
IpMessagingV2Credential.prototype['date_created'] = undefined;

/**
 * @member {Date} date_updated
 */
IpMessagingV2Credential.prototype['date_updated'] = undefined;

/**
 * @member {String} friendly_name
 */
IpMessagingV2Credential.prototype['friendly_name'] = undefined;

/**
 * @member {String} sandbox
 */
IpMessagingV2Credential.prototype['sandbox'] = undefined;

/**
 * @member {String} sid
 */
IpMessagingV2Credential.prototype['sid'] = undefined;

/**
 * @member {module:model/CredentialEnumPushService} type
 */
IpMessagingV2Credential.prototype['type'] = undefined;

/**
 * @member {String} url
 */
IpMessagingV2Credential.prototype['url'] = undefined;
...
export default IpMessagingV2Credential;
