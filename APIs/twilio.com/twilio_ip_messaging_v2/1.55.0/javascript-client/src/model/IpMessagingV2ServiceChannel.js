...
/**
 * The IpMessagingV2ServiceChannel model module.
 * @module model/IpMessagingV2ServiceChannel
 * @version 1.55.0
 */
class IpMessagingV2ServiceChannel {
    /**
     * Constructs a new <code>IpMessagingV2ServiceChannel</code>.
     * @alias module:model/IpMessagingV2ServiceChannel
     */
    constructor() { 
        
        IpMessagingV2ServiceChannel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IpMessagingV2ServiceChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IpMessagingV2ServiceChannel} obj Optional instance to populate.
     * @return {module:model/IpMessagingV2ServiceChannel} The populated <code>IpMessagingV2ServiceChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IpMessagingV2ServiceChannel();
    ...
    /**
     * Validates the JSON data with respect to <code>IpMessagingV2ServiceChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IpMessagingV2ServiceChannel</code>.
     */
 ...
 */
IpMessagingV2ServiceChannel.prototype['account_sid'] = undefined;

/**
 * @member {String} attributes
 */
IpMessagingV2ServiceChannel.prototype['attributes'] = undefined;

/**
 * @member {String} created_by
 */
IpMessagingV2ServiceChannel.prototype['created_by'] = undefined;

/**
 * @member {Date} date_created
 */
IpMessagingV2ServiceChannel.prototype['date_created'] = undefined;

/**
 * @member {Date} date_updated
 */
IpMessagingV2ServiceChannel.prototype['date_updated'] = undefined;

/**
 * @member {String} friendly_name
 */
IpMessagingV2ServiceChannel.prototype['friendly_name'] = undefined;

/**
 * @member {Object} links
 */
IpMessagingV2ServiceChannel.prototype['links'] = undefined;

/**
 * @member {Number} members_count
 */
IpMessagingV2ServiceChannel.prototype['members_count'] = undefined;

/**
 * @member {Number} messages_count
 */
IpMessagingV2ServiceChannel.prototype['messages_count'] = undefined;

/**
 * @member {String} service_sid
 */
IpMessagingV2ServiceChannel.prototype['service_sid'] = undefined;

/**
 * @member {String} sid
 */
IpMessagingV2ServiceChannel.prototype['sid'] = undefined;

/**
 * @member {module:model/ChannelEnumChannelType} type
 */
IpMessagingV2ServiceChannel.prototype['type'] = undefined;

/**
 * @member {String} unique_name
 */
IpMessagingV2ServiceChannel.prototype['unique_name'] = undefined;

/**
 * @member {String} url
 */
IpMessagingV2ServiceChannel.prototype['url'] = undefined;
...
export default IpMessagingV2ServiceChannel;
