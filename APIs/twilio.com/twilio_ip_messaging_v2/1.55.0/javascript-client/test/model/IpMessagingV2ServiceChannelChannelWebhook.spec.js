...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV2ServiceChannelChannelWebhook();
  });
  ...
  describe('IpMessagingV2ServiceChannelChannelWebhook', function() {
    it('should create an instance of IpMessagingV2ServiceChannelChannelWebhook', function() {
      // uncomment below and update the code to test IpMessagingV2ServiceChannelChannelWebhook
      //var instance = new TwilioIpMessaging.IpMessagingV2ServiceChannelChannelWebhook();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV2ServiceChannelChannelWebhook);
    });
