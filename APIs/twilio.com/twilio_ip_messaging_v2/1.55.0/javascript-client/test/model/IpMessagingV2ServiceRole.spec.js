...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV2ServiceRole();
  });
  ...
  describe('IpMessagingV2ServiceRole', function() {
    it('should create an instance of IpMessagingV2ServiceRole', function() {
      // uncomment below and update the code to test IpMessagingV2ServiceRole
      //var instance = new TwilioIpMessaging.IpMessagingV2ServiceRole();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV2ServiceRole);
    });
