...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV2ServiceChannelMessage();
  });
  ...
  describe('IpMessagingV2ServiceChannelMessage', function() {
    it('should create an instance of IpMessagingV2ServiceChannelMessage', function() {
      // uncomment below and update the code to test IpMessagingV2ServiceChannelMessage
      //var instance = new TwilioIpMessaging.IpMessagingV2ServiceChannelMessage();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV2ServiceChannelMessage);
    });
