...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV2ServiceUser();
  });
  ...
  describe('IpMessagingV2ServiceUser', function() {
    it('should create an instance of IpMessagingV2ServiceUser', function() {
      // uncomment below and update the code to test IpMessagingV2ServiceUser
      //var instance = new TwilioIpMessaging.IpMessagingV2ServiceUser();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV2ServiceUser);
    });
    ...
    it('should have the property isNotifiable (base name: "is_notifiable")', function() {
      // uncomment below and update the code to test the property isNotifiable
      //var instance = new TwilioIpMessaging.IpMessagingV2ServiceUser();
      //expect(instance).to.be();
    });
    ...
    it('should have the property joinedChannelsCount (base name: "joined_channels_count")', function() {
      // uncomment below and update the code to test the property joinedChannelsCount
      //var instance = new TwilioIpMessaging.IpMessagingV2ServiceUser();
      //expect(instance).to.be();
    });
