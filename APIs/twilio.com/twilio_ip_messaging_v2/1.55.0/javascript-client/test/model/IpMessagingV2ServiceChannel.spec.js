...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV2ServiceChannel();
  });
  ...
  describe('IpMessagingV2ServiceChannel', function() {
    it('should create an instance of IpMessagingV2ServiceChannel', function() {
      // uncomment below and update the code to test IpMessagingV2ServiceChannel
      //var instance = new TwilioIpMessaging.IpMessagingV2ServiceChannel();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV2ServiceChannel);
    });
