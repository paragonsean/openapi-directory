...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV2Credential();
  });
  ...
  describe('IpMessagingV2Credential', function() {
    it('should create an instance of IpMessagingV2Credential', function() {
      // uncomment below and update the code to test IpMessagingV2Credential
      //var instance = new TwilioIpMessaging.IpMessagingV2Credential();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV2Credential);
    });
