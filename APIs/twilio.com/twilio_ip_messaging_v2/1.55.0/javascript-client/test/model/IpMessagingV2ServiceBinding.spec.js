...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV2ServiceBinding();
  });
  ...
  describe('IpMessagingV2ServiceBinding', function() {
    it('should create an instance of IpMessagingV2ServiceBinding', function() {
      // uncomment below and update the code to test IpMessagingV2ServiceBinding
      //var instance = new TwilioIpMessaging.IpMessagingV2ServiceBinding();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV2ServiceBinding);
    });
