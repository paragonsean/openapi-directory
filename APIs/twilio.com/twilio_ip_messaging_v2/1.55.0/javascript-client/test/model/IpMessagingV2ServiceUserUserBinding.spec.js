...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV2ServiceUserUserBinding();
  });
  ...
  describe('IpMessagingV2ServiceUserUserBinding', function() {
    it('should create an instance of IpMessagingV2ServiceUserUserBinding', function() {
      // uncomment below and update the code to test IpMessagingV2ServiceUserUserBinding
      //var instance = new TwilioIpMessaging.IpMessagingV2ServiceUserUserBinding();
      //expect(instance).to.be.a(TwilioIpMessaging.IpMessagingV2ServiceUserUserBinding);
    });
