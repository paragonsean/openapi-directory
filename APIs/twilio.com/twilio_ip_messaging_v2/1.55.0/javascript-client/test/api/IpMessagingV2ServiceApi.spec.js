...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioIpMessaging.IpMessagingV2ServiceApi();
  });
  ...
  describe('IpMessagingV2ServiceApi', function() {
    ...
    describe('fetchService', function() {
      it('should call fetchService successfully', function(done) {
        //uncomment below and update the code to test fetchService
        //instance.fetchService(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listService', function() {
      it('should call listService successfully', function(done) {
        //uncomment below and update the code to test listService
        //instance.listService(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
