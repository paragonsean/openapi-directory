...
public class ListServiceResponse {
  ...
  private List<IpMessagingV2Service> services = new ArrayList<>();
  ...
  public ListServiceResponse services(List<IpMessagingV2Service> services) {
    this.services = services;
    return this;
  }

  public ListServiceResponse addServicesItem(IpMessagingV2Service servicesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<IpMessagingV2Service> getServices() {
    return services;
  }

  public void setServices(List<IpMessagingV2Service> services) {
    this.services = services;
  }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            IpMessagingV2Service.validateJsonElement(jsonArrayservices.get(i));
          };
        }
      }
  }
