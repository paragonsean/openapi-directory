...
public class ListCredentialResponse {
  ...
  private List<IpMessagingV2Credential> credentials = new ArrayList<>();
  ...
  public ListCredentialResponse credentials(List<IpMessagingV2Credential> credentials) {
    this.credentials = credentials;
    return this;
  }

  public ListCredentialResponse addCredentialsItem(IpMessagingV2Credential credentialsItem) {
  ...
  public List<IpMessagingV2Credential> getCredentials() {
    return credentials;
  }

  public void setCredentials(List<IpMessagingV2Credential> credentials) {
    this.credentials = credentials;
  }
      ...
      if (jsonObj.get("credentials") != null && !jsonObj.get("credentials").isJsonNull()) {
        ...
        if (jsonArraycredentials != null) {
          ...
          for (int i = 0; i < jsonArraycredentials.size(); i++) {
            IpMessagingV2Credential.validateJsonElement(jsonArraycredentials.get(i));
          };
        }
      }
