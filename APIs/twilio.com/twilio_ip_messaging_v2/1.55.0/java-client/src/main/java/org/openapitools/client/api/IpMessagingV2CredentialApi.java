...
import org.openapitools.client.model.IpMessagingV2Credential;
...
public class IpMessagingV2CredentialApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public IpMessagingV2CredentialApi() {
        this(Configuration.getDefaultApiClient());
    }

    public IpMessagingV2CredentialApi(ApiClient apiClient) {
    ...
    public okhttp3.Call createCredentialCall(CredentialEnumPushService type, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2/Credentials";
     ...
     */
    public IpMessagingV2Credential createCredential(CredentialEnumPushService type, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
        ApiResponse<IpMessagingV2Credential> localVarResp = createCredentialWithHttpInfo(type, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
     ...
     * @param sandbox  (optional)
     * @param secret  (optional)
     * @return ApiResponse&lt;IpMessagingV2Credential&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<IpMessagingV2Credential> createCredentialWithHttpInfo(CredentialEnumPushService type, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<IpMessagingV2Credential>(){}.getType();
     ...
     */
    public okhttp3.Call createCredentialAsync(CredentialEnumPushService type, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret, final ApiCallback<IpMessagingV2Credential> _callback) throws ApiException {
    ...
    public okhttp3.Call deleteCredentialCall(String sid, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/Credentials/{Sid}"
     ...
     */
    public IpMessagingV2Credential fetchCredential(String sid) throws ApiException {
        ApiResponse<IpMessagingV2Credential> localVarResp = fetchCredentialWithHttpInfo(sid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IpMessagingV2Credential> fetchCredentialWithHttpInfo(String sid) throws ApiException {
     ...
     */
    public okhttp3.Call fetchCredentialAsync(String sid, final ApiCallback<IpMessagingV2Credential> _callback) throws ApiException {
     ...
     */
    public IpMessagingV2Credential updateCredential(String sid, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
        ApiResponse<IpMessagingV2Credential> localVarResp = updateCredentialWithHttpInfo(sid, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IpMessagingV2Credential> updateCredentialWithHttpInfo(String sid, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret) throws ApiException {
     ...
     */
    public okhttp3.Call updateCredentialAsync(String sid, String apiKey, String certificate, String friendlyName, String privateKey, Boolean sandbox, String secret, final ApiCallback<IpMessagingV2Credential> _callback) throws ApiException {
