...
public class IpMessagingV2BindingApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public IpMessagingV2BindingApi() {
        this(Configuration.getDefaultApiClient());
    }

    public IpMessagingV2BindingApi(ApiClient apiClient) {
    ...
    public okhttp3.Call deleteBindingCall(String serviceSid, String sid, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2/Services/{ServiceSid}/Bindings/{Sid}"
     ...
     */
    public IpMessagingV2ServiceBinding fetchBinding(String serviceSid, String sid) throws ApiException {
        ApiResponse<IpMessagingV2ServiceBinding> localVarResp = fetchBindingWithHttpInfo(serviceSid, sid);
     ...
     * @param serviceSid  (required)
     * @param sid  (required)
     * @return ApiResponse&lt;IpMessagingV2ServiceBinding&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<IpMessagingV2ServiceBinding> fetchBindingWithHttpInfo(String serviceSid, String sid) throws ApiException {
        okhttp3.Call localVarCall = fetchBindingValidateBeforeCall(serviceSid, sid, null);
        Type localVarReturnType = new TypeToken<IpMessagingV2ServiceBinding>(){}.getType();
     ...
     */
    public okhttp3.Call fetchBindingAsync(String serviceSid, String sid, final ApiCallback<IpMessagingV2ServiceBinding> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call listBindingCall(String serviceSid, List<BindingEnumBindingType> bindingType, List<String> identity, Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] { "https://ip-messaging.twilio.com" };
        ...
        // create path and map variables
        String localVarPath = "/v2/Services/{ServiceSid}/Bindings"
            .replace("{" + "ServiceSid" + "}", localVarApiClient.escapeString(serviceSid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listBindingValidateBeforeCall(String serviceSid, List<BindingEnumBindingType> bindingType, List<String> identity, Integer pageSize, Integer page, String pageToken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'serviceSid' is set
        if (serviceSid == null) {
            throw new ApiException("Missing the required parameter 'serviceSid' when calling listBinding(Async)");
        }

        return listBindingCall(serviceSid, bindingType, identity, pageSize, page, pageToken, _callback);
     ...
     */
    public ListBindingResponse listBinding(String serviceSid, List<BindingEnumBindingType> bindingType, List<String> identity, Integer pageSize, Integer page, String pageToken) throws ApiException {
        ApiResponse<ListBindingResponse> localVarResp = listBindingWithHttpInfo(serviceSid, bindingType, identity, pageSize, page, pageToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListBindingResponse> listBindingWithHttpInfo(String serviceSid, List<BindingEnumBindingType> bindingType, List<String> identity, Integer pageSize, Integer page, String pageToken) throws ApiException {
        okhttp3.Call localVarCall = listBindingValidateBeforeCall(serviceSid, bindingType, identity, pageSize, page, pageToken, null);
     ...
     */
    public okhttp3.Call listBindingAsync(String serviceSid, List<BindingEnumBindingType> bindingType, List<String> identity, Integer pageSize, Integer page, String pageToken, final ApiCallback<ListBindingResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listBindingValidateBeforeCall(serviceSid, bindingType, identity, pageSize, page, pageToken, _callback);
        Type localVarReturnType = new TypeToken<ListBindingResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
