...
public class ListUserResponse {
  ...
  private List<IpMessagingV2ServiceUser> users = new ArrayList<>();
  ...
  public ListUserResponse users(List<IpMessagingV2ServiceUser> users) {
    this.users = users;
    return this;
  }

  public ListUserResponse addUsersItem(IpMessagingV2ServiceUser usersItem) {
    if (this.users == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<IpMessagingV2ServiceUser> getUsers() {
    return users;
  }

  public void setUsers(List<IpMessagingV2ServiceUser> users) {
    this.users = users;
  }
      ...
      if (jsonObj.get("users") != null && !jsonObj.get("users").isJsonNull()) {
        ...
        if (jsonArrayusers != null) {
          ...
          for (int i = 0; i < jsonArrayusers.size(); i++) {
            IpMessagingV2ServiceUser.validateJsonElement(jsonArrayusers.get(i));
          };
        }
      }
  }
