...
/**
 * API tests for IpMessagingV2ServiceApi
 */
@Disabled
public class IpMessagingV2ServiceApiTest {

    private final IpMessagingV2ServiceApi api = new IpMessagingV2ServiceApi();
    ...
    public void createServiceTest() throws ApiException {
        ...
        IpMessagingV2Service response = api.createService(friendlyName);
    ...
    public void fetchServiceTest() throws ApiException {
        String sid = null;
        IpMessagingV2Service response = api.fetchService(sid);
        // TODO: test validations
    }
