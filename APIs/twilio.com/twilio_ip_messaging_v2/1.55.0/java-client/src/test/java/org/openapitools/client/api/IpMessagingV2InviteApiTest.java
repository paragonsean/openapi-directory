...
/**
 * API tests for IpMessagingV2InviteApi
 */
@Disabled
public class IpMessagingV2InviteApiTest {

    private final IpMessagingV2InviteApi api = new IpMessagingV2InviteApi();
    ...
    public void createInviteTest() throws ApiException {
        ...
        String roleSid = null;
        IpMessagingV2ServiceChannelInvite response = api.createInvite(serviceSid, channelSid, identity, roleSid);
    ...
    public void fetchInviteTest() throws ApiException {
        ...
        String channelSid = null;
        String sid = null;
        IpMessagingV2ServiceChannelInvite response = api.fetchInvite(serviceSid, channelSid, sid);
        // TODO: test validations
    }
