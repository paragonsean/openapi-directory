...
/**
 * API tests for IpMessagingV2CredentialApi
 */
@Disabled
public class IpMessagingV2CredentialApiTest {

    private final IpMessagingV2CredentialApi api = new IpMessagingV2CredentialApi();
    ...
    public void createCredentialTest() throws ApiException {
        ...
        String secret = null;
        IpMessagingV2Credential response = api.createCredential(type, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
    ...
    public void fetchCredentialTest() throws ApiException {
        String sid = null;
        IpMessagingV2Credential response = api.fetchCredential(sid);
        // TODO: test validations
    }
    ...
    public void updateCredentialTest() throws ApiException {
        ...
        Boolean sandbox = null;
        String secret = null;
        IpMessagingV2Credential response = api.updateCredential(sid, apiKey, certificate, friendlyName, privateKey, sandbox, secret);
        // TODO: test validations
    }
