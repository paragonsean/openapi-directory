...
/*
 * OAIIp_messaging_v2_service_channel_channel_webhook.h
 *
 * 
 */

#ifndef OAIIp_messaging_v2_service_channel_channel_webhook_H
#define OAIIp_messaging_v2_service_channel_channel_webhook_H
...
class OAIIp_messaging_v2_service_channel_channel_webhook : public OAIObject {
public:
    OAIIp_messaging_v2_service_channel_channel_webhook();
    OAIIp_messaging_v2_service_channel_channel_webhook(QString json);
    ~OAIIp_messaging_v2_service_channel_channel_webhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIp_messaging_v2_service_channel_channel_webhook)

#endif // OAIIp_messaging_v2_service_channel_channel_webhook_H
