...
/*
 * OAIIp_messaging_v2_service_channel_message.h
 *
 * 
 */

#ifndef OAIIp_messaging_v2_service_channel_message_H
#define OAIIp_messaging_v2_service_channel_message_H
...
class OAIIp_messaging_v2_service_channel_message : public OAIObject {
public:
    OAIIp_messaging_v2_service_channel_message();
    OAIIp_messaging_v2_service_channel_message(QString json);
    ~OAIIp_messaging_v2_service_channel_message() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIp_messaging_v2_service_channel_message)

#endif // OAIIp_messaging_v2_service_channel_message_H
