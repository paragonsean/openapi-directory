...
#ifndef OAI_OAIIpMessagingV2BindingApi_H
#define OAI_OAIIpMessagingV2BindingApi_H
...
class OAIIpMessagingV2BindingApi : public QObject {
    Q_OBJECT

public:
    OAIIpMessagingV2BindingApi(const int timeOut = 0);
    ~OAIIpMessagingV2BindingApi();
...
Q_SIGNALS:
    ...
    void fetchBindingSignal(OAIIp_messaging_v2_service_binding summary);
    void listBindingSignal(OAIListBindingResponse summary);


    void deleteBindingSignalFull(OAIHttpRequestWorker *worker);
    void fetchBindingSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v2_service_binding summary);
    ...
    void fetchBindingSignalE(OAIIp_messaging_v2_service_binding summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchBindingSignalError(OAIIp_messaging_v2_service_binding summary, QNetworkReply::NetworkError error_type, const QString &error_str);
