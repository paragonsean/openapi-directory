...
#ifndef OAI_OAIIpMessagingV2ChannelApi_H
#define OAI_OAIIpMessagingV2ChannelApi_H
...
class OAIIpMessagingV2ChannelApi : public QObject {
    Q_OBJECT

public:
    OAIIpMessagingV2ChannelApi(const int timeOut = 0);
    ~OAIIpMessagingV2ChannelApi();
...
Q_SIGNALS:
    ...
    void createChannelSignal(OAIIp_messaging_v2_service_channel summary);
    void deleteChannelSignal();
    void fetchChannelSignal(OAIIp_messaging_v2_service_channel summary);
    void listChannelSignal(OAIListChannelResponse summary);
    void updateChannelSignal(OAIIp_messaging_v2_service_channel summary);


    void createChannelSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v2_service_channel summary);
    void deleteChannelSignalFull(OAIHttpRequestWorker *worker);
    void fetchChannelSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v2_service_channel summary);
    void listChannelSignalFull(OAIHttpRequestWorker *worker, OAIListChannelResponse summary);
    void updateChannelSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v2_service_channel summary);

    Q_DECL_DEPRECATED_X("Use createChannelSignalError() instead")
    void createChannelSignalE(OAIIp_messaging_v2_service_channel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createChannelSignalError(OAIIp_messaging_v2_service_channel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchChannelSignalE(OAIIp_messaging_v2_service_channel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchChannelSignalError(OAIIp_messaging_v2_service_channel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateChannelSignalE(OAIIp_messaging_v2_service_channel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateChannelSignalError(OAIIp_messaging_v2_service_channel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
