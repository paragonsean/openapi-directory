...
/*
 * OAIIp_messaging_v2_service_user_user_binding.h
 *
 * 
 */

#ifndef OAIIp_messaging_v2_service_user_user_binding_H
#define OAIIp_messaging_v2_service_user_user_binding_H
...
class OAIIp_messaging_v2_service_user_user_binding : public OAIObject {
public:
    OAIIp_messaging_v2_service_user_user_binding();
    OAIIp_messaging_v2_service_user_user_binding(QString json);
    ~OAIIp_messaging_v2_service_user_user_binding() override;
    ...
    OAIUser_binding_enum_binding_type getBindingType() const;
    void setBindingType(const OAIUser_binding_enum_binding_type &binding_type);
...
private:
    ...
    OAIUser_binding_enum_binding_type m_binding_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIp_messaging_v2_service_user_user_binding)

#endif // OAIIp_messaging_v2_service_user_user_binding_H
