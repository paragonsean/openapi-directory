...
/*
 * OAIIp_messaging_v2_service_channel.h
 *
 * 
 */

#ifndef OAIIp_messaging_v2_service_channel_H
#define OAIIp_messaging_v2_service_channel_H
...
class OAIIp_messaging_v2_service_channel : public OAIObject {
public:
    OAIIp_messaging_v2_service_channel();
    OAIIp_messaging_v2_service_channel(QString json);
    ~OAIIp_messaging_v2_service_channel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIp_messaging_v2_service_channel)

#endif // OAIIp_messaging_v2_service_channel_H
