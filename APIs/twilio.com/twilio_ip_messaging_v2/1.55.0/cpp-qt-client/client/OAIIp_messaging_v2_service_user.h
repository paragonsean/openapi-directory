...
/*
 * OAIIp_messaging_v2_service_user.h
 *
 * 
 */

#ifndef OAIIp_messaging_v2_service_user_H
#define OAIIp_messaging_v2_service_user_H
...
class OAIIp_messaging_v2_service_user : public OAIObject {
public:
    OAIIp_messaging_v2_service_user();
    OAIIp_messaging_v2_service_user(QString json);
    ~OAIIp_messaging_v2_service_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIp_messaging_v2_service_user)

#endif // OAIIp_messaging_v2_service_user_H
