...
#ifndef OAI_OAIIpMessagingV2CredentialApi_H
#define OAI_OAIIpMessagingV2CredentialApi_H
...
#include "OAIIp_messaging_v2_credential.h"
...
class OAIIpMessagingV2CredentialApi : public QObject {
    Q_OBJECT

public:
    OAIIpMessagingV2CredentialApi(const int timeOut = 0);
    ~OAIIpMessagingV2CredentialApi();
...
Q_SIGNALS:
    ...
    void createCredentialSignal(OAIIp_messaging_v2_credential summary);
    void deleteCredentialSignal();
    void fetchCredentialSignal(OAIIp_messaging_v2_credential summary);
    void listCredentialSignal(OAIListCredentialResponse summary);
    void updateCredentialSignal(OAIIp_messaging_v2_credential summary);


    void createCredentialSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v2_credential summary);
    void deleteCredentialSignalFull(OAIHttpRequestWorker *worker);
    void fetchCredentialSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v2_credential summary);
    void listCredentialSignalFull(OAIHttpRequestWorker *worker, OAIListCredentialResponse summary);
    void updateCredentialSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v2_credential summary);

    Q_DECL_DEPRECATED_X("Use createCredentialSignalError() instead")
    void createCredentialSignalE(OAIIp_messaging_v2_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createCredentialSignalError(OAIIp_messaging_v2_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchCredentialSignalE(OAIIp_messaging_v2_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchCredentialSignalError(OAIIp_messaging_v2_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateCredentialSignalE(OAIIp_messaging_v2_credential summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateCredentialSignalError(OAIIp_messaging_v2_credential summary, QNetworkReply::NetworkError error_type, const QString &error_str);
