...
/*
 * OAIIp_messaging_v2_service_binding.h
 *
 * 
 */

#ifndef OAIIp_messaging_v2_service_binding_H
#define OAIIp_messaging_v2_service_binding_H
...
class OAIIp_messaging_v2_service_binding : public OAIObject {
public:
    OAIIp_messaging_v2_service_binding();
    OAIIp_messaging_v2_service_binding(QString json);
    ~OAIIp_messaging_v2_service_binding() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIp_messaging_v2_service_binding)

#endif // OAIIp_messaging_v2_service_binding_H
