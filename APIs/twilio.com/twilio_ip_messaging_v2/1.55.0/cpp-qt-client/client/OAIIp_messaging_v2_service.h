...
/*
 * OAIIp_messaging_v2_service.h
 *
 * 
 */

#ifndef OAIIp_messaging_v2_service_H
#define OAIIp_messaging_v2_service_H
...
class OAIIp_messaging_v2_service : public OAIObject {
public:
    OAIIp_messaging_v2_service();
    OAIIp_messaging_v2_service(QString json);
    ~OAIIp_messaging_v2_service() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIp_messaging_v2_service)

#endif // OAIIp_messaging_v2_service_H
