...
#ifndef OAI_OAIIpMessagingV2ServiceApi_H
#define OAI_OAIIpMessagingV2ServiceApi_H
...
class OAIIpMessagingV2ServiceApi : public QObject {
    Q_OBJECT

public:
    OAIIpMessagingV2ServiceApi(const int timeOut = 0);
    ~OAIIpMessagingV2ServiceApi();
...
Q_SIGNALS:
    ...
    void createServiceSignal(OAIIp_messaging_v2_service summary);
    void deleteServiceSignal();
    void fetchServiceSignal(OAIIp_messaging_v2_service summary);
    void listServiceSignal(OAIListServiceResponse summary);
    void updateServiceSignal(OAIIp_messaging_v2_service summary);


    void createServiceSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v2_service summary);
    void deleteServiceSignalFull(OAIHttpRequestWorker *worker);
    void fetchServiceSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v2_service summary);
    void listServiceSignalFull(OAIHttpRequestWorker *worker, OAIListServiceResponse summary);
    void updateServiceSignalFull(OAIHttpRequestWorker *worker, OAIIp_messaging_v2_service summary);

    Q_DECL_DEPRECATED_X("Use createServiceSignalError() instead")
    void createServiceSignalE(OAIIp_messaging_v2_service summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createServiceSignalError(OAIIp_messaging_v2_service summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void fetchServiceSignalE(OAIIp_messaging_v2_service summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchServiceSignalError(OAIIp_messaging_v2_service summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateServiceSignalE(OAIIp_messaging_v2_service summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateServiceSignalError(OAIIp_messaging_v2_service summary, QNetworkReply::NetworkError error_type, const QString &error_str);
