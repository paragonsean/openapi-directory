...
public class ListServiceResponse {
  ...
  private List<VerifyV2Service> services = new ArrayList<>();

  public ListServiceResponse() {
  }

  public ListServiceResponse meta(ListVerificationAttemptResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public ListServiceResponse services(List<VerifyV2Service> services) {
    this.services = services;
    return this;
  }

  public ListServiceResponse addServicesItem(VerifyV2Service servicesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<VerifyV2Service> getServices() {
    return services;
  }

  public void setServices(List<VerifyV2Service> services) {
    this.services = services;
  }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            VerifyV2Service.validateJsonElement(jsonArrayservices.get(i));
          };
        }
      }
  }
