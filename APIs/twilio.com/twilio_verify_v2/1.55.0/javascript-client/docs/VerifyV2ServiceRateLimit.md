# TwilioVerify.VerifyV2ServiceRateLimit
...
**sid** | **String** | A 34 character string that uniquely identifies this Rate Limit. | [optional] 
**uniqueName** | **String** | Provides a unique and addressable name to be assigned to this Rate Limit, assigned by the developer, to be optionally used in addition to SID. **This value should not contain PII.** | [optional] 
