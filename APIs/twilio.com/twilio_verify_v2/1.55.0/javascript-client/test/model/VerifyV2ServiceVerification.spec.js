...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioVerify.VerifyV2ServiceVerification();
  });
  ...
  describe('VerifyV2ServiceVerification', function() {
    it('should create an instance of VerifyV2ServiceVerification', function() {
      // uncomment below and update the code to test VerifyV2ServiceVerification
      //var instance = new TwilioVerify.VerifyV2ServiceVerification();
      //expect(instance).to.be.a(TwilioVerify.VerifyV2ServiceVerification);
    });
    ...
    it('should have the property sendCodeAttempts (base name: "send_code_attempts")', function() {
      // uncomment below and update the code to test the property sendCodeAttempts
      //var instance = new TwilioVerify.VerifyV2ServiceVerification();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sna (base name: "sna")', function() {
      // uncomment below and update the code to test the property sna
      //var instance = new TwilioVerify.VerifyV2ServiceVerification();
      //expect(instance).to.be();
    });
