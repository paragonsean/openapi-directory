...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioVerify.VerifyV2ServiceEntity();
  });
  ...
  describe('VerifyV2ServiceEntity', function() {
    it('should create an instance of VerifyV2ServiceEntity', function() {
      // uncomment below and update the code to test VerifyV2ServiceEntity
      //var instance = new TwilioVerify.VerifyV2ServiceEntity();
      //expect(instance).to.be.a(TwilioVerify.VerifyV2ServiceEntity);
    });
