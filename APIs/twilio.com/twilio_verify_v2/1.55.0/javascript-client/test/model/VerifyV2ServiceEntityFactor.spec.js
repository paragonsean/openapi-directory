...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioVerify.VerifyV2ServiceEntityFactor();
  });
  ...
  describe('VerifyV2ServiceEntityFactor', function() {
    it('should create an instance of VerifyV2ServiceEntityFactor', function() {
      // uncomment below and update the code to test VerifyV2ServiceEntityFactor
      //var instance = new TwilioVerify.VerifyV2ServiceEntityFactor();
      //expect(instance).to.be.a(TwilioVerify.VerifyV2ServiceEntityFactor);
    });
