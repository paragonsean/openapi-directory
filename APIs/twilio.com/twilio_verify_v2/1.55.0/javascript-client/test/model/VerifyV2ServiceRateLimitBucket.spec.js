...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioVerify.VerifyV2ServiceRateLimitBucket();
  });
  ...
  describe('VerifyV2ServiceRateLimitBucket', function() {
    it('should create an instance of VerifyV2ServiceRateLimitBucket', function() {
      // uncomment below and update the code to test VerifyV2ServiceRateLimitBucket
      //var instance = new TwilioVerify.VerifyV2ServiceRateLimitBucket();
      //expect(instance).to.be.a(TwilioVerify.VerifyV2ServiceRateLimitBucket);
    });
    ...
    it('should have the property rateLimitSid (base name: "rate_limit_sid")', function() {
      // uncomment below and update the code to test the property rateLimitSid
      //var instance = new TwilioVerify.VerifyV2ServiceRateLimitBucket();
      //expect(instance).to.be();
    });
