...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioVerify.VerifyV2ServiceMessagingConfiguration();
  });
  ...
  describe('VerifyV2ServiceMessagingConfiguration', function() {
    it('should create an instance of VerifyV2ServiceMessagingConfiguration', function() {
      // uncomment below and update the code to test VerifyV2ServiceMessagingConfiguration
      //var instance = new TwilioVerify.VerifyV2ServiceMessagingConfiguration();
      //expect(instance).to.be.a(TwilioVerify.VerifyV2ServiceMessagingConfiguration);
    });
