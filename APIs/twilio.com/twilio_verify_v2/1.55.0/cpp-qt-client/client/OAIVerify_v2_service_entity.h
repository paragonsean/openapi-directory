...
/*
 * OAIVerify_v2_service_entity.h
 *
 * 
 */

#ifndef OAIVerify_v2_service_entity_H
#define OAIVerify_v2_service_entity_H
...
class OAIVerify_v2_service_entity : public OAIObject {
public:
    OAIVerify_v2_service_entity();
    OAIVerify_v2_service_entity(QString json);
    ~OAIVerify_v2_service_entity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerify_v2_service_entity)

#endif // OAIVerify_v2_service_entity_H
