...
/*
 * OAIVerify_v2_service_entity_new_factor.h
 *
 * 
 */

#ifndef OAIVerify_v2_service_entity_new_factor_H
#define OAIVerify_v2_service_entity_new_factor_H
...
class OAIVerify_v2_service_entity_new_factor : public OAIObject {
public:
    OAIVerify_v2_service_entity_new_factor();
    OAIVerify_v2_service_entity_new_factor(QString json);
    ~OAIVerify_v2_service_entity_new_factor() override;
    ...
    QJsonValue getBinding() const;
    void setBinding(const QJsonValue &binding);
    ...
    OAINew_factor_enum_factor_types getFactorType() const;
    void setFactorType(const OAINew_factor_enum_factor_types &factor_type);
    ...
    OAINew_factor_enum_factor_statuses getStatus() const;
    void setStatus(const OAINew_factor_enum_factor_statuses &status);
...
private:
    ...
    OAINew_factor_enum_factor_types m_factor_type;
    ...
    OAINew_factor_enum_factor_statuses m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerify_v2_service_entity_new_factor)

#endif // OAIVerify_v2_service_entity_new_factor_H
