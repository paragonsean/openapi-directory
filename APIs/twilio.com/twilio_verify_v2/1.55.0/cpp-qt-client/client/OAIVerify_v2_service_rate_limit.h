...
/*
 * OAIVerify_v2_service_rate_limit.h
 *
 * 
 */

#ifndef OAIVerify_v2_service_rate_limit_H
#define OAIVerify_v2_service_rate_limit_H
...
class OAIVerify_v2_service_rate_limit : public OAIObject {
public:
    OAIVerify_v2_service_rate_limit();
    OAIVerify_v2_service_rate_limit(QString json);
    ~OAIVerify_v2_service_rate_limit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerify_v2_service_rate_limit)

#endif // OAIVerify_v2_service_rate_limit_H
