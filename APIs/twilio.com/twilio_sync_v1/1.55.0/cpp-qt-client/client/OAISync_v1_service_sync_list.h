...
/*
 * OAISync_v1_service_sync_list.h
 *
 * 
 */

#ifndef OAISync_v1_service_sync_list_H
#define OAISync_v1_service_sync_list_H
...
class OAISync_v1_service_sync_list : public OAIObject {
public:
    OAISync_v1_service_sync_list();
    OAISync_v1_service_sync_list(QString json);
    ~OAISync_v1_service_sync_list() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISync_v1_service_sync_list)

#endif // OAISync_v1_service_sync_list_H
