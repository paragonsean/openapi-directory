...
/*
 * OAISync_v1_service_sync_map_sync_map_item.h
 *
 * 
 */

#ifndef OAISync_v1_service_sync_map_sync_map_item_H
#define OAISync_v1_service_sync_map_sync_map_item_H
...
class OAISync_v1_service_sync_map_sync_map_item : public OAIObject {
public:
    OAISync_v1_service_sync_map_sync_map_item();
    OAISync_v1_service_sync_map_sync_map_item(QString json);
    ~OAISync_v1_service_sync_map_sync_map_item() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISync_v1_service_sync_map_sync_map_item)

#endif // OAISync_v1_service_sync_map_sync_map_item_H
