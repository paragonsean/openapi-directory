...
/*
 * OAISync_v1_service_sync_stream.h
 *
 * 
 */

#ifndef OAISync_v1_service_sync_stream_H
#define OAISync_v1_service_sync_stream_H
...
class OAISync_v1_service_sync_stream : public OAIObject {
public:
    OAISync_v1_service_sync_stream();
    OAISync_v1_service_sync_stream(QString json);
    ~OAISync_v1_service_sync_stream() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISync_v1_service_sync_stream)

#endif // OAISync_v1_service_sync_stream_H
