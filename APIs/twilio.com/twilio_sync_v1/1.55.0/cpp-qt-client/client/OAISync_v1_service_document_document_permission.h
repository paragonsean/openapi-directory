...
/*
 * OAISync_v1_service_document_document_permission.h
 *
 * 
 */

#ifndef OAISync_v1_service_document_document_permission_H
#define OAISync_v1_service_document_document_permission_H
...
class OAISync_v1_service_document_document_permission : public OAIObject {
public:
    OAISync_v1_service_document_document_permission();
    OAISync_v1_service_document_document_permission(QString json);
    ~OAISync_v1_service_document_document_permission() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISync_v1_service_document_document_permission)

#endif // OAISync_v1_service_document_document_permission_H
