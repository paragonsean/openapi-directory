...
/*
 * OAISync_v1_service_sync_map.h
 *
 * 
 */

#ifndef OAISync_v1_service_sync_map_H
#define OAISync_v1_service_sync_map_H
...
class OAISync_v1_service_sync_map : public OAIObject {
public:
    OAISync_v1_service_sync_map();
    OAISync_v1_service_sync_map(QString json);
    ~OAISync_v1_service_sync_map() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISync_v1_service_sync_map)

#endif // OAISync_v1_service_sync_map_H
