...
public class ListServiceResponse {
  ...
  private List<SyncV1Service> services = new ArrayList<>();
  ...
  public ListServiceResponse services(List<SyncV1Service> services) {
    this.services = services;
    return this;
  }

  public ListServiceResponse addServicesItem(SyncV1Service servicesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SyncV1Service> getServices() {
    return services;
  }

  public void setServices(List<SyncV1Service> services) {
    this.services = services;
  }
      ...
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            SyncV1Service.validateJsonElement(jsonArrayservices.get(i));
          };
        }
      }
  }
