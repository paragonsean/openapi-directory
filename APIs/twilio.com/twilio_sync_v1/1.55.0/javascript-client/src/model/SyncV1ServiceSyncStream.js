...
/**
 * The SyncV1ServiceSyncStream model module.
 * @module model/SyncV1ServiceSyncStream
 * @version 1.55.0
 */
class SyncV1ServiceSyncStream {
    /**
     * Constructs a new <code>SyncV1ServiceSyncStream</code>.
     * @alias module:model/SyncV1ServiceSyncStream
     */
    constructor() { 
        
        SyncV1ServiceSyncStream.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SyncV1ServiceSyncStream</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyncV1ServiceSyncStream} obj Optional instance to populate.
     * @return {module:model/SyncV1ServiceSyncStream} The populated <code>SyncV1ServiceSyncStream</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SyncV1ServiceSyncStream();
    ...
    /**
     * Validates the JSON data with respect to <code>SyncV1ServiceSyncStream</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SyncV1ServiceSyncStream</code>.
     */
 ...
 */
SyncV1ServiceSyncStream.prototype['account_sid'] = undefined;
 ...
 */
SyncV1ServiceSyncStream.prototype['created_by'] = undefined;

/**
 * The date and time in GMT when the resource was created specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_created
 */
SyncV1ServiceSyncStream.prototype['date_created'] = undefined;
 ...
 */
SyncV1ServiceSyncStream.prototype['date_expires'] = undefined;

/**
 * The date and time in GMT when the resource was last updated specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_updated
 */
SyncV1ServiceSyncStream.prototype['date_updated'] = undefined;

/**
 * The URLs of the Stream's nested resources.
 * @member {Object} links
 */
SyncV1ServiceSyncStream.prototype['links'] = undefined;
 ...
 */
SyncV1ServiceSyncStream.prototype['service_sid'] = undefined;

/**
 * The unique string that we created to identify the Sync Stream resource.
 * @member {String} sid
 */
SyncV1ServiceSyncStream.prototype['sid'] = undefined;

/**
 * An application-defined string that uniquely identifies the resource. It can be used in place of the resource's `sid` in the URL to address the resource.
 * @member {String} unique_name
 */
SyncV1ServiceSyncStream.prototype['unique_name'] = undefined;

/**
 * The absolute URL of the Message Stream resource.
 * @member {String} url
 */
SyncV1ServiceSyncStream.prototype['url'] = undefined;
...
export default SyncV1ServiceSyncStream;
