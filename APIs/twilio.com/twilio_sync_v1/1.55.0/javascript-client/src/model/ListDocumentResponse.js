...
import SyncV1ServiceDocument from './SyncV1ServiceDocument';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('documents')) {
                obj['documents'] = ApiClient.convertToType(data['documents'], [SyncV1ServiceDocument]);
            }
    ...
    static validateJSON(data) {
        if (data['documents']) { // data not null
            ...
            for (const item of data['documents']) {
                SyncV1ServiceDocument.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/SyncV1ServiceDocument>} documents
 */
ListDocumentResponse.prototype['documents'] = undefined;

/**
 * @member {module:model/ListServiceResponseMeta} meta
 */
ListDocumentResponse.prototype['meta'] = undefined;
