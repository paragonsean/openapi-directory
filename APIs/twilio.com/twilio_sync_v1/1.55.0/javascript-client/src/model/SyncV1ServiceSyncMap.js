...
/**
 * The SyncV1ServiceSyncMap model module.
 * @module model/SyncV1ServiceSyncMap
 * @version 1.55.0
 */
class SyncV1ServiceSyncMap {
    /**
     * Constructs a new <code>SyncV1ServiceSyncMap</code>.
     * @alias module:model/SyncV1ServiceSyncMap
     */
    constructor() { 
        
        SyncV1ServiceSyncMap.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SyncV1ServiceSyncMap</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyncV1ServiceSyncMap} obj Optional instance to populate.
     * @return {module:model/SyncV1ServiceSyncMap} The populated <code>SyncV1ServiceSyncMap</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SyncV1ServiceSyncMap();
    ...
    /**
     * Validates the JSON data with respect to <code>SyncV1ServiceSyncMap</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SyncV1ServiceSyncMap</code>.
     */
 ...
 */
SyncV1ServiceSyncMap.prototype['account_sid'] = undefined;
 ...
 */
SyncV1ServiceSyncMap.prototype['created_by'] = undefined;

/**
 * The date and time in GMT when the resource was created specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_created
 */
SyncV1ServiceSyncMap.prototype['date_created'] = undefined;
 ...
 */
SyncV1ServiceSyncMap.prototype['date_expires'] = undefined;

/**
 * The date and time in GMT when the resource was last updated specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_updated
 */
SyncV1ServiceSyncMap.prototype['date_updated'] = undefined;

/**
 * The URLs of the Sync Map's nested resources.
 * @member {Object} links
 */
SyncV1ServiceSyncMap.prototype['links'] = undefined;

/**
 * The current revision of the Sync Map, represented as a string.
 * @member {String} revision
 */
SyncV1ServiceSyncMap.prototype['revision'] = undefined;
 ...
 */
SyncV1ServiceSyncMap.prototype['service_sid'] = undefined;

/**
 * The unique string that we created to identify the Sync Map resource.
 * @member {String} sid
 */
SyncV1ServiceSyncMap.prototype['sid'] = undefined;

/**
 * An application-defined string that uniquely identifies the resource. It can be used in place of the resource's `sid` in the URL to address the resource.
 * @member {String} unique_name
 */
SyncV1ServiceSyncMap.prototype['unique_name'] = undefined;

/**
 * The absolute URL of the Sync Map resource.
 * @member {String} url
 */
SyncV1ServiceSyncMap.prototype['url'] = undefined;
...
export default SyncV1ServiceSyncMap;
