...
/**
 * The SyncV1ServiceSyncList model module.
 * @module model/SyncV1ServiceSyncList
 * @version 1.55.0
 */
class SyncV1ServiceSyncList {
    /**
     * Constructs a new <code>SyncV1ServiceSyncList</code>.
     * @alias module:model/SyncV1ServiceSyncList
     */
    constructor() { 
        
        SyncV1ServiceSyncList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SyncV1ServiceSyncList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyncV1ServiceSyncList} obj Optional instance to populate.
     * @return {module:model/SyncV1ServiceSyncList} The populated <code>SyncV1ServiceSyncList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SyncV1ServiceSyncList();
    ...
    /**
     * Validates the JSON data with respect to <code>SyncV1ServiceSyncList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SyncV1ServiceSyncList</code>.
     */
 ...
 */
SyncV1ServiceSyncList.prototype['account_sid'] = undefined;
 ...
 */
SyncV1ServiceSyncList.prototype['created_by'] = undefined;

/**
 * The date and time in GMT when the resource was created specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_created
 */
SyncV1ServiceSyncList.prototype['date_created'] = undefined;
 ...
 */
SyncV1ServiceSyncList.prototype['date_expires'] = undefined;

/**
 * The date and time in GMT when the resource was last updated specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
 * @member {Date} date_updated
 */
SyncV1ServiceSyncList.prototype['date_updated'] = undefined;

/**
 * The URLs of the Sync List's nested resources.
 * @member {Object} links
 */
SyncV1ServiceSyncList.prototype['links'] = undefined;

/**
 * The current revision of the Sync List, represented as a string.
 * @member {String} revision
 */
SyncV1ServiceSyncList.prototype['revision'] = undefined;
 ...
 */
SyncV1ServiceSyncList.prototype['service_sid'] = undefined;

/**
 * The unique string that we created to identify the Sync List resource.
 * @member {String} sid
 */
SyncV1ServiceSyncList.prototype['sid'] = undefined;

/**
 * An application-defined string that uniquely identifies the resource. It can be used in place of the resource's `sid` in the URL to address the resource.
 * @member {String} unique_name
 */
SyncV1ServiceSyncList.prototype['unique_name'] = undefined;

/**
 * The absolute URL of the Sync List resource.
 * @member {String} url
 */
SyncV1ServiceSyncList.prototype['url'] = undefined;
...
export default SyncV1ServiceSyncList;
