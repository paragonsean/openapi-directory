...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioSync.SyncV1ServiceSyncList();
  });
  ...
  describe('SyncV1ServiceSyncList', function() {
    it('should create an instance of SyncV1ServiceSyncList', function() {
      // uncomment below and update the code to test SyncV1ServiceSyncList
      //var instance = new TwilioSync.SyncV1ServiceSyncList();
      //expect(instance).to.be.a(TwilioSync.SyncV1ServiceSyncList);
    });
