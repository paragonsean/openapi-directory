...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioSync.SyncV1ServiceSyncMap();
  });
  ...
  describe('SyncV1ServiceSyncMap', function() {
    it('should create an instance of SyncV1ServiceSyncMap', function() {
      // uncomment below and update the code to test SyncV1ServiceSyncMap
      //var instance = new TwilioSync.SyncV1ServiceSyncMap();
      //expect(instance).to.be.a(TwilioSync.SyncV1ServiceSyncMap);
    });
