...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioSync.SyncV1ServiceSyncStream();
  });
  ...
  describe('SyncV1ServiceSyncStream', function() {
    it('should create an instance of SyncV1ServiceSyncStream', function() {
      // uncomment below and update the code to test SyncV1ServiceSyncStream
      //var instance = new TwilioSync.SyncV1ServiceSyncStream();
      //expect(instance).to.be.a(TwilioSync.SyncV1ServiceSyncStream);
    });
