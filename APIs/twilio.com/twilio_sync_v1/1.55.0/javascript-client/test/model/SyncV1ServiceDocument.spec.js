...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioSync.SyncV1ServiceDocument();
  });
  ...
  describe('SyncV1ServiceDocument', function() {
    it('should create an instance of SyncV1ServiceDocument', function() {
      // uncomment below and update the code to test SyncV1ServiceDocument
      //var instance = new TwilioSync.SyncV1ServiceDocument();
      //expect(instance).to.be.a(TwilioSync.SyncV1ServiceDocument);
    });
