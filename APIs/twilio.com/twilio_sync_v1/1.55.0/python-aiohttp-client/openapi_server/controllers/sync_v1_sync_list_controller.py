...
async def create_sync_list(request: web.Request, service_sid, collection_ttl=None, ttl=None, unique_name=None) -> web.Response:
    """create_sync_list

    

    :param service_sid: The SID of the [Sync Service](https://www.twilio.com/docs/sync/api/service) to create the new Sync List in.
...
async def delete_sync_list(request: web.Request, service_sid, sid) -> web.Response:
    """delete_sync_list

    

    :param service_sid: The SID of the [Sync Service](https://www.twilio.com/docs/sync/api/service) with the Sync List resource to delete.
    :type service_sid: str
...
async def fetch_sync_list(request: web.Request, service_sid, sid) -> web.Response:
    """fetch_sync_list

    

    :param service_sid: The SID of the [Sync Service](https://www.twilio.com/docs/sync/api/service) with the Sync List resource to fetch.
    :type service_sid: str
...
async def list_sync_list(request: web.Request, service_sid, page_size=None, page=None, page_token=None) -> web.Response:
    """list_sync_list
...
async def update_sync_list(request: web.Request, service_sid, sid, collection_ttl=None, ttl=None) -> web.Response:
    """update_sync_list
