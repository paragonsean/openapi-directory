# TwilioSupersim.SupersimV1EsimProfile
...
**smdpPlusAddress** | **String** | Address of the SM-DP+ server from which the Profile will be downloaded. The URL will appear once the eSIM Profile reaches the status &#x60;available&#x60;. | [optional] 
**status** | [**EsimProfileEnumStatus**](EsimProfileEnumStatus.md) |  | [optional] 
