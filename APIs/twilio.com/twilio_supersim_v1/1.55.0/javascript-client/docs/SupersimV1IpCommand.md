# TwilioSupersim.SupersimV1IpCommand
...
**devicePort** | **Number** | For an IP Command sent to a Super SIM, it would be the destination port of the IP message. For an IP Command sent from a Super SIM, it would be the source port of the IP message. | [optional] 
**direction** | [**IpCommandEnumDirection**](IpCommandEnumDirection.md) |  | [optional] 
...
**payloadType** | [**IpCommandEnumPayloadType**](IpCommandEnumPayloadType.md) |  | [optional] 
...
**status** | [**IpCommandEnumStatus**](IpCommandEnumStatus.md) |  | [optional] 
