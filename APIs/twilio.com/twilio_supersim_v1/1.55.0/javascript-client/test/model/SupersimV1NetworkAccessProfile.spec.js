...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioSupersim.SupersimV1NetworkAccessProfile();
  });
  ...
  describe('SupersimV1NetworkAccessProfile', function() {
    it('should create an instance of SupersimV1NetworkAccessProfile', function() {
      // uncomment below and update the code to test SupersimV1NetworkAccessProfile
      //var instance = new TwilioSupersim.SupersimV1NetworkAccessProfile();
      //expect(instance).to.be.a(TwilioSupersim.SupersimV1NetworkAccessProfile);
    });
