...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioSupersim.SupersimV1SettingsUpdate();
  });
  ...
  describe('SupersimV1SettingsUpdate', function() {
    it('should create an instance of SupersimV1SettingsUpdate', function() {
      // uncomment below and update the code to test SupersimV1SettingsUpdate
      //var instance = new TwilioSupersim.SupersimV1SettingsUpdate();
      //expect(instance).to.be.a(TwilioSupersim.SupersimV1SettingsUpdate);
    });
