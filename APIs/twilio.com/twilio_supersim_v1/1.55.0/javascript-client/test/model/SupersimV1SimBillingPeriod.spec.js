...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioSupersim.SupersimV1SimBillingPeriod();
  });
  ...
  describe('SupersimV1SimBillingPeriod', function() {
    it('should create an instance of SupersimV1SimBillingPeriod', function() {
      // uncomment below and update the code to test SupersimV1SimBillingPeriod
      //var instance = new TwilioSupersim.SupersimV1SimBillingPeriod();
      //expect(instance).to.be.a(TwilioSupersim.SupersimV1SimBillingPeriod);
    });
