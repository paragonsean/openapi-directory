...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioSupersim.SupersimV1SmsCommand();
  });
  ...
  describe('SupersimV1SmsCommand', function() {
    it('should create an instance of SupersimV1SmsCommand', function() {
      // uncomment below and update the code to test SupersimV1SmsCommand
      //var instance = new TwilioSupersim.SupersimV1SmsCommand();
      //expect(instance).to.be.a(TwilioSupersim.SupersimV1SmsCommand);
    });
