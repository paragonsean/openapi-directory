...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioSupersim.SupersimV1Sim();
  });
  ...
  describe('SupersimV1Sim', function() {
    it('should create an instance of SupersimV1Sim', function() {
      // uncomment below and update the code to test SupersimV1Sim
      //var instance = new TwilioSupersim.SupersimV1Sim();
      //expect(instance).to.be.a(TwilioSupersim.SupersimV1Sim);
    });
