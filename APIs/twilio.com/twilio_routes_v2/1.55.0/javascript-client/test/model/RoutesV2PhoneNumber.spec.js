...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwilioRoutes.RoutesV2PhoneNumber();
  });
  ...
  describe('RoutesV2PhoneNumber', function() {
    it('should create an instance of RoutesV2PhoneNumber', function() {
      // uncomment below and update the code to test RoutesV2PhoneNumber
      //var instance = new TwilioRoutes.RoutesV2PhoneNumber();
      //expect(instance).to.be.a(TwilioRoutes.RoutesV2PhoneNumber);
    });
