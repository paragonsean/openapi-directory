...
/*
 * OAIRoutes_v2_sip_domain.h
 *
 * 
 */

#ifndef OAIRoutes_v2_sip_domain_H
#define OAIRoutes_v2_sip_domain_H
...
class OAIRoutes_v2_sip_domain : public OAIObject {
public:
    OAIRoutes_v2_sip_domain();
    OAIRoutes_v2_sip_domain(QString json);
    ~OAIRoutes_v2_sip_domain() override;
    ...
    void setSipDomain(const QString &sip_domain);
    bool is_sip_domain_Set() const;
    bool is_sip_domain_Valid() const;
...
private:
    ...
    QString m_sip_domain;
    bool m_sip_domain_isSet;
    bool m_sip_domain_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoutes_v2_sip_domain)

#endif // OAIRoutes_v2_sip_domain_H
