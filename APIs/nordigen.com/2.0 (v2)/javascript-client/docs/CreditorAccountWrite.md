# NordigenAccountInformationServicesApi.CreditorAccountWrite
...
**addressCountry** | [**AddressCountryEnum**](AddressCountryEnum.md) |  | [optional] 
...
**id** | **String** | Unique entry ID | [optional] [readonly] 
