...
/**
 * The CreditorAccountWrite model module.
 * @module model/CreditorAccountWrite
 * @version 2.0 (v2)
 */
class CreditorAccountWrite {
    /**
     * Constructs a new <code>CreditorAccountWrite</code>.
     * Creditor account write serializer.
     * @alias module:model/CreditorAccountWrite
    ...
    constructor(account, currency, name) { 
        ...
        CreditorAccountWrite.initialize(this, account, currency, name);
    }
    ...
    /**
     * Constructs a <code>CreditorAccountWrite</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreditorAccountWrite} obj Optional instance to populate.
     * @return {module:model/CreditorAccountWrite} The populated <code>CreditorAccountWrite</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreditorAccountWrite();
    ...
    /**
     * Validates the JSON data with respect to <code>CreditorAccountWrite</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreditorAccountWrite</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreditorAccountWrite.RequiredProperties) {
...
CreditorAccountWrite.RequiredProperties = ["account", "currency", "name"];

/**
 * Creditor account type identifier
 * @member {String} account
 */
CreditorAccountWrite.prototype['account'] = undefined;

/**
 * @member {module:model/AddressCountryEnum} address_country
 */
CreditorAccountWrite.prototype['address_country'] = undefined;

/**
 * Creditor account address street
 * @member {String} address_street
 */
CreditorAccountWrite.prototype['address_street'] = undefined;

/**
 * Creditor account BICFI Identifier
 * @member {String} agent
 */
CreditorAccountWrite.prototype['agent'] = undefined;

/**
 * Creditor account agent name
 * @member {String} agent_name
 */
CreditorAccountWrite.prototype['agent_name'] = undefined;

/**
 * Creditor account currency
 * @member {String} currency
 */
CreditorAccountWrite.prototype['currency'] = undefined;

/**
 * Unique entry ID
 * @member {String} id
 */
CreditorAccountWrite.prototype['id'] = undefined;

/**
 * an Institution ID for this CreditorAccount
 * @member {String} institution_id
 */
CreditorAccountWrite.prototype['institution_id'] = undefined;

/**
 * Creditor account name
 * @member {String} name
 */
CreditorAccountWrite.prototype['name'] = undefined;

/**
 * Creditor account address post code
 * @member {String} post_code
 */
CreditorAccountWrite.prototype['post_code'] = undefined;

/**
 * Creditor account type  * `IBAN` - IBAN * `SCAN` - SortCodeAccountNumber
 * @member {module:model/TypeEnum} type
 */
CreditorAccountWrite.prototype['type'] = undefined;
...
export default CreditorAccountWrite;
