...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NordigenAccountInformationServicesApi.DebtorAccountWrite();
  });
  ...
  describe('DebtorAccountWrite', function() {
    it('should create an instance of DebtorAccountWrite', function() {
      // uncomment below and update the code to test DebtorAccountWrite
      //var instance = new NordigenAccountInformationServicesApi.DebtorAccountWrite();
      //expect(instance).to.be.a(NordigenAccountInformationServicesApi.DebtorAccountWrite);
    });
    ...
    it('should have the property typeNumber (base name: "type_number")', function() {
