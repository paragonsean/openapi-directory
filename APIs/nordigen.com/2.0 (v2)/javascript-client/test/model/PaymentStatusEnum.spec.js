...
(function(root, factory) {
  ...
  describe('PaymentStatusEnum', function() {
    it('should create an instance of PaymentStatusEnum', function() {
      // uncomment below and update the code to test PaymentStatusEnum
      //var instance = new NordigenAccountInformationServicesApi.PaymentStatusEnum();
      //expect(instance).to.be.a(NordigenAccountInformationServicesApi.PaymentStatusEnum);
    });
