...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NordigenAccountInformationServicesApi.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instance = new NordigenAccountInformationServicesApi.Account();
      //expect(instance).to.be.a(NordigenAccountInformationServicesApi.Account);
    });
