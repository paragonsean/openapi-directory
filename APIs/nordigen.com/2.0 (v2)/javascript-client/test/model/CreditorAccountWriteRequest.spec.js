...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NordigenAccountInformationServicesApi.CreditorAccountWriteRequest();
  });
  ...
  describe('CreditorAccountWriteRequest', function() {
    it('should create an instance of CreditorAccountWriteRequest', function() {
      // uncomment below and update the code to test CreditorAccountWriteRequest
      //var instance = new NordigenAccountInformationServicesApi.CreditorAccountWriteRequest();
      //expect(instance).to.be.a(NordigenAccountInformationServicesApi.CreditorAccountWriteRequest);
    });
