...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NordigenAccountInformationServicesApi.Requisition();
  });
  ...
  describe('Requisition', function() {
    it('should create an instance of Requisition', function() {
      // uncomment below and update the code to test Requisition
      //var instance = new NordigenAccountInformationServicesApi.Requisition();
      //expect(instance).to.be.a(NordigenAccountInformationServicesApi.Requisition);
    });
