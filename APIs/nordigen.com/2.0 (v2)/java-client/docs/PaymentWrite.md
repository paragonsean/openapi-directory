...
|**creditorObject** | [**CreditorAccountWrite**](CreditorAccountWrite.md) | Creditor account |  [optional] |
|**customPaymentId** | **String** | Payment Custom Payment ID |  [optional] |
|**description** | **String** | Payment description |  [optional] |
|**instructedAmount** | [**InstructedAmount**](InstructedAmount.md) | Instructed amount |  |
|**link** | **URI** | Link to initiate authorization with Institution |  [optional] [readonly] |
|**paymentId** | **String** | Payment ID |  [optional] [readonly] |
...
|**requestedExecutionDate** | **LocalDate** | Payment Execution date (for periodic payments) |  [optional] |
|**submitPayment** | **Boolean** | Indicates whether payment should be submitted separately |  [optional] |
