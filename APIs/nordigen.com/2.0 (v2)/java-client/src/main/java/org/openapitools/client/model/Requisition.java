...
public class Requisition {
  ...
  public Requisition accountSelection(Boolean accountSelection) {
  ...
  public Requisition agreement(UUID agreement) {
  ...
  public Requisition institutionId(String institutionId) {
  ...
  public Requisition redirectImmediate(Boolean redirectImmediate) {
  ...
  public Requisition ssn(String ssn) {
    this.ssn = ssn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountSelection, requisition.accountSelection) &&
        Objects.equals(this.accounts, requisition.accounts) &&
        Objects.equals(this.agreement, requisition.agreement) &&
        Objects.equals(this.created, requisition.created) &&
        Objects.equals(this.id, requisition.id) &&
        Objects.equals(this.institutionId, requisition.institutionId) &&
        Objects.equals(this.link, requisition.link) &&
        Objects.equals(this.redirect, requisition.redirect) &&
        Objects.equals(this.redirectImmediate, requisition.redirectImmediate) &&
        Objects.equals(this.reference, requisition.reference) &&
        Objects.equals(this.ssn, requisition.ssn) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to Requisition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Requisition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Requisition is not found in the empty JSON string", Requisition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Requisition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Requisition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Requisition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Requisition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Requisition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Requisition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Requisition.class));

       return (TypeAdapter<T>) new TypeAdapter<Requisition>() {
           @Override
           public void write(JsonWriter out, Requisition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Requisition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Requisition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Requisition
   * @throws IOException if the JSON string is invalid with respect to Requisition
   */
  public static Requisition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Requisition.class);
  }

  /**
   * Convert an instance of Requisition to an JSON string
   *
   * @return JSON string
   */
