 ...
 */
@JsonAdapter(AddressCountryEnum.Adapter.class)
public enum AddressCountryEnum {
  ...
  public static class Adapter extends TypeAdapter<AddressCountryEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final AddressCountryEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AddressCountryEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AddressCountryEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AddressCountryEnum.fromValue(value);
  }
}
