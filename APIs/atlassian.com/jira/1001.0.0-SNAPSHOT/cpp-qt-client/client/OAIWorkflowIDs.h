...
#ifndef OAIWorkflowIDs_H
#define OAIWorkflowIDs_H
...
class OAIWorkflowIDs : public OAIObject {
public:
    OAIWorkflowIDs();
    OAIWorkflowIDs(QString json);
    ~OAIWorkflowIDs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowIDs)

#endif // OAIWorkflowIDs_H
