...
/*
 * OAIWorkflowCondition.h
 *
 * The workflow transition rule conditions tree.
 */

#ifndef OAIWorkflowCondition_H
#define OAIWorkflowCondition_H
...
class OAIWorkflowCondition : public OAIObject {
public:
    OAIWorkflowCondition();
    OAIWorkflowCondition(QString json);
    ~OAIWorkflowCondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkflowCondition)

#endif // OAIWorkflowCondition_H
