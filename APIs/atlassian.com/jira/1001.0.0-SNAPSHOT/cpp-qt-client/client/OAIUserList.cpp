...
qint32 OAIUserList::getEndIndex() const {
    return m_end_index;
}
void OAIUserList::setEndIndex(const qint32 &end_index) {
    m_end_index = end_index;
    m_end_index_isSet = true;
}

bool OAIUserList::is_end_index_Set() const{
    return m_end_index_isSet;
}

bool OAIUserList::is_end_index_Valid() const{
    return m_end_index_isValid;
}

QList<OAIUser> OAIUserList::getItems() const {
    return m_items;
}
void OAIUserList::setItems(const QList<OAIUser> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIUserList::is_items_Set() const{
    return m_items_isSet;
}

bool OAIUserList::is_items_Valid() const{
    return m_items_isValid;
}

qint32 OAIUserList::getMaxResults() const {
    return m_max_results;
}
void OAIUserList::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIUserList::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIUserList::is_max_results_Valid() const{
    return m_max_results_isValid;
}

qint32 OAIUserList::getSize() const {
    return m_size;
}
void OAIUserList::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIUserList::is_size_Set() const{
    return m_size_isSet;
}

bool OAIUserList::is_size_Valid() const{
    return m_size_isValid;
}

qint32 OAIUserList::getStartIndex() const {
    return m_start_index;
}
void OAIUserList::setStartIndex(const qint32 &start_index) {
    m_start_index = start_index;
    m_start_index_isSet = true;
}

bool OAIUserList::is_start_index_Set() const{
    return m_start_index_isSet;
}

bool OAIUserList::is_start_index_Valid() const{
