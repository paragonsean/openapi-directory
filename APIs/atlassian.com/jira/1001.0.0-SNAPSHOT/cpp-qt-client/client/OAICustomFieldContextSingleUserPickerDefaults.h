...
/*
 * OAICustomFieldContextSingleUserPickerDefaults.h
 *
 * Defaults for a User Picker (single) custom field.
 */

#ifndef OAICustomFieldContextSingleUserPickerDefaults_H
#define OAICustomFieldContextSingleUserPickerDefaults_H
...
class OAICustomFieldContextSingleUserPickerDefaults : public OAIObject {
public:
    OAICustomFieldContextSingleUserPickerDefaults();
    OAICustomFieldContextSingleUserPickerDefaults(QString json);
    ~OAICustomFieldContextSingleUserPickerDefaults() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomFieldContextSingleUserPickerDefaults)

#endif // OAICustomFieldContextSingleUserPickerDefaults_H
