...
#ifndef OAI_OAIWorkflowStatusCategoriesApi_H
#define OAI_OAIWorkflowStatusCategoriesApi_H
...
class OAIWorkflowStatusCategoriesApi : public QObject {
    Q_OBJECT

public:
    OAIWorkflowStatusCategoriesApi(const int timeOut = 0);
    ~OAIWorkflowStatusCategoriesApi();
...
Q_SIGNALS:
    ...
    void getStatusCategoriesSignal(QList<OAIStatusCategory> summary);
    void getStatusCategorySignal(OAIStatusCategory summary);


    void getStatusCategoriesSignalFull(OAIHttpRequestWorker *worker, QList<OAIStatusCategory> summary);
    void getStatusCategorySignalFull(OAIHttpRequestWorker *worker, OAIStatusCategory summary);

    Q_DECL_DEPRECATED_X("Use getStatusCategoriesSignalError() instead")
    void getStatusCategoriesSignalE(QList<OAIStatusCategory> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getStatusCategoriesSignalError(QList<OAIStatusCategory> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getStatusCategorySignalError() instead")
    void getStatusCategorySignalE(OAIStatusCategory summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getStatusCategorySignalError(OAIStatusCategory summary, QNetworkReply::NetworkError error_type, const QString &error_str);
