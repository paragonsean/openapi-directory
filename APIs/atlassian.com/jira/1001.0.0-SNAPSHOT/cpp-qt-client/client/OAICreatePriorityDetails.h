...
/*
 * OAICreatePriorityDetails.h
 *
 * Details of an issue priority.
 */

#ifndef OAICreatePriorityDetails_H
#define OAICreatePriorityDetails_H
...
class OAICreatePriorityDetails : public OAIObject {
public:
    OAICreatePriorityDetails();
    OAICreatePriorityDetails(QString json);
    ~OAICreatePriorityDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePriorityDetails)

#endif // OAICreatePriorityDetails_H
