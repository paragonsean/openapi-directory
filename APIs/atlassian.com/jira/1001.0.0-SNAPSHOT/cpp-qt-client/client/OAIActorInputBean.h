...
#ifndef OAIActorInputBean_H
#define OAIActorInputBean_H
...
class OAIActorInputBean : public OAIObject {
public:
    OAIActorInputBean();
    OAIActorInputBean(QString json);
    ~OAIActorInputBean() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActorInputBean)

#endif // OAIActorInputBean_H
