...
/*
 * OAIAssociatedItemBean.h
 *
 * Details of an item associated with the changed record.
 */

#ifndef OAIAssociatedItemBean_H
#define OAIAssociatedItemBean_H
...
class OAIAssociatedItemBean : public OAIObject {
public:
    OAIAssociatedItemBean();
    OAIAssociatedItemBean(QString json);
    ~OAIAssociatedItemBean() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociatedItemBean)

#endif // OAIAssociatedItemBean_H
