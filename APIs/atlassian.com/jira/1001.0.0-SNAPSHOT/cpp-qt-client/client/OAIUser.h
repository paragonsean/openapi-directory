...
namespace OpenAPI {
class OAISimpleListWrapperApplicationRole;
class OAIAvatarUrlsBean;
class OAISimpleListWrapperGroupName;
...
public:
    ...
    OAISimpleListWrapperApplicationRole getApplicationRoles() const;
    void setApplicationRoles(const OAISimpleListWrapperApplicationRole &application_roles);
    bool is_application_roles_Set() const;
    bool is_application_roles_Valid() const;
    ...
    OAISimpleListWrapperGroupName getGroups() const;
    void setGroups(const OAISimpleListWrapperGroupName &groups);
...
private:
    ...
    OAISimpleListWrapperApplicationRole m_application_roles;
    bool m_application_roles_isSet;
    bool m_application_roles_isValid;
    ...
    OAISimpleListWrapperGroupName m_groups;
    bool m_groups_isSet;
