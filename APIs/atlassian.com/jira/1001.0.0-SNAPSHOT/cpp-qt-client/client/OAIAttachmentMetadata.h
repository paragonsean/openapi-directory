...
/*
 * OAIAttachmentMetadata.h
 *
 * Metadata for an issue attachment.
 */

#ifndef OAIAttachmentMetadata_H
#define OAIAttachmentMetadata_H
...
class OAIAttachmentMetadata : public OAIObject {
public:
    OAIAttachmentMetadata();
    OAIAttachmentMetadata(QString json);
    ~OAIAttachmentMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachmentMetadata)

#endif // OAIAttachmentMetadata_H
