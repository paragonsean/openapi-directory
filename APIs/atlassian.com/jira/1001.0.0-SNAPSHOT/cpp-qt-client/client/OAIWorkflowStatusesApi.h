...
#ifndef OAI_OAIWorkflowStatusesApi_H
#define OAI_OAIWorkflowStatusesApi_H
...
class OAIWorkflowStatusesApi : public QObject {
    Q_OBJECT

public:
    OAIWorkflowStatusesApi(const int timeOut = 0);
    ~OAIWorkflowStatusesApi();
...
Q_SIGNALS:
    ...
    void getStatusSignal(OAIStatusDetails summary);
    void getStatusesSignal(QList<OAIStatusDetails> summary);


    void getStatusSignalFull(OAIHttpRequestWorker *worker, OAIStatusDetails summary);
    void getStatusesSignalFull(OAIHttpRequestWorker *worker, QList<OAIStatusDetails> summary);

    Q_DECL_DEPRECATED_X("Use getStatusSignalError() instead")
    void getStatusSignalE(OAIStatusDetails summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getStatusSignalError(OAIStatusDetails summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getStatusesSignalError() instead")
    void getStatusesSignalE(QList<OAIStatusDetails> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getStatusesSignalError(QList<OAIStatusDetails> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
