...
#ifndef OAIPageBeanString_H
#define OAIPageBeanString_H
...
class OAIPageBeanString : public OAIObject {
public:
    OAIPageBeanString();
    OAIPageBeanString(QString json);
    ~OAIPageBeanString() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPageBeanString)

#endif // OAIPageBeanString_H
