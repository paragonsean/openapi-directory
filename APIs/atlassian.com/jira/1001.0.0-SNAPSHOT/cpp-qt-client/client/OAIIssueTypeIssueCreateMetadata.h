...
/*
 * OAIIssueTypeIssueCreateMetadata.h
 *
 * Details of the issue creation metadata for an issue type.
 */

#ifndef OAIIssueTypeIssueCreateMetadata_H
#define OAIIssueTypeIssueCreateMetadata_H
...
class OAIIssueTypeIssueCreateMetadata : public OAIObject {
public:
    OAIIssueTypeIssueCreateMetadata();
    OAIIssueTypeIssueCreateMetadata(QString json);
    ~OAIIssueTypeIssueCreateMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssueTypeIssueCreateMetadata)

#endif // OAIIssueTypeIssueCreateMetadata_H
