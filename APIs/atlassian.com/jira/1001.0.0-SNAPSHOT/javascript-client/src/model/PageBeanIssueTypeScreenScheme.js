...
class PageBeanIssueTypeScreenScheme {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], [IssueTypeScreenScheme]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PageBeanIssueTypeScreenScheme</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PageBeanIssueTypeScreenScheme</code>.
     */
    static validateJSON(data) {
        ...
        if (data['values']) { // data not null
            ...
            for (const item of data['values']) {
                IssueTypeScreenScheme.validateJSON(item);
            };
        }
...
export default PageBeanIssueTypeScreenScheme;
