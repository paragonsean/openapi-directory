...
class ConnectWorkflowTransitionRule {
    ...
    constructor(configuration, id, key) { 
        ...
        ConnectWorkflowTransitionRule.initialize(this, configuration, id, key);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('transition')) {
                obj['transition'] = WorkflowTransition.constructFromObject(data['transition']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectWorkflowTransitionRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectWorkflowTransitionRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConnectWorkflowTransitionRule.RequiredProperties) {
...
ConnectWorkflowTransitionRule.RequiredProperties = ["configuration", "id", "key"];
