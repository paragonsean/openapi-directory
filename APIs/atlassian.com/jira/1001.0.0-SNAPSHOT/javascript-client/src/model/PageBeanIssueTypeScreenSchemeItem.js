...
class PageBeanIssueTypeScreenSchemeItem {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], [IssueTypeScreenSchemeItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PageBeanIssueTypeScreenSchemeItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PageBeanIssueTypeScreenSchemeItem</code>.
     */
    static validateJSON(data) {
        ...
        if (data['values']) { // data not null
            ...
            for (const item of data['values']) {
                IssueTypeScreenSchemeItem.validateJSON(item);
            };
        }
...
export default PageBeanIssueTypeScreenSchemeItem;
