...
class SimpleApplicationPropertyBean {
    ...
    /**
     * Validates the JSON data with respect to <code>SimpleApplicationPropertyBean</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleApplicationPropertyBean</code>.
     */
...
export default SimpleApplicationPropertyBean;
