...
class PageBeanIssueFieldOption {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], [IssueFieldOption]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PageBeanIssueFieldOption</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PageBeanIssueFieldOption</code>.
     */
    static validateJSON(data) {
        ...
        if (data['values']) { // data not null
            ...
            for (const item of data['values']) {
                IssueFieldOption.validateJSON(item);
            };
        }
...
export default PageBeanIssueFieldOption;
