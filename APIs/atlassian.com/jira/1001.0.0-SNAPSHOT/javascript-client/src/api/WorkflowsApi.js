...
export default class WorkflowsApi {
    ...
    */
     ...
     * @callback module:api/WorkflowsApi~createWorkflowCallback
     * @param {String} error Error message, if any.
     * @param {module:model/WorkflowIDs} data The data returned by the service call.
     ...
     * @param {module:model/CreateWorkflowDetails} createWorkflowDetails The workflow details.
     * @param {module:api/WorkflowsApi~createWorkflowCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/WorkflowIDs}
     */
    createWorkflow(createWorkflowDetails, callback) {
      let postBody = createWorkflowDetails;
      // verify the required parameter 'createWorkflowDetails' is set
      if (createWorkflowDetails === undefined || createWorkflowDetails === null) {
        throw new Error("Missing the required parameter 'createWorkflowDetails' when calling createWorkflow");
      }
    ...
    /**
     * Callback function to receive the result of the deleteInactiveWorkflow operation.
     * @callback module:api/WorkflowsApi~deleteInactiveWorkflowCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/WorkflowsApi~deleteInactiveWorkflowCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteInactiveWorkflow(entityId, callback) {
      let postBody = null;
      // verify the required parameter 'entityId' is set
      if (entityId === undefined || entityId === null) {
        throw new Error("Missing the required parameter 'entityId' when calling deleteInactiveWorkflow");
      }
    ...
    /**
     * Callback function to receive the result of the getWorkflowsPaginated operation.
     * @callback module:api/WorkflowsApi~getWorkflowsPaginatedCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Array.<String>} [workflowName] The name of a workflow to return. To include multiple workflows, provide an ampersand-separated list. For example, `workflowName=name1&workflowName=name2`.
     ...
     * @param {module:model/String} [orderBy] [Order](#ordering) the results by a field:   *  `name` Sorts by workflow name.  *  `created` Sorts by create time.  *  `updated` Sorts by update time.
     * @param {Boolean} [isActive] Filters active and inactive workflows.
     * @param {module:api/WorkflowsApi~getWorkflowsPaginatedCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PageBeanWorkflow}
     */
    getWorkflowsPaginated(opts, callback) {
      opts = opts || {};
      let postBody = null;
