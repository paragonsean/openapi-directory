# TheJiraCloudPlatformRestApi.ProjectTypesApi
...
let apiInstance = new TheJiraCloudPlatformRestApi.ProjectTypesApi();
...
> [ProjectType] getAllAccessibleProjectTypes()
...
let apiInstance = new TheJiraCloudPlatformRestApi.ProjectTypesApi();
apiInstance.getAllAccessibleProjectTypes((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [ProjectType] getAllProjectTypes()
