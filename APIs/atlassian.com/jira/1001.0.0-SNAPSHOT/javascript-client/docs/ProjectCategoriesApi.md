# TheJiraCloudPlatformRestApi.ProjectCategoriesApi
...
let apiInstance = new TheJiraCloudPlatformRestApi.ProjectCategoriesApi();
let projectCategory = {"description":"Created Project Category","name":"CREATED"}; // ProjectCategory | 
apiInstance.createProjectCategory(projectCategory, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new TheJiraCloudPlatformRestApi.ProjectCategoriesApi();
let id = 789; // Number | 
let projectCategory = {"description":"Updated Project Category","name":"UPDATED"}; // ProjectCategory | 
apiInstance.updateProjectCategory(id, projectCategory, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
