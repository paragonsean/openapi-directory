# TheJiraCloudPlatformRestApi.SharePermission
...
**id** | **Number** | The unique identifier of the share permission. | [optional] [readonly] 
...
* `project-unknown` (value: `"project-unknown"`)
