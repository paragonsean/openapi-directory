# TheJiraCloudPlatformRestApi.TimeTrackingApi
...
> [TimeTrackingProvider] getAvailableTimeTrackingImplementations()
...
let apiInstance = new TheJiraCloudPlatformRestApi.TimeTrackingApi();
apiInstance.getAvailableTimeTrackingImplementations((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new TheJiraCloudPlatformRestApi.TimeTrackingApi();
apiInstance.getSelectedTimeTrackingImplementation((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new TheJiraCloudPlatformRestApi.TimeTrackingApi();
apiInstance.getSharedTimeTrackingConfiguration((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new TheJiraCloudPlatformRestApi.TimeTrackingApi();
let timeTrackingProvider = {"key":"Jira"}; // TimeTrackingProvider | 
apiInstance.selectTimeTrackingImplementation(timeTrackingProvider, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new TheJiraCloudPlatformRestApi.TimeTrackingApi();
let timeTrackingConfiguration = {"defaultUnit":"hour","timeFormat":"pretty","workingDaysPerWeek":5.5,"workingHoursPerDay":7.6}; // TimeTrackingConfiguration | 
apiInstance.setSharedTimeTrackingConfiguration(timeTrackingConfiguration, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
