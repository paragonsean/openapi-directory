# TheJiraCloudPlatformRestApi.PageBeanIssueTypeToContextMapping
...
**values** | [**[IssueTypeToContextMapping]**](IssueTypeToContextMapping.md) | The list of items. | [optional] [readonly] 
