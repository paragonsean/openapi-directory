# TheJiraCloudPlatformRestApi.ProjectPermissionSchemesApi
...
> PermissionScheme assignPermissionScheme(projectKeyOrId, idBean, opts)
...
let apiInstance = new TheJiraCloudPlatformRestApi.ProjectPermissionSchemesApi();
let projectKeyOrId = "projectKeyOrId_example"; // String | The project ID or project key (case sensitive).
let idBean = {"id":10000}; // IdBean | 
let opts = {
...
apiInstance.assignPermissionScheme(projectKeyOrId, idBean, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> PermissionScheme getAssignedPermissionScheme(projectKeyOrId, opts)
...
let apiInstance = new TheJiraCloudPlatformRestApi.ProjectPermissionSchemesApi();
let projectKeyOrId = "projectKeyOrId_example"; // String | The project ID or project key (case sensitive).
apiInstance.getProjectIssueSecurityScheme(projectKeyOrId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
