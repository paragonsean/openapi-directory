# TheJiraCloudPlatformRestApi.UserPropertiesApi
...
> deleteUserProperty(propertyKey, opts)
...
let apiInstance = new TheJiraCloudPlatformRestApi.UserPropertiesApi();
...
apiInstance.deleteUserProperty(propertyKey, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> EntityProperty getUserProperty(propertyKey, opts)
...
apiInstance.getUserProperty(propertyKey, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> PropertyKeys getUserPropertyKeys(opts)
...
apiInstance.getUserPropertyKeys(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object setUserProperty(propertyKey, body, opts)
...
apiInstance.setUserProperty(propertyKey, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
