# TheJiraCloudPlatformRestApi.IssueAttachmentsApi
...
> [Attachment] addAttachment(issueIdOrKey)
...
let apiInstance = new TheJiraCloudPlatformRestApi.IssueAttachmentsApi();
...
apiInstance.expandAttachmentForHumans(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new TheJiraCloudPlatformRestApi.IssueAttachmentsApi();
let id = "id_example"; // String | The ID of the attachment.
apiInstance.expandAttachmentForMachines(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object getAttachmentContent(id, opts)
...
let id = "id_example"; // String | The ID of the attachment.
let opts = {
  'redirect': true // Boolean | Whether a redirect is provided for the attachment download. Clients that do not automatically follow redirects can set this to `false` to avoid making multiple requests to download the attachment.
};
apiInstance.getAttachmentContent(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object getAttachmentThumbnail(id, opts)
...
let opts = {
  'redirect': true, // Boolean | Whether a redirect is provided for the attachment download. Clients that do not automatically follow redirects can set this to `false` to avoid making multiple requests to download the attachment.
  'fallbackToDefault': true, // Boolean | Whether a default thumbnail is returned when the requested thumbnail is not found.
  'width': 56, // Number | The maximum width to scale the thumbnail to.
  'height': 56 // Number | The maximum height to scale the thumbnail to.
};
apiInstance.getAttachmentThumbnail(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **width** | **Number**| The maximum width to scale the thumbnail to. | [optional] 
 **height** | **Number**| The maximum height to scale the thumbnail to. | [optional] 
