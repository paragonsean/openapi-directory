# TheJiraCloudPlatformRestApi.JiraSettingsApi
...
> [ApplicationProperty] getAdvancedSettings()
...
let apiInstance = new TheJiraCloudPlatformRestApi.JiraSettingsApi();
...
> [ApplicationProperty] getApplicationProperty(opts)
...
apiInstance.getApplicationProperty(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let simpleApplicationPropertyBean = {"id":"jira.home","value":"/var/jira/jira-home"}; // SimpleApplicationPropertyBean | 
apiInstance.setApplicationProperty(id, simpleApplicationPropertyBean, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
