# TheJiraCloudPlatformRestApi.IssueWatchersApi
...
let apiInstance = new TheJiraCloudPlatformRestApi.IssueWatchersApi();
...
apiInstance.addWatcher(issueIdOrKey, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new TheJiraCloudPlatformRestApi.IssueWatchersApi();
let issueList = {"issueIds":["10001","10002","10005"]}; // IssueList | A list of issue IDs.
apiInstance.getIsWatchingIssueBulk(issueList, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
