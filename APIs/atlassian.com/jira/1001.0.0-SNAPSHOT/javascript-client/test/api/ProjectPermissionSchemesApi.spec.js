...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.ProjectPermissionSchemesApi();
  });
  ...
  describe('ProjectPermissionSchemesApi', function() {
    ...
    describe('getProjectIssueSecurityScheme', function() {
      it('should call getProjectIssueSecurityScheme successfully', function(done) {
        //uncomment below and update the code to test getProjectIssueSecurityScheme
        //instance.getProjectIssueSecurityScheme(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
