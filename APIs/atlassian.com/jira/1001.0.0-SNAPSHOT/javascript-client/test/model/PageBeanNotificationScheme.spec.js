...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanNotificationScheme();
  });
  ...
  describe('PageBeanNotificationScheme', function() {
    it('should create an instance of PageBeanNotificationScheme', function() {
      // uncomment below and update the code to test PageBeanNotificationScheme
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanNotificationScheme();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanNotificationScheme);
    });
