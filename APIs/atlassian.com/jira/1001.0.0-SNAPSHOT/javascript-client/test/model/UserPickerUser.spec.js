...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.UserPickerUser();
  });
  ...
  describe('UserPickerUser', function() {
    it('should create an instance of UserPickerUser', function() {
      // uncomment below and update the code to test UserPickerUser
      //var instance = new TheJiraCloudPlatformRestApi.UserPickerUser();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.UserPickerUser);
    });
