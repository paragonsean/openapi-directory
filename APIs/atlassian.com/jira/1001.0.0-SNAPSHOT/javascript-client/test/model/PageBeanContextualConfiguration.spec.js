...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanContextualConfiguration();
  });
  ...
  describe('PageBeanContextualConfiguration', function() {
    it('should create an instance of PageBeanContextualConfiguration', function() {
      // uncomment below and update the code to test PageBeanContextualConfiguration
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanContextualConfiguration();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanContextualConfiguration);
    });
