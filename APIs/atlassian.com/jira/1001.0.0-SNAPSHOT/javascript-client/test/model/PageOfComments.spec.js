...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageOfComments();
  });
  ...
  describe('PageOfComments', function() {
    it('should create an instance of PageOfComments', function() {
      // uncomment below and update the code to test PageOfComments
      //var instance = new TheJiraCloudPlatformRestApi.PageOfComments();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageOfComments);
    });
