...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.AttachmentArchiveImpl();
  });
  ...
  describe('AttachmentArchiveImpl', function() {
    it('should create an instance of AttachmentArchiveImpl', function() {
      // uncomment below and update the code to test AttachmentArchiveImpl
      //var instance = new TheJiraCloudPlatformRestApi.AttachmentArchiveImpl();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.AttachmentArchiveImpl);
    });
