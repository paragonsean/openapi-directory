...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationSchemeProjects();
  });
  ...
  describe('PageBeanFieldConfigurationSchemeProjects', function() {
    it('should create an instance of PageBeanFieldConfigurationSchemeProjects', function() {
      // uncomment below and update the code to test PageBeanFieldConfigurationSchemeProjects
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationSchemeProjects();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationSchemeProjects);
    });
