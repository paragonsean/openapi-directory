...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanResolutionJsonBean();
  });
  ...
  describe('PageBeanResolutionJsonBean', function() {
    it('should create an instance of PageBeanResolutionJsonBean', function() {
      // uncomment below and update the code to test PageBeanResolutionJsonBean
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanResolutionJsonBean();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanResolutionJsonBean);
    });
