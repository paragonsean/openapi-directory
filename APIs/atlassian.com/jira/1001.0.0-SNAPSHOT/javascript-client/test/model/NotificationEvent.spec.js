...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.NotificationEvent();
  });
  ...
  describe('NotificationEvent', function() {
    it('should create an instance of NotificationEvent', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.NotificationEvent();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.NotificationEvent);
    });
