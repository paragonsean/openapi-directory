...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PermissionScheme();
  });
  ...
  describe('PermissionScheme', function() {
    it('should create an instance of PermissionScheme', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.PermissionScheme();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PermissionScheme);
    });
