...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Context();
  });
  ...
  describe('Context', function() {
    it('should create an instance of Context', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Context();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Context);
    });
