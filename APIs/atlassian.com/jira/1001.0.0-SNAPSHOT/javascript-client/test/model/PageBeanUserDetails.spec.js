...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanUserDetails();
  });
  ...
  describe('PageBeanUserDetails', function() {
    it('should create an instance of PageBeanUserDetails', function() {
      // uncomment below and update the code to test PageBeanUserDetails
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanUserDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanUserDetails);
    });
