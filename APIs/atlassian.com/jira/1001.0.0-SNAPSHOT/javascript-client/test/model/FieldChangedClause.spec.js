...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.FieldChangedClause();
  });
  ...
  describe('FieldChangedClause', function() {
    it('should create an instance of FieldChangedClause', function() {
      // uncomment below and update the code to test FieldChangedClause
      //var instance = new TheJiraCloudPlatformRestApi.FieldChangedClause();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.FieldChangedClause);
    });
