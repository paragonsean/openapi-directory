...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.JqlQuery();
  });
  ...
  describe('JqlQuery', function() {
    it('should create an instance of JqlQuery', function() {
      // uncomment below and update the code to test JqlQuery
      //var instance = new TheJiraCloudPlatformRestApi.JqlQuery();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.JqlQuery);
    });
