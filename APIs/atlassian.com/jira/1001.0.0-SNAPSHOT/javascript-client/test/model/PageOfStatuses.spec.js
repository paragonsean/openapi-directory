...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageOfStatuses();
  });
  ...
  describe('PageOfStatuses', function() {
    it('should create an instance of PageOfStatuses', function() {
      // uncomment below and update the code to test PageOfStatuses
      //var instance = new TheJiraCloudPlatformRestApi.PageOfStatuses();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageOfStatuses);
    });
