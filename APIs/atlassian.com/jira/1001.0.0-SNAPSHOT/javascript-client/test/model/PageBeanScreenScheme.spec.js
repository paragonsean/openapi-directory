...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanScreenScheme();
  });
  ...
  describe('PageBeanScreenScheme', function() {
    it('should create an instance of PageBeanScreenScheme', function() {
      // uncomment below and update the code to test PageBeanScreenScheme
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanScreenScheme();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanScreenScheme);
    });
