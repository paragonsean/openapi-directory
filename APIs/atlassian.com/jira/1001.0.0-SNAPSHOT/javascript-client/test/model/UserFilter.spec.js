...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.UserFilter();
  });
  ...
  describe('UserFilter', function() {
    it('should create an instance of UserFilter', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.UserFilter();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.UserFilter);
    });
