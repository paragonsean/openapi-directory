...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.ProjectDetails();
  });
  ...
  describe('ProjectDetails', function() {
    it('should create an instance of ProjectDetails', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.ProjectDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.ProjectDetails);
    });
