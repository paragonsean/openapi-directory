...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeSchemeMapping();
  });
  ...
  describe('PageBeanIssueTypeSchemeMapping', function() {
    it('should create an instance of PageBeanIssueTypeSchemeMapping', function() {
      // uncomment below and update the code to test PageBeanIssueTypeSchemeMapping
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeSchemeMapping();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanIssueTypeSchemeMapping);
    });
