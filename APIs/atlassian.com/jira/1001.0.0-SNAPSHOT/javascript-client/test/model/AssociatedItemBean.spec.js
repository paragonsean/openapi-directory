...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.AssociatedItemBean();
  });
  ...
  describe('AssociatedItemBean', function() {
    it('should create an instance of AssociatedItemBean', function() {
      // uncomment below and update the code to test AssociatedItemBean
      //var instance = new TheJiraCloudPlatformRestApi.AssociatedItemBean();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.AssociatedItemBean);
    });
