...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Resolution();
  });
  ...
  describe('Resolution', function() {
    it('should create an instance of Resolution', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Resolution();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Resolution);
    });
