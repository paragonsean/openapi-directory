...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.ChangeDetails();
  });
  ...
  describe('ChangeDetails', function() {
    it('should create an instance of ChangeDetails', function() {
      // uncomment below and update the code to test ChangeDetails
      //var instance = new TheJiraCloudPlatformRestApi.ChangeDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.ChangeDetails);
    });
    ...
    it('should have the property fromString (base name: "fromString")', function() {
      // uncomment below and update the code to test the property fromString
      //var instance = new TheJiraCloudPlatformRestApi.ChangeDetails();
      //expect(instance).to.be();
    });
