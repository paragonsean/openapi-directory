...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.JqlQueryClause();
  });
  ...
  describe('JqlQueryClause', function() {
    it('should create an instance of JqlQueryClause', function() {
      // uncomment below and update the code to test JqlQueryClause
      //var instance = new TheJiraCloudPlatformRestApi.JqlQueryClause();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.JqlQueryClause);
    });
