...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Avatars();
  });
  ...
  describe('Avatars', function() {
    it('should create an instance of Avatars', function() {
      // uncomment below and update the code to test Avatars
      //var instance = new TheJiraCloudPlatformRestApi.Avatars();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Avatars);
    });
