...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeScheme();
  });
  ...
  describe('PageBeanIssueTypeScheme', function() {
    it('should create an instance of PageBeanIssueTypeScheme', function() {
      // uncomment below and update the code to test PageBeanIssueTypeScheme
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeScheme();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanIssueTypeScheme);
    });
