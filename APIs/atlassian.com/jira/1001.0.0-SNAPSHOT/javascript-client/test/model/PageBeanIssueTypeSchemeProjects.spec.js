...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeSchemeProjects();
  });
  ...
  describe('PageBeanIssueTypeSchemeProjects', function() {
    it('should create an instance of PageBeanIssueTypeSchemeProjects', function() {
      // uncomment below and update the code to test PageBeanIssueTypeSchemeProjects
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeSchemeProjects();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanIssueTypeSchemeProjects);
    });
