...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.ProjectPermissions();
  });
  ...
  describe('ProjectPermissions', function() {
    it('should create an instance of ProjectPermissions', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.ProjectPermissions();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.ProjectPermissions);
    });
