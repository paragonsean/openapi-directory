...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanDashboard();
  });
  ...
  describe('PageBeanDashboard', function() {
    it('should create an instance of PageBeanDashboard', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanDashboard();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanDashboard);
    });
