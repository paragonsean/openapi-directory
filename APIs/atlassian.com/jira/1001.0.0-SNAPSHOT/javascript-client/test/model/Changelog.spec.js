...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Changelog();
  });
  ...
  describe('Changelog', function() {
    it('should create an instance of Changelog', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Changelog();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Changelog);
    });
