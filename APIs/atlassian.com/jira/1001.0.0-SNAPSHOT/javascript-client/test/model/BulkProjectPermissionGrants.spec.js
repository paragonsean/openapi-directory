...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.BulkProjectPermissionGrants();
  });
  ...
  describe('BulkProjectPermissionGrants', function() {
    it('should create an instance of BulkProjectPermissionGrants', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.BulkProjectPermissionGrants();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.BulkProjectPermissionGrants);
    });
