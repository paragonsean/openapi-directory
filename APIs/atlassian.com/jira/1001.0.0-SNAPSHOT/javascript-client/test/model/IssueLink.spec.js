...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.IssueLink();
  });
  ...
  describe('IssueLink', function() {
    it('should create an instance of IssueLink', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.IssueLink();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.IssueLink);
    });
