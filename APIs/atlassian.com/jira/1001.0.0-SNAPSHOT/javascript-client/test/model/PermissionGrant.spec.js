...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PermissionGrant();
  });
  ...
  describe('PermissionGrant', function() {
    it('should create an instance of PermissionGrant', function() {
      // uncomment below and update the code to test PermissionGrant
      //var instance = new TheJiraCloudPlatformRestApi.PermissionGrant();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PermissionGrant);
    });
