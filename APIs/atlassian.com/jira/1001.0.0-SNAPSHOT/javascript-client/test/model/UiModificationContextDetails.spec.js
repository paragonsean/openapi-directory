...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.UiModificationContextDetails();
  });
  ...
  describe('UiModificationContextDetails', function() {
    it('should create an instance of UiModificationContextDetails', function() {
      // uncomment below and update the code to test UiModificationContextDetails
      //var instance = new TheJiraCloudPlatformRestApi.UiModificationContextDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.UiModificationContextDetails);
    });
