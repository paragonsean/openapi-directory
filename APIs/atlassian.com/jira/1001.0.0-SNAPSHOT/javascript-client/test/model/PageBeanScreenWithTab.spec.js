...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanScreenWithTab();
  });
  ...
  describe('PageBeanScreenWithTab', function() {
    it('should create an instance of PageBeanScreenWithTab', function() {
      // uncomment below and update the code to test PageBeanScreenWithTab
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanScreenWithTab();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanScreenWithTab);
    });
