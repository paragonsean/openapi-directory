...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Visibility();
  });
  ...
  describe('Visibility', function() {
    it('should create an instance of Visibility', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Visibility();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Visibility);
    });
