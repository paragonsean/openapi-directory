...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeScreenSchemeItem();
  });
  ...
  describe('PageBeanIssueTypeScreenSchemeItem', function() {
    it('should create an instance of PageBeanIssueTypeScreenSchemeItem', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeScreenSchemeItem();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanIssueTypeScreenSchemeItem);
    });
