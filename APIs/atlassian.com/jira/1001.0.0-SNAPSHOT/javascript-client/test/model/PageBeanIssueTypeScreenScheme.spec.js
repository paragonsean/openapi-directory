...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeScreenScheme();
  });
  ...
  describe('PageBeanIssueTypeScreenScheme', function() {
    it('should create an instance of PageBeanIssueTypeScreenScheme', function() {
      // uncomment below and update the code to test PageBeanIssueTypeScreenScheme
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeScreenScheme();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanIssueTypeScreenScheme);
    });
