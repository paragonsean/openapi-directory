...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Status();
  });
  ...
  describe('Status', function() {
    it('should create an instance of Status', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Status();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Status);
    });
