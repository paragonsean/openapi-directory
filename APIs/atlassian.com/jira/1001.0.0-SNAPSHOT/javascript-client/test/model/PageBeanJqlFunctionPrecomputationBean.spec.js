...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanJqlFunctionPrecomputationBean();
  });
  ...
  describe('PageBeanJqlFunctionPrecomputationBean', function() {
    it('should create an instance of PageBeanJqlFunctionPrecomputationBean', function() {
      // uncomment below and update the code to test PageBeanJqlFunctionPrecomputationBean
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanJqlFunctionPrecomputationBean();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanJqlFunctionPrecomputationBean);
    });
