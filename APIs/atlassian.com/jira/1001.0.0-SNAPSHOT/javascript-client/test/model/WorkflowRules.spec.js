...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.WorkflowRules();
  });
  ...
  describe('WorkflowRules', function() {
    it('should create an instance of WorkflowRules', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.WorkflowRules();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.WorkflowRules);
    });

    it('should have the property conditionsTree (base name: "conditionsTree")', function() {
      // uncomment below and update the code to test the property conditionsTree
      //var instance = new TheJiraCloudPlatformRestApi.WorkflowRules();
