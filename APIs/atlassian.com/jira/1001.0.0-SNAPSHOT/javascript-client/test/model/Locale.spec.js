...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Locale();
  });
  ...
  describe('Locale', function() {
    it('should create an instance of Locale', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Locale();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Locale);
    });
