...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanComponentWithIssueCount();
  });
  ...
  describe('PageBeanComponentWithIssueCount', function() {
    it('should create an instance of PageBeanComponentWithIssueCount', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanComponentWithIssueCount();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanComponentWithIssueCount);
    });
