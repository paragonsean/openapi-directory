...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Application();
  });
  ...
  describe('Application', function() {
    it('should create an instance of Application', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Application();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Application);
    });
