...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanVersion();
  });
  ...
  describe('PageBeanVersion', function() {
    it('should create an instance of PageBeanVersion', function() {
      // uncomment below and update the code to test PageBeanVersion
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanVersion();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanVersion);
    });
