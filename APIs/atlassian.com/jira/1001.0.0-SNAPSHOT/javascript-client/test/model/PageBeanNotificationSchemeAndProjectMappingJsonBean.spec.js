...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanNotificationSchemeAndProjectMappingJsonBean();
  });
  ...
  describe('PageBeanNotificationSchemeAndProjectMappingJsonBean', function() {
    it('should create an instance of PageBeanNotificationSchemeAndProjectMappingJsonBean', function() {
      // uncomment below and update the code to test PageBeanNotificationSchemeAndProjectMappingJsonBean
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanNotificationSchemeAndProjectMappingJsonBean();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanNotificationSchemeAndProjectMappingJsonBean);
    });
