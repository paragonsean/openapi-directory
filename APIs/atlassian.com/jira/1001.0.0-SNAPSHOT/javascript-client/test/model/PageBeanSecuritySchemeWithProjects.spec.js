...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanSecuritySchemeWithProjects();
  });
  ...
  describe('PageBeanSecuritySchemeWithProjects', function() {
    it('should create an instance of PageBeanSecuritySchemeWithProjects', function() {
      // uncomment below and update the code to test PageBeanSecuritySchemeWithProjects
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanSecuritySchemeWithProjects();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanSecuritySchemeWithProjects);
    });
