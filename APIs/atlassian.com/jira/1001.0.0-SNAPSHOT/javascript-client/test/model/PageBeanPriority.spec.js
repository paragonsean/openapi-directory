...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanPriority();
  });
  ...
  describe('PageBeanPriority', function() {
    it('should create an instance of PageBeanPriority', function() {
      // uncomment below and update the code to test PageBeanPriority
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanPriority();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanPriority);
    });
