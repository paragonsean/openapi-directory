...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.WorkflowCondition();
  });
  ...
  describe('WorkflowCondition', function() {
    it('should create an instance of WorkflowCondition', function() {
      // uncomment below and update the code to test WorkflowCondition
      //var instance = new TheJiraCloudPlatformRestApi.WorkflowCondition();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.WorkflowCondition);
    });
