...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanScreen();
  });
  ...
  describe('PageBeanScreen', function() {
    it('should create an instance of PageBeanScreen', function() {
      // uncomment below and update the code to test PageBeanScreen
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanScreen();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanScreen);
    });
