...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.CompoundClause();
  });
  ...
  describe('CompoundClause', function() {
    it('should create an instance of CompoundClause', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.CompoundClause();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.CompoundClause);
    });
