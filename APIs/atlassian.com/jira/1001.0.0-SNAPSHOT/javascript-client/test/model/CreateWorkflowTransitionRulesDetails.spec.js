...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.CreateWorkflowTransitionRulesDetails();
  });
  ...
  describe('CreateWorkflowTransitionRulesDetails', function() {
    it('should create an instance of CreateWorkflowTransitionRulesDetails', function() {
      // uncomment below and update the code to test CreateWorkflowTransitionRulesDetails
      //var instance = new TheJiraCloudPlatformRestApi.CreateWorkflowTransitionRulesDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.CreateWorkflowTransitionRulesDetails);
    });
