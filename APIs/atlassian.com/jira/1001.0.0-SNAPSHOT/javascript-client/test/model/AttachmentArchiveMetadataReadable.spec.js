...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.AttachmentArchiveMetadataReadable();
  });
  ...
  describe('AttachmentArchiveMetadataReadable', function() {
    it('should create an instance of AttachmentArchiveMetadataReadable', function() {
      // uncomment below and update the code to test AttachmentArchiveMetadataReadable
      //var instance = new TheJiraCloudPlatformRestApi.AttachmentArchiveMetadataReadable();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.AttachmentArchiveMetadataReadable);
    });
