...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.IssueTypeDetails();
  });
  ...
  describe('IssueTypeDetails', function() {
    it('should create an instance of IssueTypeDetails', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.IssueTypeDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.IssueTypeDetails);
    });
