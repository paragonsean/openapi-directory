...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Permissions();
  });
  ...
  describe('Permissions', function() {
    it('should create an instance of Permissions', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Permissions();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Permissions);
    });
