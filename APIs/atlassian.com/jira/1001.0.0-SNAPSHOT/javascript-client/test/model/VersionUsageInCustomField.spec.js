...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.VersionUsageInCustomField();
  });
  ...
  describe('VersionUsageInCustomField', function() {
    it('should create an instance of VersionUsageInCustomField', function() {
      // uncomment below and update the code to test VersionUsageInCustomField
      //var instance = new TheJiraCloudPlatformRestApi.VersionUsageInCustomField();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.VersionUsageInCustomField);
    });
