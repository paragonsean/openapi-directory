...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.WorkflowTransitionRules();
  });
  ...
  describe('WorkflowTransitionRules', function() {
    it('should create an instance of WorkflowTransitionRules', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.WorkflowTransitionRules();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.WorkflowTransitionRules);
    });
