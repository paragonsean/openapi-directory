...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.AutoCompleteSuggestions();
  });
  ...
  describe('AutoCompleteSuggestions', function() {
    it('should create an instance of AutoCompleteSuggestions', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.AutoCompleteSuggestions();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.AutoCompleteSuggestions);
    });
