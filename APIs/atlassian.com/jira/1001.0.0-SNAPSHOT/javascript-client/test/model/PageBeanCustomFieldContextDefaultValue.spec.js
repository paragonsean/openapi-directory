...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanCustomFieldContextDefaultValue();
  });
  ...
  describe('PageBeanCustomFieldContextDefaultValue', function() {
    it('should create an instance of PageBeanCustomFieldContextDefaultValue', function() {
      // uncomment below and update the code to test PageBeanCustomFieldContextDefaultValue
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanCustomFieldContextDefaultValue();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanCustomFieldContextDefaultValue);
    });
