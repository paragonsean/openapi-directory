...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.WorkflowOperations();
  });
  ...
  describe('WorkflowOperations', function() {
    it('should create an instance of WorkflowOperations', function() {
      // uncomment below and update the code to test WorkflowOperations
      //var instance = new TheJiraCloudPlatformRestApi.WorkflowOperations();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.WorkflowOperations);
    });
