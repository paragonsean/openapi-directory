...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.LinkGroup();
  });
  ...
  describe('LinkGroup', function() {
    it('should create an instance of LinkGroup', function() {
      // uncomment below and update the code to test LinkGroup
      //var instance = new TheJiraCloudPlatformRestApi.LinkGroup();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.LinkGroup);
    });
