...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.EventNotification();
  });
  ...
  describe('EventNotification', function() {
    it('should create an instance of EventNotification', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.EventNotification();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.EventNotification);
    });
