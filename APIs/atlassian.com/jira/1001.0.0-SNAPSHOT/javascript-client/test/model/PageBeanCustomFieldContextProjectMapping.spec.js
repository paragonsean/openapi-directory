...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanCustomFieldContextProjectMapping();
  });
  ...
  describe('PageBeanCustomFieldContextProjectMapping', function() {
    it('should create an instance of PageBeanCustomFieldContextProjectMapping', function() {
      // uncomment below and update the code to test PageBeanCustomFieldContextProjectMapping
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanCustomFieldContextProjectMapping();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanCustomFieldContextProjectMapping);
    });
