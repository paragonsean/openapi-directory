...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.UserDetails();
  });
  ...
  describe('UserDetails', function() {
    it('should create an instance of UserDetails', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.UserDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.UserDetails);
    });
