...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanCustomFieldContextOption();
  });
  ...
  describe('PageBeanCustomFieldContextOption', function() {
    it('should create an instance of PageBeanCustomFieldContextOption', function() {
      // uncomment below and update the code to test PageBeanCustomFieldContextOption
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanCustomFieldContextOption();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanCustomFieldContextOption);
    });
