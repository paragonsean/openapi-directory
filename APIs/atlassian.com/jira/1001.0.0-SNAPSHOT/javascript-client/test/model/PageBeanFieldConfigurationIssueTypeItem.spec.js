...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationIssueTypeItem();
  });
  ...
  describe('PageBeanFieldConfigurationIssueTypeItem', function() {
    it('should create an instance of PageBeanFieldConfigurationIssueTypeItem', function() {
      // uncomment below and update the code to test PageBeanFieldConfigurationIssueTypeItem
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationIssueTypeItem();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationIssueTypeItem);
    });
