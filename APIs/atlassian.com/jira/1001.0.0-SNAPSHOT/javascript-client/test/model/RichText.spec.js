...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.RichText();
  });
  ...
  describe('RichText', function() {
    it('should create an instance of RichText', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.RichText();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.RichText);
    });
    ...
    it('should have the property finalised (base name: "finalised")', function() {
      // uncomment below and update the code to test the property finalised
      //var instance = new TheJiraCloudPlatformRestApi.RichText();
      //expect(instance).to.be();
    });
