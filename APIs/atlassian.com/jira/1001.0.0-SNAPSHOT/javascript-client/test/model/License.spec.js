...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.License();
  });
  ...
  describe('License', function() {
    it('should create an instance of License', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.License();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.License);
    });
