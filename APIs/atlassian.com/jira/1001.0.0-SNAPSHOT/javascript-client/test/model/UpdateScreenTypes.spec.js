...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.UpdateScreenTypes();
  });
  ...
  describe('UpdateScreenTypes', function() {
    it('should create an instance of UpdateScreenTypes', function() {
      // uncomment below and update the code to test UpdateScreenTypes
      //var instance = new TheJiraCloudPlatformRestApi.UpdateScreenTypes();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.UpdateScreenTypes);
    });
