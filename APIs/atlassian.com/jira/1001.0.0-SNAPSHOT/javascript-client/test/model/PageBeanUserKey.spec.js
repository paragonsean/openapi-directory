...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanUserKey();
  });
  ...
  describe('PageBeanUserKey', function() {
    it('should create an instance of PageBeanUserKey', function() {
      // uncomment below and update the code to test PageBeanUserKey
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanUserKey();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanUserKey);
    });
