...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.WorkflowCompoundCondition();
  });
  ...
  describe('WorkflowCompoundCondition', function() {
    it('should create an instance of WorkflowCompoundCondition', function() {
      // uncomment below and update the code to test WorkflowCompoundCondition
      //var instance = new TheJiraCloudPlatformRestApi.WorkflowCompoundCondition();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.WorkflowCompoundCondition);
    });
