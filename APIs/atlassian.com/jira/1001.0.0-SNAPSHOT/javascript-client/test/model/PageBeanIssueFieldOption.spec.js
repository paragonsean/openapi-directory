...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanIssueFieldOption();
  });
  ...
  describe('PageBeanIssueFieldOption', function() {
    it('should create an instance of PageBeanIssueFieldOption', function() {
      // uncomment below and update the code to test PageBeanIssueFieldOption
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanIssueFieldOption();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanIssueFieldOption);
    });
