...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanSecurityLevelMember();
  });
  ...
  describe('PageBeanSecurityLevelMember', function() {
    it('should create an instance of PageBeanSecurityLevelMember', function() {
      // uncomment below and update the code to test PageBeanSecurityLevelMember
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanSecurityLevelMember();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanSecurityLevelMember);
    });
