...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanCustomFieldContext();
  });
  ...
  describe('PageBeanCustomFieldContext', function() {
    it('should create an instance of PageBeanCustomFieldContext', function() {
      // uncomment below and update the code to test PageBeanCustomFieldContext
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanCustomFieldContext();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanCustomFieldContext);
    });
