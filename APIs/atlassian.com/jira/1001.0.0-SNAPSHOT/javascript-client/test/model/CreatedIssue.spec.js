...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.CreatedIssue();
  });
  ...
  describe('CreatedIssue', function() {
    it('should create an instance of CreatedIssue', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.CreatedIssue();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.CreatedIssue);
    });
