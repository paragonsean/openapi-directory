...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationItem();
  });
  ...
  describe('PageBeanFieldConfigurationItem', function() {
    it('should create an instance of PageBeanFieldConfigurationItem', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationItem();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationItem);
    });
