...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Attachment();
  });
  ...
  describe('Attachment', function() {
    it('should create an instance of Attachment', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Attachment();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Attachment);
    });
