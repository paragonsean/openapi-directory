...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PermissionHolder();
  });
  ...
  describe('PermissionHolder', function() {
    it('should create an instance of PermissionHolder', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.PermissionHolder();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PermissionHolder);
    });
