...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Priority();
  });
  ...
  describe('Priority', function() {
    it('should create an instance of Priority', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Priority();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Priority);
    });
