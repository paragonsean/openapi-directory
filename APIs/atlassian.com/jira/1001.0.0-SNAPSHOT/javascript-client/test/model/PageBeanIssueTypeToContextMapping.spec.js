...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeToContextMapping();
  });
  ...
  describe('PageBeanIssueTypeToContextMapping', function() {
    it('should create an instance of PageBeanIssueTypeToContextMapping', function() {
      // uncomment below and update the code to test PageBeanIssueTypeToContextMapping
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanIssueTypeToContextMapping();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanIssueTypeToContextMapping);
    });
