...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanContext();
  });
  ...
  describe('PageBeanContext', function() {
    it('should create an instance of PageBeanContext', function() {
      // uncomment below and update the code to test PageBeanContext
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanContext();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanContext);
    });
