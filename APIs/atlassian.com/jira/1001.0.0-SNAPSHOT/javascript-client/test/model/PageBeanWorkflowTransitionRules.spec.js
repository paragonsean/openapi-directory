...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanWorkflowTransitionRules();
  });
  ...
  describe('PageBeanWorkflowTransitionRules', function() {
    it('should create an instance of PageBeanWorkflowTransitionRules', function() {
      // uncomment below and update the code to test PageBeanWorkflowTransitionRules
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanWorkflowTransitionRules();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanWorkflowTransitionRules);
    });
