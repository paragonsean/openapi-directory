...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.OrderOfIssueTypes();
  });
  ...
  describe('OrderOfIssueTypes', function() {
    it('should create an instance of OrderOfIssueTypes', function() {
      // uncomment below and update the code to test OrderOfIssueTypes
      //var instance = new TheJiraCloudPlatformRestApi.OrderOfIssueTypes();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.OrderOfIssueTypes);
    });
