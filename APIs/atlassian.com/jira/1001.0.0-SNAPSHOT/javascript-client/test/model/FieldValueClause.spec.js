...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.FieldValueClause();
  });
  ...
  describe('FieldValueClause', function() {
    it('should create an instance of FieldValueClause', function() {
      // uncomment below and update the code to test FieldValueClause
      //var instance = new TheJiraCloudPlatformRestApi.FieldValueClause();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.FieldValueClause);
    });
