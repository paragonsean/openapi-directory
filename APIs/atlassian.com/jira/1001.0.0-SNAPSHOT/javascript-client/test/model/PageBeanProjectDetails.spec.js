...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanProjectDetails();
  });
  ...
  describe('PageBeanProjectDetails', function() {
    it('should create an instance of PageBeanProjectDetails', function() {
      // uncomment below and update the code to test PageBeanProjectDetails
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanProjectDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanProjectDetails);
    });
