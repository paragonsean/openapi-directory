...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationScheme();
  });
  ...
  describe('PageBeanFieldConfigurationScheme', function() {
    it('should create an instance of PageBeanFieldConfigurationScheme', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationScheme();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanFieldConfigurationScheme);
    });
