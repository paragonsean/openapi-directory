...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanFilterDetails();
  });
  ...
  describe('PageBeanFilterDetails', function() {
    it('should create an instance of PageBeanFilterDetails', function() {
      // uncomment below and update the code to test PageBeanFilterDetails
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanFilterDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanFilterDetails);
    });
