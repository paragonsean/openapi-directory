...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanUiModificationDetails();
  });
  ...
  describe('PageBeanUiModificationDetails', function() {
    it('should create an instance of PageBeanUiModificationDetails', function() {
      // uncomment below and update the code to test PageBeanUiModificationDetails
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanUiModificationDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanUiModificationDetails);
    });
