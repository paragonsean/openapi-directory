...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanContextForProjectAndIssueType();
  });
  ...
  describe('PageBeanContextForProjectAndIssueType', function() {
    it('should create an instance of PageBeanContextForProjectAndIssueType', function() {
      // uncomment below and update the code to test PageBeanContextForProjectAndIssueType
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanContextForProjectAndIssueType();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanContextForProjectAndIssueType);
    });
