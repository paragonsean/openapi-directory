...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanSecurityLevel();
  });
  ...
  describe('PageBeanSecurityLevel', function() {
    it('should create an instance of PageBeanSecurityLevel', function() {
      // uncomment below and update the code to test PageBeanSecurityLevel
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanSecurityLevel();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanSecurityLevel);
    });
