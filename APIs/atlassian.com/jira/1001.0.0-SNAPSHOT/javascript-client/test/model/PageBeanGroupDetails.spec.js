...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanGroupDetails();
  });
  ...
  describe('PageBeanGroupDetails', function() {
    it('should create an instance of PageBeanGroupDetails', function() {
      // uncomment below and update the code to test PageBeanGroupDetails
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanGroupDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanGroupDetails);
    });
