...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.ScreenTypes();
  });
  ...
  describe('ScreenTypes', function() {
    it('should create an instance of ScreenTypes', function() {
      // uncomment below and update the code to test ScreenTypes
      //var instance = new TheJiraCloudPlatformRestApi.ScreenTypes();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.ScreenTypes);
    });
