...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.SearchResults();
  });
  ...
  describe('SearchResults', function() {
    it('should create an instance of SearchResults', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.SearchResults();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.SearchResults);
    });
