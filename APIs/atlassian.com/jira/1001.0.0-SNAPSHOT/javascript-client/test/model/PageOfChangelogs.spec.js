...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageOfChangelogs();
  });
  ...
  describe('PageOfChangelogs', function() {
    it('should create an instance of PageOfChangelogs', function() {
      // uncomment below and update the code to test PageOfChangelogs
      //var instance = new TheJiraCloudPlatformRestApi.PageOfChangelogs();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageOfChangelogs);
    });
