...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanUser();
  });
  ...
  describe('PageBeanUser', function() {
    it('should create an instance of PageBeanUser', function() {
      // uncomment below and update the code to test PageBeanUser
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanUser();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanUser);
    });
