...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanField();
  });
  ...
  describe('PageBeanField', function() {
    it('should create an instance of PageBeanField', function() {
      // uncomment below and update the code to test PageBeanField
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanField();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanField);
    });
