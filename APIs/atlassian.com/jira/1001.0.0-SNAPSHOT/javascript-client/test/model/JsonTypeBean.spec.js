...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.JsonTypeBean();
  });
  ...
  describe('JsonTypeBean', function() {
    it('should create an instance of JsonTypeBean', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.JsonTypeBean();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.JsonTypeBean);
    });
