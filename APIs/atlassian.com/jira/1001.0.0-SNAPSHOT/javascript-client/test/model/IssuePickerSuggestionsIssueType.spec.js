...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.IssuePickerSuggestionsIssueType();
  });
  ...
  describe('IssuePickerSuggestionsIssueType', function() {
    it('should create an instance of IssuePickerSuggestionsIssueType', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.IssuePickerSuggestionsIssueType();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.IssuePickerSuggestionsIssueType);
    });
