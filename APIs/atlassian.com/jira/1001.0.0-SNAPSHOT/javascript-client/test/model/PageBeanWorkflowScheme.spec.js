...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanWorkflowScheme();
  });
  ...
  describe('PageBeanWorkflowScheme', function() {
    it('should create an instance of PageBeanWorkflowScheme', function() {
      // uncomment below and update the code to test PageBeanWorkflowScheme
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanWorkflowScheme();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanWorkflowScheme);
    });
