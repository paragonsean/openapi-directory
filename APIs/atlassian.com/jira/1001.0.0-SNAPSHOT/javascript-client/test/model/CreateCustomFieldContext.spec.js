...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.CreateCustomFieldContext();
  });
  ...
  describe('CreateCustomFieldContext', function() {
    it('should create an instance of CreateCustomFieldContext', function() {
      // uncomment below and update the code to test CreateCustomFieldContext
      //var instance = new TheJiraCloudPlatformRestApi.CreateCustomFieldContext();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.CreateCustomFieldContext);
    });
