...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.CreateWorkflowDetails();
  });
  ...
  describe('CreateWorkflowDetails', function() {
    it('should create an instance of CreateWorkflowDetails', function() {
      // uncomment below and update the code to test CreateWorkflowDetails
      //var instance = new TheJiraCloudPlatformRestApi.CreateWorkflowDetails();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.CreateWorkflowDetails);
    });
