...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.CreateWorkflowCondition();
  });
  ...
  describe('CreateWorkflowCondition', function() {
    it('should create an instance of CreateWorkflowCondition', function() {
      // uncomment below and update the code to test CreateWorkflowCondition
      //var instance = new TheJiraCloudPlatformRestApi.CreateWorkflowCondition();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.CreateWorkflowCondition);
    });
