...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.FieldConfigurationItem();
  });
  ...
  describe('FieldConfigurationItem', function() {
    it('should create an instance of FieldConfigurationItem', function() {
      // uncomment below and update the code to test FieldConfigurationItem
      //var instance = new TheJiraCloudPlatformRestApi.FieldConfigurationItem();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.FieldConfigurationItem);
    });
