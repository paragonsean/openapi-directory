...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.HealthCheckResult();
  });
  ...
  describe('HealthCheckResult', function() {
    it('should create an instance of HealthCheckResult', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.HealthCheckResult();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.HealthCheckResult);
    });
