...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanIssueSecuritySchemeToProjectMapping();
  });
  ...
  describe('PageBeanIssueSecuritySchemeToProjectMapping', function() {
    it('should create an instance of PageBeanIssueSecuritySchemeToProjectMapping', function() {
      // uncomment below and update the code to test PageBeanIssueSecuritySchemeToProjectMapping
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanIssueSecuritySchemeToProjectMapping();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanIssueSecuritySchemeToProjectMapping);
    });
