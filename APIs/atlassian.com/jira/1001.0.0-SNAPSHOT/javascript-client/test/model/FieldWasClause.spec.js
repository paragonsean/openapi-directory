...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.FieldWasClause();
  });
  ...
  describe('FieldWasClause', function() {
    it('should create an instance of FieldWasClause', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.FieldWasClause();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.FieldWasClause);
    });
