...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.IssueTypeScreenSchemeItem();
  });
  ...
  describe('IssueTypeScreenSchemeItem', function() {
    it('should create an instance of IssueTypeScreenSchemeItem', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.IssueTypeScreenSchemeItem();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.IssueTypeScreenSchemeItem);
    });
