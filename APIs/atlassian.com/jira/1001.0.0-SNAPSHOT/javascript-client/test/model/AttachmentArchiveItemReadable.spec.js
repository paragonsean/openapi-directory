...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.AttachmentArchiveItemReadable();
  });
  ...
  describe('AttachmentArchiveItemReadable', function() {
    it('should create an instance of AttachmentArchiveItemReadable', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.AttachmentArchiveItemReadable();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.AttachmentArchiveItemReadable);
    });
