...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanIssueSecurityLevelMember();
  });
  ...
  describe('PageBeanIssueSecurityLevelMember', function() {
    it('should create an instance of PageBeanIssueSecurityLevelMember', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanIssueSecurityLevelMember();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanIssueSecurityLevelMember);
    });
