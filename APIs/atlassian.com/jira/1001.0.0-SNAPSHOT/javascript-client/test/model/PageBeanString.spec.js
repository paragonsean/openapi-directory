...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanString();
  });
  ...
  describe('PageBeanString', function() {
    it('should create an instance of PageBeanString', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanString();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanString);
    });
