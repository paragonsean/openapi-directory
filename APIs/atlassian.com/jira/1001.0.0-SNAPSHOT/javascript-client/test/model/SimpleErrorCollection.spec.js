...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.SimpleErrorCollection();
  });
  ...
  describe('SimpleErrorCollection', function() {
    it('should create an instance of SimpleErrorCollection', function() {
      // uncomment below and update the code to test SimpleErrorCollection
      //var instance = new TheJiraCloudPlatformRestApi.SimpleErrorCollection();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.SimpleErrorCollection);
    });
