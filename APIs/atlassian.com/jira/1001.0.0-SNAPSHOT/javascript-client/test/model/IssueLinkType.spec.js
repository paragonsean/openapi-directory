...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.IssueLinkType();
  });
  ...
  describe('IssueLinkType', function() {
    it('should create an instance of IssueLinkType', function() {
      // uncomment below and update the code to test IssueLinkType
      //var instance = new TheJiraCloudPlatformRestApi.IssueLinkType();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.IssueLinkType);
    });
