...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.IssueTypeWithStatus();
  });
  ...
  describe('IssueTypeWithStatus', function() {
    it('should create an instance of IssueTypeWithStatus', function() {
      // uncomment below and update the code to test IssueTypeWithStatus
      //var instance = new TheJiraCloudPlatformRestApi.IssueTypeWithStatus();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.IssueTypeWithStatus);
    });
