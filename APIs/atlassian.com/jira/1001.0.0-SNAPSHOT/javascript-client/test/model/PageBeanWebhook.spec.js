...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanWebhook();
  });
  ...
  describe('PageBeanWebhook', function() {
    it('should create an instance of PageBeanWebhook', function() {
      // uncomment below and update the code to test PageBeanWebhook
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanWebhook();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanWebhook);
    });
