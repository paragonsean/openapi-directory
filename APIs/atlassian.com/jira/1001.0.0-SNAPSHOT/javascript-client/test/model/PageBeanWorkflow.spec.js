...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanWorkflow();
  });
  ...
  describe('PageBeanWorkflow', function() {
    it('should create an instance of PageBeanWorkflow', function() {
      // uncomment below and update the code to test PageBeanWorkflow
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanWorkflow();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanWorkflow);
    });
