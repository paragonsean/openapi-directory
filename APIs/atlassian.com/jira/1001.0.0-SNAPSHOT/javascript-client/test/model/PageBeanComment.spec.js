...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageBeanComment();
  });
  ...
  describe('PageBeanComment', function() {
    it('should create an instance of PageBeanComment', function() {
      // uncomment below and update the code to test PageBeanComment
      //var instance = new TheJiraCloudPlatformRestApi.PageBeanComment();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageBeanComment);
    });
