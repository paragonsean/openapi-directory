...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageOfWorklogs();
  });
  ...
  describe('PageOfWorklogs', function() {
    it('should create an instance of PageOfWorklogs', function() {
      // uncomment below and update the code to test PageOfWorklogs
      //var instance = new TheJiraCloudPlatformRestApi.PageOfWorklogs();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageOfWorklogs);
    });
