...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.PageOfDashboards();
  });
  ...
  describe('PageOfDashboards', function() {
    it('should create an instance of PageOfDashboards', function() {
      // uncomment below and update the code to test PageOfDashboards
      //var instance = new TheJiraCloudPlatformRestApi.PageOfDashboards();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.PageOfDashboards);
    });
