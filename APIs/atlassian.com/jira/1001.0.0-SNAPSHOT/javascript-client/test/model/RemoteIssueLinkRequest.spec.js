...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.RemoteIssueLinkRequest();
  });
  ...
  describe('RemoteIssueLinkRequest', function() {
    it('should create an instance of RemoteIssueLinkRequest', function() {
      // uncomment below and update the code to test RemoteIssueLinkRequest
      //var instance = new TheJiraCloudPlatformRestApi.RemoteIssueLinkRequest();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.RemoteIssueLinkRequest);
    });
