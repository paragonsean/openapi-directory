...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.Transitions();
  });
  ...
  describe('Transitions', function() {
    it('should create an instance of Transitions', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.Transitions();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.Transitions);
    });
