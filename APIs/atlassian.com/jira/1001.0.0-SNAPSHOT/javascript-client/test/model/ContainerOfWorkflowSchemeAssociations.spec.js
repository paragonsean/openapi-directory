...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheJiraCloudPlatformRestApi.ContainerOfWorkflowSchemeAssociations();
  });
  ...
  describe('ContainerOfWorkflowSchemeAssociations', function() {
    it('should create an instance of ContainerOfWorkflowSchemeAssociations', function() {
      ...
      //var instance = new TheJiraCloudPlatformRestApi.ContainerOfWorkflowSchemeAssociations();
      //expect(instance).to.be.a(TheJiraCloudPlatformRestApi.ContainerOfWorkflowSchemeAssociations);
    });
