...
public class StatusUpdate {
   ...
   * @return the StatusUpdate instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatusUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatusUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StatusUpdate>() {
           ...
           public StatusUpdate read(JsonReader in) throws IOException {
             ...
             StatusUpdate instance = thisAdapter.fromJsonTree(jsonObj);
