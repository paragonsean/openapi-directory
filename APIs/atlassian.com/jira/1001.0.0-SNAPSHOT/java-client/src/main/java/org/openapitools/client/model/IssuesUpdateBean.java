...
public class IssuesUpdateBean {
   ...
   * @return the IssuesUpdateBean instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssuesUpdateBean
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssuesUpdateBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
