...
|------------ | ------------- | ------------- | -------------|
|**application** | **Application** | Details of the remote application the linked item is in. For example, trello. |  [optional] |
...
|**_object** | **RemoteObject** | Details of the item linked to. |  |
