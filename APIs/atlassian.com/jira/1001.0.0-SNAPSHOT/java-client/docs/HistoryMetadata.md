...
|**actor** | **HistoryMetadataParticipant** | Details of the user whose action created the history record. |  [optional] |
|**cause** | **HistoryMetadataParticipant** | Details of the cause that triggered the creation the history record. |  [optional] |
...
|**generator** | **HistoryMetadataParticipant** | Details of the system that generated the history record. |  [optional] |
