...
class PageBeanCustomFieldContextDefaultValue(Model):
    ...
    def __init__(self, is_last: bool=None, max_results: int=None, next_page: str=None, _self: str=None, start_at: int=None, total: int=None, values: List[CustomFieldContextDefaultValue]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PageBeanCustomFieldContextDefaultValue':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PageBeanCustomFieldContextDefaultValue of this PageBeanCustomFieldContextDefaultValue.
        """
