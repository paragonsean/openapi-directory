...
async def get_application_property(request: web.Request, key=None, permission_level=None, key_filter=None) -> web.Response:
...
async def set_application_property(request: web.Request, id, body) -> web.Response:
    ...
    """
    body = SimpleApplicationPropertyBean.from_dict(body)
    return web.Response(status=200)
