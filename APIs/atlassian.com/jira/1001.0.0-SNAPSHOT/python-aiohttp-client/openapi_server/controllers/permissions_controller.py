...
async def get_bulk_permissions(request: web.Request, body) -> web.Response:
    ...
    """
    body = BulkPermissionsRequestBean.from_dict(body)
    return web.Response(status=200)


async def get_my_permissions(request: web.Request, project_key=None, project_id=None, issue_key=None, issue_id=None, permissions=None, project_uuid=None, project_configuration_uuid=None, comment_id=None) -> web.Response:
    """Get my permissions
...
async def get_permitted_projects(request: web.Request, body) -> web.Response:
    ...
    """
    body = PermissionsKeysBean.from_dict(body)
    return web.Response(status=200)
