...
async def test_create_issue_type(client):
    ...
    Create issue type
    """
    body = {"hierarchyLevel":0,"name":"name","description":"description","type":"subtask"}
    headers = { 
...
async def test_create_issue_type_avatar(client):
    ...
    response = await client.request(
        method='POST',
        path='/rest/api/3/issuetype/{id}/avatar2'.format(id='id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_delete_issue_type(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/rest/api/3/issuetype/{id}'.format(id='id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_alternative_issue_types(client):
    ...
    response = await client.request(
        method='GET',
        path='/rest/api/3/issuetype/{id}/alternatives'.format(id='id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_issue_type(client):
...
async def test_update_issue_type(client):
    ...
    Update issue type
    """
    body = {"avatarId":0,"name":"name","description":"description"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': 'Bearer special-key',
