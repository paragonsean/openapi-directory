...
/*
 * OAIMarketChangeMessage.h
 *
 * 
 */

#ifndef OAIMarketChangeMessage_H
#define OAIMarketChangeMessage_H
...
namespace OpenAPI {
class OAIMarketChange;

class OAIMarketChangeMessage : public OAIObject {
public:
    OAIMarketChangeMessage();
    OAIMarketChangeMessage(QString json);
    ~OAIMarketChangeMessage() override;
    ...
    QList<OAIMarketChange> getMc() const;
    void setMc(const QList<OAIMarketChange> &mc);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarketChangeMessage)

#endif // OAIMarketChangeMessage_H
