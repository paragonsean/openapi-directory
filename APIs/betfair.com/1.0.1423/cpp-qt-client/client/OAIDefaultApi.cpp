...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://stream-api.betfair.com:443/api"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("requestPost", defaultConf);
    _serverIndices.insert("requestPost", 0);
}
...
void OAIDefaultApi::requestPost(const OAIAllRequestTypesExample &oai_all_request_types_example) {
    QString fullPath = QString(_serverConfigs["requestPost"][_serverIndices.value("requestPost")].URL()+"/request");
...

    {
        ...
        QByteArray output = oai_all_request_types_example.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::requestPostCallback);
...
void OAIDefaultApi::requestPostCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIAllResponseTypesExample output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT requestPostSignal(output);
        Q_EMIT requestPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT requestPostSignalE(output, error_type, error_str);
        Q_EMIT requestPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT requestPostSignalError(output, error_type, error_str);
        Q_EMIT requestPostSignalErrorFull(worker, error_type, error_str);
    }
}
