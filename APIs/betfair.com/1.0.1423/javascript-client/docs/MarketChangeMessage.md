# BetfairExchangeStreamingApi.MarketChangeMessage
...
**mc** | [**[MarketChange]**](MarketChange.md) | MarketChanges - the modifications to markets (will be null on a heartbeat | [optional] 
