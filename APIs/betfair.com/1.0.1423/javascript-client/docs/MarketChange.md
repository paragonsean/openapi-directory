# BetfairExchangeStreamingApi.MarketChange
...
**rc** | [**[RunnerChange]**](RunnerChange.md) | Runner Changes - a list of changes to runners (or null if un-changed) | [optional] 
**tv** | **Number** | The total amount matched across the market. This value is truncated at 2dp (or null if un-changed) | [optional] 
