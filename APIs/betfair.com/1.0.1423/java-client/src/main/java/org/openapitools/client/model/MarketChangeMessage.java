...
import org.openapitools.client.model.MarketChange;
...
public class MarketChangeMessage extends ResponseMessage {
  ...
  private List<MarketChange> mc = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clk, marketChangeMessage.clk) &&
        Objects.equals(this.conflateMs, marketChangeMessage.conflateMs) &&
        Objects.equals(this.ct, marketChangeMessage.ct) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clk, conflateMs, ct, heartbeatMs, initialClk, mc, pt, segmentType, status, super.hashCode());
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MarketChangeMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MarketChangeMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MarketChangeMessage is not found in the empty JSON string", MarketChangeMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MarketChangeMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MarketChangeMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MarketChangeMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MarketChangeMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MarketChangeMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MarketChangeMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<MarketChangeMessage>() {
           @Override
           public void write(JsonWriter out, MarketChangeMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MarketChangeMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MarketChangeMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MarketChangeMessage
   * @throws IOException if the JSON string is invalid with respect to MarketChangeMessage
   */
  public static MarketChangeMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MarketChangeMessage.class);
  }

  /**
   * Convert an instance of MarketChangeMessage to an JSON string
   *
   * @return JSON string
   */
