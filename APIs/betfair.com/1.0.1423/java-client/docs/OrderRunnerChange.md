...
|**mb** | **List&lt;List&lt;Double&gt;&gt;** | Matched Backs - matched amounts by distinct matched price on the Back side for this runner (selection) |  [optional] |
|**ml** | **List&lt;List&lt;Double&gt;&gt;** | Matched Lays - matched amounts by distinct matched price on the Lay side for this runner (selection) |  [optional] |
