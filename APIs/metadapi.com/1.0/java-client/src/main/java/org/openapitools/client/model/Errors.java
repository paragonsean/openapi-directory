...
public class Errors {
  ...
  private Set<ErrorsErrorsInner> errors = new LinkedHashSet<>();

  public Errors() {
  }

  public Errors errors(Set<ErrorsErrorsInner> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public Set<ErrorsErrorsInner> getErrors() {
    return errors;
  }

  public void setErrors(Set<ErrorsErrorsInner> errors) {
    this.errors = errors;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayerrors.size(); i++) {
        ErrorsErrorsInner.validateJsonElement(jsonArrayerrors.get(i));
      };
  }
