...
|------------ | ------------- | ------------- | -------------|
|**cityAliases** | [**Set&lt;ZipcodeCityAliasesInner&gt;**](ZipcodeCityAliasesInner.md) | Array that contains all the city aliases for the given zip code. |  |
...
|**landAreaKm2** | **BigDecimal** | Zip Code Land Area in square kilometers. |  |
|**landAreaMi2** | **BigDecimal** | Zip Code Land area in Square Miles |  |
|**latitude** | **BigDecimal** | Zip Code Latitude |  [optional] |
|**longitude** | **BigDecimal** | Zip Code Longitude |  [optional] |
...
|**waterAreaKm2** | **BigDecimal** | Zip Code water area in Square kilometers. |  |
|**waterAreaMi2** | **BigDecimal** | Zip Code Water Area in Square Miles |  |
...
|**zipCodeStatistics** | [**Set&lt;ZipcodeZipCodeStatisticsInner&gt;**](ZipcodeZipCodeStatisticsInner.md) | Available statistics by year of the Zip Code. |  |
