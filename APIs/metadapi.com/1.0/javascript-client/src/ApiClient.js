...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://global.metadapi.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://global.metadapi.com
         */
        ...
        this.authentications = {
            'subscription-key': {type: 'apiKey', 'in': 'header', name: 'Ocp-Apim-Subscription-Key'}
        }
