...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.GetRadius200ResponseLinks();
  });
  ...
  describe('GetRadius200ResponseLinks', function() {
    it('should create an instance of GetRadius200ResponseLinks', function() {
      // uncomment below and update the code to test GetRadius200ResponseLinks
      //var instance = new ZipCodeDataApi.GetRadius200ResponseLinks();
      //expect(instance).to.be.a(ZipCodeDataApi.GetRadius200ResponseLinks);
    });
