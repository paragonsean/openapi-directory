...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.GetMsagroups200ResponseDataInnerStatesInner();
  });
  ...
  describe('GetMsagroups200ResponseDataInnerStatesInner', function() {
    it('should create an instance of GetMsagroups200ResponseDataInnerStatesInner', function() {
      // uncomment below and update the code to test GetMsagroups200ResponseDataInnerStatesInner
      //var instance = new ZipCodeDataApi.GetMsagroups200ResponseDataInnerStatesInner();
      //expect(instance).to.be.a(ZipCodeDataApi.GetMsagroups200ResponseDataInnerStatesInner);
    });
