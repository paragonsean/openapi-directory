...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner();
  });
  ...
  describe('GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner', function() {
    it('should create an instance of GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner', function() {
      // uncomment below and update the code to test GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner
      //var instance = new ZipCodeDataApi.GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner();
      //expect(instance).to.be.a(ZipCodeDataApi.GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner);
    });
