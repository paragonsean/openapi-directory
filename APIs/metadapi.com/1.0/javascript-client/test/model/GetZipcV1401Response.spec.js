...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.GetZipcV1401Response();
  });
  ...
  describe('GetZipcV1401Response', function() {
    it('should create an instance of GetZipcV1401Response', function() {
      // uncomment below and update the code to test GetZipcV1401Response
      //var instance = new ZipCodeDataApi.GetZipcV1401Response();
      //expect(instance).to.be.a(ZipCodeDataApi.GetZipcV1401Response);
    });
