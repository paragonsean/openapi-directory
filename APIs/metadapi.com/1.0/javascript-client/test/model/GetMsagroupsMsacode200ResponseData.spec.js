...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.GetMsagroupsMsacode200ResponseData();
  });
  ...
  describe('GetMsagroupsMsacode200ResponseData', function() {
    it('should create an instance of GetMsagroupsMsacode200ResponseData', function() {
      // uncomment below and update the code to test GetMsagroupsMsacode200ResponseData
      //var instance = new ZipCodeDataApi.GetMsagroupsMsacode200ResponseData();
      //expect(instance).to.be.a(ZipCodeDataApi.GetMsagroupsMsacode200ResponseData);
    });
