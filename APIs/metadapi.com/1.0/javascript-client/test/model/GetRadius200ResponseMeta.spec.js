...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.GetRadius200ResponseMeta();
  });
  ...
  describe('GetRadius200ResponseMeta', function() {
    it('should create an instance of GetRadius200ResponseMeta', function() {
      // uncomment below and update the code to test GetRadius200ResponseMeta
      //var instance = new ZipCodeDataApi.GetRadius200ResponseMeta();
      //expect(instance).to.be.a(ZipCodeDataApi.GetRadius200ResponseMeta);
    });
