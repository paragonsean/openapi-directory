...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.GetDistance200ResponseLinks();
  });
  ...
  describe('GetDistance200ResponseLinks', function() {
    it('should create an instance of GetDistance200ResponseLinks', function() {
      // uncomment below and update the code to test GetDistance200ResponseLinks
      //var instance = new ZipCodeDataApi.GetDistance200ResponseLinks();
      //expect(instance).to.be.a(ZipCodeDataApi.GetDistance200ResponseLinks);
    });
