...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.GetMsagroups200ResponseMeta();
  });
  ...
  describe('GetMsagroups200ResponseMeta', function() {
    it('should create an instance of GetMsagroups200ResponseMeta', function() {
      // uncomment below and update the code to test GetMsagroups200ResponseMeta
      //var instance = new ZipCodeDataApi.GetMsagroups200ResponseMeta();
      //expect(instance).to.be.a(ZipCodeDataApi.GetMsagroups200ResponseMeta);
    });
