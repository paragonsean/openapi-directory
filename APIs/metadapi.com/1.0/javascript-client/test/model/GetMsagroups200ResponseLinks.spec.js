...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.GetMsagroups200ResponseLinks();
  });
  ...
  describe('GetMsagroups200ResponseLinks', function() {
    it('should create an instance of GetMsagroups200ResponseLinks', function() {
      // uncomment below and update the code to test GetMsagroups200ResponseLinks
      //var instance = new ZipCodeDataApi.GetMsagroups200ResponseLinks();
      //expect(instance).to.be.a(ZipCodeDataApi.GetMsagroups200ResponseLinks);
    });
