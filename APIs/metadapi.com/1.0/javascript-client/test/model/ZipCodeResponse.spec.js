...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.ZipCodeResponse();
  });
  ...
  describe('ZipCodeResponse', function() {
    it('should create an instance of ZipCodeResponse', function() {
      // uncomment below and update the code to test ZipCodeResponse
      //var instance = new ZipCodeDataApi.ZipCodeResponse();
      //expect(instance).to.be.a(ZipCodeDataApi.ZipCodeResponse);
    });
