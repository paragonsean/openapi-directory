...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZipCodeDataApi.GetRadius400ResponseErrorsInner();
  });
  ...
  describe('GetRadius400ResponseErrorsInner', function() {
    it('should create an instance of GetRadius400ResponseErrorsInner', function() {
      // uncomment below and update the code to test GetRadius400ResponseErrorsInner
      //var instance = new ZipCodeDataApi.GetRadius400ResponseErrorsInner();
      //expect(instance).to.be.a(ZipCodeDataApi.GetRadius400ResponseErrorsInner);
    });
