...
class GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner(Model):
    ...
    def __init__(self, county_fips_code: str=None, title_case_county_name: str=None, usps_county_name: str=None):
        """GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner - a model defined in OpenAPI

        :param county_fips_code: The county_fips_code of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.
        :param title_case_county_name: The title_case_county_name of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.
        :param usps_county_name: The usps_county_name of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The get_msagroups_msacode_200_response_data_states_inner_counties_inner of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def county_fips_code(self):
        """Gets the county_fips_code of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.

        FIPS code assigned to the county of the main city of the zip code.

        :return: The county_fips_code of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.
        :rtype: str
        """
    ...
    def county_fips_code(self, county_fips_code):
        """Sets the county_fips_code of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.
    ...
    def title_case_county_name(self):
        """Gets the title_case_county_name of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.

        County Name in Title Case

        :return: The title_case_county_name of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.
        :rtype: str
        """
    ...
    def title_case_county_name(self, title_case_county_name):
        """Sets the title_case_county_name of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.
    ...
    def usps_county_name(self):
        """Gets the usps_county_name of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.

        Name of the county of the main city for the zip code USPS Standard.

        :return: The usps_county_name of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.
        :rtype: str
        """
    ...
    def usps_county_name(self, usps_county_name):
        """Sets the usps_county_name of this GetMsagroupsMsacode200ResponseDataStatesInnerCountiesInner.
