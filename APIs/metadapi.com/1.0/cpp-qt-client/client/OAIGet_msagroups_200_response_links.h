...
/*
 * OAIGet_msagroups_200_response_links.h
 *
 * Response Link Navigation object
 */

#ifndef OAIGet_msagroups_200_response_links_H
#define OAIGet_msagroups_200_response_links_H
...
class OAIGet_msagroups_200_response_links : public OAIObject {
public:
    OAIGet_msagroups_200_response_links();
    OAIGet_msagroups_200_response_links(QString json);
    ~OAIGet_msagroups_200_response_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_msagroups_200_response_links)

#endif // OAIGet_msagroups_200_response_links_H
