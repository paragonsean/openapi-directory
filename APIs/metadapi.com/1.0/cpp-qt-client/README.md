...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getDistanceSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getDistanceSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString zip_code1 = create(); // QString | Zip Code 1
      ...
      QString zip_code2 = create(); // QString | Zip Code 2
      apiInstance.getDistance(zip_code1zip_code2);
