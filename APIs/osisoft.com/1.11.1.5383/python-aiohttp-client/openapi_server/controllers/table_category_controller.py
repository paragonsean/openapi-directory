...
async def table_category_create_security_entry(request: web.Request, web_id, security_entry, apply_to_children=None, web_id_type=None) -> web.Response:
    """Create a security entry owned by the table category.

    

    :param web_id: The ID of the table category where the security entry will be created.
    :type web_id: str
...
async def table_category_delete(request: web.Request, web_id) -> web.Response:
    """Delete a table category.

    

    :param web_id: The ID of the table category to delete.
    :type web_id: str
...
async def table_category_delete_security_entry(request: web.Request, name, web_id, apply_to_children=None) -> web.Response:
    ...
    :type name: str
    :param web_id: The ID of the table category where the security entry will be deleted.
    :type web_id: str
    :param apply_to_children: If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.
    :type apply_to_children: bool
...
async def table_category_get(request: web.Request, web_id, selected_fields=None, web_id_type=None) -> web.Response:
    """Retrieve a table category.

    

    :param web_id: The id of the table category.
    :type web_id: str
...
async def table_category_get_by_path(request: web.Request, path, selected_fields=None, web_id_type=None) -> web.Response:
...
async def table_category_get_security(request: web.Request, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None) -> web.Response:
    """Get the security information of the specified security item associated with the table category for a specified user.

    

    :param web_id: The ID of the table category for the security to be checked.
    :type web_id: str
...
async def table_category_get_security_entries(request: web.Request, web_id, name_filter=None, selected_fields=None, web_id_type=None) -> web.Response:
...
async def table_category_get_security_entry_by_name(request: web.Request, name, web_id, selected_fields=None, web_id_type=None) -> web.Response:
...
async def table_category_update(request: web.Request, web_id, table_category) -> web.Response:
    """Update a table category by replacing items in its definition.

    

    :param web_id: The ID of the table category to update.
    :type web_id: str
    :param table_category: A partial table category containing the desired changes.
...
async def table_category_update_security_entry(request: web.Request, name, web_id, security_entry, apply_to_children=None) -> web.Response:
    ...
    :type name: str
    :param web_id: The ID of the table category where the security entry will be updated.
    :type web_id: str
