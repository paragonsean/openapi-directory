...
async def notification_rule_template_create_notification_rule_template_subscriber(request: web.Request, web_id, notification_rule_subscriber, web_id_type=None) -> web.Response:
    """Create a notification rule subscriber.

    

    :param web_id: The ID of the notification rule template on which to create the notification rule subscriber.
    :type web_id: str
    :param notification_rule_subscriber: The new notification rule subscriber definition.
...
async def notification_rule_template_create_security_entry(request: web.Request, web_id, security_entry, apply_to_children=None, web_id_type=None) -> web.Response:
    """Create a security entry owned by the notification rule template.

    

    :param web_id: The ID of the notification rule template, where the security entry will be created.
    :type web_id: str
...
async def notification_rule_template_delete(request: web.Request, web_id) -> web.Response:
    """Delete a notification rule template.

    

    :param web_id: The ID of the notification rule template.
    :type web_id: str
...
async def notification_rule_template_delete_security_entry(request: web.Request, name, web_id, apply_to_children=None) -> web.Response:
    ...
    :type name: str
    :param web_id: The ID of the notification rule template, where the security entry will be deleted.
    :type web_id: str
    :param apply_to_children: If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.
    :type apply_to_children: bool
...
async def notification_rule_template_get(request: web.Request, web_id, selected_fields=None, web_id_type=None) -> web.Response:
...
async def notification_rule_template_get_by_path(request: web.Request, path, selected_fields=None, web_id_type=None) -> web.Response:
    ...
    :param path: The path to the notification rule template.
    :type path: str
    :param selected_fields: List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.
    :type selected_fields: str
    :param web_id_type: Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \&quot;WebIDType\&quot;.
...
async def notification_rule_template_get_notification_rule_template_subscribers(request: web.Request, web_id, selected_fields=None, web_id_type=None) -> web.Response:
...
async def notification_rule_template_get_notification_rule_templates_query(request: web.Request, database_web_id=None, max_count=None, query=None, selected_fields=None, start_index=None, web_id_type=None) -> web.Response:
    ...
    :type max_count: int
    :param query: The query string is a list of filters used to perform an AFSearch for the Notification rule templates in the asset database. An example would be: \&quot;query&#x3D;NotificationRuleTemplate:{ Name:&#x3D;&#39;MyNotificationRuleTemplate&#39; } Type:&#x3D;Int32\&quot;.
    :type query: str
    :param selected_fields: List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.
    :type selected_fields: str
...
async def notification_rule_template_get_security(request: web.Request, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None) -> web.Response:
    ...
    :param web_id: The ID of the notification rule template for the security to be checked.
    :type web_id: str
...
async def notification_rule_template_get_security_entries(request: web.Request, web_id, name_filter=None, selected_fields=None, web_id_type=None) -> web.Response:
...
async def notification_rule_template_get_security_entry_by_name(request: web.Request, name, web_id, selected_fields=None, web_id_type=None) -> web.Response:
...
async def notification_rule_template_update(request: web.Request, web_id, notification_rule_template) -> web.Response:
    """Update a notification rule template by replacing items in its definition.

    

    :param web_id: The ID of the notification rule template to update.
    :type web_id: str
    :param notification_rule_template: A partial notification rule template containing the desired changes.
...
async def notification_rule_template_update_security_entry(request: web.Request, name, web_id, security_entry, apply_to_children=None) -> web.Response:
    ...
    :type name: str
    :param web_id: The ID of the notification rule template, where the security entry will be updated.
    :type web_id: str
