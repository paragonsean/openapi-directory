...
async def analysis_rule_plug_in_get(request: web.Request, web_id, selected_fields=None, web_id_type=None) -> web.Response:
    """Retrieve an Analysis Rule Plug-in.

    

    :param web_id: The ID of the Analysis Rule Plug-in.
    :type web_id: str
...
async def analysis_rule_plug_in_get_by_path(request: web.Request, path, selected_fields=None, web_id_type=None) -> web.Response:
