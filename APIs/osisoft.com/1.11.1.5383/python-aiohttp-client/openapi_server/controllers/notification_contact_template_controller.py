...
async def notification_contact_template_create_security_entry(request: web.Request, web_id, security_entry, apply_to_children=None, web_id_type=None) -> web.Response:
    """Create a security entry owned by the notification contact template.

    

    :param web_id: The ID of the notification contact template, where the security entry will be created.
    :type web_id: str
...
async def notification_contact_template_delete(request: web.Request, web_id) -> web.Response:
    """Delete a notification contact template.

    

    :param web_id: The ID of the notification contact template to be deleted.
    :type web_id: str
...
async def notification_contact_template_delete_security_entry(request: web.Request, name, web_id, apply_to_children=None) -> web.Response:
    ...
    :type name: str
    :param web_id: The ID of the notification contact template, where the security entry will be deleted.
    :type web_id: str
    :param apply_to_children: If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.
    :type apply_to_children: bool
...
async def notification_contact_template_get(request: web.Request, web_id, selected_fields=None, web_id_type=None) -> web.Response:
    """Retrieve a notification contact template.

    

    :param web_id: The ID of the notification contact template.
    :type web_id: str
...
async def notification_contact_template_get_by_path(request: web.Request, path, selected_fields=None, web_id_type=None) -> web.Response:
    """Retrieve a notification contact template by path.

    

    :param path: The path to the notification contact template.
    :type path: str
    :param selected_fields: List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.
    :type selected_fields: str
    :param web_id_type: Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \&quot;WebIDType\&quot;.
...
async def notification_contact_template_get_notification_contact_templates(request: web.Request, web_id, selected_fields=None, web_id_type=None) -> web.Response:
...
async def notification_contact_template_get_notification_contact_templates_query(request: web.Request, asset_server_web_id=None, max_count=None, query=None, selected_fields=None, start_index=None, web_id_type=None) -> web.Response:
...
async def notification_contact_template_get_security(request: web.Request, web_id, user_identity, force_refresh=None, selected_fields=None, web_id_type=None) -> web.Response:
    ...
    :param web_id: The ID of the notification contact template for the security to be checked.
    :type web_id: str
...
async def notification_contact_template_get_security_entries(request: web.Request, web_id, name_filter=None, selected_fields=None, web_id_type=None) -> web.Response:
...
async def notification_contact_template_get_security_entry_by_name(request: web.Request, name, web_id, selected_fields=None, web_id_type=None) -> web.Response:
...
async def notification_contact_template_update(request: web.Request, web_id, notification_contact_template) -> web.Response:
    """Update a notification contact template by replacing items in its definition.

    

    :param web_id: The ID of the notification contact template to update.
    :type web_id: str
    :param notification_contact_template: A partial notification contact template containing the desired changes.
...
async def notification_contact_template_update_security_entry(request: web.Request, name, web_id, security_entry, apply_to_children=None) -> web.Response:
    ...
    :type name: str
    :param web_id: The ID of the notification contact template, where the security entry will be updated.
    :type web_id: str
