...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PiWebApi2018Sp1SwaggerSpec.DataServer();
  });
  ...
  describe('DataServer', function() {
    it('should create an instance of DataServer', function() {
      // uncomment below and update the code to test DataServer
      //var instance = new PiWebApi2018Sp1SwaggerSpec.DataServer();
      //expect(instance).to.be.a(PiWebApi2018Sp1SwaggerSpec.DataServer);
    });
