...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PiWebApi2018Sp1SwaggerSpec.ItemEventFrame();
  });
  ...
  describe('ItemEventFrame', function() {
    it('should create an instance of ItemEventFrame', function() {
      // uncomment below and update the code to test ItemEventFrame
      //var instance = new PiWebApi2018Sp1SwaggerSpec.ItemEventFrame();
      //expect(instance).to.be.a(PiWebApi2018Sp1SwaggerSpec.ItemEventFrame);
    });
