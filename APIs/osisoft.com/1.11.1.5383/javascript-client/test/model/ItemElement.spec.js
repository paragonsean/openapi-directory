...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PiWebApi2018Sp1SwaggerSpec.ItemElement();
  });
  ...
  describe('ItemElement', function() {
    it('should create an instance of ItemElement', function() {
      // uncomment below and update the code to test ItemElement
      //var instance = new PiWebApi2018Sp1SwaggerSpec.ItemElement();
      //expect(instance).to.be.a(PiWebApi2018Sp1SwaggerSpec.ItemElement);
    });
