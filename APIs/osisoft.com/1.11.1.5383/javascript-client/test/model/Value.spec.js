...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PiWebApi2018Sp1SwaggerSpec.Value();
  });
  ...
  describe('Value', function() {
    it('should create an instance of Value', function() {
      ...
      //var instance = new PiWebApi2018Sp1SwaggerSpec.Value();
      //expect(instance).to.be.a(PiWebApi2018Sp1SwaggerSpec.Value);
    });
