...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PiWebApi2018Sp1SwaggerSpec.ItemPoint();
  });
  ...
  describe('ItemPoint', function() {
    it('should create an instance of ItemPoint', function() {
      // uncomment below and update the code to test ItemPoint
      //var instance = new PiWebApi2018Sp1SwaggerSpec.ItemPoint();
      //expect(instance).to.be.a(PiWebApi2018Sp1SwaggerSpec.ItemPoint);
    });
