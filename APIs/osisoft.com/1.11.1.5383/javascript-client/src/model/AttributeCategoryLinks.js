...
/**
 * The AttributeCategoryLinks model module.
 * @module model/AttributeCategoryLinks
 * @version 1.11.1.5383
 */
class AttributeCategoryLinks {
    /**
     * Constructs a new <code>AttributeCategoryLinks</code>.
     * @alias module:model/AttributeCategoryLinks
     */
    constructor() { 
        
        AttributeCategoryLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AttributeCategoryLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttributeCategoryLinks} obj Optional instance to populate.
     * @return {module:model/AttributeCategoryLinks} The populated <code>AttributeCategoryLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttributeCategoryLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>AttributeCategoryLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttributeCategoryLinks</code>.
     */
 ...
 */
AttributeCategoryLinks.prototype['Database'] = undefined;

/**
 * @member {String} Security
 */
AttributeCategoryLinks.prototype['Security'] = undefined;

/**
 * @member {String} SecurityEntries
 */
AttributeCategoryLinks.prototype['SecurityEntries'] = undefined;

/**
 * @member {String} Self
 */
AttributeCategoryLinks.prototype['Self'] = undefined;
...
export default AttributeCategoryLinks;
