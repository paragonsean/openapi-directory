...
/**
 * The ElementCategoryLinks model module.
 * @module model/ElementCategoryLinks
 * @version 1.11.1.5383
 */
class ElementCategoryLinks {
    /**
     * Constructs a new <code>ElementCategoryLinks</code>.
     * @alias module:model/ElementCategoryLinks
     */
    constructor() { 
        
        ElementCategoryLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ElementCategoryLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ElementCategoryLinks} obj Optional instance to populate.
     * @return {module:model/ElementCategoryLinks} The populated <code>ElementCategoryLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ElementCategoryLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>ElementCategoryLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ElementCategoryLinks</code>.
     */
 ...
 */
ElementCategoryLinks.prototype['Database'] = undefined;

/**
 * @member {String} Security
 */
ElementCategoryLinks.prototype['Security'] = undefined;

/**
 * @member {String} SecurityEntries
 */
ElementCategoryLinks.prototype['SecurityEntries'] = undefined;

/**
 * @member {String} Self
 */
ElementCategoryLinks.prototype['Self'] = undefined;
...
export default ElementCategoryLinks;
