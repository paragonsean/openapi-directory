...
/**
 * The AnalysisCategoryLinks model module.
 * @module model/AnalysisCategoryLinks
 * @version 1.11.1.5383
 */
class AnalysisCategoryLinks {
    /**
     * Constructs a new <code>AnalysisCategoryLinks</code>.
     * @alias module:model/AnalysisCategoryLinks
     */
    constructor() { 
        
        AnalysisCategoryLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AnalysisCategoryLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnalysisCategoryLinks} obj Optional instance to populate.
     * @return {module:model/AnalysisCategoryLinks} The populated <code>AnalysisCategoryLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnalysisCategoryLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>AnalysisCategoryLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnalysisCategoryLinks</code>.
     */
 ...
 */
AnalysisCategoryLinks.prototype['Database'] = undefined;

/**
 * @member {String} Security
 */
AnalysisCategoryLinks.prototype['Security'] = undefined;

/**
 * @member {String} SecurityEntries
 */
AnalysisCategoryLinks.prototype['SecurityEntries'] = undefined;

/**
 * @member {String} Self
 */
AnalysisCategoryLinks.prototype['Self'] = undefined;
...
export default AnalysisCategoryLinks;
