# PiWebApi2018Sp1SwaggerSpec.TableCategoryApi
...
> tableCategoryCreateSecurityEntry(webId, securityEntry, opts)
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.TableCategoryApi();
let webId = "webId_example"; // String | The ID of the table category where the security entry will be created.
...
apiInstance.tableCategoryCreateSecurityEntry(webId, securityEntry, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.TableCategoryApi();
let webId = "webId_example"; // String | The ID of the table category to delete.
apiInstance.tableCategoryDelete(webId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> tableCategoryDeleteSecurityEntry(name, webId, opts)
...
let webId = "webId_example"; // String | The ID of the table category where the security entry will be deleted.
let opts = {
  'applyToChildren': true // Boolean | If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.
};
apiInstance.tableCategoryDeleteSecurityEntry(name, webId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> TableCategory tableCategoryGet(webId, opts)
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.TableCategoryApi();
let webId = "webId_example"; // String | The id of the table category.
let opts = {
...
apiInstance.tableCategoryGet(webId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> TableCategory tableCategoryGetByPath(path, opts)
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.TableCategoryApi();
let path = "path_example"; // String | The path to the target table category.
let opts = {
  'selectedFields': "selectedFields_example", // String | List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.
  'webIdType': "webIdType_example" // String | Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".
};
apiInstance.tableCategoryGetByPath(path, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ItemsSecurityRights tableCategoryGetSecurity(webId, userIdentity, opts)
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.TableCategoryApi();
let webId = "webId_example"; // String | The ID of the table category for the security to be checked.
...
apiInstance.tableCategoryGetSecurity(webId, userIdentity, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ItemsSecurityEntry tableCategoryGetSecurityEntries(webId, opts)
...
apiInstance.tableCategoryGetSecurityEntries(webId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> SecurityEntry tableCategoryGetSecurityEntryByName(name, webId, opts)
...
apiInstance.tableCategoryGetSecurityEntryByName(name, webId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.TableCategoryApi();
let webId = "webId_example"; // String | The ID of the table category to update.
let tableCategory = new PiWebApi2018Sp1SwaggerSpec.TableCategory(); // TableCategory | A partial table category containing the desired changes.
apiInstance.tableCategoryUpdate(webId, tableCategory, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> tableCategoryUpdateSecurityEntry(name, webId, securityEntry, opts)
...
let webId = "webId_example"; // String | The ID of the table category where the security entry will be updated.
...
apiInstance.tableCategoryUpdateSecurityEntry(name, webId, securityEntry, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
