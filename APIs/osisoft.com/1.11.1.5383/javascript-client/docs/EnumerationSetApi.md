# PiWebApi2018Sp1SwaggerSpec.EnumerationSetApi
...
> enumerationSetCreateSecurityEntry(webId, securityEntry, opts)
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.EnumerationSetApi();
let webId = "webId_example"; // String | The ID of the enumeration set where the security entry will be created.
...
apiInstance.enumerationSetCreateSecurityEntry(webId, securityEntry, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> enumerationSetCreateValue(webId, enumerationValue, opts)
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.EnumerationSetApi();
let webId = "webId_example"; // String | The ID of the enumeration set on which to create the enumeration value.
let enumerationValue = new PiWebApi2018Sp1SwaggerSpec.EnumerationValue(); // EnumerationValue | The new enumeration value definition.
let opts = {
  'webIdType': "webIdType_example" // String | Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".
};
apiInstance.enumerationSetCreateValue(webId, enumerationValue, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.EnumerationSetApi();
let webId = "webId_example"; // String | The ID of the enumeration set to delete.
apiInstance.enumerationSetDelete(webId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> enumerationSetDeleteSecurityEntry(name, webId, opts)
...
let webId = "webId_example"; // String | The ID of the enumeration set where the security entry will be deleted.
let opts = {
  'applyToChildren': true // Boolean | If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.
};
apiInstance.enumerationSetDeleteSecurityEntry(name, webId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> EnumerationSet enumerationSetGet(webId, opts)
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.EnumerationSetApi();
let webId = "webId_example"; // String | The ID of the enumeration set.
let opts = {
...
apiInstance.enumerationSetGet(webId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> EnumerationSet enumerationSetGetByPath(path, opts)
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.EnumerationSetApi();
let path = "path_example"; // String | The path to the target enumeration set.
let opts = {
  'selectedFields': "selectedFields_example", // String | List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.
  'webIdType': "webIdType_example" // String | Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".
};
apiInstance.enumerationSetGetByPath(path, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ItemsSecurityRights enumerationSetGetSecurity(webId, userIdentity, opts)
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.EnumerationSetApi();
let webId = "webId_example"; // String | The ID of the enumeration set for the security to be checked.
...
apiInstance.enumerationSetGetSecurity(webId, userIdentity, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ItemsSecurityEntry enumerationSetGetSecurityEntries(webId, opts)
...
apiInstance.enumerationSetGetSecurityEntries(webId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> SecurityEntry enumerationSetGetSecurityEntryByName(name, webId, opts)
...
apiInstance.enumerationSetGetSecurityEntryByName(name, webId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ItemsEnumerationValue enumerationSetGetValues(webId, opts)
...
apiInstance.enumerationSetGetValues(webId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new PiWebApi2018Sp1SwaggerSpec.EnumerationSetApi();
let webId = "webId_example"; // String | The ID of the enumeration set to update.
let enumerationSet = new PiWebApi2018Sp1SwaggerSpec.EnumerationSet(); // EnumerationSet | A partial enumeration set containing the desired changes.
apiInstance.enumerationSetUpdate(webId, enumerationSet, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> enumerationSetUpdateSecurityEntry(name, webId, securityEntry, opts)
...
let webId = "webId_example"; // String | The ID of the enumeration set where the security entry will be updated.
...
apiInstance.enumerationSetUpdateSecurityEntry(name, webId, securityEntry, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
