...
/*
 * OAITableCategoryLinks.h
 *
 * 
 */

#ifndef OAITableCategoryLinks_H
#define OAITableCategoryLinks_H
...
class OAITableCategoryLinks : public OAIObject {
public:
    OAITableCategoryLinks();
    OAITableCategoryLinks(QString json);
    ~OAITableCategoryLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableCategoryLinks)

#endif // OAITableCategoryLinks_H
