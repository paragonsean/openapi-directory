...
#ifndef OAIDataPipeEvent_H
#define OAIDataPipeEvent_H
...
class OAIDataPipeEvent : public OAIObject {
public:
    OAIDataPipeEvent();
    OAIDataPipeEvent(QString json);
    ~OAIDataPipeEvent() override;
    ...
    QString getPreviousEventAction() const;
    void setPreviousEventAction(const QString &previous_event_action);
    bool is_previous_event_action_Set() const;
    bool is_previous_event_action_Valid() const;
...
private:
    ...
    QString m_previous_event_action;
    bool m_previous_event_action_isSet;
    bool m_previous_event_action_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataPipeEvent)

#endif // OAIDataPipeEvent_H
