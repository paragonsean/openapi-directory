...
#ifndef OAIElementLinks_H
#define OAIElementLinks_H
...
class OAIElementLinks : public OAIObject {
public:
    OAIElementLinks();
    OAIElementLinks(QString json);
    ~OAIElementLinks() override;
    ...
    QString getAnalyses() const;
    void setAnalyses(const QString &analyses);
    ...
    QString getNotificationRules() const;
    void setNotificationRules(const QString &notification_rules);
...
Q_DECLARE_METATYPE(OpenAPI::OAIElementLinks)

#endif // OAIElementLinks_H
