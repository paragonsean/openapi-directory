...
void OAIBatchApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("batchExecute", defaultConf);
    _serverIndices.insert("batchExecute", 0);
}
...
void OAIBatchApi::batchExecute(const QMap<QString, OAIRequest> &batch) {
    QString fullPath = QString(_serverConfigs["batchExecute"][_serverIndices.value("batchExecute")].URL()+"/batch");
...

    {
        ...
        QJsonDocument doc(::OpenAPI::toJsonValue(batch).toObject());
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBatchApi::batchExecuteCallback);
...
void OAIBatchApi::batchExecuteCallback(OAIHttpRequestWorker *worker) {
    ...
    QMap<QString, OAIResponse> output;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT batchExecuteSignal(output);
        Q_EMIT batchExecuteSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT batchExecuteSignalE(output, error_type, error_str);
        Q_EMIT batchExecuteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT batchExecuteSignalError(output, error_type, error_str);
        Q_EMIT batchExecuteSignalErrorFull(worker, error_type, error_str);
    }
}
