...
OAIExtendedTimedValue::OAIExtendedTimedValue(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExtendedTimedValue::OAIExtendedTimedValue() {
    this->initializeModel();
}

OAIExtendedTimedValue::~OAIExtendedTimedValue() {}

void OAIExtendedTimedValue::initializeModel() {
...
void OAIExtendedTimedValue::fromJson(QString jsonString) {
...
void OAIExtendedTimedValue::fromJsonObject(QJsonObject json) {
...
QString OAIExtendedTimedValue::asJson() const {
...
QJsonObject OAIExtendedTimedValue::asJsonObject() const {
    QJsonObject obj;
...
bool OAIExtendedTimedValue::isAnnotated() const {
    return m_annotated;
}
void OAIExtendedTimedValue::setAnnotated(const bool &annotated) {
    m_annotated = annotated;
    m_annotated_isSet = true;
}

bool OAIExtendedTimedValue::is_annotated_Set() const{
    return m_annotated_isSet;
}

bool OAIExtendedTimedValue::is_annotated_Valid() const{
    return m_annotated_isValid;
}

QList<OAIStreamAnnotation> OAIExtendedTimedValue::getAnnotations() const {
    return m_annotations;
}
void OAIExtendedTimedValue::setAnnotations(const QList<OAIStreamAnnotation> &annotations) {
    m_annotations = annotations;
    m_annotations_isSet = true;
}

bool OAIExtendedTimedValue::is_annotations_Set() const{
    return m_annotations_isSet;
}

bool OAIExtendedTimedValue::is_annotations_Valid() const{
    return m_annotations_isValid;
}

QList<OAIPropertyError> OAIExtendedTimedValue::getErrors() const {
    return m_errors;
}
void OAIExtendedTimedValue::setErrors(const QList<OAIPropertyError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIExtendedTimedValue::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIExtendedTimedValue::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIExtendedTimedValue::isGood() const {
    return m_good;
}
void OAIExtendedTimedValue::setGood(const bool &good) {
    m_good = good;
    m_good_isSet = true;
}

bool OAIExtendedTimedValue::is_good_Set() const{
    return m_good_isSet;
}

bool OAIExtendedTimedValue::is_good_Valid() const{
    return m_good_isValid;
}

bool OAIExtendedTimedValue::isQuestionable() const {
    return m_questionable;
}
void OAIExtendedTimedValue::setQuestionable(const bool &questionable) {
    m_questionable = questionable;
    m_questionable_isSet = true;
}

bool OAIExtendedTimedValue::is_questionable_Set() const{
    return m_questionable_isSet;
}

bool OAIExtendedTimedValue::is_questionable_Valid() const{
    return m_questionable_isValid;
}

bool OAIExtendedTimedValue::isSubstituted() const {
    return m_substituted;
}
void OAIExtendedTimedValue::setSubstituted(const bool &substituted) {
    m_substituted = substituted;
    m_substituted_isSet = true;
}

bool OAIExtendedTimedValue::is_substituted_Set() const{
    return m_substituted_isSet;
}

bool OAIExtendedTimedValue::is_substituted_Valid() const{
    return m_substituted_isValid;
}

QDateTime OAIExtendedTimedValue::getTimestamp() const {
    return m_timestamp;
}
void OAIExtendedTimedValue::setTimestamp(const QDateTime &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAIExtendedTimedValue::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIExtendedTimedValue::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

QString OAIExtendedTimedValue::getUnitsAbbreviation() const {
    return m_units_abbreviation;
}
void OAIExtendedTimedValue::setUnitsAbbreviation(const QString &units_abbreviation) {
    m_units_abbreviation = units_abbreviation;
    m_units_abbreviation_isSet = true;
}

bool OAIExtendedTimedValue::is_units_abbreviation_Set() const{
    return m_units_abbreviation_isSet;
}

bool OAIExtendedTimedValue::is_units_abbreviation_Valid() const{
    return m_units_abbreviation_isValid;
}

OAIObject OAIExtendedTimedValue::getValue() const {
    return m_value;
}
void OAIExtendedTimedValue::setValue(const OAIObject &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIExtendedTimedValue::is_value_Set() const{
    return m_value_isSet;
}

bool OAIExtendedTimedValue::is_value_Valid() const{
    return m_value_isValid;
}

OAIWebException OAIExtendedTimedValue::getWebException() const {
    return m_web_exception;
}
void OAIExtendedTimedValue::setWebException(const OAIWebException &web_exception) {
    m_web_exception = web_exception;
    m_web_exception_isSet = true;
}

bool OAIExtendedTimedValue::is_web_exception_Set() const{
    return m_web_exception_isSet;
}

bool OAIExtendedTimedValue::is_web_exception_Valid() const{
    return m_web_exception_isValid;
}

bool OAIExtendedTimedValue::isSet() const {
...
bool OAIExtendedTimedValue::isValid() const {
