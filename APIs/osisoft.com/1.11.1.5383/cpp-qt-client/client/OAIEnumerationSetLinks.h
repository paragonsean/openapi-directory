...
/*
 * OAIEnumerationSetLinks.h
 *
 * 
 */

#ifndef OAIEnumerationSetLinks_H
#define OAIEnumerationSetLinks_H
...
class OAIEnumerationSetLinks : public OAIObject {
public:
    OAIEnumerationSetLinks();
    OAIEnumerationSetLinks(QString json);
    ~OAIEnumerationSetLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnumerationSetLinks)

#endif // OAIEnumerationSetLinks_H
