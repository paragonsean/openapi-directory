...
#ifndef OAIAssetDatabase_H
#define OAIAssetDatabase_H
...
namespace OpenAPI {
class OAIValue;
class OAIAssetDatabaseLinks;
class OAIWebException;

class OAIAssetDatabase : public OAIObject {
public:
    OAIAssetDatabase();
    OAIAssetDatabase(QString json);
    ~OAIAssetDatabase() override;
    ...
    OAIAssetDatabaseLinks getLinks() const;
    void setLinks(const OAIAssetDatabaseLinks &links);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetDatabase)

#endif // OAIAssetDatabase_H
