...
#ifndef OAITimedValues_H
#define OAITimedValues_H
...
class OAITimedValues : public OAIObject {
public:
    OAITimedValues();
    OAITimedValues(QString json);
    ~OAITimedValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimedValues)

#endif // OAITimedValues_H
