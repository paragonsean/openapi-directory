...
#ifndef OAITimedValue_H
#define OAITimedValue_H
...
class OAITimedValue : public OAIObject {
public:
    OAITimedValue();
    OAITimedValue(QString json);
    ~OAITimedValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimedValue)

#endif // OAITimedValue_H
