...
/*
 * OAIAnalysisCategoryLinks.h
 *
 * 
 */

#ifndef OAIAnalysisCategoryLinks_H
#define OAIAnalysisCategoryLinks_H
...
class OAIAnalysisCategoryLinks : public OAIObject {
public:
    OAIAnalysisCategoryLinks();
    OAIAnalysisCategoryLinks(QString json);
    ~OAIAnalysisCategoryLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnalysisCategoryLinks)

#endif // OAIAnalysisCategoryLinks_H
