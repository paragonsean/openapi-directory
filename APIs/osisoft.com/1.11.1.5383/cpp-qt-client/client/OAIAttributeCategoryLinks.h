...
/*
 * OAIAttributeCategoryLinks.h
 *
 * 
 */

#ifndef OAIAttributeCategoryLinks_H
#define OAIAttributeCategoryLinks_H
...
class OAIAttributeCategoryLinks : public OAIObject {
public:
    OAIAttributeCategoryLinks();
    OAIAttributeCategoryLinks(QString json);
    ~OAIAttributeCategoryLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributeCategoryLinks)

#endif // OAIAttributeCategoryLinks_H
