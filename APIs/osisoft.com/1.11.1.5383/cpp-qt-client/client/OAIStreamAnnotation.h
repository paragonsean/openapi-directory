...
/*
 * OAIStreamAnnotation.h
 *
 * 
 */

#ifndef OAIStreamAnnotation_H
#define OAIStreamAnnotation_H
...
class OAIStreamAnnotation : public OAIObject {
public:
    OAIStreamAnnotation();
    OAIStreamAnnotation(QString json);
    ~OAIStreamAnnotation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamAnnotation)

#endif // OAIStreamAnnotation_H
