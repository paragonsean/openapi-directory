...
OAITimeRulePlugIn::OAITimeRulePlugIn(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITimeRulePlugIn::OAITimeRulePlugIn() {
    this->initializeModel();
}

OAITimeRulePlugIn::~OAITimeRulePlugIn() {}

void OAITimeRulePlugIn::initializeModel() {
...
void OAITimeRulePlugIn::fromJson(QString jsonString) {
...
void OAITimeRulePlugIn::fromJsonObject(QJsonObject json) {
...
QString OAITimeRulePlugIn::asJson() const {
...
QJsonObject OAITimeRulePlugIn::asJsonObject() const {
    QJsonObject obj;
...
QString OAITimeRulePlugIn::getAssemblyFileName() const {
    return m_assembly_file_name;
}
void OAITimeRulePlugIn::setAssemblyFileName(const QString &assembly_file_name) {
    m_assembly_file_name = assembly_file_name;
    m_assembly_file_name_isSet = true;
}

bool OAITimeRulePlugIn::is_assembly_file_name_Set() const{
    return m_assembly_file_name_isSet;
}

bool OAITimeRulePlugIn::is_assembly_file_name_Valid() const{
    return m_assembly_file_name_isValid;
}

QString OAITimeRulePlugIn::getAssemblyId() const {
    return m_assembly_id;
}
void OAITimeRulePlugIn::setAssemblyId(const QString &assembly_id) {
    m_assembly_id = assembly_id;
    m_assembly_id_isSet = true;
}

bool OAITimeRulePlugIn::is_assembly_id_Set() const{
    return m_assembly_id_isSet;
}

bool OAITimeRulePlugIn::is_assembly_id_Valid() const{
    return m_assembly_id_isValid;
}

QList<QString> OAITimeRulePlugIn::getAssemblyLoadProperties() const {
    return m_assembly_load_properties;
}
void OAITimeRulePlugIn::setAssemblyLoadProperties(const QList<QString> &assembly_load_properties) {
    m_assembly_load_properties = assembly_load_properties;
    m_assembly_load_properties_isSet = true;
}

bool OAITimeRulePlugIn::is_assembly_load_properties_Set() const{
    return m_assembly_load_properties_isSet;
}

bool OAITimeRulePlugIn::is_assembly_load_properties_Valid() const{
    return m_assembly_load_properties_isValid;
}

QDateTime OAITimeRulePlugIn::getAssemblyTime() const {
    return m_assembly_time;
}
void OAITimeRulePlugIn::setAssemblyTime(const QDateTime &assembly_time) {
    m_assembly_time = assembly_time;
    m_assembly_time_isSet = true;
}

bool OAITimeRulePlugIn::is_assembly_time_Set() const{
    return m_assembly_time_isSet;
}

bool OAITimeRulePlugIn::is_assembly_time_Valid() const{
    return m_assembly_time_isValid;
}

qint32 OAITimeRulePlugIn::getCompatibilityVersion() const {
    return m_compatibility_version;
}
void OAITimeRulePlugIn::setCompatibilityVersion(const qint32 &compatibility_version) {
    m_compatibility_version = compatibility_version;
    m_compatibility_version_isSet = true;
}

bool OAITimeRulePlugIn::is_compatibility_version_Set() const{
    return m_compatibility_version_isSet;
}

bool OAITimeRulePlugIn::is_compatibility_version_Valid() const{
    return m_compatibility_version_isValid;
}

QString OAITimeRulePlugIn::getDescription() const {
    return m_description;
}
void OAITimeRulePlugIn::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAITimeRulePlugIn::is_description_Set() const{
    return m_description_isSet;
}

bool OAITimeRulePlugIn::is_description_Valid() const{
    return m_description_isValid;
}

QString OAITimeRulePlugIn::getId() const {
    return m_id;
}
void OAITimeRulePlugIn::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITimeRulePlugIn::is_id_Set() const{
    return m_id_isSet;
}

bool OAITimeRulePlugIn::is_id_Valid() const{
    return m_id_isValid;
}

bool OAITimeRulePlugIn::isIsBrowsable() const {
    return m_is_browsable;
}
void OAITimeRulePlugIn::setIsBrowsable(const bool &is_browsable) {
    m_is_browsable = is_browsable;
    m_is_browsable_isSet = true;
}

bool OAITimeRulePlugIn::is_is_browsable_Set() const{
    return m_is_browsable_isSet;
}

bool OAITimeRulePlugIn::is_is_browsable_Valid() const{
    return m_is_browsable_isValid;
}

bool OAITimeRulePlugIn::isIsNonEditableConfig() const {
    return m_is_non_editable_config;
}
void OAITimeRulePlugIn::setIsNonEditableConfig(const bool &is_non_editable_config) {
    m_is_non_editable_config = is_non_editable_config;
    m_is_non_editable_config_isSet = true;
}

bool OAITimeRulePlugIn::is_is_non_editable_config_Set() const{
    return m_is_non_editable_config_isSet;
}

bool OAITimeRulePlugIn::is_is_non_editable_config_Valid() const{
    return m_is_non_editable_config_isValid;
}

OAITimeRulePlugInLinks OAITimeRulePlugIn::getLinks() const {
    return m_links;
}
void OAITimeRulePlugIn::setLinks(const OAITimeRulePlugInLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAITimeRulePlugIn::is_links_Set() const{
    return m_links_isSet;
}

bool OAITimeRulePlugIn::is_links_Valid() const{
    return m_links_isValid;
}

QDateTime OAITimeRulePlugIn::getLoadedAssemblyTime() const {
    return m_loaded_assembly_time;
}
void OAITimeRulePlugIn::setLoadedAssemblyTime(const QDateTime &loaded_assembly_time) {
    m_loaded_assembly_time = loaded_assembly_time;
    m_loaded_assembly_time_isSet = true;
}

bool OAITimeRulePlugIn::is_loaded_assembly_time_Set() const{
    return m_loaded_assembly_time_isSet;
}

bool OAITimeRulePlugIn::is_loaded_assembly_time_Valid() const{
    return m_loaded_assembly_time_isValid;
}

QString OAITimeRulePlugIn::getLoadedVersion() const {
    return m_loaded_version;
}
void OAITimeRulePlugIn::setLoadedVersion(const QString &loaded_version) {
    m_loaded_version = loaded_version;
    m_loaded_version_isSet = true;
}

bool OAITimeRulePlugIn::is_loaded_version_Set() const{
    return m_loaded_version_isSet;
}

bool OAITimeRulePlugIn::is_loaded_version_Valid() const{
    return m_loaded_version_isValid;
}

QString OAITimeRulePlugIn::getName() const {
    return m_name;
}
void OAITimeRulePlugIn::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITimeRulePlugIn::is_name_Set() const{
    return m_name_isSet;
}

bool OAITimeRulePlugIn::is_name_Valid() const{
    return m_name_isValid;
}

QString OAITimeRulePlugIn::getPath() const {
    return m_path;
}
void OAITimeRulePlugIn::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAITimeRulePlugIn::is_path_Set() const{
    return m_path_isSet;
}

bool OAITimeRulePlugIn::is_path_Valid() const{
    return m_path_isValid;
}

QString OAITimeRulePlugIn::getVersion() const {
    return m_version;
}
void OAITimeRulePlugIn::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAITimeRulePlugIn::is_version_Set() const{
    return m_version_isSet;
}

bool OAITimeRulePlugIn::is_version_Valid() const{
    return m_version_isValid;
}

OAIWebException OAITimeRulePlugIn::getWebException() const {
    return m_web_exception;
}
void OAITimeRulePlugIn::setWebException(const OAIWebException &web_exception) {
    m_web_exception = web_exception;
    m_web_exception_isSet = true;
}

bool OAITimeRulePlugIn::is_web_exception_Set() const{
    return m_web_exception_isSet;
}

bool OAITimeRulePlugIn::is_web_exception_Valid() const{
    return m_web_exception_isValid;
}

QString OAITimeRulePlugIn::getWebId() const {
    return m_web_id;
}
void OAITimeRulePlugIn::setWebId(const QString &web_id) {
    m_web_id = web_id;
    m_web_id_isSet = true;
}

bool OAITimeRulePlugIn::is_web_id_Set() const{
    return m_web_id_isSet;
}

bool OAITimeRulePlugIn::is_web_id_Valid() const{
    return m_web_id_isValid;
}

bool OAITimeRulePlugIn::isSet() const {
...
bool OAITimeRulePlugIn::isValid() const {
