...
public class ApiClient {
    ...
    private String basePath = "https://devdata.osisoft.com/piwebapi";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.11.1.5383/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://devdata.osisoft.com/piwebapi
