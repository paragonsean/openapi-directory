...
import org.openapitools.client.model.AnalysisRulePlugInLinks;
...
public class AnalysisRulePlugIn {
  ...
  private AnalysisRulePlugInLinks links;
  ...
  public AnalysisRulePlugIn() {
  }

  public AnalysisRulePlugIn assemblyFileName(String assemblyFileName) {
  ...
  public AnalysisRulePlugIn assemblyID(UUID assemblyID) {
  ...
  public AnalysisRulePlugIn assemblyLoadProperties(List<String> assemblyLoadProperties) {
    this.assemblyLoadProperties = assemblyLoadProperties;
    return this;
  }

  public AnalysisRulePlugIn addAssemblyLoadPropertiesItem(String assemblyLoadPropertiesItem) {
  ...
  public AnalysisRulePlugIn assemblyTime(OffsetDateTime assemblyTime) {
  ...
  public AnalysisRulePlugIn compatibilityVersion(Integer compatibilityVersion) {
  ...
  public AnalysisRulePlugIn description(String description) {
  ...
  public AnalysisRulePlugIn id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public AnalysisRulePlugIn isBrowsable(Boolean isBrowsable) {
  ...
  public AnalysisRulePlugIn isNonEditableConfig(Boolean isNonEditableConfig) {
  ...
  public AnalysisRulePlugIn links(AnalysisRulePlugInLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AnalysisRulePlugInLinks getLinks() {
    return links;
  }

  public void setLinks(AnalysisRulePlugInLinks links) {
    this.links = links;
  }


  public AnalysisRulePlugIn loadedAssemblyTime(OffsetDateTime loadedAssemblyTime) {
  ...
  public AnalysisRulePlugIn loadedVersion(String loadedVersion) {
  ...
  public AnalysisRulePlugIn name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AnalysisRulePlugIn path(String path) {
    this.path = path;
    return this;
  }
  ...
  public AnalysisRulePlugIn version(String version) {
  ...
  public AnalysisRulePlugIn webException(WebException webException) {
  ...
  public AnalysisRulePlugIn webId(String webId) {
    this.webId = webId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AnalysisRulePlugIn analysisRulePlugIn = (AnalysisRulePlugIn) o;
    return Objects.equals(this.assemblyFileName, analysisRulePlugIn.assemblyFileName) &&
        Objects.equals(this.assemblyID, analysisRulePlugIn.assemblyID) &&
        Objects.equals(this.assemblyLoadProperties, analysisRulePlugIn.assemblyLoadProperties) &&
        Objects.equals(this.assemblyTime, analysisRulePlugIn.assemblyTime) &&
        Objects.equals(this.compatibilityVersion, analysisRulePlugIn.compatibilityVersion) &&
        Objects.equals(this.description, analysisRulePlugIn.description) &&
        Objects.equals(this.id, analysisRulePlugIn.id) &&
        Objects.equals(this.isBrowsable, analysisRulePlugIn.isBrowsable) &&
        Objects.equals(this.isNonEditableConfig, analysisRulePlugIn.isNonEditableConfig) &&
        Objects.equals(this.links, analysisRulePlugIn.links) &&
        Objects.equals(this.loadedAssemblyTime, analysisRulePlugIn.loadedAssemblyTime) &&
        Objects.equals(this.loadedVersion, analysisRulePlugIn.loadedVersion) &&
        Objects.equals(this.name, analysisRulePlugIn.name) &&
        Objects.equals(this.path, analysisRulePlugIn.path) &&
        Objects.equals(this.version, analysisRulePlugIn.version) &&
        Objects.equals(this.webException, analysisRulePlugIn.webException) &&
        Objects.equals(this.webId, analysisRulePlugIn.webId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnalysisRulePlugIn {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnalysisRulePlugIn
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnalysisRulePlugIn.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalysisRulePlugIn is not found in the empty JSON string", AnalysisRulePlugIn.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnalysisRulePlugIn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnalysisRulePlugIn` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Links") != null && !jsonObj.get("Links").isJsonNull()) {
        AnalysisRulePlugInLinks.validateJsonElement(jsonObj.get("Links"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnalysisRulePlugIn.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnalysisRulePlugIn' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnalysisRulePlugIn> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnalysisRulePlugIn.class));

       return (TypeAdapter<T>) new TypeAdapter<AnalysisRulePlugIn>() {
           @Override
           public void write(JsonWriter out, AnalysisRulePlugIn value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnalysisRulePlugIn read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnalysisRulePlugIn given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnalysisRulePlugIn
   * @throws IOException if the JSON string is invalid with respect to AnalysisRulePlugIn
   */
  public static AnalysisRulePlugIn fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnalysisRulePlugIn.class);
  }

  /**
   * Convert an instance of AnalysisRulePlugIn to an JSON string
   *
   * @return JSON string
   */
