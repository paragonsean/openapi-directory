...
public class TimeRulePlugIn {
  ...
  private TimeRulePlugInLinks links;
  ...
  public TimeRulePlugIn() {
  }

  public TimeRulePlugIn assemblyFileName(String assemblyFileName) {
  ...
  public TimeRulePlugIn assemblyID(UUID assemblyID) {
  ...
  public TimeRulePlugIn assemblyLoadProperties(List<String> assemblyLoadProperties) {
    this.assemblyLoadProperties = assemblyLoadProperties;
    return this;
  }

  public TimeRulePlugIn addAssemblyLoadPropertiesItem(String assemblyLoadPropertiesItem) {
  ...
  public TimeRulePlugIn assemblyTime(OffsetDateTime assemblyTime) {
  ...
  public TimeRulePlugIn compatibilityVersion(Integer compatibilityVersion) {
  ...
  public TimeRulePlugIn description(String description) {
  ...
  public TimeRulePlugIn id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public TimeRulePlugIn isBrowsable(Boolean isBrowsable) {
  ...
  public TimeRulePlugIn isNonEditableConfig(Boolean isNonEditableConfig) {
  ...
  public TimeRulePlugIn links(TimeRulePlugInLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public TimeRulePlugInLinks getLinks() {
    return links;
  }

  public void setLinks(TimeRulePlugInLinks links) {
    this.links = links;
  }


  public TimeRulePlugIn loadedAssemblyTime(OffsetDateTime loadedAssemblyTime) {
  ...
  public TimeRulePlugIn loadedVersion(String loadedVersion) {
  ...
  public TimeRulePlugIn name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TimeRulePlugIn path(String path) {
    this.path = path;
    return this;
  }
  ...
  public TimeRulePlugIn version(String version) {
  ...
  public TimeRulePlugIn webException(WebException webException) {
  ...
  public TimeRulePlugIn webId(String webId) {
    this.webId = webId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TimeRulePlugIn timeRulePlugIn = (TimeRulePlugIn) o;
    return Objects.equals(this.assemblyFileName, timeRulePlugIn.assemblyFileName) &&
        Objects.equals(this.assemblyID, timeRulePlugIn.assemblyID) &&
        Objects.equals(this.assemblyLoadProperties, timeRulePlugIn.assemblyLoadProperties) &&
        Objects.equals(this.assemblyTime, timeRulePlugIn.assemblyTime) &&
        Objects.equals(this.compatibilityVersion, timeRulePlugIn.compatibilityVersion) &&
        Objects.equals(this.description, timeRulePlugIn.description) &&
        Objects.equals(this.id, timeRulePlugIn.id) &&
        Objects.equals(this.isBrowsable, timeRulePlugIn.isBrowsable) &&
        Objects.equals(this.isNonEditableConfig, timeRulePlugIn.isNonEditableConfig) &&
        Objects.equals(this.links, timeRulePlugIn.links) &&
        Objects.equals(this.loadedAssemblyTime, timeRulePlugIn.loadedAssemblyTime) &&
        Objects.equals(this.loadedVersion, timeRulePlugIn.loadedVersion) &&
        Objects.equals(this.name, timeRulePlugIn.name) &&
        Objects.equals(this.path, timeRulePlugIn.path) &&
        Objects.equals(this.version, timeRulePlugIn.version) &&
        Objects.equals(this.webException, timeRulePlugIn.webException) &&
        Objects.equals(this.webId, timeRulePlugIn.webId);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeRulePlugIn {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeRulePlugIn
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeRulePlugIn.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeRulePlugIn is not found in the empty JSON string", TimeRulePlugIn.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeRulePlugIn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeRulePlugIn` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Links") != null && !jsonObj.get("Links").isJsonNull()) {
        TimeRulePlugInLinks.validateJsonElement(jsonObj.get("Links"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeRulePlugIn.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeRulePlugIn' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeRulePlugIn> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeRulePlugIn.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeRulePlugIn>() {
           @Override
           public void write(JsonWriter out, TimeRulePlugIn value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimeRulePlugIn read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimeRulePlugIn given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimeRulePlugIn
   * @throws IOException if the JSON string is invalid with respect to TimeRulePlugIn
   */
  public static TimeRulePlugIn fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeRulePlugIn.class);
  }

  /**
   * Convert an instance of TimeRulePlugIn to an JSON string
   *
   * @return JSON string
   */
