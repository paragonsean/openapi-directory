...
<a id="timeRulePlugInGet"></a>
# **timeRulePlugInGet**
> TimeRulePlugIn timeRulePlugInGet(webId, selectedFields, webIdType)
...
import org.openapitools.client.api.TimeRulePlugInApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TimeRulePlugInApi apiInstance = new TimeRulePlugInApi(defaultClient);
    String webId = "webId_example"; // String | The ID of the Time Rule Plug-in.
    ...
    try {
      TimeRulePlugIn result = apiInstance.timeRulePlugInGet(webId, selectedFields, webIdType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeRulePlugInApi#timeRulePlugInGet");
...
<a id="timeRulePlugInGetByPath"></a>
# **timeRulePlugInGetByPath**
> TimeRulePlugIn timeRulePlugInGetByPath(path, selectedFields, webIdType)
...
public class Example {
  public static void main(String[] args) {
    ...
    TimeRulePlugInApi apiInstance = new TimeRulePlugInApi(defaultClient);
    String path = "path_example"; // String | The path to the Time Rule Plug-in.
    String selectedFields = "selectedFields_example"; // String | List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.
    String webIdType = "webIdType_example"; // String | Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".
    try {
      TimeRulePlugIn result = apiInstance.timeRulePlugInGetByPath(path, selectedFields, webIdType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeRulePlugInApi#timeRulePlugInGetByPath");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
