...
<a id="elementCategoryCreateSecurityEntry"></a>
# **elementCategoryCreateSecurityEntry**
> elementCategoryCreateSecurityEntry(webId, securityEntry, applyToChildren, webIdType)
...
import org.openapitools.client.api.ElementCategoryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ElementCategoryApi apiInstance = new ElementCategoryApi(defaultClient);
    String webId = "webId_example"; // String | The ID of the element category where the security entry will be created.
    ...
    try {
      apiInstance.elementCategoryCreateSecurityEntry(webId, securityEntry, applyToChildren, webIdType);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElementCategoryApi#elementCategoryCreateSecurityEntry");
...
public class Example {
  public static void main(String[] args) {
    ...
    ElementCategoryApi apiInstance = new ElementCategoryApi(defaultClient);
    String webId = "webId_example"; // String | The ID of the element category to delete.
    try {
      apiInstance.elementCategoryDelete(webId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElementCategoryApi#elementCategoryDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="elementCategoryDeleteSecurityEntry"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String webId = "webId_example"; // String | The ID of the element category where the security entry will be deleted.
    Boolean applyToChildren = true; // Boolean | If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.
    try {
      apiInstance.elementCategoryDeleteSecurityEntry(name, webId, applyToChildren);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElementCategoryApi#elementCategoryDeleteSecurityEntry");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="elementCategoryGet"></a>
# **elementCategoryGet**
> ElementCategory elementCategoryGet(webId, selectedFields, webIdType)
...
public class Example {
  public static void main(String[] args) {
    ...
    ElementCategoryApi apiInstance = new ElementCategoryApi(defaultClient);
    String webId = "webId_example"; // String | The id of the element category.
    ...
    String webIdType = "webIdType_example"; // String | Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".
    try {
      ElementCategory result = apiInstance.elementCategoryGet(webId, selectedFields, webIdType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElementCategoryApi#elementCategoryGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="elementCategoryGetByPath"></a>
# **elementCategoryGetByPath**
> ElementCategory elementCategoryGetByPath(path, selectedFields, webIdType)
...
public class Example {
  public static void main(String[] args) {
    ...
    ElementCategoryApi apiInstance = new ElementCategoryApi(defaultClient);
    String path = "path_example"; // String | The path to the target element category.
    String selectedFields = "selectedFields_example"; // String | List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.
    String webIdType = "webIdType_example"; // String | Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".
    try {
      ElementCategory result = apiInstance.elementCategoryGetByPath(path, selectedFields, webIdType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElementCategoryApi#elementCategoryGetByPath");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="elementCategoryGetSecurity"></a>
# **elementCategoryGetSecurity**
> ItemsSecurityRights elementCategoryGetSecurity(webId, userIdentity, forceRefresh, selectedFields, webIdType)
...
public class Example {
  public static void main(String[] args) {
    ...
    ElementCategoryApi apiInstance = new ElementCategoryApi(defaultClient);
    String webId = "webId_example"; // String | The ID of the element category for the security to be checked.
    ...
    String webIdType = "webIdType_example"; // String | Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".
    try {
      ItemsSecurityRights result = apiInstance.elementCategoryGetSecurity(webId, userIdentity, forceRefresh, selectedFields, webIdType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElementCategoryApi#elementCategoryGetSecurity");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="elementCategoryGetSecurityEntries"></a>
# **elementCategoryGetSecurityEntries**
> ItemsSecurityEntry elementCategoryGetSecurityEntries(webId, nameFilter, selectedFields, webIdType)
...
public class Example {
  public static void main(String[] args) {
    ...
    String webIdType = "webIdType_example"; // String | Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".
    try {
      ItemsSecurityEntry result = apiInstance.elementCategoryGetSecurityEntries(webId, nameFilter, selectedFields, webIdType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElementCategoryApi#elementCategoryGetSecurityEntries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="elementCategoryGetSecurityEntryByName"></a>
# **elementCategoryGetSecurityEntryByName**
> SecurityEntry elementCategoryGetSecurityEntryByName(name, webId, selectedFields, webIdType)
...
public class Example {
  public static void main(String[] args) {
    ...
    String webIdType = "webIdType_example"; // String | Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item \"WebIDType\".
    try {
      SecurityEntry result = apiInstance.elementCategoryGetSecurityEntryByName(name, webId, selectedFields, webIdType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElementCategoryApi#elementCategoryGetSecurityEntryByName");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ElementCategoryApi apiInstance = new ElementCategoryApi(defaultClient);
    String webId = "webId_example"; // String | The ID of the element category to update.
    ElementCategory elementCategory = new ElementCategory(); // ElementCategory | A partial element category containing the desired changes.
    try {
      apiInstance.elementCategoryUpdate(webId, elementCategory);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElementCategoryApi#elementCategoryUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="elementCategoryUpdateSecurityEntry"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String webId = "webId_example"; // String | The ID of the element category where the security entry will be updated.
    ...
    Boolean applyToChildren = true; // Boolean | If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.
    try {
      apiInstance.elementCategoryUpdateSecurityEntry(name, webId, securityEntry, applyToChildren);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElementCategoryApi#elementCategoryUpdateSecurityEntry");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
