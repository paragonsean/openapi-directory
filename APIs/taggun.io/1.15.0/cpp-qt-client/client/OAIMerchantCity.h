...
#ifndef OAIMerchantCity_H
#define OAIMerchantCity_H
...
class OAIMerchantCity : public OAIObject {
public:
    OAIMerchantCity();
    OAIMerchantCity(QString json);
    ~OAIMerchantCity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantCity)

#endif // OAIMerchantCity_H
