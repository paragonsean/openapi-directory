...
QString OAIName::getData() const {
    return m_data;
}
void OAIName::setData(const QString &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIName::is_data_Set() const{
    return m_data_isSet;
}

bool OAIName::is_data_Valid() const{
    return m_data_isValid;
}

QList<QList> OAIName::getRegions() const {
    return m_regions;
}
void OAIName::setRegions(const QList<QList> &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIName::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIName::is_regions_Valid() const{
    return m_regions_isValid;
}

QString OAIName::getText() const {
    return m_text;
}
void OAIName::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIName::is_text_Set() const{
    return m_text_isSet;
}

bool OAIName::is_text_Valid() const{
