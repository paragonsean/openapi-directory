...
void OAIPaymentType::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIPaymentType::asJsonObject() const {
    QJsonObject obj;
...
double OAIPaymentType::getConfidenceLevel() const {
    return m_confidence_level;
}
void OAIPaymentType::setConfidenceLevel(const double &confidence_level) {
    m_confidence_level = confidence_level;
    m_confidence_level_isSet = true;
}

bool OAIPaymentType::is_confidence_level_Set() const{
    return m_confidence_level_isSet;
}

bool OAIPaymentType::is_confidence_level_Valid() const{
    return m_confidence_level_isValid;
}

QString OAIPaymentType::getData() const {
    return m_data;
}
void OAIPaymentType::setData(const QString &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPaymentType::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPaymentType::is_data_Valid() const{
    return m_data_isValid;
}

double OAIPaymentType::getIndex() const {
    return m_index;
}
void OAIPaymentType::setIndex(const double &index) {
    m_index = index;
    m_index_isSet = true;
}

bool OAIPaymentType::is_index_Set() const{
    return m_index_isSet;
}

bool OAIPaymentType::is_index_Valid() const{
    return m_index_isValid;
}

QList<QList> OAIPaymentType::getRegions() const {
    return m_regions;
}
void OAIPaymentType::setRegions(const QList<QList> &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIPaymentType::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIPaymentType::is_regions_Valid() const{
    return m_regions_isValid;
}

QString OAIPaymentType::getText() const {
    return m_text;
}
void OAIPaymentType::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIPaymentType::is_text_Set() const{
    return m_text_isSet;
}

bool OAIPaymentType::is_text_Valid() const{
