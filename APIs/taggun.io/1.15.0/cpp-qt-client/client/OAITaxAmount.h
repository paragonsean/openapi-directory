...
#ifndef OAITaxAmount_H
#define OAITaxAmount_H
...
class OAITaxAmount : public OAIObject {
public:
    OAITaxAmount();
    OAITaxAmount(QString json);
    ~OAITaxAmount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaxAmount)

#endif // OAITaxAmount_H
