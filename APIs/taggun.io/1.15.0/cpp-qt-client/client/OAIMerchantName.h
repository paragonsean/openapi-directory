...
#ifndef OAIMerchantName_H
#define OAIMerchantName_H
...
class OAIMerchantName : public OAIObject {
public:
    OAIMerchantName();
    OAIMerchantName(QString json);
    ~OAIMerchantName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantName)

#endif // OAIMerchantName_H
