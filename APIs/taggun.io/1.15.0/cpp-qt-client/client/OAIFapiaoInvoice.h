...
#ifndef OAIFapiaoInvoice_H
#define OAIFapiaoInvoice_H
...
class OAIFapiaoInvoice : public OAIObject {
public:
    OAIFapiaoInvoice();
    OAIFapiaoInvoice(QString json);
    ~OAIFapiaoInvoice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFapiaoInvoice)

#endif // OAIFapiaoInvoice_H
