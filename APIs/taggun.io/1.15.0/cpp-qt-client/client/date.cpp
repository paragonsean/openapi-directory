...
void date::fromJson(QString jsonString) {
...
void date::fromJsonObject(QJsonObject json) {
...
QJsonObject date::asJsonObject() const {
    QJsonObject obj;
...
double date::getConfidenceLevel() const {
    return m_confidence_level;
}
void date::setConfidenceLevel(const double &confidence_level) {
    m_confidence_level = confidence_level;
    m_confidence_level_isSet = true;
}

bool date::is_confidence_level_Set() const{
    return m_confidence_level_isSet;
}

bool date::is_confidence_level_Valid() const{
    return m_confidence_level_isValid;
}

QDateTime date::getData() const {
    return m_data;
}
void date::setData(const QDateTime &data) {
    m_data = data;
    m_data_isSet = true;
}

bool date::is_data_Set() const{
    return m_data_isSet;
}

bool date::is_data_Valid() const{
    return m_data_isValid;
}

double date::getIndex() const {
    return m_index;
}
void date::setIndex(const double &index) {
    m_index = index;
    m_index_isSet = true;
}

bool date::is_index_Set() const{
    return m_index_isSet;
}

bool date::is_index_Valid() const{
    return m_index_isValid;
}

QList<QList> date::getRegions() const {
    return m_regions;
}
void date::setRegions(const QList<QList> &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool date::is_regions_Set() const{
    return m_regions_isSet;
}

bool date::is_regions_Valid() const{
    return m_regions_isValid;
}

QString date::getText() const {
    return m_text;
}
void date::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool date::is_text_Set() const{
    return m_text_isSet;
}

bool date::is_text_Valid() const{
