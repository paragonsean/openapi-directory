...
#ifndef OAIBranchNumber_H
#define OAIBranchNumber_H
...
class OAIBranchNumber : public OAIObject {
public:
    OAIBranchNumber();
    OAIBranchNumber(QString json);
    ~OAIBranchNumber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBranchNumber)

#endif // OAIBranchNumber_H
