...
/*
 * OAIFapiaoInvoiceCode.h
 *
 * 
 */

#ifndef OAIFapiaoInvoiceCode_H
#define OAIFapiaoInvoiceCode_H
...
class OAIFapiaoInvoiceCode : public OAIObject {
public:
    OAIFapiaoInvoiceCode();
    OAIFapiaoInvoiceCode(QString json);
    ~OAIFapiaoInvoiceCode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFapiaoInvoiceCode)

#endif // OAIFapiaoInvoiceCode_H
