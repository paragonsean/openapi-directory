...
double OAIMatch::getConfidenceLevel() const {
    return m_confidence_level;
}
void OAIMatch::setConfidenceLevel(const double &confidence_level) {
    m_confidence_level = confidence_level;
    m_confidence_level_isSet = true;
}

bool OAIMatch::is_confidence_level_Set() const{
    return m_confidence_level_isSet;
}

bool OAIMatch::is_confidence_level_Valid() const{
    return m_confidence_level_isValid;
}

QString OAIMatch::getData() const {
    return m_data;
}
void OAIMatch::setData(const QString &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMatch::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMatch::is_data_Valid() const{
    return m_data_isValid;
}

double OAIMatch::getIndex() const {
    return m_index;
}
void OAIMatch::setIndex(const double &index) {
    m_index = index;
    m_index_isSet = true;
}

bool OAIMatch::is_index_Set() const{
    return m_index_isSet;
}

bool OAIMatch::is_index_Valid() const{
    return m_index_isValid;
}

QString OAIMatch::getKeyword() const {
    return m_keyword;
}
void OAIMatch::setKeyword(const QString &keyword) {
    m_keyword = keyword;
    m_keyword_isSet = true;
}

bool OAIMatch::is_keyword_Set() const{
    return m_keyword_isSet;
}

bool OAIMatch::is_keyword_Valid() const{
    return m_keyword_isValid;
}

QList<QList> OAIMatch::getRegions() const {
    return m_regions;
}
void OAIMatch::setRegions(const QList<QList> &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIMatch::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIMatch::is_regions_Valid() const{
