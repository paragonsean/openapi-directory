...
/*
 * OAIShoppingMallName.h
 *
 * 
 */

#ifndef OAIShoppingMallName_H
#define OAIShoppingMallName_H
...
class OAIShoppingMallName : public OAIObject {
public:
    OAIShoppingMallName();
    OAIShoppingMallName(QString json);
    ~OAIShoppingMallName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShoppingMallName)

#endif // OAIShoppingMallName_H
