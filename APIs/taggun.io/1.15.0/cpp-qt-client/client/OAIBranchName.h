...
#ifndef OAIBranchName_H
#define OAIBranchName_H
...
class OAIBranchName : public OAIObject {
public:
    OAIBranchName();
    OAIBranchName(QString json);
    ~OAIBranchName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBranchName)

#endif // OAIBranchName_H
