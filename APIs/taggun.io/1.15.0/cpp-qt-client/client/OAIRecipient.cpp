...
double OAIRecipient::getConfidenceLevel() const {
    return m_confidence_level;
}
void OAIRecipient::setConfidenceLevel(const double &confidence_level) {
    m_confidence_level = confidence_level;
    m_confidence_level_isSet = true;
}

bool OAIRecipient::is_confidence_level_Set() const{
    return m_confidence_level_isSet;
}

bool OAIRecipient::is_confidence_level_Valid() const{
    return m_confidence_level_isValid;
}

QString OAIRecipient::getData() const {
    return m_data;
}
void OAIRecipient::setData(const QString &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIRecipient::is_data_Set() const{
    return m_data_isSet;
}

bool OAIRecipient::is_data_Valid() const{
    return m_data_isValid;
}

double OAIRecipient::getIndex() const {
    return m_index;
}
void OAIRecipient::setIndex(const double &index) {
    m_index = index;
    m_index_isSet = true;
}

bool OAIRecipient::is_index_Set() const{
    return m_index_isSet;
}

bool OAIRecipient::is_index_Valid() const{
    return m_index_isValid;
}

QList<QList> OAIRecipient::getRegions() const {
    return m_regions;
}
void OAIRecipient::setRegions(const QList<QList> &regions) {
    m_regions = regions;
    m_regions_isSet = true;
}

bool OAIRecipient::is_regions_Set() const{
    return m_regions_isSet;
}

bool OAIRecipient::is_regions_Valid() const{
    return m_regions_isValid;
}

QString OAIRecipient::getText() const {
    return m_text;
}
void OAIRecipient::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIRecipient::is_text_Set() const{
    return m_text_isSet;
}

bool OAIRecipient::is_text_Valid() const{
