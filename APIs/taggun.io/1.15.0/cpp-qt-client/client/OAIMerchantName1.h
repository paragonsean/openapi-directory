...
#ifndef OAIMerchantName1_H
#define OAIMerchantName1_H
...
class OAIMerchantName1 : public OAIObject {
public:
    OAIMerchantName1();
    OAIMerchantName1(QString json);
    ~OAIMerchantName1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantName1)

#endif // OAIMerchantName1_H
