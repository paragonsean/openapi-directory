...
#ifndef OAIBankName_H
#define OAIBankName_H
...
class OAIBankName : public OAIObject {
public:
    OAIBankName();
    OAIBankName(QString json);
    ~OAIBankName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankName)
