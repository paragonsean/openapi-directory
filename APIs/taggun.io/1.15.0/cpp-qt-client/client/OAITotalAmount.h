...
#ifndef OAITotalAmount_H
#define OAITotalAmount_H
...
class OAITotalAmount : public OAIObject {
public:
    OAITotalAmount();
    OAITotalAmount(QString json);
    ~OAITotalAmount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITotalAmount)

#endif // OAITotalAmount_H
