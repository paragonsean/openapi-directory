...
#ifndef OAIQrCodeData_H
#define OAIQrCodeData_H
...
class OAIQrCodeData : public OAIObject {
public:
    OAIQrCodeData();
    OAIQrCodeData(QString json);
    ~OAIQrCodeData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQrCodeData)

#endif // OAIQrCodeData_H
