...
#ifndef OAIMerchantCity1_H
#define OAIMerchantCity1_H
...
class OAIMerchantCity1 : public OAIObject {
public:
    OAIMerchantCity1();
    OAIMerchantCity1(QString json);
    ~OAIMerchantCity1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantCity1)

#endif // OAIMerchantCity1_H
