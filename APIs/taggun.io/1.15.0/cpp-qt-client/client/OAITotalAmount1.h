...
#ifndef OAITotalAmount1_H
#define OAITotalAmount1_H
...
class OAITotalAmount1 : public OAIObject {
public:
    OAITotalAmount1();
    OAITotalAmount1(QString json);
    ~OAITotalAmount1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITotalAmount1)

#endif // OAITotalAmount1_H
