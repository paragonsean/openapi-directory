...
/*
 * OAIFapiaoInvoiceNumber.h
 *
 * 
 */

#ifndef OAIFapiaoInvoiceNumber_H
#define OAIFapiaoInvoiceNumber_H
...
class OAIFapiaoInvoiceNumber : public OAIObject {
public:
    OAIFapiaoInvoiceNumber();
    OAIFapiaoInvoiceNumber(QString json);
    ~OAIFapiaoInvoiceNumber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFapiaoInvoiceNumber)

#endif // OAIFapiaoInvoiceNumber_H
