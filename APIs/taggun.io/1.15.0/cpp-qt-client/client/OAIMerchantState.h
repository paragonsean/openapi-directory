...
#ifndef OAIMerchantState_H
#define OAIMerchantState_H
...
class OAIMerchantState : public OAIObject {
public:
    OAIMerchantState();
    OAIMerchantState(QString json);
    ~OAIMerchantState() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantState)

#endif // OAIMerchantState_H
