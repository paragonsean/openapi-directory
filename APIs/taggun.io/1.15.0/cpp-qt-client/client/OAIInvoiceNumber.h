...
#ifndef OAIInvoiceNumber_H
#define OAIInvoiceNumber_H
...
class OAIInvoiceNumber : public OAIObject {
public:
    OAIInvoiceNumber();
    OAIInvoiceNumber(QString json);
    ~OAIInvoiceNumber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceNumber)

#endif // OAIInvoiceNumber_H
