...
#ifndef OAIProductName_H
#define OAIProductName_H
...
class OAIProductName : public OAIObject {
public:
    OAIProductName();
    OAIProductName(QString json);
    ~OAIProductName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductName)

#endif // OAIProductName_H
