...
#ifndef OAIStoragePayload_H
#define OAIStoragePayload_H
...
class OAIStoragePayload : public OAIObject {
public:
    OAIStoragePayload();
    OAIStoragePayload(QString json);
    ~OAIStoragePayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoragePayload)

#endif // OAIStoragePayload_H
