...
#ifndef OAIWineVarietal_H
#define OAIWineVarietal_H
...
class OAIWineVarietal : public OAIObject {
public:
    OAIWineVarietal();
    OAIWineVarietal(QString json);
    ~OAIWineVarietal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWineVarietal)

#endif // OAIWineVarietal_H
