...
/*
 * OAIMerchantAddress1.h
 *
 * 
 */

#ifndef OAIMerchantAddress1_H
#define OAIMerchantAddress1_H
...
class OAIMerchantAddress1 : public OAIObject {
public:
    OAIMerchantAddress1();
    OAIMerchantAddress1(QString json);
    ~OAIMerchantAddress1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantAddress1)

#endif // OAIMerchantAddress1_H
