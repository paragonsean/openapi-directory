...
/*
 * OAIFapiaoMerchantTaxId.h
 *
 * 
 */

#ifndef OAIFapiaoMerchantTaxId_H
#define OAIFapiaoMerchantTaxId_H
...
class OAIFapiaoMerchantTaxId : public OAIObject {
public:
    OAIFapiaoMerchantTaxId();
    OAIFapiaoMerchantTaxId(QString json);
    ~OAIFapiaoMerchantTaxId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFapiaoMerchantTaxId)

#endif // OAIFapiaoMerchantTaxId_H
