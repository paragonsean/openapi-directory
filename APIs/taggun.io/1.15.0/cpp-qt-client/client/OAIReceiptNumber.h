...
#ifndef OAIReceiptNumber_H
#define OAIReceiptNumber_H
...
class OAIReceiptNumber : public OAIObject {
public:
    OAIReceiptNumber();
    OAIReceiptNumber(QString json);
    ~OAIReceiptNumber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReceiptNumber)

#endif // OAIReceiptNumber_H
