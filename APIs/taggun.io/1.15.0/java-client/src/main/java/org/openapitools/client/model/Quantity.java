...
public class Quantity {
  ...
  public Quantity data(BigDecimal data) {
    this.data = data;
    return this;
  }
  ...
  public Quantity text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, quantity.data) &&
        Objects.equals(this.text, quantity.text);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Quantity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Quantity is not found in the empty JSON string", Quantity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Quantity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Quantity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
