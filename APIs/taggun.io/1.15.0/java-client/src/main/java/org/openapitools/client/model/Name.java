...
public class Name {
  ...
  public Name regions(List<List<Model1>> regions) {
    this.regions = regions;
    return this;
  }

  public Name addRegionsItem(List<Model1> regionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    Name name = (Name) o;
    return Objects.equals(this.data, name.data) &&
        Objects.equals(this.regions, name.regions) &&
