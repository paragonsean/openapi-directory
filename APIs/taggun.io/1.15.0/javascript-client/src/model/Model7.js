...
class Model7 {
    ...
    /**
     * Validates the JSON data with respect to <code>Model7</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Model7</code>.
     */
 ...
 */
Model7.prototype['confidenceLevel'] = undefined;

/**
 * @member {module:model/Data2} data
 */
Model7.prototype['data'] = undefined;

/**
 * @member {Number} index
 */
Model7.prototype['index'] = undefined;

/**
 * @member {Array.<Array.<module:model/Model1>>} regions
 */
Model7.prototype['regions'] = undefined;

/**
 * @member {String} text
 */
Model7.prototype['text'] = undefined;
