...
class PaymentType {
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentType</code>.
     */
 ...
 */
PaymentType.prototype['confidenceLevel'] = undefined;

/**
 * @member {String} data
 */
PaymentType.prototype['data'] = undefined;

/**
 * @member {Number} index
 */
PaymentType.prototype['index'] = undefined;

/**
 * @member {Array.<Array.<module:model/Model1>>} regions
 */
PaymentType.prototype['regions'] = undefined;

/**
 * @member {String} text
 */
PaymentType.prototype['text'] = undefined;
