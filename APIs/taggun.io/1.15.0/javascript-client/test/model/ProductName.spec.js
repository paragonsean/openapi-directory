...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.ProductName();
  });
  ...
  describe('ProductName', function() {
    it('should create an instance of ProductName', function() {
      // uncomment below and update the code to test ProductName
      //var instance = new TaggunReceiptOcrScanningApi.ProductName();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.ProductName);
    });
