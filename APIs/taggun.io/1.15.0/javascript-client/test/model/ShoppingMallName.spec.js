...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.ShoppingMallName();
  });
  ...
  describe('ShoppingMallName', function() {
    it('should create an instance of ShoppingMallName', function() {
      // uncomment below and update the code to test ShoppingMallName
      //var instance = new TaggunReceiptOcrScanningApi.ShoppingMallName();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.ShoppingMallName);
    });
