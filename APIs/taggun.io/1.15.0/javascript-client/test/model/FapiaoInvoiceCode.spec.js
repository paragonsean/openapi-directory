...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.FapiaoInvoiceCode();
  });
  ...
  describe('FapiaoInvoiceCode', function() {
    it('should create an instance of FapiaoInvoiceCode', function() {
      // uncomment below and update the code to test FapiaoInvoiceCode
      //var instance = new TaggunReceiptOcrScanningApi.FapiaoInvoiceCode();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.FapiaoInvoiceCode);
    });
