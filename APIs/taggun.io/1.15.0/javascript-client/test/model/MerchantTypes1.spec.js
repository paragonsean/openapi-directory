...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.MerchantTypes1();
  });
  ...
  describe('MerchantTypes1', function() {
    it('should create an instance of MerchantTypes1', function() {
      // uncomment below and update the code to test MerchantTypes1
      //var instance = new TaggunReceiptOcrScanningApi.MerchantTypes1();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.MerchantTypes1);
    });
