...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.TotalAmount();
  });
  ...
  describe('TotalAmount', function() {
    it('should create an instance of TotalAmount', function() {
      // uncomment below and update the code to test TotalAmount
      //var instance = new TaggunReceiptOcrScanningApi.TotalAmount();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.TotalAmount);
    });
