...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Match();
  });
  ...
  describe('Match', function() {
    it('should create an instance of Match', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.Match();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Match);
    });
