...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Quantity1();
  });
  ...
  describe('Quantity1', function() {
    it('should create an instance of Quantity1', function() {
      // uncomment below and update the code to test Quantity1
      //var instance = new TaggunReceiptOcrScanningApi.Quantity1();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Quantity1);
    });
