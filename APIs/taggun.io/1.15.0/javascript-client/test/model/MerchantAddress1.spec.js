...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.MerchantAddress1();
  });
  ...
  describe('MerchantAddress1', function() {
    it('should create an instance of MerchantAddress1', function() {
      // uncomment below and update the code to test MerchantAddress1
      //var instance = new TaggunReceiptOcrScanningApi.MerchantAddress1();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.MerchantAddress1);
    });
