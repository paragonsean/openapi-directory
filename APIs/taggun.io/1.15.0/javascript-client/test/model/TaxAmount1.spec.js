...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.TaxAmount1();
  });
  ...
  describe('TaxAmount1', function() {
    it('should create an instance of TaxAmount1', function() {
      // uncomment below and update the code to test TaxAmount1
      //var instance = new TaggunReceiptOcrScanningApi.TaxAmount1();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.TaxAmount1);
    });
