...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Model8();
  });
  ...
  describe('Model8', function() {
    it('should create an instance of Model8', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.Model8();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Model8);
    });
