...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Result();
  });
  ...
  describe('Result', function() {
    it('should create an instance of Result', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.Result();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Result);
    });
