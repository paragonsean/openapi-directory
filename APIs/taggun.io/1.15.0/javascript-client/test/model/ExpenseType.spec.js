...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.ExpenseType();
  });
  ...
  describe('ExpenseType', function() {
    it('should create an instance of ExpenseType', function() {
      // uncomment below and update the code to test ExpenseType
      //var instance = new TaggunReceiptOcrScanningApi.ExpenseType();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.ExpenseType);
    });
