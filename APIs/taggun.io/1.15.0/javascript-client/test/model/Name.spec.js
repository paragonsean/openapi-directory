...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Name();
  });
  ...
  describe('Name', function() {
    it('should create an instance of Name', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.Name();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Name);
    });
