...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.PaymentType();
  });
  ...
  describe('PaymentType', function() {
    it('should create an instance of PaymentType', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.PaymentType();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.PaymentType);
    });
