...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.InvoiceNumber();
  });
  ...
  describe('InvoiceNumber', function() {
    it('should create an instance of InvoiceNumber', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.InvoiceNumber();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.InvoiceNumber);
    });
