...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.FapiaoInvoiceNumber();
  });
  ...
  describe('FapiaoInvoiceNumber', function() {
    it('should create an instance of FapiaoInvoiceNumber', function() {
      // uncomment below and update the code to test FapiaoInvoiceNumber
      //var instance = new TaggunReceiptOcrScanningApi.FapiaoInvoiceNumber();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.FapiaoInvoiceNumber);
    });
