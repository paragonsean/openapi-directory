...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.TotalAmount1();
  });
  ...
  describe('TotalAmount1', function() {
    it('should create an instance of TotalAmount1', function() {
      // uncomment below and update the code to test TotalAmount1
      //var instance = new TaggunReceiptOcrScanningApi.TotalAmount1();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.TotalAmount1);
    });
