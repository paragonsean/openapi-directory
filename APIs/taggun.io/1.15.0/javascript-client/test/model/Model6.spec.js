...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Model6();
  });
  ...
  describe('Model6', function() {
    it('should create an instance of Model6', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.Model6();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Model6);
    });
