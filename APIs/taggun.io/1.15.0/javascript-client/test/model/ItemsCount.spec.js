...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.ItemsCount();
  });
  ...
  describe('ItemsCount', function() {
    it('should create an instance of ItemsCount', function() {
      // uncomment below and update the code to test ItemsCount
      //var instance = new TaggunReceiptOcrScanningApi.ItemsCount();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.ItemsCount);
    });
