...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.MerchantCountryCode1();
  });
  ...
  describe('MerchantCountryCode1', function() {
    it('should create an instance of MerchantCountryCode1', function() {
      // uncomment below and update the code to test MerchantCountryCode1
      //var instance = new TaggunReceiptOcrScanningApi.MerchantCountryCode1();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.MerchantCountryCode1);
    });
