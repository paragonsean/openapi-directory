...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Model3();
  });
  ...
  describe('Model3', function() {
    it('should create an instance of Model3', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.Model3();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Model3);
    });
