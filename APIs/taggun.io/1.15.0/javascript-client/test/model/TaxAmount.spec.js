...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.TaxAmount();
  });
  ...
  describe('TaxAmount', function() {
    it('should create an instance of TaxAmount', function() {
      // uncomment below and update the code to test TaxAmount
      //var instance = new TaggunReceiptOcrScanningApi.TaxAmount();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.TaxAmount);
    });
