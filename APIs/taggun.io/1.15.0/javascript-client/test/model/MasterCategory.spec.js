...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.MasterCategory();
  });
  ...
  describe('MasterCategory', function() {
    it('should create an instance of MasterCategory', function() {
      // uncomment below and update the code to test MasterCategory
      //var instance = new TaggunReceiptOcrScanningApi.MasterCategory();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.MasterCategory);
    });
