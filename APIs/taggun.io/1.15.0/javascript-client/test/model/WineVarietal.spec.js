...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.WineVarietal();
  });
  ...
  describe('WineVarietal', function() {
    it('should create an instance of WineVarietal', function() {
      // uncomment below and update the code to test WineVarietal
      //var instance = new TaggunReceiptOcrScanningApi.WineVarietal();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.WineVarietal);
    });
