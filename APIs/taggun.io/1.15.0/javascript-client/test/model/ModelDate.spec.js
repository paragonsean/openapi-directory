...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.ModelDate();
  });
  ...
  describe('ModelDate', function() {
    it('should create an instance of ModelDate', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.ModelDate();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.ModelDate);
    });
