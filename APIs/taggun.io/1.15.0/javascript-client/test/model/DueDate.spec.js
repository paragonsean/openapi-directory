...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.DueDate();
  });
  ...
  describe('DueDate', function() {
    it('should create an instance of DueDate', function() {
      // uncomment below and update the code to test DueDate
      //var instance = new TaggunReceiptOcrScanningApi.DueDate();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.DueDate);
    });
