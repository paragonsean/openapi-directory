...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.MerchantCity1();
  });
  ...
  describe('MerchantCity1', function() {
    it('should create an instance of MerchantCity1', function() {
      // uncomment below and update the code to test MerchantCity1
      //var instance = new TaggunReceiptOcrScanningApi.MerchantCity1();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.MerchantCity1);
    });
