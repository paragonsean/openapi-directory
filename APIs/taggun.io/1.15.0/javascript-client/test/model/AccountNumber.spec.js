...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.AccountNumber();
  });
  ...
  describe('AccountNumber', function() {
    it('should create an instance of AccountNumber', function() {
      // uncomment below and update the code to test AccountNumber
      //var instance = new TaggunReceiptOcrScanningApi.AccountNumber();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.AccountNumber);
    });
