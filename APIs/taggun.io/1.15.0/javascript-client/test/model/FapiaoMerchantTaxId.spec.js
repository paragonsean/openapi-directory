...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.FapiaoMerchantTaxId();
  });
  ...
  describe('FapiaoMerchantTaxId', function() {
    it('should create an instance of FapiaoMerchantTaxId', function() {
      // uncomment below and update the code to test FapiaoMerchantTaxId
      //var instance = new TaggunReceiptOcrScanningApi.FapiaoMerchantTaxId();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.FapiaoMerchantTaxId);
    });
