...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.BranchNumber();
  });
  ...
  describe('BranchNumber', function() {
    it('should create an instance of BranchNumber', function() {
      // uncomment below and update the code to test BranchNumber
      //var instance = new TaggunReceiptOcrScanningApi.BranchNumber();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.BranchNumber);
    });
