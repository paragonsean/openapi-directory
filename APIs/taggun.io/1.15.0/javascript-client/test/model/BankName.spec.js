...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.BankName();
  });
  ...
  describe('BankName', function() {
    it('should create an instance of BankName', function() {
      // uncomment below and update the code to test BankName
      //var instance = new TaggunReceiptOcrScanningApi.BankName();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.BankName);
    });
