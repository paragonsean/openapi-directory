...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.ReceiptNumber();
  });
  ...
  describe('ReceiptNumber', function() {
    it('should create an instance of ReceiptNumber', function() {
      // uncomment below and update the code to test ReceiptNumber
      //var instance = new TaggunReceiptOcrScanningApi.ReceiptNumber();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.ReceiptNumber);
    });
