...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.MerchantVerification();
  });
  ...
  describe('MerchantVerification', function() {
    it('should create an instance of MerchantVerification', function() {
      // uncomment below and update the code to test MerchantVerification
      //var instance = new TaggunReceiptOcrScanningApi.MerchantVerification();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.MerchantVerification);
    });
