...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.ReceiptMatchResult();
  });
  ...
  describe('ReceiptMatchResult', function() {
    it('should create an instance of ReceiptMatchResult', function() {
      // uncomment below and update the code to test ReceiptMatchResult
      //var instance = new TaggunReceiptOcrScanningApi.ReceiptMatchResult();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.ReceiptMatchResult);
    });
