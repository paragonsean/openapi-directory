...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.IBAN();
  });
  ...
  describe('IBAN', function() {
    it('should create an instance of IBAN', function() {
      // uncomment below and update the code to test IBAN
      //var instance = new TaggunReceiptOcrScanningApi.IBAN();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.IBAN);
    });
