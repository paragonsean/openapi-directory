...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Recipient();
  });
  ...
  describe('Recipient', function() {
    it('should create an instance of Recipient', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.Recipient();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Recipient);
    });
