...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Text();
  });
  ...
  describe('Text', function() {
    it('should create an instance of Text', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.Text();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Text);
    });
