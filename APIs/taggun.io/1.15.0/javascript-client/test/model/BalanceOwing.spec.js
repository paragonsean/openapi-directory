...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.BalanceOwing();
  });
  ...
  describe('BalanceOwing', function() {
    it('should create an instance of BalanceOwing', function() {
      // uncomment below and update the code to test BalanceOwing
      //var instance = new TaggunReceiptOcrScanningApi.BalanceOwing();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.BalanceOwing);
    });
