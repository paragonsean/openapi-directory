...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.BranchName();
  });
  ...
  describe('BranchName', function() {
    it('should create an instance of BranchName', function() {
      // uncomment below and update the code to test BranchName
      //var instance = new TaggunReceiptOcrScanningApi.BranchName();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.BranchName);
    });
