...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.QrCodeData();
  });
  ...
  describe('QrCodeData', function() {
    it('should create an instance of QrCodeData', function() {
      // uncomment below and update the code to test QrCodeData
      //var instance = new TaggunReceiptOcrScanningApi.QrCodeData();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.QrCodeData);
    });
