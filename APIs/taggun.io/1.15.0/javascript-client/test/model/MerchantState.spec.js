...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.MerchantState();
  });
  ...
  describe('MerchantState', function() {
    it('should create an instance of MerchantState', function() {
      // uncomment below and update the code to test MerchantState
      //var instance = new TaggunReceiptOcrScanningApi.MerchantState();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.MerchantState);
    });
