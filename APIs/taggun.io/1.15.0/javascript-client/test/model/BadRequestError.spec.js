...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.BadRequestError();
  });
  ...
  describe('BadRequestError', function() {
    it('should create an instance of BadRequestError', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.BadRequestError();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.BadRequestError);
    });
