...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Model7();
  });
  ...
  describe('Model7', function() {
    it('should create an instance of Model7', function() {
      ...
      //var instance = new TaggunReceiptOcrScanningApi.Model7();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Model7);
    });
