...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.FapiaoInvoice();
  });
  ...
  describe('FapiaoInvoice', function() {
    it('should create an instance of FapiaoInvoice', function() {
      // uncomment below and update the code to test FapiaoInvoice
      //var instance = new TaggunReceiptOcrScanningApi.FapiaoInvoice();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.FapiaoInvoice);
    });
