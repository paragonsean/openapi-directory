...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.MerchantName1();
  });
  ...
  describe('MerchantName1', function() {
    it('should create an instance of MerchantName1', function() {
      // uncomment below and update the code to test MerchantName1
      //var instance = new TaggunReceiptOcrScanningApi.MerchantName1();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.MerchantName1);
    });
