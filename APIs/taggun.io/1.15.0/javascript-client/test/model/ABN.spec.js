...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.ABN();
  });
  ...
  describe('ABN', function() {
    it('should create an instance of ABN', function() {
      // uncomment below and update the code to test ABN
      //var instance = new TaggunReceiptOcrScanningApi.ABN();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.ABN);
    });
