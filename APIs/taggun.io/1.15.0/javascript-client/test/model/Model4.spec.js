...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Model4();
  });
  ...
  describe('Model4', function() {
    it('should create an instance of Model4', function() {
      // uncomment below and update the code to test Model4
      //var instance = new TaggunReceiptOcrScanningApi.Model4();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Model4);
    });
