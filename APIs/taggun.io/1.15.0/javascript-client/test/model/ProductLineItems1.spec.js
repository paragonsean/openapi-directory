...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.ProductLineItems1();
  });
  ...
  describe('ProductLineItems1', function() {
    it('should create an instance of ProductLineItems1', function() {
      // uncomment below and update the code to test ProductLineItems1
      //var instance = new TaggunReceiptOcrScanningApi.ProductLineItems1();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.ProductLineItems1);
    });
