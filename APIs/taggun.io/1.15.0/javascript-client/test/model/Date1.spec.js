...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaggunReceiptOcrScanningApi.Date1();
  });
  ...
  describe('Date1', function() {
    it('should create an instance of Date1', function() {
      // uncomment below and update the code to test Date1
      //var instance = new TaggunReceiptOcrScanningApi.Date1();
      //expect(instance).to.be.a(TaggunReceiptOcrScanningApi.Date1);
    });
