...
|------------ | ------------- | ------------- | -------------|
|**cloudCover** | [**PointPointDailyAfternoonCloudCoverData**](PointPointDailyAfternoonCloudCoverData.md) |  |  |
|**dewPoint** | **BigDecimal** | Units: metric &#x3D; °C, us &#x3D; °F, uk &#x3D; °C, ca &#x3D; °C |  [optional] |
|**feelsLike** | **BigDecimal** | Units: metric &#x3D; °C, us &#x3D; °F, uk &#x3D; °C, ca &#x3D; °C |  [optional] |
|**humidity** | **Integer** | Relative humidity. (afternoon avg) Unit: \\% |  [optional] |
...
|**ozone** | **BigDecimal** | Total column of ozone. (afternoon avg) Unit: Dobson |  [optional] |
|**precipitation** | [**PointPointDailyAfternoonPrecipitationData**](PointPointDailyAfternoonPrecipitationData.md) |  |  |
|**pressure** | **BigDecimal** | Atmospheric pressure at mean sea level. (afternoon avg) Units: metric &#x3D; hPa, us &#x3D; Hg, uk &#x3D; hPa, ca &#x3D; kPa |  [optional] |
|**probability** | [**PointPointDailyAfternoonProbData**](PointPointDailyAfternoonProbData.md) |  |  |
|**snowDepth** | **BigDecimal** | Snow depth. (afternoon avg) Units: metric &#x3D; cm, us &#x3D; inch, uk &#x3D; cm, ca &#x3D; cm |  [optional] |
...
|**temperature** | **BigDecimal** | Temperature 2 metres above ground. (afternoon avg) Units: metric &#x3D; °C, us &#x3D; °F, uk &#x3D; °C, ca &#x3D; °C |  [optional] |
|**visibility** | **BigDecimal** | Visibility. (afternoon avg) Units: metric &#x3D; km, us &#x3D; mi, uk &#x3D; mi, ca &#x3D; km |  [optional] |
|**weather** | **String** | Afternoon day string identifier of the weather icon, e.g. &#x60;light_rain&#x60;. |  [optional] |
|**wind** | [**PointPointDailyAfternoonWindData**](PointPointDailyAfternoonWindData.md) |  |  |
|**windChill** | **BigDecimal** | Temperature 2 metres above ground. (afternoon avg) Units: metric &#x3D; °C, us &#x3D; °F, uk &#x3D; °C, ca &#x3D; °C |  [optional] |
