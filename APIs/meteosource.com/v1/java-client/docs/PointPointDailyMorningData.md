...
|------------ | ------------- | ------------- | -------------|
|**cloudCover** | [**PointPointDailyMorningCloudCoverData**](PointPointDailyMorningCloudCoverData.md) |  |  |
|**dewPoint** | **BigDecimal** | Units: metric &#x3D; °C, us &#x3D; °F, uk &#x3D; °C, ca &#x3D; °C |  [optional] |
|**feelsLike** | **BigDecimal** | Units: metric &#x3D; °C, us &#x3D; °F, uk &#x3D; °C, ca &#x3D; °C |  [optional] |
|**humidity** | **Integer** | Relative humidity. (morning avg) Unit: \\% |  [optional] |
...
|**ozone** | **BigDecimal** | Total column of ozone. (morning avg) Unit: Dobson |  [optional] |
|**precipitation** | [**PointPointDailyMorningPrecipitationData**](PointPointDailyMorningPrecipitationData.md) |  |  |
|**pressure** | **BigDecimal** | Atmospheric pressure at mean sea level. (morning avg) Units: metric &#x3D; hPa, us &#x3D; Hg, uk &#x3D; hPa, ca &#x3D; kPa |  [optional] |
|**probability** | [**PointPointDailyMorningProbData**](PointPointDailyMorningProbData.md) |  |  |
|**snowDepth** | **BigDecimal** | Snow depth. (morning avg) Units: metric &#x3D; cm, us &#x3D; inch, uk &#x3D; cm, ca &#x3D; cm |  [optional] |
...
|**temperature** | **BigDecimal** | Temperature 2 metres above ground. (morning avg) Units: metric &#x3D; °C, us &#x3D; °F, uk &#x3D; °C, ca &#x3D; °C |  [optional] |
|**visibility** | **BigDecimal** | Visibility. (morning avg) Units: metric &#x3D; km, us &#x3D; mi, uk &#x3D; mi, ca &#x3D; km |  [optional] |
|**weather** | **String** | Morning day string identifier of the weather icon, e.g. &#x60;light_rain&#x60;. |  [optional] |
|**wind** | [**PointPointDailyMorningWindData**](PointPointDailyMorningWindData.md) |  |  |
|**windChill** | **BigDecimal** | Temperature 2 metres above ground. (morning avg) Units: metric &#x3D; °C, us &#x3D; °F, uk &#x3D; °C, ca &#x3D; °C |  [optional] |
