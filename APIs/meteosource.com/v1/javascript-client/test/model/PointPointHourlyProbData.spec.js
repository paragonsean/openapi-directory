...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.PointPointHourlyProbData();
  });
  ...
  describe('PointPointHourlyProbData', function() {
    it('should create an instance of PointPointHourlyProbData', function() {
      // uncomment below and update the code to test PointPointHourlyProbData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointHourlyProbData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.PointPointHourlyProbData);
    });
