...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.PointPointCurrentData();
  });
  ...
  describe('PointPointCurrentData', function() {
    it('should create an instance of PointPointCurrentData', function() {
      // uncomment below and update the code to test PointPointCurrentData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointCurrentData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.PointPointCurrentData);
    });
    ...
    it('should have the property iconNum (base name: "icon_num")', function() {
      // uncomment below and update the code to test the property iconNum
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointCurrentData();
      //expect(instance).to.be();
    });

    it('should have the property irradiance (base name: "irradiance")', function() {
      // uncomment below and update the code to test the property irradiance
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointCurrentData();
      //expect(instance).to.be();
    });
