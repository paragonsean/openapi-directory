...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.TimeMachinePointDailyStatsWindData();
  });
  ...
  describe('TimeMachinePointDailyStatsWindData', function() {
    it('should create an instance of TimeMachinePointDailyStatsWindData', function() {
      // uncomment below and update the code to test TimeMachinePointDailyStatsWindData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.TimeMachinePointDailyStatsWindData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.TimeMachinePointDailyStatsWindData);
    });
