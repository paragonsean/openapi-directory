...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new InteractiveDocumentationForYourPremiumPlan.ValidationError();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.ValidationError);
    });
