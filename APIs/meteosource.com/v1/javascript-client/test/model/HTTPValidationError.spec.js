...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new InteractiveDocumentationForYourPremiumPlan.HTTPValidationError();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.HTTPValidationError);
    });
