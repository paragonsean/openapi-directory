...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.PointPointData();
  });
  ...
  describe('PointPointData', function() {
    it('should create an instance of PointPointData', function() {
      // uncomment below and update the code to test PointPointData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.PointPointData);
    });
    ...
    it('should have the property minutely (base name: "minutely")', function() {
      // uncomment below and update the code to test the property minutely
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointData();
      //expect(instance).to.be();
    });
