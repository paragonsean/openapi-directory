...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.PointPointHourlyCloudCoverData();
  });
  ...
  describe('PointPointHourlyCloudCoverData', function() {
    it('should create an instance of PointPointHourlyCloudCoverData', function() {
      // uncomment below and update the code to test PointPointHourlyCloudCoverData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointHourlyCloudCoverData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.PointPointHourlyCloudCoverData);
    });
