...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.AirQualityPointData();
  });
  ...
  describe('AirQualityPointData', function() {
    it('should create an instance of AirQualityPointData', function() {
      // uncomment below and update the code to test AirQualityPointData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.AirQualityPointData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.AirQualityPointData);
    });
