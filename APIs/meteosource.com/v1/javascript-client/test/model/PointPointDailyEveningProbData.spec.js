...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.PointPointDailyEveningProbData();
  });
  ...
  describe('PointPointDailyEveningProbData', function() {
    it('should create an instance of PointPointDailyEveningProbData', function() {
      // uncomment below and update the code to test PointPointDailyEveningProbData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointDailyEveningProbData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.PointPointDailyEveningProbData);
    });
