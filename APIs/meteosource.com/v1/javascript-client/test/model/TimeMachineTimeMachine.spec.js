...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.TimeMachineTimeMachine();
  });
  ...
  describe('TimeMachineTimeMachine', function() {
    it('should create an instance of TimeMachineTimeMachine', function() {
      // uncomment below and update the code to test TimeMachineTimeMachine
      //var instance = new InteractiveDocumentationForYourPremiumPlan.TimeMachineTimeMachine();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.TimeMachineTimeMachine);
    });
