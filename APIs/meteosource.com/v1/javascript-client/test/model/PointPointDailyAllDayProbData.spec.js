...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.PointPointDailyAllDayProbData();
  });
  ...
  describe('PointPointDailyAllDayProbData', function() {
    it('should create an instance of PointPointDailyAllDayProbData', function() {
      // uncomment below and update the code to test PointPointDailyAllDayProbData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointDailyAllDayProbData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.PointPointDailyAllDayProbData);
    });
