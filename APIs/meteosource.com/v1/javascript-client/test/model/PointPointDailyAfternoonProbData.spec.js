...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.PointPointDailyAfternoonProbData();
  });
  ...
  describe('PointPointDailyAfternoonProbData', function() {
    it('should create an instance of PointPointDailyAfternoonProbData', function() {
      // uncomment below and update the code to test PointPointDailyAfternoonProbData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointDailyAfternoonProbData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.PointPointDailyAfternoonProbData);
    });
