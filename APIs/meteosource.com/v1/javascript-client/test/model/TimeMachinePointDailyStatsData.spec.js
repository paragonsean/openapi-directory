...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.TimeMachinePointDailyStatsData();
  });
  ...
  describe('TimeMachinePointDailyStatsData', function() {
    it('should create an instance of TimeMachinePointDailyStatsData', function() {
      // uncomment below and update the code to test TimeMachinePointDailyStatsData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.TimeMachinePointDailyStatsData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.TimeMachinePointDailyStatsData);
    });
