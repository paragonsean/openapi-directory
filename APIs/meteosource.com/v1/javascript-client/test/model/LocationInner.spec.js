...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.LocationInner();
  });
  ...
  describe('LocationInner', function() {
    it('should create an instance of LocationInner', function() {
      ...
      //var instance = new InteractiveDocumentationForYourPremiumPlan.LocationInner();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.LocationInner);
    });
