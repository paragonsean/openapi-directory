...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InteractiveDocumentationForYourPremiumPlan.PointPointDailyStatsData();
  });
  ...
  describe('PointPointDailyStatsData', function() {
    it('should create an instance of PointPointDailyStatsData', function() {
      // uncomment below and update the code to test PointPointDailyStatsData
      //var instance = new InteractiveDocumentationForYourPremiumPlan.PointPointDailyStatsData();
      //expect(instance).to.be.a(InteractiveDocumentationForYourPremiumPlan.PointPointDailyStatsData);
    });
