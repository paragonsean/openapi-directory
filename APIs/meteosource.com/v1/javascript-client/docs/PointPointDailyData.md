# InteractiveDocumentationForYourPremiumPlan.PointPointDailyData
...
**allDay** | [**PointPointDailyAllDayData**](PointPointDailyAllDayData.md) |  | 
**astro** | [**PointPointDailyAstroData**](PointPointDailyAstroData.md) |  | 
**day** | **File** | Datetime in YYYY-MM-DDTHH:MM:SS format. | [optional] 
...
**predictability** | **Number** | Weather predictability. Values from 1 (very high predictability) to 5 (very low predictability). Unit: 1-5 | [optional] 
...
**weather** | **String** | All day string identifier of the weather icon, e.g. &#x60;light_rain&#x60;. | [optional] 
