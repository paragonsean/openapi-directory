...
/*
 * OAIPoint_PointDailySunData.h
 *
 * 
 */

#ifndef OAIPoint_PointDailySunData_H
#define OAIPoint_PointDailySunData_H
...
class OAIPoint_PointDailySunData : public OAIObject {
public:
    OAIPoint_PointDailySunData();
    OAIPoint_PointDailySunData(QString json);
    ~OAIPoint_PointDailySunData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPoint_PointDailySunData)

#endif // OAIPoint_PointDailySunData_H
