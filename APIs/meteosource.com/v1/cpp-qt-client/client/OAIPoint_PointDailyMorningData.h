...
/*
 * OAIPoint_PointDailyMorningData.h
 *
 * 
 */

#ifndef OAIPoint_PointDailyMorningData_H
#define OAIPoint_PointDailyMorningData_H

#include <QJsonObject>

#include "OAIPoint_PointDailyMorningCloudCoverData.h"
#include "OAIPoint_PointDailyMorningPrecipitationData.h"
#include "OAIPoint_PointDailyMorningProbData.h"
...
namespace OpenAPI {
class OAIPoint_PointDailyMorningCloudCoverData;
class OAIPoint_PointDailyMorningPrecipitationData;
class OAIPoint_PointDailyMorningProbData;
class OAIPoint_PointDailyMorningWindData;

class OAIPoint_PointDailyMorningData : public OAIObject {
public:
    OAIPoint_PointDailyMorningData();
    OAIPoint_PointDailyMorningData(QString json);
    ~OAIPoint_PointDailyMorningData() override;
    ...
    OAIPoint_PointDailyMorningCloudCoverData getCloudCover() const;
    void setCloudCover(const OAIPoint_PointDailyMorningCloudCoverData &cloud_cover);
    ...
    OAIPoint_PointDailyMorningPrecipitationData getPrecipitation() const;
    void setPrecipitation(const OAIPoint_PointDailyMorningPrecipitationData &precipitation);
    ...
    OAIPoint_PointDailyMorningProbData getProbability() const;
    void setProbability(const OAIPoint_PointDailyMorningProbData &probability);
    ...
    OAIPoint_PointDailyMorningWindData getWind() const;
    void setWind(const OAIPoint_PointDailyMorningWindData &wind);
...
private:
    ...
    OAIPoint_PointDailyMorningCloudCoverData m_cloud_cover;
    ...
    OAIPoint_PointDailyMorningPrecipitationData m_precipitation;
    ...
    OAIPoint_PointDailyMorningProbData m_probability;
    ...
    OAIPoint_PointDailyMorningWindData m_wind;
    bool m_wind_isSet;
    bool m_wind_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPoint_PointDailyMorningData)

#endif // OAIPoint_PointDailyMorningData_H
