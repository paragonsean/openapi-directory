...
/*
 * OAIPoint_PointDailyStatsTemperatureData.h
 *
 * 
 */

#ifndef OAIPoint_PointDailyStatsTemperatureData_H
#define OAIPoint_PointDailyStatsTemperatureData_H
...
class OAIPoint_PointDailyStatsTemperatureData : public OAIObject {
public:
    OAIPoint_PointDailyStatsTemperatureData();
    OAIPoint_PointDailyStatsTemperatureData(QString json);
    ~OAIPoint_PointDailyStatsTemperatureData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPoint_PointDailyStatsTemperatureData)

#endif // OAIPoint_PointDailyStatsTemperatureData_H
