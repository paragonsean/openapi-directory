...
OAIPoint_PointDailyMorningData::OAIPoint_PointDailyMorningData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPoint_PointDailyMorningData::OAIPoint_PointDailyMorningData() {
    this->initializeModel();
}

OAIPoint_PointDailyMorningData::~OAIPoint_PointDailyMorningData() {}

void OAIPoint_PointDailyMorningData::initializeModel() {
...
void OAIPoint_PointDailyMorningData::fromJson(QString jsonString) {
...
void OAIPoint_PointDailyMorningData::fromJsonObject(QJsonObject json) {
...
QString OAIPoint_PointDailyMorningData::asJson() const {
...
QJsonObject OAIPoint_PointDailyMorningData::asJsonObject() const {
    QJsonObject obj;
...
OAIPoint_PointDailyMorningCloudCoverData OAIPoint_PointDailyMorningData::getCloudCover() const {
    return m_cloud_cover;
}
void OAIPoint_PointDailyMorningData::setCloudCover(const OAIPoint_PointDailyMorningCloudCoverData &cloud_cover) {
    m_cloud_cover = cloud_cover;
    m_cloud_cover_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_cloud_cover_Set() const{
    return m_cloud_cover_isSet;
}

bool OAIPoint_PointDailyMorningData::is_cloud_cover_Valid() const{
    return m_cloud_cover_isValid;
}

double OAIPoint_PointDailyMorningData::getDewPoint() const {
    return m_dew_point;
}
void OAIPoint_PointDailyMorningData::setDewPoint(const double &dew_point) {
    m_dew_point = dew_point;
    m_dew_point_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_dew_point_Set() const{
    return m_dew_point_isSet;
}

bool OAIPoint_PointDailyMorningData::is_dew_point_Valid() const{
    return m_dew_point_isValid;
}

double OAIPoint_PointDailyMorningData::getFeelsLike() const {
    return m_feels_like;
}
void OAIPoint_PointDailyMorningData::setFeelsLike(const double &feels_like) {
    m_feels_like = feels_like;
    m_feels_like_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_feels_like_Set() const{
    return m_feels_like_isSet;
}

bool OAIPoint_PointDailyMorningData::is_feels_like_Valid() const{
    return m_feels_like_isValid;
}

qint32 OAIPoint_PointDailyMorningData::getHumidity() const {
    return m_humidity;
}
void OAIPoint_PointDailyMorningData::setHumidity(const qint32 &humidity) {
    m_humidity = humidity;
    m_humidity_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_humidity_Set() const{
    return m_humidity_isSet;
}

bool OAIPoint_PointDailyMorningData::is_humidity_Valid() const{
    return m_humidity_isValid;
}

qint32 OAIPoint_PointDailyMorningData::getIcon() const {
    return m_icon;
}
void OAIPoint_PointDailyMorningData::setIcon(const qint32 &icon) {
    m_icon = icon;
    m_icon_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_icon_Set() const{
    return m_icon_isSet;
}

bool OAIPoint_PointDailyMorningData::is_icon_Valid() const{
    return m_icon_isValid;
}

double OAIPoint_PointDailyMorningData::getOzone() const {
    return m_ozone;
}
void OAIPoint_PointDailyMorningData::setOzone(const double &ozone) {
    m_ozone = ozone;
    m_ozone_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_ozone_Set() const{
    return m_ozone_isSet;
}

bool OAIPoint_PointDailyMorningData::is_ozone_Valid() const{
    return m_ozone_isValid;
}

OAIPoint_PointDailyMorningPrecipitationData OAIPoint_PointDailyMorningData::getPrecipitation() const {
    return m_precipitation;
}
void OAIPoint_PointDailyMorningData::setPrecipitation(const OAIPoint_PointDailyMorningPrecipitationData &precipitation) {
    m_precipitation = precipitation;
    m_precipitation_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_precipitation_Set() const{
    return m_precipitation_isSet;
}

bool OAIPoint_PointDailyMorningData::is_precipitation_Valid() const{
    return m_precipitation_isValid;
}

double OAIPoint_PointDailyMorningData::getPressure() const {
    return m_pressure;
}
void OAIPoint_PointDailyMorningData::setPressure(const double &pressure) {
    m_pressure = pressure;
    m_pressure_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_pressure_Set() const{
    return m_pressure_isSet;
}

bool OAIPoint_PointDailyMorningData::is_pressure_Valid() const{
    return m_pressure_isValid;
}

OAIPoint_PointDailyMorningProbData OAIPoint_PointDailyMorningData::getProbability() const {
    return m_probability;
}
void OAIPoint_PointDailyMorningData::setProbability(const OAIPoint_PointDailyMorningProbData &probability) {
    m_probability = probability;
    m_probability_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_probability_Set() const{
    return m_probability_isSet;
}

bool OAIPoint_PointDailyMorningData::is_probability_Valid() const{
    return m_probability_isValid;
}

double OAIPoint_PointDailyMorningData::getSnowDepth() const {
    return m_snow_depth;
}
void OAIPoint_PointDailyMorningData::setSnowDepth(const double &snow_depth) {
    m_snow_depth = snow_depth;
    m_snow_depth_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_snow_depth_Set() const{
    return m_snow_depth_isSet;
}

bool OAIPoint_PointDailyMorningData::is_snow_depth_Valid() const{
    return m_snow_depth_isValid;
}

double OAIPoint_PointDailyMorningData::getSoilTemperature() const {
    return m_soil_temperature;
}
void OAIPoint_PointDailyMorningData::setSoilTemperature(const double &soil_temperature) {
    m_soil_temperature = soil_temperature;
    m_soil_temperature_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_soil_temperature_Set() const{
    return m_soil_temperature_isSet;
}

bool OAIPoint_PointDailyMorningData::is_soil_temperature_Valid() const{
    return m_soil_temperature_isValid;
}

double OAIPoint_PointDailyMorningData::getSurfaceTemperature() const {
    return m_surface_temperature;
}
void OAIPoint_PointDailyMorningData::setSurfaceTemperature(const double &surface_temperature) {
    m_surface_temperature = surface_temperature;
    m_surface_temperature_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_surface_temperature_Set() const{
    return m_surface_temperature_isSet;
}

bool OAIPoint_PointDailyMorningData::is_surface_temperature_Valid() const{
    return m_surface_temperature_isValid;
}

double OAIPoint_PointDailyMorningData::getTemperature() const {
    return m_temperature;
}
void OAIPoint_PointDailyMorningData::setTemperature(const double &temperature) {
    m_temperature = temperature;
    m_temperature_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_temperature_Set() const{
    return m_temperature_isSet;
}

bool OAIPoint_PointDailyMorningData::is_temperature_Valid() const{
    return m_temperature_isValid;
}

double OAIPoint_PointDailyMorningData::getVisibility() const {
    return m_visibility;
}
void OAIPoint_PointDailyMorningData::setVisibility(const double &visibility) {
    m_visibility = visibility;
    m_visibility_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_visibility_Set() const{
    return m_visibility_isSet;
}

bool OAIPoint_PointDailyMorningData::is_visibility_Valid() const{
    return m_visibility_isValid;
}

QString OAIPoint_PointDailyMorningData::getWeather() const {
    return m_weather;
}
void OAIPoint_PointDailyMorningData::setWeather(const QString &weather) {
    m_weather = weather;
    m_weather_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_weather_Set() const{
    return m_weather_isSet;
}

bool OAIPoint_PointDailyMorningData::is_weather_Valid() const{
    return m_weather_isValid;
}

OAIPoint_PointDailyMorningWindData OAIPoint_PointDailyMorningData::getWind() const {
    return m_wind;
}
void OAIPoint_PointDailyMorningData::setWind(const OAIPoint_PointDailyMorningWindData &wind) {
    m_wind = wind;
    m_wind_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_wind_Set() const{
    return m_wind_isSet;
}

bool OAIPoint_PointDailyMorningData::is_wind_Valid() const{
    return m_wind_isValid;
}

double OAIPoint_PointDailyMorningData::getWindChill() const {
    return m_wind_chill;
}
void OAIPoint_PointDailyMorningData::setWindChill(const double &wind_chill) {
    m_wind_chill = wind_chill;
    m_wind_chill_isSet = true;
}

bool OAIPoint_PointDailyMorningData::is_wind_chill_Set() const{
    return m_wind_chill_isSet;
}

bool OAIPoint_PointDailyMorningData::is_wind_chill_Valid() const{
    return m_wind_chill_isValid;
}

bool OAIPoint_PointDailyMorningData::isSet() const {
...
bool OAIPoint_PointDailyMorningData::isValid() const {
