...
public class BetaAppLocalizationAttributes {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BetaAppLocalizationAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BetaAppLocalizationAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BetaAppLocalizationAttributes is not found in the empty JSON string", BetaAppLocalizationAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BetaAppLocalizationAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BetaAppLocalizationAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BetaAppLocalizationAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BetaAppLocalizationAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BetaAppLocalizationAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BetaAppLocalizationAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<BetaAppLocalizationAttributes>() {
           @Override
           public void write(JsonWriter out, BetaAppLocalizationAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BetaAppLocalizationAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BetaAppLocalizationAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BetaAppLocalizationAttributes
   * @throws IOException if the JSON string is invalid with respect to BetaAppLocalizationAttributes
   */
  public static BetaAppLocalizationAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BetaAppLocalizationAttributes.class);
  }

  /**
   * Convert an instance of BetaAppLocalizationAttributes to an JSON string
   *
   * @return JSON string
   */
