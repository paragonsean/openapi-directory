...
public class BetaGroupCreateRequestDataAttributes {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BetaGroupCreateRequestDataAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BetaGroupCreateRequestDataAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BetaGroupCreateRequestDataAttributes is not found in the empty JSON string", BetaGroupCreateRequestDataAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BetaGroupCreateRequestDataAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BetaGroupCreateRequestDataAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BetaGroupCreateRequestDataAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BetaGroupCreateRequestDataAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BetaGroupCreateRequestDataAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BetaGroupCreateRequestDataAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BetaGroupCreateRequestDataAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<BetaGroupCreateRequestDataAttributes>() {
           @Override
           public void write(JsonWriter out, BetaGroupCreateRequestDataAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BetaGroupCreateRequestDataAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BetaGroupCreateRequestDataAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BetaGroupCreateRequestDataAttributes
   * @throws IOException if the JSON string is invalid with respect to BetaGroupCreateRequestDataAttributes
   */
  public static BetaGroupCreateRequestDataAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BetaGroupCreateRequestDataAttributes.class);
  }

  /**
   * Convert an instance of BetaGroupCreateRequestDataAttributes to an JSON string
   *
   * @return JSON string
   */
