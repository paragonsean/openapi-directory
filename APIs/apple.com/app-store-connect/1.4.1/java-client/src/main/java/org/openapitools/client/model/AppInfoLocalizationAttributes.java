...
public class AppInfoLocalizationAttributes {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppInfoLocalizationAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppInfoLocalizationAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppInfoLocalizationAttributes is not found in the empty JSON string", AppInfoLocalizationAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppInfoLocalizationAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppInfoLocalizationAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppInfoLocalizationAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppInfoLocalizationAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppInfoLocalizationAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppInfoLocalizationAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<AppInfoLocalizationAttributes>() {
           @Override
           public void write(JsonWriter out, AppInfoLocalizationAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppInfoLocalizationAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppInfoLocalizationAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppInfoLocalizationAttributes
   * @throws IOException if the JSON string is invalid with respect to AppInfoLocalizationAttributes
   */
  public static AppInfoLocalizationAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppInfoLocalizationAttributes.class);
  }

  /**
   * Convert an instance of AppInfoLocalizationAttributes to an JSON string
   *
   * @return JSON string
   */
