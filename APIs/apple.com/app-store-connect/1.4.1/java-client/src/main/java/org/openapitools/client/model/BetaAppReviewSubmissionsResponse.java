...
public class BetaAppReviewSubmissionsResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BetaAppReviewSubmissionsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BetaAppReviewSubmissionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BetaAppReviewSubmissionsResponse is not found in the empty JSON string", BetaAppReviewSubmissionsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BetaAppReviewSubmissionsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BetaAppReviewSubmissionsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BetaAppReviewSubmissionsResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        BetaAppReviewSubmission.validateJsonElement(jsonArraydata.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BetaAppReviewSubmissionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BetaAppReviewSubmissionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BetaAppReviewSubmissionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BetaAppReviewSubmissionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BetaAppReviewSubmissionsResponse>() {
           @Override
           public void write(JsonWriter out, BetaAppReviewSubmissionsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BetaAppReviewSubmissionsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BetaAppReviewSubmissionsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BetaAppReviewSubmissionsResponse
   * @throws IOException if the JSON string is invalid with respect to BetaAppReviewSubmissionsResponse
   */
  public static BetaAppReviewSubmissionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BetaAppReviewSubmissionsResponse.class);
  }

  /**
   * Convert an instance of BetaAppReviewSubmissionsResponse to an JSON string
   *
   * @return JSON string
   */
