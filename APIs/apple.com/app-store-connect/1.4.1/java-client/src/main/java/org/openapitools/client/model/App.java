...
public class App {
  ...
  public boolean equals(Object o) {
    ...
    App app = (App) o;
    return Objects.equals(this.attributes, app.attributes) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        AppAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        AppRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
