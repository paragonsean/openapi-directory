...
public class BetaAppReviewSubmissionResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BetaAppReviewSubmissionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BetaAppReviewSubmissionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BetaAppReviewSubmissionResponse is not found in the empty JSON string", BetaAppReviewSubmissionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BetaAppReviewSubmissionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BetaAppReviewSubmissionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BetaAppReviewSubmissionResponse.openapiRequiredFields) {
      ...
      BetaAppReviewSubmission.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BetaAppReviewSubmissionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BetaAppReviewSubmissionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BetaAppReviewSubmissionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BetaAppReviewSubmissionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BetaAppReviewSubmissionResponse>() {
           @Override
           public void write(JsonWriter out, BetaAppReviewSubmissionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BetaAppReviewSubmissionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BetaAppReviewSubmissionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BetaAppReviewSubmissionResponse
   * @throws IOException if the JSON string is invalid with respect to BetaAppReviewSubmissionResponse
   */
  public static BetaAppReviewSubmissionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BetaAppReviewSubmissionResponse.class);
  }

  /**
   * Convert an instance of BetaAppReviewSubmissionResponse to an JSON string
   *
   * @return JSON string
   */
