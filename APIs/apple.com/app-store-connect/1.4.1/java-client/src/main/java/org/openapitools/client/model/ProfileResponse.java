...
import org.openapitools.client.model.ProfileResponseIncludedInner;
...
public class ProfileResponse {
  ...
  private List<ProfileResponseIncludedInner> included = new ArrayList<>();
  ...
  public ProfileResponse included(List<ProfileResponseIncludedInner> included) {
    this.included = included;
    return this;
  }

  public ProfileResponse addIncludedItem(ProfileResponseIncludedInner includedItem) {
  ...
  public List<ProfileResponseIncludedInner> getIncluded() {
    return included;
  }

  public void setIncluded(List<ProfileResponseIncludedInner> included) {
    this.included = included;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, profileResponse.data) &&
        Objects.equals(this.included, profileResponse.included) &&
        Objects.equals(this.links, profileResponse.links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ProfileResponse.openapiRequiredFields) {
      ...
      Profile.validateJsonElement(jsonObj.get("data"));
      if (jsonObj.get("included") != null && !jsonObj.get("included").isJsonNull()) {
        ...
        if (jsonArrayincluded != null) {
          ...
          for (int i = 0; i < jsonArrayincluded.size(); i++) {
            ProfileResponseIncludedInner.validateJsonElement(jsonArrayincluded.get(i));
          };
        }
      }
