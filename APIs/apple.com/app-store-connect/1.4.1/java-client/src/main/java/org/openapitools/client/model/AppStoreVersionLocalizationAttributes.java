...
public class AppStoreVersionLocalizationAttributes {
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppStoreVersionLocalizationAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppStoreVersionLocalizationAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppStoreVersionLocalizationAttributes is not found in the empty JSON string", AppStoreVersionLocalizationAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppStoreVersionLocalizationAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppStoreVersionLocalizationAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppStoreVersionLocalizationAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppStoreVersionLocalizationAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppStoreVersionLocalizationAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppStoreVersionLocalizationAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<AppStoreVersionLocalizationAttributes>() {
           @Override
           public void write(JsonWriter out, AppStoreVersionLocalizationAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppStoreVersionLocalizationAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppStoreVersionLocalizationAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppStoreVersionLocalizationAttributes
   * @throws IOException if the JSON string is invalid with respect to AppStoreVersionLocalizationAttributes
   */
  public static AppStoreVersionLocalizationAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppStoreVersionLocalizationAttributes.class);
  }

  /**
   * Convert an instance of AppStoreVersionLocalizationAttributes to an JSON string
   *
   * @return JSON string
   */
