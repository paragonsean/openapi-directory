...
public class BetaBuildLocalizationsResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BetaBuildLocalizationsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BetaBuildLocalizationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BetaBuildLocalizationsResponse is not found in the empty JSON string", BetaBuildLocalizationsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BetaBuildLocalizationsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BetaBuildLocalizationsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BetaBuildLocalizationsResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        BetaBuildLocalization.validateJsonElement(jsonArraydata.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BetaBuildLocalizationsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BetaBuildLocalizationsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BetaBuildLocalizationsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BetaBuildLocalizationsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BetaBuildLocalizationsResponse>() {
           @Override
           public void write(JsonWriter out, BetaBuildLocalizationsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BetaBuildLocalizationsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BetaBuildLocalizationsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BetaBuildLocalizationsResponse
   * @throws IOException if the JSON string is invalid with respect to BetaBuildLocalizationsResponse
   */
  public static BetaBuildLocalizationsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BetaBuildLocalizationsResponse.class);
  }

  /**
   * Convert an instance of BetaBuildLocalizationsResponse to an JSON string
   *
   * @return JSON string
   */
