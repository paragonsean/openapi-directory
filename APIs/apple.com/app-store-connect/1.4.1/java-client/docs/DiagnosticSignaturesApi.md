...
> DiagnosticLogsResponse diagnosticSignaturesLogsGetToManyRelated(id, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DiagnosticLogsResponse result = apiInstance.diagnosticSignaturesLogsGetToManyRelated(id, limit);
