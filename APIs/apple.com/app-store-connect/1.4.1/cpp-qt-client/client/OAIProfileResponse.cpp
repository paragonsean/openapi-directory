...
OAIProfile OAIProfileResponse::getData() const {
    return m_data;
}
void OAIProfileResponse::setData(const OAIProfile &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIProfileResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIProfileResponse::is_data_Valid() const{
    return m_data_isValid;
}

QList<OAIProfileResponse_included_inner> OAIProfileResponse::getIncluded() const {
    return m_included;
}
void OAIProfileResponse::setIncluded(const QList<OAIProfileResponse_included_inner> &included) {
    m_included = included;
    m_included_isSet = true;
}

bool OAIProfileResponse::is_included_Set() const{
    return m_included_isSet;
}

bool OAIProfileResponse::is_included_Valid() const{
    return m_included_isValid;
}

OAIDocumentLinks OAIProfileResponse::getLinks() const {
    return m_links;
}
void OAIProfileResponse::setLinks(const OAIDocumentLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIProfileResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAIProfileResponse::is_links_Valid() const{
