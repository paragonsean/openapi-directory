...
OAIUser_attributes OAIUser::getAttributes() const {
    return m_attributes;
}
void OAIUser::setAttributes(const OAIUser_attributes &attributes) {
...
OAIResourceLinks OAIUser::getLinks() const {
    return m_links;
}
void OAIUser::setLinks(const OAIResourceLinks &links) {
    m_links = links;
    m_links_isSet = true;
}
