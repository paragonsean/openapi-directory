...
namespace OpenAPI {
class OAIUser_attributes;
class OAIResourceLinks;
class OAIUser_relationships;
...
public:
    ...
    OAIUser_attributes getAttributes() const;
    void setAttributes(const OAIUser_attributes &attributes);
    ...
    OAIUser_relationships getRelationships() const;
    void setRelationships(const OAIUser_relationships &relationships);
...
private:
    ...
    OAIUser_attributes m_attributes;
    ...
    OAIUser_relationships m_relationships;
