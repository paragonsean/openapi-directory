...
OAIProfile_attributes OAIProfile::getAttributes() const {
    return m_attributes;
}
void OAIProfile::setAttributes(const OAIProfile_attributes &attributes) {
...
OAIResourceLinks OAIProfile::getLinks() const {
    return m_links;
}
void OAIProfile::setLinks(const OAIResourceLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIProfile::is_links_Set() const{
    return m_links_isSet;
}

bool OAIProfile::is_links_Valid() const{
    return m_links_isValid;
}

OAIProfile_relationships OAIProfile::getRelationships() const {
    return m_relationships;
}
void OAIProfile::setRelationships(const OAIProfile_relationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIProfile::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIProfile::is_relationships_Valid() const{
