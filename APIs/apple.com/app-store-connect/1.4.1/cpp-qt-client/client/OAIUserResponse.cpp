...
QList<OAIApp> OAIUserResponse::getIncluded() const {
    return m_included;
}
void OAIUserResponse::setIncluded(const QList<OAIApp> &included) {
    m_included = included;
...
OAIDocumentLinks OAIUserResponse::getLinks() const {
    return m_links;
}
void OAIUserResponse::setLinks(const OAIDocumentLinks &links) {
    m_links = links;
    m_links_isSet = true;
}
