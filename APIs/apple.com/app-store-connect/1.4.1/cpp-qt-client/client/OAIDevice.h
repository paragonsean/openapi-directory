...
public:
    ...
    OAIDevice_attributes getAttributes() const;
    void setAttributes(const OAIDevice_attributes &attributes);
...
private:
    ...
    OAIDevice_attributes m_attributes;
