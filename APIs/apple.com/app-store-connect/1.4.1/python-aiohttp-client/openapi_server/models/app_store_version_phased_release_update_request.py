...
class AppStoreVersionPhasedReleaseUpdateRequest(Model):
    ...
    def __init__(self, data: AppStoreVersionPhasedReleaseUpdateRequestData=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AppStoreVersionPhasedReleaseUpdateRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AppStoreVersionPhasedReleaseUpdateRequest of this AppStoreVersionPhasedReleaseUpdateRequest.
        """
