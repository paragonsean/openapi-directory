...
class IdfaDeclarationUpdateRequestData(Model):
    ...
    def __init__(self, attributes: IdfaDeclarationAttributes=None, id: str=None, type: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'IdfaDeclarationUpdateRequestData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The IdfaDeclarationUpdateRequest_data of this IdfaDeclarationUpdateRequestData.
        """
