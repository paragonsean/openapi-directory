...
class AppAttributes(Model):
    ...
    def __init__(self, available_in_new_territories: bool=None, bundle_id: str=None, content_rights_declaration: str=None, is_or_ever_was_made_for_kids: bool=None, name: str=None, primary_locale: str=None, sku: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AppAttributes':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The App_attributes of this AppAttributes.
        """
    ...
    @property
    def is_or_ever_was_made_for_kids(self):
    ...
    def is_or_ever_was_made_for_kids(self, is_or_ever_was_made_for_kids):
