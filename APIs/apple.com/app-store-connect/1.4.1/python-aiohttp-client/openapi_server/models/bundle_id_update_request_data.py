...
class BundleIdUpdateRequestData(Model):
    ...
    def __init__(self, attributes: BundleIdUpdateRequestDataAttributes=None, id: str=None, type: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BundleIdUpdateRequestData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BundleIdUpdateRequest_data of this BundleIdUpdateRequestData.
        """
