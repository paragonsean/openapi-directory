...
class AppStoreReviewDetailRelationshipsAppStoreReviewAttachments(Model):
    ...
    def __init__(self, data: List[AppStoreReviewDetailRelationshipsAppStoreReviewAttachmentsDataInner]=None, links: AppRelationshipsAppInfosLinks=None, meta: PagingInformation=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AppStoreReviewDetailRelationshipsAppStoreReviewAttachments':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AppStoreReviewDetail_relationships_appStoreReviewAttachments of this AppStoreReviewDetailRelationshipsAppStoreReviewAttachments.
        """
