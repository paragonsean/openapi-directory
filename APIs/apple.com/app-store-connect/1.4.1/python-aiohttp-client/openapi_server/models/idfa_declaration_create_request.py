...
class IdfaDeclarationCreateRequest(Model):
    ...
    def __init__(self, data: IdfaDeclarationCreateRequestData=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'IdfaDeclarationCreateRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The IdfaDeclarationCreateRequest of this IdfaDeclarationCreateRequest.
        """
