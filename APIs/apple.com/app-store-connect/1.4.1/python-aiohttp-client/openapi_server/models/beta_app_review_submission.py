...
class BetaAppReviewSubmission(Model):
    ...
    def __init__(self, attributes: BetaAppReviewSubmissionAttributes=None, id: str=None, links: ResourceLinks=None, relationships: BetaAppReviewSubmissionRelationships=None, type: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BetaAppReviewSubmission':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BetaAppReviewSubmission of this BetaAppReviewSubmission.
        """
