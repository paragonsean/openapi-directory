...
class EndUserLicenseAgreementResponse(Model):
    ...
    def __init__(self, data: EndUserLicenseAgreement=None, included: List[Territory]=None, links: DocumentLinks=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EndUserLicenseAgreementResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EndUserLicenseAgreementResponse of this EndUserLicenseAgreementResponse.
        """
