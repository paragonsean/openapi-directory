...
class DeviceUpdateRequestData(Model):
    ...
    def __init__(self, attributes: DeviceUpdateRequestDataAttributes=None, id: str=None, type: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeviceUpdateRequestData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeviceUpdateRequest_data of this DeviceUpdateRequestData.
        """
