...
class BuildBetaDetailUpdateRequestData(Model):
    ...
    def __init__(self, attributes: BuildBetaDetailUpdateRequestDataAttributes=None, id: str=None, type: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BuildBetaDetailUpdateRequestData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BuildBetaDetailUpdateRequest_data of this BuildBetaDetailUpdateRequestData.
        """
