...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.BetaGroupCreateRequestDataRelationships();
  });
  ...
  describe('BetaGroupCreateRequestDataRelationships', function() {
    it('should create an instance of BetaGroupCreateRequestDataRelationships', function() {
      // uncomment below and update the code to test BetaGroupCreateRequestDataRelationships
      //var instance = new AppStoreConnectApi.BetaGroupCreateRequestDataRelationships();
      //expect(instance).to.be.a(AppStoreConnectApi.BetaGroupCreateRequestDataRelationships);
    });
