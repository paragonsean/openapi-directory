...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.ProfileRelationships();
  });
  ...
  describe('ProfileRelationships', function() {
    it('should create an instance of ProfileRelationships', function() {
      // uncomment below and update the code to test ProfileRelationships
      //var instance = new AppStoreConnectApi.ProfileRelationships();
      //expect(instance).to.be.a(AppStoreConnectApi.ProfileRelationships);
    });
