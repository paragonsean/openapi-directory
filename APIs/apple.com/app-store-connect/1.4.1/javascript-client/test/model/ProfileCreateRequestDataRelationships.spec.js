...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.ProfileCreateRequestDataRelationships();
  });
  ...
  describe('ProfileCreateRequestDataRelationships', function() {
    it('should create an instance of ProfileCreateRequestDataRelationships', function() {
      // uncomment below and update the code to test ProfileCreateRequestDataRelationships
      //var instance = new AppStoreConnectApi.ProfileCreateRequestDataRelationships();
      //expect(instance).to.be.a(AppStoreConnectApi.ProfileCreateRequestDataRelationships);
    });
