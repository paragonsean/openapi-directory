...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.DeviceResponse();
  });
  ...
  describe('DeviceResponse', function() {
    it('should create an instance of DeviceResponse', function() {
      ...
      //var instance = new AppStoreConnectApi.DeviceResponse();
      //expect(instance).to.be.a(AppStoreConnectApi.DeviceResponse);
    });
