...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.CertificateAttributes();
  });
  ...
  describe('CertificateAttributes', function() {
    it('should create an instance of CertificateAttributes', function() {
      ...
      //var instance = new AppStoreConnectApi.CertificateAttributes();
      //expect(instance).to.be.a(AppStoreConnectApi.CertificateAttributes);
    });

    it('should have the property certificateContent (base name: "certificateContent")', function() {
      // uncomment below and update the code to test the property certificateContent
      //var instance = new AppStoreConnectApi.CertificateAttributes();
