...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new AppStoreConnectApi.ErrorResponse();
      //expect(instance).to.be.a(AppStoreConnectApi.ErrorResponse);
    });
