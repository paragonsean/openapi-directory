...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.BetaGroupRelationships();
  });
  ...
  describe('BetaGroupRelationships', function() {
    it('should create an instance of BetaGroupRelationships', function() {
      // uncomment below and update the code to test BetaGroupRelationships
      //var instance = new AppStoreConnectApi.BetaGroupRelationships();
      //expect(instance).to.be.a(AppStoreConnectApi.BetaGroupRelationships);
    });
