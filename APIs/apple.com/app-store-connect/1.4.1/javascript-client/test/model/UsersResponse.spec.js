...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.UsersResponse();
  });
  ...
  describe('UsersResponse', function() {
    it('should create an instance of UsersResponse', function() {
      ...
      //var instance = new AppStoreConnectApi.UsersResponse();
      //expect(instance).to.be.a(AppStoreConnectApi.UsersResponse);
    });
