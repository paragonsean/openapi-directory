...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.UserInvitation();
  });
  ...
  describe('UserInvitation', function() {
    it('should create an instance of UserInvitation', function() {
      ...
      //var instance = new AppStoreConnectApi.UserInvitation();
      //expect(instance).to.be.a(AppStoreConnectApi.UserInvitation);
    });
