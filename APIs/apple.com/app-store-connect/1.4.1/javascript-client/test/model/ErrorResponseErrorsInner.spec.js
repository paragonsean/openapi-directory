...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppStoreConnectApi.ErrorResponseErrorsInner();
  });
  ...
  describe('ErrorResponseErrorsInner', function() {
    it('should create an instance of ErrorResponseErrorsInner', function() {
      ...
      //var instance = new AppStoreConnectApi.ErrorResponseErrorsInner();
      //expect(instance).to.be.a(AppStoreConnectApi.ErrorResponseErrorsInner);
    });
