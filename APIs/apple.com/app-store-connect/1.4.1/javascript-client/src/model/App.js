...
class App {
     ...
     * @param type {module:model/App.TypeEnum} 
     */
    constructor(id, links, type) { 
        
        App.initialize(this, id, links, type);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = AppAttributes.constructFromObject(data['attributes']);
            }
            ...
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = AppRelationships.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          AppAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          AppRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
App.RequiredProperties = ["id", "links", "type"];
 ...
 */
App.prototype['links'] = undefined;

/**
 * @member {module:model/AppRelationships} relationships
 */
App.prototype['relationships'] = undefined;
