...
class Profile {
     ...
     * @param type {module:model/Profile.TypeEnum} 
     */
    constructor(id, links, type) { 
        
        Profile.initialize(this, id, links, type);
    }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          ProfileAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          ProfileRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
Profile.RequiredProperties = ["id", "links", "type"];
 ...
 */
Profile.prototype['links'] = undefined;

/**
 * @member {module:model/ProfileRelationships} relationships
 */
Profile.prototype['relationships'] = undefined;
