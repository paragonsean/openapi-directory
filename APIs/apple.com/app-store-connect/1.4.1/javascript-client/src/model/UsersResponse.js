...
class UsersResponse {
    ...
    constructor(data, links) { 
        ...
        UsersResponse.initialize(this, data, links);
    }
...
UsersResponse.RequiredProperties = ["data", "links"];

/**
 * @member {Array.<module:model/User>} data
 */
UsersResponse.prototype['data'] = undefined;

/**
 * @member {Array.<module:model/App>} included
 */
UsersResponse.prototype['included'] = undefined;

/**
 * @member {module:model/PagedDocumentLinks} links
 */
UsersResponse.prototype['links'] = undefined;

/**
 * @member {module:model/PagingInformation} meta
 */
UsersResponse.prototype['meta'] = undefined;
