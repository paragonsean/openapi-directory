...
class Certificate {
     ...
     * @param type {module:model/Certificate.TypeEnum} 
     */
    constructor(id, links, type) { 
        
        Certificate.initialize(this, id, links, type);
    }
...
Certificate.RequiredProperties = ["id", "links", "type"];

/**
 * @member {module:model/CertificateAttributes} attributes
 */
Certificate.prototype['attributes'] = undefined;
 ...
 */
Certificate.prototype['links'] = undefined;
