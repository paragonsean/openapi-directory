...
/**
 * The PlaybackRepeatModeResolutionResult model module.
 * @module model/PlaybackRepeatModeResolutionResult
 * @version 1.0.2
 */
class PlaybackRepeatModeResolutionResult {
    /**
     * Constructs a new <code>PlaybackRepeatModeResolutionResult</code>.
     * @alias module:model/PlaybackRepeatModeResolutionResult
    ...
    constructor() { 
        ...
        PlaybackRepeatModeResolutionResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PlaybackRepeatModeResolutionResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlaybackRepeatModeResolutionResult} obj Optional instance to populate.
     * @return {module:model/PlaybackRepeatModeResolutionResult} The populated <code>PlaybackRepeatModeResolutionResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlaybackRepeatModeResolutionResult();
    ...
    /**
     * Validates the JSON data with respect to <code>PlaybackRepeatModeResolutionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlaybackRepeatModeResolutionResult</code>.
     */
...
/**
 * @member {module:model/PlaybackRepeatModeResolutionResult.ClassEnum} class
 */
PlaybackRepeatModeResolutionResult.prototype['class'] = undefined;

/**
 * @member {Object} confirmationRequired
 */
PlaybackRepeatModeResolutionResult.prototype['confirmationRequired'] = undefined;

/**
 * @member {Object} success
 */
PlaybackRepeatModeResolutionResult.prototype['success'] = undefined;
 ...
 * @readonly
 */
PlaybackRepeatModeResolutionResult['ClassEnum'] = {
...
export default PlaybackRepeatModeResolutionResult;
