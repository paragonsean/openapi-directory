...
import PlayMediaMediaItemUnsupportedReason from './PlayMediaMediaItemUnsupportedReason';

/**
 * The PlayMediaMediaItemResolutionResult model module.
 * @module model/PlayMediaMediaItemResolutionResult
 * @version 1.0.2
 */
class PlayMediaMediaItemResolutionResult {
    /**
     * Constructs a new <code>PlayMediaMediaItemResolutionResult</code>.
     * @alias module:model/PlayMediaMediaItemResolutionResult
    ...
    constructor() { 
        ...
        PlayMediaMediaItemResolutionResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PlayMediaMediaItemResolutionResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlayMediaMediaItemResolutionResult} obj Optional instance to populate.
     * @return {module:model/PlayMediaMediaItemResolutionResult} The populated <code>PlayMediaMediaItemResolutionResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlayMediaMediaItemResolutionResult();
    ...
    /**
     * Validates the JSON data with respect to <code>PlayMediaMediaItemResolutionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlayMediaMediaItemResolutionResult</code>.
     */
...
/**
 * @member {module:model/PlayMediaMediaItemResolutionResult.ClassEnum} class
 */
PlayMediaMediaItemResolutionResult.prototype['class'] = undefined;

/**
 * @member {Object} confirmationRequired
 */
PlayMediaMediaItemResolutionResult.prototype['confirmationRequired'] = undefined;

/**
 * @member {Object} disambiguation
 */
PlayMediaMediaItemResolutionResult.prototype['disambiguation'] = undefined;

/**
 * @member {Object} success
 */
PlayMediaMediaItemResolutionResult.prototype['success'] = undefined;

/**
 * @member {Object} unsupported
 */
PlayMediaMediaItemResolutionResult.prototype['unsupported'] = undefined;
 ...
 * @readonly
 */
PlayMediaMediaItemResolutionResult['ClassEnum'] = {
...
export default PlayMediaMediaItemResolutionResult;
