...
import AddMediaMediaDestinationUnsupportedReason from './AddMediaMediaDestinationUnsupportedReason';
import IntentResolutionResult from './IntentResolutionResult';
import MediaDestination from './MediaDestination';

/**
 * The AddMediaMediaDestinationResolutionResult model module.
 * @module model/AddMediaMediaDestinationResolutionResult
 * @version 1.0.2
 */
class AddMediaMediaDestinationResolutionResult {
    /**
     * Constructs a new <code>AddMediaMediaDestinationResolutionResult</code>.
     * @alias module:model/AddMediaMediaDestinationResolutionResult
    ...
    constructor() { 
        ...
        AddMediaMediaDestinationResolutionResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddMediaMediaDestinationResolutionResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddMediaMediaDestinationResolutionResult} obj Optional instance to populate.
     * @return {module:model/AddMediaMediaDestinationResolutionResult} The populated <code>AddMediaMediaDestinationResolutionResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddMediaMediaDestinationResolutionResult();
    ...
    /**
     * Validates the JSON data with respect to <code>AddMediaMediaDestinationResolutionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddMediaMediaDestinationResolutionResult</code>.
     */
...
/**
 * @member {module:model/AddMediaMediaDestinationResolutionResult.ClassEnum} class
 */
AddMediaMediaDestinationResolutionResult.prototype['class'] = undefined;

/**
 * @member {Object} confirmationRequired
 */
AddMediaMediaDestinationResolutionResult.prototype['confirmationRequired'] = undefined;

/**
 * @member {Object} disambiguation
 */
AddMediaMediaDestinationResolutionResult.prototype['disambiguation'] = undefined;

/**
 * @member {Object} success
 */
AddMediaMediaDestinationResolutionResult.prototype['success'] = undefined;

/**
 * @member {Object} unsupported
 */
AddMediaMediaDestinationResolutionResult.prototype['unsupported'] = undefined;
 ...
 * @readonly
 */
AddMediaMediaDestinationResolutionResult['ClassEnum'] = {

    /**
     * value: "AddMediaMediaDestinationResolutionResult"
     * @const
     */
    "AddMediaMediaDestinationResolutionResult": "AddMediaMediaDestinationResolutionResult"
};



export default AddMediaMediaDestinationResolutionResult;
