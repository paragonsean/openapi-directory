...
/**
 * The BooleanResolutionResult model module.
 * @module model/BooleanResolutionResult
 * @version 1.0.2
 */
class BooleanResolutionResult {
    /**
     * Constructs a new <code>BooleanResolutionResult</code>.
     * @alias module:model/BooleanResolutionResult
    ...
    constructor() { 
        ...
        BooleanResolutionResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BooleanResolutionResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BooleanResolutionResult} obj Optional instance to populate.
     * @return {module:model/BooleanResolutionResult} The populated <code>BooleanResolutionResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BooleanResolutionResult();
    ...
    /**
     * Validates the JSON data with respect to <code>BooleanResolutionResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BooleanResolutionResult</code>.
     */
...
/**
 * @member {module:model/BooleanResolutionResult.ClassEnum} class
 */
BooleanResolutionResult.prototype['class'] = undefined;

/**
 * @member {Object} confirmationRequired
 */
BooleanResolutionResult.prototype['confirmationRequired'] = undefined;

/**
 * @member {Object} success
 */
BooleanResolutionResult.prototype['success'] = undefined;
 ...
 * @readonly
 */
BooleanResolutionResult['ClassEnum'] = {
...
export default BooleanResolutionResult;
