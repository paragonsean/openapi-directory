...
OAIDateComponents::OAIDateComponents(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDateComponents::OAIDateComponents() {
    this->initializeModel();
}

OAIDateComponents::~OAIDateComponents() {}

void OAIDateComponents::initializeModel() {
...
void OAIDateComponents::fromJson(QString jsonString) {
...
void OAIDateComponents::fromJsonObject(QJsonObject json) {
...
QString OAIDateComponents::asJson() const {
...
QJsonObject OAIDateComponents::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDateComponents::getCalendarIdentifier() const {
    return m_calendar_identifier;
}
void OAIDateComponents::setCalendarIdentifier(const QString &calendar_identifier) {
    m_calendar_identifier = calendar_identifier;
    m_calendar_identifier_isSet = true;
}

bool OAIDateComponents::is_calendar_identifier_Set() const{
    return m_calendar_identifier_isSet;
}

bool OAIDateComponents::is_calendar_identifier_Valid() const{
    return m_calendar_identifier_isValid;
}

qint32 OAIDateComponents::getDay() const {
    return m_day;
}
void OAIDateComponents::setDay(const qint32 &day) {
    m_day = day;
    m_day_isSet = true;
}

bool OAIDateComponents::is_day_Set() const{
    return m_day_isSet;
}

bool OAIDateComponents::is_day_Valid() const{
    return m_day_isValid;
}

qint32 OAIDateComponents::getEra() const {
    return m_era;
}
void OAIDateComponents::setEra(const qint32 &era) {
    m_era = era;
    m_era_isSet = true;
}

bool OAIDateComponents::is_era_Set() const{
    return m_era_isSet;
}

bool OAIDateComponents::is_era_Valid() const{
    return m_era_isValid;
}

qint32 OAIDateComponents::getHour() const {
    return m_hour;
}
void OAIDateComponents::setHour(const qint32 &hour) {
    m_hour = hour;
    m_hour_isSet = true;
}

bool OAIDateComponents::is_hour_Set() const{
    return m_hour_isSet;
}

bool OAIDateComponents::is_hour_Valid() const{
    return m_hour_isValid;
}

qint32 OAIDateComponents::getMinute() const {
    return m_minute;
}
void OAIDateComponents::setMinute(const qint32 &minute) {
    m_minute = minute;
    m_minute_isSet = true;
}

bool OAIDateComponents::is_minute_Set() const{
    return m_minute_isSet;
}

bool OAIDateComponents::is_minute_Valid() const{
    return m_minute_isValid;
}

qint32 OAIDateComponents::getMonth() const {
    return m_month;
}
void OAIDateComponents::setMonth(const qint32 &month) {
    m_month = month;
    m_month_isSet = true;
}

bool OAIDateComponents::is_month_Set() const{
    return m_month_isSet;
}

bool OAIDateComponents::is_month_Valid() const{
    return m_month_isValid;
}

qint32 OAIDateComponents::getNanosecond() const {
    return m_nanosecond;
}
void OAIDateComponents::setNanosecond(const qint32 &nanosecond) {
    m_nanosecond = nanosecond;
    m_nanosecond_isSet = true;
}

bool OAIDateComponents::is_nanosecond_Set() const{
    return m_nanosecond_isSet;
}

bool OAIDateComponents::is_nanosecond_Valid() const{
    return m_nanosecond_isValid;
}

qint32 OAIDateComponents::getSecond() const {
    return m_second;
}
void OAIDateComponents::setSecond(const qint32 &second) {
    m_second = second;
    m_second_isSet = true;
}

bool OAIDateComponents::is_second_Set() const{
    return m_second_isSet;
}

bool OAIDateComponents::is_second_Valid() const{
    return m_second_isValid;
}

QString OAIDateComponents::getTimeZone() const {
    return m_time_zone;
}
void OAIDateComponents::setTimeZone(const QString &time_zone) {
    m_time_zone = time_zone;
    m_time_zone_isSet = true;
}

bool OAIDateComponents::is_time_zone_Set() const{
    return m_time_zone_isSet;
}

bool OAIDateComponents::is_time_zone_Valid() const{
    return m_time_zone_isValid;
}

qint32 OAIDateComponents::getYear() const {
    return m_year;
}
void OAIDateComponents::setYear(const qint32 &year) {
    m_year = year;
    m_year_isSet = true;
}

bool OAIDateComponents::is_year_Set() const{
    return m_year_isSet;
}

bool OAIDateComponents::is_year_Valid() const{
    return m_year_isValid;
}

bool OAIDateComponents::isSet() const {
...
bool OAIDateComponents::isValid() const {
