...
OAIBooleanResolutionResult::OAIBooleanResolutionResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBooleanResolutionResult::OAIBooleanResolutionResult() {
    this->initializeModel();
}

OAIBooleanResolutionResult::~OAIBooleanResolutionResult() {}

void OAIBooleanResolutionResult::initializeModel() {
...
void OAIBooleanResolutionResult::fromJson(QString jsonString) {
...
void OAIBooleanResolutionResult::fromJsonObject(QJsonObject json) {
...
QString OAIBooleanResolutionResult::asJson() const {
...
QJsonObject OAIBooleanResolutionResult::asJsonObject() const {
    QJsonObject obj;
    if (m_r_class_isSet) {
...
QString OAIBooleanResolutionResult::getRClass() const {
    return m_r_class;
}
void OAIBooleanResolutionResult::setRClass(const QString &r_class) {
    m_r_class = r_class;
    m_r_class_isSet = true;
}

bool OAIBooleanResolutionResult::is_r_class_Set() const{
    return m_r_class_isSet;
}

bool OAIBooleanResolutionResult::is_r_class_Valid() const{
    return m_r_class_isValid;
}

OAIObject OAIBooleanResolutionResult::getConfirmationRequired() const {
    return m_confirmation_required;
}
void OAIBooleanResolutionResult::setConfirmationRequired(const OAIObject &confirmation_required) {
    m_confirmation_required = confirmation_required;
    m_confirmation_required_isSet = true;
}

bool OAIBooleanResolutionResult::is_confirmation_required_Set() const{
    return m_confirmation_required_isSet;
}

bool OAIBooleanResolutionResult::is_confirmation_required_Valid() const{
    return m_confirmation_required_isValid;
}

OAIObject OAIBooleanResolutionResult::getSuccess() const {
    return m_success;
}
void OAIBooleanResolutionResult::setSuccess(const OAIObject &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIBooleanResolutionResult::is_success_Set() const{
    return m_success_isSet;
}

bool OAIBooleanResolutionResult::is_success_Valid() const{
    return m_success_isValid;
}

OAIObject OAIBooleanResolutionResult::getNeedsValue() const {
    return m_needs_value;
}
void OAIBooleanResolutionResult::setNeedsValue(const OAIObject &needs_value) {
    m_needs_value = needs_value;
    m_needs_value_isSet = true;
}

bool OAIBooleanResolutionResult::is_needs_value_Set() const{
    return m_needs_value_isSet;
}

bool OAIBooleanResolutionResult::is_needs_value_Valid() const{
    return m_needs_value_isValid;
}

OAIObject OAIBooleanResolutionResult::getNotRequired() const {
    return m_not_required;
}
void OAIBooleanResolutionResult::setNotRequired(const OAIObject &not_required) {
    m_not_required = not_required;
    m_not_required_isSet = true;
}

bool OAIBooleanResolutionResult::is_not_required_Set() const{
    return m_not_required_isSet;
}

bool OAIBooleanResolutionResult::is_not_required_Valid() const{
    return m_not_required_isValid;
}

OAIObject OAIBooleanResolutionResult::getUnsupported() const {
    return m_unsupported;
}
void OAIBooleanResolutionResult::setUnsupported(const OAIObject &unsupported) {
    m_unsupported = unsupported;
    m_unsupported_isSet = true;
}

bool OAIBooleanResolutionResult::is_unsupported_Set() const{
    return m_unsupported_isSet;
}

bool OAIBooleanResolutionResult::is_unsupported_Valid() const{
    return m_unsupported_isValid;
}

bool OAIBooleanResolutionResult::isSet() const {
...
bool OAIBooleanResolutionResult::isValid() const {
