...
OAIPlayMediaMediaItemResolutionResult::OAIPlayMediaMediaItemResolutionResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlayMediaMediaItemResolutionResult::OAIPlayMediaMediaItemResolutionResult() {
    this->initializeModel();
}

OAIPlayMediaMediaItemResolutionResult::~OAIPlayMediaMediaItemResolutionResult() {}

void OAIPlayMediaMediaItemResolutionResult::initializeModel() {
...
void OAIPlayMediaMediaItemResolutionResult::fromJson(QString jsonString) {
...
void OAIPlayMediaMediaItemResolutionResult::fromJsonObject(QJsonObject json) {
...
QString OAIPlayMediaMediaItemResolutionResult::asJson() const {
...
QJsonObject OAIPlayMediaMediaItemResolutionResult::asJsonObject() const {
    QJsonObject obj;
    if (m_r_class_isSet) {
...
QString OAIPlayMediaMediaItemResolutionResult::getRClass() const {
    return m_r_class;
}
void OAIPlayMediaMediaItemResolutionResult::setRClass(const QString &r_class) {
    m_r_class = r_class;
    m_r_class_isSet = true;
}

bool OAIPlayMediaMediaItemResolutionResult::is_r_class_Set() const{
    return m_r_class_isSet;
}

bool OAIPlayMediaMediaItemResolutionResult::is_r_class_Valid() const{
    return m_r_class_isValid;
}

OAIObject OAIPlayMediaMediaItemResolutionResult::getConfirmationRequired() const {
    return m_confirmation_required;
}
void OAIPlayMediaMediaItemResolutionResult::setConfirmationRequired(const OAIObject &confirmation_required) {
    m_confirmation_required = confirmation_required;
    m_confirmation_required_isSet = true;
}

bool OAIPlayMediaMediaItemResolutionResult::is_confirmation_required_Set() const{
    return m_confirmation_required_isSet;
}

bool OAIPlayMediaMediaItemResolutionResult::is_confirmation_required_Valid() const{
    return m_confirmation_required_isValid;
}

OAIObject OAIPlayMediaMediaItemResolutionResult::getDisambiguation() const {
    return m_disambiguation;
}
void OAIPlayMediaMediaItemResolutionResult::setDisambiguation(const OAIObject &disambiguation) {
    m_disambiguation = disambiguation;
    m_disambiguation_isSet = true;
}

bool OAIPlayMediaMediaItemResolutionResult::is_disambiguation_Set() const{
    return m_disambiguation_isSet;
}

bool OAIPlayMediaMediaItemResolutionResult::is_disambiguation_Valid() const{
    return m_disambiguation_isValid;
}

OAIObject OAIPlayMediaMediaItemResolutionResult::getSuccess() const {
    return m_success;
}
void OAIPlayMediaMediaItemResolutionResult::setSuccess(const OAIObject &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIPlayMediaMediaItemResolutionResult::is_success_Set() const{
    return m_success_isSet;
}

bool OAIPlayMediaMediaItemResolutionResult::is_success_Valid() const{
    return m_success_isValid;
}

OAIObject OAIPlayMediaMediaItemResolutionResult::getUnsupported() const {
    return m_unsupported;
}
void OAIPlayMediaMediaItemResolutionResult::setUnsupported(const OAIObject &unsupported) {
    m_unsupported = unsupported;
    m_unsupported_isSet = true;
}

bool OAIPlayMediaMediaItemResolutionResult::is_unsupported_Set() const{
    return m_unsupported_isSet;
}

bool OAIPlayMediaMediaItemResolutionResult::is_unsupported_Valid() const{
    return m_unsupported_isValid;
}

OAIObject OAIPlayMediaMediaItemResolutionResult::getNeedsValue() const {
    return m_needs_value;
}
void OAIPlayMediaMediaItemResolutionResult::setNeedsValue(const OAIObject &needs_value) {
    m_needs_value = needs_value;
    m_needs_value_isSet = true;
}

bool OAIPlayMediaMediaItemResolutionResult::is_needs_value_Set() const{
    return m_needs_value_isSet;
}

bool OAIPlayMediaMediaItemResolutionResult::is_needs_value_Valid() const{
    return m_needs_value_isValid;
}

OAIObject OAIPlayMediaMediaItemResolutionResult::getNotRequired() const {
    return m_not_required;
}
void OAIPlayMediaMediaItemResolutionResult::setNotRequired(const OAIObject &not_required) {
    m_not_required = not_required;
    m_not_required_isSet = true;
}

bool OAIPlayMediaMediaItemResolutionResult::is_not_required_Set() const{
    return m_not_required_isSet;
}

bool OAIPlayMediaMediaItemResolutionResult::is_not_required_Valid() const{
    return m_not_required_isValid;
}

bool OAIPlayMediaMediaItemResolutionResult::isSet() const {
...
bool OAIPlayMediaMediaItemResolutionResult::isValid() const {
