...
#ifndef OAIIntentResponse_H
#define OAIIntentResponse_H
...
class OAIIntentResponse : public OAIObject {
public:
    OAIIntentResponse();
    OAIIntentResponse(QString json);
    ~OAIIntentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntentResponse)

#endif // OAIIntentResponse_H
