...
/*
 * OAIExplicitDateComponents.h
 *
 * 
 */

#ifndef OAIExplicitDateComponents_H
#define OAIExplicitDateComponents_H
...
class OAIExplicitDateComponents : public OAIObject {
public:
    OAIExplicitDateComponents();
    OAIExplicitDateComponents(QString json);
    ~OAIExplicitDateComponents() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExplicitDateComponents)

#endif // OAIExplicitDateComponents_H
