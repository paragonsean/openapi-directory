...
#ifndef OAIInvocation_H
#define OAIInvocation_H
...
class OAIInvocation : public OAIObject {
public:
    OAIInvocation();
    OAIInvocation(QString json);
    ~OAIInvocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvocation)

#endif // OAIInvocation_H
