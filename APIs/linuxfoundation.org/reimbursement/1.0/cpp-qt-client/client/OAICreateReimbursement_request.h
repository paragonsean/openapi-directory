...
/*
 * OAICreateReimbursement_request.h
 *
 * 
 */

#ifndef OAICreateReimbursement_request_H
#define OAICreateReimbursement_request_H
...
class OAICreateReimbursement_request : public OAIObject {
public:
    OAICreateReimbursement_request();
    OAICreateReimbursement_request(QString json);
    ~OAICreateReimbursement_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateReimbursement_request)

#endif // OAICreateReimbursement_request_H
