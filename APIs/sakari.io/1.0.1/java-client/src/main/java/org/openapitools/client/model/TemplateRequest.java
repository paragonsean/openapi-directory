...
public class TemplateRequest {
  ...
  public TemplateRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, template, type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
