...
import org.openapitools.client.model.ShareFileResponseData;
...
public class ShareFileResponse {
  ...
  private ShareFileResponseData data;
  ...
  public ShareFileResponse data(ShareFileResponseData data) {
    this.data = data;
    return this;
  }
  ...
  public ShareFileResponseData getData() {
    return data;
  }

  public void setData(ShareFileResponseData data) {
    this.data = data;
  }


  public ShareFileResponse success(Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    ShareFileResponse shareFileResponse = (ShareFileResponse) o;
    return Objects.equals(this.data, shareFileResponse.data) &&
        Objects.equals(this.success, shareFileResponse.success);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShareFileResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShareFileResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShareFileResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShareFileResponse is not found in the empty JSON string", ShareFileResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShareFileResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShareFileResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ShareFileResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShareFileResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShareFileResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShareFileResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShareFileResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ShareFileResponse>() {
           @Override
           public void write(JsonWriter out, ShareFileResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShareFileResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ShareFileResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ShareFileResponse
   * @throws IOException if the JSON string is invalid with respect to ShareFileResponse
   */
  public static ShareFileResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShareFileResponse.class);
  }

  /**
   * Convert an instance of ShareFileResponse to an JSON string
   *
   * @return JSON string
   */
