...
public class CampaignsResponse {
  ...
  public CampaignsResponse error(PaginatedResponseError error) {
    this.error = error;
    return this;
  }
  ...
  public CampaignsResponse pagination(PaginatedResponsePagination pagination) {
  ...
  public CampaignsResponse success(Boolean success) {
  ...
  public CampaignsResponse data(List<Campaign> data) {
    this.data = data;
    return this;
  }

  public CampaignsResponse addDataItem(Campaign dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsResponse campaignsResponse = (CampaignsResponse) o;
    return Objects.equals(this.error, campaignsResponse.error) &&
        Objects.equals(this.pagination, campaignsResponse.pagination) &&
        Objects.equals(this.success, campaignsResponse.success) &&
        Objects.equals(this.data, campaignsResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CampaignsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsResponse is not found in the empty JSON string", CampaignsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsResponse>() {
           @Override
           public void write(JsonWriter out, CampaignsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CampaignsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CampaignsResponse
   * @throws IOException if the JSON string is invalid with respect to CampaignsResponse
   */
  public static CampaignsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsResponse.class);
  }

  /**
   * Convert an instance of CampaignsResponse to an JSON string
   *
   * @return JSON string
   */
