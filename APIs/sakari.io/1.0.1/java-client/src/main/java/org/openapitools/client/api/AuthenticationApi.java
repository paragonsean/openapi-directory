...
public class AuthenticationApi {
     ...
     */
    public okhttp3.Call authTokenCall(TokenRequest tokenRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call authTokenValidateBeforeCall(TokenRequest tokenRequest, final ApiCallback _callback) throws ApiException {
        return authTokenCall(tokenRequest, _callback);
     ...
     */
    public TokenResponse authToken(TokenRequest tokenRequest) throws ApiException {
        ApiResponse<TokenResponse> localVarResp = authTokenWithHttpInfo(tokenRequest);
     ...
     */
    public ApiResponse<TokenResponse> authTokenWithHttpInfo(TokenRequest tokenRequest) throws ApiException {
        okhttp3.Call localVarCall = authTokenValidateBeforeCall(tokenRequest, null);
        Type localVarReturnType = new TypeToken<TokenResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get token for accessing APIs (asynchronously)
     * 
     * @param tokenRequest  (optional)
     ...
     */
    public okhttp3.Call authTokenAsync(TokenRequest tokenRequest, final ApiCallback<TokenResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = authTokenValidateBeforeCall(tokenRequest, _callback);
        Type localVarReturnType = new TypeToken<TokenResponse>(){}.getType();
