...
public class WebhooksResponse {
  ...
  public WebhooksResponse error(PaginatedResponseError error) {
    this.error = error;
    return this;
  }
  ...
  public WebhooksResponse pagination(PaginatedResponsePagination pagination) {
  ...
  public WebhooksResponse data(List<Webhook> data) {
    this.data = data;
    return this;
  }

  public WebhooksResponse addDataItem(Webhook dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, webhooksResponse.error) &&
        Objects.equals(this.pagination, webhooksResponse.pagination) &&
        Objects.equals(this.success, webhooksResponse.success) &&
        Objects.equals(this.data, webhooksResponse.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhooksResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhooksResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhooksResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhooksResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
