...
public class CampaignsRemove200Response {
  public static final String SERIALIZED_NAME_SUCCESS = "success";
  @SerializedName(SERIALIZED_NAME_SUCCESS)
  private Boolean success;

  public CampaignsRemove200Response() {
  }

  public CampaignsRemove200Response success(Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsRemove200Response campaignsRemove200Response = (CampaignsRemove200Response) o;
    return Objects.equals(this.success, campaignsRemove200Response.success);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsRemove200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CampaignsRemove200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignsRemove200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsRemove200Response is not found in the empty JSON string", CampaignsRemove200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignsRemove200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignsRemove200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsRemove200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsRemove200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsRemove200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsRemove200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsRemove200Response>() {
           @Override
           public void write(JsonWriter out, CampaignsRemove200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignsRemove200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CampaignsRemove200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CampaignsRemove200Response
   * @throws IOException if the JSON string is invalid with respect to CampaignsRemove200Response
   */
  public static CampaignsRemove200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsRemove200Response.class);
  }

  /**
   * Convert an instance of CampaignsRemove200Response to an JSON string
   *
   * @return JSON string
   */
