...
public class PaginatedResponsePagination {
  ...
  public PaginatedResponsePagination() {
  }

  public PaginatedResponsePagination limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PaginatedResponsePagination offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public PaginatedResponsePagination totalCount(Integer totalCount) {
  ...
  public boolean equals(Object o) {
    ...
    PaginatedResponsePagination paginatedResponsePagination = (PaginatedResponsePagination) o;
    return Objects.equals(this.limit, paginatedResponsePagination.limit) &&
        Objects.equals(this.offset, paginatedResponsePagination.offset) &&
        Objects.equals(this.totalCount, paginatedResponsePagination.totalCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedResponsePagination {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaginatedResponsePagination
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaginatedResponsePagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginatedResponsePagination is not found in the empty JSON string", PaginatedResponsePagination.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaginatedResponsePagination.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginatedResponsePagination` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaginatedResponsePagination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaginatedResponsePagination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaginatedResponsePagination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaginatedResponsePagination.class));

       return (TypeAdapter<T>) new TypeAdapter<PaginatedResponsePagination>() {
           @Override
           public void write(JsonWriter out, PaginatedResponsePagination value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaginatedResponsePagination read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaginatedResponsePagination given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaginatedResponsePagination
   * @throws IOException if the JSON string is invalid with respect to PaginatedResponsePagination
   */
  public static PaginatedResponsePagination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaginatedResponsePagination.class);
  }

  /**
   * Convert an instance of PaginatedResponsePagination to an JSON string
   *
   * @return JSON string
   */
