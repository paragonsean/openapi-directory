...
public class ContactUploadResponse {
  ...
  private ContactUploadResponseData data;
  ...
  public ContactUploadResponse data(ContactUploadResponseData data) {
    this.data = data;
    return this;
  }
  ...
  public ContactUploadResponseData getData() {
    return data;
  }

  public void setData(ContactUploadResponseData data) {
    this.data = data;
  }


  public ContactUploadResponse success(Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    ContactUploadResponse contactUploadResponse = (ContactUploadResponse) o;
    return Objects.equals(this.data, contactUploadResponse.data) &&
        Objects.equals(this.success, contactUploadResponse.success);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactUploadResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactUploadResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactUploadResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactUploadResponse is not found in the empty JSON string", ContactUploadResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactUploadResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactUploadResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ContactUploadResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactUploadResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactUploadResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactUploadResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactUploadResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactUploadResponse>() {
           @Override
           public void write(JsonWriter out, ContactUploadResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactUploadResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactUploadResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactUploadResponse
   * @throws IOException if the JSON string is invalid with respect to ContactUploadResponse
   */
  public static ContactUploadResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactUploadResponse.class);
  }

  /**
   * Convert an instance of ContactUploadResponse to an JSON string
   *
   * @return JSON string
   */
