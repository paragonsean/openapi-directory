...
public class SendMessagesRequestMediaInner {
  public static final String SERIALIZED_NAME_URL = "url";
  @SerializedName(SERIALIZED_NAME_URL)
  private String url;

  public SendMessagesRequestMediaInner() {
  }

  public SendMessagesRequestMediaInner url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendMessagesRequestMediaInner sendMessagesRequestMediaInner = (SendMessagesRequestMediaInner) o;
    return Objects.equals(this.url, sendMessagesRequestMediaInner.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendMessagesRequestMediaInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendMessagesRequestMediaInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendMessagesRequestMediaInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendMessagesRequestMediaInner is not found in the empty JSON string", SendMessagesRequestMediaInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendMessagesRequestMediaInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SendMessagesRequestMediaInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendMessagesRequestMediaInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendMessagesRequestMediaInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendMessagesRequestMediaInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendMessagesRequestMediaInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SendMessagesRequestMediaInner>() {
           @Override
           public void write(JsonWriter out, SendMessagesRequestMediaInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendMessagesRequestMediaInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendMessagesRequestMediaInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendMessagesRequestMediaInner
   * @throws IOException if the JSON string is invalid with respect to SendMessagesRequestMediaInner
   */
  public static SendMessagesRequestMediaInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendMessagesRequestMediaInner.class);
  }

  /**
   * Convert an instance of SendMessagesRequestMediaInner to an JSON string
   *
   * @return JSON string
   */
