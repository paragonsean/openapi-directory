...
public class SendMessagesRequestPhoneNumberFilter {
  ...
  private MessageConversation group;

  public SendMessagesRequestPhoneNumberFilter() {
  }

  public SendMessagesRequestPhoneNumberFilter group(MessageConversation group) {
    this.group = group;
    return this;
  }
  ...
  public MessageConversation getGroup() {
    return group;
  }

  public void setGroup(MessageConversation group) {
    this.group = group;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendMessagesRequestPhoneNumberFilter sendMessagesRequestPhoneNumberFilter = (SendMessagesRequestPhoneNumberFilter) o;
    return Objects.equals(this.group, sendMessagesRequestPhoneNumberFilter.group);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendMessagesRequestPhoneNumberFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendMessagesRequestPhoneNumberFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendMessagesRequestPhoneNumberFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendMessagesRequestPhoneNumberFilter is not found in the empty JSON string", SendMessagesRequestPhoneNumberFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendMessagesRequestPhoneNumberFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SendMessagesRequestPhoneNumberFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `group`
      if (jsonObj.get("group") != null && !jsonObj.get("group").isJsonNull()) {
        MessageConversation.validateJsonElement(jsonObj.get("group"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendMessagesRequestPhoneNumberFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendMessagesRequestPhoneNumberFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendMessagesRequestPhoneNumberFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendMessagesRequestPhoneNumberFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<SendMessagesRequestPhoneNumberFilter>() {
           @Override
           public void write(JsonWriter out, SendMessagesRequestPhoneNumberFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendMessagesRequestPhoneNumberFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendMessagesRequestPhoneNumberFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendMessagesRequestPhoneNumberFilter
   * @throws IOException if the JSON string is invalid with respect to SendMessagesRequestPhoneNumberFilter
   */
  public static SendMessagesRequestPhoneNumberFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendMessagesRequestPhoneNumberFilter.class);
  }

  /**
   * Convert an instance of SendMessagesRequestPhoneNumberFilter to an JSON string
   *
   * @return JSON string
   */
