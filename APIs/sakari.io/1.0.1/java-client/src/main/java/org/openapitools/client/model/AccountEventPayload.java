...
public class AccountEventPayload {
  ...
  public AccountEventPayload balance(Double balance) {
  ...
  public boolean equals(Object o) {
    ...
    AccountEventPayload accountEventPayload = (AccountEventPayload) o;
    return Objects.equals(this.balance, accountEventPayload.balance);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountEventPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountEventPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountEventPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountEventPayload is not found in the empty JSON string", AccountEventPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountEventPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountEventPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountEventPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountEventPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountEventPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountEventPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountEventPayload>() {
           @Override
           public void write(JsonWriter out, AccountEventPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountEventPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountEventPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountEventPayload
   * @throws IOException if the JSON string is invalid with respect to AccountEventPayload
   */
  public static AccountEventPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountEventPayload.class);
  }

  /**
   * Convert an instance of AccountEventPayload to an JSON string
   *
   * @return JSON string
   */
