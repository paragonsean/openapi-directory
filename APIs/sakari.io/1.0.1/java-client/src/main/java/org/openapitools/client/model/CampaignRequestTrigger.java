...
public class CampaignRequestTrigger {
  ...
  public CampaignRequestTrigger code(CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CampaignRequestTrigger campaignRequestTrigger = (CampaignRequestTrigger) o;
    return Objects.equals(this.code, campaignRequestTrigger.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignRequestTrigger {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CampaignRequestTrigger
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignRequestTrigger.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignRequestTrigger is not found in the empty JSON string", CampaignRequestTrigger.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignRequestTrigger.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignRequestTrigger` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignRequestTrigger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignRequestTrigger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignRequestTrigger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignRequestTrigger.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignRequestTrigger>() {
           @Override
           public void write(JsonWriter out, CampaignRequestTrigger value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignRequestTrigger read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CampaignRequestTrigger given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CampaignRequestTrigger
   * @throws IOException if the JSON string is invalid with respect to CampaignRequestTrigger
   */
  public static CampaignRequestTrigger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignRequestTrigger.class);
  }

  /**
   * Convert an instance of CampaignRequestTrigger to an JSON string
   *
   * @return JSON string
   */
