...
public class ShareFileResponseData {
  ...
  public ShareFileResponseData expires(OffsetDateTime expires) {
  ...
  public ShareFileResponseData link(String link) {
    this.link = link;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ShareFileResponseData shareFileResponseData = (ShareFileResponseData) o;
    return Objects.equals(this.expires, shareFileResponseData.expires) &&
        Objects.equals(this.link, shareFileResponseData.link);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expires, link);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ShareFileResponseData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShareFileResponseData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShareFileResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShareFileResponseData is not found in the empty JSON string", ShareFileResponseData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShareFileResponseData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShareFileResponseData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShareFileResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShareFileResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShareFileResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShareFileResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<ShareFileResponseData>() {
           @Override
           public void write(JsonWriter out, ShareFileResponseData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShareFileResponseData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ShareFileResponseData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ShareFileResponseData
   * @throws IOException if the JSON string is invalid with respect to ShareFileResponseData
   */
  public static ShareFileResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShareFileResponseData.class);
  }

  /**
   * Convert an instance of ShareFileResponseData to an JSON string
   *
   * @return JSON string
   */
