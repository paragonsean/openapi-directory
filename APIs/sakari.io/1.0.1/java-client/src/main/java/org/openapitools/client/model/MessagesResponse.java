...
public class MessagesResponse {
  ...
  public MessagesResponse error(PaginatedResponseError error) {
    this.error = error;
    return this;
  }
  ...
  public MessagesResponse pagination(PaginatedResponsePagination pagination) {
  ...
  public MessagesResponse success(Boolean success) {
  ...
  public MessagesResponse data(List<Message> data) {
    this.data = data;
    return this;
  }

  public MessagesResponse addDataItem(Message dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, messagesResponse.error) &&
        Objects.equals(this.pagination, messagesResponse.pagination) &&
        Objects.equals(this.success, messagesResponse.success) &&
        Objects.equals(this.data, messagesResponse.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessagesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessagesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessagesResponse is not found in the empty JSON string", MessagesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessagesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessagesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessagesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessagesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessagesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessagesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MessagesResponse>() {
           @Override
           public void write(JsonWriter out, MessagesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessagesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessagesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessagesResponse
   * @throws IOException if the JSON string is invalid with respect to MessagesResponse
   */
  public static MessagesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessagesResponse.class);
  }

  /**
   * Convert an instance of MessagesResponse to an JSON string
   *
   * @return JSON string
   */
