...
public class ContactIdentifiers {
  ...
  public ContactIdentifiers email(String email) {
    this.email = email;
    return this;
  }
  ...
  public ContactIdentifiers firstName(String firstName) {
  ...
  public ContactIdentifiers id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ContactIdentifiers lastName(String lastName) {
  ...
  public ContactIdentifiers mobile(ContactIdentifiersMobile mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ContactIdentifiers contactIdentifiers = (ContactIdentifiers) o;
    return Objects.equals(this.email, contactIdentifiers.email) &&
        Objects.equals(this.firstName, contactIdentifiers.firstName) &&
        Objects.equals(this.id, contactIdentifiers.id) &&
        Objects.equals(this.lastName, contactIdentifiers.lastName) &&
        Objects.equals(this.mobile, contactIdentifiers.mobile);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactIdentifiers {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactIdentifiers
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactIdentifiers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactIdentifiers is not found in the empty JSON string", ContactIdentifiers.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactIdentifiers.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactIdentifiers` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactIdentifiers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactIdentifiers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactIdentifiers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactIdentifiers.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactIdentifiers>() {
           @Override
           public void write(JsonWriter out, ContactIdentifiers value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactIdentifiers read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactIdentifiers given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactIdentifiers
   * @throws IOException if the JSON string is invalid with respect to ContactIdentifiers
   */
  public static ContactIdentifiers fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactIdentifiers.class);
  }

  /**
   * Convert an instance of ContactIdentifiers to an JSON string
   *
   * @return JSON string
   */
