...
public class SendMessagesRequestFilters {
  ...
  public SendMessagesRequestFilters attributes(List<Object> attributes) {
    this.attributes = attributes;
    return this;
  }

  public SendMessagesRequestFilters addAttributesItem(Object attributesItem) {
  ...
  public SendMessagesRequestFilters tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public SendMessagesRequestFilters addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    SendMessagesRequestFilters sendMessagesRequestFilters = (SendMessagesRequestFilters) o;
    return Objects.equals(this.attributes, sendMessagesRequestFilters.attributes) &&
        Objects.equals(this.tags, sendMessagesRequestFilters.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendMessagesRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendMessagesRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendMessagesRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendMessagesRequestFilters is not found in the empty JSON string", SendMessagesRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendMessagesRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SendMessagesRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendMessagesRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendMessagesRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendMessagesRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendMessagesRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<SendMessagesRequestFilters>() {
           @Override
           public void write(JsonWriter out, SendMessagesRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendMessagesRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendMessagesRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendMessagesRequestFilters
   * @throws IOException if the JSON string is invalid with respect to SendMessagesRequestFilters
   */
  public static SendMessagesRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendMessagesRequestFilters.class);
  }

  /**
   * Convert an instance of SendMessagesRequestFilters to an JSON string
   *
   * @return JSON string
   */
