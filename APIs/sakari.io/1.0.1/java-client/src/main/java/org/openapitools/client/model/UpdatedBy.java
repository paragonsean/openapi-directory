...
public class UpdatedBy {
  ...
  public UpdatedBy firstName(String firstName) {
  ...
  public UpdatedBy lastName(String lastName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.firstName, updatedBy.firstName) &&
        Objects.equals(this.id, updatedBy.id) &&
        Objects.equals(this.lastName, updatedBy.lastName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatedBy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatedBy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatedBy is not found in the empty JSON string", UpdatedBy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatedBy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatedBy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatedBy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatedBy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatedBy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatedBy.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatedBy>() {
           @Override
           public void write(JsonWriter out, UpdatedBy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatedBy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatedBy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatedBy
   * @throws IOException if the JSON string is invalid with respect to UpdatedBy
   */
  public static UpdatedBy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatedBy.class);
  }

  /**
   * Convert an instance of UpdatedBy to an JSON string
   *
   * @return JSON string
   */
