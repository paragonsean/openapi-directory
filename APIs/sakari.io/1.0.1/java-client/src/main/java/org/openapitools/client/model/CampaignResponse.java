...
public class CampaignResponse {
  ...
  public CampaignResponse data(Campaign data) {
    this.data = data;
    return this;
  }
  ...
  public CampaignResponse success(Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, campaignResponse.data) &&
        Objects.equals(this.success, campaignResponse.success);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Campaign.validateJsonElement(jsonObj.get("data"));
      }
  }
