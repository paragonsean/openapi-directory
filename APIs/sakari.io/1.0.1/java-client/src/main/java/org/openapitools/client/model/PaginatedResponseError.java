...
public class PaginatedResponseError {
  ...
  public PaginatedResponseError() {
  }

  public PaginatedResponseError code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PaginatedResponseError message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    PaginatedResponseError paginatedResponseError = (PaginatedResponseError) o;
    return Objects.equals(this.code, paginatedResponseError.code) &&
        Objects.equals(this.message, paginatedResponseError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedResponseError {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaginatedResponseError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaginatedResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginatedResponseError is not found in the empty JSON string", PaginatedResponseError.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaginatedResponseError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginatedResponseError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaginatedResponseError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaginatedResponseError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaginatedResponseError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaginatedResponseError.class));

       return (TypeAdapter<T>) new TypeAdapter<PaginatedResponseError>() {
           @Override
           public void write(JsonWriter out, PaginatedResponseError value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaginatedResponseError read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaginatedResponseError given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaginatedResponseError
   * @throws IOException if the JSON string is invalid with respect to PaginatedResponseError
   */
  public static PaginatedResponseError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaginatedResponseError.class);
  }

  /**
   * Convert an instance of PaginatedResponseError to an JSON string
   *
   * @return JSON string
   */
