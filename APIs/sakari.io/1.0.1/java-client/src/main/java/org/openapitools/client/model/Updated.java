...
public class Updated {
  ...
  private UpdatedBy by;

  public Updated() {
  }

  public Updated at(OffsetDateTime at) {
    this.at = at;
    return this;
  }
  ...
  public Updated by(UpdatedBy by) {
    this.by = by;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public UpdatedBy getBy() {
    return by;
  }

  public void setBy(UpdatedBy by) {
    this.by = by;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.at, updated.at) &&
        Objects.equals(this.by, updated.by);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Updated
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Updated.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Updated is not found in the empty JSON string", Updated.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Updated.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Updated` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `by`
      if (jsonObj.get("by") != null && !jsonObj.get("by").isJsonNull()) {
        UpdatedBy.validateJsonElement(jsonObj.get("by"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Updated.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Updated' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Updated> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Updated.class));

       return (TypeAdapter<T>) new TypeAdapter<Updated>() {
           @Override
           public void write(JsonWriter out, Updated value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Updated read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Updated given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Updated
   * @throws IOException if the JSON string is invalid with respect to Updated
   */
  public static Updated fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Updated.class);
  }

  /**
   * Convert an instance of Updated to an JSON string
   *
   * @return JSON string
   */
