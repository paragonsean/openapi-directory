...
import java.io.File;
import org.openapitools.client.model.ShareFileResponse;
import org.openapitools.client.model.ToolsShareFileRequest;
...
public class ToolsApi {
     ...
     */
    public okhttp3.Call toolsShareFileCall(File body, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/tools/sharefile";
    ...
    private okhttp3.Call toolsShareFileValidateBeforeCall(File body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling toolsShareFile(Async)");
        }

        return toolsShareFileCall(body, _callback);
     ...
     */
    public ShareFileResponse toolsShareFile(File body) throws ApiException {
        ApiResponse<ShareFileResponse> localVarResp = toolsShareFileWithHttpInfo(body);
     ...
     * 
     * @param body  (required)
     * @return ApiResponse&lt;ShareFileResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ShareFileResponse> toolsShareFileWithHttpInfo(File body) throws ApiException {
        okhttp3.Call localVarCall = toolsShareFileValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<ShareFileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Share file - use to host a file and generate a short link to be used directly in a message or as a link to media for a MMS (asynchronously)
     * 
     * @param body  (required)
     ...
     */
    public okhttp3.Call toolsShareFileAsync(File body, final ApiCallback<ShareFileResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = toolsShareFileValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<ShareFileResponse>(){}.getType();
