...
public class CampaignRequest {
  ...
  private CampaignRequestFilters filters;
  ...
  private CampaignRequestTrigger trigger;

  public CampaignRequest() {
  }

  public CampaignRequest filters(CampaignRequestFilters filters) {
  ...
  public CampaignRequestFilters getFilters() {
    return filters;
  }

  public void setFilters(CampaignRequestFilters filters) {
    this.filters = filters;
  }


  public CampaignRequest template(String template) {
  ...
  public CampaignRequest trigger(CampaignRequestTrigger trigger) {
   ...
   */
  @javax.annotation.Nullable
  public CampaignRequestTrigger getTrigger() {
    return trigger;
  }

  public void setTrigger(CampaignRequestTrigger trigger) {
    this.trigger = trigger;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filters, campaignRequest.filters) &&
        Objects.equals(this.template, campaignRequest.template) &&
        Objects.equals(this.trigger, campaignRequest.trigger);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filters, template, trigger);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("filters") != null && !jsonObj.get("filters").isJsonNull()) {
        CampaignRequestFilters.validateJsonElement(jsonObj.get("filters"));
      }
      ...
      if (jsonObj.get("trigger") != null && !jsonObj.get("trigger").isJsonNull()) {
        CampaignRequestTrigger.validateJsonElement(jsonObj.get("trigger"));
      }
  }
