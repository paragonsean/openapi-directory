...
public class CampaignRequestFilters {
  ...
  public CampaignRequestFilters attributes(List<String> attributes) {
    this.attributes = attributes;
    return this;
  }

  public CampaignRequestFilters addAttributesItem(String attributesItem) {
  ...
  public CampaignRequestFilters contacts(List<String> contacts) {
    this.contacts = contacts;
    return this;
  }

  public CampaignRequestFilters addContactsItem(String contactsItem) {
  ...
  public CampaignRequestFilters tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public CampaignRequestFilters addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignRequestFilters campaignRequestFilters = (CampaignRequestFilters) o;
    return Objects.equals(this.attributes, campaignRequestFilters.attributes) &&
        Objects.equals(this.contacts, campaignRequestFilters.contacts) &&
        Objects.equals(this.tags, campaignRequestFilters.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributes, contacts, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CampaignRequestFilters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CampaignRequestFilters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignRequestFilters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignRequestFilters is not found in the empty JSON string", CampaignRequestFilters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignRequestFilters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignRequestFilters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignRequestFilters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignRequestFilters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignRequestFilters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignRequestFilters.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignRequestFilters>() {
           @Override
           public void write(JsonWriter out, CampaignRequestFilters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignRequestFilters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CampaignRequestFilters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CampaignRequestFilters
   * @throws IOException if the JSON string is invalid with respect to CampaignRequestFilters
   */
  public static CampaignRequestFilters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignRequestFilters.class);
  }

  /**
   * Convert an instance of CampaignRequestFilters to an JSON string
   *
   * @return JSON string
   */
