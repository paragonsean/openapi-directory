...
public class ConversationsResponse {
  ...
  public ConversationsResponse error(PaginatedResponseError error) {
    this.error = error;
    return this;
  }
  ...
  public ConversationsResponse pagination(PaginatedResponsePagination pagination) {
  ...
  public ConversationsResponse data(List<Conversation> data) {
    this.data = data;
    return this;
  }

  public ConversationsResponse addDataItem(Conversation dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, conversationsResponse.error) &&
        Objects.equals(this.pagination, conversationsResponse.pagination) &&
        Objects.equals(this.success, conversationsResponse.success) &&
        Objects.equals(this.data, conversationsResponse.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConversationsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConversationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConversationsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConversationsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
