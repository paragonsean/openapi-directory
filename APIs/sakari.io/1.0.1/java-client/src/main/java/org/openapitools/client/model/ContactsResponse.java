...
public class ContactsResponse {
  ...
  public ContactsResponse error(PaginatedResponseError error) {
    this.error = error;
    return this;
  }
  ...
  public ContactsResponse pagination(PaginatedResponsePagination pagination) {
  ...
  public ContactsResponse success(Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, contactsResponse.error) &&
        Objects.equals(this.pagination, contactsResponse.pagination) &&
        Objects.equals(this.success, contactsResponse.success) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
