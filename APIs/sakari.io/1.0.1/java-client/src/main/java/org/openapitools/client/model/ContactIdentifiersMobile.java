...
public class ContactIdentifiersMobile {
  ...
  public ContactIdentifiersMobile country(String country) {
  ...
  public ContactIdentifiersMobile number(String number) {
    this.number = number;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ContactIdentifiersMobile contactIdentifiersMobile = (ContactIdentifiersMobile) o;
    return Objects.equals(this.country, contactIdentifiersMobile.country) &&
        Objects.equals(this.number, contactIdentifiersMobile.number);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactIdentifiersMobile {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactIdentifiersMobile
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactIdentifiersMobile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactIdentifiersMobile is not found in the empty JSON string", ContactIdentifiersMobile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactIdentifiersMobile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactIdentifiersMobile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactIdentifiersMobile.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactIdentifiersMobile' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactIdentifiersMobile> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactIdentifiersMobile.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactIdentifiersMobile>() {
           @Override
           public void write(JsonWriter out, ContactIdentifiersMobile value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactIdentifiersMobile read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactIdentifiersMobile given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactIdentifiersMobile
   * @throws IOException if the JSON string is invalid with respect to ContactIdentifiersMobile
   */
  public static ContactIdentifiersMobile fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactIdentifiersMobile.class);
  }

  /**
   * Convert an instance of ContactIdentifiersMobile to an JSON string
   *
   * @return JSON string
   */
