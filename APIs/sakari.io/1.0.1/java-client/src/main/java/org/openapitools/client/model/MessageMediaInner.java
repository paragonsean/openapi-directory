...
public class MessageMediaInner {
  ...
  public MessageMediaInner() {
  }

  public MessageMediaInner filename(String filename) {
  ...
  public MessageMediaInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public MessageMediaInner url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MessageMediaInner messageMediaInner = (MessageMediaInner) o;
    return Objects.equals(this.filename, messageMediaInner.filename) &&
        Objects.equals(this.type, messageMediaInner.type) &&
        Objects.equals(this.url, messageMediaInner.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessageMediaInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageMediaInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageMediaInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageMediaInner is not found in the empty JSON string", MessageMediaInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageMediaInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageMediaInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageMediaInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageMediaInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageMediaInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageMediaInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageMediaInner>() {
           @Override
           public void write(JsonWriter out, MessageMediaInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageMediaInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageMediaInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageMediaInner
   * @throws IOException if the JSON string is invalid with respect to MessageMediaInner
   */
  public static MessageMediaInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageMediaInner.class);
  }

  /**
   * Convert an instance of MessageMediaInner to an JSON string
   *
   * @return JSON string
   */
