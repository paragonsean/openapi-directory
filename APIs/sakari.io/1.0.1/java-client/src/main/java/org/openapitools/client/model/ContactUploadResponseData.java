...
public class ContactUploadResponseData {
  ...
  private List<Contact> errors = new ArrayList<>();
  ...
  public ContactUploadResponseData contacts(List<Contact> contacts) {
    this.contacts = contacts;
    return this;
  }

  public ContactUploadResponseData addContactsItem(Contact contactsItem) {
  ...
  public ContactUploadResponseData errors(List<Contact> errors) {
    this.errors = errors;
    return this;
  }

  public ContactUploadResponseData addErrorsItem(Contact errorsItem) {
    if (this.errors == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<Contact> getErrors() {
    return errors;
  }

  public void setErrors(List<Contact> errors) {
    this.errors = errors;
  }


  public ContactUploadResponseData inserted(Integer inserted) {
  ...
  public ContactUploadResponseData submitted(Integer submitted) {
  ...
  public ContactUploadResponseData success(Integer success) {
  ...
  public ContactUploadResponseData updated(Integer updated) {
  ...
  public boolean equals(Object o) {
    ...
    ContactUploadResponseData contactUploadResponseData = (ContactUploadResponseData) o;
    return Objects.equals(this.contacts, contactUploadResponseData.contacts) &&
        Objects.equals(this.errors, contactUploadResponseData.errors) &&
        Objects.equals(this.inserted, contactUploadResponseData.inserted) &&
        Objects.equals(this.submitted, contactUploadResponseData.submitted) &&
        Objects.equals(this.success, contactUploadResponseData.success) &&
        Objects.equals(this.updated, contactUploadResponseData.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contacts, errors, inserted, submitted, success, updated);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ContactUploadResponseData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactUploadResponseData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactUploadResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactUploadResponseData is not found in the empty JSON string", ContactUploadResponseData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactUploadResponseData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactUploadResponseData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            Contact.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactUploadResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactUploadResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactUploadResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactUploadResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactUploadResponseData>() {
           @Override
           public void write(JsonWriter out, ContactUploadResponseData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactUploadResponseData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactUploadResponseData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactUploadResponseData
   * @throws IOException if the JSON string is invalid with respect to ContactUploadResponseData
   */
  public static ContactUploadResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactUploadResponseData.class);
  }

  /**
   * Convert an instance of ContactUploadResponseData to an JSON string
   *
   * @return JSON string
   */
