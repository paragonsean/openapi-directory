...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.CampaignsApi();
  });
  ...
  describe('CampaignsApi', function() {
    ...
    describe('campaignsFetch', function() {
      it('should call campaignsFetch successfully', function(done) {
        //uncomment below and update the code to test campaignsFetch
        //instance.campaignsFetch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('campaignsFetchAll', function() {
      it('should call campaignsFetchAll successfully', function(done) {
        //uncomment below and update the code to test campaignsFetchAll
        //instance.campaignsFetchAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('campaignsRemove', function() {
      it('should call campaignsRemove successfully', function(done) {
        //uncomment below and update the code to test campaignsRemove
        //instance.campaignsRemove(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
