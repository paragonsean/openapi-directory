...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.Sakari);
  }
}(this, function(expect, Sakari) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new Sakari.ConversationsApi();
  });
  ...
  describe('ConversationsApi', function() {
    ...
    describe('conversationsFetch', function() {
      it('should call conversationsFetch successfully', function(done) {
        //uncomment below and update the code to test conversationsFetch
        //instance.conversationsFetch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('conversationsFetchAll', function() {
      it('should call conversationsFetchAll successfully', function(done) {
        //uncomment below and update the code to test conversationsFetchAll
        //instance.conversationsFetchAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
