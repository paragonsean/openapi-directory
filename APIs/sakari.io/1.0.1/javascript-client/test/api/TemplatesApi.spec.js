...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.TemplatesApi();
  });
  ...
  describe('TemplatesApi', function() {
    describe('templatesCreate', function() {
      it('should call templatesCreate successfully', function(done) {
        //uncomment below and update the code to test templatesCreate
        //instance.templatesCreate(function(error) {
    ...
    describe('templatesFetch', function() {
      it('should call templatesFetch successfully', function(done) {
        //uncomment below and update the code to test templatesFetch
        //instance.templatesFetch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('templatesFetchAll', function() {
      it('should call templatesFetchAll successfully', function(done) {
        //uncomment below and update the code to test templatesFetchAll
        //instance.templatesFetchAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('templatesRemove', function() {
      it('should call templatesRemove successfully', function(done) {
        //uncomment below and update the code to test templatesRemove
        //instance.templatesRemove(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('templatesUpdate', function() {
      it('should call templatesUpdate successfully', function(done) {
        //uncomment below and update the code to test templatesUpdate
        //instance.templatesUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
