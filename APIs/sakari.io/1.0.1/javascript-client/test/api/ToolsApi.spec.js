...
(function(root, factory) {
  ...
  describe('ToolsApi', function() {
    describe('toolsShareFile', function() {
      it('should call toolsShareFile successfully', function(done) {
        //uncomment below and update the code to test toolsShareFile
        //instance.toolsShareFile(function(error) {
