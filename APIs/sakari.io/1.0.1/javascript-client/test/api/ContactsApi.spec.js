...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.ContactsApi();
  });
  ...
  describe('ContactsApi', function() {
    ...
    describe('contactsFetch', function() {
      it('should call contactsFetch successfully', function(done) {
        //uncomment below and update the code to test contactsFetch
        //instance.contactsFetch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('contactsFetchAll', function() {
      it('should call contactsFetchAll successfully', function(done) {
        //uncomment below and update the code to test contactsFetchAll
        //instance.contactsFetchAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('contactsRemove', function() {
      it('should call contactsRemove successfully', function(done) {
        //uncomment below and update the code to test contactsRemove
        //instance.contactsRemove(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
