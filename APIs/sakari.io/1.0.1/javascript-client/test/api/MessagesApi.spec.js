...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.MessagesApi();
  });
  ...
  describe('MessagesApi', function() {
    describe('messagesFetch', function() {
      it('should call messagesFetch successfully', function(done) {
        //uncomment below and update the code to test messagesFetch
        //instance.messagesFetch(function(error) {
    ...
    describe('messagesFetchAll', function() {
      it('should call messagesFetchAll successfully', function(done) {
        //uncomment below and update the code to test messagesFetchAll
        //instance.messagesFetchAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('messagesSend', function() {
      it('should call messagesSend successfully', function(done) {
        //uncomment below and update the code to test messagesSend
        //instance.messagesSend(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
