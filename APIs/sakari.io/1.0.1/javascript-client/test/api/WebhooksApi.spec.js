...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.WebhooksApi();
  });
  ...
  describe('WebhooksApi', function() {
    describe('webhooksFetchAll', function() {
      it('should call webhooksFetchAll successfully', function(done) {
        //uncomment below and update the code to test webhooksFetchAll
        //instance.webhooksFetchAll(function(error) {
    ...
    describe('webhooksSubscribe', function() {
      it('should call webhooksSubscribe successfully', function(done) {
        //uncomment below and update the code to test webhooksSubscribe
        //instance.webhooksSubscribe(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('webhooksUnsubscribe', function() {
      it('should call webhooksUnsubscribe successfully', function(done) {
        //uncomment below and update the code to test webhooksUnsubscribe
        //instance.webhooksUnsubscribe(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
