...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.ConversationsResponse();
  });
  ...
  describe('ConversationsResponse', function() {
    it('should create an instance of ConversationsResponse', function() {
      // uncomment below and update the code to test ConversationsResponse
      //var instance = new Sakari.ConversationsResponse();
      //expect(instance).to.be.a(Sakari.ConversationsResponse);
    });
