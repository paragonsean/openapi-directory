...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.CampaignRequestFilters();
  });
  ...
  describe('CampaignRequestFilters', function() {
    it('should create an instance of CampaignRequestFilters', function() {
      // uncomment below and update the code to test CampaignRequestFilters
      //var instance = new Sakari.CampaignRequestFilters();
      //expect(instance).to.be.a(Sakari.CampaignRequestFilters);
    });
