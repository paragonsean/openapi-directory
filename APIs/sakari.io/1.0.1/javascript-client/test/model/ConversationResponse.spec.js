...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.ConversationResponse();
  });
  ...
  describe('ConversationResponse', function() {
    it('should create an instance of ConversationResponse', function() {
      // uncomment below and update the code to test ConversationResponse
      //var instance = new Sakari.ConversationResponse();
      //expect(instance).to.be.a(Sakari.ConversationResponse);
    });
