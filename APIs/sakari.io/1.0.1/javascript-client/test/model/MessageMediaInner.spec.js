...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.MessageMediaInner();
  });
  ...
  describe('MessageMediaInner', function() {
    it('should create an instance of MessageMediaInner', function() {
      // uncomment below and update the code to test MessageMediaInner
      //var instance = new Sakari.MessageMediaInner();
      //expect(instance).to.be.a(Sakari.MessageMediaInner);
    });
