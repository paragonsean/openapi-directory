...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.MessageConversation();
  });
  ...
  describe('MessageConversation', function() {
    it('should create an instance of MessageConversation', function() {
      // uncomment below and update the code to test MessageConversation
      //var instance = new Sakari.MessageConversation();
      //expect(instance).to.be.a(Sakari.MessageConversation);
    });
