...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.ContactIdentifiers();
  });
  ...
  describe('ContactIdentifiers', function() {
    it('should create an instance of ContactIdentifiers', function() {
      // uncomment below and update the code to test ContactIdentifiers
      //var instance = new Sakari.ContactIdentifiers();
      //expect(instance).to.be.a(Sakari.ContactIdentifiers);
    });
