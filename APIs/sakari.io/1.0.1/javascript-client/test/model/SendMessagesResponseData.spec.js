...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.SendMessagesResponseData();
  });
  ...
  describe('SendMessagesResponseData', function() {
    it('should create an instance of SendMessagesResponseData', function() {
      // uncomment below and update the code to test SendMessagesResponseData
      //var instance = new Sakari.SendMessagesResponseData();
      //expect(instance).to.be.a(Sakari.SendMessagesResponseData);
    });

    it('should have the property estimatedPrice (base name: "estimatedPrice")', function() {
