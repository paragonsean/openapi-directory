...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.ShareFileResponse();
  });
  ...
  describe('ShareFileResponse', function() {
    it('should create an instance of ShareFileResponse', function() {
      // uncomment below and update the code to test ShareFileResponse
      //var instance = new Sakari.ShareFileResponse();
      //expect(instance).to.be.a(Sakari.ShareFileResponse);
    });
