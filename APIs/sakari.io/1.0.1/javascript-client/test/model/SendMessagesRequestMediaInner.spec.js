...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.SendMessagesRequestMediaInner();
  });
  ...
  describe('SendMessagesRequestMediaInner', function() {
    it('should create an instance of SendMessagesRequestMediaInner', function() {
      // uncomment below and update the code to test SendMessagesRequestMediaInner
      //var instance = new Sakari.SendMessagesRequestMediaInner();
      //expect(instance).to.be.a(Sakari.SendMessagesRequestMediaInner);
    });
