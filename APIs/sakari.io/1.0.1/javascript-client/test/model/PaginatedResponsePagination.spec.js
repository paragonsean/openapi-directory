...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.PaginatedResponsePagination();
  });
  ...
  describe('PaginatedResponsePagination', function() {
    it('should create an instance of PaginatedResponsePagination', function() {
      // uncomment below and update the code to test PaginatedResponsePagination
      //var instance = new Sakari.PaginatedResponsePagination();
      //expect(instance).to.be.a(Sakari.PaginatedResponsePagination);
    });
