...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.AccountEventPayload();
  });
  ...
  describe('AccountEventPayload', function() {
    it('should create an instance of AccountEventPayload', function() {
      // uncomment below and update the code to test AccountEventPayload
      //var instance = new Sakari.AccountEventPayload();
      //expect(instance).to.be.a(Sakari.AccountEventPayload);
    });
