...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.ShareFileResponseData();
  });
  ...
  describe('ShareFileResponseData', function() {
    it('should create an instance of ShareFileResponseData', function() {
      // uncomment below and update the code to test ShareFileResponseData
      //var instance = new Sakari.ShareFileResponseData();
      //expect(instance).to.be.a(Sakari.ShareFileResponseData);
    });
