...
(function(root, factory) {
  ...
  describe('UpdatedBy', function() {
    it('should create an instance of UpdatedBy', function() {
      // uncomment below and update the code to test UpdatedBy
      //var instance = new Sakari.UpdatedBy();
      //expect(instance).to.be.a(Sakari.UpdatedBy);
    });
