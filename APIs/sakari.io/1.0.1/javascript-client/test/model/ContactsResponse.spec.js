...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.ContactsResponse();
  });
  ...
  describe('ContactsResponse', function() {
    it('should create an instance of ContactsResponse', function() {
      // uncomment below and update the code to test ContactsResponse
      //var instance = new Sakari.ContactsResponse();
      //expect(instance).to.be.a(Sakari.ContactsResponse);
    });
