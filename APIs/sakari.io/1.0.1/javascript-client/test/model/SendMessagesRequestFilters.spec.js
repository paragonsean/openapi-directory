...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.SendMessagesRequestFilters();
  });
  ...
  describe('SendMessagesRequestFilters', function() {
    it('should create an instance of SendMessagesRequestFilters', function() {
      // uncomment below and update the code to test SendMessagesRequestFilters
      //var instance = new Sakari.SendMessagesRequestFilters();
      //expect(instance).to.be.a(Sakari.SendMessagesRequestFilters);
    });
