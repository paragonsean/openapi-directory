...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.PaginatedResponseError();
  });
  ...
  describe('PaginatedResponseError', function() {
    it('should create an instance of PaginatedResponseError', function() {
      // uncomment below and update the code to test PaginatedResponseError
      //var instance = new Sakari.PaginatedResponseError();
      //expect(instance).to.be.a(Sakari.PaginatedResponseError);
    });
