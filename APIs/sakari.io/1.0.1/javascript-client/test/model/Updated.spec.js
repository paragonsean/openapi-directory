...
(function(root, factory) {
  ...
  describe('Updated', function() {
    it('should create an instance of Updated', function() {
      // uncomment below and update the code to test Updated
      //var instance = new Sakari.Updated();
      //expect(instance).to.be.a(Sakari.Updated);
    });
