...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.ContactIdentifiersMobile();
  });
  ...
  describe('ContactIdentifiersMobile', function() {
    it('should create an instance of ContactIdentifiersMobile', function() {
      // uncomment below and update the code to test ContactIdentifiersMobile
      //var instance = new Sakari.ContactIdentifiersMobile();
      //expect(instance).to.be.a(Sakari.ContactIdentifiersMobile);
    });
