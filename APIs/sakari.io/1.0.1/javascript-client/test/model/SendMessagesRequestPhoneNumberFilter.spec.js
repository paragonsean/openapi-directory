...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.SendMessagesRequestPhoneNumberFilter();
  });
  ...
  describe('SendMessagesRequestPhoneNumberFilter', function() {
    it('should create an instance of SendMessagesRequestPhoneNumberFilter', function() {
      // uncomment below and update the code to test SendMessagesRequestPhoneNumberFilter
      //var instance = new Sakari.SendMessagesRequestPhoneNumberFilter();
      //expect(instance).to.be.a(Sakari.SendMessagesRequestPhoneNumberFilter);
    });
