...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.WebhooksSubscribeRequest();
  });
  ...
  describe('WebhooksSubscribeRequest', function() {
    it('should create an instance of WebhooksSubscribeRequest', function() {
      // uncomment below and update the code to test WebhooksSubscribeRequest
      //var instance = new Sakari.WebhooksSubscribeRequest();
      //expect(instance).to.be.a(Sakari.WebhooksSubscribeRequest);
    });
