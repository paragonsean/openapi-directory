...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.SendMessagesRequest();
  });
  ...
  describe('SendMessagesRequest', function() {
    it('should create an instance of SendMessagesRequest', function() {
      ...
      //var instance = new Sakari.SendMessagesRequest();
      //expect(instance).to.be.a(Sakari.SendMessagesRequest);
    });
    ...
    it('should have the property conversationStrategy (base name: "conversationStrategy")', function() {
      // uncomment below and update the code to test the property conversationStrategy
      //var instance = new Sakari.SendMessagesRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property phoneNumberFilter (base name: "phoneNumberFilter")', function() {
      // uncomment below and update the code to test the property phoneNumberFilter
      //var instance = new Sakari.SendMessagesRequest();
      //expect(instance).to.be();
    });
