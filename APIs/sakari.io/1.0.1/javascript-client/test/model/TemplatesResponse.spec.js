...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.TemplatesResponse();
  });
  ...
  describe('TemplatesResponse', function() {
    it('should create an instance of TemplatesResponse', function() {
      // uncomment below and update the code to test TemplatesResponse
      //var instance = new Sakari.TemplatesResponse();
      //expect(instance).to.be.a(Sakari.TemplatesResponse);
    });
