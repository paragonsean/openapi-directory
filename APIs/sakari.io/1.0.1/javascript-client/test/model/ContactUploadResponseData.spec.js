...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.ContactUploadResponseData();
  });
  ...
  describe('ContactUploadResponseData', function() {
    it('should create an instance of ContactUploadResponseData', function() {
      // uncomment below and update the code to test ContactUploadResponseData
      //var instance = new Sakari.ContactUploadResponseData();
      //expect(instance).to.be.a(Sakari.ContactUploadResponseData);
    });
    ...
    it('should have the property inserted (base name: "inserted")', function() {
      // uncomment below and update the code to test the property inserted
      //var instance = new Sakari.ContactUploadResponseData();
      //expect(instance).to.be();
    });
