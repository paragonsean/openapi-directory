...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.ContactUploadResponse();
  });
  ...
  describe('ContactUploadResponse', function() {
    it('should create an instance of ContactUploadResponse', function() {
      // uncomment below and update the code to test ContactUploadResponse
      //var instance = new Sakari.ContactUploadResponse();
      //expect(instance).to.be.a(Sakari.ContactUploadResponse);
    });
