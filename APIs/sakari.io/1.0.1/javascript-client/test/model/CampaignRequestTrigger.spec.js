...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.CampaignRequestTrigger();
  });
  ...
  describe('CampaignRequestTrigger', function() {
    it('should create an instance of CampaignRequestTrigger', function() {
      // uncomment below and update the code to test CampaignRequestTrigger
      //var instance = new Sakari.CampaignRequestTrigger();
      //expect(instance).to.be.a(Sakari.CampaignRequestTrigger);
    });
