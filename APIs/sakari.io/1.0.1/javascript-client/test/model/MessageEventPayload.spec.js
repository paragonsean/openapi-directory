...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sakari.MessageEventPayload();
  });
  ...
  describe('MessageEventPayload', function() {
    it('should create an instance of MessageEventPayload', function() {
      // uncomment below and update the code to test MessageEventPayload
      //var instance = new Sakari.MessageEventPayload();
      //expect(instance).to.be.a(Sakari.MessageEventPayload);
    });
