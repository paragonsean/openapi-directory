...
class MessagesResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>MessagesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessagesResponse</code>.
     */
 ...
 */
MessagesResponse.prototype['error'] = undefined;

/**
 * @member {module:model/PaginatedResponsePagination} pagination
 */
MessagesResponse.prototype['pagination'] = undefined;

/**
 * @member {Boolean} success
 */
MessagesResponse.prototype['success'] = undefined;
