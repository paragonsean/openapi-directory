...
/**
 * The ContactUploadResponse model module.
 * @module model/ContactUploadResponse
 * @version 1.0.1
 */
class ContactUploadResponse {
    /**
     * Constructs a new <code>ContactUploadResponse</code>.
     * @alias module:model/ContactUploadResponse
     */
    constructor() { 
        
        ContactUploadResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactUploadResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactUploadResponse} obj Optional instance to populate.
     * @return {module:model/ContactUploadResponse} The populated <code>ContactUploadResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactUploadResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ContactUploadResponseData.constructFromObject(data['data']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ContactUploadResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactUploadResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ContactUploadResponseData.validateJSON(data['data']);
        }
 ...
 */
ContactUploadResponse.prototype['data'] = undefined;

/**
 * @member {Boolean} success
 * @default true
 */
ContactUploadResponse.prototype['success'] = true;
...
export default ContactUploadResponse;
