...
import ShareFileResponseData from './ShareFileResponseData';

/**
 * The ShareFileResponse model module.
 * @module model/ShareFileResponse
 * @version 1.0.1
 */
class ShareFileResponse {
    /**
     * Constructs a new <code>ShareFileResponse</code>.
     * @alias module:model/ShareFileResponse
     */
    constructor() { 
        
        ShareFileResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ShareFileResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShareFileResponse} obj Optional instance to populate.
     * @return {module:model/ShareFileResponse} The populated <code>ShareFileResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShareFileResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ShareFileResponseData.constructFromObject(data['data']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ShareFileResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShareFileResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ShareFileResponseData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/ShareFileResponseData} data
 */
ShareFileResponse.prototype['data'] = undefined;

/**
 * @member {Boolean} success
 */
ShareFileResponse.prototype['success'] = undefined;
...
export default ShareFileResponse;
