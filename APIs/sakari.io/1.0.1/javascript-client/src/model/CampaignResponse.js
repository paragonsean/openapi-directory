...
class CampaignResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = Campaign.constructFromObject(data['data']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          Campaign.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/Campaign} data
 */
CampaignResponse.prototype['data'] = undefined;

/**
 * @member {Boolean} success
 */
CampaignResponse.prototype['success'] = undefined;
