...
/**
 * The AccountEventPayload model module.
 * @module model/AccountEventPayload
 * @version 1.0.1
 */
class AccountEventPayload {
    /**
     * Constructs a new <code>AccountEventPayload</code>.
     * @alias module:model/AccountEventPayload
     */
    constructor() { 
        
        AccountEventPayload.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountEventPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountEventPayload} obj Optional instance to populate.
     * @return {module:model/AccountEventPayload} The populated <code>AccountEventPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountEventPayload();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountEventPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountEventPayload</code>.
     */
 ...
 */
AccountEventPayload.prototype['balance'] = undefined;
...
export default AccountEventPayload;
