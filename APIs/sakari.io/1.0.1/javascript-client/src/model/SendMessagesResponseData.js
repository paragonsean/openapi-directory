...
/**
 * The SendMessagesResponseData model module.
 * @module model/SendMessagesResponseData
 * @version 1.0.1
 */
class SendMessagesResponseData {
    /**
     * Constructs a new <code>SendMessagesResponseData</code>.
     * @alias module:model/SendMessagesResponseData
     */
    constructor() { 
        
        SendMessagesResponseData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SendMessagesResponseData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SendMessagesResponseData} obj Optional instance to populate.
     * @return {module:model/SendMessagesResponseData} The populated <code>SendMessagesResponseData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendMessagesResponseData();

            if (data.hasOwnProperty('estimatedPrice')) {
                obj['estimatedPrice'] = ApiClient.convertToType(data['estimatedPrice'], 'Number');
            }
            if (data.hasOwnProperty('invalid')) {
                obj['invalid'] = ApiClient.convertToType(data['invalid'], [Contact]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SendMessagesResponseData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendMessagesResponseData</code>.
     */
...
/**
 * @member {Number} estimatedPrice
 */
SendMessagesResponseData.prototype['estimatedPrice'] = undefined;

/**
 * @member {Array.<module:model/Contact>} invalid
 */
SendMessagesResponseData.prototype['invalid'] = undefined;

/**
 * @member {String} jobId
 */
SendMessagesResponseData.prototype['jobId'] = undefined;

/**
 * @member {Array.<module:model/Message>} messages
 */
SendMessagesResponseData.prototype['messages'] = undefined;

/**
 * @member {Number} requested
 */
SendMessagesResponseData.prototype['requested'] = undefined;

/**
 * @member {Number} valid
 */
SendMessagesResponseData.prototype['valid'] = undefined;
...
export default SendMessagesResponseData;
