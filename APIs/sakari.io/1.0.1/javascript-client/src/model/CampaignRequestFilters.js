...
/**
 * The CampaignRequestFilters model module.
 * @module model/CampaignRequestFilters
 * @version 1.0.1
 */
class CampaignRequestFilters {
    /**
     * Constructs a new <code>CampaignRequestFilters</code>.
     * @alias module:model/CampaignRequestFilters
     */
    constructor() { 
        
        CampaignRequestFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CampaignRequestFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CampaignRequestFilters} obj Optional instance to populate.
     * @return {module:model/CampaignRequestFilters} The populated <code>CampaignRequestFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignRequestFilters();
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignRequestFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignRequestFilters</code>.
     */
 ...
 */
CampaignRequestFilters.prototype['attributes'] = undefined;

/**
 * @member {Array.<String>} contacts
 */
CampaignRequestFilters.prototype['contacts'] = undefined;

/**
 * @member {Array.<String>} tags
 */
CampaignRequestFilters.prototype['tags'] = undefined;
...
export default CampaignRequestFilters;
