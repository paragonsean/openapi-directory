...
/**
 * The WebhooksSubscribeRequest model module.
 * @module model/WebhooksSubscribeRequest
 * @version 1.0.1
 */
class WebhooksSubscribeRequest {
    /**
     * Constructs a new <code>WebhooksSubscribeRequest</code>.
     * @alias module:model/WebhooksSubscribeRequest
     */
    constructor() { 
        
        WebhooksSubscribeRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhooksSubscribeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksSubscribeRequest} obj Optional instance to populate.
     * @return {module:model/WebhooksSubscribeRequest} The populated <code>WebhooksSubscribeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksSubscribeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhooksSubscribeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhooksSubscribeRequest</code>.
     */
...
/**
 * @member {Array.<module:model/WebhooksSubscribeRequest.EventTypesEnum>} eventTypes
 */
WebhooksSubscribeRequest.prototype['eventTypes'] = undefined;

/**
 * @member {String} url
 */
WebhooksSubscribeRequest.prototype['url'] = undefined;
 ...
 * @readonly
 */
WebhooksSubscribeRequest['EventTypesEnum'] = {
     ...
     * @const
     */
    "list-opt-out": "list-opt-out",

    /**
     * value: "list-opt-in"
     * @const
     */
    "list-opt-in": "list-opt-in"
};



export default WebhooksSubscribeRequest;
