...
/**
 * The SendMessagesRequestMediaInner model module.
 * @module model/SendMessagesRequestMediaInner
 * @version 1.0.1
 */
class SendMessagesRequestMediaInner {
    /**
     * Constructs a new <code>SendMessagesRequestMediaInner</code>.
     * @alias module:model/SendMessagesRequestMediaInner
     */
    constructor() { 
        
        SendMessagesRequestMediaInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SendMessagesRequestMediaInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SendMessagesRequestMediaInner} obj Optional instance to populate.
     * @return {module:model/SendMessagesRequestMediaInner} The populated <code>SendMessagesRequestMediaInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendMessagesRequestMediaInner();
    ...
    /**
     * Validates the JSON data with respect to <code>SendMessagesRequestMediaInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendMessagesRequestMediaInner</code>.
     */
 ...
 * @member {String} url
 */
SendMessagesRequestMediaInner.prototype['url'] = undefined;
...
export default SendMessagesRequestMediaInner;
