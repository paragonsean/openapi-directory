...
/**
 * The SendMessagesRequestPhoneNumberFilter model module.
 * @module model/SendMessagesRequestPhoneNumberFilter
 * @version 1.0.1
 */
class SendMessagesRequestPhoneNumberFilter {
    /**
     * Constructs a new <code>SendMessagesRequestPhoneNumberFilter</code>.
     * @alias module:model/SendMessagesRequestPhoneNumberFilter
     */
    constructor() { 
        
        SendMessagesRequestPhoneNumberFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SendMessagesRequestPhoneNumberFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SendMessagesRequestPhoneNumberFilter} obj Optional instance to populate.
     * @return {module:model/SendMessagesRequestPhoneNumberFilter} The populated <code>SendMessagesRequestPhoneNumberFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendMessagesRequestPhoneNumberFilter();

            if (data.hasOwnProperty('group')) {
                obj['group'] = MessageConversation.constructFromObject(data['group']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SendMessagesRequestPhoneNumberFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendMessagesRequestPhoneNumberFilter</code>.
     */
    static validateJSON(data) {
        // validate the optional field `group`
        if (data['group']) { // data not null
          MessageConversation.validateJSON(data['group']);
        }
...
/**
 * @member {module:model/MessageConversation} group
 */
SendMessagesRequestPhoneNumberFilter.prototype['group'] = undefined;
...
export default SendMessagesRequestPhoneNumberFilter;
