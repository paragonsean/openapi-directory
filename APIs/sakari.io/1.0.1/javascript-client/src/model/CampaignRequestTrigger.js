...
/**
 * The CampaignRequestTrigger model module.
 * @module model/CampaignRequestTrigger
 * @version 1.0.1
 */
class CampaignRequestTrigger {
    /**
     * Constructs a new <code>CampaignRequestTrigger</code>.
     * @alias module:model/CampaignRequestTrigger
     */
    constructor() { 
        
        CampaignRequestTrigger.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CampaignRequestTrigger</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CampaignRequestTrigger} obj Optional instance to populate.
     * @return {module:model/CampaignRequestTrigger} The populated <code>CampaignRequestTrigger</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignRequestTrigger();
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignRequestTrigger</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignRequestTrigger</code>.
     */
 ...
 * @member {module:model/CampaignRequestTrigger.CodeEnum} code
 */
CampaignRequestTrigger.prototype['code'] = undefined;
 ...
 * @readonly
 */
CampaignRequestTrigger['CodeEnum'] = {
...
export default CampaignRequestTrigger;
