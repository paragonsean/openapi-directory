...
/**
 * The CampaignsRemove200Response model module.
 * @module model/CampaignsRemove200Response
 * @version 1.0.1
 */
class CampaignsRemove200Response {
    /**
     * Constructs a new <code>CampaignsRemove200Response</code>.
     * @alias module:model/CampaignsRemove200Response
     */
    constructor() { 
        
        CampaignsRemove200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CampaignsRemove200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CampaignsRemove200Response} obj Optional instance to populate.
     * @return {module:model/CampaignsRemove200Response} The populated <code>CampaignsRemove200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignsRemove200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignsRemove200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignsRemove200Response</code>.
     */
 ...
 */
CampaignsRemove200Response.prototype['success'] = undefined;
...
export default CampaignsRemove200Response;
