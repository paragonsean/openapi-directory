...
import SendMessagesResponseData from './SendMessagesResponseData';
...
class SendMessagesResponse {
    ...
    constructor() { 
        ...
        SendMessagesResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = SendMessagesResponseData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          SendMessagesResponseData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/SendMessagesResponseData} data
 */
SendMessagesResponse.prototype['data'] = undefined;
