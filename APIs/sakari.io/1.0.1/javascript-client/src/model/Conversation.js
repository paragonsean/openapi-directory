...
class Conversation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('lastMessage')) {
                obj['lastMessage'] = Message.constructFromObject(data['lastMessage']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['lastMessage']) { // data not null
          Message.validateJSON(data['lastMessage']);
        }
        ...
        if (!Array.isArray(data['unread'])) {
            throw new Error("Expected the field `unread` to be an array in the JSON data but got " + data['unread']);
        }
 ...
 */
Conversation.prototype['contact'] = undefined;

/**
 * @member {module:model/Updated} created
 */
Conversation.prototype['created'] = undefined;
...
/**
 * @member {module:model/Message} lastMessage
 */
Conversation.prototype['lastMessage'] = undefined;

/**
 * @member {module:model/PhoneNumber} phoneNumber
 */
Conversation.prototype['phoneNumber'] = undefined;

/**
 * @member {Array.<String>} unread
 */
 ...
 */
Conversation.prototype['updated'] = undefined;
