...
/**
 * The ContactIdentifiersMobile model module.
 * @module model/ContactIdentifiersMobile
 * @version 1.0.1
 */
class ContactIdentifiersMobile {
    /**
     * Constructs a new <code>ContactIdentifiersMobile</code>.
     * @alias module:model/ContactIdentifiersMobile
     */
    constructor() { 
        
        ContactIdentifiersMobile.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactIdentifiersMobile</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactIdentifiersMobile} obj Optional instance to populate.
     * @return {module:model/ContactIdentifiersMobile} The populated <code>ContactIdentifiersMobile</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactIdentifiersMobile();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactIdentifiersMobile</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactIdentifiersMobile</code>.
     */
 ...
 */
ContactIdentifiersMobile.prototype['country'] = undefined;

/**
 * @member {String} number
 */
ContactIdentifiersMobile.prototype['number'] = undefined;
...
export default ContactIdentifiersMobile;
