...
/**
 * The MessageMediaInner model module.
 * @module model/MessageMediaInner
 * @version 1.0.1
 */
class MessageMediaInner {
    /**
     * Constructs a new <code>MessageMediaInner</code>.
     * @alias module:model/MessageMediaInner
     */
    constructor() { 
        
        MessageMediaInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessageMediaInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageMediaInner} obj Optional instance to populate.
     * @return {module:model/MessageMediaInner} The populated <code>MessageMediaInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageMediaInner();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageMediaInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageMediaInner</code>.
     */
 ...
 */
MessageMediaInner.prototype['filename'] = undefined;

/**
 * @member {String} type
 */
MessageMediaInner.prototype['type'] = undefined;

/**
 * @member {String} url
 */
MessageMediaInner.prototype['url'] = undefined;
...
export default MessageMediaInner;
