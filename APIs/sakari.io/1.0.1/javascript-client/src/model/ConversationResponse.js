 ...
 * @module model/ConversationResponse
 * @version 1.0.1
 */
class ConversationResponse {
    /**
     * Constructs a new <code>ConversationResponse</code>.
     * @alias module:model/ConversationResponse
     */
    constructor() { 
     ...
     * @param {module:model/ConversationResponse} obj Optional instance to populate.
     * @return {module:model/ConversationResponse} The populated <code>ConversationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = Conversation.constructFromObject(data['data']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConversationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          Conversation.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/Conversation} data
 */
ConversationResponse.prototype['data'] = undefined;

/**
 * @member {Boolean} success
 */
ConversationResponse.prototype['success'] = undefined;
