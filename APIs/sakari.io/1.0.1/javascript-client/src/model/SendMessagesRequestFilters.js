...
/**
 * The SendMessagesRequestFilters model module.
 * @module model/SendMessagesRequestFilters
 * @version 1.0.1
 */
class SendMessagesRequestFilters {
    /**
     * Constructs a new <code>SendMessagesRequestFilters</code>.
     * @alias module:model/SendMessagesRequestFilters
     */
    constructor() { 
        
        SendMessagesRequestFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SendMessagesRequestFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SendMessagesRequestFilters} obj Optional instance to populate.
     * @return {module:model/SendMessagesRequestFilters} The populated <code>SendMessagesRequestFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SendMessagesRequestFilters();
    ...
    /**
     * Validates the JSON data with respect to <code>SendMessagesRequestFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SendMessagesRequestFilters</code>.
     */
 ...
 */
SendMessagesRequestFilters.prototype['attributes'] = undefined;

/**
 * @member {Array.<String>} tags
 */
SendMessagesRequestFilters.prototype['tags'] = undefined;
...
export default SendMessagesRequestFilters;
