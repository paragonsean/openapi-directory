...
class Template {
     ...
     * @implements module:model/TemplateRequest
     */
    constructor() { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            TemplateRequest.constructFromObject(data, obj);
...
// Implement TemplateRequest interface:
/**
 * @member {String} name
 */
TemplateRequest.prototype['name'] = undefined;
/**
 * @member {String} template
 */
TemplateRequest.prototype['template'] = undefined;
/**
 * @member {module:model/TemplateRequest.TypeEnum} type
 */
TemplateRequest.prototype['type'] = undefined;
