...
/**
 * The ContactUploadResponseData model module.
 * @module model/ContactUploadResponseData
 * @version 1.0.1
 */
class ContactUploadResponseData {
    /**
     * Constructs a new <code>ContactUploadResponseData</code>.
     * @alias module:model/ContactUploadResponseData
     */
    constructor() { 
        
        ContactUploadResponseData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactUploadResponseData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactUploadResponseData} obj Optional instance to populate.
     * @return {module:model/ContactUploadResponseData} The populated <code>ContactUploadResponseData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactUploadResponseData();

            if (data.hasOwnProperty('contacts')) {
                obj['contacts'] = ApiClient.convertToType(data['contacts'], [Contact]);
            }
            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [Contact]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ContactUploadResponseData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactUploadResponseData</code>.
     */
 ...
 */
ContactUploadResponseData.prototype['contacts'] = undefined;

/**
 * Contacts that failed validation
 * @member {Array.<module:model/Contact>} errors
 */
ContactUploadResponseData.prototype['errors'] = undefined;

/**
 * @member {Number} inserted
 */
ContactUploadResponseData.prototype['inserted'] = undefined;

/**
 * @member {Number} submitted
 */
ContactUploadResponseData.prototype['submitted'] = undefined;

/**
 * @member {Number} success
 */
ContactUploadResponseData.prototype['success'] = undefined;

/**
 * @member {Number} updated
 */
ContactUploadResponseData.prototype['updated'] = undefined;
...
export default ContactUploadResponseData;
