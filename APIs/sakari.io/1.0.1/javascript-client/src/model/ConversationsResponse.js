 ...
 * @module model/ConversationsResponse
 * @version 1.0.1
 */
class ConversationsResponse {
    /**
     * Constructs a new <code>ConversationsResponse</code>.
     * @alias module:model/ConversationsResponse
     ...
     * @param {module:model/ConversationsResponse} obj Optional instance to populate.
     * @return {module:model/ConversationsResponse} The populated <code>ConversationsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Conversation]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConversationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversationsResponse</code>.
     */
 ...
 */
ConversationsResponse.prototype['pagination'] = undefined;
...
/**
 * @member {Array.<module:model/Conversation>} data
 */
ConversationsResponse.prototype['data'] = undefined;
