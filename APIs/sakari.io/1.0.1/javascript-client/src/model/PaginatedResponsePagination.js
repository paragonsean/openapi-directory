...
/**
 * The PaginatedResponsePagination model module.
 * @module model/PaginatedResponsePagination
 * @version 1.0.1
 */
class PaginatedResponsePagination {
    /**
     * Constructs a new <code>PaginatedResponsePagination</code>.
     * @alias module:model/PaginatedResponsePagination
     */
    constructor() { 
        
        PaginatedResponsePagination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaginatedResponsePagination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaginatedResponsePagination} obj Optional instance to populate.
     * @return {module:model/PaginatedResponsePagination} The populated <code>PaginatedResponsePagination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaginatedResponsePagination();
    ...
    /**
     * Validates the JSON data with respect to <code>PaginatedResponsePagination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginatedResponsePagination</code>.
     */
 ...
 * @member {Number} limit
 */
PaginatedResponsePagination.prototype['limit'] = undefined;

/**
 * @member {Number} offset
 */
PaginatedResponsePagination.prototype['offset'] = undefined;

/**
 * @member {Number} totalCount
 */
PaginatedResponsePagination.prototype['totalCount'] = undefined;
...
export default PaginatedResponsePagination;
