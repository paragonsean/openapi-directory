...
/**
 * The MessageEventPayload model module.
 * @module model/MessageEventPayload
 * @version 1.0.1
 */
class MessageEventPayload {
    /**
     * Constructs a new <code>MessageEventPayload</code>.
     * @alias module:model/MessageEventPayload
     */
    constructor() { 
        
        MessageEventPayload.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessageEventPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageEventPayload} obj Optional instance to populate.
     * @return {module:model/MessageEventPayload} The populated <code>MessageEventPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageEventPayload();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageEventPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageEventPayload</code>.
     */
 ...
 */
MessageEventPayload.prototype['contact'] = undefined;

/**
 * @member {String} error
 */
MessageEventPayload.prototype['error'] = undefined;

/**
 * @member {String} message
 */
MessageEventPayload.prototype['message'] = undefined;

/**
 * @member {String} status
 */
MessageEventPayload.prototype['status'] = undefined;
...
export default MessageEventPayload;
