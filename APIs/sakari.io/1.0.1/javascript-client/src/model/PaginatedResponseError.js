...
/**
 * The PaginatedResponseError model module.
 * @module model/PaginatedResponseError
 * @version 1.0.1
 */
class PaginatedResponseError {
    /**
     * Constructs a new <code>PaginatedResponseError</code>.
     * @alias module:model/PaginatedResponseError
     */
    constructor() { 
        
        PaginatedResponseError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaginatedResponseError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaginatedResponseError} obj Optional instance to populate.
     * @return {module:model/PaginatedResponseError} The populated <code>PaginatedResponseError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaginatedResponseError();
    ...
    /**
     * Validates the JSON data with respect to <code>PaginatedResponseError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginatedResponseError</code>.
     */
 ...
 * @member {String} code
 */
PaginatedResponseError.prototype['code'] = undefined;

/**
 * @member {String} message
 */
PaginatedResponseError.prototype['message'] = undefined;
...
export default PaginatedResponseError;
