...
/**
 * The Updated model module.
 * @module model/Updated
 * @version 1.0.1
 */
class Updated {
    /**
     * Constructs a new <code>Updated</code>.
     * @alias module:model/Updated
     */
    constructor() { 
        
        Updated.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Updated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Updated} obj Optional instance to populate.
     * @return {module:model/Updated} The populated <code>Updated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('by')) {
                obj['by'] = UpdatedBy.constructFromObject(data['by']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Updated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Updated</code>.
     */
    static validateJSON(data) {
        // validate the optional field `by`
        if (data['by']) { // data not null
          UpdatedBy.validateJSON(data['by']);
        }
 ...
 * @member {Date} at
 */
Updated.prototype['at'] = undefined;

/**
 * @member {module:model/UpdatedBy} by
 */
Updated.prototype['by'] = undefined;
