...
/**
 * The ShareFileResponseData model module.
 * @module model/ShareFileResponseData
 * @version 1.0.1
 */
class ShareFileResponseData {
    /**
     * Constructs a new <code>ShareFileResponseData</code>.
     * @alias module:model/ShareFileResponseData
     */
    constructor() { 
        
        ShareFileResponseData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ShareFileResponseData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShareFileResponseData} obj Optional instance to populate.
     * @return {module:model/ShareFileResponseData} The populated <code>ShareFileResponseData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShareFileResponseData();
    ...
    /**
     * Validates the JSON data with respect to <code>ShareFileResponseData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShareFileResponseData</code>.
     */
 ...
 * @member {Date} expires
 */
ShareFileResponseData.prototype['expires'] = undefined;

/**
 * @member {String} link
 */
ShareFileResponseData.prototype['link'] = undefined;
...
export default ShareFileResponseData;
