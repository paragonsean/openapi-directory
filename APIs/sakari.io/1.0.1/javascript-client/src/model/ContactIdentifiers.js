...
/**
 * The ContactIdentifiers model module.
 * @module model/ContactIdentifiers
 * @version 1.0.1
 */
class ContactIdentifiers {
    /**
     * Constructs a new <code>ContactIdentifiers</code>.
     * @alias module:model/ContactIdentifiers
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ContactIdentifiers</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactIdentifiers} obj Optional instance to populate.
     * @return {module:model/ContactIdentifiers} The populated <code>ContactIdentifiers</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactIdentifiers();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactIdentifiers</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactIdentifiers</code>.
     */
...
export default ContactIdentifiers;
