...
/**
 * The UpdatedBy model module.
 * @module model/UpdatedBy
 * @version 1.0.1
 */
class UpdatedBy {
    /**
     * Constructs a new <code>UpdatedBy</code>.
     * @alias module:model/UpdatedBy
     */
    constructor() { 
        
        UpdatedBy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatedBy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatedBy} obj Optional instance to populate.
     * @return {module:model/UpdatedBy} The populated <code>UpdatedBy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatedBy();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatedBy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatedBy</code>.
     */
 ...
 */
UpdatedBy.prototype['firstName'] = undefined;

/**
 * @member {String} id
 */
UpdatedBy.prototype['id'] = undefined;

/**
 * @member {String} lastName
 */
UpdatedBy.prototype['lastName'] = undefined;
