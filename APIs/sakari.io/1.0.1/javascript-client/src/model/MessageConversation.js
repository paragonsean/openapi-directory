...
/**
 * The MessageConversation model module.
 * @module model/MessageConversation
 * @version 1.0.1
 */
class MessageConversation {
    /**
     * Constructs a new <code>MessageConversation</code>.
     * @alias module:model/MessageConversation
     */
    constructor() { 
        
        MessageConversation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessageConversation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageConversation} obj Optional instance to populate.
     * @return {module:model/MessageConversation} The populated <code>MessageConversation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageConversation();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageConversation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageConversation</code>.
     */
 ...
 * @member {String} id
 */
MessageConversation.prototype['id'] = undefined;
