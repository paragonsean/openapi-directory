...
import AccountEventPayload from './AccountEventPayload';
import ContactIdentifiers from './ContactIdentifiers';
import MessageEventPayload from './MessageEventPayload';
...
class EventData {
     ...
     * @param {(module:model/AccountEventPayload|module:model/MessageEventPayload)} instance The actual instance to initialize EventData.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "AccountEventPayload") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                AccountEventPayload.validateJSON(instance); // throw an exception if no match
                // create AccountEventPayload from JS object
                this.actualInstance = AccountEventPayload.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into AccountEventPayload
            errorMessages.push("Failed to construct AccountEventPayload: " + err)
        }

        try {
            if (typeof instance === "MessageEventPayload") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                MessageEventPayload.validateJSON(instance); // throw an exception if no match
                // create MessageEventPayload from JS object
                this.actualInstance = MessageEventPayload.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into MessageEventPayload
            errorMessages.push("Failed to construct MessageEventPayload: " + err)
        }

        if (match > 1) {
            throw new Error("Multiple matches found constructing `EventData` with oneOf schemas AccountEventPayload, MessageEventPayload. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `EventData` with oneOf schemas AccountEventPayload, MessageEventPayload. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Gets the actual instance, which can be <code>AccountEventPayload</code>, <code>MessageEventPayload</code>.
     * @return {(module:model/AccountEventPayload|module:model/MessageEventPayload)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>AccountEventPayload</code>, <code>MessageEventPayload</code>.
     * @param {(module:model/AccountEventPayload|module:model/MessageEventPayload)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = EventData.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/EventData} An instance of EventData.
     */
    static fromJSON = function(json_string){
        return EventData.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
EventData.prototype['balance'] = undefined;

/**
 * @member {module:model/ContactIdentifiers} contact
 */
EventData.prototype['contact'] = undefined;

/**
 * @member {String} error
 */
EventData.prototype['error'] = undefined;

/**
 * @member {String} message
 */
EventData.prototype['message'] = undefined;
...
EventData.OneOf = ["AccountEventPayload", "MessageEventPayload"];
