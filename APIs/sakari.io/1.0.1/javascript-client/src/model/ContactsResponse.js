...
/**
 * The ContactsResponse model module.
 * @module model/ContactsResponse
 * @version 1.0.1
 */
class ContactsResponse {
    /**
     * Constructs a new <code>ContactsResponse</code>.
     * @alias module:model/ContactsResponse
     * @implements module:model/PaginatedResponse
     */
    constructor() { 
        PaginatedResponse.initialize(this);
        ContactsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContactsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactsResponse} obj Optional instance to populate.
     * @return {module:model/ContactsResponse} The populated <code>ContactsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactsResponse</code>.
     */
 ...
 */
ContactsResponse.prototype['error'] = undefined;

/**
 * @member {module:model/PaginatedResponsePagination} pagination
 */
ContactsResponse.prototype['pagination'] = undefined;

/**
 * @member {Boolean} success
 */
ContactsResponse.prototype['success'] = undefined;

/**
 * @member {Array.<module:model/Contact>} data
 */
ContactsResponse.prototype['data'] = undefined;
