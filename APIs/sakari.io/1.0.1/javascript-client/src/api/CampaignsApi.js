...
export default class CampaignsApi {
    ...
    */
     ...
     * @param {module:model/CampaignRequest} [campaignRequest] 
     ...
     */
    campaignsCreate(accountId, opts, callback) {
      opts = opts || {};
      let postBody = opts['campaignRequest'];
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling campaignsCreate");
      }
      ...
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/campaigns', 'POST',
    ...
    /**
     * Callback function to receive the result of the campaignsFetch operation.
     * @callback module:api/CampaignsApi~campaignsFetchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CampaignResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CampaignsApi~campaignsFetchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CampaignResponse}
     */
    campaignsFetch(accountId, campaignId, callback) {
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling campaignsFetch");
      }
      // verify the required parameter 'campaignId' is set
      if (campaignId === undefined || campaignId === null) {
        throw new Error("Missing the required parameter 'campaignId' when calling campaignsFetch");
      }
      ...
      let returnType = CampaignResponse;
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/campaigns/{campaignId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the campaignsFetchAll operation.
     * @callback module:api/CampaignsApi~campaignsFetchAllCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CampaignsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CampaignsApi~campaignsFetchAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CampaignsResponse}
     */
    campaignsFetchAll(accountId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling campaignsFetchAll");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CampaignsResponse;
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/campaigns', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the campaignsRemove operation.
     * @callback module:api/CampaignsApi~campaignsRemoveCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/CampaignsApi~campaignsRemoveCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CampaignsRemove200Response}
     */
    campaignsRemove(accountId, campaignId, callback) {
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling campaignsRemove");
      }
      // verify the required parameter 'campaignId' is set
      if (campaignId === undefined || campaignId === null) {
        throw new Error("Missing the required parameter 'campaignId' when calling campaignsRemove");
      }
      ...
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/campaigns/{campaignId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/CampaignResponse}
     */
    campaignsUpdate(accountId, campaignId, callback) {
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling campaignsUpdate");
      }
      // verify the required parameter 'campaignId' is set
      if (campaignId === undefined || campaignId === null) {
        throw new Error("Missing the required parameter 'campaignId' when calling campaignsUpdate");
      }
      ...
      let returnType = CampaignResponse;
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/campaigns/{campaignId}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
