...
export default class ContactsApi {
    ...
    */
     ...
     * @param {module:model/ContactsCreate201Response} data The data returned by the service call.
     ...
     * @param {module:model/String} [mergeStrategy] Determines how existing contacts with matching mobile numbers are treated
     * @param {module:model/ContactRequest} [contactRequest] 
     ...
     * data is of type: {@link module:model/ContactsCreate201Response}
     */
    contactsCreate(accountId, opts, callback) {
      opts = opts || {};
      let postBody = opts['contactRequest'];
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling contactsCreate");
      }
      ...
      let contentTypes = ['application/json', 'text/csv'];
      let accepts = ['application/json'];
      let returnType = ContactsCreate201Response;
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/contacts', 'POST',
    ...
    /**
     * Callback function to receive the result of the contactsFetch operation.
     * @callback module:api/ContactsApi~contactsFetchCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ContactsApi~contactsFetchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ContactResponse}
     */
    contactsFetch(accountId, contactId, callback) {
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling contactsFetch");
      }
      // verify the required parameter 'contactId' is set
      if (contactId === undefined || contactId === null) {
        throw new Error("Missing the required parameter 'contactId' when calling contactsFetch");
      }
      ...
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/contacts/{contactId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the contactsFetchAll operation.
     * @callback module:api/ContactsApi~contactsFetchAllCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ContactsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ContactsApi~contactsFetchAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ContactsResponse}
     */
    contactsFetchAll(accountId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling contactsFetchAll");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ContactsResponse;
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/contacts', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the contactsRemove operation.
     * @callback module:api/ContactsApi~contactsRemoveCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ContactsApi~contactsRemoveCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CampaignsRemove200Response}
     */
    contactsRemove(accountId, contactId, callback) {
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling contactsRemove");
      }
      // verify the required parameter 'contactId' is set
      if (contactId === undefined || contactId === null) {
        throw new Error("Missing the required parameter 'contactId' when calling contactsRemove");
      }
      ...
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/contacts/{contactId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/ContactResponse}
     */
    contactsUpdate(accountId, contactId, callback) {
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling contactsUpdate");
      }
      // verify the required parameter 'contactId' is set
      if (contactId === undefined || contactId === null) {
        throw new Error("Missing the required parameter 'contactId' when calling contactsUpdate");
      }
      ...
      let returnType = ContactResponse;
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/contacts/{contactId}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
