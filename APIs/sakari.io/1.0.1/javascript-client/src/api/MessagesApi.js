...
export default class MessagesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the messagesFetch operation.
     * @callback module:api/MessagesApi~messagesFetchCallback
     ...
     * @param {module:api/MessagesApi~messagesFetchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MessageResponse}
     */
    messagesFetch(accountId, messageId, callback) {
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling messagesFetch");
      }
      // verify the required parameter 'messageId' is set
      if (messageId === undefined || messageId === null) {
        throw new Error("Missing the required parameter 'messageId' when calling messagesFetch");
      }
      ...
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/messages/{messageId}', 'GET',
    ...
    /**
     * Callback function to receive the result of the messagesFetchAll operation.
     * @callback module:api/MessagesApi~messagesFetchAllCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MessagesApi~messagesFetchAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MessagesResponse}
     */
    messagesFetchAll(accountId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling messagesFetchAll");
      }
    ...
    /**
     * Callback function to receive the result of the messagesSend operation.
     * @callback module:api/MessagesApi~messagesSendCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MessagesApi~messagesSendCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SendMessagesResponse}
     */
    messagesSend(accountId, opts, callback) {
      opts = opts || {};
      let postBody = opts['sendMessagesRequest'];
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling messagesSend");
      }
      ...
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/messages', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
