...
export default class ConversationsApi {
    ...
    */
     ...
     * @param {module:model/ConversationResponse} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/ConversationResponse}
     */
    conversationsClose(accountId, conversationId, callback) {
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling conversationsClose");
      }
      // verify the required parameter 'conversationId' is set
      if (conversationId === undefined || conversationId === null) {
        throw new Error("Missing the required parameter 'conversationId' when calling conversationsClose");
      }
      ...
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/conversations/{conversationId}/close', 'PUT',
    ...
    /**
     * Callback function to receive the result of the conversationsFetch operation.
     * @callback module:api/ConversationsApi~conversationsFetchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ConversationResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ConversationsApi~conversationsFetchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ConversationResponse}
     */
    conversationsFetch(accountId, conversationId, callback) {
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling conversationsFetch");
      }
      // verify the required parameter 'conversationId' is set
      if (conversationId === undefined || conversationId === null) {
        throw new Error("Missing the required parameter 'conversationId' when calling conversationsFetch");
      }
      ...
      let returnType = ConversationResponse;
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/conversations/{conversationId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the conversationsFetchAll operation.
     * @callback module:api/ConversationsApi~conversationsFetchAllCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ConversationsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ConversationsApi~conversationsFetchAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ConversationsResponse}
     */
    conversationsFetchAll(accountId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling conversationsFetchAll");
      }
      ...
      return this.apiClient.callApi(
        '/v1/accounts/{accountId}/conversations', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
