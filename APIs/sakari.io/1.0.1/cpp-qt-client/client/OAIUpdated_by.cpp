...
OAIUpdated_by::OAIUpdated_by(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdated_by::OAIUpdated_by() {
    this->initializeModel();
}

OAIUpdated_by::~OAIUpdated_by() {}

void OAIUpdated_by::initializeModel() {
...
void OAIUpdated_by::fromJson(QString jsonString) {
...
void OAIUpdated_by::fromJsonObject(QJsonObject json) {
...
QString OAIUpdated_by::asJson() const {
...
QJsonObject OAIUpdated_by::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdated_by::getFirstName() const {
    return m_first_name;
}
void OAIUpdated_by::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIUpdated_by::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIUpdated_by::is_first_name_Valid() const{
    return m_first_name_isValid;
}

QString OAIUpdated_by::getId() const {
    return m_id;
}
void OAIUpdated_by::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUpdated_by::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUpdated_by::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIUpdated_by::getLastName() const {
    return m_last_name;
}
void OAIUpdated_by::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIUpdated_by::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIUpdated_by::is_last_name_Valid() const{
    return m_last_name_isValid;
}

bool OAIUpdated_by::isSet() const {
...
bool OAIUpdated_by::isValid() const {
