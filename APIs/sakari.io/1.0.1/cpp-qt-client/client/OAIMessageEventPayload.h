...
/*
 * OAIMessageEventPayload.h
 *
 * 
 */

#ifndef OAIMessageEventPayload_H
#define OAIMessageEventPayload_H
...
class OAIMessageEventPayload : public OAIObject {
public:
    OAIMessageEventPayload();
    OAIMessageEventPayload(QString json);
    ~OAIMessageEventPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageEventPayload)

#endif // OAIMessageEventPayload_H
