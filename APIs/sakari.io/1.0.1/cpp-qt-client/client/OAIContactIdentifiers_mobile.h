...
/*
 * OAIContactIdentifiers_mobile.h
 *
 * 
 */

#ifndef OAIContactIdentifiers_mobile_H
#define OAIContactIdentifiers_mobile_H
...
class OAIContactIdentifiers_mobile : public OAIObject {
public:
    OAIContactIdentifiers_mobile();
    OAIContactIdentifiers_mobile(QString json);
    ~OAIContactIdentifiers_mobile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactIdentifiers_mobile)

#endif // OAIContactIdentifiers_mobile_H
