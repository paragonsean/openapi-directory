...
#include "OAIAccountEventPayload.h"
...
OAIAccountEventPayload::OAIAccountEventPayload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountEventPayload::OAIAccountEventPayload() {
    this->initializeModel();
}

OAIAccountEventPayload::~OAIAccountEventPayload() {}

void OAIAccountEventPayload::initializeModel() {

    m_balance_isSet = false;
    m_balance_isValid = false;
}

void OAIAccountEventPayload::fromJson(QString jsonString) {
...
void OAIAccountEventPayload::fromJsonObject(QJsonObject json) {

    m_balance_isValid = ::OpenAPI::fromJsonValue(m_balance, json[QString("balance")]);
    m_balance_isSet = !json[QString("balance")].isNull() && m_balance_isValid;
}

QString OAIAccountEventPayload::asJson() const {
...
QJsonObject OAIAccountEventPayload::asJsonObject() const {
    QJsonObject obj;
    if (m_balance_isSet) {
...
double OAIAccountEventPayload::getBalance() const {
    return m_balance;
}
void OAIAccountEventPayload::setBalance(const double &balance) {
    m_balance = balance;
    m_balance_isSet = true;
}

bool OAIAccountEventPayload::is_balance_Set() const{
    return m_balance_isSet;
}

bool OAIAccountEventPayload::is_balance_Valid() const{
    return m_balance_isValid;
}

bool OAIAccountEventPayload::isSet() const {
...
bool OAIAccountEventPayload::isValid() const {
