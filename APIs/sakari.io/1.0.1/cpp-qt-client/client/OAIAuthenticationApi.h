...
public:
    ...
    /**
    * @param[in]  oai_token_request OAITokenRequest [optional]
    */
    virtual void auth_token(const ::OpenAPI::OptionalParam<OAITokenRequest> &oai_token_request = ::OpenAPI::OptionalParam<OAITokenRequest>());
...
private:
    ...
    void auth_tokenCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void auth_tokenSignal(OAITokenResponse summary);


    void auth_tokenSignalFull(OAIHttpRequestWorker *worker, OAITokenResponse summary);

    Q_DECL_DEPRECATED_X("Use auth_tokenSignalError() instead")
    void auth_tokenSignalE(OAITokenResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void auth_tokenSignalError(OAITokenResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use auth_tokenSignalErrorFull() instead")
    void auth_tokenSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void auth_tokenSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
