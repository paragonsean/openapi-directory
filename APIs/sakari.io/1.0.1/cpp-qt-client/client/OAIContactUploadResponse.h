...
/*
 * OAIContactUploadResponse.h
 *
 * 
 */

#ifndef OAIContactUploadResponse_H
#define OAIContactUploadResponse_H
...
class OAIContactUploadResponse : public OAIObject {
public:
    OAIContactUploadResponse();
    OAIContactUploadResponse(QString json);
    ~OAIContactUploadResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactUploadResponse)

#endif // OAIContactUploadResponse_H
