...
/*
 * OAICampaignRequest_filters.h
 *
 * 
 */

#ifndef OAICampaignRequest_filters_H
#define OAICampaignRequest_filters_H
...
class OAICampaignRequest_filters : public OAIObject {
public:
    OAICampaignRequest_filters();
    OAICampaignRequest_filters(QString json);
    ~OAICampaignRequest_filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaignRequest_filters)

#endif // OAICampaignRequest_filters_H
