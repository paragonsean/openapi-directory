...
OAITemplate OAITemplateResponse::getData() const {
    return m_data;
}
void OAITemplateResponse::setData(const OAITemplate &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAITemplateResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAITemplateResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAITemplateResponse::isSuccess() const {
    return m_success;
}
void OAITemplateResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAITemplateResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAITemplateResponse::is_success_Valid() const{
