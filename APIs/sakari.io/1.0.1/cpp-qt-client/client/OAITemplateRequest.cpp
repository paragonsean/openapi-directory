...
QString OAITemplateRequest::getName() const {
    return m_name;
}
void OAITemplateRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITemplateRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAITemplateRequest::is_name_Valid() const{
...
QString OAITemplateRequest::getType() const {
    return m_type;
}
void OAITemplateRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAITemplateRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAITemplateRequest::is_type_Valid() const{
