...
OAIMessagesResponse::OAIMessagesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMessagesResponse::OAIMessagesResponse() {
    this->initializeModel();
}

OAIMessagesResponse::~OAIMessagesResponse() {}

void OAIMessagesResponse::initializeModel() {
...
void OAIMessagesResponse::fromJson(QString jsonString) {
...
void OAIMessagesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIMessagesResponse::asJson() const {
...
QJsonObject OAIMessagesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_error.isSet()) {
...
OAIPaginatedResponse_error OAIMessagesResponse::getError() const {
    return m_error;
}
void OAIMessagesResponse::setError(const OAIPaginatedResponse_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIMessagesResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAIMessagesResponse::is_error_Valid() const{
    return m_error_isValid;
}

OAIPaginatedResponse_pagination OAIMessagesResponse::getPagination() const {
    return m_pagination;
}
void OAIMessagesResponse::setPagination(const OAIPaginatedResponse_pagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIMessagesResponse::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIMessagesResponse::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAIMessagesResponse::isSuccess() const {
    return m_success;
}
void OAIMessagesResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIMessagesResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIMessagesResponse::is_success_Valid() const{
    return m_success_isValid;
}

QList<OAIMessage> OAIMessagesResponse::getData() const {
    return m_data;
}
void OAIMessagesResponse::setData(const QList<OAIMessage> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMessagesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMessagesResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIMessagesResponse::isSet() const {
...
bool OAIMessagesResponse::isValid() const {
