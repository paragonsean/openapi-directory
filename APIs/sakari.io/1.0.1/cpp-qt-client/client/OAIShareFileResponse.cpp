...
OAIShareFileResponse::OAIShareFileResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIShareFileResponse::OAIShareFileResponse() {
    this->initializeModel();
}

OAIShareFileResponse::~OAIShareFileResponse() {}

void OAIShareFileResponse::initializeModel() {
...
void OAIShareFileResponse::fromJson(QString jsonString) {
...
void OAIShareFileResponse::fromJsonObject(QJsonObject json) {
...
QString OAIShareFileResponse::asJson() const {
...
QJsonObject OAIShareFileResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIShareFileResponse_data OAIShareFileResponse::getData() const {
    return m_data;
}
void OAIShareFileResponse::setData(const OAIShareFileResponse_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIShareFileResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIShareFileResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIShareFileResponse::isSuccess() const {
    return m_success;
}
void OAIShareFileResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIShareFileResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIShareFileResponse::is_success_Valid() const{
    return m_success_isValid;
}

bool OAIShareFileResponse::isSet() const {
...
bool OAIShareFileResponse::isValid() const {
