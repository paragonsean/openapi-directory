...
/*
 * OAIPaginatedResponse_pagination.h
 *
 * 
 */

#ifndef OAIPaginatedResponse_pagination_H
#define OAIPaginatedResponse_pagination_H
...
class OAIPaginatedResponse_pagination : public OAIObject {
public:
    OAIPaginatedResponse_pagination();
    OAIPaginatedResponse_pagination(QString json);
    ~OAIPaginatedResponse_pagination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaginatedResponse_pagination)

#endif // OAIPaginatedResponse_pagination_H
