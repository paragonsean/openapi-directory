...
OAICampaign OAICampaignResponse::getData() const {
    return m_data;
}
void OAICampaignResponse::setData(const OAICampaign &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICampaignResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAICampaignResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAICampaignResponse::isSuccess() const {
    return m_success;
}
void OAICampaignResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAICampaignResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAICampaignResponse::is_success_Valid() const{
