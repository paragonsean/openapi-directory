...
void OAIMessagesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("messages_fetch", defaultConf);
    _serverIndices.insert("messages_fetch", 0);
    _serverConfigs.insert("messages_fetchAll", defaultConf);
    _serverIndices.insert("messages_fetchAll", 0);
    _serverConfigs.insert("messages_send", defaultConf);
    _serverIndices.insert("messages_send", 0);
}
...
void OAIMessagesApi::messages_fetch(const QString &account_id, const QString &message_id) {
    QString fullPath = QString(_serverConfigs["messages_fetch"][_serverIndices.value("messages_fetch")].URL()+"/v1/accounts/{accountId}/messages/{messageId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMessagesApi::messages_fetchCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMessagesApi::messages_fetchCallback);
...
void OAIMessagesApi::messages_fetchCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT messages_fetchSignal(output);
        Q_EMIT messages_fetchSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT messages_fetchSignalE(output, error_type, error_str);
        Q_EMIT messages_fetchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT messages_fetchSignalError(output, error_type, error_str);
        Q_EMIT messages_fetchSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMessagesApi::messages_fetchAll(const QString &account_id, const ::OpenAPI::OptionalParam<qint64> &offset, const ::OpenAPI::OptionalParam<qint64> &limit, const ::OpenAPI::OptionalParam<QString> &contact_id, const ::OpenAPI::OptionalParam<QString> &conversation_id) {
    QString fullPath = QString(_serverConfigs["messages_fetchAll"][_serverIndices.value("messages_fetchAll")].URL()+"/v1/accounts/{accountId}/messages");
    ...
    if (contact_id.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("contactId")).append(querySuffix).append(QUrl::toPercentEncoding(contact_id.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMessagesApi::messages_fetchAllCallback);
    connect(this, &OAIMessagesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMessagesApi::messages_fetchAllCallback);
    connect(this, &OAIMessagesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMessagesApi::messages_fetchAllCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIMessagesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT messages_fetchAllSignal(output);
        Q_EMIT messages_fetchAllSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT messages_fetchAllSignalE(output, error_type, error_str);
        Q_EMIT messages_fetchAllSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT messages_fetchAllSignalError(output, error_type, error_str);
        Q_EMIT messages_fetchAllSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMessagesApi::messages_send(const QString &account_id, const ::OpenAPI::OptionalParam<OAISendMessagesRequest> &oai_send_messages_request) {
    QString fullPath = QString(_serverConfigs["messages_send"][_serverIndices.value("messages_send")].URL()+"/v1/accounts/{accountId}/messages");
    ...
    if (oai_send_messages_request.hasValue()){

        
        QByteArray output = oai_send_messages_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMessagesApi::messages_sendCallback);
    connect(this, &OAIMessagesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMessagesApi::messages_sendCallback);
    connect(this, &OAIMessagesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMessagesApi::messages_sendCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT messages_sendSignal(output);
        Q_EMIT messages_sendSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT messages_sendSignalE(output, error_type, error_str);
        Q_EMIT messages_sendSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT messages_sendSignalError(output, error_type, error_str);
        Q_EMIT messages_sendSignalErrorFull(worker, error_type, error_str);
    }
}
