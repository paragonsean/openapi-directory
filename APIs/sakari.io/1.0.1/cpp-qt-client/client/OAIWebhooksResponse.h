...
/*
 * OAIWebhooksResponse.h
 *
 * 
 */

#ifndef OAIWebhooksResponse_H
#define OAIWebhooksResponse_H
...
class OAIWebhooksResponse : public OAIObject {
public:
    OAIWebhooksResponse();
    OAIWebhooksResponse(QString json);
    ~OAIWebhooksResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhooksResponse)

#endif // OAIWebhooksResponse_H
