...
void OAIAuthenticationApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("auth_token", defaultConf);
    _serverIndices.insert("auth_token", 0);
}
...
void OAIAuthenticationApi::auth_token(const ::OpenAPI::OptionalParam<OAITokenRequest> &oai_token_request) {
    QString fullPath = QString(_serverConfigs["auth_token"][_serverIndices.value("auth_token")].URL()+"/oauth2/token");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationApi::auth_tokenCallback);
...
void OAIAuthenticationApi::auth_tokenCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT auth_tokenSignal(output);
        Q_EMIT auth_tokenSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT auth_tokenSignalE(output, error_type, error_str);
        Q_EMIT auth_tokenSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT auth_tokenSignalError(output, error_type, error_str);
        Q_EMIT auth_tokenSignalErrorFull(worker, error_type, error_str);
    }
}
