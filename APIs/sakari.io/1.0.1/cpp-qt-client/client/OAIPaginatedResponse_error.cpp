...
OAIPaginatedResponse_error::OAIPaginatedResponse_error(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaginatedResponse_error::OAIPaginatedResponse_error() {
    this->initializeModel();
}

OAIPaginatedResponse_error::~OAIPaginatedResponse_error() {}

void OAIPaginatedResponse_error::initializeModel() {
...
void OAIPaginatedResponse_error::fromJson(QString jsonString) {
...
void OAIPaginatedResponse_error::fromJsonObject(QJsonObject json) {
...
QString OAIPaginatedResponse_error::asJson() const {
...
QJsonObject OAIPaginatedResponse_error::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIPaginatedResponse_error::getCode() const {
    return m_code;
}
void OAIPaginatedResponse_error::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIPaginatedResponse_error::is_code_Set() const{
    return m_code_isSet;
}

bool OAIPaginatedResponse_error::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIPaginatedResponse_error::getMessage() const {
    return m_message;
}
void OAIPaginatedResponse_error::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIPaginatedResponse_error::is_message_Set() const{
    return m_message_isSet;
}

bool OAIPaginatedResponse_error::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIPaginatedResponse_error::isSet() const {
...
bool OAIPaginatedResponse_error::isValid() const {
