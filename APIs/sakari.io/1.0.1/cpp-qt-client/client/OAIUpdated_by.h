...
#ifndef OAIUpdated_by_H
#define OAIUpdated_by_H
...
class OAIUpdated_by : public OAIObject {
public:
    OAIUpdated_by();
    OAIUpdated_by(QString json);
    ~OAIUpdated_by() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdated_by)

#endif // OAIUpdated_by_H
