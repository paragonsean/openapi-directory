...
QString OAIEvent::getAccountId() const {
    return m_account_id;
}
void OAIEvent::setAccountId(const QString &account_id) {
...
OAIEvent_data OAIEvent::getData() const {
    return m_data;
}
void OAIEvent::setData(const OAIEvent_data &data) {
    m_data = data;
    m_data_isSet = true;
}
