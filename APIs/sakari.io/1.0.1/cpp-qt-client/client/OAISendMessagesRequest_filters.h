...
/*
 * OAISendMessagesRequest_filters.h
 *
 * 
 */

#ifndef OAISendMessagesRequest_filters_H
#define OAISendMessagesRequest_filters_H
...
class OAISendMessagesRequest_filters : public OAIObject {
public:
    OAISendMessagesRequest_filters();
    OAISendMessagesRequest_filters(QString json);
    ~OAISendMessagesRequest_filters() override;
    ...
    QList<OAIObject> getAttributes() const;
    void setAttributes(const QList<OAIObject> &attributes);
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMessagesRequest_filters)

#endif // OAISendMessagesRequest_filters_H
