...
OAIMessage_conversation::OAIMessage_conversation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMessage_conversation::OAIMessage_conversation() {
    this->initializeModel();
}

OAIMessage_conversation::~OAIMessage_conversation() {}

void OAIMessage_conversation::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIMessage_conversation::fromJson(QString jsonString) {
...
void OAIMessage_conversation::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIMessage_conversation::asJson() const {
...
QJsonObject OAIMessage_conversation::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIMessage_conversation::getId() const {
    return m_id;
}
void OAIMessage_conversation::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMessage_conversation::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMessage_conversation::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIMessage_conversation::isSet() const {
...
bool OAIMessage_conversation::isValid() const {
