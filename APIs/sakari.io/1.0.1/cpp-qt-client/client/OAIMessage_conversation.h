...
/*
 * OAIMessage_conversation.h
 *
 * 
 */

#ifndef OAIMessage_conversation_H
#define OAIMessage_conversation_H
...
class OAIMessage_conversation : public OAIObject {
public:
    OAIMessage_conversation();
    OAIMessage_conversation(QString json);
    ~OAIMessage_conversation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessage_conversation)

#endif // OAIMessage_conversation_H
