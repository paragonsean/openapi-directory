...
/*
 * OAIPaginatedResponse.h
 *
 * 
 */

#ifndef OAIPaginatedResponse_H
#define OAIPaginatedResponse_H
...
class OAIPaginatedResponse : public OAIObject {
public:
    OAIPaginatedResponse();
    OAIPaginatedResponse(QString json);
    ~OAIPaginatedResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaginatedResponse)

#endif // OAIPaginatedResponse_H
