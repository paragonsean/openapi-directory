...
OAIWebhooks_subscribe_request::OAIWebhooks_subscribe_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebhooks_subscribe_request::OAIWebhooks_subscribe_request() {
    this->initializeModel();
}

OAIWebhooks_subscribe_request::~OAIWebhooks_subscribe_request() {}

void OAIWebhooks_subscribe_request::initializeModel() {
...
void OAIWebhooks_subscribe_request::fromJson(QString jsonString) {
...
void OAIWebhooks_subscribe_request::fromJsonObject(QJsonObject json) {
...
QString OAIWebhooks_subscribe_request::asJson() const {
...
QJsonObject OAIWebhooks_subscribe_request::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIWebhooks_subscribe_request::getEventTypes() const {
    return m_event_types;
}
void OAIWebhooks_subscribe_request::setEventTypes(const QList<QString> &event_types) {
    m_event_types = event_types;
    m_event_types_isSet = true;
}

bool OAIWebhooks_subscribe_request::is_event_types_Set() const{
    return m_event_types_isSet;
}

bool OAIWebhooks_subscribe_request::is_event_types_Valid() const{
    return m_event_types_isValid;
}

QString OAIWebhooks_subscribe_request::getUrl() const {
    return m_url;
}
void OAIWebhooks_subscribe_request::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIWebhooks_subscribe_request::is_url_Set() const{
    return m_url_isSet;
}

bool OAIWebhooks_subscribe_request::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIWebhooks_subscribe_request::isSet() const {
...
bool OAIWebhooks_subscribe_request::isValid() const {
