...
/*
 * OAICampaignRequest.h
 *
 * 
 */

#ifndef OAICampaignRequest_H
#define OAICampaignRequest_H

#include <QJsonObject>

#include "OAICampaignRequest_filters.h"
#include "OAICampaignRequest_trigger.h"
#include <QString>
...
namespace OpenAPI {
class OAICampaignRequest_filters;
class OAICampaignRequest_trigger;

class OAICampaignRequest : public OAIObject {
public:
    OAICampaignRequest();
    OAICampaignRequest(QString json);
    ~OAICampaignRequest() override;
    ...
    OAICampaignRequest_filters getFilters() const;
    void setFilters(const OAICampaignRequest_filters &filters);
    ...
    OAICampaignRequest_trigger getTrigger() const;
    void setTrigger(const OAICampaignRequest_trigger &trigger);
...
private:
    ...
    OAICampaignRequest_filters m_filters;
    ...
    OAICampaignRequest_trigger m_trigger;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaignRequest)

#endif // OAICampaignRequest_H
