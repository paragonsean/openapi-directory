...
OAICampaignRequest_trigger::OAICampaignRequest_trigger(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICampaignRequest_trigger::OAICampaignRequest_trigger() {
    this->initializeModel();
}

OAICampaignRequest_trigger::~OAICampaignRequest_trigger() {}

void OAICampaignRequest_trigger::initializeModel() {

    m_code_isSet = false;
    m_code_isValid = false;
}

void OAICampaignRequest_trigger::fromJson(QString jsonString) {
...
void OAICampaignRequest_trigger::fromJsonObject(QJsonObject json) {

    m_code_isValid = ::OpenAPI::fromJsonValue(m_code, json[QString("code")]);
    m_code_isSet = !json[QString("code")].isNull() && m_code_isValid;
}

QString OAICampaignRequest_trigger::asJson() const {
...
QJsonObject OAICampaignRequest_trigger::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAICampaignRequest_trigger::getCode() const {
    return m_code;
}
void OAICampaignRequest_trigger::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAICampaignRequest_trigger::is_code_Set() const{
    return m_code_isSet;
}

bool OAICampaignRequest_trigger::is_code_Valid() const{
    return m_code_isValid;
}

bool OAICampaignRequest_trigger::isSet() const {
...
bool OAICampaignRequest_trigger::isValid() const {
