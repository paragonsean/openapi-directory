...
/*
 * OAISendMessagesResponse_data.h
 *
 * 
 */

#ifndef OAISendMessagesResponse_data_H
#define OAISendMessagesResponse_data_H
...
class OAISendMessagesResponse_data : public OAIObject {
public:
    OAISendMessagesResponse_data();
    OAISendMessagesResponse_data(QString json);
    ~OAISendMessagesResponse_data() override;
    ...
    void setEstimatedPrice(const double &estimated_price);
    bool is_estimated_price_Set() const;
    bool is_estimated_price_Valid() const;

    QList<OAIContact> getInvalid() const;
    void setInvalid(const QList<OAIContact> &invalid);
    ...
    qint32 getRequested() const;
    void setRequested(const qint32 &requested);
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMessagesResponse_data)

#endif // OAISendMessagesResponse_data_H
