...
OAIContactsResponse::OAIContactsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContactsResponse::OAIContactsResponse() {
    this->initializeModel();
}

OAIContactsResponse::~OAIContactsResponse() {}

void OAIContactsResponse::initializeModel() {
...
void OAIContactsResponse::fromJson(QString jsonString) {
...
void OAIContactsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIContactsResponse::asJson() const {
...
QJsonObject OAIContactsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_error.isSet()) {
...
OAIPaginatedResponse_error OAIContactsResponse::getError() const {
    return m_error;
}
void OAIContactsResponse::setError(const OAIPaginatedResponse_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIContactsResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAIContactsResponse::is_error_Valid() const{
    return m_error_isValid;
}

OAIPaginatedResponse_pagination OAIContactsResponse::getPagination() const {
    return m_pagination;
}
void OAIContactsResponse::setPagination(const OAIPaginatedResponse_pagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIContactsResponse::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIContactsResponse::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAIContactsResponse::isSuccess() const {
    return m_success;
}
void OAIContactsResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIContactsResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIContactsResponse::is_success_Valid() const{
    return m_success_isValid;
}

QList<OAIContact> OAIContactsResponse::getData() const {
    return m_data;
}
void OAIContactsResponse::setData(const QList<OAIContact> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIContactsResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIContactsResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIContactsResponse::isSet() const {
...
bool OAIContactsResponse::isValid() const {
