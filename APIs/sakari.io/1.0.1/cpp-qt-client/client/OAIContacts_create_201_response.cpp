...
OAIContacts_create_201_response::OAIContacts_create_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContacts_create_201_response::OAIContacts_create_201_response() {
    this->initializeModel();
}

OAIContacts_create_201_response::~OAIContacts_create_201_response() {}

void OAIContacts_create_201_response::initializeModel() {
...
void OAIContacts_create_201_response::fromJson(QString jsonString) {
...
void OAIContacts_create_201_response::fromJsonObject(QJsonObject json) {
...
QString OAIContacts_create_201_response::asJson() const {
...
QJsonObject OAIContacts_create_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error.isSet()) {
...
OAIPaginatedResponse_error OAIContacts_create_201_response::getError() const {
    return m_error;
}
void OAIContacts_create_201_response::setError(const OAIPaginatedResponse_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIContacts_create_201_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIContacts_create_201_response::is_error_Valid() const{
    return m_error_isValid;
}

OAIPaginatedResponse_pagination OAIContacts_create_201_response::getPagination() const {
    return m_pagination;
}
void OAIContacts_create_201_response::setPagination(const OAIPaginatedResponse_pagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIContacts_create_201_response::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIContacts_create_201_response::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAIContacts_create_201_response::isSuccess() const {
    return m_success;
}
void OAIContacts_create_201_response::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIContacts_create_201_response::is_success_Set() const{
    return m_success_isSet;
}

bool OAIContacts_create_201_response::is_success_Valid() const{
    return m_success_isValid;
}

OAIContactUploadResponse_data OAIContacts_create_201_response::getData() const {
    return m_data;
}
void OAIContacts_create_201_response::setData(const OAIContactUploadResponse_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIContacts_create_201_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIContacts_create_201_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIContacts_create_201_response::isSet() const {
...
bool OAIContacts_create_201_response::isValid() const {
