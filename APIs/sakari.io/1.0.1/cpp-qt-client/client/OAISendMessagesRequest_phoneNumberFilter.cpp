...
OAISendMessagesRequest_phoneNumberFilter::OAISendMessagesRequest_phoneNumberFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendMessagesRequest_phoneNumberFilter::OAISendMessagesRequest_phoneNumberFilter() {
    this->initializeModel();
}

OAISendMessagesRequest_phoneNumberFilter::~OAISendMessagesRequest_phoneNumberFilter() {}

void OAISendMessagesRequest_phoneNumberFilter::initializeModel() {

    m_group_isSet = false;
    m_group_isValid = false;
}

void OAISendMessagesRequest_phoneNumberFilter::fromJson(QString jsonString) {
...
void OAISendMessagesRequest_phoneNumberFilter::fromJsonObject(QJsonObject json) {

    m_group_isValid = ::OpenAPI::fromJsonValue(m_group, json[QString("group")]);
    m_group_isSet = !json[QString("group")].isNull() && m_group_isValid;
}

QString OAISendMessagesRequest_phoneNumberFilter::asJson() const {
...
QJsonObject OAISendMessagesRequest_phoneNumberFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_group.isSet()) {
...
OAIMessage_conversation OAISendMessagesRequest_phoneNumberFilter::getGroup() const {
    return m_group;
}
void OAISendMessagesRequest_phoneNumberFilter::setGroup(const OAIMessage_conversation &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAISendMessagesRequest_phoneNumberFilter::is_group_Set() const{
    return m_group_isSet;
}

bool OAISendMessagesRequest_phoneNumberFilter::is_group_Valid() const{
    return m_group_isValid;
}

bool OAISendMessagesRequest_phoneNumberFilter::isSet() const {
...
bool OAISendMessagesRequest_phoneNumberFilter::isValid() const {
