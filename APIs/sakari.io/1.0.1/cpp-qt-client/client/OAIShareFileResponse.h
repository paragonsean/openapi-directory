...
/*
 * OAIShareFileResponse.h
 *
 * 
 */

#ifndef OAIShareFileResponse_H
#define OAIShareFileResponse_H

#include <QJsonObject>

#include "OAIShareFileResponse_data.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIShareFileResponse_data;

class OAIShareFileResponse : public OAIObject {
public:
    OAIShareFileResponse();
    OAIShareFileResponse(QString json);
    ~OAIShareFileResponse() override;
    ...
    OAIShareFileResponse_data getData() const;
    void setData(const OAIShareFileResponse_data &data);
...
private:
    ...
    OAIShareFileResponse_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShareFileResponse)

#endif // OAIShareFileResponse_H
