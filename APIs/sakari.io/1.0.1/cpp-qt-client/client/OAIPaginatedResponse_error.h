...
/*
 * OAIPaginatedResponse_error.h
 *
 * 
 */

#ifndef OAIPaginatedResponse_error_H
#define OAIPaginatedResponse_error_H
...
class OAIPaginatedResponse_error : public OAIObject {
public:
    OAIPaginatedResponse_error();
    OAIPaginatedResponse_error(QString json);
    ~OAIPaginatedResponse_error() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaginatedResponse_error)

#endif // OAIPaginatedResponse_error_H
