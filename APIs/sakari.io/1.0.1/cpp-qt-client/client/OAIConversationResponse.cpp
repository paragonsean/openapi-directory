...
OAIConversationResponse::OAIConversationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConversationResponse::OAIConversationResponse() {
    this->initializeModel();
}

OAIConversationResponse::~OAIConversationResponse() {}

void OAIConversationResponse::initializeModel() {
...
void OAIConversationResponse::fromJson(QString jsonString) {
...
void OAIConversationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIConversationResponse::asJson() const {
...
QJsonObject OAIConversationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIConversation OAIConversationResponse::getData() const {
    return m_data;
}
void OAIConversationResponse::setData(const OAIConversation &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIConversationResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIConversationResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIConversationResponse::isSuccess() const {
    return m_success;
}
void OAIConversationResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIConversationResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIConversationResponse::is_success_Valid() const{
    return m_success_isValid;
}

bool OAIConversationResponse::isSet() const {
...
bool OAIConversationResponse::isValid() const {
