...
/*
 * OAIConversationResponse.h
 *
 * 
 */

#ifndef OAIConversationResponse_H
#define OAIConversationResponse_H
...
class OAIConversationResponse : public OAIObject {
public:
    OAIConversationResponse();
    OAIConversationResponse(QString json);
    ~OAIConversationResponse() override;
    ...
    OAIConversation getData() const;
    void setData(const OAIConversation &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversationResponse)

#endif // OAIConversationResponse_H
