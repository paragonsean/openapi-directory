...
/*
 * OAIContactUploadResponse_data.h
 *
 * 
 */

#ifndef OAIContactUploadResponse_data_H
#define OAIContactUploadResponse_data_H
...
class OAIContactUploadResponse_data : public OAIObject {
public:
    OAIContactUploadResponse_data();
    OAIContactUploadResponse_data(QString json);
    ~OAIContactUploadResponse_data() override;
    ...
    QList<OAIContact> getErrors() const;
    void setErrors(const QList<OAIContact> &errors);
    bool is_errors_Set() const;
    bool is_errors_Valid() const;

    qint32 getInserted() const;
    void setInserted(const qint32 &inserted);
    bool is_inserted_Set() const;
    bool is_inserted_Valid() const;

    qint32 getSubmitted() const;
    void setSubmitted(const qint32 &submitted);
...
private:
    ...
    QList<OAIContact> m_errors;
    bool m_errors_isSet;
    bool m_errors_isValid;

    qint32 m_inserted;
    bool m_inserted_isSet;
    bool m_inserted_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactUploadResponse_data)

#endif // OAIContactUploadResponse_data_H
