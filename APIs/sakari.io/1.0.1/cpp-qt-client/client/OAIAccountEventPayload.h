...
/*
 * OAIAccountEventPayload.h
 *
 * 
 */

#ifndef OAIAccountEventPayload_H
#define OAIAccountEventPayload_H
...
class OAIAccountEventPayload : public OAIObject {
public:
    OAIAccountEventPayload();
    OAIAccountEventPayload(QString json);
    ~OAIAccountEventPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountEventPayload)

#endif // OAIAccountEventPayload_H
