...
OAICampaignsResponse::OAICampaignsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICampaignsResponse::OAICampaignsResponse() {
    this->initializeModel();
}

OAICampaignsResponse::~OAICampaignsResponse() {}

void OAICampaignsResponse::initializeModel() {
...
void OAICampaignsResponse::fromJson(QString jsonString) {
...
void OAICampaignsResponse::fromJsonObject(QJsonObject json) {
...
QString OAICampaignsResponse::asJson() const {
...
QJsonObject OAICampaignsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_error.isSet()) {
...
OAIPaginatedResponse_error OAICampaignsResponse::getError() const {
    return m_error;
}
void OAICampaignsResponse::setError(const OAIPaginatedResponse_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAICampaignsResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAICampaignsResponse::is_error_Valid() const{
    return m_error_isValid;
}

OAIPaginatedResponse_pagination OAICampaignsResponse::getPagination() const {
    return m_pagination;
}
void OAICampaignsResponse::setPagination(const OAIPaginatedResponse_pagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAICampaignsResponse::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAICampaignsResponse::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAICampaignsResponse::isSuccess() const {
    return m_success;
}
void OAICampaignsResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAICampaignsResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAICampaignsResponse::is_success_Valid() const{
    return m_success_isValid;
}

QList<OAICampaign> OAICampaignsResponse::getData() const {
    return m_data;
}
void OAICampaignsResponse::setData(const QList<OAICampaign> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICampaignsResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAICampaignsResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAICampaignsResponse::isSet() const {
...
bool OAICampaignsResponse::isValid() const {
