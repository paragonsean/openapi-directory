...
/*
 * OAIContactsResponse.h
 *
 * 
 */

#ifndef OAIContactsResponse_H
#define OAIContactsResponse_H
...
class OAIContactsResponse : public OAIObject {
public:
    OAIContactsResponse();
    OAIContactsResponse(QString json);
    ~OAIContactsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactsResponse)

#endif // OAIContactsResponse_H
