...
OAICampaignRequest::OAICampaignRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICampaignRequest::OAICampaignRequest() {
    this->initializeModel();
}

OAICampaignRequest::~OAICampaignRequest() {}

void OAICampaignRequest::initializeModel() {
...
void OAICampaignRequest::fromJson(QString jsonString) {
...
void OAICampaignRequest::fromJsonObject(QJsonObject json) {
...
QString OAICampaignRequest::asJson() const {
...
QJsonObject OAICampaignRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_filters.isSet()) {
...
OAICampaignRequest_filters OAICampaignRequest::getFilters() const {
    return m_filters;
}
void OAICampaignRequest::setFilters(const OAICampaignRequest_filters &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAICampaignRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAICampaignRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

QString OAICampaignRequest::getRTemplate() const {
    return m_r_template;
}
void OAICampaignRequest::setRTemplate(const QString &r_template) {
    m_r_template = r_template;
    m_r_template_isSet = true;
}

bool OAICampaignRequest::is_r_template_Set() const{
    return m_r_template_isSet;
}

bool OAICampaignRequest::is_r_template_Valid() const{
    return m_r_template_isValid;
}

OAICampaignRequest_trigger OAICampaignRequest::getTrigger() const {
    return m_trigger;
}
void OAICampaignRequest::setTrigger(const OAICampaignRequest_trigger &trigger) {
    m_trigger = trigger;
    m_trigger_isSet = true;
}

bool OAICampaignRequest::is_trigger_Set() const{
    return m_trigger_isSet;
}

bool OAICampaignRequest::is_trigger_Valid() const{
    return m_trigger_isValid;
}

bool OAICampaignRequest::isSet() const {
...
bool OAICampaignRequest::isValid() const {
