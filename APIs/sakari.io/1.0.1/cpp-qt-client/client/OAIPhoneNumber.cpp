...
bool OAIPhoneNumber::isActive() const {
    return m_active;
}
void OAIPhoneNumber::setActive(const bool &active) {
    m_active = active;
    m_active_isSet = true;
}

bool OAIPhoneNumber::is_active_Set() const{
    return m_active_isSet;
}

bool OAIPhoneNumber::is_active_Valid() const{
