...
/*
 * OAICampaignsResponse.h
 *
 * 
 */

#ifndef OAICampaignsResponse_H
#define OAICampaignsResponse_H
...
class OAICampaignsResponse : public OAIObject {
public:
    OAICampaignsResponse();
    OAICampaignsResponse(QString json);
    ~OAICampaignsResponse() override;
    ...
    QList<OAICampaign> getData() const;
    void setData(const QList<OAICampaign> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaignsResponse)

#endif // OAICampaignsResponse_H
