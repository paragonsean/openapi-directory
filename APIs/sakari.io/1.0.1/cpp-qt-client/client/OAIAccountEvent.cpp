...
QString OAIAccountEvent::getAccountId() const {
    return m_account_id;
}
void OAIAccountEvent::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIAccountEvent::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIAccountEvent::is_account_id_Valid() const{
    return m_account_id_isValid;
}

OAIEventType OAIAccountEvent::getType() const {
    return m_type;
}
void OAIAccountEvent::setType(const OAIEventType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAccountEvent::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAccountEvent::is_type_Valid() const{
