...
/*
 * OAIWebhooks_subscribe_request.h
 *
 * 
 */

#ifndef OAIWebhooks_subscribe_request_H
#define OAIWebhooks_subscribe_request_H
...
class OAIWebhooks_subscribe_request : public OAIObject {
public:
    OAIWebhooks_subscribe_request();
    OAIWebhooks_subscribe_request(QString json);
    ~OAIWebhooks_subscribe_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhooks_subscribe_request)

#endif // OAIWebhooks_subscribe_request_H
