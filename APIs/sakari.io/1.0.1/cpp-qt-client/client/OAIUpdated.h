...
class OAIUpdated : public OAIObject {
public:
    OAIUpdated();
    OAIUpdated(QString json);
    ~OAIUpdated() override;
    ...
    OAIUpdated_by getBy() const;
    void setBy(const OAIUpdated_by &by);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdated)
