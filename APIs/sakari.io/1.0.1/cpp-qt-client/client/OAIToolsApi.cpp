...
OAIToolsApi::OAIToolsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIToolsApi::~OAIToolsApi() {
}

void OAIToolsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("tools_shareFile", defaultConf);
    _serverIndices.insert("tools_shareFile", 0);
}
...
*/
int OAIToolsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIToolsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIToolsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIToolsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIToolsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIToolsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIToolsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIToolsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIToolsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIToolsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIToolsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIToolsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIToolsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIToolsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIToolsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIToolsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIToolsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIToolsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIToolsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIToolsApi::tools_shareFile(const OAIHttpFileElement &body) {
    QString fullPath = QString(_serverConfigs["tools_shareFile"][_serverIndices.value("tools_shareFile")].URL()+"/v1/tools/sharefile");
...

    {
        ...
        input.headers.insert("Content-Type", "application/octet-stream", "multipart/form-data");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIToolsApi::tools_shareFileCallback);
    connect(this, &OAIToolsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIToolsApi::tools_shareFileCallback);
    connect(this, &OAIToolsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIToolsApi::tools_shareFileCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIShareFileResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT tools_shareFileSignal(output);
        Q_EMIT tools_shareFileSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT tools_shareFileSignalE(output, error_type, error_str);
        Q_EMIT tools_shareFileSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT tools_shareFileSignalError(output, error_type, error_str);
        Q_EMIT tools_shareFileSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIToolsApi::tokenAvailable(){
