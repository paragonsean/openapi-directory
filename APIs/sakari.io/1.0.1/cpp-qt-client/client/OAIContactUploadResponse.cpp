...
#include "OAIContactUploadResponse.h"
...
OAIContactUploadResponse::OAIContactUploadResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContactUploadResponse::OAIContactUploadResponse() {
    this->initializeModel();
}

OAIContactUploadResponse::~OAIContactUploadResponse() {}

void OAIContactUploadResponse::initializeModel() {
...
void OAIContactUploadResponse::fromJson(QString jsonString) {
...
void OAIContactUploadResponse::fromJsonObject(QJsonObject json) {
...
QString OAIContactUploadResponse::asJson() const {
...
QJsonObject OAIContactUploadResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIContactUploadResponse_data OAIContactUploadResponse::getData() const {
    return m_data;
}
void OAIContactUploadResponse::setData(const OAIContactUploadResponse_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIContactUploadResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIContactUploadResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIContactUploadResponse::isSuccess() const {
    return m_success;
}
void OAIContactUploadResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIContactUploadResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIContactUploadResponse::is_success_Valid() const{
    return m_success_isValid;
}

bool OAIContactUploadResponse::isSet() const {
...
bool OAIContactUploadResponse::isValid() const {
