...
OAIShareFileResponse_data::OAIShareFileResponse_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIShareFileResponse_data::OAIShareFileResponse_data() {
    this->initializeModel();
}

OAIShareFileResponse_data::~OAIShareFileResponse_data() {}

void OAIShareFileResponse_data::initializeModel() {
...
void OAIShareFileResponse_data::fromJson(QString jsonString) {
...
void OAIShareFileResponse_data::fromJsonObject(QJsonObject json) {
...
QString OAIShareFileResponse_data::asJson() const {
...
QJsonObject OAIShareFileResponse_data::asJsonObject() const {
    QJsonObject obj;
    if (m_expires_isSet) {
...
QDateTime OAIShareFileResponse_data::getExpires() const {
    return m_expires;
}
void OAIShareFileResponse_data::setExpires(const QDateTime &expires) {
    m_expires = expires;
    m_expires_isSet = true;
}

bool OAIShareFileResponse_data::is_expires_Set() const{
    return m_expires_isSet;
}

bool OAIShareFileResponse_data::is_expires_Valid() const{
    return m_expires_isValid;
}

QString OAIShareFileResponse_data::getLink() const {
    return m_link;
}
void OAIShareFileResponse_data::setLink(const QString &link) {
    m_link = link;
    m_link_isSet = true;
}

bool OAIShareFileResponse_data::is_link_Set() const{
    return m_link_isSet;
}

bool OAIShareFileResponse_data::is_link_Valid() const{
    return m_link_isValid;
}

bool OAIShareFileResponse_data::isSet() const {
...
bool OAIShareFileResponse_data::isValid() const {
