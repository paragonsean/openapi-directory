...
namespace OpenAPI {
class OAISendMessagesResponse_data;
...
public:
    ...
    OAISendMessagesResponse_data getData() const;
    void setData(const OAISendMessagesResponse_data &data);
...
private:
    ...
    OAISendMessagesResponse_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
