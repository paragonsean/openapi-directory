...
/*
 * OAIMessage_media_inner.h
 *
 * 
 */

#ifndef OAIMessage_media_inner_H
#define OAIMessage_media_inner_H
...
class OAIMessage_media_inner : public OAIObject {
public:
    OAIMessage_media_inner();
    OAIMessage_media_inner(QString json);
    ~OAIMessage_media_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessage_media_inner)

#endif // OAIMessage_media_inner_H
