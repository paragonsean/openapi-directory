...
#include "OAIPaginatedResponse.h"
...
OAIPaginatedResponse::OAIPaginatedResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaginatedResponse::OAIPaginatedResponse() {
    this->initializeModel();
}

OAIPaginatedResponse::~OAIPaginatedResponse() {}

void OAIPaginatedResponse::initializeModel() {
...
void OAIPaginatedResponse::fromJson(QString jsonString) {
...
void OAIPaginatedResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPaginatedResponse::asJson() const {
...
QJsonObject OAIPaginatedResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_error.isSet()) {
...
OAIPaginatedResponse_error OAIPaginatedResponse::getError() const {
    return m_error;
}
void OAIPaginatedResponse::setError(const OAIPaginatedResponse_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIPaginatedResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAIPaginatedResponse::is_error_Valid() const{
    return m_error_isValid;
}

OAIPaginatedResponse_pagination OAIPaginatedResponse::getPagination() const {
    return m_pagination;
}
void OAIPaginatedResponse::setPagination(const OAIPaginatedResponse_pagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIPaginatedResponse::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIPaginatedResponse::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAIPaginatedResponse::isSuccess() const {
    return m_success;
}
void OAIPaginatedResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIPaginatedResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIPaginatedResponse::is_success_Valid() const{
    return m_success_isValid;
}

bool OAIPaginatedResponse::isSet() const {
...
bool OAIPaginatedResponse::isValid() const {
