...
OAICampaignRequest_filters::OAICampaignRequest_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICampaignRequest_filters::OAICampaignRequest_filters() {
    this->initializeModel();
}

OAICampaignRequest_filters::~OAICampaignRequest_filters() {}

void OAICampaignRequest_filters::initializeModel() {
...
void OAICampaignRequest_filters::fromJson(QString jsonString) {
...
void OAICampaignRequest_filters::fromJsonObject(QJsonObject json) {
...
QString OAICampaignRequest_filters::asJson() const {
...
QJsonObject OAICampaignRequest_filters::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAICampaignRequest_filters::getAttributes() const {
    return m_attributes;
}
void OAICampaignRequest_filters::setAttributes(const QList<QString> &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICampaignRequest_filters::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICampaignRequest_filters::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QList<QString> OAICampaignRequest_filters::getContacts() const {
    return m_contacts;
}
void OAICampaignRequest_filters::setContacts(const QList<QString> &contacts) {
    m_contacts = contacts;
    m_contacts_isSet = true;
}

bool OAICampaignRequest_filters::is_contacts_Set() const{
    return m_contacts_isSet;
}

bool OAICampaignRequest_filters::is_contacts_Valid() const{
    return m_contacts_isValid;
}

QList<QString> OAICampaignRequest_filters::getTags() const {
    return m_tags;
}
void OAICampaignRequest_filters::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICampaignRequest_filters::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICampaignRequest_filters::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICampaignRequest_filters::isSet() const {
...
bool OAICampaignRequest_filters::isValid() const {
