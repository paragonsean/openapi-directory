...
/*
 * OAIConversationsResponse.h
 *
 * 
 */

#ifndef OAIConversationsResponse_H
#define OAIConversationsResponse_H
...
class OAIConversationsResponse : public OAIObject {
public:
    OAIConversationsResponse();
    OAIConversationsResponse(QString json);
    ~OAIConversationsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversationsResponse)

#endif // OAIConversationsResponse_H
