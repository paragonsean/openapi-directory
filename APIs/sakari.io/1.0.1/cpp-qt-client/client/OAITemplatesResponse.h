...
/*
 * OAITemplatesResponse.h
 *
 * 
 */

#ifndef OAITemplatesResponse_H
#define OAITemplatesResponse_H

#include <QJsonObject>

#include "OAIPaginatedResponse_error.h"
#include "OAIPaginatedResponse_pagination.h"
...
namespace OpenAPI {
class OAIPaginatedResponse_error;
class OAIPaginatedResponse_pagination;
class OAITemplate;

class OAITemplatesResponse : public OAIObject {
public:
    OAITemplatesResponse();
    OAITemplatesResponse(QString json);
    ~OAITemplatesResponse() override;
    ...
    OAIPaginatedResponse_error getError() const;
    void setError(const OAIPaginatedResponse_error &error);
    bool is_error_Set() const;
    bool is_error_Valid() const;

    OAIPaginatedResponse_pagination getPagination() const;
    void setPagination(const OAIPaginatedResponse_pagination &pagination);
    ...
    QList<OAITemplate> getData() const;
    void setData(const QList<OAITemplate> &data);
...
private:
    ...
    OAIPaginatedResponse_error m_error;
    bool m_error_isSet;
    bool m_error_isValid;

    OAIPaginatedResponse_pagination m_pagination;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplatesResponse)

#endif // OAITemplatesResponse_H
