...
QList<QString> OAIWebhook::getEventTypes() const {
    return m_event_types;
}
void OAIWebhook::setEventTypes(const QList<QString> &event_types) {
    m_event_types = event_types;
    m_event_types_isSet = true;
}

bool OAIWebhook::is_event_types_Set() const{
    return m_event_types_isSet;
}

bool OAIWebhook::is_event_types_Valid() const{
