...
/*
 * OAIMessagesResponse.h
 *
 * 
 */

#ifndef OAIMessagesResponse_H
#define OAIMessagesResponse_H
...
class OAIMessagesResponse : public OAIObject {
public:
    OAIMessagesResponse();
    OAIMessagesResponse(QString json);
    ~OAIMessagesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessagesResponse)

#endif // OAIMessagesResponse_H
