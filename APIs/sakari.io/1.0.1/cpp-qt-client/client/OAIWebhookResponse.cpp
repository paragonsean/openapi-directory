...
OAIWebhook OAIWebhookResponse::getData() const {
    return m_data;
}
void OAIWebhookResponse::setData(const OAIWebhook &data) {
    m_data = data;
    m_data_isSet = true;
}
...
bool OAIWebhookResponse::isSuccess() const {
    return m_success;
}
void OAIWebhookResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIWebhookResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIWebhookResponse::is_success_Valid() const{
