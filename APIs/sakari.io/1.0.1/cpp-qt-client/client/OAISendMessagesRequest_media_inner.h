...
/*
 * OAISendMessagesRequest_media_inner.h
 *
 * 
 */

#ifndef OAISendMessagesRequest_media_inner_H
#define OAISendMessagesRequest_media_inner_H
...
class OAISendMessagesRequest_media_inner : public OAIObject {
public:
    OAISendMessagesRequest_media_inner();
    OAISendMessagesRequest_media_inner(QString json);
    ~OAISendMessagesRequest_media_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMessagesRequest_media_inner)

#endif // OAISendMessagesRequest_media_inner_H
