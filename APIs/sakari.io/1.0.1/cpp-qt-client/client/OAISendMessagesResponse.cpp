...
OAISendMessagesResponse_data OAISendMessagesResponse::getData() const {
    return m_data;
}
void OAISendMessagesResponse::setData(const OAISendMessagesResponse_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAISendMessagesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAISendMessagesResponse::is_data_Valid() const{
