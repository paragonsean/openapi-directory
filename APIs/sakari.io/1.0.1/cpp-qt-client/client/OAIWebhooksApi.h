...
#include "OAIWebhooks_subscribe_request.h"
#include <QString>
...
public:
    ...
    */
    virtual void webhooks_fetchAll(const QString &account_id);

    /**
    * @param[in]  account_id QString [required]
    * @param[in]  oai_webhooks_subscribe_request OAIWebhooks_subscribe_request [required]
    */
    virtual void webhooks_subscribe(const QString &account_id, const OAIWebhooks_subscribe_request &oai_webhooks_subscribe_request);

    /**
    * @param[in]  account_id QString [required]
    * @param[in]  url QString [required]
    */
    virtual void webhooks_unsubscribe(const QString &account_id, const QString &url);
...
private:
    ...
    void webhooks_fetchAllCallback(OAIHttpRequestWorker *worker);
    void webhooks_subscribeCallback(OAIHttpRequestWorker *worker);
    void webhooks_unsubscribeCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void webhooks_fetchAllSignal(OAIWebhooksResponse summary);
    void webhooks_subscribeSignal(OAIWebhookResponse summary);
    void webhooks_unsubscribeSignal();


    void webhooks_fetchAllSignalFull(OAIHttpRequestWorker *worker, OAIWebhooksResponse summary);
    void webhooks_subscribeSignalFull(OAIHttpRequestWorker *worker, OAIWebhookResponse summary);
    void webhooks_unsubscribeSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use webhooks_fetchAllSignalError() instead")
    void webhooks_fetchAllSignalE(OAIWebhooksResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webhooks_fetchAllSignalError(OAIWebhooksResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use webhooks_subscribeSignalError() instead")
    void webhooks_subscribeSignalE(OAIWebhookResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void webhooks_subscribeSignalError(OAIWebhookResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use webhooks_unsubscribeSignalError() instead")
    void webhooks_unsubscribeSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void webhooks_unsubscribeSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use webhooks_fetchAllSignalErrorFull() instead")
    void webhooks_fetchAllSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webhooks_fetchAllSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use webhooks_subscribeSignalErrorFull() instead")
    void webhooks_subscribeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webhooks_subscribeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use webhooks_unsubscribeSignalErrorFull() instead")
    void webhooks_unsubscribeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void webhooks_unsubscribeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
