...
OAIMessage OAIMessageResponse::getData() const {
    return m_data;
}
void OAIMessageResponse::setData(const OAIMessage &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMessageResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMessageResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIMessageResponse::isSuccess() const {
    return m_success;
}
void OAIMessageResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIMessageResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIMessageResponse::is_success_Valid() const{
