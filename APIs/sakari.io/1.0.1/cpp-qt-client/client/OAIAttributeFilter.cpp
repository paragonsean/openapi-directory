...
OAIAttributeFilter::OAIAttributeFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttributeFilter::OAIAttributeFilter() {
    this->initializeModel();
}

OAIAttributeFilter::~OAIAttributeFilter() {}

void OAIAttributeFilter::initializeModel() {
...
void OAIAttributeFilter::fromJson(QString jsonString) {
...
void OAIAttributeFilter::fromJsonObject(QJsonObject json) {
...
QString OAIAttributeFilter::asJson() const {
...
QJsonObject OAIAttributeFilter::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAttributeFilter::getComparator() const {
    return m_comparator;
}
void OAIAttributeFilter::setComparator(const QString &comparator) {
    m_comparator = comparator;
    m_comparator_isSet = true;
}

bool OAIAttributeFilter::is_comparator_Set() const{
    return m_comparator_isSet;
}

bool OAIAttributeFilter::is_comparator_Valid() const{
    return m_comparator_isValid;
}

QString OAIAttributeFilter::getName() const {
    return m_name;
}
void OAIAttributeFilter::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAttributeFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAttributeFilter::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIAttributeFilter::getValue() const {
    return m_value;
}
void OAIAttributeFilter::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIAttributeFilter::is_value_Set() const{
    return m_value_isSet;
}

bool OAIAttributeFilter::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIAttributeFilter::isSet() const {
...
bool OAIAttributeFilter::isValid() const {
