...
OAITemplatesResponse::OAITemplatesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplatesResponse::OAITemplatesResponse() {
    this->initializeModel();
}

OAITemplatesResponse::~OAITemplatesResponse() {}

void OAITemplatesResponse::initializeModel() {
...
void OAITemplatesResponse::fromJson(QString jsonString) {
...
void OAITemplatesResponse::fromJsonObject(QJsonObject json) {
...
QString OAITemplatesResponse::asJson() const {
...
QJsonObject OAITemplatesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_error.isSet()) {
...
OAIPaginatedResponse_error OAITemplatesResponse::getError() const {
    return m_error;
}
void OAITemplatesResponse::setError(const OAIPaginatedResponse_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAITemplatesResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAITemplatesResponse::is_error_Valid() const{
    return m_error_isValid;
}

OAIPaginatedResponse_pagination OAITemplatesResponse::getPagination() const {
    return m_pagination;
}
void OAITemplatesResponse::setPagination(const OAIPaginatedResponse_pagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAITemplatesResponse::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAITemplatesResponse::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAITemplatesResponse::isSuccess() const {
    return m_success;
}
void OAITemplatesResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAITemplatesResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAITemplatesResponse::is_success_Valid() const{
    return m_success_isValid;
}

QList<OAITemplate> OAITemplatesResponse::getData() const {
    return m_data;
}
void OAITemplatesResponse::setData(const QList<OAITemplate> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAITemplatesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAITemplatesResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAITemplatesResponse::isSet() const {
...
bool OAITemplatesResponse::isValid() const {
