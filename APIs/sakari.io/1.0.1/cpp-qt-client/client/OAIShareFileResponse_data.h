...
/*
 * OAIShareFileResponse_data.h
 *
 * 
 */

#ifndef OAIShareFileResponse_data_H
#define OAIShareFileResponse_data_H
...
class OAIShareFileResponse_data : public OAIObject {
public:
    OAIShareFileResponse_data();
    OAIShareFileResponse_data(QString json);
    ~OAIShareFileResponse_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShareFileResponse_data)

#endif // OAIShareFileResponse_data_H
