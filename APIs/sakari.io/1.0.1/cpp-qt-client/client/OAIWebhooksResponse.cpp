...
OAIPaginatedResponse_error OAIWebhooksResponse::getError() const {
    return m_error;
}
void OAIWebhooksResponse::setError(const OAIPaginatedResponse_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIWebhooksResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAIWebhooksResponse::is_error_Valid() const{
    return m_error_isValid;
}

OAIPaginatedResponse_pagination OAIWebhooksResponse::getPagination() const {
    return m_pagination;
}
void OAIWebhooksResponse::setPagination(const OAIPaginatedResponse_pagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIWebhooksResponse::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIWebhooksResponse::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAIWebhooksResponse::isSuccess() const {
    return m_success;
}
void OAIWebhooksResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIWebhooksResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIWebhooksResponse::is_success_Valid() const{
    return m_success_isValid;
}

QList<OAIWebhook> OAIWebhooksResponse::getData() const {
    return m_data;
}
void OAIWebhooksResponse::setData(const QList<OAIWebhook> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIWebhooksResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIWebhooksResponse::is_data_Valid() const{
