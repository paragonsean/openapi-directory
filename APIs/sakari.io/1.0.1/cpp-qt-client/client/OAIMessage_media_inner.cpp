...
OAIMessage_media_inner::OAIMessage_media_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMessage_media_inner::OAIMessage_media_inner() {
    this->initializeModel();
}

OAIMessage_media_inner::~OAIMessage_media_inner() {}

void OAIMessage_media_inner::initializeModel() {
...
void OAIMessage_media_inner::fromJson(QString jsonString) {
...
void OAIMessage_media_inner::fromJsonObject(QJsonObject json) {
...
QString OAIMessage_media_inner::asJson() const {
...
QJsonObject OAIMessage_media_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_filename_isSet) {
...
QString OAIMessage_media_inner::getFilename() const {
    return m_filename;
}
void OAIMessage_media_inner::setFilename(const QString &filename) {
    m_filename = filename;
    m_filename_isSet = true;
}

bool OAIMessage_media_inner::is_filename_Set() const{
    return m_filename_isSet;
}

bool OAIMessage_media_inner::is_filename_Valid() const{
    return m_filename_isValid;
}

QString OAIMessage_media_inner::getType() const {
    return m_type;
}
void OAIMessage_media_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMessage_media_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMessage_media_inner::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIMessage_media_inner::getUrl() const {
    return m_url;
}
void OAIMessage_media_inner::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIMessage_media_inner::is_url_Set() const{
    return m_url_isSet;
}

bool OAIMessage_media_inner::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIMessage_media_inner::isSet() const {
...
bool OAIMessage_media_inner::isValid() const {
