...
OAISendMessagesRequest_media_inner::OAISendMessagesRequest_media_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendMessagesRequest_media_inner::OAISendMessagesRequest_media_inner() {
    this->initializeModel();
}

OAISendMessagesRequest_media_inner::~OAISendMessagesRequest_media_inner() {}

void OAISendMessagesRequest_media_inner::initializeModel() {

    m_url_isSet = false;
    m_url_isValid = false;
}

void OAISendMessagesRequest_media_inner::fromJson(QString jsonString) {
...
void OAISendMessagesRequest_media_inner::fromJsonObject(QJsonObject json) {

    m_url_isValid = ::OpenAPI::fromJsonValue(m_url, json[QString("url")]);
    m_url_isSet = !json[QString("url")].isNull() && m_url_isValid;
}

QString OAISendMessagesRequest_media_inner::asJson() const {
...
QJsonObject OAISendMessagesRequest_media_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_url_isSet) {
...
QString OAISendMessagesRequest_media_inner::getUrl() const {
    return m_url;
}
void OAISendMessagesRequest_media_inner::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAISendMessagesRequest_media_inner::is_url_Set() const{
    return m_url_isSet;
}

bool OAISendMessagesRequest_media_inner::is_url_Valid() const{
    return m_url_isValid;
}

bool OAISendMessagesRequest_media_inner::isSet() const {
...
bool OAISendMessagesRequest_media_inner::isValid() const {
