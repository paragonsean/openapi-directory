...
void OAIEventType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("account", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::ACCOUNT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("messageStatus", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::MESSAGESTATUS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("messageIncoming", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::MESSAGEINCOMING;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIEventType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIEventType::ACCOUNT:
            val = "account";
            break;
        case eOAIEventType::MESSAGESTATUS:
            val = "messageStatus";
            break;
        case eOAIEventType::MESSAGEINCOMING:
            val = "messageIncoming";
            break;
        default:
            break;
