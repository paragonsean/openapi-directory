...
#ifndef OAI_OAIToolsApi_H
#define OAI_OAIToolsApi_H
...
#include "OAIShareFileResponse.h"
#include "OAITools_shareFile_request.h"
#include <QString>
...
class OAIToolsApi : public QObject {
    Q_OBJECT

public:
    OAIToolsApi(const int timeOut = 0);
    ~OAIToolsApi();
    ...
    */
    virtual void tools_shareFile(const OAIHttpFileElement &body);
...
private:
    ...
    void tools_shareFileCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void tools_shareFileSignal(OAIShareFileResponse summary);


    void tools_shareFileSignalFull(OAIHttpRequestWorker *worker, OAIShareFileResponse summary);

    Q_DECL_DEPRECATED_X("Use tools_shareFileSignalError() instead")
    void tools_shareFileSignalE(OAIShareFileResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void tools_shareFileSignalError(OAIShareFileResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use tools_shareFileSignalErrorFull() instead")
    void tools_shareFileSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void tools_shareFileSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
