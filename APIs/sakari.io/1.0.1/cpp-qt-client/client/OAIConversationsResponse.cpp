...
OAIConversationsResponse::OAIConversationsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConversationsResponse::OAIConversationsResponse() {
    this->initializeModel();
}

OAIConversationsResponse::~OAIConversationsResponse() {}

void OAIConversationsResponse::initializeModel() {
...
void OAIConversationsResponse::fromJson(QString jsonString) {
...
void OAIConversationsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIConversationsResponse::asJson() const {
...
QJsonObject OAIConversationsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_error.isSet()) {
...
OAIPaginatedResponse_error OAIConversationsResponse::getError() const {
    return m_error;
}
void OAIConversationsResponse::setError(const OAIPaginatedResponse_error &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIConversationsResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAIConversationsResponse::is_error_Valid() const{
    return m_error_isValid;
}

OAIPaginatedResponse_pagination OAIConversationsResponse::getPagination() const {
    return m_pagination;
}
void OAIConversationsResponse::setPagination(const OAIPaginatedResponse_pagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIConversationsResponse::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIConversationsResponse::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAIConversationsResponse::isSuccess() const {
    return m_success;
}
void OAIConversationsResponse::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAIConversationsResponse::is_success_Set() const{
    return m_success_isSet;
}

bool OAIConversationsResponse::is_success_Valid() const{
    return m_success_isValid;
}

QList<OAIConversation> OAIConversationsResponse::getData() const {
    return m_data;
}
void OAIConversationsResponse::setData(const QList<OAIConversation> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIConversationsResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIConversationsResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIConversationsResponse::isSet() const {
...
bool OAIConversationsResponse::isValid() const {
