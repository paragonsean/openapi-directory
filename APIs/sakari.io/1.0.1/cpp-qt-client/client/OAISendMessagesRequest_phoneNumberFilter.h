...
/*
 * OAISendMessagesRequest_phoneNumberFilter.h
 *
 * 
 */

#ifndef OAISendMessagesRequest_phoneNumberFilter_H
#define OAISendMessagesRequest_phoneNumberFilter_H
...
class OAISendMessagesRequest_phoneNumberFilter : public OAIObject {
public:
    OAISendMessagesRequest_phoneNumberFilter();
    OAISendMessagesRequest_phoneNumberFilter(QString json);
    ~OAISendMessagesRequest_phoneNumberFilter() override;
    ...
    OAIMessage_conversation getGroup() const;
    void setGroup(const OAIMessage_conversation &group);
...
private:
    ...
    OAIMessage_conversation m_group;
    bool m_group_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMessagesRequest_phoneNumberFilter)

#endif // OAISendMessagesRequest_phoneNumberFilter_H
