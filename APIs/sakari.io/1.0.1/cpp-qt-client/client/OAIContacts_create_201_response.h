...
/*
 * OAIContacts_create_201_response.h
 *
 * 
 */

#ifndef OAIContacts_create_201_response_H
#define OAIContacts_create_201_response_H
...
class OAIContactUploadResponse_data;

class OAIContacts_create_201_response : public OAIObject {
public:
    OAIContacts_create_201_response();
    OAIContacts_create_201_response(QString json);
    ~OAIContacts_create_201_response() override;
    ...
    OAIContactUploadResponse_data getData() const;
    void setData(const OAIContactUploadResponse_data &data);
...
private:
    ...
    OAIContactUploadResponse_data m_data;
    bool m_data_isSet;
    bool m_data_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIContacts_create_201_response)

#endif // OAIContacts_create_201_response_H
