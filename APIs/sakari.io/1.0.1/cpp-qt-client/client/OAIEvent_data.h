...
#ifndef OAIEvent_data_H
#define OAIEvent_data_H
...
class OAIEvent_data : public OAIObject {
public:
    OAIEvent_data();
    OAIEvent_data(QString json);
    ~OAIEvent_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvent_data)

#endif // OAIEvent_data_H
