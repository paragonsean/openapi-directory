...
/*
 * OAICampaignRequest_trigger.h
 *
 * 
 */

#ifndef OAICampaignRequest_trigger_H
#define OAICampaignRequest_trigger_H
...
class OAICampaignRequest_trigger : public OAIObject {
public:
    OAICampaignRequest_trigger();
    OAICampaignRequest_trigger(QString json);
    ~OAICampaignRequest_trigger() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaignRequest_trigger)

#endif // OAICampaignRequest_trigger_H
