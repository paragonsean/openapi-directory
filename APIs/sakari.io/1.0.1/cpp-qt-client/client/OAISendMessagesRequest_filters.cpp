...
OAISendMessagesRequest_filters::OAISendMessagesRequest_filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendMessagesRequest_filters::OAISendMessagesRequest_filters() {
    this->initializeModel();
}

OAISendMessagesRequest_filters::~OAISendMessagesRequest_filters() {}

void OAISendMessagesRequest_filters::initializeModel() {
...
void OAISendMessagesRequest_filters::fromJson(QString jsonString) {
...
void OAISendMessagesRequest_filters::fromJsonObject(QJsonObject json) {
...
QString OAISendMessagesRequest_filters::asJson() const {
...
QJsonObject OAISendMessagesRequest_filters::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIObject> OAISendMessagesRequest_filters::getAttributes() const {
    return m_attributes;
}
void OAISendMessagesRequest_filters::setAttributes(const QList<OAIObject> &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAISendMessagesRequest_filters::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAISendMessagesRequest_filters::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QList<QString> OAISendMessagesRequest_filters::getTags() const {
    return m_tags;
}
void OAISendMessagesRequest_filters::setTags(const QList<QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAISendMessagesRequest_filters::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAISendMessagesRequest_filters::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAISendMessagesRequest_filters::isSet() const {
...
bool OAISendMessagesRequest_filters::isValid() const {
