...
OAICampaigns_remove_200_response::OAICampaigns_remove_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICampaigns_remove_200_response::OAICampaigns_remove_200_response() {
    this->initializeModel();
}

OAICampaigns_remove_200_response::~OAICampaigns_remove_200_response() {}

void OAICampaigns_remove_200_response::initializeModel() {

    m_success_isSet = false;
    m_success_isValid = false;
}

void OAICampaigns_remove_200_response::fromJson(QString jsonString) {
...
void OAICampaigns_remove_200_response::fromJsonObject(QJsonObject json) {
...
QString OAICampaigns_remove_200_response::asJson() const {
...
QJsonObject OAICampaigns_remove_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_success_isSet) {
...
bool OAICampaigns_remove_200_response::isSuccess() const {
    return m_success;
}
void OAICampaigns_remove_200_response::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAICampaigns_remove_200_response::is_success_Set() const{
    return m_success_isSet;
}

bool OAICampaigns_remove_200_response::is_success_Valid() const{
    return m_success_isValid;
}

bool OAICampaigns_remove_200_response::isSet() const {
...
bool OAICampaigns_remove_200_response::isValid() const {
