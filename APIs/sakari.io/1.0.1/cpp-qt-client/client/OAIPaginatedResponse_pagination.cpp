...
OAIPaginatedResponse_pagination::OAIPaginatedResponse_pagination(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaginatedResponse_pagination::OAIPaginatedResponse_pagination() {
    this->initializeModel();
}

OAIPaginatedResponse_pagination::~OAIPaginatedResponse_pagination() {}

void OAIPaginatedResponse_pagination::initializeModel() {
...
void OAIPaginatedResponse_pagination::fromJson(QString jsonString) {
...
void OAIPaginatedResponse_pagination::fromJsonObject(QJsonObject json) {
...
QString OAIPaginatedResponse_pagination::asJson() const {
...
QJsonObject OAIPaginatedResponse_pagination::asJsonObject() const {
    QJsonObject obj;
    if (m_limit_isSet) {
...
qint32 OAIPaginatedResponse_pagination::getLimit() const {
    return m_limit;
}
void OAIPaginatedResponse_pagination::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIPaginatedResponse_pagination::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIPaginatedResponse_pagination::is_limit_Valid() const{
    return m_limit_isValid;
}

qint32 OAIPaginatedResponse_pagination::getOffset() const {
    return m_offset;
}
void OAIPaginatedResponse_pagination::setOffset(const qint32 &offset) {
    m_offset = offset;
    m_offset_isSet = true;
}

bool OAIPaginatedResponse_pagination::is_offset_Set() const{
    return m_offset_isSet;
}

bool OAIPaginatedResponse_pagination::is_offset_Valid() const{
    return m_offset_isValid;
}

qint32 OAIPaginatedResponse_pagination::getTotalCount() const {
    return m_total_count;
}
void OAIPaginatedResponse_pagination::setTotalCount(const qint32 &total_count) {
    m_total_count = total_count;
    m_total_count_isSet = true;
}

bool OAIPaginatedResponse_pagination::is_total_count_Set() const{
    return m_total_count_isSet;
}

bool OAIPaginatedResponse_pagination::is_total_count_Valid() const{
    return m_total_count_isValid;
}

bool OAIPaginatedResponse_pagination::isSet() const {
...
bool OAIPaginatedResponse_pagination::isValid() const {
