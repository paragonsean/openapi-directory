...
(function(root, factory) {
  ...
  describe('Label', function() {
    it('should create an instance of Label', function() {
      ...
      //var instance = new Tsapi.Label();
      //expect(instance).to.be.a(Tsapi.Label);
    });

    it('should have the property altLabels (base name: "altLabels")', function() {
