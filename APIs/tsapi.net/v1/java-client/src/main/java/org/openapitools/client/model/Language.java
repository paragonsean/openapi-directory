...
public class Language {
  ...
  public static final String SERIALIZED_NAME_SUB_LANGUAGES = "subLanguages";
  @SerializedName(SERIALIZED_NAME_SUB_LANGUAGES)
  private List<Language> subLanguages;

  public Language() {
  }

  public Language ident(String ident) {
    this.ident = ident;
    return this;
  }
  ...
  public Language subLanguages(List<Language> subLanguages) {
    this.subLanguages = subLanguages;
    return this;
  }

  public Language addSubLanguagesItem(Language subLanguagesItem) {
    if (this.subLanguages == null) {
      this.subLanguages = new ArrayList<>();
    }
    this.subLanguages.add(subLanguagesItem);
    return this;
  }
  ...
  public void setSubLanguages(List<Language> subLanguages) {
    this.subLanguages = subLanguages;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ident, language.ident) &&
        Objects.equals(this.name, language.name) &&
        Objects.equals(this.subLanguages, language.subLanguages);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ident, name, subLanguages);
  }
  ...
  public String toString() {
    ...
    sb.append("    subLanguages: ").append(toIndentedString(subLanguages)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("subLanguages");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("subLanguages") != null && !jsonObj.get("subLanguages").isJsonNull()) {
        JsonArray jsonArraysubLanguages = jsonObj.getAsJsonArray("subLanguages");
        if (jsonArraysubLanguages != null) {
          // ensure the json data is an array
          if (!jsonObj.get("subLanguages").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `subLanguages` to be an array in the JSON string but got `%s`", jsonObj.get("subLanguages").toString()));
          }

          // validate the optional field `subLanguages` (array)
          for (int i = 0; i < jsonArraysubLanguages.size(); i++) {
            Language.validateJsonElement(jsonArraysubLanguages.get(i));
          };
        }
      }
  }
