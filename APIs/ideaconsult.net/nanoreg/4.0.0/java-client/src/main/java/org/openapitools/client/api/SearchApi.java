...
public class SearchApi {
     ...
     */
    public okhttp3.Call solrqueryGetCall(String q, Integer start, Integer rows, String wt, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call solrqueryGetValidateBeforeCall(String q, Integer start, Integer rows, String wt, final ApiCallback _callback) throws ApiException {
        return solrqueryGetCall(q, start, rows, wt, _callback);
     ...
     */
    public SolrResponse solrqueryGet(String q, Integer start, Integer rows, String wt) throws ApiException {
        ApiResponse<SolrResponse> localVarResp = solrqueryGetWithHttpInfo(q, start, rows, wt);
     ...
     */
    public ApiResponse<SolrResponse> solrqueryGetWithHttpInfo(String q, Integer start, Integer rows, String wt) throws ApiException {
        okhttp3.Call localVarCall = solrqueryGetValidateBeforeCall(q, start, rows, wt, null);
     ...
     */
    public okhttp3.Call solrqueryGetAsync(String q, Integer start, Integer rows, String wt, final ApiCallback<SolrResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = solrqueryGetValidateBeforeCall(q, start, rows, wt, _callback);
        Type localVarReturnType = new TypeToken<SolrResponse>(){}.getType();
