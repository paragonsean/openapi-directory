...
void OAISearchApi::solrqueryGet(const ::OpenAPI::OptionalParam<QString> &q, const ::OpenAPI::OptionalParam<qint32> &start, const ::OpenAPI::OptionalParam<qint32> &rows, const ::OpenAPI::OptionalParam<QString> &wt) {
