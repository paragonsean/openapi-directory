...
<a id="solrqueryGet"></a>
# **solrqueryGet**
> SolrResponse solrqueryGet(q, fq, fl, start, rows, wt)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fq = "fq_example"; // String | Filter query
    String fl = "*"; // String | Field list
    Integer start = 0; // Integer | Starting page
    Integer rows = 10; // Integer | Page size
    String wt = "json"; // String | Response format
    try {
      SolrResponse result = apiInstance.solrqueryGet(q, fq, fl, start, rows, wt);
...
| **fl** | **String**| Field list | [optional] |
| **start** | **Integer**| Starting page | [optional] |
| **rows** | **Integer**| Page size | [optional] |
| **wt** | **String**| Response format | [optional] [default to xml] [enum: json, xml, csv] |
