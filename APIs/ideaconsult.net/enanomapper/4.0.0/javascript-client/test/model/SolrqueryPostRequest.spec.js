...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ENanoMapperDatabase.SolrqueryPostRequest();
  });
  ...
  describe('SolrqueryPostRequest', function() {
    it('should create an instance of SolrqueryPostRequest', function() {
      // uncomment below and update the code to test SolrqueryPostRequest
      //var instance = new ENanoMapperDatabase.SolrqueryPostRequest();
      //expect(instance).to.be.a(ENanoMapperDatabase.SolrqueryPostRequest);
    });
