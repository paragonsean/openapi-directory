...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoTvasApi.FirmwareRisk();
  });
  ...
  describe('FirmwareRisk', function() {
    it('should create an instance of FirmwareRisk', function() {
      // uncomment below and update the code to test FirmwareRisk
      //var instance = new IoTvasApi.FirmwareRisk();
      //expect(instance).to.be.a(IoTvasApi.FirmwareRisk);
    });

    it('should have the property riskSummary (base name: "risk_summary")', function() {
      // uncomment below and update the code to test the property riskSummary
      //var instance = new IoTvasApi.FirmwareRisk();
      //expect(instance).to.be();
    });

    it('should have the property vulnerableComponents (base name: "vulnerable_components")', function() {
      // uncomment below and update the code to test the property vulnerableComponents
      //var instance = new IoTvasApi.FirmwareRisk();
      //expect(instance).to.be();
    });
