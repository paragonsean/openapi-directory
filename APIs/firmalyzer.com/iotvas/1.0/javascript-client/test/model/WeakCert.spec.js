...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoTvasApi.WeakCert();
  });
  ...
  describe('WeakCert', function() {
    it('should create an instance of WeakCert', function() {
      // uncomment below and update the code to test WeakCert
      //var instance = new IoTvasApi.WeakCert();
      //expect(instance).to.be.a(IoTvasApi.WeakCert);
    });
    ...
    it('should have the property signAlgorithm (base name: "sign_algorithm")', function() {
      // uncomment below and update the code to test the property signAlgorithm
      //var instance = new IoTvasApi.WeakCert();
      //expect(instance).to.be();
    });
