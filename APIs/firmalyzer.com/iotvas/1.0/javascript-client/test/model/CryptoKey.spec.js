...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoTvasApi.CryptoKey();
  });
  ...
  describe('CryptoKey', function() {
    it('should create an instance of CryptoKey', function() {
      ...
      //var instance = new IoTvasApi.CryptoKey();
      //expect(instance).to.be.a(IoTvasApi.CryptoKey);
    });
    ...
    it('should have the property pemType (base name: "pem_type")', function() {
      // uncomment below and update the code to test the property pemType
      //var instance = new IoTvasApi.CryptoKey();
      //expect(instance).to.be();
    });
