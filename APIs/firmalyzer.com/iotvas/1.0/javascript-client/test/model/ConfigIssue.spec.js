...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoTvasApi.ConfigIssue();
  });
  ...
  describe('ConfigIssue', function() {
    it('should create an instance of ConfigIssue', function() {
      // uncomment below and update the code to test ConfigIssue
      //var instance = new IoTvasApi.ConfigIssue();
      //expect(instance).to.be.a(IoTvasApi.ConfigIssue);
    });

    it('should have the property configFile (base name: "config_file")', function() {
