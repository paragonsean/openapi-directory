...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IoTvasApi.DeviceApi();
  });
  ...
  describe('DeviceApi', function() {
    describe('detectDevice', function() {
      it('should call detectDevice successfully', function(done) {
        //uncomment below and update the code to test detectDevice
        //instance.detectDevice(function(error) {
