...
#ifndef OAIWeakCert_H
#define OAIWeakCert_H
...
class OAIWeakCert : public OAIObject {
public:
    OAIWeakCert();
    OAIWeakCert(QString json);
    ~OAIWeakCert() override;
    ...
    QString getSignAlgorithm() const;
    void setSignAlgorithm(const QString &sign_algorithm);
    bool is_sign_algorithm_Set() const;
    bool is_sign_algorithm_Valid() const;
...
private:
    ...
    QString m_sign_algorithm;
    bool m_sign_algorithm_isSet;
    bool m_sign_algorithm_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWeakCert)
