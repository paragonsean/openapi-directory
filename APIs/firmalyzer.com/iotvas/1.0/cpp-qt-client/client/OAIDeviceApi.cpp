...
void OAIDeviceApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("detectDevice", defaultConf);
    _serverIndices.insert("detectDevice", 0);
}
...
void OAIDeviceApi::detectDevice(const OAIDeviceFeatures &oai_device_features) {
    QString fullPath = QString(_serverConfigs["detectDevice"][_serverIndices.value("detectDevice")].URL()+"/device/detect");
...

    {
        ...
        QByteArray output = oai_device_features.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDeviceApi::detectDeviceCallback);
...
void OAIDeviceApi::detectDeviceCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT detectDeviceSignal(output);
        Q_EMIT detectDeviceSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT detectDeviceSignalE(output, error_type, error_str);
        Q_EMIT detectDeviceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT detectDeviceSignalError(output, error_type, error_str);
        Q_EMIT detectDeviceSignalErrorFull(worker, error_type, error_str);
    }
}
