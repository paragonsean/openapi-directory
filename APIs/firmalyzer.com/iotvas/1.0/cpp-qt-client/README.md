...
#include <iostream>
#include "../client/OAIDeviceApi.h"

using namespace test_namespace;

class Example : public QObject {
    Q_OBJECT
    OAIDeviceFeatures create();
public Q_SLOTS:
...
OAIDeviceFeatures Example::create(){
    OAIDeviceFeatures obj;
 return obj;
}

void Example::exampleFunction1(){
     OAIDeviceApi apiInstance;
     
      // Configure API key authorization: api-key-header
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAIDeviceApi::detectDeviceSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDeviceApi::detectDeviceSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIDeviceFeatures oai_device_features = create(); // OAIDeviceFeatures | 
      apiInstance.detectDevice(oai_device_features);
