...
/**
 * API tests for GlobalWineScoreApi
 */
@Disabled
public class GlobalWineScoreApiTest {

    private final GlobalWineScoreApi api = new GlobalWineScoreApi();
     ...
     */
    @Test
    public void globalwinescoresLatestGetTest() throws ApiException {
        String authorization = null;
        List<Integer> wineId = null;
        String vintage = null;
        String color = null;
        Boolean isPrimeurs = null;
        String lwin = null;
        String lwin11 = null;
        Integer limit = null;
        Integer offset = null;
        String ordering = null;
        api.globalwinescoresLatestGet(authorization, wineId, vintage, color, isPrimeurs, lwin, lwin11, limit, offset, ordering);
     ...
     */
    @Test
    public void listHistoricalGWSTest() throws ApiException {
        String authorization = null;
        List<Integer> wineId = null;
        String vintage = null;
        String color = null;
        ...
        Integer offset = null;
        String ordering = null;
        api.listHistoricalGWS(authorization, wineId, vintage, color, isPrimeurs, lwin, lwin11, limit, offset, ordering);
        // TODO: test validations
    }
