...
public class OauthTokenPost200Response {
  public static final String SERIALIZED_NAME_ACCESS_TOEKN = "access_toekn";
  @SerializedName(SERIALIZED_NAME_ACCESS_TOEKN)
  ...
  public OauthTokenPost200Response accessToekn(String accessToekn) {
  ...
  public OauthTokenPost200Response expiresIn(String expiresIn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessToekn, oauthTokenPost200Response.accessToekn) &&
        Objects.equals(this.expiresIn, oauthTokenPost200Response.expiresIn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToekn, expiresIn);
  }
  ...
  public String toString() {
    ...
    sb.append("    accessToekn: ").append(toIndentedString(accessToekn)).append("\n");
  ...
  static {
    ...
    openapiFields.add("access_toekn");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("access_toekn") != null && !jsonObj.get("access_toekn").isJsonNull()) && !jsonObj.get("access_toekn").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `access_toekn` to be a primitive type in the JSON string but got `%s`", jsonObj.get("access_toekn").toString()));
      }
