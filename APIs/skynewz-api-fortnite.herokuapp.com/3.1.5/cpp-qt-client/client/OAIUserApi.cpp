...
void OAIUserApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("userPlateformUsernameGet", defaultConf);
    _serverIndices.insert("userPlateformUsernameGet", 0);
}
...
void OAIUserApi::userPlateformUsernameGet(const QString &plateform, const QString &username) {
    QString fullPath = QString(_serverConfigs["userPlateformUsernameGet"][_serverIndices.value("userPlateformUsernameGet")].URL()+"/user/{plateform}/{username}");
    ...
    {
        QString plateformPathParam("{");
        plateformPathParam.append("plateform").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "plateform", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"plateform"+pathSuffix : pathPrefix;
        fullPath.replace(plateformPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(plateform)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUserApi::userPlateformUsernameGetCallback);
...
void OAIUserApi::userPlateformUsernameGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_user__plateform___username__get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT userPlateformUsernameGetSignal(output);
        Q_EMIT userPlateformUsernameGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT userPlateformUsernameGetSignalE(output, error_type, error_str);
        Q_EMIT userPlateformUsernameGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT userPlateformUsernameGetSignalError(output, error_type, error_str);
        Q_EMIT userPlateformUsernameGetSignalErrorFull(worker, error_type, error_str);
    }
}
