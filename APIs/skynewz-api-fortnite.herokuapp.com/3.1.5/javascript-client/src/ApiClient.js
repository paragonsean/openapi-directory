...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://skynewz-api-fortnite.herokuapp.com/api') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://skynewz-api-fortnite.herokuapp.com/api
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://skynewz-api-fortnite.herokuapp.com/api",
