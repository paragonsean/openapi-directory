...
/**
 * The WebhookImage model module.
 * @module model/WebhookImage
 * @version 1.0
 */
class WebhookImage {
    /**
     * Constructs a new <code>WebhookImage</code>.
     * 
     * @alias module:model/WebhookImage
     */
    constructor() { 
        
        WebhookImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookImage} obj Optional instance to populate.
     * @return {module:model/WebhookImage} The populated <code>WebhookImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookImage();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookImage</code>.
     */
 ...
 */
WebhookImage.prototype['caption'] = undefined;

/**
 * Absolute filename and location on media volume. This parameter is deprecated.
 * @member {String} file
 */
WebhookImage.prototype['file'] = undefined;

/**
 * ID of the media. Can be used to delete the media if stored locally on the client.
 * @member {String} id
 */
WebhookImage.prototype['id'] = undefined;

/**
 * @member {String} link
 */
WebhookImage.prototype['link'] = undefined;

/**
 * Mime type of media
 * @member {String} mime_type
 */
WebhookImage.prototype['mime_type'] = undefined;

/**
 * Checksum
 * @member {String} sha256
 */
WebhookImage.prototype['sha256'] = undefined;
