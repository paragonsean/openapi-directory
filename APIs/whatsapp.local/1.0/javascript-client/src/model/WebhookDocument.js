...
/**
 * The WebhookDocument model module.
 * @module model/WebhookDocument
 * @version 1.0
 */
class WebhookDocument {
    /**
     * Constructs a new <code>WebhookDocument</code>.
     * 
     * @alias module:model/WebhookDocument
     */
    constructor() { 
        
        WebhookDocument.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookDocument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookDocument} obj Optional instance to populate.
     * @return {module:model/WebhookDocument} The populated <code>WebhookDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookDocument();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookDocument</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookDocument</code>.
     */
 ...
 */
WebhookDocument.prototype['caption'] = undefined;

/**
 * Absolute filename and location on media volume. This parameter is deprecated.
 * @member {String} file
 */
WebhookDocument.prototype['file'] = undefined;

/**
 * Filename on the sender's device. This will only be present in audio and document media messages.
 * @member {String} filename
 */
WebhookDocument.prototype['filename'] = undefined;

/**
 * ID of the media. Can be used to delete the media if stored locally on the client.
 * @member {String} id
 */
WebhookDocument.prototype['id'] = undefined;

/**
 * @member {String} link
 */
WebhookDocument.prototype['link'] = undefined;

/**
 * Mime type of media
 * @member {String} mime_type
 */
WebhookDocument.prototype['mime_type'] = undefined;

/**
 * Checksum
 * @member {String} sha256
 */
WebhookDocument.prototype['sha256'] = undefined;
...
export default WebhookDocument;
