...
/**
 * The WebhookVideo model module.
 * @module model/WebhookVideo
 * @version 1.0
 */
class WebhookVideo {
    /**
     * Constructs a new <code>WebhookVideo</code>.
     * 
     * @alias module:model/WebhookVideo
     */
    constructor() { 
        
        WebhookVideo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookVideo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookVideo} obj Optional instance to populate.
     * @return {module:model/WebhookVideo} The populated <code>WebhookVideo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookVideo();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookVideo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookVideo</code>.
     */
 ...
 */
WebhookVideo.prototype['caption'] = undefined;

/**
 * Absolute filename and location on media volume. This parameter is deprecated.
 * @member {String} file
 */
WebhookVideo.prototype['file'] = undefined;

/**
 * ID of the media. Can be used to delete the media if stored locally on the client.
 * @member {String} id
 */
WebhookVideo.prototype['id'] = undefined;

/**
 * @member {String} link
 */
WebhookVideo.prototype['link'] = undefined;

/**
 * Mime type of media
 * @member {String} mime_type
 */
WebhookVideo.prototype['mime_type'] = undefined;

/**
 * Checksum
 * @member {String} sha256
 */
WebhookVideo.prototype['sha256'] = undefined;
