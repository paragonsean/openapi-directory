    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('groups')) {
                obj['groups'] = ApiClient.convertToType(data['groups'], [GroupInfo]);
            }
        }
        return obj;
    }
 ...
 */
GroupResponse.prototype['errors'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
GroupResponse.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/GroupInfo>} groups
 */
GroupResponse.prototype['groups'] = undefined;
