# WhatsAppBusinessApi.ApplicationSettings
...
**callbackPersist** | **Boolean** | Stores callbacks on disk until they are successfully acknowledged by the Webhook or not. Restart required. | [optional] [default to true]
**heartbeatInterval** | **Number** | Multiconnect: Interval of the Master node monitoring of Coreapp nodes in seconds | [optional] [default to 5]
**maxCallbackBackoffDelayMs** | **String** | Maximum delay for a failed callback in milliseconds | [optional] [default to &#39;900000&#39;]
...
**sentStatus** | **Boolean** | Receive a notification that a message is sent to server. When true, you will receive a message indicating that a message has been sent. If false (default), you will not receive notification. | [optional] [default to false]
**unhealthyInterval** | **Number** | Multiconnect: Maximum amount of seconds a Master node waits for a Coreapp node to respond to a heartbeat before considering it unhealthy and starting the failover process. | [optional] [default to 30]
