...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsAppBusinessApi.WebhookEvent();
  });
  ...
  describe('WebhookEvent', function() {
    it('should create an instance of WebhookEvent', function() {
      ...
      //var instance = new WhatsAppBusinessApi.WebhookEvent();
      //expect(instance).to.be.a(WhatsAppBusinessApi.WebhookEvent);
    });
