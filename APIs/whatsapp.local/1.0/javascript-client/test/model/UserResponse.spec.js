...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsAppBusinessApi.UserResponse();
  });
  ...
  describe('UserResponse', function() {
    it('should create an instance of UserResponse', function() {
      ...
      //var instance = new WhatsAppBusinessApi.UserResponse();
      //expect(instance).to.be.a(WhatsAppBusinessApi.UserResponse);
    });
