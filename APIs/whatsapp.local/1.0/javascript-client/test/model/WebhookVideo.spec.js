...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsAppBusinessApi.WebhookVideo();
  });
  ...
  describe('WebhookVideo', function() {
    it('should create an instance of WebhookVideo', function() {
      // uncomment below and update the code to test WebhookVideo
      //var instance = new WhatsAppBusinessApi.WebhookVideo();
      //expect(instance).to.be.a(WhatsAppBusinessApi.WebhookVideo);
    });
