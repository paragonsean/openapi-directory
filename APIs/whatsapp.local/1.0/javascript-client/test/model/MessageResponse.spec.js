...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsAppBusinessApi.MessageResponse();
  });
  ...
  describe('MessageResponse', function() {
    it('should create an instance of MessageResponse', function() {
      ...
      //var instance = new WhatsAppBusinessApi.MessageResponse();
      //expect(instance).to.be.a(WhatsAppBusinessApi.MessageResponse);
    });
