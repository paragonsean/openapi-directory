...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsAppBusinessApi.WebhookImage();
  });
  ...
  describe('WebhookImage', function() {
    it('should create an instance of WebhookImage', function() {
      // uncomment below and update the code to test WebhookImage
      //var instance = new WhatsAppBusinessApi.WebhookImage();
      //expect(instance).to.be.a(WhatsAppBusinessApi.WebhookImage);
    });
