...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsAppBusinessApi.WebhookDocument();
  });
  ...
  describe('WebhookDocument', function() {
    it('should create an instance of WebhookDocument', function() {
      // uncomment below and update the code to test WebhookDocument
      //var instance = new WhatsAppBusinessApi.WebhookDocument();
      //expect(instance).to.be.a(WhatsAppBusinessApi.WebhookDocument);
    });
