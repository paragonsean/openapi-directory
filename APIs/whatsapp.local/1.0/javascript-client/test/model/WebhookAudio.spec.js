...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatsAppBusinessApi.WebhookAudio();
  });
  ...
  describe('WebhookAudio', function() {
    it('should create an instance of WebhookAudio', function() {
      // uncomment below and update the code to test WebhookAudio
      //var instance = new WhatsAppBusinessApi.WebhookAudio();
      //expect(instance).to.be.a(WhatsAppBusinessApi.WebhookAudio);
    });
