...
public class Example {
  public static void main(String[] args) {
    ...
    HealthApi apiInstance = new HealthApi(defaultClient);
    String format = "prometheus"; // String | 
    try {
      Object result = apiInstance.getAppStats(format);
...
public class Example {
  public static void main(String[] args) {
    ...
    String format = "prometheus"; // String | 
    try {
      Object result = apiInstance.getDbStats(format);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String format = "prometheus"; // String | 
    try {
      Object result = apiInstance.getMetrics(format);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling HealthApi#getMetrics");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    HealthApi apiInstance = new HealthApi(defaultClient);
    try {
      Object result = apiInstance.getSupportInfo();
      System.out.println(result);
    } catch (ApiException e) {
