...
public class Meta {
   ...
   */
  @JsonAdapter(ApiStatusEnum.Adapter.class)
  public enum ApiStatusEnum {
    ...
    public static class Adapter extends TypeAdapter<ApiStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ApiStatusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ApiStatusEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ApiStatusEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ApiStatusEnum.fromValue(value);
    }
  }
  ...
  public Meta apiStatus(ApiStatusEnum apiStatus) {
  ...
  public boolean equals(Object o) {
    ...
    Meta meta = (Meta) o;
    return Objects.equals(this.apiStatus, meta.apiStatus) &&
        Objects.equals(this.version, meta.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiStatus, version);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("api_status") != null && !jsonObj.get("api_status").isJsonNull()) && !jsonObj.get("api_status").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `api_status` to be a primitive type in the JSON string but got `%s`", jsonObj.get("api_status").toString()));
      }
      // validate the optional field `api_status`
      if (jsonObj.get("api_status") != null && !jsonObj.get("api_status").isJsonNull()) {
        ApiStatusEnum.validateJsonElement(jsonObj.get("api_status"));
      }
