...
/*
 * OAIVideoByProvider.h
 *
 * 
 */

#ifndef OAIVideoByProvider_H
#define OAIVideoByProvider_H
...
class OAIVideoByProvider : public OAIObject {
public:
    OAIVideoByProvider();
    OAIVideoByProvider(QString json);
    ~OAIVideoByProvider() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoByProvider)

#endif // OAIVideoByProvider_H
