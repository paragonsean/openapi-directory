...
#ifndef OAIWebhook_Video_H
#define OAIWebhook_Video_H
...
class OAIWebhook_Video : public OAIObject {
public:
    OAIWebhook_Video();
    OAIWebhook_Video(QString json);
    ~OAIWebhook_Video() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_Video)

#endif // OAIWebhook_Video_H
