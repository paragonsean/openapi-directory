...
/*
 * OAIDocumentByProvider.h
 *
 * 
 */

#ifndef OAIDocumentByProvider_H
#define OAIDocumentByProvider_H
...
class OAIDocumentByProvider : public OAIObject {
public:
    OAIDocumentByProvider();
    OAIDocumentByProvider(QString json);
    ~OAIDocumentByProvider() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentByProvider)

#endif // OAIDocumentByProvider_H
