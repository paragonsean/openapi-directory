...
#ifndef OAIWebhook_Voice_H
#define OAIWebhook_Voice_H
...
class OAIWebhook_Voice : public OAIObject {
public:
    OAIWebhook_Voice();
    OAIWebhook_Voice(QString json);
    ~OAIWebhook_Voice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_Voice)

#endif // OAIWebhook_Voice_H
