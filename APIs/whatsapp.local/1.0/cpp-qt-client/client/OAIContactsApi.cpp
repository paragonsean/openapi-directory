...
void OAIContactsApi::initializeServerConfigs() {
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("checkContact", defaultConf);
    _serverIndices.insert("checkContact", 0);
}
...
void OAIContactsApi::checkContact(const OAICheck_Contact_Request_Body &oai_check_contact_request_body) {
    QString fullPath = QString(_serverConfigs["checkContact"][_serverIndices.value("checkContact")].URL()+"/contacts");
...

    {
        ...
        QByteArray output = oai_check_contact_request_body.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIContactsApi::checkContactCallback);
...
void OAIContactsApi::checkContactCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICheck_Contact_Response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT checkContactSignal(output);
        Q_EMIT checkContactSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT checkContactSignalE(output, error_type, error_str);
        Q_EMIT checkContactSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT checkContactSignalError(output, error_type, error_str);
        Q_EMIT checkContactSignalErrorFull(worker, error_type, error_str);
    }
}
