...
#ifndef OAIWebhook_Image_H
#define OAIWebhook_Image_H
...
class OAIWebhook_Image : public OAIObject {
public:
    OAIWebhook_Image();
    OAIWebhook_Image(QString json);
    ~OAIWebhook_Image() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_Image)

#endif // OAIWebhook_Image_H
