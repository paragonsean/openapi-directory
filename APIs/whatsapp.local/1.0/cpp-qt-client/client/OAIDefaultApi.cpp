...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("deleteProfilePhoto", defaultConf);
    _serverIndices.insert("deleteProfilePhoto", 0);
}
...
void OAIDefaultApi::deleteProfilePhoto() {
    QString fullPath = QString(_serverConfigs["deleteProfilePhoto"][_serverIndices.value("deleteProfilePhoto")].URL()+"/settings/profile/photo");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::deleteProfilePhotoCallback);
...
void OAIDefaultApi::deleteProfilePhotoCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteProfilePhotoSignal();
        Q_EMIT deleteProfilePhotoSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteProfilePhotoSignalE(error_type, error_str);
        Q_EMIT deleteProfilePhotoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteProfilePhotoSignalError(error_type, error_str);
        Q_EMIT deleteProfilePhotoSignalErrorFull(worker, error_type, error_str);
    }
}
