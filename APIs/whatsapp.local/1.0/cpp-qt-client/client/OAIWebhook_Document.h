...
/*
 * OAIWebhook_Document.h
 *
 * 
 */

#ifndef OAIWebhook_Document_H
#define OAIWebhook_Document_H
...
class OAIWebhook_Document : public OAIObject {
public:
    OAIWebhook_Document();
    OAIWebhook_Document(QString json);
    ~OAIWebhook_Document() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhook_Document)

#endif // OAIWebhook_Document_H
