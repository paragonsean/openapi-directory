...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Contribly.UserApi();
  });
  ...
  describe('UserApi', function() {
    ...
    describe('usersIdLinkedTypeGet', function() {
      it('should call usersIdLinkedTypeGet successfully', function(done) {
        //uncomment below and update the code to test usersIdLinkedTypeGet
        //instance.usersIdLinkedTypeGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
