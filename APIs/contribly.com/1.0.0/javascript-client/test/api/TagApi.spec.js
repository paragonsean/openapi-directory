...
(function(root, factory) {
  ...
  describe('TagApi', function() {
    ...
    describe('tagsetsGet', function() {
      it('should call tagsetsGet successfully', function(done) {
        //uncomment below and update the code to test tagsetsGet
        //instance.tagsetsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('tagsetsIdGet', function() {
      it('should call tagsetsIdGet successfully', function(done) {
        //uncomment below and update the code to test tagsetsIdGet
        //instance.tagsetsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('tagsetsPost', function() {
      it('should call tagsetsPost successfully', function(done) {
        //uncomment below and update the code to test tagsetsPost
        //instance.tagsetsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
