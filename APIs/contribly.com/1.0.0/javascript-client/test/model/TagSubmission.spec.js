...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Contribly.TagSubmission();
  });
  ...
  describe('TagSubmission', function() {
    it('should create an instance of TagSubmission', function() {
      // uncomment below and update the code to test TagSubmission
      //var instance = new Contribly.TagSubmission();
      //expect(instance).to.be.a(Contribly.TagSubmission);
    });
