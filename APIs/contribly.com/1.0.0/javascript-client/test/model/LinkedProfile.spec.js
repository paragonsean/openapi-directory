...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Contribly.LinkedProfile();
  });
  ...
  describe('LinkedProfile', function() {
    it('should create an instance of LinkedProfile', function() {
      // uncomment below and update the code to test LinkedProfile
      //var instance = new Contribly.LinkedProfile();
      //expect(instance).to.be.a(Contribly.LinkedProfile);
    });
