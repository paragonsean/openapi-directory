...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Contribly.MediaUsage();
  });
  ...
  describe('MediaUsage', function() {
    it('should create an instance of MediaUsage', function() {
      // uncomment below and update the code to test MediaUsage
      //var instance = new Contribly.MediaUsage();
      //expect(instance).to.be.a(Contribly.MediaUsage);
    });
