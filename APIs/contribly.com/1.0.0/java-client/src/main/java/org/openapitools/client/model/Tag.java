...
public class Tag {
  ...
  public Tag tagSet(TagSet tagSet) {
    this.tagSet = tagSet;
    return this;
  }
  ...
  public Tag urlWords(String urlWords) {
  ...
  public boolean equals(Object o) {
    ...
    Tag tag = (Tag) o;
    return Objects.equals(this.colour, tag.colour) &&
        Objects.equals(this.id, tag.id) &&
        Objects.equals(this.name, tag.name) &&
        Objects.equals(this.tagSet, tag.tagSet) &&
        Objects.equals(this.urlWords, tag.urlWords);
  }

  @Override
  public int hashCode() {
    return Objects.hash(colour, id, name, tagSet, urlWords);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("tagSet") != null && !jsonObj.get("tagSet").isJsonNull()) {
        TagSet.validateJsonElement(jsonObj.get("tagSet"));
      }
