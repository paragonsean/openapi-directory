...
export default class AuthApi {
    ...
    */
     ...
     * @callback module:api/AuthApi~postOauthAccessTokenCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AccessTokenResponseV2} data The data returned by the service call.
     ...
     * @param {module:model/AccessTokenRequestV2} body Get an access token
     * @param {module:api/AuthApi~postOauthAccessTokenCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AccessTokenResponseV2}
     */
    postOauthAccessToken(body, callback) {
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling postOauthAccessToken");
      }
      ...
      let returnType = AccessTokenResponseV2;
