...
export default class TrackingApi {
    ...
    */
     ...
     * @callback module:api/TrackingApi~getTrackCallback
     ...
     * @param {module:api/TrackingApi~getTrackCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TrackingResponse}
     */
    getTrack(opts, callback) {
      opts = opts || {};
      let postBody = null;
