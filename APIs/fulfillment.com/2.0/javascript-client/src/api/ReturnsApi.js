...
export default class ReturnsApi {
    ...
    */
     ...
     * @param {module:model/ReturnsArrayV2} data The data returned by the service call.
     ...
     * @param {Number} [page = 1)] A multiplier of the number of items (limit parameter) to skip before returning results
     * @param {Number} [limit = 80)] The numbers of items to return
     ...
     * data is of type: {@link module:model/ReturnsArrayV2}
     */
    getReturns(fromDate, toDate, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'fromDate' is set
      if (fromDate === undefined || fromDate === null) {
        throw new Error("Missing the required parameter 'fromDate' when calling getReturns");
      }
      // verify the required parameter 'toDate' is set
      if (toDate === undefined || toDate === null) {
        throw new Error("Missing the required parameter 'toDate' when calling getReturns");
      }
      ...
      let authNames = ['fdcAuth', 'fdcAuth'];
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ReturnsArrayV2;
    ...
    /**
     * Callback function to receive the result of the putReturns operation.
     * @callback module:api/ReturnsApi~putReturnsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RmaResponseV2} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/RmaRequestV2} rmaRequestV2 RMA
     * @param {module:api/ReturnsApi~putReturnsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RmaResponseV2}
     */
    putReturns(rmaRequestV2, callback) {
      let postBody = rmaRequestV2;
      // verify the required parameter 'rmaRequestV2' is set
      if (rmaRequestV2 === undefined || rmaRequestV2 === null) {
        throw new Error("Missing the required parameter 'rmaRequestV2' when calling putReturns");
      }
