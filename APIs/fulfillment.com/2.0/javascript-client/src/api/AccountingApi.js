...
export default class AccountingApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAccounting operation.
     * @callback module:api/AccountingApi~getAccountingCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AccountingArrayV2} data The data returned by the service call.
     ...
     * @param {Array.<module:model/String>} hydrate Adds additional information to the response, uses a CSV format for multiple values.
     ...
     * @param {module:api/AccountingApi~getAccountingCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AccountingArrayV2}
     */
    getAccounting(fromDate, toDate, hydrate, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'fromDate' is set
      if (fromDate === undefined || fromDate === null) {
        throw new Error("Missing the required parameter 'fromDate' when calling getAccounting");
      }
      // verify the required parameter 'toDate' is set
      if (toDate === undefined || toDate === null) {
        throw new Error("Missing the required parameter 'toDate' when calling getAccounting");
      }
      // verify the required parameter 'hydrate' is set
      if (hydrate === undefined || hydrate === null) {
        throw new Error("Missing the required parameter 'hydrate' when calling getAccounting");
      }
      ...
      let queryParams = {
        ...
        'hydrate': this.apiClient.buildCollectionParam(hydrate, 'multi')
      };
      let headerParams = {
      };
      let formParams = {
      ...
      let returnType = AccountingArrayV2;
