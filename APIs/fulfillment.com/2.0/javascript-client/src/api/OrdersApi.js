    ...
    */
    ...
    deleteOrdersId(id, callback) {
      ...
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteOrdersId");
      }
    ...
    getOrders(fromDate, toDate, opts, callback) {
      ...
      if (fromDate === undefined || fromDate === null) {
        throw new Error("Missing the required parameter 'fromDate' when calling getOrders");
      }
      // verify the required parameter 'toDate' is set
      if (toDate === undefined || toDate === null) {
        throw new Error("Missing the required parameter 'toDate' when calling getOrders");
      }
     ...
     * @param {module:model/OrderRequestV2} body The order to create
