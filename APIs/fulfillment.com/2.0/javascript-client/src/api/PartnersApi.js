...
export default class PartnersApi {
    ...
    */
     ...
     * @param {module:model/OrderShipV2} body Shipping Details
     ...
     */
    putOrdersIdShip(id, body, callback) {
      let postBody = body;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling putOrdersIdShip");
      }
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling putOrdersIdShip");
      }
     ...
     * Note, this API is used to update orders and is reserved for our shipping partners.
     * @param {Number} id The FDC order Id
     * @param {module:model/StatusTypeSimpleV2} body New status event
     ...
     * data is of type: {@link Object}
     */
    putOrdersIdStatus(id, body, callback) {
      let postBody = body;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling putOrdersIdStatus");
      }
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling putOrdersIdStatus");
      }
