...
/**
 * The OrderRequestV2ItemsInner model module.
 * @module model/OrderRequestV2ItemsInner
 * @version 2.0
 */
class OrderRequestV2ItemsInner {
    /**
     * Constructs a new <code>OrderRequestV2ItemsInner</code>.
     * @alias module:model/OrderRequestV2ItemsInner
     * @param declaredValue {Number} Using USD, a per unit value of a single SKU. If your declaring a kit this is the sum total for a single kit. In both scenarios we will multiply the `declaredValue` against the `quantity` for customs declaration.
     * @param quantity {Number} 
     * @param sku {String} 
     */
    constructor(declaredValue, quantity, sku) { 
        
        OrderRequestV2ItemsInner.initialize(this, declaredValue, quantity, sku);
    }
     ...
     */
    static initialize(obj, declaredValue, quantity, sku) { 
        obj['declaredValue'] = declaredValue;
        obj['quantity'] = quantity;
        obj['sku'] = sku;
    }

    /**
     * Constructs a <code>OrderRequestV2ItemsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderRequestV2ItemsInner} obj Optional instance to populate.
     * @return {module:model/OrderRequestV2ItemsInner} The populated <code>OrderRequestV2ItemsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderRequestV2ItemsInner();

            if (data.hasOwnProperty('declaredValue')) {
                obj['declaredValue'] = ApiClient.convertToType(data['declaredValue'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderRequestV2ItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderRequestV2ItemsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderRequestV2ItemsInner.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['declaredValue'] && !(typeof data['declaredValue'] === 'string' || data['declaredValue'] instanceof String)) {
            throw new Error("Expected the field `declaredValue` to be a primitive type in the JSON string but got " + data['declaredValue']);
        }
        // ensure the json data is a string
...
OrderRequestV2ItemsInner.RequiredProperties = ["declaredValue", "quantity", "sku"];
 ...
 * @member {Number} declaredValue
 */
OrderRequestV2ItemsInner.prototype['declaredValue'] = undefined;

/**
 * @member {Number} quantity
 */
OrderRequestV2ItemsInner.prototype['quantity'] = undefined;

/**
 * @member {String} sku
 */
OrderRequestV2ItemsInner.prototype['sku'] = undefined;
...
export default OrderRequestV2ItemsInner;
