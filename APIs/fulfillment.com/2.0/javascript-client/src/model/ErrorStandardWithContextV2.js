...
/**
 * The ErrorStandardWithContextV2 model module.
 * @module model/ErrorStandardWithContextV2
 * @version 2.0
 */
class ErrorStandardWithContextV2 {
    /**
     * Constructs a new <code>ErrorStandardWithContextV2</code>.
     * @alias module:model/ErrorStandardWithContextV2
     */
    constructor() { 
        
        ErrorStandardWithContextV2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ErrorStandardWithContextV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorStandardWithContextV2} obj Optional instance to populate.
     * @return {module:model/ErrorStandardWithContextV2} The populated <code>ErrorStandardWithContextV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorStandardWithContextV2();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorStandardWithContextV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorStandardWithContextV2</code>.
     */
...
/**
 * @member {Array.<Object>} context
 */
ErrorStandardWithContextV2.prototype['context'] = undefined;

/**
 * @member {String} message
 */
ErrorStandardWithContextV2.prototype['message'] = undefined;
...
export default ErrorStandardWithContextV2;
