...
import AccountingV2Fees from './AccountingV2Fees';
import AccountingV2ItemsInner from './AccountingV2ItemsInner';
import AccountingV2Merchant from './AccountingV2Merchant';
import AccountingV2Order from './AccountingV2Order';
import AccountingV2Warehouse from './AccountingV2Warehouse';

/**
 * The AccountingV2 model module.
 * @module model/AccountingV2
 * @version 2.0
 */
class AccountingV2 {
    /**
     * Constructs a new <code>AccountingV2</code>.
     * @alias module:model/AccountingV2
     */
    constructor() { 
        
        AccountingV2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountingV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountingV2} obj Optional instance to populate.
     * @return {module:model/AccountingV2} The populated <code>AccountingV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountingV2();

            if (data.hasOwnProperty('fees')) {
                obj['fees'] = AccountingV2Fees.constructFromObject(data['fees']);
            }
            if (data.hasOwnProperty('itemCount')) {
                obj['itemCount'] = ApiClient.convertToType(data['itemCount'], 'Number');
            }
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [AccountingV2ItemsInner]);
            }
            if (data.hasOwnProperty('merchant')) {
                obj['merchant'] = AccountingV2Merchant.constructFromObject(data['merchant']);
            }
            if (data.hasOwnProperty('order')) {
                obj['order'] = AccountingV2Order.constructFromObject(data['order']);
            }
            if (data.hasOwnProperty('warehouse')) {
                obj['warehouse'] = AccountingV2Warehouse.constructFromObject(data['warehouse']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountingV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountingV2</code>.
     */
    static validateJSON(data) {
        // validate the optional field `fees`
        if (data['fees']) { // data not null
          AccountingV2Fees.validateJSON(data['fees']);
        }
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                AccountingV2ItemsInner.validateJSON(item);
            };
        }
        // validate the optional field `merchant`
        if (data['merchant']) { // data not null
          AccountingV2Merchant.validateJSON(data['merchant']);
        }
        // validate the optional field `order`
        if (data['order']) { // data not null
          AccountingV2Order.validateJSON(data['order']);
        }
        // validate the optional field `warehouse`
        if (data['warehouse']) { // data not null
          AccountingV2Warehouse.validateJSON(data['warehouse']);
        }
...
/**
 * @member {module:model/AccountingV2Fees} fees
 */
AccountingV2.prototype['fees'] = undefined;

/**
 * Total number of items accounted for
 * @member {Number} itemCount
 */
AccountingV2.prototype['itemCount'] = undefined;

/**
 * @member {Array.<module:model/AccountingV2ItemsInner>} items
 */
AccountingV2.prototype['items'] = undefined;

/**
 * @member {module:model/AccountingV2Merchant} merchant
 */
AccountingV2.prototype['merchant'] = undefined;

/**
 * @member {module:model/AccountingV2Order} order
 */
AccountingV2.prototype['order'] = undefined;

/**
 * @member {module:model/AccountingV2Warehouse} warehouse
 */
AccountingV2.prototype['warehouse'] = undefined;
