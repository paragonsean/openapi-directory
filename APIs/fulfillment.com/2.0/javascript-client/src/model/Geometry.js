...
class Geometry {
     ...
     * @param coordinates {module:model/GeometryCoordinates} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('coordinates')) {
                obj['coordinates'] = GeometryCoordinates.constructFromObject(data['coordinates']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['coordinates']) { // data not null
          GeometryCoordinates.validateJSON(data['coordinates']);
        }
...
/**
 * @member {module:model/GeometryCoordinates} coordinates
 */
