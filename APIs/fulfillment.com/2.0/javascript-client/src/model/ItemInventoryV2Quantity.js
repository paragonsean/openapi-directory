...
import ItemInventoryV2QuantityTotal from './ItemInventoryV2QuantityTotal';

/**
 * The ItemInventoryV2Quantity model module.
 * @module model/ItemInventoryV2Quantity
 * @version 2.0
 */
class ItemInventoryV2Quantity {
    /**
     * Constructs a new <code>ItemInventoryV2Quantity</code>.
     * @alias module:model/ItemInventoryV2Quantity
     */
    constructor() { 
        
        ItemInventoryV2Quantity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemInventoryV2Quantity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemInventoryV2Quantity} obj Optional instance to populate.
     * @return {module:model/ItemInventoryV2Quantity} The populated <code>ItemInventoryV2Quantity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryV2Quantity();

            if (data.hasOwnProperty('total')) {
                obj['total'] = ItemInventoryV2QuantityTotal.constructFromObject(data['total']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemInventoryV2Quantity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemInventoryV2Quantity</code>.
     */
    static validateJSON(data) {
        // validate the optional field `total`
        if (data['total']) { // data not null
          ItemInventoryV2QuantityTotal.validateJSON(data['total']);
        }
...
/**
 * @member {module:model/ItemInventoryV2QuantityTotal} total
 */
ItemInventoryV2Quantity.prototype['total'] = undefined;
...
export default ItemInventoryV2Quantity;
