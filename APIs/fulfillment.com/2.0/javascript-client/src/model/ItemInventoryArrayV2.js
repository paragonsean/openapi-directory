...
class ItemInventoryArrayV2 {
    ...
    constructor() { 
        ...
        ItemInventoryArrayV2.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemInventoryArrayV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemInventoryArrayV2</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ItemInventoryV2.validateJSON(item);
            };
        }
 ...
 */
ItemInventoryArrayV2.prototype['data'] = undefined;

/**
 * @member {module:model/AccountingArrayV2Meta} meta
 */
ItemInventoryArrayV2.prototype['meta'] = undefined;
...
export default ItemInventoryArrayV2;
