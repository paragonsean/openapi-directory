...
import OrderRequestV2ItemsInner from './OrderRequestV2ItemsInner';
import OrderRequestV2Warehouse from './OrderRequestV2Warehouse';
...
class OrderRequestV2 {
     ...
     * @param items {Array.<module:model/OrderRequestV2ItemsInner>} 
     ...
     */
    constructor(items, merchantOrderId, recipient, shippingMethod) { 
        
        OrderRequestV2.initialize(this, items, merchantOrderId, recipient, shippingMethod);
    }
     ...
     */
    static initialize(obj, items, merchantOrderId, recipient, shippingMethod) { 
        obj['items'] = items;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [OrderRequestV2ItemsInner]);
            }
            ...
            if (data.hasOwnProperty('warehouse')) {
                obj['warehouse'] = OrderRequestV2Warehouse.constructFromObject(data['warehouse']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderRequestV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderRequestV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderRequestV2.RequiredProperties) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                OrderRequestV2ItemsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['recipient']) { // data not null
          ConsigneeNewV2.validateJSON(data['recipient']);
        }
        // ensure the json data is a string
        ...
        if (data['warehouse']) { // data not null
          OrderRequestV2Warehouse.validateJSON(data['warehouse']);
        }
...
OrderRequestV2.RequiredProperties = ["items", "merchantOrderId", "recipient", "shippingMethod"];
 ...
 */
OrderRequestV2.prototype['integrator'] = undefined;

/**
 * @member {Array.<module:model/OrderRequestV2ItemsInner>} items
 */
OrderRequestV2.prototype['items'] = undefined;
 ...
 */
OrderRequestV2.prototype['merchantId'] = undefined;

/**
 * Unique ID provided by the merchant
 * @member {String} merchantOrderId
 */
OrderRequestV2.prototype['merchantOrderId'] = undefined;

/**
 * @member {String} notes
 */
OrderRequestV2.prototype['notes'] = undefined;

/**
 * @member {module:model/ConsigneeNewV2} recipient
 */
OrderRequestV2.prototype['recipient'] = undefined;

/**
 * Custom for you, it will be mapped to an actual method within the OMS UI
 * @member {String} shippingMethod
 */
OrderRequestV2.prototype['shippingMethod'] = undefined;

/**
 * @member {module:model/OrderRequestV2Warehouse} warehouse
 */
OrderRequestV2.prototype['warehouse'] = undefined;
