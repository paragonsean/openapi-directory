...
/**
 * The UserContactV2Merchant model module.
 * @module model/UserContactV2Merchant
 * @version 2.0
 */
class UserContactV2Merchant {
    /**
     * Constructs a new <code>UserContactV2Merchant</code>.
     * @alias module:model/UserContactV2Merchant
     */
    constructor() { 
        
        UserContactV2Merchant.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserContactV2Merchant</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserContactV2Merchant} obj Optional instance to populate.
     * @return {module:model/UserContactV2Merchant} The populated <code>UserContactV2Merchant</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserContactV2Merchant();
    ...
    /**
     * Validates the JSON data with respect to <code>UserContactV2Merchant</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserContactV2Merchant</code>.
     */
 ...
 * @member {Number} id
 */
UserContactV2Merchant.prototype['id'] = undefined;
...
export default UserContactV2Merchant;
