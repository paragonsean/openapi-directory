...
import LineItemsResponseV2InventoryDetailsInner from './LineItemsResponseV2InventoryDetailsInner';
import LineItemsResponseV2LineDetails from './LineItemsResponseV2LineDetails';
import LineItemsResponseV2RequestedSkuData from './LineItemsResponseV2RequestedSkuData';

/**
 * The LineItemsResponseV2 model module.
 * @module model/LineItemsResponseV2
 * @version 2.0
 */
class LineItemsResponseV2 {
    /**
     * Constructs a new <code>LineItemsResponseV2</code>.
     * 
     * @alias module:model/LineItemsResponseV2
     */
    constructor() { 
        
        LineItemsResponseV2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LineItemsResponseV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LineItemsResponseV2} obj Optional instance to populate.
     * @return {module:model/LineItemsResponseV2} The populated <code>LineItemsResponseV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LineItemsResponseV2();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'Number');
            }
            if (data.hasOwnProperty('inventoryDetails')) {
                obj['inventoryDetails'] = ApiClient.convertToType(data['inventoryDetails'], [LineItemsResponseV2InventoryDetailsInner]);
            }
            if (data.hasOwnProperty('lineDetails')) {
                obj['lineDetails'] = LineItemsResponseV2LineDetails.constructFromObject(data['lineDetails']);
            }
            if (data.hasOwnProperty('requestedSkuData')) {
                obj['requestedSkuData'] = LineItemsResponseV2RequestedSkuData.constructFromObject(data['requestedSkuData']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LineItemsResponseV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LineItemsResponseV2</code>.
     */
    static validateJSON(data) {
        if (data['inventoryDetails']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['inventoryDetails'])) {
                throw new Error("Expected the field `inventoryDetails` to be an array in the JSON data but got " + data['inventoryDetails']);
            }
            // validate the optional field `inventoryDetails` (array)
            for (const item of data['inventoryDetails']) {
                LineItemsResponseV2InventoryDetailsInner.validateJSON(item);
            };
        }
        // validate the optional field `lineDetails`
        if (data['lineDetails']) { // data not null
          LineItemsResponseV2LineDetails.validateJSON(data['lineDetails']);
        }
        // validate the optional field `requestedSkuData`
        if (data['requestedSkuData']) { // data not null
          LineItemsResponseV2RequestedSkuData.validateJSON(data['requestedSkuData']);
        }
 ...
 * @member {Number} id
 */
LineItemsResponseV2.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/LineItemsResponseV2InventoryDetailsInner>} inventoryDetails
 */
LineItemsResponseV2.prototype['inventoryDetails'] = undefined;

/**
 * @member {module:model/LineItemsResponseV2LineDetails} lineDetails
 */
LineItemsResponseV2.prototype['lineDetails'] = undefined;

/**
 * @member {module:model/LineItemsResponseV2RequestedSkuData} requestedSkuData
 */
LineItemsResponseV2.prototype['requestedSkuData'] = undefined;
...
export default LineItemsResponseV2;
