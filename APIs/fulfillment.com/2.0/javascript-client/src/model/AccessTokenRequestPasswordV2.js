...
/**
 * The AccessTokenRequestPasswordV2 model module.
 * @module model/AccessTokenRequestPasswordV2
 * @version 2.0
 */
class AccessTokenRequestPasswordV2 {
    /**
     * Constructs a new <code>AccessTokenRequestPasswordV2</code>.
     * @alias module:model/AccessTokenRequestPasswordV2
     * @param password {String} 
     * @param username {String} 
     * @param clientId {String} Id and secret provided by FDC
     * @param clientSecret {String} 
     * @param grantType {module:model/AccessTokenRequestPasswordV2.GrantTypeEnum} Indicates how you're authenticating your request
     * @param scope {module:model/AccessTokenRequestPasswordV2.ScopeEnum} Currently limited to Order Management System
     */
    constructor(password, username, clientId, clientSecret, grantType, scope) { 
        
        AccessTokenRequestPasswordV2.initialize(this, password, username, clientId, clientSecret, grantType, scope);
    }
     ...
     */
    static initialize(obj, password, username, clientId, clientSecret, grantType, scope) { 
    ...
    /**
     * Constructs a <code>AccessTokenRequestPasswordV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccessTokenRequestPasswordV2} obj Optional instance to populate.
     * @return {module:model/AccessTokenRequestPasswordV2} The populated <code>AccessTokenRequestPasswordV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccessTokenRequestPasswordV2();
    ...
    /**
     * Validates the JSON data with respect to <code>AccessTokenRequestPasswordV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccessTokenRequestPasswordV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccessTokenRequestPasswordV2.RequiredProperties) {
...
AccessTokenRequestPasswordV2.RequiredProperties = ["password", "username", "client_id", "client_secret", "grant_type", "scope"];

/**
 * 
 * @member {String} password
 */
AccessTokenRequestPasswordV2.prototype['password'] = undefined;

/**
 * 
 * @member {String} username
 */
AccessTokenRequestPasswordV2.prototype['username'] = undefined;

/**
 * Id and secret provided by FDC
 * @member {String} client_id
 */
AccessTokenRequestPasswordV2.prototype['client_id'] = undefined;

/**
 * @member {String} client_secret
 */
AccessTokenRequestPasswordV2.prototype['client_secret'] = undefined;

/**
 * Indicates how you're authenticating your request
 * @member {module:model/AccessTokenRequestPasswordV2.GrantTypeEnum} grant_type
 */
AccessTokenRequestPasswordV2.prototype['grant_type'] = undefined;

/**
 * Currently limited to Order Management System
 * @member {module:model/AccessTokenRequestPasswordV2.ScopeEnum} scope
 * @default 'oms'
 */
AccessTokenRequestPasswordV2.prototype['scope'] = 'oms';
 ...
 * @readonly
 */
AccessTokenRequestPasswordV2['GrantTypeEnum'] = {
 ...
 * @readonly
 */
AccessTokenRequestPasswordV2['ScopeEnum'] = {
...
export default AccessTokenRequestPasswordV2;
