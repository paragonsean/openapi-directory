...
/**
 * The LineItemsResponseV2RequestedSkuData model module.
 * @module model/LineItemsResponseV2RequestedSkuData
 * @version 2.0
 */
class LineItemsResponseV2RequestedSkuData {
    /**
     * Constructs a new <code>LineItemsResponseV2RequestedSkuData</code>.
     * @alias module:model/LineItemsResponseV2RequestedSkuData
     */
    constructor() { 
        
        LineItemsResponseV2RequestedSkuData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LineItemsResponseV2RequestedSkuData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LineItemsResponseV2RequestedSkuData} obj Optional instance to populate.
     * @return {module:model/LineItemsResponseV2RequestedSkuData} The populated <code>LineItemsResponseV2RequestedSkuData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LineItemsResponseV2RequestedSkuData();
    ...
    /**
     * Validates the JSON data with respect to <code>LineItemsResponseV2RequestedSkuData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LineItemsResponseV2RequestedSkuData</code>.
     */
 ...
 */
LineItemsResponseV2RequestedSkuData.prototype['declaredValue'] = undefined;

/**
 * @member {Number} id
 */
LineItemsResponseV2RequestedSkuData.prototype['id'] = undefined;

/**
 * @member {Number} quantity
 */
LineItemsResponseV2RequestedSkuData.prototype['quantity'] = undefined;

/**
 * @member {String} sku
 */
LineItemsResponseV2RequestedSkuData.prototype['sku'] = undefined;
...
export default LineItemsResponseV2RequestedSkuData;
