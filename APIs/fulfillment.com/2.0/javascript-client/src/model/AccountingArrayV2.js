...
import AccountingV2 from './AccountingV2';

/**
 * The AccountingArrayV2 model module.
 * @module model/AccountingArrayV2
 * @version 2.0
 */
class AccountingArrayV2 {
    /**
     * Constructs a new <code>AccountingArrayV2</code>.
     * @alias module:model/AccountingArrayV2
     */
    constructor() { 
        
        AccountingArrayV2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountingArrayV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountingArrayV2} obj Optional instance to populate.
     * @return {module:model/AccountingArrayV2} The populated <code>AccountingArrayV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountingArrayV2();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [AccountingV2]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountingArrayV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountingArrayV2</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                AccountingV2.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/AccountingV2>} data
 */
AccountingArrayV2.prototype['data'] = undefined;

/**
 * @member {module:model/AccountingArrayV2Meta} meta
 */
AccountingArrayV2.prototype['meta'] = undefined;
...
export default AccountingArrayV2;
