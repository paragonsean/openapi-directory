...
/**
 * The CarrierHydratedV2 model module.
 * @module model/CarrierHydratedV2
 * @version 2.0
 */
class CarrierHydratedV2 {
    /**
     * Constructs a new <code>CarrierHydratedV2</code>.
     * @alias module:model/CarrierHydratedV2
     * @param id {Number} 
     * @param name {String} 
     * @param symbol {String} 
     */
    constructor(id, name, symbol) { 
        ...
        CarrierHydratedV2.initialize(this, id, name, symbol);
    }
     ...
     */
    static initialize(obj, id, name, symbol) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['symbol'] = symbol;
    }
    ...
    /**
     * Constructs a <code>CarrierHydratedV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CarrierHydratedV2} obj Optional instance to populate.
     * @return {module:model/CarrierHydratedV2} The populated <code>CarrierHydratedV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CarrierHydratedV2();

            if (data.hasOwnProperty('canReprintPostage')) {
                obj['canReprintPostage'] = ApiClient.convertToType(data['canReprintPostage'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('includePeripherals')) {
                obj['includePeripherals'] = ApiClient.convertToType(data['includePeripherals'], 'Boolean');
            }
            if (data.hasOwnProperty('internalRatesOnly')) {
                obj['internalRatesOnly'] = ApiClient.convertToType(data['internalRatesOnly'], 'Boolean');
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('requiresDimensions')) {
                obj['requiresDimensions'] = ApiClient.convertToType(data['requiresDimensions'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CarrierHydratedV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CarrierHydratedV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CarrierHydratedV2.RequiredProperties) {
...
CarrierHydratedV2.RequiredProperties = ["id", "name", "symbol"];

/**
 * @member {Boolean} canReprintPostage
 */
CarrierHydratedV2.prototype['canReprintPostage'] = undefined;

/**
 * @member {Boolean} enabled
 */
CarrierHydratedV2.prototype['enabled'] = undefined;

/**
 * @member {Number} id
 */
CarrierHydratedV2.prototype['id'] = undefined;

/**
 * @member {Boolean} includePeripherals
 */
CarrierHydratedV2.prototype['includePeripherals'] = undefined;

/**
 * @member {Boolean} internalRatesOnly
 */
CarrierHydratedV2.prototype['internalRatesOnly'] = undefined;

/**
 * @member {String} name
 */
CarrierHydratedV2.prototype['name'] = undefined;

/**
 * @member {Boolean} requiresDimensions
 */
CarrierHydratedV2.prototype['requiresDimensions'] = undefined;

/**
 * @member {String} symbol
 */
CarrierHydratedV2.prototype['symbol'] = undefined;
...
export default CarrierHydratedV2;
