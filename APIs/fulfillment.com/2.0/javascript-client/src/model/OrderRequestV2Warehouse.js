...
/**
 * The OrderRequestV2Warehouse model module.
 * @module model/OrderRequestV2Warehouse
 * @version 2.0
 */
class OrderRequestV2Warehouse {
    /**
     * Constructs a new <code>OrderRequestV2Warehouse</code>.
     ...
     * @alias module:model/OrderRequestV2Warehouse
     */
    constructor() { 
        
        OrderRequestV2Warehouse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderRequestV2Warehouse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderRequestV2Warehouse} obj Optional instance to populate.
     * @return {module:model/OrderRequestV2Warehouse} The populated <code>OrderRequestV2Warehouse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderRequestV2Warehouse();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderRequestV2Warehouse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderRequestV2Warehouse</code>.
     */
 ...
 * @member {Number} id
 */
OrderRequestV2Warehouse.prototype['id'] = undefined;
...
export default OrderRequestV2Warehouse;
