...
import StatusTypeSimpleV2Status from './StatusTypeSimpleV2Status';
...
class StatusTypeSimpleV2 {
     ...
     * @param status {module:model/StatusTypeSimpleV2Status} 
     */
    constructor(reason, status) { 
        
        StatusTypeSimpleV2.initialize(this, reason, status);
    }
     ...
     */
    static initialize(obj, reason, status) { 
        obj['reason'] = reason;
        obj['status'] = status;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = StatusTypeSimpleV2Status.constructFromObject(data['status']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatusTypeSimpleV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatusTypeSimpleV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatusTypeSimpleV2.RequiredProperties) {
        ...
        if (data['status']) { // data not null
          StatusTypeSimpleV2Status.validateJSON(data['status']);
        }
...
StatusTypeSimpleV2.RequiredProperties = ["reason", "status"];

/**
 * Human-readable description
 * @member {String} reason
 */
StatusTypeSimpleV2.prototype['reason'] = undefined;

/**
 * @member {module:model/StatusTypeSimpleV2Status} status
 */
StatusTypeSimpleV2.prototype['status'] = undefined;
...
export default StatusTypeSimpleV2;
