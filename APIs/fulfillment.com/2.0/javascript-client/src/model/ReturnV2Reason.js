...
/**
 * The ReturnV2Reason model module.
 * @module model/ReturnV2Reason
 * @version 2.0
 */
class ReturnV2Reason {
    /**
     * Constructs a new <code>ReturnV2Reason</code>.
     * @alias module:model/ReturnV2Reason
     * @param id {Number} 
     * @param title {String} 
     */
    constructor(id, title) { 
        
        ReturnV2Reason.initialize(this, id, title);
    }
    ...
    /**
     * Constructs a <code>ReturnV2Reason</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReturnV2Reason} obj Optional instance to populate.
     * @return {module:model/ReturnV2Reason} The populated <code>ReturnV2Reason</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnV2Reason();
    ...
    /**
     * Validates the JSON data with respect to <code>ReturnV2Reason</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReturnV2Reason</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReturnV2Reason.RequiredProperties) {
...
ReturnV2Reason.RequiredProperties = ["id", "title"];

/**
 * @member {Number} id
 */
ReturnV2Reason.prototype['id'] = undefined;

/**
 * @member {String} title
 */
ReturnV2Reason.prototype['title'] = undefined;
