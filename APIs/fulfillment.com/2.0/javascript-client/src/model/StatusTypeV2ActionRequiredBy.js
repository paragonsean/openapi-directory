...
/**
 * The StatusTypeV2ActionRequiredBy model module.
 * @module model/StatusTypeV2ActionRequiredBy
 * @version 2.0
 */
class StatusTypeV2ActionRequiredBy {
    /**
     * Constructs a new <code>StatusTypeV2ActionRequiredBy</code>.
     * Responsibility for resolving this issue
     * @alias module:model/StatusTypeV2ActionRequiredBy
     */
    constructor() { 
        
        StatusTypeV2ActionRequiredBy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StatusTypeV2ActionRequiredBy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatusTypeV2ActionRequiredBy} obj Optional instance to populate.
     * @return {module:model/StatusTypeV2ActionRequiredBy} The populated <code>StatusTypeV2ActionRequiredBy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatusTypeV2ActionRequiredBy();
    ...
    /**
     * Validates the JSON data with respect to <code>StatusTypeV2ActionRequiredBy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatusTypeV2ActionRequiredBy</code>.
     */
 ...
 * @member {Number} id
 */
StatusTypeV2ActionRequiredBy.prototype['id'] = undefined;

/**
 * Human readable description of responsible party to resolve the issue
 * @member {String} name
 */
StatusTypeV2ActionRequiredBy.prototype['name'] = undefined;
...
export default StatusTypeV2ActionRequiredBy;
