...
class Feature {
    ...
    constructor(geometry, properties, type) { 
        ...
        Feature.initialize(this, geometry, properties, type);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bbox')) {
                obj['bbox'] = ApiClient.convertToType(data['bbox'], [Object]);
            }
            if (data.hasOwnProperty('centerline')) {
                obj['centerline'] = Object.constructFromObject(data['centerline']);
            }
...
Feature.RequiredProperties = ["geometry", "properties", "type"];

/**
 * @member {Array.<Object>} bbox
 */
Feature.prototype['bbox'] = undefined;

/**
 * @member {Object} centerline
 */
Feature.prototype['centerline'] = undefined;
