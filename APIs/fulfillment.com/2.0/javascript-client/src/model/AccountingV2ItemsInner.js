...
/**
 * The AccountingV2ItemsInner model module.
 * @module model/AccountingV2ItemsInner
 * @version 2.0
 */
class AccountingV2ItemsInner {
    /**
     * Constructs a new <code>AccountingV2ItemsInner</code>.
     * @alias module:model/AccountingV2ItemsInner
     */
    constructor() { 
        
        AccountingV2ItemsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountingV2ItemsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountingV2ItemsInner} obj Optional instance to populate.
     * @return {module:model/AccountingV2ItemsInner} The populated <code>AccountingV2ItemsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountingV2ItemsInner();
            ...
            if (data.hasOwnProperty('wmsItemId')) {
                obj['wmsItemId'] = ApiClient.convertToType(data['wmsItemId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountingV2ItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountingV2ItemsInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['wmsItemId'] && !(typeof data['wmsItemId'] === 'string' || data['wmsItemId'] instanceof String)) {
            throw new Error("Expected the field `wmsItemId` to be a primitive type in the JSON string but got " + data['wmsItemId']);
        }
 ...
 * @member {Number} id
 */
AccountingV2ItemsInner.prototype['id'] = undefined;

/**
 * @member {String} name
 */
AccountingV2ItemsInner.prototype['name'] = undefined;

/**
 * @member {Number} quantity
 */
AccountingV2ItemsInner.prototype['quantity'] = undefined;

/**
 * @member {String} wmsItemId
 */
AccountingV2ItemsInner.prototype['wmsItemId'] = undefined;
...
export default AccountingV2ItemsInner;
