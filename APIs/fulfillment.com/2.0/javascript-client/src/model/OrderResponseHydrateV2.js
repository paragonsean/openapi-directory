...
/**
 * The OrderResponseHydrateV2 model module.
 * @module model/OrderResponseHydrateV2
 * @version 2.0
 */
class OrderResponseHydrateV2 {
    /**
     * Constructs a new <code>OrderResponseHydrateV2</code>.
     * Requires hydrate to be set in the request and the corresponding node will be filled.
     * @alias module:model/OrderResponseHydrateV2
     * @implements module:model/ERRORUNKNOWN
     */
    constructor() { 
        
        OrderResponseHydrateV2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderResponseHydrateV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderResponseHydrateV2} obj Optional instance to populate.
     * @return {module:model/OrderResponseHydrateV2} The populated <code>OrderResponseHydrateV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderResponseHydrateV2();
            ERRORUNKNOWN.constructFromObject(data, obj);

            if (data.hasOwnProperty('integrator')) {
                obj['integrator'] = ApiClient.convertToType(data['integrator'], 'String');
            }
            if (data.hasOwnProperty('lineItems')) {
                obj['lineItems'] = ApiClient.convertToType(data['lineItems'], [LineItemsResponseV2]);
            }
            if (data.hasOwnProperty('trackingNumbers')) {
                obj['trackingNumbers'] = ApiClient.convertToType(data['trackingNumbers'], [OrderResponseHydrateV2AllOfTrackingNumbersInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderResponseHydrateV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderResponseHydrateV2</code>.
     */
    static validateJSON(data) {
        ...
        if (data['lineItems']) { // data not null
            ...
            for (const item of data['lineItems']) {
                LineItemsResponseV2.validateJSON(item);
            };
        }
        if (data['trackingNumbers']) { // data not null
            ...
            for (const item of data['trackingNumbers']) {
                OrderResponseHydrateV2AllOfTrackingNumbersInner.validateJSON(item);
            };
        }
 ...
 */
OrderResponseHydrateV2.prototype['integrator'] = undefined;

/**
 * @member {Array.<module:model/LineItemsResponseV2>} lineItems
 */
OrderResponseHydrateV2.prototype['lineItems'] = undefined;

/**
 * @member {Array.<module:model/OrderResponseHydrateV2AllOfTrackingNumbersInner>} trackingNumbers
 */
OrderResponseHydrateV2.prototype['trackingNumbers'] = undefined;
...
export default OrderResponseHydrateV2;
