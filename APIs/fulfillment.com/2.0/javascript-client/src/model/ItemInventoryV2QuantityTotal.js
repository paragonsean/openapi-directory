...
/**
 * The ItemInventoryV2QuantityTotal model module.
 * @module model/ItemInventoryV2QuantityTotal
 * @version 2.0
 */
class ItemInventoryV2QuantityTotal {
    /**
     * Constructs a new <code>ItemInventoryV2QuantityTotal</code>.
     * @alias module:model/ItemInventoryV2QuantityTotal
     */
    constructor() { 
        
        ItemInventoryV2QuantityTotal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemInventoryV2QuantityTotal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemInventoryV2QuantityTotal} obj Optional instance to populate.
     * @return {module:model/ItemInventoryV2QuantityTotal} The populated <code>ItemInventoryV2QuantityTotal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryV2QuantityTotal();

            if (data.hasOwnProperty('availableToPromise')) {
                obj['availableToPromise'] = ApiClient.convertToType(data['availableToPromise'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemInventoryV2QuantityTotal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemInventoryV2QuantityTotal</code>.
     */
 ...
 * @member {Number} availableToPromise
 */
ItemInventoryV2QuantityTotal.prototype['availableToPromise'] = undefined;
...
export default ItemInventoryV2QuantityTotal;
