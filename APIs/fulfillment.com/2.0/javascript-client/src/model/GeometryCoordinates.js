...
/**
 * The GeometryCoordinates model module.
 * @module model/GeometryCoordinates
 * @version 2.0
 */
class GeometryCoordinates {
    /**
     * Constructs a new <code>GeometryCoordinates</code>.
     * @alias module:model/GeometryCoordinates
     * @param {(module:model/[Number]|module:model/[Object])} instance The actual instance to initialize GeometryCoordinates.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `GeometryCoordinates` with oneOf schemas [Number], [Object]. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `GeometryCoordinates` with oneOf schemas [Number], [Object]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>GeometryCoordinates</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GeometryCoordinates} obj Optional instance to populate.
     * @return {module:model/GeometryCoordinates} The populated <code>GeometryCoordinates</code> instance.
     */
    static constructFromObject(data, obj) {
        return new GeometryCoordinates(data);
    }

    /**
     * Gets the actual instance, which can be <code>[Number]</code>, <code>[Object]</code>.
     * @return {(module:model/[Number]|module:model/[Object])} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>[Number]</code>, <code>[Object]</code>.
     * @param {(module:model/[Number]|module:model/[Object])} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = GeometryCoordinates.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of GeometryCoordinates from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GeometryCoordinates} An instance of GeometryCoordinates.
     */
    static fromJSON = function(json_string){
        return GeometryCoordinates.constructFromObject(JSON.parse(json_string));
    }
}


GeometryCoordinates.OneOf = ["[Number]", "[Object]"];

export default GeometryCoordinates;
