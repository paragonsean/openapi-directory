...
/**
 * The MerchantV2 model module.
 * @module model/MerchantV2
 * @version 2.0
 */
class MerchantV2 {
    /**
     * Constructs a new <code>MerchantV2</code>.
     * @alias module:model/MerchantV2
     * @param id {Number} 
     * @param name {String} Merchant Company Name
     */
    constructor(id, name) { 
        
        MerchantV2.initialize(this, id, name);
    }
    ...
    /**
     * Constructs a <code>MerchantV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MerchantV2} obj Optional instance to populate.
     * @return {module:model/MerchantV2} The populated <code>MerchantV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MerchantV2();
    ...
    /**
     * Validates the JSON data with respect to <code>MerchantV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MerchantV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MerchantV2.RequiredProperties) {
...
MerchantV2.RequiredProperties = ["id", "name"];

/**
 * @member {Number} id
 */
MerchantV2.prototype['id'] = undefined;

/**
 * Merchant Company Name
 * @member {String} name
 */
MerchantV2.prototype['name'] = undefined;
