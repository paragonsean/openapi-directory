...
/**
 * The PaginationV2 model module.
 * @module model/PaginationV2
 * @version 2.0
 */
class PaginationV2 {
    /**
     * Constructs a new <code>PaginationV2</code>.
     * @alias module:model/PaginationV2
     */
    constructor() { 
        
        PaginationV2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaginationV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaginationV2} obj Optional instance to populate.
     * @return {module:model/PaginationV2} The populated <code>PaginationV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaginationV2();
    ...
    /**
     * Validates the JSON data with respect to <code>PaginationV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginationV2</code>.
     */
 ...
 * @member {Number} count
 */
PaginationV2.prototype['count'] = undefined;

/**
 * Current page of the response, this will match the page parameter
 * @member {Number} currentPage
 */
PaginationV2.prototype['currentPage'] = undefined;

/**
 * Total number of records available to request
 * @member {Number} total
 */
PaginationV2.prototype['total'] = undefined;

/**
 * Total number of pages available to request
 * @member {Number} totalPages
 */
PaginationV2.prototype['totalPages'] = undefined;
