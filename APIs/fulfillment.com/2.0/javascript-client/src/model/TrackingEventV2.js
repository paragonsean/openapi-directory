...
class TrackingEventV2 {
    ...
    constructor() { 
        ...
        TrackingEventV2.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('eventLocation')) {
                obj['eventLocation'] = Object.constructFromObject(data['eventLocation']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TrackingEventV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrackingEventV2</code>.
     */
 ...
 */
TrackingEventV2.prototype['eventCategory'] = undefined;

/**
 * @member {Number} eventCategoryCode
 */
TrackingEventV2.prototype['eventCategoryCode'] = undefined;

/**
 * @member {Date} eventDateTime
 */
TrackingEventV2.prototype['eventDateTime'] = undefined;

/**
 * @member {Object} eventLocation
 */
TrackingEventV2.prototype['eventLocation'] = undefined;

/**
 * @member {module:model/TrackingEventV2.EventSourceEnum} eventSource
 */
TrackingEventV2.prototype['eventSource'] = undefined;

/**
 * @member {String} eventStatus
 */
TrackingEventV2.prototype['eventStatus'] = undefined;
 ...
 * @readonly
 */
TrackingEventV2['EventSourceEnum'] = {
...
export default TrackingEventV2;
