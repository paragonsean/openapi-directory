...
/**
 * The RmaResponseV2 model module.
 * @module model/RmaResponseV2
 * @version 2.0
 */
class RmaResponseV2 {
    /**
     * Constructs a new <code>RmaResponseV2</code>.
     * @alias module:model/RmaResponseV2
     * @param items {Array.<module:model/RmaRequestV2ItemsInner>} 
     * @param recipient {module:model/ConsigneeV2} 
     * @param rmaNumber {String} 
     */
    constructor(items, recipient, rmaNumber) { 
        
        RmaResponseV2.initialize(this, items, recipient, rmaNumber);
    }
    ...
    /**
     * Constructs a <code>RmaResponseV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RmaResponseV2} obj Optional instance to populate.
     * @return {module:model/RmaResponseV2} The populated <code>RmaResponseV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RmaResponseV2();
            ...
            if (data.hasOwnProperty('recipient')) {
                obj['recipient'] = ConsigneeV2.constructFromObject(data['recipient']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RmaResponseV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RmaResponseV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RmaResponseV2.RequiredProperties) {
        ...
        if (data['recipient']) { // data not null
          ConsigneeV2.validateJSON(data['recipient']);
        }
        // ensure the json data is a string
...
RmaResponseV2.RequiredProperties = ["items", "recipient", "rmaNumber"];

/**
 * @member {Array.<module:model/RmaRequestV2ItemsInner>} items
 */
RmaResponseV2.prototype['items'] = undefined;

/**
 * @member {String} merchantOrderId
 */
RmaResponseV2.prototype['merchantOrderId'] = undefined;

/**
 * @member {module:model/ConsigneeV2} recipient
 */
RmaResponseV2.prototype['recipient'] = undefined;

/**
 * @member {String} rmaNumber
 */
RmaResponseV2.prototype['rmaNumber'] = undefined;
