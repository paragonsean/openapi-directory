...
/**
 * The ItemInventoryV2Item model module.
 * @module model/ItemInventoryV2Item
 * @version 2.0
 */
class ItemInventoryV2Item {
    /**
     * Constructs a new <code>ItemInventoryV2Item</code>.
     * Item this inventory data is based on
     * @alias module:model/ItemInventoryV2Item
     */
    constructor() { 
        
        ItemInventoryV2Item.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemInventoryV2Item</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemInventoryV2Item} obj Optional instance to populate.
     * @return {module:model/ItemInventoryV2Item} The populated <code>ItemInventoryV2Item</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryV2Item();

            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'Number');
            }
            if (data.hasOwnProperty('skuReference')) {
                obj['skuReference'] = ApiClient.convertToType(data['skuReference'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemInventoryV2Item</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemInventoryV2Item</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['skuReference'] && !(typeof data['skuReference'] === 'string' || data['skuReference'] instanceof String)) {
            throw new Error("Expected the field `skuReference` to be a primitive type in the JSON string but got " + data['skuReference']);
        }
 ...
 * @member {Number} id
 */
ItemInventoryV2Item.prototype['id'] = undefined;

/**
 * Sku reference name for this item
 * @member {String} skuReference
 */
ItemInventoryV2Item.prototype['skuReference'] = undefined;
...
export default ItemInventoryV2Item;
