...
/**
 * The WarehouseV2 model module.
 * @module model/WarehouseV2
 * @version 2.0
 */
class WarehouseV2 {
    /**
     * Constructs a new <code>WarehouseV2</code>.
     * 
     * @alias module:model/WarehouseV2
     * @param id {Number} 
     */
    constructor(id) { 
        
        WarehouseV2.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>WarehouseV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WarehouseV2} obj Optional instance to populate.
     * @return {module:model/WarehouseV2} The populated <code>WarehouseV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WarehouseV2();
    ...
    /**
     * Validates the JSON data with respect to <code>WarehouseV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WarehouseV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WarehouseV2.RequiredProperties) {
...
WarehouseV2.RequiredProperties = ["id"];

/**
 * @member {Number} id
 */
WarehouseV2.prototype['id'] = undefined;
