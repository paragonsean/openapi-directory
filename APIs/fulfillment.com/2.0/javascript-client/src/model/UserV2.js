...
class UserV2 {
    ...
    /**
     * Validates the JSON data with respect to <code>UserV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserV2.RequiredProperties) {
...
UserV2.RequiredProperties = ["id"];

/**
 * @member {Number} id
 */
UserV2.prototype['id'] = undefined;
