...
/**
 * The AccountingV2Warehouse model module.
 * @module model/AccountingV2Warehouse
 * @version 2.0
 */
class AccountingV2Warehouse {
    /**
     * Constructs a new <code>AccountingV2Warehouse</code>.
     * @alias module:model/AccountingV2Warehouse
     */
    constructor() { 
        
        AccountingV2Warehouse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountingV2Warehouse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountingV2Warehouse} obj Optional instance to populate.
     * @return {module:model/AccountingV2Warehouse} The populated <code>AccountingV2Warehouse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountingV2Warehouse();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountingV2Warehouse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountingV2Warehouse</code>.
     */
 ...
 * @member {Number} id
 */
AccountingV2Warehouse.prototype['id'] = undefined;

/**
 * Name of the merchant
 * @member {String} shortName
 */
AccountingV2Warehouse.prototype['shortName'] = undefined;
...
export default AccountingV2Warehouse;
