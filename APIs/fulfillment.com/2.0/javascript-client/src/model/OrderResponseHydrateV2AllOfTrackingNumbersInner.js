...
import CarrierHydratedV2 from './CarrierHydratedV2';

/**
 * The OrderResponseHydrateV2AllOfTrackingNumbersInner model module.
 * @module model/OrderResponseHydrateV2AllOfTrackingNumbersInner
 * @version 2.0
 */
class OrderResponseHydrateV2AllOfTrackingNumbersInner {
    /**
     * Constructs a new <code>OrderResponseHydrateV2AllOfTrackingNumbersInner</code>.
     * @alias module:model/OrderResponseHydrateV2AllOfTrackingNumbersInner
     */
    constructor() { 
        
        OrderResponseHydrateV2AllOfTrackingNumbersInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderResponseHydrateV2AllOfTrackingNumbersInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderResponseHydrateV2AllOfTrackingNumbersInner} obj Optional instance to populate.
     * @return {module:model/OrderResponseHydrateV2AllOfTrackingNumbersInner} The populated <code>OrderResponseHydrateV2AllOfTrackingNumbersInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderResponseHydrateV2AllOfTrackingNumbersInner();

            if (data.hasOwnProperty('carrier')) {
                obj['carrier'] = CarrierHydratedV2.constructFromObject(data['carrier']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderResponseHydrateV2AllOfTrackingNumbersInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderResponseHydrateV2AllOfTrackingNumbersInner</code>.
     */
    static validateJSON(data) {
        // validate the optional field `carrier`
        if (data['carrier']) { // data not null
          CarrierHydratedV2.validateJSON(data['carrier']);
        }
...
/**
 * @member {module:model/CarrierHydratedV2} carrier
 */
OrderResponseHydrateV2AllOfTrackingNumbersInner.prototype['carrier'] = undefined;
...
export default OrderResponseHydrateV2AllOfTrackingNumbersInner;
