...
/**
 * The RmaItemV2NonRestockedReason model module.
 * @module model/RmaItemV2NonRestockedReason
 * @version 2.0
 */
class RmaItemV2NonRestockedReason {
    /**
     * Constructs a new <code>RmaItemV2NonRestockedReason</code>.
     * @alias module:model/RmaItemV2NonRestockedReason
     */
    constructor() { 
        
        RmaItemV2NonRestockedReason.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RmaItemV2NonRestockedReason</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RmaItemV2NonRestockedReason} obj Optional instance to populate.
     * @return {module:model/RmaItemV2NonRestockedReason} The populated <code>RmaItemV2NonRestockedReason</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RmaItemV2NonRestockedReason();
    ...
    /**
     * Validates the JSON data with respect to <code>RmaItemV2NonRestockedReason</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RmaItemV2NonRestockedReason</code>.
     */
 ...
 * @member {Number} id
 */
RmaItemV2NonRestockedReason.prototype['id'] = undefined;

/**
 * @member {String} title
 */
RmaItemV2NonRestockedReason.prototype['title'] = undefined;
...
export default RmaItemV2NonRestockedReason;
