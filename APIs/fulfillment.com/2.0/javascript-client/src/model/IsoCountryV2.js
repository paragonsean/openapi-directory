...
class IsoCountryV2 {
    ...
    /**
     * Validates the JSON data with respect to <code>IsoCountryV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsoCountryV2</code>.
     */
 ...
 * @member {Number} id
 */
IsoCountryV2.prototype['id'] = undefined;

/**
 * Two character ISO code
 * @member {String} iso2
 */
IsoCountryV2.prototype['iso2'] = undefined;

/**
 * Country Name
 * @member {String} name
 */
IsoCountryV2.prototype['name'] = undefined;
