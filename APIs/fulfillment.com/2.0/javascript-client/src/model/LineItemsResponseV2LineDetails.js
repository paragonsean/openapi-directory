...
/**
 * The LineItemsResponseV2LineDetails model module.
 * @module model/LineItemsResponseV2LineDetails
 * @version 2.0
 */
class LineItemsResponseV2LineDetails {
    /**
     * Constructs a new <code>LineItemsResponseV2LineDetails</code>.
     * @alias module:model/LineItemsResponseV2LineDetails
     */
    constructor() { 
        
        LineItemsResponseV2LineDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LineItemsResponseV2LineDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LineItemsResponseV2LineDetails} obj Optional instance to populate.
     * @return {module:model/LineItemsResponseV2LineDetails} The populated <code>LineItemsResponseV2LineDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LineItemsResponseV2LineDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>LineItemsResponseV2LineDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LineItemsResponseV2LineDetails</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['externalSku'] && !(typeof data['externalSku'] === 'string' || data['externalSku'] instanceof String)) {
            throw new Error("Expected the field `externalSku` to be a primitive type in the JSON string but got " + data['externalSku']);
        }
        // ensure the json data is a string
 ...
 */
LineItemsResponseV2LineDetails.prototype['description'] = undefined;

/**
 * @member {String} externalSku
 */
LineItemsResponseV2LineDetails.prototype['externalSku'] = undefined;

/**
 * @member {Number} id
 */
LineItemsResponseV2LineDetails.prototype['id'] = undefined;

/**
 * @member {String} name
 */
LineItemsResponseV2LineDetails.prototype['name'] = undefined;

/**
 * @member {Number} totalQuantity
 */
LineItemsResponseV2LineDetails.prototype['totalQuantity'] = undefined;
...
export default LineItemsResponseV2LineDetails;
