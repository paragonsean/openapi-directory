...
import RmaRequestV2ItemsInner from './RmaRequestV2ItemsInner';

/**
 * The RmaRequestV2 model module.
 * @module model/RmaRequestV2
 * @version 2.0
 */
class RmaRequestV2 {
    /**
     * Constructs a new <code>RmaRequestV2</code>.
     * @alias module:model/RmaRequestV2
     * @param items {Array.<module:model/RmaRequestV2ItemsInner>} 
     * @param recipient {Object} 
     * @param rmaNumber {String} 
     */
    constructor(items, recipient, rmaNumber) { 
        
        RmaRequestV2.initialize(this, items, recipient, rmaNumber);
    }
     ...
     */
    static initialize(obj, items, recipient, rmaNumber) { 
        obj['items'] = items;
        obj['recipient'] = recipient;
        obj['rmaNumber'] = rmaNumber;
    }

    /**
     * Constructs a <code>RmaRequestV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RmaRequestV2} obj Optional instance to populate.
     * @return {module:model/RmaRequestV2} The populated <code>RmaRequestV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RmaRequestV2();

            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [RmaRequestV2ItemsInner]);
            }
            if (data.hasOwnProperty('merchantOrderId')) {
                obj['merchantOrderId'] = ApiClient.convertToType(data['merchantOrderId'], 'String');
            }
            if (data.hasOwnProperty('recipient')) {
                obj['recipient'] = Object.constructFromObject(data['recipient']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RmaRequestV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RmaRequestV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RmaRequestV2.RequiredProperties) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                RmaRequestV2ItemsInner.validateJSON(item);
            };
        }
...
RmaRequestV2.RequiredProperties = ["items", "recipient", "rmaNumber"];

/**
 * @member {Array.<module:model/RmaRequestV2ItemsInner>} items
 */
RmaRequestV2.prototype['items'] = undefined;

/**
 * @member {String} merchantOrderId
 */
RmaRequestV2.prototype['merchantOrderId'] = undefined;

/**
 * @member {Object} recipient
 */
RmaRequestV2.prototype['recipient'] = undefined;

/**
 * @member {String} rmaNumber
 */
RmaRequestV2.prototype['rmaNumber'] = undefined;
