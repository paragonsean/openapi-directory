...
/**
 * The RmaRequestV2ItemsInner model module.
 * @module model/RmaRequestV2ItemsInner
 * @version 2.0
 */
class RmaRequestV2ItemsInner {
    /**
     * Constructs a new <code>RmaRequestV2ItemsInner</code>.
     * @alias module:model/RmaRequestV2ItemsInner
     * @param quantityExpected {Number} 
     * @param sku {String} 
     */
    constructor(quantityExpected, sku) { 
        
        RmaRequestV2ItemsInner.initialize(this, quantityExpected, sku);
    }
     ...
     */
    static initialize(obj, quantityExpected, sku) { 
        obj['quantityExpected'] = quantityExpected;
        obj['sku'] = sku;
    }

    /**
     * Constructs a <code>RmaRequestV2ItemsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RmaRequestV2ItemsInner} obj Optional instance to populate.
     * @return {module:model/RmaRequestV2ItemsInner} The populated <code>RmaRequestV2ItemsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RmaRequestV2ItemsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>RmaRequestV2ItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RmaRequestV2ItemsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RmaRequestV2ItemsInner.RequiredProperties) {
...
RmaRequestV2ItemsInner.RequiredProperties = ["quantityExpected", "sku"];

/**
 * @member {Number} quantityExpected
 */
RmaRequestV2ItemsInner.prototype['quantityExpected'] = undefined;

/**
 * @member {String} sku
 */
RmaRequestV2ItemsInner.prototype['sku'] = undefined;
...
export default RmaRequestV2ItemsInner;
