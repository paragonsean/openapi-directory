...
import StatusTypeV2 from './StatusTypeV2';

/**
 * The StatusEventV2 model module.
 * @module model/StatusEventV2
 * @version 2.0
 */
class StatusEventV2 {
    /**
     * Constructs a new <code>StatusEventV2</code>.
     * @alias module:model/StatusEventV2
     * @param id {Number} 
     */
    constructor(id) { 
        
        StatusEventV2.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>StatusEventV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatusEventV2} obj Optional instance to populate.
     * @return {module:model/StatusEventV2} The populated <code>StatusEventV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatusEventV2();
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = StatusTypeV2.constructFromObject(data['status']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatusEventV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatusEventV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatusEventV2.RequiredProperties) {
        ...
        if (data['status']) { // data not null
          StatusTypeV2.validateJSON(data['status']);
        }
...
StatusEventV2.RequiredProperties = ["id"];

/**
 * @member {Object} createdBy
 */
StatusEventV2.prototype['createdBy'] = undefined;

/**
 * DateTime of Status Event
 * @member {Date} date
 */
StatusEventV2.prototype['date'] = undefined;

/**
 * @member {Number} id
 */
StatusEventV2.prototype['id'] = undefined;

/**
 * Explanation for status
 * @member {String} reason
 */
StatusEventV2.prototype['reason'] = undefined;

/**
 * @member {module:model/StatusTypeV2} status
 */
StatusEventV2.prototype['status'] = undefined;
