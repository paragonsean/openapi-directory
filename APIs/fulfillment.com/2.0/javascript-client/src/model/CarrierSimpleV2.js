...
/**
 * The CarrierSimpleV2 model module.
 * @module model/CarrierSimpleV2
 * @version 2.0
 */
class CarrierSimpleV2 {
    /**
     * Constructs a new <code>CarrierSimpleV2</code>.
     * @alias module:model/CarrierSimpleV2
     * @param id {Number} 
     */
    constructor(id) { 
        
        CarrierSimpleV2.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>CarrierSimpleV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CarrierSimpleV2} obj Optional instance to populate.
     * @return {module:model/CarrierSimpleV2} The populated <code>CarrierSimpleV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CarrierSimpleV2();
    ...
    /**
     * Validates the JSON data with respect to <code>CarrierSimpleV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CarrierSimpleV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CarrierSimpleV2.RequiredProperties) {
...
CarrierSimpleV2.RequiredProperties = ["id"];

/**
 * @member {Number} id
 */
CarrierSimpleV2.prototype['id'] = undefined;
...
export default CarrierSimpleV2;
