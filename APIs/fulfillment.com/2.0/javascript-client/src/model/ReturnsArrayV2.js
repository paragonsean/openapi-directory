...
import AccountingArrayV2Meta from './AccountingArrayV2Meta';
import ReturnV2 from './ReturnV2';

/**
 * The ReturnsArrayV2 model module.
 * @module model/ReturnsArrayV2
 * @version 2.0
 */
class ReturnsArrayV2 {
    /**
     * Constructs a new <code>ReturnsArrayV2</code>.
     * @alias module:model/ReturnsArrayV2
     */
    constructor() { 
        
        ReturnsArrayV2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReturnsArrayV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReturnsArrayV2} obj Optional instance to populate.
     * @return {module:model/ReturnsArrayV2} The populated <code>ReturnsArrayV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnsArrayV2();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ReturnV2]);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = AccountingArrayV2Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ReturnsArrayV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReturnsArrayV2</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ReturnV2.validateJSON(item);
            };
        }
        // validate the optional field `meta`
        if (data['meta']) { // data not null
          AccountingArrayV2Meta.validateJSON(data['meta']);
        }
...
/**
 * @member {Array.<module:model/ReturnV2>} data
 */
ReturnsArrayV2.prototype['data'] = undefined;

/**
 * @member {module:model/AccountingArrayV2Meta} meta
 */
ReturnsArrayV2.prototype['meta'] = undefined;
