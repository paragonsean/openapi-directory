...
/**
 * The OrderShipV2 model module.
 * @module model/OrderShipV2
 * @version 2.0
 */
class OrderShipV2 {
    /**
     * Constructs a new <code>OrderShipV2</code>.
     * @alias module:model/OrderShipV2
     * @param trackingNumber {String} Tracking number of package
     */
    constructor(trackingNumber) { 
        
        OrderShipV2.initialize(this, trackingNumber);
    }
     ...
     */
    static initialize(obj, trackingNumber) { 
        obj['trackingNumber'] = trackingNumber;
    }

    /**
     * Constructs a <code>OrderShipV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderShipV2} obj Optional instance to populate.
     * @return {module:model/OrderShipV2} The populated <code>OrderShipV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderShipV2();

            if (data.hasOwnProperty('trackingNumber')) {
                obj['trackingNumber'] = ApiClient.convertToType(data['trackingNumber'], 'String');
            }
            if (data.hasOwnProperty('weightOverride')) {
                obj['weightOverride'] = ApiClient.convertToType(data['weightOverride'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderShipV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderShipV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OrderShipV2.RequiredProperties) {
...
OrderShipV2.RequiredProperties = ["trackingNumber"];

/**
 * Tracking number of package
 * @member {String} trackingNumber
 */
OrderShipV2.prototype['trackingNumber'] = undefined;

/**
 * Override predicted weight of package
 * @member {Number} weightOverride
 */
OrderShipV2.prototype['weightOverride'] = undefined;
