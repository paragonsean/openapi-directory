...
import ItemInventoryV2Item from './ItemInventoryV2Item';
import ItemInventoryV2Merchant from './ItemInventoryV2Merchant';
import ItemInventoryV2Quantity from './ItemInventoryV2Quantity';
...
class ItemInventoryV2 {
    ...
    constructor() { 
        ...
        ItemInventoryV2.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = ItemInventoryV2Item.constructFromObject(data['item']);
            }
            if (data.hasOwnProperty('merchant')) {
                obj['merchant'] = ItemInventoryV2Merchant.constructFromObject(data['merchant']);
            }
            if (data.hasOwnProperty('quantity')) {
                obj['quantity'] = ItemInventoryV2Quantity.constructFromObject(data['quantity']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemInventoryV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemInventoryV2</code>.
     */
    static validateJSON(data) {
        // validate the optional field `item`
        if (data['item']) { // data not null
          ItemInventoryV2Item.validateJSON(data['item']);
        }
        // validate the optional field `merchant`
        if (data['merchant']) { // data not null
          ItemInventoryV2Merchant.validateJSON(data['merchant']);
        }
        // validate the optional field `quantity`
        if (data['quantity']) { // data not null
          ItemInventoryV2Quantity.validateJSON(data['quantity']);
        }
...
/**
 * @member {module:model/ItemInventoryV2Item} item
 */
ItemInventoryV2.prototype['item'] = undefined;

/**
 * @member {module:model/ItemInventoryV2Merchant} merchant
 */
ItemInventoryV2.prototype['merchant'] = undefined;

/**
 * @member {module:model/ItemInventoryV2Quantity} quantity
 */
ItemInventoryV2.prototype['quantity'] = undefined;
