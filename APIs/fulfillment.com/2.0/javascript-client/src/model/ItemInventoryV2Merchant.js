...
/**
 * The ItemInventoryV2Merchant model module.
 * @module model/ItemInventoryV2Merchant
 * @version 2.0
 */
class ItemInventoryV2Merchant {
    /**
     * Constructs a new <code>ItemInventoryV2Merchant</code>.
     * Merchant that owns this item
     * @alias module:model/ItemInventoryV2Merchant
     */
    constructor() { 
        
        ItemInventoryV2Merchant.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemInventoryV2Merchant</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemInventoryV2Merchant} obj Optional instance to populate.
     * @return {module:model/ItemInventoryV2Merchant} The populated <code>ItemInventoryV2Merchant</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryV2Merchant();
    ...
    /**
     * Validates the JSON data with respect to <code>ItemInventoryV2Merchant</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemInventoryV2Merchant</code>.
     */
 ...
 * @member {String} name
 */
ItemInventoryV2Merchant.prototype['name'] = undefined;
...
export default ItemInventoryV2Merchant;
