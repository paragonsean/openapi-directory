...
/**
 * The ConsigneeNewV2 model module.
 * @module model/ConsigneeNewV2
 * @version 2.0
 */
class ConsigneeNewV2 {
    /**
     * Constructs a new <code>ConsigneeNewV2</code>.
     * @alias module:model/ConsigneeNewV2
     * @param address1 {String} Address Line 1
     * @param addressLocality {String} City
     * @param addressRegion {String} Province / State
     * @param country {String} Country, for best results please provide the two character ISO code
     * @param email {String} Email, required for international shipments
     * @param firstName {String} 
     * @param lastName {String} 
     * @param phone {String} Phone number, required for international shipments
     */
    constructor(address1, addressLocality, addressRegion, country, email, firstName, lastName, phone) { 
        
        ConsigneeNewV2.initialize(this, address1, addressLocality, addressRegion, country, email, firstName, lastName, phone);
    }
     ...
     */
    static initialize(obj, address1, addressLocality, addressRegion, country, email, firstName, lastName, phone) { 
    ...
    /**
     * Constructs a <code>ConsigneeNewV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConsigneeNewV2} obj Optional instance to populate.
     * @return {module:model/ConsigneeNewV2} The populated <code>ConsigneeNewV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConsigneeNewV2();
    ...
    /**
     * Validates the JSON data with respect to <code>ConsigneeNewV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConsigneeNewV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConsigneeNewV2.RequiredProperties) {
...
ConsigneeNewV2.RequiredProperties = ["address1", "addressLocality", "addressRegion", "country", "email", "firstName", "lastName", "phone"];

/**
 * Address Line 1
 * @member {String} address1
 */
ConsigneeNewV2.prototype['address1'] = undefined;

/**
 * Address Line 2
 * @member {String} address2
 */
ConsigneeNewV2.prototype['address2'] = undefined;

/**
 * City
 * @member {String} addressLocality
 */
ConsigneeNewV2.prototype['addressLocality'] = undefined;

/**
 * Province / State
 * @member {String} addressRegion
 */
ConsigneeNewV2.prototype['addressRegion'] = undefined;

/**
 * @member {String} companyName
 */
ConsigneeNewV2.prototype['companyName'] = undefined;

/**
 * Country, for best results please provide the two character ISO code
 * @member {String} country
 */
ConsigneeNewV2.prototype['country'] = undefined;

/**
 * Email, required for international shipments
 * @member {String} email
 */
ConsigneeNewV2.prototype['email'] = undefined;

/**
 * @member {String} firstName
 */
ConsigneeNewV2.prototype['firstName'] = undefined;

/**
 * @member {String} lastName
 */
ConsigneeNewV2.prototype['lastName'] = undefined;

/**
 * Phone number, required for international shipments
 * @member {String} phone
 */
ConsigneeNewV2.prototype['phone'] = undefined;

/**
 * Postal Code / Zip
 * @member {String} postalCode
 */
ConsigneeNewV2.prototype['postalCode'] = undefined;
