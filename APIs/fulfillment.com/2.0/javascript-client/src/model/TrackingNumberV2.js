...
import CarrierSimpleV2 from './CarrierSimpleV2';
...
class TrackingNumberV2 {
    ...
    constructor() { 
        ...
        TrackingNumberV2.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('carrier')) {
                obj['carrier'] = CarrierSimpleV2.constructFromObject(data['carrier']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TrackingNumberV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrackingNumberV2</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['barcodeScanValue'] && !(typeof data['barcodeScanValue'] === 'string' || data['barcodeScanValue'] instanceof String)) {
            throw new Error("Expected the field `barcodeScanValue` to be a primitive type in the JSON string but got " + data['barcodeScanValue']);
        }
        // validate the optional field `carrier`
        if (data['carrier']) { // data not null
          CarrierSimpleV2.validateJSON(data['carrier']);
        }
        // ensure the json data is a string
 ...
 */
TrackingNumberV2.prototype['barcodeScanValue'] = undefined;

/**
 * @member {module:model/CarrierSimpleV2} carrier
 */
TrackingNumberV2.prototype['carrier'] = undefined;

/**
 * The human readable tracking number recipients (consignee) expect
 * @member {String} value
 */
TrackingNumberV2.prototype['value'] = undefined;
...
export default TrackingNumberV2;
