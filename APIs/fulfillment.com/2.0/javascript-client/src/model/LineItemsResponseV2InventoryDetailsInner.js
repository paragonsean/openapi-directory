...
/**
 * The LineItemsResponseV2InventoryDetailsInner model module.
 * @module model/LineItemsResponseV2InventoryDetailsInner
 * @version 2.0
 */
class LineItemsResponseV2InventoryDetailsInner {
    /**
     * Constructs a new <code>LineItemsResponseV2InventoryDetailsInner</code>.
     * @alias module:model/LineItemsResponseV2InventoryDetailsInner
     */
    constructor() { 
        
        LineItemsResponseV2InventoryDetailsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LineItemsResponseV2InventoryDetailsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LineItemsResponseV2InventoryDetailsInner} obj Optional instance to populate.
     * @return {module:model/LineItemsResponseV2InventoryDetailsInner} The populated <code>LineItemsResponseV2InventoryDetailsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LineItemsResponseV2InventoryDetailsInner();

            if (data.hasOwnProperty('expirationDate')) {
                obj['expirationDate'] = ApiClient.convertToType(data['expirationDate'], 'Date');
            }
            if (data.hasOwnProperty('lotNum')) {
                obj['lotNum'] = ApiClient.convertToType(data['lotNum'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LineItemsResponseV2InventoryDetailsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LineItemsResponseV2InventoryDetailsInner</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['lotNum'] && !(typeof data['lotNum'] === 'string' || data['lotNum'] instanceof String)) {
            throw new Error("Expected the field `lotNum` to be a primitive type in the JSON string but got " + data['lotNum']);
        }
        // ensure the json data is a string
 ...
 */
LineItemsResponseV2InventoryDetailsInner.prototype['expirationDate'] = undefined;

/**
 * @member {String} lotNum
 */
LineItemsResponseV2InventoryDetailsInner.prototype['lotNum'] = undefined;

/**
 * @member {Number} quantity
 */
LineItemsResponseV2InventoryDetailsInner.prototype['quantity'] = undefined;

/**
 * @member {String} serialNum
 */
LineItemsResponseV2InventoryDetailsInner.prototype['serialNum'] = undefined;
...
export default LineItemsResponseV2InventoryDetailsInner;
