...
/**
 * The RmaItemV2Item model module.
 * @module model/RmaItemV2Item
 * @version 2.0
 */
class RmaItemV2Item {
    /**
     * Constructs a new <code>RmaItemV2Item</code>.
     * @alias module:model/RmaItemV2Item
     */
    constructor() { 
        
        RmaItemV2Item.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RmaItemV2Item</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RmaItemV2Item} obj Optional instance to populate.
     * @return {module:model/RmaItemV2Item} The populated <code>RmaItemV2Item</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RmaItemV2Item();
    ...
    /**
     * Validates the JSON data with respect to <code>RmaItemV2Item</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RmaItemV2Item</code>.
     */
 ...
 * @member {Number} id
 */
RmaItemV2Item.prototype['id'] = undefined;

/**
 * @member {String} sku
 */
RmaItemV2Item.prototype['sku'] = undefined;
