...
import UserContactV2Merchant from './UserContactV2Merchant';
...
class UserContactV2 {
    ...
    constructor(id) { 
        ...
        UserContactV2.initialize(this, id);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('contactInfo')) {
                obj['contactInfo'] = UserContactV2.constructFromObject(data['contactInfo']);
            }
            ...
            if (data.hasOwnProperty('merchant')) {
                obj['merchant'] = UserContactV2Merchant.constructFromObject(data['merchant']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UserContactV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserContactV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserContactV2.RequiredProperties) {
        ...
        if (data['contactInfo']) { // data not null
          UserContactV2.validateJSON(data['contactInfo']);
        }
        // validate the optional field `merchant`
        if (data['merchant']) { // data not null
          UserContactV2Merchant.validateJSON(data['merchant']);
        }
        // ensure the json data is a string
...
UserContactV2.RequiredProperties = ["id"];

/**
 * Depricated
 * @member {String} apiKey
 */
UserContactV2.prototype['apiKey'] = undefined;

/**
 * @member {module:model/UserContactV2} contactInfo
 */
UserContactV2.prototype['contactInfo'] = undefined;

/**
 * @member {Date} createDate
 */
UserContactV2.prototype['createDate'] = undefined;

/**
 * @member {Boolean} deptLeader
 */
UserContactV2.prototype['deptLeader'] = undefined;

/**
 * @member {Number} id
 */
UserContactV2.prototype['id'] = undefined;

/**
 * @member {module:model/UserContactV2Merchant} merchant
 */
UserContactV2.prototype['merchant'] = undefined;

/**
 * @member {String} name
 */
UserContactV2.prototype['name'] = undefined;

/**
 * @member {Boolean} status
 */
UserContactV2.prototype['status'] = undefined;

/**
 * @member {Date} updatedAt
 */
UserContactV2.prototype['updatedAt'] = undefined;

/**
 * @member {Date} updatedBy
 */
UserContactV2.prototype['updatedBy'] = undefined;

/**
 * @member {String} username
 */
UserContactV2.prototype['username'] = undefined;
