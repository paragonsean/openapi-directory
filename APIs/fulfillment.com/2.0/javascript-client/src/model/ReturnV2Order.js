...
/**
 * The ReturnV2Order model module.
 * @module model/ReturnV2Order
 * @version 2.0
 */
class ReturnV2Order {
    /**
     * Constructs a new <code>ReturnV2Order</code>.
     * @alias module:model/ReturnV2Order
     */
    constructor() { 
        
        ReturnV2Order.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReturnV2Order</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReturnV2Order} obj Optional instance to populate.
     * @return {module:model/ReturnV2Order} The populated <code>ReturnV2Order</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnV2Order();
    ...
    /**
     * Validates the JSON data with respect to <code>ReturnV2Order</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReturnV2Order</code>.
     */
 ...
 * @member {Number} id
 */
ReturnV2Order.prototype['id'] = undefined;

/**
 * @member {Number} merchantId
 */
ReturnV2Order.prototype['merchantId'] = undefined;

/**
 * @member {String} merchantOrderId
 */
ReturnV2Order.prototype['merchantOrderId'] = undefined;
