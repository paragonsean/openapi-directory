...
class ErrorStandardV2 {
    ...
    constructor() { 
        ...
        ErrorStandardV2.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorStandardV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorStandardV2</code>.
     */
 ...
 */
ErrorStandardV2.prototype['message'] = undefined;
...
export default ErrorStandardV2;
