...
class StatusTypeV2Stage {
    ...
    constructor() { 
        ...
        StatusTypeV2Stage.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StatusTypeV2Stage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatusTypeV2Stage</code>.
     */
 ...
 * @member {String} code
 */
StatusTypeV2Stage.prototype['code'] = undefined;

/**
 * @member {String} name
 */
StatusTypeV2Stage.prototype['name'] = undefined;
...
export default StatusTypeV2Stage;
