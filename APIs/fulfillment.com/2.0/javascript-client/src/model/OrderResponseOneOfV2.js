...
import LineItemsResponseV2 from './LineItemsResponseV2';
import OrderResponseHydrateV2 from './OrderResponseHydrateV2';
import OrderResponseHydrateV2AllOfTrackingNumbersInner from './OrderResponseHydrateV2AllOfTrackingNumbersInner';

/**
 * The OrderResponseOneOfV2 model module.
 * @module model/OrderResponseOneOfV2
 * @version 2.0
 */
class OrderResponseOneOfV2 {
    /**
     * Constructs a new <code>OrderResponseOneOfV2</code>.
     * Standard Order Response or a Hydrated Response
     * @alias module:model/OrderResponseOneOfV2
     * @param {(module:model/ERRORUNKNOWN|module:model/OrderResponseHydrateV2)} instance The actual instance to initialize OrderResponseOneOfV2.
     */
    constructor(instance = null) {
        ...
        try {
            if (typeof instance === "OrderResponseHydrateV2") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                OrderResponseHydrateV2.validateJSON(instance); // throw an exception if no match
                // create OrderResponseHydrateV2 from JS object
                this.actualInstance = OrderResponseHydrateV2.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into OrderResponseHydrateV2
            errorMessages.push("Failed to construct OrderResponseHydrateV2: " + err)
        }

        if (match > 1) {
            throw new Error("Multiple matches found constructing `OrderResponseOneOfV2` with oneOf schemas ERRORUNKNOWN, OrderResponseHydrateV2. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `OrderResponseOneOfV2` with oneOf schemas ERRORUNKNOWN, OrderResponseHydrateV2. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>OrderResponseOneOfV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderResponseOneOfV2} obj Optional instance to populate.
     * @return {module:model/OrderResponseOneOfV2} The populated <code>OrderResponseOneOfV2</code> instance.
     */
    static constructFromObject(data, obj) {
        return new OrderResponseOneOfV2(data);
    }

    /**
     * Gets the actual instance, which can be <code>ERRORUNKNOWN</code>, <code>OrderResponseHydrateV2</code>.
     * @return {(module:model/ERRORUNKNOWN|module:model/OrderResponseHydrateV2)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>ERRORUNKNOWN</code>, <code>OrderResponseHydrateV2</code>.
     * @param {(module:model/ERRORUNKNOWN|module:model/OrderResponseHydrateV2)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = OrderResponseOneOfV2.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of OrderResponseOneOfV2 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/OrderResponseOneOfV2} An instance of OrderResponseOneOfV2.
     */
    static fromJSON = function(json_string){
        return OrderResponseOneOfV2.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
OrderResponseOneOfV2.prototype['integrator'] = undefined;

/**
 * @member {Array.<module:model/LineItemsResponseV2>} lineItems
 */
OrderResponseOneOfV2.prototype['lineItems'] = undefined;

/**
 * @member {Array.<module:model/OrderResponseHydrateV2AllOfTrackingNumbersInner>} trackingNumbers
 */
OrderResponseOneOfV2.prototype['trackingNumbers'] = undefined;


OrderResponseOneOfV2.OneOf = ["ERRORUNKNOWN", "OrderResponseHydrateV2"];

export default OrderResponseOneOfV2;
