...
import RmaItemV2Item from './RmaItemV2Item';
import RmaItemV2NonRestockedReason from './RmaItemV2NonRestockedReason';

/**
 * The RmaItemV2 model module.
 * @module model/RmaItemV2
 * @version 2.0
 */
class RmaItemV2 {
    /**
     * Constructs a new <code>RmaItemV2</code>.
     * @alias module:model/RmaItemV2
     */
    constructor() { 
        
        RmaItemV2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RmaItemV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RmaItemV2} obj Optional instance to populate.
     * @return {module:model/RmaItemV2} The populated <code>RmaItemV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RmaItemV2();
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = RmaItemV2Item.constructFromObject(data['item']);
            }
            if (data.hasOwnProperty('nonRestockedReason')) {
                obj['nonRestockedReason'] = RmaItemV2NonRestockedReason.constructFromObject(data['nonRestockedReason']);
            }
            if (data.hasOwnProperty('quantityExpected')) {
                obj['quantityExpected'] = ApiClient.convertToType(data['quantityExpected'], 'Number');
            }
            if (data.hasOwnProperty('quantityRestocked')) {
                obj['quantityRestocked'] = ApiClient.convertToType(data['quantityRestocked'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>RmaItemV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RmaItemV2</code>.
     */
    static validateJSON(data) {
        ...
        if (data['item']) { // data not null
          RmaItemV2Item.validateJSON(data['item']);
        }
        // validate the optional field `nonRestockedReason`
        if (data['nonRestockedReason']) { // data not null
          RmaItemV2NonRestockedReason.validateJSON(data['nonRestockedReason']);
        }
 ...
 */
RmaItemV2.prototype['comments'] = undefined;

/**
 * @member {Number} id
 */
RmaItemV2.prototype['id'] = undefined;

/**
 * @member {module:model/RmaItemV2Item} item
 */
RmaItemV2.prototype['item'] = undefined;

/**
 * @member {module:model/RmaItemV2NonRestockedReason} nonRestockedReason
 */
RmaItemV2.prototype['nonRestockedReason'] = undefined;

/**
 * @member {Number} quantityExpected
 */
RmaItemV2.prototype['quantityExpected'] = undefined;

/**
 * @member {Number} quantityRestocked
 */
RmaItemV2.prototype['quantityRestocked'] = undefined;

/**
 * @member {Number} quantityReturned
 */
RmaItemV2.prototype['quantityReturned'] = undefined;

/**
 * @member {Number} quantityShipped
 */
RmaItemV2.prototype['quantityShipped'] = undefined;
