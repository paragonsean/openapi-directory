...
/**
 * The StatusTypeSimpleV2Status model module.
 * @module model/StatusTypeSimpleV2Status
 * @version 2.0
 */
class StatusTypeSimpleV2Status {
    /**
     * Constructs a new <code>StatusTypeSimpleV2Status</code>.
     * @alias module:model/StatusTypeSimpleV2Status
     * @param code {String} 
     */
    constructor(code) { 
        
        StatusTypeSimpleV2Status.initialize(this, code);
    }
    ...
    /**
     * Constructs a <code>StatusTypeSimpleV2Status</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatusTypeSimpleV2Status} obj Optional instance to populate.
     * @return {module:model/StatusTypeSimpleV2Status} The populated <code>StatusTypeSimpleV2Status</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatusTypeSimpleV2Status();
    ...
    /**
     * Validates the JSON data with respect to <code>StatusTypeSimpleV2Status</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatusTypeSimpleV2Status</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatusTypeSimpleV2Status.RequiredProperties) {
...
StatusTypeSimpleV2Status.RequiredProperties = ["code"];

/**
 * @member {String} code
 */
StatusTypeSimpleV2Status.prototype['code'] = undefined;
...
export default StatusTypeSimpleV2Status;
