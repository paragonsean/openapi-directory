...
import AccessTokenRequestPasswordV2 from './AccessTokenRequestPasswordV2';
import AccessTokenRequestRefreshV2 from './AccessTokenRequestRefreshV2';
 ...
 * @version 2.0
 */
class AccessTokenRequestV2 {
    /**
     * Constructs a new <code>AccessTokenRequestV2</code>.
     * @alias module:model/AccessTokenRequestV2
     * @param {(module:model/AccessTokenRequestPasswordV2|module:model/AccessTokenRequestRefreshV2)} instance The actual instance to initialize AccessTokenRequestV2.
     */
    constructor(instance = null) {
        ...
        var errorMessages = [];
        try {
            if (typeof instance === "AccessTokenRequestPasswordV2") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                AccessTokenRequestPasswordV2.validateJSON(instance); // throw an exception if no match
                // create AccessTokenRequestPasswordV2 from JS object
                this.actualInstance = AccessTokenRequestPasswordV2.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into AccessTokenRequestPasswordV2
            errorMessages.push("Failed to construct AccessTokenRequestPasswordV2: " + err)
        }

        try {
            if (typeof instance === "AccessTokenRequestRefreshV2") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                AccessTokenRequestRefreshV2.validateJSON(instance); // throw an exception if no match
                // create AccessTokenRequestRefreshV2 from JS object
                this.actualInstance = AccessTokenRequestRefreshV2.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into AccessTokenRequestRefreshV2
            errorMessages.push("Failed to construct AccessTokenRequestRefreshV2: " + err)
        }

        if (match > 1) {
            throw new Error("Multiple matches found constructing `AccessTokenRequestV2` with oneOf schemas AccessTokenRequestPasswordV2, AccessTokenRequestRefreshV2. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `AccessTokenRequestV2` with oneOf schemas AccessTokenRequestPasswordV2, AccessTokenRequestRefreshV2. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    static constructFromObject(data, obj) {
        return new AccessTokenRequestV2(data);
    }

    /**
     * Gets the actual instance, which can be <code>AccessTokenRequestPasswordV2</code>, <code>AccessTokenRequestRefreshV2</code>.
     * @return {(module:model/AccessTokenRequestPasswordV2|module:model/AccessTokenRequestRefreshV2)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>AccessTokenRequestPasswordV2</code>, <code>AccessTokenRequestRefreshV2</code>.
     * @param {(module:model/AccessTokenRequestPasswordV2|module:model/AccessTokenRequestRefreshV2)} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = AccessTokenRequestV2.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of AccessTokenRequestV2 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/AccessTokenRequestV2} An instance of AccessTokenRequestV2.
     */
    static fromJSON = function(json_string){
        return AccessTokenRequestV2.constructFromObject(JSON.parse(json_string));
    }
}
 ...
 */
AccessTokenRequestV2.prototype['password'] = undefined;

/**
 * 
 * @member {String} username
 */
AccessTokenRequestV2.prototype['username'] = undefined;

/**
 * Id and secret provided by FDC
 * @member {String} client_id
 */
AccessTokenRequestV2.prototype['client_id'] = undefined;

/**
 * @member {String} client_secret
 */
AccessTokenRequestV2.prototype['client_secret'] = undefined;

/**
 * Indicates how you're authenticating your request
 * @member {module:model/AccessTokenRequestV2.GrantTypeEnum} grant_type
 */
AccessTokenRequestV2.prototype['grant_type'] = undefined;

/**
 * Currently limited to Order Management System
 * @member {module:model/AccessTokenRequestV2.ScopeEnum} scope
 * @default 'oms'
 */
AccessTokenRequestV2.prototype['scope'] = 'oms';

/**
 * You may request future tokens with the `refresh_token` from your previous `/oauth/access_token` request
 * @member {String} refresh_token
 */
AccessTokenRequestV2.prototype['refresh_token'] = undefined;


AccessTokenRequestV2.OneOf = ["AccessTokenRequestPasswordV2", "AccessTokenRequestRefreshV2"];

export default AccessTokenRequestV2;
