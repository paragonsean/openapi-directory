...
/**
 * The AccountingArrayV2Meta model module.
 * @module model/AccountingArrayV2Meta
 * @version 2.0
 */
class AccountingArrayV2Meta {
    /**
     * Constructs a new <code>AccountingArrayV2Meta</code>.
     * @alias module:model/AccountingArrayV2Meta
     */
    constructor() { 
        
        AccountingArrayV2Meta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountingArrayV2Meta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountingArrayV2Meta} obj Optional instance to populate.
     * @return {module:model/AccountingArrayV2Meta} The populated <code>AccountingArrayV2Meta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountingArrayV2Meta();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountingArrayV2Meta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountingArrayV2Meta</code>.
     */
    static validateJSON(data) {
        // validate the optional field `pagination`
        if (data['pagination']) { // data not null
          PaginationV2.validateJSON(data['pagination']);
        }
 ...
 */
AccountingArrayV2Meta.prototype['pagination'] = undefined;
...
export default AccountingArrayV2Meta;
