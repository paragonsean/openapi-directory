...
/**
 * The AccountingV2Order model module.
 * @module model/AccountingV2Order
 * @version 2.0
 */
class AccountingV2Order {
    /**
     * Constructs a new <code>AccountingV2Order</code>.
     * @alias module:model/AccountingV2Order
     */
    constructor() { 
        
        AccountingV2Order.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountingV2Order</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountingV2Order} obj Optional instance to populate.
     * @return {module:model/AccountingV2Order} The populated <code>AccountingV2Order</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountingV2Order();
            ...
            if (data.hasOwnProperty('merchantOrderId')) {
                obj['merchantOrderId'] = ApiClient.convertToType(data['merchantOrderId'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountingV2Order</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountingV2Order</code>.
     */
 ...
 * @member {Number} id
 */
AccountingV2Order.prototype['id'] = undefined;

/**
 * Date of the order when it was recorded by accounting.
 * @member {Date} invoiceDate
 */
AccountingV2Order.prototype['invoiceDate'] = undefined;

/**
 * Merchant order id
 * @member {Number} merchantOrderId
 */
AccountingV2Order.prototype['merchantOrderId'] = undefined;

/**
 * Date of the order when it was initially received.
 * @member {Date} recordedDate
 */
AccountingV2Order.prototype['recordedDate'] = undefined;
...
export default AccountingV2Order;
