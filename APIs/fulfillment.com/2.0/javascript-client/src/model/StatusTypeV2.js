...
class StatusTypeV2 {
     ...
     */
    constructor(code, detailCode, stage, state) { 
        
        StatusTypeV2.initialize(this, code, detailCode, stage, state);
    }
     ...
     */
    static initialize(obj, code, detailCode, stage, state) { 
        obj['code'] = code;
    ...
    /**
     * Validates the JSON data with respect to <code>StatusTypeV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StatusTypeV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StatusTypeV2.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `actionRequiredBy`
        if (data['actionRequiredBy']) { // data not null
          StatusTypeV2ActionRequiredBy.validateJSON(data['actionRequiredBy']);
        }
        ...
        // ensure the json data is a string
        if (data['detailCode'] && !(typeof data['detailCode'] === 'string' || data['detailCode'] instanceof String)) {
            throw new Error("Expected the field `detailCode` to be a primitive type in the JSON string but got " + data['detailCode']);
        }
        // ensure the json data is a string
        ...
        if (data['stage']) { // data not null
          StatusTypeV2Stage.validateJSON(data['stage']);
        }
        // validate the optional field `state`
        if (data['state']) { // data not null
          StatusTypeV2Stage.validateJSON(data['state']);
        }
...
StatusTypeV2.RequiredProperties = ["code", "detailCode", "stage", "state"];

/**
 * @member {module:model/StatusTypeV2ActionRequiredBy} actionRequiredBy
 */
StatusTypeV2.prototype['actionRequiredBy'] = undefined;

/**
 * Code, see [status codes](#section/Getting-Started/Status-Codes)
 * @member {String} code
 */
StatusTypeV2.prototype['code'] = undefined;

/**
 * @member {String} detail
 */
StatusTypeV2.prototype['detail'] = undefined;

/**
 * @member {String} detailCode
 */
StatusTypeV2.prototype['detailCode'] = undefined;

/**
 * Depricated, use code instead
 * @member {Number} id
 */
StatusTypeV2.prototype['id'] = undefined;

/**
 * Depricated, does this status event close the order
 * @member {Boolean} isClosed
 */
StatusTypeV2.prototype['isClosed'] = undefined;

/**
 * Depricated, use stage/state instead
 * @member {String} name
 */
StatusTypeV2.prototype['name'] = undefined;

/**
 * Depricated
 * @member {String} reason
 */
StatusTypeV2.prototype['reason'] = undefined;

/**
 * @member {module:model/StatusTypeV2Stage} stage
 */
StatusTypeV2.prototype['stage'] = undefined;

/**
 * @member {module:model/StatusTypeV2Stage} state
 */
StatusTypeV2.prototype['state'] = undefined;
