...
/**
 * The AccountingV2Fees model module.
 * @module model/AccountingV2Fees
 * @version 2.0
 */
class AccountingV2Fees {
    /**
     * Constructs a new <code>AccountingV2Fees</code>.
     * @alias module:model/AccountingV2Fees
     */
    constructor() { 
        
        AccountingV2Fees.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountingV2Fees</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountingV2Fees} obj Optional instance to populate.
     * @return {module:model/AccountingV2Fees} The populated <code>AccountingV2Fees</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountingV2Fees();

            if (data.hasOwnProperty('box')) {
                obj['box'] = ApiClient.convertToType(data['box'], 'Number');
            }
            if (data.hasOwnProperty('envelope')) {
                obj['envelope'] = ApiClient.convertToType(data['envelope'], 'Number');
            }
            if (data.hasOwnProperty('fulfillment')) {
                obj['fulfillment'] = ApiClient.convertToType(data['fulfillment'], 'Number');
            }
            if (data.hasOwnProperty('insert')) {
                obj['insert'] = ApiClient.convertToType(data['insert'], 'Number');
            }
            if (data.hasOwnProperty('kitting')) {
                obj['kitting'] = ApiClient.convertToType(data['kitting'], 'Number');
            }
            if (data.hasOwnProperty('picking')) {
                obj['picking'] = ApiClient.convertToType(data['picking'], 'Number');
            }
            if (data.hasOwnProperty('postage')) {
                obj['postage'] = ApiClient.convertToType(data['postage'], 'Number');
            }
            if (data.hasOwnProperty('print')) {
                obj['print'] = ApiClient.convertToType(data['print'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountingV2Fees</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountingV2Fees</code>.
     */
 ...
 * @member {Number} box
 */
AccountingV2Fees.prototype['box'] = undefined;

/**
 * 
 * @member {Number} envelope
 */
AccountingV2Fees.prototype['envelope'] = undefined;

/**
 * 
 * @member {Number} fulfillment
 */
AccountingV2Fees.prototype['fulfillment'] = undefined;

/**
 * 
 * @member {Number} insert
 */
AccountingV2Fees.prototype['insert'] = undefined;

/**
 * 
 * @member {Number} kitting
 */
AccountingV2Fees.prototype['kitting'] = undefined;

/**
 * 
 * @member {Number} picking
 */
AccountingV2Fees.prototype['picking'] = undefined;

/**
 * 
 * @member {Number} postage
 */
AccountingV2Fees.prototype['postage'] = undefined;

/**
 * 
 * @member {Number} print
 */
AccountingV2Fees.prototype['print'] = undefined;

/**
 * 
 * @member {Number} total
 */
AccountingV2Fees.prototype['total'] = undefined;
...
export default AccountingV2Fees;
