...
/**
 * The OrderResponseV2ParentOrder model module.
 * @module model/OrderResponseV2ParentOrder
 * @version 2.0
 */
class OrderResponseV2ParentOrder {
    /**
     * Constructs a new <code>OrderResponseV2ParentOrder</code>.
     * @alias module:model/OrderResponseV2ParentOrder
     */
    constructor() { 
        
        OrderResponseV2ParentOrder.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderResponseV2ParentOrder</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderResponseV2ParentOrder} obj Optional instance to populate.
     * @return {module:model/OrderResponseV2ParentOrder} The populated <code>OrderResponseV2ParentOrder</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderResponseV2ParentOrder();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderResponseV2ParentOrder</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderResponseV2ParentOrder</code>.
     */
 ...
 * @member {Number} id
 */
OrderResponseV2ParentOrder.prototype['id'] = undefined;
...
export default OrderResponseV2ParentOrder;
