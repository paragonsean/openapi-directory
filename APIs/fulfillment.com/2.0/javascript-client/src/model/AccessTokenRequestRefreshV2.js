...
/**
 * The AccessTokenRequestRefreshV2 model module.
 * @module model/AccessTokenRequestRefreshV2
 * @version 2.0
 */
class AccessTokenRequestRefreshV2 {
    /**
     * Constructs a new <code>AccessTokenRequestRefreshV2</code>.
     * @alias module:model/AccessTokenRequestRefreshV2
     * @implements module:model/ERRORUNKNOWN
     * @param refreshToken {String} You may request future tokens with the `refresh_token` from your previous `/oauth/access_token` request
     */
    constructor(refreshToken) { 
        
        AccessTokenRequestRefreshV2.initialize(this, refreshToken);
    }
    ...
    /**
     * Constructs a <code>AccessTokenRequestRefreshV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccessTokenRequestRefreshV2} obj Optional instance to populate.
     * @return {module:model/AccessTokenRequestRefreshV2} The populated <code>AccessTokenRequestRefreshV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccessTokenRequestRefreshV2();
    ...
    /**
     * Validates the JSON data with respect to <code>AccessTokenRequestRefreshV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccessTokenRequestRefreshV2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccessTokenRequestRefreshV2.RequiredProperties) {
...
AccessTokenRequestRefreshV2.RequiredProperties = ["refresh_token"];

/**
 * You may request future tokens with the `refresh_token` from your previous `/oauth/access_token` request
 * @member {String} refresh_token
 */
AccessTokenRequestRefreshV2.prototype['refresh_token'] = undefined;
...
export default AccessTokenRequestRefreshV2;
