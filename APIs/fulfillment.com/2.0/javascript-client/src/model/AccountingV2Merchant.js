...
/**
 * The AccountingV2Merchant model module.
 * @module model/AccountingV2Merchant
 * @version 2.0
 */
class AccountingV2Merchant {
    /**
     * Constructs a new <code>AccountingV2Merchant</code>.
     * @alias module:model/AccountingV2Merchant
     */
    constructor() { 
        
        AccountingV2Merchant.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountingV2Merchant</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountingV2Merchant} obj Optional instance to populate.
     * @return {module:model/AccountingV2Merchant} The populated <code>AccountingV2Merchant</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountingV2Merchant();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountingV2Merchant</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountingV2Merchant</code>.
     */
 ...
 * @member {Number} id
 */
AccountingV2Merchant.prototype['id'] = undefined;

/**
 * Name of the merchant
 * @member {String} name
 */
AccountingV2Merchant.prototype['name'] = undefined;
...
export default AccountingV2Merchant;
