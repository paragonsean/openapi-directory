...
class TrackingResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('destination')) {
                obj['destination'] = Object.constructFromObject(data['destination']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TrackingResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrackingResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `origin`
        if (data['origin']) { // data not null
          Feature.validateJSON(data['origin']);
        }
        ...
        if (data['trackedEvents']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['trackedEvents'])) {
                throw new Error("Expected the field `trackedEvents` to be an array in the JSON data but got " + data['trackedEvents']);
            }
            // validate the optional field `trackedEvents` (array)
            for (const item of data['trackedEvents']) {
                TrackingEventV2.validateJSON(item);
            };
        }
        // validate the optional field `trackingNumber`
        if (data['trackingNumber']) { // data not null
          TrackingNumberV2.validateJSON(data['trackingNumber']);
        }
 ...
 */
TrackingResponse.prototype['destination'] = undefined;

/**
 * @member {Number} fdcOrderId
 */
TrackingResponse.prototype['fdcOrderId'] = undefined;

/**
 * @member {Date} firstCheckedDateTime
 */
TrackingResponse.prototype['firstCheckedDateTime'] = undefined;

/**
 * @member {Date} firstTransitEvent
 */
TrackingResponse.prototype['firstTransitEvent'] = undefined;

/**
 * @member {Date} lastCheckedDateTime
 */
TrackingResponse.prototype['lastCheckedDateTime'] = undefined;

/**
 * @member {Date} lastUpdatedDateTime
 */
TrackingResponse.prototype['lastUpdatedDateTime'] = undefined;

/**
 * @member {module:model/Feature} origin
 */
TrackingResponse.prototype['origin'] = undefined;
 ...
 */
TrackingResponse.prototype['statusCategoryCode'] = undefined;

/**
 * @member {Date} statusDateTime
 */
TrackingResponse.prototype['statusDateTime'] = undefined;

/**
 * @member {String} statusMessage
 */
TrackingResponse.prototype['statusMessage'] = undefined;

/**
 * @member {Array.<module:model/TrackingEventV2>} trackedEvents
 */
TrackingResponse.prototype['trackedEvents'] = undefined;
