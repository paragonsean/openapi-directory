...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.ReturnsApi();
  });
  ...
  describe('ReturnsApi', function() {
    ...
    describe('putReturns', function() {
      it('should call putReturns successfully', function(done) {
        //uncomment below and update the code to test putReturns
        //instance.putReturns(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
