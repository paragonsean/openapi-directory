...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.PartnersApi();
  });
  ...
  describe('PartnersApi', function() {
    describe('putOrdersIdShip', function() {
      it('should call putOrdersIdShip successfully', function(done) {
        //uncomment below and update the code to test putOrdersIdShip
        //instance.putOrdersIdShip(function(error) {
    ...
    describe('putOrdersIdStatus', function() {
      it('should call putOrdersIdStatus successfully', function(done) {
        //uncomment below and update the code to test putOrdersIdStatus
        //instance.putOrdersIdStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
