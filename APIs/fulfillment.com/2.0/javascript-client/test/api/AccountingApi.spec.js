...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccountingApi();
  });
  ...
  describe('AccountingApi', function() {
    describe('getAccounting', function() {
      it('should call getAccounting successfully', function(done) {
        //uncomment below and update the code to test getAccounting
        //instance.getAccounting(function(error) {
