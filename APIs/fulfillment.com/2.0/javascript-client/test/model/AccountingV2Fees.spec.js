...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccountingV2Fees();
  });
  ...
  describe('AccountingV2Fees', function() {
    it('should create an instance of AccountingV2Fees', function() {
      // uncomment below and update the code to test AccountingV2Fees
      //var instance = new FulfillmentComApiv2.AccountingV2Fees();
      //expect(instance).to.be.a(FulfillmentComApiv2.AccountingV2Fees);
    });
    ...
    it('should have the property kitting (base name: "kitting")', function() {
      // uncomment below and update the code to test the property kitting
      //var instance = new FulfillmentComApiv2.AccountingV2Fees();
      //expect(instance).to.be();
    });

    it('should have the property picking (base name: "picking")', function() {
      // uncomment below and update the code to test the property picking
      //var instance = new FulfillmentComApiv2.AccountingV2Fees();
      //expect(instance).to.be();
    });

    it('should have the property postage (base name: "postage")', function() {
      // uncomment below and update the code to test the property postage
      //var instance = new FulfillmentComApiv2.AccountingV2Fees();
      //expect(instance).to.be();
    });
