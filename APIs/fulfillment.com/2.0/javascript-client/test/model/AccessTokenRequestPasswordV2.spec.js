...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccessTokenRequestPasswordV2();
  });
  ...
  describe('AccessTokenRequestPasswordV2', function() {
    it('should create an instance of AccessTokenRequestPasswordV2', function() {
      // uncomment below and update the code to test AccessTokenRequestPasswordV2
      //var instance = new FulfillmentComApiv2.AccessTokenRequestPasswordV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.AccessTokenRequestPasswordV2);
    });
