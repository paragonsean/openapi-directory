...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.OrderResponseHydrateV2();
  });
  ...
  describe('OrderResponseHydrateV2', function() {
    it('should create an instance of OrderResponseHydrateV2', function() {
      // uncomment below and update the code to test OrderResponseHydrateV2
      //var instance = new FulfillmentComApiv2.OrderResponseHydrateV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.OrderResponseHydrateV2);
    });
