...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.OrderRequestV2Warehouse();
  });
  ...
  describe('OrderRequestV2Warehouse', function() {
    it('should create an instance of OrderRequestV2Warehouse', function() {
      // uncomment below and update the code to test OrderRequestV2Warehouse
      //var instance = new FulfillmentComApiv2.OrderRequestV2Warehouse();
      //expect(instance).to.be.a(FulfillmentComApiv2.OrderRequestV2Warehouse);
    });
