...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.ReturnV2Order();
  });
  ...
  describe('ReturnV2Order', function() {
    it('should create an instance of ReturnV2Order', function() {
      // uncomment below and update the code to test ReturnV2Order
      //var instance = new FulfillmentComApiv2.ReturnV2Order();
      //expect(instance).to.be.a(FulfillmentComApiv2.ReturnV2Order);
    });
