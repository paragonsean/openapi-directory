...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.OrderResponseOneOfV2();
  });
  ...
  describe('OrderResponseOneOfV2', function() {
    it('should create an instance of OrderResponseOneOfV2', function() {
      // uncomment below and update the code to test OrderResponseOneOfV2
      //var instance = new FulfillmentComApiv2.OrderResponseOneOfV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.OrderResponseOneOfV2);
    });
    ...
    it('should have the property trackingNumbers (base name: "trackingNumbers")', function() {
