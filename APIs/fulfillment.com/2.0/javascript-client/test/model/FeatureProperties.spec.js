...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.FeatureProperties();
  });
  ...
  describe('FeatureProperties', function() {
    it('should create an instance of FeatureProperties', function() {
      ...
      //var instance = new FulfillmentComApiv2.FeatureProperties();
      //expect(instance).to.be.a(FulfillmentComApiv2.FeatureProperties);
    });
