...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.LineItemsResponseV2();
  });
  ...
  describe('LineItemsResponseV2', function() {
    it('should create an instance of LineItemsResponseV2', function() {
      // uncomment below and update the code to test LineItemsResponseV2
      //var instance = new FulfillmentComApiv2.LineItemsResponseV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.LineItemsResponseV2);
    });
    ...
    it('should have the property lineDetails (base name: "lineDetails")', function() {
      // uncomment below and update the code to test the property lineDetails
      //var instance = new FulfillmentComApiv2.LineItemsResponseV2();
      //expect(instance).to.be();
    });

    it('should have the property requestedSkuData (base name: "requestedSkuData")', function() {
      // uncomment below and update the code to test the property requestedSkuData
      //var instance = new FulfillmentComApiv2.LineItemsResponseV2();
      //expect(instance).to.be();
    });
