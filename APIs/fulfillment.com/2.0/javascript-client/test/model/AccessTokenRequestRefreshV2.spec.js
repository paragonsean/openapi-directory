...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccessTokenRequestRefreshV2();
  });
  ...
  describe('AccessTokenRequestRefreshV2', function() {
    it('should create an instance of AccessTokenRequestRefreshV2', function() {
      // uncomment below and update the code to test AccessTokenRequestRefreshV2
      //var instance = new FulfillmentComApiv2.AccessTokenRequestRefreshV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.AccessTokenRequestRefreshV2);
    });
