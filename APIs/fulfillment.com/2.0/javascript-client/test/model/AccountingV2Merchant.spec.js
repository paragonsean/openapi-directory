...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccountingV2Merchant();
  });
  ...
  describe('AccountingV2Merchant', function() {
    it('should create an instance of AccountingV2Merchant', function() {
      // uncomment below and update the code to test AccountingV2Merchant
      //var instance = new FulfillmentComApiv2.AccountingV2Merchant();
      //expect(instance).to.be.a(FulfillmentComApiv2.AccountingV2Merchant);
    });
