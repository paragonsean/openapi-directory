...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.StatusTypeSimpleV2Status();
  });
  ...
  describe('StatusTypeSimpleV2Status', function() {
    it('should create an instance of StatusTypeSimpleV2Status', function() {
      // uncomment below and update the code to test StatusTypeSimpleV2Status
      //var instance = new FulfillmentComApiv2.StatusTypeSimpleV2Status();
      //expect(instance).to.be.a(FulfillmentComApiv2.StatusTypeSimpleV2Status);
    });
