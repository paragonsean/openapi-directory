...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.CarrierHydratedV2();
  });
  ...
  describe('CarrierHydratedV2', function() {
    it('should create an instance of CarrierHydratedV2', function() {
      // uncomment below and update the code to test CarrierHydratedV2
      //var instance = new FulfillmentComApiv2.CarrierHydratedV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.CarrierHydratedV2);
    });

    it('should have the property canReprintPostage (base name: "canReprintPostage")', function() {
      // uncomment below and update the code to test the property canReprintPostage
      //var instance = new FulfillmentComApiv2.CarrierHydratedV2();
    ...
    it('should have the property includePeripherals (base name: "includePeripherals")', function() {
      // uncomment below and update the code to test the property includePeripherals
      //var instance = new FulfillmentComApiv2.CarrierHydratedV2();
      //expect(instance).to.be();
    });

    it('should have the property internalRatesOnly (base name: "internalRatesOnly")', function() {
      // uncomment below and update the code to test the property internalRatesOnly
      //var instance = new FulfillmentComApiv2.CarrierHydratedV2();
      //expect(instance).to.be();
    });
    ...
    it('should have the property requiresDimensions (base name: "requiresDimensions")', function() {
      // uncomment below and update the code to test the property requiresDimensions
      //var instance = new FulfillmentComApiv2.CarrierHydratedV2();
      //expect(instance).to.be();
    });
