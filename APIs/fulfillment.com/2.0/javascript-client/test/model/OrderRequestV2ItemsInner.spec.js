...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.OrderRequestV2ItemsInner();
  });
  ...
  describe('OrderRequestV2ItemsInner', function() {
    it('should create an instance of OrderRequestV2ItemsInner', function() {
      // uncomment below and update the code to test OrderRequestV2ItemsInner
      //var instance = new FulfillmentComApiv2.OrderRequestV2ItemsInner();
      //expect(instance).to.be.a(FulfillmentComApiv2.OrderRequestV2ItemsInner);
    });
