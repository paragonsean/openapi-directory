...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccountingV2();
  });
  ...
  describe('AccountingV2', function() {
    it('should create an instance of AccountingV2', function() {
      // uncomment below and update the code to test AccountingV2
      //var instance = new FulfillmentComApiv2.AccountingV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.AccountingV2);
    });
