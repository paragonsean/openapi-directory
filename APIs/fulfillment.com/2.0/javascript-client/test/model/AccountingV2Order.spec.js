...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccountingV2Order();
  });
  ...
  describe('AccountingV2Order', function() {
    it('should create an instance of AccountingV2Order', function() {
      // uncomment below and update the code to test AccountingV2Order
      //var instance = new FulfillmentComApiv2.AccountingV2Order();
      //expect(instance).to.be.a(FulfillmentComApiv2.AccountingV2Order);
    });
