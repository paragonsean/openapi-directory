...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccountingArrayV2Meta();
  });
  ...
  describe('AccountingArrayV2Meta', function() {
    it('should create an instance of AccountingArrayV2Meta', function() {
      // uncomment below and update the code to test AccountingArrayV2Meta
      //var instance = new FulfillmentComApiv2.AccountingArrayV2Meta();
      //expect(instance).to.be.a(FulfillmentComApiv2.AccountingArrayV2Meta);
    });
