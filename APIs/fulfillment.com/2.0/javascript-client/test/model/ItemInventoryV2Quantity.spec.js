...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.ItemInventoryV2Quantity();
  });
  ...
  describe('ItemInventoryV2Quantity', function() {
    it('should create an instance of ItemInventoryV2Quantity', function() {
      // uncomment below and update the code to test ItemInventoryV2Quantity
      //var instance = new FulfillmentComApiv2.ItemInventoryV2Quantity();
      //expect(instance).to.be.a(FulfillmentComApiv2.ItemInventoryV2Quantity);
    });
