...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.CarrierSimpleV2();
  });
  ...
  describe('CarrierSimpleV2', function() {
    it('should create an instance of CarrierSimpleV2', function() {
      // uncomment below and update the code to test CarrierSimpleV2
      //var instance = new FulfillmentComApiv2.CarrierSimpleV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.CarrierSimpleV2);
    });
