...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccountingV2Warehouse();
  });
  ...
  describe('AccountingV2Warehouse', function() {
    it('should create an instance of AccountingV2Warehouse', function() {
      // uncomment below and update the code to test AccountingV2Warehouse
      //var instance = new FulfillmentComApiv2.AccountingV2Warehouse();
      //expect(instance).to.be.a(FulfillmentComApiv2.AccountingV2Warehouse);
    });
