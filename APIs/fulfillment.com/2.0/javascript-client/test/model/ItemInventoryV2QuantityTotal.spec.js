...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.ItemInventoryV2QuantityTotal();
  });
  ...
  describe('ItemInventoryV2QuantityTotal', function() {
    it('should create an instance of ItemInventoryV2QuantityTotal', function() {
      // uncomment below and update the code to test ItemInventoryV2QuantityTotal
      //var instance = new FulfillmentComApiv2.ItemInventoryV2QuantityTotal();
      //expect(instance).to.be.a(FulfillmentComApiv2.ItemInventoryV2QuantityTotal);
    });
