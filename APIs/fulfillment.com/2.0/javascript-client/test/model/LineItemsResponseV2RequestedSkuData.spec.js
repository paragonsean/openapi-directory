...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.LineItemsResponseV2RequestedSkuData();
  });
  ...
  describe('LineItemsResponseV2RequestedSkuData', function() {
    it('should create an instance of LineItemsResponseV2RequestedSkuData', function() {
      // uncomment below and update the code to test LineItemsResponseV2RequestedSkuData
      //var instance = new FulfillmentComApiv2.LineItemsResponseV2RequestedSkuData();
      //expect(instance).to.be.a(FulfillmentComApiv2.LineItemsResponseV2RequestedSkuData);
    });
