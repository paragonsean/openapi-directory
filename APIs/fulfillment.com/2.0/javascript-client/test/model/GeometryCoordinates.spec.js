...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.GeometryCoordinates();
  });
  ...
  describe('GeometryCoordinates', function() {
    it('should create an instance of GeometryCoordinates', function() {
      // uncomment below and update the code to test GeometryCoordinates
      //var instance = new FulfillmentComApiv2.GeometryCoordinates();
      //expect(instance).to.be.a(FulfillmentComApiv2.GeometryCoordinates);
    });
