...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.LineItemsResponseV2InventoryDetailsInner();
  });
  ...
  describe('LineItemsResponseV2InventoryDetailsInner', function() {
    it('should create an instance of LineItemsResponseV2InventoryDetailsInner', function() {
      // uncomment below and update the code to test LineItemsResponseV2InventoryDetailsInner
      //var instance = new FulfillmentComApiv2.LineItemsResponseV2InventoryDetailsInner();
      //expect(instance).to.be.a(FulfillmentComApiv2.LineItemsResponseV2InventoryDetailsInner);
    });
    ...
    it('should have the property lotNum (base name: "lotNum")', function() {
      // uncomment below and update the code to test the property lotNum
      //var instance = new FulfillmentComApiv2.LineItemsResponseV2InventoryDetailsInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property serialNum (base name: "serialNum")', function() {
      // uncomment below and update the code to test the property serialNum
      //var instance = new FulfillmentComApiv2.LineItemsResponseV2InventoryDetailsInner();
      //expect(instance).to.be();
    });
