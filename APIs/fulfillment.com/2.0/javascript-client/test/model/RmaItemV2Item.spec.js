...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.RmaItemV2Item();
  });
  ...
  describe('RmaItemV2Item', function() {
    it('should create an instance of RmaItemV2Item', function() {
      // uncomment below and update the code to test RmaItemV2Item
      //var instance = new FulfillmentComApiv2.RmaItemV2Item();
      //expect(instance).to.be.a(FulfillmentComApiv2.RmaItemV2Item);
    });
