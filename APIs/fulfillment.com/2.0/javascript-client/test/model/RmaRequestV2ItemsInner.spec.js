...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.RmaRequestV2ItemsInner();
  });
  ...
  describe('RmaRequestV2ItemsInner', function() {
    it('should create an instance of RmaRequestV2ItemsInner', function() {
      // uncomment below and update the code to test RmaRequestV2ItemsInner
      //var instance = new FulfillmentComApiv2.RmaRequestV2ItemsInner();
      //expect(instance).to.be.a(FulfillmentComApiv2.RmaRequestV2ItemsInner);
    });
