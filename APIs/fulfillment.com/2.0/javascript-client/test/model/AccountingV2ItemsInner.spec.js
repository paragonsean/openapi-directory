...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccountingV2ItemsInner();
  });
  ...
  describe('AccountingV2ItemsInner', function() {
    it('should create an instance of AccountingV2ItemsInner', function() {
      // uncomment below and update the code to test AccountingV2ItemsInner
      //var instance = new FulfillmentComApiv2.AccountingV2ItemsInner();
      //expect(instance).to.be.a(FulfillmentComApiv2.AccountingV2ItemsInner);
    });
    ...
    it('should have the property wmsItemId (base name: "wmsItemId")', function() {
      // uncomment below and update the code to test the property wmsItemId
      //var instance = new FulfillmentComApiv2.AccountingV2ItemsInner();
      //expect(instance).to.be();
    });
