...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.ItemInventoryV2Merchant();
  });
  ...
  describe('ItemInventoryV2Merchant', function() {
    it('should create an instance of ItemInventoryV2Merchant', function() {
      // uncomment below and update the code to test ItemInventoryV2Merchant
      //var instance = new FulfillmentComApiv2.ItemInventoryV2Merchant();
      //expect(instance).to.be.a(FulfillmentComApiv2.ItemInventoryV2Merchant);
    });
