...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.UserContactV2();
  });
  ...
  describe('UserContactV2', function() {
    it('should create an instance of UserContactV2', function() {
      // uncomment below and update the code to test UserContactV2
      //var instance = new FulfillmentComApiv2.UserContactV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.UserContactV2);
    });
