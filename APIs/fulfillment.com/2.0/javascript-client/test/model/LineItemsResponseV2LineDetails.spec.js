...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.LineItemsResponseV2LineDetails();
  });
  ...
  describe('LineItemsResponseV2LineDetails', function() {
    it('should create an instance of LineItemsResponseV2LineDetails', function() {
      // uncomment below and update the code to test LineItemsResponseV2LineDetails
      //var instance = new FulfillmentComApiv2.LineItemsResponseV2LineDetails();
      //expect(instance).to.be.a(FulfillmentComApiv2.LineItemsResponseV2LineDetails);
    });
    ...
    it('should have the property externalSku (base name: "externalSku")', function() {
      // uncomment below and update the code to test the property externalSku
      //var instance = new FulfillmentComApiv2.LineItemsResponseV2LineDetails();
      //expect(instance).to.be();
    });
