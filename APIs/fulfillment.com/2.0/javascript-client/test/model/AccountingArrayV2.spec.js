...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.AccountingArrayV2();
  });
  ...
  describe('AccountingArrayV2', function() {
    it('should create an instance of AccountingArrayV2', function() {
      // uncomment below and update the code to test AccountingArrayV2
      //var instance = new FulfillmentComApiv2.AccountingArrayV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.AccountingArrayV2);
    });
