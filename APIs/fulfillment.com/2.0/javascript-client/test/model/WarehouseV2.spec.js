...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.WarehouseV2();
  });
  ...
  describe('WarehouseV2', function() {
    it('should create an instance of WarehouseV2', function() {
      // uncomment below and update the code to test WarehouseV2
      //var instance = new FulfillmentComApiv2.WarehouseV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.WarehouseV2);
    });
