...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.StatusTypeSimpleV2();
  });
  ...
  describe('StatusTypeSimpleV2', function() {
    it('should create an instance of StatusTypeSimpleV2', function() {
      // uncomment below and update the code to test StatusTypeSimpleV2
      //var instance = new FulfillmentComApiv2.StatusTypeSimpleV2();
      //expect(instance).to.be.a(FulfillmentComApiv2.StatusTypeSimpleV2);
    });
