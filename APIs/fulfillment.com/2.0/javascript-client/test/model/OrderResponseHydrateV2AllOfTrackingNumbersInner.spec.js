...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.OrderResponseHydrateV2AllOfTrackingNumbersInner();
  });
  ...
  describe('OrderResponseHydrateV2AllOfTrackingNumbersInner', function() {
    it('should create an instance of OrderResponseHydrateV2AllOfTrackingNumbersInner', function() {
      // uncomment below and update the code to test OrderResponseHydrateV2AllOfTrackingNumbersInner
      //var instance = new FulfillmentComApiv2.OrderResponseHydrateV2AllOfTrackingNumbersInner();
      //expect(instance).to.be.a(FulfillmentComApiv2.OrderResponseHydrateV2AllOfTrackingNumbersInner);
    });
