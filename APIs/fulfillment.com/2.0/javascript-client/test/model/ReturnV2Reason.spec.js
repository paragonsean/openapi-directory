...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.ReturnV2Reason();
  });
  ...
  describe('ReturnV2Reason', function() {
    it('should create an instance of ReturnV2Reason', function() {
      // uncomment below and update the code to test ReturnV2Reason
      //var instance = new FulfillmentComApiv2.ReturnV2Reason();
      //expect(instance).to.be.a(FulfillmentComApiv2.ReturnV2Reason);
    });
