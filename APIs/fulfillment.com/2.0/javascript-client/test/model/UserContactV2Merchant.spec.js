...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.UserContactV2Merchant();
  });
  ...
  describe('UserContactV2Merchant', function() {
    it('should create an instance of UserContactV2Merchant', function() {
      // uncomment below and update the code to test UserContactV2Merchant
      //var instance = new FulfillmentComApiv2.UserContactV2Merchant();
      //expect(instance).to.be.a(FulfillmentComApiv2.UserContactV2Merchant);
    });
