...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.RmaItemV2NonRestockedReason();
  });
  ...
  describe('RmaItemV2NonRestockedReason', function() {
    it('should create an instance of RmaItemV2NonRestockedReason', function() {
      // uncomment below and update the code to test RmaItemV2NonRestockedReason
      //var instance = new FulfillmentComApiv2.RmaItemV2NonRestockedReason();
      //expect(instance).to.be.a(FulfillmentComApiv2.RmaItemV2NonRestockedReason);
    });
