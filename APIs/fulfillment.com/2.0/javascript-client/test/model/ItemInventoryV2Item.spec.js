...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentComApiv2.ItemInventoryV2Item();
  });
  ...
  describe('ItemInventoryV2Item', function() {
    it('should create an instance of ItemInventoryV2Item', function() {
      // uncomment below and update the code to test ItemInventoryV2Item
      //var instance = new FulfillmentComApiv2.ItemInventoryV2Item();
      //expect(instance).to.be.a(FulfillmentComApiv2.ItemInventoryV2Item);
    });
    ...
    it('should have the property skuReference (base name: "skuReference")', function() {
      // uncomment below and update the code to test the property skuReference
      //var instance = new FulfillmentComApiv2.ItemInventoryV2Item();
      //expect(instance).to.be();
    });
