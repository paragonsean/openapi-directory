...
public class RmaItemV2Item {
  ...
  public RmaItemV2Item() {
  }

  public RmaItemV2Item id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RmaItemV2Item sku(String sku) {
    this.sku = sku;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RmaItemV2Item rmaItemV2Item = (RmaItemV2Item) o;
    return Objects.equals(this.id, rmaItemV2Item.id) &&
        Objects.equals(this.sku, rmaItemV2Item.sku);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RmaItemV2Item
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RmaItemV2Item.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RmaItemV2Item is not found in the empty JSON string", RmaItemV2Item.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RmaItemV2Item.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RmaItemV2Item` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RmaItemV2Item.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RmaItemV2Item' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RmaItemV2Item> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RmaItemV2Item.class));

       return (TypeAdapter<T>) new TypeAdapter<RmaItemV2Item>() {
           @Override
           public void write(JsonWriter out, RmaItemV2Item value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RmaItemV2Item read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RmaItemV2Item given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RmaItemV2Item
   * @throws IOException if the JSON string is invalid with respect to RmaItemV2Item
   */
  public static RmaItemV2Item fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RmaItemV2Item.class);
  }

  /**
   * Convert an instance of RmaItemV2Item to an JSON string
   *
   * @return JSON string
   */
