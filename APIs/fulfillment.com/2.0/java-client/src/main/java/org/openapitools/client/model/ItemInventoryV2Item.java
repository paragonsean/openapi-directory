...
public class ItemInventoryV2Item {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Integer id;

  public static final String SERIALIZED_NAME_SKU_REFERENCE = "skuReference";
  @SerializedName(SERIALIZED_NAME_SKU_REFERENCE)
  private String skuReference;

  public ItemInventoryV2Item() {
  }

  public ItemInventoryV2Item id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ItemInventoryV2Item skuReference(String skuReference) {
  ...
  public boolean equals(Object o) {
    ...
    ItemInventoryV2Item itemInventoryV2Item = (ItemInventoryV2Item) o;
    return Objects.equals(this.id, itemInventoryV2Item.id) &&
        Objects.equals(this.skuReference, itemInventoryV2Item.skuReference);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, skuReference);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ItemInventoryV2Item {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    skuReference: ").append(toIndentedString(skuReference)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("skuReference");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemInventoryV2Item
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemInventoryV2Item.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemInventoryV2Item is not found in the empty JSON string", ItemInventoryV2Item.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemInventoryV2Item.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemInventoryV2Item` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("skuReference") != null && !jsonObj.get("skuReference").isJsonNull()) && !jsonObj.get("skuReference").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `skuReference` to be a primitive type in the JSON string but got `%s`", jsonObj.get("skuReference").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemInventoryV2Item.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemInventoryV2Item' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemInventoryV2Item> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemInventoryV2Item.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemInventoryV2Item>() {
           @Override
           public void write(JsonWriter out, ItemInventoryV2Item value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemInventoryV2Item read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ItemInventoryV2Item given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemInventoryV2Item
   * @throws IOException if the JSON string is invalid with respect to ItemInventoryV2Item
   */
  public static ItemInventoryV2Item fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemInventoryV2Item.class);
  }

  /**
   * Convert an instance of ItemInventoryV2Item to an JSON string
   *
   * @return JSON string
   */
