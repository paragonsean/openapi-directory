...
public class AccessTokenResponseV2 {
  ...
  public AccessTokenResponseV2 accessToken(String accessToken) {
  ...
  public AccessTokenResponseV2 expiresIn(Integer expiresIn) {
  ...
  public AccessTokenResponseV2 refreshToken(String refreshToken) {
  ...
  public AccessTokenResponseV2 tokenType(String tokenType) {
  ...
  public boolean equals(Object o) {
    ...
    AccessTokenResponseV2 accessTokenResponseV2 = (AccessTokenResponseV2) o;
    return Objects.equals(this.accessToken, accessTokenResponseV2.accessToken) &&
        Objects.equals(this.expiresIn, accessTokenResponseV2.expiresIn) &&
        Objects.equals(this.refreshToken, accessTokenResponseV2.refreshToken) &&
        Objects.equals(this.tokenType, accessTokenResponseV2.tokenType);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessTokenResponseV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccessTokenResponseV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessTokenResponseV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessTokenResponseV2 is not found in the empty JSON string", AccessTokenResponseV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessTokenResponseV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessTokenResponseV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessTokenResponseV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessTokenResponseV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessTokenResponseV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessTokenResponseV2.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessTokenResponseV2>() {
           @Override
           public void write(JsonWriter out, AccessTokenResponseV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessTokenResponseV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccessTokenResponseV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccessTokenResponseV2
   * @throws IOException if the JSON string is invalid with respect to AccessTokenResponseV2
   */
  public static AccessTokenResponseV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessTokenResponseV2.class);
  }

  /**
   * Convert an instance of AccessTokenResponseV2 to an JSON string
   *
   * @return JSON string
   */
