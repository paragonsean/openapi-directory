...
public class OrderShipV2 {
  public static final String SERIALIZED_NAME_TRACKING_NUMBER = "trackingNumber";
  @SerializedName(SERIALIZED_NAME_TRACKING_NUMBER)
  private String trackingNumber;

  public static final String SERIALIZED_NAME_WEIGHT_OVERRIDE = "weightOverride";
  @SerializedName(SERIALIZED_NAME_WEIGHT_OVERRIDE)
  private Float weightOverride;

  public OrderShipV2() {
  }

  public OrderShipV2 trackingNumber(String trackingNumber) {
  ...
  public OrderShipV2 weightOverride(Float weightOverride) {
  ...
  public Float getWeightOverride() {
    return weightOverride;
  }

  public void setWeightOverride(Float weightOverride) {
    this.weightOverride = weightOverride;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrderShipV2 orderShipV2 = (OrderShipV2) o;
    return Objects.equals(this.trackingNumber, orderShipV2.trackingNumber) &&
        Objects.equals(this.weightOverride, orderShipV2.weightOverride);
  }

  @Override
  public int hashCode() {
    return Objects.hash(trackingNumber, weightOverride);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderShipV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderShipV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderShipV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderShipV2 is not found in the empty JSON string", OrderShipV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderShipV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderShipV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderShipV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderShipV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderShipV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderShipV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderShipV2.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderShipV2>() {
           @Override
           public void write(JsonWriter out, OrderShipV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderShipV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderShipV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderShipV2
   * @throws IOException if the JSON string is invalid with respect to OrderShipV2
   */
  public static OrderShipV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderShipV2.class);
  }

  /**
   * Convert an instance of OrderShipV2 to an JSON string
   *
   * @return JSON string
   */
