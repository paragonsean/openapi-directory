...
public class StatusTypeV2ActionRequiredBy {
  ...
  public StatusTypeV2ActionRequiredBy() {
  }

  public StatusTypeV2ActionRequiredBy id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public StatusTypeV2ActionRequiredBy name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StatusTypeV2ActionRequiredBy statusTypeV2ActionRequiredBy = (StatusTypeV2ActionRequiredBy) o;
    return Objects.equals(this.id, statusTypeV2ActionRequiredBy.id) &&
        Objects.equals(this.name, statusTypeV2ActionRequiredBy.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatusTypeV2ActionRequiredBy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatusTypeV2ActionRequiredBy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatusTypeV2ActionRequiredBy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatusTypeV2ActionRequiredBy is not found in the empty JSON string", StatusTypeV2ActionRequiredBy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatusTypeV2ActionRequiredBy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatusTypeV2ActionRequiredBy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatusTypeV2ActionRequiredBy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatusTypeV2ActionRequiredBy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatusTypeV2ActionRequiredBy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatusTypeV2ActionRequiredBy.class));

       return (TypeAdapter<T>) new TypeAdapter<StatusTypeV2ActionRequiredBy>() {
           @Override
           public void write(JsonWriter out, StatusTypeV2ActionRequiredBy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatusTypeV2ActionRequiredBy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatusTypeV2ActionRequiredBy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatusTypeV2ActionRequiredBy
   * @throws IOException if the JSON string is invalid with respect to StatusTypeV2ActionRequiredBy
   */
  public static StatusTypeV2ActionRequiredBy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatusTypeV2ActionRequiredBy.class);
  }

  /**
   * Convert an instance of StatusTypeV2ActionRequiredBy to an JSON string
   *
   * @return JSON string
   */
