...
public class FeatureProperties {
  ...
  public FeatureProperties name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, featureProperties.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FeatureProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeatureProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeatureProperties is not found in the empty JSON string", FeatureProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FeatureProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeatureProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeatureProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeatureProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeatureProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeatureProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<FeatureProperties>() {
           @Override
           public void write(JsonWriter out, FeatureProperties value) throws IOException {
  ...
  /**
   * Create an instance of FeatureProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FeatureProperties
   * @throws IOException if the JSON string is invalid with respect to FeatureProperties
   */
  public static FeatureProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeatureProperties.class);
  }

  /**
   * Convert an instance of FeatureProperties to an JSON string
   *
   * @return JSON string
   */
