...
public class TrackingEventV2 {
  ...
  public static final String SERIALIZED_NAME_EVENT_CATEGORY_CODE = "eventCategoryCode";
  @SerializedName(SERIALIZED_NAME_EVENT_CATEGORY_CODE)
  private Integer eventCategoryCode;
  ...
  private Object eventLocation = null;
  ...
  public TrackingEventV2() {
  }

  public TrackingEventV2 eventCategory(String eventCategory) {
  ...
  public TrackingEventV2 eventCategoryCode(Integer eventCategoryCode) {
    this.eventCategoryCode = eventCategoryCode;
    return this;
  }

  /**
   * Get eventCategoryCode
   * @return eventCategoryCode
   */
  @javax.annotation.Nullable
  public Integer getEventCategoryCode() {
    return eventCategoryCode;
  }

  public void setEventCategoryCode(Integer eventCategoryCode) {
    this.eventCategoryCode = eventCategoryCode;
  }


  public TrackingEventV2 eventDateTime(OffsetDateTime eventDateTime) {
  ...
  public TrackingEventV2 eventLocation(Object eventLocation) {
  ...
  public TrackingEventV2 eventSource(EventSourceEnum eventSource) {
  ...
  public TrackingEventV2 eventStatus(String eventStatus) {
  ...
  public boolean equals(Object o) {
    ...
    TrackingEventV2 trackingEventV2 = (TrackingEventV2) o;
    return Objects.equals(this.eventCategory, trackingEventV2.eventCategory) &&
        Objects.equals(this.eventCategoryCode, trackingEventV2.eventCategoryCode) &&
        Objects.equals(this.eventDateTime, trackingEventV2.eventDateTime) &&
        Objects.equals(this.eventLocation, trackingEventV2.eventLocation) &&
        Objects.equals(this.eventSource, trackingEventV2.eventSource) &&
        Objects.equals(this.eventStatus, trackingEventV2.eventStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventCategory, eventCategoryCode, eventDateTime, eventLocation, eventSource, eventStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrackingEventV2 {\n");
    sb.append("    eventCategory: ").append(toIndentedString(eventCategory)).append("\n");
    sb.append("    eventCategoryCode: ").append(toIndentedString(eventCategoryCode)).append("\n");
  ...
  static {
    ...
    openapiFields.add("eventCategoryCode");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrackingEventV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackingEventV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackingEventV2 is not found in the empty JSON string", TrackingEventV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackingEventV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackingEventV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackingEventV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackingEventV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackingEventV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackingEventV2.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackingEventV2>() {
           @Override
           public void write(JsonWriter out, TrackingEventV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackingEventV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrackingEventV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrackingEventV2
   * @throws IOException if the JSON string is invalid with respect to TrackingEventV2
   */
  public static TrackingEventV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackingEventV2.class);
  }

  /**
   * Convert an instance of TrackingEventV2 to an JSON string
   *
   * @return JSON string
   */
