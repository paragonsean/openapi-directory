...
public class CarrierHydratedV2 {
  public static final String SERIALIZED_NAME_CAN_REPRINT_POSTAGE = "canReprintPostage";
  @SerializedName(SERIALIZED_NAME_CAN_REPRINT_POSTAGE)
  private Boolean canReprintPostage;
  ...
  public static final String SERIALIZED_NAME_INCLUDE_PERIPHERALS = "includePeripherals";
  @SerializedName(SERIALIZED_NAME_INCLUDE_PERIPHERALS)
  private Boolean includePeripherals;

  public static final String SERIALIZED_NAME_INTERNAL_RATES_ONLY = "internalRatesOnly";
  @SerializedName(SERIALIZED_NAME_INTERNAL_RATES_ONLY)
  private Boolean internalRatesOnly;

  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public static final String SERIALIZED_NAME_REQUIRES_DIMENSIONS = "requiresDimensions";
  @SerializedName(SERIALIZED_NAME_REQUIRES_DIMENSIONS)
  ...
  public CarrierHydratedV2() {
  }

  public CarrierHydratedV2 canReprintPostage(Boolean canReprintPostage) {
    this.canReprintPostage = canReprintPostage;
    return this;
  }

  /**
   * Get canReprintPostage
   * @return canReprintPostage
   */
  @javax.annotation.Nullable
  public Boolean getCanReprintPostage() {
    return canReprintPostage;
  }

  public void setCanReprintPostage(Boolean canReprintPostage) {
    this.canReprintPostage = canReprintPostage;
  }


  public CarrierHydratedV2 enabled(Boolean enabled) {
  ...
  public CarrierHydratedV2 id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public CarrierHydratedV2 includePeripherals(Boolean includePeripherals) {
    this.includePeripherals = includePeripherals;
    return this;
  }

  /**
   * Get includePeripherals
   * @return includePeripherals
   */
  @javax.annotation.Nullable
  public Boolean getIncludePeripherals() {
    return includePeripherals;
  }
  ...
  public CarrierHydratedV2 internalRatesOnly(Boolean internalRatesOnly) {
    this.internalRatesOnly = internalRatesOnly;
    return this;
  }

  /**
   * Get internalRatesOnly
   * @return internalRatesOnly
   */
  @javax.annotation.Nullable
  public Boolean getInternalRatesOnly() {
    return internalRatesOnly;
  }

  public void setInternalRatesOnly(Boolean internalRatesOnly) {
    this.internalRatesOnly = internalRatesOnly;
  }


  public CarrierHydratedV2 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CarrierHydratedV2 requiresDimensions(Boolean requiresDimensions) {
    this.requiresDimensions = requiresDimensions;
    return this;
  }

  /**
   * Get requiresDimensions
   * @return requiresDimensions
   */
  @javax.annotation.Nullable
  public Boolean getRequiresDimensions() {
    return requiresDimensions;
  }
  ...
  public CarrierHydratedV2 symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CarrierHydratedV2 carrierHydratedV2 = (CarrierHydratedV2) o;
    return Objects.equals(this.canReprintPostage, carrierHydratedV2.canReprintPostage) &&
        Objects.equals(this.enabled, carrierHydratedV2.enabled) &&
        Objects.equals(this.id, carrierHydratedV2.id) &&
        Objects.equals(this.includePeripherals, carrierHydratedV2.includePeripherals) &&
        Objects.equals(this.internalRatesOnly, carrierHydratedV2.internalRatesOnly) &&
        Objects.equals(this.name, carrierHydratedV2.name) &&
        Objects.equals(this.requiresDimensions, carrierHydratedV2.requiresDimensions) &&
        Objects.equals(this.symbol, carrierHydratedV2.symbol);
  }

  @Override
  public int hashCode() {
    return Objects.hash(canReprintPostage, enabled, id, includePeripherals, internalRatesOnly, name, requiresDimensions, symbol);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CarrierHydratedV2 {\n");
    sb.append("    canReprintPostage: ").append(toIndentedString(canReprintPostage)).append("\n");
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    includePeripherals: ").append(toIndentedString(includePeripherals)).append("\n");
    sb.append("    internalRatesOnly: ").append(toIndentedString(internalRatesOnly)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    requiresDimensions: ").append(toIndentedString(requiresDimensions)).append("\n");
  ...
  static {
    ...
    openapiFields.add("canReprintPostage");
    openapiFields.add("enabled");
    openapiFields.add("id");
    openapiFields.add("includePeripherals");
    openapiFields.add("internalRatesOnly");
    openapiFields.add("name");
    openapiFields.add("requiresDimensions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CarrierHydratedV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CarrierHydratedV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CarrierHydratedV2 is not found in the empty JSON string", CarrierHydratedV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CarrierHydratedV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CarrierHydratedV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CarrierHydratedV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CarrierHydratedV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CarrierHydratedV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CarrierHydratedV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CarrierHydratedV2.class));

       return (TypeAdapter<T>) new TypeAdapter<CarrierHydratedV2>() {
           @Override
           public void write(JsonWriter out, CarrierHydratedV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CarrierHydratedV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CarrierHydratedV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CarrierHydratedV2
   * @throws IOException if the JSON string is invalid with respect to CarrierHydratedV2
   */
  public static CarrierHydratedV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CarrierHydratedV2.class);
  }

  /**
   * Convert an instance of CarrierHydratedV2 to an JSON string
   *
   * @return JSON string
   */
