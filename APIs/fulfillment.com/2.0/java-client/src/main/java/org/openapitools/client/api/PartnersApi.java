...
import org.openapitools.client.model.OrderShipV2;
import org.openapitools.client.model.StatusTypeSimpleV2;
...
public class PartnersApi {
    ...
    /**
     * Build call for putOrdersIdShip
     * @param id The FDC order Id (required)
     * @param body Shipping Details (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Order Found </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Order not found </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call putOrdersIdShipCall(Integer id, OrderShipV2 body, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/orders/{id}/ship"
    ...
    private okhttp3.Call putOrdersIdShipValidateBeforeCall(Integer id, OrderShipV2 body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling putOrdersIdShip(Async)");
        }

        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling putOrdersIdShip(Async)");
        }

        return putOrdersIdShipCall(id, body, _callback);
     ...
     */
    public Object putOrdersIdShip(Integer id, OrderShipV2 body) throws ApiException {
        ApiResponse<Object> localVarResp = putOrdersIdShipWithHttpInfo(id, body);
     ...
     */
    public ApiResponse<Object> putOrdersIdShipWithHttpInfo(Integer id, OrderShipV2 body) throws ApiException {
        okhttp3.Call localVarCall = putOrdersIdShipValidateBeforeCall(id, body, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Ship an Order (asynchronously)
     * Note, this API is used to update orders and is reserved for our shipping partners.
     * @param id The FDC order Id (required)
     * @param body Shipping Details (required)
     ...
     */
    public okhttp3.Call putOrdersIdShipAsync(Integer id, OrderShipV2 body, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = putOrdersIdShipValidateBeforeCall(id, body, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for putOrdersIdStatus
     * @param id The FDC order Id (required)
     * @param body New status event (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call putOrdersIdStatusCall(Integer id, StatusTypeSimpleV2 body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putOrdersIdStatusValidateBeforeCall(Integer id, StatusTypeSimpleV2 body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling putOrdersIdStatus(Async)");
        }

        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling putOrdersIdStatus(Async)");
        }

        return putOrdersIdStatusCall(id, body, _callback);
     ...
     */
    public Object putOrdersIdStatus(Integer id, StatusTypeSimpleV2 body) throws ApiException {
        ApiResponse<Object> localVarResp = putOrdersIdStatusWithHttpInfo(id, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> putOrdersIdStatusWithHttpInfo(Integer id, StatusTypeSimpleV2 body) throws ApiException {
        okhttp3.Call localVarCall = putOrdersIdStatusValidateBeforeCall(id, body, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call putOrdersIdStatusAsync(Integer id, StatusTypeSimpleV2 body, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = putOrdersIdStatusValidateBeforeCall(id, body, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
