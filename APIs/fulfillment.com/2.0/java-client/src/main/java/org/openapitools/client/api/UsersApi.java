...
import org.openapitools.client.model.UserContactV2;
...
public class UsersApi {
     ...
     */
    public UserContactV2 getUsersMe() throws ApiException {
        ApiResponse<UserContactV2> localVarResp = getUsersMeWithHttpInfo();
     ...
     * About Me
     * Returns the user profile of the access token&#39;s owner. This could be useful if managing multiple accounts or confirming validity of a token.
     * @return ApiResponse&lt;UserContactV2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<UserContactV2> getUsersMeWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getUsersMeValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<UserContactV2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * About Me (asynchronously)
     * Returns the user profile of the access token&#39;s owner. This could be useful if managing multiple accounts or confirming validity of a token.
     ...
     */
    public okhttp3.Call getUsersMeAsync(final ApiCallback<UserContactV2> _callback) throws ApiException {
