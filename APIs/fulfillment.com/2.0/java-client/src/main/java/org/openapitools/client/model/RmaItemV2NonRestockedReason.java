...
public class RmaItemV2NonRestockedReason {
  ...
  public RmaItemV2NonRestockedReason() {
  }

  public RmaItemV2NonRestockedReason id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RmaItemV2NonRestockedReason title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RmaItemV2NonRestockedReason rmaItemV2NonRestockedReason = (RmaItemV2NonRestockedReason) o;
    return Objects.equals(this.id, rmaItemV2NonRestockedReason.id) &&
        Objects.equals(this.title, rmaItemV2NonRestockedReason.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class RmaItemV2NonRestockedReason {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RmaItemV2NonRestockedReason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RmaItemV2NonRestockedReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RmaItemV2NonRestockedReason is not found in the empty JSON string", RmaItemV2NonRestockedReason.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RmaItemV2NonRestockedReason.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RmaItemV2NonRestockedReason` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RmaItemV2NonRestockedReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RmaItemV2NonRestockedReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RmaItemV2NonRestockedReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RmaItemV2NonRestockedReason.class));

       return (TypeAdapter<T>) new TypeAdapter<RmaItemV2NonRestockedReason>() {
           @Override
           public void write(JsonWriter out, RmaItemV2NonRestockedReason value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RmaItemV2NonRestockedReason read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RmaItemV2NonRestockedReason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RmaItemV2NonRestockedReason
   * @throws IOException if the JSON string is invalid with respect to RmaItemV2NonRestockedReason
   */
  public static RmaItemV2NonRestockedReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RmaItemV2NonRestockedReason.class);
  }

  /**
   * Convert an instance of RmaItemV2NonRestockedReason to an JSON string
   *
   * @return JSON string
   */
