...
public class AccessTokenRequestRefreshV2 {
  public static final String SERIALIZED_NAME_REFRESH_TOKEN = "refresh_token";
  @SerializedName(SERIALIZED_NAME_REFRESH_TOKEN)
  private String refreshToken;

  public AccessTokenRequestRefreshV2() {
  }

  public AccessTokenRequestRefreshV2 refreshToken(String refreshToken) {
  ...
  public boolean equals(Object o) {
    ...
    AccessTokenRequestRefreshV2 accessTokenRequestRefreshV2 = (AccessTokenRequestRefreshV2) o;
    return Objects.equals(this.refreshToken, accessTokenRequestRefreshV2.refreshToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessTokenRequestRefreshV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccessTokenRequestRefreshV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessTokenRequestRefreshV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessTokenRequestRefreshV2 is not found in the empty JSON string", AccessTokenRequestRefreshV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessTokenRequestRefreshV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessTokenRequestRefreshV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessTokenRequestRefreshV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessTokenRequestRefreshV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessTokenRequestRefreshV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessTokenRequestRefreshV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessTokenRequestRefreshV2.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessTokenRequestRefreshV2>() {
           @Override
           public void write(JsonWriter out, AccessTokenRequestRefreshV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessTokenRequestRefreshV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccessTokenRequestRefreshV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccessTokenRequestRefreshV2
   * @throws IOException if the JSON string is invalid with respect to AccessTokenRequestRefreshV2
   */
  public static AccessTokenRequestRefreshV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessTokenRequestRefreshV2.class);
  }

  /**
   * Convert an instance of AccessTokenRequestRefreshV2 to an JSON string
   *
   * @return JSON string
   */
