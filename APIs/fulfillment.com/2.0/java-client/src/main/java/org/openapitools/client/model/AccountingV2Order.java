...
public class AccountingV2Order {
  ...
  public AccountingV2Order() {
  }

  public AccountingV2Order id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public AccountingV2Order invoiceDate(LocalDate invoiceDate) {
  ...
  public AccountingV2Order merchantOrderId(Integer merchantOrderId) {
  ...
  public AccountingV2Order recordedDate(LocalDate recordedDate) {
  ...
  public boolean equals(Object o) {
    ...
    AccountingV2Order accountingV2Order = (AccountingV2Order) o;
    return Objects.equals(this.id, accountingV2Order.id) &&
        Objects.equals(this.invoiceDate, accountingV2Order.invoiceDate) &&
        Objects.equals(this.merchantOrderId, accountingV2Order.merchantOrderId) &&
        Objects.equals(this.recordedDate, accountingV2Order.recordedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, invoiceDate, merchantOrderId, recordedDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccountingV2Order {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountingV2Order
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountingV2Order.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountingV2Order is not found in the empty JSON string", AccountingV2Order.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountingV2Order.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountingV2Order` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountingV2Order.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountingV2Order' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountingV2Order> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountingV2Order.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountingV2Order>() {
           @Override
           public void write(JsonWriter out, AccountingV2Order value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountingV2Order read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountingV2Order given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountingV2Order
   * @throws IOException if the JSON string is invalid with respect to AccountingV2Order
   */
  public static AccountingV2Order fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountingV2Order.class);
  }

  /**
   * Convert an instance of AccountingV2Order to an JSON string
   *
   * @return JSON string
   */
