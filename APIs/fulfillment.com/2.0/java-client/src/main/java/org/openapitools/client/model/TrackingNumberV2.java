...
import org.openapitools.client.model.CarrierSimpleV2;
...
public class TrackingNumberV2 {
  public static final String SERIALIZED_NAME_BARCODE_SCAN_VALUE = "barcodeScanValue";
  @Deprecated
  @SerializedName(SERIALIZED_NAME_BARCODE_SCAN_VALUE)
  private String barcodeScanValue;

  public static final String SERIALIZED_NAME_CARRIER = "carrier";
  @SerializedName(SERIALIZED_NAME_CARRIER)
  private CarrierSimpleV2 carrier;

  public static final String SERIALIZED_NAME_VALUE = "value";
  @SerializedName(SERIALIZED_NAME_VALUE)
  private String value;

  public TrackingNumberV2() {
  }

  @Deprecated
  public TrackingNumberV2 barcodeScanValue(String barcodeScanValue) {
   ...
   * @return barcodeScanValue
   * @deprecated
   */
  @Deprecated
  @javax.annotation.Nullable
  public String getBarcodeScanValue() {
    return barcodeScanValue;
  }

  @Deprecated
  public void setBarcodeScanValue(String barcodeScanValue) {
    this.barcodeScanValue = barcodeScanValue;
  }


  public TrackingNumberV2 carrier(CarrierSimpleV2 carrier) {
   ...
   */
  @javax.annotation.Nullable
  public CarrierSimpleV2 getCarrier() {
    return carrier;
  }

  public void setCarrier(CarrierSimpleV2 carrier) {
    this.carrier = carrier;
  }


  public TrackingNumberV2 value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrackingNumberV2 trackingNumberV2 = (TrackingNumberV2) o;
    return Objects.equals(this.barcodeScanValue, trackingNumberV2.barcodeScanValue) &&
        Objects.equals(this.carrier, trackingNumberV2.carrier) &&
        Objects.equals(this.value, trackingNumberV2.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(barcodeScanValue, carrier, value);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrackingNumberV2 {\n");
    sb.append("    barcodeScanValue: ").append(toIndentedString(barcodeScanValue)).append("\n");
  ...
  static {
    ...
    openapiFields.add("barcodeScanValue");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrackingNumberV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackingNumberV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackingNumberV2 is not found in the empty JSON string", TrackingNumberV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackingNumberV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackingNumberV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("barcodeScanValue") != null && !jsonObj.get("barcodeScanValue").isJsonNull()) && !jsonObj.get("barcodeScanValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `barcodeScanValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("barcodeScanValue").toString()));
      }
      // validate the optional field `carrier`
      if (jsonObj.get("carrier") != null && !jsonObj.get("carrier").isJsonNull()) {
        CarrierSimpleV2.validateJsonElement(jsonObj.get("carrier"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackingNumberV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackingNumberV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackingNumberV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackingNumberV2.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackingNumberV2>() {
           @Override
           public void write(JsonWriter out, TrackingNumberV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackingNumberV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrackingNumberV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrackingNumberV2
   * @throws IOException if the JSON string is invalid with respect to TrackingNumberV2
   */
  public static TrackingNumberV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackingNumberV2.class);
  }

  /**
   * Convert an instance of TrackingNumberV2 to an JSON string
   *
   * @return JSON string
   */
