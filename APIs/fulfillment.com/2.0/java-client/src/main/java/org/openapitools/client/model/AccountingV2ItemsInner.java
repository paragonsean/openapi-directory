...
public class AccountingV2ItemsInner {
  ...
  public static final String SERIALIZED_NAME_WMS_ITEM_ID = "wmsItemId";
  @SerializedName(SERIALIZED_NAME_WMS_ITEM_ID)
  private String wmsItemId;

  public AccountingV2ItemsInner() {
  }

  public AccountingV2ItemsInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public AccountingV2ItemsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AccountingV2ItemsInner quantity(Integer quantity) {
  ...
  public AccountingV2ItemsInner wmsItemId(String wmsItemId) {
   ...
   */
  @javax.annotation.Nullable
  public String getWmsItemId() {
    return wmsItemId;
  }

  public void setWmsItemId(String wmsItemId) {
    this.wmsItemId = wmsItemId;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccountingV2ItemsInner accountingV2ItemsInner = (AccountingV2ItemsInner) o;
    return Objects.equals(this.id, accountingV2ItemsInner.id) &&
        Objects.equals(this.name, accountingV2ItemsInner.name) &&
        Objects.equals(this.quantity, accountingV2ItemsInner.quantity) &&
        Objects.equals(this.wmsItemId, accountingV2ItemsInner.wmsItemId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, quantity, wmsItemId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccountingV2ItemsInner {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    quantity: ").append(toIndentedString(quantity)).append("\n");
    sb.append("    wmsItemId: ").append(toIndentedString(wmsItemId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountingV2ItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountingV2ItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountingV2ItemsInner is not found in the empty JSON string", AccountingV2ItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountingV2ItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountingV2ItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("wmsItemId") != null && !jsonObj.get("wmsItemId").isJsonNull()) && !jsonObj.get("wmsItemId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `wmsItemId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("wmsItemId").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountingV2ItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountingV2ItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountingV2ItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountingV2ItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountingV2ItemsInner>() {
           @Override
           public void write(JsonWriter out, AccountingV2ItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountingV2ItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountingV2ItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountingV2ItemsInner
   * @throws IOException if the JSON string is invalid with respect to AccountingV2ItemsInner
   */
  public static AccountingV2ItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountingV2ItemsInner.class);
  }

  /**
   * Convert an instance of AccountingV2ItemsInner to an JSON string
   *
   * @return JSON string
   */
