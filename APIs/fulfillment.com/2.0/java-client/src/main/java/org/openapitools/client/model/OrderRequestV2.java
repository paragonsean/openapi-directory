...
import org.openapitools.client.model.ConsigneeNewV2;
import org.openapitools.client.model.OrderRequestV2ItemsInner;
import org.openapitools.client.model.OrderRequestV2Warehouse;
...
public class OrderRequestV2 {
   ...
   */
  @JsonAdapter(IntegratorEnum.Adapter.class)
  public enum IntegratorEnum {
    ...
    public static IntegratorEnum fromValue(String value) {
      for (IntegratorEnum b : IntegratorEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<IntegratorEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final IntegratorEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public IntegratorEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return IntegratorEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      IntegratorEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_INTEGRATOR = "integrator";
  @SerializedName(SERIALIZED_NAME_INTEGRATOR)
  private IntegratorEnum integrator;

  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<OrderRequestV2ItemsInner> items = new ArrayList<>();
  ...
  private ConsigneeNewV2 recipient;
  ...
  private OrderRequestV2Warehouse warehouse;

  public OrderRequestV2() {
  }

  public OrderRequestV2 integrator(IntegratorEnum integrator) {
  ...
  public IntegratorEnum getIntegrator() {
    return integrator;
  }
  ...
  public OrderRequestV2 items(List<OrderRequestV2ItemsInner> items) {
    this.items = items;
    return this;
  }

  public OrderRequestV2 addItemsItem(OrderRequestV2ItemsInner itemsItem) {
    if (this.items == null) {
  ...
  public List<OrderRequestV2ItemsInner> getItems() {
    return items;
  }

  public void setItems(List<OrderRequestV2ItemsInner> items) {
    this.items = items;
  }


  public OrderRequestV2 merchantId(Integer merchantId) {
  ...
  public OrderRequestV2 merchantOrderId(String merchantOrderId) {
  ...
  public OrderRequestV2 notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public OrderRequestV2 recipient(ConsigneeNewV2 recipient) {
   ...
   */
  @javax.annotation.Nonnull
  public ConsigneeNewV2 getRecipient() {
    return recipient;
  }

  public void setRecipient(ConsigneeNewV2 recipient) {
    this.recipient = recipient;
  }


  public OrderRequestV2 shippingMethod(String shippingMethod) {
  ...
  public OrderRequestV2 warehouse(OrderRequestV2Warehouse warehouse) {
   ...
   */
  @javax.annotation.Nullable
  public OrderRequestV2Warehouse getWarehouse() {
    return warehouse;
  }

  public void setWarehouse(OrderRequestV2Warehouse warehouse) {
    this.warehouse = warehouse;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrderRequestV2 orderRequestV2 = (OrderRequestV2) o;
    return Objects.equals(this.integrator, orderRequestV2.integrator) &&
        Objects.equals(this.items, orderRequestV2.items) &&
        Objects.equals(this.merchantId, orderRequestV2.merchantId) &&
        Objects.equals(this.merchantOrderId, orderRequestV2.merchantOrderId) &&
        Objects.equals(this.notes, orderRequestV2.notes) &&
        Objects.equals(this.recipient, orderRequestV2.recipient) &&
        Objects.equals(this.shippingMethod, orderRequestV2.shippingMethod) &&
        Objects.equals(this.warehouse, orderRequestV2.warehouse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(integrator, items, merchantId, merchantOrderId, notes, recipient, shippingMethod, warehouse);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderRequestV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderRequestV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderRequestV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderRequestV2 is not found in the empty JSON string", OrderRequestV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderRequestV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderRequestV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderRequestV2.openapiRequiredFields) {
      ...
      if (jsonObj.get("integrator") != null && !jsonObj.get("integrator").isJsonNull()) {
        IntegratorEnum.validateJsonElement(jsonObj.get("integrator"));
      }
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        OrderRequestV2ItemsInner.validateJsonElement(jsonArrayitems.get(i));
      };
      ...
      ConsigneeNewV2.validateJsonElement(jsonObj.get("recipient"));
      ...
      if (jsonObj.get("warehouse") != null && !jsonObj.get("warehouse").isJsonNull()) {
        OrderRequestV2Warehouse.validateJsonElement(jsonObj.get("warehouse"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderRequestV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderRequestV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderRequestV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderRequestV2.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderRequestV2>() {
           @Override
           public void write(JsonWriter out, OrderRequestV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderRequestV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderRequestV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderRequestV2
   * @throws IOException if the JSON string is invalid with respect to OrderRequestV2
   */
  public static OrderRequestV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderRequestV2.class);
  }

  /**
   * Convert an instance of OrderRequestV2 to an JSON string
   *
   * @return JSON string
   */
