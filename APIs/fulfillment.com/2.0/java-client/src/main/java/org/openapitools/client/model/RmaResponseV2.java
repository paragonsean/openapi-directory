...
public class RmaResponseV2 {
  ...
  private ConsigneeV2 recipient;

  public static final String SERIALIZED_NAME_RMA_NUMBER = "rmaNumber";
  @SerializedName(SERIALIZED_NAME_RMA_NUMBER)
  private String rmaNumber;

  public RmaResponseV2() {
  }

  public RmaResponseV2 items(List<RmaRequestV2ItemsInner> items) {
    this.items = items;
    return this;
  }

  public RmaResponseV2 addItemsItem(RmaRequestV2ItemsInner itemsItem) {
    if (this.items == null) {
  ...
  public RmaResponseV2 merchantOrderId(String merchantOrderId) {
  ...
  public RmaResponseV2 recipient(ConsigneeV2 recipient) {
   ...
   */
  @javax.annotation.Nonnull
  public ConsigneeV2 getRecipient() {
    return recipient;
  }

  public void setRecipient(ConsigneeV2 recipient) {
    this.recipient = recipient;
  }


  public RmaResponseV2 rmaNumber(String rmaNumber) {
  ...
  public boolean equals(Object o) {
    ...
    RmaResponseV2 rmaResponseV2 = (RmaResponseV2) o;
    return Objects.equals(this.items, rmaResponseV2.items) &&
        Objects.equals(this.merchantOrderId, rmaResponseV2.merchantOrderId) &&
        Objects.equals(this.recipient, rmaResponseV2.recipient) &&
        Objects.equals(this.rmaNumber, rmaResponseV2.rmaNumber);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RmaResponseV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RmaResponseV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RmaResponseV2 is not found in the empty JSON string", RmaResponseV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RmaResponseV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RmaResponseV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RmaResponseV2.openapiRequiredFields) {
      ...
      ConsigneeV2.validateJsonElement(jsonObj.get("recipient"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RmaResponseV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RmaResponseV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RmaResponseV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RmaResponseV2.class));

       return (TypeAdapter<T>) new TypeAdapter<RmaResponseV2>() {
           @Override
           public void write(JsonWriter out, RmaResponseV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RmaResponseV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RmaResponseV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RmaResponseV2
   * @throws IOException if the JSON string is invalid with respect to RmaResponseV2
   */
  public static RmaResponseV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RmaResponseV2.class);
  }

  /**
   * Convert an instance of RmaResponseV2 to an JSON string
   *
   * @return JSON string
   */
