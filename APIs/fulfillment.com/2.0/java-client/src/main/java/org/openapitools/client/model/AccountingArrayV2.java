...
import org.openapitools.client.model.AccountingV2;
...
public class AccountingArrayV2 {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<AccountingV2> data = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private AccountingArrayV2Meta meta;

  public AccountingArrayV2() {
  }

  public AccountingArrayV2 data(List<AccountingV2> data) {
    this.data = data;
    return this;
  }

  public AccountingArrayV2 addDataItem(AccountingV2 dataItem) {
    if (this.data == null) {
  ...
  public List<AccountingV2> getData() {
    return data;
  }

  public void setData(List<AccountingV2> data) {
    this.data = data;
  }


  public AccountingArrayV2 meta(AccountingArrayV2Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccountingArrayV2 accountingArrayV2 = (AccountingArrayV2) o;
    return Objects.equals(this.data, accountingArrayV2.data) &&
        Objects.equals(this.meta, accountingArrayV2.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountingArrayV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountingArrayV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountingArrayV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountingArrayV2 is not found in the empty JSON string", AccountingArrayV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountingArrayV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountingArrayV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            AccountingV2.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountingArrayV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountingArrayV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountingArrayV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountingArrayV2.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountingArrayV2>() {
           @Override
           public void write(JsonWriter out, AccountingArrayV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountingArrayV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountingArrayV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountingArrayV2
   * @throws IOException if the JSON string is invalid with respect to AccountingArrayV2
   */
  public static AccountingArrayV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountingArrayV2.class);
  }

  /**
   * Convert an instance of AccountingArrayV2 to an JSON string
   *
   * @return JSON string
   */
