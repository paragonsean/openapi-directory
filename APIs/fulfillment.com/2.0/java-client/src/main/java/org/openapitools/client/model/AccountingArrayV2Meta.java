...
import org.openapitools.client.model.PaginationV2;
...
public class AccountingArrayV2Meta {
  public static final String SERIALIZED_NAME_PAGINATION = "pagination";
  @SerializedName(SERIALIZED_NAME_PAGINATION)
  private PaginationV2 pagination;

  public AccountingArrayV2Meta() {
  }

  public AccountingArrayV2Meta pagination(PaginationV2 pagination) {
  ...
  public PaginationV2 getPagination() {
    return pagination;
  }

  public void setPagination(PaginationV2 pagination) {
    this.pagination = pagination;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccountingArrayV2Meta accountingArrayV2Meta = (AccountingArrayV2Meta) o;
    return Objects.equals(this.pagination, accountingArrayV2Meta.pagination);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountingArrayV2Meta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountingArrayV2Meta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountingArrayV2Meta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountingArrayV2Meta is not found in the empty JSON string", AccountingArrayV2Meta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountingArrayV2Meta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountingArrayV2Meta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `pagination`
      if (jsonObj.get("pagination") != null && !jsonObj.get("pagination").isJsonNull()) {
        PaginationV2.validateJsonElement(jsonObj.get("pagination"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountingArrayV2Meta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountingArrayV2Meta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountingArrayV2Meta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountingArrayV2Meta.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountingArrayV2Meta>() {
           @Override
           public void write(JsonWriter out, AccountingArrayV2Meta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountingArrayV2Meta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountingArrayV2Meta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountingArrayV2Meta
   * @throws IOException if the JSON string is invalid with respect to AccountingArrayV2Meta
   */
  public static AccountingArrayV2Meta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountingArrayV2Meta.class);
  }

  /**
   * Convert an instance of AccountingArrayV2Meta to an JSON string
   *
   * @return JSON string
   */
