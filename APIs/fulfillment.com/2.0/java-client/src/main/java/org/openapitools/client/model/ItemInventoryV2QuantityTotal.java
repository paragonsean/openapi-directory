...
public class ItemInventoryV2QuantityTotal {
  public static final String SERIALIZED_NAME_AVAILABLE_TO_PROMISE = "availableToPromise";
  @SerializedName(SERIALIZED_NAME_AVAILABLE_TO_PROMISE)
  private Integer availableToPromise;

  public ItemInventoryV2QuantityTotal() {
  }

  public ItemInventoryV2QuantityTotal availableToPromise(Integer availableToPromise) {
  ...
  public boolean equals(Object o) {
    ...
    ItemInventoryV2QuantityTotal itemInventoryV2QuantityTotal = (ItemInventoryV2QuantityTotal) o;
    return Objects.equals(this.availableToPromise, itemInventoryV2QuantityTotal.availableToPromise);
  }

  @Override
  public int hashCode() {
    return Objects.hash(availableToPromise);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ItemInventoryV2QuantityTotal {\n");
    sb.append("    availableToPromise: ").append(toIndentedString(availableToPromise)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("availableToPromise");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemInventoryV2QuantityTotal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemInventoryV2QuantityTotal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemInventoryV2QuantityTotal is not found in the empty JSON string", ItemInventoryV2QuantityTotal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemInventoryV2QuantityTotal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemInventoryV2QuantityTotal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemInventoryV2QuantityTotal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemInventoryV2QuantityTotal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemInventoryV2QuantityTotal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemInventoryV2QuantityTotal.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemInventoryV2QuantityTotal>() {
           @Override
           public void write(JsonWriter out, ItemInventoryV2QuantityTotal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemInventoryV2QuantityTotal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ItemInventoryV2QuantityTotal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemInventoryV2QuantityTotal
   * @throws IOException if the JSON string is invalid with respect to ItemInventoryV2QuantityTotal
   */
  public static ItemInventoryV2QuantityTotal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemInventoryV2QuantityTotal.class);
  }

  /**
   * Convert an instance of ItemInventoryV2QuantityTotal to an JSON string
   *
   * @return JSON string
   */
