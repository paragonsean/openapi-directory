...
public class MerchantV2 {
  ...
  public MerchantV2 id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public MerchantV2 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MerchantV2 merchantV2 = (MerchantV2) o;
    return Objects.equals(this.id, merchantV2.id) &&
        Objects.equals(this.name, merchantV2.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MerchantV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantV2 is not found in the empty JSON string", MerchantV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MerchantV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantV2.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantV2>() {
           @Override
           public void write(JsonWriter out, MerchantV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MerchantV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MerchantV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MerchantV2
   * @throws IOException if the JSON string is invalid with respect to MerchantV2
   */
  public static MerchantV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantV2.class);
  }

  /**
   * Convert an instance of MerchantV2 to an JSON string
   *
   * @return JSON string
   */
