...
public class UserContactV2Merchant {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Integer id;

  public UserContactV2Merchant() {
  }

  public UserContactV2Merchant id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UserContactV2Merchant userContactV2Merchant = (UserContactV2Merchant) o;
    return Objects.equals(this.id, userContactV2Merchant.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserContactV2Merchant {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserContactV2Merchant
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserContactV2Merchant.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserContactV2Merchant is not found in the empty JSON string", UserContactV2Merchant.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserContactV2Merchant.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserContactV2Merchant` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserContactV2Merchant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserContactV2Merchant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserContactV2Merchant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserContactV2Merchant.class));

       return (TypeAdapter<T>) new TypeAdapter<UserContactV2Merchant>() {
           @Override
           public void write(JsonWriter out, UserContactV2Merchant value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserContactV2Merchant read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserContactV2Merchant given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserContactV2Merchant
   * @throws IOException if the JSON string is invalid with respect to UserContactV2Merchant
   */
  public static UserContactV2Merchant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserContactV2Merchant.class);
  }

  /**
   * Convert an instance of UserContactV2Merchant to an JSON string
   *
   * @return JSON string
   */
