...
public class AccountingV2Merchant {
  ...
  public AccountingV2Merchant() {
  }

  public AccountingV2Merchant id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public AccountingV2Merchant name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccountingV2Merchant accountingV2Merchant = (AccountingV2Merchant) o;
    return Objects.equals(this.id, accountingV2Merchant.id) &&
        Objects.equals(this.name, accountingV2Merchant.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountingV2Merchant {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountingV2Merchant
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountingV2Merchant.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountingV2Merchant is not found in the empty JSON string", AccountingV2Merchant.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountingV2Merchant.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountingV2Merchant` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountingV2Merchant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountingV2Merchant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountingV2Merchant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountingV2Merchant.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountingV2Merchant>() {
           @Override
           public void write(JsonWriter out, AccountingV2Merchant value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountingV2Merchant read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountingV2Merchant given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountingV2Merchant
   * @throws IOException if the JSON string is invalid with respect to AccountingV2Merchant
   */
  public static AccountingV2Merchant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountingV2Merchant.class);
  }

  /**
   * Convert an instance of AccountingV2Merchant to an JSON string
   *
   * @return JSON string
   */
