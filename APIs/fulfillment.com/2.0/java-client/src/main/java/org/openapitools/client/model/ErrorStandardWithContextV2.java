...
public class ErrorStandardWithContextV2 {
  ...
  public ErrorStandardWithContextV2() {
  }

  public ErrorStandardWithContextV2 context(List<Object> context) {
    this.context = context;
    return this;
  }

  public ErrorStandardWithContextV2 addContextItem(Object contextItem) {
  ...
  public ErrorStandardWithContextV2 message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    ErrorStandardWithContextV2 errorStandardWithContextV2 = (ErrorStandardWithContextV2) o;
    return Objects.equals(this.context, errorStandardWithContextV2.context) &&
        Objects.equals(this.message, errorStandardWithContextV2.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorStandardWithContextV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ErrorStandardWithContextV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorStandardWithContextV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ErrorStandardWithContextV2 is not found in the empty JSON string", ErrorStandardWithContextV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ErrorStandardWithContextV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ErrorStandardWithContextV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ErrorStandardWithContextV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ErrorStandardWithContextV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ErrorStandardWithContextV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ErrorStandardWithContextV2.class));

       return (TypeAdapter<T>) new TypeAdapter<ErrorStandardWithContextV2>() {
           @Override
           public void write(JsonWriter out, ErrorStandardWithContextV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ErrorStandardWithContextV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ErrorStandardWithContextV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ErrorStandardWithContextV2
   * @throws IOException if the JSON string is invalid with respect to ErrorStandardWithContextV2
   */
  public static ErrorStandardWithContextV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ErrorStandardWithContextV2.class);
  }

  /**
   * Convert an instance of ErrorStandardWithContextV2 to an JSON string
   *
   * @return JSON string
   */
