...
public class TrackingApi {
     ...
     */
    public okhttp3.Call getTrackCall(String trackingNumber, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getTrackValidateBeforeCall(String trackingNumber, final ApiCallback _callback) throws ApiException {
        return getTrackCall(trackingNumber, _callback);
     ...
     */
    public TrackingResponse getTrack(String trackingNumber) throws ApiException {
        ApiResponse<TrackingResponse> localVarResp = getTrackWithHttpInfo(trackingNumber);
     ...
     */
    public ApiResponse<TrackingResponse> getTrackWithHttpInfo(String trackingNumber) throws ApiException {
        okhttp3.Call localVarCall = getTrackValidateBeforeCall(trackingNumber, null);
     ...
     */
    public okhttp3.Call getTrackAsync(String trackingNumber, final ApiCallback<TrackingResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTrackValidateBeforeCall(trackingNumber, _callback);
        Type localVarReturnType = new TypeToken<TrackingResponse>(){}.getType();
