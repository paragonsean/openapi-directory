...
public class StatusTypeSimpleV2 {
  ...
  private StatusTypeSimpleV2Status status;

  public StatusTypeSimpleV2() {
  }

  public StatusTypeSimpleV2 reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public StatusTypeSimpleV2 status(StatusTypeSimpleV2Status status) {
    this.status = status;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public StatusTypeSimpleV2Status getStatus() {
    return status;
  }

  public void setStatus(StatusTypeSimpleV2Status status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    StatusTypeSimpleV2 statusTypeSimpleV2 = (StatusTypeSimpleV2) o;
    return Objects.equals(this.reason, statusTypeSimpleV2.reason) &&
        Objects.equals(this.status, statusTypeSimpleV2.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatusTypeSimpleV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatusTypeSimpleV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatusTypeSimpleV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatusTypeSimpleV2 is not found in the empty JSON string", StatusTypeSimpleV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatusTypeSimpleV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatusTypeSimpleV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatusTypeSimpleV2.openapiRequiredFields) {
      ...
      StatusTypeSimpleV2Status.validateJsonElement(jsonObj.get("status"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatusTypeSimpleV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatusTypeSimpleV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatusTypeSimpleV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatusTypeSimpleV2.class));

       return (TypeAdapter<T>) new TypeAdapter<StatusTypeSimpleV2>() {
           @Override
           public void write(JsonWriter out, StatusTypeSimpleV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatusTypeSimpleV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatusTypeSimpleV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatusTypeSimpleV2
   * @throws IOException if the JSON string is invalid with respect to StatusTypeSimpleV2
   */
  public static StatusTypeSimpleV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatusTypeSimpleV2.class);
  }

  /**
   * Convert an instance of StatusTypeSimpleV2 to an JSON string
   *
   * @return JSON string
   */
