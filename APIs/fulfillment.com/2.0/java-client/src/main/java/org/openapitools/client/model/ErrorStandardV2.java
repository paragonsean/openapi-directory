...
public class ErrorStandardV2 {
  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  private String message;

  public ErrorStandardV2() {
  }

  public ErrorStandardV2 message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    ErrorStandardV2 errorStandardV2 = (ErrorStandardV2) o;
    return Objects.equals(this.message, errorStandardV2.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorStandardV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ErrorStandardV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorStandardV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ErrorStandardV2 is not found in the empty JSON string", ErrorStandardV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ErrorStandardV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ErrorStandardV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ErrorStandardV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ErrorStandardV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ErrorStandardV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ErrorStandardV2.class));

       return (TypeAdapter<T>) new TypeAdapter<ErrorStandardV2>() {
           @Override
           public void write(JsonWriter out, ErrorStandardV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ErrorStandardV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ErrorStandardV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ErrorStandardV2
   * @throws IOException if the JSON string is invalid with respect to ErrorStandardV2
   */
  public static ErrorStandardV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ErrorStandardV2.class);
  }

  /**
   * Convert an instance of ErrorStandardV2 to an JSON string
   *
   * @return JSON string
   */
