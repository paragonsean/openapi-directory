...
public class OrdersApi {
    ...
    /**
     * Build call for deleteOrdersId
     * @param id ID of order that needs to be canceled (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Your order was successfully canceled </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Order not found </td><td>  -  </td></tr>
        <tr><td> 405 </td><td> Could not cancel your order, perhaps it already shipped </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteOrdersIdCall(Integer id, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteOrdersIdValidateBeforeCall(Integer id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteOrdersId(Async)");
        }

        return deleteOrdersIdCall(id, _callback);
     ...
     */
    public Object deleteOrdersId(Integer id) throws ApiException {
        ApiResponse<Object> localVarResp = deleteOrdersIdWithHttpInfo(id);
     ...
     */
    public ApiResponse<Object> deleteOrdersIdWithHttpInfo(Integer id) throws ApiException {
        okhttp3.Call localVarCall = deleteOrdersIdValidateBeforeCall(id, null);
     ...
     */
    public okhttp3.Call deleteOrdersIdAsync(Integer id, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteOrdersIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
     ...
     * @param merchantId Providing your &#x60;merchantId&#x60; indicates the &#x60;id&#x60; is your &#x60;merchantOrderId&#x60;. Although it is not necessary to provide this it will speed up your results when using your &#x60;merchantOrderId&#x60; however it will slow your results when using the FDC provided &#x60;id&#x60; (optional)
     * @param hydrate Adds additional information to the response, uses a CSV format for multiple values.&#39; (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getOrderCall(String id, Integer merchantId, List<String> hydrate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (hydrate != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("csv", "hydrate", hydrate));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOrderValidateBeforeCall(String id, Integer merchantId, List<String> hydrate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getOrder(Async)");
        }

        return getOrderCall(id, merchantId, hydrate, _callback);
     ...
     */
    public Object getOrder(String id, Integer merchantId, List<String> hydrate) throws ApiException {
        ApiResponse<Object> localVarResp = getOrderWithHttpInfo(id, merchantId, hydrate);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> getOrderWithHttpInfo(String id, Integer merchantId, List<String> hydrate) throws ApiException {
        okhttp3.Call localVarCall = getOrderValidateBeforeCall(id, merchantId, hydrate, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Order Details (asynchronously)
     * For the fastest results use the FDC provided &#x60;id&#x60; however you can use your &#x60;merchantOrderId&#x60; as the &#x60;id&#x60;.
     * @param id The FDC order Id (required)
     * @param merchantId Providing your &#x60;merchantId&#x60; indicates the &#x60;id&#x60; is your &#x60;merchantOrderId&#x60;. Although it is not necessary to provide this it will speed up your results when using your &#x60;merchantOrderId&#x60; however it will slow your results when using the FDC provided &#x60;id&#x60; (optional)
     * @param hydrate Adds additional information to the response, uses a CSV format for multiple values.&#39; (optional)
     ...
     */
    public okhttp3.Call getOrderAsync(String id, Integer merchantId, List<String> hydrate, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrderValidateBeforeCall(id, merchantId, hydrate, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getOrdersCall(String fromDate, String toDate, List<Integer> merchantIds, List<Integer> warehouseIds, Integer page, Integer limit, List<String> hydrate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOrdersValidateBeforeCall(String fromDate, String toDate, List<Integer> merchantIds, List<Integer> warehouseIds, Integer page, Integer limit, List<String> hydrate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'fromDate' is set
        if (fromDate == null) {
            throw new ApiException("Missing the required parameter 'fromDate' when calling getOrders(Async)");
        }

        // verify the required parameter 'toDate' is set
        if (toDate == null) {
            throw new ApiException("Missing the required parameter 'toDate' when calling getOrders(Async)");
        }

        return getOrdersCall(fromDate, toDate, merchantIds, warehouseIds, page, limit, hydrate, _callback);
     ...
     */
    public OrderResponseOneOfV2 getOrders(String fromDate, String toDate, List<Integer> merchantIds, List<Integer> warehouseIds, Integer page, Integer limit, List<String> hydrate) throws ApiException {
        ApiResponse<OrderResponseOneOfV2> localVarResp = getOrdersWithHttpInfo(fromDate, toDate, merchantIds, warehouseIds, page, limit, hydrate);
        return localVarResp.getData();
    }
     ...
     * @param limit The numbers of items to return (optional, default to 80)
     * @param hydrate Adds additional information to the response, uses a CSV format for multiple values.&#39; (optional)
     * @return ApiResponse&lt;OrderResponseOneOfV2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<OrderResponseOneOfV2> getOrdersWithHttpInfo(String fromDate, String toDate, List<Integer> merchantIds, List<Integer> warehouseIds, Integer page, Integer limit, List<String> hydrate) throws ApiException {
        okhttp3.Call localVarCall = getOrdersValidateBeforeCall(fromDate, toDate, merchantIds, warehouseIds, page, limit, hydrate, null);
        Type localVarReturnType = new TypeToken<OrderResponseOneOfV2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List of Orders (asynchronously)
     * Retrieve many orders at once
     * @param fromDate Date-time in ISO 8601 format for selecting orders after, or at, the specified time (required)
     * @param toDate Date-time in ISO 8601 format for selecting orders before, or at, the specified time (required)
     * @param merchantIds A CSV of merchant id, &#39;123&#39; or &#39;1,2,3&#39; (optional)
     ...
     */
    public okhttp3.Call getOrdersAsync(String fromDate, String toDate, List<Integer> merchantIds, List<Integer> warehouseIds, Integer page, Integer limit, List<String> hydrate, final ApiCallback<OrderResponseOneOfV2> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrdersValidateBeforeCall(fromDate, toDate, merchantIds, warehouseIds, page, limit, hydrate, _callback);
        Type localVarReturnType = new TypeToken<OrderResponseOneOfV2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param body The order to create (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Invalid order object </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> You do not have permission to create orders </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> Conflict </td><td>  -  </td></tr>
        <tr><td> 422 </td><td> Validation Failure </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call postOrdersCall(OrderRequestV2 body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postOrdersValidateBeforeCall(OrderRequestV2 body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling postOrders(Async)");
        }

        return postOrdersCall(body, _callback);
     ...
     */
    public OrderResponseV2 postOrders(OrderRequestV2 body) throws ApiException {
        ApiResponse<OrderResponseV2> localVarResp = postOrdersWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     * Error Notes&amp;#58; * When &#x60;409 Conflict&#x60; is a &#39;Duplicate Order&#39; the &#x60;context&#x60; will include the FDC &#x60;id&#x60;, see samples. 
     * @param body The order to create (required)
     * @return ApiResponse&lt;OrderResponseV2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<OrderResponseV2> postOrdersWithHttpInfo(OrderRequestV2 body) throws ApiException {
        okhttp3.Call localVarCall = postOrdersValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<OrderResponseV2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * New Order (asynchronously)
     * Error Notes&amp;#58; * When &#x60;409 Conflict&#x60; is a &#39;Duplicate Order&#39; the &#x60;context&#x60; will include the FDC &#x60;id&#x60;, see samples. 
     * @param body The order to create (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call postOrdersAsync(OrderRequestV2 body, final ApiCallback<OrderResponseV2> _callback) throws ApiException {

        okhttp3.Call localVarCall = postOrdersValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<OrderResponseV2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
