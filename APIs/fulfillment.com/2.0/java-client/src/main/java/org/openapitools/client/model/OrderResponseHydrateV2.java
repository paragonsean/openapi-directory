...
public class OrderResponseHydrateV2 {
  ...
  private List<LineItemsResponseV2> lineItems = new ArrayList<>();
  ...
  private List<OrderResponseHydrateV2AllOfTrackingNumbersInner> trackingNumbers = new ArrayList<>();

  public OrderResponseHydrateV2() {
  }

  public OrderResponseHydrateV2 integrator(String integrator) {
  ...
  public OrderResponseHydrateV2 lineItems(List<LineItemsResponseV2> lineItems) {
    this.lineItems = lineItems;
    return this;
  }

  public OrderResponseHydrateV2 addLineItemsItem(LineItemsResponseV2 lineItemsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<LineItemsResponseV2> getLineItems() {
    return lineItems;
  }

  public void setLineItems(List<LineItemsResponseV2> lineItems) {
    this.lineItems = lineItems;
  }


  public OrderResponseHydrateV2 trackingNumbers(List<OrderResponseHydrateV2AllOfTrackingNumbersInner> trackingNumbers) {
    this.trackingNumbers = trackingNumbers;
    return this;
  }

  public OrderResponseHydrateV2 addTrackingNumbersItem(OrderResponseHydrateV2AllOfTrackingNumbersInner trackingNumbersItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<OrderResponseHydrateV2AllOfTrackingNumbersInner> getTrackingNumbers() {
    return trackingNumbers;
  }

  public void setTrackingNumbers(List<OrderResponseHydrateV2AllOfTrackingNumbersInner> trackingNumbers) {
    this.trackingNumbers = trackingNumbers;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrderResponseHydrateV2 orderResponseHydrateV2 = (OrderResponseHydrateV2) o;
    return Objects.equals(this.integrator, orderResponseHydrateV2.integrator) &&
        Objects.equals(this.lineItems, orderResponseHydrateV2.lineItems) &&
        Objects.equals(this.trackingNumbers, orderResponseHydrateV2.trackingNumbers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(integrator, lineItems, trackingNumbers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderResponseHydrateV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderResponseHydrateV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderResponseHydrateV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderResponseHydrateV2 is not found in the empty JSON string", OrderResponseHydrateV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderResponseHydrateV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderResponseHydrateV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("lineItems") != null && !jsonObj.get("lineItems").isJsonNull()) {
        ...
        if (jsonArraylineItems != null) {
          ...
          for (int i = 0; i < jsonArraylineItems.size(); i++) {
            LineItemsResponseV2.validateJsonElement(jsonArraylineItems.get(i));
          };
        }
      }
      if (jsonObj.get("trackingNumbers") != null && !jsonObj.get("trackingNumbers").isJsonNull()) {
        ...
        if (jsonArraytrackingNumbers != null) {
          ...
          for (int i = 0; i < jsonArraytrackingNumbers.size(); i++) {
            OrderResponseHydrateV2AllOfTrackingNumbersInner.validateJsonElement(jsonArraytrackingNumbers.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderResponseHydrateV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderResponseHydrateV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderResponseHydrateV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderResponseHydrateV2.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderResponseHydrateV2>() {
           @Override
           public void write(JsonWriter out, OrderResponseHydrateV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderResponseHydrateV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderResponseHydrateV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderResponseHydrateV2
   * @throws IOException if the JSON string is invalid with respect to OrderResponseHydrateV2
   */
  public static OrderResponseHydrateV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderResponseHydrateV2.class);
  }

  /**
   * Convert an instance of OrderResponseHydrateV2 to an JSON string
   *
   * @return JSON string
   */
