...
import org.openapitools.client.model.ItemInventoryArrayV2;
...
public class InventoryApi {
     ...
     * @param merchantIds A CSV of merchant id, &#39;123&#39; or &#39;1,2,3&#39; (optional)
     * @param warehouseIds A CSV of warehouse id, &#39;123&#39; or &#39;1,2,3&#39; (optional)
     * @param externalSkuNames A CSV of sku reference names, &#39;skuName1&#39; or &#39;skuName1,skuName2,skuName3&#39; (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Found Inventory </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Access Denied </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> No Inventory Found </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getInventoryCall(Integer page, Integer limit, List<Integer> merchantIds, List<Integer> warehouseIds, List<String> externalSkuNames, final ApiCallback _callback) throws ApiException {
        ...
        if (merchantIds != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("csv", "merchantIds", merchantIds));
        }
        ...
        if (externalSkuNames != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("csv", "externalSkuNames", externalSkuNames));
        }
    ...
    private okhttp3.Call getInventoryValidateBeforeCall(Integer page, Integer limit, List<Integer> merchantIds, List<Integer> warehouseIds, List<String> externalSkuNames, final ApiCallback _callback) throws ApiException {
        return getInventoryCall(page, limit, merchantIds, warehouseIds, externalSkuNames, _callback);
     ...
     */
    public ItemInventoryArrayV2 getInventory(Integer page, Integer limit, List<Integer> merchantIds, List<Integer> warehouseIds, List<String> externalSkuNames) throws ApiException {
        ApiResponse<ItemInventoryArrayV2> localVarResp = getInventoryWithHttpInfo(page, limit, merchantIds, warehouseIds, externalSkuNames);
     ...
     * @param warehouseIds A CSV of warehouse id, &#39;123&#39; or &#39;1,2,3&#39; (optional)
     * @param externalSkuNames A CSV of sku reference names, &#39;skuName1&#39; or &#39;skuName1,skuName2,skuName3&#39; (optional)
     * @return ApiResponse&lt;ItemInventoryArrayV2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ItemInventoryArrayV2> getInventoryWithHttpInfo(Integer page, Integer limit, List<Integer> merchantIds, List<Integer> warehouseIds, List<String> externalSkuNames) throws ApiException {
        okhttp3.Call localVarCall = getInventoryValidateBeforeCall(page, limit, merchantIds, warehouseIds, externalSkuNames, null);
        Type localVarReturnType = new TypeToken<ItemInventoryArrayV2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List of Item Inventories (asynchronously)
     * Retrieve inventory for one or more items. This API requires elevated permissions, please speak to your success manager.
     * @param page A multiplier of the number of items (limit parameter) to skip before returning results (optional, default to 1)
     * @param limit The numbers of items to return (optional, default to 80)
     * @param merchantIds A CSV of merchant id, &#39;123&#39; or &#39;1,2,3&#39; (optional)
     ...
     */
    public okhttp3.Call getInventoryAsync(Integer page, Integer limit, List<Integer> merchantIds, List<Integer> warehouseIds, List<String> externalSkuNames, final ApiCallback<ItemInventoryArrayV2> _callback) throws ApiException {

        okhttp3.Call localVarCall = getInventoryValidateBeforeCall(page, limit, merchantIds, warehouseIds, externalSkuNames, _callback);
        Type localVarReturnType = new TypeToken<ItemInventoryArrayV2>(){}.getType();
