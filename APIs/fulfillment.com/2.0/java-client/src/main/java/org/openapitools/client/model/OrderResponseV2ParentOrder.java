...
public class OrderResponseV2ParentOrder {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Integer id;

  public OrderResponseV2ParentOrder() {
  }

  public OrderResponseV2ParentOrder id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrderResponseV2ParentOrder orderResponseV2ParentOrder = (OrderResponseV2ParentOrder) o;
    return Objects.equals(this.id, orderResponseV2ParentOrder.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderResponseV2ParentOrder {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderResponseV2ParentOrder
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderResponseV2ParentOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderResponseV2ParentOrder is not found in the empty JSON string", OrderResponseV2ParentOrder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderResponseV2ParentOrder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderResponseV2ParentOrder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderResponseV2ParentOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderResponseV2ParentOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderResponseV2ParentOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderResponseV2ParentOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderResponseV2ParentOrder>() {
           @Override
           public void write(JsonWriter out, OrderResponseV2ParentOrder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderResponseV2ParentOrder read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderResponseV2ParentOrder given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderResponseV2ParentOrder
   * @throws IOException if the JSON string is invalid with respect to OrderResponseV2ParentOrder
   */
  public static OrderResponseV2ParentOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderResponseV2ParentOrder.class);
  }

  /**
   * Convert an instance of OrderResponseV2ParentOrder to an JSON string
   *
   * @return JSON string
   */
