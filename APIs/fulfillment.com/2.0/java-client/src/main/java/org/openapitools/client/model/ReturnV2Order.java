...
public class ReturnV2Order {
  ...
  public ReturnV2Order() {
  }

  public ReturnV2Order id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ReturnV2Order merchantId(Integer merchantId) {
  ...
  public ReturnV2Order merchantOrderId(String merchantOrderId) {
  ...
  public boolean equals(Object o) {
    ...
    ReturnV2Order returnV2Order = (ReturnV2Order) o;
    return Objects.equals(this.id, returnV2Order.id) &&
        Objects.equals(this.merchantId, returnV2Order.merchantId) &&
        Objects.equals(this.merchantOrderId, returnV2Order.merchantOrderId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, merchantId, merchantOrderId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReturnV2Order {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReturnV2Order
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReturnV2Order.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReturnV2Order is not found in the empty JSON string", ReturnV2Order.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReturnV2Order.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReturnV2Order` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReturnV2Order.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReturnV2Order' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReturnV2Order> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReturnV2Order.class));

       return (TypeAdapter<T>) new TypeAdapter<ReturnV2Order>() {
           @Override
           public void write(JsonWriter out, ReturnV2Order value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReturnV2Order read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReturnV2Order given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReturnV2Order
   * @throws IOException if the JSON string is invalid with respect to ReturnV2Order
   */
  public static ReturnV2Order fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReturnV2Order.class);
  }

  /**
   * Convert an instance of ReturnV2Order to an JSON string
   *
   * @return JSON string
   */
