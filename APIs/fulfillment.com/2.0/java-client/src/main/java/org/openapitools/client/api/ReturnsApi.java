...
public class ReturnsApi {
     ...
     * @param fromDate Date-time in ISO 8601 format for selecting orders after, or at, the specified time (required)
     * @param toDate Date-time in ISO 8601 format for selecting orders before, or at, the specified time (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Returns </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getReturnsCall(String fromDate, String toDate, Integer page, Integer limit, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getReturnsValidateBeforeCall(String fromDate, String toDate, Integer page, Integer limit, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'fromDate' is set
        if (fromDate == null) {
            throw new ApiException("Missing the required parameter 'fromDate' when calling getReturns(Async)");
        }

        // verify the required parameter 'toDate' is set
        if (toDate == null) {
            throw new ApiException("Missing the required parameter 'toDate' when calling getReturns(Async)");
        }

        return getReturnsCall(fromDate, toDate, page, limit, _callback);
     ...
     */
    public ReturnsArrayV2 getReturns(String fromDate, String toDate, Integer page, Integer limit) throws ApiException {
        ApiResponse<ReturnsArrayV2> localVarResp = getReturnsWithHttpInfo(fromDate, toDate, page, limit);
     ...
     * @param page A multiplier of the number of items (limit parameter) to skip before returning results (optional, default to 1)
     * @param limit The numbers of items to return (optional, default to 80)
     * @return ApiResponse&lt;ReturnsArrayV2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ReturnsArrayV2> getReturnsWithHttpInfo(String fromDate, String toDate, Integer page, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = getReturnsValidateBeforeCall(fromDate, toDate, page, limit, null);
        Type localVarReturnType = new TypeToken<ReturnsArrayV2>(){}.getType();
     ...
     */
    public okhttp3.Call getReturnsAsync(String fromDate, String toDate, Integer page, Integer limit, final ApiCallback<ReturnsArrayV2> _callback) throws ApiException {

        okhttp3.Call localVarCall = getReturnsValidateBeforeCall(fromDate, toDate, page, limit, _callback);
        Type localVarReturnType = new TypeToken<ReturnsArrayV2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for putReturns
     * @param rmaRequestV2 RMA (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> RMA Created </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> RMA Updated </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> A Component of Your Request Was Not Found </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> RMA Already Processed </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call putReturnsCall(RmaRequestV2 rmaRequestV2, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = rmaRequestV2;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putReturnsValidateBeforeCall(RmaRequestV2 rmaRequestV2, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'rmaRequestV2' is set
        if (rmaRequestV2 == null) {
            throw new ApiException("Missing the required parameter 'rmaRequestV2' when calling putReturns(Async)");
        }

        return putReturnsCall(rmaRequestV2, _callback);
     ...
     */
    public RmaResponseV2 putReturns(RmaRequestV2 rmaRequestV2) throws ApiException {
        ApiResponse<RmaResponseV2> localVarResp = putReturnsWithHttpInfo(rmaRequestV2);
        return localVarResp.getData();
    }
     ...
     * Inform FDC of an expected return.
     * @param rmaRequestV2 RMA (required)
     * @return ApiResponse&lt;RmaResponseV2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<RmaResponseV2> putReturnsWithHttpInfo(RmaRequestV2 rmaRequestV2) throws ApiException {
        okhttp3.Call localVarCall = putReturnsValidateBeforeCall(rmaRequestV2, null);
        Type localVarReturnType = new TypeToken<RmaResponseV2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Inform us of an RMA (asynchronously)
     * Inform FDC of an expected return.
     * @param rmaRequestV2 RMA (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call putReturnsAsync(RmaRequestV2 rmaRequestV2, final ApiCallback<RmaResponseV2> _callback) throws ApiException {

        okhttp3.Call localVarCall = putReturnsValidateBeforeCall(rmaRequestV2, _callback);
        Type localVarReturnType = new TypeToken<RmaResponseV2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
