...
public class IsoCountryV2 {
  ...
  public IsoCountryV2 id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public IsoCountryV2 iso2(String iso2) {
    this.iso2 = iso2;
    return this;
  }
  ...
  public IsoCountryV2 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IsoCountryV2 isoCountryV2 = (IsoCountryV2) o;
    return Objects.equals(this.id, isoCountryV2.id) &&
        Objects.equals(this.iso2, isoCountryV2.iso2) &&
        Objects.equals(this.name, isoCountryV2.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsoCountryV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsoCountryV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsoCountryV2 is not found in the empty JSON string", IsoCountryV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsoCountryV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsoCountryV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsoCountryV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsoCountryV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsoCountryV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsoCountryV2.class));

       return (TypeAdapter<T>) new TypeAdapter<IsoCountryV2>() {
           @Override
           public void write(JsonWriter out, IsoCountryV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsoCountryV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsoCountryV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsoCountryV2
   * @throws IOException if the JSON string is invalid with respect to IsoCountryV2
   */
  public static IsoCountryV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsoCountryV2.class);
  }

  /**
   * Convert an instance of IsoCountryV2 to an JSON string
   *
   * @return JSON string
   */
