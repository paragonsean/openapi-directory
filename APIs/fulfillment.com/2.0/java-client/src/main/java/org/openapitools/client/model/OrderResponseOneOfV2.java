...
public class OrderResponseOneOfV2 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(OrderResponseOneOfV2.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrderResponseOneOfV2.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrderResponseOneOfV2' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<Object> adapterObject = gson.getDelegateAdapter(this, TypeToken.get(Object.class));
            final TypeAdapter<OrderResponseHydrateV2> adapterOrderResponseHydrateV2 = gson.getDelegateAdapter(this, TypeToken.get(OrderResponseHydrateV2.class));

            return (TypeAdapter<T>) new TypeAdapter<OrderResponseOneOfV2>() {
                @Override
                public void write(JsonWriter out, OrderResponseOneOfV2 value) throws IOException {
                    ...
                    // check if the actual instance is of the type `OrderResponseHydrateV2`
                    if (value.getActualInstance() instanceof OrderResponseHydrateV2) {
                        JsonElement element = adapterOrderResponseHydrateV2.toJsonTree((OrderResponseHydrateV2)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: ERRORUNKNOWN, OrderResponseHydrateV2");
                }

                @Override
                public OrderResponseOneOfV2 read(JsonReader in) throws IOException {
                    ...
                    // deserialize OrderResponseHydrateV2
                    try {
                        // validate the JSON object to see if any exception is thrown
                        OrderResponseHydrateV2.validateJsonElement(jsonElement);
                        actualAdapter = adapterOrderResponseHydrateV2;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'OrderResponseHydrateV2'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for OrderResponseHydrateV2 failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'OrderResponseHydrateV2'", e);
                    }

                    if (match == 1) {
                        OrderResponseOneOfV2 ret = new OrderResponseOneOfV2();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for OrderResponseOneOfV2: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public OrderResponseOneOfV2() {
        super("oneOf", Boolean.FALSE);
    }

    public OrderResponseOneOfV2(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("OrderResponseHydrateV2", OrderResponseHydrateV2.class);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return OrderResponseOneOfV2.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * ERRORUNKNOWN, OrderResponseHydrateV2
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof OrderResponseHydrateV2) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be ERRORUNKNOWN, OrderResponseHydrateV2");
    }
     ...
     * ERRORUNKNOWN, OrderResponseHydrateV2
     *
     * @return The actual instance (ERRORUNKNOWN, OrderResponseHydrateV2)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `OrderResponseHydrateV2`. If the actual instance is not `OrderResponseHydrateV2`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `OrderResponseHydrateV2`
     * @throws ClassCastException if the instance is not `OrderResponseHydrateV2`
     */
    public OrderResponseHydrateV2 getOrderResponseHydrateV2() throws ClassCastException {
        return (OrderResponseHydrateV2)super.getActualInstance();
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to OrderResponseOneOfV2
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with OrderResponseHydrateV2
        try {
            OrderResponseHydrateV2.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for OrderResponseOneOfV2 with oneOf schemas: ERRORUNKNOWN, OrderResponseHydrateV2. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of OrderResponseOneOfV2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OrderResponseOneOfV2
     * @throws IOException if the JSON string is invalid with respect to OrderResponseOneOfV2
     */
    public static OrderResponseOneOfV2 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OrderResponseOneOfV2.class);
    }

    /**
     * Convert an instance of OrderResponseOneOfV2 to an JSON string
     *
     * @return JSON string
     */
