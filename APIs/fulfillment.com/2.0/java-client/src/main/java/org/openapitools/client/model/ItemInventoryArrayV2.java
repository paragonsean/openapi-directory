...
import org.openapitools.client.model.ItemInventoryV2;
...
public class ItemInventoryArrayV2 {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ItemInventoryV2> data = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private AccountingArrayV2Meta meta;

  public ItemInventoryArrayV2() {
  }

  public ItemInventoryArrayV2 data(List<ItemInventoryV2> data) {
    this.data = data;
    return this;
  }

  public ItemInventoryArrayV2 addDataItem(ItemInventoryV2 dataItem) {
    if (this.data == null) {
  ...
  public List<ItemInventoryV2> getData() {
    return data;
  }

  public void setData(List<ItemInventoryV2> data) {
    this.data = data;
  }


  public ItemInventoryArrayV2 meta(AccountingArrayV2Meta meta) {
    this.meta = meta;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AccountingArrayV2Meta getMeta() {
    return meta;
  }

  public void setMeta(AccountingArrayV2Meta meta) {
    this.meta = meta;
  }
  ...
  public boolean equals(Object o) {
    ...
    ItemInventoryArrayV2 itemInventoryArrayV2 = (ItemInventoryArrayV2) o;
    return Objects.equals(this.data, itemInventoryArrayV2.data) &&
        Objects.equals(this.meta, itemInventoryArrayV2.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class ItemInventoryArrayV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemInventoryArrayV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemInventoryArrayV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemInventoryArrayV2 is not found in the empty JSON string", ItemInventoryArrayV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemInventoryArrayV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemInventoryArrayV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ItemInventoryV2.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
      // validate the optional field `meta`
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        AccountingArrayV2Meta.validateJsonElement(jsonObj.get("meta"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemInventoryArrayV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemInventoryArrayV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemInventoryArrayV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemInventoryArrayV2.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemInventoryArrayV2>() {
           @Override
           public void write(JsonWriter out, ItemInventoryArrayV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemInventoryArrayV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ItemInventoryArrayV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemInventoryArrayV2
   * @throws IOException if the JSON string is invalid with respect to ItemInventoryArrayV2
   */
  public static ItemInventoryArrayV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemInventoryArrayV2.class);
  }

  /**
   * Convert an instance of ItemInventoryArrayV2 to an JSON string
   *
   * @return JSON string
   */
