...
import org.openapitools.client.model.RmaItemV2Item;
import org.openapitools.client.model.RmaItemV2NonRestockedReason;
...
public class RmaItemV2 {
  ...
  private RmaItemV2Item item;

  public static final String SERIALIZED_NAME_NON_RESTOCKED_REASON = "nonRestockedReason";
  @SerializedName(SERIALIZED_NAME_NON_RESTOCKED_REASON)
  private RmaItemV2NonRestockedReason nonRestockedReason;
  ...
  public RmaItemV2 comments(String comments) {
  ...
  public RmaItemV2 id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RmaItemV2 item(RmaItemV2Item item) {
    this.item = item;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public RmaItemV2Item getItem() {
    return item;
  }

  public void setItem(RmaItemV2Item item) {
    this.item = item;
  }


  public RmaItemV2 nonRestockedReason(RmaItemV2NonRestockedReason nonRestockedReason) {
    this.nonRestockedReason = nonRestockedReason;
    return this;
  }

  /**
   * Get nonRestockedReason
   * @return nonRestockedReason
   */
  @javax.annotation.Nullable
  public RmaItemV2NonRestockedReason getNonRestockedReason() {
    return nonRestockedReason;
  }

  public void setNonRestockedReason(RmaItemV2NonRestockedReason nonRestockedReason) {
    this.nonRestockedReason = nonRestockedReason;
  }


  public RmaItemV2 quantityExpected(Integer quantityExpected) {
  ...
  public RmaItemV2 quantityRestocked(Integer quantityRestocked) {
    this.quantityRestocked = quantityRestocked;
    return this;
  }

  /**
   * Get quantityRestocked
  ...
  public RmaItemV2 quantityReturned(Integer quantityReturned) {
  ...
  public RmaItemV2 quantityShipped(Integer quantityShipped) {
  ...
  public boolean equals(Object o) {
    ...
    RmaItemV2 rmaItemV2 = (RmaItemV2) o;
    return Objects.equals(this.comments, rmaItemV2.comments) &&
        Objects.equals(this.id, rmaItemV2.id) &&
        Objects.equals(this.item, rmaItemV2.item) &&
        Objects.equals(this.nonRestockedReason, rmaItemV2.nonRestockedReason) &&
        Objects.equals(this.quantityExpected, rmaItemV2.quantityExpected) &&
        Objects.equals(this.quantityRestocked, rmaItemV2.quantityRestocked) &&
        Objects.equals(this.quantityReturned, rmaItemV2.quantityReturned) &&
        Objects.equals(this.quantityShipped, rmaItemV2.quantityShipped);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comments, id, item, nonRestockedReason, quantityExpected, quantityRestocked, quantityReturned, quantityShipped);
  }
  ...
  public String toString() {
    ...
    sb.append("class RmaItemV2 {\n");
    sb.append("    comments: ").append(toIndentedString(comments)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    item: ").append(toIndentedString(item)).append("\n");
    sb.append("    nonRestockedReason: ").append(toIndentedString(nonRestockedReason)).append("\n");
  ...
  static {
    ...
    openapiFields.add("nonRestockedReason");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RmaItemV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RmaItemV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RmaItemV2 is not found in the empty JSON string", RmaItemV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RmaItemV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RmaItemV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("item") != null && !jsonObj.get("item").isJsonNull()) {
        RmaItemV2Item.validateJsonElement(jsonObj.get("item"));
      }
      // validate the optional field `nonRestockedReason`
      if (jsonObj.get("nonRestockedReason") != null && !jsonObj.get("nonRestockedReason").isJsonNull()) {
        RmaItemV2NonRestockedReason.validateJsonElement(jsonObj.get("nonRestockedReason"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RmaItemV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RmaItemV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RmaItemV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RmaItemV2.class));

       return (TypeAdapter<T>) new TypeAdapter<RmaItemV2>() {
           @Override
           public void write(JsonWriter out, RmaItemV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RmaItemV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RmaItemV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RmaItemV2
   * @throws IOException if the JSON string is invalid with respect to RmaItemV2
   */
  public static RmaItemV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RmaItemV2.class);
  }

  /**
   * Convert an instance of RmaItemV2 to an JSON string
   *
   * @return JSON string
   */
