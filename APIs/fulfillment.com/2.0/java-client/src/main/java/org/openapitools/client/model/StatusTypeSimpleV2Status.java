...
public class StatusTypeSimpleV2Status {
  public static final String SERIALIZED_NAME_CODE = "code";
  @SerializedName(SERIALIZED_NAME_CODE)
  private String code;

  public StatusTypeSimpleV2Status() {
  }

  public StatusTypeSimpleV2Status code(String code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StatusTypeSimpleV2Status statusTypeSimpleV2Status = (StatusTypeSimpleV2Status) o;
    return Objects.equals(this.code, statusTypeSimpleV2Status.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatusTypeSimpleV2Status {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatusTypeSimpleV2Status
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatusTypeSimpleV2Status.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatusTypeSimpleV2Status is not found in the empty JSON string", StatusTypeSimpleV2Status.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatusTypeSimpleV2Status.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatusTypeSimpleV2Status` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatusTypeSimpleV2Status.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatusTypeSimpleV2Status.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatusTypeSimpleV2Status' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatusTypeSimpleV2Status> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatusTypeSimpleV2Status.class));

       return (TypeAdapter<T>) new TypeAdapter<StatusTypeSimpleV2Status>() {
           @Override
           public void write(JsonWriter out, StatusTypeSimpleV2Status value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatusTypeSimpleV2Status read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatusTypeSimpleV2Status given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatusTypeSimpleV2Status
   * @throws IOException if the JSON string is invalid with respect to StatusTypeSimpleV2Status
   */
  public static StatusTypeSimpleV2Status fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatusTypeSimpleV2Status.class);
  }

  /**
   * Convert an instance of StatusTypeSimpleV2Status to an JSON string
   *
   * @return JSON string
   */
