...
public class StatusTypeV2Stage {
  ...
  public StatusTypeV2Stage() {
  }

  public StatusTypeV2Stage code(String code) {
    this.code = code;
    return this;
  }
  ...
  public StatusTypeV2Stage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StatusTypeV2Stage statusTypeV2Stage = (StatusTypeV2Stage) o;
    return Objects.equals(this.code, statusTypeV2Stage.code) &&
        Objects.equals(this.name, statusTypeV2Stage.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatusTypeV2Stage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatusTypeV2Stage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatusTypeV2Stage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatusTypeV2Stage is not found in the empty JSON string", StatusTypeV2Stage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatusTypeV2Stage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatusTypeV2Stage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatusTypeV2Stage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatusTypeV2Stage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatusTypeV2Stage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatusTypeV2Stage.class));

       return (TypeAdapter<T>) new TypeAdapter<StatusTypeV2Stage>() {
           @Override
           public void write(JsonWriter out, StatusTypeV2Stage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatusTypeV2Stage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatusTypeV2Stage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatusTypeV2Stage
   * @throws IOException if the JSON string is invalid with respect to StatusTypeV2Stage
   */
  public static StatusTypeV2Stage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatusTypeV2Stage.class);
  }

  /**
   * Convert an instance of StatusTypeV2Stage to an JSON string
   *
   * @return JSON string
   */
