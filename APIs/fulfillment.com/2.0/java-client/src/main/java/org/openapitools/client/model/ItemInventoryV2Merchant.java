...
public class ItemInventoryV2Merchant {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public ItemInventoryV2Merchant() {
  }

  public ItemInventoryV2Merchant name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ItemInventoryV2Merchant itemInventoryV2Merchant = (ItemInventoryV2Merchant) o;
    return Objects.equals(this.name, itemInventoryV2Merchant.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ItemInventoryV2Merchant {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemInventoryV2Merchant
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemInventoryV2Merchant.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemInventoryV2Merchant is not found in the empty JSON string", ItemInventoryV2Merchant.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemInventoryV2Merchant.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemInventoryV2Merchant` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemInventoryV2Merchant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemInventoryV2Merchant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemInventoryV2Merchant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemInventoryV2Merchant.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemInventoryV2Merchant>() {
           @Override
           public void write(JsonWriter out, ItemInventoryV2Merchant value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemInventoryV2Merchant read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ItemInventoryV2Merchant given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemInventoryV2Merchant
   * @throws IOException if the JSON string is invalid with respect to ItemInventoryV2Merchant
   */
  public static ItemInventoryV2Merchant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemInventoryV2Merchant.class);
  }

  /**
   * Convert an instance of ItemInventoryV2Merchant to an JSON string
   *
   * @return JSON string
   */
