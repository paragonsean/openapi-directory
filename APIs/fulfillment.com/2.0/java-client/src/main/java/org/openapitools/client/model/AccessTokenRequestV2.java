...
import org.openapitools.client.model.AccessTokenRequestPasswordV2;
import org.openapitools.client.model.AccessTokenRequestRefreshV2;
...
public class AccessTokenRequestV2 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AccessTokenRequestV2.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccessTokenRequestV2.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AccessTokenRequestV2' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AccessTokenRequestPasswordV2> adapterAccessTokenRequestPasswordV2 = gson.getDelegateAdapter(this, TypeToken.get(AccessTokenRequestPasswordV2.class));
            final TypeAdapter<AccessTokenRequestRefreshV2> adapterAccessTokenRequestRefreshV2 = gson.getDelegateAdapter(this, TypeToken.get(AccessTokenRequestRefreshV2.class));

            return (TypeAdapter<T>) new TypeAdapter<AccessTokenRequestV2>() {
                @Override
                public void write(JsonWriter out, AccessTokenRequestV2 value) throws IOException {
                    if (value == null || value.getActualInstance() == null) {
                        elementAdapter.write(out, null);
                        return;
                    }

                    // check if the actual instance is of the type `AccessTokenRequestPasswordV2`
                    if (value.getActualInstance() instanceof AccessTokenRequestPasswordV2) {
                        JsonElement element = adapterAccessTokenRequestPasswordV2.toJsonTree((AccessTokenRequestPasswordV2)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    // check if the actual instance is of the type `AccessTokenRequestRefreshV2`
                    if (value.getActualInstance() instanceof AccessTokenRequestRefreshV2) {
                        JsonElement element = adapterAccessTokenRequestRefreshV2.toJsonTree((AccessTokenRequestRefreshV2)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: AccessTokenRequestPasswordV2, AccessTokenRequestRefreshV2");
                }

                @Override
                public AccessTokenRequestV2 read(JsonReader in) throws IOException {
                    ...
                    // deserialize AccessTokenRequestPasswordV2
                    try {
                        // validate the JSON object to see if any exception is thrown
                        AccessTokenRequestPasswordV2.validateJsonElement(jsonElement);
                        actualAdapter = adapterAccessTokenRequestPasswordV2;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'AccessTokenRequestPasswordV2'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for AccessTokenRequestPasswordV2 failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'AccessTokenRequestPasswordV2'", e);
                    }
                    // deserialize AccessTokenRequestRefreshV2
                    try {
                        // validate the JSON object to see if any exception is thrown
                        AccessTokenRequestRefreshV2.validateJsonElement(jsonElement);
                        actualAdapter = adapterAccessTokenRequestRefreshV2;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'AccessTokenRequestRefreshV2'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for AccessTokenRequestRefreshV2 failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'AccessTokenRequestRefreshV2'", e);
                    }

                    if (match == 1) {
                        AccessTokenRequestV2 ret = new AccessTokenRequestV2();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for AccessTokenRequestV2: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AccessTokenRequestV2() {
        super("oneOf", Boolean.FALSE);
    }

    public AccessTokenRequestV2(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("AccessTokenRequestPasswordV2", AccessTokenRequestPasswordV2.class);
        schemas.put("AccessTokenRequestRefreshV2", AccessTokenRequestRefreshV2.class);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return AccessTokenRequestV2.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * AccessTokenRequestPasswordV2, AccessTokenRequestRefreshV2
     *
     * It could be an instance of the 'oneOf' schemas.
     */
    @Override
    public void setActualInstance(Object instance) {
        if (instance instanceof AccessTokenRequestPasswordV2) {
            super.setActualInstance(instance);
            return;
        }

        if (instance instanceof AccessTokenRequestRefreshV2) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be AccessTokenRequestPasswordV2, AccessTokenRequestRefreshV2");
    }
     ...
     * AccessTokenRequestPasswordV2, AccessTokenRequestRefreshV2
     *
     * @return The actual instance (AccessTokenRequestPasswordV2, AccessTokenRequestRefreshV2)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `AccessTokenRequestPasswordV2`. If the actual instance is not `AccessTokenRequestPasswordV2`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AccessTokenRequestPasswordV2`
     * @throws ClassCastException if the instance is not `AccessTokenRequestPasswordV2`
     */
    public AccessTokenRequestPasswordV2 getAccessTokenRequestPasswordV2() throws ClassCastException {
        return (AccessTokenRequestPasswordV2)super.getActualInstance();
    }
    /**
     * Get the actual instance of `AccessTokenRequestRefreshV2`. If the actual instance is not `AccessTokenRequestRefreshV2`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AccessTokenRequestRefreshV2`
     * @throws ClassCastException if the instance is not `AccessTokenRequestRefreshV2`
     */
    public AccessTokenRequestRefreshV2 getAccessTokenRequestRefreshV2() throws ClassCastException {
        return (AccessTokenRequestRefreshV2)super.getActualInstance();
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to AccessTokenRequestV2
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        // validate oneOf schemas one by one
        int validCount = 0;
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with AccessTokenRequestPasswordV2
        try {
            AccessTokenRequestPasswordV2.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        // validate the json string with AccessTokenRequestRefreshV2
        try {
            AccessTokenRequestRefreshV2.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for AccessTokenRequestV2 with oneOf schemas: AccessTokenRequestPasswordV2, AccessTokenRequestRefreshV2. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of AccessTokenRequestV2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccessTokenRequestV2
     * @throws IOException if the JSON string is invalid with respect to AccessTokenRequestV2
     */
    public static AccessTokenRequestV2 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AccessTokenRequestV2.class);
    }

    /**
     * Convert an instance of AccessTokenRequestV2 to an JSON string
     *
     * @return JSON string
     */
