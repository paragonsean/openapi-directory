...
public class LineItemsResponseV2LineDetails {
  public static final String SERIALIZED_NAME_DESCRIPTION = "description";
  @SerializedName(SERIALIZED_NAME_DESCRIPTION)
  private String description;

  public static final String SERIALIZED_NAME_EXTERNAL_SKU = "externalSku";
  @SerializedName(SERIALIZED_NAME_EXTERNAL_SKU)
  ...
  public LineItemsResponseV2LineDetails() {
  }

  public LineItemsResponseV2LineDetails description(String description) {
  ...
  public LineItemsResponseV2LineDetails externalSku(String externalSku) {
  ...
  public LineItemsResponseV2LineDetails id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public LineItemsResponseV2LineDetails name(String name) {
    this.name = name;
    return this;
  }
  ...
  public LineItemsResponseV2LineDetails totalQuantity(Integer totalQuantity) {
  ...
  public boolean equals(Object o) {
    ...
    LineItemsResponseV2LineDetails lineItemsResponseV2LineDetails = (LineItemsResponseV2LineDetails) o;
    return Objects.equals(this.description, lineItemsResponseV2LineDetails.description) &&
        Objects.equals(this.externalSku, lineItemsResponseV2LineDetails.externalSku) &&
        Objects.equals(this.id, lineItemsResponseV2LineDetails.id) &&
        Objects.equals(this.name, lineItemsResponseV2LineDetails.name) &&
        Objects.equals(this.totalQuantity, lineItemsResponseV2LineDetails.totalQuantity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, externalSku, id, name, totalQuantity);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LineItemsResponseV2LineDetails {\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    externalSku: ").append(toIndentedString(externalSku)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LineItemsResponseV2LineDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LineItemsResponseV2LineDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LineItemsResponseV2LineDetails is not found in the empty JSON string", LineItemsResponseV2LineDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LineItemsResponseV2LineDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LineItemsResponseV2LineDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("externalSku") != null && !jsonObj.get("externalSku").isJsonNull()) && !jsonObj.get("externalSku").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `externalSku` to be a primitive type in the JSON string but got `%s`", jsonObj.get("externalSku").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LineItemsResponseV2LineDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LineItemsResponseV2LineDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LineItemsResponseV2LineDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LineItemsResponseV2LineDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<LineItemsResponseV2LineDetails>() {
           @Override
           public void write(JsonWriter out, LineItemsResponseV2LineDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LineItemsResponseV2LineDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LineItemsResponseV2LineDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LineItemsResponseV2LineDetails
   * @throws IOException if the JSON string is invalid with respect to LineItemsResponseV2LineDetails
   */
  public static LineItemsResponseV2LineDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LineItemsResponseV2LineDetails.class);
  }

  /**
   * Convert an instance of LineItemsResponseV2LineDetails to an JSON string
   *
   * @return JSON string
   */
