...
import org.openapitools.client.model.CarrierHydratedV2;
...
public class OrderResponseHydrateV2AllOfTrackingNumbersInner {
  public static final String SERIALIZED_NAME_CARRIER = "carrier";
  @SerializedName(SERIALIZED_NAME_CARRIER)
  private CarrierHydratedV2 carrier;

  public OrderResponseHydrateV2AllOfTrackingNumbersInner() {
  }

  public OrderResponseHydrateV2AllOfTrackingNumbersInner carrier(CarrierHydratedV2 carrier) {
  ...
  public CarrierHydratedV2 getCarrier() {
    return carrier;
  }

  public void setCarrier(CarrierHydratedV2 carrier) {
    this.carrier = carrier;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrderResponseHydrateV2AllOfTrackingNumbersInner orderResponseHydrateV2AllOfTrackingNumbersInner = (OrderResponseHydrateV2AllOfTrackingNumbersInner) o;
    return Objects.equals(this.carrier, orderResponseHydrateV2AllOfTrackingNumbersInner.carrier);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderResponseHydrateV2AllOfTrackingNumbersInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderResponseHydrateV2AllOfTrackingNumbersInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderResponseHydrateV2AllOfTrackingNumbersInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderResponseHydrateV2AllOfTrackingNumbersInner is not found in the empty JSON string", OrderResponseHydrateV2AllOfTrackingNumbersInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderResponseHydrateV2AllOfTrackingNumbersInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderResponseHydrateV2AllOfTrackingNumbersInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `carrier`
      if (jsonObj.get("carrier") != null && !jsonObj.get("carrier").isJsonNull()) {
        CarrierHydratedV2.validateJsonElement(jsonObj.get("carrier"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderResponseHydrateV2AllOfTrackingNumbersInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderResponseHydrateV2AllOfTrackingNumbersInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderResponseHydrateV2AllOfTrackingNumbersInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderResponseHydrateV2AllOfTrackingNumbersInner.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderResponseHydrateV2AllOfTrackingNumbersInner>() {
           @Override
           public void write(JsonWriter out, OrderResponseHydrateV2AllOfTrackingNumbersInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderResponseHydrateV2AllOfTrackingNumbersInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderResponseHydrateV2AllOfTrackingNumbersInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderResponseHydrateV2AllOfTrackingNumbersInner
   * @throws IOException if the JSON string is invalid with respect to OrderResponseHydrateV2AllOfTrackingNumbersInner
   */
  public static OrderResponseHydrateV2AllOfTrackingNumbersInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderResponseHydrateV2AllOfTrackingNumbersInner.class);
  }

  /**
   * Convert an instance of OrderResponseHydrateV2AllOfTrackingNumbersInner to an JSON string
   *
   * @return JSON string
   */
