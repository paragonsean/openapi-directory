...
import org.openapitools.client.model.AccountingArrayV2;
...
public class AccountingApi {
    ...
    /**
     * Build call for getAccounting
     * @param fromDate Orders invoice date. Date-time in ISO 8601 format for selecting orders after, or at, the specified time (required)
     * @param toDate Orders invoice date. Date-time in ISO 8601 format for selecting orders before, or at, the specified time (required)
     * @param hydrate Adds additional information to the response, uses a CSV format for multiple values. (required)
     * @param page A multiplier of the number of items (limit parameter) to skip before returning results (optional, default to 1)
     * @param limit The numbers of items to return (optional, default to 80)
     * @param warehouseIds A CSV of warehouse id, &#39;123&#39; or &#39;1,2,3&#39; (optional)
     * @param orderIds A CSV of FDC order id, &#39;123&#39; or &#39;1,2,3&#39; (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Accounting </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAccountingCall(String fromDate, String toDate, List<String> hydrate, Integer page, Integer limit, List<Integer> warehouseIds, List<Integer> orderIds, final ApiCallback _callback) throws ApiException {
        ...
        if (warehouseIds != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("csv", "warehouseIds", warehouseIds));
        }
        ...
        if (hydrate != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "hydrate", hydrate));
        }
        ...
        String[] localVarAuthNames = new String[] { "fdcAuth", "fdcAuth" };
        return localVarApiClient.buildCall(basePath, localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAuthNames, _callback);
    }

    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAccountingValidateBeforeCall(String fromDate, String toDate, List<String> hydrate, Integer page, Integer limit, List<Integer> warehouseIds, List<Integer> orderIds, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'fromDate' is set
        if (fromDate == null) {
            throw new ApiException("Missing the required parameter 'fromDate' when calling getAccounting(Async)");
        }

        // verify the required parameter 'toDate' is set
        if (toDate == null) {
            throw new ApiException("Missing the required parameter 'toDate' when calling getAccounting(Async)");
        }

        // verify the required parameter 'hydrate' is set
        if (hydrate == null) {
            throw new ApiException("Missing the required parameter 'hydrate' when calling getAccounting(Async)");
        }

        return getAccountingCall(fromDate, toDate, hydrate, page, limit, warehouseIds, orderIds, _callback);
     ...
     */
    public AccountingArrayV2 getAccounting(String fromDate, String toDate, List<String> hydrate, Integer page, Integer limit, List<Integer> warehouseIds, List<Integer> orderIds) throws ApiException {
        ApiResponse<AccountingArrayV2> localVarResp = getAccountingWithHttpInfo(fromDate, toDate, hydrate, page, limit, warehouseIds, orderIds);
     ...
     * @param warehouseIds A CSV of warehouse id, &#39;123&#39; or &#39;1,2,3&#39; (optional)
     * @param orderIds A CSV of FDC order id, &#39;123&#39; or &#39;1,2,3&#39; (optional)
     * @return ApiResponse&lt;AccountingArrayV2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AccountingArrayV2> getAccountingWithHttpInfo(String fromDate, String toDate, List<String> hydrate, Integer page, Integer limit, List<Integer> warehouseIds, List<Integer> orderIds) throws ApiException {
        okhttp3.Call localVarCall = getAccountingValidateBeforeCall(fromDate, toDate, hydrate, page, limit, warehouseIds, orderIds, null);
        Type localVarReturnType = new TypeToken<AccountingArrayV2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List Order Accounting (asynchronously)
     * Retrieves accounting activity during the queried timespan.
     * @param fromDate Orders invoice date. Date-time in ISO 8601 format for selecting orders after, or at, the specified time (required)
     * @param toDate Orders invoice date. Date-time in ISO 8601 format for selecting orders before, or at, the specified time (required)
     * @param hydrate Adds additional information to the response, uses a CSV format for multiple values. (required)
     ...
     */
    public okhttp3.Call getAccountingAsync(String fromDate, String toDate, List<String> hydrate, Integer page, Integer limit, List<Integer> warehouseIds, List<Integer> orderIds, final ApiCallback<AccountingArrayV2> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountingValidateBeforeCall(fromDate, toDate, hydrate, page, limit, warehouseIds, orderIds, _callback);
        Type localVarReturnType = new TypeToken<AccountingArrayV2>(){}.getType();
