...
public class ItemInventoryV2Quantity {
  public static final String SERIALIZED_NAME_TOTAL = "total";
  @SerializedName(SERIALIZED_NAME_TOTAL)
  private ItemInventoryV2QuantityTotal total;

  public ItemInventoryV2Quantity() {
  }

  public ItemInventoryV2Quantity total(ItemInventoryV2QuantityTotal total) {
    this.total = total;
    return this;
  }
  ...
  public ItemInventoryV2QuantityTotal getTotal() {
    return total;
  }

  public void setTotal(ItemInventoryV2QuantityTotal total) {
    this.total = total;
  }
  ...
  public boolean equals(Object o) {
    ...
    ItemInventoryV2Quantity itemInventoryV2Quantity = (ItemInventoryV2Quantity) o;
    return Objects.equals(this.total, itemInventoryV2Quantity.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class ItemInventoryV2Quantity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemInventoryV2Quantity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemInventoryV2Quantity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemInventoryV2Quantity is not found in the empty JSON string", ItemInventoryV2Quantity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemInventoryV2Quantity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemInventoryV2Quantity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `total`
      if (jsonObj.get("total") != null && !jsonObj.get("total").isJsonNull()) {
        ItemInventoryV2QuantityTotal.validateJsonElement(jsonObj.get("total"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemInventoryV2Quantity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemInventoryV2Quantity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemInventoryV2Quantity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemInventoryV2Quantity.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemInventoryV2Quantity>() {
           @Override
           public void write(JsonWriter out, ItemInventoryV2Quantity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemInventoryV2Quantity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ItemInventoryV2Quantity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemInventoryV2Quantity
   * @throws IOException if the JSON string is invalid with respect to ItemInventoryV2Quantity
   */
  public static ItemInventoryV2Quantity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemInventoryV2Quantity.class);
  }

  /**
   * Convert an instance of ItemInventoryV2Quantity to an JSON string
   *
   * @return JSON string
   */
