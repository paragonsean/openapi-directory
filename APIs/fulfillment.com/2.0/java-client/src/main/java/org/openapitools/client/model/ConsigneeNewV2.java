...
public class ConsigneeNewV2 {
  ...
  public ConsigneeNewV2() {
  }

  public ConsigneeNewV2 address1(String address1) {
  ...
  public ConsigneeNewV2 address2(String address2) {
  ...
  public ConsigneeNewV2 addressLocality(String addressLocality) {
  ...
  public ConsigneeNewV2 addressRegion(String addressRegion) {
  ...
  public ConsigneeNewV2 companyName(String companyName) {
  ...
  public ConsigneeNewV2 country(String country) {
  ...
  public ConsigneeNewV2 email(String email) {
    this.email = email;
    return this;
  }
  ...
  public ConsigneeNewV2 firstName(String firstName) {
  ...
  public ConsigneeNewV2 lastName(String lastName) {
  ...
  public ConsigneeNewV2 phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public ConsigneeNewV2 postalCode(String postalCode) {
  ...
  public boolean equals(Object o) {
    ...
    ConsigneeNewV2 consigneeNewV2 = (ConsigneeNewV2) o;
    return Objects.equals(this.address1, consigneeNewV2.address1) &&
        Objects.equals(this.address2, consigneeNewV2.address2) &&
        Objects.equals(this.addressLocality, consigneeNewV2.addressLocality) &&
        Objects.equals(this.addressRegion, consigneeNewV2.addressRegion) &&
        Objects.equals(this.companyName, consigneeNewV2.companyName) &&
        Objects.equals(this.country, consigneeNewV2.country) &&
        Objects.equals(this.email, consigneeNewV2.email) &&
        Objects.equals(this.firstName, consigneeNewV2.firstName) &&
        Objects.equals(this.lastName, consigneeNewV2.lastName) &&
        Objects.equals(this.phone, consigneeNewV2.phone) &&
        Objects.equals(this.postalCode, consigneeNewV2.postalCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address1, address2, addressLocality, addressRegion, companyName, country, email, firstName, lastName, phone, postalCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsigneeNewV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConsigneeNewV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConsigneeNewV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsigneeNewV2 is not found in the empty JSON string", ConsigneeNewV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConsigneeNewV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConsigneeNewV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConsigneeNewV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsigneeNewV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsigneeNewV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsigneeNewV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsigneeNewV2.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsigneeNewV2>() {
           @Override
           public void write(JsonWriter out, ConsigneeNewV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConsigneeNewV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConsigneeNewV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConsigneeNewV2
   * @throws IOException if the JSON string is invalid with respect to ConsigneeNewV2
   */
  public static ConsigneeNewV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsigneeNewV2.class);
  }

  /**
   * Convert an instance of ConsigneeNewV2 to an JSON string
   *
   * @return JSON string
   */
