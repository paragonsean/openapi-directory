...
import org.openapitools.client.model.LineItemsResponseV2InventoryDetailsInner;
import org.openapitools.client.model.LineItemsResponseV2LineDetails;
import org.openapitools.client.model.LineItemsResponseV2RequestedSkuData;
...
public class LineItemsResponseV2 {
  ...
  private List<LineItemsResponseV2InventoryDetailsInner> inventoryDetails = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINE_DETAILS = "lineDetails";
  @SerializedName(SERIALIZED_NAME_LINE_DETAILS)
  private LineItemsResponseV2LineDetails lineDetails;

  public static final String SERIALIZED_NAME_REQUESTED_SKU_DATA = "requestedSkuData";
  @SerializedName(SERIALIZED_NAME_REQUESTED_SKU_DATA)
  private LineItemsResponseV2RequestedSkuData requestedSkuData;

  public LineItemsResponseV2() {
  }

  public LineItemsResponseV2 id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public LineItemsResponseV2 inventoryDetails(List<LineItemsResponseV2InventoryDetailsInner> inventoryDetails) {
    this.inventoryDetails = inventoryDetails;
    return this;
  }

  public LineItemsResponseV2 addInventoryDetailsItem(LineItemsResponseV2InventoryDetailsInner inventoryDetailsItem) {
    if (this.inventoryDetails == null) {
      this.inventoryDetails = new ArrayList<>();
    }
    this.inventoryDetails.add(inventoryDetailsItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<LineItemsResponseV2InventoryDetailsInner> getInventoryDetails() {
    return inventoryDetails;
  }

  public void setInventoryDetails(List<LineItemsResponseV2InventoryDetailsInner> inventoryDetails) {
    this.inventoryDetails = inventoryDetails;
  }


  public LineItemsResponseV2 lineDetails(LineItemsResponseV2LineDetails lineDetails) {
   ...
   */
  @javax.annotation.Nullable
  public LineItemsResponseV2LineDetails getLineDetails() {
    return lineDetails;
  }

  public void setLineDetails(LineItemsResponseV2LineDetails lineDetails) {
    this.lineDetails = lineDetails;
  }


  public LineItemsResponseV2 requestedSkuData(LineItemsResponseV2RequestedSkuData requestedSkuData) {
    this.requestedSkuData = requestedSkuData;
    return this;
  }

  /**
   * Get requestedSkuData
   * @return requestedSkuData
   */
  @javax.annotation.Nullable
  public LineItemsResponseV2RequestedSkuData getRequestedSkuData() {
    return requestedSkuData;
  }

  public void setRequestedSkuData(LineItemsResponseV2RequestedSkuData requestedSkuData) {
    this.requestedSkuData = requestedSkuData;
  }
  ...
  public boolean equals(Object o) {
    ...
    LineItemsResponseV2 lineItemsResponseV2 = (LineItemsResponseV2) o;
    return Objects.equals(this.id, lineItemsResponseV2.id) &&
        Objects.equals(this.inventoryDetails, lineItemsResponseV2.inventoryDetails) &&
        Objects.equals(this.lineDetails, lineItemsResponseV2.lineDetails) &&
        Objects.equals(this.requestedSkuData, lineItemsResponseV2.requestedSkuData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, inventoryDetails, lineDetails, requestedSkuData);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LineItemsResponseV2 {\n");
    ...
    sb.append("    requestedSkuData: ").append(toIndentedString(requestedSkuData)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("lineDetails");
    openapiFields.add("requestedSkuData");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LineItemsResponseV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LineItemsResponseV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LineItemsResponseV2 is not found in the empty JSON string", LineItemsResponseV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LineItemsResponseV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LineItemsResponseV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("inventoryDetails") != null && !jsonObj.get("inventoryDetails").isJsonNull()) {
        JsonArray jsonArrayinventoryDetails = jsonObj.getAsJsonArray("inventoryDetails");
        if (jsonArrayinventoryDetails != null) {
          // ensure the json data is an array
          if (!jsonObj.get("inventoryDetails").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `inventoryDetails` to be an array in the JSON string but got `%s`", jsonObj.get("inventoryDetails").toString()));
          }

          // validate the optional field `inventoryDetails` (array)
          for (int i = 0; i < jsonArrayinventoryDetails.size(); i++) {
            LineItemsResponseV2InventoryDetailsInner.validateJsonElement(jsonArrayinventoryDetails.get(i));
          };
        }
      }
      // validate the optional field `lineDetails`
      if (jsonObj.get("lineDetails") != null && !jsonObj.get("lineDetails").isJsonNull()) {
        LineItemsResponseV2LineDetails.validateJsonElement(jsonObj.get("lineDetails"));
      }
      // validate the optional field `requestedSkuData`
      if (jsonObj.get("requestedSkuData") != null && !jsonObj.get("requestedSkuData").isJsonNull()) {
        LineItemsResponseV2RequestedSkuData.validateJsonElement(jsonObj.get("requestedSkuData"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LineItemsResponseV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LineItemsResponseV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LineItemsResponseV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LineItemsResponseV2.class));

       return (TypeAdapter<T>) new TypeAdapter<LineItemsResponseV2>() {
           @Override
           public void write(JsonWriter out, LineItemsResponseV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LineItemsResponseV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LineItemsResponseV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LineItemsResponseV2
   * @throws IOException if the JSON string is invalid with respect to LineItemsResponseV2
   */
  public static LineItemsResponseV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LineItemsResponseV2.class);
  }

  /**
   * Convert an instance of LineItemsResponseV2 to an JSON string
   *
   * @return JSON string
   */
