...
public class OrderRequestV2Warehouse {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Integer id;

  public OrderRequestV2Warehouse() {
  }

  public OrderRequestV2Warehouse id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrderRequestV2Warehouse orderRequestV2Warehouse = (OrderRequestV2Warehouse) o;
    return Objects.equals(this.id, orderRequestV2Warehouse.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderRequestV2Warehouse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderRequestV2Warehouse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderRequestV2Warehouse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderRequestV2Warehouse is not found in the empty JSON string", OrderRequestV2Warehouse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderRequestV2Warehouse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderRequestV2Warehouse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderRequestV2Warehouse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderRequestV2Warehouse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderRequestV2Warehouse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderRequestV2Warehouse.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderRequestV2Warehouse>() {
           @Override
           public void write(JsonWriter out, OrderRequestV2Warehouse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderRequestV2Warehouse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderRequestV2Warehouse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderRequestV2Warehouse
   * @throws IOException if the JSON string is invalid with respect to OrderRequestV2Warehouse
   */
  public static OrderRequestV2Warehouse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderRequestV2Warehouse.class);
  }

  /**
   * Convert an instance of OrderRequestV2Warehouse to an JSON string
   *
   * @return JSON string
   */
