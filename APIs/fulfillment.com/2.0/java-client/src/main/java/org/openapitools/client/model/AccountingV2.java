...
import org.openapitools.client.model.AccountingV2Fees;
import org.openapitools.client.model.AccountingV2ItemsInner;
import org.openapitools.client.model.AccountingV2Merchant;
import org.openapitools.client.model.AccountingV2Order;
import org.openapitools.client.model.AccountingV2Warehouse;
...
public class AccountingV2 {
  public static final String SERIALIZED_NAME_FEES = "fees";
  @SerializedName(SERIALIZED_NAME_FEES)
  private AccountingV2Fees fees;
  ...
  private List<AccountingV2ItemsInner> items = new ArrayList<>();

  public static final String SERIALIZED_NAME_MERCHANT = "merchant";
  @SerializedName(SERIALIZED_NAME_MERCHANT)
  private AccountingV2Merchant merchant;

  public static final String SERIALIZED_NAME_ORDER = "order";
  @SerializedName(SERIALIZED_NAME_ORDER)
  private AccountingV2Order order;

  public static final String SERIALIZED_NAME_WAREHOUSE = "warehouse";
  @SerializedName(SERIALIZED_NAME_WAREHOUSE)
  private AccountingV2Warehouse warehouse;

  public AccountingV2() {
  }

  public AccountingV2 fees(AccountingV2Fees fees) {
    this.fees = fees;
    return this;
  }
  ...
  public AccountingV2Fees getFees() {
    return fees;
  }

  public void setFees(AccountingV2Fees fees) {
    this.fees = fees;
  }


  public AccountingV2 itemCount(Integer itemCount) {
  ...
  public AccountingV2 items(List<AccountingV2ItemsInner> items) {
    this.items = items;
    return this;
  }

  public AccountingV2 addItemsItem(AccountingV2ItemsInner itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AccountingV2ItemsInner> getItems() {
    return items;
  }

  public void setItems(List<AccountingV2ItemsInner> items) {
    this.items = items;
  }


  public AccountingV2 merchant(AccountingV2Merchant merchant) {
   ...
   */
  @javax.annotation.Nullable
  public AccountingV2Merchant getMerchant() {
    return merchant;
  }

  public void setMerchant(AccountingV2Merchant merchant) {
    this.merchant = merchant;
  }


  public AccountingV2 order(AccountingV2Order order) {
    this.order = order;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AccountingV2Order getOrder() {
    return order;
  }

  public void setOrder(AccountingV2Order order) {
    this.order = order;
  }


  public AccountingV2 warehouse(AccountingV2Warehouse warehouse) {
   ...
   */
  @javax.annotation.Nullable
  public AccountingV2Warehouse getWarehouse() {
    return warehouse;
  }

  public void setWarehouse(AccountingV2Warehouse warehouse) {
    this.warehouse = warehouse;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccountingV2 accountingV2 = (AccountingV2) o;
    return Objects.equals(this.fees, accountingV2.fees) &&
        Objects.equals(this.itemCount, accountingV2.itemCount) &&
        Objects.equals(this.items, accountingV2.items) &&
        Objects.equals(this.merchant, accountingV2.merchant) &&
        Objects.equals(this.order, accountingV2.order) &&
        Objects.equals(this.warehouse, accountingV2.warehouse);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fees, itemCount, items, merchant, order, warehouse);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccountingV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountingV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountingV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountingV2 is not found in the empty JSON string", AccountingV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountingV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountingV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `fees`
      if (jsonObj.get("fees") != null && !jsonObj.get("fees").isJsonNull()) {
        AccountingV2Fees.validateJsonElement(jsonObj.get("fees"));
      }
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            AccountingV2ItemsInner.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
      // validate the optional field `merchant`
      if (jsonObj.get("merchant") != null && !jsonObj.get("merchant").isJsonNull()) {
        AccountingV2Merchant.validateJsonElement(jsonObj.get("merchant"));
      }
      // validate the optional field `order`
      if (jsonObj.get("order") != null && !jsonObj.get("order").isJsonNull()) {
        AccountingV2Order.validateJsonElement(jsonObj.get("order"));
      }
      // validate the optional field `warehouse`
      if (jsonObj.get("warehouse") != null && !jsonObj.get("warehouse").isJsonNull()) {
        AccountingV2Warehouse.validateJsonElement(jsonObj.get("warehouse"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountingV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountingV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountingV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountingV2.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountingV2>() {
           @Override
           public void write(JsonWriter out, AccountingV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountingV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountingV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountingV2
   * @throws IOException if the JSON string is invalid with respect to AccountingV2
   */
  public static AccountingV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountingV2.class);
  }

  /**
   * Convert an instance of AccountingV2 to an JSON string
   *
   * @return JSON string
   */
