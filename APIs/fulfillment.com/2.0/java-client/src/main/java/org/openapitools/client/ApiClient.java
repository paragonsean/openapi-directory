...
public class ApiClient {
    ...
    private String basePath = "https://api.fulfillment.com/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("fdcAuth", new OAuth());
        authentications.put("fdcAuth", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.fulfillment.com/v2/oauth/access_token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.fulfillment.com/v2
