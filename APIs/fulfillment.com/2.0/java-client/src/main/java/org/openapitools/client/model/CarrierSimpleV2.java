...
public class CarrierSimpleV2 {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Integer id;

  public CarrierSimpleV2() {
  }

  public CarrierSimpleV2 id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CarrierSimpleV2 carrierSimpleV2 = (CarrierSimpleV2) o;
    return Objects.equals(this.id, carrierSimpleV2.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class CarrierSimpleV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CarrierSimpleV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CarrierSimpleV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CarrierSimpleV2 is not found in the empty JSON string", CarrierSimpleV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CarrierSimpleV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CarrierSimpleV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CarrierSimpleV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CarrierSimpleV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CarrierSimpleV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CarrierSimpleV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CarrierSimpleV2.class));

       return (TypeAdapter<T>) new TypeAdapter<CarrierSimpleV2>() {
           @Override
           public void write(JsonWriter out, CarrierSimpleV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CarrierSimpleV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CarrierSimpleV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CarrierSimpleV2
   * @throws IOException if the JSON string is invalid with respect to CarrierSimpleV2
   */
  public static CarrierSimpleV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CarrierSimpleV2.class);
  }

  /**
   * Convert an instance of CarrierSimpleV2 to an JSON string
   *
   * @return JSON string
   */
