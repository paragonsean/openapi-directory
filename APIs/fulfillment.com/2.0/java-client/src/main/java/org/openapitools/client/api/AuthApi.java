...
import org.openapitools.client.model.AccessTokenRequestV2;
import org.openapitools.client.model.AccessTokenResponseV2;
...
public class AuthApi {
     ...
     * @param body Get an access token (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Authorized </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
     </table>
     * More Information on Refresh Tokens
     * @see <a href="#section/Getting-Started/Perpetuating-Access">Generate an Access Token Documentation</a>
     */
    public okhttp3.Call postOauthAccessTokenCall(AccessTokenRequestV2 body, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call postOauthAccessTokenValidateBeforeCall(AccessTokenRequestV2 body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling postOauthAccessToken(Async)");
        }

        return postOauthAccessTokenCall(body, _callback);
     ...
     * @see <a href="#section/Getting-Started/Perpetuating-Access">Generate an Access Token Documentation</a>
     */
    public AccessTokenResponseV2 postOauthAccessToken(AccessTokenRequestV2 body) throws ApiException {
        ApiResponse<AccessTokenResponseV2> localVarResp = postOauthAccessTokenWithHttpInfo(body);
     ...
     * By default tokens are valid for 7 days while refresh tokens are valid for 30 days. If your &#x60;grant_type&#x60; is \&quot;password\&quot; include the &#x60;username&#x60; and &#x60;password&#x60;, if however your &#x60;grant_type&#x60; is \&quot;refresh_token\&quot; the username/password are not required, instead set the &#x60;refresh_token&#x60;
     * @param body Get an access token (required)
     * @return ApiResponse&lt;AccessTokenResponseV2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="#section/Getting-Started/Perpetuating-Access">Generate an Access Token Documentation</a>
     */
    public ApiResponse<AccessTokenResponseV2> postOauthAccessTokenWithHttpInfo(AccessTokenRequestV2 body) throws ApiException {
        okhttp3.Call localVarCall = postOauthAccessTokenValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<AccessTokenResponseV2>(){}.getType();
     ...
     * @see <a href="#section/Getting-Started/Perpetuating-Access">Generate an Access Token Documentation</a>
     */
    public okhttp3.Call postOauthAccessTokenAsync(AccessTokenRequestV2 body, final ApiCallback<AccessTokenResponseV2> _callback) throws ApiException {

        okhttp3.Call localVarCall = postOauthAccessTokenValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<AccessTokenResponseV2>(){}.getType();
