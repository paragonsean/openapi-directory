...
import org.openapitools.client.model.ItemInventoryV2Item;
import org.openapitools.client.model.ItemInventoryV2Merchant;
import org.openapitools.client.model.ItemInventoryV2Quantity;
...
public class ItemInventoryV2 {
  public static final String SERIALIZED_NAME_ITEM = "item";
  @SerializedName(SERIALIZED_NAME_ITEM)
  private ItemInventoryV2Item item;

  public static final String SERIALIZED_NAME_MERCHANT = "merchant";
  @SerializedName(SERIALIZED_NAME_MERCHANT)
  private ItemInventoryV2Merchant merchant;

  public static final String SERIALIZED_NAME_QUANTITY = "quantity";
  @SerializedName(SERIALIZED_NAME_QUANTITY)
  private ItemInventoryV2Quantity quantity;

  public ItemInventoryV2() {
  }

  public ItemInventoryV2 item(ItemInventoryV2Item item) {
    this.item = item;
    return this;
  }
  ...
  public ItemInventoryV2Item getItem() {
    return item;
  }

  public void setItem(ItemInventoryV2Item item) {
    this.item = item;
  }


  public ItemInventoryV2 merchant(ItemInventoryV2Merchant merchant) {
   ...
   */
  @javax.annotation.Nullable
  public ItemInventoryV2Merchant getMerchant() {
    return merchant;
  }

  public void setMerchant(ItemInventoryV2Merchant merchant) {
    this.merchant = merchant;
  }


  public ItemInventoryV2 quantity(ItemInventoryV2Quantity quantity) {
   ...
   */
  @javax.annotation.Nullable
  public ItemInventoryV2Quantity getQuantity() {
    return quantity;
  }

  public void setQuantity(ItemInventoryV2Quantity quantity) {
    this.quantity = quantity;
  }
  ...
  public boolean equals(Object o) {
    ...
    ItemInventoryV2 itemInventoryV2 = (ItemInventoryV2) o;
    return Objects.equals(this.item, itemInventoryV2.item) &&
        Objects.equals(this.merchant, itemInventoryV2.merchant) &&
        Objects.equals(this.quantity, itemInventoryV2.quantity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(item, merchant, quantity);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ItemInventoryV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemInventoryV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemInventoryV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemInventoryV2 is not found in the empty JSON string", ItemInventoryV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemInventoryV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemInventoryV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `item`
      if (jsonObj.get("item") != null && !jsonObj.get("item").isJsonNull()) {
        ItemInventoryV2Item.validateJsonElement(jsonObj.get("item"));
      }
      // validate the optional field `merchant`
      if (jsonObj.get("merchant") != null && !jsonObj.get("merchant").isJsonNull()) {
        ItemInventoryV2Merchant.validateJsonElement(jsonObj.get("merchant"));
      }
      // validate the optional field `quantity`
      if (jsonObj.get("quantity") != null && !jsonObj.get("quantity").isJsonNull()) {
        ItemInventoryV2Quantity.validateJsonElement(jsonObj.get("quantity"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemInventoryV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemInventoryV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemInventoryV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemInventoryV2.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemInventoryV2>() {
           @Override
           public void write(JsonWriter out, ItemInventoryV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemInventoryV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ItemInventoryV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemInventoryV2
   * @throws IOException if the JSON string is invalid with respect to ItemInventoryV2
   */
  public static ItemInventoryV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemInventoryV2.class);
  }

  /**
   * Convert an instance of ItemInventoryV2 to an JSON string
   *
   * @return JSON string
   */
