...
import org.openapitools.client.model.RmaRequestV2ItemsInner;
...
public class RmaRequestV2 {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<RmaRequestV2ItemsInner> items = new ArrayList<>();
  ...
  public RmaRequestV2 items(List<RmaRequestV2ItemsInner> items) {
    this.items = items;
    return this;
  }

  public RmaRequestV2 addItemsItem(RmaRequestV2ItemsInner itemsItem) {
    if (this.items == null) {
  ...
  public List<RmaRequestV2ItemsInner> getItems() {
    return items;
  }

  public void setItems(List<RmaRequestV2ItemsInner> items) {
    this.items = items;
  }


  public RmaRequestV2 merchantOrderId(String merchantOrderId) {
  ...
  public RmaRequestV2 recipient(Object recipient) {
  ...
  public RmaRequestV2 rmaNumber(String rmaNumber) {
  ...
  public boolean equals(Object o) {
    ...
    RmaRequestV2 rmaRequestV2 = (RmaRequestV2) o;
    return Objects.equals(this.items, rmaRequestV2.items) &&
        Objects.equals(this.merchantOrderId, rmaRequestV2.merchantOrderId) &&
        Objects.equals(this.recipient, rmaRequestV2.recipient) &&
        Objects.equals(this.rmaNumber, rmaRequestV2.rmaNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(items, merchantOrderId, recipient, rmaNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RmaRequestV2 {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("rmaNumber");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RmaRequestV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RmaRequestV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RmaRequestV2 is not found in the empty JSON string", RmaRequestV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RmaRequestV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RmaRequestV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RmaRequestV2.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        RmaRequestV2ItemsInner.validateJsonElement(jsonArrayitems.get(i));
      };
      ...
      if (!jsonObj.get("rmaNumber").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RmaRequestV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RmaRequestV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RmaRequestV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RmaRequestV2.class));

       return (TypeAdapter<T>) new TypeAdapter<RmaRequestV2>() {
           @Override
           public void write(JsonWriter out, RmaRequestV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RmaRequestV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RmaRequestV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RmaRequestV2
   * @throws IOException if the JSON string is invalid with respect to RmaRequestV2
   */
  public static RmaRequestV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RmaRequestV2.class);
  }

  /**
   * Convert an instance of RmaRequestV2 to an JSON string
   *
   * @return JSON string
   */
