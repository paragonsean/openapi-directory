...
public class Geometry {
  ...
  private GeometryCoordinates coordinates;
  ...
  public Geometry coordinates(GeometryCoordinates coordinates) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      GeometryCoordinates.validateJsonElement(jsonObj.get("coordinates"));
