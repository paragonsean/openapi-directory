...
public class RmaRequestV2ItemsInner {
  ...
  public RmaRequestV2ItemsInner() {
  }

  public RmaRequestV2ItemsInner quantityExpected(Integer quantityExpected) {
  ...
  public RmaRequestV2ItemsInner sku(String sku) {
    this.sku = sku;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RmaRequestV2ItemsInner rmaRequestV2ItemsInner = (RmaRequestV2ItemsInner) o;
    return Objects.equals(this.quantityExpected, rmaRequestV2ItemsInner.quantityExpected) &&
        Objects.equals(this.sku, rmaRequestV2ItemsInner.sku);
  }

  @Override
  public int hashCode() {
    return Objects.hash(quantityExpected, sku);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RmaRequestV2ItemsInner {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("quantityExpected");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RmaRequestV2ItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RmaRequestV2ItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RmaRequestV2ItemsInner is not found in the empty JSON string", RmaRequestV2ItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RmaRequestV2ItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RmaRequestV2ItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RmaRequestV2ItemsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RmaRequestV2ItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RmaRequestV2ItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RmaRequestV2ItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RmaRequestV2ItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<RmaRequestV2ItemsInner>() {
           @Override
           public void write(JsonWriter out, RmaRequestV2ItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RmaRequestV2ItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RmaRequestV2ItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RmaRequestV2ItemsInner
   * @throws IOException if the JSON string is invalid with respect to RmaRequestV2ItemsInner
   */
  public static RmaRequestV2ItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RmaRequestV2ItemsInner.class);
  }

  /**
   * Convert an instance of RmaRequestV2ItemsInner to an JSON string
   *
   * @return JSON string
   */
