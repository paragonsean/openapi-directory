...
import org.openapitools.client.model.StatusTypeV2;
...
public class StatusEventV2 {
  ...
  private StatusTypeV2 status;

  public StatusEventV2() {
  }

  public StatusEventV2 createdBy(Object createdBy) {
  ...
  public StatusEventV2 date(OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public StatusEventV2 id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public StatusEventV2 reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public StatusEventV2 status(StatusTypeV2 status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(StatusTypeV2 status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    StatusEventV2 statusEventV2 = (StatusEventV2) o;
    return Objects.equals(this.createdBy, statusEventV2.createdBy) &&
        Objects.equals(this.date, statusEventV2.date) &&
        Objects.equals(this.id, statusEventV2.id) &&
        Objects.equals(this.reason, statusEventV2.reason) &&
        Objects.equals(this.status, statusEventV2.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdBy, date, id, reason, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatusEventV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatusEventV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatusEventV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatusEventV2 is not found in the empty JSON string", StatusEventV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatusEventV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatusEventV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatusEventV2.openapiRequiredFields) {
      ...
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        StatusTypeV2.validateJsonElement(jsonObj.get("status"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatusEventV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatusEventV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatusEventV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatusEventV2.class));

       return (TypeAdapter<T>) new TypeAdapter<StatusEventV2>() {
           @Override
           public void write(JsonWriter out, StatusEventV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatusEventV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatusEventV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatusEventV2
   * @throws IOException if the JSON string is invalid with respect to StatusEventV2
   */
  public static StatusEventV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatusEventV2.class);
  }

  /**
   * Convert an instance of StatusEventV2 to an JSON string
   *
   * @return JSON string
   */
