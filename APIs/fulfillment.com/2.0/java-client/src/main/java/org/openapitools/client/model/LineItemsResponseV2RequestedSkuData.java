...
public class LineItemsResponseV2RequestedSkuData {
  ...
  public LineItemsResponseV2RequestedSkuData() {
  }

  public LineItemsResponseV2RequestedSkuData declaredValue(String declaredValue) {
  ...
  public LineItemsResponseV2RequestedSkuData id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public LineItemsResponseV2RequestedSkuData quantity(Integer quantity) {
  ...
  public LineItemsResponseV2RequestedSkuData sku(String sku) {
    this.sku = sku;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LineItemsResponseV2RequestedSkuData lineItemsResponseV2RequestedSkuData = (LineItemsResponseV2RequestedSkuData) o;
    return Objects.equals(this.declaredValue, lineItemsResponseV2RequestedSkuData.declaredValue) &&
        Objects.equals(this.id, lineItemsResponseV2RequestedSkuData.id) &&
        Objects.equals(this.quantity, lineItemsResponseV2RequestedSkuData.quantity) &&
        Objects.equals(this.sku, lineItemsResponseV2RequestedSkuData.sku);
  }

  @Override
  public int hashCode() {
    return Objects.hash(declaredValue, id, quantity, sku);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LineItemsResponseV2RequestedSkuData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LineItemsResponseV2RequestedSkuData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LineItemsResponseV2RequestedSkuData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LineItemsResponseV2RequestedSkuData is not found in the empty JSON string", LineItemsResponseV2RequestedSkuData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LineItemsResponseV2RequestedSkuData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LineItemsResponseV2RequestedSkuData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("declaredValue") != null && !jsonObj.get("declaredValue").isJsonNull()) && !jsonObj.get("declaredValue").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LineItemsResponseV2RequestedSkuData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LineItemsResponseV2RequestedSkuData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LineItemsResponseV2RequestedSkuData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LineItemsResponseV2RequestedSkuData.class));

       return (TypeAdapter<T>) new TypeAdapter<LineItemsResponseV2RequestedSkuData>() {
           @Override
           public void write(JsonWriter out, LineItemsResponseV2RequestedSkuData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LineItemsResponseV2RequestedSkuData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LineItemsResponseV2RequestedSkuData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LineItemsResponseV2RequestedSkuData
   * @throws IOException if the JSON string is invalid with respect to LineItemsResponseV2RequestedSkuData
   */
  public static LineItemsResponseV2RequestedSkuData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LineItemsResponseV2RequestedSkuData.class);
  }

  /**
   * Convert an instance of LineItemsResponseV2RequestedSkuData to an JSON string
   *
   * @return JSON string
   */
