...
public class AccountingV2Fees {
  ...
  private Float fulfillment;

  public static final String SERIALIZED_NAME_INSERT = "insert";
  @SerializedName(SERIALIZED_NAME_INSERT)
  private Float insert;

  public static final String SERIALIZED_NAME_KITTING = "kitting";
  @SerializedName(SERIALIZED_NAME_KITTING)
  private Float kitting;

  public static final String SERIALIZED_NAME_PICKING = "picking";
  @SerializedName(SERIALIZED_NAME_PICKING)
  private Float picking;

  public static final String SERIALIZED_NAME_POSTAGE = "postage";
  @SerializedName(SERIALIZED_NAME_POSTAGE)
  ...
  public AccountingV2Fees() {
  }

  public AccountingV2Fees box(Float box) {
    this.box = box;
    return this;
  }
  ...
  public AccountingV2Fees envelope(Float envelope) {
  ...
  public AccountingV2Fees fulfillment(Float fulfillment) {
  ...
  public void setFulfillment(Float fulfillment) {
    this.fulfillment = fulfillment;
  }


  public AccountingV2Fees insert(Float insert) {
    this.insert = insert;
    return this;
  }
  ...
  public void setInsert(Float insert) {
    this.insert = insert;
  }


  public AccountingV2Fees kitting(Float kitting) {
   ...
   */
  @javax.annotation.Nullable
  public Float getKitting() {
    return kitting;
  }

  public void setKitting(Float kitting) {
    this.kitting = kitting;
  }


  public AccountingV2Fees picking(Float picking) {
  ...
  public AccountingV2Fees postage(Float postage) {
  ...
  public AccountingV2Fees print(Float print) {
    this.print = print;
    return this;
  }
  ...
  public void setPrint(Float print) {
    this.print = print;
  }


  public AccountingV2Fees total(Float total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccountingV2Fees accountingV2Fees = (AccountingV2Fees) o;
    return Objects.equals(this.box, accountingV2Fees.box) &&
        Objects.equals(this.envelope, accountingV2Fees.envelope) &&
        Objects.equals(this.fulfillment, accountingV2Fees.fulfillment) &&
        Objects.equals(this.insert, accountingV2Fees.insert) &&
        Objects.equals(this.kitting, accountingV2Fees.kitting) &&
        Objects.equals(this.picking, accountingV2Fees.picking) &&
        Objects.equals(this.postage, accountingV2Fees.postage) &&
        Objects.equals(this.print, accountingV2Fees.print) &&
        Objects.equals(this.total, accountingV2Fees.total);
  }

  @Override
  public int hashCode() {
    return Objects.hash(box, envelope, fulfillment, insert, kitting, picking, postage, print, total);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccountingV2Fees {\n");
    ...
    sb.append("    kitting: ").append(toIndentedString(kitting)).append("\n");
  ...
  static {
    ...
    openapiFields.add("kitting");
    openapiFields.add("picking");
    openapiFields.add("postage");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountingV2Fees
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountingV2Fees.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountingV2Fees is not found in the empty JSON string", AccountingV2Fees.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountingV2Fees.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountingV2Fees` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountingV2Fees.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountingV2Fees' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountingV2Fees> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountingV2Fees.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountingV2Fees>() {
           @Override
           public void write(JsonWriter out, AccountingV2Fees value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountingV2Fees read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountingV2Fees given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountingV2Fees
   * @throws IOException if the JSON string is invalid with respect to AccountingV2Fees
   */
  public static AccountingV2Fees fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountingV2Fees.class);
  }

  /**
   * Convert an instance of AccountingV2Fees to an JSON string
   *
   * @return JSON string
   */
