...
public class AccountingV2Warehouse {
  ...
  public AccountingV2Warehouse() {
  }

  public AccountingV2Warehouse id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public AccountingV2Warehouse shortName(String shortName) {
  ...
  public boolean equals(Object o) {
    ...
    AccountingV2Warehouse accountingV2Warehouse = (AccountingV2Warehouse) o;
    return Objects.equals(this.id, accountingV2Warehouse.id) &&
        Objects.equals(this.shortName, accountingV2Warehouse.shortName);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountingV2Warehouse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountingV2Warehouse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountingV2Warehouse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountingV2Warehouse is not found in the empty JSON string", AccountingV2Warehouse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountingV2Warehouse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountingV2Warehouse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountingV2Warehouse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountingV2Warehouse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountingV2Warehouse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountingV2Warehouse.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountingV2Warehouse>() {
           @Override
           public void write(JsonWriter out, AccountingV2Warehouse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountingV2Warehouse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountingV2Warehouse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountingV2Warehouse
   * @throws IOException if the JSON string is invalid with respect to AccountingV2Warehouse
   */
  public static AccountingV2Warehouse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountingV2Warehouse.class);
  }

  /**
   * Convert an instance of AccountingV2Warehouse to an JSON string
   *
   * @return JSON string
   */
