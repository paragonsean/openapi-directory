...
public class PaginationV2 {
  ...
  public PaginationV2 count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PaginationV2 currentPage(Integer currentPage) {
  ...
  public PaginationV2 total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  public PaginationV2 totalPages(Integer totalPages) {
  ...
  public boolean equals(Object o) {
    ...
    PaginationV2 paginationV2 = (PaginationV2) o;
    return Objects.equals(this.count, paginationV2.count) &&
        Objects.equals(this.currentPage, paginationV2.currentPage) &&
        Objects.equals(this.total, paginationV2.total) &&
        Objects.equals(this.totalPages, paginationV2.totalPages);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, currentPage, total, totalPages);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaginationV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaginationV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaginationV2 is not found in the empty JSON string", PaginationV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaginationV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginationV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaginationV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaginationV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaginationV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaginationV2.class));

       return (TypeAdapter<T>) new TypeAdapter<PaginationV2>() {
           @Override
           public void write(JsonWriter out, PaginationV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaginationV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaginationV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaginationV2
   * @throws IOException if the JSON string is invalid with respect to PaginationV2
   */
  public static PaginationV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaginationV2.class);
  }

  /**
   * Convert an instance of PaginationV2 to an JSON string
   *
   * @return JSON string
   */
