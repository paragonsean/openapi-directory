...
public class LineItemsResponseV2InventoryDetailsInner {
  public static final String SERIALIZED_NAME_EXPIRATION_DATE = "expirationDate";
  @SerializedName(SERIALIZED_NAME_EXPIRATION_DATE)
  private LocalDate expirationDate;

  public static final String SERIALIZED_NAME_LOT_NUM = "lotNum";
  @SerializedName(SERIALIZED_NAME_LOT_NUM)
  ...
  public static final String SERIALIZED_NAME_SERIAL_NUM = "serialNum";
  @SerializedName(SERIALIZED_NAME_SERIAL_NUM)
  private String serialNum;

  public LineItemsResponseV2InventoryDetailsInner() {
  }

  public LineItemsResponseV2InventoryDetailsInner expirationDate(LocalDate expirationDate) {
  ...
  public LineItemsResponseV2InventoryDetailsInner lotNum(String lotNum) {
    this.lotNum = lotNum;
    return this;
  }
  ...
  public LineItemsResponseV2InventoryDetailsInner quantity(Integer quantity) {
  ...
  public LineItemsResponseV2InventoryDetailsInner serialNum(String serialNum) {
  ...
  public boolean equals(Object o) {
    ...
    LineItemsResponseV2InventoryDetailsInner lineItemsResponseV2InventoryDetailsInner = (LineItemsResponseV2InventoryDetailsInner) o;
    return Objects.equals(this.expirationDate, lineItemsResponseV2InventoryDetailsInner.expirationDate) &&
        Objects.equals(this.lotNum, lineItemsResponseV2InventoryDetailsInner.lotNum) &&
        Objects.equals(this.quantity, lineItemsResponseV2InventoryDetailsInner.quantity) &&
        Objects.equals(this.serialNum, lineItemsResponseV2InventoryDetailsInner.serialNum);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expirationDate, lotNum, quantity, serialNum);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LineItemsResponseV2InventoryDetailsInner {\n");
    sb.append("    expirationDate: ").append(toIndentedString(expirationDate)).append("\n");
    sb.append("    lotNum: ").append(toIndentedString(lotNum)).append("\n");
  ...
  static {
    ...
    openapiFields.add("lotNum");
    openapiFields.add("quantity");
    openapiFields.add("serialNum");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LineItemsResponseV2InventoryDetailsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LineItemsResponseV2InventoryDetailsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LineItemsResponseV2InventoryDetailsInner is not found in the empty JSON string", LineItemsResponseV2InventoryDetailsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LineItemsResponseV2InventoryDetailsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LineItemsResponseV2InventoryDetailsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("lotNum") != null && !jsonObj.get("lotNum").isJsonNull()) && !jsonObj.get("lotNum").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `lotNum` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lotNum").toString()));
      }
      if ((jsonObj.get("serialNum") != null && !jsonObj.get("serialNum").isJsonNull()) && !jsonObj.get("serialNum").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `serialNum` to be a primitive type in the JSON string but got `%s`", jsonObj.get("serialNum").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LineItemsResponseV2InventoryDetailsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LineItemsResponseV2InventoryDetailsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LineItemsResponseV2InventoryDetailsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LineItemsResponseV2InventoryDetailsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<LineItemsResponseV2InventoryDetailsInner>() {
           @Override
           public void write(JsonWriter out, LineItemsResponseV2InventoryDetailsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LineItemsResponseV2InventoryDetailsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LineItemsResponseV2InventoryDetailsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LineItemsResponseV2InventoryDetailsInner
   * @throws IOException if the JSON string is invalid with respect to LineItemsResponseV2InventoryDetailsInner
   */
  public static LineItemsResponseV2InventoryDetailsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LineItemsResponseV2InventoryDetailsInner.class);
  }

  /**
   * Convert an instance of LineItemsResponseV2InventoryDetailsInner to an JSON string
   *
   * @return JSON string
   */
