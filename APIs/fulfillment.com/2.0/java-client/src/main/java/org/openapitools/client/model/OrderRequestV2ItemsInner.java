...
public class OrderRequestV2ItemsInner {
  ...
  public OrderRequestV2ItemsInner() {
  }

  public OrderRequestV2ItemsInner declaredValue(Double declaredValue) {
  ...
  public OrderRequestV2ItemsInner quantity(Integer quantity) {
  ...
  public OrderRequestV2ItemsInner sku(String sku) {
    this.sku = sku;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrderRequestV2ItemsInner orderRequestV2ItemsInner = (OrderRequestV2ItemsInner) o;
    return Objects.equals(this.declaredValue, orderRequestV2ItemsInner.declaredValue) &&
        Objects.equals(this.quantity, orderRequestV2ItemsInner.quantity) &&
        Objects.equals(this.sku, orderRequestV2ItemsInner.sku);
  }

  @Override
  public int hashCode() {
    return Objects.hash(declaredValue, quantity, sku);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderRequestV2ItemsInner {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("declaredValue");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderRequestV2ItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderRequestV2ItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderRequestV2ItemsInner is not found in the empty JSON string", OrderRequestV2ItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderRequestV2ItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderRequestV2ItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderRequestV2ItemsInner.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("declaredValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `declaredValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("declaredValue").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderRequestV2ItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderRequestV2ItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderRequestV2ItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderRequestV2ItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderRequestV2ItemsInner>() {
           @Override
           public void write(JsonWriter out, OrderRequestV2ItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderRequestV2ItemsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderRequestV2ItemsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderRequestV2ItemsInner
   * @throws IOException if the JSON string is invalid with respect to OrderRequestV2ItemsInner
   */
  public static OrderRequestV2ItemsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderRequestV2ItemsInner.class);
  }

  /**
   * Convert an instance of OrderRequestV2ItemsInner to an JSON string
   *
   * @return JSON string
   */
