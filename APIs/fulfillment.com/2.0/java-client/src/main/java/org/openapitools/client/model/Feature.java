...
public class Feature {
  ...
  public static final String SERIALIZED_NAME_CENTERLINE = "centerline";
  @SerializedName(SERIALIZED_NAME_CENTERLINE)
  private Object centerline = null;
  ...
  public Feature bbox(List<Object> bbox) {
    this.bbox = bbox;
    return this;
  }

  public Feature addBboxItem(Object bboxItem) {
    if (this.bbox == null) {
  ...
  public Feature centerline(Object centerline) {
   ...
   */
  @javax.annotation.Nullable
  public Object getCenterline() {
    return centerline;
  }

  public void setCenterline(Object centerline) {
    this.centerline = centerline;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bbox, feature.bbox) &&
        Objects.equals(this.centerline, feature.centerline) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bbox, centerline, geometry, id, properties, title, type);
  }
  ...
  public String toString() {
    ...
    sb.append("    centerline: ").append(toIndentedString(centerline)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      FeatureProperties.validateJsonElement(jsonObj.get("properties"));
