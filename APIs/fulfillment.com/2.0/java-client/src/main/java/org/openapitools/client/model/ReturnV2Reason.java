...
public class ReturnV2Reason {
  ...
  public ReturnV2Reason() {
  }

  public ReturnV2Reason id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ReturnV2Reason title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ReturnV2Reason returnV2Reason = (ReturnV2Reason) o;
    return Objects.equals(this.id, returnV2Reason.id) &&
        Objects.equals(this.title, returnV2Reason.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReturnV2Reason {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReturnV2Reason
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReturnV2Reason.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReturnV2Reason is not found in the empty JSON string", ReturnV2Reason.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReturnV2Reason.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReturnV2Reason` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReturnV2Reason.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReturnV2Reason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReturnV2Reason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReturnV2Reason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReturnV2Reason.class));

       return (TypeAdapter<T>) new TypeAdapter<ReturnV2Reason>() {
           @Override
           public void write(JsonWriter out, ReturnV2Reason value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReturnV2Reason read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReturnV2Reason given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReturnV2Reason
   * @throws IOException if the JSON string is invalid with respect to ReturnV2Reason
   */
  public static ReturnV2Reason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReturnV2Reason.class);
  }

  /**
   * Convert an instance of ReturnV2Reason to an JSON string
   *
   * @return JSON string
   */
