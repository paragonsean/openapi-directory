...
public class ReturnsArrayV2 {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ReturnV2> data = new ArrayList<>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private AccountingArrayV2Meta meta;

  public ReturnsArrayV2() {
  }

  public ReturnsArrayV2 data(List<ReturnV2> data) {
    this.data = data;
    return this;
  }

  public ReturnsArrayV2 addDataItem(ReturnV2 dataItem) {
    if (this.data == null) {
  ...
  public List<ReturnV2> getData() {
    return data;
  }

  public void setData(List<ReturnV2> data) {
    this.data = data;
  }


  public ReturnsArrayV2 meta(AccountingArrayV2Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ReturnsArrayV2 returnsArrayV2 = (ReturnsArrayV2) o;
    return Objects.equals(this.data, returnsArrayV2.data) &&
        Objects.equals(this.meta, returnsArrayV2.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReturnsArrayV2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReturnsArrayV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReturnsArrayV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReturnsArrayV2 is not found in the empty JSON string", ReturnsArrayV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReturnsArrayV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReturnsArrayV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ReturnV2.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReturnsArrayV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReturnsArrayV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReturnsArrayV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReturnsArrayV2.class));

       return (TypeAdapter<T>) new TypeAdapter<ReturnsArrayV2>() {
           @Override
           public void write(JsonWriter out, ReturnsArrayV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReturnsArrayV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReturnsArrayV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReturnsArrayV2
   * @throws IOException if the JSON string is invalid with respect to ReturnsArrayV2
   */
  public static ReturnsArrayV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReturnsArrayV2.class);
  }

  /**
   * Convert an instance of ReturnsArrayV2 to an JSON string
   *
   * @return JSON string
   */
