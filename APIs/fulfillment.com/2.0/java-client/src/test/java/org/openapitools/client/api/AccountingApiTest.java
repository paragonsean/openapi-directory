...
public class AccountingApiTest {
     ...
     */
    @Test
    public void getAccountingTest() throws ApiException {
        String fromDate = null;
        String toDate = null;
        List<String> hydrate = null;
        Integer page = null;
        Integer limit = null;
        List<Integer> warehouseIds = null;
        List<Integer> orderIds = null;
        AccountingArrayV2 response = api.getAccounting(fromDate, toDate, hydrate, page, limit, warehouseIds, orderIds);
