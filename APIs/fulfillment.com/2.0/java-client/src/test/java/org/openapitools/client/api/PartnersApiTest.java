...
public class PartnersApiTest {
     ...
     */
    @Test
    public void putOrdersIdShipTest() throws ApiException {
        Integer id = null;
        OrderShipV2 body = null;
        Object response = api.putOrdersIdShip(id, body);
     ...
     */
    @Test
    public void putOrdersIdStatusTest() throws ApiException {
        Integer id = null;
        StatusTypeSimpleV2 body = null;
        Object response = api.putOrdersIdStatus(id, body);
        // TODO: test validations
    }
