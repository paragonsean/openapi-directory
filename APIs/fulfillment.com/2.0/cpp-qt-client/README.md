...
#include <iostream>
#include "../client/OAIAccountingApi.h"
...
void Example::exampleFunction1(){
     OAIAccountingApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAccountingApi::getAccountingSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAccountingApi::getAccountingSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString from_date = create(); // QString | Orders invoice date. Date-time in ISO 8601 format for selecting orders after, or at, the specified time
      ...
      QString to_date = create(); // QString | Orders invoice date. Date-time in ISO 8601 format for selecting orders before, or at, the specified time
      ...
      QList<QString> hydrate = create(); // QList<QString> | Adds additional information to the response, uses a CSV format for multiple values.
      ...
      qint32 page = create(); // qint32 | A multiplier of the number of items (limit parameter) to skip before returning results
      ...
      qint32 limit = create(); // qint32 | The numbers of items to return
      ...
      QList<qint32> warehouse_ids = create(); // QList<qint32> | A CSV of warehouse id, '123' or '1,2,3'
      ...
      QList<qint32> order_ids = create(); // QList<qint32> | A CSV of FDC order id, '123' or '1,2,3'
      apiInstance.getAccounting(from_dateto_datehydratepagelimitwarehouse_idsorder_ids);
