...
#ifndef OAIStatusEvent_v2_H
#define OAIStatusEvent_v2_H
...
namespace OpenAPI {
class OAIStatusType_v2;

class OAIStatusEvent_v2 : public OAIObject {
public:
    OAIStatusEvent_v2();
    OAIStatusEvent_v2(QString json);
    ~OAIStatusEvent_v2() override;
    ...
    OAIStatusType_v2 getStatus() const;
    void setStatus(const OAIStatusType_v2 &status);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusEvent_v2)

#endif // OAIStatusEvent_v2_H
