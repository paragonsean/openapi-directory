...
OAIOrderRequest_v2_items_inner::OAIOrderRequest_v2_items_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderRequest_v2_items_inner::OAIOrderRequest_v2_items_inner() {
    this->initializeModel();
}

OAIOrderRequest_v2_items_inner::~OAIOrderRequest_v2_items_inner() {}

void OAIOrderRequest_v2_items_inner::initializeModel() {
...
void OAIOrderRequest_v2_items_inner::fromJson(QString jsonString) {
...
void OAIOrderRequest_v2_items_inner::fromJsonObject(QJsonObject json) {
...
QString OAIOrderRequest_v2_items_inner::asJson() const {
...
QJsonObject OAIOrderRequest_v2_items_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAIOrderRequest_v2_items_inner::getDeclaredValue() const {
    return m_declared_value;
}
void OAIOrderRequest_v2_items_inner::setDeclaredValue(const QString &declared_value) {
    m_declared_value = declared_value;
    m_declared_value_isSet = true;
}

bool OAIOrderRequest_v2_items_inner::is_declared_value_Set() const{
    return m_declared_value_isSet;
}

bool OAIOrderRequest_v2_items_inner::is_declared_value_Valid() const{
    return m_declared_value_isValid;
}

qint32 OAIOrderRequest_v2_items_inner::getQuantity() const {
    return m_quantity;
}
void OAIOrderRequest_v2_items_inner::setQuantity(const qint32 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIOrderRequest_v2_items_inner::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIOrderRequest_v2_items_inner::is_quantity_Valid() const{
    return m_quantity_isValid;
}

QString OAIOrderRequest_v2_items_inner::getSku() const {
    return m_sku;
}
void OAIOrderRequest_v2_items_inner::setSku(const QString &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}

bool OAIOrderRequest_v2_items_inner::is_sku_Set() const{
    return m_sku_isSet;
}

bool OAIOrderRequest_v2_items_inner::is_sku_Valid() const{
    return m_sku_isValid;
}

bool OAIOrderRequest_v2_items_inner::isSet() const {
...
bool OAIOrderRequest_v2_items_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_declared_value_isValid && m_quantity_isValid && m_sku_isValid && true;
}
