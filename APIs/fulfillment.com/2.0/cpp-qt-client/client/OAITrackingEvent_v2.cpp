...
OAITrackingEvent_v2::OAITrackingEvent_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrackingEvent_v2::OAITrackingEvent_v2() {
    this->initializeModel();
}

OAITrackingEvent_v2::~OAITrackingEvent_v2() {}

void OAITrackingEvent_v2::initializeModel() {

    m_event_category_isSet = false;
    m_event_category_isValid = false;

    m_event_category_code_isSet = false;
    m_event_category_code_isValid = false;
...
void OAITrackingEvent_v2::fromJson(QString jsonString) {
...
void OAITrackingEvent_v2::fromJsonObject(QJsonObject json) {
    ...
    m_event_category_code_isValid = ::OpenAPI::fromJsonValue(m_event_category_code, json[QString("eventCategoryCode")]);
    m_event_category_code_isSet = !json[QString("eventCategoryCode")].isNull() && m_event_category_code_isValid;
...
QString OAITrackingEvent_v2::asJson() const {
...
QJsonObject OAITrackingEvent_v2::asJsonObject() const {
    ...
    if (m_event_status_isSet) {
        obj.insert(QString("eventStatus"), ::OpenAPI::toJsonValue(m_event_status));
    }
    return obj;
}

QString OAITrackingEvent_v2::getEventCategory() const {
    return m_event_category;
}
void OAITrackingEvent_v2::setEventCategory(const QString &event_category) {
    m_event_category = event_category;
    m_event_category_isSet = true;
}

bool OAITrackingEvent_v2::is_event_category_Set() const{
    return m_event_category_isSet;
}

bool OAITrackingEvent_v2::is_event_category_Valid() const{
    return m_event_category_isValid;
}

qint32 OAITrackingEvent_v2::getEventCategoryCode() const {
    return m_event_category_code;
}
void OAITrackingEvent_v2::setEventCategoryCode(const qint32 &event_category_code) {
    m_event_category_code = event_category_code;
    m_event_category_code_isSet = true;
}

bool OAITrackingEvent_v2::is_event_category_code_Set() const{
    return m_event_category_code_isSet;
}

bool OAITrackingEvent_v2::is_event_category_code_Valid() const{
    return m_event_category_code_isValid;
}

QDateTime OAITrackingEvent_v2::getEventDateTime() const {
    return m_event_date_time;
}
void OAITrackingEvent_v2::setEventDateTime(const QDateTime &event_date_time) {
    m_event_date_time = event_date_time;
    m_event_date_time_isSet = true;
}

bool OAITrackingEvent_v2::is_event_date_time_Set() const{
    return m_event_date_time_isSet;
}

bool OAITrackingEvent_v2::is_event_date_time_Valid() const{
    return m_event_date_time_isValid;
}

OAIObject OAITrackingEvent_v2::getEventLocation() const {
    return m_event_location;
}
void OAITrackingEvent_v2::setEventLocation(const OAIObject &event_location) {
    m_event_location = event_location;
    m_event_location_isSet = true;
}

bool OAITrackingEvent_v2::is_event_location_Set() const{
    return m_event_location_isSet;
}

bool OAITrackingEvent_v2::is_event_location_Valid() const{
    return m_event_location_isValid;
}

QString OAITrackingEvent_v2::getEventSource() const {
    return m_event_source;
}
void OAITrackingEvent_v2::setEventSource(const QString &event_source) {
    m_event_source = event_source;
    m_event_source_isSet = true;
}

bool OAITrackingEvent_v2::is_event_source_Set() const{
    return m_event_source_isSet;
}

bool OAITrackingEvent_v2::is_event_source_Valid() const{
    return m_event_source_isValid;
}

QString OAITrackingEvent_v2::getEventStatus() const {
    return m_event_status;
}
void OAITrackingEvent_v2::setEventStatus(const QString &event_status) {
    m_event_status = event_status;
    m_event_status_isSet = true;
}

bool OAITrackingEvent_v2::is_event_status_Set() const{
    return m_event_status_isSet;
}

bool OAITrackingEvent_v2::is_event_status_Valid() const{
    return m_event_status_isValid;
}

bool OAITrackingEvent_v2::isSet() const {
...
bool OAITrackingEvent_v2::isValid() const {
