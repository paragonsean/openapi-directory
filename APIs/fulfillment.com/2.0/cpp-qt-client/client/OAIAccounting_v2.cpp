...
OAIAccounting_v2::OAIAccounting_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccounting_v2::OAIAccounting_v2() {
    this->initializeModel();
}

OAIAccounting_v2::~OAIAccounting_v2() {}

void OAIAccounting_v2::initializeModel() {
...
void OAIAccounting_v2::fromJson(QString jsonString) {
...
void OAIAccounting_v2::fromJsonObject(QJsonObject json) {
...
QString OAIAccounting_v2::asJson() const {
...
QJsonObject OAIAccounting_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_fees.isSet()) {
...
OAIAccounting_v2_fees OAIAccounting_v2::getFees() const {
    return m_fees;
}
void OAIAccounting_v2::setFees(const OAIAccounting_v2_fees &fees) {
    m_fees = fees;
    m_fees_isSet = true;
}

bool OAIAccounting_v2::is_fees_Set() const{
    return m_fees_isSet;
}

bool OAIAccounting_v2::is_fees_Valid() const{
    return m_fees_isValid;
}

qint32 OAIAccounting_v2::getItemCount() const {
    return m_item_count;
}
void OAIAccounting_v2::setItemCount(const qint32 &item_count) {
    m_item_count = item_count;
    m_item_count_isSet = true;
}

bool OAIAccounting_v2::is_item_count_Set() const{
    return m_item_count_isSet;
}

bool OAIAccounting_v2::is_item_count_Valid() const{
    return m_item_count_isValid;
}

QList<OAIAccounting_v2_items_inner> OAIAccounting_v2::getItems() const {
    return m_items;
}
void OAIAccounting_v2::setItems(const QList<OAIAccounting_v2_items_inner> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIAccounting_v2::is_items_Set() const{
    return m_items_isSet;
}

bool OAIAccounting_v2::is_items_Valid() const{
    return m_items_isValid;
}

OAIAccounting_v2_merchant OAIAccounting_v2::getMerchant() const {
    return m_merchant;
}
void OAIAccounting_v2::setMerchant(const OAIAccounting_v2_merchant &merchant) {
    m_merchant = merchant;
    m_merchant_isSet = true;
}

bool OAIAccounting_v2::is_merchant_Set() const{
    return m_merchant_isSet;
}

bool OAIAccounting_v2::is_merchant_Valid() const{
    return m_merchant_isValid;
}

OAIAccounting_v2_order OAIAccounting_v2::getOrder() const {
    return m_order;
}
void OAIAccounting_v2::setOrder(const OAIAccounting_v2_order &order) {
    m_order = order;
    m_order_isSet = true;
}

bool OAIAccounting_v2::is_order_Set() const{
    return m_order_isSet;
}

bool OAIAccounting_v2::is_order_Valid() const{
    return m_order_isValid;
}

OAIAccounting_v2_warehouse OAIAccounting_v2::getWarehouse() const {
    return m_warehouse;
}
void OAIAccounting_v2::setWarehouse(const OAIAccounting_v2_warehouse &warehouse) {
    m_warehouse = warehouse;
    m_warehouse_isSet = true;
}

bool OAIAccounting_v2::is_warehouse_Set() const{
    return m_warehouse_isSet;
}

bool OAIAccounting_v2::is_warehouse_Valid() const{
    return m_warehouse_isValid;
}

bool OAIAccounting_v2::isSet() const {
...
bool OAIAccounting_v2::isValid() const {
