...
#ifndef OAIWarehouse_v2_H
#define OAIWarehouse_v2_H
...
class OAIWarehouse_v2 : public OAIObject {
public:
    OAIWarehouse_v2();
    OAIWarehouse_v2(QString json);
    ~OAIWarehouse_v2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWarehouse_v2)

#endif // OAIWarehouse_v2_H
