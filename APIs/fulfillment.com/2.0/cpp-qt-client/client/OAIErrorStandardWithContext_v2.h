...
/*
 * OAIErrorStandardWithContext_v2.h
 *
 * 
 */

#ifndef OAIErrorStandardWithContext_v2_H
#define OAIErrorStandardWithContext_v2_H
...
class OAIErrorStandardWithContext_v2 : public OAIObject {
public:
    OAIErrorStandardWithContext_v2();
    OAIErrorStandardWithContext_v2(QString json);
    ~OAIErrorStandardWithContext_v2() override;
    ...
    QList<OAIObject> getContext() const;
    void setContext(const QList<OAIObject> &context);
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorStandardWithContext_v2)

#endif // OAIErrorStandardWithContext_v2_H
