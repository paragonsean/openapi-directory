...
OAIAccountingArray_v2::OAIAccountingArray_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountingArray_v2::OAIAccountingArray_v2() {
    this->initializeModel();
}

OAIAccountingArray_v2::~OAIAccountingArray_v2() {}

void OAIAccountingArray_v2::initializeModel() {
...
void OAIAccountingArray_v2::fromJson(QString jsonString) {
...
void OAIAccountingArray_v2::fromJsonObject(QJsonObject json) {
...
QString OAIAccountingArray_v2::asJson() const {
...
QJsonObject OAIAccountingArray_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIAccounting_v2> OAIAccountingArray_v2::getData() const {
    return m_data;
}
void OAIAccountingArray_v2::setData(const QList<OAIAccounting_v2> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIAccountingArray_v2::is_data_Set() const{
    return m_data_isSet;
}

bool OAIAccountingArray_v2::is_data_Valid() const{
    return m_data_isValid;
}

OAIAccountingArray_v2_meta OAIAccountingArray_v2::getMeta() const {
    return m_meta;
}
void OAIAccountingArray_v2::setMeta(const OAIAccountingArray_v2_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIAccountingArray_v2::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIAccountingArray_v2::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIAccountingArray_v2::isSet() const {
...
bool OAIAccountingArray_v2::isValid() const {
