...
/*
 * OAIItemInventory_v2_quantity_total.h
 *
 * 
 */

#ifndef OAIItemInventory_v2_quantity_total_H
#define OAIItemInventory_v2_quantity_total_H
...
class OAIItemInventory_v2_quantity_total : public OAIObject {
public:
    OAIItemInventory_v2_quantity_total();
    OAIItemInventory_v2_quantity_total(QString json);
    ~OAIItemInventory_v2_quantity_total() override;
    ...
    qint32 getAvailableToPromise() const;
    void setAvailableToPromise(const qint32 &available_to_promise);
    bool is_available_to_promise_Set() const;
    bool is_available_to_promise_Valid() const;
...
private:
    ...
    qint32 m_available_to_promise;
    bool m_available_to_promise_isSet;
    bool m_available_to_promise_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIItemInventory_v2_quantity_total)

#endif // OAIItemInventory_v2_quantity_total_H
