...
#include "OAIItemInventoryArray_v2.h"
...
OAIItemInventoryArray_v2::OAIItemInventoryArray_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIItemInventoryArray_v2::OAIItemInventoryArray_v2() {
    this->initializeModel();
}

OAIItemInventoryArray_v2::~OAIItemInventoryArray_v2() {}

void OAIItemInventoryArray_v2::initializeModel() {
...
void OAIItemInventoryArray_v2::fromJson(QString jsonString) {
...
void OAIItemInventoryArray_v2::fromJsonObject(QJsonObject json) {
...
QString OAIItemInventoryArray_v2::asJson() const {
...
QJsonObject OAIItemInventoryArray_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIItemInventory_v2> OAIItemInventoryArray_v2::getData() const {
    return m_data;
}
void OAIItemInventoryArray_v2::setData(const QList<OAIItemInventory_v2> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIItemInventoryArray_v2::is_data_Set() const{
    return m_data_isSet;
}

bool OAIItemInventoryArray_v2::is_data_Valid() const{
    return m_data_isValid;
}

OAIAccountingArray_v2_meta OAIItemInventoryArray_v2::getMeta() const {
    return m_meta;
}
void OAIItemInventoryArray_v2::setMeta(const OAIAccountingArray_v2_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIItemInventoryArray_v2::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIItemInventoryArray_v2::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIItemInventoryArray_v2::isSet() const {
...
bool OAIItemInventoryArray_v2::isValid() const {
