...
#ifndef OAIReturn_v2_H
#define OAIReturn_v2_H

#include <QJsonObject>

#include "OAIObject.h"
#include "OAIReturn_v2_order.h"
#include "OAIReturn_v2_reason.h"
#include "OAIRmaItem_v2.h"
#include "OAIUser_v2.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIReturn_v2_order;
class OAIReturn_v2_reason;
class OAIRmaItem_v2;
class OAIUser_v2;

class OAIReturn_v2 : public OAIObject {
public:
    OAIReturn_v2();
    OAIReturn_v2(QString json);
    ~OAIReturn_v2() override;
    ...
    OAIObject getCreatedBy() const;
    void setCreatedBy(const OAIObject &created_by);
    ...
    OAIReturn_v2_order getOrder() const;
    void setOrder(const OAIReturn_v2_order &order);
    bool is_order_Set() const;
    bool is_order_Valid() const;

    OAIReturn_v2_reason getReason() const;
    void setReason(const OAIReturn_v2_reason &reason);
    bool is_reason_Set() const;
    bool is_reason_Valid() const;

    QString getReturnedBy() const;
    void setReturnedBy(const QString &returned_by);
    bool is_returned_by_Set() const;
    bool is_returned_by_Valid() const;

    QList<OAIRmaItem_v2> getRmaItems() const;
    void setRmaItems(const QList<OAIRmaItem_v2> &rma_items);
    bool is_rma_items_Set() const;
    bool is_rma_items_Valid() const;
    ...
    OAIReturn_v2_reason getStatus() const;
    void setStatus(const OAIReturn_v2_reason &status);
    ...
    OAIUser_v2 getUpdatedBy() const;
    void setUpdatedBy(const OAIUser_v2 &updated_by);
...
private:
    ...
    OAIReturn_v2_order m_order;
    bool m_order_isSet;
    bool m_order_isValid;

    OAIReturn_v2_reason m_reason;
    bool m_reason_isSet;
    bool m_reason_isValid;

    QString m_returned_by;
    bool m_returned_by_isSet;
    bool m_returned_by_isValid;

    QList<OAIRmaItem_v2> m_rma_items;
    bool m_rma_items_isSet;
    bool m_rma_items_isValid;

    QString m_rma_number;
    bool m_rma_number_isSet;
    bool m_rma_number_isValid;

    OAIReturn_v2_reason m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturn_v2)

#endif // OAIReturn_v2_H
