...
/*
 * OAIRmaItem_v2_item.h
 *
 * 
 */

#ifndef OAIRmaItem_v2_item_H
#define OAIRmaItem_v2_item_H
...
class OAIRmaItem_v2_item : public OAIObject {
public:
    OAIRmaItem_v2_item();
    OAIRmaItem_v2_item(QString json);
    ~OAIRmaItem_v2_item() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRmaItem_v2_item)

#endif // OAIRmaItem_v2_item_H
