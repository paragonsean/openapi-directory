...
void OAIAuthApi::postOauthAccessToken(const OAIAccessTokenRequest_v2 &body) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthApi::postOauthAccessTokenCallback);
...
void OAIAuthApi::postOauthAccessTokenCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIAccessTokenResponse_v2 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT postOauthAccessTokenSignal(output);
        Q_EMIT postOauthAccessTokenSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT postOauthAccessTokenSignalE(output, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT postOauthAccessTokenSignalError(output, error_type, error_str);
