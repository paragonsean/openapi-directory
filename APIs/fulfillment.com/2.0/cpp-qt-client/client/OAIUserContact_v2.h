...
#ifndef OAIUserContact_v2_H
#define OAIUserContact_v2_H
...
namespace OpenAPI {
class OAIUserContact_v2_merchant;

class OAIUserContact_v2 : public OAIObject {
public:
    OAIUserContact_v2();
    OAIUserContact_v2(QString json);
    ~OAIUserContact_v2() override;
    ...
    Q_DECL_DEPRECATED QString getApiKey() const;
    Q_DECL_DEPRECATED void setApiKey(const QString &api_key);
    Q_DECL_DEPRECATED bool is_api_key_Set() const;
    Q_DECL_DEPRECATED bool is_api_key_Valid() const;

    OAIUserContact_v2 getContactInfo() const;
    void setContactInfo(const OAIUserContact_v2 &contact_info);
    ...
    Q_DECL_DEPRECATED bool isDeptLeader() const;
    Q_DECL_DEPRECATED void setDeptLeader(const bool &dept_leader);
    Q_DECL_DEPRECATED bool is_dept_leader_Set() const;
    Q_DECL_DEPRECATED bool is_dept_leader_Valid() const;
    ...
    OAIUserContact_v2_merchant getMerchant() const;
    void setMerchant(const OAIUserContact_v2_merchant &merchant);
    ...
    QDateTime getUpdatedBy() const;
    void setUpdatedBy(const QDateTime &updated_by);
...
private:
    ...
    OAIUserContact_v2 m_contact_info;
    ...
    bool m_dept_leader;
    bool m_dept_leader_isSet;
    bool m_dept_leader_isValid;

    qint32 m_id;
    bool m_id_isSet;
    bool m_id_isValid;

    OAIUserContact_v2_merchant m_merchant;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserContact_v2)

#endif // OAIUserContact_v2_H
