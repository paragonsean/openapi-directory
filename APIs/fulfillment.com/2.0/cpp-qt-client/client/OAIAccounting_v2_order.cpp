...
OAIAccounting_v2_order::OAIAccounting_v2_order(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccounting_v2_order::OAIAccounting_v2_order() {
    this->initializeModel();
}

OAIAccounting_v2_order::~OAIAccounting_v2_order() {}

void OAIAccounting_v2_order::initializeModel() {
...
void OAIAccounting_v2_order::fromJson(QString jsonString) {
...
void OAIAccounting_v2_order::fromJsonObject(QJsonObject json) {
...
QString OAIAccounting_v2_order::asJson() const {
...
QJsonObject OAIAccounting_v2_order::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIAccounting_v2_order::getId() const {
    return m_id;
}
void OAIAccounting_v2_order::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAccounting_v2_order::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAccounting_v2_order::is_id_Valid() const{
    return m_id_isValid;
}

QDate OAIAccounting_v2_order::getInvoiceDate() const {
    return m_invoice_date;
}
void OAIAccounting_v2_order::setInvoiceDate(const QDate &invoice_date) {
    m_invoice_date = invoice_date;
    m_invoice_date_isSet = true;
}

bool OAIAccounting_v2_order::is_invoice_date_Set() const{
    return m_invoice_date_isSet;
}

bool OAIAccounting_v2_order::is_invoice_date_Valid() const{
    return m_invoice_date_isValid;
}

qint32 OAIAccounting_v2_order::getMerchantOrderId() const {
    return m_merchant_order_id;
}
void OAIAccounting_v2_order::setMerchantOrderId(const qint32 &merchant_order_id) {
    m_merchant_order_id = merchant_order_id;
    m_merchant_order_id_isSet = true;
}

bool OAIAccounting_v2_order::is_merchant_order_id_Set() const{
    return m_merchant_order_id_isSet;
}

bool OAIAccounting_v2_order::is_merchant_order_id_Valid() const{
    return m_merchant_order_id_isValid;
}

QDate OAIAccounting_v2_order::getRecordedDate() const {
    return m_recorded_date;
}
void OAIAccounting_v2_order::setRecordedDate(const QDate &recorded_date) {
    m_recorded_date = recorded_date;
    m_recorded_date_isSet = true;
}

bool OAIAccounting_v2_order::is_recorded_date_Set() const{
    return m_recorded_date_isSet;
}

bool OAIAccounting_v2_order::is_recorded_date_Valid() const{
    return m_recorded_date_isValid;
}

bool OAIAccounting_v2_order::isSet() const {
...
bool OAIAccounting_v2_order::isValid() const {
