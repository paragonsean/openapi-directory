...
#ifndef OAIPagination_v2_H
#define OAIPagination_v2_H
...
class OAIPagination_v2 : public OAIObject {
public:
    OAIPagination_v2();
    OAIPagination_v2(QString json);
    ~OAIPagination_v2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagination_v2)

#endif // OAIPagination_v2_H
