...
/*
 * OAIAccounting_v2_warehouse.h
 *
 * 
 */

#ifndef OAIAccounting_v2_warehouse_H
#define OAIAccounting_v2_warehouse_H
...
class OAIAccounting_v2_warehouse : public OAIObject {
public:
    OAIAccounting_v2_warehouse();
    OAIAccounting_v2_warehouse(QString json);
    ~OAIAccounting_v2_warehouse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccounting_v2_warehouse)

#endif // OAIAccounting_v2_warehouse_H
