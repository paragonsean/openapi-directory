...
/*
 * OAILineItemsResponse_v2_inventoryDetails_inner.h
 *
 * 
 */

#ifndef OAILineItemsResponse_v2_inventoryDetails_inner_H
#define OAILineItemsResponse_v2_inventoryDetails_inner_H
...
class OAILineItemsResponse_v2_inventoryDetails_inner : public OAIObject {
public:
    OAILineItemsResponse_v2_inventoryDetails_inner();
    OAILineItemsResponse_v2_inventoryDetails_inner(QString json);
    ~OAILineItemsResponse_v2_inventoryDetails_inner() override;
    ...
    QString getLotNum() const;
    void setLotNum(const QString &lot_num);
    bool is_lot_num_Set() const;
    bool is_lot_num_Valid() const;
    ...
    bool is_serial_num_Set() const;
    bool is_serial_num_Valid() const;
...
private:
    ...
    QString m_lot_num;
    bool m_lot_num_isSet;
    bool m_lot_num_isValid;
    ...
    bool m_serial_num_isSet;
    bool m_serial_num_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILineItemsResponse_v2_inventoryDetails_inner)

#endif // OAILineItemsResponse_v2_inventoryDetails_inner_H
