...
#ifndef OAIRmaResponse_v2_H
#define OAIRmaResponse_v2_H

#include <QJsonObject>

#include "OAIConsignee_v2.h"
#include "OAIRmaRequest_v2_items_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIRmaRequest_v2_items_inner;
class OAIConsignee_v2;

class OAIRmaResponse_v2 : public OAIObject {
public:
    OAIRmaResponse_v2();
    OAIRmaResponse_v2(QString json);
    ~OAIRmaResponse_v2() override;
    ...
    QList<OAIRmaRequest_v2_items_inner> getItems() const;
    void setItems(const QList<OAIRmaRequest_v2_items_inner> &items);
    ...
    OAIConsignee_v2 getRecipient() const;
    void setRecipient(const OAIConsignee_v2 &recipient);
...
private:
    ...
    QList<OAIRmaRequest_v2_items_inner> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRmaResponse_v2)

#endif // OAIRmaResponse_v2_H
