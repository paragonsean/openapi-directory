...
/*
 * OAIOrderResponse_v2.h
 *
 * 
 */

#ifndef OAIOrderResponse_v2_H
#define OAIOrderResponse_v2_H

#include <QJsonObject>

#include "OAIConsignee_v2.h"
#include "OAIMerchant_v2.h"
#include "OAIObject.h"
#include "OAIOrderResponse_v2_parentOrder.h"
#include "OAIStatusEvent_v2.h"
#include "OAITrackingNumber_v2.h"
#include "OAIWarehouse_v2.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIStatusEvent_v2;
class OAIMerchant_v2;
class OAIConsignee_v2;
class OAIOrderResponse_v2_parentOrder;
class OAITrackingNumber_v2;
class OAIWarehouse_v2;

class OAIOrderResponse_v2 : public OAIObject {
public:
    OAIOrderResponse_v2();
    OAIOrderResponse_v2(QString json);
    ~OAIOrderResponse_v2() override;
    ...
    OAIStatusEvent_v2 getCurrentStatus() const;
    void setCurrentStatus(const OAIStatusEvent_v2 &current_status);
    bool is_current_status_Set() const;
    bool is_current_status_Valid() const;

    QDateTime getDepartDate() const;
    void setDepartDate(const QDateTime &depart_date);
    bool is_depart_date_Set() const;
    bool is_depart_date_Valid() const;

    QDateTime getDispatchDate() const;
    void setDispatchDate(const QDateTime &dispatch_date);
    bool is_dispatch_date_Set() const;
    bool is_dispatch_date_Valid() const;
    ...
    OAIMerchant_v2 getMerchant() const;
    void setMerchant(const OAIMerchant_v2 &merchant);
    ...
    QString getMerchantShippingMethod() const;
    void setMerchantShippingMethod(const QString &merchant_shipping_method);
    bool is_merchant_shipping_method_Set() const;
    bool is_merchant_shipping_method_Valid() const;

    OAIConsignee_v2 getOriginalConsignee() const;
    void setOriginalConsignee(const OAIConsignee_v2 &original_consignee);
    bool is_original_consignee_Set() const;
    bool is_original_consignee_Valid() const;

    OAIOrderResponse_v2_parentOrder getParentOrder() const;
    void setParentOrder(const OAIOrderResponse_v2_parentOrder &parent_order);
    bool is_parent_order_Set() const;
    bool is_parent_order_Valid() const;

    QString getPurchaseOrderNum() const;
    void setPurchaseOrderNum(const QString &purchase_order_num);
    bool is_purchase_order_num_Set() const;
    bool is_purchase_order_num_Valid() const;

    QDateTime getRecordedOn() const;
    void setRecordedOn(const QDateTime &recorded_on);
    bool is_recorded_on_Set() const;
    bool is_recorded_on_Valid() const;

    QList<OAITrackingNumber_v2> getTrackingNumbers() const;
    void setTrackingNumbers(const QList<OAITrackingNumber_v2> &tracking_numbers);
    bool is_tracking_numbers_Set() const;
    bool is_tracking_numbers_Valid() const;

    OAIObject getValidatedConsignee() const;
    void setValidatedConsignee(const OAIObject &validated_consignee);
    bool is_validated_consignee_Set() const;
    bool is_validated_consignee_Valid() const;

    OAIWarehouse_v2 getWarehouse() const;
    void setWarehouse(const OAIWarehouse_v2 &warehouse);
...
private:
    ...
    OAIStatusEvent_v2 m_current_status;
    bool m_current_status_isSet;
    bool m_current_status_isValid;

    QDateTime m_depart_date;
    bool m_depart_date_isSet;
    bool m_depart_date_isValid;

    QDateTime m_dispatch_date;
    bool m_dispatch_date_isSet;
    bool m_dispatch_date_isValid;

    qint32 m_id;
    bool m_id_isSet;
    bool m_id_isValid;

    OAIMerchant_v2 m_merchant;
    ...
    QString m_merchant_shipping_method;
    bool m_merchant_shipping_method_isSet;
    bool m_merchant_shipping_method_isValid;

    OAIConsignee_v2 m_original_consignee;
    bool m_original_consignee_isSet;
    bool m_original_consignee_isValid;

    OAIOrderResponse_v2_parentOrder m_parent_order;
    bool m_parent_order_isSet;
    bool m_parent_order_isValid;

    QString m_purchase_order_num;
    bool m_purchase_order_num_isSet;
    bool m_purchase_order_num_isValid;

    QDateTime m_recorded_on;
    bool m_recorded_on_isSet;
    bool m_recorded_on_isValid;

    QList<OAITrackingNumber_v2> m_tracking_numbers;
    bool m_tracking_numbers_isSet;
    bool m_tracking_numbers_isValid;

    OAIObject m_validated_consignee;
    bool m_validated_consignee_isSet;
    bool m_validated_consignee_isValid;

    OAIWarehouse_v2 m_warehouse;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderResponse_v2)

#endif // OAIOrderResponse_v2_H
