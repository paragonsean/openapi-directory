...
/*
 * OAILineItemsResponse_v2.h
 *
 * 
 */

#ifndef OAILineItemsResponse_v2_H
#define OAILineItemsResponse_v2_H
...
namespace OpenAPI {
class OAILineItemsResponse_v2_inventoryDetails_inner;
class OAILineItemsResponse_v2_lineDetails;
class OAILineItemsResponse_v2_requestedSkuData;

class OAILineItemsResponse_v2 : public OAIObject {
public:
    OAILineItemsResponse_v2();
    OAILineItemsResponse_v2(QString json);
    ~OAILineItemsResponse_v2() override;
    ...
    QList<OAILineItemsResponse_v2_inventoryDetails_inner> getInventoryDetails() const;
    void setInventoryDetails(const QList<OAILineItemsResponse_v2_inventoryDetails_inner> &inventory_details);
    bool is_inventory_details_Set() const;
    bool is_inventory_details_Valid() const;

    OAILineItemsResponse_v2_lineDetails getLineDetails() const;
    void setLineDetails(const OAILineItemsResponse_v2_lineDetails &line_details);
    bool is_line_details_Set() const;
    bool is_line_details_Valid() const;

    OAILineItemsResponse_v2_requestedSkuData getRequestedSkuData() const;
    void setRequestedSkuData(const OAILineItemsResponse_v2_requestedSkuData &requested_sku_data);
    bool is_requested_sku_data_Set() const;
    bool is_requested_sku_data_Valid() const;
...
private:
    ...
    QList<OAILineItemsResponse_v2_inventoryDetails_inner> m_inventory_details;
    bool m_inventory_details_isSet;
    bool m_inventory_details_isValid;

    OAILineItemsResponse_v2_lineDetails m_line_details;
    bool m_line_details_isSet;
    bool m_line_details_isValid;

    OAILineItemsResponse_v2_requestedSkuData m_requested_sku_data;
    bool m_requested_sku_data_isSet;
    bool m_requested_sku_data_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILineItemsResponse_v2)

#endif // OAILineItemsResponse_v2_H
