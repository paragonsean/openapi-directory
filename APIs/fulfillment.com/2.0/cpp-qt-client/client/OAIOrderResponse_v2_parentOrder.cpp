...
OAIOrderResponse_v2_parentOrder::OAIOrderResponse_v2_parentOrder(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderResponse_v2_parentOrder::OAIOrderResponse_v2_parentOrder() {
    this->initializeModel();
}

OAIOrderResponse_v2_parentOrder::~OAIOrderResponse_v2_parentOrder() {}

void OAIOrderResponse_v2_parentOrder::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIOrderResponse_v2_parentOrder::fromJson(QString jsonString) {
...
void OAIOrderResponse_v2_parentOrder::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIOrderResponse_v2_parentOrder::asJson() const {
...
QJsonObject OAIOrderResponse_v2_parentOrder::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIOrderResponse_v2_parentOrder::getId() const {
    return m_id;
}
void OAIOrderResponse_v2_parentOrder::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOrderResponse_v2_parentOrder::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOrderResponse_v2_parentOrder::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIOrderResponse_v2_parentOrder::isSet() const {
...
bool OAIOrderResponse_v2_parentOrder::isValid() const {
