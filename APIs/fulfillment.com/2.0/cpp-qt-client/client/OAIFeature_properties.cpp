...
#include "OAIFeature_properties.h"
...
OAIFeature_properties::OAIFeature_properties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFeature_properties::OAIFeature_properties() {
    this->initializeModel();
}

OAIFeature_properties::~OAIFeature_properties() {}

void OAIFeature_properties::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIFeature_properties::fromJson(QString jsonString) {
...
void OAIFeature_properties::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIFeature_properties::asJson() const {
...
QJsonObject OAIFeature_properties::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIFeature_properties::getName() const {
    return m_name;
}
void OAIFeature_properties::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFeature_properties::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFeature_properties::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIFeature_properties::isSet() const {
...
bool OAIFeature_properties::isValid() const {
