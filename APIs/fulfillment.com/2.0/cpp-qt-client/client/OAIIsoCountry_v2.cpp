...
OAIIsoCountry_v2::OAIIsoCountry_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsoCountry_v2::OAIIsoCountry_v2() {
    this->initializeModel();
}

OAIIsoCountry_v2::~OAIIsoCountry_v2() {}

void OAIIsoCountry_v2::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;

    m_iso2_isSet = false;
    m_iso2_isValid = false;

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIIsoCountry_v2::fromJson(QString jsonString) {
...
void OAIIsoCountry_v2::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;

    m_iso2_isValid = ::OpenAPI::fromJsonValue(m_iso2, json[QString("iso2")]);
    m_iso2_isSet = !json[QString("iso2")].isNull() && m_iso2_isValid;

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIIsoCountry_v2::asJson() const {
...
QJsonObject OAIIsoCountry_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
        obj.insert(QString("id"), ::OpenAPI::toJsonValue(m_id));
    }
    if (m_iso2_isSet) {
        obj.insert(QString("iso2"), ::OpenAPI::toJsonValue(m_iso2));
    }
    if (m_name_isSet) {
...
qint32 OAIIsoCountry_v2::getId() const {
    return m_id;
}
void OAIIsoCountry_v2::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIIsoCountry_v2::is_id_Set() const{
    return m_id_isSet;
}

bool OAIIsoCountry_v2::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIIsoCountry_v2::getIso2() const {
    return m_iso2;
}
void OAIIsoCountry_v2::setIso2(const QString &iso2) {
    m_iso2 = iso2;
    m_iso2_isSet = true;
}

bool OAIIsoCountry_v2::is_iso2_Set() const{
    return m_iso2_isSet;
}

bool OAIIsoCountry_v2::is_iso2_Valid() const{
    return m_iso2_isValid;
}

QString OAIIsoCountry_v2::getName() const {
    return m_name;
}
void OAIIsoCountry_v2::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIIsoCountry_v2::is_name_Set() const{
    return m_name_isSet;
}

bool OAIIsoCountry_v2::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIIsoCountry_v2::isSet() const {
...
bool OAIIsoCountry_v2::isValid() const {
