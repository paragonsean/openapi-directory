...
/*
 * OAIReturn_v2_order.h
 *
 * 
 */

#ifndef OAIReturn_v2_order_H
#define OAIReturn_v2_order_H
...
class OAIReturn_v2_order : public OAIObject {
public:
    OAIReturn_v2_order();
    OAIReturn_v2_order(QString json);
    ~OAIReturn_v2_order() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturn_v2_order)

#endif // OAIReturn_v2_order_H
