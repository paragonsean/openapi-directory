...
#include "OAIStatusType_v2_actionRequiredBy.h"
...
OAIStatusType_v2_actionRequiredBy::OAIStatusType_v2_actionRequiredBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatusType_v2_actionRequiredBy::OAIStatusType_v2_actionRequiredBy() {
    this->initializeModel();
}

OAIStatusType_v2_actionRequiredBy::~OAIStatusType_v2_actionRequiredBy() {}

void OAIStatusType_v2_actionRequiredBy::initializeModel() {
...
void OAIStatusType_v2_actionRequiredBy::fromJson(QString jsonString) {
...
void OAIStatusType_v2_actionRequiredBy::fromJsonObject(QJsonObject json) {
...
QString OAIStatusType_v2_actionRequiredBy::asJson() const {
...
QJsonObject OAIStatusType_v2_actionRequiredBy::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIStatusType_v2_actionRequiredBy::getId() const {
    return m_id;
}
void OAIStatusType_v2_actionRequiredBy::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStatusType_v2_actionRequiredBy::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStatusType_v2_actionRequiredBy::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIStatusType_v2_actionRequiredBy::getName() const {
    return m_name;
}
void OAIStatusType_v2_actionRequiredBy::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStatusType_v2_actionRequiredBy::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStatusType_v2_actionRequiredBy::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIStatusType_v2_actionRequiredBy::isSet() const {
...
bool OAIStatusType_v2_actionRequiredBy::isValid() const {
