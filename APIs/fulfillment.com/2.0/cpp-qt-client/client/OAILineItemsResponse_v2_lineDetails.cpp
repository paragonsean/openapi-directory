...
#include "OAILineItemsResponse_v2_lineDetails.h"
...
OAILineItemsResponse_v2_lineDetails::OAILineItemsResponse_v2_lineDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILineItemsResponse_v2_lineDetails::OAILineItemsResponse_v2_lineDetails() {
    this->initializeModel();
}

OAILineItemsResponse_v2_lineDetails::~OAILineItemsResponse_v2_lineDetails() {}

void OAILineItemsResponse_v2_lineDetails::initializeModel() {

    m_description_isSet = false;
    m_description_isValid = false;

    m_external_sku_isSet = false;
    m_external_sku_isValid = false;
...
void OAILineItemsResponse_v2_lineDetails::fromJson(QString jsonString) {
...
void OAILineItemsResponse_v2_lineDetails::fromJsonObject(QJsonObject json) {

    m_description_isValid = ::OpenAPI::fromJsonValue(m_description, json[QString("description")]);
    m_description_isSet = !json[QString("description")].isNull() && m_description_isValid;

    m_external_sku_isValid = ::OpenAPI::fromJsonValue(m_external_sku, json[QString("externalSku")]);
    m_external_sku_isSet = !json[QString("externalSku")].isNull() && m_external_sku_isValid;
...
QString OAILineItemsResponse_v2_lineDetails::asJson() const {
...
QJsonObject OAILineItemsResponse_v2_lineDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_description_isSet) {
        obj.insert(QString("description"), ::OpenAPI::toJsonValue(m_description));
    }
    if (m_external_sku_isSet) {
        obj.insert(QString("externalSku"), ::OpenAPI::toJsonValue(m_external_sku));
    }
    if (m_id_isSet) {
...
QString OAILineItemsResponse_v2_lineDetails::getDescription() const {
    return m_description;
}
void OAILineItemsResponse_v2_lineDetails::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAILineItemsResponse_v2_lineDetails::is_description_Set() const{
    return m_description_isSet;
}

bool OAILineItemsResponse_v2_lineDetails::is_description_Valid() const{
    return m_description_isValid;
}

QString OAILineItemsResponse_v2_lineDetails::getExternalSku() const {
    return m_external_sku;
}
void OAILineItemsResponse_v2_lineDetails::setExternalSku(const QString &external_sku) {
    m_external_sku = external_sku;
    m_external_sku_isSet = true;
}

bool OAILineItemsResponse_v2_lineDetails::is_external_sku_Set() const{
    return m_external_sku_isSet;
}

bool OAILineItemsResponse_v2_lineDetails::is_external_sku_Valid() const{
    return m_external_sku_isValid;
}

qint32 OAILineItemsResponse_v2_lineDetails::getId() const {
    return m_id;
}
void OAILineItemsResponse_v2_lineDetails::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILineItemsResponse_v2_lineDetails::is_id_Set() const{
    return m_id_isSet;
}

bool OAILineItemsResponse_v2_lineDetails::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILineItemsResponse_v2_lineDetails::getName() const {
    return m_name;
}
void OAILineItemsResponse_v2_lineDetails::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILineItemsResponse_v2_lineDetails::is_name_Set() const{
    return m_name_isSet;
}

bool OAILineItemsResponse_v2_lineDetails::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAILineItemsResponse_v2_lineDetails::getTotalQuantity() const {
    return m_total_quantity;
}
void OAILineItemsResponse_v2_lineDetails::setTotalQuantity(const qint32 &total_quantity) {
    m_total_quantity = total_quantity;
    m_total_quantity_isSet = true;
}

bool OAILineItemsResponse_v2_lineDetails::is_total_quantity_Set() const{
    return m_total_quantity_isSet;
}

bool OAILineItemsResponse_v2_lineDetails::is_total_quantity_Valid() const{
    return m_total_quantity_isValid;
}

bool OAILineItemsResponse_v2_lineDetails::isSet() const {
...
bool OAILineItemsResponse_v2_lineDetails::isValid() const {
