...
/*
 * OAIItemInventory_v2.h
 *
 * 
 */

#ifndef OAIItemInventory_v2_H
#define OAIItemInventory_v2_H

#include <QJsonObject>

#include "OAIItemInventory_v2_item.h"
#include "OAIItemInventory_v2_merchant.h"
#include "OAIItemInventory_v2_quantity.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIItemInventory_v2_item;
class OAIItemInventory_v2_merchant;
class OAIItemInventory_v2_quantity;

class OAIItemInventory_v2 : public OAIObject {
public:
    OAIItemInventory_v2();
    OAIItemInventory_v2(QString json);
    ~OAIItemInventory_v2() override;
    ...
    OAIItemInventory_v2_item getItem() const;
    void setItem(const OAIItemInventory_v2_item &item);
    bool is_item_Set() const;
    bool is_item_Valid() const;

    OAIItemInventory_v2_merchant getMerchant() const;
    void setMerchant(const OAIItemInventory_v2_merchant &merchant);
    bool is_merchant_Set() const;
    bool is_merchant_Valid() const;

    OAIItemInventory_v2_quantity getQuantity() const;
    void setQuantity(const OAIItemInventory_v2_quantity &quantity);
...
private:
    ...
    OAIItemInventory_v2_item m_item;
    bool m_item_isSet;
    bool m_item_isValid;

    OAIItemInventory_v2_merchant m_merchant;
    bool m_merchant_isSet;
    bool m_merchant_isValid;

    OAIItemInventory_v2_quantity m_quantity;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemInventory_v2)

#endif // OAIItemInventory_v2_H
