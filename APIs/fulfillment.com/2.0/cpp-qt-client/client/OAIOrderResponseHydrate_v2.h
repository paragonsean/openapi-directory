...
/*
 * OAIOrderResponseHydrate_v2.h
 *
 * Requires hydrate to be set in the request and the corresponding node will be filled.
 */

#ifndef OAIOrderResponseHydrate_v2_H
#define OAIOrderResponseHydrate_v2_H
...
class OAIOrderResponseHydrate_v2 : public OAIObject {
public:
    OAIOrderResponseHydrate_v2();
    OAIOrderResponseHydrate_v2(QString json);
    ~OAIOrderResponseHydrate_v2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderResponseHydrate_v2)

#endif // OAIOrderResponseHydrate_v2_H
