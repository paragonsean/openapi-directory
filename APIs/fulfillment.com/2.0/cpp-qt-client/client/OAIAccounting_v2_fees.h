...
/*
 * OAIAccounting_v2_fees.h
 *
 * 
 */

#ifndef OAIAccounting_v2_fees_H
#define OAIAccounting_v2_fees_H
...
class OAIAccounting_v2_fees : public OAIObject {
public:
    OAIAccounting_v2_fees();
    OAIAccounting_v2_fees(QString json);
    ~OAIAccounting_v2_fees() override;
    ...
    void setEnvelope(const float &envelope);
    bool is_envelope_Set() const;
    bool is_envelope_Valid() const;

    float getFulfillment() const;
    void setFulfillment(const float &fulfillment);
    bool is_fulfillment_Set() const;
    bool is_fulfillment_Valid() const;

    float getInsert() const;
    void setInsert(const float &insert);
    bool is_insert_Set() const;
    bool is_insert_Valid() const;

    float getKitting() const;
    void setKitting(const float &kitting);
    bool is_kitting_Set() const;
    bool is_kitting_Valid() const;

    float getPicking() const;
    void setPicking(const float &picking);
    bool is_picking_Set() const;
    bool is_picking_Valid() const;

    float getPostage() const;
    void setPostage(const float &postage);
    bool is_postage_Set() const;
    bool is_postage_Valid() const;

    float getPrint() const;
    void setPrint(const float &print);
...
private:
    ...
    float m_kitting;
    bool m_kitting_isSet;
    bool m_kitting_isValid;

    float m_picking;
    bool m_picking_isSet;
    bool m_picking_isValid;

    float m_postage;
    bool m_postage_isSet;
    bool m_postage_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccounting_v2_fees)

#endif // OAIAccounting_v2_fees_H
