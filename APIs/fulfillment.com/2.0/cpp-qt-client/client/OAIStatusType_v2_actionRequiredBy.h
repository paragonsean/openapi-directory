...
/*
 * OAIStatusType_v2_actionRequiredBy.h
 *
 * Responsibility for resolving this issue
 */

#ifndef OAIStatusType_v2_actionRequiredBy_H
#define OAIStatusType_v2_actionRequiredBy_H
...
class OAIStatusType_v2_actionRequiredBy : public OAIObject {
public:
    OAIStatusType_v2_actionRequiredBy();
    OAIStatusType_v2_actionRequiredBy(QString json);
    ~OAIStatusType_v2_actionRequiredBy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusType_v2_actionRequiredBy)

#endif // OAIStatusType_v2_actionRequiredBy_H
