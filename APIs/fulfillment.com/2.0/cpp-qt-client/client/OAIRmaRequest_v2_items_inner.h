...
/*
 * OAIRmaRequest_v2_items_inner.h
 *
 * 
 */

#ifndef OAIRmaRequest_v2_items_inner_H
#define OAIRmaRequest_v2_items_inner_H
...
class OAIRmaRequest_v2_items_inner : public OAIObject {
public:
    OAIRmaRequest_v2_items_inner();
    OAIRmaRequest_v2_items_inner(QString json);
    ~OAIRmaRequest_v2_items_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRmaRequest_v2_items_inner)

#endif // OAIRmaRequest_v2_items_inner_H
