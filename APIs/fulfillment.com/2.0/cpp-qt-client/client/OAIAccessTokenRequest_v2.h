...
/*
 * OAIAccessTokenRequest_v2.h
 *
 * 
 */

#ifndef OAIAccessTokenRequest_v2_H
#define OAIAccessTokenRequest_v2_H

#include <QJsonObject>

#include "OAIAccessTokenRequestPassword_v2.h"
...
class OAIAccessTokenRequest_v2 : public OAIObject {
public:
    OAIAccessTokenRequest_v2();
    OAIAccessTokenRequest_v2(QString json);
    ~OAIAccessTokenRequest_v2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessTokenRequest_v2)

#endif // OAIAccessTokenRequest_v2_H
