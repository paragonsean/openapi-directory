...
OAIReturn_v2_reason::OAIReturn_v2_reason(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReturn_v2_reason::OAIReturn_v2_reason() {
    this->initializeModel();
}

OAIReturn_v2_reason::~OAIReturn_v2_reason() {}

void OAIReturn_v2_reason::initializeModel() {
...
void OAIReturn_v2_reason::fromJson(QString jsonString) {
...
void OAIReturn_v2_reason::fromJsonObject(QJsonObject json) {
...
QString OAIReturn_v2_reason::asJson() const {
...
QJsonObject OAIReturn_v2_reason::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIReturn_v2_reason::getId() const {
    return m_id;
}
void OAIReturn_v2_reason::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIReturn_v2_reason::is_id_Set() const{
    return m_id_isSet;
}

bool OAIReturn_v2_reason::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIReturn_v2_reason::getTitle() const {
    return m_title;
}
void OAIReturn_v2_reason::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIReturn_v2_reason::is_title_Set() const{
    return m_title_isSet;
}

bool OAIReturn_v2_reason::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIReturn_v2_reason::isSet() const {
...
bool OAIReturn_v2_reason::isValid() const {
