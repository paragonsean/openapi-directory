...
/*
 * OAIItemInventoryArray_v2.h
 *
 * 
 */

#ifndef OAIItemInventoryArray_v2_H
#define OAIItemInventoryArray_v2_H

#include <QJsonObject>

#include "OAIAccountingArray_v2_meta.h"
#include "OAIItemInventory_v2.h"
#include <QList>
...
namespace OpenAPI {
class OAIItemInventory_v2;
class OAIAccountingArray_v2_meta;

class OAIItemInventoryArray_v2 : public OAIObject {
public:
    OAIItemInventoryArray_v2();
    OAIItemInventoryArray_v2(QString json);
    ~OAIItemInventoryArray_v2() override;
    ...
    QList<OAIItemInventory_v2> getData() const;
    void setData(const QList<OAIItemInventory_v2> &data);
...
private:
    ...
    QList<OAIItemInventory_v2> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemInventoryArray_v2)

#endif // OAIItemInventoryArray_v2_H
