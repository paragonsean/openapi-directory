...
#ifndef OAIIsoCountry_v2_H
#define OAIIsoCountry_v2_H
...
class OAIIsoCountry_v2 : public OAIObject {
public:
    OAIIsoCountry_v2();
    OAIIsoCountry_v2(QString json);
    ~OAIIsoCountry_v2() override;
    ...
    QString getIso2() const;
    void setIso2(const QString &iso2);
    bool is_iso2_Set() const;
    bool is_iso2_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsoCountry_v2)

#endif // OAIIsoCountry_v2_H
