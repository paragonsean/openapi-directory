...
OAIUser_v2::OAIUser_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUser_v2::OAIUser_v2() {
    this->initializeModel();
}

OAIUser_v2::~OAIUser_v2() {}

void OAIUser_v2::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIUser_v2::fromJson(QString jsonString) {
...
void OAIUser_v2::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIUser_v2::asJson() const {
...
QJsonObject OAIUser_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIUser_v2::getId() const {
    return m_id;
}
void OAIUser_v2::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUser_v2::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUser_v2::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIUser_v2::isSet() const {
