...
#ifndef OAIAccounting_v2_H
#define OAIAccounting_v2_H

#include <QJsonObject>

#include "OAIAccounting_v2_fees.h"
#include "OAIAccounting_v2_items_inner.h"
#include "OAIAccounting_v2_merchant.h"
#include "OAIAccounting_v2_order.h"
#include "OAIAccounting_v2_warehouse.h"
#include <QList>
...
namespace OpenAPI {
class OAIAccounting_v2_fees;
class OAIAccounting_v2_items_inner;
class OAIAccounting_v2_merchant;
class OAIAccounting_v2_order;
class OAIAccounting_v2_warehouse;

class OAIAccounting_v2 : public OAIObject {
public:
    OAIAccounting_v2();
    OAIAccounting_v2(QString json);
    ~OAIAccounting_v2() override;
    ...
    OAIAccounting_v2_fees getFees() const;
    void setFees(const OAIAccounting_v2_fees &fees);
    ...
    QList<OAIAccounting_v2_items_inner> getItems() const;
    void setItems(const QList<OAIAccounting_v2_items_inner> &items);
    bool is_items_Set() const;
    bool is_items_Valid() const;

    OAIAccounting_v2_merchant getMerchant() const;
    void setMerchant(const OAIAccounting_v2_merchant &merchant);
    bool is_merchant_Set() const;
    bool is_merchant_Valid() const;

    OAIAccounting_v2_order getOrder() const;
    void setOrder(const OAIAccounting_v2_order &order);
    bool is_order_Set() const;
    bool is_order_Valid() const;

    OAIAccounting_v2_warehouse getWarehouse() const;
    void setWarehouse(const OAIAccounting_v2_warehouse &warehouse);
...
private:
    ...
    QList<OAIAccounting_v2_items_inner> m_items;
    bool m_items_isSet;
    bool m_items_isValid;

    OAIAccounting_v2_merchant m_merchant;
    bool m_merchant_isSet;
    bool m_merchant_isValid;

    OAIAccounting_v2_order m_order;
    bool m_order_isSet;
    bool m_order_isValid;

    OAIAccounting_v2_warehouse m_warehouse;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccounting_v2)

#endif // OAIAccounting_v2_H
