...
#ifndef OAIOrderShip_v2_H
#define OAIOrderShip_v2_H
...
class OAIOrderShip_v2 : public OAIObject {
public:
    OAIOrderShip_v2();
    OAIOrderShip_v2(QString json);
    ~OAIOrderShip_v2() override;
    ...
    float getWeightOverride() const;
    void setWeightOverride(const float &weight_override);
    bool is_weight_override_Set() const;
    bool is_weight_override_Valid() const;
...
private:
    ...
    float m_weight_override;
    bool m_weight_override_isSet;
    bool m_weight_override_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIOrderShip_v2)

#endif // OAIOrderShip_v2_H
