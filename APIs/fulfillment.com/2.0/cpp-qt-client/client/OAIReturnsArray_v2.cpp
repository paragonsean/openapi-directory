...
OAIReturnsArray_v2::OAIReturnsArray_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReturnsArray_v2::OAIReturnsArray_v2() {
    this->initializeModel();
}

OAIReturnsArray_v2::~OAIReturnsArray_v2() {}

void OAIReturnsArray_v2::initializeModel() {
...
void OAIReturnsArray_v2::fromJson(QString jsonString) {
...
void OAIReturnsArray_v2::fromJsonObject(QJsonObject json) {
...
QString OAIReturnsArray_v2::asJson() const {
...
QJsonObject OAIReturnsArray_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIReturn_v2> OAIReturnsArray_v2::getData() const {
    return m_data;
}
void OAIReturnsArray_v2::setData(const QList<OAIReturn_v2> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIReturnsArray_v2::is_data_Set() const{
    return m_data_isSet;
}

bool OAIReturnsArray_v2::is_data_Valid() const{
    return m_data_isValid;
}

OAIAccountingArray_v2_meta OAIReturnsArray_v2::getMeta() const {
    return m_meta;
}
void OAIReturnsArray_v2::setMeta(const OAIAccountingArray_v2_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIReturnsArray_v2::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIReturnsArray_v2::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIReturnsArray_v2::isSet() const {
...
bool OAIReturnsArray_v2::isValid() const {
