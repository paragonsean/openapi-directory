...
/*
 * OAITrackingEvent_v2.h
 *
 * 
 */

#ifndef OAITrackingEvent_v2_H
#define OAITrackingEvent_v2_H
...
class OAITrackingEvent_v2 : public OAIObject {
public:
    OAITrackingEvent_v2();
    OAITrackingEvent_v2(QString json);
    ~OAITrackingEvent_v2() override;
    ...
    qint32 getEventCategoryCode() const;
    void setEventCategoryCode(const qint32 &event_category_code);
    bool is_event_category_code_Set() const;
    bool is_event_category_code_Valid() const;
    ...
    OAIObject getEventLocation() const;
    void setEventLocation(const OAIObject &event_location);
    ...
    QString getEventStatus() const;
    void setEventStatus(const QString &event_status);
...
private:
    ...
    qint32 m_event_category_code;
    bool m_event_category_code_isSet;
    bool m_event_category_code_isValid;

    QDateTime m_event_date_time;
    bool m_event_date_time_isSet;
    bool m_event_date_time_isValid;

    OAIObject m_event_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrackingEvent_v2)

#endif // OAITrackingEvent_v2_H
