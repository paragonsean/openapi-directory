...
/*
 * OAIStatusTypeSimple_v2_status.h
 *
 * 
 */

#ifndef OAIStatusTypeSimple_v2_status_H
#define OAIStatusTypeSimple_v2_status_H
...
class OAIStatusTypeSimple_v2_status : public OAIObject {
public:
    OAIStatusTypeSimple_v2_status();
    OAIStatusTypeSimple_v2_status(QString json);
    ~OAIStatusTypeSimple_v2_status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusTypeSimple_v2_status)

#endif // OAIStatusTypeSimple_v2_status_H
