...
/*
 * OAITrackingNumber_v2.h
 *
 * 
 */

#ifndef OAITrackingNumber_v2_H
#define OAITrackingNumber_v2_H

#include <QJsonObject>

#include "OAICarrierSimple_v2.h"
#include <QString>
...
namespace OpenAPI {
class OAICarrierSimple_v2;

class OAITrackingNumber_v2 : public OAIObject {
public:
    OAITrackingNumber_v2();
    OAITrackingNumber_v2(QString json);
    ~OAITrackingNumber_v2() override;
    ...
    Q_DECL_DEPRECATED QString getBarcodeScanValue() const;
    Q_DECL_DEPRECATED void setBarcodeScanValue(const QString &barcode_scan_value);
    Q_DECL_DEPRECATED bool is_barcode_scan_value_Set() const;
    Q_DECL_DEPRECATED bool is_barcode_scan_value_Valid() const;

    OAICarrierSimple_v2 getCarrier() const;
    void setCarrier(const OAICarrierSimple_v2 &carrier);
...
private:
    ...
    QString m_barcode_scan_value;
    bool m_barcode_scan_value_isSet;
    bool m_barcode_scan_value_isValid;

    OAICarrierSimple_v2 m_carrier;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrackingNumber_v2)

#endif // OAITrackingNumber_v2_H
