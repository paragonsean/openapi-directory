...
#include "OAIAccessTokenRequestRefresh_v2.h"
...
OAIAccessTokenRequestRefresh_v2::OAIAccessTokenRequestRefresh_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccessTokenRequestRefresh_v2::OAIAccessTokenRequestRefresh_v2() {
    this->initializeModel();
}

OAIAccessTokenRequestRefresh_v2::~OAIAccessTokenRequestRefresh_v2() {}

void OAIAccessTokenRequestRefresh_v2::initializeModel() {

    m_refresh_token_isSet = false;
    m_refresh_token_isValid = false;
}

void OAIAccessTokenRequestRefresh_v2::fromJson(QString jsonString) {
...
void OAIAccessTokenRequestRefresh_v2::fromJsonObject(QJsonObject json) {
...
QString OAIAccessTokenRequestRefresh_v2::asJson() const {
...
QJsonObject OAIAccessTokenRequestRefresh_v2::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAccessTokenRequestRefresh_v2::getRefreshToken() const {
    return m_refresh_token;
}
void OAIAccessTokenRequestRefresh_v2::setRefreshToken(const QString &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAIAccessTokenRequestRefresh_v2::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAIAccessTokenRequestRefresh_v2::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

bool OAIAccessTokenRequestRefresh_v2::isSet() const {
...
bool OAIAccessTokenRequestRefresh_v2::isValid() const {
