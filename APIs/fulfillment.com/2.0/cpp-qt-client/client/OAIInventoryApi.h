...
public:
    ...
    * @param[in]  external_sku_names QList<QString> [optional]
    */
    virtual void getInventory(const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<qint32>> &merchant_ids = ::OpenAPI::OptionalParam<QList<qint32>>(), const ::OpenAPI::OptionalParam<QList<qint32>> &warehouse_ids = ::OpenAPI::OptionalParam<QList<qint32>>(), const ::OpenAPI::OptionalParam<QList<QString>> &external_sku_names = ::OpenAPI::OptionalParam<QList<QString>>());
...
Q_SIGNALS:
    ...
    void getInventorySignal(OAIItemInventoryArray_v2 summary);


    void getInventorySignalFull(OAIHttpRequestWorker *worker, OAIItemInventoryArray_v2 summary);

    Q_DECL_DEPRECATED_X("Use getInventorySignalError() instead")
    void getInventorySignalE(OAIItemInventoryArray_v2 summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getInventorySignalError(OAIItemInventoryArray_v2 summary, QNetworkReply::NetworkError error_type, const QString &error_str);
