...
/*
 * OAIOrderResponseOneOf_v2.h
 *
 * Standard Order Response or a Hydrated Response
 */

#ifndef OAIOrderResponseOneOf_v2_H
#define OAIOrderResponseOneOf_v2_H

#include <QJsonObject>

#include "OAILineItemsResponse_v2.h"
#include "OAIOrderResponseHydrate_v2.h"
#include "OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAILineItemsResponse_v2;
class OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner;

class OAIOrderResponseOneOf_v2 : public OAIObject {
public:
    OAIOrderResponseOneOf_v2();
    OAIOrderResponseOneOf_v2(QString json);
    ~OAIOrderResponseOneOf_v2() override;
    ...
    QList<OAILineItemsResponse_v2> getLineItems() const;
    void setLineItems(const QList<OAILineItemsResponse_v2> &line_items);
    bool is_line_items_Set() const;
    bool is_line_items_Valid() const;

    QList<OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner> getTrackingNumbers() const;
    void setTrackingNumbers(const QList<OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner> &tracking_numbers);
...
private:
    ...
    QList<OAILineItemsResponse_v2> m_line_items;
    bool m_line_items_isSet;
    bool m_line_items_isValid;

    QList<OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner> m_tracking_numbers;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderResponseOneOf_v2)

#endif // OAIOrderResponseOneOf_v2_H
