...
OAICarrierSimple_v2::OAICarrierSimple_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICarrierSimple_v2::OAICarrierSimple_v2() {
    this->initializeModel();
}

OAICarrierSimple_v2::~OAICarrierSimple_v2() {}

void OAICarrierSimple_v2::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAICarrierSimple_v2::fromJson(QString jsonString) {
...
void OAICarrierSimple_v2::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAICarrierSimple_v2::asJson() const {
...
QJsonObject OAICarrierSimple_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAICarrierSimple_v2::getId() const {
    return m_id;
}
void OAICarrierSimple_v2::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICarrierSimple_v2::is_id_Set() const{
    return m_id_isSet;
}

bool OAICarrierSimple_v2::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICarrierSimple_v2::isSet() const {
...
bool OAICarrierSimple_v2::isValid() const {
