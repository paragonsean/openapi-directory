...
public:
    ...
    /**
    * @param[in]  body OAIAccessTokenRequest_v2 [required]
    */
    virtual void postOauthAccessToken(const OAIAccessTokenRequest_v2 &body);
...
Q_SIGNALS:
    ...
    void postOauthAccessTokenSignal(OAIAccessTokenResponse_v2 summary);


    void postOauthAccessTokenSignalFull(OAIHttpRequestWorker *worker, OAIAccessTokenResponse_v2 summary);

    Q_DECL_DEPRECATED_X("Use postOauthAccessTokenSignalError() instead")
    void postOauthAccessTokenSignalE(OAIAccessTokenResponse_v2 summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postOauthAccessTokenSignalError(OAIAccessTokenResponse_v2 summary, QNetworkReply::NetworkError error_type, const QString &error_str);
