...
/*
 * OAIAccountingArray_v2_meta.h
 *
 * 
 */

#ifndef OAIAccountingArray_v2_meta_H
#define OAIAccountingArray_v2_meta_H

#include <QJsonObject>

#include "OAIPagination_v2.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPagination_v2;

class OAIAccountingArray_v2_meta : public OAIObject {
public:
    OAIAccountingArray_v2_meta();
    OAIAccountingArray_v2_meta(QString json);
    ~OAIAccountingArray_v2_meta() override;
    ...
    OAIPagination_v2 getPagination() const;
    void setPagination(const OAIPagination_v2 &pagination);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountingArray_v2_meta)

#endif // OAIAccountingArray_v2_meta_H
