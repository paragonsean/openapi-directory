...
#include "OAIStatusTypeSimple_v2.h"
...
OAIStatusTypeSimple_v2::OAIStatusTypeSimple_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatusTypeSimple_v2::OAIStatusTypeSimple_v2() {
    this->initializeModel();
}

OAIStatusTypeSimple_v2::~OAIStatusTypeSimple_v2() {}

void OAIStatusTypeSimple_v2::initializeModel() {
...
void OAIStatusTypeSimple_v2::fromJson(QString jsonString) {
...
void OAIStatusTypeSimple_v2::fromJsonObject(QJsonObject json) {
...
QString OAIStatusTypeSimple_v2::asJson() const {
...
QJsonObject OAIStatusTypeSimple_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_reason_isSet) {
...
QString OAIStatusTypeSimple_v2::getReason() const {
    return m_reason;
}
void OAIStatusTypeSimple_v2::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIStatusTypeSimple_v2::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIStatusTypeSimple_v2::is_reason_Valid() const{
    return m_reason_isValid;
}

OAIStatusTypeSimple_v2_status OAIStatusTypeSimple_v2::getStatus() const {
    return m_status;
}
void OAIStatusTypeSimple_v2::setStatus(const OAIStatusTypeSimple_v2_status &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStatusTypeSimple_v2::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStatusTypeSimple_v2::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIStatusTypeSimple_v2::isSet() const {
...
bool OAIStatusTypeSimple_v2::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_reason_isValid && m_status_isValid && true;
}
