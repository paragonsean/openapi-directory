...
/*
 * OAIAccessTokenRequestRefresh_v2.h
 *
 * 
 */

#ifndef OAIAccessTokenRequestRefresh_v2_H
#define OAIAccessTokenRequestRefresh_v2_H
...
class OAIAccessTokenRequestRefresh_v2 : public OAIObject {
public:
    OAIAccessTokenRequestRefresh_v2();
    OAIAccessTokenRequestRefresh_v2(QString json);
    ~OAIAccessTokenRequestRefresh_v2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccessTokenRequestRefresh_v2)

#endif // OAIAccessTokenRequestRefresh_v2_H
