...
#include "OAILineItemsResponse_v2.h"
...
OAILineItemsResponse_v2::OAILineItemsResponse_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILineItemsResponse_v2::OAILineItemsResponse_v2() {
    this->initializeModel();
}

OAILineItemsResponse_v2::~OAILineItemsResponse_v2() {}

void OAILineItemsResponse_v2::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;

    m_inventory_details_isSet = false;
    m_inventory_details_isValid = false;

    m_line_details_isSet = false;
    m_line_details_isValid = false;

    m_requested_sku_data_isSet = false;
    m_requested_sku_data_isValid = false;
}

void OAILineItemsResponse_v2::fromJson(QString jsonString) {
...
void OAILineItemsResponse_v2::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;

    m_inventory_details_isValid = ::OpenAPI::fromJsonValue(m_inventory_details, json[QString("inventoryDetails")]);
    m_inventory_details_isSet = !json[QString("inventoryDetails")].isNull() && m_inventory_details_isValid;

    m_line_details_isValid = ::OpenAPI::fromJsonValue(m_line_details, json[QString("lineDetails")]);
    m_line_details_isSet = !json[QString("lineDetails")].isNull() && m_line_details_isValid;

    m_requested_sku_data_isValid = ::OpenAPI::fromJsonValue(m_requested_sku_data, json[QString("requestedSkuData")]);
    m_requested_sku_data_isSet = !json[QString("requestedSkuData")].isNull() && m_requested_sku_data_isValid;
}

QString OAILineItemsResponse_v2::asJson() const {
...
QJsonObject OAILineItemsResponse_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
        obj.insert(QString("id"), ::OpenAPI::toJsonValue(m_id));
    }
    if (m_inventory_details.size() > 0) {
        obj.insert(QString("inventoryDetails"), ::OpenAPI::toJsonValue(m_inventory_details));
    }
    if (m_line_details.isSet()) {
        obj.insert(QString("lineDetails"), ::OpenAPI::toJsonValue(m_line_details));
    }
    if (m_requested_sku_data.isSet()) {
        obj.insert(QString("requestedSkuData"), ::OpenAPI::toJsonValue(m_requested_sku_data));
    }
    return obj;
}

qint32 OAILineItemsResponse_v2::getId() const {
    return m_id;
}
void OAILineItemsResponse_v2::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILineItemsResponse_v2::is_id_Set() const{
    return m_id_isSet;
}

bool OAILineItemsResponse_v2::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAILineItemsResponse_v2_inventoryDetails_inner> OAILineItemsResponse_v2::getInventoryDetails() const {
    return m_inventory_details;
}
void OAILineItemsResponse_v2::setInventoryDetails(const QList<OAILineItemsResponse_v2_inventoryDetails_inner> &inventory_details) {
    m_inventory_details = inventory_details;
    m_inventory_details_isSet = true;
}

bool OAILineItemsResponse_v2::is_inventory_details_Set() const{
    return m_inventory_details_isSet;
}

bool OAILineItemsResponse_v2::is_inventory_details_Valid() const{
    return m_inventory_details_isValid;
}

OAILineItemsResponse_v2_lineDetails OAILineItemsResponse_v2::getLineDetails() const {
    return m_line_details;
}
void OAILineItemsResponse_v2::setLineDetails(const OAILineItemsResponse_v2_lineDetails &line_details) {
    m_line_details = line_details;
    m_line_details_isSet = true;
}

bool OAILineItemsResponse_v2::is_line_details_Set() const{
    return m_line_details_isSet;
}

bool OAILineItemsResponse_v2::is_line_details_Valid() const{
    return m_line_details_isValid;
}

OAILineItemsResponse_v2_requestedSkuData OAILineItemsResponse_v2::getRequestedSkuData() const {
    return m_requested_sku_data;
}
void OAILineItemsResponse_v2::setRequestedSkuData(const OAILineItemsResponse_v2_requestedSkuData &requested_sku_data) {
    m_requested_sku_data = requested_sku_data;
    m_requested_sku_data_isSet = true;
}

bool OAILineItemsResponse_v2::is_requested_sku_data_Set() const{
    return m_requested_sku_data_isSet;
}

bool OAILineItemsResponse_v2::is_requested_sku_data_Valid() const{
    return m_requested_sku_data_isValid;
}

bool OAILineItemsResponse_v2::isSet() const {
...
bool OAILineItemsResponse_v2::isValid() const {
