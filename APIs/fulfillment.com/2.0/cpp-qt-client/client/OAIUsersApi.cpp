...
void OAIUsersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getUsersMe", defaultConf);
    _serverIndices.insert("getUsersMe", 0);
}
...
void OAIUsersApi::getUsersMe() {
    QString fullPath = QString(_serverConfigs["getUsersMe"][_serverIndices.value("getUsersMe")].URL()+"/users/me");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::getUsersMeCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::getUsersMeCallback);
...
void OAIUsersApi::getUsersMeCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIUserContact_v2 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getUsersMeSignal(output);
        Q_EMIT getUsersMeSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getUsersMeSignalE(output, error_type, error_str);
        Q_EMIT getUsersMeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getUsersMeSignalError(output, error_type, error_str);
        Q_EMIT getUsersMeSignalErrorFull(worker, error_type, error_str);
    }
}
