...
OAIAccessTokenRequestPassword_v2::OAIAccessTokenRequestPassword_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccessTokenRequestPassword_v2::OAIAccessTokenRequestPassword_v2() {
    this->initializeModel();
}

OAIAccessTokenRequestPassword_v2::~OAIAccessTokenRequestPassword_v2() {}

void OAIAccessTokenRequestPassword_v2::initializeModel() {
...
void OAIAccessTokenRequestPassword_v2::fromJson(QString jsonString) {
...
void OAIAccessTokenRequestPassword_v2::fromJsonObject(QJsonObject json) {
...
QString OAIAccessTokenRequestPassword_v2::asJson() const {
...
QJsonObject OAIAccessTokenRequestPassword_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_password_isSet) {
...
QString OAIAccessTokenRequestPassword_v2::getPassword() const {
    return m_password;
}
void OAIAccessTokenRequestPassword_v2::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAIAccessTokenRequestPassword_v2::is_password_Set() const{
    return m_password_isSet;
}

bool OAIAccessTokenRequestPassword_v2::is_password_Valid() const{
    return m_password_isValid;
}

QString OAIAccessTokenRequestPassword_v2::getUsername() const {
    return m_username;
}
void OAIAccessTokenRequestPassword_v2::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAccessTokenRequestPassword_v2::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAccessTokenRequestPassword_v2::is_username_Valid() const{
    return m_username_isValid;
}

QString OAIAccessTokenRequestPassword_v2::getClientId() const {
    return m_client_id;
}
void OAIAccessTokenRequestPassword_v2::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIAccessTokenRequestPassword_v2::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIAccessTokenRequestPassword_v2::is_client_id_Valid() const{
    return m_client_id_isValid;
}

QString OAIAccessTokenRequestPassword_v2::getClientSecret() const {
    return m_client_secret;
}
void OAIAccessTokenRequestPassword_v2::setClientSecret(const QString &client_secret) {
    m_client_secret = client_secret;
    m_client_secret_isSet = true;
}

bool OAIAccessTokenRequestPassword_v2::is_client_secret_Set() const{
    return m_client_secret_isSet;
}

bool OAIAccessTokenRequestPassword_v2::is_client_secret_Valid() const{
    return m_client_secret_isValid;
}

QString OAIAccessTokenRequestPassword_v2::getGrantType() const {
    return m_grant_type;
}
void OAIAccessTokenRequestPassword_v2::setGrantType(const QString &grant_type) {
    m_grant_type = grant_type;
    m_grant_type_isSet = true;
}

bool OAIAccessTokenRequestPassword_v2::is_grant_type_Set() const{
    return m_grant_type_isSet;
}

bool OAIAccessTokenRequestPassword_v2::is_grant_type_Valid() const{
    return m_grant_type_isValid;
}

QString OAIAccessTokenRequestPassword_v2::getScope() const {
    return m_scope;
}
void OAIAccessTokenRequestPassword_v2::setScope(const QString &scope) {
    m_scope = scope;
    m_scope_isSet = true;
}

bool OAIAccessTokenRequestPassword_v2::is_scope_Set() const{
    return m_scope_isSet;
}

bool OAIAccessTokenRequestPassword_v2::is_scope_Valid() const{
    return m_scope_isValid;
}

bool OAIAccessTokenRequestPassword_v2::isSet() const {
...
bool OAIAccessTokenRequestPassword_v2::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_password_isValid && m_username_isValid && m_client_id_isValid && m_client_secret_isValid && m_grant_type_isValid && m_scope_isValid && true;
}
