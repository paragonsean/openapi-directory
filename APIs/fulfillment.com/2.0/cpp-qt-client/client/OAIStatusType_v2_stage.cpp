...
#include "OAIStatusType_v2_stage.h"
...
OAIStatusType_v2_stage::OAIStatusType_v2_stage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatusType_v2_stage::OAIStatusType_v2_stage() {
    this->initializeModel();
}

OAIStatusType_v2_stage::~OAIStatusType_v2_stage() {}

void OAIStatusType_v2_stage::initializeModel() {
...
void OAIStatusType_v2_stage::fromJson(QString jsonString) {
...
void OAIStatusType_v2_stage::fromJsonObject(QJsonObject json) {
...
QString OAIStatusType_v2_stage::asJson() const {
...
QJsonObject OAIStatusType_v2_stage::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIStatusType_v2_stage::getCode() const {
    return m_code;
}
void OAIStatusType_v2_stage::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIStatusType_v2_stage::is_code_Set() const{
    return m_code_isSet;
}

bool OAIStatusType_v2_stage::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIStatusType_v2_stage::getName() const {
    return m_name;
}
void OAIStatusType_v2_stage::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStatusType_v2_stage::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStatusType_v2_stage::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIStatusType_v2_stage::isSet() const {
...
bool OAIStatusType_v2_stage::isValid() const {
