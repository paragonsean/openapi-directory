...
/*
 * OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner.h
 *
 * 
 */

#ifndef OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner_H
#define OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner_H
...
namespace OpenAPI {
class OAICarrierHydrated_v2;

class OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner : public OAIObject {
public:
    OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner();
    OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner(QString json);
    ~OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner() override;
    ...
    OAICarrierHydrated_v2 getCarrier() const;
    void setCarrier(const OAICarrierHydrated_v2 &carrier);
...
private:
    ...
    OAICarrierHydrated_v2 m_carrier;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner)

#endif // OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner_H
