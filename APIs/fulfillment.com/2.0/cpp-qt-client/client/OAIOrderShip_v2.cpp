...
OAIOrderShip_v2::OAIOrderShip_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderShip_v2::OAIOrderShip_v2() {
    this->initializeModel();
}

OAIOrderShip_v2::~OAIOrderShip_v2() {}

void OAIOrderShip_v2::initializeModel() {

    m_tracking_number_isSet = false;
    m_tracking_number_isValid = false;

    m_weight_override_isSet = false;
    m_weight_override_isValid = false;
}

void OAIOrderShip_v2::fromJson(QString jsonString) {
...
void OAIOrderShip_v2::fromJsonObject(QJsonObject json) {
    ...
    m_weight_override_isValid = ::OpenAPI::fromJsonValue(m_weight_override, json[QString("weightOverride")]);
    m_weight_override_isSet = !json[QString("weightOverride")].isNull() && m_weight_override_isValid;
}

QString OAIOrderShip_v2::asJson() const {
...
QJsonObject OAIOrderShip_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_tracking_number_isSet) {
        obj.insert(QString("trackingNumber"), ::OpenAPI::toJsonValue(m_tracking_number));
    }
    if (m_weight_override_isSet) {
        obj.insert(QString("weightOverride"), ::OpenAPI::toJsonValue(m_weight_override));
    }
    return obj;
}

QString OAIOrderShip_v2::getTrackingNumber() const {
    return m_tracking_number;
}
void OAIOrderShip_v2::setTrackingNumber(const QString &tracking_number) {
    m_tracking_number = tracking_number;
    m_tracking_number_isSet = true;
}

bool OAIOrderShip_v2::is_tracking_number_Set() const{
    return m_tracking_number_isSet;
}

bool OAIOrderShip_v2::is_tracking_number_Valid() const{
    return m_tracking_number_isValid;
}

float OAIOrderShip_v2::getWeightOverride() const {
    return m_weight_override;
}
void OAIOrderShip_v2::setWeightOverride(const float &weight_override) {
    m_weight_override = weight_override;
    m_weight_override_isSet = true;
}

bool OAIOrderShip_v2::is_weight_override_Set() const{
    return m_weight_override_isSet;
}

bool OAIOrderShip_v2::is_weight_override_Valid() const{
    return m_weight_override_isValid;
}

bool OAIOrderShip_v2::isSet() const {
...
bool OAIOrderShip_v2::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_tracking_number_isValid && true;
}
