...
OAIAccountingArray_v2_meta::OAIAccountingArray_v2_meta(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountingArray_v2_meta::OAIAccountingArray_v2_meta() {
    this->initializeModel();
}

OAIAccountingArray_v2_meta::~OAIAccountingArray_v2_meta() {}

void OAIAccountingArray_v2_meta::initializeModel() {

    m_pagination_isSet = false;
    m_pagination_isValid = false;
}

void OAIAccountingArray_v2_meta::fromJson(QString jsonString) {
...
void OAIAccountingArray_v2_meta::fromJsonObject(QJsonObject json) {
...
QString OAIAccountingArray_v2_meta::asJson() const {
...
QJsonObject OAIAccountingArray_v2_meta::asJsonObject() const {
    QJsonObject obj;
...
OAIPagination_v2 OAIAccountingArray_v2_meta::getPagination() const {
    return m_pagination;
}
void OAIAccountingArray_v2_meta::setPagination(const OAIPagination_v2 &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIAccountingArray_v2_meta::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIAccountingArray_v2_meta::is_pagination_Valid() const{
    return m_pagination_isValid;
}

bool OAIAccountingArray_v2_meta::isSet() const {
...
bool OAIAccountingArray_v2_meta::isValid() const {
