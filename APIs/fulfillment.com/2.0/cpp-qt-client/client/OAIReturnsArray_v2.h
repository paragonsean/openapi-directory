...
/*
 * OAIReturnsArray_v2.h
 *
 * 
 */

#ifndef OAIReturnsArray_v2_H
#define OAIReturnsArray_v2_H
...
class OAIReturnsArray_v2 : public OAIObject {
public:
    OAIReturnsArray_v2();
    OAIReturnsArray_v2(QString json);
    ~OAIReturnsArray_v2() override;
    ...
    QList<OAIReturn_v2> getData() const;
    void setData(const QList<OAIReturn_v2> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturnsArray_v2)

#endif // OAIReturnsArray_v2_H
