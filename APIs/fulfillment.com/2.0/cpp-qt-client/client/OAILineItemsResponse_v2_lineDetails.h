...
/*
 * OAILineItemsResponse_v2_lineDetails.h
 *
 * 
 */

#ifndef OAILineItemsResponse_v2_lineDetails_H
#define OAILineItemsResponse_v2_lineDetails_H
...
class OAILineItemsResponse_v2_lineDetails : public OAIObject {
public:
    OAILineItemsResponse_v2_lineDetails();
    OAILineItemsResponse_v2_lineDetails(QString json);
    ~OAILineItemsResponse_v2_lineDetails() override;
    ...
    QString getExternalSku() const;
    void setExternalSku(const QString &external_sku);
    bool is_external_sku_Set() const;
    bool is_external_sku_Valid() const;
...
private:
    ...
    QString m_external_sku;
    bool m_external_sku_isSet;
    bool m_external_sku_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILineItemsResponse_v2_lineDetails)

#endif // OAILineItemsResponse_v2_lineDetails_H
