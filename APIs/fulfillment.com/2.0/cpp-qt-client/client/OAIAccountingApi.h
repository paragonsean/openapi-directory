...
#include "OAIAccountingArray_v2.h"
#include <QString>
...
public:
    ...
    * @param[in]  hydrate QList<QString> [required]
    * @param[in]  page qint32 [optional]
    * @param[in]  limit qint32 [optional]
    * @param[in]  warehouse_ids QList<qint32> [optional]
    * @param[in]  order_ids QList<qint32> [optional]
    */
    virtual void getAccounting(const QString &from_date, const QString &to_date, const QList<QString> &hydrate, const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<qint32>> &warehouse_ids = ::OpenAPI::OptionalParam<QList<qint32>>(), const ::OpenAPI::OptionalParam<QList<qint32>> &order_ids = ::OpenAPI::OptionalParam<QList<qint32>>());
...
private:
    ...
    void getAccountingCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getAccountingSignal(OAIAccountingArray_v2 summary);


    void getAccountingSignalFull(OAIHttpRequestWorker *worker, OAIAccountingArray_v2 summary);

    Q_DECL_DEPRECATED_X("Use getAccountingSignalError() instead")
    void getAccountingSignalE(OAIAccountingArray_v2 summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccountingSignalError(OAIAccountingArray_v2 summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getAccountingSignalErrorFull() instead")
    void getAccountingSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccountingSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
