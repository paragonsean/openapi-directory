...
/*
 * OAIUserContact_v2_merchant.h
 *
 * 
 */

#ifndef OAIUserContact_v2_merchant_H
#define OAIUserContact_v2_merchant_H
...
class OAIUserContact_v2_merchant : public OAIObject {
public:
    OAIUserContact_v2_merchant();
    OAIUserContact_v2_merchant(QString json);
    ~OAIUserContact_v2_merchant() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserContact_v2_merchant)

#endif // OAIUserContact_v2_merchant_H
