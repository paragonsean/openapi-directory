...
/*
 * OAIAccounting_v2_order.h
 *
 * 
 */

#ifndef OAIAccounting_v2_order_H
#define OAIAccounting_v2_order_H
...
class OAIAccounting_v2_order : public OAIObject {
public:
    OAIAccounting_v2_order();
    OAIAccounting_v2_order(QString json);
    ~OAIAccounting_v2_order() override;
    ...
    qint32 getMerchantOrderId() const;
    void setMerchantOrderId(const qint32 &merchant_order_id);
    bool is_merchant_order_id_Set() const;
    bool is_merchant_order_id_Valid() const;

    QDate getRecordedDate() const;
    void setRecordedDate(const QDate &recorded_date);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccounting_v2_order)

#endif // OAIAccounting_v2_order_H
