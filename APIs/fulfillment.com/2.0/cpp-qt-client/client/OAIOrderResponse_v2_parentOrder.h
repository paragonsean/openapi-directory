...
/*
 * OAIOrderResponse_v2_parentOrder.h
 *
 * 
 */

#ifndef OAIOrderResponse_v2_parentOrder_H
#define OAIOrderResponse_v2_parentOrder_H
...
class OAIOrderResponse_v2_parentOrder : public OAIObject {
public:
    OAIOrderResponse_v2_parentOrder();
    OAIOrderResponse_v2_parentOrder(QString json);
    ~OAIOrderResponse_v2_parentOrder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderResponse_v2_parentOrder)

#endif // OAIOrderResponse_v2_parentOrder_H
