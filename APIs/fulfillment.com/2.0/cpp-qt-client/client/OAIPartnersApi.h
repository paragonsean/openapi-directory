...
public:
    ...
    * @param[in]  body OAIOrderShip_v2 [required]
    */
    virtual void putOrdersIdShip(const qint32 &id, const OAIOrderShip_v2 &body);

    /**
    * @param[in]  id qint32 [required]
    * @param[in]  body OAIStatusTypeSimple_v2 [required]
    */
    virtual void putOrdersIdStatus(const qint32 &id, const OAIStatusTypeSimple_v2 &body);
...
private:
    ...
    void putOrdersIdShipCallback(OAIHttpRequestWorker *worker);
    void putOrdersIdStatusCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void putOrdersIdShipSignal(OAIObject summary);
    void putOrdersIdStatusSignal(OAIObject summary);


    void putOrdersIdShipSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void putOrdersIdStatusSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);

    Q_DECL_DEPRECATED_X("Use putOrdersIdShipSignalError() instead")
    void putOrdersIdShipSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void putOrdersIdShipSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use putOrdersIdStatusSignalError() instead")
    void putOrdersIdStatusSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void putOrdersIdStatusSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use putOrdersIdShipSignalErrorFull() instead")
    void putOrdersIdShipSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void putOrdersIdShipSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use putOrdersIdStatusSignalErrorFull() instead")
    void putOrdersIdStatusSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void putOrdersIdStatusSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
