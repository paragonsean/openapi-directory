...
OAIAccounting_v2_merchant::OAIAccounting_v2_merchant(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccounting_v2_merchant::OAIAccounting_v2_merchant() {
    this->initializeModel();
}

OAIAccounting_v2_merchant::~OAIAccounting_v2_merchant() {}

void OAIAccounting_v2_merchant::initializeModel() {
...
void OAIAccounting_v2_merchant::fromJson(QString jsonString) {
...
void OAIAccounting_v2_merchant::fromJsonObject(QJsonObject json) {
...
QString OAIAccounting_v2_merchant::asJson() const {
...
QJsonObject OAIAccounting_v2_merchant::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIAccounting_v2_merchant::getId() const {
    return m_id;
}
void OAIAccounting_v2_merchant::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAccounting_v2_merchant::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAccounting_v2_merchant::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAccounting_v2_merchant::getName() const {
    return m_name;
}
void OAIAccounting_v2_merchant::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAccounting_v2_merchant::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAccounting_v2_merchant::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIAccounting_v2_merchant::isSet() const {
...
bool OAIAccounting_v2_merchant::isValid() const {
