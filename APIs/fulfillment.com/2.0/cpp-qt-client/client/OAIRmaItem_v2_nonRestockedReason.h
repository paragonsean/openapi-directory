...
/*
 * OAIRmaItem_v2_nonRestockedReason.h
 *
 * 
 */

#ifndef OAIRmaItem_v2_nonRestockedReason_H
#define OAIRmaItem_v2_nonRestockedReason_H
...
class OAIRmaItem_v2_nonRestockedReason : public OAIObject {
public:
    OAIRmaItem_v2_nonRestockedReason();
    OAIRmaItem_v2_nonRestockedReason(QString json);
    ~OAIRmaItem_v2_nonRestockedReason() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRmaItem_v2_nonRestockedReason)

#endif // OAIRmaItem_v2_nonRestockedReason_H
