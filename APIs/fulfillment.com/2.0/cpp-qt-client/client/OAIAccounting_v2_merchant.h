...
/*
 * OAIAccounting_v2_merchant.h
 *
 * 
 */

#ifndef OAIAccounting_v2_merchant_H
#define OAIAccounting_v2_merchant_H
...
class OAIAccounting_v2_merchant : public OAIObject {
public:
    OAIAccounting_v2_merchant();
    OAIAccounting_v2_merchant(QString json);
    ~OAIAccounting_v2_merchant() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccounting_v2_merchant)

#endif // OAIAccounting_v2_merchant_H
