...
#include "OAILineItemsResponse_v2_requestedSkuData.h"
...
OAILineItemsResponse_v2_requestedSkuData::OAILineItemsResponse_v2_requestedSkuData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILineItemsResponse_v2_requestedSkuData::OAILineItemsResponse_v2_requestedSkuData() {
    this->initializeModel();
}

OAILineItemsResponse_v2_requestedSkuData::~OAILineItemsResponse_v2_requestedSkuData() {}

void OAILineItemsResponse_v2_requestedSkuData::initializeModel() {
...
void OAILineItemsResponse_v2_requestedSkuData::fromJson(QString jsonString) {
...
void OAILineItemsResponse_v2_requestedSkuData::fromJsonObject(QJsonObject json) {
...
QString OAILineItemsResponse_v2_requestedSkuData::asJson() const {
...
QJsonObject OAILineItemsResponse_v2_requestedSkuData::asJsonObject() const {
    QJsonObject obj;
...
QString OAILineItemsResponse_v2_requestedSkuData::getDeclaredValue() const {
    return m_declared_value;
}
void OAILineItemsResponse_v2_requestedSkuData::setDeclaredValue(const QString &declared_value) {
    m_declared_value = declared_value;
    m_declared_value_isSet = true;
}

bool OAILineItemsResponse_v2_requestedSkuData::is_declared_value_Set() const{
    return m_declared_value_isSet;
}

bool OAILineItemsResponse_v2_requestedSkuData::is_declared_value_Valid() const{
    return m_declared_value_isValid;
}

qint32 OAILineItemsResponse_v2_requestedSkuData::getId() const {
    return m_id;
}
void OAILineItemsResponse_v2_requestedSkuData::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILineItemsResponse_v2_requestedSkuData::is_id_Set() const{
    return m_id_isSet;
}

bool OAILineItemsResponse_v2_requestedSkuData::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAILineItemsResponse_v2_requestedSkuData::getQuantity() const {
    return m_quantity;
}
void OAILineItemsResponse_v2_requestedSkuData::setQuantity(const qint32 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAILineItemsResponse_v2_requestedSkuData::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAILineItemsResponse_v2_requestedSkuData::is_quantity_Valid() const{
    return m_quantity_isValid;
}

QString OAILineItemsResponse_v2_requestedSkuData::getSku() const {
    return m_sku;
}
void OAILineItemsResponse_v2_requestedSkuData::setSku(const QString &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}

bool OAILineItemsResponse_v2_requestedSkuData::is_sku_Set() const{
    return m_sku_isSet;
}

bool OAILineItemsResponse_v2_requestedSkuData::is_sku_Valid() const{
    return m_sku_isValid;
}

bool OAILineItemsResponse_v2_requestedSkuData::isSet() const {
...
bool OAILineItemsResponse_v2_requestedSkuData::isValid() const {
