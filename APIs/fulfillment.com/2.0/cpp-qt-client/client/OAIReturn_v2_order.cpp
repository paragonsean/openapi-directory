...
OAIReturn_v2_order::OAIReturn_v2_order(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReturn_v2_order::OAIReturn_v2_order() {
    this->initializeModel();
}

OAIReturn_v2_order::~OAIReturn_v2_order() {}

void OAIReturn_v2_order::initializeModel() {
...
void OAIReturn_v2_order::fromJson(QString jsonString) {
...
void OAIReturn_v2_order::fromJsonObject(QJsonObject json) {
...
QString OAIReturn_v2_order::asJson() const {
...
QJsonObject OAIReturn_v2_order::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIReturn_v2_order::getId() const {
    return m_id;
}
void OAIReturn_v2_order::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIReturn_v2_order::is_id_Set() const{
    return m_id_isSet;
}

bool OAIReturn_v2_order::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAIReturn_v2_order::getMerchantId() const {
    return m_merchant_id;
}
void OAIReturn_v2_order::setMerchantId(const qint32 &merchant_id) {
    m_merchant_id = merchant_id;
    m_merchant_id_isSet = true;
}

bool OAIReturn_v2_order::is_merchant_id_Set() const{
    return m_merchant_id_isSet;
}

bool OAIReturn_v2_order::is_merchant_id_Valid() const{
    return m_merchant_id_isValid;
}

QString OAIReturn_v2_order::getMerchantOrderId() const {
    return m_merchant_order_id;
}
void OAIReturn_v2_order::setMerchantOrderId(const QString &merchant_order_id) {
    m_merchant_order_id = merchant_order_id;
    m_merchant_order_id_isSet = true;
}

bool OAIReturn_v2_order::is_merchant_order_id_Set() const{
    return m_merchant_order_id_isSet;
}

bool OAIReturn_v2_order::is_merchant_order_id_Valid() const{
    return m_merchant_order_id_isValid;
}

bool OAIReturn_v2_order::isSet() const {
...
bool OAIReturn_v2_order::isValid() const {
