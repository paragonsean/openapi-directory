...
OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner() {
    this->initializeModel();
}

OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::~OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner() {}

void OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::initializeModel() {

    m_carrier_isSet = false;
    m_carrier_isValid = false;
}

void OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::fromJson(QString jsonString) {
...
void OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::fromJsonObject(QJsonObject json) {
...
QString OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::asJson() const {
...
QJsonObject OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_carrier.isSet()) {
...
OAICarrierHydrated_v2 OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::getCarrier() const {
    return m_carrier;
}
void OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::setCarrier(const OAICarrierHydrated_v2 &carrier) {
    m_carrier = carrier;
    m_carrier_isSet = true;
}

bool OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::is_carrier_Set() const{
    return m_carrier_isSet;
}

bool OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::is_carrier_Valid() const{
    return m_carrier_isValid;
}

bool OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::isSet() const {
...
bool OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner::isValid() const {
