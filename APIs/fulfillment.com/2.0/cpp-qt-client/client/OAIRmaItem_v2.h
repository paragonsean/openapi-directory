...
#ifndef OAIRmaItem_v2_H
#define OAIRmaItem_v2_H

#include <QJsonObject>

#include "OAIRmaItem_v2_item.h"
#include "OAIRmaItem_v2_nonRestockedReason.h"
#include <QString>
...
namespace OpenAPI {
class OAIRmaItem_v2_item;
class OAIRmaItem_v2_nonRestockedReason;

class OAIRmaItem_v2 : public OAIObject {
public:
    OAIRmaItem_v2();
    OAIRmaItem_v2(QString json);
    ~OAIRmaItem_v2() override;
    ...
    OAIRmaItem_v2_item getItem() const;
    void setItem(const OAIRmaItem_v2_item &item);
    bool is_item_Set() const;
    bool is_item_Valid() const;

    OAIRmaItem_v2_nonRestockedReason getNonRestockedReason() const;
    void setNonRestockedReason(const OAIRmaItem_v2_nonRestockedReason &non_restocked_reason);
    bool is_non_restocked_reason_Set() const;
    bool is_non_restocked_reason_Valid() const;

    qint32 getQuantityExpected() const;
    void setQuantityExpected(const qint32 &quantity_expected);
    bool is_quantity_expected_Set() const;
    bool is_quantity_expected_Valid() const;

    qint32 getQuantityRestocked() const;
    void setQuantityRestocked(const qint32 &quantity_restocked);
    bool is_quantity_restocked_Set() const;
    bool is_quantity_restocked_Valid() const;
...
private:
    ...
    OAIRmaItem_v2_item m_item;
    bool m_item_isSet;
    bool m_item_isValid;

    OAIRmaItem_v2_nonRestockedReason m_non_restocked_reason;
    bool m_non_restocked_reason_isSet;
    bool m_non_restocked_reason_isValid;

    qint32 m_quantity_expected;
    bool m_quantity_expected_isSet;
    bool m_quantity_expected_isValid;

    qint32 m_quantity_restocked;
    bool m_quantity_restocked_isSet;
    bool m_quantity_restocked_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRmaItem_v2)

#endif // OAIRmaItem_v2_H
