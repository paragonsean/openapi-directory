...
#include "OAIErrorStandardWithContext_v2.h"
#include "OAIErrorStandard_v2.h"
#include "OAIObject.h"
...
public:
    ...
    */
    virtual void deleteOrdersId(const qint32 &id);

    /**
    * @param[in]  id QString [required]
    * @param[in]  merchant_id qint32 [optional]
    * @param[in]  hydrate QList<QString> [optional]
    */
    virtual void getOrder(const QString &id, const ::OpenAPI::OptionalParam<qint32> &merchant_id = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &hydrate = ::OpenAPI::OptionalParam<QList<QString>>());

    /**
    * @param[in]  from_date QString [required]
    * @param[in]  to_date QString [required]
    * @param[in]  merchant_ids QList<qint32> [optional]
    * @param[in]  warehouse_ids QList<qint32> [optional]
    * @param[in]  page qint32 [optional]
    * @param[in]  limit qint32 [optional]
    * @param[in]  hydrate QList<QString> [optional]
    */
    virtual void getOrders(const QString &from_date, const QString &to_date, const ::OpenAPI::OptionalParam<QList<qint32>> &merchant_ids = ::OpenAPI::OptionalParam<QList<qint32>>(), const ::OpenAPI::OptionalParam<QList<qint32>> &warehouse_ids = ::OpenAPI::OptionalParam<QList<qint32>>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QList<QString>> &hydrate = ::OpenAPI::OptionalParam<QList<QString>>());

    /**
    * @param[in]  body OAIOrderRequest_v2 [required]
    */
    virtual void postOrders(const OAIOrderRequest_v2 &body);
...
private:
    ...
    void deleteOrdersIdCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void deleteOrdersIdSignal(OAIObject summary);
    void getOrderSignal(OAIObject summary);
    void getOrdersSignal(OAIOrderResponseOneOf_v2 summary);
    void postOrdersSignal(OAIOrderResponse_v2 summary);


    void deleteOrdersIdSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getOrderSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getOrdersSignalFull(OAIHttpRequestWorker *worker, OAIOrderResponseOneOf_v2 summary);
    void postOrdersSignalFull(OAIHttpRequestWorker *worker, OAIOrderResponse_v2 summary);

    Q_DECL_DEPRECATED_X("Use deleteOrdersIdSignalError() instead")
    void deleteOrdersIdSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteOrdersIdSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getOrderSignalError() instead")
    void getOrderSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getOrderSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getOrdersSignalError() instead")
    void getOrdersSignalE(OAIOrderResponseOneOf_v2 summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getOrdersSignalError(OAIOrderResponseOneOf_v2 summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postOrdersSignalError() instead")
    void postOrdersSignalE(OAIOrderResponse_v2 summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postOrdersSignalError(OAIOrderResponse_v2 summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use deleteOrdersIdSignalErrorFull() instead")
    void deleteOrdersIdSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteOrdersIdSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
