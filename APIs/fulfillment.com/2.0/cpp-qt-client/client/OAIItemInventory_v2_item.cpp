...
#include "OAIItemInventory_v2_item.h"
...
OAIItemInventory_v2_item::OAIItemInventory_v2_item(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIItemInventory_v2_item::OAIItemInventory_v2_item() {
    this->initializeModel();
}

OAIItemInventory_v2_item::~OAIItemInventory_v2_item() {}

void OAIItemInventory_v2_item::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;

    m_sku_reference_isSet = false;
    m_sku_reference_isValid = false;
}

void OAIItemInventory_v2_item::fromJson(QString jsonString) {
...
void OAIItemInventory_v2_item::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;

    m_sku_reference_isValid = ::OpenAPI::fromJsonValue(m_sku_reference, json[QString("skuReference")]);
    m_sku_reference_isSet = !json[QString("skuReference")].isNull() && m_sku_reference_isValid;
}

QString OAIItemInventory_v2_item::asJson() const {
...
QJsonObject OAIItemInventory_v2_item::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
        obj.insert(QString("id"), ::OpenAPI::toJsonValue(m_id));
    }
    if (m_sku_reference_isSet) {
        obj.insert(QString("skuReference"), ::OpenAPI::toJsonValue(m_sku_reference));
    }
    return obj;
}

qint32 OAIItemInventory_v2_item::getId() const {
    return m_id;
}
void OAIItemInventory_v2_item::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIItemInventory_v2_item::is_id_Set() const{
    return m_id_isSet;
}

bool OAIItemInventory_v2_item::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIItemInventory_v2_item::getSkuReference() const {
    return m_sku_reference;
}
void OAIItemInventory_v2_item::setSkuReference(const QString &sku_reference) {
    m_sku_reference = sku_reference;
    m_sku_reference_isSet = true;
}

bool OAIItemInventory_v2_item::is_sku_reference_Set() const{
    return m_sku_reference_isSet;
}

bool OAIItemInventory_v2_item::is_sku_reference_Valid() const{
    return m_sku_reference_isValid;
}

bool OAIItemInventory_v2_item::isSet() const {
...
bool OAIItemInventory_v2_item::isValid() const {
