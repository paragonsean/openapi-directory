...
/*
 * OAIOrderRequest_v2_items_inner.h
 *
 * 
 */

#ifndef OAIOrderRequest_v2_items_inner_H
#define OAIOrderRequest_v2_items_inner_H
...
class OAIOrderRequest_v2_items_inner : public OAIObject {
public:
    OAIOrderRequest_v2_items_inner();
    OAIOrderRequest_v2_items_inner(QString json);
    ~OAIOrderRequest_v2_items_inner() override;
    ...
    QString getDeclaredValue() const;
    void setDeclaredValue(const QString &declared_value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderRequest_v2_items_inner)

#endif // OAIOrderRequest_v2_items_inner_H
