...
/*
 * OAILineItemsResponse_v2_requestedSkuData.h
 *
 * 
 */

#ifndef OAILineItemsResponse_v2_requestedSkuData_H
#define OAILineItemsResponse_v2_requestedSkuData_H
...
class OAILineItemsResponse_v2_requestedSkuData : public OAIObject {
public:
    OAILineItemsResponse_v2_requestedSkuData();
    OAILineItemsResponse_v2_requestedSkuData(QString json);
    ~OAILineItemsResponse_v2_requestedSkuData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILineItemsResponse_v2_requestedSkuData)

#endif // OAILineItemsResponse_v2_requestedSkuData_H
