...
#ifndef OAIRmaRequest_v2_H
#define OAIRmaRequest_v2_H
...
class OAIRmaRequest_v2 : public OAIObject {
public:
    OAIRmaRequest_v2();
    OAIRmaRequest_v2(QString json);
    ~OAIRmaRequest_v2() override;
    ...
    OAIObject getRecipient() const;
    void setRecipient(const OAIObject &recipient);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRmaRequest_v2)

#endif // OAIRmaRequest_v2_H
