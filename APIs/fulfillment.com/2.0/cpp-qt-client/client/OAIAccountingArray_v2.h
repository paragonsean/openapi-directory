...
/*
 * OAIAccountingArray_v2.h
 *
 * 
 */

#ifndef OAIAccountingArray_v2_H
#define OAIAccountingArray_v2_H

#include <QJsonObject>

#include "OAIAccountingArray_v2_meta.h"
#include "OAIAccounting_v2.h"
#include <QList>
...
namespace OpenAPI {
class OAIAccounting_v2;
class OAIAccountingArray_v2_meta;

class OAIAccountingArray_v2 : public OAIObject {
public:
    OAIAccountingArray_v2();
    OAIAccountingArray_v2(QString json);
    ~OAIAccountingArray_v2() override;
    ...
    QList<OAIAccounting_v2> getData() const;
    void setData(const QList<OAIAccounting_v2> &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIAccountingArray_v2_meta getMeta() const;
    void setMeta(const OAIAccountingArray_v2_meta &meta);
...
private:
    ...
    QList<OAIAccounting_v2> m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIAccountingArray_v2_meta m_meta;
    bool m_meta_isSet;
    bool m_meta_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountingArray_v2)

#endif // OAIAccountingArray_v2_H
