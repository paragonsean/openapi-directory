...
/*
 * OAIStatusType_v2_stage.h
 *
 * 
 */

#ifndef OAIStatusType_v2_stage_H
#define OAIStatusType_v2_stage_H
...
class OAIStatusType_v2_stage : public OAIObject {
public:
    OAIStatusType_v2_stage();
    OAIStatusType_v2_stage(QString json);
    ~OAIStatusType_v2_stage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusType_v2_stage)

#endif // OAIStatusType_v2_stage_H
