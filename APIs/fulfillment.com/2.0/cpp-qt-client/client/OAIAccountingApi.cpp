...
OAIAccountingApi::OAIAccountingApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIAccountingApi::~OAIAccountingApi() {
}

void OAIAccountingApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getAccounting", defaultConf);
    _serverIndices.insert("getAccounting", 0);
}
...
*/
int OAIAccountingApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIAccountingApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIAccountingApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIAccountingApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIAccountingApi::setUsername(const QString &username) {
    _username = username;
}

void OAIAccountingApi::setPassword(const QString &password) {
    _password = password;
}


void OAIAccountingApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIAccountingApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIAccountingApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIAccountingApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAccountingApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAccountingApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIAccountingApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIAccountingApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIAccountingApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIAccountingApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIAccountingApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIAccountingApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIAccountingApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIAccountingApi::getAccounting(const QString &from_date, const QString &to_date, const QList<QString> &hydrate, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<QList<qint32>> &warehouse_ids, const ::OpenAPI::OptionalParam<QList<qint32>> &order_ids) {
    QString fullPath = QString(_serverConfigs["getAccounting"][_serverIndices.value("getAccounting")].URL()+"/accounting");
    ...
    
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "hydrate", true);
        if (hydrate.size() > 0) {
            if (QString("multi").indexOf("multi") == 0) {
                for (QString t : hydrate) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountingApi::getAccountingCallback);
    connect(this, &OAIAccountingApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountingApi::getAccountingCallback);
    connect(this, &OAIAccountingApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIAccountingApi::getAccountingCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIAccountingArray_v2 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAccountingSignal(output);
        Q_EMIT getAccountingSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAccountingSignalE(output, error_type, error_str);
        Q_EMIT getAccountingSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAccountingSignalError(output, error_type, error_str);
        Q_EMIT getAccountingSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAccountingApi::tokenAvailable(){
