...
void OAIPartnersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("putOrdersIdShip", defaultConf);
    _serverIndices.insert("putOrdersIdShip", 0);
    _serverConfigs.insert("putOrdersIdStatus", defaultConf);
    _serverIndices.insert("putOrdersIdStatus", 0);
}
...
void OAIPartnersApi::putOrdersIdShip(const qint32 &id, const OAIOrderShip_v2 &body) {
    QString fullPath = QString(_serverConfigs["putOrdersIdShip"][_serverIndices.value("putOrdersIdShip")].URL()+"/orders/{id}/ship");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPartnersApi::putOrdersIdShipCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPartnersApi::putOrdersIdShipCallback);
...
void OAIPartnersApi::putOrdersIdShipCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT putOrdersIdShipSignal(output);
        Q_EMIT putOrdersIdShipSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT putOrdersIdShipSignalE(output, error_type, error_str);
        Q_EMIT putOrdersIdShipSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT putOrdersIdShipSignalError(output, error_type, error_str);
        Q_EMIT putOrdersIdShipSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPartnersApi::putOrdersIdStatus(const qint32 &id, const OAIStatusTypeSimple_v2 &body) {
    QString fullPath = QString(_serverConfigs["putOrdersIdStatus"][_serverIndices.value("putOrdersIdStatus")].URL()+"/orders/{id}/status");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPartnersApi::putOrdersIdStatusCallback);
    connect(this, &OAIPartnersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPartnersApi::putOrdersIdStatusCallback);
    connect(this, &OAIPartnersApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPartnersApi::putOrdersIdStatusCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT putOrdersIdStatusSignal(output);
        Q_EMIT putOrdersIdStatusSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT putOrdersIdStatusSignalE(output, error_type, error_str);
        Q_EMIT putOrdersIdStatusSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT putOrdersIdStatusSignalError(output, error_type, error_str);
        Q_EMIT putOrdersIdStatusSignalErrorFull(worker, error_type, error_str);
    }
}
