...
private:
    ...
    void getUsersMeCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getUsersMeSignal(OAIUserContact_v2 summary);


    void getUsersMeSignalFull(OAIHttpRequestWorker *worker, OAIUserContact_v2 summary);

    Q_DECL_DEPRECATED_X("Use getUsersMeSignalError() instead")
    void getUsersMeSignalE(OAIUserContact_v2 summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getUsersMeSignalError(OAIUserContact_v2 summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getUsersMeSignalErrorFull() instead")
    void getUsersMeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getUsersMeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
