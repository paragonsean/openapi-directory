...
OAIConsigneeNew_v2::OAIConsigneeNew_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConsigneeNew_v2::OAIConsigneeNew_v2() {
    this->initializeModel();
}

OAIConsigneeNew_v2::~OAIConsigneeNew_v2() {}

void OAIConsigneeNew_v2::initializeModel() {
...
void OAIConsigneeNew_v2::fromJson(QString jsonString) {
...
void OAIConsigneeNew_v2::fromJsonObject(QJsonObject json) {
...
QString OAIConsigneeNew_v2::asJson() const {
...
QJsonObject OAIConsigneeNew_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_address1_isSet) {
...
QString OAIConsigneeNew_v2::getAddress1() const {
    return m_address1;
}
void OAIConsigneeNew_v2::setAddress1(const QString &address1) {
    m_address1 = address1;
    m_address1_isSet = true;
}

bool OAIConsigneeNew_v2::is_address1_Set() const{
    return m_address1_isSet;
}

bool OAIConsigneeNew_v2::is_address1_Valid() const{
    return m_address1_isValid;
}

QString OAIConsigneeNew_v2::getAddress2() const {
    return m_address2;
}
void OAIConsigneeNew_v2::setAddress2(const QString &address2) {
    m_address2 = address2;
    m_address2_isSet = true;
}

bool OAIConsigneeNew_v2::is_address2_Set() const{
    return m_address2_isSet;
}

bool OAIConsigneeNew_v2::is_address2_Valid() const{
    return m_address2_isValid;
}

QString OAIConsigneeNew_v2::getAddressLocality() const {
    return m_address_locality;
}
void OAIConsigneeNew_v2::setAddressLocality(const QString &address_locality) {
    m_address_locality = address_locality;
    m_address_locality_isSet = true;
}

bool OAIConsigneeNew_v2::is_address_locality_Set() const{
    return m_address_locality_isSet;
}

bool OAIConsigneeNew_v2::is_address_locality_Valid() const{
    return m_address_locality_isValid;
}

QString OAIConsigneeNew_v2::getAddressRegion() const {
    return m_address_region;
}
void OAIConsigneeNew_v2::setAddressRegion(const QString &address_region) {
    m_address_region = address_region;
    m_address_region_isSet = true;
}

bool OAIConsigneeNew_v2::is_address_region_Set() const{
    return m_address_region_isSet;
}

bool OAIConsigneeNew_v2::is_address_region_Valid() const{
    return m_address_region_isValid;
}

QString OAIConsigneeNew_v2::getCompanyName() const {
    return m_company_name;
}
void OAIConsigneeNew_v2::setCompanyName(const QString &company_name) {
    m_company_name = company_name;
    m_company_name_isSet = true;
}

bool OAIConsigneeNew_v2::is_company_name_Set() const{
    return m_company_name_isSet;
}

bool OAIConsigneeNew_v2::is_company_name_Valid() const{
    return m_company_name_isValid;
}

QString OAIConsigneeNew_v2::getCountry() const {
    return m_country;
}
void OAIConsigneeNew_v2::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIConsigneeNew_v2::is_country_Set() const{
    return m_country_isSet;
}

bool OAIConsigneeNew_v2::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIConsigneeNew_v2::getEmail() const {
    return m_email;
}
void OAIConsigneeNew_v2::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIConsigneeNew_v2::is_email_Set() const{
    return m_email_isSet;
}

bool OAIConsigneeNew_v2::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIConsigneeNew_v2::getFirstName() const {
    return m_first_name;
}
void OAIConsigneeNew_v2::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIConsigneeNew_v2::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIConsigneeNew_v2::is_first_name_Valid() const{
    return m_first_name_isValid;
}

QString OAIConsigneeNew_v2::getLastName() const {
    return m_last_name;
}
void OAIConsigneeNew_v2::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIConsigneeNew_v2::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIConsigneeNew_v2::is_last_name_Valid() const{
    return m_last_name_isValid;
}

QString OAIConsigneeNew_v2::getPhone() const {
    return m_phone;
}
void OAIConsigneeNew_v2::setPhone(const QString &phone) {
    m_phone = phone;
    m_phone_isSet = true;
}

bool OAIConsigneeNew_v2::is_phone_Set() const{
    return m_phone_isSet;
}

bool OAIConsigneeNew_v2::is_phone_Valid() const{
    return m_phone_isValid;
}

QString OAIConsigneeNew_v2::getPostalCode() const {
    return m_postal_code;
}
void OAIConsigneeNew_v2::setPostalCode(const QString &postal_code) {
    m_postal_code = postal_code;
    m_postal_code_isSet = true;
}

bool OAIConsigneeNew_v2::is_postal_code_Set() const{
    return m_postal_code_isSet;
}

bool OAIConsigneeNew_v2::is_postal_code_Valid() const{
    return m_postal_code_isValid;
}

bool OAIConsigneeNew_v2::isSet() const {
...
bool OAIConsigneeNew_v2::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_address1_isValid && m_address_locality_isValid && m_address_region_isValid && m_country_isValid && m_email_isValid && m_first_name_isValid && m_last_name_isValid && m_phone_isValid && true;
}
