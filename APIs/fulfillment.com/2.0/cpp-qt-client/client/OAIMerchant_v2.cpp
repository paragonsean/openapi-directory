...
OAIMerchant_v2::OAIMerchant_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMerchant_v2::OAIMerchant_v2() {
    this->initializeModel();
}

OAIMerchant_v2::~OAIMerchant_v2() {}

void OAIMerchant_v2::initializeModel() {
...
void OAIMerchant_v2::fromJson(QString jsonString) {
...
void OAIMerchant_v2::fromJsonObject(QJsonObject json) {
...
QString OAIMerchant_v2::asJson() const {
...
QJsonObject OAIMerchant_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIMerchant_v2::getId() const {
    return m_id;
}
void OAIMerchant_v2::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMerchant_v2::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMerchant_v2::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIMerchant_v2::getName() const {
    return m_name;
}
void OAIMerchant_v2::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMerchant_v2::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMerchant_v2::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIMerchant_v2::isSet() const {
...
bool OAIMerchant_v2::isValid() const {
