...
#include "OAIItemInventory_v2_merchant.h"
...
OAIItemInventory_v2_merchant::OAIItemInventory_v2_merchant(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIItemInventory_v2_merchant::OAIItemInventory_v2_merchant() {
    this->initializeModel();
}

OAIItemInventory_v2_merchant::~OAIItemInventory_v2_merchant() {}

void OAIItemInventory_v2_merchant::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIItemInventory_v2_merchant::fromJson(QString jsonString) {
...
void OAIItemInventory_v2_merchant::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIItemInventory_v2_merchant::asJson() const {
...
QJsonObject OAIItemInventory_v2_merchant::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIItemInventory_v2_merchant::getName() const {
    return m_name;
}
void OAIItemInventory_v2_merchant::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIItemInventory_v2_merchant::is_name_Set() const{
    return m_name_isSet;
}

bool OAIItemInventory_v2_merchant::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIItemInventory_v2_merchant::isSet() const {
...
bool OAIItemInventory_v2_merchant::isValid() const {
