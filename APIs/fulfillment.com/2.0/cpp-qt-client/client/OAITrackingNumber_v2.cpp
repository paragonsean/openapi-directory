...
OAITrackingNumber_v2::OAITrackingNumber_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrackingNumber_v2::OAITrackingNumber_v2() {
    this->initializeModel();
}

OAITrackingNumber_v2::~OAITrackingNumber_v2() {}

void OAITrackingNumber_v2::initializeModel() {

    m_barcode_scan_value_isSet = false;
    m_barcode_scan_value_isValid = false;
...
void OAITrackingNumber_v2::fromJson(QString jsonString) {
...
void OAITrackingNumber_v2::fromJsonObject(QJsonObject json) {

    m_barcode_scan_value_isValid = ::OpenAPI::fromJsonValue(m_barcode_scan_value, json[QString("barcodeScanValue")]);
    m_barcode_scan_value_isSet = !json[QString("barcodeScanValue")].isNull() && m_barcode_scan_value_isValid;
...
QString OAITrackingNumber_v2::asJson() const {
...
QJsonObject OAITrackingNumber_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_barcode_scan_value_isSet) {
        obj.insert(QString("barcodeScanValue"), ::OpenAPI::toJsonValue(m_barcode_scan_value));
    }
    if (m_carrier.isSet()) {
...
QString OAITrackingNumber_v2::getBarcodeScanValue() const {
    return m_barcode_scan_value;
}
void OAITrackingNumber_v2::setBarcodeScanValue(const QString &barcode_scan_value) {
    m_barcode_scan_value = barcode_scan_value;
    m_barcode_scan_value_isSet = true;
}

bool OAITrackingNumber_v2::is_barcode_scan_value_Set() const{
    return m_barcode_scan_value_isSet;
}

bool OAITrackingNumber_v2::is_barcode_scan_value_Valid() const{
    return m_barcode_scan_value_isValid;
}

OAICarrierSimple_v2 OAITrackingNumber_v2::getCarrier() const {
    return m_carrier;
}
void OAITrackingNumber_v2::setCarrier(const OAICarrierSimple_v2 &carrier) {
    m_carrier = carrier;
    m_carrier_isSet = true;
}

bool OAITrackingNumber_v2::is_carrier_Set() const{
    return m_carrier_isSet;
}

bool OAITrackingNumber_v2::is_carrier_Valid() const{
    return m_carrier_isValid;
}

QString OAITrackingNumber_v2::getValue() const {
    return m_value;
}
void OAITrackingNumber_v2::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAITrackingNumber_v2::is_value_Set() const{
    return m_value_isSet;
}

bool OAITrackingNumber_v2::is_value_Valid() const{
    return m_value_isValid;
}

bool OAITrackingNumber_v2::isSet() const {
...
bool OAITrackingNumber_v2::isValid() const {
