...
OAIItemInventory_v2_quantity::OAIItemInventory_v2_quantity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIItemInventory_v2_quantity::OAIItemInventory_v2_quantity() {
    this->initializeModel();
}

OAIItemInventory_v2_quantity::~OAIItemInventory_v2_quantity() {}

void OAIItemInventory_v2_quantity::initializeModel() {

    m_total_isSet = false;
    m_total_isValid = false;
}

void OAIItemInventory_v2_quantity::fromJson(QString jsonString) {
...
void OAIItemInventory_v2_quantity::fromJsonObject(QJsonObject json) {

    m_total_isValid = ::OpenAPI::fromJsonValue(m_total, json[QString("total")]);
    m_total_isSet = !json[QString("total")].isNull() && m_total_isValid;
}

QString OAIItemInventory_v2_quantity::asJson() const {
...
QJsonObject OAIItemInventory_v2_quantity::asJsonObject() const {
    QJsonObject obj;
    if (m_total.isSet()) {
...
OAIItemInventory_v2_quantity_total OAIItemInventory_v2_quantity::getTotal() const {
    return m_total;
}
void OAIItemInventory_v2_quantity::setTotal(const OAIItemInventory_v2_quantity_total &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIItemInventory_v2_quantity::is_total_Set() const{
    return m_total_isSet;
}

bool OAIItemInventory_v2_quantity::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIItemInventory_v2_quantity::isSet() const {
...
bool OAIItemInventory_v2_quantity::isValid() const {
