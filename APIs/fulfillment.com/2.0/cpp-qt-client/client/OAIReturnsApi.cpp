...
void OAIReturnsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("putReturns", defaultConf);
    _serverIndices.insert("putReturns", 0);
}
...
void OAIReturnsApi::getReturns(const QString &from_date, const QString &to_date, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &limit) {
    QString fullPath = QString(_serverConfigs["getReturns"][_serverIndices.value("getReturns")].URL()+"/returns");
...
void OAIReturnsApi::getReturnsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIReturnsArray_v2 output(QString(worker->response));
    worker->deleteLater();
...
void OAIReturnsApi::putReturns(const OAIRmaRequest_v2 &oai_rma_request_v2) {
    QString fullPath = QString(_serverConfigs["putReturns"][_serverIndices.value("putReturns")].URL()+"/returns");
...

    {
        ...
        QByteArray output = oai_rma_request_v2.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReturnsApi::putReturnsCallback);
    connect(this, &OAIReturnsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReturnsApi::putReturnsCallback);
    connect(this, &OAIReturnsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReturnsApi::putReturnsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIRmaResponse_v2 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT putReturnsSignal(output);
        Q_EMIT putReturnsSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT putReturnsSignalE(output, error_type, error_str);
        Q_EMIT putReturnsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT putReturnsSignalError(output, error_type, error_str);
        Q_EMIT putReturnsSignalErrorFull(worker, error_type, error_str);
    }
}
