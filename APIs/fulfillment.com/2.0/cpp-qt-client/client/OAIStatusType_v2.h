...
#ifndef OAIStatusType_v2_H
#define OAIStatusType_v2_H
...
namespace OpenAPI {
class OAIStatusType_v2_actionRequiredBy;
class OAIStatusType_v2_stage;

class OAIStatusType_v2 : public OAIObject {
public:
    OAIStatusType_v2();
    OAIStatusType_v2(QString json);
    ~OAIStatusType_v2() override;
    ...
    OAIStatusType_v2_actionRequiredBy getActionRequiredBy() const;
    void setActionRequiredBy(const OAIStatusType_v2_actionRequiredBy &action_required_by);
    bool is_action_required_by_Set() const;
    bool is_action_required_by_Valid() const;
    ...
    QString getDetailCode() const;
    void setDetailCode(const QString &detail_code);
    bool is_detail_code_Set() const;
    bool is_detail_code_Valid() const;
    ...
    OAIStatusType_v2_stage getStage() const;
    void setStage(const OAIStatusType_v2_stage &stage);
    bool is_stage_Set() const;
    bool is_stage_Valid() const;

    OAIStatusType_v2_stage getState() const;
    void setState(const OAIStatusType_v2_stage &state);
...
private:
    ...
    OAIStatusType_v2_actionRequiredBy m_action_required_by;
    bool m_action_required_by_isSet;
    bool m_action_required_by_isValid;
    ...
    QString m_detail_code;
    bool m_detail_code_isSet;
    bool m_detail_code_isValid;
    ...
    OAIStatusType_v2_stage m_stage;
    bool m_stage_isSet;
    bool m_stage_isValid;

    OAIStatusType_v2_stage m_state;
    bool m_state_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusType_v2)

#endif // OAIStatusType_v2_H
