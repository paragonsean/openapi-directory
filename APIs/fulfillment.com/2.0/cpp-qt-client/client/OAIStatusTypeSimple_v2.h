...
/*
 * OAIStatusTypeSimple_v2.h
 *
 * 
 */

#ifndef OAIStatusTypeSimple_v2_H
#define OAIStatusTypeSimple_v2_H

#include <QJsonObject>

#include "OAIStatusTypeSimple_v2_status.h"
#include <QString>
...
namespace OpenAPI {
class OAIStatusTypeSimple_v2_status;

class OAIStatusTypeSimple_v2 : public OAIObject {
public:
    OAIStatusTypeSimple_v2();
    OAIStatusTypeSimple_v2(QString json);
    ~OAIStatusTypeSimple_v2() override;
    ...
    OAIStatusTypeSimple_v2_status getStatus() const;
    void setStatus(const OAIStatusTypeSimple_v2_status &status);
...
private:
    ...
    OAIStatusTypeSimple_v2_status m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusTypeSimple_v2)

#endif // OAIStatusTypeSimple_v2_H
