...
#include "OAILineItemsResponse_v2_inventoryDetails_inner.h"
...
OAILineItemsResponse_v2_inventoryDetails_inner::OAILineItemsResponse_v2_inventoryDetails_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILineItemsResponse_v2_inventoryDetails_inner::OAILineItemsResponse_v2_inventoryDetails_inner() {
    this->initializeModel();
}

OAILineItemsResponse_v2_inventoryDetails_inner::~OAILineItemsResponse_v2_inventoryDetails_inner() {}

void OAILineItemsResponse_v2_inventoryDetails_inner::initializeModel() {

    m_expiration_date_isSet = false;
    m_expiration_date_isValid = false;

    m_lot_num_isSet = false;
    m_lot_num_isValid = false;

    m_quantity_isSet = false;
    m_quantity_isValid = false;

    m_serial_num_isSet = false;
    m_serial_num_isValid = false;
}

void OAILineItemsResponse_v2_inventoryDetails_inner::fromJson(QString jsonString) {
...
void OAILineItemsResponse_v2_inventoryDetails_inner::fromJsonObject(QJsonObject json) {
    ...
    m_lot_num_isValid = ::OpenAPI::fromJsonValue(m_lot_num, json[QString("lotNum")]);
    m_lot_num_isSet = !json[QString("lotNum")].isNull() && m_lot_num_isValid;

    m_quantity_isValid = ::OpenAPI::fromJsonValue(m_quantity, json[QString("quantity")]);
    m_quantity_isSet = !json[QString("quantity")].isNull() && m_quantity_isValid;

    m_serial_num_isValid = ::OpenAPI::fromJsonValue(m_serial_num, json[QString("serialNum")]);
    m_serial_num_isSet = !json[QString("serialNum")].isNull() && m_serial_num_isValid;
}

QString OAILineItemsResponse_v2_inventoryDetails_inner::asJson() const {
...
QJsonObject OAILineItemsResponse_v2_inventoryDetails_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_expiration_date_isSet) {
        obj.insert(QString("expirationDate"), ::OpenAPI::toJsonValue(m_expiration_date));
    }
    if (m_lot_num_isSet) {
        obj.insert(QString("lotNum"), ::OpenAPI::toJsonValue(m_lot_num));
    }
    if (m_quantity_isSet) {
        obj.insert(QString("quantity"), ::OpenAPI::toJsonValue(m_quantity));
    }
    if (m_serial_num_isSet) {
        obj.insert(QString("serialNum"), ::OpenAPI::toJsonValue(m_serial_num));
    }
    return obj;
}

QDate OAILineItemsResponse_v2_inventoryDetails_inner::getExpirationDate() const {
    return m_expiration_date;
}
void OAILineItemsResponse_v2_inventoryDetails_inner::setExpirationDate(const QDate &expiration_date) {
    m_expiration_date = expiration_date;
    m_expiration_date_isSet = true;
}

bool OAILineItemsResponse_v2_inventoryDetails_inner::is_expiration_date_Set() const{
    return m_expiration_date_isSet;
}

bool OAILineItemsResponse_v2_inventoryDetails_inner::is_expiration_date_Valid() const{
    return m_expiration_date_isValid;
}

QString OAILineItemsResponse_v2_inventoryDetails_inner::getLotNum() const {
    return m_lot_num;
}
void OAILineItemsResponse_v2_inventoryDetails_inner::setLotNum(const QString &lot_num) {
    m_lot_num = lot_num;
    m_lot_num_isSet = true;
}

bool OAILineItemsResponse_v2_inventoryDetails_inner::is_lot_num_Set() const{
    return m_lot_num_isSet;
}

bool OAILineItemsResponse_v2_inventoryDetails_inner::is_lot_num_Valid() const{
    return m_lot_num_isValid;
}

qint32 OAILineItemsResponse_v2_inventoryDetails_inner::getQuantity() const {
    return m_quantity;
}
void OAILineItemsResponse_v2_inventoryDetails_inner::setQuantity(const qint32 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAILineItemsResponse_v2_inventoryDetails_inner::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAILineItemsResponse_v2_inventoryDetails_inner::is_quantity_Valid() const{
    return m_quantity_isValid;
}

QString OAILineItemsResponse_v2_inventoryDetails_inner::getSerialNum() const {
    return m_serial_num;
}
void OAILineItemsResponse_v2_inventoryDetails_inner::setSerialNum(const QString &serial_num) {
    m_serial_num = serial_num;
    m_serial_num_isSet = true;
}

bool OAILineItemsResponse_v2_inventoryDetails_inner::is_serial_num_Set() const{
    return m_serial_num_isSet;
}

bool OAILineItemsResponse_v2_inventoryDetails_inner::is_serial_num_Valid() const{
    return m_serial_num_isValid;
}

bool OAILineItemsResponse_v2_inventoryDetails_inner::isSet() const {
...
bool OAILineItemsResponse_v2_inventoryDetails_inner::isValid() const {
