...
#include "OAIItemInventory_v2_quantity_total.h"
...
OAIItemInventory_v2_quantity_total::OAIItemInventory_v2_quantity_total(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIItemInventory_v2_quantity_total::OAIItemInventory_v2_quantity_total() {
    this->initializeModel();
}

OAIItemInventory_v2_quantity_total::~OAIItemInventory_v2_quantity_total() {}

void OAIItemInventory_v2_quantity_total::initializeModel() {

    m_available_to_promise_isSet = false;
    m_available_to_promise_isValid = false;
}

void OAIItemInventory_v2_quantity_total::fromJson(QString jsonString) {
...
void OAIItemInventory_v2_quantity_total::fromJsonObject(QJsonObject json) {

    m_available_to_promise_isValid = ::OpenAPI::fromJsonValue(m_available_to_promise, json[QString("availableToPromise")]);
    m_available_to_promise_isSet = !json[QString("availableToPromise")].isNull() && m_available_to_promise_isValid;
}

QString OAIItemInventory_v2_quantity_total::asJson() const {
...
QJsonObject OAIItemInventory_v2_quantity_total::asJsonObject() const {
    QJsonObject obj;
    if (m_available_to_promise_isSet) {
        obj.insert(QString("availableToPromise"), ::OpenAPI::toJsonValue(m_available_to_promise));
    }
    return obj;
}

qint32 OAIItemInventory_v2_quantity_total::getAvailableToPromise() const {
    return m_available_to_promise;
}
void OAIItemInventory_v2_quantity_total::setAvailableToPromise(const qint32 &available_to_promise) {
    m_available_to_promise = available_to_promise;
    m_available_to_promise_isSet = true;
}

bool OAIItemInventory_v2_quantity_total::is_available_to_promise_Set() const{
    return m_available_to_promise_isSet;
}

bool OAIItemInventory_v2_quantity_total::is_available_to_promise_Valid() const{
    return m_available_to_promise_isValid;
}

bool OAIItemInventory_v2_quantity_total::isSet() const {
...
bool OAIItemInventory_v2_quantity_total::isValid() const {
