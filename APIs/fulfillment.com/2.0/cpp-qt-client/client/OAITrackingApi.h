...
public:
    ...
    */
    virtual void getTrack(const ::OpenAPI::OptionalParam<QString> &tracking_number = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void getTrackSignal(OAITrackingResponse summary);


    void getTrackSignalFull(OAIHttpRequestWorker *worker, OAITrackingResponse summary);

    Q_DECL_DEPRECATED_X("Use getTrackSignalError() instead")
    void getTrackSignalE(OAITrackingResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTrackSignalError(OAITrackingResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
