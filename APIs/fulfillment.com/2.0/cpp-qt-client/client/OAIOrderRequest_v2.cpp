...
OAIOrderRequest_v2::OAIOrderRequest_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderRequest_v2::OAIOrderRequest_v2() {
    this->initializeModel();
}

OAIOrderRequest_v2::~OAIOrderRequest_v2() {}

void OAIOrderRequest_v2::initializeModel() {
...
void OAIOrderRequest_v2::fromJson(QString jsonString) {
...
void OAIOrderRequest_v2::fromJsonObject(QJsonObject json) {
...
QString OAIOrderRequest_v2::asJson() const {
...
QJsonObject OAIOrderRequest_v2::asJsonObject() const {
    QJsonObject obj;
...
QString OAIOrderRequest_v2::getIntegrator() const {
    return m_integrator;
}
void OAIOrderRequest_v2::setIntegrator(const QString &integrator) {
    m_integrator = integrator;
    m_integrator_isSet = true;
}

bool OAIOrderRequest_v2::is_integrator_Set() const{
    return m_integrator_isSet;
}

bool OAIOrderRequest_v2::is_integrator_Valid() const{
    return m_integrator_isValid;
}

QList<OAIOrderRequest_v2_items_inner> OAIOrderRequest_v2::getItems() const {
    return m_items;
}
void OAIOrderRequest_v2::setItems(const QList<OAIOrderRequest_v2_items_inner> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIOrderRequest_v2::is_items_Set() const{
    return m_items_isSet;
}

bool OAIOrderRequest_v2::is_items_Valid() const{
    return m_items_isValid;
}

qint32 OAIOrderRequest_v2::getMerchantId() const {
    return m_merchant_id;
}
void OAIOrderRequest_v2::setMerchantId(const qint32 &merchant_id) {
    m_merchant_id = merchant_id;
    m_merchant_id_isSet = true;
}

bool OAIOrderRequest_v2::is_merchant_id_Set() const{
    return m_merchant_id_isSet;
}

bool OAIOrderRequest_v2::is_merchant_id_Valid() const{
    return m_merchant_id_isValid;
}

QString OAIOrderRequest_v2::getMerchantOrderId() const {
    return m_merchant_order_id;
}
void OAIOrderRequest_v2::setMerchantOrderId(const QString &merchant_order_id) {
    m_merchant_order_id = merchant_order_id;
    m_merchant_order_id_isSet = true;
}

bool OAIOrderRequest_v2::is_merchant_order_id_Set() const{
    return m_merchant_order_id_isSet;
}

bool OAIOrderRequest_v2::is_merchant_order_id_Valid() const{
    return m_merchant_order_id_isValid;
}

QString OAIOrderRequest_v2::getNotes() const {
    return m_notes;
}
void OAIOrderRequest_v2::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIOrderRequest_v2::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIOrderRequest_v2::is_notes_Valid() const{
    return m_notes_isValid;
}

OAIConsigneeNew_v2 OAIOrderRequest_v2::getRecipient() const {
    return m_recipient;
}
void OAIOrderRequest_v2::setRecipient(const OAIConsigneeNew_v2 &recipient) {
    m_recipient = recipient;
    m_recipient_isSet = true;
}

bool OAIOrderRequest_v2::is_recipient_Set() const{
    return m_recipient_isSet;
}

bool OAIOrderRequest_v2::is_recipient_Valid() const{
    return m_recipient_isValid;
}

QString OAIOrderRequest_v2::getShippingMethod() const {
    return m_shipping_method;
}
void OAIOrderRequest_v2::setShippingMethod(const QString &shipping_method) {
    m_shipping_method = shipping_method;
    m_shipping_method_isSet = true;
}

bool OAIOrderRequest_v2::is_shipping_method_Set() const{
    return m_shipping_method_isSet;
}

bool OAIOrderRequest_v2::is_shipping_method_Valid() const{
    return m_shipping_method_isValid;
}

OAIOrderRequest_v2_warehouse OAIOrderRequest_v2::getWarehouse() const {
    return m_warehouse;
}
void OAIOrderRequest_v2::setWarehouse(const OAIOrderRequest_v2_warehouse &warehouse) {
    m_warehouse = warehouse;
    m_warehouse_isSet = true;
}

bool OAIOrderRequest_v2::is_warehouse_Set() const{
    return m_warehouse_isSet;
}

bool OAIOrderRequest_v2::is_warehouse_Valid() const{
    return m_warehouse_isValid;
}

bool OAIOrderRequest_v2::isSet() const {
...
bool OAIOrderRequest_v2::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_items_isValid && m_merchant_order_id_isValid && m_recipient_isValid && m_shipping_method_isValid && true;
}
