...
OAIStatusEvent_v2::OAIStatusEvent_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatusEvent_v2::OAIStatusEvent_v2() {
    this->initializeModel();
}

OAIStatusEvent_v2::~OAIStatusEvent_v2() {}

void OAIStatusEvent_v2::initializeModel() {
...
void OAIStatusEvent_v2::fromJson(QString jsonString) {
...
void OAIStatusEvent_v2::fromJsonObject(QJsonObject json) {
...
QString OAIStatusEvent_v2::asJson() const {
...
QJsonObject OAIStatusEvent_v2::asJsonObject() const {
    QJsonObject obj;
...
OAIObject OAIStatusEvent_v2::getCreatedBy() const {
    return m_created_by;
}
void OAIStatusEvent_v2::setCreatedBy(const OAIObject &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIStatusEvent_v2::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIStatusEvent_v2::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QDateTime OAIStatusEvent_v2::getDate() const {
    return m_date;
}
void OAIStatusEvent_v2::setDate(const QDateTime &date) {
    m_date = date;
    m_date_isSet = true;
}

bool OAIStatusEvent_v2::is_date_Set() const{
    return m_date_isSet;
}

bool OAIStatusEvent_v2::is_date_Valid() const{
    return m_date_isValid;
}

qint32 OAIStatusEvent_v2::getId() const {
    return m_id;
}
void OAIStatusEvent_v2::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIStatusEvent_v2::is_id_Set() const{
    return m_id_isSet;
}

bool OAIStatusEvent_v2::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIStatusEvent_v2::getReason() const {
    return m_reason;
}
void OAIStatusEvent_v2::setReason(const QString &reason) {
    m_reason = reason;
    m_reason_isSet = true;
}

bool OAIStatusEvent_v2::is_reason_Set() const{
    return m_reason_isSet;
}

bool OAIStatusEvent_v2::is_reason_Valid() const{
    return m_reason_isValid;
}

OAIStatusType_v2 OAIStatusEvent_v2::getStatus() const {
    return m_status;
}
void OAIStatusEvent_v2::setStatus(const OAIStatusType_v2 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStatusEvent_v2::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStatusEvent_v2::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIStatusEvent_v2::isSet() const {
...
bool OAIStatusEvent_v2::isValid() const {
