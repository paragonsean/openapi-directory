...
/*
 * OAIItemInventory_v2_item.h
 *
 * Item this inventory data is based on
 */

#ifndef OAIItemInventory_v2_item_H
#define OAIItemInventory_v2_item_H
...
class OAIItemInventory_v2_item : public OAIObject {
public:
    OAIItemInventory_v2_item();
    OAIItemInventory_v2_item(QString json);
    ~OAIItemInventory_v2_item() override;
    ...
    QString getSkuReference() const;
    void setSkuReference(const QString &sku_reference);
    bool is_sku_reference_Set() const;
    bool is_sku_reference_Valid() const;
...
private:
    ...
    QString m_sku_reference;
    bool m_sku_reference_isSet;
    bool m_sku_reference_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIItemInventory_v2_item)

#endif // OAIItemInventory_v2_item_H
