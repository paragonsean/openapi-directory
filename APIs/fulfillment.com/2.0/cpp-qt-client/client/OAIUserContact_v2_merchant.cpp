...
#include "OAIUserContact_v2_merchant.h"
...
OAIUserContact_v2_merchant::OAIUserContact_v2_merchant(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserContact_v2_merchant::OAIUserContact_v2_merchant() {
    this->initializeModel();
}

OAIUserContact_v2_merchant::~OAIUserContact_v2_merchant() {}

void OAIUserContact_v2_merchant::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIUserContact_v2_merchant::fromJson(QString jsonString) {
...
void OAIUserContact_v2_merchant::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIUserContact_v2_merchant::asJson() const {
...
QJsonObject OAIUserContact_v2_merchant::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIUserContact_v2_merchant::getId() const {
    return m_id;
}
void OAIUserContact_v2_merchant::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUserContact_v2_merchant::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUserContact_v2_merchant::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIUserContact_v2_merchant::isSet() const {
...
bool OAIUserContact_v2_merchant::isValid() const {
