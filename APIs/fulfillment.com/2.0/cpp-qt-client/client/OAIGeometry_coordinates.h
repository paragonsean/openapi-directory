...
/*
 * OAIGeometry_coordinates.h
 *
 * 
 */

#ifndef OAIGeometry_coordinates_H
#define OAIGeometry_coordinates_H
...
class OAIGeometry_coordinates : public OAIObject {
public:
    OAIGeometry_coordinates();
    OAIGeometry_coordinates(QString json);
    ~OAIGeometry_coordinates() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeometry_coordinates)

#endif // OAIGeometry_coordinates_H
