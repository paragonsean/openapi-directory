...
#ifndef OAIMerchant_v2_H
#define OAIMerchant_v2_H
...
class OAIMerchant_v2 : public OAIObject {
public:
    OAIMerchant_v2();
    OAIMerchant_v2(QString json);
    ~OAIMerchant_v2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchant_v2)

#endif // OAIMerchant_v2_H
