...
OAIRmaItem_v2_nonRestockedReason::OAIRmaItem_v2_nonRestockedReason(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRmaItem_v2_nonRestockedReason::OAIRmaItem_v2_nonRestockedReason() {
    this->initializeModel();
}

OAIRmaItem_v2_nonRestockedReason::~OAIRmaItem_v2_nonRestockedReason() {}

void OAIRmaItem_v2_nonRestockedReason::initializeModel() {
...
void OAIRmaItem_v2_nonRestockedReason::fromJson(QString jsonString) {
...
void OAIRmaItem_v2_nonRestockedReason::fromJsonObject(QJsonObject json) {
...
QString OAIRmaItem_v2_nonRestockedReason::asJson() const {
...
QJsonObject OAIRmaItem_v2_nonRestockedReason::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIRmaItem_v2_nonRestockedReason::getId() const {
    return m_id;
}
void OAIRmaItem_v2_nonRestockedReason::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRmaItem_v2_nonRestockedReason::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRmaItem_v2_nonRestockedReason::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIRmaItem_v2_nonRestockedReason::getTitle() const {
    return m_title;
}
void OAIRmaItem_v2_nonRestockedReason::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIRmaItem_v2_nonRestockedReason::is_title_Set() const{
    return m_title_isSet;
}

bool OAIRmaItem_v2_nonRestockedReason::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIRmaItem_v2_nonRestockedReason::isSet() const {
...
bool OAIRmaItem_v2_nonRestockedReason::isValid() const {
