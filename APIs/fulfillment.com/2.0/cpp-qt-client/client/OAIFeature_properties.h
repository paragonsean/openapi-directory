...
/*
 * OAIFeature_properties.h
 *
 * 
 */

#ifndef OAIFeature_properties_H
#define OAIFeature_properties_H
...
class OAIFeature_properties : public OAIObject {
public:
    OAIFeature_properties();
    OAIFeature_properties(QString json);
    ~OAIFeature_properties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeature_properties)

#endif // OAIFeature_properties_H
