...
public:
    ...
    QList<QJsonValue> getBbox() const;
    void setBbox(const QList<QJsonValue> &bbox);
    bool is_bbox_Set() const;
    bool is_bbox_Valid() const;

    OAIObject getCenterline() const;
    void setCenterline(const OAIObject &centerline);
    bool is_centerline_Set() const;
    bool is_centerline_Valid() const;
    ...
    OAIFeature_properties getProperties() const;
    void setProperties(const OAIFeature_properties &properties);
...
private:
    ...
    QList<QJsonValue> m_bbox;
    bool m_bbox_isSet;
    bool m_bbox_isValid;

    OAIObject m_centerline;
    bool m_centerline_isSet;
    bool m_centerline_isValid;
    ...
    OAIFeature_properties m_properties;
