...
OAIErrorStandard_v2::OAIErrorStandard_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIErrorStandard_v2::OAIErrorStandard_v2() {
    this->initializeModel();
}

OAIErrorStandard_v2::~OAIErrorStandard_v2() {}

void OAIErrorStandard_v2::initializeModel() {

    m_message_isSet = false;
    m_message_isValid = false;
}

void OAIErrorStandard_v2::fromJson(QString jsonString) {
...
void OAIErrorStandard_v2::fromJsonObject(QJsonObject json) {

    m_message_isValid = ::OpenAPI::fromJsonValue(m_message, json[QString("message")]);
    m_message_isSet = !json[QString("message")].isNull() && m_message_isValid;
}

QString OAIErrorStandard_v2::asJson() const {
...
QJsonObject OAIErrorStandard_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
QString OAIErrorStandard_v2::getMessage() const {
    return m_message;
}
void OAIErrorStandard_v2::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIErrorStandard_v2::is_message_Set() const{
    return m_message_isSet;
}

bool OAIErrorStandard_v2::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIErrorStandard_v2::isSet() const {
...
bool OAIErrorStandard_v2::isValid() const {
