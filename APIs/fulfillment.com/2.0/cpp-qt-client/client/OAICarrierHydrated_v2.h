...
/*
 * OAICarrierHydrated_v2.h
 *
 * 
 */

#ifndef OAICarrierHydrated_v2_H
#define OAICarrierHydrated_v2_H
...
class OAICarrierHydrated_v2 : public OAIObject {
public:
    OAICarrierHydrated_v2();
    OAICarrierHydrated_v2(QString json);
    ~OAICarrierHydrated_v2() override;
    ...
    bool isCanReprintPostage() const;
    void setCanReprintPostage(const bool &can_reprint_postage);
    bool is_can_reprint_postage_Set() const;
    bool is_can_reprint_postage_Valid() const;
    ...
    bool isIncludePeripherals() const;
    void setIncludePeripherals(const bool &include_peripherals);
    bool is_include_peripherals_Set() const;
    bool is_include_peripherals_Valid() const;

    bool isInternalRatesOnly() const;
    void setInternalRatesOnly(const bool &internal_rates_only);
    bool is_internal_rates_only_Set() const;
    bool is_internal_rates_only_Valid() const;
    ...
    bool isRequiresDimensions() const;
    void setRequiresDimensions(const bool &requires_dimensions);
    bool is_requires_dimensions_Set() const;
    bool is_requires_dimensions_Valid() const;
...
private:
    ...
    bool m_can_reprint_postage;
    bool m_can_reprint_postage_isSet;
    bool m_can_reprint_postage_isValid;
    ...
    bool m_include_peripherals;
    bool m_include_peripherals_isSet;
    bool m_include_peripherals_isValid;

    bool m_internal_rates_only;
    bool m_internal_rates_only_isSet;
    bool m_internal_rates_only_isValid;

    QString m_name;
    bool m_name_isSet;
    bool m_name_isValid;

    bool m_requires_dimensions;
    bool m_requires_dimensions_isSet;
    bool m_requires_dimensions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICarrierHydrated_v2)

#endif // OAICarrierHydrated_v2_H
