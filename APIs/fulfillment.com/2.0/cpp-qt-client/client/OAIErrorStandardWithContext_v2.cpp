...
OAIErrorStandardWithContext_v2::OAIErrorStandardWithContext_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIErrorStandardWithContext_v2::OAIErrorStandardWithContext_v2() {
    this->initializeModel();
}

OAIErrorStandardWithContext_v2::~OAIErrorStandardWithContext_v2() {}

void OAIErrorStandardWithContext_v2::initializeModel() {
...
void OAIErrorStandardWithContext_v2::fromJson(QString jsonString) {
...
void OAIErrorStandardWithContext_v2::fromJsonObject(QJsonObject json) {
...
QString OAIErrorStandardWithContext_v2::asJson() const {
...
QJsonObject OAIErrorStandardWithContext_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_context.size() > 0) {
...
QList<OAIObject> OAIErrorStandardWithContext_v2::getContext() const {
    return m_context;
}
void OAIErrorStandardWithContext_v2::setContext(const QList<OAIObject> &context) {
    m_context = context;
    m_context_isSet = true;
}

bool OAIErrorStandardWithContext_v2::is_context_Set() const{
    return m_context_isSet;
}

bool OAIErrorStandardWithContext_v2::is_context_Valid() const{
    return m_context_isValid;
}

QString OAIErrorStandardWithContext_v2::getMessage() const {
    return m_message;
}
void OAIErrorStandardWithContext_v2::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIErrorStandardWithContext_v2::is_message_Set() const{
    return m_message_isSet;
}

bool OAIErrorStandardWithContext_v2::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIErrorStandardWithContext_v2::isSet() const {
...
bool OAIErrorStandardWithContext_v2::isValid() const {
