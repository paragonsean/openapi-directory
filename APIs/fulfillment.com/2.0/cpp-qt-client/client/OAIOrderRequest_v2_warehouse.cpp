...
OAIOrderRequest_v2_warehouse::OAIOrderRequest_v2_warehouse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderRequest_v2_warehouse::OAIOrderRequest_v2_warehouse() {
    this->initializeModel();
}

OAIOrderRequest_v2_warehouse::~OAIOrderRequest_v2_warehouse() {}

void OAIOrderRequest_v2_warehouse::initializeModel() {

    m_id_isSet = false;
    m_id_isValid = false;
}

void OAIOrderRequest_v2_warehouse::fromJson(QString jsonString) {
...
void OAIOrderRequest_v2_warehouse::fromJsonObject(QJsonObject json) {

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIOrderRequest_v2_warehouse::asJson() const {
...
QJsonObject OAIOrderRequest_v2_warehouse::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIOrderRequest_v2_warehouse::getId() const {
    return m_id;
}
void OAIOrderRequest_v2_warehouse::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOrderRequest_v2_warehouse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOrderRequest_v2_warehouse::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIOrderRequest_v2_warehouse::isSet() const {
...
bool OAIOrderRequest_v2_warehouse::isValid() const {
