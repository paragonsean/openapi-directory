...
/*
 * OAIItemInventory_v2_quantity.h
 *
 * 
 */

#ifndef OAIItemInventory_v2_quantity_H
#define OAIItemInventory_v2_quantity_H
...
namespace OpenAPI {
class OAIItemInventory_v2_quantity_total;

class OAIItemInventory_v2_quantity : public OAIObject {
public:
    OAIItemInventory_v2_quantity();
    OAIItemInventory_v2_quantity(QString json);
    ~OAIItemInventory_v2_quantity() override;
    ...
    OAIItemInventory_v2_quantity_total getTotal() const;
    void setTotal(const OAIItemInventory_v2_quantity_total &total);
...
private:
    ...
    OAIItemInventory_v2_quantity_total m_total;
    bool m_total_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemInventory_v2_quantity)

#endif // OAIItemInventory_v2_quantity_H
