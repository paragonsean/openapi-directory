...
/*
 * OAIItemInventory_v2_merchant.h
 *
 * Merchant that owns this item
 */

#ifndef OAIItemInventory_v2_merchant_H
#define OAIItemInventory_v2_merchant_H
...
class OAIItemInventory_v2_merchant : public OAIObject {
public:
    OAIItemInventory_v2_merchant();
    OAIItemInventory_v2_merchant(QString json);
    ~OAIItemInventory_v2_merchant() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemInventory_v2_merchant)

#endif // OAIItemInventory_v2_merchant_H
