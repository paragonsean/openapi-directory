...
/*
 * OAIAccounting_v2_items_inner.h
 *
 * 
 */

#ifndef OAIAccounting_v2_items_inner_H
#define OAIAccounting_v2_items_inner_H
...
class OAIAccounting_v2_items_inner : public OAIObject {
public:
    OAIAccounting_v2_items_inner();
    OAIAccounting_v2_items_inner(QString json);
    ~OAIAccounting_v2_items_inner() override;
    ...
    QString getWmsItemId() const;
    void setWmsItemId(const QString &wms_item_id);
    bool is_wms_item_id_Set() const;
    bool is_wms_item_id_Valid() const;
...
private:
    ...
    QString m_wms_item_id;
    bool m_wms_item_id_isSet;
    bool m_wms_item_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAccounting_v2_items_inner)

#endif // OAIAccounting_v2_items_inner_H
