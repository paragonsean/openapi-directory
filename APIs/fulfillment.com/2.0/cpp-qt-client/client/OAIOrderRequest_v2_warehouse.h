...
/*
 * OAIOrderRequest_v2_warehouse.h
 *
...
#ifndef OAIOrderRequest_v2_warehouse_H
#define OAIOrderRequest_v2_warehouse_H
...
class OAIOrderRequest_v2_warehouse : public OAIObject {
public:
    OAIOrderRequest_v2_warehouse();
    OAIOrderRequest_v2_warehouse(QString json);
    ~OAIOrderRequest_v2_warehouse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderRequest_v2_warehouse)

#endif // OAIOrderRequest_v2_warehouse_H
