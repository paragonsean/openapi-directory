...
OAIStatusTypeSimple_v2_status::OAIStatusTypeSimple_v2_status(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStatusTypeSimple_v2_status::OAIStatusTypeSimple_v2_status() {
    this->initializeModel();
}

OAIStatusTypeSimple_v2_status::~OAIStatusTypeSimple_v2_status() {}

void OAIStatusTypeSimple_v2_status::initializeModel() {

    m_code_isSet = false;
    m_code_isValid = false;
}

void OAIStatusTypeSimple_v2_status::fromJson(QString jsonString) {
...
void OAIStatusTypeSimple_v2_status::fromJsonObject(QJsonObject json) {

    m_code_isValid = ::OpenAPI::fromJsonValue(m_code, json[QString("code")]);
    m_code_isSet = !json[QString("code")].isNull() && m_code_isValid;
}

QString OAIStatusTypeSimple_v2_status::asJson() const {
...
QJsonObject OAIStatusTypeSimple_v2_status::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIStatusTypeSimple_v2_status::getCode() const {
    return m_code;
}
void OAIStatusTypeSimple_v2_status::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIStatusTypeSimple_v2_status::is_code_Set() const{
    return m_code_isSet;
}

bool OAIStatusTypeSimple_v2_status::is_code_Valid() const{
    return m_code_isValid;
}

bool OAIStatusTypeSimple_v2_status::isSet() const {
...
bool OAIStatusTypeSimple_v2_status::isValid() const {
