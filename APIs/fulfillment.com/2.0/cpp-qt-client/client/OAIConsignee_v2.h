...
#ifndef OAIConsignee_v2_H
#define OAIConsignee_v2_H
...
namespace OpenAPI {
class OAIIsoCountry_v2;

class OAIConsignee_v2 : public OAIObject {
public:
    OAIConsignee_v2();
    OAIConsignee_v2(QString json);
    ~OAIConsignee_v2() override;
    ...
    OAIIsoCountry_v2 getIso() const;
    void setIso(const OAIIsoCountry_v2 &iso);
    ...
    OAIObject getUpdatedBy() const;
    void setUpdatedBy(const OAIObject &updated_by);
...
Q_DECLARE_METATYPE(OpenAPI::OAIConsignee_v2)

#endif // OAIConsignee_v2_H
