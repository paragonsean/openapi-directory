...
OAIRmaRequest_v2::OAIRmaRequest_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRmaRequest_v2::OAIRmaRequest_v2() {
    this->initializeModel();
}

OAIRmaRequest_v2::~OAIRmaRequest_v2() {}

void OAIRmaRequest_v2::initializeModel() {
...
void OAIRmaRequest_v2::fromJson(QString jsonString) {
...
void OAIRmaRequest_v2::fromJsonObject(QJsonObject json) {
...
QString OAIRmaRequest_v2::asJson() const {
...
QJsonObject OAIRmaRequest_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_items.size() > 0) {
...
QList<OAIRmaRequest_v2_items_inner> OAIRmaRequest_v2::getItems() const {
    return m_items;
}
void OAIRmaRequest_v2::setItems(const QList<OAIRmaRequest_v2_items_inner> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIRmaRequest_v2::is_items_Set() const{
    return m_items_isSet;
}

bool OAIRmaRequest_v2::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIRmaRequest_v2::getMerchantOrderId() const {
    return m_merchant_order_id;
}
void OAIRmaRequest_v2::setMerchantOrderId(const QString &merchant_order_id) {
    m_merchant_order_id = merchant_order_id;
    m_merchant_order_id_isSet = true;
}

bool OAIRmaRequest_v2::is_merchant_order_id_Set() const{
    return m_merchant_order_id_isSet;
}

bool OAIRmaRequest_v2::is_merchant_order_id_Valid() const{
    return m_merchant_order_id_isValid;
}

OAIObject OAIRmaRequest_v2::getRecipient() const {
    return m_recipient;
}
void OAIRmaRequest_v2::setRecipient(const OAIObject &recipient) {
    m_recipient = recipient;
    m_recipient_isSet = true;
}

bool OAIRmaRequest_v2::is_recipient_Set() const{
    return m_recipient_isSet;
}

bool OAIRmaRequest_v2::is_recipient_Valid() const{
    return m_recipient_isValid;
}

QString OAIRmaRequest_v2::getRmaNumber() const {
    return m_rma_number;
}
void OAIRmaRequest_v2::setRmaNumber(const QString &rma_number) {
    m_rma_number = rma_number;
    m_rma_number_isSet = true;
}

bool OAIRmaRequest_v2::is_rma_number_Set() const{
    return m_rma_number_isSet;
}

bool OAIRmaRequest_v2::is_rma_number_Valid() const{
    return m_rma_number_isValid;
}

bool OAIRmaRequest_v2::isSet() const {
...
bool OAIRmaRequest_v2::isValid() const {
