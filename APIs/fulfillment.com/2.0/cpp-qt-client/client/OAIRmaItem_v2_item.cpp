...
OAIRmaItem_v2_item::OAIRmaItem_v2_item(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRmaItem_v2_item::OAIRmaItem_v2_item() {
    this->initializeModel();
}

OAIRmaItem_v2_item::~OAIRmaItem_v2_item() {}

void OAIRmaItem_v2_item::initializeModel() {
...
void OAIRmaItem_v2_item::fromJson(QString jsonString) {
...
void OAIRmaItem_v2_item::fromJsonObject(QJsonObject json) {
...
QString OAIRmaItem_v2_item::asJson() const {
...
QJsonObject OAIRmaItem_v2_item::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIRmaItem_v2_item::getId() const {
    return m_id;
}
void OAIRmaItem_v2_item::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRmaItem_v2_item::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRmaItem_v2_item::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIRmaItem_v2_item::getSku() const {
    return m_sku;
}
void OAIRmaItem_v2_item::setSku(const QString &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}

bool OAIRmaItem_v2_item::is_sku_Set() const{
    return m_sku_isSet;
}

bool OAIRmaItem_v2_item::is_sku_Valid() const{
    return m_sku_isValid;
}

bool OAIRmaItem_v2_item::isSet() const {
...
bool OAIRmaItem_v2_item::isValid() const {
