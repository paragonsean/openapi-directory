...
OAIRmaRequest_v2_items_inner::OAIRmaRequest_v2_items_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRmaRequest_v2_items_inner::OAIRmaRequest_v2_items_inner() {
    this->initializeModel();
}

OAIRmaRequest_v2_items_inner::~OAIRmaRequest_v2_items_inner() {}

void OAIRmaRequest_v2_items_inner::initializeModel() {
...
void OAIRmaRequest_v2_items_inner::fromJson(QString jsonString) {
...
void OAIRmaRequest_v2_items_inner::fromJsonObject(QJsonObject json) {
...
QString OAIRmaRequest_v2_items_inner::asJson() const {
...
QJsonObject OAIRmaRequest_v2_items_inner::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIRmaRequest_v2_items_inner::getQuantityExpected() const {
    return m_quantity_expected;
}
void OAIRmaRequest_v2_items_inner::setQuantityExpected(const qint32 &quantity_expected) {
    m_quantity_expected = quantity_expected;
    m_quantity_expected_isSet = true;
}

bool OAIRmaRequest_v2_items_inner::is_quantity_expected_Set() const{
    return m_quantity_expected_isSet;
}

bool OAIRmaRequest_v2_items_inner::is_quantity_expected_Valid() const{
    return m_quantity_expected_isValid;
}

QString OAIRmaRequest_v2_items_inner::getSku() const {
    return m_sku;
}
void OAIRmaRequest_v2_items_inner::setSku(const QString &sku) {
    m_sku = sku;
    m_sku_isSet = true;
}

bool OAIRmaRequest_v2_items_inner::is_sku_Set() const{
    return m_sku_isSet;
}

bool OAIRmaRequest_v2_items_inner::is_sku_Valid() const{
    return m_sku_isValid;
}

bool OAIRmaRequest_v2_items_inner::isSet() const {
...
bool OAIRmaRequest_v2_items_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_quantity_expected_isValid && m_sku_isValid && true;
}
