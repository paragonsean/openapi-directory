...
#include "OAIGeometry_coordinates.h"
...
OAIGeometry_coordinates::OAIGeometry_coordinates(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGeometry_coordinates::OAIGeometry_coordinates() {
    this->initializeModel();
}

OAIGeometry_coordinates::~OAIGeometry_coordinates() {}

void OAIGeometry_coordinates::initializeModel() {

}

void OAIGeometry_coordinates::fromJson(QString jsonString) {
...
void OAIGeometry_coordinates::fromJsonObject(QJsonObject json) {

}

QString OAIGeometry_coordinates::asJson() const {
...
QJsonObject OAIGeometry_coordinates::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAIGeometry_coordinates::isSet() const {
...
bool OAIGeometry_coordinates::isValid() const {
