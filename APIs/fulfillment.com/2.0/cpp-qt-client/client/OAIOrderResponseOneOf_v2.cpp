...
#include "OAIOrderResponseOneOf_v2.h"
...
OAIOrderResponseOneOf_v2::OAIOrderResponseOneOf_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrderResponseOneOf_v2::OAIOrderResponseOneOf_v2() {
    this->initializeModel();
}

OAIOrderResponseOneOf_v2::~OAIOrderResponseOneOf_v2() {}

void OAIOrderResponseOneOf_v2::initializeModel() {
...
void OAIOrderResponseOneOf_v2::fromJson(QString jsonString) {
...
void OAIOrderResponseOneOf_v2::fromJsonObject(QJsonObject json) {
...
QString OAIOrderResponseOneOf_v2::asJson() const {
...
QJsonObject OAIOrderResponseOneOf_v2::asJsonObject() const {
    QJsonObject obj;
...
QString OAIOrderResponseOneOf_v2::getIntegrator() const {
    return m_integrator;
}
void OAIOrderResponseOneOf_v2::setIntegrator(const QString &integrator) {
    m_integrator = integrator;
    m_integrator_isSet = true;
}

bool OAIOrderResponseOneOf_v2::is_integrator_Set() const{
    return m_integrator_isSet;
}

bool OAIOrderResponseOneOf_v2::is_integrator_Valid() const{
    return m_integrator_isValid;
}

QList<OAILineItemsResponse_v2> OAIOrderResponseOneOf_v2::getLineItems() const {
    return m_line_items;
}
void OAIOrderResponseOneOf_v2::setLineItems(const QList<OAILineItemsResponse_v2> &line_items) {
    m_line_items = line_items;
    m_line_items_isSet = true;
}

bool OAIOrderResponseOneOf_v2::is_line_items_Set() const{
    return m_line_items_isSet;
}

bool OAIOrderResponseOneOf_v2::is_line_items_Valid() const{
    return m_line_items_isValid;
}

QList<OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner> OAIOrderResponseOneOf_v2::getTrackingNumbers() const {
    return m_tracking_numbers;
}
void OAIOrderResponseOneOf_v2::setTrackingNumbers(const QList<OAIOrderResponseHydrate_v2_allOf_trackingNumbers_inner> &tracking_numbers) {
    m_tracking_numbers = tracking_numbers;
    m_tracking_numbers_isSet = true;
}

bool OAIOrderResponseOneOf_v2::is_tracking_numbers_Set() const{
    return m_tracking_numbers_isSet;
}

bool OAIOrderResponseOneOf_v2::is_tracking_numbers_Valid() const{
    return m_tracking_numbers_isValid;
}

bool OAIOrderResponseOneOf_v2::isSet() const {
...
bool OAIOrderResponseOneOf_v2::isValid() const {
