...
#include "OAIObject.h"
#include "OAIReturnsArray_v2.h"
#include "OAIRmaRequest_v2.h"
...
public:
    ...
    */
    virtual void getReturns(const QString &from_date, const QString &to_date, const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  oai_rma_request_v2 OAIRmaRequest_v2 [required]
    */
    virtual void putReturns(const OAIRmaRequest_v2 &oai_rma_request_v2);
...
private:
    ...
    void putReturnsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getReturnsSignal(OAIReturnsArray_v2 summary);
    void putReturnsSignal(OAIRmaResponse_v2 summary);


    void getReturnsSignalFull(OAIHttpRequestWorker *worker, OAIReturnsArray_v2 summary);
    void putReturnsSignalFull(OAIHttpRequestWorker *worker, OAIRmaResponse_v2 summary);

    Q_DECL_DEPRECATED_X("Use getReturnsSignalError() instead")
    void getReturnsSignalE(OAIReturnsArray_v2 summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getReturnsSignalError(OAIReturnsArray_v2 summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use putReturnsSignalError() instead")
    void putReturnsSignalE(OAIRmaResponse_v2 summary, QNetworkReply::NetworkError error_type, QString error_str);
    void putReturnsSignalError(OAIRmaResponse_v2 summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use putReturnsSignalErrorFull() instead")
    void putReturnsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void putReturnsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
