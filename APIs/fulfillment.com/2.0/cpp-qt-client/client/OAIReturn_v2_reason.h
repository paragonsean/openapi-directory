...
/*
 * OAIReturn_v2_reason.h
 *
 * 
 */

#ifndef OAIReturn_v2_reason_H
#define OAIReturn_v2_reason_H
...
class OAIReturn_v2_reason : public OAIObject {
public:
    OAIReturn_v2_reason();
    OAIReturn_v2_reason(QString json);
    ~OAIReturn_v2_reason() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturn_v2_reason)

#endif // OAIReturn_v2_reason_H
