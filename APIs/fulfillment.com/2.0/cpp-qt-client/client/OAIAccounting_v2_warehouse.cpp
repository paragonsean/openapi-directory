...
OAIAccounting_v2_warehouse::OAIAccounting_v2_warehouse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccounting_v2_warehouse::OAIAccounting_v2_warehouse() {
    this->initializeModel();
}

OAIAccounting_v2_warehouse::~OAIAccounting_v2_warehouse() {}

void OAIAccounting_v2_warehouse::initializeModel() {
...
void OAIAccounting_v2_warehouse::fromJson(QString jsonString) {
...
void OAIAccounting_v2_warehouse::fromJsonObject(QJsonObject json) {
...
QString OAIAccounting_v2_warehouse::asJson() const {
...
QJsonObject OAIAccounting_v2_warehouse::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIAccounting_v2_warehouse::getId() const {
    return m_id;
}
void OAIAccounting_v2_warehouse::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAccounting_v2_warehouse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAccounting_v2_warehouse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAccounting_v2_warehouse::getShortName() const {
    return m_short_name;
}
void OAIAccounting_v2_warehouse::setShortName(const QString &short_name) {
    m_short_name = short_name;
    m_short_name_isSet = true;
}

bool OAIAccounting_v2_warehouse::is_short_name_Set() const{
    return m_short_name_isSet;
}

bool OAIAccounting_v2_warehouse::is_short_name_Valid() const{
    return m_short_name_isValid;
}

bool OAIAccounting_v2_warehouse::isSet() const {
...
bool OAIAccounting_v2_warehouse::isValid() const {
