...
OAIRmaResponse_v2::OAIRmaResponse_v2(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRmaResponse_v2::OAIRmaResponse_v2() {
    this->initializeModel();
}

OAIRmaResponse_v2::~OAIRmaResponse_v2() {}

void OAIRmaResponse_v2::initializeModel() {
...
void OAIRmaResponse_v2::fromJson(QString jsonString) {
...
void OAIRmaResponse_v2::fromJsonObject(QJsonObject json) {
...
QString OAIRmaResponse_v2::asJson() const {
...
QJsonObject OAIRmaResponse_v2::asJsonObject() const {
    QJsonObject obj;
    if (m_items.size() > 0) {
...
QList<OAIRmaRequest_v2_items_inner> OAIRmaResponse_v2::getItems() const {
    return m_items;
}
void OAIRmaResponse_v2::setItems(const QList<OAIRmaRequest_v2_items_inner> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIRmaResponse_v2::is_items_Set() const{
    return m_items_isSet;
}

bool OAIRmaResponse_v2::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIRmaResponse_v2::getMerchantOrderId() const {
    return m_merchant_order_id;
}
void OAIRmaResponse_v2::setMerchantOrderId(const QString &merchant_order_id) {
    m_merchant_order_id = merchant_order_id;
    m_merchant_order_id_isSet = true;
}

bool OAIRmaResponse_v2::is_merchant_order_id_Set() const{
    return m_merchant_order_id_isSet;
}

bool OAIRmaResponse_v2::is_merchant_order_id_Valid() const{
    return m_merchant_order_id_isValid;
}

OAIConsignee_v2 OAIRmaResponse_v2::getRecipient() const {
    return m_recipient;
}
void OAIRmaResponse_v2::setRecipient(const OAIConsignee_v2 &recipient) {
    m_recipient = recipient;
    m_recipient_isSet = true;
}

bool OAIRmaResponse_v2::is_recipient_Set() const{
    return m_recipient_isSet;
}

bool OAIRmaResponse_v2::is_recipient_Valid() const{
    return m_recipient_isValid;
}

QString OAIRmaResponse_v2::getRmaNumber() const {
    return m_rma_number;
}
void OAIRmaResponse_v2::setRmaNumber(const QString &rma_number) {
    m_rma_number = rma_number;
    m_rma_number_isSet = true;
}

bool OAIRmaResponse_v2::is_rma_number_Set() const{
    return m_rma_number_isSet;
}

bool OAIRmaResponse_v2::is_rma_number_Valid() const{
    return m_rma_number_isValid;
}

bool OAIRmaResponse_v2::isSet() const {
...
bool OAIRmaResponse_v2::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_items_isValid && m_recipient_isValid && m_rma_number_isValid && true;
}
