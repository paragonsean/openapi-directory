...
OAIAccounting_v2_items_inner::OAIAccounting_v2_items_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccounting_v2_items_inner::OAIAccounting_v2_items_inner() {
    this->initializeModel();
}

OAIAccounting_v2_items_inner::~OAIAccounting_v2_items_inner() {}

void OAIAccounting_v2_items_inner::initializeModel() {
    ...
    m_wms_item_id_isSet = false;
    m_wms_item_id_isValid = false;
}

void OAIAccounting_v2_items_inner::fromJson(QString jsonString) {
...
void OAIAccounting_v2_items_inner::fromJsonObject(QJsonObject json) {
    ...
    m_wms_item_id_isValid = ::OpenAPI::fromJsonValue(m_wms_item_id, json[QString("wmsItemId")]);
    m_wms_item_id_isSet = !json[QString("wmsItemId")].isNull() && m_wms_item_id_isValid;
}

QString OAIAccounting_v2_items_inner::asJson() const {
...
QJsonObject OAIAccounting_v2_items_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
    ...
    if (m_wms_item_id_isSet) {
        obj.insert(QString("wmsItemId"), ::OpenAPI::toJsonValue(m_wms_item_id));
    }
    return obj;
}

qint32 OAIAccounting_v2_items_inner::getId() const {
    return m_id;
}
void OAIAccounting_v2_items_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAccounting_v2_items_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAccounting_v2_items_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAccounting_v2_items_inner::getName() const {
    return m_name;
}
void OAIAccounting_v2_items_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAccounting_v2_items_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAccounting_v2_items_inner::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIAccounting_v2_items_inner::getQuantity() const {
    return m_quantity;
}
void OAIAccounting_v2_items_inner::setQuantity(const qint32 &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIAccounting_v2_items_inner::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIAccounting_v2_items_inner::is_quantity_Valid() const{
    return m_quantity_isValid;
}

QString OAIAccounting_v2_items_inner::getWmsItemId() const {
    return m_wms_item_id;
}
void OAIAccounting_v2_items_inner::setWmsItemId(const QString &wms_item_id) {
    m_wms_item_id = wms_item_id;
    m_wms_item_id_isSet = true;
}

bool OAIAccounting_v2_items_inner::is_wms_item_id_Set() const{
    return m_wms_item_id_isSet;
}

bool OAIAccounting_v2_items_inner::is_wms_item_id_Valid() const{
    return m_wms_item_id_isValid;
}

bool OAIAccounting_v2_items_inner::isSet() const {
...
bool OAIAccounting_v2_items_inner::isValid() const {
