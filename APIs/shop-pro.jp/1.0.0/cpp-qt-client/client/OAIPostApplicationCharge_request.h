...
/*
 * OAIPostApplicationCharge_request.h
 *
 * 
 */

#ifndef OAIPostApplicationCharge_request_H
#define OAIPostApplicationCharge_request_H

#include <QJsonObject>

#include "OAIPostApplicationCharge_request_application_charge.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPostApplicationCharge_request_application_charge;

class OAIPostApplicationCharge_request : public OAIObject {
public:
    OAIPostApplicationCharge_request();
    OAIPostApplicationCharge_request(QString json);
    ~OAIPostApplicationCharge_request() override;
    ...
    OAIPostApplicationCharge_request_application_charge getApplicationCharge() const;
    void setApplicationCharge(const OAIPostApplicationCharge_request_application_charge &application_charge);
...
private:
    ...
    OAIPostApplicationCharge_request_application_charge m_application_charge;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostApplicationCharge_request)

#endif // OAIPostApplicationCharge_request_H
