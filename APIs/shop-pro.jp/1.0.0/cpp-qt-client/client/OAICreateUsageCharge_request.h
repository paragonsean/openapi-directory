...
/*
 * OAICreateUsageCharge_request.h
 *
 * 
 */

#ifndef OAICreateUsageCharge_request_H
#define OAICreateUsageCharge_request_H
...
namespace OpenAPI {
class OAICreateUsageCharge_request_usage_charge;

class OAICreateUsageCharge_request : public OAIObject {
public:
    OAICreateUsageCharge_request();
    OAICreateUsageCharge_request(QString json);
    ~OAICreateUsageCharge_request() override;
    ...
    OAICreateUsageCharge_request_usage_charge getUsageCharge() const;
    void setUsageCharge(const OAICreateUsageCharge_request_usage_charge &usage_charge);
...
private:
    ...
    OAICreateUsageCharge_request_usage_charge m_usage_charge;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUsageCharge_request)

#endif // OAICreateUsageCharge_request_H
