...
#include "OAIGetInlineScriptTags_200_response_inline_script_tags_inner.h"
...
OAIGetInlineScriptTags_200_response_inline_script_tags_inner::OAIGetInlineScriptTags_200_response_inline_script_tags_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetInlineScriptTags_200_response_inline_script_tags_inner::OAIGetInlineScriptTags_200_response_inline_script_tags_inner() {
    this->initializeModel();
}

OAIGetInlineScriptTags_200_response_inline_script_tags_inner::~OAIGetInlineScriptTags_200_response_inline_script_tags_inner() {}

void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::initializeModel() {

    m_account_id_isSet = false;
    m_account_id_isValid = false;

    m_display_scope_isSet = false;
    m_display_scope_isValid = false;
...
void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::fromJson(QString jsonString) {
...
void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::fromJsonObject(QJsonObject json) {

    m_account_id_isValid = ::OpenAPI::fromJsonValue(m_account_id, json[QString("account_id")]);
    m_account_id_isSet = !json[QString("account_id")].isNull() && m_account_id_isValid;

    m_display_scope_isValid = ::OpenAPI::fromJsonValue(m_display_scope, json[QString("display_scope")]);
    m_display_scope_isSet = !json[QString("display_scope")].isNull() && m_display_scope_isValid;
    ...
    m_trigger_event_isValid = ::OpenAPI::fromJsonValue(m_trigger_event, json[QString("trigger_event")]);
    m_trigger_event_isSet = !json[QString("trigger_event")].isNull() && m_trigger_event_isValid;
...
QString OAIGetInlineScriptTags_200_response_inline_script_tags_inner::asJson() const {
...
QJsonObject OAIGetInlineScriptTags_200_response_inline_script_tags_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_account_id_isSet) {
        obj.insert(QString("account_id"), ::OpenAPI::toJsonValue(m_account_id));
    }
    if (m_display_scope_isSet) {
        obj.insert(QString("display_scope"), ::OpenAPI::toJsonValue(m_display_scope));
    }
    if (m_id_isSet) {
    ...
    if (m_trigger_event_isSet) {
        obj.insert(QString("trigger_event"), ::OpenAPI::toJsonValue(m_trigger_event));
    }
...
QString OAIGetInlineScriptTags_200_response_inline_script_tags_inner::getAccountId() const {
    return m_account_id;
}
void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIGetInlineScriptTags_200_response_inline_script_tags_inner::getDisplayScope() const {
    return m_display_scope;
}
void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::setDisplayScope(const QString &display_scope) {
    m_display_scope = display_scope;
    m_display_scope_isSet = true;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_display_scope_Set() const{
    return m_display_scope_isSet;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_display_scope_Valid() const{
    return m_display_scope_isValid;
}

qint32 OAIGetInlineScriptTags_200_response_inline_script_tags_inner::getId() const {
    return m_id;
}
void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAIGetInlineScriptTags_200_response_inline_script_tags_inner::getMakeDate() const {
    return m_make_date;
}
void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::setMakeDate(const qint32 &make_date) {
    m_make_date = make_date;
    m_make_date_isSet = true;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_make_date_Set() const{
    return m_make_date_isSet;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_make_date_Valid() const{
    return m_make_date_isValid;
}

qint32 OAIGetInlineScriptTags_200_response_inline_script_tags_inner::getOauthApplicationId() const {
    return m_oauth_application_id;
}
void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::setOauthApplicationId(const qint32 &oauth_application_id) {
    m_oauth_application_id = oauth_application_id;
    m_oauth_application_id_isSet = true;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_oauth_application_id_Set() const{
    return m_oauth_application_id_isSet;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_oauth_application_id_Valid() const{
    return m_oauth_application_id_isValid;
}

QString OAIGetInlineScriptTags_200_response_inline_script_tags_inner::getScript() const {
    return m_script;
}
void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::setScript(const QString &script) {
    m_script = script;
    m_script_isSet = true;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_script_Set() const{
    return m_script_isSet;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_script_Valid() const{
    return m_script_isValid;
}

QString OAIGetInlineScriptTags_200_response_inline_script_tags_inner::getTriggerEvent() const {
    return m_trigger_event;
}
void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::setTriggerEvent(const QString &trigger_event) {
    m_trigger_event = trigger_event;
    m_trigger_event_isSet = true;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_trigger_event_Set() const{
    return m_trigger_event_isSet;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_trigger_event_Valid() const{
    return m_trigger_event_isValid;
}

qint32 OAIGetInlineScriptTags_200_response_inline_script_tags_inner::getUpdateDate() const {
    return m_update_date;
}
void OAIGetInlineScriptTags_200_response_inline_script_tags_inner::setUpdateDate(const qint32 &update_date) {
    m_update_date = update_date;
    m_update_date_isSet = true;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_update_date_Set() const{
    return m_update_date_isSet;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::is_update_date_Valid() const{
    return m_update_date_isValid;
}

bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::isSet() const {
...
bool OAIGetInlineScriptTags_200_response_inline_script_tags_inner::isValid() const {
