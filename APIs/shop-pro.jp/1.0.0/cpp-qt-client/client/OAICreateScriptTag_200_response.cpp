...
#include "OAICreateScriptTag_200_response.h"
...
OAICreateScriptTag_200_response::OAICreateScriptTag_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateScriptTag_200_response::OAICreateScriptTag_200_response() {
    this->initializeModel();
}

OAICreateScriptTag_200_response::~OAICreateScriptTag_200_response() {}

void OAICreateScriptTag_200_response::initializeModel() {

    m_script_tag_isSet = false;
    m_script_tag_isValid = false;
}

void OAICreateScriptTag_200_response::fromJson(QString jsonString) {
...
void OAICreateScriptTag_200_response::fromJsonObject(QJsonObject json) {
...
QString OAICreateScriptTag_200_response::asJson() const {
...
QJsonObject OAICreateScriptTag_200_response::asJsonObject() const {
    QJsonObject obj;
...
OAIGetScriptTags_200_response_script_tags_inner OAICreateScriptTag_200_response::getScriptTag() const {
    return m_script_tag;
}
void OAICreateScriptTag_200_response::setScriptTag(const OAIGetScriptTags_200_response_script_tags_inner &script_tag) {
    m_script_tag = script_tag;
    m_script_tag_isSet = true;
}

bool OAICreateScriptTag_200_response::is_script_tag_Set() const{
    return m_script_tag_isSet;
}

bool OAICreateScriptTag_200_response::is_script_tag_Valid() const{
    return m_script_tag_isValid;
}

bool OAICreateScriptTag_200_response::isSet() const {
...
bool OAICreateScriptTag_200_response::isValid() const {
