...
/*
 * OAIDeleteInstallation_200_response_usage_charge.h
 *
 * （従量課金の場合）従量課金アンインストール情報
 */

#ifndef OAIDeleteInstallation_200_response_usage_charge_H
#define OAIDeleteInstallation_200_response_usage_charge_H
...
class OAIDeleteInstallation_200_response_usage_charge : public OAIObject {
public:
    OAIDeleteInstallation_200_response_usage_charge();
    OAIDeleteInstallation_200_response_usage_charge(QString json);
    ~OAIDeleteInstallation_200_response_usage_charge() override;
    ...
    qint32 getClosingOn() const;
    void setClosingOn(const qint32 &closing_on);
    bool is_closing_on_Set() const;
    bool is_closing_on_Valid() const;
...
private:
    ...
    qint32 m_closing_on;
    bool m_closing_on_isSet;
    bool m_closing_on_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteInstallation_200_response_usage_charge)

#endif // OAIDeleteInstallation_200_response_usage_charge_H
