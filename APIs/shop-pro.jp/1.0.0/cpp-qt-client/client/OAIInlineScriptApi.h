...
#ifndef OAI_OAIInlineScriptApi_H
#define OAI_OAIInlineScriptApi_H
...
#include "OAICreateInlineScriptTag_201_response.h"
#include "OAICreateInlineScriptTag_request.h"
#include "OAIGetInlineScriptTags_200_response.h"
#include <QString>
...
class OAIInlineScriptApi : public QObject {
    Q_OBJECT

public:
    OAIInlineScriptApi(const int timeOut = 0);
    ~OAIInlineScriptApi();
    ...
    /**
    * @param[in]  oai_create_inline_script_tag_request OAICreateInlineScriptTag_request [optional]
    */
    virtual void createInlineScriptTag(const ::OpenAPI::OptionalParam<OAICreateInlineScriptTag_request> &oai_create_inline_script_tag_request = ::OpenAPI::OptionalParam<OAICreateInlineScriptTag_request>());

    /**
    * @param[in]  inline_script_tag_id qint32 [required]
    */
    virtual void deleteInlineScriptTag(const qint32 &inline_script_tag_id);

    /**
    * @param[in]  inline_script_tag_id qint32 [required]
    */
    virtual void getInlineScriptTag(const qint32 &inline_script_tag_id);


    virtual void getInlineScriptTags();

    /**
    * @param[in]  inline_script_tag_id qint32 [required]
    * @param[in]  oai_create_inline_script_tag_request OAICreateInlineScriptTag_request [optional]
    */
    virtual void updateInlineScriptTag(const qint32 &inline_script_tag_id, const ::OpenAPI::OptionalParam<OAICreateInlineScriptTag_request> &oai_create_inline_script_tag_request = ::OpenAPI::OptionalParam<OAICreateInlineScriptTag_request>());
...
private:
    ...
    void createInlineScriptTagCallback(OAIHttpRequestWorker *worker);
    void deleteInlineScriptTagCallback(OAIHttpRequestWorker *worker);
    void getInlineScriptTagCallback(OAIHttpRequestWorker *worker);
    void getInlineScriptTagsCallback(OAIHttpRequestWorker *worker);
    void updateInlineScriptTagCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void createInlineScriptTagSignal(OAICreateInlineScriptTag_201_response summary);
    void deleteInlineScriptTagSignal();
    void getInlineScriptTagSignal(OAICreateInlineScriptTag_201_response summary);
    void getInlineScriptTagsSignal(OAIGetInlineScriptTags_200_response summary);
    void updateInlineScriptTagSignal(OAICreateInlineScriptTag_201_response summary);


    void createInlineScriptTagSignalFull(OAIHttpRequestWorker *worker, OAICreateInlineScriptTag_201_response summary);
    void deleteInlineScriptTagSignalFull(OAIHttpRequestWorker *worker);
    void getInlineScriptTagSignalFull(OAIHttpRequestWorker *worker, OAICreateInlineScriptTag_201_response summary);
    void getInlineScriptTagsSignalFull(OAIHttpRequestWorker *worker, OAIGetInlineScriptTags_200_response summary);
    void updateInlineScriptTagSignalFull(OAIHttpRequestWorker *worker, OAICreateInlineScriptTag_201_response summary);

    Q_DECL_DEPRECATED_X("Use createInlineScriptTagSignalError() instead")
    void createInlineScriptTagSignalE(OAICreateInlineScriptTag_201_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createInlineScriptTagSignalError(OAICreateInlineScriptTag_201_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteInlineScriptTagSignalError() instead")
    void deleteInlineScriptTagSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void deleteInlineScriptTagSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getInlineScriptTagSignalError() instead")
    void getInlineScriptTagSignalE(OAICreateInlineScriptTag_201_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getInlineScriptTagSignalError(OAICreateInlineScriptTag_201_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getInlineScriptTagsSignalError() instead")
    void getInlineScriptTagsSignalE(OAIGetInlineScriptTags_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getInlineScriptTagsSignalError(OAIGetInlineScriptTags_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateInlineScriptTagSignalError() instead")
    void updateInlineScriptTagSignalE(OAICreateInlineScriptTag_201_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateInlineScriptTagSignalError(OAICreateInlineScriptTag_201_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use createInlineScriptTagSignalErrorFull() instead")
    void createInlineScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createInlineScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteInlineScriptTagSignalErrorFull() instead")
    void deleteInlineScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteInlineScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getInlineScriptTagSignalErrorFull() instead")
    void getInlineScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getInlineScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getInlineScriptTagsSignalErrorFull() instead")
    void getInlineScriptTagsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getInlineScriptTagsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateInlineScriptTagSignalErrorFull() instead")
    void updateInlineScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void updateInlineScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
