...
/*
 * OAICreateShopScriptTag_request_script_tag.h
 *
 * 
 */

#ifndef OAICreateShopScriptTag_request_script_tag_H
#define OAICreateShopScriptTag_request_script_tag_H
...
class OAICreateShopScriptTag_request_script_tag : public OAIObject {
public:
    OAICreateShopScriptTag_request_script_tag();
    OAICreateShopScriptTag_request_script_tag(QString json);
    ~OAICreateShopScriptTag_request_script_tag() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateShopScriptTag_request_script_tag)

#endif // OAICreateShopScriptTag_request_script_tag_H
