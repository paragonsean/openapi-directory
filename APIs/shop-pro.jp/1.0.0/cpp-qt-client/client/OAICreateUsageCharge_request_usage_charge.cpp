...
#include "OAICreateUsageCharge_request_usage_charge.h"
...
OAICreateUsageCharge_request_usage_charge::OAICreateUsageCharge_request_usage_charge(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUsageCharge_request_usage_charge::OAICreateUsageCharge_request_usage_charge() {
    this->initializeModel();
}

OAICreateUsageCharge_request_usage_charge::~OAICreateUsageCharge_request_usage_charge() {}

void OAICreateUsageCharge_request_usage_charge::initializeModel() {
...
void OAICreateUsageCharge_request_usage_charge::fromJson(QString jsonString) {
...
void OAICreateUsageCharge_request_usage_charge::fromJsonObject(QJsonObject json) {
...
QString OAICreateUsageCharge_request_usage_charge::asJson() const {
...
QJsonObject OAICreateUsageCharge_request_usage_charge::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateUsageCharge_request_usage_charge::getDescription() const {
    return m_description;
}
void OAICreateUsageCharge_request_usage_charge::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateUsageCharge_request_usage_charge::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateUsageCharge_request_usage_charge::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAICreateUsageCharge_request_usage_charge::getPoint() const {
    return m_point;
}
void OAICreateUsageCharge_request_usage_charge::setPoint(const qint32 &point) {
    m_point = point;
    m_point_isSet = true;
}

bool OAICreateUsageCharge_request_usage_charge::is_point_Set() const{
    return m_point_isSet;
}

bool OAICreateUsageCharge_request_usage_charge::is_point_Valid() const{
    return m_point_isValid;
}

bool OAICreateUsageCharge_request_usage_charge::isSet() const {
...
bool OAICreateUsageCharge_request_usage_charge::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_description_isValid && m_point_isValid && true;
}
