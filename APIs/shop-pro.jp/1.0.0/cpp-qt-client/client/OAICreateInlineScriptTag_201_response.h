...
/*
 * OAICreateInlineScriptTag_201_response.h
 *
 * 
 */

#ifndef OAICreateInlineScriptTag_201_response_H
#define OAICreateInlineScriptTag_201_response_H
...
class OAICreateInlineScriptTag_201_response : public OAIObject {
public:
    OAICreateInlineScriptTag_201_response();
    OAICreateInlineScriptTag_201_response(QString json);
    ~OAICreateInlineScriptTag_201_response() override;
    ...
    OAIGetInlineScriptTags_200_response_inline_script_tags_inner getInlineScriptTag() const;
    void setInlineScriptTag(const OAIGetInlineScriptTags_200_response_inline_script_tags_inner &inline_script_tag);
...
private:
    ...
    OAIGetInlineScriptTags_200_response_inline_script_tags_inner m_inline_script_tag;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateInlineScriptTag_201_response)

#endif // OAICreateInlineScriptTag_201_response_H
