...
/*
 * OAICreateScriptTag_request.h
 *
 * 
 */

#ifndef OAICreateScriptTag_request_H
#define OAICreateScriptTag_request_H
...
namespace OpenAPI {
class OAICreateScriptTag_request_script_tag;

class OAICreateScriptTag_request : public OAIObject {
public:
    OAICreateScriptTag_request();
    OAICreateScriptTag_request(QString json);
    ~OAICreateScriptTag_request() override;
    ...
    OAICreateScriptTag_request_script_tag getScriptTag() const;
    void setScriptTag(const OAICreateScriptTag_request_script_tag &script_tag);
...
private:
    ...
    OAICreateScriptTag_request_script_tag m_script_tag;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateScriptTag_request)

#endif // OAICreateScriptTag_request_H
