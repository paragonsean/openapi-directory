...
OAIPostApplicationCharge_201_response::OAIPostApplicationCharge_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostApplicationCharge_201_response::OAIPostApplicationCharge_201_response() {
    this->initializeModel();
}

OAIPostApplicationCharge_201_response::~OAIPostApplicationCharge_201_response() {}

void OAIPostApplicationCharge_201_response::initializeModel() {

    m_application_charge_isSet = false;
    m_application_charge_isValid = false;
}

void OAIPostApplicationCharge_201_response::fromJson(QString jsonString) {
...
void OAIPostApplicationCharge_201_response::fromJsonObject(QJsonObject json) {
...
QString OAIPostApplicationCharge_201_response::asJson() const {
...
QJsonObject OAIPostApplicationCharge_201_response::asJsonObject() const {
    QJsonObject obj;
...
OAIPostApplicationCharge_201_response_application_charge OAIPostApplicationCharge_201_response::getApplicationCharge() const {
    return m_application_charge;
}
void OAIPostApplicationCharge_201_response::setApplicationCharge(const OAIPostApplicationCharge_201_response_application_charge &application_charge) {
    m_application_charge = application_charge;
    m_application_charge_isSet = true;
}

bool OAIPostApplicationCharge_201_response::is_application_charge_Set() const{
    return m_application_charge_isSet;
}

bool OAIPostApplicationCharge_201_response::is_application_charge_Valid() const{
    return m_application_charge_isValid;
}

bool OAIPostApplicationCharge_201_response::isSet() const {
...
bool OAIPostApplicationCharge_201_response::isValid() const {
