...
/*
 * OAIGetScriptTags_200_response_script_tags_inner.h
 *
 * 
 */

#ifndef OAIGetScriptTags_200_response_script_tags_inner_H
#define OAIGetScriptTags_200_response_script_tags_inner_H
...
class OAIGetScriptTags_200_response_script_tags_inner : public OAIObject {
public:
    OAIGetScriptTags_200_response_script_tags_inner();
    OAIGetScriptTags_200_response_script_tags_inner(QString json);
    ~OAIGetScriptTags_200_response_script_tags_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetScriptTags_200_response_script_tags_inner)

#endif // OAIGetScriptTags_200_response_script_tags_inner_H
