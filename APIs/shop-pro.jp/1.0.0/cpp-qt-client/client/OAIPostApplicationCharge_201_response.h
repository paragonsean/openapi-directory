...
/*
 * OAIPostApplicationCharge_201_response.h
 *
 * 
 */

#ifndef OAIPostApplicationCharge_201_response_H
#define OAIPostApplicationCharge_201_response_H

#include <QJsonObject>

#include "OAIPostApplicationCharge_201_response_application_charge.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPostApplicationCharge_201_response_application_charge;

class OAIPostApplicationCharge_201_response : public OAIObject {
public:
    OAIPostApplicationCharge_201_response();
    OAIPostApplicationCharge_201_response(QString json);
    ~OAIPostApplicationCharge_201_response() override;
    ...
    OAIPostApplicationCharge_201_response_application_charge getApplicationCharge() const;
    void setApplicationCharge(const OAIPostApplicationCharge_201_response_application_charge &application_charge);
    bool is_application_charge_Set() const;
    bool is_application_charge_Valid() const;
...
private:
    ...
    OAIPostApplicationCharge_201_response_application_charge m_application_charge;
    bool m_application_charge_isSet;
    bool m_application_charge_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPostApplicationCharge_201_response)

#endif // OAIPostApplicationCharge_201_response_H
