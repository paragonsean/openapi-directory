...
#ifndef OAI_OAIUninstallationApi_H
#define OAI_OAIUninstallationApi_H
...
class OAIUninstallationApi : public QObject {
    Q_OBJECT

public:
    OAIUninstallationApi(const int timeOut = 0);
    ~OAIUninstallationApi();
    ...
    virtual void deleteInstallation();
...
private:
    ...
    void deleteInstallationCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void deleteInstallationSignal(OAIDeleteInstallation_200_response summary);


    void deleteInstallationSignalFull(OAIHttpRequestWorker *worker, OAIDeleteInstallation_200_response summary);

    Q_DECL_DEPRECATED_X("Use deleteInstallationSignalError() instead")
    void deleteInstallationSignalE(OAIDeleteInstallation_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteInstallationSignalError(OAIDeleteInstallation_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use deleteInstallationSignalErrorFull() instead")
    void deleteInstallationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteInstallationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
