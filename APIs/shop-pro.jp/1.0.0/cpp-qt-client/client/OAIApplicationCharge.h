...
/*
 * OAIApplicationCharge.h
 *
 * 
 */

#ifndef OAIApplicationCharge_H
#define OAIApplicationCharge_H
...
class OAIApplicationCharge : public OAIObject {
public:
    OAIApplicationCharge();
    OAIApplicationCharge(QString json);
    ~OAIApplicationCharge() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationCharge)

#endif // OAIApplicationCharge_H
