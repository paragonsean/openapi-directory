...
OAIPostApplicationCharge_request_application_charge::OAIPostApplicationCharge_request_application_charge(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostApplicationCharge_request_application_charge::OAIPostApplicationCharge_request_application_charge() {
    this->initializeModel();
}

OAIPostApplicationCharge_request_application_charge::~OAIPostApplicationCharge_request_application_charge() {}

void OAIPostApplicationCharge_request_application_charge::initializeModel() {

    m_application_charge_source_id_isSet = false;
    m_application_charge_source_id_isValid = false;
}

void OAIPostApplicationCharge_request_application_charge::fromJson(QString jsonString) {
...
void OAIPostApplicationCharge_request_application_charge::fromJsonObject(QJsonObject json) {
...
QString OAIPostApplicationCharge_request_application_charge::asJson() const {
...
QJsonObject OAIPostApplicationCharge_request_application_charge::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPostApplicationCharge_request_application_charge::getApplicationChargeSourceId() const {
    return m_application_charge_source_id;
}
void OAIPostApplicationCharge_request_application_charge::setApplicationChargeSourceId(const QString &application_charge_source_id) {
    m_application_charge_source_id = application_charge_source_id;
    m_application_charge_source_id_isSet = true;
}

bool OAIPostApplicationCharge_request_application_charge::is_application_charge_source_id_Set() const{
    return m_application_charge_source_id_isSet;
}

bool OAIPostApplicationCharge_request_application_charge::is_application_charge_source_id_Valid() const{
    return m_application_charge_source_id_isValid;
}

bool OAIPostApplicationCharge_request_application_charge::isSet() const {
...
bool OAIPostApplicationCharge_request_application_charge::isValid() const {
