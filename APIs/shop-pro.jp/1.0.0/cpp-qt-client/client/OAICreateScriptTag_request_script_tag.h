...
/*
 * OAICreateScriptTag_request_script_tag.h
 *
 * 
 */

#ifndef OAICreateScriptTag_request_script_tag_H
#define OAICreateScriptTag_request_script_tag_H
...
class OAICreateScriptTag_request_script_tag : public OAIObject {
public:
    OAICreateScriptTag_request_script_tag();
    OAICreateScriptTag_request_script_tag(QString json);
    ~OAICreateScriptTag_request_script_tag() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateScriptTag_request_script_tag)

#endif // OAICreateScriptTag_request_script_tag_H
