...
/*
 * OAICreateInlineScriptTag_request.h
 *
 * 
 */

#ifndef OAICreateInlineScriptTag_request_H
#define OAICreateInlineScriptTag_request_H

#include <QJsonObject>

#include "OAICreateInlineScriptTag_request_inline_script_tag.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateInlineScriptTag_request_inline_script_tag;

class OAICreateInlineScriptTag_request : public OAIObject {
public:
    OAICreateInlineScriptTag_request();
    OAICreateInlineScriptTag_request(QString json);
    ~OAICreateInlineScriptTag_request() override;
    ...
    OAICreateInlineScriptTag_request_inline_script_tag getInlineScriptTag() const;
    void setInlineScriptTag(const OAICreateInlineScriptTag_request_inline_script_tag &inline_script_tag);
    bool is_inline_script_tag_Set() const;
    bool is_inline_script_tag_Valid() const;
...
private:
    ...
    OAICreateInlineScriptTag_request_inline_script_tag m_inline_script_tag;
    bool m_inline_script_tag_isSet;
    bool m_inline_script_tag_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateInlineScriptTag_request)

#endif // OAICreateInlineScriptTag_request_H
