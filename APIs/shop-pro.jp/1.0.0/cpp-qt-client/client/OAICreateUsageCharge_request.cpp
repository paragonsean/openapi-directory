...
#include "OAICreateUsageCharge_request.h"
...
OAICreateUsageCharge_request::OAICreateUsageCharge_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUsageCharge_request::OAICreateUsageCharge_request() {
    this->initializeModel();
}

OAICreateUsageCharge_request::~OAICreateUsageCharge_request() {}

void OAICreateUsageCharge_request::initializeModel() {

    m_usage_charge_isSet = false;
    m_usage_charge_isValid = false;
}

void OAICreateUsageCharge_request::fromJson(QString jsonString) {
...
void OAICreateUsageCharge_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateUsageCharge_request::asJson() const {
...
QJsonObject OAICreateUsageCharge_request::asJsonObject() const {
    QJsonObject obj;
...
OAICreateUsageCharge_request_usage_charge OAICreateUsageCharge_request::getUsageCharge() const {
    return m_usage_charge;
}
void OAICreateUsageCharge_request::setUsageCharge(const OAICreateUsageCharge_request_usage_charge &usage_charge) {
    m_usage_charge = usage_charge;
    m_usage_charge_isSet = true;
}

bool OAICreateUsageCharge_request::is_usage_charge_Set() const{
    return m_usage_charge_isSet;
}

bool OAICreateUsageCharge_request::is_usage_charge_Valid() const{
    return m_usage_charge_isValid;
}

bool OAICreateUsageCharge_request::isSet() const {
...
bool OAICreateUsageCharge_request::isValid() const {
