...
#ifndef OAI_OAIApplicationChargeApi_H
#define OAI_OAIApplicationChargeApi_H
...
#include "OAIPostApplicationCharge_201_response.h"
...
class OAIApplicationChargeApi : public QObject {
    Q_OBJECT

public:
    OAIApplicationChargeApi(const int timeOut = 0);
    ~OAIApplicationChargeApi();
    ...
    /**
    * @param[in]  recurring_application_charge_id QString [required]
    * @param[in]  oai_create_usage_charge_request OAICreateUsageCharge_request [required]
    * @param[in]  x_appstore_usage_charge_token QString [optional]
    */
    virtual void createUsageCharge(const QString &recurring_application_charge_id, const OAICreateUsageCharge_request &oai_create_usage_charge_request, const ::OpenAPI::OptionalParam<QString> &x_appstore_usage_charge_token = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  oai_post_application_charge_request OAIPostApplicationCharge_request [required]
    */
    virtual void postApplicationCharge(const OAIPostApplicationCharge_request &oai_post_application_charge_request);
...
private:
    ...
    void createUsageChargeCallback(OAIHttpRequestWorker *worker);
    void postApplicationChargeCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void createUsageChargeSignal(OAICreateUsageCharge_201_response summary);
    void postApplicationChargeSignal(OAIPostApplicationCharge_201_response summary);


    void createUsageChargeSignalFull(OAIHttpRequestWorker *worker, OAICreateUsageCharge_201_response summary);
    void postApplicationChargeSignalFull(OAIHttpRequestWorker *worker, OAIPostApplicationCharge_201_response summary);

    Q_DECL_DEPRECATED_X("Use createUsageChargeSignalError() instead")
    void createUsageChargeSignalE(OAICreateUsageCharge_201_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createUsageChargeSignalError(OAICreateUsageCharge_201_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postApplicationChargeSignalError() instead")
    void postApplicationChargeSignalE(OAIPostApplicationCharge_201_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postApplicationChargeSignalError(OAIPostApplicationCharge_201_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use createUsageChargeSignalErrorFull() instead")
    void createUsageChargeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createUsageChargeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postApplicationChargeSignalErrorFull() instead")
    void postApplicationChargeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postApplicationChargeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
