...
OAICreateInlineScriptTag_201_response::OAICreateInlineScriptTag_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateInlineScriptTag_201_response::OAICreateInlineScriptTag_201_response() {
    this->initializeModel();
}

OAICreateInlineScriptTag_201_response::~OAICreateInlineScriptTag_201_response() {}

void OAICreateInlineScriptTag_201_response::initializeModel() {

    m_inline_script_tag_isSet = false;
    m_inline_script_tag_isValid = false;
}

void OAICreateInlineScriptTag_201_response::fromJson(QString jsonString) {
...
void OAICreateInlineScriptTag_201_response::fromJsonObject(QJsonObject json) {

    m_inline_script_tag_isValid = ::OpenAPI::fromJsonValue(m_inline_script_tag, json[QString("inline_script_tag")]);
    m_inline_script_tag_isSet = !json[QString("inline_script_tag")].isNull() && m_inline_script_tag_isValid;
}

QString OAICreateInlineScriptTag_201_response::asJson() const {
...
QJsonObject OAICreateInlineScriptTag_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_inline_script_tag.isSet()) {
        obj.insert(QString("inline_script_tag"), ::OpenAPI::toJsonValue(m_inline_script_tag));
    }
    return obj;
}

OAIGetInlineScriptTags_200_response_inline_script_tags_inner OAICreateInlineScriptTag_201_response::getInlineScriptTag() const {
    return m_inline_script_tag;
}
void OAICreateInlineScriptTag_201_response::setInlineScriptTag(const OAIGetInlineScriptTags_200_response_inline_script_tags_inner &inline_script_tag) {
    m_inline_script_tag = inline_script_tag;
    m_inline_script_tag_isSet = true;
}

bool OAICreateInlineScriptTag_201_response::is_inline_script_tag_Set() const{
    return m_inline_script_tag_isSet;
}

bool OAICreateInlineScriptTag_201_response::is_inline_script_tag_Valid() const{
    return m_inline_script_tag_isValid;
}

bool OAICreateInlineScriptTag_201_response::isSet() const {
...
bool OAICreateInlineScriptTag_201_response::isValid() const {
