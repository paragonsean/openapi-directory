...
OAIShopScriptTag::OAIShopScriptTag(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIShopScriptTag::OAIShopScriptTag() {
    this->initializeModel();
}

OAIShopScriptTag::~OAIShopScriptTag() {}

void OAIShopScriptTag::initializeModel() {
...
void OAIShopScriptTag::fromJson(QString jsonString) {
...
void OAIShopScriptTag::fromJsonObject(QJsonObject json) {
...
QString OAIShopScriptTag::asJson() const {
...
QJsonObject OAIShopScriptTag::asJsonObject() const {
    QJsonObject obj;
...
QString OAIShopScriptTag::getAccountId() const {
    return m_account_id;
}
void OAIShopScriptTag::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIShopScriptTag::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIShopScriptTag::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIShopScriptTag::getDisplayScope() const {
    return m_display_scope;
}
void OAIShopScriptTag::setDisplayScope(const QString &display_scope) {
    m_display_scope = display_scope;
    m_display_scope_isSet = true;
}

bool OAIShopScriptTag::is_display_scope_Set() const{
    return m_display_scope_isSet;
}

bool OAIShopScriptTag::is_display_scope_Valid() const{
    return m_display_scope_isValid;
}

qint32 OAIShopScriptTag::getId() const {
    return m_id;
}
void OAIShopScriptTag::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIShopScriptTag::is_id_Set() const{
    return m_id_isSet;
}

bool OAIShopScriptTag::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIShopScriptTag::getIntegrity() const {
    return m_integrity;
}
void OAIShopScriptTag::setIntegrity(const QString &integrity) {
    m_integrity = integrity;
    m_integrity_isSet = true;
}

bool OAIShopScriptTag::is_integrity_Set() const{
    return m_integrity_isSet;
}

bool OAIShopScriptTag::is_integrity_Valid() const{
    return m_integrity_isValid;
}

qint32 OAIShopScriptTag::getMakeDate() const {
    return m_make_date;
}
void OAIShopScriptTag::setMakeDate(const qint32 &make_date) {
    m_make_date = make_date;
    m_make_date_isSet = true;
}

bool OAIShopScriptTag::is_make_date_Set() const{
    return m_make_date_isSet;
}

bool OAIShopScriptTag::is_make_date_Valid() const{
    return m_make_date_isValid;
}

qint32 OAIShopScriptTag::getOauthApplicationId() const {
    return m_oauth_application_id;
}
void OAIShopScriptTag::setOauthApplicationId(const qint32 &oauth_application_id) {
    m_oauth_application_id = oauth_application_id;
    m_oauth_application_id_isSet = true;
}

bool OAIShopScriptTag::is_oauth_application_id_Set() const{
    return m_oauth_application_id_isSet;
}

bool OAIShopScriptTag::is_oauth_application_id_Valid() const{
    return m_oauth_application_id_isValid;
}

QString OAIShopScriptTag::getSrc() const {
    return m_src;
}
void OAIShopScriptTag::setSrc(const QString &src) {
    m_src = src;
    m_src_isSet = true;
}

bool OAIShopScriptTag::is_src_Set() const{
    return m_src_isSet;
}

bool OAIShopScriptTag::is_src_Valid() const{
    return m_src_isValid;
}

qint32 OAIShopScriptTag::getUpdateDate() const {
    return m_update_date;
}
void OAIShopScriptTag::setUpdateDate(const qint32 &update_date) {
    m_update_date = update_date;
    m_update_date_isSet = true;
}

bool OAIShopScriptTag::is_update_date_Set() const{
    return m_update_date_isSet;
}

bool OAIShopScriptTag::is_update_date_Valid() const{
    return m_update_date_isValid;
}

bool OAIShopScriptTag::isSet() const {
...
bool OAIShopScriptTag::isValid() const {
