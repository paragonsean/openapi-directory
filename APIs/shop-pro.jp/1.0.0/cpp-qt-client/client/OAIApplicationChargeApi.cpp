...
#include "OAIApplicationChargeApi.h"
...
OAIApplicationChargeApi::OAIApplicationChargeApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIApplicationChargeApi::~OAIApplicationChargeApi() {
}

void OAIApplicationChargeApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("createUsageCharge", defaultConf);
    _serverIndices.insert("createUsageCharge", 0);
    _serverConfigs.insert("postApplicationCharge", defaultConf);
    _serverIndices.insert("postApplicationCharge", 0);
}
...
*/
int OAIApplicationChargeApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIApplicationChargeApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIApplicationChargeApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIApplicationChargeApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIApplicationChargeApi::setUsername(const QString &username) {
    _username = username;
}

void OAIApplicationChargeApi::setPassword(const QString &password) {
    _password = password;
}


void OAIApplicationChargeApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIApplicationChargeApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIApplicationChargeApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIApplicationChargeApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIApplicationChargeApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIApplicationChargeApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIApplicationChargeApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIApplicationChargeApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIApplicationChargeApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIApplicationChargeApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIApplicationChargeApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIApplicationChargeApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIApplicationChargeApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIApplicationChargeApi::createUsageCharge(const QString &recurring_application_charge_id, const OAICreateUsageCharge_request &oai_create_usage_charge_request, const ::OpenAPI::OptionalParam<QString> &x_appstore_usage_charge_token) {
    QString fullPath = QString(_serverConfigs["createUsageCharge"][_serverIndices.value("createUsageCharge")].URL()+"/appstore/v1/recurring_application_charges/{recurringApplicationChargeId}/usage_charges.json");
    
    
    {
        QString recurring_application_charge_idPathParam("{");
        recurring_application_charge_idPathParam.append("recurringApplicationChargeId").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "recurringApplicationChargeId", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"recurringApplicationChargeId"+pathSuffix : pathPrefix;
        fullPath.replace(recurring_application_charge_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(recurring_application_charge_id)));
    }
...

    {
        ...
        QByteArray output = oai_create_usage_charge_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    if (x_appstore_usage_charge_token.hasValue())
    {
        if (!::OpenAPI::toStringValue(x_appstore_usage_charge_token.value()).isEmpty()) {
            input.headers.insert("X-Appstore-Usage-Charge-Token", ::OpenAPI::toStringValue(x_appstore_usage_charge_token.value()));
        }
        }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApplicationChargeApi::createUsageChargeCallback);
    connect(this, &OAIApplicationChargeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("write_application_charge");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApplicationChargeApi::createUsageChargeCallback);
    connect(this, &OAIApplicationChargeApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIApplicationChargeApi::createUsageChargeCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICreateUsageCharge_201_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createUsageChargeSignal(output);
        Q_EMIT createUsageChargeSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createUsageChargeSignalE(output, error_type, error_str);
        Q_EMIT createUsageChargeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createUsageChargeSignalError(output, error_type, error_str);
        Q_EMIT createUsageChargeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIApplicationChargeApi::postApplicationCharge(const OAIPostApplicationCharge_request &oai_post_application_charge_request) {
    QString fullPath = QString(_serverConfigs["postApplicationCharge"][_serverIndices.value("postApplicationCharge")].URL()+"/appstore/v1/application_charges.json");
...

    {
        ...
        QByteArray output = oai_post_application_charge_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApplicationChargeApi::postApplicationChargeCallback);
    connect(this, &OAIApplicationChargeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApplicationChargeApi::postApplicationChargeCallback);
    connect(this, &OAIApplicationChargeApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIApplicationChargeApi::postApplicationChargeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIPostApplicationCharge_201_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT postApplicationChargeSignal(output);
        Q_EMIT postApplicationChargeSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("write_application_charge");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT postApplicationChargeSignalE(output, error_type, error_str);
        Q_EMIT postApplicationChargeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT postApplicationChargeSignalError(output, error_type, error_str);
        Q_EMIT postApplicationChargeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIApplicationChargeApi::tokenAvailable(){
