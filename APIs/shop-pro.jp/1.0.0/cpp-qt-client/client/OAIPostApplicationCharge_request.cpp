...
#include "OAIPostApplicationCharge_request.h"
...
OAIPostApplicationCharge_request::OAIPostApplicationCharge_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostApplicationCharge_request::OAIPostApplicationCharge_request() {
    this->initializeModel();
}

OAIPostApplicationCharge_request::~OAIPostApplicationCharge_request() {}

void OAIPostApplicationCharge_request::initializeModel() {

    m_application_charge_isSet = false;
    m_application_charge_isValid = false;
}

void OAIPostApplicationCharge_request::fromJson(QString jsonString) {
...
void OAIPostApplicationCharge_request::fromJsonObject(QJsonObject json) {

    m_application_charge_isValid = ::OpenAPI::fromJsonValue(m_application_charge, json[QString("application_charge")]);
    m_application_charge_isSet = !json[QString("application_charge")].isNull() && m_application_charge_isValid;
}

QString OAIPostApplicationCharge_request::asJson() const {
...
QJsonObject OAIPostApplicationCharge_request::asJsonObject() const {
    QJsonObject obj;
    if (m_application_charge.isSet()) {
        obj.insert(QString("application_charge"), ::OpenAPI::toJsonValue(m_application_charge));
    }
    return obj;
}

OAIPostApplicationCharge_request_application_charge OAIPostApplicationCharge_request::getApplicationCharge() const {
    return m_application_charge;
}
void OAIPostApplicationCharge_request::setApplicationCharge(const OAIPostApplicationCharge_request_application_charge &application_charge) {
    m_application_charge = application_charge;
    m_application_charge_isSet = true;
}

bool OAIPostApplicationCharge_request::is_application_charge_Set() const{
    return m_application_charge_isSet;
}

bool OAIPostApplicationCharge_request::is_application_charge_Valid() const{
    return m_application_charge_isValid;
}

bool OAIPostApplicationCharge_request::isSet() const {
...
bool OAIPostApplicationCharge_request::isValid() const {
