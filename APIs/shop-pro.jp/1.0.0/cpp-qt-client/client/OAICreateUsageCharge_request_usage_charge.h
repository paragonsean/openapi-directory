...
/*
 * OAICreateUsageCharge_request_usage_charge.h
 *
 * 
 */

#ifndef OAICreateUsageCharge_request_usage_charge_H
#define OAICreateUsageCharge_request_usage_charge_H
...
class OAICreateUsageCharge_request_usage_charge : public OAIObject {
public:
    OAICreateUsageCharge_request_usage_charge();
    OAICreateUsageCharge_request_usage_charge(QString json);
    ~OAICreateUsageCharge_request_usage_charge() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUsageCharge_request_usage_charge)

#endif // OAICreateUsageCharge_request_usage_charge_H
