...
/*
 * OAICreateShopScriptTag_200_response.h
 *
 * 
 */

#ifndef OAICreateShopScriptTag_200_response_H
#define OAICreateShopScriptTag_200_response_H
...
class OAICreateShopScriptTag_200_response : public OAIObject {
public:
    OAICreateShopScriptTag_200_response();
    OAICreateShopScriptTag_200_response(QString json);
    ~OAICreateShopScriptTag_200_response() override;
    ...
    OAIGetShopScriptTags_200_response_script_tags_inner getScriptTag() const;
    void setScriptTag(const OAIGetShopScriptTags_200_response_script_tags_inner &script_tag);
...
private:
    ...
    OAIGetShopScriptTags_200_response_script_tags_inner m_script_tag;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateShopScriptTag_200_response)

#endif // OAICreateShopScriptTag_200_response_H
