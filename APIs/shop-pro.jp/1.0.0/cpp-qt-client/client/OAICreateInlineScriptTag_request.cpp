...
OAICreateInlineScriptTag_request::OAICreateInlineScriptTag_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateInlineScriptTag_request::OAICreateInlineScriptTag_request() {
    this->initializeModel();
}

OAICreateInlineScriptTag_request::~OAICreateInlineScriptTag_request() {}

void OAICreateInlineScriptTag_request::initializeModel() {

    m_inline_script_tag_isSet = false;
    m_inline_script_tag_isValid = false;
}

void OAICreateInlineScriptTag_request::fromJson(QString jsonString) {
...
void OAICreateInlineScriptTag_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateInlineScriptTag_request::asJson() const {
...
QJsonObject OAICreateInlineScriptTag_request::asJsonObject() const {
    QJsonObject obj;
...
OAICreateInlineScriptTag_request_inline_script_tag OAICreateInlineScriptTag_request::getInlineScriptTag() const {
    return m_inline_script_tag;
}
void OAICreateInlineScriptTag_request::setInlineScriptTag(const OAICreateInlineScriptTag_request_inline_script_tag &inline_script_tag) {
    m_inline_script_tag = inline_script_tag;
    m_inline_script_tag_isSet = true;
}

bool OAICreateInlineScriptTag_request::is_inline_script_tag_Set() const{
    return m_inline_script_tag_isSet;
}

bool OAICreateInlineScriptTag_request::is_inline_script_tag_Valid() const{
    return m_inline_script_tag_isValid;
}

bool OAICreateInlineScriptTag_request::isSet() const {
...
bool OAICreateInlineScriptTag_request::isValid() const {
