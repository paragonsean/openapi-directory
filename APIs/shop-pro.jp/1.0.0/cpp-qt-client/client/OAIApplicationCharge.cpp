...
#include "OAIApplicationCharge.h"
...
OAIApplicationCharge::OAIApplicationCharge(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApplicationCharge::OAIApplicationCharge() {
    this->initializeModel();
}

OAIApplicationCharge::~OAIApplicationCharge() {}

void OAIApplicationCharge::initializeModel() {
...
void OAIApplicationCharge::fromJson(QString jsonString) {
...
void OAIApplicationCharge::fromJsonObject(QJsonObject json) {
...
QString OAIApplicationCharge::asJson() const {
...
QJsonObject OAIApplicationCharge::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIApplicationCharge::getId() const {
    return m_id;
}
void OAIApplicationCharge::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIApplicationCharge::is_id_Set() const{
    return m_id_isSet;
}

bool OAIApplicationCharge::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAIApplicationCharge::getMakeDate() const {
    return m_make_date;
}
void OAIApplicationCharge::setMakeDate(const qint32 &make_date) {
    m_make_date = make_date;
    m_make_date_isSet = true;
}

bool OAIApplicationCharge::is_make_date_Set() const{
    return m_make_date_isSet;
}

bool OAIApplicationCharge::is_make_date_Valid() const{
    return m_make_date_isValid;
}

qint32 OAIApplicationCharge::getPoint() const {
    return m_point;
}
void OAIApplicationCharge::setPoint(const qint32 &point) {
    m_point = point;
    m_point_isSet = true;
}

bool OAIApplicationCharge::is_point_Set() const{
    return m_point_isSet;
}

bool OAIApplicationCharge::is_point_Valid() const{
    return m_point_isValid;
}

qint32 OAIApplicationCharge::getUpdateDate() const {
    return m_update_date;
}
void OAIApplicationCharge::setUpdateDate(const qint32 &update_date) {
    m_update_date = update_date;
    m_update_date_isSet = true;
}

bool OAIApplicationCharge::is_update_date_Set() const{
    return m_update_date_isSet;
}

bool OAIApplicationCharge::is_update_date_Valid() const{
    return m_update_date_isValid;
}

bool OAIApplicationCharge::isSet() const {
...
bool OAIApplicationCharge::isValid() const {
