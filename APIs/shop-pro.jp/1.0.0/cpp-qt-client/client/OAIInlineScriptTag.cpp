...
OAIInlineScriptTag::OAIInlineScriptTag(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInlineScriptTag::OAIInlineScriptTag() {
    this->initializeModel();
}

OAIInlineScriptTag::~OAIInlineScriptTag() {}

void OAIInlineScriptTag::initializeModel() {
...
void OAIInlineScriptTag::fromJson(QString jsonString) {
...
void OAIInlineScriptTag::fromJsonObject(QJsonObject json) {
...
QString OAIInlineScriptTag::asJson() const {
...
QJsonObject OAIInlineScriptTag::asJsonObject() const {
    QJsonObject obj;
...
QString OAIInlineScriptTag::getAccountId() const {
    return m_account_id;
}
void OAIInlineScriptTag::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIInlineScriptTag::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIInlineScriptTag::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIInlineScriptTag::getDisplayScope() const {
    return m_display_scope;
}
void OAIInlineScriptTag::setDisplayScope(const QString &display_scope) {
    m_display_scope = display_scope;
    m_display_scope_isSet = true;
}

bool OAIInlineScriptTag::is_display_scope_Set() const{
    return m_display_scope_isSet;
}

bool OAIInlineScriptTag::is_display_scope_Valid() const{
    return m_display_scope_isValid;
}

qint32 OAIInlineScriptTag::getId() const {
    return m_id;
}
void OAIInlineScriptTag::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInlineScriptTag::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInlineScriptTag::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAIInlineScriptTag::getMakeDate() const {
    return m_make_date;
}
void OAIInlineScriptTag::setMakeDate(const qint32 &make_date) {
    m_make_date = make_date;
    m_make_date_isSet = true;
}

bool OAIInlineScriptTag::is_make_date_Set() const{
    return m_make_date_isSet;
}

bool OAIInlineScriptTag::is_make_date_Valid() const{
    return m_make_date_isValid;
}

qint32 OAIInlineScriptTag::getOauthApplicationId() const {
    return m_oauth_application_id;
}
void OAIInlineScriptTag::setOauthApplicationId(const qint32 &oauth_application_id) {
    m_oauth_application_id = oauth_application_id;
    m_oauth_application_id_isSet = true;
}

bool OAIInlineScriptTag::is_oauth_application_id_Set() const{
    return m_oauth_application_id_isSet;
}

bool OAIInlineScriptTag::is_oauth_application_id_Valid() const{
    return m_oauth_application_id_isValid;
}

QString OAIInlineScriptTag::getScript() const {
    return m_script;
}
void OAIInlineScriptTag::setScript(const QString &script) {
    m_script = script;
    m_script_isSet = true;
}

bool OAIInlineScriptTag::is_script_Set() const{
    return m_script_isSet;
}

bool OAIInlineScriptTag::is_script_Valid() const{
    return m_script_isValid;
}

QString OAIInlineScriptTag::getTriggerEvent() const {
    return m_trigger_event;
}
void OAIInlineScriptTag::setTriggerEvent(const QString &trigger_event) {
    m_trigger_event = trigger_event;
    m_trigger_event_isSet = true;
}

bool OAIInlineScriptTag::is_trigger_event_Set() const{
    return m_trigger_event_isSet;
}

bool OAIInlineScriptTag::is_trigger_event_Valid() const{
    return m_trigger_event_isValid;
}

qint32 OAIInlineScriptTag::getUpdateDate() const {
    return m_update_date;
}
void OAIInlineScriptTag::setUpdateDate(const qint32 &update_date) {
    m_update_date = update_date;
    m_update_date_isSet = true;
}

bool OAIInlineScriptTag::is_update_date_Set() const{
    return m_update_date_isSet;
}

bool OAIInlineScriptTag::is_update_date_Valid() const{
    return m_update_date_isValid;
}

bool OAIInlineScriptTag::isSet() const {
...
bool OAIInlineScriptTag::isValid() const {
