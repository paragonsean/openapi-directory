...
OAIUsageCharge::OAIUsageCharge(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUsageCharge::OAIUsageCharge() {
    this->initializeModel();
}

OAIUsageCharge::~OAIUsageCharge() {}

void OAIUsageCharge::initializeModel() {
...
void OAIUsageCharge::fromJson(QString jsonString) {
...
void OAIUsageCharge::fromJsonObject(QJsonObject json) {
...
QString OAIUsageCharge::asJson() const {
...
QJsonObject OAIUsageCharge::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUsageCharge::getDescription() const {
    return m_description;
}
void OAIUsageCharge::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUsageCharge::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUsageCharge::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUsageCharge::getId() const {
    return m_id;
}
void OAIUsageCharge::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUsageCharge::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUsageCharge::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAIUsageCharge::getMakeDate() const {
    return m_make_date;
}
void OAIUsageCharge::setMakeDate(const qint32 &make_date) {
    m_make_date = make_date;
    m_make_date_isSet = true;
}

bool OAIUsageCharge::is_make_date_Set() const{
    return m_make_date_isSet;
}

bool OAIUsageCharge::is_make_date_Valid() const{
    return m_make_date_isValid;
}

qint32 OAIUsageCharge::getPoint() const {
    return m_point;
}
void OAIUsageCharge::setPoint(const qint32 &point) {
    m_point = point;
    m_point_isSet = true;
}

bool OAIUsageCharge::is_point_Set() const{
    return m_point_isSet;
}

bool OAIUsageCharge::is_point_Valid() const{
    return m_point_isValid;
}

qint32 OAIUsageCharge::getUpdateDate() const {
    return m_update_date;
}
void OAIUsageCharge::setUpdateDate(const qint32 &update_date) {
    m_update_date = update_date;
    m_update_date_isSet = true;
}

bool OAIUsageCharge::is_update_date_Set() const{
    return m_update_date_isSet;
}

bool OAIUsageCharge::is_update_date_Valid() const{
    return m_update_date_isValid;
}

bool OAIUsageCharge::isSet() const {
...
bool OAIUsageCharge::isValid() const {
