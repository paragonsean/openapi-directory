...
#ifndef OAI_OAIScriptApi_H
#define OAI_OAIScriptApi_H
...
#include "OAICreateShopScriptTag_200_response.h"
...
class OAIScriptApi : public QObject {
    Q_OBJECT

public:
    OAIScriptApi(const int timeOut = 0);
    ~OAIScriptApi();
    ...
    /**
    * @param[in]  oai_create_shop_script_tag_request OAICreateShopScriptTag_request [optional]
    */
    virtual void createShopScriptTag(const ::OpenAPI::OptionalParam<OAICreateShopScriptTag_request> &oai_create_shop_script_tag_request = ::OpenAPI::OptionalParam<OAICreateShopScriptTag_request>());

    /**
    * @param[in]  script_tag_id qint32 [required]
    */
    virtual void deleteScriptTag(const qint32 &script_tag_id);

    /**
    * @param[in]  script_tag_id qint32 [required]
    */
    virtual void getShopScriptTag(const qint32 &script_tag_id);


    virtual void getShopScriptTags();

    /**
    * @param[in]  script_tag_id qint32 [required]
    * @param[in]  oai_create_shop_script_tag_request OAICreateShopScriptTag_request [optional]
    */
    virtual void updateShopScriptTag(const qint32 &script_tag_id, const ::OpenAPI::OptionalParam<OAICreateShopScriptTag_request> &oai_create_shop_script_tag_request = ::OpenAPI::OptionalParam<OAICreateShopScriptTag_request>());
...
private:
    ...
    void createShopScriptTagCallback(OAIHttpRequestWorker *worker);
    void deleteScriptTagCallback(OAIHttpRequestWorker *worker);
    void getShopScriptTagCallback(OAIHttpRequestWorker *worker);
    void getShopScriptTagsCallback(OAIHttpRequestWorker *worker);
    void updateShopScriptTagCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void createShopScriptTagSignal(OAICreateShopScriptTag_200_response summary);
    void deleteScriptTagSignal();
    void getShopScriptTagSignal(OAICreateShopScriptTag_200_response summary);
    void getShopScriptTagsSignal(OAIGetShopScriptTags_200_response summary);
    void updateShopScriptTagSignal(OAICreateShopScriptTag_200_response summary);


    void createShopScriptTagSignalFull(OAIHttpRequestWorker *worker, OAICreateShopScriptTag_200_response summary);
    void deleteScriptTagSignalFull(OAIHttpRequestWorker *worker);
    void getShopScriptTagSignalFull(OAIHttpRequestWorker *worker, OAICreateShopScriptTag_200_response summary);
    void getShopScriptTagsSignalFull(OAIHttpRequestWorker *worker, OAIGetShopScriptTags_200_response summary);
    void updateShopScriptTagSignalFull(OAIHttpRequestWorker *worker, OAICreateShopScriptTag_200_response summary);

    Q_DECL_DEPRECATED_X("Use createShopScriptTagSignalError() instead")
    void createShopScriptTagSignalE(OAICreateShopScriptTag_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createShopScriptTagSignalError(OAICreateShopScriptTag_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteScriptTagSignalError() instead")
    void deleteScriptTagSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void deleteScriptTagSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getShopScriptTagSignalError() instead")
    void getShopScriptTagSignalE(OAICreateShopScriptTag_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getShopScriptTagSignalError(OAICreateShopScriptTag_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getShopScriptTagsSignalError() instead")
    void getShopScriptTagsSignalE(OAIGetShopScriptTags_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getShopScriptTagsSignalError(OAIGetShopScriptTags_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateShopScriptTagSignalError() instead")
    void updateShopScriptTagSignalE(OAICreateShopScriptTag_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateShopScriptTagSignalError(OAICreateShopScriptTag_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use createShopScriptTagSignalErrorFull() instead")
    void createShopScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createShopScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteScriptTagSignalErrorFull() instead")
    void deleteScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getShopScriptTagSignalErrorFull() instead")
    void getShopScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getShopScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getShopScriptTagsSignalErrorFull() instead")
    void getShopScriptTagsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getShopScriptTagsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateShopScriptTagSignalErrorFull() instead")
    void updateShopScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void updateShopScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
