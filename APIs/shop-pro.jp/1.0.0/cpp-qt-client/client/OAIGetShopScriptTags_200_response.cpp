...
#include "OAIGetShopScriptTags_200_response.h"
...
OAIGetShopScriptTags_200_response::OAIGetShopScriptTags_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetShopScriptTags_200_response::OAIGetShopScriptTags_200_response() {
    this->initializeModel();
}

OAIGetShopScriptTags_200_response::~OAIGetShopScriptTags_200_response() {}

void OAIGetShopScriptTags_200_response::initializeModel() {

    m_script_tags_isSet = false;
    m_script_tags_isValid = false;
}

void OAIGetShopScriptTags_200_response::fromJson(QString jsonString) {
...
void OAIGetShopScriptTags_200_response::fromJsonObject(QJsonObject json) {

    m_script_tags_isValid = ::OpenAPI::fromJsonValue(m_script_tags, json[QString("script_tags")]);
    m_script_tags_isSet = !json[QString("script_tags")].isNull() && m_script_tags_isValid;
}

QString OAIGetShopScriptTags_200_response::asJson() const {
...
QJsonObject OAIGetShopScriptTags_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_script_tags.size() > 0) {
        obj.insert(QString("script_tags"), ::OpenAPI::toJsonValue(m_script_tags));
    }
    return obj;
}

QList<OAIGetShopScriptTags_200_response_script_tags_inner> OAIGetShopScriptTags_200_response::getScriptTags() const {
    return m_script_tags;
}
void OAIGetShopScriptTags_200_response::setScriptTags(const QList<OAIGetShopScriptTags_200_response_script_tags_inner> &script_tags) {
    m_script_tags = script_tags;
    m_script_tags_isSet = true;
}

bool OAIGetShopScriptTags_200_response::is_script_tags_Set() const{
    return m_script_tags_isSet;
}

bool OAIGetShopScriptTags_200_response::is_script_tags_Valid() const{
    return m_script_tags_isValid;
}

bool OAIGetShopScriptTags_200_response::isSet() const {
...
bool OAIGetShopScriptTags_200_response::isValid() const {
