...
/*
 * OAIGetInlineScriptTags_200_response.h
 *
 * 
 */

#ifndef OAIGetInlineScriptTags_200_response_H
#define OAIGetInlineScriptTags_200_response_H
...
namespace OpenAPI {
class OAIGetInlineScriptTags_200_response_inline_script_tags_inner;

class OAIGetInlineScriptTags_200_response : public OAIObject {
public:
    OAIGetInlineScriptTags_200_response();
    OAIGetInlineScriptTags_200_response(QString json);
    ~OAIGetInlineScriptTags_200_response() override;
    ...
    QList<OAIGetInlineScriptTags_200_response_inline_script_tags_inner> getInlineScriptTags() const;
    void setInlineScriptTags(const QList<OAIGetInlineScriptTags_200_response_inline_script_tags_inner> &inline_script_tags);
    bool is_inline_script_tags_Set() const;
    bool is_inline_script_tags_Valid() const;
...
private:
    ...
    QList<OAIGetInlineScriptTags_200_response_inline_script_tags_inner> m_inline_script_tags;
    bool m_inline_script_tags_isSet;
    bool m_inline_script_tags_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetInlineScriptTags_200_response)

#endif // OAIGetInlineScriptTags_200_response_H
