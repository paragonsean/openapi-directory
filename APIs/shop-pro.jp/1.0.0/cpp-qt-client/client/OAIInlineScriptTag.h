...
/*
 * OAIInlineScriptTag.h
 *
 * 
 */

#ifndef OAIInlineScriptTag_H
#define OAIInlineScriptTag_H
...
class OAIInlineScriptTag : public OAIObject {
public:
    OAIInlineScriptTag();
    OAIInlineScriptTag(QString json);
    ~OAIInlineScriptTag() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInlineScriptTag)

#endif // OAIInlineScriptTag_H
