...
#ifndef OAICartScriptTag_H
#define OAICartScriptTag_H
...
class OAICartScriptTag : public OAIObject {
public:
    OAICartScriptTag();
    OAICartScriptTag(QString json);
    ~OAICartScriptTag() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICartScriptTag)

#endif // OAICartScriptTag_H
