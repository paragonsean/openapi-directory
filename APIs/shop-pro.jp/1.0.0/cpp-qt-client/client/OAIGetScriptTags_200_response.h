...
/*
 * OAIGetScriptTags_200_response.h
 *
 * 
 */

#ifndef OAIGetScriptTags_200_response_H
#define OAIGetScriptTags_200_response_H

#include <QJsonObject>

#include "OAIGetScriptTags_200_response_script_tags_inner.h"
#include <QList>
...
namespace OpenAPI {
class OAIGetScriptTags_200_response_script_tags_inner;

class OAIGetScriptTags_200_response : public OAIObject {
public:
    OAIGetScriptTags_200_response();
    OAIGetScriptTags_200_response(QString json);
    ~OAIGetScriptTags_200_response() override;
    ...
    QList<OAIGetScriptTags_200_response_script_tags_inner> getScriptTags() const;
    void setScriptTags(const QList<OAIGetScriptTags_200_response_script_tags_inner> &script_tags);
    bool is_script_tags_Set() const;
    bool is_script_tags_Valid() const;
...
private:
    ...
    QList<OAIGetScriptTags_200_response_script_tags_inner> m_script_tags;
    bool m_script_tags_isSet;
    bool m_script_tags_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetScriptTags_200_response)

#endif // OAIGetScriptTags_200_response_H
