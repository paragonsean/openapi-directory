...
/*
 * OAIGetShopScriptTags_200_response.h
 *
 * 
 */

#ifndef OAIGetShopScriptTags_200_response_H
#define OAIGetShopScriptTags_200_response_H
...
namespace OpenAPI {
class OAIGetShopScriptTags_200_response_script_tags_inner;

class OAIGetShopScriptTags_200_response : public OAIObject {
public:
    OAIGetShopScriptTags_200_response();
    OAIGetShopScriptTags_200_response(QString json);
    ~OAIGetShopScriptTags_200_response() override;
    ...
    QList<OAIGetShopScriptTags_200_response_script_tags_inner> getScriptTags() const;
    void setScriptTags(const QList<OAIGetShopScriptTags_200_response_script_tags_inner> &script_tags);
...
private:
    ...
    QList<OAIGetShopScriptTags_200_response_script_tags_inner> m_script_tags;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetShopScriptTags_200_response)

#endif // OAIGetShopScriptTags_200_response_H
