...
OAICreateInlineScriptTag_request_inline_script_tag::OAICreateInlineScriptTag_request_inline_script_tag(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateInlineScriptTag_request_inline_script_tag::OAICreateInlineScriptTag_request_inline_script_tag() {
    this->initializeModel();
}

OAICreateInlineScriptTag_request_inline_script_tag::~OAICreateInlineScriptTag_request_inline_script_tag() {}

void OAICreateInlineScriptTag_request_inline_script_tag::initializeModel() {
...
void OAICreateInlineScriptTag_request_inline_script_tag::fromJson(QString jsonString) {
...
void OAICreateInlineScriptTag_request_inline_script_tag::fromJsonObject(QJsonObject json) {
...
QString OAICreateInlineScriptTag_request_inline_script_tag::asJson() const {
...
QJsonObject OAICreateInlineScriptTag_request_inline_script_tag::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateInlineScriptTag_request_inline_script_tag::getDisplayScope() const {
    return m_display_scope;
}
void OAICreateInlineScriptTag_request_inline_script_tag::setDisplayScope(const QString &display_scope) {
    m_display_scope = display_scope;
    m_display_scope_isSet = true;
}

bool OAICreateInlineScriptTag_request_inline_script_tag::is_display_scope_Set() const{
    return m_display_scope_isSet;
}

bool OAICreateInlineScriptTag_request_inline_script_tag::is_display_scope_Valid() const{
    return m_display_scope_isValid;
}

QString OAICreateInlineScriptTag_request_inline_script_tag::getScript() const {
    return m_script;
}
void OAICreateInlineScriptTag_request_inline_script_tag::setScript(const QString &script) {
    m_script = script;
    m_script_isSet = true;
}

bool OAICreateInlineScriptTag_request_inline_script_tag::is_script_Set() const{
    return m_script_isSet;
}

bool OAICreateInlineScriptTag_request_inline_script_tag::is_script_Valid() const{
    return m_script_isValid;
}

QString OAICreateInlineScriptTag_request_inline_script_tag::getTriggerEvent() const {
    return m_trigger_event;
}
void OAICreateInlineScriptTag_request_inline_script_tag::setTriggerEvent(const QString &trigger_event) {
    m_trigger_event = trigger_event;
    m_trigger_event_isSet = true;
}

bool OAICreateInlineScriptTag_request_inline_script_tag::is_trigger_event_Set() const{
    return m_trigger_event_isSet;
}

bool OAICreateInlineScriptTag_request_inline_script_tag::is_trigger_event_Valid() const{
    return m_trigger_event_isValid;
}

bool OAICreateInlineScriptTag_request_inline_script_tag::isSet() const {
...
bool OAICreateInlineScriptTag_request_inline_script_tag::isValid() const {
