...
/*
 * OAICreateUsageCharge_201_response_usage_charge.h
 *
 * 
 */

#ifndef OAICreateUsageCharge_201_response_usage_charge_H
#define OAICreateUsageCharge_201_response_usage_charge_H
...
class OAICreateUsageCharge_201_response_usage_charge : public OAIObject {
public:
    OAICreateUsageCharge_201_response_usage_charge();
    OAICreateUsageCharge_201_response_usage_charge(QString json);
    ~OAICreateUsageCharge_201_response_usage_charge() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUsageCharge_201_response_usage_charge)

#endif // OAICreateUsageCharge_201_response_usage_charge_H
