...
/*
 * OAIDeleteInstallation_200_response.h
 *
 * 
 */

#ifndef OAIDeleteInstallation_200_response_H
#define OAIDeleteInstallation_200_response_H
...
namespace OpenAPI {
class OAIDeleteInstallation_200_response_usage_charge;

class OAIDeleteInstallation_200_response : public OAIObject {
public:
    OAIDeleteInstallation_200_response();
    OAIDeleteInstallation_200_response(QString json);
    ~OAIDeleteInstallation_200_response() override;
    ...
    QString getApplicationChargeSourceId() const;
    void setApplicationChargeSourceId(const QString &application_charge_source_id);
    bool is_application_charge_source_id_Set() const;
    bool is_application_charge_source_id_Valid() const;

    QString getRecurringApplicationChargeId() const;
    void setRecurringApplicationChargeId(const QString &recurring_application_charge_id);
    bool is_recurring_application_charge_id_Set() const;
    bool is_recurring_application_charge_id_Valid() const;

    qint32 getUninstalledAt() const;
    void setUninstalledAt(const qint32 &uninstalled_at);
    bool is_uninstalled_at_Set() const;
    bool is_uninstalled_at_Valid() const;

    OAIDeleteInstallation_200_response_usage_charge getUsageCharge() const;
    void setUsageCharge(const OAIDeleteInstallation_200_response_usage_charge &usage_charge);
...
private:
    ...
    QString m_application_charge_source_id;
    bool m_application_charge_source_id_isSet;
    bool m_application_charge_source_id_isValid;

    QString m_recurring_application_charge_id;
    bool m_recurring_application_charge_id_isSet;
    bool m_recurring_application_charge_id_isValid;

    qint32 m_uninstalled_at;
    bool m_uninstalled_at_isSet;
    bool m_uninstalled_at_isValid;

    OAIDeleteInstallation_200_response_usage_charge m_usage_charge;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteInstallation_200_response)

#endif // OAIDeleteInstallation_200_response_H
