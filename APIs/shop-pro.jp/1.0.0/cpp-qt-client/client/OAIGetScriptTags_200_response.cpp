...
OAIGetScriptTags_200_response::OAIGetScriptTags_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetScriptTags_200_response::OAIGetScriptTags_200_response() {
    this->initializeModel();
}

OAIGetScriptTags_200_response::~OAIGetScriptTags_200_response() {}

void OAIGetScriptTags_200_response::initializeModel() {

    m_script_tags_isSet = false;
    m_script_tags_isValid = false;
}

void OAIGetScriptTags_200_response::fromJson(QString jsonString) {
...
void OAIGetScriptTags_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetScriptTags_200_response::asJson() const {
...
QJsonObject OAIGetScriptTags_200_response::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIGetScriptTags_200_response_script_tags_inner> OAIGetScriptTags_200_response::getScriptTags() const {
    return m_script_tags;
}
void OAIGetScriptTags_200_response::setScriptTags(const QList<OAIGetScriptTags_200_response_script_tags_inner> &script_tags) {
    m_script_tags = script_tags;
    m_script_tags_isSet = true;
}

bool OAIGetScriptTags_200_response::is_script_tags_Set() const{
    return m_script_tags_isSet;
}

bool OAIGetScriptTags_200_response::is_script_tags_Valid() const{
    return m_script_tags_isValid;
}

bool OAIGetScriptTags_200_response::isSet() const {
...
bool OAIGetScriptTags_200_response::isValid() const {
