...
OAIGetInlineScriptTags_200_response::OAIGetInlineScriptTags_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetInlineScriptTags_200_response::OAIGetInlineScriptTags_200_response() {
    this->initializeModel();
}

OAIGetInlineScriptTags_200_response::~OAIGetInlineScriptTags_200_response() {}

void OAIGetInlineScriptTags_200_response::initializeModel() {

    m_inline_script_tags_isSet = false;
    m_inline_script_tags_isValid = false;
}

void OAIGetInlineScriptTags_200_response::fromJson(QString jsonString) {
...
void OAIGetInlineScriptTags_200_response::fromJsonObject(QJsonObject json) {

    m_inline_script_tags_isValid = ::OpenAPI::fromJsonValue(m_inline_script_tags, json[QString("inline_script_tags")]);
    m_inline_script_tags_isSet = !json[QString("inline_script_tags")].isNull() && m_inline_script_tags_isValid;
}

QString OAIGetInlineScriptTags_200_response::asJson() const {
...
QJsonObject OAIGetInlineScriptTags_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_inline_script_tags.size() > 0) {
        obj.insert(QString("inline_script_tags"), ::OpenAPI::toJsonValue(m_inline_script_tags));
    }
    return obj;
}

QList<OAIGetInlineScriptTags_200_response_inline_script_tags_inner> OAIGetInlineScriptTags_200_response::getInlineScriptTags() const {
    return m_inline_script_tags;
}
void OAIGetInlineScriptTags_200_response::setInlineScriptTags(const QList<OAIGetInlineScriptTags_200_response_inline_script_tags_inner> &inline_script_tags) {
    m_inline_script_tags = inline_script_tags;
    m_inline_script_tags_isSet = true;
}

bool OAIGetInlineScriptTags_200_response::is_inline_script_tags_Set() const{
    return m_inline_script_tags_isSet;
}

bool OAIGetInlineScriptTags_200_response::is_inline_script_tags_Valid() const{
    return m_inline_script_tags_isValid;
}

bool OAIGetInlineScriptTags_200_response::isSet() const {
...
bool OAIGetInlineScriptTags_200_response::isValid() const {
