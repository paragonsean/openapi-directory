...
#include "OAICreateUsageCharge_201_response.h"
...
OAICreateUsageCharge_201_response::OAICreateUsageCharge_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUsageCharge_201_response::OAICreateUsageCharge_201_response() {
    this->initializeModel();
}

OAICreateUsageCharge_201_response::~OAICreateUsageCharge_201_response() {}

void OAICreateUsageCharge_201_response::initializeModel() {

    m_usage_charge_isSet = false;
    m_usage_charge_isValid = false;
}

void OAICreateUsageCharge_201_response::fromJson(QString jsonString) {
...
void OAICreateUsageCharge_201_response::fromJsonObject(QJsonObject json) {
...
QString OAICreateUsageCharge_201_response::asJson() const {
...
QJsonObject OAICreateUsageCharge_201_response::asJsonObject() const {
    QJsonObject obj;
...
OAICreateUsageCharge_201_response_usage_charge OAICreateUsageCharge_201_response::getUsageCharge() const {
    return m_usage_charge;
}
void OAICreateUsageCharge_201_response::setUsageCharge(const OAICreateUsageCharge_201_response_usage_charge &usage_charge) {
    m_usage_charge = usage_charge;
    m_usage_charge_isSet = true;
}

bool OAICreateUsageCharge_201_response::is_usage_charge_Set() const{
    return m_usage_charge_isSet;
}

bool OAICreateUsageCharge_201_response::is_usage_charge_Valid() const{
    return m_usage_charge_isValid;
}

bool OAICreateUsageCharge_201_response::isSet() const {
...
bool OAICreateUsageCharge_201_response::isValid() const {
