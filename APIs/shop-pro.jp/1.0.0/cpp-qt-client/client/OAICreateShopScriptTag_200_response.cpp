...
OAICreateShopScriptTag_200_response::OAICreateShopScriptTag_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateShopScriptTag_200_response::OAICreateShopScriptTag_200_response() {
    this->initializeModel();
}

OAICreateShopScriptTag_200_response::~OAICreateShopScriptTag_200_response() {}

void OAICreateShopScriptTag_200_response::initializeModel() {

    m_script_tag_isSet = false;
    m_script_tag_isValid = false;
}

void OAICreateShopScriptTag_200_response::fromJson(QString jsonString) {
...
void OAICreateShopScriptTag_200_response::fromJsonObject(QJsonObject json) {
...
QString OAICreateShopScriptTag_200_response::asJson() const {
...
QJsonObject OAICreateShopScriptTag_200_response::asJsonObject() const {
    QJsonObject obj;
...
OAIGetShopScriptTags_200_response_script_tags_inner OAICreateShopScriptTag_200_response::getScriptTag() const {
    return m_script_tag;
}
void OAICreateShopScriptTag_200_response::setScriptTag(const OAIGetShopScriptTags_200_response_script_tags_inner &script_tag) {
    m_script_tag = script_tag;
    m_script_tag_isSet = true;
}

bool OAICreateShopScriptTag_200_response::is_script_tag_Set() const{
    return m_script_tag_isSet;
}

bool OAICreateShopScriptTag_200_response::is_script_tag_Valid() const{
    return m_script_tag_isValid;
}

bool OAICreateShopScriptTag_200_response::isSet() const {
...
bool OAICreateShopScriptTag_200_response::isValid() const {
