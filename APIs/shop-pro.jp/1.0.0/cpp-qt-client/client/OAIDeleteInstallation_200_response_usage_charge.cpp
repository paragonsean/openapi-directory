...
#include "OAIDeleteInstallation_200_response_usage_charge.h"
...
OAIDeleteInstallation_200_response_usage_charge::OAIDeleteInstallation_200_response_usage_charge(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteInstallation_200_response_usage_charge::OAIDeleteInstallation_200_response_usage_charge() {
    this->initializeModel();
}

OAIDeleteInstallation_200_response_usage_charge::~OAIDeleteInstallation_200_response_usage_charge() {}

void OAIDeleteInstallation_200_response_usage_charge::initializeModel() {

    m_api_token_isSet = false;
    m_api_token_isValid = false;

    m_closing_on_isSet = false;
    m_closing_on_isValid = false;
}

void OAIDeleteInstallation_200_response_usage_charge::fromJson(QString jsonString) {
...
void OAIDeleteInstallation_200_response_usage_charge::fromJsonObject(QJsonObject json) {
    ...
    m_closing_on_isValid = ::OpenAPI::fromJsonValue(m_closing_on, json[QString("closing_on")]);
    m_closing_on_isSet = !json[QString("closing_on")].isNull() && m_closing_on_isValid;
}

QString OAIDeleteInstallation_200_response_usage_charge::asJson() const {
...
QJsonObject OAIDeleteInstallation_200_response_usage_charge::asJsonObject() const {
    QJsonObject obj;
    if (m_api_token_isSet) {
        obj.insert(QString("api_token"), ::OpenAPI::toJsonValue(m_api_token));
    }
    if (m_closing_on_isSet) {
        obj.insert(QString("closing_on"), ::OpenAPI::toJsonValue(m_closing_on));
    }
    return obj;
}

QString OAIDeleteInstallation_200_response_usage_charge::getApiToken() const {
    return m_api_token;
}
void OAIDeleteInstallation_200_response_usage_charge::setApiToken(const QString &api_token) {
    m_api_token = api_token;
    m_api_token_isSet = true;
}

bool OAIDeleteInstallation_200_response_usage_charge::is_api_token_Set() const{
    return m_api_token_isSet;
}

bool OAIDeleteInstallation_200_response_usage_charge::is_api_token_Valid() const{
    return m_api_token_isValid;
}

qint32 OAIDeleteInstallation_200_response_usage_charge::getClosingOn() const {
    return m_closing_on;
}
void OAIDeleteInstallation_200_response_usage_charge::setClosingOn(const qint32 &closing_on) {
    m_closing_on = closing_on;
    m_closing_on_isSet = true;
}

bool OAIDeleteInstallation_200_response_usage_charge::is_closing_on_Set() const{
    return m_closing_on_isSet;
}

bool OAIDeleteInstallation_200_response_usage_charge::is_closing_on_Valid() const{
    return m_closing_on_isValid;
}

bool OAIDeleteInstallation_200_response_usage_charge::isSet() const {
...
bool OAIDeleteInstallation_200_response_usage_charge::isValid() const {
