...
OAIScriptTag::OAIScriptTag(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScriptTag::OAIScriptTag() {
    this->initializeModel();
}

OAIScriptTag::~OAIScriptTag() {}

void OAIScriptTag::initializeModel() {
...
void OAIScriptTag::fromJson(QString jsonString) {
...
void OAIScriptTag::fromJsonObject(QJsonObject json) {
...
QString OAIScriptTag::asJson() const {
...
QJsonObject OAIScriptTag::asJsonObject() const {
    QJsonObject obj;
...
QString OAIScriptTag::getDisplayScope() const {
    return m_display_scope;
}
void OAIScriptTag::setDisplayScope(const QString &display_scope) {
    m_display_scope = display_scope;
    m_display_scope_isSet = true;
}

bool OAIScriptTag::is_display_scope_Set() const{
    return m_display_scope_isSet;
}

bool OAIScriptTag::is_display_scope_Valid() const{
    return m_display_scope_isValid;
}

qint32 OAIScriptTag::getId() const {
    return m_id;
}
void OAIScriptTag::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIScriptTag::is_id_Set() const{
    return m_id_isSet;
}

bool OAIScriptTag::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAIScriptTag::getMakeDate() const {
    return m_make_date;
}
void OAIScriptTag::setMakeDate(const qint32 &make_date) {
    m_make_date = make_date;
    m_make_date_isSet = true;
}

bool OAIScriptTag::is_make_date_Set() const{
    return m_make_date_isSet;
}

bool OAIScriptTag::is_make_date_Valid() const{
    return m_make_date_isValid;
}

QString OAIScriptTag::getSrc() const {
    return m_src;
}
void OAIScriptTag::setSrc(const QString &src) {
    m_src = src;
    m_src_isSet = true;
}

bool OAIScriptTag::is_src_Set() const{
    return m_src_isSet;
}

bool OAIScriptTag::is_src_Valid() const{
    return m_src_isValid;
}

qint32 OAIScriptTag::getUpdateDate() const {
    return m_update_date;
}
void OAIScriptTag::setUpdateDate(const qint32 &update_date) {
    m_update_date = update_date;
    m_update_date_isSet = true;
}

bool OAIScriptTag::is_update_date_Set() const{
    return m_update_date_isSet;
}

bool OAIScriptTag::is_update_date_Valid() const{
    return m_update_date_isValid;
}

bool OAIScriptTag::isSet() const {
...
bool OAIScriptTag::isValid() const {
