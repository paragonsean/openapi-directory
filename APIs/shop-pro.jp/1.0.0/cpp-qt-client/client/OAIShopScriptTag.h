...
#ifndef OAIShopScriptTag_H
#define OAIShopScriptTag_H
...
class OAIShopScriptTag : public OAIObject {
public:
    OAIShopScriptTag();
    OAIShopScriptTag(QString json);
    ~OAIShopScriptTag() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShopScriptTag)

#endif // OAIShopScriptTag_H
