...
#include "OAICreateScriptTag_request_script_tag.h"
...
OAICreateScriptTag_request_script_tag::OAICreateScriptTag_request_script_tag(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateScriptTag_request_script_tag::OAICreateScriptTag_request_script_tag() {
    this->initializeModel();
}

OAICreateScriptTag_request_script_tag::~OAICreateScriptTag_request_script_tag() {}

void OAICreateScriptTag_request_script_tag::initializeModel() {
...
void OAICreateScriptTag_request_script_tag::fromJson(QString jsonString) {
...
void OAICreateScriptTag_request_script_tag::fromJsonObject(QJsonObject json) {
...
QString OAICreateScriptTag_request_script_tag::asJson() const {
...
QJsonObject OAICreateScriptTag_request_script_tag::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateScriptTag_request_script_tag::getDisplayScope() const {
    return m_display_scope;
}
void OAICreateScriptTag_request_script_tag::setDisplayScope(const QString &display_scope) {
    m_display_scope = display_scope;
    m_display_scope_isSet = true;
}

bool OAICreateScriptTag_request_script_tag::is_display_scope_Set() const{
    return m_display_scope_isSet;
}

bool OAICreateScriptTag_request_script_tag::is_display_scope_Valid() const{
    return m_display_scope_isValid;
}

QString OAICreateScriptTag_request_script_tag::getSrc() const {
    return m_src;
}
void OAICreateScriptTag_request_script_tag::setSrc(const QString &src) {
    m_src = src;
    m_src_isSet = true;
}

bool OAICreateScriptTag_request_script_tag::is_src_Set() const{
    return m_src_isSet;
}

bool OAICreateScriptTag_request_script_tag::is_src_Valid() const{
    return m_src_isValid;
}

bool OAICreateScriptTag_request_script_tag::isSet() const {
...
bool OAICreateScriptTag_request_script_tag::isValid() const {
