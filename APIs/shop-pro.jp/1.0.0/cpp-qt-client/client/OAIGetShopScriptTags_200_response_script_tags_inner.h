...
/*
 * OAIGetShopScriptTags_200_response_script_tags_inner.h
 *
 * 
 */

#ifndef OAIGetShopScriptTags_200_response_script_tags_inner_H
#define OAIGetShopScriptTags_200_response_script_tags_inner_H
...
class OAIGetShopScriptTags_200_response_script_tags_inner : public OAIObject {
public:
    OAIGetShopScriptTags_200_response_script_tags_inner();
    OAIGetShopScriptTags_200_response_script_tags_inner(QString json);
    ~OAIGetShopScriptTags_200_response_script_tags_inner() override;
    ...
    QString getDisplayScope() const;
    void setDisplayScope(const QString &display_scope);
    bool is_display_scope_Set() const;
    bool is_display_scope_Valid() const;
    ...
    QString getIntegrity() const;
    void setIntegrity(const QString &integrity);
    bool is_integrity_Set() const;
    bool is_integrity_Valid() const;

    qint32 getMakeDate() const;
    void setMakeDate(const qint32 &make_date);
    bool is_make_date_Set() const;
    bool is_make_date_Valid() const;

    qint32 getOauthApplicationId() const;
    void setOauthApplicationId(const qint32 &oauth_application_id);
    bool is_oauth_application_id_Set() const;
    bool is_oauth_application_id_Valid() const;
    ...
    qint32 getUpdateDate() const;
    void setUpdateDate(const qint32 &update_date);
...
private:
    ...
    QString m_display_scope;
    bool m_display_scope_isSet;
    bool m_display_scope_isValid;
    ...
    QString m_integrity;
    bool m_integrity_isSet;
    bool m_integrity_isValid;

    qint32 m_make_date;
    bool m_make_date_isSet;
    bool m_make_date_isValid;

    qint32 m_oauth_application_id;
    bool m_oauth_application_id_isSet;
    bool m_oauth_application_id_isValid;

    QString m_src;
    bool m_src_isSet;
    bool m_src_isValid;

    qint32 m_update_date;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetShopScriptTags_200_response_script_tags_inner)

#endif // OAIGetShopScriptTags_200_response_script_tags_inner_H
