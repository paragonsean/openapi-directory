...
#include "OAICreateShopScriptTag_request.h"
...
OAICreateShopScriptTag_request::OAICreateShopScriptTag_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateShopScriptTag_request::OAICreateShopScriptTag_request() {
    this->initializeModel();
}

OAICreateShopScriptTag_request::~OAICreateShopScriptTag_request() {}

void OAICreateShopScriptTag_request::initializeModel() {

    m_script_tag_isSet = false;
    m_script_tag_isValid = false;
}

void OAICreateShopScriptTag_request::fromJson(QString jsonString) {
...
void OAICreateShopScriptTag_request::fromJsonObject(QJsonObject json) {

    m_script_tag_isValid = ::OpenAPI::fromJsonValue(m_script_tag, json[QString("script_tag")]);
    m_script_tag_isSet = !json[QString("script_tag")].isNull() && m_script_tag_isValid;
}

QString OAICreateShopScriptTag_request::asJson() const {
...
QJsonObject OAICreateShopScriptTag_request::asJsonObject() const {
    QJsonObject obj;
    if (m_script_tag.isSet()) {
        obj.insert(QString("script_tag"), ::OpenAPI::toJsonValue(m_script_tag));
    }
    return obj;
}

OAICreateShopScriptTag_request_script_tag OAICreateShopScriptTag_request::getScriptTag() const {
    return m_script_tag;
}
void OAICreateShopScriptTag_request::setScriptTag(const OAICreateShopScriptTag_request_script_tag &script_tag) {
    m_script_tag = script_tag;
    m_script_tag_isSet = true;
}

bool OAICreateShopScriptTag_request::is_script_tag_Set() const{
    return m_script_tag_isSet;
}

bool OAICreateShopScriptTag_request::is_script_tag_Valid() const{
    return m_script_tag_isValid;
}

bool OAICreateShopScriptTag_request::isSet() const {
...
bool OAICreateShopScriptTag_request::isValid() const {
