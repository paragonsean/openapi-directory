...
#ifndef OAIUsageCharge_H
#define OAIUsageCharge_H
...
class OAIUsageCharge : public OAIObject {
public:
    OAIUsageCharge();
    OAIUsageCharge(QString json);
    ~OAIUsageCharge() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsageCharge)

#endif // OAIUsageCharge_H
