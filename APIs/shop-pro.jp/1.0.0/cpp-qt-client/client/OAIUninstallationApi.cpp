...
#include "OAIUninstallationApi.h"
...
OAIUninstallationApi::OAIUninstallationApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIUninstallationApi::~OAIUninstallationApi() {
}

void OAIUninstallationApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("deleteInstallation", defaultConf);
    _serverIndices.insert("deleteInstallation", 0);
}
...
*/
int OAIUninstallationApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIUninstallationApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIUninstallationApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIUninstallationApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIUninstallationApi::setUsername(const QString &username) {
    _username = username;
}

void OAIUninstallationApi::setPassword(const QString &password) {
    _password = password;
}


void OAIUninstallationApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIUninstallationApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIUninstallationApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIUninstallationApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIUninstallationApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIUninstallationApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIUninstallationApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIUninstallationApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIUninstallationApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIUninstallationApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIUninstallationApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIUninstallationApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIUninstallationApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIUninstallationApi::deleteInstallation() {
    QString fullPath = QString(_serverConfigs["deleteInstallation"][_serverIndices.value("deleteInstallation")].URL()+"/appstore/v1/installation.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUninstallationApi::deleteInstallationCallback);
    connect(this, &OAIUninstallationApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUninstallationApi::deleteInstallationCallback);
    connect(this, &OAIUninstallationApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIUninstallationApi::deleteInstallationCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIDeleteInstallation_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteInstallationSignal(output);
        Q_EMIT deleteInstallationSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteInstallationSignalE(output, error_type, error_str);
        Q_EMIT deleteInstallationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteInstallationSignalError(output, error_type, error_str);
        Q_EMIT deleteInstallationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUninstallationApi::tokenAvailable(){
