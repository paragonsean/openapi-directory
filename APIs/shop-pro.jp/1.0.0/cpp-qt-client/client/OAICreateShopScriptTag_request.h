...
/*
 * OAICreateShopScriptTag_request.h
 *
 * 
 */

#ifndef OAICreateShopScriptTag_request_H
#define OAICreateShopScriptTag_request_H
...
namespace OpenAPI {
class OAICreateShopScriptTag_request_script_tag;

class OAICreateShopScriptTag_request : public OAIObject {
public:
    OAICreateShopScriptTag_request();
    OAICreateShopScriptTag_request(QString json);
    ~OAICreateShopScriptTag_request() override;
    ...
    OAICreateShopScriptTag_request_script_tag getScriptTag() const;
    void setScriptTag(const OAICreateShopScriptTag_request_script_tag &script_tag);
...
private:
    ...
    OAICreateShopScriptTag_request_script_tag m_script_tag;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateShopScriptTag_request)

#endif // OAICreateShopScriptTag_request_H
