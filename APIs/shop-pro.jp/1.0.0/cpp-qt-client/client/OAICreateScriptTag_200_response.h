...
/*
 * OAICreateScriptTag_200_response.h
 *
 * 
 */

#ifndef OAICreateScriptTag_200_response_H
#define OAICreateScriptTag_200_response_H
...
class OAICreateScriptTag_200_response : public OAIObject {
public:
    OAICreateScriptTag_200_response();
    OAICreateScriptTag_200_response(QString json);
    ~OAICreateScriptTag_200_response() override;
    ...
    OAIGetScriptTags_200_response_script_tags_inner getScriptTag() const;
    void setScriptTag(const OAIGetScriptTags_200_response_script_tags_inner &script_tag);
    bool is_script_tag_Set() const;
    bool is_script_tag_Valid() const;
...
private:
    ...
    OAIGetScriptTags_200_response_script_tags_inner m_script_tag;
    bool m_script_tag_isSet;
    bool m_script_tag_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateScriptTag_200_response)

#endif // OAICreateScriptTag_200_response_H
