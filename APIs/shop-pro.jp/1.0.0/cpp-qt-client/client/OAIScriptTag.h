...
#ifndef OAIScriptTag_H
#define OAIScriptTag_H
...
class OAIScriptTag : public OAIObject {
public:
    OAIScriptTag();
    OAIScriptTag(QString json);
    ~OAIScriptTag() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScriptTag)

#endif // OAIScriptTag_H
