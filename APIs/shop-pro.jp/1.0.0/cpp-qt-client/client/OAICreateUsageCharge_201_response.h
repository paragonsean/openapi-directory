...
/*
 * OAICreateUsageCharge_201_response.h
 *
 * 
 */

#ifndef OAICreateUsageCharge_201_response_H
#define OAICreateUsageCharge_201_response_H
...
namespace OpenAPI {
class OAICreateUsageCharge_201_response_usage_charge;

class OAICreateUsageCharge_201_response : public OAIObject {
public:
    OAICreateUsageCharge_201_response();
    OAICreateUsageCharge_201_response(QString json);
    ~OAICreateUsageCharge_201_response() override;
    ...
    OAICreateUsageCharge_201_response_usage_charge getUsageCharge() const;
    void setUsageCharge(const OAICreateUsageCharge_201_response_usage_charge &usage_charge);
    bool is_usage_charge_Set() const;
    bool is_usage_charge_Valid() const;
...
private:
    ...
    OAICreateUsageCharge_201_response_usage_charge m_usage_charge;
    bool m_usage_charge_isSet;
    bool m_usage_charge_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateUsageCharge_201_response)

#endif // OAICreateUsageCharge_201_response_H
