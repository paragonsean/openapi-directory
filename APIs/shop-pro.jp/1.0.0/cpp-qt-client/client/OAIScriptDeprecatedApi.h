...
#ifndef OAI_OAIScriptDeprecatedApi_H
#define OAI_OAIScriptDeprecatedApi_H
...
#include "OAIGetScriptTags_200_response.h"
#include <QString>
...
class OAIScriptDeprecatedApi : public QObject {
    Q_OBJECT

public:
    OAIScriptDeprecatedApi(const int timeOut = 0);
    ~OAIScriptDeprecatedApi();
    ...
    /**
    * @param[in]  oai_create_script_tag_request OAICreateScriptTag_request [optional]
    */
    virtual void createScriptTag(const ::OpenAPI::OptionalParam<OAICreateScriptTag_request> &oai_create_script_tag_request = ::OpenAPI::OptionalParam<OAICreateScriptTag_request>());

    /**
    * @param[in]  script_tag_id qint32 [required]
    */
    virtual void getScriptTag(const qint32 &script_tag_id);


    virtual void getScriptTags();

    /**
    * @param[in]  script_tag_id qint32 [required]
    * @param[in]  oai_create_script_tag_request OAICreateScriptTag_request [optional]
    */
    virtual void updateScriptTag(const qint32 &script_tag_id, const ::OpenAPI::OptionalParam<OAICreateScriptTag_request> &oai_create_script_tag_request = ::OpenAPI::OptionalParam<OAICreateScriptTag_request>());

    /**
    * @param[in]  script_tag_id qint32 [required]
    */
    virtual void v1ScriptTagsScriptTagIdJsonDelete(const qint32 &script_tag_id);
...
private:
    ...
    void createScriptTagCallback(OAIHttpRequestWorker *worker);
    void getScriptTagCallback(OAIHttpRequestWorker *worker);
    void getScriptTagsCallback(OAIHttpRequestWorker *worker);
    void updateScriptTagCallback(OAIHttpRequestWorker *worker);
    void v1ScriptTagsScriptTagIdJsonDeleteCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void createScriptTagSignal(OAICreateScriptTag_200_response summary);
    void getScriptTagSignal(OAICreateScriptTag_200_response summary);
    void getScriptTagsSignal(OAIGetScriptTags_200_response summary);
    void updateScriptTagSignal(OAICreateScriptTag_200_response summary);
    void v1ScriptTagsScriptTagIdJsonDeleteSignal();


    void createScriptTagSignalFull(OAIHttpRequestWorker *worker, OAICreateScriptTag_200_response summary);
    void getScriptTagSignalFull(OAIHttpRequestWorker *worker, OAICreateScriptTag_200_response summary);
    void getScriptTagsSignalFull(OAIHttpRequestWorker *worker, OAIGetScriptTags_200_response summary);
    void updateScriptTagSignalFull(OAIHttpRequestWorker *worker, OAICreateScriptTag_200_response summary);
    void v1ScriptTagsScriptTagIdJsonDeleteSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use createScriptTagSignalError() instead")
    void createScriptTagSignalE(OAICreateScriptTag_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createScriptTagSignalError(OAICreateScriptTag_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getScriptTagSignalError() instead")
    void getScriptTagSignalE(OAICreateScriptTag_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getScriptTagSignalError(OAICreateScriptTag_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getScriptTagsSignalError() instead")
    void getScriptTagsSignalE(OAIGetScriptTags_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getScriptTagsSignalError(OAIGetScriptTags_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateScriptTagSignalError() instead")
    void updateScriptTagSignalE(OAICreateScriptTag_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateScriptTagSignalError(OAICreateScriptTag_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use v1ScriptTagsScriptTagIdJsonDeleteSignalError() instead")
    void v1ScriptTagsScriptTagIdJsonDeleteSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void v1ScriptTagsScriptTagIdJsonDeleteSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use createScriptTagSignalErrorFull() instead")
    void createScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void createScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getScriptTagSignalErrorFull() instead")
    void getScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getScriptTagsSignalErrorFull() instead")
    void getScriptTagsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getScriptTagsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateScriptTagSignalErrorFull() instead")
    void updateScriptTagSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void updateScriptTagSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use v1ScriptTagsScriptTagIdJsonDeleteSignalErrorFull() instead")
    void v1ScriptTagsScriptTagIdJsonDeleteSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void v1ScriptTagsScriptTagIdJsonDeleteSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
