...
OAIScriptApi::OAIScriptApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIScriptApi::~OAIScriptApi() {
}

void OAIScriptApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("createShopScriptTag", defaultConf);
    _serverIndices.insert("createShopScriptTag", 0);
    _serverConfigs.insert("deleteScriptTag", defaultConf);
    _serverIndices.insert("deleteScriptTag", 0);
    _serverConfigs.insert("getShopScriptTag", defaultConf);
    _serverIndices.insert("getShopScriptTag", 0);
    _serverConfigs.insert("getShopScriptTags", defaultConf);
    _serverIndices.insert("getShopScriptTags", 0);
    _serverConfigs.insert("updateShopScriptTag", defaultConf);
    _serverIndices.insert("updateShopScriptTag", 0);
}
...
*/
int OAIScriptApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIScriptApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIScriptApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIScriptApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIScriptApi::setUsername(const QString &username) {
    _username = username;
}

void OAIScriptApi::setPassword(const QString &password) {
    _password = password;
}


void OAIScriptApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIScriptApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIScriptApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIScriptApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIScriptApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIScriptApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIScriptApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIScriptApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIScriptApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIScriptApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIScriptApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIScriptApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIScriptApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIScriptApi::createShopScriptTag(const ::OpenAPI::OptionalParam<OAICreateShopScriptTag_request> &oai_create_shop_script_tag_request) {
    QString fullPath = QString(_serverConfigs["createShopScriptTag"][_serverIndices.value("createShopScriptTag")].URL()+"/appstore/v1/script_tags.json");
    ...
    if (oai_create_shop_script_tag_request.hasValue()){

        
        QByteArray output = oai_create_shop_script_tag_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScriptApi::createShopScriptTagCallback);
    connect(this, &OAIScriptApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("write_shop_script_tags");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScriptApi::createShopScriptTagCallback);
    connect(this, &OAIScriptApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIScriptApi::createShopScriptTagCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICreateShopScriptTag_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createShopScriptTagSignal(output);
        Q_EMIT createShopScriptTagSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createShopScriptTagSignalE(output, error_type, error_str);
        Q_EMIT createShopScriptTagSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createShopScriptTagSignalError(output, error_type, error_str);
        Q_EMIT createShopScriptTagSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScriptApi::deleteScriptTag(const qint32 &script_tag_id) {
    QString fullPath = QString(_serverConfigs["deleteScriptTag"][_serverIndices.value("deleteScriptTag")].URL()+"/appstore/v1/script_tags/{scriptTagId}.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScriptApi::deleteScriptTagCallback);
    connect(this, &OAIScriptApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScriptApi::deleteScriptTagCallback);
    connect(this, &OAIScriptApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIScriptApi::deleteScriptTagCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteScriptTagSignal();
        Q_EMIT deleteScriptTagSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("write_shop_script_tags");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteScriptTagSignalE(error_type, error_str);
        Q_EMIT deleteScriptTagSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteScriptTagSignalError(error_type, error_str);
        Q_EMIT deleteScriptTagSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScriptApi::getShopScriptTag(const qint32 &script_tag_id) {
    QString fullPath = QString(_serverConfigs["getShopScriptTag"][_serverIndices.value("getShopScriptTag")].URL()+"/appstore/v1/script_tags/{scriptTagId}.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScriptApi::getShopScriptTagCallback);
    connect(this, &OAIScriptApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("read_shop_script_tags");
    auto token = _authFlow.getToken(scope.join(" "));
    if(token.isValid())
        input.headers.insert("Authorization", "Bearer " + token.getToken());
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScriptApi::getShopScriptTagCallback);
    connect(this, &OAIScriptApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIScriptApi::getShopScriptTagCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getShopScriptTagSignal(output);
        Q_EMIT getShopScriptTagSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("read_shop_script_tags");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getShopScriptTagSignalE(output, error_type, error_str);
        Q_EMIT getShopScriptTagSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getShopScriptTagSignalError(output, error_type, error_str);
        Q_EMIT getShopScriptTagSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScriptApi::getShopScriptTags() {
    QString fullPath = QString(_serverConfigs["getShopScriptTags"][_serverIndices.value("getShopScriptTags")].URL()+"/appstore/v1/script_tags.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScriptApi::getShopScriptTagsCallback);
    connect(this, &OAIScriptApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScriptApi::getShopScriptTagsCallback);
    connect(this, &OAIScriptApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIScriptApi::getShopScriptTagsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetShopScriptTags_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getShopScriptTagsSignal(output);
        Q_EMIT getShopScriptTagsSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("read_shop_script_tags");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getShopScriptTagsSignalE(output, error_type, error_str);
        Q_EMIT getShopScriptTagsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getShopScriptTagsSignalError(output, error_type, error_str);
        Q_EMIT getShopScriptTagsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScriptApi::updateShopScriptTag(const qint32 &script_tag_id, const ::OpenAPI::OptionalParam<OAICreateShopScriptTag_request> &oai_create_shop_script_tag_request) {
    QString fullPath = QString(_serverConfigs["updateShopScriptTag"][_serverIndices.value("updateShopScriptTag")].URL()+"/appstore/v1/script_tags/{scriptTagId}.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScriptApi::updateShopScriptTagCallback);
    connect(this, &OAIScriptApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScriptApi::updateShopScriptTagCallback);
    connect(this, &OAIScriptApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIScriptApi::updateShopScriptTagCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateShopScriptTagSignal(output);
        Q_EMIT updateShopScriptTagSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("write_shop_script_tags");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateShopScriptTagSignalE(output, error_type, error_str);
        Q_EMIT updateShopScriptTagSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateShopScriptTagSignalError(output, error_type, error_str);
        Q_EMIT updateShopScriptTagSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScriptApi::tokenAvailable(){
