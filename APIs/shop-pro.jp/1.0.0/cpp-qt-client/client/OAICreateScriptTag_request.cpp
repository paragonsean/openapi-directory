...
#include "OAICreateScriptTag_request.h"
...
OAICreateScriptTag_request::OAICreateScriptTag_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateScriptTag_request::OAICreateScriptTag_request() {
    this->initializeModel();
}

OAICreateScriptTag_request::~OAICreateScriptTag_request() {}

void OAICreateScriptTag_request::initializeModel() {

    m_script_tag_isSet = false;
    m_script_tag_isValid = false;
}

void OAICreateScriptTag_request::fromJson(QString jsonString) {
...
void OAICreateScriptTag_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateScriptTag_request::asJson() const {
...
QJsonObject OAICreateScriptTag_request::asJsonObject() const {
    QJsonObject obj;
...
OAICreateScriptTag_request_script_tag OAICreateScriptTag_request::getScriptTag() const {
    return m_script_tag;
}
void OAICreateScriptTag_request::setScriptTag(const OAICreateScriptTag_request_script_tag &script_tag) {
    m_script_tag = script_tag;
    m_script_tag_isSet = true;
}

bool OAICreateScriptTag_request::is_script_tag_Set() const{
    return m_script_tag_isSet;
}

bool OAICreateScriptTag_request::is_script_tag_Valid() const{
    return m_script_tag_isValid;
}

bool OAICreateScriptTag_request::isSet() const {
...
bool OAICreateScriptTag_request::isValid() const {
