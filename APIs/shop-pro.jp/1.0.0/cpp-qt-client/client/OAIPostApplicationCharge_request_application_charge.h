...
/*
 * OAIPostApplicationCharge_request_application_charge.h
 *
 * 
 */

#ifndef OAIPostApplicationCharge_request_application_charge_H
#define OAIPostApplicationCharge_request_application_charge_H
...
class OAIPostApplicationCharge_request_application_charge : public OAIObject {
public:
    OAIPostApplicationCharge_request_application_charge();
    OAIPostApplicationCharge_request_application_charge(QString json);
    ~OAIPostApplicationCharge_request_application_charge() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostApplicationCharge_request_application_charge)

#endif // OAIPostApplicationCharge_request_application_charge_H
