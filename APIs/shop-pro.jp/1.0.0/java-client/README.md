...
カラーミーショップアプリストア API
- API version: 1.0.0
  - Build date: 2024-10-12T12:30:55.197839-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*ApplicationChargeApi* | [**createUsageCharge**](docs/ApplicationChargeApi.md#createUsageCharge) | **POST** /appstore/v1/recurring_application_charges/{recurringApplicationChargeId}/usage_charges.json | 従量課金データの作成
*ApplicationChargeApi* | [**postApplicationCharge**](docs/ApplicationChargeApi.md#postApplicationCharge) | **POST** /appstore/v1/application_charges.json | アプリ内課金データの作成
*InlineScriptApi* | [**createInlineScriptTag**](docs/InlineScriptApi.md#createInlineScriptTag) | **POST** /v1/inline_script_tags.json | インラインスクリプトタグの登録
*InlineScriptApi* | [**deleteInlineScriptTag**](docs/InlineScriptApi.md#deleteInlineScriptTag) | **DELETE** /v1/inline_script_tags/{inlineScriptTagId}.json | インラインスクリプトタグの削除
*InlineScriptApi* | [**getInlineScriptTag**](docs/InlineScriptApi.md#getInlineScriptTag) | **GET** /v1/inline_script_tags/{inlineScriptTagId}.json | インラインスクリプトタグの取得
*InlineScriptApi* | [**getInlineScriptTags**](docs/InlineScriptApi.md#getInlineScriptTags) | **GET** /v1/inline_script_tags.json | インラインスクリプトタグの取得
*InlineScriptApi* | [**updateInlineScriptTag**](docs/InlineScriptApi.md#updateInlineScriptTag) | **PUT** /v1/inline_script_tags/{inlineScriptTagId}.json | インラインスクリプトタグの更新
*ScriptApi* | [**createShopScriptTag**](docs/ScriptApi.md#createShopScriptTag) | **POST** /appstore/v1/script_tags.json | スクリプトタグの作成
*ScriptApi* | [**deleteScriptTag**](docs/ScriptApi.md#deleteScriptTag) | **DELETE** /appstore/v1/script_tags/{scriptTagId}.json | スクリプトタグの削除
*ScriptApi* | [**getShopScriptTag**](docs/ScriptApi.md#getShopScriptTag) | **GET** /appstore/v1/script_tags/{scriptTagId}.json | スクリプトタグの取得
*ScriptApi* | [**getShopScriptTags**](docs/ScriptApi.md#getShopScriptTags) | **GET** /appstore/v1/script_tags.json | スクリプトタグの取得
*ScriptApi* | [**updateShopScriptTag**](docs/ScriptApi.md#updateShopScriptTag) | **PUT** /appstore/v1/script_tags/{scriptTagId}.json | スクリプトタグの更新
*ScriptDeprecatedApi* | [**createScriptTag**](docs/ScriptDeprecatedApi.md#createScriptTag) | **POST** /v1/script_tags.json | スクリプトタグの作成
*ScriptDeprecatedApi* | [**getScriptTag**](docs/ScriptDeprecatedApi.md#getScriptTag) | **GET** /v1/script_tags/{scriptTagId}.json | スクリプトタグの取得
*ScriptDeprecatedApi* | [**getScriptTags**](docs/ScriptDeprecatedApi.md#getScriptTags) | **GET** /v1/script_tags.json | スクリプトタグの取得
*ScriptDeprecatedApi* | [**updateScriptTag**](docs/ScriptDeprecatedApi.md#updateScriptTag) | **PUT** /v1/script_tags/{scriptTagId}.json | スクリプトタグの更新
*ScriptDeprecatedApi* | [**v1ScriptTagsScriptTagIdJsonDelete**](docs/ScriptDeprecatedApi.md#v1ScriptTagsScriptTagIdJsonDelete) | **DELETE** /v1/script_tags/{scriptTagId}.json | スクリプトタグの削除
*UninstallationApi* | [**deleteInstallation**](docs/UninstallationApi.md#deleteInstallation) | **DELETE** /appstore/v1/installation.json | アプリストアアプリのアンインストール


## Documentation for Models

 - [ApplicationCharge](docs/ApplicationCharge.md)
 - [CartScriptTag](docs/CartScriptTag.md)
 - [CreateInlineScriptTag201Response](docs/CreateInlineScriptTag201Response.md)
 - [CreateInlineScriptTagRequest](docs/CreateInlineScriptTagRequest.md)
 - [CreateInlineScriptTagRequestInlineScriptTag](docs/CreateInlineScriptTagRequestInlineScriptTag.md)
 - [CreateScriptTag200Response](docs/CreateScriptTag200Response.md)
 - [CreateScriptTagRequest](docs/CreateScriptTagRequest.md)
 - [CreateScriptTagRequestScriptTag](docs/CreateScriptTagRequestScriptTag.md)
 - [CreateShopScriptTag200Response](docs/CreateShopScriptTag200Response.md)
 - [CreateShopScriptTagRequest](docs/CreateShopScriptTagRequest.md)
 - [CreateShopScriptTagRequestScriptTag](docs/CreateShopScriptTagRequestScriptTag.md)
 - [CreateUsageCharge201Response](docs/CreateUsageCharge201Response.md)
 - [CreateUsageCharge201ResponseUsageCharge](docs/CreateUsageCharge201ResponseUsageCharge.md)
 - [CreateUsageChargeRequest](docs/CreateUsageChargeRequest.md)
 - [CreateUsageChargeRequestUsageCharge](docs/CreateUsageChargeRequestUsageCharge.md)
 - [DeleteInstallation200Response](docs/DeleteInstallation200Response.md)
 - [DeleteInstallation200ResponseUsageCharge](docs/DeleteInstallation200ResponseUsageCharge.md)
 - [GetInlineScriptTags200Response](docs/GetInlineScriptTags200Response.md)
 - [GetInlineScriptTags200ResponseInlineScriptTagsInner](docs/GetInlineScriptTags200ResponseInlineScriptTagsInner.md)
 - [GetScriptTags200Response](docs/GetScriptTags200Response.md)
 - [GetScriptTags200ResponseScriptTagsInner](docs/GetScriptTags200ResponseScriptTagsInner.md)
 - [GetShopScriptTags200Response](docs/GetShopScriptTags200Response.md)
 - [GetShopScriptTags200ResponseScriptTagsInner](docs/GetShopScriptTags200ResponseScriptTagsInner.md)
 - [InlineScriptTag](docs/InlineScriptTag.md)
 - [PostApplicationCharge201Response](docs/PostApplicationCharge201Response.md)
 - [PostApplicationCharge201ResponseApplicationCharge](docs/PostApplicationCharge201ResponseApplicationCharge.md)
 - [PostApplicationChargeRequest](docs/PostApplicationChargeRequest.md)
 - [PostApplicationChargeRequestApplicationCharge](docs/PostApplicationChargeRequestApplicationCharge.md)
 - [ScriptTag](docs/ScriptTag.md)
 - [ShopScriptTag](docs/ShopScriptTag.md)
 - [UsageCharge](docs/UsageCharge.md)
