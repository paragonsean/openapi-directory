...
public class CreateShopScriptTagRequestScriptTag {
  /**
  ...
  public CreateShopScriptTagRequestScriptTag() {
  }

  public CreateShopScriptTagRequestScriptTag displayScope(DisplayScopeEnum displayScope) {
  ...
  public CreateShopScriptTagRequestScriptTag integrity(String integrity) {
  ...
  public CreateShopScriptTagRequestScriptTag src(String src) {
    this.src = src;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateShopScriptTagRequestScriptTag createShopScriptTagRequestScriptTag = (CreateShopScriptTagRequestScriptTag) o;
    return Objects.equals(this.displayScope, createShopScriptTagRequestScriptTag.displayScope) &&
        Objects.equals(this.integrity, createShopScriptTagRequestScriptTag.integrity) &&
        Objects.equals(this.src, createShopScriptTagRequestScriptTag.src);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayScope, integrity, src);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateShopScriptTagRequestScriptTag {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateShopScriptTagRequestScriptTag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateShopScriptTagRequestScriptTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateShopScriptTagRequestScriptTag is not found in the empty JSON string", CreateShopScriptTagRequestScriptTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateShopScriptTagRequestScriptTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateShopScriptTagRequestScriptTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateShopScriptTagRequestScriptTag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateShopScriptTagRequestScriptTag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateShopScriptTagRequestScriptTag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateShopScriptTagRequestScriptTag.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateShopScriptTagRequestScriptTag>() {
           @Override
           public void write(JsonWriter out, CreateShopScriptTagRequestScriptTag value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateShopScriptTagRequestScriptTag read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateShopScriptTagRequestScriptTag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateShopScriptTagRequestScriptTag
   * @throws IOException if the JSON string is invalid with respect to CreateShopScriptTagRequestScriptTag
   */
  public static CreateShopScriptTagRequestScriptTag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateShopScriptTagRequestScriptTag.class);
  }

  /**
   * Convert an instance of CreateShopScriptTagRequestScriptTag to an JSON string
   *
   * @return JSON string
   */
