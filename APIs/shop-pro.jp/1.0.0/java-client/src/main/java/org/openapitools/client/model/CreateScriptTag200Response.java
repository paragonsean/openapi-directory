...
import org.openapitools.client.model.GetScriptTags200ResponseScriptTagsInner;
...
public class CreateScriptTag200Response {
  public static final String SERIALIZED_NAME_SCRIPT_TAG = "script_tag";
  @SerializedName(SERIALIZED_NAME_SCRIPT_TAG)
  private GetScriptTags200ResponseScriptTagsInner scriptTag;

  public CreateScriptTag200Response() {
  }

  public CreateScriptTag200Response scriptTag(GetScriptTags200ResponseScriptTagsInner scriptTag) {
  ...
  public GetScriptTags200ResponseScriptTagsInner getScriptTag() {
    return scriptTag;
  }

  public void setScriptTag(GetScriptTags200ResponseScriptTagsInner scriptTag) {
    this.scriptTag = scriptTag;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateScriptTag200Response createScriptTag200Response = (CreateScriptTag200Response) o;
    return Objects.equals(this.scriptTag, createScriptTag200Response.scriptTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scriptTag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateScriptTag200Response {\n");
    sb.append("    scriptTag: ").append(toIndentedString(scriptTag)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateScriptTag200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateScriptTag200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateScriptTag200Response is not found in the empty JSON string", CreateScriptTag200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateScriptTag200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateScriptTag200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `script_tag`
      if (jsonObj.get("script_tag") != null && !jsonObj.get("script_tag").isJsonNull()) {
        GetScriptTags200ResponseScriptTagsInner.validateJsonElement(jsonObj.get("script_tag"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateScriptTag200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateScriptTag200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateScriptTag200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateScriptTag200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateScriptTag200Response>() {
           @Override
           public void write(JsonWriter out, CreateScriptTag200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateScriptTag200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateScriptTag200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateScriptTag200Response
   * @throws IOException if the JSON string is invalid with respect to CreateScriptTag200Response
   */
  public static CreateScriptTag200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateScriptTag200Response.class);
  }

  /**
   * Convert an instance of CreateScriptTag200Response to an JSON string
   *
   * @return JSON string
   */
