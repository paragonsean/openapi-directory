...
public class GetInlineScriptTags200ResponseInlineScriptTagsInner {
  ...
  public GetInlineScriptTags200ResponseInlineScriptTagsInner() {
  }

  public GetInlineScriptTags200ResponseInlineScriptTagsInner accountId(String accountId) {
  ...
  public GetInlineScriptTags200ResponseInlineScriptTagsInner displayScope(DisplayScopeEnum displayScope) {
  ...
  public GetInlineScriptTags200ResponseInlineScriptTagsInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public GetInlineScriptTags200ResponseInlineScriptTagsInner makeDate(Integer makeDate) {
  ...
  public GetInlineScriptTags200ResponseInlineScriptTagsInner oauthApplicationId(Integer oauthApplicationId) {
  ...
  public GetInlineScriptTags200ResponseInlineScriptTagsInner script(String script) {
    this.script = script;
    return this;
  }
  ...
  public GetInlineScriptTags200ResponseInlineScriptTagsInner triggerEvent(TriggerEventEnum triggerEvent) {
  ...
  public GetInlineScriptTags200ResponseInlineScriptTagsInner updateDate(Integer updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    GetInlineScriptTags200ResponseInlineScriptTagsInner getInlineScriptTags200ResponseInlineScriptTagsInner = (GetInlineScriptTags200ResponseInlineScriptTagsInner) o;
    return Objects.equals(this.accountId, getInlineScriptTags200ResponseInlineScriptTagsInner.accountId) &&
        Objects.equals(this.displayScope, getInlineScriptTags200ResponseInlineScriptTagsInner.displayScope) &&
        Objects.equals(this.id, getInlineScriptTags200ResponseInlineScriptTagsInner.id) &&
        Objects.equals(this.makeDate, getInlineScriptTags200ResponseInlineScriptTagsInner.makeDate) &&
        Objects.equals(this.oauthApplicationId, getInlineScriptTags200ResponseInlineScriptTagsInner.oauthApplicationId) &&
        Objects.equals(this.script, getInlineScriptTags200ResponseInlineScriptTagsInner.script) &&
        Objects.equals(this.triggerEvent, getInlineScriptTags200ResponseInlineScriptTagsInner.triggerEvent) &&
        Objects.equals(this.updateDate, getInlineScriptTags200ResponseInlineScriptTagsInner.updateDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetInlineScriptTags200ResponseInlineScriptTagsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetInlineScriptTags200ResponseInlineScriptTagsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetInlineScriptTags200ResponseInlineScriptTagsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetInlineScriptTags200ResponseInlineScriptTagsInner is not found in the empty JSON string", GetInlineScriptTags200ResponseInlineScriptTagsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetInlineScriptTags200ResponseInlineScriptTagsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetInlineScriptTags200ResponseInlineScriptTagsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetInlineScriptTags200ResponseInlineScriptTagsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetInlineScriptTags200ResponseInlineScriptTagsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetInlineScriptTags200ResponseInlineScriptTagsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetInlineScriptTags200ResponseInlineScriptTagsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetInlineScriptTags200ResponseInlineScriptTagsInner>() {
           @Override
           public void write(JsonWriter out, GetInlineScriptTags200ResponseInlineScriptTagsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetInlineScriptTags200ResponseInlineScriptTagsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetInlineScriptTags200ResponseInlineScriptTagsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetInlineScriptTags200ResponseInlineScriptTagsInner
   * @throws IOException if the JSON string is invalid with respect to GetInlineScriptTags200ResponseInlineScriptTagsInner
   */
  public static GetInlineScriptTags200ResponseInlineScriptTagsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetInlineScriptTags200ResponseInlineScriptTagsInner.class);
  }

  /**
   * Convert an instance of GetInlineScriptTags200ResponseInlineScriptTagsInner to an JSON string
   *
   * @return JSON string
   */
