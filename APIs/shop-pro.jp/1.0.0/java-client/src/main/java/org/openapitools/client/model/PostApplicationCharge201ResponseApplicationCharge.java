...
/**
 * PostApplicationCharge201ResponseApplicationCharge
 */
...
public class PostApplicationCharge201ResponseApplicationCharge {
  ...
  public PostApplicationCharge201ResponseApplicationCharge() {
  }

  public PostApplicationCharge201ResponseApplicationCharge id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PostApplicationCharge201ResponseApplicationCharge makeDate(Integer makeDate) {
  ...
  public PostApplicationCharge201ResponseApplicationCharge point(Integer point) {
    this.point = point;
    return this;
  }
  ...
  public PostApplicationCharge201ResponseApplicationCharge updateDate(Integer updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    PostApplicationCharge201ResponseApplicationCharge postApplicationCharge201ResponseApplicationCharge = (PostApplicationCharge201ResponseApplicationCharge) o;
    return Objects.equals(this.id, postApplicationCharge201ResponseApplicationCharge.id) &&
        Objects.equals(this.makeDate, postApplicationCharge201ResponseApplicationCharge.makeDate) &&
        Objects.equals(this.point, postApplicationCharge201ResponseApplicationCharge.point) &&
        Objects.equals(this.updateDate, postApplicationCharge201ResponseApplicationCharge.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, makeDate, point, updateDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostApplicationCharge201ResponseApplicationCharge {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostApplicationCharge201ResponseApplicationCharge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostApplicationCharge201ResponseApplicationCharge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostApplicationCharge201ResponseApplicationCharge is not found in the empty JSON string", PostApplicationCharge201ResponseApplicationCharge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostApplicationCharge201ResponseApplicationCharge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostApplicationCharge201ResponseApplicationCharge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostApplicationCharge201ResponseApplicationCharge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostApplicationCharge201ResponseApplicationCharge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostApplicationCharge201ResponseApplicationCharge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostApplicationCharge201ResponseApplicationCharge.class));

       return (TypeAdapter<T>) new TypeAdapter<PostApplicationCharge201ResponseApplicationCharge>() {
           @Override
           public void write(JsonWriter out, PostApplicationCharge201ResponseApplicationCharge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostApplicationCharge201ResponseApplicationCharge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostApplicationCharge201ResponseApplicationCharge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostApplicationCharge201ResponseApplicationCharge
   * @throws IOException if the JSON string is invalid with respect to PostApplicationCharge201ResponseApplicationCharge
   */
  public static PostApplicationCharge201ResponseApplicationCharge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostApplicationCharge201ResponseApplicationCharge.class);
  }

  /**
   * Convert an instance of PostApplicationCharge201ResponseApplicationCharge to an JSON string
   *
   * @return JSON string
   */
