...
public class CreateUsageCharge201ResponseUsageCharge {
  ...
  public CreateUsageCharge201ResponseUsageCharge() {
  }

  public CreateUsageCharge201ResponseUsageCharge description(String description) {
  ...
  public CreateUsageCharge201ResponseUsageCharge id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreateUsageCharge201ResponseUsageCharge makeDate(Integer makeDate) {
  ...
  public CreateUsageCharge201ResponseUsageCharge point(Integer point) {
    this.point = point;
    return this;
  }
  ...
  public CreateUsageCharge201ResponseUsageCharge updateDate(Integer updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUsageCharge201ResponseUsageCharge createUsageCharge201ResponseUsageCharge = (CreateUsageCharge201ResponseUsageCharge) o;
    return Objects.equals(this.description, createUsageCharge201ResponseUsageCharge.description) &&
        Objects.equals(this.id, createUsageCharge201ResponseUsageCharge.id) &&
        Objects.equals(this.makeDate, createUsageCharge201ResponseUsageCharge.makeDate) &&
        Objects.equals(this.point, createUsageCharge201ResponseUsageCharge.point) &&
        Objects.equals(this.updateDate, createUsageCharge201ResponseUsageCharge.updateDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUsageCharge201ResponseUsageCharge {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUsageCharge201ResponseUsageCharge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUsageCharge201ResponseUsageCharge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUsageCharge201ResponseUsageCharge is not found in the empty JSON string", CreateUsageCharge201ResponseUsageCharge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUsageCharge201ResponseUsageCharge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUsageCharge201ResponseUsageCharge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUsageCharge201ResponseUsageCharge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUsageCharge201ResponseUsageCharge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUsageCharge201ResponseUsageCharge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUsageCharge201ResponseUsageCharge.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUsageCharge201ResponseUsageCharge>() {
           @Override
           public void write(JsonWriter out, CreateUsageCharge201ResponseUsageCharge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUsageCharge201ResponseUsageCharge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUsageCharge201ResponseUsageCharge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUsageCharge201ResponseUsageCharge
   * @throws IOException if the JSON string is invalid with respect to CreateUsageCharge201ResponseUsageCharge
   */
  public static CreateUsageCharge201ResponseUsageCharge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUsageCharge201ResponseUsageCharge.class);
  }

  /**
   * Convert an instance of CreateUsageCharge201ResponseUsageCharge to an JSON string
   *
   * @return JSON string
   */
