...
/**
 * CreateUsageChargeRequestUsageCharge
 */
...
public class CreateUsageChargeRequestUsageCharge {
  ...
  public CreateUsageChargeRequestUsageCharge() {
  }

  public CreateUsageChargeRequestUsageCharge description(String description) {
  ...
  public CreateUsageChargeRequestUsageCharge point(Integer point) {
    this.point = point;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateUsageChargeRequestUsageCharge createUsageChargeRequestUsageCharge = (CreateUsageChargeRequestUsageCharge) o;
    return Objects.equals(this.description, createUsageChargeRequestUsageCharge.description) &&
        Objects.equals(this.point, createUsageChargeRequestUsageCharge.point);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, point);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateUsageChargeRequestUsageCharge {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUsageChargeRequestUsageCharge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUsageChargeRequestUsageCharge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUsageChargeRequestUsageCharge is not found in the empty JSON string", CreateUsageChargeRequestUsageCharge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUsageChargeRequestUsageCharge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUsageChargeRequestUsageCharge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateUsageChargeRequestUsageCharge.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUsageChargeRequestUsageCharge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUsageChargeRequestUsageCharge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUsageChargeRequestUsageCharge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUsageChargeRequestUsageCharge.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUsageChargeRequestUsageCharge>() {
           @Override
           public void write(JsonWriter out, CreateUsageChargeRequestUsageCharge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUsageChargeRequestUsageCharge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUsageChargeRequestUsageCharge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUsageChargeRequestUsageCharge
   * @throws IOException if the JSON string is invalid with respect to CreateUsageChargeRequestUsageCharge
   */
  public static CreateUsageChargeRequestUsageCharge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUsageChargeRequestUsageCharge.class);
  }

  /**
   * Convert an instance of CreateUsageChargeRequestUsageCharge to an JSON string
   *
   * @return JSON string
   */
