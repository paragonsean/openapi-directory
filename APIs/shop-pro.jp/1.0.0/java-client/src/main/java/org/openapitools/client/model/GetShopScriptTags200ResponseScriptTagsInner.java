...
public class GetShopScriptTags200ResponseScriptTagsInner {
  ...
  public GetShopScriptTags200ResponseScriptTagsInner() {
  }

  public GetShopScriptTags200ResponseScriptTagsInner accountId(String accountId) {
  ...
  public GetShopScriptTags200ResponseScriptTagsInner displayScope(DisplayScopeEnum displayScope) {
  ...
  public GetShopScriptTags200ResponseScriptTagsInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public GetShopScriptTags200ResponseScriptTagsInner integrity(String integrity) {
  ...
  public GetShopScriptTags200ResponseScriptTagsInner makeDate(Integer makeDate) {
  ...
  public GetShopScriptTags200ResponseScriptTagsInner oauthApplicationId(Integer oauthApplicationId) {
  ...
  public GetShopScriptTags200ResponseScriptTagsInner src(String src) {
    this.src = src;
    return this;
  }
  ...
  public GetShopScriptTags200ResponseScriptTagsInner updateDate(Integer updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    GetShopScriptTags200ResponseScriptTagsInner getShopScriptTags200ResponseScriptTagsInner = (GetShopScriptTags200ResponseScriptTagsInner) o;
    return Objects.equals(this.accountId, getShopScriptTags200ResponseScriptTagsInner.accountId) &&
        Objects.equals(this.displayScope, getShopScriptTags200ResponseScriptTagsInner.displayScope) &&
        Objects.equals(this.id, getShopScriptTags200ResponseScriptTagsInner.id) &&
        Objects.equals(this.integrity, getShopScriptTags200ResponseScriptTagsInner.integrity) &&
        Objects.equals(this.makeDate, getShopScriptTags200ResponseScriptTagsInner.makeDate) &&
        Objects.equals(this.oauthApplicationId, getShopScriptTags200ResponseScriptTagsInner.oauthApplicationId) &&
        Objects.equals(this.src, getShopScriptTags200ResponseScriptTagsInner.src) &&
        Objects.equals(this.updateDate, getShopScriptTags200ResponseScriptTagsInner.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, displayScope, id, integrity, makeDate, oauthApplicationId, src, updateDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetShopScriptTags200ResponseScriptTagsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetShopScriptTags200ResponseScriptTagsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetShopScriptTags200ResponseScriptTagsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetShopScriptTags200ResponseScriptTagsInner is not found in the empty JSON string", GetShopScriptTags200ResponseScriptTagsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetShopScriptTags200ResponseScriptTagsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetShopScriptTags200ResponseScriptTagsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("integrity") != null && !jsonObj.get("integrity").isJsonNull()) && !jsonObj.get("integrity").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetShopScriptTags200ResponseScriptTagsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetShopScriptTags200ResponseScriptTagsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetShopScriptTags200ResponseScriptTagsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetShopScriptTags200ResponseScriptTagsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetShopScriptTags200ResponseScriptTagsInner>() {
           @Override
           public void write(JsonWriter out, GetShopScriptTags200ResponseScriptTagsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetShopScriptTags200ResponseScriptTagsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetShopScriptTags200ResponseScriptTagsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetShopScriptTags200ResponseScriptTagsInner
   * @throws IOException if the JSON string is invalid with respect to GetShopScriptTags200ResponseScriptTagsInner
   */
  public static GetShopScriptTags200ResponseScriptTagsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetShopScriptTags200ResponseScriptTagsInner.class);
  }

  /**
   * Convert an instance of GetShopScriptTags200ResponseScriptTagsInner to an JSON string
   *
   * @return JSON string
   */
