...
public class CreateScriptTagRequest {
  ...
  private CreateScriptTagRequestScriptTag scriptTag;

  public CreateScriptTagRequest() {
  }

  public CreateScriptTagRequest scriptTag(CreateScriptTagRequestScriptTag scriptTag) {
  ...
  public CreateScriptTagRequestScriptTag getScriptTag() {
    return scriptTag;
  }

  public void setScriptTag(CreateScriptTagRequestScriptTag scriptTag) {
    this.scriptTag = scriptTag;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateScriptTagRequest createScriptTagRequest = (CreateScriptTagRequest) o;
    return Objects.equals(this.scriptTag, createScriptTagRequest.scriptTag);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateScriptTagRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateScriptTagRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateScriptTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateScriptTagRequest is not found in the empty JSON string", CreateScriptTagRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateScriptTagRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateScriptTagRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `script_tag`
      if (jsonObj.get("script_tag") != null && !jsonObj.get("script_tag").isJsonNull()) {
        CreateScriptTagRequestScriptTag.validateJsonElement(jsonObj.get("script_tag"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateScriptTagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateScriptTagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateScriptTagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateScriptTagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateScriptTagRequest>() {
           @Override
           public void write(JsonWriter out, CreateScriptTagRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateScriptTagRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateScriptTagRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateScriptTagRequest
   * @throws IOException if the JSON string is invalid with respect to CreateScriptTagRequest
   */
  public static CreateScriptTagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateScriptTagRequest.class);
  }

  /**
   * Convert an instance of CreateScriptTagRequest to an JSON string
   *
   * @return JSON string
   */
