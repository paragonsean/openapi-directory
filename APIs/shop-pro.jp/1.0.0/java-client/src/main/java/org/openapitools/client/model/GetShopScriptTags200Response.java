...
import org.openapitools.client.model.GetShopScriptTags200ResponseScriptTagsInner;
...
public class GetShopScriptTags200Response {
  public static final String SERIALIZED_NAME_SCRIPT_TAGS = "script_tags";
  @SerializedName(SERIALIZED_NAME_SCRIPT_TAGS)
  private List<GetShopScriptTags200ResponseScriptTagsInner> scriptTags = new ArrayList<>();

  public GetShopScriptTags200Response() {
  }

  public GetShopScriptTags200Response scriptTags(List<GetShopScriptTags200ResponseScriptTagsInner> scriptTags) {
    this.scriptTags = scriptTags;
    return this;
  }

  public GetShopScriptTags200Response addScriptTagsItem(GetShopScriptTags200ResponseScriptTagsInner scriptTagsItem) {
    if (this.scriptTags == null) {
      this.scriptTags = new ArrayList<>();
    }
    this.scriptTags.add(scriptTagsItem);
    return this;
  }
  ...
  public List<GetShopScriptTags200ResponseScriptTagsInner> getScriptTags() {
    return scriptTags;
  }

  public void setScriptTags(List<GetShopScriptTags200ResponseScriptTagsInner> scriptTags) {
    this.scriptTags = scriptTags;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetShopScriptTags200Response getShopScriptTags200Response = (GetShopScriptTags200Response) o;
    return Objects.equals(this.scriptTags, getShopScriptTags200Response.scriptTags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scriptTags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetShopScriptTags200Response {\n");
    sb.append("    scriptTags: ").append(toIndentedString(scriptTags)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetShopScriptTags200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetShopScriptTags200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetShopScriptTags200Response is not found in the empty JSON string", GetShopScriptTags200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetShopScriptTags200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetShopScriptTags200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("script_tags") != null && !jsonObj.get("script_tags").isJsonNull()) {
        JsonArray jsonArrayscriptTags = jsonObj.getAsJsonArray("script_tags");
        if (jsonArrayscriptTags != null) {
          // ensure the json data is an array
          if (!jsonObj.get("script_tags").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `script_tags` to be an array in the JSON string but got `%s`", jsonObj.get("script_tags").toString()));
          }

          // validate the optional field `script_tags` (array)
          for (int i = 0; i < jsonArrayscriptTags.size(); i++) {
            GetShopScriptTags200ResponseScriptTagsInner.validateJsonElement(jsonArrayscriptTags.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetShopScriptTags200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetShopScriptTags200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetShopScriptTags200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetShopScriptTags200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetShopScriptTags200Response>() {
           @Override
           public void write(JsonWriter out, GetShopScriptTags200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetShopScriptTags200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetShopScriptTags200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetShopScriptTags200Response
   * @throws IOException if the JSON string is invalid with respect to GetShopScriptTags200Response
   */
  public static GetShopScriptTags200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetShopScriptTags200Response.class);
  }

  /**
   * Convert an instance of GetShopScriptTags200Response to an JSON string
   *
   * @return JSON string
   */
