...
public class CreateShopScriptTagRequest {
  ...
  private CreateShopScriptTagRequestScriptTag scriptTag;

  public CreateShopScriptTagRequest() {
  }

  public CreateShopScriptTagRequest scriptTag(CreateShopScriptTagRequestScriptTag scriptTag) {
  ...
  public CreateShopScriptTagRequestScriptTag getScriptTag() {
    return scriptTag;
  }

  public void setScriptTag(CreateShopScriptTagRequestScriptTag scriptTag) {
    this.scriptTag = scriptTag;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateShopScriptTagRequest createShopScriptTagRequest = (CreateShopScriptTagRequest) o;
    return Objects.equals(this.scriptTag, createShopScriptTagRequest.scriptTag);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateShopScriptTagRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateShopScriptTagRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateShopScriptTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateShopScriptTagRequest is not found in the empty JSON string", CreateShopScriptTagRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateShopScriptTagRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateShopScriptTagRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `script_tag`
      if (jsonObj.get("script_tag") != null && !jsonObj.get("script_tag").isJsonNull()) {
        CreateShopScriptTagRequestScriptTag.validateJsonElement(jsonObj.get("script_tag"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateShopScriptTagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateShopScriptTagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateShopScriptTagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateShopScriptTagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateShopScriptTagRequest>() {
           @Override
           public void write(JsonWriter out, CreateShopScriptTagRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateShopScriptTagRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateShopScriptTagRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateShopScriptTagRequest
   * @throws IOException if the JSON string is invalid with respect to CreateShopScriptTagRequest
   */
  public static CreateShopScriptTagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateShopScriptTagRequest.class);
  }

  /**
   * Convert an instance of CreateShopScriptTagRequest to an JSON string
   *
   * @return JSON string
   */
