...
import org.openapitools.client.model.CreateScriptTag200Response;
import org.openapitools.client.model.CreateScriptTagRequest;
import org.openapitools.client.model.GetScriptTags200Response;
...
public class ScriptDeprecatedApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ScriptDeprecatedApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ScriptDeprecatedApi(ApiClient apiClient) {
    ...
    /**
     * Build call for createScriptTag
     * @param createScriptTagRequest 作成するスクリプトタグの情報 (optional)
     ...
     */
    public okhttp3.Call createScriptTagCall(CreateScriptTagRequest createScriptTagRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createScriptTagRequest;

        // create path and map variables
        String localVarPath = "/v1/script_tags.json";
    ...
    private okhttp3.Call createScriptTagValidateBeforeCall(CreateScriptTagRequest createScriptTagRequest, final ApiCallback _callback) throws ApiException {
        return createScriptTagCall(createScriptTagRequest, _callback);
     ...
     * 
     * @param createScriptTagRequest 作成するスクリプトタグの情報 (optional)
     * @return CreateScriptTag200Response
     ...
     */
    public CreateScriptTag200Response createScriptTag(CreateScriptTagRequest createScriptTagRequest) throws ApiException {
        ApiResponse<CreateScriptTag200Response> localVarResp = createScriptTagWithHttpInfo(createScriptTagRequest);
     ...
     * 
     * @param createScriptTagRequest 作成するスクリプトタグの情報 (optional)
     * @return ApiResponse&lt;CreateScriptTag200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CreateScriptTag200Response> createScriptTagWithHttpInfo(CreateScriptTagRequest createScriptTagRequest) throws ApiException {
        okhttp3.Call localVarCall = createScriptTagValidateBeforeCall(createScriptTagRequest, null);
        Type localVarReturnType = new TypeToken<CreateScriptTag200Response>(){}.getType();
     ...
     */
    public okhttp3.Call createScriptTagAsync(CreateScriptTagRequest createScriptTagRequest, final ApiCallback<CreateScriptTag200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = createScriptTagValidateBeforeCall(createScriptTagRequest, _callback);
        Type localVarReturnType = new TypeToken<CreateScriptTag200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getScriptTag
     ...
     */
    public okhttp3.Call getScriptTagCall(Integer scriptTagId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v1/script_tags/{scriptTagId}.json"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getScriptTagValidateBeforeCall(Integer scriptTagId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'scriptTagId' is set
        if (scriptTagId == null) {
            throw new ApiException("Missing the required parameter 'scriptTagId' when calling getScriptTag(Async)");
        }

        return getScriptTagCall(scriptTagId, _callback);
     ...
     */
    public CreateScriptTag200Response getScriptTag(Integer scriptTagId) throws ApiException {
        ApiResponse<CreateScriptTag200Response> localVarResp = getScriptTagWithHttpInfo(scriptTagId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CreateScriptTag200Response> getScriptTagWithHttpInfo(Integer scriptTagId) throws ApiException {
        okhttp3.Call localVarCall = getScriptTagValidateBeforeCall(scriptTagId, null);
        Type localVarReturnType = new TypeToken<CreateScriptTag200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getScriptTagAsync(Integer scriptTagId, final ApiCallback<CreateScriptTag200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getScriptTagValidateBeforeCall(scriptTagId, _callback);
        Type localVarReturnType = new TypeToken<CreateScriptTag200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getScriptTags
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getScriptTagsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getScriptTagsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getScriptTagsCall(_callback);
     ...
     * スクリプトタグの取得
     * 
     * @return GetScriptTags200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public GetScriptTags200Response getScriptTags() throws ApiException {
        ApiResponse<GetScriptTags200Response> localVarResp = getScriptTagsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * スクリプトタグの取得
     * 
     * @return ApiResponse&lt;GetScriptTags200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetScriptTags200Response> getScriptTagsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getScriptTagsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GetScriptTags200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getScriptTagsAsync(final ApiCallback<GetScriptTags200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getScriptTagsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<GetScriptTags200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for updateScriptTag
     * @param scriptTagId スクリプトタグID (required)
     * @param createScriptTagRequest 作成するスクリプトタグの情報 (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call updateScriptTagCall(Integer scriptTagId, CreateScriptTagRequest createScriptTagRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateScriptTagValidateBeforeCall(Integer scriptTagId, CreateScriptTagRequest createScriptTagRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'scriptTagId' is set
        if (scriptTagId == null) {
            throw new ApiException("Missing the required parameter 'scriptTagId' when calling updateScriptTag(Async)");
        }

        return updateScriptTagCall(scriptTagId, createScriptTagRequest, _callback);
     ...
     */
    public CreateScriptTag200Response updateScriptTag(Integer scriptTagId, CreateScriptTagRequest createScriptTagRequest) throws ApiException {
        ApiResponse<CreateScriptTag200Response> localVarResp = updateScriptTagWithHttpInfo(scriptTagId, createScriptTagRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CreateScriptTag200Response> updateScriptTagWithHttpInfo(Integer scriptTagId, CreateScriptTagRequest createScriptTagRequest) throws ApiException {
        okhttp3.Call localVarCall = updateScriptTagValidateBeforeCall(scriptTagId, createScriptTagRequest, null);
        Type localVarReturnType = new TypeToken<CreateScriptTag200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateScriptTagAsync(Integer scriptTagId, CreateScriptTagRequest createScriptTagRequest, final ApiCallback<CreateScriptTag200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateScriptTagValidateBeforeCall(scriptTagId, createScriptTagRequest, _callback);
        Type localVarReturnType = new TypeToken<CreateScriptTag200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for v1ScriptTagsScriptTagIdJsonDelete
     * @param scriptTagId スクリプトタグID (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call v1ScriptTagsScriptTagIdJsonDeleteCall(Integer scriptTagId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call v1ScriptTagsScriptTagIdJsonDeleteValidateBeforeCall(Integer scriptTagId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'scriptTagId' is set
        if (scriptTagId == null) {
            throw new ApiException("Missing the required parameter 'scriptTagId' when calling v1ScriptTagsScriptTagIdJsonDelete(Async)");
        }

        return v1ScriptTagsScriptTagIdJsonDeleteCall(scriptTagId, _callback);
     ...
     */
    public void v1ScriptTagsScriptTagIdJsonDelete(Integer scriptTagId) throws ApiException {
        v1ScriptTagsScriptTagIdJsonDeleteWithHttpInfo(scriptTagId);
    }
     ...
     */
    public ApiResponse<Void> v1ScriptTagsScriptTagIdJsonDeleteWithHttpInfo(Integer scriptTagId) throws ApiException {
        okhttp3.Call localVarCall = v1ScriptTagsScriptTagIdJsonDeleteValidateBeforeCall(scriptTagId, null);
     ...
     */
    public okhttp3.Call v1ScriptTagsScriptTagIdJsonDeleteAsync(Integer scriptTagId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = v1ScriptTagsScriptTagIdJsonDeleteValidateBeforeCall(scriptTagId, _callback);
