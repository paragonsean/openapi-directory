...
import org.openapitools.client.model.DeleteInstallation200Response;
...
public class UninstallationApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public UninstallationApi() {
        this(Configuration.getDefaultApiClient());
    }

    public UninstallationApi(ApiClient apiClient) {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> アンインストール成功 </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteInstallationCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/appstore/v1/installation.json";
    ...
    private okhttp3.Call deleteInstallationValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return deleteInstallationCall(_callback);
     ...
     * @return DeleteInstallation200Response
     ...
     */
    public DeleteInstallation200Response deleteInstallation() throws ApiException {
        ApiResponse<DeleteInstallation200Response> localVarResp = deleteInstallationWithHttpInfo();
     ...
     * アプリストアアプリのアンインストール
     * このAPIは OAuth のアクセストークンに紐付くアプリケーションをショップから削除します。 このAPIを利用した場合、ショップオーナーがアンインストールした場合と異なり、アンインストールフックは実行されません。 代わりにアンインストールフックで通知される情報は、このAPIのレスポンスに含まれています。  アンインストール時の注意点については、[アプリのアンインストール](https://app.shop-pro.jp/open_api#section/API/アプリのインストール)を参照して下さい。 
     * @return ApiResponse&lt;DeleteInstallation200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<DeleteInstallation200Response> deleteInstallationWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = deleteInstallationValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<DeleteInstallation200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * アプリストアアプリのアンインストール (asynchronously)
     * このAPIは OAuth のアクセストークンに紐付くアプリケーションをショップから削除します。 このAPIを利用した場合、ショップオーナーがアンインストールした場合と異なり、アンインストールフックは実行されません。 代わりにアンインストールフックで通知される情報は、このAPIのレスポンスに含まれています。  アンインストール時の注意点については、[アプリのアンインストール](https://app.shop-pro.jp/open_api#section/API/アプリのインストール)を参照して下さい。 
     ...
     */
    public okhttp3.Call deleteInstallationAsync(final ApiCallback<DeleteInstallation200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteInstallationValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<DeleteInstallation200Response>(){}.getType();
