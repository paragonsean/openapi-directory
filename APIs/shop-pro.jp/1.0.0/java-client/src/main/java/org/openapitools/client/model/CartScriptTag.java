...
public class CartScriptTag {
  ...
  public CartScriptTag() {
  }

  public CartScriptTag accountId(String accountId) {
  ...
  public CartScriptTag id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public CartScriptTag integrity(String integrity) {
  ...
  public CartScriptTag makeDate(Integer makeDate) {
  ...
  public CartScriptTag oauthApplicationId(Integer oauthApplicationId) {
  ...
  public CartScriptTag src(String src) {
    this.src = src;
    return this;
  }
  ...
  public CartScriptTag updateDate(Integer updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    CartScriptTag cartScriptTag = (CartScriptTag) o;
    return Objects.equals(this.accountId, cartScriptTag.accountId) &&
        Objects.equals(this.id, cartScriptTag.id) &&
        Objects.equals(this.integrity, cartScriptTag.integrity) &&
        Objects.equals(this.makeDate, cartScriptTag.makeDate) &&
        Objects.equals(this.oauthApplicationId, cartScriptTag.oauthApplicationId) &&
        Objects.equals(this.src, cartScriptTag.src) &&
        Objects.equals(this.updateDate, cartScriptTag.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, id, integrity, makeDate, oauthApplicationId, src, updateDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CartScriptTag {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CartScriptTag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CartScriptTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CartScriptTag is not found in the empty JSON string", CartScriptTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CartScriptTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CartScriptTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CartScriptTag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CartScriptTag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CartScriptTag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CartScriptTag.class));

       return (TypeAdapter<T>) new TypeAdapter<CartScriptTag>() {
           @Override
           public void write(JsonWriter out, CartScriptTag value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CartScriptTag read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CartScriptTag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CartScriptTag
   * @throws IOException if the JSON string is invalid with respect to CartScriptTag
   */
  public static CartScriptTag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CartScriptTag.class);
  }

  /**
   * Convert an instance of CartScriptTag to an JSON string
   *
   * @return JSON string
   */
