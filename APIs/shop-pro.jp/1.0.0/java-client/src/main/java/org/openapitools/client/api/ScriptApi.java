...
public class ScriptApi {
    ...
    /**
     * Build call for createShopScriptTag
     * @param createShopScriptTagRequest 作成するスクリプトタグの情報 (optional)
     ...
     */
    public okhttp3.Call createShopScriptTagCall(CreateShopScriptTagRequest createShopScriptTagRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createShopScriptTagRequest;

        // create path and map variables
        String localVarPath = "/appstore/v1/script_tags.json";
    ...
    private okhttp3.Call createShopScriptTagValidateBeforeCall(CreateShopScriptTagRequest createShopScriptTagRequest, final ApiCallback _callback) throws ApiException {
        return createShopScriptTagCall(createShopScriptTagRequest, _callback);
     ...
     * 
     * @param createShopScriptTagRequest 作成するスクリプトタグの情報 (optional)
     * @return CreateShopScriptTag200Response
     ...
     */
    public CreateShopScriptTag200Response createShopScriptTag(CreateShopScriptTagRequest createShopScriptTagRequest) throws ApiException {
        ApiResponse<CreateShopScriptTag200Response> localVarResp = createShopScriptTagWithHttpInfo(createShopScriptTagRequest);
     ...
     * 
     * @param createShopScriptTagRequest 作成するスクリプトタグの情報 (optional)
     * @return ApiResponse&lt;CreateShopScriptTag200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CreateShopScriptTag200Response> createShopScriptTagWithHttpInfo(CreateShopScriptTagRequest createShopScriptTagRequest) throws ApiException {
        okhttp3.Call localVarCall = createShopScriptTagValidateBeforeCall(createShopScriptTagRequest, null);
        Type localVarReturnType = new TypeToken<CreateShopScriptTag200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * スクリプトタグの作成 (asynchronously)
     * 
     * @param createShopScriptTagRequest 作成するスクリプトタグの情報 (optional)
     ...
     */
    public okhttp3.Call createShopScriptTagAsync(CreateShopScriptTagRequest createShopScriptTagRequest, final ApiCallback<CreateShopScriptTag200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = createShopScriptTagValidateBeforeCall(createShopScriptTagRequest, _callback);
        Type localVarReturnType = new TypeToken<CreateShopScriptTag200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteScriptTag
     * @param scriptTagId スクリプトタグID (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call deleteScriptTagCall(Integer scriptTagId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/appstore/v1/script_tags/{scriptTagId}.json"
            .replace("{" + "scriptTagId" + "}", localVarApiClient.escapeString(scriptTagId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteScriptTagValidateBeforeCall(Integer scriptTagId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'scriptTagId' is set
        if (scriptTagId == null) {
            throw new ApiException("Missing the required parameter 'scriptTagId' when calling deleteScriptTag(Async)");
        }

        return deleteScriptTagCall(scriptTagId, _callback);
     ...
     */
    public void deleteScriptTag(Integer scriptTagId) throws ApiException {
        deleteScriptTagWithHttpInfo(scriptTagId);
    }
     ...
     */
    public ApiResponse<Void> deleteScriptTagWithHttpInfo(Integer scriptTagId) throws ApiException {
        okhttp3.Call localVarCall = deleteScriptTagValidateBeforeCall(scriptTagId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * スクリプトタグの削除 (asynchronously)
     * 
     * @param scriptTagId スクリプトタグID (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteScriptTagAsync(Integer scriptTagId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteScriptTagValidateBeforeCall(scriptTagId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getShopScriptTag
     * @param scriptTagId スクリプトタグID (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getShopScriptTagCall(Integer scriptTagId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getShopScriptTagValidateBeforeCall(Integer scriptTagId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'scriptTagId' is set
        if (scriptTagId == null) {
            throw new ApiException("Missing the required parameter 'scriptTagId' when calling getShopScriptTag(Async)");
        }

        return getShopScriptTagCall(scriptTagId, _callback);
     ...
     */
    public CreateShopScriptTag200Response getShopScriptTag(Integer scriptTagId) throws ApiException {
        ApiResponse<CreateShopScriptTag200Response> localVarResp = getShopScriptTagWithHttpInfo(scriptTagId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CreateShopScriptTag200Response> getShopScriptTagWithHttpInfo(Integer scriptTagId) throws ApiException {
        okhttp3.Call localVarCall = getShopScriptTagValidateBeforeCall(scriptTagId, null);
        Type localVarReturnType = new TypeToken<CreateShopScriptTag200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * スクリプトタグの取得 (asynchronously)
     * 
     * @param scriptTagId スクリプトタグID (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getShopScriptTagAsync(Integer scriptTagId, final ApiCallback<CreateShopScriptTag200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getShopScriptTagValidateBeforeCall(scriptTagId, _callback);
        Type localVarReturnType = new TypeToken<CreateShopScriptTag200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getShopScriptTags
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getShopScriptTagsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getShopScriptTagsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getShopScriptTagsCall(_callback);
     ...
     * スクリプトタグの取得
     * 
     * @return GetShopScriptTags200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public GetShopScriptTags200Response getShopScriptTags() throws ApiException {
        ApiResponse<GetShopScriptTags200Response> localVarResp = getShopScriptTagsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * スクリプトタグの取得
     * 
     * @return ApiResponse&lt;GetShopScriptTags200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetShopScriptTags200Response> getShopScriptTagsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getShopScriptTagsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GetShopScriptTags200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getShopScriptTagsAsync(final ApiCallback<GetShopScriptTags200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getShopScriptTagsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<GetShopScriptTags200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for updateShopScriptTag
     * @param scriptTagId スクリプトタグID (required)
     * @param createShopScriptTagRequest 作成するスクリプトタグの情報 (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call updateShopScriptTagCall(Integer scriptTagId, CreateShopScriptTagRequest createShopScriptTagRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateShopScriptTagValidateBeforeCall(Integer scriptTagId, CreateShopScriptTagRequest createShopScriptTagRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'scriptTagId' is set
        if (scriptTagId == null) {
            throw new ApiException("Missing the required parameter 'scriptTagId' when calling updateShopScriptTag(Async)");
        }

        return updateShopScriptTagCall(scriptTagId, createShopScriptTagRequest, _callback);
     ...
     */
    public CreateShopScriptTag200Response updateShopScriptTag(Integer scriptTagId, CreateShopScriptTagRequest createShopScriptTagRequest) throws ApiException {
        ApiResponse<CreateShopScriptTag200Response> localVarResp = updateShopScriptTagWithHttpInfo(scriptTagId, createShopScriptTagRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CreateShopScriptTag200Response> updateShopScriptTagWithHttpInfo(Integer scriptTagId, CreateShopScriptTagRequest createShopScriptTagRequest) throws ApiException {
        okhttp3.Call localVarCall = updateShopScriptTagValidateBeforeCall(scriptTagId, createShopScriptTagRequest, null);
        Type localVarReturnType = new TypeToken<CreateShopScriptTag200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * スクリプトタグの更新 (asynchronously)
     * 
     * @param scriptTagId スクリプトタグID (required)
     * @param createShopScriptTagRequest 作成するスクリプトタグの情報 (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateShopScriptTagAsync(Integer scriptTagId, CreateShopScriptTagRequest createShopScriptTagRequest, final ApiCallback<CreateShopScriptTag200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateShopScriptTagValidateBeforeCall(scriptTagId, createShopScriptTagRequest, _callback);
        Type localVarReturnType = new TypeToken<CreateShopScriptTag200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
