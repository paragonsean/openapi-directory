...
public class CreateUsageChargeRequest {
  ...
  private CreateUsageChargeRequestUsageCharge usageCharge;

  public CreateUsageChargeRequest() {
  }

  public CreateUsageChargeRequest usageCharge(CreateUsageChargeRequestUsageCharge usageCharge) {
  ...
  public CreateUsageChargeRequestUsageCharge getUsageCharge() {
    return usageCharge;
  }

  public void setUsageCharge(CreateUsageChargeRequestUsageCharge usageCharge) {
    this.usageCharge = usageCharge;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateUsageChargeRequest createUsageChargeRequest = (CreateUsageChargeRequest) o;
    return Objects.equals(this.usageCharge, createUsageChargeRequest.usageCharge);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateUsageChargeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUsageChargeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUsageChargeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUsageChargeRequest is not found in the empty JSON string", CreateUsageChargeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUsageChargeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUsageChargeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `usage_charge`
      if (jsonObj.get("usage_charge") != null && !jsonObj.get("usage_charge").isJsonNull()) {
        CreateUsageChargeRequestUsageCharge.validateJsonElement(jsonObj.get("usage_charge"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUsageChargeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUsageChargeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUsageChargeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUsageChargeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUsageChargeRequest>() {
           @Override
           public void write(JsonWriter out, CreateUsageChargeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUsageChargeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUsageChargeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUsageChargeRequest
   * @throws IOException if the JSON string is invalid with respect to CreateUsageChargeRequest
   */
  public static CreateUsageChargeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUsageChargeRequest.class);
  }

  /**
   * Convert an instance of CreateUsageChargeRequest to an JSON string
   *
   * @return JSON string
   */
