...
public class DeleteInstallation200Response {
  ...
  public static final String SERIALIZED_NAME_RECURRING_APPLICATION_CHARGE_ID = "recurring_application_charge_id";
  @SerializedName(SERIALIZED_NAME_RECURRING_APPLICATION_CHARGE_ID)
  private String recurringApplicationChargeId;

  public static final String SERIALIZED_NAME_UNINSTALLED_AT = "uninstalled_at";
  ...
  private DeleteInstallation200ResponseUsageCharge usageCharge;

  public DeleteInstallation200Response() {
  }

  public DeleteInstallation200Response accountId(String accountId) {
  ...
  public DeleteInstallation200Response applicationChargeSourceId(String applicationChargeSourceId) {
  ...
  public DeleteInstallation200Response recurringApplicationChargeId(String recurringApplicationChargeId) {
  ...
  /**
   * （買い切り以外の課金の場合）課金契約ID
   * @return recurringApplicationChargeId
   */
  @javax.annotation.Nullable
  public String getRecurringApplicationChargeId() {
    return recurringApplicationChargeId;
  }

  public void setRecurringApplicationChargeId(String recurringApplicationChargeId) {
    this.recurringApplicationChargeId = recurringApplicationChargeId;
  }


  public DeleteInstallation200Response uninstalledAt(Integer uninstalledAt) {
  ...
  public void setUninstalledAt(Integer uninstalledAt) {
    this.uninstalledAt = uninstalledAt;
  }


  public DeleteInstallation200Response usageCharge(DeleteInstallation200ResponseUsageCharge usageCharge) {
   ...
   */
  @javax.annotation.Nullable
  public DeleteInstallation200ResponseUsageCharge getUsageCharge() {
    return usageCharge;
  }

  public void setUsageCharge(DeleteInstallation200ResponseUsageCharge usageCharge) {
    this.usageCharge = usageCharge;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteInstallation200Response deleteInstallation200Response = (DeleteInstallation200Response) o;
    return Objects.equals(this.accountId, deleteInstallation200Response.accountId) &&
        Objects.equals(this.applicationChargeSourceId, deleteInstallation200Response.applicationChargeSourceId) &&
        Objects.equals(this.recurringApplicationChargeId, deleteInstallation200Response.recurringApplicationChargeId) &&
        Objects.equals(this.uninstalledAt, deleteInstallation200Response.uninstalledAt) &&
        Objects.equals(this.usageCharge, deleteInstallation200Response.usageCharge);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, applicationChargeSourceId, recurringApplicationChargeId, uninstalledAt, usageCharge);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteInstallation200Response {\n");
    sb.append("    accountId: ").append(toIndentedString(accountId)).append("\n");
    sb.append("    applicationChargeSourceId: ").append(toIndentedString(applicationChargeSourceId)).append("\n");
    sb.append("    recurringApplicationChargeId: ").append(toIndentedString(recurringApplicationChargeId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("recurring_application_charge_id");
    openapiFields.add("uninstalled_at");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteInstallation200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteInstallation200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteInstallation200Response is not found in the empty JSON string", DeleteInstallation200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteInstallation200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteInstallation200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("recurring_application_charge_id") != null && !jsonObj.get("recurring_application_charge_id").isJsonNull()) && !jsonObj.get("recurring_application_charge_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `recurring_application_charge_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("recurring_application_charge_id").toString()));
      }
      // validate the optional field `usage_charge`
      if (jsonObj.get("usage_charge") != null && !jsonObj.get("usage_charge").isJsonNull()) {
        DeleteInstallation200ResponseUsageCharge.validateJsonElement(jsonObj.get("usage_charge"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteInstallation200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteInstallation200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteInstallation200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteInstallation200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteInstallation200Response>() {
           @Override
           public void write(JsonWriter out, DeleteInstallation200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteInstallation200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteInstallation200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteInstallation200Response
   * @throws IOException if the JSON string is invalid with respect to DeleteInstallation200Response
   */
  public static DeleteInstallation200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteInstallation200Response.class);
  }

  /**
   * Convert an instance of DeleteInstallation200Response to an JSON string
   *
   * @return JSON string
   */
