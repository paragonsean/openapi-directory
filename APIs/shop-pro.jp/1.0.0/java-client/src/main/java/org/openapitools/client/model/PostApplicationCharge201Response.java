...
public class PostApplicationCharge201Response {
  ...
  private PostApplicationCharge201ResponseApplicationCharge applicationCharge;

  public PostApplicationCharge201Response() {
  }

  public PostApplicationCharge201Response applicationCharge(PostApplicationCharge201ResponseApplicationCharge applicationCharge) {
  ...
  public PostApplicationCharge201ResponseApplicationCharge getApplicationCharge() {
    return applicationCharge;
  }

  public void setApplicationCharge(PostApplicationCharge201ResponseApplicationCharge applicationCharge) {
    this.applicationCharge = applicationCharge;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostApplicationCharge201Response postApplicationCharge201Response = (PostApplicationCharge201Response) o;
    return Objects.equals(this.applicationCharge, postApplicationCharge201Response.applicationCharge);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostApplicationCharge201Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostApplicationCharge201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostApplicationCharge201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostApplicationCharge201Response is not found in the empty JSON string", PostApplicationCharge201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostApplicationCharge201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostApplicationCharge201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("application_charge") != null && !jsonObj.get("application_charge").isJsonNull()) {
        PostApplicationCharge201ResponseApplicationCharge.validateJsonElement(jsonObj.get("application_charge"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostApplicationCharge201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostApplicationCharge201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostApplicationCharge201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostApplicationCharge201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<PostApplicationCharge201Response>() {
           @Override
           public void write(JsonWriter out, PostApplicationCharge201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostApplicationCharge201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostApplicationCharge201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostApplicationCharge201Response
   * @throws IOException if the JSON string is invalid with respect to PostApplicationCharge201Response
   */
  public static PostApplicationCharge201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostApplicationCharge201Response.class);
  }

  /**
   * Convert an instance of PostApplicationCharge201Response to an JSON string
   *
   * @return JSON string
   */
