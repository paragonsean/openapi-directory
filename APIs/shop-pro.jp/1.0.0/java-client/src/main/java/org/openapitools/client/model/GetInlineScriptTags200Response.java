...
public class GetInlineScriptTags200Response {
  public static final String SERIALIZED_NAME_INLINE_SCRIPT_TAGS = "inline_script_tags";
  @SerializedName(SERIALIZED_NAME_INLINE_SCRIPT_TAGS)
  private List<GetInlineScriptTags200ResponseInlineScriptTagsInner> inlineScriptTags = new ArrayList<>();

  public GetInlineScriptTags200Response() {
  }

  public GetInlineScriptTags200Response inlineScriptTags(List<GetInlineScriptTags200ResponseInlineScriptTagsInner> inlineScriptTags) {
    this.inlineScriptTags = inlineScriptTags;
    return this;
  }

  public GetInlineScriptTags200Response addInlineScriptTagsItem(GetInlineScriptTags200ResponseInlineScriptTagsInner inlineScriptTagsItem) {
    if (this.inlineScriptTags == null) {
      this.inlineScriptTags = new ArrayList<>();
    }
    this.inlineScriptTags.add(inlineScriptTagsItem);
    return this;
  }

  /**
   * Get inlineScriptTags
   * @return inlineScriptTags
   */
  @javax.annotation.Nullable
  public List<GetInlineScriptTags200ResponseInlineScriptTagsInner> getInlineScriptTags() {
    return inlineScriptTags;
  }

  public void setInlineScriptTags(List<GetInlineScriptTags200ResponseInlineScriptTagsInner> inlineScriptTags) {
    this.inlineScriptTags = inlineScriptTags;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetInlineScriptTags200Response getInlineScriptTags200Response = (GetInlineScriptTags200Response) o;
    return Objects.equals(this.inlineScriptTags, getInlineScriptTags200Response.inlineScriptTags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inlineScriptTags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetInlineScriptTags200Response {\n");
    sb.append("    inlineScriptTags: ").append(toIndentedString(inlineScriptTags)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("inline_script_tags");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetInlineScriptTags200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetInlineScriptTags200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetInlineScriptTags200Response is not found in the empty JSON string", GetInlineScriptTags200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetInlineScriptTags200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetInlineScriptTags200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("inline_script_tags") != null && !jsonObj.get("inline_script_tags").isJsonNull()) {
        JsonArray jsonArrayinlineScriptTags = jsonObj.getAsJsonArray("inline_script_tags");
        if (jsonArrayinlineScriptTags != null) {
          // ensure the json data is an array
          if (!jsonObj.get("inline_script_tags").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `inline_script_tags` to be an array in the JSON string but got `%s`", jsonObj.get("inline_script_tags").toString()));
          }

          // validate the optional field `inline_script_tags` (array)
          for (int i = 0; i < jsonArrayinlineScriptTags.size(); i++) {
            GetInlineScriptTags200ResponseInlineScriptTagsInner.validateJsonElement(jsonArrayinlineScriptTags.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetInlineScriptTags200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetInlineScriptTags200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetInlineScriptTags200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetInlineScriptTags200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetInlineScriptTags200Response>() {
           @Override
           public void write(JsonWriter out, GetInlineScriptTags200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetInlineScriptTags200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetInlineScriptTags200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetInlineScriptTags200Response
   * @throws IOException if the JSON string is invalid with respect to GetInlineScriptTags200Response
   */
  public static GetInlineScriptTags200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetInlineScriptTags200Response.class);
  }

  /**
   * Convert an instance of GetInlineScriptTags200Response to an JSON string
   *
   * @return JSON string
   */
