...
public class CreateShopScriptTag200Response {
  public static final String SERIALIZED_NAME_SCRIPT_TAG = "script_tag";
  @SerializedName(SERIALIZED_NAME_SCRIPT_TAG)
  private GetShopScriptTags200ResponseScriptTagsInner scriptTag;

  public CreateShopScriptTag200Response() {
  }

  public CreateShopScriptTag200Response scriptTag(GetShopScriptTags200ResponseScriptTagsInner scriptTag) {
  ...
  public GetShopScriptTags200ResponseScriptTagsInner getScriptTag() {
    return scriptTag;
  }

  public void setScriptTag(GetShopScriptTags200ResponseScriptTagsInner scriptTag) {
    this.scriptTag = scriptTag;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateShopScriptTag200Response createShopScriptTag200Response = (CreateShopScriptTag200Response) o;
    return Objects.equals(this.scriptTag, createShopScriptTag200Response.scriptTag);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateShopScriptTag200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateShopScriptTag200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateShopScriptTag200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateShopScriptTag200Response is not found in the empty JSON string", CreateShopScriptTag200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateShopScriptTag200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateShopScriptTag200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `script_tag`
      if (jsonObj.get("script_tag") != null && !jsonObj.get("script_tag").isJsonNull()) {
        GetShopScriptTags200ResponseScriptTagsInner.validateJsonElement(jsonObj.get("script_tag"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateShopScriptTag200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateShopScriptTag200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateShopScriptTag200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateShopScriptTag200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateShopScriptTag200Response>() {
           @Override
           public void write(JsonWriter out, CreateShopScriptTag200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateShopScriptTag200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateShopScriptTag200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateShopScriptTag200Response
   * @throws IOException if the JSON string is invalid with respect to CreateShopScriptTag200Response
   */
  public static CreateShopScriptTag200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateShopScriptTag200Response.class);
  }

  /**
   * Convert an instance of CreateShopScriptTag200Response to an JSON string
   *
   * @return JSON string
   */
