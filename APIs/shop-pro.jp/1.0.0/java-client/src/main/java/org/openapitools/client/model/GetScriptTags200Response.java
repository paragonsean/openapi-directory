...
public class GetScriptTags200Response {
  public static final String SERIALIZED_NAME_SCRIPT_TAGS = "script_tags";
  @SerializedName(SERIALIZED_NAME_SCRIPT_TAGS)
  private List<GetScriptTags200ResponseScriptTagsInner> scriptTags = new ArrayList<>();

  public GetScriptTags200Response() {
  }

  public GetScriptTags200Response scriptTags(List<GetScriptTags200ResponseScriptTagsInner> scriptTags) {
    this.scriptTags = scriptTags;
    return this;
  }

  public GetScriptTags200Response addScriptTagsItem(GetScriptTags200ResponseScriptTagsInner scriptTagsItem) {
  ...
  public List<GetScriptTags200ResponseScriptTagsInner> getScriptTags() {
    return scriptTags;
  }

  public void setScriptTags(List<GetScriptTags200ResponseScriptTagsInner> scriptTags) {
    this.scriptTags = scriptTags;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetScriptTags200Response getScriptTags200Response = (GetScriptTags200Response) o;
    return Objects.equals(this.scriptTags, getScriptTags200Response.scriptTags);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetScriptTags200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetScriptTags200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetScriptTags200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetScriptTags200Response is not found in the empty JSON string", GetScriptTags200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetScriptTags200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetScriptTags200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("script_tags") != null && !jsonObj.get("script_tags").isJsonNull()) {
        ...
        if (jsonArrayscriptTags != null) {
          ...
          for (int i = 0; i < jsonArrayscriptTags.size(); i++) {
            GetScriptTags200ResponseScriptTagsInner.validateJsonElement(jsonArrayscriptTags.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetScriptTags200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetScriptTags200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetScriptTags200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetScriptTags200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetScriptTags200Response>() {
           @Override
           public void write(JsonWriter out, GetScriptTags200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetScriptTags200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetScriptTags200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetScriptTags200Response
   * @throws IOException if the JSON string is invalid with respect to GetScriptTags200Response
   */
  public static GetScriptTags200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetScriptTags200Response.class);
  }

  /**
   * Convert an instance of GetScriptTags200Response to an JSON string
   *
   * @return JSON string
   */
