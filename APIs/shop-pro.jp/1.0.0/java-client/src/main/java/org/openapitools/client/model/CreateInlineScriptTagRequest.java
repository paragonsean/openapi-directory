...
public class CreateInlineScriptTagRequest {
  ...
  private CreateInlineScriptTagRequestInlineScriptTag inlineScriptTag;

  public CreateInlineScriptTagRequest() {
  }

  public CreateInlineScriptTagRequest inlineScriptTag(CreateInlineScriptTagRequestInlineScriptTag inlineScriptTag) {
  ...
  public CreateInlineScriptTagRequestInlineScriptTag getInlineScriptTag() {
    return inlineScriptTag;
  }

  public void setInlineScriptTag(CreateInlineScriptTagRequestInlineScriptTag inlineScriptTag) {
    this.inlineScriptTag = inlineScriptTag;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateInlineScriptTagRequest createInlineScriptTagRequest = (CreateInlineScriptTagRequest) o;
    return Objects.equals(this.inlineScriptTag, createInlineScriptTagRequest.inlineScriptTag);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateInlineScriptTagRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateInlineScriptTagRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateInlineScriptTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateInlineScriptTagRequest is not found in the empty JSON string", CreateInlineScriptTagRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateInlineScriptTagRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateInlineScriptTagRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("inline_script_tag") != null && !jsonObj.get("inline_script_tag").isJsonNull()) {
        CreateInlineScriptTagRequestInlineScriptTag.validateJsonElement(jsonObj.get("inline_script_tag"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateInlineScriptTagRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateInlineScriptTagRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateInlineScriptTagRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateInlineScriptTagRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateInlineScriptTagRequest>() {
           @Override
           public void write(JsonWriter out, CreateInlineScriptTagRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateInlineScriptTagRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateInlineScriptTagRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateInlineScriptTagRequest
   * @throws IOException if the JSON string is invalid with respect to CreateInlineScriptTagRequest
   */
  public static CreateInlineScriptTagRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateInlineScriptTagRequest.class);
  }

  /**
   * Convert an instance of CreateInlineScriptTagRequest to an JSON string
   *
   * @return JSON string
   */
