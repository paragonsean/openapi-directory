...
public class ShopScriptTag {
  ...
  public ShopScriptTag() {
  }

  public ShopScriptTag accountId(String accountId) {
  ...
  public ShopScriptTag displayScope(DisplayScopeEnum displayScope) {
  ...
  public ShopScriptTag id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ShopScriptTag integrity(String integrity) {
  ...
  public ShopScriptTag makeDate(Integer makeDate) {
  ...
  public ShopScriptTag oauthApplicationId(Integer oauthApplicationId) {
  ...
  public ShopScriptTag src(String src) {
    this.src = src;
    return this;
  }
  ...
  public ShopScriptTag updateDate(Integer updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    ShopScriptTag shopScriptTag = (ShopScriptTag) o;
    return Objects.equals(this.accountId, shopScriptTag.accountId) &&
        Objects.equals(this.displayScope, shopScriptTag.displayScope) &&
        Objects.equals(this.id, shopScriptTag.id) &&
        Objects.equals(this.integrity, shopScriptTag.integrity) &&
        Objects.equals(this.makeDate, shopScriptTag.makeDate) &&
        Objects.equals(this.oauthApplicationId, shopScriptTag.oauthApplicationId) &&
        Objects.equals(this.src, shopScriptTag.src) &&
        Objects.equals(this.updateDate, shopScriptTag.updateDate);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShopScriptTag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShopScriptTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShopScriptTag is not found in the empty JSON string", ShopScriptTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShopScriptTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShopScriptTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShopScriptTag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShopScriptTag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShopScriptTag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShopScriptTag.class));

       return (TypeAdapter<T>) new TypeAdapter<ShopScriptTag>() {
           @Override
           public void write(JsonWriter out, ShopScriptTag value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShopScriptTag read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ShopScriptTag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ShopScriptTag
   * @throws IOException if the JSON string is invalid with respect to ShopScriptTag
   */
  public static ShopScriptTag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShopScriptTag.class);
  }

  /**
   * Convert an instance of ShopScriptTag to an JSON string
   *
   * @return JSON string
   */
