...
import org.openapitools.client.model.CreateUsageCharge201ResponseUsageCharge;
...
public class CreateUsageCharge201Response {
  public static final String SERIALIZED_NAME_USAGE_CHARGE = "usage_charge";
  @SerializedName(SERIALIZED_NAME_USAGE_CHARGE)
  private CreateUsageCharge201ResponseUsageCharge usageCharge;

  public CreateUsageCharge201Response() {
  }

  public CreateUsageCharge201Response usageCharge(CreateUsageCharge201ResponseUsageCharge usageCharge) {
  ...
  public CreateUsageCharge201ResponseUsageCharge getUsageCharge() {
    return usageCharge;
  }

  public void setUsageCharge(CreateUsageCharge201ResponseUsageCharge usageCharge) {
    this.usageCharge = usageCharge;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateUsageCharge201Response createUsageCharge201Response = (CreateUsageCharge201Response) o;
    return Objects.equals(this.usageCharge, createUsageCharge201Response.usageCharge);
  }

  @Override
  public int hashCode() {
    return Objects.hash(usageCharge);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateUsageCharge201Response {\n");
    sb.append("    usageCharge: ").append(toIndentedString(usageCharge)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("usage_charge");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateUsageCharge201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUsageCharge201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUsageCharge201Response is not found in the empty JSON string", CreateUsageCharge201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateUsageCharge201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateUsageCharge201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `usage_charge`
      if (jsonObj.get("usage_charge") != null && !jsonObj.get("usage_charge").isJsonNull()) {
        CreateUsageCharge201ResponseUsageCharge.validateJsonElement(jsonObj.get("usage_charge"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUsageCharge201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUsageCharge201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUsageCharge201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUsageCharge201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUsageCharge201Response>() {
           @Override
           public void write(JsonWriter out, CreateUsageCharge201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateUsageCharge201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateUsageCharge201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateUsageCharge201Response
   * @throws IOException if the JSON string is invalid with respect to CreateUsageCharge201Response
   */
  public static CreateUsageCharge201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUsageCharge201Response.class);
  }

  /**
   * Convert an instance of CreateUsageCharge201Response to an JSON string
   *
   * @return JSON string
   */
