...
import org.openapitools.client.model.GetInlineScriptTags200ResponseInlineScriptTagsInner;
...
/**
 * CreateInlineScriptTag201Response
 */
...
public class CreateInlineScriptTag201Response {
  public static final String SERIALIZED_NAME_INLINE_SCRIPT_TAG = "inline_script_tag";
  @SerializedName(SERIALIZED_NAME_INLINE_SCRIPT_TAG)
  private GetInlineScriptTags200ResponseInlineScriptTagsInner inlineScriptTag;

  public CreateInlineScriptTag201Response() {
  }

  public CreateInlineScriptTag201Response inlineScriptTag(GetInlineScriptTags200ResponseInlineScriptTagsInner inlineScriptTag) {
  ...
  /**
   * Get inlineScriptTag
   * @return inlineScriptTag
   */
  @javax.annotation.Nullable
  public GetInlineScriptTags200ResponseInlineScriptTagsInner getInlineScriptTag() {
    return inlineScriptTag;
  }

  public void setInlineScriptTag(GetInlineScriptTags200ResponseInlineScriptTagsInner inlineScriptTag) {
    this.inlineScriptTag = inlineScriptTag;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateInlineScriptTag201Response createInlineScriptTag201Response = (CreateInlineScriptTag201Response) o;
    return Objects.equals(this.inlineScriptTag, createInlineScriptTag201Response.inlineScriptTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inlineScriptTag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateInlineScriptTag201Response {\n");
    sb.append("    inlineScriptTag: ").append(toIndentedString(inlineScriptTag)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("inline_script_tag");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateInlineScriptTag201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateInlineScriptTag201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateInlineScriptTag201Response is not found in the empty JSON string", CreateInlineScriptTag201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateInlineScriptTag201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateInlineScriptTag201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `inline_script_tag`
      if (jsonObj.get("inline_script_tag") != null && !jsonObj.get("inline_script_tag").isJsonNull()) {
        GetInlineScriptTags200ResponseInlineScriptTagsInner.validateJsonElement(jsonObj.get("inline_script_tag"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateInlineScriptTag201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateInlineScriptTag201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateInlineScriptTag201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateInlineScriptTag201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateInlineScriptTag201Response>() {
           @Override
           public void write(JsonWriter out, CreateInlineScriptTag201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateInlineScriptTag201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateInlineScriptTag201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateInlineScriptTag201Response
   * @throws IOException if the JSON string is invalid with respect to CreateInlineScriptTag201Response
   */
  public static CreateInlineScriptTag201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateInlineScriptTag201Response.class);
  }

  /**
   * Convert an instance of CreateInlineScriptTag201Response to an JSON string
   *
   * @return JSON string
   */
