...
public class CreateInlineScriptTagRequestInlineScriptTag {
  /**
  ...
  public CreateInlineScriptTagRequestInlineScriptTag() {
  }

  public CreateInlineScriptTagRequestInlineScriptTag displayScope(DisplayScopeEnum displayScope) {
  ...
  public CreateInlineScriptTagRequestInlineScriptTag script(String script) {
    this.script = script;
    return this;
  }
  ...
  public CreateInlineScriptTagRequestInlineScriptTag triggerEvent(TriggerEventEnum triggerEvent) {
  ...
  public boolean equals(Object o) {
    ...
    CreateInlineScriptTagRequestInlineScriptTag createInlineScriptTagRequestInlineScriptTag = (CreateInlineScriptTagRequestInlineScriptTag) o;
    return Objects.equals(this.displayScope, createInlineScriptTagRequestInlineScriptTag.displayScope) &&
        Objects.equals(this.script, createInlineScriptTagRequestInlineScriptTag.script) &&
        Objects.equals(this.triggerEvent, createInlineScriptTagRequestInlineScriptTag.triggerEvent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayScope, script, triggerEvent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateInlineScriptTagRequestInlineScriptTag {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateInlineScriptTagRequestInlineScriptTag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateInlineScriptTagRequestInlineScriptTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateInlineScriptTagRequestInlineScriptTag is not found in the empty JSON string", CreateInlineScriptTagRequestInlineScriptTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateInlineScriptTagRequestInlineScriptTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateInlineScriptTagRequestInlineScriptTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateInlineScriptTagRequestInlineScriptTag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateInlineScriptTagRequestInlineScriptTag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateInlineScriptTagRequestInlineScriptTag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateInlineScriptTagRequestInlineScriptTag.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateInlineScriptTagRequestInlineScriptTag>() {
           @Override
           public void write(JsonWriter out, CreateInlineScriptTagRequestInlineScriptTag value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateInlineScriptTagRequestInlineScriptTag read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateInlineScriptTagRequestInlineScriptTag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateInlineScriptTagRequestInlineScriptTag
   * @throws IOException if the JSON string is invalid with respect to CreateInlineScriptTagRequestInlineScriptTag
   */
  public static CreateInlineScriptTagRequestInlineScriptTag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateInlineScriptTagRequestInlineScriptTag.class);
  }

  /**
   * Convert an instance of CreateInlineScriptTagRequestInlineScriptTag to an JSON string
   *
   * @return JSON string
   */
