...
public class ApplicationCharge {
  ...
  public ApplicationCharge id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ApplicationCharge makeDate(Integer makeDate) {
  ...
  public ApplicationCharge point(Integer point) {
    this.point = point;
    return this;
  }
  ...
  public ApplicationCharge updateDate(Integer updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationCharge applicationCharge = (ApplicationCharge) o;
    return Objects.equals(this.id, applicationCharge.id) &&
        Objects.equals(this.makeDate, applicationCharge.makeDate) &&
        Objects.equals(this.point, applicationCharge.point) &&
        Objects.equals(this.updateDate, applicationCharge.updateDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationCharge {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplicationCharge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplicationCharge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationCharge is not found in the empty JSON string", ApplicationCharge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationCharge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationCharge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationCharge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationCharge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationCharge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationCharge.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationCharge>() {
           @Override
           public void write(JsonWriter out, ApplicationCharge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplicationCharge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplicationCharge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplicationCharge
   * @throws IOException if the JSON string is invalid with respect to ApplicationCharge
   */
  public static ApplicationCharge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationCharge.class);
  }

  /**
   * Convert an instance of ApplicationCharge to an JSON string
   *
   * @return JSON string
   */
