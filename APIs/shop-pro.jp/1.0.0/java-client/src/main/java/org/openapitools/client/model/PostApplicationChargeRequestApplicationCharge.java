...
/**
 * PostApplicationChargeRequestApplicationCharge
 */
...
public class PostApplicationChargeRequestApplicationCharge {
  public static final String SERIALIZED_NAME_APPLICATION_CHARGE_SOURCE_ID = "application_charge_source_id";
  @SerializedName(SERIALIZED_NAME_APPLICATION_CHARGE_SOURCE_ID)
  private String applicationChargeSourceId;

  public PostApplicationChargeRequestApplicationCharge() {
  }

  public PostApplicationChargeRequestApplicationCharge applicationChargeSourceId(String applicationChargeSourceId) {
  ...
  /**
   * アプリ内課金ID
   * @return applicationChargeSourceId
   */
  @javax.annotation.Nullable
  public String getApplicationChargeSourceId() {
    return applicationChargeSourceId;
  }

  public void setApplicationChargeSourceId(String applicationChargeSourceId) {
    this.applicationChargeSourceId = applicationChargeSourceId;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostApplicationChargeRequestApplicationCharge postApplicationChargeRequestApplicationCharge = (PostApplicationChargeRequestApplicationCharge) o;
    return Objects.equals(this.applicationChargeSourceId, postApplicationChargeRequestApplicationCharge.applicationChargeSourceId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicationChargeSourceId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostApplicationChargeRequestApplicationCharge {\n");
    sb.append("    applicationChargeSourceId: ").append(toIndentedString(applicationChargeSourceId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("application_charge_source_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostApplicationChargeRequestApplicationCharge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostApplicationChargeRequestApplicationCharge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostApplicationChargeRequestApplicationCharge is not found in the empty JSON string", PostApplicationChargeRequestApplicationCharge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostApplicationChargeRequestApplicationCharge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostApplicationChargeRequestApplicationCharge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("application_charge_source_id") != null && !jsonObj.get("application_charge_source_id").isJsonNull()) && !jsonObj.get("application_charge_source_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `application_charge_source_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("application_charge_source_id").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostApplicationChargeRequestApplicationCharge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostApplicationChargeRequestApplicationCharge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostApplicationChargeRequestApplicationCharge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostApplicationChargeRequestApplicationCharge.class));

       return (TypeAdapter<T>) new TypeAdapter<PostApplicationChargeRequestApplicationCharge>() {
           @Override
           public void write(JsonWriter out, PostApplicationChargeRequestApplicationCharge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostApplicationChargeRequestApplicationCharge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostApplicationChargeRequestApplicationCharge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostApplicationChargeRequestApplicationCharge
   * @throws IOException if the JSON string is invalid with respect to PostApplicationChargeRequestApplicationCharge
   */
  public static PostApplicationChargeRequestApplicationCharge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostApplicationChargeRequestApplicationCharge.class);
  }

  /**
   * Convert an instance of PostApplicationChargeRequestApplicationCharge to an JSON string
   *
   * @return JSON string
   */
