...
public class ScriptTag {
  ...
  public ScriptTag displayScope(DisplayScopeEnum displayScope) {
  ...
  public ScriptTag id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ScriptTag makeDate(Integer makeDate) {
  ...
  public ScriptTag updateDate(Integer updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    ScriptTag scriptTag = (ScriptTag) o;
    return Objects.equals(this.displayScope, scriptTag.displayScope) &&
        Objects.equals(this.id, scriptTag.id) &&
        Objects.equals(this.makeDate, scriptTag.makeDate) &&
        Objects.equals(this.src, scriptTag.src) &&
        Objects.equals(this.updateDate, scriptTag.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayScope, id, makeDate, src, updateDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ScriptTag {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScriptTag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScriptTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScriptTag is not found in the empty JSON string", ScriptTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScriptTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScriptTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScriptTag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScriptTag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScriptTag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScriptTag.class));

       return (TypeAdapter<T>) new TypeAdapter<ScriptTag>() {
           @Override
           public void write(JsonWriter out, ScriptTag value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScriptTag read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScriptTag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScriptTag
   * @throws IOException if the JSON string is invalid with respect to ScriptTag
   */
  public static ScriptTag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScriptTag.class);
  }

  /**
   * Convert an instance of ScriptTag to an JSON string
   *
   * @return JSON string
   */
