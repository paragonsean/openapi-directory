...
public class PostApplicationChargeRequest {
  public static final String SERIALIZED_NAME_APPLICATION_CHARGE = "application_charge";
  @SerializedName(SERIALIZED_NAME_APPLICATION_CHARGE)
  private PostApplicationChargeRequestApplicationCharge applicationCharge;

  public PostApplicationChargeRequest() {
  }

  public PostApplicationChargeRequest applicationCharge(PostApplicationChargeRequestApplicationCharge applicationCharge) {
    this.applicationCharge = applicationCharge;
    return this;
  }

  /**
   * Get applicationCharge
   * @return applicationCharge
   */
  @javax.annotation.Nullable
  public PostApplicationChargeRequestApplicationCharge getApplicationCharge() {
    return applicationCharge;
  }

  public void setApplicationCharge(PostApplicationChargeRequestApplicationCharge applicationCharge) {
    this.applicationCharge = applicationCharge;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostApplicationChargeRequest postApplicationChargeRequest = (PostApplicationChargeRequest) o;
    return Objects.equals(this.applicationCharge, postApplicationChargeRequest.applicationCharge);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicationCharge);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostApplicationChargeRequest {\n");
    sb.append("    applicationCharge: ").append(toIndentedString(applicationCharge)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("application_charge");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostApplicationChargeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostApplicationChargeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostApplicationChargeRequest is not found in the empty JSON string", PostApplicationChargeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostApplicationChargeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostApplicationChargeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `application_charge`
      if (jsonObj.get("application_charge") != null && !jsonObj.get("application_charge").isJsonNull()) {
        PostApplicationChargeRequestApplicationCharge.validateJsonElement(jsonObj.get("application_charge"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostApplicationChargeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostApplicationChargeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostApplicationChargeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostApplicationChargeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PostApplicationChargeRequest>() {
           @Override
           public void write(JsonWriter out, PostApplicationChargeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostApplicationChargeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostApplicationChargeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostApplicationChargeRequest
   * @throws IOException if the JSON string is invalid with respect to PostApplicationChargeRequest
   */
  public static PostApplicationChargeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostApplicationChargeRequest.class);
  }

  /**
   * Convert an instance of PostApplicationChargeRequest to an JSON string
   *
   * @return JSON string
   */
