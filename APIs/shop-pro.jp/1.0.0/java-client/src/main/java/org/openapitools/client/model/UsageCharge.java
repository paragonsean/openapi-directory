...
public class UsageCharge {
  ...
  public UsageCharge description(String description) {
  ...
  public UsageCharge id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UsageCharge makeDate(Integer makeDate) {
  ...
  public UsageCharge point(Integer point) {
    this.point = point;
    return this;
  }
  ...
  public UsageCharge updateDate(Integer updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    UsageCharge usageCharge = (UsageCharge) o;
    return Objects.equals(this.description, usageCharge.description) &&
        Objects.equals(this.id, usageCharge.id) &&
        Objects.equals(this.makeDate, usageCharge.makeDate) &&
        Objects.equals(this.point, usageCharge.point) &&
        Objects.equals(this.updateDate, usageCharge.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, makeDate, point, updateDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UsageCharge {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UsageCharge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsageCharge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsageCharge is not found in the empty JSON string", UsageCharge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UsageCharge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UsageCharge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsageCharge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsageCharge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsageCharge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageCharge.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageCharge>() {
           @Override
           public void write(JsonWriter out, UsageCharge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UsageCharge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UsageCharge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UsageCharge
   * @throws IOException if the JSON string is invalid with respect to UsageCharge
   */
  public static UsageCharge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsageCharge.class);
  }

  /**
   * Convert an instance of UsageCharge to an JSON string
   *
   * @return JSON string
   */
