...
public class DeleteInstallation200ResponseUsageCharge {
  public static final String SERIALIZED_NAME_API_TOKEN = "api_token";
  @SerializedName(SERIALIZED_NAME_API_TOKEN)
  private String apiToken;

  public static final String SERIALIZED_NAME_CLOSING_ON = "closing_on";
  @SerializedName(SERIALIZED_NAME_CLOSING_ON)
  private Integer closingOn;

  public DeleteInstallation200ResponseUsageCharge() {
  }

  public DeleteInstallation200ResponseUsageCharge apiToken(String apiToken) {
  ...
  public DeleteInstallation200ResponseUsageCharge closingOn(Integer closingOn) {
   ...
   */
  @javax.annotation.Nullable
  public Integer getClosingOn() {
    return closingOn;
  }

  public void setClosingOn(Integer closingOn) {
    this.closingOn = closingOn;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteInstallation200ResponseUsageCharge deleteInstallation200ResponseUsageCharge = (DeleteInstallation200ResponseUsageCharge) o;
    return Objects.equals(this.apiToken, deleteInstallation200ResponseUsageCharge.apiToken) &&
        Objects.equals(this.closingOn, deleteInstallation200ResponseUsageCharge.closingOn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiToken, closingOn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteInstallation200ResponseUsageCharge {\n");
    sb.append("    apiToken: ").append(toIndentedString(apiToken)).append("\n");
    sb.append("    closingOn: ").append(toIndentedString(closingOn)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteInstallation200ResponseUsageCharge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteInstallation200ResponseUsageCharge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteInstallation200ResponseUsageCharge is not found in the empty JSON string", DeleteInstallation200ResponseUsageCharge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteInstallation200ResponseUsageCharge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteInstallation200ResponseUsageCharge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteInstallation200ResponseUsageCharge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteInstallation200ResponseUsageCharge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteInstallation200ResponseUsageCharge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteInstallation200ResponseUsageCharge.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteInstallation200ResponseUsageCharge>() {
           @Override
           public void write(JsonWriter out, DeleteInstallation200ResponseUsageCharge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteInstallation200ResponseUsageCharge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteInstallation200ResponseUsageCharge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteInstallation200ResponseUsageCharge
   * @throws IOException if the JSON string is invalid with respect to DeleteInstallation200ResponseUsageCharge
   */
  public static DeleteInstallation200ResponseUsageCharge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteInstallation200ResponseUsageCharge.class);
  }

  /**
   * Convert an instance of DeleteInstallation200ResponseUsageCharge to an JSON string
   *
   * @return JSON string
   */
