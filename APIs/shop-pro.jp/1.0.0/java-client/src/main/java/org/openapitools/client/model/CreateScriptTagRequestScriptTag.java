...
/**
 * CreateScriptTagRequestScriptTag
 */
...
public class CreateScriptTagRequestScriptTag {
  /**
  ...
  public CreateScriptTagRequestScriptTag() {
  }

  public CreateScriptTagRequestScriptTag displayScope(DisplayScopeEnum displayScope) {
  ...
  public CreateScriptTagRequestScriptTag src(String src) {
    this.src = src;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateScriptTagRequestScriptTag createScriptTagRequestScriptTag = (CreateScriptTagRequestScriptTag) o;
    return Objects.equals(this.displayScope, createScriptTagRequestScriptTag.displayScope) &&
        Objects.equals(this.src, createScriptTagRequestScriptTag.src);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayScope, src);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateScriptTagRequestScriptTag {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateScriptTagRequestScriptTag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateScriptTagRequestScriptTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateScriptTagRequestScriptTag is not found in the empty JSON string", CreateScriptTagRequestScriptTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateScriptTagRequestScriptTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateScriptTagRequestScriptTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateScriptTagRequestScriptTag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateScriptTagRequestScriptTag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateScriptTagRequestScriptTag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateScriptTagRequestScriptTag.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateScriptTagRequestScriptTag>() {
           @Override
           public void write(JsonWriter out, CreateScriptTagRequestScriptTag value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateScriptTagRequestScriptTag read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateScriptTagRequestScriptTag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateScriptTagRequestScriptTag
   * @throws IOException if the JSON string is invalid with respect to CreateScriptTagRequestScriptTag
   */
  public static CreateScriptTagRequestScriptTag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateScriptTagRequestScriptTag.class);
  }

  /**
   * Convert an instance of CreateScriptTagRequestScriptTag to an JSON string
   *
   * @return JSON string
   */
