...
public class GetScriptTags200ResponseScriptTagsInner {
  /**
  ...
  public GetScriptTags200ResponseScriptTagsInner() {
  }

  public GetScriptTags200ResponseScriptTagsInner displayScope(DisplayScopeEnum displayScope) {
  ...
  public GetScriptTags200ResponseScriptTagsInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public GetScriptTags200ResponseScriptTagsInner makeDate(Integer makeDate) {
  ...
  public GetScriptTags200ResponseScriptTagsInner src(String src) {
    this.src = src;
    return this;
  }
  ...
  public GetScriptTags200ResponseScriptTagsInner updateDate(Integer updateDate) {
  ...
  public boolean equals(Object o) {
    ...
    GetScriptTags200ResponseScriptTagsInner getScriptTags200ResponseScriptTagsInner = (GetScriptTags200ResponseScriptTagsInner) o;
    return Objects.equals(this.displayScope, getScriptTags200ResponseScriptTagsInner.displayScope) &&
        Objects.equals(this.id, getScriptTags200ResponseScriptTagsInner.id) &&
        Objects.equals(this.makeDate, getScriptTags200ResponseScriptTagsInner.makeDate) &&
        Objects.equals(this.src, getScriptTags200ResponseScriptTagsInner.src) &&
        Objects.equals(this.updateDate, getScriptTags200ResponseScriptTagsInner.updateDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetScriptTags200ResponseScriptTagsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetScriptTags200ResponseScriptTagsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetScriptTags200ResponseScriptTagsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetScriptTags200ResponseScriptTagsInner is not found in the empty JSON string", GetScriptTags200ResponseScriptTagsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetScriptTags200ResponseScriptTagsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetScriptTags200ResponseScriptTagsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetScriptTags200ResponseScriptTagsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetScriptTags200ResponseScriptTagsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetScriptTags200ResponseScriptTagsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetScriptTags200ResponseScriptTagsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetScriptTags200ResponseScriptTagsInner>() {
           @Override
           public void write(JsonWriter out, GetScriptTags200ResponseScriptTagsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetScriptTags200ResponseScriptTagsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetScriptTags200ResponseScriptTagsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetScriptTags200ResponseScriptTagsInner
   * @throws IOException if the JSON string is invalid with respect to GetScriptTags200ResponseScriptTagsInner
   */
  public static GetScriptTags200ResponseScriptTagsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetScriptTags200ResponseScriptTagsInner.class);
  }

  /**
   * Convert an instance of GetScriptTags200ResponseScriptTagsInner to an JSON string
   *
   * @return JSON string
   */
