...
/**
 * API tests for ApplicationChargeApi
 */
@Disabled
public class ApplicationChargeApiTest {

    private final ApplicationChargeApi api = new ApplicationChargeApi();
     ...
     */
    @Test
    public void createUsageChargeTest() throws ApiException {
        String recurringApplicationChargeId = null;
        CreateUsageChargeRequest createUsageChargeRequest = null;
        String xAppstoreUsageChargeToken = null;
        CreateUsageCharge201Response response = api.createUsageCharge(recurringApplicationChargeId, createUsageChargeRequest, xAppstoreUsageChargeToken);
     ...
     */
    @Test
    public void postApplicationChargeTest() throws ApiException {
        PostApplicationChargeRequest postApplicationChargeRequest = null;
        PostApplicationCharge201Response response = api.postApplicationCharge(postApplicationChargeRequest);
        // TODO: test validations
    }
