...
/**
 * API tests for UninstallationApi
 */
@Disabled
public class UninstallationApiTest {

    private final UninstallationApi api = new UninstallationApi();
    ...
    public void deleteInstallationTest() throws ApiException {
        DeleteInstallation200Response response = api.deleteInstallation();
