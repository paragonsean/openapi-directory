...
/**
* ApplicationCharge service.
* @module api/ApplicationChargeApi
* @version 1.0.0
*/
export default class ApplicationChargeApi {

    /**
    * Constructs a new ApplicationChargeApi. 
    * @alias module:api/ApplicationChargeApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createUsageCharge operation.
     * @callback module:api/ApplicationChargeApi~createUsageChargeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateUsageCharge201Response} data The data returned by the service call.
     ...
     * @param {module:model/CreateUsageChargeRequest} createUsageChargeRequest 従量課金データ
     * @param {Object} opts Optional parameters
     * @param {String} [xAppstoreUsageChargeToken] アンインストール後の従量課金の精算をする際に、 `Authorization` ヘッダへアクセストークンを指定する代わりにこのヘッダを指定することで、このAPIを実行することができます。 インストール中は指定不要で、アンインストール後のみ必須となります。 アンインストールフックで通知される `usage_charge.api_token` の値を指定してください。 このヘッダは、アンインストールフックで通知される `usage_charge.closing_on` まで有効です。この期間を過ぎると従量課金を精算できなくなりますのでご注意ください。詳しくは [アプリのアンインストール](#section/API/アプリのアンインストール) をご確認ください。
     * @param {module:api/ApplicationChargeApi~createUsageChargeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateUsageCharge201Response}
     */
    createUsageCharge(recurringApplicationChargeId, createUsageChargeRequest, opts, callback) {
      opts = opts || {};
      let postBody = createUsageChargeRequest;
      // verify the required parameter 'recurringApplicationChargeId' is set
      if (recurringApplicationChargeId === undefined || recurringApplicationChargeId === null) {
        throw new Error("Missing the required parameter 'recurringApplicationChargeId' when calling createUsageCharge");
      }
      // verify the required parameter 'createUsageChargeRequest' is set
      if (createUsageChargeRequest === undefined || createUsageChargeRequest === null) {
        throw new Error("Missing the required parameter 'createUsageChargeRequest' when calling createUsageCharge");
      }
      ...
      let headerParams = {
        'X-Appstore-Usage-Charge-Token': opts['xAppstoreUsageChargeToken']
      };
      let formParams = {
      };
      ...
      let returnType = CreateUsageCharge201Response;
      return this.apiClient.callApi(
        '/appstore/v1/recurring_application_charges/{recurringApplicationChargeId}/usage_charges.json', 'POST',
    ...
    /**
     * Callback function to receive the result of the postApplicationCharge operation.
     * @callback module:api/ApplicationChargeApi~postApplicationChargeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PostApplicationCharge201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/PostApplicationChargeRequest} postApplicationChargeRequest 
     * @param {module:api/ApplicationChargeApi~postApplicationChargeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PostApplicationCharge201Response}
     */
    postApplicationCharge(postApplicationChargeRequest, callback) {
      let postBody = postApplicationChargeRequest;
      // verify the required parameter 'postApplicationChargeRequest' is set
      if (postApplicationChargeRequest === undefined || postApplicationChargeRequest === null) {
        throw new Error("Missing the required parameter 'postApplicationChargeRequest' when calling postApplicationCharge");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = PostApplicationCharge201Response;
      return this.apiClient.callApi(
        '/appstore/v1/application_charges.json', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
