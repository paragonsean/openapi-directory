...
import DeleteInstallation200Response from '../model/DeleteInstallation200Response';

/**
* Uninstallation service.
* @module api/UninstallationApi
* @version 1.0.0
*/
export default class UninstallationApi {

    /**
    * Constructs a new UninstallationApi. 
    * @alias module:api/UninstallationApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the deleteInstallation operation.
     * @callback module:api/UninstallationApi~deleteInstallationCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeleteInstallation200Response} data The data returned by the service call.
     ...
     * @param {module:api/UninstallationApi~deleteInstallationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeleteInstallation200Response}
     */
    deleteInstallation(callback) {
      let postBody = null;
      ...
      let returnType = DeleteInstallation200Response;
      return this.apiClient.callApi(
        '/appstore/v1/installation.json', 'DELETE',
