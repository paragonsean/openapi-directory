...
/**
* ScriptDeprecated service.
* @module api/ScriptDeprecatedApi
* @version 1.0.0
*/
export default class ScriptDeprecatedApi {

    /**
    * Constructs a new ScriptDeprecatedApi. 
    * @alias module:api/ScriptDeprecatedApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createScriptTag operation.
     * @callback module:api/ScriptDeprecatedApi~createScriptTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateScriptTag200Response} data The data returned by the service call.
     ...
     * @param {module:model/CreateScriptTagRequest} [createScriptTagRequest] 作成するスクリプトタグの情報
     * @param {module:api/ScriptDeprecatedApi~createScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateScriptTag200Response}
     */
    createScriptTag(opts, callback) {
      opts = opts || {};
      let postBody = opts['createScriptTagRequest'];
      ...
      let returnType = CreateScriptTag200Response;
    ...
    /**
     * Callback function to receive the result of the getScriptTag operation.
     * @callback module:api/ScriptDeprecatedApi~getScriptTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateScriptTag200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ScriptDeprecatedApi~getScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateScriptTag200Response}
     */
    getScriptTag(scriptTagId, callback) {
      let postBody = null;
      // verify the required parameter 'scriptTagId' is set
      if (scriptTagId === undefined || scriptTagId === null) {
        throw new Error("Missing the required parameter 'scriptTagId' when calling getScriptTag");
      }
    ...
    /**
     * Callback function to receive the result of the getScriptTags operation.
     * @callback module:api/ScriptDeprecatedApi~getScriptTagsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetScriptTags200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * スクリプトタグの取得
     * 
     * @param {module:api/ScriptDeprecatedApi~getScriptTagsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetScriptTags200Response}
     */
    getScriptTags(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetScriptTags200Response;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the updateScriptTag operation.
     * @callback module:api/ScriptDeprecatedApi~updateScriptTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateScriptTag200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateScriptTagRequest} [createScriptTagRequest] 作成するスクリプトタグの情報
     * @param {module:api/ScriptDeprecatedApi~updateScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateScriptTag200Response}
     */
    updateScriptTag(scriptTagId, opts, callback) {
      opts = opts || {};
      let postBody = opts['createScriptTagRequest'];
      // verify the required parameter 'scriptTagId' is set
      if (scriptTagId === undefined || scriptTagId === null) {
        throw new Error("Missing the required parameter 'scriptTagId' when calling updateScriptTag");
      }
    ...
    /**
     * Callback function to receive the result of the v1ScriptTagsScriptTagIdJsonDelete operation.
     * @callback module:api/ScriptDeprecatedApi~v1ScriptTagsScriptTagIdJsonDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {Number} scriptTagId スクリプトタグID
     * @param {module:api/ScriptDeprecatedApi~v1ScriptTagsScriptTagIdJsonDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    v1ScriptTagsScriptTagIdJsonDelete(scriptTagId, callback) {
      let postBody = null;
      // verify the required parameter 'scriptTagId' is set
      if (scriptTagId === undefined || scriptTagId === null) {
        throw new Error("Missing the required parameter 'scriptTagId' when calling v1ScriptTagsScriptTagIdJsonDelete");
      }
