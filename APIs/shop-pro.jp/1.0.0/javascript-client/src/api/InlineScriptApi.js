...
/**
* InlineScript service.
* @module api/InlineScriptApi
* @version 1.0.0
*/
export default class InlineScriptApi {

    /**
    * Constructs a new InlineScriptApi. 
    * @alias module:api/InlineScriptApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createInlineScriptTag operation.
     * @callback module:api/InlineScriptApi~createInlineScriptTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateInlineScriptTag201Response} data The data returned by the service call.
     ...
     * @param {module:model/CreateInlineScriptTagRequest} [createInlineScriptTagRequest] 作成するインラインスクリプトタグの情報
     * @param {module:api/InlineScriptApi~createInlineScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateInlineScriptTag201Response}
     */
    createInlineScriptTag(opts, callback) {
      opts = opts || {};
      let postBody = opts['createInlineScriptTagRequest'];
      ...
      let returnType = CreateInlineScriptTag201Response;
      return this.apiClient.callApi(
        '/v1/inline_script_tags.json', 'POST',
    ...
    /**
     * Callback function to receive the result of the deleteInlineScriptTag operation.
     * @callback module:api/InlineScriptApi~deleteInlineScriptTagCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/InlineScriptApi~deleteInlineScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteInlineScriptTag(inlineScriptTagId, callback) {
      let postBody = null;
      // verify the required parameter 'inlineScriptTagId' is set
      if (inlineScriptTagId === undefined || inlineScriptTagId === null) {
        throw new Error("Missing the required parameter 'inlineScriptTagId' when calling deleteInlineScriptTag");
      }

      let pathParams = {
        'inlineScriptTagId': inlineScriptTagId
      };
      let queryParams = {
      };
      let headerParams = {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/v1/inline_script_tags/{inlineScriptTagId}.json', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getInlineScriptTag operation.
     * @callback module:api/InlineScriptApi~getInlineScriptTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateInlineScriptTag201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {Number} inlineScriptTagId インラインスクリプトタグID
     * @param {module:api/InlineScriptApi~getInlineScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateInlineScriptTag201Response}
     */
    getInlineScriptTag(inlineScriptTagId, callback) {
      let postBody = null;
      // verify the required parameter 'inlineScriptTagId' is set
      if (inlineScriptTagId === undefined || inlineScriptTagId === null) {
        throw new Error("Missing the required parameter 'inlineScriptTagId' when calling getInlineScriptTag");
      }
      ...
      let returnType = CreateInlineScriptTag201Response;
      return this.apiClient.callApi(
        '/v1/inline_script_tags/{inlineScriptTagId}.json', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getInlineScriptTags operation.
     * @callback module:api/InlineScriptApi~getInlineScriptTagsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetInlineScriptTags200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * インラインスクリプトタグの取得
     * 
     * @param {module:api/InlineScriptApi~getInlineScriptTagsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetInlineScriptTags200Response}
     */
    getInlineScriptTags(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetInlineScriptTags200Response;
      return this.apiClient.callApi(
        '/v1/inline_script_tags.json', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateInlineScriptTag operation.
     * @callback module:api/InlineScriptApi~updateInlineScriptTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateInlineScriptTag201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} inlineScriptTagId インラインスクリプトタグID
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateInlineScriptTagRequest} [createInlineScriptTagRequest] 更新するスクリプトタグの情報
     * @param {module:api/InlineScriptApi~updateInlineScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateInlineScriptTag201Response}
     */
    updateInlineScriptTag(inlineScriptTagId, opts, callback) {
      opts = opts || {};
      let postBody = opts['createInlineScriptTagRequest'];
      // verify the required parameter 'inlineScriptTagId' is set
      if (inlineScriptTagId === undefined || inlineScriptTagId === null) {
        throw new Error("Missing the required parameter 'inlineScriptTagId' when calling updateInlineScriptTag");
      }
      ...
      let returnType = CreateInlineScriptTag201Response;
      return this.apiClient.callApi(
        '/v1/inline_script_tags/{inlineScriptTagId}.json', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
