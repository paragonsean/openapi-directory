...
export default class ScriptApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createShopScriptTag operation.
     * @callback module:api/ScriptApi~createShopScriptTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateShopScriptTag200Response} data The data returned by the service call.
     ...
     * @param {module:model/CreateShopScriptTagRequest} [createShopScriptTagRequest] 作成するスクリプトタグの情報
     * @param {module:api/ScriptApi~createShopScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateShopScriptTag200Response}
     */
    createShopScriptTag(opts, callback) {
      opts = opts || {};
      let postBody = opts['createShopScriptTagRequest'];
      ...
      let returnType = CreateShopScriptTag200Response;
      return this.apiClient.callApi(
        '/appstore/v1/script_tags.json', 'POST',
    ...
    /**
     * Callback function to receive the result of the deleteScriptTag operation.
     * @callback module:api/ScriptApi~deleteScriptTagCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ScriptApi~deleteScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteScriptTag(scriptTagId, callback) {
      let postBody = null;
      // verify the required parameter 'scriptTagId' is set
      if (scriptTagId === undefined || scriptTagId === null) {
        throw new Error("Missing the required parameter 'scriptTagId' when calling deleteScriptTag");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/appstore/v1/script_tags/{scriptTagId}.json', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getShopScriptTag operation.
     * @callback module:api/ScriptApi~getShopScriptTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateShopScriptTag200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {Number} scriptTagId スクリプトタグID
     * @param {module:api/ScriptApi~getShopScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateShopScriptTag200Response}
     */
    getShopScriptTag(scriptTagId, callback) {
      let postBody = null;
      // verify the required parameter 'scriptTagId' is set
      if (scriptTagId === undefined || scriptTagId === null) {
        throw new Error("Missing the required parameter 'scriptTagId' when calling getShopScriptTag");
      }
      ...
      let returnType = CreateShopScriptTag200Response;
      return this.apiClient.callApi(
        '/appstore/v1/script_tags/{scriptTagId}.json', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getShopScriptTags operation.
     * @callback module:api/ScriptApi~getShopScriptTagsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetShopScriptTags200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * スクリプトタグの取得
     * 
     * @param {module:api/ScriptApi~getShopScriptTagsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetShopScriptTags200Response}
     */
    getShopScriptTags(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetShopScriptTags200Response;
      return this.apiClient.callApi(
        '/appstore/v1/script_tags.json', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateShopScriptTag operation.
     * @callback module:api/ScriptApi~updateShopScriptTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateShopScriptTag200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateShopScriptTagRequest} [createShopScriptTagRequest] 作成するスクリプトタグの情報
     * @param {module:api/ScriptApi~updateShopScriptTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateShopScriptTag200Response}
     */
    updateShopScriptTag(scriptTagId, opts, callback) {
      opts = opts || {};
      let postBody = opts['createShopScriptTagRequest'];
      // verify the required parameter 'scriptTagId' is set
      if (scriptTagId === undefined || scriptTagId === null) {
        throw new Error("Missing the required parameter 'scriptTagId' when calling updateShopScriptTag");
      }
      ...
      let returnType = CreateShopScriptTag200Response;
      return this.apiClient.callApi(
        '/appstore/v1/script_tags/{scriptTagId}.json', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
