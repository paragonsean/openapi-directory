...
/**
 * The GetScriptTags200Response model module.
 * @module model/GetScriptTags200Response
 * @version 1.0.0
 */
class GetScriptTags200Response {
    /**
     * Constructs a new <code>GetScriptTags200Response</code>.
     * @alias module:model/GetScriptTags200Response
     */
    constructor() { 
        
        GetScriptTags200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetScriptTags200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetScriptTags200Response} obj Optional instance to populate.
     * @return {module:model/GetScriptTags200Response} The populated <code>GetScriptTags200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetScriptTags200Response();

            if (data.hasOwnProperty('script_tags')) {
                obj['script_tags'] = ApiClient.convertToType(data['script_tags'], [GetScriptTags200ResponseScriptTagsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetScriptTags200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetScriptTags200Response</code>.
     */
    static validateJSON(data) {
        if (data['script_tags']) { // data not null
            ...
            for (const item of data['script_tags']) {
                GetScriptTags200ResponseScriptTagsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/GetScriptTags200ResponseScriptTagsInner>} script_tags
 */
GetScriptTags200Response.prototype['script_tags'] = undefined;
...
export default GetScriptTags200Response;
