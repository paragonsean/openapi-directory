...
import CreateUsageChargeRequestUsageCharge from './CreateUsageChargeRequestUsageCharge';

/**
 * The CreateUsageChargeRequest model module.
 * @module model/CreateUsageChargeRequest
 * @version 1.0.0
 */
class CreateUsageChargeRequest {
    /**
     * Constructs a new <code>CreateUsageChargeRequest</code>.
     * @alias module:model/CreateUsageChargeRequest
     */
    constructor() { 
        
        CreateUsageChargeRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUsageChargeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUsageChargeRequest} obj Optional instance to populate.
     * @return {module:model/CreateUsageChargeRequest} The populated <code>CreateUsageChargeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUsageChargeRequest();

            if (data.hasOwnProperty('usage_charge')) {
                obj['usage_charge'] = CreateUsageChargeRequestUsageCharge.constructFromObject(data['usage_charge']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUsageChargeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUsageChargeRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `usage_charge`
        if (data['usage_charge']) { // data not null
          CreateUsageChargeRequestUsageCharge.validateJSON(data['usage_charge']);
        }
...
/**
 * @member {module:model/CreateUsageChargeRequestUsageCharge} usage_charge
 */
CreateUsageChargeRequest.prototype['usage_charge'] = undefined;
...
export default CreateUsageChargeRequest;
