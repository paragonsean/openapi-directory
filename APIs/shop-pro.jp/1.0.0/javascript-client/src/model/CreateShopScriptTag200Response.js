...
import GetShopScriptTags200ResponseScriptTagsInner from './GetShopScriptTags200ResponseScriptTagsInner';

/**
 * The CreateShopScriptTag200Response model module.
 * @module model/CreateShopScriptTag200Response
 * @version 1.0.0
 */
class CreateShopScriptTag200Response {
    /**
     * Constructs a new <code>CreateShopScriptTag200Response</code>.
     * @alias module:model/CreateShopScriptTag200Response
     */
    constructor() { 
        
        CreateShopScriptTag200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateShopScriptTag200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateShopScriptTag200Response} obj Optional instance to populate.
     * @return {module:model/CreateShopScriptTag200Response} The populated <code>CreateShopScriptTag200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateShopScriptTag200Response();

            if (data.hasOwnProperty('script_tag')) {
                obj['script_tag'] = GetShopScriptTags200ResponseScriptTagsInner.constructFromObject(data['script_tag']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateShopScriptTag200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateShopScriptTag200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `script_tag`
        if (data['script_tag']) { // data not null
          GetShopScriptTags200ResponseScriptTagsInner.validateJSON(data['script_tag']);
        }
...
/**
 * @member {module:model/GetShopScriptTags200ResponseScriptTagsInner} script_tag
 */
CreateShopScriptTag200Response.prototype['script_tag'] = undefined;
...
export default CreateShopScriptTag200Response;
