...
/**
 * The ShopScriptTag model module.
 * @module model/ShopScriptTag
 * @version 1.0.0
 */
class ShopScriptTag {
    /**
     * Constructs a new <code>ShopScriptTag</code>.
     * @alias module:model/ShopScriptTag
     */
    constructor() { 
        
        ShopScriptTag.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ShopScriptTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShopScriptTag} obj Optional instance to populate.
     * @return {module:model/ShopScriptTag} The populated <code>ShopScriptTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShopScriptTag();
    ...
    /**
     * Validates the JSON data with respect to <code>ShopScriptTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShopScriptTag</code>.
     */
 ...
 */
ShopScriptTag.prototype['account_id'] = undefined;

/**
 * スクリプトを出力するページ - `shop`: ショップページ - `thanks_page`: 注文完了ページ 
 * @member {module:model/ShopScriptTag.DisplayScopeEnum} display_scope
 */
ShopScriptTag.prototype['display_scope'] = undefined;

/**
 * スクリプトタグID
 * @member {Number} id
 */
ShopScriptTag.prototype['id'] = undefined;

/**
 * スクリプトファイルのハッシュ値（script tagのintegrity属性）
 * @member {String} integrity
 */
ShopScriptTag.prototype['integrity'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
ShopScriptTag.prototype['make_date'] = undefined;

/**
 * OAuthアプリケーションID
 * @member {Number} oauth_application_id
 */
ShopScriptTag.prototype['oauth_application_id'] = undefined;

/**
 * スクリプトURL
 * @member {String} src
 */
ShopScriptTag.prototype['src'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
ShopScriptTag.prototype['update_date'] = undefined;
 ...
 * @readonly
 */
ShopScriptTag['DisplayScopeEnum'] = {
