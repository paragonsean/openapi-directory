...
/**
 * The CreateScriptTagRequestScriptTag model module.
 * @module model/CreateScriptTagRequestScriptTag
 * @version 1.0.0
 */
class CreateScriptTagRequestScriptTag {
    /**
     * Constructs a new <code>CreateScriptTagRequestScriptTag</code>.
     * @alias module:model/CreateScriptTagRequestScriptTag
     */
    constructor() { 
        
        CreateScriptTagRequestScriptTag.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateScriptTagRequestScriptTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateScriptTagRequestScriptTag} obj Optional instance to populate.
     * @return {module:model/CreateScriptTagRequestScriptTag} The populated <code>CreateScriptTagRequestScriptTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateScriptTagRequestScriptTag();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateScriptTagRequestScriptTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateScriptTagRequestScriptTag</code>.
     */
 ...
 * @member {module:model/CreateScriptTagRequestScriptTag.DisplayScopeEnum} display_scope
 */
CreateScriptTagRequestScriptTag.prototype['display_scope'] = undefined;

/**
 * スクリプトURL
 * @member {String} src
 */
CreateScriptTagRequestScriptTag.prototype['src'] = undefined;
 ...
 * @readonly
 */
CreateScriptTagRequestScriptTag['DisplayScopeEnum'] = {
...
export default CreateScriptTagRequestScriptTag;
