...
/**
 * The CreateUsageChargeRequestUsageCharge model module.
 * @module model/CreateUsageChargeRequestUsageCharge
 * @version 1.0.0
 */
class CreateUsageChargeRequestUsageCharge {
    /**
     * Constructs a new <code>CreateUsageChargeRequestUsageCharge</code>.
     * @alias module:model/CreateUsageChargeRequestUsageCharge
     * @param description {String} 従量課金の発生理由。使用可能文字は ASCII, JIS X 0208, JIS X 0201, JIS X 0212に限ります。（[デベロッパー](https://developer.shop-pro.jp) ページに掲載される各アプリの「従量課金」一覧で登録内容を確認できます。カラーミーショップ側がこのパラメータを参照して課金の内容を確認することがあります。）
     * @param point {Number} ポイント数（税抜）。100 円以上 100 万円以下が指定可能。このポイントに消費税を加算してショップオーナーに請求します。
     */
    constructor(description, point) { 
        
        CreateUsageChargeRequestUsageCharge.initialize(this, description, point);
    }
     ...
     */
    static initialize(obj, description, point) { 
        obj['description'] = description;
        obj['point'] = point;
    }

    /**
     * Constructs a <code>CreateUsageChargeRequestUsageCharge</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUsageChargeRequestUsageCharge} obj Optional instance to populate.
     * @return {module:model/CreateUsageChargeRequestUsageCharge} The populated <code>CreateUsageChargeRequestUsageCharge</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUsageChargeRequestUsageCharge();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUsageChargeRequestUsageCharge</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUsageChargeRequestUsageCharge</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateUsageChargeRequestUsageCharge.RequiredProperties) {
...
CreateUsageChargeRequestUsageCharge.RequiredProperties = ["description", "point"];
 ...
 */
CreateUsageChargeRequestUsageCharge.prototype['description'] = undefined;

/**
 * ポイント数（税抜）。100 円以上 100 万円以下が指定可能。このポイントに消費税を加算してショップオーナーに請求します。
 * @member {Number} point
 */
CreateUsageChargeRequestUsageCharge.prototype['point'] = undefined;
...
export default CreateUsageChargeRequestUsageCharge;
