...
import CreateShopScriptTagRequestScriptTag from './CreateShopScriptTagRequestScriptTag';

/**
 * The CreateShopScriptTagRequest model module.
 * @module model/CreateShopScriptTagRequest
 * @version 1.0.0
 */
class CreateShopScriptTagRequest {
    /**
     * Constructs a new <code>CreateShopScriptTagRequest</code>.
     * @alias module:model/CreateShopScriptTagRequest
     */
    constructor() { 
        
        CreateShopScriptTagRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateShopScriptTagRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateShopScriptTagRequest} obj Optional instance to populate.
     * @return {module:model/CreateShopScriptTagRequest} The populated <code>CreateShopScriptTagRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateShopScriptTagRequest();

            if (data.hasOwnProperty('script_tag')) {
                obj['script_tag'] = CreateShopScriptTagRequestScriptTag.constructFromObject(data['script_tag']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateShopScriptTagRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateShopScriptTagRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `script_tag`
        if (data['script_tag']) { // data not null
          CreateShopScriptTagRequestScriptTag.validateJSON(data['script_tag']);
        }
...
/**
 * @member {module:model/CreateShopScriptTagRequestScriptTag} script_tag
 */
CreateShopScriptTagRequest.prototype['script_tag'] = undefined;
...
export default CreateShopScriptTagRequest;
