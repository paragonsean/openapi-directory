...
/**
 * The InlineScriptTag model module.
 * @module model/InlineScriptTag
 * @version 1.0.0
 */
class InlineScriptTag {
    /**
     * Constructs a new <code>InlineScriptTag</code>.
     * @alias module:model/InlineScriptTag
     */
    constructor() { 
        
        InlineScriptTag.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineScriptTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineScriptTag} obj Optional instance to populate.
     * @return {module:model/InlineScriptTag} The populated <code>InlineScriptTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineScriptTag();
    ...
    /**
     * Validates the JSON data with respect to <code>InlineScriptTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineScriptTag</code>.
     */
 ...
 */
InlineScriptTag.prototype['account_id'] = undefined;

/**
 * インラインスクリプトを出力するページ。  - `all`: カートの途中のページと注文完了ページの両方 - `thanks_page`: 注文完了ページ - `cart`: カートの途中のページ 
 * @member {module:model/InlineScriptTag.DisplayScopeEnum} display_scope
 */
InlineScriptTag.prototype['display_scope'] = undefined;

/**
 * インラインスクリプトタグID
 * @member {Number} id
 */
InlineScriptTag.prototype['id'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
InlineScriptTag.prototype['make_date'] = undefined;

/**
 * アプリID
 * @member {Number} oauth_application_id
 */
InlineScriptTag.prototype['oauth_application_id'] = undefined;

/**
 * インラインスクリプト
 * @member {String} script
 */
InlineScriptTag.prototype['script'] = undefined;

/**
 * インラインスクリプトを実行するタイミング。  - `object_builded`: JSオブジェクトの作成が完了した時 
 * @member {module:model/InlineScriptTag.TriggerEventEnum} trigger_event
 */
InlineScriptTag.prototype['trigger_event'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
InlineScriptTag.prototype['update_date'] = undefined;
 ...
 * @readonly
 */
InlineScriptTag['DisplayScopeEnum'] = {
 ...
 * @readonly
 */
InlineScriptTag['TriggerEventEnum'] = {
...
export default InlineScriptTag;
