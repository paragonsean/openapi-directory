...
import CreateScriptTagRequestScriptTag from './CreateScriptTagRequestScriptTag';

/**
 * The CreateScriptTagRequest model module.
 * @module model/CreateScriptTagRequest
 * @version 1.0.0
 */
class CreateScriptTagRequest {
    /**
     * Constructs a new <code>CreateScriptTagRequest</code>.
     * @alias module:model/CreateScriptTagRequest
     */
    constructor() { 
        
        CreateScriptTagRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateScriptTagRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateScriptTagRequest} obj Optional instance to populate.
     * @return {module:model/CreateScriptTagRequest} The populated <code>CreateScriptTagRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateScriptTagRequest();

            if (data.hasOwnProperty('script_tag')) {
                obj['script_tag'] = CreateScriptTagRequestScriptTag.constructFromObject(data['script_tag']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateScriptTagRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateScriptTagRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `script_tag`
        if (data['script_tag']) { // data not null
          CreateScriptTagRequestScriptTag.validateJSON(data['script_tag']);
        }
...
/**
 * @member {module:model/CreateScriptTagRequestScriptTag} script_tag
 */
CreateScriptTagRequest.prototype['script_tag'] = undefined;
...
export default CreateScriptTagRequest;
