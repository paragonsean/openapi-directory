...
/**
 * The PostApplicationChargeRequestApplicationCharge model module.
 * @module model/PostApplicationChargeRequestApplicationCharge
 * @version 1.0.0
 */
class PostApplicationChargeRequestApplicationCharge {
    /**
     * Constructs a new <code>PostApplicationChargeRequestApplicationCharge</code>.
     * @alias module:model/PostApplicationChargeRequestApplicationCharge
     */
    constructor() { 
        
        PostApplicationChargeRequestApplicationCharge.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostApplicationChargeRequestApplicationCharge</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostApplicationChargeRequestApplicationCharge} obj Optional instance to populate.
     * @return {module:model/PostApplicationChargeRequestApplicationCharge} The populated <code>PostApplicationChargeRequestApplicationCharge</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostApplicationChargeRequestApplicationCharge();

            if (data.hasOwnProperty('application_charge_source_id')) {
                obj['application_charge_source_id'] = ApiClient.convertToType(data['application_charge_source_id'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostApplicationChargeRequestApplicationCharge</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostApplicationChargeRequestApplicationCharge</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['application_charge_source_id'] && !(typeof data['application_charge_source_id'] === 'string' || data['application_charge_source_id'] instanceof String)) {
            throw new Error("Expected the field `application_charge_source_id` to be a primitive type in the JSON string but got " + data['application_charge_source_id']);
        }
...
/**
 * アプリ内課金ID
 * @member {String} application_charge_source_id
 */
PostApplicationChargeRequestApplicationCharge.prototype['application_charge_source_id'] = undefined;
...
export default PostApplicationChargeRequestApplicationCharge;
