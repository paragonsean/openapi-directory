...
import CreateUsageCharge201ResponseUsageCharge from './CreateUsageCharge201ResponseUsageCharge';

/**
 * The CreateUsageCharge201Response model module.
 * @module model/CreateUsageCharge201Response
 * @version 1.0.0
 */
class CreateUsageCharge201Response {
    /**
     * Constructs a new <code>CreateUsageCharge201Response</code>.
     * @alias module:model/CreateUsageCharge201Response
     */
    constructor() { 
        
        CreateUsageCharge201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUsageCharge201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUsageCharge201Response} obj Optional instance to populate.
     * @return {module:model/CreateUsageCharge201Response} The populated <code>CreateUsageCharge201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUsageCharge201Response();

            if (data.hasOwnProperty('usage_charge')) {
                obj['usage_charge'] = CreateUsageCharge201ResponseUsageCharge.constructFromObject(data['usage_charge']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUsageCharge201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUsageCharge201Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `usage_charge`
        if (data['usage_charge']) { // data not null
          CreateUsageCharge201ResponseUsageCharge.validateJSON(data['usage_charge']);
        }
...
/**
 * @member {module:model/CreateUsageCharge201ResponseUsageCharge} usage_charge
 */
CreateUsageCharge201Response.prototype['usage_charge'] = undefined;
...
export default CreateUsageCharge201Response;
