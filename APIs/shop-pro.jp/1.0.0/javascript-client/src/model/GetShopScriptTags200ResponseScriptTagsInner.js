...
/**
 * The GetShopScriptTags200ResponseScriptTagsInner model module.
 * @module model/GetShopScriptTags200ResponseScriptTagsInner
 * @version 1.0.0
 */
class GetShopScriptTags200ResponseScriptTagsInner {
    /**
     * Constructs a new <code>GetShopScriptTags200ResponseScriptTagsInner</code>.
     * @alias module:model/GetShopScriptTags200ResponseScriptTagsInner
     */
    constructor() { 
        
        GetShopScriptTags200ResponseScriptTagsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetShopScriptTags200ResponseScriptTagsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetShopScriptTags200ResponseScriptTagsInner} obj Optional instance to populate.
     * @return {module:model/GetShopScriptTags200ResponseScriptTagsInner} The populated <code>GetShopScriptTags200ResponseScriptTagsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetShopScriptTags200ResponseScriptTagsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>GetShopScriptTags200ResponseScriptTagsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetShopScriptTags200ResponseScriptTagsInner</code>.
     */
 ...
 */
GetShopScriptTags200ResponseScriptTagsInner.prototype['account_id'] = undefined;

/**
 * スクリプトを出力するページ - `shop`: ショップページ - `thanks_page`: 注文完了ページ 
 * @member {module:model/GetShopScriptTags200ResponseScriptTagsInner.DisplayScopeEnum} display_scope
 */
GetShopScriptTags200ResponseScriptTagsInner.prototype['display_scope'] = undefined;

/**
 * スクリプトタグID
 * @member {Number} id
 */
GetShopScriptTags200ResponseScriptTagsInner.prototype['id'] = undefined;

/**
 * スクリプトファイルのハッシュ値（script tagのintegrity属性）
 * @member {String} integrity
 */
GetShopScriptTags200ResponseScriptTagsInner.prototype['integrity'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
GetShopScriptTags200ResponseScriptTagsInner.prototype['make_date'] = undefined;

/**
 * OAuthアプリケーションID
 * @member {Number} oauth_application_id
 */
GetShopScriptTags200ResponseScriptTagsInner.prototype['oauth_application_id'] = undefined;

/**
 * スクリプトURL
 * @member {String} src
 */
GetShopScriptTags200ResponseScriptTagsInner.prototype['src'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
GetShopScriptTags200ResponseScriptTagsInner.prototype['update_date'] = undefined;
 ...
 * @readonly
 */
GetShopScriptTags200ResponseScriptTagsInner['DisplayScopeEnum'] = {
...
export default GetShopScriptTags200ResponseScriptTagsInner;
