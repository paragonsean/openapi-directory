...
/**
 * The CreateUsageCharge201ResponseUsageCharge model module.
 * @module model/CreateUsageCharge201ResponseUsageCharge
 * @version 1.0.0
 */
class CreateUsageCharge201ResponseUsageCharge {
    /**
     * Constructs a new <code>CreateUsageCharge201ResponseUsageCharge</code>.
     * @alias module:model/CreateUsageCharge201ResponseUsageCharge
     */
    constructor() { 
        
        CreateUsageCharge201ResponseUsageCharge.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUsageCharge201ResponseUsageCharge</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUsageCharge201ResponseUsageCharge} obj Optional instance to populate.
     * @return {module:model/CreateUsageCharge201ResponseUsageCharge} The populated <code>CreateUsageCharge201ResponseUsageCharge</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUsageCharge201ResponseUsageCharge();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUsageCharge201ResponseUsageCharge</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUsageCharge201ResponseUsageCharge</code>.
     */
 ...
 */
CreateUsageCharge201ResponseUsageCharge.prototype['description'] = undefined;

/**
 * 従量課金ID
 * @member {String} id
 */
CreateUsageCharge201ResponseUsageCharge.prototype['id'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
CreateUsageCharge201ResponseUsageCharge.prototype['make_date'] = undefined;

/**
 * ポイント請求額(税抜)
 * @member {Number} point
 */
CreateUsageCharge201ResponseUsageCharge.prototype['point'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
CreateUsageCharge201ResponseUsageCharge.prototype['update_date'] = undefined;
...
export default CreateUsageCharge201ResponseUsageCharge;
