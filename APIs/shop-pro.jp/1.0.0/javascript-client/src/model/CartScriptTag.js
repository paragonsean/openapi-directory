...
/**
 * The CartScriptTag model module.
 * @module model/CartScriptTag
 * @version 1.0.0
 */
class CartScriptTag {
    /**
     * Constructs a new <code>CartScriptTag</code>.
     * @alias module:model/CartScriptTag
     */
    constructor() { 
        
        CartScriptTag.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CartScriptTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CartScriptTag} obj Optional instance to populate.
     * @return {module:model/CartScriptTag} The populated <code>CartScriptTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CartScriptTag();
    ...
    /**
     * Validates the JSON data with respect to <code>CartScriptTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CartScriptTag</code>.
     */
 ...
 */
CartScriptTag.prototype['account_id'] = undefined;

/**
 * スクリプトタグID
 * @member {Number} id
 */
CartScriptTag.prototype['id'] = undefined;

/**
 * スクリプトファイルのハッシュ値（script tagのintegrity属性）
 * @member {String} integrity
 */
CartScriptTag.prototype['integrity'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
CartScriptTag.prototype['make_date'] = undefined;

/**
 * OAuthアプリケーションID
 * @member {Number} oauth_application_id
 */
CartScriptTag.prototype['oauth_application_id'] = undefined;

/**
 * スクリプトURL
 * @member {String} src
 */
CartScriptTag.prototype['src'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
CartScriptTag.prototype['update_date'] = undefined;
