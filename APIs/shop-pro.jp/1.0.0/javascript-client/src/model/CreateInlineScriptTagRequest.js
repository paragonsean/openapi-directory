...
import CreateInlineScriptTagRequestInlineScriptTag from './CreateInlineScriptTagRequestInlineScriptTag';

/**
 * The CreateInlineScriptTagRequest model module.
 * @module model/CreateInlineScriptTagRequest
 * @version 1.0.0
 */
class CreateInlineScriptTagRequest {
    /**
     * Constructs a new <code>CreateInlineScriptTagRequest</code>.
     * @alias module:model/CreateInlineScriptTagRequest
     */
    constructor() { 
        
        CreateInlineScriptTagRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateInlineScriptTagRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateInlineScriptTagRequest} obj Optional instance to populate.
     * @return {module:model/CreateInlineScriptTagRequest} The populated <code>CreateInlineScriptTagRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateInlineScriptTagRequest();

            if (data.hasOwnProperty('inline_script_tag')) {
                obj['inline_script_tag'] = CreateInlineScriptTagRequestInlineScriptTag.constructFromObject(data['inline_script_tag']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateInlineScriptTagRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateInlineScriptTagRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `inline_script_tag`
        if (data['inline_script_tag']) { // data not null
          CreateInlineScriptTagRequestInlineScriptTag.validateJSON(data['inline_script_tag']);
        }
...
/**
 * @member {module:model/CreateInlineScriptTagRequestInlineScriptTag} inline_script_tag
 */
CreateInlineScriptTagRequest.prototype['inline_script_tag'] = undefined;
...
export default CreateInlineScriptTagRequest;
