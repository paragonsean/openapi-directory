...
/**
 * The CreateInlineScriptTag201Response model module.
 * @module model/CreateInlineScriptTag201Response
 * @version 1.0.0
 */
class CreateInlineScriptTag201Response {
    /**
     * Constructs a new <code>CreateInlineScriptTag201Response</code>.
     * @alias module:model/CreateInlineScriptTag201Response
     */
    constructor() { 
        
        CreateInlineScriptTag201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateInlineScriptTag201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateInlineScriptTag201Response} obj Optional instance to populate.
     * @return {module:model/CreateInlineScriptTag201Response} The populated <code>CreateInlineScriptTag201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateInlineScriptTag201Response();

            if (data.hasOwnProperty('inline_script_tag')) {
                obj['inline_script_tag'] = GetInlineScriptTags200ResponseInlineScriptTagsInner.constructFromObject(data['inline_script_tag']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateInlineScriptTag201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateInlineScriptTag201Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `inline_script_tag`
        if (data['inline_script_tag']) { // data not null
          GetInlineScriptTags200ResponseInlineScriptTagsInner.validateJSON(data['inline_script_tag']);
        }
...
/**
 * @member {module:model/GetInlineScriptTags200ResponseInlineScriptTagsInner} inline_script_tag
 */
CreateInlineScriptTag201Response.prototype['inline_script_tag'] = undefined;
...
export default CreateInlineScriptTag201Response;
