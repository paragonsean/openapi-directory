...
/**
 * The GetScriptTags200ResponseScriptTagsInner model module.
 * @module model/GetScriptTags200ResponseScriptTagsInner
 * @version 1.0.0
 */
class GetScriptTags200ResponseScriptTagsInner {
    /**
     * Constructs a new <code>GetScriptTags200ResponseScriptTagsInner</code>.
     * @alias module:model/GetScriptTags200ResponseScriptTagsInner
     */
    constructor() { 
        
        GetScriptTags200ResponseScriptTagsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetScriptTags200ResponseScriptTagsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetScriptTags200ResponseScriptTagsInner} obj Optional instance to populate.
     * @return {module:model/GetScriptTags200ResponseScriptTagsInner} The populated <code>GetScriptTags200ResponseScriptTagsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetScriptTags200ResponseScriptTagsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>GetScriptTags200ResponseScriptTagsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetScriptTags200ResponseScriptTagsInner</code>.
     */
 ...
 * @member {module:model/GetScriptTags200ResponseScriptTagsInner.DisplayScopeEnum} display_scope
 */
GetScriptTags200ResponseScriptTagsInner.prototype['display_scope'] = undefined;

/**
 * スクリプトタグID
 * @member {Number} id
 */
GetScriptTags200ResponseScriptTagsInner.prototype['id'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
GetScriptTags200ResponseScriptTagsInner.prototype['make_date'] = undefined;

/**
 * スクリプトURL
 * @member {String} src
 */
GetScriptTags200ResponseScriptTagsInner.prototype['src'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
GetScriptTags200ResponseScriptTagsInner.prototype['update_date'] = undefined;
 ...
 * @readonly
 */
GetScriptTags200ResponseScriptTagsInner['DisplayScopeEnum'] = {
...
export default GetScriptTags200ResponseScriptTagsInner;
