...
import GetInlineScriptTags200ResponseInlineScriptTagsInner from './GetInlineScriptTags200ResponseInlineScriptTagsInner';

/**
 * The GetInlineScriptTags200Response model module.
 * @module model/GetInlineScriptTags200Response
 * @version 1.0.0
 */
class GetInlineScriptTags200Response {
    /**
     * Constructs a new <code>GetInlineScriptTags200Response</code>.
     * @alias module:model/GetInlineScriptTags200Response
     */
    constructor() { 
        
        GetInlineScriptTags200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetInlineScriptTags200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetInlineScriptTags200Response} obj Optional instance to populate.
     * @return {module:model/GetInlineScriptTags200Response} The populated <code>GetInlineScriptTags200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetInlineScriptTags200Response();

            if (data.hasOwnProperty('inline_script_tags')) {
                obj['inline_script_tags'] = ApiClient.convertToType(data['inline_script_tags'], [GetInlineScriptTags200ResponseInlineScriptTagsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetInlineScriptTags200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetInlineScriptTags200Response</code>.
     */
    static validateJSON(data) {
        if (data['inline_script_tags']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['inline_script_tags'])) {
                throw new Error("Expected the field `inline_script_tags` to be an array in the JSON data but got " + data['inline_script_tags']);
            }
            // validate the optional field `inline_script_tags` (array)
            for (const item of data['inline_script_tags']) {
                GetInlineScriptTags200ResponseInlineScriptTagsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/GetInlineScriptTags200ResponseInlineScriptTagsInner>} inline_script_tags
 */
GetInlineScriptTags200Response.prototype['inline_script_tags'] = undefined;
...
export default GetInlineScriptTags200Response;
