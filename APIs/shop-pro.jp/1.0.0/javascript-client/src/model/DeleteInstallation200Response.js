...
import DeleteInstallation200ResponseUsageCharge from './DeleteInstallation200ResponseUsageCharge';

/**
 * The DeleteInstallation200Response model module.
 * @module model/DeleteInstallation200Response
 * @version 1.0.0
 */
class DeleteInstallation200Response {
    /**
     * Constructs a new <code>DeleteInstallation200Response</code>.
     * @alias module:model/DeleteInstallation200Response
     */
    constructor() { 
        
        DeleteInstallation200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteInstallation200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteInstallation200Response} obj Optional instance to populate.
     * @return {module:model/DeleteInstallation200Response} The populated <code>DeleteInstallation200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteInstallation200Response();
            ...
            if (data.hasOwnProperty('recurring_application_charge_id')) {
                obj['recurring_application_charge_id'] = ApiClient.convertToType(data['recurring_application_charge_id'], 'String');
            }
            if (data.hasOwnProperty('uninstalled_at')) {
                obj['uninstalled_at'] = ApiClient.convertToType(data['uninstalled_at'], 'Number');
            }
            if (data.hasOwnProperty('usage_charge')) {
                obj['usage_charge'] = DeleteInstallation200ResponseUsageCharge.constructFromObject(data['usage_charge']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteInstallation200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteInstallation200Response</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['recurring_application_charge_id'] && !(typeof data['recurring_application_charge_id'] === 'string' || data['recurring_application_charge_id'] instanceof String)) {
            throw new Error("Expected the field `recurring_application_charge_id` to be a primitive type in the JSON string but got " + data['recurring_application_charge_id']);
        }
        // validate the optional field `usage_charge`
        if (data['usage_charge']) { // data not null
          DeleteInstallation200ResponseUsageCharge.validateJSON(data['usage_charge']);
        }
 ...
 */
DeleteInstallation200Response.prototype['account_id'] = undefined;

/**
 * プラン課金ID
 * @member {String} application_charge_source_id
 */
DeleteInstallation200Response.prototype['application_charge_source_id'] = undefined;

/**
 * （買い切り以外の課金の場合）課金契約ID
 * @member {String} recurring_application_charge_id
 */
DeleteInstallation200Response.prototype['recurring_application_charge_id'] = undefined;

/**
 * アンインストール日時
 * @member {Number} uninstalled_at
 */
DeleteInstallation200Response.prototype['uninstalled_at'] = undefined;

/**
 * @member {module:model/DeleteInstallation200ResponseUsageCharge} usage_charge
 */
DeleteInstallation200Response.prototype['usage_charge'] = undefined;
...
export default DeleteInstallation200Response;
