...
/**
 * The GetInlineScriptTags200ResponseInlineScriptTagsInner model module.
 * @module model/GetInlineScriptTags200ResponseInlineScriptTagsInner
 * @version 1.0.0
 */
class GetInlineScriptTags200ResponseInlineScriptTagsInner {
    /**
     * Constructs a new <code>GetInlineScriptTags200ResponseInlineScriptTagsInner</code>.
     * @alias module:model/GetInlineScriptTags200ResponseInlineScriptTagsInner
     */
    constructor() { 
        
        GetInlineScriptTags200ResponseInlineScriptTagsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetInlineScriptTags200ResponseInlineScriptTagsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetInlineScriptTags200ResponseInlineScriptTagsInner} obj Optional instance to populate.
     * @return {module:model/GetInlineScriptTags200ResponseInlineScriptTagsInner} The populated <code>GetInlineScriptTags200ResponseInlineScriptTagsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetInlineScriptTags200ResponseInlineScriptTagsInner();

            if (data.hasOwnProperty('account_id')) {
                obj['account_id'] = ApiClient.convertToType(data['account_id'], 'String');
            }
            if (data.hasOwnProperty('display_scope')) {
                obj['display_scope'] = ApiClient.convertToType(data['display_scope'], 'String');
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'Number');
            }
            if (data.hasOwnProperty('make_date')) {
                obj['make_date'] = ApiClient.convertToType(data['make_date'], 'Number');
            }
            if (data.hasOwnProperty('oauth_application_id')) {
                obj['oauth_application_id'] = ApiClient.convertToType(data['oauth_application_id'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetInlineScriptTags200ResponseInlineScriptTagsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetInlineScriptTags200ResponseInlineScriptTagsInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['display_scope'] && !(typeof data['display_scope'] === 'string' || data['display_scope'] instanceof String)) {
            throw new Error("Expected the field `display_scope` to be a primitive type in the JSON string but got " + data['display_scope']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['trigger_event'] && !(typeof data['trigger_event'] === 'string' || data['trigger_event'] instanceof String)) {
            throw new Error("Expected the field `trigger_event` to be a primitive type in the JSON string but got " + data['trigger_event']);
        }
 ...
 */
GetInlineScriptTags200ResponseInlineScriptTagsInner.prototype['account_id'] = undefined;

/**
 * インラインスクリプトを出力するページ。  - `all`: カートの途中のページと注文完了ページの両方 - `thanks_page`: 注文完了ページ - `cart`: カートの途中のページ 
 * @member {module:model/GetInlineScriptTags200ResponseInlineScriptTagsInner.DisplayScopeEnum} display_scope
 */
GetInlineScriptTags200ResponseInlineScriptTagsInner.prototype['display_scope'] = undefined;

/**
 * インラインスクリプトタグID
 * @member {Number} id
 */
GetInlineScriptTags200ResponseInlineScriptTagsInner.prototype['id'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
GetInlineScriptTags200ResponseInlineScriptTagsInner.prototype['make_date'] = undefined;

/**
 * アプリID
 * @member {Number} oauth_application_id
 */
GetInlineScriptTags200ResponseInlineScriptTagsInner.prototype['oauth_application_id'] = undefined;

/**
 * インラインスクリプト
 * @member {String} script
 */
GetInlineScriptTags200ResponseInlineScriptTagsInner.prototype['script'] = undefined;

/**
 * インラインスクリプトを実行するタイミング。  - `object_builded`: JSオブジェクトの作成が完了した時 
 * @member {module:model/GetInlineScriptTags200ResponseInlineScriptTagsInner.TriggerEventEnum} trigger_event
 */
GetInlineScriptTags200ResponseInlineScriptTagsInner.prototype['trigger_event'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
GetInlineScriptTags200ResponseInlineScriptTagsInner.prototype['update_date'] = undefined;
...
/**
 * Allowed values for the <code>display_scope</code> property.
 * @enum {String}
 * @readonly
 */
GetInlineScriptTags200ResponseInlineScriptTagsInner['DisplayScopeEnum'] = {
 ...
 * @readonly
 */
GetInlineScriptTags200ResponseInlineScriptTagsInner['TriggerEventEnum'] = {

    /**
     * value: "object_builded"
     * @const
     */
...
export default GetInlineScriptTags200ResponseInlineScriptTagsInner;
