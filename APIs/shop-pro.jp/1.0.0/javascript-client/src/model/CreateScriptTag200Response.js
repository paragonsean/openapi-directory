...
import GetScriptTags200ResponseScriptTagsInner from './GetScriptTags200ResponseScriptTagsInner';

/**
 * The CreateScriptTag200Response model module.
 * @module model/CreateScriptTag200Response
 * @version 1.0.0
 */
class CreateScriptTag200Response {
    /**
     * Constructs a new <code>CreateScriptTag200Response</code>.
     * @alias module:model/CreateScriptTag200Response
     */
    constructor() { 
        
        CreateScriptTag200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateScriptTag200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateScriptTag200Response} obj Optional instance to populate.
     * @return {module:model/CreateScriptTag200Response} The populated <code>CreateScriptTag200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateScriptTag200Response();

            if (data.hasOwnProperty('script_tag')) {
                obj['script_tag'] = GetScriptTags200ResponseScriptTagsInner.constructFromObject(data['script_tag']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateScriptTag200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateScriptTag200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `script_tag`
        if (data['script_tag']) { // data not null
          GetScriptTags200ResponseScriptTagsInner.validateJSON(data['script_tag']);
        }
...
/**
 * @member {module:model/GetScriptTags200ResponseScriptTagsInner} script_tag
 */
CreateScriptTag200Response.prototype['script_tag'] = undefined;
...
export default CreateScriptTag200Response;
