...
/**
 * The UsageCharge model module.
 * @module model/UsageCharge
 * @version 1.0.0
 */
class UsageCharge {
    /**
     * Constructs a new <code>UsageCharge</code>.
     * @alias module:model/UsageCharge
     */
    constructor() { 
        
        UsageCharge.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UsageCharge</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UsageCharge} obj Optional instance to populate.
     * @return {module:model/UsageCharge} The populated <code>UsageCharge</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsageCharge();
    ...
    /**
     * Validates the JSON data with respect to <code>UsageCharge</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsageCharge</code>.
     */
 ...
 */
UsageCharge.prototype['description'] = undefined;

/**
 * 従量課金ID
 * @member {String} id
 */
UsageCharge.prototype['id'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
UsageCharge.prototype['make_date'] = undefined;

/**
 * ポイント請求額(税抜)
 * @member {Number} point
 */
UsageCharge.prototype['point'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
UsageCharge.prototype['update_date'] = undefined;
