...
/**
 * The DeleteInstallation200ResponseUsageCharge model module.
 * @module model/DeleteInstallation200ResponseUsageCharge
 * @version 1.0.0
 */
class DeleteInstallation200ResponseUsageCharge {
    /**
     * Constructs a new <code>DeleteInstallation200ResponseUsageCharge</code>.
     * （従量課金の場合）従量課金アンインストール情報
     * @alias module:model/DeleteInstallation200ResponseUsageCharge
     */
    constructor() { 
        
        DeleteInstallation200ResponseUsageCharge.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteInstallation200ResponseUsageCharge</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteInstallation200ResponseUsageCharge} obj Optional instance to populate.
     * @return {module:model/DeleteInstallation200ResponseUsageCharge} The populated <code>DeleteInstallation200ResponseUsageCharge</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteInstallation200ResponseUsageCharge();

            if (data.hasOwnProperty('api_token')) {
                obj['api_token'] = ApiClient.convertToType(data['api_token'], 'String');
            }
            if (data.hasOwnProperty('closing_on')) {
                obj['closing_on'] = ApiClient.convertToType(data['closing_on'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteInstallation200ResponseUsageCharge</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteInstallation200ResponseUsageCharge</code>.
     */
 ...
 */
DeleteInstallation200ResponseUsageCharge.prototype['api_token'] = undefined;

/**
 * ポイント締め日
 * @member {Number} closing_on
 */
DeleteInstallation200ResponseUsageCharge.prototype['closing_on'] = undefined;
...
export default DeleteInstallation200ResponseUsageCharge;
