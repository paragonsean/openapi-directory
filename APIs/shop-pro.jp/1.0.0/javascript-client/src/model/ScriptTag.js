...
/**
 * The ScriptTag model module.
 * @module model/ScriptTag
 * @version 1.0.0
 */
class ScriptTag {
    /**
     * Constructs a new <code>ScriptTag</code>.
     * @alias module:model/ScriptTag
     */
    constructor() { 
        
        ScriptTag.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScriptTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScriptTag} obj Optional instance to populate.
     * @return {module:model/ScriptTag} The populated <code>ScriptTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScriptTag();
    ...
    /**
     * Validates the JSON data with respect to <code>ScriptTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScriptTag</code>.
     */
 ...
 * @member {module:model/ScriptTag.DisplayScopeEnum} display_scope
 */
ScriptTag.prototype['display_scope'] = undefined;

/**
 * スクリプトタグID
 * @member {Number} id
 */
ScriptTag.prototype['id'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
ScriptTag.prototype['make_date'] = undefined;

/**
 * スクリプトURL
 * @member {String} src
 */
ScriptTag.prototype['src'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
ScriptTag.prototype['update_date'] = undefined;
