...
/**
 * The CreateInlineScriptTagRequestInlineScriptTag model module.
 * @module model/CreateInlineScriptTagRequestInlineScriptTag
 * @version 1.0.0
 */
class CreateInlineScriptTagRequestInlineScriptTag {
    /**
     * Constructs a new <code>CreateInlineScriptTagRequestInlineScriptTag</code>.
     * @alias module:model/CreateInlineScriptTagRequestInlineScriptTag
     */
    constructor() { 
        
        CreateInlineScriptTagRequestInlineScriptTag.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateInlineScriptTagRequestInlineScriptTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateInlineScriptTagRequestInlineScriptTag} obj Optional instance to populate.
     * @return {module:model/CreateInlineScriptTagRequestInlineScriptTag} The populated <code>CreateInlineScriptTagRequestInlineScriptTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateInlineScriptTagRequestInlineScriptTag();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateInlineScriptTagRequestInlineScriptTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateInlineScriptTagRequestInlineScriptTag</code>.
     */
 ...
 * @member {module:model/CreateInlineScriptTagRequestInlineScriptTag.DisplayScopeEnum} display_scope
 */
CreateInlineScriptTagRequestInlineScriptTag.prototype['display_scope'] = undefined;

/**
 * インラインスクリプト
 * @member {String} script
 */
CreateInlineScriptTagRequestInlineScriptTag.prototype['script'] = undefined;

/**
 * インラインスクリプトを実行するタイミング。  - `object_builded`: JSオブジェクトの作成が完了した時 
 * @member {module:model/CreateInlineScriptTagRequestInlineScriptTag.TriggerEventEnum} trigger_event
 */
CreateInlineScriptTagRequestInlineScriptTag.prototype['trigger_event'] = undefined;
 ...
 * @readonly
 */
CreateInlineScriptTagRequestInlineScriptTag['DisplayScopeEnum'] = {
 ...
 * @readonly
 */
CreateInlineScriptTagRequestInlineScriptTag['TriggerEventEnum'] = {
...
export default CreateInlineScriptTagRequestInlineScriptTag;
