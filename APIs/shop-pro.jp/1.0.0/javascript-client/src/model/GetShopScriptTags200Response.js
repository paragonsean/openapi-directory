...
/**
 * The GetShopScriptTags200Response model module.
 * @module model/GetShopScriptTags200Response
 * @version 1.0.0
 */
class GetShopScriptTags200Response {
    /**
     * Constructs a new <code>GetShopScriptTags200Response</code>.
     * @alias module:model/GetShopScriptTags200Response
     */
    constructor() { 
        
        GetShopScriptTags200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetShopScriptTags200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetShopScriptTags200Response} obj Optional instance to populate.
     * @return {module:model/GetShopScriptTags200Response} The populated <code>GetShopScriptTags200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetShopScriptTags200Response();

            if (data.hasOwnProperty('script_tags')) {
                obj['script_tags'] = ApiClient.convertToType(data['script_tags'], [GetShopScriptTags200ResponseScriptTagsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetShopScriptTags200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetShopScriptTags200Response</code>.
     */
    static validateJSON(data) {
        if (data['script_tags']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['script_tags'])) {
                throw new Error("Expected the field `script_tags` to be an array in the JSON data but got " + data['script_tags']);
            }
            // validate the optional field `script_tags` (array)
            for (const item of data['script_tags']) {
                GetShopScriptTags200ResponseScriptTagsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/GetShopScriptTags200ResponseScriptTagsInner>} script_tags
 */
GetShopScriptTags200Response.prototype['script_tags'] = undefined;
...
export default GetShopScriptTags200Response;
