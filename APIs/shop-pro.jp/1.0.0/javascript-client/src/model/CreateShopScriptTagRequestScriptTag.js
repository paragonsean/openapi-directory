...
/**
 * The CreateShopScriptTagRequestScriptTag model module.
 * @module model/CreateShopScriptTagRequestScriptTag
 * @version 1.0.0
 */
class CreateShopScriptTagRequestScriptTag {
    /**
     * Constructs a new <code>CreateShopScriptTagRequestScriptTag</code>.
     * @alias module:model/CreateShopScriptTagRequestScriptTag
     */
    constructor() { 
        
        CreateShopScriptTagRequestScriptTag.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateShopScriptTagRequestScriptTag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateShopScriptTagRequestScriptTag} obj Optional instance to populate.
     * @return {module:model/CreateShopScriptTagRequestScriptTag} The populated <code>CreateShopScriptTagRequestScriptTag</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateShopScriptTagRequestScriptTag();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateShopScriptTagRequestScriptTag</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateShopScriptTagRequestScriptTag</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['integrity'] && !(typeof data['integrity'] === 'string' || data['integrity'] instanceof String)) {
            throw new Error("Expected the field `integrity` to be a primitive type in the JSON string but got " + data['integrity']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/CreateShopScriptTagRequestScriptTag.DisplayScopeEnum} display_scope
 */
CreateShopScriptTagRequestScriptTag.prototype['display_scope'] = undefined;
 ...
 */
CreateShopScriptTagRequestScriptTag.prototype['integrity'] = undefined;

/**
 * スクリプトURL
 * @member {String} src
 */
CreateShopScriptTagRequestScriptTag.prototype['src'] = undefined;
 ...
 * @readonly
 */
CreateShopScriptTagRequestScriptTag['DisplayScopeEnum'] = {
...
export default CreateShopScriptTagRequestScriptTag;
