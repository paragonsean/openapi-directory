...
import PostApplicationChargeRequestApplicationCharge from './PostApplicationChargeRequestApplicationCharge';

/**
 * The PostApplicationChargeRequest model module.
 * @module model/PostApplicationChargeRequest
 * @version 1.0.0
 */
class PostApplicationChargeRequest {
    /**
     * Constructs a new <code>PostApplicationChargeRequest</code>.
     * @alias module:model/PostApplicationChargeRequest
     */
    constructor() { 
        
        PostApplicationChargeRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostApplicationChargeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostApplicationChargeRequest} obj Optional instance to populate.
     * @return {module:model/PostApplicationChargeRequest} The populated <code>PostApplicationChargeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostApplicationChargeRequest();

            if (data.hasOwnProperty('application_charge')) {
                obj['application_charge'] = PostApplicationChargeRequestApplicationCharge.constructFromObject(data['application_charge']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostApplicationChargeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostApplicationChargeRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `application_charge`
        if (data['application_charge']) { // data not null
          PostApplicationChargeRequestApplicationCharge.validateJSON(data['application_charge']);
        }
...
/**
 * @member {module:model/PostApplicationChargeRequestApplicationCharge} application_charge
 */
PostApplicationChargeRequest.prototype['application_charge'] = undefined;
...
export default PostApplicationChargeRequest;
