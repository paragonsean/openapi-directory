...
/**
 * The PostApplicationCharge201ResponseApplicationCharge model module.
 * @module model/PostApplicationCharge201ResponseApplicationCharge
 * @version 1.0.0
 */
class PostApplicationCharge201ResponseApplicationCharge {
    /**
     * Constructs a new <code>PostApplicationCharge201ResponseApplicationCharge</code>.
     * @alias module:model/PostApplicationCharge201ResponseApplicationCharge
     */
    constructor() { 
        
        PostApplicationCharge201ResponseApplicationCharge.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostApplicationCharge201ResponseApplicationCharge</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostApplicationCharge201ResponseApplicationCharge} obj Optional instance to populate.
     * @return {module:model/PostApplicationCharge201ResponseApplicationCharge} The populated <code>PostApplicationCharge201ResponseApplicationCharge</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostApplicationCharge201ResponseApplicationCharge();
    ...
    /**
     * Validates the JSON data with respect to <code>PostApplicationCharge201ResponseApplicationCharge</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostApplicationCharge201ResponseApplicationCharge</code>.
     */
 ...
 * @member {String} id
 */
PostApplicationCharge201ResponseApplicationCharge.prototype['id'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
PostApplicationCharge201ResponseApplicationCharge.prototype['make_date'] = undefined;

/**
 * ポイント請求額(税抜)
 * @member {Number} point
 */
PostApplicationCharge201ResponseApplicationCharge.prototype['point'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
PostApplicationCharge201ResponseApplicationCharge.prototype['update_date'] = undefined;
...
export default PostApplicationCharge201ResponseApplicationCharge;
