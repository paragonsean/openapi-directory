...
import PostApplicationCharge201ResponseApplicationCharge from './PostApplicationCharge201ResponseApplicationCharge';

/**
 * The PostApplicationCharge201Response model module.
 * @module model/PostApplicationCharge201Response
 * @version 1.0.0
 */
class PostApplicationCharge201Response {
    /**
     * Constructs a new <code>PostApplicationCharge201Response</code>.
     * @alias module:model/PostApplicationCharge201Response
     */
    constructor() { 
        
        PostApplicationCharge201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostApplicationCharge201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostApplicationCharge201Response} obj Optional instance to populate.
     * @return {module:model/PostApplicationCharge201Response} The populated <code>PostApplicationCharge201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostApplicationCharge201Response();

            if (data.hasOwnProperty('application_charge')) {
                obj['application_charge'] = PostApplicationCharge201ResponseApplicationCharge.constructFromObject(data['application_charge']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostApplicationCharge201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostApplicationCharge201Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `application_charge`
        if (data['application_charge']) { // data not null
          PostApplicationCharge201ResponseApplicationCharge.validateJSON(data['application_charge']);
        }
...
/**
 * @member {module:model/PostApplicationCharge201ResponseApplicationCharge} application_charge
 */
PostApplicationCharge201Response.prototype['application_charge'] = undefined;
...
export default PostApplicationCharge201Response;
