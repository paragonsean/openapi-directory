...
/**
 * The ApplicationCharge model module.
 * @module model/ApplicationCharge
 * @version 1.0.0
 */
class ApplicationCharge {
    /**
     * Constructs a new <code>ApplicationCharge</code>.
     * @alias module:model/ApplicationCharge
     */
    constructor() { 
        
        ApplicationCharge.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApplicationCharge</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationCharge} obj Optional instance to populate.
     * @return {module:model/ApplicationCharge} The populated <code>ApplicationCharge</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationCharge();
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationCharge</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationCharge</code>.
     */
 ...
 * @member {String} id
 */
ApplicationCharge.prototype['id'] = undefined;

/**
 * 作成日時
 * @member {Number} make_date
 */
ApplicationCharge.prototype['make_date'] = undefined;

/**
 * ポイント請求額(税抜)
 * @member {Number} point
 */
ApplicationCharge.prototype['point'] = undefined;

/**
 * 更新日時
 * @member {Number} update_date
 */
ApplicationCharge.prototype['update_date'] = undefined;
