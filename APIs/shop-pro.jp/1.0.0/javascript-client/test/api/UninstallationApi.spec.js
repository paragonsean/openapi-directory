...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.UninstallationApi();
  });
  ...
  describe('UninstallationApi', function() {
    describe('deleteInstallation', function() {
      it('should call deleteInstallation successfully', function(done) {
        //uncomment below and update the code to test deleteInstallation
        //instance.deleteInstallation(function(error) {
