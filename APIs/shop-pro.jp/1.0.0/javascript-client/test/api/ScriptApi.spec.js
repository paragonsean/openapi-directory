...
(function(root, factory) {
  ...
  describe('ScriptApi', function() {
    describe('createShopScriptTag', function() {
      it('should call createShopScriptTag successfully', function(done) {
        //uncomment below and update the code to test createShopScriptTag
        //instance.createShopScriptTag(function(error) {
    ...
    describe('deleteScriptTag', function() {
      it('should call deleteScriptTag successfully', function(done) {
        //uncomment below and update the code to test deleteScriptTag
        //instance.deleteScriptTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getShopScriptTag', function() {
      it('should call getShopScriptTag successfully', function(done) {
        //uncomment below and update the code to test getShopScriptTag
        //instance.getShopScriptTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getShopScriptTags', function() {
      it('should call getShopScriptTags successfully', function(done) {
        //uncomment below and update the code to test getShopScriptTags
        //instance.getShopScriptTags(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateShopScriptTag', function() {
      it('should call updateShopScriptTag successfully', function(done) {
        //uncomment below and update the code to test updateShopScriptTag
        //instance.updateShopScriptTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
