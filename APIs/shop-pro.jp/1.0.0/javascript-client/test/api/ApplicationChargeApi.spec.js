...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.ApplicationChargeApi();
  });
  ...
  describe('ApplicationChargeApi', function() {
    describe('createUsageCharge', function() {
      it('should call createUsageCharge successfully', function(done) {
        //uncomment below and update the code to test createUsageCharge
        //instance.createUsageCharge(function(error) {
    ...
    describe('postApplicationCharge', function() {
      it('should call postApplicationCharge successfully', function(done) {
        //uncomment below and update the code to test postApplicationCharge
        //instance.postApplicationCharge(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
