...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.ScriptDeprecatedApi();
  });
  ...
  describe('ScriptDeprecatedApi', function() {
    describe('createScriptTag', function() {
      it('should call createScriptTag successfully', function(done) {
        //uncomment below and update the code to test createScriptTag
        //instance.createScriptTag(function(error) {
    ...
    describe('getScriptTag', function() {
      it('should call getScriptTag successfully', function(done) {
        //uncomment below and update the code to test getScriptTag
        //instance.getScriptTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getScriptTags', function() {
      it('should call getScriptTags successfully', function(done) {
        //uncomment below and update the code to test getScriptTags
        //instance.getScriptTags(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateScriptTag', function() {
      it('should call updateScriptTag successfully', function(done) {
        //uncomment below and update the code to test updateScriptTag
        //instance.updateScriptTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('v1ScriptTagsScriptTagIdJsonDelete', function() {
      it('should call v1ScriptTagsScriptTagIdJsonDelete successfully', function(done) {
        //uncomment below and update the code to test v1ScriptTagsScriptTagIdJsonDelete
        //instance.v1ScriptTagsScriptTagIdJsonDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
