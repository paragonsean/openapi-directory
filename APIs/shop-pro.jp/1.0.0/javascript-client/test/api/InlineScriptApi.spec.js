...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.InlineScriptApi();
  });
  ...
  describe('InlineScriptApi', function() {
    describe('createInlineScriptTag', function() {
      it('should call createInlineScriptTag successfully', function(done) {
        //uncomment below and update the code to test createInlineScriptTag
        //instance.createInlineScriptTag(function(error) {
    ...
    describe('deleteInlineScriptTag', function() {
      it('should call deleteInlineScriptTag successfully', function(done) {
        //uncomment below and update the code to test deleteInlineScriptTag
        //instance.deleteInlineScriptTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getInlineScriptTag', function() {
      it('should call getInlineScriptTag successfully', function(done) {
        //uncomment below and update the code to test getInlineScriptTag
        //instance.getInlineScriptTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getInlineScriptTags', function() {
      it('should call getInlineScriptTags successfully', function(done) {
        //uncomment below and update the code to test getInlineScriptTags
        //instance.getInlineScriptTags(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateInlineScriptTag', function() {
      it('should call updateInlineScriptTag successfully', function(done) {
        //uncomment below and update the code to test updateInlineScriptTag
        //instance.updateInlineScriptTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
