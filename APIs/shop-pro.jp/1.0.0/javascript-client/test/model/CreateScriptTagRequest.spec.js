...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateScriptTagRequest();
  });
  ...
  describe('CreateScriptTagRequest', function() {
    it('should create an instance of CreateScriptTagRequest', function() {
      // uncomment below and update the code to test CreateScriptTagRequest
      //var instance = new Api.CreateScriptTagRequest();
      //expect(instance).to.be.a(Api.CreateScriptTagRequest);
    });
