...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.ShopScriptTag();
  });
  ...
  describe('ShopScriptTag', function() {
    it('should create an instance of ShopScriptTag', function() {
      // uncomment below and update the code to test ShopScriptTag
      //var instance = new Api.ShopScriptTag();
      //expect(instance).to.be.a(Api.ShopScriptTag);
    });
    ...
    it('should have the property integrity (base name: "integrity")', function() {
      // uncomment below and update the code to test the property integrity
      //var instance = new Api.ShopScriptTag();
      //expect(instance).to.be();
    });
