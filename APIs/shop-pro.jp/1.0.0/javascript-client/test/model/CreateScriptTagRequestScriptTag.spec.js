...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateScriptTagRequestScriptTag();
  });
  ...
  describe('CreateScriptTagRequestScriptTag', function() {
    it('should create an instance of CreateScriptTagRequestScriptTag', function() {
      // uncomment below and update the code to test CreateScriptTagRequestScriptTag
      //var instance = new Api.CreateScriptTagRequestScriptTag();
      //expect(instance).to.be.a(Api.CreateScriptTagRequestScriptTag);
    });
