...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PostApplicationChargeRequest();
  });
  ...
  describe('PostApplicationChargeRequest', function() {
    it('should create an instance of PostApplicationChargeRequest', function() {
      // uncomment below and update the code to test PostApplicationChargeRequest
      //var instance = new Api.PostApplicationChargeRequest();
      //expect(instance).to.be.a(Api.PostApplicationChargeRequest);
    });
