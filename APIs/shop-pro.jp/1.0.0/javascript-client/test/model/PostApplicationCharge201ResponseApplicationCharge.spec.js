...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PostApplicationCharge201ResponseApplicationCharge();
  });
  ...
  describe('PostApplicationCharge201ResponseApplicationCharge', function() {
    it('should create an instance of PostApplicationCharge201ResponseApplicationCharge', function() {
      // uncomment below and update the code to test PostApplicationCharge201ResponseApplicationCharge
      //var instance = new Api.PostApplicationCharge201ResponseApplicationCharge();
      //expect(instance).to.be.a(Api.PostApplicationCharge201ResponseApplicationCharge);
    });
