...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.DeleteInstallation200Response();
  });
  ...
  describe('DeleteInstallation200Response', function() {
    it('should create an instance of DeleteInstallation200Response', function() {
      // uncomment below and update the code to test DeleteInstallation200Response
      //var instance = new Api.DeleteInstallation200Response();
      //expect(instance).to.be.a(Api.DeleteInstallation200Response);
    });
    ...
    it('should have the property recurringApplicationChargeId (base name: "recurring_application_charge_id")', function() {
      // uncomment below and update the code to test the property recurringApplicationChargeId
      //var instance = new Api.DeleteInstallation200Response();
      //expect(instance).to.be();
    });

    it('should have the property uninstalledAt (base name: "uninstalled_at")', function() {
