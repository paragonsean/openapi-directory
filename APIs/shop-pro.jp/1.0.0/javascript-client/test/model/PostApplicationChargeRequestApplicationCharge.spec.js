...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PostApplicationChargeRequestApplicationCharge();
  });
  ...
  describe('PostApplicationChargeRequestApplicationCharge', function() {
    it('should create an instance of PostApplicationChargeRequestApplicationCharge', function() {
      // uncomment below and update the code to test PostApplicationChargeRequestApplicationCharge
      //var instance = new Api.PostApplicationChargeRequestApplicationCharge();
      //expect(instance).to.be.a(Api.PostApplicationChargeRequestApplicationCharge);
    });

    it('should have the property applicationChargeSourceId (base name: "application_charge_source_id")', function() {
      // uncomment below and update the code to test the property applicationChargeSourceId
      //var instance = new Api.PostApplicationChargeRequestApplicationCharge();
