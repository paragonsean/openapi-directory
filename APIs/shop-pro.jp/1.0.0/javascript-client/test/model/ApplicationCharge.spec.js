...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.ApplicationCharge();
  });
  ...
  describe('ApplicationCharge', function() {
    it('should create an instance of ApplicationCharge', function() {
      // uncomment below and update the code to test ApplicationCharge
      //var instance = new Api.ApplicationCharge();
      //expect(instance).to.be.a(Api.ApplicationCharge);
    });
