...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CartScriptTag();
  });
  ...
  describe('CartScriptTag', function() {
    it('should create an instance of CartScriptTag', function() {
      // uncomment below and update the code to test CartScriptTag
      //var instance = new Api.CartScriptTag();
      //expect(instance).to.be.a(Api.CartScriptTag);
    });
