...
(function(root, factory) {
  ...
  describe('ScriptTag', function() {
    it('should create an instance of ScriptTag', function() {
      // uncomment below and update the code to test ScriptTag
      //var instance = new Api.ScriptTag();
      //expect(instance).to.be.a(Api.ScriptTag);
    });
