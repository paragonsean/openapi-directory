...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.InlineScriptTag();
  });
  ...
  describe('InlineScriptTag', function() {
    it('should create an instance of InlineScriptTag', function() {
      // uncomment below and update the code to test InlineScriptTag
      //var instance = new Api.InlineScriptTag();
      //expect(instance).to.be.a(Api.InlineScriptTag);
    });
    ...
    it('should have the property displayScope (base name: "display_scope")', function() {
      // uncomment below and update the code to test the property displayScope
      //var instance = new Api.InlineScriptTag();
      //expect(instance).to.be();
    });
    ...
    it('should have the property makeDate (base name: "make_date")', function() {
      // uncomment below and update the code to test the property makeDate
      //var instance = new Api.InlineScriptTag();
      //expect(instance).to.be();
    });

    it('should have the property oauthApplicationId (base name: "oauth_application_id")', function() {
      // uncomment below and update the code to test the property oauthApplicationId
      //var instance = new Api.InlineScriptTag();
      //expect(instance).to.be();
    });
    ...
    it('should have the property triggerEvent (base name: "trigger_event")', function() {
