...
(function(root, factory) {
  ...
  describe('UsageCharge', function() {
    it('should create an instance of UsageCharge', function() {
      // uncomment below and update the code to test UsageCharge
      //var instance = new Api.UsageCharge();
      //expect(instance).to.be.a(Api.UsageCharge);
    });
