...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.DeleteInstallation200ResponseUsageCharge();
  });
  ...
  describe('DeleteInstallation200ResponseUsageCharge', function() {
    it('should create an instance of DeleteInstallation200ResponseUsageCharge', function() {
      // uncomment below and update the code to test DeleteInstallation200ResponseUsageCharge
      //var instance = new Api.DeleteInstallation200ResponseUsageCharge();
      //expect(instance).to.be.a(Api.DeleteInstallation200ResponseUsageCharge);
    });
    ...
    it('should have the property closingOn (base name: "closing_on")', function() {
      // uncomment below and update the code to test the property closingOn
      //var instance = new Api.DeleteInstallation200ResponseUsageCharge();
      //expect(instance).to.be();
    });
