...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateInlineScriptTag201Response();
  });
  ...
  describe('CreateInlineScriptTag201Response', function() {
    it('should create an instance of CreateInlineScriptTag201Response', function() {
      // uncomment below and update the code to test CreateInlineScriptTag201Response
      //var instance = new Api.CreateInlineScriptTag201Response();
      //expect(instance).to.be.a(Api.CreateInlineScriptTag201Response);
    });

    it('should have the property inlineScriptTag (base name: "inline_script_tag")', function() {
      // uncomment below and update the code to test the property inlineScriptTag
      //var instance = new Api.CreateInlineScriptTag201Response();
