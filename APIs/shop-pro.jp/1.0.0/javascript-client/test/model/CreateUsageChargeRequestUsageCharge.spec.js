...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateUsageChargeRequestUsageCharge();
  });
  ...
  describe('CreateUsageChargeRequestUsageCharge', function() {
    it('should create an instance of CreateUsageChargeRequestUsageCharge', function() {
      // uncomment below and update the code to test CreateUsageChargeRequestUsageCharge
      //var instance = new Api.CreateUsageChargeRequestUsageCharge();
      //expect(instance).to.be.a(Api.CreateUsageChargeRequestUsageCharge);
    });
