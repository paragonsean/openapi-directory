...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GetInlineScriptTags200Response();
  });
  ...
  describe('GetInlineScriptTags200Response', function() {
    it('should create an instance of GetInlineScriptTags200Response', function() {
      // uncomment below and update the code to test GetInlineScriptTags200Response
      //var instance = new Api.GetInlineScriptTags200Response();
      //expect(instance).to.be.a(Api.GetInlineScriptTags200Response);
    });

    it('should have the property inlineScriptTags (base name: "inline_script_tags")', function() {
      // uncomment below and update the code to test the property inlineScriptTags
      //var instance = new Api.GetInlineScriptTags200Response();
