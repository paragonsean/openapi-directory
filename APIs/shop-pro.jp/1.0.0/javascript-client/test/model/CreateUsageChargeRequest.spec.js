...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateUsageChargeRequest();
  });
  ...
  describe('CreateUsageChargeRequest', function() {
    it('should create an instance of CreateUsageChargeRequest', function() {
      // uncomment below and update the code to test CreateUsageChargeRequest
      //var instance = new Api.CreateUsageChargeRequest();
      //expect(instance).to.be.a(Api.CreateUsageChargeRequest);
    });

    it('should have the property usageCharge (base name: "usage_charge")', function() {
      // uncomment below and update the code to test the property usageCharge
      //var instance = new Api.CreateUsageChargeRequest();
