...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateShopScriptTagRequest();
  });
  ...
  describe('CreateShopScriptTagRequest', function() {
    it('should create an instance of CreateShopScriptTagRequest', function() {
      // uncomment below and update the code to test CreateShopScriptTagRequest
      //var instance = new Api.CreateShopScriptTagRequest();
      //expect(instance).to.be.a(Api.CreateShopScriptTagRequest);
    });

    it('should have the property scriptTag (base name: "script_tag")', function() {
      // uncomment below and update the code to test the property scriptTag
      //var instance = new Api.CreateShopScriptTagRequest();
