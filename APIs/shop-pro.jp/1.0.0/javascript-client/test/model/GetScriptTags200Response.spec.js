...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GetScriptTags200Response();
  });
  ...
  describe('GetScriptTags200Response', function() {
    it('should create an instance of GetScriptTags200Response', function() {
      // uncomment below and update the code to test GetScriptTags200Response
      //var instance = new Api.GetScriptTags200Response();
      //expect(instance).to.be.a(Api.GetScriptTags200Response);
    });

    it('should have the property scriptTags (base name: "script_tags")', function() {
      // uncomment below and update the code to test the property scriptTags
      //var instance = new Api.GetScriptTags200Response();
