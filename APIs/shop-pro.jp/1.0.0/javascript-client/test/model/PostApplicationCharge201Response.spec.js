...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.PostApplicationCharge201Response();
  });
  ...
  describe('PostApplicationCharge201Response', function() {
    it('should create an instance of PostApplicationCharge201Response', function() {
      // uncomment below and update the code to test PostApplicationCharge201Response
      //var instance = new Api.PostApplicationCharge201Response();
      //expect(instance).to.be.a(Api.PostApplicationCharge201Response);
    });

    it('should have the property applicationCharge (base name: "application_charge")', function() {
      // uncomment below and update the code to test the property applicationCharge
      //var instance = new Api.PostApplicationCharge201Response();
