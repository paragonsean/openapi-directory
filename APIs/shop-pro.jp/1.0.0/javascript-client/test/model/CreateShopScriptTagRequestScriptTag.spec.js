...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateShopScriptTagRequestScriptTag();
  });
  ...
  describe('CreateShopScriptTagRequestScriptTag', function() {
    it('should create an instance of CreateShopScriptTagRequestScriptTag', function() {
      // uncomment below and update the code to test CreateShopScriptTagRequestScriptTag
      //var instance = new Api.CreateShopScriptTagRequestScriptTag();
      //expect(instance).to.be.a(Api.CreateShopScriptTagRequestScriptTag);
    });
