...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateInlineScriptTagRequest();
  });
  ...
  describe('CreateInlineScriptTagRequest', function() {
    it('should create an instance of CreateInlineScriptTagRequest', function() {
      // uncomment below and update the code to test CreateInlineScriptTagRequest
      //var instance = new Api.CreateInlineScriptTagRequest();
      //expect(instance).to.be.a(Api.CreateInlineScriptTagRequest);
    });
