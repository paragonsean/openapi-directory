...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateInlineScriptTagRequestInlineScriptTag();
  });
  ...
  describe('CreateInlineScriptTagRequestInlineScriptTag', function() {
    it('should create an instance of CreateInlineScriptTagRequestInlineScriptTag', function() {
      // uncomment below and update the code to test CreateInlineScriptTagRequestInlineScriptTag
      //var instance = new Api.CreateInlineScriptTagRequestInlineScriptTag();
      //expect(instance).to.be.a(Api.CreateInlineScriptTagRequestInlineScriptTag);
    });
