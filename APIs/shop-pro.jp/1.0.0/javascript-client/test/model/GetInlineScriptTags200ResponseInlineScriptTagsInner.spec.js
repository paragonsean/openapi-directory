...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GetInlineScriptTags200ResponseInlineScriptTagsInner();
  });
  ...
  describe('GetInlineScriptTags200ResponseInlineScriptTagsInner', function() {
    it('should create an instance of GetInlineScriptTags200ResponseInlineScriptTagsInner', function() {
      // uncomment below and update the code to test GetInlineScriptTags200ResponseInlineScriptTagsInner
      //var instance = new Api.GetInlineScriptTags200ResponseInlineScriptTagsInner();
      //expect(instance).to.be.a(Api.GetInlineScriptTags200ResponseInlineScriptTagsInner);
    });
