...
To use the link you just defined in your project, switch to the directory you want to use your _api from, and run:
...
var api = new Api.ApplicationChargeApi()
var recurringApplicationChargeId = "recurringApplicationChargeId_example"; // {String} 課金契約ID
var createUsageChargeRequest = new Api.CreateUsageChargeRequest(); // {CreateUsageChargeRequest} 従量課金データ
var opts = {
  'xAppstoreUsageChargeToken': "xAppstoreUsageChargeToken_example" // {String} アンインストール後の従量課金の精算をする際に、 `Authorization` ヘッダへアクセストークンを指定する代わりにこのヘッダを指定することで、このAPIを実行することができます。 インストール中は指定不要で、アンインストール後のみ必須となります。 アンインストールフックで通知される `usage_charge.api_token` の値を指定してください。 このヘッダは、アンインストールフックで通知される `usage_charge.closing_on` まで有効です。この期間を過ぎると従量課金を精算できなくなりますのでご注意ください。詳しくは [アプリのアンインストール](#section/API/アプリのアンインストール) をご確認ください。
};
...
api.createUsageCharge(recurringApplicationChargeId, createUsageChargeRequest, opts, callback);
...
------------ | ------------- | ------------- | -------------
*Api.ApplicationChargeApi* | [**createUsageCharge**](docs/ApplicationChargeApi.md#createUsageCharge) | **POST** /appstore/v1/recurring_application_charges/{recurringApplicationChargeId}/usage_charges.json | 従量課金データの作成
*Api.ApplicationChargeApi* | [**postApplicationCharge**](docs/ApplicationChargeApi.md#postApplicationCharge) | **POST** /appstore/v1/application_charges.json | アプリ内課金データの作成
*Api.InlineScriptApi* | [**createInlineScriptTag**](docs/InlineScriptApi.md#createInlineScriptTag) | **POST** /v1/inline_script_tags.json | インラインスクリプトタグの登録
*Api.InlineScriptApi* | [**deleteInlineScriptTag**](docs/InlineScriptApi.md#deleteInlineScriptTag) | **DELETE** /v1/inline_script_tags/{inlineScriptTagId}.json | インラインスクリプトタグの削除
*Api.InlineScriptApi* | [**getInlineScriptTag**](docs/InlineScriptApi.md#getInlineScriptTag) | **GET** /v1/inline_script_tags/{inlineScriptTagId}.json | インラインスクリプトタグの取得
*Api.InlineScriptApi* | [**getInlineScriptTags**](docs/InlineScriptApi.md#getInlineScriptTags) | **GET** /v1/inline_script_tags.json | インラインスクリプトタグの取得
*Api.InlineScriptApi* | [**updateInlineScriptTag**](docs/InlineScriptApi.md#updateInlineScriptTag) | **PUT** /v1/inline_script_tags/{inlineScriptTagId}.json | インラインスクリプトタグの更新
*Api.ScriptApi* | [**createShopScriptTag**](docs/ScriptApi.md#createShopScriptTag) | **POST** /appstore/v1/script_tags.json | スクリプトタグの作成
*Api.ScriptApi* | [**deleteScriptTag**](docs/ScriptApi.md#deleteScriptTag) | **DELETE** /appstore/v1/script_tags/{scriptTagId}.json | スクリプトタグの削除
*Api.ScriptApi* | [**getShopScriptTag**](docs/ScriptApi.md#getShopScriptTag) | **GET** /appstore/v1/script_tags/{scriptTagId}.json | スクリプトタグの取得
*Api.ScriptApi* | [**getShopScriptTags**](docs/ScriptApi.md#getShopScriptTags) | **GET** /appstore/v1/script_tags.json | スクリプトタグの取得
*Api.ScriptApi* | [**updateShopScriptTag**](docs/ScriptApi.md#updateShopScriptTag) | **PUT** /appstore/v1/script_tags/{scriptTagId}.json | スクリプトタグの更新
*Api.ScriptDeprecatedApi* | [**createScriptTag**](docs/ScriptDeprecatedApi.md#createScriptTag) | **POST** /v1/script_tags.json | スクリプトタグの作成
*Api.ScriptDeprecatedApi* | [**getScriptTag**](docs/ScriptDeprecatedApi.md#getScriptTag) | **GET** /v1/script_tags/{scriptTagId}.json | スクリプトタグの取得
*Api.ScriptDeprecatedApi* | [**getScriptTags**](docs/ScriptDeprecatedApi.md#getScriptTags) | **GET** /v1/script_tags.json | スクリプトタグの取得
*Api.ScriptDeprecatedApi* | [**updateScriptTag**](docs/ScriptDeprecatedApi.md#updateScriptTag) | **PUT** /v1/script_tags/{scriptTagId}.json | スクリプトタグの更新
*Api.ScriptDeprecatedApi* | [**v1ScriptTagsScriptTagIdJsonDelete**](docs/ScriptDeprecatedApi.md#v1ScriptTagsScriptTagIdJsonDelete) | **DELETE** /v1/script_tags/{scriptTagId}.json | スクリプトタグの削除
*Api.UninstallationApi* | [**deleteInstallation**](docs/UninstallationApi.md#deleteInstallation) | **DELETE** /appstore/v1/installation.json | アプリストアアプリのアンインストール


## Documentation for Models

 - [Api.ApplicationCharge](docs/ApplicationCharge.md)
 - [Api.CartScriptTag](docs/CartScriptTag.md)
 - [Api.CreateInlineScriptTag201Response](docs/CreateInlineScriptTag201Response.md)
 - [Api.CreateInlineScriptTagRequest](docs/CreateInlineScriptTagRequest.md)
 - [Api.CreateInlineScriptTagRequestInlineScriptTag](docs/CreateInlineScriptTagRequestInlineScriptTag.md)
 - [Api.CreateScriptTag200Response](docs/CreateScriptTag200Response.md)
 - [Api.CreateScriptTagRequest](docs/CreateScriptTagRequest.md)
 - [Api.CreateScriptTagRequestScriptTag](docs/CreateScriptTagRequestScriptTag.md)
 - [Api.CreateShopScriptTag200Response](docs/CreateShopScriptTag200Response.md)
 - [Api.CreateShopScriptTagRequest](docs/CreateShopScriptTagRequest.md)
 - [Api.CreateShopScriptTagRequestScriptTag](docs/CreateShopScriptTagRequestScriptTag.md)
 - [Api.CreateUsageCharge201Response](docs/CreateUsageCharge201Response.md)
 - [Api.CreateUsageCharge201ResponseUsageCharge](docs/CreateUsageCharge201ResponseUsageCharge.md)
 - [Api.CreateUsageChargeRequest](docs/CreateUsageChargeRequest.md)
 - [Api.CreateUsageChargeRequestUsageCharge](docs/CreateUsageChargeRequestUsageCharge.md)
 - [Api.DeleteInstallation200Response](docs/DeleteInstallation200Response.md)
 - [Api.DeleteInstallation200ResponseUsageCharge](docs/DeleteInstallation200ResponseUsageCharge.md)
 - [Api.GetInlineScriptTags200Response](docs/GetInlineScriptTags200Response.md)
 - [Api.GetInlineScriptTags200ResponseInlineScriptTagsInner](docs/GetInlineScriptTags200ResponseInlineScriptTagsInner.md)
 - [Api.GetScriptTags200Response](docs/GetScriptTags200Response.md)
 - [Api.GetScriptTags200ResponseScriptTagsInner](docs/GetScriptTags200ResponseScriptTagsInner.md)
 - [Api.GetShopScriptTags200Response](docs/GetShopScriptTags200Response.md)
 - [Api.GetShopScriptTags200ResponseScriptTagsInner](docs/GetShopScriptTags200ResponseScriptTagsInner.md)
 - [Api.InlineScriptTag](docs/InlineScriptTag.md)
 - [Api.PostApplicationCharge201Response](docs/PostApplicationCharge201Response.md)
 - [Api.PostApplicationCharge201ResponseApplicationCharge](docs/PostApplicationCharge201ResponseApplicationCharge.md)
 - [Api.PostApplicationChargeRequest](docs/PostApplicationChargeRequest.md)
 - [Api.PostApplicationChargeRequestApplicationCharge](docs/PostApplicationChargeRequestApplicationCharge.md)
 - [Api.ScriptTag](docs/ScriptTag.md)
 - [Api.ShopScriptTag](docs/ShopScriptTag.md)
 - [Api.UsageCharge](docs/UsageCharge.md)
