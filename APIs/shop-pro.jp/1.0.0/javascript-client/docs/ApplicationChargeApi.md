...
> CreateUsageCharge201Response createUsageCharge(recurringApplicationChargeId, createUsageChargeRequest, opts)
...
let apiInstance = new Api.ApplicationChargeApi();
let recurringApplicationChargeId = "recurringApplicationChargeId_example"; // String | 課金契約ID
let createUsageChargeRequest = new Api.CreateUsageChargeRequest(); // CreateUsageChargeRequest | 従量課金データ
let opts = {
...
apiInstance.createUsageCharge(recurringApplicationChargeId, createUsageChargeRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new Api.ApplicationChargeApi();
let postApplicationChargeRequest = new Api.PostApplicationChargeRequest(); // PostApplicationChargeRequest | 
apiInstance.postApplicationCharge(postApplicationChargeRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
