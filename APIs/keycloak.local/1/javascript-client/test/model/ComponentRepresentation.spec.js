...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeycloakAdminRestApi.ComponentRepresentation();
  });
  ...
  describe('ComponentRepresentation', function() {
    it('should create an instance of ComponentRepresentation', function() {
      // uncomment below and update the code to test ComponentRepresentation
      //var instance = new KeycloakAdminRestApi.ComponentRepresentation();
      //expect(instance).to.be.a(KeycloakAdminRestApi.ComponentRepresentation);
    });
