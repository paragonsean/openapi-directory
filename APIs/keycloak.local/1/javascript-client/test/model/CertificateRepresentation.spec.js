...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeycloakAdminRestApi.CertificateRepresentation();
  });
  ...
  describe('CertificateRepresentation', function() {
    it('should create an instance of CertificateRepresentation', function() {
      // uncomment below and update the code to test CertificateRepresentation
      //var instance = new KeycloakAdminRestApi.CertificateRepresentation();
      //expect(instance).to.be.a(KeycloakAdminRestApi.CertificateRepresentation);
    });
