...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeycloakAdminRestApi.SpiInfoRepresentation();
  });
  ...
  describe('SpiInfoRepresentation', function() {
    it('should create an instance of SpiInfoRepresentation', function() {
      // uncomment below and update the code to test SpiInfoRepresentation
      //var instance = new KeycloakAdminRestApi.SpiInfoRepresentation();
      //expect(instance).to.be.a(KeycloakAdminRestApi.SpiInfoRepresentation);
    });
