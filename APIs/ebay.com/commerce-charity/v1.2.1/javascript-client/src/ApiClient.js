...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.ebay.com/commerce/charity/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.ebay.com/commerce/charity/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1.2.1/Javascript'
        };
        ...
        return [
            {
              ...
              'variables': {
                basePath: {
                    ...
                    'default_value': "/commerce/charity/v1",
                  }
                }
            }
      ];
