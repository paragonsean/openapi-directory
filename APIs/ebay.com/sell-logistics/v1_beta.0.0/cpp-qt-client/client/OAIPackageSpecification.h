...
/*
 * OAIPackageSpecification.h
 *
 * This complex type specifies the dimensions and weight of a package.
 */

#ifndef OAIPackageSpecification_H
#define OAIPackageSpecification_H
...
class OAIPackageSpecification : public OAIObject {
public:
    OAIPackageSpecification();
    OAIPackageSpecification(QString json);
    ~OAIPackageSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackageSpecification)

#endif // OAIPackageSpecification_H
