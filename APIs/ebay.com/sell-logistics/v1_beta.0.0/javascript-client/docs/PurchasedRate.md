# LogisticsApi.PurchasedRate

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**additionalOptions** | [**[AdditionalOption]**](AdditionalOption.md) | An list of additional, optional features that have been purchased for the shipment. | [optional] 
...
**pickupNetworks** | **[String]** | A list of pickup networks compatible with the shipping service. | [optional] 
