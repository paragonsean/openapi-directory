...
let apiInstance = new LogisticsApi.ShippingQuoteApi();
...
let shippingQuoteRequest = new LogisticsApi.ShippingQuoteRequest(); // ShippingQuoteRequest | The request object for <b>createShippingQuote</b>.
apiInstance.createShippingQuote(X_EBAY_C_MARKETPLACE_ID, shippingQuoteRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new LogisticsApi.ShippingQuoteApi();
let shippingQuoteId = "shippingQuoteId_example"; // String | This path parameter specifies the unique eBay-assigned ID of the shipping quote you want to retrieve. The <b>shippingQuoteId</b> value is generated and returned by a call to <b>createShippingQuote</b>.
apiInstance.getShippingQuote(shippingQuoteId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
