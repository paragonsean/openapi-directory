...
public class MarketingPrice {
  ...
  public MarketingPrice discountAmount(Amount discountAmount) {
  ...
  public MarketingPrice originalPrice(Amount originalPrice) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("originalPrice") != null && !jsonObj.get("originalPrice").isJsonNull()) {
        Amount.validateJsonElement(jsonObj.get("originalPrice"));
      }
