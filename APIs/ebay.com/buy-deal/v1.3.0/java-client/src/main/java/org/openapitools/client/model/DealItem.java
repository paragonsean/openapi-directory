...
public class DealItem {
  ...
  public static final String SERIALIZED_NAME_DEAL_AFFILIATE_WEB_URL = "dealAffiliateWebUrl";
  @SerializedName(SERIALIZED_NAME_DEAL_AFFILIATE_WEB_URL)
  private String dealAffiliateWebUrl;

  public static final String SERIALIZED_NAME_DEAL_END_DATE = "dealEndDate";
  @SerializedName(SERIALIZED_NAME_DEAL_END_DATE)
  private String dealEndDate;

  public static final String SERIALIZED_NAME_DEAL_START_DATE = "dealStartDate";
  @SerializedName(SERIALIZED_NAME_DEAL_START_DATE)
  private String dealStartDate;

  public static final String SERIALIZED_NAME_DEAL_WEB_URL = "dealWebUrl";
  @SerializedName(SERIALIZED_NAME_DEAL_WEB_URL)
  private String dealWebUrl;
  ...
  public DealItem additionalImages(List<Image> additionalImages) {
    this.additionalImages = additionalImages;
    return this;
  }

  public DealItem addAdditionalImagesItem(Image additionalImagesItem) {
  ...
  public DealItem categoryAncestorIds(List<String> categoryAncestorIds) {
    this.categoryAncestorIds = categoryAncestorIds;
    return this;
  }

  public DealItem addCategoryAncestorIdsItem(String categoryAncestorIdsItem) {
  ...
  public DealItem categoryId(String categoryId) {
  ...
  public DealItem commissionable(Boolean commissionable) {
  ...
  public DealItem dealAffiliateWebUrl(String dealAffiliateWebUrl) {
   ...
   * @return dealAffiliateWebUrl
   */
  @javax.annotation.Nullable
  public String getDealAffiliateWebUrl() {
    return dealAffiliateWebUrl;
  }

  public void setDealAffiliateWebUrl(String dealAffiliateWebUrl) {
    this.dealAffiliateWebUrl = dealAffiliateWebUrl;
  }


  public DealItem dealEndDate(String dealEndDate) {
  ...
  public DealItem dealStartDate(String dealStartDate) {
  ...
  public DealItem dealWebUrl(String dealWebUrl) {
   ...
   */
  @javax.annotation.Nullable
  public String getDealWebUrl() {
    return dealWebUrl;
  }

  public void setDealWebUrl(String dealWebUrl) {
    this.dealWebUrl = dealWebUrl;
  }


  public DealItem energyEfficiencyClass(String energyEfficiencyClass) {
  ...
  public DealItem image(Image image) {
    this.image = image;
    return this;
  }
  ...
  public DealItem itemAffiliateWebUrl(String itemAffiliateWebUrl) {
  ...
  public DealItem itemGroupId(String itemGroupId) {
  ...
  public DealItem itemGroupType(String itemGroupType) {
  ...
  public DealItem itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public DealItem itemWebUrl(String itemWebUrl) {
  ...
  public DealItem legacyItemId(String legacyItemId) {
  ...
  public DealItem marketingPrice(MarketingPrice marketingPrice) {
  ...
  public DealItem price(Amount price) {
    this.price = price;
    return this;
  }
  ...
  public DealItem qualifiedPrograms(List<String> qualifiedPrograms) {
    this.qualifiedPrograms = qualifiedPrograms;
    return this;
  }

  public DealItem addQualifiedProgramsItem(String qualifiedProgramsItem) {
  ...
  public DealItem shippingOptions(List<ShippingOption> shippingOptions) {
    this.shippingOptions = shippingOptions;
    return this;
  }

  public DealItem addShippingOptionsItem(ShippingOption shippingOptionsItem) {
  ...
  public DealItem title(String title) {
    this.title = title;
    return this;
  }
  ...
  public DealItem unitPrice(Amount unitPrice) {
  ...
  public DealItem unitPricingMeasure(String unitPricingMeasure) {
  ...
  public boolean equals(Object o) {
    ...
    DealItem dealItem = (DealItem) o;
    return Objects.equals(this.additionalImages, dealItem.additionalImages) &&
        Objects.equals(this.categoryAncestorIds, dealItem.categoryAncestorIds) &&
        Objects.equals(this.categoryId, dealItem.categoryId) &&
        Objects.equals(this.commissionable, dealItem.commissionable) &&
        Objects.equals(this.dealAffiliateWebUrl, dealItem.dealAffiliateWebUrl) &&
        Objects.equals(this.dealEndDate, dealItem.dealEndDate) &&
        Objects.equals(this.dealStartDate, dealItem.dealStartDate) &&
        Objects.equals(this.dealWebUrl, dealItem.dealWebUrl) &&
        Objects.equals(this.energyEfficiencyClass, dealItem.energyEfficiencyClass) &&
        Objects.equals(this.image, dealItem.image) &&
        Objects.equals(this.itemAffiliateWebUrl, dealItem.itemAffiliateWebUrl) &&
        Objects.equals(this.itemGroupId, dealItem.itemGroupId) &&
        Objects.equals(this.itemGroupType, dealItem.itemGroupType) &&
        Objects.equals(this.itemId, dealItem.itemId) &&
        Objects.equals(this.itemWebUrl, dealItem.itemWebUrl) &&
        Objects.equals(this.legacyItemId, dealItem.legacyItemId) &&
        Objects.equals(this.marketingPrice, dealItem.marketingPrice) &&
        Objects.equals(this.price, dealItem.price) &&
        Objects.equals(this.qualifiedPrograms, dealItem.qualifiedPrograms) &&
        Objects.equals(this.shippingOptions, dealItem.shippingOptions) &&
        Objects.equals(this.title, dealItem.title) &&
        Objects.equals(this.unitPrice, dealItem.unitPrice) &&
        Objects.equals(this.unitPricingMeasure, dealItem.unitPricingMeasure);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additionalImages, categoryAncestorIds, categoryId, commissionable, dealAffiliateWebUrl, dealEndDate, dealStartDate, dealWebUrl, energyEfficiencyClass, image, itemAffiliateWebUrl, itemGroupId, itemGroupType, itemId, itemWebUrl, legacyItemId, marketingPrice, price, qualifiedPrograms, shippingOptions, title, unitPrice, unitPricingMeasure);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DealItem {\n");
    ...
    sb.append("    dealAffiliateWebUrl: ").append(toIndentedString(dealAffiliateWebUrl)).append("\n");
    sb.append("    dealEndDate: ").append(toIndentedString(dealEndDate)).append("\n");
    sb.append("    dealStartDate: ").append(toIndentedString(dealStartDate)).append("\n");
    sb.append("    dealWebUrl: ").append(toIndentedString(dealWebUrl)).append("\n");
  ...
  static {
    ...
    openapiFields.add("dealAffiliateWebUrl");
    openapiFields.add("dealEndDate");
    openapiFields.add("dealStartDate");
    openapiFields.add("dealWebUrl");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DealItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DealItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DealItem is not found in the empty JSON string", DealItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DealItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DealItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("dealAffiliateWebUrl") != null && !jsonObj.get("dealAffiliateWebUrl").isJsonNull()) && !jsonObj.get("dealAffiliateWebUrl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `dealAffiliateWebUrl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dealAffiliateWebUrl").toString()));
      }
      if ((jsonObj.get("dealEndDate") != null && !jsonObj.get("dealEndDate").isJsonNull()) && !jsonObj.get("dealEndDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `dealEndDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dealEndDate").toString()));
      }
      if ((jsonObj.get("dealStartDate") != null && !jsonObj.get("dealStartDate").isJsonNull()) && !jsonObj.get("dealStartDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `dealStartDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dealStartDate").toString()));
      }
      if ((jsonObj.get("dealWebUrl") != null && !jsonObj.get("dealWebUrl").isJsonNull()) && !jsonObj.get("dealWebUrl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `dealWebUrl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dealWebUrl").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DealItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DealItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DealItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DealItem.class));

       return (TypeAdapter<T>) new TypeAdapter<DealItem>() {
           @Override
           public void write(JsonWriter out, DealItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DealItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DealItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DealItem
   * @throws IOException if the JSON string is invalid with respect to DealItem
   */
  public static DealItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DealItem.class);
  }

  /**
   * Convert an instance of DealItem to an JSON string
   *
   * @return JSON string
   */
