...
|------------ | ------------- | ------------- | -------------|
|**additionalImages** | [**List&lt;Image&gt;**](Image.md) | The additional images for the deal item. |  [optional] |
...
|**qualifiedPrograms** | **List&lt;String&gt;** | A list of programs applicable to the item. |  [optional] |
|**shippingOptions** | [**List&lt;ShippingOption&gt;**](ShippingOption.md) | The cost required to ship the deal item. |  [optional] |
