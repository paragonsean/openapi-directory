...
|------------ | ------------- | ------------- | -------------|
|**additionalImages** | [**List&lt;Image&gt;**](Image.md) | The additional images for the event item. |  [optional] |
|**categoryAncestorIds** | **List&lt;String&gt;** | The IDs of the ancestors for the primary category. |  [optional] |
...
|**qualifiedPrograms** | **List&lt;String&gt;** | A list of programs applicable to the event item. |  [optional] |
|**shippingOptions** | [**List&lt;ShippingOption&gt;**](ShippingOption.md) | The cost required to ship the event item. |  [optional] |
