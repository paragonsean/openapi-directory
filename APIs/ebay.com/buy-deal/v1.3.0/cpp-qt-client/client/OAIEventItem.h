...
#ifndef OAIEventItem_H
#define OAIEventItem_H
...
class OAIEventItem : public OAIObject {
public:
    OAIEventItem();
    OAIEventItem(QString json);
    ~OAIEventItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventItem)

#endif // OAIEventItem_H
