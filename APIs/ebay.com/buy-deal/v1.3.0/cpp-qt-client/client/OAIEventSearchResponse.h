...
/*
 * OAIEventSearchResponse.h
 *
 * The result set for the specified event search criteria.
 */

#ifndef OAIEventSearchResponse_H
#define OAIEventSearchResponse_H
...
class OAIEventSearchResponse : public OAIObject {
public:
    OAIEventSearchResponse();
    OAIEventSearchResponse(QString json);
    ~OAIEventSearchResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventSearchResponse)

#endif // OAIEventSearchResponse_H
