...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DealApi.EventSearchResponse();
  });
  ...
  describe('EventSearchResponse', function() {
    it('should create an instance of EventSearchResponse', function() {
      // uncomment below and update the code to test EventSearchResponse
      //var instance = new DealApi.EventSearchResponse();
      //expect(instance).to.be.a(DealApi.EventSearchResponse);
    });
