...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DealApi.DealItemApi();
  });
  ...
  describe('DealItemApi', function() {
    describe('getDealItems', function() {
      it('should call getDealItems successfully', function(done) {
        //uncomment below and update the code to test getDealItems
        //instance.getDealItems(function(error) {
