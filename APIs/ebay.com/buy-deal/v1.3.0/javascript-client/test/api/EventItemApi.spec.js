...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DealApi.EventItemApi();
  });
  ...
  describe('EventItemApi', function() {
    describe('getEventItems', function() {
      it('should call getEventItems successfully', function(done) {
        //uncomment below and update the code to test getEventItems
        //instance.getEventItems(function(error) {
