...
/**
* EventItem service.
* @module api/EventItemApi
* @version v1.3.0
*/
export default class EventItemApi {

    /**
    * Constructs a new EventItemApi. 
    * @alias module:api/EventItemApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getEventItems operation.
     * @callback module:api/EventItemApi~getEventItemsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EventItemSearchResponse} data The data returned by the service call.
     ...
     * @param {String} eventIds The unique identifiers for the eBay events. Maximum Value: 1
     * @param {String} X_EBAY_C_MARKETPLACE_ID A header used to specify the eBay marketplace ID.
     * @param {Object} opts Optional parameters
     * @param {String} [categoryIds] The unique identifier of the eBay category for the search. Maximum Value: 1
     ...
     * @param {module:api/EventItemApi~getEventItemsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EventItemSearchResponse}
     */
    getEventItems(eventIds, X_EBAY_C_MARKETPLACE_ID, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'eventIds' is set
      if (eventIds === undefined || eventIds === null) {
        throw new Error("Missing the required parameter 'eventIds' when calling getEventItems");
      }
      // verify the required parameter 'X_EBAY_C_MARKETPLACE_ID' is set
      if (X_EBAY_C_MARKETPLACE_ID === undefined || X_EBAY_C_MARKETPLACE_ID === null) {
        throw new Error("Missing the required parameter 'X_EBAY_C_MARKETPLACE_ID' when calling getEventItems");
      }
      ...
      let returnType = EventItemSearchResponse;
