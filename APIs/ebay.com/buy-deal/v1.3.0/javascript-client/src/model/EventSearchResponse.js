...
/**
 * The EventSearchResponse model module.
 * @module model/EventSearchResponse
 * @version v1.3.0
 */
class EventSearchResponse {
    /**
     * Constructs a new <code>EventSearchResponse</code>.
     * The result set for the specified event search criteria.
     * @alias module:model/EventSearchResponse
     */
    constructor() { 
        
        EventSearchResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventSearchResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventSearchResponse} obj Optional instance to populate.
     * @return {module:model/EventSearchResponse} The populated <code>EventSearchResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventSearchResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EventSearchResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventSearchResponse</code>.
     */
 ...
 */
EventSearchResponse.prototype['offset'] = undefined;

/**
 * The relative path to the previous set of results.
 * @member {String} prev
 */
EventSearchResponse.prototype['prev'] = undefined;

/**
 * The total number of matches for the specified search criteria.
 * @member {Number} total
 */
EventSearchResponse.prototype['total'] = undefined;
