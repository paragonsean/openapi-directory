...
/**
* CategoryTree service.
* @module api/CategoryTreeApi
* @version v1.0.0
*/
export default class CategoryTreeApi {

    /**
    * Constructs a new CategoryTreeApi. 
    * @alias module:api/CategoryTreeApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchItemAspects operation.
     * @callback module:api/CategoryTreeApi~fetchItemAspectsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetCategoriesAspectResponse} data The data returned by the service call.
     ...
     * @param {module:api/CategoryTreeApi~fetchItemAspectsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetCategoriesAspectResponse}
     */
    fetchItemAspects(categoryTreeId, callback) {
      let postBody = null;
      // verify the required parameter 'categoryTreeId' is set
      if (categoryTreeId === undefined || categoryTreeId === null) {
        throw new Error("Missing the required parameter 'categoryTreeId' when calling fetchItemAspects");
      }
      ...
      let returnType = GetCategoriesAspectResponse;
    ...
    /**
     * Callback function to receive the result of the getCategorySubtree operation.
     * @callback module:api/CategoryTreeApi~getCategorySubtreeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CategorySubtree} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CategoryTreeApi~getCategorySubtreeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CategorySubtree}
     */
    getCategorySubtree(categoryId, categoryTreeId, callback) {
      let postBody = null;
      // verify the required parameter 'categoryId' is set
      if (categoryId === undefined || categoryId === null) {
        throw new Error("Missing the required parameter 'categoryId' when calling getCategorySubtree");
      }
      // verify the required parameter 'categoryTreeId' is set
      if (categoryTreeId === undefined || categoryTreeId === null) {
        throw new Error("Missing the required parameter 'categoryTreeId' when calling getCategorySubtree");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CategorySubtree;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getCategorySuggestions operation.
     * @callback module:api/CategoryTreeApi~getCategorySuggestionsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CategorySuggestionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} q A quoted string that describes or characterizes the item being offered for sale. The string format is free form, and can contain any combination of phrases or keywords. eBay will parse the string and return suggested categories for the item.
     * @param {module:api/CategoryTreeApi~getCategorySuggestionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CategorySuggestionResponse}
     */
    getCategorySuggestions(categoryTreeId, q, callback) {
      let postBody = null;
      // verify the required parameter 'categoryTreeId' is set
      if (categoryTreeId === undefined || categoryTreeId === null) {
        throw new Error("Missing the required parameter 'categoryTreeId' when calling getCategorySuggestions");
      }
      // verify the required parameter 'q' is set
      if (q === undefined || q === null) {
        throw new Error("Missing the required parameter 'q' when calling getCategorySuggestions");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CategorySuggestionResponse;
      return this.apiClient.callApi(
     ...
     * @callback module:api/CategoryTreeApi~getCategoryTreeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CategoryTree} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} categoryTreeId The unique identifier of the eBay category tree being requested.
     * @param {module:api/CategoryTreeApi~getCategoryTreeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CategoryTree}
     */
    getCategoryTree(categoryTreeId, callback) {
      let postBody = null;
      // verify the required parameter 'categoryTreeId' is set
      if (categoryTreeId === undefined || categoryTreeId === null) {
        throw new Error("Missing the required parameter 'categoryTreeId' when calling getCategoryTree");
      }
    ...
    /**
     * Callback function to receive the result of the getCompatibilityProperties operation.
     * @callback module:api/CategoryTreeApi~getCompatibilityPropertiesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetCompatibilityMetadataResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CategoryTreeApi~getCompatibilityPropertiesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetCompatibilityMetadataResponse}
     */
    getCompatibilityProperties(categoryTreeId, categoryId, callback) {
      let postBody = null;
      // verify the required parameter 'categoryTreeId' is set
      if (categoryTreeId === undefined || categoryTreeId === null) {
        throw new Error("Missing the required parameter 'categoryTreeId' when calling getCompatibilityProperties");
      }
      // verify the required parameter 'categoryId' is set
      if (categoryId === undefined || categoryId === null) {
        throw new Error("Missing the required parameter 'categoryId' when calling getCompatibilityProperties");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetCompatibilityMetadataResponse;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getCompatibilityPropertyValues operation.
     * @callback module:api/CategoryTreeApi~getCompatibilityPropertyValuesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetCompatibilityPropertyValuesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CategoryTreeApi~getCompatibilityPropertyValuesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetCompatibilityPropertyValuesResponse}
     */
    getCompatibilityPropertyValues(categoryTreeId, compatibilityProperty, categoryId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'categoryTreeId' is set
      if (categoryTreeId === undefined || categoryTreeId === null) {
        throw new Error("Missing the required parameter 'categoryTreeId' when calling getCompatibilityPropertyValues");
      }
      // verify the required parameter 'compatibilityProperty' is set
      if (compatibilityProperty === undefined || compatibilityProperty === null) {
        throw new Error("Missing the required parameter 'compatibilityProperty' when calling getCompatibilityPropertyValues");
      }
      // verify the required parameter 'categoryId' is set
      if (categoryId === undefined || categoryId === null) {
        throw new Error("Missing the required parameter 'categoryId' when calling getCompatibilityPropertyValues");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetCompatibilityPropertyValuesResponse;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getDefaultCategoryTreeId operation.
     * @callback module:api/CategoryTreeApi~getDefaultCategoryTreeIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BaseCategoryTree} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} marketplaceId The ID of the eBay marketplace for which the category tree ID is being requested. For a list of supported marketplace IDs, see Marketplaces with Default Category Trees.
     * @param {Object} opts Optional parameters
     ...
     * @param {module:api/CategoryTreeApi~getDefaultCategoryTreeIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BaseCategoryTree}
     */
    getDefaultCategoryTreeId(marketplaceId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'marketplaceId' is set
      if (marketplaceId === undefined || marketplaceId === null) {
        throw new Error("Missing the required parameter 'marketplaceId' when calling getDefaultCategoryTreeId");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = BaseCategoryTree;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getItemAspectsForCategory operation.
     * @callback module:api/CategoryTreeApi~getItemAspectsForCategoryCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AspectMetadata} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} categoryId The unique identifier of the leaf category for which aspects are being requested. Note: If the category_id submitted does not identify a leaf node of the tree, this call returns an error.
     ...
     * @param {module:api/CategoryTreeApi~getItemAspectsForCategoryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AspectMetadata}
     */
    getItemAspectsForCategory(categoryId, categoryTreeId, callback) {
      let postBody = null;
      // verify the required parameter 'categoryId' is set
      if (categoryId === undefined || categoryId === null) {
        throw new Error("Missing the required parameter 'categoryId' when calling getItemAspectsForCategory");
      }
      // verify the required parameter 'categoryTreeId' is set
      if (categoryTreeId === undefined || categoryTreeId === null) {
        throw new Error("Missing the required parameter 'categoryTreeId' when calling getItemAspectsForCategory");
      }
