...
public class BaseCategoryTree {
  ...
  public BaseCategoryTree categoryTreeId(String categoryTreeId) {
  ...
  public BaseCategoryTree categoryTreeVersion(String categoryTreeVersion) {
  ...
  public boolean equals(Object o) {
    ...
    BaseCategoryTree baseCategoryTree = (BaseCategoryTree) o;
    return Objects.equals(this.categoryTreeId, baseCategoryTree.categoryTreeId) &&
        Objects.equals(this.categoryTreeVersion, baseCategoryTree.categoryTreeVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(categoryTreeId, categoryTreeVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BaseCategoryTree {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BaseCategoryTree
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BaseCategoryTree.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BaseCategoryTree is not found in the empty JSON string", BaseCategoryTree.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BaseCategoryTree.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BaseCategoryTree` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BaseCategoryTree.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BaseCategoryTree' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BaseCategoryTree> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BaseCategoryTree.class));

       return (TypeAdapter<T>) new TypeAdapter<BaseCategoryTree>() {
           @Override
           public void write(JsonWriter out, BaseCategoryTree value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BaseCategoryTree read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BaseCategoryTree given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BaseCategoryTree
   * @throws IOException if the JSON string is invalid with respect to BaseCategoryTree
   */
  public static BaseCategoryTree fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BaseCategoryTree.class);
  }

  /**
   * Convert an instance of BaseCategoryTree to an JSON string
   *
   * @return JSON string
   */
