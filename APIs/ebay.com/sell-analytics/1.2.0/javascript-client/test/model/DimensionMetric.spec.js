...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SellerServiceMetricsApi.DimensionMetric();
  });
  ...
  describe('DimensionMetric', function() {
    it('should create an instance of DimensionMetric', function() {
      // uncomment below and update the code to test DimensionMetric
      //var instance = new SellerServiceMetricsApi.DimensionMetric();
      //expect(instance).to.be.a(SellerServiceMetricsApi.DimensionMetric);
    });
