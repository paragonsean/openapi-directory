...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NegotiationApi.Offer();
  });
  ...
  describe('Offer', function() {
    it('should create an instance of Offer', function() {
      ...
      //var instance = new NegotiationApi.Offer();
      //expect(instance).to.be.a(NegotiationApi.Offer);
    });

    it('should have the property allowCounterOffer (base name: "allowCounterOffer")', function() {
      // uncomment below and update the code to test the property allowCounterOffer
      //var instance = new NegotiationApi.Offer();
    ...
    it('should have the property offerDuration (base name: "offerDuration")', function() {
      // uncomment below and update the code to test the property offerDuration
      //var instance = new NegotiationApi.Offer();
      //expect(instance).to.be();
    });
    ...
    it('should have the property offerStatus (base name: "offerStatus")', function() {
      // uncomment below and update the code to test the property offerStatus
      //var instance = new NegotiationApi.Offer();
      //expect(instance).to.be();
    });
    ...
    it('should have the property offeredItems (base name: "offeredItems")', function() {
      // uncomment below and update the code to test the property offeredItems
      //var instance = new NegotiationApi.Offer();
      //expect(instance).to.be();
    });
