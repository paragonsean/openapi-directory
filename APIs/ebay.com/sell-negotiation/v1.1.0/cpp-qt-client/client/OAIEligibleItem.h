...
#ifndef OAIEligibleItem_H
#define OAIEligibleItem_H
...
class OAIEligibleItem : public OAIObject {
public:
    OAIEligibleItem();
    OAIEligibleItem(QString json);
    ~OAIEligibleItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEligibleItem)

#endif // OAIEligibleItem_H
