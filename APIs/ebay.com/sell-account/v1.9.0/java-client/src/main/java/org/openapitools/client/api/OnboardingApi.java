...
public class OnboardingApi {
    ...
    private okhttp3.Call getPaymentsProgramOnboardingValidateBeforeCall(String marketplaceId, String paymentsProgramType, final ApiCallback _callback) throws ApiException {
        ...
        return getPaymentsProgramOnboardingCall(marketplaceId, paymentsProgramType, _callback);
     ...
     */
    public ApiResponse<PaymentsProgramOnboardingResponse> getPaymentsProgramOnboardingWithHttpInfo(String marketplaceId, String paymentsProgramType) throws ApiException {
