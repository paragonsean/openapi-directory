...
import org.openapitools.client.api.RateTableApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    RateTableApi apiInstance = new RateTableApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling RateTableApi#getRateTables");
