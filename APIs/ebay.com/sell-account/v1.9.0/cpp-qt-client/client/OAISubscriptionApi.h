...
public:
    ...
    */
    virtual void getSubscription(const ::OpenAPI::OptionalParam<QString> &limit = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &continuation_token = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void getSubscriptionSignal(OAISubscriptionResponse summary);


    void getSubscriptionSignalFull(OAIHttpRequestWorker *worker, OAISubscriptionResponse summary);

    Q_DECL_DEPRECATED_X("Use getSubscriptionSignalError() instead")
    void getSubscriptionSignalE(OAISubscriptionResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getSubscriptionSignalError(OAISubscriptionResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
