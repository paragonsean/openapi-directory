...
OAIFulfillmentPolicyRequest::OAIFulfillmentPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFulfillmentPolicyRequest::OAIFulfillmentPolicyRequest() {
    this->initializeModel();
}

OAIFulfillmentPolicyRequest::~OAIFulfillmentPolicyRequest() {}

void OAIFulfillmentPolicyRequest::initializeModel() {
...
void OAIFulfillmentPolicyRequest::fromJson(QString jsonString) {
...
void OAIFulfillmentPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIFulfillmentPolicyRequest::asJson() const {
...
QJsonObject OAIFulfillmentPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QList<OAICategoryType> OAIFulfillmentPolicyRequest::getCategoryTypes() const {
    return m_category_types;
}
void OAIFulfillmentPolicyRequest::setCategoryTypes(const QList<OAICategoryType> &category_types) {
    m_category_types = category_types;
    m_category_types_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_category_types_Set() const{
    return m_category_types_isSet;
}

bool OAIFulfillmentPolicyRequest::is_category_types_Valid() const{
    return m_category_types_isValid;
}

QString OAIFulfillmentPolicyRequest::getDescription() const {
    return m_description;
}
void OAIFulfillmentPolicyRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIFulfillmentPolicyRequest::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIFulfillmentPolicyRequest::isFreightShipping() const {
    return m_freight_shipping;
}
void OAIFulfillmentPolicyRequest::setFreightShipping(const bool &freight_shipping) {
    m_freight_shipping = freight_shipping;
    m_freight_shipping_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_freight_shipping_Set() const{
    return m_freight_shipping_isSet;
}

bool OAIFulfillmentPolicyRequest::is_freight_shipping_Valid() const{
    return m_freight_shipping_isValid;
}

bool OAIFulfillmentPolicyRequest::isGlobalShipping() const {
    return m_global_shipping;
}
void OAIFulfillmentPolicyRequest::setGlobalShipping(const bool &global_shipping) {
    m_global_shipping = global_shipping;
    m_global_shipping_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_global_shipping_Set() const{
    return m_global_shipping_isSet;
}

bool OAIFulfillmentPolicyRequest::is_global_shipping_Valid() const{
    return m_global_shipping_isValid;
}

OAITimeDuration OAIFulfillmentPolicyRequest::getHandlingTime() const {
    return m_handling_time;
}
void OAIFulfillmentPolicyRequest::setHandlingTime(const OAITimeDuration &handling_time) {
    m_handling_time = handling_time;
    m_handling_time_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_handling_time_Set() const{
    return m_handling_time_isSet;
}

bool OAIFulfillmentPolicyRequest::is_handling_time_Valid() const{
    return m_handling_time_isValid;
}

bool OAIFulfillmentPolicyRequest::isLocalPickup() const {
    return m_local_pickup;
}
void OAIFulfillmentPolicyRequest::setLocalPickup(const bool &local_pickup) {
    m_local_pickup = local_pickup;
    m_local_pickup_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_local_pickup_Set() const{
    return m_local_pickup_isSet;
}

bool OAIFulfillmentPolicyRequest::is_local_pickup_Valid() const{
    return m_local_pickup_isValid;
}

QString OAIFulfillmentPolicyRequest::getMarketplaceId() const {
    return m_marketplace_id;
}
void OAIFulfillmentPolicyRequest::setMarketplaceId(const QString &marketplace_id) {
    m_marketplace_id = marketplace_id;
    m_marketplace_id_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_marketplace_id_Set() const{
    return m_marketplace_id_isSet;
}

bool OAIFulfillmentPolicyRequest::is_marketplace_id_Valid() const{
    return m_marketplace_id_isValid;
}

QString OAIFulfillmentPolicyRequest::getName() const {
    return m_name;
}
void OAIFulfillmentPolicyRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFulfillmentPolicyRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIFulfillmentPolicyRequest::isPickupDropOff() const {
    return m_pickup_drop_off;
}
void OAIFulfillmentPolicyRequest::setPickupDropOff(const bool &pickup_drop_off) {
    m_pickup_drop_off = pickup_drop_off;
    m_pickup_drop_off_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_pickup_drop_off_Set() const{
    return m_pickup_drop_off_isSet;
}

bool OAIFulfillmentPolicyRequest::is_pickup_drop_off_Valid() const{
    return m_pickup_drop_off_isValid;
}

OAIRegionSet OAIFulfillmentPolicyRequest::getShipToLocations() const {
    return m_ship_to_locations;
}
void OAIFulfillmentPolicyRequest::setShipToLocations(const OAIRegionSet &ship_to_locations) {
    m_ship_to_locations = ship_to_locations;
    m_ship_to_locations_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_ship_to_locations_Set() const{
    return m_ship_to_locations_isSet;
}

bool OAIFulfillmentPolicyRequest::is_ship_to_locations_Valid() const{
    return m_ship_to_locations_isValid;
}

QList<OAIShippingOption> OAIFulfillmentPolicyRequest::getShippingOptions() const {
    return m_shipping_options;
}
void OAIFulfillmentPolicyRequest::setShippingOptions(const QList<OAIShippingOption> &shipping_options) {
    m_shipping_options = shipping_options;
    m_shipping_options_isSet = true;
}

bool OAIFulfillmentPolicyRequest::is_shipping_options_Set() const{
    return m_shipping_options_isSet;
}

bool OAIFulfillmentPolicyRequest::is_shipping_options_Valid() const{
    return m_shipping_options_isValid;
}

bool OAIFulfillmentPolicyRequest::isSet() const {
...
bool OAIFulfillmentPolicyRequest::isValid() const {
