...
#ifndef OAIPaymentPolicy_H
#define OAIPaymentPolicy_H
...
class OAIPaymentPolicy : public OAIObject {
public:
    OAIPaymentPolicy();
    OAIPaymentPolicy(QString json);
    ~OAIPaymentPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentPolicy)

#endif // OAIPaymentPolicy_H
