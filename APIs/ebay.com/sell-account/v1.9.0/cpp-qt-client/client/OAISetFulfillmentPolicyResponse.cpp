...
OAISetFulfillmentPolicyResponse::OAISetFulfillmentPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetFulfillmentPolicyResponse::OAISetFulfillmentPolicyResponse() {
    this->initializeModel();
}

OAISetFulfillmentPolicyResponse::~OAISetFulfillmentPolicyResponse() {}

void OAISetFulfillmentPolicyResponse::initializeModel() {
...
void OAISetFulfillmentPolicyResponse::fromJson(QString jsonString) {
...
void OAISetFulfillmentPolicyResponse::fromJsonObject(QJsonObject json) {
...
QString OAISetFulfillmentPolicyResponse::asJson() const {
...
QJsonObject OAISetFulfillmentPolicyResponse::asJsonObject() const {
    QJsonObject obj;
...
QList<OAICategoryType> OAISetFulfillmentPolicyResponse::getCategoryTypes() const {
    return m_category_types;
}
void OAISetFulfillmentPolicyResponse::setCategoryTypes(const QList<OAICategoryType> &category_types) {
    m_category_types = category_types;
    m_category_types_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_category_types_Set() const{
    return m_category_types_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_category_types_Valid() const{
    return m_category_types_isValid;
}

QString OAISetFulfillmentPolicyResponse::getDescription() const {
    return m_description;
}
void OAISetFulfillmentPolicyResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_description_Valid() const{
    return m_description_isValid;
}

bool OAISetFulfillmentPolicyResponse::isFreightShipping() const {
    return m_freight_shipping;
}
void OAISetFulfillmentPolicyResponse::setFreightShipping(const bool &freight_shipping) {
    m_freight_shipping = freight_shipping;
    m_freight_shipping_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_freight_shipping_Set() const{
    return m_freight_shipping_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_freight_shipping_Valid() const{
    return m_freight_shipping_isValid;
}

QString OAISetFulfillmentPolicyResponse::getFulfillmentPolicyId() const {
    return m_fulfillment_policy_id;
}
void OAISetFulfillmentPolicyResponse::setFulfillmentPolicyId(const QString &fulfillment_policy_id) {
    m_fulfillment_policy_id = fulfillment_policy_id;
    m_fulfillment_policy_id_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_fulfillment_policy_id_Set() const{
    return m_fulfillment_policy_id_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_fulfillment_policy_id_Valid() const{
    return m_fulfillment_policy_id_isValid;
}

bool OAISetFulfillmentPolicyResponse::isGlobalShipping() const {
    return m_global_shipping;
}
void OAISetFulfillmentPolicyResponse::setGlobalShipping(const bool &global_shipping) {
    m_global_shipping = global_shipping;
    m_global_shipping_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_global_shipping_Set() const{
    return m_global_shipping_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_global_shipping_Valid() const{
    return m_global_shipping_isValid;
}

OAITimeDuration OAISetFulfillmentPolicyResponse::getHandlingTime() const {
    return m_handling_time;
}
void OAISetFulfillmentPolicyResponse::setHandlingTime(const OAITimeDuration &handling_time) {
    m_handling_time = handling_time;
    m_handling_time_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_handling_time_Set() const{
    return m_handling_time_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_handling_time_Valid() const{
    return m_handling_time_isValid;
}

bool OAISetFulfillmentPolicyResponse::isLocalPickup() const {
    return m_local_pickup;
}
void OAISetFulfillmentPolicyResponse::setLocalPickup(const bool &local_pickup) {
    m_local_pickup = local_pickup;
    m_local_pickup_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_local_pickup_Set() const{
    return m_local_pickup_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_local_pickup_Valid() const{
    return m_local_pickup_isValid;
}

QString OAISetFulfillmentPolicyResponse::getMarketplaceId() const {
    return m_marketplace_id;
}
void OAISetFulfillmentPolicyResponse::setMarketplaceId(const QString &marketplace_id) {
    m_marketplace_id = marketplace_id;
    m_marketplace_id_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_marketplace_id_Set() const{
    return m_marketplace_id_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_marketplace_id_Valid() const{
    return m_marketplace_id_isValid;
}

QString OAISetFulfillmentPolicyResponse::getName() const {
    return m_name;
}
void OAISetFulfillmentPolicyResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_name_Valid() const{
    return m_name_isValid;
}

bool OAISetFulfillmentPolicyResponse::isPickupDropOff() const {
    return m_pickup_drop_off;
}
void OAISetFulfillmentPolicyResponse::setPickupDropOff(const bool &pickup_drop_off) {
    m_pickup_drop_off = pickup_drop_off;
    m_pickup_drop_off_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_pickup_drop_off_Set() const{
    return m_pickup_drop_off_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_pickup_drop_off_Valid() const{
    return m_pickup_drop_off_isValid;
}

OAIRegionSet OAISetFulfillmentPolicyResponse::getShipToLocations() const {
    return m_ship_to_locations;
}
void OAISetFulfillmentPolicyResponse::setShipToLocations(const OAIRegionSet &ship_to_locations) {
    m_ship_to_locations = ship_to_locations;
    m_ship_to_locations_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_ship_to_locations_Set() const{
    return m_ship_to_locations_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_ship_to_locations_Valid() const{
    return m_ship_to_locations_isValid;
}

QList<OAIShippingOption> OAISetFulfillmentPolicyResponse::getShippingOptions() const {
    return m_shipping_options;
}
void OAISetFulfillmentPolicyResponse::setShippingOptions(const QList<OAIShippingOption> &shipping_options) {
    m_shipping_options = shipping_options;
    m_shipping_options_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_shipping_options_Set() const{
    return m_shipping_options_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_shipping_options_Valid() const{
    return m_shipping_options_isValid;
}

QList<OAIError> OAISetFulfillmentPolicyResponse::getWarnings() const {
    return m_warnings;
}
void OAISetFulfillmentPolicyResponse::setWarnings(const QList<OAIError> &warnings) {
    m_warnings = warnings;
    m_warnings_isSet = true;
}

bool OAISetFulfillmentPolicyResponse::is_warnings_Set() const{
    return m_warnings_isSet;
}

bool OAISetFulfillmentPolicyResponse::is_warnings_Valid() const{
    return m_warnings_isValid;
}

bool OAISetFulfillmentPolicyResponse::isSet() const {
...
bool OAISetFulfillmentPolicyResponse::isValid() const {
