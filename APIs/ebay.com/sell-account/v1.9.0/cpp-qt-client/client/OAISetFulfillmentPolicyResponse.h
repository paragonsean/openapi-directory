...
/*
 * OAISetFulfillmentPolicyResponse.h
 *
 * Complex type that that gets populated with a response containing a fulfillment policy.
 */

#ifndef OAISetFulfillmentPolicyResponse_H
#define OAISetFulfillmentPolicyResponse_H
...
class OAISetFulfillmentPolicyResponse : public OAIObject {
public:
    OAISetFulfillmentPolicyResponse();
    OAISetFulfillmentPolicyResponse(QString json);
    ~OAISetFulfillmentPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetFulfillmentPolicyResponse)

#endif // OAISetFulfillmentPolicyResponse_H
