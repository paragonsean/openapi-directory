...
#ifndef OAIReturnPolicyRequest_H
#define OAIReturnPolicyRequest_H
...
class OAIReturnPolicyRequest : public OAIObject {
public:
    OAIReturnPolicyRequest();
    OAIReturnPolicyRequest(QString json);
    ~OAIReturnPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReturnPolicyRequest)

#endif // OAIReturnPolicyRequest_H
