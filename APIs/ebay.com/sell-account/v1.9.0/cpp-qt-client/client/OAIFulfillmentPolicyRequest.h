...
#ifndef OAIFulfillmentPolicyRequest_H
#define OAIFulfillmentPolicyRequest_H
...
class OAIFulfillmentPolicyRequest : public OAIObject {
public:
    OAIFulfillmentPolicyRequest();
    OAIFulfillmentPolicyRequest(QString json);
    ~OAIFulfillmentPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFulfillmentPolicyRequest)

#endif // OAIFulfillmentPolicyRequest_H
