...
OAIReturnPolicyRequest::OAIReturnPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReturnPolicyRequest::OAIReturnPolicyRequest() {
    this->initializeModel();
}

OAIReturnPolicyRequest::~OAIReturnPolicyRequest() {}

void OAIReturnPolicyRequest::initializeModel() {
...
void OAIReturnPolicyRequest::fromJson(QString jsonString) {
...
void OAIReturnPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIReturnPolicyRequest::asJson() const {
...
QJsonObject OAIReturnPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QList<OAICategoryType> OAIReturnPolicyRequest::getCategoryTypes() const {
    return m_category_types;
}
void OAIReturnPolicyRequest::setCategoryTypes(const QList<OAICategoryType> &category_types) {
    m_category_types = category_types;
    m_category_types_isSet = true;
}

bool OAIReturnPolicyRequest::is_category_types_Set() const{
    return m_category_types_isSet;
}

bool OAIReturnPolicyRequest::is_category_types_Valid() const{
    return m_category_types_isValid;
}

QString OAIReturnPolicyRequest::getDescription() const {
    return m_description;
}
void OAIReturnPolicyRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIReturnPolicyRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIReturnPolicyRequest::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIReturnPolicyRequest::isExtendedHolidayReturnsOffered() const {
    return m_extended_holiday_returns_offered;
}
void OAIReturnPolicyRequest::setExtendedHolidayReturnsOffered(const bool &extended_holiday_returns_offered) {
    m_extended_holiday_returns_offered = extended_holiday_returns_offered;
    m_extended_holiday_returns_offered_isSet = true;
}

bool OAIReturnPolicyRequest::is_extended_holiday_returns_offered_Set() const{
    return m_extended_holiday_returns_offered_isSet;
}

bool OAIReturnPolicyRequest::is_extended_holiday_returns_offered_Valid() const{
    return m_extended_holiday_returns_offered_isValid;
}

OAIInternationalReturnOverrideType OAIReturnPolicyRequest::getInternationalOverride() const {
    return m_international_override;
}
void OAIReturnPolicyRequest::setInternationalOverride(const OAIInternationalReturnOverrideType &international_override) {
    m_international_override = international_override;
    m_international_override_isSet = true;
}

bool OAIReturnPolicyRequest::is_international_override_Set() const{
    return m_international_override_isSet;
}

bool OAIReturnPolicyRequest::is_international_override_Valid() const{
    return m_international_override_isValid;
}

QString OAIReturnPolicyRequest::getMarketplaceId() const {
    return m_marketplace_id;
}
void OAIReturnPolicyRequest::setMarketplaceId(const QString &marketplace_id) {
    m_marketplace_id = marketplace_id;
    m_marketplace_id_isSet = true;
}

bool OAIReturnPolicyRequest::is_marketplace_id_Set() const{
    return m_marketplace_id_isSet;
}

bool OAIReturnPolicyRequest::is_marketplace_id_Valid() const{
    return m_marketplace_id_isValid;
}

QString OAIReturnPolicyRequest::getName() const {
    return m_name;
}
void OAIReturnPolicyRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIReturnPolicyRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIReturnPolicyRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIReturnPolicyRequest::getRefundMethod() const {
    return m_refund_method;
}
void OAIReturnPolicyRequest::setRefundMethod(const QString &refund_method) {
    m_refund_method = refund_method;
    m_refund_method_isSet = true;
}

bool OAIReturnPolicyRequest::is_refund_method_Set() const{
    return m_refund_method_isSet;
}

bool OAIReturnPolicyRequest::is_refund_method_Valid() const{
    return m_refund_method_isValid;
}

QString OAIReturnPolicyRequest::getRestockingFeePercentage() const {
    return m_restocking_fee_percentage;
}
void OAIReturnPolicyRequest::setRestockingFeePercentage(const QString &restocking_fee_percentage) {
    m_restocking_fee_percentage = restocking_fee_percentage;
    m_restocking_fee_percentage_isSet = true;
}

bool OAIReturnPolicyRequest::is_restocking_fee_percentage_Set() const{
    return m_restocking_fee_percentage_isSet;
}

bool OAIReturnPolicyRequest::is_restocking_fee_percentage_Valid() const{
    return m_restocking_fee_percentage_isValid;
}

QString OAIReturnPolicyRequest::getReturnInstructions() const {
    return m_return_instructions;
}
void OAIReturnPolicyRequest::setReturnInstructions(const QString &return_instructions) {
    m_return_instructions = return_instructions;
    m_return_instructions_isSet = true;
}

bool OAIReturnPolicyRequest::is_return_instructions_Set() const{
    return m_return_instructions_isSet;
}

bool OAIReturnPolicyRequest::is_return_instructions_Valid() const{
    return m_return_instructions_isValid;
}

QString OAIReturnPolicyRequest::getReturnMethod() const {
    return m_return_method;
}
void OAIReturnPolicyRequest::setReturnMethod(const QString &return_method) {
    m_return_method = return_method;
    m_return_method_isSet = true;
}

bool OAIReturnPolicyRequest::is_return_method_Set() const{
    return m_return_method_isSet;
}

bool OAIReturnPolicyRequest::is_return_method_Valid() const{
    return m_return_method_isValid;
}

OAITimeDuration OAIReturnPolicyRequest::getReturnPeriod() const {
    return m_return_period;
}
void OAIReturnPolicyRequest::setReturnPeriod(const OAITimeDuration &return_period) {
    m_return_period = return_period;
    m_return_period_isSet = true;
}

bool OAIReturnPolicyRequest::is_return_period_Set() const{
    return m_return_period_isSet;
}

bool OAIReturnPolicyRequest::is_return_period_Valid() const{
    return m_return_period_isValid;
}

QString OAIReturnPolicyRequest::getReturnShippingCostPayer() const {
    return m_return_shipping_cost_payer;
}
void OAIReturnPolicyRequest::setReturnShippingCostPayer(const QString &return_shipping_cost_payer) {
    m_return_shipping_cost_payer = return_shipping_cost_payer;
    m_return_shipping_cost_payer_isSet = true;
}

bool OAIReturnPolicyRequest::is_return_shipping_cost_payer_Set() const{
    return m_return_shipping_cost_payer_isSet;
}

bool OAIReturnPolicyRequest::is_return_shipping_cost_payer_Valid() const{
    return m_return_shipping_cost_payer_isValid;
}

bool OAIReturnPolicyRequest::isReturnsAccepted() const {
    return m_returns_accepted;
}
void OAIReturnPolicyRequest::setReturnsAccepted(const bool &returns_accepted) {
    m_returns_accepted = returns_accepted;
    m_returns_accepted_isSet = true;
}

bool OAIReturnPolicyRequest::is_returns_accepted_Set() const{
    return m_returns_accepted_isSet;
}

bool OAIReturnPolicyRequest::is_returns_accepted_Valid() const{
    return m_returns_accepted_isValid;
}

bool OAIReturnPolicyRequest::isSet() const {
...
bool OAIReturnPolicyRequest::isValid() const {
