...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.ReturnPolicyRequest();
  });
  ...
  describe('ReturnPolicyRequest', function() {
    it('should create an instance of ReturnPolicyRequest', function() {
      // uncomment below and update the code to test ReturnPolicyRequest
      //var instance = new AccountApi.ReturnPolicyRequest();
      //expect(instance).to.be.a(AccountApi.ReturnPolicyRequest);
    });
