...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.InternationalReturnOverrideType();
  });
  ...
  describe('InternationalReturnOverrideType', function() {
    it('should create an instance of InternationalReturnOverrideType', function() {
      ...
      //var instance = new AccountApi.InternationalReturnOverrideType();
      //expect(instance).to.be.a(AccountApi.InternationalReturnOverrideType);
    });
