...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.CustomPolicy();
  });
  ...
  describe('CustomPolicy', function() {
    it('should create an instance of CustomPolicy', function() {
      // uncomment below and update the code to test CustomPolicy
      //var instance = new AccountApi.CustomPolicy();
      //expect(instance).to.be.a(AccountApi.CustomPolicy);
    });

    it('should have the property customPolicyId (base name: "customPolicyId")', function() {
      // uncomment below and update the code to test the property customPolicyId
      //var instance = new AccountApi.CustomPolicy();
