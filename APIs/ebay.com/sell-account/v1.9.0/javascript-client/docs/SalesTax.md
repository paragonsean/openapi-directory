...
**salesTaxJurisdictionId** | **String** | A unique ID that identifies the sales tax jurisdiction to which the sales tax rate applies (for example, a state within the United States). | [optional] 
