...
OAICreateOrderTaskRequest::OAICreateOrderTaskRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateOrderTaskRequest::OAICreateOrderTaskRequest() {
    this->initializeModel();
}

OAICreateOrderTaskRequest::~OAICreateOrderTaskRequest() {}

void OAICreateOrderTaskRequest::initializeModel() {
...
void OAICreateOrderTaskRequest::fromJson(QString jsonString) {
...
void OAICreateOrderTaskRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateOrderTaskRequest::asJson() const {
...
QJsonObject OAICreateOrderTaskRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateOrderTaskRequest::getFeedType() const {
    return m_feed_type;
}
void OAICreateOrderTaskRequest::setFeedType(const QString &feed_type) {
    m_feed_type = feed_type;
    m_feed_type_isSet = true;
}

bool OAICreateOrderTaskRequest::is_feed_type_Set() const{
    return m_feed_type_isSet;
}

bool OAICreateOrderTaskRequest::is_feed_type_Valid() const{
    return m_feed_type_isValid;
}

OAIOrderFilterCriteria OAICreateOrderTaskRequest::getFilterCriteria() const {
    return m_filter_criteria;
}
void OAICreateOrderTaskRequest::setFilterCriteria(const OAIOrderFilterCriteria &filter_criteria) {
    m_filter_criteria = filter_criteria;
    m_filter_criteria_isSet = true;
}

bool OAICreateOrderTaskRequest::is_filter_criteria_Set() const{
    return m_filter_criteria_isSet;
}

bool OAICreateOrderTaskRequest::is_filter_criteria_Valid() const{
    return m_filter_criteria_isValid;
}

QString OAICreateOrderTaskRequest::getSchemaVersion() const {
    return m_schema_version;
}
void OAICreateOrderTaskRequest::setSchemaVersion(const QString &schema_version) {
    m_schema_version = schema_version;
    m_schema_version_isSet = true;
}

bool OAICreateOrderTaskRequest::is_schema_version_Set() const{
    return m_schema_version_isSet;
}

bool OAICreateOrderTaskRequest::is_schema_version_Valid() const{
    return m_schema_version_isValid;
}

bool OAICreateOrderTaskRequest::isSet() const {
...
bool OAICreateOrderTaskRequest::isValid() const {
