...
/*
 * OAIUpdateUserScheduleRequest.h
 *
 * The type that defines the fields for a schedule update to a schedule generated with the Feed API.
 */

#ifndef OAIUpdateUserScheduleRequest_H
#define OAIUpdateUserScheduleRequest_H
...
class OAIUpdateUserScheduleRequest : public OAIObject {
public:
    OAIUpdateUserScheduleRequest();
    OAIUpdateUserScheduleRequest(QString json);
    ~OAIUpdateUserScheduleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserScheduleRequest)

#endif // OAIUpdateUserScheduleRequest_H
