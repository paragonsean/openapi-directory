...
#ifndef OAIOrderTaskCollection_H
#define OAIOrderTaskCollection_H
...
class OAIOrderTaskCollection : public OAIObject {
public:
    OAIOrderTaskCollection();
    OAIOrderTaskCollection(QString json);
    ~OAIOrderTaskCollection() override;
    ...
    QList<OAIOrderTask> getTasks() const;
    void setTasks(const QList<OAIOrderTask> &tasks);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderTaskCollection)

#endif // OAIOrderTaskCollection_H
