...
#ifndef OAIInventoryTask_H
#define OAIInventoryTask_H
...
class OAIInventoryTask : public OAIObject {
public:
    OAIInventoryTask();
    OAIInventoryTask(QString json);
    ~OAIInventoryTask() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryTask)

#endif // OAIInventoryTask_H
