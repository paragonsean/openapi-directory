...
OAIInventoryTask::OAIInventoryTask(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInventoryTask::OAIInventoryTask() {
    this->initializeModel();
}

OAIInventoryTask::~OAIInventoryTask() {}

void OAIInventoryTask::initializeModel() {
...
void OAIInventoryTask::fromJson(QString jsonString) {
...
void OAIInventoryTask::fromJsonObject(QJsonObject json) {
...
QString OAIInventoryTask::asJson() const {
...
QJsonObject OAIInventoryTask::asJsonObject() const {
    QJsonObject obj;
...
QString OAIInventoryTask::getCompletionDate() const {
    return m_completion_date;
}
void OAIInventoryTask::setCompletionDate(const QString &completion_date) {
    m_completion_date = completion_date;
    m_completion_date_isSet = true;
}

bool OAIInventoryTask::is_completion_date_Set() const{
    return m_completion_date_isSet;
}

bool OAIInventoryTask::is_completion_date_Valid() const{
    return m_completion_date_isValid;
}

QString OAIInventoryTask::getCreationDate() const {
    return m_creation_date;
}
void OAIInventoryTask::setCreationDate(const QString &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIInventoryTask::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIInventoryTask::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAIInventoryTask::getDetailHref() const {
    return m_detail_href;
}
void OAIInventoryTask::setDetailHref(const QString &detail_href) {
    m_detail_href = detail_href;
    m_detail_href_isSet = true;
}

bool OAIInventoryTask::is_detail_href_Set() const{
    return m_detail_href_isSet;
}

bool OAIInventoryTask::is_detail_href_Valid() const{
    return m_detail_href_isValid;
}

QString OAIInventoryTask::getFeedType() const {
    return m_feed_type;
}
void OAIInventoryTask::setFeedType(const QString &feed_type) {
    m_feed_type = feed_type;
    m_feed_type_isSet = true;
}

bool OAIInventoryTask::is_feed_type_Set() const{
    return m_feed_type_isSet;
}

bool OAIInventoryTask::is_feed_type_Valid() const{
    return m_feed_type_isValid;
}

OAIInventoryFilterCriteria OAIInventoryTask::getFilterCriteria() const {
    return m_filter_criteria;
}
void OAIInventoryTask::setFilterCriteria(const OAIInventoryFilterCriteria &filter_criteria) {
    m_filter_criteria = filter_criteria;
    m_filter_criteria_isSet = true;
}

bool OAIInventoryTask::is_filter_criteria_Set() const{
    return m_filter_criteria_isSet;
}

bool OAIInventoryTask::is_filter_criteria_Valid() const{
    return m_filter_criteria_isValid;
}

QString OAIInventoryTask::getSchemaVersion() const {
    return m_schema_version;
}
void OAIInventoryTask::setSchemaVersion(const QString &schema_version) {
    m_schema_version = schema_version;
    m_schema_version_isSet = true;
}

bool OAIInventoryTask::is_schema_version_Set() const{
    return m_schema_version_isSet;
}

bool OAIInventoryTask::is_schema_version_Valid() const{
    return m_schema_version_isValid;
}

QString OAIInventoryTask::getStatus() const {
    return m_status;
}
void OAIInventoryTask::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIInventoryTask::is_status_Set() const{
    return m_status_isSet;
}

bool OAIInventoryTask::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIInventoryTask::getTaskId() const {
    return m_task_id;
}
void OAIInventoryTask::setTaskId(const QString &task_id) {
    m_task_id = task_id;
    m_task_id_isSet = true;
}

bool OAIInventoryTask::is_task_id_Set() const{
    return m_task_id_isSet;
}

bool OAIInventoryTask::is_task_id_Valid() const{
    return m_task_id_isValid;
}

OAIUploadSummary OAIInventoryTask::getUploadSummary() const {
    return m_upload_summary;
}
void OAIInventoryTask::setUploadSummary(const OAIUploadSummary &upload_summary) {
    m_upload_summary = upload_summary;
    m_upload_summary_isSet = true;
}

bool OAIInventoryTask::is_upload_summary_Set() const{
    return m_upload_summary_isSet;
}

bool OAIInventoryTask::is_upload_summary_Valid() const{
    return m_upload_summary_isValid;
}

bool OAIInventoryTask::isSet() const {
...
bool OAIInventoryTask::isValid() const {
