...
<a id="createTask"></a>
# **createTask**
> createTask(createTaskRequest, X_EBAY_C_MARKETPLACE_ID)
...
public class Example {
  public static void main(String[] args) {
    ...
    CreateTaskRequest createTaskRequest = new CreateTaskRequest(); // CreateTaskRequest | description not needed
    ...
    try {
      apiInstance.createTask(createTaskRequest, X_EBAY_C_MARKETPLACE_ID);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TaskApi#getInputFile");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TaskApi#getResultFile");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    Map<String, String> parameters = new HashMap(); // Map<String, String> | The parameters you want associated with the file.
    ...
    try {
      ...
      System.err.println("Exception when calling TaskApi#uploadFile");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **parameters** | [**Map&lt;String, String&gt;**](Map.md)| The parameters you want associated with the file. | [optional] |
