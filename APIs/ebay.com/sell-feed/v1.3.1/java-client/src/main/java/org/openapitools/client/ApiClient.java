...
public class ApiClient {
    ...
    private String basePath = "https://api.ebay.com/sell/feed/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1.3.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ebay.com/sell/feed/v1
