...
**tasks** | [**[OrderTask]**](OrderTask.md) | An array of the order tasks on this page. The tasks are sorted by creation date. An empty array is returned if the filter criteria excludes all tasks. | [optional] 
**total** | **Number** | The total number of order tasks that match the input criteria. | [optional] 
