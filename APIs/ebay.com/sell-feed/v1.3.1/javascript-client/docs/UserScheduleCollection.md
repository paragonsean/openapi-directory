# FeedApi.UserScheduleCollection
...
**schedules** | [**[UserScheduleResponse]**](UserScheduleResponse.md) | An array of the schedules on this page. An empty array is returned if the filter criteria excludes all tasks. | [optional] 
**total** | **Number** | The total number of schedules that match the input criteria. | [optional] 
