# FeedApi.InventoryTaskCollection
...
**tasks** | [**[InventoryTask]**](InventoryTask.md) | An array of the inventory tasks on this page. The tasks are sorted by creation date.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;strong&gt;Note:&lt;/strong&gt; An empty array is returned if the filter criteria excludes all tasks.&lt;/span&gt; | [optional] 
**total** | **Number** | The total number of inventory tasks that match the input criteria. | [optional] 
