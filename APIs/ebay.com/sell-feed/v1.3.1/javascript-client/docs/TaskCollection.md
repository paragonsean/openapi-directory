...
**tasks** | [**[Task]**](Task.md) | An array of the tasks on this page. The tasks are sorted by creation date. An empty array is returned if the filter criteria excludes all tasks.  | [optional] 
**total** | **Number** | The total number of tasks that match the input criteria. | [optional] 
