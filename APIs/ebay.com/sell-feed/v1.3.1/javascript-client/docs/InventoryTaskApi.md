...
let apiInstance = new FeedApi.InventoryTaskApi();
let createInventoryTaskRequest = new FeedApi.CreateInventoryTaskRequest(); // CreateInventoryTaskRequest | The request payload containing the version, feedType, and optional filterCriteria.
apiInstance.createInventoryTask(createInventoryTaskRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new FeedApi.InventoryTaskApi();
let taskId = "taskId_example"; // String | The ID of the task. This ID was generated when the task was created by the <strong>createInventoryTask</strong> method
apiInstance.getInventoryTask(taskId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> InventoryTaskCollection getInventoryTasks(opts)
...
apiInstance.getInventoryTasks(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
