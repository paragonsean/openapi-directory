...
let apiInstance = new FeedApi.OrderTaskApi();
let createOrderTaskRequest = new FeedApi.CreateOrderTaskRequest(); // CreateOrderTaskRequest | description not needed
apiInstance.createOrderTask(createOrderTaskRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new FeedApi.OrderTaskApi();
let taskId = "taskId_example"; // String | The ID of the task. This ID is generated when the task was created by the <b> createOrderTask</b> method.
apiInstance.getOrderTask(taskId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> OrderTaskCollection getOrderTasks(opts)
...
apiInstance.getOrderTasks(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
