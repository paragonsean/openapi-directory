# FeedApi.CustomerServiceMetricTaskCollection
...
**tasks** | [**[ServiceMetricsTask]**](ServiceMetricsTask.md) | An array of the customer service tasks on this page. The tasks are sorted by creation date. An empty array is returned if the filter criteria excludes all tasks. | [optional] 
**total** | **Number** | The total number of tasks that match the criteria. | [optional] 
