# FeedApi.ScheduleTemplateCollection
...
**scheduleTemplates** | [**[ScheduleTemplateResponse]**](ScheduleTemplateResponse.md) | An array of the schedule templates on this page. An empty array is returned if the filter criteria excludes all tasks. | [optional] 
**total** | **Number** | The total number of schedule templates that match the input criteria. | [optional] 
