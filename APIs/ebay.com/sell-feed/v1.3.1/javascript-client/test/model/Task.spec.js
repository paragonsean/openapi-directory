...
(function(root, factory) {
  ...
  describe('Task', function() {
    it('should create an instance of Task', function() {
      ...
      //var instance = new FeedApi.Task();
      //expect(instance).to.be.a(FeedApi.Task);
    });
    ...
    it('should have the property uploadSummary (base name: "uploadSummary")', function() {
      // uncomment below and update the code to test the property uploadSummary
      //var instance = new FeedApi.Task();
      //expect(instance).to.be();
    });
