...
export default class TaskApi {
    ...
    */
     ...
     * @param {module:model/CreateTaskRequest} createTaskRequest description not needed
    ...
    /**
     * Callback function to receive the result of the getInputFile operation.
     * @callback module:api/TaskApi~getInputFileCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/TaskApi~getInputFileCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    getInputFile(taskId, callback) {
      let postBody = null;
      // verify the required parameter 'taskId' is set
      if (taskId === undefined || taskId === null) {
        throw new Error("Missing the required parameter 'taskId' when calling getInputFile");
      }
     ...
     * @callback module:api/TaskApi~getResultFileCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TaskApi~getResultFileCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    getResultFile(taskId, callback) {
      let postBody = null;
      // verify the required parameter 'taskId' is set
      if (taskId === undefined || taskId === null) {
        throw new Error("Missing the required parameter 'taskId' when calling getResultFile");
      }
     ...
     * @callback module:api/TaskApi~uploadFileCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [creationDate] The file creation date. <br /><br /><b> Format: </b> UTC <code>yyyy-MM-ddThh:mm:ss.SSSZ</code><p><b>For example:</b><p>Created on September 8, 2019</p><p><code>2019-09-08T00:00:00.000Z</code></p>
     * @param {String} [fileName] The name of the file including its extension (for example, xml or csv) to be uploaded.
     * @param {String} [modificationDate] The file modified date. <br /><br /><b> Format: </b> UTC <code>yyyy-MM-ddThh:mm:ss.SSSZ</code><p><b>For example:</b><p>Created on September 9, 2019</p><p><code>2019-09-09T00:00:00.000Z</code></p>
     * @param {String} [name] A content identifier. The only presently supported name is <code>file</code>.
     * @param {Object.<String, {String: String}>} [parameters] The parameters you want associated with the file.
     * @param {String} [readDate] The date you read the file. <br /><br /><b> Format: </b> UTC <code>yyyy-MM-ddThh:mm:ss.SSSZ</code><p><b>For example:</b><p>Created on September 10, 2019</p><p><code>2019-09-10T00:00:00.000Z</code></p>
     * @param {Number} [size] The size of the file.
     * @param {String} [type] The file type. The only presently supported type is <code>form-data</code>.
     * @param {module:api/TaskApi~uploadFileCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    uploadFile(taskId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'taskId' is set
      if (taskId === undefined || taskId === null) {
        throw new Error("Missing the required parameter 'taskId' when calling uploadFile");
      }
      ...
      let formParams = {
        ...
        'modificationDate': opts['modificationDate'],
        'name': opts['name'],
