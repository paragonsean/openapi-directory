...
/**
 * The UpdateUserScheduleRequest model module.
 * @module model/UpdateUserScheduleRequest
 * @version v1.3.1
 */
class UpdateUserScheduleRequest {
    /**
     * Constructs a new <code>UpdateUserScheduleRequest</code>.
     * The type that defines the fields for a schedule update to a schedule generated with the Feed API.
     * @alias module:model/UpdateUserScheduleRequest
     */
    constructor() { 
        
        UpdateUserScheduleRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserScheduleRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserScheduleRequest} obj Optional instance to populate.
     * @return {module:model/UpdateUserScheduleRequest} The populated <code>UpdateUserScheduleRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserScheduleRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserScheduleRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserScheduleRequest</code>.
     */
 ...
 */
UpdateUserScheduleRequest.prototype['preferredTriggerDayOfMonth'] = undefined;
 ...
 */
UpdateUserScheduleRequest.prototype['preferredTriggerDayOfWeek'] = undefined;
 ...
 */
UpdateUserScheduleRequest.prototype['preferredTriggerHour'] = undefined;
 ...
 */
UpdateUserScheduleRequest.prototype['scheduleEndDate'] = undefined;

/**
 * The schedule name assigned by the user for the created schedule.
 * @member {String} scheduleName
 */
UpdateUserScheduleRequest.prototype['scheduleName'] = undefined;
 ...
 */
UpdateUserScheduleRequest.prototype['scheduleStartDate'] = undefined;
 ...
 */
UpdateUserScheduleRequest.prototype['schemaVersion'] = undefined;
...
export default UpdateUserScheduleRequest;
