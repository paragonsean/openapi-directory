...
/**
 * The CustomerServiceMetricTaskCollection model module.
 * @module model/CustomerServiceMetricTaskCollection
 * @version v1.3.1
 */
class CustomerServiceMetricTaskCollection {
    /**
     * Constructs a new <code>CustomerServiceMetricTaskCollection</code>.
     * @alias module:model/CustomerServiceMetricTaskCollection
     */
    constructor() { 
        
        CustomerServiceMetricTaskCollection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomerServiceMetricTaskCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomerServiceMetricTaskCollection} obj Optional instance to populate.
     * @return {module:model/CustomerServiceMetricTaskCollection} The populated <code>CustomerServiceMetricTaskCollection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerServiceMetricTaskCollection();
            ...
            if (data.hasOwnProperty('tasks')) {
                obj['tasks'] = ApiClient.convertToType(data['tasks'], [ServiceMetricsTask]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CustomerServiceMetricTaskCollection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerServiceMetricTaskCollection</code>.
     */
    static validateJSON(data) {
        ...
        if (data['tasks']) { // data not null
            ...
            for (const item of data['tasks']) {
                ServiceMetricsTask.validateJSON(item);
            };
        }
 ...
 * @member {String} href
 */
CustomerServiceMetricTaskCollection.prototype['href'] = undefined;
 ...
 * @member {Number} limit
 */
CustomerServiceMetricTaskCollection.prototype['limit'] = undefined;
 ...
 * @member {String} next
 */
CustomerServiceMetricTaskCollection.prototype['next'] = undefined;
 ...
 */
CustomerServiceMetricTaskCollection.prototype['offset'] = undefined;
 ...
 * @member {String} prev
 */
CustomerServiceMetricTaskCollection.prototype['prev'] = undefined;
 ...
 * @member {Array.<module:model/ServiceMetricsTask>} tasks
 */
CustomerServiceMetricTaskCollection.prototype['tasks'] = undefined;

/**
 * The total number of tasks that match the criteria.
 * @member {Number} total
 */
CustomerServiceMetricTaskCollection.prototype['total'] = undefined;
...
export default CustomerServiceMetricTaskCollection;
