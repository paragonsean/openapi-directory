...
/**
 * The OrderTaskCollection model module.
 * @module model/OrderTaskCollection
 * @version v1.3.1
 */
class OrderTaskCollection {
    /**
     * Constructs a new <code>OrderTaskCollection</code>.
     ...
     * @alias module:model/OrderTaskCollection
     */
    constructor() { 
        
        OrderTaskCollection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderTaskCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderTaskCollection} obj Optional instance to populate.
     * @return {module:model/OrderTaskCollection} The populated <code>OrderTaskCollection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderTaskCollection();
            ...
            if (data.hasOwnProperty('tasks')) {
                obj['tasks'] = ApiClient.convertToType(data['tasks'], [OrderTask]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderTaskCollection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderTaskCollection</code>.
     */
 ...
 * @member {String} href
 */
OrderTaskCollection.prototype['href'] = undefined;
 ...
 * @member {Number} limit
 */
OrderTaskCollection.prototype['limit'] = undefined;
 ...
 * @member {String} next
 */
OrderTaskCollection.prototype['next'] = undefined;
 ...
 */
OrderTaskCollection.prototype['offset'] = undefined;
 ...
 * @member {String} prev
 */
OrderTaskCollection.prototype['prev'] = undefined;
 ...
 * @member {Array.<module:model/OrderTask>} tasks
 */
OrderTaskCollection.prototype['tasks'] = undefined;

/**
 * The total number of order tasks that match the input criteria.
 * @member {Number} total
 */
OrderTaskCollection.prototype['total'] = undefined;
...
export default OrderTaskCollection;
