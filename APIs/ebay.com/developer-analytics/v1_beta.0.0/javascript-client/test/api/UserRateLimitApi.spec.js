...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnalyticsApi.UserRateLimitApi();
  });
  ...
  describe('UserRateLimitApi', function() {
    describe('getUserRateLimits', function() {
      it('should call getUserRateLimits successfully', function(done) {
        //uncomment below and update the code to test getUserRateLimits
        //instance.getUserRateLimits(function(error) {
