...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnalyticsApi.RateLimitsResponse();
  });
  ...
  describe('RateLimitsResponse', function() {
    it('should create an instance of RateLimitsResponse', function() {
      // uncomment below and update the code to test RateLimitsResponse
      //var instance = new AnalyticsApi.RateLimitsResponse();
      //expect(instance).to.be.a(AnalyticsApi.RateLimitsResponse);
    });
