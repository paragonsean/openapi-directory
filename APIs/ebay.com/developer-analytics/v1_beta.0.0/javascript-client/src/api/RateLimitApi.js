...
export default class RateLimitApi {
    ...
    */
     ...
     * @callback module:api/RateLimitApi~getRateLimitsCallback
     ...
     * @param {module:api/RateLimitApi~getRateLimitsCallback} callback The callback function, accepting three arguments: error, data, response
