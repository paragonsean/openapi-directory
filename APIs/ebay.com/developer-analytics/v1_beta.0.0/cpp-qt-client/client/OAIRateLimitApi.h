...
public:
    ...
    */
    virtual void getRateLimits(const ::OpenAPI::OptionalParam<QString> &api_context = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &api_name = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void getRateLimitsSignal(OAIRateLimitsResponse summary);


    void getRateLimitsSignalFull(OAIHttpRequestWorker *worker, OAIRateLimitsResponse summary);

    Q_DECL_DEPRECATED_X("Use getRateLimitsSignalError() instead")
    void getRateLimitsSignalE(OAIRateLimitsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getRateLimitsSignalError(OAIRateLimitsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
