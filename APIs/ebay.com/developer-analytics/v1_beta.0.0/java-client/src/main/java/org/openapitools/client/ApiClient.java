...
public class ApiClient {
    ...
    private String basePath = "https://api.ebay.com/developer/analytics/v1_beta";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ebay.com/developer/analytics/v1_beta
