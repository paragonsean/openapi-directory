...
public class RateLimitApi {
     ...
     */
    public okhttp3.Call getRateLimitsCall(String apiContext, String apiName, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getRateLimitsValidateBeforeCall(String apiContext, String apiName, final ApiCallback _callback) throws ApiException {
        return getRateLimitsCall(apiContext, apiName, _callback);
     ...
     */
    public RateLimitsResponse getRateLimits(String apiContext, String apiName) throws ApiException {
        ApiResponse<RateLimitsResponse> localVarResp = getRateLimitsWithHttpInfo(apiContext, apiName);
     ...
     */
    public ApiResponse<RateLimitsResponse> getRateLimitsWithHttpInfo(String apiContext, String apiName) throws ApiException {
        okhttp3.Call localVarCall = getRateLimitsValidateBeforeCall(apiContext, apiName, null);
     ...
     */
    public okhttp3.Call getRateLimitsAsync(String apiContext, String apiName, final ApiCallback<RateLimitsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRateLimitsValidateBeforeCall(apiContext, apiName, _callback);
        Type localVarReturnType = new TypeToken<RateLimitsResponse>(){}.getType();
