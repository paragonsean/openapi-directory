...
QString OAIMetricMetadata::getDataType() const {
    return m_data_type;
}
void OAIMetricMetadata::setDataType(const QString &data_type) {
    m_data_type = data_type;
    m_data_type_isSet = true;
}

bool OAIMetricMetadata::is_data_type_Set() const{
    return m_data_type_isSet;
}

bool OAIMetricMetadata::is_data_type_Valid() const{
    return m_data_type_isValid;
}

QString OAIMetricMetadata::getMetricKey() const {
    return m_metric_key;
}
void OAIMetricMetadata::setMetricKey(const QString &metric_key) {
    m_metric_key = metric_key;
    m_metric_key_isSet = true;
}

bool OAIMetricMetadata::is_metric_key_Set() const{
    return m_metric_key_isSet;
}

bool OAIMetricMetadata::is_metric_key_Valid() const{
