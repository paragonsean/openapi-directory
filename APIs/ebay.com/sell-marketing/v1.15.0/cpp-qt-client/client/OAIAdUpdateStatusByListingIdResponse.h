...
/*
 * OAIAdUpdateStatusByListingIdResponse.h
 *
 * A type that contains the fields for the ad update status by listing ID response.
 */

#ifndef OAIAdUpdateStatusByListingIdResponse_H
#define OAIAdUpdateStatusByListingIdResponse_H
...
class OAIAdUpdateStatusByListingIdResponse : public OAIObject {
public:
    OAIAdUpdateStatusByListingIdResponse();
    OAIAdUpdateStatusByListingIdResponse(QString json);
    ~OAIAdUpdateStatusByListingIdResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdUpdateStatusByListingIdResponse)

#endif // OAIAdUpdateStatusByListingIdResponse_H
