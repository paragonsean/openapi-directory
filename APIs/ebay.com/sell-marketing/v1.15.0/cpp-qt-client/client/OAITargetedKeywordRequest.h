...
/*
 * OAITargetedKeywordRequest.h
 *
 * A type that provides details for the targeted keywords.
 */

#ifndef OAITargetedKeywordRequest_H
#define OAITargetedKeywordRequest_H
...
class OAITargetedKeywordRequest : public OAIObject {
public:
    OAITargetedKeywordRequest();
    OAITargetedKeywordRequest(QString json);
    ~OAITargetedKeywordRequest() override;
    ...
    QList<QString> getAdditionalInfo() const;
    void setAdditionalInfo(const QList<QString> &additional_info);
    bool is_additional_info_Set() const;
    bool is_additional_info_Valid() const;

    QList<QString> getExclusions() const;
    void setExclusions(const QList<QString> &exclusions);
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetedKeywordRequest)

#endif // OAITargetedKeywordRequest_H
