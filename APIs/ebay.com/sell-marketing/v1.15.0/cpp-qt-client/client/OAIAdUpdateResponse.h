...
/*
 * OAIAdUpdateResponse.h
 *
 * A type that contains the fields for the ad update response.
 */

#ifndef OAIAdUpdateResponse_H
#define OAIAdUpdateResponse_H
...
class OAIAdUpdateResponse : public OAIObject {
public:
    OAIAdUpdateResponse();
    OAIAdUpdateResponse(QString json);
    ~OAIAdUpdateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdUpdateResponse)

#endif // OAIAdUpdateResponse_H
