...
/*
 * OAIDeleteAdResponse.h
 *
 * This type defines the fields returned in a delete-ad response.
 */

#ifndef OAIDeleteAdResponse_H
#define OAIDeleteAdResponse_H
...
class OAIDeleteAdResponse : public OAIObject {
public:
    OAIDeleteAdResponse();
    OAIDeleteAdResponse(QString json);
    ~OAIDeleteAdResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAdResponse)

#endif // OAIDeleteAdResponse_H
