...
#ifndef OAIItemsPagedCollection_H
#define OAIItemsPagedCollection_H
...
namespace OpenAPI {
class OAIListingDetail;
class OAIError;

class OAIItemsPagedCollection : public OAIObject {
public:
    OAIItemsPagedCollection();
    OAIItemsPagedCollection(QString json);
    ~OAIItemsPagedCollection() override;
    ...
    QList<OAIListingDetail> getListings() const;
    void setListings(const QList<OAIListingDetail> &listings);
...
private:
    ...
    QList<OAIListingDetail> m_listings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemsPagedCollection)

#endif // OAIItemsPagedCollection_H
