...
/*
 * OAIReportTaskPagedCollection.h
 *
...
#ifndef OAIReportTaskPagedCollection_H
#define OAIReportTaskPagedCollection_H
...
class OAIReportTaskPagedCollection : public OAIObject {
public:
    OAIReportTaskPagedCollection();
    OAIReportTaskPagedCollection(QString json);
    ~OAIReportTaskPagedCollection() override;
    ...
    QList<OAIReportTask> getReportTasks() const;
    void setReportTasks(const QList<OAIReportTask> &report_tasks);
    bool is_report_tasks_Set() const;
    bool is_report_tasks_Valid() const;
...
private:
    ...
    QList<OAIReportTask> m_report_tasks;
    bool m_report_tasks_isSet;
    bool m_report_tasks_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportTaskPagedCollection)

#endif // OAIReportTaskPagedCollection_H
