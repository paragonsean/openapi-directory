...
/*
 * OAIPromotionsPagedCollection.h
 *
...
#ifndef OAIPromotionsPagedCollection_H
#define OAIPromotionsPagedCollection_H
...
namespace OpenAPI {
class OAIPromotionDetail;

class OAIPromotionsPagedCollection : public OAIObject {
public:
    OAIPromotionsPagedCollection();
    OAIPromotionsPagedCollection(QString json);
    ~OAIPromotionsPagedCollection() override;
    ...
    QList<OAIPromotionDetail> getPromotions() const;
    void setPromotions(const QList<OAIPromotionDetail> &promotions);
...
private:
    ...
    QList<OAIPromotionDetail> m_promotions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPromotionsPagedCollection)

#endif // OAIPromotionsPagedCollection_H
