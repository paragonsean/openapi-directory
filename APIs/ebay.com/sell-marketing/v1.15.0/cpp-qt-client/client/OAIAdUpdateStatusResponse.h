...
/*
 * OAIAdUpdateStatusResponse.h
 *
 * A type that contains the fields for the ad update status response.
 */

#ifndef OAIAdUpdateStatusResponse_H
#define OAIAdUpdateStatusResponse_H
...
class OAIAdUpdateStatusResponse : public OAIObject {
public:
    OAIAdUpdateStatusResponse();
    OAIAdUpdateStatusResponse(QString json);
    ~OAIAdUpdateStatusResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdUpdateStatusResponse)

#endif // OAIAdUpdateStatusResponse_H
