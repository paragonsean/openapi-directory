...
QString OAIAdResponse::getAdId() const {
    return m_ad_id;
}
void OAIAdResponse::setAdId(const QString &ad_id) {
    m_ad_id = ad_id;
    m_ad_id_isSet = true;
}

bool OAIAdResponse::is_ad_id_Set() const{
    return m_ad_id_isSet;
}

bool OAIAdResponse::is_ad_id_Valid() const{
    return m_ad_id_isValid;
}

QList<OAIError> OAIAdResponse::getErrors() const {
    return m_errors;
}
void OAIAdResponse::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIAdResponse::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIAdResponse::is_errors_Valid() const{
    return m_errors_isValid;
}

QString OAIAdResponse::getHref() const {
    return m_href;
}
void OAIAdResponse::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAIAdResponse::is_href_Set() const{
    return m_href_isSet;
}

bool OAIAdResponse::is_href_Valid() const{
    return m_href_isValid;
}

QString OAIAdResponse::getListingId() const {
    return m_listing_id;
}
void OAIAdResponse::setListingId(const QString &listing_id) {
    m_listing_id = listing_id;
    m_listing_id_isSet = true;
}

bool OAIAdResponse::is_listing_id_Set() const{
    return m_listing_id_isSet;
}

bool OAIAdResponse::is_listing_id_Valid() const{
    return m_listing_id_isValid;
}

qint32 OAIAdResponse::getStatusCode() const {
    return m_status_code;
}
void OAIAdResponse::setStatusCode(const qint32 &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAIAdResponse::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAIAdResponse::is_status_code_Valid() const{
