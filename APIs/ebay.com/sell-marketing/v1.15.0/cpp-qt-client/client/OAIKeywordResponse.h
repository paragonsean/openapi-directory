...
/*
 * OAIKeywordResponse.h
 *
 * A type that defines the response fields used by the &lt;b&gt;Keyword&lt;/b&gt; method.
 */

#ifndef OAIKeywordResponse_H
#define OAIKeywordResponse_H
...
class OAIKeywordResponse : public OAIObject {
public:
    OAIKeywordResponse();
    OAIKeywordResponse(QString json);
    ~OAIKeywordResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeywordResponse)

#endif // OAIKeywordResponse_H
