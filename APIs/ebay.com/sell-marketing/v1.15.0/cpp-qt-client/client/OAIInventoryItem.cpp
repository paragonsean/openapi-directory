...
QString OAIInventoryItem::getInventoryReferenceId() const {
    return m_inventory_reference_id;
}
void OAIInventoryItem::setInventoryReferenceId(const QString &inventory_reference_id) {
    m_inventory_reference_id = inventory_reference_id;
    m_inventory_reference_id_isSet = true;
}

bool OAIInventoryItem::is_inventory_reference_id_Set() const{
    return m_inventory_reference_id_isSet;
}

bool OAIInventoryItem::is_inventory_reference_id_Valid() const{
