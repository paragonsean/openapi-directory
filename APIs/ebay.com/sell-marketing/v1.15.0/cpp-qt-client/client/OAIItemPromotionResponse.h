...
/*
 * OAIItemPromotionResponse.h
 *
 * This complex type defines the fields returned for an item (threshold) promotion.
 */

#ifndef OAIItemPromotionResponse_H
#define OAIItemPromotionResponse_H
...
class OAIItemPromotionResponse : public OAIObject {
public:
    OAIItemPromotionResponse();
    OAIItemPromotionResponse(QString json);
    ~OAIItemPromotionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemPromotionResponse)

#endif // OAIItemPromotionResponse_H
