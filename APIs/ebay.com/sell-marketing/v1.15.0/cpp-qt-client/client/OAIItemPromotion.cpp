...
OAIItemPromotion::OAIItemPromotion(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIItemPromotion::OAIItemPromotion() {
    this->initializeModel();
}

OAIItemPromotion::~OAIItemPromotion() {}

void OAIItemPromotion::initializeModel() {
...
void OAIItemPromotion::fromJson(QString jsonString) {
...
void OAIItemPromotion::fromJsonObject(QJsonObject json) {
...
QString OAIItemPromotion::asJson() const {
...
QJsonObject OAIItemPromotion::asJsonObject() const {
    QJsonObject obj;
...
bool OAIItemPromotion::isApplyDiscountToSingleItemOnly() const {
    return m_apply_discount_to_single_item_only;
}
void OAIItemPromotion::setApplyDiscountToSingleItemOnly(const bool &apply_discount_to_single_item_only) {
    m_apply_discount_to_single_item_only = apply_discount_to_single_item_only;
    m_apply_discount_to_single_item_only_isSet = true;
}

bool OAIItemPromotion::is_apply_discount_to_single_item_only_Set() const{
    return m_apply_discount_to_single_item_only_isSet;
}

bool OAIItemPromotion::is_apply_discount_to_single_item_only_Valid() const{
    return m_apply_discount_to_single_item_only_isValid;
}

OAIAmount OAIItemPromotion::getBudget() const {
    return m_budget;
}
void OAIItemPromotion::setBudget(const OAIAmount &budget) {
    m_budget = budget;
    m_budget_isSet = true;
}

bool OAIItemPromotion::is_budget_Set() const{
    return m_budget_isSet;
}

bool OAIItemPromotion::is_budget_Valid() const{
    return m_budget_isValid;
}

OAICouponConfiguration OAIItemPromotion::getCouponConfiguration() const {
    return m_coupon_configuration;
}
void OAIItemPromotion::setCouponConfiguration(const OAICouponConfiguration &coupon_configuration) {
    m_coupon_configuration = coupon_configuration;
    m_coupon_configuration_isSet = true;
}

bool OAIItemPromotion::is_coupon_configuration_Set() const{
    return m_coupon_configuration_isSet;
}

bool OAIItemPromotion::is_coupon_configuration_Valid() const{
    return m_coupon_configuration_isValid;
}

QString OAIItemPromotion::getDescription() const {
    return m_description;
}
void OAIItemPromotion::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIItemPromotion::is_description_Set() const{
    return m_description_isSet;
}

bool OAIItemPromotion::is_description_Valid() const{
    return m_description_isValid;
}

QList<OAIDiscountRule> OAIItemPromotion::getDiscountRules() const {
    return m_discount_rules;
}
void OAIItemPromotion::setDiscountRules(const QList<OAIDiscountRule> &discount_rules) {
    m_discount_rules = discount_rules;
    m_discount_rules_isSet = true;
}

bool OAIItemPromotion::is_discount_rules_Set() const{
    return m_discount_rules_isSet;
}

bool OAIItemPromotion::is_discount_rules_Valid() const{
    return m_discount_rules_isValid;
}

QString OAIItemPromotion::getEndDate() const {
    return m_end_date;
}
void OAIItemPromotion::setEndDate(const QString &end_date) {
    m_end_date = end_date;
    m_end_date_isSet = true;
}

bool OAIItemPromotion::is_end_date_Set() const{
    return m_end_date_isSet;
}

bool OAIItemPromotion::is_end_date_Valid() const{
    return m_end_date_isValid;
}

OAIInventoryCriterion OAIItemPromotion::getInventoryCriterion() const {
    return m_inventory_criterion;
}
void OAIItemPromotion::setInventoryCriterion(const OAIInventoryCriterion &inventory_criterion) {
    m_inventory_criterion = inventory_criterion;
    m_inventory_criterion_isSet = true;
}

bool OAIItemPromotion::is_inventory_criterion_Set() const{
    return m_inventory_criterion_isSet;
}

bool OAIItemPromotion::is_inventory_criterion_Valid() const{
    return m_inventory_criterion_isValid;
}

QString OAIItemPromotion::getMarketplaceId() const {
    return m_marketplace_id;
}
void OAIItemPromotion::setMarketplaceId(const QString &marketplace_id) {
    m_marketplace_id = marketplace_id;
    m_marketplace_id_isSet = true;
}

bool OAIItemPromotion::is_marketplace_id_Set() const{
    return m_marketplace_id_isSet;
}

bool OAIItemPromotion::is_marketplace_id_Valid() const{
    return m_marketplace_id_isValid;
}

QString OAIItemPromotion::getName() const {
    return m_name;
}
void OAIItemPromotion::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIItemPromotion::is_name_Set() const{
    return m_name_isSet;
}

bool OAIItemPromotion::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIItemPromotion::getPriority() const {
    return m_priority;
}
void OAIItemPromotion::setPriority(const QString &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIItemPromotion::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIItemPromotion::is_priority_Valid() const{
    return m_priority_isValid;
}

QString OAIItemPromotion::getPromotionImageUrl() const {
    return m_promotion_image_url;
}
void OAIItemPromotion::setPromotionImageUrl(const QString &promotion_image_url) {
    m_promotion_image_url = promotion_image_url;
    m_promotion_image_url_isSet = true;
}

bool OAIItemPromotion::is_promotion_image_url_Set() const{
    return m_promotion_image_url_isSet;
}

bool OAIItemPromotion::is_promotion_image_url_Valid() const{
    return m_promotion_image_url_isValid;
}

QString OAIItemPromotion::getPromotionStatus() const {
    return m_promotion_status;
}
void OAIItemPromotion::setPromotionStatus(const QString &promotion_status) {
    m_promotion_status = promotion_status;
    m_promotion_status_isSet = true;
}

bool OAIItemPromotion::is_promotion_status_Set() const{
    return m_promotion_status_isSet;
}

bool OAIItemPromotion::is_promotion_status_Valid() const{
    return m_promotion_status_isValid;
}

QString OAIItemPromotion::getPromotionType() const {
    return m_promotion_type;
}
void OAIItemPromotion::setPromotionType(const QString &promotion_type) {
    m_promotion_type = promotion_type;
    m_promotion_type_isSet = true;
}

bool OAIItemPromotion::is_promotion_type_Set() const{
    return m_promotion_type_isSet;
}

bool OAIItemPromotion::is_promotion_type_Valid() const{
    return m_promotion_type_isValid;
}

QString OAIItemPromotion::getStartDate() const {
    return m_start_date;
}
void OAIItemPromotion::setStartDate(const QString &start_date) {
    m_start_date = start_date;
    m_start_date_isSet = true;
}

bool OAIItemPromotion::is_start_date_Set() const{
    return m_start_date_isSet;
}

bool OAIItemPromotion::is_start_date_Valid() const{
    return m_start_date_isValid;
}

bool OAIItemPromotion::isSet() const {
...
bool OAIItemPromotion::isValid() const {
