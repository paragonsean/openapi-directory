...
QString OAIAlert::getAlertType() const {
    return m_alert_type;
}
void OAIAlert::setAlertType(const QString &alert_type) {
...
QList<OAIAlertDetails> OAIAlert::getDetails() const {
    return m_details;
}
void OAIAlert::setDetails(const QList<OAIAlertDetails> &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIAlert::is_details_Set() const{
    return m_details_isSet;
}

bool OAIAlert::is_details_Valid() const{
