...
/*
 * OAIKeywordPagedCollectionResponse.h
 *
 * A type that defines the keywords of the paged collection.
 */

#ifndef OAIKeywordPagedCollectionResponse_H
#define OAIKeywordPagedCollectionResponse_H
...
class OAIKeywordPagedCollectionResponse : public OAIObject {
public:
    OAIKeywordPagedCollectionResponse();
    OAIKeywordPagedCollectionResponse(QString json);
    ~OAIKeywordPagedCollectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeywordPagedCollectionResponse)

#endif // OAIKeywordPagedCollectionResponse_H
