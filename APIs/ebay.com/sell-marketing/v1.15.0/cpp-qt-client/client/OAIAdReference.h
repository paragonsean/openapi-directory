...
#ifndef OAIAdReference_H
#define OAIAdReference_H
...
class OAIAdReference : public OAIObject {
public:
    OAIAdReference();
    OAIAdReference(QString json);
    ~OAIAdReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdReference)

#endif // OAIAdReference_H
