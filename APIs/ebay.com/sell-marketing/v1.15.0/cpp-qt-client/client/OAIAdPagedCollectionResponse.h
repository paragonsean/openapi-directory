...
/*
 * OAIAdPagedCollectionResponse.h
 *
...
#ifndef OAIAdPagedCollectionResponse_H
#define OAIAdPagedCollectionResponse_H
...
class OAIAdPagedCollectionResponse : public OAIObject {
public:
    OAIAdPagedCollectionResponse();
    OAIAdPagedCollectionResponse(QString json);
    ~OAIAdPagedCollectionResponse() override;
    ...
    QList<OAIAd> getAds() const;
    void setAds(const QList<OAIAd> &ads);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdPagedCollectionResponse)

#endif // OAIAdPagedCollectionResponse_H
