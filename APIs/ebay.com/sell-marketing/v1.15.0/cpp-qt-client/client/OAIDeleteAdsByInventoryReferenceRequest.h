...
/*
 * OAIDeleteAdsByInventoryReferenceRequest.h
 *
...
#ifndef OAIDeleteAdsByInventoryReferenceRequest_H
#define OAIDeleteAdsByInventoryReferenceRequest_H
...
class OAIDeleteAdsByInventoryReferenceRequest : public OAIObject {
public:
    OAIDeleteAdsByInventoryReferenceRequest();
    OAIDeleteAdsByInventoryReferenceRequest(QString json);
    ~OAIDeleteAdsByInventoryReferenceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAdsByInventoryReferenceRequest)

#endif // OAIDeleteAdsByInventoryReferenceRequest_H
