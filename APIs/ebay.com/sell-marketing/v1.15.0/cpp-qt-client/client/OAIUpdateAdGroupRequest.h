...
/*
 * OAIUpdateAdGroupRequest.h
 *
 * A type that contains the fields used by the &lt;b&gt;UpdateAdGroup&lt;/b&gt; request.
 */

#ifndef OAIUpdateAdGroupRequest_H
#define OAIUpdateAdGroupRequest_H
...
class OAIUpdateAdGroupRequest : public OAIObject {
public:
    OAIUpdateAdGroupRequest();
    OAIUpdateAdGroupRequest(QString json);
    ~OAIUpdateAdGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAdGroupRequest)

#endif // OAIUpdateAdGroupRequest_H
