...
#ifndef OAIAdReferences_H
#define OAIAdReferences_H
...
class OAIAdReferences : public OAIObject {
public:
    OAIAdReferences();
    OAIAdReferences(QString json);
    ~OAIAdReferences() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdReferences)

#endif // OAIAdReferences_H
