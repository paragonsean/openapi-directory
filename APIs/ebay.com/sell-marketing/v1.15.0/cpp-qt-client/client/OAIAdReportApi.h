...
#ifndef OAI_OAIAdReportApi_H
#define OAI_OAIAdReportApi_H
...
class OAIAdReportApi : public QObject {
    Q_OBJECT

public:
    OAIAdReportApi(const int timeOut = 0);
    ~OAIAdReportApi();
...
Q_SIGNALS:
    ...
    void getReportSignal(OAIObject summary);


    void getReportSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);

    Q_DECL_DEPRECATED_X("Use getReportSignalError() instead")
    void getReportSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getReportSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
