...
/*
 * OAIDeleteAdRequest.h
 *
 * This type defines the fields used in a delete-ad request.
 */

#ifndef OAIDeleteAdRequest_H
#define OAIDeleteAdRequest_H
...
class OAIDeleteAdRequest : public OAIObject {
public:
    OAIDeleteAdRequest();
    OAIDeleteAdRequest(QString json);
    ~OAIDeleteAdRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAdRequest)

#endif // OAIDeleteAdRequest_H
