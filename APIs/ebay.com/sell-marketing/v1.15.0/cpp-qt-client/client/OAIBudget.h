...
public:
    ...
    QString getBudgetStatus() const;
    void setBudgetStatus(const QString &budget_status);
    bool is_budget_status_Set() const;
    bool is_budget_status_Valid() const;
...
private:
    ...
    QString m_budget_status;
    bool m_budget_status_isSet;
    bool m_budget_status_isValid;
};
