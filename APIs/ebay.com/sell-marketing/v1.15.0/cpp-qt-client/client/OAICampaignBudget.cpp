...
OAIBudget OAICampaignBudget::getDaily() const {
    return m_daily;
}
void OAICampaignBudget::setDaily(const OAIBudget &daily) {
    m_daily = daily;
    m_daily_isSet = true;
}

bool OAICampaignBudget::is_daily_Set() const{
    return m_daily_isSet;
}

bool OAICampaignBudget::is_daily_Valid() const{
