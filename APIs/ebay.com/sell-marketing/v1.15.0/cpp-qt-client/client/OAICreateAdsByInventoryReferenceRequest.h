...
/*
 * OAICreateAdsByInventoryReferenceRequest.h
 *
 * This type defines the fields needed to create ads by inventory reference ID request.
 */

#ifndef OAICreateAdsByInventoryReferenceRequest_H
#define OAICreateAdsByInventoryReferenceRequest_H
...
class OAICreateAdsByInventoryReferenceRequest : public OAIObject {
public:
    OAICreateAdsByInventoryReferenceRequest();
    OAICreateAdsByInventoryReferenceRequest(QString json);
    ~OAICreateAdsByInventoryReferenceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAdsByInventoryReferenceRequest)

#endif // OAICreateAdsByInventoryReferenceRequest_H
