...
#ifndef OAIInventoryReference_H
#define OAIInventoryReference_H
...
class OAIInventoryReference : public OAIObject {
public:
    OAIInventoryReference();
    OAIInventoryReference(QString json);
    ~OAIInventoryReference() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInventoryReference)

#endif // OAIInventoryReference_H
