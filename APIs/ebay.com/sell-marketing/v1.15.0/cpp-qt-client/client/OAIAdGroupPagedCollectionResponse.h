...
/*
 * OAIAdGroupPagedCollectionResponse.h
 *
...
#ifndef OAIAdGroupPagedCollectionResponse_H
#define OAIAdGroupPagedCollectionResponse_H
...
class OAIAdGroupPagedCollectionResponse : public OAIObject {
public:
    OAIAdGroupPagedCollectionResponse();
    OAIAdGroupPagedCollectionResponse(QString json);
    ~OAIAdGroupPagedCollectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdGroupPagedCollectionResponse)

#endif // OAIAdGroupPagedCollectionResponse_H
