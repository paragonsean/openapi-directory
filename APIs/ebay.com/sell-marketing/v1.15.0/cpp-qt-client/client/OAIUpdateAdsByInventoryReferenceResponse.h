...
/*
 * OAIUpdateAdsByInventoryReferenceResponse.h
 *
 * A type that contains the response fields used by the &lt;b&gt;UpdateAdsByInventoryReference&lt;/b&gt; method.
 */

#ifndef OAIUpdateAdsByInventoryReferenceResponse_H
#define OAIUpdateAdsByInventoryReferenceResponse_H
...
class OAIUpdateAdsByInventoryReferenceResponse : public OAIObject {
public:
    OAIUpdateAdsByInventoryReferenceResponse();
    OAIUpdateAdsByInventoryReferenceResponse(QString json);
    ~OAIUpdateAdsByInventoryReferenceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAdsByInventoryReferenceResponse)

#endif // OAIUpdateAdsByInventoryReferenceResponse_H
