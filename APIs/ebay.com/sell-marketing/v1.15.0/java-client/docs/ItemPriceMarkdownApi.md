...
<a id="createItemPriceMarkdownPromotion"></a>
...
import org.openapitools.client.api.ItemPriceMarkdownApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ItemPriceMarkdownApi apiInstance = new ItemPriceMarkdownApi(defaultClient);
    ItemPriceMarkdown itemPriceMarkdown = new ItemPriceMarkdown(); // ItemPriceMarkdown | This type defines the fields that describe an item price markdown promotion.
    try {
      Object result = apiInstance.createItemPriceMarkdownPromotion(itemPriceMarkdown);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ItemPriceMarkdownApi#createItemPriceMarkdownPromotion");
...
<a id="deleteItemPriceMarkdownPromotion"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ItemPriceMarkdownApi#deleteItemPriceMarkdownPromotion");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getItemPriceMarkdownPromotion"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ItemPriceMarkdownApi#getItemPriceMarkdownPromotion");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateItemPriceMarkdownPromotion"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ItemPriceMarkdownApi#updateItemPriceMarkdownPromotion");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
