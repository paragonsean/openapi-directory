...
import org.openapitools.client.api.AdReportTaskApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    AdReportTaskApi apiInstance = new AdReportTaskApi(defaultClient);
    CreateReportTask createReportTask = new CreateReportTask(); // CreateReportTask | The container for the fields that define the report task.
    try {
      apiInstance.createReportTask(createReportTask);
    } catch (ApiException e) {
      System.err.println("Exception when calling AdReportTaskApi#createReportTask");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AdReportTaskApi#deleteReportTask");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AdReportTaskApi#getReportTask");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AdReportTaskApi#getReportTasks");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
