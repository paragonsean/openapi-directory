...
public class DeleteAdsByInventoryReferenceResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAdsByInventoryReferenceResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAdsByInventoryReferenceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAdsByInventoryReferenceResponse is not found in the empty JSON string", DeleteAdsByInventoryReferenceResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAdsByInventoryReferenceResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAdsByInventoryReferenceResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAdsByInventoryReferenceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAdsByInventoryReferenceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAdsByInventoryReferenceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAdsByInventoryReferenceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAdsByInventoryReferenceResponse>() {
           @Override
           public void write(JsonWriter out, DeleteAdsByInventoryReferenceResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAdsByInventoryReferenceResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAdsByInventoryReferenceResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAdsByInventoryReferenceResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteAdsByInventoryReferenceResponse
   */
  public static DeleteAdsByInventoryReferenceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAdsByInventoryReferenceResponse.class);
  }

  /**
   * Convert an instance of DeleteAdsByInventoryReferenceResponse to an JSON string
   *
   * @return JSON string
   */
