...
public class UpdateAdrateStrategyRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAdrateStrategyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAdrateStrategyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAdrateStrategyRequest is not found in the empty JSON string", UpdateAdrateStrategyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAdrateStrategyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAdrateStrategyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAdrateStrategyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAdrateStrategyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAdrateStrategyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAdrateStrategyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAdrateStrategyRequest>() {
           @Override
           public void write(JsonWriter out, UpdateAdrateStrategyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAdrateStrategyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAdrateStrategyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAdrateStrategyRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateAdrateStrategyRequest
   */
  public static UpdateAdrateStrategyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAdrateStrategyRequest.class);
  }

  /**
   * Convert an instance of UpdateAdrateStrategyRequest to an JSON string
   *
   * @return JSON string
   */
