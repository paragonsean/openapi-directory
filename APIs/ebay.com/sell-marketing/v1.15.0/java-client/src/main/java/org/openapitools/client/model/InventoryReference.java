...
public class InventoryReference {
   ...
   * @throws IOException if the JSON Element is invalid with respect to InventoryReference
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InventoryReference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InventoryReference is not found in the empty JSON string", InventoryReference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InventoryReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InventoryReference` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InventoryReference.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InventoryReference' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InventoryReference> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InventoryReference.class));

       return (TypeAdapter<T>) new TypeAdapter<InventoryReference>() {
           @Override
           public void write(JsonWriter out, InventoryReference value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InventoryReference read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InventoryReference given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InventoryReference
   * @throws IOException if the JSON string is invalid with respect to InventoryReference
   */
  public static InventoryReference fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InventoryReference.class);
  }

  /**
   * Convert an instance of InventoryReference to an JSON string
   *
   * @return JSON string
   */
