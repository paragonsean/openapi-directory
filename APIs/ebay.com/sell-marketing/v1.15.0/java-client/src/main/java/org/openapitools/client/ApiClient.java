...
public class ApiClient {
    ...
    private String basePath = "https://api.ebay.com/sell/marketing/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1.15.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ebay.com/sell/marketing/v1
