...
public class CampaignPagedCollectionResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CampaignPagedCollectionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignPagedCollectionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignPagedCollectionResponse is not found in the empty JSON string", CampaignPagedCollectionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignPagedCollectionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignPagedCollectionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignPagedCollectionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignPagedCollectionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignPagedCollectionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignPagedCollectionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignPagedCollectionResponse>() {
           @Override
           public void write(JsonWriter out, CampaignPagedCollectionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CampaignPagedCollectionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CampaignPagedCollectionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CampaignPagedCollectionResponse
   * @throws IOException if the JSON string is invalid with respect to CampaignPagedCollectionResponse
   */
  public static CampaignPagedCollectionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignPagedCollectionResponse.class);
  }

  /**
   * Convert an instance of CampaignPagedCollectionResponse to an JSON string
   *
   * @return JSON string
   */
