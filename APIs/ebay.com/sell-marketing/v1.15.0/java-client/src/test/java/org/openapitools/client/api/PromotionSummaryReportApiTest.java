...
/**
 * API tests for PromotionSummaryReportApi
 */
@Disabled
public class PromotionSummaryReportApiTest {

    private final PromotionSummaryReportApi api = new PromotionSummaryReportApi();
