...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketingApi.SelectionRule();
  });
  ...
  describe('SelectionRule', function() {
    it('should create an instance of SelectionRule', function() {
      // uncomment below and update the code to test SelectionRule
      //var instance = new MarketingApi.SelectionRule();
      //expect(instance).to.be.a(MarketingApi.SelectionRule);
    });
    ...
    it('should have the property categoryScope (base name: "categoryScope")', function() {
      // uncomment below and update the code to test the property categoryScope
      //var instance = new MarketingApi.SelectionRule();
      //expect(instance).to.be();
    });

    it('should have the property listingConditionIds (base name: "listingConditionIds")', function() {
      // uncomment below and update the code to test the property listingConditionIds
      //var instance = new MarketingApi.SelectionRule();
      //expect(instance).to.be();
    });
