...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketingApi.TargetedKeywordRequest();
  });
  ...
  describe('TargetedKeywordRequest', function() {
    it('should create an instance of TargetedKeywordRequest', function() {
      // uncomment below and update the code to test TargetedKeywordRequest
      //var instance = new MarketingApi.TargetedKeywordRequest();
      //expect(instance).to.be.a(MarketingApi.TargetedKeywordRequest);
    });
