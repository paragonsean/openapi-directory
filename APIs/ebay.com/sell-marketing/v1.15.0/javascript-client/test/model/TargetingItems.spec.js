...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketingApi.TargetingItems();
  });
  ...
  describe('TargetingItems', function() {
    it('should create an instance of TargetingItems', function() {
      // uncomment below and update the code to test TargetingItems
      //var instance = new MarketingApi.TargetingItems();
      //expect(instance).to.be.a(MarketingApi.TargetingItems);
    });
