...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketingApi.AlertDetails();
  });
  ...
  describe('AlertDetails', function() {
    it('should create an instance of AlertDetails', function() {
      // uncomment below and update the code to test AlertDetails
      //var instance = new MarketingApi.AlertDetails();
      //expect(instance).to.be.a(MarketingApi.AlertDetails);
    });
