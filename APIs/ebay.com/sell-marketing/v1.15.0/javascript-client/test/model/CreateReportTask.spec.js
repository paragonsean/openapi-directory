...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketingApi.CreateReportTask();
  });
  ...
  describe('CreateReportTask', function() {
    it('should create an instance of CreateReportTask', function() {
      // uncomment below and update the code to test CreateReportTask
      //var instance = new MarketingApi.CreateReportTask();
      //expect(instance).to.be.a(MarketingApi.CreateReportTask);
    });

    it('should have the property additionalRecords (base name: "additionalRecords")', function() {
      // uncomment below and update the code to test the property additionalRecords
      //var instance = new MarketingApi.CreateReportTask();
