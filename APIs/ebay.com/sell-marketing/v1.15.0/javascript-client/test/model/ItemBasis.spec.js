...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketingApi.ItemBasis();
  });
  ...
  describe('ItemBasis', function() {
    it('should create an instance of ItemBasis', function() {
      // uncomment below and update the code to test ItemBasis
      //var instance = new MarketingApi.ItemBasis();
      //expect(instance).to.be.a(MarketingApi.ItemBasis);
    });
