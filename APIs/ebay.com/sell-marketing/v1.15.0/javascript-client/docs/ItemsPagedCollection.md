# MarketingApi.ItemsPagedCollection
...
**listings** | [**[ListingDetail]**](ListingDetail.md) | An array of the listings associated with a promotion. | [optional] 
...
**warnings** | [**[Error]**](Error.md) | A list of warnings that were generated by the request. Warning do not stop processing, but should be checked to ensure that the response contains the correct information. | [optional] 
