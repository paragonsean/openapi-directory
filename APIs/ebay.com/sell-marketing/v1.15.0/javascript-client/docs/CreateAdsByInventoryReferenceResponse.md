# MarketingApi.CreateAdsByInventoryReferenceResponse
...
**ads** | [**[AdReference]**](AdReference.md) | A list of ad IDs. An ad ID is generated for each successfully created ad. | [optional] 
**errors** | [**[Error]**](Error.md) | An array of errors or warnings associated with the create-ads request. | [optional] 
...
**statusCode** | **Number** | An HTTP status code that indicates the response-status of the request. Check this code to see if the ads were successfuly created. | [optional] 
