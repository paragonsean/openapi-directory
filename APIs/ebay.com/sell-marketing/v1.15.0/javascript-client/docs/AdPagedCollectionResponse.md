# MarketingApi.AdPagedCollectionResponse

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**ads** | [**[Ad]**](Ad.md) | The list of ads that matched the request criteria. | [optional] 
**href** | **String** | The URI of the current page of results from the result set. | [optional] 
**limit** | **Number** | The number of items returned on a single page from the result set. This value can be set in the request with the &lt;b&gt;limit&lt;/b&gt; query parameter.&lt;p&gt;&lt;b&gt;Default&lt;/b&gt;: &lt;code&gt;10&lt;/code&gt; | [optional] 
