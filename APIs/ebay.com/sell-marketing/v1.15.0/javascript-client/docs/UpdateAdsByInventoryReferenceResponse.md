# MarketingApi.UpdateAdsByInventoryReferenceResponse

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**ads** | [**[AdReference]**](AdReference.md) | A list of ad IDs and links to retrieve them. | [optional] 
**errors** | [**[Error]**](Error.md) | A container for all of the errors associated with the specified inventory reference ID. | [optional] 
...
**statusCode** | **Number** | An HTTP status code that indicates whether or not the CPS ad was successfully updated. | [optional] 
