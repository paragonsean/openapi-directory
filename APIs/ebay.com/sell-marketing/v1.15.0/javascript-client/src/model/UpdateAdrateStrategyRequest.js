...
/**
 * The UpdateAdrateStrategyRequest model module.
 * @module model/UpdateAdrateStrategyRequest
 * @version v1.15.0
 */
class UpdateAdrateStrategyRequest {
    /**
     * Constructs a new <code>UpdateAdrateStrategyRequest</code>.
     * A type that defines the request fields used to update the ad rate strategy for a Promoted Listings ad campaign.
     * @alias module:model/UpdateAdrateStrategyRequest
     */
    constructor() { 
        
        UpdateAdrateStrategyRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateAdrateStrategyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAdrateStrategyRequest} obj Optional instance to populate.
     * @return {module:model/UpdateAdrateStrategyRequest} The populated <code>UpdateAdrateStrategyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAdrateStrategyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAdrateStrategyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAdrateStrategyRequest</code>.
     */
 ...
 */
UpdateAdrateStrategyRequest.prototype['adRateStrategy'] = undefined;
 ...
 */
UpdateAdrateStrategyRequest.prototype['bidPercentage'] = undefined;
 ...
 */
UpdateAdrateStrategyRequest.prototype['dynamicAdRatePreferences'] = undefined;
...
export default UpdateAdrateStrategyRequest;
