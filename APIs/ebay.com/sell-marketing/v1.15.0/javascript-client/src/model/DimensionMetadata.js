...
class DimensionMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dimensionKeyAnnotations')) {
                obj['dimensionKeyAnnotations'] = ApiClient.convertToType(data['dimensionKeyAnnotations'], [DimensionKeyAnnotation]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['dimensionKeyAnnotations']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['dimensionKeyAnnotations'])) {
                throw new Error("Expected the field `dimensionKeyAnnotations` to be an array in the JSON data but got " + data['dimensionKeyAnnotations']);
            }
            // validate the optional field `dimensionKeyAnnotations` (array)
            for (const item of data['dimensionKeyAnnotations']) {
                DimensionKeyAnnotation.validateJSON(item);
            };
        }
 ...
 */
DimensionMetadata.prototype['dataType'] = undefined;

/**
 * The name of the dimension used to create the report.
 * @member {String} dimensionKey
 */
DimensionMetadata.prototype['dimensionKey'] = undefined;

/**
 * An list of annotation keys associated with the specified dimension of the report.
 * @member {Array.<module:model/DimensionKeyAnnotation>} dimensionKeyAnnotations
 */
DimensionMetadata.prototype['dimensionKeyAnnotations'] = undefined;
