...
/**
 * The CreateAdRequest model module.
 * @module model/CreateAdRequest
 * @version v1.15.0
 */
class CreateAdRequest {
    /**
     * Constructs a new <code>CreateAdRequest</code>.
     * This type defines the fields for the create ad request.
     * @alias module:model/CreateAdRequest
     */
    constructor() { 
        
        CreateAdRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAdRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAdRequest} obj Optional instance to populate.
     * @return {module:model/CreateAdRequest} The populated <code>CreateAdRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAdRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAdRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAdRequest</code>.
     */
 ...
 */
CreateAdRequest.prototype['adGroupId'] = undefined;
 ...
 */
CreateAdRequest.prototype['bidPercentage'] = undefined;
 ...
 */
CreateAdRequest.prototype['listingId'] = undefined;
