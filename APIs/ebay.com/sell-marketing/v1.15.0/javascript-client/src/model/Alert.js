    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('details')) {
                obj['details'] = ApiClient.convertToType(data['details'], [AlertDetails]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['details']) { // data not null
            ...
            for (const item of data['details']) {
                AlertDetails.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/AlertDetails>} details
 */
Alert.prototype['details'] = undefined;
