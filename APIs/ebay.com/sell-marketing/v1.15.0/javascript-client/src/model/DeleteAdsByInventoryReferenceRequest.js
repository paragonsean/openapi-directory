...
/**
 * The DeleteAdsByInventoryReferenceRequest model module.
 * @module model/DeleteAdsByInventoryReferenceRequest
 * @version v1.15.0
 */
class DeleteAdsByInventoryReferenceRequest {
    /**
     * Constructs a new <code>DeleteAdsByInventoryReferenceRequest</code>.
     ...
     * @alias module:model/DeleteAdsByInventoryReferenceRequest
     */
    constructor() { 
        
        DeleteAdsByInventoryReferenceRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteAdsByInventoryReferenceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAdsByInventoryReferenceRequest} obj Optional instance to populate.
     * @return {module:model/DeleteAdsByInventoryReferenceRequest} The populated <code>DeleteAdsByInventoryReferenceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAdsByInventoryReferenceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAdsByInventoryReferenceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAdsByInventoryReferenceRequest</code>.
     */
 ...
 */
DeleteAdsByInventoryReferenceRequest.prototype['inventoryReferenceId'] = undefined;
 ...
 */
DeleteAdsByInventoryReferenceRequest.prototype['inventoryReferenceType'] = undefined;
...
export default DeleteAdsByInventoryReferenceRequest;
