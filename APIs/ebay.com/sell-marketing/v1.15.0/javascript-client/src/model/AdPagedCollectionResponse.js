...
/**
 * The AdPagedCollectionResponse model module.
 * @module model/AdPagedCollectionResponse
 * @version v1.15.0
 */
class AdPagedCollectionResponse {
    /**
     * Constructs a new <code>AdPagedCollectionResponse</code>.
     ...
     * @alias module:model/AdPagedCollectionResponse
     */
    constructor() { 
        
        AdPagedCollectionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdPagedCollectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdPagedCollectionResponse} obj Optional instance to populate.
     * @return {module:model/AdPagedCollectionResponse} The populated <code>AdPagedCollectionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdPagedCollectionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AdPagedCollectionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdPagedCollectionResponse</code>.
     */
 ...
 */
AdPagedCollectionResponse.prototype['ads'] = undefined;

/**
 * The URI of the current page of results from the result set.
 * @member {String} href
 */
AdPagedCollectionResponse.prototype['href'] = undefined;
 ...
 * @member {Number} limit
 */
AdPagedCollectionResponse.prototype['limit'] = undefined;
 ...
 * @member {String} next
 */
AdPagedCollectionResponse.prototype['next'] = undefined;
 ...
 */
AdPagedCollectionResponse.prototype['offset'] = undefined;
 ...
 * @member {String} prev
 */
AdPagedCollectionResponse.prototype['prev'] = undefined;
 ...
 * @member {Number} total
 */
AdPagedCollectionResponse.prototype['total'] = undefined;
...
export default AdPagedCollectionResponse;
