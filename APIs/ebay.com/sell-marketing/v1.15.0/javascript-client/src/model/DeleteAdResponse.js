...
/**
 * The DeleteAdResponse model module.
 * @module model/DeleteAdResponse
 * @version v1.15.0
 */
class DeleteAdResponse {
    /**
     * Constructs a new <code>DeleteAdResponse</code>.
     * This type defines the fields returned in a delete-ad response.
     * @alias module:model/DeleteAdResponse
     */
    constructor() { 
        
        DeleteAdResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteAdResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAdResponse} obj Optional instance to populate.
     * @return {module:model/DeleteAdResponse} The populated <code>DeleteAdResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAdResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAdResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAdResponse</code>.
     */
 ...
 */
DeleteAdResponse.prototype['statusCode'] = undefined;
...
export default DeleteAdResponse;
