...
/**
 * The SuggestedKeywords model module.
 * @module model/SuggestedKeywords
 * @version v1.15.0
 */
class SuggestedKeywords {
    /**
     * Constructs a new <code>SuggestedKeywords</code>.
     * The suggested keywords for the item.
     * @alias module:model/SuggestedKeywords
     */
    constructor() { 
        
        SuggestedKeywords.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SuggestedKeywords</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SuggestedKeywords} obj Optional instance to populate.
     * @return {module:model/SuggestedKeywords} The populated <code>SuggestedKeywords</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SuggestedKeywords();
    ...
    /**
     * Validates the JSON data with respect to <code>SuggestedKeywords</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SuggestedKeywords</code>.
     */
    static validateJSON(data) {
        if (data['additionalInfo']) { // data not null
            ...
            for (const item of data['additionalInfo']) {
                AdditionalInfo.validateJSON(item);
            };
        }
 ...
 */
SuggestedKeywords.prototype['additionalInfo'] = undefined;

/**
 * The text for the keyword.
 * @member {String} keywordText
 */
SuggestedKeywords.prototype['keywordText'] = undefined;
 ...
 */
SuggestedKeywords.prototype['matchType'] = undefined;
