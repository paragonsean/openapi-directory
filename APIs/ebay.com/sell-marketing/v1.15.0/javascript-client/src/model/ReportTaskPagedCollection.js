...
/**
 * The ReportTaskPagedCollection model module.
 * @module model/ReportTaskPagedCollection
 * @version v1.15.0
 */
class ReportTaskPagedCollection {
    /**
     * Constructs a new <code>ReportTaskPagedCollection</code>.
     ...
     * @alias module:model/ReportTaskPagedCollection
     */
    constructor() { 
        
        ReportTaskPagedCollection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReportTaskPagedCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReportTaskPagedCollection} obj Optional instance to populate.
     * @return {module:model/ReportTaskPagedCollection} The populated <code>ReportTaskPagedCollection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportTaskPagedCollection();
            ...
            if (data.hasOwnProperty('reportTasks')) {
                obj['reportTasks'] = ApiClient.convertToType(data['reportTasks'], [ReportTask]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ReportTaskPagedCollection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReportTaskPagedCollection</code>.
     */
    static validateJSON(data) {
        ...
        if (data['reportTasks']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['reportTasks'])) {
                throw new Error("Expected the field `reportTasks` to be an array in the JSON data but got " + data['reportTasks']);
            }
            // validate the optional field `reportTasks` (array)
            for (const item of data['reportTasks']) {
                ReportTask.validateJSON(item);
            };
        }
 ...
 * @member {String} href
 */
ReportTaskPagedCollection.prototype['href'] = undefined;
 ...
 * @member {Number} limit
 */
ReportTaskPagedCollection.prototype['limit'] = undefined;
 ...
 * @member {String} next
 */
ReportTaskPagedCollection.prototype['next'] = undefined;
 ...
 */
ReportTaskPagedCollection.prototype['offset'] = undefined;
 ...
 * @member {String} prev
 */
ReportTaskPagedCollection.prototype['prev'] = undefined;

/**
 * A list of report tasks contained on this page from the paginated response.
 * @member {Array.<module:model/ReportTask>} reportTasks
 */
ReportTaskPagedCollection.prototype['reportTasks'] = undefined;
 ...
 * @member {Number} total
 */
ReportTaskPagedCollection.prototype['total'] = undefined;
...
export default ReportTaskPagedCollection;
