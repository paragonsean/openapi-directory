...
/**
* AdReportTask service.
* @module api/AdReportTaskApi
* @version v1.15.0
*/
export default class AdReportTaskApi {

    /**
    * Constructs a new AdReportTaskApi. 
    * @alias module:api/AdReportTaskApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createReportTask operation.
     * @callback module:api/AdReportTaskApi~createReportTaskCallback
     ...
     * @param {module:model/CreateReportTask} createReportTask The container for the fields that define the report task.
     * @param {module:api/AdReportTaskApi~createReportTaskCallback} callback The callback function, accepting three arguments: error, data, response
     */
    createReportTask(createReportTask, callback) {
      let postBody = createReportTask;
      // verify the required parameter 'createReportTask' is set
      if (createReportTask === undefined || createReportTask === null) {
        throw new Error("Missing the required parameter 'createReportTask' when calling createReportTask");
      }
    ...
    /**
     * Callback function to receive the result of the deleteReportTask operation.
     * @callback module:api/AdReportTaskApi~deleteReportTaskCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AdReportTaskApi~deleteReportTaskCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteReportTask(reportTaskId, callback) {
      let postBody = null;
      // verify the required parameter 'reportTaskId' is set
      if (reportTaskId === undefined || reportTaskId === null) {
        throw new Error("Missing the required parameter 'reportTaskId' when calling deleteReportTask");
      }
    ...
    /**
     * Callback function to receive the result of the getReportTask operation.
     * @callback module:api/AdReportTaskApi~getReportTaskCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReportTask} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} reportTaskId A unique eBay-assigned ID for the report task that's generated when the report task is created by a call to <a href=\"/api-docs/sell/marketing/resources/ad_report_task/methods/createReportTask\">createReportTask</a>.
     * @param {module:api/AdReportTaskApi~getReportTaskCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReportTask}
     */
    getReportTask(reportTaskId, callback) {
      let postBody = null;
      // verify the required parameter 'reportTaskId' is set
      if (reportTaskId === undefined || reportTaskId === null) {
        throw new Error("Missing the required parameter 'reportTaskId' when calling getReportTask");
      }
    ...
    /**
     * Callback function to receive the result of the getReportTasks operation.
     * @callback module:api/AdReportTaskApi~getReportTasksCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReportTaskPagedCollection} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [reportTaskStatuses] This parameter filters the returned report tasks by their status. Supply a comma-separated list of the report statuses you want returned. The results are filtered to include only the report statuses you specify.<br /><br /><span class=\"tablenote\"><span style=\"color:#004680\"><strong>Note:</strong></span> The results might not include some report tasks if other search conditions exclude them.</span><br /><br /><b>Valid values: </b> <br>&nbsp;&nbsp;&nbsp;<code>PENDING</code> <br>&nbsp;&nbsp;&nbsp;<code>SUCCESS</code> <br>&nbsp;&nbsp;&nbsp;<code>FAILED</code>
     * @param {module:api/AdReportTaskApi~getReportTasksCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReportTaskPagedCollection}
     */
    getReportTasks(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'limit': opts['limit'],
        'offset': opts['offset'],
        'report_task_statuses': opts['reportTaskStatuses']
      };
      let headerParams = {
      };
      let formParams = {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ReportTaskPagedCollection;
      return this.apiClient.callApi(
        '/ad_report_task', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
