...
class UpdateBidPercentageRequest(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, bid_percentage: str=None):
        """UpdateBidPercentageRequest - a model defined in OpenAPI

        :param bid_percentage: The bid_percentage of this UpdateBidPercentageRequest.
        """
        self.openapi_types = {
            'bid_percentage': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateBidPercentageRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateBidPercentageRequest of this UpdateBidPercentageRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bid_percentage(self):
        """Gets the bid_percentage of this UpdateBidPercentageRequest.
        ...
        :return: The bid_percentage of this UpdateBidPercentageRequest.
        :rtype: str
        """
