...
class NegativeKeyword(Model):
    ...
    def __init__(self, ad_group_id: str=None, campaign_id: str=None, negative_keyword_id: str=None, negative_keyword_match_type: str=None, negative_keyword_status: str=None, negative_keyword_text: str=None):
        """NegativeKeyword - a model defined in OpenAPI

        :param ad_group_id: The ad_group_id of this NegativeKeyword.
        :param campaign_id: The campaign_id of this NegativeKeyword.
        :param negative_keyword_id: The negative_keyword_id of this NegativeKeyword.
        :param negative_keyword_match_type: The negative_keyword_match_type of this NegativeKeyword.
        :param negative_keyword_status: The negative_keyword_status of this NegativeKeyword.
        :param negative_keyword_text: The negative_keyword_text of this NegativeKeyword.
        """
        self.openapi_types = {
            'ad_group_id': str,
            'campaign_id': str,
    ...
    def ad_group_id(self):
        """Gets the ad_group_id of this NegativeKeyword.
        ...
        :return: The ad_group_id of this NegativeKeyword.
        :rtype: str
        """
    ...
    def campaign_id(self):
        """Gets the campaign_id of this NegativeKeyword.

        A unique eBay-assigned ID for a campaign. This ID is generated when a campaign is created.

        :return: The campaign_id of this NegativeKeyword.
        :rtype: str
        """
    ...
    def negative_keyword_id(self):
        """Gets the negative_keyword_id of this NegativeKeyword.
        ...
        :return: The negative_keyword_id of this NegativeKeyword.
        :rtype: str
        """
    ...
    def negative_keyword_match_type(self):
        """Gets the negative_keyword_match_type of this NegativeKeyword.
        ...
        :return: The negative_keyword_match_type of this NegativeKeyword.
        :rtype: str
        """
    ...
    def negative_keyword_status(self):
        """Gets the negative_keyword_status of this NegativeKeyword.
        ...
        :return: The negative_keyword_status of this NegativeKeyword.
        :rtype: str
        """
    ...
    def negative_keyword_text(self):
        """Gets the negative_keyword_text of this NegativeKeyword.

        The text for the negative keyword.

        :return: The negative_keyword_text of this NegativeKeyword.
        :rtype: str
        """
