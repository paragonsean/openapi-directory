...
async def find_listing_recommendations(request: web.Request, x_ebay_c_marketplace_id, filter=None, limit=None, offset=None, body=None) -> web.Response:
    ...
    :param x_ebay_c_marketplace_id: Use this header to specify the eBay marketplace where you list the items for which you want to get recommendations.
    ...
    """
    body = FindListingRecommendationRequest.from_dict(body)
