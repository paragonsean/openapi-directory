...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecommendationApi.FindListingRecommendationRequest();
  });
  ...
  describe('FindListingRecommendationRequest', function() {
    it('should create an instance of FindListingRecommendationRequest', function() {
      // uncomment below and update the code to test FindListingRecommendationRequest
      //var instance = new RecommendationApi.FindListingRecommendationRequest();
      //expect(instance).to.be.a(RecommendationApi.FindListingRecommendationRequest);
    });
