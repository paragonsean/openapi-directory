# RecommendationApi.PagedListingRecommendationCollection
...
**total** | **Number** | The total number of items retrieved in the result set. If no items are found, this field is returned with a value of 0. | [optional] 
