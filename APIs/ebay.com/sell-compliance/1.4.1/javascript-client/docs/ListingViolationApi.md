# ComplianceApi.ListingViolationApi
...
> PagedComplianceViolationCollection getListingViolations(X_EBAY_C_MARKETPLACE_ID, opts)
...
let apiInstance = new ComplianceApi.ListingViolationApi();
...
apiInstance.getListingViolations(X_EBAY_C_MARKETPLACE_ID, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new ComplianceApi.ListingViolationApi();
let suppressViolationRequest = new ComplianceApi.SuppressViolationRequest(); // SuppressViolationRequest | This type is the base request type of the SuppressViolation method.
apiInstance.suppressViolation(suppressViolationRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
