...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComplianceApi.ComplianceViolation();
  });
  ...
  describe('ComplianceViolation', function() {
    it('should create an instance of ComplianceViolation', function() {
      // uncomment below and update the code to test ComplianceViolation
      //var instance = new ComplianceApi.ComplianceViolation();
      //expect(instance).to.be.a(ComplianceApi.ComplianceViolation);
    });
