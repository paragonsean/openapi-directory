...
(function(root, factory) {
  ...
  describe('PaymentDispute', function() {
    it('should create an instance of PaymentDispute', function() {
      ...
      //var instance = new FulfillmentApi.PaymentDispute();
    ...
    it('should have the property monetaryTransactions (base name: "monetaryTransactions")', function() {
      // uncomment below and update the code to test the property monetaryTransactions
      //var instance = new FulfillmentApi.PaymentDispute();
      //expect(instance).to.be();
    });
