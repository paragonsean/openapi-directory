...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentApi.UpdateEvidencePaymentDisputeRequest();
  });
  ...
  describe('UpdateEvidencePaymentDisputeRequest', function() {
    it('should create an instance of UpdateEvidencePaymentDisputeRequest', function() {
      // uncomment below and update the code to test UpdateEvidencePaymentDisputeRequest
      //var instance = new FulfillmentApi.UpdateEvidencePaymentDisputeRequest();
      //expect(instance).to.be.a(FulfillmentApi.UpdateEvidencePaymentDisputeRequest);
    });
