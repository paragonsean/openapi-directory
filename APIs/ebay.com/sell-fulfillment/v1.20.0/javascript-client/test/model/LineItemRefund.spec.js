...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentApi.LineItemRefund();
  });
  ...
  describe('LineItemRefund', function() {
    it('should create an instance of LineItemRefund', function() {
      // uncomment below and update the code to test LineItemRefund
      //var instance = new FulfillmentApi.LineItemRefund();
      //expect(instance).to.be.a(FulfillmentApi.LineItemRefund);
    });
