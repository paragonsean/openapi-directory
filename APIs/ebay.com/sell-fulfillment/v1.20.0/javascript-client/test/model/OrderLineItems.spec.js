...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentApi.OrderLineItems();
  });
  ...
  describe('OrderLineItems', function() {
    it('should create an instance of OrderLineItems', function() {
      // uncomment below and update the code to test OrderLineItems
      //var instance = new FulfillmentApi.OrderLineItems();
      //expect(instance).to.be.a(FulfillmentApi.OrderLineItems);
    });
