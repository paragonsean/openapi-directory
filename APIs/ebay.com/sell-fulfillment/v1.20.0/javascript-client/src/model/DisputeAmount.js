...
/**
 * The DisputeAmount model module.
 * @module model/DisputeAmount
 * @version v1.20.0
 */
class DisputeAmount {
    /**
     * Constructs a new <code>DisputeAmount</code>.
     * This type defines the monetary value of an amount. It can provide the amount in both the currency used on the eBay site where an item is being offered and the conversion of that value into another currency, if applicable.
     * @alias module:model/DisputeAmount
     */
    constructor() { 
        
        DisputeAmount.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DisputeAmount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DisputeAmount} obj Optional instance to populate.
     * @return {module:model/DisputeAmount} The populated <code>DisputeAmount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DisputeAmount();
    ...
    /**
     * Validates the JSON data with respect to <code>DisputeAmount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DisputeAmount</code>.
     */
 ...
 */
DisputeAmount.prototype['convertedFromCurrency'] = undefined;
 ...
 */
DisputeAmount.prototype['convertedFromValue'] = undefined;
 ...
 */
DisputeAmount.prototype['currency'] = undefined;
 ...
 */
DisputeAmount.prototype['exchangeRate'] = undefined;
 ...
 * @member {String} value
 */
DisputeAmount.prototype['value'] = undefined;
