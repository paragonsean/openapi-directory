...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.ebay.com/sell/fulfillment/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.ebay.com/sell/fulfillment/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1.20.0/Javascript'
        };
