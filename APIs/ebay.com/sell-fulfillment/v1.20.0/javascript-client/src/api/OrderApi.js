...
export default class OrderApi {
    ...
    */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/IssueRefundRequest} [issueRefundRequest] 
    ...
    issueRefund(orderId, opts, callback) {
      opts = opts || {};
      let postBody = opts['issueRefundRequest'];
      // verify the required parameter 'orderId' is set
      if (orderId === undefined || orderId === null) {
        throw new Error("Missing the required parameter 'orderId' when calling issueRefund");
      }
