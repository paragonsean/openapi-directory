...
var orderId = "orderId_example"; // {String} The unique identifier of the order. Order ID values are shown in My eBay/Seller Hub, and are also returned by the <b>getOrders</b> method in the <b>orders.orderId</b> field.<span class=\"tablenote\"><strong>Note:</strong> <b>getOrders</b> can return orders up to two years old. Do not provide the orderId for an order created more than two years in the past.</span>
var opts = {
  'fieldGroups': "fieldGroups_example" // {String} The response type associated with the order. The only presently supported value is <code>TAX_BREAKDOWN</code>. This type returns a breakdown of tax and fee values associated with the order.
};
...
## Documentation for Models
 ...
 - [FulfillmentApi.DisputeAmount](docs/DisputeAmount.md)
 ...
 - [FulfillmentApi.EbayCollectedCharges](docs/EbayCollectedCharges.md)
 - [FulfillmentApi.EbayFulfillmentProgram](docs/EbayFulfillmentProgram.md)
 - [FulfillmentApi.EbayInternationalShipping](docs/EbayInternationalShipping.md)
 - [FulfillmentApi.EbayShipping](docs/EbayShipping.md)
 - [FulfillmentApi.EbayTaxReference](docs/EbayTaxReference.md)
 - [FulfillmentApi.EbayVaultProgram](docs/EbayVaultProgram.md)
 ...
 - [FulfillmentApi.ItemLocation](docs/ItemLocation.md)
 ...
 - [FulfillmentApi.LinkedOrderLineItem](docs/LinkedOrderLineItem.md)
 - [FulfillmentApi.MonetaryTransaction](docs/MonetaryTransaction.md)
 - [FulfillmentApi.NameValuePair](docs/NameValuePair.md)
 ...
 - [FulfillmentApi.TaxAddress](docs/TaxAddress.md)
