...
async def accept_payment_dispute(request: web.Request, payment_dispute_id, body=None) -> web.Response:
    ...
    """
    body = AcceptPaymentDisputeRequest.from_dict(body)
    return web.Response(status=200)


async def add_evidence(request: web.Request, payment_dispute_id, body=None) -> web.Response:
    ...
    """
    body = AddEvidencePaymentDisputeRequest.from_dict(body)
    return web.Response(status=200)


async def contest_payment_dispute(request: web.Request, payment_dispute_id, body=None) -> web.Response:
    ...
    """
    body = ContestPaymentDisputeRequest.from_dict(body)
    return web.Response(status=200)


async def fetch_evidence_content(request: web.Request, payment_dispute_id, evidence_id, file_id) -> web.Response:
    ...
    :param payment_dispute_id: The identifier of the payment dispute. The identifier of each payment dispute is returned in the &lt;strong&gt;getPaymentDisputeSummaries&lt;/strong&gt; response. This identifier is passed in as a path parameter at the end of the call URI.
    :type payment_dispute_id: str
...
async def get_activities(request: web.Request, payment_dispute_id) -> web.Response:
...
async def get_payment_dispute(request: web.Request, payment_dispute_id) -> web.Response:
...
async def get_payment_dispute_summaries(request: web.Request, order_id=None, buyer_username=None, open_date_from=None, open_date_to=None, payment_dispute_status=None, limit=None, offset=None) -> web.Response:
...
async def update_evidence(request: web.Request, payment_dispute_id, body=None) -> web.Response:
    """Update evidence
    ...
    """
    body = UpdateEvidencePaymentDisputeRequest.from_dict(body)
    return web.Response(status=200)


async def upload_evidence_file(request: web.Request, payment_dispute_id) -> web.Response:
