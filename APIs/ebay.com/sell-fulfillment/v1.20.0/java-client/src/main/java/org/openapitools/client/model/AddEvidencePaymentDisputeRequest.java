...
public class AddEvidencePaymentDisputeRequest {
  ...
  public AddEvidencePaymentDisputeRequest() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddEvidencePaymentDisputeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddEvidencePaymentDisputeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddEvidencePaymentDisputeRequest is not found in the empty JSON string", AddEvidencePaymentDisputeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddEvidencePaymentDisputeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddEvidencePaymentDisputeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddEvidencePaymentDisputeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddEvidencePaymentDisputeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddEvidencePaymentDisputeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddEvidencePaymentDisputeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddEvidencePaymentDisputeRequest>() {
           @Override
           public void write(JsonWriter out, AddEvidencePaymentDisputeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddEvidencePaymentDisputeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddEvidencePaymentDisputeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddEvidencePaymentDisputeRequest
   * @throws IOException if the JSON string is invalid with respect to AddEvidencePaymentDisputeRequest
   */
  public static AddEvidencePaymentDisputeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddEvidencePaymentDisputeRequest.class);
  }

  /**
   * Convert an instance of AddEvidencePaymentDisputeRequest to an JSON string
   *
   * @return JSON string
   */
