...
/*
 * OAIUpdateEvidencePaymentDisputeRequest.h
 *
...
#ifndef OAIUpdateEvidencePaymentDisputeRequest_H
#define OAIUpdateEvidencePaymentDisputeRequest_H
...
class OAIUpdateEvidencePaymentDisputeRequest : public OAIObject {
public:
    OAIUpdateEvidencePaymentDisputeRequest();
    OAIUpdateEvidencePaymentDisputeRequest(QString json);
    ~OAIUpdateEvidencePaymentDisputeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEvidencePaymentDisputeRequest)

#endif // OAIUpdateEvidencePaymentDisputeRequest_H
