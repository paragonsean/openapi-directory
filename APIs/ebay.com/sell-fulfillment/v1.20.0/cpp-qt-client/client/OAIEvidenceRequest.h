...
#ifndef OAIEvidenceRequest_H
#define OAIEvidenceRequest_H
...
class OAIEvidenceRequest : public OAIObject {
public:
    OAIEvidenceRequest();
    OAIEvidenceRequest(QString json);
    ~OAIEvidenceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvidenceRequest)

#endif // OAIEvidenceRequest_H
