...
> RemoteShopcartResponse addItem(opts)
...
```javascript
import BrowseApi from 'browse_api';
let defaultClient = BrowseApi.ApiClient.instance;
// Configure OAuth2 access token for authorization: Authorization Code
let Authorization Code = defaultClient.authentications['Authorization Code'];
Authorization Code.accessToken = 'YOUR ACCESS TOKEN';

let apiInstance = new BrowseApi.ShoppingCartApi();
let opts = {
  'body': new BrowseApi.AddCartItemInput() // AddCartItemInput | 
};
apiInstance.addItem(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new BrowseApi.ShoppingCartApi();
apiInstance.getShoppingCart((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> RemoteShopcartResponse removeItem(opts)
...
let apiInstance = new BrowseApi.ShoppingCartApi();
let opts = {
  'body': new BrowseApi.RemoveCartItemInput() // RemoveCartItemInput | 
};
apiInstance.removeItem(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> RemoteShopcartResponse updateQuantity(opts)
...
let apiInstance = new BrowseApi.ShoppingCartApi();
let opts = {
  'body': new BrowseApi.UpdateCartItemInput() // UpdateCartItemInput | 
};
apiInstance.updateQuantity(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
