...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowseApi.ConditionDistribution();
  });
  ...
  describe('ConditionDistribution', function() {
    it('should create an instance of ConditionDistribution', function() {
      // uncomment below and update the code to test ConditionDistribution
      //var instance = new BrowseApi.ConditionDistribution();
      //expect(instance).to.be.a(BrowseApi.ConditionDistribution);
    });
