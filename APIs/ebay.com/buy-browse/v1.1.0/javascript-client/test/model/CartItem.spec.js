...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowseApi.CartItem();
  });
  ...
  describe('CartItem', function() {
    it('should create an instance of CartItem', function() {
      ...
      //var instance = new BrowseApi.CartItem();
      //expect(instance).to.be.a(BrowseApi.CartItem);
    });

    it('should have the property cartItemId (base name: "cartItemId")', function() {
      // uncomment below and update the code to test the property cartItemId
      //var instance = new BrowseApi.CartItem();
      //expect(instance).to.be();
    });

    it('should have the property cartItemSubtotal (base name: "cartItemSubtotal")', function() {
      // uncomment below and update the code to test the property cartItemSubtotal
      //var instance = new BrowseApi.CartItem();
      //expect(instance).to.be();
    });
