...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowseApi.VatDetail();
  });
  ...
  describe('VatDetail', function() {
    it('should create an instance of VatDetail', function() {
      // uncomment below and update the code to test VatDetail
      //var instance = new BrowseApi.VatDetail();
      //expect(instance).to.be.a(BrowseApi.VatDetail);
    });
