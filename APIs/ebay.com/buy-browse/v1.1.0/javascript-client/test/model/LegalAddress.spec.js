...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowseApi.LegalAddress();
  });
  ...
  describe('LegalAddress', function() {
    it('should create an instance of LegalAddress', function() {
      // uncomment below and update the code to test LegalAddress
      //var instance = new BrowseApi.LegalAddress();
      //expect(instance).to.be.a(BrowseApi.LegalAddress);
    });
