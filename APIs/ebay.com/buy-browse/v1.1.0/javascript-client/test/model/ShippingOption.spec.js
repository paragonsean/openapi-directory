...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrowseApi.ShippingOption();
  });
  ...
  describe('ShippingOption', function() {
    it('should create an instance of ShippingOption', function() {
      ...
      //var instance = new BrowseApi.ShippingOption();
      //expect(instance).to.be.a(BrowseApi.ShippingOption);
    });
    ...
    it('should have the property cutOffDateUsedForEstimate (base name: "cutOffDateUsedForEstimate")', function() {
      // uncomment below and update the code to test the property cutOffDateUsedForEstimate
      //var instance = new BrowseApi.ShippingOption();
      //expect(instance).to.be();
    });

    it('should have the property fulfilledThrough (base name: "fulfilledThrough")', function() {
      // uncomment below and update the code to test the property fulfilledThrough
      //var instance = new BrowseApi.ShippingOption();
      //expect(instance).to.be();
    });
    ...
    it('should have the property shipToLocationUsedForEstimate (base name: "shipToLocationUsedForEstimate")', function() {
      // uncomment below and update the code to test the property shipToLocationUsedForEstimate
      //var instance = new BrowseApi.ShippingOption();
      //expect(instance).to.be();
    });
    ...
    it('should have the property trademarkSymbol (base name: "trademarkSymbol")', function() {
      // uncomment below and update the code to test the property trademarkSymbol
      //var instance = new BrowseApi.ShippingOption();
      //expect(instance).to.be();
    });
