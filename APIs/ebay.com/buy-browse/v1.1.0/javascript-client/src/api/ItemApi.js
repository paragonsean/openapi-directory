...
export default class ItemApi {
    ...
    */
     ...
     * @param {String} X_EBAY_C_MARKETPLACE_ID The ID of the eBay marketplace you want to use. Note: This value is case sensitive. For example: &nbsp;&nbsp;X-EBAY-C-MARKETPLACE-ID = EBAY_US For a list of supported sites see, API Restrictions.
     * @param {Object} opts Optional parameters
     * @param {module:model/CompatibilityPayload} [body] 
     ...
     */
    checkCompatibility(itemId, X_EBAY_C_MARKETPLACE_ID, opts, callback) {
      opts = opts || {};
      ...
      if (X_EBAY_C_MARKETPLACE_ID === undefined || X_EBAY_C_MARKETPLACE_ID === null) {
        throw new Error("Missing the required parameter 'X_EBAY_C_MARKETPLACE_ID' when calling checkCompatibility");
      }
     ...
     * @param {String} [legacyVariationId] Specifies the legacy item ID of a specific item in an item group, such as the red shirt size L. Legacy ids are returned by APIs, such as the Finding API. Maximum: 1 Requirement: You must always pass in the legacy_item_id with the legacy_variation_id
     ...
     */
    getItemsByItemGroup(itemGroupId, callback) {
      let postBody = null;
