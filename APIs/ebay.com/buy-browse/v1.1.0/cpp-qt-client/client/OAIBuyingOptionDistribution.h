...
#ifndef OAIBuyingOptionDistribution_H
#define OAIBuyingOptionDistribution_H
...
class OAIBuyingOptionDistribution : public OAIObject {
public:
    OAIBuyingOptionDistribution();
    OAIBuyingOptionDistribution(QString json);
    ~OAIBuyingOptionDistribution() override;
    ...
    QString getBuyingOption() const;
    void setBuyingOption(const QString &buying_option);
    bool is_buying_option_Set() const;
    bool is_buying_option_Valid() const;
...
private:
    ...
    QString m_buying_option;
    bool m_buying_option_isSet;
    bool m_buying_option_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuyingOptionDistribution)

#endif // OAIBuyingOptionDistribution_H
