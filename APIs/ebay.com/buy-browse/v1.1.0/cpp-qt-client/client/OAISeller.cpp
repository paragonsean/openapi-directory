...
QString OAISeller::getFeedbackPercentage() const {
    return m_feedback_percentage;
}
void OAISeller::setFeedbackPercentage(const QString &feedback_percentage) {
    m_feedback_percentage = feedback_percentage;
    m_feedback_percentage_isSet = true;
}

bool OAISeller::is_feedback_percentage_Set() const{
    return m_feedback_percentage_isSet;
}

bool OAISeller::is_feedback_percentage_Valid() const{
    return m_feedback_percentage_isValid;
}

qint32 OAISeller::getFeedbackScore() const {
    return m_feedback_score;
}
void OAISeller::setFeedbackScore(const qint32 &feedback_score) {
    m_feedback_score = feedback_score;
    m_feedback_score_isSet = true;
}

bool OAISeller::is_feedback_score_Set() const{
    return m_feedback_score_isSet;
}

bool OAISeller::is_feedback_score_Valid() const{
    return m_feedback_score_isValid;
}

QString OAISeller::getSellerAccountType() const {
    return m_seller_account_type;
}
void OAISeller::setSellerAccountType(const QString &seller_account_type) {
    m_seller_account_type = seller_account_type;
    m_seller_account_type_isSet = true;
}

bool OAISeller::is_seller_account_type_Set() const{
    return m_seller_account_type_isSet;
}

bool OAISeller::is_seller_account_type_Valid() const{
    return m_seller_account_type_isValid;
}

QString OAISeller::getUsername() const {
    return m_username;
}
void OAISeller::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAISeller::is_username_Set() const{
    return m_username_isSet;
}

bool OAISeller::is_username_Valid() const{
