...
#ifndef OAICommonDescriptions_H
#define OAICommonDescriptions_H
...
class OAICommonDescriptions : public OAIObject {
public:
    OAICommonDescriptions();
    OAICommonDescriptions(QString json);
    ~OAICommonDescriptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICommonDescriptions)

#endif // OAICommonDescriptions_H
