...
#ifndef OAIShipToRegion_H
#define OAIShipToRegion_H
...
class OAIShipToRegion : public OAIObject {
public:
    OAIShipToRegion();
    OAIShipToRegion(QString json);
    ~OAIShipToRegion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShipToRegion)

#endif // OAIShipToRegion_H
