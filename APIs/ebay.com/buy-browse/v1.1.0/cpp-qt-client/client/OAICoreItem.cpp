...
OAICoreItem::OAICoreItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICoreItem::OAICoreItem() {
    this->initializeModel();
}

OAICoreItem::~OAICoreItem() {}

void OAICoreItem::initializeModel() {
...
void OAICoreItem::fromJson(QString jsonString) {
...
void OAICoreItem::fromJsonObject(QJsonObject json) {
...
QString OAICoreItem::asJson() const {
...
QJsonObject OAICoreItem::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIImage> OAICoreItem::getAdditionalImages() const {
    return m_additional_images;
}
void OAICoreItem::setAdditionalImages(const QList<OAIImage> &additional_images) {
    m_additional_images = additional_images;
    m_additional_images_isSet = true;
}

bool OAICoreItem::is_additional_images_Set() const{
    return m_additional_images_isSet;
}

bool OAICoreItem::is_additional_images_Valid() const{
    return m_additional_images_isValid;
}

bool OAICoreItem::isAdultOnly() const {
    return m_adult_only;
}
void OAICoreItem::setAdultOnly(const bool &adult_only) {
    m_adult_only = adult_only;
    m_adult_only_isSet = true;
}

bool OAICoreItem::is_adult_only_Set() const{
    return m_adult_only_isSet;
}

bool OAICoreItem::is_adult_only_Valid() const{
    return m_adult_only_isValid;
}

QString OAICoreItem::getAgeGroup() const {
    return m_age_group;
}
void OAICoreItem::setAgeGroup(const QString &age_group) {
    m_age_group = age_group;
    m_age_group_isSet = true;
}

bool OAICoreItem::is_age_group_Set() const{
    return m_age_group_isSet;
}

bool OAICoreItem::is_age_group_Valid() const{
    return m_age_group_isValid;
}

QList<OAIAvailableCoupon> OAICoreItem::getAvailableCoupons() const {
    return m_available_coupons;
}
void OAICoreItem::setAvailableCoupons(const QList<OAIAvailableCoupon> &available_coupons) {
    m_available_coupons = available_coupons;
    m_available_coupons_isSet = true;
}

bool OAICoreItem::is_available_coupons_Set() const{
    return m_available_coupons_isSet;
}

bool OAICoreItem::is_available_coupons_Valid() const{
    return m_available_coupons_isValid;
}

qint32 OAICoreItem::getBidCount() const {
    return m_bid_count;
}
void OAICoreItem::setBidCount(const qint32 &bid_count) {
    m_bid_count = bid_count;
    m_bid_count_isSet = true;
}

bool OAICoreItem::is_bid_count_Set() const{
    return m_bid_count_isSet;
}

bool OAICoreItem::is_bid_count_Valid() const{
    return m_bid_count_isValid;
}

QString OAICoreItem::getBrand() const {
    return m_brand;
}
void OAICoreItem::setBrand(const QString &brand) {
    m_brand = brand;
    m_brand_isSet = true;
}

bool OAICoreItem::is_brand_Set() const{
    return m_brand_isSet;
}

bool OAICoreItem::is_brand_Valid() const{
    return m_brand_isValid;
}

QList<QString> OAICoreItem::getBuyingOptions() const {
    return m_buying_options;
}
void OAICoreItem::setBuyingOptions(const QList<QString> &buying_options) {
    m_buying_options = buying_options;
    m_buying_options_isSet = true;
}

bool OAICoreItem::is_buying_options_Set() const{
    return m_buying_options_isSet;
}

bool OAICoreItem::is_buying_options_Valid() const{
    return m_buying_options_isValid;
}

QString OAICoreItem::getCategoryId() const {
    return m_category_id;
}
void OAICoreItem::setCategoryId(const QString &category_id) {
    m_category_id = category_id;
    m_category_id_isSet = true;
}

bool OAICoreItem::is_category_id_Set() const{
    return m_category_id_isSet;
}

bool OAICoreItem::is_category_id_Valid() const{
    return m_category_id_isValid;
}

QString OAICoreItem::getCategoryPath() const {
    return m_category_path;
}
void OAICoreItem::setCategoryPath(const QString &category_path) {
    m_category_path = category_path;
    m_category_path_isSet = true;
}

bool OAICoreItem::is_category_path_Set() const{
    return m_category_path_isSet;
}

bool OAICoreItem::is_category_path_Valid() const{
    return m_category_path_isValid;
}

QString OAICoreItem::getColor() const {
    return m_color;
}
void OAICoreItem::setColor(const QString &color) {
    m_color = color;
    m_color_isSet = true;
}

bool OAICoreItem::is_color_Set() const{
    return m_color_isSet;
}

bool OAICoreItem::is_color_Valid() const{
    return m_color_isValid;
}

QString OAICoreItem::getCondition() const {
    return m_condition;
}
void OAICoreItem::setCondition(const QString &condition) {
    m_condition = condition;
    m_condition_isSet = true;
}

bool OAICoreItem::is_condition_Set() const{
    return m_condition_isSet;
}

bool OAICoreItem::is_condition_Valid() const{
    return m_condition_isValid;
}

QString OAICoreItem::getConditionDescription() const {
    return m_condition_description;
}
void OAICoreItem::setConditionDescription(const QString &condition_description) {
    m_condition_description = condition_description;
    m_condition_description_isSet = true;
}

bool OAICoreItem::is_condition_description_Set() const{
    return m_condition_description_isSet;
}

bool OAICoreItem::is_condition_description_Valid() const{
    return m_condition_description_isValid;
}

QString OAICoreItem::getConditionId() const {
    return m_condition_id;
}
void OAICoreItem::setConditionId(const QString &condition_id) {
    m_condition_id = condition_id;
    m_condition_id_isSet = true;
}

bool OAICoreItem::is_condition_id_Set() const{
    return m_condition_id_isSet;
}

bool OAICoreItem::is_condition_id_Valid() const{
    return m_condition_id_isValid;
}

OAIConvertedAmount OAICoreItem::getCurrentBidPrice() const {
    return m_current_bid_price;
}
void OAICoreItem::setCurrentBidPrice(const OAIConvertedAmount &current_bid_price) {
    m_current_bid_price = current_bid_price;
    m_current_bid_price_isSet = true;
}

bool OAICoreItem::is_current_bid_price_Set() const{
    return m_current_bid_price_isSet;
}

bool OAICoreItem::is_current_bid_price_Valid() const{
    return m_current_bid_price_isValid;
}

QString OAICoreItem::getDescription() const {
    return m_description;
}
void OAICoreItem::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICoreItem::is_description_Set() const{
    return m_description_isSet;
}

bool OAICoreItem::is_description_Valid() const{
    return m_description_isValid;
}

bool OAICoreItem::isEligibleForInlineCheckout() const {
    return m_eligible_for_inline_checkout;
}
void OAICoreItem::setEligibleForInlineCheckout(const bool &eligible_for_inline_checkout) {
    m_eligible_for_inline_checkout = eligible_for_inline_checkout;
    m_eligible_for_inline_checkout_isSet = true;
}

bool OAICoreItem::is_eligible_for_inline_checkout_Set() const{
    return m_eligible_for_inline_checkout_isSet;
}

bool OAICoreItem::is_eligible_for_inline_checkout_Valid() const{
    return m_eligible_for_inline_checkout_isValid;
}

bool OAICoreItem::isEnabledForGuestCheckout() const {
    return m_enabled_for_guest_checkout;
}
void OAICoreItem::setEnabledForGuestCheckout(const bool &enabled_for_guest_checkout) {
    m_enabled_for_guest_checkout = enabled_for_guest_checkout;
    m_enabled_for_guest_checkout_isSet = true;
}

bool OAICoreItem::is_enabled_for_guest_checkout_Set() const{
    return m_enabled_for_guest_checkout_isSet;
}

bool OAICoreItem::is_enabled_for_guest_checkout_Valid() const{
    return m_enabled_for_guest_checkout_isValid;
}

QString OAICoreItem::getEnergyEfficiencyClass() const {
    return m_energy_efficiency_class;
}
void OAICoreItem::setEnergyEfficiencyClass(const QString &energy_efficiency_class) {
    m_energy_efficiency_class = energy_efficiency_class;
    m_energy_efficiency_class_isSet = true;
}

bool OAICoreItem::is_energy_efficiency_class_Set() const{
    return m_energy_efficiency_class_isSet;
}

bool OAICoreItem::is_energy_efficiency_class_Valid() const{
    return m_energy_efficiency_class_isValid;
}

QString OAICoreItem::getEpid() const {
    return m_epid;
}
void OAICoreItem::setEpid(const QString &epid) {
    m_epid = epid;
    m_epid_isSet = true;
}

bool OAICoreItem::is_epid_Set() const{
    return m_epid_isSet;
}

bool OAICoreItem::is_epid_Valid() const{
    return m_epid_isValid;
}

QList<OAIEstimatedAvailability> OAICoreItem::getEstimatedAvailabilities() const {
    return m_estimated_availabilities;
}
void OAICoreItem::setEstimatedAvailabilities(const QList<OAIEstimatedAvailability> &estimated_availabilities) {
    m_estimated_availabilities = estimated_availabilities;
    m_estimated_availabilities_isSet = true;
}

bool OAICoreItem::is_estimated_availabilities_Set() const{
    return m_estimated_availabilities_isSet;
}

bool OAICoreItem::is_estimated_availabilities_Valid() const{
    return m_estimated_availabilities_isValid;
}

QString OAICoreItem::getGender() const {
    return m_gender;
}
void OAICoreItem::setGender(const QString &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAICoreItem::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAICoreItem::is_gender_Valid() const{
    return m_gender_isValid;
}

QString OAICoreItem::getGtin() const {
    return m_gtin;
}
void OAICoreItem::setGtin(const QString &gtin) {
    m_gtin = gtin;
    m_gtin_isSet = true;
}

bool OAICoreItem::is_gtin_Set() const{
    return m_gtin_isSet;
}

bool OAICoreItem::is_gtin_Valid() const{
    return m_gtin_isValid;
}

OAIImage OAICoreItem::getImage() const {
    return m_image;
}
void OAICoreItem::setImage(const OAIImage &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAICoreItem::is_image_Set() const{
    return m_image_isSet;
}

bool OAICoreItem::is_image_Valid() const{
    return m_image_isValid;
}

QString OAICoreItem::getInferredEpid() const {
    return m_inferred_epid;
}
void OAICoreItem::setInferredEpid(const QString &inferred_epid) {
    m_inferred_epid = inferred_epid;
    m_inferred_epid_isSet = true;
}

bool OAICoreItem::is_inferred_epid_Set() const{
    return m_inferred_epid_isSet;
}

bool OAICoreItem::is_inferred_epid_Valid() const{
    return m_inferred_epid_isValid;
}

QString OAICoreItem::getItemAffiliateWebUrl() const {
    return m_item_affiliate_web_url;
}
void OAICoreItem::setItemAffiliateWebUrl(const QString &item_affiliate_web_url) {
    m_item_affiliate_web_url = item_affiliate_web_url;
    m_item_affiliate_web_url_isSet = true;
}

bool OAICoreItem::is_item_affiliate_web_url_Set() const{
    return m_item_affiliate_web_url_isSet;
}

bool OAICoreItem::is_item_affiliate_web_url_Valid() const{
    return m_item_affiliate_web_url_isValid;
}

QString OAICoreItem::getItemEndDate() const {
    return m_item_end_date;
}
void OAICoreItem::setItemEndDate(const QString &item_end_date) {
    m_item_end_date = item_end_date;
    m_item_end_date_isSet = true;
}

bool OAICoreItem::is_item_end_date_Set() const{
    return m_item_end_date_isSet;
}

bool OAICoreItem::is_item_end_date_Valid() const{
    return m_item_end_date_isValid;
}

QString OAICoreItem::getItemId() const {
    return m_item_id;
}
void OAICoreItem::setItemId(const QString &item_id) {
    m_item_id = item_id;
    m_item_id_isSet = true;
}

bool OAICoreItem::is_item_id_Set() const{
    return m_item_id_isSet;
}

bool OAICoreItem::is_item_id_Valid() const{
    return m_item_id_isValid;
}

OAIAddress OAICoreItem::getItemLocation() const {
    return m_item_location;
}
void OAICoreItem::setItemLocation(const OAIAddress &item_location) {
    m_item_location = item_location;
    m_item_location_isSet = true;
}

bool OAICoreItem::is_item_location_Set() const{
    return m_item_location_isSet;
}

bool OAICoreItem::is_item_location_Valid() const{
    return m_item_location_isValid;
}

QString OAICoreItem::getItemWebUrl() const {
    return m_item_web_url;
}
void OAICoreItem::setItemWebUrl(const QString &item_web_url) {
    m_item_web_url = item_web_url;
    m_item_web_url_isSet = true;
}

bool OAICoreItem::is_item_web_url_Set() const{
    return m_item_web_url_isSet;
}

bool OAICoreItem::is_item_web_url_Valid() const{
    return m_item_web_url_isValid;
}

QString OAICoreItem::getLegacyItemId() const {
    return m_legacy_item_id;
}
void OAICoreItem::setLegacyItemId(const QString &legacy_item_id) {
    m_legacy_item_id = legacy_item_id;
    m_legacy_item_id_isSet = true;
}

bool OAICoreItem::is_legacy_item_id_Set() const{
    return m_legacy_item_id_isSet;
}

bool OAICoreItem::is_legacy_item_id_Valid() const{
    return m_legacy_item_id_isValid;
}

QList<OAITypedNameValue> OAICoreItem::getLocalizedAspects() const {
    return m_localized_aspects;
}
void OAICoreItem::setLocalizedAspects(const QList<OAITypedNameValue> &localized_aspects) {
    m_localized_aspects = localized_aspects;
    m_localized_aspects_isSet = true;
}

bool OAICoreItem::is_localized_aspects_Set() const{
    return m_localized_aspects_isSet;
}

bool OAICoreItem::is_localized_aspects_Valid() const{
    return m_localized_aspects_isValid;
}

qint32 OAICoreItem::getLotSize() const {
    return m_lot_size;
}
void OAICoreItem::setLotSize(const qint32 &lot_size) {
    m_lot_size = lot_size;
    m_lot_size_isSet = true;
}

bool OAICoreItem::is_lot_size_Set() const{
    return m_lot_size_isSet;
}

bool OAICoreItem::is_lot_size_Valid() const{
    return m_lot_size_isValid;
}

OAIMarketingPrice OAICoreItem::getMarketingPrice() const {
    return m_marketing_price;
}
void OAICoreItem::setMarketingPrice(const OAIMarketingPrice &marketing_price) {
    m_marketing_price = marketing_price;
    m_marketing_price_isSet = true;
}

bool OAICoreItem::is_marketing_price_Set() const{
    return m_marketing_price_isSet;
}

bool OAICoreItem::is_marketing_price_Valid() const{
    return m_marketing_price_isValid;
}

QString OAICoreItem::getMaterial() const {
    return m_material;
}
void OAICoreItem::setMaterial(const QString &material) {
    m_material = material;
    m_material_isSet = true;
}

bool OAICoreItem::is_material_Set() const{
    return m_material_isSet;
}

bool OAICoreItem::is_material_Valid() const{
    return m_material_isValid;
}

OAIConvertedAmount OAICoreItem::getMinimumPriceToBid() const {
    return m_minimum_price_to_bid;
}
void OAICoreItem::setMinimumPriceToBid(const OAIConvertedAmount &minimum_price_to_bid) {
    m_minimum_price_to_bid = minimum_price_to_bid;
    m_minimum_price_to_bid_isSet = true;
}

bool OAICoreItem::is_minimum_price_to_bid_Set() const{
    return m_minimum_price_to_bid_isSet;
}

bool OAICoreItem::is_minimum_price_to_bid_Valid() const{
    return m_minimum_price_to_bid_isValid;
}

QString OAICoreItem::getMpn() const {
    return m_mpn;
}
void OAICoreItem::setMpn(const QString &mpn) {
    m_mpn = mpn;
    m_mpn_isSet = true;
}

bool OAICoreItem::is_mpn_Set() const{
    return m_mpn_isSet;
}

bool OAICoreItem::is_mpn_Valid() const{
    return m_mpn_isValid;
}

QString OAICoreItem::getPattern() const {
    return m_pattern;
}
void OAICoreItem::setPattern(const QString &pattern) {
    m_pattern = pattern;
    m_pattern_isSet = true;
}

bool OAICoreItem::is_pattern_Set() const{
    return m_pattern_isSet;
}

bool OAICoreItem::is_pattern_Valid() const{
    return m_pattern_isValid;
}

QList<OAIPaymentMethod> OAICoreItem::getPaymentMethods() const {
    return m_payment_methods;
}
void OAICoreItem::setPaymentMethods(const QList<OAIPaymentMethod> &payment_methods) {
    m_payment_methods = payment_methods;
    m_payment_methods_isSet = true;
}

bool OAICoreItem::is_payment_methods_Set() const{
    return m_payment_methods_isSet;
}

bool OAICoreItem::is_payment_methods_Valid() const{
    return m_payment_methods_isValid;
}

OAIConvertedAmount OAICoreItem::getPrice() const {
    return m_price;
}
void OAICoreItem::setPrice(const OAIConvertedAmount &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAICoreItem::is_price_Set() const{
    return m_price_isSet;
}

bool OAICoreItem::is_price_Valid() const{
    return m_price_isValid;
}

QString OAICoreItem::getPriceDisplayCondition() const {
    return m_price_display_condition;
}
void OAICoreItem::setPriceDisplayCondition(const QString &price_display_condition) {
    m_price_display_condition = price_display_condition;
    m_price_display_condition_isSet = true;
}

bool OAICoreItem::is_price_display_condition_Set() const{
    return m_price_display_condition_isSet;
}

bool OAICoreItem::is_price_display_condition_Valid() const{
    return m_price_display_condition_isValid;
}

OAIItemGroupSummary OAICoreItem::getPrimaryItemGroup() const {
    return m_primary_item_group;
}
void OAICoreItem::setPrimaryItemGroup(const OAIItemGroupSummary &primary_item_group) {
    m_primary_item_group = primary_item_group;
    m_primary_item_group_isSet = true;
}

bool OAICoreItem::is_primary_item_group_Set() const{
    return m_primary_item_group_isSet;
}

bool OAICoreItem::is_primary_item_group_Valid() const{
    return m_primary_item_group_isValid;
}

OAIReviewRating OAICoreItem::getPrimaryProductReviewRating() const {
    return m_primary_product_review_rating;
}
void OAICoreItem::setPrimaryProductReviewRating(const OAIReviewRating &primary_product_review_rating) {
    m_primary_product_review_rating = primary_product_review_rating;
    m_primary_product_review_rating_isSet = true;
}

bool OAICoreItem::is_primary_product_review_rating_Set() const{
    return m_primary_product_review_rating_isSet;
}

bool OAICoreItem::is_primary_product_review_rating_Valid() const{
    return m_primary_product_review_rating_isValid;
}

OAIProduct OAICoreItem::getProduct() const {
    return m_product;
}
void OAICoreItem::setProduct(const OAIProduct &product) {
    m_product = product;
    m_product_isSet = true;
}

bool OAICoreItem::is_product_Set() const{
    return m_product_isSet;
}

bool OAICoreItem::is_product_Valid() const{
    return m_product_isValid;
}

QString OAICoreItem::getProductFicheWebUrl() const {
    return m_product_fiche_web_url;
}
void OAICoreItem::setProductFicheWebUrl(const QString &product_fiche_web_url) {
    m_product_fiche_web_url = product_fiche_web_url;
    m_product_fiche_web_url_isSet = true;
}

bool OAICoreItem::is_product_fiche_web_url_Set() const{
    return m_product_fiche_web_url_isSet;
}

bool OAICoreItem::is_product_fiche_web_url_Valid() const{
    return m_product_fiche_web_url_isValid;
}

QList<QString> OAICoreItem::getQualifiedPrograms() const {
    return m_qualified_programs;
}
void OAICoreItem::setQualifiedPrograms(const QList<QString> &qualified_programs) {
    m_qualified_programs = qualified_programs;
    m_qualified_programs_isSet = true;
}

bool OAICoreItem::is_qualified_programs_Set() const{
    return m_qualified_programs_isSet;
}

bool OAICoreItem::is_qualified_programs_Valid() const{
    return m_qualified_programs_isValid;
}

qint32 OAICoreItem::getQuantityLimitPerBuyer() const {
    return m_quantity_limit_per_buyer;
}
void OAICoreItem::setQuantityLimitPerBuyer(const qint32 &quantity_limit_per_buyer) {
    m_quantity_limit_per_buyer = quantity_limit_per_buyer;
    m_quantity_limit_per_buyer_isSet = true;
}

bool OAICoreItem::is_quantity_limit_per_buyer_Set() const{
    return m_quantity_limit_per_buyer_isSet;
}

bool OAICoreItem::is_quantity_limit_per_buyer_Valid() const{
    return m_quantity_limit_per_buyer_isValid;
}

bool OAICoreItem::isReservePriceMet() const {
    return m_reserve_price_met;
}
void OAICoreItem::setReservePriceMet(const bool &reserve_price_met) {
    m_reserve_price_met = reserve_price_met;
    m_reserve_price_met_isSet = true;
}

bool OAICoreItem::is_reserve_price_met_Set() const{
    return m_reserve_price_met_isSet;
}

bool OAICoreItem::is_reserve_price_met_Valid() const{
    return m_reserve_price_met_isValid;
}

OAIItemReturnTerms OAICoreItem::getReturnTerms() const {
    return m_return_terms;
}
void OAICoreItem::setReturnTerms(const OAIItemReturnTerms &return_terms) {
    m_return_terms = return_terms;
    m_return_terms_isSet = true;
}

bool OAICoreItem::is_return_terms_Set() const{
    return m_return_terms_isSet;
}

bool OAICoreItem::is_return_terms_Valid() const{
    return m_return_terms_isValid;
}

OAISellerDetail OAICoreItem::getSeller() const {
    return m_seller;
}
void OAICoreItem::setSeller(const OAISellerDetail &seller) {
    m_seller = seller;
    m_seller_isSet = true;
}

bool OAICoreItem::is_seller_Set() const{
    return m_seller_isSet;
}

bool OAICoreItem::is_seller_Valid() const{
    return m_seller_isValid;
}

QString OAICoreItem::getSellerItemRevision() const {
    return m_seller_item_revision;
}
void OAICoreItem::setSellerItemRevision(const QString &seller_item_revision) {
    m_seller_item_revision = seller_item_revision;
    m_seller_item_revision_isSet = true;
}

bool OAICoreItem::is_seller_item_revision_Set() const{
    return m_seller_item_revision_isSet;
}

bool OAICoreItem::is_seller_item_revision_Valid() const{
    return m_seller_item_revision_isValid;
}

OAIShipToLocations OAICoreItem::getShipToLocations() const {
    return m_ship_to_locations;
}
void OAICoreItem::setShipToLocations(const OAIShipToLocations &ship_to_locations) {
    m_ship_to_locations = ship_to_locations;
    m_ship_to_locations_isSet = true;
}

bool OAICoreItem::is_ship_to_locations_Set() const{
    return m_ship_to_locations_isSet;
}

bool OAICoreItem::is_ship_to_locations_Valid() const{
    return m_ship_to_locations_isValid;
}

QList<OAIShippingOption> OAICoreItem::getShippingOptions() const {
    return m_shipping_options;
}
void OAICoreItem::setShippingOptions(const QList<OAIShippingOption> &shipping_options) {
    m_shipping_options = shipping_options;
    m_shipping_options_isSet = true;
}

bool OAICoreItem::is_shipping_options_Set() const{
    return m_shipping_options_isSet;
}

bool OAICoreItem::is_shipping_options_Valid() const{
    return m_shipping_options_isValid;
}

QString OAICoreItem::getShortDescription() const {
    return m_short_description;
}
void OAICoreItem::setShortDescription(const QString &short_description) {
    m_short_description = short_description;
    m_short_description_isSet = true;
}

bool OAICoreItem::is_short_description_Set() const{
    return m_short_description_isSet;
}

bool OAICoreItem::is_short_description_Valid() const{
    return m_short_description_isValid;
}

QString OAICoreItem::getSize() const {
    return m_size;
}
void OAICoreItem::setSize(const QString &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAICoreItem::is_size_Set() const{
    return m_size_isSet;
}

bool OAICoreItem::is_size_Valid() const{
    return m_size_isValid;
}

QString OAICoreItem::getSizeSystem() const {
    return m_size_system;
}
void OAICoreItem::setSizeSystem(const QString &size_system) {
    m_size_system = size_system;
    m_size_system_isSet = true;
}

bool OAICoreItem::is_size_system_Set() const{
    return m_size_system_isSet;
}

bool OAICoreItem::is_size_system_Valid() const{
    return m_size_system_isValid;
}

QString OAICoreItem::getSizeType() const {
    return m_size_type;
}
void OAICoreItem::setSizeType(const QString &size_type) {
    m_size_type = size_type;
    m_size_type_isSet = true;
}

bool OAICoreItem::is_size_type_Set() const{
    return m_size_type_isSet;
}

bool OAICoreItem::is_size_type_Valid() const{
    return m_size_type_isValid;
}

QString OAICoreItem::getSubtitle() const {
    return m_subtitle;
}
void OAICoreItem::setSubtitle(const QString &subtitle) {
    m_subtitle = subtitle;
    m_subtitle_isSet = true;
}

bool OAICoreItem::is_subtitle_Set() const{
    return m_subtitle_isSet;
}

bool OAICoreItem::is_subtitle_Valid() const{
    return m_subtitle_isValid;
}

QList<OAITaxes> OAICoreItem::getTaxes() const {
    return m_taxes;
}
void OAICoreItem::setTaxes(const QList<OAITaxes> &taxes) {
    m_taxes = taxes;
    m_taxes_isSet = true;
}

bool OAICoreItem::is_taxes_Set() const{
    return m_taxes_isSet;
}

bool OAICoreItem::is_taxes_Valid() const{
    return m_taxes_isValid;
}

QString OAICoreItem::getTitle() const {
    return m_title;
}
void OAICoreItem::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAICoreItem::is_title_Set() const{
    return m_title_isSet;
}

bool OAICoreItem::is_title_Valid() const{
    return m_title_isValid;
}

bool OAICoreItem::isTopRatedBuyingExperience() const {
    return m_top_rated_buying_experience;
}
void OAICoreItem::setTopRatedBuyingExperience(const bool &top_rated_buying_experience) {
    m_top_rated_buying_experience = top_rated_buying_experience;
    m_top_rated_buying_experience_isSet = true;
}

bool OAICoreItem::is_top_rated_buying_experience_Set() const{
    return m_top_rated_buying_experience_isSet;
}

bool OAICoreItem::is_top_rated_buying_experience_Valid() const{
    return m_top_rated_buying_experience_isValid;
}

qint32 OAICoreItem::getUniqueBidderCount() const {
    return m_unique_bidder_count;
}
void OAICoreItem::setUniqueBidderCount(const qint32 &unique_bidder_count) {
    m_unique_bidder_count = unique_bidder_count;
    m_unique_bidder_count_isSet = true;
}

bool OAICoreItem::is_unique_bidder_count_Set() const{
    return m_unique_bidder_count_isSet;
}

bool OAICoreItem::is_unique_bidder_count_Valid() const{
    return m_unique_bidder_count_isValid;
}

OAIConvertedAmount OAICoreItem::getUnitPrice() const {
    return m_unit_price;
}
void OAICoreItem::setUnitPrice(const OAIConvertedAmount &unit_price) {
    m_unit_price = unit_price;
    m_unit_price_isSet = true;
}

bool OAICoreItem::is_unit_price_Set() const{
    return m_unit_price_isSet;
}

bool OAICoreItem::is_unit_price_Valid() const{
    return m_unit_price_isValid;
}

QString OAICoreItem::getUnitPricingMeasure() const {
    return m_unit_pricing_measure;
}
void OAICoreItem::setUnitPricingMeasure(const QString &unit_pricing_measure) {
    m_unit_pricing_measure = unit_pricing_measure;
    m_unit_pricing_measure_isSet = true;
}

bool OAICoreItem::is_unit_pricing_measure_Set() const{
    return m_unit_pricing_measure_isSet;
}

bool OAICoreItem::is_unit_pricing_measure_Valid() const{
    return m_unit_pricing_measure_isValid;
}

bool OAICoreItem::isSet() const {
...
bool OAICoreItem::isValid() const {
