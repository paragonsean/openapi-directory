...
#ifndef OAIItemLocationImpl_H
#define OAIItemLocationImpl_H
...
class OAIItemLocationImpl : public OAIObject {
public:
    OAIItemLocationImpl();
    OAIItemLocationImpl(QString json);
    ~OAIItemLocationImpl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemLocationImpl)

#endif // OAIItemLocationImpl_H
