...
#ifndef OAICoreItem_H
#define OAICoreItem_H
...
class OAICoreItem : public OAIObject {
public:
    OAICoreItem();
    OAICoreItem(QString json);
    ~OAICoreItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICoreItem)
