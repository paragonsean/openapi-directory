...
#ifndef OAIConditionDistribution_H
#define OAIConditionDistribution_H
...
class OAIConditionDistribution : public OAIObject {
public:
    OAIConditionDistribution();
    OAIConditionDistribution(QString json);
    ~OAIConditionDistribution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConditionDistribution)

#endif // OAIConditionDistribution_H
