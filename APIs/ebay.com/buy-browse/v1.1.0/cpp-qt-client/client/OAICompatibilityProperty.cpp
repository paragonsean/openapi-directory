...
QString OAICompatibilityProperty::getValue() const {
    return m_value;
}
void OAICompatibilityProperty::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAICompatibilityProperty::is_value_Set() const{
    return m_value_isSet;
}

bool OAICompatibilityProperty::is_value_Valid() const{
