...
public class ItemLocationImpl {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemLocationImpl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemLocationImpl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemLocationImpl is not found in the empty JSON string", ItemLocationImpl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemLocationImpl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemLocationImpl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemLocationImpl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemLocationImpl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemLocationImpl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemLocationImpl.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemLocationImpl>() {
           @Override
           public void write(JsonWriter out, ItemLocationImpl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemLocationImpl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ItemLocationImpl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemLocationImpl
   * @throws IOException if the JSON string is invalid with respect to ItemLocationImpl
   */
  public static ItemLocationImpl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemLocationImpl.class);
  }

  /**
   * Convert an instance of ItemLocationImpl to an JSON string
   *
   * @return JSON string
   */
