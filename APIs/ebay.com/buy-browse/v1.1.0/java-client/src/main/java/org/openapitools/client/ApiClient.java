...
public class ApiClient {
    ...
    private String basePath = "https://api.ebay.com/buy/browse/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("Authorization Code", new OAuth());
        authentications.put("Client Credentials", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ebay.com/buy/browse/v1
