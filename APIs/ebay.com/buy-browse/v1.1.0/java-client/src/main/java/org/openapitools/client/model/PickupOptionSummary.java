...
public class PickupOptionSummary {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PickupOptionSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PickupOptionSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PickupOptionSummary is not found in the empty JSON string", PickupOptionSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PickupOptionSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PickupOptionSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PickupOptionSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PickupOptionSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PickupOptionSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PickupOptionSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<PickupOptionSummary>() {
           @Override
           public void write(JsonWriter out, PickupOptionSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PickupOptionSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PickupOptionSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PickupOptionSummary
   * @throws IOException if the JSON string is invalid with respect to PickupOptionSummary
   */
  public static PickupOptionSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PickupOptionSummary.class);
  }

  /**
   * Convert an instance of PickupOptionSummary to an JSON string
   *
   * @return JSON string
   */
