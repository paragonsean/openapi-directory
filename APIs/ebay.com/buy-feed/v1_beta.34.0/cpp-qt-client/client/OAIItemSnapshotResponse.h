...
namespace OpenAPI {
class OAIItemSnapshot;

class OAIItemSnapshotResponse : public OAIObject {
public:
    OAIItemSnapshotResponse();
    OAIItemSnapshotResponse(QString json);
    ~OAIItemSnapshotResponse() override;
    ...
    QList<OAIItemSnapshot> getItems() const;
    void setItems(const QList<OAIItemSnapshot> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemSnapshotResponse)

#endif // OAIItemSnapshotResponse_H
