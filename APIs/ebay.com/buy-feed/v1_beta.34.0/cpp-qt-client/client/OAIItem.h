...
public:
    ...
    QString getInferredBrand() const;
    void setInferredBrand(const QString &inferred_brand);
    bool is_inferred_brand_Set() const;
    bool is_inferred_brand_Valid() const;
    ...
    QString getInferredGtin() const;
    void setInferredGtin(const QString &inferred_gtin);
    bool is_inferred_gtin_Set() const;
    bool is_inferred_gtin_Valid() const;

    QString getInferredLocalizedAspects() const;
    void setInferredLocalizedAspects(const QString &inferred_localized_aspects);
    bool is_inferred_localized_aspects_Set() const;
    bool is_inferred_localized_aspects_Valid() const;

    QString getInferredMpn() const;
    void setInferredMpn(const QString &inferred_mpn);
    bool is_inferred_mpn_Set() const;
    bool is_inferred_mpn_Valid() const;
    ...
    QString getLengthUnitOfMeasure() const;
    void setLengthUnitOfMeasure(const QString &length_unit_of_measure);
    bool is_length_unit_of_measure_Set() const;
    bool is_length_unit_of_measure_Valid() const;
    ...
    QString getPackageHeight() const;
    void setPackageHeight(const QString &package_height);
    bool is_package_height_Set() const;
    bool is_package_height_Valid() const;

    QString getPackageLength() const;
    void setPackageLength(const QString &package_length);
    bool is_package_length_Set() const;
    bool is_package_length_Valid() const;

    QString getPackageWeight() const;
    void setPackageWeight(const QString &package_weight);
    bool is_package_weight_Set() const;
    bool is_package_weight_Valid() const;

    QString getPackageWidth() const;
    void setPackageWidth(const QString &package_width);
    ...
    QString getWeightUnitOfMeasure() const;
    void setWeightUnitOfMeasure(const QString &weight_unit_of_measure);
    bool is_weight_unit_of_measure_Set() const;
    bool is_weight_unit_of_measure_Valid() const;
...
private:
    ...
    QString m_inferred_brand;
    bool m_inferred_brand_isSet;
    bool m_inferred_brand_isValid;

    QString m_inferred_epid;
    bool m_inferred_epid_isSet;
    bool m_inferred_epid_isValid;

    QString m_inferred_gtin;
    bool m_inferred_gtin_isSet;
    bool m_inferred_gtin_isValid;

    QString m_inferred_localized_aspects;
    bool m_inferred_localized_aspects_isSet;
    bool m_inferred_localized_aspects_isValid;

    QString m_inferred_mpn;
    bool m_inferred_mpn_isSet;
    bool m_inferred_mpn_isValid;
    ...
    QString m_length_unit_of_measure;
    bool m_length_unit_of_measure_isSet;
    bool m_length_unit_of_measure_isValid;
    ...
    QString m_package_height;
    bool m_package_height_isSet;
    bool m_package_height_isValid;

    QString m_package_length;
    bool m_package_length_isSet;
    bool m_package_length_isValid;

    QString m_package_weight;
    bool m_package_weight_isSet;
    bool m_package_weight_isValid;

    QString m_package_width;
    ...
    QString m_weight_unit_of_measure;
    bool m_weight_unit_of_measure_isSet;
    bool m_weight_unit_of_measure_isValid;
};
