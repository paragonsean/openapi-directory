...
QList<OAIItem> OAIItemResponse::getItems() const {
    return m_items;
}
void OAIItemResponse::setItems(const QList<OAIItem> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIItemResponse::is_items_Set() const{
    return m_items_isSet;
}

bool OAIItemResponse::is_items_Valid() const{
