...
public class ApiClient {
    ...
    private String basePath = "https://api.ebay.com/buy/feed/v1_beta";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1_beta.34.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ebay.com/buy/feed/v1_beta
