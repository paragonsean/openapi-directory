...
public class ItemSnapshot {
  ...
  public static final String SERIALIZED_NAME_AUTHENTICITY_GUARANTEE_FEE_CURRENCY = "authenticityGuaranteeFeeCurrency";
  @SerializedName(SERIALIZED_NAME_AUTHENTICITY_GUARANTEE_FEE_CURRENCY)
  private String authenticityGuaranteeFeeCurrency;

  public static final String SERIALIZED_NAME_AUTHENTICITY_GUARANTEE_FEE_VALUE = "authenticityGuaranteeFeeValue";
  @SerializedName(SERIALIZED_NAME_AUTHENTICITY_GUARANTEE_FEE_VALUE)
  private String authenticityGuaranteeFeeValue;

  public static final String SERIALIZED_NAME_AUTHENTICITY_GUARANTEE_SELECTION = "authenticityGuaranteeSelection";
  @SerializedName(SERIALIZED_NAME_AUTHENTICITY_GUARANTEE_SELECTION)
  private String authenticityGuaranteeSelection;

  public static final String SERIALIZED_NAME_AUTHENTICITY_GUARANTEE_SERVICE_ID = "authenticityGuaranteeServiceId";
  @SerializedName(SERIALIZED_NAME_AUTHENTICITY_GUARANTEE_SERVICE_ID)
  private String authenticityGuaranteeServiceId;
  ...
  public static final String SERIALIZED_NAME_COUPON_DISCOUNT_CURRENCY = "couponDiscountCurrency";
  @SerializedName(SERIALIZED_NAME_COUPON_DISCOUNT_CURRENCY)
  private String couponDiscountCurrency;

  public static final String SERIALIZED_NAME_COUPON_DISCOUNT_TYPE = "couponDiscountType";
  @SerializedName(SERIALIZED_NAME_COUPON_DISCOUNT_TYPE)
  private String couponDiscountType;

  public static final String SERIALIZED_NAME_COUPON_DISCOUNT_VALUE = "couponDiscountValue";
  @SerializedName(SERIALIZED_NAME_COUPON_DISCOUNT_VALUE)
  private String couponDiscountValue;

  public static final String SERIALIZED_NAME_COUPON_EXPIRATION_DATE = "couponExpirationDate";
  @SerializedName(SERIALIZED_NAME_COUPON_EXPIRATION_DATE)
  private String couponExpirationDate;

  public static final String SERIALIZED_NAME_COUPON_MESSAGE = "couponMessage";
  @SerializedName(SERIALIZED_NAME_COUPON_MESSAGE)
  private String couponMessage;

  public static final String SERIALIZED_NAME_COUPON_REDEMPTION_CODE = "couponRedemptionCode";
  @SerializedName(SERIALIZED_NAME_COUPON_REDEMPTION_CODE)
  private String couponRedemptionCode;

  public static final String SERIALIZED_NAME_COUPON_TERMS_WEB_URL = "couponTermsWebUrl";
  @SerializedName(SERIALIZED_NAME_COUPON_TERMS_WEB_URL)
  private String couponTermsWebUrl;
  ...
  public static final String SERIALIZED_NAME_ITEM_SNAPSHOT_DATE = "itemSnapshotDate";
  @SerializedName(SERIALIZED_NAME_ITEM_SNAPSHOT_DATE)
  private String itemSnapshotDate;
  ...
  public ItemSnapshot acceptedPaymentMethods(String acceptedPaymentMethods) {
  ...
  public ItemSnapshot additionalImageUrls(String additionalImageUrls) {
  ...
  public ItemSnapshot additionalShippingCostPerUnit(String additionalShippingCostPerUnit) {
  ...
  public ItemSnapshot ageGroup(String ageGroup) {
  ...
  public ItemSnapshot alerts(String alerts) {
    this.alerts = alerts;
    return this;
  }
  ...
  public ItemSnapshot authenticityGuaranteeFeeCurrency(String authenticityGuaranteeFeeCurrency) {
   ...
   * @return authenticityGuaranteeFeeCurrency
   */
  @javax.annotation.Nullable
  public String getAuthenticityGuaranteeFeeCurrency() {
    return authenticityGuaranteeFeeCurrency;
  }

  public void setAuthenticityGuaranteeFeeCurrency(String authenticityGuaranteeFeeCurrency) {
    this.authenticityGuaranteeFeeCurrency = authenticityGuaranteeFeeCurrency;
  }


  public ItemSnapshot authenticityGuaranteeFeeValue(String authenticityGuaranteeFeeValue) {
   ...
   * @return authenticityGuaranteeFeeValue
   */
  @javax.annotation.Nullable
  public String getAuthenticityGuaranteeFeeValue() {
    return authenticityGuaranteeFeeValue;
  }

  public void setAuthenticityGuaranteeFeeValue(String authenticityGuaranteeFeeValue) {
    this.authenticityGuaranteeFeeValue = authenticityGuaranteeFeeValue;
  }


  public ItemSnapshot authenticityGuaranteeSelection(String authenticityGuaranteeSelection) {
   ...
   * @return authenticityGuaranteeSelection
   */
  @javax.annotation.Nullable
  public String getAuthenticityGuaranteeSelection() {
    return authenticityGuaranteeSelection;
  }

  public void setAuthenticityGuaranteeSelection(String authenticityGuaranteeSelection) {
    this.authenticityGuaranteeSelection = authenticityGuaranteeSelection;
  }


  public ItemSnapshot authenticityGuaranteeServiceId(String authenticityGuaranteeServiceId) {
   ...
   * @return authenticityGuaranteeServiceId
   */
  @javax.annotation.Nullable
  public String getAuthenticityGuaranteeServiceId() {
    return authenticityGuaranteeServiceId;
  }

  public void setAuthenticityGuaranteeServiceId(String authenticityGuaranteeServiceId) {
    this.authenticityGuaranteeServiceId = authenticityGuaranteeServiceId;
  }


  public ItemSnapshot availability(String availability) {
  ...
  public ItemSnapshot availabilityThreshold(Integer availabilityThreshold) {
  ...
  public ItemSnapshot availabilityThresholdType(String availabilityThresholdType) {
  ...
  public ItemSnapshot brand(String brand) {
    this.brand = brand;
    return this;
  }
  ...
  public ItemSnapshot buyingOptions(String buyingOptions) {
  ...
  public ItemSnapshot category(String category) {
  ...
  public ItemSnapshot categoryId(String categoryId) {
  ...
  public ItemSnapshot changeMetadata(String changeMetadata) {
  ...
  public ItemSnapshot color(String color) {
    this.color = color;
    return this;
  }
  ...
  public ItemSnapshot condition(String condition) {
  ...
  public ItemSnapshot conditionId(String conditionId) {
  ...
  public ItemSnapshot couponDiscountCurrency(String couponDiscountCurrency) {
   ...
   * @return couponDiscountCurrency
   */
  @javax.annotation.Nullable
  public String getCouponDiscountCurrency() {
    return couponDiscountCurrency;
  }

  public void setCouponDiscountCurrency(String couponDiscountCurrency) {
    this.couponDiscountCurrency = couponDiscountCurrency;
  }


  public ItemSnapshot couponDiscountType(String couponDiscountType) {
  ...
  public ItemSnapshot couponDiscountValue(String couponDiscountValue) {
  ...
  public ItemSnapshot couponExpirationDate(String couponExpirationDate) {
  ...
  public ItemSnapshot couponMessage(String couponMessage) {
  ...
  public ItemSnapshot couponRedemptionCode(String couponRedemptionCode) {
  ...
  public ItemSnapshot couponTermsWebUrl(String couponTermsWebUrl) {
   ...
   * @return couponTermsWebUrl
   */
  @javax.annotation.Nullable
  public String getCouponTermsWebUrl() {
    return couponTermsWebUrl;
  }

  public void setCouponTermsWebUrl(String couponTermsWebUrl) {
    this.couponTermsWebUrl = couponTermsWebUrl;
  }


  public ItemSnapshot defaultImageUrl(String defaultImageUrl) {
  ...
  public ItemSnapshot deliveryOptions(String deliveryOptions) {
  ...
  public ItemSnapshot description(String description) {
  ...
  public ItemSnapshot discountAmount(String discountAmount) {
  ...
  public ItemSnapshot discountPercentage(String discountPercentage) {
  ...
  public ItemSnapshot ecoParticipationFeeCurrency(String ecoParticipationFeeCurrency) {
  ...
  public ItemSnapshot ecoParticipationFeeValue(String ecoParticipationFeeValue) {
  ...
  public ItemSnapshot energyEfficiencyClass(String energyEfficiencyClass) {
  ...
  public ItemSnapshot epid(String epid) {
    this.epid = epid;
    return this;
  }
  ...
  public ItemSnapshot estimatedAvailableQuantity(Integer estimatedAvailableQuantity) {
  ...
  public ItemSnapshot gender(String gender) {
    this.gender = gender;
    return this;
  }
  ...
  public ItemSnapshot gtin(String gtin) {
    this.gtin = gtin;
    return this;
  }
  ...
  public ItemSnapshot hazmatAdditionalInformation(String hazmatAdditionalInformation) {
  ...
  public ItemSnapshot hazmatPictogramDescriptions(String hazmatPictogramDescriptions) {
  ...
  public ItemSnapshot hazmatPictogramIds(String hazmatPictogramIds) {
  ...
  public ItemSnapshot hazmatPictogramImageUrls(String hazmatPictogramImageUrls) {
  ...
  public ItemSnapshot hazmatSignalWord(String hazmatSignalWord) {
  ...
  public ItemSnapshot hazmatSignalWordId(String hazmatSignalWordId) {
  ...
  public ItemSnapshot hazmatStatementDescriptions(String hazmatStatementDescriptions) {
  ...
  public ItemSnapshot hazmatStatementIds(String hazmatStatementIds) {
  ...
  public ItemSnapshot imageAlteringProhibited(Boolean imageAlteringProhibited) {
  ...
  public ItemSnapshot imageUrl(String imageUrl) {
  ...
  public ItemSnapshot inferredEpid(String inferredEpid) {
  ...
  public ItemSnapshot itemAffiliateWebUrl(String itemAffiliateWebUrl) {
  ...
  public ItemSnapshot itemCreationDate(String itemCreationDate) {
  ...
  public ItemSnapshot itemEndDate(String itemEndDate) {
  ...
  public ItemSnapshot itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public ItemSnapshot itemLocationCountry(String itemLocationCountry) {
  ...
  public ItemSnapshot itemSnapshotDate(String itemSnapshotDate) {
   ...
   * @return itemSnapshotDate
   */
  @javax.annotation.Nullable
  public String getItemSnapshotDate() {
    return itemSnapshotDate;
  }

  public void setItemSnapshotDate(String itemSnapshotDate) {
    this.itemSnapshotDate = itemSnapshotDate;
  }


  public ItemSnapshot itemWebUrl(String itemWebUrl) {
  ...
  public ItemSnapshot legacyItemId(String legacyItemId) {
  ...
  public ItemSnapshot localizedAspects(String localizedAspects) {
  ...
  public ItemSnapshot lotSize(Integer lotSize) {
  ...
  public ItemSnapshot material(String material) {
  ...
  public ItemSnapshot mpn(String mpn) {
    this.mpn = mpn;
    return this;
  }
  ...
  public ItemSnapshot originalPriceCurrency(String originalPriceCurrency) {
  ...
  public ItemSnapshot originalPriceValue(String originalPriceValue) {
  ...
  public ItemSnapshot pattern(String pattern) {
  ...
  public ItemSnapshot priceCurrency(String priceCurrency) {
  ...
  public ItemSnapshot priceValue(String priceValue) {
  ...
  public ItemSnapshot primaryItemGroupId(String primaryItemGroupId) {
  ...
  public ItemSnapshot primaryItemGroupType(String primaryItemGroupType) {
  ...
  public ItemSnapshot qualifiedPrograms(String qualifiedPrograms) {
  ...
  public ItemSnapshot quantityUsedForEstimate(Integer quantityUsedForEstimate) {
  ...
  public ItemSnapshot refundMethod(String refundMethod) {
  ...
  public ItemSnapshot repairScore(String repairScore) {
  ...
  public ItemSnapshot returnMethod(String returnMethod) {
  ...
  public ItemSnapshot returnPeriodUnit(String returnPeriodUnit) {
  ...
  public ItemSnapshot returnPeriodValue(Integer returnPeriodValue) {
  ...
  public ItemSnapshot returnShippingCostPayer(String returnShippingCostPayer) {
  ...
  public ItemSnapshot returnsAccepted(Boolean returnsAccepted) {
  ...
  public ItemSnapshot sellerAccountType(String sellerAccountType) {
  ...
  public ItemSnapshot sellerFeedbackPercentage(String sellerFeedbackPercentage) {
  ...
  public ItemSnapshot sellerFeedbackScore(String sellerFeedbackScore) {
  ...
  public ItemSnapshot sellerItemRevision(String sellerItemRevision) {
  ...
  public ItemSnapshot sellerTrustLevel(String sellerTrustLevel) {
  ...
  public ItemSnapshot sellerUsername(String sellerUsername) {
  ...
  public ItemSnapshot shipToExcludedRegions(String shipToExcludedRegions) {
  ...
  public ItemSnapshot shipToIncludedRegions(String shipToIncludedRegions) {
  ...
  public ItemSnapshot shippingCarrierCode(String shippingCarrierCode) {
  ...
  public ItemSnapshot shippingCost(String shippingCost) {
  ...
  public ItemSnapshot shippingCostType(String shippingCostType) {
  ...
  public ItemSnapshot shippingServiceCode(String shippingServiceCode) {
  ...
  public ItemSnapshot shippingType(String shippingType) {
  ...
  public ItemSnapshot size(String size) {
    this.size = size;
    return this;
  }
  ...
  public ItemSnapshot takeBackPolicyDescription(String takeBackPolicyDescription) {
  ...
  public ItemSnapshot takeBackPolicyLabel(String takeBackPolicyLabel) {
  ...
  public ItemSnapshot title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ItemSnapshot totalUnits(String totalUnits) {
  ...
  public ItemSnapshot tyreLabelImageUrl(String tyreLabelImageUrl) {
  ...
  public ItemSnapshot unitPrice(String unitPrice) {
  ...
  public ItemSnapshot unitPricingMeasure(String unitPricingMeasure) {
  ...
  public boolean equals(Object o) {
    ...
    ItemSnapshot itemSnapshot = (ItemSnapshot) o;
    return Objects.equals(this.acceptedPaymentMethods, itemSnapshot.acceptedPaymentMethods) &&
        Objects.equals(this.additionalImageUrls, itemSnapshot.additionalImageUrls) &&
        Objects.equals(this.additionalShippingCostPerUnit, itemSnapshot.additionalShippingCostPerUnit) &&
        Objects.equals(this.ageGroup, itemSnapshot.ageGroup) &&
        Objects.equals(this.alerts, itemSnapshot.alerts) &&
        Objects.equals(this.authenticityGuaranteeFeeCurrency, itemSnapshot.authenticityGuaranteeFeeCurrency) &&
        Objects.equals(this.authenticityGuaranteeFeeValue, itemSnapshot.authenticityGuaranteeFeeValue) &&
        Objects.equals(this.authenticityGuaranteeSelection, itemSnapshot.authenticityGuaranteeSelection) &&
        Objects.equals(this.authenticityGuaranteeServiceId, itemSnapshot.authenticityGuaranteeServiceId) &&
        Objects.equals(this.availability, itemSnapshot.availability) &&
        Objects.equals(this.availabilityThreshold, itemSnapshot.availabilityThreshold) &&
        Objects.equals(this.availabilityThresholdType, itemSnapshot.availabilityThresholdType) &&
        Objects.equals(this.brand, itemSnapshot.brand) &&
        Objects.equals(this.buyingOptions, itemSnapshot.buyingOptions) &&
        Objects.equals(this.category, itemSnapshot.category) &&
        Objects.equals(this.categoryId, itemSnapshot.categoryId) &&
        Objects.equals(this.changeMetadata, itemSnapshot.changeMetadata) &&
        Objects.equals(this.color, itemSnapshot.color) &&
        Objects.equals(this.condition, itemSnapshot.condition) &&
        Objects.equals(this.conditionId, itemSnapshot.conditionId) &&
        Objects.equals(this.couponDiscountCurrency, itemSnapshot.couponDiscountCurrency) &&
        Objects.equals(this.couponDiscountType, itemSnapshot.couponDiscountType) &&
        Objects.equals(this.couponDiscountValue, itemSnapshot.couponDiscountValue) &&
        Objects.equals(this.couponExpirationDate, itemSnapshot.couponExpirationDate) &&
        Objects.equals(this.couponMessage, itemSnapshot.couponMessage) &&
        Objects.equals(this.couponRedemptionCode, itemSnapshot.couponRedemptionCode) &&
        Objects.equals(this.couponTermsWebUrl, itemSnapshot.couponTermsWebUrl) &&
        Objects.equals(this.defaultImageUrl, itemSnapshot.defaultImageUrl) &&
        Objects.equals(this.deliveryOptions, itemSnapshot.deliveryOptions) &&
        Objects.equals(this.description, itemSnapshot.description) &&
        Objects.equals(this.discountAmount, itemSnapshot.discountAmount) &&
        Objects.equals(this.discountPercentage, itemSnapshot.discountPercentage) &&
        Objects.equals(this.ecoParticipationFeeCurrency, itemSnapshot.ecoParticipationFeeCurrency) &&
        Objects.equals(this.ecoParticipationFeeValue, itemSnapshot.ecoParticipationFeeValue) &&
        Objects.equals(this.energyEfficiencyClass, itemSnapshot.energyEfficiencyClass) &&
        Objects.equals(this.epid, itemSnapshot.epid) &&
        Objects.equals(this.estimatedAvailableQuantity, itemSnapshot.estimatedAvailableQuantity) &&
        Objects.equals(this.gender, itemSnapshot.gender) &&
        Objects.equals(this.gtin, itemSnapshot.gtin) &&
        Objects.equals(this.hazmatAdditionalInformation, itemSnapshot.hazmatAdditionalInformation) &&
        Objects.equals(this.hazmatPictogramDescriptions, itemSnapshot.hazmatPictogramDescriptions) &&
        Objects.equals(this.hazmatPictogramIds, itemSnapshot.hazmatPictogramIds) &&
        Objects.equals(this.hazmatPictogramImageUrls, itemSnapshot.hazmatPictogramImageUrls) &&
        Objects.equals(this.hazmatSignalWord, itemSnapshot.hazmatSignalWord) &&
        Objects.equals(this.hazmatSignalWordId, itemSnapshot.hazmatSignalWordId) &&
        Objects.equals(this.hazmatStatementDescriptions, itemSnapshot.hazmatStatementDescriptions) &&
        Objects.equals(this.hazmatStatementIds, itemSnapshot.hazmatStatementIds) &&
        Objects.equals(this.imageAlteringProhibited, itemSnapshot.imageAlteringProhibited) &&
        Objects.equals(this.imageUrl, itemSnapshot.imageUrl) &&
        Objects.equals(this.inferredEpid, itemSnapshot.inferredEpid) &&
        Objects.equals(this.itemAffiliateWebUrl, itemSnapshot.itemAffiliateWebUrl) &&
        Objects.equals(this.itemCreationDate, itemSnapshot.itemCreationDate) &&
        Objects.equals(this.itemEndDate, itemSnapshot.itemEndDate) &&
        Objects.equals(this.itemId, itemSnapshot.itemId) &&
        Objects.equals(this.itemLocationCountry, itemSnapshot.itemLocationCountry) &&
        Objects.equals(this.itemSnapshotDate, itemSnapshot.itemSnapshotDate) &&
        Objects.equals(this.itemWebUrl, itemSnapshot.itemWebUrl) &&
        Objects.equals(this.legacyItemId, itemSnapshot.legacyItemId) &&
        Objects.equals(this.localizedAspects, itemSnapshot.localizedAspects) &&
        Objects.equals(this.lotSize, itemSnapshot.lotSize) &&
        Objects.equals(this.material, itemSnapshot.material) &&
        Objects.equals(this.mpn, itemSnapshot.mpn) &&
        Objects.equals(this.originalPriceCurrency, itemSnapshot.originalPriceCurrency) &&
        Objects.equals(this.originalPriceValue, itemSnapshot.originalPriceValue) &&
        Objects.equals(this.pattern, itemSnapshot.pattern) &&
        Objects.equals(this.priceCurrency, itemSnapshot.priceCurrency) &&
        Objects.equals(this.priceValue, itemSnapshot.priceValue) &&
        Objects.equals(this.primaryItemGroupId, itemSnapshot.primaryItemGroupId) &&
        Objects.equals(this.primaryItemGroupType, itemSnapshot.primaryItemGroupType) &&
        Objects.equals(this.qualifiedPrograms, itemSnapshot.qualifiedPrograms) &&
        Objects.equals(this.quantityUsedForEstimate, itemSnapshot.quantityUsedForEstimate) &&
        Objects.equals(this.refundMethod, itemSnapshot.refundMethod) &&
        Objects.equals(this.repairScore, itemSnapshot.repairScore) &&
        Objects.equals(this.returnMethod, itemSnapshot.returnMethod) &&
        Objects.equals(this.returnPeriodUnit, itemSnapshot.returnPeriodUnit) &&
        Objects.equals(this.returnPeriodValue, itemSnapshot.returnPeriodValue) &&
        Objects.equals(this.returnShippingCostPayer, itemSnapshot.returnShippingCostPayer) &&
        Objects.equals(this.returnsAccepted, itemSnapshot.returnsAccepted) &&
        Objects.equals(this.sellerAccountType, itemSnapshot.sellerAccountType) &&
        Objects.equals(this.sellerFeedbackPercentage, itemSnapshot.sellerFeedbackPercentage) &&
        Objects.equals(this.sellerFeedbackScore, itemSnapshot.sellerFeedbackScore) &&
        Objects.equals(this.sellerItemRevision, itemSnapshot.sellerItemRevision) &&
        Objects.equals(this.sellerTrustLevel, itemSnapshot.sellerTrustLevel) &&
        Objects.equals(this.sellerUsername, itemSnapshot.sellerUsername) &&
        Objects.equals(this.shipToExcludedRegions, itemSnapshot.shipToExcludedRegions) &&
        Objects.equals(this.shipToIncludedRegions, itemSnapshot.shipToIncludedRegions) &&
        Objects.equals(this.shippingCarrierCode, itemSnapshot.shippingCarrierCode) &&
        Objects.equals(this.shippingCost, itemSnapshot.shippingCost) &&
        Objects.equals(this.shippingCostType, itemSnapshot.shippingCostType) &&
        Objects.equals(this.shippingServiceCode, itemSnapshot.shippingServiceCode) &&
        Objects.equals(this.shippingType, itemSnapshot.shippingType) &&
        Objects.equals(this.size, itemSnapshot.size) &&
        Objects.equals(this.takeBackPolicyDescription, itemSnapshot.takeBackPolicyDescription) &&
        Objects.equals(this.takeBackPolicyLabel, itemSnapshot.takeBackPolicyLabel) &&
        Objects.equals(this.title, itemSnapshot.title) &&
        Objects.equals(this.totalUnits, itemSnapshot.totalUnits) &&
        Objects.equals(this.tyreLabelImageUrl, itemSnapshot.tyreLabelImageUrl) &&
        Objects.equals(this.unitPrice, itemSnapshot.unitPrice) &&
        Objects.equals(this.unitPricingMeasure, itemSnapshot.unitPricingMeasure);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acceptedPaymentMethods, additionalImageUrls, additionalShippingCostPerUnit, ageGroup, alerts, authenticityGuaranteeFeeCurrency, authenticityGuaranteeFeeValue, authenticityGuaranteeSelection, authenticityGuaranteeServiceId, availability, availabilityThreshold, availabilityThresholdType, brand, buyingOptions, category, categoryId, changeMetadata, color, condition, conditionId, couponDiscountCurrency, couponDiscountType, couponDiscountValue, couponExpirationDate, couponMessage, couponRedemptionCode, couponTermsWebUrl, defaultImageUrl, deliveryOptions, description, discountAmount, discountPercentage, ecoParticipationFeeCurrency, ecoParticipationFeeValue, energyEfficiencyClass, epid, estimatedAvailableQuantity, gender, gtin, hazmatAdditionalInformation, hazmatPictogramDescriptions, hazmatPictogramIds, hazmatPictogramImageUrls, hazmatSignalWord, hazmatSignalWordId, hazmatStatementDescriptions, hazmatStatementIds, imageAlteringProhibited, imageUrl, inferredEpid, itemAffiliateWebUrl, itemCreationDate, itemEndDate, itemId, itemLocationCountry, itemSnapshotDate, itemWebUrl, legacyItemId, localizedAspects, lotSize, material, mpn, originalPriceCurrency, originalPriceValue, pattern, priceCurrency, priceValue, primaryItemGroupId, primaryItemGroupType, qualifiedPrograms, quantityUsedForEstimate, refundMethod, repairScore, returnMethod, returnPeriodUnit, returnPeriodValue, returnShippingCostPayer, returnsAccepted, sellerAccountType, sellerFeedbackPercentage, sellerFeedbackScore, sellerItemRevision, sellerTrustLevel, sellerUsername, shipToExcludedRegions, shipToIncludedRegions, shippingCarrierCode, shippingCost, shippingCostType, shippingServiceCode, shippingType, size, takeBackPolicyDescription, takeBackPolicyLabel, title, totalUnits, tyreLabelImageUrl, unitPrice, unitPricingMeasure);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ItemSnapshot {\n");
    ...
    sb.append("    authenticityGuaranteeFeeCurrency: ").append(toIndentedString(authenticityGuaranteeFeeCurrency)).append("\n");
    sb.append("    authenticityGuaranteeFeeValue: ").append(toIndentedString(authenticityGuaranteeFeeValue)).append("\n");
    sb.append("    authenticityGuaranteeSelection: ").append(toIndentedString(authenticityGuaranteeSelection)).append("\n");
    sb.append("    authenticityGuaranteeServiceId: ").append(toIndentedString(authenticityGuaranteeServiceId)).append("\n");
    ...
    sb.append("    couponDiscountCurrency: ").append(toIndentedString(couponDiscountCurrency)).append("\n");
    sb.append("    couponDiscountType: ").append(toIndentedString(couponDiscountType)).append("\n");
    sb.append("    couponDiscountValue: ").append(toIndentedString(couponDiscountValue)).append("\n");
    sb.append("    couponExpirationDate: ").append(toIndentedString(couponExpirationDate)).append("\n");
    sb.append("    couponMessage: ").append(toIndentedString(couponMessage)).append("\n");
    sb.append("    couponRedemptionCode: ").append(toIndentedString(couponRedemptionCode)).append("\n");
    sb.append("    couponTermsWebUrl: ").append(toIndentedString(couponTermsWebUrl)).append("\n");
    ...
    sb.append("    itemSnapshotDate: ").append(toIndentedString(itemSnapshotDate)).append("\n");
  ...
  static {
    ...
    openapiFields.add("authenticityGuaranteeFeeCurrency");
    openapiFields.add("authenticityGuaranteeFeeValue");
    openapiFields.add("authenticityGuaranteeSelection");
    openapiFields.add("authenticityGuaranteeServiceId");
    ...
    openapiFields.add("couponDiscountCurrency");
    openapiFields.add("couponDiscountType");
    openapiFields.add("couponDiscountValue");
    openapiFields.add("couponExpirationDate");
    openapiFields.add("couponMessage");
    openapiFields.add("couponRedemptionCode");
    openapiFields.add("couponTermsWebUrl");
    ...
    openapiFields.add("itemSnapshotDate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ItemSnapshot
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemSnapshot.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ItemSnapshot is not found in the empty JSON string", ItemSnapshot.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemSnapshot.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ItemSnapshot` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("authenticityGuaranteeFeeCurrency") != null && !jsonObj.get("authenticityGuaranteeFeeCurrency").isJsonNull()) && !jsonObj.get("authenticityGuaranteeFeeCurrency").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `authenticityGuaranteeFeeCurrency` to be a primitive type in the JSON string but got `%s`", jsonObj.get("authenticityGuaranteeFeeCurrency").toString()));
      }
      if ((jsonObj.get("authenticityGuaranteeFeeValue") != null && !jsonObj.get("authenticityGuaranteeFeeValue").isJsonNull()) && !jsonObj.get("authenticityGuaranteeFeeValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `authenticityGuaranteeFeeValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("authenticityGuaranteeFeeValue").toString()));
      }
      if ((jsonObj.get("authenticityGuaranteeSelection") != null && !jsonObj.get("authenticityGuaranteeSelection").isJsonNull()) && !jsonObj.get("authenticityGuaranteeSelection").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `authenticityGuaranteeSelection` to be a primitive type in the JSON string but got `%s`", jsonObj.get("authenticityGuaranteeSelection").toString()));
      }
      if ((jsonObj.get("authenticityGuaranteeServiceId") != null && !jsonObj.get("authenticityGuaranteeServiceId").isJsonNull()) && !jsonObj.get("authenticityGuaranteeServiceId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `authenticityGuaranteeServiceId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("authenticityGuaranteeServiceId").toString()));
      }
      ...
      if ((jsonObj.get("couponDiscountCurrency") != null && !jsonObj.get("couponDiscountCurrency").isJsonNull()) && !jsonObj.get("couponDiscountCurrency").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `couponDiscountCurrency` to be a primitive type in the JSON string but got `%s`", jsonObj.get("couponDiscountCurrency").toString()));
      }
      if ((jsonObj.get("couponDiscountType") != null && !jsonObj.get("couponDiscountType").isJsonNull()) && !jsonObj.get("couponDiscountType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `couponDiscountType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("couponDiscountType").toString()));
      }
      if ((jsonObj.get("couponDiscountValue") != null && !jsonObj.get("couponDiscountValue").isJsonNull()) && !jsonObj.get("couponDiscountValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `couponDiscountValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("couponDiscountValue").toString()));
      }
      if ((jsonObj.get("couponExpirationDate") != null && !jsonObj.get("couponExpirationDate").isJsonNull()) && !jsonObj.get("couponExpirationDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `couponExpirationDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("couponExpirationDate").toString()));
      }
      if ((jsonObj.get("couponMessage") != null && !jsonObj.get("couponMessage").isJsonNull()) && !jsonObj.get("couponMessage").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `couponMessage` to be a primitive type in the JSON string but got `%s`", jsonObj.get("couponMessage").toString()));
      }
      if ((jsonObj.get("couponRedemptionCode") != null && !jsonObj.get("couponRedemptionCode").isJsonNull()) && !jsonObj.get("couponRedemptionCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `couponRedemptionCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("couponRedemptionCode").toString()));
      }
      if ((jsonObj.get("couponTermsWebUrl") != null && !jsonObj.get("couponTermsWebUrl").isJsonNull()) && !jsonObj.get("couponTermsWebUrl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `couponTermsWebUrl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("couponTermsWebUrl").toString()));
      }
      ...
      if ((jsonObj.get("itemSnapshotDate") != null && !jsonObj.get("itemSnapshotDate").isJsonNull()) && !jsonObj.get("itemSnapshotDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `itemSnapshotDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("itemSnapshotDate").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ItemSnapshot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ItemSnapshot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ItemSnapshot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ItemSnapshot.class));

       return (TypeAdapter<T>) new TypeAdapter<ItemSnapshot>() {
           @Override
           public void write(JsonWriter out, ItemSnapshot value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ItemSnapshot read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ItemSnapshot given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ItemSnapshot
   * @throws IOException if the JSON string is invalid with respect to ItemSnapshot
   */
  public static ItemSnapshot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ItemSnapshot.class);
  }

  /**
   * Convert an instance of ItemSnapshot to an JSON string
   *
   * @return JSON string
   */
