...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ItemFeedService.ItemPriorityApi();
  });
  ...
  describe('ItemPriorityApi', function() {
    describe('getItemPriorityFeed', function() {
      it('should call getItemPriorityFeed successfully', function(done) {
        //uncomment below and update the code to test getItemPriorityFeed
        //instance.getItemPriorityFeed(function(error) {
