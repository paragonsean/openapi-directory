...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ItemFeedService.ItemSnapshotApi();
  });
  ...
  describe('ItemSnapshotApi', function() {
    describe('getItemSnapshotFeed', function() {
      it('should call getItemSnapshotFeed successfully', function(done) {
        //uncomment below and update the code to test getItemSnapshotFeed
        //instance.getItemSnapshotFeed(function(error) {
