...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ItemFeedService.ItemApi();
  });
  ...
  describe('ItemApi', function() {
    describe('getItemFeed', function() {
      it('should call getItemFeed successfully', function(done) {
        //uncomment below and update the code to test getItemFeed
        //instance.getItemFeed(function(error) {
