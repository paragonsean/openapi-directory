...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ItemFeedService.ItemGroupResponse();
  });
  ...
  describe('ItemGroupResponse', function() {
    it('should create an instance of ItemGroupResponse', function() {
      // uncomment below and update the code to test ItemGroupResponse
      //var instance = new ItemFeedService.ItemGroupResponse();
      //expect(instance).to.be.a(ItemFeedService.ItemGroupResponse);
    });

    it('should have the property itemGroups (base name: "itemGroups")', function() {
      // uncomment below and update the code to test the property itemGroups
      //var instance = new ItemFeedService.ItemGroupResponse();
