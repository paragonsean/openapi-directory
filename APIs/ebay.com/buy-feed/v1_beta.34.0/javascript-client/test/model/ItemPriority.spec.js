...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ItemFeedService.ItemPriority();
  });
  ...
  describe('ItemPriority', function() {
    it('should create an instance of ItemPriority', function() {
      // uncomment below and update the code to test ItemPriority
      //var instance = new ItemFeedService.ItemPriority();
      //expect(instance).to.be.a(ItemFeedService.ItemPriority);
    });
