...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ItemFeedService.ItemGroup();
  });
  ...
  describe('ItemGroup', function() {
    it('should create an instance of ItemGroup', function() {
      // uncomment below and update the code to test ItemGroup
      //var instance = new ItemFeedService.ItemGroup();
      //expect(instance).to.be.a(ItemFeedService.ItemGroup);
    });
    ...
    it('should have the property variesByLocalizedAspects (base name: "variesByLocalizedAspects")', function() {
      // uncomment below and update the code to test the property variesByLocalizedAspects
      //var instance = new ItemFeedService.ItemGroup();
      //expect(instance).to.be();
    });
