...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ItemFeedService.ItemPriorityResponse();
  });
  ...
  describe('ItemPriorityResponse', function() {
    it('should create an instance of ItemPriorityResponse', function() {
      // uncomment below and update the code to test ItemPriorityResponse
      //var instance = new ItemFeedService.ItemPriorityResponse();
      //expect(instance).to.be.a(ItemFeedService.ItemPriorityResponse);
    });

    it('should have the property itemDelta (base name: "itemDelta")', function() {
      // uncomment below and update the code to test the property itemDelta
      //var instance = new ItemFeedService.ItemPriorityResponse();
