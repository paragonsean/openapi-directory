...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ItemFeedService.ItemSnapshotResponse();
  });
  ...
  describe('ItemSnapshotResponse', function() {
    it('should create an instance of ItemSnapshotResponse', function() {
      // uncomment below and update the code to test ItemSnapshotResponse
      //var instance = new ItemFeedService.ItemSnapshotResponse();
      //expect(instance).to.be.a(ItemFeedService.ItemSnapshotResponse);
    });
