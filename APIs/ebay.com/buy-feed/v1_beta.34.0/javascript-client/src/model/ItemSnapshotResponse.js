...
/**
 * The ItemSnapshotResponse model module.
 * @module model/ItemSnapshotResponse
 * @version v1_beta.34.0
 */
class ItemSnapshotResponse {
    /**
     * Constructs a new <code>ItemSnapshotResponse</code>.
     * The type that defines the array for the items returned in the &lt;b&gt;Hourly Snapshot&lt;/b&gt; feed file.
     * @alias module:model/ItemSnapshotResponse
     */
    constructor() { 
        
        ItemSnapshotResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ItemSnapshotResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ItemSnapshotResponse} obj Optional instance to populate.
     * @return {module:model/ItemSnapshotResponse} The populated <code>ItemSnapshotResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemSnapshotResponse();

            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ItemSnapshot]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ItemSnapshotResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemSnapshotResponse</code>.
     */
    static validateJSON(data) {
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ItemSnapshot.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/ItemSnapshot>} items
 */
ItemSnapshotResponse.prototype['items'] = undefined;
...
export default ItemSnapshotResponse;
