...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ListingApi.ItemDraft();
  });
  ...
  describe('ItemDraft', function() {
    it('should create an instance of ItemDraft', function() {
      // uncomment below and update the code to test ItemDraft
      //var instance = new ListingApi.ItemDraft();
      //expect(instance).to.be.a(ListingApi.ItemDraft);
    });
