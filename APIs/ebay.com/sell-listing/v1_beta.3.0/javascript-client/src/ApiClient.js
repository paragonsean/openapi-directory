...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.ebay.com/sell/listing/v1_beta') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.ebay.com/sell/listing/v1_beta
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1_beta.3.0/Javascript'
        };
        ...
        return [
            {
              ...
              'variables': {
                basePath: {
                    ...
                    'default_value': "/sell/listing/v1_beta",
                  }
                }
            }
      ];
