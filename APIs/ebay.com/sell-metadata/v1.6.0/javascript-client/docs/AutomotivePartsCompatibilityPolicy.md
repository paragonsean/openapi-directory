# MetadataApi.AutomotivePartsCompatibilityPolicy
...
**compatibleVehicleTypes** | **[String]** | Indicates the compatibility classification of the part based on high-level vehicle types. | [optional] 
**maxNumberOfCompatibleVehicles** | **Number** | Specifies the maximum number of compatible vehicle-applications allowed per item. | [optional] 
