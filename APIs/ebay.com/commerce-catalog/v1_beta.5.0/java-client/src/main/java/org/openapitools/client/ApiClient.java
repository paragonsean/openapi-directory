...
public class ApiClient {
    ...
    private String basePath = "https://api.ebay.com/commerce/catalog/v1_beta";
    ...
    public ApiClient() {
        ...
        authentications.put("api_auth", new OAuth());
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1_beta.5.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.ebay.com/commerce/catalog/v1_beta
