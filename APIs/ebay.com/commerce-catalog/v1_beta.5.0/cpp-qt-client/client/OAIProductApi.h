...
public:
    ...
    /**
    * @param[in]  epid QString [required]
    * @param[in]  x_ebay_c_marketplace_id QString [optional]
    */
    virtual void getProduct(const QString &epid, const ::OpenAPI::OptionalParam<QString> &x_ebay_c_marketplace_id = ::OpenAPI::OptionalParam<QString>());
