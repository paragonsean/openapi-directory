...
public:
    ...
    QList<QString> getOtherApplicableCategoryIds() const;
    void setOtherApplicableCategoryIds(const QList<QString> &other_applicable_category_ids);
    bool is_other_applicable_category_ids_Set() const;
    bool is_other_applicable_category_ids_Valid() const;
...
private:
    ...
    QList<QString> m_other_applicable_category_ids;
    bool m_other_applicable_category_ids_isSet;
    bool m_other_applicable_category_ids_isValid;
