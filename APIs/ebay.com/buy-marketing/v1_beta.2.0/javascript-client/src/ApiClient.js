...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.ebay.com/buy/marketing/v1_beta') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.ebay.com/buy/marketing/v1_beta
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1_beta.2.0/Javascript'
        };
