...
**setpointHistory** | [**[NASetpointLog]**](NASetpointLog.md) | The last 20 setpoints (mode, endtime, and timestamp) the thermostats has entered. | [optional] 
**setpointOrder** | [**NASetpoint**](NASetpoint.md) |  | [optional] 
**thermOrientation** | **Number** |  | [optional] 
**thermProgramList** | [**[NAThermProgram]**](NAThermProgram.md) | List of the weekly heating planning used by the thermostat | [optional] 
**thermRelayCmd** | **Number** |  | [optional] 
