...
------------- | ------------- | -------------
[**getmeasure**](StationApi.md#getmeasure) | **GET** /getmeasure | 
[**getstationsdata**](StationApi.md#getstationsdata) | **GET** /getstationsdata | 



## getmeasure

> NAMeasureResponse getmeasure(deviceId, scale, type, opts)
...
let apiInstance = new Netatmo.StationApi();
...
apiInstance.getmeasure(deviceId, scale, type, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> NAStationDataResponse getstationsdata(opts)
...
let opts = {
  ...
  'getFavorites': false // Boolean | Whether to include the user's favorite Weather Stations in addition to the user's own Weather Stations
};
apiInstance.getstationsdata(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **getFavorites** | **Boolean**| Whether to include the user&#39;s favorite Weather Stations in addition to the user&#39;s own Weather Stations | [optional] [default to false]

### Return type

[**NAStationDataResponse**](NAStationDataResponse.md)
