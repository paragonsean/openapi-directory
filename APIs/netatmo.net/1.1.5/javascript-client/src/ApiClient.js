...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.netatmo.net/api') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.netatmo.net/api
         */
        ...
        this.authentications = {
            'code_oauth': {type: 'oauth2'},
            'password_oauth': {type: 'oauth2'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.1.5/Javascript'
        };
