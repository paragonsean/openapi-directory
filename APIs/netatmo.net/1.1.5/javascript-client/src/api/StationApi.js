...
export default class StationApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getmeasure operation.
     * @callback module:api/StationApi~getmeasureCallback
     ...
     * @param {module:api/StationApi~getmeasureCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NAMeasureResponse}
     */
    getmeasure(deviceId, scale, type, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'deviceId' is set
      if (deviceId === undefined || deviceId === null) {
        throw new Error("Missing the required parameter 'deviceId' when calling getmeasure");
      }
      // verify the required parameter 'scale' is set
      if (scale === undefined || scale === null) {
        throw new Error("Missing the required parameter 'scale' when calling getmeasure");
      }
      // verify the required parameter 'type' is set
      if (type === undefined || type === null) {
        throw new Error("Missing the required parameter 'type' when calling getmeasure");
      }
    ...
    /**
     * Callback function to receive the result of the getstationsdata operation.
     * @callback module:api/StationApi~getstationsdataCallback
     * @param {String} error Error message, if any.
     * @param {module:model/NAStationDataResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} [getFavorites = false)] Whether to include the user's favorite Weather Stations in addition to the user's own Weather Stations
     * @param {module:api/StationApi~getstationsdataCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NAStationDataResponse}
     */
    getstationsdata(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = NAStationDataResponse;
      return this.apiClient.callApi(
        '/getstationsdata', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
