...
export default class PartnerApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getmeasure_1 operation.
     * @callback module:api/PartnerApi~getmeasure_1Callback
     ...
     * @param {module:api/PartnerApi~getmeasure_1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NAMeasureResponse}
     */
    getmeasure_1(deviceId, scale, type, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'deviceId' is set
      if (deviceId === undefined || deviceId === null) {
        throw new Error("Missing the required parameter 'deviceId' when calling getmeasure_1");
      }
      // verify the required parameter 'scale' is set
      if (scale === undefined || scale === null) {
        throw new Error("Missing the required parameter 'scale' when calling getmeasure_1");
      }
      // verify the required parameter 'type' is set
      if (type === undefined || type === null) {
        throw new Error("Missing the required parameter 'type' when calling getmeasure_1");
      }
    ...
    /**
     * Callback function to receive the result of the partnerdevices operation.
     * @callback module:api/PartnerApi~partnerdevicesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/NAPartnerDevicesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * The method partnerdevices returns the list of device_id to which your partner application has access to.
     * @param {module:api/PartnerApi~partnerdevicesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/NAPartnerDevicesResponse}
     */
    partnerdevices(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = NAPartnerDevicesResponse;
      return this.apiClient.callApi(
        '/partnerdevices', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
