...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Netatmo.NALinkStation();
  });
  ...
  describe('NALinkStation', function() {
    it('should create an instance of NALinkStation', function() {
      // uncomment below and update the code to test NALinkStation
      //var instance = new Netatmo.NALinkStation();
      //expect(instance).to.be.a(Netatmo.NALinkStation);
    });
