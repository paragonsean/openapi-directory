...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Netatmo.NAWelcomeHome();
  });
  ...
  describe('NAWelcomeHome', function() {
    it('should create an instance of NAWelcomeHome', function() {
      // uncomment below and update the code to test NAWelcomeHome
      //var instance = new Netatmo.NAWelcomeHome();
      //expect(instance).to.be.a(Netatmo.NAWelcomeHome);
    });
