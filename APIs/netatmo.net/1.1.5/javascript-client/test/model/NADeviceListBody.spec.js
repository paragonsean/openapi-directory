...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Netatmo.NADeviceListBody();
  });
  ...
  describe('NADeviceListBody', function() {
    it('should create an instance of NADeviceListBody', function() {
      // uncomment below and update the code to test NADeviceListBody
      //var instance = new Netatmo.NADeviceListBody();
      //expect(instance).to.be.a(Netatmo.NADeviceListBody);
    });
