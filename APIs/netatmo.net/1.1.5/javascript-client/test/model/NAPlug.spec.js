...
(function(root, factory) {
  ...
  describe('NAPlug', function() {
    it('should create an instance of NAPlug', function() {
      // uncomment below and update the code to test NAPlug
      //var instance = new Netatmo.NAPlug();
      //expect(instance).to.be.a(Netatmo.NAPlug);
    });
    ...
    it('should have the property lastBilan (base name: "last_bilan")', function() {
      // uncomment below and update the code to test the property lastBilan
      //var instance = new Netatmo.NAPlug();
      //expect(instance).to.be();
    });
    ...
    it('should have the property syncing (base name: "syncing")', function() {
      // uncomment below and update the code to test the property syncing
      //var instance = new Netatmo.NAPlug();
      //expect(instance).to.be();
    });
