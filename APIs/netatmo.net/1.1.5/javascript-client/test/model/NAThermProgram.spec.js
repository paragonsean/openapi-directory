...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Netatmo.NAThermProgram();
  });
  ...
  describe('NAThermProgram', function() {
    it('should create an instance of NAThermProgram', function() {
      // uncomment below and update the code to test NAThermProgram
      //var instance = new Netatmo.NAThermProgram();
      //expect(instance).to.be.a(Netatmo.NAThermProgram);
    });
