...
(function(root, factory) {
  ...
  describe('NADevice', function() {
    it('should create an instance of NADevice', function() {
      // uncomment below and update the code to test NADevice
      //var instance = new Netatmo.NADevice();
      //expect(instance).to.be.a(Netatmo.NADevice);
    });
    ...
    it('should have the property heatingSystem (base name: "heating_system")', function() {
      // uncomment below and update the code to test the property heatingSystem
      //var instance = new Netatmo.NADevice();
      //expect(instance).to.be();
    });

    it('should have the property houseModel (base name: "house_model")', function() {
      // uncomment below and update the code to test the property houseModel
      //var instance = new Netatmo.NADevice();
      //expect(instance).to.be();
    });

    it('should have the property hwVersion (base name: "hw_version")', function() {
    ...
    it('should have the property lastFwUpdate (base name: "last_fw_update")', function() {
      // uncomment below and update the code to test the property lastFwUpdate
      //var instance = new Netatmo.NADevice();
      //expect(instance).to.be();
    });

    it('should have the property lastRadioStore (base name: "last_radio_store")', function() {
      // uncomment below and update the code to test the property lastRadioStore
      //var instance = new Netatmo.NADevice();
      //expect(instance).to.be();
    });
    ...
    it('should have the property newFeatureAvail (base name: "new_feature_avail")', function() {
      // uncomment below and update the code to test the property newFeatureAvail
      //var instance = new Netatmo.NADevice();
      //expect(instance).to.be();
    });
    ...
    it('should have the property setpointDefaultDuration (base name: "setpoint_default_duration")', function() {
      // uncomment below and update the code to test the property setpointDefaultDuration
      //var instance = new Netatmo.NADevice();
      //expect(instance).to.be();
    });
    ...
    it('should have the property userOwner (base name: "user_owner")', function() {
      // uncomment below and update the code to test the property userOwner
      //var instance = new Netatmo.NADevice();
      //expect(instance).to.be();
    });
