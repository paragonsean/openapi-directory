...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Netatmo.NAWelcomeUser();
  });
  ...
  describe('NAWelcomeUser', function() {
    it('should create an instance of NAWelcomeUser', function() {
      // uncomment below and update the code to test NAWelcomeUser
      //var instance = new Netatmo.NAWelcomeUser();
      //expect(instance).to.be.a(Netatmo.NAWelcomeUser);
    });
