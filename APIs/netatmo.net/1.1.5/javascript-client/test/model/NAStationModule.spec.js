...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Netatmo.NAStationModule();
  });
  ...
  describe('NAStationModule', function() {
    it('should create an instance of NAStationModule', function() {
      // uncomment below and update the code to test NAStationModule
      //var instance = new Netatmo.NAStationModule();
      //expect(instance).to.be.a(Netatmo.NAStationModule);
    });
