...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Netatmo.NAHealthyHomeCoach();
  });
  ...
  describe('NAHealthyHomeCoach', function() {
    it('should create an instance of NAHealthyHomeCoach', function() {
      // uncomment below and update the code to test NAHealthyHomeCoach
      //var instance = new Netatmo.NAHealthyHomeCoach();
      //expect(instance).to.be.a(Netatmo.NAHealthyHomeCoach);
    });
