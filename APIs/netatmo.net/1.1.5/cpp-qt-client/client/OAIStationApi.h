...
#ifndef OAI_OAIStationApi_H
#define OAI_OAIStationApi_H
...
class OAIStationApi : public QObject {
    Q_OBJECT

public:
    OAIStationApi(const int timeOut = 0);
    ~OAIStationApi();
    ...
    */
    virtual void getstationsdata(const ::OpenAPI::OptionalParam<QString> &device_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &get_favorites = ::OpenAPI::OptionalParam<bool>());
...
private:
    ...
    void getstationsdataCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getmeasureSignal(OAINAMeasureResponse summary);
    void getstationsdataSignal(OAINAStationDataResponse summary);


    void getmeasureSignalFull(OAIHttpRequestWorker *worker, OAINAMeasureResponse summary);
    void getstationsdataSignalFull(OAIHttpRequestWorker *worker, OAINAStationDataResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use getstationsdataSignalError() instead")
    void getstationsdataSignalE(OAINAStationDataResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getstationsdataSignalError(OAINAStationDataResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getstationsdataSignalErrorFull() instead")
    void getstationsdataSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getstationsdataSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
