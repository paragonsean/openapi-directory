...
#ifndef OAINAUserResponse_H
#define OAINAUserResponse_H
...
class OAINAUserResponse : public OAIObject {
public:
    OAINAUserResponse();
    OAINAUserResponse(QString json);
    ~OAINAUserResponse() override;
    ...
    OAINAUser getBody() const;
    void setBody(const OAINAUser &body);
...
Q_DECLARE_METATYPE(OpenAPI::OAINAUserResponse)

#endif // OAINAUserResponse_H
