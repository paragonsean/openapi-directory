...
class OAINAStationModule;
class OAINAPlace;

class OAINAMain : public OAIObject {
public:
    OAINAMain();
    OAINAMain(QString json);
    ~OAINAMain() override;
    ...
    QList<OAINAStationModule> getModules() const;
    void setModules(const QList<OAINAStationModule> &modules);
...
private:
    ...
    QList<OAINAStationModule> m_modules;
...
Q_DECLARE_METATYPE(OpenAPI::OAINAMain)
