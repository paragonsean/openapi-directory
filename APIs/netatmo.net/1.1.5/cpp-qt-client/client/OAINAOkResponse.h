...
#ifndef OAINAOkResponse_H
#define OAINAOkResponse_H
...
class OAINAOkResponse : public OAIObject {
public:
    OAINAOkResponse();
    OAINAOkResponse(QString json);
    ~OAINAOkResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINAOkResponse)

#endif // OAINAOkResponse_H
