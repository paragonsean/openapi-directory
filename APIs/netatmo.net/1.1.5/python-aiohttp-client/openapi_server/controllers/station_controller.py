...
async def getmeasure(request: web.Request, device_id, scale, type, module_id=None, date_begin=None, date_end=None, limit=None, optimize=None, real_time=None) -> web.Response:
    """getmeasure
...
async def getstationsdata(request: web.Request, device_id=None, get_favorites=None) -> web.Response:
    """getstationsdata
    ...
    :type device_id: str
    :param get_favorites: Whether to include the user&#39;s favorite Weather Stations in addition to the user&#39;s own Weather Stations
