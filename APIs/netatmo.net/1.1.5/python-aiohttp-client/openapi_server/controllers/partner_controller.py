...
async def getmeasure_1(request: web.Request, device_id, scale, type, module_id=None, date_begin=None, date_end=None, limit=None, optimize=None, real_time=None) -> web.Response:
    """getmeasure_1
...
async def partnerdevices(request: web.Request, ) -> web.Response:
    """partnerdevices
