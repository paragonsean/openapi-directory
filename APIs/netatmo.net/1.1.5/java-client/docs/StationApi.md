...
<a id="getmeasure"></a>
# **getmeasure**
> NAMeasureResponse getmeasure(deviceId, scale, type, moduleId, dateBegin, dateEnd, limit, optimize, realTime)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      NAMeasureResponse result = apiInstance.getmeasure(deviceId, scale, type, moduleId, dateBegin, dateEnd, limit, optimize, realTime);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StationApi#getmeasure");
...
<a id="getstationsdata"></a>
# **getstationsdata**
> NAStationDataResponse getstationsdata(deviceId, getFavorites)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean getFavorites = false; // Boolean | Whether to include the user's favorite Weather Stations in addition to the user's own Weather Stations
    try {
      NAStationDataResponse result = apiInstance.getstationsdata(deviceId, getFavorites);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StationApi#getstationsdata");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
