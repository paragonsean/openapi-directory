...
|------------- | ------------- | -------------|
| [**getmeasure_1**](PartnerApi.md#getmeasure_1) | **GET** /getmeasure |  |
| [**partnerdevices**](PartnerApi.md#partnerdevices) | **GET** /partnerdevices |  |


<a id="getmeasure_1"></a>
# **getmeasure_1**
> NAMeasureResponse getmeasure_1(deviceId, scale, type, moduleId, dateBegin, dateEnd, limit, optimize, realTime)
...
import org.openapitools.client.api.PartnerApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      NAMeasureResponse result = apiInstance.getmeasure_1(deviceId, scale, type, moduleId, dateBegin, dateEnd, limit, optimize, realTime);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PartnerApi#getmeasure_1");
...
<a id="partnerdevices"></a>
# **partnerdevices**
> NAPartnerDevicesResponse partnerdevices()
...
public class Example {
  public static void main(String[] args) {
    ...
    PartnerApi apiInstance = new PartnerApi(defaultClient);
    try {
      NAPartnerDevicesResponse result = apiInstance.partnerdevices();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PartnerApi#partnerdevices");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**NAPartnerDevicesResponse**](NAPartnerDevicesResponse.md)
