...
public class StationApi {
     ...
     */
    public okhttp3.Call getmeasureCall(String deviceId, String scale, List<String> type, String moduleId, Integer dateBegin, String dateEnd, Integer limit, Boolean optimize, Boolean realTime, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getmeasureValidateBeforeCall(String deviceId, String scale, List<String> type, String moduleId, Integer dateBegin, String dateEnd, Integer limit, Boolean optimize, Boolean realTime, final ApiCallback _callback) throws ApiException {
        ...
        return getmeasureCall(deviceId, scale, type, moduleId, dateBegin, dateEnd, limit, optimize, realTime, _callback);
     ...
     */
    public NAMeasureResponse getmeasure(String deviceId, String scale, List<String> type, String moduleId, Integer dateBegin, String dateEnd, Integer limit, Boolean optimize, Boolean realTime) throws ApiException {
        ApiResponse<NAMeasureResponse> localVarResp = getmeasureWithHttpInfo(deviceId, scale, type, moduleId, dateBegin, dateEnd, limit, optimize, realTime);
     ...
     */
    public ApiResponse<NAMeasureResponse> getmeasureWithHttpInfo(String deviceId, String scale, List<String> type, String moduleId, Integer dateBegin, String dateEnd, Integer limit, Boolean optimize, Boolean realTime) throws ApiException {
        okhttp3.Call localVarCall = getmeasureValidateBeforeCall(deviceId, scale, type, moduleId, dateBegin, dateEnd, limit, optimize, realTime, null);
     ...
     */
    public okhttp3.Call getmeasureAsync(String deviceId, String scale, List<String> type, String moduleId, Integer dateBegin, String dateEnd, Integer limit, Boolean optimize, Boolean realTime, final ApiCallback<NAMeasureResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getmeasureValidateBeforeCall(deviceId, scale, type, moduleId, dateBegin, dateEnd, limit, optimize, realTime, _callback);
        Type localVarReturnType = new TypeToken<NAMeasureResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getstationsdata
     * @param deviceId Id of the device you want to retrieve information of (optional)
     * @param getFavorites Whether to include the user&#39;s favorite Weather Stations in addition to the user&#39;s own Weather Stations (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getstationsdataCall(String deviceId, Boolean getFavorites, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/getstationsdata";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getstationsdataValidateBeforeCall(String deviceId, Boolean getFavorites, final ApiCallback _callback) throws ApiException {
        return getstationsdataCall(deviceId, getFavorites, _callback);
     ...
     */
    public NAStationDataResponse getstationsdata(String deviceId, Boolean getFavorites) throws ApiException {
        ApiResponse<NAStationDataResponse> localVarResp = getstationsdataWithHttpInfo(deviceId, getFavorites);
        return localVarResp.getData();
    }
     ...
     * @param deviceId Id of the device you want to retrieve information of (optional)
     * @param getFavorites Whether to include the user&#39;s favorite Weather Stations in addition to the user&#39;s own Weather Stations (optional, default to false)
     * @return ApiResponse&lt;NAStationDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<NAStationDataResponse> getstationsdataWithHttpInfo(String deviceId, Boolean getFavorites) throws ApiException {
        okhttp3.Call localVarCall = getstationsdataValidateBeforeCall(deviceId, getFavorites, null);
        Type localVarReturnType = new TypeToken<NAStationDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getstationsdataAsync(String deviceId, Boolean getFavorites, final ApiCallback<NAStationDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getstationsdataValidateBeforeCall(deviceId, getFavorites, _callback);
        Type localVarReturnType = new TypeToken<NAStationDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
