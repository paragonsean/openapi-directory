...
public class ApiClient {
    ...
    private String basePath = "https://api.netatmo.net/api";
    ...
    public ApiClient() {
        ...
        authentications.put("code_oauth", new OAuth());
        authentications.put("password_oauth", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.netatmo.net/oauth2/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.netatmo.net/api
