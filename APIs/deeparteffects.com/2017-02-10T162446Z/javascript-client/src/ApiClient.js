...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.deeparteffects.com/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.deeparteffects.com/v1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-02-10T16:24:46Z/Javascript'
        };
