...
public class ApiClient {
    ...
    private String basePath = "https://api.jokes.one";
    ...
    public ApiClient() {
        ...
        authentications.put("X-JokesOne-Api-Secret", new ApiKeyAuth("header", "X-JokesOne-Api-Secret"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.jokes.one
