...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JokesOneApi.JokeResponseContents();
  });
  ...
  describe('JokeResponseContents', function() {
    it('should create an instance of JokeResponseContents', function() {
      // uncomment below and update the code to test JokeResponseContents
      //var instance = new JokesOneApi.JokeResponseContents();
      //expect(instance).to.be.a(JokesOneApi.JokeResponseContents);
    });
