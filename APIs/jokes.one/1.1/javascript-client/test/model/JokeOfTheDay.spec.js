...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JokesOneApi.JokeOfTheDay();
  });
  ...
  describe('JokeOfTheDay', function() {
    it('should create an instance of JokeOfTheDay', function() {
      // uncomment below and update the code to test JokeOfTheDay
      //var instance = new JokesOneApi.JokeOfTheDay();
      //expect(instance).to.be.a(JokesOneApi.JokeOfTheDay);
    });
