...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JokesOneApi.JokeResponse();
  });
  ...
  describe('JokeResponse', function() {
    it('should create an instance of JokeResponse', function() {
      // uncomment below and update the code to test JokeResponse
      //var instance = new JokesOneApi.JokeResponse();
      //expect(instance).to.be.a(JokesOneApi.JokeResponse);
    });
