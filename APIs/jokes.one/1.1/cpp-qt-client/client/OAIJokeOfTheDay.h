...
#ifndef OAIJokeOfTheDay_H
#define OAIJokeOfTheDay_H
...
class OAIJokeOfTheDay : public OAIObject {
public:
    OAIJokeOfTheDay();
    OAIJokeOfTheDay(QString json);
    ~OAIJokeOfTheDay() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJokeOfTheDay)

#endif // OAIJokeOfTheDay_H
