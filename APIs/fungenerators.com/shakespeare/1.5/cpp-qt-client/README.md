...
void Example::exampleFunction1(){
     OAIGenerationApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIGenerationApi::shakespeareGenerateInsultGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIGenerationApi::shakespeareGenerateInsultGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
