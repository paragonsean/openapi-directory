...
void Example::exampleFunction1(){
     OAITauntApi apiInstance;
     
      // Configure API key authorization: X-Fungenerators-Api-Secret
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAITauntApi::tauntCategoriesGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAITauntApi::tauntCategoriesGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      qint32 start = create(); // qint32 | start
      ...
      apiInstance.tauntCategoriesGet(startlimit);
