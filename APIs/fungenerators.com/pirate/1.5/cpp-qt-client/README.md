...
#include <iostream>
#include "../client/OAIGenerationApi.h"
...
void Example::exampleFunction1(){
     OAIGenerationApi apiInstance;
     
      // Configure API key authorization: X-Fungenerators-Api-Secret
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAIGenerationApi::pirateGenerateInsultGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIGenerationApi::pirateGenerateInsultGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      qint32 limit = create(); // qint32 | No of insults to generate
