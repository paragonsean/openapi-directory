...
public class Example {
  public static void main(String[] args) {
    ...
    String text = "text_example"; // String | Text to translate to pirate lingo.
    try {
      apiInstance.pirateTranslateGet(text);
    } catch (ApiException e) {
      System.err.println("Exception when calling TranslationApi#pirateTranslateGet");
