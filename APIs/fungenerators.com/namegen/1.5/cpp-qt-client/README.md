...
void Example::exampleFunction1(){
     OAINamesApi apiInstance;
     
      // Configure API key authorization: X-Fungenerators-Api-Secret
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAINamesApi::nameCategoriesGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAINamesApi::nameCategoriesGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.nameCategoriesGet(startlimit);
