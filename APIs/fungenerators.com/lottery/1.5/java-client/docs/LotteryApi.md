...
import org.openapitools.client.api.LotteryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    LotteryApi apiInstance = new LotteryApi(defaultClient);
    try {
      apiInstance.lotteryCountriesGet();
    } catch (ApiException e) {
      System.err.println("Exception when calling LotteryApi#lotteryCountriesGet");
...
<a id="lotteryDrawGet"></a>
# **lotteryDrawGet**
> lotteryDrawGet(game, count)
...
public class Example {
  public static void main(String[] args) {
    ...
    LotteryApi apiInstance = new LotteryApi(defaultClient);
    String game = "game_example"; // String | Lottery Game Name
    Integer count = 56; // Integer | Number of draws (max 5 per request)
    try {
      apiInstance.lotteryDrawGet(game, count);
    } catch (ApiException e) {
      System.err.println("Exception when calling LotteryApi#lotteryDrawGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **count** | **Integer**| Number of draws (max 5 per request) | [optional] |
...
public class Example {
  public static void main(String[] args) {
    ...
    LotteryApi apiInstance = new LotteryApi(defaultClient);
    String country = "country_example"; // String | Country Name
    try {
      apiInstance.lotterySupportedGet(country);
    } catch (ApiException e) {
      System.err.println("Exception when calling LotteryApi#lotterySupportedGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
