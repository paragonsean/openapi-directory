...
import org.openapitools.client.api.FactOfTheDayApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    FactOfTheDayApi apiInstance = new FactOfTheDayApi(defaultClient);
    try {
      apiInstance.factFodCategoriesGet();
    } catch (ApiException e) {
      System.err.println("Exception when calling FactOfTheDayApi#factFodCategoriesGet");
...
public class Example {
  public static void main(String[] args) {
    ...
    FactOfTheDayApi apiInstance = new FactOfTheDayApi(defaultClient);
    String category = "category_example"; // String | Category to get the fact of the day from. Must be one from the list returned from /fact/fod/categories
    try {
      apiInstance.factFodGet(category);
    } catch (ApiException e) {
      System.err.println("Exception when calling FactOfTheDayApi#factFodGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
