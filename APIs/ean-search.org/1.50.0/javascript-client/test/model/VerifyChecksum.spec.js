...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EanSearchOrgApi.VerifyChecksum();
  });
  ...
  describe('VerifyChecksum', function() {
    it('should create an instance of VerifyChecksum', function() {
      // uncomment below and update the code to test VerifyChecksum
      //var instance = new EanSearchOrgApi.VerifyChecksum();
      //expect(instance).to.be.a(EanSearchOrgApi.VerifyChecksum);
    });
