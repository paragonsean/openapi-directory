...
public class Crawl200Response {
  ...
  public Crawl200Response() {
  }

  public Crawl200Response answer(String answer) {
    this.answer = answer;
    return this;
  }
  ...
  public Crawl200Response results(List<String> results) {
    this.results = results;
    return this;
  }

  public Crawl200Response addResultsItem(String resultsItem) {
  ...
  public Crawl200Response total(String total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Crawl200Response crawl200Response = (Crawl200Response) o;
    return Objects.equals(this.answer, crawl200Response.answer) &&
        Objects.equals(this.results, crawl200Response.results) &&
        Objects.equals(this.total, crawl200Response.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class Crawl200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Crawl200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Crawl200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Crawl200Response is not found in the empty JSON string", Crawl200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Crawl200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Crawl200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Crawl200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Crawl200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Crawl200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Crawl200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Crawl200Response>() {
           @Override
           public void write(JsonWriter out, Crawl200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Crawl200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Crawl200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Crawl200Response
   * @throws IOException if the JSON string is invalid with respect to Crawl200Response
   */
  public static Crawl200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Crawl200Response.class);
  }

  /**
   * Convert an instance of Crawl200Response to an JSON string
   *
   * @return JSON string
   */
