...
public class GetTheStatusOfTheAPIService200Response {
  public static final String SERIALIZED_NAME_STATUS = "status";
  @SerializedName(SERIALIZED_NAME_STATUS)
  private Boolean status;

  public GetTheStatusOfTheAPIService200Response() {
  }

  public GetTheStatusOfTheAPIService200Response status(Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTheStatusOfTheAPIService200Response getTheStatusOfTheAPIService200Response = (GetTheStatusOfTheAPIService200Response) o;
    return Objects.equals(this.status, getTheStatusOfTheAPIService200Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTheStatusOfTheAPIService200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTheStatusOfTheAPIService200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTheStatusOfTheAPIService200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTheStatusOfTheAPIService200Response is not found in the empty JSON string", GetTheStatusOfTheAPIService200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTheStatusOfTheAPIService200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTheStatusOfTheAPIService200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTheStatusOfTheAPIService200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTheStatusOfTheAPIService200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTheStatusOfTheAPIService200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTheStatusOfTheAPIService200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTheStatusOfTheAPIService200Response>() {
           @Override
           public void write(JsonWriter out, GetTheStatusOfTheAPIService200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTheStatusOfTheAPIService200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTheStatusOfTheAPIService200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTheStatusOfTheAPIService200Response
   * @throws IOException if the JSON string is invalid with respect to GetTheStatusOfTheAPIService200Response
   */
  public static GetTheStatusOfTheAPIService200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTheStatusOfTheAPIService200Response.class);
  }

  /**
   * Convert an instance of GetTheStatusOfTheAPIService200Response to an JSON string
   *
   * @return JSON string
   */
