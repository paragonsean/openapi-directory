...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('crawl', function() {
      it('should call crawl successfully', function(done) {
        //uncomment below and update the code to test crawl
        //instance.crawl(function(error) {
    ...
    describe('getTheStatusOfTheAPIService', function() {
      it('should call getTheStatusOfTheAPIService successfully', function(done) {
        //uncomment below and update the code to test getTheStatusOfTheAPIService
        //instance.getTheStatusOfTheAPIService(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('serp', function() {
      it('should call serp successfully', function(done) {
        //uncomment below and update the code to test serp
        //instance.serp(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
