...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseFeed();
  });
  ...
  describe('News200ResponseFeed', function() {
    it('should create an instance of News200ResponseFeed', function() {
      // uncomment below and update the code to test News200ResponseFeed
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseFeed();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.News200ResponseFeed);
    });
    ...
    it('should have the property generatorDetail (base name: "generator_detail")', function() {
      // uncomment below and update the code to test the property generatorDetail
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseFeed();
      //expect(instance).to.be();
    });
    ...
    it('should have the property publisherDetail (base name: "publisher_detail")', function() {
      // uncomment below and update the code to test the property publisherDetail
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseFeed();
      //expect(instance).to.be();
    });
    ...
    it('should have the property rightsDetail (base name: "rights_detail")', function() {
      // uncomment below and update the code to test the property rightsDetail
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseFeed();
      //expect(instance).to.be();
    });
    ...
    it('should have the property subtitleDetail (base name: "subtitle_detail")', function() {
      // uncomment below and update the code to test the property subtitleDetail
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseFeed();
      //expect(instance).to.be();
    });
    ...
    it('should have the property updatedParsed (base name: "updated_parsed")', function() {
      // uncomment below and update the code to test the property updatedParsed
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseFeed();
      //expect(instance).to.be();
    });
