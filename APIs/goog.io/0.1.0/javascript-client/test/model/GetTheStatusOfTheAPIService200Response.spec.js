...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.GetTheStatusOfTheAPIService200Response();
  });
  ...
  describe('GetTheStatusOfTheAPIService200Response', function() {
    it('should create an instance of GetTheStatusOfTheAPIService200Response', function() {
      // uncomment below and update the code to test GetTheStatusOfTheAPIService200Response
      //var instance = new GoogIoUnofficalGoogleSearchApi.GetTheStatusOfTheAPIService200Response();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.GetTheStatusOfTheAPIService200Response);
    });
