...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.Images200ResponseImageResultsInnerLink();
  });
  ...
  describe('Images200ResponseImageResultsInnerLink', function() {
    it('should create an instance of Images200ResponseImageResultsInnerLink', function() {
      // uncomment below and update the code to test Images200ResponseImageResultsInnerLink
      //var instance = new GoogIoUnofficalGoogleSearchApi.Images200ResponseImageResultsInnerLink();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.Images200ResponseImageResultsInnerLink);
    });
