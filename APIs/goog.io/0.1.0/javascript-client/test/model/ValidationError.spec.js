...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new GoogIoUnofficalGoogleSearchApi.ValidationError();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.ValidationError);
    });
