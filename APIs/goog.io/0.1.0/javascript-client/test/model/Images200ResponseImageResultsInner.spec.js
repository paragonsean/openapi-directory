...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.Images200ResponseImageResultsInner();
  });
  ...
  describe('Images200ResponseImageResultsInner', function() {
    it('should create an instance of Images200ResponseImageResultsInner', function() {
      // uncomment below and update the code to test Images200ResponseImageResultsInner
      //var instance = new GoogIoUnofficalGoogleSearchApi.Images200ResponseImageResultsInner();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.Images200ResponseImageResultsInner);
    });
