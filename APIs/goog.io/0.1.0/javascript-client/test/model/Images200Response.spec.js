...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.Images200Response();
  });
  ...
  describe('Images200Response', function() {
    it('should create an instance of Images200Response', function() {
      // uncomment below and update the code to test Images200Response
      //var instance = new GoogIoUnofficalGoogleSearchApi.Images200Response();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.Images200Response);
    });
    ...
    it('should have the property imageResults (base name: "image_results")', function() {
