...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new GoogIoUnofficalGoogleSearchApi.HTTPValidationError();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.HTTPValidationError);
    });
