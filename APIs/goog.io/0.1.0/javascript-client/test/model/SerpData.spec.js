...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.SerpData();
  });
  ...
  describe('SerpData', function() {
    it('should create an instance of SerpData', function() {
      // uncomment below and update the code to test SerpData
      //var instance = new GoogIoUnofficalGoogleSearchApi.SerpData();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.SerpData);
    });
