...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.Search200ResponseResultsInner();
  });
  ...
  describe('Search200ResponseResultsInner', function() {
    it('should create an instance of Search200ResponseResultsInner', function() {
      // uncomment below and update the code to test Search200ResponseResultsInner
      //var instance = new GoogIoUnofficalGoogleSearchApi.Search200ResponseResultsInner();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.Search200ResponseResultsInner);
    });
