...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseEntriesInner();
  });
  ...
  describe('News200ResponseEntriesInner', function() {
    it('should create an instance of News200ResponseEntriesInner', function() {
      // uncomment below and update the code to test News200ResponseEntriesInner
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseEntriesInner();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.News200ResponseEntriesInner);
    });

    it('should have the property guidislink (base name: "guidislink")', function() {
      // uncomment below and update the code to test the property guidislink
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseEntriesInner();
    ...
    it('should have the property publishedParsed (base name: "published_parsed")', function() {
      // uncomment below and update the code to test the property publishedParsed
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseEntriesInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property subArticles (base name: "sub_articles")', function() {
      // uncomment below and update the code to test the property subArticles
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseEntriesInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property summaryDetail (base name: "summary_detail")', function() {
      // uncomment below and update the code to test the property summaryDetail
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseEntriesInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property titleDetail (base name: "title_detail")', function() {
      // uncomment below and update the code to test the property titleDetail
      //var instance = new GoogIoUnofficalGoogleSearchApi.News200ResponseEntriesInner();
      //expect(instance).to.be();
    });
