...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.Serp200Response();
  });
  ...
  describe('Serp200Response', function() {
    it('should create an instance of Serp200Response', function() {
      // uncomment below and update the code to test Serp200Response
      //var instance = new GoogIoUnofficalGoogleSearchApi.Serp200Response();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.Serp200Response);
    });
    ...
    it('should have the property searchedResults (base name: "searched_results")', function() {
      // uncomment below and update the code to test the property searchedResults
      //var instance = new GoogIoUnofficalGoogleSearchApi.Serp200Response();
      //expect(instance).to.be();
    });
