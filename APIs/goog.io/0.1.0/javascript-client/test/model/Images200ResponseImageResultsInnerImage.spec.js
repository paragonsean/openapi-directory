...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.GoogIoUnofficalGoogleSearchApi);
  }
}(this, function(expect, GoogIoUnofficalGoogleSearchApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new GoogIoUnofficalGoogleSearchApi.Images200ResponseImageResultsInnerImage();
  });
  ...
  describe('Images200ResponseImageResultsInnerImage', function() {
    it('should create an instance of Images200ResponseImageResultsInnerImage', function() {
      // uncomment below and update the code to test Images200ResponseImageResultsInnerImage
      //var instance = new GoogIoUnofficalGoogleSearchApi.Images200ResponseImageResultsInnerImage();
      //expect(instance).to.be.a(GoogIoUnofficalGoogleSearchApi.Images200ResponseImageResultsInnerImage);
    });
