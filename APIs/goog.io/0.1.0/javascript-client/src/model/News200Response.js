...
import News200ResponseEntriesInner from './News200ResponseEntriesInner';
import News200ResponseFeed from './News200ResponseFeed';

/**
 * The News200Response model module.
 * @module model/News200Response
 * @version 0.1.0
 */
class News200Response {
    /**
     * Constructs a new <code>News200Response</code>.
     * @alias module:model/News200Response
     */
    constructor() { 
        
        News200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>News200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/News200Response} obj Optional instance to populate.
     * @return {module:model/News200Response} The populated <code>News200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new News200Response();

            if (data.hasOwnProperty('entries')) {
                obj['entries'] = ApiClient.convertToType(data['entries'], [News200ResponseEntriesInner]);
            }
            if (data.hasOwnProperty('feed')) {
                obj['feed'] = News200ResponseFeed.constructFromObject(data['feed']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>News200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>News200Response</code>.
     */
    static validateJSON(data) {
        if (data['entries']) { // data not null
            ...
            for (const item of data['entries']) {
                News200ResponseEntriesInner.validateJSON(item);
            };
        }
        // validate the optional field `feed`
        if (data['feed']) { // data not null
          News200ResponseFeed.validateJSON(data['feed']);
        }
...
/**
 * @member {Array.<module:model/News200ResponseEntriesInner>} entries
 */
News200Response.prototype['entries'] = undefined;

/**
 * @member {module:model/News200ResponseFeed} feed
 */
News200Response.prototype['feed'] = undefined;
...
export default News200Response;
