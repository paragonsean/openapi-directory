...
/**
 * The GetTheStatusOfTheAPIService200Response model module.
 * @module model/GetTheStatusOfTheAPIService200Response
 * @version 0.1.0
 */
class GetTheStatusOfTheAPIService200Response {
    /**
     * Constructs a new <code>GetTheStatusOfTheAPIService200Response</code>.
     * @alias module:model/GetTheStatusOfTheAPIService200Response
     */
    constructor() { 
        
        GetTheStatusOfTheAPIService200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTheStatusOfTheAPIService200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTheStatusOfTheAPIService200Response} obj Optional instance to populate.
     * @return {module:model/GetTheStatusOfTheAPIService200Response} The populated <code>GetTheStatusOfTheAPIService200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTheStatusOfTheAPIService200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTheStatusOfTheAPIService200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTheStatusOfTheAPIService200Response</code>.
     */
 ...
 */
GetTheStatusOfTheAPIService200Response.prototype['status'] = undefined;
...
export default GetTheStatusOfTheAPIService200Response;
