...
/**
 * The Serp200Response model module.
 * @module model/Serp200Response
 * @version 0.1.0
 */
class Serp200Response {
    /**
     * Constructs a new <code>Serp200Response</code>.
     * @alias module:model/Serp200Response
     */
    constructor() { 
        
        Serp200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Serp200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Serp200Response} obj Optional instance to populate.
     * @return {module:model/Serp200Response} The populated <code>Serp200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Serp200Response();
            ...
            if (data.hasOwnProperty('searched_results')) {
                obj['searched_results'] = ApiClient.convertToType(data['searched_results'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Serp200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Serp200Response</code>.
     */
 ...
 */
Serp200Response.prototype['position'] = undefined;

/**
 * @member {String} query
 */
Serp200Response.prototype['query'] = undefined;

/**
 * @member {Number} searched_results
 */
Serp200Response.prototype['searched_results'] = undefined;

/**
 * @member {String} website
 */
Serp200Response.prototype['website'] = undefined;
...
export default Serp200Response;
