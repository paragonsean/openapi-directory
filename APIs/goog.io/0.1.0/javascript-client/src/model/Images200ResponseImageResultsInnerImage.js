...
/**
 * The Images200ResponseImageResultsInnerImage model module.
 * @module model/Images200ResponseImageResultsInnerImage
 * @version 0.1.0
 */
class Images200ResponseImageResultsInnerImage {
    /**
     * Constructs a new <code>Images200ResponseImageResultsInnerImage</code>.
     * @alias module:model/Images200ResponseImageResultsInnerImage
     */
    constructor() { 
        
        Images200ResponseImageResultsInnerImage.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Images200ResponseImageResultsInnerImage</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Images200ResponseImageResultsInnerImage} obj Optional instance to populate.
     * @return {module:model/Images200ResponseImageResultsInnerImage} The populated <code>Images200ResponseImageResultsInnerImage</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Images200ResponseImageResultsInnerImage();
    ...
    /**
     * Validates the JSON data with respect to <code>Images200ResponseImageResultsInnerImage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Images200ResponseImageResultsInnerImage</code>.
     */
 ...
 * @member {String} alt
 */
Images200ResponseImageResultsInnerImage.prototype['alt'] = undefined;

/**
 * @member {String} src
 */
Images200ResponseImageResultsInnerImage.prototype['src'] = undefined;
...
export default Images200ResponseImageResultsInnerImage;
