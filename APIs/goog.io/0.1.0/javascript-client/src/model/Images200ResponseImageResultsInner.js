...
import Images200ResponseImageResultsInnerImage from './Images200ResponseImageResultsInnerImage';
import Images200ResponseImageResultsInnerLink from './Images200ResponseImageResultsInnerLink';

/**
 * The Images200ResponseImageResultsInner model module.
 * @module model/Images200ResponseImageResultsInner
 * @version 0.1.0
 */
class Images200ResponseImageResultsInner {
    /**
     * Constructs a new <code>Images200ResponseImageResultsInner</code>.
     * @alias module:model/Images200ResponseImageResultsInner
     */
    constructor() { 
        
        Images200ResponseImageResultsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Images200ResponseImageResultsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Images200ResponseImageResultsInner} obj Optional instance to populate.
     * @return {module:model/Images200ResponseImageResultsInner} The populated <code>Images200ResponseImageResultsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Images200ResponseImageResultsInner();

            if (data.hasOwnProperty('image')) {
                obj['image'] = Images200ResponseImageResultsInnerImage.constructFromObject(data['image']);
            }
            if (data.hasOwnProperty('link')) {
                obj['link'] = Images200ResponseImageResultsInnerLink.constructFromObject(data['link']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Images200ResponseImageResultsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Images200ResponseImageResultsInner</code>.
     */
    static validateJSON(data) {
        // validate the optional field `image`
        if (data['image']) { // data not null
          Images200ResponseImageResultsInnerImage.validateJSON(data['image']);
        }
        // validate the optional field `link`
        if (data['link']) { // data not null
          Images200ResponseImageResultsInnerLink.validateJSON(data['link']);
        }
...
/**
 * @member {module:model/Images200ResponseImageResultsInnerImage} image
 */
Images200ResponseImageResultsInner.prototype['image'] = undefined;

/**
 * @member {module:model/Images200ResponseImageResultsInnerLink} link
 */
Images200ResponseImageResultsInner.prototype['link'] = undefined;
...
export default Images200ResponseImageResultsInner;
