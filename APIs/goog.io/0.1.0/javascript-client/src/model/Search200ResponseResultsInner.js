...
/**
 * The Search200ResponseResultsInner model module.
 * @module model/Search200ResponseResultsInner
 * @version 0.1.0
 */
class Search200ResponseResultsInner {
    /**
     * Constructs a new <code>Search200ResponseResultsInner</code>.
     * @alias module:model/Search200ResponseResultsInner
     */
    constructor() { 
        
        Search200ResponseResultsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Search200ResponseResultsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Search200ResponseResultsInner} obj Optional instance to populate.
     * @return {module:model/Search200ResponseResultsInner} The populated <code>Search200ResponseResultsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Search200ResponseResultsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>Search200ResponseResultsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Search200ResponseResultsInner</code>.
     */
 ...
 */
Search200ResponseResultsInner.prototype['description'] = undefined;

/**
 * @member {String} link
 */
Search200ResponseResultsInner.prototype['link'] = undefined;

/**
 * @member {String} title
 */
Search200ResponseResultsInner.prototype['title'] = undefined;
...
export default Search200ResponseResultsInner;
