...
/*
 * OAIImages_200_response_image_results_inner.h
 *
 * 
 */

#ifndef OAIImages_200_response_image_results_inner_H
#define OAIImages_200_response_image_results_inner_H
...
namespace OpenAPI {
class OAIImages_200_response_image_results_inner_image;
class OAIImages_200_response_image_results_inner_link;

class OAIImages_200_response_image_results_inner : public OAIObject {
public:
    OAIImages_200_response_image_results_inner();
    OAIImages_200_response_image_results_inner(QString json);
    ~OAIImages_200_response_image_results_inner() override;
    ...
    OAIImages_200_response_image_results_inner_image getImage() const;
    void setImage(const OAIImages_200_response_image_results_inner_image &image);
    bool is_image_Set() const;
    bool is_image_Valid() const;

    OAIImages_200_response_image_results_inner_link getLink() const;
    void setLink(const OAIImages_200_response_image_results_inner_link &link);
...
private:
    ...
    OAIImages_200_response_image_results_inner_image m_image;
    bool m_image_isSet;
    bool m_image_isValid;

    OAIImages_200_response_image_results_inner_link m_link;
    bool m_link_isSet;
    bool m_link_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIImages_200_response_image_results_inner)

#endif // OAIImages_200_response_image_results_inner_H
