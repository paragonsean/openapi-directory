...
/*
 * OAIImages_200_response.h
 *
 * 
 */

#ifndef OAIImages_200_response_H
#define OAIImages_200_response_H
...
namespace OpenAPI {
class OAIImages_200_response_image_results_inner;

class OAIImages_200_response : public OAIObject {
public:
    OAIImages_200_response();
    OAIImages_200_response(QString json);
    ~OAIImages_200_response() override;
    ...
    QList<OAIImages_200_response_image_results_inner> getImageResults() const;
    void setImageResults(const QList<OAIImages_200_response_image_results_inner> &image_results);
    bool is_image_results_Set() const;
    bool is_image_results_Valid() const;

    QList<OAIObject> getResults() const;
    void setResults(const QList<OAIObject> &results);
...
private:
    ...
    QList<OAIImages_200_response_image_results_inner> m_image_results;
    bool m_image_results_isSet;
    bool m_image_results_isValid;

    QList<OAIObject> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImages_200_response)

#endif // OAIImages_200_response_H
