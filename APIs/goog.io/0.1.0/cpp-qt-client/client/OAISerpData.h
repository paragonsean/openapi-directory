...
#ifndef OAISerpData_H
#define OAISerpData_H
...
class OAISerpData : public OAIObject {
public:
    OAISerpData();
    OAISerpData(QString json);
    ~OAISerpData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISerpData)
