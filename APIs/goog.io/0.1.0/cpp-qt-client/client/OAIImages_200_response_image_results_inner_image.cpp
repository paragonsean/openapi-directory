...
#include "OAIImages_200_response_image_results_inner_image.h"
...
OAIImages_200_response_image_results_inner_image::OAIImages_200_response_image_results_inner_image(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImages_200_response_image_results_inner_image::OAIImages_200_response_image_results_inner_image() {
    this->initializeModel();
}

OAIImages_200_response_image_results_inner_image::~OAIImages_200_response_image_results_inner_image() {}

void OAIImages_200_response_image_results_inner_image::initializeModel() {
...
void OAIImages_200_response_image_results_inner_image::fromJson(QString jsonString) {
...
void OAIImages_200_response_image_results_inner_image::fromJsonObject(QJsonObject json) {
...
QString OAIImages_200_response_image_results_inner_image::asJson() const {
...
QJsonObject OAIImages_200_response_image_results_inner_image::asJsonObject() const {
    QJsonObject obj;
    if (m_alt_isSet) {
...
QString OAIImages_200_response_image_results_inner_image::getAlt() const {
    return m_alt;
}
void OAIImages_200_response_image_results_inner_image::setAlt(const QString &alt) {
    m_alt = alt;
    m_alt_isSet = true;
}

bool OAIImages_200_response_image_results_inner_image::is_alt_Set() const{
    return m_alt_isSet;
}

bool OAIImages_200_response_image_results_inner_image::is_alt_Valid() const{
    return m_alt_isValid;
}

QString OAIImages_200_response_image_results_inner_image::getSrc() const {
    return m_src;
}
void OAIImages_200_response_image_results_inner_image::setSrc(const QString &src) {
    m_src = src;
    m_src_isSet = true;
}

bool OAIImages_200_response_image_results_inner_image::is_src_Set() const{
    return m_src_isSet;
}

bool OAIImages_200_response_image_results_inner_image::is_src_Valid() const{
    return m_src_isValid;
}

bool OAIImages_200_response_image_results_inner_image::isSet() const {
...
bool OAIImages_200_response_image_results_inner_image::isValid() const {
