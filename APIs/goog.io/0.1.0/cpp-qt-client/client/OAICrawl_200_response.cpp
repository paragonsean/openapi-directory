...
OAICrawl_200_response::OAICrawl_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICrawl_200_response::OAICrawl_200_response() {
    this->initializeModel();
}

OAICrawl_200_response::~OAICrawl_200_response() {}

void OAICrawl_200_response::initializeModel() {
...
void OAICrawl_200_response::fromJson(QString jsonString) {
...
void OAICrawl_200_response::fromJsonObject(QJsonObject json) {
...
QString OAICrawl_200_response::asJson() const {
...
QJsonObject OAICrawl_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_answer_isSet) {
...
QString OAICrawl_200_response::getAnswer() const {
    return m_answer;
}
void OAICrawl_200_response::setAnswer(const QString &answer) {
    m_answer = answer;
    m_answer_isSet = true;
}

bool OAICrawl_200_response::is_answer_Set() const{
    return m_answer_isSet;
}

bool OAICrawl_200_response::is_answer_Valid() const{
    return m_answer_isValid;
}

QList<QString> OAICrawl_200_response::getResults() const {
    return m_results;
}
void OAICrawl_200_response::setResults(const QList<QString> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAICrawl_200_response::is_results_Set() const{
    return m_results_isSet;
}

bool OAICrawl_200_response::is_results_Valid() const{
    return m_results_isValid;
}

QString OAICrawl_200_response::getTotal() const {
    return m_total;
}
void OAICrawl_200_response::setTotal(const QString &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAICrawl_200_response::is_total_Set() const{
    return m_total_isSet;
}

bool OAICrawl_200_response::is_total_Valid() const{
    return m_total_isValid;
}

bool OAICrawl_200_response::isSet() const {
...
bool OAICrawl_200_response::isValid() const {
