...
namespace OpenAPI {
class OAISearch_200_response_results_inner;
...
public:
    ...
    QList<OAISearch_200_response_results_inner> getResults() const;
    void setResults(const QList<OAISearch_200_response_results_inner> &results);
...
private:
    ...
    QList<OAISearch_200_response_results_inner> m_results;
