...
/*
 * OAICrawl_200_response.h
 *
 * 
 */

#ifndef OAICrawl_200_response_H
#define OAICrawl_200_response_H
...
class OAICrawl_200_response : public OAIObject {
public:
    OAICrawl_200_response();
    OAICrawl_200_response(QString json);
    ~OAICrawl_200_response() override;
    ...
    QList<QString> getResults() const;
    void setResults(const QList<QString> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAICrawl_200_response)

#endif // OAICrawl_200_response_H
