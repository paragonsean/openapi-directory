...
/*
 * OAIImages_200_response_image_results_inner_link.h
 *
 * 
 */

#ifndef OAIImages_200_response_image_results_inner_link_H
#define OAIImages_200_response_image_results_inner_link_H
...
class OAIImages_200_response_image_results_inner_link : public OAIObject {
public:
    OAIImages_200_response_image_results_inner_link();
    OAIImages_200_response_image_results_inner_link(QString json);
    ~OAIImages_200_response_image_results_inner_link() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImages_200_response_image_results_inner_link)

#endif // OAIImages_200_response_image_results_inner_link_H
