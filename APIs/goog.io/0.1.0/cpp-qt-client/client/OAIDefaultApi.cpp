...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.goog.io"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("crawl", defaultConf);
    _serverIndices.insert("crawl", 0);
    _serverConfigs.insert("get_the_status_of_the_API_service", defaultConf);
    _serverIndices.insert("get_the_status_of_the_API_service", 0);
    _serverConfigs.insert("images", defaultConf);
    _serverIndices.insert("images", 0);
    ...
    _serverConfigs.insert("serp", defaultConf);
    _serverIndices.insert("serp", 0);
}
...
void OAIDefaultApi::crawl(const QString &query) {
    QString fullPath = QString(_serverConfigs["crawl"][_serverIndices.value("crawl")].URL()+"/v1/crawl/{query}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::crawlCallback);
...
void OAIDefaultApi::crawlCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICrawl_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT crawlSignal(output);
        Q_EMIT crawlSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT crawlSignalE(output, error_type, error_str);
        Q_EMIT crawlSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT crawlSignalError(output, error_type, error_str);
        Q_EMIT crawlSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::get_the_status_of_the_API_service() {
    QString fullPath = QString(_serverConfigs["get_the_status_of_the_API_service"][_serverIndices.value("get_the_status_of_the_API_service")].URL()+"/");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::get_the_status_of_the_API_serviceCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::get_the_status_of_the_API_serviceCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGet_the_status_of_the_API_service_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_the_status_of_the_API_serviceSignal(output);
        Q_EMIT get_the_status_of_the_API_serviceSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_the_status_of_the_API_serviceSignalE(output, error_type, error_str);
        Q_EMIT get_the_status_of_the_API_serviceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_the_status_of_the_API_serviceSignalError(output, error_type, error_str);
        Q_EMIT get_the_status_of_the_API_serviceSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::images(const QString &query) {
    QString fullPath = QString(_serverConfigs["images"][_serverIndices.value("images")].URL()+"/v1/images/{query}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::imagesCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::imagesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIImages_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT imagesSignal(output);
        Q_EMIT imagesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT imagesSignalE(output, error_type, error_str);
        Q_EMIT imagesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT imagesSignalError(output, error_type, error_str);
        Q_EMIT imagesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::news(const QString &query) {
    QString fullPath = QString(_serverConfigs["news"][_serverIndices.value("news")].URL()+"/v1/news/{query}");
...
void OAIDefaultApi::newsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAINews_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::search(const QString &query) {
    QString fullPath = QString(_serverConfigs["search"][_serverIndices.value("search")].URL()+"/v1/search/{query}");
...
void OAIDefaultApi::serp(const OAISerpData &oai_serp_data) {
    QString fullPath = QString(_serverConfigs["serp"][_serverIndices.value("serp")].URL()+"/v1/serp/");
...

    {
        ...
        QByteArray output = oai_serp_data.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::serpCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::serpCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISerp_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT serpSignal(output);
        Q_EMIT serpSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT serpSignalE(output, error_type, error_str);
        Q_EMIT serpSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT serpSignalError(output, error_type, error_str);
        Q_EMIT serpSignalErrorFull(worker, error_type, error_str);
    }
}
