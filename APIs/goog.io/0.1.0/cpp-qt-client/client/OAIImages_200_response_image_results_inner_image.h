...
/*
 * OAIImages_200_response_image_results_inner_image.h
 *
 * 
 */

#ifndef OAIImages_200_response_image_results_inner_image_H
#define OAIImages_200_response_image_results_inner_image_H
...
class OAIImages_200_response_image_results_inner_image : public OAIObject {
public:
    OAIImages_200_response_image_results_inner_image();
    OAIImages_200_response_image_results_inner_image(QString json);
    ~OAIImages_200_response_image_results_inner_image() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImages_200_response_image_results_inner_image)

#endif // OAIImages_200_response_image_results_inner_image_H
