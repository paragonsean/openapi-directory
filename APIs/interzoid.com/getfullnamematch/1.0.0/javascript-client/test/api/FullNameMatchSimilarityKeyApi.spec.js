...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterzoidGetFullNameMatchSimilarityKeyApi.FullNameMatchSimilarityKeyApi();
  });
  ...
  describe('FullNameMatchSimilarityKeyApi', function() {
    describe('getfullnamematch', function() {
      it('should call getfullnamematch successfully', function(done) {
        //uncomment below and update the code to test getfullnamematch
        //instance.getfullnamematch(function(error) {
