...
- API version: 1.0.0
  - Build date: 2024-10-12T12:40:10.829875-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*StateDataStandardizationApi* | [**getstateabbreviation**](docs/StateDataStandardizationApi.md#getstateabbreviation) | **GET** /getstateabbreviation | Gets a two-letter abbreviation for a state or province name data


## Documentation for Models

 - [Getstateabbreviation200Response](docs/Getstateabbreviation200Response.md)
