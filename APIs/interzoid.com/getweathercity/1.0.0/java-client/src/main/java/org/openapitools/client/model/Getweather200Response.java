...
public class Getweather200Response {
  ...
  public Getweather200Response() {
  }

  public Getweather200Response city(String city) {
    this.city = city;
    return this;
  }
  ...
  public Getweather200Response code(String code) {
    this.code = code;
    return this;
  }
  ...
  public Getweather200Response credits(String credits) {
  ...
  public Getweather200Response relativeHumidity(String relativeHumidity) {
  ...
  public Getweather200Response state(String state) {
    this.state = state;
    return this;
  }
  ...
  public Getweather200Response tempC(String tempC) {
    this.tempC = tempC;
    return this;
  }
  ...
  public Getweather200Response tempF(String tempF) {
    this.tempF = tempF;
    return this;
  }
  ...
  public Getweather200Response visibilityMiles(String visibilityMiles) {
  ...
  public Getweather200Response weather(String weather) {
  ...
  public Getweather200Response windDir(String windDir) {
  ...
  public Getweather200Response windMPH(String windMPH) {
  ...
  public boolean equals(Object o) {
    ...
    Getweather200Response getweather200Response = (Getweather200Response) o;
    return Objects.equals(this.city, getweather200Response.city) &&
        Objects.equals(this.code, getweather200Response.code) &&
        Objects.equals(this.credits, getweather200Response.credits) &&
        Objects.equals(this.relativeHumidity, getweather200Response.relativeHumidity) &&
        Objects.equals(this.state, getweather200Response.state) &&
        Objects.equals(this.tempC, getweather200Response.tempC) &&
        Objects.equals(this.tempF, getweather200Response.tempF) &&
        Objects.equals(this.visibilityMiles, getweather200Response.visibilityMiles) &&
        Objects.equals(this.weather, getweather200Response.weather) &&
        Objects.equals(this.windDir, getweather200Response.windDir) &&
        Objects.equals(this.windMPH, getweather200Response.windMPH);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Getweather200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Getweather200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Getweather200Response is not found in the empty JSON string", Getweather200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Getweather200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Getweather200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Getweather200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Getweather200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Getweather200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Getweather200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Getweather200Response>() {
           @Override
           public void write(JsonWriter out, Getweather200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Getweather200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Getweather200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Getweather200Response
   * @throws IOException if the JSON string is invalid with respect to Getweather200Response
   */
  public static Getweather200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Getweather200Response.class);
  }

  /**
   * Convert an instance of Getweather200Response to an JSON string
   *
   * @return JSON string
   */
