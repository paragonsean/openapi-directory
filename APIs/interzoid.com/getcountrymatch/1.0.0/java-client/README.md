...
- API version: 1.0.0
  - Build date: 2024-10-12T12:40:29.075744-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*CountryMatchSimilarityKeyApi* | [**getcountrymatch**](docs/CountryMatchSimilarityKeyApi.md#getcountrymatch) | **GET** /getcountrymatch | Gets a similarity key for matching purposes for country name data


## Documentation for Models

 - [Getcountrymatch200Response](docs/Getcountrymatch200Response.md)
