...
- API version: 1.0.0
  - Build date: 2024-10-12T12:40:12.978887-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*StreetAddressSimilarityKeyApi* | [**getaddressmatch**](docs/StreetAddressSimilarityKeyApi.md#getaddressmatch) | **GET** /getaddressmatch | Gets a similarity key for matching purposes for address data


## Documentation for Models

 - [Getaddressmatch200Response](docs/Getaddressmatch200Response.md)
