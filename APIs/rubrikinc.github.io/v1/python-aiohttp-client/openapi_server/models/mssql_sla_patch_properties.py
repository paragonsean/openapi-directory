...
class MssqlSlaPatchProperties(Model):
    ...
    def __init__(self, copy_only: bool=None, log_backup_frequency_in_seconds: int=None, log_retention_hours: int=None, configured_sla_domain_id: str=None, use_configured_default_log_retention: bool=None):
        """MssqlSlaPatchProperties - a model defined in OpenAPI

        :param copy_only: The copy_only of this MssqlSlaPatchProperties.
        :param log_backup_frequency_in_seconds: The log_backup_frequency_in_seconds of this MssqlSlaPatchProperties.
        :param log_retention_hours: The log_retention_hours of this MssqlSlaPatchProperties.
        :param configured_sla_domain_id: The configured_sla_domain_id of this MssqlSlaPatchProperties.
        :param use_configured_default_log_retention: The use_configured_default_log_retention of this MssqlSlaPatchProperties.
        """
        self.openapi_types = {
            'copy_only': bool,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MssqlSlaPatchProperties':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MssqlSlaPatchProperties of this MssqlSlaPatchProperties.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def copy_only(self):
        """Gets the copy_only of this MssqlSlaPatchProperties.
        ...
        :return: The copy_only of this MssqlSlaPatchProperties.
        :rtype: bool
        """
    ...
    def copy_only(self, copy_only):
        """Sets the copy_only of this MssqlSlaPatchProperties.
    ...
    def log_backup_frequency_in_seconds(self):
        """Gets the log_backup_frequency_in_seconds of this MssqlSlaPatchProperties.

        Seconds between two log backups. A value of 0 disables log backup.

        :return: The log_backup_frequency_in_seconds of this MssqlSlaPatchProperties.
        :rtype: int
        """
    ...
    def log_backup_frequency_in_seconds(self, log_backup_frequency_in_seconds):
        """Sets the log_backup_frequency_in_seconds of this MssqlSlaPatchProperties.
    ...
    def log_retention_hours(self):
        """Gets the log_retention_hours of this MssqlSlaPatchProperties.
        ...
        :return: The log_retention_hours of this MssqlSlaPatchProperties.
        :rtype: int
        """
    ...
    def log_retention_hours(self, log_retention_hours):
        """Sets the log_retention_hours of this MssqlSlaPatchProperties.
    ...
    def configured_sla_domain_id(self):
        """Gets the configured_sla_domain_id of this MssqlSlaPatchProperties.
        ...
        :return: The configured_sla_domain_id of this MssqlSlaPatchProperties.
        :rtype: str
        """
    ...
    def configured_sla_domain_id(self, configured_sla_domain_id):
        """Sets the configured_sla_domain_id of this MssqlSlaPatchProperties.
    ...
    def use_configured_default_log_retention(self):
        """Gets the use_configured_default_log_retention of this MssqlSlaPatchProperties.

        Determines whether to use the configured default value of log backup retention.

        :return: The use_configured_default_log_retention of this MssqlSlaPatchProperties.
        :rtype: bool
        """
    ...
    def use_configured_default_log_retention(self, use_configured_default_log_retention):
        """Sets the use_configured_default_log_retention of this MssqlSlaPatchProperties.
