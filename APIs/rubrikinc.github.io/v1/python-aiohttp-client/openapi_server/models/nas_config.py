...
class NasConfig(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, api_certificate: str=None, api_endpoint: str=None, api_hostname: str=None, api_password: str=None, api_token: str=None, api_username: str=None, is_isilon_changelist_enabled: bool=None, is_net_app_snap_diff_enabled: bool=None, is_share_auto_discovery_enabled: bool=None, vendor_type: str=None, zone_name: str=None):
        """NasConfig - a model defined in OpenAPI

        :param api_certificate: The api_certificate of this NasConfig.
        :param api_endpoint: The api_endpoint of this NasConfig.
        :param api_hostname: The api_hostname of this NasConfig.
        :param api_password: The api_password of this NasConfig.
        :param api_token: The api_token of this NasConfig.
        :param api_username: The api_username of this NasConfig.
        :param is_isilon_changelist_enabled: The is_isilon_changelist_enabled of this NasConfig.
        :param is_net_app_snap_diff_enabled: The is_net_app_snap_diff_enabled of this NasConfig.
        :param is_share_auto_discovery_enabled: The is_share_auto_discovery_enabled of this NasConfig.
        :param vendor_type: The vendor_type of this NasConfig.
        :param zone_name: The zone_name of this NasConfig.
        """
        self.openapi_types = {
            'api_certificate': str,
            'api_endpoint': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'NasConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The NasConfig of this NasConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def api_certificate(self):
        """Gets the api_certificate of this NasConfig.

        TLS certification to validate NAS server.

        :return: The api_certificate of this NasConfig.
        :rtype: str
        """
    ...
    def api_certificate(self, api_certificate):
        """Sets the api_certificate of this NasConfig.
    ...
    def api_endpoint(self):
        """Gets the api_endpoint of this NasConfig.

        API endpoint to access NAS API 'FLASHBLADE'.

        :return: The api_endpoint of this NasConfig.
        :rtype: str
        """
    ...
    def api_endpoint(self, api_endpoint):
        """Sets the api_endpoint of this NasConfig.
    ...
    def api_hostname(self):
        """Gets the api_hostname of this NasConfig.

        Hostname or IP used in the NAS API calls.

        :return: The api_hostname of this NasConfig.
        :rtype: str
        """
    ...
    def api_hostname(self, api_hostname):
        """Sets the api_hostname of this NasConfig.
    ...
    def api_password(self):
        """Gets the api_password of this NasConfig.

        Password to access NAS API 'ISILON/NETAPP'.

        :return: The api_password of this NasConfig.
        :rtype: str
        """
    ...
    def api_password(self, api_password):
        """Sets the api_password of this NasConfig.
    ...
    @property
    def api_token(self):
        """Gets the api_token of this NasConfig.

        API token to access NAS API 'FLASHBLADE'.

        :return: The api_token of this NasConfig.
        :rtype: str
        """
    ...
    def api_token(self, api_token):
        """Sets the api_token of this NasConfig.
    ...
    def api_username(self):
        """Gets the api_username of this NasConfig.

        Username to access NAS API 'ISILON/NETAPP'.

        :return: The api_username of this NasConfig.
        :rtype: str
        """
    ...
    def api_username(self, api_username):
        """Sets the api_username of this NasConfig.
    ...
    def is_isilon_changelist_enabled(self):
        """Gets the is_isilon_changelist_enabled of this NasConfig.
        ...
        :return: The is_isilon_changelist_enabled of this NasConfig.
        :rtype: bool
        """
    ...
    def is_isilon_changelist_enabled(self, is_isilon_changelist_enabled):
        """Sets the is_isilon_changelist_enabled of this NasConfig.
    ...
    def is_net_app_snap_diff_enabled(self):
        """Gets the is_net_app_snap_diff_enabled of this NasConfig.
        ...
        :return: The is_net_app_snap_diff_enabled of this NasConfig.
        :rtype: bool
        """
    ...
    def is_net_app_snap_diff_enabled(self, is_net_app_snap_diff_enabled):
        """Sets the is_net_app_snap_diff_enabled of this NasConfig.
    ...
    def is_share_auto_discovery_enabled(self):
        """Gets the is_share_auto_discovery_enabled of this NasConfig.
        ...
        :return: The is_share_auto_discovery_enabled of this NasConfig.
        :rtype: bool
        """
    ...
    def is_share_auto_discovery_enabled(self, is_share_auto_discovery_enabled):
        """Sets the is_share_auto_discovery_enabled of this NasConfig.
    ...
    def vendor_type(self):
        """Gets the vendor_type of this NasConfig.

        Type of NAS vendor 'ISILON/NETAPP/FLASHBLADE'.

        :return: The vendor_type of this NasConfig.
        :rtype: str
        """
    ...
    def vendor_type(self, vendor_type):
        """Sets the vendor_type of this NasConfig.
    ...
    @property
    def zone_name(self):
        """Gets the zone_name of this NasConfig.

        Name of the Isilon zone that data IP belongs to.

        :return: The zone_name of this NasConfig.
        :rtype: str
        """
    ...
    def zone_name(self, zone_name):
        """Sets the zone_name of this NasConfig.
