...
class MssqlLogShippingReseedConfig(Model):
    ...
    def __init__(self, should_disconnect_standby_users: bool=None, state: MssqlLogShippingOkState=None):
        """MssqlLogShippingReseedConfig - a model defined in OpenAPI

        :param should_disconnect_standby_users: The should_disconnect_standby_users of this MssqlLogShippingReseedConfig.
        :param state: The state of this MssqlLogShippingReseedConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MssqlLogShippingReseedConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MssqlLogShippingReseedConfig of this MssqlLogShippingReseedConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def should_disconnect_standby_users(self):
        """Gets the should_disconnect_standby_users of this MssqlLogShippingReseedConfig.
        ...
        :return: The should_disconnect_standby_users of this MssqlLogShippingReseedConfig.
        :rtype: bool
        """
    ...
    def should_disconnect_standby_users(self, should_disconnect_standby_users):
        """Sets the should_disconnect_standby_users of this MssqlLogShippingReseedConfig.
    ...
    @property
    def state(self):
        """Gets the state of this MssqlLogShippingReseedConfig.


        :return: The state of this MssqlLogShippingReseedConfig.
    ...
    def state(self, state):
        """Sets the state of this MssqlLogShippingReseedConfig.
