...
class VcdClusterSummary(Model):
    ...
    def __init__(self, configured_sla_domain_id: str=None, configured_sla_domain_name: str=None, configured_sla_domain_type: ConfiguredSlaType=None, id: str=None, is_configured_sla_domain_retention_locked: bool=None, name: str=None, primary_cluster_id: str=None, sla_last_update_time: datetime=None, ca_certs: str=None, hostname: str=None, username: str=None, connection_status: VcdConnectionStatus=None):
        """VcdClusterSummary - a model defined in OpenAPI

        :param configured_sla_domain_id: The configured_sla_domain_id of this VcdClusterSummary.
        :param configured_sla_domain_name: The configured_sla_domain_name of this VcdClusterSummary.
        :param configured_sla_domain_type: The configured_sla_domain_type of this VcdClusterSummary.
        :param id: The id of this VcdClusterSummary.
        :param is_configured_sla_domain_retention_locked: The is_configured_sla_domain_retention_locked of this VcdClusterSummary.
        :param name: The name of this VcdClusterSummary.
        :param primary_cluster_id: The primary_cluster_id of this VcdClusterSummary.
        :param sla_last_update_time: The sla_last_update_time of this VcdClusterSummary.
        :param ca_certs: The ca_certs of this VcdClusterSummary.
        :param hostname: The hostname of this VcdClusterSummary.
        :param username: The username of this VcdClusterSummary.
        :param connection_status: The connection_status of this VcdClusterSummary.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'VcdClusterSummary':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The VcdClusterSummary of this VcdClusterSummary.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def configured_sla_domain_id(self):
        """Gets the configured_sla_domain_id of this VcdClusterSummary.

        The ID of the SLA Domain configured directly on the Rubrik object.

        :return: The configured_sla_domain_id of this VcdClusterSummary.
        :rtype: str
        """
    ...
    def configured_sla_domain_id(self, configured_sla_domain_id):
        """Sets the configured_sla_domain_id of this VcdClusterSummary.
    ...
    def configured_sla_domain_name(self):
        """Gets the configured_sla_domain_name of this VcdClusterSummary.

        The name of the SLA Domain configured directly on the Rubrik object.

        :return: The configured_sla_domain_name of this VcdClusterSummary.
        :rtype: str
        """
    ...
    def configured_sla_domain_name(self, configured_sla_domain_name):
        """Sets the configured_sla_domain_name of this VcdClusterSummary.
    ...
    def configured_sla_domain_type(self):
        """Gets the configured_sla_domain_type of this VcdClusterSummary.


        :return: The configured_sla_domain_type of this VcdClusterSummary.
    ...
    def configured_sla_domain_type(self, configured_sla_domain_type):
        """Sets the configured_sla_domain_type of this VcdClusterSummary.
    ...
    @property
    def id(self):
        """Gets the id of this VcdClusterSummary.

        ID assigned to a vCD Cluster object.

        :return: The id of this VcdClusterSummary.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this VcdClusterSummary.
    ...
    def is_configured_sla_domain_retention_locked(self):
        """Gets the is_configured_sla_domain_retention_locked of this VcdClusterSummary.
        ...
        :return: The is_configured_sla_domain_retention_locked of this VcdClusterSummary.
        :rtype: bool
        """
    ...
    def is_configured_sla_domain_retention_locked(self, is_configured_sla_domain_retention_locked):
        """Sets the is_configured_sla_domain_retention_locked of this VcdClusterSummary.
    ...
    @property
    def name(self):
        """Gets the name of this VcdClusterSummary.

        The name of the Rubrik object.

        :return: The name of this VcdClusterSummary.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this VcdClusterSummary.
    ...
    def primary_cluster_id(self):
        """Gets the primary_cluster_id of this VcdClusterSummary.

        The ID of the cluster that manages the Rubrik object.

        :return: The primary_cluster_id of this VcdClusterSummary.
        :rtype: str
        """
    ...
    def primary_cluster_id(self, primary_cluster_id):
        """Sets the primary_cluster_id of this VcdClusterSummary.
    ...
    def sla_last_update_time(self):
        """Gets the sla_last_update_time of this VcdClusterSummary.

        The UTC time when the SLA Domain was last updated.

        :return: The sla_last_update_time of this VcdClusterSummary.
        :rtype: datetime
        """
    ...
    def sla_last_update_time(self, sla_last_update_time):
        """Sets the sla_last_update_time of this VcdClusterSummary.
    ...
    @property
    def ca_certs(self):
        """Gets the ca_certs of this VcdClusterSummary.
        ...
        :return: The ca_certs of this VcdClusterSummary.
        :rtype: str
        """
    ...
    def ca_certs(self, ca_certs):
        """Sets the ca_certs of this VcdClusterSummary.
    ...
    @property
    def hostname(self):
        """Gets the hostname of this VcdClusterSummary.


        :return: The hostname of this VcdClusterSummary.
        :rtype: str
        """
    ...
    def hostname(self, hostname):
        """Sets the hostname of this VcdClusterSummary.
    ...
    @property
    def username(self):
        """Gets the username of this VcdClusterSummary.


        :return: The username of this VcdClusterSummary.
        :rtype: str
        """
    ...
    def username(self, username):
        """Sets the username of this VcdClusterSummary.
    ...
    def connection_status(self):
        """Gets the connection_status of this VcdClusterSummary.


        :return: The connection_status of this VcdClusterSummary.
    ...
    def connection_status(self, connection_status):
        """Sets the connection_status of this VcdClusterSummary.
