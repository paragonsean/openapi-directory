...
class VmwareHostUpdate(Model):
    ...
    def __init__(self, configured_sla_domain_id: str=None):
        """VmwareHostUpdate - a model defined in OpenAPI

        :param configured_sla_domain_id: The configured_sla_domain_id of this VmwareHostUpdate.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'VmwareHostUpdate':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The VmwareHostUpdate of this VmwareHostUpdate.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def configured_sla_domain_id(self):
        """Gets the configured_sla_domain_id of this VmwareHostUpdate.
        ...
        :return: The configured_sla_domain_id of this VmwareHostUpdate.
        :rtype: str
        """
    ...
    def configured_sla_domain_id(self, configured_sla_domain_id):
        """Sets the configured_sla_domain_id of this VmwareHostUpdate.
