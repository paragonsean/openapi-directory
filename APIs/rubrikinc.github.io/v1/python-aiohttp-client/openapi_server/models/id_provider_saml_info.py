...
class IdProviderSamlInfo(Model):
    ...
    def __init__(self, metadata_xml_base64: str=None, skewness_in_sec: int=300):
        """IdProviderSamlInfo - a model defined in OpenAPI

        :param metadata_xml_base64: The metadata_xml_base64 of this IdProviderSamlInfo.
        :param skewness_in_sec: The skewness_in_sec of this IdProviderSamlInfo.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'IdProviderSamlInfo':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The IdProviderSamlInfo of this IdProviderSamlInfo.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def metadata_xml_base64(self):
        """Gets the metadata_xml_base64 of this IdProviderSamlInfo.

        Identity Provider (IdP) metadata XML file in a base64 encoded format.

        :return: The metadata_xml_base64 of this IdProviderSamlInfo.
        :rtype: str
        """
    ...
    def metadata_xml_base64(self, metadata_xml_base64):
        """Sets the metadata_xml_base64 of this IdProviderSamlInfo.
    ...
    def skewness_in_sec(self):
        """Gets the skewness_in_sec of this IdProviderSamlInfo.

        The clock skewness tolerance, in seconds, between the Identity Provider (IdP) and the Rubrik cluster.

        :return: The skewness_in_sec of this IdProviderSamlInfo.
        :rtype: int
        """
    ...
    def skewness_in_sec(self, skewness_in_sec):
        """Sets the skewness_in_sec of this IdProviderSamlInfo.
