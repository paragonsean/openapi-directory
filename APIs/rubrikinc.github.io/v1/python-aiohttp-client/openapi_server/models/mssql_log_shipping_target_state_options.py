...
class MssqlLogShippingTargetStateOptions(Model):
    ...
    def __init__(self, should_disconnect_standby_users: bool=None, state: MssqlLogShippingOkState=None):
        """MssqlLogShippingTargetStateOptions - a model defined in OpenAPI

        :param should_disconnect_standby_users: The should_disconnect_standby_users of this MssqlLogShippingTargetStateOptions.
        :param state: The state of this MssqlLogShippingTargetStateOptions.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MssqlLogShippingTargetStateOptions':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MssqlLogShippingTargetStateOptions of this MssqlLogShippingTargetStateOptions.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def should_disconnect_standby_users(self):
        """Gets the should_disconnect_standby_users of this MssqlLogShippingTargetStateOptions.
        ...
        :return: The should_disconnect_standby_users of this MssqlLogShippingTargetStateOptions.
        :rtype: bool
        """
    ...
    def should_disconnect_standby_users(self, should_disconnect_standby_users):
        """Sets the should_disconnect_standby_users of this MssqlLogShippingTargetStateOptions.
    ...
    @property
    def state(self):
        """Gets the state of this MssqlLogShippingTargetStateOptions.


        :return: The state of this MssqlLogShippingTargetStateOptions.
    ...
    def state(self, state):
        """Sets the state of this MssqlLogShippingTargetStateOptions.
