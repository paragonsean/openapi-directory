...
class VcdVmSnapshotDetail(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, index_state: int=None, vcd_vm_moid: str=None, vcenter_vm_id: str=None, vm_name: str=None, vm_snapshot_id: str=None, network_connections: List[VappVmNetworkConnection]=None):
        """VcdVmSnapshotDetail - a model defined in OpenAPI

        :param index_state: The index_state of this VcdVmSnapshotDetail.
        :param vcd_vm_moid: The vcd_vm_moid of this VcdVmSnapshotDetail.
        :param vcenter_vm_id: The vcenter_vm_id of this VcdVmSnapshotDetail.
        :param vm_name: The vm_name of this VcdVmSnapshotDetail.
        :param vm_snapshot_id: The vm_snapshot_id of this VcdVmSnapshotDetail.
        :param network_connections: The network_connections of this VcdVmSnapshotDetail.
        """
        self.openapi_types = {
            'index_state': int,
            'vcd_vm_moid': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'VcdVmSnapshotDetail':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The VcdVmSnapshotDetail of this VcdVmSnapshotDetail.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def index_state(self):
        """Gets the index_state of this VcdVmSnapshotDetail.
        ...
        :return: The index_state of this VcdVmSnapshotDetail.
        :rtype: int
        """
    ...
    def index_state(self, index_state):
        """Sets the index_state of this VcdVmSnapshotDetail.
    ...
    def vcd_vm_moid(self):
        """Gets the vcd_vm_moid of this VcdVmSnapshotDetail.

        Id assigned by vCloud Director to the virtual machine of the specified snapshot.

        :return: The vcd_vm_moid of this VcdVmSnapshotDetail.
        :rtype: str
        """
    ...
    def vcd_vm_moid(self, vcd_vm_moid):
        """Sets the vcd_vm_moid of this VcdVmSnapshotDetail.
    ...
    def vcenter_vm_id(self, vcenter_vm_id):
        """Sets the vcenter_vm_id of this VcdVmSnapshotDetail.
    ...
    @property
    def vm_name(self):
        """Gets the vm_name of this VcdVmSnapshotDetail.

        Name of the virtual machine object of the snapshot.

        :return: The vm_name of this VcdVmSnapshotDetail.
        :rtype: str
        """
    ...
    def vm_name(self, vm_name):
        """Sets the vm_name of this VcdVmSnapshotDetail.
    ...
    def vm_snapshot_id(self):
        """Gets the vm_snapshot_id of this VcdVmSnapshotDetail.

        ID assigned to the object that represents a virtual machine snapshot.

        :return: The vm_snapshot_id of this VcdVmSnapshotDetail.
        :rtype: str
        """
    ...
    def vm_snapshot_id(self, vm_snapshot_id):
        """Sets the vm_snapshot_id of this VcdVmSnapshotDetail.
    ...
    def network_connections(self):
        """Gets the network_connections of this VcdVmSnapshotDetail.

        Array of networks present in the virtual machine at the time of the snapshot.

        :return: The network_connections of this VcdVmSnapshotDetail.
    ...
    def network_connections(self, network_connections):
        """Sets the network_connections of this VcdVmSnapshotDetail.
