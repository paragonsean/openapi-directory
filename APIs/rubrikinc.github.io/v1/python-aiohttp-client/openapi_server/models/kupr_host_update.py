...
class KuprHostUpdate(Model):
    ...
    def __init__(self, agent_certificate: str=None, agent_id: str=None, hostname: str=None, ipv4_addresses: List[str]=None, operating_system_info: str=None, operating_system_type: str=None, operating_system_version: str=None):
        """KuprHostUpdate - a model defined in OpenAPI

        :param agent_certificate: The agent_certificate of this KuprHostUpdate.
        :param agent_id: The agent_id of this KuprHostUpdate.
        :param hostname: The hostname of this KuprHostUpdate.
        :param ipv4_addresses: The ipv4_addresses of this KuprHostUpdate.
        :param operating_system_info: The operating_system_info of this KuprHostUpdate.
        :param operating_system_type: The operating_system_type of this KuprHostUpdate.
        :param operating_system_version: The operating_system_version of this KuprHostUpdate.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'KuprHostUpdate':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The KuprHostUpdate of this KuprHostUpdate.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def agent_certificate(self):
        """Gets the agent_certificate of this KuprHostUpdate.
        ...
        :return: The agent_certificate of this KuprHostUpdate.
        :rtype: str
        """
    ...
    def agent_certificate(self, agent_certificate):
        """Sets the agent_certificate of this KuprHostUpdate.
    ...
    @property
    def agent_id(self):
        """Gets the agent_id of this KuprHostUpdate.

        The agent ID of the registered host.

        :return: The agent_id of this KuprHostUpdate.
        :rtype: str
        """
    ...
    def agent_id(self, agent_id):
        """Sets the agent_id of this KuprHostUpdate.
    ...
    @property
    def hostname(self):
        """Gets the hostname of this KuprHostUpdate.


        :return: The hostname of this KuprHostUpdate.
        :rtype: str
        """
    ...
    def hostname(self, hostname):
        """Sets the hostname of this KuprHostUpdate.
    ...
    def ipv4_addresses(self):
        """Gets the ipv4_addresses of this KuprHostUpdate.

        An array containing the IPv4 address to Kupr host. 

        :return: The ipv4_addresses of this KuprHostUpdate.
        :rtype: List[str]
        """
    ...
    def ipv4_addresses(self, ipv4_addresses):
        """Sets the ipv4_addresses of this KuprHostUpdate.
    ...
    def operating_system_info(self):
        """Gets the operating_system_info of this KuprHostUpdate.

        Operating system information of a specified kupr host.

        :return: The operating_system_info of this KuprHostUpdate.
        :rtype: str
        """
    ...
    def operating_system_info(self, operating_system_info):
        """Sets the operating_system_info of this KuprHostUpdate.
    ...
    def operating_system_type(self):
        """Gets the operating_system_type of this KuprHostUpdate.

        Operating system of a specified kupr host.

        :return: The operating_system_type of this KuprHostUpdate.
        :rtype: str
        """
    ...
    def operating_system_type(self, operating_system_type):
        """Sets the operating_system_type of this KuprHostUpdate.
    ...
    def operating_system_version(self):
        """Gets the operating_system_version of this KuprHostUpdate.

        Operating system version of a specified kupr host.

        :return: The operating_system_version of this KuprHostUpdate.
        :rtype: str
        """
    ...
    def operating_system_version(self, operating_system_version):
        """Sets the operating_system_version of this KuprHostUpdate.
