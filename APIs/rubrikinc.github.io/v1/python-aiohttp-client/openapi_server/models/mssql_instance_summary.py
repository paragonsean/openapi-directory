...
class MssqlInstanceSummary(Model):
    ...
    def __init__(self, copy_only: bool=None, log_backup_frequency_in_seconds: int=None, log_retention_hours: int=None, cluster_instance_address: str=None, configured_sla_domain_id: str=None, configured_sla_domain_name: str=None, configured_sla_domain_type: str=None, id: str=None, internal_timestamp: int=None, is_retention_locked: bool=None, name: str=None, primary_cluster_id: str=None, protection_date: date=None, root_properties: MssqlRootProperties=None, unprotectable_reasons: List[str]=None, version: str=None):
        """MssqlInstanceSummary - a model defined in OpenAPI

        :param copy_only: The copy_only of this MssqlInstanceSummary.
        :param log_backup_frequency_in_seconds: The log_backup_frequency_in_seconds of this MssqlInstanceSummary.
        :param log_retention_hours: The log_retention_hours of this MssqlInstanceSummary.
        :param cluster_instance_address: The cluster_instance_address of this MssqlInstanceSummary.
        :param configured_sla_domain_id: The configured_sla_domain_id of this MssqlInstanceSummary.
        :param configured_sla_domain_name: The configured_sla_domain_name of this MssqlInstanceSummary.
        :param configured_sla_domain_type: The configured_sla_domain_type of this MssqlInstanceSummary.
        :param id: The id of this MssqlInstanceSummary.
        :param internal_timestamp: The internal_timestamp of this MssqlInstanceSummary.
        :param is_retention_locked: The is_retention_locked of this MssqlInstanceSummary.
        :param name: The name of this MssqlInstanceSummary.
        :param primary_cluster_id: The primary_cluster_id of this MssqlInstanceSummary.
        :param protection_date: The protection_date of this MssqlInstanceSummary.
        :param root_properties: The root_properties of this MssqlInstanceSummary.
        :param unprotectable_reasons: The unprotectable_reasons of this MssqlInstanceSummary.
        :param version: The version of this MssqlInstanceSummary.
        """
        self.openapi_types = {
            'copy_only': bool,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MssqlInstanceSummary':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MssqlInstanceSummary of this MssqlInstanceSummary.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def copy_only(self):
        """Gets the copy_only of this MssqlInstanceSummary.
        ...
        :return: The copy_only of this MssqlInstanceSummary.
        :rtype: bool
        """
    ...
    def copy_only(self, copy_only):
        """Sets the copy_only of this MssqlInstanceSummary.
    ...
    def log_backup_frequency_in_seconds(self):
        """Gets the log_backup_frequency_in_seconds of this MssqlInstanceSummary.

        Seconds between two log backups. A value of 0 disables log backup.

        :return: The log_backup_frequency_in_seconds of this MssqlInstanceSummary.
        :rtype: int
        """
    ...
    def log_backup_frequency_in_seconds(self, log_backup_frequency_in_seconds):
        """Sets the log_backup_frequency_in_seconds of this MssqlInstanceSummary.
    ...
    def log_retention_hours(self):
        """Gets the log_retention_hours of this MssqlInstanceSummary.
        ...
        :return: The log_retention_hours of this MssqlInstanceSummary.
        :rtype: int
        """
    ...
    def log_retention_hours(self, log_retention_hours):
        """Sets the log_retention_hours of this MssqlInstanceSummary.
    ...
    def cluster_instance_address(self):
        """Gets the cluster_instance_address of this MssqlInstanceSummary.

        The address of the instance in a Windows server failover cluster, populated only if it belongs to one.

        :return: The cluster_instance_address of this MssqlInstanceSummary.
        :rtype: str
        """
    ...
    def cluster_instance_address(self, cluster_instance_address):
        """Sets the cluster_instance_address of this MssqlInstanceSummary.
    ...
    def configured_sla_domain_id(self):
        """Gets the configured_sla_domain_id of this MssqlInstanceSummary.

        SLA Domain ID assigned to instance.

        :return: The configured_sla_domain_id of this MssqlInstanceSummary.
        :rtype: str
        """
    ...
    def configured_sla_domain_id(self, configured_sla_domain_id):
        """Sets the configured_sla_domain_id of this MssqlInstanceSummary.
    ...
    def configured_sla_domain_name(self):
        """Gets the configured_sla_domain_name of this MssqlInstanceSummary.

        SLA Domain name assigned to instance.

        :return: The configured_sla_domain_name of this MssqlInstanceSummary.
        :rtype: str
        """
    ...
    def configured_sla_domain_name(self, configured_sla_domain_name):
        """Sets the configured_sla_domain_name of this MssqlInstanceSummary.
    ...
    def configured_sla_domain_type(self):
        """Gets the configured_sla_domain_type of this MssqlInstanceSummary.

        Specifies whether the SLA Domain is used for protection or retention.

        :return: The configured_sla_domain_type of this MssqlInstanceSummary.
        :rtype: str
        """
    ...
    def configured_sla_domain_type(self, configured_sla_domain_type):
        """Sets the configured_sla_domain_type of this MssqlInstanceSummary.
    ...
    @property
    def id(self):
        """Gets the id of this MssqlInstanceSummary.


        :return: The id of this MssqlInstanceSummary.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this MssqlInstanceSummary.
    ...
    def internal_timestamp(self):
        """Gets the internal_timestamp of this MssqlInstanceSummary.


        :return: The internal_timestamp of this MssqlInstanceSummary.
        :rtype: int
        """
    ...
    def internal_timestamp(self, internal_timestamp):
        """Sets the internal_timestamp of this MssqlInstanceSummary.
    ...
    def is_retention_locked(self):
        """Gets the is_retention_locked of this MssqlInstanceSummary.
        ...
        :return: The is_retention_locked of this MssqlInstanceSummary.
        :rtype: bool
        """
    ...
    def is_retention_locked(self, is_retention_locked):
        """Sets the is_retention_locked of this MssqlInstanceSummary.
    ...
    @property
    def name(self):
        """Gets the name of this MssqlInstanceSummary.


        :return: The name of this MssqlInstanceSummary.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MssqlInstanceSummary.
    ...
    def primary_cluster_id(self):
        """Gets the primary_cluster_id of this MssqlInstanceSummary.


        :return: The primary_cluster_id of this MssqlInstanceSummary.
        :rtype: str
        """
    ...
    def primary_cluster_id(self, primary_cluster_id):
        """Sets the primary_cluster_id of this MssqlInstanceSummary.
    ...
    def protection_date(self):
        """Gets the protection_date of this MssqlInstanceSummary.


        :return: The protection_date of this MssqlInstanceSummary.
        :rtype: date
        """
    ...
    def protection_date(self, protection_date):
        """Sets the protection_date of this MssqlInstanceSummary.
    ...
    def root_properties(self):
        """Gets the root_properties of this MssqlInstanceSummary.


        :return: The root_properties of this MssqlInstanceSummary.
    ...
    def root_properties(self, root_properties):
        """Sets the root_properties of this MssqlInstanceSummary.
    ...
    def unprotectable_reasons(self):
        """Gets the unprotectable_reasons of this MssqlInstanceSummary.

        A list of reasons that all the SQL Server databases in a SQL Server instance cannot be protected by the Rubrik CDM.

        :return: The unprotectable_reasons of this MssqlInstanceSummary.
        :rtype: List[str]
        """
    ...
    def unprotectable_reasons(self, unprotectable_reasons):
        """Sets the unprotectable_reasons of this MssqlInstanceSummary.
    ...
    @property
    def version(self):
        """Gets the version of this MssqlInstanceSummary.


        :return: The version of this MssqlInstanceSummary.
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this MssqlInstanceSummary.
