...
class MssqlHostConfigurationWithHostId(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, enable_database_batch_snapshots: HostConfigurationPropertyEnabled=None, enable_group_fetch: HostConfigurationPropertyEnabled=None, enable_vdi: HostConfigurationPropertyEnabled=None, enable_vdi_db: HostConfigurationPropertyEnabled=None, file_restore_read_parallelism: int=None, file_restore_write_parallelism: int=None, file_transfer_parallelism: int=None, mssql_default_max_data_streams_per_database: int=None, physical_host_database_restore_throttle_max_ref_count: int=None, physical_host_log_backup_throttle_max_ref_count: int=None, throttle_physical_host_max_ref_count: int=None, host_id: str=None):
        """MssqlHostConfigurationWithHostId - a model defined in OpenAPI

        :param enable_database_batch_snapshots: The enable_database_batch_snapshots of this MssqlHostConfigurationWithHostId.
        :param enable_group_fetch: The enable_group_fetch of this MssqlHostConfigurationWithHostId.
        :param enable_vdi: The enable_vdi of this MssqlHostConfigurationWithHostId.
        :param enable_vdi_db: The enable_vdi_db of this MssqlHostConfigurationWithHostId.
        :param file_restore_read_parallelism: The file_restore_read_parallelism of this MssqlHostConfigurationWithHostId.
        :param file_restore_write_parallelism: The file_restore_write_parallelism of this MssqlHostConfigurationWithHostId.
        :param file_transfer_parallelism: The file_transfer_parallelism of this MssqlHostConfigurationWithHostId.
        :param mssql_default_max_data_streams_per_database: The mssql_default_max_data_streams_per_database of this MssqlHostConfigurationWithHostId.
        :param physical_host_database_restore_throttle_max_ref_count: The physical_host_database_restore_throttle_max_ref_count of this MssqlHostConfigurationWithHostId.
        :param physical_host_log_backup_throttle_max_ref_count: The physical_host_log_backup_throttle_max_ref_count of this MssqlHostConfigurationWithHostId.
        :param throttle_physical_host_max_ref_count: The throttle_physical_host_max_ref_count of this MssqlHostConfigurationWithHostId.
        :param host_id: The host_id of this MssqlHostConfigurationWithHostId.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MssqlHostConfigurationWithHostId':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MssqlHostConfigurationWithHostId of this MssqlHostConfigurationWithHostId.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def enable_database_batch_snapshots(self):
        """Gets the enable_database_batch_snapshots of this MssqlHostConfigurationWithHostId.


        :return: The enable_database_batch_snapshots of this MssqlHostConfigurationWithHostId.
    ...
    def enable_database_batch_snapshots(self, enable_database_batch_snapshots):
        """Sets the enable_database_batch_snapshots of this MssqlHostConfigurationWithHostId.
    ...
    def enable_group_fetch(self):
        """Gets the enable_group_fetch of this MssqlHostConfigurationWithHostId.


        :return: The enable_group_fetch of this MssqlHostConfigurationWithHostId.
        :rtype: HostConfigurationPropertyEnabled
        """
    ...
    def enable_group_fetch(self, enable_group_fetch):
        """Sets the enable_group_fetch of this MssqlHostConfigurationWithHostId.
    ...
    @property
    def enable_vdi(self):
        """Gets the enable_vdi of this MssqlHostConfigurationWithHostId.


        :return: The enable_vdi of this MssqlHostConfigurationWithHostId.
        :rtype: HostConfigurationPropertyEnabled
        """
    ...
    def enable_vdi(self, enable_vdi):
        """Sets the enable_vdi of this MssqlHostConfigurationWithHostId.
    ...
    def enable_vdi_db(self):
        """Gets the enable_vdi_db of this MssqlHostConfigurationWithHostId.


        :return: The enable_vdi_db of this MssqlHostConfigurationWithHostId.
        :rtype: HostConfigurationPropertyEnabled
        """
    ...
    def enable_vdi_db(self, enable_vdi_db):
        """Sets the enable_vdi_db of this MssqlHostConfigurationWithHostId.
    ...
    def file_restore_read_parallelism(self):
        """Gets the file_restore_read_parallelism of this MssqlHostConfigurationWithHostId.

        Number of concurrent read requests for restoring a file from the Rubrik cluster to a remote host.

        :return: The file_restore_read_parallelism of this MssqlHostConfigurationWithHostId.
        :rtype: int
        """
    ...
    def file_restore_read_parallelism(self, file_restore_read_parallelism):
        """Sets the file_restore_read_parallelism of this MssqlHostConfigurationWithHostId.
    ...
    def file_restore_write_parallelism(self):
        """Gets the file_restore_write_parallelism of this MssqlHostConfigurationWithHostId.

        Number of concurrent write requests for restoring a file from the Rubrik cluster to a remote host.

        :return: The file_restore_write_parallelism of this MssqlHostConfigurationWithHostId.
        :rtype: int
        """
    ...
    def file_restore_write_parallelism(self, file_restore_write_parallelism):
        """Sets the file_restore_write_parallelism of this MssqlHostConfigurationWithHostId.
    ...
    def file_transfer_parallelism(self):
        """Gets the file_transfer_parallelism of this MssqlHostConfigurationWithHostId.

        Number of concurrent requests for transferring a file from a remote host to the Rubrik cluster.

        :return: The file_transfer_parallelism of this MssqlHostConfigurationWithHostId.
        :rtype: int
        """
    ...
    def file_transfer_parallelism(self, file_transfer_parallelism):
        """Sets the file_transfer_parallelism of this MssqlHostConfigurationWithHostId.
    ...
    def mssql_default_max_data_streams_per_database(self):
        """Gets the mssql_default_max_data_streams_per_database of this MssqlHostConfigurationWithHostId.

        The default value for maximum number of data streams per database.

        :return: The mssql_default_max_data_streams_per_database of this MssqlHostConfigurationWithHostId.
        :rtype: int
        """
    ...
    def mssql_default_max_data_streams_per_database(self, mssql_default_max_data_streams_per_database):
        """Sets the mssql_default_max_data_streams_per_database of this MssqlHostConfigurationWithHostId.
    ...
    def physical_host_database_restore_throttle_max_ref_count(self):
        """Gets the physical_host_database_restore_throttle_max_ref_count of this MssqlHostConfigurationWithHostId.

        The maximum number of concurrent database restore job running on a host.

        :return: The physical_host_database_restore_throttle_max_ref_count of this MssqlHostConfigurationWithHostId.
        :rtype: int
        """
    ...
    def physical_host_database_restore_throttle_max_ref_count(self, physical_host_database_restore_throttle_max_ref_count):
        """Sets the physical_host_database_restore_throttle_max_ref_count of this MssqlHostConfigurationWithHostId.
    ...
    def physical_host_log_backup_throttle_max_ref_count(self):
        """Gets the physical_host_log_backup_throttle_max_ref_count of this MssqlHostConfigurationWithHostId.

        Maximum number of concurrent SQL Server log backup jobs per physical host.

        :return: The physical_host_log_backup_throttle_max_ref_count of this MssqlHostConfigurationWithHostId.
        :rtype: int
        """
    ...
    def physical_host_log_backup_throttle_max_ref_count(self, physical_host_log_backup_throttle_max_ref_count):
        """Sets the physical_host_log_backup_throttle_max_ref_count of this MssqlHostConfigurationWithHostId.
    ...
    def throttle_physical_host_max_ref_count(self):
        """Gets the throttle_physical_host_max_ref_count of this MssqlHostConfigurationWithHostId.

        Maximum number of concurrent snapshots per physical host.

        :return: The throttle_physical_host_max_ref_count of this MssqlHostConfigurationWithHostId.
        :rtype: int
        """
    ...
    def throttle_physical_host_max_ref_count(self, throttle_physical_host_max_ref_count):
        """Sets the throttle_physical_host_max_ref_count of this MssqlHostConfigurationWithHostId.
    ...
    @property
    def host_id(self):
        """Gets the host_id of this MssqlHostConfigurationWithHostId.

        the ID of the host.

        :return: The host_id of this MssqlHostConfigurationWithHostId.
        :rtype: str
        """
    ...
    def host_id(self, host_id):
        """Sets the host_id of this MssqlHostConfigurationWithHostId.
