...
|**vNicsInfo** | [**List&lt;VmwareVNicBindingInfo&gt;**](VmwareVNicBindingInfo.md) |  |  [optional] |
|**vmName** | **String** |  |  |
|**config** | **String** |  |  [optional] |
|**isCorrupt** | **Boolean** |  |  [optional] |
|**snapshotDiskDetails** | [**List&lt;VmSnapshotDiskDetail&gt;**](VmSnapshotDiskDetail.md) |  |  |
|**snapshotDiskIds** | **List&lt;String&gt;** | This field is deprecated, use snapshotDiskDetails instead. |  [optional] |
|**virtualMachine** | [**VirtualMachineSummary**](VirtualMachineSummary.md) |  |  [optional] |
|**vmwareTagList** | **List&lt;String&gt;** | List of vSphere tags assigned to the virtual machine. |  [optional] |
