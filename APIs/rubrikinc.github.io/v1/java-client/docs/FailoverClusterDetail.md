...
|**nodes** | [**List&lt;FailoverClusterNode&gt;**](FailoverClusterNode.md) | Details of the nodes of this failover cluster. |  |
|**operatingSystemType** | **FailoverClusterOsType** |  |  [optional] |
|**slaAssignment** | **SlaAssignment** |  |  [optional] |
|**numApps** | **Integer** | Count of the number of failover cluster apps. |  |
|**numNodes** | **Integer** | Count of the number of nodes on the failover cluster. |  |
