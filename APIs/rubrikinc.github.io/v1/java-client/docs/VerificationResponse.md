...
|**snapshotVerificationInfo** | [**List&lt;SnapshotEventSeries&gt;**](SnapshotEventSeries.md) | List of IDs of the snapshots requested for verification and their corresponding event series IDs.  |  |
