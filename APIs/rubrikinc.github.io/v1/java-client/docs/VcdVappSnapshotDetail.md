...
|**excludedVcdVmMoids** | **List&lt;String&gt;** | Array that lists the Virtual Machines of the vApp that where excluded from the snapshot. |  [optional] |
|**networks** | [**List&lt;VappNetworkSummary&gt;**](VappNetworkSummary.md) | Array that lists the vApp networks in the vApp at the time of the snapshot. |  |
|**vmSnapshots** | [**List&lt;VcdVmSnapshotDetail&gt;**](VcdVmSnapshotDetail.md) |  |  |
