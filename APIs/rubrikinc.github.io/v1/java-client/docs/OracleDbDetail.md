...
|**archiveLogDestinations** | **List&lt;String&gt;** | An array that contains the archive log destinations for the specified Oracle database. |  [optional] |
...
|**dataGuardGroupMembers** | [**List&lt;DataGuardGroupMember&gt;**](DataGuardGroupMember.md) | List of Data Guard group members. |  [optional] |
|**dataGuardGroupName** | **String** | Name of the Data Guard group to which this database belongs. |  [optional] |
|**dataGuardType** | **DataGuardType** |  |  [optional] |
...
|**instances** | [**List&lt;OracleInstanceProperties&gt;**](OracleInstanceProperties.md) | Details of the instances of the Oracle database. |  [optional] |
...
|**numInstances** | **Integer** | Count of the number of instances of the Oracle database. |  [optional] |
|**numMissedSnapshot** | **Integer** | An integer that specifies the number of missed snapshots. |  |
|**numTablespaces** | **Integer** | Count of the number of table spaces in Oracle database. |  |
...
|**hostsInfo** | [**List&lt;HostInfo&gt;**](HostInfo.md) | An array that contains the host info for each instance. |  [optional] |
|**isLiveMount** | **Boolean** | Value that indicates whether an Oracle database object is a Live Mount or not. A true value indicates that the object is a Live Mount. |  [optional] |
|**lastValidationResult** | [**OracleLastValidationResult**](OracleLastValidationResult.md) |  |  [optional] |
|**latestRecoveryPoint** | **LocalDate** | The time stamp of the most recent recovery point for this database. |  [optional] |
|**oldestRecoveryPoint** | **LocalDate** | The time stamp of the earliest recovery point for this database. |  [optional] |
|**oracleHome** | **String** | Oracle Home of the Oracle database. |  [optional] |
|**pendingSlaDomain** | [**ManagedObjectPendingSlaInfo**](ManagedObjectPendingSlaInfo.md) |  |  [optional] |
|**preferredDGMemberUniqueNames** | **List&lt;String&gt;** | Ordered list of database unique names to use for backup in a Data Guard group. |  [optional] |
|**shouldBackupFromPrimaryDGGroupMemberOnly** | **Boolean** | Indicates whether to backup only from the PRIMARY Data Guard member or from any available member. |  [optional] |
|**snapshotCount** | **Integer** |  |  |
|**tablespaces** | **List&lt;String&gt;** | An array that contains tablespace names of the specified Oracle database. |  |
