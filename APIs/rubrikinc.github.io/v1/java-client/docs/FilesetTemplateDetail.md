...
|**hostCount** | **Integer** | Number of hosts where this template has been applied. |  [optional] |
|**id** | **String** |  |  |
|**isArchived** | **Boolean** |  |  [optional] |
|**isCreatedByKupr** | **Boolean** | Specifies whether this is created by a Kupr Host. |  [optional] |
|**primaryClusterId** | **String** |  |  |
|**shareCount** | **Integer** | Number of shares where this template has been applied. |  [optional] |
