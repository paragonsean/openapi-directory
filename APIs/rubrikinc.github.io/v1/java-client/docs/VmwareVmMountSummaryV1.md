...
|------------ | ------------- | ------------- | -------------|
|**attachingDiskCount** | **Integer** | An integer value that identifies how many disks are attached. |  [optional] |
...
|**mountTimestamp** | **OffsetDateTime** | Gives the timestamp at which the mount was created. |  [optional] |
