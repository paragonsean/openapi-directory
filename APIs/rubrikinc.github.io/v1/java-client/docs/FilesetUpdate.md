...
|**forceFullPartitionIds** | **List&lt;Integer&gt;** | Assign partition ids to set the force full. In order for this to be valid input, forceFull must be set to true. |  [optional] |
