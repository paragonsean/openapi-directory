...
|**operationTimeout** | **Long** | Number of seconds after which the operation is terminated if it has not completed execution. Default value is 600 seconds. |  [optional] |
...
|**operationMode** | **OperationMode** |  |  [optional] |
