...
|**hostname** | **String** |  |  |
|**ipv4Addresses** | **List&lt;String&gt;** |  |  [optional] |
|**operatingSystemInfo** | [**OperatingSystemInfoEnum**](#OperatingSystemInfoEnum) | Operating system information of a specified kupr host. |  |
|**operatingSystemType** | [**OperatingSystemTypeEnum**](#OperatingSystemTypeEnum) | Operating system of a specified kupr host. |  |
