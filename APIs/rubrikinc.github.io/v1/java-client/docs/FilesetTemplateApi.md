...
import org.openapitools.client.api.FilesetTemplateApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    FilesetTemplateApi apiInstance = new FilesetTemplateApi(defaultClient);
    FilesetTemplateCreate filesetTemplateCreate = new FilesetTemplateCreate(); // FilesetTemplateCreate | Provide an object with the fileset template definition.
    try {
      FilesetTemplateDetail result = apiInstance.createFilesetTemplate(filesetTemplateCreate);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FilesetTemplateApi#createFilesetTemplate");
...
|-------------|-------------|------------------|
| **201** | Summary information for the created fileset template. |  -  |

<a id="deleteFilesetTemplate"></a>
# **deleteFilesetTemplate**
> deleteFilesetTemplate(id, preserveSnapshots)
...
public class Example {
  public static void main(String[] args) {
    ...
    FilesetTemplateApi apiInstance = new FilesetTemplateApi(defaultClient);
    String id = "id_example"; // String | ID of the fileset template to remove.
    Boolean preserveSnapshots = true; // Boolean | Flag to indicate whether to convert snapshots of all filesets of this template to relics or to delete them.  Default is true.
    try {
      apiInstance.deleteFilesetTemplate(id, preserveSnapshots);
    } catch (ApiException e) {
      System.err.println("Exception when calling FilesetTemplateApi#deleteFilesetTemplate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **204** | Successfully removed the specified fileset template. |  -  |

<a id="getFilesetTemplate"></a>
# **getFilesetTemplate**
...
public class Example {
  public static void main(String[] args) {
    ...
    FilesetTemplateApi apiInstance = new FilesetTemplateApi(defaultClient);
    String id = "id_example"; // String | The ID of the fileset template.
    try {
      FilesetTemplateDetail result = apiInstance.getFilesetTemplate(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FilesetTemplateApi#getFilesetTemplate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Summary information for the specified fileset template. |  -  |

<a id="queryFilesetTemplate"></a>
# **queryFilesetTemplate**
> FilesetTemplateDetailListResponse queryFilesetTemplate(primaryClusterId, operatingSystemType, shareType, name, sortBy, sortOrder)
...
public class Example {
  public static void main(String[] args) {
    ...
    String operatingSystemType = "UnixLike"; // String | Filter the summary information based on the operating system type of the fileset. Accepted values: 'Windows', 'UnixLike', 'ANY', 'NONE'. Use **_NONE_** to only return information for fileset templates that do not have operating system type set. Use **_ANY_** to only return information for fileset templates that have operating system type set.
    String shareType = "NFS"; // String | Filter the summary information based on the share type where the fileset is assigned to. Accepted values: 'NFS', 'SMB', 'ANY', 'NONE'. Use **_NONE_** to only return information for fileset templates that do not have share type set. Use **_ANY_** to only return information for fileset templates that have share type set.
    String name = "name_example"; // String | Retrieve fileset templates with a name matching the provided name. The search is performed as a case-insensitive infix search.
    ...
    try {
      FilesetTemplateDetailListResponse result = apiInstance.queryFilesetTemplate(primaryClusterId, operatingSystemType, shareType, name, sortBy, sortOrder);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FilesetTemplateApi#queryFilesetTemplate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **operatingSystemType** | **String**| Filter the summary information based on the operating system type of the fileset. Accepted values: &#39;Windows&#39;, &#39;UnixLike&#39;, &#39;ANY&#39;, &#39;NONE&#39;. Use **_NONE_** to only return information for fileset templates that do not have operating system type set. Use **_ANY_** to only return information for fileset templates that have operating system type set. | [optional] [enum: UnixLike, Windows, ANY, NONE] |
| **shareType** | **String**| Filter the summary information based on the share type where the fileset is assigned to. Accepted values: &#39;NFS&#39;, &#39;SMB&#39;, &#39;ANY&#39;, &#39;NONE&#39;. Use **_NONE_** to only return information for fileset templates that do not have share type set. Use **_ANY_** to only return information for fileset templates that have share type set. | [optional] [enum: NFS, SMB, ANY, NONE] |
...
| **sortBy** | **String**| Specifies a comma-separated list of fileset attributes to use in sorting the fileset summary information. Performs an ASCII sort of the summary information using each specified attribute, in the order specified.  Valid attributes are: **_name_**, **_includes_**, **_excludes_**, **_exceptions_**, **_hostCount_**, **_shareType_**. Default sort_order is ascending. | [optional] [enum: name, hostCount, includes, excludes, exceptions, shareType] |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Summary information for all fileset templates. |  -  |

<a id="updateFilesetTemplate"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    FilesetTemplateApi apiInstance = new FilesetTemplateApi(defaultClient);
    String id = "id_example"; // String | ID of the fileset template to update.
    FilesetTemplatePatch filesetTemplatePatch = new FilesetTemplatePatch(); // FilesetTemplatePatch | Provide an object with the fileset template definition.
    try {
      FilesetTemplateDetail result = apiInstance.updateFilesetTemplate(id, filesetTemplatePatch);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FilesetTemplateApi#updateFilesetTemplate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Detailed information for modified fileset template. |  -  |
