...
|------------ | ------------- | ------------- | -------------|
|**dataPathSpec** | [**SapHanaSystemDataPathSpec**](SapHanaSystemDataPathSpec.md) |  |  [optional] |
|**hostIds** | **List&lt;String&gt;** | The SAP HANA system hosts. |  |
|**instanceNumber** | **String** | The instance number of the SAP HANA system. |  |
|**password** | **String** | The password of the SAP HANA system. |  |
