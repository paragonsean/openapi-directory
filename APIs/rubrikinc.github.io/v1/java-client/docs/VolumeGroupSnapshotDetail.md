...
|**fileSizeInBytes** | **Long** | The logical size of the Volume Group snapshot in bytes. |  [optional] |
|**includedVolumes** | [**List&lt;VolumeGroupSnapshotVolumeSummary&gt;**](VolumeGroupSnapshotVolumeSummary.md) | Configuration details of the volume(s) included in the snapshot. |  |
|**name** | **String** | A human-readable name of the mount points included in the snapshot. |  |
|**usedFastVhdx** | **Boolean** | Specifies whether the snapshot was taken using the fast VHDX builder, which became available in the Rubrik CDM 5.1 release. |  [optional] |
|**volumeGroupId** | **String** | The unique ID of the Volume Group that was snapshoted. |  |
