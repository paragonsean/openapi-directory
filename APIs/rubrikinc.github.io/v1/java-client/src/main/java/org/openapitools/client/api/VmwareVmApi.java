...
import org.openapitools.client.model.BaseOnDemandSnapshotConfig;
import org.openapitools.client.model.BatchAsyncRequestStatus;
import org.openapitools.client.model.BatchMountSnapshotJobConfig;
import org.openapitools.client.model.BatchVmSnapshotSummaries;
import org.openapitools.client.model.BatchVmwareCdpLiveInfo;
import org.openapitools.client.model.BatchVmwareCdpStateInfo;
import org.openapitools.client.model.BatchVmwareVmMissedRecoverableRanges;
import org.openapitools.client.model.BatchVmwareVmMissedRecoverableRangesRequest;
import org.openapitools.client.model.BatchVmwareVmRecoverableRanges;
import org.openapitools.client.model.BatchVmwareVmRecoverableRangesRequest;
import org.openapitools.client.model.BrowseResponseListResponse;
import org.openapitools.client.model.BulkOnDemandSnapshotJobConfig;
import org.openapitools.client.model.DownloadFileJobConfig;
import org.openapitools.client.model.ExportSnapshotJobConfigV1;
import org.openapitools.client.model.InstantRecoveryJobConfig;
import org.openapitools.client.model.MissedSnapshotListResponse;
import org.openapitools.client.model.MountSnapshotJobConfigV1;
import java.time.OffsetDateTime;
import org.openapitools.client.model.RelocateMountConfig;
import org.openapitools.client.model.RestoreFileJobConfig;
import org.openapitools.client.model.SearchResponseListResponse;
import org.openapitools.client.model.UpdateMountConfig;
import org.openapitools.client.model.VirtualDiskDetail;
import org.openapitools.client.model.VirtualDiskUpdate;
import org.openapitools.client.model.VirtualMachineDetail;
import org.openapitools.client.model.VirtualMachineSummaryListResponse;
import org.openapitools.client.model.VirtualMachineUpdateWithSecret;
import org.openapitools.client.model.VmForceFullRequest;
import org.openapitools.client.model.VmForceFullResponse;
import org.openapitools.client.model.VmGuestScriptRunConfig;
import org.openapitools.client.model.VmSnapshotDetail;
import org.openapitools.client.model.VmSnapshotSummaryListResponse;
import org.openapitools.client.model.VmwareRecoverableRangeListResponse;
import org.openapitools.client.model.VmwareVmMountDetailV1;
import org.openapitools.client.model.VmwareVmMountSummaryV1ListResponse;
...
public class VmwareVmApi {
    ...
    public VmwareVmApi(ApiClient apiClient) {
    ...
    /**
     * Build call for batchMountSnapshot
     * @param batchMountSnapshotJobConfig Configuration object containing an array of virtual machine IDs, a way to indicate the snapshot to be chosen and mount configs. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 202 </td><td> Status of the Live Mount requests. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call batchMountSnapshotCall(BatchMountSnapshotJobConfig batchMountSnapshotJobConfig, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = batchMountSnapshotJobConfig;

        // create path and map variables
        String localVarPath = "/vmware/vm/batch_mount";
    ...
    private okhttp3.Call batchMountSnapshotValidateBeforeCall(BatchMountSnapshotJobConfig batchMountSnapshotJobConfig, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'batchMountSnapshotJobConfig' is set
        if (batchMountSnapshotJobConfig == null) {
            throw new ApiException("Missing the required parameter 'batchMountSnapshotJobConfig' when calling batchMountSnapshot(Async)");
        }

        return batchMountSnapshotCall(batchMountSnapshotJobConfig, _callback);
     ...
     * 
     * @param batchMountSnapshotJobConfig Configuration object containing an array of virtual machine IDs, a way to indicate the snapshot to be chosen and mount configs. (required)
     * @return BatchAsyncRequestStatus
     ...
     */
    public BatchAsyncRequestStatus batchMountSnapshot(BatchMountSnapshotJobConfig batchMountSnapshotJobConfig) throws ApiException {
        ApiResponse<BatchAsyncRequestStatus> localVarResp = batchMountSnapshotWithHttpInfo(batchMountSnapshotJobConfig);
     ...
     * 
     * @param batchMountSnapshotJobConfig Configuration object containing an array of virtual machine IDs, a way to indicate the snapshot to be chosen and mount configs. (required)
     * @return ApiResponse&lt;BatchAsyncRequestStatus&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BatchAsyncRequestStatus> batchMountSnapshotWithHttpInfo(BatchMountSnapshotJobConfig batchMountSnapshotJobConfig) throws ApiException {
        okhttp3.Call localVarCall = batchMountSnapshotValidateBeforeCall(batchMountSnapshotJobConfig, null);
        Type localVarReturnType = new TypeToken<BatchAsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Live mount a snapshot each from a set of virtual machines (asynchronously)
     * 
     * @param batchMountSnapshotJobConfig Configuration object containing an array of virtual machine IDs, a way to indicate the snapshot to be chosen and mount configs. (required)
     ...
     */
    public okhttp3.Call batchMountSnapshotAsync(BatchMountSnapshotJobConfig batchMountSnapshotJobConfig, final ApiCallback<BatchAsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = batchMountSnapshotValidateBeforeCall(batchMountSnapshotJobConfig, _callback);
        Type localVarReturnType = new TypeToken<BatchAsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for browseVmwareSnapshot
     * @param id ID of snapshot. (required)
     * @param path The absolute path of the starting point for the directory listing. (required)
     * @param offset Starting position in the list of path entries contained in the query results, sorted by lexicographical order. The response includes the specified numbered entry and all higher numbered entries. (optional)
     * @param limit Maximum number of entries in the response. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> List of files and directories at the specified path. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call browseVmwareSnapshotCall(String id, String path, Integer offset, Integer limit, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/{id}/browse"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call browseVmwareSnapshotValidateBeforeCall(String id, String path, Integer offset, Integer limit, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling browseVmwareSnapshot(Async)");
        }

        // verify the required parameter 'path' is set
        if (path == null) {
            throw new ApiException("Missing the required parameter 'path' when calling browseVmwareSnapshot(Async)");
        }

        return browseVmwareSnapshotCall(id, path, offset, limit, _callback);
     ...
     */
    public BrowseResponseListResponse browseVmwareSnapshot(String id, String path, Integer offset, Integer limit) throws ApiException {
        ApiResponse<BrowseResponseListResponse> localVarResp = browseVmwareSnapshotWithHttpInfo(id, path, offset, limit);
        return localVarResp.getData();
    }
     ...
     * @param offset Starting position in the list of path entries contained in the query results, sorted by lexicographical order. The response includes the specified numbered entry and all higher numbered entries. (optional)
     * @param limit Maximum number of entries in the response. (optional)
     * @return ApiResponse&lt;BrowseResponseListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BrowseResponseListResponse> browseVmwareSnapshotWithHttpInfo(String id, String path, Integer offset, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = browseVmwareSnapshotValidateBeforeCall(id, path, offset, limit, null);
        Type localVarReturnType = new TypeToken<BrowseResponseListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List files in VM snapshot (asynchronously)
     * For a virtual machine snapshot, list the directories and files that are beneath a specified file system path.
     * @param id ID of snapshot. (required)
     * @param path The absolute path of the starting point for the directory listing. (required)
     * @param offset Starting position in the list of path entries contained in the query results, sorted by lexicographical order. The response includes the specified numbered entry and all higher numbered entries. (optional)
     ...
     */
    public okhttp3.Call browseVmwareSnapshotAsync(String id, String path, Integer offset, Integer limit, final ApiCallback<BrowseResponseListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = browseVmwareSnapshotValidateBeforeCall(id, path, offset, limit, _callback);
        Type localVarReturnType = new TypeToken<BrowseResponseListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bulkCreateOnDemandBackup
     * @param bulkOnDemandSnapshotJobConfig The IDs of the virtual machines for which to take an on-demand snapshot and the ID of the SLA Domain to assign to the resulting snapshot. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Status of the on-demand backup requests. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call bulkCreateOnDemandBackupCall(BulkOnDemandSnapshotJobConfig bulkOnDemandSnapshotJobConfig, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = bulkOnDemandSnapshotJobConfig;

        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/bulk";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bulkCreateOnDemandBackupValidateBeforeCall(BulkOnDemandSnapshotJobConfig bulkOnDemandSnapshotJobConfig, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'bulkOnDemandSnapshotJobConfig' is set
        if (bulkOnDemandSnapshotJobConfig == null) {
            throw new ApiException("Missing the required parameter 'bulkOnDemandSnapshotJobConfig' when calling bulkCreateOnDemandBackup(Async)");
        }

        return bulkCreateOnDemandBackupCall(bulkOnDemandSnapshotJobConfig, _callback);
     ...
     */
    public BatchAsyncRequestStatus bulkCreateOnDemandBackup(BulkOnDemandSnapshotJobConfig bulkOnDemandSnapshotJobConfig) throws ApiException {
        ApiResponse<BatchAsyncRequestStatus> localVarResp = bulkCreateOnDemandBackupWithHttpInfo(bulkOnDemandSnapshotJobConfig);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<BatchAsyncRequestStatus> bulkCreateOnDemandBackupWithHttpInfo(BulkOnDemandSnapshotJobConfig bulkOnDemandSnapshotJobConfig) throws ApiException {
        okhttp3.Call localVarCall = bulkCreateOnDemandBackupValidateBeforeCall(bulkOnDemandSnapshotJobConfig, null);
        Type localVarReturnType = new TypeToken<BatchAsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Take an on-demand snapshot of multiple virtual machines (asynchronously)
     * Bulk operation of taking on-demand snapshot for given virtual machines.
     * @param bulkOnDemandSnapshotJobConfig The IDs of the virtual machines for which to take an on-demand snapshot and the ID of the SLA Domain to assign to the resulting snapshot. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call bulkCreateOnDemandBackupAsync(BulkOnDemandSnapshotJobConfig bulkOnDemandSnapshotJobConfig, final ApiCallback<BatchAsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = bulkCreateOnDemandBackupValidateBeforeCall(bulkOnDemandSnapshotJobConfig, _callback);
        Type localVarReturnType = new TypeToken<BatchAsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createDownloadFileJob
     * @param id ID of a snapshot. (required)
     * @param downloadFileJobConfig Configuration for the file download request. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Status of the file download request. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createDownloadFileJobCall(String id, DownloadFileJobConfig downloadFileJobConfig, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = downloadFileJobConfig;

        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/{id}/download_file"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createDownloadFileJobValidateBeforeCall(String id, DownloadFileJobConfig downloadFileJobConfig, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling createDownloadFileJob(Async)");
        }

        // verify the required parameter 'downloadFileJobConfig' is set
        if (downloadFileJobConfig == null) {
            throw new ApiException("Missing the required parameter 'downloadFileJobConfig' when calling createDownloadFileJob(Async)");
        }

        return createDownloadFileJobCall(id, downloadFileJobConfig, _callback);
     ...
     */
    public AsyncRequestStatus createDownloadFileJob(String id, DownloadFileJobConfig downloadFileJobConfig) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = createDownloadFileJobWithHttpInfo(id, downloadFileJobConfig);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> createDownloadFileJobWithHttpInfo(String id, DownloadFileJobConfig downloadFileJobConfig) throws ApiException {
        okhttp3.Call localVarCall = createDownloadFileJobValidateBeforeCall(id, downloadFileJobConfig, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Download file from VM snapshot (asynchronously)
     * Create a request to download a file from a virtual machine snapshot.
     * @param id ID of a snapshot. (required)
     * @param downloadFileJobConfig Configuration for the file download request. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createDownloadFileJobAsync(String id, DownloadFileJobConfig downloadFileJobConfig, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = createDownloadFileJobValidateBeforeCall(id, downloadFileJobConfig, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createDownloadSnapshotFromCloud
     * @param id ID of snapshot. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Status for the download request. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createDownloadSnapshotFromCloudCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/{id}/download"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createDownloadSnapshotFromCloudValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling createDownloadSnapshotFromCloud(Async)");
        }

        return createDownloadSnapshotFromCloudCall(id, _callback);
     ...
     */
    public AsyncRequestStatus createDownloadSnapshotFromCloud(String id) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = createDownloadSnapshotFromCloudWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> createDownloadSnapshotFromCloudWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = createDownloadSnapshotFromCloudValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Download snapshot from archive (asynchronously)
     * Provides a method for retrieving a snapshot, that is not available locally, from an archival location.
     * @param id ID of snapshot. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call createDownloadSnapshotFromCloudAsync(String id, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = createDownloadSnapshotFromCloudValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createExportV1
     * @param id ID of a snapshot. (required)
     * @param exportSnapshotJobConfigV1 Configuration for the export request. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Status of the export request. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createExportV1Call(String id, ExportSnapshotJobConfigV1 exportSnapshotJobConfigV1, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = exportSnapshotJobConfigV1;

        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/{id}/export"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createExportV1ValidateBeforeCall(String id, ExportSnapshotJobConfigV1 exportSnapshotJobConfigV1, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling createExportV1(Async)");
        }

        // verify the required parameter 'exportSnapshotJobConfigV1' is set
        if (exportSnapshotJobConfigV1 == null) {
            throw new ApiException("Missing the required parameter 'exportSnapshotJobConfigV1' when calling createExportV1(Async)");
        }

        return createExportV1Call(id, exportSnapshotJobConfigV1, _callback);
     ...
     */
    public AsyncRequestStatus createExportV1(String id, ExportSnapshotJobConfigV1 exportSnapshotJobConfigV1) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = createExportV1WithHttpInfo(id, exportSnapshotJobConfigV1);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> createExportV1WithHttpInfo(String id, ExportSnapshotJobConfigV1 exportSnapshotJobConfigV1) throws ApiException {
        okhttp3.Call localVarCall = createExportV1ValidateBeforeCall(id, exportSnapshotJobConfigV1, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Export VM snapshot (asynchronously)
     * Export a virtual machine from a snapshot, using a specified hypervisor host as the datastore.
     * @param id ID of a snapshot. (required)
     * @param exportSnapshotJobConfigV1 Configuration for the export request. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createExportV1Async(String id, ExportSnapshotJobConfigV1 exportSnapshotJobConfigV1, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = createExportV1ValidateBeforeCall(id, exportSnapshotJobConfigV1, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createExportWithDownloadFromCloudV1
     * @param id ID of a snapshot. (required)
     * @param exportSnapshotJobConfigV1 Configuration for the export request. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Status of the download request. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createExportWithDownloadFromCloudV1Call(String id, ExportSnapshotJobConfigV1 exportSnapshotJobConfigV1, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/{id}/export_with_download"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createExportWithDownloadFromCloudV1ValidateBeforeCall(String id, ExportSnapshotJobConfigV1 exportSnapshotJobConfigV1, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling createExportWithDownloadFromCloudV1(Async)");
        }

        // verify the required parameter 'exportSnapshotJobConfigV1' is set
        if (exportSnapshotJobConfigV1 == null) {
            throw new ApiException("Missing the required parameter 'exportSnapshotJobConfigV1' when calling createExportWithDownloadFromCloudV1(Async)");
        }

        return createExportWithDownloadFromCloudV1Call(id, exportSnapshotJobConfigV1, _callback);
     ...
     */
    public AsyncRequestStatus createExportWithDownloadFromCloudV1(String id, ExportSnapshotJobConfigV1 exportSnapshotJobConfigV1) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = createExportWithDownloadFromCloudV1WithHttpInfo(id, exportSnapshotJobConfigV1);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> createExportWithDownloadFromCloudV1WithHttpInfo(String id, ExportSnapshotJobConfigV1 exportSnapshotJobConfigV1) throws ApiException {
        okhttp3.Call localVarCall = createExportWithDownloadFromCloudV1ValidateBeforeCall(id, exportSnapshotJobConfigV1, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Download a snapshot from an archival location, then export a virtual machine using the downloaded snapshot (asynchronously)
     * Download a snapshot from an archival location and then export a virtual machine using the downloaded snapshot.
     * @param id ID of a snapshot. (required)
     * @param exportSnapshotJobConfigV1 Configuration for the export request. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createExportWithDownloadFromCloudV1Async(String id, ExportSnapshotJobConfigV1 exportSnapshotJobConfigV1, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = createExportWithDownloadFromCloudV1ValidateBeforeCall(id, exportSnapshotJobConfigV1, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createInstantRecovery
     * @param id ID of Snapshot. (required)
     * @param instantRecoveryJobConfig Configuration for the Instant Recovery request. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Status of the Instant Recovery request. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createInstantRecoveryCall(String id, InstantRecoveryJobConfig instantRecoveryJobConfig, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = instantRecoveryJobConfig;

        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/{id}/instant_recover"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createInstantRecoveryValidateBeforeCall(String id, InstantRecoveryJobConfig instantRecoveryJobConfig, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling createInstantRecovery(Async)");
        }

        // verify the required parameter 'instantRecoveryJobConfig' is set
        if (instantRecoveryJobConfig == null) {
            throw new ApiException("Missing the required parameter 'instantRecoveryJobConfig' when calling createInstantRecovery(Async)");
        }

        return createInstantRecoveryCall(id, instantRecoveryJobConfig, _callback);
     ...
     */
    public AsyncRequestStatus createInstantRecovery(String id, InstantRecoveryJobConfig instantRecoveryJobConfig) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = createInstantRecoveryWithHttpInfo(id, instantRecoveryJobConfig);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> createInstantRecoveryWithHttpInfo(String id, InstantRecoveryJobConfig instantRecoveryJobConfig) throws ApiException {
        okhttp3.Call localVarCall = createInstantRecoveryValidateBeforeCall(id, instantRecoveryJobConfig, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Instantly recover a VM (asynchronously)
     * Instantly recovery a virtual machine from a snapshot. The Instant Recovery request starts the virtual machine with networking enabled and renames and powers off the source virtual machine, if it still exists.
     * @param id ID of Snapshot. (required)
     * @param instantRecoveryJobConfig Configuration for the Instant Recovery request. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createInstantRecoveryAsync(String id, InstantRecoveryJobConfig instantRecoveryJobConfig, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = createInstantRecoveryValidateBeforeCall(id, instantRecoveryJobConfig, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createMountV1
     * @param id ID of a snapshot. (required)
     * @param mountSnapshotJobConfigV1 Configuration for the Live Mount request. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Status of the Live Mount request. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createMountV1Call(String id, MountSnapshotJobConfigV1 mountSnapshotJobConfigV1, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = mountSnapshotJobConfigV1;

        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/{id}/mount"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createMountV1ValidateBeforeCall(String id, MountSnapshotJobConfigV1 mountSnapshotJobConfigV1, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling createMountV1(Async)");
        }

        return createMountV1Call(id, mountSnapshotJobConfigV1, _callback);
     ...
     */
    public AsyncRequestStatus createMountV1(String id, MountSnapshotJobConfigV1 mountSnapshotJobConfigV1) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = createMountV1WithHttpInfo(id, mountSnapshotJobConfigV1);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> createMountV1WithHttpInfo(String id, MountSnapshotJobConfigV1 mountSnapshotJobConfigV1) throws ApiException {
        okhttp3.Call localVarCall = createMountV1ValidateBeforeCall(id, mountSnapshotJobConfigV1, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Live mount a VM from a snapshot (asynchronously)
     * Create a request to Live Mount a virtual machine from a snapshot using a specified configuration.
     * @param id ID of a snapshot. (required)
     * @param mountSnapshotJobConfigV1 Configuration for the Live Mount request. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createMountV1Async(String id, MountSnapshotJobConfigV1 mountSnapshotJobConfigV1, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = createMountV1ValidateBeforeCall(id, mountSnapshotJobConfigV1, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createOnDemandBackup
     * @param id ID of the virtual machine. (required)
     * @param baseOnDemandSnapshotConfig Configuration for the on-demand snapshot. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> On-demand snapshot status. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createOnDemandBackupCall(String id, BaseOnDemandSnapshotConfig baseOnDemandSnapshotConfig, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = baseOnDemandSnapshotConfig;

        // create path and map variables
        String localVarPath = "/vmware/vm/{id}/snapshot"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createOnDemandBackupValidateBeforeCall(String id, BaseOnDemandSnapshotConfig baseOnDemandSnapshotConfig, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling createOnDemandBackup(Async)");
        }

        return createOnDemandBackupCall(id, baseOnDemandSnapshotConfig, _callback);
     ...
     */
    public AsyncRequestStatus createOnDemandBackup(String id, BaseOnDemandSnapshotConfig baseOnDemandSnapshotConfig) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = createOnDemandBackupWithHttpInfo(id, baseOnDemandSnapshotConfig);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> createOnDemandBackupWithHttpInfo(String id, BaseOnDemandSnapshotConfig baseOnDemandSnapshotConfig) throws ApiException {
        okhttp3.Call localVarCall = createOnDemandBackupValidateBeforeCall(id, baseOnDemandSnapshotConfig, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create an on-demand snapshot for a VM (asynchronously)
     * Use the ID of a virtual machine to create an on-demand snapshot.
     * @param id ID of the virtual machine. (required)
     * @param baseOnDemandSnapshotConfig Configuration for the on-demand snapshot. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createOnDemandBackupAsync(String id, BaseOnDemandSnapshotConfig baseOnDemandSnapshotConfig, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = createOnDemandBackupValidateBeforeCall(id, baseOnDemandSnapshotConfig, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createRestoreFileJob
     * @param id ID of a snapshot. (required)
     * @param restoreFileJobConfig Configuration for the restore request. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Status of the restore request. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createRestoreFileJobCall(String id, RestoreFileJobConfig restoreFileJobConfig, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = restoreFileJobConfig;

        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/{id}/restore_file"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createRestoreFileJobValidateBeforeCall(String id, RestoreFileJobConfig restoreFileJobConfig, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling createRestoreFileJob(Async)");
        }

        // verify the required parameter 'restoreFileJobConfig' is set
        if (restoreFileJobConfig == null) {
            throw new ApiException("Missing the required parameter 'restoreFileJobConfig' when calling createRestoreFileJob(Async)");
        }

        return createRestoreFileJobCall(id, restoreFileJobConfig, _callback);
     ...
     */
    public AsyncRequestStatus createRestoreFileJob(String id, RestoreFileJobConfig restoreFileJobConfig) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = createRestoreFileJobWithHttpInfo(id, restoreFileJobConfig);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> createRestoreFileJobWithHttpInfo(String id, RestoreFileJobConfig restoreFileJobConfig) throws ApiException {
        okhttp3.Call localVarCall = createRestoreFileJobValidateBeforeCall(id, restoreFileJobConfig, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Restore file from VM snapshot (asynchronously)
     * Create a request to restore a file or folder to the source virtual machine.
     * @param id ID of a snapshot. (required)
     * @param restoreFileJobConfig Configuration for the restore request. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createRestoreFileJobAsync(String id, RestoreFileJobConfig restoreFileJobConfig, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = createRestoreFileJobValidateBeforeCall(id, restoreFileJobConfig, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for createUnmount
     * @param id ID of a Live Mount. (required)
     * @param force Force unmount to remove metadata when the datastore of the Live Mount virtual machine was moved off of the Rubrik cluster. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Status of the delete request. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createUnmountCall(String id, Boolean force, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/mount/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createUnmountValidateBeforeCall(String id, Boolean force, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling createUnmount(Async)");
        }

        return createUnmountCall(id, force, _callback);
     ...
     */
    public AsyncRequestStatus createUnmount(String id, Boolean force) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = createUnmountWithHttpInfo(id, force);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> createUnmountWithHttpInfo(String id, Boolean force) throws ApiException {
        okhttp3.Call localVarCall = createUnmountValidateBeforeCall(id, force, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Delete a Live Mount VM (asynchronously)
     * Create a request to delete a Live Mount virtual machine.
     * @param id ID of a Live Mount. (required)
     * @param force Force unmount to remove metadata when the datastore of the Live Mount virtual machine was moved off of the Rubrik cluster. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createUnmountAsync(String id, Boolean force, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = createUnmountValidateBeforeCall(id, force, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteVmwareSnapshot
     * @param id ID of snapshot. (required)
     * @param location Location of the snapshot. Use **_local_** to delete only the local copy of the snapshot. Or use **_all_** to delete the snapshot locally, on a replication target, and at an archival location. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Snapshot successfully deleted. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteVmwareSnapshotCall(String id, String location, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteVmwareSnapshotValidateBeforeCall(String id, String location, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteVmwareSnapshot(Async)");
        }

        // verify the required parameter 'location' is set
        if (location == null) {
            throw new ApiException("Missing the required parameter 'location' when calling deleteVmwareSnapshot(Async)");
        }

        return deleteVmwareSnapshotCall(id, location, _callback);
     ...
     */
    public void deleteVmwareSnapshot(String id, String location) throws ApiException {
        deleteVmwareSnapshotWithHttpInfo(id, location);
    }
     ...
     */
    public ApiResponse<Void> deleteVmwareSnapshotWithHttpInfo(String id, String location) throws ApiException {
        okhttp3.Call localVarCall = deleteVmwareSnapshotValidateBeforeCall(id, location, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Delete VM snapshot (asynchronously)
     * Designate a snapshot as expired and available for garbage collection. The snapshot must be an on-demand snapshot or a snapshot from a virtual machine that is not assigned to an SLA Domain.
     * @param id ID of snapshot. (required)
     * @param location Location of the snapshot. Use **_local_** to delete only the local copy of the snapshot. Or use **_all_** to delete the snapshot locally, on a replication target, and at an archival location. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call deleteVmwareSnapshotAsync(String id, String location, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteVmwareSnapshotValidateBeforeCall(id, location, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteVmwareSnapshots
     * @param id Virtual machine ID. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Snapshots successfully deleted. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteVmwareSnapshotsCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteVmwareSnapshotsValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteVmwareSnapshots(Async)");
        }

        return deleteVmwareSnapshotsCall(id, _callback);
     ...
     */
    public void deleteVmwareSnapshots(String id) throws ApiException {
        deleteVmwareSnapshotsWithHttpInfo(id);
    }
     ...
     */
    public ApiResponse<Void> deleteVmwareSnapshotsWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = deleteVmwareSnapshotsValidateBeforeCall(id, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Delete all snapshots of VM (asynchronously)
     * Delete all of the snapshots from a virtual machine.
     * @param id Virtual machine ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteVmwareSnapshotsAsync(String id, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteVmwareSnapshotsValidateBeforeCall(id, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAsyncRequestStatus
     * @param id ID of an asynchronous request. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Status of an asynchronous request. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAsyncRequestStatusCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/request/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAsyncRequestStatusValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getAsyncRequestStatus(Async)");
        }

        return getAsyncRequestStatusCall(id, _callback);
     ...
     */
    public AsyncRequestStatus getAsyncRequestStatus(String id) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = getAsyncRequestStatusWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> getAsyncRequestStatusWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getAsyncRequestStatusValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get asynchronous request details for VM (asynchronously)
     * Get the details of an asynchronous request that involves a VMware virtual machine.
     * @param id ID of an asynchronous request. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getAsyncRequestStatusAsync(String id, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAsyncRequestStatusValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getMountV1
     * @param id ID of a Live Mount. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Detailed information for the specified Live Mount. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getMountV1Call(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMountV1ValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getMountV1(Async)");
        }

        return getMountV1Call(id, _callback);
     ...
     */
    public VmwareVmMountDetailV1 getMountV1(String id) throws ApiException {
        ApiResponse<VmwareVmMountDetailV1> localVarResp = getMountV1WithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Retrieve detailed information for a specified Live Mount.
     * @param id ID of a Live Mount. (required)
     * @return ApiResponse&lt;VmwareVmMountDetailV1&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VmwareVmMountDetailV1> getMountV1WithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getMountV1ValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<VmwareVmMountDetailV1>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get information for a Live Mount (asynchronously)
     * Retrieve detailed information for a specified Live Mount.
     * @param id ID of a Live Mount. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getMountV1Async(String id, final ApiCallback<VmwareVmMountDetailV1> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMountV1ValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<VmwareVmMountDetailV1>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Snapshot details. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getSnapshotCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSnapshotValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
     ...
     */
    public VmSnapshotDetail getSnapshot(String id) throws ApiException {
        ApiResponse<VmSnapshotDetail> localVarResp = getSnapshotWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Retrieve detailed information about a virtual machine snapshot.
     * @param id ID of a snapshot. (required)
     * @return ApiResponse&lt;VmSnapshotDetail&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VmSnapshotDetail> getSnapshotWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSnapshotValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<VmSnapshotDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get VM snapshot details (asynchronously)
     * Retrieve detailed information about a virtual machine snapshot.
     * @param id ID of a snapshot. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getSnapshotAsync(String id, final ApiCallback<VmSnapshotDetail> _callback) throws ApiException {
    ...
    /**
     * Build call for getVirtualDisk
     * @param id ID of the Virtual Disk. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Return details about the virtual disk. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getVirtualDiskCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/virtual_disk/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVirtualDiskValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getVirtualDisk(Async)");
        }

        return getVirtualDiskCall(id, _callback);
     ...
     */
    public VirtualDiskDetail getVirtualDisk(String id) throws ApiException {
        ApiResponse<VirtualDiskDetail> localVarResp = getVirtualDiskWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Detailed about the specific Virtual Disk.
     * @param id ID of the Virtual Disk. (required)
     * @return ApiResponse&lt;VirtualDiskDetail&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VirtualDiskDetail> getVirtualDiskWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getVirtualDiskValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<VirtualDiskDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Details about the specific Virtual Disk (asynchronously)
     * Detailed about the specific Virtual Disk.
     * @param id ID of the Virtual Disk. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getVirtualDiskAsync(String id, final ApiCallback<VirtualDiskDetail> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVirtualDiskValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<VirtualDiskDetail>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Virtual machine details. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getVmCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
     ...
     */
    public VirtualMachineDetail getVm(String id) throws ApiException {
        ApiResponse<VirtualMachineDetail> localVarResp = getVmWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Retrieve details for a virtual machine.
     * @param id ID of the virtual machine. (required)
     * @return ApiResponse&lt;VirtualMachineDetail&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VirtualMachineDetail> getVmWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getVmValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<VirtualMachineDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get VM details (asynchronously)
     * Retrieve details for a virtual machine.
     * @param id ID of the virtual machine. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getVmAsync(String id, final ApiCallback<VirtualMachineDetail> _callback) throws ApiException {
    ...
    /**
     * Build call for getVmForceFullSpec
     * @param id ID of the VMware virtual machine. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Return the configuration for forcing a full snapshot for the VMware virtual machine. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getVmForceFullSpecCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/{id}/request/force_full_snapshot"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVmForceFullSpecValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getVmForceFullSpec(Async)");
        }

        return getVmForceFullSpecCall(id, _callback);
     ...
     */
    public VmForceFullResponse getVmForceFullSpec(String id) throws ApiException {
        ApiResponse<VmForceFullResponse> localVarResp = getVmForceFullSpecWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Retrieve the configuration that has been set for forcing a full snapshot for a VMware virtual machine.
     * @param id ID of the VMware virtual machine. (required)
     * @return ApiResponse&lt;VmForceFullResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VmForceFullResponse> getVmForceFullSpecWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getVmForceFullSpecValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<VmForceFullResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve the configuration for forcing a full snapshot of a VMware virtual machine (asynchronously)
     * Retrieve the configuration that has been set for forcing a full snapshot for a VMware virtual machine.
     * @param id ID of the VMware virtual machine. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getVmForceFullSpecAsync(String id, final ApiCallback<VmForceFullResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVmForceFullSpecValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<VmForceFullResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getVmwareCdpLiveInfo
     * @param requestBody The ID of each CDP-enabled virtual machine for which live info is being retrieved. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns the live CDP info for the CDP-enabled virtual machines. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getVmwareCdpLiveInfoCall(List<String> requestBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/cdp";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVmwareCdpLiveInfoValidateBeforeCall(List<String> requestBody, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
            throw new ApiException("Missing the required parameter 'requestBody' when calling getVmwareCdpLiveInfo(Async)");
        }

        return getVmwareCdpLiveInfoCall(requestBody, _callback);
     ...
     */
    public BatchVmwareCdpLiveInfo getVmwareCdpLiveInfo(List<String> requestBody) throws ApiException {
        ApiResponse<BatchVmwareCdpLiveInfo> localVarResp = getVmwareCdpLiveInfoWithHttpInfo(requestBody);
        return localVarResp.getData();
    }
     ...
     * 
     * @param requestBody The ID of each CDP-enabled virtual machine for which live info is being retrieved. (required)
     * @return ApiResponse&lt;BatchVmwareCdpLiveInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BatchVmwareCdpLiveInfo> getVmwareCdpLiveInfoWithHttpInfo(List<String> requestBody) throws ApiException {
        okhttp3.Call localVarCall = getVmwareCdpLiveInfoValidateBeforeCall(requestBody, null);
        Type localVarReturnType = new TypeToken<BatchVmwareCdpLiveInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Returns the live CDP info for a set of CDP-enabled virtual machines (asynchronously)
     * 
     * @param requestBody The ID of each CDP-enabled virtual machine for which live info is being retrieved. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getVmwareCdpLiveInfoAsync(List<String> requestBody, final ApiCallback<BatchVmwareCdpLiveInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVmwareCdpLiveInfoValidateBeforeCall(requestBody, _callback);
        Type localVarReturnType = new TypeToken<BatchVmwareCdpLiveInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getVmwareCdpStateInfo
     * @param requestBody The ID of each virtual machine for which CDP state info is being retrieved. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns CDP state info for the virtual machines. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getVmwareCdpStateInfoCall(List<String> requestBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/cdp_state";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVmwareCdpStateInfoValidateBeforeCall(List<String> requestBody, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
            throw new ApiException("Missing the required parameter 'requestBody' when calling getVmwareCdpStateInfo(Async)");
        }

        return getVmwareCdpStateInfoCall(requestBody, _callback);
     ...
     * 
     * @param requestBody The ID of each virtual machine for which CDP state info is being retrieved. (required)
     * @return BatchVmwareCdpStateInfo
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BatchVmwareCdpStateInfo getVmwareCdpStateInfo(List<String> requestBody) throws ApiException {
        ApiResponse<BatchVmwareCdpStateInfo> localVarResp = getVmwareCdpStateInfoWithHttpInfo(requestBody);
        return localVarResp.getData();
    }
     ...
     * 
     * @param requestBody The ID of each virtual machine for which CDP state info is being retrieved. (required)
     * @return ApiResponse&lt;BatchVmwareCdpStateInfo&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BatchVmwareCdpStateInfo> getVmwareCdpStateInfoWithHttpInfo(List<String> requestBody) throws ApiException {
        okhttp3.Call localVarCall = getVmwareCdpStateInfoValidateBeforeCall(requestBody, null);
        Type localVarReturnType = new TypeToken<BatchVmwareCdpStateInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Returns CDP state info for a set of virtual machines (asynchronously)
     * 
     * @param requestBody The ID of each virtual machine for which CDP state info is being retrieved. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getVmwareCdpStateInfoAsync(List<String> requestBody, final ApiCallback<BatchVmwareCdpStateInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVmwareCdpStateInfoValidateBeforeCall(requestBody, _callback);
        Type localVarReturnType = new TypeToken<BatchVmwareCdpStateInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getVmwareMissedRecoverableRanges
     * @param id The virtual machine ID. (required)
     * @param afterTime Filter ranges to end after this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     * @param beforeTime Filter ranges to start before this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns the missed recoverable ranges for the virtual machine. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getVmwareMissedRecoverableRangesCall(String id, OffsetDateTime afterTime, OffsetDateTime beforeTime, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/{id}/missed_recoverable_range"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
        ...
        if (afterTime != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("after_time", afterTime));
        }

        if (beforeTime != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("before_time", beforeTime));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVmwareMissedRecoverableRangesValidateBeforeCall(String id, OffsetDateTime afterTime, OffsetDateTime beforeTime, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getVmwareMissedRecoverableRanges(Async)");
        }

        return getVmwareMissedRecoverableRangesCall(id, afterTime, beforeTime, _callback);
     ...
     * @param afterTime Filter ranges to end after this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     * @param beforeTime Filter ranges to start before this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     * @return VmwareRecoverableRangeListResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public VmwareRecoverableRangeListResponse getVmwareMissedRecoverableRanges(String id, OffsetDateTime afterTime, OffsetDateTime beforeTime) throws ApiException {
        ApiResponse<VmwareRecoverableRangeListResponse> localVarResp = getVmwareMissedRecoverableRangesWithHttpInfo(id, afterTime, beforeTime);
        return localVarResp.getData();
    }
     ...
     * @param afterTime Filter ranges to end after this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     * @param beforeTime Filter ranges to start before this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     * @return ApiResponse&lt;VmwareRecoverableRangeListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VmwareRecoverableRangeListResponse> getVmwareMissedRecoverableRangesWithHttpInfo(String id, OffsetDateTime afterTime, OffsetDateTime beforeTime) throws ApiException {
        okhttp3.Call localVarCall = getVmwareMissedRecoverableRangesValidateBeforeCall(id, afterTime, beforeTime, null);
        Type localVarReturnType = new TypeToken<VmwareRecoverableRangeListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get missed time ranges for point in time recovery (asynchronously)
     * Gets a list of time ranges to which a CDP-enabled virtual machine cannot perform a point-in-time recovery. The time ranges are indicated by start and end timestamps listed as date-time strings.
     * @param id The virtual machine ID. (required)
     * @param afterTime Filter ranges to end after this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     * @param beforeTime Filter ranges to start before this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     ...
     */
    public okhttp3.Call getVmwareMissedRecoverableRangesAsync(String id, OffsetDateTime afterTime, OffsetDateTime beforeTime, final ApiCallback<VmwareRecoverableRangeListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVmwareMissedRecoverableRangesValidateBeforeCall(id, afterTime, beforeTime, _callback);
        Type localVarReturnType = new TypeToken<VmwareRecoverableRangeListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getVmwareRecoverableRanges
     * @param id The virtual machine ID. (required)
     * @param afterTime Filter ranges to end after this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     * @param beforeTime Filter ranges to start before this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     * @param _callback Callback for upload/download progress
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns the recoverable ranges for the virtual machine. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getVmwareRecoverableRangesCall(String id, OffsetDateTime afterTime, OffsetDateTime beforeTime, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/{id}/recoverable_range"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVmwareRecoverableRangesValidateBeforeCall(String id, OffsetDateTime afterTime, OffsetDateTime beforeTime, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getVmwareRecoverableRanges(Async)");
        }

        return getVmwareRecoverableRangesCall(id, afterTime, beforeTime, _callback);
     ...
     */
    public VmwareRecoverableRangeListResponse getVmwareRecoverableRanges(String id, OffsetDateTime afterTime, OffsetDateTime beforeTime) throws ApiException {
        ApiResponse<VmwareRecoverableRangeListResponse> localVarResp = getVmwareRecoverableRangesWithHttpInfo(id, afterTime, beforeTime);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VmwareRecoverableRangeListResponse> getVmwareRecoverableRangesWithHttpInfo(String id, OffsetDateTime afterTime, OffsetDateTime beforeTime) throws ApiException {
        okhttp3.Call localVarCall = getVmwareRecoverableRangesValidateBeforeCall(id, afterTime, beforeTime, null);
        Type localVarReturnType = new TypeToken<VmwareRecoverableRangeListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get available time ranges for point in time recovery (asynchronously)
     * Gets time ranges available for point-in-time recovery. The time ranges are indicated by start and end date-time strings.
     * @param id The virtual machine ID. (required)
     * @param afterTime Filter ranges to end after this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     * @param beforeTime Filter ranges to start before this time. The date-time string should be in ISO8601 format, such as &#x60;2018-01-01T01:23:45.678Z&#x60;. (optional)
     ...
     */
    public okhttp3.Call getVmwareRecoverableRangesAsync(String id, OffsetDateTime afterTime, OffsetDateTime beforeTime, final ApiCallback<VmwareRecoverableRangeListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVmwareRecoverableRangesValidateBeforeCall(id, afterTime, beforeTime, _callback);
        Type localVarReturnType = new TypeToken<VmwareRecoverableRangeListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getVmwareVmMissedRecoverableRangesInBatch
     * @param batchVmwareVmMissedRecoverableRangesRequest The batch request and the date ranges (optional) as a filter. The batch request includes the ID of each CDP-enabled virtual machine for which missed recoverable ranges are being retrieved. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns the missed recoverable ranges for a set of CDP-enabled virtual machines. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getVmwareVmMissedRecoverableRangesInBatchCall(BatchVmwareVmMissedRecoverableRangesRequest batchVmwareVmMissedRecoverableRangesRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = batchVmwareVmMissedRecoverableRangesRequest;

        // create path and map variables
        String localVarPath = "/vmware/vm/missed_recoverable_range";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVmwareVmMissedRecoverableRangesInBatchValidateBeforeCall(BatchVmwareVmMissedRecoverableRangesRequest batchVmwareVmMissedRecoverableRangesRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'batchVmwareVmMissedRecoverableRangesRequest' is set
        if (batchVmwareVmMissedRecoverableRangesRequest == null) {
            throw new ApiException("Missing the required parameter 'batchVmwareVmMissedRecoverableRangesRequest' when calling getVmwareVmMissedRecoverableRangesInBatch(Async)");
        }

        return getVmwareVmMissedRecoverableRangesInBatchCall(batchVmwareVmMissedRecoverableRangesRequest, _callback);
     ...
     * 
     * @param batchVmwareVmMissedRecoverableRangesRequest The batch request and the date ranges (optional) as a filter. The batch request includes the ID of each CDP-enabled virtual machine for which missed recoverable ranges are being retrieved. (required)
     * @return BatchVmwareVmMissedRecoverableRanges
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BatchVmwareVmMissedRecoverableRanges getVmwareVmMissedRecoverableRangesInBatch(BatchVmwareVmMissedRecoverableRangesRequest batchVmwareVmMissedRecoverableRangesRequest) throws ApiException {
        ApiResponse<BatchVmwareVmMissedRecoverableRanges> localVarResp = getVmwareVmMissedRecoverableRangesInBatchWithHttpInfo(batchVmwareVmMissedRecoverableRangesRequest);
        return localVarResp.getData();
    }
     ...
     * 
     * @param batchVmwareVmMissedRecoverableRangesRequest The batch request and the date ranges (optional) as a filter. The batch request includes the ID of each CDP-enabled virtual machine for which missed recoverable ranges are being retrieved. (required)
     * @return ApiResponse&lt;BatchVmwareVmMissedRecoverableRanges&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BatchVmwareVmMissedRecoverableRanges> getVmwareVmMissedRecoverableRangesInBatchWithHttpInfo(BatchVmwareVmMissedRecoverableRangesRequest batchVmwareVmMissedRecoverableRangesRequest) throws ApiException {
        okhttp3.Call localVarCall = getVmwareVmMissedRecoverableRangesInBatchValidateBeforeCall(batchVmwareVmMissedRecoverableRangesRequest, null);
        Type localVarReturnType = new TypeToken<BatchVmwareVmMissedRecoverableRanges>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Returns the recoverable ranges that were missed for a set of CDP-enabled virtual machines (asynchronously)
     * 
     * @param batchVmwareVmMissedRecoverableRangesRequest The batch request and the date ranges (optional) as a filter. The batch request includes the ID of each CDP-enabled virtual machine for which missed recoverable ranges are being retrieved. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getVmwareVmMissedRecoverableRangesInBatchAsync(BatchVmwareVmMissedRecoverableRangesRequest batchVmwareVmMissedRecoverableRangesRequest, final ApiCallback<BatchVmwareVmMissedRecoverableRanges> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVmwareVmMissedRecoverableRangesInBatchValidateBeforeCall(batchVmwareVmMissedRecoverableRangesRequest, _callback);
        Type localVarReturnType = new TypeToken<BatchVmwareVmMissedRecoverableRanges>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getVmwareVmRecoverableRangesInBatch
     * @param batchVmwareVmRecoverableRangesRequest The batch request, which includes the ID of each CDP-enabled virtual machine for which recoverable ranges are being retrieved, and optionally the date ranges as a filter. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns the recoverable ranges for a set of CDP-enabled virtual machines. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getVmwareVmRecoverableRangesInBatchCall(BatchVmwareVmRecoverableRangesRequest batchVmwareVmRecoverableRangesRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = batchVmwareVmRecoverableRangesRequest;

        // create path and map variables
        String localVarPath = "/vmware/vm/recoverable_range";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVmwareVmRecoverableRangesInBatchValidateBeforeCall(BatchVmwareVmRecoverableRangesRequest batchVmwareVmRecoverableRangesRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'batchVmwareVmRecoverableRangesRequest' is set
        if (batchVmwareVmRecoverableRangesRequest == null) {
            throw new ApiException("Missing the required parameter 'batchVmwareVmRecoverableRangesRequest' when calling getVmwareVmRecoverableRangesInBatch(Async)");
        }

        return getVmwareVmRecoverableRangesInBatchCall(batchVmwareVmRecoverableRangesRequest, _callback);
     ...
     */
    public BatchVmwareVmRecoverableRanges getVmwareVmRecoverableRangesInBatch(BatchVmwareVmRecoverableRangesRequest batchVmwareVmRecoverableRangesRequest) throws ApiException {
        ApiResponse<BatchVmwareVmRecoverableRanges> localVarResp = getVmwareVmRecoverableRangesInBatchWithHttpInfo(batchVmwareVmRecoverableRangesRequest);
        return localVarResp.getData();
    }
     ...
     * 
     * @param batchVmwareVmRecoverableRangesRequest The batch request, which includes the ID of each CDP-enabled virtual machine for which recoverable ranges are being retrieved, and optionally the date ranges as a filter. (required)
     * @return ApiResponse&lt;BatchVmwareVmRecoverableRanges&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BatchVmwareVmRecoverableRanges> getVmwareVmRecoverableRangesInBatchWithHttpInfo(BatchVmwareVmRecoverableRangesRequest batchVmwareVmRecoverableRangesRequest) throws ApiException {
        okhttp3.Call localVarCall = getVmwareVmRecoverableRangesInBatchValidateBeforeCall(batchVmwareVmRecoverableRangesRequest, null);
        Type localVarReturnType = new TypeToken<BatchVmwareVmRecoverableRanges>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Returns the recoverable ranges for a set of CDP-enabled virtual machines (asynchronously)
     * 
     * @param batchVmwareVmRecoverableRangesRequest The batch request, which includes the ID of each CDP-enabled virtual machine for which recoverable ranges are being retrieved, and optionally the date ranges as a filter. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getVmwareVmRecoverableRangesInBatchAsync(BatchVmwareVmRecoverableRangesRequest batchVmwareVmRecoverableRangesRequest, final ApiCallback<BatchVmwareVmRecoverableRanges> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVmwareVmRecoverableRangesInBatchValidateBeforeCall(batchVmwareVmRecoverableRangesRequest, _callback);
        Type localVarReturnType = new TypeToken<BatchVmwareVmRecoverableRanges>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for missedSnapshots
     * @param id ID of a virtual machine. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Missed snapshot details for a virtual machine. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call missedSnapshotsCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/{id}/missed_snapshot"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call missedSnapshotsValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling missedSnapshots(Async)");
        }

        return missedSnapshotsCall(id, _callback);
     ...
     * @param id ID of a virtual machine. (required)
     * @return MissedSnapshotListResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public MissedSnapshotListResponse missedSnapshots(String id) throws ApiException {
        ApiResponse<MissedSnapshotListResponse> localVarResp = missedSnapshotsWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Retrieve details about the missed snapshots for a virtual machine.
     * @param id ID of a virtual machine. (required)
     * @return ApiResponse&lt;MissedSnapshotListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<MissedSnapshotListResponse> missedSnapshotsWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = missedSnapshotsValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<MissedSnapshotListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get details about missed snapshots for a VM (asynchronously)
     * Retrieve details about the missed snapshots for a virtual machine.
     * @param id ID of a virtual machine. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call missedSnapshotsAsync(String id, final ApiCallback<MissedSnapshotListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = missedSnapshotsValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<MissedSnapshotListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for queryMountV1
     * @param vmId Filters information by virtual machine ID. (optional)
     * @param offset Starting position in the list of Live Mount entries contained in the response. The summary information includes the specified numbered entry and all higher numbered entries. Use with **_limit_** to retrieve the summary information as smaller groups of entries, e.g. for paging of the results. (optional)
     * @param limit Limit the summary information to a specified maximum number of entries. Optionally, use with **_offset_** to start the count at a specified point. Default is 25. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Summary information for all Live Mounts. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call queryMountV1Call(String vmId, Integer offset, Integer limit, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/mount";
        ...
        if (vmId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("vm_id", vmId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryMountV1ValidateBeforeCall(String vmId, Integer offset, Integer limit, final ApiCallback _callback) throws ApiException {
        return queryMountV1Call(vmId, offset, limit, _callback);
     ...
     * @param offset Starting position in the list of Live Mount entries contained in the response. The summary information includes the specified numbered entry and all higher numbered entries. Use with **_limit_** to retrieve the summary information as smaller groups of entries, e.g. for paging of the results. (optional)
     * @param limit Limit the summary information to a specified maximum number of entries. Optionally, use with **_offset_** to start the count at a specified point. Default is 25. (optional)
     * @return VmwareVmMountSummaryV1ListResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public VmwareVmMountSummaryV1ListResponse queryMountV1(String vmId, Integer offset, Integer limit) throws ApiException {
        ApiResponse<VmwareVmMountSummaryV1ListResponse> localVarResp = queryMountV1WithHttpInfo(vmId, offset, limit);
        return localVarResp.getData();
    }
     ...
     * @param offset Starting position in the list of Live Mount entries contained in the response. The summary information includes the specified numbered entry and all higher numbered entries. Use with **_limit_** to retrieve the summary information as smaller groups of entries, e.g. for paging of the results. (optional)
     * @param limit Limit the summary information to a specified maximum number of entries. Optionally, use with **_offset_** to start the count at a specified point. Default is 25. (optional)
     * @return ApiResponse&lt;VmwareVmMountSummaryV1ListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VmwareVmMountSummaryV1ListResponse> queryMountV1WithHttpInfo(String vmId, Integer offset, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = queryMountV1ValidateBeforeCall(vmId, offset, limit, null);
        Type localVarReturnType = new TypeToken<VmwareVmMountSummaryV1ListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Live Mount information (asynchronously)
     * Retrieve summary information about Live Mount activity.
     * @param vmId Filters information by virtual machine ID. (optional)
     * @param offset Starting position in the list of Live Mount entries contained in the response. The summary information includes the specified numbered entry and all higher numbered entries. Use with **_limit_** to retrieve the summary information as smaller groups of entries, e.g. for paging of the results. (optional)
     * @param limit Limit the summary information to a specified maximum number of entries. Optionally, use with **_offset_** to start the count at a specified point. Default is 25. (optional)
     ...
     */
    public okhttp3.Call queryMountV1Async(String vmId, Integer offset, Integer limit, final ApiCallback<VmwareVmMountSummaryV1ListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryMountV1ValidateBeforeCall(vmId, offset, limit, _callback);
        Type localVarReturnType = new TypeToken<VmwareVmMountSummaryV1ListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for querySnapshot
     * @param id ID of the virtual machine. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Summary snapshot information for a virtual machine. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call querySnapshotCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call querySnapshotValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling querySnapshot(Async)");
        }

        return querySnapshotCall(id, _callback);
     ...
     * @param id ID of the virtual machine. (required)
     * @return VmSnapshotSummaryListResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public VmSnapshotSummaryListResponse querySnapshot(String id) throws ApiException {
        ApiResponse<VmSnapshotSummaryListResponse> localVarResp = querySnapshotWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Retrieve summary information for the snapshots of a virtual machine.
     * @param id ID of the virtual machine. (required)
     * @return ApiResponse&lt;VmSnapshotSummaryListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VmSnapshotSummaryListResponse> querySnapshotWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = querySnapshotValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<VmSnapshotSummaryListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get list of snapshots of VM (asynchronously)
     * Retrieve summary information for the snapshots of a virtual machine.
     * @param id ID of the virtual machine. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call querySnapshotAsync(String id, final ApiCallback<VmSnapshotSummaryListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = querySnapshotValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<VmSnapshotSummaryListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for querySnapshotsForVms
     * @param requestBody IDs of the virtual machines. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Snapshot summaries for a list of virtual machines. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call querySnapshotsForVmsCall(List<String> requestBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/snapshots";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call querySnapshotsForVmsValidateBeforeCall(List<String> requestBody, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
            throw new ApiException("Missing the required parameter 'requestBody' when calling querySnapshotsForVms(Async)");
        }

        return querySnapshotsForVmsCall(requestBody, _callback);
     ...
     * @param requestBody IDs of the virtual machines. (required)
     * @return BatchVmSnapshotSummaries
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BatchVmSnapshotSummaries querySnapshotsForVms(List<String> requestBody) throws ApiException {
        ApiResponse<BatchVmSnapshotSummaries> localVarResp = querySnapshotsForVmsWithHttpInfo(requestBody);
        return localVarResp.getData();
    }
     ...
     * Retrieve snapshot summaries for a list of virtual machines.
     * @param requestBody IDs of the virtual machines. (required)
     * @return ApiResponse&lt;BatchVmSnapshotSummaries&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BatchVmSnapshotSummaries> querySnapshotsForVmsWithHttpInfo(List<String> requestBody) throws ApiException {
        okhttp3.Call localVarCall = querySnapshotsForVmsValidateBeforeCall(requestBody, null);
        Type localVarReturnType = new TypeToken<BatchVmSnapshotSummaries>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get snapshot information for a list of virtual machines (asynchronously)
     * Retrieve snapshot summaries for a list of virtual machines.
     * @param requestBody IDs of the virtual machines. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call querySnapshotsForVmsAsync(List<String> requestBody, final ApiCallback<BatchVmSnapshotSummaries> _callback) throws ApiException {

        okhttp3.Call localVarCall = querySnapshotsForVmsValidateBeforeCall(requestBody, _callback);
        Type localVarReturnType = new TypeToken<BatchVmSnapshotSummaries>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for queryVm
     * @param effectiveSlaDomainId Filter by ID of effective SLA Domain. (optional)
     * @param primaryClusterId Filter by primary cluster ID, or **local**. (optional)
     * @param limit Limit the number of matches returned. (optional)
     * @param offset Ignore these many matches in the beginning. (optional)
     * @param isRelic Filter by the isRelic field of the virtual machine. When this parameter is not set, return both relic and non-relic virtual machines. (optional)
     * @param name Search by using a virtual machine name. (optional)
     * @param moid Search by using a virtual machine managed object ID. (optional)
     * @param slaAssignment Filter by SLA Domain assignment type. (optional)
     * @param guestOsName Filters by the name of operating system using infix search. (optional)
     * @param sortBy Sort results based on the specified attribute. (optional)
     * @param sortOrder Sort order, either ascending or descending. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Virtual machine summary. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call queryVmCall(String effectiveSlaDomainId, String primaryClusterId, Integer limit, Integer offset, Boolean isRelic, String name, String moid, String slaAssignment, String guestOsName, String sortBy, String sortOrder, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (effectiveSlaDomainId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("effective_sla_domain_id", effectiveSlaDomainId));
        }

        if (primaryClusterId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("primary_cluster_id", primaryClusterId));
        }
        ...
        if (isRelic != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("is_relic", isRelic));
        }
        ...
        if (moid != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("moid", moid));
        }

        if (slaAssignment != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("sla_assignment", slaAssignment));
        }

        if (guestOsName != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("guest_os_name", guestOsName));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryVmValidateBeforeCall(String effectiveSlaDomainId, String primaryClusterId, Integer limit, Integer offset, Boolean isRelic, String name, String moid, String slaAssignment, String guestOsName, String sortBy, String sortOrder, final ApiCallback _callback) throws ApiException {
        return queryVmCall(effectiveSlaDomainId, primaryClusterId, limit, offset, isRelic, name, moid, slaAssignment, guestOsName, sortBy, sortOrder, _callback);
     ...
     * @param sortBy Sort results based on the specified attribute. (optional)
     * @param sortOrder Sort order, either ascending or descending. (optional)
     * @return VirtualMachineSummaryListResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public VirtualMachineSummaryListResponse queryVm(String effectiveSlaDomainId, String primaryClusterId, Integer limit, Integer offset, Boolean isRelic, String name, String moid, String slaAssignment, String guestOsName, String sortBy, String sortOrder) throws ApiException {
        ApiResponse<VirtualMachineSummaryListResponse> localVarResp = queryVmWithHttpInfo(effectiveSlaDomainId, primaryClusterId, limit, offset, isRelic, name, moid, slaAssignment, guestOsName, sortBy, sortOrder);
        return localVarResp.getData();
    }
     ...
     * @param sortBy Sort results based on the specified attribute. (optional)
     * @param sortOrder Sort order, either ascending or descending. (optional)
     * @return ApiResponse&lt;VirtualMachineSummaryListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VirtualMachineSummaryListResponse> queryVmWithHttpInfo(String effectiveSlaDomainId, String primaryClusterId, Integer limit, Integer offset, Boolean isRelic, String name, String moid, String slaAssignment, String guestOsName, String sortBy, String sortOrder) throws ApiException {
        okhttp3.Call localVarCall = queryVmValidateBeforeCall(effectiveSlaDomainId, primaryClusterId, limit, offset, isRelic, name, moid, slaAssignment, guestOsName, sortBy, sortOrder, null);
        Type localVarReturnType = new TypeToken<VirtualMachineSummaryListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get list of VMs (asynchronously)
     * Get summary of all the VMs.
     * @param effectiveSlaDomainId Filter by ID of effective SLA Domain. (optional)
     * @param primaryClusterId Filter by primary cluster ID, or **local**. (optional)
     * @param limit Limit the number of matches returned. (optional)
     ...
     */
    public okhttp3.Call queryVmAsync(String effectiveSlaDomainId, String primaryClusterId, Integer limit, Integer offset, Boolean isRelic, String name, String moid, String slaAssignment, String guestOsName, String sortBy, String sortOrder, final ApiCallback<VirtualMachineSummaryListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryVmValidateBeforeCall(effectiveSlaDomainId, primaryClusterId, limit, offset, isRelic, name, moid, slaAssignment, guestOsName, sortBy, sortOrder, _callback);
        Type localVarReturnType = new TypeToken<VirtualMachineSummaryListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for relocateMount
     * @param id ID of the live mount. (required)
     * @param relocateMountConfig Configuration for the RelocateMount request to another data store. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Status of an asynchronous request to migrate datastore. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call relocateMountCall(String id, RelocateMountConfig relocateMountConfig, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = relocateMountConfig;

        // create path and map variables
        String localVarPath = "/vmware/vm/snapshot/mount/{id}/relocate"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call relocateMountValidateBeforeCall(String id, RelocateMountConfig relocateMountConfig, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling relocateMount(Async)");
        }

        // verify the required parameter 'relocateMountConfig' is set
        if (relocateMountConfig == null) {
            throw new ApiException("Missing the required parameter 'relocateMountConfig' when calling relocateMount(Async)");
        }

        return relocateMountCall(id, relocateMountConfig, _callback);
     ...
     */
    public AsyncRequestStatus relocateMount(String id, RelocateMountConfig relocateMountConfig) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = relocateMountWithHttpInfo(id, relocateMountConfig);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> relocateMountWithHttpInfo(String id, RelocateMountConfig relocateMountConfig) throws ApiException {
        okhttp3.Call localVarCall = relocateMountValidateBeforeCall(id, relocateMountConfig, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Relocate a virtual machine to another datastore (asynchronously)
     * Run storage VMotion to relocate a specified Live Mount into another data store.
     * @param id ID of the live mount. (required)
     * @param relocateMountConfig Configuration for the RelocateMount request to another data store. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call relocateMountAsync(String id, RelocateMountConfig relocateMountConfig, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = relocateMountValidateBeforeCall(id, relocateMountConfig, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for requestVmForceFullSnapshot
     * @param id ID of the VMware virtual machine. (required)
     * @param vmForceFullRequest Configuration for forcing a full snapshot on the VMware virtual machine. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returns the response to the request for a forced full snapshot. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call requestVmForceFullSnapshotCall(String id, VmForceFullRequest vmForceFullRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = vmForceFullRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call requestVmForceFullSnapshotValidateBeforeCall(String id, VmForceFullRequest vmForceFullRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling requestVmForceFullSnapshot(Async)");
        }

        // verify the required parameter 'vmForceFullRequest' is set
        if (vmForceFullRequest == null) {
            throw new ApiException("Missing the required parameter 'vmForceFullRequest' when calling requestVmForceFullSnapshot(Async)");
        }

        return requestVmForceFullSnapshotCall(id, vmForceFullRequest, _callback);
     ...
     */
    public VmForceFullResponse requestVmForceFullSnapshot(String id, VmForceFullRequest vmForceFullRequest) throws ApiException {
        ApiResponse<VmForceFullResponse> localVarResp = requestVmForceFullSnapshotWithHttpInfo(id, vmForceFullRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VmForceFullResponse> requestVmForceFullSnapshotWithHttpInfo(String id, VmForceFullRequest vmForceFullRequest) throws ApiException {
        okhttp3.Call localVarCall = requestVmForceFullSnapshotValidateBeforeCall(id, vmForceFullRequest, null);
        Type localVarReturnType = new TypeToken<VmForceFullResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Request a full snapshot for the next backup job of a VMware virtual machine (asynchronously)
     * Request a full snapshot to be taken for the next backup job of a VMware virtual machine.
     * @param id ID of the VMware virtual machine. (required)
     * @param vmForceFullRequest Configuration for forcing a full snapshot on the VMware virtual machine. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call requestVmForceFullSnapshotAsync(String id, VmForceFullRequest vmForceFullRequest, final ApiCallback<VmForceFullResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = requestVmForceFullSnapshotValidateBeforeCall(id, vmForceFullRequest, _callback);
        Type localVarReturnType = new TypeToken<VmForceFullResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for runGuestOsScript
     * @param id ID of the virtual machine. (required)
     * @param vmGuestScriptRunConfig Configuration used to run the specified preBackup, postSnap, or postBackup guest OS script. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Guest OS script ran successfully and returned a 0 exit code. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call runGuestOsScriptCall(String id, VmGuestScriptRunConfig vmGuestScriptRunConfig, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = vmGuestScriptRunConfig;

        // create path and map variables
        String localVarPath = "/vmware/vm/{id}/guest_script/run"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call runGuestOsScriptValidateBeforeCall(String id, VmGuestScriptRunConfig vmGuestScriptRunConfig, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling runGuestOsScript(Async)");
        }

        // verify the required parameter 'vmGuestScriptRunConfig' is set
        if (vmGuestScriptRunConfig == null) {
            throw new ApiException("Missing the required parameter 'vmGuestScriptRunConfig' when calling runGuestOsScript(Async)");
        }

        return runGuestOsScriptCall(id, vmGuestScriptRunConfig, _callback);
     ...
     */
    public void runGuestOsScript(String id, VmGuestScriptRunConfig vmGuestScriptRunConfig) throws ApiException {
        runGuestOsScriptWithHttpInfo(id, vmGuestScriptRunConfig);
    }
     ...
     */
    public ApiResponse<Void> runGuestOsScriptWithHttpInfo(String id, VmGuestScriptRunConfig vmGuestScriptRunConfig) throws ApiException {
        okhttp3.Call localVarCall = runGuestOsScriptValidateBeforeCall(id, vmGuestScriptRunConfig, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Run guest OS script (asynchronously)
     * Run the specified preBackup, postSnap, or postBackup script in the guest OS of a virtual machine. The script must exist and meet requirements.
     * @param id ID of the virtual machine. (required)
     * @param vmGuestScriptRunConfig Configuration used to run the specified preBackup, postSnap, or postBackup guest OS script. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call runGuestOsScriptAsync(String id, VmGuestScriptRunConfig vmGuestScriptRunConfig, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = runGuestOsScriptValidateBeforeCall(id, vmGuestScriptRunConfig, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for searchVm
     * @param id ID of the virtual machine. (required)
     * @param path The path query. Use either a path prefix or a filename prefix. (required)
     * @param limit Maximum number of entries in the response. (optional)
     * @param cursor Pagination cursor returned by the previous request. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> File search results. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call searchVmCall(String id, String path, Integer limit, String cursor, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/{id}/search"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchVmValidateBeforeCall(String id, String path, Integer limit, String cursor, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling searchVm(Async)");
        }

        // verify the required parameter 'path' is set
        if (path == null) {
            throw new ApiException("Missing the required parameter 'path' when calling searchVm(Async)");
        }

        return searchVmCall(id, path, limit, cursor, _callback);
     ...
     */
    public SearchResponseListResponse searchVm(String id, String path, Integer limit, String cursor) throws ApiException {
        ApiResponse<SearchResponseListResponse> localVarResp = searchVmWithHttpInfo(id, path, limit, cursor);
        return localVarResp.getData();
    }
     ...
     * @param limit Maximum number of entries in the response. (optional)
     * @param cursor Pagination cursor returned by the previous request. (optional)
     * @return ApiResponse&lt;SearchResponseListResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SearchResponseListResponse> searchVmWithHttpInfo(String id, String path, Integer limit, String cursor) throws ApiException {
        okhttp3.Call localVarCall = searchVmValidateBeforeCall(id, path, limit, cursor, null);
        Type localVarReturnType = new TypeToken<SearchResponseListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Search for a file from a VM (asynchronously)
     * Search for a file in the snapshots of a a virtual machine. Specify the file by full path prefix or filename prefix.
     * @param id ID of the virtual machine. (required)
     * @param path The path query. Use either a path prefix or a filename prefix. (required)
     * @param limit Maximum number of entries in the response. (optional)
     ...
     */
    public okhttp3.Call searchVmAsync(String id, String path, Integer limit, String cursor, final ApiCallback<SearchResponseListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchVmValidateBeforeCall(id, path, limit, cursor, _callback);
        Type localVarReturnType = new TypeToken<SearchResponseListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for updateMount
     * @param id ID of a Live Mount. (required)
     * @param updateMountConfig Power state configuration. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Details of the Live Mount. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call updateMountCall(String id, UpdateMountConfig updateMountConfig, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = updateMountConfig;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateMountValidateBeforeCall(String id, UpdateMountConfig updateMountConfig, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateMount(Async)");
        }

        // verify the required parameter 'updateMountConfig' is set
        if (updateMountConfig == null) {
            throw new ApiException("Missing the required parameter 'updateMountConfig' when calling updateMount(Async)");
        }

        return updateMountCall(id, updateMountConfig, _callback);
     ...
     */
    public VmwareVmMountDetailV1 updateMount(String id, UpdateMountConfig updateMountConfig) throws ApiException {
        ApiResponse<VmwareVmMountDetailV1> localVarResp = updateMountWithHttpInfo(id, updateMountConfig);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VmwareVmMountDetailV1> updateMountWithHttpInfo(String id, UpdateMountConfig updateMountConfig) throws ApiException {
        okhttp3.Call localVarCall = updateMountValidateBeforeCall(id, updateMountConfig, null);
        Type localVarReturnType = new TypeToken<VmwareVmMountDetailV1>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Power a Live Mount on and off (asynchronously)
     * Power a specified Live Mount virtual machine on or off. Pass **_true_** to power the virtual machine on and pass **_false_** to power the virtual machine off.
     * @param id ID of a Live Mount. (required)
     * @param updateMountConfig Power state configuration. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateMountAsync(String id, UpdateMountConfig updateMountConfig, final ApiCallback<VmwareVmMountDetailV1> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateMountValidateBeforeCall(id, updateMountConfig, _callback);
        Type localVarReturnType = new TypeToken<VmwareVmMountDetailV1>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for updateVirtualDisk
     * @param id ID of the Virtual Disk. (required)
     * @param virtualDiskUpdate Virtual Disk update information. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The updated Virtual Disk. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call updateVirtualDiskCall(String id, VirtualDiskUpdate virtualDiskUpdate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = virtualDiskUpdate;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateVirtualDiskValidateBeforeCall(String id, VirtualDiskUpdate virtualDiskUpdate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateVirtualDisk(Async)");
        }

        // verify the required parameter 'virtualDiskUpdate' is set
        if (virtualDiskUpdate == null) {
            throw new ApiException("Missing the required parameter 'virtualDiskUpdate' when calling updateVirtualDisk(Async)");
        }

        return updateVirtualDiskCall(id, virtualDiskUpdate, _callback);
     ...
     */
    public VirtualDiskDetail updateVirtualDisk(String id, VirtualDiskUpdate virtualDiskUpdate) throws ApiException {
        ApiResponse<VirtualDiskDetail> localVarResp = updateVirtualDiskWithHttpInfo(id, virtualDiskUpdate);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VirtualDiskDetail> updateVirtualDiskWithHttpInfo(String id, VirtualDiskUpdate virtualDiskUpdate) throws ApiException {
        okhttp3.Call localVarCall = updateVirtualDiskValidateBeforeCall(id, virtualDiskUpdate, null);
        Type localVarReturnType = new TypeToken<VirtualDiskDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update a specific Virtual Disk (asynchronously)
     * Update a specific Virtual Disk.
     * @param id ID of the Virtual Disk. (required)
     * @param virtualDiskUpdate Virtual Disk update information. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateVirtualDiskAsync(String id, VirtualDiskUpdate virtualDiskUpdate, final ApiCallback<VirtualDiskDetail> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateVirtualDiskValidateBeforeCall(id, virtualDiskUpdate, _callback);
        Type localVarReturnType = new TypeToken<VirtualDiskDetail>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param id ID of virtual machine. (required)
     * @param virtualMachineUpdateWithSecret Properties to update. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateVmCall(String id, VirtualMachineUpdateWithSecret virtualMachineUpdateWithSecret, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = virtualMachineUpdateWithSecret;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateVmValidateBeforeCall(String id, VirtualMachineUpdateWithSecret virtualMachineUpdateWithSecret, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateVm(Async)");
        }

        // verify the required parameter 'virtualMachineUpdateWithSecret' is set
        if (virtualMachineUpdateWithSecret == null) {
            throw new ApiException("Missing the required parameter 'virtualMachineUpdateWithSecret' when calling updateVm(Async)");
        }

        return updateVmCall(id, virtualMachineUpdateWithSecret, _callback);
     ...
     */
    public VirtualMachineDetail updateVm(String id, VirtualMachineUpdateWithSecret virtualMachineUpdateWithSecret) throws ApiException {
        ApiResponse<VirtualMachineDetail> localVarResp = updateVmWithHttpInfo(id, virtualMachineUpdateWithSecret);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VirtualMachineDetail> updateVmWithHttpInfo(String id, VirtualMachineUpdateWithSecret virtualMachineUpdateWithSecret) throws ApiException {
        okhttp3.Call localVarCall = updateVmValidateBeforeCall(id, virtualMachineUpdateWithSecret, null);
        Type localVarReturnType = new TypeToken<VirtualMachineDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update VM (asynchronously)
     * Update a virtual machine with specified properties. Use the guestCredential field to update the guest credential for a specified virtual machine.
     * @param id ID of virtual machine. (required)
     * @param virtualMachineUpdateWithSecret Properties to update. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateVmAsync(String id, VirtualMachineUpdateWithSecret virtualMachineUpdateWithSecret, final ApiCallback<VirtualMachineDetail> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateVmValidateBeforeCall(id, virtualMachineUpdateWithSecret, _callback);
        Type localVarReturnType = new TypeToken<VirtualMachineDetail>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for vmMakePrimary
     * @param requestBody IDs of hosts to migrate. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Asynchronous request for making this cluster primary. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call vmMakePrimaryCall(List<String> requestBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/make_primary";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call vmMakePrimaryValidateBeforeCall(List<String> requestBody, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
            throw new ApiException("Missing the required parameter 'requestBody' when calling vmMakePrimary(Async)");
        }

        return vmMakePrimaryCall(requestBody, _callback);
     ...
     */
    public AsyncRequestStatus vmMakePrimary(List<String> requestBody) throws ApiException {
        ApiResponse<AsyncRequestStatus> localVarResp = vmMakePrimaryWithHttpInfo(requestBody);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AsyncRequestStatus> vmMakePrimaryWithHttpInfo(List<String> requestBody) throws ApiException {
        okhttp3.Call localVarCall = vmMakePrimaryValidateBeforeCall(requestBody, null);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Make this cluster the primary for agents on a set of VMs (asynchronously)
     * Migrate the primary cluster with which the agent is able to communicate. For disaster recovery when migrating everything over from another cluster, the /host/make_primary endpoint can be used with the oldPrimaryClusterUuid parameter.
     * @param requestBody IDs of hosts to migrate. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call vmMakePrimaryAsync(List<String> requestBody, final ApiCallback<AsyncRequestStatus> _callback) throws ApiException {

        okhttp3.Call localVarCall = vmMakePrimaryValidateBeforeCall(requestBody, _callback);
        Type localVarReturnType = new TypeToken<AsyncRequestStatus>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for vmRegisterAgent
     * @param id ID assigned to a virtual machine object. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Successfully registered the Rubrik Backup Service for a specified virtual machine. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call vmRegisterAgentCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/vmware/vm/{id}/register_agent"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call vmRegisterAgentValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling vmRegisterAgent(Async)");
        }

        return vmRegisterAgentCall(id, _callback);
     ...
     */
    public void vmRegisterAgent(String id) throws ApiException {
        vmRegisterAgentWithHttpInfo(id);
    }
     ...
     */
    public ApiResponse<Void> vmRegisterAgentWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = vmRegisterAgentValidateBeforeCall(id, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Register Rubrik Backup Service (asynchronously)
     * Register the Rubrik Backup Service that is running on a specified host with the specified Rubrik cluster.
     * @param id ID assigned to a virtual machine object. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call vmRegisterAgentAsync(String id, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = vmRegisterAgentValidateBeforeCall(id, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
