...
Rubrik REST API
- API version: v1
  - Build date: 2024-10-12T10:12:29.121303-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*ArchiveApi* | [**disableArchivalLocation**](docs/ArchiveApi.md#disableArchivalLocation) | **POST** /archive/location/{id}/owner/disable | Disable location for archival and modification operations
*ArchiveApi* | [**enableArchivalLocation**](docs/ArchiveApi.md#enableArchivalLocation) | **POST** /archive/location/{id}/owner/enable | Enable archival location for archival and modification operations
*ArchiveApi* | [**getAwsAccountId**](docs/ArchiveApi.md#getAwsAccountId) | **GET** /archive/aws/s3/{id}/account_id | Get the AWS account ID of an AWS S3 archival location
*ArchiveApi* | [**refreshArchivalLocationDataSources**](docs/ArchiveApi.md#refreshArchivalLocationDataSources) | **POST** /archive/location/{location_id}/reader/refresh/data_sources | Refresh archive information for a list of data sources
*AuthorizationApi* | [**deleteAuthzCache**](docs/AuthorizationApi.md#deleteAuthzCache) | **DELETE** /authorization/cache | Clear cached authorization information
*BackupApi* | [**createBackupRemediationAsyncTask**](docs/BackupApi.md#createBackupRemediationAsyncTask) | **POST** /backup/retry | Reschedule unsuccessful backup tasks
*BackupApi* | [**getBackupRemediationAsyncTaskStatus**](docs/BackupApi.md#getBackupRemediationAsyncTaskStatus) | **GET** /backup/retry/{id} | Get status of reschedule attempt
*BackupApi* | [**getBackupVerificationAsyncRequestStatus**](docs/BackupApi.md#getBackupVerificationAsyncRequestStatus) | **GET** /backup/verify/{id} | Get asynchronous request details for Backup Verification
*BackupApi* | [**verifySnapshot**](docs/BackupApi.md#verifySnapshot) | **POST** /backup/verify | Trigger a job for snapshot verification
*BlackoutWindowApi* | [**getBlackoutWindowStatus**](docs/BlackoutWindowApi.md#getBlackoutWindowStatus) | **GET** /blackout_window | Get current status of global blackout window
*BlackoutWindowApi* | [**toggleBlackoutWindow**](docs/BlackoutWindowApi.md#toggleBlackoutWindow) | **PATCH** /blackout_window | Starts or stops the global blackout window in local Rubrik cluster
*CertificateApi* | [**deleteCertificate**](docs/CertificateApi.md#deleteCertificate) | **DELETE** /certificate/{id} | Delete imported certificate object
*CertificateApi* | [**exportCertificate**](docs/CertificateApi.md#exportCertificate) | **GET** /certificate/{id} | Get a certificate summary to export
*CertificateApi* | [**importCertificate**](docs/CertificateApi.md#importCertificate) | **POST** /certificate | Import a certificate
*CertificateApi* | [**queryCertificates**](docs/CertificateApi.md#queryCertificates) | **GET** /certificate | Get all certificates
*CertificateApi* | [**updateCertificate**](docs/CertificateApi.md#updateCertificate) | **PATCH** /certificate/{id} | Update a certificate entry
*CertificateAgentApi* | [**markAgentSecondaryCertificate**](docs/CertificateAgentApi.md#markAgentSecondaryCertificate) | **POST** /certificate/agent | Mark a certificate to be added to agents
*CertificateAgentApi* | [**queryAgentSecondaryCertificate**](docs/CertificateAgentApi.md#queryAgentSecondaryCertificate) | **GET** /certificate/agent | Get all potential agent secondary cluster certificates
*CertificateAgentApi* | [**unmarkAgentSecondaryCertificate**](docs/CertificateAgentApi.md#unmarkAgentSecondaryCertificate) | **DELETE** /certificate/agent/{id} | Unmark a certificate that was previously marked
*CloudUtilizationApi* | [**doCloudOutForecast**](docs/CloudUtilizationApi.md#doCloudOutForecast) | **POST** /cloud_utilization/cloud_out_forecast | Forecast of the cloud utilization for CloudOut
*ClusterApi* | [**addKmipServer**](docs/ClusterApi.md#addKmipServer) | **PUT** /cluster/{id}/security/kmip/server | Add a KMIP server
*ClusterApi* | [**addSyslogExportRule**](docs/ClusterApi.md#addSyslogExportRule) | **POST** /syslog/export | Add a new syslog export rule
*ClusterApi* | [**availableVersion**](docs/ClusterApi.md#availableVersion) | **GET** /cluster/{id}/upgrade/available_version | Retrieve CDM versions available for upgrade
*ClusterApi* | [**changeClusterNodeHostnames**](docs/ClusterApi.md#changeClusterNodeHostnames) | **POST** /cluster/{id}/node_hostname | Change hostname for nodes in a Rubrik cluster
*ClusterApi* | [**deleteKmipServer**](docs/ClusterApi.md#deleteKmipServer) | **DELETE** /cluster/{id}/security/kmip/server | Remove the specified KMIP server
*ClusterApi* | [**deleteSyslogExportRule**](docs/ClusterApi.md#deleteSyslogExportRule) | **DELETE** /syslog/export/{id} | Delete the specified syslog export rule
*ClusterApi* | [**getAsyncRequestStatusForUpgrade**](docs/ClusterApi.md#getAsyncRequestStatusForUpgrade) | **GET** /cluster/{id}/upgrade/request/{request_id} | Get asynchronous request details
*ClusterApi* | [**getClusterApiVersion**](docs/ClusterApi.md#getClusterApiVersion) | **GET** /cluster/{id}/api_version | Get cluster REST API version
*ClusterApi* | [**getClusterCertificate**](docs/ClusterApi.md#getClusterCertificate) | **GET** /cluster/{id}/certificate | Get the cluster certificate
*ClusterApi* | [**getClusterNodeHostnames**](docs/ClusterApi.md#getClusterNodeHostnames) | **GET** /cluster/{id}/node_hostname | Get the node ID to hostname mapping for all the nodes in a Rubrik cluster 
*ClusterApi* | [**getClusterNodeIds**](docs/ClusterApi.md#getClusterNodeIds) | **GET** /cluster/{id}/node_id | Get the name of the nodes in the cluster
*ClusterApi* | [**getClusterVersion**](docs/ClusterApi.md#getClusterVersion) | **GET** /cluster/{id}/version | Get cluster software version
*ClusterApi* | [**getCorsConfiguration**](docs/ClusterApi.md#getCorsConfiguration) | **GET** /cluster/{id}/security/cors | Get CORS configuration
*ClusterApi* | [**getEncryptionStatus**](docs/ClusterApi.md#getEncryptionStatus) | **GET** /cluster/{id}/security/encryption | Get encryption at rest status
*ClusterApi* | [**getFips**](docs/ClusterApi.md#getFips) | **GET** /cluster/{id}/security/fips | Get FIPS enablement status
*ClusterApi* | [**getKmipClient**](docs/ClusterApi.md#getKmipClient) | **GET** /cluster/{id}/security/kmip/client | Get the KMIP client configuration
*ClusterApi* | [**getKmipServer**](docs/ClusterApi.md#getKmipServer) | **GET** /cluster/{id}/security/kmip/server | Get KMIP server information
*ClusterApi* | [**getPeriodicUpgradePrechecksStatus**](docs/ClusterApi.md#getPeriodicUpgradePrechecksStatus) | **GET** /cluster/{id}/upgrade/precheck_status | Get the result of the latest run of the upgrade prechecks
*ClusterApi* | [**getPublicClusterInfo**](docs/ClusterApi.md#getPublicClusterInfo) | **GET** /cluster/{id} | Get cluster details
*ClusterApi* | [**getRubrikSnmpMibDownloadLink**](docs/ClusterApi.md#getRubrikSnmpMibDownloadLink) | **GET** /cluster/{id}/snmp_mib_link | Get the link for Rubrik SNMP MIB file
*ClusterApi* | [**getSyslogExportRule**](docs/ClusterApi.md#getSyslogExportRule) | **GET** /syslog/export/{id} | Get the specified syslog export rule
*ClusterApi* | [**getSyslogExportRules**](docs/ClusterApi.md#getSyslogExportRules) | **GET** /syslog/export | Get the configured syslog export rules
*ClusterApi* | [**getSyslogMsgSnmpMibDownloadLink**](docs/ClusterApi.md#getSyslogMsgSnmpMibDownloadLink) | **GET** /cluster/{id}/syslog_msg_mib_link | Get the link for SYSLOG-MSG-MIB file
*ClusterApi* | [**getSyslogTcSnmpMibDownloadLink**](docs/ClusterApi.md#getSyslogTcSnmpMibDownloadLink) | **GET** /cluster/{id}/syslog_tc_mib_link | Get the link for SYSLOG-TC-MIB file
*ClusterApi* | [**getTotpGlobalSetting**](docs/ClusterApi.md#getTotpGlobalSetting) | **GET** /cluster/{id}/security/totp/setting | Get global TOTP setting
*ClusterApi* | [**getTruststores**](docs/ClusterApi.md#getTruststores) | **GET** /cluster/{id}/security/truststore | Get summary of all truststores
*ClusterApi* | [**getWebSignedCertificate**](docs/ClusterApi.md#getWebSignedCertificate) | **GET** /cluster/{id}/security/web_signed_cert | Get the signed certificate for Web server
*ClusterApi* | [**hasRubrikSupportPortalCredentials**](docs/ClusterApi.md#hasRubrikSupportPortalCredentials) | **GET** /cluster/{id}/rubrik_support_portal_credentials | Check credentials to the Rubrik support portal
*ClusterApi* | [**manualDiscover**](docs/ClusterApi.md#manualDiscover) | **POST** /cluster/{id}/manual_discover | Manually discover nodes
*ClusterApi* | [**manualDiscoverIpv4**](docs/ClusterApi.md#manualDiscoverIpv4) | **POST** /cluster/{id}/manual_discover_ipv4 | Manually discover nodes over IPv4 address
*ClusterApi* | [**monitorEvents**](docs/ClusterApi.md#monitorEvents) | **GET** /cluster/me/upgrade/monitor_events | Get event notifications
*ClusterApi* | [**patchPasswordRequirements**](docs/ClusterApi.md#patchPasswordRequirements) | **PATCH** /cluster/{id}/security/password_requirements | Set password requirements
*ClusterApi* | [**queryPasswordRequirements**](docs/ClusterApi.md#queryPasswordRequirements) | **GET** /cluster/{id}/security/password_requirements | Get password requirements
*ClusterApi* | [**resetWebSignedCertificate**](docs/ClusterApi.md#resetWebSignedCertificate) | **DELETE** /cluster/{id}/security/web_signed_cert | Reset the signed certificate for Web server
*ClusterApi* | [**runPeriodicUpgradePrechecks**](docs/ClusterApi.md#runPeriodicUpgradePrechecks) | **POST** /cluster/{id}/upgrade/precheck_status | Start an on demand run of the prechecks
*ClusterApi* | [**setKmipClient**](docs/ClusterApi.md#setKmipClient) | **PUT** /cluster/{id}/security/kmip/client | Specify KMIP client credentials for nodes
*ClusterApi* | [**setTruststoreCertificate**](docs/ClusterApi.md#setTruststoreCertificate) | **PATCH** /cluster/{id}/security/truststore | Set certificates for one or more truststores
*ClusterApi* | [**setWebSignedCertificate**](docs/ClusterApi.md#setWebSignedCertificate) | **PUT** /cluster/{id}/security/web_signed_cert | Set a signed certificate for Web server
*ClusterApi* | [**stageCdmSoftware**](docs/ClusterApi.md#stageCdmSoftware) | **POST** /cluster/{id}/upgrade/stage_cdm_software | Stage software on CDM for upgrade
*ClusterApi* | [**testSyslogExportRule**](docs/ClusterApi.md#testSyslogExportRule) | **POST** /syslog/export/test | Test the specified syslog export rule
*ClusterApi* | [**unsetTruststoreCertificate**](docs/ClusterApi.md#unsetTruststoreCertificate) | **DELETE** /cluster/{id}/security/truststore | Remove certificate associated with specified truststore
*ClusterApi* | [**updateCluster**](docs/ClusterApi.md#updateCluster) | **PATCH** /cluster/{id} | Change Rubrik cluster properties
*ClusterApi* | [**updateCorsConfiguration**](docs/ClusterApi.md#updateCorsConfiguration) | **PATCH** /cluster/{id}/security/cors | Update CORS configuration
*ClusterApi* | [**updateFips**](docs/ClusterApi.md#updateFips) | **PATCH** /cluster/{id}/security/fips | Update FIPS enablement status
*ClusterApi* | [**updateRubrikSupportPortalCredentials**](docs/ClusterApi.md#updateRubrikSupportPortalCredentials) | **POST** /cluster/{id}/rubrik_support_portal_credentials | Update credentials to the Rubrik support portal
*ClusterApi* | [**updateSyslogExportRule**](docs/ClusterApi.md#updateSyslogExportRule) | **PATCH** /syslog/export/{id} | Update the specified syslog export rule
*ClusterApi* | [**updateTotpGlobalSetting**](docs/ClusterApi.md#updateTotpGlobalSetting) | **PUT** /cluster/{id}/security/totp/setting | Update TOTP global setting
*ConfigHistoryApi* | [**queryConfigurationHistoryUpdates**](docs/ConfigHistoryApi.md#queryConfigurationHistoryUpdates) | **GET** /config/history/list_updates | View a list of filtered configuration updates
*ConfigHistoryApi* | [**retrieveConfigurationValues**](docs/ConfigHistoryApi.md#retrieveConfigurationValues) | **GET** /config/history/ondate | View a list of configurations and their values on a given date
*CsrApi* | [**deleteCsr**](docs/CsrApi.md#deleteCsr) | **DELETE** /csr/{id} | Delete a certificate signing request
*CsrApi* | [**generateCsr**](docs/CsrApi.md#generateCsr) | **POST** /csr | Generate a new private key and return a certificate signing request
*CsrApi* | [**getAllCsrs**](docs/CsrApi.md#getAllCsrs) | **GET** /csr | Get all certificate signing requests
*DataSourceApi* | [**bulkDeleteSnapshots**](docs/DataSourceApi.md#bulkDeleteSnapshots) | **POST** /data_source/snapshot/bulk_delete | Bulk delete all snapshots for the given objects
*DataSourceApi* | [**bulkDeleteSnapshotsForObject**](docs/DataSourceApi.md#bulkDeleteSnapshotsForObject) | **POST** /data_source/{id}/snapshot/bulk_delete | Bulk delete specified snapshots for the given object
*DataSourceApi* | [**expiredCustomRetentionSnapshots**](docs/DataSourceApi.md#expiredCustomRetentionSnapshots) | **GET** /data_source/{id}/expired_custom_retention_snapshots | Returns a list of snapshots that have expired according to their snapshot-level SLA Domain assignments 
*DatabaseLogReportApi* | [**queryLogReport**](docs/DatabaseLogReportApi.md#queryLogReport) | **GET** /database/log_report | Get the database log backup delay information
*DatabaseLogReportApi* | [**queryReportProperties**](docs/DatabaseLogReportApi.md#queryReportProperties) | **GET** /database/log_report/defaults | Get the database log backup report properties
*DatabaseLogReportApi* | [**updateReportProperties**](docs/DatabaseLogReportApi.md#updateReportProperties) | **PATCH** /database/log_report/defaults | Update the database log backup report properties
*EventApi* | [**getEventsCsvDownloadLink**](docs/EventApi.md#getEventsCsvDownloadLink) | **GET** /event/csv_download_link | Download summary of events as a CSV file
*EventApi* | [**queryEventV1**](docs/EventApi.md#queryEventV1) | **GET** /event | Get information for all events
*EventApi* | [**queryLatestEventsV1**](docs/EventApi.md#queryLatestEventsV1) | **GET** /event/latest | Get latest events with their associated event series information
*EventSeriesApi* | [**queryEventSeriesByIdV1**](docs/EventSeriesApi.md#queryEventSeriesByIdV1) | **GET** /event_series/{id} | Get all events and relevant information associated with an event series ID
*ExclusionPatternApi* | [**bulkCreateExclusionPattern**](docs/ExclusionPatternApi.md#bulkCreateExclusionPattern) | **POST** /exclusion_pattern/bulk | Bulk create exclusion patterns
*ExclusionPatternApi* | [**bulkDeleteExclusionPattern**](docs/ExclusionPatternApi.md#bulkDeleteExclusionPattern) | **DELETE** /exclusion_pattern/bulk | Bulk delete the provided mutable exclusion patterns
*ExclusionPatternApi* | [**createExclusionPattern**](docs/ExclusionPatternApi.md#createExclusionPattern) | **POST** /exclusion_pattern | Create an exclusion pattern
*ExclusionPatternApi* | [**deleteExclusionPattern**](docs/ExclusionPatternApi.md#deleteExclusionPattern) | **DELETE** /exclusion_pattern/{id} | Delete a mutable exclusion pattern
*ExclusionPatternApi* | [**getExclusionPattern**](docs/ExclusionPatternApi.md#getExclusionPattern) | **GET** /exclusion_pattern/{id} | Get details of a exclusion pattern
*ExclusionPatternApi* | [**queryExclusionPattern**](docs/ExclusionPatternApi.md#queryExclusionPattern) | **GET** /exclusion_pattern | Get a summary of all exclusion patterns
*ExclusionPatternApi* | [**updateExclusionPattern**](docs/ExclusionPatternApi.md#updateExclusionPattern) | **POST** /exclusion_pattern/{id} | Update a mutable exclusion pattern
*FailoverClusterApi* | [**bulkDeleteFailoverCluster**](docs/FailoverClusterApi.md#bulkDeleteFailoverCluster) | **DELETE** /failover_cluster/bulk | Delete the provided failover clusters
*FailoverClusterApi* | [**createFailoverCluster**](docs/FailoverClusterApi.md#createFailoverCluster) | **POST** /failover_cluster | Create a failover cluster
*FailoverClusterApi* | [**deleteFailoverCluster**](docs/FailoverClusterApi.md#deleteFailoverCluster) | **DELETE** /failover_cluster/{id} | Delete a failover cluster
*FailoverClusterApi* | [**getFailoverCluster**](docs/FailoverClusterApi.md#getFailoverCluster) | **GET** /failover_cluster/{id} | Get details of a failover cluster
*FailoverClusterApi* | [**queryFailoverCluster**](docs/FailoverClusterApi.md#queryFailoverCluster) | **GET** /failover_cluster | Get a summary of all failover clusters
*FailoverClusterApi* | [**updateFailoverCluster**](docs/FailoverClusterApi.md#updateFailoverCluster) | **PATCH** /failover_cluster/{id} | Update a failover cluster
*FailoverClusterFailoverClusterAppApi* | [**bulkDeleteFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#bulkDeleteFailoverClusterApp) | **DELETE** /failover_cluster/failover_cluster_app/bulk | Delete failover cluster applications
*FailoverClusterFailoverClusterAppApi* | [**createFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#createFailoverClusterApp) | **POST** /failover_cluster/failover_cluster_app | Create a failover cluster app
*FailoverClusterFailoverClusterAppApi* | [**deleteFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#deleteFailoverClusterApp) | **DELETE** /failover_cluster/failover_cluster_app/{id} | Delete a failover cluster app
*FailoverClusterFailoverClusterAppApi* | [**getFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#getFailoverClusterApp) | **GET** /failover_cluster/failover_cluster_app/{id} | Get details of a failover cluster app
*FailoverClusterFailoverClusterAppApi* | [**queryFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#queryFailoverClusterApp) | **GET** /failover_cluster/failover_cluster_app | Get a summary of all failover cluster apps
*FailoverClusterFailoverClusterAppApi* | [**updateFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#updateFailoverClusterApp) | **PATCH** /failover_cluster/failover_cluster_app/{id} | Update a failover cluster app
*FailoverClusterHierarchyApi* | [**getFailoverClusterHierarchyChildren**](docs/FailoverClusterHierarchyApi.md#getFailoverClusterHierarchyChildren) | **GET** /failover_cluster/hierarchy/{id}/children | Get list of immediate descendant objects
*FailoverClusterHierarchyApi* | [**getFailoverClusterHierarchyDescendants**](docs/FailoverClusterHierarchyApi.md#getFailoverClusterHierarchyDescendants) | **GET** /failover_cluster/hierarchy/{id}/descendants | Get list of descendant objects
*FailoverClusterHierarchyApi* | [**getFailoverClusterHierarchyObject**](docs/FailoverClusterHierarchyApi.md#getFailoverClusterHierarchyObject) | **GET** /failover_cluster/hierarchy/{id} | Get summary of a hierarchy object
*FilesetApi* | [**browseFilesetSnapshot**](docs/FilesetApi.md#browseFilesetSnapshot) | **GET** /fileset/snapshot/{id}/browse | Lists all files and directories in a given path
*FilesetApi* | [**createDownloadFilesetSnapshotFromCloud**](docs/FilesetApi.md#createDownloadFilesetSnapshotFromCloud) | **POST** /fileset/snapshot/{id}/download | Create a download fileset snapshot from archival request
*FilesetApi* | [**createFileset**](docs/FilesetApi.md#createFileset) | **POST** /fileset | Create one fileset for a host
*FilesetApi* | [**createFilesetBackupJob**](docs/FilesetApi.md#createFilesetBackupJob) | **POST** /fileset/{id}/snapshot | Initiate an on-demand backup for a fileset
*FilesetApi* | [**createFilesetDownloadFileJob**](docs/FilesetApi.md#createFilesetDownloadFileJob) | **POST** /fileset/snapshot/{id}/download_file | Create a file download job from a fileset backup
*FilesetApi* | [**createFilesetExportFileJob**](docs/FilesetApi.md#createFilesetExportFileJob) | **POST** /fileset/snapshot/{id}/export_file | Create export job
*FilesetApi* | [**createFilesetRestoreFileJob**](docs/FilesetApi.md#createFilesetRestoreFileJob) | **POST** /fileset/snapshot/{id}/restore_file | Create restore job
*FilesetApi* | [**deleteFileset**](docs/FilesetApi.md#deleteFileset) | **DELETE** /fileset/{id} | Delete a fileset
*FilesetApi* | [**deleteFilesetSnapshot**](docs/FilesetApi.md#deleteFilesetSnapshot) | **DELETE** /fileset/snapshot/{id} | Delete a fileset snapshot
*FilesetApi* | [**deleteFilesetSnapshots**](docs/FilesetApi.md#deleteFilesetSnapshots) | **DELETE** /fileset/{id}/snapshot | Delete all snapshots of a fileset
*FilesetApi* | [**getFileset**](docs/FilesetApi.md#getFileset) | **GET** /fileset/{id} | Get information for a single fileset
*FilesetApi* | [**getFilesetAsyncRequestStatus**](docs/FilesetApi.md#getFilesetAsyncRequestStatus) | **GET** /fileset/request/{id} | Get details about an async request
*FilesetApi* | [**getFilesetSnapshot**](docs/FilesetApi.md#getFilesetSnapshot) | **GET** /fileset/snapshot/{id} | Get information for a fileset snapshot
*FilesetApi* | [**getMissedFilesetSnapshots**](docs/FilesetApi.md#getMissedFilesetSnapshots) | **GET** /fileset/{id}/missed_snapshot | Get missed snapshots for a fileset
*FilesetApi* | [**queryFileset**](docs/FilesetApi.md#queryFileset) | **GET** /fileset | Get summary information for all filesets
*FilesetApi* | [**searchFileset**](docs/FilesetApi.md#searchFileset) | **GET** /fileset/{id}/search | Search for a file within the fileset
*FilesetApi* | [**updateFileset**](docs/FilesetApi.md#updateFileset) | **PATCH** /fileset/{id} | Update a Fileset
*FilesetTemplateApi* | [**createFilesetTemplate**](docs/FilesetTemplateApi.md#createFilesetTemplate) | **POST** /fileset_template | Create a fileset template
*FilesetTemplateApi* | [**deleteFilesetTemplate**](docs/FilesetTemplateApi.md#deleteFilesetTemplate) | **DELETE** /fileset_template/{id} | Delete a fileset template
*FilesetTemplateApi* | [**getFilesetTemplate**](docs/FilesetTemplateApi.md#getFilesetTemplate) | **GET** /fileset_template/{id} | Get information for a fileset template
*FilesetTemplateApi* | [**queryFilesetTemplate**](docs/FilesetTemplateApi.md#queryFilesetTemplate) | **GET** /fileset_template | Get summary information for all fileset templates
*FilesetTemplateApi* | [**updateFilesetTemplate**](docs/FilesetTemplateApi.md#updateFilesetTemplate) | **PATCH** /fileset_template/{id} | Modify a fileset template
*HdfsApi* | [**browseHdfsSnapshot**](docs/HdfsApi.md#browseHdfsSnapshot) | **GET** /hdfs/snapshot/{id}/browse | Lists all files and directories in a given path
*HdfsApi* | [**createHdfs**](docs/HdfsApi.md#createHdfs) | **POST** /hdfs | Create one HDFS directory for a host
*HdfsApi* | [**createHdfsBackupJob**](docs/HdfsApi.md#createHdfsBackupJob) | **POST** /hdfs/{id}/snapshot | Initiate an on-demand backup for a HDFS directory
*HdfsApi* | [**createHdfsExportFileJob**](docs/HdfsApi.md#createHdfsExportFileJob) | **POST** /hdfs/snapshot/{id}/export_file | Create export job
*HdfsApi* | [**createHdfsRestoreFileJob**](docs/HdfsApi.md#createHdfsRestoreFileJob) | **POST** /hdfs/snapshot/{id}/restore_file | Create restore job
*HdfsApi* | [**deleteHdfs**](docs/HdfsApi.md#deleteHdfs) | **DELETE** /hdfs/{id} | Delete a HDFS directory
*HdfsApi* | [**deleteHdfsSnapshot**](docs/HdfsApi.md#deleteHdfsSnapshot) | **DELETE** /hdfs/snapshot/{id} | Delete a HDFS directory snapshot
*HdfsApi* | [**deleteHdfsSnapshots**](docs/HdfsApi.md#deleteHdfsSnapshots) | **DELETE** /hdfs/{id}/snapshot | Delete all snapshots of a HDFS directory
*HdfsApi* | [**getHdfs**](docs/HdfsApi.md#getHdfs) | **GET** /hdfs/{id} | Get information for a single HDFS directory
*HdfsApi* | [**getHdfsAsyncRequestStatus**](docs/HdfsApi.md#getHdfsAsyncRequestStatus) | **GET** /hdfs/request/{id} | Get details about an asynchronous request
*HdfsApi* | [**getHdfsSnapshot**](docs/HdfsApi.md#getHdfsSnapshot) | **GET** /hdfs/snapshot/{id} | Get information for a HDFS directory snapshot
*HdfsApi* | [**getMissedHdfsSnapshots**](docs/HdfsApi.md#getMissedHdfsSnapshots) | **GET** /hdfs/{id}/missed_snapshot | Get missed snapshots for a HDFS directory
*HdfsApi* | [**queryHdfs**](docs/HdfsApi.md#queryHdfs) | **GET** /hdfs | Get summary information for all HDFS directories
*HdfsApi* | [**searchHdfs**](docs/HdfsApi.md#searchHdfs) | **GET** /hdfs/{id}/search | Search for a file within the HDFS directory
*HdfsApi* | [**updateHdfs**](docs/HdfsApi.md#updateHdfs) | **PATCH** /hdfs/{id} | Update a HDFS directory
*HdfsTemplateApi* | [**createHdfsTemplate**](docs/HdfsTemplateApi.md#createHdfsTemplate) | **POST** /hdfs_template | Create a HDFS directory template
*HdfsTemplateApi* | [**deleteHdfsTemplate**](docs/HdfsTemplateApi.md#deleteHdfsTemplate) | **DELETE** /hdfs_template/{id} | Delete a HDFS directory template
*HdfsTemplateApi* | [**getHdfsTemplate**](docs/HdfsTemplateApi.md#getHdfsTemplate) | **GET** /hdfs_template/{id} | Get information for a HDFS directory template
*HdfsTemplateApi* | [**queryHdfsTemplate**](docs/HdfsTemplateApi.md#queryHdfsTemplate) | **GET** /hdfs_template | Get summary information for all HDFS directory templates
*HdfsTemplateApi* | [**updateHdfsTemplate**](docs/HdfsTemplateApi.md#updateHdfsTemplate) | **PATCH** /hdfs_template/{id} | Modify a HDFS directory template
*HealthMonitorApi* | [**getPolicies**](docs/HealthMonitorApi.md#getPolicies) | **GET** /health_monitor/policies | Get details of health monitor policies
*HealthMonitorApi* | [**getPolicyStatus**](docs/HealthMonitorApi.md#getPolicyStatus) | **GET** /health_monitor/policy_status | Get the status of health monitor policy enforcement
*HealthMonitorApi* | [**runPolicies**](docs/HealthMonitorApi.md#runPolicies) | **POST** /health_monitor/run_policy | Enforce health monitor policies
*HierarchyApi* | [**bulkHierarchySlaConflictsV1**](docs/HierarchyApi.md#bulkHierarchySlaConflictsV1) | **POST** /hierarchy/bulk_sla_conflicts | Retrieve the list of descendant objects with SLA conflicts in bulk
*HostApi* | [**bulkRegisterHostAsync**](docs/HostApi.md#bulkRegisterHostAsync) | **POST** /host/bulk_background | Register hosts
*HostApi* | [**deleteHost**](docs/HostApi.md#deleteHost) | **DELETE** /host/{id} | Delete a registered host
*HostApi* | [**discoverNasShares**](docs/HostApi.md#discoverNasShares) | **GET** /host/{id}/nas_share_discover | Discover and return all shares on a NAS host
*HostApi* | [**getHost**](docs/HostApi.md#getHost) | **GET** /host/{id} | Get summary information for a host
*HostApi* | [**getRbsHostInfo**](docs/HostApi.md#getRbsHostInfo) | **GET** /host/rbs | Get the Rubrik Backup Service details for a host
*HostApi* | [**hostMakePrimary**](docs/HostApi.md#hostMakePrimary) | **POST** /host/make_primary | Make this cluster the primary for agents on a set of hosts
*HostApi* | [**queryHost**](docs/HostApi.md#queryHost) | **GET** /host | Get summary information for hosts
*HostApi* | [**queryHostVolume**](docs/HostApi.md#queryHostVolume) | **GET** /host/{id}/volume | Get list of Volume Group volumes
*HostApi* | [**rbsInstall**](docs/HostApi.md#rbsInstall) | **POST** /host/rbs/install | Install Rubrik Backup Service on a host
*HostApi* | [**rbsUninstall**](docs/HostApi.md#rbsUninstall) | **POST** /host/rbs/uninstall | Uninstall Rubrik Backup Service from a host
*HostApi* | [**rbsUpgrade**](docs/HostApi.md#rbsUpgrade) | **POST** /host/rbs/upgrade | Upgrade Rubrik Backup Service on a host
*HostApi* | [**refreshHost**](docs/HostApi.md#refreshHost) | **POST** /host/{id}/refresh | Refresh a host
*HostApi* | [**registerHost**](docs/HostApi.md#registerHost) | **POST** /host | Register a host
*HostApi* | [**registerHostAsync**](docs/HostApi.md#registerHostAsync) | **POST** /host/background | Register a host
*HostApi* | [**searchHost**](docs/HostApi.md#searchHost) | **GET** /host/{id}/search | Search for a file within the host
*HostApi* | [**updateCertificateHost**](docs/HostApi.md#updateCertificateHost) | **PUT** /host/certificate/{id} | Update certificate
*HostApi* | [**updateHost**](docs/HostApi.md#updateHost) | **PATCH** /host/{id} | Modify information for a registered host
*HostHierarchyApi* | [**getHostHierarchyChildren**](docs/HostHierarchyApi.md#getHostHierarchyChildren) | **GET** /host/hierarchy/{id}/children | Get immediate descendant objects
*HostHierarchyApi* | [**getHostHierarchyObject**](docs/HostHierarchyApi.md#getHostHierarchyObject) | **GET** /host/hierarchy/{id} | Get summary of a host/share hierarchy object
*HostShareApi* | [**bulkAddHostShares**](docs/HostShareApi.md#bulkAddHostShares) | **POST** /host/share/bulk | Add NAS shares in bulk
*HostShareApi* | [**bulkUpdateHostShare**](docs/HostShareApi.md#bulkUpdateHostShare) | **PATCH** /host/share/bulk | Update network shares
*HypervVmApi* | [**getHypervVirtualMachineForceFullSpec**](docs/HypervVmApi.md#getHypervVirtualMachineForceFullSpec) | **GET** /hyperv/vm/{id}/request/force_full_snapshot | Retrieve the configuration which has been set for forcing a full snapshot for a Hyper-V Virtual Machine
*HypervVmApi* | [**requestHypervVirtualMachineForceFullSnapshot**](docs/HypervVmApi.md#requestHypervVirtualMachineForceFullSnapshot) | **POST** /hyperv/vm/{id}/request/force_full_snapshot | Request a full snapshot during next backup job of a Hyper-V virtual machine
*IdpAuthDomainApi* | [**createIdProviderAuthDomain**](docs/IdpAuthDomainApi.md#createIdProviderAuthDomain) | **POST** /idp_auth_domain | Add a new IdP authentication domain
*IdpAuthDomainApi* | [**deleteIdProviderAuthDomain**](docs/IdpAuthDomainApi.md#deleteIdProviderAuthDomain) | **DELETE** /idp_auth_domain/{id} | Delete an IdP authentication domain for the given ID
*IdpAuthDomainApi* | [**getIdProviderAuthDomain**](docs/IdpAuthDomainApi.md#getIdProviderAuthDomain) | **GET** /idp_auth_domain/{id} | Get an IdP authentication domain for the given id
*IdpAuthDomainApi* | [**queryIdProviderAuthDomain**](docs/IdpAuthDomainApi.md#queryIdProviderAuthDomain) | **GET** /idp_auth_domain | Get a list of IdP authentication domains
*IdpAuthDomainApi* | [**updateIdProviderAuthDomain**](docs/IdpAuthDomainApi.md#updateIdProviderAuthDomain) | **PATCH** /idp_auth_domain/{id} | Update an existing IdP authentication domain
*JobMonitoringApi* | [**createMonitoringSubscription**](docs/JobMonitoringApi.md#createMonitoringSubscription) | **POST** /job_monitoring/subscription | Create an email subscription to the job monitoring page
*JobMonitoringApi* | [**deleteMonitoringSubscription**](docs/JobMonitoringApi.md#deleteMonitoringSubscription) | **DELETE** /job_monitoring/subscription/{subscription_id} | Delete a monitoring page email subscription
*JobMonitoringApi* | [**getJobMonitoringInfo**](docs/JobMonitoringApi.md#getJobMonitoringInfo) | **GET** /job_monitoring | Get job monitoring information
*JobMonitoringApi* | [**getJobMonitoringInfoCsvDownloadLink**](docs/JobMonitoringApi.md#getJobMonitoringInfoCsvDownloadLink) | **GET** /job_monitoring/csv_download_link | Download job monitoring information as a CSV file
*JobMonitoringApi* | [**getMonitoringJobCountByJobState**](docs/JobMonitoringApi.md#getMonitoringJobCountByJobState) | **GET** /job_monitoring/summary_by_job_state | Get job monitoring summary information separated by job state
*JobMonitoringApi* | [**getMonitoringJobCountByJobType**](docs/JobMonitoringApi.md#getMonitoringJobCountByJobType) | **GET** /job_monitoring/summary_by_job_type | Get job monitoring summary information separated by job type
*JobMonitoringApi* | [**getMonitoringSubscription**](docs/JobMonitoringApi.md#getMonitoringSubscription) | **GET** /job_monitoring/subscription/{subscription_id} | Get a specific monitoring email subscription by id
*JobMonitoringApi* | [**getMonitoringSubscriptions**](docs/JobMonitoringApi.md#getMonitoringSubscriptions) | **GET** /job_monitoring/subscription | Returns all email subscriptions for the monitoring page
*JobMonitoringApi* | [**updateMonitoringSubscription**](docs/JobMonitoringApi.md#updateMonitoringSubscription) | **PATCH** /job_monitoring/subscription/{subscription_id} | Update a monitoring email subscription
*LdapServiceApi* | [**createLdapService**](docs/LdapServiceApi.md#createLdapService) | **POST** /ldap_service | Add a new authentication domain
*LdapServiceApi* | [**deleteLdapService**](docs/LdapServiceApi.md#deleteLdapService) | **DELETE** /ldap_service/{id} | Delete an authentication domain for the given ID
*LdapServiceApi* | [**getLdapService**](docs/LdapServiceApi.md#getLdapService) | **GET** /ldap_service/{id} | Get a LDAP service for the given ID
*LdapServiceApi* | [**patchLdapService**](docs/LdapServiceApi.md#patchLdapService) | **PATCH** /ldap_service/{id} | Update an existing authentication domain
*LdapServiceApi* | [**putLdapService**](docs/LdapServiceApi.md#putLdapService) | **PUT** /ldap_service/{id} | Replace the values of an authentication domain
*LdapServiceApi* | [**queryLdapService**](docs/LdapServiceApi.md#queryLdapService) | **GET** /ldap_service | Get a list of LDAP services
*LegalHoldApi* | [**applyLegalHold**](docs/LegalHoldApi.md#applyLegalHold) | **POST** /legal_hold/snapshot | Apply a Legal Hold
*LegalHoldApi* | [**dissolveLegalHoldSnapshots**](docs/LegalHoldApi.md#dissolveLegalHoldSnapshots) | **POST** /legal_hold/object/{id}/dissolve | Dissolve a collection of snapshots of specified data source from Legal Hold
*LegalHoldApi* | [**getLegalHoldObjects**](docs/LegalHoldApi.md#getLegalHoldObjects) | **GET** /legal_hold/object | Get objects part of Legal Hold
*LegalHoldApi* | [**queryLegalHold**](docs/LegalHoldApi.md#queryLegalHold) | **GET** /legal_hold/snapshot | Get snasphots held under legal hold
*ManagedVolumeApi* | [**createManagedVolumeGenerateScriptJob**](docs/ManagedVolumeApi.md#createManagedVolumeGenerateScriptJob) | **POST** /managed_volume/snapshot/export/{id}/script | Generate and download unified view script
*MfaRsaApi* | [**createRsaMfaServer**](docs/MfaRsaApi.md#createRsaMfaServer) | **POST** /mfa/rsa/server | Register a new RSA server
*MfaRsaApi* | [**deleteRsaMfaServer**](docs/MfaRsaApi.md#deleteRsaMfaServer) | **DELETE** /mfa/rsa/server/{id} | Delete RSA server
*MfaRsaApi* | [**getRsaMfaServer**](docs/MfaRsaApi.md#getRsaMfaServer) | **GET** /mfa/rsa/server/{id} | Get RSA server configuration
*MfaRsaApi* | [**queryRsaMfaServers**](docs/MfaRsaApi.md#queryRsaMfaServers) | **GET** /mfa/rsa/server | Get RSA server configuration
*MfaRsaApi* | [**updateRsaMfaServer**](docs/MfaRsaApi.md#updateRsaMfaServer) | **PATCH** /mfa/rsa/server/{id} | Update RSA server configuration
*MssqlApi* | [**assignMssqlSlaProperties**](docs/MssqlApi.md#assignMssqlSlaProperties) | **POST** /mssql/sla_domain/assign | Assign SLA properties to SQL Server objects
*MssqlApi* | [**browseMssqlBackupFiles**](docs/MssqlApi.md#browseMssqlBackupFiles) | **POST** /mssql/db/{id}/browse | List snapshots and logs from a Microsoft SQL database
*MssqlApi* | [**bulkUpdateMssqlDbV1**](docs/MssqlApi.md#bulkUpdateMssqlDbV1) | **PATCH** /mssql/db/bulk | Update multiple Microsoft SQL databases
*MssqlApi* | [**countMssqlDbV1**](docs/MssqlApi.md#countMssqlDbV1) | **GET** /mssql/db/count | Returns a count of Microsoft SQL databases
*MssqlApi* | [**countMssqlInstanceV1**](docs/MssqlApi.md#countMssqlInstanceV1) | **GET** /mssql/instance/count | Returns a count of Microsoft SQL instances
*MssqlApi* | [**createDownloadMssqlBackupFiles**](docs/MssqlApi.md#createDownloadMssqlBackupFiles) | **POST** /mssql/db/{id}/download_files | Download snapshots and logs backups from a Microsoft SQL Database
*MssqlApi* | [**createDownloadMssqlBackupFilesById**](docs/MssqlApi.md#createDownloadMssqlBackupFilesById) | **POST** /mssql/db/{id}/download_files_by_id | Downloads a list of snapshot and log backups from a Microsoft SQL database
*MssqlApi* | [**createExportMssqlDb**](docs/MssqlApi.md#createExportMssqlDb) | **POST** /mssql/db/{id}/export | Export a Microsoft SQL database to a new location
*MssqlApi* | [**createLogShippingConfiguration**](docs/MssqlApi.md#createLogShippingConfiguration) | **POST** /mssql/db/{id}/log_shipping | Create a log shipping configuration
*MssqlApi* | [**createMssqlHostConfig**](docs/MssqlApi.md#createMssqlHostConfig) | **POST** /mssql/host/configuration | Create a SQL Server host configuration
*MssqlApi* | [**createMssqlMount**](docs/MssqlApi.md#createMssqlMount) | **POST** /mssql/db/{id}/mount | Live Mount SQL Server database from a point in time copy
*MssqlApi* | [**createMssqlUnmount**](docs/MssqlApi.md#createMssqlUnmount) | **DELETE** /mssql/db/mount/{id} | Delete a Live Mount of a SQL Server database
*MssqlApi* | [**createOnDemandMssqlBackup**](docs/MssqlApi.md#createOnDemandMssqlBackup) | **POST** /mssql/db/{id}/snapshot | Take an on-demand backup of a Microsoft SQL database
*MssqlApi* | [**createOnDemandMssqlBatchBackupV1**](docs/MssqlApi.md#createOnDemandMssqlBatchBackupV1) | **POST** /mssql/db/bulk/snapshot | Take an on-demand backup of multiple Microsoft SQL databases
*MssqlApi* | [**createOnDemandMssqlLogBackup**](docs/MssqlApi.md#createOnDemandMssqlLogBackup) | **POST** /mssql/db/{id}/log_backup | Take an on-demand log backup for a Microsoft SQL database
*MssqlApi* | [**createRestoreMssqlDb**](docs/MssqlApi.md#createRestoreMssqlDb) | **POST** /mssql/db/{id}/restore | Restore a Microsoft SQL database
*MssqlApi* | [**deleteDownloadedMssqlDbRecoverableRangesV1**](docs/MssqlApi.md#deleteDownloadedMssqlDbRecoverableRangesV1) | **DELETE** /mssql/db/{id}/recoverable_range/download | Delete downloaded recoverable ranges of a Microsoft SQL database
*MssqlApi* | [**deleteLogShippingConfiguration**](docs/MssqlApi.md#deleteLogShippingConfiguration) | **DELETE** /mssql/db/log_shipping/{id} | Delete a specified log shipping configuration
*MssqlApi* | [**deleteMssqlDbSnapshots**](docs/MssqlApi.md#deleteMssqlDbSnapshots) | **DELETE** /mssql/db/{id}/snapshot | Delete all snapshots of a Microsoft SQL database
*MssqlApi* | [**deleteMssqlHostConfig**](docs/MssqlApi.md#deleteMssqlHostConfig) | **DELETE** /mssql/host/configuration/{host_id} | Delete the SQL Server host configuration
*MssqlApi* | [**downloadFromArchive**](docs/MssqlApi.md#downloadFromArchive) | **POST** /mssql/db/{id}/download | Download snapshots and log backups from archival
*MssqlApi* | [**getCompatibleMssqlInstancesV1**](docs/MssqlApi.md#getCompatibleMssqlInstancesV1) | **GET** /mssql/db/{id}/compatible_instance | Get compatible instances for the recovery of a Microsoft SQL database
*MssqlApi* | [**getDefaultDbPropertiesV1**](docs/MssqlApi.md#getDefaultDbPropertiesV1) | **GET** /mssql/db/defaults | Returns the current default properties for Microsoft SQL databases
*MssqlApi* | [**getDeleteMssqlDbRecoverableRangesStatusV1**](docs/MssqlApi.md#getDeleteMssqlDbRecoverableRangesStatusV1) | **GET** /mssql/db/recoverable_range/download/{id} | Get the deletion status of downloaded recoverable ranges
*MssqlApi* | [**getLogShippingConfiguration**](docs/MssqlApi.md#getLogShippingConfiguration) | **GET** /mssql/db/log_shipping/{id} | Get a log shipping configuration
*MssqlApi* | [**getMissedMssqlDbSnapshots**](docs/MssqlApi.md#getMissedMssqlDbSnapshots) | **GET** /mssql/db/{id}/missed_snapshot | Get summary information for missed snapshots of a SQL database
*MssqlApi* | [**getMssqlAsyncRequestStatus**](docs/MssqlApi.md#getMssqlAsyncRequestStatus) | **GET** /mssql/request/{id} | Get details for an async request
*MssqlApi* | [**getMssqlAvailabilityGroupV1**](docs/MssqlApi.md#getMssqlAvailabilityGroupV1) | **GET** /mssql/availability_group/{id} | Returns detailed information for a Microsoft SQL availability group
*MssqlApi* | [**getMssqlDb**](docs/MssqlApi.md#getMssqlDb) | **GET** /mssql/db/{id} | Get detailed information for a Microsoft SQL database
*MssqlApi* | [**getMssqlDbMissedRecoverableRanges**](docs/MssqlApi.md#getMssqlDbMissedRecoverableRanges) | **GET** /mssql/db/{id}/missed_recoverable_range | Get missed recoverable ranges of a Microsoft SQL database
*MssqlApi* | [**getMssqlDbRecoverableRanges**](docs/MssqlApi.md#getMssqlDbRecoverableRanges) | **GET** /mssql/db/{id}/recoverable_range | Get recoverable ranges of a Microsoft SQL database
*MssqlApi* | [**getMssqlDbSnapshot**](docs/MssqlApi.md#getMssqlDbSnapshot) | **GET** /mssql/db/snapshot/{id} | Get details information about a Microsoft SQL database snapshot
*MssqlApi* | [**getMssqlHierarchyChildren**](docs/MssqlApi.md#getMssqlHierarchyChildren) | **GET** /mssql/hierarchy/{id}/children | Get list of immediate descendant objects
*MssqlApi* | [**getMssqlHierarchyDescendants**](docs/MssqlApi.md#getMssqlHierarchyDescendants) | **GET** /mssql/hierarchy/{id}/descendants | Get list of descendant objects
*MssqlApi* | [**getMssqlHierarchyObject**](docs/MssqlApi.md#getMssqlHierarchyObject) | **GET** /mssql/hierarchy/{id} | Get summary of a SQL Server hierarchy object
*MssqlApi* | [**getMssqlHostConfig**](docs/MssqlApi.md#getMssqlHostConfig) | **GET** /mssql/host/configuration/{host_id} | Get the configuration for a specific host
*MssqlApi* | [**getMssqlInstance**](docs/MssqlApi.md#getMssqlInstance) | **GET** /mssql/instance/{id} | Get detailed information for a Microsoft SQL instance
*MssqlApi* | [**getMssqlMount**](docs/MssqlApi.md#getMssqlMount) | **GET** /mssql/db/mount/{id} | Get detailed information for a Live Mount of a SQL Server database
*MssqlApi* | [**getOnDemandMssqlBatchBackupResultV1**](docs/MssqlApi.md#getOnDemandMssqlBatchBackupResultV1) | **GET** /mssql/db/bulk/snapshot/{id} | Returns details for an on-demand backup of multiple Microsoft SQL databases
*MssqlApi* | [**mssqlGetRestoreFilesV1**](docs/MssqlApi.md#mssqlGetRestoreFilesV1) | **GET** /mssql/db/{id}/restore_files | Returns a list all database files to be restored
*MssqlApi* | [**mssqlGetSnappableIdV1**](docs/MssqlApi.md#mssqlGetSnappableIdV1) | **GET** /mssql/db/{id}/snappable_id | Returns the snappableId for a Microsoft SQL database
*MssqlApi* | [**mssqlRestoreEstimateV1**](docs/MssqlApi.md#mssqlRestoreEstimateV1) | **GET** /mssql/db/{id}/restore_estimate | Returns a size estimate for a restore or export
*MssqlApi* | [**queryLogShippingConfigurations**](docs/MssqlApi.md#queryLogShippingConfigurations) | **GET** /mssql/db/log_shipping | Get log shipping configurations
*MssqlApi* | [**queryMssqlAvailabilityGroupV1**](docs/MssqlApi.md#queryMssqlAvailabilityGroupV1) | **GET** /mssql/availability_group | Returns summary information for Microsoft SQL availability groups
*MssqlApi* | [**queryMssqlDb**](docs/MssqlApi.md#queryMssqlDb) | **GET** /mssql/db | Get summary information for SQL Server databases
*MssqlApi* | [**queryMssqlDbSnapshot**](docs/MssqlApi.md#queryMssqlDbSnapshot) | **GET** /mssql/db/{id}/snapshot | Get summary information for snapshots of a Microsoft SQL database
*MssqlApi* | [**queryMssqlHostConfig**](docs/MssqlApi.md#queryMssqlHostConfig) | **GET** /mssql/host/configuration | Get the summary of SQL Server host configurations
*MssqlApi* | [**queryMssqlInstance**](docs/MssqlApi.md#queryMssqlInstance) | **GET** /mssql/instance | Get summary information for Microsoft SQL instances
*MssqlApi* | [**queryMssqlMount**](docs/MssqlApi.md#queryMssqlMount) | **GET** /mssql/db/mount | Get summary information for all Live Mounts SQL Server databases
*MssqlApi* | [**reseedSecondary**](docs/MssqlApi.md#reseedSecondary) | **POST** /mssql/db/log_shipping/{id}/reseed | Reseed a secondary database
*MssqlApi* | [**updateDefaultDbPropertiesV1**](docs/MssqlApi.md#updateDefaultDbPropertiesV1) | **PATCH** /mssql/db/defaults | Update the default properties for Microsoft SQL databases
*MssqlApi* | [**updateLogShippingConfiguration**](docs/MssqlApi.md#updateLogShippingConfiguration) | **PATCH** /mssql/db/log_shipping/{id} | Update a specified log shipping configuration
*MssqlApi* | [**updateMssqlAvailabilityGroupV1**](docs/MssqlApi.md#updateMssqlAvailabilityGroupV1) | **PATCH** /mssql/availability_group/{id} | Update a Microsoft SQL availability group
*MssqlApi* | [**updateMssqlDb**](docs/MssqlApi.md#updateMssqlDb) | **PATCH** /mssql/db/{id} | Update a Microsoft SQL database
*MssqlApi* | [**updateMssqlHostConfig**](docs/MssqlApi.md#updateMssqlHostConfig) | **PATCH** /mssql/host/configuration/{host_id} | Update host configuration
*MssqlApi* | [**updateMssqlInstance**](docs/MssqlApi.md#updateMssqlInstance) | **PATCH** /mssql/instance/{id} | Update a Microsoft SQL instance
*OracleApi* | [**bulkUpdateOracleDb**](docs/OracleApi.md#bulkUpdateOracleDb) | **PATCH** /oracle/db/bulk | Update Oracle Databases
*OracleApi* | [**bulkUpdateOracleHost**](docs/OracleApi.md#bulkUpdateOracleHost) | **PATCH** /oracle/host/bulk | Update Oracle Hosts
*OracleApi* | [**bulkUpdateOracleRac**](docs/OracleApi.md#bulkUpdateOracleRac) | **PATCH** /oracle/rac/bulk | Update Oracle RACs
*OracleApi* | [**createOracleValidateBackupJob**](docs/OracleApi.md#createOracleValidateBackupJob) | **POST** /oracle/db/{id}/validate | Validate Oracle database backups
*OracleApi* | [**deleteDownloadedSnapshots**](docs/OracleApi.md#deleteDownloadedSnapshots) | **DELETE** /oracle/db/{id}/downloaded_snapshots | Delete downloaded Oracle database snapshots and log snapshots
*OracleApi* | [**getAcoParameterList**](docs/OracleApi.md#getAcoParameterList) | **GET** /oracle/aco_parameter_list | List of supported Advanced Cloning Options
*OracleApi* | [**getExampleAcoDownloadLink**](docs/OracleApi.md#getExampleAcoDownloadLink) | **GET** /oracle/aco_example_download_link | Link to download the Advanced Recovery Options example file
*OracleApi* | [**getOracleDbV1**](docs/OracleApi.md#getOracleDbV1) | **GET** /oracle/db/{id} | Get Oracle database information
*OracleApi* | [**oracleRestoreEstimate**](docs/OracleApi.md#oracleRestoreEstimate) | **GET** /oracle/db/{id}/restore_estimate | Get a size estimate for a restore or export
*OracleApi* | [**queryOracleDbV1**](docs/OracleApi.md#queryOracleDbV1) | **GET** /oracle/db | Get summary information for Oracle databases
*OracleApi* | [**updateOracleDataGuardGroup**](docs/OracleApi.md#updateOracleDataGuardGroup) | **PATCH** /oracle/data_guard_group/{id} | Update an Oracle Data Guard group
*OracleApi* | [**updateOracleDbV1**](docs/OracleApi.md#updateOracleDbV1) | **PATCH** /oracle/db/{id} | Update an Oracle database
*OracleApi* | [**validateOracleAcoFile**](docs/OracleApi.md#validateOracleAcoFile) | **POST** /oracle/validate_aco_file | Validate Oracle ACO file
*OrganizationApi* | [**bulkCreateEnvoys**](docs/OrganizationApi.md#bulkCreateEnvoys) | **POST** /organization/{id}/envoy/bulk | Create a list of Rubrik Envoy objects
*OrganizationApi* | [**bulkDeleteEnvoys**](docs/OrganizationApi.md#bulkDeleteEnvoys) | **DELETE** /organization/{id}/envoy/bulk | Remove a list of Rubrik Envoy objects
*OrganizationApi* | [**bulkUpdateEnvoys**](docs/OrganizationApi.md#bulkUpdateEnvoys) | **PATCH** /organization/{id}/envoy/bulk | Update a list of Rubrik Envoy objects
*PrincipalApi* | [**assignRolesToPrincipals**](docs/PrincipalApi.md#assignRolesToPrincipals) | **POST** /principal/role | Assign roles to principals
*PrincipalApi* | [**getRolesForPrincipals**](docs/PrincipalApi.md#getRolesForPrincipals) | **GET** /principal/role | Get roles assigned to principals
*PrincipalApi* | [**revokeRolesFromPrincipals**](docs/PrincipalApi.md#revokeRolesFromPrincipals) | **POST** /principal/role/bulk_revoke | Revoke roles from principals
*PrincipalApi* | [**searchPrincipalsV1**](docs/PrincipalApi.md#searchPrincipalsV1) | **GET** /principal | Search for principals
*ReplicationApi* | [**disablePerLocationPause**](docs/ReplicationApi.md#disablePerLocationPause) | **POST** /replication/location_pause/disable | Resume replication from specified source clusters
*ReplicationApi* | [**enablePerLocationPause**](docs/ReplicationApi.md#enablePerLocationPause) | **POST** /replication/location_pause/enable | Pause replication from specified source clusters
*ReportsApi* | [**getComplianceSummarySLAV1**](docs/ReportsApi.md#getComplianceSummarySLAV1) | **GET** /report/compliance_summary_sla | Get compliance summary information
*ReportsApi* | [**getComplianceSummaryV1**](docs/ReportsApi.md#getComplianceSummaryV1) | **GET** /report/compliance_summary | Get compliance summary information
*ReportsApi* | [**setReportConfig**](docs/ReportsApi.md#setReportConfig) | **PATCH** /report/config | Modify the report config
*RoleApi* | [**createRole**](docs/RoleApi.md#createRole) | **POST** /role | Create a new role
*RoleApi* | [**deleteRole**](docs/RoleApi.md#deleteRole) | **DELETE** /role/{id} | Delete a role
*RoleApi* | [**getRole**](docs/RoleApi.md#getRole) | **GET** /role/{id} | Get role information for the specified role
*RoleApi* | [**getRoles**](docs/RoleApi.md#getRoles) | **GET** /role | Get all roles in an organization
*RoleApi* | [**updateRole**](docs/RoleApi.md#updateRole) | **PATCH** /role/{id} | Update role information
*SamlApi* | [**configRubrikSamlMetadata**](docs/SamlApi.md#configRubrikSamlMetadata) | **POST** /saml/rubrik_metadata | Configure and generate Rubrik SAML metadata
*SamlApi* | [**getSamlSsoStatus**](docs/SamlApi.md#getSamlSsoStatus) | **GET** /saml/sso_status | Check SAML SSO Status
*SamlApi* | [**makeSamlAuthnRequest**](docs/SamlApi.md#makeSamlAuthnRequest) | **POST** /saml/authn_request/{idp_name} | Make SAML authentication request
*SapHanaApi* | [**addSapHanaSystem**](docs/SapHanaApi.md#addSapHanaSystem) | **POST** /sap_hana/system | Add a SAP HANA system
*SapHanaApi* | [**configureSapHanaRestore**](docs/SapHanaApi.md#configureSapHanaRestore) | **POST** /sap_hana/db/{id}/configure_restore | Configure the target database for system copy restore
*SapHanaApi* | [**createOnDemandSapHanaBackup**](docs/SapHanaApi.md#createOnDemandSapHanaBackup) | **POST** /sap_hana/db/{id}/snapshot | Create on demand database snapshot
*SapHanaApi* | [**createSapHanaSystemRefresh**](docs/SapHanaApi.md#createSapHanaSystemRefresh) | **POST** /sap_hana/system/{id}/refresh | Refresh SAP HANA system metadata
*SapHanaApi* | [**deleteSapHanaDbSnapshot**](docs/SapHanaApi.md#deleteSapHanaDbSnapshot) | **DELETE** /sap_hana/db/snapshot/{id} | Delete a particular full snapshot of a SAP HANA database
*SapHanaApi* | [**deleteSapHanaSystem**](docs/SapHanaApi.md#deleteSapHanaSystem) | **DELETE** /sap_hana/system/{id} | Delete a SAP HANA system
*SapHanaApi* | [**getMissedSapHanaDbSnapshots**](docs/SapHanaApi.md#getMissedSapHanaDbSnapshots) | **GET** /sap_hana/db/{id}/missed_snapshot | Retrieve summary information for missed snapshots of a SAP HANA database
*SapHanaApi* | [**getSapHanaDatabase**](docs/SapHanaApi.md#getSapHanaDatabase) | **GET** /sap_hana/db/{id} | Get detailed information for an SAP HANA database
*SapHanaApi* | [**getSapHanaDbAsyncRequestStatus**](docs/SapHanaApi.md#getSapHanaDbAsyncRequestStatus) | **GET** /sap_hana/db/request/{id} | Get the status of a SAP HANA database request
*SapHanaApi* | [**getSapHanaDbRecoverableRanges**](docs/SapHanaApi.md#getSapHanaDbRecoverableRanges) | **GET** /sap_hana/db/{id}/recoverable_range | Get recoverable ranges of a SAP HANA database
*SapHanaApi* | [**getSapHanaDbSnapshot**](docs/SapHanaApi.md#getSapHanaDbSnapshot) | **GET** /sap_hana/db/snapshot/{id} | Get SAP HANA database snapshot details
*SapHanaApi* | [**getSapHanaSystem**](docs/SapHanaApi.md#getSapHanaSystem) | **GET** /sap_hana/system/{id} | Get summary information for a SAP HANA system
*SapHanaApi* | [**getSapHanaSystemAsyncRequestStatus**](docs/SapHanaApi.md#getSapHanaSystemAsyncRequestStatus) | **GET** /sap_hana/system/request/{id} | Get the status of a SAP HANA system request
*SapHanaApi* | [**patchSapHanaDatabase**](docs/SapHanaApi.md#patchSapHanaDatabase) | **PATCH** /sap_hana/db/{id} | Update the SLA Domain for an SAP HANA database
*SapHanaApi* | [**patchSapHanaSystem**](docs/SapHanaApi.md#patchSapHanaSystem) | **PATCH** /sap_hana/system/{id} | Update the SLA Domain for a SAP HANA system
*SapHanaApi* | [**querySapHanaDatabases**](docs/SapHanaApi.md#querySapHanaDatabases) | **GET** /sap_hana/db | Get summary information for discovered SAP HANA databases
*SapHanaApi* | [**querySapHanaDbSnapshot**](docs/SapHanaApi.md#querySapHanaDbSnapshot) | **GET** /sap_hana/db/{id}/snapshot | Get a summary list of snapshots for a SAP HANA database
*SapHanaApi* | [**querySapHanaSystems**](docs/SapHanaApi.md#querySapHanaSystems) | **GET** /sap_hana/system | Get summary information for added SAP HANA systems
*SapHanaApi* | [**unconfigureSapHanaRestore**](docs/SapHanaApi.md#unconfigureSapHanaRestore) | **POST** /sap_hana/db/{id}/unconfigure_restore | Reset the configuration for system copy restore on target database
*SessionApi* | [**createSession**](docs/SessionApi.md#createSession) | **POST** /session | Create user session
*SessionApi* | [**deleteSession**](docs/SessionApi.md#deleteSession) | **DELETE** /session/{id} | Delete user session
*SlaDomainApi* | [**assignSlaToDownloadedSnapshots**](docs/SlaDomainApi.md#assignSlaToDownloadedSnapshots) | **POST** /sla_domain/assign_to_downloaded_snapshots | Assign retention SLA Domain to the downloaded snapshots of a single object
*SlaDomainApi* | [**createSlaDomain**](docs/SlaDomainApi.md#createSlaDomain) | **POST** /sla_domain | Create SLA Domain
*SlaDomainApi* | [**deleteSlaDomain**](docs/SlaDomainApi.md#deleteSlaDomain) | **DELETE** /sla_domain/{id} | Remove SLA Domain
*SlaDomainApi* | [**getSlaDomain**](docs/SlaDomainApi.md#getSlaDomain) | **GET** /sla_domain/{id} | Get SLA Domain details
*SlaDomainApi* | [**patchSlaDomain**](docs/SlaDomainApi.md#patchSlaDomain) | **PATCH** /sla_domain/{id} | Patch SLA Domain
*SlaDomainApi* | [**querySlaDomain**](docs/SlaDomainApi.md#querySlaDomain) | **GET** /sla_domain | Get list of SLA Domains
*SlaDomainApi* | [**updateSlaDomain**](docs/SlaDomainApi.md#updateSlaDomain) | **PUT** /sla_domain/{id} | Update SLA Domain
*SnapshotApi* | [**getSnapshotStorageStatsV1**](docs/SnapshotApi.md#getSnapshotStorageStatsV1) | **GET** /snapshot/{id}/storage/stats | Returns storage stats for a snapshot
*UnmanagedObjectApi* | [**assignToRetentionSlaAsync**](docs/UnmanagedObjectApi.md#assignToRetentionSlaAsync) | **POST** /unmanaged_object/assign_retention_sla | Assign relic/unmanaged entities to an SLA Domain for managing retention asynchronously
*UnmanagedObjectApi* | [**bulkTierExistingSnapshots**](docs/UnmanagedObjectApi.md#bulkTierExistingSnapshots) | **POST** /unmanaged_object/snapshot/bulk_archive_tier | Bulk tier existing snapshots to cold storage
*UnmanagedObjectApi* | [**queryUnmanagedObjectSnapshotsV1**](docs/UnmanagedObjectApi.md#queryUnmanagedObjectSnapshotsV1) | **GET** /unmanaged_object/{id}/snapshot | Get summary of all the snapshots for a given object
*UnmanagedObjectApi* | [**queryUnmanagedObjectV1**](docs/UnmanagedObjectApi.md#queryUnmanagedObjectV1) | **GET** /unmanaged_object | Get summary of all the objects with unmanaged snapshots
*UnmanagedObjectApi* | [**queryUnmanagedReaderObject**](docs/UnmanagedObjectApi.md#queryUnmanagedReaderObject) | **GET** /unmanaged_object/reader_object | Get summary of all unmanaged reader objects
*UserApi* | [**generateTotpSecret**](docs/UserApi.md#generateTotpSecret) | **POST** /user/{id}/totp/new_secret | Generate a TOTP secret key for the given user
*UserApi* | [**getTotpStatus**](docs/UserApi.md#getTotpStatus) | **GET** /user/{id}/totp/status | Get the TOTP status for the given user
*UserApi* | [**getUserAccountLockoutSettings**](docs/UserApi.md#getUserAccountLockoutSettings) | **GET** /user/lockout | Get the local user account lockout settings
*UserApi* | [**manageUserAccountLockoutSettings**](docs/UserApi.md#manageUserAccountLockoutSettings) | **PATCH** /user/lockout | Update the local user account lockout settings
*UserApi* | [**resetTotp**](docs/UserApi.md#resetTotp) | **DELETE** /user/{id}/totp/config | Reset the TOTP for the given user
*UserApi* | [**setupTotp**](docs/UserApi.md#setupTotp) | **PUT** /user/{id}/totp/config | Configure the TOTP secret for the given user
*UserApi* | [**unlockUser**](docs/UserApi.md#unlockUser) | **POST** /user/{id}/unlock | Unlock a user account
*UserDefinedTagApi* | [**createUserDefinedTag**](docs/UserDefinedTagApi.md#createUserDefinedTag) | **POST** /user_defined_tag | Create a user-defined resource tag for tagging cloud compute resources
*UserDefinedTagApi* | [**deleteUserDefinedTag**](docs/UserDefinedTagApi.md#deleteUserDefinedTag) | **DELETE** /user_defined_tag/{id} | Delete a user-defined resource tag
*UserDefinedTagApi* | [**deleteUserDefinedTagBulk**](docs/UserDefinedTagApi.md#deleteUserDefinedTagBulk) | **DELETE** /user_defined_tag | Delete a list of user-defined resource tags
*UserDefinedTagApi* | [**getUserDefinedTag**](docs/UserDefinedTagApi.md#getUserDefinedTag) | **GET** /user_defined_tag/{id} | Get user-defined tag
*UserDefinedTagApi* | [**queryUserDefinedTag**](docs/UserDefinedTagApi.md#queryUserDefinedTag) | **GET** /user_defined_tag | Get user-defined resource tags
*UserDefinedTagApi* | [**updateUserDefinedTag**](docs/UserDefinedTagApi.md#updateUserDefinedTag) | **PATCH** /user_defined_tag/{id} | Update the value of a user-defined resource tag
*VcdClusterApi* | [**createVcdClusterV1**](docs/VcdClusterApi.md#createVcdClusterV1) | **POST** /vcd/cluster | Add a vCD Cluster
*VcdClusterApi* | [**deleteVcdClusterV1**](docs/VcdClusterApi.md#deleteVcdClusterV1) | **DELETE** /vcd/cluster/{id} | Remove vCD Cluster
*VcdClusterApi* | [**getVcdClusterAsyncRequestStatusV1**](docs/VcdClusterApi.md#getVcdClusterAsyncRequestStatusV1) | **GET** /vcd/cluster/request/{id} | Get vCD Cluster job status
*VcdClusterApi* | [**getVcdClusterV1**](docs/VcdClusterApi.md#getVcdClusterV1) | **GET** /vcd/cluster/{id} | Get vCD Cluster details
*VcdClusterApi* | [**queryVcdClusterV1**](docs/VcdClusterApi.md#queryVcdClusterV1) | **GET** /vcd/cluster | Get summary for all vCD Clusters
*VcdClusterApi* | [**queryVcdVimServerV1**](docs/VcdClusterApi.md#queryVcdVimServerV1) | **GET** /vcd/cluster/{id}/vimserver | Get VimServers of a vCD Cluster
*VcdClusterApi* | [**refreshVcdClusterV1**](docs/VcdClusterApi.md#refreshVcdClusterV1) | **POST** /vcd/cluster/{id}/refresh | Refresh a vCD Cluster
*VcdClusterApi* | [**updateVcdClusterV1**](docs/VcdClusterApi.md#updateVcdClusterV1) | **PATCH** /vcd/cluster/{id} | Change vCD Cluster object
*VcdHierarchyApi* | [**getVcdHierarchyChildrenV1**](docs/VcdHierarchyApi.md#getVcdHierarchyChildrenV1) | **GET** /vcd/hierarchy/{id}/children | Get immediate descendant objects
*VcdHierarchyApi* | [**getVcdHierarchyDescendantsV1**](docs/VcdHierarchyApi.md#getVcdHierarchyDescendantsV1) | **GET** /vcd/hierarchy/{id}/descendants | Get list of descendant objects
*VcdHierarchyApi* | [**getVcdHierarchyObjectV1**](docs/VcdHierarchyApi.md#getVcdHierarchyObjectV1) | **GET** /vcd/hierarchy/{id} | Get summary of a vCD hierarchy object
*VcdVappApi* | [**createOnDemandSnapshotV1**](docs/VcdVappApi.md#createOnDemandSnapshotV1) | **POST** /vcd/vapp/{id}/snapshot | Create an on-demand snapshot for a vApp
*VcdVappApi* | [**createVappExportV1**](docs/VcdVappApi.md#createVappExportV1) | **POST** /vcd/vapp/snapshot/{snapshot_id}/export | Export vApp snapshot
*VcdVappApi* | [**createVappInstantRecoveryV1**](docs/VcdVappApi.md#createVappInstantRecoveryV1) | **POST** /vcd/vapp/snapshot/{snapshot_id}/instant_recover | Instant Recovery of vApp virtual machines
*VcdVappApi* | [**createVappTemplateSnapshotExport**](docs/VcdVappApi.md#createVappTemplateSnapshotExport) | **POST** /vcd/vapp/template/snapshot/{snapshot_id}/export | Export of a vApp template snapshot
*VcdVappApi* | [**createVcdVappDownloadSnapshotFromCloudV1**](docs/VcdVappApi.md#createVcdVappDownloadSnapshotFromCloudV1) | **POST** /vcd/vapp/snapshot/{id}/download | Download snapshot from archive
*VcdVappApi* | [**deleteVappSnapshotV1**](docs/VcdVappApi.md#deleteVappSnapshotV1) | **DELETE** /vcd/vapp/snapshot/{id} | Delete a vApp snapshot
*VcdVappApi* | [**deleteVappSnapshotsV1**](docs/VcdVappApi.md#deleteVappSnapshotsV1) | **DELETE** /vcd/vapp/{id}/snapshot | Delete all snapshots of vApp
*VcdVappApi* | [**getVappAsyncRequestStatusV1**](docs/VcdVappApi.md#getVappAsyncRequestStatusV1) | **GET** /vcd/vapp/request/{id} | Get vApp job status
*VcdVappApi* | [**getVappSnapshotExportOptionsV1**](docs/VcdVappApi.md#getVappSnapshotExportOptionsV1) | **GET** /vcd/vapp/snapshot/{snapshot_id}/export/options | Get exportable network configurations
*VcdVappApi* | [**getVappSnapshotInstantRecoveryOptionsV1**](docs/VcdVappApi.md#getVappSnapshotInstantRecoveryOptionsV1) | **GET** /vcd/vapp/snapshot/{snapshot_id}/instant_recover/options | Get Instant Recovery information
*VcdVappApi* | [**getVappSnapshotV1**](docs/VcdVappApi.md#getVappSnapshotV1) | **GET** /vcd/vapp/snapshot/{id} | Get vApp snapshot details
*VcdVappApi* | [**getVappTemplateSnapshotExportOptions**](docs/VcdVappApi.md#getVappTemplateSnapshotExportOptions) | **GET** /vcd/vapp/template/snapshot/{snapshot_id}/export/options | Get Export information for a vApp template snapshot
*VcdVappApi* | [**getVcdVappV1**](docs/VcdVappApi.md#getVcdVappV1) | **GET** /vcd/vapp/{id} | Get details of a specific vApp
*VcdVappApi* | [**queryVappSnapshotV1**](docs/VcdVappApi.md#queryVappSnapshotV1) | **GET** /vcd/vapp/{id}/snapshot | Get list of snapshots of vApp
*VcdVappApi* | [**queryVcdVappsV1**](docs/VcdVappApi.md#queryVcdVappsV1) | **GET** /vcd/vapp | Get summary for vApps
*VcdVappApi* | [**searchVappV1**](docs/VcdVappApi.md#searchVappV1) | **GET** /vcd/vapp/{id}/search | Search for a file in a vApp
*VcdVappApi* | [**updateVcdVappV1**](docs/VcdVappApi.md#updateVcdVappV1) | **PATCH** /vcd/vapp/{id} | Update vApp
*VcdVappApi* | [**vcdMissedSnapshotsV1**](docs/VcdVappApi.md#vcdMissedSnapshotsV1) | **GET** /vcd/vapp/{id}/missed_snapshot | Get details about missed snapshots for a vApp
*VmwareComputeClusterApi* | [**getAsyncRequestStatusForComputeCluster**](docs/VmwareComputeClusterApi.md#getAsyncRequestStatusForComputeCluster) | **GET** /vmware/compute_cluster/request/{id} | Get asynchronous request details for VMware cluster
*VmwareComputeClusterApi* | [**getComputeCluster**](docs/VmwareComputeClusterApi.md#getComputeCluster) | **GET** /vmware/compute_cluster/{id} | Get details for the compute cluster
*VmwareComputeClusterApi* | [**getIoFilters**](docs/VmwareComputeClusterApi.md#getIoFilters) | **GET** /vmware/compute_cluster/{id}/io_filter | Get the ioFilters on the VMware compute cluster with a specific ID
*VmwareComputeClusterApi* | [**installIoFilter**](docs/VmwareComputeClusterApi.md#installIoFilter) | **POST** /vmware/compute_cluster/{id}/install_io_filter | Install the Rubrik ioFilter to the VMware cluster with a specific ID
*VmwareComputeClusterApi* | [**queryComputeCluster**](docs/VmwareComputeClusterApi.md#queryComputeCluster) | **GET** /vmware/compute_cluster | Get all the clusters belonging to this datacenter
*VmwareComputeClusterApi* | [**uninstallIoFilter**](docs/VmwareComputeClusterApi.md#uninstallIoFilter) | **POST** /vmware/compute_cluster/{id}/uninstall_io_filter | Uninstall the Rubrik ioFilter from the VMware cluster with a specific ID
*VmwareComputeClusterApi* | [**updateComputeCluster**](docs/VmwareComputeClusterApi.md#updateComputeCluster) | **PATCH** /vmware/compute_cluster/{id} | Modify information for a VMware compute cluster
*VmwareComputeClusterApi* | [**upgradeIoFilter**](docs/VmwareComputeClusterApi.md#upgradeIoFilter) | **POST** /vmware/compute_cluster/{id}/upgrade_io_filter | Upgrade the Rubrik ioFilter for the VMware cluster with a specific ID
*VmwareConfigApi* | [**getPreferredCdpNetworkProtocol**](docs/VmwareConfigApi.md#getPreferredCdpNetworkProtocol) | **GET** /vmware/config/cdp/get_preferred_cdp_network_protocol | Returns the current preference of CDM between IPv4 and IPv6 for CDP data transfer
*VmwareConfigApi* | [**getVmwareRecoveryNetworks**](docs/VmwareConfigApi.md#getVmwareRecoveryNetworks) | **GET** /vmware/config/recovery/networks | Get all the VMware recovery networks for a compute resource ID
*VmwareConfigApi* | [**setPreferredCdpNetworkProtocol**](docs/VmwareConfigApi.md#setPreferredCdpNetworkProtocol) | **PATCH** /vmware/config/cdp/set_preferred_cdp_network_protocol | Set the current preference of CDM between IPv4 and IPv6 for CDP data transfer
*VmwareHierarchyApi* | [**getVmwareHierarchyExport**](docs/VmwareHierarchyApi.md#getVmwareHierarchyExport) | **GET** /vmware/hierarchy/export | Get Available VMware Hierarchy Objects for Export Operations
*VmwareHierarchyApi* | [**getVmwareHierarchyObject**](docs/VmwareHierarchyApi.md#getVmwareHierarchyObject) | **GET** /vmware/hierarchy/{id}/export | Get VMware Hierarchy Object Information
*VmwareHostApi* | [**getVmwareHost**](docs/VmwareHostApi.md#getVmwareHost) | **GET** /vmware/host/{id} | Get details of a ESXi hypervisor
*VmwareHostApi* | [**getVmwareHostDatastore**](docs/VmwareHostApi.md#getVmwareHostDatastore) | **GET** /vmware/host/{id}/datastore | Get details of datastores in a ESXi hypervisor
*VmwareHostApi* | [**queryVmwareHost**](docs/VmwareHostApi.md#queryVmwareHost) | **GET** /vmware/host | Get summary of all the ESXi hypervisor
*VmwareHostApi* | [**updateVmwareHost**](docs/VmwareHostApi.md#updateVmwareHost) | **PATCH** /vmware/host/{id} | Update the SLA Domain for an ESXi hypervisor
*VmwareVcenterApi* | [**createRefresh**](docs/VmwareVcenterApi.md#createRefresh) | **POST** /vmware/vcenter/{id}/refresh | Refresh vCenter Server metadata
*VmwareVcenterApi* | [**createRefreshVmV1**](docs/VmwareVcenterApi.md#createRefreshVmV1) | **POST** /vmware/vcenter/{id}/refresh_vm | Refresh single virtual machine metadata in a vcenter
*VmwareVcenterApi* | [**createVcenter**](docs/VmwareVcenterApi.md#createVcenter) | **POST** /vmware/vcenter | Add vCenter Server
*VmwareVcenterApi* | [**deleteVcenter**](docs/VmwareVcenterApi.md#deleteVcenter) | **DELETE** /vmware/vcenter/{id} | Remove vCenter Server
*VmwareVcenterApi* | [**getHotAddBandwidth**](docs/VmwareVcenterApi.md#getHotAddBandwidth) | **GET** /vmware/vcenter/{id}/hotadd/bandwidth | Get the ingest and export bandwidth limits for HotAdd with the vCenter
*VmwareVcenterApi* | [**getHotAddNetwork**](docs/VmwareVcenterApi.md#getHotAddNetwork) | **GET** /vmware/vcenter/{id}/hotadd/network | Retrieve the user-configured network for HotAdd operations
*VmwareVcenterApi* | [**getNetworks**](docs/VmwareVcenterApi.md#getNetworks) | **GET** /vmware/vcenter/{id}/networks | Get the user-configured networks in the vCenter
*VmwareVcenterApi* | [**getNumProxiesNeeded**](docs/VmwareVcenterApi.md#getNumProxiesNeeded) | **GET** /vmware/vcenter/{id}/hotadd/needed | Get the number of HotAdd proxies needed for the vCenter
*VmwareVcenterApi* | [**getVcenter**](docs/VmwareVcenterApi.md#getVcenter) | **GET** /vmware/vcenter/{id} | Get the details of a vCenter Server
*VmwareVcenterApi* | [**getVcenterAsyncRequestStatus**](docs/VmwareVcenterApi.md#getVcenterAsyncRequestStatus) | **GET** /vmware/vcenter/request/{id} | Get vCenter Server async request
*VmwareVcenterApi* | [**patchVcenter**](docs/VmwareVcenterApi.md#patchVcenter) | **PATCH** /vmware/vcenter/{id} | Update the SLA Domain for a vCenter Server
*VmwareVcenterApi* | [**queryHotAddProxyVm**](docs/VmwareVcenterApi.md#queryHotAddProxyVm) | **GET** /vmware/vcenter/hotadd/vm | Get a list of HotAdd proxy virtual machines
*VmwareVcenterApi* | [**queryVcenter**](docs/VmwareVcenterApi.md#queryVcenter) | **GET** /vmware/vcenter | Get list of vCenters
*VmwareVcenterApi* | [**setHotAddBandwidth**](docs/VmwareVcenterApi.md#setHotAddBandwidth) | **POST** /vmware/vcenter/{id}/hotadd/bandwidth | Set the ingest and export bandwidth limits for HotAdd with the vCenter
*VmwareVcenterApi* | [**setHotAddNetwork**](docs/VmwareVcenterApi.md#setHotAddNetwork) | **POST** /vmware/vcenter/{id}/hotadd/network | Set the user-configured network for HotAdd backup and recovery
*VmwareVcenterApi* | [**updateVcenter**](docs/VmwareVcenterApi.md#updateVcenter) | **PUT** /vmware/vcenter/{id} | Update vCenter Server
*VmwareVmApi* | [**batchMountSnapshot**](docs/VmwareVmApi.md#batchMountSnapshot) | **POST** /vmware/vm/batch_mount | Live mount a snapshot each from a set of virtual machines
*VmwareVmApi* | [**browseVmwareSnapshot**](docs/VmwareVmApi.md#browseVmwareSnapshot) | **GET** /vmware/vm/snapshot/{id}/browse | List files in VM snapshot
*VmwareVmApi* | [**bulkCreateOnDemandBackup**](docs/VmwareVmApi.md#bulkCreateOnDemandBackup) | **POST** /vmware/vm/snapshot/bulk | Take an on-demand snapshot of multiple virtual machines
*VmwareVmApi* | [**createDownloadFileJob**](docs/VmwareVmApi.md#createDownloadFileJob) | **POST** /vmware/vm/snapshot/{id}/download_file | Download file from VM snapshot
*VmwareVmApi* | [**createDownloadSnapshotFromCloud**](docs/VmwareVmApi.md#createDownloadSnapshotFromCloud) | **POST** /vmware/vm/snapshot/{id}/download | Download snapshot from archive
*VmwareVmApi* | [**createExportV1**](docs/VmwareVmApi.md#createExportV1) | **POST** /vmware/vm/snapshot/{id}/export | Export VM snapshot
*VmwareVmApi* | [**createExportWithDownloadFromCloudV1**](docs/VmwareVmApi.md#createExportWithDownloadFromCloudV1) | **POST** /vmware/vm/snapshot/{id}/export_with_download | Download a snapshot from an archival location, then export a virtual machine using the downloaded snapshot
*VmwareVmApi* | [**createInstantRecovery**](docs/VmwareVmApi.md#createInstantRecovery) | **POST** /vmware/vm/snapshot/{id}/instant_recover | Instantly recover a VM
*VmwareVmApi* | [**createMountV1**](docs/VmwareVmApi.md#createMountV1) | **POST** /vmware/vm/snapshot/{id}/mount | Live mount a VM from a snapshot
*VmwareVmApi* | [**createOnDemandBackup**](docs/VmwareVmApi.md#createOnDemandBackup) | **POST** /vmware/vm/{id}/snapshot | Create an on-demand snapshot for a VM
*VmwareVmApi* | [**createRestoreFileJob**](docs/VmwareVmApi.md#createRestoreFileJob) | **POST** /vmware/vm/snapshot/{id}/restore_file | Restore file from VM snapshot
*VmwareVmApi* | [**createUnmount**](docs/VmwareVmApi.md#createUnmount) | **DELETE** /vmware/vm/snapshot/mount/{id} | Delete a Live Mount VM
*VmwareVmApi* | [**deleteVmwareSnapshot**](docs/VmwareVmApi.md#deleteVmwareSnapshot) | **DELETE** /vmware/vm/snapshot/{id} | Delete VM snapshot
*VmwareVmApi* | [**deleteVmwareSnapshots**](docs/VmwareVmApi.md#deleteVmwareSnapshots) | **DELETE** /vmware/vm/{id}/snapshot | Delete all snapshots of VM
*VmwareVmApi* | [**getAsyncRequestStatus**](docs/VmwareVmApi.md#getAsyncRequestStatus) | **GET** /vmware/vm/request/{id} | Get asynchronous request details for VM
*VmwareVmApi* | [**getMountV1**](docs/VmwareVmApi.md#getMountV1) | **GET** /vmware/vm/snapshot/mount/{id} | Get information for a Live Mount
*VmwareVmApi* | [**getSnapshot**](docs/VmwareVmApi.md#getSnapshot) | **GET** /vmware/vm/snapshot/{id} | Get VM snapshot details
*VmwareVmApi* | [**getVirtualDisk**](docs/VmwareVmApi.md#getVirtualDisk) | **GET** /vmware/vm/virtual_disk/{id} | Details about the specific Virtual Disk
*VmwareVmApi* | [**getVm**](docs/VmwareVmApi.md#getVm) | **GET** /vmware/vm/{id} | Get VM details
*VmwareVmApi* | [**getVmForceFullSpec**](docs/VmwareVmApi.md#getVmForceFullSpec) | **GET** /vmware/vm/{id}/request/force_full_snapshot | Retrieve the configuration for forcing a full snapshot of a VMware virtual machine
*VmwareVmApi* | [**getVmwareCdpLiveInfo**](docs/VmwareVmApi.md#getVmwareCdpLiveInfo) | **POST** /vmware/vm/cdp | Returns the live CDP info for a set of CDP-enabled virtual machines
*VmwareVmApi* | [**getVmwareCdpStateInfo**](docs/VmwareVmApi.md#getVmwareCdpStateInfo) | **POST** /vmware/vm/cdp_state | Returns CDP state info for a set of virtual machines
*VmwareVmApi* | [**getVmwareMissedRecoverableRanges**](docs/VmwareVmApi.md#getVmwareMissedRecoverableRanges) | **GET** /vmware/vm/{id}/missed_recoverable_range | Get missed time ranges for point in time recovery
*VmwareVmApi* | [**getVmwareRecoverableRanges**](docs/VmwareVmApi.md#getVmwareRecoverableRanges) | **GET** /vmware/vm/{id}/recoverable_range | Get available time ranges for point in time recovery
*VmwareVmApi* | [**getVmwareVmMissedRecoverableRangesInBatch**](docs/VmwareVmApi.md#getVmwareVmMissedRecoverableRangesInBatch) | **POST** /vmware/vm/missed_recoverable_range | Returns the recoverable ranges that were missed for a set of CDP-enabled virtual machines
*VmwareVmApi* | [**getVmwareVmRecoverableRangesInBatch**](docs/VmwareVmApi.md#getVmwareVmRecoverableRangesInBatch) | **POST** /vmware/vm/recoverable_range | Returns the recoverable ranges for a set of CDP-enabled virtual machines
*VmwareVmApi* | [**missedSnapshots**](docs/VmwareVmApi.md#missedSnapshots) | **GET** /vmware/vm/{id}/missed_snapshot | Get details about missed snapshots for a VM
*VmwareVmApi* | [**queryMountV1**](docs/VmwareVmApi.md#queryMountV1) | **GET** /vmware/vm/snapshot/mount | Get Live Mount information
*VmwareVmApi* | [**querySnapshot**](docs/VmwareVmApi.md#querySnapshot) | **GET** /vmware/vm/{id}/snapshot | Get list of snapshots of VM
*VmwareVmApi* | [**querySnapshotsForVms**](docs/VmwareVmApi.md#querySnapshotsForVms) | **POST** /vmware/vm/snapshots | Get snapshot information for a list of virtual machines
*VmwareVmApi* | [**queryVm**](docs/VmwareVmApi.md#queryVm) | **GET** /vmware/vm | Get list of VMs
*VmwareVmApi* | [**relocateMount**](docs/VmwareVmApi.md#relocateMount) | **POST** /vmware/vm/snapshot/mount/{id}/relocate | Relocate a virtual machine to another datastore
*VmwareVmApi* | [**requestVmForceFullSnapshot**](docs/VmwareVmApi.md#requestVmForceFullSnapshot) | **POST** /vmware/vm/{id}/request/force_full_snapshot | Request a full snapshot for the next backup job of a VMware virtual machine
*VmwareVmApi* | [**runGuestOsScript**](docs/VmwareVmApi.md#runGuestOsScript) | **POST** /vmware/vm/{id}/guest_script/run | Run guest OS script
*VmwareVmApi* | [**searchVm**](docs/VmwareVmApi.md#searchVm) | **GET** /vmware/vm/{id}/search | Search for a file from a VM
*VmwareVmApi* | [**updateMount**](docs/VmwareVmApi.md#updateMount) | **PATCH** /vmware/vm/snapshot/mount/{id} | Power a Live Mount on and off
*VmwareVmApi* | [**updateVirtualDisk**](docs/VmwareVmApi.md#updateVirtualDisk) | **PATCH** /vmware/vm/virtual_disk/{id} | Update a specific Virtual Disk
*VmwareVmApi* | [**updateVm**](docs/VmwareVmApi.md#updateVm) | **PATCH** /vmware/vm/{id} | Update VM
*VmwareVmApi* | [**vmMakePrimary**](docs/VmwareVmApi.md#vmMakePrimary) | **POST** /vmware/vm/make_primary | Make this cluster the primary for agents on a set of VMs
*VmwareVmApi* | [**vmRegisterAgent**](docs/VmwareVmApi.md#vmRegisterAgent) | **POST** /vmware/vm/{id}/register_agent | Register Rubrik Backup Service
*VolumeGroupApi* | [**createOnDemandVolumeGroupBackup**](docs/VolumeGroupApi.md#createOnDemandVolumeGroupBackup) | **POST** /volume_group/{id}/snapshot | Create on-demand snapshot for the Volume Group
*VolumeGroupApi* | [**getVolumeGroup**](docs/VolumeGroupApi.md#getVolumeGroup) | **GET** /volume_group/{id} | Get Volume Group details
*VolumeGroupApi* | [**getVolumeGroupForceFullSpec**](docs/VolumeGroupApi.md#getVolumeGroupForceFullSpec) | **GET** /volume_group/{id}/request/force_full_snapshot | Retrieve the configuration for forcing a full snapshot
*VolumeGroupApi* | [**getVolumeGroupSnapshot**](docs/VolumeGroupApi.md#getVolumeGroupSnapshot) | **GET** /volume_group/snapshot/{id} | Get Volume Group snapshot details
*VolumeGroupApi* | [**getVolumeGroupSnapshotMount**](docs/VolumeGroupApi.md#getVolumeGroupSnapshotMount) | **GET** /volume_group/snapshot/mount/{id} | Get summary information for a mount
*VolumeGroupApi* | [**patchVolumeGroup**](docs/VolumeGroupApi.md#patchVolumeGroup) | **PATCH** /volume_group/{id} | Update Volume Group properties
*VolumeGroupApi* | [**queryVolumeGroup**](docs/VolumeGroupApi.md#queryVolumeGroup) | **GET** /volume_group | Get list of Volume Groups
*VolumeGroupApi* | [**queryVolumeGroupLatestSnapshot**](docs/VolumeGroupApi.md#queryVolumeGroupLatestSnapshot) | **GET** /volume_group/{id}/latest_snapshot | Get the latest snapshot of the Volume Group
*VolumeGroupApi* | [**queryVolumeGroupSnapshot**](docs/VolumeGroupApi.md#queryVolumeGroupSnapshot) | **GET** /volume_group/{id}/snapshot | Get list of snapshots of the Volume Group
*VolumeGroupApi* | [**queryVolumeGroupSnapshotMount**](docs/VolumeGroupApi.md#queryVolumeGroupSnapshotMount) | **GET** /volume_group/snapshot/mount | Get summary information for all mounts
*VolumeGroupApi* | [**requestVolumeGroupForceFullSnapshot**](docs/VolumeGroupApi.md#requestVolumeGroupForceFullSnapshot) | **POST** /volume_group/{id}/request/force_full_snapshot | Request a full snapshot on the next backup job of a Volume Group
*WindowsClusterApi* | [**getWindowsCluster**](docs/WindowsClusterApi.md#getWindowsCluster) | **GET** /windows_cluster/{id} | Get detailed information for a Windows cluster
*WindowsClusterApi* | [**queryWindowsCluster**](docs/WindowsClusterApi.md#queryWindowsCluster) | **GET** /windows_cluster | Get summary information for Windows clusters


## Documentation for Models

 - [ActionDetails](docs/ActionDetails.md)
 - [ActivityLogSummaryV1](docs/ActivityLogSummaryV1.md)
 - [ActivityLogSummaryV1ListResponse](docs/ActivityLogSummaryV1ListResponse.md)
 - [AdaptiveThrottlingSettingsVmwareFields](docs/AdaptiveThrottlingSettingsVmwareFields.md)
 - [AdvancedLdapConfiguration](docs/AdvancedLdapConfiguration.md)
 - [AdvancedUiConfigAttributes](docs/AdvancedUiConfigAttributes.md)
 - [AgentSecondaryCertificateInfo](docs/AgentSecondaryCertificateInfo.md)
 - [AgentSecondaryCertificateInfoListResponse](docs/AgentSecondaryCertificateInfoListResponse.md)
 - [AgentStatus](docs/AgentStatus.md)
 - [AppSearchResponse](docs/AppSearchResponse.md)
 - [AppSearchResponseListResponse](docs/AppSearchResponseListResponse.md)
 - [ApplyLegalHoldDefinition](docs/ApplyLegalHoldDefinition.md)
 - [ArchivalSpec](docs/ArchivalSpec.md)
 - [ArchivalSpecV2](docs/ArchivalSpecV2.md)
 - [ArchivalTieringSpec](docs/ArchivalTieringSpec.md)
 - [AsyncRequestStatus](docs/AsyncRequestStatus.md)
 - [AuthDomainType](docs/AuthDomainType.md)
 - [AvailableVersionInfo](docs/AvailableVersionInfo.md)
 - [AwsEc2InstanceSlaObjectCount](docs/AwsEc2InstanceSlaObjectCount.md)
 - [BackupTaskDiagnosticInfo](docs/BackupTaskDiagnosticInfo.md)
 - [BackupWindow](docs/BackupWindow.md)
 - [BaseGuestCredential](docs/BaseGuestCredential.md)
 - [BaseGuestCredentialDetail](docs/BaseGuestCredentialDetail.md)
 - [BaseOnDemandSnapshotConfig](docs/BaseOnDemandSnapshotConfig.md)
 - [BaseSnapshotDetail](docs/BaseSnapshotDetail.md)
 - [BaseSnapshotSummary](docs/BaseSnapshotSummary.md)
 - [BatchAsyncRequest](docs/BatchAsyncRequest.md)
 - [BatchAsyncRequestStatus](docs/BatchAsyncRequestStatus.md)
 - [BatchMountSnapshotJobConfig](docs/BatchMountSnapshotJobConfig.md)
 - [BatchVmSnapshotSummaries](docs/BatchVmSnapshotSummaries.md)
 - [BatchVmwareCdpLiveInfo](docs/BatchVmwareCdpLiveInfo.md)
 - [BatchVmwareCdpStateInfo](docs/BatchVmwareCdpStateInfo.md)
 - [BatchVmwareVmMissedRecoverableRanges](docs/BatchVmwareVmMissedRecoverableRanges.md)
 - [BatchVmwareVmMissedRecoverableRangesRequest](docs/BatchVmwareVmMissedRecoverableRangesRequest.md)
 - [BatchVmwareVmRecoverableRanges](docs/BatchVmwareVmRecoverableRanges.md)
 - [BatchVmwareVmRecoverableRangesRequest](docs/BatchVmwareVmRecoverableRangesRequest.md)
 - [BlackoutWindow](docs/BlackoutWindow.md)
 - [BlackoutWindowResponseInfo](docs/BlackoutWindowResponseInfo.md)
 - [BlackoutWindowStatus](docs/BlackoutWindowStatus.md)
 - [BlackoutWindows](docs/BlackoutWindows.md)
 - [BooleanResponse](docs/BooleanResponse.md)
 - [BootstrappableNodeInfoV1](docs/BootstrappableNodeInfoV1.md)
 - [BootstrappableNodeIpv4Info](docs/BootstrappableNodeIpv4Info.md)
 - [BrowseResponse](docs/BrowseResponse.md)
 - [BrowseResponseListResponse](docs/BrowseResponseListResponse.md)
 - [BulkDeleteObjectSnapshotsConfig](docs/BulkDeleteObjectSnapshotsConfig.md)
 - [BulkDeleteSnapshotsConfig](docs/BulkDeleteSnapshotsConfig.md)
 - [BulkOnDemandSnapshotJobConfig](docs/BulkOnDemandSnapshotJobConfig.md)
 - [BulkOracleDbDetails](docs/BulkOracleDbDetails.md)
 - [BulkOracleHostDetails](docs/BulkOracleHostDetails.md)
 - [BulkOracleRacDetails](docs/BulkOracleRacDetails.md)
 - [BulkShareAddResponse](docs/BulkShareAddResponse.md)
 - [BulkSlaConflictsSummary](docs/BulkSlaConflictsSummary.md)
 - [BulkTierSnapshotsConfig](docs/BulkTierSnapshotsConfig.md)
 - [CdpLocalStatus](docs/CdpLocalStatus.md)
 - [CdpReplicationStatus](docs/CdpReplicationStatus.md)
 - [CdpState](docs/CdpState.md)
 - [CertificateImportRequest](docs/CertificateImportRequest.md)
 - [CertificateListSortAttributes](docs/CertificateListSortAttributes.md)
 - [CertificatePatchRequest](docs/CertificatePatchRequest.md)
 - [CertificateSummary](docs/CertificateSummary.md)
 - [CertificateSummaryListResponse](docs/CertificateSummaryListResponse.md)
 - [CloudInstantiationSpec](docs/CloudInstantiationSpec.md)
 - [CloudOutComputeForecastSummaries](docs/CloudOutComputeForecastSummaries.md)
 - [CloudOutComputeForecastSummary](docs/CloudOutComputeForecastSummary.md)
 - [CloudOutForecastRequest](docs/CloudOutForecastRequest.md)
 - [CloudOutForecastSlaParameters](docs/CloudOutForecastSlaParameters.md)
 - [CloudOutForecastSummary](docs/CloudOutForecastSummary.md)
 - [CloudOutStorageForecastSummaries](docs/CloudOutStorageForecastSummaries.md)
 - [CloudOutStorageForecastSummary](docs/CloudOutStorageForecastSummary.md)
 - [CloudStorageColdTier](docs/CloudStorageColdTier.md)
 - [CloudStorageRehydrationSpeed](docs/CloudStorageRehydrationSpeed.md)
 - [ClusterApiVersion](docs/ClusterApiVersion.md)
 - [ClusterCertificate](docs/ClusterCertificate.md)
 - [ClusterGeolocation](docs/ClusterGeolocation.md)
 - [ClusterHostGroupInfo](docs/ClusterHostGroupInfo.md)
 - [ClusterInfo](docs/ClusterInfo.md)
 - [ClusterTimezone](docs/ClusterTimezone.md)
 - [ClusterUpdate](docs/ClusterUpdate.md)
 - [ClusterVersion](docs/ClusterVersion.md)
 - [ClusterVisibilityConfig](docs/ClusterVisibilityConfig.md)
 - [ClusterVisibilityInfo](docs/ClusterVisibilityInfo.md)
 - [CommunityUserCredentials](docs/CommunityUserCredentials.md)
 - [ComplianceRangeFilter](docs/ComplianceRangeFilter.md)
 - [ComplianceSummarySLAV1](docs/ComplianceSummarySLAV1.md)
 - [ComplianceSummaryStatus](docs/ComplianceSummaryStatus.md)
 - [ComplianceSummaryV1](docs/ComplianceSummaryV1.md)
 - [ComputeClusterDetail](docs/ComputeClusterDetail.md)
 - [ComputeClusterSummary](docs/ComputeClusterSummary.md)
 - [ComputeClusterSummaryListResponse](docs/ComputeClusterSummaryListResponse.md)
 - [ComputeClusterUpdate](docs/ComputeClusterUpdate.md)
 - [ConfigChangeSource](docs/ConfigChangeSource.md)
 - [ConfigParam](docs/ConfigParam.md)
 - [ConfigurationSummary](docs/ConfigurationSummary.md)
 - [ConfigurationSummaryListResponse](docs/ConfigurationSummaryListResponse.md)
 - [ConfigurationUpdateSummary](docs/ConfigurationUpdateSummary.md)
 - [ConfigurationUpdateSummaryListResponse](docs/ConfigurationUpdateSummaryListResponse.md)
 - [ConfiguredSlaType](docs/ConfiguredSlaType.md)
 - [CorsConfiguration](docs/CorsConfiguration.md)
 - [CorsConfigurationPatch](docs/CorsConfigurationPatch.md)
 - [CountResponse](docs/CountResponse.md)
 - [CreateNewVappParams](docs/CreateNewVappParams.md)
 - [CreateVappNetworkParams](docs/CreateVappNetworkParams.md)
 - [CsrRequest](docs/CsrRequest.md)
 - [CsrSummary](docs/CsrSummary.md)
 - [CsrSummaryListResponse](docs/CsrSummaryListResponse.md)
 - [DataCenterSummary](docs/DataCenterSummary.md)
 - [DataGuardGroupMember](docs/DataGuardGroupMember.md)
 - [DataGuardType](docs/DataGuardType.md)
 - [DataStoreSummary](docs/DataStoreSummary.md)
 - [DatabaseType](docs/DatabaseType.md)
 - [DbLogReportProperties](docs/DbLogReportProperties.md)
 - [DbLogReportPropertiesUpdate](docs/DbLogReportPropertiesUpdate.md)
 - [DbLogReportSummary](docs/DbLogReportSummary.md)
 - [DbLogReportSummaryListResponse](docs/DbLogReportSummaryListResponse.md)
 - [DbLogReportSummaryListSortAttribute](docs/DbLogReportSummaryListSortAttribute.md)
 - [DiagnosticTaskStatus](docs/DiagnosticTaskStatus.md)
 - [DisablePerLocationPause](docs/DisablePerLocationPause.md)
 - [DiscoveredNasShare](docs/DiscoveredNasShare.md)
 - [DissolveLegalHoldDefinition](docs/DissolveLegalHoldDefinition.md)
 - [DissolveLegalHoldResponse](docs/DissolveLegalHoldResponse.md)
 - [DownloadFileJobConfig](docs/DownloadFileJobConfig.md)
 - [DownloadJobInfo](docs/DownloadJobInfo.md)
 - [DownloadMssqlBackupFilesByIdJobConfig](docs/DownloadMssqlBackupFilesByIdJobConfig.md)
 - [DownloadedSnapshotSlaAssignmentInfo](docs/DownloadedSnapshotSlaAssignmentInfo.md)
 - [EffectiveSlaHolder](docs/EffectiveSlaHolder.md)
 - [EnablePerLocationPause](docs/EnablePerLocationPause.md)
 - [EncryptionStatus](docs/EncryptionStatus.md)
 - [EnvoyBulkUpdate](docs/EnvoyBulkUpdate.md)
 - [EnvoyCreate](docs/EnvoyCreate.md)
 - [EnvoyDetail](docs/EnvoyDetail.md)
 - [EnvoyDetailList](docs/EnvoyDetailList.md)
 - [EnvoyIdList](docs/EnvoyIdList.md)
 - [EnvoySummary](docs/EnvoySummary.md)
 - [EnvoyUpdate](docs/EnvoyUpdate.md)
 - [EnvoyUserInfo](docs/EnvoyUserInfo.md)
 - [EventCsvDownloadResponse](docs/EventCsvDownloadResponse.md)
 - [EventNotification](docs/EventNotification.md)
 - [EventSeriesStatusV1](docs/EventSeriesStatusV1.md)
 - [EventSeriesSummaryV1](docs/EventSeriesSummaryV1.md)
 - [EventSeverityV1](docs/EventSeverityV1.md)
 - [EventStatusV1](docs/EventStatusV1.md)
 - [EventSummaryV1](docs/EventSummaryV1.md)
 - [EventTypeV1](docs/EventTypeV1.md)
 - [EventsAndSeriesSummariesResponse](docs/EventsAndSeriesSummariesResponse.md)
 - [EventsAndSeriesSummariesV1](docs/EventsAndSeriesSummariesV1.md)
 - [ExampleEnum](docs/ExampleEnum.md)
 - [ExclusionPatternCreateConfig](docs/ExclusionPatternCreateConfig.md)
 - [ExclusionPatternDetail](docs/ExclusionPatternDetail.md)
 - [ExclusionPatternDetailList](docs/ExclusionPatternDetailList.md)
 - [ExclusionPatternDetailListResponse](docs/ExclusionPatternDetailListResponse.md)
 - [ExclusionPatternUpdateConfig](docs/ExclusionPatternUpdateConfig.md)
 - [ExistingSnapshotRetention](docs/ExistingSnapshotRetention.md)
 - [ExpiredCustomRetentionSnapshotInfo](docs/ExpiredCustomRetentionSnapshotInfo.md)
 - [ExpiredCustomRetentionSnapshots](docs/ExpiredCustomRetentionSnapshots.md)
 - [ExportMssqlDbJobConfig](docs/ExportMssqlDbJobConfig.md)
 - [ExportSnapshotJobConfigV1](docs/ExportSnapshotJobConfigV1.md)
 - [FailoverClusterAppConfig](docs/FailoverClusterAppConfig.md)
 - [FailoverClusterAppConnectionStatus](docs/FailoverClusterAppConnectionStatus.md)
 - [FailoverClusterAppDetail](docs/FailoverClusterAppDetail.md)
 - [FailoverClusterAppSource](docs/FailoverClusterAppSource.md)
 - [FailoverClusterAppSummary](docs/FailoverClusterAppSummary.md)
 - [FailoverClusterAppSummaryListResponse](docs/FailoverClusterAppSummaryListResponse.md)
 - [FailoverClusterConfig](docs/FailoverClusterConfig.md)
 - [FailoverClusterConnectionStatus](docs/FailoverClusterConnectionStatus.md)
 - [FailoverClusterDetail](docs/FailoverClusterDetail.md)
 - [FailoverClusterHierarchyObjectDescendentCount](docs/FailoverClusterHierarchyObjectDescendentCount.md)
 - [FailoverClusterHierarchyObjectSortAttribute](docs/FailoverClusterHierarchyObjectSortAttribute.md)
 - [FailoverClusterHierarchyObjectSummary](docs/FailoverClusterHierarchyObjectSummary.md)
 - [FailoverClusterHierarchyObjectSummaryListResponse](docs/FailoverClusterHierarchyObjectSummaryListResponse.md)
 - [FailoverClusterNode](docs/FailoverClusterNode.md)
 - [FailoverClusterNodeConnectionStatus](docs/FailoverClusterNodeConnectionStatus.md)
 - [FailoverClusterNodeOrder](docs/FailoverClusterNodeOrder.md)
 - [FailoverClusterNodeOsType](docs/FailoverClusterNodeOsType.md)
 - [FailoverClusterObjectType](docs/FailoverClusterObjectType.md)
 - [FailoverClusterOsType](docs/FailoverClusterOsType.md)
 - [FailoverClusterSummary](docs/FailoverClusterSummary.md)
 - [FailoverClusterSummaryListResponse](docs/FailoverClusterSummaryListResponse.md)
 - [FailoverClusterType](docs/FailoverClusterType.md)
 - [FileSystemType](docs/FileSystemType.md)
 - [FileVersion](docs/FileVersion.md)
 - [FilesetArraySpec](docs/FilesetArraySpec.md)
 - [FilesetCreate](docs/FilesetCreate.md)
 - [FilesetDetail](docs/FilesetDetail.md)
 - [FilesetDownloadFileJobConfig](docs/FilesetDownloadFileJobConfig.md)
 - [FilesetExportFileJobConfig](docs/FilesetExportFileJobConfig.md)
 - [FilesetOptions](docs/FilesetOptions.md)
 - [FilesetRestoreFileJobConfig](docs/FilesetRestoreFileJobConfig.md)
 - [FilesetSnapshotDetail](docs/FilesetSnapshotDetail.md)
 - [FilesetSnapshotSummary](docs/FilesetSnapshotSummary.md)
 - [FilesetSnapshotVerbose](docs/FilesetSnapshotVerbose.md)
 - [FilesetSummary](docs/FilesetSummary.md)
 - [FilesetSummaryListResponse](docs/FilesetSummaryListResponse.md)
 - [FilesetTemplateCreate](docs/FilesetTemplateCreate.md)
 - [FilesetTemplateDetail](docs/FilesetTemplateDetail.md)
 - [FilesetTemplateDetailListResponse](docs/FilesetTemplateDetailListResponse.md)
 - [FilesetTemplatePatch](docs/FilesetTemplatePatch.md)
 - [FilesetUpdate](docs/FilesetUpdate.md)
 - [FipsStatus](docs/FipsStatus.md)
 - [FipsStatusPatch](docs/FipsStatusPatch.md)
 - [ForceFullVolumeInfo](docs/ForceFullVolumeInfo.md)
 - [ForecastAssumptions](docs/ForecastAssumptions.md)
 - [ForecastConsolidationFilter](docs/ForecastConsolidationFilter.md)
 - [ForecastGranularity](docs/ForecastGranularity.md)
 - [FrequencyChangeRates](docs/FrequencyChangeRates.md)
 - [FrequencyConfig](docs/FrequencyConfig.md)
 - [FullyQualifiedDomainNameInfo](docs/FullyQualifiedDomainNameInfo.md)
 - [GenericCsrRequest](docs/GenericCsrRequest.md)
 - [GlobalBlackoutWindowStatus](docs/GlobalBlackoutWindowStatus.md)
 - [HdfsBaseConfig](docs/HdfsBaseConfig.md)
 - [HdfsConfig](docs/HdfsConfig.md)
 - [HdfsCreate](docs/HdfsCreate.md)
 - [HdfsDetail](docs/HdfsDetail.md)
 - [HdfsExportFileJobConfig](docs/HdfsExportFileJobConfig.md)
 - [HdfsHost](docs/HdfsHost.md)
 - [HdfsRestoreFileJobConfig](docs/HdfsRestoreFileJobConfig.md)
 - [HdfsSnapshotDetail](docs/HdfsSnapshotDetail.md)
 - [HdfsSnapshotSummary](docs/HdfsSnapshotSummary.md)
 - [HdfsSummary](docs/HdfsSummary.md)
 - [HdfsSummaryListResponse](docs/HdfsSummaryListResponse.md)
 - [HdfsTemplateCreate](docs/HdfsTemplateCreate.md)
 - [HdfsTemplateDetail](docs/HdfsTemplateDetail.md)
 - [HdfsTemplateDetailListResponse](docs/HdfsTemplateDetailListResponse.md)
 - [HdfsTemplatePatch](docs/HdfsTemplatePatch.md)
 - [HdfsUpdate](docs/HdfsUpdate.md)
 - [HealthMonitorPolicy](docs/HealthMonitorPolicy.md)
 - [HierarchyObjectIds](docs/HierarchyObjectIds.md)
 - [HoldConfig](docs/HoldConfig.md)
 - [HostConfigurationPropertyEnabled](docs/HostConfigurationPropertyEnabled.md)
 - [HostDetail](docs/HostDetail.md)
 - [HostFilterStatus](docs/HostFilterStatus.md)
 - [HostGroupInfo](docs/HostGroupInfo.md)
 - [HostHierarchyObjectDescendantCount](docs/HostHierarchyObjectDescendantCount.md)
 - [HostHierarchyObjectSortAttribute](docs/HostHierarchyObjectSortAttribute.md)
 - [HostHierarchyObjectSummary](docs/HostHierarchyObjectSummary.md)
 - [HostHierarchyObjectSummaryListResponse](docs/HostHierarchyObjectSummaryListResponse.md)
 - [HostInfo](docs/HostInfo.md)
 - [HostMakePrimaryRequest](docs/HostMakePrimaryRequest.md)
 - [HostObjectType](docs/HostObjectType.md)
 - [HostOperatingSystemType](docs/HostOperatingSystemType.md)
 - [HostRbsStatus](docs/HostRbsStatus.md)
 - [HostRegister](docs/HostRegister.md)
 - [HostShareDetail](docs/HostShareDetail.md)
 - [HostShareParameters](docs/HostShareParameters.md)
 - [HostSharePatch](docs/HostSharePatch.md)
 - [HostShareUpdate](docs/HostShareUpdate.md)
 - [HostShareVendorType](docs/HostShareVendorType.md)
 - [HostSummary](docs/HostSummary.md)
 - [HostSummaryListResponse](docs/HostSummaryListResponse.md)
 - [HostUiFilterStatus](docs/HostUiFilterStatus.md)
 - [HostUpdate](docs/HostUpdate.md)
 - [HostVfdInstallConfig](docs/HostVfdInstallConfig.md)
 - [HostVfdState](docs/HostVfdState.md)
 - [HostVolumeSummary](docs/HostVolumeSummary.md)
 - [HostVolumeSummaryListResponse](docs/HostVolumeSummaryListResponse.md)
 - [HotAddBandwidthInfo](docs/HotAddBandwidthInfo.md)
 - [HotAddNetworkConfigWithId](docs/HotAddNetworkConfigWithId.md)
 - [HotAddNetworkConfigWithName](docs/HotAddNetworkConfigWithName.md)
 - [HotAddProxiesNeededInfo](docs/HotAddProxiesNeededInfo.md)
 - [HotAddProxyVmInfo](docs/HotAddProxyVmInfo.md)
 - [HotAddProxyVmInfoListResponse](docs/HotAddProxyVmInfoListResponse.md)
 - [HotAddProxyVmStatusType](docs/HotAddProxyVmStatusType.md)
 - [HypervVirtualDiskForceFullInfo](docs/HypervVirtualDiskForceFullInfo.md)
 - [HypervVirtualMachineForceFullRequest](docs/HypervVirtualMachineForceFullRequest.md)
 - [HypervVirtualMachineForceFullResponse](docs/HypervVirtualMachineForceFullResponse.md)
 - [HypervVmSlaObjectCount](docs/HypervVmSlaObjectCount.md)
 - [IdNamePair](docs/IdNamePair.md)
 - [IdProviderAuthDomainInfo](docs/IdProviderAuthDomainInfo.md)
 - [IdProviderAuthDomainInfoUpdate](docs/IdProviderAuthDomainInfoUpdate.md)
 - [IdProviderAuthDomainSummary](docs/IdProviderAuthDomainSummary.md)
 - [IdProviderAuthDomainSummaryListResponse](docs/IdProviderAuthDomainSummaryListResponse.md)
 - [IdProviderSamlInfo](docs/IdProviderSamlInfo.md)
 - [IdProviderSamlInfoUpdate](docs/IdProviderSamlInfoUpdate.md)
 - [InstantRecoveryJobConfig](docs/InstantRecoveryJobConfig.md)
 - [InternalJobInstanceDetail](docs/InternalJobInstanceDetail.md)
 - [IoFilterStatus](docs/IoFilterStatus.md)
 - [IoFilterSummary](docs/IoFilterSummary.md)
 - [IoFilterSummaryListResponse](docs/IoFilterSummaryListResponse.md)
 - [JobMonitoringCsvDownloadResponse](docs/JobMonitoringCsvDownloadResponse.md)
 - [JobMonitoringInfo](docs/JobMonitoringInfo.md)
 - [JobMonitoringJobProgressInfo](docs/JobMonitoringJobProgressInfo.md)
 - [JobMonitoringObjectsCountByState](docs/JobMonitoringObjectsCountByState.md)
 - [JobMonitoringObjectsCountByType](docs/JobMonitoringObjectsCountByType.md)
 - [JobMonitoringResponse](docs/JobMonitoringResponse.md)
 - [JobMonitoringRetryStatus](docs/JobMonitoringRetryStatus.md)
 - [JobMonitoringState](docs/JobMonitoringState.md)
 - [JobMonitoringStatus](docs/JobMonitoringStatus.md)
 - [JobMonitoringStream](docs/JobMonitoringStream.md)
 - [JobMonitoringStreamingResponse](docs/JobMonitoringStreamingResponse.md)
 - [JobMonitoringSummaryByState](docs/JobMonitoringSummaryByState.md)
 - [JobMonitoringSummaryByType](docs/JobMonitoringSummaryByType.md)
 - [JobMonitoringTaskType](docs/JobMonitoringTaskType.md)
 - [JobScheduledResponse](docs/JobScheduledResponse.md)
 - [KmipClientConfiguration](docs/KmipClientConfiguration.md)
 - [KmipClientDetail](docs/KmipClientDetail.md)
 - [KmipServerConfiguration](docs/KmipServerConfiguration.md)
 - [KmipServerDetail](docs/KmipServerDetail.md)
 - [KuprHostRegister](docs/KuprHostRegister.md)
 - [KuprHostUpdate](docs/KuprHostUpdate.md)
 - [LdapDomainName](docs/LdapDomainName.md)
 - [LdapDomainNameListResponse](docs/LdapDomainNameListResponse.md)
 - [LdapServiceInfo](docs/LdapServiceInfo.md)
 - [LdapServiceInfoUpdate](docs/LdapServiceInfoUpdate.md)
 - [LdapServiceSummary](docs/LdapServiceSummary.md)
 - [LdapServiceSummaryListResponse](docs/LdapServiceSummaryListResponse.md)
 - [LegalHoldDownloadConfig](docs/LegalHoldDownloadConfig.md)
 - [LegalHoldObjectSortAttribute](docs/LegalHoldObjectSortAttribute.md)
 - [LegalHoldSnapshotSortAttribute](docs/LegalHoldSnapshotSortAttribute.md)
 - [LegalHoldSummary](docs/LegalHoldSummary.md)
 - [LegalHoldSummaryListResponse](docs/LegalHoldSummaryListResponse.md)
 - [Link](docs/Link.md)
 - [LocalUserAccountLockoutConfig](docs/LocalUserAccountLockoutConfig.md)
 - [LocalUserAccountLockoutStatus](docs/LocalUserAccountLockoutStatus.md)
 - [LocationPathPoint](docs/LocationPathPoint.md)
 - [LsnRecoveryPoint](docs/LsnRecoveryPoint.md)
 - [ManagedHierarchyObjectAncestor](docs/ManagedHierarchyObjectAncestor.md)
 - [ManagedHierarchyObjectSummary](docs/ManagedHierarchyObjectSummary.md)
 - [ManagedObjectDescendantCountVcdVappFields](docs/ManagedObjectDescendantCountVcdVappFields.md)
 - [ManagedObjectPendingSlaInfo](docs/ManagedObjectPendingSlaInfo.md)
 - [ManagedVolumeSlaObjectCount](docs/ManagedVolumeSlaObjectCount.md)
 - [ManualDiscoveryNodeInfo](docs/ManualDiscoveryNodeInfo.md)
 - [ManualDiscoveryNodeIpv4Info](docs/ManualDiscoveryNodeIpv4Info.md)
 - [MfaServerConfig](docs/MfaServerConfig.md)
 - [MissedSnapshot](docs/MissedSnapshot.md)
 - [MissedSnapshotDayOfTimeUnit](docs/MissedSnapshotDayOfTimeUnit.md)
 - [MissedSnapshotListResponse](docs/MissedSnapshotListResponse.md)
 - [MissedSnapshotTimeUnitConfig](docs/MissedSnapshotTimeUnitConfig.md)
 - [MonitoringEmailSubscriptionRequest](docs/MonitoringEmailSubscriptionRequest.md)
 - [MonitoringEmailSubscriptionUpdate](docs/MonitoringEmailSubscriptionUpdate.md)
 - [MonitoringRowType](docs/MonitoringRowType.md)
 - [MonitoringSubscriptionSummary](docs/MonitoringSubscriptionSummary.md)
 - [MonthlyConfig](docs/MonthlyConfig.md)
 - [MountExportSnapshotJobCommonOptions](docs/MountExportSnapshotJobCommonOptions.md)
 - [MountMssqlDbConfig](docs/MountMssqlDbConfig.md)
 - [MountSnapshotJobConfigForBatchV1](docs/MountSnapshotJobConfigForBatchV1.md)
 - [MountSnapshotJobConfigV1](docs/MountSnapshotJobConfigV1.md)
 - [MssqlAvailabilityGroupDetail](docs/MssqlAvailabilityGroupDetail.md)
 - [MssqlAvailabilityGroupSummary](docs/MssqlAvailabilityGroupSummary.md)
 - [MssqlAvailabilityGroupSummaryListResponse](docs/MssqlAvailabilityGroupSummaryListResponse.md)
 - [MssqlAvailabilityGroupUpdate](docs/MssqlAvailabilityGroupUpdate.md)
 - [MssqlBackup](docs/MssqlBackup.md)
 - [MssqlBackupJobConfig](docs/MssqlBackupJobConfig.md)
 - [MssqlBackupSelection](docs/MssqlBackupSelection.md)
 - [MssqlBackupType](docs/MssqlBackupType.md)
 - [MssqlBackups](docs/MssqlBackups.md)
 - [MssqlBatchBackupCanceledSummary](docs/MssqlBatchBackupCanceledSummary.md)
 - [MssqlBatchBackupFailureSummary](docs/MssqlBatchBackupFailureSummary.md)
 - [MssqlBatchBackupJobConfig](docs/MssqlBatchBackupJobConfig.md)
 - [MssqlBatchBackupSuccessSummary](docs/MssqlBatchBackupSuccessSummary.md)
 - [MssqlBatchBackupSummary](docs/MssqlBatchBackupSummary.md)
 - [MssqlCbtEffectiveStatusType](docs/MssqlCbtEffectiveStatusType.md)
 - [MssqlCbtStatusType](docs/MssqlCbtStatusType.md)
 - [MssqlDatabaseFileType](docs/MssqlDatabaseFileType.md)
 - [MssqlDatabaseListSortAttribute](docs/MssqlDatabaseListSortAttribute.md)
 - [MssqlDatabaseRecoveryModel](docs/MssqlDatabaseRecoveryModel.md)
 - [MssqlDbDefaults](docs/MssqlDbDefaults.md)
 - [MssqlDbDefaultsUpdate](docs/MssqlDbDefaultsUpdate.md)
 - [MssqlDbDetail](docs/MssqlDbDetail.md)
 - [MssqlDbFileExportPath](docs/MssqlDbFileExportPath.md)
 - [MssqlDbReplica](docs/MssqlDbReplica.md)
 - [MssqlDbReplicaAvailabilityInfo](docs/MssqlDbReplicaAvailabilityInfo.md)
 - [MssqlDbSlaObjectCount](docs/MssqlDbSlaObjectCount.md)
 - [MssqlDbSnapshotDetail](docs/MssqlDbSnapshotDetail.md)
 - [MssqlDbSnapshotSummary](docs/MssqlDbSnapshotSummary.md)
 - [MssqlDbSnapshotSummaryListResponse](docs/MssqlDbSnapshotSummaryListResponse.md)
 - [MssqlDbSummary](docs/MssqlDbSummary.md)
 - [MssqlDbSummaryListResponse](docs/MssqlDbSummaryListResponse.md)
 - [MssqlDbUpdate](docs/MssqlDbUpdate.md)
 - [MssqlDbUpdateId](docs/MssqlDbUpdateId.md)
 - [MssqlDownloadFromArchiveConfig](docs/MssqlDownloadFromArchiveConfig.md)
 - [MssqlHierarchyObjectDescendantCount](docs/MssqlHierarchyObjectDescendantCount.md)
 - [MssqlHierarchyObjectSummary](docs/MssqlHierarchyObjectSummary.md)
 - [MssqlHierarchyObjectSummaryListResponse](docs/MssqlHierarchyObjectSummaryListResponse.md)
 - [MssqlHierarchyObjectType](docs/MssqlHierarchyObjectType.md)
 - [MssqlHostCbtEffectiveStatusType](docs/MssqlHostCbtEffectiveStatusType.md)
 - [MssqlHostCbtStatusType](docs/MssqlHostCbtStatusType.md)
 - [MssqlHostConfiguration](docs/MssqlHostConfiguration.md)
 - [MssqlHostConfigurationWithHostId](docs/MssqlHostConfigurationWithHostId.md)
 - [MssqlHostConfigurationWithHostIdListResponse](docs/MssqlHostConfigurationWithHostIdListResponse.md)
 - [MssqlInstanceDetail](docs/MssqlInstanceDetail.md)
 - [MssqlInstanceShortSummary](docs/MssqlInstanceShortSummary.md)
 - [MssqlInstanceSummary](docs/MssqlInstanceSummary.md)
 - [MssqlInstanceSummaryListResponse](docs/MssqlInstanceSummaryListResponse.md)
 - [MssqlInstanceUpdate](docs/MssqlInstanceUpdate.md)
 - [MssqlLogShippingCreateConfig](docs/MssqlLogShippingCreateConfig.md)
 - [MssqlLogShippingDetail](docs/MssqlLogShippingDetail.md)
 - [MssqlLogShippingLinks](docs/MssqlLogShippingLinks.md)
 - [MssqlLogShippingListSortAttribute](docs/MssqlLogShippingListSortAttribute.md)
 - [MssqlLogShippingOkState](docs/MssqlLogShippingOkState.md)
 - [MssqlLogShippingReseedConfig](docs/MssqlLogShippingReseedConfig.md)
 - [MssqlLogShippingStatus](docs/MssqlLogShippingStatus.md)
 - [MssqlLogShippingStatusInfo](docs/MssqlLogShippingStatusInfo.md)
 - [MssqlLogShippingSummary](docs/MssqlLogShippingSummary.md)
 - [MssqlLogShippingSummaryListResponse](docs/MssqlLogShippingSummaryListResponse.md)
 - [MssqlLogShippingTargetStateOptions](docs/MssqlLogShippingTargetStateOptions.md)
 - [MssqlLogShippingUpdate](docs/MssqlLogShippingUpdate.md)
 - [MssqlMissedRecoverableRange](docs/MssqlMissedRecoverableRange.md)
 - [MssqlMissedRecoverableRangeError](docs/MssqlMissedRecoverableRangeError.md)
 - [MssqlMissedRecoverableRangeListResponse](docs/MssqlMissedRecoverableRangeListResponse.md)
 - [MssqlMountDetail](docs/MssqlMountDetail.md)
 - [MssqlMountLinks](docs/MssqlMountLinks.md)
 - [MssqlMountSummary](docs/MssqlMountSummary.md)
 - [MssqlMountSummaryListResponse](docs/MssqlMountSummaryListResponse.md)
 - [MssqlRecoverableRange](docs/MssqlRecoverableRange.md)
 - [MssqlRecoverableRangeListResponse](docs/MssqlRecoverableRangeListResponse.md)
 - [MssqlRecoveryPoint](docs/MssqlRecoveryPoint.md)
 - [MssqlRestoreEstimateResult](docs/MssqlRestoreEstimateResult.md)
 - [MssqlRestoreFile](docs/MssqlRestoreFile.md)
 - [MssqlRootProperties](docs/MssqlRootProperties.md)
 - [MssqlScriptDetail](docs/MssqlScriptDetail.md)
 - [MssqlSlaDomainAssignInfo](docs/MssqlSlaDomainAssignInfo.md)
 - [MssqlSlaDomainInfo](docs/MssqlSlaDomainInfo.md)
 - [MssqlSlaPatchProperties](docs/MssqlSlaPatchProperties.md)
 - [MssqlSlaRelatedProperties](docs/MssqlSlaRelatedProperties.md)
 - [MssqlSnappableId](docs/MssqlSnappableId.md)
 - [NasBaseConfig](docs/NasBaseConfig.md)
 - [NasConfig](docs/NasConfig.md)
 - [NasSharesToAdd](docs/NasSharesToAdd.md)
 - [NasVendorType](docs/NasVendorType.md)
 - [NetworkInfo](docs/NetworkInfo.md)
 - [NetworkInfoListResponse](docs/NetworkInfoListResponse.md)
 - [NodeHostnameInfo](docs/NodeHostnameInfo.md)
 - [NodeHostnameInfoListResponse](docs/NodeHostnameInfoListResponse.md)
 - [NodeId](docs/NodeId.md)
 - [NodePolicyCheckResult](docs/NodePolicyCheckResult.md)
 ...
 - [NutanixVmSlaObjectCount](docs/NutanixVmSlaObjectCount.md)
 - [ObjectHoldSummary](docs/ObjectHoldSummary.md)
 - [ObjectHoldSummaryListResponse](docs/ObjectHoldSummaryListResponse.md)
 - [ObjectHolder](docs/ObjectHolder.md)
 - [ObjectTypeV1](docs/ObjectTypeV1.md)
 - [OperatingSystemFamily](docs/OperatingSystemFamily.md)
 - [OperationMode](docs/OperationMode.md)
 - [OracleAcoParameterDetail](docs/OracleAcoParameterDetail.md)
 - [OracleAcoParameterList](docs/OracleAcoParameterList.md)
 - [OracleAcoValidationResult](docs/OracleAcoValidationResult.md)
 - [OracleAcoValueErrorDetail](docs/OracleAcoValueErrorDetail.md)
 - [OracleBulkUpdate](docs/OracleBulkUpdate.md)
 - [OracleDataGuardGroupUpdate](docs/OracleDataGuardGroupUpdate.md)
 - [OracleDbDetail](docs/OracleDbDetail.md)
 - [OracleDbSummary](docs/OracleDbSummary.md)
 - [OracleDbSummaryListResponse](docs/OracleDbSummaryListResponse.md)
 - [OracleFileDownloadLink](docs/OracleFileDownloadLink.md)
 - [OracleHostDetail](docs/OracleHostDetail.md)
 - [OracleHostSummary](docs/OracleHostSummary.md)
 - [OracleInstanceProperties](docs/OracleInstanceProperties.md)
 - [OracleLastValidationResult](docs/OracleLastValidationResult.md)
 - [OracleNodeOrder](docs/OracleNodeOrder.md)
 - [OracleNodeProperties](docs/OracleNodeProperties.md)
 - [OracleNonSlaProperties](docs/OracleNonSlaProperties.md)
 - [OracleRacDetail](docs/OracleRacDetail.md)
 - [OracleRacSummary](docs/OracleRacSummary.md)
 - [OracleRecoveryApiValidationErrors](docs/OracleRecoveryApiValidationErrors.md)
 - [OracleRecoveryPoint](docs/OracleRecoveryPoint.md)
 - [OracleRestoreEstimateResult](docs/OracleRestoreEstimateResult.md)
 - [OracleUpdate](docs/OracleUpdate.md)
 - [OracleUpdateCommon](docs/OracleUpdateCommon.md)
 - [OracleValidateConfig](docs/OracleValidateConfig.md)
 - [ParentAppInfo](docs/ParentAppInfo.md)
 - [PasswordRequirementsPatchRequest](docs/PasswordRequirementsPatchRequest.md)
 - [PasswordRequirementsSummary](docs/PasswordRequirementsSummary.md)
 - [PatternStatus](docs/PatternStatus.md)
 - [PerLocationCloudOutForecastSummary](docs/PerLocationCloudOutForecastSummary.md)
 - [PerStorageClassCloudOutStorageForecastSummary](docs/PerStorageClassCloudOutStorageForecastSummary.md)
 - [PolicyCheckResult](docs/PolicyCheckResult.md)
 - [PolicyScopeEnum](docs/PolicyScopeEnum.md)
 - [PolicyTypeEnum](docs/PolicyTypeEnum.md)
 - [PrecheckFailureResult](docs/PrecheckFailureResult.md)
 - [PrecheckStatusNextRunInfo](docs/PrecheckStatusNextRunInfo.md)
 - [PrecheckStatusResponse](docs/PrecheckStatusResponse.md)
 - [PreferredCdpNetworkProtocol](docs/PreferredCdpNetworkProtocol.md)
 - [PreferredCdpNetworkProtocolObject](docs/PreferredCdpNetworkProtocolObject.md)
 - [PrincipalSearchSortAttribute](docs/PrincipalSearchSortAttribute.md)
 - [PrincipalSummaryV1](docs/PrincipalSummaryV1.md)
 - [PrincipalSummaryV1ListResponse](docs/PrincipalSummaryV1ListResponse.md)
 - [PrincipalType](docs/PrincipalType.md)
 - [PrincipalWithRoleInfo](docs/PrincipalWithRoleInfo.md)
 - [ProtectedObjectsCount](docs/ProtectedObjectsCount.md)
 - [QuarterlyConfig](docs/QuarterlyConfig.md)
 - [RbsHostOperationRequest](docs/RbsHostOperationRequest.md)
 - [RbsHostOperationResponse](docs/RbsHostOperationResponse.md)
 - [RbsHostSummary](docs/RbsHostSummary.md)
 - [RbsHostUserConfig](docs/RbsHostUserConfig.md)
 - [ReaderRefreshDataSourcesRequest](docs/ReaderRefreshDataSourcesRequest.md)
 - [RefreshableObjectConnectionStatus](docs/RefreshableObjectConnectionStatus.md)
 - [RefreshableObjectConnectionStatusType](docs/RefreshableObjectConnectionStatusType.md)
 - [RelocateMountConfig](docs/RelocateMountConfig.md)
 - [RemediationRequest](docs/RemediationRequest.md)
 - [RemediationRequestRunConfig](docs/RemediationRequestRunConfig.md)
 - [RemediationRequestSpec](docs/RemediationRequestSpec.md)
 - [RemediationResponse](docs/RemediationResponse.md)
 - [ReplicationSpec](docs/ReplicationSpec.md)
 - [ReplicationType](docs/ReplicationType.md)
 - [ReportConfigPatch](docs/ReportConfigPatch.md)
 - [ReportConfigResponse](docs/ReportConfigResponse.md)
 - [ReportableObjectType](docs/ReportableObjectType.md)
 - [RequestErrorInfo](docs/RequestErrorInfo.md)
 - [RequestFailedException](docs/RequestFailedException.md)
 - [ResourceTagDefinition](docs/ResourceTagDefinition.md)
 - [ResourceTagDeleteResponse](docs/ResourceTagDeleteResponse.md)
 - [ResourceTagDetail](docs/ResourceTagDetail.md)
 - [ResourceTagGetResponse](docs/ResourceTagGetResponse.md)
 - [ResourceTagUpdate](docs/ResourceTagUpdate.md)
 - [RestoreFileJobConfig](docs/RestoreFileJobConfig.md)
 - [RestoreMssqlDbJobConfig](docs/RestoreMssqlDbJobConfig.md)
 - [RoleAssignmentRequest](docs/RoleAssignmentRequest.md)
 - [RoleInfo](docs/RoleInfo.md)
 - [RoleInfoCreate](docs/RoleInfoCreate.md)
 - [RoleInfoListResponse](docs/RoleInfoListResponse.md)
 - [RoleInfoUpdate](docs/RoleInfoUpdate.md)
 - [RoleInfoWithPrincipals](docs/RoleInfoWithPrincipals.md)
 - [RoleListSortAttributes](docs/RoleListSortAttributes.md)
 - [RsaMfaServerConfig](docs/RsaMfaServerConfig.md)
 - [RsaMfaServerConfigUpdate](docs/RsaMfaServerConfigUpdate.md)
 - [RsaMfaServerConfigWithoutSecrets](docs/RsaMfaServerConfigWithoutSecrets.md)
 - [RsaMfaServerDetail](docs/RsaMfaServerDetail.md)
 - [RsaMfaServerDetailListResponse](docs/RsaMfaServerDetailListResponse.md)
 - [RubrikMibFileDownloadLink](docs/RubrikMibFileDownloadLink.md)
 - [RubrikSamlMetadataDetail](docs/RubrikSamlMetadataDetail.md)
 - [RubrikSamlMetadataInfo](docs/RubrikSamlMetadataInfo.md)
 - [RubrikSamlMetadataSummary](docs/RubrikSamlMetadataSummary.md)
 - [RunPolicyArg](docs/RunPolicyArg.md)
 - [SamlSsoAuthnRequestDetail](docs/SamlSsoAuthnRequestDetail.md)
 - [SamlSsoAuthnRequestInfo](docs/SamlSsoAuthnRequestInfo.md)
 - [SamlSsoStatus](docs/SamlSsoStatus.md)
 - [SapHanaAddSystemResponse](docs/SapHanaAddSystemResponse.md)
 - [SapHanaDataPathSpec](docs/SapHanaDataPathSpec.md)
 - [SapHanaDataPathType](docs/SapHanaDataPathType.md)
 - [SapHanaDatabaseDetail](docs/SapHanaDatabaseDetail.md)
 - [SapHanaDatabaseListSortAttribute](docs/SapHanaDatabaseListSortAttribute.md)
 - [SapHanaDatabasePatch](docs/SapHanaDatabasePatch.md)
 - [SapHanaDatabaseSnapshotDetail](docs/SapHanaDatabaseSnapshotDetail.md)
 - [SapHanaDatabaseSnapshotSummary](docs/SapHanaDatabaseSnapshotSummary.md)
 - [SapHanaDatabaseSnapshotSummaryListResponse](docs/SapHanaDatabaseSnapshotSummaryListResponse.md)
 - [SapHanaDatabaseSummary](docs/SapHanaDatabaseSummary.md)
 - [SapHanaDatabaseSummaryListResponse](docs/SapHanaDatabaseSummaryListResponse.md)
 - [SapHanaHost](docs/SapHanaHost.md)
 - [SapHanaPatchSystemResponse](docs/SapHanaPatchSystemResponse.md)
 - [SapHanaRecoverableRange](docs/SapHanaRecoverableRange.md)
 - [SapHanaRecoverableRangeListResponse](docs/SapHanaRecoverableRangeListResponse.md)
 - [SapHanaRestoreSourceConfig](docs/SapHanaRestoreSourceConfig.md)
 - [SapHanaSslInfo](docs/SapHanaSslInfo.md)
 - [SapHanaSystemConfig](docs/SapHanaSystemConfig.md)
 - [SapHanaSystemDataPathSpec](docs/SapHanaSystemDataPathSpec.md)
 - [SapHanaSystemInfo](docs/SapHanaSystemInfo.md)
 - [SapHanaSystemListSortAttribute](docs/SapHanaSystemListSortAttribute.md)
 - [SapHanaSystemPatch](docs/SapHanaSystemPatch.md)
 - [SapHanaSystemSummary](docs/SapHanaSystemSummary.md)
 - [SapHanaSystemSummaryListResponse](docs/SapHanaSystemSummaryListResponse.md)
 - [ScriptErrorAction](docs/ScriptErrorAction.md)
 - [SearchResponse](docs/SearchResponse.md)
 - [SearchResponseListResponse](docs/SearchResponseListResponse.md)
 - [SessionSummary](docs/SessionSummary.md)
 - [SlaAssignable](docs/SlaAssignable.md)
 - [SlaAssignment](docs/SlaAssignment.md)
 - [SlaConflictsSummary](docs/SlaConflictsSummary.md)
 - [SlaDayOfMonth](docs/SlaDayOfMonth.md)
 - [SlaDayOfQuarter](docs/SlaDayOfQuarter.md)
 - [SlaDayOfWeek](docs/SlaDayOfWeek.md)
 - [SlaDayOfYear](docs/SlaDayOfYear.md)
 - [SlaDomainDefinition](docs/SlaDomainDefinition.md)
 - [SlaDomainPatchDefinition](docs/SlaDomainPatchDefinition.md)
 - [SlaDomainSummary](docs/SlaDomainSummary.md)
 - [SlaDomainSummaryListResponse](docs/SlaDomainSummaryListResponse.md)
 - [SlaFrequency](docs/SlaFrequency.md)
 - [SlaFrequencyV2](docs/SlaFrequencyV2.md)
 - [SlaMonth](docs/SlaMonth.md)
 - [SlaObjectCounts](docs/SlaObjectCounts.md)
 - [SlaStartTimeAttributes](docs/SlaStartTimeAttributes.md)
 - [SlaTimeUnit](docs/SlaTimeUnit.md)
 - [Snappable](docs/Snappable.md)
 - [SnappablePrivilegeStatus](docs/SnappablePrivilegeStatus.md)
 - [SnappableRecoveryInfo](docs/SnappableRecoveryInfo.md)
 - [SnapshotCloudStorageTier](docs/SnapshotCloudStorageTier.md)
 - [SnapshotEventSeries](docs/SnapshotEventSeries.md)
 - [SnapshotLocationRetentionInfo](docs/SnapshotLocationRetentionInfo.md)
 - [SnapshotRetentionInfo](docs/SnapshotRetentionInfo.md)
 - [SnapshotSortAttribute](docs/SnapshotSortAttribute.md)
 - [SnapshotStorageStats](docs/SnapshotStorageStats.md)
 - [SnapshotSummary](docs/SnapshotSummary.md)
 - [SnapshotSummaryListResponse](docs/SnapshotSummaryListResponse.md)
 - [SnapshotType](docs/SnapshotType.md)
 - [SoftwareAvailability](docs/SoftwareAvailability.md)
 - [SortColumn](docs/SortColumn.md)
 - [SortOrder](docs/SortOrder.md)
 - [StageCdmSoftwareInfo](docs/StageCdmSoftwareInfo.md)
 - [StaticIpInfo](docs/StaticIpInfo.md)
 - [Status](docs/Status.md)
 - [StringResponse](docs/StringResponse.md)
 - [SubscriptionAttachmentType](docs/SubscriptionAttachmentType.md)
 - [SubscriptionOwner](docs/SubscriptionOwner.md)
 - [SubscriptionScheduleTimeAttributes](docs/SubscriptionScheduleTimeAttributes.md)
 - [SubscriptionStatus](docs/SubscriptionStatus.md)
 - [SupportDataConfig](docs/SupportDataConfig.md)
 - [SupportDataType](docs/SupportDataType.md)
 - [SupportDataTypeConfig](docs/SupportDataTypeConfig.md)
 - [SupportDataTypeStatus](docs/SupportDataTypeStatus.md)
 - [SyslogExportRuleFull](docs/SyslogExportRuleFull.md)
 - [SyslogExportRulePartial](docs/SyslogExportRulePartial.md)
 - [SyslogExportRuleSummary](docs/SyslogExportRuleSummary.md)
 - [SyslogExportRuleSummaryListResponse](docs/SyslogExportRuleSummaryListResponse.md)
 - [SyslogFacility](docs/SyslogFacility.md)
 - [SyslogMsgMibFileDownloadLink](docs/SyslogMsgMibFileDownloadLink.md)
 - [SyslogServerTestResult](docs/SyslogServerTestResult.md)
 - [SyslogSeverity](docs/SyslogSeverity.md)
 - [SyslogTcMibFileDownloadLink](docs/SyslogTcMibFileDownloadLink.md)
 - [TelemetryConfig](docs/TelemetryConfig.md)
 - [TelemetryLevel](docs/TelemetryLevel.md)
 - [TotpConfigUpdateRequest](docs/TotpConfigUpdateRequest.md)
 - [TotpGlobalSetting](docs/TotpGlobalSetting.md)
 - [TotpGlobalSettingUpdate](docs/TotpGlobalSettingUpdate.md)
 - [TotpSecret](docs/TotpSecret.md)
 - [TotpStatus](docs/TotpStatus.md)
 - [TransportLayerProtocol](docs/TransportLayerProtocol.md)
 - [TruststorePayload](docs/TruststorePayload.md)
 - [TruststoreSummary](docs/TruststoreSummary.md)
 - [TruststoreSummaryListResponse](docs/TruststoreSummaryListResponse.md)
 - [TruststoreType](docs/TruststoreType.md)
 - [UnmanagedObjectDetails](docs/UnmanagedObjectDetails.md)
 - [UnmanagedObjectDetailsListResponse](docs/UnmanagedObjectDetailsListResponse.md)
 - [UnmanagedObjectSlaAssignmentInfo](docs/UnmanagedObjectSlaAssignmentInfo.md)
 - [UnmanagedObjectSortAttribute](docs/UnmanagedObjectSortAttribute.md)
 - [UnmanagedObjectStatus](docs/UnmanagedObjectStatus.md)
 - [UnmanagedObjectSummary](docs/UnmanagedObjectSummary.md)
 - [UnmanagedObjectSummaryListResponse](docs/UnmanagedObjectSummaryListResponse.md)
 - [UnmanagedObjectType](docs/UnmanagedObjectType.md)
 - [UnmanagedSnapshotType](docs/UnmanagedSnapshotType.md)
 - [UpdateMountConfig](docs/UpdateMountConfig.md)
 - [UserActionV1](docs/UserActionV1.md)
 - [VappAttributes](docs/VappAttributes.md)
 - [VappExportMode](docs/VappExportMode.md)
 - [VappExportOptions](docs/VappExportOptions.md)
 - [VappExportSnapshotJobConfig](docs/VappExportSnapshotJobConfig.md)
 - [VappInstantRecoveryJobConfig](docs/VappInstantRecoveryJobConfig.md)
 - [VappInstantRecoveryOptions](docs/VappInstantRecoveryOptions.md)
 - [VappNetworkMode](docs/VappNetworkMode.md)
 - [VappNetworkSummary](docs/VappNetworkSummary.md)
 - [VappTemplateExportJobConfig](docs/VappTemplateExportJobConfig.md)
 - [VappTemplateExportOptions](docs/VappTemplateExportOptions.md)
 - [VappTemplateExportOptionsUnion](docs/VappTemplateExportOptionsUnion.md)
 - [VappVmDetail](docs/VappVmDetail.md)
 - [VappVmIpAddressingMode](docs/VappVmIpAddressingMode.md)
 - [VappVmNetworkConnection](docs/VappVmNetworkConnection.md)
 - [VappVmRestoreSpec](docs/VappVmRestoreSpec.md)
 - [VappVmSummary](docs/VappVmSummary.md)
 - [VcdClusterBaseConfig](docs/VcdClusterBaseConfig.md)
 - [VcdClusterConfig](docs/VcdClusterConfig.md)
 - [VcdClusterDetail](docs/VcdClusterDetail.md)
 - [VcdClusterListSortAttribute](docs/VcdClusterListSortAttribute.md)
 - [VcdClusterPatch](docs/VcdClusterPatch.md)
 - [VcdClusterSummary](docs/VcdClusterSummary.md)
 - [VcdClusterSummaryListResponse](docs/VcdClusterSummaryListResponse.md)
 - [VcdConnectionStatus](docs/VcdConnectionStatus.md)
 - [VcdHierarchyObjectAttributes](docs/VcdHierarchyObjectAttributes.md)
 - [VcdHierarchyObjectDescendantCount](docs/VcdHierarchyObjectDescendantCount.md)
 - [VcdHierarchyObjectSortAttribute](docs/VcdHierarchyObjectSortAttribute.md)
 - [VcdHierarchyObjectSummary](docs/VcdHierarchyObjectSummary.md)
 - [VcdHierarchyObjectSummaryListResponse](docs/VcdHierarchyObjectSummaryListResponse.md)
 - [VcdObjectType](docs/VcdObjectType.md)
 - [VcdOrgVdcStorageProfile](docs/VcdOrgVdcStorageProfile.md)
 - [VcdVappDetail](docs/VcdVappDetail.md)
 - [VcdVappObjectSortAttribute](docs/VcdVappObjectSortAttribute.md)
 - [VcdVappPatch](docs/VcdVappPatch.md)
 - [VcdVappSlaObjectCount](docs/VcdVappSlaObjectCount.md)
 - [VcdVappSnapshotDetail](docs/VcdVappSnapshotDetail.md)
 - [VcdVappSnapshotSummary](docs/VcdVappSnapshotSummary.md)
 - [VcdVappSnapshotSummaryDetailSharedFields](docs/VcdVappSnapshotSummaryDetailSharedFields.md)
 - [VcdVappSnapshotSummaryListResponse](docs/VcdVappSnapshotSummaryListResponse.md)
 - [VcdVappSummary](docs/VcdVappSummary.md)
 - [VcdVappSummaryListResponse](docs/VcdVappSummaryListResponse.md)
 - [VcdVmSnapshotDetail](docs/VcdVmSnapshotDetail.md)
 - [VcdVmSnapshotSummary](docs/VcdVmSnapshotSummary.md)
 - [VcenterConfig](docs/VcenterConfig.md)
 - [VcenterConnectionConfig](docs/VcenterConnectionConfig.md)
 - [VcenterDetail](docs/VcenterDetail.md)
 - [VcenterPatch](docs/VcenterPatch.md)
 - [VcenterPreAddConfig](docs/VcenterPreAddConfig.md)
 - [VcenterPreAddInfo](docs/VcenterPreAddInfo.md)
 - [VcenterSummary](docs/VcenterSummary.md)
 - [VcenterSummaryListResponse](docs/VcenterSummaryListResponse.md)
 - [VerificationParameters](docs/VerificationParameters.md)
 - [VerificationResponse](docs/VerificationResponse.md)
 - [VimserverSummary](docs/VimserverSummary.md)
 - [VimserverSummaryListResponse](docs/VimserverSummaryListResponse.md)
 - [VirtualDiskDetail](docs/VirtualDiskDetail.md)
 - [VirtualDiskUpdate](docs/VirtualDiskUpdate.md)
 - [VirtualMachineDetail](docs/VirtualMachineDetail.md)
 - [VirtualMachineScriptDetail](docs/VirtualMachineScriptDetail.md)
 - [VirtualMachineSummary](docs/VirtualMachineSummary.md)
 - [VirtualMachineSummaryListResponse](docs/VirtualMachineSummaryListResponse.md)
 - [VirtualMachineUpdate](docs/VirtualMachineUpdate.md)
 - [VirtualMachineUpdateWithSecret](docs/VirtualMachineUpdateWithSecret.md)
 - [VmForceFullRequest](docs/VmForceFullRequest.md)
 - [VmForceFullResponse](docs/VmForceFullResponse.md)
 - [VmGuestScriptRunConfig](docs/VmGuestScriptRunConfig.md)
 - [VmPathPoint](docs/VmPathPoint.md)
 - [VmSnapshotDetail](docs/VmSnapshotDetail.md)
 - [VmSnapshotDiskDetail](docs/VmSnapshotDiskDetail.md)
 - [VmSnapshotSummaries](docs/VmSnapshotSummaries.md)
 - [VmSnapshotSummary](docs/VmSnapshotSummary.md)
 - [VmSnapshotSummaryListResponse](docs/VmSnapshotSummaryListResponse.md)
 - [VmwareAdaptiveThrottlingSettings](docs/VmwareAdaptiveThrottlingSettings.md)
 - [VmwareCdpLiveInfo](docs/VmwareCdpLiveInfo.md)
 - [VmwareCdpStateInfo](docs/VmwareCdpStateInfo.md)
 - [VmwareHierarchyInfo](docs/VmwareHierarchyInfo.md)
 - [VmwareHierarchyInfoListResponse](docs/VmwareHierarchyInfoListResponse.md)
 - [VmwareHierarchyObjectType](docs/VmwareHierarchyObjectType.md)
 - [VmwareHostDatastoreDetail](docs/VmwareHostDatastoreDetail.md)
 - [VmwareHostDetail](docs/VmwareHostDetail.md)
 - [VmwareHostSummary](docs/VmwareHostSummary.md)
 - [VmwareHostSummaryListResponse](docs/VmwareHostSummaryListResponse.md)
 - [VmwareHostUpdate](docs/VmwareHostUpdate.md)
 - [VmwareNetworkCollection](docs/VmwareNetworkCollection.md)
 - [VmwareNetworkDeviceInfo](docs/VmwareNetworkDeviceInfo.md)
 - [VmwareNetworkInfo](docs/VmwareNetworkInfo.md)
 - [VmwareNetworkType](docs/VmwareNetworkType.md)
 - [VmwareRecoverableRange](docs/VmwareRecoverableRange.md)
 - [VmwareRecoverableRangeListResponse](docs/VmwareRecoverableRangeListResponse.md)
 - [VmwareVNicBindingInfo](docs/VmwareVNicBindingInfo.md)
 - [VmwareVdiskForceFullInfo](docs/VmwareVdiskForceFullInfo.md)
 - [VmwareVmMissedRecoverableRanges](docs/VmwareVmMissedRecoverableRanges.md)
 - [VmwareVmMountDetailV1](docs/VmwareVmMountDetailV1.md)
 - [VmwareVmMountSummaryV1](docs/VmwareVmMountSummaryV1.md)
 - [VmwareVmMountSummaryV1ListResponse](docs/VmwareVmMountSummaryV1ListResponse.md)
 - [VmwareVmRecoverableRanges](docs/VmwareVmRecoverableRanges.md)
 - [VolumeGroupDetail](docs/VolumeGroupDetail.md)
 - [VolumeGroupForceFullRequest](docs/VolumeGroupForceFullRequest.md)
 - [VolumeGroupForceFullResponse](docs/VolumeGroupForceFullResponse.md)
 - [VolumeGroupListSortAttribute](docs/VolumeGroupListSortAttribute.md)
 - [VolumeGroupMountListSortAttribute](docs/VolumeGroupMountListSortAttribute.md)
 - [VolumeGroupMountSummary](docs/VolumeGroupMountSummary.md)
 - [VolumeGroupMountSummaryListResponse](docs/VolumeGroupMountSummaryListResponse.md)
 - [VolumeGroupOnDemandSnapshotConfig](docs/VolumeGroupOnDemandSnapshotConfig.md)
 - [VolumeGroupPatch](docs/VolumeGroupPatch.md)
 - [VolumeGroupReleaseVersion](docs/VolumeGroupReleaseVersion.md)
 - [VolumeGroupRestoreVolumeSpec](docs/VolumeGroupRestoreVolumeSpec.md)
 - [VolumeGroupRestoreVolumesConfig](docs/VolumeGroupRestoreVolumesConfig.md)
 - [VolumeGroupSnapshotDetail](docs/VolumeGroupSnapshotDetail.md)
 - [VolumeGroupSnapshotSummary](docs/VolumeGroupSnapshotSummary.md)
 - [VolumeGroupSnapshotSummaryListResponse](docs/VolumeGroupSnapshotSummaryListResponse.md)
 - [VolumeGroupSnapshotVolumeSummary](docs/VolumeGroupSnapshotVolumeSummary.md)
 - [VolumeGroupSummary](docs/VolumeGroupSummary.md)
 - [VolumeGroupSummaryListResponse](docs/VolumeGroupSummaryListResponse.md)
 - [VolumeMountInfo](docs/VolumeMountInfo.md)
 - [WebServerCertificatePayload](docs/WebServerCertificatePayload.md)
 - [WebServerCertificateSummary](docs/WebServerCertificateSummary.md)
 - [WeeklyConfig](docs/WeeklyConfig.md)
 - [WindowsClusterDetail](docs/WindowsClusterDetail.md)
 - [WindowsClusterSummary](docs/WindowsClusterSummary.md)
 - [WindowsClusterSummaryListResponse](docs/WindowsClusterSummaryListResponse.md)
 - [YearlyConfig](docs/YearlyConfig.md)
