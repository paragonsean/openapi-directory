...
#include <iostream>
#include "../client/OAIArchiveApi.h"
...
void Example::exampleFunction1(){
     OAIArchiveApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIArchiveApi::disableArchivalLocationSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIArchiveApi::disableArchivalLocationSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString id = create(); // QString | ID assigned to an archival location object.
