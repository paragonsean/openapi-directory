...
OAIVmwareVmApi::OAIVmwareVmApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIVmwareVmApi::~OAIVmwareVmApi() {
}

void OAIVmwareVmApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("batchMountSnapshot", defaultConf);
    _serverIndices.insert("batchMountSnapshot", 0);
    _serverConfigs.insert("browseVmwareSnapshot", defaultConf);
    _serverIndices.insert("browseVmwareSnapshot", 0);
    _serverConfigs.insert("bulkCreateOnDemandBackup", defaultConf);
    _serverIndices.insert("bulkCreateOnDemandBackup", 0);
    _serverConfigs.insert("createDownloadFileJob", defaultConf);
    _serverIndices.insert("createDownloadFileJob", 0);
    _serverConfigs.insert("createDownloadSnapshotFromCloud", defaultConf);
    _serverIndices.insert("createDownloadSnapshotFromCloud", 0);
    _serverConfigs.insert("createExportV1", defaultConf);
    _serverIndices.insert("createExportV1", 0);
    _serverConfigs.insert("createExportWithDownloadFromCloudV1", defaultConf);
    _serverIndices.insert("createExportWithDownloadFromCloudV1", 0);
    _serverConfigs.insert("createInstantRecovery", defaultConf);
    _serverIndices.insert("createInstantRecovery", 0);
    _serverConfigs.insert("createMountV1", defaultConf);
    _serverIndices.insert("createMountV1", 0);
    _serverConfigs.insert("createOnDemandBackup", defaultConf);
    _serverIndices.insert("createOnDemandBackup", 0);
    _serverConfigs.insert("createRestoreFileJob", defaultConf);
    _serverIndices.insert("createRestoreFileJob", 0);
    _serverConfigs.insert("createUnmount", defaultConf);
    _serverIndices.insert("createUnmount", 0);
    _serverConfigs.insert("deleteVmwareSnapshot", defaultConf);
    _serverIndices.insert("deleteVmwareSnapshot", 0);
    _serverConfigs.insert("deleteVmwareSnapshots", defaultConf);
    _serverIndices.insert("deleteVmwareSnapshots", 0);
    _serverConfigs.insert("getAsyncRequestStatus", defaultConf);
    _serverIndices.insert("getAsyncRequestStatus", 0);
    _serverConfigs.insert("getMountV1", defaultConf);
    _serverIndices.insert("getMountV1", 0);
    _serverConfigs.insert("getSnapshot", defaultConf);
    _serverIndices.insert("getSnapshot", 0);
    _serverConfigs.insert("getVirtualDisk", defaultConf);
    _serverIndices.insert("getVirtualDisk", 0);
    _serverConfigs.insert("getVm", defaultConf);
    _serverIndices.insert("getVm", 0);
    _serverConfigs.insert("getVmForceFullSpec", defaultConf);
    _serverIndices.insert("getVmForceFullSpec", 0);
    _serverConfigs.insert("getVmwareCdpLiveInfo", defaultConf);
    _serverIndices.insert("getVmwareCdpLiveInfo", 0);
    _serverConfigs.insert("getVmwareCdpStateInfo", defaultConf);
    _serverIndices.insert("getVmwareCdpStateInfo", 0);
    _serverConfigs.insert("getVmwareMissedRecoverableRanges", defaultConf);
    _serverIndices.insert("getVmwareMissedRecoverableRanges", 0);
    _serverConfigs.insert("getVmwareRecoverableRanges", defaultConf);
    _serverIndices.insert("getVmwareRecoverableRanges", 0);
    _serverConfigs.insert("getVmwareVmMissedRecoverableRangesInBatch", defaultConf);
    _serverIndices.insert("getVmwareVmMissedRecoverableRangesInBatch", 0);
    _serverConfigs.insert("getVmwareVmRecoverableRangesInBatch", defaultConf);
    _serverIndices.insert("getVmwareVmRecoverableRangesInBatch", 0);
    _serverConfigs.insert("missedSnapshots", defaultConf);
    _serverIndices.insert("missedSnapshots", 0);
    _serverConfigs.insert("queryMountV1", defaultConf);
    _serverIndices.insert("queryMountV1", 0);
    _serverConfigs.insert("querySnapshot", defaultConf);
    _serverIndices.insert("querySnapshot", 0);
    _serverConfigs.insert("querySnapshotsForVms", defaultConf);
    _serverIndices.insert("querySnapshotsForVms", 0);
    _serverConfigs.insert("queryVm", defaultConf);
    _serverIndices.insert("queryVm", 0);
    _serverConfigs.insert("relocateMount", defaultConf);
    _serverIndices.insert("relocateMount", 0);
    _serverConfigs.insert("requestVmForceFullSnapshot", defaultConf);
    _serverIndices.insert("requestVmForceFullSnapshot", 0);
    _serverConfigs.insert("runGuestOsScript", defaultConf);
    _serverIndices.insert("runGuestOsScript", 0);
    _serverConfigs.insert("searchVm", defaultConf);
    _serverIndices.insert("searchVm", 0);
    _serverConfigs.insert("updateMount", defaultConf);
    _serverIndices.insert("updateMount", 0);
    _serverConfigs.insert("updateVirtualDisk", defaultConf);
    _serverIndices.insert("updateVirtualDisk", 0);
    _serverConfigs.insert("updateVm", defaultConf);
    _serverIndices.insert("updateVm", 0);
    _serverConfigs.insert("vmMakePrimary", defaultConf);
    _serverIndices.insert("vmMakePrimary", 0);
    _serverConfigs.insert("vmRegisterAgent", defaultConf);
    _serverIndices.insert("vmRegisterAgent", 0);
}
...
*/
int OAIVmwareVmApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIVmwareVmApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIVmwareVmApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIVmwareVmApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIVmwareVmApi::setUsername(const QString &username) {
    _username = username;
}

void OAIVmwareVmApi::setPassword(const QString &password) {
    _password = password;
}


void OAIVmwareVmApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIVmwareVmApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIVmwareVmApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIVmwareVmApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIVmwareVmApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIVmwareVmApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIVmwareVmApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIVmwareVmApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIVmwareVmApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIVmwareVmApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIVmwareVmApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIVmwareVmApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIVmwareVmApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIVmwareVmApi::batchMountSnapshot(const OAIBatchMountSnapshotJobConfig &oai_batch_mount_snapshot_job_config) {
    QString fullPath = QString(_serverConfigs["batchMountSnapshot"][_serverIndices.value("batchMountSnapshot")].URL()+"/vmware/vm/batch_mount");
...

    {
        ...
        QByteArray output = oai_batch_mount_snapshot_job_config.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::batchMountSnapshotCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIVmwareVmApi::batchMountSnapshotCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIBatchAsyncRequestStatus output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT batchMountSnapshotSignal(output);
        Q_EMIT batchMountSnapshotSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT batchMountSnapshotSignalE(output, error_type, error_str);
        Q_EMIT batchMountSnapshotSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT batchMountSnapshotSignalError(output, error_type, error_str);
        Q_EMIT batchMountSnapshotSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::browseVmwareSnapshot(const QString &id, const QString &path, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<qint32> &limit) {
    QString fullPath = QString(_serverConfigs["browseVmwareSnapshot"][_serverIndices.value("browseVmwareSnapshot")].URL()+"/vmware/vm/snapshot/{id}/browse");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::browseVmwareSnapshotCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::browseVmwareSnapshotCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBrowseResponseListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT browseVmwareSnapshotSignal(output);
        Q_EMIT browseVmwareSnapshotSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT browseVmwareSnapshotSignalE(output, error_type, error_str);
        Q_EMIT browseVmwareSnapshotSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT browseVmwareSnapshotSignalError(output, error_type, error_str);
        Q_EMIT browseVmwareSnapshotSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::bulkCreateOnDemandBackup(const OAIBulkOnDemandSnapshotJobConfig &oai_bulk_on_demand_snapshot_job_config) {
    QString fullPath = QString(_serverConfigs["bulkCreateOnDemandBackup"][_serverIndices.value("bulkCreateOnDemandBackup")].URL()+"/vmware/vm/snapshot/bulk");
...

    {
        ...
        QByteArray output = oai_bulk_on_demand_snapshot_job_config.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::bulkCreateOnDemandBackupCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::bulkCreateOnDemandBackupCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bulkCreateOnDemandBackupSignal(output);
        Q_EMIT bulkCreateOnDemandBackupSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bulkCreateOnDemandBackupSignalE(output, error_type, error_str);
        Q_EMIT bulkCreateOnDemandBackupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bulkCreateOnDemandBackupSignalError(output, error_type, error_str);
        Q_EMIT bulkCreateOnDemandBackupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::createDownloadFileJob(const QString &id, const OAIDownloadFileJobConfig &oai_download_file_job_config) {
    QString fullPath = QString(_serverConfigs["createDownloadFileJob"][_serverIndices.value("createDownloadFileJob")].URL()+"/vmware/vm/snapshot/{id}/download_file");
...

    {
        ...
        QByteArray output = oai_download_file_job_config.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::createDownloadFileJobCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::createDownloadFileJobCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createDownloadFileJobSignal(output);
        Q_EMIT createDownloadFileJobSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createDownloadFileJobSignalE(output, error_type, error_str);
        Q_EMIT createDownloadFileJobSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createDownloadFileJobSignalError(output, error_type, error_str);
        Q_EMIT createDownloadFileJobSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::createDownloadSnapshotFromCloud(const QString &id) {
    QString fullPath = QString(_serverConfigs["createDownloadSnapshotFromCloud"][_serverIndices.value("createDownloadSnapshotFromCloud")].URL()+"/vmware/vm/snapshot/{id}/download");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::createDownloadSnapshotFromCloudCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::createDownloadSnapshotFromCloudCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createDownloadSnapshotFromCloudSignal(output);
        Q_EMIT createDownloadSnapshotFromCloudSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createDownloadSnapshotFromCloudSignalE(output, error_type, error_str);
        Q_EMIT createDownloadSnapshotFromCloudSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createDownloadSnapshotFromCloudSignalError(output, error_type, error_str);
        Q_EMIT createDownloadSnapshotFromCloudSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::createExportV1(const QString &id, const OAIExportSnapshotJobConfigV1 &oai_export_snapshot_job_config_v1) {
    QString fullPath = QString(_serverConfigs["createExportV1"][_serverIndices.value("createExportV1")].URL()+"/vmware/vm/snapshot/{id}/export");
...

    {
        ...
        QByteArray output = oai_export_snapshot_job_config_v1.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::createExportV1Callback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::createExportV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createExportV1Signal(output);
        Q_EMIT createExportV1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createExportV1SignalE(output, error_type, error_str);
        Q_EMIT createExportV1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createExportV1SignalError(output, error_type, error_str);
        Q_EMIT createExportV1SignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::createExportWithDownloadFromCloudV1(const QString &id, const OAIExportSnapshotJobConfigV1 &oai_export_snapshot_job_config_v1) {
    QString fullPath = QString(_serverConfigs["createExportWithDownloadFromCloudV1"][_serverIndices.value("createExportWithDownloadFromCloudV1")].URL()+"/vmware/vm/snapshot/{id}/export_with_download");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::createExportWithDownloadFromCloudV1Callback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::createExportWithDownloadFromCloudV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createExportWithDownloadFromCloudV1Signal(output);
        Q_EMIT createExportWithDownloadFromCloudV1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createExportWithDownloadFromCloudV1SignalE(output, error_type, error_str);
        Q_EMIT createExportWithDownloadFromCloudV1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createExportWithDownloadFromCloudV1SignalError(output, error_type, error_str);
        Q_EMIT createExportWithDownloadFromCloudV1SignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::createInstantRecovery(const QString &id, const OAIInstantRecoveryJobConfig &oai_instant_recovery_job_config) {
    QString fullPath = QString(_serverConfigs["createInstantRecovery"][_serverIndices.value("createInstantRecovery")].URL()+"/vmware/vm/snapshot/{id}/instant_recover");
...

    {
        ...
        QByteArray output = oai_instant_recovery_job_config.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::createInstantRecoveryCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::createInstantRecoveryCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createInstantRecoverySignal(output);
        Q_EMIT createInstantRecoverySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createInstantRecoverySignalE(output, error_type, error_str);
        Q_EMIT createInstantRecoverySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createInstantRecoverySignalError(output, error_type, error_str);
        Q_EMIT createInstantRecoverySignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::createMountV1(const QString &id, const ::OpenAPI::OptionalParam<OAIMountSnapshotJobConfigV1> &oai_mount_snapshot_job_config_v1) {
    QString fullPath = QString(_serverConfigs["createMountV1"][_serverIndices.value("createMountV1")].URL()+"/vmware/vm/snapshot/{id}/mount");
    ...
    if (oai_mount_snapshot_job_config_v1.hasValue()){

        
        QByteArray output = oai_mount_snapshot_job_config_v1.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::createMountV1Callback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::createMountV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createMountV1Signal(output);
        Q_EMIT createMountV1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createMountV1SignalE(output, error_type, error_str);
        Q_EMIT createMountV1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createMountV1SignalError(output, error_type, error_str);
        Q_EMIT createMountV1SignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::createOnDemandBackup(const QString &id, const ::OpenAPI::OptionalParam<OAIBaseOnDemandSnapshotConfig> &oai_base_on_demand_snapshot_config) {
    QString fullPath = QString(_serverConfigs["createOnDemandBackup"][_serverIndices.value("createOnDemandBackup")].URL()+"/vmware/vm/{id}/snapshot");
    ...
    if (oai_base_on_demand_snapshot_config.hasValue()){

        
        QByteArray output = oai_base_on_demand_snapshot_config.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::createOnDemandBackupCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::createOnDemandBackupCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createOnDemandBackupSignal(output);
        Q_EMIT createOnDemandBackupSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createOnDemandBackupSignalE(output, error_type, error_str);
        Q_EMIT createOnDemandBackupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createOnDemandBackupSignalError(output, error_type, error_str);
        Q_EMIT createOnDemandBackupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::createRestoreFileJob(const QString &id, const OAIRestoreFileJobConfig &oai_restore_file_job_config) {
    QString fullPath = QString(_serverConfigs["createRestoreFileJob"][_serverIndices.value("createRestoreFileJob")].URL()+"/vmware/vm/snapshot/{id}/restore_file");
...

    {
        ...
        QByteArray output = oai_restore_file_job_config.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::createRestoreFileJobCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::createRestoreFileJobCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createRestoreFileJobSignal(output);
        Q_EMIT createRestoreFileJobSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createRestoreFileJobSignalE(output, error_type, error_str);
        Q_EMIT createRestoreFileJobSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createRestoreFileJobSignalError(output, error_type, error_str);
        Q_EMIT createRestoreFileJobSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::createUnmount(const QString &id, const ::OpenAPI::OptionalParam<bool> &force) {
    QString fullPath = QString(_serverConfigs["createUnmount"][_serverIndices.value("createUnmount")].URL()+"/vmware/vm/snapshot/mount/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::createUnmountCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::createUnmountCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT createUnmountSignal(output);
        Q_EMIT createUnmountSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT createUnmountSignalE(output, error_type, error_str);
        Q_EMIT createUnmountSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT createUnmountSignalError(output, error_type, error_str);
        Q_EMIT createUnmountSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::deleteVmwareSnapshot(const QString &id, const QString &location) {
    QString fullPath = QString(_serverConfigs["deleteVmwareSnapshot"][_serverIndices.value("deleteVmwareSnapshot")].URL()+"/vmware/vm/snapshot/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::deleteVmwareSnapshotCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::deleteVmwareSnapshotCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteVmwareSnapshotSignal();
        Q_EMIT deleteVmwareSnapshotSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteVmwareSnapshotSignalE(error_type, error_str);
        Q_EMIT deleteVmwareSnapshotSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteVmwareSnapshotSignalError(error_type, error_str);
        Q_EMIT deleteVmwareSnapshotSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::deleteVmwareSnapshots(const QString &id) {
    QString fullPath = QString(_serverConfigs["deleteVmwareSnapshots"][_serverIndices.value("deleteVmwareSnapshots")].URL()+"/vmware/vm/{id}/snapshot");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::deleteVmwareSnapshotsCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::deleteVmwareSnapshotsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT deleteVmwareSnapshotsSignal();
        Q_EMIT deleteVmwareSnapshotsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT deleteVmwareSnapshotsSignalE(error_type, error_str);
        Q_EMIT deleteVmwareSnapshotsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT deleteVmwareSnapshotsSignalError(error_type, error_str);
        Q_EMIT deleteVmwareSnapshotsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::getAsyncRequestStatus(const QString &id) {
    QString fullPath = QString(_serverConfigs["getAsyncRequestStatus"][_serverIndices.value("getAsyncRequestStatus")].URL()+"/vmware/vm/request/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getAsyncRequestStatusCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getAsyncRequestStatusCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAsyncRequestStatusSignal(output);
        Q_EMIT getAsyncRequestStatusSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAsyncRequestStatusSignalE(output, error_type, error_str);
        Q_EMIT getAsyncRequestStatusSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAsyncRequestStatusSignalError(output, error_type, error_str);
        Q_EMIT getAsyncRequestStatusSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::getMountV1(const QString &id) {
    QString fullPath = QString(_serverConfigs["getMountV1"][_serverIndices.value("getMountV1")].URL()+"/vmware/vm/snapshot/mount/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getMountV1Callback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getMountV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIVmwareVmMountDetailV1 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getMountV1Signal(output);
        Q_EMIT getMountV1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getMountV1SignalE(output, error_type, error_str);
        Q_EMIT getMountV1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getMountV1SignalError(output, error_type, error_str);
        Q_EMIT getMountV1SignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::getSnapshot(const QString &id) {
    QString fullPath = QString(_serverConfigs["getSnapshot"][_serverIndices.value("getSnapshot")].URL()+"/vmware/vm/snapshot/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getSnapshotCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getSnapshotCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIVmSnapshotDetail output(QString(worker->response));
    worker->deleteLater();
...
void OAIVmwareVmApi::getVirtualDisk(const QString &id) {
    QString fullPath = QString(_serverConfigs["getVirtualDisk"][_serverIndices.value("getVirtualDisk")].URL()+"/vmware/vm/virtual_disk/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getVirtualDiskCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getVirtualDiskCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIVirtualDiskDetail output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getVirtualDiskSignal(output);
        Q_EMIT getVirtualDiskSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getVirtualDiskSignalE(output, error_type, error_str);
        Q_EMIT getVirtualDiskSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getVirtualDiskSignalError(output, error_type, error_str);
        Q_EMIT getVirtualDiskSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::getVm(const QString &id) {
    QString fullPath = QString(_serverConfigs["getVm"][_serverIndices.value("getVm")].URL()+"/vmware/vm/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getVmCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getVmCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIVirtualMachineDetail output(QString(worker->response));
    worker->deleteLater();
...
void OAIVmwareVmApi::getVmForceFullSpec(const QString &id) {
    QString fullPath = QString(_serverConfigs["getVmForceFullSpec"][_serverIndices.value("getVmForceFullSpec")].URL()+"/vmware/vm/{id}/request/force_full_snapshot");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getVmForceFullSpecCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getVmForceFullSpecCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIVmForceFullResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getVmForceFullSpecSignal(output);
        Q_EMIT getVmForceFullSpecSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getVmForceFullSpecSignalE(output, error_type, error_str);
        Q_EMIT getVmForceFullSpecSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getVmForceFullSpecSignalError(output, error_type, error_str);
        Q_EMIT getVmForceFullSpecSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::getVmwareCdpLiveInfo(const QList<QString> &request_body) {
    QString fullPath = QString(_serverConfigs["getVmwareCdpLiveInfo"][_serverIndices.value("getVmwareCdpLiveInfo")].URL()+"/vmware/vm/cdp");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getVmwareCdpLiveInfoCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getVmwareCdpLiveInfoCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBatchVmwareCdpLiveInfo output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getVmwareCdpLiveInfoSignal(output);
        Q_EMIT getVmwareCdpLiveInfoSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getVmwareCdpLiveInfoSignalE(output, error_type, error_str);
        Q_EMIT getVmwareCdpLiveInfoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getVmwareCdpLiveInfoSignalError(output, error_type, error_str);
        Q_EMIT getVmwareCdpLiveInfoSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::getVmwareCdpStateInfo(const QList<QString> &request_body) {
    QString fullPath = QString(_serverConfigs["getVmwareCdpStateInfo"][_serverIndices.value("getVmwareCdpStateInfo")].URL()+"/vmware/vm/cdp_state");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getVmwareCdpStateInfoCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getVmwareCdpStateInfoCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBatchVmwareCdpStateInfo output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getVmwareCdpStateInfoSignal(output);
        Q_EMIT getVmwareCdpStateInfoSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getVmwareCdpStateInfoSignalE(output, error_type, error_str);
        Q_EMIT getVmwareCdpStateInfoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getVmwareCdpStateInfoSignalError(output, error_type, error_str);
        Q_EMIT getVmwareCdpStateInfoSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::getVmwareMissedRecoverableRanges(const QString &id, const ::OpenAPI::OptionalParam<QDateTime> &after_time, const ::OpenAPI::OptionalParam<QDateTime> &before_time) {
    QString fullPath = QString(_serverConfigs["getVmwareMissedRecoverableRanges"][_serverIndices.value("getVmwareMissedRecoverableRanges")].URL()+"/vmware/vm/{id}/missed_recoverable_range");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getVmwareMissedRecoverableRangesCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getVmwareMissedRecoverableRangesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIVmwareRecoverableRangeListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getVmwareMissedRecoverableRangesSignal(output);
        Q_EMIT getVmwareMissedRecoverableRangesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getVmwareMissedRecoverableRangesSignalE(output, error_type, error_str);
        Q_EMIT getVmwareMissedRecoverableRangesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getVmwareMissedRecoverableRangesSignalError(output, error_type, error_str);
        Q_EMIT getVmwareMissedRecoverableRangesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::getVmwareRecoverableRanges(const QString &id, const ::OpenAPI::OptionalParam<QDateTime> &after_time, const ::OpenAPI::OptionalParam<QDateTime> &before_time) {
    QString fullPath = QString(_serverConfigs["getVmwareRecoverableRanges"][_serverIndices.value("getVmwareRecoverableRanges")].URL()+"/vmware/vm/{id}/recoverable_range");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getVmwareRecoverableRangesCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getVmwareRecoverableRangesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getVmwareRecoverableRangesSignal(output);
        Q_EMIT getVmwareRecoverableRangesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getVmwareRecoverableRangesSignalE(output, error_type, error_str);
        Q_EMIT getVmwareRecoverableRangesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getVmwareRecoverableRangesSignalError(output, error_type, error_str);
        Q_EMIT getVmwareRecoverableRangesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::getVmwareVmMissedRecoverableRangesInBatch(const OAIBatchVmwareVmMissedRecoverableRangesRequest &oai_batch_vmware_vm_missed_recoverable_ranges_request) {
    QString fullPath = QString(_serverConfigs["getVmwareVmMissedRecoverableRangesInBatch"][_serverIndices.value("getVmwareVmMissedRecoverableRangesInBatch")].URL()+"/vmware/vm/missed_recoverable_range");
...

    {
        ...
        QByteArray output = oai_batch_vmware_vm_missed_recoverable_ranges_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getVmwareVmMissedRecoverableRangesInBatchCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getVmwareVmMissedRecoverableRangesInBatchCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBatchVmwareVmMissedRecoverableRanges output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getVmwareVmMissedRecoverableRangesInBatchSignal(output);
        Q_EMIT getVmwareVmMissedRecoverableRangesInBatchSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getVmwareVmMissedRecoverableRangesInBatchSignalE(output, error_type, error_str);
        Q_EMIT getVmwareVmMissedRecoverableRangesInBatchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getVmwareVmMissedRecoverableRangesInBatchSignalError(output, error_type, error_str);
        Q_EMIT getVmwareVmMissedRecoverableRangesInBatchSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::getVmwareVmRecoverableRangesInBatch(const OAIBatchVmwareVmRecoverableRangesRequest &oai_batch_vmware_vm_recoverable_ranges_request) {
    QString fullPath = QString(_serverConfigs["getVmwareVmRecoverableRangesInBatch"][_serverIndices.value("getVmwareVmRecoverableRangesInBatch")].URL()+"/vmware/vm/recoverable_range");
...

    {
        ...
        QByteArray output = oai_batch_vmware_vm_recoverable_ranges_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::getVmwareVmRecoverableRangesInBatchCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::getVmwareVmRecoverableRangesInBatchCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBatchVmwareVmRecoverableRanges output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getVmwareVmRecoverableRangesInBatchSignal(output);
        Q_EMIT getVmwareVmRecoverableRangesInBatchSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getVmwareVmRecoverableRangesInBatchSignalE(output, error_type, error_str);
        Q_EMIT getVmwareVmRecoverableRangesInBatchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getVmwareVmRecoverableRangesInBatchSignalError(output, error_type, error_str);
        Q_EMIT getVmwareVmRecoverableRangesInBatchSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::missedSnapshots(const QString &id) {
    QString fullPath = QString(_serverConfigs["missedSnapshots"][_serverIndices.value("missedSnapshots")].URL()+"/vmware/vm/{id}/missed_snapshot");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::missedSnapshotsCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::missedSnapshotsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT missedSnapshotsSignal(output);
        Q_EMIT missedSnapshotsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT missedSnapshotsSignalE(output, error_type, error_str);
        Q_EMIT missedSnapshotsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT missedSnapshotsSignalError(output, error_type, error_str);
        Q_EMIT missedSnapshotsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::queryMountV1(const ::OpenAPI::OptionalParam<QString> &vm_id, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<qint32> &limit) {
    QString fullPath = QString(_serverConfigs["queryMountV1"][_serverIndices.value("queryMountV1")].URL()+"/vmware/vm/snapshot/mount");
    ...
    if (vm_id.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "vm_id", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("vm_id")).append(querySuffix).append(QUrl::toPercentEncoding(vm_id.stringValue()));
    }
    if (offset.hasValue())
    {
        queryStyle = "form";
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::queryMountV1Callback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::queryMountV1Callback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIVmwareVmMountSummaryV1ListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT queryMountV1Signal(output);
        Q_EMIT queryMountV1SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT queryMountV1SignalE(output, error_type, error_str);
        Q_EMIT queryMountV1SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT queryMountV1SignalError(output, error_type, error_str);
        Q_EMIT queryMountV1SignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::querySnapshot(const QString &id) {
    QString fullPath = QString(_serverConfigs["querySnapshot"][_serverIndices.value("querySnapshot")].URL()+"/vmware/vm/{id}/snapshot");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::querySnapshotCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::querySnapshotCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIVmSnapshotSummaryListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT querySnapshotSignal(output);
        Q_EMIT querySnapshotSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT querySnapshotSignalE(output, error_type, error_str);
        Q_EMIT querySnapshotSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT querySnapshotSignalError(output, error_type, error_str);
        Q_EMIT querySnapshotSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::querySnapshotsForVms(const QList<QString> &request_body) {
    QString fullPath = QString(_serverConfigs["querySnapshotsForVms"][_serverIndices.value("querySnapshotsForVms")].URL()+"/vmware/vm/snapshots");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::querySnapshotsForVmsCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::querySnapshotsForVmsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBatchVmSnapshotSummaries output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT querySnapshotsForVmsSignal(output);
        Q_EMIT querySnapshotsForVmsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT querySnapshotsForVmsSignalE(output, error_type, error_str);
        Q_EMIT querySnapshotsForVmsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT querySnapshotsForVmsSignalError(output, error_type, error_str);
        Q_EMIT querySnapshotsForVmsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::queryVm(const ::OpenAPI::OptionalParam<QString> &effective_sla_domain_id, const ::OpenAPI::OptionalParam<QString> &primary_cluster_id, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<qint32> &offset, const ::OpenAPI::OptionalParam<bool> &is_relic, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<QString> &moid, const ::OpenAPI::OptionalParam<QString> &sla_assignment, const ::OpenAPI::OptionalParam<QString> &guest_os_name, const ::OpenAPI::OptionalParam<QString> &sort_by, const ::OpenAPI::OptionalParam<QString> &sort_order) {
    QString fullPath = QString(_serverConfigs["queryVm"][_serverIndices.value("queryVm")].URL()+"/vmware/vm");
    ...
    if (moid.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "moid", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("moid")).append(querySuffix).append(QUrl::toPercentEncoding(moid.stringValue()));
    }
    ...
    if (guest_os_name.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "guest_os_name", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("guest_os_name")).append(querySuffix).append(QUrl::toPercentEncoding(guest_os_name.stringValue()));
    }
    if (sort_by.hasValue())
    {
        queryStyle = "form";
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::queryVmCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::queryVmCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIVirtualMachineSummaryListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT queryVmSignal(output);
        Q_EMIT queryVmSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT queryVmSignalE(output, error_type, error_str);
        Q_EMIT queryVmSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT queryVmSignalError(output, error_type, error_str);
        Q_EMIT queryVmSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::relocateMount(const QString &id, const OAIRelocateMountConfig &oai_relocate_mount_config) {
    QString fullPath = QString(_serverConfigs["relocateMount"][_serverIndices.value("relocateMount")].URL()+"/vmware/vm/snapshot/mount/{id}/relocate");
...

    {
        ...
        QByteArray output = oai_relocate_mount_config.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::relocateMountCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::relocateMountCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT relocateMountSignal(output);
        Q_EMIT relocateMountSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT relocateMountSignalE(output, error_type, error_str);
        Q_EMIT relocateMountSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT relocateMountSignalError(output, error_type, error_str);
        Q_EMIT relocateMountSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::requestVmForceFullSnapshot(const QString &id, const OAIVmForceFullRequest &oaivm_force_full_request) {
    QString fullPath = QString(_serverConfigs["requestVmForceFullSnapshot"][_serverIndices.value("requestVmForceFullSnapshot")].URL()+"/vmware/vm/{id}/request/force_full_snapshot");
...

    {
        ...
        QByteArray output = oaivm_force_full_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::requestVmForceFullSnapshotCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::requestVmForceFullSnapshotCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT requestVmForceFullSnapshotSignal(output);
        Q_EMIT requestVmForceFullSnapshotSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT requestVmForceFullSnapshotSignalE(output, error_type, error_str);
        Q_EMIT requestVmForceFullSnapshotSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT requestVmForceFullSnapshotSignalError(output, error_type, error_str);
        Q_EMIT requestVmForceFullSnapshotSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::runGuestOsScript(const QString &id, const OAIVmGuestScriptRunConfig &oaivm_guest_script_run_config) {
    QString fullPath = QString(_serverConfigs["runGuestOsScript"][_serverIndices.value("runGuestOsScript")].URL()+"/vmware/vm/{id}/guest_script/run");
...

    {
        ...
        QByteArray output = oaivm_guest_script_run_config.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::runGuestOsScriptCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::runGuestOsScriptCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT runGuestOsScriptSignal();
        Q_EMIT runGuestOsScriptSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT runGuestOsScriptSignalE(error_type, error_str);
        Q_EMIT runGuestOsScriptSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT runGuestOsScriptSignalError(error_type, error_str);
        Q_EMIT runGuestOsScriptSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::searchVm(const QString &id, const QString &path, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<QString> &cursor) {
    QString fullPath = QString(_serverConfigs["searchVm"][_serverIndices.value("searchVm")].URL()+"/vmware/vm/{id}/search");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::searchVmCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::searchVmCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISearchResponseListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchVmSignal(output);
        Q_EMIT searchVmSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchVmSignalE(output, error_type, error_str);
        Q_EMIT searchVmSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchVmSignalError(output, error_type, error_str);
        Q_EMIT searchVmSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::updateMount(const QString &id, const OAIUpdateMountConfig &oai_update_mount_config) {
    QString fullPath = QString(_serverConfigs["updateMount"][_serverIndices.value("updateMount")].URL()+"/vmware/vm/snapshot/mount/{id}");
...

    {
        ...
        QByteArray output = oai_update_mount_config.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::updateMountCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::updateMountCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateMountSignal(output);
        Q_EMIT updateMountSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateMountSignalE(output, error_type, error_str);
        Q_EMIT updateMountSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateMountSignalError(output, error_type, error_str);
        Q_EMIT updateMountSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::updateVirtualDisk(const QString &id, const OAIVirtualDiskUpdate &oai_virtual_disk_update) {
    QString fullPath = QString(_serverConfigs["updateVirtualDisk"][_serverIndices.value("updateVirtualDisk")].URL()+"/vmware/vm/virtual_disk/{id}");
...

    {
        ...
        QByteArray output = oai_virtual_disk_update.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::updateVirtualDiskCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::updateVirtualDiskCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateVirtualDiskSignal(output);
        Q_EMIT updateVirtualDiskSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateVirtualDiskSignalE(output, error_type, error_str);
        Q_EMIT updateVirtualDiskSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateVirtualDiskSignalError(output, error_type, error_str);
        Q_EMIT updateVirtualDiskSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::updateVm(const QString &id, const OAIVirtualMachineUpdateWithSecret &oai_virtual_machine_update_with_secret) {
    QString fullPath = QString(_serverConfigs["updateVm"][_serverIndices.value("updateVm")].URL()+"/vmware/vm/{id}");
...

    {
        ...
        QByteArray output = oai_virtual_machine_update_with_secret.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::updateVmCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::updateVmCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateVmSignal(output);
        Q_EMIT updateVmSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateVmSignalE(output, error_type, error_str);
        Q_EMIT updateVmSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateVmSignalError(output, error_type, error_str);
        Q_EMIT updateVmSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::vmMakePrimary(const QList<QString> &request_body) {
    QString fullPath = QString(_serverConfigs["vmMakePrimary"][_serverIndices.value("vmMakePrimary")].URL()+"/vmware/vm/make_primary");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::vmMakePrimaryCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::vmMakePrimaryCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT vmMakePrimarySignal(output);
        Q_EMIT vmMakePrimarySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT vmMakePrimarySignalE(output, error_type, error_str);
        Q_EMIT vmMakePrimarySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT vmMakePrimarySignalError(output, error_type, error_str);
        Q_EMIT vmMakePrimarySignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::vmRegisterAgent(const QString &id) {
    QString fullPath = QString(_serverConfigs["vmRegisterAgent"][_serverIndices.value("vmRegisterAgent")].URL()+"/vmware/vm/{id}/register_agent");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVmwareVmApi::vmRegisterAgentCallback);
    connect(this, &OAIVmwareVmApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVmwareVmApi::vmRegisterAgentCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT vmRegisterAgentSignal();
        Q_EMIT vmRegisterAgentSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT vmRegisterAgentSignalE(error_type, error_str);
        Q_EMIT vmRegisterAgentSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT vmRegisterAgentSignalError(error_type, error_str);
        Q_EMIT vmRegisterAgentSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVmwareVmApi::tokenAvailable(){
