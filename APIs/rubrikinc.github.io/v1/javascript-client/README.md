...
RubrikRestApi - JavaScript client for rubrik_rest_api
...
```shell
npm install rubrik_rest_api --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your rubrik_rest_api from, and run:
...
```javascript
var RubrikRestApi = require('rubrik_rest_api');

var defaultClient = RubrikRestApi.ApiClient.instance;
...
var api = new RubrikRestApi.ArchiveApi()
var id = "id_example"; // {String} ID assigned to an archival location object.
...
api.disableArchivalLocation(id, callback);
...
------------ | ------------- | ------------- | -------------
*RubrikRestApi.ArchiveApi* | [**disableArchivalLocation**](docs/ArchiveApi.md#disableArchivalLocation) | **POST** /archive/location/{id}/owner/disable | Disable location for archival and modification operations
*RubrikRestApi.ArchiveApi* | [**enableArchivalLocation**](docs/ArchiveApi.md#enableArchivalLocation) | **POST** /archive/location/{id}/owner/enable | Enable archival location for archival and modification operations
*RubrikRestApi.ArchiveApi* | [**getAwsAccountId**](docs/ArchiveApi.md#getAwsAccountId) | **GET** /archive/aws/s3/{id}/account_id | Get the AWS account ID of an AWS S3 archival location
*RubrikRestApi.ArchiveApi* | [**refreshArchivalLocationDataSources**](docs/ArchiveApi.md#refreshArchivalLocationDataSources) | **POST** /archive/location/{location_id}/reader/refresh/data_sources | Refresh archive information for a list of data sources
*RubrikRestApi.AuthorizationApi* | [**deleteAuthzCache**](docs/AuthorizationApi.md#deleteAuthzCache) | **DELETE** /authorization/cache | Clear cached authorization information
*RubrikRestApi.BackupApi* | [**createBackupRemediationAsyncTask**](docs/BackupApi.md#createBackupRemediationAsyncTask) | **POST** /backup/retry | Reschedule unsuccessful backup tasks
*RubrikRestApi.BackupApi* | [**getBackupRemediationAsyncTaskStatus**](docs/BackupApi.md#getBackupRemediationAsyncTaskStatus) | **GET** /backup/retry/{id} | Get status of reschedule attempt
*RubrikRestApi.BackupApi* | [**getBackupVerificationAsyncRequestStatus**](docs/BackupApi.md#getBackupVerificationAsyncRequestStatus) | **GET** /backup/verify/{id} | Get asynchronous request details for Backup Verification
*RubrikRestApi.BackupApi* | [**verifySnapshot**](docs/BackupApi.md#verifySnapshot) | **POST** /backup/verify | Trigger a job for snapshot verification
*RubrikRestApi.BlackoutWindowApi* | [**getBlackoutWindowStatus**](docs/BlackoutWindowApi.md#getBlackoutWindowStatus) | **GET** /blackout_window | Get current status of global blackout window
*RubrikRestApi.BlackoutWindowApi* | [**toggleBlackoutWindow**](docs/BlackoutWindowApi.md#toggleBlackoutWindow) | **PATCH** /blackout_window | Starts or stops the global blackout window in local Rubrik cluster
*RubrikRestApi.CertificateApi* | [**deleteCertificate**](docs/CertificateApi.md#deleteCertificate) | **DELETE** /certificate/{id} | Delete imported certificate object
*RubrikRestApi.CertificateApi* | [**exportCertificate**](docs/CertificateApi.md#exportCertificate) | **GET** /certificate/{id} | Get a certificate summary to export
*RubrikRestApi.CertificateApi* | [**importCertificate**](docs/CertificateApi.md#importCertificate) | **POST** /certificate | Import a certificate
*RubrikRestApi.CertificateApi* | [**queryCertificates**](docs/CertificateApi.md#queryCertificates) | **GET** /certificate | Get all certificates
*RubrikRestApi.CertificateApi* | [**updateCertificate**](docs/CertificateApi.md#updateCertificate) | **PATCH** /certificate/{id} | Update a certificate entry
*RubrikRestApi.CertificateAgentApi* | [**markAgentSecondaryCertificate**](docs/CertificateAgentApi.md#markAgentSecondaryCertificate) | **POST** /certificate/agent | Mark a certificate to be added to agents
*RubrikRestApi.CertificateAgentApi* | [**queryAgentSecondaryCertificate**](docs/CertificateAgentApi.md#queryAgentSecondaryCertificate) | **GET** /certificate/agent | Get all potential agent secondary cluster certificates
*RubrikRestApi.CertificateAgentApi* | [**unmarkAgentSecondaryCertificate**](docs/CertificateAgentApi.md#unmarkAgentSecondaryCertificate) | **DELETE** /certificate/agent/{id} | Unmark a certificate that was previously marked
*RubrikRestApi.CloudUtilizationApi* | [**doCloudOutForecast**](docs/CloudUtilizationApi.md#doCloudOutForecast) | **POST** /cloud_utilization/cloud_out_forecast | Forecast of the cloud utilization for CloudOut
*RubrikRestApi.ClusterApi* | [**addKmipServer**](docs/ClusterApi.md#addKmipServer) | **PUT** /cluster/{id}/security/kmip/server | Add a KMIP server
*RubrikRestApi.ClusterApi* | [**addSyslogExportRule**](docs/ClusterApi.md#addSyslogExportRule) | **POST** /syslog/export | Add a new syslog export rule
*RubrikRestApi.ClusterApi* | [**availableVersion**](docs/ClusterApi.md#availableVersion) | **GET** /cluster/{id}/upgrade/available_version | Retrieve CDM versions available for upgrade
*RubrikRestApi.ClusterApi* | [**changeClusterNodeHostnames**](docs/ClusterApi.md#changeClusterNodeHostnames) | **POST** /cluster/{id}/node_hostname | Change hostname for nodes in a Rubrik cluster
*RubrikRestApi.ClusterApi* | [**deleteKmipServer**](docs/ClusterApi.md#deleteKmipServer) | **DELETE** /cluster/{id}/security/kmip/server | Remove the specified KMIP server
*RubrikRestApi.ClusterApi* | [**deleteSyslogExportRule**](docs/ClusterApi.md#deleteSyslogExportRule) | **DELETE** /syslog/export/{id} | Delete the specified syslog export rule
*RubrikRestApi.ClusterApi* | [**getAsyncRequestStatusForUpgrade**](docs/ClusterApi.md#getAsyncRequestStatusForUpgrade) | **GET** /cluster/{id}/upgrade/request/{request_id} | Get asynchronous request details
*RubrikRestApi.ClusterApi* | [**getClusterApiVersion**](docs/ClusterApi.md#getClusterApiVersion) | **GET** /cluster/{id}/api_version | Get cluster REST API version
*RubrikRestApi.ClusterApi* | [**getClusterCertificate**](docs/ClusterApi.md#getClusterCertificate) | **GET** /cluster/{id}/certificate | Get the cluster certificate
*RubrikRestApi.ClusterApi* | [**getClusterNodeHostnames**](docs/ClusterApi.md#getClusterNodeHostnames) | **GET** /cluster/{id}/node_hostname | Get the node ID to hostname mapping for all the nodes in a Rubrik cluster 
*RubrikRestApi.ClusterApi* | [**getClusterNodeIds**](docs/ClusterApi.md#getClusterNodeIds) | **GET** /cluster/{id}/node_id | Get the name of the nodes in the cluster
*RubrikRestApi.ClusterApi* | [**getClusterVersion**](docs/ClusterApi.md#getClusterVersion) | **GET** /cluster/{id}/version | Get cluster software version
*RubrikRestApi.ClusterApi* | [**getCorsConfiguration**](docs/ClusterApi.md#getCorsConfiguration) | **GET** /cluster/{id}/security/cors | Get CORS configuration
*RubrikRestApi.ClusterApi* | [**getEncryptionStatus**](docs/ClusterApi.md#getEncryptionStatus) | **GET** /cluster/{id}/security/encryption | Get encryption at rest status
*RubrikRestApi.ClusterApi* | [**getFips**](docs/ClusterApi.md#getFips) | **GET** /cluster/{id}/security/fips | Get FIPS enablement status
*RubrikRestApi.ClusterApi* | [**getKmipClient**](docs/ClusterApi.md#getKmipClient) | **GET** /cluster/{id}/security/kmip/client | Get the KMIP client configuration
*RubrikRestApi.ClusterApi* | [**getKmipServer**](docs/ClusterApi.md#getKmipServer) | **GET** /cluster/{id}/security/kmip/server | Get KMIP server information
*RubrikRestApi.ClusterApi* | [**getPeriodicUpgradePrechecksStatus**](docs/ClusterApi.md#getPeriodicUpgradePrechecksStatus) | **GET** /cluster/{id}/upgrade/precheck_status | Get the result of the latest run of the upgrade prechecks
*RubrikRestApi.ClusterApi* | [**getPublicClusterInfo**](docs/ClusterApi.md#getPublicClusterInfo) | **GET** /cluster/{id} | Get cluster details
*RubrikRestApi.ClusterApi* | [**getRubrikSnmpMibDownloadLink**](docs/ClusterApi.md#getRubrikSnmpMibDownloadLink) | **GET** /cluster/{id}/snmp_mib_link | Get the link for Rubrik SNMP MIB file
*RubrikRestApi.ClusterApi* | [**getSyslogExportRule**](docs/ClusterApi.md#getSyslogExportRule) | **GET** /syslog/export/{id} | Get the specified syslog export rule
*RubrikRestApi.ClusterApi* | [**getSyslogExportRules**](docs/ClusterApi.md#getSyslogExportRules) | **GET** /syslog/export | Get the configured syslog export rules
*RubrikRestApi.ClusterApi* | [**getSyslogMsgSnmpMibDownloadLink**](docs/ClusterApi.md#getSyslogMsgSnmpMibDownloadLink) | **GET** /cluster/{id}/syslog_msg_mib_link | Get the link for SYSLOG-MSG-MIB file
*RubrikRestApi.ClusterApi* | [**getSyslogTcSnmpMibDownloadLink**](docs/ClusterApi.md#getSyslogTcSnmpMibDownloadLink) | **GET** /cluster/{id}/syslog_tc_mib_link | Get the link for SYSLOG-TC-MIB file
*RubrikRestApi.ClusterApi* | [**getTotpGlobalSetting**](docs/ClusterApi.md#getTotpGlobalSetting) | **GET** /cluster/{id}/security/totp/setting | Get global TOTP setting
*RubrikRestApi.ClusterApi* | [**getTruststores**](docs/ClusterApi.md#getTruststores) | **GET** /cluster/{id}/security/truststore | Get summary of all truststores
*RubrikRestApi.ClusterApi* | [**getWebSignedCertificate**](docs/ClusterApi.md#getWebSignedCertificate) | **GET** /cluster/{id}/security/web_signed_cert | Get the signed certificate for Web server
*RubrikRestApi.ClusterApi* | [**hasRubrikSupportPortalCredentials**](docs/ClusterApi.md#hasRubrikSupportPortalCredentials) | **GET** /cluster/{id}/rubrik_support_portal_credentials | Check credentials to the Rubrik support portal
*RubrikRestApi.ClusterApi* | [**manualDiscover**](docs/ClusterApi.md#manualDiscover) | **POST** /cluster/{id}/manual_discover | Manually discover nodes
*RubrikRestApi.ClusterApi* | [**manualDiscoverIpv4**](docs/ClusterApi.md#manualDiscoverIpv4) | **POST** /cluster/{id}/manual_discover_ipv4 | Manually discover nodes over IPv4 address
*RubrikRestApi.ClusterApi* | [**monitorEvents**](docs/ClusterApi.md#monitorEvents) | **GET** /cluster/me/upgrade/monitor_events | Get event notifications
*RubrikRestApi.ClusterApi* | [**patchPasswordRequirements**](docs/ClusterApi.md#patchPasswordRequirements) | **PATCH** /cluster/{id}/security/password_requirements | Set password requirements
*RubrikRestApi.ClusterApi* | [**queryPasswordRequirements**](docs/ClusterApi.md#queryPasswordRequirements) | **GET** /cluster/{id}/security/password_requirements | Get password requirements
*RubrikRestApi.ClusterApi* | [**resetWebSignedCertificate**](docs/ClusterApi.md#resetWebSignedCertificate) | **DELETE** /cluster/{id}/security/web_signed_cert | Reset the signed certificate for Web server
*RubrikRestApi.ClusterApi* | [**runPeriodicUpgradePrechecks**](docs/ClusterApi.md#runPeriodicUpgradePrechecks) | **POST** /cluster/{id}/upgrade/precheck_status | Start an on demand run of the prechecks
*RubrikRestApi.ClusterApi* | [**setKmipClient**](docs/ClusterApi.md#setKmipClient) | **PUT** /cluster/{id}/security/kmip/client | Specify KMIP client credentials for nodes
*RubrikRestApi.ClusterApi* | [**setTruststoreCertificate**](docs/ClusterApi.md#setTruststoreCertificate) | **PATCH** /cluster/{id}/security/truststore | Set certificates for one or more truststores
*RubrikRestApi.ClusterApi* | [**setWebSignedCertificate**](docs/ClusterApi.md#setWebSignedCertificate) | **PUT** /cluster/{id}/security/web_signed_cert | Set a signed certificate for Web server
*RubrikRestApi.ClusterApi* | [**stageCdmSoftware**](docs/ClusterApi.md#stageCdmSoftware) | **POST** /cluster/{id}/upgrade/stage_cdm_software | Stage software on CDM for upgrade
*RubrikRestApi.ClusterApi* | [**testSyslogExportRule**](docs/ClusterApi.md#testSyslogExportRule) | **POST** /syslog/export/test | Test the specified syslog export rule
*RubrikRestApi.ClusterApi* | [**unsetTruststoreCertificate**](docs/ClusterApi.md#unsetTruststoreCertificate) | **DELETE** /cluster/{id}/security/truststore | Remove certificate associated with specified truststore
*RubrikRestApi.ClusterApi* | [**updateCluster**](docs/ClusterApi.md#updateCluster) | **PATCH** /cluster/{id} | Change Rubrik cluster properties
*RubrikRestApi.ClusterApi* | [**updateCorsConfiguration**](docs/ClusterApi.md#updateCorsConfiguration) | **PATCH** /cluster/{id}/security/cors | Update CORS configuration
*RubrikRestApi.ClusterApi* | [**updateFips**](docs/ClusterApi.md#updateFips) | **PATCH** /cluster/{id}/security/fips | Update FIPS enablement status
*RubrikRestApi.ClusterApi* | [**updateRubrikSupportPortalCredentials**](docs/ClusterApi.md#updateRubrikSupportPortalCredentials) | **POST** /cluster/{id}/rubrik_support_portal_credentials | Update credentials to the Rubrik support portal
*RubrikRestApi.ClusterApi* | [**updateSyslogExportRule**](docs/ClusterApi.md#updateSyslogExportRule) | **PATCH** /syslog/export/{id} | Update the specified syslog export rule
*RubrikRestApi.ClusterApi* | [**updateTotpGlobalSetting**](docs/ClusterApi.md#updateTotpGlobalSetting) | **PUT** /cluster/{id}/security/totp/setting | Update TOTP global setting
*RubrikRestApi.ConfigHistoryApi* | [**queryConfigurationHistoryUpdates**](docs/ConfigHistoryApi.md#queryConfigurationHistoryUpdates) | **GET** /config/history/list_updates | View a list of filtered configuration updates
*RubrikRestApi.ConfigHistoryApi* | [**retrieveConfigurationValues**](docs/ConfigHistoryApi.md#retrieveConfigurationValues) | **GET** /config/history/ondate | View a list of configurations and their values on a given date
*RubrikRestApi.CsrApi* | [**deleteCsr**](docs/CsrApi.md#deleteCsr) | **DELETE** /csr/{id} | Delete a certificate signing request
*RubrikRestApi.CsrApi* | [**generateCsr**](docs/CsrApi.md#generateCsr) | **POST** /csr | Generate a new private key and return a certificate signing request
*RubrikRestApi.CsrApi* | [**getAllCsrs**](docs/CsrApi.md#getAllCsrs) | **GET** /csr | Get all certificate signing requests
*RubrikRestApi.DataSourceApi* | [**bulkDeleteSnapshots**](docs/DataSourceApi.md#bulkDeleteSnapshots) | **POST** /data_source/snapshot/bulk_delete | Bulk delete all snapshots for the given objects
*RubrikRestApi.DataSourceApi* | [**bulkDeleteSnapshotsForObject**](docs/DataSourceApi.md#bulkDeleteSnapshotsForObject) | **POST** /data_source/{id}/snapshot/bulk_delete | Bulk delete specified snapshots for the given object
*RubrikRestApi.DataSourceApi* | [**expiredCustomRetentionSnapshots**](docs/DataSourceApi.md#expiredCustomRetentionSnapshots) | **GET** /data_source/{id}/expired_custom_retention_snapshots | Returns a list of snapshots that have expired according to their snapshot-level SLA Domain assignments 
*RubrikRestApi.DatabaseLogReportApi* | [**queryLogReport**](docs/DatabaseLogReportApi.md#queryLogReport) | **GET** /database/log_report | Get the database log backup delay information
*RubrikRestApi.DatabaseLogReportApi* | [**queryReportProperties**](docs/DatabaseLogReportApi.md#queryReportProperties) | **GET** /database/log_report/defaults | Get the database log backup report properties
*RubrikRestApi.DatabaseLogReportApi* | [**updateReportProperties**](docs/DatabaseLogReportApi.md#updateReportProperties) | **PATCH** /database/log_report/defaults | Update the database log backup report properties
*RubrikRestApi.EventApi* | [**getEventsCsvDownloadLink**](docs/EventApi.md#getEventsCsvDownloadLink) | **GET** /event/csv_download_link | Download summary of events as a CSV file
*RubrikRestApi.EventApi* | [**queryEventV1**](docs/EventApi.md#queryEventV1) | **GET** /event | Get information for all events
*RubrikRestApi.EventApi* | [**queryLatestEventsV1**](docs/EventApi.md#queryLatestEventsV1) | **GET** /event/latest | Get latest events with their associated event series information
*RubrikRestApi.EventSeriesApi* | [**queryEventSeriesByIdV1**](docs/EventSeriesApi.md#queryEventSeriesByIdV1) | **GET** /event_series/{id} | Get all events and relevant information associated with an event series ID
*RubrikRestApi.ExclusionPatternApi* | [**bulkCreateExclusionPattern**](docs/ExclusionPatternApi.md#bulkCreateExclusionPattern) | **POST** /exclusion_pattern/bulk | Bulk create exclusion patterns
*RubrikRestApi.ExclusionPatternApi* | [**bulkDeleteExclusionPattern**](docs/ExclusionPatternApi.md#bulkDeleteExclusionPattern) | **DELETE** /exclusion_pattern/bulk | Bulk delete the provided mutable exclusion patterns
*RubrikRestApi.ExclusionPatternApi* | [**createExclusionPattern**](docs/ExclusionPatternApi.md#createExclusionPattern) | **POST** /exclusion_pattern | Create an exclusion pattern
*RubrikRestApi.ExclusionPatternApi* | [**deleteExclusionPattern**](docs/ExclusionPatternApi.md#deleteExclusionPattern) | **DELETE** /exclusion_pattern/{id} | Delete a mutable exclusion pattern
*RubrikRestApi.ExclusionPatternApi* | [**getExclusionPattern**](docs/ExclusionPatternApi.md#getExclusionPattern) | **GET** /exclusion_pattern/{id} | Get details of a exclusion pattern
*RubrikRestApi.ExclusionPatternApi* | [**queryExclusionPattern**](docs/ExclusionPatternApi.md#queryExclusionPattern) | **GET** /exclusion_pattern | Get a summary of all exclusion patterns
*RubrikRestApi.ExclusionPatternApi* | [**updateExclusionPattern**](docs/ExclusionPatternApi.md#updateExclusionPattern) | **POST** /exclusion_pattern/{id} | Update a mutable exclusion pattern
*RubrikRestApi.FailoverClusterApi* | [**bulkDeleteFailoverCluster**](docs/FailoverClusterApi.md#bulkDeleteFailoverCluster) | **DELETE** /failover_cluster/bulk | Delete the provided failover clusters
*RubrikRestApi.FailoverClusterApi* | [**createFailoverCluster**](docs/FailoverClusterApi.md#createFailoverCluster) | **POST** /failover_cluster | Create a failover cluster
*RubrikRestApi.FailoverClusterApi* | [**deleteFailoverCluster**](docs/FailoverClusterApi.md#deleteFailoverCluster) | **DELETE** /failover_cluster/{id} | Delete a failover cluster
*RubrikRestApi.FailoverClusterApi* | [**getFailoverCluster**](docs/FailoverClusterApi.md#getFailoverCluster) | **GET** /failover_cluster/{id} | Get details of a failover cluster
*RubrikRestApi.FailoverClusterApi* | [**queryFailoverCluster**](docs/FailoverClusterApi.md#queryFailoverCluster) | **GET** /failover_cluster | Get a summary of all failover clusters
*RubrikRestApi.FailoverClusterApi* | [**updateFailoverCluster**](docs/FailoverClusterApi.md#updateFailoverCluster) | **PATCH** /failover_cluster/{id} | Update a failover cluster
*RubrikRestApi.FailoverClusterFailoverClusterAppApi* | [**bulkDeleteFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#bulkDeleteFailoverClusterApp) | **DELETE** /failover_cluster/failover_cluster_app/bulk | Delete failover cluster applications
*RubrikRestApi.FailoverClusterFailoverClusterAppApi* | [**createFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#createFailoverClusterApp) | **POST** /failover_cluster/failover_cluster_app | Create a failover cluster app
*RubrikRestApi.FailoverClusterFailoverClusterAppApi* | [**deleteFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#deleteFailoverClusterApp) | **DELETE** /failover_cluster/failover_cluster_app/{id} | Delete a failover cluster app
*RubrikRestApi.FailoverClusterFailoverClusterAppApi* | [**getFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#getFailoverClusterApp) | **GET** /failover_cluster/failover_cluster_app/{id} | Get details of a failover cluster app
*RubrikRestApi.FailoverClusterFailoverClusterAppApi* | [**queryFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#queryFailoverClusterApp) | **GET** /failover_cluster/failover_cluster_app | Get a summary of all failover cluster apps
*RubrikRestApi.FailoverClusterFailoverClusterAppApi* | [**updateFailoverClusterApp**](docs/FailoverClusterFailoverClusterAppApi.md#updateFailoverClusterApp) | **PATCH** /failover_cluster/failover_cluster_app/{id} | Update a failover cluster app
*RubrikRestApi.FailoverClusterHierarchyApi* | [**getFailoverClusterHierarchyChildren**](docs/FailoverClusterHierarchyApi.md#getFailoverClusterHierarchyChildren) | **GET** /failover_cluster/hierarchy/{id}/children | Get list of immediate descendant objects
*RubrikRestApi.FailoverClusterHierarchyApi* | [**getFailoverClusterHierarchyDescendants**](docs/FailoverClusterHierarchyApi.md#getFailoverClusterHierarchyDescendants) | **GET** /failover_cluster/hierarchy/{id}/descendants | Get list of descendant objects
*RubrikRestApi.FailoverClusterHierarchyApi* | [**getFailoverClusterHierarchyObject**](docs/FailoverClusterHierarchyApi.md#getFailoverClusterHierarchyObject) | **GET** /failover_cluster/hierarchy/{id} | Get summary of a hierarchy object
*RubrikRestApi.FilesetApi* | [**browseFilesetSnapshot**](docs/FilesetApi.md#browseFilesetSnapshot) | **GET** /fileset/snapshot/{id}/browse | Lists all files and directories in a given path
*RubrikRestApi.FilesetApi* | [**createDownloadFilesetSnapshotFromCloud**](docs/FilesetApi.md#createDownloadFilesetSnapshotFromCloud) | **POST** /fileset/snapshot/{id}/download | Create a download fileset snapshot from archival request
*RubrikRestApi.FilesetApi* | [**createFileset**](docs/FilesetApi.md#createFileset) | **POST** /fileset | Create one fileset for a host
*RubrikRestApi.FilesetApi* | [**createFilesetBackupJob**](docs/FilesetApi.md#createFilesetBackupJob) | **POST** /fileset/{id}/snapshot | Initiate an on-demand backup for a fileset
*RubrikRestApi.FilesetApi* | [**createFilesetDownloadFileJob**](docs/FilesetApi.md#createFilesetDownloadFileJob) | **POST** /fileset/snapshot/{id}/download_file | Create a file download job from a fileset backup
*RubrikRestApi.FilesetApi* | [**createFilesetExportFileJob**](docs/FilesetApi.md#createFilesetExportFileJob) | **POST** /fileset/snapshot/{id}/export_file | Create export job
*RubrikRestApi.FilesetApi* | [**createFilesetRestoreFileJob**](docs/FilesetApi.md#createFilesetRestoreFileJob) | **POST** /fileset/snapshot/{id}/restore_file | Create restore job
*RubrikRestApi.FilesetApi* | [**deleteFileset**](docs/FilesetApi.md#deleteFileset) | **DELETE** /fileset/{id} | Delete a fileset
*RubrikRestApi.FilesetApi* | [**deleteFilesetSnapshot**](docs/FilesetApi.md#deleteFilesetSnapshot) | **DELETE** /fileset/snapshot/{id} | Delete a fileset snapshot
*RubrikRestApi.FilesetApi* | [**deleteFilesetSnapshots**](docs/FilesetApi.md#deleteFilesetSnapshots) | **DELETE** /fileset/{id}/snapshot | Delete all snapshots of a fileset
*RubrikRestApi.FilesetApi* | [**getFileset**](docs/FilesetApi.md#getFileset) | **GET** /fileset/{id} | Get information for a single fileset
*RubrikRestApi.FilesetApi* | [**getFilesetAsyncRequestStatus**](docs/FilesetApi.md#getFilesetAsyncRequestStatus) | **GET** /fileset/request/{id} | Get details about an async request
*RubrikRestApi.FilesetApi* | [**getFilesetSnapshot**](docs/FilesetApi.md#getFilesetSnapshot) | **GET** /fileset/snapshot/{id} | Get information for a fileset snapshot
*RubrikRestApi.FilesetApi* | [**getMissedFilesetSnapshots**](docs/FilesetApi.md#getMissedFilesetSnapshots) | **GET** /fileset/{id}/missed_snapshot | Get missed snapshots for a fileset
*RubrikRestApi.FilesetApi* | [**queryFileset**](docs/FilesetApi.md#queryFileset) | **GET** /fileset | Get summary information for all filesets
*RubrikRestApi.FilesetApi* | [**searchFileset**](docs/FilesetApi.md#searchFileset) | **GET** /fileset/{id}/search | Search for a file within the fileset
*RubrikRestApi.FilesetApi* | [**updateFileset**](docs/FilesetApi.md#updateFileset) | **PATCH** /fileset/{id} | Update a Fileset
*RubrikRestApi.FilesetTemplateApi* | [**createFilesetTemplate**](docs/FilesetTemplateApi.md#createFilesetTemplate) | **POST** /fileset_template | Create a fileset template
*RubrikRestApi.FilesetTemplateApi* | [**deleteFilesetTemplate**](docs/FilesetTemplateApi.md#deleteFilesetTemplate) | **DELETE** /fileset_template/{id} | Delete a fileset template
*RubrikRestApi.FilesetTemplateApi* | [**getFilesetTemplate**](docs/FilesetTemplateApi.md#getFilesetTemplate) | **GET** /fileset_template/{id} | Get information for a fileset template
*RubrikRestApi.FilesetTemplateApi* | [**queryFilesetTemplate**](docs/FilesetTemplateApi.md#queryFilesetTemplate) | **GET** /fileset_template | Get summary information for all fileset templates
*RubrikRestApi.FilesetTemplateApi* | [**updateFilesetTemplate**](docs/FilesetTemplateApi.md#updateFilesetTemplate) | **PATCH** /fileset_template/{id} | Modify a fileset template
*RubrikRestApi.HdfsApi* | [**browseHdfsSnapshot**](docs/HdfsApi.md#browseHdfsSnapshot) | **GET** /hdfs/snapshot/{id}/browse | Lists all files and directories in a given path
*RubrikRestApi.HdfsApi* | [**createHdfs**](docs/HdfsApi.md#createHdfs) | **POST** /hdfs | Create one HDFS directory for a host
*RubrikRestApi.HdfsApi* | [**createHdfsBackupJob**](docs/HdfsApi.md#createHdfsBackupJob) | **POST** /hdfs/{id}/snapshot | Initiate an on-demand backup for a HDFS directory
*RubrikRestApi.HdfsApi* | [**createHdfsExportFileJob**](docs/HdfsApi.md#createHdfsExportFileJob) | **POST** /hdfs/snapshot/{id}/export_file | Create export job
*RubrikRestApi.HdfsApi* | [**createHdfsRestoreFileJob**](docs/HdfsApi.md#createHdfsRestoreFileJob) | **POST** /hdfs/snapshot/{id}/restore_file | Create restore job
*RubrikRestApi.HdfsApi* | [**deleteHdfs**](docs/HdfsApi.md#deleteHdfs) | **DELETE** /hdfs/{id} | Delete a HDFS directory
*RubrikRestApi.HdfsApi* | [**deleteHdfsSnapshot**](docs/HdfsApi.md#deleteHdfsSnapshot) | **DELETE** /hdfs/snapshot/{id} | Delete a HDFS directory snapshot
*RubrikRestApi.HdfsApi* | [**deleteHdfsSnapshots**](docs/HdfsApi.md#deleteHdfsSnapshots) | **DELETE** /hdfs/{id}/snapshot | Delete all snapshots of a HDFS directory
*RubrikRestApi.HdfsApi* | [**getHdfs**](docs/HdfsApi.md#getHdfs) | **GET** /hdfs/{id} | Get information for a single HDFS directory
*RubrikRestApi.HdfsApi* | [**getHdfsAsyncRequestStatus**](docs/HdfsApi.md#getHdfsAsyncRequestStatus) | **GET** /hdfs/request/{id} | Get details about an asynchronous request
*RubrikRestApi.HdfsApi* | [**getHdfsSnapshot**](docs/HdfsApi.md#getHdfsSnapshot) | **GET** /hdfs/snapshot/{id} | Get information for a HDFS directory snapshot
*RubrikRestApi.HdfsApi* | [**getMissedHdfsSnapshots**](docs/HdfsApi.md#getMissedHdfsSnapshots) | **GET** /hdfs/{id}/missed_snapshot | Get missed snapshots for a HDFS directory
*RubrikRestApi.HdfsApi* | [**queryHdfs**](docs/HdfsApi.md#queryHdfs) | **GET** /hdfs | Get summary information for all HDFS directories
*RubrikRestApi.HdfsApi* | [**searchHdfs**](docs/HdfsApi.md#searchHdfs) | **GET** /hdfs/{id}/search | Search for a file within the HDFS directory
*RubrikRestApi.HdfsApi* | [**updateHdfs**](docs/HdfsApi.md#updateHdfs) | **PATCH** /hdfs/{id} | Update a HDFS directory
*RubrikRestApi.HdfsTemplateApi* | [**createHdfsTemplate**](docs/HdfsTemplateApi.md#createHdfsTemplate) | **POST** /hdfs_template | Create a HDFS directory template
*RubrikRestApi.HdfsTemplateApi* | [**deleteHdfsTemplate**](docs/HdfsTemplateApi.md#deleteHdfsTemplate) | **DELETE** /hdfs_template/{id} | Delete a HDFS directory template
*RubrikRestApi.HdfsTemplateApi* | [**getHdfsTemplate**](docs/HdfsTemplateApi.md#getHdfsTemplate) | **GET** /hdfs_template/{id} | Get information for a HDFS directory template
*RubrikRestApi.HdfsTemplateApi* | [**queryHdfsTemplate**](docs/HdfsTemplateApi.md#queryHdfsTemplate) | **GET** /hdfs_template | Get summary information for all HDFS directory templates
*RubrikRestApi.HdfsTemplateApi* | [**updateHdfsTemplate**](docs/HdfsTemplateApi.md#updateHdfsTemplate) | **PATCH** /hdfs_template/{id} | Modify a HDFS directory template
*RubrikRestApi.HealthMonitorApi* | [**getPolicies**](docs/HealthMonitorApi.md#getPolicies) | **GET** /health_monitor/policies | Get details of health monitor policies
*RubrikRestApi.HealthMonitorApi* | [**getPolicyStatus**](docs/HealthMonitorApi.md#getPolicyStatus) | **GET** /health_monitor/policy_status | Get the status of health monitor policy enforcement
*RubrikRestApi.HealthMonitorApi* | [**runPolicies**](docs/HealthMonitorApi.md#runPolicies) | **POST** /health_monitor/run_policy | Enforce health monitor policies
*RubrikRestApi.HierarchyApi* | [**bulkHierarchySlaConflictsV1**](docs/HierarchyApi.md#bulkHierarchySlaConflictsV1) | **POST** /hierarchy/bulk_sla_conflicts | Retrieve the list of descendant objects with SLA conflicts in bulk
*RubrikRestApi.HostApi* | [**bulkRegisterHostAsync**](docs/HostApi.md#bulkRegisterHostAsync) | **POST** /host/bulk_background | Register hosts
*RubrikRestApi.HostApi* | [**deleteHost**](docs/HostApi.md#deleteHost) | **DELETE** /host/{id} | Delete a registered host
*RubrikRestApi.HostApi* | [**discoverNasShares**](docs/HostApi.md#discoverNasShares) | **GET** /host/{id}/nas_share_discover | Discover and return all shares on a NAS host
*RubrikRestApi.HostApi* | [**getHost**](docs/HostApi.md#getHost) | **GET** /host/{id} | Get summary information for a host
*RubrikRestApi.HostApi* | [**getRbsHostInfo**](docs/HostApi.md#getRbsHostInfo) | **GET** /host/rbs | Get the Rubrik Backup Service details for a host
*RubrikRestApi.HostApi* | [**hostMakePrimary**](docs/HostApi.md#hostMakePrimary) | **POST** /host/make_primary | Make this cluster the primary for agents on a set of hosts
*RubrikRestApi.HostApi* | [**queryHost**](docs/HostApi.md#queryHost) | **GET** /host | Get summary information for hosts
*RubrikRestApi.HostApi* | [**queryHostVolume**](docs/HostApi.md#queryHostVolume) | **GET** /host/{id}/volume | Get list of Volume Group volumes
*RubrikRestApi.HostApi* | [**rbsInstall**](docs/HostApi.md#rbsInstall) | **POST** /host/rbs/install | Install Rubrik Backup Service on a host
*RubrikRestApi.HostApi* | [**rbsUninstall**](docs/HostApi.md#rbsUninstall) | **POST** /host/rbs/uninstall | Uninstall Rubrik Backup Service from a host
*RubrikRestApi.HostApi* | [**rbsUpgrade**](docs/HostApi.md#rbsUpgrade) | **POST** /host/rbs/upgrade | Upgrade Rubrik Backup Service on a host
*RubrikRestApi.HostApi* | [**refreshHost**](docs/HostApi.md#refreshHost) | **POST** /host/{id}/refresh | Refresh a host
*RubrikRestApi.HostApi* | [**registerHost**](docs/HostApi.md#registerHost) | **POST** /host | Register a host
*RubrikRestApi.HostApi* | [**registerHostAsync**](docs/HostApi.md#registerHostAsync) | **POST** /host/background | Register a host
*RubrikRestApi.HostApi* | [**searchHost**](docs/HostApi.md#searchHost) | **GET** /host/{id}/search | Search for a file within the host
*RubrikRestApi.HostApi* | [**updateCertificateHost**](docs/HostApi.md#updateCertificateHost) | **PUT** /host/certificate/{id} | Update certificate
*RubrikRestApi.HostApi* | [**updateHost**](docs/HostApi.md#updateHost) | **PATCH** /host/{id} | Modify information for a registered host
*RubrikRestApi.HostHierarchyApi* | [**getHostHierarchyChildren**](docs/HostHierarchyApi.md#getHostHierarchyChildren) | **GET** /host/hierarchy/{id}/children | Get immediate descendant objects
*RubrikRestApi.HostHierarchyApi* | [**getHostHierarchyObject**](docs/HostHierarchyApi.md#getHostHierarchyObject) | **GET** /host/hierarchy/{id} | Get summary of a host/share hierarchy object
*RubrikRestApi.HostShareApi* | [**bulkAddHostShares**](docs/HostShareApi.md#bulkAddHostShares) | **POST** /host/share/bulk | Add NAS shares in bulk
*RubrikRestApi.HostShareApi* | [**bulkUpdateHostShare**](docs/HostShareApi.md#bulkUpdateHostShare) | **PATCH** /host/share/bulk | Update network shares
*RubrikRestApi.HypervVmApi* | [**getHypervVirtualMachineForceFullSpec**](docs/HypervVmApi.md#getHypervVirtualMachineForceFullSpec) | **GET** /hyperv/vm/{id}/request/force_full_snapshot | Retrieve the configuration which has been set for forcing a full snapshot for a Hyper-V Virtual Machine
*RubrikRestApi.HypervVmApi* | [**requestHypervVirtualMachineForceFullSnapshot**](docs/HypervVmApi.md#requestHypervVirtualMachineForceFullSnapshot) | **POST** /hyperv/vm/{id}/request/force_full_snapshot | Request a full snapshot during next backup job of a Hyper-V virtual machine
*RubrikRestApi.IdpAuthDomainApi* | [**createIdProviderAuthDomain**](docs/IdpAuthDomainApi.md#createIdProviderAuthDomain) | **POST** /idp_auth_domain | Add a new IdP authentication domain
*RubrikRestApi.IdpAuthDomainApi* | [**deleteIdProviderAuthDomain**](docs/IdpAuthDomainApi.md#deleteIdProviderAuthDomain) | **DELETE** /idp_auth_domain/{id} | Delete an IdP authentication domain for the given ID
*RubrikRestApi.IdpAuthDomainApi* | [**getIdProviderAuthDomain**](docs/IdpAuthDomainApi.md#getIdProviderAuthDomain) | **GET** /idp_auth_domain/{id} | Get an IdP authentication domain for the given id
*RubrikRestApi.IdpAuthDomainApi* | [**queryIdProviderAuthDomain**](docs/IdpAuthDomainApi.md#queryIdProviderAuthDomain) | **GET** /idp_auth_domain | Get a list of IdP authentication domains
*RubrikRestApi.IdpAuthDomainApi* | [**updateIdProviderAuthDomain**](docs/IdpAuthDomainApi.md#updateIdProviderAuthDomain) | **PATCH** /idp_auth_domain/{id} | Update an existing IdP authentication domain
*RubrikRestApi.JobMonitoringApi* | [**createMonitoringSubscription**](docs/JobMonitoringApi.md#createMonitoringSubscription) | **POST** /job_monitoring/subscription | Create an email subscription to the job monitoring page
*RubrikRestApi.JobMonitoringApi* | [**deleteMonitoringSubscription**](docs/JobMonitoringApi.md#deleteMonitoringSubscription) | **DELETE** /job_monitoring/subscription/{subscription_id} | Delete a monitoring page email subscription
*RubrikRestApi.JobMonitoringApi* | [**getJobMonitoringInfo**](docs/JobMonitoringApi.md#getJobMonitoringInfo) | **GET** /job_monitoring | Get job monitoring information
*RubrikRestApi.JobMonitoringApi* | [**getJobMonitoringInfoCsvDownloadLink**](docs/JobMonitoringApi.md#getJobMonitoringInfoCsvDownloadLink) | **GET** /job_monitoring/csv_download_link | Download job monitoring information as a CSV file
*RubrikRestApi.JobMonitoringApi* | [**getMonitoringJobCountByJobState**](docs/JobMonitoringApi.md#getMonitoringJobCountByJobState) | **GET** /job_monitoring/summary_by_job_state | Get job monitoring summary information separated by job state
*RubrikRestApi.JobMonitoringApi* | [**getMonitoringJobCountByJobType**](docs/JobMonitoringApi.md#getMonitoringJobCountByJobType) | **GET** /job_monitoring/summary_by_job_type | Get job monitoring summary information separated by job type
*RubrikRestApi.JobMonitoringApi* | [**getMonitoringSubscription**](docs/JobMonitoringApi.md#getMonitoringSubscription) | **GET** /job_monitoring/subscription/{subscription_id} | Get a specific monitoring email subscription by id
*RubrikRestApi.JobMonitoringApi* | [**getMonitoringSubscriptions**](docs/JobMonitoringApi.md#getMonitoringSubscriptions) | **GET** /job_monitoring/subscription | Returns all email subscriptions for the monitoring page
*RubrikRestApi.JobMonitoringApi* | [**updateMonitoringSubscription**](docs/JobMonitoringApi.md#updateMonitoringSubscription) | **PATCH** /job_monitoring/subscription/{subscription_id} | Update a monitoring email subscription
*RubrikRestApi.LdapServiceApi* | [**createLdapService**](docs/LdapServiceApi.md#createLdapService) | **POST** /ldap_service | Add a new authentication domain
*RubrikRestApi.LdapServiceApi* | [**deleteLdapService**](docs/LdapServiceApi.md#deleteLdapService) | **DELETE** /ldap_service/{id} | Delete an authentication domain for the given ID
*RubrikRestApi.LdapServiceApi* | [**getLdapService**](docs/LdapServiceApi.md#getLdapService) | **GET** /ldap_service/{id} | Get a LDAP service for the given ID
*RubrikRestApi.LdapServiceApi* | [**patchLdapService**](docs/LdapServiceApi.md#patchLdapService) | **PATCH** /ldap_service/{id} | Update an existing authentication domain
*RubrikRestApi.LdapServiceApi* | [**putLdapService**](docs/LdapServiceApi.md#putLdapService) | **PUT** /ldap_service/{id} | Replace the values of an authentication domain
*RubrikRestApi.LdapServiceApi* | [**queryLdapService**](docs/LdapServiceApi.md#queryLdapService) | **GET** /ldap_service | Get a list of LDAP services
*RubrikRestApi.LegalHoldApi* | [**applyLegalHold**](docs/LegalHoldApi.md#applyLegalHold) | **POST** /legal_hold/snapshot | Apply a Legal Hold
*RubrikRestApi.LegalHoldApi* | [**dissolveLegalHoldSnapshots**](docs/LegalHoldApi.md#dissolveLegalHoldSnapshots) | **POST** /legal_hold/object/{id}/dissolve | Dissolve a collection of snapshots of specified data source from Legal Hold
*RubrikRestApi.LegalHoldApi* | [**getLegalHoldObjects**](docs/LegalHoldApi.md#getLegalHoldObjects) | **GET** /legal_hold/object | Get objects part of Legal Hold
*RubrikRestApi.LegalHoldApi* | [**queryLegalHold**](docs/LegalHoldApi.md#queryLegalHold) | **GET** /legal_hold/snapshot | Get snasphots held under legal hold
*RubrikRestApi.ManagedVolumeApi* | [**createManagedVolumeGenerateScriptJob**](docs/ManagedVolumeApi.md#createManagedVolumeGenerateScriptJob) | **POST** /managed_volume/snapshot/export/{id}/script | Generate and download unified view script
*RubrikRestApi.MfaRsaApi* | [**createRsaMfaServer**](docs/MfaRsaApi.md#createRsaMfaServer) | **POST** /mfa/rsa/server | Register a new RSA server
*RubrikRestApi.MfaRsaApi* | [**deleteRsaMfaServer**](docs/MfaRsaApi.md#deleteRsaMfaServer) | **DELETE** /mfa/rsa/server/{id} | Delete RSA server
*RubrikRestApi.MfaRsaApi* | [**getRsaMfaServer**](docs/MfaRsaApi.md#getRsaMfaServer) | **GET** /mfa/rsa/server/{id} | Get RSA server configuration
*RubrikRestApi.MfaRsaApi* | [**queryRsaMfaServers**](docs/MfaRsaApi.md#queryRsaMfaServers) | **GET** /mfa/rsa/server | Get RSA server configuration
*RubrikRestApi.MfaRsaApi* | [**updateRsaMfaServer**](docs/MfaRsaApi.md#updateRsaMfaServer) | **PATCH** /mfa/rsa/server/{id} | Update RSA server configuration
*RubrikRestApi.MssqlApi* | [**assignMssqlSlaProperties**](docs/MssqlApi.md#assignMssqlSlaProperties) | **POST** /mssql/sla_domain/assign | Assign SLA properties to SQL Server objects
*RubrikRestApi.MssqlApi* | [**browseMssqlBackupFiles**](docs/MssqlApi.md#browseMssqlBackupFiles) | **POST** /mssql/db/{id}/browse | List snapshots and logs from a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**bulkUpdateMssqlDbV1**](docs/MssqlApi.md#bulkUpdateMssqlDbV1) | **PATCH** /mssql/db/bulk | Update multiple Microsoft SQL databases
*RubrikRestApi.MssqlApi* | [**countMssqlDbV1**](docs/MssqlApi.md#countMssqlDbV1) | **GET** /mssql/db/count | Returns a count of Microsoft SQL databases
*RubrikRestApi.MssqlApi* | [**countMssqlInstanceV1**](docs/MssqlApi.md#countMssqlInstanceV1) | **GET** /mssql/instance/count | Returns a count of Microsoft SQL instances
*RubrikRestApi.MssqlApi* | [**createDownloadMssqlBackupFiles**](docs/MssqlApi.md#createDownloadMssqlBackupFiles) | **POST** /mssql/db/{id}/download_files | Download snapshots and logs backups from a Microsoft SQL Database
*RubrikRestApi.MssqlApi* | [**createDownloadMssqlBackupFilesById**](docs/MssqlApi.md#createDownloadMssqlBackupFilesById) | **POST** /mssql/db/{id}/download_files_by_id | Downloads a list of snapshot and log backups from a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**createExportMssqlDb**](docs/MssqlApi.md#createExportMssqlDb) | **POST** /mssql/db/{id}/export | Export a Microsoft SQL database to a new location
*RubrikRestApi.MssqlApi* | [**createLogShippingConfiguration**](docs/MssqlApi.md#createLogShippingConfiguration) | **POST** /mssql/db/{id}/log_shipping | Create a log shipping configuration
*RubrikRestApi.MssqlApi* | [**createMssqlHostConfig**](docs/MssqlApi.md#createMssqlHostConfig) | **POST** /mssql/host/configuration | Create a SQL Server host configuration
*RubrikRestApi.MssqlApi* | [**createMssqlMount**](docs/MssqlApi.md#createMssqlMount) | **POST** /mssql/db/{id}/mount | Live Mount SQL Server database from a point in time copy
*RubrikRestApi.MssqlApi* | [**createMssqlUnmount**](docs/MssqlApi.md#createMssqlUnmount) | **DELETE** /mssql/db/mount/{id} | Delete a Live Mount of a SQL Server database
*RubrikRestApi.MssqlApi* | [**createOnDemandMssqlBackup**](docs/MssqlApi.md#createOnDemandMssqlBackup) | **POST** /mssql/db/{id}/snapshot | Take an on-demand backup of a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**createOnDemandMssqlBatchBackupV1**](docs/MssqlApi.md#createOnDemandMssqlBatchBackupV1) | **POST** /mssql/db/bulk/snapshot | Take an on-demand backup of multiple Microsoft SQL databases
*RubrikRestApi.MssqlApi* | [**createOnDemandMssqlLogBackup**](docs/MssqlApi.md#createOnDemandMssqlLogBackup) | **POST** /mssql/db/{id}/log_backup | Take an on-demand log backup for a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**createRestoreMssqlDb**](docs/MssqlApi.md#createRestoreMssqlDb) | **POST** /mssql/db/{id}/restore | Restore a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**deleteDownloadedMssqlDbRecoverableRangesV1**](docs/MssqlApi.md#deleteDownloadedMssqlDbRecoverableRangesV1) | **DELETE** /mssql/db/{id}/recoverable_range/download | Delete downloaded recoverable ranges of a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**deleteLogShippingConfiguration**](docs/MssqlApi.md#deleteLogShippingConfiguration) | **DELETE** /mssql/db/log_shipping/{id} | Delete a specified log shipping configuration
*RubrikRestApi.MssqlApi* | [**deleteMssqlDbSnapshots**](docs/MssqlApi.md#deleteMssqlDbSnapshots) | **DELETE** /mssql/db/{id}/snapshot | Delete all snapshots of a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**deleteMssqlHostConfig**](docs/MssqlApi.md#deleteMssqlHostConfig) | **DELETE** /mssql/host/configuration/{host_id} | Delete the SQL Server host configuration
*RubrikRestApi.MssqlApi* | [**downloadFromArchive**](docs/MssqlApi.md#downloadFromArchive) | **POST** /mssql/db/{id}/download | Download snapshots and log backups from archival
*RubrikRestApi.MssqlApi* | [**getCompatibleMssqlInstancesV1**](docs/MssqlApi.md#getCompatibleMssqlInstancesV1) | **GET** /mssql/db/{id}/compatible_instance | Get compatible instances for the recovery of a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**getDefaultDbPropertiesV1**](docs/MssqlApi.md#getDefaultDbPropertiesV1) | **GET** /mssql/db/defaults | Returns the current default properties for Microsoft SQL databases
*RubrikRestApi.MssqlApi* | [**getDeleteMssqlDbRecoverableRangesStatusV1**](docs/MssqlApi.md#getDeleteMssqlDbRecoverableRangesStatusV1) | **GET** /mssql/db/recoverable_range/download/{id} | Get the deletion status of downloaded recoverable ranges
*RubrikRestApi.MssqlApi* | [**getLogShippingConfiguration**](docs/MssqlApi.md#getLogShippingConfiguration) | **GET** /mssql/db/log_shipping/{id} | Get a log shipping configuration
*RubrikRestApi.MssqlApi* | [**getMissedMssqlDbSnapshots**](docs/MssqlApi.md#getMissedMssqlDbSnapshots) | **GET** /mssql/db/{id}/missed_snapshot | Get summary information for missed snapshots of a SQL database
*RubrikRestApi.MssqlApi* | [**getMssqlAsyncRequestStatus**](docs/MssqlApi.md#getMssqlAsyncRequestStatus) | **GET** /mssql/request/{id} | Get details for an async request
*RubrikRestApi.MssqlApi* | [**getMssqlAvailabilityGroupV1**](docs/MssqlApi.md#getMssqlAvailabilityGroupV1) | **GET** /mssql/availability_group/{id} | Returns detailed information for a Microsoft SQL availability group
*RubrikRestApi.MssqlApi* | [**getMssqlDb**](docs/MssqlApi.md#getMssqlDb) | **GET** /mssql/db/{id} | Get detailed information for a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**getMssqlDbMissedRecoverableRanges**](docs/MssqlApi.md#getMssqlDbMissedRecoverableRanges) | **GET** /mssql/db/{id}/missed_recoverable_range | Get missed recoverable ranges of a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**getMssqlDbRecoverableRanges**](docs/MssqlApi.md#getMssqlDbRecoverableRanges) | **GET** /mssql/db/{id}/recoverable_range | Get recoverable ranges of a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**getMssqlDbSnapshot**](docs/MssqlApi.md#getMssqlDbSnapshot) | **GET** /mssql/db/snapshot/{id} | Get details information about a Microsoft SQL database snapshot
*RubrikRestApi.MssqlApi* | [**getMssqlHierarchyChildren**](docs/MssqlApi.md#getMssqlHierarchyChildren) | **GET** /mssql/hierarchy/{id}/children | Get list of immediate descendant objects
*RubrikRestApi.MssqlApi* | [**getMssqlHierarchyDescendants**](docs/MssqlApi.md#getMssqlHierarchyDescendants) | **GET** /mssql/hierarchy/{id}/descendants | Get list of descendant objects
*RubrikRestApi.MssqlApi* | [**getMssqlHierarchyObject**](docs/MssqlApi.md#getMssqlHierarchyObject) | **GET** /mssql/hierarchy/{id} | Get summary of a SQL Server hierarchy object
*RubrikRestApi.MssqlApi* | [**getMssqlHostConfig**](docs/MssqlApi.md#getMssqlHostConfig) | **GET** /mssql/host/configuration/{host_id} | Get the configuration for a specific host
*RubrikRestApi.MssqlApi* | [**getMssqlInstance**](docs/MssqlApi.md#getMssqlInstance) | **GET** /mssql/instance/{id} | Get detailed information for a Microsoft SQL instance
*RubrikRestApi.MssqlApi* | [**getMssqlMount**](docs/MssqlApi.md#getMssqlMount) | **GET** /mssql/db/mount/{id} | Get detailed information for a Live Mount of a SQL Server database
*RubrikRestApi.MssqlApi* | [**getOnDemandMssqlBatchBackupResultV1**](docs/MssqlApi.md#getOnDemandMssqlBatchBackupResultV1) | **GET** /mssql/db/bulk/snapshot/{id} | Returns details for an on-demand backup of multiple Microsoft SQL databases
*RubrikRestApi.MssqlApi* | [**mssqlGetRestoreFilesV1**](docs/MssqlApi.md#mssqlGetRestoreFilesV1) | **GET** /mssql/db/{id}/restore_files | Returns a list all database files to be restored
*RubrikRestApi.MssqlApi* | [**mssqlGetSnappableIdV1**](docs/MssqlApi.md#mssqlGetSnappableIdV1) | **GET** /mssql/db/{id}/snappable_id | Returns the snappableId for a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**mssqlRestoreEstimateV1**](docs/MssqlApi.md#mssqlRestoreEstimateV1) | **GET** /mssql/db/{id}/restore_estimate | Returns a size estimate for a restore or export
*RubrikRestApi.MssqlApi* | [**queryLogShippingConfigurations**](docs/MssqlApi.md#queryLogShippingConfigurations) | **GET** /mssql/db/log_shipping | Get log shipping configurations
*RubrikRestApi.MssqlApi* | [**queryMssqlAvailabilityGroupV1**](docs/MssqlApi.md#queryMssqlAvailabilityGroupV1) | **GET** /mssql/availability_group | Returns summary information for Microsoft SQL availability groups
*RubrikRestApi.MssqlApi* | [**queryMssqlDb**](docs/MssqlApi.md#queryMssqlDb) | **GET** /mssql/db | Get summary information for SQL Server databases
*RubrikRestApi.MssqlApi* | [**queryMssqlDbSnapshot**](docs/MssqlApi.md#queryMssqlDbSnapshot) | **GET** /mssql/db/{id}/snapshot | Get summary information for snapshots of a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**queryMssqlHostConfig**](docs/MssqlApi.md#queryMssqlHostConfig) | **GET** /mssql/host/configuration | Get the summary of SQL Server host configurations
*RubrikRestApi.MssqlApi* | [**queryMssqlInstance**](docs/MssqlApi.md#queryMssqlInstance) | **GET** /mssql/instance | Get summary information for Microsoft SQL instances
*RubrikRestApi.MssqlApi* | [**queryMssqlMount**](docs/MssqlApi.md#queryMssqlMount) | **GET** /mssql/db/mount | Get summary information for all Live Mounts SQL Server databases
*RubrikRestApi.MssqlApi* | [**reseedSecondary**](docs/MssqlApi.md#reseedSecondary) | **POST** /mssql/db/log_shipping/{id}/reseed | Reseed a secondary database
*RubrikRestApi.MssqlApi* | [**updateDefaultDbPropertiesV1**](docs/MssqlApi.md#updateDefaultDbPropertiesV1) | **PATCH** /mssql/db/defaults | Update the default properties for Microsoft SQL databases
*RubrikRestApi.MssqlApi* | [**updateLogShippingConfiguration**](docs/MssqlApi.md#updateLogShippingConfiguration) | **PATCH** /mssql/db/log_shipping/{id} | Update a specified log shipping configuration
*RubrikRestApi.MssqlApi* | [**updateMssqlAvailabilityGroupV1**](docs/MssqlApi.md#updateMssqlAvailabilityGroupV1) | **PATCH** /mssql/availability_group/{id} | Update a Microsoft SQL availability group
*RubrikRestApi.MssqlApi* | [**updateMssqlDb**](docs/MssqlApi.md#updateMssqlDb) | **PATCH** /mssql/db/{id} | Update a Microsoft SQL database
*RubrikRestApi.MssqlApi* | [**updateMssqlHostConfig**](docs/MssqlApi.md#updateMssqlHostConfig) | **PATCH** /mssql/host/configuration/{host_id} | Update host configuration
*RubrikRestApi.MssqlApi* | [**updateMssqlInstance**](docs/MssqlApi.md#updateMssqlInstance) | **PATCH** /mssql/instance/{id} | Update a Microsoft SQL instance
*RubrikRestApi.OracleApi* | [**bulkUpdateOracleDb**](docs/OracleApi.md#bulkUpdateOracleDb) | **PATCH** /oracle/db/bulk | Update Oracle Databases
*RubrikRestApi.OracleApi* | [**bulkUpdateOracleHost**](docs/OracleApi.md#bulkUpdateOracleHost) | **PATCH** /oracle/host/bulk | Update Oracle Hosts
*RubrikRestApi.OracleApi* | [**bulkUpdateOracleRac**](docs/OracleApi.md#bulkUpdateOracleRac) | **PATCH** /oracle/rac/bulk | Update Oracle RACs
*RubrikRestApi.OracleApi* | [**createOracleValidateBackupJob**](docs/OracleApi.md#createOracleValidateBackupJob) | **POST** /oracle/db/{id}/validate | Validate Oracle database backups
*RubrikRestApi.OracleApi* | [**deleteDownloadedSnapshots**](docs/OracleApi.md#deleteDownloadedSnapshots) | **DELETE** /oracle/db/{id}/downloaded_snapshots | Delete downloaded Oracle database snapshots and log snapshots
*RubrikRestApi.OracleApi* | [**getAcoParameterList**](docs/OracleApi.md#getAcoParameterList) | **GET** /oracle/aco_parameter_list | List of supported Advanced Cloning Options
*RubrikRestApi.OracleApi* | [**getExampleAcoDownloadLink**](docs/OracleApi.md#getExampleAcoDownloadLink) | **GET** /oracle/aco_example_download_link | Link to download the Advanced Recovery Options example file
*RubrikRestApi.OracleApi* | [**getOracleDbV1**](docs/OracleApi.md#getOracleDbV1) | **GET** /oracle/db/{id} | Get Oracle database information
*RubrikRestApi.OracleApi* | [**oracleRestoreEstimate**](docs/OracleApi.md#oracleRestoreEstimate) | **GET** /oracle/db/{id}/restore_estimate | Get a size estimate for a restore or export
*RubrikRestApi.OracleApi* | [**queryOracleDbV1**](docs/OracleApi.md#queryOracleDbV1) | **GET** /oracle/db | Get summary information for Oracle databases
*RubrikRestApi.OracleApi* | [**updateOracleDataGuardGroup**](docs/OracleApi.md#updateOracleDataGuardGroup) | **PATCH** /oracle/data_guard_group/{id} | Update an Oracle Data Guard group
*RubrikRestApi.OracleApi* | [**updateOracleDbV1**](docs/OracleApi.md#updateOracleDbV1) | **PATCH** /oracle/db/{id} | Update an Oracle database
*RubrikRestApi.OracleApi* | [**validateOracleAcoFile**](docs/OracleApi.md#validateOracleAcoFile) | **POST** /oracle/validate_aco_file | Validate Oracle ACO file
*RubrikRestApi.OrganizationApi* | [**bulkCreateEnvoys**](docs/OrganizationApi.md#bulkCreateEnvoys) | **POST** /organization/{id}/envoy/bulk | Create a list of Rubrik Envoy objects
*RubrikRestApi.OrganizationApi* | [**bulkDeleteEnvoys**](docs/OrganizationApi.md#bulkDeleteEnvoys) | **DELETE** /organization/{id}/envoy/bulk | Remove a list of Rubrik Envoy objects
*RubrikRestApi.OrganizationApi* | [**bulkUpdateEnvoys**](docs/OrganizationApi.md#bulkUpdateEnvoys) | **PATCH** /organization/{id}/envoy/bulk | Update a list of Rubrik Envoy objects
*RubrikRestApi.PrincipalApi* | [**assignRolesToPrincipals**](docs/PrincipalApi.md#assignRolesToPrincipals) | **POST** /principal/role | Assign roles to principals
*RubrikRestApi.PrincipalApi* | [**getRolesForPrincipals**](docs/PrincipalApi.md#getRolesForPrincipals) | **GET** /principal/role | Get roles assigned to principals
*RubrikRestApi.PrincipalApi* | [**revokeRolesFromPrincipals**](docs/PrincipalApi.md#revokeRolesFromPrincipals) | **POST** /principal/role/bulk_revoke | Revoke roles from principals
*RubrikRestApi.PrincipalApi* | [**searchPrincipalsV1**](docs/PrincipalApi.md#searchPrincipalsV1) | **GET** /principal | Search for principals
*RubrikRestApi.ReplicationApi* | [**disablePerLocationPause**](docs/ReplicationApi.md#disablePerLocationPause) | **POST** /replication/location_pause/disable | Resume replication from specified source clusters
*RubrikRestApi.ReplicationApi* | [**enablePerLocationPause**](docs/ReplicationApi.md#enablePerLocationPause) | **POST** /replication/location_pause/enable | Pause replication from specified source clusters
*RubrikRestApi.ReportsApi* | [**getComplianceSummarySLAV1**](docs/ReportsApi.md#getComplianceSummarySLAV1) | **GET** /report/compliance_summary_sla | Get compliance summary information
*RubrikRestApi.ReportsApi* | [**getComplianceSummaryV1**](docs/ReportsApi.md#getComplianceSummaryV1) | **GET** /report/compliance_summary | Get compliance summary information
*RubrikRestApi.ReportsApi* | [**setReportConfig**](docs/ReportsApi.md#setReportConfig) | **PATCH** /report/config | Modify the report config
*RubrikRestApi.RoleApi* | [**createRole**](docs/RoleApi.md#createRole) | **POST** /role | Create a new role
*RubrikRestApi.RoleApi* | [**deleteRole**](docs/RoleApi.md#deleteRole) | **DELETE** /role/{id} | Delete a role
*RubrikRestApi.RoleApi* | [**getRole**](docs/RoleApi.md#getRole) | **GET** /role/{id} | Get role information for the specified role
*RubrikRestApi.RoleApi* | [**getRoles**](docs/RoleApi.md#getRoles) | **GET** /role | Get all roles in an organization
*RubrikRestApi.RoleApi* | [**updateRole**](docs/RoleApi.md#updateRole) | **PATCH** /role/{id} | Update role information
*RubrikRestApi.SamlApi* | [**configRubrikSamlMetadata**](docs/SamlApi.md#configRubrikSamlMetadata) | **POST** /saml/rubrik_metadata | Configure and generate Rubrik SAML metadata
*RubrikRestApi.SamlApi* | [**getSamlSsoStatus**](docs/SamlApi.md#getSamlSsoStatus) | **GET** /saml/sso_status | Check SAML SSO Status
*RubrikRestApi.SamlApi* | [**makeSamlAuthnRequest**](docs/SamlApi.md#makeSamlAuthnRequest) | **POST** /saml/authn_request/{idp_name} | Make SAML authentication request
*RubrikRestApi.SapHanaApi* | [**addSapHanaSystem**](docs/SapHanaApi.md#addSapHanaSystem) | **POST** /sap_hana/system | Add a SAP HANA system
*RubrikRestApi.SapHanaApi* | [**configureSapHanaRestore**](docs/SapHanaApi.md#configureSapHanaRestore) | **POST** /sap_hana/db/{id}/configure_restore | Configure the target database for system copy restore
*RubrikRestApi.SapHanaApi* | [**createOnDemandSapHanaBackup**](docs/SapHanaApi.md#createOnDemandSapHanaBackup) | **POST** /sap_hana/db/{id}/snapshot | Create on demand database snapshot
*RubrikRestApi.SapHanaApi* | [**createSapHanaSystemRefresh**](docs/SapHanaApi.md#createSapHanaSystemRefresh) | **POST** /sap_hana/system/{id}/refresh | Refresh SAP HANA system metadata
*RubrikRestApi.SapHanaApi* | [**deleteSapHanaDbSnapshot**](docs/SapHanaApi.md#deleteSapHanaDbSnapshot) | **DELETE** /sap_hana/db/snapshot/{id} | Delete a particular full snapshot of a SAP HANA database
*RubrikRestApi.SapHanaApi* | [**deleteSapHanaSystem**](docs/SapHanaApi.md#deleteSapHanaSystem) | **DELETE** /sap_hana/system/{id} | Delete a SAP HANA system
*RubrikRestApi.SapHanaApi* | [**getMissedSapHanaDbSnapshots**](docs/SapHanaApi.md#getMissedSapHanaDbSnapshots) | **GET** /sap_hana/db/{id}/missed_snapshot | Retrieve summary information for missed snapshots of a SAP HANA database
*RubrikRestApi.SapHanaApi* | [**getSapHanaDatabase**](docs/SapHanaApi.md#getSapHanaDatabase) | **GET** /sap_hana/db/{id} | Get detailed information for an SAP HANA database
*RubrikRestApi.SapHanaApi* | [**getSapHanaDbAsyncRequestStatus**](docs/SapHanaApi.md#getSapHanaDbAsyncRequestStatus) | **GET** /sap_hana/db/request/{id} | Get the status of a SAP HANA database request
*RubrikRestApi.SapHanaApi* | [**getSapHanaDbRecoverableRanges**](docs/SapHanaApi.md#getSapHanaDbRecoverableRanges) | **GET** /sap_hana/db/{id}/recoverable_range | Get recoverable ranges of a SAP HANA database
*RubrikRestApi.SapHanaApi* | [**getSapHanaDbSnapshot**](docs/SapHanaApi.md#getSapHanaDbSnapshot) | **GET** /sap_hana/db/snapshot/{id} | Get SAP HANA database snapshot details
*RubrikRestApi.SapHanaApi* | [**getSapHanaSystem**](docs/SapHanaApi.md#getSapHanaSystem) | **GET** /sap_hana/system/{id} | Get summary information for a SAP HANA system
*RubrikRestApi.SapHanaApi* | [**getSapHanaSystemAsyncRequestStatus**](docs/SapHanaApi.md#getSapHanaSystemAsyncRequestStatus) | **GET** /sap_hana/system/request/{id} | Get the status of a SAP HANA system request
*RubrikRestApi.SapHanaApi* | [**patchSapHanaDatabase**](docs/SapHanaApi.md#patchSapHanaDatabase) | **PATCH** /sap_hana/db/{id} | Update the SLA Domain for an SAP HANA database
*RubrikRestApi.SapHanaApi* | [**patchSapHanaSystem**](docs/SapHanaApi.md#patchSapHanaSystem) | **PATCH** /sap_hana/system/{id} | Update the SLA Domain for a SAP HANA system
*RubrikRestApi.SapHanaApi* | [**querySapHanaDatabases**](docs/SapHanaApi.md#querySapHanaDatabases) | **GET** /sap_hana/db | Get summary information for discovered SAP HANA databases
*RubrikRestApi.SapHanaApi* | [**querySapHanaDbSnapshot**](docs/SapHanaApi.md#querySapHanaDbSnapshot) | **GET** /sap_hana/db/{id}/snapshot | Get a summary list of snapshots for a SAP HANA database
*RubrikRestApi.SapHanaApi* | [**querySapHanaSystems**](docs/SapHanaApi.md#querySapHanaSystems) | **GET** /sap_hana/system | Get summary information for added SAP HANA systems
*RubrikRestApi.SapHanaApi* | [**unconfigureSapHanaRestore**](docs/SapHanaApi.md#unconfigureSapHanaRestore) | **POST** /sap_hana/db/{id}/unconfigure_restore | Reset the configuration for system copy restore on target database
*RubrikRestApi.SessionApi* | [**createSession**](docs/SessionApi.md#createSession) | **POST** /session | Create user session
*RubrikRestApi.SessionApi* | [**deleteSession**](docs/SessionApi.md#deleteSession) | **DELETE** /session/{id} | Delete user session
*RubrikRestApi.SlaDomainApi* | [**assignSlaToDownloadedSnapshots**](docs/SlaDomainApi.md#assignSlaToDownloadedSnapshots) | **POST** /sla_domain/assign_to_downloaded_snapshots | Assign retention SLA Domain to the downloaded snapshots of a single object
*RubrikRestApi.SlaDomainApi* | [**createSlaDomain**](docs/SlaDomainApi.md#createSlaDomain) | **POST** /sla_domain | Create SLA Domain
*RubrikRestApi.SlaDomainApi* | [**deleteSlaDomain**](docs/SlaDomainApi.md#deleteSlaDomain) | **DELETE** /sla_domain/{id} | Remove SLA Domain
*RubrikRestApi.SlaDomainApi* | [**getSlaDomain**](docs/SlaDomainApi.md#getSlaDomain) | **GET** /sla_domain/{id} | Get SLA Domain details
*RubrikRestApi.SlaDomainApi* | [**patchSlaDomain**](docs/SlaDomainApi.md#patchSlaDomain) | **PATCH** /sla_domain/{id} | Patch SLA Domain
*RubrikRestApi.SlaDomainApi* | [**querySlaDomain**](docs/SlaDomainApi.md#querySlaDomain) | **GET** /sla_domain | Get list of SLA Domains
*RubrikRestApi.SlaDomainApi* | [**updateSlaDomain**](docs/SlaDomainApi.md#updateSlaDomain) | **PUT** /sla_domain/{id} | Update SLA Domain
*RubrikRestApi.SnapshotApi* | [**getSnapshotStorageStatsV1**](docs/SnapshotApi.md#getSnapshotStorageStatsV1) | **GET** /snapshot/{id}/storage/stats | Returns storage stats for a snapshot
*RubrikRestApi.UnmanagedObjectApi* | [**assignToRetentionSlaAsync**](docs/UnmanagedObjectApi.md#assignToRetentionSlaAsync) | **POST** /unmanaged_object/assign_retention_sla | Assign relic/unmanaged entities to an SLA Domain for managing retention asynchronously
*RubrikRestApi.UnmanagedObjectApi* | [**bulkTierExistingSnapshots**](docs/UnmanagedObjectApi.md#bulkTierExistingSnapshots) | **POST** /unmanaged_object/snapshot/bulk_archive_tier | Bulk tier existing snapshots to cold storage
*RubrikRestApi.UnmanagedObjectApi* | [**queryUnmanagedObjectSnapshotsV1**](docs/UnmanagedObjectApi.md#queryUnmanagedObjectSnapshotsV1) | **GET** /unmanaged_object/{id}/snapshot | Get summary of all the snapshots for a given object
*RubrikRestApi.UnmanagedObjectApi* | [**queryUnmanagedObjectV1**](docs/UnmanagedObjectApi.md#queryUnmanagedObjectV1) | **GET** /unmanaged_object | Get summary of all the objects with unmanaged snapshots
*RubrikRestApi.UnmanagedObjectApi* | [**queryUnmanagedReaderObject**](docs/UnmanagedObjectApi.md#queryUnmanagedReaderObject) | **GET** /unmanaged_object/reader_object | Get summary of all unmanaged reader objects
*RubrikRestApi.UserApi* | [**generateTotpSecret**](docs/UserApi.md#generateTotpSecret) | **POST** /user/{id}/totp/new_secret | Generate a TOTP secret key for the given user
*RubrikRestApi.UserApi* | [**getTotpStatus**](docs/UserApi.md#getTotpStatus) | **GET** /user/{id}/totp/status | Get the TOTP status for the given user
*RubrikRestApi.UserApi* | [**getUserAccountLockoutSettings**](docs/UserApi.md#getUserAccountLockoutSettings) | **GET** /user/lockout | Get the local user account lockout settings
*RubrikRestApi.UserApi* | [**manageUserAccountLockoutSettings**](docs/UserApi.md#manageUserAccountLockoutSettings) | **PATCH** /user/lockout | Update the local user account lockout settings
*RubrikRestApi.UserApi* | [**resetTotp**](docs/UserApi.md#resetTotp) | **DELETE** /user/{id}/totp/config | Reset the TOTP for the given user
*RubrikRestApi.UserApi* | [**setupTotp**](docs/UserApi.md#setupTotp) | **PUT** /user/{id}/totp/config | Configure the TOTP secret for the given user
*RubrikRestApi.UserApi* | [**unlockUser**](docs/UserApi.md#unlockUser) | **POST** /user/{id}/unlock | Unlock a user account
*RubrikRestApi.UserDefinedTagApi* | [**createUserDefinedTag**](docs/UserDefinedTagApi.md#createUserDefinedTag) | **POST** /user_defined_tag | Create a user-defined resource tag for tagging cloud compute resources
*RubrikRestApi.UserDefinedTagApi* | [**deleteUserDefinedTag**](docs/UserDefinedTagApi.md#deleteUserDefinedTag) | **DELETE** /user_defined_tag/{id} | Delete a user-defined resource tag
*RubrikRestApi.UserDefinedTagApi* | [**deleteUserDefinedTagBulk**](docs/UserDefinedTagApi.md#deleteUserDefinedTagBulk) | **DELETE** /user_defined_tag | Delete a list of user-defined resource tags
*RubrikRestApi.UserDefinedTagApi* | [**getUserDefinedTag**](docs/UserDefinedTagApi.md#getUserDefinedTag) | **GET** /user_defined_tag/{id} | Get user-defined tag
*RubrikRestApi.UserDefinedTagApi* | [**queryUserDefinedTag**](docs/UserDefinedTagApi.md#queryUserDefinedTag) | **GET** /user_defined_tag | Get user-defined resource tags
*RubrikRestApi.UserDefinedTagApi* | [**updateUserDefinedTag**](docs/UserDefinedTagApi.md#updateUserDefinedTag) | **PATCH** /user_defined_tag/{id} | Update the value of a user-defined resource tag
*RubrikRestApi.VcdClusterApi* | [**createVcdClusterV1**](docs/VcdClusterApi.md#createVcdClusterV1) | **POST** /vcd/cluster | Add a vCD Cluster
*RubrikRestApi.VcdClusterApi* | [**deleteVcdClusterV1**](docs/VcdClusterApi.md#deleteVcdClusterV1) | **DELETE** /vcd/cluster/{id} | Remove vCD Cluster
*RubrikRestApi.VcdClusterApi* | [**getVcdClusterAsyncRequestStatusV1**](docs/VcdClusterApi.md#getVcdClusterAsyncRequestStatusV1) | **GET** /vcd/cluster/request/{id} | Get vCD Cluster job status
*RubrikRestApi.VcdClusterApi* | [**getVcdClusterV1**](docs/VcdClusterApi.md#getVcdClusterV1) | **GET** /vcd/cluster/{id} | Get vCD Cluster details
*RubrikRestApi.VcdClusterApi* | [**queryVcdClusterV1**](docs/VcdClusterApi.md#queryVcdClusterV1) | **GET** /vcd/cluster | Get summary for all vCD Clusters
*RubrikRestApi.VcdClusterApi* | [**queryVcdVimServerV1**](docs/VcdClusterApi.md#queryVcdVimServerV1) | **GET** /vcd/cluster/{id}/vimserver | Get VimServers of a vCD Cluster
*RubrikRestApi.VcdClusterApi* | [**refreshVcdClusterV1**](docs/VcdClusterApi.md#refreshVcdClusterV1) | **POST** /vcd/cluster/{id}/refresh | Refresh a vCD Cluster
*RubrikRestApi.VcdClusterApi* | [**updateVcdClusterV1**](docs/VcdClusterApi.md#updateVcdClusterV1) | **PATCH** /vcd/cluster/{id} | Change vCD Cluster object
*RubrikRestApi.VcdHierarchyApi* | [**getVcdHierarchyChildrenV1**](docs/VcdHierarchyApi.md#getVcdHierarchyChildrenV1) | **GET** /vcd/hierarchy/{id}/children | Get immediate descendant objects
*RubrikRestApi.VcdHierarchyApi* | [**getVcdHierarchyDescendantsV1**](docs/VcdHierarchyApi.md#getVcdHierarchyDescendantsV1) | **GET** /vcd/hierarchy/{id}/descendants | Get list of descendant objects
*RubrikRestApi.VcdHierarchyApi* | [**getVcdHierarchyObjectV1**](docs/VcdHierarchyApi.md#getVcdHierarchyObjectV1) | **GET** /vcd/hierarchy/{id} | Get summary of a vCD hierarchy object
*RubrikRestApi.VcdVappApi* | [**createOnDemandSnapshotV1**](docs/VcdVappApi.md#createOnDemandSnapshotV1) | **POST** /vcd/vapp/{id}/snapshot | Create an on-demand snapshot for a vApp
*RubrikRestApi.VcdVappApi* | [**createVappExportV1**](docs/VcdVappApi.md#createVappExportV1) | **POST** /vcd/vapp/snapshot/{snapshot_id}/export | Export vApp snapshot
*RubrikRestApi.VcdVappApi* | [**createVappInstantRecoveryV1**](docs/VcdVappApi.md#createVappInstantRecoveryV1) | **POST** /vcd/vapp/snapshot/{snapshot_id}/instant_recover | Instant Recovery of vApp virtual machines
*RubrikRestApi.VcdVappApi* | [**createVappTemplateSnapshotExport**](docs/VcdVappApi.md#createVappTemplateSnapshotExport) | **POST** /vcd/vapp/template/snapshot/{snapshot_id}/export | Export of a vApp template snapshot
*RubrikRestApi.VcdVappApi* | [**createVcdVappDownloadSnapshotFromCloudV1**](docs/VcdVappApi.md#createVcdVappDownloadSnapshotFromCloudV1) | **POST** /vcd/vapp/snapshot/{id}/download | Download snapshot from archive
*RubrikRestApi.VcdVappApi* | [**deleteVappSnapshotV1**](docs/VcdVappApi.md#deleteVappSnapshotV1) | **DELETE** /vcd/vapp/snapshot/{id} | Delete a vApp snapshot
*RubrikRestApi.VcdVappApi* | [**deleteVappSnapshotsV1**](docs/VcdVappApi.md#deleteVappSnapshotsV1) | **DELETE** /vcd/vapp/{id}/snapshot | Delete all snapshots of vApp
*RubrikRestApi.VcdVappApi* | [**getVappAsyncRequestStatusV1**](docs/VcdVappApi.md#getVappAsyncRequestStatusV1) | **GET** /vcd/vapp/request/{id} | Get vApp job status
*RubrikRestApi.VcdVappApi* | [**getVappSnapshotExportOptionsV1**](docs/VcdVappApi.md#getVappSnapshotExportOptionsV1) | **GET** /vcd/vapp/snapshot/{snapshot_id}/export/options | Get exportable network configurations
*RubrikRestApi.VcdVappApi* | [**getVappSnapshotInstantRecoveryOptionsV1**](docs/VcdVappApi.md#getVappSnapshotInstantRecoveryOptionsV1) | **GET** /vcd/vapp/snapshot/{snapshot_id}/instant_recover/options | Get Instant Recovery information
*RubrikRestApi.VcdVappApi* | [**getVappSnapshotV1**](docs/VcdVappApi.md#getVappSnapshotV1) | **GET** /vcd/vapp/snapshot/{id} | Get vApp snapshot details
*RubrikRestApi.VcdVappApi* | [**getVappTemplateSnapshotExportOptions**](docs/VcdVappApi.md#getVappTemplateSnapshotExportOptions) | **GET** /vcd/vapp/template/snapshot/{snapshot_id}/export/options | Get Export information for a vApp template snapshot
*RubrikRestApi.VcdVappApi* | [**getVcdVappV1**](docs/VcdVappApi.md#getVcdVappV1) | **GET** /vcd/vapp/{id} | Get details of a specific vApp
*RubrikRestApi.VcdVappApi* | [**queryVappSnapshotV1**](docs/VcdVappApi.md#queryVappSnapshotV1) | **GET** /vcd/vapp/{id}/snapshot | Get list of snapshots of vApp
*RubrikRestApi.VcdVappApi* | [**queryVcdVappsV1**](docs/VcdVappApi.md#queryVcdVappsV1) | **GET** /vcd/vapp | Get summary for vApps
*RubrikRestApi.VcdVappApi* | [**searchVappV1**](docs/VcdVappApi.md#searchVappV1) | **GET** /vcd/vapp/{id}/search | Search for a file in a vApp
*RubrikRestApi.VcdVappApi* | [**updateVcdVappV1**](docs/VcdVappApi.md#updateVcdVappV1) | **PATCH** /vcd/vapp/{id} | Update vApp
*RubrikRestApi.VcdVappApi* | [**vcdMissedSnapshotsV1**](docs/VcdVappApi.md#vcdMissedSnapshotsV1) | **GET** /vcd/vapp/{id}/missed_snapshot | Get details about missed snapshots for a vApp
*RubrikRestApi.VmwareComputeClusterApi* | [**getAsyncRequestStatusForComputeCluster**](docs/VmwareComputeClusterApi.md#getAsyncRequestStatusForComputeCluster) | **GET** /vmware/compute_cluster/request/{id} | Get asynchronous request details for VMware cluster
*RubrikRestApi.VmwareComputeClusterApi* | [**getComputeCluster**](docs/VmwareComputeClusterApi.md#getComputeCluster) | **GET** /vmware/compute_cluster/{id} | Get details for the compute cluster
*RubrikRestApi.VmwareComputeClusterApi* | [**getIoFilters**](docs/VmwareComputeClusterApi.md#getIoFilters) | **GET** /vmware/compute_cluster/{id}/io_filter | Get the ioFilters on the VMware compute cluster with a specific ID
*RubrikRestApi.VmwareComputeClusterApi* | [**installIoFilter**](docs/VmwareComputeClusterApi.md#installIoFilter) | **POST** /vmware/compute_cluster/{id}/install_io_filter | Install the Rubrik ioFilter to the VMware cluster with a specific ID
*RubrikRestApi.VmwareComputeClusterApi* | [**queryComputeCluster**](docs/VmwareComputeClusterApi.md#queryComputeCluster) | **GET** /vmware/compute_cluster | Get all the clusters belonging to this datacenter
*RubrikRestApi.VmwareComputeClusterApi* | [**uninstallIoFilter**](docs/VmwareComputeClusterApi.md#uninstallIoFilter) | **POST** /vmware/compute_cluster/{id}/uninstall_io_filter | Uninstall the Rubrik ioFilter from the VMware cluster with a specific ID
*RubrikRestApi.VmwareComputeClusterApi* | [**updateComputeCluster**](docs/VmwareComputeClusterApi.md#updateComputeCluster) | **PATCH** /vmware/compute_cluster/{id} | Modify information for a VMware compute cluster
*RubrikRestApi.VmwareComputeClusterApi* | [**upgradeIoFilter**](docs/VmwareComputeClusterApi.md#upgradeIoFilter) | **POST** /vmware/compute_cluster/{id}/upgrade_io_filter | Upgrade the Rubrik ioFilter for the VMware cluster with a specific ID
*RubrikRestApi.VmwareConfigApi* | [**getPreferredCdpNetworkProtocol**](docs/VmwareConfigApi.md#getPreferredCdpNetworkProtocol) | **GET** /vmware/config/cdp/get_preferred_cdp_network_protocol | Returns the current preference of CDM between IPv4 and IPv6 for CDP data transfer
*RubrikRestApi.VmwareConfigApi* | [**getVmwareRecoveryNetworks**](docs/VmwareConfigApi.md#getVmwareRecoveryNetworks) | **GET** /vmware/config/recovery/networks | Get all the VMware recovery networks for a compute resource ID
*RubrikRestApi.VmwareConfigApi* | [**setPreferredCdpNetworkProtocol**](docs/VmwareConfigApi.md#setPreferredCdpNetworkProtocol) | **PATCH** /vmware/config/cdp/set_preferred_cdp_network_protocol | Set the current preference of CDM between IPv4 and IPv6 for CDP data transfer
*RubrikRestApi.VmwareHierarchyApi* | [**getVmwareHierarchyExport**](docs/VmwareHierarchyApi.md#getVmwareHierarchyExport) | **GET** /vmware/hierarchy/export | Get Available VMware Hierarchy Objects for Export Operations
*RubrikRestApi.VmwareHierarchyApi* | [**getVmwareHierarchyObject**](docs/VmwareHierarchyApi.md#getVmwareHierarchyObject) | **GET** /vmware/hierarchy/{id}/export | Get VMware Hierarchy Object Information
*RubrikRestApi.VmwareHostApi* | [**getVmwareHost**](docs/VmwareHostApi.md#getVmwareHost) | **GET** /vmware/host/{id} | Get details of a ESXi hypervisor
*RubrikRestApi.VmwareHostApi* | [**getVmwareHostDatastore**](docs/VmwareHostApi.md#getVmwareHostDatastore) | **GET** /vmware/host/{id}/datastore | Get details of datastores in a ESXi hypervisor
*RubrikRestApi.VmwareHostApi* | [**queryVmwareHost**](docs/VmwareHostApi.md#queryVmwareHost) | **GET** /vmware/host | Get summary of all the ESXi hypervisor
*RubrikRestApi.VmwareHostApi* | [**updateVmwareHost**](docs/VmwareHostApi.md#updateVmwareHost) | **PATCH** /vmware/host/{id} | Update the SLA Domain for an ESXi hypervisor
*RubrikRestApi.VmwareVcenterApi* | [**createRefresh**](docs/VmwareVcenterApi.md#createRefresh) | **POST** /vmware/vcenter/{id}/refresh | Refresh vCenter Server metadata
*RubrikRestApi.VmwareVcenterApi* | [**createRefreshVmV1**](docs/VmwareVcenterApi.md#createRefreshVmV1) | **POST** /vmware/vcenter/{id}/refresh_vm | Refresh single virtual machine metadata in a vcenter
*RubrikRestApi.VmwareVcenterApi* | [**createVcenter**](docs/VmwareVcenterApi.md#createVcenter) | **POST** /vmware/vcenter | Add vCenter Server
*RubrikRestApi.VmwareVcenterApi* | [**deleteVcenter**](docs/VmwareVcenterApi.md#deleteVcenter) | **DELETE** /vmware/vcenter/{id} | Remove vCenter Server
*RubrikRestApi.VmwareVcenterApi* | [**getHotAddBandwidth**](docs/VmwareVcenterApi.md#getHotAddBandwidth) | **GET** /vmware/vcenter/{id}/hotadd/bandwidth | Get the ingest and export bandwidth limits for HotAdd with the vCenter
*RubrikRestApi.VmwareVcenterApi* | [**getHotAddNetwork**](docs/VmwareVcenterApi.md#getHotAddNetwork) | **GET** /vmware/vcenter/{id}/hotadd/network | Retrieve the user-configured network for HotAdd operations
*RubrikRestApi.VmwareVcenterApi* | [**getNetworks**](docs/VmwareVcenterApi.md#getNetworks) | **GET** /vmware/vcenter/{id}/networks | Get the user-configured networks in the vCenter
*RubrikRestApi.VmwareVcenterApi* | [**getNumProxiesNeeded**](docs/VmwareVcenterApi.md#getNumProxiesNeeded) | **GET** /vmware/vcenter/{id}/hotadd/needed | Get the number of HotAdd proxies needed for the vCenter
*RubrikRestApi.VmwareVcenterApi* | [**getVcenter**](docs/VmwareVcenterApi.md#getVcenter) | **GET** /vmware/vcenter/{id} | Get the details of a vCenter Server
*RubrikRestApi.VmwareVcenterApi* | [**getVcenterAsyncRequestStatus**](docs/VmwareVcenterApi.md#getVcenterAsyncRequestStatus) | **GET** /vmware/vcenter/request/{id} | Get vCenter Server async request
*RubrikRestApi.VmwareVcenterApi* | [**patchVcenter**](docs/VmwareVcenterApi.md#patchVcenter) | **PATCH** /vmware/vcenter/{id} | Update the SLA Domain for a vCenter Server
*RubrikRestApi.VmwareVcenterApi* | [**queryHotAddProxyVm**](docs/VmwareVcenterApi.md#queryHotAddProxyVm) | **GET** /vmware/vcenter/hotadd/vm | Get a list of HotAdd proxy virtual machines
*RubrikRestApi.VmwareVcenterApi* | [**queryVcenter**](docs/VmwareVcenterApi.md#queryVcenter) | **GET** /vmware/vcenter | Get list of vCenters
*RubrikRestApi.VmwareVcenterApi* | [**setHotAddBandwidth**](docs/VmwareVcenterApi.md#setHotAddBandwidth) | **POST** /vmware/vcenter/{id}/hotadd/bandwidth | Set the ingest and export bandwidth limits for HotAdd with the vCenter
*RubrikRestApi.VmwareVcenterApi* | [**setHotAddNetwork**](docs/VmwareVcenterApi.md#setHotAddNetwork) | **POST** /vmware/vcenter/{id}/hotadd/network | Set the user-configured network for HotAdd backup and recovery
*RubrikRestApi.VmwareVcenterApi* | [**updateVcenter**](docs/VmwareVcenterApi.md#updateVcenter) | **PUT** /vmware/vcenter/{id} | Update vCenter Server
*RubrikRestApi.VmwareVmApi* | [**batchMountSnapshot**](docs/VmwareVmApi.md#batchMountSnapshot) | **POST** /vmware/vm/batch_mount | Live mount a snapshot each from a set of virtual machines
*RubrikRestApi.VmwareVmApi* | [**browseVmwareSnapshot**](docs/VmwareVmApi.md#browseVmwareSnapshot) | **GET** /vmware/vm/snapshot/{id}/browse | List files in VM snapshot
*RubrikRestApi.VmwareVmApi* | [**bulkCreateOnDemandBackup**](docs/VmwareVmApi.md#bulkCreateOnDemandBackup) | **POST** /vmware/vm/snapshot/bulk | Take an on-demand snapshot of multiple virtual machines
*RubrikRestApi.VmwareVmApi* | [**createDownloadFileJob**](docs/VmwareVmApi.md#createDownloadFileJob) | **POST** /vmware/vm/snapshot/{id}/download_file | Download file from VM snapshot
*RubrikRestApi.VmwareVmApi* | [**createDownloadSnapshotFromCloud**](docs/VmwareVmApi.md#createDownloadSnapshotFromCloud) | **POST** /vmware/vm/snapshot/{id}/download | Download snapshot from archive
*RubrikRestApi.VmwareVmApi* | [**createExportV1**](docs/VmwareVmApi.md#createExportV1) | **POST** /vmware/vm/snapshot/{id}/export | Export VM snapshot
*RubrikRestApi.VmwareVmApi* | [**createExportWithDownloadFromCloudV1**](docs/VmwareVmApi.md#createExportWithDownloadFromCloudV1) | **POST** /vmware/vm/snapshot/{id}/export_with_download | Download a snapshot from an archival location, then export a virtual machine using the downloaded snapshot
*RubrikRestApi.VmwareVmApi* | [**createInstantRecovery**](docs/VmwareVmApi.md#createInstantRecovery) | **POST** /vmware/vm/snapshot/{id}/instant_recover | Instantly recover a VM
*RubrikRestApi.VmwareVmApi* | [**createMountV1**](docs/VmwareVmApi.md#createMountV1) | **POST** /vmware/vm/snapshot/{id}/mount | Live mount a VM from a snapshot
*RubrikRestApi.VmwareVmApi* | [**createOnDemandBackup**](docs/VmwareVmApi.md#createOnDemandBackup) | **POST** /vmware/vm/{id}/snapshot | Create an on-demand snapshot for a VM
*RubrikRestApi.VmwareVmApi* | [**createRestoreFileJob**](docs/VmwareVmApi.md#createRestoreFileJob) | **POST** /vmware/vm/snapshot/{id}/restore_file | Restore file from VM snapshot
*RubrikRestApi.VmwareVmApi* | [**createUnmount**](docs/VmwareVmApi.md#createUnmount) | **DELETE** /vmware/vm/snapshot/mount/{id} | Delete a Live Mount VM
*RubrikRestApi.VmwareVmApi* | [**deleteVmwareSnapshot**](docs/VmwareVmApi.md#deleteVmwareSnapshot) | **DELETE** /vmware/vm/snapshot/{id} | Delete VM snapshot
*RubrikRestApi.VmwareVmApi* | [**deleteVmwareSnapshots**](docs/VmwareVmApi.md#deleteVmwareSnapshots) | **DELETE** /vmware/vm/{id}/snapshot | Delete all snapshots of VM
*RubrikRestApi.VmwareVmApi* | [**getAsyncRequestStatus**](docs/VmwareVmApi.md#getAsyncRequestStatus) | **GET** /vmware/vm/request/{id} | Get asynchronous request details for VM
*RubrikRestApi.VmwareVmApi* | [**getMountV1**](docs/VmwareVmApi.md#getMountV1) | **GET** /vmware/vm/snapshot/mount/{id} | Get information for a Live Mount
*RubrikRestApi.VmwareVmApi* | [**getSnapshot**](docs/VmwareVmApi.md#getSnapshot) | **GET** /vmware/vm/snapshot/{id} | Get VM snapshot details
*RubrikRestApi.VmwareVmApi* | [**getVirtualDisk**](docs/VmwareVmApi.md#getVirtualDisk) | **GET** /vmware/vm/virtual_disk/{id} | Details about the specific Virtual Disk
*RubrikRestApi.VmwareVmApi* | [**getVm**](docs/VmwareVmApi.md#getVm) | **GET** /vmware/vm/{id} | Get VM details
*RubrikRestApi.VmwareVmApi* | [**getVmForceFullSpec**](docs/VmwareVmApi.md#getVmForceFullSpec) | **GET** /vmware/vm/{id}/request/force_full_snapshot | Retrieve the configuration for forcing a full snapshot of a VMware virtual machine
*RubrikRestApi.VmwareVmApi* | [**getVmwareCdpLiveInfo**](docs/VmwareVmApi.md#getVmwareCdpLiveInfo) | **POST** /vmware/vm/cdp | Returns the live CDP info for a set of CDP-enabled virtual machines
*RubrikRestApi.VmwareVmApi* | [**getVmwareCdpStateInfo**](docs/VmwareVmApi.md#getVmwareCdpStateInfo) | **POST** /vmware/vm/cdp_state | Returns CDP state info for a set of virtual machines
*RubrikRestApi.VmwareVmApi* | [**getVmwareMissedRecoverableRanges**](docs/VmwareVmApi.md#getVmwareMissedRecoverableRanges) | **GET** /vmware/vm/{id}/missed_recoverable_range | Get missed time ranges for point in time recovery
*RubrikRestApi.VmwareVmApi* | [**getVmwareRecoverableRanges**](docs/VmwareVmApi.md#getVmwareRecoverableRanges) | **GET** /vmware/vm/{id}/recoverable_range | Get available time ranges for point in time recovery
*RubrikRestApi.VmwareVmApi* | [**getVmwareVmMissedRecoverableRangesInBatch**](docs/VmwareVmApi.md#getVmwareVmMissedRecoverableRangesInBatch) | **POST** /vmware/vm/missed_recoverable_range | Returns the recoverable ranges that were missed for a set of CDP-enabled virtual machines
*RubrikRestApi.VmwareVmApi* | [**getVmwareVmRecoverableRangesInBatch**](docs/VmwareVmApi.md#getVmwareVmRecoverableRangesInBatch) | **POST** /vmware/vm/recoverable_range | Returns the recoverable ranges for a set of CDP-enabled virtual machines
*RubrikRestApi.VmwareVmApi* | [**missedSnapshots**](docs/VmwareVmApi.md#missedSnapshots) | **GET** /vmware/vm/{id}/missed_snapshot | Get details about missed snapshots for a VM
*RubrikRestApi.VmwareVmApi* | [**queryMountV1**](docs/VmwareVmApi.md#queryMountV1) | **GET** /vmware/vm/snapshot/mount | Get Live Mount information
*RubrikRestApi.VmwareVmApi* | [**querySnapshot**](docs/VmwareVmApi.md#querySnapshot) | **GET** /vmware/vm/{id}/snapshot | Get list of snapshots of VM
*RubrikRestApi.VmwareVmApi* | [**querySnapshotsForVms**](docs/VmwareVmApi.md#querySnapshotsForVms) | **POST** /vmware/vm/snapshots | Get snapshot information for a list of virtual machines
*RubrikRestApi.VmwareVmApi* | [**queryVm**](docs/VmwareVmApi.md#queryVm) | **GET** /vmware/vm | Get list of VMs
*RubrikRestApi.VmwareVmApi* | [**relocateMount**](docs/VmwareVmApi.md#relocateMount) | **POST** /vmware/vm/snapshot/mount/{id}/relocate | Relocate a virtual machine to another datastore
*RubrikRestApi.VmwareVmApi* | [**requestVmForceFullSnapshot**](docs/VmwareVmApi.md#requestVmForceFullSnapshot) | **POST** /vmware/vm/{id}/request/force_full_snapshot | Request a full snapshot for the next backup job of a VMware virtual machine
*RubrikRestApi.VmwareVmApi* | [**runGuestOsScript**](docs/VmwareVmApi.md#runGuestOsScript) | **POST** /vmware/vm/{id}/guest_script/run | Run guest OS script
*RubrikRestApi.VmwareVmApi* | [**searchVm**](docs/VmwareVmApi.md#searchVm) | **GET** /vmware/vm/{id}/search | Search for a file from a VM
*RubrikRestApi.VmwareVmApi* | [**updateMount**](docs/VmwareVmApi.md#updateMount) | **PATCH** /vmware/vm/snapshot/mount/{id} | Power a Live Mount on and off
*RubrikRestApi.VmwareVmApi* | [**updateVirtualDisk**](docs/VmwareVmApi.md#updateVirtualDisk) | **PATCH** /vmware/vm/virtual_disk/{id} | Update a specific Virtual Disk
*RubrikRestApi.VmwareVmApi* | [**updateVm**](docs/VmwareVmApi.md#updateVm) | **PATCH** /vmware/vm/{id} | Update VM
*RubrikRestApi.VmwareVmApi* | [**vmMakePrimary**](docs/VmwareVmApi.md#vmMakePrimary) | **POST** /vmware/vm/make_primary | Make this cluster the primary for agents on a set of VMs
*RubrikRestApi.VmwareVmApi* | [**vmRegisterAgent**](docs/VmwareVmApi.md#vmRegisterAgent) | **POST** /vmware/vm/{id}/register_agent | Register Rubrik Backup Service
*RubrikRestApi.VolumeGroupApi* | [**createOnDemandVolumeGroupBackup**](docs/VolumeGroupApi.md#createOnDemandVolumeGroupBackup) | **POST** /volume_group/{id}/snapshot | Create on-demand snapshot for the Volume Group
*RubrikRestApi.VolumeGroupApi* | [**getVolumeGroup**](docs/VolumeGroupApi.md#getVolumeGroup) | **GET** /volume_group/{id} | Get Volume Group details
*RubrikRestApi.VolumeGroupApi* | [**getVolumeGroupForceFullSpec**](docs/VolumeGroupApi.md#getVolumeGroupForceFullSpec) | **GET** /volume_group/{id}/request/force_full_snapshot | Retrieve the configuration for forcing a full snapshot
*RubrikRestApi.VolumeGroupApi* | [**getVolumeGroupSnapshot**](docs/VolumeGroupApi.md#getVolumeGroupSnapshot) | **GET** /volume_group/snapshot/{id} | Get Volume Group snapshot details
*RubrikRestApi.VolumeGroupApi* | [**getVolumeGroupSnapshotMount**](docs/VolumeGroupApi.md#getVolumeGroupSnapshotMount) | **GET** /volume_group/snapshot/mount/{id} | Get summary information for a mount
*RubrikRestApi.VolumeGroupApi* | [**patchVolumeGroup**](docs/VolumeGroupApi.md#patchVolumeGroup) | **PATCH** /volume_group/{id} | Update Volume Group properties
*RubrikRestApi.VolumeGroupApi* | [**queryVolumeGroup**](docs/VolumeGroupApi.md#queryVolumeGroup) | **GET** /volume_group | Get list of Volume Groups
*RubrikRestApi.VolumeGroupApi* | [**queryVolumeGroupLatestSnapshot**](docs/VolumeGroupApi.md#queryVolumeGroupLatestSnapshot) | **GET** /volume_group/{id}/latest_snapshot | Get the latest snapshot of the Volume Group
*RubrikRestApi.VolumeGroupApi* | [**queryVolumeGroupSnapshot**](docs/VolumeGroupApi.md#queryVolumeGroupSnapshot) | **GET** /volume_group/{id}/snapshot | Get list of snapshots of the Volume Group
*RubrikRestApi.VolumeGroupApi* | [**queryVolumeGroupSnapshotMount**](docs/VolumeGroupApi.md#queryVolumeGroupSnapshotMount) | **GET** /volume_group/snapshot/mount | Get summary information for all mounts
*RubrikRestApi.VolumeGroupApi* | [**requestVolumeGroupForceFullSnapshot**](docs/VolumeGroupApi.md#requestVolumeGroupForceFullSnapshot) | **POST** /volume_group/{id}/request/force_full_snapshot | Request a full snapshot on the next backup job of a Volume Group
*RubrikRestApi.WindowsClusterApi* | [**getWindowsCluster**](docs/WindowsClusterApi.md#getWindowsCluster) | **GET** /windows_cluster/{id} | Get detailed information for a Windows cluster
*RubrikRestApi.WindowsClusterApi* | [**queryWindowsCluster**](docs/WindowsClusterApi.md#queryWindowsCluster) | **GET** /windows_cluster | Get summary information for Windows clusters


## Documentation for Models

 - [RubrikRestApi.ActionDetails](docs/ActionDetails.md)
 - [RubrikRestApi.ActivityLogSummaryV1](docs/ActivityLogSummaryV1.md)
 - [RubrikRestApi.ActivityLogSummaryV1ListResponse](docs/ActivityLogSummaryV1ListResponse.md)
 - [RubrikRestApi.AdaptiveThrottlingSettingsVmwareFields](docs/AdaptiveThrottlingSettingsVmwareFields.md)
 - [RubrikRestApi.AdvancedLdapConfiguration](docs/AdvancedLdapConfiguration.md)
 - [RubrikRestApi.AdvancedUiConfigAttributes](docs/AdvancedUiConfigAttributes.md)
 - [RubrikRestApi.AgentSecondaryCertificateInfo](docs/AgentSecondaryCertificateInfo.md)
 - [RubrikRestApi.AgentSecondaryCertificateInfoListResponse](docs/AgentSecondaryCertificateInfoListResponse.md)
 - [RubrikRestApi.AgentStatus](docs/AgentStatus.md)
 - [RubrikRestApi.AppSearchResponse](docs/AppSearchResponse.md)
 - [RubrikRestApi.AppSearchResponseListResponse](docs/AppSearchResponseListResponse.md)
 - [RubrikRestApi.ApplyLegalHoldDefinition](docs/ApplyLegalHoldDefinition.md)
 - [RubrikRestApi.ArchivalSpec](docs/ArchivalSpec.md)
 - [RubrikRestApi.ArchivalSpecV2](docs/ArchivalSpecV2.md)
 - [RubrikRestApi.ArchivalTieringSpec](docs/ArchivalTieringSpec.md)
 - [RubrikRestApi.AsyncRequestStatus](docs/AsyncRequestStatus.md)
 - [RubrikRestApi.AuthDomainType](docs/AuthDomainType.md)
 - [RubrikRestApi.AvailableVersionInfo](docs/AvailableVersionInfo.md)
 - [RubrikRestApi.AwsEc2InstanceSlaObjectCount](docs/AwsEc2InstanceSlaObjectCount.md)
 - [RubrikRestApi.BackupTaskDiagnosticInfo](docs/BackupTaskDiagnosticInfo.md)
 - [RubrikRestApi.BackupWindow](docs/BackupWindow.md)
 - [RubrikRestApi.BaseGuestCredential](docs/BaseGuestCredential.md)
 - [RubrikRestApi.BaseGuestCredentialDetail](docs/BaseGuestCredentialDetail.md)
 - [RubrikRestApi.BaseOnDemandSnapshotConfig](docs/BaseOnDemandSnapshotConfig.md)
 - [RubrikRestApi.BaseSnapshotDetail](docs/BaseSnapshotDetail.md)
 - [RubrikRestApi.BaseSnapshotSummary](docs/BaseSnapshotSummary.md)
 - [RubrikRestApi.BatchAsyncRequest](docs/BatchAsyncRequest.md)
 - [RubrikRestApi.BatchAsyncRequestStatus](docs/BatchAsyncRequestStatus.md)
 - [RubrikRestApi.BatchMountSnapshotJobConfig](docs/BatchMountSnapshotJobConfig.md)
 - [RubrikRestApi.BatchVmSnapshotSummaries](docs/BatchVmSnapshotSummaries.md)
 - [RubrikRestApi.BatchVmwareCdpLiveInfo](docs/BatchVmwareCdpLiveInfo.md)
 - [RubrikRestApi.BatchVmwareCdpStateInfo](docs/BatchVmwareCdpStateInfo.md)
 - [RubrikRestApi.BatchVmwareVmMissedRecoverableRanges](docs/BatchVmwareVmMissedRecoverableRanges.md)
 - [RubrikRestApi.BatchVmwareVmMissedRecoverableRangesRequest](docs/BatchVmwareVmMissedRecoverableRangesRequest.md)
 - [RubrikRestApi.BatchVmwareVmRecoverableRanges](docs/BatchVmwareVmRecoverableRanges.md)
 - [RubrikRestApi.BatchVmwareVmRecoverableRangesRequest](docs/BatchVmwareVmRecoverableRangesRequest.md)
 - [RubrikRestApi.BlackoutWindow](docs/BlackoutWindow.md)
 - [RubrikRestApi.BlackoutWindowResponseInfo](docs/BlackoutWindowResponseInfo.md)
 - [RubrikRestApi.BlackoutWindowStatus](docs/BlackoutWindowStatus.md)
 - [RubrikRestApi.BlackoutWindows](docs/BlackoutWindows.md)
 - [RubrikRestApi.BooleanResponse](docs/BooleanResponse.md)
 - [RubrikRestApi.BootstrappableNodeInfoV1](docs/BootstrappableNodeInfoV1.md)
 - [RubrikRestApi.BootstrappableNodeIpv4Info](docs/BootstrappableNodeIpv4Info.md)
 - [RubrikRestApi.BrowseResponse](docs/BrowseResponse.md)
 - [RubrikRestApi.BrowseResponseListResponse](docs/BrowseResponseListResponse.md)
 - [RubrikRestApi.BulkDeleteObjectSnapshotsConfig](docs/BulkDeleteObjectSnapshotsConfig.md)
 - [RubrikRestApi.BulkDeleteSnapshotsConfig](docs/BulkDeleteSnapshotsConfig.md)
 - [RubrikRestApi.BulkOnDemandSnapshotJobConfig](docs/BulkOnDemandSnapshotJobConfig.md)
 - [RubrikRestApi.BulkOracleDbDetails](docs/BulkOracleDbDetails.md)
 - [RubrikRestApi.BulkOracleHostDetails](docs/BulkOracleHostDetails.md)
 - [RubrikRestApi.BulkOracleRacDetails](docs/BulkOracleRacDetails.md)
 - [RubrikRestApi.BulkShareAddResponse](docs/BulkShareAddResponse.md)
 - [RubrikRestApi.BulkSlaConflictsSummary](docs/BulkSlaConflictsSummary.md)
 - [RubrikRestApi.BulkTierSnapshotsConfig](docs/BulkTierSnapshotsConfig.md)
 - [RubrikRestApi.CdpLocalStatus](docs/CdpLocalStatus.md)
 - [RubrikRestApi.CdpReplicationStatus](docs/CdpReplicationStatus.md)
 - [RubrikRestApi.CdpState](docs/CdpState.md)
 - [RubrikRestApi.CertificateImportRequest](docs/CertificateImportRequest.md)
 - [RubrikRestApi.CertificateListSortAttributes](docs/CertificateListSortAttributes.md)
 - [RubrikRestApi.CertificatePatchRequest](docs/CertificatePatchRequest.md)
 - [RubrikRestApi.CertificateSummary](docs/CertificateSummary.md)
 - [RubrikRestApi.CertificateSummaryListResponse](docs/CertificateSummaryListResponse.md)
 - [RubrikRestApi.CloudInstantiationSpec](docs/CloudInstantiationSpec.md)
 - [RubrikRestApi.CloudOutComputeForecastSummaries](docs/CloudOutComputeForecastSummaries.md)
 - [RubrikRestApi.CloudOutComputeForecastSummary](docs/CloudOutComputeForecastSummary.md)
 - [RubrikRestApi.CloudOutForecastRequest](docs/CloudOutForecastRequest.md)
 - [RubrikRestApi.CloudOutForecastSlaParameters](docs/CloudOutForecastSlaParameters.md)
 - [RubrikRestApi.CloudOutForecastSummary](docs/CloudOutForecastSummary.md)
 - [RubrikRestApi.CloudOutStorageForecastSummaries](docs/CloudOutStorageForecastSummaries.md)
 - [RubrikRestApi.CloudOutStorageForecastSummary](docs/CloudOutStorageForecastSummary.md)
 - [RubrikRestApi.CloudStorageColdTier](docs/CloudStorageColdTier.md)
 - [RubrikRestApi.CloudStorageRehydrationSpeed](docs/CloudStorageRehydrationSpeed.md)
 - [RubrikRestApi.ClusterApiVersion](docs/ClusterApiVersion.md)
 - [RubrikRestApi.ClusterCertificate](docs/ClusterCertificate.md)
 - [RubrikRestApi.ClusterGeolocation](docs/ClusterGeolocation.md)
 - [RubrikRestApi.ClusterHostGroupInfo](docs/ClusterHostGroupInfo.md)
 - [RubrikRestApi.ClusterInfo](docs/ClusterInfo.md)
 - [RubrikRestApi.ClusterTimezone](docs/ClusterTimezone.md)
 - [RubrikRestApi.ClusterUpdate](docs/ClusterUpdate.md)
 - [RubrikRestApi.ClusterVersion](docs/ClusterVersion.md)
 - [RubrikRestApi.ClusterVisibilityConfig](docs/ClusterVisibilityConfig.md)
 - [RubrikRestApi.ClusterVisibilityInfo](docs/ClusterVisibilityInfo.md)
 - [RubrikRestApi.CommunityUserCredentials](docs/CommunityUserCredentials.md)
 - [RubrikRestApi.ComplianceRangeFilter](docs/ComplianceRangeFilter.md)
 - [RubrikRestApi.ComplianceSummarySLAV1](docs/ComplianceSummarySLAV1.md)
 - [RubrikRestApi.ComplianceSummaryStatus](docs/ComplianceSummaryStatus.md)
 - [RubrikRestApi.ComplianceSummaryV1](docs/ComplianceSummaryV1.md)
 - [RubrikRestApi.ComputeClusterDetail](docs/ComputeClusterDetail.md)
 - [RubrikRestApi.ComputeClusterSummary](docs/ComputeClusterSummary.md)
 - [RubrikRestApi.ComputeClusterSummaryListResponse](docs/ComputeClusterSummaryListResponse.md)
 - [RubrikRestApi.ComputeClusterUpdate](docs/ComputeClusterUpdate.md)
 - [RubrikRestApi.ConfigChangeSource](docs/ConfigChangeSource.md)
 - [RubrikRestApi.ConfigParam](docs/ConfigParam.md)
 - [RubrikRestApi.ConfigurationSummary](docs/ConfigurationSummary.md)
 - [RubrikRestApi.ConfigurationSummaryListResponse](docs/ConfigurationSummaryListResponse.md)
 - [RubrikRestApi.ConfigurationUpdateSummary](docs/ConfigurationUpdateSummary.md)
 - [RubrikRestApi.ConfigurationUpdateSummaryListResponse](docs/ConfigurationUpdateSummaryListResponse.md)
 - [RubrikRestApi.ConfiguredSlaType](docs/ConfiguredSlaType.md)
 - [RubrikRestApi.CorsConfiguration](docs/CorsConfiguration.md)
 - [RubrikRestApi.CorsConfigurationPatch](docs/CorsConfigurationPatch.md)
 - [RubrikRestApi.CountResponse](docs/CountResponse.md)
 - [RubrikRestApi.CreateNewVappParams](docs/CreateNewVappParams.md)
 - [RubrikRestApi.CreateVappNetworkParams](docs/CreateVappNetworkParams.md)
 - [RubrikRestApi.CsrRequest](docs/CsrRequest.md)
 - [RubrikRestApi.CsrSummary](docs/CsrSummary.md)
 - [RubrikRestApi.CsrSummaryListResponse](docs/CsrSummaryListResponse.md)
 - [RubrikRestApi.DataCenterSummary](docs/DataCenterSummary.md)
 - [RubrikRestApi.DataGuardGroupMember](docs/DataGuardGroupMember.md)
 - [RubrikRestApi.DataGuardType](docs/DataGuardType.md)
 - [RubrikRestApi.DataStoreSummary](docs/DataStoreSummary.md)
 - [RubrikRestApi.DatabaseType](docs/DatabaseType.md)
 - [RubrikRestApi.DbLogReportProperties](docs/DbLogReportProperties.md)
 - [RubrikRestApi.DbLogReportPropertiesUpdate](docs/DbLogReportPropertiesUpdate.md)
 - [RubrikRestApi.DbLogReportSummary](docs/DbLogReportSummary.md)
 - [RubrikRestApi.DbLogReportSummaryListResponse](docs/DbLogReportSummaryListResponse.md)
 - [RubrikRestApi.DbLogReportSummaryListSortAttribute](docs/DbLogReportSummaryListSortAttribute.md)
 - [RubrikRestApi.DiagnosticTaskStatus](docs/DiagnosticTaskStatus.md)
 - [RubrikRestApi.DisablePerLocationPause](docs/DisablePerLocationPause.md)
 - [RubrikRestApi.DiscoveredNasShare](docs/DiscoveredNasShare.md)
 - [RubrikRestApi.DissolveLegalHoldDefinition](docs/DissolveLegalHoldDefinition.md)
 - [RubrikRestApi.DissolveLegalHoldResponse](docs/DissolveLegalHoldResponse.md)
 - [RubrikRestApi.DownloadFileJobConfig](docs/DownloadFileJobConfig.md)
 - [RubrikRestApi.DownloadJobInfo](docs/DownloadJobInfo.md)
 - [RubrikRestApi.DownloadMssqlBackupFilesByIdJobConfig](docs/DownloadMssqlBackupFilesByIdJobConfig.md)
 - [RubrikRestApi.DownloadedSnapshotSlaAssignmentInfo](docs/DownloadedSnapshotSlaAssignmentInfo.md)
 - [RubrikRestApi.EffectiveSlaHolder](docs/EffectiveSlaHolder.md)
 - [RubrikRestApi.EnablePerLocationPause](docs/EnablePerLocationPause.md)
 - [RubrikRestApi.EncryptionStatus](docs/EncryptionStatus.md)
 - [RubrikRestApi.EnvoyBulkUpdate](docs/EnvoyBulkUpdate.md)
 - [RubrikRestApi.EnvoyCreate](docs/EnvoyCreate.md)
 - [RubrikRestApi.EnvoyDetail](docs/EnvoyDetail.md)
 - [RubrikRestApi.EnvoyDetailList](docs/EnvoyDetailList.md)
 - [RubrikRestApi.EnvoyIdList](docs/EnvoyIdList.md)
 - [RubrikRestApi.EnvoySummary](docs/EnvoySummary.md)
 - [RubrikRestApi.EnvoyUpdate](docs/EnvoyUpdate.md)
 - [RubrikRestApi.EnvoyUserInfo](docs/EnvoyUserInfo.md)
 - [RubrikRestApi.EventCsvDownloadResponse](docs/EventCsvDownloadResponse.md)
 - [RubrikRestApi.EventNotification](docs/EventNotification.md)
 - [RubrikRestApi.EventSeriesStatusV1](docs/EventSeriesStatusV1.md)
 - [RubrikRestApi.EventSeriesSummaryV1](docs/EventSeriesSummaryV1.md)
 - [RubrikRestApi.EventSeverityV1](docs/EventSeverityV1.md)
 - [RubrikRestApi.EventStatusV1](docs/EventStatusV1.md)
 - [RubrikRestApi.EventSummaryV1](docs/EventSummaryV1.md)
 - [RubrikRestApi.EventTypeV1](docs/EventTypeV1.md)
 - [RubrikRestApi.EventsAndSeriesSummariesResponse](docs/EventsAndSeriesSummariesResponse.md)
 - [RubrikRestApi.EventsAndSeriesSummariesV1](docs/EventsAndSeriesSummariesV1.md)
 - [RubrikRestApi.ExampleEnum](docs/ExampleEnum.md)
 - [RubrikRestApi.ExclusionPatternCreateConfig](docs/ExclusionPatternCreateConfig.md)
 - [RubrikRestApi.ExclusionPatternDetail](docs/ExclusionPatternDetail.md)
 - [RubrikRestApi.ExclusionPatternDetailList](docs/ExclusionPatternDetailList.md)
 - [RubrikRestApi.ExclusionPatternDetailListResponse](docs/ExclusionPatternDetailListResponse.md)
 - [RubrikRestApi.ExclusionPatternUpdateConfig](docs/ExclusionPatternUpdateConfig.md)
 - [RubrikRestApi.ExistingSnapshotRetention](docs/ExistingSnapshotRetention.md)
 - [RubrikRestApi.ExpiredCustomRetentionSnapshotInfo](docs/ExpiredCustomRetentionSnapshotInfo.md)
 - [RubrikRestApi.ExpiredCustomRetentionSnapshots](docs/ExpiredCustomRetentionSnapshots.md)
 - [RubrikRestApi.ExportMssqlDbJobConfig](docs/ExportMssqlDbJobConfig.md)
 - [RubrikRestApi.ExportSnapshotJobConfigV1](docs/ExportSnapshotJobConfigV1.md)
 - [RubrikRestApi.FailoverClusterAppConfig](docs/FailoverClusterAppConfig.md)
 - [RubrikRestApi.FailoverClusterAppConnectionStatus](docs/FailoverClusterAppConnectionStatus.md)
 - [RubrikRestApi.FailoverClusterAppDetail](docs/FailoverClusterAppDetail.md)
 - [RubrikRestApi.FailoverClusterAppSource](docs/FailoverClusterAppSource.md)
 - [RubrikRestApi.FailoverClusterAppSummary](docs/FailoverClusterAppSummary.md)
 - [RubrikRestApi.FailoverClusterAppSummaryListResponse](docs/FailoverClusterAppSummaryListResponse.md)
 - [RubrikRestApi.FailoverClusterConfig](docs/FailoverClusterConfig.md)
 - [RubrikRestApi.FailoverClusterConnectionStatus](docs/FailoverClusterConnectionStatus.md)
 - [RubrikRestApi.FailoverClusterDetail](docs/FailoverClusterDetail.md)
 - [RubrikRestApi.FailoverClusterHierarchyObjectDescendentCount](docs/FailoverClusterHierarchyObjectDescendentCount.md)
 - [RubrikRestApi.FailoverClusterHierarchyObjectSortAttribute](docs/FailoverClusterHierarchyObjectSortAttribute.md)
 - [RubrikRestApi.FailoverClusterHierarchyObjectSummary](docs/FailoverClusterHierarchyObjectSummary.md)
 - [RubrikRestApi.FailoverClusterHierarchyObjectSummaryListResponse](docs/FailoverClusterHierarchyObjectSummaryListResponse.md)
 - [RubrikRestApi.FailoverClusterNode](docs/FailoverClusterNode.md)
 - [RubrikRestApi.FailoverClusterNodeConnectionStatus](docs/FailoverClusterNodeConnectionStatus.md)
 - [RubrikRestApi.FailoverClusterNodeOrder](docs/FailoverClusterNodeOrder.md)
 - [RubrikRestApi.FailoverClusterNodeOsType](docs/FailoverClusterNodeOsType.md)
 - [RubrikRestApi.FailoverClusterObjectType](docs/FailoverClusterObjectType.md)
 - [RubrikRestApi.FailoverClusterOsType](docs/FailoverClusterOsType.md)
 - [RubrikRestApi.FailoverClusterSummary](docs/FailoverClusterSummary.md)
 - [RubrikRestApi.FailoverClusterSummaryListResponse](docs/FailoverClusterSummaryListResponse.md)
 - [RubrikRestApi.FailoverClusterType](docs/FailoverClusterType.md)
 - [RubrikRestApi.FileSystemType](docs/FileSystemType.md)
 - [RubrikRestApi.FileVersion](docs/FileVersion.md)
 - [RubrikRestApi.FilesetArraySpec](docs/FilesetArraySpec.md)
 - [RubrikRestApi.FilesetCreate](docs/FilesetCreate.md)
 - [RubrikRestApi.FilesetDetail](docs/FilesetDetail.md)
 - [RubrikRestApi.FilesetDownloadFileJobConfig](docs/FilesetDownloadFileJobConfig.md)
 - [RubrikRestApi.FilesetExportFileJobConfig](docs/FilesetExportFileJobConfig.md)
 - [RubrikRestApi.FilesetOptions](docs/FilesetOptions.md)
 - [RubrikRestApi.FilesetRestoreFileJobConfig](docs/FilesetRestoreFileJobConfig.md)
 - [RubrikRestApi.FilesetSnapshotDetail](docs/FilesetSnapshotDetail.md)
 - [RubrikRestApi.FilesetSnapshotSummary](docs/FilesetSnapshotSummary.md)
 - [RubrikRestApi.FilesetSnapshotVerbose](docs/FilesetSnapshotVerbose.md)
 - [RubrikRestApi.FilesetSummary](docs/FilesetSummary.md)
 - [RubrikRestApi.FilesetSummaryListResponse](docs/FilesetSummaryListResponse.md)
 - [RubrikRestApi.FilesetTemplateCreate](docs/FilesetTemplateCreate.md)
 - [RubrikRestApi.FilesetTemplateDetail](docs/FilesetTemplateDetail.md)
 - [RubrikRestApi.FilesetTemplateDetailListResponse](docs/FilesetTemplateDetailListResponse.md)
 - [RubrikRestApi.FilesetTemplatePatch](docs/FilesetTemplatePatch.md)
 - [RubrikRestApi.FilesetUpdate](docs/FilesetUpdate.md)
 - [RubrikRestApi.FipsStatus](docs/FipsStatus.md)
 - [RubrikRestApi.FipsStatusPatch](docs/FipsStatusPatch.md)
 - [RubrikRestApi.ForceFullVolumeInfo](docs/ForceFullVolumeInfo.md)
 - [RubrikRestApi.ForecastAssumptions](docs/ForecastAssumptions.md)
 - [RubrikRestApi.ForecastConsolidationFilter](docs/ForecastConsolidationFilter.md)
 - [RubrikRestApi.ForecastGranularity](docs/ForecastGranularity.md)
 - [RubrikRestApi.FrequencyChangeRates](docs/FrequencyChangeRates.md)
 - [RubrikRestApi.FrequencyConfig](docs/FrequencyConfig.md)
 - [RubrikRestApi.FullyQualifiedDomainNameInfo](docs/FullyQualifiedDomainNameInfo.md)
 - [RubrikRestApi.GenericCsrRequest](docs/GenericCsrRequest.md)
 - [RubrikRestApi.GlobalBlackoutWindowStatus](docs/GlobalBlackoutWindowStatus.md)
 - [RubrikRestApi.HdfsBaseConfig](docs/HdfsBaseConfig.md)
 - [RubrikRestApi.HdfsConfig](docs/HdfsConfig.md)
 - [RubrikRestApi.HdfsCreate](docs/HdfsCreate.md)
 - [RubrikRestApi.HdfsDetail](docs/HdfsDetail.md)
 - [RubrikRestApi.HdfsExportFileJobConfig](docs/HdfsExportFileJobConfig.md)
 - [RubrikRestApi.HdfsHost](docs/HdfsHost.md)
 - [RubrikRestApi.HdfsRestoreFileJobConfig](docs/HdfsRestoreFileJobConfig.md)
 - [RubrikRestApi.HdfsSnapshotDetail](docs/HdfsSnapshotDetail.md)
 - [RubrikRestApi.HdfsSnapshotSummary](docs/HdfsSnapshotSummary.md)
 - [RubrikRestApi.HdfsSummary](docs/HdfsSummary.md)
 - [RubrikRestApi.HdfsSummaryListResponse](docs/HdfsSummaryListResponse.md)
 - [RubrikRestApi.HdfsTemplateCreate](docs/HdfsTemplateCreate.md)
 - [RubrikRestApi.HdfsTemplateDetail](docs/HdfsTemplateDetail.md)
 - [RubrikRestApi.HdfsTemplateDetailListResponse](docs/HdfsTemplateDetailListResponse.md)
 - [RubrikRestApi.HdfsTemplatePatch](docs/HdfsTemplatePatch.md)
 - [RubrikRestApi.HdfsUpdate](docs/HdfsUpdate.md)
 - [RubrikRestApi.HealthMonitorPolicy](docs/HealthMonitorPolicy.md)
 - [RubrikRestApi.HierarchyObjectIds](docs/HierarchyObjectIds.md)
 - [RubrikRestApi.HoldConfig](docs/HoldConfig.md)
 - [RubrikRestApi.HostConfigurationPropertyEnabled](docs/HostConfigurationPropertyEnabled.md)
 - [RubrikRestApi.HostDetail](docs/HostDetail.md)
 - [RubrikRestApi.HostFilterStatus](docs/HostFilterStatus.md)
 - [RubrikRestApi.HostGroupInfo](docs/HostGroupInfo.md)
 - [RubrikRestApi.HostHierarchyObjectDescendantCount](docs/HostHierarchyObjectDescendantCount.md)
 - [RubrikRestApi.HostHierarchyObjectSortAttribute](docs/HostHierarchyObjectSortAttribute.md)
 - [RubrikRestApi.HostHierarchyObjectSummary](docs/HostHierarchyObjectSummary.md)
 - [RubrikRestApi.HostHierarchyObjectSummaryListResponse](docs/HostHierarchyObjectSummaryListResponse.md)
 - [RubrikRestApi.HostInfo](docs/HostInfo.md)
 - [RubrikRestApi.HostMakePrimaryRequest](docs/HostMakePrimaryRequest.md)
 - [RubrikRestApi.HostObjectType](docs/HostObjectType.md)
 - [RubrikRestApi.HostOperatingSystemType](docs/HostOperatingSystemType.md)
 - [RubrikRestApi.HostRbsStatus](docs/HostRbsStatus.md)
 - [RubrikRestApi.HostRegister](docs/HostRegister.md)
 - [RubrikRestApi.HostShareDetail](docs/HostShareDetail.md)
 - [RubrikRestApi.HostShareParameters](docs/HostShareParameters.md)
 - [RubrikRestApi.HostSharePatch](docs/HostSharePatch.md)
 - [RubrikRestApi.HostShareUpdate](docs/HostShareUpdate.md)
 - [RubrikRestApi.HostShareVendorType](docs/HostShareVendorType.md)
 - [RubrikRestApi.HostSummary](docs/HostSummary.md)
 - [RubrikRestApi.HostSummaryListResponse](docs/HostSummaryListResponse.md)
 - [RubrikRestApi.HostUiFilterStatus](docs/HostUiFilterStatus.md)
 - [RubrikRestApi.HostUpdate](docs/HostUpdate.md)
 - [RubrikRestApi.HostVfdInstallConfig](docs/HostVfdInstallConfig.md)
 - [RubrikRestApi.HostVfdState](docs/HostVfdState.md)
 - [RubrikRestApi.HostVolumeSummary](docs/HostVolumeSummary.md)
 - [RubrikRestApi.HostVolumeSummaryListResponse](docs/HostVolumeSummaryListResponse.md)
 - [RubrikRestApi.HotAddBandwidthInfo](docs/HotAddBandwidthInfo.md)
 - [RubrikRestApi.HotAddNetworkConfigWithId](docs/HotAddNetworkConfigWithId.md)
 - [RubrikRestApi.HotAddNetworkConfigWithName](docs/HotAddNetworkConfigWithName.md)
 - [RubrikRestApi.HotAddProxiesNeededInfo](docs/HotAddProxiesNeededInfo.md)
 - [RubrikRestApi.HotAddProxyVmInfo](docs/HotAddProxyVmInfo.md)
 - [RubrikRestApi.HotAddProxyVmInfoListResponse](docs/HotAddProxyVmInfoListResponse.md)
 - [RubrikRestApi.HotAddProxyVmStatusType](docs/HotAddProxyVmStatusType.md)
 - [RubrikRestApi.HypervVirtualDiskForceFullInfo](docs/HypervVirtualDiskForceFullInfo.md)
 - [RubrikRestApi.HypervVirtualMachineForceFullRequest](docs/HypervVirtualMachineForceFullRequest.md)
 - [RubrikRestApi.HypervVirtualMachineForceFullResponse](docs/HypervVirtualMachineForceFullResponse.md)
 - [RubrikRestApi.HypervVmSlaObjectCount](docs/HypervVmSlaObjectCount.md)
 - [RubrikRestApi.IdNamePair](docs/IdNamePair.md)
 - [RubrikRestApi.IdProviderAuthDomainInfo](docs/IdProviderAuthDomainInfo.md)
 - [RubrikRestApi.IdProviderAuthDomainInfoUpdate](docs/IdProviderAuthDomainInfoUpdate.md)
 - [RubrikRestApi.IdProviderAuthDomainSummary](docs/IdProviderAuthDomainSummary.md)
 - [RubrikRestApi.IdProviderAuthDomainSummaryListResponse](docs/IdProviderAuthDomainSummaryListResponse.md)
 - [RubrikRestApi.IdProviderSamlInfo](docs/IdProviderSamlInfo.md)
 - [RubrikRestApi.IdProviderSamlInfoUpdate](docs/IdProviderSamlInfoUpdate.md)
 - [RubrikRestApi.InstantRecoveryJobConfig](docs/InstantRecoveryJobConfig.md)
 - [RubrikRestApi.InternalJobInstanceDetail](docs/InternalJobInstanceDetail.md)
 - [RubrikRestApi.IoFilterStatus](docs/IoFilterStatus.md)
 - [RubrikRestApi.IoFilterSummary](docs/IoFilterSummary.md)
 - [RubrikRestApi.IoFilterSummaryListResponse](docs/IoFilterSummaryListResponse.md)
 - [RubrikRestApi.JobMonitoringCsvDownloadResponse](docs/JobMonitoringCsvDownloadResponse.md)
 - [RubrikRestApi.JobMonitoringInfo](docs/JobMonitoringInfo.md)
 - [RubrikRestApi.JobMonitoringJobProgressInfo](docs/JobMonitoringJobProgressInfo.md)
 - [RubrikRestApi.JobMonitoringObjectsCountByState](docs/JobMonitoringObjectsCountByState.md)
 - [RubrikRestApi.JobMonitoringObjectsCountByType](docs/JobMonitoringObjectsCountByType.md)
 - [RubrikRestApi.JobMonitoringResponse](docs/JobMonitoringResponse.md)
 - [RubrikRestApi.JobMonitoringRetryStatus](docs/JobMonitoringRetryStatus.md)
 - [RubrikRestApi.JobMonitoringState](docs/JobMonitoringState.md)
 - [RubrikRestApi.JobMonitoringStatus](docs/JobMonitoringStatus.md)
 - [RubrikRestApi.JobMonitoringStream](docs/JobMonitoringStream.md)
 - [RubrikRestApi.JobMonitoringStreamingResponse](docs/JobMonitoringStreamingResponse.md)
 - [RubrikRestApi.JobMonitoringSummaryByState](docs/JobMonitoringSummaryByState.md)
 - [RubrikRestApi.JobMonitoringSummaryByType](docs/JobMonitoringSummaryByType.md)
 - [RubrikRestApi.JobMonitoringTaskType](docs/JobMonitoringTaskType.md)
 - [RubrikRestApi.JobScheduledResponse](docs/JobScheduledResponse.md)
 - [RubrikRestApi.KmipClientConfiguration](docs/KmipClientConfiguration.md)
 - [RubrikRestApi.KmipClientDetail](docs/KmipClientDetail.md)
 - [RubrikRestApi.KmipServerConfiguration](docs/KmipServerConfiguration.md)
 - [RubrikRestApi.KmipServerDetail](docs/KmipServerDetail.md)
 - [RubrikRestApi.KuprHostRegister](docs/KuprHostRegister.md)
 - [RubrikRestApi.KuprHostUpdate](docs/KuprHostUpdate.md)
 - [RubrikRestApi.LdapDomainName](docs/LdapDomainName.md)
 - [RubrikRestApi.LdapDomainNameListResponse](docs/LdapDomainNameListResponse.md)
 - [RubrikRestApi.LdapServiceInfo](docs/LdapServiceInfo.md)
 - [RubrikRestApi.LdapServiceInfoUpdate](docs/LdapServiceInfoUpdate.md)
 - [RubrikRestApi.LdapServiceSummary](docs/LdapServiceSummary.md)
 - [RubrikRestApi.LdapServiceSummaryListResponse](docs/LdapServiceSummaryListResponse.md)
 - [RubrikRestApi.LegalHoldDownloadConfig](docs/LegalHoldDownloadConfig.md)
 - [RubrikRestApi.LegalHoldObjectSortAttribute](docs/LegalHoldObjectSortAttribute.md)
 - [RubrikRestApi.LegalHoldSnapshotSortAttribute](docs/LegalHoldSnapshotSortAttribute.md)
 - [RubrikRestApi.LegalHoldSummary](docs/LegalHoldSummary.md)
 - [RubrikRestApi.LegalHoldSummaryListResponse](docs/LegalHoldSummaryListResponse.md)
 - [RubrikRestApi.Link](docs/Link.md)
 - [RubrikRestApi.LocalUserAccountLockoutConfig](docs/LocalUserAccountLockoutConfig.md)
 - [RubrikRestApi.LocalUserAccountLockoutStatus](docs/LocalUserAccountLockoutStatus.md)
 - [RubrikRestApi.LocationPathPoint](docs/LocationPathPoint.md)
 - [RubrikRestApi.LsnRecoveryPoint](docs/LsnRecoveryPoint.md)
 - [RubrikRestApi.ManagedHierarchyObjectAncestor](docs/ManagedHierarchyObjectAncestor.md)
 - [RubrikRestApi.ManagedHierarchyObjectSummary](docs/ManagedHierarchyObjectSummary.md)
 - [RubrikRestApi.ManagedObjectDescendantCountVcdVappFields](docs/ManagedObjectDescendantCountVcdVappFields.md)
 - [RubrikRestApi.ManagedObjectPendingSlaInfo](docs/ManagedObjectPendingSlaInfo.md)
 - [RubrikRestApi.ManagedVolumeSlaObjectCount](docs/ManagedVolumeSlaObjectCount.md)
 - [RubrikRestApi.ManualDiscoveryNodeInfo](docs/ManualDiscoveryNodeInfo.md)
 - [RubrikRestApi.ManualDiscoveryNodeIpv4Info](docs/ManualDiscoveryNodeIpv4Info.md)
 - [RubrikRestApi.MfaServerConfig](docs/MfaServerConfig.md)
 - [RubrikRestApi.MissedSnapshot](docs/MissedSnapshot.md)
 - [RubrikRestApi.MissedSnapshotDayOfTimeUnit](docs/MissedSnapshotDayOfTimeUnit.md)
 - [RubrikRestApi.MissedSnapshotListResponse](docs/MissedSnapshotListResponse.md)
 - [RubrikRestApi.MissedSnapshotTimeUnitConfig](docs/MissedSnapshotTimeUnitConfig.md)
 - [RubrikRestApi.MonitoringEmailSubscriptionRequest](docs/MonitoringEmailSubscriptionRequest.md)
 - [RubrikRestApi.MonitoringEmailSubscriptionUpdate](docs/MonitoringEmailSubscriptionUpdate.md)
 - [RubrikRestApi.MonitoringRowType](docs/MonitoringRowType.md)
 - [RubrikRestApi.MonitoringSubscriptionSummary](docs/MonitoringSubscriptionSummary.md)
 - [RubrikRestApi.MonthlyConfig](docs/MonthlyConfig.md)
 - [RubrikRestApi.MountExportSnapshotJobCommonOptions](docs/MountExportSnapshotJobCommonOptions.md)
 - [RubrikRestApi.MountMssqlDbConfig](docs/MountMssqlDbConfig.md)
 - [RubrikRestApi.MountSnapshotJobConfigForBatchV1](docs/MountSnapshotJobConfigForBatchV1.md)
 - [RubrikRestApi.MountSnapshotJobConfigV1](docs/MountSnapshotJobConfigV1.md)
 - [RubrikRestApi.MssqlAvailabilityGroupDetail](docs/MssqlAvailabilityGroupDetail.md)
 - [RubrikRestApi.MssqlAvailabilityGroupSummary](docs/MssqlAvailabilityGroupSummary.md)
 - [RubrikRestApi.MssqlAvailabilityGroupSummaryListResponse](docs/MssqlAvailabilityGroupSummaryListResponse.md)
 - [RubrikRestApi.MssqlAvailabilityGroupUpdate](docs/MssqlAvailabilityGroupUpdate.md)
 - [RubrikRestApi.MssqlBackup](docs/MssqlBackup.md)
 - [RubrikRestApi.MssqlBackupJobConfig](docs/MssqlBackupJobConfig.md)
 - [RubrikRestApi.MssqlBackupSelection](docs/MssqlBackupSelection.md)
 - [RubrikRestApi.MssqlBackupType](docs/MssqlBackupType.md)
 - [RubrikRestApi.MssqlBackups](docs/MssqlBackups.md)
 - [RubrikRestApi.MssqlBatchBackupCanceledSummary](docs/MssqlBatchBackupCanceledSummary.md)
 - [RubrikRestApi.MssqlBatchBackupFailureSummary](docs/MssqlBatchBackupFailureSummary.md)
 - [RubrikRestApi.MssqlBatchBackupJobConfig](docs/MssqlBatchBackupJobConfig.md)
 - [RubrikRestApi.MssqlBatchBackupSuccessSummary](docs/MssqlBatchBackupSuccessSummary.md)
 - [RubrikRestApi.MssqlBatchBackupSummary](docs/MssqlBatchBackupSummary.md)
 - [RubrikRestApi.MssqlCbtEffectiveStatusType](docs/MssqlCbtEffectiveStatusType.md)
 - [RubrikRestApi.MssqlCbtStatusType](docs/MssqlCbtStatusType.md)
 - [RubrikRestApi.MssqlDatabaseFileType](docs/MssqlDatabaseFileType.md)
 - [RubrikRestApi.MssqlDatabaseListSortAttribute](docs/MssqlDatabaseListSortAttribute.md)
 - [RubrikRestApi.MssqlDatabaseRecoveryModel](docs/MssqlDatabaseRecoveryModel.md)
 - [RubrikRestApi.MssqlDbDefaults](docs/MssqlDbDefaults.md)
 - [RubrikRestApi.MssqlDbDefaultsUpdate](docs/MssqlDbDefaultsUpdate.md)
 - [RubrikRestApi.MssqlDbDetail](docs/MssqlDbDetail.md)
 - [RubrikRestApi.MssqlDbFileExportPath](docs/MssqlDbFileExportPath.md)
 - [RubrikRestApi.MssqlDbReplica](docs/MssqlDbReplica.md)
 - [RubrikRestApi.MssqlDbReplicaAvailabilityInfo](docs/MssqlDbReplicaAvailabilityInfo.md)
 - [RubrikRestApi.MssqlDbSlaObjectCount](docs/MssqlDbSlaObjectCount.md)
 - [RubrikRestApi.MssqlDbSnapshotDetail](docs/MssqlDbSnapshotDetail.md)
 - [RubrikRestApi.MssqlDbSnapshotSummary](docs/MssqlDbSnapshotSummary.md)
 - [RubrikRestApi.MssqlDbSnapshotSummaryListResponse](docs/MssqlDbSnapshotSummaryListResponse.md)
 - [RubrikRestApi.MssqlDbSummary](docs/MssqlDbSummary.md)
 - [RubrikRestApi.MssqlDbSummaryListResponse](docs/MssqlDbSummaryListResponse.md)
 - [RubrikRestApi.MssqlDbUpdate](docs/MssqlDbUpdate.md)
 - [RubrikRestApi.MssqlDbUpdateId](docs/MssqlDbUpdateId.md)
 - [RubrikRestApi.MssqlDownloadFromArchiveConfig](docs/MssqlDownloadFromArchiveConfig.md)
 - [RubrikRestApi.MssqlHierarchyObjectDescendantCount](docs/MssqlHierarchyObjectDescendantCount.md)
 - [RubrikRestApi.MssqlHierarchyObjectSummary](docs/MssqlHierarchyObjectSummary.md)
 - [RubrikRestApi.MssqlHierarchyObjectSummaryListResponse](docs/MssqlHierarchyObjectSummaryListResponse.md)
 - [RubrikRestApi.MssqlHierarchyObjectType](docs/MssqlHierarchyObjectType.md)
 - [RubrikRestApi.MssqlHostCbtEffectiveStatusType](docs/MssqlHostCbtEffectiveStatusType.md)
 - [RubrikRestApi.MssqlHostCbtStatusType](docs/MssqlHostCbtStatusType.md)
 - [RubrikRestApi.MssqlHostConfiguration](docs/MssqlHostConfiguration.md)
 - [RubrikRestApi.MssqlHostConfigurationWithHostId](docs/MssqlHostConfigurationWithHostId.md)
 - [RubrikRestApi.MssqlHostConfigurationWithHostIdListResponse](docs/MssqlHostConfigurationWithHostIdListResponse.md)
 - [RubrikRestApi.MssqlInstanceDetail](docs/MssqlInstanceDetail.md)
 - [RubrikRestApi.MssqlInstanceShortSummary](docs/MssqlInstanceShortSummary.md)
 - [RubrikRestApi.MssqlInstanceSummary](docs/MssqlInstanceSummary.md)
 - [RubrikRestApi.MssqlInstanceSummaryListResponse](docs/MssqlInstanceSummaryListResponse.md)
 - [RubrikRestApi.MssqlInstanceUpdate](docs/MssqlInstanceUpdate.md)
 - [RubrikRestApi.MssqlLogShippingCreateConfig](docs/MssqlLogShippingCreateConfig.md)
 - [RubrikRestApi.MssqlLogShippingDetail](docs/MssqlLogShippingDetail.md)
 - [RubrikRestApi.MssqlLogShippingLinks](docs/MssqlLogShippingLinks.md)
 - [RubrikRestApi.MssqlLogShippingListSortAttribute](docs/MssqlLogShippingListSortAttribute.md)
 - [RubrikRestApi.MssqlLogShippingOkState](docs/MssqlLogShippingOkState.md)
 - [RubrikRestApi.MssqlLogShippingReseedConfig](docs/MssqlLogShippingReseedConfig.md)
 - [RubrikRestApi.MssqlLogShippingStatus](docs/MssqlLogShippingStatus.md)
 - [RubrikRestApi.MssqlLogShippingStatusInfo](docs/MssqlLogShippingStatusInfo.md)
 - [RubrikRestApi.MssqlLogShippingSummary](docs/MssqlLogShippingSummary.md)
 - [RubrikRestApi.MssqlLogShippingSummaryListResponse](docs/MssqlLogShippingSummaryListResponse.md)
 - [RubrikRestApi.MssqlLogShippingTargetStateOptions](docs/MssqlLogShippingTargetStateOptions.md)
 - [RubrikRestApi.MssqlLogShippingUpdate](docs/MssqlLogShippingUpdate.md)
 - [RubrikRestApi.MssqlMissedRecoverableRange](docs/MssqlMissedRecoverableRange.md)
 - [RubrikRestApi.MssqlMissedRecoverableRangeError](docs/MssqlMissedRecoverableRangeError.md)
 - [RubrikRestApi.MssqlMissedRecoverableRangeListResponse](docs/MssqlMissedRecoverableRangeListResponse.md)
 - [RubrikRestApi.MssqlMountDetail](docs/MssqlMountDetail.md)
 - [RubrikRestApi.MssqlMountLinks](docs/MssqlMountLinks.md)
 - [RubrikRestApi.MssqlMountSummary](docs/MssqlMountSummary.md)
 - [RubrikRestApi.MssqlMountSummaryListResponse](docs/MssqlMountSummaryListResponse.md)
 - [RubrikRestApi.MssqlRecoverableRange](docs/MssqlRecoverableRange.md)
 - [RubrikRestApi.MssqlRecoverableRangeListResponse](docs/MssqlRecoverableRangeListResponse.md)
 - [RubrikRestApi.MssqlRecoveryPoint](docs/MssqlRecoveryPoint.md)
 - [RubrikRestApi.MssqlRestoreEstimateResult](docs/MssqlRestoreEstimateResult.md)
 - [RubrikRestApi.MssqlRestoreFile](docs/MssqlRestoreFile.md)
 - [RubrikRestApi.MssqlRootProperties](docs/MssqlRootProperties.md)
 - [RubrikRestApi.MssqlScriptDetail](docs/MssqlScriptDetail.md)
 - [RubrikRestApi.MssqlSlaDomainAssignInfo](docs/MssqlSlaDomainAssignInfo.md)
 - [RubrikRestApi.MssqlSlaDomainInfo](docs/MssqlSlaDomainInfo.md)
 - [RubrikRestApi.MssqlSlaPatchProperties](docs/MssqlSlaPatchProperties.md)
 - [RubrikRestApi.MssqlSlaRelatedProperties](docs/MssqlSlaRelatedProperties.md)
 - [RubrikRestApi.MssqlSnappableId](docs/MssqlSnappableId.md)
 - [RubrikRestApi.NasBaseConfig](docs/NasBaseConfig.md)
 - [RubrikRestApi.NasConfig](docs/NasConfig.md)
 - [RubrikRestApi.NasSharesToAdd](docs/NasSharesToAdd.md)
 - [RubrikRestApi.NasVendorType](docs/NasVendorType.md)
 - [RubrikRestApi.NetworkInfo](docs/NetworkInfo.md)
 - [RubrikRestApi.NetworkInfoListResponse](docs/NetworkInfoListResponse.md)
 - [RubrikRestApi.NodeHostnameInfo](docs/NodeHostnameInfo.md)
 - [RubrikRestApi.NodeHostnameInfoListResponse](docs/NodeHostnameInfoListResponse.md)
 - [RubrikRestApi.NodeId](docs/NodeId.md)
 - [RubrikRestApi.NodePolicyCheckResult](docs/NodePolicyCheckResult.md)
 - [RubrikRestApi.NodeStatusEnum](docs/NodeStatusEnum.md)
 - [RubrikRestApi.NotificationConfig](docs/NotificationConfig.md)
 - [RubrikRestApi.NotificationDetails](docs/NotificationDetails.md)
 - [RubrikRestApi.NotificationTypeEnum](docs/NotificationTypeEnum.md)
 - [RubrikRestApi.NutanixVmSlaObjectCount](docs/NutanixVmSlaObjectCount.md)
 - [RubrikRestApi.ObjectHoldSummary](docs/ObjectHoldSummary.md)
 - [RubrikRestApi.ObjectHoldSummaryListResponse](docs/ObjectHoldSummaryListResponse.md)
 - [RubrikRestApi.ObjectHolder](docs/ObjectHolder.md)
 - [RubrikRestApi.ObjectTypeV1](docs/ObjectTypeV1.md)
 - [RubrikRestApi.OperatingSystemFamily](docs/OperatingSystemFamily.md)
 - [RubrikRestApi.OperationMode](docs/OperationMode.md)
 - [RubrikRestApi.OracleAcoParameterDetail](docs/OracleAcoParameterDetail.md)
 - [RubrikRestApi.OracleAcoParameterList](docs/OracleAcoParameterList.md)
 - [RubrikRestApi.OracleAcoValidationResult](docs/OracleAcoValidationResult.md)
 - [RubrikRestApi.OracleAcoValueErrorDetail](docs/OracleAcoValueErrorDetail.md)
 - [RubrikRestApi.OracleBulkUpdate](docs/OracleBulkUpdate.md)
 - [RubrikRestApi.OracleDataGuardGroupUpdate](docs/OracleDataGuardGroupUpdate.md)
 - [RubrikRestApi.OracleDbDetail](docs/OracleDbDetail.md)
 - [RubrikRestApi.OracleDbSummary](docs/OracleDbSummary.md)
 - [RubrikRestApi.OracleDbSummaryListResponse](docs/OracleDbSummaryListResponse.md)
 - [RubrikRestApi.OracleFileDownloadLink](docs/OracleFileDownloadLink.md)
 - [RubrikRestApi.OracleHostDetail](docs/OracleHostDetail.md)
 - [RubrikRestApi.OracleHostSummary](docs/OracleHostSummary.md)
 - [RubrikRestApi.OracleInstanceProperties](docs/OracleInstanceProperties.md)
 - [RubrikRestApi.OracleLastValidationResult](docs/OracleLastValidationResult.md)
 - [RubrikRestApi.OracleNodeOrder](docs/OracleNodeOrder.md)
 - [RubrikRestApi.OracleNodeProperties](docs/OracleNodeProperties.md)
 - [RubrikRestApi.OracleNonSlaProperties](docs/OracleNonSlaProperties.md)
 - [RubrikRestApi.OracleRacDetail](docs/OracleRacDetail.md)
 - [RubrikRestApi.OracleRacSummary](docs/OracleRacSummary.md)
 - [RubrikRestApi.OracleRecoveryApiValidationErrors](docs/OracleRecoveryApiValidationErrors.md)
 - [RubrikRestApi.OracleRecoveryPoint](docs/OracleRecoveryPoint.md)
 - [RubrikRestApi.OracleRestoreEstimateResult](docs/OracleRestoreEstimateResult.md)
 - [RubrikRestApi.OracleUpdate](docs/OracleUpdate.md)
 - [RubrikRestApi.OracleUpdateCommon](docs/OracleUpdateCommon.md)
 - [RubrikRestApi.OracleValidateConfig](docs/OracleValidateConfig.md)
 - [RubrikRestApi.ParentAppInfo](docs/ParentAppInfo.md)
 - [RubrikRestApi.PasswordRequirementsPatchRequest](docs/PasswordRequirementsPatchRequest.md)
 - [RubrikRestApi.PasswordRequirementsSummary](docs/PasswordRequirementsSummary.md)
 - [RubrikRestApi.PatternStatus](docs/PatternStatus.md)
 - [RubrikRestApi.PerLocationCloudOutForecastSummary](docs/PerLocationCloudOutForecastSummary.md)
 - [RubrikRestApi.PerStorageClassCloudOutStorageForecastSummary](docs/PerStorageClassCloudOutStorageForecastSummary.md)
 - [RubrikRestApi.PolicyCheckResult](docs/PolicyCheckResult.md)
 - [RubrikRestApi.PolicyScopeEnum](docs/PolicyScopeEnum.md)
 - [RubrikRestApi.PolicyTypeEnum](docs/PolicyTypeEnum.md)
 - [RubrikRestApi.PrecheckFailureResult](docs/PrecheckFailureResult.md)
 - [RubrikRestApi.PrecheckStatusNextRunInfo](docs/PrecheckStatusNextRunInfo.md)
 - [RubrikRestApi.PrecheckStatusResponse](docs/PrecheckStatusResponse.md)
 - [RubrikRestApi.PreferredCdpNetworkProtocol](docs/PreferredCdpNetworkProtocol.md)
 - [RubrikRestApi.PreferredCdpNetworkProtocolObject](docs/PreferredCdpNetworkProtocolObject.md)
 - [RubrikRestApi.PrincipalSearchSortAttribute](docs/PrincipalSearchSortAttribute.md)
 - [RubrikRestApi.PrincipalSummaryV1](docs/PrincipalSummaryV1.md)
 - [RubrikRestApi.PrincipalSummaryV1ListResponse](docs/PrincipalSummaryV1ListResponse.md)
 - [RubrikRestApi.PrincipalType](docs/PrincipalType.md)
 - [RubrikRestApi.PrincipalWithRoleInfo](docs/PrincipalWithRoleInfo.md)
 - [RubrikRestApi.ProtectedObjectsCount](docs/ProtectedObjectsCount.md)
 - [RubrikRestApi.QuarterlyConfig](docs/QuarterlyConfig.md)
 - [RubrikRestApi.RbsHostOperationRequest](docs/RbsHostOperationRequest.md)
 - [RubrikRestApi.RbsHostOperationResponse](docs/RbsHostOperationResponse.md)
 - [RubrikRestApi.RbsHostSummary](docs/RbsHostSummary.md)
 - [RubrikRestApi.RbsHostUserConfig](docs/RbsHostUserConfig.md)
 - [RubrikRestApi.ReaderRefreshDataSourcesRequest](docs/ReaderRefreshDataSourcesRequest.md)
 - [RubrikRestApi.RefreshableObjectConnectionStatus](docs/RefreshableObjectConnectionStatus.md)
 - [RubrikRestApi.RefreshableObjectConnectionStatusType](docs/RefreshableObjectConnectionStatusType.md)
 - [RubrikRestApi.RelocateMountConfig](docs/RelocateMountConfig.md)
 - [RubrikRestApi.RemediationRequest](docs/RemediationRequest.md)
 - [RubrikRestApi.RemediationRequestRunConfig](docs/RemediationRequestRunConfig.md)
 - [RubrikRestApi.RemediationRequestSpec](docs/RemediationRequestSpec.md)
 - [RubrikRestApi.RemediationResponse](docs/RemediationResponse.md)
 - [RubrikRestApi.ReplicationSpec](docs/ReplicationSpec.md)
 - [RubrikRestApi.ReplicationType](docs/ReplicationType.md)
 - [RubrikRestApi.ReportConfigPatch](docs/ReportConfigPatch.md)
 - [RubrikRestApi.ReportConfigResponse](docs/ReportConfigResponse.md)
 - [RubrikRestApi.ReportableObjectType](docs/ReportableObjectType.md)
 - [RubrikRestApi.RequestErrorInfo](docs/RequestErrorInfo.md)
 - [RubrikRestApi.RequestFailedException](docs/RequestFailedException.md)
 - [RubrikRestApi.ResourceTagDefinition](docs/ResourceTagDefinition.md)
 - [RubrikRestApi.ResourceTagDeleteResponse](docs/ResourceTagDeleteResponse.md)
 - [RubrikRestApi.ResourceTagDetail](docs/ResourceTagDetail.md)
 - [RubrikRestApi.ResourceTagGetResponse](docs/ResourceTagGetResponse.md)
 - [RubrikRestApi.ResourceTagUpdate](docs/ResourceTagUpdate.md)
 - [RubrikRestApi.RestoreFileJobConfig](docs/RestoreFileJobConfig.md)
 - [RubrikRestApi.RestoreMssqlDbJobConfig](docs/RestoreMssqlDbJobConfig.md)
 - [RubrikRestApi.RoleAssignmentRequest](docs/RoleAssignmentRequest.md)
 - [RubrikRestApi.RoleInfo](docs/RoleInfo.md)
 - [RubrikRestApi.RoleInfoCreate](docs/RoleInfoCreate.md)
 - [RubrikRestApi.RoleInfoListResponse](docs/RoleInfoListResponse.md)
 - [RubrikRestApi.RoleInfoUpdate](docs/RoleInfoUpdate.md)
 - [RubrikRestApi.RoleInfoWithPrincipals](docs/RoleInfoWithPrincipals.md)
 - [RubrikRestApi.RoleListSortAttributes](docs/RoleListSortAttributes.md)
 - [RubrikRestApi.RsaMfaServerConfig](docs/RsaMfaServerConfig.md)
 - [RubrikRestApi.RsaMfaServerConfigUpdate](docs/RsaMfaServerConfigUpdate.md)
 - [RubrikRestApi.RsaMfaServerConfigWithoutSecrets](docs/RsaMfaServerConfigWithoutSecrets.md)
 - [RubrikRestApi.RsaMfaServerDetail](docs/RsaMfaServerDetail.md)
 - [RubrikRestApi.RsaMfaServerDetailListResponse](docs/RsaMfaServerDetailListResponse.md)
 - [RubrikRestApi.RubrikMibFileDownloadLink](docs/RubrikMibFileDownloadLink.md)
 - [RubrikRestApi.RubrikSamlMetadataDetail](docs/RubrikSamlMetadataDetail.md)
 - [RubrikRestApi.RubrikSamlMetadataInfo](docs/RubrikSamlMetadataInfo.md)
 - [RubrikRestApi.RubrikSamlMetadataSummary](docs/RubrikSamlMetadataSummary.md)
 - [RubrikRestApi.RunPolicyArg](docs/RunPolicyArg.md)
 - [RubrikRestApi.SamlSsoAuthnRequestDetail](docs/SamlSsoAuthnRequestDetail.md)
 - [RubrikRestApi.SamlSsoAuthnRequestInfo](docs/SamlSsoAuthnRequestInfo.md)
 - [RubrikRestApi.SamlSsoStatus](docs/SamlSsoStatus.md)
 - [RubrikRestApi.SapHanaAddSystemResponse](docs/SapHanaAddSystemResponse.md)
 - [RubrikRestApi.SapHanaDataPathSpec](docs/SapHanaDataPathSpec.md)
 - [RubrikRestApi.SapHanaDataPathType](docs/SapHanaDataPathType.md)
 - [RubrikRestApi.SapHanaDatabaseDetail](docs/SapHanaDatabaseDetail.md)
 - [RubrikRestApi.SapHanaDatabaseListSortAttribute](docs/SapHanaDatabaseListSortAttribute.md)
 - [RubrikRestApi.SapHanaDatabasePatch](docs/SapHanaDatabasePatch.md)
 - [RubrikRestApi.SapHanaDatabaseSnapshotDetail](docs/SapHanaDatabaseSnapshotDetail.md)
 - [RubrikRestApi.SapHanaDatabaseSnapshotSummary](docs/SapHanaDatabaseSnapshotSummary.md)
 - [RubrikRestApi.SapHanaDatabaseSnapshotSummaryListResponse](docs/SapHanaDatabaseSnapshotSummaryListResponse.md)
 - [RubrikRestApi.SapHanaDatabaseSummary](docs/SapHanaDatabaseSummary.md)
 - [RubrikRestApi.SapHanaDatabaseSummaryListResponse](docs/SapHanaDatabaseSummaryListResponse.md)
 - [RubrikRestApi.SapHanaHost](docs/SapHanaHost.md)
 - [RubrikRestApi.SapHanaPatchSystemResponse](docs/SapHanaPatchSystemResponse.md)
 - [RubrikRestApi.SapHanaRecoverableRange](docs/SapHanaRecoverableRange.md)
 - [RubrikRestApi.SapHanaRecoverableRangeListResponse](docs/SapHanaRecoverableRangeListResponse.md)
 - [RubrikRestApi.SapHanaRestoreSourceConfig](docs/SapHanaRestoreSourceConfig.md)
 - [RubrikRestApi.SapHanaSslInfo](docs/SapHanaSslInfo.md)
 - [RubrikRestApi.SapHanaSystemConfig](docs/SapHanaSystemConfig.md)
 - [RubrikRestApi.SapHanaSystemDataPathSpec](docs/SapHanaSystemDataPathSpec.md)
 - [RubrikRestApi.SapHanaSystemInfo](docs/SapHanaSystemInfo.md)
 - [RubrikRestApi.SapHanaSystemListSortAttribute](docs/SapHanaSystemListSortAttribute.md)
 - [RubrikRestApi.SapHanaSystemPatch](docs/SapHanaSystemPatch.md)
 - [RubrikRestApi.SapHanaSystemSummary](docs/SapHanaSystemSummary.md)
 - [RubrikRestApi.SapHanaSystemSummaryListResponse](docs/SapHanaSystemSummaryListResponse.md)
 - [RubrikRestApi.ScriptErrorAction](docs/ScriptErrorAction.md)
 - [RubrikRestApi.SearchResponse](docs/SearchResponse.md)
 - [RubrikRestApi.SearchResponseListResponse](docs/SearchResponseListResponse.md)
 - [RubrikRestApi.SessionSummary](docs/SessionSummary.md)
 - [RubrikRestApi.SlaAssignable](docs/SlaAssignable.md)
 - [RubrikRestApi.SlaAssignment](docs/SlaAssignment.md)
 - [RubrikRestApi.SlaConflictsSummary](docs/SlaConflictsSummary.md)
 - [RubrikRestApi.SlaDayOfMonth](docs/SlaDayOfMonth.md)
 - [RubrikRestApi.SlaDayOfQuarter](docs/SlaDayOfQuarter.md)
 - [RubrikRestApi.SlaDayOfWeek](docs/SlaDayOfWeek.md)
 - [RubrikRestApi.SlaDayOfYear](docs/SlaDayOfYear.md)
 - [RubrikRestApi.SlaDomainDefinition](docs/SlaDomainDefinition.md)
 - [RubrikRestApi.SlaDomainPatchDefinition](docs/SlaDomainPatchDefinition.md)
 - [RubrikRestApi.SlaDomainSummary](docs/SlaDomainSummary.md)
 - [RubrikRestApi.SlaDomainSummaryListResponse](docs/SlaDomainSummaryListResponse.md)
 - [RubrikRestApi.SlaFrequency](docs/SlaFrequency.md)
 - [RubrikRestApi.SlaFrequencyV2](docs/SlaFrequencyV2.md)
 - [RubrikRestApi.SlaMonth](docs/SlaMonth.md)
 - [RubrikRestApi.SlaObjectCounts](docs/SlaObjectCounts.md)
 - [RubrikRestApi.SlaStartTimeAttributes](docs/SlaStartTimeAttributes.md)
 - [RubrikRestApi.SlaTimeUnit](docs/SlaTimeUnit.md)
 - [RubrikRestApi.Snappable](docs/Snappable.md)
 - [RubrikRestApi.SnappablePrivilegeStatus](docs/SnappablePrivilegeStatus.md)
 - [RubrikRestApi.SnappableRecoveryInfo](docs/SnappableRecoveryInfo.md)
 - [RubrikRestApi.SnapshotCloudStorageTier](docs/SnapshotCloudStorageTier.md)
 - [RubrikRestApi.SnapshotEventSeries](docs/SnapshotEventSeries.md)
 - [RubrikRestApi.SnapshotLocationRetentionInfo](docs/SnapshotLocationRetentionInfo.md)
 - [RubrikRestApi.SnapshotRetentionInfo](docs/SnapshotRetentionInfo.md)
 - [RubrikRestApi.SnapshotSortAttribute](docs/SnapshotSortAttribute.md)
 - [RubrikRestApi.SnapshotStorageStats](docs/SnapshotStorageStats.md)
 - [RubrikRestApi.SnapshotSummary](docs/SnapshotSummary.md)
 - [RubrikRestApi.SnapshotSummaryListResponse](docs/SnapshotSummaryListResponse.md)
 - [RubrikRestApi.SnapshotType](docs/SnapshotType.md)
 - [RubrikRestApi.SoftwareAvailability](docs/SoftwareAvailability.md)
 - [RubrikRestApi.SortColumn](docs/SortColumn.md)
 - [RubrikRestApi.SortOrder](docs/SortOrder.md)
 - [RubrikRestApi.StageCdmSoftwareInfo](docs/StageCdmSoftwareInfo.md)
 - [RubrikRestApi.StaticIpInfo](docs/StaticIpInfo.md)
 - [RubrikRestApi.Status](docs/Status.md)
 - [RubrikRestApi.StringResponse](docs/StringResponse.md)
 - [RubrikRestApi.SubscriptionAttachmentType](docs/SubscriptionAttachmentType.md)
 - [RubrikRestApi.SubscriptionOwner](docs/SubscriptionOwner.md)
 - [RubrikRestApi.SubscriptionScheduleTimeAttributes](docs/SubscriptionScheduleTimeAttributes.md)
 - [RubrikRestApi.SubscriptionStatus](docs/SubscriptionStatus.md)
 - [RubrikRestApi.SupportDataConfig](docs/SupportDataConfig.md)
 - [RubrikRestApi.SupportDataType](docs/SupportDataType.md)
 - [RubrikRestApi.SupportDataTypeConfig](docs/SupportDataTypeConfig.md)
 - [RubrikRestApi.SupportDataTypeStatus](docs/SupportDataTypeStatus.md)
 - [RubrikRestApi.SyslogExportRuleFull](docs/SyslogExportRuleFull.md)
 - [RubrikRestApi.SyslogExportRulePartial](docs/SyslogExportRulePartial.md)
 - [RubrikRestApi.SyslogExportRuleSummary](docs/SyslogExportRuleSummary.md)
 - [RubrikRestApi.SyslogExportRuleSummaryListResponse](docs/SyslogExportRuleSummaryListResponse.md)
 - [RubrikRestApi.SyslogFacility](docs/SyslogFacility.md)
 - [RubrikRestApi.SyslogMsgMibFileDownloadLink](docs/SyslogMsgMibFileDownloadLink.md)
 - [RubrikRestApi.SyslogServerTestResult](docs/SyslogServerTestResult.md)
 - [RubrikRestApi.SyslogSeverity](docs/SyslogSeverity.md)
 - [RubrikRestApi.SyslogTcMibFileDownloadLink](docs/SyslogTcMibFileDownloadLink.md)
 - [RubrikRestApi.TelemetryConfig](docs/TelemetryConfig.md)
 - [RubrikRestApi.TelemetryLevel](docs/TelemetryLevel.md)
 - [RubrikRestApi.TotpConfigUpdateRequest](docs/TotpConfigUpdateRequest.md)
 - [RubrikRestApi.TotpGlobalSetting](docs/TotpGlobalSetting.md)
 - [RubrikRestApi.TotpGlobalSettingUpdate](docs/TotpGlobalSettingUpdate.md)
 - [RubrikRestApi.TotpSecret](docs/TotpSecret.md)
 - [RubrikRestApi.TotpStatus](docs/TotpStatus.md)
 - [RubrikRestApi.TransportLayerProtocol](docs/TransportLayerProtocol.md)
 - [RubrikRestApi.TruststorePayload](docs/TruststorePayload.md)
 - [RubrikRestApi.TruststoreSummary](docs/TruststoreSummary.md)
 - [RubrikRestApi.TruststoreSummaryListResponse](docs/TruststoreSummaryListResponse.md)
 - [RubrikRestApi.TruststoreType](docs/TruststoreType.md)
 - [RubrikRestApi.UnmanagedObjectDetails](docs/UnmanagedObjectDetails.md)
 - [RubrikRestApi.UnmanagedObjectDetailsListResponse](docs/UnmanagedObjectDetailsListResponse.md)
 - [RubrikRestApi.UnmanagedObjectSlaAssignmentInfo](docs/UnmanagedObjectSlaAssignmentInfo.md)
 - [RubrikRestApi.UnmanagedObjectSortAttribute](docs/UnmanagedObjectSortAttribute.md)
 - [RubrikRestApi.UnmanagedObjectStatus](docs/UnmanagedObjectStatus.md)
 - [RubrikRestApi.UnmanagedObjectSummary](docs/UnmanagedObjectSummary.md)
 - [RubrikRestApi.UnmanagedObjectSummaryListResponse](docs/UnmanagedObjectSummaryListResponse.md)
 - [RubrikRestApi.UnmanagedObjectType](docs/UnmanagedObjectType.md)
 - [RubrikRestApi.UnmanagedSnapshotType](docs/UnmanagedSnapshotType.md)
 - [RubrikRestApi.UpdateMountConfig](docs/UpdateMountConfig.md)
 - [RubrikRestApi.UserActionV1](docs/UserActionV1.md)
 - [RubrikRestApi.VappAttributes](docs/VappAttributes.md)
 - [RubrikRestApi.VappExportMode](docs/VappExportMode.md)
 - [RubrikRestApi.VappExportOptions](docs/VappExportOptions.md)
 - [RubrikRestApi.VappExportSnapshotJobConfig](docs/VappExportSnapshotJobConfig.md)
 - [RubrikRestApi.VappInstantRecoveryJobConfig](docs/VappInstantRecoveryJobConfig.md)
 - [RubrikRestApi.VappInstantRecoveryOptions](docs/VappInstantRecoveryOptions.md)
 - [RubrikRestApi.VappNetworkMode](docs/VappNetworkMode.md)
 - [RubrikRestApi.VappNetworkSummary](docs/VappNetworkSummary.md)
 - [RubrikRestApi.VappTemplateExportJobConfig](docs/VappTemplateExportJobConfig.md)
 - [RubrikRestApi.VappTemplateExportOptions](docs/VappTemplateExportOptions.md)
 - [RubrikRestApi.VappTemplateExportOptionsUnion](docs/VappTemplateExportOptionsUnion.md)
 - [RubrikRestApi.VappVmDetail](docs/VappVmDetail.md)
 - [RubrikRestApi.VappVmIpAddressingMode](docs/VappVmIpAddressingMode.md)
 - [RubrikRestApi.VappVmNetworkConnection](docs/VappVmNetworkConnection.md)
 - [RubrikRestApi.VappVmRestoreSpec](docs/VappVmRestoreSpec.md)
 - [RubrikRestApi.VappVmSummary](docs/VappVmSummary.md)
 - [RubrikRestApi.VcdClusterBaseConfig](docs/VcdClusterBaseConfig.md)
 - [RubrikRestApi.VcdClusterConfig](docs/VcdClusterConfig.md)
 - [RubrikRestApi.VcdClusterDetail](docs/VcdClusterDetail.md)
 - [RubrikRestApi.VcdClusterListSortAttribute](docs/VcdClusterListSortAttribute.md)
 - [RubrikRestApi.VcdClusterPatch](docs/VcdClusterPatch.md)
 - [RubrikRestApi.VcdClusterSummary](docs/VcdClusterSummary.md)
 - [RubrikRestApi.VcdClusterSummaryListResponse](docs/VcdClusterSummaryListResponse.md)
 - [RubrikRestApi.VcdConnectionStatus](docs/VcdConnectionStatus.md)
 - [RubrikRestApi.VcdHierarchyObjectAttributes](docs/VcdHierarchyObjectAttributes.md)
 - [RubrikRestApi.VcdHierarchyObjectDescendantCount](docs/VcdHierarchyObjectDescendantCount.md)
 - [RubrikRestApi.VcdHierarchyObjectSortAttribute](docs/VcdHierarchyObjectSortAttribute.md)
 - [RubrikRestApi.VcdHierarchyObjectSummary](docs/VcdHierarchyObjectSummary.md)
 - [RubrikRestApi.VcdHierarchyObjectSummaryListResponse](docs/VcdHierarchyObjectSummaryListResponse.md)
 - [RubrikRestApi.VcdObjectType](docs/VcdObjectType.md)
 - [RubrikRestApi.VcdOrgVdcStorageProfile](docs/VcdOrgVdcStorageProfile.md)
 - [RubrikRestApi.VcdVappDetail](docs/VcdVappDetail.md)
 - [RubrikRestApi.VcdVappObjectSortAttribute](docs/VcdVappObjectSortAttribute.md)
 - [RubrikRestApi.VcdVappPatch](docs/VcdVappPatch.md)
 - [RubrikRestApi.VcdVappSlaObjectCount](docs/VcdVappSlaObjectCount.md)
 - [RubrikRestApi.VcdVappSnapshotDetail](docs/VcdVappSnapshotDetail.md)
 - [RubrikRestApi.VcdVappSnapshotSummary](docs/VcdVappSnapshotSummary.md)
 - [RubrikRestApi.VcdVappSnapshotSummaryDetailSharedFields](docs/VcdVappSnapshotSummaryDetailSharedFields.md)
 - [RubrikRestApi.VcdVappSnapshotSummaryListResponse](docs/VcdVappSnapshotSummaryListResponse.md)
 - [RubrikRestApi.VcdVappSummary](docs/VcdVappSummary.md)
 - [RubrikRestApi.VcdVappSummaryListResponse](docs/VcdVappSummaryListResponse.md)
 - [RubrikRestApi.VcdVmSnapshotDetail](docs/VcdVmSnapshotDetail.md)
 - [RubrikRestApi.VcdVmSnapshotSummary](docs/VcdVmSnapshotSummary.md)
 - [RubrikRestApi.VcenterConfig](docs/VcenterConfig.md)
 - [RubrikRestApi.VcenterConnectionConfig](docs/VcenterConnectionConfig.md)
 - [RubrikRestApi.VcenterDetail](docs/VcenterDetail.md)
 - [RubrikRestApi.VcenterPatch](docs/VcenterPatch.md)
 - [RubrikRestApi.VcenterPreAddConfig](docs/VcenterPreAddConfig.md)
 - [RubrikRestApi.VcenterPreAddInfo](docs/VcenterPreAddInfo.md)
 - [RubrikRestApi.VcenterSummary](docs/VcenterSummary.md)
 - [RubrikRestApi.VcenterSummaryListResponse](docs/VcenterSummaryListResponse.md)
 - [RubrikRestApi.VerificationParameters](docs/VerificationParameters.md)
 - [RubrikRestApi.VerificationResponse](docs/VerificationResponse.md)
 - [RubrikRestApi.VimserverSummary](docs/VimserverSummary.md)
 - [RubrikRestApi.VimserverSummaryListResponse](docs/VimserverSummaryListResponse.md)
 - [RubrikRestApi.VirtualDiskDetail](docs/VirtualDiskDetail.md)
 - [RubrikRestApi.VirtualDiskUpdate](docs/VirtualDiskUpdate.md)
 - [RubrikRestApi.VirtualMachineDetail](docs/VirtualMachineDetail.md)
 - [RubrikRestApi.VirtualMachineScriptDetail](docs/VirtualMachineScriptDetail.md)
 - [RubrikRestApi.VirtualMachineSummary](docs/VirtualMachineSummary.md)
 - [RubrikRestApi.VirtualMachineSummaryListResponse](docs/VirtualMachineSummaryListResponse.md)
 - [RubrikRestApi.VirtualMachineUpdate](docs/VirtualMachineUpdate.md)
 - [RubrikRestApi.VirtualMachineUpdateWithSecret](docs/VirtualMachineUpdateWithSecret.md)
 - [RubrikRestApi.VmForceFullRequest](docs/VmForceFullRequest.md)
 - [RubrikRestApi.VmForceFullResponse](docs/VmForceFullResponse.md)
 - [RubrikRestApi.VmGuestScriptRunConfig](docs/VmGuestScriptRunConfig.md)
 - [RubrikRestApi.VmPathPoint](docs/VmPathPoint.md)
 - [RubrikRestApi.VmSnapshotDetail](docs/VmSnapshotDetail.md)
 - [RubrikRestApi.VmSnapshotDiskDetail](docs/VmSnapshotDiskDetail.md)
 - [RubrikRestApi.VmSnapshotSummaries](docs/VmSnapshotSummaries.md)
 - [RubrikRestApi.VmSnapshotSummary](docs/VmSnapshotSummary.md)
 - [RubrikRestApi.VmSnapshotSummaryListResponse](docs/VmSnapshotSummaryListResponse.md)
 - [RubrikRestApi.VmwareAdaptiveThrottlingSettings](docs/VmwareAdaptiveThrottlingSettings.md)
 - [RubrikRestApi.VmwareCdpLiveInfo](docs/VmwareCdpLiveInfo.md)
 - [RubrikRestApi.VmwareCdpStateInfo](docs/VmwareCdpStateInfo.md)
 - [RubrikRestApi.VmwareHierarchyInfo](docs/VmwareHierarchyInfo.md)
 - [RubrikRestApi.VmwareHierarchyInfoListResponse](docs/VmwareHierarchyInfoListResponse.md)
 - [RubrikRestApi.VmwareHierarchyObjectType](docs/VmwareHierarchyObjectType.md)
 - [RubrikRestApi.VmwareHostDatastoreDetail](docs/VmwareHostDatastoreDetail.md)
 - [RubrikRestApi.VmwareHostDetail](docs/VmwareHostDetail.md)
 - [RubrikRestApi.VmwareHostSummary](docs/VmwareHostSummary.md)
 - [RubrikRestApi.VmwareHostSummaryListResponse](docs/VmwareHostSummaryListResponse.md)
 - [RubrikRestApi.VmwareHostUpdate](docs/VmwareHostUpdate.md)
 - [RubrikRestApi.VmwareNetworkCollection](docs/VmwareNetworkCollection.md)
 - [RubrikRestApi.VmwareNetworkDeviceInfo](docs/VmwareNetworkDeviceInfo.md)
 - [RubrikRestApi.VmwareNetworkInfo](docs/VmwareNetworkInfo.md)
 - [RubrikRestApi.VmwareNetworkType](docs/VmwareNetworkType.md)
 - [RubrikRestApi.VmwareRecoverableRange](docs/VmwareRecoverableRange.md)
 - [RubrikRestApi.VmwareRecoverableRangeListResponse](docs/VmwareRecoverableRangeListResponse.md)
 - [RubrikRestApi.VmwareVNicBindingInfo](docs/VmwareVNicBindingInfo.md)
 - [RubrikRestApi.VmwareVdiskForceFullInfo](docs/VmwareVdiskForceFullInfo.md)
 - [RubrikRestApi.VmwareVmMissedRecoverableRanges](docs/VmwareVmMissedRecoverableRanges.md)
 - [RubrikRestApi.VmwareVmMountDetailV1](docs/VmwareVmMountDetailV1.md)
 - [RubrikRestApi.VmwareVmMountSummaryV1](docs/VmwareVmMountSummaryV1.md)
 - [RubrikRestApi.VmwareVmMountSummaryV1ListResponse](docs/VmwareVmMountSummaryV1ListResponse.md)
 - [RubrikRestApi.VmwareVmRecoverableRanges](docs/VmwareVmRecoverableRanges.md)
 - [RubrikRestApi.VolumeGroupDetail](docs/VolumeGroupDetail.md)
 - [RubrikRestApi.VolumeGroupForceFullRequest](docs/VolumeGroupForceFullRequest.md)
 - [RubrikRestApi.VolumeGroupForceFullResponse](docs/VolumeGroupForceFullResponse.md)
 - [RubrikRestApi.VolumeGroupListSortAttribute](docs/VolumeGroupListSortAttribute.md)
 - [RubrikRestApi.VolumeGroupMountListSortAttribute](docs/VolumeGroupMountListSortAttribute.md)
 - [RubrikRestApi.VolumeGroupMountSummary](docs/VolumeGroupMountSummary.md)
 - [RubrikRestApi.VolumeGroupMountSummaryListResponse](docs/VolumeGroupMountSummaryListResponse.md)
 - [RubrikRestApi.VolumeGroupOnDemandSnapshotConfig](docs/VolumeGroupOnDemandSnapshotConfig.md)
 - [RubrikRestApi.VolumeGroupPatch](docs/VolumeGroupPatch.md)
 - [RubrikRestApi.VolumeGroupReleaseVersion](docs/VolumeGroupReleaseVersion.md)
 - [RubrikRestApi.VolumeGroupRestoreVolumeSpec](docs/VolumeGroupRestoreVolumeSpec.md)
 - [RubrikRestApi.VolumeGroupRestoreVolumesConfig](docs/VolumeGroupRestoreVolumesConfig.md)
 - [RubrikRestApi.VolumeGroupSnapshotDetail](docs/VolumeGroupSnapshotDetail.md)
 - [RubrikRestApi.VolumeGroupSnapshotSummary](docs/VolumeGroupSnapshotSummary.md)
 - [RubrikRestApi.VolumeGroupSnapshotSummaryListResponse](docs/VolumeGroupSnapshotSummaryListResponse.md)
 - [RubrikRestApi.VolumeGroupSnapshotVolumeSummary](docs/VolumeGroupSnapshotVolumeSummary.md)
 - [RubrikRestApi.VolumeGroupSummary](docs/VolumeGroupSummary.md)
 - [RubrikRestApi.VolumeGroupSummaryListResponse](docs/VolumeGroupSummaryListResponse.md)
 - [RubrikRestApi.VolumeMountInfo](docs/VolumeMountInfo.md)
 - [RubrikRestApi.WebServerCertificatePayload](docs/WebServerCertificatePayload.md)
 - [RubrikRestApi.WebServerCertificateSummary](docs/WebServerCertificateSummary.md)
 - [RubrikRestApi.WeeklyConfig](docs/WeeklyConfig.md)
 - [RubrikRestApi.WindowsClusterDetail](docs/WindowsClusterDetail.md)
 - [RubrikRestApi.WindowsClusterSummary](docs/WindowsClusterSummary.md)
 - [RubrikRestApi.WindowsClusterSummaryListResponse](docs/WindowsClusterSummaryListResponse.md)
 - [RubrikRestApi.YearlyConfig](docs/YearlyConfig.md)
