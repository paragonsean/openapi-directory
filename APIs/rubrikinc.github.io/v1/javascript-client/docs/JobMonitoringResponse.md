# RubrikRestApi.JobMonitoringResponse
...
**jobEventStatus** | [**[JobMonitoringStatus]**](JobMonitoringStatus.md) | The requested event status of the jobs (if applicable). | [optional] 
**jobMonitoringInfoList** | [**[JobMonitoringInfo]**](JobMonitoringInfo.md) | A list of jobs. | 
**jobType** | [**JobMonitoringTaskType**](JobMonitoringTaskType.md) |  | [optional] 
**lastUpdateTime** | **Date** | The earliest possible time at which the latest update to all rows has been made. | [optional] 
