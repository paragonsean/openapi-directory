# RubrikRestApi.SapHanaDatabaseDetail
...
**latestRecoveryPoint** | **Date** | The most recent recovery point for the database. | [optional] 
**logSnapshotJobIntervalInMinutes** | **Number** | The log snapshot job interval in minutes. | 
**numChannels** | **Number** | The number of channels for multistream backups. | [optional] 
**oldestRecoveryPoint** | **Date** | The earliest recovery point for the database. | [optional] 
**previousFailedBackupPrefixes** | **[String]** | The Prefixes of previous failed backup jobs. Prefix is an identifier used by SAP HANA BACKINT to uniquely identify backups. | 
**snapshotCount** | **Number** | The total number of SAP HANA snapshots that have been taken. | 
