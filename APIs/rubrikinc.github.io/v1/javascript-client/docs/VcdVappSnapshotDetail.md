# RubrikRestApi.VcdVappSnapshotDetail
...
**isSynchronized** | **Boolean** | Boolean value that indicates whether a vApp snapshot is synchronized with the source vApp. Set to &#39;true&#39; when the vApp snapshot is synchronized, and set to &#39;false&#39; when it is not synchronized. | [optional] 
**vappName** | **String** | ID assigned to the vApp object that is the source of the specified snapshot object. | 
**excludedVcdVmMoids** | **[String]** | Array that lists the Virtual Machines of the vApp that where excluded from the snapshot. | [optional] 
**networks** | [**[VappNetworkSummary]**](VappNetworkSummary.md) | Array that lists the vApp networks in the vApp at the time of the snapshot. | 
**vmSnapshots** | [**[VcdVmSnapshotDetail]**](VcdVmSnapshotDetail.md) |  | 
