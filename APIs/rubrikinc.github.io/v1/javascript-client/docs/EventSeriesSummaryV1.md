# RubrikRestApi.EventSeriesSummaryV1
...
**dataToTransfer** | **Number** | The amount of data the job corresponding to the event needs to transfer. | [optional] 
**dataTransferred** | **Number** | The total amount of data that has been transferred by the event or job to date. | [optional] 
...
**endTime** | **Date** | For event series that correspond to a job, the time when the job finished. For a completed event series, the time of the last event in the series. This field is empty for jobs that have not completed or for event series that do not correspond to a job. | [optional] 
...
**eventDetailList** | [**[EventSummaryV1]**](EventSummaryV1.md) | List of the events in the event series. | 
...
**logicalSize** | **Number** | The logical size of the object related to the event series. | [optional] 
**nodeIds** | **String** | The IDs of the nodes where the job associated with the event is running. | [optional] 
**numberOfRetries** | **Number** | The number of times the job has been retried. | [optional] 
...
**startTime** | **Date** | The time when the job started. Only applicable to the event series that correspond to a job. | [optional] 
**status** | [**EventStatusV1**](EventStatusV1.md) |  | 
**taskType** | **String** | Type of the event series. Matches the event type.  | 
**throughput** | **Number** | The average rate of data transfer, measured in bytes per second. This rate is the total amount of data transferred divided by the total time required by the transfer. | [optional] 
