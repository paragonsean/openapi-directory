...
**lastRefreshTime** | **Date** | Optional field containing the last time that a vcenter was refreshed (either lite or full). | [optional] 
**username** | **String** |  | 
...
* `AllowAutoConflictResolution` (value: `"AllowAutoConflictResolution"`)

* `NoConflictResolution` (value: `"NoConflictResolution"`)
