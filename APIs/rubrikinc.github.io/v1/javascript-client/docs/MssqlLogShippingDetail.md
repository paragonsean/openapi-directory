# RubrikRestApi.MssqlLogShippingDetail
...
**lagTime** | **Number** | Number of milliseconds elapsed since the latest backup was applied to the secondary database and the time the backup was taken on the primary database. | [optional] 
**lastAppliedPoint** | **Date** | Timestamp of the last transaction applied using the specified log shipping configuration object. | [optional] 
...
**primaryDatabaseLogBackupFrequency** | **Number** | Log backup frequency, in seconds, of the primary database. | 
