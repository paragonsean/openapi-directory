# RubrikRestApi.VolumeGroupSnapshotSummary
...
**fileSizeInBytes** | **Number** | The logical size of the Volume Group snapshot in bytes. | [optional] 
**includedVolumes** | [**[VolumeGroupSnapshotVolumeSummary]**](VolumeGroupSnapshotVolumeSummary.md) | Configuration details of the volume(s) included in the snapshot. | 
