...
**bindUserName** | **String** | The name of the user that searches the authentication server for other users. | 
**bindUserPassword** | **String** | Password for the bind user. | 
