# RubrikRestApi.ExportMssqlDbJobConfig

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**allowOverwrite** | **Boolean** | A Boolean value that determines whether an existing database can be overwritten by a database this is exported from a backup. Set to false to prevent overwrites. This is the default. Set to true to allow overwrites. | [optional] [default to false]
...
**targetFilePaths** | [**[MssqlDbFileExportPath]**](MssqlDbFileExportPath.md) | One target path for each individual database file. Overrides targetDataFilePath and targetLogFilePath. | [optional] 
