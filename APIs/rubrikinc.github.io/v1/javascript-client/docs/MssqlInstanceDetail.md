# RubrikRestApi.MssqlInstanceDetail
...
**id** | **String** |  | 
**internalTimestamp** | **Number** |  | [optional] 
...
**unprotectableReasons** | **[String]** | A list of reasons that all the SQL Server databases in a SQL Server instance cannot be protected by the Rubrik CDM. | [optional] 
