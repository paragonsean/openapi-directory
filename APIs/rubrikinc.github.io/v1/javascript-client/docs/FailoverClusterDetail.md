# RubrikRestApi.FailoverClusterDetail
...
**numApps** | **Number** | Count of the number of failover cluster apps. | 
**numNodes** | **Number** | Count of the number of nodes on the failover cluster. | 
