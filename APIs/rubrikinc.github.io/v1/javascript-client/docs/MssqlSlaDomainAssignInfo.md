# RubrikRestApi.MssqlSlaDomainAssignInfo
...
**existingSnapshotRetention** | [**ExistingSnapshotRetention**](ExistingSnapshotRetention.md) |  | [optional] 
**ids** | **[String]** | List of SQL Server object IDs which should be assigned these properties.  | 
