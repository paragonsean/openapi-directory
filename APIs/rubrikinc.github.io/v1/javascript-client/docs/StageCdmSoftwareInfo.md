# RubrikRestApi.StageCdmSoftwareInfo
...
**size** | **Number** | Size, in bytes, of the package containing CDM software. | [optional] 
**skipDownload** | **Boolean** | Specifies whether to download the CDM software externally. When this value is false, the CDM software package must be available on the cluster. When this value is true, provide the version. | [optional] [default to false]
