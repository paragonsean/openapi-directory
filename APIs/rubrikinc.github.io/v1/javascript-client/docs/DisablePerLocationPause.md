# RubrikRestApi.DisablePerLocationPause
...
**sourceClusterUuids** | **[String]** | Replication from specified Rubrik clusters are resumed. Specified Rubrik clusters must be paused replication sources of local Rubrik cluster.  | 
