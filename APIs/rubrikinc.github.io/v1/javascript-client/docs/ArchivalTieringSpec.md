# RubrikRestApi.ArchivalTieringSpec

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**coldStorageClass** | [**CloudStorageColdTier**](CloudStorageColdTier.md) |  | [optional] 
...
**minAccessibleDurationInSeconds** | **Number** | Specifies an interval in seconds. Uploaded snapshots are accessible for instant recovery for the duration of the specified interval. This value is ignored when Instant Tiering is enabled.  | [optional] 
