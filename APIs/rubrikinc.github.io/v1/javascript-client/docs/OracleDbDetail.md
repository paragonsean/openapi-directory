...
**hostsInfo** | [**[HostInfo]**](HostInfo.md) | An array that contains the host info for each instance. | [optional] 
...
**latestRecoveryPoint** | **Date** | The time stamp of the most recent recovery point for this database. | [optional] 
**oldestRecoveryPoint** | **Date** | The time stamp of the earliest recovery point for this database. | [optional] 
...
**preferredDGMemberUniqueNames** | **[String]** | Ordered list of database unique names to use for backup in a Data Guard group. | [optional] 
...
**tablespaces** | **[String]** | An array that contains tablespace names of the specified Oracle database. | 
