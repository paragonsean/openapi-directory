# RubrikRestApi.VmSnapshotDetail
...
**vNicsInfo** | [**[VmwareVNicBindingInfo]**](VmwareVNicBindingInfo.md) |  | [optional] 
**vmName** | **String** |  | 
**config** | **String** |  | [optional] 
**isCorrupt** | **Boolean** |  | [optional] 
**snapshotDiskDetails** | [**[VmSnapshotDiskDetail]**](VmSnapshotDiskDetail.md) |  | 
**snapshotDiskIds** | **[String]** | This field is deprecated, use snapshotDiskDetails instead. | [optional] 
**virtualMachine** | [**VirtualMachineSummary**](VirtualMachineSummary.md) |  | [optional] 
**vmwareTagList** | **[String]** | List of vSphere tags assigned to the virtual machine. | [optional] 
**vmxFileContent** | **String** |  | [optional] 
