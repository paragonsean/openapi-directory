...
**hostnames** | **[String]** | A comma-separated list of host names that are associated with the certificate. This list accepts wildcard hostnames, such as &#39;*.rubrik.example.com&#39;, in addition to fully-qualified domain names. | 
