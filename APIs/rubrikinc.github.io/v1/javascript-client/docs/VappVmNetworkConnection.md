# RubrikRestApi.VappVmNetworkConnection

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**addressingMode** | [**VappVmIpAddressingMode**](VappVmIpAddressingMode.md) |  | 
...
**nicIndex** | **Number** | Index assigned to the NIC that is used by the specified vApp network connection. | 
