# RubrikRestApi.ExpiredCustomRetentionSnapshotInfo
...
**globalExpirationDate** | **Date** | Timestamp that indicates when the snapshot expires from all cluster-managed locations.  | 
...
**snapshotDate** | **Date** | Creation timestamp for the snapshot. | 
