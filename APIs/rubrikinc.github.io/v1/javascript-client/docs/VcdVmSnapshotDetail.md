# RubrikRestApi.VcdVmSnapshotDetail
...
**networkConnections** | [**[VappVmNetworkConnection]**](VappVmNetworkConnection.md) | Array of networks present in the virtual machine at the time of the snapshot. | 
