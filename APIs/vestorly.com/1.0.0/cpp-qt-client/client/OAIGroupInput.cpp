...
OAIGroupInput::OAIGroupInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGroupInput::OAIGroupInput() {
    this->initializeModel();
}

OAIGroupInput::~OAIGroupInput() {}

void OAIGroupInput::initializeModel() {
...
void OAIGroupInput::fromJson(QString jsonString) {
...
void OAIGroupInput::fromJsonObject(QJsonObject json) {
...
QString OAIGroupInput::asJson() const {
...
QJsonObject OAIGroupInput::asJsonObject() const {
    QJsonObject obj;
    if (m__id_isSet) {
...
QString OAIGroupInput::getId() const {
    return m__id;
}
void OAIGroupInput::setId(const QString &_id) {
    m__id = _id;
    m__id_isSet = true;
}

bool OAIGroupInput::is__id_Set() const{
    return m__id_isSet;
}

bool OAIGroupInput::is__id_Valid() const{
    return m__id_isValid;
}

bool OAIGroupInput::isAutopublish() const {
    return m_autopublish;
}
void OAIGroupInput::setAutopublish(const bool &autopublish) {
    m_autopublish = autopublish;
    m_autopublish_isSet = true;
}

bool OAIGroupInput::is_autopublish_Set() const{
    return m_autopublish_isSet;
}

bool OAIGroupInput::is_autopublish_Valid() const{
    return m_autopublish_isValid;
}

bool OAIGroupInput::isIsDefault() const {
    return m_is_default;
}
void OAIGroupInput::setIsDefault(const bool &is_default) {
    m_is_default = is_default;
    m_is_default_isSet = true;
}

bool OAIGroupInput::is_is_default_Set() const{
    return m_is_default_isSet;
}

bool OAIGroupInput::is_is_default_Valid() const{
    return m_is_default_isValid;
}

bool OAIGroupInput::isIsHidden() const {
    return m_is_hidden;
}
void OAIGroupInput::setIsHidden(const bool &is_hidden) {
    m_is_hidden = is_hidden;
    m_is_hidden_isSet = true;
}

bool OAIGroupInput::is_is_hidden_Set() const{
    return m_is_hidden_isSet;
}

bool OAIGroupInput::is_is_hidden_Valid() const{
    return m_is_hidden_isValid;
}

QString OAIGroupInput::getName() const {
    return m_name;
}
void OAIGroupInput::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGroupInput::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGroupInput::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIGroupInput::getNewWeeklyMailerContent() const {
    return m_new_weekly_mailer_content;
}
void OAIGroupInput::setNewWeeklyMailerContent(const QString &new_weekly_mailer_content) {
    m_new_weekly_mailer_content = new_weekly_mailer_content;
    m_new_weekly_mailer_content_isSet = true;
}

bool OAIGroupInput::is_new_weekly_mailer_content_Set() const{
    return m_new_weekly_mailer_content_isSet;
}

bool OAIGroupInput::is_new_weekly_mailer_content_Valid() const{
    return m_new_weekly_mailer_content_isValid;
}

QString OAIGroupInput::getNewsletterSubject() const {
    return m_newsletter_subject;
}
void OAIGroupInput::setNewsletterSubject(const QString &newsletter_subject) {
    m_newsletter_subject = newsletter_subject;
    m_newsletter_subject_isSet = true;
}

bool OAIGroupInput::is_newsletter_subject_Set() const{
    return m_newsletter_subject_isSet;
}

bool OAIGroupInput::is_newsletter_subject_Valid() const{
    return m_newsletter_subject_isValid;
}

qint32 OAIGroupInput::getNumberArticlesPerGroup() const {
    return m_number_articles_per_group;
}
void OAIGroupInput::setNumberArticlesPerGroup(const qint32 &number_articles_per_group) {
    m_number_articles_per_group = number_articles_per_group;
    m_number_articles_per_group_isSet = true;
}

bool OAIGroupInput::is_number_articles_per_group_Set() const{
    return m_number_articles_per_group_isSet;
}

bool OAIGroupInput::is_number_articles_per_group_Valid() const{
    return m_number_articles_per_group_isValid;
}

qint32 OAIGroupInput::getNumberArticlesPerNewsletter() const {
    return m_number_articles_per_newsletter;
}
void OAIGroupInput::setNumberArticlesPerNewsletter(const qint32 &number_articles_per_newsletter) {
    m_number_articles_per_newsletter = number_articles_per_newsletter;
    m_number_articles_per_newsletter_isSet = true;
}

bool OAIGroupInput::is_number_articles_per_newsletter_Set() const{
    return m_number_articles_per_newsletter_isSet;
}

bool OAIGroupInput::is_number_articles_per_newsletter_Valid() const{
    return m_number_articles_per_newsletter_isValid;
}

bool OAIGroupInput::isSet() const {
...
bool OAIGroupInput::isValid() const {
