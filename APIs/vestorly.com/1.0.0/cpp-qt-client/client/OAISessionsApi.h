...
public:
    ...
    */
    virtual void logout(const QString &vestorly_auth, const QString &id);
...
Q_SIGNALS:
    ...
    void logoutSignal(OAISessionLogoutResponse summary);


    void loginSignalFull(OAIHttpRequestWorker *worker, OAISession summary);
    void logoutSignalFull(OAIHttpRequestWorker *worker, OAISessionLogoutResponse summary);
    ...
    void logoutSignalE(OAISessionLogoutResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void logoutSignalError(OAISessionLogoutResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
