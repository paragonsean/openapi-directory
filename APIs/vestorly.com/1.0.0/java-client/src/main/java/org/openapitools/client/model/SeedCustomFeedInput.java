...
public class SeedCustomFeedInput {
  ...
  public SeedCustomFeedInput() {
  }

  public SeedCustomFeedInput articleId(String articleId) {
  ...
  public SeedCustomFeedInput customFeedId(String customFeedId) {
  ...
  public SeedCustomFeedInput notArticleId(String notArticleId) {
  ...
  public SeedCustomFeedInput notSeeds(List<String> notSeeds) {
    this.notSeeds = notSeeds;
    return this;
  }

  public SeedCustomFeedInput addNotSeedsItem(String notSeedsItem) {
  ...
  public SeedCustomFeedInput seeds(List<String> seeds) {
    this.seeds = seeds;
    return this;
  }

  public SeedCustomFeedInput addSeedsItem(String seedsItem) {
    if (this.seeds == null) {
  ...
  public SeedCustomFeedInput sortBy(String sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SeedCustomFeedInput seedCustomFeedInput = (SeedCustomFeedInput) o;
    return Objects.equals(this.articleId, seedCustomFeedInput.articleId) &&
        Objects.equals(this.customFeedId, seedCustomFeedInput.customFeedId) &&
        Objects.equals(this.notArticleId, seedCustomFeedInput.notArticleId) &&
        Objects.equals(this.notSeeds, seedCustomFeedInput.notSeeds) &&
        Objects.equals(this.seeds, seedCustomFeedInput.seeds) &&
        Objects.equals(this.sortBy, seedCustomFeedInput.sortBy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(articleId, customFeedId, notArticleId, notSeeds, seeds, sortBy);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SeedCustomFeedInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SeedCustomFeedInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SeedCustomFeedInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SeedCustomFeedInput is not found in the empty JSON string", SeedCustomFeedInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SeedCustomFeedInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SeedCustomFeedInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SeedCustomFeedInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SeedCustomFeedInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SeedCustomFeedInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SeedCustomFeedInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SeedCustomFeedInput.class));

       return (TypeAdapter<T>) new TypeAdapter<SeedCustomFeedInput>() {
           @Override
           public void write(JsonWriter out, SeedCustomFeedInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SeedCustomFeedInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SeedCustomFeedInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SeedCustomFeedInput
   * @throws IOException if the JSON string is invalid with respect to SeedCustomFeedInput
   */
  public static SeedCustomFeedInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SeedCustomFeedInput.class);
  }

  /**
   * Convert an instance of SeedCustomFeedInput to an JSON string
   *
   * @return JSON string
   */
