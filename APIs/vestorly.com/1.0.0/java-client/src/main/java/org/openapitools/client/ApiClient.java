...
public class ApiClient {
    ...
    private String basePath = "https://staging.vestorly.com/api/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("access_token", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://staging.vestorly.com/api/v2
