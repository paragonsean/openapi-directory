...
public class Post {
  ...
  public Post advisorId(String advisorId) {
  ...
  public Post approvalStatus(String approvalStatus) {
  ...
  public Post approvalTransactions(List<String> approvalTransactions) {
    this.approvalTransactions = approvalTransactions;
    return this;
  }

  public Post addApprovalTransactionsItem(String approvalTransactionsItem) {
  ...
  public Post articleId(String articleId) {
  ...
  public Post displayDate(String displayDate) {
  ...
  public Post displaySummary(String displaySummary) {
  ...
  public Post displayTag(String displayTag) {
  ...
  public Post externalUrl(String externalUrl) {
  ...
  public Post externalUrlSource(String externalUrlSource) {
  ...
  public Post externalUrlType(String externalUrlType) {
  ...
  public Post groupIds(List<String> groupIds) {
    this.groupIds = groupIds;
    return this;
  }

  public Post addGroupIdsItem(String groupIdsItem) {
  ...
  public Post imageHeight(String imageHeight) {
  ...
  public Post imagePath(String imagePath) {
  ...
  public Post imageWidth(String imageWidth) {
  ...
  public Post isFeatured(Boolean isFeatured) {
  ...
  public Post isMobileProxyNeeded(Boolean isMobileProxyNeeded) {
  ...
  public Post isProxyNeeded(Boolean isProxyNeeded) {
  ...
  public Post isPublished(Boolean isPublished) {
  ...
  public Post isResponsive(Boolean isResponsive) {
  ...
  public Post logoUrl(String logoUrl) {
  ...
  public Post needsSanitize(String needsSanitize) {
  ...
  public Post newsletterIds(List<String> newsletterIds) {
    this.newsletterIds = newsletterIds;
    return this;
  }

  public Post addNewsletterIdsItem(String newsletterIdsItem) {
  ...
  public Post postDate(String postDate) {
  ...
  public Post proxyUrl(String proxyUrl) {
  ...
  public Post redirectorLink(String redirectorLink) {
  ...
  public Post squareLogoUrl(String squareLogoUrl) {
  ...
  public Post suitabilityScore(String suitabilityScore) {
  ...
  public Post topic(String topic) {
    this.topic = topic;
    return this;
  }
  ...
  public Post vestorlyUrl(String vestorlyUrl) {
  ...
  public Post video(String video) {
    this.video = video;
    return this;
  }
  ...
  public Post videoId(String videoId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, post.id) &&
        Objects.equals(this.advisorId, post.advisorId) &&
        Objects.equals(this.approvalStatus, post.approvalStatus) &&
        Objects.equals(this.approvalTransactions, post.approvalTransactions) &&
        Objects.equals(this.articleId, post.articleId) &&
        Objects.equals(this.comment, post.comment) &&
        Objects.equals(this.createdAt, post.createdAt) &&
        Objects.equals(this.displayDate, post.displayDate) &&
        Objects.equals(this.displaySummary, post.displaySummary) &&
        Objects.equals(this.displayTag, post.displayTag) &&
        Objects.equals(this.externalUrl, post.externalUrl) &&
        Objects.equals(this.externalUrlSource, post.externalUrlSource) &&
        Objects.equals(this.externalUrlType, post.externalUrlType) &&
        Objects.equals(this.groupIds, post.groupIds) &&
        Objects.equals(this.imageHeight, post.imageHeight) &&
        Objects.equals(this.imagePath, post.imagePath) &&
        Objects.equals(this.imageUrl, post.imageUrl) &&
        Objects.equals(this.imageWidth, post.imageWidth) &&
        Objects.equals(this.isFeatured, post.isFeatured) &&
        Objects.equals(this.isMobileProxyNeeded, post.isMobileProxyNeeded) &&
        Objects.equals(this.isProxyNeeded, post.isProxyNeeded) &&
        Objects.equals(this.isPublished, post.isPublished) &&
        Objects.equals(this.isResponsive, post.isResponsive) &&
        Objects.equals(this.logoUrl, post.logoUrl) &&
        Objects.equals(this.needsSanitize, post.needsSanitize) &&
        Objects.equals(this.newsletterIds, post.newsletterIds) &&
        Objects.equals(this.postDate, post.postDate) &&
        Objects.equals(this.proxyUrl, post.proxyUrl) &&
        Objects.equals(this.redirectorLink, post.redirectorLink) &&
        Objects.equals(this.slug, post.slug) &&
        Objects.equals(this.squareLogoUrl, post.squareLogoUrl) &&
        Objects.equals(this.suitabilityScore, post.suitabilityScore) &&
        ...
        Objects.equals(this.vestorlyUrl, post.vestorlyUrl) &&
        Objects.equals(this.video, post.video) &&
        Objects.equals(this.videoId, post.videoId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, advisorId, approvalStatus, approvalTransactions, articleId, comment, createdAt, displayDate, displaySummary, displayTag, externalUrl, externalUrlSource, externalUrlType, groupIds, imageHeight, imagePath, imageUrl, imageWidth, isFeatured, isMobileProxyNeeded, isProxyNeeded, isPublished, isResponsive, logoUrl, needsSanitize, newsletterIds, postDate, proxyUrl, redirectorLink, slug, squareLogoUrl, suitabilityScore, summary, title, topic, updatedAt, vestorlyUrl, video, videoId);
  }
