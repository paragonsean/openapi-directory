...
class Event {
     ...
     * @param type {module:model/Event.TypeEnum} 
     */
    constructor(id, originalUrl, subjectEmail, type) { 
        
        Event.initialize(this, id, originalUrl, subjectEmail, type);
    }
     ...
     */
    static initialize(obj, id, originalUrl, subjectEmail, type) { 
        obj['_id'] = id;
...
Event.RequiredProperties = ["_id", "original_url", "subject_email", "type"];
 ...
 */
Event.prototype['advisor_id'] = undefined;
 ...
 */
Event.prototype['event_content'] = undefined;

/**
 * @member {String} original_url
 */
Event.prototype['original_url'] = undefined;

/**
 * @member {String} originator_email
 */
Event.prototype['originator_email'] = undefined;

/**
 * @member {String} originator_id
 */
Event.prototype['originator_id'] = undefined;

/**
 * @member {String} parent_event_id
 */
Event.prototype['parent_event_id'] = undefined;

/**
 * @member {String} referer
 */
Event.prototype['referer'] = undefined;

/**
 * @member {String} subject_email
 */
Event.prototype['subject_email'] = undefined;

/**
 * @member {String} subject_id
 */
Event.prototype['subject_id'] = undefined;
