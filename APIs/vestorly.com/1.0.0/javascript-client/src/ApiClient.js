...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://staging.vestorly.com/api/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://staging.vestorly.com/api/v2
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://staging.vestorly.com/api/v2",
