...
class Event(Model):
    ...
    def __init__(self, id: str=None, advisor_id: str=None, created_at: str=None, event_content: EventContent=None, original_url: str=None, originator_email: str=None, originator_id: str=None, parent_event_id: str=None, referer: str=None, subject_email: str=None, subject_id: str=None, type: str=None):
