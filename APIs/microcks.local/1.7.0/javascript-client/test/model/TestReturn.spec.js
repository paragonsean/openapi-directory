...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MicrocksApiV17.TestReturn();
  });
  ...
  describe('TestReturn', function() {
    it('should create an instance of TestReturn', function() {
      // uncomment below and update the code to test TestReturn
      //var instance = new MicrocksApiV17.TestReturn();
      //expect(instance).to.be.a(MicrocksApiV17.TestReturn);
    });
