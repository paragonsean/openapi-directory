...
public class ApiClient {
    ...
    private String basePath = "http://microcks.local";
    ...
    public ApiClient() {
        ...
        authentications.put("jwt-bearer", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://keycloak.example.com/realms/microcks/protocol/openid-connect/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://microcks.local
