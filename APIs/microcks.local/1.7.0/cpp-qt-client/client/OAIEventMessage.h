...
#ifndef OAIEventMessage_H
#define OAIEventMessage_H
...
class OAIEventMessage : public OAIObject {
public:
    OAIEventMessage();
    OAIEventMessage(QString json);
    ~OAIEventMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventMessage)

#endif // OAIEventMessage_H
