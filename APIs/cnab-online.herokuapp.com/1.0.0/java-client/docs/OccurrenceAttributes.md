...
|**bankTax** | **BigDecimal** | Tarifa bancária |  [optional] |
...
|**discountValue** | **BigDecimal** | Valor de desconto |  [optional] |
...
|**iofTax** | **BigDecimal** | Retorna o valor do Imposto sobre operações financeiras (IOF) |  [optional] |
...
|**othersCreditsValue** | **BigDecimal** | Retorna o valor de outros creditos |  [optional] |
...
|**rebateValue** | **BigDecimal** | Retornna o valor dos abatimentos concedidos (depois da emissão) |  [optional] |
|**receivedValue** | **BigDecimal** | Valor recebido |  [optional] |
|**sequencialNumber** | **BigDecimal** | Retorna o numero sequencial da ocorrência no arquivo |  [optional] |
|**titleValue** | **BigDecimal** | Valor do título (valor do boleto) |  [optional] |
