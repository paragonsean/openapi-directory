...
/*
 * OAISimplifiedPlaylistObject.h
 *
 * 
 */

#ifndef OAISimplifiedPlaylistObject_H
#define OAISimplifiedPlaylistObject_H
...
class OAIPlaylistTracksRefObject;

class OAISimplifiedPlaylistObject : public OAIObject {
public:
    OAISimplifiedPlaylistObject();
    OAISimplifiedPlaylistObject(QString json);
    ~OAISimplifiedPlaylistObject() override;
    ...
    OAIPlaylistTracksRefObject getTracks() const;
    void setTracks(const OAIPlaylistTracksRefObject &tracks);
...
private:
    ...
    OAIPlaylistTracksRefObject m_tracks;
    bool m_tracks_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimplifiedPlaylistObject)

#endif // OAISimplifiedPlaylistObject_H
