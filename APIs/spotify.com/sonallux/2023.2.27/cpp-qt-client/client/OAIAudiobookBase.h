...
#ifndef OAIAudiobookBase_H
#define OAIAudiobookBase_H
...
class OAIAudiobookBase : public OAIObject {
public:
    OAIAudiobookBase();
    OAIAudiobookBase(QString json);
    ~OAIAudiobookBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAudiobookBase)

#endif // OAIAudiobookBase_H
