...
/*
 * OAIPlaylistOwnerObject.h
 *
 * 
 */

#ifndef OAIPlaylistOwnerObject_H
#define OAIPlaylistOwnerObject_H
...
class OAIPlaylistOwnerObject : public OAIObject {
public:
    OAIPlaylistOwnerObject();
    OAIPlaylistOwnerObject(QString json);
    ~OAIPlaylistOwnerObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaylistOwnerObject)

#endif // OAIPlaylistOwnerObject_H
