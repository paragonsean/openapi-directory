...
/*
 * OAIPagingSavedShowObject.h
 *
 * 
 */

#ifndef OAIPagingSavedShowObject_H
#define OAIPagingSavedShowObject_H
...
namespace OpenAPI {
class OAISavedShowObject;

class OAIPagingSavedShowObject : public OAIObject {
public:
    OAIPagingSavedShowObject();
    OAIPagingSavedShowObject(QString json);
    ~OAIPagingSavedShowObject() override;
    ...
    QList<OAISavedShowObject> getItems() const;
    void setItems(const QList<OAISavedShowObject> &items);
...
private:
    ...
    QList<OAISavedShowObject> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagingSavedShowObject)

#endif // OAIPagingSavedShowObject_H
