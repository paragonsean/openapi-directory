...
/*
 * OAIPlaylistUserObject.h
 *
 * 
 */

#ifndef OAIPlaylistUserObject_H
#define OAIPlaylistUserObject_H
...
class OAIPlaylistUserObject : public OAIObject {
public:
    OAIPlaylistUserObject();
    OAIPlaylistUserObject(QString json);
    ~OAIPlaylistUserObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaylistUserObject)

#endif // OAIPlaylistUserObject_H
