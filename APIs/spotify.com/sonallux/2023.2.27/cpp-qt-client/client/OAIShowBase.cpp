...
OAIShowBase::OAIShowBase(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIShowBase::OAIShowBase() {
    this->initializeModel();
}

OAIShowBase::~OAIShowBase() {}

void OAIShowBase::initializeModel() {
...
void OAIShowBase::fromJson(QString jsonString) {
...
void OAIShowBase::fromJsonObject(QJsonObject json) {
...
QString OAIShowBase::asJson() const {
...
QJsonObject OAIShowBase::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIShowBase::getAvailableMarkets() const {
    return m_available_markets;
}
void OAIShowBase::setAvailableMarkets(const QList<QString> &available_markets) {
    m_available_markets = available_markets;
    m_available_markets_isSet = true;
}

bool OAIShowBase::is_available_markets_Set() const{
    return m_available_markets_isSet;
}

bool OAIShowBase::is_available_markets_Valid() const{
    return m_available_markets_isValid;
}

QList<OAICopyrightObject> OAIShowBase::getCopyrights() const {
    return m_copyrights;
}
void OAIShowBase::setCopyrights(const QList<OAICopyrightObject> &copyrights) {
    m_copyrights = copyrights;
    m_copyrights_isSet = true;
}

bool OAIShowBase::is_copyrights_Set() const{
    return m_copyrights_isSet;
}

bool OAIShowBase::is_copyrights_Valid() const{
    return m_copyrights_isValid;
}

QString OAIShowBase::getDescription() const {
    return m_description;
}
void OAIShowBase::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIShowBase::is_description_Set() const{
    return m_description_isSet;
}

bool OAIShowBase::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIShowBase::isRExplicit() const {
    return m_r_explicit;
}
void OAIShowBase::setRExplicit(const bool &r_explicit) {
    m_r_explicit = r_explicit;
    m_r_explicit_isSet = true;
}

bool OAIShowBase::is_r_explicit_Set() const{
    return m_r_explicit_isSet;
}

bool OAIShowBase::is_r_explicit_Valid() const{
    return m_r_explicit_isValid;
}

OAIExternalUrlObject OAIShowBase::getExternalUrls() const {
    return m_external_urls;
}
void OAIShowBase::setExternalUrls(const OAIExternalUrlObject &external_urls) {
    m_external_urls = external_urls;
    m_external_urls_isSet = true;
}

bool OAIShowBase::is_external_urls_Set() const{
    return m_external_urls_isSet;
}

bool OAIShowBase::is_external_urls_Valid() const{
    return m_external_urls_isValid;
}

QString OAIShowBase::getHref() const {
    return m_href;
}
void OAIShowBase::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAIShowBase::is_href_Set() const{
    return m_href_isSet;
}

bool OAIShowBase::is_href_Valid() const{
    return m_href_isValid;
}

QString OAIShowBase::getHtmlDescription() const {
    return m_html_description;
}
void OAIShowBase::setHtmlDescription(const QString &html_description) {
    m_html_description = html_description;
    m_html_description_isSet = true;
}

bool OAIShowBase::is_html_description_Set() const{
    return m_html_description_isSet;
}

bool OAIShowBase::is_html_description_Valid() const{
    return m_html_description_isValid;
}

QString OAIShowBase::getId() const {
    return m_id;
}
void OAIShowBase::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIShowBase::is_id_Set() const{
    return m_id_isSet;
}

bool OAIShowBase::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIImageObject> OAIShowBase::getImages() const {
    return m_images;
}
void OAIShowBase::setImages(const QList<OAIImageObject> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAIShowBase::is_images_Set() const{
    return m_images_isSet;
}

bool OAIShowBase::is_images_Valid() const{
    return m_images_isValid;
}

bool OAIShowBase::isIsExternallyHosted() const {
    return m_is_externally_hosted;
}
void OAIShowBase::setIsExternallyHosted(const bool &is_externally_hosted) {
    m_is_externally_hosted = is_externally_hosted;
    m_is_externally_hosted_isSet = true;
}

bool OAIShowBase::is_is_externally_hosted_Set() const{
    return m_is_externally_hosted_isSet;
}

bool OAIShowBase::is_is_externally_hosted_Valid() const{
    return m_is_externally_hosted_isValid;
}

QList<QString> OAIShowBase::getLanguages() const {
    return m_languages;
}
void OAIShowBase::setLanguages(const QList<QString> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIShowBase::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIShowBase::is_languages_Valid() const{
    return m_languages_isValid;
}

QString OAIShowBase::getMediaType() const {
    return m_media_type;
}
void OAIShowBase::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIShowBase::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIShowBase::is_media_type_Valid() const{
    return m_media_type_isValid;
}

QString OAIShowBase::getName() const {
    return m_name;
}
void OAIShowBase::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIShowBase::is_name_Set() const{
    return m_name_isSet;
}

bool OAIShowBase::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIShowBase::getPublisher() const {
    return m_publisher;
}
void OAIShowBase::setPublisher(const QString &publisher) {
    m_publisher = publisher;
    m_publisher_isSet = true;
}

bool OAIShowBase::is_publisher_Set() const{
    return m_publisher_isSet;
}

bool OAIShowBase::is_publisher_Valid() const{
    return m_publisher_isValid;
}

qint32 OAIShowBase::getTotalEpisodes() const {
    return m_total_episodes;
}
void OAIShowBase::setTotalEpisodes(const qint32 &total_episodes) {
    m_total_episodes = total_episodes;
    m_total_episodes_isSet = true;
}

bool OAIShowBase::is_total_episodes_Set() const{
    return m_total_episodes_isSet;
}

bool OAIShowBase::is_total_episodes_Valid() const{
    return m_total_episodes_isValid;
}

QString OAIShowBase::getType() const {
    return m_type;
}
void OAIShowBase::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIShowBase::is_type_Set() const{
    return m_type_isSet;
}

bool OAIShowBase::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIShowBase::getUri() const {
    return m_uri;
}
void OAIShowBase::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAIShowBase::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAIShowBase::is_uri_Valid() const{
    return m_uri_isValid;
}

bool OAIShowBase::isSet() const {
