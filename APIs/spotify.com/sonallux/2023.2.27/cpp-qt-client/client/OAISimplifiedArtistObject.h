...
/*
 * OAISimplifiedArtistObject.h
 *
 * 
 */

#ifndef OAISimplifiedArtistObject_H
#define OAISimplifiedArtistObject_H
...
class OAISimplifiedArtistObject : public OAIObject {
public:
    OAISimplifiedArtistObject();
    OAISimplifiedArtistObject(QString json);
    ~OAISimplifiedArtistObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimplifiedArtistObject)

#endif // OAISimplifiedArtistObject_H
