...
Q_SIGNALS:
    ...
    void getAUsersAvailableDevicesSignal(OAIDevicesObject summary);
    ...
    void getTheUsersCurrentlyPlayingTrackSignal(OAICurrentlyPlayingObject summary);
    ...
    void getAUsersAvailableDevicesSignalFull(OAIHttpRequestWorker *worker, OAIDevicesObject summary);
    ...
    void getTheUsersCurrentlyPlayingTrackSignalFull(OAIHttpRequestWorker *worker, OAICurrentlyPlayingObject summary);
    ...
    void getAUsersAvailableDevicesSignalE(OAIDevicesObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAUsersAvailableDevicesSignalError(OAIDevicesObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void getTheUsersCurrentlyPlayingTrackSignalE(OAICurrentlyPlayingObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getTheUsersCurrentlyPlayingTrackSignalError(OAICurrentlyPlayingObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
