...
OAILinkedTrackObject OAICurrentlyPlayingContextObject_item::getLinkedFrom() const {
    return m_linked_from;
}
void OAICurrentlyPlayingContextObject_item::setLinkedFrom(const OAILinkedTrackObject &linked_from) {
