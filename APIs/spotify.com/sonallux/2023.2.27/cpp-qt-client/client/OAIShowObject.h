...
#ifndef OAIShowObject_H
#define OAIShowObject_H
...
class OAIShowObject : public OAIObject {
public:
    OAIShowObject();
    OAIShowObject(QString json);
    ~OAIShowObject() override;
    ...
    OAIObject getEpisodes() const;
    void setEpisodes(const OAIObject &episodes);
...
Q_DECLARE_METATYPE(OpenAPI::OAIShowObject)

#endif // OAIShowObject_H
