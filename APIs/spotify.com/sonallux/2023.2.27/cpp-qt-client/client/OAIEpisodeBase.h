...
#ifndef OAIEpisodeBase_H
#define OAIEpisodeBase_H
...
class OAIEpisodeBase : public OAIObject {
public:
    OAIEpisodeBase();
    OAIEpisodeBase(QString json);
    ~OAIEpisodeBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEpisodeBase)

#endif // OAIEpisodeBase_H
