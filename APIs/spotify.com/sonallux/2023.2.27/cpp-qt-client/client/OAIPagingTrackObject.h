...
/*
 * OAIPagingTrackObject.h
 *
 * 
 */

#ifndef OAIPagingTrackObject_H
#define OAIPagingTrackObject_H
...
class OAIPagingTrackObject : public OAIObject {
public:
    OAIPagingTrackObject();
    OAIPagingTrackObject(QString json);
    ~OAIPagingTrackObject() override;
    ...
    QList<OAITrackObject> getItems() const;
    void setItems(const QList<OAITrackObject> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagingTrackObject)

#endif // OAIPagingTrackObject_H
