...
/*
 * OAISavedTrackObject.h
 *
 * 
 */

#ifndef OAISavedTrackObject_H
#define OAISavedTrackObject_H
...
class OAISavedTrackObject : public OAIObject {
public:
    OAISavedTrackObject();
    OAISavedTrackObject(QString json);
    ~OAISavedTrackObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISavedTrackObject)

#endif // OAISavedTrackObject_H
