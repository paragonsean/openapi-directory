...
#ifndef OAIChapterBase_H
#define OAIChapterBase_H
...
class OAIChapterBase : public OAIObject {
public:
    OAIChapterBase();
    OAIChapterBase(QString json);
    ~OAIChapterBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChapterBase)

#endif // OAIChapterBase_H
