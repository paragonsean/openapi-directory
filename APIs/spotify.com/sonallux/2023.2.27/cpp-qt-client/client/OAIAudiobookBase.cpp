...
OAIAudiobookBase::OAIAudiobookBase(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAudiobookBase::OAIAudiobookBase() {
    this->initializeModel();
}

OAIAudiobookBase::~OAIAudiobookBase() {}

void OAIAudiobookBase::initializeModel() {
...
void OAIAudiobookBase::fromJson(QString jsonString) {
...
void OAIAudiobookBase::fromJsonObject(QJsonObject json) {
...
QString OAIAudiobookBase::asJson() const {
...
QJsonObject OAIAudiobookBase::asJsonObject() const {
    QJsonObject obj;
    if (m_authors.size() > 0) {
...
QList<OAIAuthorObject> OAIAudiobookBase::getAuthors() const {
    return m_authors;
}
void OAIAudiobookBase::setAuthors(const QList<OAIAuthorObject> &authors) {
    m_authors = authors;
    m_authors_isSet = true;
}

bool OAIAudiobookBase::is_authors_Set() const{
    return m_authors_isSet;
}

bool OAIAudiobookBase::is_authors_Valid() const{
    return m_authors_isValid;
}

QList<QString> OAIAudiobookBase::getAvailableMarkets() const {
    return m_available_markets;
}
void OAIAudiobookBase::setAvailableMarkets(const QList<QString> &available_markets) {
    m_available_markets = available_markets;
    m_available_markets_isSet = true;
}

bool OAIAudiobookBase::is_available_markets_Set() const{
    return m_available_markets_isSet;
}

bool OAIAudiobookBase::is_available_markets_Valid() const{
    return m_available_markets_isValid;
}

QList<OAICopyrightObject> OAIAudiobookBase::getCopyrights() const {
    return m_copyrights;
}
void OAIAudiobookBase::setCopyrights(const QList<OAICopyrightObject> &copyrights) {
    m_copyrights = copyrights;
    m_copyrights_isSet = true;
}

bool OAIAudiobookBase::is_copyrights_Set() const{
    return m_copyrights_isSet;
}

bool OAIAudiobookBase::is_copyrights_Valid() const{
    return m_copyrights_isValid;
}

QString OAIAudiobookBase::getDescription() const {
    return m_description;
}
void OAIAudiobookBase::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIAudiobookBase::is_description_Set() const{
    return m_description_isSet;
}

bool OAIAudiobookBase::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIAudiobookBase::getEdition() const {
    return m_edition;
}
void OAIAudiobookBase::setEdition(const QString &edition) {
    m_edition = edition;
    m_edition_isSet = true;
}

bool OAIAudiobookBase::is_edition_Set() const{
    return m_edition_isSet;
}

bool OAIAudiobookBase::is_edition_Valid() const{
    return m_edition_isValid;
}

bool OAIAudiobookBase::isRExplicit() const {
    return m_r_explicit;
}
void OAIAudiobookBase::setRExplicit(const bool &r_explicit) {
    m_r_explicit = r_explicit;
    m_r_explicit_isSet = true;
}

bool OAIAudiobookBase::is_r_explicit_Set() const{
    return m_r_explicit_isSet;
}

bool OAIAudiobookBase::is_r_explicit_Valid() const{
    return m_r_explicit_isValid;
}

OAIExternalUrlObject OAIAudiobookBase::getExternalUrls() const {
    return m_external_urls;
}
void OAIAudiobookBase::setExternalUrls(const OAIExternalUrlObject &external_urls) {
    m_external_urls = external_urls;
    m_external_urls_isSet = true;
}

bool OAIAudiobookBase::is_external_urls_Set() const{
    return m_external_urls_isSet;
}

bool OAIAudiobookBase::is_external_urls_Valid() const{
    return m_external_urls_isValid;
}

QString OAIAudiobookBase::getHref() const {
    return m_href;
}
void OAIAudiobookBase::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAIAudiobookBase::is_href_Set() const{
    return m_href_isSet;
}

bool OAIAudiobookBase::is_href_Valid() const{
    return m_href_isValid;
}

QString OAIAudiobookBase::getHtmlDescription() const {
    return m_html_description;
}
void OAIAudiobookBase::setHtmlDescription(const QString &html_description) {
    m_html_description = html_description;
    m_html_description_isSet = true;
}

bool OAIAudiobookBase::is_html_description_Set() const{
    return m_html_description_isSet;
}

bool OAIAudiobookBase::is_html_description_Valid() const{
    return m_html_description_isValid;
}

QString OAIAudiobookBase::getId() const {
    return m_id;
}
void OAIAudiobookBase::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAudiobookBase::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAudiobookBase::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIImageObject> OAIAudiobookBase::getImages() const {
    return m_images;
}
void OAIAudiobookBase::setImages(const QList<OAIImageObject> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAIAudiobookBase::is_images_Set() const{
    return m_images_isSet;
}

bool OAIAudiobookBase::is_images_Valid() const{
    return m_images_isValid;
}

QList<QString> OAIAudiobookBase::getLanguages() const {
    return m_languages;
}
void OAIAudiobookBase::setLanguages(const QList<QString> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIAudiobookBase::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIAudiobookBase::is_languages_Valid() const{
    return m_languages_isValid;
}

QString OAIAudiobookBase::getMediaType() const {
    return m_media_type;
}
void OAIAudiobookBase::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIAudiobookBase::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIAudiobookBase::is_media_type_Valid() const{
    return m_media_type_isValid;
}

QString OAIAudiobookBase::getName() const {
    return m_name;
}
void OAIAudiobookBase::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAudiobookBase::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAudiobookBase::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAINarratorObject> OAIAudiobookBase::getNarrators() const {
    return m_narrators;
}
void OAIAudiobookBase::setNarrators(const QList<OAINarratorObject> &narrators) {
    m_narrators = narrators;
    m_narrators_isSet = true;
}

bool OAIAudiobookBase::is_narrators_Set() const{
    return m_narrators_isSet;
}

bool OAIAudiobookBase::is_narrators_Valid() const{
    return m_narrators_isValid;
}

QString OAIAudiobookBase::getPublisher() const {
    return m_publisher;
}
void OAIAudiobookBase::setPublisher(const QString &publisher) {
    m_publisher = publisher;
    m_publisher_isSet = true;
}

bool OAIAudiobookBase::is_publisher_Set() const{
    return m_publisher_isSet;
}

bool OAIAudiobookBase::is_publisher_Valid() const{
    return m_publisher_isValid;
}

qint32 OAIAudiobookBase::getTotalChapters() const {
    return m_total_chapters;
}
void OAIAudiobookBase::setTotalChapters(const qint32 &total_chapters) {
    m_total_chapters = total_chapters;
    m_total_chapters_isSet = true;
}

bool OAIAudiobookBase::is_total_chapters_Set() const{
    return m_total_chapters_isSet;
}

bool OAIAudiobookBase::is_total_chapters_Valid() const{
    return m_total_chapters_isValid;
}

QString OAIAudiobookBase::getType() const {
    return m_type;
}
void OAIAudiobookBase::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAudiobookBase::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAudiobookBase::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIAudiobookBase::getUri() const {
    return m_uri;
}
void OAIAudiobookBase::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAIAudiobookBase::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAIAudiobookBase::is_uri_Valid() const{
    return m_uri_isValid;
}

bool OAIAudiobookBase::isSet() const {
...
bool OAIAudiobookBase::isValid() const {
