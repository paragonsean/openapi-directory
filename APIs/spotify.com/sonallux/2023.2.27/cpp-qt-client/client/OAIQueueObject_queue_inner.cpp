...
OAIQueueObject_queue_inner::OAIQueueObject_queue_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIQueueObject_queue_inner::OAIQueueObject_queue_inner() {
    this->initializeModel();
}

OAIQueueObject_queue_inner::~OAIQueueObject_queue_inner() {}

void OAIQueueObject_queue_inner::initializeModel() {
...
void OAIQueueObject_queue_inner::fromJson(QString jsonString) {
...
void OAIQueueObject_queue_inner::fromJsonObject(QJsonObject json) {
...
QString OAIQueueObject_queue_inner::asJson() const {
...
QJsonObject OAIQueueObject_queue_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_album.isSet()) {
...
OAISimplifiedAlbumObject OAIQueueObject_queue_inner::getAlbum() const {
    return m_album;
}
void OAIQueueObject_queue_inner::setAlbum(const OAISimplifiedAlbumObject &album) {
    m_album = album;
    m_album_isSet = true;
}

bool OAIQueueObject_queue_inner::is_album_Set() const{
    return m_album_isSet;
}

bool OAIQueueObject_queue_inner::is_album_Valid() const{
    return m_album_isValid;
}

QList<OAIArtistObject> OAIQueueObject_queue_inner::getArtists() const {
    return m_artists;
}
void OAIQueueObject_queue_inner::setArtists(const QList<OAIArtistObject> &artists) {
    m_artists = artists;
    m_artists_isSet = true;
}

bool OAIQueueObject_queue_inner::is_artists_Set() const{
    return m_artists_isSet;
}

bool OAIQueueObject_queue_inner::is_artists_Valid() const{
    return m_artists_isValid;
}

QList<QString> OAIQueueObject_queue_inner::getAvailableMarkets() const {
    return m_available_markets;
}
void OAIQueueObject_queue_inner::setAvailableMarkets(const QList<QString> &available_markets) {
    m_available_markets = available_markets;
    m_available_markets_isSet = true;
}

bool OAIQueueObject_queue_inner::is_available_markets_Set() const{
    return m_available_markets_isSet;
}

bool OAIQueueObject_queue_inner::is_available_markets_Valid() const{
    return m_available_markets_isValid;
}

qint32 OAIQueueObject_queue_inner::getDiscNumber() const {
    return m_disc_number;
}
void OAIQueueObject_queue_inner::setDiscNumber(const qint32 &disc_number) {
    m_disc_number = disc_number;
    m_disc_number_isSet = true;
}

bool OAIQueueObject_queue_inner::is_disc_number_Set() const{
    return m_disc_number_isSet;
}

bool OAIQueueObject_queue_inner::is_disc_number_Valid() const{
    return m_disc_number_isValid;
}

qint32 OAIQueueObject_queue_inner::getDurationMs() const {
    return m_duration_ms;
}
void OAIQueueObject_queue_inner::setDurationMs(const qint32 &duration_ms) {
    m_duration_ms = duration_ms;
    m_duration_ms_isSet = true;
}

bool OAIQueueObject_queue_inner::is_duration_ms_Set() const{
    return m_duration_ms_isSet;
}

bool OAIQueueObject_queue_inner::is_duration_ms_Valid() const{
    return m_duration_ms_isValid;
}

bool OAIQueueObject_queue_inner::isRExplicit() const {
    return m_r_explicit;
}
void OAIQueueObject_queue_inner::setRExplicit(const bool &r_explicit) {
    m_r_explicit = r_explicit;
    m_r_explicit_isSet = true;
}

bool OAIQueueObject_queue_inner::is_r_explicit_Set() const{
    return m_r_explicit_isSet;
}

bool OAIQueueObject_queue_inner::is_r_explicit_Valid() const{
    return m_r_explicit_isValid;
}

OAIExternalIdObject OAIQueueObject_queue_inner::getExternalIds() const {
    return m_external_ids;
}
void OAIQueueObject_queue_inner::setExternalIds(const OAIExternalIdObject &external_ids) {
    m_external_ids = external_ids;
    m_external_ids_isSet = true;
}

bool OAIQueueObject_queue_inner::is_external_ids_Set() const{
    return m_external_ids_isSet;
}

bool OAIQueueObject_queue_inner::is_external_ids_Valid() const{
    return m_external_ids_isValid;
}

OAIExternalUrlObject OAIQueueObject_queue_inner::getExternalUrls() const {
    return m_external_urls;
}
void OAIQueueObject_queue_inner::setExternalUrls(const OAIExternalUrlObject &external_urls) {
    m_external_urls = external_urls;
    m_external_urls_isSet = true;
}

bool OAIQueueObject_queue_inner::is_external_urls_Set() const{
    return m_external_urls_isSet;
}

bool OAIQueueObject_queue_inner::is_external_urls_Valid() const{
    return m_external_urls_isValid;
}

QString OAIQueueObject_queue_inner::getHref() const {
    return m_href;
}
void OAIQueueObject_queue_inner::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAIQueueObject_queue_inner::is_href_Set() const{
    return m_href_isSet;
}

bool OAIQueueObject_queue_inner::is_href_Valid() const{
    return m_href_isValid;
}

QString OAIQueueObject_queue_inner::getId() const {
    return m_id;
}
void OAIQueueObject_queue_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIQueueObject_queue_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIQueueObject_queue_inner::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIQueueObject_queue_inner::isIsLocal() const {
    return m_is_local;
}
void OAIQueueObject_queue_inner::setIsLocal(const bool &is_local) {
    m_is_local = is_local;
    m_is_local_isSet = true;
}

bool OAIQueueObject_queue_inner::is_is_local_Set() const{
    return m_is_local_isSet;
}

bool OAIQueueObject_queue_inner::is_is_local_Valid() const{
    return m_is_local_isValid;
}

bool OAIQueueObject_queue_inner::isIsPlayable() const {
    return m_is_playable;
}
void OAIQueueObject_queue_inner::setIsPlayable(const bool &is_playable) {
    m_is_playable = is_playable;
    m_is_playable_isSet = true;
}

bool OAIQueueObject_queue_inner::is_is_playable_Set() const{
    return m_is_playable_isSet;
}

bool OAIQueueObject_queue_inner::is_is_playable_Valid() const{
    return m_is_playable_isValid;
}

OAILinkedTrackObject OAIQueueObject_queue_inner::getLinkedFrom() const {
    return m_linked_from;
}
void OAIQueueObject_queue_inner::setLinkedFrom(const OAILinkedTrackObject &linked_from) {
    m_linked_from = linked_from;
    m_linked_from_isSet = true;
}

bool OAIQueueObject_queue_inner::is_linked_from_Set() const{
    return m_linked_from_isSet;
}

bool OAIQueueObject_queue_inner::is_linked_from_Valid() const{
    return m_linked_from_isValid;
}

QString OAIQueueObject_queue_inner::getName() const {
    return m_name;
}
void OAIQueueObject_queue_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIQueueObject_queue_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIQueueObject_queue_inner::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAIQueueObject_queue_inner::getPopularity() const {
    return m_popularity;
}
void OAIQueueObject_queue_inner::setPopularity(const qint32 &popularity) {
    m_popularity = popularity;
    m_popularity_isSet = true;
}

bool OAIQueueObject_queue_inner::is_popularity_Set() const{
    return m_popularity_isSet;
}

bool OAIQueueObject_queue_inner::is_popularity_Valid() const{
    return m_popularity_isValid;
}

QString OAIQueueObject_queue_inner::getPreviewUrl() const {
    return m_preview_url;
}
void OAIQueueObject_queue_inner::setPreviewUrl(const QString &preview_url) {
    m_preview_url = preview_url;
    m_preview_url_isSet = true;
}

bool OAIQueueObject_queue_inner::is_preview_url_Set() const{
    return m_preview_url_isSet;
}

bool OAIQueueObject_queue_inner::is_preview_url_Valid() const{
    return m_preview_url_isValid;
}

OAIEpisodeRestrictionObject OAIQueueObject_queue_inner::getRestrictions() const {
    return m_restrictions;
}
void OAIQueueObject_queue_inner::setRestrictions(const OAIEpisodeRestrictionObject &restrictions) {
    m_restrictions = restrictions;
    m_restrictions_isSet = true;
}

bool OAIQueueObject_queue_inner::is_restrictions_Set() const{
    return m_restrictions_isSet;
}

bool OAIQueueObject_queue_inner::is_restrictions_Valid() const{
    return m_restrictions_isValid;
}

qint32 OAIQueueObject_queue_inner::getTrackNumber() const {
    return m_track_number;
}
void OAIQueueObject_queue_inner::setTrackNumber(const qint32 &track_number) {
    m_track_number = track_number;
    m_track_number_isSet = true;
}

bool OAIQueueObject_queue_inner::is_track_number_Set() const{
    return m_track_number_isSet;
}

bool OAIQueueObject_queue_inner::is_track_number_Valid() const{
    return m_track_number_isValid;
}

QString OAIQueueObject_queue_inner::getType() const {
    return m_type;
}
void OAIQueueObject_queue_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIQueueObject_queue_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIQueueObject_queue_inner::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIQueueObject_queue_inner::getUri() const {
    return m_uri;
}
void OAIQueueObject_queue_inner::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAIQueueObject_queue_inner::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAIQueueObject_queue_inner::is_uri_Valid() const{
    return m_uri_isValid;
}

QString OAIQueueObject_queue_inner::getAudioPreviewUrl() const {
    return m_audio_preview_url;
}
void OAIQueueObject_queue_inner::setAudioPreviewUrl(const QString &audio_preview_url) {
    m_audio_preview_url = audio_preview_url;
    m_audio_preview_url_isSet = true;
}

bool OAIQueueObject_queue_inner::is_audio_preview_url_Set() const{
    return m_audio_preview_url_isSet;
}

bool OAIQueueObject_queue_inner::is_audio_preview_url_Valid() const{
    return m_audio_preview_url_isValid;
}

QString OAIQueueObject_queue_inner::getDescription() const {
    return m_description;
}
void OAIQueueObject_queue_inner::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIQueueObject_queue_inner::is_description_Set() const{
    return m_description_isSet;
}

bool OAIQueueObject_queue_inner::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIQueueObject_queue_inner::getHtmlDescription() const {
    return m_html_description;
}
void OAIQueueObject_queue_inner::setHtmlDescription(const QString &html_description) {
    m_html_description = html_description;
    m_html_description_isSet = true;
}

bool OAIQueueObject_queue_inner::is_html_description_Set() const{
    return m_html_description_isSet;
}

bool OAIQueueObject_queue_inner::is_html_description_Valid() const{
    return m_html_description_isValid;
}

QList<OAIImageObject> OAIQueueObject_queue_inner::getImages() const {
    return m_images;
}
void OAIQueueObject_queue_inner::setImages(const QList<OAIImageObject> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAIQueueObject_queue_inner::is_images_Set() const{
    return m_images_isSet;
}

bool OAIQueueObject_queue_inner::is_images_Valid() const{
    return m_images_isValid;
}

bool OAIQueueObject_queue_inner::isIsExternallyHosted() const {
    return m_is_externally_hosted;
}
void OAIQueueObject_queue_inner::setIsExternallyHosted(const bool &is_externally_hosted) {
    m_is_externally_hosted = is_externally_hosted;
    m_is_externally_hosted_isSet = true;
}

bool OAIQueueObject_queue_inner::is_is_externally_hosted_Set() const{
    return m_is_externally_hosted_isSet;
}

bool OAIQueueObject_queue_inner::is_is_externally_hosted_Valid() const{
    return m_is_externally_hosted_isValid;
}

QString OAIQueueObject_queue_inner::getLanguage() const {
    return m_language;
}
void OAIQueueObject_queue_inner::setLanguage(const QString &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIQueueObject_queue_inner::is_language_Set() const{
    return m_language_isSet;
}

bool OAIQueueObject_queue_inner::is_language_Valid() const{
    return m_language_isValid;
}

QList<QString> OAIQueueObject_queue_inner::getLanguages() const {
    return m_languages;
}
void OAIQueueObject_queue_inner::setLanguages(const QList<QString> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIQueueObject_queue_inner::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIQueueObject_queue_inner::is_languages_Valid() const{
    return m_languages_isValid;
}

QString OAIQueueObject_queue_inner::getReleaseDate() const {
    return m_release_date;
}
void OAIQueueObject_queue_inner::setReleaseDate(const QString &release_date) {
    m_release_date = release_date;
    m_release_date_isSet = true;
}

bool OAIQueueObject_queue_inner::is_release_date_Set() const{
    return m_release_date_isSet;
}

bool OAIQueueObject_queue_inner::is_release_date_Valid() const{
    return m_release_date_isValid;
}

QString OAIQueueObject_queue_inner::getReleaseDatePrecision() const {
    return m_release_date_precision;
}
void OAIQueueObject_queue_inner::setReleaseDatePrecision(const QString &release_date_precision) {
    m_release_date_precision = release_date_precision;
    m_release_date_precision_isSet = true;
}

bool OAIQueueObject_queue_inner::is_release_date_precision_Set() const{
    return m_release_date_precision_isSet;
}

bool OAIQueueObject_queue_inner::is_release_date_precision_Valid() const{
    return m_release_date_precision_isValid;
}

OAIResumePointObject OAIQueueObject_queue_inner::getResumePoint() const {
    return m_resume_point;
}
void OAIQueueObject_queue_inner::setResumePoint(const OAIResumePointObject &resume_point) {
    m_resume_point = resume_point;
    m_resume_point_isSet = true;
}

bool OAIQueueObject_queue_inner::is_resume_point_Set() const{
    return m_resume_point_isSet;
}

bool OAIQueueObject_queue_inner::is_resume_point_Valid() const{
    return m_resume_point_isValid;
}

OAISimplifiedShowObject OAIQueueObject_queue_inner::getShow() const {
    return m_show;
}
void OAIQueueObject_queue_inner::setShow(const OAISimplifiedShowObject &show) {
    m_show = show;
    m_show_isSet = true;
}

bool OAIQueueObject_queue_inner::is_show_Set() const{
    return m_show_isSet;
}

bool OAIQueueObject_queue_inner::is_show_Valid() const{
    return m_show_isValid;
}

bool OAIQueueObject_queue_inner::isSet() const {
...
bool OAIQueueObject_queue_inner::isValid() const {
