...
#include "OAISimplifiedEpisodeObject.h"
...
OAISimplifiedEpisodeObject::OAISimplifiedEpisodeObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISimplifiedEpisodeObject::OAISimplifiedEpisodeObject() {
    this->initializeModel();
}

OAISimplifiedEpisodeObject::~OAISimplifiedEpisodeObject() {}

void OAISimplifiedEpisodeObject::initializeModel() {
...
void OAISimplifiedEpisodeObject::fromJson(QString jsonString) {
...
void OAISimplifiedEpisodeObject::fromJsonObject(QJsonObject json) {
...
QString OAISimplifiedEpisodeObject::asJson() const {
...
QJsonObject OAISimplifiedEpisodeObject::asJsonObject() const {
    QJsonObject obj;
...
QString OAISimplifiedEpisodeObject::getAudioPreviewUrl() const {
    return m_audio_preview_url;
}
void OAISimplifiedEpisodeObject::setAudioPreviewUrl(const QString &audio_preview_url) {
    m_audio_preview_url = audio_preview_url;
    m_audio_preview_url_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_audio_preview_url_Set() const{
    return m_audio_preview_url_isSet;
}

bool OAISimplifiedEpisodeObject::is_audio_preview_url_Valid() const{
    return m_audio_preview_url_isValid;
}

QString OAISimplifiedEpisodeObject::getDescription() const {
    return m_description;
}
void OAISimplifiedEpisodeObject::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_description_Set() const{
    return m_description_isSet;
}

bool OAISimplifiedEpisodeObject::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAISimplifiedEpisodeObject::getDurationMs() const {
    return m_duration_ms;
}
void OAISimplifiedEpisodeObject::setDurationMs(const qint32 &duration_ms) {
    m_duration_ms = duration_ms;
    m_duration_ms_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_duration_ms_Set() const{
    return m_duration_ms_isSet;
}

bool OAISimplifiedEpisodeObject::is_duration_ms_Valid() const{
    return m_duration_ms_isValid;
}

bool OAISimplifiedEpisodeObject::isRExplicit() const {
    return m_r_explicit;
}
void OAISimplifiedEpisodeObject::setRExplicit(const bool &r_explicit) {
    m_r_explicit = r_explicit;
    m_r_explicit_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_r_explicit_Set() const{
    return m_r_explicit_isSet;
}

bool OAISimplifiedEpisodeObject::is_r_explicit_Valid() const{
    return m_r_explicit_isValid;
}

OAIExternalUrlObject OAISimplifiedEpisodeObject::getExternalUrls() const {
    return m_external_urls;
}
void OAISimplifiedEpisodeObject::setExternalUrls(const OAIExternalUrlObject &external_urls) {
    m_external_urls = external_urls;
    m_external_urls_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_external_urls_Set() const{
    return m_external_urls_isSet;
}

bool OAISimplifiedEpisodeObject::is_external_urls_Valid() const{
    return m_external_urls_isValid;
}

QString OAISimplifiedEpisodeObject::getHref() const {
    return m_href;
}
void OAISimplifiedEpisodeObject::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_href_Set() const{
    return m_href_isSet;
}

bool OAISimplifiedEpisodeObject::is_href_Valid() const{
    return m_href_isValid;
}

QString OAISimplifiedEpisodeObject::getHtmlDescription() const {
    return m_html_description;
}
void OAISimplifiedEpisodeObject::setHtmlDescription(const QString &html_description) {
    m_html_description = html_description;
    m_html_description_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_html_description_Set() const{
    return m_html_description_isSet;
}

bool OAISimplifiedEpisodeObject::is_html_description_Valid() const{
    return m_html_description_isValid;
}

QString OAISimplifiedEpisodeObject::getId() const {
    return m_id;
}
void OAISimplifiedEpisodeObject::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_id_Set() const{
    return m_id_isSet;
}

bool OAISimplifiedEpisodeObject::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIImageObject> OAISimplifiedEpisodeObject::getImages() const {
    return m_images;
}
void OAISimplifiedEpisodeObject::setImages(const QList<OAIImageObject> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_images_Set() const{
    return m_images_isSet;
}

bool OAISimplifiedEpisodeObject::is_images_Valid() const{
    return m_images_isValid;
}

bool OAISimplifiedEpisodeObject::isIsExternallyHosted() const {
    return m_is_externally_hosted;
}
void OAISimplifiedEpisodeObject::setIsExternallyHosted(const bool &is_externally_hosted) {
    m_is_externally_hosted = is_externally_hosted;
    m_is_externally_hosted_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_is_externally_hosted_Set() const{
    return m_is_externally_hosted_isSet;
}

bool OAISimplifiedEpisodeObject::is_is_externally_hosted_Valid() const{
    return m_is_externally_hosted_isValid;
}

bool OAISimplifiedEpisodeObject::isIsPlayable() const {
    return m_is_playable;
}
void OAISimplifiedEpisodeObject::setIsPlayable(const bool &is_playable) {
    m_is_playable = is_playable;
    m_is_playable_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_is_playable_Set() const{
    return m_is_playable_isSet;
}

bool OAISimplifiedEpisodeObject::is_is_playable_Valid() const{
    return m_is_playable_isValid;
}

QString OAISimplifiedEpisodeObject::getLanguage() const {
    return m_language;
}
void OAISimplifiedEpisodeObject::setLanguage(const QString &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_language_Set() const{
    return m_language_isSet;
}

bool OAISimplifiedEpisodeObject::is_language_Valid() const{
    return m_language_isValid;
}

QList<QString> OAISimplifiedEpisodeObject::getLanguages() const {
    return m_languages;
}
void OAISimplifiedEpisodeObject::setLanguages(const QList<QString> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAISimplifiedEpisodeObject::is_languages_Valid() const{
    return m_languages_isValid;
}

QString OAISimplifiedEpisodeObject::getName() const {
    return m_name;
}
void OAISimplifiedEpisodeObject::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_name_Set() const{
    return m_name_isSet;
}

bool OAISimplifiedEpisodeObject::is_name_Valid() const{
    return m_name_isValid;
}

QString OAISimplifiedEpisodeObject::getReleaseDate() const {
    return m_release_date;
}
void OAISimplifiedEpisodeObject::setReleaseDate(const QString &release_date) {
    m_release_date = release_date;
    m_release_date_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_release_date_Set() const{
    return m_release_date_isSet;
}

bool OAISimplifiedEpisodeObject::is_release_date_Valid() const{
    return m_release_date_isValid;
}

QString OAISimplifiedEpisodeObject::getReleaseDatePrecision() const {
    return m_release_date_precision;
}
void OAISimplifiedEpisodeObject::setReleaseDatePrecision(const QString &release_date_precision) {
    m_release_date_precision = release_date_precision;
    m_release_date_precision_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_release_date_precision_Set() const{
    return m_release_date_precision_isSet;
}

bool OAISimplifiedEpisodeObject::is_release_date_precision_Valid() const{
    return m_release_date_precision_isValid;
}

OAIEpisodeRestrictionObject OAISimplifiedEpisodeObject::getRestrictions() const {
    return m_restrictions;
}
void OAISimplifiedEpisodeObject::setRestrictions(const OAIEpisodeRestrictionObject &restrictions) {
    m_restrictions = restrictions;
    m_restrictions_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_restrictions_Set() const{
    return m_restrictions_isSet;
}

bool OAISimplifiedEpisodeObject::is_restrictions_Valid() const{
    return m_restrictions_isValid;
}

OAIResumePointObject OAISimplifiedEpisodeObject::getResumePoint() const {
    return m_resume_point;
}
void OAISimplifiedEpisodeObject::setResumePoint(const OAIResumePointObject &resume_point) {
    m_resume_point = resume_point;
    m_resume_point_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_resume_point_Set() const{
    return m_resume_point_isSet;
}

bool OAISimplifiedEpisodeObject::is_resume_point_Valid() const{
    return m_resume_point_isValid;
}

QString OAISimplifiedEpisodeObject::getType() const {
    return m_type;
}
void OAISimplifiedEpisodeObject::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_type_Set() const{
    return m_type_isSet;
}

bool OAISimplifiedEpisodeObject::is_type_Valid() const{
    return m_type_isValid;
}

QString OAISimplifiedEpisodeObject::getUri() const {
    return m_uri;
}
void OAISimplifiedEpisodeObject::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAISimplifiedEpisodeObject::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAISimplifiedEpisodeObject::is_uri_Valid() const{
    return m_uri_isValid;
}

bool OAISimplifiedEpisodeObject::isSet() const {
...
bool OAISimplifiedEpisodeObject::isValid() const {
