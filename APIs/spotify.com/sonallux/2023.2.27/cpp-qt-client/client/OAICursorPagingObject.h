...
/*
 * OAICursorPagingObject.h
 *
 * 
 */

#ifndef OAICursorPagingObject_H
#define OAICursorPagingObject_H
...
class OAICursorPagingObject : public OAIObject {
public:
    OAICursorPagingObject();
    OAICursorPagingObject(QString json);
    ~OAICursorPagingObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICursorPagingObject)

#endif // OAICursorPagingObject_H
