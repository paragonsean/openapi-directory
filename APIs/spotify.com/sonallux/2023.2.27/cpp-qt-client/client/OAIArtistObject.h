...
#ifndef OAIArtistObject_H
#define OAIArtistObject_H
...
class OAIArtistObject : public OAIObject {
public:
    OAIArtistObject();
    OAIArtistObject(QString json);
    ~OAIArtistObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArtistObject)

#endif // OAIArtistObject_H
