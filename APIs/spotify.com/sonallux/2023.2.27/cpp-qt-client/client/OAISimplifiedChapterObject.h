...
/*
 * OAISimplifiedChapterObject.h
 *
 * 
 */

#ifndef OAISimplifiedChapterObject_H
#define OAISimplifiedChapterObject_H
...
class OAISimplifiedChapterObject : public OAIObject {
public:
    OAISimplifiedChapterObject();
    OAISimplifiedChapterObject(QString json);
    ~OAISimplifiedChapterObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimplifiedChapterObject)

#endif // OAISimplifiedChapterObject_H
