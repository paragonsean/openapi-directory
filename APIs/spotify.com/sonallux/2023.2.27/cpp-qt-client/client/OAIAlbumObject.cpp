...
OAIAlbumObject::OAIAlbumObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAlbumObject::OAIAlbumObject() {
    this->initializeModel();
}

OAIAlbumObject::~OAIAlbumObject() {}

void OAIAlbumObject::initializeModel() {
...
void OAIAlbumObject::fromJson(QString jsonString) {
...
void OAIAlbumObject::fromJsonObject(QJsonObject json) {
...
QString OAIAlbumObject::asJson() const {
...
QJsonObject OAIAlbumObject::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAlbumObject::getAlbumType() const {
    return m_album_type;
}
void OAIAlbumObject::setAlbumType(const QString &album_type) {
    m_album_type = album_type;
    m_album_type_isSet = true;
}

bool OAIAlbumObject::is_album_type_Set() const{
    return m_album_type_isSet;
}

bool OAIAlbumObject::is_album_type_Valid() const{
    return m_album_type_isValid;
}

QList<QString> OAIAlbumObject::getAvailableMarkets() const {
    return m_available_markets;
}
void OAIAlbumObject::setAvailableMarkets(const QList<QString> &available_markets) {
    m_available_markets = available_markets;
    m_available_markets_isSet = true;
}

bool OAIAlbumObject::is_available_markets_Set() const{
    return m_available_markets_isSet;
}

bool OAIAlbumObject::is_available_markets_Valid() const{
    return m_available_markets_isValid;
}

OAIExternalUrlObject OAIAlbumObject::getExternalUrls() const {
    return m_external_urls;
}
void OAIAlbumObject::setExternalUrls(const OAIExternalUrlObject &external_urls) {
    m_external_urls = external_urls;
    m_external_urls_isSet = true;
}

bool OAIAlbumObject::is_external_urls_Set() const{
    return m_external_urls_isSet;
}

bool OAIAlbumObject::is_external_urls_Valid() const{
    return m_external_urls_isValid;
}

QString OAIAlbumObject::getHref() const {
    return m_href;
}
void OAIAlbumObject::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAIAlbumObject::is_href_Set() const{
    return m_href_isSet;
}

bool OAIAlbumObject::is_href_Valid() const{
    return m_href_isValid;
}

QString OAIAlbumObject::getId() const {
    return m_id;
}
void OAIAlbumObject::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAlbumObject::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAlbumObject::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIImageObject> OAIAlbumObject::getImages() const {
    return m_images;
}
void OAIAlbumObject::setImages(const QList<OAIImageObject> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAIAlbumObject::is_images_Set() const{
    return m_images_isSet;
}

bool OAIAlbumObject::is_images_Valid() const{
    return m_images_isValid;
}

QString OAIAlbumObject::getName() const {
    return m_name;
}
void OAIAlbumObject::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAlbumObject::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAlbumObject::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIAlbumObject::getReleaseDate() const {
    return m_release_date;
}
void OAIAlbumObject::setReleaseDate(const QString &release_date) {
    m_release_date = release_date;
    m_release_date_isSet = true;
}

bool OAIAlbumObject::is_release_date_Set() const{
    return m_release_date_isSet;
}

bool OAIAlbumObject::is_release_date_Valid() const{
    return m_release_date_isValid;
}

QString OAIAlbumObject::getReleaseDatePrecision() const {
    return m_release_date_precision;
}
void OAIAlbumObject::setReleaseDatePrecision(const QString &release_date_precision) {
    m_release_date_precision = release_date_precision;
    m_release_date_precision_isSet = true;
}

bool OAIAlbumObject::is_release_date_precision_Set() const{
    return m_release_date_precision_isSet;
}

bool OAIAlbumObject::is_release_date_precision_Valid() const{
    return m_release_date_precision_isValid;
}

OAIAlbumRestrictionObject OAIAlbumObject::getRestrictions() const {
    return m_restrictions;
}
void OAIAlbumObject::setRestrictions(const OAIAlbumRestrictionObject &restrictions) {
    m_restrictions = restrictions;
    m_restrictions_isSet = true;
}

bool OAIAlbumObject::is_restrictions_Set() const{
    return m_restrictions_isSet;
}

bool OAIAlbumObject::is_restrictions_Valid() const{
    return m_restrictions_isValid;
}

qint32 OAIAlbumObject::getTotalTracks() const {
    return m_total_tracks;
}
void OAIAlbumObject::setTotalTracks(const qint32 &total_tracks) {
    m_total_tracks = total_tracks;
    m_total_tracks_isSet = true;
}

bool OAIAlbumObject::is_total_tracks_Set() const{
    return m_total_tracks_isSet;
}

bool OAIAlbumObject::is_total_tracks_Valid() const{
    return m_total_tracks_isValid;
}

QString OAIAlbumObject::getType() const {
    return m_type;
}
void OAIAlbumObject::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAlbumObject::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAlbumObject::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIAlbumObject::getUri() const {
    return m_uri;
}
void OAIAlbumObject::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAIAlbumObject::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAIAlbumObject::is_uri_Valid() const{
    return m_uri_isValid;
}

QList<OAISimplifiedArtistObject> OAIAlbumObject::getArtists() const {
    return m_artists;
}
void OAIAlbumObject::setArtists(const QList<OAISimplifiedArtistObject> &artists) {
    m_artists = artists;
    m_artists_isSet = true;
}

bool OAIAlbumObject::is_artists_Set() const{
    return m_artists_isSet;
}

bool OAIAlbumObject::is_artists_Valid() const{
    return m_artists_isValid;
}

QList<OAICopyrightObject> OAIAlbumObject::getCopyrights() const {
    return m_copyrights;
}
void OAIAlbumObject::setCopyrights(const QList<OAICopyrightObject> &copyrights) {
    m_copyrights = copyrights;
    m_copyrights_isSet = true;
}

bool OAIAlbumObject::is_copyrights_Set() const{
    return m_copyrights_isSet;
}

bool OAIAlbumObject::is_copyrights_Valid() const{
    return m_copyrights_isValid;
}

OAIExternalIdObject OAIAlbumObject::getExternalIds() const {
    return m_external_ids;
}
void OAIAlbumObject::setExternalIds(const OAIExternalIdObject &external_ids) {
    m_external_ids = external_ids;
    m_external_ids_isSet = true;
}

bool OAIAlbumObject::is_external_ids_Set() const{
    return m_external_ids_isSet;
}

bool OAIAlbumObject::is_external_ids_Valid() const{
    return m_external_ids_isValid;
}

QList<QString> OAIAlbumObject::getGenres() const {
    return m_genres;
}
void OAIAlbumObject::setGenres(const QList<QString> &genres) {
    m_genres = genres;
    m_genres_isSet = true;
}

bool OAIAlbumObject::is_genres_Set() const{
    return m_genres_isSet;
}

bool OAIAlbumObject::is_genres_Valid() const{
    return m_genres_isValid;
}

QString OAIAlbumObject::getLabel() const {
    return m_label;
}
void OAIAlbumObject::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIAlbumObject::is_label_Set() const{
    return m_label_isSet;
}

bool OAIAlbumObject::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAIAlbumObject::getPopularity() const {
    return m_popularity;
}
void OAIAlbumObject::setPopularity(const qint32 &popularity) {
    m_popularity = popularity;
    m_popularity_isSet = true;
}

bool OAIAlbumObject::is_popularity_Set() const{
    return m_popularity_isSet;
}

bool OAIAlbumObject::is_popularity_Valid() const{
    return m_popularity_isValid;
}

OAIPagingSimplifiedTrackObject OAIAlbumObject::getTracks() const {
    return m_tracks;
}
void OAIAlbumObject::setTracks(const OAIPagingSimplifiedTrackObject &tracks) {
    m_tracks = tracks;
    m_tracks_isSet = true;
}

bool OAIAlbumObject::is_tracks_Set() const{
    return m_tracks_isSet;
}

bool OAIAlbumObject::is_tracks_Valid() const{
    return m_tracks_isValid;
}

bool OAIAlbumObject::isSet() const {
...
bool OAIAlbumObject::isValid() const {
