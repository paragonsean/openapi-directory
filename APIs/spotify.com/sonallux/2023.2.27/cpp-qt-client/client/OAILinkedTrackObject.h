...
/*
 * OAILinkedTrackObject.h
 *
 * 
 */

#ifndef OAILinkedTrackObject_H
#define OAILinkedTrackObject_H
...
class OAILinkedTrackObject : public OAIObject {
public:
    OAILinkedTrackObject();
    OAILinkedTrackObject(QString json);
    ~OAILinkedTrackObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinkedTrackObject)

#endif // OAILinkedTrackObject_H
