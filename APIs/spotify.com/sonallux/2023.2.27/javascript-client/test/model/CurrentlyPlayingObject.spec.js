...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.CurrentlyPlayingObject();
  });
  ...
  describe('CurrentlyPlayingObject', function() {
    it('should create an instance of CurrentlyPlayingObject', function() {
      ...
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.CurrentlyPlayingObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.CurrentlyPlayingObject);
    });
