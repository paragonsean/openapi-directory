...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.SectionObject();
  });
  ...
  describe('SectionObject', function() {
    it('should create an instance of SectionObject', function() {
      // uncomment below and update the code to test SectionObject
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.SectionObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.SectionObject);
    });
