...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistTrackObjectTrack();
  });
  ...
  describe('PlaylistTrackObjectTrack', function() {
    it('should create an instance of PlaylistTrackObjectTrack', function() {
      // uncomment below and update the code to test PlaylistTrackObjectTrack
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistTrackObjectTrack();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistTrackObjectTrack);
    });
