...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.SimplifiedChapterObject();
  });
  ...
  describe('SimplifiedChapterObject', function() {
    it('should create an instance of SimplifiedChapterObject', function() {
      // uncomment below and update the code to test SimplifiedChapterObject
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.SimplifiedChapterObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.SimplifiedChapterObject);
    });
