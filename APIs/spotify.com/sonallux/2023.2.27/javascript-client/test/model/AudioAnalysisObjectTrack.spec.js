...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudioAnalysisObjectTrack();
  });
  ...
  describe('AudioAnalysisObjectTrack', function() {
    it('should create an instance of AudioAnalysisObjectTrack', function() {
      ...
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudioAnalysisObjectTrack();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudioAnalysisObjectTrack);
    });
