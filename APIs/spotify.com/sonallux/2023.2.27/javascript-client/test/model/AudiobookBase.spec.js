...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudiobookBase();
  });
  ...
  describe('AudiobookBase', function() {
    it('should create an instance of AudiobookBase', function() {
      // uncomment below and update the code to test AudiobookBase
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudiobookBase();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudiobookBase);
    });
