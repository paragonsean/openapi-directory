...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.ExternalIdObject();
  });
  ...
  describe('ExternalIdObject', function() {
    it('should create an instance of ExternalIdObject', function() {
      // uncomment below and update the code to test ExternalIdObject
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.ExternalIdObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.ExternalIdObject);
    });
