...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.QueueObjectQueueInner();
  });
  ...
  describe('QueueObjectQueueInner', function() {
    it('should create an instance of QueueObjectQueueInner', function() {
      // uncomment below and update the code to test QueueObjectQueueInner
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.QueueObjectQueueInner();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.QueueObjectQueueInner);
    });
