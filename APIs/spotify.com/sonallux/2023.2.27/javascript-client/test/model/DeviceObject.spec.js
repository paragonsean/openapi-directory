...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.DeviceObject();
  });
  ...
  describe('DeviceObject', function() {
    it('should create an instance of DeviceObject', function() {
      ...
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.DeviceObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.DeviceObject);
    });
