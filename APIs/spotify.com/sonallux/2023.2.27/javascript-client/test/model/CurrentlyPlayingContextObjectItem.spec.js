...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.CurrentlyPlayingContextObjectItem();
  });
  ...
  describe('CurrentlyPlayingContextObjectItem', function() {
    it('should create an instance of CurrentlyPlayingContextObjectItem', function() {
      // uncomment below and update the code to test CurrentlyPlayingContextObjectItem
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.CurrentlyPlayingContextObjectItem();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.CurrentlyPlayingContextObjectItem);
    });
