...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistTrackObject();
  });
  ...
  describe('PlaylistTrackObject', function() {
    it('should create an instance of PlaylistTrackObject', function() {
      // uncomment below and update the code to test PlaylistTrackObject
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistTrackObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistTrackObject);
    });
