...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.PublicUserObject();
  });
  ...
  describe('PublicUserObject', function() {
    it('should create an instance of PublicUserObject', function() {
      // uncomment below and update the code to test PublicUserObject
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.PublicUserObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.PublicUserObject);
    });
