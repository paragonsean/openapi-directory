...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudiobookObject();
  });
  ...
  describe('AudiobookObject', function() {
    it('should create an instance of AudiobookObject', function() {
      ...
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudiobookObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudiobookObject);
    });
