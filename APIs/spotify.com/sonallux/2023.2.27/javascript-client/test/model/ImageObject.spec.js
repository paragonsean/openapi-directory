...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.ImageObject();
  });
  ...
  describe('ImageObject', function() {
    it('should create an instance of ImageObject', function() {
      ...
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.ImageObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.ImageObject);
    });
