...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.CursorObject();
  });
  ...
  describe('CursorObject', function() {
    it('should create an instance of CursorObject', function() {
      ...
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.CursorObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.CursorObject);
    });
