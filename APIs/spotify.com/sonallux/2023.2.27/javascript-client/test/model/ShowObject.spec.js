...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.ShowObject();
  });
  ...
  describe('ShowObject', function() {
    it('should create an instance of ShowObject', function() {
      // uncomment below and update the code to test ShowObject
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.ShowObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.ShowObject);
    });
