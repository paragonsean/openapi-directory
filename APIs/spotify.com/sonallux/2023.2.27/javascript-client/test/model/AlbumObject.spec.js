...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AlbumObject();
  });
  ...
  describe('AlbumObject', function() {
    it('should create an instance of AlbumObject', function() {
      // uncomment below and update the code to test AlbumObject
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AlbumObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.AlbumObject);
    });
