...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudioFeaturesObject();
  });
  ...
  describe('AudioFeaturesObject', function() {
    it('should create an instance of AudioFeaturesObject', function() {
      ...
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudioFeaturesObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudioFeaturesObject);
    });
