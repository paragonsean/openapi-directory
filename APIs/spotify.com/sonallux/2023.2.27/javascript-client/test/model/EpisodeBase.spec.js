...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.EpisodeBase();
  });
  ...
  describe('EpisodeBase', function() {
    it('should create an instance of EpisodeBase', function() {
      // uncomment below and update the code to test EpisodeBase
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.EpisodeBase();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.EpisodeBase);
    });
