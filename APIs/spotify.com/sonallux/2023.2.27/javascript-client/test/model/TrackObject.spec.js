...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.TrackObject();
  });
  ...
  describe('TrackObject', function() {
    it('should create an instance of TrackObject', function() {
      // uncomment below and update the code to test TrackObject
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.TrackObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.TrackObject);
    });
