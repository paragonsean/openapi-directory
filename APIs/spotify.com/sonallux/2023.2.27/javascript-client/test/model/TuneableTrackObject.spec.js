...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.TuneableTrackObject();
  });
  ...
  describe('TuneableTrackObject', function() {
    it('should create an instance of TuneableTrackObject', function() {
      // uncomment below and update the code to test TuneableTrackObject
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.TuneableTrackObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.TuneableTrackObject);
    });
