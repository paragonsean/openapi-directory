...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistOwnerObject();
  });
  ...
  describe('PlaylistOwnerObject', function() {
    it('should create an instance of PlaylistOwnerObject', function() {
      ...
      //var instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistOwnerObject();
      //expect(instance).to.be.a(SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistOwnerObject);
    });
