...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    ...
    describe('getUsersTopArtists', function() {
      it('should call getUsersTopArtists successfully', function(done) {
        //uncomment below and update the code to test getUsersTopArtists
        //instance.getUsersTopArtists(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getUsersTopTracks', function() {
      it('should call getUsersTopTracks successfully', function(done) {
        //uncomment below and update the code to test getUsersTopTracks
        //instance.getUsersTopTracks(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
