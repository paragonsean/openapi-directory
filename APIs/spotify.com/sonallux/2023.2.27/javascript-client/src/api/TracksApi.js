...
export default class TracksApi {
    ...
    */
     ...
     */
    getRecommendations(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'limit': opts['limit'],
        'market': opts['market'],
        'seed_artists': opts['seedArtists'],
        'seed_genres': opts['seedGenres'],
        'seed_tracks': opts['seedTracks'],
    ...
    /**
     * Callback function to receive the result of the getUsersTopTracks_0 operation.
     * @callback module:api/TracksApi~getUsersTopTracks_0Callback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} [limit = 20)] 
     * @param {Number} [offset = 0)] 
     * @param {module:api/TracksApi~getUsersTopTracks_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PagingTrackObject}
     */
    getUsersTopTracks_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
