...
export default class PlayerApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/DevicesObject} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/DevicesObject}
     */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/CurrentlyPlayingObject} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/CurrentlyPlayingObject}
     */
    getTheUsersCurrentlyPlayingTrack(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = CurrentlyPlayingObject;
      return this.apiClient.callApi(
