...
/**
 * The AlbumBase model module.
 * @module model/AlbumBase
 * @version 2023.2.27
 */
class AlbumBase {
    /**
     * Constructs a new <code>AlbumBase</code>.
     * @alias module:model/AlbumBase
     * @param albumType {module:model/AlbumBase.AlbumTypeEnum} The type of the album. 
     ...
     * @param releaseDatePrecision {module:model/AlbumBase.ReleaseDatePrecisionEnum} The precision with which `release_date` value is known. 
     * @param totalTracks {Number} The number of tracks in the album.
     * @param type {module:model/AlbumBase.TypeEnum} The object type. 
     * @param uri {String} The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the album. 
     */
    constructor(albumType, availableMarkets, externalUrls, href, id, images, name, releaseDate, releaseDatePrecision, totalTracks, type, uri) { 
     ...
     */
    static initialize(obj, albumType, availableMarkets, externalUrls, href, id, images, name, releaseDate, releaseDatePrecision, totalTracks, type, uri) { 
    ...
    /**
     * Constructs a <code>AlbumBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AlbumBase} obj Optional instance to populate.
     * @return {module:model/AlbumBase} The populated <code>AlbumBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AlbumBase();
    ...
    /**
     * Validates the JSON data with respect to <code>AlbumBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AlbumBase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AlbumBase.RequiredProperties) {
...
AlbumBase.RequiredProperties = ["album_type", "available_markets", "external_urls", "href", "id", "images", "name", "release_date", "release_date_precision", "total_tracks", "type", "uri"];
 ...
 * @readonly
 */
AlbumBase['ReleaseDatePrecisionEnum'] = {
