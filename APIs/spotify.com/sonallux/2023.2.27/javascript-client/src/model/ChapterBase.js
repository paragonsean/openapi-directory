...
/**
 * The ChapterBase model module.
 * @module model/ChapterBase
 * @version 2023.2.27
 */
class ChapterBase {
    /**
     * Constructs a new <code>ChapterBase</code>.
     * @alias module:model/ChapterBase
     ...
     * @param releaseDatePrecision {module:model/ChapterBase.ReleaseDatePrecisionEnum} The precision with which `release_date` value is known. 
     ...
     * @param type {module:model/ChapterBase.TypeEnum} The object type. 
    ...
    /**
     * Constructs a <code>ChapterBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChapterBase} obj Optional instance to populate.
     * @return {module:model/ChapterBase} The populated <code>ChapterBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChapterBase();
    ...
    /**
     * Validates the JSON data with respect to <code>ChapterBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChapterBase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChapterBase.RequiredProperties) {
...
ChapterBase.RequiredProperties = ["audio_preview_url", "chapter_number", "description", "duration_ms", "explicit", "external_urls", "href", "html_description", "id", "images", "is_playable", "languages", "name", "release_date", "release_date_precision", "resume_point", "type", "uri"];
 ...
 * @readonly
 */
ChapterBase['ReleaseDatePrecisionEnum'] = {
