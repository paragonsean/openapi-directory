...
/**
 * The AlbumObject model module.
 * @module model/AlbumObject
 * @version 2023.2.27
 */
class AlbumObject {
    /**
     * Constructs a new <code>AlbumObject</code>.
     * @alias module:model/AlbumObject
     * @implements module:model/AlbumBase
     * @param albumType {module:model/AlbumObject.AlbumTypeEnum} The type of the album. 
     ...
     * @param releaseDatePrecision {module:model/AlbumObject.ReleaseDatePrecisionEnum} The precision with which `release_date` value is known. 
     * @param totalTracks {Number} The number of tracks in the album.
     * @param type {module:model/AlbumObject.TypeEnum} The object type. 
    ...
    constructor(albumType, availableMarkets, externalUrls, href, id, images, name, releaseDate, releaseDatePrecision, totalTracks, type, uri) { 
        ...
        AlbumObject.initialize(this, albumType, availableMarkets, externalUrls, href, id, images, name, releaseDate, releaseDatePrecision, totalTracks, type, uri);
    }
    ...
    /**
     * Constructs a <code>AlbumObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AlbumObject} obj Optional instance to populate.
     * @return {module:model/AlbumObject} The populated <code>AlbumObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AlbumObject();
            ...
            if (data.hasOwnProperty('tracks')) {
                obj['tracks'] = ApiClient.convertToType(data['tracks'], PagingSimplifiedTrackObject);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AlbumObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AlbumObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AlbumObject.RequiredProperties) {
        ...
        if (data['tracks']) { // data not null
          PagingSimplifiedTrackObject.validateJSON(data['tracks']);
        }
...
AlbumObject.RequiredProperties = ["album_type", "available_markets", "external_urls", "href", "id", "images", "name", "release_date", "release_date_precision", "total_tracks", "type", "uri"];

/**
 * The type of the album. 
 * @member {module:model/AlbumObject.AlbumTypeEnum} album_type
 */
AlbumObject.prototype['album_type'] = undefined;

/**
 * The markets in which the album is available: [ISO 3166-1 alpha-2 country codes](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2). _**NOTE**: an album is considered available in a market when at least 1 of its tracks is available in that market._ 
 * @member {Array.<String>} available_markets
 */
AlbumObject.prototype['available_markets'] = undefined;

/**
 * Known external URLs for this album. 
 * @member {module:model/ExternalUrlObject} external_urls
 */
AlbumObject.prototype['external_urls'] = undefined;

/**
 * A link to the Web API endpoint providing full details of the album. 
 * @member {String} href
 */
AlbumObject.prototype['href'] = undefined;

/**
 * The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the album. 
 * @member {String} id
 */
AlbumObject.prototype['id'] = undefined;

/**
 * The cover art for the album in various sizes, widest first. 
 * @member {Array.<module:model/ImageObject>} images
 */
AlbumObject.prototype['images'] = undefined;

/**
 * The name of the album. In case of an album takedown, the value may be an empty string. 
 * @member {String} name
 */
AlbumObject.prototype['name'] = undefined;

/**
 * The date the album was first released. 
 * @member {String} release_date
 */
AlbumObject.prototype['release_date'] = undefined;

/**
 * The precision with which `release_date` value is known. 
 * @member {module:model/AlbumObject.ReleaseDatePrecisionEnum} release_date_precision
 */
AlbumObject.prototype['release_date_precision'] = undefined;

/**
 * Included in the response when a content restriction is applied. 
 * @member {module:model/AlbumRestrictionObject} restrictions
 */
AlbumObject.prototype['restrictions'] = undefined;

/**
 * The number of tracks in the album.
 * @member {Number} total_tracks
 */
AlbumObject.prototype['total_tracks'] = undefined;

/**
 * The object type. 
 * @member {module:model/AlbumObject.TypeEnum} type
 */
AlbumObject.prototype['type'] = undefined;

/**
 * The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the album. 
 * @member {String} uri
 */
AlbumObject.prototype['uri'] = undefined;

/**
 * The artists of the album. Each artist object includes a link in `href` to more detailed information about the artist. 
 * @member {Array.<module:model/SimplifiedArtistObject>} artists
 */
AlbumObject.prototype['artists'] = undefined;

/**
 * The copyright statements of the album.
 * @member {Array.<module:model/CopyrightObject>} copyrights
 */
AlbumObject.prototype['copyrights'] = undefined;

/**
 * Known external IDs for the album. 
 * @member {module:model/ExternalIdObject} external_ids
 */
AlbumObject.prototype['external_ids'] = undefined;

/**
 * A list of the genres used to classify the album. (If not yet classified, the array is empty.)
 * @member {Array.<String>} genres
 */
AlbumObject.prototype['genres'] = undefined;

/**
 * The label for the album.
 * @member {String} label
 */
AlbumObject.prototype['label'] = undefined;
 ...
 */
AlbumObject.prototype['popularity'] = undefined;

/**
 * The tracks of the album. 
 * @member {module:model/PagingSimplifiedTrackObject} tracks
 */
AlbumObject.prototype['tracks'] = undefined;
 ...
 * @readonly
 */
AlbumObject['ReleaseDatePrecisionEnum'] = {
