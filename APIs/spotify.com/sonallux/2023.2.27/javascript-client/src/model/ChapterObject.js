...
class ChapterObject {
     ...
     * @param audiobook {module:model/SimplifiedAudiobookObject} The audiobook for which the chapter belongs. 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('audiobook')) {
                obj['audiobook'] = ApiClient.convertToType(data['audiobook'], SimplifiedAudiobookObject);
            }
        }
        return obj;
    }
