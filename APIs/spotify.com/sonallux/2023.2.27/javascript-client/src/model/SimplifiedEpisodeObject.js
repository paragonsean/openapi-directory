...
/**
 * The SimplifiedEpisodeObject model module.
 * @module model/SimplifiedEpisodeObject
 * @version 2023.2.27
 */
class SimplifiedEpisodeObject {
    /**
     * Constructs a new <code>SimplifiedEpisodeObject</code>.
     * @alias module:model/SimplifiedEpisodeObject
     ...
     * @param releaseDatePrecision {module:model/SimplifiedEpisodeObject.ReleaseDatePrecisionEnum} The precision with which `release_date` value is known. 
     ...
     * @param type {module:model/SimplifiedEpisodeObject.TypeEnum} The object type. 
    ...
    constructor(audioPreviewUrl, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isExternallyHosted, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri) { 
        ...
        SimplifiedEpisodeObject.initialize(this, audioPreviewUrl, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isExternallyHosted, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri);
    }
    ...
    /**
     * Constructs a <code>SimplifiedEpisodeObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimplifiedEpisodeObject} obj Optional instance to populate.
     * @return {module:model/SimplifiedEpisodeObject} The populated <code>SimplifiedEpisodeObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimplifiedEpisodeObject();
    ...
    /**
     * Validates the JSON data with respect to <code>SimplifiedEpisodeObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimplifiedEpisodeObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SimplifiedEpisodeObject.RequiredProperties) {
...
SimplifiedEpisodeObject.RequiredProperties = ["audio_preview_url", "description", "duration_ms", "explicit", "external_urls", "href", "html_description", "id", "images", "is_externally_hosted", "is_playable", "languages", "name", "release_date", "release_date_precision", "resume_point", "type", "uri"];

/**
 * A URL to a 30 second preview (MP3 format) of the episode. `null` if not available. 
 * @member {String} audio_preview_url
 */
SimplifiedEpisodeObject.prototype['audio_preview_url'] = undefined;

/**
 * A description of the episode. HTML tags are stripped away from this field, use `html_description` field in case HTML tags are needed. 
 * @member {String} description
 */
SimplifiedEpisodeObject.prototype['description'] = undefined;

/**
 * The episode length in milliseconds. 
 * @member {Number} duration_ms
 */
SimplifiedEpisodeObject.prototype['duration_ms'] = undefined;

/**
 * Whether or not the episode has explicit content (true = yes it does; false = no it does not OR unknown). 
 * @member {Boolean} explicit
 */
SimplifiedEpisodeObject.prototype['explicit'] = undefined;

/**
 * External URLs for this episode. 
 * @member {module:model/ExternalUrlObject} external_urls
 */
SimplifiedEpisodeObject.prototype['external_urls'] = undefined;

/**
 * A link to the Web API endpoint providing full details of the episode. 
 * @member {String} href
 */
SimplifiedEpisodeObject.prototype['href'] = undefined;

/**
 * A description of the episode. This field may contain HTML tags. 
 * @member {String} html_description
 */
SimplifiedEpisodeObject.prototype['html_description'] = undefined;

/**
 * The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
 * @member {String} id
 */
SimplifiedEpisodeObject.prototype['id'] = undefined;

/**
 * The cover art for the episode in various sizes, widest first. 
 * @member {Array.<module:model/ImageObject>} images
 */
SimplifiedEpisodeObject.prototype['images'] = undefined;

/**
 * True if the episode is hosted outside of Spotify's CDN. 
 * @member {Boolean} is_externally_hosted
 */
SimplifiedEpisodeObject.prototype['is_externally_hosted'] = undefined;

/**
 * True if the episode is playable in the given market. Otherwise false. 
 * @member {Boolean} is_playable
 */
SimplifiedEpisodeObject.prototype['is_playable'] = undefined;

/**
 * The language used in the episode, identified by a [ISO 639](https://en.wikipedia.org/wiki/ISO_639) code. This field is deprecated and might be removed in the future. Please use the `languages` field instead. 
 * @member {String} language
 */
SimplifiedEpisodeObject.prototype['language'] = undefined;

/**
 * A list of the languages used in the episode, identified by their [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639) code. 
 * @member {Array.<String>} languages
 */
SimplifiedEpisodeObject.prototype['languages'] = undefined;

/**
 * The name of the episode. 
 * @member {String} name
 */
SimplifiedEpisodeObject.prototype['name'] = undefined;

/**
 * The date the episode was first released, for example `\"1981-12-15\"`. Depending on the precision, it might be shown as `\"1981\"` or `\"1981-12\"`. 
 * @member {String} release_date
 */
SimplifiedEpisodeObject.prototype['release_date'] = undefined;

/**
 * The precision with which `release_date` value is known. 
 * @member {module:model/SimplifiedEpisodeObject.ReleaseDatePrecisionEnum} release_date_precision
 */
SimplifiedEpisodeObject.prototype['release_date_precision'] = undefined;

/**
 * Included in the response when a content restriction is applied. 
 * @member {module:model/EpisodeRestrictionObject} restrictions
 */
SimplifiedEpisodeObject.prototype['restrictions'] = undefined;

/**
 * The user's most recent position in the episode. Set if the supplied access token is a user token and has the scope 'user-read-playback-position'. 
 * @member {module:model/ResumePointObject} resume_point
 */
SimplifiedEpisodeObject.prototype['resume_point'] = undefined;

/**
 * The object type. 
 * @member {module:model/SimplifiedEpisodeObject.TypeEnum} type
 */
SimplifiedEpisodeObject.prototype['type'] = undefined;

/**
 * The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
 * @member {String} uri
 */
SimplifiedEpisodeObject.prototype['uri'] = undefined;
 ...
 * @readonly
 */
SimplifiedEpisodeObject['ReleaseDatePrecisionEnum'] = {
 ...
 * @readonly
 */
SimplifiedEpisodeObject['TypeEnum'] = {
...
export default SimplifiedEpisodeObject;
