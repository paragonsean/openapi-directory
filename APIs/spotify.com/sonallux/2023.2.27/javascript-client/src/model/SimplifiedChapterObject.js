...
/**
 * The SimplifiedChapterObject model module.
 * @module model/SimplifiedChapterObject
 * @version 2023.2.27
 */
class SimplifiedChapterObject {
    /**
     * Constructs a new <code>SimplifiedChapterObject</code>.
     * @alias module:model/SimplifiedChapterObject
     * @implements module:model/ChapterBase
     * @param audioPreviewUrl {String} A URL to a 30 second preview (MP3 format) of the episode. `null` if not available. 
     * @param chapterNumber {Number} The number of the chapter 
     ...
     * @param releaseDatePrecision {module:model/SimplifiedChapterObject.ReleaseDatePrecisionEnum} The precision with which `release_date` value is known. 
     ...
     * @param type {module:model/SimplifiedChapterObject.TypeEnum} The object type. 
     * @param uri {String} The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
     */
    constructor(audioPreviewUrl, chapterNumber, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri) { 
        ChapterBase.initialize(this, audioPreviewUrl, chapterNumber, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri);
        SimplifiedChapterObject.initialize(this, audioPreviewUrl, chapterNumber, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri);
    }
     ...
     */
    static initialize(obj, audioPreviewUrl, chapterNumber, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri) { 
    ...
    /**
     * Constructs a <code>SimplifiedChapterObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimplifiedChapterObject} obj Optional instance to populate.
     * @return {module:model/SimplifiedChapterObject} The populated <code>SimplifiedChapterObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimplifiedChapterObject();
            ChapterBase.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('restrictions')) {
                obj['restrictions'] = ApiClient.convertToType(data['restrictions'], ChapterRestrictionObject);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SimplifiedChapterObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimplifiedChapterObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SimplifiedChapterObject.RequiredProperties) {
        ...
        if (data['restrictions']) { // data not null
          ChapterRestrictionObject.validateJSON(data['restrictions']);
        }
...
SimplifiedChapterObject.RequiredProperties = ["audio_preview_url", "chapter_number", "description", "duration_ms", "explicit", "external_urls", "href", "html_description", "id", "images", "is_playable", "languages", "name", "release_date", "release_date_precision", "resume_point", "type", "uri"];

/**
 * A URL to a 30 second preview (MP3 format) of the episode. `null` if not available. 
 * @member {String} audio_preview_url
 */
SimplifiedChapterObject.prototype['audio_preview_url'] = undefined;
 ...
 */
SimplifiedChapterObject.prototype['available_markets'] = undefined;

/**
 * The number of the chapter 
 * @member {Number} chapter_number
 */
SimplifiedChapterObject.prototype['chapter_number'] = undefined;

/**
 * A description of the episode. HTML tags are stripped away from this field, use `html_description` field in case HTML tags are needed. 
 * @member {String} description
 */
SimplifiedChapterObject.prototype['description'] = undefined;

/**
 * The episode length in milliseconds. 
 * @member {Number} duration_ms
 */
SimplifiedChapterObject.prototype['duration_ms'] = undefined;

/**
 * Whether or not the episode has explicit content (true = yes it does; false = no it does not OR unknown). 
 * @member {Boolean} explicit
 */
SimplifiedChapterObject.prototype['explicit'] = undefined;

/**
 * External URLs for this episode. 
 * @member {module:model/ExternalUrlObject} external_urls
 */
SimplifiedChapterObject.prototype['external_urls'] = undefined;

/**
 * A link to the Web API endpoint providing full details of the episode. 
 * @member {String} href
 */
SimplifiedChapterObject.prototype['href'] = undefined;

/**
 * A description of the episode. This field may contain HTML tags. 
 * @member {String} html_description
 */
SimplifiedChapterObject.prototype['html_description'] = undefined;

/**
 * The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
 * @member {String} id
 */
SimplifiedChapterObject.prototype['id'] = undefined;

/**
 * The cover art for the episode in various sizes, widest first. 
 * @member {Array.<module:model/ImageObject>} images
 */
SimplifiedChapterObject.prototype['images'] = undefined;

/**
 * True if the episode is playable in the given market. Otherwise false. 
 * @member {Boolean} is_playable
 */
SimplifiedChapterObject.prototype['is_playable'] = undefined;

/**
 * A list of the languages used in the episode, identified by their [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639) code. 
 * @member {Array.<String>} languages
 */
SimplifiedChapterObject.prototype['languages'] = undefined;

/**
 * The name of the episode. 
 * @member {String} name
 */
SimplifiedChapterObject.prototype['name'] = undefined;

/**
 * The date the episode was first released, for example `\"1981-12-15\"`. Depending on the precision, it might be shown as `\"1981\"` or `\"1981-12\"`. 
 * @member {String} release_date
 */
SimplifiedChapterObject.prototype['release_date'] = undefined;

/**
 * The precision with which `release_date` value is known. 
 * @member {module:model/SimplifiedChapterObject.ReleaseDatePrecisionEnum} release_date_precision
 */
SimplifiedChapterObject.prototype['release_date_precision'] = undefined;

/**
 * Included in the response when a content restriction is applied. 
 * @member {module:model/ChapterRestrictionObject} restrictions
 */
SimplifiedChapterObject.prototype['restrictions'] = undefined;

/**
 * The user's most recent position in the episode. Set if the supplied access token is a user token and has the scope 'user-read-playback-position'. 
 * @member {module:model/ResumePointObject} resume_point
 */
SimplifiedChapterObject.prototype['resume_point'] = undefined;

/**
 * The object type. 
 * @member {module:model/SimplifiedChapterObject.TypeEnum} type
 */
SimplifiedChapterObject.prototype['type'] = undefined;

/**
 * The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
 * @member {String} uri
 */
SimplifiedChapterObject.prototype['uri'] = undefined;


// Implement ChapterBase interface:
/**
 * A URL to a 30 second preview (MP3 format) of the episode. `null` if not available. 
 * @member {String} audio_preview_url
 */
ChapterBase.prototype['audio_preview_url'] = undefined;
/**
 * A list of the countries in which the chapter can be played, identified by their [ISO 3166-1 alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) code. 
 * @member {Array.<String>} available_markets
 */
ChapterBase.prototype['available_markets'] = undefined;
/**
 * The number of the chapter 
 * @member {Number} chapter_number
 */
ChapterBase.prototype['chapter_number'] = undefined;
/**
 * A description of the episode. HTML tags are stripped away from this field, use `html_description` field in case HTML tags are needed. 
 * @member {String} description
 */
ChapterBase.prototype['description'] = undefined;
/**
 * The episode length in milliseconds. 
 * @member {Number} duration_ms
 */
ChapterBase.prototype['duration_ms'] = undefined;
/**
 * Whether or not the episode has explicit content (true = yes it does; false = no it does not OR unknown). 
 * @member {Boolean} explicit
 */
ChapterBase.prototype['explicit'] = undefined;
/**
 * External URLs for this episode. 
 * @member {module:model/ExternalUrlObject} external_urls
 */
ChapterBase.prototype['external_urls'] = undefined;
/**
 * A link to the Web API endpoint providing full details of the episode. 
 * @member {String} href
 */
ChapterBase.prototype['href'] = undefined;
/**
 * A description of the episode. This field may contain HTML tags. 
 * @member {String} html_description
 */
ChapterBase.prototype['html_description'] = undefined;
/**
 * The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
 * @member {String} id
 */
ChapterBase.prototype['id'] = undefined;
/**
 * The cover art for the episode in various sizes, widest first. 
 * @member {Array.<module:model/ImageObject>} images
 */
ChapterBase.prototype['images'] = undefined;
/**
 * True if the episode is playable in the given market. Otherwise false. 
 * @member {Boolean} is_playable
 */
ChapterBase.prototype['is_playable'] = undefined;
/**
 * A list of the languages used in the episode, identified by their [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639) code. 
 * @member {Array.<String>} languages
 */
ChapterBase.prototype['languages'] = undefined;
/**
 * The name of the episode. 
 * @member {String} name
 */
ChapterBase.prototype['name'] = undefined;
/**
 * The date the episode was first released, for example `\"1981-12-15\"`. Depending on the precision, it might be shown as `\"1981\"` or `\"1981-12\"`. 
 * @member {String} release_date
 */
ChapterBase.prototype['release_date'] = undefined;
/**
 * The precision with which `release_date` value is known. 
 * @member {module:model/ChapterBase.ReleaseDatePrecisionEnum} release_date_precision
 */
ChapterBase.prototype['release_date_precision'] = undefined;
/**
 * Included in the response when a content restriction is applied. 
 * @member {module:model/ChapterRestrictionObject} restrictions
 */
ChapterBase.prototype['restrictions'] = undefined;
/**
 * The user's most recent position in the episode. Set if the supplied access token is a user token and has the scope 'user-read-playback-position'. 
 * @member {module:model/ResumePointObject} resume_point
 */
ChapterBase.prototype['resume_point'] = undefined;
/**
 * The object type. 
 * @member {module:model/ChapterBase.TypeEnum} type
 */
ChapterBase.prototype['type'] = undefined;
/**
 * The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
 * @member {String} uri
 */
ChapterBase.prototype['uri'] = undefined;
 ...
 * @readonly
 */
SimplifiedChapterObject['ReleaseDatePrecisionEnum'] = {
 ...
 * @readonly
 */
SimplifiedChapterObject['TypeEnum'] = {
...
export default SimplifiedChapterObject;
