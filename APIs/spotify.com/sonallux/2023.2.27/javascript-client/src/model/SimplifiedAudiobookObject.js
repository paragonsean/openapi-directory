...
/**
 * The SimplifiedAudiobookObject model module.
 * @module model/SimplifiedAudiobookObject
 * @version 2023.2.27
 */
class SimplifiedAudiobookObject {
    /**
     * Constructs a new <code>SimplifiedAudiobookObject</code>.
     * @alias module:model/SimplifiedAudiobookObject
     ...
     * @param type {module:model/SimplifiedAudiobookObject.TypeEnum} The object type. 
    ...
    constructor(authors, availableMarkets, copyrights, description, explicit, externalUrls, href, htmlDescription, id, images, languages, mediaType, name, narrators, publisher, totalChapters, type, uri) { 
        ...
        SimplifiedAudiobookObject.initialize(this, authors, availableMarkets, copyrights, description, explicit, externalUrls, href, htmlDescription, id, images, languages, mediaType, name, narrators, publisher, totalChapters, type, uri);
    }
    ...
    /**
     * Constructs a <code>SimplifiedAudiobookObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimplifiedAudiobookObject} obj Optional instance to populate.
     * @return {module:model/SimplifiedAudiobookObject} The populated <code>SimplifiedAudiobookObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimplifiedAudiobookObject();
    ...
    /**
     * Validates the JSON data with respect to <code>SimplifiedAudiobookObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimplifiedAudiobookObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SimplifiedAudiobookObject.RequiredProperties) {
...
SimplifiedAudiobookObject.RequiredProperties = ["authors", "available_markets", "copyrights", "description", "explicit", "external_urls", "href", "html_description", "id", "images", "languages", "media_type", "name", "narrators", "publisher", "total_chapters", "type", "uri"];

/**
 * The author(s) for the audiobook. 
 * @member {Array.<module:model/AuthorObject>} authors
 */
SimplifiedAudiobookObject.prototype['authors'] = undefined;

/**
 * A list of the countries in which the audiobook can be played, identified by their [ISO 3166-1 alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) code. 
 * @member {Array.<String>} available_markets
 */
SimplifiedAudiobookObject.prototype['available_markets'] = undefined;

/**
 * The copyright statements of the audiobook. 
 * @member {Array.<module:model/CopyrightObject>} copyrights
 */
SimplifiedAudiobookObject.prototype['copyrights'] = undefined;

/**
 * A description of the audiobook. HTML tags are stripped away from this field, use `html_description` field in case HTML tags are needed. 
 * @member {String} description
 */
SimplifiedAudiobookObject.prototype['description'] = undefined;

/**
 * The edition of the audiobook. 
 * @member {String} edition
 */
SimplifiedAudiobookObject.prototype['edition'] = undefined;

/**
 * Whether or not the audiobook has explicit content (true = yes it does; false = no it does not OR unknown). 
 * @member {Boolean} explicit
 */
SimplifiedAudiobookObject.prototype['explicit'] = undefined;

/**
 * External URLs for this audiobook. 
 * @member {module:model/ExternalUrlObject} external_urls
 */
SimplifiedAudiobookObject.prototype['external_urls'] = undefined;

/**
 * A link to the Web API endpoint providing full details of the audiobook. 
 * @member {String} href
 */
SimplifiedAudiobookObject.prototype['href'] = undefined;

/**
 * A description of the audiobook. This field may contain HTML tags. 
 * @member {String} html_description
 */
SimplifiedAudiobookObject.prototype['html_description'] = undefined;

/**
 * The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the audiobook. 
 * @member {String} id
 */
SimplifiedAudiobookObject.prototype['id'] = undefined;

/**
 * The cover art for the audiobook in various sizes, widest first. 
 * @member {Array.<module:model/ImageObject>} images
 */
SimplifiedAudiobookObject.prototype['images'] = undefined;

/**
 * A list of the languages used in the audiobook, identified by their [ISO 639](https://en.wikipedia.org/wiki/ISO_639) code. 
 * @member {Array.<String>} languages
 */
SimplifiedAudiobookObject.prototype['languages'] = undefined;

/**
 * The media type of the audiobook. 
 * @member {String} media_type
 */
SimplifiedAudiobookObject.prototype['media_type'] = undefined;

/**
 * The name of the audiobook. 
 * @member {String} name
 */
SimplifiedAudiobookObject.prototype['name'] = undefined;

/**
 * The narrator(s) for the audiobook. 
 * @member {Array.<module:model/NarratorObject>} narrators
 */
SimplifiedAudiobookObject.prototype['narrators'] = undefined;

/**
 * The publisher of the audiobook. 
 * @member {String} publisher
 */
SimplifiedAudiobookObject.prototype['publisher'] = undefined;

/**
 * The number of chapters in this audiobook. 
 * @member {Number} total_chapters
 */
SimplifiedAudiobookObject.prototype['total_chapters'] = undefined;

/**
 * The object type. 
 * @member {module:model/SimplifiedAudiobookObject.TypeEnum} type
 */
SimplifiedAudiobookObject.prototype['type'] = undefined;

/**
 * The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the audiobook. 
 * @member {String} uri
 */
SimplifiedAudiobookObject.prototype['uri'] = undefined;
 ...
 * @readonly
 */
SimplifiedAudiobookObject['TypeEnum'] = {
...
export default SimplifiedAudiobookObject;
