...
/**
 * The AudiobookObject model module.
 * @module model/AudiobookObject
 * @version 2023.2.27
 */
class AudiobookObject {
    /**
     * Constructs a new <code>AudiobookObject</code>.
     * @alias module:model/AudiobookObject
     * @implements module:model/AudiobookBase
     ...
     * @param type {module:model/AudiobookObject.TypeEnum} The object type. 
     * @param uri {String} The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the audiobook. 
     * @param chapters {Object} The chapters of the audiobook. 
     */
    constructor(authors, availableMarkets, copyrights, description, explicit, externalUrls, href, htmlDescription, id, images, languages, mediaType, name, narrators, publisher, totalChapters, type, uri, chapters) { 
        ...
        AudiobookObject.initialize(this, authors, availableMarkets, copyrights, description, explicit, externalUrls, href, htmlDescription, id, images, languages, mediaType, name, narrators, publisher, totalChapters, type, uri, chapters);
    }
     ...
     */
    static initialize(obj, authors, availableMarkets, copyrights, description, explicit, externalUrls, href, htmlDescription, id, images, languages, mediaType, name, narrators, publisher, totalChapters, type, uri, chapters) { 
        obj['authors'] = authors;
    ...
    /**
     * Constructs a <code>AudiobookObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AudiobookObject} obj Optional instance to populate.
     * @return {module:model/AudiobookObject} The populated <code>AudiobookObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AudiobookObject();
            AudiobookBase.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('chapters')) {
                obj['chapters'] = ApiClient.convertToType(data['chapters'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AudiobookObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AudiobookObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AudiobookObject.RequiredProperties) {
...
AudiobookObject.RequiredProperties = ["authors", "available_markets", "copyrights", "description", "explicit", "external_urls", "href", "html_description", "id", "images", "languages", "media_type", "name", "narrators", "publisher", "total_chapters", "type", "uri", "chapters"];

/**
 * The author(s) for the audiobook. 
 * @member {Array.<module:model/AuthorObject>} authors
 */
AudiobookObject.prototype['authors'] = undefined;

/**
 * A list of the countries in which the audiobook can be played, identified by their [ISO 3166-1 alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) code. 
 * @member {Array.<String>} available_markets
 */
AudiobookObject.prototype['available_markets'] = undefined;

/**
 * The copyright statements of the audiobook. 
 * @member {Array.<module:model/CopyrightObject>} copyrights
 */
AudiobookObject.prototype['copyrights'] = undefined;

/**
 * A description of the audiobook. HTML tags are stripped away from this field, use `html_description` field in case HTML tags are needed. 
 * @member {String} description
 */
AudiobookObject.prototype['description'] = undefined;

/**
 * The edition of the audiobook. 
 * @member {String} edition
 */
AudiobookObject.prototype['edition'] = undefined;

/**
 * Whether or not the audiobook has explicit content (true = yes it does; false = no it does not OR unknown). 
 * @member {Boolean} explicit
 */
AudiobookObject.prototype['explicit'] = undefined;

/**
 * External URLs for this audiobook. 
 * @member {module:model/ExternalUrlObject} external_urls
 */
AudiobookObject.prototype['external_urls'] = undefined;

/**
 * A link to the Web API endpoint providing full details of the audiobook. 
 * @member {String} href
 */
AudiobookObject.prototype['href'] = undefined;

/**
 * A description of the audiobook. This field may contain HTML tags. 
 * @member {String} html_description
 */
AudiobookObject.prototype['html_description'] = undefined;

/**
 * The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the audiobook. 
 * @member {String} id
 */
AudiobookObject.prototype['id'] = undefined;

/**
 * The cover art for the audiobook in various sizes, widest first. 
 * @member {Array.<module:model/ImageObject>} images
 */
AudiobookObject.prototype['images'] = undefined;

/**
 * A list of the languages used in the audiobook, identified by their [ISO 639](https://en.wikipedia.org/wiki/ISO_639) code. 
 * @member {Array.<String>} languages
 */
AudiobookObject.prototype['languages'] = undefined;

/**
 * The media type of the audiobook. 
 * @member {String} media_type
 */
AudiobookObject.prototype['media_type'] = undefined;

/**
 * The name of the audiobook. 
 * @member {String} name
 */
AudiobookObject.prototype['name'] = undefined;

/**
 * The narrator(s) for the audiobook. 
 * @member {Array.<module:model/NarratorObject>} narrators
 */
AudiobookObject.prototype['narrators'] = undefined;

/**
 * The publisher of the audiobook. 
 * @member {String} publisher
 */
AudiobookObject.prototype['publisher'] = undefined;

/**
 * The number of chapters in this audiobook. 
 * @member {Number} total_chapters
 */
AudiobookObject.prototype['total_chapters'] = undefined;

/**
 * The object type. 
 * @member {module:model/AudiobookObject.TypeEnum} type
 */
AudiobookObject.prototype['type'] = undefined;

/**
 * The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the audiobook. 
 * @member {String} uri
 */
AudiobookObject.prototype['uri'] = undefined;

/**
 * The chapters of the audiobook. 
 * @member {Object} chapters
 */
AudiobookObject.prototype['chapters'] = undefined;


// Implement AudiobookBase interface:
/**
 * The author(s) for the audiobook. 
 * @member {Array.<module:model/AuthorObject>} authors
 */
