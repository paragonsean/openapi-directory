# SpotifyWebApiWithFixesAndImprovementsFromSonallux.UsersApi
...
let apiInstance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.UsersApi();
...
> PagingArtistObject getUsersTopArtists(opts)
...
apiInstance.getUsersTopArtists(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PagingTrackObject getUsersTopTracks(opts)
...
apiInstance.getUsersTopTracks(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
