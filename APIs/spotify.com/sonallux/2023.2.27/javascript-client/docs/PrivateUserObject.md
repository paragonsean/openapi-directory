# SpotifyWebApiWithFixesAndImprovementsFromSonallux.PrivateUserObject
...
**explicitContent** | [**ExplicitContentSettingsObject**](ExplicitContentSettingsObject.md) | The user&#39;s explicit content settings. _This field is only available when the current user has granted access to the [user-read-private](/documentation/web-api/concepts/scopes/#list-of-scopes) scope._  | [optional] 
...
**images** | [**[ImageObject]**](ImageObject.md) | The user&#39;s profile image. | [optional] 
