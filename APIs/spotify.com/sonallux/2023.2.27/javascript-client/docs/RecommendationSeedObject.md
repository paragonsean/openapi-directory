# SpotifyWebApiWithFixesAndImprovementsFromSonallux.RecommendationSeedObject

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**afterFilteringSize** | **Number** | The number of tracks available after min\\_\\* and max\\_\\* filters have been applied.  | [optional] 
**afterRelinkingSize** | **Number** | The number of tracks available after relinking for regional availability.  | [optional] 
...
**initialPoolSize** | **Number** | The number of recommended tracks available for this seed.  | [optional] 
