# SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistsApi
...
let apiInstance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistsApi();
...
let opts = {
  ...
  'addTracksToPlaylistRequest': new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AddTracksToPlaylistRequest() // AddTracksToPlaylistRequest | 
};
...
let playlistId = "3cEYpjA9oz9GiPac4AsH4n"; // String | 
let opts = {
  'followPlaylistRequest': new SpotifyWebApiWithFixesAndImprovementsFromSonallux.FollowPlaylistRequest() // FollowPlaylistRequest | 
};
...
let playlistId = "3cEYpjA9oz9GiPac4AsH4n"; // String | 
let opts = {
  'removeTracksPlaylistRequest': new SpotifyWebApiWithFixesAndImprovementsFromSonallux.RemoveTracksPlaylistRequest() // RemoveTracksPlaylistRequest | 
};
...
let opts = {
  ...
  'reorderOrReplacePlaylistsTracksRequest': new SpotifyWebApiWithFixesAndImprovementsFromSonallux.ReorderOrReplacePlaylistsTracksRequest() // ReorderOrReplacePlaylistsTracksRequest | 
};
...
let apiInstance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.PlaylistsApi();
let playlistId = "3cEYpjA9oz9GiPac4AsH4n"; // String | 
let body = "body_example"; // String | The new cover image of the playlist as a Base64 encoded JPEG image. Maximum payload size is 256KB.
apiInstance.uploadCustomPlaylistCover(playlistId, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
