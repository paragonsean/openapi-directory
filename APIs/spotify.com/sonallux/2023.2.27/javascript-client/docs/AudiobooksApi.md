# SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudiobooksApi
...
let apiInstance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudiobooksApi();
...
> PagingSavedAudiobookObject getUsersSavedAudiobooks(opts)
