# SpotifyWebApiWithFixesAndImprovementsFromSonallux.TracksApi
...
[**getUsersTopTracks_0**](TracksApi.md#getUsersTopTracks_0) | **GET** /me/top/tracks | Get User&#39;s Top Tracks 
...
let apiInstance = new SpotifyWebApiWithFixesAndImprovementsFromSonallux.TracksApi();
...
> RecommendationsObject getRecommendations(opts)
...
apiInstance.getRecommendations(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PagingTrackObject getUsersTopTracks_0(opts)
...
apiInstance.getUsersTopTracks_0(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
