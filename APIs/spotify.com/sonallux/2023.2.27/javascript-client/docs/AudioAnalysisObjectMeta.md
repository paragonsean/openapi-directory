# SpotifyWebApiWithFixesAndImprovementsFromSonallux.AudioAnalysisObjectMeta

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**analysisTime** | **Number** | The amount of time taken to analyze this track. | [optional] 
...
**statusCode** | **Number** | The return code of the analyzer process. 0 if successful, 1 if any errors occurred. | [optional] 
**timestamp** | **Number** | The Unix timestamp (in seconds) at which this track was analyzed. | [optional] 
