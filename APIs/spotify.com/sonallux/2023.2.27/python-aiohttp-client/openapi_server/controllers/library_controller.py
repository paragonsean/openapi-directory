...
async def get_users_top_artists_1(request: web.Request, time_range=None, limit=None, offset=None) -> web.Response:
...
async def get_users_top_tracks_1(request: web.Request, time_range=None, limit=None, offset=None) -> web.Response:
...
async def remove_shows_user_0(request: web.Request, ids, market=None, body=None) -> web.Response:
...
async def save_shows_user_0(request: web.Request, ids, body=None) -> web.Response:
