...
class EpisodeBase(Model):
    ...
    def __init__(self, audio_preview_url: str=None, description: str=None, duration_ms: int=None, explicit: bool=None, external_urls: ExternalUrlObject=None, href: str=None, html_description: str=None, id: str=None, images: List[ImageObject]=None, is_externally_hosted: bool=None, is_playable: bool=None, language: str=None, languages: List[str]=None, name: str=None, release_date: str=None, release_date_precision: str=None, restrictions: EpisodeRestrictionObject=None, resume_point: ResumePointObject=None, type: str=None, uri: str=None):
        """EpisodeBase - a model defined in OpenAPI

        :param audio_preview_url: The audio_preview_url of this EpisodeBase.
        :param description: The description of this EpisodeBase.
        :param duration_ms: The duration_ms of this EpisodeBase.
        :param explicit: The explicit of this EpisodeBase.
        :param external_urls: The external_urls of this EpisodeBase.
        :param href: The href of this EpisodeBase.
        :param html_description: The html_description of this EpisodeBase.
        :param id: The id of this EpisodeBase.
        :param images: The images of this EpisodeBase.
        :param is_externally_hosted: The is_externally_hosted of this EpisodeBase.
        :param is_playable: The is_playable of this EpisodeBase.
        :param language: The language of this EpisodeBase.
        :param languages: The languages of this EpisodeBase.
        :param name: The name of this EpisodeBase.
        :param release_date: The release_date of this EpisodeBase.
        :param release_date_precision: The release_date_precision of this EpisodeBase.
        :param restrictions: The restrictions of this EpisodeBase.
        :param resume_point: The resume_point of this EpisodeBase.
        :param type: The type of this EpisodeBase.
        :param uri: The uri of this EpisodeBase.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EpisodeBase':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EpisodeBase of this EpisodeBase.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def audio_preview_url(self):
        """Gets the audio_preview_url of this EpisodeBase.

        A URL to a 30 second preview (MP3 format) of the episode. `null` if not available. 

        :return: The audio_preview_url of this EpisodeBase.
        :rtype: str
        """
    ...
    def description(self):
        """Gets the description of this EpisodeBase.

        A description of the episode. HTML tags are stripped away from this field, use `html_description` field in case HTML tags are needed. 

        :return: The description of this EpisodeBase.
        :rtype: str
        """
    ...
    def duration_ms(self):
        """Gets the duration_ms of this EpisodeBase.

        The episode length in milliseconds. 

        :return: The duration_ms of this EpisodeBase.
        :rtype: int
        """
    ...
    @property
    def explicit(self):
        """Gets the explicit of this EpisodeBase.

        Whether or not the episode has explicit content (true = yes it does; false = no it does not OR unknown). 

        :return: The explicit of this EpisodeBase.
        :rtype: bool
        """
    ...
    def external_urls(self):
        """Gets the external_urls of this EpisodeBase.

        External URLs for this episode. 

        :return: The external_urls of this EpisodeBase.
    ...
    @property
    def href(self):
        """Gets the href of this EpisodeBase.

        A link to the Web API endpoint providing full details of the episode. 

        :return: The href of this EpisodeBase.
        :rtype: str
        """
        return self._href
    ...
    def html_description(self):
        """Gets the html_description of this EpisodeBase.

        A description of the episode. This field may contain HTML tags. 

        :return: The html_description of this EpisodeBase.
        :rtype: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this EpisodeBase.

        The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 

        :return: The id of this EpisodeBase.
        :rtype: str
        """
        return self._id
    ...
    @property
    def images(self):
        """Gets the images of this EpisodeBase.

        The cover art for the episode in various sizes, widest first. 

        :return: The images of this EpisodeBase.
    ...
    def is_externally_hosted(self):
        """Gets the is_externally_hosted of this EpisodeBase.

        True if the episode is hosted outside of Spotify's CDN. 

        :return: The is_externally_hosted of this EpisodeBase.
        :rtype: bool
        """
    ...
    def is_playable(self):
        """Gets the is_playable of this EpisodeBase.

        True if the episode is playable in the given market. Otherwise false. 

        :return: The is_playable of this EpisodeBase.
        :rtype: bool
        """
    ...
    @property
    def language(self):
        """Gets the language of this EpisodeBase.

        The language used in the episode, identified by a [ISO 639](https://en.wikipedia.org/wiki/ISO_639) code. This field is deprecated and might be removed in the future. Please use the `languages` field instead. 

        :return: The language of this EpisodeBase.
        :rtype: str
        """
    ...
    @property
    def languages(self):
        """Gets the languages of this EpisodeBase.

        A list of the languages used in the episode, identified by their [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639) code. 

        :return: The languages of this EpisodeBase.
        :rtype: List[str]
        """
    ...
    @property
    def name(self):
        """Gets the name of this EpisodeBase.

        The name of the episode. 

        :return: The name of this EpisodeBase.
        :rtype: str
        """
        return self._name
    ...
    def release_date(self):
        """Gets the release_date of this EpisodeBase.

        The date the episode was first released, for example `\"1981-12-15\"`. Depending on the precision, it might be shown as `\"1981\"` or `\"1981-12\"`. 

        :return: The release_date of this EpisodeBase.
        :rtype: str
        """
    ...
    def release_date_precision(self):
        """Gets the release_date_precision of this EpisodeBase.

        The precision with which `release_date` value is known. 

        :return: The release_date_precision of this EpisodeBase.
        :rtype: str
        """
    ...
    def restrictions(self):
        """Gets the restrictions of this EpisodeBase.

        Included in the response when a content restriction is applied. 

        :return: The restrictions of this EpisodeBase.
    ...
    def resume_point(self):
        """Gets the resume_point of this EpisodeBase.

        The user's most recent position in the episode. Set if the supplied access token is a user token and has the scope 'user-read-playback-position'. 

        :return: The resume_point of this EpisodeBase.
    ...
    @property
    def type(self):
        """Gets the type of this EpisodeBase.

        The object type. 

        :return: The type of this EpisodeBase.
        :rtype: str
        """
        return self._type
    ...
    @property
    def uri(self):
        """Gets the uri of this EpisodeBase.

        The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 

        :return: The uri of this EpisodeBase.
        :rtype: str
        """
        return self._uri
