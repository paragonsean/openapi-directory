...
<a id="getUsersTopArtists_0"></a>
# **getUsersTopArtists_0**
> PagingArtistObject getUsersTopArtists_0(timeRange, limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer offset = 0; // Integer | 
    try {
      PagingArtistObject result = apiInstance.getUsersTopArtists_0(timeRange, limit, offset);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ArtistsApi#getUsersTopArtists_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
