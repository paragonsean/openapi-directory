...
<a id="getUsersTopTracks_0"></a>
# **getUsersTopTracks_0**
> PagingTrackObject getUsersTopTracks_0(timeRange, limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer offset = 0; // Integer | 
    try {
      PagingTrackObject result = apiInstance.getUsersTopTracks_0(timeRange, limit, offset);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TracksApi#getUsersTopTracks_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
