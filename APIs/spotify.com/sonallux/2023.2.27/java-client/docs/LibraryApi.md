...
> PagingSavedAudiobookObject getUsersSavedAudiobooks_0(limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer offset = 0; // Integer | 
    try {
      PagingSavedAudiobookObject result = apiInstance.getUsersSavedAudiobooks_0(limit, offset);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="getUsersTopArtists_1"></a>
# **getUsersTopArtists_1**
> PagingArtistObject getUsersTopArtists_1(timeRange, limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer offset = 0; // Integer | 
    try {
      PagingArtistObject result = apiInstance.getUsersTopArtists_1(timeRange, limit, offset);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LibraryApi#getUsersTopArtists_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getUsersTopTracks_1"></a>
# **getUsersTopTracks_1**
> PagingTrackObject getUsersTopTracks_1(timeRange, limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer offset = 0; // Integer | 
    try {
      PagingTrackObject result = apiInstance.getUsersTopTracks_1(timeRange, limit, offset);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LibraryApi#getUsersTopTracks_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **removeShowsUser_0**
> removeShowsUser_0(ids, market, saveShowsUserRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.removeShowsUser_0(ids, market, saveShowsUserRequest);
    } catch (ApiException e) {
...
# **saveShowsUser_0**
> saveShowsUser_0(ids, saveShowsUserRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    SaveShowsUserRequest saveShowsUserRequest = new SaveShowsUserRequest(); // SaveShowsUserRequest | 
    try {
      apiInstance.saveShowsUser_0(ids, saveShowsUserRequest);
    } catch (ApiException e) {
