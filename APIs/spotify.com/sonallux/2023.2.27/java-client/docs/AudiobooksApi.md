...
<a id="checkUsersSavedAudiobooks"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String market = "ES"; // String | 
    try {
      GetMultipleAudiobooks200Response result = apiInstance.getMultipleAudiobooks(ids, market);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="getUsersSavedAudiobooks"></a>
