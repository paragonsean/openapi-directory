...
public class ChapterObject {
  ...
  public ChapterObject audioPreviewUrl(String audioPreviewUrl) {
  ...
  public ChapterObject availableMarkets(List<String> availableMarkets) {
    this.availableMarkets = availableMarkets;
    return this;
  }

  public ChapterObject addAvailableMarketsItem(String availableMarketsItem) {
  ...
  public ChapterObject chapterNumber(Integer chapterNumber) {
  ...
  public ChapterObject description(String description) {
  ...
  public ChapterObject durationMs(Integer durationMs) {
  ...
  public ChapterObject explicit(Boolean explicit) {
  ...
  public ChapterObject externalUrls(ExternalUrlObject externalUrls) {
  ...
  public ChapterObject href(String href) {
    this.href = href;
    return this;
  }
  ...
  public ChapterObject htmlDescription(String htmlDescription) {
  ...
  public ChapterObject id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ChapterObject images(List<ImageObject> images) {
    this.images = images;
    return this;
  }

  public ChapterObject addImagesItem(ImageObject imagesItem) {
    if (this.images == null) {
  ...
  public ChapterObject isPlayable(Boolean isPlayable) {
  ...
  public ChapterObject languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public ChapterObject addLanguagesItem(String languagesItem) {
  ...
  public ChapterObject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ChapterObject releaseDate(String releaseDate) {
  ...
  public ChapterObject releaseDatePrecision(ReleaseDatePrecisionEnum releaseDatePrecision) {
  ...
  public ChapterObject restrictions(ChapterRestrictionObject restrictions) {
  ...
  public ChapterObject resumePoint(ResumePointObject resumePoint) {
  ...
  public ChapterObject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ChapterObject uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public ChapterObject audiobook(SimplifiedAudiobookObject audiobook) {
  ...
  public boolean equals(Object o) {
    ...
    ChapterObject chapterObject = (ChapterObject) o;
    return Objects.equals(this.audioPreviewUrl, chapterObject.audioPreviewUrl) &&
        Objects.equals(this.availableMarkets, chapterObject.availableMarkets) &&
        Objects.equals(this.chapterNumber, chapterObject.chapterNumber) &&
        Objects.equals(this.description, chapterObject.description) &&
        Objects.equals(this.durationMs, chapterObject.durationMs) &&
        Objects.equals(this.explicit, chapterObject.explicit) &&
        Objects.equals(this.externalUrls, chapterObject.externalUrls) &&
        Objects.equals(this.href, chapterObject.href) &&
        Objects.equals(this.htmlDescription, chapterObject.htmlDescription) &&
        Objects.equals(this.id, chapterObject.id) &&
        Objects.equals(this.images, chapterObject.images) &&
        Objects.equals(this.isPlayable, chapterObject.isPlayable) &&
        Objects.equals(this.languages, chapterObject.languages) &&
        Objects.equals(this.name, chapterObject.name) &&
        Objects.equals(this.releaseDate, chapterObject.releaseDate) &&
        Objects.equals(this.releaseDatePrecision, chapterObject.releaseDatePrecision) &&
        Objects.equals(this.restrictions, chapterObject.restrictions) &&
        Objects.equals(this.resumePoint, chapterObject.resumePoint) &&
        Objects.equals(this.type, chapterObject.type) &&
        Objects.equals(this.uri, chapterObject.uri) &&
        Objects.equals(this.audiobook, chapterObject.audiobook);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audioPreviewUrl, availableMarkets, chapterNumber, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isPlayable, languages, name, releaseDate, releaseDatePrecision, restrictions, resumePoint, type, uri, audiobook);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ChapterObject {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChapterObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChapterObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChapterObject is not found in the empty JSON string", ChapterObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChapterObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChapterObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChapterObject.openapiRequiredFields) {
      ...
      if (jsonObj.get("restrictions") != null && !jsonObj.get("restrictions").isJsonNull()) {
        ChapterRestrictionObject.validateJsonElement(jsonObj.get("restrictions"));
      }
      ...
      SimplifiedAudiobookObject.validateJsonElement(jsonObj.get("audiobook"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChapterObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChapterObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChapterObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChapterObject.class));

       return (TypeAdapter<T>) new TypeAdapter<ChapterObject>() {
           @Override
           public void write(JsonWriter out, ChapterObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChapterObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChapterObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChapterObject
   * @throws IOException if the JSON string is invalid with respect to ChapterObject
   */
  public static ChapterObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChapterObject.class);
  }

  /**
   * Convert an instance of ChapterObject to an JSON string
   *
   * @return JSON string
   */
