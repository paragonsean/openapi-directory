...
import org.openapitools.client.model.GetAvailableMarkets200Response;
...
public class MarketsApi {
    ...
    private okhttp3.Call getAvailableMarketsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getAvailableMarketsCall(_callback);
     ...
     */
    public GetAvailableMarkets200Response getAvailableMarkets() throws ApiException {
        ApiResponse<GetAvailableMarkets200Response> localVarResp = getAvailableMarketsWithHttpInfo();
     ...
     * Get Available Markets 
     * Get the list of markets where Spotify is available. 
     * @return ApiResponse&lt;GetAvailableMarkets200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetAvailableMarkets200Response> getAvailableMarketsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAvailableMarketsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GetAvailableMarkets200Response>(){}.getType();
     ...
     */
    public okhttp3.Call getAvailableMarketsAsync(final ApiCallback<GetAvailableMarkets200Response> _callback) throws ApiException {
