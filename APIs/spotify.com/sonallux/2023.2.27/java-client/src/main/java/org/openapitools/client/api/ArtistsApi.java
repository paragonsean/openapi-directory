...
public class ArtistsApi {
    ...
    /**
     * Build call for getUsersTopArtists_0
     ...
     */
    public okhttp3.Call getUsersTopArtists_0Call(String timeRange, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUsersTopArtists_0ValidateBeforeCall(String timeRange, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        return getUsersTopArtists_0Call(timeRange, limit, offset, _callback);
     ...
     */
    public PagingArtistObject getUsersTopArtists_0(String timeRange, Integer limit, Integer offset) throws ApiException {
        ApiResponse<PagingArtistObject> localVarResp = getUsersTopArtists_0WithHttpInfo(timeRange, limit, offset);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagingArtistObject> getUsersTopArtists_0WithHttpInfo(String timeRange, Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getUsersTopArtists_0ValidateBeforeCall(timeRange, limit, offset, null);
     ...
     */
    public okhttp3.Call getUsersTopArtists_0Async(String timeRange, Integer limit, Integer offset, final ApiCallback<PagingArtistObject> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUsersTopArtists_0ValidateBeforeCall(timeRange, limit, offset, _callback);
        Type localVarReturnType = new TypeToken<PagingArtistObject>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
