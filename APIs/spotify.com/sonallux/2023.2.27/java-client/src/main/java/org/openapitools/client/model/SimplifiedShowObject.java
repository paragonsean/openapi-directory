...
public class SimplifiedShowObject {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.availableMarkets, simplifiedShowObject.availableMarkets) &&
        Objects.equals(this.copyrights, simplifiedShowObject.copyrights) &&
        Objects.equals(this.description, simplifiedShowObject.description) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimplifiedShowObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimplifiedShowObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimplifiedShowObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimplifiedShowObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
