...
public class TracksApi {
    ...
    /**
     * Build call for getUsersTopTracks_0
     ...
     */
    public okhttp3.Call getUsersTopTracks_0Call(String timeRange, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUsersTopTracks_0ValidateBeforeCall(String timeRange, Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        return getUsersTopTracks_0Call(timeRange, limit, offset, _callback);
     ...
     */
    public PagingTrackObject getUsersTopTracks_0(String timeRange, Integer limit, Integer offset) throws ApiException {
        ApiResponse<PagingTrackObject> localVarResp = getUsersTopTracks_0WithHttpInfo(timeRange, limit, offset);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagingTrackObject> getUsersTopTracks_0WithHttpInfo(String timeRange, Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getUsersTopTracks_0ValidateBeforeCall(timeRange, limit, offset, null);
     ...
     */
    public okhttp3.Call getUsersTopTracks_0Async(String timeRange, Integer limit, Integer offset, final ApiCallback<PagingTrackObject> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUsersTopTracks_0ValidateBeforeCall(timeRange, limit, offset, _callback);
        Type localVarReturnType = new TypeToken<PagingTrackObject>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
