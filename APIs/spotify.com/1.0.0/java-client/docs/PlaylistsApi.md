...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ReorderOrReplacePlaylistsTracks200Response result = apiInstance.addTracksToPlaylist(playlistId, position, uris, addTracksToPlaylistRequest);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.changePlaylistDetails(playlistId, changePlaylistDetailsRequest);
    } catch (ApiException e) {
...
<a id="checkIfUserFollowsPlaylist_0"></a>
# **checkIfUserFollowsPlaylist_0**
> List&lt;Boolean&gt; checkIfUserFollowsPlaylist_0(playlistId, ids)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Boolean> result = apiInstance.checkIfUserFollowsPlaylist_0(playlistId, ids);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PlaylistsApi#checkIfUserFollowsPlaylist_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PlaylistObject result = apiInstance.createPlaylist(userId, createPlaylistRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="followPlaylist_0"></a>
# **followPlaylist_0**
> followPlaylist_0(playlistId, followPlaylistRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.followPlaylist_0(playlistId, followPlaylistRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling PlaylistsApi#followPlaylist_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getACategoriesPlaylists"></a>
...
<a id="getAListOfCurrentUsersPlaylists"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ReorderOrReplacePlaylistsTracks200Response result = apiInstance.removeTracksPlaylist(playlistId, removeTracksPlaylistRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="reorderOrReplacePlaylistsTracks"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ReorderOrReplacePlaylistsTracks200Response result = apiInstance.reorderOrReplacePlaylistsTracks(playlistId, uris, reorderOrReplacePlaylistsTracksRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String playlistId = "3cEYpjA9oz9GiPac4AsH4n"; // String | 
    try {
      apiInstance.unfollowPlaylist_0(playlistId);
    } catch (ApiException e) {
      System.err.println("Exception when calling PlaylistsApi#unfollowPlaylist_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="uploadCustomPlaylistCover"></a>
