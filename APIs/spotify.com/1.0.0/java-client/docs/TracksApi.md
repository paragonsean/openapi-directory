...
<a id="addTracksToPlaylist_0"></a>
# **addTracksToPlaylist_0**
> ReorderOrReplacePlaylistsTracks200Response addTracksToPlaylist_0(playlistId, position, uris, addTracksToPlaylistRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    AddTracksToPlaylistRequest addTracksToPlaylistRequest = new AddTracksToPlaylistRequest(); // AddTracksToPlaylistRequest | 
    try {
      ReorderOrReplacePlaylistsTracks200Response result = apiInstance.addTracksToPlaylist_0(playlistId, position, uris, addTracksToPlaylistRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TracksApi#addTracksToPlaylist_0");
...
<a id="getAnAlbumsTracks_0"></a>
# **getAnAlbumsTracks_0**
> PagingSimplifiedTrackObject getAnAlbumsTracks_0(id, market, limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PagingSimplifiedTrackObject result = apiInstance.getAnAlbumsTracks_0(id, market, limit, offset);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TracksApi#getAnAlbumsTracks_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getAnArtistsTopTracks_0"></a>
# **getAnArtistsTopTracks_0**
> GetAnArtistsTopTracks200Response getAnArtistsTopTracks_0(id, market)
...
public class Example {
  public static void main(String[] args) {
    ...
    String market = "ES"; // String | 
    try {
      GetAnArtistsTopTracks200Response result = apiInstance.getAnArtistsTopTracks_0(id, market);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TracksApi#getAnArtistsTopTracks_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getPlaylistsTracks_0"></a>
# **getPlaylistsTracks_0**
> PagingPlaylistTrackObject getPlaylistsTracks_0(playlistId, market, fields, limit, offset, additionalTypes)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PagingPlaylistTrackObject result = apiInstance.getPlaylistsTracks_0(playlistId, market, fields, limit, offset, additionalTypes);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TracksApi#getPlaylistsTracks_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      RecommendationsObject result = apiInstance.getRecommendations(seedArtists, seedGenres, seedTracks, limit, market, minAcousticness, maxAcousticness, targetAcousticness, minDanceability, maxDanceability, targetDanceability, minDurationMs, maxDurationMs, targetDurationMs, minEnergy, maxEnergy, targetEnergy, minInstrumentalness, maxInstrumentalness, targetInstrumentalness, minKey, maxKey, targetKey, minLiveness, maxLiveness, targetLiveness, minLoudness, maxLoudness, targetLoudness, minMode, maxMode, targetMode, minPopularity, maxPopularity, targetPopularity, minSpeechiness, maxSpeechiness, targetSpeechiness, minTempo, maxTempo, targetTempo, minTimeSignature, maxTimeSignature, targetTimeSignature, minValence, maxValence, targetValence);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="getSeveralAudioFeatures"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String ids = "7ouMYWpwJ422jRcDASZB7P,4VqPOruhp5EdPBeR92t6lQ,2takcwOaAZWiXQijPHIx7B"; // String | 
    try {
      GetSeveralAudioFeatures200Response result = apiInstance.getSeveralAudioFeatures(ids);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String market = "ES"; // String | 
    try {
      GetAnArtistsTopTracks200Response result = apiInstance.getSeveralTracks(ids, market);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="getUsersTopArtistsAndTracks_0"></a>
# **getUsersTopArtistsAndTracks_0**
> GetUsersTopArtistsAndTracks200Response getUsersTopArtistsAndTracks_0(type, timeRange, limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer offset = 0; // Integer | 
    try {
      GetUsersTopArtistsAndTracks200Response result = apiInstance.getUsersTopArtistsAndTracks_0(type, timeRange, limit, offset);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TracksApi#getUsersTopArtistsAndTracks_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="removeTracksPlaylist_0"></a>
# **removeTracksPlaylist_0**
> ReorderOrReplacePlaylistsTracks200Response removeTracksPlaylist_0(playlistId, removeTracksPlaylistRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    TracksApi apiInstance = new TracksApi(defaultClient);
    String playlistId = "3cEYpjA9oz9GiPac4AsH4n"; // String | 
    RemoveTracksPlaylistRequest removeTracksPlaylistRequest = new RemoveTracksPlaylistRequest(); // RemoveTracksPlaylistRequest | 
    try {
      ReorderOrReplacePlaylistsTracks200Response result = apiInstance.removeTracksPlaylist_0(playlistId, removeTracksPlaylistRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TracksApi#removeTracksPlaylist_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.removeTracksUser(ids, saveAlbumsUserRequest);
    } catch (ApiException e) {
...
<a id="reorderOrReplacePlaylistsTracks_0"></a>
# **reorderOrReplacePlaylistsTracks_0**
> ReorderOrReplacePlaylistsTracks200Response reorderOrReplacePlaylistsTracks_0(playlistId, uris, reorderOrReplacePlaylistsTracksRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ReorderOrReplacePlaylistsTracksRequest reorderOrReplacePlaylistsTracksRequest = new ReorderOrReplacePlaylistsTracksRequest(); // ReorderOrReplacePlaylistsTracksRequest | 
    try {
      ReorderOrReplacePlaylistsTracks200Response result = apiInstance.reorderOrReplacePlaylistsTracks_0(playlistId, uris, reorderOrReplacePlaylistsTracksRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TracksApi#reorderOrReplacePlaylistsTracks_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.saveTracksUser(ids, saveTracksUserRequest);
    } catch (ApiException e) {
