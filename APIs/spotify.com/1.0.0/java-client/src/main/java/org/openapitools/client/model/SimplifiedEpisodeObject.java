...
public class SimplifiedEpisodeObject {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.audioPreviewUrl, simplifiedEpisodeObject.audioPreviewUrl) &&
        Objects.equals(this.description, simplifiedEpisodeObject.description) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimplifiedEpisodeObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimplifiedEpisodeObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimplifiedEpisodeObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimplifiedEpisodeObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
