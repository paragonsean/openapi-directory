...
public class PlaylistsApi {
     ...
     */
    public okhttp3.Call uploadCustomPlaylistCoverCall(String playlistId, byte[] body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call uploadCustomPlaylistCoverValidateBeforeCall(String playlistId, byte[] body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'playlistId' is set
        if (playlistId == null) {
     ...
     */
    public void uploadCustomPlaylistCover(String playlistId, byte[] body) throws ApiException {
     ...
     */
    public ApiResponse<Void> uploadCustomPlaylistCoverWithHttpInfo(String playlistId, byte[] body) throws ApiException {
     ...
     */
    public okhttp3.Call uploadCustomPlaylistCoverAsync(String playlistId, byte[] body, final ApiCallback<Void> _callback) throws ApiException {
