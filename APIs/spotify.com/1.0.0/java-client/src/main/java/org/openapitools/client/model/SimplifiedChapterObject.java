...
public class SimplifiedChapterObject {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.audioPreviewUrl, simplifiedChapterObject.audioPreviewUrl) &&
        ...
        Objects.equals(this.description, simplifiedChapterObject.description) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimplifiedChapterObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimplifiedChapterObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimplifiedChapterObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimplifiedChapterObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
