...
public class AudiobookObject {
  ...
  public AudiobookObject authors(List<AuthorObject> authors) {
    this.authors = authors;
    return this;
  }

  public AudiobookObject addAuthorsItem(AuthorObject authorsItem) {
  ...
  public AudiobookObject availableMarkets(List<String> availableMarkets) {
    this.availableMarkets = availableMarkets;
    return this;
  }

  public AudiobookObject addAvailableMarketsItem(String availableMarketsItem) {
  ...
  public AudiobookObject copyrights(List<CopyrightObject> copyrights) {
    this.copyrights = copyrights;
    return this;
  }

  public AudiobookObject addCopyrightsItem(CopyrightObject copyrightsItem) {
  ...
  public AudiobookObject description(String description) {
  ...
  public AudiobookObject edition(String edition) {
  ...
  public AudiobookObject explicit(Boolean explicit) {
  ...
  public AudiobookObject externalUrls(ExternalUrlObject externalUrls) {
  ...
  public AudiobookObject href(String href) {
    this.href = href;
    return this;
  }
  ...
  public AudiobookObject htmlDescription(String htmlDescription) {
  ...
  public AudiobookObject id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AudiobookObject images(List<ImageObject> images) {
    this.images = images;
    return this;
  }

  public AudiobookObject addImagesItem(ImageObject imagesItem) {
    if (this.images == null) {
  ...
  public AudiobookObject languages(List<String> languages) {
    this.languages = languages;
    return this;
  }

  public AudiobookObject addLanguagesItem(String languagesItem) {
  ...
  public AudiobookObject mediaType(String mediaType) {
  ...
  public AudiobookObject name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AudiobookObject narrators(List<NarratorObject> narrators) {
    this.narrators = narrators;
    return this;
  }

  public AudiobookObject addNarratorsItem(NarratorObject narratorsItem) {
  ...
  public AudiobookObject publisher(String publisher) {
  ...
  public AudiobookObject totalChapters(Integer totalChapters) {
  ...
  public AudiobookObject type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AudiobookObject uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authors, audiobookObject.authors) &&
        Objects.equals(this.availableMarkets, audiobookObject.availableMarkets) &&
        Objects.equals(this.copyrights, audiobookObject.copyrights) &&
        Objects.equals(this.description, audiobookObject.description) &&
        Objects.equals(this.edition, audiobookObject.edition) &&
        Objects.equals(this.explicit, audiobookObject.explicit) &&
        Objects.equals(this.externalUrls, audiobookObject.externalUrls) &&
        Objects.equals(this.href, audiobookObject.href) &&
        Objects.equals(this.htmlDescription, audiobookObject.htmlDescription) &&
        Objects.equals(this.id, audiobookObject.id) &&
        Objects.equals(this.images, audiobookObject.images) &&
        Objects.equals(this.languages, audiobookObject.languages) &&
        Objects.equals(this.mediaType, audiobookObject.mediaType) &&
        Objects.equals(this.name, audiobookObject.name) &&
        Objects.equals(this.narrators, audiobookObject.narrators) &&
        Objects.equals(this.publisher, audiobookObject.publisher) &&
        Objects.equals(this.totalChapters, audiobookObject.totalChapters) &&
        Objects.equals(this.type, audiobookObject.type) &&
        Objects.equals(this.uri, audiobookObject.uri) &&
        Objects.equals(this.chapters, audiobookObject.chapters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authors, availableMarkets, copyrights, description, edition, explicit, externalUrls, href, htmlDescription, id, images, languages, mediaType, name, narrators, publisher, totalChapters, type, uri, chapters);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AudiobookObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AudiobookObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AudiobookObject is not found in the empty JSON string", AudiobookObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AudiobookObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AudiobookObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AudiobookObject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AudiobookObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AudiobookObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AudiobookObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AudiobookObject.class));

       return (TypeAdapter<T>) new TypeAdapter<AudiobookObject>() {
           @Override
           public void write(JsonWriter out, AudiobookObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AudiobookObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AudiobookObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AudiobookObject
   * @throws IOException if the JSON string is invalid with respect to AudiobookObject
   */
  public static AudiobookObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AudiobookObject.class);
  }

  /**
   * Convert an instance of AudiobookObject to an JSON string
   *
   * @return JSON string
   */
