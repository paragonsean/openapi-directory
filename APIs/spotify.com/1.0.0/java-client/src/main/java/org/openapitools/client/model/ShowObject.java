...
public class ShowObject {
  ...
  public ShowObject episodes(Object episodes) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShowObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShowObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShowObject is not found in the empty JSON string", ShowObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShowObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShowObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ShowObject.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShowObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShowObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShowObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShowObject.class));

       return (TypeAdapter<T>) new TypeAdapter<ShowObject>() {
           @Override
           public void write(JsonWriter out, ShowObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ShowObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ShowObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ShowObject
   * @throws IOException if the JSON string is invalid with respect to ShowObject
   */
  public static ShowObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShowObject.class);
  }

  /**
   * Convert an instance of ShowObject to an JSON string
   *
   * @return JSON string
   */
