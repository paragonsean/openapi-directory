...
/*
 * OAITuneableTrackObject.h
 *
 * 
 */

#ifndef OAITuneableTrackObject_H
#define OAITuneableTrackObject_H
...
class OAITuneableTrackObject : public OAIObject {
public:
    OAITuneableTrackObject();
    OAITuneableTrackObject(QString json);
    ~OAITuneableTrackObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITuneableTrackObject)

#endif // OAITuneableTrackObject_H
