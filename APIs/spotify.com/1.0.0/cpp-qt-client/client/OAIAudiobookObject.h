...
/*
 * OAIAudiobookObject.h
 *
 * 
 */

#ifndef OAIAudiobookObject_H
#define OAIAudiobookObject_H
...
class OAIAudiobookObject : public OAIObject {
public:
    OAIAudiobookObject();
    OAIAudiobookObject(QString json);
    ~OAIAudiobookObject() override;
    ...
    OAIObject getChapters() const;
    void setChapters(const OAIObject &chapters);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAudiobookObject)

#endif // OAIAudiobookObject_H
