...
/*
 * OAISimplifiedAlbumObject.h
 *
 * 
 */

#ifndef OAISimplifiedAlbumObject_H
#define OAISimplifiedAlbumObject_H
...
class OAISimplifiedAlbumObject : public OAIObject {
public:
    OAISimplifiedAlbumObject();
    OAISimplifiedAlbumObject(QString json);
    ~OAISimplifiedAlbumObject() override;
    ...
    QString getAlbumGroup() const;
    void setAlbumGroup(const QString &album_group);
    bool is_album_group_Set() const;
    bool is_album_group_Valid() const;
...
private:
    ...
    QString m_album_group;
    bool m_album_group_isSet;
    bool m_album_group_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimplifiedAlbumObject)

#endif // OAISimplifiedAlbumObject_H
