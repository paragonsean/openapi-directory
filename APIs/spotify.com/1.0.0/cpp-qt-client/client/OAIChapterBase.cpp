...
OAIChapterBase::OAIChapterBase(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChapterBase::OAIChapterBase() {
    this->initializeModel();
}

OAIChapterBase::~OAIChapterBase() {}

void OAIChapterBase::initializeModel() {
...
void OAIChapterBase::fromJson(QString jsonString) {
...
void OAIChapterBase::fromJsonObject(QJsonObject json) {
...
QString OAIChapterBase::asJson() const {
...
QJsonObject OAIChapterBase::asJsonObject() const {
    QJsonObject obj;
...
QString OAIChapterBase::getAudioPreviewUrl() const {
    return m_audio_preview_url;
}
void OAIChapterBase::setAudioPreviewUrl(const QString &audio_preview_url) {
    m_audio_preview_url = audio_preview_url;
    m_audio_preview_url_isSet = true;
}

bool OAIChapterBase::is_audio_preview_url_Set() const{
    return m_audio_preview_url_isSet;
}

bool OAIChapterBase::is_audio_preview_url_Valid() const{
    return m_audio_preview_url_isValid;
}

QList<QString> OAIChapterBase::getAvailableMarkets() const {
    return m_available_markets;
}
void OAIChapterBase::setAvailableMarkets(const QList<QString> &available_markets) {
    m_available_markets = available_markets;
    m_available_markets_isSet = true;
}

bool OAIChapterBase::is_available_markets_Set() const{
    return m_available_markets_isSet;
}

bool OAIChapterBase::is_available_markets_Valid() const{
    return m_available_markets_isValid;
}

qint32 OAIChapterBase::getChapterNumber() const {
    return m_chapter_number;
}
void OAIChapterBase::setChapterNumber(const qint32 &chapter_number) {
    m_chapter_number = chapter_number;
    m_chapter_number_isSet = true;
}

bool OAIChapterBase::is_chapter_number_Set() const{
    return m_chapter_number_isSet;
}

bool OAIChapterBase::is_chapter_number_Valid() const{
    return m_chapter_number_isValid;
}

QString OAIChapterBase::getDescription() const {
    return m_description;
}
void OAIChapterBase::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIChapterBase::is_description_Set() const{
    return m_description_isSet;
}

bool OAIChapterBase::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAIChapterBase::getDurationMs() const {
    return m_duration_ms;
}
void OAIChapterBase::setDurationMs(const qint32 &duration_ms) {
    m_duration_ms = duration_ms;
    m_duration_ms_isSet = true;
}

bool OAIChapterBase::is_duration_ms_Set() const{
    return m_duration_ms_isSet;
}

bool OAIChapterBase::is_duration_ms_Valid() const{
    return m_duration_ms_isValid;
}

bool OAIChapterBase::isRExplicit() const {
    return m_r_explicit;
}
void OAIChapterBase::setRExplicit(const bool &r_explicit) {
    m_r_explicit = r_explicit;
    m_r_explicit_isSet = true;
}

bool OAIChapterBase::is_r_explicit_Set() const{
    return m_r_explicit_isSet;
}

bool OAIChapterBase::is_r_explicit_Valid() const{
    return m_r_explicit_isValid;
}

OAIExternalUrlObject OAIChapterBase::getExternalUrls() const {
    return m_external_urls;
}
void OAIChapterBase::setExternalUrls(const OAIExternalUrlObject &external_urls) {
    m_external_urls = external_urls;
    m_external_urls_isSet = true;
}

bool OAIChapterBase::is_external_urls_Set() const{
    return m_external_urls_isSet;
}

bool OAIChapterBase::is_external_urls_Valid() const{
    return m_external_urls_isValid;
}

QString OAIChapterBase::getHref() const {
    return m_href;
}
void OAIChapterBase::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAIChapterBase::is_href_Set() const{
    return m_href_isSet;
}

bool OAIChapterBase::is_href_Valid() const{
    return m_href_isValid;
}

QString OAIChapterBase::getHtmlDescription() const {
    return m_html_description;
}
void OAIChapterBase::setHtmlDescription(const QString &html_description) {
    m_html_description = html_description;
    m_html_description_isSet = true;
}

bool OAIChapterBase::is_html_description_Set() const{
    return m_html_description_isSet;
}

bool OAIChapterBase::is_html_description_Valid() const{
    return m_html_description_isValid;
}

QString OAIChapterBase::getId() const {
    return m_id;
}
void OAIChapterBase::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIChapterBase::is_id_Set() const{
    return m_id_isSet;
}

bool OAIChapterBase::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIImageObject> OAIChapterBase::getImages() const {
    return m_images;
}
void OAIChapterBase::setImages(const QList<OAIImageObject> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAIChapterBase::is_images_Set() const{
    return m_images_isSet;
}

bool OAIChapterBase::is_images_Valid() const{
    return m_images_isValid;
}

bool OAIChapterBase::isIsPlayable() const {
    return m_is_playable;
}
void OAIChapterBase::setIsPlayable(const bool &is_playable) {
    m_is_playable = is_playable;
    m_is_playable_isSet = true;
}

bool OAIChapterBase::is_is_playable_Set() const{
    return m_is_playable_isSet;
}

bool OAIChapterBase::is_is_playable_Valid() const{
    return m_is_playable_isValid;
}

QList<QString> OAIChapterBase::getLanguages() const {
    return m_languages;
}
void OAIChapterBase::setLanguages(const QList<QString> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAIChapterBase::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAIChapterBase::is_languages_Valid() const{
    return m_languages_isValid;
}

QString OAIChapterBase::getName() const {
    return m_name;
}
void OAIChapterBase::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIChapterBase::is_name_Set() const{
    return m_name_isSet;
}

bool OAIChapterBase::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIChapterBase::getReleaseDate() const {
    return m_release_date;
}
void OAIChapterBase::setReleaseDate(const QString &release_date) {
    m_release_date = release_date;
    m_release_date_isSet = true;
}

bool OAIChapterBase::is_release_date_Set() const{
    return m_release_date_isSet;
}

bool OAIChapterBase::is_release_date_Valid() const{
    return m_release_date_isValid;
}

QString OAIChapterBase::getReleaseDatePrecision() const {
    return m_release_date_precision;
}
void OAIChapterBase::setReleaseDatePrecision(const QString &release_date_precision) {
    m_release_date_precision = release_date_precision;
    m_release_date_precision_isSet = true;
}

bool OAIChapterBase::is_release_date_precision_Set() const{
    return m_release_date_precision_isSet;
}

bool OAIChapterBase::is_release_date_precision_Valid() const{
    return m_release_date_precision_isValid;
}

OAIChapterRestrictionObject OAIChapterBase::getRestrictions() const {
    return m_restrictions;
}
void OAIChapterBase::setRestrictions(const OAIChapterRestrictionObject &restrictions) {
    m_restrictions = restrictions;
    m_restrictions_isSet = true;
}

bool OAIChapterBase::is_restrictions_Set() const{
    return m_restrictions_isSet;
}

bool OAIChapterBase::is_restrictions_Valid() const{
    return m_restrictions_isValid;
}

OAIResumePointObject OAIChapterBase::getResumePoint() const {
    return m_resume_point;
}
void OAIChapterBase::setResumePoint(const OAIResumePointObject &resume_point) {
    m_resume_point = resume_point;
    m_resume_point_isSet = true;
}

bool OAIChapterBase::is_resume_point_Set() const{
    return m_resume_point_isSet;
}

bool OAIChapterBase::is_resume_point_Valid() const{
    return m_resume_point_isValid;
}

QString OAIChapterBase::getType() const {
    return m_type;
}
void OAIChapterBase::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIChapterBase::is_type_Set() const{
    return m_type_isSet;
}

bool OAIChapterBase::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIChapterBase::getUri() const {
    return m_uri;
}
void OAIChapterBase::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAIChapterBase::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAIChapterBase::is_uri_Valid() const{
    return m_uri_isValid;
}

bool OAIChapterBase::isSet() const {
...
bool OAIChapterBase::isValid() const {
