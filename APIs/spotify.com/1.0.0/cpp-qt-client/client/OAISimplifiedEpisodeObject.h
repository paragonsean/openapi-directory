...
/*
 * OAISimplifiedEpisodeObject.h
 *
 * 
 */

#ifndef OAISimplifiedEpisodeObject_H
#define OAISimplifiedEpisodeObject_H
...
class OAISimplifiedEpisodeObject : public OAIObject {
public:
    OAISimplifiedEpisodeObject();
    OAISimplifiedEpisodeObject(QString json);
    ~OAISimplifiedEpisodeObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimplifiedEpisodeObject)

#endif // OAISimplifiedEpisodeObject_H
