...
public:
    ...
    QMap<QString, QJsonValue> getContextUri() const;
    void setContextUri(const QMap<QString, QJsonValue> &context_uri);
    ...
    QMap<QString, QJsonValue> getPositionMs() const;
    void setPositionMs(const QMap<QString, QJsonValue> &position_ms);
...
private:
    ...
    QMap<QString, QJsonValue> m_context_uri;
    ...
    QMap<QString, QJsonValue> m_position_ms;
