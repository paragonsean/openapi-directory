...
/*
 * OAIPagingArtistObject.h
 *
 * 
 */

#ifndef OAIPagingArtistObject_H
#define OAIPagingArtistObject_H
...
class OAIPagingArtistObject : public OAIObject {
public:
    OAIPagingArtistObject();
    OAIPagingArtistObject(QString json);
    ~OAIPagingArtistObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPagingArtistObject)

#endif // OAIPagingArtistObject_H
