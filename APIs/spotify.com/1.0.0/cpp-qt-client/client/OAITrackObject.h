...
#ifndef OAITrackObject_H
#define OAITrackObject_H
...
class OAITrackObject : public OAIObject {
public:
    OAITrackObject();
    OAITrackObject(QString json);
    ~OAITrackObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrackObject)

#endif // OAITrackObject_H
