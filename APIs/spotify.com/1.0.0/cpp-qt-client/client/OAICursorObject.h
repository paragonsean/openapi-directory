...
#ifndef OAICursorObject_H
#define OAICursorObject_H
...
class OAICursorObject : public OAIObject {
public:
    OAICursorObject();
    OAICursorObject(QString json);
    ~OAICursorObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICursorObject)

#endif // OAICursorObject_H
