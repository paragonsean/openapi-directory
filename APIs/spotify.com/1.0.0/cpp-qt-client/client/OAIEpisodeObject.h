...
#ifndef OAIEpisodeObject_H
#define OAIEpisodeObject_H
...
class OAIEpisodeObject : public OAIObject {
public:
    OAIEpisodeObject();
    OAIEpisodeObject(QString json);
    ~OAIEpisodeObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEpisodeObject)

#endif // OAIEpisodeObject_H
