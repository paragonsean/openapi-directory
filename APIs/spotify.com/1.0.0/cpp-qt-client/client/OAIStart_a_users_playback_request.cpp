...
QMap<QString, QJsonValue> OAIStart_a_users_playback_request::getContextUri() const {
    return m_context_uri;
}
void OAIStart_a_users_playback_request::setContextUri(const QMap<QString, QJsonValue> &context_uri) {
...
QMap<QString, QJsonValue> OAIStart_a_users_playback_request::getPositionMs() const {
    return m_position_ms;
}
void OAIStart_a_users_playback_request::setPositionMs(const QMap<QString, QJsonValue> &position_ms) {
