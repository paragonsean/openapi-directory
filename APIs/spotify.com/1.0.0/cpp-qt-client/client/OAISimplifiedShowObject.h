...
/*
 * OAISimplifiedShowObject.h
 *
 * 
 */

#ifndef OAISimplifiedShowObject_H
#define OAISimplifiedShowObject_H
...
class OAISimplifiedShowObject : public OAIObject {
public:
    OAISimplifiedShowObject();
    OAISimplifiedShowObject(QString json);
    ~OAISimplifiedShowObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimplifiedShowObject)

#endif // OAISimplifiedShowObject_H
