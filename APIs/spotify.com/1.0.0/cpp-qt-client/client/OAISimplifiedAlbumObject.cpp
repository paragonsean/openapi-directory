...
QList<OAICopyrightObject> OAISimplifiedAlbumObject::getCopyrights() const {
    return m_copyrights;
}
void OAISimplifiedAlbumObject::setCopyrights(const QList<OAICopyrightObject> &copyrights) {
    m_copyrights = copyrights;
    m_copyrights_isSet = true;
}

bool OAISimplifiedAlbumObject::is_copyrights_Set() const{
    return m_copyrights_isSet;
}

bool OAISimplifiedAlbumObject::is_copyrights_Valid() const{
    return m_copyrights_isValid;
}

OAIExternalIdObject OAISimplifiedAlbumObject::getExternalIds() const {
    return m_external_ids;
}
void OAISimplifiedAlbumObject::setExternalIds(const OAIExternalIdObject &external_ids) {
    m_external_ids = external_ids;
    m_external_ids_isSet = true;
}

bool OAISimplifiedAlbumObject::is_external_ids_Set() const{
    return m_external_ids_isSet;
}

bool OAISimplifiedAlbumObject::is_external_ids_Valid() const{
...
QList<QString> OAISimplifiedAlbumObject::getGenres() const {
    return m_genres;
}
void OAISimplifiedAlbumObject::setGenres(const QList<QString> &genres) {
    m_genres = genres;
    m_genres_isSet = true;
}

bool OAISimplifiedAlbumObject::is_genres_Set() const{
    return m_genres_isSet;
}

bool OAISimplifiedAlbumObject::is_genres_Valid() const{
...
QString OAISimplifiedAlbumObject::getLabel() const {
    return m_label;
}
void OAISimplifiedAlbumObject::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAISimplifiedAlbumObject::is_label_Set() const{
    return m_label_isSet;
}

bool OAISimplifiedAlbumObject::is_label_Valid() const{
...
qint32 OAISimplifiedAlbumObject::getPopularity() const {
    return m_popularity;
}
void OAISimplifiedAlbumObject::setPopularity(const qint32 &popularity) {
    m_popularity = popularity;
    m_popularity_isSet = true;
}

bool OAISimplifiedAlbumObject::is_popularity_Set() const{
    return m_popularity_isSet;
}

bool OAISimplifiedAlbumObject::is_popularity_Valid() const{
