...
OAISimplifiedShowObject::OAISimplifiedShowObject(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISimplifiedShowObject::OAISimplifiedShowObject() {
    this->initializeModel();
}

OAISimplifiedShowObject::~OAISimplifiedShowObject() {}

void OAISimplifiedShowObject::initializeModel() {
...
void OAISimplifiedShowObject::fromJson(QString jsonString) {
...
void OAISimplifiedShowObject::fromJsonObject(QJsonObject json) {
...
QString OAISimplifiedShowObject::asJson() const {
...
QJsonObject OAISimplifiedShowObject::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAISimplifiedShowObject::getAvailableMarkets() const {
    return m_available_markets;
}
void OAISimplifiedShowObject::setAvailableMarkets(const QList<QString> &available_markets) {
    m_available_markets = available_markets;
    m_available_markets_isSet = true;
}

bool OAISimplifiedShowObject::is_available_markets_Set() const{
    return m_available_markets_isSet;
}

bool OAISimplifiedShowObject::is_available_markets_Valid() const{
    return m_available_markets_isValid;
}

QList<OAICopyrightObject> OAISimplifiedShowObject::getCopyrights() const {
    return m_copyrights;
}
void OAISimplifiedShowObject::setCopyrights(const QList<OAICopyrightObject> &copyrights) {
    m_copyrights = copyrights;
    m_copyrights_isSet = true;
}

bool OAISimplifiedShowObject::is_copyrights_Set() const{
    return m_copyrights_isSet;
}

bool OAISimplifiedShowObject::is_copyrights_Valid() const{
    return m_copyrights_isValid;
}

QString OAISimplifiedShowObject::getDescription() const {
    return m_description;
}
void OAISimplifiedShowObject::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISimplifiedShowObject::is_description_Set() const{
    return m_description_isSet;
}

bool OAISimplifiedShowObject::is_description_Valid() const{
    return m_description_isValid;
}

bool OAISimplifiedShowObject::isRExplicit() const {
    return m_r_explicit;
}
void OAISimplifiedShowObject::setRExplicit(const bool &r_explicit) {
    m_r_explicit = r_explicit;
    m_r_explicit_isSet = true;
}

bool OAISimplifiedShowObject::is_r_explicit_Set() const{
    return m_r_explicit_isSet;
}

bool OAISimplifiedShowObject::is_r_explicit_Valid() const{
    return m_r_explicit_isValid;
}

OAIExternalUrlObject OAISimplifiedShowObject::getExternalUrls() const {
    return m_external_urls;
}
void OAISimplifiedShowObject::setExternalUrls(const OAIExternalUrlObject &external_urls) {
    m_external_urls = external_urls;
    m_external_urls_isSet = true;
}

bool OAISimplifiedShowObject::is_external_urls_Set() const{
    return m_external_urls_isSet;
}

bool OAISimplifiedShowObject::is_external_urls_Valid() const{
    return m_external_urls_isValid;
}

QString OAISimplifiedShowObject::getHref() const {
    return m_href;
}
void OAISimplifiedShowObject::setHref(const QString &href) {
    m_href = href;
    m_href_isSet = true;
}

bool OAISimplifiedShowObject::is_href_Set() const{
    return m_href_isSet;
}

bool OAISimplifiedShowObject::is_href_Valid() const{
    return m_href_isValid;
}

QString OAISimplifiedShowObject::getHtmlDescription() const {
    return m_html_description;
}
void OAISimplifiedShowObject::setHtmlDescription(const QString &html_description) {
    m_html_description = html_description;
    m_html_description_isSet = true;
}

bool OAISimplifiedShowObject::is_html_description_Set() const{
    return m_html_description_isSet;
}

bool OAISimplifiedShowObject::is_html_description_Valid() const{
    return m_html_description_isValid;
}

QString OAISimplifiedShowObject::getId() const {
    return m_id;
}
void OAISimplifiedShowObject::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISimplifiedShowObject::is_id_Set() const{
    return m_id_isSet;
}

bool OAISimplifiedShowObject::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIImageObject> OAISimplifiedShowObject::getImages() const {
    return m_images;
}
void OAISimplifiedShowObject::setImages(const QList<OAIImageObject> &images) {
    m_images = images;
    m_images_isSet = true;
}

bool OAISimplifiedShowObject::is_images_Set() const{
    return m_images_isSet;
}

bool OAISimplifiedShowObject::is_images_Valid() const{
    return m_images_isValid;
}

bool OAISimplifiedShowObject::isIsExternallyHosted() const {
    return m_is_externally_hosted;
}
void OAISimplifiedShowObject::setIsExternallyHosted(const bool &is_externally_hosted) {
    m_is_externally_hosted = is_externally_hosted;
    m_is_externally_hosted_isSet = true;
}

bool OAISimplifiedShowObject::is_is_externally_hosted_Set() const{
    return m_is_externally_hosted_isSet;
}

bool OAISimplifiedShowObject::is_is_externally_hosted_Valid() const{
    return m_is_externally_hosted_isValid;
}

QList<QString> OAISimplifiedShowObject::getLanguages() const {
    return m_languages;
}
void OAISimplifiedShowObject::setLanguages(const QList<QString> &languages) {
    m_languages = languages;
    m_languages_isSet = true;
}

bool OAISimplifiedShowObject::is_languages_Set() const{
    return m_languages_isSet;
}

bool OAISimplifiedShowObject::is_languages_Valid() const{
    return m_languages_isValid;
}

QString OAISimplifiedShowObject::getMediaType() const {
    return m_media_type;
}
void OAISimplifiedShowObject::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAISimplifiedShowObject::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAISimplifiedShowObject::is_media_type_Valid() const{
    return m_media_type_isValid;
}

QString OAISimplifiedShowObject::getName() const {
    return m_name;
}
void OAISimplifiedShowObject::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISimplifiedShowObject::is_name_Set() const{
    return m_name_isSet;
}

bool OAISimplifiedShowObject::is_name_Valid() const{
    return m_name_isValid;
}

QString OAISimplifiedShowObject::getPublisher() const {
    return m_publisher;
}
void OAISimplifiedShowObject::setPublisher(const QString &publisher) {
    m_publisher = publisher;
    m_publisher_isSet = true;
}

bool OAISimplifiedShowObject::is_publisher_Set() const{
    return m_publisher_isSet;
}

bool OAISimplifiedShowObject::is_publisher_Valid() const{
    return m_publisher_isValid;
}

qint32 OAISimplifiedShowObject::getTotalEpisodes() const {
    return m_total_episodes;
}
void OAISimplifiedShowObject::setTotalEpisodes(const qint32 &total_episodes) {
    m_total_episodes = total_episodes;
    m_total_episodes_isSet = true;
}

bool OAISimplifiedShowObject::is_total_episodes_Set() const{
    return m_total_episodes_isSet;
}

bool OAISimplifiedShowObject::is_total_episodes_Valid() const{
    return m_total_episodes_isValid;
}

QString OAISimplifiedShowObject::getType() const {
    return m_type;
}
void OAISimplifiedShowObject::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISimplifiedShowObject::is_type_Set() const{
    return m_type_isSet;
}

bool OAISimplifiedShowObject::is_type_Valid() const{
    return m_type_isValid;
}

QString OAISimplifiedShowObject::getUri() const {
    return m_uri;
}
void OAISimplifiedShowObject::setUri(const QString &uri) {
    m_uri = uri;
    m_uri_isSet = true;
}

bool OAISimplifiedShowObject::is_uri_Set() const{
    return m_uri_isSet;
}

bool OAISimplifiedShowObject::is_uri_Valid() const{
    return m_uri_isValid;
}

bool OAISimplifiedShowObject::isSet() const {
...
bool OAISimplifiedShowObject::isValid() const {
