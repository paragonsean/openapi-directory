...
/**
 * The ShowBase model module.
 * @module model/ShowBase
 * @version 1.0.0
 */
class ShowBase {
    /**
     * Constructs a new <code>ShowBase</code>.
     * @alias module:model/ShowBase
     ...
     * @param type {module:model/ShowBase.TypeEnum} The object type. 
    ...
    /**
     * Constructs a <code>ShowBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShowBase} obj Optional instance to populate.
     * @return {module:model/ShowBase} The populated <code>ShowBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShowBase();
    ...
    /**
     * Validates the JSON data with respect to <code>ShowBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShowBase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ShowBase.RequiredProperties) {
...
ShowBase.RequiredProperties = ["available_markets", "copyrights", "description", "explicit", "external_urls", "href", "html_description", "id", "images", "is_externally_hosted", "languages", "media_type", "name", "publisher", "total_episodes", "type", "uri"];
