...
/**
 * The ShowObject model module.
 * @module model/ShowObject
 * @version 1.0.0
 */
class ShowObject {
    /**
     * Constructs a new <code>ShowObject</code>.
     * @alias module:model/ShowObject
     ...
     * @param type {module:model/ShowObject.TypeEnum} The object type. 
     * @param uri {String} The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the show. 
     * @param episodes {Object} The episodes of the show. 
     */
    constructor(availableMarkets, copyrights, description, explicit, externalUrls, href, htmlDescription, id, images, isExternallyHosted, languages, mediaType, name, publisher, totalEpisodes, type, uri, episodes) { 
        ...
        ShowObject.initialize(this, availableMarkets, copyrights, description, explicit, externalUrls, href, htmlDescription, id, images, isExternallyHosted, languages, mediaType, name, publisher, totalEpisodes, type, uri, episodes);
    }
     ...
     */
    static initialize(obj, availableMarkets, copyrights, description, explicit, externalUrls, href, htmlDescription, id, images, isExternallyHosted, languages, mediaType, name, publisher, totalEpisodes, type, uri, episodes) { 
    ...
    /**
     * Constructs a <code>ShowObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShowObject} obj Optional instance to populate.
     * @return {module:model/ShowObject} The populated <code>ShowObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShowObject();
            ...
            if (data.hasOwnProperty('episodes')) {
                obj['episodes'] = ApiClient.convertToType(data['episodes'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ShowObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShowObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ShowObject.RequiredProperties) {
...
ShowObject.RequiredProperties = ["available_markets", "copyrights", "description", "explicit", "external_urls", "href", "html_description", "id", "images", "is_externally_hosted", "languages", "media_type", "name", "publisher", "total_episodes", "type", "uri", "episodes"];

/**
 * A list of the countries in which the show can be played, identified by their [ISO 3166-1 alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) code. 
 * @member {Array.<String>} available_markets
 */
ShowObject.prototype['available_markets'] = undefined;

/**
 * The copyright statements of the show. 
 * @member {Array.<module:model/CopyrightObject>} copyrights
 */
ShowObject.prototype['copyrights'] = undefined;

/**
 * A description of the show. HTML tags are stripped away from this field, use `html_description` field in case HTML tags are needed. 
 * @member {String} description
 */
ShowObject.prototype['description'] = undefined;

/**
 * Whether or not the show has explicit content (true = yes it does; false = no it does not OR unknown). 
 * @member {Boolean} explicit
 */
ShowObject.prototype['explicit'] = undefined;

/**
 * External URLs for this show. 
 * @member {module:model/ExternalUrlObject} external_urls
 */
ShowObject.prototype['external_urls'] = undefined;

/**
 * A link to the Web API endpoint providing full details of the show. 
 * @member {String} href
 */
ShowObject.prototype['href'] = undefined;

/**
 * A description of the show. This field may contain HTML tags. 
 * @member {String} html_description
 */
ShowObject.prototype['html_description'] = undefined;

/**
 * The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the show. 
 * @member {String} id
 */
ShowObject.prototype['id'] = undefined;

/**
 * The cover art for the show in various sizes, widest first. 
 * @member {Array.<module:model/ImageObject>} images
 */
ShowObject.prototype['images'] = undefined;

/**
 * True if all of the shows episodes are hosted outside of Spotify's CDN. This field might be `null` in some cases. 
 * @member {Boolean} is_externally_hosted
 */
ShowObject.prototype['is_externally_hosted'] = undefined;

/**
 * A list of the languages used in the show, identified by their [ISO 639](https://en.wikipedia.org/wiki/ISO_639) code. 
 * @member {Array.<String>} languages
 */
ShowObject.prototype['languages'] = undefined;

/**
 * The media type of the show. 
 * @member {String} media_type
 */
ShowObject.prototype['media_type'] = undefined;

/**
 * The name of the episode. 
 * @member {String} name
 */
ShowObject.prototype['name'] = undefined;

/**
 * The publisher of the show. 
 * @member {String} publisher
 */
ShowObject.prototype['publisher'] = undefined;

/**
 * The total number of episodes in the show. 
 * @member {Number} total_episodes
 */
ShowObject.prototype['total_episodes'] = undefined;

/**
 * The object type. 
 * @member {module:model/ShowObject.TypeEnum} type
 */
ShowObject.prototype['type'] = undefined;

/**
 * The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the show. 
 * @member {String} uri
 */
ShowObject.prototype['uri'] = undefined;

/**
 * The episodes of the show. 
 * @member {Object} episodes
 */
ShowObject.prototype['episodes'] = undefined;
