...
/**
 * The ChapterObject model module.
 * @module model/ChapterObject
 * @version 1.0.0
 */
class ChapterObject {
    /**
     * Constructs a new <code>ChapterObject</code>.
     * @alias module:model/ChapterObject
     ...
     * @param releaseDatePrecision {module:model/ChapterObject.ReleaseDatePrecisionEnum} The precision with which `release_date` value is known. 
     ...
     * @param type {module:model/ChapterObject.TypeEnum} The object type. 
     * @param uri {String} The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
     * @param audiobook {module:model/SimplifiedAudiobookObject} 
     */
    constructor(audioPreviewUrl, chapterNumber, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri, audiobook) { 
        ...
        ChapterObject.initialize(this, audioPreviewUrl, chapterNumber, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri, audiobook);
    }
     ...
     */
    static initialize(obj, audioPreviewUrl, chapterNumber, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri, audiobook) { 
    ...
    /**
     * Constructs a <code>ChapterObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChapterObject} obj Optional instance to populate.
     * @return {module:model/ChapterObject} The populated <code>ChapterObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChapterObject();
            ...
            if (data.hasOwnProperty('audiobook')) {
                obj['audiobook'] = SimplifiedAudiobookObject.constructFromObject(data['audiobook']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ChapterObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChapterObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChapterObject.RequiredProperties) {
        ...
        if (data['audiobook']) { // data not null
          SimplifiedAudiobookObject.validateJSON(data['audiobook']);
        }
...
ChapterObject.RequiredProperties = ["audio_preview_url", "chapter_number", "description", "duration_ms", "explicit", "external_urls", "href", "html_description", "id", "images", "is_playable", "languages", "name", "release_date", "release_date_precision", "resume_point", "type", "uri", "audiobook"];

/**
 * A URL to a 30 second preview (MP3 format) of the episode. `null` if not available. 
 * @member {String} audio_preview_url
 */
ChapterObject.prototype['audio_preview_url'] = undefined;
 ...
 */
ChapterObject.prototype['available_markets'] = undefined;

/**
 * The number of the chapter 
 * @member {Number} chapter_number
 */
ChapterObject.prototype['chapter_number'] = undefined;

/**
 * A description of the episode. HTML tags are stripped away from this field, use `html_description` field in case HTML tags are needed. 
 * @member {String} description
 */
ChapterObject.prototype['description'] = undefined;

/**
 * The episode length in milliseconds. 
 * @member {Number} duration_ms
 */
ChapterObject.prototype['duration_ms'] = undefined;

/**
 * Whether or not the episode has explicit content (true = yes it does; false = no it does not OR unknown). 
 * @member {Boolean} explicit
 */
ChapterObject.prototype['explicit'] = undefined;

/**
 * External URLs for this episode. 
 * @member {module:model/ExternalUrlObject} external_urls
 */
ChapterObject.prototype['external_urls'] = undefined;

/**
 * A link to the Web API endpoint providing full details of the episode. 
 * @member {String} href
 */
ChapterObject.prototype['href'] = undefined;

/**
 * A description of the episode. This field may contain HTML tags. 
 * @member {String} html_description
 */
ChapterObject.prototype['html_description'] = undefined;

/**
 * The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
 * @member {String} id
 */
ChapterObject.prototype['id'] = undefined;

/**
 * The cover art for the episode in various sizes, widest first. 
 * @member {Array.<module:model/ImageObject>} images
 */
ChapterObject.prototype['images'] = undefined;

/**
 * True if the episode is playable in the given market. Otherwise false. 
 * @member {Boolean} is_playable
 */
ChapterObject.prototype['is_playable'] = undefined;

/**
 * A list of the languages used in the episode, identified by their [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639) code. 
 * @member {Array.<String>} languages
 */
ChapterObject.prototype['languages'] = undefined;

/**
 * The name of the episode. 
 * @member {String} name
 */
ChapterObject.prototype['name'] = undefined;

/**
 * The date the episode was first released, for example `\"1981-12-15\"`. Depending on the precision, it might be shown as `\"1981\"` or `\"1981-12\"`. 
 * @member {String} release_date
 */
ChapterObject.prototype['release_date'] = undefined;

/**
 * The precision with which `release_date` value is known. 
 * @member {module:model/ChapterObject.ReleaseDatePrecisionEnum} release_date_precision
 */
ChapterObject.prototype['release_date_precision'] = undefined;

/**
 * Included in the response when a content restriction is applied. 
 * @member {module:model/ChapterRestrictionObject} restrictions
 */
ChapterObject.prototype['restrictions'] = undefined;

/**
 * The user's most recent position in the episode. Set if the supplied access token is a user token and has the scope 'user-read-playback-position'. 
 * @member {module:model/ResumePointObject} resume_point
 */
ChapterObject.prototype['resume_point'] = undefined;

/**
 * The object type. 
 * @member {module:model/ChapterObject.TypeEnum} type
 */
ChapterObject.prototype['type'] = undefined;

/**
 * The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
 * @member {String} uri
 */
ChapterObject.prototype['uri'] = undefined;

/**
 * @member {module:model/SimplifiedAudiobookObject} audiobook
 */
ChapterObject.prototype['audiobook'] = undefined;
 ...
 * @readonly
 */
ChapterObject['ReleaseDatePrecisionEnum'] = {
