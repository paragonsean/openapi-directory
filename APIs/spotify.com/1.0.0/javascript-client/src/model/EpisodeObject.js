...
/**
 * The EpisodeObject model module.
 * @module model/EpisodeObject
 * @version 1.0.0
 */
class EpisodeObject {
    /**
     * Constructs a new <code>EpisodeObject</code>.
     * @alias module:model/EpisodeObject
     * @implements module:model/EpisodeBase
     ...
     * @param releaseDatePrecision {module:model/EpisodeObject.ReleaseDatePrecisionEnum} The precision with which `release_date` value is known. 
     ...
     * @param type {module:model/EpisodeObject.TypeEnum} The object type. 
     * @param uri {String} The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
     * @param show {module:model/SimplifiedShowObject} 
     */
    constructor(audioPreviewUrl, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isExternallyHosted, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri, show) { 
        ...
        EpisodeObject.initialize(this, audioPreviewUrl, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isExternallyHosted, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri, show);
    }
     ...
     */
    static initialize(obj, audioPreviewUrl, description, durationMs, explicit, externalUrls, href, htmlDescription, id, images, isExternallyHosted, isPlayable, languages, name, releaseDate, releaseDatePrecision, resumePoint, type, uri, show) { 
    ...
    /**
     * Constructs a <code>EpisodeObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EpisodeObject} obj Optional instance to populate.
     * @return {module:model/EpisodeObject} The populated <code>EpisodeObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EpisodeObject();
            EpisodeBase.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('show')) {
                obj['show'] = SimplifiedShowObject.constructFromObject(data['show']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EpisodeObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EpisodeObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EpisodeObject.RequiredProperties) {
...
EpisodeObject.RequiredProperties = ["audio_preview_url", "description", "duration_ms", "explicit", "external_urls", "href", "html_description", "id", "images", "is_externally_hosted", "is_playable", "languages", "name", "release_date", "release_date_precision", "resume_point", "type", "uri", "show"];

/**
 * A URL to a 30 second preview (MP3 format) of the episode. `null` if not available. 
 * @member {String} audio_preview_url
 */
EpisodeObject.prototype['audio_preview_url'] = undefined;

/**
 * A description of the episode. HTML tags are stripped away from this field, use `html_description` field in case HTML tags are needed. 
 * @member {String} description
 */
EpisodeObject.prototype['description'] = undefined;

/**
 * The episode length in milliseconds. 
 * @member {Number} duration_ms
 */
EpisodeObject.prototype['duration_ms'] = undefined;

/**
 * Whether or not the episode has explicit content (true = yes it does; false = no it does not OR unknown). 
 * @member {Boolean} explicit
 */
EpisodeObject.prototype['explicit'] = undefined;

/**
 * External URLs for this episode. 
 * @member {module:model/ExternalUrlObject} external_urls
 */
EpisodeObject.prototype['external_urls'] = undefined;

/**
 * A link to the Web API endpoint providing full details of the episode. 
 * @member {String} href
 */
EpisodeObject.prototype['href'] = undefined;

/**
 * A description of the episode. This field may contain HTML tags. 
 * @member {String} html_description
 */
EpisodeObject.prototype['html_description'] = undefined;

/**
 * The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
 * @member {String} id
 */
EpisodeObject.prototype['id'] = undefined;

/**
 * The cover art for the episode in various sizes, widest first. 
 * @member {Array.<module:model/ImageObject>} images
 */
EpisodeObject.prototype['images'] = undefined;

/**
 * True if the episode is hosted outside of Spotify's CDN. 
 * @member {Boolean} is_externally_hosted
 */
EpisodeObject.prototype['is_externally_hosted'] = undefined;

/**
 * True if the episode is playable in the given market. Otherwise false. 
 * @member {Boolean} is_playable
 */
EpisodeObject.prototype['is_playable'] = undefined;

/**
 * The language used in the episode, identified by a [ISO 639](https://en.wikipedia.org/wiki/ISO_639) code. This field is deprecated and might be removed in the future. Please use the `languages` field instead. 
 * @member {String} language
 */
EpisodeObject.prototype['language'] = undefined;

/**
 * A list of the languages used in the episode, identified by their [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639) code. 
 * @member {Array.<String>} languages
 */
EpisodeObject.prototype['languages'] = undefined;

/**
 * The name of the episode. 
 * @member {String} name
 */
EpisodeObject.prototype['name'] = undefined;

/**
 * The date the episode was first released, for example `\"1981-12-15\"`. Depending on the precision, it might be shown as `\"1981\"` or `\"1981-12\"`. 
 * @member {String} release_date
 */
EpisodeObject.prototype['release_date'] = undefined;

/**
 * The precision with which `release_date` value is known. 
 * @member {module:model/EpisodeObject.ReleaseDatePrecisionEnum} release_date_precision
 */
EpisodeObject.prototype['release_date_precision'] = undefined;

/**
 * Included in the response when a content restriction is applied. 
 * @member {module:model/EpisodeRestrictionObject} restrictions
 */
EpisodeObject.prototype['restrictions'] = undefined;

/**
 * The user's most recent position in the episode. Set if the supplied access token is a user token and has the scope 'user-read-playback-position'. 
 * @member {module:model/ResumePointObject} resume_point
 */
EpisodeObject.prototype['resume_point'] = undefined;

/**
 * The object type. 
 * @member {module:model/EpisodeObject.TypeEnum} type
 */
EpisodeObject.prototype['type'] = undefined;

/**
 * The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the episode. 
 * @member {String} uri
 */
EpisodeObject.prototype['uri'] = undefined;

/**
 * @member {module:model/SimplifiedShowObject} show
 */
EpisodeObject.prototype['show'] = undefined;


// Implement EpisodeBase interface:
/**
 * A URL to a 30 second preview (MP3 format) of the episode. `null` if not available. 
 * @member {String} audio_preview_url
 */
 ...
 * @readonly
 */
EpisodeObject['ReleaseDatePrecisionEnum'] = {
