...
export default class UsersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getUsersTopArtistsAndTracks operation.
     * @callback module:api/UsersApi~getUsersTopArtistsAndTracksCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} [limit = 20)] 
     * @param {Number} [offset = 0)] 
     * @param {module:api/UsersApi~getUsersTopArtistsAndTracksCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetUsersTopArtistsAndTracks200Response}
     */
    getUsersTopArtistsAndTracks(type, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'type' is set
      if (type === undefined || type === null) {
        throw new Error("Missing the required parameter 'type' when calling getUsersTopArtistsAndTracks");
      }
