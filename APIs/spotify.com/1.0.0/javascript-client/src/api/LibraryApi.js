...
export default class LibraryApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PagingSimplifiedAudiobookObject} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PagingSimplifiedAudiobookObject}
     */
    getUsersSavedAudiobooks_0(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PagingSimplifiedAudiobookObject;
      return this.apiClient.callApi(
        '/me/audiobooks', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the getUsersTopArtistsAndTracks_1 operation.
     * @callback module:api/LibraryApi~getUsersTopArtistsAndTracks_1Callback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} [limit = 20)] 
     * @param {Number} [offset = 0)] 
     * @param {module:api/LibraryApi~getUsersTopArtistsAndTracks_1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetUsersTopArtistsAndTracks200Response}
     */
    getUsersTopArtistsAndTracks_1(type, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'type' is set
      if (type === undefined || type === null) {
        throw new Error("Missing the required parameter 'type' when calling getUsersTopArtistsAndTracks_1");
      }
