...
let apiInstance = new SpotifyWebApi.LibraryApi();
...
> PagingSimplifiedAudiobookObject getUsersSavedAudiobooks_0(opts)
...
> GetUsersTopArtistsAndTracks200Response getUsersTopArtistsAndTracks_1(type, opts)
...
apiInstance.getUsersTopArtistsAndTracks_1(type, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new SpotifyWebApi.LibraryApi();
let ids = "5CfCWKI5pZ28U0uOzXkDHe,5as3aKmN2k11yfDDDSrvaZ"; // String | 
apiInstance.saveShowsUser_0(ids, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
