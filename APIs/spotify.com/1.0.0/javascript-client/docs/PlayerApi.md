...
let apiInstance = new SpotifyWebApi.PlayerApi();
...
> CurrentlyPlayingContextObject getTheUsersCurrentlyPlayingTrack(opts)
...
let opts = {
  'deviceId': "0d1841b0976bae2a3a310dd74c0f3df354899bc8", // String | 
  'startAUsersPlaybackRequest': new SpotifyWebApi.StartAUsersPlaybackRequest() // StartAUsersPlaybackRequest | 
};
...
let apiInstance = new SpotifyWebApi.PlayerApi();
let opts = {
  'transferAUsersPlaybackRequest': new SpotifyWebApi.TransferAUsersPlaybackRequest() // TransferAUsersPlaybackRequest | 
};
