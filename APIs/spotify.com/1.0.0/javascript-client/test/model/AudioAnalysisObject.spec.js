...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.AudioAnalysisObject();
  });
  ...
  describe('AudioAnalysisObject', function() {
    it('should create an instance of AudioAnalysisObject', function() {
      // uncomment below and update the code to test AudioAnalysisObject
      //var instance = new SpotifyWebApi.AudioAnalysisObject();
      //expect(instance).to.be.a(SpotifyWebApi.AudioAnalysisObject);
    });
    ...
    it('should have the property beats (base name: "beats")', function() {
      // uncomment below and update the code to test the property beats
      //var instance = new SpotifyWebApi.AudioAnalysisObject();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tatums (base name: "tatums")', function() {
      // uncomment below and update the code to test the property tatums
      //var instance = new SpotifyWebApi.AudioAnalysisObject();
      //expect(instance).to.be();
    });
