...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.CurrentlyPlayingObject();
  });
  ...
  describe('CurrentlyPlayingObject', function() {
    it('should create an instance of CurrentlyPlayingObject', function() {
      // uncomment below and update the code to test CurrentlyPlayingObject
      //var instance = new SpotifyWebApi.CurrentlyPlayingObject();
      //expect(instance).to.be.a(SpotifyWebApi.CurrentlyPlayingObject);
    });
