...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.QueueObjectQueueInner();
  });
  ...
  describe('QueueObjectQueueInner', function() {
    it('should create an instance of QueueObjectQueueInner', function() {
      ...
      //var instance = new SpotifyWebApi.QueueObjectQueueInner();
      //expect(instance).to.be.a(SpotifyWebApi.QueueObjectQueueInner);
    });
