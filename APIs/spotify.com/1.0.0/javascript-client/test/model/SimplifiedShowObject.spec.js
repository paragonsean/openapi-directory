...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.SimplifiedShowObject();
  });
  ...
  describe('SimplifiedShowObject', function() {
    it('should create an instance of SimplifiedShowObject', function() {
      ...
      //var instance = new SpotifyWebApi.SimplifiedShowObject();
      //expect(instance).to.be.a(SpotifyWebApi.SimplifiedShowObject);
    });
