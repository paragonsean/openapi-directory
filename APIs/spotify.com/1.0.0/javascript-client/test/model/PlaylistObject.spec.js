...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.PlaylistObject();
  });
  ...
  describe('PlaylistObject', function() {
    it('should create an instance of PlaylistObject', function() {
      // uncomment below and update the code to test PlaylistObject
      //var instance = new SpotifyWebApi.PlaylistObject();
      //expect(instance).to.be.a(SpotifyWebApi.PlaylistObject);
    });
