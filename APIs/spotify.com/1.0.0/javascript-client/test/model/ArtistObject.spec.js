...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.ArtistObject();
  });
  ...
  describe('ArtistObject', function() {
    it('should create an instance of ArtistObject', function() {
      // uncomment below and update the code to test ArtistObject
      //var instance = new SpotifyWebApi.ArtistObject();
      //expect(instance).to.be.a(SpotifyWebApi.ArtistObject);
    });
