...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.CursorObject();
  });
  ...
  describe('CursorObject', function() {
    it('should create an instance of CursorObject', function() {
      // uncomment below and update the code to test CursorObject
      //var instance = new SpotifyWebApi.CursorObject();
      //expect(instance).to.be.a(SpotifyWebApi.CursorObject);
    });
