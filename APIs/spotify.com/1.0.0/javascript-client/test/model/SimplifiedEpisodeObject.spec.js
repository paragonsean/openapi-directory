...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.SimplifiedEpisodeObject();
  });
  ...
  describe('SimplifiedEpisodeObject', function() {
    it('should create an instance of SimplifiedEpisodeObject', function() {
      // uncomment below and update the code to test SimplifiedEpisodeObject
      //var instance = new SpotifyWebApi.SimplifiedEpisodeObject();
      //expect(instance).to.be.a(SpotifyWebApi.SimplifiedEpisodeObject);
    });
