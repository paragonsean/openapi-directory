...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.AudiobookObject();
  });
  ...
  describe('AudiobookObject', function() {
    it('should create an instance of AudiobookObject', function() {
      // uncomment below and update the code to test AudiobookObject
      //var instance = new SpotifyWebApi.AudiobookObject();
      //expect(instance).to.be.a(SpotifyWebApi.AudiobookObject);
    });
