...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.SimplifiedTrackObject();
  });
  ...
  describe('SimplifiedTrackObject', function() {
    it('should create an instance of SimplifiedTrackObject', function() {
      ...
      //var instance = new SpotifyWebApi.SimplifiedTrackObject();
      //expect(instance).to.be.a(SpotifyWebApi.SimplifiedTrackObject);
    });
