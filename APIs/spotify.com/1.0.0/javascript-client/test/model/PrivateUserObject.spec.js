...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.PrivateUserObject();
  });
  ...
  describe('PrivateUserObject', function() {
    it('should create an instance of PrivateUserObject', function() {
      // uncomment below and update the code to test PrivateUserObject
      //var instance = new SpotifyWebApi.PrivateUserObject();
      //expect(instance).to.be.a(SpotifyWebApi.PrivateUserObject);
    });
