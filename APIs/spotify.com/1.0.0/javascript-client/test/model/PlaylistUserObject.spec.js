...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.PlaylistUserObject();
  });
  ...
  describe('PlaylistUserObject', function() {
    it('should create an instance of PlaylistUserObject', function() {
      // uncomment below and update the code to test PlaylistUserObject
      //var instance = new SpotifyWebApi.PlaylistUserObject();
      //expect(instance).to.be.a(SpotifyWebApi.PlaylistUserObject);
    });
