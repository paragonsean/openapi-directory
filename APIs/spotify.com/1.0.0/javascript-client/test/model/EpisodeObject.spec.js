...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.EpisodeObject();
  });
  ...
  describe('EpisodeObject', function() {
    it('should create an instance of EpisodeObject', function() {
      // uncomment below and update the code to test EpisodeObject
      //var instance = new SpotifyWebApi.EpisodeObject();
      //expect(instance).to.be.a(SpotifyWebApi.EpisodeObject);
    });
