...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.SavedAlbumObject();
  });
  ...
  describe('SavedAlbumObject', function() {
    it('should create an instance of SavedAlbumObject', function() {
      // uncomment below and update the code to test SavedAlbumObject
      //var instance = new SpotifyWebApi.SavedAlbumObject();
      //expect(instance).to.be.a(SpotifyWebApi.SavedAlbumObject);
    });
