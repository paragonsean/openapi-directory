...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.PlaylistOwnerObject();
  });
  ...
  describe('PlaylistOwnerObject', function() {
    it('should create an instance of PlaylistOwnerObject', function() {
      // uncomment below and update the code to test PlaylistOwnerObject
      //var instance = new SpotifyWebApi.PlaylistOwnerObject();
      //expect(instance).to.be.a(SpotifyWebApi.PlaylistOwnerObject);
    });
