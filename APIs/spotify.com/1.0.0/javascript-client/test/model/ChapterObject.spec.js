...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.ChapterObject();
  });
  ...
  describe('ChapterObject', function() {
    it('should create an instance of ChapterObject', function() {
      // uncomment below and update the code to test ChapterObject
      //var instance = new SpotifyWebApi.ChapterObject();
      //expect(instance).to.be.a(SpotifyWebApi.ChapterObject);
    });
    ...
    it('should have the property audiobook (base name: "audiobook")', function() {
      // uncomment below and update the code to test the property audiobook
      //var instance = new SpotifyWebApi.ChapterObject();
      //expect(instance).to.be();
    });
