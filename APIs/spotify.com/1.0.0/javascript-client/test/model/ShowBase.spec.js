...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.ShowBase();
  });
  ...
  describe('ShowBase', function() {
    it('should create an instance of ShowBase', function() {
      // uncomment below and update the code to test ShowBase
      //var instance = new SpotifyWebApi.ShowBase();
      //expect(instance).to.be.a(SpotifyWebApi.ShowBase);
    });
