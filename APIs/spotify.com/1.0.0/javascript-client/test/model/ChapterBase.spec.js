...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.ChapterBase();
  });
  ...
  describe('ChapterBase', function() {
    it('should create an instance of ChapterBase', function() {
      // uncomment below and update the code to test ChapterBase
      //var instance = new SpotifyWebApi.ChapterBase();
      //expect(instance).to.be.a(SpotifyWebApi.ChapterBase);
    });

    it('should have the property audioPreviewUrl (base name: "audio_preview_url")', function() {
      // uncomment below and update the code to test the property audioPreviewUrl
      //var instance = new SpotifyWebApi.ChapterBase();
    ...
    it('should have the property resumePoint (base name: "resume_point")', function() {
      // uncomment below and update the code to test the property resumePoint
      //var instance = new SpotifyWebApi.ChapterBase();
      //expect(instance).to.be();
    });
