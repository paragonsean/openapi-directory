...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.SavedTrackObject();
  });
  ...
  describe('SavedTrackObject', function() {
    it('should create an instance of SavedTrackObject', function() {
      // uncomment below and update the code to test SavedTrackObject
      //var instance = new SpotifyWebApi.SavedTrackObject();
      //expect(instance).to.be.a(SpotifyWebApi.SavedTrackObject);
    });
