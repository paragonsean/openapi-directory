...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpotifyWebApi.TracksApi();
  });
  ...
  describe('TracksApi', function() {
    ...
    describe('getUsersTopArtistsAndTracks_0', function() {
      it('should call getUsersTopArtistsAndTracks_0 successfully', function(done) {
        //uncomment below and update the code to test getUsersTopArtistsAndTracks_0
        //instance.getUsersTopArtistsAndTracks_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
