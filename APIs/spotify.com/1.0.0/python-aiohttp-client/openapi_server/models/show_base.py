...
class ShowBase(Model):
    ...
    def __init__(self, available_markets: List[str]=None, copyrights: List[CopyrightObject]=None, description: str=None, explicit: bool=None, external_urls: ExternalUrlObject=None, href: str=None, html_description: str=None, id: str=None, images: List[ImageObject]=None, is_externally_hosted: bool=None, languages: List[str]=None, media_type: str=None, name: str=None, publisher: str=None, total_episodes: int=None, type: str=None, uri: str=None):
        """ShowBase - a model defined in OpenAPI

        :param available_markets: The available_markets of this ShowBase.
        :param copyrights: The copyrights of this ShowBase.
        :param description: The description of this ShowBase.
        :param explicit: The explicit of this ShowBase.
        :param external_urls: The external_urls of this ShowBase.
        :param href: The href of this ShowBase.
        :param html_description: The html_description of this ShowBase.
        :param id: The id of this ShowBase.
        :param images: The images of this ShowBase.
        :param is_externally_hosted: The is_externally_hosted of this ShowBase.
        :param languages: The languages of this ShowBase.
        :param media_type: The media_type of this ShowBase.
        :param name: The name of this ShowBase.
        :param publisher: The publisher of this ShowBase.
        :param total_episodes: The total_episodes of this ShowBase.
        :param type: The type of this ShowBase.
        :param uri: The uri of this ShowBase.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ShowBase':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ShowBase of this ShowBase.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def available_markets(self):
        """Gets the available_markets of this ShowBase.

        A list of the countries in which the show can be played, identified by their [ISO 3166-1 alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) code. 

        :return: The available_markets of this ShowBase.
        :rtype: List[str]
        """
    ...
    @property
    def copyrights(self):
        """Gets the copyrights of this ShowBase.

        The copyright statements of the show. 

        :return: The copyrights of this ShowBase.
    ...
    def description(self):
        """Gets the description of this ShowBase.

        A description of the show. HTML tags are stripped away from this field, use `html_description` field in case HTML tags are needed. 

        :return: The description of this ShowBase.
        :rtype: str
        """
    ...
    @property
    def explicit(self):
        """Gets the explicit of this ShowBase.

        Whether or not the show has explicit content (true = yes it does; false = no it does not OR unknown). 

        :return: The explicit of this ShowBase.
        :rtype: bool
        """
    ...
    def external_urls(self):
        """Gets the external_urls of this ShowBase.

        External URLs for this show. 

        :return: The external_urls of this ShowBase.
    ...
    @property
    def href(self):
        """Gets the href of this ShowBase.

        A link to the Web API endpoint providing full details of the show. 

        :return: The href of this ShowBase.
        :rtype: str
        """
        return self._href
    ...
    def html_description(self):
        """Gets the html_description of this ShowBase.

        A description of the show. This field may contain HTML tags. 

        :return: The html_description of this ShowBase.
        :rtype: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this ShowBase.

        The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the show. 

        :return: The id of this ShowBase.
        :rtype: str
        """
        return self._id
    ...
    @property
    def images(self):
        """Gets the images of this ShowBase.

        The cover art for the show in various sizes, widest first. 

        :return: The images of this ShowBase.
    ...
    def is_externally_hosted(self):
        """Gets the is_externally_hosted of this ShowBase.

        True if all of the shows episodes are hosted outside of Spotify's CDN. This field might be `null` in some cases. 

        :return: The is_externally_hosted of this ShowBase.
        :rtype: bool
        """
    ...
    @property
    def languages(self):
        """Gets the languages of this ShowBase.

        A list of the languages used in the show, identified by their [ISO 639](https://en.wikipedia.org/wiki/ISO_639) code. 

        :return: The languages of this ShowBase.
        :rtype: List[str]
        """
    ...
    @property
    def media_type(self):
        """Gets the media_type of this ShowBase.

        The media type of the show. 

        :return: The media_type of this ShowBase.
        :rtype: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ShowBase.

        The name of the episode. 

        :return: The name of this ShowBase.
        :rtype: str
        """
        return self._name
    ...
    @property
    def publisher(self):
        """Gets the publisher of this ShowBase.

        The publisher of the show. 

        :return: The publisher of this ShowBase.
        :rtype: str
        """
    ...
    def total_episodes(self):
        """Gets the total_episodes of this ShowBase.

        The total number of episodes in the show. 

        :return: The total_episodes of this ShowBase.
        :rtype: int
        """
    ...
    @property
    def type(self):
        """Gets the type of this ShowBase.

        The object type. 

        :return: The type of this ShowBase.
        :rtype: str
        """
        return self._type
    ...
    @property
    def uri(self):
        """Gets the uri of this ShowBase.

        The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the show. 

        :return: The uri of this ShowBase.
        :rtype: str
        """
        return self._uri
