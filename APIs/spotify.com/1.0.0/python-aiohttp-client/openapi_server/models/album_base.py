...
class AlbumBase(Model):
    ...
    def __init__(self, album_type: str=None, available_markets: List[str]=None, copyrights: List[CopyrightObject]=None, external_ids: ExternalIdObject=None, external_urls: ExternalUrlObject=None, genres: List[str]=None, href: str=None, id: str=None, images: List[ImageObject]=None, label: str=None, name: str=None, popularity: int=None, release_date: str=None, release_date_precision: str=None, restrictions: AlbumRestrictionObject=None, total_tracks: int=None, type: str=None, uri: str=None):
        ...
        :param copyrights: The copyrights of this AlbumBase.
        :param external_ids: The external_ids of this AlbumBase.
        :param external_urls: The external_urls of this AlbumBase.
        :param genres: The genres of this AlbumBase.
        :param href: The href of this AlbumBase.
        :param id: The id of this AlbumBase.
        :param images: The images of this AlbumBase.
        :param label: The label of this AlbumBase.
        :param name: The name of this AlbumBase.
        :param popularity: The popularity of this AlbumBase.
    ...
    @property
    def copyrights(self):
        """Gets the copyrights of this AlbumBase.

        The copyright statements of the album. 

        :return: The copyrights of this AlbumBase.
    ...
    def external_ids(self):
        """Gets the external_ids of this AlbumBase.

        Known external IDs for the album. 

        :return: The external_ids of this AlbumBase.
    ...
    @property
    def genres(self):
        """Gets the genres of this AlbumBase.

        A list of the genres the album is associated with. If not yet classified, the array is empty. 

        :return: The genres of this AlbumBase.
        :rtype: List[str]
        """
        return self._genres
    ...
    @property
    def label(self):
        """Gets the label of this AlbumBase.

        The label associated with the album. 

        :return: The label of this AlbumBase.
        :rtype: str
        """
        return self._label
    ...
    @property
    def popularity(self):
        """Gets the popularity of this AlbumBase.

        The popularity of the album. The value will be between 0 and 100, with 100 being the most popular. 

        :return: The popularity of this AlbumBase.
        :rtype: int
        """
