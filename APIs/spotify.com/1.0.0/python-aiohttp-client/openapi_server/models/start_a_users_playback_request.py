...
class StartAUsersPlaybackRequest(Model):
    ...
    def __init__(self, context_uri: Dict[str, object]=None, offset: Dict[str, object]=None, position_ms: Dict[str, object]=None, uris: List[str]=None):
        ...
        """
        self.openapi_types = {
            'context_uri': Dict[str, object],
            'offset': Dict[str, object],
            'position_ms': Dict[str, object],
            'uris': List[str]
        }
    ...
    def context_uri(self, context_uri):
        ...
        :param context_uri: The context_uri of this StartAUsersPlaybackRequest.
        :type context_uri: Dict[str, object]
        """
    ...
    def position_ms(self, position_ms):
        ...
        :param position_ms: The position_ms of this StartAUsersPlaybackRequest.
        :type position_ms: Dict[str, object]
        """
