...
public:
    ...
    * @param[in]  body OAIProduct [required]
    */
    virtual void postProduct(const QString &site_id, const OAIProduct &body);
...
Q_SIGNALS:
    ...
    void postProductSignal();


    void postProductSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use postProductSignalError() instead")
    void postProductSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void postProductSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
