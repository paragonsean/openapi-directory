...
void OAICartItem::initializeModel() {
    ...
    m_cart_item_number_isSet = false;
    m_cart_item_number_isValid = false;
...
void OAICartItem::fromJsonObject(QJsonObject json) {
    ...
    m_cart_item_number_isValid = ::OpenAPI::fromJsonValue(m_cart_item_number, json[QString("cart_item_number")]);
    m_cart_item_number_isSet = !json[QString("cart_item_number")].isNull() && m_cart_item_number_isValid;
...
QJsonObject OAICartItem::asJsonObject() const {
    QJsonObject obj;
    if (m_cart_item_number_isSet) {
        obj.insert(QString("cart_item_number"), ::OpenAPI::toJsonValue(m_cart_item_number));
    }
...
QString OAICartItem::getCartItemNumber() const {
    return m_cart_item_number;
}
void OAICartItem::setCartItemNumber(const QString &cart_item_number) {
    m_cart_item_number = cart_item_number;
    m_cart_item_number_isSet = true;
}

bool OAICartItem::is_cart_item_number_Set() const{
    return m_cart_item_number_isSet;
}

bool OAICartItem::is_cart_item_number_Valid() const{
    return m_cart_item_number_isValid;
}

QDateTime OAICartItem::getChangeDate() const {
    return m_change_date;
}
void OAICartItem::setChangeDate(const QDateTime &change_date) {
    m_change_date = change_date;
    m_change_date_isSet = true;
}

bool OAICartItem::is_change_date_Set() const{
    return m_change_date_isSet;
}

bool OAICartItem::is_change_date_Valid() const{
    return m_change_date_isValid;
}

QDateTime OAICartItem::getCreateDate() const {
    return m_create_date;
}
void OAICartItem::setCreateDate(const QDateTime &create_date) {
    m_create_date = create_date;
    m_create_date_isSet = true;
}

bool OAICartItem::is_create_date_Set() const{
    return m_create_date_isSet;
}

bool OAICartItem::is_create_date_Valid() const{
    return m_create_date_isValid;
}

double OAICartItem::getDiscountPrice() const {
    return m_discount_price;
}
void OAICartItem::setDiscountPrice(const double &discount_price) {
    m_discount_price = discount_price;
    m_discount_price_isSet = true;
}

bool OAICartItem::is_discount_price_Set() const{
    return m_discount_price_isSet;
}

bool OAICartItem::is_discount_price_Valid() const{
    return m_discount_price_isValid;
}

QString OAICartItem::getId() const {
    return m_id;
}
void OAICartItem::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICartItem::is_id_Set() const{
    return m_id_isSet;
}

bool OAICartItem::is_id_Valid() const{
    return m_id_isValid;
}

double OAICartItem::getPrice() const {
    return m_price;
}
void OAICartItem::setPrice(const double &price) {
    m_price = price;
    m_price_isSet = true;
}
...
OAIProduct OAICartItem::getProduct() const {
    return m_product;
}
void OAICartItem::setProduct(const OAIProduct &product) {
    m_product = product;
    m_product_isSet = true;
}

bool OAICartItem::is_product_Set() const{
    return m_product_isSet;
}

bool OAICartItem::is_product_Valid() const{
...
bool OAICartItem::isValid() const {
    ...
    return m_cart_item_number_isValid && m_change_date_isValid && m_create_date_isValid && m_discount_price_isValid && m_id_isValid && m_price_isValid && m_product_isValid && m_quantity_isValid && true;
}
