...
public:
    ...
    QString getOrderItemNumber() const;
    void setOrderItemNumber(const QString &order_item_number);
    bool is_order_item_number_Set() const;
    bool is_order_item_number_Valid() const;
...
private:
    ...
    QString m_order_item_number;
    bool m_order_item_number_isSet;
    bool m_order_item_number_isValid;
