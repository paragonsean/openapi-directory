...
void OAIProductApi::postProduct(const QString &site_id, const OAIProduct &body) {
    QString fullPath = QString(_serverConfigs["postProduct"][_serverIndices.value("postProduct")].URL()+"/{siteId}/product");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductApi::postProductCallback);
...
void OAIProductApi::postProductCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT postProductSignal();
        Q_EMIT postProductSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT postProductSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT postProductSignalError(error_type, error_str);
