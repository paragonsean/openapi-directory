...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JirafeEvents.OrderItem();
  });
  ...
  describe('OrderItem', function() {
    it('should create an instance of OrderItem', function() {
      ...
      //var instance = new JirafeEvents.OrderItem();
      //expect(instance).to.be.a(JirafeEvents.OrderItem);
    });
    ...
    it('should have the property orderItemNumber (base name: "order_item_number")', function() {
