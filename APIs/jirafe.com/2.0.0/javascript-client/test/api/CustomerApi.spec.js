...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JirafeEvents.CustomerApi();
  });
  ...
  describe('CustomerApi', function() {
    describe('postCustomer', function() {
      it('should call postCustomer successfully', function(done) {
        //uncomment below and update the code to test postCustomer
        //instance.postCustomer(function(error) {
