...
public class Example {
  public static void main(String[] args) {
    ...
    Category body = new Category(); // Category | category json for the event
    try {
      apiInstance.postCategory(siteId, body);
    } catch (ApiException e) {
      System.err.println("Exception when calling CategoryApi#postCategory");
