...
public class ApiClient {
    ...
    private String basePath = "https://event.jirafe.com/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("oauth2_accessCode", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://account.jirafe.com/oauth2/code";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://event.jirafe.com/v2
