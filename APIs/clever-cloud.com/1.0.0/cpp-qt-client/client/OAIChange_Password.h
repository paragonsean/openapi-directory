...
/*
 * OAIChange_Password.h
 *
 * 
 */

#ifndef OAIChange_Password_H
#define OAIChange_Password_H
...
class OAIChange_Password : public OAIObject {
public:
    OAIChange_Password();
    OAIChange_Password(QString json);
    ~OAIChange_Password() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChange_Password)

#endif // OAIChange_Password_H
