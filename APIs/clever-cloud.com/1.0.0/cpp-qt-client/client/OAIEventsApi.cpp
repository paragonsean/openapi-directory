...
void OAIEventsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("eventsEventSocketGet", defaultConf);
    _serverIndices.insert("eventsEventSocketGet", 0);
    _serverConfigs.insert("notificationsInfoEventsGet", defaultConf);
    _serverIndices.insert("notificationsInfoEventsGet", 0);
}
...
void OAIEventsApi::eventsEventSocketGet() {
    QString fullPath = QString(_serverConfigs["eventsEventSocketGet"][_serverIndices.value("eventsEventSocketGet")].URL()+"/events/event-socket");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::eventsEventSocketGetCallback);
...
void OAIEventsApi::eventsEventSocketGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT eventsEventSocketGetSignal();
        Q_EMIT eventsEventSocketGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT eventsEventSocketGetSignalE(error_type, error_str);
        Q_EMIT eventsEventSocketGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT eventsEventSocketGetSignalError(error_type, error_str);
        Q_EMIT eventsEventSocketGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEventsApi::notificationsInfoEventsGet() {
    QString fullPath = QString(_serverConfigs["notificationsInfoEventsGet"][_serverIndices.value("notificationsInfoEventsGet")].URL()+"/notifications/info/events");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::notificationsInfoEventsGetCallback);
    connect(this, &OAIEventsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEventsApi::notificationsInfoEventsGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT notificationsInfoEventsGetSignal();
        Q_EMIT notificationsInfoEventsGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT notificationsInfoEventsGetSignalE(error_type, error_str);
        Q_EMIT notificationsInfoEventsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT notificationsInfoEventsGetSignalError(error_type, error_str);
        Q_EMIT notificationsInfoEventsGetSignalErrorFull(worker, error_type, error_str);
    }
}
