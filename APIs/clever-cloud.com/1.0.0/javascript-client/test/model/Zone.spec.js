...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CleverCloudApi.Zone();
  });
  ...
  describe('Zone', function() {
    it('should create an instance of Zone', function() {
      ...
      //var instance = new CleverCloudApi.Zone();
      //expect(instance).to.be.a(CleverCloudApi.Zone);
    });

    it('should have the property correspondingRegion (base name: "correspondingRegion")', function() {
      // uncomment below and update the code to test the property correspondingRegion
      //var instance = new CleverCloudApi.Zone();
