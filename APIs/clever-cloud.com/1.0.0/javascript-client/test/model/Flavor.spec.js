...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CleverCloudApi.Flavor();
  });
  ...
  describe('Flavor', function() {
    it('should create an instance of Flavor', function() {
      ...
      //var instance = new CleverCloudApi.Flavor();
      //expect(instance).to.be.a(CleverCloudApi.Flavor);
    });
    ...
    it('should have the property microservice (base name: "microservice")', function() {
      // uncomment below and update the code to test the property microservice
      //var instance = new CleverCloudApi.Flavor();
      //expect(instance).to.be();
    });
