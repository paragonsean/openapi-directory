...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CleverCloudApi.SummaryUser();
  });
  ...
  describe('SummaryUser', function() {
    it('should create an instance of SummaryUser', function() {
      // uncomment below and update the code to test SummaryUser
      //var instance = new CleverCloudApi.SummaryUser();
      //expect(instance).to.be.a(CleverCloudApi.SummaryUser);
    });
