...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CleverCloudApi.Vhost();
  });
  ...
  describe('Vhost', function() {
    it('should create an instance of Vhost', function() {
      // uncomment below and update the code to test Vhost
      //var instance = new CleverCloudApi.Vhost();
      //expect(instance).to.be.a(CleverCloudApi.Vhost);
    });
