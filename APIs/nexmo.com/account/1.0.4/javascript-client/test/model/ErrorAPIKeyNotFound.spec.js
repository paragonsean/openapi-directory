...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountApi.ErrorAPIKeyNotFound();
  });
  ...
  describe('ErrorAPIKeyNotFound', function() {
    it('should create an instance of ErrorAPIKeyNotFound', function() {
      // uncomment below and update the code to test ErrorAPIKeyNotFound
      //var instance = new AccountApi.ErrorAPIKeyNotFound();
      //expect(instance).to.be.a(AccountApi.ErrorAPIKeyNotFound);
    });
