...
QJsonValue OAISuccess::getErrorCode() const {
    return m_error_code;
}
void OAISuccess::setErrorCode(const QJsonValue &error_code) {
    m_error_code = error_code;
    m_error_code_isSet = true;
}

bool OAISuccess::is_error_code_Set() const{
    return m_error_code_isSet;
}

bool OAISuccess::is_error_code_Valid() const{
    return m_error_code_isValid;
}

QJsonValue OAISuccess::getErrorCodeLabel() const {
    return m_error_code_label;
}
void OAISuccess::setErrorCodeLabel(const QJsonValue &error_code_label) {
    m_error_code_label = error_code_label;
    m_error_code_label_isSet = true;
}

bool OAISuccess::is_error_code_label_Set() const{
    return m_error_code_label_isSet;
}

bool OAISuccess::is_error_code_label_Valid() const{
