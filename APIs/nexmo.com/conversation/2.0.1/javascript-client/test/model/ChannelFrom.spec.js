...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConversationApi.ChannelFrom();
  });
  ...
  describe('ChannelFrom', function() {
    it('should create an instance of ChannelFrom', function() {
      // uncomment below and update the code to test ChannelFrom
      //var instance = new ConversationApi.ChannelFrom();
      //expect(instance).to.be.a(ConversationApi.ChannelFrom);
    });
