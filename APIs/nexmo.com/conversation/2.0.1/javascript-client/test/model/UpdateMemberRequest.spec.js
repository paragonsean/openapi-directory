...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConversationApi.UpdateMemberRequest();
  });
  ...
  describe('UpdateMemberRequest', function() {
    it('should create an instance of UpdateMemberRequest', function() {
      ...
      //var instance = new ConversationApi.UpdateMemberRequest();
      //expect(instance).to.be.a(ConversationApi.UpdateMemberRequest);
    });
