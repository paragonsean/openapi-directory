...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConversationApi.CreateUserRequest();
  });
  ...
  describe('CreateUserRequest', function() {
    it('should create an instance of CreateUserRequest', function() {
      ...
      //var instance = new ConversationApi.CreateUserRequest();
      //expect(instance).to.be.a(ConversationApi.CreateUserRequest);
    });
