...
public class UpdateUserRequest {
  ...
  public UpdateUserRequest channels(Channel channels) {
  ...
  public UpdateUserRequest imageUrl(String imageUrl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.channels, updateUserRequest.channels) &&
        Objects.equals(this.displayName, updateUserRequest.displayName) &&
        Objects.equals(this.imageUrl, updateUserRequest.imageUrl) &&
        Objects.equals(this.name, updateUserRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channels, displayName, imageUrl, name);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("channels") != null && !jsonObj.get("channels").isJsonNull()) {
        Channel.validateJsonElement(jsonObj.get("channels"));
      }
