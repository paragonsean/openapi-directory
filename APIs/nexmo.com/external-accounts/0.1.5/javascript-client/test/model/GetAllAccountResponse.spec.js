...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExternalAccountsApi.GetAllAccountResponse();
  });
  ...
  describe('GetAllAccountResponse', function() {
    it('should create an instance of GetAllAccountResponse', function() {
      // uncomment below and update the code to test GetAllAccountResponse
      //var instance = new ExternalAccountsApi.GetAllAccountResponse();
      //expect(instance).to.be.a(ExternalAccountsApi.GetAllAccountResponse);
    });
