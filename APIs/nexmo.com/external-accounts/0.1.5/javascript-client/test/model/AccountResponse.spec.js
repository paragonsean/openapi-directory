...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExternalAccountsApi.AccountResponse();
  });
  ...
  describe('AccountResponse', function() {
    it('should create an instance of AccountResponse', function() {
      ...
      //var instance = new ExternalAccountsApi.AccountResponse();
      //expect(instance).to.be.a(ExternalAccountsApi.AccountResponse);
    });
