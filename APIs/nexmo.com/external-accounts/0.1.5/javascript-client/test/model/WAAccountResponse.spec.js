...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExternalAccountsApi.WAAccountResponse();
  });
  ...
  describe('WAAccountResponse', function() {
    it('should create an instance of WAAccountResponse', function() {
      // uncomment below and update the code to test WAAccountResponse
      //var instance = new ExternalAccountsApi.WAAccountResponse();
      //expect(instance).to.be.a(ExternalAccountsApi.WAAccountResponse);
    });
