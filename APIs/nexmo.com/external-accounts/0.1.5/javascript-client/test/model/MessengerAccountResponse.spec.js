...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExternalAccountsApi.MessengerAccountResponse();
  });
  ...
  describe('MessengerAccountResponse', function() {
    it('should create an instance of MessengerAccountResponse', function() {
      // uncomment below and update the code to test MessengerAccountResponse
      //var instance = new ExternalAccountsApi.MessengerAccountResponse();
      //expect(instance).to.be.a(ExternalAccountsApi.MessengerAccountResponse);
    });
