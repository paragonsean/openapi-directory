...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExternalAccountsApi.GetAllAccounts200ResponseLinks();
  });
  ...
  describe('GetAllAccounts200ResponseLinks', function() {
    it('should create an instance of GetAllAccounts200ResponseLinks', function() {
      // uncomment below and update the code to test GetAllAccounts200ResponseLinks
      //var instance = new ExternalAccountsApi.GetAllAccounts200ResponseLinks();
      //expect(instance).to.be.a(ExternalAccountsApi.GetAllAccounts200ResponseLinks);
    });
