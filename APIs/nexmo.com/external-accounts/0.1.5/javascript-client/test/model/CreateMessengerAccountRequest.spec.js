...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExternalAccountsApi.CreateMessengerAccountRequest();
  });
  ...
  describe('CreateMessengerAccountRequest', function() {
    it('should create an instance of CreateMessengerAccountRequest', function() {
      // uncomment below and update the code to test CreateMessengerAccountRequest
      //var instance = new ExternalAccountsApi.CreateMessengerAccountRequest();
      //expect(instance).to.be.a(ExternalAccountsApi.CreateMessengerAccountRequest);
    });
