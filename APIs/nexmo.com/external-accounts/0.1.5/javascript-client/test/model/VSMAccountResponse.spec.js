...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExternalAccountsApi.VSMAccountResponse();
  });
  ...
  describe('VSMAccountResponse', function() {
    it('should create an instance of VSMAccountResponse', function() {
      // uncomment below and update the code to test VSMAccountResponse
      //var instance = new ExternalAccountsApi.VSMAccountResponse();
      //expect(instance).to.be.a(ExternalAccountsApi.VSMAccountResponse);
    });
