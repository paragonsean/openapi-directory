...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExternalAccountsApi.UpdateMessengerAccount200Response();
  });
  ...
  describe('UpdateMessengerAccount200Response', function() {
    it('should create an instance of UpdateMessengerAccount200Response', function() {
      // uncomment below and update the code to test UpdateMessengerAccount200Response
      //var instance = new ExternalAccountsApi.UpdateMessengerAccount200Response();
      //expect(instance).to.be.a(ExternalAccountsApi.UpdateMessengerAccount200Response);
    });
