...
/*
 * OAIMessengerAccountResponse.h
 *
 * 
 */

#ifndef OAIMessengerAccountResponse_H
#define OAIMessengerAccountResponse_H
...
class OAIMessengerAccountResponse : public OAIObject {
public:
    OAIMessengerAccountResponse();
    OAIMessengerAccountResponse(QString json);
    ~OAIMessengerAccountResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessengerAccountResponse)

#endif // OAIMessengerAccountResponse_H
