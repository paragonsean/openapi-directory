...
QString OAIAccountResponse::getAccessToken() const {
    return m_access_token;
}
void OAIAccountResponse::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIAccountResponse::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIAccountResponse::is_access_token_Valid() const{
    return m_access_token_isValid;
}

QString OAIAccountResponse::getApiKey() const {
    return m_api_key;
}
void OAIAccountResponse::setApiKey(const QString &api_key) {
    m_api_key = api_key;
    m_api_key_isSet = true;
}

bool OAIAccountResponse::is_api_key_Set() const{
    return m_api_key_isSet;
}

bool OAIAccountResponse::is_api_key_Valid() const{
    return m_api_key_isValid;
}

QList<QString> OAIAccountResponse::getApplications() const {
    return m_applications;
}
void OAIAccountResponse::setApplications(const QList<QString> &applications) {
    m_applications = applications;
    m_applications_isSet = true;
}

bool OAIAccountResponse::is_applications_Set() const{
    return m_applications_isSet;
}

bool OAIAccountResponse::is_applications_Valid() const{
    return m_applications_isValid;
}

QString OAIAccountResponse::getExternalId() const {
    return m_external_id;
}
void OAIAccountResponse::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAIAccountResponse::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAIAccountResponse::is_external_id_Valid() const{
...
QString OAIAccountResponse::getProvider() const {
    return m_provider;
}
void OAIAccountResponse::setProvider(const QString &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAIAccountResponse::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAIAccountResponse::is_provider_Valid() const{
