...
/*
 * OAIWAAccountResponse.h
 *
 * 
 */

#ifndef OAIWAAccountResponse_H
#define OAIWAAccountResponse_H
...
class OAIWAAccountResponse : public OAIObject {
public:
    OAIWAAccountResponse();
    OAIWAAccountResponse(QString json);
    ~OAIWAAccountResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWAAccountResponse)

#endif // OAIWAAccountResponse_H
