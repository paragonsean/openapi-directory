...
void OAIAccountApi::getAllAccounts(const ::OpenAPI::OptionalParam<QString> &provider, const ::OpenAPI::OptionalParam<qint32> &page_number, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["getAllAccounts"][_serverIndices.value("getAllAccounts")].URL()+"/");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountApi::getAllAccountsCallback);
...
void OAIAccountApi::getAllAccountsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetAllAccounts_200_response output(QString(worker->response));
    worker->deleteLater();
