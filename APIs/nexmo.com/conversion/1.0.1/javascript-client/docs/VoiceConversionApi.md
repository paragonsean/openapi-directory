# NexmoConversionApi.VoiceConversionApi
...
let apiInstance = new NexmoConversionApi.VoiceConversionApi();
...
apiInstance.voiceConversion(messageId, delivered, timestamp, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
