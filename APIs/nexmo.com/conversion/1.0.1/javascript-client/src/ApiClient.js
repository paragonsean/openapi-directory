...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.nexmo.com/conversions') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.nexmo.com/conversions
         */
        ...
        this.authentications = {
            ...
            'apiSecret': {type: 'apiKey', 'in': 'query', name: 'api_secret'},
            'apiSig': {type: 'apiKey', 'in': 'query', name: 'sig'}
        }
