...
/**
* SMSConversion service.
* @module api/SMSConversionApi
* @version 1.0.1
*/
export default class SMSConversionApi {

    /**
    * Constructs a new SMSConversionApi. 
    * @alias module:api/SMSConversionApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the smsConversion operation.
     * @callback module:api/SMSConversionApi~smsConversionCallback
     ...
     * @param {module:api/SMSConversionApi~smsConversionCallback} callback The callback function, accepting three arguments: error, data, response
     */
    smsConversion(messageId, delivered, timestamp, callback) {
      let postBody = null;
      // verify the required parameter 'messageId' is set
      if (messageId === undefined || messageId === null) {
        throw new Error("Missing the required parameter 'messageId' when calling smsConversion");
      }
      // verify the required parameter 'delivered' is set
      if (delivered === undefined || delivered === null) {
        throw new Error("Missing the required parameter 'delivered' when calling smsConversion");
      }
      // verify the required parameter 'timestamp' is set
      if (timestamp === undefined || timestamp === null) {
        throw new Error("Missing the required parameter 'timestamp' when calling smsConversion");
      }
