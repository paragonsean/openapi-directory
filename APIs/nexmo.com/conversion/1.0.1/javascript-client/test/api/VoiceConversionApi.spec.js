...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexmoConversionApi.VoiceConversionApi();
  });
  ...
  describe('VoiceConversionApi', function() {
    describe('voiceConversion', function() {
      it('should call voiceConversion successfully', function(done) {
        //uncomment below and update the code to test voiceConversion
        //instance.voiceConversion(function(error) {
