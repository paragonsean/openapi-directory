...
/**
 * API tests for SmsConversionApi
 */
@Disabled
public class SmsConversionApiTest {

    private final SmsConversionApi api = new SmsConversionApi();
     ...
     */
    @Test
    public void smsConversionTest() throws ApiException {
        String messageId = null;
        Boolean delivered = null;
        String timestamp = null;
        api.smsConversion(messageId, delivered, timestamp);
