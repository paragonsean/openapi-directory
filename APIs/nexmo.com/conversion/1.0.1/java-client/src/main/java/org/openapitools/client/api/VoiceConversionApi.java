...
public class VoiceConversionApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public VoiceConversionApi() {
        this(Configuration.getDefaultApiClient());
    }

    public VoiceConversionApi(ApiClient apiClient) {
    ...
    /**
     * Build call for voiceConversion
     ...
     */
    public okhttp3.Call voiceConversionCall(String messageId, Boolean delivered, String timestamp, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call voiceConversionValidateBeforeCall(String messageId, Boolean delivered, String timestamp, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'messageId' is set
        if (messageId == null) {
            throw new ApiException("Missing the required parameter 'messageId' when calling voiceConversion(Async)");
        }

        // verify the required parameter 'delivered' is set
        if (delivered == null) {
            throw new ApiException("Missing the required parameter 'delivered' when calling voiceConversion(Async)");
        }

        // verify the required parameter 'timestamp' is set
        if (timestamp == null) {
            throw new ApiException("Missing the required parameter 'timestamp' when calling voiceConversion(Async)");
        }

        return voiceConversionCall(messageId, delivered, timestamp, _callback);
     ...
     */
    public void voiceConversion(String messageId, Boolean delivered, String timestamp) throws ApiException {
        voiceConversionWithHttpInfo(messageId, delivered, timestamp);
    }
     ...
     */
    public ApiResponse<Void> voiceConversionWithHttpInfo(String messageId, Boolean delivered, String timestamp) throws ApiException {
        okhttp3.Call localVarCall = voiceConversionValidateBeforeCall(messageId, delivered, timestamp, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Tell Nexmo if your voice call was successful (asynchronously)
     * Send a Conversion API request with information about the Call or Text-To-Speech identified by &#x60;message-id&#x60;. Nexmo uses your conversion data and internal information about &#x60;message-id&#x60; to help improve our routing of messages in the future.
     * @param messageId The ID you receive in the response to a request. * From the Verify API - use the &#x60;event_id&#x60; in the response to Verify Check. * From the SMS API - use the &#x60;message-id&#x60; * From the Text-To-Speech API - use the &#x60;call-id&#x60; * From the Text-To-Speech-Prompt API - use the &#x60;call-id&#x60; (required)
     * @param delivered Set to _true_ if your user replied to the message you sent. Otherwise, set to _false_. **Note**: for curl, use 0 and 1. (required)
     * @param timestamp When the user completed your call-to-action (e.g. visited your website, installed your app) in [UTC±00:00](https://en.wikipedia.org/wiki/UTC%C2%B100:00) format: _yyyy-MM-dd HH:mm:ss_. If you do not set this parameter, Nexmo uses the time it receives this request. (required)
     ...
     */
    public okhttp3.Call voiceConversionAsync(String messageId, Boolean delivered, String timestamp, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = voiceConversionValidateBeforeCall(messageId, delivered, timestamp, _callback);
