...
public class ApiClient {
    ...
    private String basePath = "https://api.nexmo.com/conversions";
    ...
    public ApiClient() {
        ...
        authentications.put("apiSig", new ApiKeyAuth("query", "sig"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.nexmo.com/conversions
