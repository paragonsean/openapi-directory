...
/*
 * OAIKeysWithPrivateKey.h
 *
 * 
 */

#ifndef OAIKeysWithPrivateKey_H
#define OAIKeysWithPrivateKey_H
...
class OAIKeysWithPrivateKey : public OAIObject {
public:
    OAIKeysWithPrivateKey();
    OAIKeysWithPrivateKey(QString json);
    ~OAIKeysWithPrivateKey() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeysWithPrivateKey)

#endif // OAIKeysWithPrivateKey_H
