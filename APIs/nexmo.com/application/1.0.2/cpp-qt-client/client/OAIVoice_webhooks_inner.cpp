...
OAIVoice_webhooks_inner::OAIVoice_webhooks_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVoice_webhooks_inner::OAIVoice_webhooks_inner() {
    this->initializeModel();
}

OAIVoice_webhooks_inner::~OAIVoice_webhooks_inner() {}

void OAIVoice_webhooks_inner::initializeModel() {
...
void OAIVoice_webhooks_inner::fromJson(QString jsonString) {
...
void OAIVoice_webhooks_inner::fromJsonObject(QJsonObject json) {
...
QString OAIVoice_webhooks_inner::asJson() const {
...
QJsonObject OAIVoice_webhooks_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_endpoint_isSet) {
...
QString OAIVoice_webhooks_inner::getEndpoint() const {
    return m_endpoint;
}
void OAIVoice_webhooks_inner::setEndpoint(const QString &endpoint) {
    m_endpoint = endpoint;
    m_endpoint_isSet = true;
}

bool OAIVoice_webhooks_inner::is_endpoint_Set() const{
    return m_endpoint_isSet;
}

bool OAIVoice_webhooks_inner::is_endpoint_Valid() const{
    return m_endpoint_isValid;
}

QString OAIVoice_webhooks_inner::getEndpointType() const {
    return m_endpoint_type;
}
void OAIVoice_webhooks_inner::setEndpointType(const QString &endpoint_type) {
    m_endpoint_type = endpoint_type;
    m_endpoint_type_isSet = true;
}

bool OAIVoice_webhooks_inner::is_endpoint_type_Set() const{
    return m_endpoint_type_isSet;
}

bool OAIVoice_webhooks_inner::is_endpoint_type_Valid() const{
    return m_endpoint_type_isValid;
}

QString OAIVoice_webhooks_inner::getHttpMethod() const {
    return m_http_method;
}
void OAIVoice_webhooks_inner::setHttpMethod(const QString &http_method) {
    m_http_method = http_method;
    m_http_method_isSet = true;
}

bool OAIVoice_webhooks_inner::is_http_method_Set() const{
    return m_http_method_isSet;
}

bool OAIVoice_webhooks_inner::is_http_method_Valid() const{
    return m_http_method_isValid;
}

bool OAIVoice_webhooks_inner::isSet() const {
...
bool OAIVoice_webhooks_inner::isValid() const {
