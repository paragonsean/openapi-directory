...
namespace OpenAPI {
class OAIMessages_webhooks_inner;
...
public:
    ...
    QList<OAIMessages_webhooks_inner> getWebhooks() const;
    void setWebhooks(const QList<OAIMessages_webhooks_inner> &webhooks);
...
private:
    ...
    QList<OAIMessages_webhooks_inner> m_webhooks;
