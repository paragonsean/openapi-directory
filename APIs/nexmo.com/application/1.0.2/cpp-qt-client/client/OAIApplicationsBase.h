...
/*
 * OAIApplicationsBase.h
 *
 * 
 */

#ifndef OAIApplicationsBase_H
#define OAIApplicationsBase_H
...
class OAIApplicationsBase : public OAIObject {
public:
    OAIApplicationsBase();
    OAIApplicationsBase(QString json);
    ~OAIApplicationsBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationsBase)

#endif // OAIApplicationsBase_H
