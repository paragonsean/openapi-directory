...
public class MessagesWebhooksInner {
  ...
  public MessagesWebhooksInner() {
  }

  public MessagesWebhooksInner endpoint(String endpoint) {
  ...
  public MessagesWebhooksInner endpointType(EndpointTypeEnum endpointType) {
  ...
  public MessagesWebhooksInner httpMethod(HttpMethodEnum httpMethod) {
  ...
  public boolean equals(Object o) {
    ...
    MessagesWebhooksInner messagesWebhooksInner = (MessagesWebhooksInner) o;
    return Objects.equals(this.endpoint, messagesWebhooksInner.endpoint) &&
        Objects.equals(this.endpointType, messagesWebhooksInner.endpointType) &&
        Objects.equals(this.httpMethod, messagesWebhooksInner.httpMethod);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessagesWebhooksInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessagesWebhooksInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessagesWebhooksInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessagesWebhooksInner is not found in the empty JSON string", MessagesWebhooksInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessagesWebhooksInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessagesWebhooksInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MessagesWebhooksInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessagesWebhooksInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessagesWebhooksInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessagesWebhooksInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessagesWebhooksInner.class));

       return (TypeAdapter<T>) new TypeAdapter<MessagesWebhooksInner>() {
           @Override
           public void write(JsonWriter out, MessagesWebhooksInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessagesWebhooksInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessagesWebhooksInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessagesWebhooksInner
   * @throws IOException if the JSON string is invalid with respect to MessagesWebhooksInner
   */
  public static MessagesWebhooksInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessagesWebhooksInner.class);
  }

  /**
   * Convert an instance of MessagesWebhooksInner to an JSON string
   *
   * @return JSON string
   */
