...
import org.openapitools.client.model.VoiceWebhooksInner;
...
public class Voice {
  ...
  private List<VoiceWebhooksInner> webhooks = new ArrayList<>();

  public Voice() {
  }

  public Voice webhooks(List<VoiceWebhooksInner> webhooks) {
    this.webhooks = webhooks;
    return this;
  }

  public Voice addWebhooksItem(VoiceWebhooksInner webhooksItem) {
  ...
  public List<VoiceWebhooksInner> getWebhooks() {
    return webhooks;
  }

  public void setWebhooks(List<VoiceWebhooksInner> webhooks) {
    this.webhooks = webhooks;
  }
  ...
  public boolean equals(Object o) {
    ...
    Voice voice = (Voice) o;
    return Objects.equals(this.webhooks, voice.webhooks);
  }
      ...
      if (jsonObj.get("webhooks") != null && !jsonObj.get("webhooks").isJsonNull()) {
        ...
        if (jsonArraywebhooks != null) {
          ...
          for (int i = 0; i < jsonArraywebhooks.size(); i++) {
            VoiceWebhooksInner.validateJsonElement(jsonArraywebhooks.get(i));
          };
        }
      }
  }
