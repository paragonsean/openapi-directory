...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexmoApplicationApi.Messages();
  });
  ...
  describe('Messages', function() {
    it('should create an instance of Messages', function() {
      // uncomment below and update the code to test Messages
      //var instance = new NexmoApplicationApi.Messages();
      //expect(instance).to.be.a(NexmoApplicationApi.Messages);
    });
