...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexmoApplicationApi.ApplicationCreated();
  });
  ...
  describe('ApplicationCreated', function() {
    it('should create an instance of ApplicationCreated', function() {
      // uncomment below and update the code to test ApplicationCreated
      //var instance = new NexmoApplicationApi.ApplicationCreated();
      //expect(instance).to.be.a(NexmoApplicationApi.ApplicationCreated);
    });
