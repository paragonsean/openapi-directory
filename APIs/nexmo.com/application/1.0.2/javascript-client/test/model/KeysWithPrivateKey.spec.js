...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexmoApplicationApi.KeysWithPrivateKey();
  });
  ...
  describe('KeysWithPrivateKey', function() {
    it('should create an instance of KeysWithPrivateKey', function() {
      // uncomment below and update the code to test KeysWithPrivateKey
      //var instance = new NexmoApplicationApi.KeysWithPrivateKey();
      //expect(instance).to.be.a(NexmoApplicationApi.KeysWithPrivateKey);
    });
