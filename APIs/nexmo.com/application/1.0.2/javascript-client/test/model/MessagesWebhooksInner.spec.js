...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexmoApplicationApi.MessagesWebhooksInner();
  });
  ...
  describe('MessagesWebhooksInner', function() {
    it('should create an instance of MessagesWebhooksInner', function() {
      // uncomment below and update the code to test MessagesWebhooksInner
      //var instance = new NexmoApplicationApi.MessagesWebhooksInner();
      //expect(instance).to.be.a(NexmoApplicationApi.MessagesWebhooksInner);
    });
