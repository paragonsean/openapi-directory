...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexmoApplicationApi.VoiceWebhooksInner();
  });
  ...
  describe('VoiceWebhooksInner', function() {
    it('should create an instance of VoiceWebhooksInner', function() {
      // uncomment below and update the code to test VoiceWebhooksInner
      //var instance = new NexmoApplicationApi.VoiceWebhooksInner();
      //expect(instance).to.be.a(NexmoApplicationApi.VoiceWebhooksInner);
    });
