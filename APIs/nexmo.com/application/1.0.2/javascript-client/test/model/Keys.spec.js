...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexmoApplicationApi.Keys();
  });
  ...
  describe('Keys', function() {
    it('should create an instance of Keys', function() {
      // uncomment below and update the code to test Keys
      //var instance = new NexmoApplicationApi.Keys();
      //expect(instance).to.be.a(NexmoApplicationApi.Keys);
    });
