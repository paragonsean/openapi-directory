...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NexmoApplicationApi.ApplicationsBaseEmbedded();
  });
  ...
  describe('ApplicationsBaseEmbedded', function() {
    it('should create an instance of ApplicationsBaseEmbedded', function() {
      // uncomment below and update the code to test ApplicationsBaseEmbedded
      //var instance = new NexmoApplicationApi.ApplicationsBaseEmbedded();
      //expect(instance).to.be.a(NexmoApplicationApi.ApplicationsBaseEmbedded);
    });
