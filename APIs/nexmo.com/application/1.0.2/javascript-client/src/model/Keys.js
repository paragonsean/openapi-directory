...
/**
 * The Keys model module.
 * @module model/Keys
 * @version 1.0.2
 */
class Keys {
    /**
     * Constructs a new <code>Keys</code>.
     * The Nexmo product that you access with this application.
     * @alias module:model/Keys
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Keys</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Keys} obj Optional instance to populate.
     * @return {module:model/Keys} The populated <code>Keys</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Keys</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Keys</code>.
     */
