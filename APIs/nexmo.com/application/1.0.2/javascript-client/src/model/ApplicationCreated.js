...
/**
 * The ApplicationCreated model module.
 * @module model/ApplicationCreated
 * @version 1.0.2
 */
class ApplicationCreated {
    /**
     * Constructs a new <code>ApplicationCreated</code>.
     * @alias module:model/ApplicationCreated
    ...
    constructor(messages, name, voice) { 
        ...
        ApplicationCreated.initialize(this, messages, name, voice);
    }
    ...
    /**
     * Constructs a <code>ApplicationCreated</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApplicationCreated} obj Optional instance to populate.
     * @return {module:model/ApplicationCreated} The populated <code>ApplicationCreated</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApplicationCreated();
            ...
            if (data.hasOwnProperty('keys')) {
                obj['keys'] = KeysWithPrivateKey.constructFromObject(data['keys']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ApplicationCreated</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApplicationCreated</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApplicationCreated.RequiredProperties) {
        ...
        if (data['keys']) { // data not null
          KeysWithPrivateKey.validateJSON(data['keys']);
        }
...
ApplicationCreated.RequiredProperties = ["messages", "name", "voice"];

/**
 * @member {module:model/Links} _links
 */
ApplicationCreated.prototype['_links'] = undefined;

/**
 * The ID allocated to your application by Nexmo.
 * @member {String} id
 */
ApplicationCreated.prototype['id'] = undefined;

/**
 * @member {module:model/KeysWithPrivateKey} keys
 */
ApplicationCreated.prototype['keys'] = undefined;

/**
 * @member {module:model/Messages} messages
 */
ApplicationCreated.prototype['messages'] = undefined;

/**
 * The name of your application
 * @member {String} name
 */
ApplicationCreated.prototype['name'] = undefined;

/**
 * @member {module:model/Voice} voice
 */
ApplicationCreated.prototype['voice'] = undefined;
