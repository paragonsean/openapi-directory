...
/**
 * The NUMBERINSIGHT model module.
 * @module model/NUMBERINSIGHT
 * @version 2.2.2
 */
class NUMBERINSIGHT {
    /**
     * Constructs a new <code>NUMBERINSIGHT</code>.
     * Number Insight
     * @alias module:model/NUMBERINSIGHT
    ...
    constructor(accountId) { 
        ReportRequest.initialize(this, accountId, product);NumberInsightFields.initialize(this);
        NUMBERINSIGHT.initialize(this, accountId);
    }
    ...
    /**
     * Constructs a <code>NUMBERINSIGHT</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NUMBERINSIGHT} obj Optional instance to populate.
     * @return {module:model/NUMBERINSIGHT} The populated <code>NUMBERINSIGHT</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NUMBERINSIGHT();
    ...
    /**
     * Validates the JSON data with respect to <code>NUMBERINSIGHT</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NUMBERINSIGHT</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NUMBERINSIGHT.RequiredProperties) {
...
NUMBERINSIGHT.RequiredProperties = ["account_id"];

/**
 * Network used to send the request.
 * @member {String} network
 */
NUMBERINSIGHT.prototype['network'] = undefined;

/**
 * Search only request for the target number.
 * @member {String} number
 */
NUMBERINSIGHT.prototype['number'] = undefined;

/**
 * @member {module:model/ProductNi} product
 */
NUMBERINSIGHT.prototype['product'] = undefined;
