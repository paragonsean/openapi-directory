...
/**
 * The SmsFields model module.
 * @module model/SmsFields
 * @version 2.2.2
 */
class SmsFields {
    /**
     * Constructs a new <code>SmsFields</code>.
     * SMS
     * @alias module:model/SmsFields
     * @param direction {module:model/Direction} 
     * @param product {module:model/ProductSms} 
     */
    constructor(direction, product) { 
        
        SmsFields.initialize(this, direction, product);
    }
    ...
    /**
     * Constructs a <code>SmsFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SmsFields} obj Optional instance to populate.
     * @return {module:model/SmsFields} The populated <code>SmsFields</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SmsFields();
    ...
    /**
     * Validates the JSON data with respect to <code>SmsFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SmsFields</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SmsFields.RequiredProperties) {
...
SmsFields.RequiredProperties = ["direction", "product"];
