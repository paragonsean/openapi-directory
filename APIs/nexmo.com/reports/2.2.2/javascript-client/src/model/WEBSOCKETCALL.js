...
/**
 * The WEBSOCKETCALL model module.
 * @module model/WEBSOCKETCALL
 * @version 2.2.2
 */
class WEBSOCKETCALL {
    /**
     * Constructs a new <code>WEBSOCKETCALL</code>.
     * WebSocket Call
     * @alias module:model/WEBSOCKETCALL
    ...
    constructor(accountId) { 
        ReportRequest.initialize(this, accountId, product);WebsocketCallFields.initialize(this);
        WEBSOCKETCALL.initialize(this, accountId);
    }
    ...
    /**
     * Constructs a <code>WEBSOCKETCALL</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WEBSOCKETCALL} obj Optional instance to populate.
     * @return {module:model/WEBSOCKETCALL} The populated <code>WEBSOCKETCALL</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WEBSOCKETCALL();
    ...
    /**
     * Validates the JSON data with respect to <code>WEBSOCKETCALL</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WEBSOCKETCALL</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WEBSOCKETCALL.RequiredProperties) {
...
WEBSOCKETCALL.RequiredProperties = ["account_id"];

/**
 * @member {module:model/ProductWebsocket} product
 */
WEBSOCKETCALL.prototype['product'] = undefined;

/**
 * Search only for WebSocket call with corresponding status.
 * @member {String} status
 */
WEBSOCKETCALL.prototype['status'] = undefined;
