...
/**
 * The INAPPVOICE model module.
 * @module model/INAPPVOICE
 * @version 2.2.2
 */
class INAPPVOICE {
    /**
     * Constructs a new <code>INAPPVOICE</code>.
     * In App Voice
     * @alias module:model/INAPPVOICE
    ...
    constructor(accountId) { 
        ReportRequest.initialize(this, accountId, product);InAppVoiceFields.initialize(this);
        INAPPVOICE.initialize(this, accountId);
    }
    ...
    /**
     * Constructs a <code>INAPPVOICE</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/INAPPVOICE} obj Optional instance to populate.
     * @return {module:model/INAPPVOICE} The populated <code>INAPPVOICE</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new INAPPVOICE();
    ...
    /**
     * Validates the JSON data with respect to <code>INAPPVOICE</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>INAPPVOICE</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of INAPPVOICE.RequiredProperties) {
...
INAPPVOICE.RequiredProperties = ["account_id"];
 ...
 */
INAPPVOICE.prototype['conversation_id'] = undefined;

/**
 * @member {module:model/ProductInAppVoice} product
 */
INAPPVOICE.prototype['product'] = undefined;
