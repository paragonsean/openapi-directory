...
import LinksDownloadReport from './LinksDownloadReport';
...
class Links {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('download_report')) {
                obj['download_report'] = LinksDownloadReport.constructFromObject(data['download_report']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['download_report']) { // data not null
          LinksDownloadReport.validateJSON(data['download_report']);
        }
...
/**
 * @member {module:model/LinksDownloadReport} download_report
 */
Links.prototype['download_report'] = undefined;
