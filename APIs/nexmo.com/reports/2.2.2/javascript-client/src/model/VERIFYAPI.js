...
/**
 * The VERIFYAPI model module.
 * @module model/VERIFYAPI
 * @version 2.2.2
 */
class VERIFYAPI {
    /**
     * Constructs a new <code>VERIFYAPI</code>.
     * Verify
     * @alias module:model/VERIFYAPI
    ...
    constructor(accountId) { 
        ReportRequest.initialize(this, accountId, product);VerifyApiFields.initialize(this);
        VERIFYAPI.initialize(this, accountId);
    }
    ...
    /**
     * Constructs a <code>VERIFYAPI</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VERIFYAPI} obj Optional instance to populate.
     * @return {module:model/VERIFYAPI} The populated <code>VERIFYAPI</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VERIFYAPI();
    ...
    /**
     * Validates the JSON data with respect to <code>VERIFYAPI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VERIFYAPI</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VERIFYAPI.RequiredProperties) {
...
VERIFYAPI.RequiredProperties = ["account_id"];

/**
 * Network used to send the request.
 * @member {String} network
 */
VERIFYAPI.prototype['network'] = undefined;

/**
 * @member {module:model/ProductVerify} product
 */
VERIFYAPI.prototype['product'] = undefined;

/**
 * Request to this number.
 * @member {String} to
 */
VERIFYAPI.prototype['to'] = undefined;
