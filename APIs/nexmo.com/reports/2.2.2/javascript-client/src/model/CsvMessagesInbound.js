...
/**
 * The CsvMessagesInbound model module.
 * @module model/CsvMessagesInbound
 * @version 2.2.2
 */
class CsvMessagesInbound {
    /**
     * Constructs a new <code>CsvMessagesInbound</code>.
     * Inbound Messages
     * @alias module:model/CsvMessagesInbound
     */
    constructor() { 
        
        CsvMessagesInbound.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CsvMessagesInbound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CsvMessagesInbound} obj Optional instance to populate.
     * @return {module:model/CsvMessagesInbound} The populated <code>CsvMessagesInbound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CsvMessagesInbound();
    ...
    /**
     * Validates the JSON data with respect to <code>CsvMessagesInbound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CsvMessagesInbound</code>.
     */
 ...
 */
CsvMessagesInbound.prototype['account_id'] = undefined;

/**
 * Currency of the price of the request.
 * @member {String} currency
 */
CsvMessagesInbound.prototype['currency'] = undefined;

/**
 * Date of the request.
 * @member {Date} date_received
 */
CsvMessagesInbound.prototype['date_received'] = undefined;

/**
 * @member {module:model/Direction} direction
 */
CsvMessagesInbound.prototype['direction'] = undefined;

/**
 * Request from this number.
 * @member {String} from
 */
CsvMessagesInbound.prototype['from'] = undefined;

/**
 * Body of the message sent. Only present if include_message parameter is set to true.
 * @member {String} message_body
 */
CsvMessagesInbound.prototype['message_body'] = undefined;

/**
 * Id of the request.
 * @member {String} message_id
 */
CsvMessagesInbound.prototype['message_id'] = undefined;

/**
 * Provider of the message.
 * @member {String} provider
 */
CsvMessagesInbound.prototype['provider'] = undefined;

/**
 * Request to this number.
 * @member {String} to
 */
CsvMessagesInbound.prototype['to'] = undefined;

/**
 * Total price of the request.
 * @member {String} total_price
 */
CsvMessagesInbound.prototype['total_price'] = undefined;
...
export default CsvMessagesInbound;
