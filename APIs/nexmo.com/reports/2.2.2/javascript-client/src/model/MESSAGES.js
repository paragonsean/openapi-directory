...
class MESSAGES {
    ...
    constructor(accountId, product, direction) { 
        ReportRequest.initialize(this, accountId, product);MessagesFields.initialize(this, direction, product);
        MESSAGES.initialize(this, accountId, product, direction);
    }
...
MESSAGES.RequiredProperties = ["direction", "product", "account_id"];

/**
 * @member {module:model/Direction} direction
 */
MESSAGES.prototype['direction'] = undefined;

/**
 * Request from this number.
 * @member {String} from
 */
MESSAGES.prototype['from'] = undefined;
 ...
 * @default false
 */
MESSAGES.prototype['include_message'] = false;

/**
 * @member {module:model/ProductMessages} product
 */
MESSAGES.prototype['product'] = undefined;

/**
 * Request to this number.
 * @member {String} to
 */
MESSAGES.prototype['to'] = undefined;
