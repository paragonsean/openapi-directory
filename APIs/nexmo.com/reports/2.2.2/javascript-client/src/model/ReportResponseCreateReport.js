...
/**
 * The ReportResponseCreateReport model module.
 * @module model/ReportResponseCreateReport
 * @version 2.2.2
 */
class ReportResponseCreateReport {
    /**
     * Constructs a new <code>ReportResponseCreateReport</code>.
     * @alias module:model/ReportResponseCreateReport
     */
    constructor() { 
        
        ReportResponseCreateReport.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReportResponseCreateReport</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReportResponseCreateReport} obj Optional instance to populate.
     * @return {module:model/ReportResponseCreateReport} The populated <code>ReportResponseCreateReport</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportResponseCreateReport();
    ...
    /**
     * Validates the JSON data with respect to <code>ReportResponseCreateReport</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReportResponseCreateReport</code>.
     */
...
export default ReportResponseCreateReport;
