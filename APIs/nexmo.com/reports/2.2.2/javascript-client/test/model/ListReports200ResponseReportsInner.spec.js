...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.ListReports200ResponseReportsInner();
  });
  ...
  describe('ListReports200ResponseReportsInner', function() {
    it('should create an instance of ListReports200ResponseReportsInner', function() {
      // uncomment below and update the code to test ListReports200ResponseReportsInner
      //var instance = new ReportsApi.ListReports200ResponseReportsInner();
      //expect(instance).to.be.a(ReportsApi.ListReports200ResponseReportsInner);
    });
