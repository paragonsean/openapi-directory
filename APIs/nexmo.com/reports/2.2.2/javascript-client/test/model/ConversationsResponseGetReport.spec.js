...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.ConversationsResponseGetReport();
  });
  ...
  describe('ConversationsResponseGetReport', function() {
    it('should create an instance of ConversationsResponseGetReport', function() {
      // uncomment below and update the code to test ConversationsResponseGetReport
      //var instance = new ReportsApi.ConversationsResponseGetReport();
      //expect(instance).to.be.a(ReportsApi.ConversationsResponseGetReport);
    });
