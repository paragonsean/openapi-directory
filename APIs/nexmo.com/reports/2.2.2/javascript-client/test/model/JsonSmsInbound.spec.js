...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.JsonSmsInbound();
  });
  ...
  describe('JsonSmsInbound', function() {
    it('should create an instance of JsonSmsInbound', function() {
      // uncomment below and update the code to test JsonSmsInbound
      //var instance = new ReportsApi.JsonSmsInbound();
      //expect(instance).to.be.a(ReportsApi.JsonSmsInbound);
    });
