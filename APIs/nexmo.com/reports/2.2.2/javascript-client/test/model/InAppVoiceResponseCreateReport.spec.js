...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.InAppVoiceResponseCreateReport();
  });
  ...
  describe('InAppVoiceResponseCreateReport', function() {
    it('should create an instance of InAppVoiceResponseCreateReport', function() {
      // uncomment below and update the code to test InAppVoiceResponseCreateReport
      //var instance = new ReportsApi.InAppVoiceResponseCreateReport();
      //expect(instance).to.be.a(ReportsApi.InAppVoiceResponseCreateReport);
    });
