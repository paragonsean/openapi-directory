...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.SmsFields();
  });
  ...
  describe('SmsFields', function() {
    it('should create an instance of SmsFields', function() {
      // uncomment below and update the code to test SmsFields
      //var instance = new ReportsApi.SmsFields();
      //expect(instance).to.be.a(ReportsApi.SmsFields);
    });
