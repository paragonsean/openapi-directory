...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.WebsocketCallResponseCreateReport();
  });
  ...
  describe('WebsocketCallResponseCreateReport', function() {
    it('should create an instance of WebsocketCallResponseCreateReport', function() {
      // uncomment below and update the code to test WebsocketCallResponseCreateReport
      //var instance = new ReportsApi.WebsocketCallResponseCreateReport();
      //expect(instance).to.be.a(ReportsApi.WebsocketCallResponseCreateReport);
    });
