...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.GetRecords200ResponseOneOf();
  });
  ...
  describe('GetRecords200ResponseOneOf', function() {
    it('should create an instance of GetRecords200ResponseOneOf', function() {
      // uncomment below and update the code to test GetRecords200ResponseOneOf
      //var instance = new ReportsApi.GetRecords200ResponseOneOf();
      //expect(instance).to.be.a(ReportsApi.GetRecords200ResponseOneOf);
    });
