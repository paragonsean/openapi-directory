...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.CsvSmsInbound();
  });
  ...
  describe('CsvSmsInbound', function() {
    it('should create an instance of CsvSmsInbound', function() {
      // uncomment below and update the code to test CsvSmsInbound
      //var instance = new ReportsApi.CsvSmsInbound();
      //expect(instance).to.be.a(ReportsApi.CsvSmsInbound);
    });
