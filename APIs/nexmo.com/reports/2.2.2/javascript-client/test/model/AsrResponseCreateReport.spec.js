...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.AsrResponseCreateReport();
  });
  ...
  describe('AsrResponseCreateReport', function() {
    it('should create an instance of AsrResponseCreateReport', function() {
      // uncomment below and update the code to test AsrResponseCreateReport
      //var instance = new ReportsApi.AsrResponseCreateReport();
      //expect(instance).to.be.a(ReportsApi.AsrResponseCreateReport);
    });
