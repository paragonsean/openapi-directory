...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.NumberInsightResponseGetReport();
  });
  ...
  describe('NumberInsightResponseGetReport', function() {
    it('should create an instance of NumberInsightResponseGetReport', function() {
      // uncomment below and update the code to test NumberInsightResponseGetReport
      //var instance = new ReportsApi.NumberInsightResponseGetReport();
      //expect(instance).to.be.a(ReportsApi.NumberInsightResponseGetReport);
    });
