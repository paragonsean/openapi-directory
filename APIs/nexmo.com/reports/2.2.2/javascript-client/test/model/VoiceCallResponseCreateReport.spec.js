...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.VoiceCallResponseCreateReport();
  });
  ...
  describe('VoiceCallResponseCreateReport', function() {
    it('should create an instance of VoiceCallResponseCreateReport', function() {
      // uncomment below and update the code to test VoiceCallResponseCreateReport
      //var instance = new ReportsApi.VoiceCallResponseCreateReport();
      //expect(instance).to.be.a(ReportsApi.VoiceCallResponseCreateReport);
    });
