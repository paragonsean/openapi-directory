...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.ConversationsResponseCreateReport();
  });
  ...
  describe('ConversationsResponseCreateReport', function() {
    it('should create an instance of ConversationsResponseCreateReport', function() {
      // uncomment below and update the code to test ConversationsResponseCreateReport
      //var instance = new ReportsApi.ConversationsResponseCreateReport();
      //expect(instance).to.be.a(ReportsApi.ConversationsResponseCreateReport);
    });
