...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.CsvVoice();
  });
  ...
  describe('CsvVoice', function() {
    it('should create an instance of CsvVoice', function() {
      // uncomment below and update the code to test CsvVoice
      //var instance = new ReportsApi.CsvVoice();
      //expect(instance).to.be.a(ReportsApi.CsvVoice);
    });
