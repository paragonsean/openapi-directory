...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.AsrResponseGetReport();
  });
  ...
  describe('AsrResponseGetReport', function() {
    it('should create an instance of AsrResponseGetReport', function() {
      // uncomment below and update the code to test AsrResponseGetReport
      //var instance = new ReportsApi.AsrResponseGetReport();
      //expect(instance).to.be.a(ReportsApi.AsrResponseGetReport);
    });
