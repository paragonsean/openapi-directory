...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.GetRecords200ResponseOneOf5();
  });
  ...
  describe('GetRecords200ResponseOneOf5', function() {
    it('should create an instance of GetRecords200ResponseOneOf5', function() {
      // uncomment below and update the code to test GetRecords200ResponseOneOf5
      //var instance = new ReportsApi.GetRecords200ResponseOneOf5();
      //expect(instance).to.be.a(ReportsApi.GetRecords200ResponseOneOf5);
    });
    ...
    it('should have the property idsNotFound (base name: "ids_not_found")', function() {
      // uncomment below and update the code to test the property idsNotFound
      //var instance = new ReportsApi.GetRecords200ResponseOneOf5();
      //expect(instance).to.be();
    });
