...
(function(root, factory) {
  ...
  describe('ASR', function() {
    it('should create an instance of ASR', function() {
      // uncomment below and update the code to test ASR
      //var instance = new ReportsApi.ASR();
      //expect(instance).to.be.a(ReportsApi.ASR);
    });
