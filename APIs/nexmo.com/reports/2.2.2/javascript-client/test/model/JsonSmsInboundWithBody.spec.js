...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.JsonSmsInboundWithBody();
  });
  ...
  describe('JsonSmsInboundWithBody', function() {
    it('should create an instance of JsonSmsInboundWithBody', function() {
      // uncomment below and update the code to test JsonSmsInboundWithBody
      //var instance = new ReportsApi.JsonSmsInboundWithBody();
      //expect(instance).to.be.a(ReportsApi.JsonSmsInboundWithBody);
    });
