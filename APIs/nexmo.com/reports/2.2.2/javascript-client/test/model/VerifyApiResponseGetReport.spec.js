...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.VerifyApiResponseGetReport();
  });
  ...
  describe('VerifyApiResponseGetReport', function() {
    it('should create an instance of VerifyApiResponseGetReport', function() {
      // uncomment below and update the code to test VerifyApiResponseGetReport
      //var instance = new ReportsApi.VerifyApiResponseGetReport();
      //expect(instance).to.be.a(ReportsApi.VerifyApiResponseGetReport);
    });
