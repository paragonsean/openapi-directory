...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.CsvWebsockets();
  });
  ...
  describe('CsvWebsockets', function() {
    it('should create an instance of CsvWebsockets', function() {
      // uncomment below and update the code to test CsvWebsockets
      //var instance = new ReportsApi.CsvWebsockets();
      //expect(instance).to.be.a(ReportsApi.CsvWebsockets);
    });
