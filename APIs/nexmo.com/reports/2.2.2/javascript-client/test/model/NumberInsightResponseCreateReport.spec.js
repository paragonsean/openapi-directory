...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.NumberInsightResponseCreateReport();
  });
  ...
  describe('NumberInsightResponseCreateReport', function() {
    it('should create an instance of NumberInsightResponseCreateReport', function() {
      // uncomment below and update the code to test NumberInsightResponseCreateReport
      //var instance = new ReportsApi.NumberInsightResponseCreateReport();
      //expect(instance).to.be.a(ReportsApi.NumberInsightResponseCreateReport);
    });
