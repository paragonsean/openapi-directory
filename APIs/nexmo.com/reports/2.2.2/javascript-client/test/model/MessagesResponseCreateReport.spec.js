...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.MessagesResponseCreateReport();
  });
  ...
  describe('MessagesResponseCreateReport', function() {
    it('should create an instance of MessagesResponseCreateReport', function() {
      // uncomment below and update the code to test MessagesResponseCreateReport
      //var instance = new ReportsApi.MessagesResponseCreateReport();
      //expect(instance).to.be.a(ReportsApi.MessagesResponseCreateReport);
    });
