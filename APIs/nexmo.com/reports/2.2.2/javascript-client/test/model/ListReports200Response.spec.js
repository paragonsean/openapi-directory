...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.ListReports200Response();
  });
  ...
  describe('ListReports200Response', function() {
    it('should create an instance of ListReports200Response', function() {
      // uncomment below and update the code to test ListReports200Response
      //var instance = new ReportsApi.ListReports200Response();
      //expect(instance).to.be.a(ReportsApi.ListReports200Response);
    });
    ...
    it('should have the property selfLink (base name: "self_link")', function() {
