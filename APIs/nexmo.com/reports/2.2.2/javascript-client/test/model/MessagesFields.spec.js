...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.MessagesFields();
  });
  ...
  describe('MessagesFields', function() {
    it('should create an instance of MessagesFields', function() {
      // uncomment below and update the code to test MessagesFields
      //var instance = new ReportsApi.MessagesFields();
      //expect(instance).to.be.a(ReportsApi.MessagesFields);
    });
