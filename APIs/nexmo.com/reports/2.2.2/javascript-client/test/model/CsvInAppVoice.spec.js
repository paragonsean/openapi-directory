...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.CsvInAppVoice();
  });
  ...
  describe('CsvInAppVoice', function() {
    it('should create an instance of CsvInAppVoice', function() {
      // uncomment below and update the code to test CsvInAppVoice
      //var instance = new ReportsApi.CsvInAppVoice();
      //expect(instance).to.be.a(ReportsApi.CsvInAppVoice);
    });
