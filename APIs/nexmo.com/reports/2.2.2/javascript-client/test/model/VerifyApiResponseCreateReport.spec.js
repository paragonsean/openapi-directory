...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.VerifyApiResponseCreateReport();
  });
  ...
  describe('VerifyApiResponseCreateReport', function() {
    it('should create an instance of VerifyApiResponseCreateReport', function() {
      // uncomment below and update the code to test VerifyApiResponseCreateReport
      //var instance = new ReportsApi.VerifyApiResponseCreateReport();
      //expect(instance).to.be.a(ReportsApi.VerifyApiResponseCreateReport);
    });
