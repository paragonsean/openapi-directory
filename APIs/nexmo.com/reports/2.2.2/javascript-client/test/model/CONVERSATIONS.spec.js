...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.CONVERSATIONS();
  });
  ...
  describe('CONVERSATIONS', function() {
    it('should create an instance of CONVERSATIONS', function() {
      // uncomment below and update the code to test CONVERSATIONS
      //var instance = new ReportsApi.CONVERSATIONS();
      //expect(instance).to.be.a(ReportsApi.CONVERSATIONS);
    });
