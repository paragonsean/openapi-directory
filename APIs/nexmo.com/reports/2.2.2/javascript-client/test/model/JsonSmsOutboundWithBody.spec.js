...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.JsonSmsOutboundWithBody();
  });
  ...
  describe('JsonSmsOutboundWithBody', function() {
    it('should create an instance of JsonSmsOutboundWithBody', function() {
      // uncomment below and update the code to test JsonSmsOutboundWithBody
      //var instance = new ReportsApi.JsonSmsOutboundWithBody();
      //expect(instance).to.be.a(ReportsApi.JsonSmsOutboundWithBody);
    });
    ...
    it('should have the property concatenated (base name: "concatenated")', function() {
      // uncomment below and update the code to test the property concatenated
      //var instance = new ReportsApi.JsonSmsOutboundWithBody();
      //expect(instance).to.be();
    });
