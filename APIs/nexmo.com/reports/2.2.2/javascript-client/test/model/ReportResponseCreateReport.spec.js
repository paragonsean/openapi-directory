...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.ReportResponseCreateReport();
  });
  ...
  describe('ReportResponseCreateReport', function() {
    it('should create an instance of ReportResponseCreateReport', function() {
      // uncomment below and update the code to test ReportResponseCreateReport
      //var instance = new ReportsApi.ReportResponseCreateReport();
      //expect(instance).to.be.a(ReportsApi.ReportResponseCreateReport);
    });
