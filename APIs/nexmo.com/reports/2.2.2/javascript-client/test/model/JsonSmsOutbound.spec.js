...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.JsonSmsOutbound();
  });
  ...
  describe('JsonSmsOutbound', function() {
    it('should create an instance of JsonSmsOutbound', function() {
      // uncomment below and update the code to test JsonSmsOutbound
      //var instance = new ReportsApi.JsonSmsOutbound();
      //expect(instance).to.be.a(ReportsApi.JsonSmsOutbound);
    });
