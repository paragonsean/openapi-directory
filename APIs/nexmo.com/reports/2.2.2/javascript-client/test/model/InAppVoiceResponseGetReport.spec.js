...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.InAppVoiceResponseGetReport();
  });
  ...
  describe('InAppVoiceResponseGetReport', function() {
    it('should create an instance of InAppVoiceResponseGetReport', function() {
      // uncomment below and update the code to test InAppVoiceResponseGetReport
      //var instance = new ReportsApi.InAppVoiceResponseGetReport();
      //expect(instance).to.be.a(ReportsApi.InAppVoiceResponseGetReport);
    });
