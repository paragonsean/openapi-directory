...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.VoiceCallResponseGetReport();
  });
  ...
  describe('VoiceCallResponseGetReport', function() {
    it('should create an instance of VoiceCallResponseGetReport', function() {
      // uncomment below and update the code to test VoiceCallResponseGetReport
      //var instance = new ReportsApi.VoiceCallResponseGetReport();
      //expect(instance).to.be.a(ReportsApi.VoiceCallResponseGetReport);
    });
