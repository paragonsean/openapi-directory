...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.CsvMessagesInbound();
  });
  ...
  describe('CsvMessagesInbound', function() {
    it('should create an instance of CsvMessagesInbound', function() {
      // uncomment below and update the code to test CsvMessagesInbound
      //var instance = new ReportsApi.CsvMessagesInbound();
      //expect(instance).to.be.a(ReportsApi.CsvMessagesInbound);
    });
