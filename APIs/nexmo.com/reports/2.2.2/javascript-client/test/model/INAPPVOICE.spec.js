...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.INAPPVOICE();
  });
  ...
  describe('INAPPVOICE', function() {
    it('should create an instance of INAPPVOICE', function() {
      // uncomment below and update the code to test INAPPVOICE
      //var instance = new ReportsApi.INAPPVOICE();
      //expect(instance).to.be.a(ReportsApi.INAPPVOICE);
    });
