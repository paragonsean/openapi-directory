...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.MessagesResponseGetReport();
  });
  ...
  describe('MessagesResponseGetReport', function() {
    it('should create an instance of MessagesResponseGetReport', function() {
      // uncomment below and update the code to test MessagesResponseGetReport
      //var instance = new ReportsApi.MessagesResponseGetReport();
      //expect(instance).to.be.a(ReportsApi.MessagesResponseGetReport);
    });
