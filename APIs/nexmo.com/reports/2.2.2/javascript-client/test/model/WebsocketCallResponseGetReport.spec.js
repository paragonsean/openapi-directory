...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.WebsocketCallResponseGetReport();
  });
  ...
  describe('WebsocketCallResponseGetReport', function() {
    it('should create an instance of WebsocketCallResponseGetReport', function() {
      // uncomment below and update the code to test WebsocketCallResponseGetReport
      //var instance = new ReportsApi.WebsocketCallResponseGetReport();
      //expect(instance).to.be.a(ReportsApi.WebsocketCallResponseGetReport);
    });
