...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.SmsResponseCreateReport();
  });
  ...
  describe('SmsResponseCreateReport', function() {
    it('should create an instance of SmsResponseCreateReport', function() {
      // uncomment below and update the code to test SmsResponseCreateReport
      //var instance = new ReportsApi.SmsResponseCreateReport();
      //expect(instance).to.be.a(ReportsApi.SmsResponseCreateReport);
    });
