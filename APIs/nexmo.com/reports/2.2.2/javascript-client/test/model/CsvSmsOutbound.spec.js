...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReportsApi.CsvSmsOutbound();
  });
  ...
  describe('CsvSmsOutbound', function() {
    it('should create an instance of CsvSmsOutbound', function() {
      // uncomment below and update the code to test CsvSmsOutbound
      //var instance = new ReportsApi.CsvSmsOutbound();
      //expect(instance).to.be.a(ReportsApi.CsvSmsOutbound);
    });
