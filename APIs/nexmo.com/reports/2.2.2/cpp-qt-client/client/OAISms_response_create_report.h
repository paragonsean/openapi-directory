...
/*
 * OAISms_response_create_report.h
 *
 * SMS
 */

#ifndef OAISms_response_create_report_H
#define OAISms_response_create_report_H
...
class OAISms_response_create_report : public OAIObject {
public:
    OAISms_response_create_report();
    OAISms_response_create_report(QString json);
    ~OAISms_response_create_report() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISms_response_create_report)

#endif // OAISms_response_create_report_H
