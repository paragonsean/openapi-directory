...
/*
 * OAIGet_records_200_response_oneOf_8.h
 *
 * 
 */

#ifndef OAIGet_records_200_response_oneOf_8_H
#define OAIGet_records_200_response_oneOf_8_H
...
class OAICsv_messages_inbound;

class OAIGet_records_200_response_oneOf_8 : public OAIObject {
public:
    OAIGet_records_200_response_oneOf_8();
    OAIGet_records_200_response_oneOf_8(QString json);
    ~OAIGet_records_200_response_oneOf_8() override;
    ...
    QList<OAICsv_messages_inbound> getRecords() const;
    void setRecords(const QList<OAICsv_messages_inbound> &records);
...
private:
    ...
    QList<OAICsv_messages_inbound> m_records;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_records_200_response_oneOf_8)

#endif // OAIGet_records_200_response_oneOf_8_H
