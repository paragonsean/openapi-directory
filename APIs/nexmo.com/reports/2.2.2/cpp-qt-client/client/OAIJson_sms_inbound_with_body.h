...
/*
 * OAIJson_sms_inbound_with_body.h
 *
 * 
 */

#ifndef OAIJson_sms_inbound_with_body_H
#define OAIJson_sms_inbound_with_body_H
...
class OAIJson_sms_inbound_with_body : public OAIObject {
public:
    OAIJson_sms_inbound_with_body();
    OAIJson_sms_inbound_with_body(QString json);
    ~OAIJson_sms_inbound_with_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_sms_inbound_with_body)

#endif // OAIJson_sms_inbound_with_body_H
