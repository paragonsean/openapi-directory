...
/*
 * OAIReport_response.h
 *
 * 
 */

#ifndef OAIReport_response_H
#define OAIReport_response_H
...
class OAIReport_response : public OAIObject {
public:
    OAIReport_response();
    OAIReport_response(QString json);
    ~OAIReport_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReport_response)

#endif // OAIReport_response_H
