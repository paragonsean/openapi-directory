...
/*
 * OAIGet_records_200_response_oneOf_2.h
 *
 * 
 */

#ifndef OAIGet_records_200_response_oneOf_2_H
#define OAIGet_records_200_response_oneOf_2_H
...
class OAIGet_records_200_response_oneOf_2 : public OAIObject {
public:
    OAIGet_records_200_response_oneOf_2();
    OAIGet_records_200_response_oneOf_2(QString json);
    ~OAIGet_records_200_response_oneOf_2() override;
    ...
    QList<OAICsv_voice> getRecords() const;
    void setRecords(const QList<OAICsv_voice> &records);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_records_200_response_oneOf_2)

#endif // OAIGet_records_200_response_oneOf_2_H
