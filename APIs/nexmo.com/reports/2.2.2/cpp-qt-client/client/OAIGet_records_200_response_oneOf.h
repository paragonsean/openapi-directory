...
/*
 * OAIGet_records_200_response_oneOf.h
 *
 * 
 */

#ifndef OAIGet_records_200_response_oneOf_H
#define OAIGet_records_200_response_oneOf_H
...
class OAIJson_sms_outbound_with_body;

class OAIGet_records_200_response_oneOf : public OAIObject {
public:
    OAIGet_records_200_response_oneOf();
    OAIGet_records_200_response_oneOf(QString json);
    ~OAIGet_records_200_response_oneOf() override;
    ...
    QList<OAIJson_sms_outbound_with_body> getRecords() const;
    void setRecords(const QList<OAIJson_sms_outbound_with_body> &records);
...
private:
    ...
    QList<OAIJson_sms_outbound_with_body> m_records;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_records_200_response_oneOf)

#endif // OAIGet_records_200_response_oneOf_H
