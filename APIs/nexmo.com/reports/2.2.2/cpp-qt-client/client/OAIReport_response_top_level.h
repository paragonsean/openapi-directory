...
/*
 * OAIReport_response_top_level.h
 *
 * 
 */

#ifndef OAIReport_response_top_level_H
#define OAIReport_response_top_level_H
...
class OAIReport_response_top_level : public OAIObject {
public:
    OAIReport_response_top_level();
    OAIReport_response_top_level(QString json);
    ~OAIReport_response_top_level() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReport_response_top_level)

#endif // OAIReport_response_top_level_H
