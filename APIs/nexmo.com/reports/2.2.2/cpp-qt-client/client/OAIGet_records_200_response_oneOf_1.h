...
/*
 * OAIGet_records_200_response_oneOf_1.h
 *
 * 
 */

#ifndef OAIGet_records_200_response_oneOf_1_H
#define OAIGet_records_200_response_oneOf_1_H

#include <QJsonObject>

#include "OAIJson_sms_inbound_with_body.h"
...
class OAIJson_sms_inbound_with_body;

class OAIGet_records_200_response_oneOf_1 : public OAIObject {
public:
    OAIGet_records_200_response_oneOf_1();
    OAIGet_records_200_response_oneOf_1(QString json);
    ~OAIGet_records_200_response_oneOf_1() override;
    ...
    QList<OAIJson_sms_inbound_with_body> getRecords() const;
    void setRecords(const QList<OAIJson_sms_inbound_with_body> &records);
...
private:
    ...
    QList<OAIJson_sms_inbound_with_body> m_records;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_records_200_response_oneOf_1)

#endif // OAIGet_records_200_response_oneOf_1_H
