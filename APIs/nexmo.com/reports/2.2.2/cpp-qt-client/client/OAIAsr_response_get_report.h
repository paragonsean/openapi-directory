...
/*
 * OAIAsr_response_get_report.h
 *
 * ASR
 */

#ifndef OAIAsr_response_get_report_H
#define OAIAsr_response_get_report_H
...
class OAIAsr_response_get_report : public OAIObject {
public:
    OAIAsr_response_get_report();
    OAIAsr_response_get_report(QString json);
    ~OAIAsr_response_get_report() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAsr_response_get_report)

#endif // OAIAsr_response_get_report_H
