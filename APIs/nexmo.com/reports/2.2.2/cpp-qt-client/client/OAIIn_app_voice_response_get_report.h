...
/*
 * OAIIn_app_voice_response_get_report.h
 *
 * In App Voice
 */

#ifndef OAIIn_app_voice_response_get_report_H
#define OAIIn_app_voice_response_get_report_H
...
class OAIIn_app_voice_response_get_report : public OAIObject {
public:
    OAIIn_app_voice_response_get_report();
    OAIIn_app_voice_response_get_report(QString json);
    ~OAIIn_app_voice_response_get_report() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIn_app_voice_response_get_report)

#endif // OAIIn_app_voice_response_get_report_H
