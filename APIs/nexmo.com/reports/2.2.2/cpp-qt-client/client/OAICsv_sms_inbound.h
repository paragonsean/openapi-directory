...
/*
 * OAICsv_sms_inbound.h
 *
 * Inbound SMS
 */

#ifndef OAICsv_sms_inbound_H
#define OAICsv_sms_inbound_H
...
class OAICsv_sms_inbound : public OAIObject {
public:
    OAICsv_sms_inbound();
    OAICsv_sms_inbound(QString json);
    ~OAICsv_sms_inbound() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICsv_sms_inbound)

#endif // OAICsv_sms_inbound_H
