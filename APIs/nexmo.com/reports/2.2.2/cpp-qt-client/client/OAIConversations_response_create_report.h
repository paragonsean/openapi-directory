...
/*
 * OAIConversations_response_create_report.h
 *
 * Conversations
 */

#ifndef OAIConversations_response_create_report_H
#define OAIConversations_response_create_report_H
...
class OAIConversations_response_create_report : public OAIObject {
public:
    OAIConversations_response_create_report();
    OAIConversations_response_create_report(QString json);
    ~OAIConversations_response_create_report() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_response_create_report)

#endif // OAIConversations_response_create_report_H
