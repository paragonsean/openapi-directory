...
/*
 * OAIMessages_response_get_report.h
 *
 * Messages
 */

#ifndef OAIMessages_response_get_report_H
#define OAIMessages_response_get_report_H
...
class OAIMessages_response_get_report : public OAIObject {
public:
    OAIMessages_response_get_report();
    OAIMessages_response_get_report(QString json);
    ~OAIMessages_response_get_report() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessages_response_get_report)

#endif // OAIMessages_response_get_report_H
