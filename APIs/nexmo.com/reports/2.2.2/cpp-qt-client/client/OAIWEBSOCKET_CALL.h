...
#ifndef OAIWEBSOCKET_CALL_H
#define OAIWEBSOCKET_CALL_H
...
class OAIWEBSOCKET_CALL : public OAIObject {
public:
    OAIWEBSOCKET_CALL();
    OAIWEBSOCKET_CALL(QString json);
    ~OAIWEBSOCKET_CALL() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWEBSOCKET_CALL)

#endif // OAIWEBSOCKET_CALL_H
