...
/*
 * OAISms_response_get_report.h
 *
 * SMS
 */

#ifndef OAISms_response_get_report_H
#define OAISms_response_get_report_H
...
class OAISms_response_get_report : public OAIObject {
public:
    OAISms_response_get_report();
    OAISms_response_get_report(QString json);
    ~OAISms_response_get_report() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISms_response_get_report)

#endif // OAISms_response_get_report_H
