...
#ifndef OAIVERIFY_API_H
#define OAIVERIFY_API_H
...
class OAIVERIFY_API : public OAIObject {
public:
    OAIVERIFY_API();
    OAIVERIFY_API(QString json);
    ~OAIVERIFY_API() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVERIFY_API)

#endif // OAIVERIFY_API_H
