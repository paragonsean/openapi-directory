...
/*
 * OAIGet_records_200_response_oneOf_7.h
 *
 * 
 */

#ifndef OAIGet_records_200_response_oneOf_7_H
#define OAIGet_records_200_response_oneOf_7_H
...
class OAICsv_messages_outbound;

class OAIGet_records_200_response_oneOf_7 : public OAIObject {
public:
    OAIGet_records_200_response_oneOf_7();
    OAIGet_records_200_response_oneOf_7(QString json);
    ~OAIGet_records_200_response_oneOf_7() override;
    ...
    QList<OAICsv_messages_outbound> getRecords() const;
    void setRecords(const QList<OAICsv_messages_outbound> &records);
...
private:
    ...
    QList<OAICsv_messages_outbound> m_records;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_records_200_response_oneOf_7)

#endif // OAIGet_records_200_response_oneOf_7_H
