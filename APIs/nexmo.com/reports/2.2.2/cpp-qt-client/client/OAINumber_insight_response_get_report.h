...
/*
 * OAINumber_insight_response_get_report.h
 *
 * Number Insight
 */

#ifndef OAINumber_insight_response_get_report_H
#define OAINumber_insight_response_get_report_H
...
class OAINumber_insight_response_get_report : public OAIObject {
public:
    OAINumber_insight_response_get_report();
    OAINumber_insight_response_get_report(QString json);
    ~OAINumber_insight_response_get_report() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumber_insight_response_get_report)

#endif // OAINumber_insight_response_get_report_H
