...
/*
 * OAIGet_records_200_response_oneOf_3.h
 *
 * 
 */

#ifndef OAIGet_records_200_response_oneOf_3_H
#define OAIGet_records_200_response_oneOf_3_H
...
class OAICsv_in_app_voice;

class OAIGet_records_200_response_oneOf_3 : public OAIObject {
public:
    OAIGet_records_200_response_oneOf_3();
    OAIGet_records_200_response_oneOf_3(QString json);
    ~OAIGet_records_200_response_oneOf_3() override;
    ...
    QList<OAICsv_in_app_voice> getRecords() const;
    void setRecords(const QList<OAICsv_in_app_voice> &records);
...
private:
    ...
    QList<OAICsv_in_app_voice> m_records;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_records_200_response_oneOf_3)

#endif // OAIGet_records_200_response_oneOf_3_H
