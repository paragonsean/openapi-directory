...
/*
 * OAICsv_messages_outbound.h
 *
 * Outbound Messages
 */

#ifndef OAICsv_messages_outbound_H
#define OAICsv_messages_outbound_H
...
class OAICsv_messages_outbound : public OAIObject {
public:
    OAICsv_messages_outbound();
    OAICsv_messages_outbound(QString json);
    ~OAICsv_messages_outbound() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICsv_messages_outbound)

#endif // OAICsv_messages_outbound_H
