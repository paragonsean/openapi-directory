...
/*
 * OAIVoice_call_response_get_report.h
 *
 * Voice Call
 */

#ifndef OAIVoice_call_response_get_report_H
#define OAIVoice_call_response_get_report_H
...
class OAIVoice_call_response_get_report : public OAIObject {
public:
    OAIVoice_call_response_get_report();
    OAIVoice_call_response_get_report(QString json);
    ~OAIVoice_call_response_get_report() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVoice_call_response_get_report)

#endif // OAIVoice_call_response_get_report_H
