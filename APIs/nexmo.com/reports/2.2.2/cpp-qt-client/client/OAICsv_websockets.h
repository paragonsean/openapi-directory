...
#ifndef OAICsv_websockets_H
#define OAICsv_websockets_H
...
class OAICsv_websockets : public OAIObject {
public:
    OAICsv_websockets();
    OAICsv_websockets(QString json);
    ~OAICsv_websockets() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICsv_websockets)

#endif // OAICsv_websockets_H
