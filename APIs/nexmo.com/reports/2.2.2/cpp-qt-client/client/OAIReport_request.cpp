...
OAIReport_request::OAIReport_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReport_request::OAIReport_request() {
    this->initializeModel();
}

OAIReport_request::~OAIReport_request() {}

void OAIReport_request::initializeModel() {
...
void OAIReport_request::fromJson(QString jsonString) {
...
void OAIReport_request::fromJsonObject(QJsonObject json) {
...
QString OAIReport_request::asJson() const {
...
QJsonObject OAIReport_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIReport_request::getAccountId() const {
    return m_account_id;
}
void OAIReport_request::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIReport_request::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIReport_request::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIReport_request::getCallbackUrl() const {
    return m_callback_url;
}
void OAIReport_request::setCallbackUrl(const QString &callback_url) {
    m_callback_url = callback_url;
    m_callback_url_isSet = true;
}

bool OAIReport_request::is_callback_url_Set() const{
    return m_callback_url_isSet;
}

bool OAIReport_request::is_callback_url_Valid() const{
    return m_callback_url_isValid;
}

QDate OAIReport_request::getDateEnd() const {
    return m_date_end;
}
void OAIReport_request::setDateEnd(const QDate &date_end) {
    m_date_end = date_end;
    m_date_end_isSet = true;
}

bool OAIReport_request::is_date_end_Set() const{
    return m_date_end_isSet;
}

bool OAIReport_request::is_date_end_Valid() const{
    return m_date_end_isValid;
}

QDate OAIReport_request::getDateStart() const {
    return m_date_start;
}
void OAIReport_request::setDateStart(const QDate &date_start) {
    m_date_start = date_start;
    m_date_start_isSet = true;
}

bool OAIReport_request::is_date_start_Set() const{
    return m_date_start_isSet;
}

bool OAIReport_request::is_date_start_Valid() const{
    return m_date_start_isValid;
}

bool OAIReport_request::isIncludeSubaccounts() const {
    return m_include_subaccounts;
}
void OAIReport_request::setIncludeSubaccounts(const bool &include_subaccounts) {
    m_include_subaccounts = include_subaccounts;
    m_include_subaccounts_isSet = true;
}

bool OAIReport_request::is_include_subaccounts_Set() const{
    return m_include_subaccounts_isSet;
}

bool OAIReport_request::is_include_subaccounts_Valid() const{
    return m_include_subaccounts_isValid;
}

OAIProduct OAIReport_request::getProduct() const {
    return m_product;
}
void OAIReport_request::setProduct(const OAIProduct &product) {
    m_product = product;
    m_product_isSet = true;
}

bool OAIReport_request::is_product_Set() const{
    return m_product_isSet;
}

bool OAIReport_request::is_product_Valid() const{
    return m_product_isValid;
}

bool OAIReport_request::isSet() const {
...
bool OAIReport_request::isValid() const {
