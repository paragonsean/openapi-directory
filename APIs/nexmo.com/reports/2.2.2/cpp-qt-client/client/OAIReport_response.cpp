...
OAIReport_response::OAIReport_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReport_response::OAIReport_response() {
    this->initializeModel();
}

OAIReport_response::~OAIReport_response() {}

void OAIReport_response::initializeModel() {
...
void OAIReport_response::fromJson(QString jsonString) {
...
void OAIReport_response::fromJsonObject(QJsonObject json) {
...
QString OAIReport_response::asJson() const {
...
QJsonObject OAIReport_response::asJsonObject() const {
    QJsonObject obj;
    if (m__links.isSet()) {
...
OAI_links OAIReport_response::getLinks() const {
    return m__links;
}
void OAIReport_response::setLinks(const OAI_links &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIReport_response::is__links_Set() const{
    return m__links_isSet;
}

bool OAIReport_response::is__links_Valid() const{
    return m__links_isValid;
}

QString OAIReport_response::getAccountId() const {
    return m_account_id;
}
void OAIReport_response::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIReport_response::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIReport_response::is_account_id_Valid() const{
    return m_account_id_isValid;
}

QString OAIReport_response::getCallbackUrl() const {
    return m_callback_url;
}
void OAIReport_response::setCallbackUrl(const QString &callback_url) {
    m_callback_url = callback_url;
    m_callback_url_isSet = true;
}

bool OAIReport_response::is_callback_url_Set() const{
    return m_callback_url_isSet;
}

bool OAIReport_response::is_callback_url_Valid() const{
    return m_callback_url_isValid;
}

QDate OAIReport_response::getDateEnd() const {
    return m_date_end;
}
void OAIReport_response::setDateEnd(const QDate &date_end) {
    m_date_end = date_end;
    m_date_end_isSet = true;
}

bool OAIReport_response::is_date_end_Set() const{
    return m_date_end_isSet;
}

bool OAIReport_response::is_date_end_Valid() const{
    return m_date_end_isValid;
}

QDate OAIReport_response::getDateStart() const {
    return m_date_start;
}
void OAIReport_response::setDateStart(const QDate &date_start) {
    m_date_start = date_start;
    m_date_start_isSet = true;
}

bool OAIReport_response::is_date_start_Set() const{
    return m_date_start_isSet;
}

bool OAIReport_response::is_date_start_Valid() const{
    return m_date_start_isValid;
}

bool OAIReport_response::isIncludeSubaccounts() const {
    return m_include_subaccounts;
}
void OAIReport_response::setIncludeSubaccounts(const bool &include_subaccounts) {
    m_include_subaccounts = include_subaccounts;
    m_include_subaccounts_isSet = true;
}

bool OAIReport_response::is_include_subaccounts_Set() const{
    return m_include_subaccounts_isSet;
}

bool OAIReport_response::is_include_subaccounts_Valid() const{
    return m_include_subaccounts_isValid;
}

qint32 OAIReport_response::getItemsCount() const {
    return m_items_count;
}
void OAIReport_response::setItemsCount(const qint32 &items_count) {
    m_items_count = items_count;
    m_items_count_isSet = true;
}

bool OAIReport_response::is_items_count_Set() const{
    return m_items_count_isSet;
}

bool OAIReport_response::is_items_count_Valid() const{
    return m_items_count_isValid;
}

OAIProduct OAIReport_response::getProduct() const {
    return m_product;
}
void OAIReport_response::setProduct(const OAIProduct &product) {
    m_product = product;
    m_product_isSet = true;
}

bool OAIReport_response::is_product_Set() const{
    return m_product_isSet;
}

bool OAIReport_response::is_product_Valid() const{
    return m_product_isValid;
}

QDate OAIReport_response::getReceiveTime() const {
    return m_receive_time;
}
void OAIReport_response::setReceiveTime(const QDate &receive_time) {
    m_receive_time = receive_time;
    m_receive_time_isSet = true;
}

bool OAIReport_response::is_receive_time_Set() const{
    return m_receive_time_isSet;
}

bool OAIReport_response::is_receive_time_Valid() const{
    return m_receive_time_isValid;
}

QString OAIReport_response::getRequestId() const {
    return m_request_id;
}
void OAIReport_response::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIReport_response::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIReport_response::is_request_id_Valid() const{
    return m_request_id_isValid;
}

OAIRequest_status OAIReport_response::getRequestStatus() const {
    return m_request_status;
}
void OAIReport_response::setRequestStatus(const OAIRequest_status &request_status) {
    m_request_status = request_status;
    m_request_status_isSet = true;
}

bool OAIReport_response::is_request_status_Set() const{
    return m_request_status_isSet;
}

bool OAIReport_response::is_request_status_Valid() const{
    return m_request_status_isValid;
}

QDate OAIReport_response::getStartTime() const {
    return m_start_time;
}
void OAIReport_response::setStartTime(const QDate &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIReport_response::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIReport_response::is_start_time_Valid() const{
    return m_start_time_isValid;
}

bool OAIReport_response::isSet() const {
...
bool OAIReport_response::isValid() const {
