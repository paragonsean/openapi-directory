...
/*
 * OAIJson_sms_inbound.h
 *
 * Inbound SMS
 */

#ifndef OAIJson_sms_inbound_H
#define OAIJson_sms_inbound_H
...
class OAIJson_sms_inbound : public OAIObject {
public:
    OAIJson_sms_inbound();
    OAIJson_sms_inbound(QString json);
    ~OAIJson_sms_inbound() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_sms_inbound)

#endif // OAIJson_sms_inbound_H
