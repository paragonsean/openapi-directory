...
/*
 * OAIJson_sms_outbound.h
 *
 * Outbound SMS
 */

#ifndef OAIJson_sms_outbound_H
#define OAIJson_sms_outbound_H
...
class OAIJson_sms_outbound : public OAIObject {
public:
    OAIJson_sms_outbound();
    OAIJson_sms_outbound(QString json);
    ~OAIJson_sms_outbound() override;
    ...
    void setConcatenated(const bool &concatenated);
    bool is_concatenated_Set() const;
    bool is_concatenated_Valid() const;
...
private:
    ...
    bool m_concatenated;
    bool m_concatenated_isSet;
    bool m_concatenated_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJson_sms_outbound)

#endif // OAIJson_sms_outbound_H
