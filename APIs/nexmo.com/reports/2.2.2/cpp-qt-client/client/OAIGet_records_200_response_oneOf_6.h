...
/*
 * OAIGet_records_200_response_oneOf_6.h
 *
 * 
 */

#ifndef OAIGet_records_200_response_oneOf_6_H
#define OAIGet_records_200_response_oneOf_6_H
...
class OAIGet_records_200_response_oneOf_6 : public OAIObject {
public:
    OAIGet_records_200_response_oneOf_6();
    OAIGet_records_200_response_oneOf_6(QString json);
    ~OAIGet_records_200_response_oneOf_6() override;
    ...
    QList<OAICsv_ni> getRecords() const;
    void setRecords(const QList<OAICsv_ni> &records);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_records_200_response_oneOf_6)

#endif // OAIGet_records_200_response_oneOf_6_H
