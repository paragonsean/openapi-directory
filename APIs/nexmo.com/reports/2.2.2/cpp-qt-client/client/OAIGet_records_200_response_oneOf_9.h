...
/*
 * OAIGet_records_200_response_oneOf_9.h
 *
 * 
 */

#ifndef OAIGet_records_200_response_oneOf_9_H
#define OAIGet_records_200_response_oneOf_9_H
...
class OAIGet_records_200_response_oneOf_9 : public OAIObject {
public:
    OAIGet_records_200_response_oneOf_9();
    OAIGet_records_200_response_oneOf_9(QString json);
    ~OAIGet_records_200_response_oneOf_9() override;
    ...
    QList<OAICsv_asr> getRecords() const;
    void setRecords(const QList<OAICsv_asr> &records);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_records_200_response_oneOf_9)

#endif // OAIGet_records_200_response_oneOf_9_H
