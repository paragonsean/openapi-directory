...
#ifndef OAIVOICE_CALL_H
#define OAIVOICE_CALL_H
...
class OAIVOICE_CALL : public OAIObject {
public:
    OAIVOICE_CALL();
    OAIVOICE_CALL(QString json);
    ~OAIVOICE_CALL() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVOICE_CALL)

#endif // OAIVOICE_CALL_H
