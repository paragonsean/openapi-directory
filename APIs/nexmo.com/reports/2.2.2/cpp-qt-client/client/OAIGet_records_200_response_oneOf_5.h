...
/*
 * OAIGet_records_200_response_oneOf_5.h
 *
 * 
 */

#ifndef OAIGet_records_200_response_oneOf_5_H
#define OAIGet_records_200_response_oneOf_5_H
...
class OAIGet_records_200_response_oneOf_5 : public OAIObject {
public:
    OAIGet_records_200_response_oneOf_5();
    OAIGet_records_200_response_oneOf_5(QString json);
    ~OAIGet_records_200_response_oneOf_5() override;
    ...
    QList<OAICsv_verify> getRecords() const;
    void setRecords(const QList<OAICsv_verify> &records);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_records_200_response_oneOf_5)

#endif // OAIGet_records_200_response_oneOf_5_H
