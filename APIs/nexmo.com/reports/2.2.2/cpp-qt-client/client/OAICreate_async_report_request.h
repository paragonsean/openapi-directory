...
/*
 * OAICreate_async_report_request.h
 *
 * 
 */

#ifndef OAICreate_async_report_request_H
#define OAICreate_async_report_request_H
...
class OAICreate_async_report_request : public OAIObject {
public:
    OAICreate_async_report_request();
    OAICreate_async_report_request(QString json);
    ~OAICreate_async_report_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreate_async_report_request)

#endif // OAICreate_async_report_request_H
