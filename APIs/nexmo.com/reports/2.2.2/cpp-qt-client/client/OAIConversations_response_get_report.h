...
/*
 * OAIConversations_response_get_report.h
 *
 * Conversations
 */

#ifndef OAIConversations_response_get_report_H
#define OAIConversations_response_get_report_H
...
class OAIConversations_response_get_report : public OAIObject {
public:
    OAIConversations_response_get_report();
    OAIConversations_response_get_report(QString json);
    ~OAIConversations_response_get_report() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_response_get_report)

#endif // OAIConversations_response_get_report_H
