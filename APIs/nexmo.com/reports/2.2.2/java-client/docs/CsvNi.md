...
|**country** | **String** | Country of the looked up number. |  [optional] |
|**countryName** | **String** | Country name of the looked up number. |  [optional] |
...
|**status** | **String** | Status of the Number Insight request. |  [optional] |
