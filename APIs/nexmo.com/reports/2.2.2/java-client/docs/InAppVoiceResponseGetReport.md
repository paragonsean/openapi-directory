...
|**itemsCount** | **Integer** | The number of rows in the resulting file (when report has been completed). |  [optional] |
...
|**conversationId** | **String** | Search only for In App Voive calls attached to this particular Conversation. This should include the \&quot;CON-\&quot; prefix. |  [optional] |
