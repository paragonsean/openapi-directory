...
public class JsonSmsOutboundWithBody {
  ...
  public JsonSmsOutboundWithBody() {
  }

  public JsonSmsOutboundWithBody accountId(String accountId) {
  ...
  public JsonSmsOutboundWithBody clientRef(String clientRef) {
  ...
  public JsonSmsOutboundWithBody concatenated(Boolean concatenated) {
  ...
  public JsonSmsOutboundWithBody country(String country) {
  ...
  public JsonSmsOutboundWithBody countryName(String countryName) {
  ...
  public JsonSmsOutboundWithBody currency(String currency) {
  ...
  public JsonSmsOutboundWithBody dateFinalized(LocalDate dateFinalized) {
  ...
  public JsonSmsOutboundWithBody dateReceived(LocalDate dateReceived) {
  ...
  public JsonSmsOutboundWithBody direction(Direction direction) {
  ...
  public JsonSmsOutboundWithBody errorCode(String errorCode) {
  ...
  public JsonSmsOutboundWithBody errorCodeDescription(String errorCodeDescription) {
  ...
  public JsonSmsOutboundWithBody from(String from) {
    this.from = from;
    return this;
  }
  ...
  public JsonSmsOutboundWithBody latency(Integer latency) {
  ...
  public JsonSmsOutboundWithBody messageId(String messageId) {
  ...
  public JsonSmsOutboundWithBody network(String network) {
  ...
  public JsonSmsOutboundWithBody networkName(String networkName) {
  ...
  public JsonSmsOutboundWithBody status(SmsStatus status) {
    this.status = status;
    return this;
  }
  ...
  public JsonSmsOutboundWithBody to(String to) {
    this.to = to;
    return this;
  }
  ...
  public JsonSmsOutboundWithBody totalPrice(String totalPrice) {
  ...
  public JsonSmsOutboundWithBody messageBody(String messageBody) {
  ...
  public boolean equals(Object o) {
    ...
    JsonSmsOutboundWithBody jsonSmsOutboundWithBody = (JsonSmsOutboundWithBody) o;
    return Objects.equals(this.accountId, jsonSmsOutboundWithBody.accountId) &&
        Objects.equals(this.clientRef, jsonSmsOutboundWithBody.clientRef) &&
        Objects.equals(this.concatenated, jsonSmsOutboundWithBody.concatenated) &&
        Objects.equals(this.country, jsonSmsOutboundWithBody.country) &&
        Objects.equals(this.countryName, jsonSmsOutboundWithBody.countryName) &&
        Objects.equals(this.currency, jsonSmsOutboundWithBody.currency) &&
        Objects.equals(this.dateFinalized, jsonSmsOutboundWithBody.dateFinalized) &&
        Objects.equals(this.dateReceived, jsonSmsOutboundWithBody.dateReceived) &&
        Objects.equals(this.direction, jsonSmsOutboundWithBody.direction) &&
        Objects.equals(this.errorCode, jsonSmsOutboundWithBody.errorCode) &&
        Objects.equals(this.errorCodeDescription, jsonSmsOutboundWithBody.errorCodeDescription) &&
        Objects.equals(this.from, jsonSmsOutboundWithBody.from) &&
        Objects.equals(this.latency, jsonSmsOutboundWithBody.latency) &&
        Objects.equals(this.messageId, jsonSmsOutboundWithBody.messageId) &&
        Objects.equals(this.network, jsonSmsOutboundWithBody.network) &&
        Objects.equals(this.networkName, jsonSmsOutboundWithBody.networkName) &&
        Objects.equals(this.status, jsonSmsOutboundWithBody.status) &&
        Objects.equals(this.to, jsonSmsOutboundWithBody.to) &&
        Objects.equals(this.totalPrice, jsonSmsOutboundWithBody.totalPrice) &&
        Objects.equals(this.messageBody, jsonSmsOutboundWithBody.messageBody);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, clientRef, concatenated, country, countryName, currency, dateFinalized, dateReceived, direction, errorCode, errorCodeDescription, from, latency, messageId, network, networkName, status, to, totalPrice, messageBody);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JsonSmsOutboundWithBody {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JsonSmsOutboundWithBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JsonSmsOutboundWithBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JsonSmsOutboundWithBody is not found in the empty JSON string", JsonSmsOutboundWithBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JsonSmsOutboundWithBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JsonSmsOutboundWithBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JsonSmsOutboundWithBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JsonSmsOutboundWithBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JsonSmsOutboundWithBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JsonSmsOutboundWithBody.class));

       return (TypeAdapter<T>) new TypeAdapter<JsonSmsOutboundWithBody>() {
           @Override
           public void write(JsonWriter out, JsonSmsOutboundWithBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JsonSmsOutboundWithBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JsonSmsOutboundWithBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JsonSmsOutboundWithBody
   * @throws IOException if the JSON string is invalid with respect to JsonSmsOutboundWithBody
   */
  public static JsonSmsOutboundWithBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JsonSmsOutboundWithBody.class);
  }

  /**
   * Convert an instance of JsonSmsOutboundWithBody to an JSON string
   *
   * @return JSON string
   */
