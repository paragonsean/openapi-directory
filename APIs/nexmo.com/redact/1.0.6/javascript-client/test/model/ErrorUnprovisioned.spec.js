...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedactApi.ErrorUnprovisioned();
  });
  ...
  describe('ErrorUnprovisioned', function() {
    it('should create an instance of ErrorUnprovisioned', function() {
      // uncomment below and update the code to test ErrorUnprovisioned
      //var instance = new RedactApi.ErrorUnprovisioned();
      //expect(instance).to.be.a(RedactApi.ErrorUnprovisioned);
    });
