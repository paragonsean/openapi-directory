...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedactApi.ErrorInvalidId();
  });
  ...
  describe('ErrorInvalidId', function() {
    it('should create an instance of ErrorInvalidId', function() {
      // uncomment below and update the code to test ErrorInvalidId
      //var instance = new RedactApi.ErrorInvalidId();
      //expect(instance).to.be.a(RedactApi.ErrorInvalidId);
    });
