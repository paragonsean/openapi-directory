...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedactApi.ErrorPrematureRedaction();
  });
  ...
  describe('ErrorPrematureRedaction', function() {
    it('should create an instance of ErrorPrematureRedaction', function() {
      // uncomment below and update the code to test ErrorPrematureRedaction
      //var instance = new RedactApi.ErrorPrematureRedaction();
      //expect(instance).to.be.a(RedactApi.ErrorPrematureRedaction);
    });
