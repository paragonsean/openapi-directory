...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedactApi.RedactMessage422Response();
  });
  ...
  describe('RedactMessage422Response', function() {
    it('should create an instance of RedactMessage422Response', function() {
      // uncomment below and update the code to test RedactMessage422Response
      //var instance = new RedactApi.RedactMessage422Response();
      //expect(instance).to.be.a(RedactApi.RedactMessage422Response);
    });
