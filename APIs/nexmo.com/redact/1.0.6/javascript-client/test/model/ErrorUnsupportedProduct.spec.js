...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedactApi.ErrorUnsupportedProduct();
  });
  ...
  describe('ErrorUnsupportedProduct', function() {
    it('should create an instance of ErrorUnsupportedProduct', function() {
      // uncomment below and update the code to test ErrorUnsupportedProduct
      //var instance = new RedactApi.ErrorUnsupportedProduct();
      //expect(instance).to.be.a(RedactApi.ErrorUnsupportedProduct);
    });
