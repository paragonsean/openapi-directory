...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedactApi.ErrorThrottled();
  });
  ...
  describe('ErrorThrottled', function() {
    it('should create an instance of ErrorThrottled', function() {
      // uncomment below and update the code to test ErrorThrottled
      //var instance = new RedactApi.ErrorThrottled();
      //expect(instance).to.be.a(RedactApi.ErrorThrottled);
    });
