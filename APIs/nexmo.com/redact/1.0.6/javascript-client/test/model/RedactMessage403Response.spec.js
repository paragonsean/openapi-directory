...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedactApi.RedactMessage403Response();
  });
  ...
  describe('RedactMessage403Response', function() {
    it('should create an instance of RedactMessage403Response', function() {
      // uncomment below and update the code to test RedactMessage403Response
      //var instance = new RedactApi.RedactMessage403Response();
      //expect(instance).to.be.a(RedactApi.RedactMessage403Response);
    });
