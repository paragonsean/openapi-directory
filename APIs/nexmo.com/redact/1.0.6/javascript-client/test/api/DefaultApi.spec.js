...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RedactApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('redactMessage', function() {
      it('should call redactMessage successfully', function(done) {
        //uncomment below and update the code to test redactMessage
        //instance.redactMessage(function(error) {
