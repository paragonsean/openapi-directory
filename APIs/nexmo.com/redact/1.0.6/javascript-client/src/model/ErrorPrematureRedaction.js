...
/**
 * The ErrorPrematureRedaction model module.
 * @module model/ErrorPrematureRedaction
 * @version 1.0.6
 */
class ErrorPrematureRedaction {
    /**
     * Constructs a new <code>ErrorPrematureRedaction</code>.
     * Premature Redaction
     * @alias module:model/ErrorPrematureRedaction
    ...
    constructor(detail, instance, title, type) { 
        ...
        ErrorPrematureRedaction.initialize(this, detail, instance, title, type);
    }
    ...
    /**
     * Constructs a <code>ErrorPrematureRedaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorPrematureRedaction} obj Optional instance to populate.
     * @return {module:model/ErrorPrematureRedaction} The populated <code>ErrorPrematureRedaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorPrematureRedaction();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorPrematureRedaction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorPrematureRedaction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ErrorPrematureRedaction.RequiredProperties) {
...
ErrorPrematureRedaction.RequiredProperties = ["detail", "instance", "title", "type"];

/**
 * Additional information about the error
 * @member {String} detail
 */
ErrorPrematureRedaction.prototype['detail'] = undefined;

/**
 * Internal Trace ID
 * @member {String} instance
 */
ErrorPrematureRedaction.prototype['instance'] = undefined;

/**
 * Generic error message
 * @member {String} title
 */
ErrorPrematureRedaction.prototype['title'] = undefined;

/**
 * Link to error / remediation options
 * @member {String} type
 */
ErrorPrematureRedaction.prototype['type'] = undefined;
...
export default ErrorPrematureRedaction;
