...
/**
 * The ErrorInvalidId model module.
 * @module model/ErrorInvalidId
 * @version 1.0.6
 */
class ErrorInvalidId {
    /**
     * Constructs a new <code>ErrorInvalidId</code>.
     * @alias module:model/ErrorInvalidId
    ...
    constructor(detail, instance, title, type) { 
        ...
        ErrorInvalidId.initialize(this, detail, instance, title, type);
    }
    ...
    /**
     * Constructs a <code>ErrorInvalidId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorInvalidId} obj Optional instance to populate.
     * @return {module:model/ErrorInvalidId} The populated <code>ErrorInvalidId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorInvalidId();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorInvalidId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorInvalidId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ErrorInvalidId.RequiredProperties) {
...
ErrorInvalidId.RequiredProperties = ["detail", "instance", "title", "type"];

/**
 * Additional information about the error
 * @member {String} detail
 */
ErrorInvalidId.prototype['detail'] = undefined;

/**
 * Internal Trace ID
 * @member {String} instance
 */
ErrorInvalidId.prototype['instance'] = undefined;

/**
 * Generic error message
 * @member {String} title
 */
ErrorInvalidId.prototype['title'] = undefined;

/**
 * Link to error / remediation options
 * @member {String} type
 */
ErrorInvalidId.prototype['type'] = undefined;
