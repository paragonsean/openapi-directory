...
/**
 * The ErrorUnprovisioned model module.
 * @module model/ErrorUnprovisioned
 * @version 1.0.6
 */
class ErrorUnprovisioned {
    /**
     * Constructs a new <code>ErrorUnprovisioned</code>.
     * Unprovisioned
     * @alias module:model/ErrorUnprovisioned
    ...
    constructor(detail, instance, title, type) { 
        ...
        ErrorUnprovisioned.initialize(this, detail, instance, title, type);
    }
    ...
    /**
     * Constructs a <code>ErrorUnprovisioned</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorUnprovisioned} obj Optional instance to populate.
     * @return {module:model/ErrorUnprovisioned} The populated <code>ErrorUnprovisioned</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorUnprovisioned();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorUnprovisioned</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorUnprovisioned</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ErrorUnprovisioned.RequiredProperties) {
...
ErrorUnprovisioned.RequiredProperties = ["detail", "instance", "title", "type"];

/**
 * Additional information about the error
 * @member {String} detail
 */
ErrorUnprovisioned.prototype['detail'] = undefined;

/**
 * Internal Trace ID
 * @member {String} instance
 */
ErrorUnprovisioned.prototype['instance'] = undefined;

/**
 * Generic error message
 * @member {String} title
 */
ErrorUnprovisioned.prototype['title'] = undefined;

/**
 * Link to error / remediation options
 * @member {String} type
 */
ErrorUnprovisioned.prototype['type'] = undefined;
...
export default ErrorUnprovisioned;
