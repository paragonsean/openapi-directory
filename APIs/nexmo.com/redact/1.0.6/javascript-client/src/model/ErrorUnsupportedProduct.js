...
/**
 * The ErrorUnsupportedProduct model module.
 * @module model/ErrorUnsupportedProduct
 * @version 1.0.6
 */
class ErrorUnsupportedProduct {
    /**
     * Constructs a new <code>ErrorUnsupportedProduct</code>.
     * Unsupported Product
     * @alias module:model/ErrorUnsupportedProduct
    ...
    constructor(detail, instance, title, type) { 
        ...
        ErrorUnsupportedProduct.initialize(this, detail, instance, title, type);
    }
    ...
    /**
     * Constructs a <code>ErrorUnsupportedProduct</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorUnsupportedProduct} obj Optional instance to populate.
     * @return {module:model/ErrorUnsupportedProduct} The populated <code>ErrorUnsupportedProduct</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorUnsupportedProduct();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorUnsupportedProduct</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorUnsupportedProduct</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ErrorUnsupportedProduct.RequiredProperties) {
...
ErrorUnsupportedProduct.RequiredProperties = ["detail", "instance", "title", "type"];

/**
 * Additional information about the error
 * @member {String} detail
 */
ErrorUnsupportedProduct.prototype['detail'] = undefined;

/**
 * Internal Trace ID
 * @member {String} instance
 */
ErrorUnsupportedProduct.prototype['instance'] = undefined;

/**
 * Generic error message
 * @member {String} title
 */
ErrorUnsupportedProduct.prototype['title'] = undefined;

/**
 * Link to error / remediation options
 * @member {String} type
 */
ErrorUnsupportedProduct.prototype['type'] = undefined;
...
export default ErrorUnsupportedProduct;
