...
OAIRedactTransaction Example::create(){
    OAIRedactTransaction obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::redactMessageSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::redactMessageSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIRedactTransaction oai_redact_transaction = create(); // OAIRedactTransaction | 
      apiInstance.redactMessage(oai_redact_transaction);
