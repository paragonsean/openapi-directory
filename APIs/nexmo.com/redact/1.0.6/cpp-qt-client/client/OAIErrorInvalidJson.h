...
/*
 * OAIErrorInvalidJson.h
 *
 * Invalid JSON
 */

#ifndef OAIErrorInvalidJson_H
#define OAIErrorInvalidJson_H
...
class OAIErrorInvalidJson : public OAIObject {
public:
    OAIErrorInvalidJson();
    OAIErrorInvalidJson(QString json);
    ~OAIErrorInvalidJson() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorInvalidJson)

#endif // OAIErrorInvalidJson_H
