...
/*
 * OAIErrorUnprovisioned.h
 *
 * Unprovisioned
 */

#ifndef OAIErrorUnprovisioned_H
#define OAIErrorUnprovisioned_H
...
class OAIErrorUnprovisioned : public OAIObject {
public:
    OAIErrorUnprovisioned();
    OAIErrorUnprovisioned(QString json);
    ~OAIErrorUnprovisioned() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorUnprovisioned)

#endif // OAIErrorUnprovisioned_H
