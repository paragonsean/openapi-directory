...
/*
 * OAIErrorPrematureRedaction.h
 *
 * Premature Redaction
 */

#ifndef OAIErrorPrematureRedaction_H
#define OAIErrorPrematureRedaction_H
...
class OAIErrorPrematureRedaction : public OAIObject {
public:
    OAIErrorPrematureRedaction();
    OAIErrorPrematureRedaction(QString json);
    ~OAIErrorPrematureRedaction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorPrematureRedaction)

#endif // OAIErrorPrematureRedaction_H
