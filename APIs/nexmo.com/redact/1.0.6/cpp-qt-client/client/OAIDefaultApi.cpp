...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.nexmo.com/v1/redact"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("redactMessage", defaultConf);
    _serverIndices.insert("redactMessage", 0);
}
...
void OAIDefaultApi::redactMessage(const OAIRedactTransaction &oai_redact_transaction) {
    QString fullPath = QString(_serverConfigs["redactMessage"][_serverIndices.value("redactMessage")].URL()+"/transaction");
...

    {
        ...
        QByteArray output = oai_redact_transaction.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::redactMessageCallback);
...
void OAIDefaultApi::redactMessageCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT redactMessageSignal();
        Q_EMIT redactMessageSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT redactMessageSignalE(error_type, error_str);
        Q_EMIT redactMessageSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT redactMessageSignalError(error_type, error_str);
        Q_EMIT redactMessageSignalErrorFull(worker, error_type, error_str);
    }
}
