...
/*
 * OAIErrorUnsupportedProduct.h
 *
 * Unsupported Product
 */

#ifndef OAIErrorUnsupportedProduct_H
#define OAIErrorUnsupportedProduct_H
...
class OAIErrorUnsupportedProduct : public OAIObject {
public:
    OAIErrorUnsupportedProduct();
    OAIErrorUnsupportedProduct(QString json);
    ~OAIErrorUnsupportedProduct() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorUnsupportedProduct)

#endif // OAIErrorUnsupportedProduct_H
