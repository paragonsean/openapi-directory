...
Redact API
- API version: 1.0.6
  - Build date: 2024-10-12T11:24:19.743168-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**redactMessage**](docs/DefaultApi.md#redactMessage) | **POST** /transaction | Redact a specific message
