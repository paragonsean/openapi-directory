...
/**
 * The AccountUnauthorized model module.
 * @module model/AccountUnauthorized
 * @version 1.0.20
 */
class AccountUnauthorized {
    /**
     * Constructs a new <code>AccountUnauthorized</code>.
     * @alias module:model/AccountUnauthorized
     */
    constructor() { 
        
        AccountUnauthorized.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountUnauthorized</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountUnauthorized} obj Optional instance to populate.
     * @return {module:model/AccountUnauthorized} The populated <code>AccountUnauthorized</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountUnauthorized();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountUnauthorized</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountUnauthorized</code>.
     */
 ...
 */
AccountUnauthorized.prototype['error-code'] = undefined;

/**
 * The status code description
 * @member {String} error-code-label
 */
AccountUnauthorized.prototype['error-code-label'] = undefined;
