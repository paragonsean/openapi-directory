...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumbersApi.AvailableNumbers();
  });
  ...
  describe('AvailableNumbers', function() {
    it('should create an instance of AvailableNumbers', function() {
      // uncomment below and update the code to test AvailableNumbers
      //var instance = new NumbersApi.AvailableNumbers();
      //expect(instance).to.be.a(NumbersApi.AvailableNumbers);
    });
