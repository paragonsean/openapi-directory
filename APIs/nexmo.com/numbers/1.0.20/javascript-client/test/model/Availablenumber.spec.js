...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumbersApi.Availablenumber();
  });
  ...
  describe('Availablenumber', function() {
    it('should create an instance of Availablenumber', function() {
      // uncomment below and update the code to test Availablenumber
      //var instance = new NumbersApi.Availablenumber();
      //expect(instance).to.be.a(NumbersApi.Availablenumber);
    });
