...
public class Unauthorized {
  ...
  public Unauthorized errorCode(String errorCode) {
  ...
  public Unauthorized errorCodeLabel(String errorCodeLabel) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errorCode, unauthorized.errorCode) &&
        Objects.equals(this.errorCodeLabel, unauthorized.errorCodeLabel);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Unauthorized
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Unauthorized.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Unauthorized.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Unauthorized` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
