...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConversationApi.MemberAllOfInitiator();
  });
  ...
  describe('MemberAllOfInitiator', function() {
    it('should create an instance of MemberAllOfInitiator', function() {
      // uncomment below and update the code to test MemberAllOfInitiator
      //var instance = new ConversationApi.MemberAllOfInitiator();
      //expect(instance).to.be.a(ConversationApi.MemberAllOfInitiator);
    });
