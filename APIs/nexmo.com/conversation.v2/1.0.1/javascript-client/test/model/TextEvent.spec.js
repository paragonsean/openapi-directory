...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConversationApi.TextEvent();
  });
  ...
  describe('TextEvent', function() {
    it('should create an instance of TextEvent', function() {
      // uncomment below and update the code to test TextEvent
      //var instance = new ConversationApi.TextEvent();
      //expect(instance).to.be.a(ConversationApi.TextEvent);
    });
