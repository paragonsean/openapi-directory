...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConversationApi.AllEvents();
  });
  ...
  describe('AllEvents', function() {
    it('should create an instance of AllEvents', function() {
      // uncomment below and update the code to test AllEvents
      //var instance = new ConversationApi.AllEvents();
      //expect(instance).to.be.a(ConversationApi.AllEvents);
    });
