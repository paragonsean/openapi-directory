...
void OAIDefaultApi::getUsers(const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &order, const ::OpenAPI::OptionalParam<QString> &cursor) {
...
void OAIDefaultApi::getUsersCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGet_users_200_response output(QString(worker->response));
    worker->deleteLater();
