...
#ifndef OAICustom_event_H
#define OAICustom_event_H
...
class OAICustom_event : public OAIObject {
public:
    OAICustom_event();
    OAICustom_event(QString json);
    ~OAICustom_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustom_event)

#endif // OAICustom_event_H
