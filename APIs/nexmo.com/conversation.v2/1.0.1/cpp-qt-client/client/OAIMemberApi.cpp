...
void OAIMemberApi::getMembers(const QString &conversation_id, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &order, const ::OpenAPI::OptionalParam<QString> &cursor) {
...
void OAIMemberApi::getMembersCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGet_members_200_response output(QString(worker->response));
    worker->deleteLater();
