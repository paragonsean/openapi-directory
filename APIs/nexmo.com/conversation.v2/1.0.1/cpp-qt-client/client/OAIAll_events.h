...
#ifndef OAIAll_events_H
#define OAIAll_events_H
...
#include "OAIMember.h"
#include "OAIMember_invited_event.h"
...
class OAIAll_events : public OAIObject {
public:
    OAIAll_events();
    OAIAll_events(QString json);
    ~OAIAll_events() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAll_events)

#endif // OAIAll_events_H
