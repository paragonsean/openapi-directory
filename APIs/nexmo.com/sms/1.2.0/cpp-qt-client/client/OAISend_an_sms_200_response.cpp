...
OAISend_an_sms_200_response::OAISend_an_sms_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISend_an_sms_200_response::OAISend_an_sms_200_response() {
    this->initializeModel();
}

OAISend_an_sms_200_response::~OAISend_an_sms_200_response() {}

void OAISend_an_sms_200_response::initializeModel() {
...
void OAISend_an_sms_200_response::fromJson(QString jsonString) {
...
void OAISend_an_sms_200_response::fromJsonObject(QJsonObject json) {
...
QString OAISend_an_sms_200_response::asJson() const {
...
QJsonObject OAISend_an_sms_200_response::asJsonObject() const {
    QJsonObject obj;
...
QString OAISend_an_sms_200_response::getMessageCount() const {
    return m_message_count;
}
void OAISend_an_sms_200_response::setMessageCount(const QString &message_count) {
    m_message_count = message_count;
    m_message_count_isSet = true;
}

bool OAISend_an_sms_200_response::is_message_count_Set() const{
    return m_message_count_isSet;
}

bool OAISend_an_sms_200_response::is_message_count_Valid() const{
    return m_message_count_isValid;
}

QList<OAIErrorMessage> OAISend_an_sms_200_response::getMessages() const {
    return m_messages;
}
void OAISend_an_sms_200_response::setMessages(const QList<OAIErrorMessage> &messages) {
    m_messages = messages;
    m_messages_isSet = true;
}

bool OAISend_an_sms_200_response::is_messages_Set() const{
    return m_messages_isSet;
}

bool OAISend_an_sms_200_response::is_messages_Valid() const{
    return m_messages_isValid;
}

bool OAISend_an_sms_200_response::isSet() const {
...
bool OAISend_an_sms_200_response::isValid() const {
