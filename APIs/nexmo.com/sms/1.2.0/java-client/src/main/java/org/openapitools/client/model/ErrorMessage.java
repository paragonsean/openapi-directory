...
public class ErrorMessage {
  public static final String SERIALIZED_NAME_ERROR_TEXT = "error-text";
  ...
  public ErrorMessage errorText(String errorText) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errorText, errorMessage.errorText) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("error-text") != null && !jsonObj.get("error-text").isJsonNull()) && !jsonObj.get("error-text").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `error-text` to be a primitive type in the JSON string but got `%s`", jsonObj.get("error-text").toString()));
      }
