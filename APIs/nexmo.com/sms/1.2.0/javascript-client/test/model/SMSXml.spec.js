...
(function(root, factory) {
  ...
  describe('SMSXml', function() {
    it('should create an instance of SMSXml', function() {
      // uncomment below and update the code to test SMSXml
      //var instance = new SmsApi.SMSXml();
      //expect(instance).to.be.a(SmsApi.SMSXml);
    });
