...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerifyApi.NetworkUnblockResponseNotFound();
  });
  ...
  describe('NetworkUnblockResponseNotFound', function() {
    it('should create an instance of NetworkUnblockResponseNotFound', function() {
      // uncomment below and update the code to test NetworkUnblockResponseNotFound
      //var instance = new VerifyApi.NetworkUnblockResponseNotFound();
      //expect(instance).to.be.a(VerifyApi.NetworkUnblockResponseNotFound);
    });
