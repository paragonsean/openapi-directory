...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerifyApi.RequestErrorResponse();
  });
  ...
  describe('RequestErrorResponse', function() {
    it('should create an instance of RequestErrorResponse', function() {
      // uncomment below and update the code to test RequestErrorResponse
      //var instance = new VerifyApi.RequestErrorResponse();
      //expect(instance).to.be.a(VerifyApi.RequestErrorResponse);
    });
