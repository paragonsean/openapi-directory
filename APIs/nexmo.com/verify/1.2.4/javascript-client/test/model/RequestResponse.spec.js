...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerifyApi.RequestResponse();
  });
  ...
  describe('RequestResponse', function() {
    it('should create an instance of RequestResponse', function() {
      // uncomment below and update the code to test RequestResponse
      //var instance = new VerifyApi.RequestResponse();
      //expect(instance).to.be.a(VerifyApi.RequestResponse);
    });
