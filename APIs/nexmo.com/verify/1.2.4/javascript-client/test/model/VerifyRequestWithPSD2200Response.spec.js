...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerifyApi.VerifyRequestWithPSD2200Response();
  });
  ...
  describe('VerifyRequestWithPSD2200Response', function() {
    it('should create an instance of VerifyRequestWithPSD2200Response', function() {
      // uncomment below and update the code to test VerifyRequestWithPSD2200Response
      //var instance = new VerifyApi.VerifyRequestWithPSD2200Response();
      //expect(instance).to.be.a(VerifyApi.VerifyRequestWithPSD2200Response);
    });
