...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerifyApi.NetworkUnblockResponseForbidden();
  });
  ...
  describe('NetworkUnblockResponseForbidden', function() {
    it('should create an instance of NetworkUnblockResponseForbidden', function() {
      // uncomment below and update the code to test NetworkUnblockResponseForbidden
      //var instance = new VerifyApi.NetworkUnblockResponseForbidden();
      //expect(instance).to.be.a(VerifyApi.NetworkUnblockResponseForbidden);
    });
