...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerifyApi.FraudManagementApi();
  });
  ...
  describe('FraudManagementApi', function() {
    describe('networkUnblock', function() {
      it('should call networkUnblock successfully', function(done) {
        //uncomment below and update the code to test networkUnblock
        //instance.networkUnblock(function(error) {
