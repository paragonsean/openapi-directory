...
/**
 * The ControlErrorResponse model module.
 * @module model/ControlErrorResponse
 * @version 1.2.4
 */
class ControlErrorResponse {
    /**
     * Constructs a new <code>ControlErrorResponse</code>.
     * Error
     * @alias module:model/ControlErrorResponse
     */
    constructor() { 
        
        ControlErrorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ControlErrorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ControlErrorResponse} obj Optional instance to populate.
     * @return {module:model/ControlErrorResponse} The populated <code>ControlErrorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ControlErrorResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ControlErrorResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ControlErrorResponse</code>.
     */
 ...
 */
ControlErrorResponse.prototype['error_text'] = undefined;
 ...
 * @member {module:model/ControlErrorResponse.StatusEnum} status
 */
ControlErrorResponse.prototype['status'] = undefined;
 ...
 * @readonly
 */
ControlErrorResponse['StatusEnum'] = {
...
export default ControlErrorResponse;
