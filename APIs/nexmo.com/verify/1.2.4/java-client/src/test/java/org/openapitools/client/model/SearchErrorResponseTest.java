...
/**
 * Model tests for SearchErrorResponse
 */
public class SearchErrorResponseTest {
    private final SearchErrorResponse model = new SearchErrorResponse();
