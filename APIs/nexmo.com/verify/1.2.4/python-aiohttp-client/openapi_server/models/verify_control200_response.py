...
class VerifyControl200Response(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, command: str=None, status: str=None, error_text: str=None):
        """VerifyControl200Response - a model defined in OpenAPI

        :param command: The command of this VerifyControl200Response.
        :param status: The status of this VerifyControl200Response.
        :param error_text: The error_text of this VerifyControl200Response.
        """
        self.openapi_types = {
            'command': str,
            'status': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'VerifyControl200Response':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The verifyControl_200_response of this VerifyControl200Response.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def command(self):
        """Gets the command of this VerifyControl200Response.

        The `cmd` you sent in the request.

        :return: The command of this VerifyControl200Response.
        :rtype: str
        """
    ...
    def command(self, command):
        """Sets the command of this VerifyControl200Response.
    ...
    @property
    def status(self):
        """Gets the status of this VerifyControl200Response.
        ...
        :return: The status of this VerifyControl200Response.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this VerifyControl200Response.
    ...
    @property
    def error_text(self):
        """Gets the error_text of this VerifyControl200Response.

        If the `status` is non-zero, this explains the error encountered.

        :return: The error_text of this VerifyControl200Response.
        :rtype: str
        """
    ...
    def error_text(self, error_text):
        """Sets the error_text of this VerifyControl200Response.
