...
class RequestErrorResponse(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, error_text: str=None, network: str=None, request_id: str=None, status: str=None):
        """RequestErrorResponse - a model defined in OpenAPI

        :param error_text: The error_text of this RequestErrorResponse.
        :param network: The network of this RequestErrorResponse.
        :param request_id: The request_id of this RequestErrorResponse.
        :param status: The status of this RequestErrorResponse.
        """
        self.openapi_types = {
            'error_text': str,
            'network': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RequestErrorResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The requestErrorResponse of this RequestErrorResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def error_text(self):
        """Gets the error_text of this RequestErrorResponse.

        If `status` is non-zero, this explains the error encountered.

        :return: The error_text of this RequestErrorResponse.
        :rtype: str
        """
    ...
    def error_text(self, error_text):
        """Sets the error_text of this RequestErrorResponse.
    ...
    @property
    def network(self):
        """Gets the network of this RequestErrorResponse.

        The Network ID of the blocking network, if relevant to the error.

        :return: The network of this RequestErrorResponse.
        :rtype: str
        """
    ...
    def network(self, network):
        """Sets the network of this RequestErrorResponse.
    ...
    @property
    def request_id(self):
        """Gets the request_id of this RequestErrorResponse.

        The unique ID of the Verify request. This may be blank in an error situation.

        :return: The request_id of this RequestErrorResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        """Sets the request_id of this RequestErrorResponse.
    ...
    @property
    def status(self):
        """Gets the status of this RequestErrorResponse.
        ...
        :return: The status of this RequestErrorResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this RequestErrorResponse.
