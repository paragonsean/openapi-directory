...
/*
 * OAISearchResponse_events_inner.h
 *
 * 
 */

#ifndef OAISearchResponse_events_inner_H
#define OAISearchResponse_events_inner_H
...
class OAISearchResponse_events_inner : public OAIObject {
public:
    OAISearchResponse_events_inner();
    OAISearchResponse_events_inner(QString json);
    ~OAISearchResponse_events_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchResponse_events_inner)

#endif // OAISearchResponse_events_inner_H
