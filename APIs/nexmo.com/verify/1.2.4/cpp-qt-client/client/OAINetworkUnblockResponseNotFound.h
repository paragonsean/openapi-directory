...
/*
 * OAINetworkUnblockResponseNotFound.h
 *
 * Not Found
 */

#ifndef OAINetworkUnblockResponseNotFound_H
#define OAINetworkUnblockResponseNotFound_H
...
class OAINetworkUnblockResponseNotFound : public OAIObject {
public:
    OAINetworkUnblockResponseNotFound();
    OAINetworkUnblockResponseNotFound(QString json);
    ~OAINetworkUnblockResponseNotFound() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkUnblockResponseNotFound)

#endif // OAINetworkUnblockResponseNotFound_H
