...
/*
 * OAIRequestErrorResponse.h
 *
 * Error
 */

#ifndef OAIRequestErrorResponse_H
#define OAIRequestErrorResponse_H
...
class OAIRequestErrorResponse : public OAIObject {
public:
    OAIRequestErrorResponse();
    OAIRequestErrorResponse(QString json);
    ~OAIRequestErrorResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestErrorResponse)

#endif // OAIRequestErrorResponse_H
