...
#ifndef OAIErrorThrottled_H
#define OAIErrorThrottled_H
...
class OAIErrorThrottled : public OAIObject {
public:
    OAIErrorThrottled();
    OAIErrorThrottled(QString json);
    ~OAIErrorThrottled() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorThrottled)

#endif // OAIErrorThrottled_H
