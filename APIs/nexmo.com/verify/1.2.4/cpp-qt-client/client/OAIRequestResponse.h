...
/*
 * OAIRequestResponse.h
 *
 * Success
 */

#ifndef OAIRequestResponse_H
#define OAIRequestResponse_H
...
class OAIRequestResponse : public OAIObject {
public:
    OAIRequestResponse();
    OAIRequestResponse(QString json);
    ~OAIRequestResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRequestResponse)

#endif // OAIRequestResponse_H
