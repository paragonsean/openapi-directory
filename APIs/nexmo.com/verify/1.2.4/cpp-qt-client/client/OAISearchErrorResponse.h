...
/*
 * OAISearchErrorResponse.h
 *
 * Error
 */

#ifndef OAISearchErrorResponse_H
#define OAISearchErrorResponse_H
...
class OAISearchErrorResponse : public OAIObject {
public:
    OAISearchErrorResponse();
    OAISearchErrorResponse(QString json);
    ~OAISearchErrorResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchErrorResponse)

#endif // OAISearchErrorResponse_H
