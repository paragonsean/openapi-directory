...
/*
 * OAIControlErrorResponse.h
 *
 * Error
 */

#ifndef OAIControlErrorResponse_H
#define OAIControlErrorResponse_H
...
class OAIControlErrorResponse : public OAIObject {
public:
    OAIControlErrorResponse();
    OAIControlErrorResponse(QString json);
    ~OAIControlErrorResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIControlErrorResponse)

#endif // OAIControlErrorResponse_H
