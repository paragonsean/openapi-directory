...
/*
 * OAINetworkUnblockResponseForbidden.h
 *
 * Forbidden
 */

#ifndef OAINetworkUnblockResponseForbidden_H
#define OAINetworkUnblockResponseForbidden_H
...
class OAINetworkUnblockResponseForbidden : public OAIObject {
public:
    OAINetworkUnblockResponseForbidden();
    OAINetworkUnblockResponseForbidden(QString json);
    ~OAINetworkUnblockResponseForbidden() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINetworkUnblockResponseForbidden)

#endif // OAINetworkUnblockResponseForbidden_H
