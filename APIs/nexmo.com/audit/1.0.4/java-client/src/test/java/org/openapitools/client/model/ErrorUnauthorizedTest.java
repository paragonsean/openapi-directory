...
/**
 * Model tests for ErrorUnauthorized
 */
public class ErrorUnauthorizedTest {
    private final ErrorUnauthorized model = new ErrorUnauthorized();
