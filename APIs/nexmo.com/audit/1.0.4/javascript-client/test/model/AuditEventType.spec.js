...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuditApi.AuditEventType();
  });
  ...
  describe('AuditEventType', function() {
    it('should create an instance of AuditEventType', function() {
      // uncomment below and update the code to test AuditEventType
      //var instance = new AuditApi.AuditEventType();
      //expect(instance).to.be.a(AuditApi.AuditEventType);
    });
