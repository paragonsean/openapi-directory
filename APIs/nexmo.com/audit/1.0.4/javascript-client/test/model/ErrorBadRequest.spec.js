...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuditApi.ErrorBadRequest();
  });
  ...
  describe('ErrorBadRequest', function() {
    it('should create an instance of ErrorBadRequest', function() {
      // uncomment below and update the code to test ErrorBadRequest
      //var instance = new AuditApi.ErrorBadRequest();
      //expect(instance).to.be.a(AuditApi.ErrorBadRequest);
    });
