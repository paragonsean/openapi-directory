...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuditApi.ContextAppCreate();
  });
  ...
  describe('ContextAppCreate', function() {
    it('should create an instance of ContextAppCreate', function() {
      // uncomment below and update the code to test ContextAppCreate
      //var instance = new AuditApi.ContextAppCreate();
      //expect(instance).to.be.a(AuditApi.ContextAppCreate);
    });
