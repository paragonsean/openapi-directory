...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuditApi.ContextNumberLinking();
  });
  ...
  describe('ContextNumberLinking', function() {
    it('should create an instance of ContextNumberLinking', function() {
      // uncomment below and update the code to test ContextNumberLinking
      //var instance = new AuditApi.ContextNumberLinking();
      //expect(instance).to.be.a(AuditApi.ContextNumberLinking);
    });
