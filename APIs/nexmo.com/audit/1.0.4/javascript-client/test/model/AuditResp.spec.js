...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuditApi.AuditResp();
  });
  ...
  describe('AuditResp', function() {
    it('should create an instance of AuditResp', function() {
      // uncomment below and update the code to test AuditResp
      //var instance = new AuditApi.AuditResp();
      //expect(instance).to.be.a(AuditApi.AuditResp);
    });
