...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuditApi.EventLink();
  });
  ...
  describe('EventLink', function() {
    it('should create an instance of EventLink', function() {
      // uncomment below and update the code to test EventLink
      //var instance = new AuditApi.EventLink();
      //expect(instance).to.be.a(AuditApi.EventLink);
    });
