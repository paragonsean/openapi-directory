...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuditApi.EventLinkSelf();
  });
  ...
  describe('EventLinkSelf', function() {
    it('should create an instance of EventLinkSelf', function() {
      // uncomment below and update the code to test EventLinkSelf
      //var instance = new AuditApi.EventLinkSelf();
      //expect(instance).to.be.a(AuditApi.EventLinkSelf);
    });
