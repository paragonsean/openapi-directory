...
class NoContent {
    ...
    /**
     * Validates the JSON data with respect to <code>NoContent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NoContent</code>.
     */
 ...
 * @member {String} error
 */
NoContent.prototype['error'] = undefined;

/**
 * A longer description of the error BBB
 * @member {String} message
 */
NoContent.prototype['message'] = undefined;

/**
 * The HTTP Status code of the error
 * @member {Number} status
 */
NoContent.prototype['status'] = undefined;
