...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.nexmo.com/beta/audit"),
    ...
    _serverConfigs.insert("getEventsOptions", defaultConf);
    _serverIndices.insert("getEventsOptions", 0);
}
...
void OAIDefaultApi::getEvent(const QString &id) {
    QString fullPath = QString(_serverConfigs["getEvent"][_serverIndices.value("getEvent")].URL()+"/events/{id}");
...
void OAIDefaultApi::getEventCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIAuditEvent output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::getEvents(const ::OpenAPI::OptionalParam<OAIEventTypes> &event_type, const ::OpenAPI::OptionalParam<QString> &date_from, const ::OpenAPI::OptionalParam<QString> &date_to, const ::OpenAPI::OptionalParam<QString> &search_text, const ::OpenAPI::OptionalParam<QString> &page, const ::OpenAPI::OptionalParam<qint32> &size) {
    ...
    if (event_type.hasValue())
    {
        ...
        if (fullPath.indexOf("?") > 0)
            ...
            fullPath.append("?");
        QString paramString = (queryStyle == "form" && true) ? "" : (queryStyle == "form" && !(true)) ? "event_type"+querySuffix : "";
        QJsonObject parameter = event_type.value().asJsonObject();
        qint32 count = 0;
        for(const QString& key : parameter.keys()) {
            ...
            switch(parameter.value(key).type()) {
                ...
                {
                    paramString.append(((queryStyle == "form") ? key : QString("event_type").append("[").append(key).append("]"))+assignOperator+parameter.value(key).toString());
                    break;
                }
                case QJsonValue::Double:
                {
                    paramString.append(((queryStyle == "form") ? key : QString("event_type").append("[").append(key).append("]"))+assignOperator+QString::number(parameter.value(key).toDouble()));
                    break;
                }
                case QJsonValue::Bool:
                {
                    paramString.append(((queryStyle == "form") ? key : QString("event_type").append("[").append(key).append("]"))+assignOperator+QVariant(parameter.value(key).toBool()).toString());
                    break;
                }
                case QJsonValue::Array:
                {
                    paramString.append(((queryStyle == "form") ? key : QString("event_type").append("[").append(key).append("]"))+assignOperator+QVariant(parameter.value(key).toArray()).toString());
                    break;
                }
                case QJsonValue::Object:
                {
                    paramString.append(((queryStyle == "form") ? key : QString("event_type").append("[").append(key).append("]"))+assignOperator+QVariant(parameter.value(key).toObject()).toString());
                    break;
                }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getEventsCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::getEventsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIAuditResp output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::getEventsOptions() {
    QString fullPath = QString(_serverConfigs["getEventsOptions"][_serverIndices.value("getEventsOptions")].URL()+"/events");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getEventsOptionsCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::getEventsOptionsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIAuditEventTypesResp output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getEventsOptionsSignal(output);
        Q_EMIT getEventsOptionsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getEventsOptionsSignalE(output, error_type, error_str);
        Q_EMIT getEventsOptionsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getEventsOptionsSignalError(output, error_type, error_str);
        Q_EMIT getEventsOptionsSignalErrorFull(worker, error_type, error_str);
    }
}
