...
#ifndef OAIErrorForbidden_H
#define OAIErrorForbidden_H
...
class OAIErrorForbidden : public OAIObject {
public:
    OAIErrorForbidden();
    OAIErrorForbidden(QString json);
    ~OAIErrorForbidden() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorForbidden)

#endif // OAIErrorForbidden_H
