...
QString OAIErrorUnauthorized::getError() const {
    return m_error;
}
void OAIErrorUnauthorized::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIErrorUnauthorized::is_error_Set() const{
    return m_error_isSet;
}

bool OAIErrorUnauthorized::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIErrorUnauthorized::getMessage() const {
    return m_message;
}
void OAIErrorUnauthorized::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIErrorUnauthorized::is_message_Set() const{
    return m_message_isSet;
}

bool OAIErrorUnauthorized::is_message_Valid() const{
    return m_message_isValid;
}

qint32 OAIErrorUnauthorized::getStatus() const {
    return m_status;
}
void OAIErrorUnauthorized::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIErrorUnauthorized::is_status_Set() const{
    return m_status_isSet;
}

bool OAIErrorUnauthorized::is_status_Valid() const{
