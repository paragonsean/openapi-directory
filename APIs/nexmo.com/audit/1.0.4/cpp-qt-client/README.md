...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getEventSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getEventSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString id = create(); // QString | The UUID of the audit event to retrieve
      apiInstance.getEvent(id);
