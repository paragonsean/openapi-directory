...
class CreateCallRequestBase(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, event_method: str='POST', event_url: List[str]=None, _from: EndpointPhoneFrom=None, length_timer: int=7200, machine_detection: str=None, random_from_number: bool=False, ringing_timer: int=60, to: List[CreateCallRequestBaseToInner]=None):
        """CreateCallRequestBase - a model defined in OpenAPI

        :param event_method: The event_method of this CreateCallRequestBase.
        :param event_url: The event_url of this CreateCallRequestBase.
        :param _from: The _from of this CreateCallRequestBase.
        :param length_timer: The length_timer of this CreateCallRequestBase.
        :param machine_detection: The machine_detection of this CreateCallRequestBase.
        :param random_from_number: The random_from_number of this CreateCallRequestBase.
        :param ringing_timer: The ringing_timer of this CreateCallRequestBase.
        :param to: The to of this CreateCallRequestBase.
        """
        self.openapi_types = {
            'event_method': str,
            'event_url': List[str],
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateCallRequestBase':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateCallRequestBase of this CreateCallRequestBase.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def event_method(self):
        """Gets the event_method of this CreateCallRequestBase.

        The HTTP method used to send event information to `event_url`.

        :return: The event_method of this CreateCallRequestBase.
        :rtype: str
        """
    ...
    def event_method(self, event_method):
        """Sets the event_method of this CreateCallRequestBase.
    ...
    @property
    def event_url(self):
        """Gets the event_url of this CreateCallRequestBase.
        ...
        **Required** unless `event_url` is configured at the application level, see [Create an Application](/api/application.v2#createApplication)  The webhook endpoint where call progress events are sent to. For more information about the values sent, see [Event webhook](/voice/voice-api/webhook-reference#event-webhook). 
        ...
        :return: The event_url of this CreateCallRequestBase.
        :rtype: List[str]
        """
    ...
    def event_url(self, event_url):
        """Sets the event_url of this CreateCallRequestBase.
    ...
    @property
    def _from(self):
        """Gets the _from of this CreateCallRequestBase.


        :return: The _from of this CreateCallRequestBase.
    ...
    def _from(self, _from):
        """Sets the _from of this CreateCallRequestBase.
    ...
    def length_timer(self):
        """Gets the length_timer of this CreateCallRequestBase.

        Set the number of seconds that elapse before Vonage hangs up after the call state changes to answered.

        :return: The length_timer of this CreateCallRequestBase.
        :rtype: int
        """
    ...
    def length_timer(self, length_timer):
        """Sets the length_timer of this CreateCallRequestBase.
    ...
    def machine_detection(self):
        """Gets the machine_detection of this CreateCallRequestBase.
        ...
        :return: The machine_detection of this CreateCallRequestBase.
        :rtype: str
        """
    ...
    def machine_detection(self, machine_detection):
        """Sets the machine_detection of this CreateCallRequestBase.
    ...
    def random_from_number(self):
        """Gets the random_from_number of this CreateCallRequestBase.
        ...
        :return: The random_from_number of this CreateCallRequestBase.
        :rtype: bool
        """
    ...
    def random_from_number(self, random_from_number):
        """Sets the random_from_number of this CreateCallRequestBase.
    ...
    def ringing_timer(self):
        """Gets the ringing_timer of this CreateCallRequestBase.

        Set the number of seconds that elapse before Vonage hangs up after the call state changes to ‘ringing’.

        :return: The ringing_timer of this CreateCallRequestBase.
        :rtype: int
        """
    ...
    def ringing_timer(self, ringing_timer):
        """Sets the ringing_timer of this CreateCallRequestBase.
    ...
    @property
    def to(self):
        """Gets the to of this CreateCallRequestBase.


        :return: The to of this CreateCallRequestBase.
    ...
    @to.setter
    def to(self, to):
        """Sets the to of this CreateCallRequestBase.
