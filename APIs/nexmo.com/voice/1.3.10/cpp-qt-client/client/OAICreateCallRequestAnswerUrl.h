...
/*
 * OAICreateCallRequestAnswerUrl.h
 *
 * 
 */

#ifndef OAICreateCallRequestAnswerUrl_H
#define OAICreateCallRequestAnswerUrl_H
...
class OAICreateCallRequestAnswerUrl : public OAIObject {
public:
    OAICreateCallRequestAnswerUrl();
    OAICreateCallRequestAnswerUrl(QString json);
    ~OAICreateCallRequestAnswerUrl() override;
    ...
    QList<QString> getAnswerUrl() const;
    void setAnswerUrl(const QList<QString> &answer_url);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCallRequestAnswerUrl)

#endif // OAICreateCallRequestAnswerUrl_H
