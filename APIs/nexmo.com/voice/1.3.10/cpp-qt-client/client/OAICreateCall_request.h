...
/*
 * OAICreateCall_request.h
 *
 * 
 */

#ifndef OAICreateCall_request_H
#define OAICreateCall_request_H
...
class OAICreateCall_request : public OAIObject {
public:
    OAICreateCall_request();
    OAICreateCall_request(QString json);
    ~OAICreateCall_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCall_request)

#endif // OAICreateCall_request_H
