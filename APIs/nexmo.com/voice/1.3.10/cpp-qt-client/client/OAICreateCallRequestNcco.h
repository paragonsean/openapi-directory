...
/*
 * OAICreateCallRequestNcco.h
 *
 * 
 */

#ifndef OAICreateCallRequestNcco_H
#define OAICreateCallRequestNcco_H
...
class OAICreateCallRequestNcco : public OAIObject {
public:
    OAICreateCallRequestNcco();
    OAICreateCallRequestNcco(QString json);
    ~OAICreateCallRequestNcco() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCallRequestNcco)

#endif // OAICreateCallRequestNcco_H
