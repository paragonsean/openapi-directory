...
/**
 * The CreateCallRequestBase model module.
 * @module model/CreateCallRequestBase
 * @version 1.3.10
 */
class CreateCallRequestBase {
    /**
     * Constructs a new <code>CreateCallRequestBase</code>.
     * @alias module:model/CreateCallRequestBase
    ...
    /**
     * Constructs a <code>CreateCallRequestBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCallRequestBase} obj Optional instance to populate.
     * @return {module:model/CreateCallRequestBase} The populated <code>CreateCallRequestBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCallRequestBase();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCallRequestBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCallRequestBase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCallRequestBase.RequiredProperties) {
...
CreateCallRequestBase.RequiredProperties = ["from", "to"];
 ...
 * @readonly
 */
CreateCallRequestBase['EventMethodEnum'] = {
 ...
 * @readonly
 */
CreateCallRequestBase['MachineDetectionEnum'] = {
...
export default CreateCallRequestBase;
