...
|**answerMethod** | [**AnswerMethodEnum**](#AnswerMethodEnum) | The HTTP method used to send event information to answer_url. |  [optional] |
|**answerUrl** | **List&lt;String&gt;** | The webhook endpoint where you provide the [Nexmo Call Control Object](/voice/voice-api/ncco-reference) that governs this call.  |  |
