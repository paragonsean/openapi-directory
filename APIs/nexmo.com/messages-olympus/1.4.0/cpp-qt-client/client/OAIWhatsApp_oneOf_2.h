...
/*
 * OAIWhatsApp_oneOf_2.h
 *
 * 
 */

#ifndef OAIWhatsApp_oneOf_2_H
#define OAIWhatsApp_oneOf_2_H
...
class OAIWhatsApp_oneOf_2 : public OAIObject {
public:
    OAIWhatsApp_oneOf_2();
    OAIWhatsApp_oneOf_2(QString json);
    ~OAIWhatsApp_oneOf_2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWhatsApp_oneOf_2)

#endif // OAIWhatsApp_oneOf_2_H
