...
#ifndef OAIMMS_oneOf_3_H
#define OAIMMS_oneOf_3_H
...
class OAIMMS_oneOf_3 : public OAIObject {
public:
    OAIMMS_oneOf_3();
    OAIMMS_oneOf_3(QString json);
    ~OAIMMS_oneOf_3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMMS_oneOf_3)

#endif // OAIMMS_oneOf_3_H
