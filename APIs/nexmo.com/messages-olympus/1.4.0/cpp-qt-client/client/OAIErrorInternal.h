...
#ifndef OAIErrorInternal_H
#define OAIErrorInternal_H
...
class OAIErrorInternal : public OAIObject {
public:
    OAIErrorInternal();
    OAIErrorInternal(QString json);
    ~OAIErrorInternal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorInternal)

#endif // OAIErrorInternal_H
