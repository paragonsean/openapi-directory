...
#ifndef OAIErrorSender_H
#define OAIErrorSender_H
...
class OAIErrorSender : public OAIObject {
public:
    OAIErrorSender();
    OAIErrorSender(QString json);
    ~OAIErrorSender() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorSender)

#endif // OAIErrorSender_H
