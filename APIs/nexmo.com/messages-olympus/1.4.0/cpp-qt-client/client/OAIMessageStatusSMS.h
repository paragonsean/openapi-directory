...
/*
 * OAIMessageStatusSMS.h
 *
 * 
 */

#ifndef OAIMessageStatusSMS_H
#define OAIMessageStatusSMS_H
...
class OAIMessageStatusSMS : public OAIObject {
public:
    OAIMessageStatusSMS();
    OAIMessageStatusSMS(QString json);
    ~OAIMessageStatusSMS() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageStatusSMS)

#endif // OAIMessageStatusSMS_H
