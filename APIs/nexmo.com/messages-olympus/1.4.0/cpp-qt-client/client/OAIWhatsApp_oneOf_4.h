...
/*
 * OAIWhatsApp_oneOf_4.h
 *
 * 
 */

#ifndef OAIWhatsApp_oneOf_4_H
#define OAIWhatsApp_oneOf_4_H
...
namespace OpenAPI {
class OAIWhatsApp_oneOf_4_allOf_video;

class OAIWhatsApp_oneOf_4 : public OAIObject {
public:
    OAIWhatsApp_oneOf_4();
    OAIWhatsApp_oneOf_4(QString json);
    ~OAIWhatsApp_oneOf_4() override;
    ...
    OAIWhatsApp_oneOf_4_allOf_video getVideo() const;
    void setVideo(const OAIWhatsApp_oneOf_4_allOf_video &video);
...
private:
    ...
    OAIWhatsApp_oneOf_4_allOf_video m_video;
    bool m_video_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWhatsApp_oneOf_4)

#endif // OAIWhatsApp_oneOf_4_H
