...
#ifndef OAISMS_oneOf_H
#define OAISMS_oneOf_H
...
class OAISMS_oneOf : public OAIObject {
public:
    OAISMS_oneOf();
    OAISMS_oneOf(QString json);
    ~OAISMS_oneOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMS_oneOf)

#endif // OAISMS_oneOf_H
