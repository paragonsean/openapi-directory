...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.nexmo.com/v1/messages"),
...
void OAIDefaultApi::sendMessage(const OAISendMessage_request &oai_send_message_request) {
    QString fullPath = QString(_serverConfigs["sendMessage"][_serverIndices.value("sendMessage")].URL()+"/");
...
void OAIDefaultApi::sendMessageCallback(OAIHttpRequestWorker *worker) {
    ...
    OAISendMessage_202_response output(QString(worker->response));
    worker->deleteLater();
