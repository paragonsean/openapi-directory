...
#ifndef OAIUnsupported_H
#define OAIUnsupported_H
...
class OAIUnsupported : public OAIObject {
public:
    OAIUnsupported();
    OAIUnsupported(QString json);
    ~OAIUnsupported() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsupported)

#endif // OAIUnsupported_H
