...
#ifndef OAIErrorRecipient_H
#define OAIErrorRecipient_H
...
class OAIErrorRecipient : public OAIObject {
public:
    OAIErrorRecipient();
    OAIErrorRecipient(QString json);
    ~OAIErrorRecipient() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorRecipient)

#endif // OAIErrorRecipient_H
