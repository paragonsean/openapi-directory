...
/*
 * OAIMessageStatusBase.h
 *
 * 
 */

#ifndef OAIMessageStatusBase_H
#define OAIMessageStatusBase_H
...
class OAIMessageStatusBase : public OAIObject {
public:
    OAIMessageStatusBase();
    OAIMessageStatusBase(QString json);
    ~OAIMessageStatusBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageStatusBase)

#endif // OAIMessageStatusBase_H
