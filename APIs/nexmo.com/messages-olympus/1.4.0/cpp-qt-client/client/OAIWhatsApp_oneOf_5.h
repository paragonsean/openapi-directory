...
/*
 * OAIWhatsApp_oneOf_5.h
 *
 * 
 */

#ifndef OAIWhatsApp_oneOf_5_H
#define OAIWhatsApp_oneOf_5_H
...
namespace OpenAPI {
class OAIWhatsApp_oneOf_5_allOf_file;

class OAIWhatsApp_oneOf_5 : public OAIObject {
public:
    OAIWhatsApp_oneOf_5();
    OAIWhatsApp_oneOf_5(QString json);
    ~OAIWhatsApp_oneOf_5() override;
    ...
    OAIWhatsApp_oneOf_5_allOf_file getFile() const;
    void setFile(const OAIWhatsApp_oneOf_5_allOf_file &file);
...
private:
    ...
    OAIWhatsApp_oneOf_5_allOf_file m_file;
    bool m_file_isSet;
    bool m_file_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWhatsApp_oneOf_5)

#endif // OAIWhatsApp_oneOf_5_H
