...
#ifndef OAIErrorChannel_H
#define OAIErrorChannel_H
...
class OAIErrorChannel : public OAIObject {
public:
    OAIErrorChannel();
    OAIErrorChannel(QString json);
    ~OAIErrorChannel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErrorChannel)

#endif // OAIErrorChannel_H
