...
#ifndef OAIViber_oneOf_3_H
#define OAIViber_oneOf_3_H
...
class OAIViber_oneOf_3 : public OAIObject {
public:
    OAIViber_oneOf_3();
    OAIViber_oneOf_3(QString json);
    ~OAIViber_oneOf_3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIViber_oneOf_3)

#endif // OAIViber_oneOf_3_H
