...
/*
 * OAIMessageStatusViber.h
 *
 * 
 */

#ifndef OAIMessageStatusViber_H
#define OAIMessageStatusViber_H
...
class OAIMessageStatusViber : public OAIObject {
public:
    OAIMessageStatusViber();
    OAIMessageStatusViber(QString json);
    ~OAIMessageStatusViber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageStatusViber)

#endif // OAIMessageStatusViber_H
