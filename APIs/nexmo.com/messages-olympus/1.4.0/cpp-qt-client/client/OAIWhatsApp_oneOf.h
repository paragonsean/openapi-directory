...
#ifndef OAIWhatsApp_oneOf_H
#define OAIWhatsApp_oneOf_H
...
class OAIWhatsApp_oneOf : public OAIObject {
public:
    OAIWhatsApp_oneOf();
    OAIWhatsApp_oneOf(QString json);
    ~OAIWhatsApp_oneOf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWhatsApp_oneOf)

#endif // OAIWhatsApp_oneOf_H
