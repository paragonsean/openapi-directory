...
/*
 * OAIInboundMessageMMS.h
 *
 * 
 */

#ifndef OAIInboundMessageMMS_H
#define OAIInboundMessageMMS_H
...
class OAIInboundMessageMMS : public OAIObject {
public:
    OAIInboundMessageMMS();
    OAIInboundMessageMMS(QString json);
    ~OAIInboundMessageMMS() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInboundMessageMMS)

#endif // OAIInboundMessageMMS_H
