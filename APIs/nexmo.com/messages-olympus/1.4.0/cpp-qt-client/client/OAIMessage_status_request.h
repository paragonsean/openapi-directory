...
/*
 * OAIMessage_status_request.h
 *
 * 
 */

#ifndef OAIMessage_status_request_H
#define OAIMessage_status_request_H

#include <QJsonObject>

#include "OAIMessageStatusBase_error.h"
#include "OAIMessageStatusBase_usage.h"
#include "OAIMessageStatusMMS.h"
...
class OAIMessage_status_request : public OAIObject {
public:
    OAIMessage_status_request();
    OAIMessage_status_request(QString json);
    ~OAIMessage_status_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessage_status_request)

#endif // OAIMessage_status_request_H
