...
/*
 * OAIMessageStatusWhatsApp.h
 *
 * 
 */

#ifndef OAIMessageStatusWhatsApp_H
#define OAIMessageStatusWhatsApp_H
...
class OAIWhatsApp_1_usage;
class OAIWhatsApp_1_whatsapp;

class OAIMessageStatusWhatsApp : public OAIObject {
public:
    OAIMessageStatusWhatsApp();
    OAIMessageStatusWhatsApp(QString json);
    ~OAIMessageStatusWhatsApp() override;
    ...
    OAIWhatsApp_1_usage getUsage() const;
    void setUsage(const OAIWhatsApp_1_usage &usage);
    ...
    OAIWhatsApp_1_whatsapp getWhatsapp() const;
    void setWhatsapp(const OAIWhatsApp_1_whatsapp &whatsapp);
...
private:
    ...
    OAIWhatsApp_1_whatsapp m_whatsapp;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageStatusWhatsApp)

#endif // OAIMessageStatusWhatsApp_H
