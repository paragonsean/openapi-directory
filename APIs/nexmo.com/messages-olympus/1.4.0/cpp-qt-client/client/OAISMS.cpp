...
QString OAISMS::getMessageType() const {
    return m_message_type;
}
void OAISMS::setMessageType(const QString &message_type) {
    m_message_type = message_type;
    m_message_type_isSet = true;
}

bool OAISMS::is_message_type_Set() const{
    return m_message_type_isSet;
}

bool OAISMS::is_message_type_Valid() const{
    return m_message_type_isValid;
}

QJsonValue OAISMS::getText() const {
    return m_text;
}
void OAISMS::setText(const QJsonValue &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAISMS::is_text_Set() const{
    return m_text_isSet;
}

bool OAISMS::is_text_Valid() const{
    return m_text_isValid;
}

QString OAISMS::getChannel() const {
    return m_channel;
}
void OAISMS::setChannel(const QString &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAISMS::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAISMS::is_channel_Valid() const{
