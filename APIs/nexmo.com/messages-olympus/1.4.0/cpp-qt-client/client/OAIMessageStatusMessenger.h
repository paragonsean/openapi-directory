...
/*
 * OAIMessageStatusMessenger.h
 *
 * 
 */

#ifndef OAIMessageStatusMessenger_H
#define OAIMessageStatusMessenger_H
...
class OAIMessageStatusMessenger : public OAIObject {
public:
    OAIMessageStatusMessenger();
    OAIMessageStatusMessenger(QString json);
    ~OAIMessageStatusMessenger() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageStatusMessenger)

#endif // OAIMessageStatusMessenger_H
