...
QString OAIReply::getClientRef() const {
    return m_client_ref;
}
void OAIReply::setClientRef(const QString &client_ref) {
    m_client_ref = client_ref;
    m_client_ref_isSet = true;
}

bool OAIReply::is_client_ref_Set() const{
    return m_client_ref_isSet;
}

bool OAIReply::is_client_ref_Valid() const{
    return m_client_ref_isValid;
}

QString OAIReply::getMessageType() const {
    return m_message_type;
}
void OAIReply::setMessageType(const QString &message_type) {
    m_message_type = message_type;
    m_message_type_isSet = true;
}

bool OAIReply::is_message_type_Set() const{
    return m_message_type_isSet;
}

bool OAIReply::is_message_type_Valid() const{
    return m_message_type_isValid;
}

OAIReply_1_reply OAIReply::getReply() const {
    return m_reply;
}
void OAIReply::setReply(const OAIReply_1_reply &reply) {
    m_reply = reply;
    m_reply_isSet = true;
}

bool OAIReply::is_reply_Set() const{
    return m_reply_isSet;
}

bool OAIReply::is_reply_Valid() const{
...
bool OAIReply::isValid() const {
    ...
    return m_message_type_isValid && m_reply_isValid && true;
}
