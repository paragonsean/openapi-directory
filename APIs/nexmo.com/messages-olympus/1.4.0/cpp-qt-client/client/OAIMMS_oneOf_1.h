...
#ifndef OAIMMS_oneOf_1_H
#define OAIMMS_oneOf_1_H
...
class OAIMMS_oneOf_1 : public OAIObject {
public:
    OAIMMS_oneOf_1();
    OAIMMS_oneOf_1(QString json);
    ~OAIMMS_oneOf_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMMS_oneOf_1)

#endif // OAIMMS_oneOf_1_H
