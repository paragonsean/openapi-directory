...
#ifndef OAIWhatsApp_H
#define OAIWhatsApp_H
...
class OAIWhatsApp_oneOf_2_allOf_image;
class OAIWhatsApp_oneOf_3_allOf_audio;
...
class OAIWhatsApp : public OAIObject {
public:
    OAIWhatsApp();
    OAIWhatsApp(QString json);
    ~OAIWhatsApp() override;
    ...
    OAIWhatsApp_oneOf_2_allOf_image getImage() const;
    void setImage(const OAIWhatsApp_oneOf_2_allOf_image &image);
    bool is_image_Set() const;
    bool is_image_Valid() const;

    OAIWhatsApp_oneOf_3_allOf_audio getAudio() const;
    void setAudio(const OAIWhatsApp_oneOf_3_allOf_audio &audio);
...
private:
    ...
    OAIWhatsApp_oneOf_2_allOf_image m_image;
    bool m_image_isSet;
    bool m_image_isValid;

    OAIWhatsApp_oneOf_3_allOf_audio m_audio;
    bool m_audio_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWhatsApp)
