...
class WhatsAppOneOf(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, client_ref: str=None, message_type: str=None, text: object=None, channel: str=None, _from: str=None, to: str=None):
        """WhatsAppOneOf - a model defined in OpenAPI

        :param client_ref: The client_ref of this WhatsAppOneOf.
        :param message_type: The message_type of this WhatsAppOneOf.
        :param text: The text of this WhatsAppOneOf.
        :param channel: The channel of this WhatsAppOneOf.
        :param _from: The _from of this WhatsAppOneOf.
        :param to: The to of this WhatsAppOneOf.
        """
        self.openapi_types = {
            'client_ref': str,
            'message_type': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'WhatsAppOneOf':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The WhatsApp_oneOf of this WhatsAppOneOf.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def client_ref(self):
        """Gets the client_ref of this WhatsAppOneOf.

        Client reference of up to 100 characters. The reference will be present in every message status.

        :return: The client_ref of this WhatsAppOneOf.
        :rtype: str
        """
    ...
    def client_ref(self, client_ref):
        """Sets the client_ref of this WhatsAppOneOf.
    ...
    def message_type(self):
        """Gets the message_type of this WhatsAppOneOf.

        The type of message to send. You must provide `text` in this field

        :return: The message_type of this WhatsAppOneOf.
        :rtype: str
        """
    ...
    def message_type(self, message_type):
        """Sets the message_type of this WhatsAppOneOf.
    ...
    @property
    def text(self):
        """Gets the text of this WhatsAppOneOf.

        The text of message to send; limited to 4096 characters, including unicode. 

        :return: The text of this WhatsAppOneOf.
        :rtype: object
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this WhatsAppOneOf.
    ...
    @property
    def channel(self):
        """Gets the channel of this WhatsAppOneOf.

        The channel to send to. You must provide `whatsapp` in this field

        :return: The channel of this WhatsAppOneOf.
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this WhatsAppOneOf.
    ...
    @property
    def _from(self):
        """Gets the _from of this WhatsAppOneOf.
        ...
        :return: The _from of this WhatsAppOneOf.
        :rtype: str
        """
        return self.__from
    ...
    def _from(self, _from):
        """Sets the _from of this WhatsAppOneOf.
    ...
    @property
    def to(self):
        """Gets the to of this WhatsAppOneOf.
        ...
        :return: The to of this WhatsAppOneOf.
        :rtype: str
        """
        return self._to
    ...
    @to.setter
    def to(self, to):
        """Sets the to of this WhatsAppOneOf.
