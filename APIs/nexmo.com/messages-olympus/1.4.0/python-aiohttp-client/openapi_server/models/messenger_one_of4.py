...
class MessengerOneOf4(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, client_ref: str=None, file: MessengerOneOf4AllOfFile=None, message_type: str=None, channel: str=None, _from: str=None, messenger: ChannelOptionsMessengerMessenger=None, to: str=None):
        """MessengerOneOf4 - a model defined in OpenAPI

        :param client_ref: The client_ref of this MessengerOneOf4.
        :param file: The file of this MessengerOneOf4.
        :param message_type: The message_type of this MessengerOneOf4.
        :param channel: The channel of this MessengerOneOf4.
        :param _from: The _from of this MessengerOneOf4.
        :param messenger: The messenger of this MessengerOneOf4.
        :param to: The to of this MessengerOneOf4.
        """
        self.openapi_types = {
            'client_ref': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MessengerOneOf4':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Messenger_oneOf_4 of this MessengerOneOf4.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def client_ref(self):
        """Gets the client_ref of this MessengerOneOf4.

        Client reference of up to 100 characters. The reference will be present in every message status.

        :return: The client_ref of this MessengerOneOf4.
        :rtype: str
        """
    ...
    def client_ref(self, client_ref):
        """Sets the client_ref of this MessengerOneOf4.
    ...
    @property
    def file(self):
        """Gets the file of this MessengerOneOf4.


        :return: The file of this MessengerOneOf4.
    ...
    @file.setter
    def file(self, file):
        """Sets the file of this MessengerOneOf4.
    ...
    def message_type(self):
        """Gets the message_type of this MessengerOneOf4.

        The type of message to send. You must provide `file` in this field

        :return: The message_type of this MessengerOneOf4.
        :rtype: str
        """
    ...
    def message_type(self, message_type):
        """Sets the message_type of this MessengerOneOf4.
    ...
    @property
    def channel(self):
        """Gets the channel of this MessengerOneOf4.

        The channel to send to. You must provide `messenger` in this field

        :return: The channel of this MessengerOneOf4.
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this MessengerOneOf4.
    ...
    @property
    def _from(self):
        """Gets the _from of this MessengerOneOf4.

        The ID of the message sender 

        :return: The _from of this MessengerOneOf4.
        :rtype: str
        """
        return self.__from
    ...
    def _from(self, _from):
        """Sets the _from of this MessengerOneOf4.
    ...
    @property
    def messenger(self):
        """Gets the messenger of this MessengerOneOf4.


        :return: The messenger of this MessengerOneOf4.
    ...
    def messenger(self, messenger):
        """Sets the messenger of this MessengerOneOf4.
    ...
    @property
    def to(self):
        """Gets the to of this MessengerOneOf4.

        The ID of the message recipient 

        :return: The to of this MessengerOneOf4.
        :rtype: str
        """
        return self._to
    ...
    @to.setter
    def to(self, to):
        """Sets the to of this MessengerOneOf4.
