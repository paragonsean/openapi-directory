...
class SMSOneOf(Model):
    ...
    def __init__(self, client_ref: str=None, message_type: str=None, text: object=None, channel: str=None, _from: str=None, to: str=None):
        """SMSOneOf - a model defined in OpenAPI

        :param client_ref: The client_ref of this SMSOneOf.
        :param message_type: The message_type of this SMSOneOf.
        :param text: The text of this SMSOneOf.
        :param channel: The channel of this SMSOneOf.
        :param _from: The _from of this SMSOneOf.
        :param to: The to of this SMSOneOf.
        """
        self.openapi_types = {
            'client_ref': str,
            'message_type': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SMSOneOf':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SMS_oneOf of this SMSOneOf.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def client_ref(self):
        """Gets the client_ref of this SMSOneOf.

        Client reference of up to 100 characters. The reference will be present in every message status.

        :return: The client_ref of this SMSOneOf.
        :rtype: str
        """
    ...
    def client_ref(self, client_ref):
        """Sets the client_ref of this SMSOneOf.
    ...
    def message_type(self):
        """Gets the message_type of this SMSOneOf.

        The type of message to send. You must provide `text` in this field

        :return: The message_type of this SMSOneOf.
        :rtype: str
        """
    ...
    def message_type(self, message_type):
        """Sets the message_type of this SMSOneOf.
    ...
    @property
    def text(self):
        """Gets the text of this SMSOneOf.
        ...
        :return: The text of this SMSOneOf.
        :rtype: object
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this SMSOneOf.
    ...
    @property
    def channel(self):
        """Gets the channel of this SMSOneOf.

        The channel to send to. You must provide `sms` in this field

        :return: The channel of this SMSOneOf.
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this SMSOneOf.
    ...
    @property
    def _from(self):
        """Gets the _from of this SMSOneOf.
        ...
        :return: The _from of this SMSOneOf.
        :rtype: str
        """
        return self.__from
    ...
    def _from(self, _from):
        """Sets the _from of this SMSOneOf.
    ...
    def to(self):
        ...
        :return: The to of this SMSOneOf.
        :rtype: str
        """
        return self._to
