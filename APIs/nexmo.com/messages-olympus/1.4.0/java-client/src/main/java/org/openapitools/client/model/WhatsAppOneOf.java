...
public class WhatsAppOneOf {
  ...
  public WhatsAppOneOf() {
  }

  public WhatsAppOneOf clientRef(String clientRef) {
  ...
  public WhatsAppOneOf messageType(MessageTypeEnum messageType) {
  ...
  public WhatsAppOneOf text(Object text) {
    this.text = text;
    return this;
  }
  ...
  public WhatsAppOneOf channel(ChannelEnum channel) {
  ...
  public WhatsAppOneOf from(String from) {
    this.from = from;
    return this;
  }
  ...
  public WhatsAppOneOf to(String to) {
    this.to = to;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WhatsAppOneOf whatsAppOneOf = (WhatsAppOneOf) o;
    return Objects.equals(this.clientRef, whatsAppOneOf.clientRef) &&
        Objects.equals(this.messageType, whatsAppOneOf.messageType) &&
        Objects.equals(this.text, whatsAppOneOf.text) &&
        Objects.equals(this.channel, whatsAppOneOf.channel) &&
        Objects.equals(this.from, whatsAppOneOf.from) &&
        Objects.equals(this.to, whatsAppOneOf.to);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRef, messageType, text, channel, from, to);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WhatsAppOneOf {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WhatsAppOneOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WhatsAppOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WhatsAppOneOf is not found in the empty JSON string", WhatsAppOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WhatsAppOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WhatsAppOneOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WhatsAppOneOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WhatsAppOneOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WhatsAppOneOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WhatsAppOneOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WhatsAppOneOf.class));

       return (TypeAdapter<T>) new TypeAdapter<WhatsAppOneOf>() {
           @Override
           public void write(JsonWriter out, WhatsAppOneOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WhatsAppOneOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WhatsAppOneOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WhatsAppOneOf
   * @throws IOException if the JSON string is invalid with respect to WhatsAppOneOf
   */
  public static WhatsAppOneOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WhatsAppOneOf.class);
  }

  /**
   * Convert an instance of WhatsAppOneOf to an JSON string
   *
   * @return JSON string
   */
