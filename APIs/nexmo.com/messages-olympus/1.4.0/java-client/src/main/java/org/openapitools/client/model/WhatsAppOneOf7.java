...
public class WhatsAppOneOf7 {
  ...
  public WhatsAppOneOf7() {
  }

  public WhatsAppOneOf7 clientRef(String clientRef) {
  ...
  public WhatsAppOneOf7 custom(Map<String, Object> custom) {
    this.custom = custom;
    return this;
  }

  public WhatsAppOneOf7 putCustomItem(String key, Object customItem) {
    if (this.custom == null) {
  ...
  public WhatsAppOneOf7 messageType(MessageTypeEnum messageType) {
  ...
  public WhatsAppOneOf7 channel(ChannelEnum channel) {
  ...
  public WhatsAppOneOf7 from(String from) {
    this.from = from;
    return this;
  }
  ...
  public WhatsAppOneOf7 to(String to) {
    this.to = to;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WhatsAppOneOf7 whatsAppOneOf7 = (WhatsAppOneOf7) o;
    return Objects.equals(this.clientRef, whatsAppOneOf7.clientRef) &&
        Objects.equals(this.custom, whatsAppOneOf7.custom) &&
        Objects.equals(this.messageType, whatsAppOneOf7.messageType) &&
        Objects.equals(this.channel, whatsAppOneOf7.channel) &&
        Objects.equals(this.from, whatsAppOneOf7.from) &&
        Objects.equals(this.to, whatsAppOneOf7.to);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRef, custom, messageType, channel, from, to);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WhatsAppOneOf7 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WhatsAppOneOf7
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WhatsAppOneOf7.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WhatsAppOneOf7 is not found in the empty JSON string", WhatsAppOneOf7.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WhatsAppOneOf7.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WhatsAppOneOf7` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WhatsAppOneOf7.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WhatsAppOneOf7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WhatsAppOneOf7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WhatsAppOneOf7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WhatsAppOneOf7.class));

       return (TypeAdapter<T>) new TypeAdapter<WhatsAppOneOf7>() {
           @Override
           public void write(JsonWriter out, WhatsAppOneOf7 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WhatsAppOneOf7 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WhatsAppOneOf7 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WhatsAppOneOf7
   * @throws IOException if the JSON string is invalid with respect to WhatsAppOneOf7
   */
  public static WhatsAppOneOf7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WhatsAppOneOf7.class);
  }

  /**
   * Convert an instance of WhatsAppOneOf7 to an JSON string
   *
   * @return JSON string
   */
