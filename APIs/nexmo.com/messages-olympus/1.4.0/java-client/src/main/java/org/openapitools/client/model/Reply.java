...
public class Reply {
  ...
  private Reply1Reply reply;

  public Reply() {
  }

  public Reply clientRef(String clientRef) {
  ...
  public Reply messageType(MessageTypeEnum messageType) {
  ...
  public Reply reply(Reply1Reply reply) {
    this.reply = reply;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public Reply1Reply getReply() {
    return reply;
  }

  public void setReply(Reply1Reply reply) {
    this.reply = reply;
  }
  ...
  public boolean equals(Object o) {
    ...
    Reply reply = (Reply) o;
    return Objects.equals(this.clientRef, reply.clientRef) &&
        Objects.equals(this.messageType, reply.messageType) &&
        Objects.equals(this.reply, reply.reply);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRef, messageType, reply);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `reply`
      Reply1Reply.validateJsonElement(jsonObj.get("reply"));
  }
