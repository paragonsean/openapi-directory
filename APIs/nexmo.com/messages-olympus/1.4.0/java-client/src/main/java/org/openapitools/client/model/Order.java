...
import org.openapitools.client.model.Order1Order;
...
public class Order {
  ...
  private Order1Order order;

  public Order() {
  }

  public Order clientRef(String clientRef) {
  ...
  public Order order(Order1Order order) {
    this.order = order;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public Order1Order getOrder() {
    return order;
  }

  public void setOrder(Order1Order order) {
    this.order = order;
  }
  ...
  public boolean equals(Object o) {
    ...
    Order order = (Order) o;
    return Objects.equals(this.clientRef, order.clientRef) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientRef, messageType, order);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      Order1Order.validateJsonElement(jsonObj.get("order"));
  }
