...
public class Text {
  ...
  public Text clientRef(String clientRef) {
  ...
  public Text messageType(MessageTypeEnum messageType) {
  ...
  public boolean equals(Object o) {
    ...
    Text text = (Text) o;
    return Objects.equals(this.clientRef, text.clientRef) &&
        Objects.equals(this.messageType, text.messageType) &&
        Objects.equals(this.text, text.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRef, messageType, text);
  }
