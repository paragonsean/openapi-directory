...
public class VCard {
  ...
  private VCard1Vcard vcard;

  public VCard() {
  }

  public VCard clientRef(String clientRef) {
  ...
  public VCard messageType(MessageTypeEnum messageType) {
  ...
  public VCard vcard(VCard1Vcard vcard) {
    this.vcard = vcard;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public VCard1Vcard getVcard() {
    return vcard;
  }

  public void setVcard(VCard1Vcard vcard) {
    this.vcard = vcard;
  }
  ...
  public boolean equals(Object o) {
    ...
    VCard vCard = (VCard) o;
    return Objects.equals(this.clientRef, vCard.clientRef) &&
        Objects.equals(this.messageType, vCard.messageType) &&
        Objects.equals(this.vcard, vCard.vcard);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRef, messageType, vcard);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VCard {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VCard
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VCard is not found in the empty JSON string", VCard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VCard` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VCard.openapiRequiredFields) {
      ...
      VCard1Vcard.validateJsonElement(jsonObj.get("vcard"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VCard.class));

       return (TypeAdapter<T>) new TypeAdapter<VCard>() {
           @Override
           public void write(JsonWriter out, VCard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VCard read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VCard given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VCard
   * @throws IOException if the JSON string is invalid with respect to VCard
   */
  public static VCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VCard.class);
  }

  /**
   * Convert an instance of VCard to an JSON string
   *
   * @return JSON string
   */
