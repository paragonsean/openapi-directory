...
public class SMSOneOf {
  ...
  public SMSOneOf clientRef(String clientRef) {
  ...
  public SMSOneOf messageType(MessageTypeEnum messageType) {
  ...
  public SMSOneOf text(Object text) {
    this.text = text;
    return this;
  }
  ...
  public SMSOneOf channel(ChannelEnum channel) {
  ...
  public SMSOneOf from(String from) {
    this.from = from;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SMSOneOf smSOneOf = (SMSOneOf) o;
    return Objects.equals(this.clientRef, smSOneOf.clientRef) &&
        Objects.equals(this.messageType, smSOneOf.messageType) &&
        Objects.equals(this.text, smSOneOf.text) &&
        Objects.equals(this.channel, smSOneOf.channel) &&
        Objects.equals(this.from, smSOneOf.from) &&
        Objects.equals(this.to, smSOneOf.to);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SMSOneOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SMSOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SMSOneOf is not found in the empty JSON string", SMSOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SMSOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SMSOneOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SMSOneOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SMSOneOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SMSOneOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SMSOneOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SMSOneOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SMSOneOf>() {
           @Override
           public void write(JsonWriter out, SMSOneOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SMSOneOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SMSOneOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SMSOneOf
   * @throws IOException if the JSON string is invalid with respect to SMSOneOf
   */
  public static SMSOneOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SMSOneOf.class);
  }

  /**
   * Convert an instance of SMSOneOf to an JSON string
   *
   * @return JSON string
   */
