...
public class MMSOneOf {
  ...
  private MMSOneOfAllOfImage image;
  ...
  public MMSOneOf clientRef(String clientRef) {
  ...
  public MMSOneOf image(MMSOneOfAllOfImage image) {
    this.image = image;
    return this;
  }
  ...
  public MMSOneOfAllOfImage getImage() {
    return image;
  }

  public void setImage(MMSOneOfAllOfImage image) {
    this.image = image;
  }


  public MMSOneOf messageType(MessageTypeEnum messageType) {
  ...
  public MMSOneOf channel(ChannelEnum channel) {
  ...
  public MMSOneOf from(String from) {
    this.from = from;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MMSOneOf mmSOneOf = (MMSOneOf) o;
    return Objects.equals(this.clientRef, mmSOneOf.clientRef) &&
        Objects.equals(this.image, mmSOneOf.image) &&
        Objects.equals(this.messageType, mmSOneOf.messageType) &&
        Objects.equals(this.channel, mmSOneOf.channel) &&
        Objects.equals(this.from, mmSOneOf.from) &&
        Objects.equals(this.to, mmSOneOf.to);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MMSOneOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MMSOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MMSOneOf is not found in the empty JSON string", MMSOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MMSOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MMSOneOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MMSOneOf.openapiRequiredFields) {
      ...
      MMSOneOfAllOfImage.validateJsonElement(jsonObj.get("image"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MMSOneOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MMSOneOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MMSOneOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MMSOneOf.class));

       return (TypeAdapter<T>) new TypeAdapter<MMSOneOf>() {
           @Override
           public void write(JsonWriter out, MMSOneOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MMSOneOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MMSOneOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MMSOneOf
   * @throws IOException if the JSON string is invalid with respect to MMSOneOf
   */
  public static MMSOneOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MMSOneOf.class);
  }

  /**
   * Convert an instance of MMSOneOf to an JSON string
   *
   * @return JSON string
   */
