...
public class Audio {
  ...
  public Audio clientRef(String clientRef) {
  ...
  public Audio audio(Audio1Audio audio) {
    this.audio = audio;
    return this;
  }
  ...
  public Audio1Audio getAudio() {
    return audio;
  }

  public void setAudio(Audio1Audio audio) {
    this.audio = audio;
  }


  public Audio messageType(MessageTypeEnum messageType) {
  ...
  public boolean equals(Object o) {
    ...
    Audio audio = (Audio) o;
    return Objects.equals(this.clientRef, audio.clientRef) &&
        Objects.equals(this.audio, audio.audio) &&
        Objects.equals(this.messageType, audio.messageType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientRef, audio, messageType);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      Audio1Audio.validateJsonElement(jsonObj.get("audio"));
