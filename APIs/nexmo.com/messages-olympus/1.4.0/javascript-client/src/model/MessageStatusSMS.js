...
/**
 * The MessageStatusSMS model module.
 * @module model/MessageStatusSMS
 * @version 1.4.0
 */
class MessageStatusSMS {
    /**
     * Constructs a new <code>MessageStatusSMS</code>.
     * @alias module:model/MessageStatusSMS
     ...
     * @param status {module:model/MessageStatusSMS.StatusEnum} The status of the message.
     ...
     * @param channel {module:model/MessageStatusSMS.ChannelEnum} The channel sending to.
     */
    constructor(from, messageUuid, status, timestamp, to, channel) { 
        ...
        MessageStatusSMS.initialize(this, from, messageUuid, status, timestamp, to, channel);
    }
    ...
    /**
     * Constructs a <code>MessageStatusSMS</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageStatusSMS} obj Optional instance to populate.
     * @return {module:model/MessageStatusSMS} The populated <code>MessageStatusSMS</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageStatusSMS();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageStatusSMS</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageStatusSMS</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MessageStatusSMS.RequiredProperties) {
...
MessageStatusSMS.RequiredProperties = ["from", "message_uuid", "status", "timestamp", "to", "channel"];

/**
 * Client reference of up to 100 characters. The reference will be present in every message status.
 * @member {String} client_ref
 */
MessageStatusSMS.prototype['client_ref'] = undefined;

/**
 * @member {module:model/MessageStatusBaseError} error
 */
MessageStatusSMS.prototype['error'] = undefined;

/**
 * The phone number of the message **sender** in the [E.164](https://en.wikipedia.org/wiki/E.164) format. Don't use a leading + or 00 when entering a phone number, start with the country code, for example, 447700900000. For SMS in certain localities alpha-numeric sender id's will work as well, see [Global Messaging](https://developer.nexmo.com/messaging/sms/guides/country-specific-features#country-specific-features) for more details 
 * @member {String} from
 */
MessageStatusSMS.prototype['from'] = undefined;

/**
 * The UUID of the message
 * @member {String} message_uuid
 */
MessageStatusSMS.prototype['message_uuid'] = undefined;

/**
 * The status of the message.
 * @member {module:model/MessageStatusSMS.StatusEnum} status
 */
MessageStatusSMS.prototype['status'] = undefined;

/**
 * The datetime of when the event occurred, in `ISO 8601` format.
 * @member {String} timestamp
 */
MessageStatusSMS.prototype['timestamp'] = undefined;
 ...
 * @member {String} to
 */
MessageStatusSMS.prototype['to'] = undefined;

/**
 * @member {module:model/MessageStatusBaseUsage} usage
 */
MessageStatusSMS.prototype['usage'] = undefined;

/**
 * The channel sending to.
 * @member {module:model/MessageStatusSMS.ChannelEnum} channel
 */
MessageStatusSMS.prototype['channel'] = undefined;
...
export default MessageStatusSMS;
