...
/**
 * The MessageStatusMessenger model module.
 * @module model/MessageStatusMessenger
 * @version 1.4.0
 */
class MessageStatusMessenger {
    /**
     * Constructs a new <code>MessageStatusMessenger</code>.
     * @alias module:model/MessageStatusMessenger
     ...
     * @param status {module:model/MessageStatusMessenger.StatusEnum} 
     ...
     * @param channel {module:model/MessageStatusMessenger.ChannelEnum} The channel sending to.
     */
    constructor(from, messageUuid, status, timestamp, to, channel) { 
        ...
        MessageStatusMessenger.initialize(this, from, messageUuid, status, timestamp, to, channel);
    }
    ...
    /**
     * Constructs a <code>MessageStatusMessenger</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageStatusMessenger} obj Optional instance to populate.
     * @return {module:model/MessageStatusMessenger} The populated <code>MessageStatusMessenger</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageStatusMessenger();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageStatusMessenger</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageStatusMessenger</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MessageStatusMessenger.RequiredProperties) {
...
MessageStatusMessenger.RequiredProperties = ["from", "message_uuid", "status", "timestamp", "to", "channel"];

/**
 * Client reference of up to 100 characters. The reference will be present in every message status.
 * @member {String} client_ref
 */
MessageStatusMessenger.prototype['client_ref'] = undefined;

/**
 * @member {module:model/MessageStatusBaseError} error
 */
MessageStatusMessenger.prototype['error'] = undefined;

/**
 * The ID of the message sender 
 * @member {String} from
 */
MessageStatusMessenger.prototype['from'] = undefined;

/**
 * The UUID of the message
 * @member {String} message_uuid
 */
MessageStatusMessenger.prototype['message_uuid'] = undefined;

/**
 * @member {module:model/MessageStatusMessenger.StatusEnum} status
 */
MessageStatusMessenger.prototype['status'] = undefined;

/**
 * The datetime of when the event occurred, in `ISO 8601` format.
 * @member {String} timestamp
 */
MessageStatusMessenger.prototype['timestamp'] = undefined;

/**
 * The ID of the message recipient 
 * @member {String} to
 */
MessageStatusMessenger.prototype['to'] = undefined;

/**
 * @member {module:model/MessageStatusBaseUsage} usage
 */
MessageStatusMessenger.prototype['usage'] = undefined;

/**
 * The channel sending to.
 * @member {module:model/MessageStatusMessenger.ChannelEnum} channel
 */
MessageStatusMessenger.prototype['channel'] = undefined;
 ...
 * @readonly
 */
MessageStatusMessenger['StatusEnum'] = {
 ...
 * @readonly
 */
MessageStatusMessenger['ChannelEnum'] = {
...
export default MessageStatusMessenger;
