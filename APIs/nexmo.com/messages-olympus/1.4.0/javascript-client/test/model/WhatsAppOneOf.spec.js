...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.WhatsAppOneOf();
  });
  ...
  describe('WhatsAppOneOf', function() {
    it('should create an instance of WhatsAppOneOf', function() {
      // uncomment below and update the code to test WhatsAppOneOf
      //var instance = new MessagesApi.WhatsAppOneOf();
      //expect(instance).to.be.a(MessagesApi.WhatsAppOneOf);
    });
