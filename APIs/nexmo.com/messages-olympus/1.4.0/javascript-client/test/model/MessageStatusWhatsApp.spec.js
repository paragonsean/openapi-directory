...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MessageStatusWhatsApp();
  });
  ...
  describe('MessageStatusWhatsApp', function() {
    it('should create an instance of MessageStatusWhatsApp', function() {
      // uncomment below and update the code to test MessageStatusWhatsApp
      //var instance = new MessagesApi.MessageStatusWhatsApp();
      //expect(instance).to.be.a(MessagesApi.MessageStatusWhatsApp);
    });
