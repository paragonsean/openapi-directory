...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.SMSOneOf();
  });
  ...
  describe('SMSOneOf', function() {
    it('should create an instance of SMSOneOf', function() {
      // uncomment below and update the code to test SMSOneOf
      //var instance = new MessagesApi.SMSOneOf();
      //expect(instance).to.be.a(MessagesApi.SMSOneOf);
    });
