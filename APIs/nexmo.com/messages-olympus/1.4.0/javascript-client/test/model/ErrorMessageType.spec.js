...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ErrorMessageType();
  });
  ...
  describe('ErrorMessageType', function() {
    it('should create an instance of ErrorMessageType', function() {
      // uncomment below and update the code to test ErrorMessageType
      //var instance = new MessagesApi.ErrorMessageType();
      //expect(instance).to.be.a(MessagesApi.ErrorMessageType);
    });
