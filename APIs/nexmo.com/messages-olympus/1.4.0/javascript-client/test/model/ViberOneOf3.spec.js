...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ViberOneOf3();
  });
  ...
  describe('ViberOneOf3', function() {
    it('should create an instance of ViberOneOf3', function() {
      // uncomment below and update the code to test ViberOneOf3
      //var instance = new MessagesApi.ViberOneOf3();
      //expect(instance).to.be.a(MessagesApi.ViberOneOf3);
    });
