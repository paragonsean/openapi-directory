...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MessageStatusSMS();
  });
  ...
  describe('MessageStatusSMS', function() {
    it('should create an instance of MessageStatusSMS', function() {
      // uncomment below and update the code to test MessageStatusSMS
      //var instance = new MessagesApi.MessageStatusSMS();
      //expect(instance).to.be.a(MessagesApi.MessageStatusSMS);
    });
