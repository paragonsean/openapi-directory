...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MessengerOneOf();
  });
  ...
  describe('MessengerOneOf', function() {
    it('should create an instance of MessengerOneOf', function() {
      // uncomment below and update the code to test MessengerOneOf
      //var instance = new MessagesApi.MessengerOneOf();
      //expect(instance).to.be.a(MessagesApi.MessengerOneOf);
    });
