...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.Unsupported();
  });
  ...
  describe('Unsupported', function() {
    it('should create an instance of Unsupported', function() {
      // uncomment below and update the code to test Unsupported
      //var instance = new MessagesApi.Unsupported();
      //expect(instance).to.be.a(MessagesApi.Unsupported);
    });
