...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ErrorSender();
  });
  ...
  describe('ErrorSender', function() {
    it('should create an instance of ErrorSender', function() {
      // uncomment below and update the code to test ErrorSender
      //var instance = new MessagesApi.ErrorSender();
      //expect(instance).to.be.a(MessagesApi.ErrorSender);
    });
