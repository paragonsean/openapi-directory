...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.WhatsAppOneOf7();
  });
  ...
  describe('WhatsAppOneOf7', function() {
    it('should create an instance of WhatsAppOneOf7', function() {
      // uncomment below and update the code to test WhatsAppOneOf7
      //var instance = new MessagesApi.WhatsAppOneOf7();
      //expect(instance).to.be.a(MessagesApi.WhatsAppOneOf7);
    });
