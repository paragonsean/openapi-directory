...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MMSOneOf1();
  });
  ...
  describe('MMSOneOf1', function() {
    it('should create an instance of MMSOneOf1', function() {
      // uncomment below and update the code to test MMSOneOf1
      //var instance = new MessagesApi.MMSOneOf1();
      //expect(instance).to.be.a(MessagesApi.MMSOneOf1);
    });
