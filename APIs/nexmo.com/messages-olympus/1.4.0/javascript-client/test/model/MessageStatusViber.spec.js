...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MessageStatusViber();
  });
  ...
  describe('MessageStatusViber', function() {
    it('should create an instance of MessageStatusViber', function() {
      // uncomment below and update the code to test MessageStatusViber
      //var instance = new MessagesApi.MessageStatusViber();
      //expect(instance).to.be.a(MessagesApi.MessageStatusViber);
    });
