...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.WhatsAppOneOf4();
  });
  ...
  describe('WhatsAppOneOf4', function() {
    it('should create an instance of WhatsAppOneOf4', function() {
      // uncomment below and update the code to test WhatsAppOneOf4
      //var instance = new MessagesApi.WhatsAppOneOf4();
      //expect(instance).to.be.a(MessagesApi.WhatsAppOneOf4);
    });
