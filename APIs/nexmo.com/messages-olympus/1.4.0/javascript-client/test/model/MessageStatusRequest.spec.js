...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MessageStatusRequest();
  });
  ...
  describe('MessageStatusRequest', function() {
    it('should create an instance of MessageStatusRequest', function() {
      // uncomment below and update the code to test MessageStatusRequest
      //var instance = new MessagesApi.MessageStatusRequest();
      //expect(instance).to.be.a(MessagesApi.MessageStatusRequest);
    });
