...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MessengerOneOf1();
  });
  ...
  describe('MessengerOneOf1', function() {
    it('should create an instance of MessengerOneOf1', function() {
      // uncomment below and update the code to test MessengerOneOf1
      //var instance = new MessagesApi.MessengerOneOf1();
      //expect(instance).to.be.a(MessagesApi.MessengerOneOf1);
    });
