...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MMSOneOf3();
  });
  ...
  describe('MMSOneOf3', function() {
    it('should create an instance of MMSOneOf3', function() {
      // uncomment below and update the code to test MMSOneOf3
      //var instance = new MessagesApi.MMSOneOf3();
      //expect(instance).to.be.a(MessagesApi.MMSOneOf3);
    });
