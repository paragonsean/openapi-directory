...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MessengerOneOf3();
  });
  ...
  describe('MessengerOneOf3', function() {
    it('should create an instance of MessengerOneOf3', function() {
      // uncomment below and update the code to test MessengerOneOf3
      //var instance = new MessagesApi.MessengerOneOf3();
      //expect(instance).to.be.a(MessagesApi.MessengerOneOf3);
    });
