...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ErrorPaymentRequired();
  });
  ...
  describe('ErrorPaymentRequired', function() {
    it('should create an instance of ErrorPaymentRequired', function() {
      // uncomment below and update the code to test ErrorPaymentRequired
      //var instance = new MessagesApi.ErrorPaymentRequired();
      //expect(instance).to.be.a(MessagesApi.ErrorPaymentRequired);
    });
