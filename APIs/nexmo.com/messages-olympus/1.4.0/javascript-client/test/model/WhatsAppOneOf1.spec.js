...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.WhatsAppOneOf1();
  });
  ...
  describe('WhatsAppOneOf1', function() {
    it('should create an instance of WhatsAppOneOf1', function() {
      // uncomment below and update the code to test WhatsAppOneOf1
      //var instance = new MessagesApi.WhatsAppOneOf1();
      //expect(instance).to.be.a(MessagesApi.WhatsAppOneOf1);
    });
