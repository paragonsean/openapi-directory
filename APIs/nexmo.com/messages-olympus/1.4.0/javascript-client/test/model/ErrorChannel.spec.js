...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ErrorChannel();
  });
  ...
  describe('ErrorChannel', function() {
    it('should create an instance of ErrorChannel', function() {
      // uncomment below and update the code to test ErrorChannel
      //var instance = new MessagesApi.ErrorChannel();
      //expect(instance).to.be.a(MessagesApi.ErrorChannel);
    });
