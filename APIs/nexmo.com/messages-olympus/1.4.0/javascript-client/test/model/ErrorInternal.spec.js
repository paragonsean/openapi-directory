...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ErrorInternal();
  });
  ...
  describe('ErrorInternal', function() {
    it('should create an instance of ErrorInternal', function() {
      // uncomment below and update the code to test ErrorInternal
      //var instance = new MessagesApi.ErrorInternal();
      //expect(instance).to.be.a(MessagesApi.ErrorInternal);
    });
