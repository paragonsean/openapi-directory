...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MessengerOneOf4();
  });
  ...
  describe('MessengerOneOf4', function() {
    it('should create an instance of MessengerOneOf4', function() {
      // uncomment below and update the code to test MessengerOneOf4
      //var instance = new MessagesApi.MessengerOneOf4();
      //expect(instance).to.be.a(MessagesApi.MessengerOneOf4);
    });
