...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ViberOneOf1();
  });
  ...
  describe('ViberOneOf1', function() {
    it('should create an instance of ViberOneOf1', function() {
      // uncomment below and update the code to test ViberOneOf1
      //var instance = new MessagesApi.ViberOneOf1();
      //expect(instance).to.be.a(MessagesApi.ViberOneOf1);
    });
