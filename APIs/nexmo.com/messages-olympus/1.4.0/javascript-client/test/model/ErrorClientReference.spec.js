...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ErrorClientReference();
  });
  ...
  describe('ErrorClientReference', function() {
    it('should create an instance of ErrorClientReference', function() {
      // uncomment below and update the code to test ErrorClientReference
      //var instance = new MessagesApi.ErrorClientReference();
      //expect(instance).to.be.a(MessagesApi.ErrorClientReference);
    });
