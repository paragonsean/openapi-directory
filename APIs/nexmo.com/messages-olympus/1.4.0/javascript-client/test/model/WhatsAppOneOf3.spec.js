...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.WhatsAppOneOf3();
  });
  ...
  describe('WhatsAppOneOf3', function() {
    it('should create an instance of WhatsAppOneOf3', function() {
      // uncomment below and update the code to test WhatsAppOneOf3
      //var instance = new MessagesApi.WhatsAppOneOf3();
      //expect(instance).to.be.a(MessagesApi.WhatsAppOneOf3);
    });
