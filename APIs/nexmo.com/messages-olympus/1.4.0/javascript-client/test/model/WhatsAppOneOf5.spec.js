...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.WhatsAppOneOf5();
  });
  ...
  describe('WhatsAppOneOf5', function() {
    it('should create an instance of WhatsAppOneOf5', function() {
      // uncomment below and update the code to test WhatsAppOneOf5
      //var instance = new MessagesApi.WhatsAppOneOf5();
      //expect(instance).to.be.a(MessagesApi.WhatsAppOneOf5);
    });
