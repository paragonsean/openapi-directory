...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MessageStatusBase();
  });
  ...
  describe('MessageStatusBase', function() {
    it('should create an instance of MessageStatusBase', function() {
      // uncomment below and update the code to test MessageStatusBase
      //var instance = new MessagesApi.MessageStatusBase();
      //expect(instance).to.be.a(MessagesApi.MessageStatusBase);
    });
