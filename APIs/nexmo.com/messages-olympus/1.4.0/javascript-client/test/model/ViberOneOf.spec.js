...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ViberOneOf();
  });
  ...
  describe('ViberOneOf', function() {
    it('should create an instance of ViberOneOf', function() {
      // uncomment below and update the code to test ViberOneOf
      //var instance = new MessagesApi.ViberOneOf();
      //expect(instance).to.be.a(MessagesApi.ViberOneOf);
    });
