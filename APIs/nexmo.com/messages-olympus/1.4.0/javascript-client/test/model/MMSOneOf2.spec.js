...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MMSOneOf2();
  });
  ...
  describe('MMSOneOf2', function() {
    it('should create an instance of MMSOneOf2', function() {
      // uncomment below and update the code to test MMSOneOf2
      //var instance = new MessagesApi.MMSOneOf2();
      //expect(instance).to.be.a(MessagesApi.MMSOneOf2);
    });
