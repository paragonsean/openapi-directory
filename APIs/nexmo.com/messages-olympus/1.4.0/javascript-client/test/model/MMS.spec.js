...
(function(root, factory) {
  ...
  describe('MMS', function() {
    it('should create an instance of MMS', function() {
      // uncomment below and update the code to test MMS
      //var instance = new MessagesApi.MMS();
      //expect(instance).to.be.a(MessagesApi.MMS);
    });
