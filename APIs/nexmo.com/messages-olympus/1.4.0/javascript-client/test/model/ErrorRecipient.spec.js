...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ErrorRecipient();
  });
  ...
  describe('ErrorRecipient', function() {
    it('should create an instance of ErrorRecipient', function() {
      // uncomment below and update the code to test ErrorRecipient
      //var instance = new MessagesApi.ErrorRecipient();
      //expect(instance).to.be.a(MessagesApi.ErrorRecipient);
    });
