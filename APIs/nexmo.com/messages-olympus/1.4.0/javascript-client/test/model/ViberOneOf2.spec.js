...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.ViberOneOf2();
  });
  ...
  describe('ViberOneOf2', function() {
    it('should create an instance of ViberOneOf2', function() {
      // uncomment below and update the code to test ViberOneOf2
      //var instance = new MessagesApi.ViberOneOf2();
      //expect(instance).to.be.a(MessagesApi.ViberOneOf2);
    });
