...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.WhatsAppOneOf2();
  });
  ...
  describe('WhatsAppOneOf2', function() {
    it('should create an instance of WhatsAppOneOf2', function() {
      // uncomment below and update the code to test WhatsAppOneOf2
      //var instance = new MessagesApi.WhatsAppOneOf2();
      //expect(instance).to.be.a(MessagesApi.WhatsAppOneOf2);
    });
