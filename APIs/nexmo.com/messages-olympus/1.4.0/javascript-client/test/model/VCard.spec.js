...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.VCard();
  });
  ...
  describe('VCard', function() {
    it('should create an instance of VCard', function() {
      // uncomment below and update the code to test VCard
      //var instance = new MessagesApi.VCard();
      //expect(instance).to.be.a(MessagesApi.VCard);
    });
