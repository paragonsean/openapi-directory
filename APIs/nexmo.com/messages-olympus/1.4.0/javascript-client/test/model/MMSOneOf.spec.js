...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.MMSOneOf();
  });
  ...
  describe('MMSOneOf', function() {
    it('should create an instance of MMSOneOf', function() {
      // uncomment below and update the code to test MMSOneOf
      //var instance = new MessagesApi.MMSOneOf();
      //expect(instance).to.be.a(MessagesApi.MMSOneOf);
    });
