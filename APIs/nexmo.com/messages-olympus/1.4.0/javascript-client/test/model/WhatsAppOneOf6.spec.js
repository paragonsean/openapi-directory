...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessagesApi.WhatsAppOneOf6();
  });
  ...
  describe('WhatsAppOneOf6', function() {
    it('should create an instance of WhatsAppOneOf6', function() {
      // uncomment below and update the code to test WhatsAppOneOf6
      //var instance = new MessagesApi.WhatsAppOneOf6();
      //expect(instance).to.be.a(MessagesApi.WhatsAppOneOf6);
    });
