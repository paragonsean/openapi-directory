...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.NiResponseJsonBasic();
  });
  ...
  describe('NiResponseJsonBasic', function() {
    it('should create an instance of NiResponseJsonBasic', function() {
      // uncomment below and update the code to test NiResponseJsonBasic
      //var instance = new NumberInsightApi.NiResponseJsonBasic();
      //expect(instance).to.be.a(NumberInsightApi.NiResponseJsonBasic);
    });
