...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.NiResponseJsonAdvancedRoamingUnknown();
  });
  ...
  describe('NiResponseJsonAdvancedRoamingUnknown', function() {
    it('should create an instance of NiResponseJsonAdvancedRoamingUnknown', function() {
      // uncomment below and update the code to test NiResponseJsonAdvancedRoamingUnknown
      //var instance = new NumberInsightApi.NiResponseJsonAdvancedRoamingUnknown();
      //expect(instance).to.be.a(NumberInsightApi.NiResponseJsonAdvancedRoamingUnknown);
    });
