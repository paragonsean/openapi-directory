...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.NiResponseAsync();
  });
  ...
  describe('NiResponseAsync', function() {
    it('should create an instance of NiResponseAsync', function() {
      // uncomment below and update the code to test NiResponseAsync
      //var instance = new NumberInsightApi.NiResponseAsync();
      //expect(instance).to.be.a(NumberInsightApi.NiResponseAsync);
    });
