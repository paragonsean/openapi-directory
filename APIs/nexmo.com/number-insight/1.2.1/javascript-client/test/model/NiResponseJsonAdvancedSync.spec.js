...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.NiResponseJsonAdvancedSync();
  });
  ...
  describe('NiResponseJsonAdvancedSync', function() {
    it('should create an instance of NiResponseJsonAdvancedSync', function() {
      // uncomment below and update the code to test NiResponseJsonAdvancedSync
      //var instance = new NumberInsightApi.NiResponseJsonAdvancedSync();
      //expect(instance).to.be.a(NumberInsightApi.NiResponseJsonAdvancedSync);
    });
