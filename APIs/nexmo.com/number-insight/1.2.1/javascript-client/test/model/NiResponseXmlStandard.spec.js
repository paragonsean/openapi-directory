...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.NiResponseXmlStandard();
  });
  ...
  describe('NiResponseXmlStandard', function() {
    it('should create an instance of NiResponseXmlStandard', function() {
      // uncomment below and update the code to test NiResponseXmlStandard
      //var instance = new NumberInsightApi.NiResponseXmlStandard();
      //expect(instance).to.be.a(NumberInsightApi.NiResponseXmlStandard);
    });
