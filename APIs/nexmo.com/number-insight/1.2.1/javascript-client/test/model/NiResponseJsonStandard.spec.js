...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.NiResponseJsonStandard();
  });
  ...
  describe('NiResponseJsonStandard', function() {
    it('should create an instance of NiResponseJsonStandard', function() {
      // uncomment below and update the code to test NiResponseJsonStandard
      //var instance = new NumberInsightApi.NiResponseJsonStandard();
      //expect(instance).to.be.a(NumberInsightApi.NiResponseJsonStandard);
    });
