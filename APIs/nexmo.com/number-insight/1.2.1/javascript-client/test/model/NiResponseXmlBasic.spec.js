...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.NiResponseXmlBasic();
  });
  ...
  describe('NiResponseXmlBasic', function() {
    it('should create an instance of NiResponseXmlBasic', function() {
      // uncomment below and update the code to test NiResponseXmlBasic
      //var instance = new NumberInsightApi.NiResponseXmlBasic();
      //expect(instance).to.be.a(NumberInsightApi.NiResponseXmlBasic);
    });
