...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.GetNumberInsightAdvanced200Response();
  });
  ...
  describe('GetNumberInsightAdvanced200Response', function() {
    it('should create an instance of GetNumberInsightAdvanced200Response', function() {
      // uncomment below and update the code to test GetNumberInsightAdvanced200Response
      //var instance = new NumberInsightApi.GetNumberInsightAdvanced200Response();
      //expect(instance).to.be.a(NumberInsightApi.GetNumberInsightAdvanced200Response);
    });
    ...
    it('should have the property lookupOutcomeMessage (base name: "lookup_outcome_message")', function() {
      // uncomment below and update the code to test the property lookupOutcomeMessage
      //var instance = new NumberInsightApi.GetNumberInsightAdvanced200Response();
      //expect(instance).to.be();
    });
    ...
    it('should have the property realTimeData (base name: "real_time_data")', function() {
      // uncomment below and update the code to test the property realTimeData
      //var instance = new NumberInsightApi.GetNumberInsightAdvanced200Response();
      //expect(instance).to.be();
    });
