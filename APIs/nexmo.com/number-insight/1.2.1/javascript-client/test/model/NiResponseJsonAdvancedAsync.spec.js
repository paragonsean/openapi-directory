...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.NiResponseJsonAdvancedAsync();
  });
  ...
  describe('NiResponseJsonAdvancedAsync', function() {
    it('should create an instance of NiResponseJsonAdvancedAsync', function() {
      // uncomment below and update the code to test NiResponseJsonAdvancedAsync
      //var instance = new NumberInsightApi.NiResponseJsonAdvancedAsync();
      //expect(instance).to.be.a(NumberInsightApi.NiResponseJsonAdvancedAsync);
    });
