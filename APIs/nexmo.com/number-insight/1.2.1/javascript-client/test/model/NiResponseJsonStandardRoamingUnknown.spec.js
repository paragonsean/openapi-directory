...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.NiResponseJsonStandardRoamingUnknown();
  });
  ...
  describe('NiResponseJsonStandardRoamingUnknown', function() {
    it('should create an instance of NiResponseJsonStandardRoamingUnknown', function() {
      // uncomment below and update the code to test NiResponseJsonStandardRoamingUnknown
      //var instance = new NumberInsightApi.NiResponseJsonStandardRoamingUnknown();
      //expect(instance).to.be.a(NumberInsightApi.NiResponseJsonStandardRoamingUnknown);
    });
