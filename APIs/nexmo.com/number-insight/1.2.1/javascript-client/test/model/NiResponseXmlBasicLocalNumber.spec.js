...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NumberInsightApi.NiResponseXmlBasicLocalNumber();
  });
  ...
  describe('NiResponseXmlBasicLocalNumber', function() {
    it('should create an instance of NiResponseXmlBasicLocalNumber', function() {
      // uncomment below and update the code to test NiResponseXmlBasicLocalNumber
      //var instance = new NumberInsightApi.NiResponseXmlBasicLocalNumber();
      //expect(instance).to.be.a(NumberInsightApi.NiResponseXmlBasicLocalNumber);
    });
