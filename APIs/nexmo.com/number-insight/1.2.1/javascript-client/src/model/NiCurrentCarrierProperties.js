...
/**
 * The NiCurrentCarrierProperties model module.
 * @module model/NiCurrentCarrierProperties
 * @version 1.2.1
 */
class NiCurrentCarrierProperties {
    /**
     * Constructs a new <code>NiCurrentCarrierProperties</code>.
     * Information about the network &#x60;number&#x60; is currently connected to.
     * @alias module:model/NiCurrentCarrierProperties
     */
    constructor() { 
        
        NiCurrentCarrierProperties.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NiCurrentCarrierProperties</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NiCurrentCarrierProperties} obj Optional instance to populate.
     * @return {module:model/NiCurrentCarrierProperties} The populated <code>NiCurrentCarrierProperties</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NiCurrentCarrierProperties();
    ...
    /**
     * Validates the JSON data with respect to <code>NiCurrentCarrierProperties</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NiCurrentCarrierProperties</code>.
     */
 ...
 */
NiCurrentCarrierProperties.prototype['country'] = undefined;

/**
 * The full name of the carrier that `number` is associated with.
 * @member {String} name
 */
NiCurrentCarrierProperties.prototype['name'] = undefined;
 ...
 */
NiCurrentCarrierProperties.prototype['network_code'] = undefined;

/**
 * The type of network that `number` is associated with.
 * @member {module:model/NiCurrentCarrierProperties.NetworkTypeEnum} network_type
 */
NiCurrentCarrierProperties.prototype['network_type'] = undefined;
 ...
 * @readonly
 */
NiCurrentCarrierProperties['NetworkTypeEnum'] = {
...
export default NiCurrentCarrierProperties;
