...
/**
 * The NiResponseJsonAdvancedAsync model module.
 * @module model/NiResponseJsonAdvancedAsync
 * @version 1.2.1
 */
class NiResponseJsonAdvancedAsync {
    /**
     * Constructs a new <code>NiResponseJsonAdvancedAsync</code>.
     * Advanced Response (Async)
     * @alias module:model/NiResponseJsonAdvancedAsync
    ...
    constructor(countryCode, countryCodeIso3, countryName, countryPrefix, internationalFormatNumber, nationalFormatNumber, requestId, status, statusMessage) { 
        ...
        NiResponseJsonAdvancedAsync.initialize(this, countryCode, countryCodeIso3, countryName, countryPrefix, internationalFormatNumber, nationalFormatNumber, requestId, status, statusMessage);
    }
    ...
    /**
     * Constructs a <code>NiResponseJsonAdvancedAsync</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NiResponseJsonAdvancedAsync} obj Optional instance to populate.
     * @return {module:model/NiResponseJsonAdvancedAsync} The populated <code>NiResponseJsonAdvancedAsync</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NiResponseJsonAdvancedAsync();
    ...
    /**
     * Validates the JSON data with respect to <code>NiResponseJsonAdvancedAsync</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NiResponseJsonAdvancedAsync</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NiResponseJsonAdvancedAsync.RequiredProperties) {
...
NiResponseJsonAdvancedAsync.RequiredProperties = ["country_code", "country_code_iso3", "country_name", "country_prefix", "international_format_number", "national_format_number", "request_id", "status", "status_message"];

/**
 * @member {module:model/NiCallerIdentity} caller_identity
 */
NiResponseJsonAdvancedAsync.prototype['caller_identity'] = undefined;
 ...
 */
NiResponseJsonAdvancedAsync.prototype['country_code'] = undefined;
 ...
 * @member {module:model/NiResponseJsonAdvancedAsync.LookupOutcomeEnum} lookup_outcome
 */
NiResponseJsonAdvancedAsync.prototype['lookup_outcome'] = undefined;

/**
 * Shows if all information about a phone number has been returned.
 * @member {String} lookup_outcome_message
 */
NiResponseJsonAdvancedAsync.prototype['lookup_outcome_message'] = undefined;

/**
 * The `number` in your request in the format used by the country the number belongs to.
 * @member {String} national_format_number
 */
NiResponseJsonAdvancedAsync.prototype['national_format_number'] = undefined;

/**
 * @member {module:model/NiInitialCarrierProperties} original_carrier
 */
NiResponseJsonAdvancedAsync.prototype['original_carrier'] = undefined;
 ...
 * @member {module:model/NiResponseJsonAdvancedAsync.PortedEnum} ported
 */
NiResponseJsonAdvancedAsync.prototype['ported'] = undefined;

/**
 * Can you call `number` now. This is applicable to mobile numbers only.
 * @member {module:model/NiResponseJsonAdvancedAsync.ReachableEnum} reachable
 */
NiResponseJsonAdvancedAsync.prototype['reachable'] = undefined;
 ...
 */
NiResponseJsonAdvancedAsync.prototype['refund_price'] = undefined;

/**
 * Your account balance in EUR after this request.
 * @member {String} remaining_balance
 */
NiResponseJsonAdvancedAsync.prototype['remaining_balance'] = undefined;

/**
 * The unique identifier for your request. This is a alphanumeric string up to 40 characters.
 * @member {String} request_id
 */
NiResponseJsonAdvancedAsync.prototype['request_id'] = undefined;

/**
 * The amount in EUR charged to your account.
 * @member {String} request_price
 */
NiResponseJsonAdvancedAsync.prototype['request_price'] = undefined;

/**
 * @member {module:model/NiRoaming} roaming
 */
NiResponseJsonAdvancedAsync.prototype['roaming'] = undefined;

/**
 * @member {module:model/NiStandardAdvancedStatus} status
 */
NiResponseJsonAdvancedAsync.prototype['status'] = undefined;

/**
 * The status description of your request.
 * @member {String} status_message
 */
NiResponseJsonAdvancedAsync.prototype['status_message'] = undefined;
 ...
 * @member {module:model/NiResponseJsonAdvancedAsync.ValidNumberEnum} valid_number
 */
NiResponseJsonAdvancedAsync.prototype['valid_number'] = undefined;
 ...
 * @readonly
 */
NiResponseJsonAdvancedAsync['LookupOutcomeEnum'] = {
 ...
 * @readonly
 */
NiResponseJsonAdvancedAsync['PortedEnum'] = {
 ...
 * @readonly
 */
NiResponseJsonAdvancedAsync['ReachableEnum'] = {
 ...
 * @readonly
 */
NiResponseJsonAdvancedAsync['ValidNumberEnum'] = {
...
export default NiResponseJsonAdvancedAsync;
