...
/**
 * The NiResponseXmlAdvancedLocalNumber model module.
 * @module model/NiResponseXmlAdvancedLocalNumber
 * @version 1.2.1
 */
class NiResponseXmlAdvancedLocalNumber {
    /**
     * Constructs a new <code>NiResponseXmlAdvancedLocalNumber</code>.
     * An object containing the &#x60;number&#x60; in your request in the format used by the country the number belongs to.
     * @alias module:model/NiResponseXmlAdvancedLocalNumber
     */
    constructor() { 
        
        NiResponseXmlAdvancedLocalNumber.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NiResponseXmlAdvancedLocalNumber</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NiResponseXmlAdvancedLocalNumber} obj Optional instance to populate.
     * @return {module:model/NiResponseXmlAdvancedLocalNumber} The populated <code>NiResponseXmlAdvancedLocalNumber</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NiResponseXmlAdvancedLocalNumber();
    ...
    /**
     * Validates the JSON data with respect to <code>NiResponseXmlAdvancedLocalNumber</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NiResponseXmlAdvancedLocalNumber</code>.
     */
 ...
 */
NiResponseXmlAdvancedLocalNumber.prototype['country_code'] = undefined;
 ...
 */
NiResponseXmlAdvancedLocalNumber.prototype['country_code_iso3'] = undefined;

/**
 * The full name of the country that `number` is registered in.
 * @member {String} country_name
 */
NiResponseXmlAdvancedLocalNumber.prototype['country_name'] = undefined;

/**
 * The numeric prefix for the country that `number` is registered in.
 * @member {String} country_prefix
 */
NiResponseXmlAdvancedLocalNumber.prototype['country_prefix'] = undefined;

/**
 * The `number` in your request in the format used by the country the number belongs to.
 * @member {String} number
 */
NiResponseXmlAdvancedLocalNumber.prototype['number'] = undefined;
...
export default NiResponseXmlAdvancedLocalNumber;
