...
/**
 * The NiResponseJsonAdvancedRoamingUnknown model module.
 * @module model/NiResponseJsonAdvancedRoamingUnknown
 * @version 1.2.1
 */
class NiResponseJsonAdvancedRoamingUnknown {
    /**
     * Constructs a new <code>NiResponseJsonAdvancedRoamingUnknown</code>.
     * Unknown Roaming
     * @alias module:model/NiResponseJsonAdvancedRoamingUnknown
    ...
    constructor(countryCode, countryCodeIso3, countryName, countryPrefix, internationalFormatNumber, nationalFormatNumber, requestId, status, statusMessage) { 
        ...
        NiResponseJsonAdvancedRoamingUnknown.initialize(this, countryCode, countryCodeIso3, countryName, countryPrefix, internationalFormatNumber, nationalFormatNumber, requestId, status, statusMessage);
    }
    ...
    /**
     * Constructs a <code>NiResponseJsonAdvancedRoamingUnknown</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NiResponseJsonAdvancedRoamingUnknown} obj Optional instance to populate.
     * @return {module:model/NiResponseJsonAdvancedRoamingUnknown} The populated <code>NiResponseJsonAdvancedRoamingUnknown</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NiResponseJsonAdvancedRoamingUnknown();
            ...
            if (data.hasOwnProperty('roaming')) {
                obj['roaming'] = ApiClient.convertToType(data['roaming'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>NiResponseJsonAdvancedRoamingUnknown</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NiResponseJsonAdvancedRoamingUnknown</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NiResponseJsonAdvancedRoamingUnknown.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['roaming'] && !(typeof data['roaming'] === 'string' || data['roaming'] instanceof String)) {
            throw new Error("Expected the field `roaming` to be a primitive type in the JSON string but got " + data['roaming']);
        }
        // ensure the json data is a string
...
NiResponseJsonAdvancedRoamingUnknown.RequiredProperties = ["country_code", "country_code_iso3", "country_name", "country_prefix", "international_format_number", "national_format_number", "request_id", "status", "status_message"];

/**
 * @member {module:model/NiCallerIdentity} caller_identity
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['caller_identity'] = undefined;
 ...
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['country_code'] = undefined;
 ...
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['country_code_iso3'] = undefined;

/**
 * The full name of the country that `number` is registered in.
 * @member {String} country_name
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['country_name'] = undefined;

/**
 * The numeric prefix for the country that `number` is registered in.
 * @member {String} country_prefix
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['country_prefix'] = undefined;

/**
 * @member {module:model/NiCurrentCarrierProperties} current_carrier
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['current_carrier'] = undefined;

/**
 * The `number` in your request in international format.
 * @member {String} international_format_number
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['international_format_number'] = undefined;
 ...
 * @member {module:model/NiResponseJsonAdvancedRoamingUnknown.LookupOutcomeEnum} lookup_outcome
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['lookup_outcome'] = undefined;

/**
 * Shows if all information about a phone number has been returned.
 * @member {String} lookup_outcome_message
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['lookup_outcome_message'] = undefined;

/**
 * The `number` in your request in the format used by the country the number belongs to.
 * @member {String} national_format_number
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['national_format_number'] = undefined;

/**
 * @member {module:model/NiInitialCarrierProperties} original_carrier
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['original_carrier'] = undefined;
 ...
 * @member {module:model/NiResponseJsonAdvancedRoamingUnknown.PortedEnum} ported
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['ported'] = undefined;

/**
 * Can you call `number` now. This is applicable to mobile numbers only.
 * @member {module:model/NiResponseJsonAdvancedRoamingUnknown.ReachableEnum} reachable
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['reachable'] = undefined;
 ...
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['refund_price'] = undefined;

/**
 * Your account balance in EUR after this request.
 * @member {String} remaining_balance
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['remaining_balance'] = undefined;

/**
 * The unique identifier for your request. This is a alphanumeric string up to 40 characters.
 * @member {String} request_id
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['request_id'] = undefined;

/**
 * The amount in EUR charged to your account.
 * @member {String} request_price
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['request_price'] = undefined;

/**
 * @member {module:model/NiResponseJsonAdvancedRoamingUnknown.RoamingEnum} roaming
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['roaming'] = undefined;

/**
 * @member {module:model/NiStandardAdvancedStatus} status
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['status'] = undefined;

/**
 * The status description of your request.
 * @member {String} status_message
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['status_message'] = undefined;
 ...
 * @member {module:model/NiResponseJsonAdvancedRoamingUnknown.ValidNumberEnum} valid_number
 */
NiResponseJsonAdvancedRoamingUnknown.prototype['valid_number'] = undefined;
 ...
 * @readonly
 */
NiResponseJsonAdvancedRoamingUnknown['LookupOutcomeEnum'] = {
 ...
 * @readonly
 */
NiResponseJsonAdvancedRoamingUnknown['PortedEnum'] = {
 ...
 * @readonly
 */
NiResponseJsonAdvancedRoamingUnknown['ReachableEnum'] = {
...
/**
 * Allowed values for the <code>roaming</code> property.
 * @enum {String}
 * @readonly
 */
NiResponseJsonAdvancedRoamingUnknown['RoamingEnum'] = {
 ...
 * @readonly
 */
NiResponseJsonAdvancedRoamingUnknown['ValidNumberEnum'] = {
...
export default NiResponseJsonAdvancedRoamingUnknown;
