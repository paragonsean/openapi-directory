...
/**
 * The NiResponseJsonStandardRoamingUnknown model module.
 * @module model/NiResponseJsonStandardRoamingUnknown
 * @version 1.2.1
 */
class NiResponseJsonStandardRoamingUnknown {
    /**
     * Constructs a new <code>NiResponseJsonStandardRoamingUnknown</code>.
     * Unknown Roaming
     * @alias module:model/NiResponseJsonStandardRoamingUnknown
     * @implements module:model/NiResponseJsonBasic
     */
    constructor() { 
        NiResponseJsonBasic.initialize(this);
        NiResponseJsonStandardRoamingUnknown.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NiResponseJsonStandardRoamingUnknown</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NiResponseJsonStandardRoamingUnknown} obj Optional instance to populate.
     * @return {module:model/NiResponseJsonStandardRoamingUnknown} The populated <code>NiResponseJsonStandardRoamingUnknown</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NiResponseJsonStandardRoamingUnknown();
    ...
    /**
     * Validates the JSON data with respect to <code>NiResponseJsonStandardRoamingUnknown</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NiResponseJsonStandardRoamingUnknown</code>.
     */
 ...
 */
NiResponseJsonStandardRoamingUnknown.prototype['country_code'] = undefined;
 ...
 */
NiResponseJsonStandardRoamingUnknown.prototype['country_code_iso3'] = undefined;

/**
 * The full name of the country that `number` is registered in.
 * @member {String} country_name
 */
NiResponseJsonStandardRoamingUnknown.prototype['country_name'] = undefined;

/**
 * The numeric prefix for the country that `number` is registered in.
 * @member {String} country_prefix
 */
NiResponseJsonStandardRoamingUnknown.prototype['country_prefix'] = undefined;

/**
 * The `number` in your request in international format.
 * @member {String} international_format_number
 */
NiResponseJsonStandardRoamingUnknown.prototype['international_format_number'] = undefined;

/**
 * The `number` in your request in the format used by the country the number belongs to.
 * @member {String} national_format_number
 */
NiResponseJsonStandardRoamingUnknown.prototype['national_format_number'] = undefined;

/**
 * The unique identifier for your request. This is a alphanumeric string up to 40 characters.
 * @member {String} request_id
 */
NiResponseJsonStandardRoamingUnknown.prototype['request_id'] = undefined;

/**
 * @member {module:model/NiBasicStatus} status
 */
NiResponseJsonStandardRoamingUnknown.prototype['status'] = undefined;

/**
 * The status description of your request.
 * @member {String} status_message
 */
NiResponseJsonStandardRoamingUnknown.prototype['status_message'] = undefined;

/**
 * @member {module:model/NiCallerIdentity} caller_identity
 */
NiResponseJsonStandardRoamingUnknown.prototype['caller_identity'] = undefined;
 ...
 */
NiResponseJsonStandardRoamingUnknown.prototype['caller_name'] = undefined;
 ...
 * @member {module:model/NiResponseJsonStandardRoamingUnknown.CallerTypeEnum} caller_type
 */
NiResponseJsonStandardRoamingUnknown.prototype['caller_type'] = undefined;

/**
 * @member {module:model/NiCurrentCarrierProperties} current_carrier
 */
NiResponseJsonStandardRoamingUnknown.prototype['current_carrier'] = undefined;
 ...
 */
NiResponseJsonStandardRoamingUnknown.prototype['first_name'] = undefined;
 ...
 */
NiResponseJsonStandardRoamingUnknown.prototype['last_name'] = undefined;

/**
 * @member {module:model/NiInitialCarrierProperties} original_carrier
 */
NiResponseJsonStandardRoamingUnknown.prototype['original_carrier'] = undefined;
 ...
 * @member {module:model/NiResponseJsonStandardRoamingUnknown.PortedEnum} ported
 */
NiResponseJsonStandardRoamingUnknown.prototype['ported'] = undefined;
 ...
 */
NiResponseJsonStandardRoamingUnknown.prototype['refund_price'] = undefined;

/**
 * Your account balance in EUR after this request.
 * @member {String} remaining_balance
 */
NiResponseJsonStandardRoamingUnknown.prototype['remaining_balance'] = undefined;

/**
 * The amount in EUR charged to your account.
 * @member {String} request_price
 */
NiResponseJsonStandardRoamingUnknown.prototype['request_price'] = undefined;
 ...
 * @readonly
 */
NiResponseJsonStandardRoamingUnknown['CallerTypeEnum'] = {
 ...
 * @readonly
 */
NiResponseJsonStandardRoamingUnknown['PortedEnum'] = {
...
export default NiResponseJsonStandardRoamingUnknown;
