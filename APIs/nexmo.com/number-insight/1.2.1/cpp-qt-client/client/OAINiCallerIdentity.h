...
/*
 * OAINiCallerIdentity.h
 *
 * Information about the network &#x60;number&#x60; is currently connected to.
 */

#ifndef OAINiCallerIdentity_H
#define OAINiCallerIdentity_H
...
class OAINiCallerIdentity : public OAIObject {
public:
    OAINiCallerIdentity();
    OAINiCallerIdentity(QString json);
    ~OAINiCallerIdentity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINiCallerIdentity)

#endif // OAINiCallerIdentity_H
