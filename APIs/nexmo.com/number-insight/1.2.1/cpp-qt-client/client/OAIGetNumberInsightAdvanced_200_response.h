...
/*
 * OAIGetNumberInsightAdvanced_200_response.h
 *
 * 
 */

#ifndef OAIGetNumberInsightAdvanced_200_response_H
#define OAIGetNumberInsightAdvanced_200_response_H
...
#include "OAINiResponseJsonAdvancedRoamingUnknown.h"
#include "OAINiResponseJsonAdvancedSync.h"
...
class OAINiRealtimeData;

class OAIGetNumberInsightAdvanced_200_response : public OAIObject {
public:
    OAIGetNumberInsightAdvanced_200_response();
    OAIGetNumberInsightAdvanced_200_response(QString json);
    ~OAIGetNumberInsightAdvanced_200_response() override;
    ...
    OAINiRealtimeData getRealTimeData() const;
    void setRealTimeData(const OAINiRealtimeData &real_time_data);
    bool is_real_time_data_Set() const;
    bool is_real_time_data_Valid() const;
    ...
    QString getRoaming() const;
    void setRoaming(const QString &roaming);
...
private:
    ...
    OAINiRealtimeData m_real_time_data;
    bool m_real_time_data_isSet;
    bool m_real_time_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetNumberInsightAdvanced_200_response)

#endif // OAIGetNumberInsightAdvanced_200_response_H
