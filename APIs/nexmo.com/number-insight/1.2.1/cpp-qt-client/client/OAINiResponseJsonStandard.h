...
/*
 * OAINiResponseJsonStandard.h
 *
 * Standard Response
 */

#ifndef OAINiResponseJsonStandard_H
#define OAINiResponseJsonStandard_H
...
class OAINiResponseJsonStandard : public OAIObject {
public:
    OAINiResponseJsonStandard();
    OAINiResponseJsonStandard(QString json);
    ~OAINiResponseJsonStandard() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINiResponseJsonStandard)

#endif // OAINiResponseJsonStandard_H
