...
/*
 * OAINiInitialCarrierProperties.h
 *
 * Information about the network &#x60;number&#x60; was initially connected to.
 */

#ifndef OAINiInitialCarrierProperties_H
#define OAINiInitialCarrierProperties_H
...
class OAINiInitialCarrierProperties : public OAIObject {
public:
    OAINiInitialCarrierProperties();
    OAINiInitialCarrierProperties(QString json);
    ~OAINiInitialCarrierProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINiInitialCarrierProperties)

#endif // OAINiInitialCarrierProperties_H
