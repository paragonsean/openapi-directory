...
/*
 * OAINiResponseXmlAdvanced_local_number.h
 *
 * An object containing the &#x60;number&#x60; in your request in the format used by the country the number belongs to.
 */

#ifndef OAINiResponseXmlAdvanced_local_number_H
#define OAINiResponseXmlAdvanced_local_number_H
...
class OAINiResponseXmlAdvanced_local_number : public OAIObject {
public:
    OAINiResponseXmlAdvanced_local_number();
    OAINiResponseXmlAdvanced_local_number(QString json);
    ~OAINiResponseXmlAdvanced_local_number() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINiResponseXmlAdvanced_local_number)

#endif // OAINiResponseXmlAdvanced_local_number_H
