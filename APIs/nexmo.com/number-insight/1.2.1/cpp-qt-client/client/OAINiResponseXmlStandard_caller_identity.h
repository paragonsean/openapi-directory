...
/*
 * OAINiResponseXmlStandard_caller_identity.h
 *
 * Contains details of the number owner, if &#x60;cnam&#x60; was set to &#x60;true&#x60; in the request.
 */

#ifndef OAINiResponseXmlStandard_caller_identity_H
#define OAINiResponseXmlStandard_caller_identity_H
...
class OAINiResponseXmlStandard_caller_identity : public OAIObject {
public:
    OAINiResponseXmlStandard_caller_identity();
    OAINiResponseXmlStandard_caller_identity(QString json);
    ~OAINiResponseXmlStandard_caller_identity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINiResponseXmlStandard_caller_identity)

#endif // OAINiResponseXmlStandard_caller_identity_H
