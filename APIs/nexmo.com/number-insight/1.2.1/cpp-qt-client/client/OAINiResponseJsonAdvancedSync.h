...
/*
 * OAINiResponseJsonAdvancedSync.h
 *
 * Advanced Response (sync)
 */

#ifndef OAINiResponseJsonAdvancedSync_H
#define OAINiResponseJsonAdvancedSync_H
...
class OAINiResponseJsonAdvancedSync : public OAIObject {
public:
    OAINiResponseJsonAdvancedSync();
    OAINiResponseJsonAdvancedSync(QString json);
    ~OAINiResponseJsonAdvancedSync() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINiResponseJsonAdvancedSync)

#endif // OAINiResponseJsonAdvancedSync_H
