...
class NiResponseAsync(Model):
    ...
    def __init__(self, error_text: str=None, number: str=None, remaining_balance: str=None, request_id: str=None, request_price: str=None, status: NiStandardAdvancedStatus=None):
        """NiResponseAsync - a model defined in OpenAPI

        :param error_text: The error_text of this NiResponseAsync.
        :param number: The number of this NiResponseAsync.
        :param remaining_balance: The remaining_balance of this NiResponseAsync.
        :param request_id: The request_id of this NiResponseAsync.
        :param request_price: The request_price of this NiResponseAsync.
        :param status: The status of this NiResponseAsync.
        """
        self.openapi_types = {
            'error_text': str,
            'number': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'NiResponseAsync':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The niResponseAsync of this NiResponseAsync.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def error_text(self):
        """Gets the error_text of this NiResponseAsync.

        The status description of your request. Note: This field is equivalent to `status_message` field in the other endpoints

        :return: The error_text of this NiResponseAsync.
        :rtype: str
        """
    ...
    def error_text(self, error_text):
        """Sets the error_text of this NiResponseAsync.
    ...
    @property
    def number(self):
        """Gets the number of this NiResponseAsync.

        The `number` in your request

        :return: The number of this NiResponseAsync.
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this NiResponseAsync.
    ...
    def remaining_balance(self):
        """Gets the remaining_balance of this NiResponseAsync.

        Your account balance in EUR after this request.

        :return: The remaining_balance of this NiResponseAsync.
        :rtype: str
        """
    ...
    def remaining_balance(self, remaining_balance):
        """Sets the remaining_balance of this NiResponseAsync.
    ...
    @property
    def request_id(self):
        """Gets the request_id of this NiResponseAsync.

        The unique identifier for your request. This is a alphanumeric string up to 40 characters.

        :return: The request_id of this NiResponseAsync.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        """Sets the request_id of this NiResponseAsync.
    ...
    def request_price(self):
        """Gets the request_price of this NiResponseAsync.
        ...
        :return: The request_price of this NiResponseAsync.
        :rtype: str
        """
    ...
    def request_price(self, request_price):
        """Sets the request_price of this NiResponseAsync.
    ...
    @property
    def status(self):
        """Gets the status of this NiResponseAsync.


        :return: The status of this NiResponseAsync.
    ...
    def status(self, status):
        """Sets the status of this NiResponseAsync.
