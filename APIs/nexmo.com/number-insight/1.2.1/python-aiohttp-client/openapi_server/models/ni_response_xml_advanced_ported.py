...
class NiResponseXmlAdvancedPorted(Model):
    ...
    def __init__(self, ported_message: str=None):
        """NiResponseXmlAdvancedPorted - a model defined in OpenAPI

        :param ported_message: The ported_message of this NiResponseXmlAdvancedPorted.
        """
        self.openapi_types = {
            'ported_message': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'NiResponseXmlAdvancedPorted':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The niResponseXmlAdvanced_ported of this NiResponseXmlAdvancedPorted.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def ported_message(self):
        """Gets the ported_message of this NiResponseXmlAdvancedPorted.
        ...
        :return: The ported_message of this NiResponseXmlAdvancedPorted.
        :rtype: str
        """
    ...
    def ported_message(self, ported_message):
        """Sets the ported_message of this NiResponseXmlAdvancedPorted.
