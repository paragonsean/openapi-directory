...
public class NiResponseXmlStandardCallerIdentity {
  ...
  public NiResponseXmlStandardCallerIdentity() {
  }

  public NiResponseXmlStandardCallerIdentity callerName(String callerName) {
  ...
  public NiResponseXmlStandardCallerIdentity callerType(CallerTypeEnum callerType) {
  ...
  public NiResponseXmlStandardCallerIdentity firsName(String firsName) {
  ...
  public NiResponseXmlStandardCallerIdentity firstName(String firstName) {
  ...
  public NiResponseXmlStandardCallerIdentity lastName(String lastName) {
  ...
  public boolean equals(Object o) {
    ...
    NiResponseXmlStandardCallerIdentity niResponseXmlStandardCallerIdentity = (NiResponseXmlStandardCallerIdentity) o;
    return Objects.equals(this.callerName, niResponseXmlStandardCallerIdentity.callerName) &&
        Objects.equals(this.callerType, niResponseXmlStandardCallerIdentity.callerType) &&
        Objects.equals(this.callerName, niResponseXmlStandardCallerIdentity.callerName) &&
        Objects.equals(this.callerType, niResponseXmlStandardCallerIdentity.callerType) &&
        Objects.equals(this.firsName, niResponseXmlStandardCallerIdentity.firsName) &&
        Objects.equals(this.firstName, niResponseXmlStandardCallerIdentity.firstName) &&
        Objects.equals(this.lastName, niResponseXmlStandardCallerIdentity.lastName) &&
        Objects.equals(this.lastName, niResponseXmlStandardCallerIdentity.lastName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(callerName, callerType, callerName, callerType, firsName, firstName, lastName, lastName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NiResponseXmlStandardCallerIdentity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NiResponseXmlStandardCallerIdentity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NiResponseXmlStandardCallerIdentity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NiResponseXmlStandardCallerIdentity is not found in the empty JSON string", NiResponseXmlStandardCallerIdentity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NiResponseXmlStandardCallerIdentity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NiResponseXmlStandardCallerIdentity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NiResponseXmlStandardCallerIdentity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NiResponseXmlStandardCallerIdentity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NiResponseXmlStandardCallerIdentity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NiResponseXmlStandardCallerIdentity.class));

       return (TypeAdapter<T>) new TypeAdapter<NiResponseXmlStandardCallerIdentity>() {
           @Override
           public void write(JsonWriter out, NiResponseXmlStandardCallerIdentity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NiResponseXmlStandardCallerIdentity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NiResponseXmlStandardCallerIdentity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NiResponseXmlStandardCallerIdentity
   * @throws IOException if the JSON string is invalid with respect to NiResponseXmlStandardCallerIdentity
   */
  public static NiResponseXmlStandardCallerIdentity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NiResponseXmlStandardCallerIdentity.class);
  }

  /**
   * Convert an instance of NiResponseXmlStandardCallerIdentity to an JSON string
   *
   * @return JSON string
   */
