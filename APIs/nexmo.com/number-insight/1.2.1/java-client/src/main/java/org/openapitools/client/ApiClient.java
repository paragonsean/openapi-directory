...
public class ApiClient {
    ...
    private String basePath = "https://api.nexmo.com/ni";
    ...
    public ApiClient() {
        ...
        authentications.put("apiSecret", new ApiKeyAuth("query", "api_secret"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.nexmo.com/ni
