...
public class NiResponseJsonStandardRoamingUnknown {
  ...
  public NiResponseJsonStandardRoamingUnknown() {
  }

  public NiResponseJsonStandardRoamingUnknown countryCode(String countryCode) {
  ...
  public NiResponseJsonStandardRoamingUnknown countryCodeIso3(String countryCodeIso3) {
  ...
  public NiResponseJsonStandardRoamingUnknown countryName(String countryName) {
  ...
  public NiResponseJsonStandardRoamingUnknown countryPrefix(String countryPrefix) {
  ...
  public NiResponseJsonStandardRoamingUnknown internationalFormatNumber(String internationalFormatNumber) {
  ...
  public NiResponseJsonStandardRoamingUnknown nationalFormatNumber(String nationalFormatNumber) {
  ...
  public NiResponseJsonStandardRoamingUnknown requestId(String requestId) {
  ...
  public NiResponseJsonStandardRoamingUnknown status(NiBasicStatus status) {
    this.status = status;
    return this;
  }
  ...
  public NiResponseJsonStandardRoamingUnknown statusMessage(String statusMessage) {
  ...
  public NiResponseJsonStandardRoamingUnknown callerIdentity(NiCallerIdentity callerIdentity) {
  ...
  public NiResponseJsonStandardRoamingUnknown callerName(String callerName) {
  ...
  public NiResponseJsonStandardRoamingUnknown callerType(CallerTypeEnum callerType) {
  ...
  public NiResponseJsonStandardRoamingUnknown currentCarrier(NiCurrentCarrierProperties currentCarrier) {
  ...
  public NiResponseJsonStandardRoamingUnknown firstName(String firstName) {
  ...
  public NiResponseJsonStandardRoamingUnknown lastName(String lastName) {
  ...
  public NiResponseJsonStandardRoamingUnknown originalCarrier(NiInitialCarrierProperties originalCarrier) {
  ...
  public NiResponseJsonStandardRoamingUnknown ported(PortedEnum ported) {
    this.ported = ported;
    return this;
  }
  ...
  public NiResponseJsonStandardRoamingUnknown refundPrice(String refundPrice) {
  ...
  public NiResponseJsonStandardRoamingUnknown remainingBalance(String remainingBalance) {
  ...
  public NiResponseJsonStandardRoamingUnknown requestPrice(String requestPrice) {
  ...
  public boolean equals(Object o) {
    ...
    NiResponseJsonStandardRoamingUnknown niResponseJsonStandardRoamingUnknown = (NiResponseJsonStandardRoamingUnknown) o;
    return Objects.equals(this.countryCode, niResponseJsonStandardRoamingUnknown.countryCode) &&
        Objects.equals(this.countryCodeIso3, niResponseJsonStandardRoamingUnknown.countryCodeIso3) &&
        Objects.equals(this.countryName, niResponseJsonStandardRoamingUnknown.countryName) &&
        Objects.equals(this.countryPrefix, niResponseJsonStandardRoamingUnknown.countryPrefix) &&
        Objects.equals(this.internationalFormatNumber, niResponseJsonStandardRoamingUnknown.internationalFormatNumber) &&
        Objects.equals(this.nationalFormatNumber, niResponseJsonStandardRoamingUnknown.nationalFormatNumber) &&
        Objects.equals(this.requestId, niResponseJsonStandardRoamingUnknown.requestId) &&
        Objects.equals(this.status, niResponseJsonStandardRoamingUnknown.status) &&
        Objects.equals(this.statusMessage, niResponseJsonStandardRoamingUnknown.statusMessage) &&
        Objects.equals(this.callerIdentity, niResponseJsonStandardRoamingUnknown.callerIdentity) &&
        Objects.equals(this.callerName, niResponseJsonStandardRoamingUnknown.callerName) &&
        Objects.equals(this.callerType, niResponseJsonStandardRoamingUnknown.callerType) &&
        Objects.equals(this.currentCarrier, niResponseJsonStandardRoamingUnknown.currentCarrier) &&
        Objects.equals(this.firstName, niResponseJsonStandardRoamingUnknown.firstName) &&
        Objects.equals(this.lastName, niResponseJsonStandardRoamingUnknown.lastName) &&
        Objects.equals(this.originalCarrier, niResponseJsonStandardRoamingUnknown.originalCarrier) &&
        Objects.equals(this.ported, niResponseJsonStandardRoamingUnknown.ported) &&
        Objects.equals(this.refundPrice, niResponseJsonStandardRoamingUnknown.refundPrice) &&
        Objects.equals(this.remainingBalance, niResponseJsonStandardRoamingUnknown.remainingBalance) &&
        Objects.equals(this.requestPrice, niResponseJsonStandardRoamingUnknown.requestPrice);
  }
  ...
  public String toString() {
    ...
    sb.append("class NiResponseJsonStandardRoamingUnknown {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NiResponseJsonStandardRoamingUnknown
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NiResponseJsonStandardRoamingUnknown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NiResponseJsonStandardRoamingUnknown is not found in the empty JSON string", NiResponseJsonStandardRoamingUnknown.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NiResponseJsonStandardRoamingUnknown.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NiResponseJsonStandardRoamingUnknown` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NiResponseJsonStandardRoamingUnknown.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NiResponseJsonStandardRoamingUnknown' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NiResponseJsonStandardRoamingUnknown> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NiResponseJsonStandardRoamingUnknown.class));

       return (TypeAdapter<T>) new TypeAdapter<NiResponseJsonStandardRoamingUnknown>() {
           @Override
           public void write(JsonWriter out, NiResponseJsonStandardRoamingUnknown value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NiResponseJsonStandardRoamingUnknown read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NiResponseJsonStandardRoamingUnknown given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NiResponseJsonStandardRoamingUnknown
   * @throws IOException if the JSON string is invalid with respect to NiResponseJsonStandardRoamingUnknown
   */
  public static NiResponseJsonStandardRoamingUnknown fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NiResponseJsonStandardRoamingUnknown.class);
  }

  /**
   * Convert an instance of NiResponseJsonStandardRoamingUnknown to an JSON string
   *
   * @return JSON string
   */
