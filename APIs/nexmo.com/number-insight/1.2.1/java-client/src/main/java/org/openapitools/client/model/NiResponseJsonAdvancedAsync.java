...
public class NiResponseJsonAdvancedAsync {
  ...
  public NiResponseJsonAdvancedAsync() {
  }

  public NiResponseJsonAdvancedAsync callerIdentity(NiCallerIdentity callerIdentity) {
  ...
  public NiResponseJsonAdvancedAsync countryCode(String countryCode) {
  ...
  public NiResponseJsonAdvancedAsync countryCodeIso3(String countryCodeIso3) {
  ...
  public NiResponseJsonAdvancedAsync countryName(String countryName) {
  ...
  public NiResponseJsonAdvancedAsync countryPrefix(String countryPrefix) {
  ...
  public NiResponseJsonAdvancedAsync currentCarrier(NiCurrentCarrierProperties currentCarrier) {
  ...
  public NiResponseJsonAdvancedAsync internationalFormatNumber(String internationalFormatNumber) {
  ...
  public NiResponseJsonAdvancedAsync lookupOutcome(LookupOutcomeEnum lookupOutcome) {
  ...
  public NiResponseJsonAdvancedAsync lookupOutcomeMessage(String lookupOutcomeMessage) {
  ...
  public NiResponseJsonAdvancedAsync nationalFormatNumber(String nationalFormatNumber) {
  ...
  public NiResponseJsonAdvancedAsync originalCarrier(NiInitialCarrierProperties originalCarrier) {
  ...
  public NiResponseJsonAdvancedAsync ported(PortedEnum ported) {
    this.ported = ported;
    return this;
  }
  ...
  public NiResponseJsonAdvancedAsync reachable(ReachableEnum reachable) {
  ...
  public NiResponseJsonAdvancedAsync refundPrice(String refundPrice) {
  ...
  public NiResponseJsonAdvancedAsync remainingBalance(String remainingBalance) {
  ...
  public NiResponseJsonAdvancedAsync requestId(String requestId) {
  ...
  public NiResponseJsonAdvancedAsync requestPrice(String requestPrice) {
  ...
  public NiResponseJsonAdvancedAsync roaming(NiRoaming roaming) {
  ...
  public NiResponseJsonAdvancedAsync status(NiStandardAdvancedStatus status) {
    this.status = status;
    return this;
  }
  ...
  public NiResponseJsonAdvancedAsync statusMessage(String statusMessage) {
  ...
  public NiResponseJsonAdvancedAsync validNumber(ValidNumberEnum validNumber) {
  ...
  public boolean equals(Object o) {
    ...
    NiResponseJsonAdvancedAsync niResponseJsonAdvancedAsync = (NiResponseJsonAdvancedAsync) o;
    return Objects.equals(this.callerIdentity, niResponseJsonAdvancedAsync.callerIdentity) &&
        Objects.equals(this.countryCode, niResponseJsonAdvancedAsync.countryCode) &&
        Objects.equals(this.countryCodeIso3, niResponseJsonAdvancedAsync.countryCodeIso3) &&
        Objects.equals(this.countryName, niResponseJsonAdvancedAsync.countryName) &&
        Objects.equals(this.countryPrefix, niResponseJsonAdvancedAsync.countryPrefix) &&
        Objects.equals(this.currentCarrier, niResponseJsonAdvancedAsync.currentCarrier) &&
        Objects.equals(this.internationalFormatNumber, niResponseJsonAdvancedAsync.internationalFormatNumber) &&
        Objects.equals(this.lookupOutcome, niResponseJsonAdvancedAsync.lookupOutcome) &&
        Objects.equals(this.lookupOutcomeMessage, niResponseJsonAdvancedAsync.lookupOutcomeMessage) &&
        Objects.equals(this.nationalFormatNumber, niResponseJsonAdvancedAsync.nationalFormatNumber) &&
        Objects.equals(this.originalCarrier, niResponseJsonAdvancedAsync.originalCarrier) &&
        Objects.equals(this.ported, niResponseJsonAdvancedAsync.ported) &&
        Objects.equals(this.reachable, niResponseJsonAdvancedAsync.reachable) &&
        Objects.equals(this.refundPrice, niResponseJsonAdvancedAsync.refundPrice) &&
        Objects.equals(this.remainingBalance, niResponseJsonAdvancedAsync.remainingBalance) &&
        Objects.equals(this.requestId, niResponseJsonAdvancedAsync.requestId) &&
        Objects.equals(this.requestPrice, niResponseJsonAdvancedAsync.requestPrice) &&
        Objects.equals(this.roaming, niResponseJsonAdvancedAsync.roaming) &&
        Objects.equals(this.status, niResponseJsonAdvancedAsync.status) &&
        Objects.equals(this.statusMessage, niResponseJsonAdvancedAsync.statusMessage) &&
        Objects.equals(this.validNumber, niResponseJsonAdvancedAsync.validNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class NiResponseJsonAdvancedAsync {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NiResponseJsonAdvancedAsync
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NiResponseJsonAdvancedAsync.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NiResponseJsonAdvancedAsync is not found in the empty JSON string", NiResponseJsonAdvancedAsync.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NiResponseJsonAdvancedAsync.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NiResponseJsonAdvancedAsync` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NiResponseJsonAdvancedAsync.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NiResponseJsonAdvancedAsync.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NiResponseJsonAdvancedAsync' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NiResponseJsonAdvancedAsync> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NiResponseJsonAdvancedAsync.class));

       return (TypeAdapter<T>) new TypeAdapter<NiResponseJsonAdvancedAsync>() {
           @Override
           public void write(JsonWriter out, NiResponseJsonAdvancedAsync value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NiResponseJsonAdvancedAsync read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NiResponseJsonAdvancedAsync given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NiResponseJsonAdvancedAsync
   * @throws IOException if the JSON string is invalid with respect to NiResponseJsonAdvancedAsync
   */
  public static NiResponseJsonAdvancedAsync fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NiResponseJsonAdvancedAsync.class);
  }

  /**
   * Convert an instance of NiResponseJsonAdvancedAsync to an JSON string
   *
   * @return JSON string
   */
