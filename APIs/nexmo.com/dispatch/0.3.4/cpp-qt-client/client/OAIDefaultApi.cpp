...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.nexmo.com/v0.1/dispatch"),
...
void OAIDefaultApi::createWorkflow(const OAICreateWorkflow &oai_create_workflow) {
    QString fullPath = QString(_serverConfigs["createWorkflow"][_serverIndices.value("createWorkflow")].URL()+"/");
...

    {
        ...
        QByteArray output = oai_create_workflow.asJson().toUtf8();
