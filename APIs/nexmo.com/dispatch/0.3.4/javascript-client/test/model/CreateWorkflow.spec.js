...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DispatchApi.CreateWorkflow();
  });
  ...
  describe('CreateWorkflow', function() {
    it('should create an instance of CreateWorkflow', function() {
      // uncomment below and update the code to test CreateWorkflow
      //var instance = new DispatchApi.CreateWorkflow();
      //expect(instance).to.be.a(DispatchApi.CreateWorkflow);
    });
