...
OAIGet_search_ok::OAIGet_search_ok(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_search_ok::OAIGet_search_ok() {
    this->initializeModel();
}

OAIGet_search_ok::~OAIGet_search_ok() {}

void OAIGet_search_ok::initializeModel() {
...
void OAIGet_search_ok::fromJson(QString jsonString) {
...
void OAIGet_search_ok::fromJsonObject(QJsonObject json) {
...
QString OAIGet_search_ok::asJson() const {
...
QJsonObject OAIGet_search_ok::asJsonObject() const {
    QJsonObject obj;
    if (m_agent.size() > 0) {
...
QList<qint32> OAIGet_search_ok::getAgent() const {
    return m_agent;
}
void OAIGet_search_ok::setAgent(const QList<qint32> &agent) {
    m_agent = agent;
    m_agent_isSet = true;
}

bool OAIGet_search_ok::is_agent_Set() const{
    return m_agent_isSet;
}

bool OAIGet_search_ok::is_agent_Valid() const{
    return m_agent_isValid;
}

QList<qint32> OAIGet_search_ok::getAlliance() const {
    return m_alliance;
}
void OAIGet_search_ok::setAlliance(const QList<qint32> &alliance) {
    m_alliance = alliance;
    m_alliance_isSet = true;
}

bool OAIGet_search_ok::is_alliance_Set() const{
    return m_alliance_isSet;
}

bool OAIGet_search_ok::is_alliance_Valid() const{
    return m_alliance_isValid;
}

QList<qint32> OAIGet_search_ok::getCharacter() const {
    return m_character;
}
void OAIGet_search_ok::setCharacter(const QList<qint32> &character) {
    m_character = character;
    m_character_isSet = true;
}

bool OAIGet_search_ok::is_character_Set() const{
    return m_character_isSet;
}

bool OAIGet_search_ok::is_character_Valid() const{
    return m_character_isValid;
}

QList<qint32> OAIGet_search_ok::getConstellation() const {
    return m_constellation;
}
void OAIGet_search_ok::setConstellation(const QList<qint32> &constellation) {
    m_constellation = constellation;
    m_constellation_isSet = true;
}

bool OAIGet_search_ok::is_constellation_Set() const{
    return m_constellation_isSet;
}

bool OAIGet_search_ok::is_constellation_Valid() const{
    return m_constellation_isValid;
}

QList<qint32> OAIGet_search_ok::getCorporation() const {
    return m_corporation;
}
void OAIGet_search_ok::setCorporation(const QList<qint32> &corporation) {
    m_corporation = corporation;
    m_corporation_isSet = true;
}

bool OAIGet_search_ok::is_corporation_Set() const{
    return m_corporation_isSet;
}

bool OAIGet_search_ok::is_corporation_Valid() const{
    return m_corporation_isValid;
}

QList<qint32> OAIGet_search_ok::getFaction() const {
    return m_faction;
}
void OAIGet_search_ok::setFaction(const QList<qint32> &faction) {
    m_faction = faction;
    m_faction_isSet = true;
}

bool OAIGet_search_ok::is_faction_Set() const{
    return m_faction_isSet;
}

bool OAIGet_search_ok::is_faction_Valid() const{
    return m_faction_isValid;
}

QList<qint32> OAIGet_search_ok::getInventoryType() const {
    return m_inventory_type;
}
void OAIGet_search_ok::setInventoryType(const QList<qint32> &inventory_type) {
    m_inventory_type = inventory_type;
    m_inventory_type_isSet = true;
}

bool OAIGet_search_ok::is_inventory_type_Set() const{
    return m_inventory_type_isSet;
}

bool OAIGet_search_ok::is_inventory_type_Valid() const{
    return m_inventory_type_isValid;
}

QList<qint32> OAIGet_search_ok::getRegion() const {
    return m_region;
}
void OAIGet_search_ok::setRegion(const QList<qint32> &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIGet_search_ok::is_region_Set() const{
    return m_region_isSet;
}

bool OAIGet_search_ok::is_region_Valid() const{
    return m_region_isValid;
}

QList<qint32> OAIGet_search_ok::getSolarSystem() const {
    return m_solar_system;
}
void OAIGet_search_ok::setSolarSystem(const QList<qint32> &solar_system) {
    m_solar_system = solar_system;
    m_solar_system_isSet = true;
}

bool OAIGet_search_ok::is_solar_system_Set() const{
    return m_solar_system_isSet;
}

bool OAIGet_search_ok::is_solar_system_Valid() const{
    return m_solar_system_isValid;
}

QList<qint32> OAIGet_search_ok::getStation() const {
    return m_station;
}
void OAIGet_search_ok::setStation(const QList<qint32> &station) {
    m_station = station;
    m_station_isSet = true;
}

bool OAIGet_search_ok::is_station_Set() const{
    return m_station_isSet;
}

bool OAIGet_search_ok::is_station_Valid() const{
    return m_station_isValid;
}

bool OAIGet_search_ok::isSet() const {
...
bool OAIGet_search_ok::isValid() const {
