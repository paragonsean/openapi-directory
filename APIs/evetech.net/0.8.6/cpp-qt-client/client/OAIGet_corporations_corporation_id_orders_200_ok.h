...
/*
 * OAIGet_corporations_corporation_id_orders_200_ok.h
 *
 * 200 ok object
 */

#ifndef OAIGet_corporations_corporation_id_orders_200_ok_H
#define OAIGet_corporations_corporation_id_orders_200_ok_H
...
class OAIGet_corporations_corporation_id_orders_200_ok : public OAIObject {
public:
    OAIGet_corporations_corporation_id_orders_200_ok();
    OAIGet_corporations_corporation_id_orders_200_ok(QString json);
    ~OAIGet_corporations_corporation_id_orders_200_ok() override;
    ...
    double getEscrow() const;
    void setEscrow(const double &escrow);
    bool is_escrow_Set() const;
    bool is_escrow_Valid() const;
    ...
    qint32 getWalletDivision() const;
    void setWalletDivision(const qint32 &wallet_division);
    bool is_wallet_division_Set() const;
    bool is_wallet_division_Valid() const;
...
private:
    ...
    qint32 m_wallet_division;
    bool m_wallet_division_isSet;
    bool m_wallet_division_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGet_corporations_corporation_id_orders_200_ok)

#endif // OAIGet_corporations_corporation_id_orders_200_ok_H
