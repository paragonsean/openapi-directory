...
#ifndef OAIGet_search_ok_H
#define OAIGet_search_ok_H
...
class OAIGet_search_ok : public OAIObject {
public:
    OAIGet_search_ok();
    OAIGet_search_ok(QString json);
    ~OAIGet_search_ok() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_search_ok)

#endif // OAIGet_search_ok_H
