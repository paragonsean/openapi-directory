...
/*
 * OAIGet_markets_structures_structure_id_200_ok.h
 *
 * 200 ok object
 */

#ifndef OAIGet_markets_structures_structure_id_200_ok_H
#define OAIGet_markets_structures_structure_id_200_ok_H
...
class OAIGet_markets_structures_structure_id_200_ok : public OAIObject {
public:
    OAIGet_markets_structures_structure_id_200_ok();
    OAIGet_markets_structures_structure_id_200_ok(QString json);
    ~OAIGet_markets_structures_structure_id_200_ok() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_markets_structures_structure_id_200_ok)

#endif // OAIGet_markets_structures_structure_id_200_ok_H
