...
/*
 * OAIGet_characters_character_id_orders_history_200_ok.h
 *
 * 200 ok object
 */

#ifndef OAIGet_characters_character_id_orders_history_200_ok_H
#define OAIGet_characters_character_id_orders_history_200_ok_H
...
class OAIGet_characters_character_id_orders_history_200_ok : public OAIObject {
public:
    OAIGet_characters_character_id_orders_history_200_ok();
    OAIGet_characters_character_id_orders_history_200_ok(QString json);
    ~OAIGet_characters_character_id_orders_history_200_ok() override;
    ...
    bool isIsCorporation() const;
    void setIsCorporation(const bool &is_corporation);
    bool is_is_corporation_Set() const;
    bool is_is_corporation_Valid() const;
...
private:
    ...
    bool m_is_corporation;
    bool m_is_corporation_isSet;
    bool m_is_corporation_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_characters_character_id_orders_history_200_ok)

#endif // OAIGet_characters_character_id_orders_history_200_ok_H
