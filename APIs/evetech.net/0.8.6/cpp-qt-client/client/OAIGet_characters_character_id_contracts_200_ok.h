...
/*
 * OAIGet_characters_character_id_contracts_200_ok.h
 *
 * 200 ok object
 */

#ifndef OAIGet_characters_character_id_contracts_200_ok_H
#define OAIGet_characters_character_id_contracts_200_ok_H
...
class OAIGet_characters_character_id_contracts_200_ok : public OAIObject {
public:
    OAIGet_characters_character_id_contracts_200_ok();
    OAIGet_characters_character_id_contracts_200_ok(QString json);
    ~OAIGet_characters_character_id_contracts_200_ok() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_characters_character_id_contracts_200_ok)

#endif // OAIGet_characters_character_id_contracts_200_ok_H
