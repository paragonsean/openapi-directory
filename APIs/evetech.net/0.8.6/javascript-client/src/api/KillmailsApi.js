...
* @version 0.8.6
*/
export default class KillmailsApi {
    ...
    */
     ...
     */
    getCharactersCharacterIdKillmailsRecent(characterId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = [GetCharactersCharacterIdKillmailsRecent200Ok];
     ...
     */
    getCorporationsCorporationIdKillmailsRecent(corporationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [GetCorporationsCorporationIdKillmailsRecent200Ok];
      return this.apiClient.callApi(
     ...
     */
    getKillmailsKillmailIdKillmailHash(killmailHash, killmailId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetKillmailsKillmailIdKillmailHashOk;
      return this.apiClient.callApi(
