...
class GetCorporationsCorporationIdOrders200Ok {
     ...
     */
    constructor(duration, issued, issuedBy, locationId, orderId, price, range, regionId, typeId, volumeRemain, volumeTotal, walletDivision) { 
        
        GetCorporationsCorporationIdOrders200Ok.initialize(this, duration, issued, issuedBy, locationId, orderId, price, range, regionId, typeId, volumeRemain, volumeTotal, walletDivision);
    }
     ...
     */
    static initialize(obj, duration, issued, issuedBy, locationId, orderId, price, range, regionId, typeId, volumeRemain, volumeTotal, walletDivision) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCorporationsCorporationIdOrders200Ok();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCorporationsCorporationIdOrders200Ok</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCorporationsCorporationIdOrders200Ok</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCorporationsCorporationIdOrders200Ok.RequiredProperties) {
...
GetCorporationsCorporationIdOrders200Ok.RequiredProperties = ["duration", "issued", "issued_by", "location_id", "order_id", "price", "range", "region_id", "type_id", "volume_remain", "volume_total", "wallet_division"];

/**
 * Number of days for which order is valid (starting from the issued date). An order expires at time issued + duration
 * @member {Number} duration
 */
GetCorporationsCorporationIdOrders200Ok.prototype['duration'] = undefined;

/**
 * For buy orders, the amount of ISK in escrow
 * @member {Number} escrow
 */
GetCorporationsCorporationIdOrders200Ok.prototype['escrow'] = undefined;

/**
 * True if the order is a bid (buy) order
 * @member {Boolean} is_buy_order
 */
GetCorporationsCorporationIdOrders200Ok.prototype['is_buy_order'] = undefined;

/**
 * Date and time when this order was issued
 * @member {Date} issued
 */
GetCorporationsCorporationIdOrders200Ok.prototype['issued'] = undefined;

/**
 * The character who issued this order
 * @member {Number} issued_by
 */
GetCorporationsCorporationIdOrders200Ok.prototype['issued_by'] = undefined;

/**
 * ID of the location where order was placed
 * @member {Number} location_id
 */
GetCorporationsCorporationIdOrders200Ok.prototype['location_id'] = undefined;

/**
 * For buy orders, the minimum quantity that will be accepted in a matching sell order
 * @member {Number} min_volume
 */
GetCorporationsCorporationIdOrders200Ok.prototype['min_volume'] = undefined;

/**
 * Unique order ID
 * @member {Number} order_id
 */
GetCorporationsCorporationIdOrders200Ok.prototype['order_id'] = undefined;

/**
 * Cost per unit for this order
 * @member {Number} price
 */
GetCorporationsCorporationIdOrders200Ok.prototype['price'] = undefined;

/**
 * Valid order range, numbers are ranges in jumps
 * @member {module:model/GetCorporationsCorporationIdOrders200Ok.RangeEnum} range
 */
GetCorporationsCorporationIdOrders200Ok.prototype['range'] = undefined;

/**
 * ID of the region where order was placed
 * @member {Number} region_id
 */
GetCorporationsCorporationIdOrders200Ok.prototype['region_id'] = undefined;

/**
 * The type ID of the item transacted in this order
 * @member {Number} type_id
 */
GetCorporationsCorporationIdOrders200Ok.prototype['type_id'] = undefined;

/**
 * Quantity of items still required or offered
 * @member {Number} volume_remain
 */
GetCorporationsCorporationIdOrders200Ok.prototype['volume_remain'] = undefined;

/**
 * Quantity of items required or offered at time order was placed
 * @member {Number} volume_total
 */
GetCorporationsCorporationIdOrders200Ok.prototype['volume_total'] = undefined;

/**
 * The corporation wallet division used for this order.
 * @member {Number} wallet_division
 */
GetCorporationsCorporationIdOrders200Ok.prototype['wallet_division'] = undefined;
 ...
 * @readonly
 */
GetCorporationsCorporationIdOrders200Ok['RangeEnum'] = {
...
export default GetCorporationsCorporationIdOrders200Ok;
