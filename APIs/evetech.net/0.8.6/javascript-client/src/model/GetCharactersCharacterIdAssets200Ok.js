...
class GetCharactersCharacterIdAssets200Ok {
    ...
    constructor(isSingleton, itemId, locationFlag, locationId, locationType, quantity, typeId) { 
        ...
        GetCharactersCharacterIdAssets200Ok.initialize(this, isSingleton, itemId, locationFlag, locationId, locationType, quantity, typeId);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCharactersCharacterIdAssets200Ok();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCharactersCharacterIdAssets200Ok</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCharactersCharacterIdAssets200Ok</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCharactersCharacterIdAssets200Ok.RequiredProperties) {
...
GetCharactersCharacterIdAssets200Ok.RequiredProperties = ["is_singleton", "item_id", "location_flag", "location_id", "location_type", "quantity", "type_id"];

/**
 * is_blueprint_copy boolean
 * @member {Boolean} is_blueprint_copy
 */
GetCharactersCharacterIdAssets200Ok.prototype['is_blueprint_copy'] = undefined;

/**
 * is_singleton boolean
 * @member {Boolean} is_singleton
 */
GetCharactersCharacterIdAssets200Ok.prototype['is_singleton'] = undefined;

/**
 * item_id integer
 * @member {Number} item_id
 */
GetCharactersCharacterIdAssets200Ok.prototype['item_id'] = undefined;

/**
 * location_flag string
 * @member {module:model/GetCharactersCharacterIdAssets200Ok.LocationFlagEnum} location_flag
 */
GetCharactersCharacterIdAssets200Ok.prototype['location_flag'] = undefined;

/**
 * location_id integer
 * @member {Number} location_id
 */
GetCharactersCharacterIdAssets200Ok.prototype['location_id'] = undefined;

/**
 * location_type string
 * @member {module:model/GetCharactersCharacterIdAssets200Ok.LocationTypeEnum} location_type
 */
GetCharactersCharacterIdAssets200Ok.prototype['location_type'] = undefined;

/**
 * quantity integer
 * @member {Number} quantity
 */
GetCharactersCharacterIdAssets200Ok.prototype['quantity'] = undefined;

/**
 * type_id integer
 * @member {Number} type_id
 */
GetCharactersCharacterIdAssets200Ok.prototype['type_id'] = undefined;
 ...
 * @readonly
 */
GetCharactersCharacterIdAssets200Ok['LocationFlagEnum'] = {
 ...
 * @readonly
 */
GetCharactersCharacterIdAssets200Ok['LocationTypeEnum'] = {
...
export default GetCharactersCharacterIdAssets200Ok;
