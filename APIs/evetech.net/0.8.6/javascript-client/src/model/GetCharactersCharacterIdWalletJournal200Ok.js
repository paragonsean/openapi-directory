...
class GetCharactersCharacterIdWalletJournal200Ok {
     ...
     * @param refType {module:model/GetCharactersCharacterIdWalletJournal200Ok.RefTypeEnum} \"The transaction type for the given. transaction. Different transaction types will populate different attributes. Note: If you have an existing XML API application that is using ref_types, you will need to know which string ESI ref_type maps to which integer. You can look at the following file to see string->int mappings: https://github.com/ccpgames/eve-glue/blob/master/eve_glue/wallet_journal_ref.py\"
     */
    constructor(date, description, id, refType) { 
        
        GetCharactersCharacterIdWalletJournal200Ok.initialize(this, date, description, id, refType);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCharactersCharacterIdWalletJournal200Ok();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCharactersCharacterIdWalletJournal200Ok</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCharactersCharacterIdWalletJournal200Ok</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCharactersCharacterIdWalletJournal200Ok.RequiredProperties) {
...
GetCharactersCharacterIdWalletJournal200Ok.RequiredProperties = ["date", "description", "id", "ref_type"];

/**
 * The amount of ISK given or taken from the wallet as a result of the given transaction. Positive when ISK is deposited into the wallet and negative when ISK is withdrawn
 * @member {Number} amount
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['amount'] = undefined;

/**
 * Wallet balance after transaction occurred
 * @member {Number} balance
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['balance'] = undefined;

/**
 * An ID that gives extra context to the particular transaction. Because of legacy reasons the context is completely different per ref_type and means different things. It is also possible to not have a context_id
 * @member {Number} context_id
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['context_id'] = undefined;

/**
 * The type of the given context_id if present
 * @member {module:model/GetCharactersCharacterIdWalletJournal200Ok.ContextIdTypeEnum} context_id_type
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['context_id_type'] = undefined;

/**
 * Date and time of transaction
 * @member {Date} date
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['date'] = undefined;

/**
 * The reason for the transaction, mirrors what is seen in the client
 * @member {String} description
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['description'] = undefined;

/**
 * The id of the first party involved in the transaction. This attribute has no consistency and is different or non existant for particular ref_types. The description attribute will help make sense of what this attribute means. For more info about the given ID it can be dropped into the /universe/names/ ESI route to determine its type and name
 * @member {Number} first_party_id
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['first_party_id'] = undefined;

/**
 * Unique journal reference ID
 * @member {Number} id
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['id'] = undefined;

/**
 * The user stated reason for the transaction. Only applies to some ref_types
 * @member {String} reason
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['reason'] = undefined;

/**
 * \"The transaction type for the given. transaction. Different transaction types will populate different attributes. Note: If you have an existing XML API application that is using ref_types, you will need to know which string ESI ref_type maps to which integer. You can look at the following file to see string->int mappings: https://github.com/ccpgames/eve-glue/blob/master/eve_glue/wallet_journal_ref.py\"
 * @member {module:model/GetCharactersCharacterIdWalletJournal200Ok.RefTypeEnum} ref_type
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['ref_type'] = undefined;

/**
 * The id of the second party involved in the transaction. This attribute has no consistency and is different or non existant for particular ref_types. The description attribute will help make sense of what this attribute means. For more info about the given ID it can be dropped into the /universe/names/ ESI route to determine its type and name
 * @member {Number} second_party_id
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['second_party_id'] = undefined;

/**
 * Tax amount received. Only applies to tax related transactions
 * @member {Number} tax
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['tax'] = undefined;

/**
 * The corporation ID receiving any tax paid. Only applies to tax related transactions
 * @member {Number} tax_receiver_id
 */
GetCharactersCharacterIdWalletJournal200Ok.prototype['tax_receiver_id'] = undefined;
 ...
 * @readonly
 */
GetCharactersCharacterIdWalletJournal200Ok['ContextIdTypeEnum'] = {
 ...
 * @readonly
 */
GetCharactersCharacterIdWalletJournal200Ok['RefTypeEnum'] = {
...
export default GetCharactersCharacterIdWalletJournal200Ok;
