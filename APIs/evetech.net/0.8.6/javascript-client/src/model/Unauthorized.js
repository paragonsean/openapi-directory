...
class Unauthorized {
    ...
    constructor(error) { 
        ...
        Unauthorized.initialize(this, error);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Unauthorized</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Unauthorized</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Unauthorized.RequiredProperties) {
...
Unauthorized.RequiredProperties = ["error"];
