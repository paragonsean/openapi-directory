...
class GetMarketsStructuresStructureId200Ok {
     ...
     */
    constructor(duration, isBuyOrder, issued, locationId, minVolume, orderId, price, range, typeId, volumeRemain, volumeTotal) { 
        
        GetMarketsStructuresStructureId200Ok.initialize(this, duration, isBuyOrder, issued, locationId, minVolume, orderId, price, range, typeId, volumeRemain, volumeTotal);
    }
     ...
     */
    static initialize(obj, duration, isBuyOrder, issued, locationId, minVolume, orderId, price, range, typeId, volumeRemain, volumeTotal) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetMarketsStructuresStructureId200Ok();
    ...
    /**
     * Validates the JSON data with respect to <code>GetMarketsStructuresStructureId200Ok</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetMarketsStructuresStructureId200Ok</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetMarketsStructuresStructureId200Ok.RequiredProperties) {
...
GetMarketsStructuresStructureId200Ok.RequiredProperties = ["duration", "is_buy_order", "issued", "location_id", "min_volume", "order_id", "price", "range", "type_id", "volume_remain", "volume_total"];

/**
 * duration integer
 * @member {Number} duration
 */
GetMarketsStructuresStructureId200Ok.prototype['duration'] = undefined;

/**
 * is_buy_order boolean
 * @member {Boolean} is_buy_order
 */
GetMarketsStructuresStructureId200Ok.prototype['is_buy_order'] = undefined;

/**
 * issued string
 * @member {Date} issued
 */
GetMarketsStructuresStructureId200Ok.prototype['issued'] = undefined;

/**
 * location_id integer
 * @member {Number} location_id
 */
GetMarketsStructuresStructureId200Ok.prototype['location_id'] = undefined;

/**
 * min_volume integer
 * @member {Number} min_volume
 */
GetMarketsStructuresStructureId200Ok.prototype['min_volume'] = undefined;

/**
 * order_id integer
 * @member {Number} order_id
 */
GetMarketsStructuresStructureId200Ok.prototype['order_id'] = undefined;

/**
 * price number
 * @member {Number} price
 */
GetMarketsStructuresStructureId200Ok.prototype['price'] = undefined;

/**
 * range string
 * @member {module:model/GetMarketsStructuresStructureId200Ok.RangeEnum} range
 */
GetMarketsStructuresStructureId200Ok.prototype['range'] = undefined;

/**
 * type_id integer
 * @member {Number} type_id
 */
GetMarketsStructuresStructureId200Ok.prototype['type_id'] = undefined;

/**
 * volume_remain integer
 * @member {Number} volume_remain
 */
GetMarketsStructuresStructureId200Ok.prototype['volume_remain'] = undefined;

/**
 * volume_total integer
 * @member {Number} volume_total
 */
GetMarketsStructuresStructureId200Ok.prototype['volume_total'] = undefined;
 ...
 * @readonly
 */
GetMarketsStructuresStructureId200Ok['RangeEnum'] = {
...
export default GetMarketsStructuresStructureId200Ok;
