...
class PostUiOpenwindowNewmailUnprocessableEntity {
    ...
    constructor() { 
        ...
        PostUiOpenwindowNewmailUnprocessableEntity.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostUiOpenwindowNewmailUnprocessableEntity();
    ...
    /**
     * Validates the JSON data with respect to <code>PostUiOpenwindowNewmailUnprocessableEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostUiOpenwindowNewmailUnprocessableEntity</code>.
     */
 ...
 * @member {String} error
 */
PostUiOpenwindowNewmailUnprocessableEntity.prototype['error'] = undefined;
...
export default PostUiOpenwindowNewmailUnprocessableEntity;
