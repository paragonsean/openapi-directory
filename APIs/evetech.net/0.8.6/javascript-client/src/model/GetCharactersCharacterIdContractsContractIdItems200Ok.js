...
class GetCharactersCharacterIdContractsContractIdItems200Ok {
    ...
    constructor(isIncluded, isSingleton, quantity, recordId, typeId) { 
        ...
        GetCharactersCharacterIdContractsContractIdItems200Ok.initialize(this, isIncluded, isSingleton, quantity, recordId, typeId);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCharactersCharacterIdContractsContractIdItems200Ok();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCharactersCharacterIdContractsContractIdItems200Ok</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCharactersCharacterIdContractsContractIdItems200Ok</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCharactersCharacterIdContractsContractIdItems200Ok.RequiredProperties) {
...
GetCharactersCharacterIdContractsContractIdItems200Ok.RequiredProperties = ["is_included", "is_singleton", "quantity", "record_id", "type_id"];

/**
 * true if the contract issuer has submitted this item with the contract, false if the isser is asking for this item in the contract
 * @member {Boolean} is_included
 */
GetCharactersCharacterIdContractsContractIdItems200Ok.prototype['is_included'] = undefined;

/**
 * is_singleton boolean
 * @member {Boolean} is_singleton
 */
GetCharactersCharacterIdContractsContractIdItems200Ok.prototype['is_singleton'] = undefined;

/**
 * Number of items in the stack
 * @member {Number} quantity
 */
GetCharactersCharacterIdContractsContractIdItems200Ok.prototype['quantity'] = undefined;

/**
 * -1 indicates that the item is a singleton (non-stackable). If the item happens to be a Blueprint, -1 is an Original and -2 is a Blueprint Copy
 * @member {Number} raw_quantity
 */
GetCharactersCharacterIdContractsContractIdItems200Ok.prototype['raw_quantity'] = undefined;

/**
 * Unique ID for the item
 * @member {Number} record_id
 */
GetCharactersCharacterIdContractsContractIdItems200Ok.prototype['record_id'] = undefined;

/**
 * Type ID for item
 * @member {Number} type_id
 */
GetCharactersCharacterIdContractsContractIdItems200Ok.prototype['type_id'] = undefined;
...
export default GetCharactersCharacterIdContractsContractIdItems200Ok;
