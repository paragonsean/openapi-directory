...
class GetCharactersCharacterIdContractsContractIdBids200Ok {
    ...
    constructor(amount, bidId, bidderId, dateBid) { 
        ...
        GetCharactersCharacterIdContractsContractIdBids200Ok.initialize(this, amount, bidId, bidderId, dateBid);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCharactersCharacterIdContractsContractIdBids200Ok();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCharactersCharacterIdContractsContractIdBids200Ok</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCharactersCharacterIdContractsContractIdBids200Ok</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCharactersCharacterIdContractsContractIdBids200Ok.RequiredProperties) {
...
GetCharactersCharacterIdContractsContractIdBids200Ok.RequiredProperties = ["amount", "bid_id", "bidder_id", "date_bid"];

/**
 * The amount bid, in ISK
 * @member {Number} amount
 */
GetCharactersCharacterIdContractsContractIdBids200Ok.prototype['amount'] = undefined;

/**
 * Unique ID for the bid
 * @member {Number} bid_id
 */
GetCharactersCharacterIdContractsContractIdBids200Ok.prototype['bid_id'] = undefined;

/**
 * Character ID of the bidder
 * @member {Number} bidder_id
 */
GetCharactersCharacterIdContractsContractIdBids200Ok.prototype['bidder_id'] = undefined;

/**
 * Datetime when the bid was placed
 * @member {Date} date_bid
 */
GetCharactersCharacterIdContractsContractIdBids200Ok.prototype['date_bid'] = undefined;
...
export default GetCharactersCharacterIdContractsContractIdBids200Ok;
