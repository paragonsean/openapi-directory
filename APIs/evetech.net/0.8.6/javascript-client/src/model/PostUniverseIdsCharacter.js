...
class PostUniverseIdsCharacter {
    ...
    constructor() { 
        ...
        PostUniverseIdsCharacter.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostUniverseIdsCharacter();
    ...
    /**
     * Validates the JSON data with respect to <code>PostUniverseIdsCharacter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostUniverseIdsCharacter</code>.
     */
 ...
 * @member {Number} id
 */
PostUniverseIdsCharacter.prototype['id'] = undefined;

/**
 * name string
 * @member {String} name
 */
PostUniverseIdsCharacter.prototype['name'] = undefined;
...
export default PostUniverseIdsCharacter;
