...
class GetUniverseStargatesStargateIdNotFound {
    ...
    constructor() { 
        ...
        GetUniverseStargatesStargateIdNotFound.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUniverseStargatesStargateIdNotFound();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUniverseStargatesStargateIdNotFound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUniverseStargatesStargateIdNotFound</code>.
     */
 ...
 * @member {String} error
 */
GetUniverseStargatesStargateIdNotFound.prototype['error'] = undefined;
...
export default GetUniverseStargatesStargateIdNotFound;
