...
class DeleteFleetsFleetIdSquadsSquadIdNotFound {
    ...
    constructor() { 
        ...
        DeleteFleetsFleetIdSquadsSquadIdNotFound.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteFleetsFleetIdSquadsSquadIdNotFound();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteFleetsFleetIdSquadsSquadIdNotFound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteFleetsFleetIdSquadsSquadIdNotFound</code>.
     */
 ...
 * @member {String} error
 */
DeleteFleetsFleetIdSquadsSquadIdNotFound.prototype['error'] = undefined;
...
export default DeleteFleetsFleetIdSquadsSquadIdNotFound;
