...
class GetUniverseMoonsMoonIdPosition {
    ...
    constructor(x, y, z) { 
        ...
        GetUniverseMoonsMoonIdPosition.initialize(this, x, y, z);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUniverseMoonsMoonIdPosition();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUniverseMoonsMoonIdPosition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUniverseMoonsMoonIdPosition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetUniverseMoonsMoonIdPosition.RequiredProperties) {
...
GetUniverseMoonsMoonIdPosition.RequiredProperties = ["x", "y", "z"];

/**
 * x number
 * @member {Number} x
 */
GetUniverseMoonsMoonIdPosition.prototype['x'] = undefined;

/**
 * y number
 * @member {Number} y
 */
GetUniverseMoonsMoonIdPosition.prototype['y'] = undefined;

/**
 * z number
 * @member {Number} z
 */
GetUniverseMoonsMoonIdPosition.prototype['z'] = undefined;
...
export default GetUniverseMoonsMoonIdPosition;
