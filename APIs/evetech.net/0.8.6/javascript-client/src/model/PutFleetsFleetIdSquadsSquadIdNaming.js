...
class PutFleetsFleetIdSquadsSquadIdNaming {
    ...
    constructor(name) { 
        ...
        PutFleetsFleetIdSquadsSquadIdNaming.initialize(this, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutFleetsFleetIdSquadsSquadIdNaming();
    ...
    /**
     * Validates the JSON data with respect to <code>PutFleetsFleetIdSquadsSquadIdNaming</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutFleetsFleetIdSquadsSquadIdNaming</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutFleetsFleetIdSquadsSquadIdNaming.RequiredProperties) {
...
PutFleetsFleetIdSquadsSquadIdNaming.RequiredProperties = ["name"];

/**
 * name string
 * @member {String} name
 */
PutFleetsFleetIdSquadsSquadIdNaming.prototype['name'] = undefined;
...
export default PutFleetsFleetIdSquadsSquadIdNaming;
