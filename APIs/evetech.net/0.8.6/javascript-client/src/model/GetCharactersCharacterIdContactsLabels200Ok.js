...
class GetCharactersCharacterIdContactsLabels200Ok {
    ...
    constructor(labelId, labelName) { 
        ...
        GetCharactersCharacterIdContactsLabels200Ok.initialize(this, labelId, labelName);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCharactersCharacterIdContactsLabels200Ok();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCharactersCharacterIdContactsLabels200Ok</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCharactersCharacterIdContactsLabels200Ok</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCharactersCharacterIdContactsLabels200Ok.RequiredProperties) {
...
GetCharactersCharacterIdContactsLabels200Ok.RequiredProperties = ["label_id", "label_name"];

/**
 * label_id integer
 * @member {Number} label_id
 */
GetCharactersCharacterIdContactsLabels200Ok.prototype['label_id'] = undefined;

/**
 * label_name string
 * @member {String} label_name
 */
GetCharactersCharacterIdContactsLabels200Ok.prototype['label_name'] = undefined;
...
export default GetCharactersCharacterIdContactsLabels200Ok;
