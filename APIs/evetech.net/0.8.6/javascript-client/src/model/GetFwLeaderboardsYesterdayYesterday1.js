...
class GetFwLeaderboardsYesterdayYesterday1 {
    ...
    constructor() { 
        ...
        GetFwLeaderboardsYesterdayYesterday1.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFwLeaderboardsYesterdayYesterday1();
    ...
    /**
     * Validates the JSON data with respect to <code>GetFwLeaderboardsYesterdayYesterday1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFwLeaderboardsYesterdayYesterday1</code>.
     */
 ...
 */
GetFwLeaderboardsYesterdayYesterday1.prototype['amount'] = undefined;

/**
 * faction_id integer
 * @member {Number} faction_id
 */
GetFwLeaderboardsYesterdayYesterday1.prototype['faction_id'] = undefined;
...
export default GetFwLeaderboardsYesterdayYesterday1;
