...
class GetAlliancesAllianceIdContactsLabels200Ok {
    ...
    constructor(labelId, labelName) { 
        ...
        GetAlliancesAllianceIdContactsLabels200Ok.initialize(this, labelId, labelName);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAlliancesAllianceIdContactsLabels200Ok();
    ...
    /**
     * Validates the JSON data with respect to <code>GetAlliancesAllianceIdContactsLabels200Ok</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAlliancesAllianceIdContactsLabels200Ok</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetAlliancesAllianceIdContactsLabels200Ok.RequiredProperties) {
...
GetAlliancesAllianceIdContactsLabels200Ok.RequiredProperties = ["label_id", "label_name"];

/**
 * label_id integer
 * @member {Number} label_id
 */
GetAlliancesAllianceIdContactsLabels200Ok.prototype['label_id'] = undefined;

/**
 * label_name string
 * @member {String} label_name
 */
GetAlliancesAllianceIdContactsLabels200Ok.prototype['label_name'] = undefined;
...
export default GetAlliancesAllianceIdContactsLabels200Ok;
