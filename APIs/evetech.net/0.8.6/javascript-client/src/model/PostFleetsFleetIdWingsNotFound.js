...
class PostFleetsFleetIdWingsNotFound {
    ...
    constructor() { 
        ...
        PostFleetsFleetIdWingsNotFound.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostFleetsFleetIdWingsNotFound();
    ...
    /**
     * Validates the JSON data with respect to <code>PostFleetsFleetIdWingsNotFound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostFleetsFleetIdWingsNotFound</code>.
     */
 ...
 * @member {String} error
 */
PostFleetsFleetIdWingsNotFound.prototype['error'] = undefined;
...
export default PostFleetsFleetIdWingsNotFound;
