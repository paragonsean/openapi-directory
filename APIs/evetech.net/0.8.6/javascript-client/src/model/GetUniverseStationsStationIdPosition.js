...
class GetUniverseStationsStationIdPosition {
    ...
    constructor(x, y, z) { 
        ...
        GetUniverseStationsStationIdPosition.initialize(this, x, y, z);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUniverseStationsStationIdPosition();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUniverseStationsStationIdPosition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUniverseStationsStationIdPosition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetUniverseStationsStationIdPosition.RequiredProperties) {
...
GetUniverseStationsStationIdPosition.RequiredProperties = ["x", "y", "z"];

/**
 * x number
 * @member {Number} x
 */
GetUniverseStationsStationIdPosition.prototype['x'] = undefined;

/**
 * y number
 * @member {Number} y
 */
GetUniverseStationsStationIdPosition.prototype['y'] = undefined;

/**
 * z number
 * @member {Number} z
 */
GetUniverseStationsStationIdPosition.prototype['z'] = undefined;
...
export default GetUniverseStationsStationIdPosition;
