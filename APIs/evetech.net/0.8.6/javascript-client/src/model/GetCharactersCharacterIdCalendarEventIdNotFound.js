...
class GetCharactersCharacterIdCalendarEventIdNotFound {
    ...
    constructor() { 
        ...
        GetCharactersCharacterIdCalendarEventIdNotFound.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCharactersCharacterIdCalendarEventIdNotFound();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCharactersCharacterIdCalendarEventIdNotFound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCharactersCharacterIdCalendarEventIdNotFound</code>.
     */
 ...
 * @member {String} error
 */
GetCharactersCharacterIdCalendarEventIdNotFound.prototype['error'] = undefined;
...
export default GetCharactersCharacterIdCalendarEventIdNotFound;
