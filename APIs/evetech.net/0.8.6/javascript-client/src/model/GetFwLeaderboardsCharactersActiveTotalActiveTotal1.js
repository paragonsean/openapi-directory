...
class GetFwLeaderboardsCharactersActiveTotalActiveTotal1 {
    ...
    constructor() { 
        ...
        GetFwLeaderboardsCharactersActiveTotalActiveTotal1.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFwLeaderboardsCharactersActiveTotalActiveTotal1();
    ...
    /**
     * Validates the JSON data with respect to <code>GetFwLeaderboardsCharactersActiveTotalActiveTotal1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFwLeaderboardsCharactersActiveTotalActiveTotal1</code>.
     */
 ...
 */
GetFwLeaderboardsCharactersActiveTotalActiveTotal1.prototype['amount'] = undefined;

/**
 * character_id integer
 * @member {Number} character_id
 */
GetFwLeaderboardsCharactersActiveTotalActiveTotal1.prototype['character_id'] = undefined;
...
export default GetFwLeaderboardsCharactersActiveTotalActiveTotal1;
