...
class PostFleetsFleetIdMembersUnprocessableEntity {
    ...
    constructor() { 
        ...
        PostFleetsFleetIdMembersUnprocessableEntity.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostFleetsFleetIdMembersUnprocessableEntity();
    ...
    /**
     * Validates the JSON data with respect to <code>PostFleetsFleetIdMembersUnprocessableEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostFleetsFleetIdMembersUnprocessableEntity</code>.
     */
 ...
 * @member {String} error
 */
PostFleetsFleetIdMembersUnprocessableEntity.prototype['error'] = undefined;
...
export default PostFleetsFleetIdMembersUnprocessableEntity;
