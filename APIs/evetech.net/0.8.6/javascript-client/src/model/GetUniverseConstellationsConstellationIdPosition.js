...
class GetUniverseConstellationsConstellationIdPosition {
    ...
    constructor(x, y, z) { 
        ...
        GetUniverseConstellationsConstellationIdPosition.initialize(this, x, y, z);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUniverseConstellationsConstellationIdPosition();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUniverseConstellationsConstellationIdPosition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUniverseConstellationsConstellationIdPosition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetUniverseConstellationsConstellationIdPosition.RequiredProperties) {
...
GetUniverseConstellationsConstellationIdPosition.RequiredProperties = ["x", "y", "z"];

/**
 * x number
 * @member {Number} x
 */
GetUniverseConstellationsConstellationIdPosition.prototype['x'] = undefined;

/**
 * y number
 * @member {Number} y
 */
GetUniverseConstellationsConstellationIdPosition.prototype['y'] = undefined;

/**
 * z number
 * @member {Number} z
 */
GetUniverseConstellationsConstellationIdPosition.prototype['z'] = undefined;
...
export default GetUniverseConstellationsConstellationIdPosition;
