  ...
  describe('BookmarksApi', function() {
    describe('getCharactersCharacterIdBookmarks', function() {
      it('should call getCharactersCharacterIdBookmarks successfully', function(done) {
        //uncomment below and update the code to test getCharactersCharacterIdBookmarks
        //instance.getCharactersCharacterIdBookmarks(function(error) {
    ...
    describe('getCharactersCharacterIdBookmarksFolders', function() {
      it('should call getCharactersCharacterIdBookmarksFolders successfully', function(done) {
        //uncomment below and update the code to test getCharactersCharacterIdBookmarksFolders
        //instance.getCharactersCharacterIdBookmarksFolders(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getCorporationsCorporationIdBookmarks', function() {
      it('should call getCorporationsCorporationIdBookmarks successfully', function(done) {
        //uncomment below and update the code to test getCorporationsCorporationIdBookmarks
        //instance.getCorporationsCorporationIdBookmarks(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getCorporationsCorporationIdBookmarksFolders', function() {
      it('should call getCorporationsCorporationIdBookmarksFolders successfully', function(done) {
        //uncomment below and update the code to test getCorporationsCorporationIdBookmarksFolders
        //instance.getCorporationsCorporationIdBookmarksFolders(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
