...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdPlanetsPlanetIdContent', function() {
    it('should create an instance of GetCharactersCharacterIdPlanetsPlanetIdContent', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdPlanetsPlanetIdContent
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdPlanetsPlanetIdContent();
