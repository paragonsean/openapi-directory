...
(function(root, factory) {
  ...
  describe('GetUniverseTypesTypeIdDogmaAttribute', function() {
    it('should create an instance of GetUniverseTypesTypeIdDogmaAttribute', function() {
      // uncomment below and update the code to test GetUniverseTypesTypeIdDogmaAttribute
      //var instance = new EveSwaggerInterface.GetUniverseTypesTypeIdDogmaAttribute();
