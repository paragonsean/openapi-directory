...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdMining200Ok', function() {
    it('should create an instance of GetCharactersCharacterIdMining200Ok', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdMining200Ok
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdMining200Ok();
