...
(function(root, factory) {
  ...
  describe('GetFwLeaderboardsCorporationsYesterdayYesterday', function() {
    it('should create an instance of GetFwLeaderboardsCorporationsYesterdayYesterday', function() {
      // uncomment below and update the code to test GetFwLeaderboardsCorporationsYesterdayYesterday
      //var instance = new EveSwaggerInterface.GetFwLeaderboardsCorporationsYesterdayYesterday();
