...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdWalletTransactions200Ok', function() {
    it('should create an instance of GetCharactersCharacterIdWalletTransactions200Ok', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdWalletTransactions200Ok
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdWalletTransactions200Ok();
    ...
    it('should have the property journalRefId (base name: "journal_ref_id")', function() {
      // uncomment below and update the code to test the property journalRefId
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdWalletTransactions200Ok();
      //expect(instance).to.be();
    });
