...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdOpportunities200Ok', function() {
    it('should create an instance of GetCharactersCharacterIdOpportunities200Ok', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdOpportunities200Ok
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdOpportunities200Ok();
