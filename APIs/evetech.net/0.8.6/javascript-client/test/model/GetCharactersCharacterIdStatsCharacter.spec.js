...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdStatsCharacter', function() {
    it('should create an instance of GetCharactersCharacterIdStatsCharacter', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdStatsCharacter
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdStatsCharacter();
    ...
    it('should have the property daysOfActivity (base name: "days_of_activity")', function() {
      // uncomment below and update the code to test the property daysOfActivity
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdStatsCharacter();
    ...
    it('should have the property sessionsStarted (base name: "sessions_started")', function() {
      // uncomment below and update the code to test the property sessionsStarted
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdStatsCharacter();
      //expect(instance).to.be();
    });
