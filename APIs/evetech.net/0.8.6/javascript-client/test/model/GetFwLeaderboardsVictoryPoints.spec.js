...
(function(root, factory) {
  ...
  describe('GetFwLeaderboardsVictoryPoints', function() {
    it('should create an instance of GetFwLeaderboardsVictoryPoints', function() {
      // uncomment below and update the code to test GetFwLeaderboardsVictoryPoints
      //var instance = new EveSwaggerInterface.GetFwLeaderboardsVictoryPoints();
    ...
    it('should have the property activeTotal (base name: "active_total")', function() {
      // uncomment below and update the code to test the property activeTotal
      //var instance = new EveSwaggerInterface.GetFwLeaderboardsVictoryPoints();
