...
(function(root, factory) {
  ...
  describe('GetCorporationsCorporationIdAssets200Ok', function() {
    it('should create an instance of GetCorporationsCorporationIdAssets200Ok', function() {
      // uncomment below and update the code to test GetCorporationsCorporationIdAssets200Ok
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdAssets200Ok();
    ...
    it('should have the property isBlueprintCopy (base name: "is_blueprint_copy")', function() {
      // uncomment below and update the code to test the property isBlueprintCopy
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdAssets200Ok();
