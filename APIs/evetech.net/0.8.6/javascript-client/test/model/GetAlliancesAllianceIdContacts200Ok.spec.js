...
(function(root, factory) {
  ...
  describe('GetAlliancesAllianceIdContacts200Ok', function() {
    it('should create an instance of GetAlliancesAllianceIdContacts200Ok', function() {
      // uncomment below and update the code to test GetAlliancesAllianceIdContacts200Ok
      //var instance = new EveSwaggerInterface.GetAlliancesAllianceIdContacts200Ok();
