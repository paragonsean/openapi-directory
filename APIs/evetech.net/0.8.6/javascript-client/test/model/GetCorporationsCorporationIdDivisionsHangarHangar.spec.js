...
(function(root, factory) {
  ...
  describe('GetCorporationsCorporationIdDivisionsHangarHangar', function() {
    it('should create an instance of GetCorporationsCorporationIdDivisionsHangarHangar', function() {
      // uncomment below and update the code to test GetCorporationsCorporationIdDivisionsHangarHangar
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdDivisionsHangarHangar();
