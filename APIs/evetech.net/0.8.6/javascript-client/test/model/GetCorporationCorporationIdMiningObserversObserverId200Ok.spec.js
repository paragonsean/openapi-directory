...
(function(root, factory) {
  ...
  describe('GetCorporationCorporationIdMiningObserversObserverId200Ok', function() {
    it('should create an instance of GetCorporationCorporationIdMiningObserversObserverId200Ok', function() {
      // uncomment below and update the code to test GetCorporationCorporationIdMiningObserversObserverId200Ok
      //var instance = new EveSwaggerInterface.GetCorporationCorporationIdMiningObserversObserverId200Ok();
    ...
    it('should have the property recordedCorporationId (base name: "recorded_corporation_id")', function() {
      // uncomment below and update the code to test the property recordedCorporationId
      //var instance = new EveSwaggerInterface.GetCorporationCorporationIdMiningObserversObserverId200Ok();
      //expect(instance).to.be();
    });
