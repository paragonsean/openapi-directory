...
(function(root, factory) {
  ...
  describe('GetCorporationsCorporationIdContractsContractIdBids200Ok', function() {
    it('should create an instance of GetCorporationsCorporationIdContractsContractIdBids200Ok', function() {
      // uncomment below and update the code to test GetCorporationsCorporationIdContractsContractIdBids200Ok
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdContractsContractIdBids200Ok();
    ...
    it('should have the property dateBid (base name: "date_bid")', function() {
      // uncomment below and update the code to test the property dateBid
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdContractsContractIdBids200Ok();
      //expect(instance).to.be();
    });
