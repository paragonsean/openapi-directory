...
(function(root, factory) {
  ...
  describe('GetDogmaDynamicItemsTypeIdItemIdDogmaEffect', function() {
    it('should create an instance of GetDogmaDynamicItemsTypeIdItemIdDogmaEffect', function() {
      // uncomment below and update the code to test GetDogmaDynamicItemsTypeIdItemIdDogmaEffect
      //var instance = new EveSwaggerInterface.GetDogmaDynamicItemsTypeIdItemIdDogmaEffect();
