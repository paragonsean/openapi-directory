...
(function(root, factory) {
  ...
  describe('GetFwLeaderboardsCorporationsLastWeekLastWeek', function() {
    it('should create an instance of GetFwLeaderboardsCorporationsLastWeekLastWeek', function() {
      // uncomment below and update the code to test GetFwLeaderboardsCorporationsLastWeekLastWeek
      //var instance = new EveSwaggerInterface.GetFwLeaderboardsCorporationsLastWeekLastWeek();
