...
(function(root, factory) {
  ...
  describe('GetFwLeaderboardsActiveTotalActiveTotal', function() {
    it('should create an instance of GetFwLeaderboardsActiveTotalActiveTotal', function() {
      // uncomment below and update the code to test GetFwLeaderboardsActiveTotalActiveTotal
      //var instance = new EveSwaggerInterface.GetFwLeaderboardsActiveTotalActiveTotal();
