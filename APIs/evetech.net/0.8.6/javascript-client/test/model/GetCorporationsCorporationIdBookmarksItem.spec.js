...
(function(root, factory) {
  ...
  describe('GetCorporationsCorporationIdBookmarksItem', function() {
    it('should create an instance of GetCorporationsCorporationIdBookmarksItem', function() {
      // uncomment below and update the code to test GetCorporationsCorporationIdBookmarksItem
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdBookmarksItem();
