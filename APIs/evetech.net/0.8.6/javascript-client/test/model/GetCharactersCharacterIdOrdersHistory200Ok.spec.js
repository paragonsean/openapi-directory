...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdOrdersHistory200Ok', function() {
    it('should create an instance of GetCharactersCharacterIdOrdersHistory200Ok', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdOrdersHistory200Ok
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdOrdersHistory200Ok();
    ...
    it('should have the property isCorporation (base name: "is_corporation")', function() {
      // uncomment below and update the code to test the property isCorporation
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdOrdersHistory200Ok();
      //expect(instance).to.be();
    });
