...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdFwStatsVictoryPoints', function() {
    it('should create an instance of GetCharactersCharacterIdFwStatsVictoryPoints', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdFwStatsVictoryPoints
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdFwStatsVictoryPoints();
