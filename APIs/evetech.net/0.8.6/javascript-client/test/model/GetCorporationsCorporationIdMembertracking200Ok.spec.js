...
(function(root, factory) {
  ...
  describe('GetCorporationsCorporationIdMembertracking200Ok', function() {
    it('should create an instance of GetCorporationsCorporationIdMembertracking200Ok', function() {
      // uncomment below and update the code to test GetCorporationsCorporationIdMembertracking200Ok
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdMembertracking200Ok();
    ...
    it('should have the property logoffDate (base name: "logoff_date")', function() {
      // uncomment below and update the code to test the property logoffDate
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdMembertracking200Ok();
      //expect(instance).to.be();
    });

    it('should have the property logonDate (base name: "logon_date")', function() {
      // uncomment below and update the code to test the property logonDate
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdMembertracking200Ok();
      //expect(instance).to.be();
    });
