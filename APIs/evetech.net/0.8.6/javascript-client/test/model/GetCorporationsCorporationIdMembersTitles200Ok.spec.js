...
(function(root, factory) {
  ...
  describe('GetCorporationsCorporationIdMembersTitles200Ok', function() {
    it('should create an instance of GetCorporationsCorporationIdMembersTitles200Ok', function() {
      // uncomment below and update the code to test GetCorporationsCorporationIdMembersTitles200Ok
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdMembersTitles200Ok();
