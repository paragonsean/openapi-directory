...
(function(root, factory) {
  ...
  describe('GetCorporationsCorporationIdFwStatsKills', function() {
    it('should create an instance of GetCorporationsCorporationIdFwStatsKills', function() {
      // uncomment below and update the code to test GetCorporationsCorporationIdFwStatsKills
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdFwStatsKills();
