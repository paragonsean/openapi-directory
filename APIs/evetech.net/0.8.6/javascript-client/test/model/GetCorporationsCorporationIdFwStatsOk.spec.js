...
(function(root, factory) {
  ...
  describe('GetCorporationsCorporationIdFwStatsOk', function() {
    it('should create an instance of GetCorporationsCorporationIdFwStatsOk', function() {
      // uncomment below and update the code to test GetCorporationsCorporationIdFwStatsOk
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdFwStatsOk();
