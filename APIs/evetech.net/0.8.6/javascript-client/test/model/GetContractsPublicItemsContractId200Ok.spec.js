...
(function(root, factory) {
  ...
  describe('GetContractsPublicItemsContractId200Ok', function() {
    it('should create an instance of GetContractsPublicItemsContractId200Ok', function() {
      // uncomment below and update the code to test GetContractsPublicItemsContractId200Ok
      //var instance = new EveSwaggerInterface.GetContractsPublicItemsContractId200Ok();
