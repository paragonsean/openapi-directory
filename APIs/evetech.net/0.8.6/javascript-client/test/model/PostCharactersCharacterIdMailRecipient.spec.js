...
(function(root, factory) {
  ...
  describe('PostCharactersCharacterIdMailRecipient', function() {
    it('should create an instance of PostCharactersCharacterIdMailRecipient', function() {
      // uncomment below and update the code to test PostCharactersCharacterIdMailRecipient
      //var instance = new EveSwaggerInterface.PostCharactersCharacterIdMailRecipient();
