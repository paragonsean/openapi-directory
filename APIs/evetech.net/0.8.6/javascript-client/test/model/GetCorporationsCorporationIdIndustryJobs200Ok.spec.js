...
(function(root, factory) {
  ...
  describe('GetCorporationsCorporationIdIndustryJobs200Ok', function() {
    it('should create an instance of GetCorporationsCorporationIdIndustryJobs200Ok', function() {
      // uncomment below and update the code to test GetCorporationsCorporationIdIndustryJobs200Ok
      //var instance = new EveSwaggerInterface.GetCorporationsCorporationIdIndustryJobs200Ok();
