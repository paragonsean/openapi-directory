...
(function(root, factory) {
  ...
  describe('PostCharactersCharacterIdAssetsLocations200Ok', function() {
    it('should create an instance of PostCharactersCharacterIdAssetsLocations200Ok', function() {
      // uncomment below and update the code to test PostCharactersCharacterIdAssetsLocations200Ok
      //var instance = new EveSwaggerInterface.PostCharactersCharacterIdAssetsLocations200Ok();
