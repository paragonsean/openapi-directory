...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdBookmarksItem', function() {
    it('should create an instance of GetCharactersCharacterIdBookmarksItem', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdBookmarksItem
      //var instance = new EveSwaggerInterface.GetCharactersCharacterIdBookmarksItem();
