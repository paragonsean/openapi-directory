...
(function(root, factory) {
  ...
  describe('GetFwLeaderboardsActiveTotalActiveTotal1', function() {
    it('should create an instance of GetFwLeaderboardsActiveTotalActiveTotal1', function() {
      // uncomment below and update the code to test GetFwLeaderboardsActiveTotalActiveTotal1
      //var instance = new EveSwaggerInterface.GetFwLeaderboardsActiveTotalActiveTotal1();
