...
class GetCorporationsCorporationIdAssets200Ok(Model):
    ...
    def __init__(self, is_blueprint_copy: bool=None, is_singleton: bool=None, item_id: int=None, location_flag: str=None, location_id: int=None, location_type: str=None, quantity: int=None, type_id: int=None):
        ...
        :param is_blueprint_copy: The is_blueprint_copy of this GetCorporationsCorporationIdAssets200Ok.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetCorporationsCorporationIdAssets200Ok':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The get_corporations_corporation_id_assets_200_ok of this GetCorporationsCorporationIdAssets200Ok.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def is_blueprint_copy(self):
        """Gets the is_blueprint_copy of this GetCorporationsCorporationIdAssets200Ok.

        is_blueprint_copy boolean

        :return: The is_blueprint_copy of this GetCorporationsCorporationIdAssets200Ok.
        :rtype: bool
        """
