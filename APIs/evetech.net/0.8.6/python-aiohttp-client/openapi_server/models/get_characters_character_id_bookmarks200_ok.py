...
class GetCharactersCharacterIdBookmarks200Ok(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, bookmark_id: int=None, coordinates: GetCharactersCharacterIdBookmarksCoordinates=None, created: datetime=None, creator_id: int=None, folder_id: int=None, item: GetCharactersCharacterIdBookmarksItem=None, label: str=None, location_id: int=None, notes: str=None):
        """GetCharactersCharacterIdBookmarks200Ok - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetCharactersCharacterIdBookmarks200Ok':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The get_characters_character_id_bookmarks_200_ok of this GetCharactersCharacterIdBookmarks200Ok.
        """
    ...
    def coordinates(self, coordinates):
        ...
        :param coordinates: The coordinates of this GetCharactersCharacterIdBookmarks200Ok.
        :type coordinates: GetCharactersCharacterIdBookmarksCoordinates
        """
    ...
    def item(self, item):
        ...
        :param item: The item of this GetCharactersCharacterIdBookmarks200Ok.
        :type item: GetCharactersCharacterIdBookmarksItem
        """
