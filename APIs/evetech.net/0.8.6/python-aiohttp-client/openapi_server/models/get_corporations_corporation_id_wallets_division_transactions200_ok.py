...
class GetCorporationsCorporationIdWalletsDivisionTransactions200Ok(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, client_id: int=None, _date: datetime=None, is_buy: bool=None, journal_ref_id: int=None, location_id: int=None, quantity: int=None, transaction_id: int=None, type_id: int=None, unit_price: float=None):
        """GetCorporationsCorporationIdWalletsDivisionTransactions200Ok - a model defined in OpenAPI

        :param client_id: The client_id of this GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.
        :param _date: The _date of this GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetCorporationsCorporationIdWalletsDivisionTransactions200Ok':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The get_corporations_corporation_id_wallets_division_transactions_200_ok of this GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.
        """
    ...
    @property
    def _date(self):
        """Gets the _date of this GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.

        Date and time of transaction

        :return: The _date of this GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.
        :rtype: datetime
        """
        return self.__date
