...
class GetCharactersCharacterIdContacts200Ok(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, contact_id: int=None, contact_type: str=None, is_blocked: bool=None, is_watched: bool=None, label_ids: List[int]=None, standing: float=None):
        """GetCharactersCharacterIdContacts200Ok - a model defined in OpenAPI
        ...
        :param label_ids: The label_ids of this GetCharactersCharacterIdContacts200Ok.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetCharactersCharacterIdContacts200Ok':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The get_characters_character_id_contacts_200_ok of this GetCharactersCharacterIdContacts200Ok.
        """
    ...
    @property
    def label_ids(self):
        """Gets the label_ids of this GetCharactersCharacterIdContacts200Ok.

        label_ids array

        :return: The label_ids of this GetCharactersCharacterIdContacts200Ok.
        :rtype: List[int]
        """
