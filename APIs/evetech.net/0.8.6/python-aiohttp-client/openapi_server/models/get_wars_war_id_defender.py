...
class GetWarsWarIdDefender(Model):
    ...
    def __init__(self, alliance_id: int=None, corporation_id: int=None, isk_destroyed: float=None, ships_killed: int=None):
        """GetWarsWarIdDefender - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetWarsWarIdDefender':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The get_wars_war_id_defender of this GetWarsWarIdDefender.
        """
