...
class GetCharactersCharacterIdOrders200Ok(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, duration: int=None, escrow: float=None, is_buy_order: bool=None, is_corporation: bool=None, issued: datetime=None, location_id: int=None, min_volume: int=None, order_id: int=None, price: float=None, range: str=None, region_id: int=None, type_id: int=None, volume_remain: int=None, volume_total: int=None):
        ...
        :param is_corporation: The is_corporation of this GetCharactersCharacterIdOrders200Ok.
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetCharactersCharacterIdOrders200Ok':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The get_characters_character_id_orders_200_ok of this GetCharactersCharacterIdOrders200Ok.
        """
    ...
    def is_corporation(self):
        """Gets the is_corporation of this GetCharactersCharacterIdOrders200Ok.

        Signifies whether the buy/sell order was placed on behalf of a corporation.

        :return: The is_corporation of this GetCharactersCharacterIdOrders200Ok.
        :rtype: bool
        """
