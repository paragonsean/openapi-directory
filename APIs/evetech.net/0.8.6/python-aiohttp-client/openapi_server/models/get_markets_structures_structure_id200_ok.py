...
class GetMarketsStructuresStructureId200Ok(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, duration: int=None, is_buy_order: bool=None, issued: datetime=None, location_id: int=None, min_volume: int=None, order_id: int=None, price: float=None, range: str=None, type_id: int=None, volume_remain: int=None, volume_total: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetMarketsStructuresStructureId200Ok':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The get_markets_structures_structure_id_200_ok of this GetMarketsStructuresStructureId200Ok.
        """
