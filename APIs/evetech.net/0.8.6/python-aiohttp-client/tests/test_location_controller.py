...
async def test_get_characters_character_id_location(client):
    ...
    response = await client.request(
        method='GET',
        path='/latest/characters/{character_id}/location'.format(character_id=56),
        headers=headers,
        params=params,
        )
...
async def test_get_characters_character_id_online(client):
    ...
    response = await client.request(
        method='GET',
        path='/latest/characters/{character_id}/online'.format(character_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_characters_character_id_ship(client):
    ...
    response = await client.request(
        method='GET',
        path='/latest/characters/{character_id}/ship'.format(character_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
