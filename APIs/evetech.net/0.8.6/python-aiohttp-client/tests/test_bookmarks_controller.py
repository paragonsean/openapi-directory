...
async def test_get_characters_character_id_bookmarks(client):
    ...
    response = await client.request(
        method='GET',
        path='/latest/characters/{character_id}/bookmarks'.format(character_id=56),
        headers=headers,
        params=params,
        )
...
async def test_get_characters_character_id_bookmarks_folders(client):
    ...
    response = await client.request(
        method='GET',
        path='/latest/characters/{character_id}/bookmarks/folders'.format(character_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_corporations_corporation_id_bookmarks(client):
    ...
    response = await client.request(
        method='GET',
        path='/latest/corporations/{corporation_id}/bookmarks'.format(corporation_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_corporations_corporation_id_bookmarks_folders(client):
    ...
    response = await client.request(
        method='GET',
        path='/latest/corporations/{corporation_id}/bookmarks/folders'.format(corporation_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
