...
|**fuelExpires** | **OffsetDateTime** | Date on which the structure will run out of fuel |  [optional] |
|**nextReinforceApply** | **OffsetDateTime** | The date and time when the structure&#39;s newly requested reinforcement times (e.g. next_reinforce_hour and next_reinforce_day) will take effect |  [optional] |
...
|**stateTimerEnd** | **OffsetDateTime** | Date at which the structure will move to it&#39;s next state |  [optional] |
|**stateTimerStart** | **OffsetDateTime** | Date at which the structure entered it&#39;s current state |  [optional] |
...
|**unanchorsAt** | **OffsetDateTime** | Date at which the structure will unanchor |  [optional] |
