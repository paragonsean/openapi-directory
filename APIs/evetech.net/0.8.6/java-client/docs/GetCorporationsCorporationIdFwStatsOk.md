...
|------------ | ------------- | ------------- | -------------|
|**enlistedOn** | **OffsetDateTime** | The enlistment date of the given corporation into faction warfare. Will not be included if corporation is not enlisted in faction warfare |  [optional] |
