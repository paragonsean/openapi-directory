...
|**completedDate** | **OffsetDateTime** | Date and time when this job was completed |  [optional] |
|**cost** | **Double** | The sume of job installation fee and industry facility tax |  [optional] |
|**duration** | **Integer** | Job duration in seconds |  |
|**endDate** | **OffsetDateTime** | Date and time when this job finished |  |
...
|**pauseDate** | **OffsetDateTime** | Date and time when this job was paused (i.e. time when the facility where this job was installed went offline) |  [optional] |
...
|**startDate** | **OffsetDateTime** | Date and time when this job started |  |
