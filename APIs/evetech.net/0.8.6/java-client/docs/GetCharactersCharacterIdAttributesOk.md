...
|------------ | ------------- | ------------- | -------------|
|**accruedRemapCooldownDate** | **OffsetDateTime** | Neural remapping cooldown after a character uses remap accrued over time |  [optional] |
...
|**lastRemapDate** | **OffsetDateTime** | Datetime of last neural remap, including usage of bonus remaps |  [optional] |
