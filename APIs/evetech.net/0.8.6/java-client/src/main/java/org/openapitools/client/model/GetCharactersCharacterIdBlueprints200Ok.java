...
public class GetCharactersCharacterIdBlueprints200Ok {
  ...
  public GetCharactersCharacterIdBlueprints200Ok() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCharactersCharacterIdBlueprints200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCharactersCharacterIdBlueprints200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCharactersCharacterIdBlueprints200Ok is not found in the empty JSON string", GetCharactersCharacterIdBlueprints200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCharactersCharacterIdBlueprints200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCharactersCharacterIdBlueprints200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCharactersCharacterIdBlueprints200Ok.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCharactersCharacterIdBlueprints200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCharactersCharacterIdBlueprints200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCharactersCharacterIdBlueprints200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCharactersCharacterIdBlueprints200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCharactersCharacterIdBlueprints200Ok>() {
           @Override
           public void write(JsonWriter out, GetCharactersCharacterIdBlueprints200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCharactersCharacterIdBlueprints200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCharactersCharacterIdBlueprints200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCharactersCharacterIdBlueprints200Ok
   * @throws IOException if the JSON string is invalid with respect to GetCharactersCharacterIdBlueprints200Ok
   */
  public static GetCharactersCharacterIdBlueprints200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCharactersCharacterIdBlueprints200Ok.class);
  }

  /**
   * Convert an instance of GetCharactersCharacterIdBlueprints200Ok to an JSON string
   *
   * @return JSON string
   */
