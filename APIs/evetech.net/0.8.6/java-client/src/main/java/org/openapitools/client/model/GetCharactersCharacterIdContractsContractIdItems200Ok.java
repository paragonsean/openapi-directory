...
public class GetCharactersCharacterIdContractsContractIdItems200Ok {
  ...
  public GetCharactersCharacterIdContractsContractIdItems200Ok() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCharactersCharacterIdContractsContractIdItems200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCharactersCharacterIdContractsContractIdItems200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCharactersCharacterIdContractsContractIdItems200Ok is not found in the empty JSON string", GetCharactersCharacterIdContractsContractIdItems200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCharactersCharacterIdContractsContractIdItems200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCharactersCharacterIdContractsContractIdItems200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCharactersCharacterIdContractsContractIdItems200Ok.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCharactersCharacterIdContractsContractIdItems200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCharactersCharacterIdContractsContractIdItems200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCharactersCharacterIdContractsContractIdItems200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCharactersCharacterIdContractsContractIdItems200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCharactersCharacterIdContractsContractIdItems200Ok>() {
           @Override
           public void write(JsonWriter out, GetCharactersCharacterIdContractsContractIdItems200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCharactersCharacterIdContractsContractIdItems200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCharactersCharacterIdContractsContractIdItems200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCharactersCharacterIdContractsContractIdItems200Ok
   * @throws IOException if the JSON string is invalid with respect to GetCharactersCharacterIdContractsContractIdItems200Ok
   */
  public static GetCharactersCharacterIdContractsContractIdItems200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCharactersCharacterIdContractsContractIdItems200Ok.class);
  }

  /**
   * Convert an instance of GetCharactersCharacterIdContractsContractIdItems200Ok to an JSON string
   *
   * @return JSON string
   */
