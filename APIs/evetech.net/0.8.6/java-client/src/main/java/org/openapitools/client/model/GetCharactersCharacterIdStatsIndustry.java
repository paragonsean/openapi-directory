...
public class GetCharactersCharacterIdStatsIndustry {
  ...
  static {
    ...
    openapiFields.add("hacking_successes");
    openapiFields.add("jobs_cancelled");
    openapiFields.add("jobs_completed_copy_blueprint");
    openapiFields.add("jobs_completed_invention");
    openapiFields.add("jobs_completed_manufacture");
    openapiFields.add("jobs_completed_manufacture_asteroid");
    openapiFields.add("jobs_completed_manufacture_asteroid_quantity");
    openapiFields.add("jobs_completed_manufacture_charge");
    openapiFields.add("jobs_completed_manufacture_charge_quantity");
    openapiFields.add("jobs_completed_manufacture_commodity");
    openapiFields.add("jobs_completed_manufacture_commodity_quantity");
    openapiFields.add("jobs_completed_manufacture_deployable");
    openapiFields.add("jobs_completed_manufacture_deployable_quantity");
    openapiFields.add("jobs_completed_manufacture_drone");
    openapiFields.add("jobs_completed_manufacture_drone_quantity");
    openapiFields.add("jobs_completed_manufacture_implant");
    openapiFields.add("jobs_completed_manufacture_implant_quantity");
    openapiFields.add("jobs_completed_manufacture_module");
    openapiFields.add("jobs_completed_manufacture_module_quantity");
    openapiFields.add("jobs_completed_manufacture_other");
    openapiFields.add("jobs_completed_manufacture_other_quantity");
    openapiFields.add("jobs_completed_manufacture_ship");
    openapiFields.add("jobs_completed_manufacture_ship_quantity");
    openapiFields.add("jobs_completed_manufacture_structure");
    openapiFields.add("jobs_completed_manufacture_structure_quantity");
    openapiFields.add("jobs_completed_manufacture_subsystem");
    openapiFields.add("jobs_completed_manufacture_subsystem_quantity");
    openapiFields.add("jobs_completed_material_productivity");
    openapiFields.add("jobs_completed_time_productivity");
    openapiFields.add("jobs_started_copy_blueprint");
    openapiFields.add("jobs_started_invention");
    openapiFields.add("jobs_started_manufacture");
    openapiFields.add("jobs_started_material_productivity");
    openapiFields.add("jobs_started_time_productivity");
    openapiFields.add("reprocess_item");
    openapiFields.add("reprocess_item_quantity");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCharactersCharacterIdStatsIndustry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCharactersCharacterIdStatsIndustry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCharactersCharacterIdStatsIndustry is not found in the empty JSON string", GetCharactersCharacterIdStatsIndustry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCharactersCharacterIdStatsIndustry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCharactersCharacterIdStatsIndustry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCharactersCharacterIdStatsIndustry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCharactersCharacterIdStatsIndustry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCharactersCharacterIdStatsIndustry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCharactersCharacterIdStatsIndustry.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCharactersCharacterIdStatsIndustry>() {
           @Override
           public void write(JsonWriter out, GetCharactersCharacterIdStatsIndustry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCharactersCharacterIdStatsIndustry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCharactersCharacterIdStatsIndustry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCharactersCharacterIdStatsIndustry
   * @throws IOException if the JSON string is invalid with respect to GetCharactersCharacterIdStatsIndustry
   */
  public static GetCharactersCharacterIdStatsIndustry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCharactersCharacterIdStatsIndustry.class);
  }

  /**
   * Convert an instance of GetCharactersCharacterIdStatsIndustry to an JSON string
   *
   * @return JSON string
   */
