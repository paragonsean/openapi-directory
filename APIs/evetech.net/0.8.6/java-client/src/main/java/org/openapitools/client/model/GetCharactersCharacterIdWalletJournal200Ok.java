...
public class GetCharactersCharacterIdWalletJournal200Ok {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCharactersCharacterIdWalletJournal200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCharactersCharacterIdWalletJournal200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCharactersCharacterIdWalletJournal200Ok is not found in the empty JSON string", GetCharactersCharacterIdWalletJournal200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCharactersCharacterIdWalletJournal200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCharactersCharacterIdWalletJournal200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCharactersCharacterIdWalletJournal200Ok.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCharactersCharacterIdWalletJournal200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCharactersCharacterIdWalletJournal200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCharactersCharacterIdWalletJournal200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCharactersCharacterIdWalletJournal200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCharactersCharacterIdWalletJournal200Ok>() {
           @Override
           public void write(JsonWriter out, GetCharactersCharacterIdWalletJournal200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCharactersCharacterIdWalletJournal200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCharactersCharacterIdWalletJournal200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCharactersCharacterIdWalletJournal200Ok
   * @throws IOException if the JSON string is invalid with respect to GetCharactersCharacterIdWalletJournal200Ok
   */
  public static GetCharactersCharacterIdWalletJournal200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCharactersCharacterIdWalletJournal200Ok.class);
  }

  /**
   * Convert an instance of GetCharactersCharacterIdWalletJournal200Ok to an JSON string
   *
   * @return JSON string
   */
