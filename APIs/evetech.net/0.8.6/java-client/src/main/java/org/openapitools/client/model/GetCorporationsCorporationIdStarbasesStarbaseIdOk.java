...
public class GetCorporationsCorporationIdStarbasesStarbaseIdOk {
  ...
  private List<GetCorporationsCorporationIdStarbasesStarbaseIdFuel> fuels = new ArrayList<>();
  ...
  public GetCorporationsCorporationIdStarbasesStarbaseIdOk() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCorporationsCorporationIdStarbasesStarbaseIdOk
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCorporationsCorporationIdStarbasesStarbaseIdOk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCorporationsCorporationIdStarbasesStarbaseIdOk is not found in the empty JSON string", GetCorporationsCorporationIdStarbasesStarbaseIdOk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCorporationsCorporationIdStarbasesStarbaseIdOk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCorporationsCorporationIdStarbasesStarbaseIdOk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCorporationsCorporationIdStarbasesStarbaseIdOk.openapiRequiredFields) {
      ...
      if (!jsonObj.get("fuel_bay_take").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fuel_bay_take` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fuel_bay_take").toString()));
      }
      ...
      if (!jsonObj.get("fuel_bay_view").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fuel_bay_view` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fuel_bay_view").toString()));
      }
      ...
      if (jsonObj.get("fuels") != null && !jsonObj.get("fuels").isJsonNull()) {
        ...
        if (jsonArrayfuels != null) {
          ...
          if (!jsonObj.get("fuels").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `fuels` to be an array in the JSON string but got `%s`", jsonObj.get("fuels").toString()));
          }

          // validate the optional field `fuels` (array)
          for (int i = 0; i < jsonArrayfuels.size(); i++) {
            GetCorporationsCorporationIdStarbasesStarbaseIdFuel.validateJsonElement(jsonArrayfuels.get(i));
          };
        }
      }
      if (!jsonObj.get("offline").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `offline` to be a primitive type in the JSON string but got `%s`", jsonObj.get("offline").toString()));
      }
      ...
      if (!jsonObj.get("online").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `online` to be a primitive type in the JSON string but got `%s`", jsonObj.get("online").toString()));
      }
      ...
      if (!jsonObj.get("unanchor").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `unanchor` to be a primitive type in the JSON string but got `%s`", jsonObj.get("unanchor").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCorporationsCorporationIdStarbasesStarbaseIdOk.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCorporationsCorporationIdStarbasesStarbaseIdOk' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCorporationsCorporationIdStarbasesStarbaseIdOk> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCorporationsCorporationIdStarbasesStarbaseIdOk.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCorporationsCorporationIdStarbasesStarbaseIdOk>() {
           @Override
           public void write(JsonWriter out, GetCorporationsCorporationIdStarbasesStarbaseIdOk value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCorporationsCorporationIdStarbasesStarbaseIdOk read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCorporationsCorporationIdStarbasesStarbaseIdOk given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCorporationsCorporationIdStarbasesStarbaseIdOk
   * @throws IOException if the JSON string is invalid with respect to GetCorporationsCorporationIdStarbasesStarbaseIdOk
   */
  public static GetCorporationsCorporationIdStarbasesStarbaseIdOk fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCorporationsCorporationIdStarbasesStarbaseIdOk.class);
  }

  /**
   * Convert an instance of GetCorporationsCorporationIdStarbasesStarbaseIdOk to an JSON string
   *
   * @return JSON string
   */
