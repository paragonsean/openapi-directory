...
public class GetCharactersCharacterIdOrdersHistory200Ok {
  ...
  public GetCharactersCharacterIdOrdersHistory200Ok() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCharactersCharacterIdOrdersHistory200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCharactersCharacterIdOrdersHistory200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCharactersCharacterIdOrdersHistory200Ok is not found in the empty JSON string", GetCharactersCharacterIdOrdersHistory200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCharactersCharacterIdOrdersHistory200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCharactersCharacterIdOrdersHistory200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCharactersCharacterIdOrdersHistory200Ok.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCharactersCharacterIdOrdersHistory200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCharactersCharacterIdOrdersHistory200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCharactersCharacterIdOrdersHistory200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCharactersCharacterIdOrdersHistory200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCharactersCharacterIdOrdersHistory200Ok>() {
           @Override
           public void write(JsonWriter out, GetCharactersCharacterIdOrdersHistory200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCharactersCharacterIdOrdersHistory200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCharactersCharacterIdOrdersHistory200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCharactersCharacterIdOrdersHistory200Ok
   * @throws IOException if the JSON string is invalid with respect to GetCharactersCharacterIdOrdersHistory200Ok
   */
  public static GetCharactersCharacterIdOrdersHistory200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCharactersCharacterIdOrdersHistory200Ok.class);
  }

  /**
   * Convert an instance of GetCharactersCharacterIdOrdersHistory200Ok to an JSON string
   *
   * @return JSON string
   */
