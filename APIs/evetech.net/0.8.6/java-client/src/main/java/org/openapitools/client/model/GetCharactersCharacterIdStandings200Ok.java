...
public class GetCharactersCharacterIdStandings200Ok {
  ...
  public GetCharactersCharacterIdStandings200Ok() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCharactersCharacterIdStandings200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCharactersCharacterIdStandings200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCharactersCharacterIdStandings200Ok is not found in the empty JSON string", GetCharactersCharacterIdStandings200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCharactersCharacterIdStandings200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCharactersCharacterIdStandings200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCharactersCharacterIdStandings200Ok.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCharactersCharacterIdStandings200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCharactersCharacterIdStandings200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCharactersCharacterIdStandings200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCharactersCharacterIdStandings200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCharactersCharacterIdStandings200Ok>() {
           @Override
           public void write(JsonWriter out, GetCharactersCharacterIdStandings200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCharactersCharacterIdStandings200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCharactersCharacterIdStandings200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCharactersCharacterIdStandings200Ok
   * @throws IOException if the JSON string is invalid with respect to GetCharactersCharacterIdStandings200Ok
   */
  public static GetCharactersCharacterIdStandings200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCharactersCharacterIdStandings200Ok.class);
  }

  /**
   * Convert an instance of GetCharactersCharacterIdStandings200Ok to an JSON string
   *
   * @return JSON string
   */
