...
public class GetContractsPublicItemsContractId200Ok {
  ...
  public GetContractsPublicItemsContractId200Ok() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetContractsPublicItemsContractId200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetContractsPublicItemsContractId200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetContractsPublicItemsContractId200Ok is not found in the empty JSON string", GetContractsPublicItemsContractId200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetContractsPublicItemsContractId200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetContractsPublicItemsContractId200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetContractsPublicItemsContractId200Ok.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetContractsPublicItemsContractId200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetContractsPublicItemsContractId200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetContractsPublicItemsContractId200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetContractsPublicItemsContractId200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetContractsPublicItemsContractId200Ok>() {
           @Override
           public void write(JsonWriter out, GetContractsPublicItemsContractId200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetContractsPublicItemsContractId200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetContractsPublicItemsContractId200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetContractsPublicItemsContractId200Ok
   * @throws IOException if the JSON string is invalid with respect to GetContractsPublicItemsContractId200Ok
   */
  public static GetContractsPublicItemsContractId200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetContractsPublicItemsContractId200Ok.class);
  }

  /**
   * Convert an instance of GetContractsPublicItemsContractId200Ok to an JSON string
   *
   * @return JSON string
   */
