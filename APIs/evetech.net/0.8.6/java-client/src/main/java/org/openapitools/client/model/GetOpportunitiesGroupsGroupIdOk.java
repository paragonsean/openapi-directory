...
public class GetOpportunitiesGroupsGroupIdOk {
  ...
  public GetOpportunitiesGroupsGroupIdOk() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOpportunitiesGroupsGroupIdOk
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOpportunitiesGroupsGroupIdOk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOpportunitiesGroupsGroupIdOk is not found in the empty JSON string", GetOpportunitiesGroupsGroupIdOk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOpportunitiesGroupsGroupIdOk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOpportunitiesGroupsGroupIdOk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetOpportunitiesGroupsGroupIdOk.openapiRequiredFields) {
      ...
      if (jsonObj.get("connected_groups") == null) {
        ...
        throw new IllegalArgumentException(String.format("Expected the field `connected_groups` to be an array in the JSON string but got `%s`", jsonObj.get("connected_groups").toString()));
      }
      ...
      if (jsonObj.get("required_tasks") == null) {
        ...
        throw new IllegalArgumentException(String.format("Expected the field `required_tasks` to be an array in the JSON string but got `%s`", jsonObj.get("required_tasks").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOpportunitiesGroupsGroupIdOk.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOpportunitiesGroupsGroupIdOk' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOpportunitiesGroupsGroupIdOk> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOpportunitiesGroupsGroupIdOk.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOpportunitiesGroupsGroupIdOk>() {
           @Override
           public void write(JsonWriter out, GetOpportunitiesGroupsGroupIdOk value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOpportunitiesGroupsGroupIdOk read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOpportunitiesGroupsGroupIdOk given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOpportunitiesGroupsGroupIdOk
   * @throws IOException if the JSON string is invalid with respect to GetOpportunitiesGroupsGroupIdOk
   */
  public static GetOpportunitiesGroupsGroupIdOk fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOpportunitiesGroupsGroupIdOk.class);
  }

  /**
   * Convert an instance of GetOpportunitiesGroupsGroupIdOk to an JSON string
   *
   * @return JSON string
   */
