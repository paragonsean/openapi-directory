...
public class GetFwLeaderboardsCorporationsKills {
  ...
  public GetFwLeaderboardsCorporationsKills() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFwLeaderboardsCorporationsKills
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFwLeaderboardsCorporationsKills.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFwLeaderboardsCorporationsKills is not found in the empty JSON string", GetFwLeaderboardsCorporationsKills.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFwLeaderboardsCorporationsKills.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFwLeaderboardsCorporationsKills` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetFwLeaderboardsCorporationsKills.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayactiveTotal.size(); i++) {
        GetFwLeaderboardsCorporationsActiveTotalActiveTotal.validateJsonElement(jsonArrayactiveTotal.get(i));
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArraylastWeek.size(); i++) {
        GetFwLeaderboardsCorporationsLastWeekLastWeek.validateJsonElement(jsonArraylastWeek.get(i));
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayyesterday.size(); i++) {
        GetFwLeaderboardsCorporationsYesterdayYesterday.validateJsonElement(jsonArrayyesterday.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFwLeaderboardsCorporationsKills.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFwLeaderboardsCorporationsKills' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFwLeaderboardsCorporationsKills> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFwLeaderboardsCorporationsKills.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFwLeaderboardsCorporationsKills>() {
           @Override
           public void write(JsonWriter out, GetFwLeaderboardsCorporationsKills value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFwLeaderboardsCorporationsKills read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFwLeaderboardsCorporationsKills given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFwLeaderboardsCorporationsKills
   * @throws IOException if the JSON string is invalid with respect to GetFwLeaderboardsCorporationsKills
   */
  public static GetFwLeaderboardsCorporationsKills fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFwLeaderboardsCorporationsKills.class);
  }

  /**
   * Convert an instance of GetFwLeaderboardsCorporationsKills to an JSON string
   *
   * @return JSON string
   */
