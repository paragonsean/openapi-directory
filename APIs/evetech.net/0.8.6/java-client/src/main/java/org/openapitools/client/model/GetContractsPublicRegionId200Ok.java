...
public class GetContractsPublicRegionId200Ok {
  ...
  public GetContractsPublicRegionId200Ok() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetContractsPublicRegionId200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetContractsPublicRegionId200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetContractsPublicRegionId200Ok is not found in the empty JSON string", GetContractsPublicRegionId200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetContractsPublicRegionId200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetContractsPublicRegionId200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetContractsPublicRegionId200Ok.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetContractsPublicRegionId200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetContractsPublicRegionId200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetContractsPublicRegionId200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetContractsPublicRegionId200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetContractsPublicRegionId200Ok>() {
           @Override
           public void write(JsonWriter out, GetContractsPublicRegionId200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetContractsPublicRegionId200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetContractsPublicRegionId200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetContractsPublicRegionId200Ok
   * @throws IOException if the JSON string is invalid with respect to GetContractsPublicRegionId200Ok
   */
  public static GetContractsPublicRegionId200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetContractsPublicRegionId200Ok.class);
  }

  /**
   * Convert an instance of GetContractsPublicRegionId200Ok to an JSON string
   *
   * @return JSON string
   */
