...
public class GetCorporationsCorporationIdRoles200Ok {
  ...
  public GetCorporationsCorporationIdRoles200Ok() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCorporationsCorporationIdRoles200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCorporationsCorporationIdRoles200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCorporationsCorporationIdRoles200Ok is not found in the empty JSON string", GetCorporationsCorporationIdRoles200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCorporationsCorporationIdRoles200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCorporationsCorporationIdRoles200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCorporationsCorporationIdRoles200Ok.openapiRequiredFields) {
      ...
      if (jsonObj.get("grantable_roles") != null && !jsonObj.get("grantable_roles").isJsonNull() && !jsonObj.get("grantable_roles").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `grantable_roles` to be an array in the JSON string but got `%s`", jsonObj.get("grantable_roles").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("grantable_roles_at_base") != null && !jsonObj.get("grantable_roles_at_base").isJsonNull() && !jsonObj.get("grantable_roles_at_base").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `grantable_roles_at_base` to be an array in the JSON string but got `%s`", jsonObj.get("grantable_roles_at_base").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("grantable_roles_at_hq") != null && !jsonObj.get("grantable_roles_at_hq").isJsonNull() && !jsonObj.get("grantable_roles_at_hq").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `grantable_roles_at_hq` to be an array in the JSON string but got `%s`", jsonObj.get("grantable_roles_at_hq").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("grantable_roles_at_other") != null && !jsonObj.get("grantable_roles_at_other").isJsonNull() && !jsonObj.get("grantable_roles_at_other").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `grantable_roles_at_other` to be an array in the JSON string but got `%s`", jsonObj.get("grantable_roles_at_other").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCorporationsCorporationIdRoles200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCorporationsCorporationIdRoles200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCorporationsCorporationIdRoles200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCorporationsCorporationIdRoles200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCorporationsCorporationIdRoles200Ok>() {
           @Override
           public void write(JsonWriter out, GetCorporationsCorporationIdRoles200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCorporationsCorporationIdRoles200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCorporationsCorporationIdRoles200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCorporationsCorporationIdRoles200Ok
   * @throws IOException if the JSON string is invalid with respect to GetCorporationsCorporationIdRoles200Ok
   */
  public static GetCorporationsCorporationIdRoles200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCorporationsCorporationIdRoles200Ok.class);
  }

  /**
   * Convert an instance of GetCorporationsCorporationIdRoles200Ok to an JSON string
   *
   * @return JSON string
   */
