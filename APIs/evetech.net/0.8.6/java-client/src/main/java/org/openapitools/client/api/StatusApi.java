...
public class StatusApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Server status </td><td>  * Cache-Control - The caching mechanism used <br>  * ETag - RFC7232 compliant entity tag <br>  * Expires - RFC7231 formatted datetime string <br>  * Last-Modified - RFC7231 formatted datetime string <br>  </td></tr>
     ...
     */
    public okhttp3.Call getStatusCall(String datasource, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getStatusValidateBeforeCall(String datasource, String ifNoneMatch, final ApiCallback _callback) throws ApiException {
    ...
    public GetStatusOk getStatus(String datasource, String ifNoneMatch) throws ApiException {
        ApiResponse<GetStatusOk> localVarResp = getStatusWithHttpInfo(datasource, ifNoneMatch);
     ...
     */
    public okhttp3.Call getStatusAsync(String datasource, String ifNoneMatch, final ApiCallback<GetStatusOk> _callback) throws ApiException {
