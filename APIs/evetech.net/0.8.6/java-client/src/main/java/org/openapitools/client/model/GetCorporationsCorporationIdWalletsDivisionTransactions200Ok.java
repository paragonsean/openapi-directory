...
public class GetCorporationsCorporationIdWalletsDivisionTransactions200Ok {
  ...
  public GetCorporationsCorporationIdWalletsDivisionTransactions200Ok() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCorporationsCorporationIdWalletsDivisionTransactions200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCorporationsCorporationIdWalletsDivisionTransactions200Ok is not found in the empty JSON string", GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCorporationsCorporationIdWalletsDivisionTransactions200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCorporationsCorporationIdWalletsDivisionTransactions200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCorporationsCorporationIdWalletsDivisionTransactions200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCorporationsCorporationIdWalletsDivisionTransactions200Ok>() {
           @Override
           public void write(JsonWriter out, GetCorporationsCorporationIdWalletsDivisionTransactions200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCorporationsCorporationIdWalletsDivisionTransactions200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCorporationsCorporationIdWalletsDivisionTransactions200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCorporationsCorporationIdWalletsDivisionTransactions200Ok
   * @throws IOException if the JSON string is invalid with respect to GetCorporationsCorporationIdWalletsDivisionTransactions200Ok
   */
  public static GetCorporationsCorporationIdWalletsDivisionTransactions200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCorporationsCorporationIdWalletsDivisionTransactions200Ok.class);
  }

  /**
   * Convert an instance of GetCorporationsCorporationIdWalletsDivisionTransactions200Ok to an JSON string
   *
   * @return JSON string
   */
