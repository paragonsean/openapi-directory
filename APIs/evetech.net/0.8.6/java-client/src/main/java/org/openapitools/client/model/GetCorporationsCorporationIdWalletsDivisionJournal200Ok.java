...
public class GetCorporationsCorporationIdWalletsDivisionJournal200Ok {
  ...
  public GetCorporationsCorporationIdWalletsDivisionJournal200Ok() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCorporationsCorporationIdWalletsDivisionJournal200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCorporationsCorporationIdWalletsDivisionJournal200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCorporationsCorporationIdWalletsDivisionJournal200Ok is not found in the empty JSON string", GetCorporationsCorporationIdWalletsDivisionJournal200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCorporationsCorporationIdWalletsDivisionJournal200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCorporationsCorporationIdWalletsDivisionJournal200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetCorporationsCorporationIdWalletsDivisionJournal200Ok.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("context_id_type") != null && !jsonObj.get("context_id_type").isJsonNull()) && !jsonObj.get("context_id_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `context_id_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("context_id_type").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCorporationsCorporationIdWalletsDivisionJournal200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCorporationsCorporationIdWalletsDivisionJournal200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCorporationsCorporationIdWalletsDivisionJournal200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCorporationsCorporationIdWalletsDivisionJournal200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCorporationsCorporationIdWalletsDivisionJournal200Ok>() {
           @Override
           public void write(JsonWriter out, GetCorporationsCorporationIdWalletsDivisionJournal200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCorporationsCorporationIdWalletsDivisionJournal200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCorporationsCorporationIdWalletsDivisionJournal200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCorporationsCorporationIdWalletsDivisionJournal200Ok
   * @throws IOException if the JSON string is invalid with respect to GetCorporationsCorporationIdWalletsDivisionJournal200Ok
   */
  public static GetCorporationsCorporationIdWalletsDivisionJournal200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCorporationsCorporationIdWalletsDivisionJournal200Ok.class);
  }

  /**
   * Convert an instance of GetCorporationsCorporationIdWalletsDivisionJournal200Ok to an JSON string
   *
   * @return JSON string
   */
