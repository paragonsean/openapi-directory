...
public class GetUniverseConstellationsConstellationIdOk {
  ...
  public GetUniverseConstellationsConstellationIdOk() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUniverseConstellationsConstellationIdOk
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUniverseConstellationsConstellationIdOk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUniverseConstellationsConstellationIdOk is not found in the empty JSON string", GetUniverseConstellationsConstellationIdOk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUniverseConstellationsConstellationIdOk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUniverseConstellationsConstellationIdOk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetUniverseConstellationsConstellationIdOk.openapiRequiredFields) {
      ...
      GetUniverseConstellationsConstellationIdPosition.validateJsonElement(jsonObj.get("position"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUniverseConstellationsConstellationIdOk.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUniverseConstellationsConstellationIdOk' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUniverseConstellationsConstellationIdOk> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUniverseConstellationsConstellationIdOk.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUniverseConstellationsConstellationIdOk>() {
           @Override
           public void write(JsonWriter out, GetUniverseConstellationsConstellationIdOk value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUniverseConstellationsConstellationIdOk read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUniverseConstellationsConstellationIdOk given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUniverseConstellationsConstellationIdOk
   * @throws IOException if the JSON string is invalid with respect to GetUniverseConstellationsConstellationIdOk
   */
  public static GetUniverseConstellationsConstellationIdOk fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUniverseConstellationsConstellationIdOk.class);
  }

  /**
   * Convert an instance of GetUniverseConstellationsConstellationIdOk to an JSON string
   *
   * @return JSON string
   */
