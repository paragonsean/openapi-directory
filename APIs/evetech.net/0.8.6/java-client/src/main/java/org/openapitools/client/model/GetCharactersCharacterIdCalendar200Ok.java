...
public class GetCharactersCharacterIdCalendar200Ok {
  ...
  public GetCharactersCharacterIdCalendar200Ok() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCharactersCharacterIdCalendar200Ok
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCharactersCharacterIdCalendar200Ok.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCharactersCharacterIdCalendar200Ok is not found in the empty JSON string", GetCharactersCharacterIdCalendar200Ok.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCharactersCharacterIdCalendar200Ok.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCharactersCharacterIdCalendar200Ok` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCharactersCharacterIdCalendar200Ok.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCharactersCharacterIdCalendar200Ok' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCharactersCharacterIdCalendar200Ok> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCharactersCharacterIdCalendar200Ok.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCharactersCharacterIdCalendar200Ok>() {
           @Override
           public void write(JsonWriter out, GetCharactersCharacterIdCalendar200Ok value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCharactersCharacterIdCalendar200Ok read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCharactersCharacterIdCalendar200Ok given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCharactersCharacterIdCalendar200Ok
   * @throws IOException if the JSON string is invalid with respect to GetCharactersCharacterIdCalendar200Ok
   */
  public static GetCharactersCharacterIdCalendar200Ok fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCharactersCharacterIdCalendar200Ok.class);
  }

  /**
   * Convert an instance of GetCharactersCharacterIdCalendar200Ok to an JSON string
   *
   * @return JSON string
   */
