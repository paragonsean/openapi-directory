...
- API version: 0.8.6
  - Build date: 2024-10-12T11:27:54.306821-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:0.8.6"
  }
```
...
* `target/openapi-java-client-0.8.6.jar`
* `target/lib/*.jar`
