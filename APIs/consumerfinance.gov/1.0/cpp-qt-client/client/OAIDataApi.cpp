...
void OAIDataApi::getDataset(const QString &dataset) {
    QString fullPath = QString(_serverConfigs["getDataset"][_serverIndices.value("getDataset")].URL()+"/data/{dataset}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDataApi::getDatasetCallback);
...
void OAIDataApi::getDatasetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getDatasetSignal();
        Q_EMIT getDatasetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getDatasetSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getDatasetSignalError(error_type, error_str);
        Q_EMIT getDatasetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDataApi::getDatasets() {
    QString fullPath = QString(_serverConfigs["getDatasets"][_serverIndices.value("getDatasets")].URL()+"/data");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDataApi::getDatasetsCallback);
    connect(this, &OAIDataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDataApi::getDatasetsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getDatasetsSignal();
        Q_EMIT getDatasetsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getDatasetsSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getDatasetsSignalError(error_type, error_str);
