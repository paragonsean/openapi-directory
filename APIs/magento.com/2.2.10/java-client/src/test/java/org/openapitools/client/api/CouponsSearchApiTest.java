...
/**
 * API tests for CouponsSearchApi
 */
@Disabled
public class CouponsSearchApiTest {

    private final CouponsSearchApi api = new CouponsSearchApi();
     ...
     */
    @Test
    public void salesRuleCouponRepositoryV1GetListGetTest() throws ApiException {
