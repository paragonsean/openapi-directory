...
/**
 * API tests for CartsSearchApi
 */
@Disabled
public class CartsSearchApiTest {

    private final CartsSearchApi api = new CartsSearchApi();
     ...
     */
    @Test
    public void quoteCartRepositoryV1GetListGetTest() throws ApiException {
        ...
        QuoteDataCartSearchResultsInterface response = api.quoteCartRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
