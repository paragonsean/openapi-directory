...
public class CreditmemosApiTest {
    ...
    private final CreditmemosApi api = new CreditmemosApi();
     ...
     */
    @Test
    public void salesCreditmemoRepositoryV1GetListGetTest() throws ApiException {
        ...
        SalesDataCreditmemoSearchResultInterface response = api.salesCreditmemoRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
