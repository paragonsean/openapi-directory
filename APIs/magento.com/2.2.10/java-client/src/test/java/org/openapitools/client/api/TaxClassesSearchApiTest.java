...
/**
 * API tests for TaxClassesSearchApi
 */
@Disabled
public class TaxClassesSearchApiTest {

    private final TaxClassesSearchApi api = new TaxClassesSearchApi();
     ...
     */
    @Test
    public void taxTaxClassRepositoryV1GetListGetTest() throws ApiException {
