...
public class CatalogDataProductOptionExtensionInterface {
  ...
  public CatalogDataProductOptionExtensionInterface() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bundleOptions, catalogDataProductOptionExtensionInterface.bundleOptions) &&
        Objects.equals(this.configurableItemOptions, catalogDataProductOptionExtensionInterface.configurableItemOptions) &&
        Objects.equals(this.customOptions, catalogDataProductOptionExtensionInterface.customOptions) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CatalogDataProductOptionExtensionInterface
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CatalogDataProductOptionExtensionInterface.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CatalogDataProductOptionExtensionInterface is not found in the empty JSON string", CatalogDataProductOptionExtensionInterface.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CatalogDataProductOptionExtensionInterface.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CatalogDataProductOptionExtensionInterface` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CatalogDataProductOptionExtensionInterface.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CatalogDataProductOptionExtensionInterface' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CatalogDataProductOptionExtensionInterface> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CatalogDataProductOptionExtensionInterface.class));

       return (TypeAdapter<T>) new TypeAdapter<CatalogDataProductOptionExtensionInterface>() {
           @Override
           public void write(JsonWriter out, CatalogDataProductOptionExtensionInterface value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CatalogDataProductOptionExtensionInterface read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CatalogDataProductOptionExtensionInterface given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CatalogDataProductOptionExtensionInterface
   * @throws IOException if the JSON string is invalid with respect to CatalogDataProductOptionExtensionInterface
   */
  public static CatalogDataProductOptionExtensionInterface fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CatalogDataProductOptionExtensionInterface.class);
  }

  /**
   * Convert an instance of CatalogDataProductOptionExtensionInterface to an JSON string
   *
   * @return JSON string
   */
