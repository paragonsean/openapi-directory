...
public class ApiClient {
    ...
    private String basePath = "https://example.com/rest/default";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://example.com/rest/default",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.2.10/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://example.com/rest/default
