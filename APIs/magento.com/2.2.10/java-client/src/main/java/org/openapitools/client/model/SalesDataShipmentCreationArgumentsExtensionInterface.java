...
public class SalesDataShipmentCreationArgumentsExtensionInterface {
  ...
  public SalesDataShipmentCreationArgumentsExtensionInterface() {
  }

  public SalesDataShipmentCreationArgumentsExtensionInterface extLocationId(String extLocationId) {
  ...
  public SalesDataShipmentCreationArgumentsExtensionInterface extReturnShipmentId(String extReturnShipmentId) {
  ...
  public SalesDataShipmentCreationArgumentsExtensionInterface extShipmentId(String extShipmentId) {
  ...
  public SalesDataShipmentCreationArgumentsExtensionInterface extTrackingReference(String extTrackingReference) {
  ...
  public SalesDataShipmentCreationArgumentsExtensionInterface extTrackingUrl(String extTrackingUrl) {
  ...
  public SalesDataShipmentCreationArgumentsExtensionInterface shippingLabel(String shippingLabel) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.extLocationId, salesDataShipmentCreationArgumentsExtensionInterface.extLocationId) &&
        Objects.equals(this.extReturnShipmentId, salesDataShipmentCreationArgumentsExtensionInterface.extReturnShipmentId) &&
        Objects.equals(this.extShipmentId, salesDataShipmentCreationArgumentsExtensionInterface.extShipmentId) &&
        Objects.equals(this.extTrackingReference, salesDataShipmentCreationArgumentsExtensionInterface.extTrackingReference) &&
        Objects.equals(this.extTrackingUrl, salesDataShipmentCreationArgumentsExtensionInterface.extTrackingUrl) &&
        Objects.equals(this.shippingLabel, salesDataShipmentCreationArgumentsExtensionInterface.shippingLabel);
  }

  @Override
  public int hashCode() {
    return Objects.hash(extLocationId, extReturnShipmentId, extShipmentId, extTrackingReference, extTrackingUrl, shippingLabel);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SalesDataShipmentCreationArgumentsExtensionInterface
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SalesDataShipmentCreationArgumentsExtensionInterface.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SalesDataShipmentCreationArgumentsExtensionInterface is not found in the empty JSON string", SalesDataShipmentCreationArgumentsExtensionInterface.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SalesDataShipmentCreationArgumentsExtensionInterface.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SalesDataShipmentCreationArgumentsExtensionInterface` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SalesDataShipmentCreationArgumentsExtensionInterface.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SalesDataShipmentCreationArgumentsExtensionInterface' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SalesDataShipmentCreationArgumentsExtensionInterface> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SalesDataShipmentCreationArgumentsExtensionInterface.class));

       return (TypeAdapter<T>) new TypeAdapter<SalesDataShipmentCreationArgumentsExtensionInterface>() {
           @Override
           public void write(JsonWriter out, SalesDataShipmentCreationArgumentsExtensionInterface value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SalesDataShipmentCreationArgumentsExtensionInterface read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SalesDataShipmentCreationArgumentsExtensionInterface given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SalesDataShipmentCreationArgumentsExtensionInterface
   * @throws IOException if the JSON string is invalid with respect to SalesDataShipmentCreationArgumentsExtensionInterface
   */
  public static SalesDataShipmentCreationArgumentsExtensionInterface fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SalesDataShipmentCreationArgumentsExtensionInterface.class);
  }

  /**
   * Convert an instance of SalesDataShipmentCreationArgumentsExtensionInterface to an JSON string
   *
   * @return JSON string
   */
