...
public class FrameworkCriteriaInterface {
  ...
  public FrameworkCriteriaInterface() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.criteriaList, frameworkCriteriaInterface.criteriaList) &&
        Objects.equals(this.filters, frameworkCriteriaInterface.filters) &&
        Objects.equals(this.limit, frameworkCriteriaInterface.limit) &&
        Objects.equals(this.mapperInterfaceName, frameworkCriteriaInterface.mapperInterfaceName) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to FrameworkCriteriaInterface
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FrameworkCriteriaInterface.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FrameworkCriteriaInterface is not found in the empty JSON string", FrameworkCriteriaInterface.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FrameworkCriteriaInterface.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FrameworkCriteriaInterface` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FrameworkCriteriaInterface.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FrameworkCriteriaInterface.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FrameworkCriteriaInterface' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FrameworkCriteriaInterface> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FrameworkCriteriaInterface.class));

       return (TypeAdapter<T>) new TypeAdapter<FrameworkCriteriaInterface>() {
           @Override
           public void write(JsonWriter out, FrameworkCriteriaInterface value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FrameworkCriteriaInterface read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FrameworkCriteriaInterface given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FrameworkCriteriaInterface
   * @throws IOException if the JSON string is invalid with respect to FrameworkCriteriaInterface
   */
  public static FrameworkCriteriaInterface fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FrameworkCriteriaInterface.class);
  }

  /**
   * Convert an instance of FrameworkCriteriaInterface to an JSON string
   *
   * @return JSON string
   */
