...
public class ErrorResponse {
  ...
  private List<ErrorErrorsItem> errors = new ArrayList<>();
  ...
  private List<ErrorParametersItem> parameters = new ArrayList<>();
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, errors, message, parameters, trace);
  }
      ...
      if (jsonObj.get("errors") != null && !jsonObj.get("errors").isJsonNull()) {
        ...
        if (jsonArrayerrors != null) {
          ...
          for (int i = 0; i < jsonArrayerrors.size(); i++) {
            ErrorErrorsItem.validateJsonElement(jsonArrayerrors.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("parameters") != null && !jsonObj.get("parameters").isJsonNull()) {
        ...
        if (jsonArrayparameters != null) {
          ...
          for (int i = 0; i < jsonArrayparameters.size(); i++) {
            ErrorParametersItem.validateJsonElement(jsonArrayparameters.get(i));
          };
        }
      }
