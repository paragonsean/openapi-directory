...
|------------- | ------------- | -------------|
| [**salesShipmentRepositoryV1GetListGet**](ShipmentsApi.md#salesShipmentRepositoryV1GetListGet) | **GET** /V1/shipments | shipments |


<a id="salesShipmentRepositoryV1GetListGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SalesDataShipmentSearchResultInterface result = apiInstance.salesShipmentRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ShipmentsApi#salesShipmentRepositoryV1GetListGet");
