...
|------------- | ------------- | -------------|
| [**catalogCategoryAttributeRepositoryV1GetListGet**](CategoriesAttributesApi.md#catalogCategoryAttributeRepositoryV1GetListGet) | **GET** /V1/categories/attributes | categories/attributes |


<a id="catalogCategoryAttributeRepositoryV1GetListGet"></a>
...
import org.openapitools.client.api.CategoriesAttributesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CategoriesAttributesApi apiInstance = new CategoriesAttributesApi(defaultClient);
    ...
    try {
      CatalogDataCategoryAttributeSearchResultsInterface result = apiInstance.catalogCategoryAttributeRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CategoriesAttributesApi#catalogCategoryAttributeRepositoryV1GetListGet");
