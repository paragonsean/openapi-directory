...
<a id="companyCompanyRepositoryV1GetListGet"></a>
# **companyCompanyRepositoryV1GetListGet**
> CompanyDataCompanySearchResultsInterface companyCompanyRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage)
...
<a id="companyCompanyRepositoryV1SavePost"></a>
# **companyCompanyRepositoryV1SavePost**
> CompanyDataCompanyInterface companyCompanyRepositoryV1SavePost(companyCompanyRepositoryV1SavePostRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CompanyDataCompanyInterface result = apiInstance.companyCompanyRepositoryV1SavePost(companyCompanyRepositoryV1SavePostRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CompanyApi#companyCompanyRepositoryV1SavePost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
