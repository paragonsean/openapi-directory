...
|------------- | ------------- | -------------|
| [**customerGroupRepositoryV1GetListGet**](CustomerGroupsSearchApi.md#customerGroupRepositoryV1GetListGet) | **GET** /V1/customerGroups/search | customerGroups/search |


<a id="customerGroupRepositoryV1GetListGet"></a>
...
import org.openapitools.client.api.CustomerGroupsSearchApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerGroupsSearchApi apiInstance = new CustomerGroupsSearchApi(defaultClient);
    ...
    try {
      CustomerDataGroupSearchResultsInterface result = apiInstance.customerGroupRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomerGroupsSearchApi#customerGroupRepositoryV1GetListGet");
