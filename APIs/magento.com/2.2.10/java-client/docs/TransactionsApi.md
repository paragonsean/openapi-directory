...
<a id="salesTransactionRepositoryV1GetListGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SalesDataTransactionSearchResultInterface result = apiInstance.salesTransactionRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransactionsApi#salesTransactionRepositoryV1GetListGet");
