...
|------------- | ------------- | -------------|
| [**cmsPageRepositoryV1GetListGet**](CmsPageSearchApi.md#cmsPageRepositoryV1GetListGet) | **GET** /V1/cmsPage/search | cmsPage/search |


<a id="cmsPageRepositoryV1GetListGet"></a>
...
import org.openapitools.client.api.CmsPageSearchApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CmsPageSearchApi apiInstance = new CmsPageSearchApi(defaultClient);
    ...
    try {
      CmsDataPageSearchResultsInterface result = apiInstance.cmsPageRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CmsPageSearchApi#cmsPageRepositoryV1GetListGet");
