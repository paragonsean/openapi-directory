...
<a id="eavAttributeSetRepositoryV1GetListGet"></a>
...
import org.openapitools.client.api.EavAttributeSetsListApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    EavAttributeSetsListApi apiInstance = new EavAttributeSetsListApi(defaultClient);
    ...
    try {
      EavDataAttributeSetSearchResultsInterface result = apiInstance.eavAttributeSetRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EavAttributeSetsListApi#eavAttributeSetRepositoryV1GetListGet");
