...
<a id="companyTeamRepositoryV1GetListGet"></a>
# **companyTeamRepositoryV1GetListGet**
> CompanyDataTeamSearchResultsInterface companyTeamRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TeamApi#companyTeamRepositoryV1GetListGet");
