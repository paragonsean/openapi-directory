...
|**multilineCount** | **Integer** | Of lines of the attribute value. |  |
...
|**sortOrder** | **Integer** | Attributes sort order. |  |
...
|**validationRules** | [**List&lt;CustomerDataValidationRuleInterface&gt;**](CustomerDataValidationRuleInterface.md) | Validation rules. |  |
