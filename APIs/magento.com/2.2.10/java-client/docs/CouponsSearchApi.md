...
import org.openapitools.client.api.CouponsSearchApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CouponsSearchApi apiInstance = new CouponsSearchApi(defaultClient);
    ...
    try {
      SalesRuleDataCouponSearchResultInterface result = apiInstance.salesRuleCouponRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CouponsSearchApi#salesRuleCouponRepositoryV1GetListGet");
