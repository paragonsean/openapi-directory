...
<a id="catalogProductAttributeRepositoryV1GetListGet"></a>
...
import org.openapitools.client.api.ProductsAttributesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ProductsAttributesApi apiInstance = new ProductsAttributesApi(defaultClient);
    ...
    try {
      CatalogDataProductAttributeSearchResultsInterface result = apiInstance.catalogProductAttributeRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductsAttributesApi#catalogProductAttributeRepositoryV1GetListGet");
...
<a id="catalogProductAttributeRepositoryV1SavePost"></a>
# **catalogProductAttributeRepositoryV1SavePost**
> CatalogDataProductAttributeInterface catalogProductAttributeRepositoryV1SavePost(catalogProductAttributeRepositoryV1SavePostRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CatalogDataProductAttributeInterface result = apiInstance.catalogProductAttributeRepositoryV1SavePost(catalogProductAttributeRepositoryV1SavePostRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductsAttributesApi#catalogProductAttributeRepositoryV1SavePost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
