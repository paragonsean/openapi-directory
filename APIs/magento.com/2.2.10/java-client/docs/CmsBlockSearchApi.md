...
|------------- | ------------- | -------------|
| [**cmsBlockRepositoryV1GetListGet**](CmsBlockSearchApi.md#cmsBlockRepositoryV1GetListGet) | **GET** /V1/cmsBlock/search | cmsBlock/search |


<a id="cmsBlockRepositoryV1GetListGet"></a>
...
import org.openapitools.client.api.CmsBlockSearchApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CmsBlockSearchApi apiInstance = new CmsBlockSearchApi(defaultClient);
    ...
    try {
      CmsDataBlockSearchResultsInterface result = apiInstance.cmsBlockRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CmsBlockSearchApi#cmsBlockRepositoryV1GetListGet");
