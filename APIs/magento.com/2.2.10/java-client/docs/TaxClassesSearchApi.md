...
import org.openapitools.client.api.TaxClassesSearchApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TaxClassesSearchApi apiInstance = new TaxClassesSearchApi(defaultClient);
    ...
    try {
      TaxDataTaxClassSearchResultsInterface result = apiInstance.taxTaxClassRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TaxClassesSearchApi#taxTaxClassRepositoryV1GetListGet");
