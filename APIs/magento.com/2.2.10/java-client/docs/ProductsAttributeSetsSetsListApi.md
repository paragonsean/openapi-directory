...
<a id="catalogAttributeSetRepositoryV1GetListGet"></a>
...
import org.openapitools.client.api.ProductsAttributeSetsSetsListApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ProductsAttributeSetsSetsListApi apiInstance = new ProductsAttributeSetsSetsListApi(defaultClient);
    ...
    try {
      EavDataAttributeSetSearchResultsInterface result = apiInstance.catalogAttributeSetRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProductsAttributeSetsSetsListApi#catalogAttributeSetRepositoryV1GetListGet");
