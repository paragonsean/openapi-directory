...
<a id="customerCustomerRepositoryV1GetListGet"></a>
...
import org.openapitools.client.api.CustomersSearchApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomersSearchApi apiInstance = new CustomersSearchApi(defaultClient);
    ...
    try {
      CustomerDataCustomerSearchResultsInterface result = apiInstance.customerCustomerRepositoryV1GetListGet(searchCriteriaFilterGroups0Filters0Field, searchCriteriaFilterGroups0Filters0Value, searchCriteriaFilterGroups0Filters0ConditionType, searchCriteriaSortOrders0Field, searchCriteriaSortOrders0Direction, searchCriteriaPageSize, searchCriteriaCurrentPage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomersSearchApi#customerCustomerRepositoryV1GetListGet");
