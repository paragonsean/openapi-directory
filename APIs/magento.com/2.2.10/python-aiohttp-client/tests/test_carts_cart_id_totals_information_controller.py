...
async def test_v1_carts_cart_id_totals_information_post(client):
    """Test case for v1_carts_cart_id_totals_information_post
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/carts/{cart_id}/totals-information'.format(cart_id=56),
        headers=headers,
        json=body,
        )
