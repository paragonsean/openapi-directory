...
async def test_sales_rule_coupon_repository_v1_get_list_get(client):
    """Test case for sales_rule_coupon_repository_v1_get_list_get
    ...
    response = await client.request(
        method='GET',
        path='/rest/default/V1/coupons/search',
        headers=headers,
        params=params,
        )
