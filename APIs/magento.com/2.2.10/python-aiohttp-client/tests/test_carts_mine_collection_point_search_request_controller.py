...
async def test_temando_shipping_collection_point_cart_collection_point_management_v1_delete_search_request_delete(client):
    """Test case for temando_shipping_collection_point_cart_collection_point_management_v1_delete_search_request_delete
    ...
    response = await client.request(
        method='DELETE',
        path='/rest/default/V1/carts/mine/collection-point/search-request',
        headers=headers,
        )
...
async def test_temando_shipping_collection_point_cart_collection_point_management_v1_save_search_request_put(client):
    """Test case for temando_shipping_collection_point_cart_collection_point_management_v1_save_search_request_put
