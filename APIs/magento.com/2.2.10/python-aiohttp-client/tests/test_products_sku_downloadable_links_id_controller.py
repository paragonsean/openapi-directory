...
async def test_downloadable_link_repository_v1_save_put(client):
    ...
    response = await client.request(
        method='PUT',
        path='/rest/default/V1/products/{sku}/downloadable-links/{id}'.format(sku='sku_example', id='id_example'),
        headers=headers,
        json=body,
        )
