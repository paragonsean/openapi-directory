...
async def test_quote_payment_method_management_v1_get_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/rest/default/V1/carts/mine/selected-payment-method',
        headers=headers,
        )
...
async def test_quote_payment_method_management_v1_set_put(client):
