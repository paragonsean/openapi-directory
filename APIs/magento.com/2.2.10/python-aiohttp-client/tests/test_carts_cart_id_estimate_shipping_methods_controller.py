...
async def test_v1_carts_cart_id_estimate_shipping_methods_post(client):
    """Test case for v1_carts_cart_id_estimate_shipping_methods_post
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/carts/{cart_id}/estimate-shipping-methods'.format(cart_id='cart_id_example'),
        headers=headers,
        json=body,
        )
