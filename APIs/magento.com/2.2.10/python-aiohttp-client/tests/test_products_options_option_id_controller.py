...
async def test_catalog_product_custom_option_repository_v1_save_put(client):
    ...
    response = await client.request(
        method='PUT',
        path='/rest/default/V1/products/options/{option_id}'.format(option_id='option_id_example'),
        headers=headers,
        json=body,
        )
