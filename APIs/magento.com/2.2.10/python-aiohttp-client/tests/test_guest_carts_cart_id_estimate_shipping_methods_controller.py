...
async def test_quote_guest_shipment_estimation_v1_estimate_by_extended_address_post(client):
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/guest-carts/{cart_id}/estimate-shipping-methods'.format(cart_id='cart_id_example'),
        headers=headers,
        json=body,
        )
