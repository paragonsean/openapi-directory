...
async def test_shared_catalog_shared_catalog_repository_v1_save_post(client):
    """Test case for shared_catalog_shared_catalog_repository_v1_save_post
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/sharedCatalog',
        headers=headers,
        json=body,
        )
