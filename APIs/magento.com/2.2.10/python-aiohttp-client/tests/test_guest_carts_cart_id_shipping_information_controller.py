...
async def test_checkout_guest_shipping_information_management_v1_save_address_information_post(client):
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/guest-carts/{cart_id}/shipping-information'.format(cart_id='cart_id_example'),
        headers=headers,
        json=body,
        )
