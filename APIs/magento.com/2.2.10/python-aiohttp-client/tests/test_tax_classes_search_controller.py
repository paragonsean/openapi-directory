...
async def test_tax_tax_class_repository_v1_get_list_get(client):
    """Test case for tax_tax_class_repository_v1_get_list_get
    ...
    response = await client.request(
        method='GET',
        path='/rest/default/V1/taxClasses/search',
        headers=headers,
        params=params,
        )
