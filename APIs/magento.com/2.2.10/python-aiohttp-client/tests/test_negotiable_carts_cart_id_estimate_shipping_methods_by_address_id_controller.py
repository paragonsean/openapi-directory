...
async def test_negotiable_quote_shipping_method_management_v1_estimate_by_address_id_post(client):
    """Test case for negotiable_quote_shipping_method_management_v1_estimate_by_address_id_post
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/negotiable-carts/{cart_id}/estimate-shipping-methods-by-address-id'.format(cart_id=56),
        headers=headers,
        json=body,
        )
