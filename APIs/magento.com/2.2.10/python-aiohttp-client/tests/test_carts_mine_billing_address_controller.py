...
async def test_quote_billing_address_management_v1_assign_post(client):
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/carts/mine/billing-address',
        headers=headers,
        json=body,
        )
...
async def test_quote_billing_address_management_v1_get_get(client):
