...
async def test_shared_catalog_company_management_v1_unassign_companies_post(client):
    """Test case for shared_catalog_company_management_v1_unassign_companies_post
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/sharedCatalog/{shared_catalog_id}/unassignCompanies'.format(shared_catalog_id=56),
        headers=headers,
        json=body,
        )
