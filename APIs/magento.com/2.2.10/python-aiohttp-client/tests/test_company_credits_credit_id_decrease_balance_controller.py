...
async def test_company_credit_credit_balance_management_v1_decrease_post(client):
    """Test case for company_credit_credit_balance_management_v1_decrease_post
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/companyCredits/{credit_id}/decreaseBalance'.format(credit_id=56),
        headers=headers,
        json=body,
        )
