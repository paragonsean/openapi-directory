...
async def test_customer_group_repository_v1_get_list_get(client):
    """Test case for customer_group_repository_v1_get_list_get
    ...
    response = await client.request(
        method='GET',
        path='/rest/default/V1/customerGroups/search',
        headers=headers,
        params=params,
        )
