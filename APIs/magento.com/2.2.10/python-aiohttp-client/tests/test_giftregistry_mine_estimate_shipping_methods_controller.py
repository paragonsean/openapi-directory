...
async def test_gift_registry_shipping_method_management_v1_estimate_by_registry_id_post(client):
    """Test case for gift_registry_shipping_method_management_v1_estimate_by_registry_id_post
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/giftregistry/mine/estimate-shipping-methods',
        headers=headers,
        json=body,
        )
