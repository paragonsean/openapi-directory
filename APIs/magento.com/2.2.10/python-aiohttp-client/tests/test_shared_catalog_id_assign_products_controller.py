...
async def test_shared_catalog_product_management_v1_assign_products_post(client):
    """Test case for shared_catalog_product_management_v1_assign_products_post
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/sharedCatalog/{id}/assignProducts'.format(id=56),
        headers=headers,
        json=body,
        )
