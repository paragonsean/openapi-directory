...
async def test_company_credit_credit_limit_repository_v1_get_list_get(client):
    """Test case for company_credit_credit_limit_repository_v1_get_list_get
    ...
    response = await client.request(
        method='GET',
        path='/rest/default/V1/companyCredits/',
        headers=headers,
        params=params,
        )
