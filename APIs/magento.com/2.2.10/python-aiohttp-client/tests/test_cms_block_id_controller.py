...
async def test_cms_block_repository_v1_save_put(client):
    """Test case for cms_block_repository_v1_save_put
    ...
    response = await client.request(
        method='PUT',
        path='/rest/default/V1/cmsBlock/{id}'.format(id='id_example'),
        headers=headers,
        json=body,
        )
