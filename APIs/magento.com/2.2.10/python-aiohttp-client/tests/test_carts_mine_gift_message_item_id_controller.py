...
async def test_gift_message_item_repository_v1_get_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/rest/default/V1/carts/mine/gift-message/{item_id}'.format(item_id=56),
        headers=headers,
        )
...
async def test_gift_message_item_repository_v1_save_post(client):
