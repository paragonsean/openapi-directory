...
async def test_v1_carts_cart_id_billing_address_get(client):
    """Test case for v1_carts_cart_id_billing_address_get
    ...
    response = await client.request(
        method='GET',
        path='/rest/default/V1/carts/{cart_id}/billing-address'.format(cart_id=56),
        headers=headers,
        )
...
async def test_v1_carts_cart_id_billing_address_post(client):
    """Test case for v1_carts_cart_id_billing_address_post
