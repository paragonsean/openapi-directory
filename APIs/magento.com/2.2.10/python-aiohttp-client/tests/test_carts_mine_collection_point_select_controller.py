...
async def test_temando_shipping_collection_point_cart_collection_point_management_v1_select_collection_point_post(client):
    """Test case for temando_shipping_collection_point_cart_collection_point_management_v1_select_collection_point_post
    ...
    response = await client.request(
        method='POST',
        path='/rest/default/V1/carts/mine/collection-point/select',
        headers=headers,
        json=body,
        )
