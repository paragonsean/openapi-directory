...
class QuoteDataTotalsItemInterface(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, base_discount_amount: float=None, base_price: float=None, base_price_incl_tax: float=None, base_row_total: float=None, base_row_total_incl_tax: float=None, base_tax_amount: float=None, discount_amount: float=None, discount_percent: float=None, extension_attributes: QuoteDataTotalsItemExtensionInterface=None, item_id: int=None, name: str=None, options: str=None, price: float=None, price_incl_tax: float=None, qty: float=None, row_total: float=None, row_total_incl_tax: float=None, row_total_with_discount: float=None, tax_amount: float=None, tax_percent: float=None, weee_tax_applied: str=None, weee_tax_applied_amount: float=None):
        """QuoteDataTotalsItemInterface - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'QuoteDataTotalsItemInterface':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The quote-data-totals-item-interface of this QuoteDataTotalsItemInterface.
        """
    ...
    def extension_attributes(self, extension_attributes):
        ...
        :param extension_attributes: The extension_attributes of this QuoteDataTotalsItemInterface.
        :type extension_attributes: QuoteDataTotalsItemExtensionInterface
        """
    ...
    def row_total_with_discount(self, row_total_with_discount):
        ...
        :param row_total_with_discount: The row_total_with_discount of this QuoteDataTotalsItemInterface.
        :type row_total_with_discount: float
        """
