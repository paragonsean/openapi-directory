...
async def negotiable_quote_billing_address_management_v1_assign_post(request: web.Request, cart_id, body=None) -> web.Response:
...
async def negotiable_quote_billing_address_management_v1_get_get(request: web.Request, cart_id) -> web.Response:
    """negotiable-carts/{cartId}/billing-address
