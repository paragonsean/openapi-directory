...
async def catalog_product_attribute_repository_v1_get_list_get(request: web.Request, search_criteria_filter_groups_0_filters_0_field=None, search_criteria_filter_groups_0_filters_0_value=None, search_criteria_filter_groups_0_filters_0_condition_type=None, search_criteria_sort_orders_0_field=None, search_criteria_sort_orders_0_direction=None, search_criteria_page_size=None, search_criteria_current_page=None) -> web.Response:
    """products/attributes
...
async def catalog_product_attribute_repository_v1_save_post(request: web.Request, body=None) -> web.Response:
    """products/attributes
