...
async def eav_attribute_set_repository_v1_delete_by_id_delete(request: web.Request, attribute_set_id) -> web.Response:
...
async def eav_attribute_set_repository_v1_get_get(request: web.Request, attribute_set_id) -> web.Response:
    """eav/attribute-sets/{attributeSetId}
...
async def eav_attribute_set_repository_v1_save_put(request: web.Request, attribute_set_id, body=None) -> web.Response:
    """eav/attribute-sets/{attributeSetId}
