...
async def quote_guest_cart_item_repository_v1_delete_by_id_delete(request: web.Request, cart_id, item_id) -> web.Response:
...
async def quote_guest_cart_item_repository_v1_save_put(request: web.Request, cart_id, item_id, body=None) -> web.Response:
    """guest-carts/{cartId}/items/{itemId}
