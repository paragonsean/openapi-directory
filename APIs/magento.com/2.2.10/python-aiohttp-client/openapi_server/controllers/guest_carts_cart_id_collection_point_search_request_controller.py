...
async def temando_shipping_collection_point_guest_cart_collection_point_management_v1_delete_search_request_delete(request: web.Request, cart_id) -> web.Response:
...
async def temando_shipping_collection_point_guest_cart_collection_point_management_v1_save_search_request_put(request: web.Request, cart_id, body=None) -> web.Response:
    """guest-carts/{cartId}/collection-point/search-request
