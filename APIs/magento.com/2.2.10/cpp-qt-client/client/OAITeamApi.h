...
#include "OAICompany_data_team_search_results_interface.h"
...
private:
    ...
    void companyTeamRepositoryV1GetListGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void companyTeamRepositoryV1GetListGetSignal(OAICompany_data_team_search_results_interface summary);


    void companyTeamRepositoryV1GetListGetSignalFull(OAIHttpRequestWorker *worker, OAICompany_data_team_search_results_interface summary);

    Q_DECL_DEPRECATED_X("Use companyTeamRepositoryV1GetListGetSignalError() instead")
    void companyTeamRepositoryV1GetListGetSignalE(OAICompany_data_team_search_results_interface summary, QNetworkReply::NetworkError error_type, QString error_str);
    void companyTeamRepositoryV1GetListGetSignalError(OAICompany_data_team_search_results_interface summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use companyTeamRepositoryV1GetListGetSignalErrorFull() instead")
    void companyTeamRepositoryV1GetListGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void companyTeamRepositoryV1GetListGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
