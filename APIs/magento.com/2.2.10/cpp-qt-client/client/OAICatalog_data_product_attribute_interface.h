...
/*
 * OAICatalog_data_product_attribute_interface.h
 *
 * 
 */

#ifndef OAICatalog_data_product_attribute_interface_H
#define OAICatalog_data_product_attribute_interface_H
...
class OAICatalog_data_product_attribute_interface : public OAIObject {
public:
    OAICatalog_data_product_attribute_interface();
    OAICatalog_data_product_attribute_interface(QString json);
    ~OAICatalog_data_product_attribute_interface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalog_data_product_attribute_interface)

#endif // OAICatalog_data_product_attribute_interface_H
