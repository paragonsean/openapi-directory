...
/*
 * OAISales_data_shipment_comment_interface.h
 *
...
#ifndef OAISales_data_shipment_comment_interface_H
#define OAISales_data_shipment_comment_interface_H
...
class OAISales_data_shipment_comment_interface : public OAIObject {
public:
    OAISales_data_shipment_comment_interface();
    OAISales_data_shipment_comment_interface(QString json);
    ~OAISales_data_shipment_comment_interface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISales_data_shipment_comment_interface)

#endif // OAISales_data_shipment_comment_interface_H
