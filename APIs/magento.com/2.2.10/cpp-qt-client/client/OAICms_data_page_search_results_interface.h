...
/*
 * OAICms_data_page_search_results_interface.h
 *
 * Interface for cms page search results.
 */

#ifndef OAICms_data_page_search_results_interface_H
#define OAICms_data_page_search_results_interface_H
...
class OAICms_data_page_search_results_interface : public OAIObject {
public:
    OAICms_data_page_search_results_interface();
    OAICms_data_page_search_results_interface(QString json);
    ~OAICms_data_page_search_results_interface() override;
    ...
    QList<OAICms_data_page_interface> getItems() const;
    void setItems(const QList<OAICms_data_page_interface> &items);
...
private:
    ...
    QList<OAICms_data_page_interface> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICms_data_page_search_results_interface)

#endif // OAICms_data_page_search_results_interface_H
