...
/*
 * OAISales_data_creditmemo_item_creation_interface.h
 *
 * Interface CreditmemoItemCreationInterface
 */

#ifndef OAISales_data_creditmemo_item_creation_interface_H
#define OAISales_data_creditmemo_item_creation_interface_H
...
class OAISales_data_creditmemo_item_creation_interface : public OAIObject {
public:
    OAISales_data_creditmemo_item_creation_interface();
    OAISales_data_creditmemo_item_creation_interface(QString json);
    ~OAISales_data_creditmemo_item_creation_interface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISales_data_creditmemo_item_creation_interface)

#endif // OAISales_data_creditmemo_item_creation_interface_H
