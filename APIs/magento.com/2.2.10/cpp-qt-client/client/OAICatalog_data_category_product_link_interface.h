...
/*
 * OAICatalog_data_category_product_link_interface.h
 *
 * 
 */

#ifndef OAICatalog_data_category_product_link_interface_H
#define OAICatalog_data_category_product_link_interface_H
...
class OAICatalog_data_category_product_link_interface : public OAIObject {
public:
    OAICatalog_data_category_product_link_interface();
    OAICatalog_data_category_product_link_interface(QString json);
    ~OAICatalog_data_category_product_link_interface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalog_data_category_product_link_interface)

#endif // OAICatalog_data_category_product_link_interface_H
