...
/*
 * OAISales_data_order_search_result_interface.h
 *
...
#ifndef OAISales_data_order_search_result_interface_H
#define OAISales_data_order_search_result_interface_H
...
namespace OpenAPI {
class OAISales_data_order_interface;
class OAIFramework_search_criteria_interface;

class OAISales_data_order_search_result_interface : public OAIObject {
public:
    OAISales_data_order_search_result_interface();
    OAISales_data_order_search_result_interface(QString json);
    ~OAISales_data_order_search_result_interface() override;
    ...
    QList<OAISales_data_order_interface> getItems() const;
    void setItems(const QList<OAISales_data_order_interface> &items);
...
private:
    ...
    QList<OAISales_data_order_interface> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISales_data_order_search_result_interface)

#endif // OAISales_data_order_search_result_interface_H
