...
void OAIInvoicesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("salesInvoiceRepositoryV1GetListGet", defaultConf);
    _serverIndices.insert("salesInvoiceRepositoryV1GetListGet", 0);
    _serverConfigs.insert("salesInvoiceRepositoryV1SavePost", defaultConf);
    _serverIndices.insert("salesInvoiceRepositoryV1SavePost", 0);
}
...
void OAIInvoicesApi::salesInvoiceRepositoryV1GetListGet(const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_field, const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_value, const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_condition_type, const ::OpenAPI::OptionalParam<QString> &search_criteria_sort_orders_0_field, const ::OpenAPI::OptionalParam<QString> &search_criteria_sort_orders_0_direction, const ::OpenAPI::OptionalParam<qint32> &search_criteria_page_size, const ::OpenAPI::OptionalParam<qint32> &search_criteria_current_page) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIInvoicesApi::salesInvoiceRepositoryV1GetListGetCallback);
...
void OAIInvoicesApi::salesInvoiceRepositoryV1GetListGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAISales_data_invoice_search_result_interface output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT salesInvoiceRepositoryV1GetListGetSignal(output);
        Q_EMIT salesInvoiceRepositoryV1GetListGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT salesInvoiceRepositoryV1GetListGetSignalE(output, error_type, error_str);
        Q_EMIT salesInvoiceRepositoryV1GetListGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT salesInvoiceRepositoryV1GetListGetSignalError(output, error_type, error_str);
        Q_EMIT salesInvoiceRepositoryV1GetListGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIInvoicesApi::salesInvoiceRepositoryV1SavePost(const ::OpenAPI::OptionalParam<OAISalesInvoiceRepositoryV1SavePost_request> &oai_sales_invoice_repository_v1_save_post_request) {
    QString fullPath = QString(_serverConfigs["salesInvoiceRepositoryV1SavePost"][_serverIndices.value("salesInvoiceRepositoryV1SavePost")].URL()+"/V1/invoices/");
    ...
    if (oai_sales_invoice_repository_v1_save_post_request.hasValue()){

        
        QByteArray output = oai_sales_invoice_repository_v1_save_post_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIInvoicesApi::salesInvoiceRepositoryV1SavePostCallback);
    connect(this, &OAIInvoicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIInvoicesApi::salesInvoiceRepositoryV1SavePostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT salesInvoiceRepositoryV1SavePostSignal(output);
        Q_EMIT salesInvoiceRepositoryV1SavePostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT salesInvoiceRepositoryV1SavePostSignalE(output, error_type, error_str);
        Q_EMIT salesInvoiceRepositoryV1SavePostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT salesInvoiceRepositoryV1SavePostSignalError(output, error_type, error_str);
        Q_EMIT salesInvoiceRepositoryV1SavePostSignalErrorFull(worker, error_type, error_str);
    }
}
