...
/*
 * OAICatalog_data_cost_interface.h
 *
 * Cost interface.
 */

#ifndef OAICatalog_data_cost_interface_H
#define OAICatalog_data_cost_interface_H
...
class OAICatalog_data_cost_interface : public OAIObject {
public:
    OAICatalog_data_cost_interface();
    OAICatalog_data_cost_interface(QString json);
    ~OAICatalog_data_cost_interface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICatalog_data_cost_interface)

#endif // OAICatalog_data_cost_interface_H
