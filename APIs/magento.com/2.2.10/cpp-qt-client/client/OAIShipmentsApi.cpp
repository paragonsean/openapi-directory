...
void OAIShipmentsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("salesShipmentRepositoryV1GetListGet", defaultConf);
    _serverIndices.insert("salesShipmentRepositoryV1GetListGet", 0);
}
...
void OAIShipmentsApi::salesShipmentRepositoryV1GetListGet(const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_field, const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_value, const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_condition_type, const ::OpenAPI::OptionalParam<QString> &search_criteria_sort_orders_0_field, const ::OpenAPI::OptionalParam<QString> &search_criteria_sort_orders_0_direction, const ::OpenAPI::OptionalParam<qint32> &search_criteria_page_size, const ::OpenAPI::OptionalParam<qint32> &search_criteria_current_page) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIShipmentsApi::salesShipmentRepositoryV1GetListGetCallback);
...
void OAIShipmentsApi::salesShipmentRepositoryV1GetListGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAISales_data_shipment_search_result_interface output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT salesShipmentRepositoryV1GetListGetSignal(output);
        Q_EMIT salesShipmentRepositoryV1GetListGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT salesShipmentRepositoryV1GetListGetSignalE(output, error_type, error_str);
        Q_EMIT salesShipmentRepositoryV1GetListGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT salesShipmentRepositoryV1GetListGetSignalError(output, error_type, error_str);
        Q_EMIT salesShipmentRepositoryV1GetListGetSignalErrorFull(worker, error_type, error_str);
    }
}
