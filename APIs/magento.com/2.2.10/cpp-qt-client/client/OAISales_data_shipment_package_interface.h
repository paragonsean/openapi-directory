...
/*
 * OAISales_data_shipment_package_interface.h
 *
...
#ifndef OAISales_data_shipment_package_interface_H
#define OAISales_data_shipment_package_interface_H
...
class OAISales_data_shipment_package_interface : public OAIObject {
public:
    OAISales_data_shipment_package_interface();
    OAISales_data_shipment_package_interface(QString json);
    ~OAISales_data_shipment_package_interface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISales_data_shipment_package_interface)

#endif // OAISales_data_shipment_package_interface_H
