...
void OAICouponsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("salesRuleCouponRepositoryV1SavePost", defaultConf);
    _serverIndices.insert("salesRuleCouponRepositoryV1SavePost", 0);
}
...
void OAICouponsApi::salesRuleCouponRepositoryV1SavePost(const ::OpenAPI::OptionalParam<OAISalesRuleCouponRepositoryV1SavePost_request> &oai_sales_rule_coupon_repository_v1_save_post_request) {
    QString fullPath = QString(_serverConfigs["salesRuleCouponRepositoryV1SavePost"][_serverIndices.value("salesRuleCouponRepositoryV1SavePost")].URL()+"/V1/coupons");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICouponsApi::salesRuleCouponRepositoryV1SavePostCallback);
...
void OAICouponsApi::salesRuleCouponRepositoryV1SavePostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT salesRuleCouponRepositoryV1SavePostSignal(output);
        Q_EMIT salesRuleCouponRepositoryV1SavePostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT salesRuleCouponRepositoryV1SavePostSignalE(output, error_type, error_str);
        Q_EMIT salesRuleCouponRepositoryV1SavePostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT salesRuleCouponRepositoryV1SavePostSignalError(output, error_type, error_str);
        Q_EMIT salesRuleCouponRepositoryV1SavePostSignalErrorFull(worker, error_type, error_str);
    }
}
