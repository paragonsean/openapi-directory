...
/*
 * OAISales_data_order_item_search_result_interface.h
 *
...
#ifndef OAISales_data_order_item_search_result_interface_H
#define OAISales_data_order_item_search_result_interface_H
...
class OAISales_data_order_item_search_result_interface : public OAIObject {
public:
    OAISales_data_order_item_search_result_interface();
    OAISales_data_order_item_search_result_interface(QString json);
    ~OAISales_data_order_item_search_result_interface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISales_data_order_item_search_result_interface)

#endif // OAISales_data_order_item_search_result_interface_H
