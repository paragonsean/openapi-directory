...
/*
 * OAIQuote_data_cart_search_results_interface.h
 *
 * Interface CartSearchResultsInterface
 */

#ifndef OAIQuote_data_cart_search_results_interface_H
#define OAIQuote_data_cart_search_results_interface_H
...
class OAIQuote_data_cart_search_results_interface : public OAIObject {
public:
    OAIQuote_data_cart_search_results_interface();
    OAIQuote_data_cart_search_results_interface(QString json);
    ~OAIQuote_data_cart_search_results_interface() override;
    ...
    QList<OAIQuote_data_cart_interface> getItems() const;
    void setItems(const QList<OAIQuote_data_cart_interface> &items);
...
private:
    ...
    QList<OAIQuote_data_cart_interface> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuote_data_cart_search_results_interface)

#endif // OAIQuote_data_cart_search_results_interface_H
