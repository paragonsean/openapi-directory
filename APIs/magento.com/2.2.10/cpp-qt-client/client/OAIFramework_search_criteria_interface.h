...
/*
 * OAIFramework_search_criteria_interface.h
 *
 * Search criteria interface.
 */

#ifndef OAIFramework_search_criteria_interface_H
#define OAIFramework_search_criteria_interface_H
...
class OAIFramework_search_criteria_interface : public OAIObject {
public:
    OAIFramework_search_criteria_interface();
    OAIFramework_search_criteria_interface(QString json);
    ~OAIFramework_search_criteria_interface() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFramework_search_criteria_interface)

#endif // OAIFramework_search_criteria_interface_H
