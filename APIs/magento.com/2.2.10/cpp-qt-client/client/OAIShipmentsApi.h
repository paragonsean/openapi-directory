...
private:
    ...
    void salesShipmentRepositoryV1GetListGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void salesShipmentRepositoryV1GetListGetSignal(OAISales_data_shipment_search_result_interface summary);


    void salesShipmentRepositoryV1GetListGetSignalFull(OAIHttpRequestWorker *worker, OAISales_data_shipment_search_result_interface summary);

    Q_DECL_DEPRECATED_X("Use salesShipmentRepositoryV1GetListGetSignalError() instead")
    void salesShipmentRepositoryV1GetListGetSignalE(OAISales_data_shipment_search_result_interface summary, QNetworkReply::NetworkError error_type, QString error_str);
    void salesShipmentRepositoryV1GetListGetSignalError(OAISales_data_shipment_search_result_interface summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use salesShipmentRepositoryV1GetListGetSignalErrorFull() instead")
    void salesShipmentRepositoryV1GetListGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void salesShipmentRepositoryV1GetListGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
