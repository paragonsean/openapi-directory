...
/*
 * OAIRma_data_comment_search_result_interface.h
 *
 * Interface CommentSearchResultInterface
 */

#ifndef OAIRma_data_comment_search_result_interface_H
#define OAIRma_data_comment_search_result_interface_H
...
class OAIRma_data_comment_search_result_interface : public OAIObject {
public:
    OAIRma_data_comment_search_result_interface();
    OAIRma_data_comment_search_result_interface(QString json);
    ~OAIRma_data_comment_search_result_interface() override;
    ...
    QList<OAIRma_data_comment_interface> getItems() const;
    void setItems(const QList<OAIRma_data_comment_interface> &items);
...
private:
    ...
    QList<OAIRma_data_comment_interface> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRma_data_comment_search_result_interface)

#endif // OAIRma_data_comment_search_result_interface_H
