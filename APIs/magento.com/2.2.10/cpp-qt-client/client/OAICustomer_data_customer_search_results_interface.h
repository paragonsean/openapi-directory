...
/*
 * OAICustomer_data_customer_search_results_interface.h
 *
 * Interface for customer search results.
 */

#ifndef OAICustomer_data_customer_search_results_interface_H
#define OAICustomer_data_customer_search_results_interface_H
...
class OAICustomer_data_customer_search_results_interface : public OAIObject {
public:
    OAICustomer_data_customer_search_results_interface();
    OAICustomer_data_customer_search_results_interface(QString json);
    ~OAICustomer_data_customer_search_results_interface() override;
    ...
    QList<OAICustomer_data_customer_interface> getItems() const;
    void setItems(const QList<OAICustomer_data_customer_interface> &items);
...
private:
    ...
    QList<OAICustomer_data_customer_interface> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomer_data_customer_search_results_interface)

#endif // OAICustomer_data_customer_search_results_interface_H
