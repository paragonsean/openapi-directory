...
/*
 * OAIEav_data_attribute_group_search_results_interface.h
 *
 * Interface AttributeGroupSearchResultsInterface
 */

#ifndef OAIEav_data_attribute_group_search_results_interface_H
#define OAIEav_data_attribute_group_search_results_interface_H
...
class OAIEav_data_attribute_group_search_results_interface : public OAIObject {
public:
    OAIEav_data_attribute_group_search_results_interface();
    OAIEav_data_attribute_group_search_results_interface(QString json);
    ~OAIEav_data_attribute_group_search_results_interface() override;
    ...
    QList<OAIEav_data_attribute_group_interface> getItems() const;
    void setItems(const QList<OAIEav_data_attribute_group_interface> &items);
...
private:
    ...
    QList<OAIEav_data_attribute_group_interface> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEav_data_attribute_group_search_results_interface)

#endif // OAIEav_data_attribute_group_search_results_interface_H
