...
/*
 * OAISales_data_creditmemo_interface.h
 *
...
#ifndef OAISales_data_creditmemo_interface_H
#define OAISales_data_creditmemo_interface_H
...
class OAISales_data_creditmemo_extension_interface;
class OAISales_data_creditmemo_item_interface;

class OAISales_data_creditmemo_interface : public OAIObject {
public:
    OAISales_data_creditmemo_interface();
    OAISales_data_creditmemo_interface(QString json);
    ~OAISales_data_creditmemo_interface() override;
    ...
    void setBaseAdjustment(const double &base_adjustment);
    bool is_base_adjustment_Set() const;
    bool is_base_adjustment_Valid() const;
    ...
    QList<OAISales_data_creditmemo_comment_interface> getComments() const;
    void setComments(const QList<OAISales_data_creditmemo_comment_interface> &comments);
    ...
    qint32 getCreditmemoStatus() const;
    void setCreditmemoStatus(const qint32 &creditmemo_status);
    bool is_creditmemo_status_Set() const;
    bool is_creditmemo_status_Valid() const;
    ...
    OAISales_data_creditmemo_extension_interface getExtensionAttributes() const;
    void setExtensionAttributes(const OAISales_data_creditmemo_extension_interface &extension_attributes);
    ...
    QList<OAISales_data_creditmemo_item_interface> getItems() const;
    void setItems(const QList<OAISales_data_creditmemo_item_interface> &items);
...
private:
    ...
    double m_base_adjustment;
    bool m_base_adjustment_isSet;
    bool m_base_adjustment_isValid;
    ...
    QList<OAISales_data_creditmemo_comment_interface> m_comments;
    ...
    qint32 m_creditmemo_status;
    bool m_creditmemo_status_isSet;
    bool m_creditmemo_status_isValid;
    ...
    OAISales_data_creditmemo_extension_interface m_extension_attributes;
    ...
    QList<OAISales_data_creditmemo_item_interface> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISales_data_creditmemo_interface)

#endif // OAISales_data_creditmemo_interface_H
