...
/*
 * OAISales_data_invoice_extension_interface.h
 *
 * ExtensionInterface class for @see \\Magento\\Sales\\Api\\Data\\InvoiceInterface
 */

#ifndef OAISales_data_invoice_extension_interface_H
#define OAISales_data_invoice_extension_interface_H
...
class OAISales_data_invoice_extension_interface : public OAIObject {
public:
    OAISales_data_invoice_extension_interface();
    OAISales_data_invoice_extension_interface(QString json);
    ~OAISales_data_invoice_extension_interface() override;
    ...
    OAISales_data_order_address_interface getVertexTaxCalculationBillingAddress() const;
    void setVertexTaxCalculationBillingAddress(const OAISales_data_order_address_interface &vertex_tax_calculation_billing_address);
    bool is_vertex_tax_calculation_billing_address_Set() const;
    bool is_vertex_tax_calculation_billing_address_Valid() const;

    OAISales_data_order_interface getVertexTaxCalculationOrder() const;
    void setVertexTaxCalculationOrder(const OAISales_data_order_interface &vertex_tax_calculation_order);
    bool is_vertex_tax_calculation_order_Set() const;
    bool is_vertex_tax_calculation_order_Valid() const;

    OAISales_data_order_address_interface getVertexTaxCalculationShippingAddress() const;
    void setVertexTaxCalculationShippingAddress(const OAISales_data_order_address_interface &vertex_tax_calculation_shipping_address);
    bool is_vertex_tax_calculation_shipping_address_Set() const;
    bool is_vertex_tax_calculation_shipping_address_Valid() const;
...
private:
    ...
    OAISales_data_order_address_interface m_vertex_tax_calculation_billing_address;
    bool m_vertex_tax_calculation_billing_address_isSet;
    bool m_vertex_tax_calculation_billing_address_isValid;

    OAISales_data_order_interface m_vertex_tax_calculation_order;
    bool m_vertex_tax_calculation_order_isSet;
    bool m_vertex_tax_calculation_order_isValid;

    OAISales_data_order_address_interface m_vertex_tax_calculation_shipping_address;
    bool m_vertex_tax_calculation_shipping_address_isSet;
    bool m_vertex_tax_calculation_shipping_address_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISales_data_invoice_extension_interface)

#endif // OAISales_data_invoice_extension_interface_H
