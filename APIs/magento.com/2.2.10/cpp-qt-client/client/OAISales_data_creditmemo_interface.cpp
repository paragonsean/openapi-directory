...
OAISales_data_creditmemo_interface::OAISales_data_creditmemo_interface(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISales_data_creditmemo_interface::OAISales_data_creditmemo_interface() {
    this->initializeModel();
}

OAISales_data_creditmemo_interface::~OAISales_data_creditmemo_interface() {}

void OAISales_data_creditmemo_interface::initializeModel() {
    ...
    m_base_adjustment_isSet = false;
    m_base_adjustment_isValid = false;
    ...
    m_creditmemo_status_isSet = false;
    m_creditmemo_status_isValid = false;
...
void OAISales_data_creditmemo_interface::fromJson(QString jsonString) {
...
void OAISales_data_creditmemo_interface::fromJsonObject(QJsonObject json) {
    ...
    m_base_adjustment_isValid = ::OpenAPI::fromJsonValue(m_base_adjustment, json[QString("base_adjustment")]);
    m_base_adjustment_isSet = !json[QString("base_adjustment")].isNull() && m_base_adjustment_isValid;
    ...
    m_creditmemo_status_isValid = ::OpenAPI::fromJsonValue(m_creditmemo_status, json[QString("creditmemo_status")]);
    m_creditmemo_status_isSet = !json[QString("creditmemo_status")].isNull() && m_creditmemo_status_isValid;
...
QString OAISales_data_creditmemo_interface::asJson() const {
...
QJsonObject OAISales_data_creditmemo_interface::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_base_adjustment_isSet) {
        obj.insert(QString("base_adjustment"), ::OpenAPI::toJsonValue(m_base_adjustment));
    }
    ...
    if (m_creditmemo_status_isSet) {
        obj.insert(QString("creditmemo_status"), ::OpenAPI::toJsonValue(m_creditmemo_status));
    }
...
double OAISales_data_creditmemo_interface::getAdjustment() const {
    return m_adjustment;
}
void OAISales_data_creditmemo_interface::setAdjustment(const double &adjustment) {
    m_adjustment = adjustment;
    m_adjustment_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_adjustment_Set() const{
    return m_adjustment_isSet;
}

bool OAISales_data_creditmemo_interface::is_adjustment_Valid() const{
    return m_adjustment_isValid;
}

double OAISales_data_creditmemo_interface::getAdjustmentNegative() const {
    return m_adjustment_negative;
}
void OAISales_data_creditmemo_interface::setAdjustmentNegative(const double &adjustment_negative) {
    m_adjustment_negative = adjustment_negative;
    m_adjustment_negative_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_adjustment_negative_Set() const{
    return m_adjustment_negative_isSet;
}

bool OAISales_data_creditmemo_interface::is_adjustment_negative_Valid() const{
    return m_adjustment_negative_isValid;
}

double OAISales_data_creditmemo_interface::getAdjustmentPositive() const {
    return m_adjustment_positive;
}
void OAISales_data_creditmemo_interface::setAdjustmentPositive(const double &adjustment_positive) {
    m_adjustment_positive = adjustment_positive;
    m_adjustment_positive_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_adjustment_positive_Set() const{
    return m_adjustment_positive_isSet;
}

bool OAISales_data_creditmemo_interface::is_adjustment_positive_Valid() const{
    return m_adjustment_positive_isValid;
}

double OAISales_data_creditmemo_interface::getBaseAdjustment() const {
    return m_base_adjustment;
}
void OAISales_data_creditmemo_interface::setBaseAdjustment(const double &base_adjustment) {
    m_base_adjustment = base_adjustment;
    m_base_adjustment_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_adjustment_Set() const{
    return m_base_adjustment_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_adjustment_Valid() const{
    return m_base_adjustment_isValid;
}

double OAISales_data_creditmemo_interface::getBaseAdjustmentNegative() const {
    return m_base_adjustment_negative;
}
void OAISales_data_creditmemo_interface::setBaseAdjustmentNegative(const double &base_adjustment_negative) {
    m_base_adjustment_negative = base_adjustment_negative;
    m_base_adjustment_negative_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_adjustment_negative_Set() const{
    return m_base_adjustment_negative_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_adjustment_negative_Valid() const{
    return m_base_adjustment_negative_isValid;
}

double OAISales_data_creditmemo_interface::getBaseAdjustmentPositive() const {
    return m_base_adjustment_positive;
}
void OAISales_data_creditmemo_interface::setBaseAdjustmentPositive(const double &base_adjustment_positive) {
    m_base_adjustment_positive = base_adjustment_positive;
    m_base_adjustment_positive_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_adjustment_positive_Set() const{
    return m_base_adjustment_positive_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_adjustment_positive_Valid() const{
    return m_base_adjustment_positive_isValid;
}

QString OAISales_data_creditmemo_interface::getBaseCurrencyCode() const {
    return m_base_currency_code;
}
void OAISales_data_creditmemo_interface::setBaseCurrencyCode(const QString &base_currency_code) {
    m_base_currency_code = base_currency_code;
    m_base_currency_code_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_currency_code_Set() const{
    return m_base_currency_code_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_currency_code_Valid() const{
    return m_base_currency_code_isValid;
}

double OAISales_data_creditmemo_interface::getBaseDiscountAmount() const {
    return m_base_discount_amount;
}
void OAISales_data_creditmemo_interface::setBaseDiscountAmount(const double &base_discount_amount) {
    m_base_discount_amount = base_discount_amount;
    m_base_discount_amount_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_discount_amount_Set() const{
    return m_base_discount_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_discount_amount_Valid() const{
    return m_base_discount_amount_isValid;
}

double OAISales_data_creditmemo_interface::getBaseDiscountTaxCompensationAmount() const {
    return m_base_discount_tax_compensation_amount;
}
void OAISales_data_creditmemo_interface::setBaseDiscountTaxCompensationAmount(const double &base_discount_tax_compensation_amount) {
...
bool OAISales_data_creditmemo_interface::is_base_discount_tax_compensation_amount_Set() const{
    return m_base_discount_tax_compensation_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_discount_tax_compensation_amount_Valid() const{
    return m_base_discount_tax_compensation_amount_isValid;
}

double OAISales_data_creditmemo_interface::getBaseGrandTotal() const {
    return m_base_grand_total;
}
void OAISales_data_creditmemo_interface::setBaseGrandTotal(const double &base_grand_total) {
    m_base_grand_total = base_grand_total;
    m_base_grand_total_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_grand_total_Set() const{
    return m_base_grand_total_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_grand_total_Valid() const{
    return m_base_grand_total_isValid;
}

double OAISales_data_creditmemo_interface::getBaseShippingAmount() const {
    return m_base_shipping_amount;
}
void OAISales_data_creditmemo_interface::setBaseShippingAmount(const double &base_shipping_amount) {
    m_base_shipping_amount = base_shipping_amount;
    m_base_shipping_amount_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_shipping_amount_Set() const{
    return m_base_shipping_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_shipping_amount_Valid() const{
    return m_base_shipping_amount_isValid;
}

double OAISales_data_creditmemo_interface::getBaseShippingDiscountTaxCompensationAmnt() const {
    return m_base_shipping_discount_tax_compensation_amnt;
}
void OAISales_data_creditmemo_interface::setBaseShippingDiscountTaxCompensationAmnt(const double &base_shipping_discount_tax_compensation_amnt) {
...
bool OAISales_data_creditmemo_interface::is_base_shipping_discount_tax_compensation_amnt_Set() const{
    return m_base_shipping_discount_tax_compensation_amnt_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_shipping_discount_tax_compensation_amnt_Valid() const{
    return m_base_shipping_discount_tax_compensation_amnt_isValid;
}

double OAISales_data_creditmemo_interface::getBaseShippingInclTax() const {
    return m_base_shipping_incl_tax;
}
void OAISales_data_creditmemo_interface::setBaseShippingInclTax(const double &base_shipping_incl_tax) {
    m_base_shipping_incl_tax = base_shipping_incl_tax;
    m_base_shipping_incl_tax_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_shipping_incl_tax_Set() const{
    return m_base_shipping_incl_tax_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_shipping_incl_tax_Valid() const{
    return m_base_shipping_incl_tax_isValid;
}

double OAISales_data_creditmemo_interface::getBaseShippingTaxAmount() const {
    return m_base_shipping_tax_amount;
}
void OAISales_data_creditmemo_interface::setBaseShippingTaxAmount(const double &base_shipping_tax_amount) {
    m_base_shipping_tax_amount = base_shipping_tax_amount;
    m_base_shipping_tax_amount_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_shipping_tax_amount_Set() const{
    return m_base_shipping_tax_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_shipping_tax_amount_Valid() const{
    return m_base_shipping_tax_amount_isValid;
}

double OAISales_data_creditmemo_interface::getBaseSubtotal() const {
    return m_base_subtotal;
}
void OAISales_data_creditmemo_interface::setBaseSubtotal(const double &base_subtotal) {
    m_base_subtotal = base_subtotal;
    m_base_subtotal_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_subtotal_Set() const{
    return m_base_subtotal_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_subtotal_Valid() const{
    return m_base_subtotal_isValid;
}

double OAISales_data_creditmemo_interface::getBaseSubtotalInclTax() const {
    return m_base_subtotal_incl_tax;
}
void OAISales_data_creditmemo_interface::setBaseSubtotalInclTax(const double &base_subtotal_incl_tax) {
    m_base_subtotal_incl_tax = base_subtotal_incl_tax;
    m_base_subtotal_incl_tax_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_subtotal_incl_tax_Set() const{
    return m_base_subtotal_incl_tax_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_subtotal_incl_tax_Valid() const{
    return m_base_subtotal_incl_tax_isValid;
}

double OAISales_data_creditmemo_interface::getBaseTaxAmount() const {
    return m_base_tax_amount;
}
void OAISales_data_creditmemo_interface::setBaseTaxAmount(const double &base_tax_amount) {
    m_base_tax_amount = base_tax_amount;
    m_base_tax_amount_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_tax_amount_Set() const{
    return m_base_tax_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_tax_amount_Valid() const{
    return m_base_tax_amount_isValid;
}

double OAISales_data_creditmemo_interface::getBaseToGlobalRate() const {
    return m_base_to_global_rate;
}
void OAISales_data_creditmemo_interface::setBaseToGlobalRate(const double &base_to_global_rate) {
    m_base_to_global_rate = base_to_global_rate;
    m_base_to_global_rate_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_to_global_rate_Set() const{
    return m_base_to_global_rate_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_to_global_rate_Valid() const{
    return m_base_to_global_rate_isValid;
}

double OAISales_data_creditmemo_interface::getBaseToOrderRate() const {
    return m_base_to_order_rate;
}
void OAISales_data_creditmemo_interface::setBaseToOrderRate(const double &base_to_order_rate) {
    m_base_to_order_rate = base_to_order_rate;
    m_base_to_order_rate_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_base_to_order_rate_Set() const{
    return m_base_to_order_rate_isSet;
}

bool OAISales_data_creditmemo_interface::is_base_to_order_rate_Valid() const{
    return m_base_to_order_rate_isValid;
}

qint32 OAISales_data_creditmemo_interface::getBillingAddressId() const {
    return m_billing_address_id;
}
void OAISales_data_creditmemo_interface::setBillingAddressId(const qint32 &billing_address_id) {
    m_billing_address_id = billing_address_id;
    m_billing_address_id_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_billing_address_id_Set() const{
    return m_billing_address_id_isSet;
}

bool OAISales_data_creditmemo_interface::is_billing_address_id_Valid() const{
    return m_billing_address_id_isValid;
}

QList<OAISales_data_creditmemo_comment_interface> OAISales_data_creditmemo_interface::getComments() const {
    return m_comments;
}
void OAISales_data_creditmemo_interface::setComments(const QList<OAISales_data_creditmemo_comment_interface> &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAISales_data_creditmemo_interface::is_comments_Valid() const{
    return m_comments_isValid;
}

QString OAISales_data_creditmemo_interface::getCreatedAt() const {
    return m_created_at;
}
void OAISales_data_creditmemo_interface::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAISales_data_creditmemo_interface::is_created_at_Valid() const{
    return m_created_at_isValid;
}

qint32 OAISales_data_creditmemo_interface::getCreditmemoStatus() const {
    return m_creditmemo_status;
}
void OAISales_data_creditmemo_interface::setCreditmemoStatus(const qint32 &creditmemo_status) {
    m_creditmemo_status = creditmemo_status;
    m_creditmemo_status_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_creditmemo_status_Set() const{
    return m_creditmemo_status_isSet;
}

bool OAISales_data_creditmemo_interface::is_creditmemo_status_Valid() const{
    return m_creditmemo_status_isValid;
}

double OAISales_data_creditmemo_interface::getDiscountAmount() const {
    return m_discount_amount;
}
void OAISales_data_creditmemo_interface::setDiscountAmount(const double &discount_amount) {
    m_discount_amount = discount_amount;
    m_discount_amount_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_discount_amount_Set() const{
    return m_discount_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_discount_amount_Valid() const{
    return m_discount_amount_isValid;
}

QString OAISales_data_creditmemo_interface::getDiscountDescription() const {
    return m_discount_description;
}
void OAISales_data_creditmemo_interface::setDiscountDescription(const QString &discount_description) {
    m_discount_description = discount_description;
    m_discount_description_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_discount_description_Set() const{
    return m_discount_description_isSet;
}

bool OAISales_data_creditmemo_interface::is_discount_description_Valid() const{
    return m_discount_description_isValid;
}

double OAISales_data_creditmemo_interface::getDiscountTaxCompensationAmount() const {
    return m_discount_tax_compensation_amount;
}
void OAISales_data_creditmemo_interface::setDiscountTaxCompensationAmount(const double &discount_tax_compensation_amount) {
    m_discount_tax_compensation_amount = discount_tax_compensation_amount;
    m_discount_tax_compensation_amount_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_discount_tax_compensation_amount_Set() const{
    return m_discount_tax_compensation_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_discount_tax_compensation_amount_Valid() const{
    return m_discount_tax_compensation_amount_isValid;
}

qint32 OAISales_data_creditmemo_interface::getEmailSent() const {
    return m_email_sent;
}
void OAISales_data_creditmemo_interface::setEmailSent(const qint32 &email_sent) {
    m_email_sent = email_sent;
    m_email_sent_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_email_sent_Set() const{
    return m_email_sent_isSet;
}

bool OAISales_data_creditmemo_interface::is_email_sent_Valid() const{
    return m_email_sent_isValid;
}

qint32 OAISales_data_creditmemo_interface::getEntityId() const {
    return m_entity_id;
}
void OAISales_data_creditmemo_interface::setEntityId(const qint32 &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAISales_data_creditmemo_interface::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

OAISales_data_creditmemo_extension_interface OAISales_data_creditmemo_interface::getExtensionAttributes() const {
    return m_extension_attributes;
}
void OAISales_data_creditmemo_interface::setExtensionAttributes(const OAISales_data_creditmemo_extension_interface &extension_attributes) {
    m_extension_attributes = extension_attributes;
    m_extension_attributes_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_extension_attributes_Set() const{
    return m_extension_attributes_isSet;
}

bool OAISales_data_creditmemo_interface::is_extension_attributes_Valid() const{
    return m_extension_attributes_isValid;
}

QString OAISales_data_creditmemo_interface::getGlobalCurrencyCode() const {
    return m_global_currency_code;
}
void OAISales_data_creditmemo_interface::setGlobalCurrencyCode(const QString &global_currency_code) {
    m_global_currency_code = global_currency_code;
    m_global_currency_code_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_global_currency_code_Set() const{
    return m_global_currency_code_isSet;
}

bool OAISales_data_creditmemo_interface::is_global_currency_code_Valid() const{
    return m_global_currency_code_isValid;
}

double OAISales_data_creditmemo_interface::getGrandTotal() const {
    return m_grand_total;
}
void OAISales_data_creditmemo_interface::setGrandTotal(const double &grand_total) {
    m_grand_total = grand_total;
    m_grand_total_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_grand_total_Set() const{
    return m_grand_total_isSet;
}

bool OAISales_data_creditmemo_interface::is_grand_total_Valid() const{
    return m_grand_total_isValid;
}

QString OAISales_data_creditmemo_interface::getIncrementId() const {
    return m_increment_id;
}
void OAISales_data_creditmemo_interface::setIncrementId(const QString &increment_id) {
    m_increment_id = increment_id;
    m_increment_id_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_increment_id_Set() const{
    return m_increment_id_isSet;
}

bool OAISales_data_creditmemo_interface::is_increment_id_Valid() const{
    return m_increment_id_isValid;
}

qint32 OAISales_data_creditmemo_interface::getInvoiceId() const {
    return m_invoice_id;
}
void OAISales_data_creditmemo_interface::setInvoiceId(const qint32 &invoice_id) {
    m_invoice_id = invoice_id;
    m_invoice_id_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_invoice_id_Set() const{
    return m_invoice_id_isSet;
}

bool OAISales_data_creditmemo_interface::is_invoice_id_Valid() const{
    return m_invoice_id_isValid;
}

QList<OAISales_data_creditmemo_item_interface> OAISales_data_creditmemo_interface::getItems() const {
    return m_items;
}
void OAISales_data_creditmemo_interface::setItems(const QList<OAISales_data_creditmemo_item_interface> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_items_Set() const{
    return m_items_isSet;
}

bool OAISales_data_creditmemo_interface::is_items_Valid() const{
    return m_items_isValid;
}

QString OAISales_data_creditmemo_interface::getOrderCurrencyCode() const {
    return m_order_currency_code;
}
void OAISales_data_creditmemo_interface::setOrderCurrencyCode(const QString &order_currency_code) {
    m_order_currency_code = order_currency_code;
    m_order_currency_code_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_order_currency_code_Set() const{
    return m_order_currency_code_isSet;
}

bool OAISales_data_creditmemo_interface::is_order_currency_code_Valid() const{
    return m_order_currency_code_isValid;
}

qint32 OAISales_data_creditmemo_interface::getOrderId() const {
    return m_order_id;
}
void OAISales_data_creditmemo_interface::setOrderId(const qint32 &order_id) {
    m_order_id = order_id;
    m_order_id_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_order_id_Set() const{
    return m_order_id_isSet;
}

bool OAISales_data_creditmemo_interface::is_order_id_Valid() const{
    return m_order_id_isValid;
}

qint32 OAISales_data_creditmemo_interface::getShippingAddressId() const {
    return m_shipping_address_id;
}
void OAISales_data_creditmemo_interface::setShippingAddressId(const qint32 &shipping_address_id) {
    m_shipping_address_id = shipping_address_id;
    m_shipping_address_id_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_shipping_address_id_Set() const{
    return m_shipping_address_id_isSet;
}

bool OAISales_data_creditmemo_interface::is_shipping_address_id_Valid() const{
    return m_shipping_address_id_isValid;
}

double OAISales_data_creditmemo_interface::getShippingAmount() const {
    return m_shipping_amount;
}
void OAISales_data_creditmemo_interface::setShippingAmount(const double &shipping_amount) {
    m_shipping_amount = shipping_amount;
    m_shipping_amount_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_shipping_amount_Set() const{
    return m_shipping_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_shipping_amount_Valid() const{
    return m_shipping_amount_isValid;
}

double OAISales_data_creditmemo_interface::getShippingDiscountTaxCompensationAmount() const {
    return m_shipping_discount_tax_compensation_amount;
}
void OAISales_data_creditmemo_interface::setShippingDiscountTaxCompensationAmount(const double &shipping_discount_tax_compensation_amount) {
...
bool OAISales_data_creditmemo_interface::is_shipping_discount_tax_compensation_amount_Set() const{
    return m_shipping_discount_tax_compensation_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_shipping_discount_tax_compensation_amount_Valid() const{
    return m_shipping_discount_tax_compensation_amount_isValid;
}

double OAISales_data_creditmemo_interface::getShippingInclTax() const {
    return m_shipping_incl_tax;
}
void OAISales_data_creditmemo_interface::setShippingInclTax(const double &shipping_incl_tax) {
    m_shipping_incl_tax = shipping_incl_tax;
    m_shipping_incl_tax_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_shipping_incl_tax_Set() const{
    return m_shipping_incl_tax_isSet;
}

bool OAISales_data_creditmemo_interface::is_shipping_incl_tax_Valid() const{
    return m_shipping_incl_tax_isValid;
}

double OAISales_data_creditmemo_interface::getShippingTaxAmount() const {
    return m_shipping_tax_amount;
}
void OAISales_data_creditmemo_interface::setShippingTaxAmount(const double &shipping_tax_amount) {
    m_shipping_tax_amount = shipping_tax_amount;
    m_shipping_tax_amount_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_shipping_tax_amount_Set() const{
    return m_shipping_tax_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_shipping_tax_amount_Valid() const{
    return m_shipping_tax_amount_isValid;
}

qint32 OAISales_data_creditmemo_interface::getState() const {
    return m_state;
}
void OAISales_data_creditmemo_interface::setState(const qint32 &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_state_Set() const{
    return m_state_isSet;
}

bool OAISales_data_creditmemo_interface::is_state_Valid() const{
    return m_state_isValid;
}

QString OAISales_data_creditmemo_interface::getStoreCurrencyCode() const {
    return m_store_currency_code;
}
void OAISales_data_creditmemo_interface::setStoreCurrencyCode(const QString &store_currency_code) {
    m_store_currency_code = store_currency_code;
    m_store_currency_code_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_store_currency_code_Set() const{
    return m_store_currency_code_isSet;
}

bool OAISales_data_creditmemo_interface::is_store_currency_code_Valid() const{
    return m_store_currency_code_isValid;
}

qint32 OAISales_data_creditmemo_interface::getStoreId() const {
    return m_store_id;
}
void OAISales_data_creditmemo_interface::setStoreId(const qint32 &store_id) {
    m_store_id = store_id;
    m_store_id_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_store_id_Set() const{
    return m_store_id_isSet;
}

bool OAISales_data_creditmemo_interface::is_store_id_Valid() const{
    return m_store_id_isValid;
}

double OAISales_data_creditmemo_interface::getStoreToBaseRate() const {
    return m_store_to_base_rate;
}
void OAISales_data_creditmemo_interface::setStoreToBaseRate(const double &store_to_base_rate) {
    m_store_to_base_rate = store_to_base_rate;
    m_store_to_base_rate_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_store_to_base_rate_Set() const{
    return m_store_to_base_rate_isSet;
}

bool OAISales_data_creditmemo_interface::is_store_to_base_rate_Valid() const{
    return m_store_to_base_rate_isValid;
}

double OAISales_data_creditmemo_interface::getStoreToOrderRate() const {
    return m_store_to_order_rate;
}
void OAISales_data_creditmemo_interface::setStoreToOrderRate(const double &store_to_order_rate) {
    m_store_to_order_rate = store_to_order_rate;
    m_store_to_order_rate_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_store_to_order_rate_Set() const{
    return m_store_to_order_rate_isSet;
}

bool OAISales_data_creditmemo_interface::is_store_to_order_rate_Valid() const{
    return m_store_to_order_rate_isValid;
}

double OAISales_data_creditmemo_interface::getSubtotal() const {
    return m_subtotal;
}
void OAISales_data_creditmemo_interface::setSubtotal(const double &subtotal) {
    m_subtotal = subtotal;
    m_subtotal_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_subtotal_Set() const{
    return m_subtotal_isSet;
}

bool OAISales_data_creditmemo_interface::is_subtotal_Valid() const{
    return m_subtotal_isValid;
}

double OAISales_data_creditmemo_interface::getSubtotalInclTax() const {
    return m_subtotal_incl_tax;
}
void OAISales_data_creditmemo_interface::setSubtotalInclTax(const double &subtotal_incl_tax) {
    m_subtotal_incl_tax = subtotal_incl_tax;
    m_subtotal_incl_tax_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_subtotal_incl_tax_Set() const{
    return m_subtotal_incl_tax_isSet;
}

bool OAISales_data_creditmemo_interface::is_subtotal_incl_tax_Valid() const{
    return m_subtotal_incl_tax_isValid;
}

double OAISales_data_creditmemo_interface::getTaxAmount() const {
    return m_tax_amount;
}
void OAISales_data_creditmemo_interface::setTaxAmount(const double &tax_amount) {
    m_tax_amount = tax_amount;
    m_tax_amount_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_tax_amount_Set() const{
    return m_tax_amount_isSet;
}

bool OAISales_data_creditmemo_interface::is_tax_amount_Valid() const{
    return m_tax_amount_isValid;
}

QString OAISales_data_creditmemo_interface::getTransactionId() const {
    return m_transaction_id;
}
void OAISales_data_creditmemo_interface::setTransactionId(const QString &transaction_id) {
    m_transaction_id = transaction_id;
    m_transaction_id_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_transaction_id_Set() const{
    return m_transaction_id_isSet;
}

bool OAISales_data_creditmemo_interface::is_transaction_id_Valid() const{
    return m_transaction_id_isValid;
}

QString OAISales_data_creditmemo_interface::getUpdatedAt() const {
    return m_updated_at;
}
void OAISales_data_creditmemo_interface::setUpdatedAt(const QString &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAISales_data_creditmemo_interface::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAISales_data_creditmemo_interface::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAISales_data_creditmemo_interface::isSet() const {
...
bool OAISales_data_creditmemo_interface::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_items_isValid && m_order_id_isValid && true;
}
