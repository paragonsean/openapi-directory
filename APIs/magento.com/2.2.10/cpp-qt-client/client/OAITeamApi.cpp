...
void OAITeamApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("companyTeamRepositoryV1GetListGet", defaultConf);
    _serverIndices.insert("companyTeamRepositoryV1GetListGet", 0);
}
...
void OAITeamApi::companyTeamRepositoryV1GetListGet(const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_field, const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_value, const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_condition_type, const ::OpenAPI::OptionalParam<QString> &search_criteria_sort_orders_0_field, const ::OpenAPI::OptionalParam<QString> &search_criteria_sort_orders_0_direction, const ::OpenAPI::OptionalParam<qint32> &search_criteria_page_size, const ::OpenAPI::OptionalParam<qint32> &search_criteria_current_page) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITeamApi::companyTeamRepositoryV1GetListGetCallback);
...
void OAITeamApi::companyTeamRepositoryV1GetListGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICompany_data_team_search_results_interface output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT companyTeamRepositoryV1GetListGetSignal(output);
        Q_EMIT companyTeamRepositoryV1GetListGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT companyTeamRepositoryV1GetListGetSignalE(output, error_type, error_str);
        Q_EMIT companyTeamRepositoryV1GetListGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT companyTeamRepositoryV1GetListGetSignalError(output, error_type, error_str);
        Q_EMIT companyTeamRepositoryV1GetListGetSignalErrorFull(worker, error_type, error_str);
    }
}
