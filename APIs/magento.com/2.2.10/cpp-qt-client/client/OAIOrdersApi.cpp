...
void OAIOrdersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("salesOrderRepositoryV1GetListGet", defaultConf);
    _serverIndices.insert("salesOrderRepositoryV1GetListGet", 0);
    _serverConfigs.insert("salesOrderRepositoryV1SavePost", defaultConf);
    _serverIndices.insert("salesOrderRepositoryV1SavePost", 0);
}
...
void OAIOrdersApi::salesOrderRepositoryV1GetListGet(const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_field, const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_value, const ::OpenAPI::OptionalParam<QString> &search_criteria_filter_groups_0_filters_0_condition_type, const ::OpenAPI::OptionalParam<QString> &search_criteria_sort_orders_0_field, const ::OpenAPI::OptionalParam<QString> &search_criteria_sort_orders_0_direction, const ::OpenAPI::OptionalParam<qint32> &search_criteria_page_size, const ::OpenAPI::OptionalParam<qint32> &search_criteria_current_page) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::salesOrderRepositoryV1GetListGetCallback);
...
void OAIOrdersApi::salesOrderRepositoryV1GetListGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAISales_data_order_search_result_interface output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT salesOrderRepositoryV1GetListGetSignal(output);
        Q_EMIT salesOrderRepositoryV1GetListGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT salesOrderRepositoryV1GetListGetSignalE(output, error_type, error_str);
        Q_EMIT salesOrderRepositoryV1GetListGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT salesOrderRepositoryV1GetListGetSignalError(output, error_type, error_str);
        Q_EMIT salesOrderRepositoryV1GetListGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIOrdersApi::salesOrderRepositoryV1SavePost(const ::OpenAPI::OptionalParam<OAISalesOrderRepositoryV1SavePost_request> &oai_sales_order_repository_v1_save_post_request) {
    QString fullPath = QString(_serverConfigs["salesOrderRepositoryV1SavePost"][_serverIndices.value("salesOrderRepositoryV1SavePost")].URL()+"/V1/orders/");
    ...
    if (oai_sales_order_repository_v1_save_post_request.hasValue()){

        
        QByteArray output = oai_sales_order_repository_v1_save_post_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::salesOrderRepositoryV1SavePostCallback);
    connect(this, &OAIOrdersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOrdersApi::salesOrderRepositoryV1SavePostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISales_data_order_interface output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT salesOrderRepositoryV1SavePostSignal(output);
        Q_EMIT salesOrderRepositoryV1SavePostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT salesOrderRepositoryV1SavePostSignalE(output, error_type, error_str);
        Q_EMIT salesOrderRepositoryV1SavePostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT salesOrderRepositoryV1SavePostSignalError(output, error_type, error_str);
        Q_EMIT salesOrderRepositoryV1SavePostSignalErrorFull(worker, error_type, error_str);
    }
}
