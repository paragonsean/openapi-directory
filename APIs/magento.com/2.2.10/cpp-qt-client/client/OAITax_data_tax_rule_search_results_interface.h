...
/*
 * OAITax_data_tax_rule_search_results_interface.h
 *
 * Interface for tax rule search results.
 */

#ifndef OAITax_data_tax_rule_search_results_interface_H
#define OAITax_data_tax_rule_search_results_interface_H
...
class OAITax_data_tax_rule_search_results_interface : public OAIObject {
public:
    OAITax_data_tax_rule_search_results_interface();
    OAITax_data_tax_rule_search_results_interface(QString json);
    ~OAITax_data_tax_rule_search_results_interface() override;
    ...
    QList<OAITax_data_tax_rule_interface> getItems() const;
    void setItems(const QList<OAITax_data_tax_rule_interface> &items);
...
private:
    ...
    QList<OAITax_data_tax_rule_interface> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITax_data_tax_rule_search_results_interface)

#endif // OAITax_data_tax_rule_search_results_interface_H
