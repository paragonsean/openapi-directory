...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CustomerDataRegionInterface();
  });
  ...
  describe('CustomerDataRegionInterface', function() {
    it('should create an instance of CustomerDataRegionInterface', function() {
      ...
      //var instance = new MagentoB2B.CustomerDataRegionInterface();
      //expect(instance).to.be.a(MagentoB2B.CustomerDataRegionInterface);
    });
