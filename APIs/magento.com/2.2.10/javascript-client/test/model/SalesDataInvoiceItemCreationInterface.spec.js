...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesDataInvoiceItemCreationInterface();
  });
  ...
  describe('SalesDataInvoiceItemCreationInterface', function() {
    it('should create an instance of SalesDataInvoiceItemCreationInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesDataInvoiceItemCreationInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesDataInvoiceItemCreationInterface);
    });
