...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesDataInvoiceExtensionInterface();
  });
  ...
  describe('SalesDataInvoiceExtensionInterface', function() {
    it('should create an instance of SalesDataInvoiceExtensionInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesDataInvoiceExtensionInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesDataInvoiceExtensionInterface);
    });
    ...
    it('should have the property vertexTaxCalculationBillingAddress (base name: "vertex_tax_calculation_billing_address")', function() {
      // uncomment below and update the code to test the property vertexTaxCalculationBillingAddress
      //var instance = new MagentoB2B.SalesDataInvoiceExtensionInterface();
      //expect(instance).to.be();
    });

    it('should have the property vertexTaxCalculationOrder (base name: "vertex_tax_calculation_order")', function() {
      // uncomment below and update the code to test the property vertexTaxCalculationOrder
      //var instance = new MagentoB2B.SalesDataInvoiceExtensionInterface();
      //expect(instance).to.be();
    });

    it('should have the property vertexTaxCalculationShippingAddress (base name: "vertex_tax_calculation_shipping_address")', function() {
      // uncomment below and update the code to test the property vertexTaxCalculationShippingAddress
      //var instance = new MagentoB2B.SalesDataInvoiceExtensionInterface();
      //expect(instance).to.be();
    });
