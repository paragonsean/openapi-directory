...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SharedCatalogDataSharedCatalogInterface();
  });
  ...
  describe('SharedCatalogDataSharedCatalogInterface', function() {
    it('should create an instance of SharedCatalogDataSharedCatalogInterface', function() {
      // uncomment below and update the code to test SharedCatalogDataSharedCatalogInterface
      //var instance = new MagentoB2B.SharedCatalogDataSharedCatalogInterface();
      //expect(instance).to.be.a(MagentoB2B.SharedCatalogDataSharedCatalogInterface);
    });
