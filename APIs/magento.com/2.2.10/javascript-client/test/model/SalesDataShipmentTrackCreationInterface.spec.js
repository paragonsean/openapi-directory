...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesDataShipmentTrackCreationInterface();
  });
  ...
  describe('SalesDataShipmentTrackCreationInterface', function() {
    it('should create an instance of SalesDataShipmentTrackCreationInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesDataShipmentTrackCreationInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesDataShipmentTrackCreationInterface);
    });
