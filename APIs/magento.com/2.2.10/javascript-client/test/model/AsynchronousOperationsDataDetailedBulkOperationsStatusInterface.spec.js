...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.AsynchronousOperationsDataDetailedBulkOperationsStatusInterface();
  });
  ...
  describe('AsynchronousOperationsDataDetailedBulkOperationsStatusInterface', function() {
    it('should create an instance of AsynchronousOperationsDataDetailedBulkOperationsStatusInterface', function() {
      // uncomment below and update the code to test AsynchronousOperationsDataDetailedBulkOperationsStatusInterface
      //var instance = new MagentoB2B.AsynchronousOperationsDataDetailedBulkOperationsStatusInterface();
      //expect(instance).to.be.a(MagentoB2B.AsynchronousOperationsDataDetailedBulkOperationsStatusInterface);
    });
