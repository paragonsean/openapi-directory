...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesDataInvoiceItemInterface();
  });
  ...
  describe('SalesDataInvoiceItemInterface', function() {
    it('should create an instance of SalesDataInvoiceItemInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesDataInvoiceItemInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesDataInvoiceItemInterface);
    });
