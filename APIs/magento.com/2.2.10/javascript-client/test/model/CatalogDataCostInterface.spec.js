...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CatalogDataCostInterface();
  });
  ...
  describe('CatalogDataCostInterface', function() {
    it('should create an instance of CatalogDataCostInterface', function() {
      // uncomment below and update the code to test CatalogDataCostInterface
      //var instance = new MagentoB2B.CatalogDataCostInterface();
      //expect(instance).to.be.a(MagentoB2B.CatalogDataCostInterface);
    });
