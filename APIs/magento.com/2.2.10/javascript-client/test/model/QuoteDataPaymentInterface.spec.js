...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.QuoteDataPaymentInterface();
  });
  ...
  describe('QuoteDataPaymentInterface', function() {
    it('should create an instance of QuoteDataPaymentInterface', function() {
      ...
      //var instance = new MagentoB2B.QuoteDataPaymentInterface();
      //expect(instance).to.be.a(MagentoB2B.QuoteDataPaymentInterface);
    });
