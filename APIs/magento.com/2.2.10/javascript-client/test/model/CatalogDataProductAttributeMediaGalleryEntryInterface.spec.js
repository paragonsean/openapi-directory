...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CatalogDataProductAttributeMediaGalleryEntryInterface();
  });
  ...
  describe('CatalogDataProductAttributeMediaGalleryEntryInterface', function() {
    it('should create an instance of CatalogDataProductAttributeMediaGalleryEntryInterface', function() {
      ...
      //var instance = new MagentoB2B.CatalogDataProductAttributeMediaGalleryEntryInterface();
      //expect(instance).to.be.a(MagentoB2B.CatalogDataProductAttributeMediaGalleryEntryInterface);
    });
