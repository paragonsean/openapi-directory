...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.QuoteDataAddressInterface();
  });
  ...
  describe('QuoteDataAddressInterface', function() {
    it('should create an instance of QuoteDataAddressInterface', function() {
      ...
      //var instance = new MagentoB2B.QuoteDataAddressInterface();
      //expect(instance).to.be.a(MagentoB2B.QuoteDataAddressInterface);
    });
    ...
    it('should have the property sameAsBilling (base name: "same_as_billing")', function() {
      // uncomment below and update the code to test the property sameAsBilling
      //var instance = new MagentoB2B.QuoteDataAddressInterface();
      //expect(instance).to.be();
    });

    it('should have the property saveInAddressBook (base name: "save_in_address_book")', function() {
