...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.NegotiableQuoteDataCommentAttachmentInterface();
  });
  ...
  describe('NegotiableQuoteDataCommentAttachmentInterface', function() {
    it('should create an instance of NegotiableQuoteDataCommentAttachmentInterface', function() {
      // uncomment below and update the code to test NegotiableQuoteDataCommentAttachmentInterface
      //var instance = new MagentoB2B.NegotiableQuoteDataCommentAttachmentInterface();
      //expect(instance).to.be.a(MagentoB2B.NegotiableQuoteDataCommentAttachmentInterface);
    });
