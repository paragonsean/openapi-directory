...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.QuoteDataCartItemInterface();
  });
  ...
  describe('QuoteDataCartItemInterface', function() {
    it('should create an instance of QuoteDataCartItemInterface', function() {
      ...
      //var instance = new MagentoB2B.QuoteDataCartItemInterface();
      //expect(instance).to.be.a(MagentoB2B.QuoteDataCartItemInterface);
    });
