...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CheckoutDataShippingInformationInterface();
  });
  ...
  describe('CheckoutDataShippingInformationInterface', function() {
    it('should create an instance of CheckoutDataShippingInformationInterface', function() {
      // uncomment below and update the code to test CheckoutDataShippingInformationInterface
      //var instance = new MagentoB2B.CheckoutDataShippingInformationInterface();
      //expect(instance).to.be.a(MagentoB2B.CheckoutDataShippingInformationInterface);
    });
    ...
    it('should have the property shippingCarrierCode (base name: "shipping_carrier_code")', function() {
      // uncomment below and update the code to test the property shippingCarrierCode
      //var instance = new MagentoB2B.CheckoutDataShippingInformationInterface();
      //expect(instance).to.be();
    });

    it('should have the property shippingMethodCode (base name: "shipping_method_code")', function() {
