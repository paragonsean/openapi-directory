...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesDataShipmentCommentInterface();
  });
  ...
  describe('SalesDataShipmentCommentInterface', function() {
    it('should create an instance of SalesDataShipmentCommentInterface', function() {
      // uncomment below and update the code to test SalesDataShipmentCommentInterface
      //var instance = new MagentoB2B.SalesDataShipmentCommentInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesDataShipmentCommentInterface);
    });
