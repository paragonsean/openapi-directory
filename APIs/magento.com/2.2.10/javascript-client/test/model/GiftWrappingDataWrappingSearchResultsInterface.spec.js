...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.GiftWrappingDataWrappingSearchResultsInterface();
  });
  ...
  describe('GiftWrappingDataWrappingSearchResultsInterface', function() {
    it('should create an instance of GiftWrappingDataWrappingSearchResultsInterface', function() {
      ...
      //var instance = new MagentoB2B.GiftWrappingDataWrappingSearchResultsInterface();
      //expect(instance).to.be.a(MagentoB2B.GiftWrappingDataWrappingSearchResultsInterface);
    });
