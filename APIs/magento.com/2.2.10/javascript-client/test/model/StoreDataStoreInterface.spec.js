...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.StoreDataStoreInterface();
  });
  ...
  describe('StoreDataStoreInterface', function() {
    it('should create an instance of StoreDataStoreInterface', function() {
      // uncomment below and update the code to test StoreDataStoreInterface
      //var instance = new MagentoB2B.StoreDataStoreInterface();
      //expect(instance).to.be.a(MagentoB2B.StoreDataStoreInterface);
    });
    ...
    it('should have the property storeGroupId (base name: "store_group_id")', function() {
