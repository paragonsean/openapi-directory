...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.GiftMessageDataMessageInterface();
  });
  ...
  describe('GiftMessageDataMessageInterface', function() {
    it('should create an instance of GiftMessageDataMessageInterface', function() {
      ...
      //var instance = new MagentoB2B.GiftMessageDataMessageInterface();
      //expect(instance).to.be.a(MagentoB2B.GiftMessageDataMessageInterface);
    });
    ...
    it('should have the property giftMessageId (base name: "gift_message_id")', function() {
