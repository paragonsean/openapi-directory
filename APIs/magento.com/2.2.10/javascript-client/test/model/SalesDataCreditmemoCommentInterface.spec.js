...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesDataCreditmemoCommentInterface();
  });
  ...
  describe('SalesDataCreditmemoCommentInterface', function() {
    it('should create an instance of SalesDataCreditmemoCommentInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesDataCreditmemoCommentInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesDataCreditmemoCommentInterface);
    });
