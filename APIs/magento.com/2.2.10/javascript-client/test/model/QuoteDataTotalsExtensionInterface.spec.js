...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.QuoteDataTotalsExtensionInterface();
  });
  ...
  describe('QuoteDataTotalsExtensionInterface', function() {
    it('should create an instance of QuoteDataTotalsExtensionInterface', function() {
      ...
      //var instance = new MagentoB2B.QuoteDataTotalsExtensionInterface();
      //expect(instance).to.be.a(MagentoB2B.QuoteDataTotalsExtensionInterface);
    });
    ...
    it('should have the property couponLabel (base name: "coupon_label")', function() {
      // uncomment below and update the code to test the property couponLabel
      //var instance = new MagentoB2B.QuoteDataTotalsExtensionInterface();
      //expect(instance).to.be();
    });
    ...
    it('should have the property negotiableQuoteTotals (base name: "negotiable_quote_totals")', function() {
      // uncomment below and update the code to test the property negotiableQuoteTotals
      //var instance = new MagentoB2B.QuoteDataTotalsExtensionInterface();
      //expect(instance).to.be();
    });
