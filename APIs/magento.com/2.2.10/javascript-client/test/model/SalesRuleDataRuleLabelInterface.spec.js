...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesRuleDataRuleLabelInterface();
  });
  ...
  describe('SalesRuleDataRuleLabelInterface', function() {
    it('should create an instance of SalesRuleDataRuleLabelInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesRuleDataRuleLabelInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesRuleDataRuleLabelInterface);
    });
