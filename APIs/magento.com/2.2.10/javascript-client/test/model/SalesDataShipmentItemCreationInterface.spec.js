...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesDataShipmentItemCreationInterface();
  });
  ...
  describe('SalesDataShipmentItemCreationInterface', function() {
    it('should create an instance of SalesDataShipmentItemCreationInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesDataShipmentItemCreationInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesDataShipmentItemCreationInterface);
    });
