...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.FrameworkSearchSearchResultInterface();
  });
  ...
  describe('FrameworkSearchSearchResultInterface', function() {
    it('should create an instance of FrameworkSearchSearchResultInterface', function() {
      // uncomment below and update the code to test FrameworkSearchSearchResultInterface
      //var instance = new MagentoB2B.FrameworkSearchSearchResultInterface();
      //expect(instance).to.be.a(MagentoB2B.FrameworkSearchSearchResultInterface);
    });
