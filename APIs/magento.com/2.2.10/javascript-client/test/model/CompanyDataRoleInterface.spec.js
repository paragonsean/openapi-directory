...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CompanyDataRoleInterface();
  });
  ...
  describe('CompanyDataRoleInterface', function() {
    it('should create an instance of CompanyDataRoleInterface', function() {
      // uncomment below and update the code to test CompanyDataRoleInterface
      //var instance = new MagentoB2B.CompanyDataRoleInterface();
      //expect(instance).to.be.a(MagentoB2B.CompanyDataRoleInterface);
    });
