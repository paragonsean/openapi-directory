...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.EavDataAttributeGroupInterface();
  });
  ...
  describe('EavDataAttributeGroupInterface', function() {
    it('should create an instance of EavDataAttributeGroupInterface', function() {
      ...
      //var instance = new MagentoB2B.EavDataAttributeGroupInterface();
      //expect(instance).to.be.a(MagentoB2B.EavDataAttributeGroupInterface);
    });
