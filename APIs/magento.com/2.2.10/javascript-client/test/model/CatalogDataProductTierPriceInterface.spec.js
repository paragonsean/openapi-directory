...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CatalogDataProductTierPriceInterface();
  });
  ...
  describe('CatalogDataProductTierPriceInterface', function() {
    it('should create an instance of CatalogDataProductTierPriceInterface', function() {
      ...
      //var instance = new MagentoB2B.CatalogDataProductTierPriceInterface();
      //expect(instance).to.be.a(MagentoB2B.CatalogDataProductTierPriceInterface);
    });
