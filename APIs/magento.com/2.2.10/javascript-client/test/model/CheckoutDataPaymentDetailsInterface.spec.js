...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CheckoutDataPaymentDetailsInterface();
  });
  ...
  describe('CheckoutDataPaymentDetailsInterface', function() {
    it('should create an instance of CheckoutDataPaymentDetailsInterface', function() {
      ...
      //var instance = new MagentoB2B.CheckoutDataPaymentDetailsInterface();
      //expect(instance).to.be.a(MagentoB2B.CheckoutDataPaymentDetailsInterface);
    });
