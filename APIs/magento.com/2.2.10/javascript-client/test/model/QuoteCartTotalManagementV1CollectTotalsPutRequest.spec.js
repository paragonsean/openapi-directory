...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.QuoteCartTotalManagementV1CollectTotalsPutRequest();
  });
  ...
  describe('QuoteCartTotalManagementV1CollectTotalsPutRequest', function() {
    it('should create an instance of QuoteCartTotalManagementV1CollectTotalsPutRequest', function() {
      // uncomment below and update the code to test QuoteCartTotalManagementV1CollectTotalsPutRequest
      //var instance = new MagentoB2B.QuoteCartTotalManagementV1CollectTotalsPutRequest();
      //expect(instance).to.be.a(MagentoB2B.QuoteCartTotalManagementV1CollectTotalsPutRequest);
    });
