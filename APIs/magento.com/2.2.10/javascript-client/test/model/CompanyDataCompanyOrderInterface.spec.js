...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CompanyDataCompanyOrderInterface();
  });
  ...
  describe('CompanyDataCompanyOrderInterface', function() {
    it('should create an instance of CompanyDataCompanyOrderInterface', function() {
      // uncomment below and update the code to test CompanyDataCompanyOrderInterface
      //var instance = new MagentoB2B.CompanyDataCompanyOrderInterface();
      //expect(instance).to.be.a(MagentoB2B.CompanyDataCompanyOrderInterface);
    });
