...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesDataCreditmemoCreationArgumentsInterface();
  });
  ...
  describe('SalesDataCreditmemoCreationArgumentsInterface', function() {
    it('should create an instance of SalesDataCreditmemoCreationArgumentsInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesDataCreditmemoCreationArgumentsInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesDataCreditmemoCreationArgumentsInterface);
    });
