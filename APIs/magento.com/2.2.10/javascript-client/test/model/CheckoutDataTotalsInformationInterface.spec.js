...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CheckoutDataTotalsInformationInterface();
  });
  ...
  describe('CheckoutDataTotalsInformationInterface', function() {
    it('should create an instance of CheckoutDataTotalsInformationInterface', function() {
      ...
      //var instance = new MagentoB2B.CheckoutDataTotalsInformationInterface();
      //expect(instance).to.be.a(MagentoB2B.CheckoutDataTotalsInformationInterface);
    });
