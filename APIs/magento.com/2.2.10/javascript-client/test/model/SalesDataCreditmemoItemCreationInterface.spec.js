...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesDataCreditmemoItemCreationInterface();
  });
  ...
  describe('SalesDataCreditmemoItemCreationInterface', function() {
    it('should create an instance of SalesDataCreditmemoItemCreationInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesDataCreditmemoItemCreationInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesDataCreditmemoItemCreationInterface);
    });
