...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CatalogProductAttributeManagementV1AssignPostRequest();
  });
  ...
  describe('CatalogProductAttributeManagementV1AssignPostRequest', function() {
    it('should create an instance of CatalogProductAttributeManagementV1AssignPostRequest', function() {
      // uncomment below and update the code to test CatalogProductAttributeManagementV1AssignPostRequest
      //var instance = new MagentoB2B.CatalogProductAttributeManagementV1AssignPostRequest();
      //expect(instance).to.be.a(MagentoB2B.CatalogProductAttributeManagementV1AssignPostRequest);
    });
