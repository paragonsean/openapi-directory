...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesDataShipmentSearchResultInterface();
  });
  ...
  describe('SalesDataShipmentSearchResultInterface', function() {
    it('should create an instance of SalesDataShipmentSearchResultInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesDataShipmentSearchResultInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesDataShipmentSearchResultInterface);
    });
