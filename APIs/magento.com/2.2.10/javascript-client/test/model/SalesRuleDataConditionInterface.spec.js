...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.SalesRuleDataConditionInterface();
  });
  ...
  describe('SalesRuleDataConditionInterface', function() {
    it('should create an instance of SalesRuleDataConditionInterface', function() {
      ...
      //var instance = new MagentoB2B.SalesRuleDataConditionInterface();
      //expect(instance).to.be.a(MagentoB2B.SalesRuleDataConditionInterface);
    });

    it('should have the property aggregatorType (base name: "aggregator_type")', function() {
