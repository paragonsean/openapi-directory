...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CatalogDataProductRenderFormattedPriceInfoInterface();
  });
  ...
  describe('CatalogDataProductRenderFormattedPriceInfoInterface', function() {
    it('should create an instance of CatalogDataProductRenderFormattedPriceInfoInterface', function() {
      // uncomment below and update the code to test CatalogDataProductRenderFormattedPriceInfoInterface
      //var instance = new MagentoB2B.CatalogDataProductRenderFormattedPriceInfoInterface();
      //expect(instance).to.be.a(MagentoB2B.CatalogDataProductRenderFormattedPriceInfoInterface);
    });
