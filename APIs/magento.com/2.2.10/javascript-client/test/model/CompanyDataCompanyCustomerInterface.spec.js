...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagentoB2B.CompanyDataCompanyCustomerInterface();
  });
  ...
  describe('CompanyDataCompanyCustomerInterface', function() {
    it('should create an instance of CompanyDataCompanyCustomerInterface', function() {
      // uncomment below and update the code to test CompanyDataCompanyCustomerInterface
      //var instance = new MagentoB2B.CompanyDataCompanyCustomerInterface();
      //expect(instance).to.be.a(MagentoB2B.CompanyDataCompanyCustomerInterface);
    });
