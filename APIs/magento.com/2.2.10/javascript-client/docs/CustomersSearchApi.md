# MagentoB2B.CustomersSearchApi

All URIs are relative to *https://example.com/rest/default*

Method | HTTP request | Description
------------- | ------------- | -------------
[**customerCustomerRepositoryV1GetListGet**](CustomersSearchApi.md#customerCustomerRepositoryV1GetListGet) | **GET** /V1/customers/search | customers/search
...
let apiInstance = new MagentoB2B.CustomersSearchApi();
let opts = {
...
apiInstance.customerCustomerRepositoryV1GetListGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
