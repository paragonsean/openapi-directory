# MagentoB2B.TaxRatesSearchApi

All URIs are relative to *https://example.com/rest/default*

Method | HTTP request | Description
------------- | ------------- | -------------
[**taxTaxRateRepositoryV1GetListGet**](TaxRatesSearchApi.md#taxTaxRateRepositoryV1GetListGet) | **GET** /V1/taxRates/search | taxRates/search
...
let apiInstance = new MagentoB2B.TaxRatesSearchApi();
let opts = {
...
apiInstance.taxTaxRateRepositoryV1GetListGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
