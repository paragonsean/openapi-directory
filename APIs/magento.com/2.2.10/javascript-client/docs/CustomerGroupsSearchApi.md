# MagentoB2B.CustomerGroupsSearchApi
...
let apiInstance = new MagentoB2B.CustomerGroupsSearchApi();
let opts = {
...
apiInstance.customerGroupRepositoryV1GetListGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
