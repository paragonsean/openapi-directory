# MagentoB2B.TaxClassesSearchApi

All URIs are relative to *https://example.com/rest/default*

Method | HTTP request | Description
------------- | ------------- | -------------
[**taxTaxClassRepositoryV1GetListGet**](TaxClassesSearchApi.md#taxTaxClassRepositoryV1GetListGet) | **GET** /V1/taxClasses/search | taxClasses/search
...
let apiInstance = new MagentoB2B.TaxClassesSearchApi();
let opts = {
...
apiInstance.taxTaxClassRepositoryV1GetListGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
