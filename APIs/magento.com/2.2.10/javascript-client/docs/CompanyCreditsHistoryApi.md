# MagentoB2B.CompanyCreditsHistoryApi
...
> CompanyCreditDataHistorySearchResultsInterface companyCreditCreditHistoryManagementV1GetListGet(opts)
...
let apiInstance = new MagentoB2B.CompanyCreditsHistoryApi();
let opts = {
...
apiInstance.companyCreditCreditHistoryManagementV1GetListGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
