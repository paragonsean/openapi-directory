# MagentoB2B.EavAttributeSetsListApi

All URIs are relative to *https://example.com/rest/default*

Method | HTTP request | Description
------------- | ------------- | -------------
[**eavAttributeSetRepositoryV1GetListGet**](EavAttributeSetsListApi.md#eavAttributeSetRepositoryV1GetListGet) | **GET** /V1/eav/attribute-sets/list | eav/attribute-sets/list
...
let apiInstance = new MagentoB2B.EavAttributeSetsListApi();
let opts = {
...
apiInstance.eavAttributeSetRepositoryV1GetListGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
