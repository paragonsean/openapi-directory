# MagentoB2B.ReturnsAttributeMetadataAttributeCodeApi
...
let apiInstance = new MagentoB2B.ReturnsAttributeMetadataAttributeCodeApi();
let attributeCode = "attributeCode_example"; // String | 
apiInstance.rmaRmaAttributesManagementV1GetAttributeMetadataGet(attributeCode, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
