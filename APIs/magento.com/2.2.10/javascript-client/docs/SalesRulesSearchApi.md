# MagentoB2B.SalesRulesSearchApi
...
let apiInstance = new MagentoB2B.SalesRulesSearchApi();
let opts = {
...
apiInstance.salesRuleRuleRepositoryV1GetListGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
