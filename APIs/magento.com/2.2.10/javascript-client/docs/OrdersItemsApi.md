# MagentoB2B.OrdersItemsApi

All URIs are relative to *https://example.com/rest/default*

Method | HTTP request | Description
------------- | ------------- | -------------
[**salesOrderItemRepositoryV1GetListGet**](OrdersItemsApi.md#salesOrderItemRepositoryV1GetListGet) | **GET** /V1/orders/items | orders/items
...
let apiInstance = new MagentoB2B.OrdersItemsApi();
let opts = {
...
apiInstance.salesOrderItemRepositoryV1GetListGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
