...
/**
* OrdersItems service.
* @module api/OrdersItemsApi
* @version 2.2.10
*/
export default class OrdersItemsApi {

    /**
    * Constructs a new OrdersItemsApi. 
    * @alias module:api/OrdersItemsApi
    * @class
    ...
    */
     ...
     * @callback module:api/OrdersItemsApi~salesOrderItemRepositoryV1GetListGetCallback
     ...
     * @param {module:api/OrdersItemsApi~salesOrderItemRepositoryV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SalesDataOrderItemSearchResultInterface}
     */
    salesOrderItemRepositoryV1GetListGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SalesDataOrderItemSearchResultInterface;
