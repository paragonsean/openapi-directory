...
/**
* GuestCartsCartIdEstimateShippingMethods service.
* @module api/GuestCartsCartIdEstimateShippingMethodsApi
* @version 2.2.10
*/
export default class GuestCartsCartIdEstimateShippingMethodsApi {

    /**
    * Constructs a new GuestCartsCartIdEstimateShippingMethodsApi. 
    * @alias module:api/GuestCartsCartIdEstimateShippingMethodsApi
    * @class
    ...
    */
     ...
     * @callback module:api/GuestCartsCartIdEstimateShippingMethodsApi~quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostCallback
     ...
     * @param {module:api/GuestCartsCartIdEstimateShippingMethodsApi~quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/QuoteDataShippingMethodInterface>}
     */
    quoteGuestShipmentEstimationV1EstimateByExtendedAddressPost(cartId, opts, callback) {
      opts = opts || {};
