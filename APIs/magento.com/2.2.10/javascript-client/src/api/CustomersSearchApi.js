...
/**
* CustomersSearch service.
* @module api/CustomersSearchApi
* @version 2.2.10
*/
export default class CustomersSearchApi {

    /**
    * Constructs a new CustomersSearchApi. 
    * @alias module:api/CustomersSearchApi
    * @class
    ...
    */
     ...
     * @callback module:api/CustomersSearchApi~customerCustomerRepositoryV1GetListGetCallback
     ...
     * @param {module:api/CustomersSearchApi~customerCustomerRepositoryV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomerDataCustomerSearchResultsInterface}
     */
    customerCustomerRepositoryV1GetListGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = CustomerDataCustomerSearchResultsInterface;
