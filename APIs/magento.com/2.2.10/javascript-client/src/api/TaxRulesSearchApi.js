...
/**
* TaxRulesSearch service.
* @module api/TaxRulesSearchApi
* @version 2.2.10
*/
export default class TaxRulesSearchApi {

    /**
    * Constructs a new TaxRulesSearchApi. 
    * @alias module:api/TaxRulesSearchApi
    * @class
    ...
    */
     ...
     * @callback module:api/TaxRulesSearchApi~taxTaxRuleRepositoryV1GetListGetCallback
     ...
     * @param {module:api/TaxRulesSearchApi~taxTaxRuleRepositoryV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TaxDataTaxRuleSearchResultsInterface}
     */
    taxTaxRuleRepositoryV1GetListGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = TaxDataTaxRuleSearchResultsInterface;
