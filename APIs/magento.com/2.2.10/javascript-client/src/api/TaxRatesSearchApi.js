...
/**
* TaxRatesSearch service.
* @module api/TaxRatesSearchApi
* @version 2.2.10
*/
export default class TaxRatesSearchApi {

    /**
    * Constructs a new TaxRatesSearchApi. 
    * @alias module:api/TaxRatesSearchApi
    * @class
    ...
    */
     ...
     * @callback module:api/TaxRatesSearchApi~taxTaxRateRepositoryV1GetListGetCallback
     ...
     * @param {module:api/TaxRatesSearchApi~taxTaxRateRepositoryV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TaxDataTaxRateSearchResultsInterface}
     */
    taxTaxRateRepositoryV1GetListGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = TaxDataTaxRateSearchResultsInterface;
