...
/**
* GuestCartsCartIdShippingMethods service.
* @module api/GuestCartsCartIdShippingMethodsApi
* @version 2.2.10
*/
export default class GuestCartsCartIdShippingMethodsApi {

    /**
    * Constructs a new GuestCartsCartIdShippingMethodsApi. 
    * @alias module:api/GuestCartsCartIdShippingMethodsApi
    * @class
    ...
    */
     ...
     * @callback module:api/GuestCartsCartIdShippingMethodsApi~quoteGuestShippingMethodManagementV1GetListGetCallback
     ...
     * @param {module:api/GuestCartsCartIdShippingMethodsApi~quoteGuestShippingMethodManagementV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/QuoteDataShippingMethodInterface>}
     */
    quoteGuestShippingMethodManagementV1GetListGet(cartId, callback) {
      let postBody = null;
