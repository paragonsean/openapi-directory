...
/**
* CartsSearch service.
* @module api/CartsSearchApi
* @version 2.2.10
*/
export default class CartsSearchApi {

    /**
    * Constructs a new CartsSearchApi. 
    * @alias module:api/CartsSearchApi
    * @class
    ...
    */
     ...
     * @callback module:api/CartsSearchApi~quoteCartRepositoryV1GetListGetCallback
     ...
     * @param {module:api/CartsSearchApi~quoteCartRepositoryV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/QuoteDataCartSearchResultsInterface}
     */
    quoteCartRepositoryV1GetListGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = QuoteDataCartSearchResultsInterface;
