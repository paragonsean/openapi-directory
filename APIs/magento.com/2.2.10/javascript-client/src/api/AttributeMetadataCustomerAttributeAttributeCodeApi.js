...
/**
* AttributeMetadataCustomerAttributeAttributeCode service.
* @module api/AttributeMetadataCustomerAttributeAttributeCodeApi
* @version 2.2.10
*/
export default class AttributeMetadataCustomerAttributeAttributeCodeApi {

    /**
    * Constructs a new AttributeMetadataCustomerAttributeAttributeCodeApi. 
    * @alias module:api/AttributeMetadataCustomerAttributeAttributeCodeApi
    * @class
    ...
    */
     ...
     * @callback module:api/AttributeMetadataCustomerAttributeAttributeCodeApi~customerCustomerMetadataV1GetAttributeMetadataGetCallback
     ...
     * @param {module:api/AttributeMetadataCustomerAttributeAttributeCodeApi~customerCustomerMetadataV1GetAttributeMetadataGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomerDataAttributeMetadataInterface}
     */
    customerCustomerMetadataV1GetAttributeMetadataGet(attributeCode, callback) {
      let postBody = null;
