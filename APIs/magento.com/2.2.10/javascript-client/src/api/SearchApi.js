...
export default class SearchApi {
    ...
    */
     ...
     * @callback module:api/SearchApi~searchV1SearchGetCallback
     ...
     * @param {module:api/SearchApi~searchV1SearchGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/FrameworkSearchSearchResultInterface}
     */
    searchV1SearchGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = FrameworkSearchSearchResultInterface;
