...
/**
* CompanyCreditsHistory service.
* @module api/CompanyCreditsHistoryApi
* @version 2.2.10
*/
export default class CompanyCreditsHistoryApi {

    /**
    * Constructs a new CompanyCreditsHistoryApi. 
    * @alias module:api/CompanyCreditsHistoryApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the companyCreditCreditHistoryManagementV1GetListGet operation.
     * @callback module:api/CompanyCreditsHistoryApi~companyCreditCreditHistoryManagementV1GetListGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CompanyCreditDataHistorySearchResultsInterface} data The data returned by the service call.
     ...
     * @param {module:api/CompanyCreditsHistoryApi~companyCreditCreditHistoryManagementV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CompanyCreditDataHistorySearchResultsInterface}
     */
    companyCreditCreditHistoryManagementV1GetListGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = CompanyCreditDataHistorySearchResultsInterface;
