...
/**
* Creditmemos service.
* @module api/CreditmemosApi
* @version 2.2.10
*/
export default class CreditmemosApi {

    /**
    * Constructs a new CreditmemosApi. 
    * @alias module:api/CreditmemosApi
    * @class
    ...
    */
     ...
     * @callback module:api/CreditmemosApi~salesCreditmemoRepositoryV1GetListGetCallback
     ...
     * @param {module:api/CreditmemosApi~salesCreditmemoRepositoryV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SalesDataCreditmemoSearchResultInterface}
     */
    salesCreditmemoRepositoryV1GetListGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SalesDataCreditmemoSearchResultInterface;
