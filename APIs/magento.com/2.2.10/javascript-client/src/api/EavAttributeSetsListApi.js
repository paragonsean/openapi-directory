...
/**
* EavAttributeSetsList service.
* @module api/EavAttributeSetsListApi
* @version 2.2.10
*/
export default class EavAttributeSetsListApi {

    /**
    * Constructs a new EavAttributeSetsListApi. 
    * @alias module:api/EavAttributeSetsListApi
    * @class
    ...
    */
     ...
     * @callback module:api/EavAttributeSetsListApi~eavAttributeSetRepositoryV1GetListGetCallback
     ...
     * @param {module:api/EavAttributeSetsListApi~eavAttributeSetRepositoryV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EavDataAttributeSetSearchResultsInterface}
     */
    eavAttributeSetRepositoryV1GetListGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
