...
/**
* SalesRulesSearch service.
* @module api/SalesRulesSearchApi
* @version 2.2.10
*/
export default class SalesRulesSearchApi {

    /**
    * Constructs a new SalesRulesSearchApi. 
    * @alias module:api/SalesRulesSearchApi
    * @class
    ...
    */
     ...
     * @callback module:api/SalesRulesSearchApi~salesRuleRuleRepositoryV1GetListGetCallback
     ...
     * @param {module:api/SalesRulesSearchApi~salesRuleRuleRepositoryV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SalesRuleDataRuleSearchResultInterface}
     */
    salesRuleRuleRepositoryV1GetListGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SalesRuleDataRuleSearchResultInterface;
