...
export default class TransactionsApi {
    ...
    */
     ...
     * @callback module:api/TransactionsApi~salesTransactionRepositoryV1GetListGetCallback
     ...
     * @param {module:api/TransactionsApi~salesTransactionRepositoryV1GetListGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SalesDataTransactionSearchResultInterface}
     */
    salesTransactionRepositoryV1GetListGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = SalesDataTransactionSearchResultInterface;
