...
class CatalogDataCategoryAttributeInterface {
    ...
    constructor(attributeCode, entityTypeId, frontendInput, frontendLabels, isRequired) { 
        ...
        CatalogDataCategoryAttributeInterface.initialize(this, attributeCode, entityTypeId, frontendInput, frontendLabels, isRequired);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CatalogDataCategoryAttributeInterface();
    ...
    /**
     * Validates the JSON data with respect to <code>CatalogDataCategoryAttributeInterface</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CatalogDataCategoryAttributeInterface</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CatalogDataCategoryAttributeInterface.RequiredProperties) {
...
CatalogDataCategoryAttributeInterface.RequiredProperties = ["attribute_code", "entity_type_id", "frontend_input", "frontend_labels", "is_required"];

/**
 * Apply to value for the element
 * @member {Array.<String>} apply_to
 */
CatalogDataCategoryAttributeInterface.prototype['apply_to'] = undefined;

/**
 * Code of the attribute.
 * @member {String} attribute_code
 */
CatalogDataCategoryAttributeInterface.prototype['attribute_code'] = undefined;

/**
 * Id of the attribute.
 * @member {Number} attribute_id
 */
CatalogDataCategoryAttributeInterface.prototype['attribute_id'] = undefined;

/**
 * Backend model
 * @member {String} backend_model
 */
CatalogDataCategoryAttributeInterface.prototype['backend_model'] = undefined;

/**
 * Backend type.
 * @member {String} backend_type
 */
CatalogDataCategoryAttributeInterface.prototype['backend_type'] = undefined;

/**
 * Custom attributes values.
 * @member {Array.<module:model/FrameworkAttributeInterface>} custom_attributes
 */
CatalogDataCategoryAttributeInterface.prototype['custom_attributes'] = undefined;

/**
 * Frontend label for default store
 * @member {String} default_frontend_label
 */
CatalogDataCategoryAttributeInterface.prototype['default_frontend_label'] = undefined;

/**
 * Default value for the element.
 * @member {String} default_value
 */
CatalogDataCategoryAttributeInterface.prototype['default_value'] = undefined;

/**
 * Entity type id
 * @member {String} entity_type_id
 */
CatalogDataCategoryAttributeInterface.prototype['entity_type_id'] = undefined;

/**
 * ExtensionInterface class for @see \\Magento\\Catalog\\Api\\Data\\EavAttributeInterface
 * @member {Object} extension_attributes
 */
CatalogDataCategoryAttributeInterface.prototype['extension_attributes'] = undefined;

/**
 * Frontend class of attribute
 * @member {String} frontend_class
 */
CatalogDataCategoryAttributeInterface.prototype['frontend_class'] = undefined;

/**
 * HTML for input element.
 * @member {String} frontend_input
 */
CatalogDataCategoryAttributeInterface.prototype['frontend_input'] = undefined;

/**
 * Frontend label for each store
 * @member {Array.<module:model/EavDataAttributeFrontendLabelInterface>} frontend_labels
 */
CatalogDataCategoryAttributeInterface.prototype['frontend_labels'] = undefined;

/**
 * The attribute can be compared on the frontend
 * @member {String} is_comparable
 */
CatalogDataCategoryAttributeInterface.prototype['is_comparable'] = undefined;

/**
 * It used in layered navigation
 * @member {Boolean} is_filterable
 */
CatalogDataCategoryAttributeInterface.prototype['is_filterable'] = undefined;

/**
 * It is filterable in catalog product grid
 * @member {Boolean} is_filterable_in_grid
 */
CatalogDataCategoryAttributeInterface.prototype['is_filterable_in_grid'] = undefined;

/**
 * It is used in search results layered navigation
 * @member {Boolean} is_filterable_in_search
 */
CatalogDataCategoryAttributeInterface.prototype['is_filterable_in_search'] = undefined;

/**
 * The HTML tags are allowed on the frontend
 * @member {Boolean} is_html_allowed_on_front
 */
CatalogDataCategoryAttributeInterface.prototype['is_html_allowed_on_front'] = undefined;

/**
 * Attribute is required.
 * @member {Boolean} is_required
 */
CatalogDataCategoryAttributeInterface.prototype['is_required'] = undefined;

/**
 * The attribute can be used in Quick Search
 * @member {String} is_searchable
 */
CatalogDataCategoryAttributeInterface.prototype['is_searchable'] = undefined;

/**
 * This is a unique attribute
 * @member {String} is_unique
 */
CatalogDataCategoryAttributeInterface.prototype['is_unique'] = undefined;

/**
 * The attribute can be used for promo rules
 * @member {String} is_used_for_promo_rules
 */
CatalogDataCategoryAttributeInterface.prototype['is_used_for_promo_rules'] = undefined;

/**
 * It is used in catalog product grid
 * @member {Boolean} is_used_in_grid
 */
CatalogDataCategoryAttributeInterface.prototype['is_used_in_grid'] = undefined;

/**
 * Current attribute has been defined by a user.
 * @member {Boolean} is_user_defined
 */
CatalogDataCategoryAttributeInterface.prototype['is_user_defined'] = undefined;

/**
 * Attribute is visible on frontend.
 * @member {Boolean} is_visible
 */
CatalogDataCategoryAttributeInterface.prototype['is_visible'] = undefined;

/**
 * The attribute can be used in Advanced Search
 * @member {String} is_visible_in_advanced_search
 */
CatalogDataCategoryAttributeInterface.prototype['is_visible_in_advanced_search'] = undefined;

/**
 * It is visible in catalog product grid
 * @member {Boolean} is_visible_in_grid
 */
CatalogDataCategoryAttributeInterface.prototype['is_visible_in_grid'] = undefined;

/**
 * The attribute is visible on the frontend
 * @member {String} is_visible_on_front
 */
CatalogDataCategoryAttributeInterface.prototype['is_visible_on_front'] = undefined;

/**
 * WYSIWYG flag
 * @member {Boolean} is_wysiwyg_enabled
 */
CatalogDataCategoryAttributeInterface.prototype['is_wysiwyg_enabled'] = undefined;

/**
 * The note attribute for the element.
 * @member {String} note
 */
CatalogDataCategoryAttributeInterface.prototype['note'] = undefined;

/**
 * Options of the attribute (key => value pairs for select)
 * @member {Array.<module:model/EavDataAttributeOptionInterface>} options
 */
CatalogDataCategoryAttributeInterface.prototype['options'] = undefined;

/**
 * Position
 * @member {Number} position
 */
CatalogDataCategoryAttributeInterface.prototype['position'] = undefined;

/**
 * Attribute scope
 * @member {String} scope
 */
CatalogDataCategoryAttributeInterface.prototype['scope'] = undefined;

/**
 * Source model
 * @member {String} source_model
 */
CatalogDataCategoryAttributeInterface.prototype['source_model'] = undefined;

/**
 * It is used for sorting in product listing
 * @member {Boolean} used_for_sort_by
 */
CatalogDataCategoryAttributeInterface.prototype['used_for_sort_by'] = undefined;

/**
 * The attribute can be used in product listing
 * @member {String} used_in_product_listing
 */
CatalogDataCategoryAttributeInterface.prototype['used_in_product_listing'] = undefined;

/**
 * Validation rules.
 * @member {Array.<module:model/EavDataAttributeValidationRuleInterface>} validation_rules
 */
CatalogDataCategoryAttributeInterface.prototype['validation_rules'] = undefined;
...
export default CatalogDataCategoryAttributeInterface;
