...
class CatalogDataProductOptionExtensionInterface {
    ...
    constructor() { 
        ...
        CatalogDataProductOptionExtensionInterface.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CatalogDataProductOptionExtensionInterface();
    ...
    /**
     * Validates the JSON data with respect to <code>CatalogDataProductOptionExtensionInterface</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CatalogDataProductOptionExtensionInterface</code>.
     */
 ...
 */
CatalogDataProductOptionExtensionInterface.prototype['bundle_options'] = undefined;

/**
 * @member {Array.<module:model/ConfigurableProductDataConfigurableItemOptionValueInterface>} configurable_item_options
 */
CatalogDataProductOptionExtensionInterface.prototype['configurable_item_options'] = undefined;

/**
 * @member {Array.<module:model/CatalogDataCustomOptionInterface>} custom_options
 */
CatalogDataProductOptionExtensionInterface.prototype['custom_options'] = undefined;

/**
 * @member {module:model/DownloadableDataDownloadableOptionInterface} downloadable_option
 */
CatalogDataProductOptionExtensionInterface.prototype['downloadable_option'] = undefined;

/**
 * @member {module:model/GiftCardDataGiftCardOptionInterface} giftcard_item_option
 */
CatalogDataProductOptionExtensionInterface.prototype['giftcard_item_option'] = undefined;
...
export default CatalogDataProductOptionExtensionInterface;
