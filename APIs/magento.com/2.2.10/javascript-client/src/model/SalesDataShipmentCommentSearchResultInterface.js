...
class SalesDataShipmentCommentSearchResultInterface {
    ...
    constructor(items, searchCriteria, totalCount) { 
        ...
        SalesDataShipmentCommentSearchResultInterface.initialize(this, items, searchCriteria, totalCount);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SalesDataShipmentCommentSearchResultInterface();
    ...
    /**
     * Validates the JSON data with respect to <code>SalesDataShipmentCommentSearchResultInterface</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SalesDataShipmentCommentSearchResultInterface</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SalesDataShipmentCommentSearchResultInterface.RequiredProperties) {
...
SalesDataShipmentCommentSearchResultInterface.RequiredProperties = ["items", "search_criteria", "total_count"];

/**
 * Array of collection items.
 * @member {Array.<module:model/SalesDataShipmentCommentInterface>} items
 */
SalesDataShipmentCommentSearchResultInterface.prototype['items'] = undefined;

/**
 * @member {module:model/FrameworkSearchCriteriaInterface} search_criteria
 */
SalesDataShipmentCommentSearchResultInterface.prototype['search_criteria'] = undefined;

/**
 * Total count.
 * @member {Number} total_count
 */
SalesDataShipmentCommentSearchResultInterface.prototype['total_count'] = undefined;
...
export default SalesDataShipmentCommentSearchResultInterface;
