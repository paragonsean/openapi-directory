...
class CatalogDataProductSearchResultsInterface {
    ...
    constructor(items, searchCriteria, totalCount) { 
        ...
        CatalogDataProductSearchResultsInterface.initialize(this, items, searchCriteria, totalCount);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CatalogDataProductSearchResultsInterface();
    ...
    /**
     * Validates the JSON data with respect to <code>CatalogDataProductSearchResultsInterface</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CatalogDataProductSearchResultsInterface</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CatalogDataProductSearchResultsInterface.RequiredProperties) {
...
CatalogDataProductSearchResultsInterface.RequiredProperties = ["items", "search_criteria", "total_count"];

/**
 * Attributes list.
 * @member {Array.<module:model/CatalogDataProductInterface>} items
 */
CatalogDataProductSearchResultsInterface.prototype['items'] = undefined;

/**
 * @member {module:model/FrameworkSearchCriteriaInterface} search_criteria
 */
CatalogDataProductSearchResultsInterface.prototype['search_criteria'] = undefined;

/**
 * Total count.
 * @member {Number} total_count
 */
CatalogDataProductSearchResultsInterface.prototype['total_count'] = undefined;
...
export default CatalogDataProductSearchResultsInterface;
