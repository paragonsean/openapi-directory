...
class FrameworkCriteriaInterface {
    ...
    constructor(criteriaList, filters, limit, mapperInterfaceName, orders) { 
        ...
        FrameworkCriteriaInterface.initialize(this, criteriaList, filters, limit, mapperInterfaceName, orders);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FrameworkCriteriaInterface();
    ...
    /**
     * Validates the JSON data with respect to <code>FrameworkCriteriaInterface</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FrameworkCriteriaInterface</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FrameworkCriteriaInterface.RequiredProperties) {
...
FrameworkCriteriaInterface.RequiredProperties = ["criteria_list", "filters", "limit", "mapper_interface_name", "orders"];

/**
 * Criteria objects added to current Composite Criteria
 * @member {Array.<module:model/FrameworkCriteriaInterface>} criteria_list
 */
FrameworkCriteriaInterface.prototype['criteria_list'] = undefined;

/**
 * List of filters
 * @member {Array.<String>} filters
 */
FrameworkCriteriaInterface.prototype['filters'] = undefined;

/**
 * Limit
 * @member {Array.<String>} limit
 */
FrameworkCriteriaInterface.prototype['limit'] = undefined;

/**
 * Associated Mapper Interface name
 * @member {String} mapper_interface_name
 */
FrameworkCriteriaInterface.prototype['mapper_interface_name'] = undefined;

/**
 * Ordering criteria
 * @member {Array.<String>} orders
 */
FrameworkCriteriaInterface.prototype['orders'] = undefined;
...
export default FrameworkCriteriaInterface;
