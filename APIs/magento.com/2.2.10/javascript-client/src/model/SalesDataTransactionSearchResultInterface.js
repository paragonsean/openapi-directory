...
import SalesDataTransactionInterface from './SalesDataTransactionInterface';
...
class SalesDataTransactionSearchResultInterface {
    ...
    constructor(items, searchCriteria, totalCount) { 
        ...
        SalesDataTransactionSearchResultInterface.initialize(this, items, searchCriteria, totalCount);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SalesDataTransactionSearchResultInterface();
    ...
    /**
     * Validates the JSON data with respect to <code>SalesDataTransactionSearchResultInterface</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SalesDataTransactionSearchResultInterface</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SalesDataTransactionSearchResultInterface.RequiredProperties) {
...
SalesDataTransactionSearchResultInterface.RequiredProperties = ["items", "search_criteria", "total_count"];

/**
 * Array of collection items.
 * @member {Array.<module:model/SalesDataTransactionInterface>} items
 */
SalesDataTransactionSearchResultInterface.prototype['items'] = undefined;

/**
 * @member {module:model/FrameworkSearchCriteriaInterface} search_criteria
 */
SalesDataTransactionSearchResultInterface.prototype['search_criteria'] = undefined;

/**
 * Total count.
 * @member {Number} total_count
 */
SalesDataTransactionSearchResultInterface.prototype['total_count'] = undefined;
...
export default SalesDataTransactionSearchResultInterface;
