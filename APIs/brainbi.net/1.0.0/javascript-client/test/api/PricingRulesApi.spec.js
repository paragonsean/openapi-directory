...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brainbi.PricingRulesApi();
  });
  ...
  describe('PricingRulesApi', function() {
    describe('ruleData', function() {
      it('should call ruleData successfully', function(done) {
        //uncomment below and update the code to test ruleData
        //instance.ruleData(function(error) {
    ...
    describe('ruleDataLatest', function() {
      it('should call ruleDataLatest successfully', function(done) {
        //uncomment below and update the code to test ruleDataLatest
        //instance.ruleDataLatest(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
