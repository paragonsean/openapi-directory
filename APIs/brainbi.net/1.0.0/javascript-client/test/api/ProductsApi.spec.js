...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brainbi.ProductsApi();
  });
  ...
  describe('ProductsApi', function() {
    describe('betaScrapeProductCopy', function() {
      it('should call betaScrapeProductCopy successfully', function(done) {
        //uncomment below and update the code to test betaScrapeProductCopy
        //instance.betaScrapeProductCopy(function(error) {
    ...
    describe('products', function() {
      it('should call products successfully', function(done) {
        //uncomment below and update the code to test products
        //instance.products(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('products1', function() {
      it('should call products1 successfully', function(done) {
        //uncomment below and update the code to test products1
        //instance.products1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
