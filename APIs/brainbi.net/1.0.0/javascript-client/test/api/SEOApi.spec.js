...
(function(root, factory) {
  ...
  describe('SEOApi', function() {
    describe('seoLatestRankings', function() {
      it('should call seoLatestRankings successfully', function(done) {
        //uncomment below and update the code to test seoLatestRankings
        //instance.seoLatestRankings(function(error) {
