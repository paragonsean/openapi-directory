...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brainbi.OrdersApi();
  });
  ...
  describe('OrdersApi', function() {
    ...
    describe('orders1', function() {
      it('should call orders1 successfully', function(done) {
        //uncomment below and update the code to test orders1
        //instance.orders1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
