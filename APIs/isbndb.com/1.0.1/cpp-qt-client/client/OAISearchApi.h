...
public:
    ...
    */
    virtual void searchGet(const ::OpenAPI::OptionalParam<QString> &q = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void searchGetSignal();


    void searchGetSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use searchGetSignalError() instead")
    void searchGetSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void searchGetSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
