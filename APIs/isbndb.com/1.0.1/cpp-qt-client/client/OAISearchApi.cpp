...
void OAISearchApi::searchGet(const ::OpenAPI::OptionalParam<QString> &q) {
...
void OAISearchApi::searchGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchGetSignal();
        Q_EMIT searchGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchGetSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchGetSignalError(error_type, error_str);
