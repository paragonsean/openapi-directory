...
/**
 * The AdminRecordingsStartPostRequestAllOfFilters model module.
 * @module model/AdminRecordingsStartPostRequestAllOfFilters
 * @version 2.35.0
 */
class AdminRecordingsStartPostRequestAllOfFilters {
    /**
     * Constructs a new <code>AdminRecordingsStartPostRequestAllOfFilters</code>.
     * @alias module:model/AdminRecordingsStartPostRequestAllOfFilters
     */
    constructor() { 
        
        AdminRecordingsStartPostRequestAllOfFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminRecordingsStartPostRequestAllOfFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminRecordingsStartPostRequestAllOfFilters} obj Optional instance to populate.
     * @return {module:model/AdminRecordingsStartPostRequestAllOfFilters} The populated <code>AdminRecordingsStartPostRequestAllOfFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminRecordingsStartPostRequestAllOfFilters();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminRecordingsStartPostRequestAllOfFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminRecordingsStartPostRequestAllOfFilters</code>.
     */
 ...
 */
AdminRecordingsStartPostRequestAllOfFilters.prototype['basicAuthCredentials'] = undefined;

/**
 * Request body patterns to match against in the <key>: { \"<predicate>\": \"<value>\" } form
 * @member {Array.<Object>} bodyPatterns
 */
AdminRecordingsStartPostRequestAllOfFilters.prototype['bodyPatterns'] = undefined;

/**
 * Cookie patterns to match against in the <key>: { \"<predicate>\": \"<value>\" } form
 * @member {Object} cookies
 */
AdminRecordingsStartPostRequestAllOfFilters.prototype['cookies'] = undefined;

/**
 * Header patterns to match against in the <key>: { \"<predicate>\": \"<value>\" } form
 * @member {Object} headers
 */
AdminRecordingsStartPostRequestAllOfFilters.prototype['headers'] = undefined;

/**
 * The HTTP request method e.g. GET
 * @member {String} method
 */
AdminRecordingsStartPostRequestAllOfFilters.prototype['method'] = undefined;

/**
 * Query parameter patterns to match against in the <key>: { \"<predicate>\": \"<value>\" } form
 * @member {Object} queryParameters
 */
AdminRecordingsStartPostRequestAllOfFilters.prototype['queryParameters'] = undefined;

/**
 * The path and query to match exactly against. Only one of url, urlPattern, urlPath or urlPathPattern may be specified.
 * @member {String} url
 */
AdminRecordingsStartPostRequestAllOfFilters.prototype['url'] = undefined;
 ...
 */
AdminRecordingsStartPostRequestAllOfFilters.prototype['urlPath'] = undefined;
 ...
 */
AdminRecordingsStartPostRequestAllOfFilters.prototype['urlPathPattern'] = undefined;
 ...
 */
AdminRecordingsStartPostRequestAllOfFilters.prototype['urlPattern'] = undefined;
...
export default AdminRecordingsStartPostRequestAllOfFilters;
