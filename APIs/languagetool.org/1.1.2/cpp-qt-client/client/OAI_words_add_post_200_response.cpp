...
OAI_words_add_post_200_response::OAI_words_add_post_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_words_add_post_200_response::OAI_words_add_post_200_response() {
    this->initializeModel();
}

OAI_words_add_post_200_response::~OAI_words_add_post_200_response() {}

void OAI_words_add_post_200_response::initializeModel() {

    m_added_isSet = false;
    m_added_isValid = false;
}

void OAI_words_add_post_200_response::fromJson(QString jsonString) {
...
void OAI_words_add_post_200_response::fromJsonObject(QJsonObject json) {

    m_added_isValid = ::OpenAPI::fromJsonValue(m_added, json[QString("added")]);
    m_added_isSet = !json[QString("added")].isNull() && m_added_isValid;
}

QString OAI_words_add_post_200_response::asJson() const {
...
QJsonObject OAI_words_add_post_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_added_isSet) {
...
bool OAI_words_add_post_200_response::isAdded() const {
    return m_added;
}
void OAI_words_add_post_200_response::setAdded(const bool &added) {
    m_added = added;
    m_added_isSet = true;
}

bool OAI_words_add_post_200_response::is_added_Set() const{
    return m_added_isSet;
}

bool OAI_words_add_post_200_response::is_added_Valid() const{
    return m_added_isValid;
}

bool OAI_words_add_post_200_response::isSet() const {
...
bool OAI_words_add_post_200_response::isValid() const {
