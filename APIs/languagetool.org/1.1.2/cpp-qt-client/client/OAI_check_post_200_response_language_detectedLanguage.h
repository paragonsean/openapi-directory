...
/*
 * OAI_check_post_200_response_language_detectedLanguage.h
 *
 * The automatically detected text language (might be different from the language actually used for checking).
 */

#ifndef OAI_check_post_200_response_language_detectedLanguage_H
#define OAI_check_post_200_response_language_detectedLanguage_H
...
class OAI_check_post_200_response_language_detectedLanguage : public OAIObject {
public:
    OAI_check_post_200_response_language_detectedLanguage();
    OAI_check_post_200_response_language_detectedLanguage(QString json);
    ~OAI_check_post_200_response_language_detectedLanguage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_check_post_200_response_language_detectedLanguage)

#endif // OAI_check_post_200_response_language_detectedLanguage_H
