...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LanguageToolApi.CheckPost200ResponseLanguage();
  });
  ...
  describe('CheckPost200ResponseLanguage', function() {
    it('should create an instance of CheckPost200ResponseLanguage', function() {
      // uncomment below and update the code to test CheckPost200ResponseLanguage
      //var instance = new LanguageToolApi.CheckPost200ResponseLanguage();
      //expect(instance).to.be.a(LanguageToolApi.CheckPost200ResponseLanguage);
    });
