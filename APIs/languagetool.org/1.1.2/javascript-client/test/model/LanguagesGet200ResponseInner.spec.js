...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LanguageToolApi.LanguagesGet200ResponseInner();
  });
  ...
  describe('LanguagesGet200ResponseInner', function() {
    it('should create an instance of LanguagesGet200ResponseInner', function() {
      // uncomment below and update the code to test LanguagesGet200ResponseInner
      //var instance = new LanguageToolApi.LanguagesGet200ResponseInner();
      //expect(instance).to.be.a(LanguageToolApi.LanguagesGet200ResponseInner);
    });
    ...
    it('should have the property longCode (base name: "longCode")', function() {
      // uncomment below and update the code to test the property longCode
      //var instance = new LanguageToolApi.LanguagesGet200ResponseInner();
      //expect(instance).to.be();
    });
