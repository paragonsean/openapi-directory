...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LanguageToolApi.CheckPost200ResponseSoftware();
  });
  ...
  describe('CheckPost200ResponseSoftware', function() {
    it('should create an instance of CheckPost200ResponseSoftware', function() {
      // uncomment below and update the code to test CheckPost200ResponseSoftware
      //var instance = new LanguageToolApi.CheckPost200ResponseSoftware();
      //expect(instance).to.be.a(LanguageToolApi.CheckPost200ResponseSoftware);
    });
