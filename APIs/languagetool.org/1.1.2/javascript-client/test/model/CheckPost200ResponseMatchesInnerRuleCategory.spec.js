...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LanguageToolApi.CheckPost200ResponseMatchesInnerRuleCategory();
  });
  ...
  describe('CheckPost200ResponseMatchesInnerRuleCategory', function() {
    it('should create an instance of CheckPost200ResponseMatchesInnerRuleCategory', function() {
      // uncomment below and update the code to test CheckPost200ResponseMatchesInnerRuleCategory
      //var instance = new LanguageToolApi.CheckPost200ResponseMatchesInnerRuleCategory();
      //expect(instance).to.be.a(LanguageToolApi.CheckPost200ResponseMatchesInnerRuleCategory);
    });
