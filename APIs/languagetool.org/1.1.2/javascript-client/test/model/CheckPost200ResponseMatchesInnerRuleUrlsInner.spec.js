...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LanguageToolApi.CheckPost200ResponseMatchesInnerRuleUrlsInner();
  });
  ...
  describe('CheckPost200ResponseMatchesInnerRuleUrlsInner', function() {
    it('should create an instance of CheckPost200ResponseMatchesInnerRuleUrlsInner', function() {
      // uncomment below and update the code to test CheckPost200ResponseMatchesInnerRuleUrlsInner
      //var instance = new LanguageToolApi.CheckPost200ResponseMatchesInnerRuleUrlsInner();
      //expect(instance).to.be.a(LanguageToolApi.CheckPost200ResponseMatchesInnerRuleUrlsInner);
    });
