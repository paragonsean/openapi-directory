...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LanguageToolApi.CheckPost200ResponseMatchesInnerReplacementsInner();
  });
  ...
  describe('CheckPost200ResponseMatchesInnerReplacementsInner', function() {
    it('should create an instance of CheckPost200ResponseMatchesInnerReplacementsInner', function() {
      // uncomment below and update the code to test CheckPost200ResponseMatchesInnerReplacementsInner
      //var instance = new LanguageToolApi.CheckPost200ResponseMatchesInnerReplacementsInner();
      //expect(instance).to.be.a(LanguageToolApi.CheckPost200ResponseMatchesInnerReplacementsInner);
    });
