...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LanguageToolApi.CheckPost200ResponseMatchesInnerRule();
  });
  ...
  describe('CheckPost200ResponseMatchesInnerRule', function() {
    it('should create an instance of CheckPost200ResponseMatchesInnerRule', function() {
      // uncomment below and update the code to test CheckPost200ResponseMatchesInnerRule
      //var instance = new LanguageToolApi.CheckPost200ResponseMatchesInnerRule();
      //expect(instance).to.be.a(LanguageToolApi.CheckPost200ResponseMatchesInnerRule);
    });
