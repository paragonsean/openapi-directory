...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LanguageToolApi.CheckPost200ResponseLanguageDetectedLanguage();
  });
  ...
  describe('CheckPost200ResponseLanguageDetectedLanguage', function() {
    it('should create an instance of CheckPost200ResponseLanguageDetectedLanguage', function() {
      // uncomment below and update the code to test CheckPost200ResponseLanguageDetectedLanguage
      //var instance = new LanguageToolApi.CheckPost200ResponseLanguageDetectedLanguage();
      //expect(instance).to.be.a(LanguageToolApi.CheckPost200ResponseLanguageDetectedLanguage);
    });
