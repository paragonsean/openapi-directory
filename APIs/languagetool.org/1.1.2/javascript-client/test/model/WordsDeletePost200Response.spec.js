...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LanguageToolApi.WordsDeletePost200Response();
  });
  ...
  describe('WordsDeletePost200Response', function() {
    it('should create an instance of WordsDeletePost200Response', function() {
      // uncomment below and update the code to test WordsDeletePost200Response
      //var instance = new LanguageToolApi.WordsDeletePost200Response();
      //expect(instance).to.be.a(LanguageToolApi.WordsDeletePost200Response);
    });
