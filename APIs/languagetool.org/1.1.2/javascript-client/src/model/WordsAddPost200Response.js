...
/**
 * The WordsAddPost200Response model module.
 * @module model/WordsAddPost200Response
 * @version 1.1.2
 */
class WordsAddPost200Response {
    /**
     * Constructs a new <code>WordsAddPost200Response</code>.
     * @alias module:model/WordsAddPost200Response
     */
    constructor() { 
        
        WordsAddPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WordsAddPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WordsAddPost200Response} obj Optional instance to populate.
     * @return {module:model/WordsAddPost200Response} The populated <code>WordsAddPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WordsAddPost200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>WordsAddPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WordsAddPost200Response</code>.
     */
 ...
 */
WordsAddPost200Response.prototype['added'] = undefined;
...
export default WordsAddPost200Response;
