...
class Rating {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ratingScale')) {
                obj['ratingScale'] = ApiClient.convertToType(data['ratingScale'], 'Number');
            }
 ...
 * @member {Number} ratingScale
 */
Rating.prototype['ratingScale'] = undefined;

/**
 * The rating score. (e.g. 8.5)
 * @member {Number} score
 */
Rating.prototype['score'] = undefined;

/**
 * The type of the rating.
 * @member {module:model/Rating.TypeEnum} type
 */
Rating.prototype['type'] = undefined;
