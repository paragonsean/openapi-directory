...
#ifndef OAITransferEntry_H
#define OAITransferEntry_H
...
class OAITransferEntry : public OAIObject {
public:
    OAITransferEntry();
    OAITransferEntry(QString json);
    ~OAITransferEntry() override;
    ...
    QString getCommentOnFrom() const;
    void setCommentOnFrom(const QString &comment_on_from);
    bool is_comment_on_from_Set() const;
    bool is_comment_on_from_Valid() const;

    QString getCommentOnTo() const;
    void setCommentOnTo(const QString &comment_on_to);
    bool is_comment_on_to_Set() const;
    bool is_comment_on_to_Valid() const;
    ...
    double getToUserId() const;
    void setToUserId(const double &to_user_id);
    bool is_to_user_id_Set() const;
    bool is_to_user_id_Valid() const;

    QString getToUsername() const;
    void setToUsername(const QString &to_username);
    bool is_to_username_Set() const;
    bool is_to_username_Valid() const;
...
private:
    ...
    QString m_comment_on_from;
    bool m_comment_on_from_isSet;
    bool m_comment_on_from_isValid;

    QString m_comment_on_to;
    bool m_comment_on_to_isSet;
    bool m_comment_on_to_isValid;
    ...
    double m_to_user_id;
    bool m_to_user_id_isSet;
    bool m_to_user_id_isValid;

    QString m_to_username;
    bool m_to_username_isSet;
    bool m_to_username_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITransferEntry)

#endif // OAITransferEntry_H
