...
#ifndef OAIPreSignRequest_H
#define OAIPreSignRequest_H
...
class OAIPreSignRequest : public OAIObject {
public:
    OAIPreSignRequest();
    OAIPreSignRequest(QString json);
    ~OAIPreSignRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPreSignRequest)

#endif // OAIPreSignRequest_H
