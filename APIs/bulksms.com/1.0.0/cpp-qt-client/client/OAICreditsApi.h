...
public:
    ...
    /**
    * @param[in]  oai_transfer_entry OAITransferEntry [required]
    */
    virtual void creditTransferPost(const OAITransferEntry &oai_transfer_entry);
...
private:
    ...
    void creditTransferPostCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void creditTransferPostSignal();


    void creditTransferPostSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use creditTransferPostSignalError() instead")
    void creditTransferPostSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void creditTransferPostSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use creditTransferPostSignalErrorFull() instead")
    void creditTransferPostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void creditTransferPostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
