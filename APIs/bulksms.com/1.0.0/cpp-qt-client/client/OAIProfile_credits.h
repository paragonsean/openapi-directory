...
/*
 * OAIProfile_credits.h
 *
 * 
 */

#ifndef OAIProfile_credits_H
#define OAIProfile_credits_H
...
class OAIProfile_credits : public OAIObject {
public:
    OAIProfile_credits();
    OAIProfile_credits(QString json);
    ~OAIProfile_credits() override;
    ...
    bool isIsTransferAllowed() const;
    void setIsTransferAllowed(const bool &is_transfer_allowed);
    bool is_is_transfer_allowed_Set() const;
    bool is_is_transfer_allowed_Valid() const;
...
private:
    ...
    bool m_is_transfer_allowed;
    bool m_is_transfer_allowed_isSet;
    bool m_is_transfer_allowed_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProfile_credits)

#endif // OAIProfile_credits_H
