...
OAIPreSignInfo::OAIPreSignInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPreSignInfo::OAIPreSignInfo() {
    this->initializeModel();
}

OAIPreSignInfo::~OAIPreSignInfo() {}

void OAIPreSignInfo::initializeModel() {
    ...
    m_put_url_isSet = false;
    m_put_url_isValid = false;
}

void OAIPreSignInfo::fromJson(QString jsonString) {
...
void OAIPreSignInfo::fromJsonObject(QJsonObject json) {
    ...
    m_put_url_isValid = ::OpenAPI::fromJsonValue(m_put_url, json[QString("putUrl")]);
    m_put_url_isSet = !json[QString("putUrl")].isNull() && m_put_url_isValid;
}

QString OAIPreSignInfo::asJson() const {
...
QJsonObject OAIPreSignInfo::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_put_url_isSet) {
        obj.insert(QString("putUrl"), ::OpenAPI::toJsonValue(m_put_url));
    }
    return obj;
}

QString OAIPreSignInfo::getFetchUrl() const {
    return m_fetch_url;
}
void OAIPreSignInfo::setFetchUrl(const QString &fetch_url) {
    m_fetch_url = fetch_url;
    m_fetch_url_isSet = true;
}

bool OAIPreSignInfo::is_fetch_url_Set() const{
    return m_fetch_url_isSet;
}

bool OAIPreSignInfo::is_fetch_url_Valid() const{
    return m_fetch_url_isValid;
}

QList<OAIPreSignInfo_fields_inner> OAIPreSignInfo::getFields() const {
    return m_fields;
}
void OAIPreSignInfo::setFields(const QList<OAIPreSignInfo_fields_inner> &fields) {
    m_fields = fields;
    m_fields_isSet = true;
}

bool OAIPreSignInfo::is_fields_Set() const{
    return m_fields_isSet;
}

bool OAIPreSignInfo::is_fields_Valid() const{
    return m_fields_isValid;
}

QString OAIPreSignInfo::getPutUrl() const {
    return m_put_url;
}
void OAIPreSignInfo::setPutUrl(const QString &put_url) {
    m_put_url = put_url;
    m_put_url_isSet = true;
}

bool OAIPreSignInfo::is_put_url_Set() const{
    return m_put_url_isSet;
}

bool OAIPreSignInfo::is_put_url_Valid() const{
    return m_put_url_isValid;
}

bool OAIPreSignInfo::isSet() const {
...
bool OAIPreSignInfo::isValid() const {
