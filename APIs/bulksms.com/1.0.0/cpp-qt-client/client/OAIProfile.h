...
#include "OAIProfile_commerce.h"
#include "OAIProfile_company.h"
#include "OAIProfile_credits.h"
#include "OAIProfile_originAddresses.h"
#include "OAIProfile_quota.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAIProfile_commerce;
class OAIProfile_company;
class OAIProfile_credits;
class OAIProfile_originAddresses;
class OAIProfile_quota;
...
public:
    ...
    OAIProfile_commerce getCommerce() const;
    void setCommerce(const OAIProfile_commerce &commerce);
    bool is_commerce_Set() const;
    bool is_commerce_Valid() const;

    OAIProfile_company getCompany() const;
    void setCompany(const OAIProfile_company &company);
    ...
    OAIProfile_credits getCredits() const;
    void setCredits(const OAIProfile_credits &credits);
    ...
    OAIProfile_originAddresses getOriginAddresses() const;
    void setOriginAddresses(const OAIProfile_originAddresses &origin_addresses);
    bool is_origin_addresses_Set() const;
    bool is_origin_addresses_Valid() const;

    OAIProfile_quota getQuota() const;
    void setQuota(const OAIProfile_quota &quota);
...
private:
    ...
    OAIProfile_commerce m_commerce;
    bool m_commerce_isSet;
    bool m_commerce_isValid;

    OAIProfile_company m_company;
    ...
    OAIProfile_originAddresses m_origin_addresses;
    bool m_origin_addresses_isSet;
    bool m_origin_addresses_isValid;

    OAIProfile_quota m_quota;
    bool m_quota_isSet;
