...
OAIProfile_company::OAIProfile_company(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProfile_company::OAIProfile_company() {
    this->initializeModel();
}

OAIProfile_company::~OAIProfile_company() {}

void OAIProfile_company::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;

    m_tax_reference_isSet = false;
    m_tax_reference_isValid = false;
}

void OAIProfile_company::fromJson(QString jsonString) {
...
void OAIProfile_company::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;

    m_tax_reference_isValid = ::OpenAPI::fromJsonValue(m_tax_reference, json[QString("taxReference")]);
    m_tax_reference_isSet = !json[QString("taxReference")].isNull() && m_tax_reference_isValid;
}

QString OAIProfile_company::asJson() const {
...
QJsonObject OAIProfile_company::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
        obj.insert(QString("name"), ::OpenAPI::toJsonValue(m_name));
    }
    if (m_tax_reference_isSet) {
        obj.insert(QString("taxReference"), ::OpenAPI::toJsonValue(m_tax_reference));
    }
    return obj;
}

QString OAIProfile_company::getName() const {
    return m_name;
}
void OAIProfile_company::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProfile_company::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProfile_company::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIProfile_company::getTaxReference() const {
    return m_tax_reference;
}
void OAIProfile_company::setTaxReference(const QString &tax_reference) {
    m_tax_reference = tax_reference;
    m_tax_reference_isSet = true;
}

bool OAIProfile_company::is_tax_reference_Set() const{
    return m_tax_reference_isSet;
}

bool OAIProfile_company::is_tax_reference_Valid() const{
    return m_tax_reference_isValid;
}

bool OAIProfile_company::isSet() const {
...
bool OAIProfile_company::isValid() const {
