...
#ifndef OAI_OAIBlockedNumbersApi_H
#define OAI_OAIBlockedNumbersApi_H
...
class OAIBlockedNumbersApi : public QObject {
    Q_OBJECT

public:
    OAIBlockedNumbersApi(const int timeOut = 0);
    ~OAIBlockedNumbersApi();
    ...
    /**
    * @param[in]  min_id qint32 [optional]
    * @param[in]  limit qint32 [optional]
    */
    virtual void blockedNumbersGet(const ::OpenAPI::OptionalParam<qint32> &min_id = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  request_body QList<QString> [required]
    */
    virtual void blockedNumbersPost(const QList<QString> &request_body);
...
private:
    ...
    void blockedNumbersGetCallback(OAIHttpRequestWorker *worker);
    void blockedNumbersPostCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void blockedNumbersGetSignal(OAIBlockedNumber summary);
    void blockedNumbersPostSignal();


    void blockedNumbersGetSignalFull(OAIHttpRequestWorker *worker, OAIBlockedNumber summary);
    void blockedNumbersPostSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use blockedNumbersGetSignalError() instead")
    void blockedNumbersGetSignalE(OAIBlockedNumber summary, QNetworkReply::NetworkError error_type, QString error_str);
    void blockedNumbersGetSignalError(OAIBlockedNumber summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use blockedNumbersPostSignalError() instead")
    void blockedNumbersPostSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void blockedNumbersPostSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use blockedNumbersGetSignalErrorFull() instead")
    void blockedNumbersGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void blockedNumbersGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use blockedNumbersPostSignalErrorFull() instead")
    void blockedNumbersPostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void blockedNumbersPostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
