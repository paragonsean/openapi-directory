...
/*
 * OAIMessage_submission.h
 *
 * Identifies the submission. 
 */

#ifndef OAIMessage_submission_H
#define OAIMessage_submission_H
...
class OAIMessage_submission : public OAIObject {
public:
    OAIMessage_submission();
    OAIMessage_submission(QString json);
    ~OAIMessage_submission() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessage_submission)

#endif // OAIMessage_submission_H
