...
/*
 * OAIProfile_originAddresses.h
 *
 * 
 */

#ifndef OAIProfile_originAddresses_H
#define OAIProfile_originAddresses_H
...
class OAIProfile_originAddresses : public OAIObject {
public:
    OAIProfile_originAddresses();
    OAIProfile_originAddresses(QString json);
    ~OAIProfile_originAddresses() override;
    ...
    bool isIsFullControlAllowed() const;
    void setIsFullControlAllowed(const bool &is_full_control_allowed);
    bool is_is_full_control_allowed_Set() const;
    bool is_is_full_control_allowed_Valid() const;
...
private:
    ...
    bool m_is_full_control_allowed;
    bool m_is_full_control_allowed_isSet;
    bool m_is_full_control_allowed_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProfile_originAddresses)

#endif // OAIProfile_originAddresses_H
