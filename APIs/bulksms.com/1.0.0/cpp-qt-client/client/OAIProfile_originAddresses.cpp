...
OAIProfile_originAddresses::OAIProfile_originAddresses(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProfile_originAddresses::OAIProfile_originAddresses() {
    this->initializeModel();
}

OAIProfile_originAddresses::~OAIProfile_originAddresses() {}

void OAIProfile_originAddresses::initializeModel() {

    m_allowed_isSet = false;
    m_allowed_isValid = false;

    m_is_full_control_allowed_isSet = false;
    m_is_full_control_allowed_isValid = false;
}

void OAIProfile_originAddresses::fromJson(QString jsonString) {
...
void OAIProfile_originAddresses::fromJsonObject(QJsonObject json) {
    ...
    m_is_full_control_allowed_isValid = ::OpenAPI::fromJsonValue(m_is_full_control_allowed, json[QString("isFullControlAllowed")]);
    m_is_full_control_allowed_isSet = !json[QString("isFullControlAllowed")].isNull() && m_is_full_control_allowed_isValid;
}

QString OAIProfile_originAddresses::asJson() const {
...
QJsonObject OAIProfile_originAddresses::asJsonObject() const {
    QJsonObject obj;
    if (m_allowed.size() > 0) {
        obj.insert(QString("allowed"), ::OpenAPI::toJsonValue(m_allowed));
    }
    if (m_is_full_control_allowed_isSet) {
        obj.insert(QString("isFullControlAllowed"), ::OpenAPI::toJsonValue(m_is_full_control_allowed));
    }
    return obj;
}

QList<QString> OAIProfile_originAddresses::getAllowed() const {
    return m_allowed;
}
void OAIProfile_originAddresses::setAllowed(const QList<QString> &allowed) {
    m_allowed = allowed;
    m_allowed_isSet = true;
}

bool OAIProfile_originAddresses::is_allowed_Set() const{
    return m_allowed_isSet;
}

bool OAIProfile_originAddresses::is_allowed_Valid() const{
    return m_allowed_isValid;
}

bool OAIProfile_originAddresses::isIsFullControlAllowed() const {
    return m_is_full_control_allowed;
}
void OAIProfile_originAddresses::setIsFullControlAllowed(const bool &is_full_control_allowed) {
    m_is_full_control_allowed = is_full_control_allowed;
    m_is_full_control_allowed_isSet = true;
}

bool OAIProfile_originAddresses::is_is_full_control_allowed_Set() const{
    return m_is_full_control_allowed_isSet;
}

bool OAIProfile_originAddresses::is_is_full_control_allowed_Valid() const{
    return m_is_full_control_allowed_isValid;
}

bool OAIProfile_originAddresses::isSet() const {
...
bool OAIProfile_originAddresses::isValid() const {
