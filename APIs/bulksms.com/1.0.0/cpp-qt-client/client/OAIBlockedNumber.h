...
#ifndef OAIBlockedNumber_H
#define OAIBlockedNumber_H
...
class OAIBlockedNumber : public OAIObject {
public:
    OAIBlockedNumber();
    OAIBlockedNumber(QString json);
    ~OAIBlockedNumber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlockedNumber)

#endif // OAIBlockedNumber_H
