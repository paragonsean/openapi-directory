...
/*
 * OAISubmissionEntry_to_inner.h
 *
 * 
 */

#ifndef OAISubmissionEntry_to_inner_H
#define OAISubmissionEntry_to_inner_H
...
class OAISubmissionEntry_to_inner : public OAIObject {
public:
    OAISubmissionEntry_to_inner();
    OAISubmissionEntry_to_inner(QString json);
    ~OAISubmissionEntry_to_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubmissionEntry_to_inner)

#endif // OAISubmissionEntry_to_inner_H
