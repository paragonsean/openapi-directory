...
#ifndef OAIProfile_quota_H
#define OAIProfile_quota_H
...
class OAIProfile_quota : public OAIObject {
public:
    OAIProfile_quota();
    OAIProfile_quota(QString json);
    ~OAIProfile_quota() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProfile_quota)

#endif // OAIProfile_quota_H
