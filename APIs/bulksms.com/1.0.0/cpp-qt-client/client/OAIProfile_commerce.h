...
/*
 * OAIProfile_commerce.h
 *
 * 
 */

#ifndef OAIProfile_commerce_H
#define OAIProfile_commerce_H
...
namespace OpenAPI {
class OAIProfile_commerce_address;

class OAIProfile_commerce : public OAIObject {
public:
    OAIProfile_commerce();
    OAIProfile_commerce(QString json);
    ~OAIProfile_commerce() override;
    ...
    OAIProfile_commerce_address getAddress() const;
    void setAddress(const OAIProfile_commerce_address &address);
    bool is_address_Set() const;
    bool is_address_Valid() const;

    QString getBankPaymentReference() const;
    void setBankPaymentReference(const QString &bank_payment_reference);
    bool is_bank_payment_reference_Set() const;
    bool is_bank_payment_reference_Valid() const;
...
private:
    ...
    OAIProfile_commerce_address m_address;
    bool m_address_isSet;
    bool m_address_isValid;

    QString m_bank_payment_reference;
    bool m_bank_payment_reference_isSet;
    bool m_bank_payment_reference_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProfile_commerce)

#endif // OAIProfile_commerce_H
