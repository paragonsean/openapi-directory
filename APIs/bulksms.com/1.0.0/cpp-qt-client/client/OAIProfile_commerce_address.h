...
/*
 * OAIProfile_commerce_address.h
 *
 * 
 */

#ifndef OAIProfile_commerce_address_H
#define OAIProfile_commerce_address_H
...
class OAIProfile_commerce_address : public OAIObject {
public:
    OAIProfile_commerce_address();
    OAIProfile_commerce_address(QString json);
    ~OAIProfile_commerce_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProfile_commerce_address)

#endif // OAIProfile_commerce_address_H
