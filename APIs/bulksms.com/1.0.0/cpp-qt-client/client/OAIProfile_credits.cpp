...
OAIProfile_credits::OAIProfile_credits(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProfile_credits::OAIProfile_credits() {
    this->initializeModel();
}

OAIProfile_credits::~OAIProfile_credits() {}

void OAIProfile_credits::initializeModel() {

    m_balance_isSet = false;
    m_balance_isValid = false;

    m_is_transfer_allowed_isSet = false;
    m_is_transfer_allowed_isValid = false;

    m_limit_isSet = false;
    m_limit_isValid = false;
}

void OAIProfile_credits::fromJson(QString jsonString) {
...
void OAIProfile_credits::fromJsonObject(QJsonObject json) {

    m_balance_isValid = ::OpenAPI::fromJsonValue(m_balance, json[QString("balance")]);
    m_balance_isSet = !json[QString("balance")].isNull() && m_balance_isValid;

    m_is_transfer_allowed_isValid = ::OpenAPI::fromJsonValue(m_is_transfer_allowed, json[QString("isTransferAllowed")]);
    m_is_transfer_allowed_isSet = !json[QString("isTransferAllowed")].isNull() && m_is_transfer_allowed_isValid;

    m_limit_isValid = ::OpenAPI::fromJsonValue(m_limit, json[QString("limit")]);
    m_limit_isSet = !json[QString("limit")].isNull() && m_limit_isValid;
}

QString OAIProfile_credits::asJson() const {
...
QJsonObject OAIProfile_credits::asJsonObject() const {
    QJsonObject obj;
    if (m_balance_isSet) {
        obj.insert(QString("balance"), ::OpenAPI::toJsonValue(m_balance));
    }
    if (m_is_transfer_allowed_isSet) {
        obj.insert(QString("isTransferAllowed"), ::OpenAPI::toJsonValue(m_is_transfer_allowed));
    }
    if (m_limit_isSet) {
...
float OAIProfile_credits::getBalance() const {
    return m_balance;
}
void OAIProfile_credits::setBalance(const float &balance) {
    m_balance = balance;
    m_balance_isSet = true;
}

bool OAIProfile_credits::is_balance_Set() const{
    return m_balance_isSet;
}

bool OAIProfile_credits::is_balance_Valid() const{
    return m_balance_isValid;
}

bool OAIProfile_credits::isIsTransferAllowed() const {
    return m_is_transfer_allowed;
}
void OAIProfile_credits::setIsTransferAllowed(const bool &is_transfer_allowed) {
    m_is_transfer_allowed = is_transfer_allowed;
    m_is_transfer_allowed_isSet = true;
}

bool OAIProfile_credits::is_is_transfer_allowed_Set() const{
    return m_is_transfer_allowed_isSet;
}

bool OAIProfile_credits::is_is_transfer_allowed_Valid() const{
    return m_is_transfer_allowed_isValid;
}

qint32 OAIProfile_credits::getLimit() const {
    return m_limit;
}
void OAIProfile_credits::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIProfile_credits::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIProfile_credits::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIProfile_credits::isSet() const {
...
bool OAIProfile_credits::isValid() const {
