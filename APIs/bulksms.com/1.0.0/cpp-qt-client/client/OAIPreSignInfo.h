...
#ifndef OAIPreSignInfo_H
#define OAIPreSignInfo_H
...
namespace OpenAPI {
class OAIPreSignInfo_fields_inner;

class OAIPreSignInfo : public OAIObject {
public:
    OAIPreSignInfo();
    OAIPreSignInfo(QString json);
    ~OAIPreSignInfo() override;
    ...
    QList<OAIPreSignInfo_fields_inner> getFields() const;
    void setFields(const QList<OAIPreSignInfo_fields_inner> &fields);
    bool is_fields_Set() const;
    bool is_fields_Valid() const;

    QString getPutUrl() const;
    void setPutUrl(const QString &put_url);
    bool is_put_url_Set() const;
    bool is_put_url_Valid() const;
...
private:
    ...
    QList<OAIPreSignInfo_fields_inner> m_fields;
    bool m_fields_isSet;
    bool m_fields_isValid;

    QString m_put_url;
    bool m_put_url_isSet;
    bool m_put_url_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPreSignInfo)

#endif // OAIPreSignInfo_H
