...
OAIMessage_submission::OAIMessage_submission(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMessage_submission::OAIMessage_submission() {
    this->initializeModel();
}

OAIMessage_submission::~OAIMessage_submission() {}

void OAIMessage_submission::initializeModel() {
...
void OAIMessage_submission::fromJson(QString jsonString) {
...
void OAIMessage_submission::fromJsonObject(QJsonObject json) {
...
QString OAIMessage_submission::asJson() const {
...
QJsonObject OAIMessage_submission::asJsonObject() const {
    QJsonObject obj;
    if (m_date_isSet) {
...
QDateTime OAIMessage_submission::getDate() const {
    return m_date;
}
void OAIMessage_submission::setDate(const QDateTime &date) {
    m_date = date;
    m_date_isSet = true;
}

bool OAIMessage_submission::is_date_Set() const{
    return m_date_isSet;
}

bool OAIMessage_submission::is_date_Valid() const{
    return m_date_isValid;
}

QString OAIMessage_submission::getId() const {
    return m_id;
}
void OAIMessage_submission::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMessage_submission::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMessage_submission::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIMessage_submission::isSet() const {
...
bool OAIMessage_submission::isValid() const {
