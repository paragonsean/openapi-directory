...
#ifndef OAIWebhookEntry_H
#define OAIWebhookEntry_H
...
class OAIWebhookEntry : public OAIObject {
public:
    OAIWebhookEntry();
    OAIWebhookEntry(QString json);
    ~OAIWebhookEntry() override;
    ...
    QString getInvokeOption() const;
    void setInvokeOption(const QString &invoke_option);
    bool is_invoke_option_Set() const;
    bool is_invoke_option_Valid() const;
...
private:
    ...
    QString m_invoke_option;
    bool m_invoke_option_isSet;
    bool m_invoke_option_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookEntry)

#endif // OAIWebhookEntry_H
