...
#include "OAIMessage_submission.h"
#include <QJsonValue>
#include <QString>
...
namespace OpenAPI {
class OAIMessage_status;
class OAIMessage_submission;
...
public:
    ...
    void setCreditCost(const float &credit_cost);
    ...
    qint32 getMessageClass() const;
    void setMessageClass(const qint32 &message_class);
    bool is_message_class_Set() const;
    bool is_message_class_Valid() const;

    qint32 getNumberOfParts() const;
    void setNumberOfParts(const qint32 &number_of_parts);
    bool is_number_of_parts_Set() const;
    bool is_number_of_parts_Valid() const;
    ...
    QString getRelatedSentMessageId() const;
    void setRelatedSentMessageId(const QString &related_sent_message_id);
    bool is_related_sent_message_id_Set() const;
    bool is_related_sent_message_id_Valid() const;

    OAIMessage_status getStatus() const;
    void setStatus(const OAIMessage_status &status);
    bool is_status_Set() const;
    bool is_status_Valid() const;

    OAIMessage_submission getSubmission() const;
    void setSubmission(const OAIMessage_submission &submission);
...
private:
    ...
    qint32 m_message_class;
    bool m_message_class_isSet;
    bool m_message_class_isValid;

    qint32 m_number_of_parts;
    bool m_number_of_parts_isSet;
    bool m_number_of_parts_isValid;

    qint32 m_protocol_id;
    bool m_protocol_id_isSet;
    bool m_protocol_id_isValid;

    QString m_related_sent_message_id;
    bool m_related_sent_message_id_isSet;
    bool m_related_sent_message_id_isValid;

    OAIMessage_status m_status;
    bool m_status_isSet;
    bool m_status_isValid;

    OAIMessage_submission m_submission;
