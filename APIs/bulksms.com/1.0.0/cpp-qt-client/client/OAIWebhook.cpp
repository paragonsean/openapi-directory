...
QString OAIWebhook::getContactEmailAddress() const {
    return m_contact_email_address;
}
void OAIWebhook::setContactEmailAddress(const QString &contact_email_address) {
    m_contact_email_address = contact_email_address;
    m_contact_email_address_isSet = true;
}

bool OAIWebhook::is_contact_email_address_Set() const{
    return m_contact_email_address_isSet;
}

bool OAIWebhook::is_contact_email_address_Valid() const{
...
bool OAIWebhook::isOnWebApp() const {
    return m_on_web_app;
}
void OAIWebhook::setOnWebApp(const bool &on_web_app) {
    m_on_web_app = on_web_app;
    m_on_web_app_isSet = true;
}

bool OAIWebhook::is_on_web_app_Set() const{
    return m_on_web_app_isSet;
}

bool OAIWebhook::is_on_web_app_Valid() const{
    return m_on_web_app_isValid;
}

QString OAIWebhook::getTriggerScope() const {
    return m_trigger_scope;
}
void OAIWebhook::setTriggerScope(const QString &trigger_scope) {
    m_trigger_scope = trigger_scope;
    m_trigger_scope_isSet = true;
}

bool OAIWebhook::is_trigger_scope_Set() const{
    return m_trigger_scope_isSet;
}

bool OAIWebhook::is_trigger_scope_Valid() const{
