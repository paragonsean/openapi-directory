...
OAIProfile_commerce::OAIProfile_commerce(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProfile_commerce::OAIProfile_commerce() {
    this->initializeModel();
}

OAIProfile_commerce::~OAIProfile_commerce() {}

void OAIProfile_commerce::initializeModel() {

    m_address_isSet = false;
    m_address_isValid = false;

    m_bank_payment_reference_isSet = false;
    m_bank_payment_reference_isValid = false;
}

void OAIProfile_commerce::fromJson(QString jsonString) {
...
void OAIProfile_commerce::fromJsonObject(QJsonObject json) {

    m_address_isValid = ::OpenAPI::fromJsonValue(m_address, json[QString("address")]);
    m_address_isSet = !json[QString("address")].isNull() && m_address_isValid;

    m_bank_payment_reference_isValid = ::OpenAPI::fromJsonValue(m_bank_payment_reference, json[QString("bankPaymentReference")]);
    m_bank_payment_reference_isSet = !json[QString("bankPaymentReference")].isNull() && m_bank_payment_reference_isValid;
}

QString OAIProfile_commerce::asJson() const {
...
QJsonObject OAIProfile_commerce::asJsonObject() const {
    QJsonObject obj;
    if (m_address.isSet()) {
        obj.insert(QString("address"), ::OpenAPI::toJsonValue(m_address));
    }
    if (m_bank_payment_reference_isSet) {
        obj.insert(QString("bankPaymentReference"), ::OpenAPI::toJsonValue(m_bank_payment_reference));
    }
    return obj;
}

OAIProfile_commerce_address OAIProfile_commerce::getAddress() const {
    return m_address;
}
void OAIProfile_commerce::setAddress(const OAIProfile_commerce_address &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIProfile_commerce::is_address_Set() const{
    return m_address_isSet;
}

bool OAIProfile_commerce::is_address_Valid() const{
    return m_address_isValid;
}

QString OAIProfile_commerce::getBankPaymentReference() const {
    return m_bank_payment_reference;
}
void OAIProfile_commerce::setBankPaymentReference(const QString &bank_payment_reference) {
    m_bank_payment_reference = bank_payment_reference;
    m_bank_payment_reference_isSet = true;
}

bool OAIProfile_commerce::is_bank_payment_reference_Set() const{
    return m_bank_payment_reference_isSet;
}

bool OAIProfile_commerce::is_bank_payment_reference_Valid() const{
    return m_bank_payment_reference_isValid;
}

bool OAIProfile_commerce::isSet() const {
...
bool OAIProfile_commerce::isValid() const {
