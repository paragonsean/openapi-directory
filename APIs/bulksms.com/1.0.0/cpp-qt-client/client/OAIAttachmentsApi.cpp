...
void OAIAttachmentsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("rmmPreSignAttachmentPost", defaultConf);
    _serverIndices.insert("rmmPreSignAttachmentPost", 0);
}
...
void OAIAttachmentsApi::rmmPreSignAttachmentPost(const OAIPreSignRequest &oai_pre_sign_request) {
    QString fullPath = QString(_serverConfigs["rmmPreSignAttachmentPost"][_serverIndices.value("rmmPreSignAttachmentPost")].URL()+"/rmm/pre-sign-attachment");
...

    {
        ...
        QByteArray output = oai_pre_sign_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAttachmentsApi::rmmPreSignAttachmentPostCallback);
...
void OAIAttachmentsApi::rmmPreSignAttachmentPostCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPreSignInfo output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT rmmPreSignAttachmentPostSignal(output);
        Q_EMIT rmmPreSignAttachmentPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT rmmPreSignAttachmentPostSignalE(output, error_type, error_str);
        Q_EMIT rmmPreSignAttachmentPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT rmmPreSignAttachmentPostSignalError(output, error_type, error_str);
        Q_EMIT rmmPreSignAttachmentPostSignalErrorFull(worker, error_type, error_str);
    }
}
