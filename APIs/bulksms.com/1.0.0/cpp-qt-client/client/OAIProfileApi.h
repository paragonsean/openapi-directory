...
private:
    ...
    void profileGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void profileGetSignal(OAIProfile summary);


    void profileGetSignalFull(OAIHttpRequestWorker *worker, OAIProfile summary);

    Q_DECL_DEPRECATED_X("Use profileGetSignalError() instead")
    void profileGetSignalE(OAIProfile summary, QNetworkReply::NetworkError error_type, QString error_str);
    void profileGetSignalError(OAIProfile summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use profileGetSignalErrorFull() instead")
    void profileGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void profileGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
