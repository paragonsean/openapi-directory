...
OAIBlockedNumber::OAIBlockedNumber(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBlockedNumber::OAIBlockedNumber() {
    this->initializeModel();
}

OAIBlockedNumber::~OAIBlockedNumber() {}

void OAIBlockedNumber::initializeModel() {
...
void OAIBlockedNumber::fromJson(QString jsonString) {
...
void OAIBlockedNumber::fromJsonObject(QJsonObject json) {
...
QString OAIBlockedNumber::asJson() const {
...
QJsonObject OAIBlockedNumber::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
double OAIBlockedNumber::getId() const {
    return m_id;
}
void OAIBlockedNumber::setId(const double &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBlockedNumber::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBlockedNumber::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIBlockedNumber::getPhoneNumber() const {
    return m_phone_number;
}
void OAIBlockedNumber::setPhoneNumber(const QString &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIBlockedNumber::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIBlockedNumber::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

bool OAIBlockedNumber::isSet() const {
...
bool OAIBlockedNumber::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_phone_number_isValid && true;
}
