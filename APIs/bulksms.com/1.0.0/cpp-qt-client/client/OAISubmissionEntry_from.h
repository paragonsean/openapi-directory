...
#ifndef OAISubmissionEntry_from_H
#define OAISubmissionEntry_from_H
...
class OAISubmissionEntry_from : public OAIObject {
public:
    OAISubmissionEntry_from();
    OAISubmissionEntry_from(QString json);
    ~OAISubmissionEntry_from() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubmissionEntry_from)

#endif // OAISubmissionEntry_from_H
