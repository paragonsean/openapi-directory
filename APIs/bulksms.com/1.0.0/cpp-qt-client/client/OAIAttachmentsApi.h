...
#include "OAIPreSignInfo.h"
#include "OAIPreSignRequest.h"
#include <QString>
...
public:
    ...
    /**
    * @param[in]  oai_pre_sign_request OAIPreSignRequest [required]
    */
    virtual void rmmPreSignAttachmentPost(const OAIPreSignRequest &oai_pre_sign_request);
...
private:
    ...
    void rmmPreSignAttachmentPostCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void rmmPreSignAttachmentPostSignal(OAIPreSignInfo summary);


    void rmmPreSignAttachmentPostSignalFull(OAIHttpRequestWorker *worker, OAIPreSignInfo summary);

    Q_DECL_DEPRECATED_X("Use rmmPreSignAttachmentPostSignalError() instead")
    void rmmPreSignAttachmentPostSignalE(OAIPreSignInfo summary, QNetworkReply::NetworkError error_type, QString error_str);
    void rmmPreSignAttachmentPostSignalError(OAIPreSignInfo summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use rmmPreSignAttachmentPostSignalErrorFull() instead")
    void rmmPreSignAttachmentPostSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void rmmPreSignAttachmentPostSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
