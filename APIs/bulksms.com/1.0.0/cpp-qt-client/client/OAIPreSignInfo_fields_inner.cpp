...
#include "OAIPreSignInfo_fields_inner.h"
...
OAIPreSignInfo_fields_inner::OAIPreSignInfo_fields_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPreSignInfo_fields_inner::OAIPreSignInfo_fields_inner() {
    this->initializeModel();
}

OAIPreSignInfo_fields_inner::~OAIPreSignInfo_fields_inner() {}

void OAIPreSignInfo_fields_inner::initializeModel() {
...
void OAIPreSignInfo_fields_inner::fromJson(QString jsonString) {
...
void OAIPreSignInfo_fields_inner::fromJsonObject(QJsonObject json) {
...
QString OAIPreSignInfo_fields_inner::asJson() const {
...
QJsonObject OAIPreSignInfo_fields_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIPreSignInfo_fields_inner::getName() const {
    return m_name;
}
void OAIPreSignInfo_fields_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPreSignInfo_fields_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPreSignInfo_fields_inner::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPreSignInfo_fields_inner::getValue() const {
    return m_value;
}
void OAIPreSignInfo_fields_inner::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIPreSignInfo_fields_inner::is_value_Set() const{
    return m_value_isSet;
}

bool OAIPreSignInfo_fields_inner::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIPreSignInfo_fields_inner::isSet() const {
...
bool OAIPreSignInfo_fields_inner::isValid() const {
