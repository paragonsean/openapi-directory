...
OAISubmissionEntry_from::OAISubmissionEntry_from(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubmissionEntry_from::OAISubmissionEntry_from() {
    this->initializeModel();
}

OAISubmissionEntry_from::~OAISubmissionEntry_from() {}

void OAISubmissionEntry_from::initializeModel() {
...
void OAISubmissionEntry_from::fromJson(QString jsonString) {
...
void OAISubmissionEntry_from::fromJsonObject(QJsonObject json) {
...
QString OAISubmissionEntry_from::asJson() const {
...
QJsonObject OAISubmissionEntry_from::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAISubmissionEntry_from::getAddress() const {
    return m_address;
}
void OAISubmissionEntry_from::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAISubmissionEntry_from::is_address_Set() const{
    return m_address_isSet;
}

bool OAISubmissionEntry_from::is_address_Valid() const{
    return m_address_isValid;
}

QString OAISubmissionEntry_from::getType() const {
    return m_type;
}
void OAISubmissionEntry_from::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISubmissionEntry_from::is_type_Set() const{
    return m_type_isSet;
}

bool OAISubmissionEntry_from::is_type_Valid() const{
    return m_type_isValid;
}

bool OAISubmissionEntry_from::isSet() const {
...
bool OAISubmissionEntry_from::isValid() const {
