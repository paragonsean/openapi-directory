...
/*
 * OAIPreSignInfo_fields_inner.h
 *
 * 
 */

#ifndef OAIPreSignInfo_fields_inner_H
#define OAIPreSignInfo_fields_inner_H
...
class OAIPreSignInfo_fields_inner : public OAIObject {
public:
    OAIPreSignInfo_fields_inner();
    OAIPreSignInfo_fields_inner(QString json);
    ~OAIPreSignInfo_fields_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPreSignInfo_fields_inner)

#endif // OAIPreSignInfo_fields_inner_H
