...
public:
    ...
    bool isOnWebApp() const;
    void setOnWebApp(const bool &on_web_app);
    bool is_on_web_app_Set() const;
    bool is_on_web_app_Valid() const;

    QString getTriggerScope() const;
    void setTriggerScope(const QString &trigger_scope);
    bool is_trigger_scope_Set() const;
    bool is_trigger_scope_Valid() const;
...
private:
    ...
    bool m_on_web_app;
    bool m_on_web_app_isSet;
    bool m_on_web_app_isValid;

    QString m_trigger_scope;
    bool m_trigger_scope_isSet;
    bool m_trigger_scope_isValid;
