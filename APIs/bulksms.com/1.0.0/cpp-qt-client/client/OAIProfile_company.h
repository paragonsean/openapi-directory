...
/*
 * OAIProfile_company.h
 *
 * 
 */

#ifndef OAIProfile_company_H
#define OAIProfile_company_H
...
class OAIProfile_company : public OAIObject {
public:
    OAIProfile_company();
    OAIProfile_company(QString json);
    ~OAIProfile_company() override;
    ...
    QString getTaxReference() const;
    void setTaxReference(const QString &tax_reference);
    bool is_tax_reference_Set() const;
    bool is_tax_reference_Valid() const;
...
private:
    ...
    QString m_tax_reference;
    bool m_tax_reference_isSet;
    bool m_tax_reference_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProfile_company)

#endif // OAIProfile_company_H
