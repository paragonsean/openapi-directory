...
OAIProfile_quota::OAIProfile_quota(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProfile_quota::OAIProfile_quota() {
    this->initializeModel();
}

OAIProfile_quota::~OAIProfile_quota() {}

void OAIProfile_quota::initializeModel() {
...
void OAIProfile_quota::fromJson(QString jsonString) {
...
void OAIProfile_quota::fromJsonObject(QJsonObject json) {
...
QString OAIProfile_quota::asJson() const {
...
QJsonObject OAIProfile_quota::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIProfile_quota::getRemaining() const {
    return m_remaining;
}
void OAIProfile_quota::setRemaining(const qint32 &remaining) {
    m_remaining = remaining;
    m_remaining_isSet = true;
}

bool OAIProfile_quota::is_remaining_Set() const{
    return m_remaining_isSet;
}

bool OAIProfile_quota::is_remaining_Valid() const{
    return m_remaining_isValid;
}

qint32 OAIProfile_quota::getSize() const {
    return m_size;
}
void OAIProfile_quota::setSize(const qint32 &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIProfile_quota::is_size_Set() const{
    return m_size_isSet;
}

bool OAIProfile_quota::is_size_Valid() const{
    return m_size_isValid;
}

bool OAIProfile_quota::isSet() const {
...
bool OAIProfile_quota::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_remaining_isValid && m_size_isValid && true;
}
