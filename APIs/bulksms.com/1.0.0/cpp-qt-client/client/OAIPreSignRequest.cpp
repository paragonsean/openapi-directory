...
OAIPreSignRequest::OAIPreSignRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPreSignRequest::OAIPreSignRequest() {
    this->initializeModel();
}

OAIPreSignRequest::~OAIPreSignRequest() {}

void OAIPreSignRequest::initializeModel() {
...
void OAIPreSignRequest::fromJson(QString jsonString) {
...
void OAIPreSignRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPreSignRequest::asJson() const {
...
QJsonObject OAIPreSignRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPreSignRequest::getFileExtension() const {
    return m_file_extension;
}
void OAIPreSignRequest::setFileExtension(const QString &file_extension) {
    m_file_extension = file_extension;
    m_file_extension_isSet = true;
}

bool OAIPreSignRequest::is_file_extension_Set() const{
    return m_file_extension_isSet;
}

bool OAIPreSignRequest::is_file_extension_Valid() const{
    return m_file_extension_isValid;
}

QString OAIPreSignRequest::getMediaType() const {
    return m_media_type;
}
void OAIPreSignRequest::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIPreSignRequest::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIPreSignRequest::is_media_type_Valid() const{
    return m_media_type_isValid;
}

bool OAIPreSignRequest::isSet() const {
...
bool OAIPreSignRequest::isValid() const {
