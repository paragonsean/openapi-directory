...
OAISubmissionEntry_to_inner::OAISubmissionEntry_to_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubmissionEntry_to_inner::OAISubmissionEntry_to_inner() {
    this->initializeModel();
}

OAISubmissionEntry_to_inner::~OAISubmissionEntry_to_inner() {}

void OAISubmissionEntry_to_inner::initializeModel() {
...
void OAISubmissionEntry_to_inner::fromJson(QString jsonString) {
...
void OAISubmissionEntry_to_inner::fromJsonObject(QJsonObject json) {
...
QString OAISubmissionEntry_to_inner::asJson() const {
...
QJsonObject OAISubmissionEntry_to_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_address_isSet) {
...
QString OAISubmissionEntry_to_inner::getAddress() const {
    return m_address;
}
void OAISubmissionEntry_to_inner::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAISubmissionEntry_to_inner::is_address_Set() const{
    return m_address_isSet;
}

bool OAISubmissionEntry_to_inner::is_address_Valid() const{
    return m_address_isValid;
}

QList<QString> OAISubmissionEntry_to_inner::getFields() const {
    return m_fields;
}
void OAISubmissionEntry_to_inner::setFields(const QList<QString> &fields) {
    m_fields = fields;
    m_fields_isSet = true;
}

bool OAISubmissionEntry_to_inner::is_fields_Set() const{
    return m_fields_isSet;
}

bool OAISubmissionEntry_to_inner::is_fields_Valid() const{
    return m_fields_isValid;
}

QString OAISubmissionEntry_to_inner::getId() const {
    return m_id;
}
void OAISubmissionEntry_to_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISubmissionEntry_to_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAISubmissionEntry_to_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISubmissionEntry_to_inner::getName() const {
    return m_name;
}
void OAISubmissionEntry_to_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISubmissionEntry_to_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAISubmissionEntry_to_inner::is_name_Valid() const{
    return m_name_isValid;
}

QString OAISubmissionEntry_to_inner::getType() const {
    return m_type;
}
void OAISubmissionEntry_to_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISubmissionEntry_to_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAISubmissionEntry_to_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAISubmissionEntry_to_inner::isSet() const {
...
bool OAISubmissionEntry_to_inner::isValid() const {
