...
void OAIProfileApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("profileGet", defaultConf);
    _serverIndices.insert("profileGet", 0);
}
...
void OAIProfileApi::profileGet() {
    QString fullPath = QString(_serverConfigs["profileGet"][_serverIndices.value("profileGet")].URL()+"/profile");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProfileApi::profileGetCallback);
...
void OAIProfileApi::profileGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT profileGetSignal(output);
        Q_EMIT profileGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT profileGetSignalE(output, error_type, error_str);
        Q_EMIT profileGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT profileGetSignalError(output, error_type, error_str);
        Q_EMIT profileGetSignalErrorFull(worker, error_type, error_str);
    }
}
