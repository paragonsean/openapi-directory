...
#ifndef OAIMessage_status_H
#define OAIMessage_status_H
...
class OAIMessage_status : public OAIObject {
public:
    OAIMessage_status();
    OAIMessage_status(QString json);
    ~OAIMessage_status() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessage_status)

#endif // OAIMessage_status_H
