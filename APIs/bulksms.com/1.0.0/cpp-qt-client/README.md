...
OAIPreSignRequest Example::create(){
    OAIPreSignRequest obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAttachmentsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAttachmentsApi::rmmPreSignAttachmentPostSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAttachmentsApi::rmmPreSignAttachmentPostSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIPreSignRequest oai_pre_sign_request = create(); // OAIPreSignRequest | Describes the file to upload
      apiInstance.rmmPreSignAttachmentPost(oai_pre_sign_request);
