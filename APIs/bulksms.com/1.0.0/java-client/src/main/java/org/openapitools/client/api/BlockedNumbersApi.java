...
import org.openapitools.client.model.BlockedNumber;
...
public class BlockedNumbersApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public BlockedNumbersApi() {
        this(Configuration.getDefaultApiClient());
    }

    public BlockedNumbersApi(ApiClient apiClient) {
    ...
    /**
     * Build call for blockedNumbersGet
     * @param minId Records with an &#x60;id&#x60; that is greater or equal to min-id will be returned. The default value is &#x60;0&#x60;.  You can add 1 to an id that you previously retrieved, to return subsequent records. (optional)
     * @param limit The maximum number of records to return. The default value is &#x60;10000&#x60;. The value cannot be greater than 10000. (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> A list of BlockedNumber objects </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call blockedNumbersGetCall(Integer minId, Integer limit, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/blocked-numbers";
        ...
        if (minId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("min-id", minId));
        }
    ...
    private okhttp3.Call blockedNumbersGetValidateBeforeCall(Integer minId, Integer limit, final ApiCallback _callback) throws ApiException {
        return blockedNumbersGetCall(minId, limit, _callback);
     ...
     */
    public BlockedNumber blockedNumbersGet(Integer minId, Integer limit) throws ApiException {
        ApiResponse<BlockedNumber> localVarResp = blockedNumbersGetWithHttpInfo(minId, limit);
     ...
     * @param minId Records with an &#x60;id&#x60; that is greater or equal to min-id will be returned. The default value is &#x60;0&#x60;.  You can add 1 to an id that you previously retrieved, to return subsequent records. (optional)
     * @param limit The maximum number of records to return. The default value is &#x60;10000&#x60;. The value cannot be greater than 10000. (optional)
     * @return ApiResponse&lt;BlockedNumber&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BlockedNumber> blockedNumbersGetWithHttpInfo(Integer minId, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = blockedNumbersGetValidateBeforeCall(minId, limit, null);
        Type localVarReturnType = new TypeToken<BlockedNumber>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List blocked numbers (asynchronously)
     * 
     * @param minId Records with an &#x60;id&#x60; that is greater or equal to min-id will be returned. The default value is &#x60;0&#x60;.  You can add 1 to an id that you previously retrieved, to return subsequent records. (optional)
     * @param limit The maximum number of records to return. The default value is &#x60;10000&#x60;. The value cannot be greater than 10000. (optional)
     ...
     */
    public okhttp3.Call blockedNumbersGetAsync(Integer minId, Integer limit, final ApiCallback<BlockedNumber> _callback) throws ApiException {

        okhttp3.Call localVarCall = blockedNumbersGetValidateBeforeCall(minId, limit, _callback);
        Type localVarReturnType = new TypeToken<BlockedNumber>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for blockedNumbersPost
     * @param requestBody Maximum size: &#x60;1000&#x60; items (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Empty body upon success </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call blockedNumbersPostCall(List<String> requestBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call blockedNumbersPostValidateBeforeCall(List<String> requestBody, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
            throw new ApiException("Missing the required parameter 'requestBody' when calling blockedNumbersPost(Async)");
        }

        return blockedNumbersPostCall(requestBody, _callback);
     ...
     */
    public void blockedNumbersPost(List<String> requestBody) throws ApiException {
        blockedNumbersPostWithHttpInfo(requestBody);
    }
     ...
     */
    public ApiResponse<Void> blockedNumbersPostWithHttpInfo(List<String> requestBody) throws ApiException {
        okhttp3.Call localVarCall = blockedNumbersPostValidateBeforeCall(requestBody, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Create a blocked number (asynchronously)
     * Blocked numbers are phone numbers to which your account is not permitted to send messages. The numbers can be created via this API, by a recipient replying with a STOP message to one of your previous SENT messages, or by a BulkSMS administrator.  Sending a message to a blocked number will result in the message being assigned a status of &#x60;FAILED.BLOCKED&#x60;. Messages sent to blocked numbers are billed to your account. 
     * @param requestBody Maximum size: &#x60;1000&#x60; items (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call blockedNumbersPostAsync(List<String> requestBody, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = blockedNumbersPostValidateBeforeCall(requestBody, _callback);
