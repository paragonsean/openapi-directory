...
public class ProfileQuota {
  ...
  public ProfileQuota remaining(Integer remaining) {
  ...
  public ProfileQuota size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProfileQuota profileQuota = (ProfileQuota) o;
    return Objects.equals(this.remaining, profileQuota.remaining) &&
        Objects.equals(this.size, profileQuota.size);
  }

  @Override
  public int hashCode() {
    return Objects.hash(remaining, size);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProfileQuota {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProfileQuota
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProfileQuota.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProfileQuota is not found in the empty JSON string", ProfileQuota.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProfileQuota.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProfileQuota` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProfileQuota.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProfileQuota.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProfileQuota' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProfileQuota> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProfileQuota.class));

       return (TypeAdapter<T>) new TypeAdapter<ProfileQuota>() {
           @Override
           public void write(JsonWriter out, ProfileQuota value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProfileQuota read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProfileQuota given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProfileQuota
   * @throws IOException if the JSON string is invalid with respect to ProfileQuota
   */
  public static ProfileQuota fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProfileQuota.class);
  }

  /**
   * Convert an instance of ProfileQuota to an JSON string
   *
   * @return JSON string
   */
