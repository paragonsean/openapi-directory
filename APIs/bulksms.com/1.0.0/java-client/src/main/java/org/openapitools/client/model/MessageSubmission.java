...
public class MessageSubmission {
  ...
  public MessageSubmission date(OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public MessageSubmission id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MessageSubmission messageSubmission = (MessageSubmission) o;
    return Objects.equals(this.date, messageSubmission.date) &&
        Objects.equals(this.id, messageSubmission.id);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageSubmission
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageSubmission.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageSubmission is not found in the empty JSON string", MessageSubmission.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageSubmission.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageSubmission` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MessageSubmission.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageSubmission.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageSubmission' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageSubmission> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageSubmission.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageSubmission>() {
           @Override
           public void write(JsonWriter out, MessageSubmission value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageSubmission read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageSubmission given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageSubmission
   * @throws IOException if the JSON string is invalid with respect to MessageSubmission
   */
  public static MessageSubmission fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageSubmission.class);
  }

  /**
   * Convert an instance of MessageSubmission to an JSON string
   *
   * @return JSON string
   */
