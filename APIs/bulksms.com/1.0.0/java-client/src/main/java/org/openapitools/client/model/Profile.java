...
public class Profile {
  ...
  private ProfileCommerce commerce;
  ...
  private ProfileCredits credits;

  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private String id;

  public static final String SERIALIZED_NAME_ORIGIN_ADDRESSES = "originAddresses";
  @SerializedName(SERIALIZED_NAME_ORIGIN_ADDRESSES)
  private ProfileOriginAddresses originAddresses;

  public static final String SERIALIZED_NAME_QUOTA = "quota";
  @SerializedName(SERIALIZED_NAME_QUOTA)
  private ProfileQuota quota;
  ...
  public Profile commerce(ProfileCommerce commerce) {
  ...
  public ProfileCommerce getCommerce() {
    return commerce;
  }

  public void setCommerce(ProfileCommerce commerce) {
    this.commerce = commerce;
  }


  public Profile company(ProfileCompany company) {
  ...
  public void setCompany(ProfileCompany company) {
    this.company = company;
  }


  public Profile created(OffsetDateTime created) {
  ...
  public Profile credits(ProfileCredits credits) {
   ...
   */
  @javax.annotation.Nonnull
  public ProfileCredits getCredits() {
    return credits;
  }

  public void setCredits(ProfileCredits credits) {
    this.credits = credits;
  }
  ...
  public Profile originAddresses(ProfileOriginAddresses originAddresses) {
   ...
   */
  @javax.annotation.Nullable
  public ProfileOriginAddresses getOriginAddresses() {
    return originAddresses;
  }

  public void setOriginAddresses(ProfileOriginAddresses originAddresses) {
    this.originAddresses = originAddresses;
  }


  public Profile quota(ProfileQuota quota) {
    this.quota = quota;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public ProfileQuota getQuota() {
    return quota;
  }

  public void setQuota(ProfileQuota quota) {
    this.quota = quota;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commerce, profile.commerce) &&
        Objects.equals(this.company, profile.company) &&
        Objects.equals(this.created, profile.created) &&
        Objects.equals(this.credits, profile.credits) &&
        Objects.equals(this.id, profile.id) &&
        Objects.equals(this.originAddresses, profile.originAddresses) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(commerce, company, created, credits, id, originAddresses, quota, username);
  }
  ...
  public String toString() {
    ...
    sb.append("    originAddresses: ").append(toIndentedString(originAddresses)).append("\n");
  ...
  static {
    ...
    openapiFields.add("commerce");
    openapiFields.add("company");
    openapiFields.add("created");
    openapiFields.add("credits");
    openapiFields.add("id");
    openapiFields.add("originAddresses");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("commerce") != null && !jsonObj.get("commerce").isJsonNull()) {
        ProfileCommerce.validateJsonElement(jsonObj.get("commerce"));
      }
      // validate the optional field `company`
      if (jsonObj.get("company") != null && !jsonObj.get("company").isJsonNull()) {
        ProfileCompany.validateJsonElement(jsonObj.get("company"));
      }
      // validate the required field `credits`
      ProfileCredits.validateJsonElement(jsonObj.get("credits"));
      if (!jsonObj.get("id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("id").toString()));
      }
      // validate the optional field `originAddresses`
      if (jsonObj.get("originAddresses") != null && !jsonObj.get("originAddresses").isJsonNull()) {
        ProfileOriginAddresses.validateJsonElement(jsonObj.get("originAddresses"));
      }
      // validate the required field `quota`
      ProfileQuota.validateJsonElement(jsonObj.get("quota"));
