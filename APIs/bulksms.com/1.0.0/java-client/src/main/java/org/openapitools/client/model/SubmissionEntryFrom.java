...
public class SubmissionEntryFrom {
  ...
  public SubmissionEntryFrom() {
  }

  public SubmissionEntryFrom address(String address) {
  ...
  public SubmissionEntryFrom type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SubmissionEntryFrom submissionEntryFrom = (SubmissionEntryFrom) o;
    return Objects.equals(this.address, submissionEntryFrom.address) &&
        Objects.equals(this.type, submissionEntryFrom.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubmissionEntryFrom {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubmissionEntryFrom
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubmissionEntryFrom.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubmissionEntryFrom is not found in the empty JSON string", SubmissionEntryFrom.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubmissionEntryFrom.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubmissionEntryFrom` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SubmissionEntryFrom.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubmissionEntryFrom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubmissionEntryFrom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubmissionEntryFrom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubmissionEntryFrom.class));

       return (TypeAdapter<T>) new TypeAdapter<SubmissionEntryFrom>() {
           @Override
           public void write(JsonWriter out, SubmissionEntryFrom value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubmissionEntryFrom read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubmissionEntryFrom given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubmissionEntryFrom
   * @throws IOException if the JSON string is invalid with respect to SubmissionEntryFrom
   */
  public static SubmissionEntryFrom fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubmissionEntryFrom.class);
  }

  /**
   * Convert an instance of SubmissionEntryFrom to an JSON string
   *
   * @return JSON string
   */
