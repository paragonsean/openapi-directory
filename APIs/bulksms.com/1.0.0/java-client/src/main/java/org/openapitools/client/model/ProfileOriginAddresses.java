...
public class ProfileOriginAddresses {
  ...
  public static final String SERIALIZED_NAME_IS_FULL_CONTROL_ALLOWED = "isFullControlAllowed";
  @SerializedName(SERIALIZED_NAME_IS_FULL_CONTROL_ALLOWED)
  private Boolean isFullControlAllowed;

  public ProfileOriginAddresses() {
  }

  public ProfileOriginAddresses allowed(List<String> allowed) {
    this.allowed = allowed;
    return this;
  }

  public ProfileOriginAddresses addAllowedItem(String allowedItem) {
  ...
  public ProfileOriginAddresses isFullControlAllowed(Boolean isFullControlAllowed) {
    this.isFullControlAllowed = isFullControlAllowed;
    return this;
  }

  /**
   * Get isFullControlAllowed
   * @return isFullControlAllowed
   */
  @javax.annotation.Nullable
  public Boolean getIsFullControlAllowed() {
    return isFullControlAllowed;
  }

  public void setIsFullControlAllowed(Boolean isFullControlAllowed) {
    this.isFullControlAllowed = isFullControlAllowed;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProfileOriginAddresses profileOriginAddresses = (ProfileOriginAddresses) o;
    return Objects.equals(this.allowed, profileOriginAddresses.allowed) &&
        Objects.equals(this.isFullControlAllowed, profileOriginAddresses.isFullControlAllowed);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowed, isFullControlAllowed);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProfileOriginAddresses {\n");
    sb.append("    allowed: ").append(toIndentedString(allowed)).append("\n");
    sb.append("    isFullControlAllowed: ").append(toIndentedString(isFullControlAllowed)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("isFullControlAllowed");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProfileOriginAddresses
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProfileOriginAddresses.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProfileOriginAddresses is not found in the empty JSON string", ProfileOriginAddresses.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProfileOriginAddresses.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProfileOriginAddresses` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProfileOriginAddresses.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProfileOriginAddresses' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProfileOriginAddresses> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProfileOriginAddresses.class));

       return (TypeAdapter<T>) new TypeAdapter<ProfileOriginAddresses>() {
           @Override
           public void write(JsonWriter out, ProfileOriginAddresses value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProfileOriginAddresses read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProfileOriginAddresses given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProfileOriginAddresses
   * @throws IOException if the JSON string is invalid with respect to ProfileOriginAddresses
   */
  public static ProfileOriginAddresses fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProfileOriginAddresses.class);
  }

  /**
   * Convert an instance of ProfileOriginAddresses to an JSON string
   *
   * @return JSON string
   */
