...
public class PreSignRequest {
  ...
  public PreSignRequest fileExtension(String fileExtension) {
  ...
  public PreSignRequest mediaType(String mediaType) {
  ...
  public boolean equals(Object o) {
    ...
    PreSignRequest preSignRequest = (PreSignRequest) o;
    return Objects.equals(this.fileExtension, preSignRequest.fileExtension) &&
        Objects.equals(this.mediaType, preSignRequest.mediaType);
  }
  ...
  public String toString() {
    ...
    sb.append("class PreSignRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PreSignRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PreSignRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PreSignRequest is not found in the empty JSON string", PreSignRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PreSignRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PreSignRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PreSignRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PreSignRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PreSignRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PreSignRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PreSignRequest>() {
           @Override
           public void write(JsonWriter out, PreSignRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PreSignRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PreSignRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PreSignRequest
   * @throws IOException if the JSON string is invalid with respect to PreSignRequest
   */
  public static PreSignRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PreSignRequest.class);
  }

  /**
   * Convert an instance of PreSignRequest to an JSON string
   *
   * @return JSON string
   */
