...
public class CreditsApi {
    ...
    /**
     * Build call for creditTransferPost
     * @param transferEntry Contains details of the transfer request.  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> An empty body when the credits were transferred OK. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> When the request fails validation checks. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> When there are not enough credits in your account or the credit transfer facility is not activated. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call creditTransferPostCall(TransferEntry transferEntry, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = transferEntry;

        // create path and map variables
        String localVarPath = "/credit/transfer";
    ...
    private okhttp3.Call creditTransferPostValidateBeforeCall(TransferEntry transferEntry, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'transferEntry' is set
        if (transferEntry == null) {
            throw new ApiException("Missing the required parameter 'transferEntry' when calling creditTransferPost(Async)");
        }

        return creditTransferPostCall(transferEntry, _callback);
     ...
     */
    public void creditTransferPost(TransferEntry transferEntry) throws ApiException {
        creditTransferPostWithHttpInfo(transferEntry);
    }
     ...
     */
    public ApiResponse<Void> creditTransferPostWithHttpInfo(TransferEntry transferEntry) throws ApiException {
        okhttp3.Call localVarCall = creditTransferPostValidateBeforeCall(transferEntry, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Transfer credits to another account (asynchronously)
     * Before you can use the transfer credits endpoint, the _credit-transfer facility_ must be activated for your account.  You can request activation from &#x60;support@bulksms.com&#x60;.   The recipient must be an enabled account that uses the same currency as your account. 
     * @param transferEntry Contains details of the transfer request.  (required)
     ...
     */
    public okhttp3.Call creditTransferPostAsync(TransferEntry transferEntry, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = creditTransferPostValidateBeforeCall(transferEntry, _callback);
