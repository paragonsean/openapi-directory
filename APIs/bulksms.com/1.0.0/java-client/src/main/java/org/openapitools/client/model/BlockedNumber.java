...
public class BlockedNumber {
  ...
  public BlockedNumber id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  public BlockedNumber phoneNumber(String phoneNumber) {
  ...
  public boolean equals(Object o) {
    ...
    BlockedNumber blockedNumber = (BlockedNumber) o;
    return Objects.equals(this.id, blockedNumber.id) &&
        Objects.equals(this.phoneNumber, blockedNumber.phoneNumber);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BlockedNumber
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BlockedNumber.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BlockedNumber is not found in the empty JSON string", BlockedNumber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BlockedNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BlockedNumber` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BlockedNumber.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BlockedNumber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BlockedNumber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BlockedNumber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BlockedNumber.class));

       return (TypeAdapter<T>) new TypeAdapter<BlockedNumber>() {
           @Override
           public void write(JsonWriter out, BlockedNumber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BlockedNumber read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BlockedNumber given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BlockedNumber
   * @throws IOException if the JSON string is invalid with respect to BlockedNumber
   */
  public static BlockedNumber fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlockedNumber.class);
  }

  /**
   * Convert an instance of BlockedNumber to an JSON string
   *
   * @return JSON string
   */
