...
import org.openapitools.client.model.ProfileCommerceAddress;
...
public class ProfileCommerce {
  ...
  private ProfileCommerceAddress address;

  public static final String SERIALIZED_NAME_BANK_PAYMENT_REFERENCE = "bankPaymentReference";
  @SerializedName(SERIALIZED_NAME_BANK_PAYMENT_REFERENCE)
  private String bankPaymentReference;

  public ProfileCommerce() {
  }

  public ProfileCommerce address(ProfileCommerceAddress address) {
  ...
  public ProfileCommerceAddress getAddress() {
    return address;
  }

  public void setAddress(ProfileCommerceAddress address) {
    this.address = address;
  }


  public ProfileCommerce bankPaymentReference(String bankPaymentReference) {
  ...
  public boolean equals(Object o) {
    ...
    ProfileCommerce profileCommerce = (ProfileCommerce) o;
    return Objects.equals(this.address, profileCommerce.address) &&
        Objects.equals(this.bankPaymentReference, profileCommerce.bankPaymentReference);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, bankPaymentReference);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProfileCommerce {\n");
    sb.append("    address: ").append(toIndentedString(address)).append("\n");
    sb.append("    bankPaymentReference: ").append(toIndentedString(bankPaymentReference)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("bankPaymentReference");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProfileCommerce
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProfileCommerce.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProfileCommerce is not found in the empty JSON string", ProfileCommerce.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProfileCommerce.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProfileCommerce` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `address`
      if (jsonObj.get("address") != null && !jsonObj.get("address").isJsonNull()) {
        ProfileCommerceAddress.validateJsonElement(jsonObj.get("address"));
      }
      if ((jsonObj.get("bankPaymentReference") != null && !jsonObj.get("bankPaymentReference").isJsonNull()) && !jsonObj.get("bankPaymentReference").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `bankPaymentReference` to be a primitive type in the JSON string but got `%s`", jsonObj.get("bankPaymentReference").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProfileCommerce.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProfileCommerce' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProfileCommerce> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProfileCommerce.class));

       return (TypeAdapter<T>) new TypeAdapter<ProfileCommerce>() {
           @Override
           public void write(JsonWriter out, ProfileCommerce value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProfileCommerce read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProfileCommerce given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProfileCommerce
   * @throws IOException if the JSON string is invalid with respect to ProfileCommerce
   */
  public static ProfileCommerce fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProfileCommerce.class);
  }

  /**
   * Convert an instance of ProfileCommerce to an JSON string
   *
   * @return JSON string
   */
