...
public class PreSignInfoFieldsInner {
  ...
  public PreSignInfoFieldsInner() {
  }

  public PreSignInfoFieldsInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PreSignInfoFieldsInner value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PreSignInfoFieldsInner preSignInfoFieldsInner = (PreSignInfoFieldsInner) o;
    return Objects.equals(this.name, preSignInfoFieldsInner.name) &&
        Objects.equals(this.value, preSignInfoFieldsInner.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class PreSignInfoFieldsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PreSignInfoFieldsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PreSignInfoFieldsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PreSignInfoFieldsInner is not found in the empty JSON string", PreSignInfoFieldsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PreSignInfoFieldsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PreSignInfoFieldsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PreSignInfoFieldsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PreSignInfoFieldsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PreSignInfoFieldsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PreSignInfoFieldsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PreSignInfoFieldsInner>() {
           @Override
           public void write(JsonWriter out, PreSignInfoFieldsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PreSignInfoFieldsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PreSignInfoFieldsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PreSignInfoFieldsInner
   * @throws IOException if the JSON string is invalid with respect to PreSignInfoFieldsInner
   */
  public static PreSignInfoFieldsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PreSignInfoFieldsInner.class);
  }

  /**
   * Convert an instance of PreSignInfoFieldsInner to an JSON string
   *
   * @return JSON string
   */
