...
/**
 * Model tests for MessageSubmission
 */
public class MessageSubmissionTest {
    private final MessageSubmission model = new MessageSubmission();
