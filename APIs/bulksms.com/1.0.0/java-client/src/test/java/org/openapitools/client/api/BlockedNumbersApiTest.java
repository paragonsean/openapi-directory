...
/**
 * API tests for BlockedNumbersApi
 */
@Disabled
public class BlockedNumbersApiTest {

    private final BlockedNumbersApi api = new BlockedNumbersApi();
     ...
     */
    @Test
    public void blockedNumbersGetTest() throws ApiException {
        Integer minId = null;
        Integer limit = null;
        BlockedNumber response = api.blockedNumbersGet(minId, limit);
     ...
     */
    @Test
    public void blockedNumbersPostTest() throws ApiException {
        List<String> requestBody = null;
        api.blockedNumbersPost(requestBody);
        // TODO: test validations
    }
