...
|**creditCost** | **Float** | The cost of the message (in credits).   Note that this field does not have a value in the submission response. |  [optional] |
|**encoding** | [**EncodingEnum**](#EncodingEnum) | The type of the content.  See the &#x60;encoding&#x60; field for more information. |  [optional] |
...
|**messageClass** | **Integer** | See the &#x60;messageClass&#x60; field for more information. |  [optional] |
|**numberOfParts** | **Integer** | The number of parts.  If this is a concatenated message, the number of parts will be more than 1.  Note that this field does not have a value in the submission response. |  [optional] |
|**protocolId** | **Integer** | See the &#x60;protocolId&#x60; field for more information. |  [optional] |
...
|**type** | [**TypeEnum**](#TypeEnum) | The message direction |  |
