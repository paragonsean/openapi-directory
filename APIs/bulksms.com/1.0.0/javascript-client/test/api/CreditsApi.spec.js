...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.CreditsApi();
  });
  ...
  describe('CreditsApi', function() {
    describe('creditTransferPost', function() {
      it('should call creditTransferPost successfully', function(done) {
        //uncomment below and update the code to test creditTransferPost
        //instance.creditTransferPost(function(error) {
