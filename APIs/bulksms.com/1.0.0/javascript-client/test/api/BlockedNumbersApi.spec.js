...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.BlockedNumbersApi();
  });
  ...
  describe('BlockedNumbersApi', function() {
    describe('blockedNumbersGet', function() {
      it('should call blockedNumbersGet successfully', function(done) {
        //uncomment below and update the code to test blockedNumbersGet
        //instance.blockedNumbersGet(function(error) {
    ...
    describe('blockedNumbersPost', function() {
      it('should call blockedNumbersPost successfully', function(done) {
        //uncomment below and update the code to test blockedNumbersPost
        //instance.blockedNumbersPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
