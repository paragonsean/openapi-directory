...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.AttachmentsApi();
  });
  ...
  describe('AttachmentsApi', function() {
    describe('rmmPreSignAttachmentPost', function() {
      it('should call rmmPreSignAttachmentPost successfully', function(done) {
        //uncomment below and update the code to test rmmPreSignAttachmentPost
        //instance.rmmPreSignAttachmentPost(function(error) {
