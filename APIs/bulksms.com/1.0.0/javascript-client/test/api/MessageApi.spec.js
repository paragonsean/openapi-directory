...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.MessageApi();
  });
  ...
  describe('MessageApi', function() {
    ...
    describe('messagesIdRelatedReceivedMessagesGet', function() {
      it('should call messagesIdRelatedReceivedMessagesGet successfully', function(done) {
        //uncomment below and update the code to test messagesIdRelatedReceivedMessagesGet
        //instance.messagesIdRelatedReceivedMessagesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('messagesSendGet', function() {
      it('should call messagesSendGet successfully', function(done) {
        //uncomment below and update the code to test messagesSendGet
        //instance.messagesSendGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
