...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.ProfileCommerce();
  });
  ...
  describe('ProfileCommerce', function() {
    it('should create an instance of ProfileCommerce', function() {
      // uncomment below and update the code to test ProfileCommerce
      //var instance = new BulkSmsJsonRestApi.ProfileCommerce();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.ProfileCommerce);
    });
    ...
    it('should have the property bankPaymentReference (base name: "bankPaymentReference")', function() {
      // uncomment below and update the code to test the property bankPaymentReference
      //var instance = new BulkSmsJsonRestApi.ProfileCommerce();
      //expect(instance).to.be();
    });
