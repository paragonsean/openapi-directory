...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.TransferEntry();
  });
  ...
  describe('TransferEntry', function() {
    it('should create an instance of TransferEntry', function() {
      ...
      //var instance = new BulkSmsJsonRestApi.TransferEntry();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.TransferEntry);
    });

    it('should have the property commentOnFrom (base name: "commentOnFrom")', function() {
      // uncomment below and update the code to test the property commentOnFrom
      //var instance = new BulkSmsJsonRestApi.TransferEntry();
      //expect(instance).to.be();
    });

    it('should have the property commentOnTo (base name: "commentOnTo")', function() {
      // uncomment below and update the code to test the property commentOnTo
      //var instance = new BulkSmsJsonRestApi.TransferEntry();
      //expect(instance).to.be();
    });
    ...
    it('should have the property toUsername (base name: "toUsername")', function() {
      // uncomment below and update the code to test the property toUsername
      //var instance = new BulkSmsJsonRestApi.TransferEntry();
      //expect(instance).to.be();
    });
