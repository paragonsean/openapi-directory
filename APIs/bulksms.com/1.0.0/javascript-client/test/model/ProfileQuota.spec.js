...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.ProfileQuota();
  });
  ...
  describe('ProfileQuota', function() {
    it('should create an instance of ProfileQuota', function() {
      // uncomment below and update the code to test ProfileQuota
      //var instance = new BulkSmsJsonRestApi.ProfileQuota();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.ProfileQuota);
    });
