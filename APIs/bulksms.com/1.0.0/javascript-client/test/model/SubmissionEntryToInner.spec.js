...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.SubmissionEntryToInner();
  });
  ...
  describe('SubmissionEntryToInner', function() {
    it('should create an instance of SubmissionEntryToInner', function() {
      // uncomment below and update the code to test SubmissionEntryToInner
      //var instance = new BulkSmsJsonRestApi.SubmissionEntryToInner();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.SubmissionEntryToInner);
    });
