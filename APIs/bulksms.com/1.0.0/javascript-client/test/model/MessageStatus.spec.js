...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.MessageStatus();
  });
  ...
  describe('MessageStatus', function() {
    it('should create an instance of MessageStatus', function() {
      ...
      //var instance = new BulkSmsJsonRestApi.MessageStatus();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.MessageStatus);
    });
