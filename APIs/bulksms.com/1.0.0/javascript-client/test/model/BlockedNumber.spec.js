...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.BlockedNumber();
  });
  ...
  describe('BlockedNumber', function() {
    it('should create an instance of BlockedNumber', function() {
      // uncomment below and update the code to test BlockedNumber
      //var instance = new BulkSmsJsonRestApi.BlockedNumber();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.BlockedNumber);
    });
