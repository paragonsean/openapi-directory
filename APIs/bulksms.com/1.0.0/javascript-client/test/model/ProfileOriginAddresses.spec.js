...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.ProfileOriginAddresses();
  });
  ...
  describe('ProfileOriginAddresses', function() {
    it('should create an instance of ProfileOriginAddresses', function() {
      // uncomment below and update the code to test ProfileOriginAddresses
      //var instance = new BulkSmsJsonRestApi.ProfileOriginAddresses();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.ProfileOriginAddresses);
    });
    ...
    it('should have the property isFullControlAllowed (base name: "isFullControlAllowed")', function() {
      // uncomment below and update the code to test the property isFullControlAllowed
      //var instance = new BulkSmsJsonRestApi.ProfileOriginAddresses();
      //expect(instance).to.be();
    });
