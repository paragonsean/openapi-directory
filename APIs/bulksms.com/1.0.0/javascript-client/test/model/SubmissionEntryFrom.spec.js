...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.SubmissionEntryFrom();
  });
  ...
  describe('SubmissionEntryFrom', function() {
    it('should create an instance of SubmissionEntryFrom', function() {
      // uncomment below and update the code to test SubmissionEntryFrom
      //var instance = new BulkSmsJsonRestApi.SubmissionEntryFrom();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.SubmissionEntryFrom);
    });
