...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.ProfileCredits();
  });
  ...
  describe('ProfileCredits', function() {
    it('should create an instance of ProfileCredits', function() {
      // uncomment below and update the code to test ProfileCredits
      //var instance = new BulkSmsJsonRestApi.ProfileCredits();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.ProfileCredits);
    });
    ...
    it('should have the property isTransferAllowed (base name: "isTransferAllowed")', function() {
      // uncomment below and update the code to test the property isTransferAllowed
      //var instance = new BulkSmsJsonRestApi.ProfileCredits();
      //expect(instance).to.be();
    });
