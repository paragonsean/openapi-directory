...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.MessageSubmission();
  });
  ...
  describe('MessageSubmission', function() {
    it('should create an instance of MessageSubmission', function() {
      // uncomment below and update the code to test MessageSubmission
      //var instance = new BulkSmsJsonRestApi.MessageSubmission();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.MessageSubmission);
    });
