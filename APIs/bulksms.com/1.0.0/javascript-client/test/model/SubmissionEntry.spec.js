...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.SubmissionEntry();
  });
  ...
  describe('SubmissionEntry', function() {
    it('should create an instance of SubmissionEntry', function() {
      // uncomment below and update the code to test SubmissionEntry
      //var instance = new BulkSmsJsonRestApi.SubmissionEntry();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.SubmissionEntry);
    });
    ...
    it('should have the property deliveryReports (base name: "deliveryReports")', function() {
    ...
    it('should have the property longMessageMaxParts (base name: "longMessageMaxParts")', function() {
      // uncomment below and update the code to test the property longMessageMaxParts
      //var instance = new BulkSmsJsonRestApi.SubmissionEntry();
      //expect(instance).to.be();
    });
    ...
    it('should have the property protocolId (base name: "protocolId")', function() {
      // uncomment below and update the code to test the property protocolId
      //var instance = new BulkSmsJsonRestApi.SubmissionEntry();
      //expect(instance).to.be();
    });

    it('should have the property routingGroup (base name: "routingGroup")', function() {
      // uncomment below and update the code to test the property routingGroup
      //var instance = new BulkSmsJsonRestApi.SubmissionEntry();
      //expect(instance).to.be();
    });
    ...
    it('should have the property userSuppliedId (base name: "userSuppliedId")', function() {
      // uncomment below and update the code to test the property userSuppliedId
      //var instance = new BulkSmsJsonRestApi.SubmissionEntry();
      //expect(instance).to.be();
    });
