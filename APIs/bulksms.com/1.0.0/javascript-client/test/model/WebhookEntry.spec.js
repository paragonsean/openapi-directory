...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.WebhookEntry();
  });
  ...
  describe('WebhookEntry', function() {
    it('should create an instance of WebhookEntry', function() {
      // uncomment below and update the code to test WebhookEntry
      //var instance = new BulkSmsJsonRestApi.WebhookEntry();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.WebhookEntry);
    });
    ...
    it('should have the property invokeOption (base name: "invokeOption")', function() {
      // uncomment below and update the code to test the property invokeOption
      //var instance = new BulkSmsJsonRestApi.WebhookEntry();
      //expect(instance).to.be();
    });
    ...
    it('should have the property onWebApp (base name: "onWebApp")', function() {
      // uncomment below and update the code to test the property onWebApp
      //var instance = new BulkSmsJsonRestApi.WebhookEntry();
      //expect(instance).to.be();
    });

    it('should have the property triggerScope (base name: "triggerScope")', function() {
      // uncomment below and update the code to test the property triggerScope
      //var instance = new BulkSmsJsonRestApi.WebhookEntry();
      //expect(instance).to.be();
    });
