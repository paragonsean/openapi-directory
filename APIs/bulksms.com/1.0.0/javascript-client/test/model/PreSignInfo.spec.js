...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.PreSignInfo();
  });
  ...
  describe('PreSignInfo', function() {
    it('should create an instance of PreSignInfo', function() {
      // uncomment below and update the code to test PreSignInfo
      //var instance = new BulkSmsJsonRestApi.PreSignInfo();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.PreSignInfo);
    });
    ...
    it('should have the property putUrl (base name: "putUrl")', function() {
      // uncomment below and update the code to test the property putUrl
      //var instance = new BulkSmsJsonRestApi.PreSignInfo();
      //expect(instance).to.be();
    });
