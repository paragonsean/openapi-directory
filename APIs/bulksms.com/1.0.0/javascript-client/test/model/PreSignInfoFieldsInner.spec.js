...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.BulkSmsJsonRestApi);
  }
}(this, function(expect, BulkSmsJsonRestApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.PreSignInfoFieldsInner();
  });
  ...
  describe('PreSignInfoFieldsInner', function() {
    it('should create an instance of PreSignInfoFieldsInner', function() {
      // uncomment below and update the code to test PreSignInfoFieldsInner
      //var instance = new BulkSmsJsonRestApi.PreSignInfoFieldsInner();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.PreSignInfoFieldsInner);
    });
