...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.ProfileCompany();
  });
  ...
  describe('ProfileCompany', function() {
    it('should create an instance of ProfileCompany', function() {
      // uncomment below and update the code to test ProfileCompany
      //var instance = new BulkSmsJsonRestApi.ProfileCompany();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.ProfileCompany);
    });
    ...
    it('should have the property taxReference (base name: "taxReference")', function() {
      // uncomment below and update the code to test the property taxReference
      //var instance = new BulkSmsJsonRestApi.ProfileCompany();
      //expect(instance).to.be();
    });
