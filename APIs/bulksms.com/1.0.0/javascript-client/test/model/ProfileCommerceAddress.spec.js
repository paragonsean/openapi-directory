...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.ProfileCommerceAddress();
  });
  ...
  describe('ProfileCommerceAddress', function() {
    it('should create an instance of ProfileCommerceAddress', function() {
      // uncomment below and update the code to test ProfileCommerceAddress
      //var instance = new BulkSmsJsonRestApi.ProfileCommerceAddress();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.ProfileCommerceAddress);
    });
