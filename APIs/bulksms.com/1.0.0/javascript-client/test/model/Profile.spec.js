...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.Profile();
  });
  ...
  describe('Profile', function() {
    it('should create an instance of Profile', function() {
      ...
      //var instance = new BulkSmsJsonRestApi.Profile();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.Profile);
    });

    it('should have the property commerce (base name: "commerce")', function() {
      // uncomment below and update the code to test the property commerce
      //var instance = new BulkSmsJsonRestApi.Profile();
    ...
    it('should have the property originAddresses (base name: "originAddresses")', function() {
      // uncomment below and update the code to test the property originAddresses
      //var instance = new BulkSmsJsonRestApi.Profile();
      //expect(instance).to.be();
    });
