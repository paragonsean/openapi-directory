...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BulkSmsJsonRestApi.PreSignRequest();
  });
  ...
  describe('PreSignRequest', function() {
    it('should create an instance of PreSignRequest', function() {
      // uncomment below and update the code to test PreSignRequest
      //var instance = new BulkSmsJsonRestApi.PreSignRequest();
      //expect(instance).to.be.a(BulkSmsJsonRestApi.PreSignRequest);
    });
