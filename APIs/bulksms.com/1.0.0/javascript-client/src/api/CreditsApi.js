...
export default class CreditsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the creditTransferPost operation.
     * @callback module:api/CreditsApi~creditTransferPostCallback
     ...
     * @param {module:model/TransferEntry} transferEntry Contains details of the transfer request. 
     * @param {module:api/CreditsApi~creditTransferPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
    creditTransferPost(transferEntry, callback) {
      let postBody = transferEntry;
      // verify the required parameter 'transferEntry' is set
      if (transferEntry === undefined || transferEntry === null) {
        throw new Error("Missing the required parameter 'transferEntry' when calling creditTransferPost");
      }
