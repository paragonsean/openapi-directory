...
export default class AttachmentsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the rmmPreSignAttachmentPost operation.
     * @callback module:api/AttachmentsApi~rmmPreSignAttachmentPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PreSignInfo} data The data returned by the service call.
     ...
     * @param {module:model/PreSignRequest} preSignRequest Describes the file to upload
     * @param {module:api/AttachmentsApi~rmmPreSignAttachmentPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PreSignInfo}
     */
    rmmPreSignAttachmentPost(preSignRequest, callback) {
      let postBody = preSignRequest;
      // verify the required parameter 'preSignRequest' is set
      if (preSignRequest === undefined || preSignRequest === null) {
        throw new Error("Missing the required parameter 'preSignRequest' when calling rmmPreSignAttachmentPost");
      }
      ...
      let returnType = PreSignInfo;
      return this.apiClient.callApi(
        '/rmm/pre-sign-attachment', 'POST',
