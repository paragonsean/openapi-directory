...
/**
 * The PreSignInfoFieldsInner model module.
 * @module model/PreSignInfoFieldsInner
 * @version 1.0.0
 */
class PreSignInfoFieldsInner {
    /**
     * Constructs a new <code>PreSignInfoFieldsInner</code>.
     * @alias module:model/PreSignInfoFieldsInner
     */
    constructor() { 
        
        PreSignInfoFieldsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PreSignInfoFieldsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PreSignInfoFieldsInner} obj Optional instance to populate.
     * @return {module:model/PreSignInfoFieldsInner} The populated <code>PreSignInfoFieldsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PreSignInfoFieldsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>PreSignInfoFieldsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PreSignInfoFieldsInner</code>.
     */
 ...
 * @member {String} name
 */
PreSignInfoFieldsInner.prototype['name'] = undefined;

/**
 * The header value
 * @member {String} value
 */
PreSignInfoFieldsInner.prototype['value'] = undefined;
...
export default PreSignInfoFieldsInner;
