...
class TransferEntry {
     ...
     * @param credits {Number} The amount of credits to transfer. 
     * @param toUserId {Number} The numeric user ID of the account that will receive the credits. The ID must match the username. 
     * @param toUsername {String} The username of the account that will receive the credits. 
     */
    constructor(credits, toUserId, toUsername) { 
        
        TransferEntry.initialize(this, credits, toUserId, toUsername);
    }
     ...
     */
    static initialize(obj, credits, toUserId, toUsername) { 
        obj['credits'] = credits;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransferEntry();

            if (data.hasOwnProperty('commentOnFrom')) {
                obj['commentOnFrom'] = ApiClient.convertToType(data['commentOnFrom'], 'String');
            }
            if (data.hasOwnProperty('commentOnTo')) {
                obj['commentOnTo'] = ApiClient.convertToType(data['commentOnTo'], 'String');
            }
            if (data.hasOwnProperty('credits')) {
                obj['credits'] = ApiClient.convertToType(data['credits'], 'Number');
            }
            if (data.hasOwnProperty('toUserId')) {
                obj['toUserId'] = ApiClient.convertToType(data['toUserId'], 'Number');
            }
            if (data.hasOwnProperty('toUsername')) {
                obj['toUsername'] = ApiClient.convertToType(data['toUsername'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TransferEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransferEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransferEntry.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['commentOnFrom'] && !(typeof data['commentOnFrom'] === 'string' || data['commentOnFrom'] instanceof String)) {
            throw new Error("Expected the field `commentOnFrom` to be a primitive type in the JSON string but got " + data['commentOnFrom']);
        }
        // ensure the json data is a string
        if (data['commentOnTo'] && !(typeof data['commentOnTo'] === 'string' || data['commentOnTo'] instanceof String)) {
            throw new Error("Expected the field `commentOnTo` to be a primitive type in the JSON string but got " + data['commentOnTo']);
        }
        // ensure the json data is a string
        if (data['toUsername'] && !(typeof data['toUsername'] === 'string' || data['toUsername'] instanceof String)) {
            throw new Error("Expected the field `toUsername` to be a primitive type in the JSON string but got " + data['toUsername']);
        }
...
TransferEntry.RequiredProperties = ["credits", "toUserId", "toUsername"];

/**
 * An optional note that will be shown on the credit history of your account. The maximum length of the comment is 100. 
 * @member {String} commentOnFrom
 */
TransferEntry.prototype['commentOnFrom'] = undefined;
