...
/**
 * The MessageSubmission model module.
 * @module model/MessageSubmission
 * @version 1.0.0
 */
class MessageSubmission {
    /**
     * Constructs a new <code>MessageSubmission</code>.
     * Identifies the submission. 
     * @alias module:model/MessageSubmission
     * @param date {Date} The date and time the submission was processed. If the `type` is RECEIVED, this field reflects the date and time the received message was processed.
     * @param id {String} A unique identity shared by all messages that were created from the same submission. This field should be ignored if the `type` is not SENT.
     */
    constructor(date, id) { 
        
        MessageSubmission.initialize(this, date, id);
    }
    ...
    /**
     * Constructs a <code>MessageSubmission</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageSubmission} obj Optional instance to populate.
     * @return {module:model/MessageSubmission} The populated <code>MessageSubmission</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageSubmission();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageSubmission</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageSubmission</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MessageSubmission.RequiredProperties) {
...
MessageSubmission.RequiredProperties = ["date", "id"];
 ...
 * @member {Date} date
 */
MessageSubmission.prototype['date'] = undefined;
 ...
 * @member {String} id
 */
MessageSubmission.prototype['id'] = undefined;
