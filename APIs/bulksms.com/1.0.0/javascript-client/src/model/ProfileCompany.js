...
/**
 * The ProfileCompany model module.
 * @module model/ProfileCompany
 * @version 1.0.0
 */
class ProfileCompany {
    /**
     * Constructs a new <code>ProfileCompany</code>.
     * @alias module:model/ProfileCompany
     */
    constructor() { 
        
        ProfileCompany.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProfileCompany</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProfileCompany} obj Optional instance to populate.
     * @return {module:model/ProfileCompany} The populated <code>ProfileCompany</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProfileCompany();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('taxReference')) {
                obj['taxReference'] = ApiClient.convertToType(data['taxReference'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProfileCompany</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProfileCompany</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['taxReference'] && !(typeof data['taxReference'] === 'string' || data['taxReference'] instanceof String)) {
            throw new Error("Expected the field `taxReference` to be a primitive type in the JSON string but got " + data['taxReference']);
        }
 ...
 * @member {String} name
 */
ProfileCompany.prototype['name'] = undefined;

/**
 * @member {String} taxReference
 */
ProfileCompany.prototype['taxReference'] = undefined;
