...
/**
 * The ProfileCredits model module.
 * @module model/ProfileCredits
 * @version 1.0.0
 */
class ProfileCredits {
    /**
     * Constructs a new <code>ProfileCredits</code>.
     * @alias module:model/ProfileCredits
     */
    constructor() { 
        
        ProfileCredits.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProfileCredits</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProfileCredits} obj Optional instance to populate.
     * @return {module:model/ProfileCredits} The populated <code>ProfileCredits</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProfileCredits();

            if (data.hasOwnProperty('balance')) {
                obj['balance'] = ApiClient.convertToType(data['balance'], 'Number');
            }
            if (data.hasOwnProperty('isTransferAllowed')) {
                obj['isTransferAllowed'] = ApiClient.convertToType(data['isTransferAllowed'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ProfileCredits</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProfileCredits</code>.
     */
 ...
 */
ProfileCredits.prototype['balance'] = undefined;

/**
 * @member {Boolean} isTransferAllowed
 */
ProfileCredits.prototype['isTransferAllowed'] = undefined;

/**
 * @member {Number} limit
 */
ProfileCredits.prototype['limit'] = undefined;
