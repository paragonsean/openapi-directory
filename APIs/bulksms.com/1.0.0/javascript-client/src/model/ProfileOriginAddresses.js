...
/**
 * The ProfileOriginAddresses model module.
 * @module model/ProfileOriginAddresses
 * @version 1.0.0
 */
class ProfileOriginAddresses {
    /**
     * Constructs a new <code>ProfileOriginAddresses</code>.
     * @alias module:model/ProfileOriginAddresses
     */
    constructor() { 
        
        ProfileOriginAddresses.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProfileOriginAddresses</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProfileOriginAddresses} obj Optional instance to populate.
     * @return {module:model/ProfileOriginAddresses} The populated <code>ProfileOriginAddresses</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProfileOriginAddresses();

            if (data.hasOwnProperty('allowed')) {
                obj['allowed'] = ApiClient.convertToType(data['allowed'], ['String']);
            }
            if (data.hasOwnProperty('isFullControlAllowed')) {
                obj['isFullControlAllowed'] = ApiClient.convertToType(data['isFullControlAllowed'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProfileOriginAddresses</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProfileOriginAddresses</code>.
     */
 ...
 */
ProfileOriginAddresses.prototype['allowed'] = undefined;

/**
 * @member {Boolean} isFullControlAllowed
 */
ProfileOriginAddresses.prototype['isFullControlAllowed'] = undefined;
...
export default ProfileOriginAddresses;
