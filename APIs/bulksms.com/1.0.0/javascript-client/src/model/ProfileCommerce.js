...
import ProfileCommerceAddress from './ProfileCommerceAddress';

/**
 * The ProfileCommerce model module.
 * @module model/ProfileCommerce
 * @version 1.0.0
 */
class ProfileCommerce {
    /**
     * Constructs a new <code>ProfileCommerce</code>.
     * @alias module:model/ProfileCommerce
     */
    constructor() { 
        
        ProfileCommerce.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProfileCommerce</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProfileCommerce} obj Optional instance to populate.
     * @return {module:model/ProfileCommerce} The populated <code>ProfileCommerce</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProfileCommerce();

            if (data.hasOwnProperty('address')) {
                obj['address'] = ProfileCommerceAddress.constructFromObject(data['address']);
            }
            if (data.hasOwnProperty('bankPaymentReference')) {
                obj['bankPaymentReference'] = ApiClient.convertToType(data['bankPaymentReference'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ProfileCommerce</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProfileCommerce</code>.
     */
    static validateJSON(data) {
        // validate the optional field `address`
        if (data['address']) { // data not null
          ProfileCommerceAddress.validateJSON(data['address']);
        }
        // ensure the json data is a string
        if (data['bankPaymentReference'] && !(typeof data['bankPaymentReference'] === 'string' || data['bankPaymentReference'] instanceof String)) {
            throw new Error("Expected the field `bankPaymentReference` to be a primitive type in the JSON string but got " + data['bankPaymentReference']);
        }
...
/**
 * @member {module:model/ProfileCommerceAddress} address
 */
ProfileCommerce.prototype['address'] = undefined;

/**
 * @member {String} bankPaymentReference
 */
ProfileCommerce.prototype['bankPaymentReference'] = undefined;
...
export default ProfileCommerce;
