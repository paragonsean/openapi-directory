...
/**
 * The PreSignRequest model module.
 * @module model/PreSignRequest
 * @version 1.0.0
 */
class PreSignRequest {
    /**
     * Constructs a new <code>PreSignRequest</code>.
     * @alias module:model/PreSignRequest
     */
    constructor() { 
        
        PreSignRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PreSignRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PreSignRequest} obj Optional instance to populate.
     * @return {module:model/PreSignRequest} The populated <code>PreSignRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PreSignRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PreSignRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PreSignRequest</code>.
     */
 ...
 */
PreSignRequest.prototype['fileExtension'] = undefined;
 ...
 */
PreSignRequest.prototype['mediaType'] = undefined;
