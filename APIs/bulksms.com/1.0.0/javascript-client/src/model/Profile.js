...
import ProfileOriginAddresses from './ProfileOriginAddresses';
...
class Profile {
     ...
     * @param created {Date} 
     * @param credits {module:model/ProfileCredits} 
     * @param id {String} 
     * @param quota {module:model/ProfileQuota} 
     * @param username {String} 
     */
    constructor(created, credits, id, quota, username) { 
        
        Profile.initialize(this, created, credits, id, quota, username);
    }
     ...
     */
    static initialize(obj, created, credits, id, quota, username) { 
        obj['created'] = created;
        obj['credits'] = credits;
        obj['id'] = id;
        obj['quota'] = quota;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('commerce')) {
                obj['commerce'] = ProfileCommerce.constructFromObject(data['commerce']);
            }
            if (data.hasOwnProperty('company')) {
                obj['company'] = ProfileCompany.constructFromObject(data['company']);
            }
            if (data.hasOwnProperty('created')) {
                obj['created'] = ApiClient.convertToType(data['created'], 'Date');
            }
            if (data.hasOwnProperty('credits')) {
                obj['credits'] = ProfileCredits.constructFromObject(data['credits']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('originAddresses')) {
                obj['originAddresses'] = ProfileOriginAddresses.constructFromObject(data['originAddresses']);
            }
            if (data.hasOwnProperty('quota')) {
                obj['quota'] = ProfileQuota.constructFromObject(data['quota']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['commerce']) { // data not null
          ProfileCommerce.validateJSON(data['commerce']);
        }
        // validate the optional field `company`
        if (data['company']) { // data not null
          ProfileCompany.validateJSON(data['company']);
        }
        // validate the optional field `credits`
        if (data['credits']) { // data not null
          ProfileCredits.validateJSON(data['credits']);
        }
        // ensure the json data is a string
        if (data['id'] && !(typeof data['id'] === 'string' || data['id'] instanceof String)) {
            throw new Error("Expected the field `id` to be a primitive type in the JSON string but got " + data['id']);
        }
        // validate the optional field `originAddresses`
        if (data['originAddresses']) { // data not null
          ProfileOriginAddresses.validateJSON(data['originAddresses']);
        }
        // validate the optional field `quota`
        if (data['quota']) { // data not null
          ProfileQuota.validateJSON(data['quota']);
        }
        // ensure the json data is a string
...
Profile.RequiredProperties = ["created", "credits", "id", "quota", "username"];

/**
 * @member {module:model/ProfileCommerce} commerce
 */
Profile.prototype['commerce'] = undefined;

/**
 * @member {module:model/ProfileCompany} company
 */
 ...
 * @member {Date} created
 */
Profile.prototype['created'] = undefined;

/**
 * @member {module:model/ProfileCredits} credits
 */
Profile.prototype['credits'] = undefined;
...
/**
 * @member {module:model/ProfileOriginAddresses} originAddresses
 */
Profile.prototype['originAddresses'] = undefined;

/**
 * @member {module:model/ProfileQuota} quota
 */
Profile.prototype['quota'] = undefined;
