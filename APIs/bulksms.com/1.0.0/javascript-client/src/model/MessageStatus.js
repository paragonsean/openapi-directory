...
class MessageStatus {
    ...
    static validateJSON(data) {
        ...
        for (const property of MessageStatus.RequiredProperties) {
...
MessageStatus.RequiredProperties = ["id", "type"];
 ...
 * @member {String} id
 */
MessageStatus.prototype['id'] = undefined;
 ...
 * @member {module:model/MessageStatus.SubtypeEnum} subtype
 */
MessageStatus.prototype['subtype'] = undefined;
 ...
 * @member {module:model/MessageStatus.TypeEnum} type
 */
MessageStatus.prototype['type'] = undefined;
