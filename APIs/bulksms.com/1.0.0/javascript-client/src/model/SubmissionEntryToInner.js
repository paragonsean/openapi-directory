...
/**
 * The SubmissionEntryToInner model module.
 * @module model/SubmissionEntryToInner
 * @version 1.0.0
 */
class SubmissionEntryToInner {
    /**
     * Constructs a new <code>SubmissionEntryToInner</code>.
     * @alias module:model/SubmissionEntryToInner
     */
    constructor() { 
        
        SubmissionEntryToInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SubmissionEntryToInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubmissionEntryToInner} obj Optional instance to populate.
     * @return {module:model/SubmissionEntryToInner} The populated <code>SubmissionEntryToInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubmissionEntryToInner();
    ...
    /**
     * Validates the JSON data with respect to <code>SubmissionEntryToInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubmissionEntryToInner</code>.
     */
 ...
 */
SubmissionEntryToInner.prototype['address'] = undefined;
 ...
 */
SubmissionEntryToInner.prototype['fields'] = undefined;

/**
 * The id of a group in your phonebook.  A value can be given if the `type` is GROUP.
 * @member {String} id
 */
SubmissionEntryToInner.prototype['id'] = undefined;

/**
 * The name of a group in your phonebook. A value can be given if the `type` is GROUP.
 * @member {String} name
 */
SubmissionEntryToInner.prototype['name'] = undefined;

/**
 * Type of the recipient. The default value is INTERNATIONAL.
 * @member {module:model/SubmissionEntryToInner.TypeEnum} type
 */
SubmissionEntryToInner.prototype['type'] = undefined;
 ...
 * @readonly
 */
SubmissionEntryToInner['TypeEnum'] = {
...
export default SubmissionEntryToInner;
