...
/**
 * The BlockedNumber model module.
 * @module model/BlockedNumber
 * @version 1.0.0
 */
class BlockedNumber {
    /**
     * Constructs a new <code>BlockedNumber</code>.
     * @alias module:model/BlockedNumber
     * @param id {Number} A unique identifier that is assigned when the BlockedNumber is created.
     * @param phoneNumber {String} A phone number in E.164 format
     */
    constructor(id, phoneNumber) { 
        
        BlockedNumber.initialize(this, id, phoneNumber);
    }
     ...
     */
    static initialize(obj, id, phoneNumber) { 
        obj['id'] = id;
        obj['phoneNumber'] = phoneNumber;
    }

    /**
     * Constructs a <code>BlockedNumber</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlockedNumber} obj Optional instance to populate.
     * @return {module:model/BlockedNumber} The populated <code>BlockedNumber</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlockedNumber();
    ...
    /**
     * Validates the JSON data with respect to <code>BlockedNumber</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlockedNumber</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BlockedNumber.RequiredProperties) {
...
BlockedNumber.RequiredProperties = ["id", "phoneNumber"];

/**
 * A unique identifier that is assigned when the BlockedNumber is created.
 * @member {Number} id
 */
BlockedNumber.prototype['id'] = undefined;

/**
 * A phone number in E.164 format
 * @member {String} phoneNumber
 */
BlockedNumber.prototype['phoneNumber'] = undefined;
