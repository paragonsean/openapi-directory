...
/**
 * The ProfileCommerceAddress model module.
 * @module model/ProfileCommerceAddress
 * @version 1.0.0
 */
class ProfileCommerceAddress {
    /**
     * Constructs a new <code>ProfileCommerceAddress</code>.
     * @alias module:model/ProfileCommerceAddress
     */
    constructor() { 
        
        ProfileCommerceAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProfileCommerceAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProfileCommerceAddress} obj Optional instance to populate.
     * @return {module:model/ProfileCommerceAddress} The populated <code>ProfileCommerceAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProfileCommerceAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>ProfileCommerceAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProfileCommerceAddress</code>.
     */
 ...
 * @member {String} city
 */
ProfileCommerceAddress.prototype['city'] = undefined;

/**
 * @member {String} country
 */
ProfileCommerceAddress.prototype['country'] = undefined;

/**
 * @member {String} postalCode
 */
ProfileCommerceAddress.prototype['postalCode'] = undefined;

/**
 * @member {String} region
 */
ProfileCommerceAddress.prototype['region'] = undefined;

/**
 * @member {Array.<String>} street
 */
ProfileCommerceAddress.prototype['street'] = undefined;
...
export default ProfileCommerceAddress;
