...
/**
 * The SubmissionEntryFrom model module.
 * @module model/SubmissionEntryFrom
 * @version 1.0.0
 */
class SubmissionEntryFrom {
    /**
     * Constructs a new <code>SubmissionEntryFrom</code>.
    ...
    /**
     * Constructs a <code>SubmissionEntryFrom</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubmissionEntryFrom} obj Optional instance to populate.
     * @return {module:model/SubmissionEntryFrom} The populated <code>SubmissionEntryFrom</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubmissionEntryFrom();
    ...
    /**
     * Validates the JSON data with respect to <code>SubmissionEntryFrom</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubmissionEntryFrom</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SubmissionEntryFrom.RequiredProperties) {
...
SubmissionEntryFrom.RequiredProperties = ["type"];
 ...
 */
SubmissionEntryFrom.prototype['address'] = undefined;

/**
 * The type of the sender id.  If you want BulkSMS to collect replies to this message on your behalf, specify the type as REPLIABLE.  If the recipient is in a country where BulkSMS does not have a local reply number, the reply may incur costs that are more expensive than sending a local SMS in that country. If you operate a service from a shortcode in a locale that allows messaging from such a shortcode, you can specify SHORTCODE for the type. 
 * @member {module:model/SubmissionEntryFrom.TypeEnum} type
 */
SubmissionEntryFrom.prototype['type'] = undefined;
...
export default SubmissionEntryFrom;
