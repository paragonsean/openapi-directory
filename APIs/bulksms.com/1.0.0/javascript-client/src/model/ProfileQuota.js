...
/**
 * The ProfileQuota model module.
 * @module model/ProfileQuota
 * @version 1.0.0
 */
class ProfileQuota {
    /**
     * Constructs a new <code>ProfileQuota</code>.
     * @alias module:model/ProfileQuota
     * @param remaining {Number} The number of messages you can still send today.
     * @param size {Number} The setting that limits the number of messages you can send in a day.
     */
    constructor(remaining, size) { 
        
        ProfileQuota.initialize(this, remaining, size);
    }
     ...
     */
    static initialize(obj, remaining, size) { 
        obj['remaining'] = remaining;
        obj['size'] = size;
    }

    /**
     * Constructs a <code>ProfileQuota</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProfileQuota} obj Optional instance to populate.
     * @return {module:model/ProfileQuota} The populated <code>ProfileQuota</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProfileQuota();
    ...
    /**
     * Validates the JSON data with respect to <code>ProfileQuota</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProfileQuota</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ProfileQuota.RequiredProperties) {
