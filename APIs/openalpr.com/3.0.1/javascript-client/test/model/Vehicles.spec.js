...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenAlprCarCheckApi.Vehicles();
  });
  ...
  describe('Vehicles', function() {
    it('should create an instance of Vehicles', function() {
      // uncomment below and update the code to test Vehicles
      //var instance = new OpenAlprCarCheckApi.Vehicles();
      //expect(instance).to.be.a(OpenAlprCarCheckApi.Vehicles);
    });
