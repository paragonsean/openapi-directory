...
#ifndef OAIVehicles_H
#define OAIVehicles_H
...
class OAIVehicles : public OAIObject {
public:
    OAIVehicles();
    OAIVehicles(QString json);
    ~OAIVehicles() override;
    ...
    OAIVehicle_details getDetails() const;
    void setDetails(const OAIVehicle_details &details);
...
Q_DECLARE_METATYPE(OpenAPI::OAIVehicles)
