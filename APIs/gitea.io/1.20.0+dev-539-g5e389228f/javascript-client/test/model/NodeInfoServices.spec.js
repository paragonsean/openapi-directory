...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.NodeInfoServices();
  });
  ...
  describe('NodeInfoServices', function() {
    it('should create an instance of NodeInfoServices', function() {
      // uncomment below and update the code to test NodeInfoServices
      //var instance = new GiteaApi.NodeInfoServices();
      //expect(instance).to.be.a(GiteaApi.NodeInfoServices);
    });
