...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.NodeInfoSoftware();
  });
  ...
  describe('NodeInfoSoftware', function() {
    it('should create an instance of NodeInfoSoftware', function() {
      // uncomment below and update the code to test NodeInfoSoftware
      //var instance = new GiteaApi.NodeInfoSoftware();
      //expect(instance).to.be.a(GiteaApi.NodeInfoSoftware);
    });
