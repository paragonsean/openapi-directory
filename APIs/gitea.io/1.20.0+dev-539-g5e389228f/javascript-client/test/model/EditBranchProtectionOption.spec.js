...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.EditBranchProtectionOption();
  });
  ...
  describe('EditBranchProtectionOption', function() {
    it('should create an instance of EditBranchProtectionOption', function() {
      // uncomment below and update the code to test EditBranchProtectionOption
      //var instance = new GiteaApi.EditBranchProtectionOption();
      //expect(instance).to.be.a(GiteaApi.EditBranchProtectionOption);
    });
