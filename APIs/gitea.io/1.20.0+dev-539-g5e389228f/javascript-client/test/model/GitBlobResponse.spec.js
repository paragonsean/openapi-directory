...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.GitBlobResponse();
  });
  ...
  describe('GitBlobResponse', function() {
    it('should create an instance of GitBlobResponse', function() {
      // uncomment below and update the code to test GitBlobResponse
      //var instance = new GiteaApi.GitBlobResponse();
      //expect(instance).to.be.a(GiteaApi.GitBlobResponse);
    });
