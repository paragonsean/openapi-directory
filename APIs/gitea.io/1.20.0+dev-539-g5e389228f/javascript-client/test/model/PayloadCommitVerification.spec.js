...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.PayloadCommitVerification();
  });
  ...
  describe('PayloadCommitVerification', function() {
    it('should create an instance of PayloadCommitVerification', function() {
      // uncomment below and update the code to test PayloadCommitVerification
      //var instance = new GiteaApi.PayloadCommitVerification();
      //expect(instance).to.be.a(GiteaApi.PayloadCommitVerification);
    });
