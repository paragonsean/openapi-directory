...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.AddCollaboratorOption();
  });
  ...
  describe('AddCollaboratorOption', function() {
    it('should create an instance of AddCollaboratorOption', function() {
      // uncomment below and update the code to test AddCollaboratorOption
      //var instance = new GiteaApi.AddCollaboratorOption();
      //expect(instance).to.be.a(GiteaApi.AddCollaboratorOption);
    });
