...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.CreateUserOption();
  });
  ...
  describe('CreateUserOption', function() {
    it('should create an instance of CreateUserOption', function() {
      // uncomment below and update the code to test CreateUserOption
      //var instance = new GiteaApi.CreateUserOption();
      //expect(instance).to.be.a(GiteaApi.CreateUserOption);
    });
