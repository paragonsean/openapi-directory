...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.WatchInfo();
  });
  ...
  describe('WatchInfo', function() {
    it('should create an instance of WatchInfo', function() {
      // uncomment below and update the code to test WatchInfo
      //var instance = new GiteaApi.WatchInfo();
      //expect(instance).to.be.a(GiteaApi.WatchInfo);
    });
