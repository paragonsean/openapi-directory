...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.EditPullRequestOption();
  });
  ...
  describe('EditPullRequestOption', function() {
    it('should create an instance of EditPullRequestOption', function() {
      // uncomment below and update the code to test EditPullRequestOption
      //var instance = new GiteaApi.EditPullRequestOption();
      //expect(instance).to.be.a(GiteaApi.EditPullRequestOption);
    });
