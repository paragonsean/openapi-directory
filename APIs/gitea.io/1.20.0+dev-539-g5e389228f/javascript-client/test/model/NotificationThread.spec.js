...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.NotificationThread();
  });
  ...
  describe('NotificationThread', function() {
    it('should create an instance of NotificationThread', function() {
      // uncomment below and update the code to test NotificationThread
      //var instance = new GiteaApi.NotificationThread();
      //expect(instance).to.be.a(GiteaApi.NotificationThread);
    });
