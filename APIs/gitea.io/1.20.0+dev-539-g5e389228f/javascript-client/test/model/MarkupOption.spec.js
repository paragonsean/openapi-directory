...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.MarkupOption();
  });
  ...
  describe('MarkupOption', function() {
    it('should create an instance of MarkupOption', function() {
      // uncomment below and update the code to test MarkupOption
      //var instance = new GiteaApi.MarkupOption();
      //expect(instance).to.be.a(GiteaApi.MarkupOption);
    });
