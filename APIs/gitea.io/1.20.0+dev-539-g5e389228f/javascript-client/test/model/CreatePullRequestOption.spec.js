...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.CreatePullRequestOption();
  });
  ...
  describe('CreatePullRequestOption', function() {
    it('should create an instance of CreatePullRequestOption', function() {
      // uncomment below and update the code to test CreatePullRequestOption
      //var instance = new GiteaApi.CreatePullRequestOption();
      //expect(instance).to.be.a(GiteaApi.CreatePullRequestOption);
    });
