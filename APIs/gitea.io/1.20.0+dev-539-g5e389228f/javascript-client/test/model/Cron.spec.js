...
(function(root, factory) {
  ...
  describe('Cron', function() {
    it('should create an instance of Cron', function() {
      ...
      //var instance = new GiteaApi.Cron();
      //expect(instance).to.be.a(GiteaApi.Cron);
    });

    it('should have the property execTimes (base name: "exec_times")', function() {
      // uncomment below and update the code to test the property execTimes
      //var instance = new GiteaApi.Cron();
