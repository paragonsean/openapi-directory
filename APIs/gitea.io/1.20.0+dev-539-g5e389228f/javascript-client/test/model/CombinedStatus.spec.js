...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.CombinedStatus();
  });
  ...
  describe('CombinedStatus', function() {
    it('should create an instance of CombinedStatus', function() {
      // uncomment below and update the code to test CombinedStatus
      //var instance = new GiteaApi.CombinedStatus();
      //expect(instance).to.be.a(GiteaApi.CombinedStatus);
    });
