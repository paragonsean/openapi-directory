...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.FileLinksResponse();
  });
  ...
  describe('FileLinksResponse', function() {
    it('should create an instance of FileLinksResponse', function() {
      // uncomment below and update the code to test FileLinksResponse
      //var instance = new GiteaApi.FileLinksResponse();
      //expect(instance).to.be.a(GiteaApi.FileLinksResponse);
    });
