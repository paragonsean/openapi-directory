...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GiteaApi.EditReleaseOption();
  });
  ...
  describe('EditReleaseOption', function() {
    it('should create an instance of EditReleaseOption', function() {
      // uncomment below and update the code to test EditReleaseOption
      //var instance = new GiteaApi.EditReleaseOption();
      //expect(instance).to.be.a(GiteaApi.EditReleaseOption);
    });
