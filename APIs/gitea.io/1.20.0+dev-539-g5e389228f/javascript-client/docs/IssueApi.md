...
let apiInstance = new GiteaApi.IssueApi();
...
let opts = {
  'issueLabelsOption': new GiteaApi.IssueLabelsOption() // IssueLabelsOption | 
};
...
let index = 789; // Number | index of the issue
let opts = {
  'addTimeOption': new GiteaApi.AddTimeOption() // AddTimeOption | 
};
...
let index = 789; // Number | index of the issue
let opts = {
  'createIssueCommentOption': new GiteaApi.CreateIssueCommentOption() // CreateIssueCommentOption | 
};
...
let repo = "repo_example"; // String | name of the repo
let opts = {
  'createIssueOption': new GiteaApi.CreateIssueOption() // CreateIssueOption | 
};
...
> Attachment issueCreateIssueAttachment(owner, repo, index, attachment, opts)
...
apiInstance.issueCreateIssueAttachment(owner, repo, index, attachment, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Issue issueCreateIssueBlocking(owner, repo, index, opts)
...
let owner = "owner_example"; // String | owner of the repo
let repo = "repo_example"; // String | name of the repo
let index = "index_example"; // String | index of the issue
let opts = {
  'issueMeta': new GiteaApi.IssueMeta() // IssueMeta | 
};
apiInstance.issueCreateIssueBlocking(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Attachment issueCreateIssueCommentAttachment(owner, repo, id, attachment, opts)
...
apiInstance.issueCreateIssueCommentAttachment(owner, repo, id, attachment, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Issue issueCreateIssueDependencies(owner, repo, index, opts)
...
apiInstance.issueCreateIssueDependencies(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let repo = "repo_example"; // String | name of the repo
let opts = {
  'createLabelOption': new GiteaApi.CreateLabelOption() // CreateLabelOption | 
};
...
let repo = "repo_example"; // String | name of the repo
let opts = {
  'createMilestoneOption': new GiteaApi.CreateMilestoneOption() // CreateMilestoneOption | 
};
...
let owner = "owner_example"; // String | owner of the repo
let repo = "repo_example"; // String | name of the repo
let index = 789; // Number | index of issue to delete
apiInstance.issueDelete(owner, repo, index, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> issueDeleteCommentReaction(owner, repo, id, opts)
...
let opts = {
  'editReactionOption': new GiteaApi.EditReactionOption() // EditReactionOption | 
};
apiInstance.issueDeleteCommentReaction(owner, repo, id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.issueDeleteIssueAttachment(owner, repo, index, attachmentId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let id = 789; // Number | id of the comment
let attachmentId = 789; // Number | id of the attachment to delete
apiInstance.issueDeleteIssueCommentAttachment(owner, repo, id, attachmentId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> issueDeleteIssueReaction(owner, repo, index, opts)
...
apiInstance.issueDeleteIssueReaction(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let id = 789; // Number | id of the comment to edit
let opts = {
  'editIssueCommentOption': new GiteaApi.EditIssueCommentOption() // EditIssueCommentOption | 
};
...
let opts = {
  'editIssueOption': new GiteaApi.EditIssueOption() // EditIssueOption | 
};
...
> Attachment issueEditIssueAttachment(owner, repo, index, attachmentId, opts)
...
apiInstance.issueEditIssueAttachment(owner, repo, index, attachmentId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Attachment issueEditIssueCommentAttachment(owner, repo, id, attachmentId, opts)
...
apiInstance.issueEditIssueCommentAttachment(owner, repo, id, attachmentId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let opts = {
  'editDeadlineOption': new GiteaApi.EditDeadlineOption() // EditDeadlineOption | 
};
...
let opts = {
  'editLabelOption': new GiteaApi.EditLabelOption() // EditLabelOption | 
};
...
let opts = {
  'editMilestoneOption': new GiteaApi.EditMilestoneOption() // EditMilestoneOption | 
};
...
> [TimelineComment] issueGetCommentsAndTimeline(owner, repo, index, opts)
...
apiInstance.issueGetCommentsAndTimeline(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.issueGetIssueAttachment(owner, repo, index, attachmentId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let id = 789; // Number | id of the comment
let attachmentId = 789; // Number | id of the attachment to get
apiInstance.issueGetIssueCommentAttachment(owner, repo, id, attachmentId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let repo = "repo_example"; // String | name of the repo
let opts = {
  'state': "state_example", // String | Milestone state, Recognized values are open, closed and all. Defaults to \"open\"
  'name': "name_example", // String | filter by milestone name
  'page': 56, // Number | page number of results to return (1-based)
  'limit': 56 // Number | page size of results
};
apiInstance.issueGetMilestonesList(owner, repo, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Comment] issueGetRepoComments(owner, repo, opts)
...
let repo = "repo_example"; // String | name of the repo
let opts = {
  'since': new Date("2013-10-20T19:20:30+01:00"), // Date | if provided, only comments updated since the provided time are returned.
  'before': new Date("2013-10-20T19:20:30+01:00"), // Date | if provided, only comments updated before the provided time are returned.
  'page': 56, // Number | page number of results to return (1-based)
  'limit': 56 // Number | page size of results
};
apiInstance.issueGetRepoComments(owner, repo, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **owner** | **String**| owner of the repo | 
 **repo** | **String**| name of the repo | 
 **since** | **Date**| if provided, only comments updated since the provided time are returned. | [optional] 
 **before** | **Date**| if provided, only comments updated before the provided time are returned. | [optional] 
 **page** | **Number**| page number of results to return (1-based) | [optional] 
 **limit** | **Number**| page size of results | [optional] 
...
> [Issue] issueListBlocks(owner, repo, index, opts)
...
apiInstance.issueListBlocks(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Attachment] issueListIssueAttachments(owner, repo, index)
...
let repo = "repo_example"; // String | name of the repo
let index = 789; // Number | index of the issue
apiInstance.issueListIssueAttachments(owner, repo, index, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Attachment] issueListIssueCommentAttachments(owner, repo, id)
...
let repo = "repo_example"; // String | name of the repo
let id = 789; // Number | id of the comment
apiInstance.issueListIssueCommentAttachments(owner, repo, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Issue] issueListIssueDependencies(owner, repo, index, opts)
...
apiInstance.issueListIssueDependencies(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Issue] issueListIssues(owner, repo, opts)
...
let opts = {
  ...
  'since': new Date("2013-10-20T19:20:30+01:00"), // Date | Only show items updated after the given time. This is a timestamp in RFC 3339 format
  'before': new Date("2013-10-20T19:20:30+01:00"), // Date | Only show items updated before the given time. This is a timestamp in RFC 3339 format
...
apiInstance.issueListIssues(owner, repo, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **since** | **Date**| Only show items updated after the given time. This is a timestamp in RFC 3339 format | [optional] 
 **before** | **Date**| Only show items updated before the given time. This is a timestamp in RFC 3339 format | [optional] 
...
> [Label] issueListLabels(owner, repo, opts)
...
apiInstance.issueListLabels(owner, repo, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Reaction issuePostCommentReaction(owner, repo, id, opts)
...
apiInstance.issuePostCommentReaction(owner, repo, id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Reaction issuePostIssueReaction(owner, repo, index, opts)
...
apiInstance.issuePostIssueReaction(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Issue issueRemoveIssueBlocking(owner, repo, index, opts)
...
apiInstance.issueRemoveIssueBlocking(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Issue issueRemoveIssueDependencies(owner, repo, index, opts)
...
apiInstance.issueRemoveIssueDependencies(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let repo = "repo_example"; // String | name of the repo
let index = 789; // Number | index of the issue
let id = 789; // Number | id of the label to remove
apiInstance.issueRemoveLabel(owner, repo, index, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> [Label] issueReplaceLabels(owner, repo, index, opts)
...
apiInstance.issueReplaceLabels(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | owner of the repo
let repo = "repo_example"; // String | name of the repo
let index = 789; // Number | index of the issue to add tracked time to
apiInstance.issueResetTime(owner, repo, index, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let opts = {
  ...
  'q': "q_example", // String | search string
  'priorityRepoId': 789, // Number | repository to prioritize in the results
  'type': "type_example", // String | filter by type (issues / pulls) if set
  ...
  'reviewRequested': true, // Boolean | filter pulls requesting your review, default is false
  'reviewed': true, // Boolean | filter pulls reviewed by you, default is false
...
apiInstance.issueSearchIssues(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **q** | **String**| search string | [optional] 
 **priorityRepoId** | **Number**| repository to prioritize in the results | [optional] 
 **type** | **String**| filter by type (issues / pulls) if set | [optional] 
...
let owner = "owner_example"; // String | owner of the repo
let repo = "repo_example"; // String | name of the repo
let index = 789; // Number | index of the issue to create the stopwatch on
apiInstance.issueStartStopWatch(owner, repo, index, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let repo = "repo_example"; // String | name of the repo
let index = 789; // Number | index of the issue to stop the stopwatch on
apiInstance.issueStopStopWatch(owner, repo, index, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> [User] issueSubscriptions(owner, repo, index, opts)
...
apiInstance.issueSubscriptions(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [TrackedTime] issueTrackedTimes(owner, repo, index, opts)
...
apiInstance.issueTrackedTimes(owner, repo, index, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
