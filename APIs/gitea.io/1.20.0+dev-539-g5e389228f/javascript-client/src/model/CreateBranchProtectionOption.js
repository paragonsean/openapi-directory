...
class CreateBranchProtectionOption {
    ...
    constructor() { 
        ...
        CreateBranchProtectionOption.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateBranchProtectionOption</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateBranchProtectionOption</code>.
     */
 ...
 */
CreateBranchProtectionOption.prototype['approvals_whitelist_teams'] = undefined;

/**
 * @member {Array.<String>} approvals_whitelist_username
 */
CreateBranchProtectionOption.prototype['approvals_whitelist_username'] = undefined;

/**
 * @member {Boolean} block_on_official_review_requests
 */
CreateBranchProtectionOption.prototype['block_on_official_review_requests'] = undefined;

/**
 * @member {Boolean} block_on_outdated_branch
 */
CreateBranchProtectionOption.prototype['block_on_outdated_branch'] = undefined;

/**
 * @member {Boolean} block_on_rejected_reviews
 */
CreateBranchProtectionOption.prototype['block_on_rejected_reviews'] = undefined;

/**
 * Deprecated: true
 * @member {String} branch_name
 */
CreateBranchProtectionOption.prototype['branch_name'] = undefined;

/**
 * @member {Boolean} dismiss_stale_approvals
 */
CreateBranchProtectionOption.prototype['dismiss_stale_approvals'] = undefined;

/**
 * @member {Boolean} enable_approvals_whitelist
 */
CreateBranchProtectionOption.prototype['enable_approvals_whitelist'] = undefined;

/**
 * @member {Boolean} enable_merge_whitelist
 */
CreateBranchProtectionOption.prototype['enable_merge_whitelist'] = undefined;

/**
 * @member {Boolean} enable_push
 */
CreateBranchProtectionOption.prototype['enable_push'] = undefined;

/**
 * @member {Boolean} enable_push_whitelist
 */
CreateBranchProtectionOption.prototype['enable_push_whitelist'] = undefined;

/**
 * @member {Boolean} enable_status_check
 */
CreateBranchProtectionOption.prototype['enable_status_check'] = undefined;

/**
 * @member {Array.<String>} merge_whitelist_teams
 */
CreateBranchProtectionOption.prototype['merge_whitelist_teams'] = undefined;

/**
 * @member {Array.<String>} merge_whitelist_usernames
 */
CreateBranchProtectionOption.prototype['merge_whitelist_usernames'] = undefined;

/**
 * @member {String} protected_file_patterns
 */
CreateBranchProtectionOption.prototype['protected_file_patterns'] = undefined;

/**
 * @member {Boolean} push_whitelist_deploy_keys
 */
CreateBranchProtectionOption.prototype['push_whitelist_deploy_keys'] = undefined;

/**
 * @member {Array.<String>} push_whitelist_teams
 */
CreateBranchProtectionOption.prototype['push_whitelist_teams'] = undefined;

/**
 * @member {Array.<String>} push_whitelist_usernames
 */
CreateBranchProtectionOption.prototype['push_whitelist_usernames'] = undefined;

/**
 * @member {Boolean} require_signed_commits
 */
CreateBranchProtectionOption.prototype['require_signed_commits'] = undefined;

/**
 * @member {Number} required_approvals
 */
CreateBranchProtectionOption.prototype['required_approvals'] = undefined;

/**
 * @member {String} rule_name
 */
CreateBranchProtectionOption.prototype['rule_name'] = undefined;

/**
 * @member {Array.<String>} status_check_contexts
 */
CreateBranchProtectionOption.prototype['status_check_contexts'] = undefined;

/**
 * @member {String} unprotected_file_patterns
 */
CreateBranchProtectionOption.prototype['unprotected_file_patterns'] = undefined;
...
export default CreateBranchProtectionOption;
