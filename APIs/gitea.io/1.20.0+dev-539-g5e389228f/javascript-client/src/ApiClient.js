...
class ApiClient {
    ...
    constructor(basePath = '/api/v1') {
        ...
        this.authentications = {
            'AccessToken': {type: 'apiKey', 'in': 'query', name: 'access_token'},
            'AuthorizationHeaderToken': {type: 'apiKey', 'in': 'header', name: 'Authorization'},
            'BasicAuth': {type: 'basic'},
            'SudoHeader': {type: 'apiKey', 'in': 'header', name: 'Sudo'},
            'SudoParam': {type: 'apiKey', 'in': 'query', name: 'sudo'},
            'TOTPHeader': {type: 'apiKey', 'in': 'header', name: 'X-GITEA-OTP'},
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1.20.0+dev-539-g5e389228f/Javascript'
        };
