...
/*
 * OAIUpdateFileOptions.h
 *
 * UpdateFileOptions options for updating files Note: &#x60;author&#x60; and &#x60;committer&#x60; are optional (if only one is given, it will be used for the other, otherwise the authenticated user will be used)
 */

#ifndef OAIUpdateFileOptions_H
#define OAIUpdateFileOptions_H
...
class OAIUpdateFileOptions : public OAIObject {
public:
    OAIUpdateFileOptions();
    OAIUpdateFileOptions(QString json);
    ~OAIUpdateFileOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFileOptions)

#endif // OAIUpdateFileOptions_H
