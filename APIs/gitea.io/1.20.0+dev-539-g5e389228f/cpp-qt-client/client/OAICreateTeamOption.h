...
/*
 * OAICreateTeamOption.h
 *
 * CreateTeamOption options for creating a team
 */

#ifndef OAICreateTeamOption_H
#define OAICreateTeamOption_H
...
class OAICreateTeamOption : public OAIObject {
public:
    OAICreateTeamOption();
    OAICreateTeamOption(QString json);
    ~OAICreateTeamOption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTeamOption)

#endif // OAICreateTeamOption_H
