...
/*
 * OAIUserSettingsOptions.h
 *
 * UserSettingsOptions represents options to change user settings
 */

#ifndef OAIUserSettingsOptions_H
#define OAIUserSettingsOptions_H
...
class OAIUserSettingsOptions : public OAIObject {
public:
    OAIUserSettingsOptions();
    OAIUserSettingsOptions(QString json);
    ~OAIUserSettingsOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserSettingsOptions)

#endif // OAIUserSettingsOptions_H
