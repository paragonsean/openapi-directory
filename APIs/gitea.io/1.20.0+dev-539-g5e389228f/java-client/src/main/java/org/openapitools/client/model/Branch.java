...
import org.openapitools.client.model.PayloadCommit;
...
public class Branch {
  ...
  static {
    ...
    openapiFields.add("effective_branch_protection_name");
    ...
    openapiFields.add("user_can_merge");
    openapiFields.add("user_can_push");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("effective_branch_protection_name") != null && !jsonObj.get("effective_branch_protection_name").isJsonNull()) && !jsonObj.get("effective_branch_protection_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `effective_branch_protection_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("effective_branch_protection_name").toString()));
      }
