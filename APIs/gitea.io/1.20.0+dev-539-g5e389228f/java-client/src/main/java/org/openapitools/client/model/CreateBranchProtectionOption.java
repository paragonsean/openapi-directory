...
public class CreateBranchProtectionOption {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateBranchProtectionOption
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateBranchProtectionOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateBranchProtectionOption is not found in the empty JSON string", CreateBranchProtectionOption.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateBranchProtectionOption.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateBranchProtectionOption` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateBranchProtectionOption.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateBranchProtectionOption' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateBranchProtectionOption> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateBranchProtectionOption.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateBranchProtectionOption>() {
           @Override
           public void write(JsonWriter out, CreateBranchProtectionOption value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateBranchProtectionOption read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateBranchProtectionOption given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateBranchProtectionOption
   * @throws IOException if the JSON string is invalid with respect to CreateBranchProtectionOption
   */
  public static CreateBranchProtectionOption fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateBranchProtectionOption.class);
  }

  /**
   * Convert an instance of CreateBranchProtectionOption to an JSON string
   *
   * @return JSON string
   */
