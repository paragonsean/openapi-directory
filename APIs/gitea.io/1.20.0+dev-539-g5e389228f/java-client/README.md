...
- API version: 1.20.0+dev-539-g5e389228f
  - Build date: 2024-10-12T10:09:48.734827-04:00[America/New_York]
...
<dependency>
  ...
  <version>1.20.0+dev-539-g5e389228f</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:1.20.0+dev-539-g5e389228f"
  }
```
...
* `target/openapi-java-client-1.20.0+dev-539-g5e389228f.jar`
* `target/lib/*.jar`
...
*AdminApi* | [**adminDeleteHook**](docs/AdminApi.md#adminDeleteHook) | **DELETE** /amdin/hooks/{id} | Delete a hook
...
*UserApi* | [**createCurrentUserRepo_0**](docs/UserApi.md#createCurrentUserRepo_0) | **POST** /user/repos | Create a repository
