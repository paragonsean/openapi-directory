...
qint64 OAIQuery::getCount() const {
    return m_count;
}
void OAIQuery::setCount(const qint64 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIQuery::is_count_Set() const{
    return m_count_isSet;
}

bool OAIQuery::is_count_Valid() const{
    return m_count_isValid;
}

OAIQueryFilters OAIQuery::getFilters() const {
    return m_filters;
}
void OAIQuery::setFilters(const OAIQueryFilters &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIQuery::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIQuery::is_filters_Valid() const{
    return m_filters_isValid;
}

OAIQueryOrder OAIQuery::getOrder() const {
    return m_order;
}
void OAIQuery::setOrder(const OAIQueryOrder &order) {
    m_order = order;
    m_order_isSet = true;
}
...
QList<OAIQueryProperty> OAIQuery::getQueryProperties() const {
    return m_query_properties;
}
void OAIQuery::setQueryProperties(const QList<OAIQueryProperty> &query_properties) {
    m_query_properties = query_properties;
    m_query_properties_isSet = true;
}

bool OAIQuery::is_query_properties_Set() const{
    return m_query_properties_isSet;
}

bool OAIQuery::is_query_properties_Valid() const{
    return m_query_properties_isValid;
}

qint64 OAIQuery::getStartIndex() const {
    return m_start_index;
}
void OAIQuery::setStartIndex(const qint64 &start_index) {
    m_start_index = start_index;
    m_start_index_isSet = true;
}

bool OAIQuery::is_start_index_Set() const{
    return m_start_index_isSet;
}

bool OAIQuery::is_start_index_Valid() const{
