...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SliceboxApi.RemoteBox();
  });
  ...
  describe('RemoteBox', function() {
    it('should create an instance of RemoteBox', function() {
      // uncomment below and update the code to test RemoteBox
      //var instance = new SliceboxApi.RemoteBox();
      //expect(instance).to.be.a(SliceboxApi.RemoteBox);
    });
