...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SliceboxApi.FlatSeries();
  });
  ...
  describe('FlatSeries', function() {
    it('should create an instance of FlatSeries', function() {
      // uncomment below and update the code to test FlatSeries
      //var instance = new SliceboxApi.FlatSeries();
      //expect(instance).to.be.a(SliceboxApi.FlatSeries);
    });
