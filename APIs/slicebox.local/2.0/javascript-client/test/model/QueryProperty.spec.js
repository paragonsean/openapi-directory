...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SliceboxApi.QueryProperty();
  });
  ...
  describe('QueryProperty', function() {
    it('should create an instance of QueryProperty', function() {
      // uncomment below and update the code to test QueryProperty
      //var instance = new SliceboxApi.QueryProperty();
      //expect(instance).to.be.a(SliceboxApi.QueryProperty);
    });
