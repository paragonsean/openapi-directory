...
class Example : public QObject {
    Q_OBJECT
    OAIAddUserToAccount_request create();
public Q_SLOTS:
...
OAIAddUserToAccount_request Example::create(){
    OAIAddUserToAccount_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAccountsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAccountsApi::addUserToAccountSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAccountsApi::addUserToAccountSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIAddUserToAccount_request oai_add_user_to_account_request = create(); // OAIAddUserToAccount_request | 
      apiInstance.addUserToAccount(oai_add_user_to_account_request);
