...
#include "OAIGetAccountSegments_200_response.h"
...
OAIGetAccountSegments_200_response::OAIGetAccountSegments_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAccountSegments_200_response::OAIGetAccountSegments_200_response() {
    this->initializeModel();
}

OAIGetAccountSegments_200_response::~OAIGetAccountSegments_200_response() {}

void OAIGetAccountSegments_200_response::initializeModel() {
...
void OAIGetAccountSegments_200_response::fromJson(QString jsonString) {
...
void OAIGetAccountSegments_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetAccountSegments_200_response::asJson() const {
...
QJsonObject OAIGetAccountSegments_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIDeleteAccount_202_response_allOf_meta OAIGetAccountSegments_200_response::getMeta() const {
    return m_meta;
}
void OAIGetAccountSegments_200_response::setMeta(const OAIDeleteAccount_202_response_allOf_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIGetAccountSegments_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIGetAccountSegments_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIGetAccountSegments_200_response_allOf_data_inner> OAIGetAccountSegments_200_response::getData() const {
    return m_data;
}
void OAIGetAccountSegments_200_response::setData(const QList<OAIGetAccountSegments_200_response_allOf_data_inner> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetAccountSegments_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetAccountSegments_200_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIGetAccountSegments_200_response::isSet() const {
...
bool OAIGetAccountSegments_200_response::isValid() const {
