...
#include "OAITrackJourneyEvent_request_identification.h"
...
OAITrackJourneyEvent_request_identification::OAITrackJourneyEvent_request_identification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrackJourneyEvent_request_identification::OAITrackJourneyEvent_request_identification() {
    this->initializeModel();
}

OAITrackJourneyEvent_request_identification::~OAITrackJourneyEvent_request_identification() {}

void OAITrackJourneyEvent_request_identification::initializeModel() {
...
void OAITrackJourneyEvent_request_identification::fromJson(QString jsonString) {
...
void OAITrackJourneyEvent_request_identification::fromJsonObject(QJsonObject json) {
...
QString OAITrackJourneyEvent_request_identification::asJson() const {
...
QJsonObject OAITrackJourneyEvent_request_identification::asJsonObject() const {
    QJsonObject obj;
    if (m_account.isSet()) {
...
OAIDeleteAccount_request_identification OAITrackJourneyEvent_request_identification::getAccount() const {
    return m_account;
}
void OAITrackJourneyEvent_request_identification::setAccount(const OAIDeleteAccount_request_identification &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAITrackJourneyEvent_request_identification::is_account_Set() const{
    return m_account_isSet;
}

bool OAITrackJourneyEvent_request_identification::is_account_Valid() const{
    return m_account_isValid;
}

OAIAddUserToAccount_request_users_inner_identification OAITrackJourneyEvent_request_identification::getUser() const {
    return m_user;
}
void OAITrackJourneyEvent_request_identification::setUser(const OAIAddUserToAccount_request_users_inner_identification &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAITrackJourneyEvent_request_identification::is_user_Set() const{
    return m_user_isSet;
}

bool OAITrackJourneyEvent_request_identification::is_user_Valid() const{
    return m_user_isValid;
}

bool OAITrackJourneyEvent_request_identification::isSet() const {
...
bool OAITrackJourneyEvent_request_identification::isValid() const {
