...
#include "OAITrackJourneyEvent_request.h"
...
OAITrackJourneyEvent_request::OAITrackJourneyEvent_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrackJourneyEvent_request::OAITrackJourneyEvent_request() {
    this->initializeModel();
}

OAITrackJourneyEvent_request::~OAITrackJourneyEvent_request() {}

void OAITrackJourneyEvent_request::initializeModel() {
    ...
    m_triggered_at_isSet = false;
    m_triggered_at_isValid = false;
}

void OAITrackJourneyEvent_request::fromJson(QString jsonString) {
...
void OAITrackJourneyEvent_request::fromJsonObject(QJsonObject json) {
    ...
    m_triggered_at_isValid = ::OpenAPI::fromJsonValue(m_triggered_at, json[QString("triggeredAt")]);
    m_triggered_at_isSet = !json[QString("triggeredAt")].isNull() && m_triggered_at_isValid;
}

QString OAITrackJourneyEvent_request::asJson() const {
...
QJsonObject OAITrackJourneyEvent_request::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_triggered_at_isSet) {
        obj.insert(QString("triggeredAt"), ::OpenAPI::toJsonValue(m_triggered_at));
    }
    return obj;
}

OAITrackJourneyEvent_request_identification OAITrackJourneyEvent_request::getIdentification() const {
    return m_identification;
}
void OAITrackJourneyEvent_request::setIdentification(const OAITrackJourneyEvent_request_identification &identification) {
    m_identification = identification;
    m_identification_isSet = true;
}

bool OAITrackJourneyEvent_request::is_identification_Set() const{
    return m_identification_isSet;
}

bool OAITrackJourneyEvent_request::is_identification_Valid() const{
    return m_identification_isValid;
}

QMap<QString, OAITrackJourneyEvent_request_metadata_value> OAITrackJourneyEvent_request::getMetadata() const {
    return m_metadata;
}
void OAITrackJourneyEvent_request::setMetadata(const QMap<QString, OAITrackJourneyEvent_request_metadata_value> &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAITrackJourneyEvent_request::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAITrackJourneyEvent_request::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAITrackJourneyEvent_request::getName() const {
    return m_name;
}
void OAITrackJourneyEvent_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITrackJourneyEvent_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAITrackJourneyEvent_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAITrackJourneyEvent_request::getTriggeredAt() const {
    return m_triggered_at;
}
void OAITrackJourneyEvent_request::setTriggeredAt(const QString &triggered_at) {
    m_triggered_at = triggered_at;
    m_triggered_at_isSet = true;
}

bool OAITrackJourneyEvent_request::is_triggered_at_Set() const{
    return m_triggered_at_isSet;
}

bool OAITrackJourneyEvent_request::is_triggered_at_Valid() const{
    return m_triggered_at_isValid;
}

bool OAITrackJourneyEvent_request::isSet() const {
...
bool OAITrackJourneyEvent_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_identification_isValid && m_name_isValid && true;
}
