...
#include "OAIGetTrackingSnippet_200_response.h"
...
OAIGetTrackingSnippet_200_response::OAIGetTrackingSnippet_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTrackingSnippet_200_response::OAIGetTrackingSnippet_200_response() {
    this->initializeModel();
}

OAIGetTrackingSnippet_200_response::~OAIGetTrackingSnippet_200_response() {}

void OAIGetTrackingSnippet_200_response::initializeModel() {
...
void OAIGetTrackingSnippet_200_response::fromJson(QString jsonString) {
...
void OAIGetTrackingSnippet_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetTrackingSnippet_200_response::asJson() const {
...
QJsonObject OAIGetTrackingSnippet_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIDeleteAccount_202_response_allOf_meta OAIGetTrackingSnippet_200_response::getMeta() const {
    return m_meta;
}
void OAIGetTrackingSnippet_200_response::setMeta(const OAIDeleteAccount_202_response_allOf_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIGetTrackingSnippet_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIGetTrackingSnippet_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

OAIGetTrackingSnippet_200_response_allOf_data OAIGetTrackingSnippet_200_response::getData() const {
    return m_data;
}
void OAIGetTrackingSnippet_200_response::setData(const OAIGetTrackingSnippet_200_response_allOf_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetTrackingSnippet_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetTrackingSnippet_200_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIGetTrackingSnippet_200_response::isSet() const {
...
bool OAIGetTrackingSnippet_200_response::isValid() const {
