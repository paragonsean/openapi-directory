...
#include "OAIGetEvents_200_response_allOf_data_inner_group.h"
...
OAIGetEvents_200_response_allOf_data_inner_group::OAIGetEvents_200_response_allOf_data_inner_group(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetEvents_200_response_allOf_data_inner_group::OAIGetEvents_200_response_allOf_data_inner_group() {
    this->initializeModel();
}

OAIGetEvents_200_response_allOf_data_inner_group::~OAIGetEvents_200_response_allOf_data_inner_group() {}

void OAIGetEvents_200_response_allOf_data_inner_group::initializeModel() {
...
void OAIGetEvents_200_response_allOf_data_inner_group::fromJson(QString jsonString) {
...
void OAIGetEvents_200_response_allOf_data_inner_group::fromJsonObject(QJsonObject json) {
...
QString OAIGetEvents_200_response_allOf_data_inner_group::asJson() const {
...
QJsonObject OAIGetEvents_200_response_allOf_data_inner_group::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIGetEvents_200_response_allOf_data_inner_group::getId() const {
    return m_id;
}
void OAIGetEvents_200_response_allOf_data_inner_group::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetEvents_200_response_allOf_data_inner_group::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetEvents_200_response_allOf_data_inner_group::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGetEvents_200_response_allOf_data_inner_group::getName() const {
    return m_name;
}
void OAIGetEvents_200_response_allOf_data_inner_group::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetEvents_200_response_allOf_data_inner_group::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetEvents_200_response_allOf_data_inner_group::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIGetEvents_200_response_allOf_data_inner_group::isSet() const {
...
bool OAIGetEvents_200_response_allOf_data_inner_group::isValid() const {
