...
#include "OAIUpsertUser_201_response.h"
...
OAIUpsertUser_201_response::OAIUpsertUser_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpsertUser_201_response::OAIUpsertUser_201_response() {
    this->initializeModel();
}

OAIUpsertUser_201_response::~OAIUpsertUser_201_response() {}

void OAIUpsertUser_201_response::initializeModel() {
...
void OAIUpsertUser_201_response::fromJson(QString jsonString) {
...
void OAIUpsertUser_201_response::fromJsonObject(QJsonObject json) {
...
QString OAIUpsertUser_201_response::asJson() const {
...
QJsonObject OAIUpsertUser_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIDeleteAccount_202_response_allOf_meta OAIUpsertUser_201_response::getMeta() const {
    return m_meta;
}
void OAIUpsertUser_201_response::setMeta(const OAIDeleteAccount_202_response_allOf_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIUpsertUser_201_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIUpsertUser_201_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QString OAIUpsertUser_201_response::getMessage() const {
    return m_message;
}
void OAIUpsertUser_201_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIUpsertUser_201_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAIUpsertUser_201_response::is_message_Valid() const{
    return m_message_isValid;
}

QMap<QString, QString> OAIUpsertUser_201_response::getRejected() const {
    return m_rejected;
}
void OAIUpsertUser_201_response::setRejected(const QMap<QString, QString> &rejected) {
    m_rejected = rejected;
    m_rejected_isSet = true;
}

bool OAIUpsertUser_201_response::is_rejected_Set() const{
    return m_rejected_isSet;
}

bool OAIUpsertUser_201_response::is_rejected_Valid() const{
    return m_rejected_isValid;
}

bool OAIUpsertUser_201_response::isSet() const {
...
bool OAIUpsertUser_201_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_meta_isValid && m_message_isValid && true;
}
