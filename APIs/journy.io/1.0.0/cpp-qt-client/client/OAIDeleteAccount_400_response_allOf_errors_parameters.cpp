...
#include "OAIDeleteAccount_400_response_allOf_errors_parameters.h"
...
OAIDeleteAccount_400_response_allOf_errors_parameters::OAIDeleteAccount_400_response_allOf_errors_parameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAccount_400_response_allOf_errors_parameters::OAIDeleteAccount_400_response_allOf_errors_parameters() {
    this->initializeModel();
}

OAIDeleteAccount_400_response_allOf_errors_parameters::~OAIDeleteAccount_400_response_allOf_errors_parameters() {}

void OAIDeleteAccount_400_response_allOf_errors_parameters::initializeModel() {
...
void OAIDeleteAccount_400_response_allOf_errors_parameters::fromJson(QString jsonString) {
...
void OAIDeleteAccount_400_response_allOf_errors_parameters::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAccount_400_response_allOf_errors_parameters::asJson() const {
...
QJsonObject OAIDeleteAccount_400_response_allOf_errors_parameters::asJsonObject() const {
    QJsonObject obj;
    if (m_header.size() > 0) {
...
QMap<QString, QString> OAIDeleteAccount_400_response_allOf_errors_parameters::getHeader() const {
    return m_header;
}
void OAIDeleteAccount_400_response_allOf_errors_parameters::setHeader(const QMap<QString, QString> &header) {
    m_header = header;
    m_header_isSet = true;
}

bool OAIDeleteAccount_400_response_allOf_errors_parameters::is_header_Set() const{
    return m_header_isSet;
}

bool OAIDeleteAccount_400_response_allOf_errors_parameters::is_header_Valid() const{
    return m_header_isValid;
}

QMap<QString, QString> OAIDeleteAccount_400_response_allOf_errors_parameters::getPath() const {
    return m_path;
}
void OAIDeleteAccount_400_response_allOf_errors_parameters::setPath(const QMap<QString, QString> &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIDeleteAccount_400_response_allOf_errors_parameters::is_path_Set() const{
    return m_path_isSet;
}

bool OAIDeleteAccount_400_response_allOf_errors_parameters::is_path_Valid() const{
    return m_path_isValid;
}

QMap<QString, QString> OAIDeleteAccount_400_response_allOf_errors_parameters::getQuery() const {
    return m_query;
}
void OAIDeleteAccount_400_response_allOf_errors_parameters::setQuery(const QMap<QString, QString> &query) {
    m_query = query;
    m_query_isSet = true;
}

bool OAIDeleteAccount_400_response_allOf_errors_parameters::is_query_Set() const{
    return m_query_isSet;
}

bool OAIDeleteAccount_400_response_allOf_errors_parameters::is_query_Valid() const{
    return m_query_isValid;
}

bool OAIDeleteAccount_400_response_allOf_errors_parameters::isSet() const {
...
bool OAIDeleteAccount_400_response_allOf_errors_parameters::isValid() const {
