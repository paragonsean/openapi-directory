...
OAIWebsitesApi::OAIWebsitesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIWebsitesApi::~OAIWebsitesApi() {
}

void OAIWebsitesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getTrackingSnippet", defaultConf);
    _serverIndices.insert("getTrackingSnippet", 0);
}
...
*/
int OAIWebsitesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIWebsitesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIWebsitesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIWebsitesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIWebsitesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIWebsitesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIWebsitesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIWebsitesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIWebsitesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIWebsitesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIWebsitesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIWebsitesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIWebsitesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIWebsitesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIWebsitesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIWebsitesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIWebsitesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIWebsitesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIWebsitesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIWebsitesApi::getTrackingSnippet(const QString &domain) {
    QString fullPath = QString(_serverConfigs["getTrackingSnippet"][_serverIndices.value("getTrackingSnippet")].URL()+"/tracking/snippet");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebsitesApi::getTrackingSnippetCallback);
    connect(this, &OAIWebsitesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIWebsitesApi::getTrackingSnippetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetTrackingSnippet_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getTrackingSnippetSignal(output);
        Q_EMIT getTrackingSnippetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getTrackingSnippetSignalE(output, error_type, error_str);
        Q_EMIT getTrackingSnippetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getTrackingSnippetSignalError(output, error_type, error_str);
        Q_EMIT getTrackingSnippetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIWebsitesApi::tokenAvailable(){
