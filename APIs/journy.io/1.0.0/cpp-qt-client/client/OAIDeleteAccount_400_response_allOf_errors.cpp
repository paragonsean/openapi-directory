...
#include "OAIDeleteAccount_400_response_allOf_errors.h"
...
OAIDeleteAccount_400_response_allOf_errors::OAIDeleteAccount_400_response_allOf_errors(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAccount_400_response_allOf_errors::OAIDeleteAccount_400_response_allOf_errors() {
    this->initializeModel();
}

OAIDeleteAccount_400_response_allOf_errors::~OAIDeleteAccount_400_response_allOf_errors() {}

void OAIDeleteAccount_400_response_allOf_errors::initializeModel() {
...
void OAIDeleteAccount_400_response_allOf_errors::fromJson(QString jsonString) {
...
void OAIDeleteAccount_400_response_allOf_errors::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAccount_400_response_allOf_errors::asJson() const {
...
QJsonObject OAIDeleteAccount_400_response_allOf_errors::asJsonObject() const {
    QJsonObject obj;
    if (m_fields.size() > 0) {
...
QMap<QString, QString> OAIDeleteAccount_400_response_allOf_errors::getFields() const {
    return m_fields;
}
void OAIDeleteAccount_400_response_allOf_errors::setFields(const QMap<QString, QString> &fields) {
    m_fields = fields;
    m_fields_isSet = true;
}

bool OAIDeleteAccount_400_response_allOf_errors::is_fields_Set() const{
    return m_fields_isSet;
}

bool OAIDeleteAccount_400_response_allOf_errors::is_fields_Valid() const{
    return m_fields_isValid;
}

OAIDeleteAccount_400_response_allOf_errors_parameters OAIDeleteAccount_400_response_allOf_errors::getParameters() const {
    return m_parameters;
}
void OAIDeleteAccount_400_response_allOf_errors::setParameters(const OAIDeleteAccount_400_response_allOf_errors_parameters &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIDeleteAccount_400_response_allOf_errors::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIDeleteAccount_400_response_allOf_errors::is_parameters_Valid() const{
    return m_parameters_isValid;
}

bool OAIDeleteAccount_400_response_allOf_errors::isSet() const {
...
bool OAIDeleteAccount_400_response_allOf_errors::isValid() const {
