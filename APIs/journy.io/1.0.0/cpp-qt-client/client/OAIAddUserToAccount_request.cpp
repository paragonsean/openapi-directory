...
OAIAddUserToAccount_request::OAIAddUserToAccount_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddUserToAccount_request::OAIAddUserToAccount_request() {
    this->initializeModel();
}

OAIAddUserToAccount_request::~OAIAddUserToAccount_request() {}

void OAIAddUserToAccount_request::initializeModel() {
...
void OAIAddUserToAccount_request::fromJson(QString jsonString) {
...
void OAIAddUserToAccount_request::fromJsonObject(QJsonObject json) {
...
QString OAIAddUserToAccount_request::asJson() const {
...
QJsonObject OAIAddUserToAccount_request::asJsonObject() const {
    QJsonObject obj;
    if (m_account.isSet()) {
...
OAIDeleteAccount_request_identification OAIAddUserToAccount_request::getAccount() const {
    return m_account;
}
void OAIAddUserToAccount_request::setAccount(const OAIDeleteAccount_request_identification &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAIAddUserToAccount_request::is_account_Set() const{
    return m_account_isSet;
}

bool OAIAddUserToAccount_request::is_account_Valid() const{
    return m_account_isValid;
}

QList<OAIAddUserToAccount_request_users_inner> OAIAddUserToAccount_request::getUsers() const {
    return m_users;
}
void OAIAddUserToAccount_request::setUsers(const QList<OAIAddUserToAccount_request_users_inner> &users) {
    m_users = users;
    m_users_isSet = true;
}

bool OAIAddUserToAccount_request::is_users_Set() const{
    return m_users_isSet;
}

bool OAIAddUserToAccount_request::is_users_Valid() const{
    return m_users_isValid;
}

bool OAIAddUserToAccount_request::isSet() const {
...
bool OAIAddUserToAccount_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_account_isValid && m_users_isValid && true;
}
