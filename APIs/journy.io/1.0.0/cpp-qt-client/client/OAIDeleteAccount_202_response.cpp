...
OAIDeleteAccount_202_response::OAIDeleteAccount_202_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAccount_202_response::OAIDeleteAccount_202_response() {
    this->initializeModel();
}

OAIDeleteAccount_202_response::~OAIDeleteAccount_202_response() {}

void OAIDeleteAccount_202_response::initializeModel() {
...
void OAIDeleteAccount_202_response::fromJson(QString jsonString) {
...
void OAIDeleteAccount_202_response::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAccount_202_response::asJson() const {
...
QJsonObject OAIDeleteAccount_202_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIDeleteAccount_202_response_allOf_meta OAIDeleteAccount_202_response::getMeta() const {
    return m_meta;
}
void OAIDeleteAccount_202_response::setMeta(const OAIDeleteAccount_202_response_allOf_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIDeleteAccount_202_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIDeleteAccount_202_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QString OAIDeleteAccount_202_response::getMessage() const {
    return m_message;
}
void OAIDeleteAccount_202_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIDeleteAccount_202_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAIDeleteAccount_202_response::is_message_Valid() const{
    return m_message_isValid;
}

bool OAIDeleteAccount_202_response::isSet() const {
...
bool OAIDeleteAccount_202_response::isValid() const {
