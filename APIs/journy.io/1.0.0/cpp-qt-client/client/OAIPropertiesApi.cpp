...
void OAIPropertiesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getAccountProperties", defaultConf);
    _serverIndices.insert("getAccountProperties", 0);
    _serverConfigs.insert("getUserProperties", defaultConf);
    _serverIndices.insert("getUserProperties", 0);
}
...
void OAIPropertiesApi::getAccountProperties() {
    QString fullPath = QString(_serverConfigs["getAccountProperties"][_serverIndices.value("getAccountProperties")].URL()+"/properties/accounts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPropertiesApi::getAccountPropertiesCallback);
...
void OAIPropertiesApi::getAccountPropertiesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetAccountProperties_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAccountPropertiesSignal(output);
        Q_EMIT getAccountPropertiesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAccountPropertiesSignalE(output, error_type, error_str);
        Q_EMIT getAccountPropertiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAccountPropertiesSignalError(output, error_type, error_str);
        Q_EMIT getAccountPropertiesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPropertiesApi::getUserProperties() {
    QString fullPath = QString(_serverConfigs["getUserProperties"][_serverIndices.value("getUserProperties")].URL()+"/properties/users");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPropertiesApi::getUserPropertiesCallback);
    connect(this, &OAIPropertiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPropertiesApi::getUserPropertiesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getUserPropertiesSignal(output);
        Q_EMIT getUserPropertiesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getUserPropertiesSignalE(output, error_type, error_str);
        Q_EMIT getUserPropertiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getUserPropertiesSignalError(output, error_type, error_str);
        Q_EMIT getUserPropertiesSignalErrorFull(worker, error_type, error_str);
    }
}
