...
#include "OAIDeleteAccount_400_response.h"
...
OAIDeleteAccount_400_response::OAIDeleteAccount_400_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAccount_400_response::OAIDeleteAccount_400_response() {
    this->initializeModel();
}

OAIDeleteAccount_400_response::~OAIDeleteAccount_400_response() {}

void OAIDeleteAccount_400_response::initializeModel() {
...
void OAIDeleteAccount_400_response::fromJson(QString jsonString) {
...
void OAIDeleteAccount_400_response::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAccount_400_response::asJson() const {
...
QJsonObject OAIDeleteAccount_400_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIDeleteAccount_202_response_allOf_meta OAIDeleteAccount_400_response::getMeta() const {
    return m_meta;
}
void OAIDeleteAccount_400_response::setMeta(const OAIDeleteAccount_202_response_allOf_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIDeleteAccount_400_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIDeleteAccount_400_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QString OAIDeleteAccount_400_response::getMessage() const {
    return m_message;
}
void OAIDeleteAccount_400_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIDeleteAccount_400_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAIDeleteAccount_400_response::is_message_Valid() const{
    return m_message_isValid;
}

OAIDeleteAccount_400_response_allOf_errors OAIDeleteAccount_400_response::getErrors() const {
    return m_errors;
}
void OAIDeleteAccount_400_response::setErrors(const OAIDeleteAccount_400_response_allOf_errors &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIDeleteAccount_400_response::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIDeleteAccount_400_response::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIDeleteAccount_400_response::isSet() const {
...
bool OAIDeleteAccount_400_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_meta_isValid && m_message_isValid && m_errors_isValid && true;
}
