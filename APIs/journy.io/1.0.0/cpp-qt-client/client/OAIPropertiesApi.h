...
#include "OAIDeleteAccount_202_response.h"
...
public:
    ...
    virtual void getAccountProperties();


    virtual void getUserProperties();
...
private:
    ...
    void getAccountPropertiesCallback(OAIHttpRequestWorker *worker);
    void getUserPropertiesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getAccountPropertiesSignal(OAIGetAccountProperties_200_response summary);
    void getUserPropertiesSignal(OAIGetAccountProperties_200_response summary);


    void getAccountPropertiesSignalFull(OAIHttpRequestWorker *worker, OAIGetAccountProperties_200_response summary);
    void getUserPropertiesSignalFull(OAIHttpRequestWorker *worker, OAIGetAccountProperties_200_response summary);

    Q_DECL_DEPRECATED_X("Use getAccountPropertiesSignalError() instead")
    void getAccountPropertiesSignalE(OAIGetAccountProperties_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccountPropertiesSignalError(OAIGetAccountProperties_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getUserPropertiesSignalError() instead")
    void getUserPropertiesSignalE(OAIGetAccountProperties_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getUserPropertiesSignalError(OAIGetAccountProperties_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getAccountPropertiesSignalErrorFull() instead")
    void getAccountPropertiesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccountPropertiesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getUserPropertiesSignalErrorFull() instead")
    void getUserPropertiesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getUserPropertiesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
