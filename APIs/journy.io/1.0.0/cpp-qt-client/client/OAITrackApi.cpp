...
OAITrackApi::OAITrackApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITrackApi::~OAITrackApi() {
}

void OAITrackApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("trackEvent", defaultConf);
    _serverIndices.insert("trackEvent", 0);
}
...
*/
int OAITrackApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITrackApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITrackApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITrackApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITrackApi::setUsername(const QString &username) {
    _username = username;
}

void OAITrackApi::setPassword(const QString &password) {
    _password = password;
}


void OAITrackApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITrackApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITrackApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITrackApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITrackApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITrackApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITrackApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITrackApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITrackApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITrackApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITrackApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITrackApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITrackApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITrackApi::trackEvent(const OAITrackEvent_request &oai_track_event_request) {
    QString fullPath = QString(_serverConfigs["trackEvent"][_serverIndices.value("trackEvent")].URL()+"/track");
...

    {
        ...
        QByteArray output = oai_track_event_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITrackApi::trackEventCallback);
    connect(this, &OAITrackApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAITrackApi::trackEventCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT trackEventSignal(output);
        Q_EMIT trackEventSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT trackEventSignalE(output, error_type, error_str);
        Q_EMIT trackEventSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT trackEventSignalError(output, error_type, error_str);
        Q_EMIT trackEventSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITrackApi::tokenAvailable(){
