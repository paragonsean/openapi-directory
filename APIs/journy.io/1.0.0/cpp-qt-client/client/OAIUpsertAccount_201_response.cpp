...
#include "OAIUpsertAccount_201_response.h"
...
OAIUpsertAccount_201_response::OAIUpsertAccount_201_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpsertAccount_201_response::OAIUpsertAccount_201_response() {
    this->initializeModel();
}

OAIUpsertAccount_201_response::~OAIUpsertAccount_201_response() {}

void OAIUpsertAccount_201_response::initializeModel() {
...
void OAIUpsertAccount_201_response::fromJson(QString jsonString) {
...
void OAIUpsertAccount_201_response::fromJsonObject(QJsonObject json) {
...
QString OAIUpsertAccount_201_response::asJson() const {
...
QJsonObject OAIUpsertAccount_201_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIDeleteAccount_202_response_allOf_meta OAIUpsertAccount_201_response::getMeta() const {
    return m_meta;
}
void OAIUpsertAccount_201_response::setMeta(const OAIDeleteAccount_202_response_allOf_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIUpsertAccount_201_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIUpsertAccount_201_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QString OAIUpsertAccount_201_response::getMessage() const {
    return m_message;
}
void OAIUpsertAccount_201_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIUpsertAccount_201_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAIUpsertAccount_201_response::is_message_Valid() const{
    return m_message_isValid;
}

QMap<QString, QString> OAIUpsertAccount_201_response::getRejected() const {
    return m_rejected;
}
void OAIUpsertAccount_201_response::setRejected(const QMap<QString, QString> &rejected) {
    m_rejected = rejected;
    m_rejected_isSet = true;
}

bool OAIUpsertAccount_201_response::is_rejected_Set() const{
    return m_rejected_isSet;
}

bool OAIUpsertAccount_201_response::is_rejected_Valid() const{
    return m_rejected_isValid;
}

bool OAIUpsertAccount_201_response::isSet() const {
...
bool OAIUpsertAccount_201_response::isValid() const {
