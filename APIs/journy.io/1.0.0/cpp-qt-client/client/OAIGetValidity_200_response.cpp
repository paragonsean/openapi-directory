...
#include "OAIGetValidity_200_response.h"
...
OAIGetValidity_200_response::OAIGetValidity_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetValidity_200_response::OAIGetValidity_200_response() {
    this->initializeModel();
}

OAIGetValidity_200_response::~OAIGetValidity_200_response() {}

void OAIGetValidity_200_response::initializeModel() {
...
void OAIGetValidity_200_response::fromJson(QString jsonString) {
...
void OAIGetValidity_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetValidity_200_response::asJson() const {
...
QJsonObject OAIGetValidity_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIDeleteAccount_202_response_allOf_meta OAIGetValidity_200_response::getMeta() const {
    return m_meta;
}
void OAIGetValidity_200_response::setMeta(const OAIDeleteAccount_202_response_allOf_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIGetValidity_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIGetValidity_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

OAIGetValidity_200_response_allOf_data OAIGetValidity_200_response::getData() const {
    return m_data;
}
void OAIGetValidity_200_response::setData(const OAIGetValidity_200_response_allOf_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetValidity_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetValidity_200_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIGetValidity_200_response::isSet() const {
...
bool OAIGetValidity_200_response::isValid() const {
