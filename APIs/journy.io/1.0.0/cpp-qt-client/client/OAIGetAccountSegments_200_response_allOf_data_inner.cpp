...
#include "OAIGetAccountSegments_200_response_allOf_data_inner.h"
...
OAIGetAccountSegments_200_response_allOf_data_inner::OAIGetAccountSegments_200_response_allOf_data_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAccountSegments_200_response_allOf_data_inner::OAIGetAccountSegments_200_response_allOf_data_inner() {
    this->initializeModel();
}

OAIGetAccountSegments_200_response_allOf_data_inner::~OAIGetAccountSegments_200_response_allOf_data_inner() {}

void OAIGetAccountSegments_200_response_allOf_data_inner::initializeModel() {
...
void OAIGetAccountSegments_200_response_allOf_data_inner::fromJson(QString jsonString) {
...
void OAIGetAccountSegments_200_response_allOf_data_inner::fromJsonObject(QJsonObject json) {
...
QString OAIGetAccountSegments_200_response_allOf_data_inner::asJson() const {
...
QJsonObject OAIGetAccountSegments_200_response_allOf_data_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIGetAccountSegments_200_response_allOf_data_inner::getId() const {
    return m_id;
}
void OAIGetAccountSegments_200_response_allOf_data_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGetAccountSegments_200_response_allOf_data_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGetAccountSegments_200_response_allOf_data_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGetAccountSegments_200_response_allOf_data_inner::getName() const {
    return m_name;
}
void OAIGetAccountSegments_200_response_allOf_data_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetAccountSegments_200_response_allOf_data_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetAccountSegments_200_response_allOf_data_inner::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIGetAccountSegments_200_response_allOf_data_inner::isSet() const {
...
bool OAIGetAccountSegments_200_response_allOf_data_inner::isValid() const {
