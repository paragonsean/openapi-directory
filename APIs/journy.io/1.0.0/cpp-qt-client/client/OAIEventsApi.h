...
public:
    ...
    /**
    * @param[in]  oai_track_journey_event_request OAITrackJourneyEvent_request [required]
    */
    Q_DECL_DEPRECATED virtual void trackJourneyEvent(const OAITrackJourneyEvent_request &oai_track_journey_event_request);
...
private:
    ...
    void trackJourneyEventCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getEventsSignal(OAIGetEvents_200_response summary);
    void trackJourneyEventSignal(OAIDeleteAccount_202_response summary);


    void getEventsSignalFull(OAIHttpRequestWorker *worker, OAIGetEvents_200_response summary);
    void trackJourneyEventSignalFull(OAIHttpRequestWorker *worker, OAIDeleteAccount_202_response summary);
    ...
    Q_DECL_DEPRECATED_X("Use trackJourneyEventSignalError() instead")
    void trackJourneyEventSignalE(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void trackJourneyEventSignalError(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use trackJourneyEventSignalErrorFull() instead")
    void trackJourneyEventSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void trackJourneyEventSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
