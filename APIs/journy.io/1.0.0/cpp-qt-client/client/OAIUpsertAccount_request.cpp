...
OAIUpsertAccount_request::OAIUpsertAccount_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpsertAccount_request::OAIUpsertAccount_request() {
    this->initializeModel();
}

OAIUpsertAccount_request::~OAIUpsertAccount_request() {}

void OAIUpsertAccount_request::initializeModel() {
...
void OAIUpsertAccount_request::fromJson(QString jsonString) {
...
void OAIUpsertAccount_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpsertAccount_request::asJson() const {
...
QJsonObject OAIUpsertAccount_request::asJsonObject() const {
    QJsonObject obj;
...
OAIDeleteAccount_request_identification OAIUpsertAccount_request::getIdentification() const {
    return m_identification;
}
void OAIUpsertAccount_request::setIdentification(const OAIDeleteAccount_request_identification &identification) {
    m_identification = identification;
    m_identification_isSet = true;
}

bool OAIUpsertAccount_request::is_identification_Set() const{
    return m_identification_isSet;
}

bool OAIUpsertAccount_request::is_identification_Valid() const{
    return m_identification_isValid;
}

QMap<QString, OAIUpsertAccount_request_properties_value> OAIUpsertAccount_request::getProperties() const {
    return m_properties;
}
void OAIUpsertAccount_request::setProperties(const QMap<QString, OAIUpsertAccount_request_properties_value> &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIUpsertAccount_request::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIUpsertAccount_request::is_properties_Valid() const{
    return m_properties_isValid;
}

bool OAIUpsertAccount_request::isSet() const {
...
bool OAIUpsertAccount_request::isValid() const {
