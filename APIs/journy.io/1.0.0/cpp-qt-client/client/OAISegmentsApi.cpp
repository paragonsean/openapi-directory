...
void OAISegmentsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getAccountSegments", defaultConf);
    _serverIndices.insert("getAccountSegments", 0);
    _serverConfigs.insert("getUserSegments", defaultConf);
    _serverIndices.insert("getUserSegments", 0);
}
...
void OAISegmentsApi::getAccountSegments() {
    QString fullPath = QString(_serverConfigs["getAccountSegments"][_serverIndices.value("getAccountSegments")].URL()+"/segments/accounts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISegmentsApi::getAccountSegmentsCallback);
...
void OAISegmentsApi::getAccountSegmentsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetAccountSegments_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getAccountSegmentsSignal(output);
        Q_EMIT getAccountSegmentsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getAccountSegmentsSignalE(output, error_type, error_str);
        Q_EMIT getAccountSegmentsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getAccountSegmentsSignalError(output, error_type, error_str);
        Q_EMIT getAccountSegmentsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISegmentsApi::getUserSegments() {
    QString fullPath = QString(_serverConfigs["getUserSegments"][_serverIndices.value("getUserSegments")].URL()+"/segments/users");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISegmentsApi::getUserSegmentsCallback);
    connect(this, &OAISegmentsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISegmentsApi::getUserSegmentsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getUserSegmentsSignal(output);
        Q_EMIT getUserSegmentsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getUserSegmentsSignalE(output, error_type, error_str);
        Q_EMIT getUserSegmentsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getUserSegmentsSignalError(output, error_type, error_str);
        Q_EMIT getUserSegmentsSignalErrorFull(worker, error_type, error_str);
    }
}
