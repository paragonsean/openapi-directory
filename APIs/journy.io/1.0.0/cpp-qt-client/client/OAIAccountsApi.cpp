...
void OAIAccountsApi::initializeServerConfigs() {
    ...
    QUrl("https://api.journy.io"),
    "Production",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("addUserToAccount", defaultConf);
    _serverIndices.insert("addUserToAccount", 0);
    _serverConfigs.insert("deleteAccount", defaultConf);
    _serverIndices.insert("deleteAccount", 0);
    _serverConfigs.insert("removeUserFromAccount", defaultConf);
    _serverIndices.insert("removeUserFromAccount", 0);
    _serverConfigs.insert("upsertAccount", defaultConf);
    _serverIndices.insert("upsertAccount", 0);
}
...
void OAIAccountsApi::addUserToAccount(const OAIAddUserToAccount_request &oai_add_user_to_account_request) {
    QString fullPath = QString(_serverConfigs["addUserToAccount"][_serverIndices.value("addUserToAccount")].URL()+"/accounts/users/add");
...

    {
        ...
        QByteArray output = oai_add_user_to_account_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::addUserToAccountCallback);
...
void OAIAccountsApi::addUserToAccountCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIDeleteAccount_202_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT addUserToAccountSignal(output);
        Q_EMIT addUserToAccountSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT addUserToAccountSignalE(output, error_type, error_str);
        Q_EMIT addUserToAccountSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT addUserToAccountSignalError(output, error_type, error_str);
        Q_EMIT addUserToAccountSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAccountsApi::deleteAccount(const OAIDeleteAccount_request &oai_delete_account_request) {
    QString fullPath = QString(_serverConfigs["deleteAccount"][_serverIndices.value("deleteAccount")].URL()+"/accounts");
...

    {
        ...
        QByteArray output = oai_delete_account_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
...
void OAIAccountsApi::removeUserFromAccount(const OAIAddUserToAccount_request &oai_add_user_to_account_request) {
    QString fullPath = QString(_serverConfigs["removeUserFromAccount"][_serverIndices.value("removeUserFromAccount")].URL()+"/accounts/users/remove");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::removeUserFromAccountCallback);
    connect(this, &OAIAccountsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAccountsApi::removeUserFromAccountCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT removeUserFromAccountSignal(output);
        Q_EMIT removeUserFromAccountSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT removeUserFromAccountSignalE(output, error_type, error_str);
        Q_EMIT removeUserFromAccountSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT removeUserFromAccountSignalError(output, error_type, error_str);
        Q_EMIT removeUserFromAccountSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAccountsApi::upsertAccount(const OAIUpsertAccount_request &oai_upsert_account_request) {
    QString fullPath = QString(_serverConfigs["upsertAccount"][_serverIndices.value("upsertAccount")].URL()+"/accounts/upsert");
...

    {
        ...
        QByteArray output = oai_upsert_account_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::upsertAccountCallback);
    connect(this, &OAIAccountsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAccountsApi::upsertAccountCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIUpsertAccount_201_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT upsertAccountSignal(output);
        Q_EMIT upsertAccountSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT upsertAccountSignalE(output, error_type, error_str);
        Q_EMIT upsertAccountSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT upsertAccountSignalError(output, error_type, error_str);
        Q_EMIT upsertAccountSignalErrorFull(worker, error_type, error_str);
    }
}
