...
#include "OAITrackEvent_request.h"
...
OAITrackEvent_request::OAITrackEvent_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrackEvent_request::OAITrackEvent_request() {
    this->initializeModel();
}

OAITrackEvent_request::~OAITrackEvent_request() {}

void OAITrackEvent_request::initializeModel() {
...
void OAITrackEvent_request::fromJson(QString jsonString) {
...
void OAITrackEvent_request::fromJsonObject(QJsonObject json) {
...
QString OAITrackEvent_request::asJson() const {
...
QJsonObject OAITrackEvent_request::asJsonObject() const {
    QJsonObject obj;
...
OAITrackJourneyEvent_request_identification OAITrackEvent_request::getIdentification() const {
    return m_identification;
}
void OAITrackEvent_request::setIdentification(const OAITrackJourneyEvent_request_identification &identification) {
    m_identification = identification;
    m_identification_isSet = true;
}

bool OAITrackEvent_request::is_identification_Set() const{
    return m_identification_isSet;
}

bool OAITrackEvent_request::is_identification_Valid() const{
    return m_identification_isValid;
}

QMap<QString, OAITrackEvent_request_metadata_value> OAITrackEvent_request::getMetadata() const {
    return m_metadata;
}
void OAITrackEvent_request::setMetadata(const QMap<QString, OAITrackEvent_request_metadata_value> &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAITrackEvent_request::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAITrackEvent_request::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAITrackEvent_request::getName() const {
    return m_name;
}
void OAITrackEvent_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITrackEvent_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAITrackEvent_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAITrackEvent_request::getTriggeredAt() const {
    return m_triggered_at;
}
void OAITrackEvent_request::setTriggeredAt(const QString &triggered_at) {
    m_triggered_at = triggered_at;
    m_triggered_at_isSet = true;
}

bool OAITrackEvent_request::is_triggered_at_Set() const{
    return m_triggered_at_isSet;
}

bool OAITrackEvent_request::is_triggered_at_Valid() const{
    return m_triggered_at_isValid;
}

bool OAITrackEvent_request::isSet() const {
...
bool OAITrackEvent_request::isValid() const {
