...
public:
    ...
    /**
    * @param[in]  oai_delete_user_request OAIDeleteUser_request [required]
    */
    virtual void deleteUser(const OAIDeleteUser_request &oai_delete_user_request);

    /**
    * @param[in]  oai_link_request OAILink_request [required]
    */
    virtual void link(const OAILink_request &oai_link_request);

    /**
    * @param[in]  oai_upsert_user_request OAIUpsertUser_request [required]
    */
    virtual void upsertUser(const OAIUpsertUser_request &oai_upsert_user_request);
...
private:
    ...
    void linkCallback(OAIHttpRequestWorker *worker);
    void upsertUserCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void deleteUserSignal(OAIDeleteAccount_202_response summary);
    void linkSignal(OAIDeleteAccount_202_response summary);
    void upsertUserSignal(OAIUpsertUser_201_response summary);


    void deleteUserSignalFull(OAIHttpRequestWorker *worker, OAIDeleteAccount_202_response summary);
    void linkSignalFull(OAIHttpRequestWorker *worker, OAIDeleteAccount_202_response summary);
    void upsertUserSignalFull(OAIHttpRequestWorker *worker, OAIUpsertUser_201_response summary);

    Q_DECL_DEPRECATED_X("Use deleteUserSignalError() instead")
    void deleteUserSignalE(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteUserSignalError(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use linkSignalError() instead")
    void linkSignalE(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void linkSignalError(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use upsertUserSignalError() instead")
    void upsertUserSignalE(OAIUpsertUser_201_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void upsertUserSignalError(OAIUpsertUser_201_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use linkSignalErrorFull() instead")
    void linkSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void linkSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use upsertUserSignalErrorFull() instead")
    void upsertUserSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void upsertUserSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
