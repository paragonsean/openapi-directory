...
#include "OAIGetAccountProperties_200_response_allOf_data_inner.h"
...
OAIGetAccountProperties_200_response_allOf_data_inner::OAIGetAccountProperties_200_response_allOf_data_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAccountProperties_200_response_allOf_data_inner::OAIGetAccountProperties_200_response_allOf_data_inner() {
    this->initializeModel();
}

OAIGetAccountProperties_200_response_allOf_data_inner::~OAIGetAccountProperties_200_response_allOf_data_inner() {}

void OAIGetAccountProperties_200_response_allOf_data_inner::initializeModel() {

    m_group_isSet = false;
    m_group_isValid = false;

    m_is_computed_isSet = false;
    m_is_computed_isValid = false;
...
void OAIGetAccountProperties_200_response_allOf_data_inner::fromJson(QString jsonString) {
...
void OAIGetAccountProperties_200_response_allOf_data_inner::fromJsonObject(QJsonObject json) {

    m_group_isValid = ::OpenAPI::fromJsonValue(m_group, json[QString("group")]);
    m_group_isSet = !json[QString("group")].isNull() && m_group_isValid;

    m_is_computed_isValid = ::OpenAPI::fromJsonValue(m_is_computed, json[QString("isComputed")]);
    m_is_computed_isSet = !json[QString("isComputed")].isNull() && m_is_computed_isValid;
...
QString OAIGetAccountProperties_200_response_allOf_data_inner::asJson() const {
...
QJsonObject OAIGetAccountProperties_200_response_allOf_data_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_group.isSet()) {
        obj.insert(QString("group"), ::OpenAPI::toJsonValue(m_group));
    }
    if (m_is_computed_isSet) {
        obj.insert(QString("isComputed"), ::OpenAPI::toJsonValue(m_is_computed));
    }
    if (m_label_isSet) {
...
OAIGetAccountProperties_200_response_allOf_data_inner_group OAIGetAccountProperties_200_response_allOf_data_inner::getGroup() const {
    return m_group;
}
void OAIGetAccountProperties_200_response_allOf_data_inner::setGroup(const OAIGetAccountProperties_200_response_allOf_data_inner_group &group) {
    m_group = group;
    m_group_isSet = true;
}

bool OAIGetAccountProperties_200_response_allOf_data_inner::is_group_Set() const{
    return m_group_isSet;
}

bool OAIGetAccountProperties_200_response_allOf_data_inner::is_group_Valid() const{
    return m_group_isValid;
}

bool OAIGetAccountProperties_200_response_allOf_data_inner::isIsComputed() const {
    return m_is_computed;
}
void OAIGetAccountProperties_200_response_allOf_data_inner::setIsComputed(const bool &is_computed) {
    m_is_computed = is_computed;
    m_is_computed_isSet = true;
}

bool OAIGetAccountProperties_200_response_allOf_data_inner::is_is_computed_Set() const{
    return m_is_computed_isSet;
}

bool OAIGetAccountProperties_200_response_allOf_data_inner::is_is_computed_Valid() const{
    return m_is_computed_isValid;
}

QString OAIGetAccountProperties_200_response_allOf_data_inner::getLabel() const {
    return m_label;
}
void OAIGetAccountProperties_200_response_allOf_data_inner::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIGetAccountProperties_200_response_allOf_data_inner::is_label_Set() const{
    return m_label_isSet;
}

bool OAIGetAccountProperties_200_response_allOf_data_inner::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIGetAccountProperties_200_response_allOf_data_inner::getName() const {
    return m_name;
}
void OAIGetAccountProperties_200_response_allOf_data_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetAccountProperties_200_response_allOf_data_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetAccountProperties_200_response_allOf_data_inner::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIGetAccountProperties_200_response_allOf_data_inner::isSet() const {
...
bool OAIGetAccountProperties_200_response_allOf_data_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_is_computed_isValid && m_label_isValid && m_name_isValid && true;
}
