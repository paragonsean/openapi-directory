...
#include "OAIGetAccountProperties_200_response.h"
...
OAIGetAccountProperties_200_response::OAIGetAccountProperties_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAccountProperties_200_response::OAIGetAccountProperties_200_response() {
    this->initializeModel();
}

OAIGetAccountProperties_200_response::~OAIGetAccountProperties_200_response() {}

void OAIGetAccountProperties_200_response::initializeModel() {
...
void OAIGetAccountProperties_200_response::fromJson(QString jsonString) {
...
void OAIGetAccountProperties_200_response::fromJsonObject(QJsonObject json) {
...
QString OAIGetAccountProperties_200_response::asJson() const {
...
QJsonObject OAIGetAccountProperties_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_meta.isSet()) {
...
OAIDeleteAccount_202_response_allOf_meta OAIGetAccountProperties_200_response::getMeta() const {
    return m_meta;
}
void OAIGetAccountProperties_200_response::setMeta(const OAIDeleteAccount_202_response_allOf_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIGetAccountProperties_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIGetAccountProperties_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIGetAccountProperties_200_response_allOf_data_inner> OAIGetAccountProperties_200_response::getData() const {
    return m_data;
}
void OAIGetAccountProperties_200_response::setData(const QList<OAIGetAccountProperties_200_response_allOf_data_inner> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetAccountProperties_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetAccountProperties_200_response::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIGetAccountProperties_200_response::isSet() const {
...
bool OAIGetAccountProperties_200_response::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_meta_isValid && m_data_isValid && true;
}
