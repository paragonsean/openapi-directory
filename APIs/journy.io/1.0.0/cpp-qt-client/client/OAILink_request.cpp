...
OAILink_request::OAILink_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILink_request::OAILink_request() {
    this->initializeModel();
}

OAILink_request::~OAILink_request() {}

void OAILink_request::initializeModel() {
...
void OAILink_request::fromJson(QString jsonString) {
...
void OAILink_request::fromJsonObject(QJsonObject json) {
...
QString OAILink_request::asJson() const {
...
QJsonObject OAILink_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAILink_request::getDeviceId() const {
    return m_device_id;
}
void OAILink_request::setDeviceId(const QString &device_id) {
    m_device_id = device_id;
    m_device_id_isSet = true;
}

bool OAILink_request::is_device_id_Set() const{
    return m_device_id_isSet;
}

bool OAILink_request::is_device_id_Valid() const{
    return m_device_id_isValid;
}

OAIAddUserToAccount_request_users_inner_identification OAILink_request::getIdentification() const {
    return m_identification;
}
void OAILink_request::setIdentification(const OAIAddUserToAccount_request_users_inner_identification &identification) {
    m_identification = identification;
    m_identification_isSet = true;
}

bool OAILink_request::is_identification_Set() const{
    return m_identification_isSet;
}

bool OAILink_request::is_identification_Valid() const{
    return m_identification_isValid;
}

bool OAILink_request::isSet() const {
...
bool OAILink_request::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_device_id_isValid && m_identification_isValid && true;
}
