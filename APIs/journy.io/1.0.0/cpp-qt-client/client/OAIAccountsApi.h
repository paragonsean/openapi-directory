...
public:
    ...
    /**
    * @param[in]  oai_add_user_to_account_request OAIAddUserToAccount_request [required]
    */
    virtual void addUserToAccount(const OAIAddUserToAccount_request &oai_add_user_to_account_request);

    /**
    * @param[in]  oai_delete_account_request OAIDeleteAccount_request [required]
    */
    virtual void deleteAccount(const OAIDeleteAccount_request &oai_delete_account_request);

    /**
    * @param[in]  oai_add_user_to_account_request OAIAddUserToAccount_request [required]
    */
    virtual void removeUserFromAccount(const OAIAddUserToAccount_request &oai_add_user_to_account_request);

    /**
    * @param[in]  oai_upsert_account_request OAIUpsertAccount_request [required]
    */
    virtual void upsertAccount(const OAIUpsertAccount_request &oai_upsert_account_request);
...
private:
    ...
    void addUserToAccountCallback(OAIHttpRequestWorker *worker);
    void deleteAccountCallback(OAIHttpRequestWorker *worker);
    void removeUserFromAccountCallback(OAIHttpRequestWorker *worker);
    void upsertAccountCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void addUserToAccountSignal(OAIDeleteAccount_202_response summary);
    void deleteAccountSignal(OAIDeleteAccount_202_response summary);
    void removeUserFromAccountSignal(OAIDeleteAccount_202_response summary);
    void upsertAccountSignal(OAIUpsertAccount_201_response summary);


    void addUserToAccountSignalFull(OAIHttpRequestWorker *worker, OAIDeleteAccount_202_response summary);
    void deleteAccountSignalFull(OAIHttpRequestWorker *worker, OAIDeleteAccount_202_response summary);
    void removeUserFromAccountSignalFull(OAIHttpRequestWorker *worker, OAIDeleteAccount_202_response summary);
    void upsertAccountSignalFull(OAIHttpRequestWorker *worker, OAIUpsertAccount_201_response summary);

    Q_DECL_DEPRECATED_X("Use addUserToAccountSignalError() instead")
    void addUserToAccountSignalE(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void addUserToAccountSignalError(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use deleteAccountSignalError() instead")
    void deleteAccountSignalE(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void deleteAccountSignalError(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use removeUserFromAccountSignalError() instead")
    void removeUserFromAccountSignalE(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void removeUserFromAccountSignalError(OAIDeleteAccount_202_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use upsertAccountSignalError() instead")
    void upsertAccountSignalE(OAIUpsertAccount_201_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void upsertAccountSignalError(OAIUpsertAccount_201_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use addUserToAccountSignalErrorFull() instead")
    void addUserToAccountSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void addUserToAccountSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use removeUserFromAccountSignalErrorFull() instead")
    void removeUserFromAccountSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void removeUserFromAccountSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use upsertAccountSignalErrorFull() instead")
    void upsertAccountSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void upsertAccountSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
