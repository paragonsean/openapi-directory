...
#include "OAIUpsertUser_request.h"
...
OAIUpsertUser_request::OAIUpsertUser_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpsertUser_request::OAIUpsertUser_request() {
    this->initializeModel();
}

OAIUpsertUser_request::~OAIUpsertUser_request() {}

void OAIUpsertUser_request::initializeModel() {
...
void OAIUpsertUser_request::fromJson(QString jsonString) {
...
void OAIUpsertUser_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpsertUser_request::asJson() const {
...
QJsonObject OAIUpsertUser_request::asJsonObject() const {
    QJsonObject obj;
...
OAIAddUserToAccount_request_users_inner_identification OAIUpsertUser_request::getIdentification() const {
    return m_identification;
}
void OAIUpsertUser_request::setIdentification(const OAIAddUserToAccount_request_users_inner_identification &identification) {
    m_identification = identification;
    m_identification_isSet = true;
}

bool OAIUpsertUser_request::is_identification_Set() const{
    return m_identification_isSet;
}

bool OAIUpsertUser_request::is_identification_Valid() const{
    return m_identification_isValid;
}

QMap<QString, OAIUpsertAccount_request_properties_value> OAIUpsertUser_request::getProperties() const {
    return m_properties;
}
void OAIUpsertUser_request::setProperties(const QMap<QString, OAIUpsertAccount_request_properties_value> &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIUpsertUser_request::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIUpsertUser_request::is_properties_Valid() const{
    return m_properties_isValid;
}

bool OAIUpsertUser_request::isSet() const {
...
bool OAIUpsertUser_request::isValid() const {
