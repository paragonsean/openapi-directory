...
OAIDeleteAccount_202_response_allOf_meta OAIGetEvents_200_response::getMeta() const {
    return m_meta;
}
void OAIGetEvents_200_response::setMeta(const OAIDeleteAccount_202_response_allOf_meta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIGetEvents_200_response::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIGetEvents_200_response::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIGetEvents_200_response_allOf_data_inner> OAIGetEvents_200_response::getData() const {
    return m_data;
}
void OAIGetEvents_200_response::setData(const QList<OAIGetEvents_200_response_allOf_data_inner> &data) {
    m_data = data;
    m_data_isSet = true;
}
