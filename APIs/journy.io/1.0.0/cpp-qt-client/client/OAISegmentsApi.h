...
public:
    ...
    virtual void getAccountSegments();


    virtual void getUserSegments();
...
private:
    ...
    void getAccountSegmentsCallback(OAIHttpRequestWorker *worker);
    void getUserSegmentsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getAccountSegmentsSignal(OAIGetAccountSegments_200_response summary);
    void getUserSegmentsSignal(OAIGetAccountSegments_200_response summary);


    void getAccountSegmentsSignalFull(OAIHttpRequestWorker *worker, OAIGetAccountSegments_200_response summary);
    void getUserSegmentsSignalFull(OAIHttpRequestWorker *worker, OAIGetAccountSegments_200_response summary);

    Q_DECL_DEPRECATED_X("Use getAccountSegmentsSignalError() instead")
    void getAccountSegmentsSignalE(OAIGetAccountSegments_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccountSegmentsSignalError(OAIGetAccountSegments_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getUserSegmentsSignalError() instead")
    void getUserSegmentsSignalE(OAIGetAccountSegments_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getUserSegmentsSignalError(OAIGetAccountSegments_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getAccountSegmentsSignalErrorFull() instead")
    void getAccountSegmentsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccountSegmentsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getUserSegmentsSignalErrorFull() instead")
    void getUserSegmentsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getUserSegmentsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
