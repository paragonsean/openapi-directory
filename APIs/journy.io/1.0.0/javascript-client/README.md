...
DeveloperDocumentation - JavaScript client for developer_documentation
# Welcome
...
For more information, please visit [https://developers.journy.io](https://developers.journy.io)
...
```shell
npm install developer_documentation --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your developer_documentation from, and run:
...
```javascript
var DeveloperDocumentation = require('developer_documentation');


var api = new DeveloperDocumentation.AccountsApi()
var addUserToAccountRequest = new DeveloperDocumentation.AddUserToAccountRequest(); // {AddUserToAccountRequest} 
...
api.addUserToAccount(addUserToAccountRequest, callback);
...
------------ | ------------- | ------------- | -------------
*DeveloperDocumentation.AccountsApi* | [**addUserToAccount**](docs/AccountsApi.md#addUserToAccount) | **POST** /accounts/users/add | Add users to an account
*DeveloperDocumentation.AccountsApi* | [**deleteAccount**](docs/AccountsApi.md#deleteAccount) | **DELETE** /accounts | Delete account
*DeveloperDocumentation.AccountsApi* | [**removeUserFromAccount**](docs/AccountsApi.md#removeUserFromAccount) | **POST** /accounts/users/remove | Remove user from account
*DeveloperDocumentation.AccountsApi* | [**upsertAccount**](docs/AccountsApi.md#upsertAccount) | **POST** /accounts/upsert | Create or update account
*DeveloperDocumentation.EventsApi* | [**getEvents**](docs/EventsApi.md#getEvents) | **GET** /events | Get events
*DeveloperDocumentation.EventsApi* | [**trackJourneyEvent**](docs/EventsApi.md#trackJourneyEvent) | **POST** /events | Track event
*DeveloperDocumentation.PropertiesApi* | [**getAccountProperties**](docs/PropertiesApi.md#getAccountProperties) | **GET** /properties/accounts | Get account properties
*DeveloperDocumentation.PropertiesApi* | [**getUserProperties**](docs/PropertiesApi.md#getUserProperties) | **GET** /properties/users | Get user properties
*DeveloperDocumentation.SegmentsApi* | [**getAccountSegments**](docs/SegmentsApi.md#getAccountSegments) | **GET** /segments/accounts | Get account segments
*DeveloperDocumentation.SegmentsApi* | [**getUserSegments**](docs/SegmentsApi.md#getUserSegments) | **GET** /segments/users | Get user segments
*DeveloperDocumentation.TrackApi* | [**trackEvent**](docs/TrackApi.md#trackEvent) | **POST** /track | Track event
*DeveloperDocumentation.UsersApi* | [**deleteUser**](docs/UsersApi.md#deleteUser) | **DELETE** /users | Delete user
*DeveloperDocumentation.UsersApi* | [**link**](docs/UsersApi.md#link) | **POST** /link | Link web activity to user
*DeveloperDocumentation.UsersApi* | [**upsertUser**](docs/UsersApi.md#upsertUser) | **POST** /users/upsert | Create or update user
*DeveloperDocumentation.ValidationApi* | [**getValidity**](docs/ValidationApi.md#getValidity) | **GET** /validate | Validate API key
*DeveloperDocumentation.WebsitesApi* | [**getTrackingSnippet**](docs/WebsitesApi.md#getTrackingSnippet) | **GET** /tracking/snippet | Get snippet for a website


## Documentation for Models

 - [DeveloperDocumentation.AddUserToAccountRequest](docs/AddUserToAccountRequest.md)
 - [DeveloperDocumentation.AddUserToAccountRequestUsersInner](docs/AddUserToAccountRequestUsersInner.md)
 - [DeveloperDocumentation.AddUserToAccountRequestUsersInnerIdentification](docs/AddUserToAccountRequestUsersInnerIdentification.md)
 - [DeveloperDocumentation.DeleteAccount202Response](docs/DeleteAccount202Response.md)
 - [DeveloperDocumentation.DeleteAccount202ResponseAllOfMeta](docs/DeleteAccount202ResponseAllOfMeta.md)
 - [DeveloperDocumentation.DeleteAccount400Response](docs/DeleteAccount400Response.md)
 - [DeveloperDocumentation.DeleteAccount400ResponseAllOfErrors](docs/DeleteAccount400ResponseAllOfErrors.md)
 - [DeveloperDocumentation.DeleteAccount400ResponseAllOfErrorsParameters](docs/DeleteAccount400ResponseAllOfErrorsParameters.md)
 - [DeveloperDocumentation.DeleteAccountRequest](docs/DeleteAccountRequest.md)
 - [DeveloperDocumentation.DeleteAccountRequestIdentification](docs/DeleteAccountRequestIdentification.md)
 - [DeveloperDocumentation.DeleteUserRequest](docs/DeleteUserRequest.md)
 - [DeveloperDocumentation.GetAccountProperties200Response](docs/GetAccountProperties200Response.md)
 - [DeveloperDocumentation.GetAccountProperties200ResponseAllOfDataInner](docs/GetAccountProperties200ResponseAllOfDataInner.md)
 - [DeveloperDocumentation.GetAccountProperties200ResponseAllOfDataInnerGroup](docs/GetAccountProperties200ResponseAllOfDataInnerGroup.md)
 - [DeveloperDocumentation.GetAccountSegments200Response](docs/GetAccountSegments200Response.md)
 - [DeveloperDocumentation.GetAccountSegments200ResponseAllOfDataInner](docs/GetAccountSegments200ResponseAllOfDataInner.md)
 - [DeveloperDocumentation.GetEvents200Response](docs/GetEvents200Response.md)
 - [DeveloperDocumentation.GetEvents200ResponseAllOfDataInner](docs/GetEvents200ResponseAllOfDataInner.md)
 - [DeveloperDocumentation.GetEvents200ResponseAllOfDataInnerGroup](docs/GetEvents200ResponseAllOfDataInnerGroup.md)
 - [DeveloperDocumentation.GetTrackingSnippet200Response](docs/GetTrackingSnippet200Response.md)
 - [DeveloperDocumentation.GetTrackingSnippet200ResponseAllOfData](docs/GetTrackingSnippet200ResponseAllOfData.md)
 - [DeveloperDocumentation.GetValidity200Response](docs/GetValidity200Response.md)
 - [DeveloperDocumentation.GetValidity200ResponseAllOfData](docs/GetValidity200ResponseAllOfData.md)
 - [DeveloperDocumentation.LinkRequest](docs/LinkRequest.md)
 - [DeveloperDocumentation.TrackEventRequest](docs/TrackEventRequest.md)
 - [DeveloperDocumentation.TrackEventRequestMetadataValue](docs/TrackEventRequestMetadataValue.md)
 - [DeveloperDocumentation.TrackJourneyEventRequest](docs/TrackJourneyEventRequest.md)
 - [DeveloperDocumentation.TrackJourneyEventRequestIdentification](docs/TrackJourneyEventRequestIdentification.md)
 - [DeveloperDocumentation.TrackJourneyEventRequestMetadataValue](docs/TrackJourneyEventRequestMetadataValue.md)
 - [DeveloperDocumentation.UpsertAccount201Response](docs/UpsertAccount201Response.md)
 - [DeveloperDocumentation.UpsertAccountRequest](docs/UpsertAccountRequest.md)
 - [DeveloperDocumentation.UpsertAccountRequestPropertiesValue](docs/UpsertAccountRequestPropertiesValue.md)
 - [DeveloperDocumentation.UpsertUser201Response](docs/UpsertUser201Response.md)
 - [DeveloperDocumentation.UpsertUserRequest](docs/UpsertUserRequest.md)
