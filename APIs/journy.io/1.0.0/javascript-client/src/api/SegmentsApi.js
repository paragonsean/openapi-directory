...
export default class SegmentsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAccountSegments operation.
     * @callback module:api/SegmentsApi~getAccountSegmentsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetAccountSegments200Response} data The data returned by the service call.
     ...
     * @param {module:api/SegmentsApi~getAccountSegmentsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetAccountSegments200Response}
     */
    getAccountSegments(callback) {
      let postBody = null;
      ...
      let returnType = GetAccountSegments200Response;
      return this.apiClient.callApi(
        '/segments/accounts', 'GET',
     ...
     * @callback module:api/SegmentsApi~getUserSegmentsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetAccountSegments200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SegmentsApi~getUserSegmentsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetAccountSegments200Response}
     */
    getUserSegments(callback) {
      let postBody = null;
