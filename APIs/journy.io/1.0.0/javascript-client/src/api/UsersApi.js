...
export default class UsersApi {
    ...
    */
     ...
     * @param {module:model/DeleteAccount202Response} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/DeleteAccount202Response}
     */
    deleteUser(deleteUserRequest, callback) {
      ...
      let returnType = DeleteAccount202Response;
    ...
    /**
     * Callback function to receive the result of the link operation.
     * @callback module:api/UsersApi~linkCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeleteAccount202Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/LinkRequest} linkRequest 
     * @param {module:api/UsersApi~linkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeleteAccount202Response}
     */
    link(linkRequest, callback) {
      let postBody = linkRequest;
      // verify the required parameter 'linkRequest' is set
      if (linkRequest === undefined || linkRequest === null) {
        throw new Error("Missing the required parameter 'linkRequest' when calling link");
      }
    ...
    /**
     * Callback function to receive the result of the upsertUser operation.
     * @callback module:api/UsersApi~upsertUserCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UpsertUser201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/UpsertUserRequest} upsertUserRequest 
     * @param {module:api/UsersApi~upsertUserCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UpsertUser201Response}
     */
    upsertUser(upsertUserRequest, callback) {
      let postBody = upsertUserRequest;
      // verify the required parameter 'upsertUserRequest' is set
      if (upsertUserRequest === undefined || upsertUserRequest === null) {
        throw new Error("Missing the required parameter 'upsertUserRequest' when calling upsertUser");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = UpsertUser201Response;
      return this.apiClient.callApi(
        '/users/upsert', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
