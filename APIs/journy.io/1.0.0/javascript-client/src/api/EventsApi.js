...
export default class EventsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the trackJourneyEvent operation.
     * @callback module:api/EventsApi~trackJourneyEventCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/TrackJourneyEventRequest} trackJourneyEventRequest 
     * @param {module:api/EventsApi~trackJourneyEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeleteAccount202Response}
     */
    trackJourneyEvent(trackJourneyEventRequest, callback) {
      let postBody = trackJourneyEventRequest;
      // verify the required parameter 'trackJourneyEventRequest' is set
      if (trackJourneyEventRequest === undefined || trackJourneyEventRequest === null) {
        throw new Error("Missing the required parameter 'trackJourneyEventRequest' when calling trackJourneyEvent");
      }
