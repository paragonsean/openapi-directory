...
export default class AccountsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addUserToAccount operation.
     * @callback module:api/AccountsApi~addUserToAccountCallback
     ...
     * @param {module:model/AddUserToAccountRequest} addUserToAccountRequest 
     * @param {module:api/AccountsApi~addUserToAccountCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeleteAccount202Response}
     */
    addUserToAccount(addUserToAccountRequest, callback) {
      let postBody = addUserToAccountRequest;
      // verify the required parameter 'addUserToAccountRequest' is set
      if (addUserToAccountRequest === undefined || addUserToAccountRequest === null) {
        throw new Error("Missing the required parameter 'addUserToAccountRequest' when calling addUserToAccount");
      }
     ...
     * @param {module:model/DeleteAccountRequest} deleteAccountRequest 
     ...
     * data is of type: {@link module:model/DeleteAccount202Response}
     */
    deleteAccount(deleteAccountRequest, callback) {
      let postBody = deleteAccountRequest;
      // verify the required parameter 'deleteAccountRequest' is set
      if (deleteAccountRequest === undefined || deleteAccountRequest === null) {
        throw new Error("Missing the required parameter 'deleteAccountRequest' when calling deleteAccount");
      }
    ...
    /**
     * Callback function to receive the result of the removeUserFromAccount operation.
     * @callback module:api/AccountsApi~removeUserFromAccountCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeleteAccount202Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/AddUserToAccountRequest} addUserToAccountRequest 
     * @param {module:api/AccountsApi~removeUserFromAccountCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeleteAccount202Response}
     */
    removeUserFromAccount(addUserToAccountRequest, callback) {
      let postBody = addUserToAccountRequest;
      // verify the required parameter 'addUserToAccountRequest' is set
      if (addUserToAccountRequest === undefined || addUserToAccountRequest === null) {
        throw new Error("Missing the required parameter 'addUserToAccountRequest' when calling removeUserFromAccount");
      }
    ...
    /**
     * Callback function to receive the result of the upsertAccount operation.
     * @callback module:api/AccountsApi~upsertAccountCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UpsertAccount201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/UpsertAccountRequest} upsertAccountRequest 
     * @param {module:api/AccountsApi~upsertAccountCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UpsertAccount201Response}
     */
    upsertAccount(upsertAccountRequest, callback) {
      let postBody = upsertAccountRequest;
      // verify the required parameter 'upsertAccountRequest' is set
      if (upsertAccountRequest === undefined || upsertAccountRequest === null) {
        throw new Error("Missing the required parameter 'upsertAccountRequest' when calling upsertAccount");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = UpsertAccount201Response;
      return this.apiClient.callApi(
        '/accounts/upsert', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
