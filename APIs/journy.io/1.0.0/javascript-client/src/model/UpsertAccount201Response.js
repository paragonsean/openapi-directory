...
/**
 * The UpsertAccount201Response model module.
 * @module model/UpsertAccount201Response
 * @version 1.0.0
 */
class UpsertAccount201Response {
    /**
     * Constructs a new <code>UpsertAccount201Response</code>.
     * @alias module:model/UpsertAccount201Response
     * @param meta {module:model/DeleteAccount202ResponseAllOfMeta} 
     * @param message {String} 
     */
    constructor(meta, message) { 
        
        UpsertAccount201Response.initialize(this, meta, message);
    }
    ...
    /**
     * Constructs a <code>UpsertAccount201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpsertAccount201Response} obj Optional instance to populate.
     * @return {module:model/UpsertAccount201Response} The populated <code>UpsertAccount201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpsertAccount201Response();
    ...
    /**
     * Validates the JSON data with respect to <code>UpsertAccount201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpsertAccount201Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpsertAccount201Response.RequiredProperties) {
...
UpsertAccount201Response.RequiredProperties = ["meta", "message"];

/**
 * @member {module:model/DeleteAccount202ResponseAllOfMeta} meta
 */
UpsertAccount201Response.prototype['meta'] = undefined;

/**
 * @member {String} message
 */
UpsertAccount201Response.prototype['message'] = undefined;

/**
 * If validation fails, specifies the property name and error message
 * @member {Object.<String, String>} rejected
 */
UpsertAccount201Response.prototype['rejected'] = undefined;
...
export default UpsertAccount201Response;
