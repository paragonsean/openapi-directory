...
import GetEvents200ResponseAllOfDataInnerGroup from './GetEvents200ResponseAllOfDataInnerGroup';

/**
 * The GetEvents200ResponseAllOfDataInner model module.
 * @module model/GetEvents200ResponseAllOfDataInner
 * @version 1.0.0
 */
class GetEvents200ResponseAllOfDataInner {
    /**
     * Constructs a new <code>GetEvents200ResponseAllOfDataInner</code>.
     * Event details
     * @alias module:model/GetEvents200ResponseAllOfDataInner
     * @param id {String} 
     * @param name {String} 
     */
    constructor(id, name) { 
        
        GetEvents200ResponseAllOfDataInner.initialize(this, id, name);
    }
    ...
    /**
     * Constructs a <code>GetEvents200ResponseAllOfDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetEvents200ResponseAllOfDataInner} obj Optional instance to populate.
     * @return {module:model/GetEvents200ResponseAllOfDataInner} The populated <code>GetEvents200ResponseAllOfDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetEvents200ResponseAllOfDataInner();

            if (data.hasOwnProperty('group')) {
                obj['group'] = GetEvents200ResponseAllOfDataInnerGroup.constructFromObject(data['group']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetEvents200ResponseAllOfDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetEvents200ResponseAllOfDataInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetEvents200ResponseAllOfDataInner.RequiredProperties) {
        ...
        if (data['group']) { // data not null
          GetEvents200ResponseAllOfDataInnerGroup.validateJSON(data['group']);
        }
...
GetEvents200ResponseAllOfDataInner.RequiredProperties = ["id", "name"];

/**
 * @member {module:model/GetEvents200ResponseAllOfDataInnerGroup} group
 */
GetEvents200ResponseAllOfDataInner.prototype['group'] = undefined;

/**
 * @member {String} id
 */
GetEvents200ResponseAllOfDataInner.prototype['id'] = undefined;

/**
 * @member {String} name
 */
GetEvents200ResponseAllOfDataInner.prototype['name'] = undefined;
...
export default GetEvents200ResponseAllOfDataInner;
