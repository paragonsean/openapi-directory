...
/**
 * The UpsertAccountRequestPropertiesValue model module.
 * @module model/UpsertAccountRequestPropertiesValue
 * @version 1.0.0
 */
class UpsertAccountRequestPropertiesValue {
    /**
     * Constructs a new <code>UpsertAccountRequestPropertiesValue</code>.
     * @alias module:model/UpsertAccountRequestPropertiesValue
     * @param {(module:model/Boolean|module:model/Number|module:model/String|module:model/[String])} instance The actual instance to initialize UpsertAccountRequestPropertiesValue.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `UpsertAccountRequestPropertiesValue` with oneOf schemas Boolean, Number, String, [String]. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `UpsertAccountRequestPropertiesValue` with oneOf schemas Boolean, Number, String, [String]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>UpsertAccountRequestPropertiesValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpsertAccountRequestPropertiesValue} obj Optional instance to populate.
     * @return {module:model/UpsertAccountRequestPropertiesValue} The populated <code>UpsertAccountRequestPropertiesValue</code> instance.
     */
    static constructFromObject(data, obj) {
        return new UpsertAccountRequestPropertiesValue(data);
    }

    /**
     * Gets the actual instance, which can be <code>Boolean</code>, <code>Number</code>, <code>String</code>, <code>[String]</code>.
     * @return {(module:model/Boolean|module:model/Number|module:model/String|module:model/[String])} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>Boolean</code>, <code>Number</code>, <code>String</code>, <code>[String]</code>.
     * @param {(module:model/Boolean|module:model/Number|module:model/String|module:model/[String])} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = UpsertAccountRequestPropertiesValue.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of UpsertAccountRequestPropertiesValue from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/UpsertAccountRequestPropertiesValue} An instance of UpsertAccountRequestPropertiesValue.
     */
    static fromJSON = function(json_string){
        return UpsertAccountRequestPropertiesValue.constructFromObject(JSON.parse(json_string));
    }
}


UpsertAccountRequestPropertiesValue.OneOf = ["Boolean", "Number", "String", "[String]"];

export default UpsertAccountRequestPropertiesValue;
