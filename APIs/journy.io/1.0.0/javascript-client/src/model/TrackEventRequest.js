...
import TrackEventRequestMetadataValue from './TrackEventRequestMetadataValue';
import TrackJourneyEventRequestIdentification from './TrackJourneyEventRequestIdentification';
...
class TrackEventRequest {
     ...
     * @param identification {module:model/TrackJourneyEventRequestIdentification} 
     * @param name {String} 
     */
    constructor(identification, name) { 
        
        TrackEventRequest.initialize(this, identification, name);
    }
     ...
     */
    static initialize(obj, identification, name) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('identification')) {
                obj['identification'] = TrackJourneyEventRequestIdentification.constructFromObject(data['identification']);
            }
            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = ApiClient.convertToType(data['metadata'], {'String': TrackEventRequestMetadataValue});
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('triggeredAt')) {
                obj['triggeredAt'] = ApiClient.convertToType(data['triggeredAt'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TrackEventRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrackEventRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TrackEventRequest.RequiredProperties) {
        ...
        if (data['identification']) { // data not null
          TrackJourneyEventRequestIdentification.validateJSON(data['identification']);
        }
        ...
        // ensure the json data is a string
        if (data['triggeredAt'] && !(typeof data['triggeredAt'] === 'string' || data['triggeredAt'] instanceof String)) {
            throw new Error("Expected the field `triggeredAt` to be a primitive type in the JSON string but got " + data['triggeredAt']);
        }
...
TrackEventRequest.RequiredProperties = ["identification", "name"];

/**
 * @member {module:model/TrackJourneyEventRequestIdentification} identification
 */
TrackEventRequest.prototype['identification'] = undefined;

/**
 * Event metadata, possible values are strings, booleans, numbers and datetimes (ISO 8601)
 * @member {Object.<String, module:model/TrackEventRequestMetadataValue>} metadata
 */
TrackEventRequest.prototype['metadata'] = undefined;

/**
 * @member {String} name
 */
TrackEventRequest.prototype['name'] = undefined;

/**
 * If left blank this defaults to the current datetime
 * @member {String} triggeredAt
 */
TrackEventRequest.prototype['triggeredAt'] = undefined;
