...
/**
 * The TrackJourneyEventRequestMetadataValue model module.
 * @module model/TrackJourneyEventRequestMetadataValue
 * @version 1.0.0
 */
class TrackJourneyEventRequestMetadataValue {
    /**
     * Constructs a new <code>TrackJourneyEventRequestMetadataValue</code>.
     * @alias module:model/TrackJourneyEventRequestMetadataValue
     * @param {(module:model/Boolean|module:model/Number|module:model/String)} instance The actual instance to initialize TrackJourneyEventRequestMetadataValue.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `TrackJourneyEventRequestMetadataValue` with oneOf schemas Boolean, Number, String. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `TrackJourneyEventRequestMetadataValue` with oneOf schemas Boolean, Number, String. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>TrackJourneyEventRequestMetadataValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrackJourneyEventRequestMetadataValue} obj Optional instance to populate.
     * @return {module:model/TrackJourneyEventRequestMetadataValue} The populated <code>TrackJourneyEventRequestMetadataValue</code> instance.
     */
    static constructFromObject(data, obj) {
        return new TrackJourneyEventRequestMetadataValue(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = TrackJourneyEventRequestMetadataValue.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of TrackJourneyEventRequestMetadataValue from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/TrackJourneyEventRequestMetadataValue} An instance of TrackJourneyEventRequestMetadataValue.
     */
    static fromJSON = function(json_string){
        return TrackJourneyEventRequestMetadataValue.constructFromObject(JSON.parse(json_string));
    }
}


TrackJourneyEventRequestMetadataValue.OneOf = ["Boolean", "Number", "String"];

export default TrackJourneyEventRequestMetadataValue;
