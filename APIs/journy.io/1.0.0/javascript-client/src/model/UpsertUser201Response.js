...
import DeleteAccount202ResponseAllOfMeta from './DeleteAccount202ResponseAllOfMeta';

/**
 * The UpsertUser201Response model module.
 * @module model/UpsertUser201Response
 * @version 1.0.0
 */
class UpsertUser201Response {
    /**
     * Constructs a new <code>UpsertUser201Response</code>.
     * @alias module:model/UpsertUser201Response
     * @param meta {module:model/DeleteAccount202ResponseAllOfMeta} 
     * @param message {String} 
     */
    constructor(meta, message) { 
        
        UpsertUser201Response.initialize(this, meta, message);
    }
     ...
     */
    static initialize(obj, meta, message) { 
        obj['meta'] = meta;
        obj['message'] = message;
    }

    /**
     * Constructs a <code>UpsertUser201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpsertUser201Response} obj Optional instance to populate.
     * @return {module:model/UpsertUser201Response} The populated <code>UpsertUser201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpsertUser201Response();

            if (data.hasOwnProperty('meta')) {
                obj['meta'] = DeleteAccount202ResponseAllOfMeta.constructFromObject(data['meta']);
            }
            if (data.hasOwnProperty('message')) {
                obj['message'] = ApiClient.convertToType(data['message'], 'String');
            }
            if (data.hasOwnProperty('rejected')) {
                obj['rejected'] = ApiClient.convertToType(data['rejected'], {'String': 'String'});
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpsertUser201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpsertUser201Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpsertUser201Response.RequiredProperties) {
        ...
        if (data['meta']) { // data not null
          DeleteAccount202ResponseAllOfMeta.validateJSON(data['meta']);
        }
...
UpsertUser201Response.RequiredProperties = ["meta", "message"];

/**
 * @member {module:model/DeleteAccount202ResponseAllOfMeta} meta
 */
UpsertUser201Response.prototype['meta'] = undefined;

/**
 * @member {String} message
 */
UpsertUser201Response.prototype['message'] = undefined;

/**
 * If validation fails, specifies property name and error description
 * @member {Object.<String, String>} rejected
 */
UpsertUser201Response.prototype['rejected'] = undefined;
...
export default UpsertUser201Response;
