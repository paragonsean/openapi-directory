...
import GetAccountProperties200ResponseAllOfDataInner from './GetAccountProperties200ResponseAllOfDataInner';

/**
 * The GetAccountProperties200Response model module.
 * @module model/GetAccountProperties200Response
 * @version 1.0.0
 */
class GetAccountProperties200Response {
    /**
     * Constructs a new <code>GetAccountProperties200Response</code>.
     * @alias module:model/GetAccountProperties200Response
     * @param meta {module:model/DeleteAccount202ResponseAllOfMeta} 
     * @param data {Array.<module:model/GetAccountProperties200ResponseAllOfDataInner>} 
     */
    constructor(meta, data) { 
        
        GetAccountProperties200Response.initialize(this, meta, data);
    }
    ...
    /**
     * Constructs a <code>GetAccountProperties200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAccountProperties200Response} obj Optional instance to populate.
     * @return {module:model/GetAccountProperties200Response} The populated <code>GetAccountProperties200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAccountProperties200Response();

            if (data.hasOwnProperty('meta')) {
                obj['meta'] = DeleteAccount202ResponseAllOfMeta.constructFromObject(data['meta']);
            }
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetAccountProperties200ResponseAllOfDataInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAccountProperties200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAccountProperties200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetAccountProperties200Response.RequiredProperties) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                GetAccountProperties200ResponseAllOfDataInner.validateJSON(item);
            };
        }
...
GetAccountProperties200Response.RequiredProperties = ["meta", "data"];

/**
 * @member {module:model/DeleteAccount202ResponseAllOfMeta} meta
 */
GetAccountProperties200Response.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/GetAccountProperties200ResponseAllOfDataInner>} data
 */
GetAccountProperties200Response.prototype['data'] = undefined;
...
export default GetAccountProperties200Response;
