...
import TrackJourneyEventRequestMetadataValue from './TrackJourneyEventRequestMetadataValue';

/**
 * The TrackJourneyEventRequest model module.
 * @module model/TrackJourneyEventRequest
 * @version 1.0.0
 */
class TrackJourneyEventRequest {
    /**
     * Constructs a new <code>TrackJourneyEventRequest</code>.
     * Event for a user or an account
     * @alias module:model/TrackJourneyEventRequest
     * @param identification {module:model/TrackJourneyEventRequestIdentification} 
     * @param name {String} 
     */
    constructor(identification, name) { 
        
        TrackJourneyEventRequest.initialize(this, identification, name);
    }
    ...
    /**
     * Constructs a <code>TrackJourneyEventRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrackJourneyEventRequest} obj Optional instance to populate.
     * @return {module:model/TrackJourneyEventRequest} The populated <code>TrackJourneyEventRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrackJourneyEventRequest();
            ...
            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = ApiClient.convertToType(data['metadata'], {'String': TrackJourneyEventRequestMetadataValue});
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TrackJourneyEventRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrackJourneyEventRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TrackJourneyEventRequest.RequiredProperties) {
...
TrackJourneyEventRequest.RequiredProperties = ["identification", "name"];

/**
 * @member {module:model/TrackJourneyEventRequestIdentification} identification
 */
TrackJourneyEventRequest.prototype['identification'] = undefined;

/**
 * Event metadata, possible values are strings, booleans, numbers and datetimes (ISO 8601)
 * @member {Object.<String, module:model/TrackJourneyEventRequestMetadataValue>} metadata
 */
TrackJourneyEventRequest.prototype['metadata'] = undefined;

/**
 * @member {String} name
 */
TrackJourneyEventRequest.prototype['name'] = undefined;

/**
 * If left blank this defaults to the current datetime
 * @member {String} triggeredAt
 */
TrackJourneyEventRequest.prototype['triggeredAt'] = undefined;
...
export default TrackJourneyEventRequest;
