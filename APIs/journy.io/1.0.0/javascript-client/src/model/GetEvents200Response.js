...
import GetEvents200ResponseAllOfDataInner from './GetEvents200ResponseAllOfDataInner';
...
class GetEvents200Response {
     ...
     * @param data {Array.<module:model/GetEvents200ResponseAllOfDataInner>} 
     */
    constructor(meta, data) { 
        
        GetEvents200Response.initialize(this, meta, data);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetEvents200ResponseAllOfDataInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                GetEvents200ResponseAllOfDataInner.validateJSON(item);
            };
        }
...
GetEvents200Response.RequiredProperties = ["meta", "data"];

/**
 * @member {module:model/DeleteAccount202ResponseAllOfMeta} meta
 */
GetEvents200Response.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/GetEvents200ResponseAllOfDataInner>} data
 */
