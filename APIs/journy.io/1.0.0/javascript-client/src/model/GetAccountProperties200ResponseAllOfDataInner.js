...
import GetAccountProperties200ResponseAllOfDataInnerGroup from './GetAccountProperties200ResponseAllOfDataInnerGroup';

/**
 * The GetAccountProperties200ResponseAllOfDataInner model module.
 * @module model/GetAccountProperties200ResponseAllOfDataInner
 * @version 1.0.0
 */
class GetAccountProperties200ResponseAllOfDataInner {
    /**
     * Constructs a new <code>GetAccountProperties200ResponseAllOfDataInner</code>.
     * Properties details
     * @alias module:model/GetAccountProperties200ResponseAllOfDataInner
     * @param isComputed {Boolean} 
     * @param label {String} 
     * @param name {String} 
     */
    constructor(isComputed, label, name) { 
        
        GetAccountProperties200ResponseAllOfDataInner.initialize(this, isComputed, label, name);
    }
     ...
     */
    static initialize(obj, isComputed, label, name) { 
        obj['isComputed'] = isComputed;
        obj['label'] = label;
        obj['name'] = name;
    }

    /**
     * Constructs a <code>GetAccountProperties200ResponseAllOfDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAccountProperties200ResponseAllOfDataInner} obj Optional instance to populate.
     * @return {module:model/GetAccountProperties200ResponseAllOfDataInner} The populated <code>GetAccountProperties200ResponseAllOfDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAccountProperties200ResponseAllOfDataInner();

            if (data.hasOwnProperty('group')) {
                obj['group'] = GetAccountProperties200ResponseAllOfDataInnerGroup.constructFromObject(data['group']);
            }
            if (data.hasOwnProperty('isComputed')) {
                obj['isComputed'] = ApiClient.convertToType(data['isComputed'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAccountProperties200ResponseAllOfDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAccountProperties200ResponseAllOfDataInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetAccountProperties200ResponseAllOfDataInner.RequiredProperties) {
        ...
        if (data['group']) { // data not null
          GetAccountProperties200ResponseAllOfDataInnerGroup.validateJSON(data['group']);
        }
...
GetAccountProperties200ResponseAllOfDataInner.RequiredProperties = ["isComputed", "label", "name"];

/**
 * @member {module:model/GetAccountProperties200ResponseAllOfDataInnerGroup} group
 */
GetAccountProperties200ResponseAllOfDataInner.prototype['group'] = undefined;

/**
 * @member {Boolean} isComputed
 */
GetAccountProperties200ResponseAllOfDataInner.prototype['isComputed'] = undefined;

/**
 * @member {String} label
 */
GetAccountProperties200ResponseAllOfDataInner.prototype['label'] = undefined;

/**
 * @member {String} name
 */
GetAccountProperties200ResponseAllOfDataInner.prototype['name'] = undefined;
...
export default GetAccountProperties200ResponseAllOfDataInner;
