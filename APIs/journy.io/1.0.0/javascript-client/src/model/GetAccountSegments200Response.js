...
import GetAccountSegments200ResponseAllOfDataInner from './GetAccountSegments200ResponseAllOfDataInner';

/**
 * The GetAccountSegments200Response model module.
 * @module model/GetAccountSegments200Response
 * @version 1.0.0
 */
class GetAccountSegments200Response {
    /**
     * Constructs a new <code>GetAccountSegments200Response</code>.
     * @alias module:model/GetAccountSegments200Response
     * @param meta {module:model/DeleteAccount202ResponseAllOfMeta} 
     * @param data {Array.<module:model/GetAccountSegments200ResponseAllOfDataInner>} 
     */
    constructor(meta, data) { 
        
        GetAccountSegments200Response.initialize(this, meta, data);
    }
    ...
    /**
     * Constructs a <code>GetAccountSegments200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAccountSegments200Response} obj Optional instance to populate.
     * @return {module:model/GetAccountSegments200Response} The populated <code>GetAccountSegments200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAccountSegments200Response();

            if (data.hasOwnProperty('meta')) {
                obj['meta'] = DeleteAccount202ResponseAllOfMeta.constructFromObject(data['meta']);
            }
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [GetAccountSegments200ResponseAllOfDataInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAccountSegments200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAccountSegments200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetAccountSegments200Response.RequiredProperties) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                GetAccountSegments200ResponseAllOfDataInner.validateJSON(item);
            };
        }
...
GetAccountSegments200Response.RequiredProperties = ["meta", "data"];

/**
 * @member {module:model/DeleteAccount202ResponseAllOfMeta} meta
 */
GetAccountSegments200Response.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/GetAccountSegments200ResponseAllOfDataInner>} data
 */
GetAccountSegments200Response.prototype['data'] = undefined;
...
export default GetAccountSegments200Response;
