...
/**
 * The TrackEventRequestMetadataValue model module.
 * @module model/TrackEventRequestMetadataValue
 * @version 1.0.0
 */
class TrackEventRequestMetadataValue {
    /**
     * Constructs a new <code>TrackEventRequestMetadataValue</code>.
     * @alias module:model/TrackEventRequestMetadataValue
     * @param {(module:model/Boolean|module:model/Number|module:model/String)} instance The actual instance to initialize TrackEventRequestMetadataValue.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `TrackEventRequestMetadataValue` with oneOf schemas Boolean, Number, String. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `TrackEventRequestMetadataValue` with oneOf schemas Boolean, Number, String. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>TrackEventRequestMetadataValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrackEventRequestMetadataValue} obj Optional instance to populate.
     * @return {module:model/TrackEventRequestMetadataValue} The populated <code>TrackEventRequestMetadataValue</code> instance.
     */
    static constructFromObject(data, obj) {
        return new TrackEventRequestMetadataValue(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = TrackEventRequestMetadataValue.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of TrackEventRequestMetadataValue from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/TrackEventRequestMetadataValue} An instance of TrackEventRequestMetadataValue.
     */
    static fromJSON = function(json_string){
        return TrackEventRequestMetadataValue.constructFromObject(JSON.parse(json_string));
    }
}


TrackEventRequestMetadataValue.OneOf = ["Boolean", "Number", "String"];

export default TrackEventRequestMetadataValue;
