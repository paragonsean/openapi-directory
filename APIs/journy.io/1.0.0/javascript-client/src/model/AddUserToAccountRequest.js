...
import AddUserToAccountRequestUsersInner from './AddUserToAccountRequestUsersInner';
import DeleteAccountRequestIdentification from './DeleteAccountRequestIdentification';

/**
 * The AddUserToAccountRequest model module.
 * @module model/AddUserToAccountRequest
 * @version 1.0.0
 */
class AddUserToAccountRequest {
    /**
     * Constructs a new <code>AddUserToAccountRequest</code>.
     * The identification for user and account
     * @alias module:model/AddUserToAccountRequest
     * @param account {module:model/DeleteAccountRequestIdentification} 
     * @param users {Array.<module:model/AddUserToAccountRequestUsersInner>} 
     */
    constructor(account, users) { 
        
        AddUserToAccountRequest.initialize(this, account, users);
    }
     ...
     */
    static initialize(obj, account, users) { 
        obj['account'] = account;
        obj['users'] = users;
    }

    /**
     * Constructs a <code>AddUserToAccountRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddUserToAccountRequest} obj Optional instance to populate.
     * @return {module:model/AddUserToAccountRequest} The populated <code>AddUserToAccountRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddUserToAccountRequest();

            if (data.hasOwnProperty('account')) {
                obj['account'] = DeleteAccountRequestIdentification.constructFromObject(data['account']);
            }
            if (data.hasOwnProperty('users')) {
                obj['users'] = ApiClient.convertToType(data['users'], [AddUserToAccountRequestUsersInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddUserToAccountRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddUserToAccountRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddUserToAccountRequest.RequiredProperties) {
        ...
        if (data['account']) { // data not null
          DeleteAccountRequestIdentification.validateJSON(data['account']);
        }
        if (data['users']) { // data not null
            ...
            for (const item of data['users']) {
                AddUserToAccountRequestUsersInner.validateJSON(item);
            };
        }
...
AddUserToAccountRequest.RequiredProperties = ["account", "users"];

/**
 * @member {module:model/DeleteAccountRequestIdentification} account
 */
AddUserToAccountRequest.prototype['account'] = undefined;

/**
 * @member {Array.<module:model/AddUserToAccountRequestUsersInner>} users
 */
AddUserToAccountRequest.prototype['users'] = undefined;
...
export default AddUserToAccountRequest;
