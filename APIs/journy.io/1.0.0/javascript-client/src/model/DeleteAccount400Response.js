...
import DeleteAccount400ResponseAllOfErrors from './DeleteAccount400ResponseAllOfErrors';

/**
 * The DeleteAccount400Response model module.
 * @module model/DeleteAccount400Response
 * @version 1.0.0
 */
class DeleteAccount400Response {
    /**
     * Constructs a new <code>DeleteAccount400Response</code>.
     * @alias module:model/DeleteAccount400Response
     * @param meta {module:model/DeleteAccount202ResponseAllOfMeta} 
     * @param message {String} 
     * @param errors {module:model/DeleteAccount400ResponseAllOfErrors} 
     */
    constructor(meta, message, errors) { 
        
        DeleteAccount400Response.initialize(this, meta, message, errors);
    }
     ...
     */
    static initialize(obj, meta, message, errors) { 
        obj['meta'] = meta;
        obj['message'] = message;
        obj['errors'] = errors;
    }
    ...
    /**
     * Constructs a <code>DeleteAccount400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteAccount400Response} obj Optional instance to populate.
     * @return {module:model/DeleteAccount400Response} The populated <code>DeleteAccount400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteAccount400Response();
            ...
            if (data.hasOwnProperty('errors')) {
                obj['errors'] = DeleteAccount400ResponseAllOfErrors.constructFromObject(data['errors']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAccount400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAccount400Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteAccount400Response.RequiredProperties) {
        ...
        if (data['errors']) { // data not null
          DeleteAccount400ResponseAllOfErrors.validateJSON(data['errors']);
        }
...
DeleteAccount400Response.RequiredProperties = ["meta", "message", "errors"];

/**
 * @member {module:model/DeleteAccount202ResponseAllOfMeta} meta
 */
DeleteAccount400Response.prototype['meta'] = undefined;

/**
 * @member {String} message
 */
DeleteAccount400Response.prototype['message'] = undefined;

/**
 * @member {module:model/DeleteAccount400ResponseAllOfErrors} errors
 */
DeleteAccount400Response.prototype['errors'] = undefined;
...
export default DeleteAccount400Response;
