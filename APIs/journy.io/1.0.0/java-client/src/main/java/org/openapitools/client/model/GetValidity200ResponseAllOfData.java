...
public class GetValidity200ResponseAllOfData {
  public static final String SERIALIZED_NAME_PERMISSIONS = "permissions";
  @SerializedName(SERIALIZED_NAME_PERMISSIONS)
  private List<String> permissions = new ArrayList<>();

  public GetValidity200ResponseAllOfData() {
  }

  public GetValidity200ResponseAllOfData permissions(List<String> permissions) {
    this.permissions = permissions;
    return this;
  }

  public GetValidity200ResponseAllOfData addPermissionsItem(String permissionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetValidity200ResponseAllOfData getValidity200ResponseAllOfData = (GetValidity200ResponseAllOfData) o;
    return Objects.equals(this.permissions, getValidity200ResponseAllOfData.permissions);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetValidity200ResponseAllOfData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetValidity200ResponseAllOfData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetValidity200ResponseAllOfData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetValidity200ResponseAllOfData is not found in the empty JSON string", GetValidity200ResponseAllOfData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetValidity200ResponseAllOfData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetValidity200ResponseAllOfData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetValidity200ResponseAllOfData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetValidity200ResponseAllOfData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetValidity200ResponseAllOfData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetValidity200ResponseAllOfData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetValidity200ResponseAllOfData.class));

       return (TypeAdapter<T>) new TypeAdapter<GetValidity200ResponseAllOfData>() {
           @Override
           public void write(JsonWriter out, GetValidity200ResponseAllOfData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetValidity200ResponseAllOfData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetValidity200ResponseAllOfData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetValidity200ResponseAllOfData
   * @throws IOException if the JSON string is invalid with respect to GetValidity200ResponseAllOfData
   */
  public static GetValidity200ResponseAllOfData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetValidity200ResponseAllOfData.class);
  }

  /**
   * Convert an instance of GetValidity200ResponseAllOfData to an JSON string
   *
   * @return JSON string
   */
