...
import org.openapitools.client.model.GetAccountProperties200ResponseAllOfDataInnerGroup;
...
public class GetAccountProperties200ResponseAllOfDataInner {
  public static final String SERIALIZED_NAME_GROUP = "group";
  @SerializedName(SERIALIZED_NAME_GROUP)
  private GetAccountProperties200ResponseAllOfDataInnerGroup group;

  public static final String SERIALIZED_NAME_IS_COMPUTED = "isComputed";
  @SerializedName(SERIALIZED_NAME_IS_COMPUTED)
  ...
  public GetAccountProperties200ResponseAllOfDataInner() {
  }

  public GetAccountProperties200ResponseAllOfDataInner group(GetAccountProperties200ResponseAllOfDataInnerGroup group) {
    this.group = group;
    return this;
  }
  ...
  public GetAccountProperties200ResponseAllOfDataInnerGroup getGroup() {
    return group;
  }

  public void setGroup(GetAccountProperties200ResponseAllOfDataInnerGroup group) {
    this.group = group;
  }


  public GetAccountProperties200ResponseAllOfDataInner isComputed(Boolean isComputed) {
  ...
  public GetAccountProperties200ResponseAllOfDataInner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public GetAccountProperties200ResponseAllOfDataInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetAccountProperties200ResponseAllOfDataInner getAccountProperties200ResponseAllOfDataInner = (GetAccountProperties200ResponseAllOfDataInner) o;
    return Objects.equals(this.group, getAccountProperties200ResponseAllOfDataInner.group) &&
        Objects.equals(this.isComputed, getAccountProperties200ResponseAllOfDataInner.isComputed) &&
        Objects.equals(this.label, getAccountProperties200ResponseAllOfDataInner.label) &&
        Objects.equals(this.name, getAccountProperties200ResponseAllOfDataInner.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(group, isComputed, label, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetAccountProperties200ResponseAllOfDataInner {\n");
  ...
  static {
    ...
    openapiFields.add("isComputed");
    openapiFields.add("label");
    openapiFields.add("name");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("isComputed");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAccountProperties200ResponseAllOfDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAccountProperties200ResponseAllOfDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAccountProperties200ResponseAllOfDataInner is not found in the empty JSON string", GetAccountProperties200ResponseAllOfDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAccountProperties200ResponseAllOfDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAccountProperties200ResponseAllOfDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetAccountProperties200ResponseAllOfDataInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("group") != null && !jsonObj.get("group").isJsonNull()) {
        GetAccountProperties200ResponseAllOfDataInnerGroup.validateJsonElement(jsonObj.get("group"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAccountProperties200ResponseAllOfDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAccountProperties200ResponseAllOfDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAccountProperties200ResponseAllOfDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAccountProperties200ResponseAllOfDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAccountProperties200ResponseAllOfDataInner>() {
           @Override
           public void write(JsonWriter out, GetAccountProperties200ResponseAllOfDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAccountProperties200ResponseAllOfDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAccountProperties200ResponseAllOfDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAccountProperties200ResponseAllOfDataInner
   * @throws IOException if the JSON string is invalid with respect to GetAccountProperties200ResponseAllOfDataInner
   */
  public static GetAccountProperties200ResponseAllOfDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAccountProperties200ResponseAllOfDataInner.class);
  }

  /**
   * Convert an instance of GetAccountProperties200ResponseAllOfDataInner to an JSON string
   *
   * @return JSON string
   */
