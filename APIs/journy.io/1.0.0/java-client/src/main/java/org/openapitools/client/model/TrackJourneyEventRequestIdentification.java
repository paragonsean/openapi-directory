...
public class TrackJourneyEventRequestIdentification {
  ...
  private AddUserToAccountRequestUsersInnerIdentification user;

  public TrackJourneyEventRequestIdentification() {
  }

  public TrackJourneyEventRequestIdentification account(DeleteAccountRequestIdentification account) {
  ...
  public TrackJourneyEventRequestIdentification user(AddUserToAccountRequestUsersInnerIdentification user) {
    this.user = user;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public AddUserToAccountRequestUsersInnerIdentification getUser() {
    return user;
  }

  public void setUser(AddUserToAccountRequestUsersInnerIdentification user) {
    this.user = user;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrackJourneyEventRequestIdentification trackJourneyEventRequestIdentification = (TrackJourneyEventRequestIdentification) o;
    return Objects.equals(this.account, trackJourneyEventRequestIdentification.account) &&
        Objects.equals(this.user, trackJourneyEventRequestIdentification.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrackJourneyEventRequestIdentification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrackJourneyEventRequestIdentification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackJourneyEventRequestIdentification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackJourneyEventRequestIdentification is not found in the empty JSON string", TrackJourneyEventRequestIdentification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackJourneyEventRequestIdentification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackJourneyEventRequestIdentification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("user") != null && !jsonObj.get("user").isJsonNull()) {
        AddUserToAccountRequestUsersInnerIdentification.validateJsonElement(jsonObj.get("user"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackJourneyEventRequestIdentification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackJourneyEventRequestIdentification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackJourneyEventRequestIdentification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackJourneyEventRequestIdentification.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackJourneyEventRequestIdentification>() {
           @Override
           public void write(JsonWriter out, TrackJourneyEventRequestIdentification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackJourneyEventRequestIdentification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrackJourneyEventRequestIdentification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrackJourneyEventRequestIdentification
   * @throws IOException if the JSON string is invalid with respect to TrackJourneyEventRequestIdentification
   */
  public static TrackJourneyEventRequestIdentification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackJourneyEventRequestIdentification.class);
  }

  /**
   * Convert an instance of TrackJourneyEventRequestIdentification to an JSON string
   *
   * @return JSON string
   */
