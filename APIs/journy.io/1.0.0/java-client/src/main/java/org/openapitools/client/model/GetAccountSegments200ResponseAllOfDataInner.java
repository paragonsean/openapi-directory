...
public class GetAccountSegments200ResponseAllOfDataInner {
  ...
  public GetAccountSegments200ResponseAllOfDataInner() {
  }

  public GetAccountSegments200ResponseAllOfDataInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetAccountSegments200ResponseAllOfDataInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetAccountSegments200ResponseAllOfDataInner getAccountSegments200ResponseAllOfDataInner = (GetAccountSegments200ResponseAllOfDataInner) o;
    return Objects.equals(this.id, getAccountSegments200ResponseAllOfDataInner.id) &&
        Objects.equals(this.name, getAccountSegments200ResponseAllOfDataInner.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAccountSegments200ResponseAllOfDataInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAccountSegments200ResponseAllOfDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAccountSegments200ResponseAllOfDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAccountSegments200ResponseAllOfDataInner is not found in the empty JSON string", GetAccountSegments200ResponseAllOfDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAccountSegments200ResponseAllOfDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAccountSegments200ResponseAllOfDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetAccountSegments200ResponseAllOfDataInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAccountSegments200ResponseAllOfDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAccountSegments200ResponseAllOfDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAccountSegments200ResponseAllOfDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAccountSegments200ResponseAllOfDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAccountSegments200ResponseAllOfDataInner>() {
           @Override
           public void write(JsonWriter out, GetAccountSegments200ResponseAllOfDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAccountSegments200ResponseAllOfDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAccountSegments200ResponseAllOfDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAccountSegments200ResponseAllOfDataInner
   * @throws IOException if the JSON string is invalid with respect to GetAccountSegments200ResponseAllOfDataInner
   */
  public static GetAccountSegments200ResponseAllOfDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAccountSegments200ResponseAllOfDataInner.class);
  }

  /**
   * Convert an instance of GetAccountSegments200ResponseAllOfDataInner to an JSON string
   *
   * @return JSON string
   */
