...
public class GetAccountProperties200ResponseAllOfDataInnerGroup {
  ...
  public GetAccountProperties200ResponseAllOfDataInnerGroup() {
  }

  public GetAccountProperties200ResponseAllOfDataInnerGroup id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetAccountProperties200ResponseAllOfDataInnerGroup name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetAccountProperties200ResponseAllOfDataInnerGroup getAccountProperties200ResponseAllOfDataInnerGroup = (GetAccountProperties200ResponseAllOfDataInnerGroup) o;
    return Objects.equals(this.id, getAccountProperties200ResponseAllOfDataInnerGroup.id) &&
        Objects.equals(this.name, getAccountProperties200ResponseAllOfDataInnerGroup.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAccountProperties200ResponseAllOfDataInnerGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAccountProperties200ResponseAllOfDataInnerGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAccountProperties200ResponseAllOfDataInnerGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAccountProperties200ResponseAllOfDataInnerGroup is not found in the empty JSON string", GetAccountProperties200ResponseAllOfDataInnerGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAccountProperties200ResponseAllOfDataInnerGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAccountProperties200ResponseAllOfDataInnerGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetAccountProperties200ResponseAllOfDataInnerGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAccountProperties200ResponseAllOfDataInnerGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAccountProperties200ResponseAllOfDataInnerGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAccountProperties200ResponseAllOfDataInnerGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAccountProperties200ResponseAllOfDataInnerGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAccountProperties200ResponseAllOfDataInnerGroup>() {
           @Override
           public void write(JsonWriter out, GetAccountProperties200ResponseAllOfDataInnerGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAccountProperties200ResponseAllOfDataInnerGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAccountProperties200ResponseAllOfDataInnerGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAccountProperties200ResponseAllOfDataInnerGroup
   * @throws IOException if the JSON string is invalid with respect to GetAccountProperties200ResponseAllOfDataInnerGroup
   */
  public static GetAccountProperties200ResponseAllOfDataInnerGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAccountProperties200ResponseAllOfDataInnerGroup.class);
  }

  /**
   * Convert an instance of GetAccountProperties200ResponseAllOfDataInnerGroup to an JSON string
   *
   * @return JSON string
   */
