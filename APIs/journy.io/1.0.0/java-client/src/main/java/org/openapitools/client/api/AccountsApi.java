...
import org.openapitools.client.model.AddUserToAccountRequest;
import org.openapitools.client.model.DeleteAccount202Response;
import org.openapitools.client.model.DeleteAccount400Response;
import org.openapitools.client.model.DeleteAccountRequest;
import org.openapitools.client.model.UpsertAccount201Response;
import org.openapitools.client.model.UpsertAccountRequest;
...
public class AccountsApi {
     ...
     * @param addUserToAccountRequest  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> Object was created </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request, some fields or parameters are incorrect </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 401 </td><td> No API Key was provided or the key is not authorised to perform the action </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 429 </td><td> Too many API requests were send </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 500 </td><td> An unexpected error occurred </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
     </table>
     */
    public okhttp3.Call addUserToAccountCall(AddUserToAccountRequest addUserToAccountRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = addUserToAccountRequest;

        // create path and map variables
        String localVarPath = "/accounts/users/add";
    ...
    private okhttp3.Call addUserToAccountValidateBeforeCall(AddUserToAccountRequest addUserToAccountRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'addUserToAccountRequest' is set
        if (addUserToAccountRequest == null) {
            throw new ApiException("Missing the required parameter 'addUserToAccountRequest' when calling addUserToAccount(Async)");
        }

        return addUserToAccountCall(addUserToAccountRequest, _callback);
     ...
     * @param addUserToAccountRequest  (required)
     * @return DeleteAccount202Response
     ...
     */
    public DeleteAccount202Response addUserToAccount(AddUserToAccountRequest addUserToAccountRequest) throws ApiException {
        ApiResponse<DeleteAccount202Response> localVarResp = addUserToAccountWithHttpInfo(addUserToAccountRequest);
     ...
     * You can add up to 100 users to an account.
     * @param addUserToAccountRequest  (required)
     * @return ApiResponse&lt;DeleteAccount202Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<DeleteAccount202Response> addUserToAccountWithHttpInfo(AddUserToAccountRequest addUserToAccountRequest) throws ApiException {
        okhttp3.Call localVarCall = addUserToAccountValidateBeforeCall(addUserToAccountRequest, null);
        Type localVarReturnType = new TypeToken<DeleteAccount202Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Add users to an account (asynchronously)
     * You can add up to 100 users to an account.
     * @param addUserToAccountRequest  (required)
     ...
     */
    public okhttp3.Call addUserToAccountAsync(AddUserToAccountRequest addUserToAccountRequest, final ApiCallback<DeleteAccount202Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = addUserToAccountValidateBeforeCall(addUserToAccountRequest, _callback);
        Type localVarReturnType = new TypeToken<DeleteAccount202Response>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 202 </td><td> Accepted </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request, some fields or parameters are incorrect </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 401 </td><td> No API Key was provided or the key is not authorised to perform the action </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 403 </td><td> The API Key provided is currently not enabled </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 429 </td><td> Too many API requests were send </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 500 </td><td> An unexpected error occurred </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
     </table>
     */
    public okhttp3.Call deleteAccountCall(DeleteAccountRequest deleteAccountRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = deleteAccountRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteAccountValidateBeforeCall(DeleteAccountRequest deleteAccountRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'deleteAccountRequest' is set
        if (deleteAccountRequest == null) {
            throw new ApiException("Missing the required parameter 'deleteAccountRequest' when calling deleteAccount(Async)");
        }

        return deleteAccountCall(deleteAccountRequest, _callback);
     ...
     */
    public DeleteAccount202Response deleteAccount(DeleteAccountRequest deleteAccountRequest) throws ApiException {
        ApiResponse<DeleteAccount202Response> localVarResp = deleteAccountWithHttpInfo(deleteAccountRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DeleteAccount202Response> deleteAccountWithHttpInfo(DeleteAccountRequest deleteAccountRequest) throws ApiException {
        okhttp3.Call localVarCall = deleteAccountValidateBeforeCall(deleteAccountRequest, null);
        Type localVarReturnType = new TypeToken<DeleteAccount202Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call deleteAccountAsync(DeleteAccountRequest deleteAccountRequest, final ApiCallback<DeleteAccount202Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteAccountValidateBeforeCall(deleteAccountRequest, _callback);
        Type localVarReturnType = new TypeToken<DeleteAccount202Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> No content </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request, some fields or parameters are incorrect </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 401 </td><td> No API Key was provided or the key is not authorised to perform the action </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 429 </td><td> Too many API requests were send </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 500 </td><td> An unexpected error occurred </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
     ...
     */
    public okhttp3.Call removeUserFromAccountCall(AddUserToAccountRequest addUserToAccountRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/accounts/users/remove";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeUserFromAccountValidateBeforeCall(AddUserToAccountRequest addUserToAccountRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'addUserToAccountRequest' is set
        if (addUserToAccountRequest == null) {
            throw new ApiException("Missing the required parameter 'addUserToAccountRequest' when calling removeUserFromAccount(Async)");
        }

        return removeUserFromAccountCall(addUserToAccountRequest, _callback);
     ...
     */
    public DeleteAccount202Response removeUserFromAccount(AddUserToAccountRequest addUserToAccountRequest) throws ApiException {
        ApiResponse<DeleteAccount202Response> localVarResp = removeUserFromAccountWithHttpInfo(addUserToAccountRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DeleteAccount202Response> removeUserFromAccountWithHttpInfo(AddUserToAccountRequest addUserToAccountRequest) throws ApiException {
        okhttp3.Call localVarCall = removeUserFromAccountValidateBeforeCall(addUserToAccountRequest, null);
        Type localVarReturnType = new TypeToken<DeleteAccount202Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Remove user from account (asynchronously)
     * You can remove up to 100 users from an account.  When removing a user, the user will still be stored in journy.io, but marked as \&quot;removed\&quot;. 
     * @param addUserToAccountRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call removeUserFromAccountAsync(AddUserToAccountRequest addUserToAccountRequest, final ApiCallback<DeleteAccount202Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = removeUserFromAccountValidateBeforeCall(addUserToAccountRequest, _callback);
        Type localVarReturnType = new TypeToken<DeleteAccount202Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param upsertAccountRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Account will be created </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request, some fields or parameters are incorrect </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 401 </td><td> No API Key was provided or the key is not authorised to perform the action </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 403 </td><td> The API Key provided is currently not enabled </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 429 </td><td> Too many API requests were send </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
     ...
     */
    public okhttp3.Call upsertAccountCall(UpsertAccountRequest upsertAccountRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = upsertAccountRequest;

        // create path and map variables
        String localVarPath = "/accounts/upsert";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertAccountValidateBeforeCall(UpsertAccountRequest upsertAccountRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'upsertAccountRequest' is set
        if (upsertAccountRequest == null) {
            throw new ApiException("Missing the required parameter 'upsertAccountRequest' when calling upsertAccount(Async)");
        }

        return upsertAccountCall(upsertAccountRequest, _callback);
     ...
     * @param upsertAccountRequest  (required)
     * @return UpsertAccount201Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public UpsertAccount201Response upsertAccount(UpsertAccountRequest upsertAccountRequest) throws ApiException {
        ApiResponse<UpsertAccount201Response> localVarResp = upsertAccountWithHttpInfo(upsertAccountRequest);
        return localVarResp.getData();
    }
     ...
     * Endpoint used to create or update an account.
     * @param upsertAccountRequest  (required)
     * @return ApiResponse&lt;UpsertAccount201Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<UpsertAccount201Response> upsertAccountWithHttpInfo(UpsertAccountRequest upsertAccountRequest) throws ApiException {
        okhttp3.Call localVarCall = upsertAccountValidateBeforeCall(upsertAccountRequest, null);
        Type localVarReturnType = new TypeToken<UpsertAccount201Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create or update account (asynchronously)
     * Endpoint used to create or update an account.
     * @param upsertAccountRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call upsertAccountAsync(UpsertAccountRequest upsertAccountRequest, final ApiCallback<UpsertAccount201Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertAccountValidateBeforeCall(upsertAccountRequest, _callback);
        Type localVarReturnType = new TypeToken<UpsertAccount201Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
