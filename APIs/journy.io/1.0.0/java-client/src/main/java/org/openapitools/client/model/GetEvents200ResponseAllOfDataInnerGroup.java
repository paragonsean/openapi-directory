...
public class GetEvents200ResponseAllOfDataInnerGroup {
  ...
  public GetEvents200ResponseAllOfDataInnerGroup() {
  }

  public GetEvents200ResponseAllOfDataInnerGroup id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetEvents200ResponseAllOfDataInnerGroup name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetEvents200ResponseAllOfDataInnerGroup getEvents200ResponseAllOfDataInnerGroup = (GetEvents200ResponseAllOfDataInnerGroup) o;
    return Objects.equals(this.id, getEvents200ResponseAllOfDataInnerGroup.id) &&
        Objects.equals(this.name, getEvents200ResponseAllOfDataInnerGroup.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEvents200ResponseAllOfDataInnerGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetEvents200ResponseAllOfDataInnerGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEvents200ResponseAllOfDataInnerGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEvents200ResponseAllOfDataInnerGroup is not found in the empty JSON string", GetEvents200ResponseAllOfDataInnerGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEvents200ResponseAllOfDataInnerGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEvents200ResponseAllOfDataInnerGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetEvents200ResponseAllOfDataInnerGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEvents200ResponseAllOfDataInnerGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEvents200ResponseAllOfDataInnerGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEvents200ResponseAllOfDataInnerGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEvents200ResponseAllOfDataInnerGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEvents200ResponseAllOfDataInnerGroup>() {
           @Override
           public void write(JsonWriter out, GetEvents200ResponseAllOfDataInnerGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEvents200ResponseAllOfDataInnerGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetEvents200ResponseAllOfDataInnerGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetEvents200ResponseAllOfDataInnerGroup
   * @throws IOException if the JSON string is invalid with respect to GetEvents200ResponseAllOfDataInnerGroup
   */
  public static GetEvents200ResponseAllOfDataInnerGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEvents200ResponseAllOfDataInnerGroup.class);
  }

  /**
   * Convert an instance of GetEvents200ResponseAllOfDataInnerGroup to an JSON string
   *
   * @return JSON string
   */
