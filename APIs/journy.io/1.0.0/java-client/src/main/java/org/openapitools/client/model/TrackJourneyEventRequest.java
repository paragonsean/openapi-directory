...
import org.openapitools.client.model.TrackJourneyEventRequestIdentification;
import org.openapitools.client.model.TrackJourneyEventRequestMetadataValue;
...
public class TrackJourneyEventRequest {
  ...
  private TrackJourneyEventRequestIdentification identification;

  public static final String SERIALIZED_NAME_METADATA = "metadata";
  @SerializedName(SERIALIZED_NAME_METADATA)
  private Map<String, TrackJourneyEventRequestMetadataValue> metadata = new HashMap<>();
  ...
  public TrackJourneyEventRequest() {
  }

  public TrackJourneyEventRequest identification(TrackJourneyEventRequestIdentification identification) {
  ...
  public TrackJourneyEventRequestIdentification getIdentification() {
    return identification;
  }

  public void setIdentification(TrackJourneyEventRequestIdentification identification) {
    this.identification = identification;
  }


  public TrackJourneyEventRequest metadata(Map<String, TrackJourneyEventRequestMetadataValue> metadata) {
    this.metadata = metadata;
    return this;
  }

  public TrackJourneyEventRequest putMetadataItem(String key, TrackJourneyEventRequestMetadataValue metadataItem) {
  ...
  public Map<String, TrackJourneyEventRequestMetadataValue> getMetadata() {
    return metadata;
  }

  public void setMetadata(Map<String, TrackJourneyEventRequestMetadataValue> metadata) {
    this.metadata = metadata;
  }


  public TrackJourneyEventRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TrackJourneyEventRequest triggeredAt(String triggeredAt) {
  ...
  public boolean equals(Object o) {
    ...
    TrackJourneyEventRequest trackJourneyEventRequest = (TrackJourneyEventRequest) o;
    return Objects.equals(this.identification, trackJourneyEventRequest.identification) &&
        Objects.equals(this.metadata, trackJourneyEventRequest.metadata) &&
        Objects.equals(this.name, trackJourneyEventRequest.name) &&
        Objects.equals(this.triggeredAt, trackJourneyEventRequest.triggeredAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identification, metadata, name, triggeredAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrackJourneyEventRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrackJourneyEventRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackJourneyEventRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackJourneyEventRequest is not found in the empty JSON string", TrackJourneyEventRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackJourneyEventRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackJourneyEventRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrackJourneyEventRequest.openapiRequiredFields) {
      ...
      TrackJourneyEventRequestIdentification.validateJsonElement(jsonObj.get("identification"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackJourneyEventRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackJourneyEventRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackJourneyEventRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackJourneyEventRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackJourneyEventRequest>() {
           @Override
           public void write(JsonWriter out, TrackJourneyEventRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackJourneyEventRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrackJourneyEventRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrackJourneyEventRequest
   * @throws IOException if the JSON string is invalid with respect to TrackJourneyEventRequest
   */
  public static TrackJourneyEventRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackJourneyEventRequest.class);
  }

  /**
   * Convert an instance of TrackJourneyEventRequest to an JSON string
   *
   * @return JSON string
   */
