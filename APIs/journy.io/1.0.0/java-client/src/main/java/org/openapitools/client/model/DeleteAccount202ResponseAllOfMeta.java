...
public class DeleteAccount202ResponseAllOfMeta {
  ...
  public DeleteAccount202ResponseAllOfMeta() {
  }

  public DeleteAccount202ResponseAllOfMeta requestId(String requestId) {
  ...
  public DeleteAccount202ResponseAllOfMeta status(BigDecimal status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteAccount202ResponseAllOfMeta deleteAccount202ResponseAllOfMeta = (DeleteAccount202ResponseAllOfMeta) o;
    return Objects.equals(this.requestId, deleteAccount202ResponseAllOfMeta.requestId) &&
        Objects.equals(this.status, deleteAccount202ResponseAllOfMeta.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteAccount202ResponseAllOfMeta {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAccount202ResponseAllOfMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAccount202ResponseAllOfMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAccount202ResponseAllOfMeta is not found in the empty JSON string", DeleteAccount202ResponseAllOfMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAccount202ResponseAllOfMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAccount202ResponseAllOfMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteAccount202ResponseAllOfMeta.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAccount202ResponseAllOfMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAccount202ResponseAllOfMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAccount202ResponseAllOfMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAccount202ResponseAllOfMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAccount202ResponseAllOfMeta>() {
           @Override
           public void write(JsonWriter out, DeleteAccount202ResponseAllOfMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAccount202ResponseAllOfMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAccount202ResponseAllOfMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAccount202ResponseAllOfMeta
   * @throws IOException if the JSON string is invalid with respect to DeleteAccount202ResponseAllOfMeta
   */
  public static DeleteAccount202ResponseAllOfMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAccount202ResponseAllOfMeta.class);
  }

  /**
   * Convert an instance of DeleteAccount202ResponseAllOfMeta to an JSON string
   *
   * @return JSON string
   */
