...
import org.openapitools.client.model.DeleteAccount202ResponseAllOfMeta;
import org.openapitools.client.model.GetAccountProperties200ResponseAllOfDataInner;
...
public class GetAccountProperties200Response {
  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private DeleteAccount202ResponseAllOfMeta meta;

  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<GetAccountProperties200ResponseAllOfDataInner> data = new ArrayList<>();

  public GetAccountProperties200Response() {
  }

  public GetAccountProperties200Response meta(DeleteAccount202ResponseAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public DeleteAccount202ResponseAllOfMeta getMeta() {
    return meta;
  }

  public void setMeta(DeleteAccount202ResponseAllOfMeta meta) {
    this.meta = meta;
  }


  public GetAccountProperties200Response data(List<GetAccountProperties200ResponseAllOfDataInner> data) {
    this.data = data;
    return this;
  }

  public GetAccountProperties200Response addDataItem(GetAccountProperties200ResponseAllOfDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<GetAccountProperties200ResponseAllOfDataInner> getData() {
    return data;
  }

  public void setData(List<GetAccountProperties200ResponseAllOfDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetAccountProperties200Response getAccountProperties200Response = (GetAccountProperties200Response) o;
    return Objects.equals(this.meta, getAccountProperties200Response.meta) &&
        Objects.equals(this.data, getAccountProperties200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAccountProperties200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAccountProperties200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAccountProperties200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAccountProperties200Response is not found in the empty JSON string", GetAccountProperties200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAccountProperties200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAccountProperties200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetAccountProperties200Response.openapiRequiredFields) {
      ...
      DeleteAccount202ResponseAllOfMeta.validateJsonElement(jsonObj.get("meta"));
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        GetAccountProperties200ResponseAllOfDataInner.validateJsonElement(jsonArraydata.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAccountProperties200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAccountProperties200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAccountProperties200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAccountProperties200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAccountProperties200Response>() {
           @Override
           public void write(JsonWriter out, GetAccountProperties200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAccountProperties200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAccountProperties200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAccountProperties200Response
   * @throws IOException if the JSON string is invalid with respect to GetAccountProperties200Response
   */
  public static GetAccountProperties200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAccountProperties200Response.class);
  }

  /**
   * Convert an instance of GetAccountProperties200Response to an JSON string
   *
   * @return JSON string
   */
