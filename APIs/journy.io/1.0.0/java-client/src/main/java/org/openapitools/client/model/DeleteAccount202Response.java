...
public class DeleteAccount202Response {
  ...
  public DeleteAccount202Response() {
  }

  public DeleteAccount202Response meta(DeleteAccount202ResponseAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public DeleteAccount202Response message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteAccount202Response deleteAccount202Response = (DeleteAccount202Response) o;
    return Objects.equals(this.meta, deleteAccount202Response.meta) &&
        Objects.equals(this.message, deleteAccount202Response.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, message);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteAccount202Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAccount202Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAccount202Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAccount202Response is not found in the empty JSON string", DeleteAccount202Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAccount202Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAccount202Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteAccount202Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAccount202Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAccount202Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAccount202Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAccount202Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAccount202Response>() {
           @Override
           public void write(JsonWriter out, DeleteAccount202Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAccount202Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAccount202Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAccount202Response
   * @throws IOException if the JSON string is invalid with respect to DeleteAccount202Response
   */
  public static DeleteAccount202Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAccount202Response.class);
  }

  /**
   * Convert an instance of DeleteAccount202Response to an JSON string
   *
   * @return JSON string
   */
