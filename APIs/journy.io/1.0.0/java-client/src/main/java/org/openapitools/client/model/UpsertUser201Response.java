...
public class UpsertUser201Response {
  ...
  public UpsertUser201Response() {
  }

  public UpsertUser201Response meta(DeleteAccount202ResponseAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public UpsertUser201Response message(String message) {
  ...
  public UpsertUser201Response rejected(Map<String, String> rejected) {
    this.rejected = rejected;
    return this;
  }

  public UpsertUser201Response putRejectedItem(String key, String rejectedItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpsertUser201Response upsertUser201Response = (UpsertUser201Response) o;
    return Objects.equals(this.meta, upsertUser201Response.meta) &&
        Objects.equals(this.message, upsertUser201Response.message) &&
        Objects.equals(this.rejected, upsertUser201Response.rejected);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, message, rejected);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpsertUser201Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpsertUser201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertUser201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertUser201Response is not found in the empty JSON string", UpsertUser201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpsertUser201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertUser201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpsertUser201Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertUser201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertUser201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertUser201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertUser201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertUser201Response>() {
           @Override
           public void write(JsonWriter out, UpsertUser201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertUser201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpsertUser201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpsertUser201Response
   * @throws IOException if the JSON string is invalid with respect to UpsertUser201Response
   */
  public static UpsertUser201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertUser201Response.class);
  }

  /**
   * Convert an instance of UpsertUser201Response to an JSON string
   *
   * @return JSON string
   */
