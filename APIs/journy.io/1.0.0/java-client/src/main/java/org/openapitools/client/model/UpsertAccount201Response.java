...
public class UpsertAccount201Response {
  ...
  public UpsertAccount201Response() {
  }

  public UpsertAccount201Response meta(DeleteAccount202ResponseAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public UpsertAccount201Response message(String message) {
  ...
  public UpsertAccount201Response rejected(Map<String, String> rejected) {
    this.rejected = rejected;
    return this;
  }

  public UpsertAccount201Response putRejectedItem(String key, String rejectedItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpsertAccount201Response upsertAccount201Response = (UpsertAccount201Response) o;
    return Objects.equals(this.meta, upsertAccount201Response.meta) &&
        Objects.equals(this.message, upsertAccount201Response.message) &&
        Objects.equals(this.rejected, upsertAccount201Response.rejected);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpsertAccount201Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpsertAccount201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertAccount201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertAccount201Response is not found in the empty JSON string", UpsertAccount201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpsertAccount201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertAccount201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpsertAccount201Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertAccount201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertAccount201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertAccount201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertAccount201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertAccount201Response>() {
           @Override
           public void write(JsonWriter out, UpsertAccount201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertAccount201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpsertAccount201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpsertAccount201Response
   * @throws IOException if the JSON string is invalid with respect to UpsertAccount201Response
   */
  public static UpsertAccount201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertAccount201Response.class);
  }

  /**
   * Convert an instance of UpsertAccount201Response to an JSON string
   *
   * @return JSON string
   */
