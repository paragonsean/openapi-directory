...
import org.openapitools.client.model.AddUserToAccountRequestUsersInnerIdentification;
import org.openapitools.client.model.UpsertAccountRequestPropertiesValue;
...
public class UpsertUserRequest {
  ...
  private AddUserToAccountRequestUsersInnerIdentification identification;

  public static final String SERIALIZED_NAME_PROPERTIES = "properties";
  @SerializedName(SERIALIZED_NAME_PROPERTIES)
  private Map<String, UpsertAccountRequestPropertiesValue> properties = new HashMap<>();

  public UpsertUserRequest() {
  }

  public UpsertUserRequest identification(AddUserToAccountRequestUsersInnerIdentification identification) {
  ...
  public AddUserToAccountRequestUsersInnerIdentification getIdentification() {
    return identification;
  }

  public void setIdentification(AddUserToAccountRequestUsersInnerIdentification identification) {
    this.identification = identification;
  }


  public UpsertUserRequest properties(Map<String, UpsertAccountRequestPropertiesValue> properties) {
    this.properties = properties;
    return this;
  }

  public UpsertUserRequest putPropertiesItem(String key, UpsertAccountRequestPropertiesValue propertiesItem) {
  ...
  public Map<String, UpsertAccountRequestPropertiesValue> getProperties() {
    return properties;
  }

  public void setProperties(Map<String, UpsertAccountRequestPropertiesValue> properties) {
    this.properties = properties;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identification, upsertUserRequest.identification) &&
        Objects.equals(this.properties, upsertUserRequest.properties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identification, properties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpsertUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertUserRequest is not found in the empty JSON string", UpsertUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpsertUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpsertUserRequest.openapiRequiredFields) {
      ...
      AddUserToAccountRequestUsersInnerIdentification.validateJsonElement(jsonObj.get("identification"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertUserRequest>() {
           @Override
           public void write(JsonWriter out, UpsertUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpsertUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpsertUserRequest
   * @throws IOException if the JSON string is invalid with respect to UpsertUserRequest
   */
  public static UpsertUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertUserRequest.class);
  }

  /**
   * Convert an instance of UpsertUserRequest to an JSON string
   *
   * @return JSON string
   */
