...
public class GetTrackingSnippet200ResponseAllOfData {
  ...
  public GetTrackingSnippet200ResponseAllOfData() {
  }

  public GetTrackingSnippet200ResponseAllOfData domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public GetTrackingSnippet200ResponseAllOfData snippet(String snippet) {
  ...
  public boolean equals(Object o) {
    ...
    GetTrackingSnippet200ResponseAllOfData getTrackingSnippet200ResponseAllOfData = (GetTrackingSnippet200ResponseAllOfData) o;
    return Objects.equals(this.domain, getTrackingSnippet200ResponseAllOfData.domain) &&
        Objects.equals(this.snippet, getTrackingSnippet200ResponseAllOfData.snippet);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, snippet);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetTrackingSnippet200ResponseAllOfData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTrackingSnippet200ResponseAllOfData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTrackingSnippet200ResponseAllOfData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTrackingSnippet200ResponseAllOfData is not found in the empty JSON string", GetTrackingSnippet200ResponseAllOfData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTrackingSnippet200ResponseAllOfData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTrackingSnippet200ResponseAllOfData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTrackingSnippet200ResponseAllOfData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTrackingSnippet200ResponseAllOfData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTrackingSnippet200ResponseAllOfData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTrackingSnippet200ResponseAllOfData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTrackingSnippet200ResponseAllOfData.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTrackingSnippet200ResponseAllOfData>() {
           @Override
           public void write(JsonWriter out, GetTrackingSnippet200ResponseAllOfData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTrackingSnippet200ResponseAllOfData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTrackingSnippet200ResponseAllOfData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTrackingSnippet200ResponseAllOfData
   * @throws IOException if the JSON string is invalid with respect to GetTrackingSnippet200ResponseAllOfData
   */
  public static GetTrackingSnippet200ResponseAllOfData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTrackingSnippet200ResponseAllOfData.class);
  }

  /**
   * Convert an instance of GetTrackingSnippet200ResponseAllOfData to an JSON string
   *
   * @return JSON string
   */
