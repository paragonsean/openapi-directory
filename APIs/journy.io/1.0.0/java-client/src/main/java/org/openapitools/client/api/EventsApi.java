...
import org.openapitools.client.model.TrackJourneyEventRequest;
...
public class EventsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Events </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
     ...
     */
    public GetEvents200Response getEvents() throws ApiException {
        ApiResponse<GetEvents200Response> localVarResp = getEventsWithHttpInfo();
     ...
     */
    public ApiResponse<GetEvents200Response> getEventsWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call getEventsAsync(final ApiCallback<GetEvents200Response> _callback) throws ApiException {
    ...
    /**
     * Build call for trackJourneyEvent
     * @param trackJourneyEventRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    @Deprecated
    public okhttp3.Call trackJourneyEventCall(TrackJourneyEventRequest trackJourneyEventRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = trackJourneyEventRequest;
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call trackJourneyEventValidateBeforeCall(TrackJourneyEventRequest trackJourneyEventRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'trackJourneyEventRequest' is set
        if (trackJourneyEventRequest == null) {
            throw new ApiException("Missing the required parameter 'trackJourneyEventRequest' when calling trackJourneyEvent(Async)");
        }

        return trackJourneyEventCall(trackJourneyEventRequest, _callback);
     ...
     */
    @Deprecated
    public DeleteAccount202Response trackJourneyEvent(TrackJourneyEventRequest trackJourneyEventRequest) throws ApiException {
        ApiResponse<DeleteAccount202Response> localVarResp = trackJourneyEventWithHttpInfo(trackJourneyEventRequest);
        return localVarResp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<DeleteAccount202Response> trackJourneyEventWithHttpInfo(TrackJourneyEventRequest trackJourneyEventRequest) throws ApiException {
        okhttp3.Call localVarCall = trackJourneyEventValidateBeforeCall(trackJourneyEventRequest, null);
     ...
     */
    @Deprecated
    public okhttp3.Call trackJourneyEventAsync(TrackJourneyEventRequest trackJourneyEventRequest, final ApiCallback<DeleteAccount202Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = trackJourneyEventValidateBeforeCall(trackJourneyEventRequest, _callback);
        Type localVarReturnType = new TypeToken<DeleteAccount202Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
