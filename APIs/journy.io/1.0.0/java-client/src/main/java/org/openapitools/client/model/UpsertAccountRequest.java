...
public class UpsertAccountRequest {
  ...
  public UpsertAccountRequest identification(DeleteAccountRequestIdentification identification) {
  ...
  public UpsertAccountRequest properties(Map<String, UpsertAccountRequestPropertiesValue> properties) {
    this.properties = properties;
    return this;
  }

  public UpsertAccountRequest putPropertiesItem(String key, UpsertAccountRequestPropertiesValue propertiesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identification, upsertAccountRequest.identification) &&
        Objects.equals(this.properties, upsertAccountRequest.properties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpsertAccountRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsertAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsertAccountRequest is not found in the empty JSON string", UpsertAccountRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpsertAccountRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertAccountRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpsertAccountRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsertAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsertAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsertAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsertAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsertAccountRequest>() {
           @Override
           public void write(JsonWriter out, UpsertAccountRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsertAccountRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpsertAccountRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpsertAccountRequest
   * @throws IOException if the JSON string is invalid with respect to UpsertAccountRequest
   */
  public static UpsertAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsertAccountRequest.class);
  }

  /**
   * Convert an instance of UpsertAccountRequest to an JSON string
   *
   * @return JSON string
   */
