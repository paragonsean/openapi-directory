...
import org.openapitools.client.model.LinkRequest;
import org.openapitools.client.model.UpsertUser201Response;
import org.openapitools.client.model.UpsertUserRequest;
...
public class UsersApi {
     ...
     */
    public DeleteAccount202Response deleteUser(DeleteUserRequest deleteUserRequest) throws ApiException {
        ApiResponse<DeleteAccount202Response> localVarResp = deleteUserWithHttpInfo(deleteUserRequest);
     ...
     */
    public ApiResponse<DeleteAccount202Response> deleteUserWithHttpInfo(DeleteUserRequest deleteUserRequest) throws ApiException {
     ...
     */
    public okhttp3.Call deleteUserAsync(DeleteUserRequest deleteUserRequest, final ApiCallback<DeleteAccount202Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call linkCall(LinkRequest linkRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = linkRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call linkValidateBeforeCall(LinkRequest linkRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'linkRequest' is set
        if (linkRequest == null) {
            throw new ApiException("Missing the required parameter 'linkRequest' when calling link(Async)");
        }

        return linkCall(linkRequest, _callback);
     ...
     */
    public DeleteAccount202Response link(LinkRequest linkRequest) throws ApiException {
        ApiResponse<DeleteAccount202Response> localVarResp = linkWithHttpInfo(linkRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DeleteAccount202Response> linkWithHttpInfo(LinkRequest linkRequest) throws ApiException {
        okhttp3.Call localVarCall = linkValidateBeforeCall(linkRequest, null);
        Type localVarReturnType = new TypeToken<DeleteAccount202Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Link web activity to user (asynchronously)
     * 💡 You don&#39;t need to use this endpoint if you use our JavaScript snippet in your application.  This endpoint is used to link web activity to a user in your application. This will help you discover which channels and campaigns work best.  When our JavaScript snippet is embedded on your website, blog or landing pages, a cookie named \&quot;__journey\&quot; will be set.  This will only work if your website and application are under the same top level domain.  Website, blog or landing pages * www.my-domain.tld * blog.my-domain.tld * landing-page.my-domain.tld  Application * app.my-domain.tld  The cookie on my-domain.tld will also be send to your app domain.  You should call this endpoint after the user succesfully logged in (so that you know the user&#39;s ID). Use the value of the cookie as device ID.
     * @param linkRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call linkAsync(LinkRequest linkRequest, final ApiCallback<DeleteAccount202Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = linkValidateBeforeCall(linkRequest, _callback);
        Type localVarReturnType = new TypeToken<DeleteAccount202Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> User will be created </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request, some fields or parameters are incorrect </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 401 </td><td> No API Key was provided or the key is not authorised to perform the action </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 403 </td><td> The API Key provided is currently not enabled </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 429 </td><td> Too many API requests were send </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
     ...
     */
    public okhttp3.Call upsertUserCall(UpsertUserRequest upsertUserRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/users/upsert";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertUserValidateBeforeCall(UpsertUserRequest upsertUserRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'upsertUserRequest' is set
        if (upsertUserRequest == null) {
            throw new ApiException("Missing the required parameter 'upsertUserRequest' when calling upsertUser(Async)");
        }

        return upsertUserCall(upsertUserRequest, _callback);
     ...
     */
    public UpsertUser201Response upsertUser(UpsertUserRequest upsertUserRequest) throws ApiException {
        ApiResponse<UpsertUser201Response> localVarResp = upsertUserWithHttpInfo(upsertUserRequest);
        return localVarResp.getData();
    }
     ...
     * Endpoint to create or update a user.
     * @param upsertUserRequest  (required)
     * @return ApiResponse&lt;UpsertUser201Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<UpsertUser201Response> upsertUserWithHttpInfo(UpsertUserRequest upsertUserRequest) throws ApiException {
        okhttp3.Call localVarCall = upsertUserValidateBeforeCall(upsertUserRequest, null);
        Type localVarReturnType = new TypeToken<UpsertUser201Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call upsertUserAsync(UpsertUserRequest upsertUserRequest, final ApiCallback<UpsertUser201Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertUserValidateBeforeCall(upsertUserRequest, _callback);
        Type localVarReturnType = new TypeToken<UpsertUser201Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
