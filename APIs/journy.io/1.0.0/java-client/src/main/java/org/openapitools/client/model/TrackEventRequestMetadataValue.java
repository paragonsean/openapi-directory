...
public class TrackEventRequestMetadataValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TrackEventRequestMetadataValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TrackEventRequestMetadataValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TrackEventRequestMetadataValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TrackEventRequestMetadataValue>() {
                @Override
                public void write(JsonWriter out, TrackEventRequestMetadataValue value) throws IOException {
                ...
                @Override
                public TrackEventRequestMetadataValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        TrackEventRequestMetadataValue ret = new TrackEventRequestMetadataValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for TrackEventRequestMetadataValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TrackEventRequestMetadataValue() {
        super("oneOf", Boolean.FALSE);
    }

    public TrackEventRequestMetadataValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TrackEventRequestMetadataValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TrackEventRequestMetadataValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for TrackEventRequestMetadataValue with oneOf schemas: BigDecimal, Boolean, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of TrackEventRequestMetadataValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TrackEventRequestMetadataValue
     * @throws IOException if the JSON string is invalid with respect to TrackEventRequestMetadataValue
     */
    public static TrackEventRequestMetadataValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TrackEventRequestMetadataValue.class);
    }

    /**
     * Convert an instance of TrackEventRequestMetadataValue to an JSON string
     *
     * @return JSON string
     */
