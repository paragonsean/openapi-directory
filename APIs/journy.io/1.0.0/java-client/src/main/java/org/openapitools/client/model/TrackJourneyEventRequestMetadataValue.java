...
public class TrackJourneyEventRequestMetadataValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TrackJourneyEventRequestMetadataValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TrackJourneyEventRequestMetadataValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TrackJourneyEventRequestMetadataValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TrackJourneyEventRequestMetadataValue>() {
                @Override
                public void write(JsonWriter out, TrackJourneyEventRequestMetadataValue value) throws IOException {
                ...
                @Override
                public TrackJourneyEventRequestMetadataValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        TrackJourneyEventRequestMetadataValue ret = new TrackJourneyEventRequestMetadataValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for TrackJourneyEventRequestMetadataValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TrackJourneyEventRequestMetadataValue() {
        super("oneOf", Boolean.FALSE);
    }

    public TrackJourneyEventRequestMetadataValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TrackJourneyEventRequestMetadataValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TrackJourneyEventRequestMetadataValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for TrackJourneyEventRequestMetadataValue with oneOf schemas: BigDecimal, Boolean, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of TrackJourneyEventRequestMetadataValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TrackJourneyEventRequestMetadataValue
     * @throws IOException if the JSON string is invalid with respect to TrackJourneyEventRequestMetadataValue
     */
    public static TrackJourneyEventRequestMetadataValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TrackJourneyEventRequestMetadataValue.class);
    }

    /**
     * Convert an instance of TrackJourneyEventRequestMetadataValue to an JSON string
     *
     * @return JSON string
     */
