...
public class AddUserToAccountRequestUsersInner {
  ...
  public AddUserToAccountRequestUsersInner() {
  }

  public AddUserToAccountRequestUsersInner identification(AddUserToAccountRequestUsersInnerIdentification identification) {
  ...
  public boolean equals(Object o) {
    ...
    AddUserToAccountRequestUsersInner addUserToAccountRequestUsersInner = (AddUserToAccountRequestUsersInner) o;
    return Objects.equals(this.identification, addUserToAccountRequestUsersInner.identification);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddUserToAccountRequestUsersInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddUserToAccountRequestUsersInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddUserToAccountRequestUsersInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddUserToAccountRequestUsersInner is not found in the empty JSON string", AddUserToAccountRequestUsersInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddUserToAccountRequestUsersInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddUserToAccountRequestUsersInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddUserToAccountRequestUsersInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddUserToAccountRequestUsersInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddUserToAccountRequestUsersInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddUserToAccountRequestUsersInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddUserToAccountRequestUsersInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddUserToAccountRequestUsersInner>() {
           @Override
           public void write(JsonWriter out, AddUserToAccountRequestUsersInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddUserToAccountRequestUsersInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddUserToAccountRequestUsersInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddUserToAccountRequestUsersInner
   * @throws IOException if the JSON string is invalid with respect to AddUserToAccountRequestUsersInner
   */
  public static AddUserToAccountRequestUsersInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddUserToAccountRequestUsersInner.class);
  }

  /**
   * Convert an instance of AddUserToAccountRequestUsersInner to an JSON string
   *
   * @return JSON string
   */
