...
public class LinkRequest {
  ...
  public LinkRequest deviceId(String deviceId) {
  ...
  public LinkRequest identification(AddUserToAccountRequestUsersInnerIdentification identification) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deviceId, linkRequest.deviceId) &&
        Objects.equals(this.identification, linkRequest.identification);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deviceId, identification);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LinkRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LinkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinkRequest is not found in the empty JSON string", LinkRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LinkRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LinkRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LinkRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LinkRequest>() {
           @Override
           public void write(JsonWriter out, LinkRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LinkRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LinkRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LinkRequest
   * @throws IOException if the JSON string is invalid with respect to LinkRequest
   */
  public static LinkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinkRequest.class);
  }

  /**
   * Convert an instance of LinkRequest to an JSON string
   *
   * @return JSON string
   */
