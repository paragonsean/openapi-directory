...
import org.openapitools.client.model.GetEvents200ResponseAllOfDataInner;
...
public class GetEvents200Response {
  ...
  private List<GetEvents200ResponseAllOfDataInner> data = new ArrayList<>();

  public GetEvents200Response() {
  }

  public GetEvents200Response meta(DeleteAccount202ResponseAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public GetEvents200Response data(List<GetEvents200ResponseAllOfDataInner> data) {
    this.data = data;
    return this;
  }

  public GetEvents200Response addDataItem(GetEvents200ResponseAllOfDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<GetEvents200ResponseAllOfDataInner> getData() {
    return data;
  }

  public void setData(List<GetEvents200ResponseAllOfDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, getEvents200Response.meta) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : GetEvents200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        GetEvents200ResponseAllOfDataInner.validateJsonElement(jsonArraydata.get(i));
      };
  }
