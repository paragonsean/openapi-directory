...
public class UpsertAccountRequestPropertiesValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpsertAccountRequestPropertiesValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpsertAccountRequestPropertiesValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpsertAccountRequestPropertiesValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpsertAccountRequestPropertiesValue>() {
                @Override
                public void write(JsonWriter out, UpsertAccountRequestPropertiesValue value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: BigDecimal, Boolean, List<String>, String");
                }

                @Override
                public UpsertAccountRequestPropertiesValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UpsertAccountRequestPropertiesValue ret = new UpsertAccountRequestPropertiesValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UpsertAccountRequestPropertiesValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpsertAccountRequestPropertiesValue() {
        super("oneOf", Boolean.FALSE);
    }

    public UpsertAccountRequestPropertiesValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpsertAccountRequestPropertiesValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpsertAccountRequestPropertiesValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UpsertAccountRequestPropertiesValue with oneOf schemas: BigDecimal, Boolean, List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UpsertAccountRequestPropertiesValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpsertAccountRequestPropertiesValue
     * @throws IOException if the JSON string is invalid with respect to UpsertAccountRequestPropertiesValue
     */
    public static UpsertAccountRequestPropertiesValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpsertAccountRequestPropertiesValue.class);
    }

    /**
     * Convert an instance of UpsertAccountRequestPropertiesValue to an JSON string
     *
     * @return JSON string
     */
