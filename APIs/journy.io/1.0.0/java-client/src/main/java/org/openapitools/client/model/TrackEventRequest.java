...
import org.openapitools.client.model.TrackEventRequestMetadataValue;
...
public class TrackEventRequest {
  ...
  private Map<String, TrackEventRequestMetadataValue> metadata = new HashMap<>();
  ...
  public TrackEventRequest identification(TrackJourneyEventRequestIdentification identification) {
  ...
  public TrackEventRequest metadata(Map<String, TrackEventRequestMetadataValue> metadata) {
    this.metadata = metadata;
    return this;
  }

  public TrackEventRequest putMetadataItem(String key, TrackEventRequestMetadataValue metadataItem) {
  ...
  public Map<String, TrackEventRequestMetadataValue> getMetadata() {
    return metadata;
  }

  public void setMetadata(Map<String, TrackEventRequestMetadataValue> metadata) {
    this.metadata = metadata;
  }


  public TrackEventRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TrackEventRequest triggeredAt(String triggeredAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identification, trackEventRequest.identification) &&
        Objects.equals(this.metadata, trackEventRequest.metadata) &&
        Objects.equals(this.name, trackEventRequest.name) &&
        Objects.equals(this.triggeredAt, trackEventRequest.triggeredAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackEventRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackEventRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
