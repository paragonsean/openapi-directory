...
import org.openapitools.client.model.DeleteAccount400ResponseAllOfErrorsParameters;
...
public class DeleteAccount400ResponseAllOfErrors {
  ...
  private DeleteAccount400ResponseAllOfErrorsParameters parameters;

  public DeleteAccount400ResponseAllOfErrors() {
  }

  public DeleteAccount400ResponseAllOfErrors fields(Map<String, String> fields) {
    this.fields = fields;
    return this;
  }

  public DeleteAccount400ResponseAllOfErrors putFieldsItem(String key, String fieldsItem) {
    if (this.fields == null) {
  ...
  public DeleteAccount400ResponseAllOfErrors parameters(DeleteAccount400ResponseAllOfErrorsParameters parameters) {
   ...
   */
  @javax.annotation.Nullable
  public DeleteAccount400ResponseAllOfErrorsParameters getParameters() {
    return parameters;
  }

  public void setParameters(DeleteAccount400ResponseAllOfErrorsParameters parameters) {
    this.parameters = parameters;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteAccount400ResponseAllOfErrors deleteAccount400ResponseAllOfErrors = (DeleteAccount400ResponseAllOfErrors) o;
    return Objects.equals(this.fields, deleteAccount400ResponseAllOfErrors.fields) &&
        Objects.equals(this.parameters, deleteAccount400ResponseAllOfErrors.parameters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fields, parameters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteAccount400ResponseAllOfErrors {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAccount400ResponseAllOfErrors
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAccount400ResponseAllOfErrors.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAccount400ResponseAllOfErrors is not found in the empty JSON string", DeleteAccount400ResponseAllOfErrors.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAccount400ResponseAllOfErrors.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAccount400ResponseAllOfErrors` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `parameters`
      if (jsonObj.get("parameters") != null && !jsonObj.get("parameters").isJsonNull()) {
        DeleteAccount400ResponseAllOfErrorsParameters.validateJsonElement(jsonObj.get("parameters"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAccount400ResponseAllOfErrors.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAccount400ResponseAllOfErrors' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAccount400ResponseAllOfErrors> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAccount400ResponseAllOfErrors.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAccount400ResponseAllOfErrors>() {
           @Override
           public void write(JsonWriter out, DeleteAccount400ResponseAllOfErrors value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAccount400ResponseAllOfErrors read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAccount400ResponseAllOfErrors given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAccount400ResponseAllOfErrors
   * @throws IOException if the JSON string is invalid with respect to DeleteAccount400ResponseAllOfErrors
   */
  public static DeleteAccount400ResponseAllOfErrors fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAccount400ResponseAllOfErrors.class);
  }

  /**
   * Convert an instance of DeleteAccount400ResponseAllOfErrors to an JSON string
   *
   * @return JSON string
   */
