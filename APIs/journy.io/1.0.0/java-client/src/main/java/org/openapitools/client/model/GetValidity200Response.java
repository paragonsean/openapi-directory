...
import org.openapitools.client.model.GetValidity200ResponseAllOfData;
...
public class GetValidity200Response {
  ...
  private GetValidity200ResponseAllOfData data;

  public GetValidity200Response() {
  }

  public GetValidity200Response meta(DeleteAccount202ResponseAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public GetValidity200Response data(GetValidity200ResponseAllOfData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public GetValidity200ResponseAllOfData getData() {
    return data;
  }

  public void setData(GetValidity200ResponseAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetValidity200Response getValidity200Response = (GetValidity200Response) o;
    return Objects.equals(this.meta, getValidity200Response.meta) &&
        Objects.equals(this.data, getValidity200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetValidity200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetValidity200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetValidity200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetValidity200Response is not found in the empty JSON string", GetValidity200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetValidity200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetValidity200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetValidity200Response.openapiRequiredFields) {
      ...
      GetValidity200ResponseAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetValidity200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetValidity200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetValidity200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetValidity200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetValidity200Response>() {
           @Override
           public void write(JsonWriter out, GetValidity200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetValidity200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetValidity200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetValidity200Response
   * @throws IOException if the JSON string is invalid with respect to GetValidity200Response
   */
  public static GetValidity200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetValidity200Response.class);
  }

  /**
   * Convert an instance of GetValidity200Response to an JSON string
   *
   * @return JSON string
   */
