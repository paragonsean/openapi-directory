...
import org.openapitools.client.model.AddUserToAccountRequestUsersInner;
import org.openapitools.client.model.DeleteAccountRequestIdentification;
...
public class AddUserToAccountRequest {
  ...
  private DeleteAccountRequestIdentification account;

  public static final String SERIALIZED_NAME_USERS = "users";
  @SerializedName(SERIALIZED_NAME_USERS)
  private List<AddUserToAccountRequestUsersInner> users = new ArrayList<>();

  public AddUserToAccountRequest() {
  }

  public AddUserToAccountRequest account(DeleteAccountRequestIdentification account) {
  ...
  public DeleteAccountRequestIdentification getAccount() {
    return account;
  }

  public void setAccount(DeleteAccountRequestIdentification account) {
    this.account = account;
  }


  public AddUserToAccountRequest users(List<AddUserToAccountRequestUsersInner> users) {
    this.users = users;
    return this;
  }

  public AddUserToAccountRequest addUsersItem(AddUserToAccountRequestUsersInner usersItem) {
    if (this.users == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<AddUserToAccountRequestUsersInner> getUsers() {
    return users;
  }

  public void setUsers(List<AddUserToAccountRequestUsersInner> users) {
    this.users = users;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddUserToAccountRequest addUserToAccountRequest = (AddUserToAccountRequest) o;
    return Objects.equals(this.account, addUserToAccountRequest.account) &&
        Objects.equals(this.users, addUserToAccountRequest.users);
  }

  @Override
  public int hashCode() {
    return Objects.hash(account, users);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddUserToAccountRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddUserToAccountRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddUserToAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddUserToAccountRequest is not found in the empty JSON string", AddUserToAccountRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddUserToAccountRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddUserToAccountRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddUserToAccountRequest.openapiRequiredFields) {
      ...
      DeleteAccountRequestIdentification.validateJsonElement(jsonObj.get("account"));
      ...
      for (int i = 0; i < jsonArrayusers.size(); i++) {
        AddUserToAccountRequestUsersInner.validateJsonElement(jsonArrayusers.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddUserToAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddUserToAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddUserToAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddUserToAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddUserToAccountRequest>() {
           @Override
           public void write(JsonWriter out, AddUserToAccountRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddUserToAccountRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddUserToAccountRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddUserToAccountRequest
   * @throws IOException if the JSON string is invalid with respect to AddUserToAccountRequest
   */
  public static AddUserToAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddUserToAccountRequest.class);
  }

  /**
   * Convert an instance of AddUserToAccountRequest to an JSON string
   *
   * @return JSON string
   */
