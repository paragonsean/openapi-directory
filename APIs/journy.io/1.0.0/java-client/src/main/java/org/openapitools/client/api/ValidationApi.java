...
import org.openapitools.client.model.GetValidity200Response;
...
public class ValidationApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Key validation </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
     ...
     */
    public okhttp3.Call getValidityCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getValidityValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getValidityCall(_callback);
     ...
     */
    public GetValidity200Response getValidity() throws ApiException {
        ApiResponse<GetValidity200Response> localVarResp = getValidityWithHttpInfo();
     ...
     * Validate API key
     * Endpoint used to test the validity and some basic information about a specific API Key.
     * @return ApiResponse&lt;GetValidity200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetValidity200Response> getValidityWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getValidityValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GetValidity200Response>(){}.getType();
     ...
     */
    public okhttp3.Call getValidityAsync(final ApiCallback<GetValidity200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getValidityValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<GetValidity200Response>(){}.getType();
