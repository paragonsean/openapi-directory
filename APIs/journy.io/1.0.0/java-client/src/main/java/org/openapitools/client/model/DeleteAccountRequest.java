...
public class DeleteAccountRequest {
  ...
  private DeleteAccountRequestIdentification identification;

  public DeleteAccountRequest() {
  }

  public DeleteAccountRequest identification(DeleteAccountRequestIdentification identification) {
  ...
  public DeleteAccountRequestIdentification getIdentification() {
    return identification;
  }

  public void setIdentification(DeleteAccountRequestIdentification identification) {
    this.identification = identification;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identification, deleteAccountRequest.identification);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAccountRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAccountRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAccountRequest is not found in the empty JSON string", DeleteAccountRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAccountRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAccountRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteAccountRequest.openapiRequiredFields) {
      ...
      DeleteAccountRequestIdentification.validateJsonElement(jsonObj.get("identification"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAccountRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAccountRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAccountRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAccountRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAccountRequest>() {
           @Override
           public void write(JsonWriter out, DeleteAccountRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAccountRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAccountRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAccountRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteAccountRequest
   */
  public static DeleteAccountRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAccountRequest.class);
  }

  /**
   * Convert an instance of DeleteAccountRequest to an JSON string
   *
   * @return JSON string
   */
