...
import org.openapitools.client.model.GetAccountSegments200ResponseAllOfDataInner;
...
public class GetAccountSegments200Response {
  ...
  private List<GetAccountSegments200ResponseAllOfDataInner> data = new ArrayList<>();

  public GetAccountSegments200Response() {
  }

  public GetAccountSegments200Response meta(DeleteAccount202ResponseAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public GetAccountSegments200Response data(List<GetAccountSegments200ResponseAllOfDataInner> data) {
    this.data = data;
    return this;
  }

  public GetAccountSegments200Response addDataItem(GetAccountSegments200ResponseAllOfDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<GetAccountSegments200ResponseAllOfDataInner> getData() {
    return data;
  }

  public void setData(List<GetAccountSegments200ResponseAllOfDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetAccountSegments200Response getAccountSegments200Response = (GetAccountSegments200Response) o;
    return Objects.equals(this.meta, getAccountSegments200Response.meta) &&
        Objects.equals(this.data, getAccountSegments200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAccountSegments200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAccountSegments200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAccountSegments200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAccountSegments200Response is not found in the empty JSON string", GetAccountSegments200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAccountSegments200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAccountSegments200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetAccountSegments200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        GetAccountSegments200ResponseAllOfDataInner.validateJsonElement(jsonArraydata.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAccountSegments200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAccountSegments200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAccountSegments200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAccountSegments200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAccountSegments200Response>() {
           @Override
           public void write(JsonWriter out, GetAccountSegments200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAccountSegments200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAccountSegments200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAccountSegments200Response
   * @throws IOException if the JSON string is invalid with respect to GetAccountSegments200Response
   */
  public static GetAccountSegments200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAccountSegments200Response.class);
  }

  /**
   * Convert an instance of GetAccountSegments200Response to an JSON string
   *
   * @return JSON string
   */
