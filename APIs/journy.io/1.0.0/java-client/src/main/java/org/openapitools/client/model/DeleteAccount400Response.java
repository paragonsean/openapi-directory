...
import org.openapitools.client.model.DeleteAccount400ResponseAllOfErrors;
...
public class DeleteAccount400Response {
  ...
  private DeleteAccount400ResponseAllOfErrors errors;

  public DeleteAccount400Response() {
  }

  public DeleteAccount400Response meta(DeleteAccount202ResponseAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public DeleteAccount400Response message(String message) {
  ...
  public DeleteAccount400Response errors(DeleteAccount400ResponseAllOfErrors errors) {
    this.errors = errors;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public DeleteAccount400ResponseAllOfErrors getErrors() {
    return errors;
  }

  public void setErrors(DeleteAccount400ResponseAllOfErrors errors) {
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteAccount400Response deleteAccount400Response = (DeleteAccount400Response) o;
    return Objects.equals(this.meta, deleteAccount400Response.meta) &&
        Objects.equals(this.message, deleteAccount400Response.message) &&
        Objects.equals(this.errors, deleteAccount400Response.errors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, message, errors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteAccount400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAccount400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAccount400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAccount400Response is not found in the empty JSON string", DeleteAccount400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAccount400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAccount400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteAccount400Response.openapiRequiredFields) {
      ...
      DeleteAccount400ResponseAllOfErrors.validateJsonElement(jsonObj.get("errors"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAccount400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAccount400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAccount400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAccount400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAccount400Response>() {
           @Override
           public void write(JsonWriter out, DeleteAccount400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAccount400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAccount400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAccount400Response
   * @throws IOException if the JSON string is invalid with respect to DeleteAccount400Response
   */
  public static DeleteAccount400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAccount400Response.class);
  }

  /**
   * Convert an instance of DeleteAccount400Response to an JSON string
   *
   * @return JSON string
   */
