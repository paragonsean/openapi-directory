...
import org.openapitools.client.model.GetTrackingSnippet200ResponseAllOfData;
...
public class GetTrackingSnippet200Response {
  ...
  private GetTrackingSnippet200ResponseAllOfData data;

  public GetTrackingSnippet200Response() {
  }

  public GetTrackingSnippet200Response meta(DeleteAccount202ResponseAllOfMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public GetTrackingSnippet200Response data(GetTrackingSnippet200ResponseAllOfData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public GetTrackingSnippet200ResponseAllOfData getData() {
    return data;
  }

  public void setData(GetTrackingSnippet200ResponseAllOfData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTrackingSnippet200Response getTrackingSnippet200Response = (GetTrackingSnippet200Response) o;
    return Objects.equals(this.meta, getTrackingSnippet200Response.meta) &&
        Objects.equals(this.data, getTrackingSnippet200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTrackingSnippet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTrackingSnippet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTrackingSnippet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTrackingSnippet200Response is not found in the empty JSON string", GetTrackingSnippet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTrackingSnippet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTrackingSnippet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTrackingSnippet200Response.openapiRequiredFields) {
      ...
      GetTrackingSnippet200ResponseAllOfData.validateJsonElement(jsonObj.get("data"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTrackingSnippet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTrackingSnippet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTrackingSnippet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTrackingSnippet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTrackingSnippet200Response>() {
           @Override
           public void write(JsonWriter out, GetTrackingSnippet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTrackingSnippet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTrackingSnippet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTrackingSnippet200Response
   * @throws IOException if the JSON string is invalid with respect to GetTrackingSnippet200Response
   */
  public static GetTrackingSnippet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTrackingSnippet200Response.class);
  }

  /**
   * Convert an instance of GetTrackingSnippet200Response to an JSON string
   *
   * @return JSON string
   */
