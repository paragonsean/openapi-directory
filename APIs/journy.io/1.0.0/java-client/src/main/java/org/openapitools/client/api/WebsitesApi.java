...
import org.openapitools.client.model.GetTrackingSnippet200Response;
...
public class WebsitesApi {
    ...
    /**
     * Build call for getTrackingSnippet
     * @param domain The domain you want to receive a snippet for (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Snippet </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        ...
        <tr><td> 404 </td><td> Not found </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
     ...
     */
    public okhttp3.Call getTrackingSnippetCall(String domain, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/tracking/snippet";
    ...
    private okhttp3.Call getTrackingSnippetValidateBeforeCall(String domain, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'domain' is set
        if (domain == null) {
            throw new ApiException("Missing the required parameter 'domain' when calling getTrackingSnippet(Async)");
        }

        return getTrackingSnippetCall(domain, _callback);
     ...
     * @param domain The domain you want to receive a snippet for (required)
     * @return GetTrackingSnippet200Response
     ...
     */
    public GetTrackingSnippet200Response getTrackingSnippet(String domain) throws ApiException {
        ApiResponse<GetTrackingSnippet200Response> localVarResp = getTrackingSnippetWithHttpInfo(domain);
     ...
     * Endpoint used to get a snippet for a website.
     * @param domain The domain you want to receive a snippet for (required)
     * @return ApiResponse&lt;GetTrackingSnippet200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetTrackingSnippet200Response> getTrackingSnippetWithHttpInfo(String domain) throws ApiException {
        okhttp3.Call localVarCall = getTrackingSnippetValidateBeforeCall(domain, null);
        Type localVarReturnType = new TypeToken<GetTrackingSnippet200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get snippet for a website (asynchronously)
     * Endpoint used to get a snippet for a website.
     * @param domain The domain you want to receive a snippet for (required)
     ...
     */
    public okhttp3.Call getTrackingSnippetAsync(String domain, final ApiCallback<GetTrackingSnippet200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTrackingSnippetValidateBeforeCall(domain, _callback);
        Type localVarReturnType = new TypeToken<GetTrackingSnippet200Response>(){}.getType();
