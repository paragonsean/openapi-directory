...
public class DeleteAccount400ResponseAllOfErrorsParameters {
  ...
  public DeleteAccount400ResponseAllOfErrorsParameters() {
  }

  public DeleteAccount400ResponseAllOfErrorsParameters header(Map<String, String> header) {
    this.header = header;
    return this;
  }

  public DeleteAccount400ResponseAllOfErrorsParameters putHeaderItem(String key, String headerItem) {
    if (this.header == null) {
  ...
  public DeleteAccount400ResponseAllOfErrorsParameters path(Map<String, String> path) {
    this.path = path;
    return this;
  }

  public DeleteAccount400ResponseAllOfErrorsParameters putPathItem(String key, String pathItem) {
    if (this.path == null) {
  ...
  public DeleteAccount400ResponseAllOfErrorsParameters query(Map<String, String> query) {
    this.query = query;
    return this;
  }

  public DeleteAccount400ResponseAllOfErrorsParameters putQueryItem(String key, String queryItem) {
    if (this.query == null) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteAccount400ResponseAllOfErrorsParameters deleteAccount400ResponseAllOfErrorsParameters = (DeleteAccount400ResponseAllOfErrorsParameters) o;
    return Objects.equals(this.header, deleteAccount400ResponseAllOfErrorsParameters.header) &&
        Objects.equals(this.path, deleteAccount400ResponseAllOfErrorsParameters.path) &&
        Objects.equals(this.query, deleteAccount400ResponseAllOfErrorsParameters.query);
  }

  @Override
  public int hashCode() {
    return Objects.hash(header, path, query);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteAccount400ResponseAllOfErrorsParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAccount400ResponseAllOfErrorsParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAccount400ResponseAllOfErrorsParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAccount400ResponseAllOfErrorsParameters is not found in the empty JSON string", DeleteAccount400ResponseAllOfErrorsParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAccount400ResponseAllOfErrorsParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAccount400ResponseAllOfErrorsParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAccount400ResponseAllOfErrorsParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAccount400ResponseAllOfErrorsParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAccount400ResponseAllOfErrorsParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAccount400ResponseAllOfErrorsParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAccount400ResponseAllOfErrorsParameters>() {
           @Override
           public void write(JsonWriter out, DeleteAccount400ResponseAllOfErrorsParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAccount400ResponseAllOfErrorsParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAccount400ResponseAllOfErrorsParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAccount400ResponseAllOfErrorsParameters
   * @throws IOException if the JSON string is invalid with respect to DeleteAccount400ResponseAllOfErrorsParameters
   */
  public static DeleteAccount400ResponseAllOfErrorsParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAccount400ResponseAllOfErrorsParameters.class);
  }

  /**
   * Convert an instance of DeleteAccount400ResponseAllOfErrorsParameters to an JSON string
   *
   * @return JSON string
   */
