...
import org.openapitools.client.model.GetEvents200ResponseAllOfDataInnerGroup;
...
public class GetEvents200ResponseAllOfDataInner {
  public static final String SERIALIZED_NAME_GROUP = "group";
  @SerializedName(SERIALIZED_NAME_GROUP)
  private GetEvents200ResponseAllOfDataInnerGroup group;
  ...
  public GetEvents200ResponseAllOfDataInner() {
  }

  public GetEvents200ResponseAllOfDataInner group(GetEvents200ResponseAllOfDataInnerGroup group) {
    this.group = group;
    return this;
  }
  ...
  public GetEvents200ResponseAllOfDataInnerGroup getGroup() {
    return group;
  }

  public void setGroup(GetEvents200ResponseAllOfDataInnerGroup group) {
    this.group = group;
  }


  public GetEvents200ResponseAllOfDataInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetEvents200ResponseAllOfDataInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetEvents200ResponseAllOfDataInner getEvents200ResponseAllOfDataInner = (GetEvents200ResponseAllOfDataInner) o;
    return Objects.equals(this.group, getEvents200ResponseAllOfDataInner.group) &&
        Objects.equals(this.id, getEvents200ResponseAllOfDataInner.id) &&
        Objects.equals(this.name, getEvents200ResponseAllOfDataInner.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEvents200ResponseAllOfDataInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetEvents200ResponseAllOfDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEvents200ResponseAllOfDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEvents200ResponseAllOfDataInner is not found in the empty JSON string", GetEvents200ResponseAllOfDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEvents200ResponseAllOfDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEvents200ResponseAllOfDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetEvents200ResponseAllOfDataInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("group") != null && !jsonObj.get("group").isJsonNull()) {
        GetEvents200ResponseAllOfDataInnerGroup.validateJsonElement(jsonObj.get("group"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEvents200ResponseAllOfDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEvents200ResponseAllOfDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEvents200ResponseAllOfDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEvents200ResponseAllOfDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEvents200ResponseAllOfDataInner>() {
           @Override
           public void write(JsonWriter out, GetEvents200ResponseAllOfDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEvents200ResponseAllOfDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetEvents200ResponseAllOfDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetEvents200ResponseAllOfDataInner
   * @throws IOException if the JSON string is invalid with respect to GetEvents200ResponseAllOfDataInner
   */
  public static GetEvents200ResponseAllOfDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEvents200ResponseAllOfDataInner.class);
  }

  /**
   * Convert an instance of GetEvents200ResponseAllOfDataInner to an JSON string
   *
   * @return JSON string
   */
