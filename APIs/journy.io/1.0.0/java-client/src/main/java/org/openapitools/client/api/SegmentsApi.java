...
import org.openapitools.client.model.GetAccountSegments200Response;
...
public class SegmentsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Account Segments </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
     ...
     */
    public okhttp3.Call getAccountSegmentsCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/segments/accounts";
    ...
    private okhttp3.Call getAccountSegmentsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getAccountSegmentsCall(_callback);
     ...
     * @return GetAccountSegments200Response
     ...
     */
    public GetAccountSegments200Response getAccountSegments() throws ApiException {
        ApiResponse<GetAccountSegments200Response> localVarResp = getAccountSegmentsWithHttpInfo();
     ...
     * Get account segments
     * Endpoint to list account segments.
     * @return ApiResponse&lt;GetAccountSegments200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetAccountSegments200Response> getAccountSegmentsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getAccountSegmentsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GetAccountSegments200Response>(){}.getType();
     ...
     */
    public okhttp3.Call getAccountSegmentsAsync(final ApiCallback<GetAccountSegments200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountSegmentsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<GetAccountSegments200Response>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> User Segments </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 400 </td><td> Bad request, some fields or parameters are incorrect </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 401 </td><td> No API Key was provided or the key is not authorised to perform the action </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 403 </td><td> The API Key provided is currently not enabled </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
        <tr><td> 429 </td><td> Too many API requests were send </td><td>  * X-RateLimit-Limit - Request limit per minute. <br>  * X-RateLimit-Remaining - The number of requests left for the time window. <br>  </td></tr>
     ...
     */
    public okhttp3.Call getUserSegmentsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/segments/users";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserSegmentsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getUserSegmentsCall(_callback);
     ...
     */
    public GetAccountSegments200Response getUserSegments() throws ApiException {
        ApiResponse<GetAccountSegments200Response> localVarResp = getUserSegmentsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetAccountSegments200Response> getUserSegmentsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getUserSegmentsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GetAccountSegments200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get user segments (asynchronously)
     * Endpoint to list user segments.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getUserSegmentsAsync(final ApiCallback<GetAccountSegments200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserSegmentsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<GetAccountSegments200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
