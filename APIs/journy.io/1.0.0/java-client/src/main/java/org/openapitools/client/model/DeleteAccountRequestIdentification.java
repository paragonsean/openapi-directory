...
public class DeleteAccountRequestIdentification {
  ...
  public DeleteAccountRequestIdentification() {
  }

  public DeleteAccountRequestIdentification accountId(String accountId) {
  ...
  public DeleteAccountRequestIdentification domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteAccountRequestIdentification deleteAccountRequestIdentification = (DeleteAccountRequestIdentification) o;
    return Objects.equals(this.accountId, deleteAccountRequestIdentification.accountId) &&
        Objects.equals(this.domain, deleteAccountRequestIdentification.domain);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, domain);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteAccountRequestIdentification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAccountRequestIdentification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAccountRequestIdentification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAccountRequestIdentification is not found in the empty JSON string", DeleteAccountRequestIdentification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAccountRequestIdentification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAccountRequestIdentification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAccountRequestIdentification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAccountRequestIdentification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAccountRequestIdentification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAccountRequestIdentification.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAccountRequestIdentification>() {
           @Override
           public void write(JsonWriter out, DeleteAccountRequestIdentification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAccountRequestIdentification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAccountRequestIdentification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAccountRequestIdentification
   * @throws IOException if the JSON string is invalid with respect to DeleteAccountRequestIdentification
   */
  public static DeleteAccountRequestIdentification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAccountRequestIdentification.class);
  }

  /**
   * Convert an instance of DeleteAccountRequestIdentification to an JSON string
   *
   * @return JSON string
   */
