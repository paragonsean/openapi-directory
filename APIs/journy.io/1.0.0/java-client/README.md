...
- API version: 1.0.0
  - Build date: 2024-10-12T11:25:10.373569-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*AccountsApi* | [**addUserToAccount**](docs/AccountsApi.md#addUserToAccount) | **POST** /accounts/users/add | Add users to an account
*AccountsApi* | [**deleteAccount**](docs/AccountsApi.md#deleteAccount) | **DELETE** /accounts | Delete account
*AccountsApi* | [**removeUserFromAccount**](docs/AccountsApi.md#removeUserFromAccount) | **POST** /accounts/users/remove | Remove user from account
*AccountsApi* | [**upsertAccount**](docs/AccountsApi.md#upsertAccount) | **POST** /accounts/upsert | Create or update account
*EventsApi* | [**getEvents**](docs/EventsApi.md#getEvents) | **GET** /events | Get events
*EventsApi* | [**trackJourneyEvent**](docs/EventsApi.md#trackJourneyEvent) | **POST** /events | Track event
*PropertiesApi* | [**getAccountProperties**](docs/PropertiesApi.md#getAccountProperties) | **GET** /properties/accounts | Get account properties
*PropertiesApi* | [**getUserProperties**](docs/PropertiesApi.md#getUserProperties) | **GET** /properties/users | Get user properties
*SegmentsApi* | [**getAccountSegments**](docs/SegmentsApi.md#getAccountSegments) | **GET** /segments/accounts | Get account segments
*SegmentsApi* | [**getUserSegments**](docs/SegmentsApi.md#getUserSegments) | **GET** /segments/users | Get user segments
*TrackApi* | [**trackEvent**](docs/TrackApi.md#trackEvent) | **POST** /track | Track event
*UsersApi* | [**deleteUser**](docs/UsersApi.md#deleteUser) | **DELETE** /users | Delete user
*UsersApi* | [**link**](docs/UsersApi.md#link) | **POST** /link | Link web activity to user
*UsersApi* | [**upsertUser**](docs/UsersApi.md#upsertUser) | **POST** /users/upsert | Create or update user
*ValidationApi* | [**getValidity**](docs/ValidationApi.md#getValidity) | **GET** /validate | Validate API key
*WebsitesApi* | [**getTrackingSnippet**](docs/WebsitesApi.md#getTrackingSnippet) | **GET** /tracking/snippet | Get snippet for a website


## Documentation for Models

 - [AddUserToAccountRequest](docs/AddUserToAccountRequest.md)
 - [AddUserToAccountRequestUsersInner](docs/AddUserToAccountRequestUsersInner.md)
 - [AddUserToAccountRequestUsersInnerIdentification](docs/AddUserToAccountRequestUsersInnerIdentification.md)
 - [DeleteAccount202Response](docs/DeleteAccount202Response.md)
 - [DeleteAccount202ResponseAllOfMeta](docs/DeleteAccount202ResponseAllOfMeta.md)
 - [DeleteAccount400Response](docs/DeleteAccount400Response.md)
 - [DeleteAccount400ResponseAllOfErrors](docs/DeleteAccount400ResponseAllOfErrors.md)
 - [DeleteAccount400ResponseAllOfErrorsParameters](docs/DeleteAccount400ResponseAllOfErrorsParameters.md)
 - [DeleteAccountRequest](docs/DeleteAccountRequest.md)
 - [DeleteAccountRequestIdentification](docs/DeleteAccountRequestIdentification.md)
 - [DeleteUserRequest](docs/DeleteUserRequest.md)
 - [GetAccountProperties200Response](docs/GetAccountProperties200Response.md)
 - [GetAccountProperties200ResponseAllOfDataInner](docs/GetAccountProperties200ResponseAllOfDataInner.md)
 - [GetAccountProperties200ResponseAllOfDataInnerGroup](docs/GetAccountProperties200ResponseAllOfDataInnerGroup.md)
 - [GetAccountSegments200Response](docs/GetAccountSegments200Response.md)
 - [GetAccountSegments200ResponseAllOfDataInner](docs/GetAccountSegments200ResponseAllOfDataInner.md)
 - [GetEvents200Response](docs/GetEvents200Response.md)
 - [GetEvents200ResponseAllOfDataInner](docs/GetEvents200ResponseAllOfDataInner.md)
 - [GetEvents200ResponseAllOfDataInnerGroup](docs/GetEvents200ResponseAllOfDataInnerGroup.md)
 - [GetTrackingSnippet200Response](docs/GetTrackingSnippet200Response.md)
 - [GetTrackingSnippet200ResponseAllOfData](docs/GetTrackingSnippet200ResponseAllOfData.md)
 - [GetValidity200Response](docs/GetValidity200Response.md)
 - [GetValidity200ResponseAllOfData](docs/GetValidity200ResponseAllOfData.md)
 - [LinkRequest](docs/LinkRequest.md)
 - [TrackEventRequest](docs/TrackEventRequest.md)
 - [TrackEventRequestMetadataValue](docs/TrackEventRequestMetadataValue.md)
 - [TrackJourneyEventRequest](docs/TrackJourneyEventRequest.md)
 - [TrackJourneyEventRequestIdentification](docs/TrackJourneyEventRequestIdentification.md)
 - [TrackJourneyEventRequestMetadataValue](docs/TrackJourneyEventRequestMetadataValue.md)
 - [UpsertAccount201Response](docs/UpsertAccount201Response.md)
 - [UpsertAccountRequest](docs/UpsertAccountRequest.md)
 - [UpsertAccountRequestPropertiesValue](docs/UpsertAccountRequestPropertiesValue.md)
 - [UpsertUser201Response](docs/UpsertUser201Response.md)
