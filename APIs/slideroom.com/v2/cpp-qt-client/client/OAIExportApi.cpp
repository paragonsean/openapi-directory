...
void OAIExportApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("exportGetV2", defaultConf);
    _serverIndices.insert("exportGetV2", 0);
}
...
void OAIExportApi::exportGetV2(const qint32 &token) {
    QString fullPath = QString(_serverConfigs["exportGetV2"][_serverIndices.value("exportGetV2")].URL()+"/api/v2/export/{token}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIExportApi::exportGetV2Callback);
...
void OAIExportApi::exportGetV2Callback(OAIHttpRequestWorker *worker) {
    ...
    OAIExportResultV2 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT exportGetV2Signal(output);
        Q_EMIT exportGetV2SignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT exportGetV2SignalE(output, error_type, error_str);
        Q_EMIT exportGetV2SignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT exportGetV2SignalError(output, error_type, error_str);
        Q_EMIT exportGetV2SignalErrorFull(worker, error_type, error_str);
    }
}
