...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartureboardIoApi.DeparturesArrivalsApi();
  });
  ...
  describe('DeparturesArrivalsApi', function() {
    describe('getArrivalsAndDeparturesByCRS', function() {
      it('should call getArrivalsAndDeparturesByCRS successfully', function(done) {
        //uncomment below and update the code to test getArrivalsAndDeparturesByCRS
        //instance.getArrivalsAndDeparturesByCRS(function(error) {
    ...
    describe('getArrivalsByCRS', function() {
      it('should call getArrivalsByCRS successfully', function(done) {
        //uncomment below and update the code to test getArrivalsByCRS
        //instance.getArrivalsByCRS(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getDeparturesByCRS', function() {
      it('should call getDeparturesByCRS successfully', function(done) {
        //uncomment below and update the code to test getDeparturesByCRS
        //instance.getDeparturesByCRS(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
