...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartureboardIoApi.FastestAndNextDeparturesApi();
  });
  ...
  describe('FastestAndNextDeparturesApi', function() {
    describe('getFastestDeparturesByCRS', function() {
      it('should call getFastestDeparturesByCRS successfully', function(done) {
        //uncomment below and update the code to test getFastestDeparturesByCRS
        //instance.getFastestDeparturesByCRS(function(error) {
    ...
    describe('getNextDeparturesByCRS', function() {
      it('should call getNextDeparturesByCRS successfully', function(done) {
        //uncomment below and update the code to test getNextDeparturesByCRS
        //instance.getNextDeparturesByCRS(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
