...
/*
 * OAITransportOpsgenie_jsonld_put.h
 *
...
#ifndef OAITransportOpsgenie_jsonld_put_H
#define OAITransportOpsgenie_jsonld_put_H
...
class OAITransportOpsgenie_jsonld_put : public OAIObject {
public:
    OAITransportOpsgenie_jsonld_put();
    OAITransportOpsgenie_jsonld_put(QString json);
    ~OAITransportOpsgenie_jsonld_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportOpsgenie_jsonld_put)

#endif // OAITransportOpsgenie_jsonld_put_H
