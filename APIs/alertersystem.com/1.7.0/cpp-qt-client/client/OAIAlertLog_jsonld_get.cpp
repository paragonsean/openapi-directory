...
OAIAlertLog_jsonld_get::OAIAlertLog_jsonld_get(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAlertLog_jsonld_get::OAIAlertLog_jsonld_get() {
    this->initializeModel();
}

OAIAlertLog_jsonld_get::~OAIAlertLog_jsonld_get() {}

void OAIAlertLog_jsonld_get::initializeModel() {
...
void OAIAlertLog_jsonld_get::fromJson(QString jsonString) {
...
void OAIAlertLog_jsonld_get::fromJsonObject(QJsonObject json) {
...
QString OAIAlertLog_jsonld_get::asJson() const {
...
QJsonObject OAIAlertLog_jsonld_get::asJsonObject() const {
    QJsonObject obj;
    if (m_context.isSet()) {
...
OAIAlertLog_jsonld_get__context OAIAlertLog_jsonld_get::getContext() const {
    return m_context;
}
void OAIAlertLog_jsonld_get::setContext(const OAIAlertLog_jsonld_get__context &context) {
    m_context = context;
    m_context_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_context_Set() const{
    return m_context_isSet;
}

bool OAIAlertLog_jsonld_get::is_context_Valid() const{
    return m_context_isValid;
}

QString OAIAlertLog_jsonld_get::getId() const {
    return m_id;
}
void OAIAlertLog_jsonld_get::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAlertLog_jsonld_get::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAlertLog_jsonld_get::getType() const {
    return m_type;
}
void OAIAlertLog_jsonld_get::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAlertLog_jsonld_get::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIAlertLog_jsonld_get::getAlertLogErrorMessage() const {
    return m_alert_log_error_message;
}
void OAIAlertLog_jsonld_get::setAlertLogErrorMessage(const QString &alert_log_error_message) {
    m_alert_log_error_message = alert_log_error_message;
    m_alert_log_error_message_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_alert_log_error_message_Set() const{
    return m_alert_log_error_message_isSet;
}

bool OAIAlertLog_jsonld_get::is_alert_log_error_message_Valid() const{
    return m_alert_log_error_message_isValid;
}

QString OAIAlertLog_jsonld_get::getAlertLogMessageId() const {
    return m_alert_log_message_id;
}
void OAIAlertLog_jsonld_get::setAlertLogMessageId(const QString &alert_log_message_id) {
    m_alert_log_message_id = alert_log_message_id;
    m_alert_log_message_id_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_alert_log_message_id_Set() const{
    return m_alert_log_message_id_isSet;
}

bool OAIAlertLog_jsonld_get::is_alert_log_message_id_Valid() const{
    return m_alert_log_message_id_isValid;
}

QString OAIAlertLog_jsonld_get::getAlertLogStatusCode() const {
    return m_alert_log_status_code;
}
void OAIAlertLog_jsonld_get::setAlertLogStatusCode(const QString &alert_log_status_code) {
    m_alert_log_status_code = alert_log_status_code;
    m_alert_log_status_code_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_alert_log_status_code_Set() const{
    return m_alert_log_status_code_isSet;
}

bool OAIAlertLog_jsonld_get::is_alert_log_status_code_Valid() const{
    return m_alert_log_status_code_isValid;
}

QString OAIAlertLog_jsonld_get::getAlertService() const {
    return m_alert_service;
}
void OAIAlertLog_jsonld_get::setAlertService(const QString &alert_service) {
    m_alert_service = alert_service;
    m_alert_service_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_alert_service_Set() const{
    return m_alert_service_isSet;
}

bool OAIAlertLog_jsonld_get::is_alert_service_Valid() const{
    return m_alert_service_isValid;
}

QDateTime OAIAlertLog_jsonld_get::getCreatedAt() const {
    return m_created_at;
}
void OAIAlertLog_jsonld_get::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIAlertLog_jsonld_get::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIAlertLog_jsonld_get::getDataSegmentCode() const {
    return m_data_segment_code;
}
void OAIAlertLog_jsonld_get::setDataSegmentCode(const QString &data_segment_code) {
    m_data_segment_code = data_segment_code;
    m_data_segment_code_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_data_segment_code_Set() const{
    return m_data_segment_code_isSet;
}

bool OAIAlertLog_jsonld_get::is_data_segment_code_Valid() const{
...
QString OAIAlertLog_jsonld_get::getMonitor() const {
    return m_monitor;
}
void OAIAlertLog_jsonld_get::setMonitor(const QString &monitor) {
    m_monitor = monitor;
    m_monitor_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_monitor_Set() const{
    return m_monitor_isSet;
}

bool OAIAlertLog_jsonld_get::is_monitor_Valid() const{
    return m_monitor_isValid;
}

QString OAIAlertLog_jsonld_get::getPartition() const {
    return m_partition;
}
void OAIAlertLog_jsonld_get::setPartition(const QString &partition) {
    m_partition = partition;
    m_partition_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_partition_Set() const{
    return m_partition_isSet;
}

bool OAIAlertLog_jsonld_get::is_partition_Valid() const{
    return m_partition_isValid;
}

QString OAIAlertLog_jsonld_get::getPing() const {
    return m_ping;
}
void OAIAlertLog_jsonld_get::setPing(const QString &ping) {
    m_ping = ping;
    m_ping_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_ping_Set() const{
    return m_ping_isSet;
}

bool OAIAlertLog_jsonld_get::is_ping_Valid() const{
    return m_ping_isValid;
}

QString OAIAlertLog_jsonld_get::getResourceOwner() const {
    return m_resource_owner;
}
void OAIAlertLog_jsonld_get::setResourceOwner(const QString &resource_owner) {
    m_resource_owner = resource_owner;
    m_resource_owner_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_resource_owner_Set() const{
    return m_resource_owner_isSet;
}

bool OAIAlertLog_jsonld_get::is_resource_owner_Valid() const{
    return m_resource_owner_isValid;
}

QString OAIAlertLog_jsonld_get::getWebhookResponseBody() const {
    return m_webhook_response_body;
}
void OAIAlertLog_jsonld_get::setWebhookResponseBody(const QString &webhook_response_body) {
    m_webhook_response_body = webhook_response_body;
    m_webhook_response_body_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_webhook_response_body_Set() const{
    return m_webhook_response_body_isSet;
}

bool OAIAlertLog_jsonld_get::is_webhook_response_body_Valid() const{
    return m_webhook_response_body_isValid;
}

QList<QString> OAIAlertLog_jsonld_get::getWebhookResponseHeaders() const {
    return m_webhook_response_headers;
}
void OAIAlertLog_jsonld_get::setWebhookResponseHeaders(const QList<QString> &webhook_response_headers) {
    m_webhook_response_headers = webhook_response_headers;
    m_webhook_response_headers_isSet = true;
}

bool OAIAlertLog_jsonld_get::is_webhook_response_headers_Set() const{
    return m_webhook_response_headers_isSet;
}

bool OAIAlertLog_jsonld_get::is_webhook_response_headers_Valid() const{
    return m_webhook_response_headers_isValid;
}

bool OAIAlertLog_jsonld_get::isSet() const {
...
bool OAIAlertLog_jsonld_get::isValid() const {
