...
#ifndef OAITransportOpsgenie_put_H
#define OAITransportOpsgenie_put_H
...
class OAITransportOpsgenie_put : public OAIObject {
public:
    OAITransportOpsgenie_put();
    OAITransportOpsgenie_put(QString json);
    ~OAITransportOpsgenie_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportOpsgenie_put)

#endif // OAITransportOpsgenie_put_H
