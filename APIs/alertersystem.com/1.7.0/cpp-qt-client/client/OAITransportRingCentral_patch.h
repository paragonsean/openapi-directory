...
/*
 * OAITransportRingCentral_patch.h
 *
...
#ifndef OAITransportRingCentral_patch_H
#define OAITransportRingCentral_patch_H
...
class OAITransportRingCentral_patch : public OAIObject {
public:
    OAITransportRingCentral_patch();
    OAITransportRingCentral_patch(QString json);
    ~OAITransportRingCentral_patch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportRingCentral_patch)

#endif // OAITransportRingCentral_patch_H
