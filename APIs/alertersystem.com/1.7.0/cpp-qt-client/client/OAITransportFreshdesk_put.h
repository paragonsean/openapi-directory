...
#ifndef OAITransportFreshdesk_put_H
#define OAITransportFreshdesk_put_H
...
class OAITransportFreshdesk_put : public OAIObject {
public:
    OAITransportFreshdesk_put();
    OAITransportFreshdesk_put(QString json);
    ~OAITransportFreshdesk_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportFreshdesk_put)

#endif // OAITransportFreshdesk_put_H
