...
class OAITransportPlivo_jsonld_get : public OAIObject {
public:
    OAITransportPlivo_jsonld_get();
    OAITransportPlivo_jsonld_get(QString json);
    ~OAITransportPlivo_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportPlivo_jsonld_get)

#endif // OAITransportPlivo_jsonld_get_H
