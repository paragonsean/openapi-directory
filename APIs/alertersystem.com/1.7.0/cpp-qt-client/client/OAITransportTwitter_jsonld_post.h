...
class OAITransportTwitter_jsonld_post : public OAIObject {
public:
    OAITransportTwitter_jsonld_post();
    OAITransportTwitter_jsonld_post(QString json);
    ~OAITransportTwitter_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTwitter_jsonld_post)

#endif // OAITransportTwitter_jsonld_post_H
