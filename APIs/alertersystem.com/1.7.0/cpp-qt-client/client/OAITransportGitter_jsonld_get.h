...
class OAITransportGitter_jsonld_get : public OAIObject {
public:
    OAITransportGitter_jsonld_get();
    OAITransportGitter_jsonld_get(QString json);
    ~OAITransportGitter_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGitter_jsonld_get)

#endif // OAITransportGitter_jsonld_get_H
