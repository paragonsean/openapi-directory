...
/*
 * OAITransportLinkedIn_jsonld_get.h
 *
...
#ifndef OAITransportLinkedIn_jsonld_get_H
#define OAITransportLinkedIn_jsonld_get_H
...
class OAITransportLinkedIn_jsonld_get : public OAIObject {
public:
    OAITransportLinkedIn_jsonld_get();
    OAITransportLinkedIn_jsonld_get(QString json);
    ~OAITransportLinkedIn_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportLinkedIn_jsonld_get)

#endif // OAITransportLinkedIn_jsonld_get_H
