...
class OAITransportTermii_get : public OAIObject {
public:
    OAITransportTermii_get();
    OAITransportTermii_get(QString json);
    ~OAITransportTermii_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTermii_get)

#endif // OAITransportTermii_get_H
