...
class OAITransportInfobip_jsonld_get : public OAIObject {
public:
    OAITransportInfobip_jsonld_get();
    OAITransportInfobip_jsonld_get(QString json);
    ~OAITransportInfobip_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportInfobip_jsonld_get)

#endif // OAITransportInfobip_jsonld_get_H
