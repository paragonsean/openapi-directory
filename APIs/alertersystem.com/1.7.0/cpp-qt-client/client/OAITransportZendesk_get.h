...
class OAITransportZendesk_get : public OAIObject {
public:
    OAITransportZendesk_get();
    OAITransportZendesk_get(QString json);
    ~OAITransportZendesk_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportZendesk_get)

#endif // OAITransportZendesk_get_H
