...
OAIPing_jsonld_post::OAIPing_jsonld_post(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPing_jsonld_post::OAIPing_jsonld_post() {
    this->initializeModel();
}

OAIPing_jsonld_post::~OAIPing_jsonld_post() {}

void OAIPing_jsonld_post::initializeModel() {
...
void OAIPing_jsonld_post::fromJson(QString jsonString) {
...
void OAIPing_jsonld_post::fromJsonObject(QJsonObject json) {
...
QString OAIPing_jsonld_post::asJson() const {
...
QJsonObject OAIPing_jsonld_post::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIPing_jsonld_post::getExpectNextPingAt() const {
    return m_expect_next_ping_at;
}
void OAIPing_jsonld_post::setExpectNextPingAt(const QDateTime &expect_next_ping_at) {
    m_expect_next_ping_at = expect_next_ping_at;
    m_expect_next_ping_at_isSet = true;
}

bool OAIPing_jsonld_post::is_expect_next_ping_at_Set() const{
    return m_expect_next_ping_at_isSet;
}

bool OAIPing_jsonld_post::is_expect_next_ping_at_Valid() const{
    return m_expect_next_ping_at_isValid;
}

qint32 OAIPing_jsonld_post::getExpectNextPingAtEpoch() const {
    return m_expect_next_ping_at_epoch;
}
void OAIPing_jsonld_post::setExpectNextPingAtEpoch(const qint32 &expect_next_ping_at_epoch) {
    m_expect_next_ping_at_epoch = expect_next_ping_at_epoch;
    m_expect_next_ping_at_epoch_isSet = true;
}

bool OAIPing_jsonld_post::is_expect_next_ping_at_epoch_Set() const{
    return m_expect_next_ping_at_epoch_isSet;
}

bool OAIPing_jsonld_post::is_expect_next_ping_at_epoch_Valid() const{
    return m_expect_next_ping_at_epoch_isValid;
}

QString OAIPing_jsonld_post::getMonitor() const {
    return m_monitor;
}
void OAIPing_jsonld_post::setMonitor(const QString &monitor) {
    m_monitor = monitor;
    m_monitor_isSet = true;
}

bool OAIPing_jsonld_post::is_monitor_Set() const{
    return m_monitor_isSet;
}

bool OAIPing_jsonld_post::is_monitor_Valid() const{
    return m_monitor_isValid;
}

QString OAIPing_jsonld_post::getPingCustomCode() const {
    return m_ping_custom_code;
}
void OAIPing_jsonld_post::setPingCustomCode(const QString &ping_custom_code) {
    m_ping_custom_code = ping_custom_code;
    m_ping_custom_code_isSet = true;
}

bool OAIPing_jsonld_post::is_ping_custom_code_Set() const{
    return m_ping_custom_code_isSet;
}

bool OAIPing_jsonld_post::is_ping_custom_code_Valid() const{
    return m_ping_custom_code_isValid;
}

QString OAIPing_jsonld_post::getPingCustomPayload() const {
    return m_ping_custom_payload;
}
void OAIPing_jsonld_post::setPingCustomPayload(const QString &ping_custom_payload) {
    m_ping_custom_payload = ping_custom_payload;
    m_ping_custom_payload_isSet = true;
}

bool OAIPing_jsonld_post::is_ping_custom_payload_Set() const{
    return m_ping_custom_payload_isSet;
}

bool OAIPing_jsonld_post::is_ping_custom_payload_Valid() const{
    return m_ping_custom_payload_isValid;
}

bool OAIPing_jsonld_post::isSet() const {
...
bool OAIPing_jsonld_post::isValid() const {
