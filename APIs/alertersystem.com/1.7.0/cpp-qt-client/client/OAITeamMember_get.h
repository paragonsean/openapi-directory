...
#ifndef OAITeamMember_get_H
#define OAITeamMember_get_H
...
class OAITeamMember_get : public OAIObject {
public:
    OAITeamMember_get();
    OAITeamMember_get(QString json);
    ~OAITeamMember_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITeamMember_get)

#endif // OAITeamMember_get_H
