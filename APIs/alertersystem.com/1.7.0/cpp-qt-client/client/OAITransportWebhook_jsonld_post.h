...
/*
 * OAITransportWebhook_jsonld_post.h
 *
...
#ifndef OAITransportWebhook_jsonld_post_H
#define OAITransportWebhook_jsonld_post_H
...
class OAITransportWebhook_jsonld_post : public OAIObject {
public:
    OAITransportWebhook_jsonld_post();
    OAITransportWebhook_jsonld_post(QString json);
    ~OAITransportWebhook_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportWebhook_jsonld_post)

#endif // OAITransportWebhook_jsonld_post_H
