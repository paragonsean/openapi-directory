...
/*
 * OAITransportTelegram_jsonld_post.h
 *
...
#ifndef OAITransportTelegram_jsonld_post_H
#define OAITransportTelegram_jsonld_post_H
...
class OAITransportTelegram_jsonld_post : public OAIObject {
public:
    OAITransportTelegram_jsonld_post();
    OAITransportTelegram_jsonld_post(QString json);
    ~OAITransportTelegram_jsonld_post() override;
    ...
    void setTelegramChatId(const QString &telegram_chat_id);
    bool is_telegram_chat_id_Set() const;
    bool is_telegram_chat_id_Valid() const;

    QString getTelegramToken() const;
    void setTelegramToken(const QString &telegram_token);
    bool is_telegram_token_Set() const;
    bool is_telegram_token_Valid() const;
...
private:
    ...
    QString m_telegram_chat_id;
    bool m_telegram_chat_id_isSet;
    bool m_telegram_chat_id_isValid;

    QString m_telegram_token;
    bool m_telegram_token_isSet;
    bool m_telegram_token_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTelegram_jsonld_post)

#endif // OAITransportTelegram_jsonld_post_H
