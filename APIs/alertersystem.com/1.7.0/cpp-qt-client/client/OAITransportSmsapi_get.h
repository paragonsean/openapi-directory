...
class OAITransportSmsapi_get : public OAIObject {
public:
    OAITransportSmsapi_get();
    OAITransportSmsapi_get(QString json);
    ~OAITransportSmsapi_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSmsapi_get)

#endif // OAITransportSmsapi_get_H
