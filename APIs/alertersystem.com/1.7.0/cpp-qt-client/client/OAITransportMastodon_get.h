...
#ifndef OAITransportMastodon_get_H
#define OAITransportMastodon_get_H
...
class OAITransportMastodon_get : public OAIObject {
public:
    OAITransportMastodon_get();
    OAITransportMastodon_get(QString json);
    ~OAITransportMastodon_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMastodon_get)

#endif // OAITransportMastodon_get_H
