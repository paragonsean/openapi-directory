...
/*
 * OAITransportRingCentral_jsonld_get.h
 *
...
#ifndef OAITransportRingCentral_jsonld_get_H
#define OAITransportRingCentral_jsonld_get_H
...
class OAITransportRingCentral_jsonld_get : public OAIObject {
public:
    OAITransportRingCentral_jsonld_get();
    OAITransportRingCentral_jsonld_get(QString json);
    ~OAITransportRingCentral_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportRingCentral_jsonld_get)

#endif // OAITransportRingCentral_jsonld_get_H
