...
OAIMonitor_post::OAIMonitor_post(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMonitor_post::OAIMonitor_post() {
    this->initializeModel();
}

OAIMonitor_post::~OAIMonitor_post() {}

void OAIMonitor_post::initializeModel() {
...
void OAIMonitor_post::fromJson(QString jsonString) {
...
void OAIMonitor_post::fromJsonObject(QJsonObject json) {
...
QString OAIMonitor_post::asJson() const {
...
QJsonObject OAIMonitor_post::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMonitor_post::getAlertPayloadExtended() const {
    return m_alert_payload_extended;
}
void OAIMonitor_post::setAlertPayloadExtended(const QString &alert_payload_extended) {
    m_alert_payload_extended = alert_payload_extended;
    m_alert_payload_extended_isSet = true;
}

bool OAIMonitor_post::is_alert_payload_extended_Set() const{
    return m_alert_payload_extended_isSet;
}

bool OAIMonitor_post::is_alert_payload_extended_Valid() const{
    return m_alert_payload_extended_isValid;
}

QString OAIMonitor_post::getAlertPayloadShort() const {
    return m_alert_payload_short;
}
void OAIMonitor_post::setAlertPayloadShort(const QString &alert_payload_short) {
    m_alert_payload_short = alert_payload_short;
    m_alert_payload_short_isSet = true;
}

bool OAIMonitor_post::is_alert_payload_short_Set() const{
    return m_alert_payload_short_isSet;
}

bool OAIMonitor_post::is_alert_payload_short_Valid() const{
    return m_alert_payload_short_isValid;
}

QList<QString> OAIMonitor_post::getAlertServices() const {
    return m_alert_services;
}
void OAIMonitor_post::setAlertServices(const QList<QString> &alert_services) {
    m_alert_services = alert_services;
    m_alert_services_isSet = true;
}

bool OAIMonitor_post::is_alert_services_Set() const{
    return m_alert_services_isSet;
}

bool OAIMonitor_post::is_alert_services_Valid() const{
    return m_alert_services_isValid;
}

bool OAIMonitor_post::isAllowUnauthenticatedPings() const {
    return m_allow_unauthenticated_pings;
}
void OAIMonitor_post::setAllowUnauthenticatedPings(const bool &allow_unauthenticated_pings) {
    m_allow_unauthenticated_pings = allow_unauthenticated_pings;
    m_allow_unauthenticated_pings_isSet = true;
}

bool OAIMonitor_post::is_allow_unauthenticated_pings_Set() const{
    return m_allow_unauthenticated_pings_isSet;
}

bool OAIMonitor_post::is_allow_unauthenticated_pings_Valid() const{
    return m_allow_unauthenticated_pings_isValid;
}

bool OAIMonitor_post::isContentCheckMustNotExist() const {
    return m_content_check_must_not_exist;
}
void OAIMonitor_post::setContentCheckMustNotExist(const bool &content_check_must_not_exist) {
    m_content_check_must_not_exist = content_check_must_not_exist;
    m_content_check_must_not_exist_isSet = true;
}

bool OAIMonitor_post::is_content_check_must_not_exist_Set() const{
    return m_content_check_must_not_exist_isSet;
}

bool OAIMonitor_post::is_content_check_must_not_exist_Valid() const{
    return m_content_check_must_not_exist_isValid;
}

QString OAIMonitor_post::getContentCheckText() const {
    return m_content_check_text;
}
void OAIMonitor_post::setContentCheckText(const QString &content_check_text) {
    m_content_check_text = content_check_text;
    m_content_check_text_isSet = true;
}

bool OAIMonitor_post::is_content_check_text_Set() const{
    return m_content_check_text_isSet;
}

bool OAIMonitor_post::is_content_check_text_Valid() const{
    return m_content_check_text_isValid;
}

QString OAIMonitor_post::getContentCheckUrl() const {
    return m_content_check_url;
}
void OAIMonitor_post::setContentCheckUrl(const QString &content_check_url) {
    m_content_check_url = content_check_url;
    m_content_check_url_isSet = true;
}

bool OAIMonitor_post::is_content_check_url_Set() const{
    return m_content_check_url_isSet;
}

bool OAIMonitor_post::is_content_check_url_Valid() const{
    return m_content_check_url_isValid;
}

QString OAIMonitor_post::getContentCheckXpathFilter() const {
    return m_content_check_xpath_filter;
}
void OAIMonitor_post::setContentCheckXpathFilter(const QString &content_check_xpath_filter) {
    m_content_check_xpath_filter = content_check_xpath_filter;
    m_content_check_xpath_filter_isSet = true;
}

bool OAIMonitor_post::is_content_check_xpath_filter_Set() const{
    return m_content_check_xpath_filter_isSet;
}

bool OAIMonitor_post::is_content_check_xpath_filter_Valid() const{
    return m_content_check_xpath_filter_isValid;
}

QString OAIMonitor_post::getDataSegmentCode() const {
    return m_data_segment_code;
}
void OAIMonitor_post::setDataSegmentCode(const QString &data_segment_code) {
    m_data_segment_code = data_segment_code;
    m_data_segment_code_isSet = true;
}

bool OAIMonitor_post::is_data_segment_code_Set() const{
    return m_data_segment_code_isSet;
}

bool OAIMonitor_post::is_data_segment_code_Valid() const{
    return m_data_segment_code_isValid;
}

qint32 OAIMonitor_post::getGraceSeconds() const {
    return m_grace_seconds;
}
void OAIMonitor_post::setGraceSeconds(const qint32 &grace_seconds) {
    m_grace_seconds = grace_seconds;
    m_grace_seconds_isSet = true;
}

bool OAIMonitor_post::is_grace_seconds_Set() const{
    return m_grace_seconds_isSet;
}

bool OAIMonitor_post::is_grace_seconds_Valid() const{
    return m_grace_seconds_isValid;
}

qint32 OAIMonitor_post::getIntervalDays() const {
    return m_interval_days;
}
void OAIMonitor_post::setIntervalDays(const qint32 &interval_days) {
    m_interval_days = interval_days;
    m_interval_days_isSet = true;
}

bool OAIMonitor_post::is_interval_days_Set() const{
    return m_interval_days_isSet;
}

bool OAIMonitor_post::is_interval_days_Valid() const{
    return m_interval_days_isValid;
}

qint32 OAIMonitor_post::getIntervalHours() const {
    return m_interval_hours;
}
void OAIMonitor_post::setIntervalHours(const qint32 &interval_hours) {
    m_interval_hours = interval_hours;
    m_interval_hours_isSet = true;
}

bool OAIMonitor_post::is_interval_hours_Set() const{
    return m_interval_hours_isSet;
}

bool OAIMonitor_post::is_interval_hours_Valid() const{
    return m_interval_hours_isValid;
}

qint32 OAIMonitor_post::getIntervalMinutes() const {
    return m_interval_minutes;
}
void OAIMonitor_post::setIntervalMinutes(const qint32 &interval_minutes) {
    m_interval_minutes = interval_minutes;
    m_interval_minutes_isSet = true;
}

bool OAIMonitor_post::is_interval_minutes_Set() const{
    return m_interval_minutes_isSet;
}

bool OAIMonitor_post::is_interval_minutes_Valid() const{
    return m_interval_minutes_isValid;
}

qint32 OAIMonitor_post::getIntervalMonths() const {
    return m_interval_months;
}
void OAIMonitor_post::setIntervalMonths(const qint32 &interval_months) {
    m_interval_months = interval_months;
    m_interval_months_isSet = true;
}

bool OAIMonitor_post::is_interval_months_Set() const{
    return m_interval_months_isSet;
}

bool OAIMonitor_post::is_interval_months_Valid() const{
    return m_interval_months_isValid;
}

qint32 OAIMonitor_post::getIntervalSeconds() const {
    return m_interval_seconds;
}
void OAIMonitor_post::setIntervalSeconds(const qint32 &interval_seconds) {
    m_interval_seconds = interval_seconds;
    m_interval_seconds_isSet = true;
}

bool OAIMonitor_post::is_interval_seconds_Set() const{
    return m_interval_seconds_isSet;
}

bool OAIMonitor_post::is_interval_seconds_Valid() const{
    return m_interval_seconds_isValid;
}

qint32 OAIMonitor_post::getIntervalYears() const {
    return m_interval_years;
}
void OAIMonitor_post::setIntervalYears(const qint32 &interval_years) {
    m_interval_years = interval_years;
    m_interval_years_isSet = true;
}

bool OAIMonitor_post::is_interval_years_Set() const{
    return m_interval_years_isSet;
}

bool OAIMonitor_post::is_interval_years_Valid() const{
    return m_interval_years_isValid;
}

bool OAIMonitor_post::isIsMonitorPaused() const {
    return m_is_monitor_paused;
}
void OAIMonitor_post::setIsMonitorPaused(const bool &is_monitor_paused) {
    m_is_monitor_paused = is_monitor_paused;
    m_is_monitor_paused_isSet = true;
}

bool OAIMonitor_post::is_is_monitor_paused_Set() const{
    return m_is_monitor_paused_isSet;
}

bool OAIMonitor_post::is_is_monitor_paused_Valid() const{
    return m_is_monitor_paused_isValid;
}

QString OAIMonitor_post::getMonitorName() const {
    return m_monitor_name;
}
void OAIMonitor_post::setMonitorName(const QString &monitor_name) {
    m_monitor_name = monitor_name;
    m_monitor_name_isSet = true;
}

bool OAIMonitor_post::is_monitor_name_Set() const{
    return m_monitor_name_isSet;
}

bool OAIMonitor_post::is_monitor_name_Valid() const{
    return m_monitor_name_isValid;
}

QString OAIMonitor_post::getMonitorNotes() const {
    return m_monitor_notes;
}
void OAIMonitor_post::setMonitorNotes(const QString &monitor_notes) {
    m_monitor_notes = monitor_notes;
    m_monitor_notes_isSet = true;
}

bool OAIMonitor_post::is_monitor_notes_Set() const{
    return m_monitor_notes_isSet;
}

bool OAIMonitor_post::is_monitor_notes_Valid() const{
    return m_monitor_notes_isValid;
}

QString OAIMonitor_post::getMonitorTypeCode() const {
    return m_monitor_type_code;
}
void OAIMonitor_post::setMonitorTypeCode(const QString &monitor_type_code) {
    m_monitor_type_code = monitor_type_code;
    m_monitor_type_code_isSet = true;
}

bool OAIMonitor_post::is_monitor_type_code_Set() const{
    return m_monitor_type_code_isSet;
}

bool OAIMonitor_post::is_monitor_type_code_Valid() const{
    return m_monitor_type_code_isValid;
}

QString OAIMonitor_post::getPartition() const {
    return m_partition;
}
void OAIMonitor_post::setPartition(const QString &partition) {
    m_partition = partition;
    m_partition_isSet = true;
}

bool OAIMonitor_post::is_partition_Set() const{
    return m_partition_isSet;
}

bool OAIMonitor_post::is_partition_Valid() const{
    return m_partition_isValid;
}

QString OAIMonitor_post::getPublicDescription() const {
    return m_public_description;
}
void OAIMonitor_post::setPublicDescription(const QString &public_description) {
    m_public_description = public_description;
    m_public_description_isSet = true;
}

bool OAIMonitor_post::is_public_description_Set() const{
    return m_public_description_isSet;
}

bool OAIMonitor_post::is_public_description_Valid() const{
    return m_public_description_isValid;
}

QDateTime OAIMonitor_post::getStartMonitorAt() const {
    return m_start_monitor_at;
}
void OAIMonitor_post::setStartMonitorAt(const QDateTime &start_monitor_at) {
    m_start_monitor_at = start_monitor_at;
    m_start_monitor_at_isSet = true;
}

bool OAIMonitor_post::is_start_monitor_at_Set() const{
    return m_start_monitor_at_isSet;
}

bool OAIMonitor_post::is_start_monitor_at_Valid() const{
    return m_start_monitor_at_isValid;
}

QString OAIMonitor_post::getTimezoneCode() const {
    return m_timezone_code;
}
void OAIMonitor_post::setTimezoneCode(const QString &timezone_code) {
    m_timezone_code = timezone_code;
    m_timezone_code_isSet = true;
}

bool OAIMonitor_post::is_timezone_code_Set() const{
    return m_timezone_code_isSet;
}

bool OAIMonitor_post::is_timezone_code_Valid() const{
    return m_timezone_code_isValid;
}

qint32 OAIMonitor_post::getWebResponseSecondsLimit() const {
    return m_web_response_seconds_limit;
}
void OAIMonitor_post::setWebResponseSecondsLimit(const qint32 &web_response_seconds_limit) {
    m_web_response_seconds_limit = web_response_seconds_limit;
    m_web_response_seconds_limit_isSet = true;
}

bool OAIMonitor_post::is_web_response_seconds_limit_Set() const{
    return m_web_response_seconds_limit_isSet;
}

bool OAIMonitor_post::is_web_response_seconds_limit_Valid() const{
    return m_web_response_seconds_limit_isValid;
}

QString OAIMonitor_post::getWebResponseUrl() const {
    return m_web_response_url;
}
void OAIMonitor_post::setWebResponseUrl(const QString &web_response_url) {
    m_web_response_url = web_response_url;
    m_web_response_url_isSet = true;
}

bool OAIMonitor_post::is_web_response_url_Set() const{
    return m_web_response_url_isSet;
}

bool OAIMonitor_post::is_web_response_url_Valid() const{
    return m_web_response_url_isValid;
}

bool OAIMonitor_post::isSet() const {
...
bool OAIMonitor_post::isValid() const {
