...
#ifndef OAIMonitor_jsonld_post_H
#define OAIMonitor_jsonld_post_H
...
class OAIMonitor_jsonld_post : public OAIObject {
public:
    OAIMonitor_jsonld_post();
    OAIMonitor_jsonld_post(QString json);
    ~OAIMonitor_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitor_jsonld_post)

#endif // OAIMonitor_jsonld_post_H
