...
class OAIMonitorStatusLog_jsonld_get : public OAIObject {
public:
    OAIMonitorStatusLog_jsonld_get();
    OAIMonitorStatusLog_jsonld_get(QString json);
    ~OAIMonitorStatusLog_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitorStatusLog_jsonld_get)

#endif // OAIMonitorStatusLog_jsonld_get_H
