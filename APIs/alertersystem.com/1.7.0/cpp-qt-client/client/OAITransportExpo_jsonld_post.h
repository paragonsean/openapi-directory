...
class OAITransportExpo_jsonld_post : public OAIObject {
public:
    OAITransportExpo_jsonld_post();
    OAITransportExpo_jsonld_post(QString json);
    ~OAITransportExpo_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportExpo_jsonld_post)

#endif // OAITransportExpo_jsonld_post_H
