...
class OAITransportYunpian_post : public OAIObject {
public:
    OAITransportYunpian_post();
    OAITransportYunpian_post(QString json);
    ~OAITransportYunpian_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportYunpian_post)

#endif // OAITransportYunpian_post_H
