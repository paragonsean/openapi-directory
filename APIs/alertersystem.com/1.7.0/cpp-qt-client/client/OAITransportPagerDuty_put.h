...
#ifndef OAITransportPagerDuty_put_H
#define OAITransportPagerDuty_put_H
...
class OAITransportPagerDuty_put : public OAIObject {
public:
    OAITransportPagerDuty_put();
    OAITransportPagerDuty_put(QString json);
    ~OAITransportPagerDuty_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportPagerDuty_put)

#endif // OAITransportPagerDuty_put_H
