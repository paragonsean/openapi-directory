...
class OAITransportPushy_get : public OAIObject {
public:
    OAITransportPushy_get();
    OAITransportPushy_get(QString json);
    ~OAITransportPushy_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportPushy_get)

#endif // OAITransportPushy_get_H
