...
class OAITransportVonage_jsonld_get : public OAIObject {
public:
    OAITransportVonage_jsonld_get();
    OAITransportVonage_jsonld_get(QString json);
    ~OAITransportVonage_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportVonage_jsonld_get)

#endif // OAITransportVonage_jsonld_get_H
