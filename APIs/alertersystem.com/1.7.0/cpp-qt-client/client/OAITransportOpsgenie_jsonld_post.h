...
/*
 * OAITransportOpsgenie_jsonld_post.h
 *
...
#ifndef OAITransportOpsgenie_jsonld_post_H
#define OAITransportOpsgenie_jsonld_post_H
...
class OAITransportOpsgenie_jsonld_post : public OAIObject {
public:
    OAITransportOpsgenie_jsonld_post();
    OAITransportOpsgenie_jsonld_post(QString json);
    ~OAITransportOpsgenie_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportOpsgenie_jsonld_post)

#endif // OAITransportOpsgenie_jsonld_post_H
