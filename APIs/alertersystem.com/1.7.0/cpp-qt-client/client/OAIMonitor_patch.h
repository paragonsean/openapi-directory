...
#ifndef OAIMonitor_patch_H
#define OAIMonitor_patch_H
...
class OAIMonitor_patch : public OAIObject {
public:
    OAIMonitor_patch();
    OAIMonitor_patch(QString json);
    ~OAIMonitor_patch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitor_patch)

#endif // OAIMonitor_patch_H
