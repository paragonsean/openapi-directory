...
/*
 * OAITransportTurboSms_jsonld_get.h
 *
...
#ifndef OAITransportTurboSms_jsonld_get_H
#define OAITransportTurboSms_jsonld_get_H
...
class OAITransportTurboSms_jsonld_get : public OAIObject {
public:
    OAITransportTurboSms_jsonld_get();
    OAITransportTurboSms_jsonld_get(QString json);
    ~OAITransportTurboSms_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTurboSms_jsonld_get)

#endif // OAITransportTurboSms_jsonld_get_H
