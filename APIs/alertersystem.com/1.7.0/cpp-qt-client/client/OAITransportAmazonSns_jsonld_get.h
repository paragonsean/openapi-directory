...
/*
 * OAITransportAmazonSns_jsonld_get.h
 *
...
#ifndef OAITransportAmazonSns_jsonld_get_H
#define OAITransportAmazonSns_jsonld_get_H
...
class OAITransportAmazonSns_jsonld_get : public OAIObject {
public:
    OAITransportAmazonSns_jsonld_get();
    OAITransportAmazonSns_jsonld_get(QString json);
    ~OAITransportAmazonSns_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportAmazonSns_jsonld_get)

#endif // OAITransportAmazonSns_jsonld_get_H
