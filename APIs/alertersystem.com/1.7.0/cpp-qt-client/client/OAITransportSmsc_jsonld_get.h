...
class OAITransportSmsc_jsonld_get : public OAIObject {
public:
    OAITransportSmsc_jsonld_get();
    OAITransportSmsc_jsonld_get(QString json);
    ~OAITransportSmsc_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSmsc_jsonld_get)

#endif // OAITransportSmsc_jsonld_get_H
