...
class OAITransportPushy_post : public OAIObject {
public:
    OAITransportPushy_post();
    OAITransportPushy_post(QString json);
    ~OAITransportPushy_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportPushy_post)

#endif // OAITransportPushy_post_H
