...
/*
 * OAITransportRingCentral_jsonld_post.h
 *
...
#ifndef OAITransportRingCentral_jsonld_post_H
#define OAITransportRingCentral_jsonld_post_H
...
class OAITransportRingCentral_jsonld_post : public OAIObject {
public:
    OAITransportRingCentral_jsonld_post();
    OAITransportRingCentral_jsonld_post(QString json);
    ~OAITransportRingCentral_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportRingCentral_jsonld_post)

#endif // OAITransportRingCentral_jsonld_post_H
