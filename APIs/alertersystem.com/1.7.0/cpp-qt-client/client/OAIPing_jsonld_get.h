...
class OAIPing_jsonld_get : public OAIObject {
public:
    OAIPing_jsonld_get();
    OAIPing_jsonld_get(QString json);
    ~OAIPing_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPing_jsonld_get)

#endif // OAIPing_jsonld_get_H
