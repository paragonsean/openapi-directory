...
class OAITransportMercure_jsonld_get : public OAIObject {
public:
    OAITransportMercure_jsonld_get();
    OAITransportMercure_jsonld_get(QString json);
    ~OAITransportMercure_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMercure_jsonld_get)

#endif // OAITransportMercure_jsonld_get_H
