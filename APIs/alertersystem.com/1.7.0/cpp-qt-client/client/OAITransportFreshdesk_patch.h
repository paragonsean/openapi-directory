...
#ifndef OAITransportFreshdesk_patch_H
#define OAITransportFreshdesk_patch_H
...
class OAITransportFreshdesk_patch : public OAIObject {
public:
    OAITransportFreshdesk_patch();
    OAITransportFreshdesk_patch(QString json);
    ~OAITransportFreshdesk_patch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportFreshdesk_patch)

#endif // OAITransportFreshdesk_patch_H
