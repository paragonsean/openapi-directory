...
#ifndef OAITransportFreshdesk_get_H
#define OAITransportFreshdesk_get_H
...
class OAITransportFreshdesk_get : public OAIObject {
public:
    OAITransportFreshdesk_get();
    OAITransportFreshdesk_get(QString json);
    ~OAITransportFreshdesk_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportFreshdesk_get)

#endif // OAITransportFreshdesk_get_H
