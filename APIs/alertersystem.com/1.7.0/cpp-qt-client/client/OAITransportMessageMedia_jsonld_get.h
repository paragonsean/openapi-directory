...
/*
 * OAITransportMessageMedia_jsonld_get.h
 *
...
#ifndef OAITransportMessageMedia_jsonld_get_H
#define OAITransportMessageMedia_jsonld_get_H
...
class OAITransportMessageMedia_jsonld_get : public OAIObject {
public:
    OAITransportMessageMedia_jsonld_get();
    OAITransportMessageMedia_jsonld_get(QString json);
    ~OAITransportMessageMedia_jsonld_get() override;
    ...
    QString getMessageMediaApiKey() const;
    void setMessageMediaApiKey(const QString &message_media_api_key);
    bool is_message_media_api_key_Set() const;
    bool is_message_media_api_key_Valid() const;

    QString getMessageMediaApiSecret() const;
    void setMessageMediaApiSecret(const QString &message_media_api_secret);
    bool is_message_media_api_secret_Set() const;
    bool is_message_media_api_secret_Valid() const;

    QString getMessageMediaFrom() const;
    void setMessageMediaFrom(const QString &message_media_from);
    bool is_message_media_from_Set() const;
    bool is_message_media_from_Valid() const;
...
private:
    ...
    QString m_message_media_api_key;
    bool m_message_media_api_key_isSet;
    bool m_message_media_api_key_isValid;

    QString m_message_media_api_secret;
    bool m_message_media_api_secret_isSet;
    bool m_message_media_api_secret_isValid;

    QString m_message_media_from;
    bool m_message_media_from_isSet;
    bool m_message_media_from_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMessageMedia_jsonld_get)

#endif // OAITransportMessageMedia_jsonld_get_H
