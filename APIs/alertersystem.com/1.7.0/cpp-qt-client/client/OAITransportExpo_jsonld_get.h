...
class OAITransportExpo_jsonld_get : public OAIObject {
public:
    OAITransportExpo_jsonld_get();
    OAITransportExpo_jsonld_get(QString json);
    ~OAITransportExpo_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportExpo_jsonld_get)

#endif // OAITransportExpo_jsonld_get_H
