...
/*
 * OAITransportMessageBird_jsonld_get.h
 *
...
#ifndef OAITransportMessageBird_jsonld_get_H
#define OAITransportMessageBird_jsonld_get_H
...
class OAITransportMessageBird_jsonld_get : public OAIObject {
public:
    OAITransportMessageBird_jsonld_get();
    OAITransportMessageBird_jsonld_get(QString json);
    ~OAITransportMessageBird_jsonld_get() override;
    ...
    QString getMessageBirdFrom() const;
    void setMessageBirdFrom(const QString &message_bird_from);
    bool is_message_bird_from_Set() const;
    bool is_message_bird_from_Valid() const;

    QString getMessageBirdToken() const;
    void setMessageBirdToken(const QString &message_bird_token);
    bool is_message_bird_token_Set() const;
    bool is_message_bird_token_Valid() const;
...
private:
    ...
    QString m_message_bird_from;
    bool m_message_bird_from_isSet;
    bool m_message_bird_from_isValid;

    QString m_message_bird_token;
    bool m_message_bird_token_isSet;
    bool m_message_bird_token_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMessageBird_jsonld_get)

#endif // OAITransportMessageBird_jsonld_get_H
