...
class OAITransportTrello_jsonld_get : public OAIObject {
public:
    OAITransportTrello_jsonld_get();
    OAITransportTrello_jsonld_get(QString json);
    ~OAITransportTrello_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTrello_jsonld_get)

#endif // OAITransportTrello_jsonld_get_H
