...
/*
 * OAITransportTelegram_jsonld_get.h
 *
...
#ifndef OAITransportTelegram_jsonld_get_H
#define OAITransportTelegram_jsonld_get_H
...
class OAITransportTelegram_jsonld_get : public OAIObject {
public:
    OAITransportTelegram_jsonld_get();
    OAITransportTelegram_jsonld_get(QString json);
    ~OAITransportTelegram_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTelegram_jsonld_get)

#endif // OAITransportTelegram_jsonld_get_H
