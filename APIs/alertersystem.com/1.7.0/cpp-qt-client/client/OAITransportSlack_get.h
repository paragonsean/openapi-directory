...
class OAITransportSlack_get : public OAIObject {
public:
    OAITransportSlack_get();
    OAITransportSlack_get(QString json);
    ~OAITransportSlack_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSlack_get)

#endif // OAITransportSlack_get_H
