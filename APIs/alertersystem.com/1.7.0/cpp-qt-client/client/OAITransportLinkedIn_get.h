...
#ifndef OAITransportLinkedIn_get_H
#define OAITransportLinkedIn_get_H
...
class OAITransportLinkedIn_get : public OAIObject {
public:
    OAITransportLinkedIn_get();
    OAITransportLinkedIn_get(QString json);
    ~OAITransportLinkedIn_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportLinkedIn_get)

#endif // OAITransportLinkedIn_get_H
