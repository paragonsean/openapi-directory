...
class OAITransportDiscord_jsonld_get : public OAIObject {
public:
    OAITransportDiscord_jsonld_get();
    OAITransportDiscord_jsonld_get(QString json);
    ~OAITransportDiscord_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportDiscord_jsonld_get)

#endif // OAITransportDiscord_jsonld_get_H
