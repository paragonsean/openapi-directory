...
#ifndef OAIPartition_put_H
#define OAIPartition_put_H
...
class OAIPartition_put : public OAIObject {
public:
    OAIPartition_put();
    OAIPartition_put(QString json);
    ~OAIPartition_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartition_put)

#endif // OAIPartition_put_H
