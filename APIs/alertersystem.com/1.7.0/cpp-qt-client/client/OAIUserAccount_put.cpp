...
OAIUserAccount_put::OAIUserAccount_put(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserAccount_put::OAIUserAccount_put() {
    this->initializeModel();
}

OAIUserAccount_put::~OAIUserAccount_put() {}

void OAIUserAccount_put::initializeModel() {

    m_credits_overage_percent_trip_switch_isSet = false;
    m_credits_overage_percent_trip_switch_isValid = false;
}

void OAIUserAccount_put::fromJson(QString jsonString) {
...
void OAIUserAccount_put::fromJsonObject(QJsonObject json) {
...
QString OAIUserAccount_put::asJson() const {
...
QJsonObject OAIUserAccount_put::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIUserAccount_put::getCreditsOveragePercentTripSwitch() const {
    return m_credits_overage_percent_trip_switch;
}
void OAIUserAccount_put::setCreditsOveragePercentTripSwitch(const qint32 &credits_overage_percent_trip_switch) {
...
bool OAIUserAccount_put::is_credits_overage_percent_trip_switch_Set() const{
    return m_credits_overage_percent_trip_switch_isSet;
}

bool OAIUserAccount_put::is_credits_overage_percent_trip_switch_Valid() const{
    return m_credits_overage_percent_trip_switch_isValid;
}

bool OAIUserAccount_put::isSet() const {
...
bool OAIUserAccount_put::isValid() const {
