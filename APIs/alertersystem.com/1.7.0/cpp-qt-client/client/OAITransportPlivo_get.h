...
class OAITransportPlivo_get : public OAIObject {
public:
    OAITransportPlivo_get();
    OAITransportPlivo_get(QString json);
    ~OAITransportPlivo_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportPlivo_get)

#endif // OAITransportPlivo_get_H
