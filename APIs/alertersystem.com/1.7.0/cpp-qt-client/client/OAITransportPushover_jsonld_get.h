...
/*
 * OAITransportPushover_jsonld_get.h
 *
...
#ifndef OAITransportPushover_jsonld_get_H
#define OAITransportPushover_jsonld_get_H
...
class OAITransportPushover_jsonld_get : public OAIObject {
public:
    OAITransportPushover_jsonld_get();
    OAITransportPushover_jsonld_get(QString json);
    ~OAITransportPushover_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportPushover_jsonld_get)

#endif // OAITransportPushover_jsonld_get_H
