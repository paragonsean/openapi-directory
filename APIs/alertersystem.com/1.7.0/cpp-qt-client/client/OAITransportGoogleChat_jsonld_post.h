...
/*
 * OAITransportGoogleChat_jsonld_post.h
 *
...
#ifndef OAITransportGoogleChat_jsonld_post_H
#define OAITransportGoogleChat_jsonld_post_H
...
class OAITransportGoogleChat_jsonld_post : public OAIObject {
public:
    OAITransportGoogleChat_jsonld_post();
    OAITransportGoogleChat_jsonld_post(QString json);
    ~OAITransportGoogleChat_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGoogleChat_jsonld_post)

#endif // OAITransportGoogleChat_jsonld_post_H
