...
#ifndef OAITransportOpsgenie_patch_H
#define OAITransportOpsgenie_patch_H
...
class OAITransportOpsgenie_patch : public OAIObject {
public:
    OAITransportOpsgenie_patch();
    OAITransportOpsgenie_patch(QString json);
    ~OAITransportOpsgenie_patch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportOpsgenie_patch)

#endif // OAITransportOpsgenie_patch_H
