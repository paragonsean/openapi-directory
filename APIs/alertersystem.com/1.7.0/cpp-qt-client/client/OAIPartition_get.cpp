...
OAIPartition_get::OAIPartition_get(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPartition_get::OAIPartition_get() {
    this->initializeModel();
}

OAIPartition_get::~OAIPartition_get() {}

void OAIPartition_get::initializeModel() {
...
void OAIPartition_get::fromJson(QString jsonString) {
...
void OAIPartition_get::fromJsonObject(QJsonObject json) {
...
QString OAIPartition_get::asJson() const {
...
QJsonObject OAIPartition_get::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIPartition_get::getAlertServices() const {
    return m_alert_services;
}
void OAIPartition_get::setAlertServices(const QList<QString> &alert_services) {
    m_alert_services = alert_services;
    m_alert_services_isSet = true;
}

bool OAIPartition_get::is_alert_services_Set() const{
    return m_alert_services_isSet;
}

bool OAIPartition_get::is_alert_services_Valid() const{
    return m_alert_services_isValid;
}

QDateTime OAIPartition_get::getCreatedAt() const {
    return m_created_at;
}
void OAIPartition_get::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIPartition_get::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIPartition_get::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIPartition_get::getDataSegmentCode() const {
    return m_data_segment_code;
}
void OAIPartition_get::setDataSegmentCode(const QString &data_segment_code) {
    m_data_segment_code = data_segment_code;
    m_data_segment_code_isSet = true;
}

bool OAIPartition_get::is_data_segment_code_Set() const{
    return m_data_segment_code_isSet;
}

bool OAIPartition_get::is_data_segment_code_Valid() const{
    return m_data_segment_code_isValid;
}

QString OAIPartition_get::getId() const {
    return m_id;
}
void OAIPartition_get::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPartition_get::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPartition_get::is_id_Valid() const{
    return m_id_isValid;
}

QList<QString> OAIPartition_get::getMonitors() const {
    return m_monitors;
}
void OAIPartition_get::setMonitors(const QList<QString> &monitors) {
    m_monitors = monitors;
    m_monitors_isSet = true;
}

bool OAIPartition_get::is_monitors_Set() const{
    return m_monitors_isSet;
}

bool OAIPartition_get::is_monitors_Valid() const{
    return m_monitors_isValid;
}

QString OAIPartition_get::getPartitionName() const {
    return m_partition_name;
}
void OAIPartition_get::setPartitionName(const QString &partition_name) {
    m_partition_name = partition_name;
    m_partition_name_isSet = true;
}

bool OAIPartition_get::is_partition_name_Set() const{
    return m_partition_name_isSet;
}

bool OAIPartition_get::is_partition_name_Valid() const{
    return m_partition_name_isValid;
}

QString OAIPartition_get::getPartitionNotes() const {
    return m_partition_notes;
}
void OAIPartition_get::setPartitionNotes(const QString &partition_notes) {
    m_partition_notes = partition_notes;
    m_partition_notes_isSet = true;
}

bool OAIPartition_get::is_partition_notes_Set() const{
    return m_partition_notes_isSet;
}

bool OAIPartition_get::is_partition_notes_Valid() const{
    return m_partition_notes_isValid;
}

QString OAIPartition_get::getResourceOwner() const {
    return m_resource_owner;
}
void OAIPartition_get::setResourceOwner(const QString &resource_owner) {
    m_resource_owner = resource_owner;
    m_resource_owner_isSet = true;
}

bool OAIPartition_get::is_resource_owner_Set() const{
    return m_resource_owner_isSet;
}

bool OAIPartition_get::is_resource_owner_Valid() const{
    return m_resource_owner_isValid;
}

QList<QString> OAIPartition_get::getTeamInvitations() const {
    return m_team_invitations;
}
void OAIPartition_get::setTeamInvitations(const QList<QString> &team_invitations) {
    m_team_invitations = team_invitations;
    m_team_invitations_isSet = true;
}

bool OAIPartition_get::is_team_invitations_Set() const{
    return m_team_invitations_isSet;
}

bool OAIPartition_get::is_team_invitations_Valid() const{
    return m_team_invitations_isValid;
}

QList<QString> OAIPartition_get::getTeamMembers() const {
    return m_team_members;
}
void OAIPartition_get::setTeamMembers(const QList<QString> &team_members) {
    m_team_members = team_members;
    m_team_members_isSet = true;
}

bool OAIPartition_get::is_team_members_Set() const{
    return m_team_members_isSet;
}

bool OAIPartition_get::is_team_members_Valid() const{
    return m_team_members_isValid;
}

bool OAIPartition_get::isSet() const {
...
bool OAIPartition_get::isValid() const {
