...
#ifndef OAITransportSpotHit_get_H
#define OAITransportSpotHit_get_H
...
class OAITransportSpotHit_get : public OAIObject {
public:
    OAITransportSpotHit_get();
    OAITransportSpotHit_get(QString json);
    ~OAITransportSpotHit_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSpotHit_get)

#endif // OAITransportSpotHit_get_H
