...
/*
 * OAITransportLightSms_jsonld_get.h
 *
...
#ifndef OAITransportLightSms_jsonld_get_H
#define OAITransportLightSms_jsonld_get_H
...
class OAITransportLightSms_jsonld_get : public OAIObject {
public:
    OAITransportLightSms_jsonld_get();
    OAITransportLightSms_jsonld_get(QString json);
    ~OAITransportLightSms_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportLightSms_jsonld_get)

#endif // OAITransportLightSms_jsonld_get_H
