...
class OAITransportInfobip_put : public OAIObject {
public:
    OAITransportInfobip_put();
    OAITransportInfobip_put(QString json);
    ~OAITransportInfobip_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportInfobip_put)

#endif // OAITransportInfobip_put_H
