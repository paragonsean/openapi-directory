...
class OAITransportSlack_patch : public OAIObject {
public:
    OAITransportSlack_patch();
    OAITransportSlack_patch(QString json);
    ~OAITransportSlack_patch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSlack_patch)

#endif // OAITransportSlack_patch_H
