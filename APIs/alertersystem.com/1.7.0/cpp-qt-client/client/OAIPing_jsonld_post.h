...
class OAIPing_jsonld_post : public OAIObject {
public:
    OAIPing_jsonld_post();
    OAIPing_jsonld_post(QString json);
    ~OAIPing_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPing_jsonld_post)

#endif // OAIPing_jsonld_post_H
