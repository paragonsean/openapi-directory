...
#ifndef OAITransportFirebase_get_H
#define OAITransportFirebase_get_H
...
class OAITransportFirebase_get : public OAIObject {
public:
    OAITransportFirebase_get();
    OAITransportFirebase_get(QString json);
    ~OAITransportFirebase_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportFirebase_get)

#endif // OAITransportFirebase_get_H
