...
class OAITeamMember_jsonld_get : public OAIObject {
public:
    OAITeamMember_jsonld_get();
    OAITeamMember_jsonld_get(QString json);
    ~OAITeamMember_jsonld_get() override;
    ...
    void setUserAccount(const QString &user_account);
...
Q_DECLARE_METATYPE(OpenAPI::OAITeamMember_jsonld_get)

#endif // OAITeamMember_jsonld_get_H
