...
OAITransportBandwidth_get::OAITransportBandwidth_get(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransportBandwidth_get::OAITransportBandwidth_get() {
    this->initializeModel();
}

OAITransportBandwidth_get::~OAITransportBandwidth_get() {}

void OAITransportBandwidth_get::initializeModel() {
...
void OAITransportBandwidth_get::fromJson(QString jsonString) {
...
void OAITransportBandwidth_get::fromJsonObject(QJsonObject json) {
...
QString OAITransportBandwidth_get::asJson() const {
...
QJsonObject OAITransportBandwidth_get::asJsonObject() const {
    QJsonObject obj;
...
QString OAITransportBandwidth_get::getBandwidthAccountId() const {
    return m_bandwidth_account_id;
}
void OAITransportBandwidth_get::setBandwidthAccountId(const QString &bandwidth_account_id) {
    m_bandwidth_account_id = bandwidth_account_id;
    m_bandwidth_account_id_isSet = true;
}

bool OAITransportBandwidth_get::is_bandwidth_account_id_Set() const{
    return m_bandwidth_account_id_isSet;
}

bool OAITransportBandwidth_get::is_bandwidth_account_id_Valid() const{
    return m_bandwidth_account_id_isValid;
}

QString OAITransportBandwidth_get::getBandwidthApplicationId() const {
    return m_bandwidth_application_id;
}
void OAITransportBandwidth_get::setBandwidthApplicationId(const QString &bandwidth_application_id) {
    m_bandwidth_application_id = bandwidth_application_id;
    m_bandwidth_application_id_isSet = true;
}

bool OAITransportBandwidth_get::is_bandwidth_application_id_Set() const{
    return m_bandwidth_application_id_isSet;
}

bool OAITransportBandwidth_get::is_bandwidth_application_id_Valid() const{
    return m_bandwidth_application_id_isValid;
}

QString OAITransportBandwidth_get::getBandwidthFrom() const {
    return m_bandwidth_from;
}
void OAITransportBandwidth_get::setBandwidthFrom(const QString &bandwidth_from) {
    m_bandwidth_from = bandwidth_from;
    m_bandwidth_from_isSet = true;
}

bool OAITransportBandwidth_get::is_bandwidth_from_Set() const{
    return m_bandwidth_from_isSet;
}

bool OAITransportBandwidth_get::is_bandwidth_from_Valid() const{
    return m_bandwidth_from_isValid;
}

QString OAITransportBandwidth_get::getBandwidthPassword() const {
    return m_bandwidth_password;
}
void OAITransportBandwidth_get::setBandwidthPassword(const QString &bandwidth_password) {
    m_bandwidth_password = bandwidth_password;
    m_bandwidth_password_isSet = true;
}

bool OAITransportBandwidth_get::is_bandwidth_password_Set() const{
    return m_bandwidth_password_isSet;
}

bool OAITransportBandwidth_get::is_bandwidth_password_Valid() const{
    return m_bandwidth_password_isValid;
}

QString OAITransportBandwidth_get::getBandwidthUsername() const {
    return m_bandwidth_username;
}
void OAITransportBandwidth_get::setBandwidthUsername(const QString &bandwidth_username) {
    m_bandwidth_username = bandwidth_username;
    m_bandwidth_username_isSet = true;
}

bool OAITransportBandwidth_get::is_bandwidth_username_Set() const{
    return m_bandwidth_username_isSet;
}

bool OAITransportBandwidth_get::is_bandwidth_username_Valid() const{
    return m_bandwidth_username_isValid;
}

QDateTime OAITransportBandwidth_get::getCreatedAt() const {
    return m_created_at;
}
void OAITransportBandwidth_get::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAITransportBandwidth_get::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAITransportBandwidth_get::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAITransportBandwidth_get::getDataSegmentCode() const {
    return m_data_segment_code;
}
void OAITransportBandwidth_get::setDataSegmentCode(const QString &data_segment_code) {
    m_data_segment_code = data_segment_code;
    m_data_segment_code_isSet = true;
}

bool OAITransportBandwidth_get::is_data_segment_code_Set() const{
    return m_data_segment_code_isSet;
}

bool OAITransportBandwidth_get::is_data_segment_code_Valid() const{
    return m_data_segment_code_isValid;
}

QString OAITransportBandwidth_get::getId() const {
    return m_id;
}
void OAITransportBandwidth_get::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITransportBandwidth_get::is_id_Set() const{
    return m_id_isSet;
}

bool OAITransportBandwidth_get::is_id_Valid() const{
    return m_id_isValid;
}

QString OAITransportBandwidth_get::getPartition() const {
    return m_partition;
}
void OAITransportBandwidth_get::setPartition(const QString &partition) {
    m_partition = partition;
    m_partition_isSet = true;
}

bool OAITransportBandwidth_get::is_partition_Set() const{
    return m_partition_isSet;
}

bool OAITransportBandwidth_get::is_partition_Valid() const{
    return m_partition_isValid;
}

QString OAITransportBandwidth_get::getResourceOwner() const {
    return m_resource_owner;
}
void OAITransportBandwidth_get::setResourceOwner(const QString &resource_owner) {
    m_resource_owner = resource_owner;
    m_resource_owner_isSet = true;
}

bool OAITransportBandwidth_get::is_resource_owner_Set() const{
    return m_resource_owner_isSet;
}

bool OAITransportBandwidth_get::is_resource_owner_Valid() const{
    return m_resource_owner_isValid;
}

QString OAITransportBandwidth_get::getTransportName() const {
    return m_transport_name;
}
void OAITransportBandwidth_get::setTransportName(const QString &transport_name) {
    m_transport_name = transport_name;
    m_transport_name_isSet = true;
}

bool OAITransportBandwidth_get::is_transport_name_Set() const{
    return m_transport_name_isSet;
}

bool OAITransportBandwidth_get::is_transport_name_Valid() const{
    return m_transport_name_isValid;
}

bool OAITransportBandwidth_get::isSet() const {
...
bool OAITransportBandwidth_get::isValid() const {
