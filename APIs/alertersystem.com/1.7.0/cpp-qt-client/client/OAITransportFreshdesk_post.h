...
#ifndef OAITransportFreshdesk_post_H
#define OAITransportFreshdesk_post_H
...
class OAITransportFreshdesk_post : public OAIObject {
public:
    OAITransportFreshdesk_post();
    OAITransportFreshdesk_post(QString json);
    ~OAITransportFreshdesk_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportFreshdesk_post)

#endif // OAITransportFreshdesk_post_H
