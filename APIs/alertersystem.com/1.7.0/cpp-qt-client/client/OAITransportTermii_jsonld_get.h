...
class OAITransportTermii_jsonld_get : public OAIObject {
public:
    OAITransportTermii_jsonld_get();
    OAITransportTermii_jsonld_get(QString json);
    ~OAITransportTermii_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTermii_jsonld_get)

#endif // OAITransportTermii_jsonld_get_H
