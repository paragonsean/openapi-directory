...
class OAITransportExpo_post : public OAIObject {
public:
    OAITransportExpo_post();
    OAITransportExpo_post(QString json);
    ~OAITransportExpo_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportExpo_post)

#endif // OAITransportExpo_post_H
