...
OAITransportTrello_get::OAITransportTrello_get(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransportTrello_get::OAITransportTrello_get() {
    this->initializeModel();
}

OAITransportTrello_get::~OAITransportTrello_get() {}

void OAITransportTrello_get::initializeModel() {
...
void OAITransportTrello_get::fromJson(QString jsonString) {
...
void OAITransportTrello_get::fromJsonObject(QJsonObject json) {
...
QString OAITransportTrello_get::asJson() const {
...
QJsonObject OAITransportTrello_get::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAITransportTrello_get::getCreatedAt() const {
    return m_created_at;
}
void OAITransportTrello_get::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAITransportTrello_get::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAITransportTrello_get::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAITransportTrello_get::getDataSegmentCode() const {
    return m_data_segment_code;
}
void OAITransportTrello_get::setDataSegmentCode(const QString &data_segment_code) {
    m_data_segment_code = data_segment_code;
    m_data_segment_code_isSet = true;
}

bool OAITransportTrello_get::is_data_segment_code_Set() const{
    return m_data_segment_code_isSet;
}

bool OAITransportTrello_get::is_data_segment_code_Valid() const{
    return m_data_segment_code_isValid;
}

QString OAITransportTrello_get::getId() const {
    return m_id;
}
void OAITransportTrello_get::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITransportTrello_get::is_id_Set() const{
    return m_id_isSet;
}

bool OAITransportTrello_get::is_id_Valid() const{
    return m_id_isValid;
}

QString OAITransportTrello_get::getPartition() const {
    return m_partition;
}
void OAITransportTrello_get::setPartition(const QString &partition) {
    m_partition = partition;
    m_partition_isSet = true;
}

bool OAITransportTrello_get::is_partition_Set() const{
    return m_partition_isSet;
}

bool OAITransportTrello_get::is_partition_Valid() const{
    return m_partition_isValid;
}

QString OAITransportTrello_get::getResourceOwner() const {
    return m_resource_owner;
}
void OAITransportTrello_get::setResourceOwner(const QString &resource_owner) {
    m_resource_owner = resource_owner;
    m_resource_owner_isSet = true;
}

bool OAITransportTrello_get::is_resource_owner_Set() const{
    return m_resource_owner_isSet;
}

bool OAITransportTrello_get::is_resource_owner_Valid() const{
    return m_resource_owner_isValid;
}

QString OAITransportTrello_get::getTransportName() const {
    return m_transport_name;
}
void OAITransportTrello_get::setTransportName(const QString &transport_name) {
    m_transport_name = transport_name;
    m_transport_name_isSet = true;
}

bool OAITransportTrello_get::is_transport_name_Set() const{
    return m_transport_name_isSet;
}

bool OAITransportTrello_get::is_transport_name_Valid() const{
    return m_transport_name_isValid;
}

QString OAITransportTrello_get::getTrelloApiKey() const {
    return m_trello_api_key;
}
void OAITransportTrello_get::setTrelloApiKey(const QString &trello_api_key) {
    m_trello_api_key = trello_api_key;
    m_trello_api_key_isSet = true;
}

bool OAITransportTrello_get::is_trello_api_key_Set() const{
    return m_trello_api_key_isSet;
}

bool OAITransportTrello_get::is_trello_api_key_Valid() const{
    return m_trello_api_key_isValid;
}

QString OAITransportTrello_get::getTrelloApiToken() const {
    return m_trello_api_token;
}
void OAITransportTrello_get::setTrelloApiToken(const QString &trello_api_token) {
    m_trello_api_token = trello_api_token;
    m_trello_api_token_isSet = true;
}

bool OAITransportTrello_get::is_trello_api_token_Set() const{
    return m_trello_api_token_isSet;
}

bool OAITransportTrello_get::is_trello_api_token_Valid() const{
    return m_trello_api_token_isValid;
}

QString OAITransportTrello_get::getTrelloListId() const {
    return m_trello_list_id;
}
void OAITransportTrello_get::setTrelloListId(const QString &trello_list_id) {
    m_trello_list_id = trello_list_id;
    m_trello_list_id_isSet = true;
}

bool OAITransportTrello_get::is_trello_list_id_Set() const{
    return m_trello_list_id_isSet;
}

bool OAITransportTrello_get::is_trello_list_id_Valid() const{
    return m_trello_list_id_isValid;
}

bool OAITransportTrello_get::isSet() const {
...
bool OAITransportTrello_get::isValid() const {
