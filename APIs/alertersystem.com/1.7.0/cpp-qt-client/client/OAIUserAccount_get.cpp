...
OAIUserAccount_get::OAIUserAccount_get(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserAccount_get::OAIUserAccount_get() {
    this->initializeModel();
}

OAIUserAccount_get::~OAIUserAccount_get() {}

void OAIUserAccount_get::initializeModel() {
...
void OAIUserAccount_get::fromJson(QString jsonString) {
...
void OAIUserAccount_get::fromJsonObject(QJsonObject json) {
...
QString OAIUserAccount_get::asJson() const {
...
QJsonObject OAIUserAccount_get::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUserAccount_get::getAccountLevelCode() const {
    return m_account_level_code;
}
void OAIUserAccount_get::setAccountLevelCode(const QString &account_level_code) {
    m_account_level_code = account_level_code;
    m_account_level_code_isSet = true;
}

bool OAIUserAccount_get::is_account_level_code_Set() const{
    return m_account_level_code_isSet;
}

bool OAIUserAccount_get::is_account_level_code_Valid() const{
    return m_account_level_code_isValid;
}

qint32 OAIUserAccount_get::getCreditsOveragePercentTripSwitch() const {
    return m_credits_overage_percent_trip_switch;
}
void OAIUserAccount_get::setCreditsOveragePercentTripSwitch(const qint32 &credits_overage_percent_trip_switch) {
...
bool OAIUserAccount_get::is_credits_overage_percent_trip_switch_Set() const{
    return m_credits_overage_percent_trip_switch_isSet;
}

bool OAIUserAccount_get::is_credits_overage_percent_trip_switch_Valid() const{
    return m_credits_overage_percent_trip_switch_isValid;
}

QString OAIUserAccount_get::getEmail() const {
    return m_email;
}
void OAIUserAccount_get::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIUserAccount_get::is_email_Set() const{
    return m_email_isSet;
}

bool OAIUserAccount_get::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIUserAccount_get::getFirstName() const {
    return m_first_name;
}
void OAIUserAccount_get::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIUserAccount_get::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIUserAccount_get::is_first_name_Valid() const{
    return m_first_name_isValid;
}

QString OAIUserAccount_get::getId() const {
    return m_id;
}
void OAIUserAccount_get::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUserAccount_get::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUserAccount_get::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIUserAccount_get::isIsDelinquent() const {
    return m_is_delinquent;
}
void OAIUserAccount_get::setIsDelinquent(const bool &is_delinquent) {
    m_is_delinquent = is_delinquent;
    m_is_delinquent_isSet = true;
}

bool OAIUserAccount_get::is_is_delinquent_Set() const{
    return m_is_delinquent_isSet;
}

bool OAIUserAccount_get::is_is_delinquent_Valid() const{
    return m_is_delinquent_isValid;
}

QString OAIUserAccount_get::getLastName() const {
    return m_last_name;
}
void OAIUserAccount_get::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIUserAccount_get::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIUserAccount_get::is_last_name_Valid() const{
    return m_last_name_isValid;
}

QString OAIUserAccount_get::getTimezoneCode() const {
    return m_timezone_code;
}
void OAIUserAccount_get::setTimezoneCode(const QString &timezone_code) {
    m_timezone_code = timezone_code;
    m_timezone_code_isSet = true;
}

bool OAIUserAccount_get::is_timezone_code_Set() const{
    return m_timezone_code_isSet;
}

bool OAIUserAccount_get::is_timezone_code_Valid() const{
    return m_timezone_code_isValid;
}

bool OAIUserAccount_get::isSet() const {
...
bool OAIUserAccount_get::isValid() const {
