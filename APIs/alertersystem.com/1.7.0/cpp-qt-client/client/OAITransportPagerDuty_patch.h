...
#ifndef OAITransportPagerDuty_patch_H
#define OAITransportPagerDuty_patch_H
...
class OAITransportPagerDuty_patch : public OAIObject {
public:
    OAITransportPagerDuty_patch();
    OAITransportPagerDuty_patch(QString json);
    ~OAITransportPagerDuty_patch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportPagerDuty_patch)

#endif // OAITransportPagerDuty_patch_H
