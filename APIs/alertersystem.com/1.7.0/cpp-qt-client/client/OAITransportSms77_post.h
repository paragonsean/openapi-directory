...
class OAITransportSms77_post : public OAIObject {
public:
    OAITransportSms77_post();
    OAITransportSms77_post(QString json);
    ~OAITransportSms77_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSms77_post)

#endif // OAITransportSms77_post_H
