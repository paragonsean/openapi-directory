...
#ifndef OAITransportTelegram_get_H
#define OAITransportTelegram_get_H
...
class OAITransportTelegram_get : public OAIObject {
public:
    OAITransportTelegram_get();
    OAITransportTelegram_get(QString json);
    ~OAITransportTelegram_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTelegram_get)

#endif // OAITransportTelegram_get_H
