...
OAIMonitor_jsonld_put::OAIMonitor_jsonld_put(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMonitor_jsonld_put::OAIMonitor_jsonld_put() {
    this->initializeModel();
}

OAIMonitor_jsonld_put::~OAIMonitor_jsonld_put() {}

void OAIMonitor_jsonld_put::initializeModel() {
...
void OAIMonitor_jsonld_put::fromJson(QString jsonString) {
...
void OAIMonitor_jsonld_put::fromJsonObject(QJsonObject json) {
...
QString OAIMonitor_jsonld_put::asJson() const {
...
QJsonObject OAIMonitor_jsonld_put::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMonitor_jsonld_put::getAlertPayloadExtended() const {
    return m_alert_payload_extended;
}
void OAIMonitor_jsonld_put::setAlertPayloadExtended(const QString &alert_payload_extended) {
    m_alert_payload_extended = alert_payload_extended;
    m_alert_payload_extended_isSet = true;
}

bool OAIMonitor_jsonld_put::is_alert_payload_extended_Set() const{
    return m_alert_payload_extended_isSet;
}

bool OAIMonitor_jsonld_put::is_alert_payload_extended_Valid() const{
    return m_alert_payload_extended_isValid;
}

QString OAIMonitor_jsonld_put::getAlertPayloadShort() const {
    return m_alert_payload_short;
}
void OAIMonitor_jsonld_put::setAlertPayloadShort(const QString &alert_payload_short) {
    m_alert_payload_short = alert_payload_short;
    m_alert_payload_short_isSet = true;
}

bool OAIMonitor_jsonld_put::is_alert_payload_short_Set() const{
    return m_alert_payload_short_isSet;
}

bool OAIMonitor_jsonld_put::is_alert_payload_short_Valid() const{
    return m_alert_payload_short_isValid;
}

QList<QString> OAIMonitor_jsonld_put::getAlertServices() const {
    return m_alert_services;
}
void OAIMonitor_jsonld_put::setAlertServices(const QList<QString> &alert_services) {
    m_alert_services = alert_services;
    m_alert_services_isSet = true;
}

bool OAIMonitor_jsonld_put::is_alert_services_Set() const{
    return m_alert_services_isSet;
}

bool OAIMonitor_jsonld_put::is_alert_services_Valid() const{
    return m_alert_services_isValid;
}

bool OAIMonitor_jsonld_put::isAllowUnauthenticatedPings() const {
    return m_allow_unauthenticated_pings;
}
void OAIMonitor_jsonld_put::setAllowUnauthenticatedPings(const bool &allow_unauthenticated_pings) {
    m_allow_unauthenticated_pings = allow_unauthenticated_pings;
    m_allow_unauthenticated_pings_isSet = true;
}

bool OAIMonitor_jsonld_put::is_allow_unauthenticated_pings_Set() const{
    return m_allow_unauthenticated_pings_isSet;
}

bool OAIMonitor_jsonld_put::is_allow_unauthenticated_pings_Valid() const{
    return m_allow_unauthenticated_pings_isValid;
}

bool OAIMonitor_jsonld_put::isContentCheckMustNotExist() const {
    return m_content_check_must_not_exist;
}
void OAIMonitor_jsonld_put::setContentCheckMustNotExist(const bool &content_check_must_not_exist) {
    m_content_check_must_not_exist = content_check_must_not_exist;
    m_content_check_must_not_exist_isSet = true;
}

bool OAIMonitor_jsonld_put::is_content_check_must_not_exist_Set() const{
    return m_content_check_must_not_exist_isSet;
}

bool OAIMonitor_jsonld_put::is_content_check_must_not_exist_Valid() const{
    return m_content_check_must_not_exist_isValid;
}

QString OAIMonitor_jsonld_put::getContentCheckText() const {
    return m_content_check_text;
}
void OAIMonitor_jsonld_put::setContentCheckText(const QString &content_check_text) {
    m_content_check_text = content_check_text;
    m_content_check_text_isSet = true;
}

bool OAIMonitor_jsonld_put::is_content_check_text_Set() const{
    return m_content_check_text_isSet;
}

bool OAIMonitor_jsonld_put::is_content_check_text_Valid() const{
    return m_content_check_text_isValid;
}

QString OAIMonitor_jsonld_put::getContentCheckUrl() const {
    return m_content_check_url;
}
void OAIMonitor_jsonld_put::setContentCheckUrl(const QString &content_check_url) {
    m_content_check_url = content_check_url;
    m_content_check_url_isSet = true;
}

bool OAIMonitor_jsonld_put::is_content_check_url_Set() const{
    return m_content_check_url_isSet;
}

bool OAIMonitor_jsonld_put::is_content_check_url_Valid() const{
    return m_content_check_url_isValid;
}

QString OAIMonitor_jsonld_put::getContentCheckXpathFilter() const {
    return m_content_check_xpath_filter;
}
void OAIMonitor_jsonld_put::setContentCheckXpathFilter(const QString &content_check_xpath_filter) {
    m_content_check_xpath_filter = content_check_xpath_filter;
    m_content_check_xpath_filter_isSet = true;
}

bool OAIMonitor_jsonld_put::is_content_check_xpath_filter_Set() const{
    return m_content_check_xpath_filter_isSet;
}

bool OAIMonitor_jsonld_put::is_content_check_xpath_filter_Valid() const{
    return m_content_check_xpath_filter_isValid;
}

QString OAIMonitor_jsonld_put::getDataSegmentCode() const {
    return m_data_segment_code;
}
void OAIMonitor_jsonld_put::setDataSegmentCode(const QString &data_segment_code) {
    m_data_segment_code = data_segment_code;
    m_data_segment_code_isSet = true;
}

bool OAIMonitor_jsonld_put::is_data_segment_code_Set() const{
    return m_data_segment_code_isSet;
}

bool OAIMonitor_jsonld_put::is_data_segment_code_Valid() const{
    return m_data_segment_code_isValid;
}

qint32 OAIMonitor_jsonld_put::getGraceSeconds() const {
    return m_grace_seconds;
}
void OAIMonitor_jsonld_put::setGraceSeconds(const qint32 &grace_seconds) {
    m_grace_seconds = grace_seconds;
    m_grace_seconds_isSet = true;
}

bool OAIMonitor_jsonld_put::is_grace_seconds_Set() const{
    return m_grace_seconds_isSet;
}

bool OAIMonitor_jsonld_put::is_grace_seconds_Valid() const{
    return m_grace_seconds_isValid;
}

qint32 OAIMonitor_jsonld_put::getIntervalDays() const {
    return m_interval_days;
}
void OAIMonitor_jsonld_put::setIntervalDays(const qint32 &interval_days) {
    m_interval_days = interval_days;
    m_interval_days_isSet = true;
}

bool OAIMonitor_jsonld_put::is_interval_days_Set() const{
    return m_interval_days_isSet;
}

bool OAIMonitor_jsonld_put::is_interval_days_Valid() const{
    return m_interval_days_isValid;
}

qint32 OAIMonitor_jsonld_put::getIntervalHours() const {
    return m_interval_hours;
}
void OAIMonitor_jsonld_put::setIntervalHours(const qint32 &interval_hours) {
    m_interval_hours = interval_hours;
    m_interval_hours_isSet = true;
}

bool OAIMonitor_jsonld_put::is_interval_hours_Set() const{
    return m_interval_hours_isSet;
}

bool OAIMonitor_jsonld_put::is_interval_hours_Valid() const{
    return m_interval_hours_isValid;
}

qint32 OAIMonitor_jsonld_put::getIntervalMinutes() const {
    return m_interval_minutes;
}
void OAIMonitor_jsonld_put::setIntervalMinutes(const qint32 &interval_minutes) {
    m_interval_minutes = interval_minutes;
    m_interval_minutes_isSet = true;
}

bool OAIMonitor_jsonld_put::is_interval_minutes_Set() const{
    return m_interval_minutes_isSet;
}

bool OAIMonitor_jsonld_put::is_interval_minutes_Valid() const{
    return m_interval_minutes_isValid;
}

qint32 OAIMonitor_jsonld_put::getIntervalMonths() const {
    return m_interval_months;
}
void OAIMonitor_jsonld_put::setIntervalMonths(const qint32 &interval_months) {
    m_interval_months = interval_months;
    m_interval_months_isSet = true;
}

bool OAIMonitor_jsonld_put::is_interval_months_Set() const{
    return m_interval_months_isSet;
}

bool OAIMonitor_jsonld_put::is_interval_months_Valid() const{
    return m_interval_months_isValid;
}

qint32 OAIMonitor_jsonld_put::getIntervalSeconds() const {
    return m_interval_seconds;
}
void OAIMonitor_jsonld_put::setIntervalSeconds(const qint32 &interval_seconds) {
    m_interval_seconds = interval_seconds;
    m_interval_seconds_isSet = true;
}

bool OAIMonitor_jsonld_put::is_interval_seconds_Set() const{
    return m_interval_seconds_isSet;
}

bool OAIMonitor_jsonld_put::is_interval_seconds_Valid() const{
    return m_interval_seconds_isValid;
}

qint32 OAIMonitor_jsonld_put::getIntervalYears() const {
    return m_interval_years;
}
void OAIMonitor_jsonld_put::setIntervalYears(const qint32 &interval_years) {
    m_interval_years = interval_years;
    m_interval_years_isSet = true;
}

bool OAIMonitor_jsonld_put::is_interval_years_Set() const{
    return m_interval_years_isSet;
}

bool OAIMonitor_jsonld_put::is_interval_years_Valid() const{
    return m_interval_years_isValid;
}

bool OAIMonitor_jsonld_put::isIsMonitorPaused() const {
    return m_is_monitor_paused;
}
void OAIMonitor_jsonld_put::setIsMonitorPaused(const bool &is_monitor_paused) {
    m_is_monitor_paused = is_monitor_paused;
    m_is_monitor_paused_isSet = true;
}

bool OAIMonitor_jsonld_put::is_is_monitor_paused_Set() const{
    return m_is_monitor_paused_isSet;
}

bool OAIMonitor_jsonld_put::is_is_monitor_paused_Valid() const{
    return m_is_monitor_paused_isValid;
}

QString OAIMonitor_jsonld_put::getMonitorName() const {
    return m_monitor_name;
}
void OAIMonitor_jsonld_put::setMonitorName(const QString &monitor_name) {
    m_monitor_name = monitor_name;
    m_monitor_name_isSet = true;
}

bool OAIMonitor_jsonld_put::is_monitor_name_Set() const{
    return m_monitor_name_isSet;
}

bool OAIMonitor_jsonld_put::is_monitor_name_Valid() const{
    return m_monitor_name_isValid;
}

QString OAIMonitor_jsonld_put::getMonitorNotes() const {
    return m_monitor_notes;
}
void OAIMonitor_jsonld_put::setMonitorNotes(const QString &monitor_notes) {
    m_monitor_notes = monitor_notes;
    m_monitor_notes_isSet = true;
}

bool OAIMonitor_jsonld_put::is_monitor_notes_Set() const{
    return m_monitor_notes_isSet;
}

bool OAIMonitor_jsonld_put::is_monitor_notes_Valid() const{
    return m_monitor_notes_isValid;
}

QString OAIMonitor_jsonld_put::getPublicDescription() const {
    return m_public_description;
}
void OAIMonitor_jsonld_put::setPublicDescription(const QString &public_description) {
    m_public_description = public_description;
    m_public_description_isSet = true;
}

bool OAIMonitor_jsonld_put::is_public_description_Set() const{
    return m_public_description_isSet;
}

bool OAIMonitor_jsonld_put::is_public_description_Valid() const{
    return m_public_description_isValid;
}

QDateTime OAIMonitor_jsonld_put::getStartMonitorAt() const {
    return m_start_monitor_at;
}
void OAIMonitor_jsonld_put::setStartMonitorAt(const QDateTime &start_monitor_at) {
    m_start_monitor_at = start_monitor_at;
    m_start_monitor_at_isSet = true;
}

bool OAIMonitor_jsonld_put::is_start_monitor_at_Set() const{
    return m_start_monitor_at_isSet;
}

bool OAIMonitor_jsonld_put::is_start_monitor_at_Valid() const{
    return m_start_monitor_at_isValid;
}

QString OAIMonitor_jsonld_put::getTimezoneCode() const {
    return m_timezone_code;
}
void OAIMonitor_jsonld_put::setTimezoneCode(const QString &timezone_code) {
    m_timezone_code = timezone_code;
    m_timezone_code_isSet = true;
}

bool OAIMonitor_jsonld_put::is_timezone_code_Set() const{
    return m_timezone_code_isSet;
}

bool OAIMonitor_jsonld_put::is_timezone_code_Valid() const{
    return m_timezone_code_isValid;
}

qint32 OAIMonitor_jsonld_put::getWebResponseSecondsLimit() const {
    return m_web_response_seconds_limit;
}
void OAIMonitor_jsonld_put::setWebResponseSecondsLimit(const qint32 &web_response_seconds_limit) {
    m_web_response_seconds_limit = web_response_seconds_limit;
    m_web_response_seconds_limit_isSet = true;
}

bool OAIMonitor_jsonld_put::is_web_response_seconds_limit_Set() const{
    return m_web_response_seconds_limit_isSet;
}

bool OAIMonitor_jsonld_put::is_web_response_seconds_limit_Valid() const{
    return m_web_response_seconds_limit_isValid;
}

QString OAIMonitor_jsonld_put::getWebResponseUrl() const {
    return m_web_response_url;
}
void OAIMonitor_jsonld_put::setWebResponseUrl(const QString &web_response_url) {
    m_web_response_url = web_response_url;
    m_web_response_url_isSet = true;
}

bool OAIMonitor_jsonld_put::is_web_response_url_Set() const{
    return m_web_response_url_isSet;
}

bool OAIMonitor_jsonld_put::is_web_response_url_Valid() const{
    return m_web_response_url_isValid;
}

bool OAIMonitor_jsonld_put::isSet() const {
...
bool OAIMonitor_jsonld_put::isValid() const {
