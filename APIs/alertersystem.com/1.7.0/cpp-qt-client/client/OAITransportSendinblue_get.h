...
#ifndef OAITransportSendinblue_get_H
#define OAITransportSendinblue_get_H
...
class OAITransportSendinblue_get : public OAIObject {
public:
    OAITransportSendinblue_get();
    OAITransportSendinblue_get(QString json);
    ~OAITransportSendinblue_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSendinblue_get)

#endif // OAITransportSendinblue_get_H
