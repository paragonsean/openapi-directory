...
/*
 * OAITransportHelpScout_jsonld_get.h
 *
...
#ifndef OAITransportHelpScout_jsonld_get_H
#define OAITransportHelpScout_jsonld_get_H
...
class OAITransportHelpScout_jsonld_get : public OAIObject {
public:
    OAITransportHelpScout_jsonld_get();
    OAITransportHelpScout_jsonld_get(QString json);
    ~OAITransportHelpScout_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportHelpScout_jsonld_get)

#endif // OAITransportHelpScout_jsonld_get_H
