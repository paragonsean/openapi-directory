...
/*
 * OAITransportMicrosoftTeams_jsonld_post.h
 *
...
#ifndef OAITransportMicrosoftTeams_jsonld_post_H
#define OAITransportMicrosoftTeams_jsonld_post_H
...
class OAITransportMicrosoftTeams_jsonld_post : public OAIObject {
public:
    OAITransportMicrosoftTeams_jsonld_post();
    OAITransportMicrosoftTeams_jsonld_post(QString json);
    ~OAITransportMicrosoftTeams_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMicrosoftTeams_jsonld_post)

#endif // OAITransportMicrosoftTeams_jsonld_post_H
