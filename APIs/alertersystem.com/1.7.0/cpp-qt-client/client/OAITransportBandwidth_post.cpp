...
OAITransportBandwidth_post::OAITransportBandwidth_post(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransportBandwidth_post::OAITransportBandwidth_post() {
    this->initializeModel();
}

OAITransportBandwidth_post::~OAITransportBandwidth_post() {}

void OAITransportBandwidth_post::initializeModel() {
...
void OAITransportBandwidth_post::fromJson(QString jsonString) {
...
void OAITransportBandwidth_post::fromJsonObject(QJsonObject json) {
...
QString OAITransportBandwidth_post::asJson() const {
...
QJsonObject OAITransportBandwidth_post::asJsonObject() const {
    QJsonObject obj;
...
QString OAITransportBandwidth_post::getBandwidthAccountId() const {
    return m_bandwidth_account_id;
}
void OAITransportBandwidth_post::setBandwidthAccountId(const QString &bandwidth_account_id) {
    m_bandwidth_account_id = bandwidth_account_id;
    m_bandwidth_account_id_isSet = true;
}

bool OAITransportBandwidth_post::is_bandwidth_account_id_Set() const{
    return m_bandwidth_account_id_isSet;
}

bool OAITransportBandwidth_post::is_bandwidth_account_id_Valid() const{
    return m_bandwidth_account_id_isValid;
}

QString OAITransportBandwidth_post::getBandwidthApplicationId() const {
    return m_bandwidth_application_id;
}
void OAITransportBandwidth_post::setBandwidthApplicationId(const QString &bandwidth_application_id) {
    m_bandwidth_application_id = bandwidth_application_id;
    m_bandwidth_application_id_isSet = true;
}

bool OAITransportBandwidth_post::is_bandwidth_application_id_Set() const{
    return m_bandwidth_application_id_isSet;
}

bool OAITransportBandwidth_post::is_bandwidth_application_id_Valid() const{
    return m_bandwidth_application_id_isValid;
}

QString OAITransportBandwidth_post::getBandwidthFrom() const {
    return m_bandwidth_from;
}
void OAITransportBandwidth_post::setBandwidthFrom(const QString &bandwidth_from) {
    m_bandwidth_from = bandwidth_from;
    m_bandwidth_from_isSet = true;
}

bool OAITransportBandwidth_post::is_bandwidth_from_Set() const{
    return m_bandwidth_from_isSet;
}

bool OAITransportBandwidth_post::is_bandwidth_from_Valid() const{
    return m_bandwidth_from_isValid;
}

QString OAITransportBandwidth_post::getBandwidthPassword() const {
    return m_bandwidth_password;
}
void OAITransportBandwidth_post::setBandwidthPassword(const QString &bandwidth_password) {
    m_bandwidth_password = bandwidth_password;
    m_bandwidth_password_isSet = true;
}

bool OAITransportBandwidth_post::is_bandwidth_password_Set() const{
    return m_bandwidth_password_isSet;
}

bool OAITransportBandwidth_post::is_bandwidth_password_Valid() const{
    return m_bandwidth_password_isValid;
}

QString OAITransportBandwidth_post::getBandwidthUsername() const {
    return m_bandwidth_username;
}
void OAITransportBandwidth_post::setBandwidthUsername(const QString &bandwidth_username) {
    m_bandwidth_username = bandwidth_username;
    m_bandwidth_username_isSet = true;
}

bool OAITransportBandwidth_post::is_bandwidth_username_Set() const{
    return m_bandwidth_username_isSet;
}

bool OAITransportBandwidth_post::is_bandwidth_username_Valid() const{
    return m_bandwidth_username_isValid;
}

QString OAITransportBandwidth_post::getDataSegmentCode() const {
    return m_data_segment_code;
}
void OAITransportBandwidth_post::setDataSegmentCode(const QString &data_segment_code) {
    m_data_segment_code = data_segment_code;
    m_data_segment_code_isSet = true;
}

bool OAITransportBandwidth_post::is_data_segment_code_Set() const{
    return m_data_segment_code_isSet;
}

bool OAITransportBandwidth_post::is_data_segment_code_Valid() const{
    return m_data_segment_code_isValid;
}

QString OAITransportBandwidth_post::getPartition() const {
    return m_partition;
}
void OAITransportBandwidth_post::setPartition(const QString &partition) {
    m_partition = partition;
    m_partition_isSet = true;
}

bool OAITransportBandwidth_post::is_partition_Set() const{
    return m_partition_isSet;
}

bool OAITransportBandwidth_post::is_partition_Valid() const{
    return m_partition_isValid;
}

QString OAITransportBandwidth_post::getTransportName() const {
    return m_transport_name;
}
void OAITransportBandwidth_post::setTransportName(const QString &transport_name) {
    m_transport_name = transport_name;
    m_transport_name_isSet = true;
}

bool OAITransportBandwidth_post::is_transport_name_Set() const{
    return m_transport_name_isSet;
}

bool OAITransportBandwidth_post::is_transport_name_Valid() const{
    return m_transport_name_isValid;
}

bool OAITransportBandwidth_post::isSet() const {
...
bool OAITransportBandwidth_post::isValid() const {
