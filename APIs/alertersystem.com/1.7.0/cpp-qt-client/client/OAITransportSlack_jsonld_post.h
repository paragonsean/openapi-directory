...
class OAITransportSlack_jsonld_post : public OAIObject {
public:
    OAITransportSlack_jsonld_post();
    OAITransportSlack_jsonld_post(QString json);
    ~OAITransportSlack_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSlack_jsonld_post)

#endif // OAITransportSlack_jsonld_post_H
