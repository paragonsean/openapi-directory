...
#ifndef OAITransportTurboSms_get_H
#define OAITransportTurboSms_get_H
...
class OAITransportTurboSms_get : public OAIObject {
public:
    OAITransportTurboSms_get();
    OAITransportTurboSms_get(QString json);
    ~OAITransportTurboSms_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTurboSms_get)

#endif // OAITransportTurboSms_get_H
