...
class OAITransportPushy_jsonld_get : public OAIObject {
public:
    OAITransportPushy_jsonld_get();
    OAITransportPushy_jsonld_get(QString json);
    ~OAITransportPushy_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportPushy_jsonld_get)

#endif // OAITransportPushy_jsonld_get_H
