...
#ifndef OAIAlertLog_get_H
#define OAIAlertLog_get_H
...
class OAIAlertLog_get : public OAIObject {
public:
    OAIAlertLog_get();
    OAIAlertLog_get(QString json);
    ~OAIAlertLog_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlertLog_get)

#endif // OAIAlertLog_get_H
