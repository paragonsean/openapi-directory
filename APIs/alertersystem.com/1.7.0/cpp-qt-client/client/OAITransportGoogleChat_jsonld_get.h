...
/*
 * OAITransportGoogleChat_jsonld_get.h
 *
...
#ifndef OAITransportGoogleChat_jsonld_get_H
#define OAITransportGoogleChat_jsonld_get_H
...
class OAITransportGoogleChat_jsonld_get : public OAIObject {
public:
    OAITransportGoogleChat_jsonld_get();
    OAITransportGoogleChat_jsonld_get(QString json);
    ~OAITransportGoogleChat_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGoogleChat_jsonld_get)

#endif // OAITransportGoogleChat_jsonld_get_H
