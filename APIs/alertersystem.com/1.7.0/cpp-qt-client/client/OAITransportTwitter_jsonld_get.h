...
class OAITransportTwitter_jsonld_get : public OAIObject {
public:
    OAITransportTwitter_jsonld_get();
    OAITransportTwitter_jsonld_get(QString json);
    ~OAITransportTwitter_jsonld_get() override;
    ...
    QString getTwitterAccessToken() const;
    void setTwitterAccessToken(const QString &twitter_access_token);
    bool is_twitter_access_token_Set() const;
    bool is_twitter_access_token_Valid() const;
...
private:
    ...
    QString m_twitter_access_token;
    bool m_twitter_access_token_isSet;
    bool m_twitter_access_token_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAITransportTwitter_jsonld_get)

#endif // OAITransportTwitter_jsonld_get_H
