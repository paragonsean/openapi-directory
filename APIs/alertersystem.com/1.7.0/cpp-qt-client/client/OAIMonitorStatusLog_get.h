...
class OAIMonitorStatusLog_get : public OAIObject {
public:
    OAIMonitorStatusLog_get();
    OAIMonitorStatusLog_get(QString json);
    ~OAIMonitorStatusLog_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitorStatusLog_get)

#endif // OAIMonitorStatusLog_get_H
