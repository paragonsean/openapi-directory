...
class OAITransportInfobip_jsonld_post : public OAIObject {
public:
    OAITransportInfobip_jsonld_post();
    OAITransportInfobip_jsonld_post(QString json);
    ~OAITransportInfobip_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportInfobip_jsonld_post)

#endif // OAITransportInfobip_jsonld_post_H
