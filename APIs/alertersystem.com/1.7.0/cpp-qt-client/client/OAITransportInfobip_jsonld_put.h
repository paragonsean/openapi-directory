...
class OAITransportInfobip_jsonld_put : public OAIObject {
public:
    OAITransportInfobip_jsonld_put();
    OAITransportInfobip_jsonld_put(QString json);
    ~OAITransportInfobip_jsonld_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportInfobip_jsonld_put)

#endif // OAITransportInfobip_jsonld_put_H
