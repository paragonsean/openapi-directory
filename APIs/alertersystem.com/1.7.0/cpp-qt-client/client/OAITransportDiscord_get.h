...
class OAITransportDiscord_get : public OAIObject {
public:
    OAITransportDiscord_get();
    OAITransportDiscord_get(QString json);
    ~OAITransportDiscord_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportDiscord_get)

#endif // OAITransportDiscord_get_H
