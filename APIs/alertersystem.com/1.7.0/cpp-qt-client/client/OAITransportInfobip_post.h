...
class OAITransportInfobip_post : public OAIObject {
public:
    OAITransportInfobip_post();
    OAITransportInfobip_post(QString json);
    ~OAITransportInfobip_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportInfobip_post)

#endif // OAITransportInfobip_post_H
