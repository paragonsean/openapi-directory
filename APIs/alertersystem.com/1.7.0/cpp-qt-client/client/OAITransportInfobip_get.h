...
class OAITransportInfobip_get : public OAIObject {
public:
    OAITransportInfobip_get();
    OAITransportInfobip_get(QString json);
    ~OAITransportInfobip_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportInfobip_get)

#endif // OAITransportInfobip_get_H
