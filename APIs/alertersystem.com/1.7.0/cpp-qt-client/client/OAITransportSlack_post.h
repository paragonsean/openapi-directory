...
class OAITransportSlack_post : public OAIObject {
public:
    OAITransportSlack_post();
    OAITransportSlack_post(QString json);
    ~OAITransportSlack_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSlack_post)

#endif // OAITransportSlack_post_H
