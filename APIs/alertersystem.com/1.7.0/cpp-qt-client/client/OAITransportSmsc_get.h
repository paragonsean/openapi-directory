...
class OAITransportSmsc_get : public OAIObject {
public:
    OAITransportSmsc_get();
    OAITransportSmsc_get(QString json);
    ~OAITransportSmsc_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSmsc_get)

#endif // OAITransportSmsc_get_H
