...
#ifndef OAITransportGoogleChat_get_H
#define OAITransportGoogleChat_get_H
...
class OAITransportGoogleChat_get : public OAIObject {
public:
    OAITransportGoogleChat_get();
    OAITransportGoogleChat_get(QString json);
    ~OAITransportGoogleChat_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGoogleChat_get)

#endif // OAITransportGoogleChat_get_H
