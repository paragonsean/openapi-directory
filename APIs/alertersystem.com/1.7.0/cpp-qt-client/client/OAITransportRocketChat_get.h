...
#ifndef OAITransportRocketChat_get_H
#define OAITransportRocketChat_get_H
...
class OAITransportRocketChat_get : public OAIObject {
public:
    OAITransportRocketChat_get();
    OAITransportRocketChat_get(QString json);
    ~OAITransportRocketChat_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportRocketChat_get)

#endif // OAITransportRocketChat_get_H
