...
#ifndef OAIMonitor_put_H
#define OAIMonitor_put_H
...
class OAIMonitor_put : public OAIObject {
public:
    OAIMonitor_put();
    OAIMonitor_put(QString json);
    ~OAIMonitor_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitor_put)

#endif // OAIMonitor_put_H
