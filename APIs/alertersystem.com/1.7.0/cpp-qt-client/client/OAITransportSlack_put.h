...
class OAITransportSlack_put : public OAIObject {
public:
    OAITransportSlack_put();
    OAITransportSlack_put(QString json);
    ~OAITransportSlack_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSlack_put)

#endif // OAITransportSlack_put_H
