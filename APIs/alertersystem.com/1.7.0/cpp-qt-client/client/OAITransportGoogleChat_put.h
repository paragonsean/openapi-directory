...
#ifndef OAITransportGoogleChat_put_H
#define OAITransportGoogleChat_put_H
...
class OAITransportGoogleChat_put : public OAIObject {
public:
    OAITransportGoogleChat_put();
    OAITransportGoogleChat_put(QString json);
    ~OAITransportGoogleChat_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGoogleChat_put)

#endif // OAITransportGoogleChat_put_H
