...
class OAITransportSmsmode_get : public OAIObject {
public:
    OAITransportSmsmode_get();
    OAITransportSmsmode_get(QString json);
    ~OAITransportSmsmode_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSmsmode_get)

#endif // OAITransportSmsmode_get_H
