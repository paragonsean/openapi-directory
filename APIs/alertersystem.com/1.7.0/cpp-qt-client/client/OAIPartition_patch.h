...
class OAIPartition_patch : public OAIObject {
public:
    OAIPartition_patch();
    OAIPartition_patch(QString json);
    ~OAIPartition_patch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartition_patch)

#endif // OAIPartition_patch_H
