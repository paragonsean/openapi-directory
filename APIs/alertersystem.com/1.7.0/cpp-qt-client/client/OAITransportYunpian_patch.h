...
class OAITransportYunpian_patch : public OAIObject {
public:
    OAITransportYunpian_patch();
    OAITransportYunpian_patch(QString json);
    ~OAITransportYunpian_patch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportYunpian_patch)

#endif // OAITransportYunpian_patch_H
