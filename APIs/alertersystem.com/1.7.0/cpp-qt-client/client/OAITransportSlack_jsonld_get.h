...
class OAITransportSlack_jsonld_get : public OAIObject {
public:
    OAITransportSlack_jsonld_get();
    OAITransportSlack_jsonld_get(QString json);
    ~OAITransportSlack_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSlack_jsonld_get)

#endif // OAITransportSlack_jsonld_get_H
