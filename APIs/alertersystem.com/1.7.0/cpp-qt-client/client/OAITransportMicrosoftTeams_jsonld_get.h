...
/*
 * OAITransportMicrosoftTeams_jsonld_get.h
 *
...
#ifndef OAITransportMicrosoftTeams_jsonld_get_H
#define OAITransportMicrosoftTeams_jsonld_get_H
...
class OAITransportMicrosoftTeams_jsonld_get : public OAIObject {
public:
    OAITransportMicrosoftTeams_jsonld_get();
    OAITransportMicrosoftTeams_jsonld_get(QString json);
    ~OAITransportMicrosoftTeams_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMicrosoftTeams_jsonld_get)

#endif // OAITransportMicrosoftTeams_jsonld_get_H
