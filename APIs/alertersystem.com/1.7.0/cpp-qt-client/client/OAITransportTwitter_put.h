...
class OAITransportTwitter_put : public OAIObject {
public:
    OAITransportTwitter_put();
    OAITransportTwitter_put(QString json);
    ~OAITransportTwitter_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTwitter_put)

#endif // OAITransportTwitter_put_H
