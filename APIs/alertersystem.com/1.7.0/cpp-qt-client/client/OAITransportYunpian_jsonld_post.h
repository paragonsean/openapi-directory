...
class OAITransportYunpian_jsonld_post : public OAIObject {
public:
    OAITransportYunpian_jsonld_post();
    OAITransportYunpian_jsonld_post(QString json);
    ~OAITransportYunpian_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportYunpian_jsonld_post)

#endif // OAITransportYunpian_jsonld_post_H
