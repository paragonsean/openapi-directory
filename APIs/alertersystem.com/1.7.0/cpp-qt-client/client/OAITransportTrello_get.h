...
class OAITransportTrello_get : public OAIObject {
public:
    OAITransportTrello_get();
    OAITransportTrello_get(QString json);
    ~OAITransportTrello_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTrello_get)

#endif // OAITransportTrello_get_H
