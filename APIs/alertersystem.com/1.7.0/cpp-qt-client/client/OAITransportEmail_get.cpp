...
OAITransportEmail_get::OAITransportEmail_get(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransportEmail_get::OAITransportEmail_get() {
    this->initializeModel();
}

OAITransportEmail_get::~OAITransportEmail_get() {}

void OAITransportEmail_get::initializeModel() {
...
void OAITransportEmail_get::fromJson(QString jsonString) {
...
void OAITransportEmail_get::fromJsonObject(QJsonObject json) {
...
QString OAITransportEmail_get::asJson() const {
...
QJsonObject OAITransportEmail_get::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAITransportEmail_get::getCreatedAt() const {
    return m_created_at;
}
void OAITransportEmail_get::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAITransportEmail_get::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAITransportEmail_get::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAITransportEmail_get::getDataSegmentCode() const {
    return m_data_segment_code;
}
void OAITransportEmail_get::setDataSegmentCode(const QString &data_segment_code) {
    m_data_segment_code = data_segment_code;
    m_data_segment_code_isSet = true;
}

bool OAITransportEmail_get::is_data_segment_code_Set() const{
    return m_data_segment_code_isSet;
}

bool OAITransportEmail_get::is_data_segment_code_Valid() const{
    return m_data_segment_code_isValid;
}

QString OAITransportEmail_get::getEmailFromAddress() const {
    return m_email_from_address;
}
void OAITransportEmail_get::setEmailFromAddress(const QString &email_from_address) {
    m_email_from_address = email_from_address;
    m_email_from_address_isSet = true;
}

bool OAITransportEmail_get::is_email_from_address_Set() const{
    return m_email_from_address_isSet;
}

bool OAITransportEmail_get::is_email_from_address_Valid() const{
    return m_email_from_address_isValid;
}

QString OAITransportEmail_get::getEmailFromName() const {
    return m_email_from_name;
}
void OAITransportEmail_get::setEmailFromName(const QString &email_from_name) {
    m_email_from_name = email_from_name;
    m_email_from_name_isSet = true;
}

bool OAITransportEmail_get::is_email_from_name_Set() const{
    return m_email_from_name_isSet;
}

bool OAITransportEmail_get::is_email_from_name_Valid() const{
    return m_email_from_name_isValid;
}

QString OAITransportEmail_get::getEmailPassword() const {
    return m_email_password;
}
void OAITransportEmail_get::setEmailPassword(const QString &email_password) {
    m_email_password = email_password;
    m_email_password_isSet = true;
}

bool OAITransportEmail_get::is_email_password_Set() const{
    return m_email_password_isSet;
}

bool OAITransportEmail_get::is_email_password_Valid() const{
    return m_email_password_isValid;
}

qint32 OAITransportEmail_get::getEmailPort() const {
    return m_email_port;
}
void OAITransportEmail_get::setEmailPort(const qint32 &email_port) {
    m_email_port = email_port;
    m_email_port_isSet = true;
}

bool OAITransportEmail_get::is_email_port_Set() const{
    return m_email_port_isSet;
}

bool OAITransportEmail_get::is_email_port_Valid() const{
    return m_email_port_isValid;
}

QString OAITransportEmail_get::getEmailServer() const {
    return m_email_server;
}
void OAITransportEmail_get::setEmailServer(const QString &email_server) {
    m_email_server = email_server;
    m_email_server_isSet = true;
}

bool OAITransportEmail_get::is_email_server_Set() const{
    return m_email_server_isSet;
}

bool OAITransportEmail_get::is_email_server_Valid() const{
    return m_email_server_isValid;
}

QString OAITransportEmail_get::getEmailUsername() const {
    return m_email_username;
}
void OAITransportEmail_get::setEmailUsername(const QString &email_username) {
    m_email_username = email_username;
    m_email_username_isSet = true;
}

bool OAITransportEmail_get::is_email_username_Set() const{
    return m_email_username_isSet;
}

bool OAITransportEmail_get::is_email_username_Valid() const{
    return m_email_username_isValid;
}

QString OAITransportEmail_get::getId() const {
    return m_id;
}
void OAITransportEmail_get::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITransportEmail_get::is_id_Set() const{
    return m_id_isSet;
}

bool OAITransportEmail_get::is_id_Valid() const{
    return m_id_isValid;
}

QString OAITransportEmail_get::getPartition() const {
    return m_partition;
}
void OAITransportEmail_get::setPartition(const QString &partition) {
    m_partition = partition;
    m_partition_isSet = true;
}

bool OAITransportEmail_get::is_partition_Set() const{
    return m_partition_isSet;
}

bool OAITransportEmail_get::is_partition_Valid() const{
    return m_partition_isValid;
}

QString OAITransportEmail_get::getResourceOwner() const {
    return m_resource_owner;
}
void OAITransportEmail_get::setResourceOwner(const QString &resource_owner) {
    m_resource_owner = resource_owner;
    m_resource_owner_isSet = true;
}

bool OAITransportEmail_get::is_resource_owner_Set() const{
    return m_resource_owner_isSet;
}

bool OAITransportEmail_get::is_resource_owner_Valid() const{
    return m_resource_owner_isValid;
}

QString OAITransportEmail_get::getTransportName() const {
    return m_transport_name;
}
void OAITransportEmail_get::setTransportName(const QString &transport_name) {
    m_transport_name = transport_name;
    m_transport_name_isSet = true;
}

bool OAITransportEmail_get::is_transport_name_Set() const{
    return m_transport_name_isSet;
}

bool OAITransportEmail_get::is_transport_name_Valid() const{
    return m_transport_name_isValid;
}

bool OAITransportEmail_get::isSet() const {
...
bool OAITransportEmail_get::isValid() const {
