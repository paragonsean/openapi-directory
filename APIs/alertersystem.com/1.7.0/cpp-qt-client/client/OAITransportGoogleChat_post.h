...
#ifndef OAITransportGoogleChat_post_H
#define OAITransportGoogleChat_post_H
...
class OAITransportGoogleChat_post : public OAIObject {
public:
    OAITransportGoogleChat_post();
    OAITransportGoogleChat_post(QString json);
    ~OAITransportGoogleChat_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGoogleChat_post)

#endif // OAITransportGoogleChat_post_H
