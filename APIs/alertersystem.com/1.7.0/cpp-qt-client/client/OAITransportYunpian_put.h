...
class OAITransportYunpian_put : public OAIObject {
public:
    OAITransportYunpian_put();
    OAITransportYunpian_put(QString json);
    ~OAITransportYunpian_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportYunpian_put)

#endif // OAITransportYunpian_put_H
