...
#ifndef OAIMonitor_post_H
#define OAIMonitor_post_H
...
class OAIMonitor_post : public OAIObject {
public:
    OAIMonitor_post();
    OAIMonitor_post(QString json);
    ~OAIMonitor_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitor_post)

#endif // OAIMonitor_post_H
