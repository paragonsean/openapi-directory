...
#ifndef OAITransportPagerDuty_get_H
#define OAITransportPagerDuty_get_H
...
class OAITransportPagerDuty_get : public OAIObject {
public:
    OAITransportPagerDuty_get();
    OAITransportPagerDuty_get(QString json);
    ~OAITransportPagerDuty_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportPagerDuty_get)

#endif // OAITransportPagerDuty_get_H
