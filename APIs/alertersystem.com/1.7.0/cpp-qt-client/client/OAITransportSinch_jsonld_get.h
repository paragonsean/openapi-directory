...
class OAITransportSinch_jsonld_get : public OAIObject {
public:
    OAITransportSinch_jsonld_get();
    OAITransportSinch_jsonld_get(QString json);
    ~OAITransportSinch_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSinch_jsonld_get)

#endif // OAITransportSinch_jsonld_get_H
