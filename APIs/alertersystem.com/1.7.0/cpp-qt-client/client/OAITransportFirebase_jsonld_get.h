...
/*
 * OAITransportFirebase_jsonld_get.h
 *
...
#ifndef OAITransportFirebase_jsonld_get_H
#define OAITransportFirebase_jsonld_get_H
...
class OAITransportFirebase_jsonld_get : public OAIObject {
public:
    OAITransportFirebase_jsonld_get();
    OAITransportFirebase_jsonld_get(QString json);
    ~OAITransportFirebase_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportFirebase_jsonld_get)

#endif // OAITransportFirebase_jsonld_get_H
