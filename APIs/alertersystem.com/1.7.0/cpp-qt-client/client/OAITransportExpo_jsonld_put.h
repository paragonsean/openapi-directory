...
class OAITransportExpo_jsonld_put : public OAIObject {
public:
    OAITransportExpo_jsonld_put();
    OAITransportExpo_jsonld_put(QString json);
    ~OAITransportExpo_jsonld_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportExpo_jsonld_put)

#endif // OAITransportExpo_jsonld_put_H
