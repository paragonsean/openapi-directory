...
class OAITransportZendesk_jsonld_get : public OAIObject {
public:
    OAITransportZendesk_jsonld_get();
    OAITransportZendesk_jsonld_get(QString json);
    ~OAITransportZendesk_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportZendesk_jsonld_get)

#endif // OAITransportZendesk_jsonld_get_H
