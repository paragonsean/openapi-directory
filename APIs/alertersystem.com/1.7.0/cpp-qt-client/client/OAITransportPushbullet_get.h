...
#ifndef OAITransportPushbullet_get_H
#define OAITransportPushbullet_get_H
...
class OAITransportPushbullet_get : public OAIObject {
public:
    OAITransportPushbullet_get();
    OAITransportPushbullet_get(QString json);
    ~OAITransportPushbullet_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportPushbullet_get)

#endif // OAITransportPushbullet_get_H
