...
class OAITransportExpo_put : public OAIObject {
public:
    OAITransportExpo_put();
    OAITransportExpo_put(QString json);
    ~OAITransportExpo_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportExpo_put)

#endif // OAITransportExpo_put_H
