...
class OAITransportTwitter_post : public OAIObject {
public:
    OAITransportTwitter_post();
    OAITransportTwitter_post(QString json);
    ~OAITransportTwitter_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTwitter_post)

#endif // OAITransportTwitter_post_H
