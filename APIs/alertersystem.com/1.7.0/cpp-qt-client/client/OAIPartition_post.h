...
#ifndef OAIPartition_post_H
#define OAIPartition_post_H
...
class OAIPartition_post : public OAIObject {
public:
    OAIPartition_post();
    OAIPartition_post(QString json);
    ~OAIPartition_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartition_post)

#endif // OAIPartition_post_H
