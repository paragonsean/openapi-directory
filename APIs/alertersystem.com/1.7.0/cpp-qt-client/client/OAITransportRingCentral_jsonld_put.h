...
/*
 * OAITransportRingCentral_jsonld_put.h
 *
...
#ifndef OAITransportRingCentral_jsonld_put_H
#define OAITransportRingCentral_jsonld_put_H
...
class OAITransportRingCentral_jsonld_put : public OAIObject {
public:
    OAITransportRingCentral_jsonld_put();
    OAITransportRingCentral_jsonld_put(QString json);
    ~OAITransportRingCentral_jsonld_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportRingCentral_jsonld_put)

#endif // OAITransportRingCentral_jsonld_put_H
