...
/*
 * OAITransportFreshdesk_jsonld_put.h
 *
...
#ifndef OAITransportFreshdesk_jsonld_put_H
#define OAITransportFreshdesk_jsonld_put_H
...
class OAITransportFreshdesk_jsonld_put : public OAIObject {
public:
    OAITransportFreshdesk_jsonld_put();
    OAITransportFreshdesk_jsonld_put(QString json);
    ~OAITransportFreshdesk_jsonld_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportFreshdesk_jsonld_put)

#endif // OAITransportFreshdesk_jsonld_put_H
