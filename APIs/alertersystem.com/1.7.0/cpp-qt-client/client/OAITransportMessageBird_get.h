...
#ifndef OAITransportMessageBird_get_H
#define OAITransportMessageBird_get_H
...
class OAITransportMessageBird_get : public OAIObject {
public:
    OAITransportMessageBird_get();
    OAITransportMessageBird_get(QString json);
    ~OAITransportMessageBird_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMessageBird_get)

#endif // OAITransportMessageBird_get_H
