...
#ifndef OAITransportClickatell_get_H
#define OAITransportClickatell_get_H
...
class OAITransportClickatell_get : public OAIObject {
public:
    OAITransportClickatell_get();
    OAITransportClickatell_get(QString json);
    ~OAITransportClickatell_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportClickatell_get)

#endif // OAITransportClickatell_get_H
