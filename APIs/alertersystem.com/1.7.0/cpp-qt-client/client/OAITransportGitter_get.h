...
class OAITransportGitter_get : public OAIObject {
public:
    OAITransportGitter_get();
    OAITransportGitter_get(QString json);
    ~OAITransportGitter_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGitter_get)

#endif // OAITransportGitter_get_H
