...
OAITransportTrello_put::OAITransportTrello_put(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransportTrello_put::OAITransportTrello_put() {
    this->initializeModel();
}

OAITransportTrello_put::~OAITransportTrello_put() {}

void OAITransportTrello_put::initializeModel() {
...
void OAITransportTrello_put::fromJson(QString jsonString) {
...
void OAITransportTrello_put::fromJsonObject(QJsonObject json) {
...
QString OAITransportTrello_put::asJson() const {
...
QJsonObject OAITransportTrello_put::asJsonObject() const {
    QJsonObject obj;
...
QString OAITransportTrello_put::getDataSegmentCode() const {
    return m_data_segment_code;
}
void OAITransportTrello_put::setDataSegmentCode(const QString &data_segment_code) {
    m_data_segment_code = data_segment_code;
    m_data_segment_code_isSet = true;
}

bool OAITransportTrello_put::is_data_segment_code_Set() const{
    return m_data_segment_code_isSet;
}

bool OAITransportTrello_put::is_data_segment_code_Valid() const{
    return m_data_segment_code_isValid;
}

QString OAITransportTrello_put::getTransportName() const {
    return m_transport_name;
}
void OAITransportTrello_put::setTransportName(const QString &transport_name) {
    m_transport_name = transport_name;
    m_transport_name_isSet = true;
}

bool OAITransportTrello_put::is_transport_name_Set() const{
    return m_transport_name_isSet;
}

bool OAITransportTrello_put::is_transport_name_Valid() const{
    return m_transport_name_isValid;
}

QString OAITransportTrello_put::getTrelloApiKey() const {
    return m_trello_api_key;
}
void OAITransportTrello_put::setTrelloApiKey(const QString &trello_api_key) {
    m_trello_api_key = trello_api_key;
    m_trello_api_key_isSet = true;
}

bool OAITransportTrello_put::is_trello_api_key_Set() const{
    return m_trello_api_key_isSet;
}

bool OAITransportTrello_put::is_trello_api_key_Valid() const{
    return m_trello_api_key_isValid;
}

QString OAITransportTrello_put::getTrelloApiToken() const {
    return m_trello_api_token;
}
void OAITransportTrello_put::setTrelloApiToken(const QString &trello_api_token) {
    m_trello_api_token = trello_api_token;
    m_trello_api_token_isSet = true;
}

bool OAITransportTrello_put::is_trello_api_token_Set() const{
    return m_trello_api_token_isSet;
}

bool OAITransportTrello_put::is_trello_api_token_Valid() const{
    return m_trello_api_token_isValid;
}

QString OAITransportTrello_put::getTrelloListId() const {
    return m_trello_list_id;
}
void OAITransportTrello_put::setTrelloListId(const QString &trello_list_id) {
    m_trello_list_id = trello_list_id;
    m_trello_list_id_isSet = true;
}

bool OAITransportTrello_put::is_trello_list_id_Set() const{
    return m_trello_list_id_isSet;
}

bool OAITransportTrello_put::is_trello_list_id_Valid() const{
    return m_trello_list_id_isValid;
}

bool OAITransportTrello_put::isSet() const {
...
bool OAITransportTrello_put::isValid() const {
