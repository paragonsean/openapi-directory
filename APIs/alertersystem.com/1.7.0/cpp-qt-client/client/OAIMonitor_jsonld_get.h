...
#ifndef OAIMonitor_jsonld_get_H
#define OAIMonitor_jsonld_get_H
...
class OAIMonitor_jsonld_get : public OAIObject {
public:
    OAIMonitor_jsonld_get();
    OAIMonitor_jsonld_get(QString json);
    ~OAIMonitor_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitor_jsonld_get)

#endif // OAIMonitor_jsonld_get_H
