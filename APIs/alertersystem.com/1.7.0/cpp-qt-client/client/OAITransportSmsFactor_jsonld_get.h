...
/*
 * OAITransportSmsFactor_jsonld_get.h
 *
...
#ifndef OAITransportSmsFactor_jsonld_get_H
#define OAITransportSmsFactor_jsonld_get_H
...
class OAITransportSmsFactor_jsonld_get : public OAIObject {
public:
    OAITransportSmsFactor_jsonld_get();
    OAITransportSmsFactor_jsonld_get(QString json);
    ~OAITransportSmsFactor_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSmsFactor_jsonld_get)

#endif // OAITransportSmsFactor_jsonld_get_H
