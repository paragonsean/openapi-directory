...
/*
 * OAITransportOpsgenie_jsonld_get.h
 *
...
#ifndef OAITransportOpsgenie_jsonld_get_H
#define OAITransportOpsgenie_jsonld_get_H
...
class OAITransportOpsgenie_jsonld_get : public OAIObject {
public:
    OAITransportOpsgenie_jsonld_get();
    OAITransportOpsgenie_jsonld_get(QString json);
    ~OAITransportOpsgenie_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportOpsgenie_jsonld_get)

#endif // OAITransportOpsgenie_jsonld_get_H
