...
#ifndef OAITransportEngagespot_get_H
#define OAITransportEngagespot_get_H
...
class OAITransportEngagespot_get : public OAIObject {
public:
    OAITransportEngagespot_get();
    OAITransportEngagespot_get(QString json);
    ~OAITransportEngagespot_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportEngagespot_get)

#endif // OAITransportEngagespot_get_H
