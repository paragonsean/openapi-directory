...
/*
 * OAITransportMicrosoftTeams_get.h
 *
...
#ifndef OAITransportMicrosoftTeams_get_H
#define OAITransportMicrosoftTeams_get_H
...
class OAITransportMicrosoftTeams_get : public OAIObject {
public:
    OAITransportMicrosoftTeams_get();
    OAITransportMicrosoftTeams_get(QString json);
    ~OAITransportMicrosoftTeams_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMicrosoftTeams_get)

#endif // OAITransportMicrosoftTeams_get_H
