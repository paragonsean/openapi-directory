...
class OAITransportSmsapi_jsonld_get : public OAIObject {
public:
    OAITransportSmsapi_jsonld_get();
    OAITransportSmsapi_jsonld_get(QString json);
    ~OAITransportSmsapi_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSmsapi_jsonld_get)

#endif // OAITransportSmsapi_jsonld_get_H
