...
class OAITransportGotify_jsonld_get : public OAIObject {
public:
    OAITransportGotify_jsonld_get();
    OAITransportGotify_jsonld_get(QString json);
    ~OAITransportGotify_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGotify_jsonld_get)

#endif // OAITransportGotify_jsonld_get_H
