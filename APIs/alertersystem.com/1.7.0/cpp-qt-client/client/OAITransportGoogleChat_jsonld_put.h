...
/*
 * OAITransportGoogleChat_jsonld_put.h
 *
...
#ifndef OAITransportGoogleChat_jsonld_put_H
#define OAITransportGoogleChat_jsonld_put_H
...
class OAITransportGoogleChat_jsonld_put : public OAIObject {
public:
    OAITransportGoogleChat_jsonld_put();
    OAITransportGoogleChat_jsonld_put(QString json);
    ~OAITransportGoogleChat_jsonld_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGoogleChat_jsonld_put)

#endif // OAITransportGoogleChat_jsonld_put_H
