...
#ifndef OAITransportTelegram_post_H
#define OAITransportTelegram_post_H
...
class OAITransportTelegram_post : public OAIObject {
public:
    OAITransportTelegram_post();
    OAITransportTelegram_post(QString json);
    ~OAITransportTelegram_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTelegram_post)

#endif // OAITransportTelegram_post_H
