...
class OAITransportExpo_get : public OAIObject {
public:
    OAITransportExpo_get();
    OAITransportExpo_get(QString json);
    ~OAITransportExpo_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportExpo_get)

#endif // OAITransportExpo_get_H
