...
/*
 * OAITransportSpotHit_jsonld_get.h
 *
...
#ifndef OAITransportSpotHit_jsonld_get_H
#define OAITransportSpotHit_jsonld_get_H
...
class OAITransportSpotHit_jsonld_get : public OAIObject {
public:
    OAITransportSpotHit_jsonld_get();
    OAITransportSpotHit_jsonld_get(QString json);
    ~OAITransportSpotHit_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSpotHit_jsonld_get)

#endif // OAITransportSpotHit_jsonld_get_H
