...
class OAITransportSmsapi_post : public OAIObject {
public:
    OAITransportSmsapi_post();
    OAITransportSmsapi_post(QString json);
    ~OAITransportSmsapi_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSmsapi_post)

#endif // OAITransportSmsapi_post_H
