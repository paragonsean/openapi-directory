...
class OAITransportYunpian_jsonld_get : public OAIObject {
public:
    OAITransportYunpian_jsonld_get();
    OAITransportYunpian_jsonld_get(QString json);
    ~OAITransportYunpian_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportYunpian_jsonld_get)

#endif // OAITransportYunpian_jsonld_get_H
