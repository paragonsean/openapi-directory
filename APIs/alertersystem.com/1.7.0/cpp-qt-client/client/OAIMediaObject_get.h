...
#ifndef OAIMediaObject_get_H
#define OAIMediaObject_get_H
...
class OAIMediaObject_get : public OAIObject {
public:
    OAIMediaObject_get();
    OAIMediaObject_get(QString json);
    ~OAIMediaObject_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaObject_get)

#endif // OAIMediaObject_get_H
