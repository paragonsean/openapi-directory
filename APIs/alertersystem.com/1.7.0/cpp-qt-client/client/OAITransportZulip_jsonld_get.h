...
class OAITransportZulip_jsonld_get : public OAIObject {
public:
    OAITransportZulip_jsonld_get();
    OAITransportZulip_jsonld_get(QString json);
    ~OAITransportZulip_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportZulip_jsonld_get)

#endif // OAITransportZulip_jsonld_get_H
