...
/*
 * OAITransportMicrosoftTeams_post.h
 *
...
#ifndef OAITransportMicrosoftTeams_post_H
#define OAITransportMicrosoftTeams_post_H
...
class OAITransportMicrosoftTeams_post : public OAIObject {
public:
    OAITransportMicrosoftTeams_post();
    OAITransportMicrosoftTeams_post(QString json);
    ~OAITransportMicrosoftTeams_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMicrosoftTeams_post)

#endif // OAITransportMicrosoftTeams_post_H
