...
class OAITransportTwilio_jsonld_get : public OAIObject {
public:
    OAITransportTwilio_jsonld_get();
    OAITransportTwilio_jsonld_get(QString json);
    ~OAITransportTwilio_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTwilio_jsonld_get)

#endif // OAITransportTwilio_jsonld_get_H
