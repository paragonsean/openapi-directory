...
/*
 * OAITransportRingCentral_post.h
 *
...
#ifndef OAITransportRingCentral_post_H
#define OAITransportRingCentral_post_H
...
class OAITransportRingCentral_post : public OAIObject {
public:
    OAITransportRingCentral_post();
    OAITransportRingCentral_post(QString json);
    ~OAITransportRingCentral_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportRingCentral_post)

#endif // OAITransportRingCentral_post_H
