...
#ifndef OAITransportChatwork_get_H
#define OAITransportChatwork_get_H
...
class OAITransportChatwork_get : public OAIObject {
public:
    OAITransportChatwork_get();
    OAITransportChatwork_get(QString json);
    ~OAITransportChatwork_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportChatwork_get)

#endif // OAITransportChatwork_get_H
