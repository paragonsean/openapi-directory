...
class OAITransportTwitter_get : public OAIObject {
public:
    OAITransportTwitter_get();
    OAITransportTwitter_get(QString json);
    ~OAITransportTwitter_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTwitter_get)

#endif // OAITransportTwitter_get_H
