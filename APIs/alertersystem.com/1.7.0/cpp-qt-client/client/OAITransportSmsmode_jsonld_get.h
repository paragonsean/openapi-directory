...
class OAITransportSmsmode_jsonld_get : public OAIObject {
public:
    OAITransportSmsmode_jsonld_get();
    OAITransportSmsmode_jsonld_get(QString json);
    ~OAITransportSmsmode_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSmsmode_jsonld_get)

#endif // OAITransportSmsmode_jsonld_get_H
