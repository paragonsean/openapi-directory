...
class OAITransportSms77_get : public OAIObject {
public:
    OAITransportSms77_get();
    OAITransportSms77_get(QString json);
    ~OAITransportSms77_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSms77_get)

#endif // OAITransportSms77_get_H
