...
class OAITransportSms77_jsonld_get : public OAIObject {
public:
    OAITransportSms77_jsonld_get();
    OAITransportSms77_jsonld_get(QString json);
    ~OAITransportSms77_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSms77_jsonld_get)

#endif // OAITransportSms77_jsonld_get_H
