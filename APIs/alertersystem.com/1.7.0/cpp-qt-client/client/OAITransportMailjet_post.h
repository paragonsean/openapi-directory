...
class OAITransportMailjet_post : public OAIObject {
public:
    OAITransportMailjet_post();
    OAITransportMailjet_post(QString json);
    ~OAITransportMailjet_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMailjet_post)

#endif // OAITransportMailjet_post_H
