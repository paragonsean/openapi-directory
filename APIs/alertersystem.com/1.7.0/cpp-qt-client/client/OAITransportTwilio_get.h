...
class OAITransportTwilio_get : public OAIObject {
public:
    OAITransportTwilio_get();
    OAITransportTwilio_get(QString json);
    ~OAITransportTwilio_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportTwilio_get)

#endif // OAITransportTwilio_get_H
