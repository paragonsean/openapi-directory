...
#ifndef OAITransportGatewayApi_get_H
#define OAITransportGatewayApi_get_H
...
class OAITransportGatewayApi_get : public OAIObject {
public:
    OAITransportGatewayApi_get();
    OAITransportGatewayApi_get(QString json);
    ~OAITransportGatewayApi_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGatewayApi_get)

#endif // OAITransportGatewayApi_get_H
