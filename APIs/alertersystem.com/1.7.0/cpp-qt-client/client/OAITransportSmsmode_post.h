...
class OAITransportSmsmode_post : public OAIObject {
public:
    OAITransportSmsmode_post();
    OAITransportSmsmode_post(QString json);
    ~OAITransportSmsmode_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSmsmode_post)

#endif // OAITransportSmsmode_post_H
