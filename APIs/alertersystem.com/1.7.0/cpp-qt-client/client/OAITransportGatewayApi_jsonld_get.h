...
/*
 * OAITransportGatewayApi_jsonld_get.h
 *
...
#ifndef OAITransportGatewayApi_jsonld_get_H
#define OAITransportGatewayApi_jsonld_get_H
...
class OAITransportGatewayApi_jsonld_get : public OAIObject {
public:
    OAITransportGatewayApi_jsonld_get();
    OAITransportGatewayApi_jsonld_get(QString json);
    ~OAITransportGatewayApi_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGatewayApi_jsonld_get)

#endif // OAITransportGatewayApi_jsonld_get_H
