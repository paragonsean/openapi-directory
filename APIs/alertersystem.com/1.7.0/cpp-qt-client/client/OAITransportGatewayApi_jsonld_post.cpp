...
OAITransportGatewayApi_jsonld_post::OAITransportGatewayApi_jsonld_post(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransportGatewayApi_jsonld_post::OAITransportGatewayApi_jsonld_post() {
    this->initializeModel();
}

OAITransportGatewayApi_jsonld_post::~OAITransportGatewayApi_jsonld_post() {}

void OAITransportGatewayApi_jsonld_post::initializeModel() {
...
void OAITransportGatewayApi_jsonld_post::fromJson(QString jsonString) {
...
void OAITransportGatewayApi_jsonld_post::fromJsonObject(QJsonObject json) {
...
QString OAITransportGatewayApi_jsonld_post::asJson() const {
...
QJsonObject OAITransportGatewayApi_jsonld_post::asJsonObject() const {
    QJsonObject obj;
...
QString OAITransportGatewayApi_jsonld_post::getDataSegmentCode() const {
    return m_data_segment_code;
}
void OAITransportGatewayApi_jsonld_post::setDataSegmentCode(const QString &data_segment_code) {
    m_data_segment_code = data_segment_code;
    m_data_segment_code_isSet = true;
}

bool OAITransportGatewayApi_jsonld_post::is_data_segment_code_Set() const{
    return m_data_segment_code_isSet;
}

bool OAITransportGatewayApi_jsonld_post::is_data_segment_code_Valid() const{
    return m_data_segment_code_isValid;
}

QString OAITransportGatewayApi_jsonld_post::getGatewayApiFrom() const {
    return m_gateway_api_from;
}
void OAITransportGatewayApi_jsonld_post::setGatewayApiFrom(const QString &gateway_api_from) {
    m_gateway_api_from = gateway_api_from;
    m_gateway_api_from_isSet = true;
}

bool OAITransportGatewayApi_jsonld_post::is_gateway_api_from_Set() const{
    return m_gateway_api_from_isSet;
}

bool OAITransportGatewayApi_jsonld_post::is_gateway_api_from_Valid() const{
    return m_gateway_api_from_isValid;
}

QString OAITransportGatewayApi_jsonld_post::getGatewayApiToken() const {
    return m_gateway_api_token;
}
void OAITransportGatewayApi_jsonld_post::setGatewayApiToken(const QString &gateway_api_token) {
    m_gateway_api_token = gateway_api_token;
    m_gateway_api_token_isSet = true;
}

bool OAITransportGatewayApi_jsonld_post::is_gateway_api_token_Set() const{
    return m_gateway_api_token_isSet;
}

bool OAITransportGatewayApi_jsonld_post::is_gateway_api_token_Valid() const{
    return m_gateway_api_token_isValid;
}

QString OAITransportGatewayApi_jsonld_post::getPartition() const {
    return m_partition;
}
void OAITransportGatewayApi_jsonld_post::setPartition(const QString &partition) {
    m_partition = partition;
    m_partition_isSet = true;
}

bool OAITransportGatewayApi_jsonld_post::is_partition_Set() const{
    return m_partition_isSet;
}

bool OAITransportGatewayApi_jsonld_post::is_partition_Valid() const{
    return m_partition_isValid;
}

QString OAITransportGatewayApi_jsonld_post::getTransportName() const {
    return m_transport_name;
}
void OAITransportGatewayApi_jsonld_post::setTransportName(const QString &transport_name) {
    m_transport_name = transport_name;
    m_transport_name_isSet = true;
}

bool OAITransportGatewayApi_jsonld_post::is_transport_name_Set() const{
    return m_transport_name_isSet;
}

bool OAITransportGatewayApi_jsonld_post::is_transport_name_Valid() const{
    return m_transport_name_isValid;
}

bool OAITransportGatewayApi_jsonld_post::isSet() const {
...
bool OAITransportGatewayApi_jsonld_post::isValid() const {
