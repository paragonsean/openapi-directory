...
#ifndef OAITransportSpotHit_post_H
#define OAITransportSpotHit_post_H
...
class OAITransportSpotHit_post : public OAIObject {
public:
    OAITransportSpotHit_post();
    OAITransportSpotHit_post(QString json);
    ~OAITransportSpotHit_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportSpotHit_post)

#endif // OAITransportSpotHit_post_H
