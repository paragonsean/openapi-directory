...
class OAITransportIqsms_jsonld_get : public OAIObject {
public:
    OAITransportIqsms_jsonld_get();
    OAITransportIqsms_jsonld_get(QString json);
    ~OAITransportIqsms_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportIqsms_jsonld_get)

#endif // OAITransportIqsms_jsonld_get_H
