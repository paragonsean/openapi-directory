...
/*
 * OAITransportChatwork_jsonld_get.h
 *
...
#ifndef OAITransportChatwork_jsonld_get_H
#define OAITransportChatwork_jsonld_get_H
...
class OAITransportChatwork_jsonld_get : public OAIObject {
public:
    OAITransportChatwork_jsonld_get();
    OAITransportChatwork_jsonld_get(QString json);
    ~OAITransportChatwork_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportChatwork_jsonld_get)

#endif // OAITransportChatwork_jsonld_get_H
