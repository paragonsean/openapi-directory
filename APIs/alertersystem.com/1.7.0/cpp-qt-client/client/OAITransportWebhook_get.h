...
#ifndef OAITransportWebhook_get_H
#define OAITransportWebhook_get_H
...
class OAITransportWebhook_get : public OAIObject {
public:
    OAITransportWebhook_get();
    OAITransportWebhook_get(QString json);
    ~OAITransportWebhook_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportWebhook_get)

#endif // OAITransportWebhook_get_H
