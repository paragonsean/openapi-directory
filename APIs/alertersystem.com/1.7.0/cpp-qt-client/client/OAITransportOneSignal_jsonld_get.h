...
/*
 * OAITransportOneSignal_jsonld_get.h
 *
...
#ifndef OAITransportOneSignal_jsonld_get_H
#define OAITransportOneSignal_jsonld_get_H
...
class OAITransportOneSignal_jsonld_get : public OAIObject {
public:
    OAITransportOneSignal_jsonld_get();
    OAITransportOneSignal_jsonld_get(QString json);
    ~OAITransportOneSignal_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportOneSignal_jsonld_get)

#endif // OAITransportOneSignal_jsonld_get_H
