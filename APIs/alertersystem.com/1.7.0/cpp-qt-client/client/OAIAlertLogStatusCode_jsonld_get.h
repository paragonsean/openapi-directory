...
/*
 * OAIAlertLogStatusCode_jsonld_get.h
 *
 * The AlertLogStatusCode resource is a set of codes that describes the outcomes of the dispatching of an alert.
 */

#ifndef OAIAlertLogStatusCode_jsonld_get_H
#define OAIAlertLogStatusCode_jsonld_get_H
...
class OAIAlertLogStatusCode_jsonld_get : public OAIObject {
public:
    OAIAlertLogStatusCode_jsonld_get();
    OAIAlertLogStatusCode_jsonld_get(QString json);
    ~OAIAlertLogStatusCode_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlertLogStatusCode_jsonld_get)

#endif // OAIAlertLogStatusCode_jsonld_get_H
