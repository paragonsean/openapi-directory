...
class OAITransportMailjet_jsonld_get : public OAIObject {
public:
    OAITransportMailjet_jsonld_get();
    OAITransportMailjet_jsonld_get(QString json);
    ~OAITransportMailjet_jsonld_get() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportMailjet_jsonld_get)

#endif // OAITransportMailjet_jsonld_get_H
