...
class OAITransportGitter_post : public OAIObject {
public:
    OAITransportGitter_post();
    OAITransportGitter_post(QString json);
    ~OAITransportGitter_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransportGitter_post)

#endif // OAITransportGitter_post_H
