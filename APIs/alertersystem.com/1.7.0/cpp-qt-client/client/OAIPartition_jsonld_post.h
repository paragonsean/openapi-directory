...
class OAIPartition_jsonld_post : public OAIObject {
public:
    OAIPartition_jsonld_post();
    OAIPartition_jsonld_post(QString json);
    ~OAIPartition_jsonld_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartition_jsonld_post)

#endif // OAIPartition_jsonld_post_H
