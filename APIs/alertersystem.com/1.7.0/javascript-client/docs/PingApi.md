...
> [PingGet] apiPingGetCollection(opts)
...
let apiInstance = new AlerterSystemApi.PingApi();
let opts = {
...
apiInstance.apiPingGetCollection(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new AlerterSystemApi.PingApi();
let id = "id_example"; // String | Ping identifier
apiInstance.apiPingIdGet(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new AlerterSystemApi.PingApi();
let pingPost = new AlerterSystemApi.PingPost(); // PingPost | The new Ping resource
apiInstance.apiPingPost(pingPost, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
