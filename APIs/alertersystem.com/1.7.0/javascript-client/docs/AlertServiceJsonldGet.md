# AlerterSystemApi.AlertServiceJsonldGet
...
**creditsPerTransportAlert** | **Number** | The phone number where alerts will be sent. Ensure that the number format complies with the external transport service that will send the alert. | [optional] [default to 1]
