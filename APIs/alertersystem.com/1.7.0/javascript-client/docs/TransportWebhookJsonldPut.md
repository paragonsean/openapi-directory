# AlerterSystemApi.TransportWebhookJsonldPut
...
**webhookHeaders** | **[String]** | The HTTP request headers, if any, for the Webhook service. To use the encrypted value:  E.g., Authorization: Bearer ENCRYPTED_VALUE. | [optional] 
**webhookUrl** | **String** | The URL for the Webhook service. | 
