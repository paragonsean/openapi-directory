...
**lastPingAt** | **Date** | When the last ping was received. This date-time is in the UTC timezone. | [optional] 
...
**nextPingAt** | **Date** | When the next ping is expected. This date-time is in the UTC timezone. | [optional] 
...
**startMonitorAtUtc** | **Date** | The startMonitorAt date-time in the UTC timezone. | [optional] 
**systemMessages** | **[String]** | Service notes regarding the resource. | [optional] 
