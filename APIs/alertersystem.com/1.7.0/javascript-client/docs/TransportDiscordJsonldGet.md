# AlerterSystemApi.TransportDiscordJsonldGet
...
**discordToken** | **String** | The token for the Discord service. Stored in encrypted format. | 
**discordWebhookId** | **String** | The webhook ID for the Discord service. | 
