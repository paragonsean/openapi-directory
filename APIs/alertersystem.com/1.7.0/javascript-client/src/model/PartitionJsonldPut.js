...
/**
 * The PartitionJsonldPut model module.
 * @module model/PartitionJsonldPut
 * @version 1.7.0
 */
class PartitionJsonldPut {
    /**
     * Constructs a new <code>PartitionJsonldPut</code>.
     * The Partition resource is a collection of siloed monitor and alert environments in the user account.
     * @alias module:model/PartitionJsonldPut
     * @param partitionName {String} The name of the partition. Max 255 characters.
     */
    constructor(partitionName) { 
        
        PartitionJsonldPut.initialize(this, partitionName);
    }
    ...
    /**
     * Constructs a <code>PartitionJsonldPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartitionJsonldPut} obj Optional instance to populate.
     * @return {module:model/PartitionJsonldPut} The populated <code>PartitionJsonldPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartitionJsonldPut();
    ...
    /**
     * Validates the JSON data with respect to <code>PartitionJsonldPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartitionJsonldPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PartitionJsonldPut.RequiredProperties) {
...
PartitionJsonldPut.RequiredProperties = ["partitionName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
PartitionJsonldPut.prototype['dataSegmentCode'] = undefined;

/**
 * The name of the partition. Max 255 characters.
 * @member {String} partitionName
 */
PartitionJsonldPut.prototype['partitionName'] = undefined;
 ...
 */
PartitionJsonldPut.prototype['partitionNotes'] = undefined;
...
export default PartitionJsonldPut;
