...
/**
 * The TransportOctopushPut model module.
 * @module model/TransportOctopushPut
 * @version 1.7.0
 */
class TransportOctopushPut {
    /**
     * Constructs a new <code>TransportOctopushPut</code>.
     ...
     * @alias module:model/TransportOctopushPut
    ...
    constructor(octopushApiKey, octopushFrom, octopushType, octopushUserLogin, transportName) { 
        ...
        TransportOctopushPut.initialize(this, octopushApiKey, octopushFrom, octopushType, octopushUserLogin, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportOctopushPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportOctopushPut} obj Optional instance to populate.
     * @return {module:model/TransportOctopushPut} The populated <code>TransportOctopushPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportOctopushPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportOctopushPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportOctopushPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportOctopushPut.RequiredProperties) {
...
TransportOctopushPut.RequiredProperties = ["octopushApiKey", "octopushFrom", "octopushType", "octopushUserLogin", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportOctopushPut.prototype['dataSegmentCode'] = undefined;

/**
 * The API key for the Octopush service. Stored in encrypted format.
 * @member {String} octopushApiKey
 */
TransportOctopushPut.prototype['octopushApiKey'] = undefined;

/**
 * The sender value for the Octopush service.
 * @member {String} octopushFrom
 */
TransportOctopushPut.prototype['octopushFrom'] = undefined;

/**
 * The SMS type ('XXX' = SMS LowCost; 'FR' = SMS Premium; 'WWW' = SMS World) for the Octopush service.
 * @member {String} octopushType
 */
TransportOctopushPut.prototype['octopushType'] = undefined;

/**
 * The user login (email) for the Octopush service.
 * @member {String} octopushUserLogin
 */
TransportOctopushPut.prototype['octopushUserLogin'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportOctopushPut.prototype['transportName'] = undefined;
...
export default TransportOctopushPut;
