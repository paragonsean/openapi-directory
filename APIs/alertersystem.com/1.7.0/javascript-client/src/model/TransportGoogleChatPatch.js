...
/**
 * The TransportGoogleChatPatch model module.
 * @module model/TransportGoogleChatPatch
 * @version 1.7.0
 */
class TransportGoogleChatPatch {
    /**
     * Constructs a new <code>TransportGoogleChatPatch</code>.
     ...
     * @alias module:model/TransportGoogleChatPatch
    ...
    constructor(googleChatAccessKey, googleChatAccessToken, googleChatSpace, transportName) { 
        ...
        TransportGoogleChatPatch.initialize(this, googleChatAccessKey, googleChatAccessToken, googleChatSpace, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportGoogleChatPatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportGoogleChatPatch} obj Optional instance to populate.
     * @return {module:model/TransportGoogleChatPatch} The populated <code>TransportGoogleChatPatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportGoogleChatPatch();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportGoogleChatPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportGoogleChatPatch</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportGoogleChatPatch.RequiredProperties) {
...
TransportGoogleChatPatch.RequiredProperties = ["googleChatAccessKey", "googleChatAccessToken", "googleChatSpace", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportGoogleChatPatch.prototype['dataSegmentCode'] = undefined;

/**
 * The access key for the Google Chat service.
 * @member {String} googleChatAccessKey
 */
TransportGoogleChatPatch.prototype['googleChatAccessKey'] = undefined;

/**
 * The access token for the Google Chat service. Stored in encrypted format.
 * @member {String} googleChatAccessToken
 */
TransportGoogleChatPatch.prototype['googleChatAccessToken'] = undefined;

/**
 * The space name for the Google Chat service.
 * @member {String} googleChatSpace
 */
TransportGoogleChatPatch.prototype['googleChatSpace'] = undefined;

/**
 * The optional thread key for the Google Chat service.
 * @member {String} googleChatThreadKey
 */
TransportGoogleChatPatch.prototype['googleChatThreadKey'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportGoogleChatPatch.prototype['transportName'] = undefined;
...
export default TransportGoogleChatPatch;
