...
/**
 * The TransportAlertaJsonldPut model module.
 * @module model/TransportAlertaJsonldPut
 * @version 1.7.0
 */
class TransportAlertaJsonldPut {
    /**
     * Constructs a new <code>TransportAlertaJsonldPut</code>.
     * The TransportAlerta resource is a collection of transports that carry dispatched alerts to the external Alerta service.
     * @alias module:model/TransportAlertaJsonldPut
    ...
    constructor(alertaApiKey, alertaEvent, alertaHost, alertaResource, transportName) { 
        ...
        TransportAlertaJsonldPut.initialize(this, alertaApiKey, alertaEvent, alertaHost, alertaResource, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportAlertaJsonldPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportAlertaJsonldPut} obj Optional instance to populate.
     * @return {module:model/TransportAlertaJsonldPut} The populated <code>TransportAlertaJsonldPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportAlertaJsonldPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportAlertaJsonldPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportAlertaJsonldPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportAlertaJsonldPut.RequiredProperties) {
...
export default TransportAlertaJsonldPut;
