...
/**
 * The TransportPlivoPost model module.
 * @module model/TransportPlivoPost
 * @version 1.7.0
 */
class TransportPlivoPost {
    /**
     * Constructs a new <code>TransportPlivoPost</code>.
     * The TransportPlivo resource is a collection of transports that carry dispatched alerts to the external Plivo service.
     * @alias module:model/TransportPlivoPost
    ...
    constructor(partition, plivoAuthId, plivoAuthToken, plivoFrom, transportName) { 
        ...
        TransportPlivoPost.initialize(this, partition, plivoAuthId, plivoAuthToken, plivoFrom, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportPlivoPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportPlivoPost} obj Optional instance to populate.
     * @return {module:model/TransportPlivoPost} The populated <code>TransportPlivoPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportPlivoPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportPlivoPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportPlivoPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportPlivoPost.RequiredProperties) {
...
TransportPlivoPost.RequiredProperties = ["partition", "plivoAuthId", "plivoAuthToken", "plivoFrom", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportPlivoPost.prototype['dataSegmentCode'] = undefined;
 ...
 */
TransportPlivoPost.prototype['partition'] = undefined;

/**
 * The auth ID for the Plivo service.
 * @member {String} plivoAuthId
 */
TransportPlivoPost.prototype['plivoAuthId'] = undefined;

/**
 * The auth token for the Plivo service. Stored in encrypted format.
 * @member {String} plivoAuthToken
 */
TransportPlivoPost.prototype['plivoAuthToken'] = undefined;

/**
 * The sender value for the Plivo service.
 * @member {String} plivoFrom
 */
TransportPlivoPost.prototype['plivoFrom'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportPlivoPost.prototype['transportName'] = undefined;
...
export default TransportPlivoPost;
