...
/**
 * The TransportIqsmsJsonldPost model module.
 * @module model/TransportIqsmsJsonldPost
 * @version 1.7.0
 */
class TransportIqsmsJsonldPost {
    /**
     * Constructs a new <code>TransportIqsmsJsonldPost</code>.
     * The TransportIqsms resource is a collection of transports that carry dispatched alerts to the external Iqsms service.
     * @alias module:model/TransportIqsmsJsonldPost
    ...
    constructor(iqsmsFrom, iqsmsLogin, iqsmsPassword, partition, transportName) { 
        ...
        TransportIqsmsJsonldPost.initialize(this, iqsmsFrom, iqsmsLogin, iqsmsPassword, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportIqsmsJsonldPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportIqsmsJsonldPost} obj Optional instance to populate.
     * @return {module:model/TransportIqsmsJsonldPost} The populated <code>TransportIqsmsJsonldPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportIqsmsJsonldPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportIqsmsJsonldPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportIqsmsJsonldPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportIqsmsJsonldPost.RequiredProperties) {
...
TransportIqsmsJsonldPost.RequiredProperties = ["iqsmsFrom", "iqsmsLogin", "iqsmsPassword", "partition", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportIqsmsJsonldPost.prototype['dataSegmentCode'] = undefined;

/**
 * The sender value for the Iqsms service.
 * @member {String} iqsmsFrom
 */
TransportIqsmsJsonldPost.prototype['iqsmsFrom'] = undefined;

/**
 * The login for the Iqsms service.
 * @member {String} iqsmsLogin
 */
TransportIqsmsJsonldPost.prototype['iqsmsLogin'] = undefined;

/**
 * The password for the Iqsms service. Stored in encrypted format.
 * @member {String} iqsmsPassword
 */
TransportIqsmsJsonldPost.prototype['iqsmsPassword'] = undefined;
 ...
 */
TransportIqsmsJsonldPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportIqsmsJsonldPost.prototype['transportName'] = undefined;
...
export default TransportIqsmsJsonldPost;
