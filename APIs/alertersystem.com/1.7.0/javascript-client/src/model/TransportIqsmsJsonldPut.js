...
/**
 * The TransportIqsmsJsonldPut model module.
 * @module model/TransportIqsmsJsonldPut
 * @version 1.7.0
 */
class TransportIqsmsJsonldPut {
    /**
     * Constructs a new <code>TransportIqsmsJsonldPut</code>.
     * The TransportIqsms resource is a collection of transports that carry dispatched alerts to the external Iqsms service.
     * @alias module:model/TransportIqsmsJsonldPut
    ...
    constructor(iqsmsFrom, iqsmsLogin, iqsmsPassword, transportName) { 
        ...
        TransportIqsmsJsonldPut.initialize(this, iqsmsFrom, iqsmsLogin, iqsmsPassword, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportIqsmsJsonldPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportIqsmsJsonldPut} obj Optional instance to populate.
     * @return {module:model/TransportIqsmsJsonldPut} The populated <code>TransportIqsmsJsonldPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportIqsmsJsonldPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportIqsmsJsonldPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportIqsmsJsonldPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportIqsmsJsonldPut.RequiredProperties) {
...
TransportIqsmsJsonldPut.RequiredProperties = ["iqsmsFrom", "iqsmsLogin", "iqsmsPassword", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportIqsmsJsonldPut.prototype['dataSegmentCode'] = undefined;

/**
 * The sender value for the Iqsms service.
 * @member {String} iqsmsFrom
 */
TransportIqsmsJsonldPut.prototype['iqsmsFrom'] = undefined;

/**
 * The login for the Iqsms service.
 * @member {String} iqsmsLogin
 */
TransportIqsmsJsonldPut.prototype['iqsmsLogin'] = undefined;

/**
 * The password for the Iqsms service. Stored in encrypted format.
 * @member {String} iqsmsPassword
 */
TransportIqsmsJsonldPut.prototype['iqsmsPassword'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportIqsmsJsonldPut.prototype['transportName'] = undefined;
...
export default TransportIqsmsJsonldPut;
