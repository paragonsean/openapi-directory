...
/**
 * The TransportExpoGet model module.
 * @module model/TransportExpoGet
 * @version 1.7.0
 */
class TransportExpoGet {
    /**
     * Constructs a new <code>TransportExpoGet</code>.
     * The TransportExpo resource is a collection of transports that carry dispatched alerts to the external Expo service.
     * @alias module:model/TransportExpoGet
    ...
    constructor(expoToken, partition, transportName) { 
        ...
        TransportExpoGet.initialize(this, expoToken, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportExpoGet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportExpoGet} obj Optional instance to populate.
     * @return {module:model/TransportExpoGet} The populated <code>TransportExpoGet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportExpoGet();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportExpoGet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportExpoGet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportExpoGet.RequiredProperties) {
...
TransportExpoGet.RequiredProperties = ["expoToken", "partition", "transportName"];

/**
 * When the resource instance was created. This date-time is in the UTC timezone.
 * @member {Date} createdAt
 */
TransportExpoGet.prototype['createdAt'] = undefined;

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportExpoGet.prototype['dataSegmentCode'] = undefined;

/**
 * The token for the Expo service. Stored in encrypted format.
 * @member {String} expoToken
 */
TransportExpoGet.prototype['expoToken'] = undefined;

/**
 * The unique identifier of the resource instance.
 * @member {String} id
 */
TransportExpoGet.prototype['id'] = undefined;
 ...
 */
TransportExpoGet.prototype['partition'] = undefined;

/**
 * The name of the person who owns this resource.
 * @member {String} resourceOwner
 */
TransportExpoGet.prototype['resourceOwner'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportExpoGet.prototype['transportName'] = undefined;
...
export default TransportExpoGet;
