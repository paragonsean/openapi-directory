...
/**
 * The TransportOvhCloudPatch model module.
 * @module model/TransportOvhCloudPatch
 * @version 1.7.0
 */
class TransportOvhCloudPatch {
    /**
     * Constructs a new <code>TransportOvhCloudPatch</code>.
     ...
     * @alias module:model/TransportOvhCloudPatch
    ...
    constructor(ovhCloudApplicationKey, ovhCloudApplicationSecret, ovhCloudConsumerKey, ovhCloudServiceName, transportName) { 
        ...
        TransportOvhCloudPatch.initialize(this, ovhCloudApplicationKey, ovhCloudApplicationSecret, ovhCloudConsumerKey, ovhCloudServiceName, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportOvhCloudPatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportOvhCloudPatch} obj Optional instance to populate.
     * @return {module:model/TransportOvhCloudPatch} The populated <code>TransportOvhCloudPatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportOvhCloudPatch();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportOvhCloudPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportOvhCloudPatch</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportOvhCloudPatch.RequiredProperties) {
...
TransportOvhCloudPatch.RequiredProperties = ["ovhCloudApplicationKey", "ovhCloudApplicationSecret", "ovhCloudConsumerKey", "ovhCloudServiceName", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportOvhCloudPatch.prototype['dataSegmentCode'] = undefined;

/**
 * The application key for the OVHcloud service.
 * @member {String} ovhCloudApplicationKey
 */
TransportOvhCloudPatch.prototype['ovhCloudApplicationKey'] = undefined;

/**
 * The application secret for the OVHcloud service. Stored in encrypted format.
 * @member {String} ovhCloudApplicationSecret
 */
TransportOvhCloudPatch.prototype['ovhCloudApplicationSecret'] = undefined;

/**
 * The consumer key for the OVHcloud service.
 * @member {String} ovhCloudConsumerKey
 */
TransportOvhCloudPatch.prototype['ovhCloudConsumerKey'] = undefined;

/**
 * The optional sender for the OVHcloud service.
 * @member {String} ovhCloudSender
 */
TransportOvhCloudPatch.prototype['ovhCloudSender'] = undefined;

/**
 * The service name for the OVHcloud service.
 * @member {String} ovhCloudServiceName
 */
TransportOvhCloudPatch.prototype['ovhCloudServiceName'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportOvhCloudPatch.prototype['transportName'] = undefined;
...
export default TransportOvhCloudPatch;
