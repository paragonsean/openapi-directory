...
/**
 * The TransportAlertaPut model module.
 * @module model/TransportAlertaPut
 * @version 1.7.0
 */
class TransportAlertaPut {
    /**
     * Constructs a new <code>TransportAlertaPut</code>.
     * The TransportAlerta resource is a collection of transports that carry dispatched alerts to the external Alerta service.
     * @alias module:model/TransportAlertaPut
    ...
    constructor(alertaApiKey, alertaEvent, alertaHost, alertaResource, transportName) { 
        ...
        TransportAlertaPut.initialize(this, alertaApiKey, alertaEvent, alertaHost, alertaResource, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportAlertaPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportAlertaPut} obj Optional instance to populate.
     * @return {module:model/TransportAlertaPut} The populated <code>TransportAlertaPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportAlertaPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportAlertaPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportAlertaPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportAlertaPut.RequiredProperties) {
...
export default TransportAlertaPut;
