...
/**
 * The TransportPlivoGet model module.
 * @module model/TransportPlivoGet
 * @version 1.7.0
 */
class TransportPlivoGet {
    /**
     * Constructs a new <code>TransportPlivoGet</code>.
     * The TransportPlivo resource is a collection of transports that carry dispatched alerts to the external Plivo service.
     * @alias module:model/TransportPlivoGet
    ...
    constructor(partition, plivoAuthId, plivoAuthToken, plivoFrom, transportName) { 
        ...
        TransportPlivoGet.initialize(this, partition, plivoAuthId, plivoAuthToken, plivoFrom, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportPlivoGet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportPlivoGet} obj Optional instance to populate.
     * @return {module:model/TransportPlivoGet} The populated <code>TransportPlivoGet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportPlivoGet();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportPlivoGet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportPlivoGet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportPlivoGet.RequiredProperties) {
...
TransportPlivoGet.RequiredProperties = ["partition", "plivoAuthId", "plivoAuthToken", "plivoFrom", "transportName"];

/**
 * When the resource instance was created. This date-time is in the UTC timezone.
 * @member {Date} createdAt
 */
TransportPlivoGet.prototype['createdAt'] = undefined;

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportPlivoGet.prototype['dataSegmentCode'] = undefined;

/**
 * The unique identifier of the resource instance.
 * @member {String} id
 */
TransportPlivoGet.prototype['id'] = undefined;
...
export default TransportPlivoGet;
