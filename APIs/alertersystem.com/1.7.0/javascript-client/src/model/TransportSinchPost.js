...
/**
 * The TransportSinchPost model module.
 * @module model/TransportSinchPost
 * @version 1.7.0
 */
class TransportSinchPost {
    /**
     * Constructs a new <code>TransportSinchPost</code>.
     * The TransportSinch resource is a collection of transports that carry dispatched alerts to the external Sinch service.
     * @alias module:model/TransportSinchPost
    ...
    constructor(partition, sinchAuthToken, sinchFrom, sinchServicePlanId, transportName) { 
        ...
        TransportSinchPost.initialize(this, partition, sinchAuthToken, sinchFrom, sinchServicePlanId, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportSinchPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportSinchPost} obj Optional instance to populate.
     * @return {module:model/TransportSinchPost} The populated <code>TransportSinchPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportSinchPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportSinchPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportSinchPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportSinchPost.RequiredProperties) {
...
TransportSinchPost.RequiredProperties = ["partition", "sinchAuthToken", "sinchFrom", "sinchServicePlanId", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportSinchPost.prototype['dataSegmentCode'] = undefined;
 ...
 */
TransportSinchPost.prototype['partition'] = undefined;

/**
 * The auth token for the Sinch service. Stored in encrypted format.
 * @member {String} sinchAuthToken
 */
TransportSinchPost.prototype['sinchAuthToken'] = undefined;

/**
 * The sender for the Sinch service.
 * @member {String} sinchFrom
 */
TransportSinchPost.prototype['sinchFrom'] = undefined;

/**
 * The service plan ID for the Sinch service.
 * @member {String} sinchServicePlanId
 */
TransportSinchPost.prototype['sinchServicePlanId'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportSinchPost.prototype['transportName'] = undefined;
...
export default TransportSinchPost;
