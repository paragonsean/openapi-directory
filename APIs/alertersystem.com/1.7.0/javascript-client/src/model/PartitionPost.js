...
class PartitionPost {
    ...
    /**
     * Constructs a <code>PartitionPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartitionPost} obj Optional instance to populate.
     * @return {module:model/PartitionPost} The populated <code>PartitionPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PartitionPost();
    ...
    /**
     * Validates the JSON data with respect to <code>PartitionPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartitionPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PartitionPost.RequiredProperties) {
...
PartitionPost.RequiredProperties = ["partitionName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
PartitionPost.prototype['dataSegmentCode'] = undefined;

/**
 * The name of the partition. Max 255 characters.
 * @member {String} partitionName
 */
PartitionPost.prototype['partitionName'] = undefined;
 ...
 */
PartitionPost.prototype['partitionNotes'] = undefined;
