...
/**
 * The TransportEmailJsonldPost model module.
 * @module model/TransportEmailJsonldPost
 * @version 1.7.0
 */
class TransportEmailJsonldPost {
    /**
     * Constructs a new <code>TransportEmailJsonldPost</code>.
     * The TransportEmail resource is a collection of transports that carry dispatched alerts to external SMTP email services.
     * @alias module:model/TransportEmailJsonldPost
    ...
    constructor(emailFromAddress, emailFromName, emailPassword, emailPort, emailServer, emailUsername, partition, transportName) { 
        ...
        TransportEmailJsonldPost.initialize(this, emailFromAddress, emailFromName, emailPassword, emailPort, emailServer, emailUsername, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportEmailJsonldPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportEmailJsonldPost} obj Optional instance to populate.
     * @return {module:model/TransportEmailJsonldPost} The populated <code>TransportEmailJsonldPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportEmailJsonldPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportEmailJsonldPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportEmailJsonldPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportEmailJsonldPost.RequiredProperties) {
...
TransportEmailJsonldPost.RequiredProperties = ["emailFromAddress", "emailFromName", "emailPassword", "emailPort", "emailServer", "emailUsername", "partition", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportEmailJsonldPost.prototype['dataSegmentCode'] = undefined;

/**
 * The sender email address for the SMTP Email service.
 * @member {String} emailFromAddress
 */
TransportEmailJsonldPost.prototype['emailFromAddress'] = undefined;

/**
 * The sender name for the SMTP Email service.
 * @member {String} emailFromName
 */
TransportEmailJsonldPost.prototype['emailFromName'] = undefined;

/**
 * The password for the SMTP Email service. Stored in encrypted format.
 * @member {String} emailPassword
 */
TransportEmailJsonldPost.prototype['emailPassword'] = undefined;

/**
 * The port for the SMTP Email service.
 * @member {Number} emailPort
 */
TransportEmailJsonldPost.prototype['emailPort'] = undefined;

/**
 * The server for the SMTP Email service.
 * @member {String} emailServer
 */
TransportEmailJsonldPost.prototype['emailServer'] = undefined;

/**
 * The username for the SMTP Email service.
 * @member {String} emailUsername
 */
TransportEmailJsonldPost.prototype['emailUsername'] = undefined;
 ...
 */
TransportEmailJsonldPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportEmailJsonldPost.prototype['transportName'] = undefined;
...
export default TransportEmailJsonldPost;
