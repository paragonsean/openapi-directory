...
/**
 * The TransportFreshdeskPost model module.
 * @module model/TransportFreshdeskPost
 * @version 1.7.0
 */
class TransportFreshdeskPost {
    /**
     * Constructs a new <code>TransportFreshdeskPost</code>.
     ...
     * @alias module:model/TransportFreshdeskPost
    ...
    constructor(freshdeskApiKey, freshdeskEmail, freshdeskHost, partition, transportName) { 
        ...
        TransportFreshdeskPost.initialize(this, freshdeskApiKey, freshdeskEmail, freshdeskHost, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportFreshdeskPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportFreshdeskPost} obj Optional instance to populate.
     * @return {module:model/TransportFreshdeskPost} The populated <code>TransportFreshdeskPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportFreshdeskPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportFreshdeskPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportFreshdeskPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportFreshdeskPost.RequiredProperties) {
...
TransportFreshdeskPost.RequiredProperties = ["freshdeskApiKey", "freshdeskEmail", "freshdeskHost", "partition", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportFreshdeskPost.prototype['dataSegmentCode'] = undefined;

/**
 * The API key for the Freshdesk service. Stored in encrypted format.
 * @member {String} freshdeskApiKey
 */
TransportFreshdeskPost.prototype['freshdeskApiKey'] = undefined;

/**
 * The requester email address for the Freshdesk service.
 * @member {String} freshdeskEmail
 */
TransportFreshdeskPost.prototype['freshdeskEmail'] = undefined;

/**
 * The host name for the Freshdesk service (domain.freshdesk.com).
 * @member {String} freshdeskHost
 */
TransportFreshdeskPost.prototype['freshdeskHost'] = undefined;

/**
 * The ticket priority for the Freshdesk service.
 * @member {String} freshdeskPriority
 */
TransportFreshdeskPost.prototype['freshdeskPriority'] = undefined;

/**
 * The ticket type for the Freshdesk service.
 * @member {String} freshdeskType
 */
TransportFreshdeskPost.prototype['freshdeskType'] = undefined;
 ...
 */
TransportFreshdeskPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportFreshdeskPost.prototype['transportName'] = undefined;
...
export default TransportFreshdeskPost;
