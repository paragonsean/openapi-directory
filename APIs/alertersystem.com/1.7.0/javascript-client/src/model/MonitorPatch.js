...
/**
 * The MonitorPatch model module.
 * @module model/MonitorPatch
 * @version 1.7.0
 */
class MonitorPatch {
    /**
     * Constructs a new <code>MonitorPatch</code>.
     ...
     * @alias module:model/MonitorPatch
    ...
    constructor(monitorName, timezoneCode) { 
        ...
        MonitorPatch.initialize(this, monitorName, timezoneCode);
    }
    ...
    /**
     * Constructs a <code>MonitorPatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MonitorPatch} obj Optional instance to populate.
     * @return {module:model/MonitorPatch} The populated <code>MonitorPatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MonitorPatch();
    ...
    /**
     * Validates the JSON data with respect to <code>MonitorPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MonitorPatch</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MonitorPatch.RequiredProperties) {
...
MonitorPatch.RequiredProperties = ["monitorName", "timezoneCode"];
 ...
 */
MonitorPatch.prototype['alertPayloadExtended'] = undefined;
 ...
 */
MonitorPatch.prototype['contentCheckMustNotExist'] = undefined;
 ...
 */
MonitorPatch.prototype['contentCheckXpathFilter'] = undefined;

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
MonitorPatch.prototype['dataSegmentCode'] = undefined;
 ...
 */
MonitorPatch.prototype['graceSeconds'] = undefined;
 ...
 */
MonitorPatch.prototype['intervalDays'] = undefined;
 ...
 */
MonitorPatch.prototype['intervalHours'] = undefined;
 ...
 */
MonitorPatch.prototype['intervalMinutes'] = undefined;
 ...
 */
MonitorPatch.prototype['intervalMonths'] = undefined;
 ...
 */
MonitorPatch.prototype['intervalSeconds'] = undefined;
 ...
 */
MonitorPatch.prototype['monitorNotes'] = undefined;
 ...
 */
MonitorPatch.prototype['publicDescription'] = undefined;
