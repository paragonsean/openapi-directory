...
/**
 * The AlertLogJsonldGet model module.
 * @module model/AlertLogJsonldGet
 * @version 1.7.0
 */
class AlertLogJsonldGet {
    /**
     * Constructs a new <code>AlertLogJsonldGet</code>.
     ...
     * @alias module:model/AlertLogJsonldGet
     */
    constructor() { 
        
        AlertLogJsonldGet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AlertLogJsonldGet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AlertLogJsonldGet} obj Optional instance to populate.
     * @return {module:model/AlertLogJsonldGet} The populated <code>AlertLogJsonldGet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AlertLogJsonldGet();
    ...
    /**
     * Validates the JSON data with respect to <code>AlertLogJsonldGet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AlertLogJsonldGet</code>.
     */
 ...
 */
AlertLogJsonldGet.prototype['@context'] = undefined;

/**
 * @member {String} @id
 */
AlertLogJsonldGet.prototype['@id'] = undefined;

/**
 * @member {String} @type
 */
AlertLogJsonldGet.prototype['@type'] = undefined;

/**
 * The reason why the dispatch of the alert failed.
 * @member {String} alertLogErrorMessage
 */
AlertLogJsonldGet.prototype['alertLogErrorMessage'] = undefined;
 ...
 */
AlertLogJsonldGet.prototype['alertLogMessageId'] = undefined;

/**
 * The status of the alert log.
 * @member {String} alertLogStatusCode
 */
AlertLogJsonldGet.prototype['alertLogStatusCode'] = undefined;

/**
 * The alert service that is related to this resource.
 * @member {String} alertService
 */
AlertLogJsonldGet.prototype['alertService'] = undefined;

/**
 * When the resource instance was created. This date-time is in the UTC timezone.
 * @member {Date} createdAt
 */
AlertLogJsonldGet.prototype['createdAt'] = undefined;

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
AlertLogJsonldGet.prototype['dataSegmentCode'] = undefined;
 ...
 */
AlertLogJsonldGet.prototype['monitor'] = undefined;
 ...
 */
AlertLogJsonldGet.prototype['partition'] = undefined;

/**
 * The ping that triggered this resource instance.
 * @member {String} ping
 */
AlertLogJsonldGet.prototype['ping'] = undefined;

/**
 * The name of the person who owns this resource.
 * @member {String} resourceOwner
 */
AlertLogJsonldGet.prototype['resourceOwner'] = undefined;
 ...
 */
AlertLogJsonldGet.prototype['webhookResponseBody'] = undefined;

/**
 * The response headers returned by a successful request to a webhook URL.
 * @member {Array.<String>} webhookResponseHeaders
 */
AlertLogJsonldGet.prototype['webhookResponseHeaders'] = undefined;
...
export default AlertLogJsonldGet;
