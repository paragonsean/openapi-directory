...
/**
 * The TransportOvhCloudPost model module.
 * @module model/TransportOvhCloudPost
 * @version 1.7.0
 */
class TransportOvhCloudPost {
    /**
     * Constructs a new <code>TransportOvhCloudPost</code>.
     ...
     * @alias module:model/TransportOvhCloudPost
    ...
    constructor(ovhCloudApplicationKey, ovhCloudApplicationSecret, ovhCloudConsumerKey, ovhCloudServiceName, partition, transportName) { 
        ...
        TransportOvhCloudPost.initialize(this, ovhCloudApplicationKey, ovhCloudApplicationSecret, ovhCloudConsumerKey, ovhCloudServiceName, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportOvhCloudPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportOvhCloudPost} obj Optional instance to populate.
     * @return {module:model/TransportOvhCloudPost} The populated <code>TransportOvhCloudPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportOvhCloudPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportOvhCloudPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportOvhCloudPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportOvhCloudPost.RequiredProperties) {
...
TransportOvhCloudPost.RequiredProperties = ["ovhCloudApplicationKey", "ovhCloudApplicationSecret", "ovhCloudConsumerKey", "ovhCloudServiceName", "partition", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportOvhCloudPost.prototype['dataSegmentCode'] = undefined;

/**
 * The application key for the OVHcloud service.
 * @member {String} ovhCloudApplicationKey
 */
TransportOvhCloudPost.prototype['ovhCloudApplicationKey'] = undefined;

/**
 * The application secret for the OVHcloud service. Stored in encrypted format.
 * @member {String} ovhCloudApplicationSecret
 */
TransportOvhCloudPost.prototype['ovhCloudApplicationSecret'] = undefined;

/**
 * The consumer key for the OVHcloud service.
 * @member {String} ovhCloudConsumerKey
 */
TransportOvhCloudPost.prototype['ovhCloudConsumerKey'] = undefined;

/**
 * The optional sender for the OVHcloud service.
 * @member {String} ovhCloudSender
 */
TransportOvhCloudPost.prototype['ovhCloudSender'] = undefined;

/**
 * The service name for the OVHcloud service.
 * @member {String} ovhCloudServiceName
 */
TransportOvhCloudPost.prototype['ovhCloudServiceName'] = undefined;
 ...
 */
TransportOvhCloudPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportOvhCloudPost.prototype['transportName'] = undefined;
...
export default TransportOvhCloudPost;
