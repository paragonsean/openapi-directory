...
/**
 * The TransportWebhookJsonldPut model module.
 * @module model/TransportWebhookJsonldPut
 * @version 1.7.0
 */
class TransportWebhookJsonldPut {
    /**
     * Constructs a new <code>TransportWebhookJsonldPut</code>.
     ...
     * @alias module:model/TransportWebhookJsonldPut
    ...
    constructor(httpMethodCode, transportName, webhookUrl) { 
        ...
        TransportWebhookJsonldPut.initialize(this, httpMethodCode, transportName, webhookUrl);
    }
    ...
    /**
     * Constructs a <code>TransportWebhookJsonldPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportWebhookJsonldPut} obj Optional instance to populate.
     * @return {module:model/TransportWebhookJsonldPut} The populated <code>TransportWebhookJsonldPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportWebhookJsonldPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportWebhookJsonldPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportWebhookJsonldPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportWebhookJsonldPut.RequiredProperties) {
...
TransportWebhookJsonldPut.RequiredProperties = ["httpMethodCode", "transportName", "webhookUrl"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportWebhookJsonldPut.prototype['dataSegmentCode'] = undefined;

/**
 * The HTTP request method that must be used.
 * @member {String} httpMethodCode
 */
TransportWebhookJsonldPut.prototype['httpMethodCode'] = undefined;
 ...
 */
TransportWebhookJsonldPut.prototype['mustBeEncryptedValue'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportWebhookJsonldPut.prototype['transportName'] = undefined;
 ...
 */
TransportWebhookJsonldPut.prototype['webhookHeaders'] = undefined;

/**
 * The URL for the Webhook service.
 * @member {String} webhookUrl
 */
TransportWebhookJsonldPut.prototype['webhookUrl'] = undefined;
...
export default TransportWebhookJsonldPut;
