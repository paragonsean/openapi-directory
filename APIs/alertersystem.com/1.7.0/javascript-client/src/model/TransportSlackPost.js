...
/**
 * The TransportSlackPost model module.
 * @module model/TransportSlackPost
 * @version 1.7.0
 */
class TransportSlackPost {
    /**
     * Constructs a new <code>TransportSlackPost</code>.
     * The TransportSlack resource is a collection of transports that carry dispatched alerts to the external Slack service.
     * @alias module:model/TransportSlackPost
    ...
    constructor(partition, slackChannel, slackToken, transportName) { 
        ...
        TransportSlackPost.initialize(this, partition, slackChannel, slackToken, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportSlackPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportSlackPost} obj Optional instance to populate.
     * @return {module:model/TransportSlackPost} The populated <code>TransportSlackPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportSlackPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportSlackPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportSlackPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportSlackPost.RequiredProperties) {
...
TransportSlackPost.RequiredProperties = ["partition", "slackChannel", "slackToken", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportSlackPost.prototype['dataSegmentCode'] = undefined;
 ...
 */
TransportSlackPost.prototype['partition'] = undefined;
 ...
 */
TransportSlackPost.prototype['slackChannel'] = undefined;

/**
 * The token for the Slack service. Stored in encrypted format.
 * @member {String} slackToken
 */
TransportSlackPost.prototype['slackToken'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportSlackPost.prototype['transportName'] = undefined;
...
export default TransportSlackPost;
