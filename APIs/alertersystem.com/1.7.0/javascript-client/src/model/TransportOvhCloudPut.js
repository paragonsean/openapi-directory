...
/**
 * The TransportOvhCloudPut model module.
 * @module model/TransportOvhCloudPut
 * @version 1.7.0
 */
class TransportOvhCloudPut {
    /**
     * Constructs a new <code>TransportOvhCloudPut</code>.
     ...
     * @alias module:model/TransportOvhCloudPut
    ...
    constructor(ovhCloudApplicationKey, ovhCloudApplicationSecret, ovhCloudConsumerKey, ovhCloudServiceName, transportName) { 
        ...
        TransportOvhCloudPut.initialize(this, ovhCloudApplicationKey, ovhCloudApplicationSecret, ovhCloudConsumerKey, ovhCloudServiceName, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportOvhCloudPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportOvhCloudPut} obj Optional instance to populate.
     * @return {module:model/TransportOvhCloudPut} The populated <code>TransportOvhCloudPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportOvhCloudPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportOvhCloudPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportOvhCloudPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportOvhCloudPut.RequiredProperties) {
...
TransportOvhCloudPut.RequiredProperties = ["ovhCloudApplicationKey", "ovhCloudApplicationSecret", "ovhCloudConsumerKey", "ovhCloudServiceName", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportOvhCloudPut.prototype['dataSegmentCode'] = undefined;

/**
 * The application key for the OVHcloud service.
 * @member {String} ovhCloudApplicationKey
 */
TransportOvhCloudPut.prototype['ovhCloudApplicationKey'] = undefined;

/**
 * The application secret for the OVHcloud service. Stored in encrypted format.
 * @member {String} ovhCloudApplicationSecret
 */
TransportOvhCloudPut.prototype['ovhCloudApplicationSecret'] = undefined;

/**
 * The consumer key for the OVHcloud service.
 * @member {String} ovhCloudConsumerKey
 */
TransportOvhCloudPut.prototype['ovhCloudConsumerKey'] = undefined;

/**
 * The optional sender for the OVHcloud service.
 * @member {String} ovhCloudSender
 */
TransportOvhCloudPut.prototype['ovhCloudSender'] = undefined;

/**
 * The service name for the OVHcloud service.
 * @member {String} ovhCloudServiceName
 */
TransportOvhCloudPut.prototype['ovhCloudServiceName'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportOvhCloudPut.prototype['transportName'] = undefined;
...
export default TransportOvhCloudPut;
