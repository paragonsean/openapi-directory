...
/**
 * The TransportGoogleChatPut model module.
 * @module model/TransportGoogleChatPut
 * @version 1.7.0
 */
class TransportGoogleChatPut {
    /**
     * Constructs a new <code>TransportGoogleChatPut</code>.
     ...
     * @alias module:model/TransportGoogleChatPut
    ...
    constructor(googleChatAccessKey, googleChatAccessToken, googleChatSpace, transportName) { 
        ...
        TransportGoogleChatPut.initialize(this, googleChatAccessKey, googleChatAccessToken, googleChatSpace, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportGoogleChatPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportGoogleChatPut} obj Optional instance to populate.
     * @return {module:model/TransportGoogleChatPut} The populated <code>TransportGoogleChatPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportGoogleChatPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportGoogleChatPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportGoogleChatPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportGoogleChatPut.RequiredProperties) {
...
TransportGoogleChatPut.RequiredProperties = ["googleChatAccessKey", "googleChatAccessToken", "googleChatSpace", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportGoogleChatPut.prototype['dataSegmentCode'] = undefined;

/**
 * The access key for the Google Chat service.
 * @member {String} googleChatAccessKey
 */
TransportGoogleChatPut.prototype['googleChatAccessKey'] = undefined;

/**
 * The access token for the Google Chat service. Stored in encrypted format.
 * @member {String} googleChatAccessToken
 */
TransportGoogleChatPut.prototype['googleChatAccessToken'] = undefined;

/**
 * The space name for the Google Chat service.
 * @member {String} googleChatSpace
 */
TransportGoogleChatPut.prototype['googleChatSpace'] = undefined;

/**
 * The optional thread key for the Google Chat service.
 * @member {String} googleChatThreadKey
 */
TransportGoogleChatPut.prototype['googleChatThreadKey'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportGoogleChatPut.prototype['transportName'] = undefined;
...
export default TransportGoogleChatPut;
