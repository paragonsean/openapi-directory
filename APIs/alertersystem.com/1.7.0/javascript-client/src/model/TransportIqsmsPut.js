...
/**
 * The TransportIqsmsPut model module.
 * @module model/TransportIqsmsPut
 * @version 1.7.0
 */
class TransportIqsmsPut {
    /**
     * Constructs a new <code>TransportIqsmsPut</code>.
     * The TransportIqsms resource is a collection of transports that carry dispatched alerts to the external Iqsms service.
     * @alias module:model/TransportIqsmsPut
     ...
     */
    constructor(iqsmsFrom, iqsmsLogin, iqsmsPassword, transportName) { 
        
        TransportIqsmsPut.initialize(this, iqsmsFrom, iqsmsLogin, iqsmsPassword, transportName);
    }
     ...
     */
    static initialize(obj, iqsmsFrom, iqsmsLogin, iqsmsPassword, transportName) { 
    ...
    /**
     * Constructs a <code>TransportIqsmsPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportIqsmsPut} obj Optional instance to populate.
     * @return {module:model/TransportIqsmsPut} The populated <code>TransportIqsmsPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportIqsmsPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportIqsmsPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportIqsmsPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportIqsmsPut.RequiredProperties) {
...
TransportIqsmsPut.RequiredProperties = ["iqsmsFrom", "iqsmsLogin", "iqsmsPassword", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportIqsmsPut.prototype['dataSegmentCode'] = undefined;

/**
 * The sender value for the Iqsms service.
 * @member {String} iqsmsFrom
 */
TransportIqsmsPut.prototype['iqsmsFrom'] = undefined;

/**
 * The login for the Iqsms service.
 * @member {String} iqsmsLogin
 */
TransportIqsmsPut.prototype['iqsmsLogin'] = undefined;

/**
 * The password for the Iqsms service. Stored in encrypted format.
 * @member {String} iqsmsPassword
 */
TransportIqsmsPut.prototype['iqsmsPassword'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportIqsmsPut.prototype['transportName'] = undefined;
...
export default TransportIqsmsPut;
