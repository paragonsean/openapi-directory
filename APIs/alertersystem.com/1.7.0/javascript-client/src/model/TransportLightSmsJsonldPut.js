...
/**
 * The TransportLightSmsJsonldPut model module.
 * @module model/TransportLightSmsJsonldPut
 * @version 1.7.0
 */
class TransportLightSmsJsonldPut {
    /**
     * Constructs a new <code>TransportLightSmsJsonldPut</code>.
     ...
     * @alias module:model/TransportLightSmsJsonldPut
    ...
    constructor(lightSmsLogin, lightSmsPhone, lightSmsToken, transportName) { 
        ...
        TransportLightSmsJsonldPut.initialize(this, lightSmsLogin, lightSmsPhone, lightSmsToken, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportLightSmsJsonldPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportLightSmsJsonldPut} obj Optional instance to populate.
     * @return {module:model/TransportLightSmsJsonldPut} The populated <code>TransportLightSmsJsonldPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportLightSmsJsonldPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportLightSmsJsonldPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportLightSmsJsonldPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportLightSmsJsonldPut.RequiredProperties) {
...
TransportLightSmsJsonldPut.RequiredProperties = ["lightSmsLogin", "lightSmsPhone", "lightSmsToken", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportLightSmsJsonldPut.prototype['dataSegmentCode'] = undefined;

/**
 * The login for the LightSMS service.
 * @member {String} lightSmsLogin
 */
TransportLightSmsJsonldPut.prototype['lightSmsLogin'] = undefined;

/**
 * The sender phone number for the LightSMS service.
 * @member {String} lightSmsPhone
 */
TransportLightSmsJsonldPut.prototype['lightSmsPhone'] = undefined;

/**
 * The token for the LightSMS service. Stored in encrypted format.
 * @member {String} lightSmsToken
 */
TransportLightSmsJsonldPut.prototype['lightSmsToken'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportLightSmsJsonldPut.prototype['transportName'] = undefined;
...
export default TransportLightSmsJsonldPut;
