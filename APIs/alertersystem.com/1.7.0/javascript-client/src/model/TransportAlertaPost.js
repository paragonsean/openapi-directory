...
/**
 * The TransportAlertaPost model module.
 * @module model/TransportAlertaPost
 * @version 1.7.0
 */
class TransportAlertaPost {
    /**
     * Constructs a new <code>TransportAlertaPost</code>.
     * The TransportAlerta resource is a collection of transports that carry dispatched alerts to the external Alerta service.
     * @alias module:model/TransportAlertaPost
    ...
    constructor(alertaApiKey, alertaEvent, alertaHost, alertaResource, partition, transportName) { 
        ...
        TransportAlertaPost.initialize(this, alertaApiKey, alertaEvent, alertaHost, alertaResource, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportAlertaPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportAlertaPost} obj Optional instance to populate.
     * @return {module:model/TransportAlertaPost} The populated <code>TransportAlertaPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportAlertaPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportAlertaPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportAlertaPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportAlertaPost.RequiredProperties) {
 ...
 */
TransportAlertaPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportAlertaPost.prototype['transportName'] = undefined;
...
export default TransportAlertaPost;
