...
/**
 * The TransportLightSmsPut model module.
 * @module model/TransportLightSmsPut
 * @version 1.7.0
 */
class TransportLightSmsPut {
    /**
     * Constructs a new <code>TransportLightSmsPut</code>.
     ...
     * @alias module:model/TransportLightSmsPut
    ...
    constructor(lightSmsLogin, lightSmsPhone, lightSmsToken, transportName) { 
        ...
        TransportLightSmsPut.initialize(this, lightSmsLogin, lightSmsPhone, lightSmsToken, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportLightSmsPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportLightSmsPut} obj Optional instance to populate.
     * @return {module:model/TransportLightSmsPut} The populated <code>TransportLightSmsPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportLightSmsPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportLightSmsPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportLightSmsPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportLightSmsPut.RequiredProperties) {
...
TransportLightSmsPut.RequiredProperties = ["lightSmsLogin", "lightSmsPhone", "lightSmsToken", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportLightSmsPut.prototype['dataSegmentCode'] = undefined;

/**
 * The login for the LightSMS service.
 * @member {String} lightSmsLogin
 */
TransportLightSmsPut.prototype['lightSmsLogin'] = undefined;

/**
 * The sender phone number for the LightSMS service.
 * @member {String} lightSmsPhone
 */
TransportLightSmsPut.prototype['lightSmsPhone'] = undefined;

/**
 * The token for the LightSMS service. Stored in encrypted format.
 * @member {String} lightSmsToken
 */
TransportLightSmsPut.prototype['lightSmsToken'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportLightSmsPut.prototype['transportName'] = undefined;
...
export default TransportLightSmsPut;
