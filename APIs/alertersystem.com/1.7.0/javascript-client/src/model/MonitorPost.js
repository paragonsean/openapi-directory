...
/**
 * The MonitorPost model module.
 * @module model/MonitorPost
 * @version 1.7.0
 */
class MonitorPost {
    /**
     * Constructs a new <code>MonitorPost</code>.
     ...
     * @alias module:model/MonitorPost
    ...
    constructor(monitorName, monitorTypeCode, partition, timezoneCode) { 
        ...
        MonitorPost.initialize(this, monitorName, monitorTypeCode, partition, timezoneCode);
    }
    ...
    /**
     * Constructs a <code>MonitorPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MonitorPost} obj Optional instance to populate.
     * @return {module:model/MonitorPost} The populated <code>MonitorPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MonitorPost();
    ...
    /**
     * Validates the JSON data with respect to <code>MonitorPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MonitorPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MonitorPost.RequiredProperties) {
...
MonitorPost.RequiredProperties = ["monitorName", "monitorTypeCode", "partition", "timezoneCode"];
 ...
 */
MonitorPost.prototype['alertPayloadExtended'] = undefined;
 ...
 */
MonitorPost.prototype['contentCheckMustNotExist'] = undefined;
 ...
 */
MonitorPost.prototype['contentCheckXpathFilter'] = undefined;

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
MonitorPost.prototype['dataSegmentCode'] = undefined;
 ...
 */
MonitorPost.prototype['graceSeconds'] = undefined;
 ...
 */
MonitorPost.prototype['intervalDays'] = undefined;
 ...
 */
MonitorPost.prototype['intervalHours'] = undefined;
 ...
 */
MonitorPost.prototype['intervalMinutes'] = undefined;
 ...
 */
MonitorPost.prototype['intervalMonths'] = undefined;
 ...
 */
MonitorPost.prototype['intervalSeconds'] = undefined;
 ...
 */
MonitorPost.prototype['monitorNotes'] = undefined;

/**
 * The type of the monitor.
 * @member {String} monitorTypeCode
 */
MonitorPost.prototype['monitorTypeCode'] = undefined;
 ...
 */
MonitorPost.prototype['partition'] = undefined;
 ...
 */
MonitorPost.prototype['publicDescription'] = undefined;
