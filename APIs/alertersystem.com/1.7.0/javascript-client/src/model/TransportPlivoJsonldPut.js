...
/**
 * The TransportPlivoJsonldPut model module.
 * @module model/TransportPlivoJsonldPut
 * @version 1.7.0
 */
class TransportPlivoJsonldPut {
    /**
     * Constructs a new <code>TransportPlivoJsonldPut</code>.
     * The TransportPlivo resource is a collection of transports that carry dispatched alerts to the external Plivo service.
     * @alias module:model/TransportPlivoJsonldPut
    ...
    constructor(plivoAuthId, plivoAuthToken, plivoFrom, transportName) { 
        ...
        TransportPlivoJsonldPut.initialize(this, plivoAuthId, plivoAuthToken, plivoFrom, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportPlivoJsonldPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportPlivoJsonldPut} obj Optional instance to populate.
     * @return {module:model/TransportPlivoJsonldPut} The populated <code>TransportPlivoJsonldPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportPlivoJsonldPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportPlivoJsonldPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportPlivoJsonldPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportPlivoJsonldPut.RequiredProperties) {
...
TransportPlivoJsonldPut.RequiredProperties = ["plivoAuthId", "plivoAuthToken", "plivoFrom", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportPlivoJsonldPut.prototype['dataSegmentCode'] = undefined;

/**
 * The auth ID for the Plivo service.
 * @member {String} plivoAuthId
 */
TransportPlivoJsonldPut.prototype['plivoAuthId'] = undefined;

/**
 * The auth token for the Plivo service. Stored in encrypted format.
 * @member {String} plivoAuthToken
 */
TransportPlivoJsonldPut.prototype['plivoAuthToken'] = undefined;

/**
 * The sender value for the Plivo service.
 * @member {String} plivoFrom
 */
TransportPlivoJsonldPut.prototype['plivoFrom'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportPlivoJsonldPut.prototype['transportName'] = undefined;
...
export default TransportPlivoJsonldPut;
