...
/**
 * The TransportEmailGet model module.
 * @module model/TransportEmailGet
 * @version 1.7.0
 */
class TransportEmailGet {
    /**
     * Constructs a new <code>TransportEmailGet</code>.
     * The TransportEmail resource is a collection of transports that carry dispatched alerts to external SMTP email services.
     * @alias module:model/TransportEmailGet
    ...
    constructor(emailFromAddress, emailFromName, emailPassword, emailPort, emailServer, emailUsername, partition, transportName) { 
        ...
        TransportEmailGet.initialize(this, emailFromAddress, emailFromName, emailPassword, emailPort, emailServer, emailUsername, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportEmailGet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportEmailGet} obj Optional instance to populate.
     * @return {module:model/TransportEmailGet} The populated <code>TransportEmailGet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportEmailGet();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportEmailGet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportEmailGet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportEmailGet.RequiredProperties) {
 ...
 */
TransportEmailGet.prototype['partition'] = undefined;

/**
 * The name of the person who owns this resource.
 * @member {String} resourceOwner
 */
TransportEmailGet.prototype['resourceOwner'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportEmailGet.prototype['transportName'] = undefined;
...
export default TransportEmailGet;
