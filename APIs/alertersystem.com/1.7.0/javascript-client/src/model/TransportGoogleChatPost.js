...
/**
 * The TransportGoogleChatPost model module.
 * @module model/TransportGoogleChatPost
 * @version 1.7.0
 */
class TransportGoogleChatPost {
    /**
     * Constructs a new <code>TransportGoogleChatPost</code>.
     ...
     * @alias module:model/TransportGoogleChatPost
    ...
    constructor(googleChatAccessKey, googleChatAccessToken, googleChatSpace, partition, transportName) { 
        ...
        TransportGoogleChatPost.initialize(this, googleChatAccessKey, googleChatAccessToken, googleChatSpace, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportGoogleChatPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportGoogleChatPost} obj Optional instance to populate.
     * @return {module:model/TransportGoogleChatPost} The populated <code>TransportGoogleChatPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportGoogleChatPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportGoogleChatPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportGoogleChatPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportGoogleChatPost.RequiredProperties) {
...
TransportGoogleChatPost.RequiredProperties = ["googleChatAccessKey", "googleChatAccessToken", "googleChatSpace", "partition", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportGoogleChatPost.prototype['dataSegmentCode'] = undefined;

/**
 * The access key for the Google Chat service.
 * @member {String} googleChatAccessKey
 */
TransportGoogleChatPost.prototype['googleChatAccessKey'] = undefined;

/**
 * The access token for the Google Chat service. Stored in encrypted format.
 * @member {String} googleChatAccessToken
 */
TransportGoogleChatPost.prototype['googleChatAccessToken'] = undefined;

/**
 * The space name for the Google Chat service.
 * @member {String} googleChatSpace
 */
TransportGoogleChatPost.prototype['googleChatSpace'] = undefined;

/**
 * The optional thread key for the Google Chat service.
 * @member {String} googleChatThreadKey
 */
TransportGoogleChatPost.prototype['googleChatThreadKey'] = undefined;
 ...
 */
TransportGoogleChatPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportGoogleChatPost.prototype['transportName'] = undefined;
...
export default TransportGoogleChatPost;
