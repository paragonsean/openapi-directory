...
/**
 * The TransportOctopushPatch model module.
 * @module model/TransportOctopushPatch
 * @version 1.7.0
 */
class TransportOctopushPatch {
    /**
     * Constructs a new <code>TransportOctopushPatch</code>.
     ...
     * @alias module:model/TransportOctopushPatch
    ...
    constructor(octopushApiKey, octopushFrom, octopushType, octopushUserLogin, transportName) { 
        ...
        TransportOctopushPatch.initialize(this, octopushApiKey, octopushFrom, octopushType, octopushUserLogin, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportOctopushPatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportOctopushPatch} obj Optional instance to populate.
     * @return {module:model/TransportOctopushPatch} The populated <code>TransportOctopushPatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportOctopushPatch();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportOctopushPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportOctopushPatch</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportOctopushPatch.RequiredProperties) {
...
TransportOctopushPatch.RequiredProperties = ["octopushApiKey", "octopushFrom", "octopushType", "octopushUserLogin", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportOctopushPatch.prototype['dataSegmentCode'] = undefined;

/**
 * The API key for the Octopush service. Stored in encrypted format.
 * @member {String} octopushApiKey
 */
TransportOctopushPatch.prototype['octopushApiKey'] = undefined;

/**
 * The sender value for the Octopush service.
 * @member {String} octopushFrom
 */
TransportOctopushPatch.prototype['octopushFrom'] = undefined;

/**
 * The SMS type ('XXX' = SMS LowCost; 'FR' = SMS Premium; 'WWW' = SMS World) for the Octopush service.
 * @member {String} octopushType
 */
TransportOctopushPatch.prototype['octopushType'] = undefined;

/**
 * The user login (email) for the Octopush service.
 * @member {String} octopushUserLogin
 */
TransportOctopushPatch.prototype['octopushUserLogin'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportOctopushPatch.prototype['transportName'] = undefined;
...
export default TransportOctopushPatch;
