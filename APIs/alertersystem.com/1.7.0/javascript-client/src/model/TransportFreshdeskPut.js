...
/**
 * The TransportFreshdeskPut model module.
 * @module model/TransportFreshdeskPut
 * @version 1.7.0
 */
class TransportFreshdeskPut {
    /**
     * Constructs a new <code>TransportFreshdeskPut</code>.
     ...
     * @alias module:model/TransportFreshdeskPut
    ...
    constructor(freshdeskApiKey, freshdeskEmail, freshdeskHost, transportName) { 
        ...
        TransportFreshdeskPut.initialize(this, freshdeskApiKey, freshdeskEmail, freshdeskHost, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportFreshdeskPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportFreshdeskPut} obj Optional instance to populate.
     * @return {module:model/TransportFreshdeskPut} The populated <code>TransportFreshdeskPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportFreshdeskPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportFreshdeskPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportFreshdeskPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportFreshdeskPut.RequiredProperties) {
...
TransportFreshdeskPut.RequiredProperties = ["freshdeskApiKey", "freshdeskEmail", "freshdeskHost", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportFreshdeskPut.prototype['dataSegmentCode'] = undefined;

/**
 * The API key for the Freshdesk service. Stored in encrypted format.
 * @member {String} freshdeskApiKey
 */
TransportFreshdeskPut.prototype['freshdeskApiKey'] = undefined;

/**
 * The requester email address for the Freshdesk service.
 * @member {String} freshdeskEmail
 */
TransportFreshdeskPut.prototype['freshdeskEmail'] = undefined;

/**
 * The host name for the Freshdesk service (domain.freshdesk.com).
 * @member {String} freshdeskHost
 */
TransportFreshdeskPut.prototype['freshdeskHost'] = undefined;

/**
 * The ticket priority for the Freshdesk service.
 * @member {String} freshdeskPriority
 */
TransportFreshdeskPut.prototype['freshdeskPriority'] = undefined;

/**
 * The ticket type for the Freshdesk service.
 * @member {String} freshdeskType
 */
TransportFreshdeskPut.prototype['freshdeskType'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportFreshdeskPut.prototype['transportName'] = undefined;
...
export default TransportFreshdeskPut;
