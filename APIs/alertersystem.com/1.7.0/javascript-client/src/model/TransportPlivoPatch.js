...
/**
 * The TransportPlivoPatch model module.
 * @module model/TransportPlivoPatch
 * @version 1.7.0
 */
class TransportPlivoPatch {
    /**
     * Constructs a new <code>TransportPlivoPatch</code>.
     * The TransportPlivo resource is a collection of transports that carry dispatched alerts to the external Plivo service.
     * @alias module:model/TransportPlivoPatch
    ...
    constructor(plivoAuthId, plivoAuthToken, plivoFrom, transportName) { 
        ...
        TransportPlivoPatch.initialize(this, plivoAuthId, plivoAuthToken, plivoFrom, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportPlivoPatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportPlivoPatch} obj Optional instance to populate.
     * @return {module:model/TransportPlivoPatch} The populated <code>TransportPlivoPatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportPlivoPatch();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportPlivoPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportPlivoPatch</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportPlivoPatch.RequiredProperties) {
...
TransportPlivoPatch.RequiredProperties = ["plivoAuthId", "plivoAuthToken", "plivoFrom", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportPlivoPatch.prototype['dataSegmentCode'] = undefined;

/**
 * The auth ID for the Plivo service.
 * @member {String} plivoAuthId
 */
TransportPlivoPatch.prototype['plivoAuthId'] = undefined;

/**
 * The auth token for the Plivo service. Stored in encrypted format.
 * @member {String} plivoAuthToken
 */
TransportPlivoPatch.prototype['plivoAuthToken'] = undefined;

/**
 * The sender value for the Plivo service.
 * @member {String} plivoFrom
 */
TransportPlivoPatch.prototype['plivoFrom'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportPlivoPatch.prototype['transportName'] = undefined;
...
export default TransportPlivoPatch;
