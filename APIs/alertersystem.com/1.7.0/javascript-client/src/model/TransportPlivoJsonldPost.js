...
/**
 * The TransportPlivoJsonldPost model module.
 * @module model/TransportPlivoJsonldPost
 * @version 1.7.0
 */
class TransportPlivoJsonldPost {
    /**
     * Constructs a new <code>TransportPlivoJsonldPost</code>.
     * The TransportPlivo resource is a collection of transports that carry dispatched alerts to the external Plivo service.
     * @alias module:model/TransportPlivoJsonldPost
    ...
    constructor(partition, plivoAuthId, plivoAuthToken, plivoFrom, transportName) { 
        ...
        TransportPlivoJsonldPost.initialize(this, partition, plivoAuthId, plivoAuthToken, plivoFrom, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportPlivoJsonldPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportPlivoJsonldPost} obj Optional instance to populate.
     * @return {module:model/TransportPlivoJsonldPost} The populated <code>TransportPlivoJsonldPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportPlivoJsonldPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportPlivoJsonldPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportPlivoJsonldPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportPlivoJsonldPost.RequiredProperties) {
...
TransportPlivoJsonldPost.RequiredProperties = ["partition", "plivoAuthId", "plivoAuthToken", "plivoFrom", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportPlivoJsonldPost.prototype['dataSegmentCode'] = undefined;
 ...
 */
TransportPlivoJsonldPost.prototype['partition'] = undefined;

/**
 * The auth ID for the Plivo service.
 * @member {String} plivoAuthId
 */
TransportPlivoJsonldPost.prototype['plivoAuthId'] = undefined;

/**
 * The auth token for the Plivo service. Stored in encrypted format.
 * @member {String} plivoAuthToken
 */
TransportPlivoJsonldPost.prototype['plivoAuthToken'] = undefined;

/**
 * The sender value for the Plivo service.
 * @member {String} plivoFrom
 */
TransportPlivoJsonldPost.prototype['plivoFrom'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportPlivoJsonldPost.prototype['transportName'] = undefined;
...
export default TransportPlivoJsonldPost;
