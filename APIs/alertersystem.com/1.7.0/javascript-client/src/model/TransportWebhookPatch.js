...
/**
 * The TransportWebhookPatch model module.
 * @module model/TransportWebhookPatch
 * @version 1.7.0
 */
class TransportWebhookPatch {
    /**
     * Constructs a new <code>TransportWebhookPatch</code>.
     ...
     * @alias module:model/TransportWebhookPatch
    ...
    constructor(httpMethodCode, transportName, webhookUrl) { 
        ...
        TransportWebhookPatch.initialize(this, httpMethodCode, transportName, webhookUrl);
    }
    ...
    /**
     * Constructs a <code>TransportWebhookPatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportWebhookPatch} obj Optional instance to populate.
     * @return {module:model/TransportWebhookPatch} The populated <code>TransportWebhookPatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportWebhookPatch();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportWebhookPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportWebhookPatch</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportWebhookPatch.RequiredProperties) {
...
TransportWebhookPatch.RequiredProperties = ["httpMethodCode", "transportName", "webhookUrl"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportWebhookPatch.prototype['dataSegmentCode'] = undefined;

/**
 * The HTTP request method that must be used.
 * @member {String} httpMethodCode
 */
TransportWebhookPatch.prototype['httpMethodCode'] = undefined;
 ...
 */
TransportWebhookPatch.prototype['mustBeEncryptedValue'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportWebhookPatch.prototype['transportName'] = undefined;
 ...
 */
TransportWebhookPatch.prototype['webhookHeaders'] = undefined;

/**
 * The URL for the Webhook service.
 * @member {String} webhookUrl
 */
TransportWebhookPatch.prototype['webhookUrl'] = undefined;
...
export default TransportWebhookPatch;
