...
/**
 * The TransportWebhookPost model module.
 * @module model/TransportWebhookPost
 * @version 1.7.0
 */
class TransportWebhookPost {
    /**
     * Constructs a new <code>TransportWebhookPost</code>.
     ...
     * @alias module:model/TransportWebhookPost
    ...
    constructor(httpMethodCode, partition, transportName, webhookUrl) { 
        ...
        TransportWebhookPost.initialize(this, httpMethodCode, partition, transportName, webhookUrl);
    }
    ...
    /**
     * Constructs a <code>TransportWebhookPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportWebhookPost} obj Optional instance to populate.
     * @return {module:model/TransportWebhookPost} The populated <code>TransportWebhookPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportWebhookPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportWebhookPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportWebhookPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportWebhookPost.RequiredProperties) {
...
TransportWebhookPost.RequiredProperties = ["httpMethodCode", "partition", "transportName", "webhookUrl"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportWebhookPost.prototype['dataSegmentCode'] = undefined;

/**
 * The HTTP request method that must be used.
 * @member {String} httpMethodCode
 */
TransportWebhookPost.prototype['httpMethodCode'] = undefined;
 ...
 */
TransportWebhookPost.prototype['mustBeEncryptedValue'] = undefined;
 ...
 */
TransportWebhookPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportWebhookPost.prototype['transportName'] = undefined;
 ...
 */
TransportWebhookPost.prototype['webhookHeaders'] = undefined;

/**
 * The URL for the Webhook service.
 * @member {String} webhookUrl
 */
TransportWebhookPost.prototype['webhookUrl'] = undefined;
...
export default TransportWebhookPost;
