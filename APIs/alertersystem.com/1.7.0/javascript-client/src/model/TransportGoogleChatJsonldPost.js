...
/**
 * The TransportGoogleChatJsonldPost model module.
 * @module model/TransportGoogleChatJsonldPost
 * @version 1.7.0
 */
class TransportGoogleChatJsonldPost {
    /**
     * Constructs a new <code>TransportGoogleChatJsonldPost</code>.
     ...
     * @alias module:model/TransportGoogleChatJsonldPost
    ...
    constructor(googleChatAccessKey, googleChatAccessToken, googleChatSpace, partition, transportName) { 
        ...
        TransportGoogleChatJsonldPost.initialize(this, googleChatAccessKey, googleChatAccessToken, googleChatSpace, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportGoogleChatJsonldPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportGoogleChatJsonldPost} obj Optional instance to populate.
     * @return {module:model/TransportGoogleChatJsonldPost} The populated <code>TransportGoogleChatJsonldPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportGoogleChatJsonldPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportGoogleChatJsonldPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportGoogleChatJsonldPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportGoogleChatJsonldPost.RequiredProperties) {
...
TransportGoogleChatJsonldPost.RequiredProperties = ["googleChatAccessKey", "googleChatAccessToken", "googleChatSpace", "partition", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportGoogleChatJsonldPost.prototype['dataSegmentCode'] = undefined;

/**
 * The access key for the Google Chat service.
 * @member {String} googleChatAccessKey
 */
TransportGoogleChatJsonldPost.prototype['googleChatAccessKey'] = undefined;

/**
 * The access token for the Google Chat service. Stored in encrypted format.
 * @member {String} googleChatAccessToken
 */
TransportGoogleChatJsonldPost.prototype['googleChatAccessToken'] = undefined;

/**
 * The space name for the Google Chat service.
 * @member {String} googleChatSpace
 */
TransportGoogleChatJsonldPost.prototype['googleChatSpace'] = undefined;

/**
 * The optional thread key for the Google Chat service.
 * @member {String} googleChatThreadKey
 */
TransportGoogleChatJsonldPost.prototype['googleChatThreadKey'] = undefined;
 ...
 */
TransportGoogleChatJsonldPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportGoogleChatJsonldPost.prototype['transportName'] = undefined;
...
export default TransportGoogleChatJsonldPost;
