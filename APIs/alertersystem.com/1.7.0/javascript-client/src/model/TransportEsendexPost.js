...
/**
 * The TransportEsendexPost model module.
 * @module model/TransportEsendexPost
 * @version 1.7.0
 */
class TransportEsendexPost {
    /**
     * Constructs a new <code>TransportEsendexPost</code>.
     * The TransportEsendex resource is a collection of transports that carry dispatched alerts to the external Esendex service.
     * @alias module:model/TransportEsendexPost
    ...
    constructor(esendexAccountReference, esendexFrom, esendexPassword, esendexUsername, partition, transportName) { 
        ...
        TransportEsendexPost.initialize(this, esendexAccountReference, esendexFrom, esendexPassword, esendexUsername, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportEsendexPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportEsendexPost} obj Optional instance to populate.
     * @return {module:model/TransportEsendexPost} The populated <code>TransportEsendexPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportEsendexPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportEsendexPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportEsendexPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportEsendexPost.RequiredProperties) {
 ...
 */
TransportEsendexPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportEsendexPost.prototype['transportName'] = undefined;
...
export default TransportEsendexPost;
