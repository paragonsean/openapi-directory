...
/**
 * The TransportLightSmsGet model module.
 * @module model/TransportLightSmsGet
 * @version 1.7.0
 */
class TransportLightSmsGet {
    /**
     * Constructs a new <code>TransportLightSmsGet</code>.
     ...
     * @alias module:model/TransportLightSmsGet
    ...
    constructor(lightSmsLogin, lightSmsPhone, lightSmsToken, partition, transportName) { 
        ...
        TransportLightSmsGet.initialize(this, lightSmsLogin, lightSmsPhone, lightSmsToken, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportLightSmsGet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportLightSmsGet} obj Optional instance to populate.
     * @return {module:model/TransportLightSmsGet} The populated <code>TransportLightSmsGet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportLightSmsGet();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportLightSmsGet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportLightSmsGet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportLightSmsGet.RequiredProperties) {
...
TransportLightSmsGet.RequiredProperties = ["lightSmsLogin", "lightSmsPhone", "lightSmsToken", "partition", "transportName"];

/**
 * When the resource instance was created. This date-time is in the UTC timezone.
 * @member {Date} createdAt
 */
TransportLightSmsGet.prototype['createdAt'] = undefined;

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportLightSmsGet.prototype['dataSegmentCode'] = undefined;

/**
 * The unique identifier of the resource instance.
 * @member {String} id
 */
TransportLightSmsGet.prototype['id'] = undefined;

/**
 * The login for the LightSMS service.
 * @member {String} lightSmsLogin
 */
TransportLightSmsGet.prototype['lightSmsLogin'] = undefined;

/**
 * The sender phone number for the LightSMS service.
 * @member {String} lightSmsPhone
 */
TransportLightSmsGet.prototype['lightSmsPhone'] = undefined;

/**
 * The token for the LightSMS service. Stored in encrypted format.
 * @member {String} lightSmsToken
 */
TransportLightSmsGet.prototype['lightSmsToken'] = undefined;
 ...
 */
TransportLightSmsGet.prototype['partition'] = undefined;

/**
 * The name of the person who owns this resource.
 * @member {String} resourceOwner
 */
TransportLightSmsGet.prototype['resourceOwner'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportLightSmsGet.prototype['transportName'] = undefined;
...
export default TransportLightSmsGet;
