...
/**
 * The TransportSinchPut model module.
 * @module model/TransportSinchPut
 * @version 1.7.0
 */
class TransportSinchPut {
    /**
     * Constructs a new <code>TransportSinchPut</code>.
     * The TransportSinch resource is a collection of transports that carry dispatched alerts to the external Sinch service.
     * @alias module:model/TransportSinchPut
    ...
    constructor(sinchAuthToken, sinchFrom, sinchServicePlanId, transportName) { 
        ...
        TransportSinchPut.initialize(this, sinchAuthToken, sinchFrom, sinchServicePlanId, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportSinchPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportSinchPut} obj Optional instance to populate.
     * @return {module:model/TransportSinchPut} The populated <code>TransportSinchPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportSinchPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportSinchPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportSinchPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportSinchPut.RequiredProperties) {
...
TransportSinchPut.RequiredProperties = ["sinchAuthToken", "sinchFrom", "sinchServicePlanId", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportSinchPut.prototype['dataSegmentCode'] = undefined;

/**
 * The auth token for the Sinch service. Stored in encrypted format.
 * @member {String} sinchAuthToken
 */
TransportSinchPut.prototype['sinchAuthToken'] = undefined;

/**
 * The sender for the Sinch service.
 * @member {String} sinchFrom
 */
TransportSinchPut.prototype['sinchFrom'] = undefined;

/**
 * The service plan ID for the Sinch service.
 * @member {String} sinchServicePlanId
 */
TransportSinchPut.prototype['sinchServicePlanId'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportSinchPut.prototype['transportName'] = undefined;
...
export default TransportSinchPut;
