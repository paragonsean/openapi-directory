...
/**
 * The TransportOctopushPost model module.
 * @module model/TransportOctopushPost
 * @version 1.7.0
 */
class TransportOctopushPost {
    /**
     * Constructs a new <code>TransportOctopushPost</code>.
     ...
     * @alias module:model/TransportOctopushPost
    ...
    constructor(octopushApiKey, octopushFrom, octopushType, octopushUserLogin, partition, transportName) { 
        ...
        TransportOctopushPost.initialize(this, octopushApiKey, octopushFrom, octopushType, octopushUserLogin, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportOctopushPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportOctopushPost} obj Optional instance to populate.
     * @return {module:model/TransportOctopushPost} The populated <code>TransportOctopushPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportOctopushPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportOctopushPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportOctopushPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportOctopushPost.RequiredProperties) {
...
TransportOctopushPost.RequiredProperties = ["octopushApiKey", "octopushFrom", "octopushType", "octopushUserLogin", "partition", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportOctopushPost.prototype['dataSegmentCode'] = undefined;

/**
 * The API key for the Octopush service. Stored in encrypted format.
 * @member {String} octopushApiKey
 */
TransportOctopushPost.prototype['octopushApiKey'] = undefined;

/**
 * The sender value for the Octopush service.
 * @member {String} octopushFrom
 */
TransportOctopushPost.prototype['octopushFrom'] = undefined;

/**
 * The SMS type ('XXX' = SMS LowCost; 'FR' = SMS Premium; 'WWW' = SMS World) for the Octopush service.
 * @member {String} octopushType
 */
TransportOctopushPost.prototype['octopushType'] = undefined;

/**
 * The user login (email) for the Octopush service.
 * @member {String} octopushUserLogin
 */
TransportOctopushPost.prototype['octopushUserLogin'] = undefined;
 ...
 */
TransportOctopushPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportOctopushPost.prototype['transportName'] = undefined;
...
export default TransportOctopushPost;
