...
/**
 * The MonitorJsonldPost model module.
 * @module model/MonitorJsonldPost
 * @version 1.7.0
 */
class MonitorJsonldPost {
    /**
     * Constructs a new <code>MonitorJsonldPost</code>.
     ...
     * @alias module:model/MonitorJsonldPost
    ...
    constructor(monitorName, monitorTypeCode, partition, timezoneCode) { 
        ...
        MonitorJsonldPost.initialize(this, monitorName, monitorTypeCode, partition, timezoneCode);
    }
    ...
    /**
     * Constructs a <code>MonitorJsonldPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MonitorJsonldPost} obj Optional instance to populate.
     * @return {module:model/MonitorJsonldPost} The populated <code>MonitorJsonldPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MonitorJsonldPost();
    ...
    /**
     * Validates the JSON data with respect to <code>MonitorJsonldPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MonitorJsonldPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MonitorJsonldPost.RequiredProperties) {
...
MonitorJsonldPost.RequiredProperties = ["monitorName", "monitorTypeCode", "partition", "timezoneCode"];
 ...
 */
MonitorJsonldPost.prototype['alertPayloadExtended'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['contentCheckMustNotExist'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['contentCheckXpathFilter'] = undefined;

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
MonitorJsonldPost.prototype['dataSegmentCode'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['graceSeconds'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['intervalDays'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['intervalHours'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['intervalMinutes'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['intervalMonths'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['intervalSeconds'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['monitorNotes'] = undefined;

/**
 * The type of the monitor.
 * @member {String} monitorTypeCode
 */
MonitorJsonldPost.prototype['monitorTypeCode'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['partition'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['publicDescription'] = undefined;
 ...
 */
MonitorJsonldPost.prototype['webResponseSecondsLimit'] = undefined;

/**
 * The URL that the Web Response monitor type must evaluate for the specified conditions.
 * @member {String} webResponseUrl
 */
MonitorJsonldPost.prototype['webResponseUrl'] = undefined;
...
export default MonitorJsonldPost;
