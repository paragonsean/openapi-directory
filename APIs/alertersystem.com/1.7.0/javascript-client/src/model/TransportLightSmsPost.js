...
/**
 * The TransportLightSmsPost model module.
 * @module model/TransportLightSmsPost
 * @version 1.7.0
 */
class TransportLightSmsPost {
    /**
     * Constructs a new <code>TransportLightSmsPost</code>.
     ...
     * @alias module:model/TransportLightSmsPost
    ...
    constructor(lightSmsLogin, lightSmsPhone, lightSmsToken, partition, transportName) { 
        ...
        TransportLightSmsPost.initialize(this, lightSmsLogin, lightSmsPhone, lightSmsToken, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportLightSmsPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportLightSmsPost} obj Optional instance to populate.
     * @return {module:model/TransportLightSmsPost} The populated <code>TransportLightSmsPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportLightSmsPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportLightSmsPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportLightSmsPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportLightSmsPost.RequiredProperties) {
...
TransportLightSmsPost.RequiredProperties = ["lightSmsLogin", "lightSmsPhone", "lightSmsToken", "partition", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportLightSmsPost.prototype['dataSegmentCode'] = undefined;

/**
 * The login for the LightSMS service.
 * @member {String} lightSmsLogin
 */
TransportLightSmsPost.prototype['lightSmsLogin'] = undefined;

/**
 * The sender phone number for the LightSMS service.
 * @member {String} lightSmsPhone
 */
TransportLightSmsPost.prototype['lightSmsPhone'] = undefined;

/**
 * The token for the LightSMS service. Stored in encrypted format.
 * @member {String} lightSmsToken
 */
TransportLightSmsPost.prototype['lightSmsToken'] = undefined;
 ...
 */
TransportLightSmsPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportLightSmsPost.prototype['transportName'] = undefined;
...
export default TransportLightSmsPost;
