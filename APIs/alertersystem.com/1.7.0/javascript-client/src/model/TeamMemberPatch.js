...
/**
 * The TeamMemberPatch model module.
 * @module model/TeamMemberPatch
 * @version 1.7.0
 */
class TeamMemberPatch {
    /**
     * Constructs a new <code>TeamMemberPatch</code>.
     * The TeamMember resource is a collection of active team members of the partitions in a user account.
     * @alias module:model/TeamMemberPatch
     * @param teamMemberRoleCode {String} The role of the team member on the team.
     */
    constructor(teamMemberRoleCode) { 
        
        TeamMemberPatch.initialize(this, teamMemberRoleCode);
    }
    ...
    /**
     * Constructs a <code>TeamMemberPatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TeamMemberPatch} obj Optional instance to populate.
     * @return {module:model/TeamMemberPatch} The populated <code>TeamMemberPatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TeamMemberPatch();
    ...
    /**
     * Validates the JSON data with respect to <code>TeamMemberPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TeamMemberPatch</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TeamMemberPatch.RequiredProperties) {
...
TeamMemberPatch.RequiredProperties = ["teamMemberRoleCode"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TeamMemberPatch.prototype['dataSegmentCode'] = undefined;

/**
 * The role of the team member on the team.
 * @member {String} teamMemberRoleCode
 */
TeamMemberPatch.prototype['teamMemberRoleCode'] = undefined;
...
export default TeamMemberPatch;
