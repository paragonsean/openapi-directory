...
/**
 * The TransportAlertaJsonldGet model module.
 * @module model/TransportAlertaJsonldGet
 * @version 1.7.0
 */
class TransportAlertaJsonldGet {
    /**
     * Constructs a new <code>TransportAlertaJsonldGet</code>.
     * The TransportAlerta resource is a collection of transports that carry dispatched alerts to the external Alerta service.
     * @alias module:model/TransportAlertaJsonldGet
    ...
    constructor(alertaApiKey, alertaEvent, alertaHost, alertaResource, partition, transportName) { 
        ...
        TransportAlertaJsonldGet.initialize(this, alertaApiKey, alertaEvent, alertaHost, alertaResource, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportAlertaJsonldGet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportAlertaJsonldGet} obj Optional instance to populate.
     * @return {module:model/TransportAlertaJsonldGet} The populated <code>TransportAlertaJsonldGet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportAlertaJsonldGet();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportAlertaJsonldGet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportAlertaJsonldGet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportAlertaJsonldGet.RequiredProperties) {
...
TransportAlertaJsonldGet.RequiredProperties = ["alertaApiKey", "alertaEvent", "alertaHost", "alertaResource", "partition", "transportName"];

/**
 * @member {module:model/AlertLogJsonldGetContext} @context
 */
TransportAlertaJsonldGet.prototype['@context'] = undefined;

/**
 * @member {String} @id
 */
TransportAlertaJsonldGet.prototype['@id'] = undefined;

/**
 * @member {String} @type
 */
TransportAlertaJsonldGet.prototype['@type'] = undefined;

/**
 * The API key for the Alerta service.
 * @member {String} alertaApiKey
 */
TransportAlertaJsonldGet.prototype['alertaApiKey'] = undefined;

/**
 * The comma-separated list of related event names for the Alerta service.
 * @member {String} alertaCorrelate
 */
TransportAlertaJsonldGet.prototype['alertaCorrelate'] = undefined;

/**
 * The environment value for the Alerta service.
 * @member {String} alertaEnvironment
 */
TransportAlertaJsonldGet.prototype['alertaEnvironment'] = undefined;

/**
 * The event value for the Alerta service.
 * @member {String} alertaEvent
 */
TransportAlertaJsonldGet.prototype['alertaEvent'] = undefined;

/**
 * The group value for the Alerta service.
 * @member {String} alertaGroup
 */
TransportAlertaJsonldGet.prototype['alertaGroup'] = undefined;

/**
 * The host name for the Alerta service (omit the \"https://\" part).
 * @member {String} alertaHost
 */
TransportAlertaJsonldGet.prototype['alertaHost'] = undefined;

/**
 * The origin value for the Alerta service.
 * @member {String} alertaOrigin
 */
TransportAlertaJsonldGet.prototype['alertaOrigin'] = undefined;

/**
 * The resource value for the Alerta service.
 * @member {String} alertaResource
 */
TransportAlertaJsonldGet.prototype['alertaResource'] = undefined;

/**
 * The comma-separated list of affected services for the Alerta service.
 * @member {String} alertaService
 */
TransportAlertaJsonldGet.prototype['alertaService'] = undefined;

/**
 * The severity value for the Alerta service.
 * @member {String} alertaSeverity
 */
TransportAlertaJsonldGet.prototype['alertaSeverity'] = undefined;

/**
 * The status value for the Alerta service.
 * @member {String} alertaStatus
 */
TransportAlertaJsonldGet.prototype['alertaStatus'] = undefined;

/**
 * The comma-separated list of tags for the Alerta service.
 * @member {String} alertaTags
 */
TransportAlertaJsonldGet.prototype['alertaTags'] = undefined;

/**
 * The type value for the Alerta service.
 * @member {String} alertaType
 */
TransportAlertaJsonldGet.prototype['alertaType'] = undefined;

/**
 * When the resource instance was created. This date-time is in the UTC timezone.
 * @member {Date} createdAt
 */
TransportAlertaJsonldGet.prototype['createdAt'] = undefined;

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportAlertaJsonldGet.prototype['dataSegmentCode'] = undefined;
 ...
 */
TransportAlertaJsonldGet.prototype['partition'] = undefined;

/**
 * The name of the person who owns this resource.
 * @member {String} resourceOwner
 */
TransportAlertaJsonldGet.prototype['resourceOwner'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportAlertaJsonldGet.prototype['transportName'] = undefined;
...
export default TransportAlertaJsonldGet;
