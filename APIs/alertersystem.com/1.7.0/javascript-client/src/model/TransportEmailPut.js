...
/**
 * The TransportEmailPut model module.
 * @module model/TransportEmailPut
 * @version 1.7.0
 */
class TransportEmailPut {
    /**
     * Constructs a new <code>TransportEmailPut</code>.
     * The TransportEmail resource is a collection of transports that carry dispatched alerts to external SMTP email services.
     * @alias module:model/TransportEmailPut
    ...
    constructor(emailFromAddress, emailFromName, emailPassword, emailPort, emailServer, emailUsername, transportName) { 
        ...
        TransportEmailPut.initialize(this, emailFromAddress, emailFromName, emailPassword, emailPort, emailServer, emailUsername, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportEmailPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportEmailPut} obj Optional instance to populate.
     * @return {module:model/TransportEmailPut} The populated <code>TransportEmailPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportEmailPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportEmailPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportEmailPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportEmailPut.RequiredProperties) {
...
TransportEmailPut.RequiredProperties = ["emailFromAddress", "emailFromName", "emailPassword", "emailPort", "emailServer", "emailUsername", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportEmailPut.prototype['dataSegmentCode'] = undefined;

/**
 * The sender email address for the SMTP Email service.
 * @member {String} emailFromAddress
 */
TransportEmailPut.prototype['emailFromAddress'] = undefined;

/**
 * The sender name for the SMTP Email service.
 * @member {String} emailFromName
 */
TransportEmailPut.prototype['emailFromName'] = undefined;

/**
 * The password for the SMTP Email service. Stored in encrypted format.
 * @member {String} emailPassword
 */
TransportEmailPut.prototype['emailPassword'] = undefined;

/**
 * The port for the SMTP Email service.
 * @member {Number} emailPort
 */
TransportEmailPut.prototype['emailPort'] = undefined;

/**
 * The server for the SMTP Email service.
 * @member {String} emailServer
 */
TransportEmailPut.prototype['emailServer'] = undefined;

/**
 * The username for the SMTP Email service.
 * @member {String} emailUsername
 */
TransportEmailPut.prototype['emailUsername'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportEmailPut.prototype['transportName'] = undefined;
...
export default TransportEmailPut;
