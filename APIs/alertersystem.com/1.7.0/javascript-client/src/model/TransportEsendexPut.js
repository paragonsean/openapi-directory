...
/**
 * The TransportEsendexPut model module.
 * @module model/TransportEsendexPut
 * @version 1.7.0
 */
class TransportEsendexPut {
    /**
     * Constructs a new <code>TransportEsendexPut</code>.
     * The TransportEsendex resource is a collection of transports that carry dispatched alerts to the external Esendex service.
     * @alias module:model/TransportEsendexPut
    ...
    constructor(esendexAccountReference, esendexFrom, esendexPassword, esendexUsername, transportName) { 
        ...
        TransportEsendexPut.initialize(this, esendexAccountReference, esendexFrom, esendexPassword, esendexUsername, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportEsendexPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportEsendexPut} obj Optional instance to populate.
     * @return {module:model/TransportEsendexPut} The populated <code>TransportEsendexPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportEsendexPut();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportEsendexPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportEsendexPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportEsendexPut.RequiredProperties) {
...
export default TransportEsendexPut;
