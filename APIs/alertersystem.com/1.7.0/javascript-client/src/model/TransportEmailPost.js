...
/**
 * The TransportEmailPost model module.
 * @module model/TransportEmailPost
 * @version 1.7.0
 */
class TransportEmailPost {
    /**
     * Constructs a new <code>TransportEmailPost</code>.
     * The TransportEmail resource is a collection of transports that carry dispatched alerts to external SMTP email services.
     * @alias module:model/TransportEmailPost
    ...
    constructor(emailFromAddress, emailFromName, emailPassword, emailPort, emailServer, emailUsername, partition, transportName) { 
        ...
        TransportEmailPost.initialize(this, emailFromAddress, emailFromName, emailPassword, emailPort, emailServer, emailUsername, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportEmailPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportEmailPost} obj Optional instance to populate.
     * @return {module:model/TransportEmailPost} The populated <code>TransportEmailPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportEmailPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportEmailPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportEmailPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportEmailPost.RequiredProperties) {
...
TransportEmailPost.RequiredProperties = ["emailFromAddress", "emailFromName", "emailPassword", "emailPort", "emailServer", "emailUsername", "partition", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportEmailPost.prototype['dataSegmentCode'] = undefined;

/**
 * The sender email address for the SMTP Email service.
 * @member {String} emailFromAddress
 */
TransportEmailPost.prototype['emailFromAddress'] = undefined;

/**
 * The sender name for the SMTP Email service.
 * @member {String} emailFromName
 */
TransportEmailPost.prototype['emailFromName'] = undefined;

/**
 * The password for the SMTP Email service. Stored in encrypted format.
 * @member {String} emailPassword
 */
TransportEmailPost.prototype['emailPassword'] = undefined;

/**
 * The port for the SMTP Email service.
 * @member {Number} emailPort
 */
TransportEmailPost.prototype['emailPort'] = undefined;

/**
 * The server for the SMTP Email service.
 * @member {String} emailServer
 */
TransportEmailPost.prototype['emailServer'] = undefined;

/**
 * The username for the SMTP Email service.
 * @member {String} emailUsername
 */
TransportEmailPost.prototype['emailUsername'] = undefined;
 ...
 */
TransportEmailPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportEmailPost.prototype['transportName'] = undefined;
...
export default TransportEmailPost;
