...
/**
 * The MonitorJsonldPut model module.
 * @module model/MonitorJsonldPut
 * @version 1.7.0
 */
class MonitorJsonldPut {
    /**
     * Constructs a new <code>MonitorJsonldPut</code>.
     ...
     * @alias module:model/MonitorJsonldPut
    ...
    constructor(monitorName, timezoneCode) { 
        ...
        MonitorJsonldPut.initialize(this, monitorName, timezoneCode);
    }
    ...
    /**
     * Constructs a <code>MonitorJsonldPut</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MonitorJsonldPut} obj Optional instance to populate.
     * @return {module:model/MonitorJsonldPut} The populated <code>MonitorJsonldPut</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MonitorJsonldPut();
    ...
    /**
     * Validates the JSON data with respect to <code>MonitorJsonldPut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MonitorJsonldPut</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MonitorJsonldPut.RequiredProperties) {
...
MonitorJsonldPut.RequiredProperties = ["monitorName", "timezoneCode"];
 ...
 */
MonitorJsonldPut.prototype['alertPayloadExtended'] = undefined;
 ...
 */
MonitorJsonldPut.prototype['contentCheckMustNotExist'] = undefined;
 ...
 */
MonitorJsonldPut.prototype['contentCheckXpathFilter'] = undefined;

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
MonitorJsonldPut.prototype['dataSegmentCode'] = undefined;
 ...
 */
MonitorJsonldPut.prototype['graceSeconds'] = undefined;
 ...
 */
MonitorJsonldPut.prototype['intervalDays'] = undefined;
 ...
 */
MonitorJsonldPut.prototype['intervalHours'] = undefined;
 ...
 */
MonitorJsonldPut.prototype['intervalMinutes'] = undefined;
 ...
 */
MonitorJsonldPut.prototype['intervalMonths'] = undefined;
 ...
 */
MonitorJsonldPut.prototype['intervalSeconds'] = undefined;
 ...
 */
MonitorJsonldPut.prototype['monitorNotes'] = undefined;
 ...
 */
MonitorJsonldPut.prototype['publicDescription'] = undefined;
...
export default MonitorJsonldPut;
