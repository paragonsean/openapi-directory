...
/**
 * The TransportAlertaGet model module.
 * @module model/TransportAlertaGet
 * @version 1.7.0
 */
class TransportAlertaGet {
    /**
     * Constructs a new <code>TransportAlertaGet</code>.
     * The TransportAlerta resource is a collection of transports that carry dispatched alerts to the external Alerta service.
     * @alias module:model/TransportAlertaGet
    ...
    constructor(alertaApiKey, alertaEvent, alertaHost, alertaResource, partition, transportName) { 
        ...
        TransportAlertaGet.initialize(this, alertaApiKey, alertaEvent, alertaHost, alertaResource, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportAlertaGet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportAlertaGet} obj Optional instance to populate.
     * @return {module:model/TransportAlertaGet} The populated <code>TransportAlertaGet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportAlertaGet();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportAlertaGet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportAlertaGet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportAlertaGet.RequiredProperties) {
 ...
 */
TransportAlertaGet.prototype['partition'] = undefined;

/**
 * The name of the person who owns this resource.
 * @member {String} resourceOwner
 */
TransportAlertaGet.prototype['resourceOwner'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportAlertaGet.prototype['transportName'] = undefined;
...
export default TransportAlertaGet;
