...
/**
 * The TransportExpoJsonldGet model module.
 * @module model/TransportExpoJsonldGet
 * @version 1.7.0
 */
class TransportExpoJsonldGet {
    /**
     * Constructs a new <code>TransportExpoJsonldGet</code>.
     * The TransportExpo resource is a collection of transports that carry dispatched alerts to the external Expo service.
     * @alias module:model/TransportExpoJsonldGet
    ...
    constructor(expoToken, partition, transportName) { 
        ...
        TransportExpoJsonldGet.initialize(this, expoToken, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportExpoJsonldGet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportExpoJsonldGet} obj Optional instance to populate.
     * @return {module:model/TransportExpoJsonldGet} The populated <code>TransportExpoJsonldGet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportExpoJsonldGet();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportExpoJsonldGet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportExpoJsonldGet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportExpoJsonldGet.RequiredProperties) {
...
TransportExpoJsonldGet.RequiredProperties = ["expoToken", "partition", "transportName"];

/**
 * @member {module:model/AlertLogJsonldGetContext} @context
 */
TransportExpoJsonldGet.prototype['@context'] = undefined;

/**
 * @member {String} @id
 */
TransportExpoJsonldGet.prototype['@id'] = undefined;

/**
 * @member {String} @type
 */
TransportExpoJsonldGet.prototype['@type'] = undefined;

/**
 * When the resource instance was created. This date-time is in the UTC timezone.
 * @member {Date} createdAt
 */
TransportExpoJsonldGet.prototype['createdAt'] = undefined;

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportExpoJsonldGet.prototype['dataSegmentCode'] = undefined;

/**
 * The token for the Expo service. Stored in encrypted format.
 * @member {String} expoToken
 */
TransportExpoJsonldGet.prototype['expoToken'] = undefined;
 ...
 */
TransportExpoJsonldGet.prototype['partition'] = undefined;

/**
 * The name of the person who owns this resource.
 * @member {String} resourceOwner
 */
TransportExpoJsonldGet.prototype['resourceOwner'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportExpoJsonldGet.prototype['transportName'] = undefined;
...
export default TransportExpoJsonldGet;
