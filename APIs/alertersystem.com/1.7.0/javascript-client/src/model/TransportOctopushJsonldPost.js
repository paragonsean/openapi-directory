...
/**
 * The TransportOctopushJsonldPost model module.
 * @module model/TransportOctopushJsonldPost
 * @version 1.7.0
 */
class TransportOctopushJsonldPost {
    /**
     * Constructs a new <code>TransportOctopushJsonldPost</code>.
     ...
     * @alias module:model/TransportOctopushJsonldPost
    ...
    constructor(octopushApiKey, octopushFrom, octopushType, octopushUserLogin, partition, transportName) { 
        ...
        TransportOctopushJsonldPost.initialize(this, octopushApiKey, octopushFrom, octopushType, octopushUserLogin, partition, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportOctopushJsonldPost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportOctopushJsonldPost} obj Optional instance to populate.
     * @return {module:model/TransportOctopushJsonldPost} The populated <code>TransportOctopushJsonldPost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportOctopushJsonldPost();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportOctopushJsonldPost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportOctopushJsonldPost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportOctopushJsonldPost.RequiredProperties) {
...
TransportOctopushJsonldPost.RequiredProperties = ["octopushApiKey", "octopushFrom", "octopushType", "octopushUserLogin", "partition", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportOctopushJsonldPost.prototype['dataSegmentCode'] = undefined;

/**
 * The API key for the Octopush service. Stored in encrypted format.
 * @member {String} octopushApiKey
 */
TransportOctopushJsonldPost.prototype['octopushApiKey'] = undefined;

/**
 * The sender value for the Octopush service.
 * @member {String} octopushFrom
 */
TransportOctopushJsonldPost.prototype['octopushFrom'] = undefined;

/**
 * The SMS type ('XXX' = SMS LowCost; 'FR' = SMS Premium; 'WWW' = SMS World) for the Octopush service.
 * @member {String} octopushType
 */
TransportOctopushJsonldPost.prototype['octopushType'] = undefined;

/**
 * The user login (email) for the Octopush service.
 * @member {String} octopushUserLogin
 */
TransportOctopushJsonldPost.prototype['octopushUserLogin'] = undefined;
 ...
 */
TransportOctopushJsonldPost.prototype['partition'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportOctopushJsonldPost.prototype['transportName'] = undefined;
...
export default TransportOctopushJsonldPost;
