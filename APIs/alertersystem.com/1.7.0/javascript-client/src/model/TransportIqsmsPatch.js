...
/**
 * The TransportIqsmsPatch model module.
 * @module model/TransportIqsmsPatch
 * @version 1.7.0
 */
class TransportIqsmsPatch {
    /**
     * Constructs a new <code>TransportIqsmsPatch</code>.
     * The TransportIqsms resource is a collection of transports that carry dispatched alerts to the external Iqsms service.
     * @alias module:model/TransportIqsmsPatch
    ...
    constructor(iqsmsFrom, iqsmsLogin, iqsmsPassword, transportName) { 
        ...
        TransportIqsmsPatch.initialize(this, iqsmsFrom, iqsmsLogin, iqsmsPassword, transportName);
    }
    ...
    /**
     * Constructs a <code>TransportIqsmsPatch</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransportIqsmsPatch} obj Optional instance to populate.
     * @return {module:model/TransportIqsmsPatch} The populated <code>TransportIqsmsPatch</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransportIqsmsPatch();
    ...
    /**
     * Validates the JSON data with respect to <code>TransportIqsmsPatch</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransportIqsmsPatch</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransportIqsmsPatch.RequiredProperties) {
...
TransportIqsmsPatch.RequiredProperties = ["iqsmsFrom", "iqsmsLogin", "iqsmsPassword", "transportName"];

/**
 * User-provided string on which to segment and filter data. Max 50 characters.
 * @member {String} dataSegmentCode
 */
TransportIqsmsPatch.prototype['dataSegmentCode'] = undefined;

/**
 * The sender value for the Iqsms service.
 * @member {String} iqsmsFrom
 */
TransportIqsmsPatch.prototype['iqsmsFrom'] = undefined;

/**
 * The login for the Iqsms service.
 * @member {String} iqsmsLogin
 */
TransportIqsmsPatch.prototype['iqsmsLogin'] = undefined;

/**
 * The password for the Iqsms service. Stored in encrypted format.
 * @member {String} iqsmsPassword
 */
TransportIqsmsPatch.prototype['iqsmsPassword'] = undefined;

/**
 * The name of the transport.
 * @member {String} transportName
 */
TransportIqsmsPatch.prototype['transportName'] = undefined;
...
export default TransportIqsmsPatch;
