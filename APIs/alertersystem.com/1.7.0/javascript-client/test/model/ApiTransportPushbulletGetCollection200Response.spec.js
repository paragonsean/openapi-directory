...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportPushbulletGetCollection200Response();
  });
  ...
  describe('ApiTransportPushbulletGetCollection200Response', function() {
    it('should create an instance of ApiTransportPushbulletGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportPushbulletGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportPushbulletGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportPushbulletGetCollection200Response);
    });
