...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportWebhookGetCollection200Response();
  });
  ...
  describe('ApiTransportWebhookGetCollection200Response', function() {
    it('should create an instance of ApiTransportWebhookGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportWebhookGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportWebhookGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportWebhookGetCollection200Response);
    });
