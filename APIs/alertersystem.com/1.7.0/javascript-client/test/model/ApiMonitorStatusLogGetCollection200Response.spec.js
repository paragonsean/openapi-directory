...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiMonitorStatusLogGetCollection200Response();
  });
  ...
  describe('ApiMonitorStatusLogGetCollection200Response', function() {
    it('should create an instance of ApiMonitorStatusLogGetCollection200Response', function() {
      // uncomment below and update the code to test ApiMonitorStatusLogGetCollection200Response
      //var instance = new AlerterSystemApi.ApiMonitorStatusLogGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiMonitorStatusLogGetCollection200Response);
    });
