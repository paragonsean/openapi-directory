...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportFreshdeskJsonldGet();
  });
  ...
  describe('TransportFreshdeskJsonldGet', function() {
    it('should create an instance of TransportFreshdeskJsonldGet', function() {
      // uncomment below and update the code to test TransportFreshdeskJsonldGet
      //var instance = new AlerterSystemApi.TransportFreshdeskJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportFreshdeskJsonldGet);
    });
