...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiUserAccountLevelCodeGetCollection200Response();
  });
  ...
  describe('ApiUserAccountLevelCodeGetCollection200Response', function() {
    it('should create an instance of ApiUserAccountLevelCodeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiUserAccountLevelCodeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiUserAccountLevelCodeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiUserAccountLevelCodeGetCollection200Response);
    });
