...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportMessageMediaGetCollection200Response();
  });
  ...
  describe('ApiTransportMessageMediaGetCollection200Response', function() {
    it('should create an instance of ApiTransportMessageMediaGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportMessageMediaGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportMessageMediaGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportMessageMediaGetCollection200Response);
    });
