...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiMonitorGetCollection200Response();
  });
  ...
  describe('ApiMonitorGetCollection200Response', function() {
    it('should create an instance of ApiMonitorGetCollection200Response', function() {
      // uncomment below and update the code to test ApiMonitorGetCollection200Response
      //var instance = new AlerterSystemApi.ApiMonitorGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiMonitorGetCollection200Response);
    });
