...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSms77JsonldGet();
  });
  ...
  describe('TransportSms77JsonldGet', function() {
    it('should create an instance of TransportSms77JsonldGet', function() {
      // uncomment below and update the code to test TransportSms77JsonldGet
      //var instance = new AlerterSystemApi.TransportSms77JsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSms77JsonldGet);
    });
