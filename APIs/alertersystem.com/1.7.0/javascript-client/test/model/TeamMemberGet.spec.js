...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TeamMemberGet();
  });
  ...
  describe('TeamMemberGet', function() {
    it('should create an instance of TeamMemberGet', function() {
      // uncomment below and update the code to test TeamMemberGet
      //var instance = new AlerterSystemApi.TeamMemberGet();
      //expect(instance).to.be.a(AlerterSystemApi.TeamMemberGet);
    });
