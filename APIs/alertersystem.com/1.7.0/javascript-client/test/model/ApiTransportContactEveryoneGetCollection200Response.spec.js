...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportContactEveryoneGetCollection200Response();
  });
  ...
  describe('ApiTransportContactEveryoneGetCollection200Response', function() {
    it('should create an instance of ApiTransportContactEveryoneGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportContactEveryoneGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportContactEveryoneGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportContactEveryoneGetCollection200Response);
    });
