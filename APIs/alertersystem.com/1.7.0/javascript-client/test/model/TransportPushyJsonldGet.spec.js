...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportPushyJsonldGet();
  });
  ...
  describe('TransportPushyJsonldGet', function() {
    it('should create an instance of TransportPushyJsonldGet', function() {
      // uncomment below and update the code to test TransportPushyJsonldGet
      //var instance = new AlerterSystemApi.TransportPushyJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportPushyJsonldGet);
    });
