...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportKazInfoTehGetCollection200Response();
  });
  ...
  describe('ApiTransportKazInfoTehGetCollection200Response', function() {
    it('should create an instance of ApiTransportKazInfoTehGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportKazInfoTehGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportKazInfoTehGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportKazInfoTehGetCollection200Response);
    });
