...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportMicrosoftTeamsGet();
  });
  ...
  describe('TransportMicrosoftTeamsGet', function() {
    it('should create an instance of TransportMicrosoftTeamsGet', function() {
      // uncomment below and update the code to test TransportMicrosoftTeamsGet
      //var instance = new AlerterSystemApi.TransportMicrosoftTeamsGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportMicrosoftTeamsGet);
    });
