...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSmsapiJsonldGet();
  });
  ...
  describe('TransportSmsapiJsonldGet', function() {
    it('should create an instance of TransportSmsapiJsonldGet', function() {
      // uncomment below and update the code to test TransportSmsapiJsonldGet
      //var instance = new AlerterSystemApi.TransportSmsapiJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSmsapiJsonldGet);
    });
