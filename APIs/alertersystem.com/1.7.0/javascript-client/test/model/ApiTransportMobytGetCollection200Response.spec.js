...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportMobytGetCollection200Response();
  });
  ...
  describe('ApiTransportMobytGetCollection200Response', function() {
    it('should create an instance of ApiTransportMobytGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportMobytGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportMobytGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportMobytGetCollection200Response);
    });
