...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportYunpianGet();
  });
  ...
  describe('TransportYunpianGet', function() {
    it('should create an instance of TransportYunpianGet', function() {
      // uncomment below and update the code to test TransportYunpianGet
      //var instance = new AlerterSystemApi.TransportYunpianGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportYunpianGet);
    });
