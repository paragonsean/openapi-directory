...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportYunpianJsonldGet();
  });
  ...
  describe('TransportYunpianJsonldGet', function() {
    it('should create an instance of TransportYunpianJsonldGet', function() {
      // uncomment below and update the code to test TransportYunpianJsonldGet
      //var instance = new AlerterSystemApi.TransportYunpianJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportYunpianJsonldGet);
    });
