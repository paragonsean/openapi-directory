...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportAllMySmsGetCollection200Response();
  });
  ...
  describe('ApiTransportAllMySmsGetCollection200Response', function() {
    it('should create an instance of ApiTransportAllMySmsGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportAllMySmsGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportAllMySmsGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportAllMySmsGetCollection200Response);
    });
