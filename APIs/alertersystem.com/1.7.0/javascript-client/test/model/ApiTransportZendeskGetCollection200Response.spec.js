...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportZendeskGetCollection200Response();
  });
  ...
  describe('ApiTransportZendeskGetCollection200Response', function() {
    it('should create an instance of ApiTransportZendeskGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportZendeskGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportZendeskGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportZendeskGetCollection200Response);
    });
