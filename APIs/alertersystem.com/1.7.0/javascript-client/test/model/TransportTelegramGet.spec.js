...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportTelegramGet();
  });
  ...
  describe('TransportTelegramGet', function() {
    it('should create an instance of TransportTelegramGet', function() {
      // uncomment below and update the code to test TransportTelegramGet
      //var instance = new AlerterSystemApi.TransportTelegramGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportTelegramGet);
    });
