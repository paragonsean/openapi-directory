...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.MediaObjectJsonldGet();
  });
  ...
  describe('MediaObjectJsonldGet', function() {
    it('should create an instance of MediaObjectJsonldGet', function() {
      // uncomment below and update the code to test MediaObjectJsonldGet
      //var instance = new AlerterSystemApi.MediaObjectJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.MediaObjectJsonldGet);
    });
