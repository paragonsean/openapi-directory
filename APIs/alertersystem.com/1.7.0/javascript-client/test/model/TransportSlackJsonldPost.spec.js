...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSlackJsonldPost();
  });
  ...
  describe('TransportSlackJsonldPost', function() {
    it('should create an instance of TransportSlackJsonldPost', function() {
      // uncomment below and update the code to test TransportSlackJsonldPost
      //var instance = new AlerterSystemApi.TransportSlackJsonldPost();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSlackJsonldPost);
    });
