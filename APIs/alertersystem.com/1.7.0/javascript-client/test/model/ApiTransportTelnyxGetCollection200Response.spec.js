...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportTelnyxGetCollection200Response();
  });
  ...
  describe('ApiTransportTelnyxGetCollection200Response', function() {
    it('should create an instance of ApiTransportTelnyxGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportTelnyxGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportTelnyxGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportTelnyxGetCollection200Response);
    });
