...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportLinkedInGetCollection200Response();
  });
  ...
  describe('ApiTransportLinkedInGetCollection200Response', function() {
    it('should create an instance of ApiTransportLinkedInGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportLinkedInGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportLinkedInGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportLinkedInGetCollection200Response);
    });
