...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportTurboSmsGetCollection200Response();
  });
  ...
  describe('ApiTransportTurboSmsGetCollection200Response', function() {
    it('should create an instance of ApiTransportTurboSmsGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportTurboSmsGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportTurboSmsGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportTurboSmsGetCollection200Response);
    });
