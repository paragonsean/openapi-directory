...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportPushyGetCollection200Response();
  });
  ...
  describe('ApiTransportPushyGetCollection200Response', function() {
    it('should create an instance of ApiTransportPushyGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportPushyGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportPushyGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportPushyGetCollection200Response);
    });
