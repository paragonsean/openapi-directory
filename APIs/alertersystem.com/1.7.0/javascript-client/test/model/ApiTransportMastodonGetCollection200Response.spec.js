...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportMastodonGetCollection200Response();
  });
  ...
  describe('ApiTransportMastodonGetCollection200Response', function() {
    it('should create an instance of ApiTransportMastodonGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportMastodonGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportMastodonGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportMastodonGetCollection200Response);
    });
