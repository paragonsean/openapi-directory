...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTimezoneCodeGetCollection200Response();
  });
  ...
  describe('ApiTimezoneCodeGetCollection200Response', function() {
    it('should create an instance of ApiTimezoneCodeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTimezoneCodeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTimezoneCodeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTimezoneCodeGetCollection200Response);
    });
