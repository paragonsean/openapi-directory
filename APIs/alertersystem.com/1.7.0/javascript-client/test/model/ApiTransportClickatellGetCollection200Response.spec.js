...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportClickatellGetCollection200Response();
  });
  ...
  describe('ApiTransportClickatellGetCollection200Response', function() {
    it('should create an instance of ApiTransportClickatellGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportClickatellGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportClickatellGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportClickatellGetCollection200Response);
    });
