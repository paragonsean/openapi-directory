...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportClickSendGetCollection200Response();
  });
  ...
  describe('ApiTransportClickSendGetCollection200Response', function() {
    it('should create an instance of ApiTransportClickSendGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportClickSendGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportClickSendGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportClickSendGetCollection200Response);
    });
