...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSimpleTextinGetCollection200Response();
  });
  ...
  describe('ApiTransportSimpleTextinGetCollection200Response', function() {
    it('should create an instance of ApiTransportSimpleTextinGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSimpleTextinGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSimpleTextinGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSimpleTextinGetCollection200Response);
    });
