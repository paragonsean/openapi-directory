...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportDiscordGetCollection200Response();
  });
  ...
  describe('ApiTransportDiscordGetCollection200Response', function() {
    it('should create an instance of ApiTransportDiscordGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportDiscordGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportDiscordGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportDiscordGetCollection200Response);
    });
