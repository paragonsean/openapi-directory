...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportGoogleChatGetCollection200Response();
  });
  ...
  describe('ApiTransportGoogleChatGetCollection200Response', function() {
    it('should create an instance of ApiTransportGoogleChatGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportGoogleChatGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportGoogleChatGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportGoogleChatGetCollection200Response);
    });
