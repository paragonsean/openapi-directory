...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportOvhCloudGetCollection200Response();
  });
  ...
  describe('ApiTransportOvhCloudGetCollection200Response', function() {
    it('should create an instance of ApiTransportOvhCloudGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportOvhCloudGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportOvhCloudGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportOvhCloudGetCollection200Response);
    });
