...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportGitterJsonldGet();
  });
  ...
  describe('TransportGitterJsonldGet', function() {
    it('should create an instance of TransportGitterJsonldGet', function() {
      // uncomment below and update the code to test TransportGitterJsonldGet
      //var instance = new AlerterSystemApi.TransportGitterJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportGitterJsonldGet);
    });
