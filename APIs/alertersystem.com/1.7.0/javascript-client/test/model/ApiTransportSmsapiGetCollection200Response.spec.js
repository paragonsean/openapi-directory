...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSmsapiGetCollection200Response();
  });
  ...
  describe('ApiTransportSmsapiGetCollection200Response', function() {
    it('should create an instance of ApiTransportSmsapiGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSmsapiGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSmsapiGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSmsapiGetCollection200Response);
    });
