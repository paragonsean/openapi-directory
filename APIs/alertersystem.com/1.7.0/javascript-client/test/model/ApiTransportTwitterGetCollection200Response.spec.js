...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportTwitterGetCollection200Response();
  });
  ...
  describe('ApiTransportTwitterGetCollection200Response', function() {
    it('should create an instance of ApiTransportTwitterGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportTwitterGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportTwitterGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportTwitterGetCollection200Response);
    });
