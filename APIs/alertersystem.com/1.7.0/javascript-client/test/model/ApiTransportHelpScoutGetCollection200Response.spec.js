...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportHelpScoutGetCollection200Response();
  });
  ...
  describe('ApiTransportHelpScoutGetCollection200Response', function() {
    it('should create an instance of ApiTransportHelpScoutGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportHelpScoutGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportHelpScoutGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportHelpScoutGetCollection200Response);
    });
