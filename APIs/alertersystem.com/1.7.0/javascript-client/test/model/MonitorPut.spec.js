...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.MonitorPut();
  });
  ...
  describe('MonitorPut', function() {
    it('should create an instance of MonitorPut', function() {
      // uncomment below and update the code to test MonitorPut
      //var instance = new AlerterSystemApi.MonitorPut();
      //expect(instance).to.be.a(AlerterSystemApi.MonitorPut);
    });
