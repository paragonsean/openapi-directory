...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportExpoGet();
  });
  ...
  describe('TransportExpoGet', function() {
    it('should create an instance of TransportExpoGet', function() {
      // uncomment below and update the code to test TransportExpoGet
      //var instance = new AlerterSystemApi.TransportExpoGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportExpoGet);
    });
