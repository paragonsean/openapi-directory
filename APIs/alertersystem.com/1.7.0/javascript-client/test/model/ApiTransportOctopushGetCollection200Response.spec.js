...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportOctopushGetCollection200Response();
  });
  ...
  describe('ApiTransportOctopushGetCollection200Response', function() {
    it('should create an instance of ApiTransportOctopushGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportOctopushGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportOctopushGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportOctopushGetCollection200Response);
    });
