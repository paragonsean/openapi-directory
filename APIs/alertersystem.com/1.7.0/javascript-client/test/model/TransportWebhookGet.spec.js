...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportWebhookGet();
  });
  ...
  describe('TransportWebhookGet', function() {
    it('should create an instance of TransportWebhookGet', function() {
      // uncomment below and update the code to test TransportWebhookGet
      //var instance = new AlerterSystemApi.TransportWebhookGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportWebhookGet);
    });
