...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportMailjetGet();
  });
  ...
  describe('TransportMailjetGet', function() {
    it('should create an instance of TransportMailjetGet', function() {
      // uncomment below and update the code to test TransportMailjetGet
      //var instance = new AlerterSystemApi.TransportMailjetGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportMailjetGet);
    });
