...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportVonageGetCollection200Response();
  });
  ...
  describe('ApiTransportVonageGetCollection200Response', function() {
    it('should create an instance of ApiTransportVonageGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportVonageGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportVonageGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportVonageGetCollection200Response);
    });
