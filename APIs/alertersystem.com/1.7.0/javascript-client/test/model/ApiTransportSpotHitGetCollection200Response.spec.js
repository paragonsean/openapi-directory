...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSpotHitGetCollection200Response();
  });
  ...
  describe('ApiTransportSpotHitGetCollection200Response', function() {
    it('should create an instance of ApiTransportSpotHitGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSpotHitGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSpotHitGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSpotHitGetCollection200Response);
    });
