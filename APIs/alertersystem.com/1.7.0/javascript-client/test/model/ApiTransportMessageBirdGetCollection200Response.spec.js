...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportMessageBirdGetCollection200Response();
  });
  ...
  describe('ApiTransportMessageBirdGetCollection200Response', function() {
    it('should create an instance of ApiTransportMessageBirdGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportMessageBirdGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportMessageBirdGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportMessageBirdGetCollection200Response);
    });
