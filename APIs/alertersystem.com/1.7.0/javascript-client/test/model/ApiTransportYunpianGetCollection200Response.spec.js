...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportYunpianGetCollection200Response();
  });
  ...
  describe('ApiTransportYunpianGetCollection200Response', function() {
    it('should create an instance of ApiTransportYunpianGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportYunpianGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportYunpianGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportYunpianGetCollection200Response);
    });
