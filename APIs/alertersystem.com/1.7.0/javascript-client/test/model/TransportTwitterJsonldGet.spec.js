...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportTwitterJsonldGet();
  });
  ...
  describe('TransportTwitterJsonldGet', function() {
    it('should create an instance of TransportTwitterJsonldGet', function() {
      // uncomment below and update the code to test TransportTwitterJsonldGet
      //var instance = new AlerterSystemApi.TransportTwitterJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportTwitterJsonldGet);
    });
