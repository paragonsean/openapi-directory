...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSmsapiGet();
  });
  ...
  describe('TransportSmsapiGet', function() {
    it('should create an instance of TransportSmsapiGet', function() {
      // uncomment below and update the code to test TransportSmsapiGet
      //var instance = new AlerterSystemApi.TransportSmsapiGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSmsapiGet);
    });
