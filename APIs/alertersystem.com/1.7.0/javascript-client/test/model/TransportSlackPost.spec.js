...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSlackPost();
  });
  ...
  describe('TransportSlackPost', function() {
    it('should create an instance of TransportSlackPost', function() {
      // uncomment below and update the code to test TransportSlackPost
      //var instance = new AlerterSystemApi.TransportSlackPost();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSlackPost);
    });
