...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportMercureGetCollection200Response();
  });
  ...
  describe('ApiTransportMercureGetCollection200Response', function() {
    it('should create an instance of ApiTransportMercureGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportMercureGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportMercureGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportMercureGetCollection200Response);
    });
