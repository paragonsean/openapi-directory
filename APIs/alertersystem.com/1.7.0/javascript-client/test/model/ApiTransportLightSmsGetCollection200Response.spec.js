...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportLightSmsGetCollection200Response();
  });
  ...
  describe('ApiTransportLightSmsGetCollection200Response', function() {
    it('should create an instance of ApiTransportLightSmsGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportLightSmsGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportLightSmsGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportLightSmsGetCollection200Response);
    });
