...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiAlertLogGetCollection200Response();
  });
  ...
  describe('ApiAlertLogGetCollection200Response', function() {
    it('should create an instance of ApiAlertLogGetCollection200Response', function() {
      // uncomment below and update the code to test ApiAlertLogGetCollection200Response
      //var instance = new AlerterSystemApi.ApiAlertLogGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiAlertLogGetCollection200Response);
    });
