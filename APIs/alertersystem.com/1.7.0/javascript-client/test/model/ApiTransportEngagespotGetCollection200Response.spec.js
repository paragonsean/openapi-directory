...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportEngagespotGetCollection200Response();
  });
  ...
  describe('ApiTransportEngagespotGetCollection200Response', function() {
    it('should create an instance of ApiTransportEngagespotGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportEngagespotGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportEngagespotGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportEngagespotGetCollection200Response);
    });
