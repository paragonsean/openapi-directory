...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportTwitterPost();
  });
  ...
  describe('TransportTwitterPost', function() {
    it('should create an instance of TransportTwitterPost', function() {
      // uncomment below and update the code to test TransportTwitterPost
      //var instance = new AlerterSystemApi.TransportTwitterPost();
      //expect(instance).to.be.a(AlerterSystemApi.TransportTwitterPost);
    });
