...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTeamMemberRoleCodeGetCollection200Response();
  });
  ...
  describe('ApiTeamMemberRoleCodeGetCollection200Response', function() {
    it('should create an instance of ApiTeamMemberRoleCodeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTeamMemberRoleCodeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTeamMemberRoleCodeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTeamMemberRoleCodeGetCollection200Response);
    });
