...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTeamMemberGetCollection200Response();
  });
  ...
  describe('ApiTeamMemberGetCollection200Response', function() {
    it('should create an instance of ApiTeamMemberGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTeamMemberGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTeamMemberGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTeamMemberGetCollection200Response);
    });
