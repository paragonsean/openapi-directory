...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportOpsgenieGetCollection200Response();
  });
  ...
  describe('ApiTransportOpsgenieGetCollection200Response', function() {
    it('should create an instance of ApiTransportOpsgenieGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportOpsgenieGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportOpsgenieGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportOpsgenieGetCollection200Response);
    });
