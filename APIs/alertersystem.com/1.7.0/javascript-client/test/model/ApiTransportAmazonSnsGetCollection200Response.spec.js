...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportAmazonSnsGetCollection200Response();
  });
  ...
  describe('ApiTransportAmazonSnsGetCollection200Response', function() {
    it('should create an instance of ApiTransportAmazonSnsGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportAmazonSnsGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportAmazonSnsGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportAmazonSnsGetCollection200Response);
    });
