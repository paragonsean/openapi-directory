...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportInfobipGetCollection200Response();
  });
  ...
  describe('ApiTransportInfobipGetCollection200Response', function() {
    it('should create an instance of ApiTransportInfobipGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportInfobipGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportInfobipGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportInfobipGetCollection200Response);
    });
