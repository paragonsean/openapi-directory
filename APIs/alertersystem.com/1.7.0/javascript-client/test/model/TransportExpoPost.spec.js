...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportExpoPost();
  });
  ...
  describe('TransportExpoPost', function() {
    it('should create an instance of TransportExpoPost', function() {
      // uncomment below and update the code to test TransportExpoPost
      //var instance = new AlerterSystemApi.TransportExpoPost();
      //expect(instance).to.be.a(AlerterSystemApi.TransportExpoPost);
    });
    ...
    it('should have the property expoToken (base name: "expoToken")', function() {
      // uncomment below and update the code to test the property expoToken
      //var instance = new AlerterSystemApi.TransportExpoPost();
      //expect(instance).to.be();
    });
