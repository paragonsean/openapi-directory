...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiPingMethodCodeGetCollection200Response();
  });
  ...
  describe('ApiPingMethodCodeGetCollection200Response', function() {
    it('should create an instance of ApiPingMethodCodeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiPingMethodCodeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiPingMethodCodeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiPingMethodCodeGetCollection200Response);
    });
