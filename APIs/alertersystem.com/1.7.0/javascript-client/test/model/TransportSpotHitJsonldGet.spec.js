...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSpotHitJsonldGet();
  });
  ...
  describe('TransportSpotHitJsonldGet', function() {
    it('should create an instance of TransportSpotHitJsonldGet', function() {
      // uncomment below and update the code to test TransportSpotHitJsonldGet
      //var instance = new AlerterSystemApi.TransportSpotHitJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSpotHitJsonldGet);
    });
