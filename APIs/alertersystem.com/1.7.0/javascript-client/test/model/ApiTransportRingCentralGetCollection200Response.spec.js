...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportRingCentralGetCollection200Response();
  });
  ...
  describe('ApiTransportRingCentralGetCollection200Response', function() {
    it('should create an instance of ApiTransportRingCentralGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportRingCentralGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportRingCentralGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportRingCentralGetCollection200Response);
    });
