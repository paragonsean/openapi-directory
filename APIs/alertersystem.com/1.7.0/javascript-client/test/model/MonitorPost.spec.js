...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.MonitorPost();
  });
  ...
  describe('MonitorPost', function() {
    it('should create an instance of MonitorPost', function() {
      // uncomment below and update the code to test MonitorPost
      //var instance = new AlerterSystemApi.MonitorPost();
      //expect(instance).to.be.a(AlerterSystemApi.MonitorPost);
    });
