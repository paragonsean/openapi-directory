...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportMicrosoftTeamsGetCollection200Response();
  });
  ...
  describe('ApiTransportMicrosoftTeamsGetCollection200Response', function() {
    it('should create an instance of ApiTransportMicrosoftTeamsGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportMicrosoftTeamsGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportMicrosoftTeamsGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportMicrosoftTeamsGetCollection200Response);
    });
