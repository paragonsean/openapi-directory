...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportGitterGet();
  });
  ...
  describe('TransportGitterGet', function() {
    it('should create an instance of TransportGitterGet', function() {
      // uncomment below and update the code to test TransportGitterGet
      //var instance = new AlerterSystemApi.TransportGitterGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportGitterGet);
    });
