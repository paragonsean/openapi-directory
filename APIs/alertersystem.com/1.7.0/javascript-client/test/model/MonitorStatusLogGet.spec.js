...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.MonitorStatusLogGet();
  });
  ...
  describe('MonitorStatusLogGet', function() {
    it('should create an instance of MonitorStatusLogGet', function() {
      // uncomment below and update the code to test MonitorStatusLogGet
      //var instance = new AlerterSystemApi.MonitorStatusLogGet();
      //expect(instance).to.be.a(AlerterSystemApi.MonitorStatusLogGet);
    });
