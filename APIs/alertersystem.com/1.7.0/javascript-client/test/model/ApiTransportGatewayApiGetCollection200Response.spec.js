...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportGatewayApiGetCollection200Response();
  });
  ...
  describe('ApiTransportGatewayApiGetCollection200Response', function() {
    it('should create an instance of ApiTransportGatewayApiGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportGatewayApiGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportGatewayApiGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportGatewayApiGetCollection200Response);
    });
