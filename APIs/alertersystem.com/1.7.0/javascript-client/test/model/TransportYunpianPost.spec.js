...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportYunpianPost();
  });
  ...
  describe('TransportYunpianPost', function() {
    it('should create an instance of TransportYunpianPost', function() {
      // uncomment below and update the code to test TransportYunpianPost
      //var instance = new AlerterSystemApi.TransportYunpianPost();
      //expect(instance).to.be.a(AlerterSystemApi.TransportYunpianPost);
    });
