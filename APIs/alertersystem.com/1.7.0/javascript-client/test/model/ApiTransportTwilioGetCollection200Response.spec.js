...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportTwilioGetCollection200Response();
  });
  ...
  describe('ApiTransportTwilioGetCollection200Response', function() {
    it('should create an instance of ApiTransportTwilioGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportTwilioGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportTwilioGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportTwilioGetCollection200Response);
    });
