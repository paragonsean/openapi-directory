...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportGotifyGetCollection200Response();
  });
  ...
  describe('ApiTransportGotifyGetCollection200Response', function() {
    it('should create an instance of ApiTransportGotifyGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportGotifyGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportGotifyGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportGotifyGetCollection200Response);
    });
