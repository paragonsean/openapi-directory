...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiMonitorStatusCodeGetCollection200Response();
  });
  ...
  describe('ApiMonitorStatusCodeGetCollection200Response', function() {
    it('should create an instance of ApiMonitorStatusCodeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiMonitorStatusCodeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiMonitorStatusCodeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiMonitorStatusCodeGetCollection200Response);
    });
