...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportAlertaGetCollection200Response();
  });
  ...
  describe('ApiTransportAlertaGetCollection200Response', function() {
    it('should create an instance of ApiTransportAlertaGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportAlertaGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportAlertaGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportAlertaGetCollection200Response);
    });
