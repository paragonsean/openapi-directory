...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportEmailGetCollection200Response();
  });
  ...
  describe('ApiTransportEmailGetCollection200Response', function() {
    it('should create an instance of ApiTransportEmailGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportEmailGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportEmailGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportEmailGetCollection200Response);
    });
