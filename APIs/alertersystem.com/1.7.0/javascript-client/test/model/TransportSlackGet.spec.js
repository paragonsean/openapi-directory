...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSlackGet();
  });
  ...
  describe('TransportSlackGet', function() {
    it('should create an instance of TransportSlackGet', function() {
      // uncomment below and update the code to test TransportSlackGet
      //var instance = new AlerterSystemApi.TransportSlackGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSlackGet);
    });
