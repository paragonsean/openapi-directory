...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportMicrosoftTeamsJsonldGet();
  });
  ...
  describe('TransportMicrosoftTeamsJsonldGet', function() {
    it('should create an instance of TransportMicrosoftTeamsJsonldGet', function() {
      // uncomment below and update the code to test TransportMicrosoftTeamsJsonldGet
      //var instance = new AlerterSystemApi.TransportMicrosoftTeamsJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportMicrosoftTeamsJsonldGet);
    });
