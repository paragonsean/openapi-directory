...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportOrangeSmsGetCollection200Response();
  });
  ...
  describe('ApiTransportOrangeSmsGetCollection200Response', function() {
    it('should create an instance of ApiTransportOrangeSmsGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportOrangeSmsGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportOrangeSmsGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportOrangeSmsGetCollection200Response);
    });
