...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSlackGetCollection200Response();
  });
  ...
  describe('ApiTransportSlackGetCollection200Response', function() {
    it('should create an instance of ApiTransportSlackGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSlackGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSlackGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSlackGetCollection200Response);
    });
