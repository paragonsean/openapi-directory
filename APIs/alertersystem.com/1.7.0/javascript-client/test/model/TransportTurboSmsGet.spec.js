...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportTurboSmsGet();
  });
  ...
  describe('TransportTurboSmsGet', function() {
    it('should create an instance of TransportTurboSmsGet', function() {
      // uncomment below and update the code to test TransportTurboSmsGet
      //var instance = new AlerterSystemApi.TransportTurboSmsGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportTurboSmsGet);
    });
