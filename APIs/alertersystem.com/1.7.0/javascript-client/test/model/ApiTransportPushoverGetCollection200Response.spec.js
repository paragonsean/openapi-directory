...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportPushoverGetCollection200Response();
  });
  ...
  describe('ApiTransportPushoverGetCollection200Response', function() {
    it('should create an instance of ApiTransportPushoverGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportPushoverGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportPushoverGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportPushoverGetCollection200Response);
    });
