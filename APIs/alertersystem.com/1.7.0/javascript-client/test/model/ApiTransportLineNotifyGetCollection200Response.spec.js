...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportLineNotifyGetCollection200Response();
  });
  ...
  describe('ApiTransportLineNotifyGetCollection200Response', function() {
    it('should create an instance of ApiTransportLineNotifyGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportLineNotifyGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportLineNotifyGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportLineNotifyGetCollection200Response);
    });
