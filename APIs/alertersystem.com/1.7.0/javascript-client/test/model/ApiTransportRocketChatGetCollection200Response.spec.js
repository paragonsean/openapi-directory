...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportRocketChatGetCollection200Response();
  });
  ...
  describe('ApiTransportRocketChatGetCollection200Response', function() {
    it('should create an instance of ApiTransportRocketChatGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportRocketChatGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportRocketChatGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportRocketChatGetCollection200Response);
    });
