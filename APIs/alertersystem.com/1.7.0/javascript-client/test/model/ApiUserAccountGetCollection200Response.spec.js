...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiUserAccountGetCollection200Response();
  });
  ...
  describe('ApiUserAccountGetCollection200Response', function() {
    it('should create an instance of ApiUserAccountGetCollection200Response', function() {
      // uncomment below and update the code to test ApiUserAccountGetCollection200Response
      //var instance = new AlerterSystemApi.ApiUserAccountGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiUserAccountGetCollection200Response);
    });
