...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSmsmodeGetCollection200Response();
  });
  ...
  describe('ApiTransportSmsmodeGetCollection200Response', function() {
    it('should create an instance of ApiTransportSmsmodeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSmsmodeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSmsmodeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSmsmodeGetCollection200Response);
    });
