...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.PartitionJsonldGet();
  });
  ...
  describe('PartitionJsonldGet', function() {
    it('should create an instance of PartitionJsonldGet', function() {
      // uncomment below and update the code to test PartitionJsonldGet
      //var instance = new AlerterSystemApi.PartitionJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.PartitionJsonldGet);
    });
