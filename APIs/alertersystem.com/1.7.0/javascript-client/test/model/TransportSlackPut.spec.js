...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSlackPut();
  });
  ...
  describe('TransportSlackPut', function() {
    it('should create an instance of TransportSlackPut', function() {
      // uncomment below and update the code to test TransportSlackPut
      //var instance = new AlerterSystemApi.TransportSlackPut();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSlackPut);
    });
