...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.MediaObjectGet();
  });
  ...
  describe('MediaObjectGet', function() {
    it('should create an instance of MediaObjectGet', function() {
      // uncomment below and update the code to test MediaObjectGet
      //var instance = new AlerterSystemApi.MediaObjectGet();
      //expect(instance).to.be.a(AlerterSystemApi.MediaObjectGet);
    });
