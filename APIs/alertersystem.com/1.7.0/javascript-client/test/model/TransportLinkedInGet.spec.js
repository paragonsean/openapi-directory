...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportLinkedInGet();
  });
  ...
  describe('TransportLinkedInGet', function() {
    it('should create an instance of TransportLinkedInGet', function() {
      // uncomment below and update the code to test TransportLinkedInGet
      //var instance = new AlerterSystemApi.TransportLinkedInGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportLinkedInGet);
    });
