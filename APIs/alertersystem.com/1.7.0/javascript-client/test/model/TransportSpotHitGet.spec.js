...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSpotHitGet();
  });
  ...
  describe('TransportSpotHitGet', function() {
    it('should create an instance of TransportSpotHitGet', function() {
      // uncomment below and update the code to test TransportSpotHitGet
      //var instance = new AlerterSystemApi.TransportSpotHitGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSpotHitGet);
    });
