...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportGatewayApiGet();
  });
  ...
  describe('TransportGatewayApiGet', function() {
    it('should create an instance of TransportGatewayApiGet', function() {
      // uncomment below and update the code to test TransportGatewayApiGet
      //var instance = new AlerterSystemApi.TransportGatewayApiGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportGatewayApiGet);
    });
