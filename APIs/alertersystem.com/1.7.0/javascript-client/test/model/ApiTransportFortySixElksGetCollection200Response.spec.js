...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportFortySixElksGetCollection200Response();
  });
  ...
  describe('ApiTransportFortySixElksGetCollection200Response', function() {
    it('should create an instance of ApiTransportFortySixElksGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportFortySixElksGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportFortySixElksGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportFortySixElksGetCollection200Response);
    });
