...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportPushoverGet();
  });
  ...
  describe('TransportPushoverGet', function() {
    it('should create an instance of TransportPushoverGet', function() {
      // uncomment below and update the code to test TransportPushoverGet
      //var instance = new AlerterSystemApi.TransportPushoverGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportPushoverGet);
    });
