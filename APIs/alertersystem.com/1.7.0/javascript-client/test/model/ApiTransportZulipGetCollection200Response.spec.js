...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportZulipGetCollection200Response();
  });
  ...
  describe('ApiTransportZulipGetCollection200Response', function() {
    it('should create an instance of ApiTransportZulipGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportZulipGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportZulipGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportZulipGetCollection200Response);
    });
