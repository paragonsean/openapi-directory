...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiAlertLogStatusCodeGetCollection200Response();
  });
  ...
  describe('ApiAlertLogStatusCodeGetCollection200Response', function() {
    it('should create an instance of ApiAlertLogStatusCodeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiAlertLogStatusCodeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiAlertLogStatusCodeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiAlertLogStatusCodeGetCollection200Response);
    });
