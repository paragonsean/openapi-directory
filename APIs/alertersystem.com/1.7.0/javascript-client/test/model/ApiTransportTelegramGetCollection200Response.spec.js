...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportTelegramGetCollection200Response();
  });
  ...
  describe('ApiTransportTelegramGetCollection200Response', function() {
    it('should create an instance of ApiTransportTelegramGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportTelegramGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportTelegramGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportTelegramGetCollection200Response);
    });
