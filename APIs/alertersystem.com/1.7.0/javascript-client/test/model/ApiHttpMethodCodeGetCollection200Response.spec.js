...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiHttpMethodCodeGetCollection200Response();
  });
  ...
  describe('ApiHttpMethodCodeGetCollection200Response', function() {
    it('should create an instance of ApiHttpMethodCodeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiHttpMethodCodeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiHttpMethodCodeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiHttpMethodCodeGetCollection200Response);
    });
