...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportMailjetGetCollection200Response();
  });
  ...
  describe('ApiTransportMailjetGetCollection200Response', function() {
    it('should create an instance of ApiTransportMailjetGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportMailjetGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportMailjetGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportMailjetGetCollection200Response);
    });
