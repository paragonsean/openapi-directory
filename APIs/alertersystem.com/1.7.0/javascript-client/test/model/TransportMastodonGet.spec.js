...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportMastodonGet();
  });
  ...
  describe('TransportMastodonGet', function() {
    it('should create an instance of TransportMastodonGet', function() {
      // uncomment below and update the code to test TransportMastodonGet
      //var instance = new AlerterSystemApi.TransportMastodonGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportMastodonGet);
    });
