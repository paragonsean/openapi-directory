...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TeamMemberJsonldGet();
  });
  ...
  describe('TeamMemberJsonldGet', function() {
    it('should create an instance of TeamMemberJsonldGet', function() {
      // uncomment below and update the code to test TeamMemberJsonldGet
      //var instance = new AlerterSystemApi.TeamMemberJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TeamMemberJsonldGet);
    });
