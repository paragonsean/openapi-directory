...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSmsBiurasGetCollection200Response();
  });
  ...
  describe('ApiTransportSmsBiurasGetCollection200Response', function() {
    it('should create an instance of ApiTransportSmsBiurasGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSmsBiurasGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSmsBiurasGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSmsBiurasGetCollection200Response);
    });
