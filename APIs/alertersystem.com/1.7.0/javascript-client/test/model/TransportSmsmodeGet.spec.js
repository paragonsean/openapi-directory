...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSmsmodeGet();
  });
  ...
  describe('TransportSmsmodeGet', function() {
    it('should create an instance of TransportSmsmodeGet', function() {
      // uncomment below and update the code to test TransportSmsmodeGet
      //var instance = new AlerterSystemApi.TransportSmsmodeGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSmsmodeGet);
    });
