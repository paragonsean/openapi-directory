...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiPingGetCollection200Response();
  });
  ...
  describe('ApiPingGetCollection200Response', function() {
    it('should create an instance of ApiPingGetCollection200Response', function() {
      // uncomment below and update the code to test ApiPingGetCollection200Response
      //var instance = new AlerterSystemApi.ApiPingGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiPingGetCollection200Response);
    });
