...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.MonitorGet();
  });
  ...
  describe('MonitorGet', function() {
    it('should create an instance of MonitorGet', function() {
      // uncomment below and update the code to test MonitorGet
      //var instance = new AlerterSystemApi.MonitorGet();
      //expect(instance).to.be.a(AlerterSystemApi.MonitorGet);
    });
