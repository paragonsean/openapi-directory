...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSlackJsonldGet();
  });
  ...
  describe('TransportSlackJsonldGet', function() {
    it('should create an instance of TransportSlackJsonldGet', function() {
      // uncomment below and update the code to test TransportSlackJsonldGet
      //var instance = new AlerterSystemApi.TransportSlackJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSlackJsonldGet);
    });
