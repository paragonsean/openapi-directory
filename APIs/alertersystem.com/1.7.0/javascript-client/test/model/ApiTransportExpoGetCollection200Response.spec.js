...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportExpoGetCollection200Response();
  });
  ...
  describe('ApiTransportExpoGetCollection200Response', function() {
    it('should create an instance of ApiTransportExpoGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportExpoGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportExpoGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportExpoGetCollection200Response);
    });
