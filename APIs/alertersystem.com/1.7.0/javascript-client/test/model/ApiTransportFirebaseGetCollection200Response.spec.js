...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportFirebaseGetCollection200Response();
  });
  ...
  describe('ApiTransportFirebaseGetCollection200Response', function() {
    it('should create an instance of ApiTransportFirebaseGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportFirebaseGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportFirebaseGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportFirebaseGetCollection200Response);
    });
