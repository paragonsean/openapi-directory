...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportChatworkGet();
  });
  ...
  describe('TransportChatworkGet', function() {
    it('should create an instance of TransportChatworkGet', function() {
      // uncomment below and update the code to test TransportChatworkGet
      //var instance = new AlerterSystemApi.TransportChatworkGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportChatworkGet);
    });
