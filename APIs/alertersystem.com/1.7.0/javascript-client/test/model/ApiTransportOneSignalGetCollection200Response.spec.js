...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportOneSignalGetCollection200Response();
  });
  ...
  describe('ApiTransportOneSignalGetCollection200Response', function() {
    it('should create an instance of ApiTransportOneSignalGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportOneSignalGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportOneSignalGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportOneSignalGetCollection200Response);
    });
