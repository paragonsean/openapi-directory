...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSmsFactorGetCollection200Response();
  });
  ...
  describe('ApiTransportSmsFactorGetCollection200Response', function() {
    it('should create an instance of ApiTransportSmsFactorGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSmsFactorGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSmsFactorGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSmsFactorGetCollection200Response);
    });
