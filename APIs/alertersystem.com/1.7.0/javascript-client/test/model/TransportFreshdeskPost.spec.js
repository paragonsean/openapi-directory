...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportFreshdeskPost();
  });
  ...
  describe('TransportFreshdeskPost', function() {
    it('should create an instance of TransportFreshdeskPost', function() {
      // uncomment below and update the code to test TransportFreshdeskPost
      //var instance = new AlerterSystemApi.TransportFreshdeskPost();
      //expect(instance).to.be.a(AlerterSystemApi.TransportFreshdeskPost);
    });
