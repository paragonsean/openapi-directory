...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportBandwidthGetCollection200Response();
  });
  ...
  describe('ApiTransportBandwidthGetCollection200Response', function() {
    it('should create an instance of ApiTransportBandwidthGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportBandwidthGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportBandwidthGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportBandwidthGetCollection200Response);
    });
