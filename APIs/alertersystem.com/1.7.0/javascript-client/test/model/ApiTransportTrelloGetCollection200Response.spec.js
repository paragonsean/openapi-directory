...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportTrelloGetCollection200Response();
  });
  ...
  describe('ApiTransportTrelloGetCollection200Response', function() {
    it('should create an instance of ApiTransportTrelloGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportTrelloGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportTrelloGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportTrelloGetCollection200Response);
    });
