...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportPlivoGetCollection200Response();
  });
  ...
  describe('ApiTransportPlivoGetCollection200Response', function() {
    it('should create an instance of ApiTransportPlivoGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportPlivoGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportPlivoGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportPlivoGetCollection200Response);
    });
