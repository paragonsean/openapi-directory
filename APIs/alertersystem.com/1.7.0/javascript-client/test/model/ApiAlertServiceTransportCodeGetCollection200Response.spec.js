...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiAlertServiceTransportCodeGetCollection200Response();
  });
  ...
  describe('ApiAlertServiceTransportCodeGetCollection200Response', function() {
    it('should create an instance of ApiAlertServiceTransportCodeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiAlertServiceTransportCodeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiAlertServiceTransportCodeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiAlertServiceTransportCodeGetCollection200Response);
    });
