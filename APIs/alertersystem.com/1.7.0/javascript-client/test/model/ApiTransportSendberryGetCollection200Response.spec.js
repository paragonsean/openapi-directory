...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSendberryGetCollection200Response();
  });
  ...
  describe('ApiTransportSendberryGetCollection200Response', function() {
    it('should create an instance of ApiTransportSendberryGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSendberryGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSendberryGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSendberryGetCollection200Response);
    });
