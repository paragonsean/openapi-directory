...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportEsendexGetCollection200Response();
  });
  ...
  describe('ApiTransportEsendexGetCollection200Response', function() {
    it('should create an instance of ApiTransportEsendexGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportEsendexGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportEsendexGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportEsendexGetCollection200Response);
    });
