...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportIqsmsGetCollection200Response();
  });
  ...
  describe('ApiTransportIqsmsGetCollection200Response', function() {
    it('should create an instance of ApiTransportIqsmsGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportIqsmsGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportIqsmsGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportIqsmsGetCollection200Response);
    });
