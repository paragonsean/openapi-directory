...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportExpoJsonldGet();
  });
  ...
  describe('TransportExpoJsonldGet', function() {
    it('should create an instance of TransportExpoJsonldGet', function() {
      // uncomment below and update the code to test TransportExpoJsonldGet
      //var instance = new AlerterSystemApi.TransportExpoJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportExpoJsonldGet);
    });
