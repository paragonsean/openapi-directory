...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSinchGetCollection200Response();
  });
  ...
  describe('ApiTransportSinchGetCollection200Response', function() {
    it('should create an instance of ApiTransportSinchGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSinchGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSinchGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSinchGetCollection200Response);
    });
