...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportTwitterGet();
  });
  ...
  describe('TransportTwitterGet', function() {
    it('should create an instance of TransportTwitterGet', function() {
      // uncomment below and update the code to test TransportTwitterGet
      //var instance = new AlerterSystemApi.TransportTwitterGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportTwitterGet);
    });
