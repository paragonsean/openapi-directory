...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSmscGetCollection200Response();
  });
  ...
  describe('ApiTransportSmscGetCollection200Response', function() {
    it('should create an instance of ApiTransportSmscGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSmscGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSmscGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSmscGetCollection200Response);
    });
