...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSlackJsonldPut();
  });
  ...
  describe('TransportSlackJsonldPut', function() {
    it('should create an instance of TransportSlackJsonldPut', function() {
      // uncomment below and update the code to test TransportSlackJsonldPut
      //var instance = new AlerterSystemApi.TransportSlackJsonldPut();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSlackJsonldPut);
    });
