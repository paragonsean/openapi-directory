...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportMailjetJsonldGet();
  });
  ...
  describe('TransportMailjetJsonldGet', function() {
    it('should create an instance of TransportMailjetJsonldGet', function() {
      // uncomment below and update the code to test TransportMailjetJsonldGet
      //var instance = new AlerterSystemApi.TransportMailjetJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportMailjetJsonldGet);
    });
    ...
    it('should have the property mailjetFrom (base name: "mailjetFrom")', function() {
      // uncomment below and update the code to test the property mailjetFrom
      //var instance = new AlerterSystemApi.TransportMailjetJsonldGet();
      //expect(instance).to.be();
    });

    it('should have the property mailjetToken (base name: "mailjetToken")', function() {
      // uncomment below and update the code to test the property mailjetToken
      //var instance = new AlerterSystemApi.TransportMailjetJsonldGet();
      //expect(instance).to.be();
    });
