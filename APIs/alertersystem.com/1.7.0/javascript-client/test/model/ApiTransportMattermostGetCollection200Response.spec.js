...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportMattermostGetCollection200Response();
  });
  ...
  describe('ApiTransportMattermostGetCollection200Response', function() {
    it('should create an instance of ApiTransportMattermostGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportMattermostGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportMattermostGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportMattermostGetCollection200Response);
    });
