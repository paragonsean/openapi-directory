...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportSendinblueGetCollection200Response();
  });
  ...
  describe('ApiTransportSendinblueGetCollection200Response', function() {
    it('should create an instance of ApiTransportSendinblueGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportSendinblueGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportSendinblueGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportSendinblueGetCollection200Response);
    });
