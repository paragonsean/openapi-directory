...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportExpoJsonldPost();
  });
  ...
  describe('TransportExpoJsonldPost', function() {
    it('should create an instance of TransportExpoJsonldPost', function() {
      // uncomment below and update the code to test TransportExpoJsonldPost
      //var instance = new AlerterSystemApi.TransportExpoJsonldPost();
      //expect(instance).to.be.a(AlerterSystemApi.TransportExpoJsonldPost);
    });
