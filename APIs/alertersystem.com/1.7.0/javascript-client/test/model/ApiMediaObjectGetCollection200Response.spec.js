...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiMediaObjectGetCollection200Response();
  });
  ...
  describe('ApiMediaObjectGetCollection200Response', function() {
    it('should create an instance of ApiMediaObjectGetCollection200Response', function() {
      // uncomment below and update the code to test ApiMediaObjectGetCollection200Response
      //var instance = new AlerterSystemApi.ApiMediaObjectGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiMediaObjectGetCollection200Response);
    });
