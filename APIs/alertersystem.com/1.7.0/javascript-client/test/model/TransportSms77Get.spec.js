...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSms77Get();
  });
  ...
  describe('TransportSms77Get', function() {
    it('should create an instance of TransportSms77Get', function() {
      // uncomment below and update the code to test TransportSms77Get
      //var instance = new AlerterSystemApi.TransportSms77Get();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSms77Get);
    });
