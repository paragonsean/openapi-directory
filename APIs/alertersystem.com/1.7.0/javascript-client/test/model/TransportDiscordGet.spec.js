...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportDiscordGet();
  });
  ...
  describe('TransportDiscordGet', function() {
    it('should create an instance of TransportDiscordGet', function() {
      // uncomment below and update the code to test TransportDiscordGet
      //var instance = new AlerterSystemApi.TransportDiscordGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportDiscordGet);
    });
