...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportFreshdeskPatch();
  });
  ...
  describe('TransportFreshdeskPatch', function() {
    it('should create an instance of TransportFreshdeskPatch', function() {
      // uncomment below and update the code to test TransportFreshdeskPatch
      //var instance = new AlerterSystemApi.TransportFreshdeskPatch();
      //expect(instance).to.be.a(AlerterSystemApi.TransportFreshdeskPatch);
    });
