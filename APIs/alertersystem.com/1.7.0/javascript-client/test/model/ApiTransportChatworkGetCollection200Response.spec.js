...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportChatworkGetCollection200Response();
  });
  ...
  describe('ApiTransportChatworkGetCollection200Response', function() {
    it('should create an instance of ApiTransportChatworkGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportChatworkGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportChatworkGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportChatworkGetCollection200Response);
    });
