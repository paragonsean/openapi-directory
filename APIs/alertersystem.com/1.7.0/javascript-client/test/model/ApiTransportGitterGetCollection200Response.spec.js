...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportGitterGetCollection200Response();
  });
  ...
  describe('ApiTransportGitterGetCollection200Response', function() {
    it('should create an instance of ApiTransportGitterGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportGitterGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportGitterGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportGitterGetCollection200Response);
    });
