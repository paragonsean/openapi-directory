...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportFreshdeskJsonldPost();
  });
  ...
  describe('TransportFreshdeskJsonldPost', function() {
    it('should create an instance of TransportFreshdeskJsonldPost', function() {
      // uncomment below and update the code to test TransportFreshdeskJsonldPost
      //var instance = new AlerterSystemApi.TransportFreshdeskJsonldPost();
      //expect(instance).to.be.a(AlerterSystemApi.TransportFreshdeskJsonldPost);
    });
