...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTeamInvitationGetCollection200Response();
  });
  ...
  describe('ApiTeamInvitationGetCollection200Response', function() {
    it('should create an instance of ApiTeamInvitationGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTeamInvitationGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTeamInvitationGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTeamInvitationGetCollection200Response);
    });
