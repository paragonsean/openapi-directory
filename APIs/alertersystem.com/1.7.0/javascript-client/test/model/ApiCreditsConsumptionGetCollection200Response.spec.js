...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiCreditsConsumptionGetCollection200Response();
  });
  ...
  describe('ApiCreditsConsumptionGetCollection200Response', function() {
    it('should create an instance of ApiCreditsConsumptionGetCollection200Response', function() {
      // uncomment below and update the code to test ApiCreditsConsumptionGetCollection200Response
      //var instance = new AlerterSystemApi.ApiCreditsConsumptionGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiCreditsConsumptionGetCollection200Response);
    });
