...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportTermiiGetCollection200Response();
  });
  ...
  describe('ApiTransportTermiiGetCollection200Response', function() {
    it('should create an instance of ApiTransportTermiiGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportTermiiGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportTermiiGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportTermiiGetCollection200Response);
    });
