...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSlackPatch();
  });
  ...
  describe('TransportSlackPatch', function() {
    it('should create an instance of TransportSlackPatch', function() {
      // uncomment below and update the code to test TransportSlackPatch
      //var instance = new AlerterSystemApi.TransportSlackPatch();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSlackPatch);
    });
