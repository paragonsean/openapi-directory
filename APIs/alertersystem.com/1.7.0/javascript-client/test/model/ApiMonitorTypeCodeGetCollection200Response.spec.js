...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiMonitorTypeCodeGetCollection200Response();
  });
  ...
  describe('ApiMonitorTypeCodeGetCollection200Response', function() {
    it('should create an instance of ApiMonitorTypeCodeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiMonitorTypeCodeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiMonitorTypeCodeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiMonitorTypeCodeGetCollection200Response);
    });
