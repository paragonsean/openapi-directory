...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.MonitorJsonldPost();
  });
  ...
  describe('MonitorJsonldPost', function() {
    it('should create an instance of MonitorJsonldPost', function() {
      // uncomment below and update the code to test MonitorJsonldPost
      //var instance = new AlerterSystemApi.MonitorJsonldPost();
      //expect(instance).to.be.a(AlerterSystemApi.MonitorJsonldPost);
    });
