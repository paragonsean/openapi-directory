...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiPartitionGetCollection200Response();
  });
  ...
  describe('ApiPartitionGetCollection200Response', function() {
    it('should create an instance of ApiPartitionGetCollection200Response', function() {
      // uncomment below and update the code to test ApiPartitionGetCollection200Response
      //var instance = new AlerterSystemApi.ApiPartitionGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiPartitionGetCollection200Response);
    });
