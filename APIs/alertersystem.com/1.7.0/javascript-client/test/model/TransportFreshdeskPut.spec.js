...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportFreshdeskPut();
  });
  ...
  describe('TransportFreshdeskPut', function() {
    it('should create an instance of TransportFreshdeskPut', function() {
      // uncomment below and update the code to test TransportFreshdeskPut
      //var instance = new AlerterSystemApi.TransportFreshdeskPut();
      //expect(instance).to.be.a(AlerterSystemApi.TransportFreshdeskPut);
    });
