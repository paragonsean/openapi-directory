...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportFreeMobileGetCollection200Response();
  });
  ...
  describe('ApiTransportFreeMobileGetCollection200Response', function() {
    it('should create an instance of ApiTransportFreeMobileGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportFreeMobileGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportFreeMobileGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportFreeMobileGetCollection200Response);
    });
