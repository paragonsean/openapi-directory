...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportPushyGet();
  });
  ...
  describe('TransportPushyGet', function() {
    it('should create an instance of TransportPushyGet', function() {
      // uncomment below and update the code to test TransportPushyGet
      //var instance = new AlerterSystemApi.TransportPushyGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportPushyGet);
    });
