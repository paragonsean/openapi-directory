...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportFirebaseGet();
  });
  ...
  describe('TransportFirebaseGet', function() {
    it('should create an instance of TransportFirebaseGet', function() {
      // uncomment below and update the code to test TransportFirebaseGet
      //var instance = new AlerterSystemApi.TransportFirebaseGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportFirebaseGet);
    });
