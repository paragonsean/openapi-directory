...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportPagerTreeGetCollection200Response();
  });
  ...
  describe('ApiTransportPagerTreeGetCollection200Response', function() {
    it('should create an instance of ApiTransportPagerTreeGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportPagerTreeGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportPagerTreeGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportPagerTreeGetCollection200Response);
    });
