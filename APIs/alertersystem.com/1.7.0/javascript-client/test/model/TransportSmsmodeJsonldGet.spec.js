...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportSmsmodeJsonldGet();
  });
  ...
  describe('TransportSmsmodeJsonldGet', function() {
    it('should create an instance of TransportSmsmodeJsonldGet', function() {
      // uncomment below and update the code to test TransportSmsmodeJsonldGet
      //var instance = new AlerterSystemApi.TransportSmsmodeJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportSmsmodeJsonldGet);
    });
    ...
    it('should have the property smsmodeApiKey (base name: "smsmodeApiKey")', function() {
      // uncomment below and update the code to test the property smsmodeApiKey
      //var instance = new AlerterSystemApi.TransportSmsmodeJsonldGet();
      //expect(instance).to.be();
    });

    it('should have the property smsmodeFrom (base name: "smsmodeFrom")', function() {
      // uncomment below and update the code to test the property smsmodeFrom
      //var instance = new AlerterSystemApi.TransportSmsmodeJsonldGet();
      //expect(instance).to.be();
    });
