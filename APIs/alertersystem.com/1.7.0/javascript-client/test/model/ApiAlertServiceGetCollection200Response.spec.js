...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiAlertServiceGetCollection200Response();
  });
  ...
  describe('ApiAlertServiceGetCollection200Response', function() {
    it('should create an instance of ApiAlertServiceGetCollection200Response', function() {
      // uncomment below and update the code to test ApiAlertServiceGetCollection200Response
      //var instance = new AlerterSystemApi.ApiAlertServiceGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiAlertServiceGetCollection200Response);
    });
