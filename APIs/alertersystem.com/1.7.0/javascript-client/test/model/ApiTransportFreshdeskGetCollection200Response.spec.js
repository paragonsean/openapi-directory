...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.ApiTransportFreshdeskGetCollection200Response();
  });
  ...
  describe('ApiTransportFreshdeskGetCollection200Response', function() {
    it('should create an instance of ApiTransportFreshdeskGetCollection200Response', function() {
      // uncomment below and update the code to test ApiTransportFreshdeskGetCollection200Response
      //var instance = new AlerterSystemApi.ApiTransportFreshdeskGetCollection200Response();
      //expect(instance).to.be.a(AlerterSystemApi.ApiTransportFreshdeskGetCollection200Response);
    });
