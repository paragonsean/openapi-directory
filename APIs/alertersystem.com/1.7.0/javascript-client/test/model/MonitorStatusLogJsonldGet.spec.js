...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.MonitorStatusLogJsonldGet();
  });
  ...
  describe('MonitorStatusLogJsonldGet', function() {
    it('should create an instance of MonitorStatusLogJsonldGet', function() {
      // uncomment below and update the code to test MonitorStatusLogJsonldGet
      //var instance = new AlerterSystemApi.MonitorStatusLogJsonldGet();
      //expect(instance).to.be.a(AlerterSystemApi.MonitorStatusLogJsonldGet);
    });
