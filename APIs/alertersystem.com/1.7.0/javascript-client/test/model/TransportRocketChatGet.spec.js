...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.TransportRocketChatGet();
  });
  ...
  describe('TransportRocketChatGet', function() {
    it('should create an instance of TransportRocketChatGet', function() {
      // uncomment below and update the code to test TransportRocketChatGet
      //var instance = new AlerterSystemApi.TransportRocketChatGet();
      //expect(instance).to.be.a(AlerterSystemApi.TransportRocketChatGet);
    });
