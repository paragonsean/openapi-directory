...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlerterSystemApi.MonitorPatch();
  });
  ...
  describe('MonitorPatch', function() {
    it('should create an instance of MonitorPatch', function() {
      // uncomment below and update the code to test MonitorPatch
      //var instance = new AlerterSystemApi.MonitorPatch();
      //expect(instance).to.be.a(AlerterSystemApi.MonitorPatch);
    });
