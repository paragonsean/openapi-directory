...
async def api_transport_amazon_sns_get_collection(request: web.Request, page=None, data_segment_code=None, data_segment_code2=None, partition=None, partition2=None, properties=None) -> web.Response:
...
async def api_transport_amazon_sns_id_delete(request: web.Request, id) -> web.Response:
    """Removes the TransportAmazonSns resource.

    Removes the TransportAmazonSns resource.

    :param id: TransportAmazonSns identifier
    :type id: str
...
async def api_transport_amazon_sns_id_get(request: web.Request, id) -> web.Response:
...
async def api_transport_amazon_sns_id_patch(request: web.Request, id, body) -> web.Response:
    ...
    :param id: TransportAmazonSns identifier
    :type id: str
    :param body: The updated TransportAmazonSns resource
    :type body: dict | bytes

    """
    body = TransportAmazonSnsPatch.from_dict(body)
    return web.Response(status=200)


async def api_transport_amazon_sns_id_put(request: web.Request, id, body) -> web.Response:
    ...
    """
    body = TransportAmazonSnsPut.from_dict(body)
    return web.Response(status=200)


async def api_transport_amazon_sns_post(request: web.Request, body) -> web.Response:
    """Creates a TransportAmazonSns resource.

    Creates a TransportAmazonSns resource.

    :param body: The new TransportAmazonSns resource
    :type body: dict | bytes

    """
    body = TransportAmazonSnsPost.from_dict(body)
    return web.Response(status=200)
