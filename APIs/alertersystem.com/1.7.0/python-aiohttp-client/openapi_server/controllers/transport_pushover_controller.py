...
async def api_transport_pushover_get_collection(request: web.Request, page=None, data_segment_code=None, data_segment_code2=None, partition=None, partition2=None, properties=None) -> web.Response:
...
async def api_transport_pushover_id_delete(request: web.Request, id) -> web.Response:
    """Removes the TransportPushover resource.

    Removes the TransportPushover resource.

    :param id: TransportPushover identifier
    :type id: str
...
async def api_transport_pushover_id_get(request: web.Request, id) -> web.Response:
...
async def api_transport_pushover_id_patch(request: web.Request, id, body) -> web.Response:
    ...
    :param id: TransportPushover identifier
    :type id: str
    :param body: The updated TransportPushover resource
    :type body: dict | bytes

    """
    body = TransportPushoverPatch.from_dict(body)
    return web.Response(status=200)


async def api_transport_pushover_id_put(request: web.Request, id, body) -> web.Response:
    ...
    """
    body = TransportPushoverPut.from_dict(body)
    return web.Response(status=200)


async def api_transport_pushover_post(request: web.Request, body) -> web.Response:
    """Creates a TransportPushover resource.

    Creates a TransportPushover resource.

    :param body: The new TransportPushover resource
    :type body: dict | bytes

    """
    body = TransportPushoverPost.from_dict(body)
    return web.Response(status=200)
