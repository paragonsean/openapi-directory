...
async def api_transport_yunpian_get_collection(request: web.Request, page=None, data_segment_code=None, data_segment_code2=None, partition=None, partition2=None, properties=None) -> web.Response:
...
async def api_transport_yunpian_id_delete(request: web.Request, id) -> web.Response:
    """Removes the TransportYunpian resource.

    Removes the TransportYunpian resource.

    :param id: TransportYunpian identifier
    :type id: str
...
async def api_transport_yunpian_id_get(request: web.Request, id) -> web.Response:
...
async def api_transport_yunpian_id_patch(request: web.Request, id, body) -> web.Response:
    ...
    :param id: TransportYunpian identifier
    :type id: str
    :param body: The updated TransportYunpian resource
    :type body: dict | bytes

    """
    body = TransportYunpianPatch.from_dict(body)
    return web.Response(status=200)


async def api_transport_yunpian_id_put(request: web.Request, id, body) -> web.Response:
    ...
    """
    body = TransportYunpianPut.from_dict(body)
    return web.Response(status=200)


async def api_transport_yunpian_post(request: web.Request, body) -> web.Response:
    """Creates a TransportYunpian resource.

    Creates a TransportYunpian resource.

    :param body: The new TransportYunpian resource
    :type body: dict | bytes

    """
    body = TransportYunpianPost.from_dict(body)
    return web.Response(status=200)
