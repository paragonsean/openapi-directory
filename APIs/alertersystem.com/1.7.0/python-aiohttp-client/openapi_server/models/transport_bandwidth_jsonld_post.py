...
class TransportBandwidthJsonldPost(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, bandwidth_account_id: str=None, bandwidth_application_id: str=None, bandwidth_from: str=None, bandwidth_password: str=None, bandwidth_username: str=None, data_segment_code: str=None, partition: str=None, transport_name: str=None):
        """TransportBandwidthJsonldPost - a model defined in OpenAPI

        :param bandwidth_account_id: The bandwidth_account_id of this TransportBandwidthJsonldPost.
        :param bandwidth_application_id: The bandwidth_application_id of this TransportBandwidthJsonldPost.
        :param bandwidth_from: The bandwidth_from of this TransportBandwidthJsonldPost.
        :param bandwidth_password: The bandwidth_password of this TransportBandwidthJsonldPost.
        :param bandwidth_username: The bandwidth_username of this TransportBandwidthJsonldPost.
        :param data_segment_code: The data_segment_code of this TransportBandwidthJsonldPost.
        :param partition: The partition of this TransportBandwidthJsonldPost.
        :param transport_name: The transport_name of this TransportBandwidthJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportBandwidthJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportBandwidth.jsonld-post of this TransportBandwidthJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bandwidth_account_id(self):
        """Gets the bandwidth_account_id of this TransportBandwidthJsonldPost.

        The account ID value for the Bandwidth service.

        :return: The bandwidth_account_id of this TransportBandwidthJsonldPost.
        :rtype: str
        """
    ...
    def bandwidth_account_id(self, bandwidth_account_id):
        """Sets the bandwidth_account_id of this TransportBandwidthJsonldPost.
    ...
    def bandwidth_application_id(self):
        """Gets the bandwidth_application_id of this TransportBandwidthJsonldPost.

        The application ID value for the Bandwidth service.

        :return: The bandwidth_application_id of this TransportBandwidthJsonldPost.
        :rtype: str
        """
    ...
    def bandwidth_application_id(self, bandwidth_application_id):
        """Sets the bandwidth_application_id of this TransportBandwidthJsonldPost.
    ...
    def bandwidth_from(self):
        """Gets the bandwidth_from of this TransportBandwidthJsonldPost.

        The from value for the Bandwidth service.

        :return: The bandwidth_from of this TransportBandwidthJsonldPost.
        :rtype: str
        """
    ...
    def bandwidth_from(self, bandwidth_from):
        """Sets the bandwidth_from of this TransportBandwidthJsonldPost.
    ...
    def bandwidth_password(self):
        """Gets the bandwidth_password of this TransportBandwidthJsonldPost.

        The password for the Bandwidth service. Stored in encrypted format.

        :return: The bandwidth_password of this TransportBandwidthJsonldPost.
        :rtype: str
        """
    ...
    def bandwidth_password(self, bandwidth_password):
        """Sets the bandwidth_password of this TransportBandwidthJsonldPost.
    ...
    def bandwidth_username(self):
        """Gets the bandwidth_username of this TransportBandwidthJsonldPost.

        The username for the Bandwidth service.

        :return: The bandwidth_username of this TransportBandwidthJsonldPost.
        :rtype: str
        """
    ...
    def bandwidth_username(self, bandwidth_username):
        """Sets the bandwidth_username of this TransportBandwidthJsonldPost.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportBandwidthJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportBandwidthJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportBandwidthJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportBandwidthJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportBandwidthJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportBandwidthJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportBandwidthJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportBandwidthJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportBandwidthJsonldPost.
