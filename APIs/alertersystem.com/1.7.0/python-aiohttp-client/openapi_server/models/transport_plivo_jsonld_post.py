...
class TransportPlivoJsonldPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition: str=None, plivo_auth_id: str=None, plivo_auth_token: str=None, plivo_from: str=None, transport_name: str=None):
        """TransportPlivoJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportPlivoJsonldPost.
        :param partition: The partition of this TransportPlivoJsonldPost.
        :param plivo_auth_id: The plivo_auth_id of this TransportPlivoJsonldPost.
        :param plivo_auth_token: The plivo_auth_token of this TransportPlivoJsonldPost.
        :param plivo_from: The plivo_from of this TransportPlivoJsonldPost.
        :param transport_name: The transport_name of this TransportPlivoJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportPlivoJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportPlivo.jsonld-post of this TransportPlivoJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportPlivoJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportPlivoJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportPlivoJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportPlivoJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportPlivoJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportPlivoJsonldPost.
    ...
    def plivo_auth_id(self):
        """Gets the plivo_auth_id of this TransportPlivoJsonldPost.

        The auth ID for the Plivo service.

        :return: The plivo_auth_id of this TransportPlivoJsonldPost.
        :rtype: str
        """
    ...
    def plivo_auth_id(self, plivo_auth_id):
        """Sets the plivo_auth_id of this TransportPlivoJsonldPost.
    ...
    def plivo_auth_token(self):
        """Gets the plivo_auth_token of this TransportPlivoJsonldPost.

        The auth token for the Plivo service. Stored in encrypted format.

        :return: The plivo_auth_token of this TransportPlivoJsonldPost.
        :rtype: str
        """
    ...
    def plivo_auth_token(self, plivo_auth_token):
        """Sets the plivo_auth_token of this TransportPlivoJsonldPost.
    ...
    @property
    def plivo_from(self):
        """Gets the plivo_from of this TransportPlivoJsonldPost.

        The sender value for the Plivo service.

        :return: The plivo_from of this TransportPlivoJsonldPost.
        :rtype: str
        """
    ...
    def plivo_from(self, plivo_from):
        """Sets the plivo_from of this TransportPlivoJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportPlivoJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportPlivoJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportPlivoJsonldPost.
