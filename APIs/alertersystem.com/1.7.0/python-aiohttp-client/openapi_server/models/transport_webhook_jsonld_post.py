...
class TransportWebhookJsonldPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, http_method_code: str=None, must_be_encrypted_value: str=None, partition: str=None, transport_name: str=None, webhook_headers: List[str]=None, webhook_url: str=None):
        """TransportWebhookJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportWebhookJsonldPost.
        :param http_method_code: The http_method_code of this TransportWebhookJsonldPost.
        :param must_be_encrypted_value: The must_be_encrypted_value of this TransportWebhookJsonldPost.
        :param partition: The partition of this TransportWebhookJsonldPost.
        :param transport_name: The transport_name of this TransportWebhookJsonldPost.
        :param webhook_headers: The webhook_headers of this TransportWebhookJsonldPost.
        :param webhook_url: The webhook_url of this TransportWebhookJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportWebhookJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportWebhook.jsonld-post of this TransportWebhookJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportWebhookJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportWebhookJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportWebhookJsonldPost.
    ...
    def http_method_code(self):
        """Gets the http_method_code of this TransportWebhookJsonldPost.

        The HTTP request method that must be used.

        :return: The http_method_code of this TransportWebhookJsonldPost.
        :rtype: str
        """
    ...
    def http_method_code(self, http_method_code):
        """Sets the http_method_code of this TransportWebhookJsonldPost.
    ...
    def must_be_encrypted_value(self):
        """Gets the must_be_encrypted_value of this TransportWebhookJsonldPost.
        ...
        :return: The must_be_encrypted_value of this TransportWebhookJsonldPost.
        :rtype: str
        """
    ...
    def must_be_encrypted_value(self, must_be_encrypted_value):
        """Sets the must_be_encrypted_value of this TransportWebhookJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportWebhookJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportWebhookJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportWebhookJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportWebhookJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportWebhookJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportWebhookJsonldPost.
    ...
    def webhook_headers(self):
        """Gets the webhook_headers of this TransportWebhookJsonldPost.
        ...
        :return: The webhook_headers of this TransportWebhookJsonldPost.
        :rtype: List[str]
        """
    ...
    def webhook_headers(self, webhook_headers):
        """Sets the webhook_headers of this TransportWebhookJsonldPost.
    ...
    def webhook_url(self):
        """Gets the webhook_url of this TransportWebhookJsonldPost.

        The URL for the Webhook service.

        :return: The webhook_url of this TransportWebhookJsonldPost.
        :rtype: str
        """
    ...
    def webhook_url(self, webhook_url):
        """Sets the webhook_url of this TransportWebhookJsonldPost.
