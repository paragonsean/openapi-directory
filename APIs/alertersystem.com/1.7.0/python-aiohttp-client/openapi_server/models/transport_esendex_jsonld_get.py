...
class TransportEsendexJsonldGet(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, context: AlertLogJsonldGetContext=None, id: str=None, type: str=None, created_at: datetime=None, data_segment_code: str=None, esendex_account_reference: str=None, esendex_from: str=None, esendex_password: str=None, esendex_username: str=None, id: str=None, partition: str=None, resource_owner: str=None, transport_name: str=None):
        """TransportEsendexJsonldGet - a model defined in OpenAPI

        :param context: The context of this TransportEsendexJsonldGet.
        :param id: The id of this TransportEsendexJsonldGet.
        :param type: The type of this TransportEsendexJsonldGet.
        :param created_at: The created_at of this TransportEsendexJsonldGet.
        :param data_segment_code: The data_segment_code of this TransportEsendexJsonldGet.
        :param esendex_account_reference: The esendex_account_reference of this TransportEsendexJsonldGet.
        :param esendex_from: The esendex_from of this TransportEsendexJsonldGet.
        :param esendex_password: The esendex_password of this TransportEsendexJsonldGet.
        :param esendex_username: The esendex_username of this TransportEsendexJsonldGet.
        :param id: The id of this TransportEsendexJsonldGet.
        :param partition: The partition of this TransportEsendexJsonldGet.
        :param resource_owner: The resource_owner of this TransportEsendexJsonldGet.
        :param transport_name: The transport_name of this TransportEsendexJsonldGet.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportEsendexJsonldGet':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportEsendex.jsonld-get of this TransportEsendexJsonldGet.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def context(self):
        """Gets the context of this TransportEsendexJsonldGet.


        :return: The context of this TransportEsendexJsonldGet.
    ...
    def context(self, context):
        """Sets the context of this TransportEsendexJsonldGet.
    ...
    @property
    def id(self):
        """Gets the id of this TransportEsendexJsonldGet.


        :return: The id of this TransportEsendexJsonldGet.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TransportEsendexJsonldGet.
    ...
    @property
    def type(self):
        """Gets the type of this TransportEsendexJsonldGet.


        :return: The type of this TransportEsendexJsonldGet.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TransportEsendexJsonldGet.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this TransportEsendexJsonldGet.

        When the resource instance was created. This date-time is in the UTC timezone.

        :return: The created_at of this TransportEsendexJsonldGet.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this TransportEsendexJsonldGet.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportEsendexJsonldGet.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportEsendexJsonldGet.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportEsendexJsonldGet.
    ...
    def esendex_account_reference(self):
        """Gets the esendex_account_reference of this TransportEsendexJsonldGet.

        The account reference that the message should be sent from for the Esendex service.

        :return: The esendex_account_reference of this TransportEsendexJsonldGet.
        :rtype: str
        """
    ...
    def esendex_account_reference(self, esendex_account_reference):
        """Sets the esendex_account_reference of this TransportEsendexJsonldGet.
    ...
    def esendex_from(self):
        """Gets the esendex_from of this TransportEsendexJsonldGet.

        The alphanumeric originator for the message to appear to originate from for the Esendex service.

        :return: The esendex_from of this TransportEsendexJsonldGet.
        :rtype: str
        """
    ...
    def esendex_from(self, esendex_from):
        """Sets the esendex_from of this TransportEsendexJsonldGet.
    ...
    def esendex_password(self):
        """Gets the esendex_password of this TransportEsendexJsonldGet.

        The API password for the Esendex service. Stored in encrypted format.

        :return: The esendex_password of this TransportEsendexJsonldGet.
        :rtype: str
        """
    ...
    def esendex_password(self, esendex_password):
        """Sets the esendex_password of this TransportEsendexJsonldGet.
    ...
    def esendex_username(self):
        """Gets the esendex_username of this TransportEsendexJsonldGet.

        The account email for the Esendex service.

        :return: The esendex_username of this TransportEsendexJsonldGet.
        :rtype: str
        """
    ...
    def esendex_username(self, esendex_username):
        """Sets the esendex_username of this TransportEsendexJsonldGet.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportEsendexJsonldGet.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportEsendexJsonldGet.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportEsendexJsonldGet.
    ...
    def resource_owner(self):
        """Gets the resource_owner of this TransportEsendexJsonldGet.

        The name of the person who owns this resource.

        :return: The resource_owner of this TransportEsendexJsonldGet.
        :rtype: str
        """
    ...
    def resource_owner(self, resource_owner):
        """Sets the resource_owner of this TransportEsendexJsonldGet.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportEsendexJsonldGet.

        The name of the transport.

        :return: The transport_name of this TransportEsendexJsonldGet.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportEsendexJsonldGet.
