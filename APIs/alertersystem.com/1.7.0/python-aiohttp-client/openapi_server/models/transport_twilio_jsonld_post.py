...
class TransportTwilioJsonldPost(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data_segment_code: str=None, partition: str=None, transport_name: str=None, twilio_from: str=None, twilio_sid: str=None, twilio_token: str=None):
        """TransportTwilioJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportTwilioJsonldPost.
        :param partition: The partition of this TransportTwilioJsonldPost.
        :param transport_name: The transport_name of this TransportTwilioJsonldPost.
        :param twilio_from: The twilio_from of this TransportTwilioJsonldPost.
        :param twilio_sid: The twilio_sid of this TransportTwilioJsonldPost.
        :param twilio_token: The twilio_token of this TransportTwilioJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportTwilioJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportTwilio.jsonld-post of this TransportTwilioJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportTwilioJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportTwilioJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportTwilioJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportTwilioJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportTwilioJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportTwilioJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportTwilioJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportTwilioJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportTwilioJsonldPost.
    ...
    def twilio_from(self):
        """Gets the twilio_from of this TransportTwilioJsonldPost.

        The sender for the Twilio service.

        :return: The twilio_from of this TransportTwilioJsonldPost.
        :rtype: str
        """
    ...
    def twilio_from(self, twilio_from):
        """Sets the twilio_from of this TransportTwilioJsonldPost.
    ...
    @property
    def twilio_sid(self):
        """Gets the twilio_sid of this TransportTwilioJsonldPost.

        The SID for the Twilio service.

        :return: The twilio_sid of this TransportTwilioJsonldPost.
        :rtype: str
        """
    ...
    def twilio_sid(self, twilio_sid):
        """Sets the twilio_sid of this TransportTwilioJsonldPost.
    ...
    def twilio_token(self):
        """Gets the twilio_token of this TransportTwilioJsonldPost.

        The token for the Twilio service. Stored in encrypted format.

        :return: The twilio_token of this TransportTwilioJsonldPost.
        :rtype: str
        """
    ...
    def twilio_token(self, twilio_token):
        """Sets the twilio_token of this TransportTwilioJsonldPost.
