...
class TransportOvhCloudJsonldGet(Model):
    ...
    def __init__(self, context: AlertLogJsonldGetContext=None, id: str=None, type: str=None, created_at: datetime=None, data_segment_code: str=None, id: str=None, ovh_cloud_application_key: str=None, ovh_cloud_application_secret: str=None, ovh_cloud_consumer_key: str=None, ovh_cloud_sender: str=None, ovh_cloud_service_name: str=None, partition: str=None, resource_owner: str=None, transport_name: str=None):
        """TransportOvhCloudJsonldGet - a model defined in OpenAPI

        :param context: The context of this TransportOvhCloudJsonldGet.
        :param id: The id of this TransportOvhCloudJsonldGet.
        :param type: The type of this TransportOvhCloudJsonldGet.
        :param created_at: The created_at of this TransportOvhCloudJsonldGet.
        :param data_segment_code: The data_segment_code of this TransportOvhCloudJsonldGet.
        :param id: The id of this TransportOvhCloudJsonldGet.
        :param ovh_cloud_application_key: The ovh_cloud_application_key of this TransportOvhCloudJsonldGet.
        :param ovh_cloud_application_secret: The ovh_cloud_application_secret of this TransportOvhCloudJsonldGet.
        :param ovh_cloud_consumer_key: The ovh_cloud_consumer_key of this TransportOvhCloudJsonldGet.
        :param ovh_cloud_sender: The ovh_cloud_sender of this TransportOvhCloudJsonldGet.
        :param ovh_cloud_service_name: The ovh_cloud_service_name of this TransportOvhCloudJsonldGet.
        :param partition: The partition of this TransportOvhCloudJsonldGet.
        :param resource_owner: The resource_owner of this TransportOvhCloudJsonldGet.
        :param transport_name: The transport_name of this TransportOvhCloudJsonldGet.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportOvhCloudJsonldGet':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportOvhCloud.jsonld-get of this TransportOvhCloudJsonldGet.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def context(self):
        """Gets the context of this TransportOvhCloudJsonldGet.


        :return: The context of this TransportOvhCloudJsonldGet.
    ...
    def context(self, context):
        """Sets the context of this TransportOvhCloudJsonldGet.
    ...
    @property
    def id(self):
        """Gets the id of this TransportOvhCloudJsonldGet.


        :return: The id of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TransportOvhCloudJsonldGet.
    ...
    @property
    def type(self):
        """Gets the type of this TransportOvhCloudJsonldGet.


        :return: The type of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TransportOvhCloudJsonldGet.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this TransportOvhCloudJsonldGet.

        When the resource instance was created. This date-time is in the UTC timezone.

        :return: The created_at of this TransportOvhCloudJsonldGet.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this TransportOvhCloudJsonldGet.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportOvhCloudJsonldGet.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportOvhCloudJsonldGet.
    ...
    def ovh_cloud_application_key(self):
        """Gets the ovh_cloud_application_key of this TransportOvhCloudJsonldGet.

        The application key for the OVHcloud service.

        :return: The ovh_cloud_application_key of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
    ...
    def ovh_cloud_application_key(self, ovh_cloud_application_key):
        """Sets the ovh_cloud_application_key of this TransportOvhCloudJsonldGet.
    ...
    def ovh_cloud_application_secret(self):
        """Gets the ovh_cloud_application_secret of this TransportOvhCloudJsonldGet.

        The application secret for the OVHcloud service. Stored in encrypted format.

        :return: The ovh_cloud_application_secret of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
    ...
    def ovh_cloud_application_secret(self, ovh_cloud_application_secret):
        """Sets the ovh_cloud_application_secret of this TransportOvhCloudJsonldGet.
    ...
    def ovh_cloud_consumer_key(self):
        """Gets the ovh_cloud_consumer_key of this TransportOvhCloudJsonldGet.

        The consumer key for the OVHcloud service.

        :return: The ovh_cloud_consumer_key of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
    ...
    def ovh_cloud_consumer_key(self, ovh_cloud_consumer_key):
        """Sets the ovh_cloud_consumer_key of this TransportOvhCloudJsonldGet.
    ...
    def ovh_cloud_sender(self):
        """Gets the ovh_cloud_sender of this TransportOvhCloudJsonldGet.

        The optional sender for the OVHcloud service.

        :return: The ovh_cloud_sender of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
    ...
    def ovh_cloud_sender(self, ovh_cloud_sender):
        """Sets the ovh_cloud_sender of this TransportOvhCloudJsonldGet.
    ...
    def ovh_cloud_service_name(self):
        """Gets the ovh_cloud_service_name of this TransportOvhCloudJsonldGet.

        The service name for the OVHcloud service.

        :return: The ovh_cloud_service_name of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
    ...
    def ovh_cloud_service_name(self, ovh_cloud_service_name):
        """Sets the ovh_cloud_service_name of this TransportOvhCloudJsonldGet.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportOvhCloudJsonldGet.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportOvhCloudJsonldGet.
    ...
    def resource_owner(self):
        """Gets the resource_owner of this TransportOvhCloudJsonldGet.

        The name of the person who owns this resource.

        :return: The resource_owner of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
    ...
    def resource_owner(self, resource_owner):
        """Sets the resource_owner of this TransportOvhCloudJsonldGet.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportOvhCloudJsonldGet.

        The name of the transport.

        :return: The transport_name of this TransportOvhCloudJsonldGet.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportOvhCloudJsonldGet.
