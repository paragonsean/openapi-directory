...
class TransportTelegramPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, telegram_chat_id: str=None, telegram_token: str=None, transport_name: str=None):
        """TransportTelegramPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportTelegramPut.
        :param telegram_chat_id: The telegram_chat_id of this TransportTelegramPut.
        :param telegram_token: The telegram_token of this TransportTelegramPut.
        :param transport_name: The transport_name of this TransportTelegramPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportTelegramPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportTelegram-put of this TransportTelegramPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportTelegramPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportTelegramPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportTelegramPut.
    ...
    def telegram_chat_id(self):
        """Gets the telegram_chat_id of this TransportTelegramPut.

        The chat ID for the Telegram service.

        :return: The telegram_chat_id of this TransportTelegramPut.
        :rtype: str
        """
    ...
    def telegram_chat_id(self, telegram_chat_id):
        """Sets the telegram_chat_id of this TransportTelegramPut.
    ...
    def telegram_token(self):
        """Gets the telegram_token of this TransportTelegramPut.

        The token for the Telegram service. Stored in encrypted format.

        :return: The telegram_token of this TransportTelegramPut.
        :rtype: str
        """
    ...
    def telegram_token(self, telegram_token):
        """Sets the telegram_token of this TransportTelegramPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportTelegramPut.

        The name of the transport.

        :return: The transport_name of this TransportTelegramPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportTelegramPut.
