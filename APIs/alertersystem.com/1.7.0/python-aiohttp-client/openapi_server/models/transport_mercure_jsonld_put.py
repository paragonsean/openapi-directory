...
class TransportMercureJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, mercure_hub_jwt_token: str=None, mercure_hub_url: str=None, mercure_topic: str=None, transport_name: str=None):
        """TransportMercureJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportMercureJsonldPut.
        :param mercure_hub_jwt_token: The mercure_hub_jwt_token of this TransportMercureJsonldPut.
        :param mercure_hub_url: The mercure_hub_url of this TransportMercureJsonldPut.
        :param mercure_topic: The mercure_topic of this TransportMercureJsonldPut.
        :param transport_name: The transport_name of this TransportMercureJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportMercureJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportMercure.jsonld-put of this TransportMercureJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportMercureJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportMercureJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportMercureJsonldPut.
    ...
    def mercure_hub_jwt_token(self):
        """Gets the mercure_hub_jwt_token of this TransportMercureJsonldPut.

        The JWT token for the hub for the Mercure service. Stored in encrypted format.

        :return: The mercure_hub_jwt_token of this TransportMercureJsonldPut.
        :rtype: str
        """
    ...
    def mercure_hub_jwt_token(self, mercure_hub_jwt_token):
        """Sets the mercure_hub_jwt_token of this TransportMercureJsonldPut.
    ...
    def mercure_hub_url(self):
        """Gets the mercure_hub_url of this TransportMercureJsonldPut.

        The URL for the hub for the Mercure service.

        :return: The mercure_hub_url of this TransportMercureJsonldPut.
        :rtype: str
        """
    ...
    def mercure_hub_url(self, mercure_hub_url):
        """Sets the mercure_hub_url of this TransportMercureJsonldPut.
    ...
    def mercure_topic(self):
        """Gets the mercure_topic of this TransportMercureJsonldPut.

        The optional topic for the Mercure service.

        :return: The mercure_topic of this TransportMercureJsonldPut.
        :rtype: str
        """
    ...
    def mercure_topic(self, mercure_topic):
        """Sets the mercure_topic of this TransportMercureJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportMercureJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportMercureJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportMercureJsonldPut.
