...
class TransportOpsgeniePut(Model):
    ...
    def __init__(self, data_segment_code: str=None, opsgenie_alias: str=None, opsgenie_api_key: str=None, opsgenie_entity: str=None, opsgenie_note: str=None, opsgenie_priority: str=None, opsgenie_user: str=None, transport_name: str=None):
        """TransportOpsgeniePut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportOpsgeniePut.
        :param opsgenie_alias: The opsgenie_alias of this TransportOpsgeniePut.
        :param opsgenie_api_key: The opsgenie_api_key of this TransportOpsgeniePut.
        :param opsgenie_entity: The opsgenie_entity of this TransportOpsgeniePut.
        :param opsgenie_note: The opsgenie_note of this TransportOpsgeniePut.
        :param opsgenie_priority: The opsgenie_priority of this TransportOpsgeniePut.
        :param opsgenie_user: The opsgenie_user of this TransportOpsgeniePut.
        :param transport_name: The transport_name of this TransportOpsgeniePut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportOpsgeniePut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportOpsgenie-put of this TransportOpsgeniePut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportOpsgeniePut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportOpsgeniePut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportOpsgeniePut.
    ...
    def opsgenie_alias(self):
        """Gets the opsgenie_alias of this TransportOpsgeniePut.

        The alias for the Opsgenie service.

        :return: The opsgenie_alias of this TransportOpsgeniePut.
        :rtype: str
        """
    ...
    def opsgenie_alias(self, opsgenie_alias):
        """Sets the opsgenie_alias of this TransportOpsgeniePut.
    ...
    def opsgenie_api_key(self):
        """Gets the opsgenie_api_key of this TransportOpsgeniePut.

        The API key for the Opsgenie service. Stored in encrypted format.

        :return: The opsgenie_api_key of this TransportOpsgeniePut.
        :rtype: str
        """
    ...
    def opsgenie_api_key(self, opsgenie_api_key):
        """Sets the opsgenie_api_key of this TransportOpsgeniePut.
    ...
    def opsgenie_entity(self):
        """Gets the opsgenie_entity of this TransportOpsgeniePut.

        The entity for the Opsgenie service.

        :return: The opsgenie_entity of this TransportOpsgeniePut.
        :rtype: str
        """
    ...
    def opsgenie_entity(self, opsgenie_entity):
        """Sets the opsgenie_entity of this TransportOpsgeniePut.
    ...
    def opsgenie_note(self):
        """Gets the opsgenie_note of this TransportOpsgeniePut.

        The note for the Opsgenie service.

        :return: The opsgenie_note of this TransportOpsgeniePut.
        :rtype: str
        """
    ...
    def opsgenie_note(self, opsgenie_note):
        """Sets the opsgenie_note of this TransportOpsgeniePut.
    ...
    def opsgenie_priority(self):
        """Gets the opsgenie_priority of this TransportOpsgeniePut.

        The priority for the Opsgenie service.

        :return: The opsgenie_priority of this TransportOpsgeniePut.
        :rtype: str
        """
    ...
    def opsgenie_priority(self, opsgenie_priority):
        """Sets the opsgenie_priority of this TransportOpsgeniePut.
    ...
    def opsgenie_user(self):
        """Gets the opsgenie_user of this TransportOpsgeniePut.

        The user for the Opsgenie service.

        :return: The opsgenie_user of this TransportOpsgeniePut.
        :rtype: str
        """
    ...
    def opsgenie_user(self, opsgenie_user):
        """Sets the opsgenie_user of this TransportOpsgeniePut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportOpsgeniePut.

        The name of the transport.

        :return: The transport_name of this TransportOpsgeniePut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportOpsgeniePut.
