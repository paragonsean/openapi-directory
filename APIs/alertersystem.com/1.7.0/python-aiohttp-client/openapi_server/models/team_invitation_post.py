...
class TeamInvitationPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, id: str=None, invitee_email: str=None, invitee_first_name: str=None, invitee_last_name: str=None, partition: str=None, team_member_role_code: str=None):
        """TeamInvitationPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TeamInvitationPost.
        :param id: The id of this TeamInvitationPost.
        :param invitee_email: The invitee_email of this TeamInvitationPost.
        :param invitee_first_name: The invitee_first_name of this TeamInvitationPost.
        :param invitee_last_name: The invitee_last_name of this TeamInvitationPost.
        :param partition: The partition of this TeamInvitationPost.
        :param team_member_role_code: The team_member_role_code of this TeamInvitationPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TeamInvitationPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TeamInvitation-post of this TeamInvitationPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TeamInvitationPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TeamInvitationPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TeamInvitationPost.
    ...
    @property
    def id(self):
        """Gets the id of this TeamInvitationPost.

        The unique identifier of the resource instance.

        :return: The id of this TeamInvitationPost.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TeamInvitationPost.
    ...
    def invitee_email(self):
        """Gets the invitee_email of this TeamInvitationPost.

        The email address of the person that is being invited.

        :return: The invitee_email of this TeamInvitationPost.
        :rtype: str
        """
    ...
    def invitee_email(self, invitee_email):
        """Sets the invitee_email of this TeamInvitationPost.
    ...
    def invitee_first_name(self):
        """Gets the invitee_first_name of this TeamInvitationPost.

        The first name of the person that is being invited.

        :return: The invitee_first_name of this TeamInvitationPost.
        :rtype: str
        """
    ...
    def invitee_first_name(self, invitee_first_name):
        """Sets the invitee_first_name of this TeamInvitationPost.
    ...
    def invitee_last_name(self):
        """Gets the invitee_last_name of this TeamInvitationPost.

        The last name of the person that is being invited.

        :return: The invitee_last_name of this TeamInvitationPost.
        :rtype: str
        """
    ...
    def invitee_last_name(self, invitee_last_name):
        """Sets the invitee_last_name of this TeamInvitationPost.
    ...
    def partition(self, partition):
        """Sets the partition of this TeamInvitationPost.
    ...
    def team_member_role_code(self):
        """Gets the team_member_role_code of this TeamInvitationPost.

        The role of the team member on the team.

        :return: The team_member_role_code of this TeamInvitationPost.
        :rtype: str
        """
    ...
    def team_member_role_code(self, team_member_role_code):
        """Sets the team_member_role_code of this TeamInvitationPost.
