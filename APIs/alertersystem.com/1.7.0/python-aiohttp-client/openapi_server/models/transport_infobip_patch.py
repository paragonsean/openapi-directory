...
class TransportInfobipPatch(Model):
    ...
    def __init__(self, data_segment_code: str=None, infobip_auth_token: str=None, infobip_from: str=None, infobip_host: str=None, transport_name: str=None):
        """TransportInfobipPatch - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportInfobipPatch.
        :param infobip_auth_token: The infobip_auth_token of this TransportInfobipPatch.
        :param infobip_from: The infobip_from of this TransportInfobipPatch.
        :param infobip_host: The infobip_host of this TransportInfobipPatch.
        :param transport_name: The transport_name of this TransportInfobipPatch.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportInfobipPatch':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportInfobip-patch of this TransportInfobipPatch.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportInfobipPatch.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportInfobipPatch.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportInfobipPatch.
    ...
    def infobip_auth_token(self):
        """Gets the infobip_auth_token of this TransportInfobipPatch.

        The auth token for the Infobip service. Stored in encrypted format.

        :return: The infobip_auth_token of this TransportInfobipPatch.
        :rtype: str
        """
    ...
    def infobip_auth_token(self, infobip_auth_token):
        """Sets the infobip_auth_token of this TransportInfobipPatch.
    ...
    def infobip_from(self):
        """Gets the infobip_from of this TransportInfobipPatch.

        The sender value for the Infobip service.

        :return: The infobip_from of this TransportInfobipPatch.
        :rtype: str
        """
    ...
    def infobip_from(self, infobip_from):
        """Sets the infobip_from of this TransportInfobipPatch.
    ...
    def infobip_host(self):
        """Gets the infobip_host of this TransportInfobipPatch.

        The host for the Infobip service.

        :return: The infobip_host of this TransportInfobipPatch.
        :rtype: str
        """
    ...
    def infobip_host(self, infobip_host):
        """Sets the infobip_host of this TransportInfobipPatch.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportInfobipPatch.

        The name of the transport.

        :return: The transport_name of this TransportInfobipPatch.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportInfobipPatch.
