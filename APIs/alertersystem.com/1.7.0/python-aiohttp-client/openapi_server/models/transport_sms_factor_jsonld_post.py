...
class TransportSmsFactorJsonldPost(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data_segment_code: str=None, partition: str=None, sms_factor_push_type: str=None, sms_factor_sender: str=None, sms_factor_token: str=None, transport_name: str=None):
        """TransportSmsFactorJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportSmsFactorJsonldPost.
        :param partition: The partition of this TransportSmsFactorJsonldPost.
        :param sms_factor_push_type: The sms_factor_push_type of this TransportSmsFactorJsonldPost.
        :param sms_factor_sender: The sms_factor_sender of this TransportSmsFactorJsonldPost.
        :param sms_factor_token: The sms_factor_token of this TransportSmsFactorJsonldPost.
        :param transport_name: The transport_name of this TransportSmsFactorJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportSmsFactorJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportSmsFactor.jsonld-post of this TransportSmsFactorJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportSmsFactorJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportSmsFactorJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportSmsFactorJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportSmsFactorJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportSmsFactorJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportSmsFactorJsonldPost.
    ...
    def sms_factor_push_type(self):
        """Gets the sms_factor_push_type of this TransportSmsFactorJsonldPost.

        The push type for the SMSFactor service.

        :return: The sms_factor_push_type of this TransportSmsFactorJsonldPost.
        :rtype: str
        """
    ...
    def sms_factor_push_type(self, sms_factor_push_type):
        """Sets the sms_factor_push_type of this TransportSmsFactorJsonldPost.
    ...
    def sms_factor_sender(self):
        """Gets the sms_factor_sender of this TransportSmsFactorJsonldPost.

        The sender value for the SMSFactor service.

        :return: The sms_factor_sender of this TransportSmsFactorJsonldPost.
        :rtype: str
        """
    ...
    def sms_factor_sender(self, sms_factor_sender):
        """Sets the sms_factor_sender of this TransportSmsFactorJsonldPost.
    ...
    def sms_factor_token(self):
        """Gets the sms_factor_token of this TransportSmsFactorJsonldPost.

        The token for the SMSFactor service. Stored in encrypted format.

        :return: The sms_factor_token of this TransportSmsFactorJsonldPost.
        :rtype: str
        """
    ...
    def sms_factor_token(self, sms_factor_token):
        """Sets the sms_factor_token of this TransportSmsFactorJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportSmsFactorJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportSmsFactorJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportSmsFactorJsonldPost.
