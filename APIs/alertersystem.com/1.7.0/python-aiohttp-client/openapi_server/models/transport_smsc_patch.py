...
class TransportSmscPatch(Model):
    ...
    def __init__(self, data_segment_code: str=None, smsc_from: str=None, smsc_login: str=None, smsc_password: str=None, transport_name: str=None):
        """TransportSmscPatch - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportSmscPatch.
        :param smsc_from: The smsc_from of this TransportSmscPatch.
        :param smsc_login: The smsc_login of this TransportSmscPatch.
        :param smsc_password: The smsc_password of this TransportSmscPatch.
        :param transport_name: The transport_name of this TransportSmscPatch.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportSmscPatch':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportSmsc-patch of this TransportSmscPatch.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportSmscPatch.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportSmscPatch.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportSmscPatch.
    ...
    @property
    def smsc_from(self):
        """Gets the smsc_from of this TransportSmscPatch.

        The sender (NB: text identity, not a phone number) for the Smsc service.

        :return: The smsc_from of this TransportSmscPatch.
        :rtype: str
        """
    ...
    def smsc_from(self, smsc_from):
        """Sets the smsc_from of this TransportSmscPatch.
    ...
    @property
    def smsc_login(self):
        """Gets the smsc_login of this TransportSmscPatch.

        The login for the Smsc service.

        :return: The smsc_login of this TransportSmscPatch.
        :rtype: str
        """
    ...
    def smsc_login(self, smsc_login):
        """Sets the smsc_login of this TransportSmscPatch.
    ...
    def smsc_password(self):
        """Gets the smsc_password of this TransportSmscPatch.

        The API password for the Smsc service. Stored in encrypted format.

        :return: The smsc_password of this TransportSmscPatch.
        :rtype: str
        """
    ...
    def smsc_password(self, smsc_password):
        """Sets the smsc_password of this TransportSmscPatch.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportSmscPatch.

        The name of the transport.

        :return: The transport_name of this TransportSmscPatch.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportSmscPatch.
