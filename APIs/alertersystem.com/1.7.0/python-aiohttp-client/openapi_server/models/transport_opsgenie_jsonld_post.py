...
class TransportOpsgenieJsonldPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, opsgenie_alias: str=None, opsgenie_api_key: str=None, opsgenie_entity: str=None, opsgenie_note: str=None, opsgenie_priority: str=None, opsgenie_user: str=None, partition: str=None, transport_name: str=None):
        """TransportOpsgenieJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportOpsgenieJsonldPost.
        :param opsgenie_alias: The opsgenie_alias of this TransportOpsgenieJsonldPost.
        :param opsgenie_api_key: The opsgenie_api_key of this TransportOpsgenieJsonldPost.
        :param opsgenie_entity: The opsgenie_entity of this TransportOpsgenieJsonldPost.
        :param opsgenie_note: The opsgenie_note of this TransportOpsgenieJsonldPost.
        :param opsgenie_priority: The opsgenie_priority of this TransportOpsgenieJsonldPost.
        :param opsgenie_user: The opsgenie_user of this TransportOpsgenieJsonldPost.
        :param partition: The partition of this TransportOpsgenieJsonldPost.
        :param transport_name: The transport_name of this TransportOpsgenieJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportOpsgenieJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportOpsgenie.jsonld-post of this TransportOpsgenieJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportOpsgenieJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportOpsgenieJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportOpsgenieJsonldPost.
    ...
    def opsgenie_alias(self):
        """Gets the opsgenie_alias of this TransportOpsgenieJsonldPost.

        The alias for the Opsgenie service.

        :return: The opsgenie_alias of this TransportOpsgenieJsonldPost.
        :rtype: str
        """
    ...
    def opsgenie_alias(self, opsgenie_alias):
        """Sets the opsgenie_alias of this TransportOpsgenieJsonldPost.
    ...
    def opsgenie_api_key(self):
        """Gets the opsgenie_api_key of this TransportOpsgenieJsonldPost.

        The API key for the Opsgenie service. Stored in encrypted format.

        :return: The opsgenie_api_key of this TransportOpsgenieJsonldPost.
        :rtype: str
        """
    ...
    def opsgenie_api_key(self, opsgenie_api_key):
        """Sets the opsgenie_api_key of this TransportOpsgenieJsonldPost.
    ...
    def opsgenie_entity(self):
        """Gets the opsgenie_entity of this TransportOpsgenieJsonldPost.

        The entity for the Opsgenie service.

        :return: The opsgenie_entity of this TransportOpsgenieJsonldPost.
        :rtype: str
        """
    ...
    def opsgenie_entity(self, opsgenie_entity):
        """Sets the opsgenie_entity of this TransportOpsgenieJsonldPost.
    ...
    def opsgenie_note(self):
        """Gets the opsgenie_note of this TransportOpsgenieJsonldPost.

        The note for the Opsgenie service.

        :return: The opsgenie_note of this TransportOpsgenieJsonldPost.
        :rtype: str
        """
    ...
    def opsgenie_note(self, opsgenie_note):
        """Sets the opsgenie_note of this TransportOpsgenieJsonldPost.
    ...
    def opsgenie_priority(self):
        """Gets the opsgenie_priority of this TransportOpsgenieJsonldPost.

        The priority for the Opsgenie service.

        :return: The opsgenie_priority of this TransportOpsgenieJsonldPost.
        :rtype: str
        """
    ...
    def opsgenie_priority(self, opsgenie_priority):
        """Sets the opsgenie_priority of this TransportOpsgenieJsonldPost.
    ...
    def opsgenie_user(self):
        """Gets the opsgenie_user of this TransportOpsgenieJsonldPost.

        The user for the Opsgenie service.

        :return: The opsgenie_user of this TransportOpsgenieJsonldPost.
        :rtype: str
        """
    ...
    def opsgenie_user(self, opsgenie_user):
        """Sets the opsgenie_user of this TransportOpsgenieJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportOpsgenieJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportOpsgenieJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportOpsgenieJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportOpsgenieJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportOpsgenieJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportOpsgenieJsonldPost.
