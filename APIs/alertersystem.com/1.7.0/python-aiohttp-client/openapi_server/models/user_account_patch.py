...
class UserAccountPatch(Model):
    ...
    def __init__(self, credits_overage_percent_trip_switch: int=None):
        """UserAccountPatch - a model defined in OpenAPI

        :param credits_overage_percent_trip_switch: The credits_overage_percent_trip_switch of this UserAccountPatch.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UserAccountPatch':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UserAccount-patch of this UserAccountPatch.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def credits_overage_percent_trip_switch(self):
        """Gets the credits_overage_percent_trip_switch of this UserAccountPatch.
        ...
        :return: The credits_overage_percent_trip_switch of this UserAccountPatch.
        :rtype: int
        """
    ...
    def credits_overage_percent_trip_switch(self, credits_overage_percent_trip_switch):
        """Sets the credits_overage_percent_trip_switch of this UserAccountPatch.
