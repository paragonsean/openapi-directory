...
class TransportWebhookJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, http_method_code: str=None, must_be_encrypted_value: str=None, transport_name: str=None, webhook_headers: List[str]=None, webhook_url: str=None):
        """TransportWebhookJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportWebhookJsonldPut.
        :param http_method_code: The http_method_code of this TransportWebhookJsonldPut.
        :param must_be_encrypted_value: The must_be_encrypted_value of this TransportWebhookJsonldPut.
        :param transport_name: The transport_name of this TransportWebhookJsonldPut.
        :param webhook_headers: The webhook_headers of this TransportWebhookJsonldPut.
        :param webhook_url: The webhook_url of this TransportWebhookJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportWebhookJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportWebhook.jsonld-put of this TransportWebhookJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportWebhookJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportWebhookJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportWebhookJsonldPut.
    ...
    def http_method_code(self):
        """Gets the http_method_code of this TransportWebhookJsonldPut.

        The HTTP request method that must be used.

        :return: The http_method_code of this TransportWebhookJsonldPut.
        :rtype: str
        """
    ...
    def http_method_code(self, http_method_code):
        """Sets the http_method_code of this TransportWebhookJsonldPut.
    ...
    def must_be_encrypted_value(self):
        """Gets the must_be_encrypted_value of this TransportWebhookJsonldPut.
        ...
        :return: The must_be_encrypted_value of this TransportWebhookJsonldPut.
        :rtype: str
        """
    ...
    def must_be_encrypted_value(self, must_be_encrypted_value):
        """Sets the must_be_encrypted_value of this TransportWebhookJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportWebhookJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportWebhookJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportWebhookJsonldPut.
    ...
    def webhook_headers(self):
        """Gets the webhook_headers of this TransportWebhookJsonldPut.
        ...
        :return: The webhook_headers of this TransportWebhookJsonldPut.
        :rtype: List[str]
        """
    ...
    def webhook_headers(self, webhook_headers):
        """Sets the webhook_headers of this TransportWebhookJsonldPut.
    ...
    def webhook_url(self):
        """Gets the webhook_url of this TransportWebhookJsonldPut.

        The URL for the Webhook service.

        :return: The webhook_url of this TransportWebhookJsonldPut.
        :rtype: str
        """
    ...
    def webhook_url(self, webhook_url):
        """Sets the webhook_url of this TransportWebhookJsonldPut.
