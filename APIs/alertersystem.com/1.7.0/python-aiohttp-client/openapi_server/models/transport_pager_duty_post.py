...
class TransportPagerDutyPost(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data_segment_code: str=None, pager_duty_api_token: str=None, pager_duty_dedup_key: str=None, pager_duty_event_action: str=None, pager_duty_payload_class: str=None, pager_duty_payload_component: str=None, pager_duty_payload_group: str=None, pager_duty_payload_severity: str=None, pager_duty_payload_source: str=None, pager_duty_routing_key: str=None, partition: str=None, transport_name: str=None):
        """TransportPagerDutyPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportPagerDutyPost.
        :param pager_duty_api_token: The pager_duty_api_token of this TransportPagerDutyPost.
        :param pager_duty_dedup_key: The pager_duty_dedup_key of this TransportPagerDutyPost.
        :param pager_duty_event_action: The pager_duty_event_action of this TransportPagerDutyPost.
        :param pager_duty_payload_class: The pager_duty_payload_class of this TransportPagerDutyPost.
        :param pager_duty_payload_component: The pager_duty_payload_component of this TransportPagerDutyPost.
        :param pager_duty_payload_group: The pager_duty_payload_group of this TransportPagerDutyPost.
        :param pager_duty_payload_severity: The pager_duty_payload_severity of this TransportPagerDutyPost.
        :param pager_duty_payload_source: The pager_duty_payload_source of this TransportPagerDutyPost.
        :param pager_duty_routing_key: The pager_duty_routing_key of this TransportPagerDutyPost.
        :param partition: The partition of this TransportPagerDutyPost.
        :param transport_name: The transport_name of this TransportPagerDutyPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportPagerDutyPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportPagerDuty-post of this TransportPagerDutyPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportPagerDutyPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportPagerDutyPost.
    ...
    def pager_duty_api_token(self):
        """Gets the pager_duty_api_token of this TransportPagerDutyPost.

        The API token for the Pager Duty service. Stored in encrypted format.

        :return: The pager_duty_api_token of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def pager_duty_api_token(self, pager_duty_api_token):
        """Sets the pager_duty_api_token of this TransportPagerDutyPost.
    ...
    def pager_duty_dedup_key(self):
        """Gets the pager_duty_dedup_key of this TransportPagerDutyPost.

        The dedup key for the Pager Duty service.

        :return: The pager_duty_dedup_key of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def pager_duty_dedup_key(self, pager_duty_dedup_key):
        """Sets the pager_duty_dedup_key of this TransportPagerDutyPost.
    ...
    def pager_duty_event_action(self):
        """Gets the pager_duty_event_action of this TransportPagerDutyPost.

        The event action for the Pager Duty service.

        :return: The pager_duty_event_action of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def pager_duty_event_action(self, pager_duty_event_action):
        """Sets the pager_duty_event_action of this TransportPagerDutyPost.
    ...
    def pager_duty_payload_class(self):
        """Gets the pager_duty_payload_class of this TransportPagerDutyPost.

        The payload class for the Pager Duty service.

        :return: The pager_duty_payload_class of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def pager_duty_payload_class(self, pager_duty_payload_class):
        """Sets the pager_duty_payload_class of this TransportPagerDutyPost.
    ...
    def pager_duty_payload_component(self):
        """Gets the pager_duty_payload_component of this TransportPagerDutyPost.

        The payload component for the Pager Duty service.

        :return: The pager_duty_payload_component of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def pager_duty_payload_component(self, pager_duty_payload_component):
        """Sets the pager_duty_payload_component of this TransportPagerDutyPost.
    ...
    def pager_duty_payload_group(self):
        """Gets the pager_duty_payload_group of this TransportPagerDutyPost.

        The payload group for the Pager Duty service.

        :return: The pager_duty_payload_group of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def pager_duty_payload_group(self, pager_duty_payload_group):
        """Sets the pager_duty_payload_group of this TransportPagerDutyPost.
    ...
    def pager_duty_payload_severity(self):
        """Gets the pager_duty_payload_severity of this TransportPagerDutyPost.

        The payload severity for the Pager Duty service.

        :return: The pager_duty_payload_severity of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def pager_duty_payload_severity(self, pager_duty_payload_severity):
        """Sets the pager_duty_payload_severity of this TransportPagerDutyPost.
    ...
    def pager_duty_payload_source(self):
        """Gets the pager_duty_payload_source of this TransportPagerDutyPost.

        The payload source for the Pager Duty service.

        :return: The pager_duty_payload_source of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def pager_duty_payload_source(self, pager_duty_payload_source):
        """Sets the pager_duty_payload_source of this TransportPagerDutyPost.
    ...
    def pager_duty_routing_key(self):
        """Gets the pager_duty_routing_key of this TransportPagerDutyPost.

        The routing key for the Pager Duty service.

        :return: The pager_duty_routing_key of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def pager_duty_routing_key(self, pager_duty_routing_key):
        """Sets the pager_duty_routing_key of this TransportPagerDutyPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportPagerDutyPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportPagerDutyPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportPagerDutyPost.

        The name of the transport.

        :return: The transport_name of this TransportPagerDutyPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportPagerDutyPost.
