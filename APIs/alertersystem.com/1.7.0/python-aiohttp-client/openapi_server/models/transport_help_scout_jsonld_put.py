...
class TransportHelpScoutJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, help_scout_customer_email: str=None, help_scout_mailbox_id: int=None, help_scout_oauth_token: str=None, transport_name: str=None):
        """TransportHelpScoutJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportHelpScoutJsonldPut.
        :param help_scout_customer_email: The help_scout_customer_email of this TransportHelpScoutJsonldPut.
        :param help_scout_mailbox_id: The help_scout_mailbox_id of this TransportHelpScoutJsonldPut.
        :param help_scout_oauth_token: The help_scout_oauth_token of this TransportHelpScoutJsonldPut.
        :param transport_name: The transport_name of this TransportHelpScoutJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportHelpScoutJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportHelpScout.jsonld-put of this TransportHelpScoutJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportHelpScoutJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportHelpScoutJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportHelpScoutJsonldPut.
    ...
    def help_scout_customer_email(self):
        """Gets the help_scout_customer_email of this TransportHelpScoutJsonldPut.

        The requester customer email address for the HelpScout service.

        :return: The help_scout_customer_email of this TransportHelpScoutJsonldPut.
        :rtype: str
        """
    ...
    def help_scout_customer_email(self, help_scout_customer_email):
        """Sets the help_scout_customer_email of this TransportHelpScoutJsonldPut.
    ...
    def help_scout_mailbox_id(self):
        """Gets the help_scout_mailbox_id of this TransportHelpScoutJsonldPut.

        The mailbox ID for the HelpScout service.

        :return: The help_scout_mailbox_id of this TransportHelpScoutJsonldPut.
        :rtype: int
        """
    ...
    def help_scout_mailbox_id(self, help_scout_mailbox_id):
        """Sets the help_scout_mailbox_id of this TransportHelpScoutJsonldPut.
    ...
    def help_scout_oauth_token(self):
        """Gets the help_scout_oauth_token of this TransportHelpScoutJsonldPut.

        The OAuth token for the HelpScout service. Stored in encrypted format.

        :return: The help_scout_oauth_token of this TransportHelpScoutJsonldPut.
        :rtype: str
        """
    ...
    def help_scout_oauth_token(self, help_scout_oauth_token):
        """Sets the help_scout_oauth_token of this TransportHelpScoutJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportHelpScoutJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportHelpScoutJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportHelpScoutJsonldPut.
