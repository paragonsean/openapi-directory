...
class TransportMobytPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, mobyt_access_token: str=None, mobyt_from: str=None, mobyt_type_quality: str=None, mobyt_user_key: str=None, partition: str=None, transport_name: str=None):
        """TransportMobytPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportMobytPost.
        :param mobyt_access_token: The mobyt_access_token of this TransportMobytPost.
        :param mobyt_from: The mobyt_from of this TransportMobytPost.
        :param mobyt_type_quality: The mobyt_type_quality of this TransportMobytPost.
        :param mobyt_user_key: The mobyt_user_key of this TransportMobytPost.
        :param partition: The partition of this TransportMobytPost.
        :param transport_name: The transport_name of this TransportMobytPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportMobytPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportMobyt-post of this TransportMobytPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportMobytPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportMobytPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportMobytPost.
    ...
    def mobyt_access_token(self):
        """Gets the mobyt_access_token of this TransportMobytPost.

        The access token for the Mobyt service. Stored in encrypted format.

        :return: The mobyt_access_token of this TransportMobytPost.
        :rtype: str
        """
    ...
    def mobyt_access_token(self, mobyt_access_token):
        """Sets the mobyt_access_token of this TransportMobytPost.
    ...
    @property
    def mobyt_from(self):
        """Gets the mobyt_from of this TransportMobytPost.

        The sender for the Mobyt service.

        :return: The mobyt_from of this TransportMobytPost.
        :rtype: str
        """
    ...
    def mobyt_from(self, mobyt_from):
        """Sets the mobyt_from of this TransportMobytPost.
    ...
    def mobyt_type_quality(self):
        """Gets the mobyt_type_quality of this TransportMobytPost.

        The quality of your message: 'N' for high, 'L' for medium, 'LL' for low, for the Mobyt service.

        :return: The mobyt_type_quality of this TransportMobytPost.
        :rtype: str
        """
    ...
    def mobyt_type_quality(self, mobyt_type_quality):
        """Sets the mobyt_type_quality of this TransportMobytPost.
    ...
    def mobyt_user_key(self):
        """Gets the mobyt_user_key of this TransportMobytPost.

        The user key for the Mobyt service.

        :return: The mobyt_user_key of this TransportMobytPost.
        :rtype: str
        """
    ...
    def mobyt_user_key(self, mobyt_user_key):
        """Sets the mobyt_user_key of this TransportMobytPost.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportMobytPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportMobytPost.

        The name of the transport.

        :return: The transport_name of this TransportMobytPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportMobytPost.
