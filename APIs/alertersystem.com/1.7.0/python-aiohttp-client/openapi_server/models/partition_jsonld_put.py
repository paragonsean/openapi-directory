...
class PartitionJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition_name: str=None, partition_notes: str=None):
        """PartitionJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this PartitionJsonldPut.
        :param partition_name: The partition_name of this PartitionJsonldPut.
        :param partition_notes: The partition_notes of this PartitionJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PartitionJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Partition.jsonld-put of this PartitionJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this PartitionJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this PartitionJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this PartitionJsonldPut.
    ...
    def partition_name(self):
        """Gets the partition_name of this PartitionJsonldPut.

        The name of the partition. Max 255 characters.

        :return: The partition_name of this PartitionJsonldPut.
        :rtype: str
        """
    ...
    def partition_name(self, partition_name):
        """Sets the partition_name of this PartitionJsonldPut.
    ...
    def partition_notes(self, partition_notes):
        """Sets the partition_notes of this PartitionJsonldPut.
