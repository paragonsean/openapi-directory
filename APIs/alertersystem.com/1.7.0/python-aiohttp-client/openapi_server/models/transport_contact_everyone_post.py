...
class TransportContactEveryonePost(Model):
    ...
    def __init__(self, contact_everyone_category: str=None, contact_everyone_diffusion_name: str=None, contact_everyone_token: str=None, data_segment_code: str=None, partition: str=None, transport_name: str=None):
        """TransportContactEveryonePost - a model defined in OpenAPI

        :param contact_everyone_category: The contact_everyone_category of this TransportContactEveryonePost.
        :param contact_everyone_diffusion_name: The contact_everyone_diffusion_name of this TransportContactEveryonePost.
        :param contact_everyone_token: The contact_everyone_token of this TransportContactEveryonePost.
        :param data_segment_code: The data_segment_code of this TransportContactEveryonePost.
        :param partition: The partition of this TransportContactEveryonePost.
        :param transport_name: The transport_name of this TransportContactEveryonePost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportContactEveryonePost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportContactEveryone-post of this TransportContactEveryonePost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def contact_everyone_category(self):
        """Gets the contact_everyone_category of this TransportContactEveryonePost.

        The label of the category that will be displayed in the external service event logs of the ContactEveryone service.

        :return: The contact_everyone_category of this TransportContactEveryonePost.
        :rtype: str
        """
    ...
    def contact_everyone_category(self, contact_everyone_category):
        """Sets the contact_everyone_category of this TransportContactEveryonePost.
    ...
    def contact_everyone_diffusion_name(self):
        """Gets the contact_everyone_diffusion_name of this TransportContactEveryonePost.

        The label of the diffusion that will be displayed in the external service event logs of the ContactEveryone service.

        :return: The contact_everyone_diffusion_name of this TransportContactEveryonePost.
        :rtype: str
        """
    ...
    def contact_everyone_diffusion_name(self, contact_everyone_diffusion_name):
        """Sets the contact_everyone_diffusion_name of this TransportContactEveryonePost.
    ...
    def contact_everyone_token(self):
        """Gets the contact_everyone_token of this TransportContactEveryonePost.

        The token for the Contact Everyone service. Stored in encrypted format.

        :return: The contact_everyone_token of this TransportContactEveryonePost.
        :rtype: str
        """
    ...
    def contact_everyone_token(self, contact_everyone_token):
        """Sets the contact_everyone_token of this TransportContactEveryonePost.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportContactEveryonePost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportContactEveryonePost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportContactEveryonePost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportContactEveryonePost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportContactEveryonePost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportContactEveryonePost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportContactEveryonePost.

        The name of the transport.

        :return: The transport_name of this TransportContactEveryonePost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportContactEveryonePost.
