...
class TransportRocketChatPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, rocket_chat_channel: str=None, rocket_chat_token: str=None, transport_name: str=None):
        """TransportRocketChatPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportRocketChatPut.
        :param rocket_chat_channel: The rocket_chat_channel of this TransportRocketChatPut.
        :param rocket_chat_token: The rocket_chat_token of this TransportRocketChatPut.
        :param transport_name: The transport_name of this TransportRocketChatPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportRocketChatPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportRocketChat-put of this TransportRocketChatPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportRocketChatPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportRocketChatPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportRocketChatPut.
    ...
    def rocket_chat_channel(self):
        """Gets the rocket_chat_channel of this TransportRocketChatPut.

        The channel for the Rocket Chat service.

        :return: The rocket_chat_channel of this TransportRocketChatPut.
        :rtype: str
        """
    ...
    def rocket_chat_channel(self, rocket_chat_channel):
        """Sets the rocket_chat_channel of this TransportRocketChatPut.
    ...
    def rocket_chat_token(self):
        """Gets the rocket_chat_token of this TransportRocketChatPut.

        The access token for the Rocket Chat service. Stored in encrypted format.

        :return: The rocket_chat_token of this TransportRocketChatPut.
        :rtype: str
        """
    ...
    def rocket_chat_token(self, rocket_chat_token):
        """Sets the rocket_chat_token of this TransportRocketChatPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportRocketChatPut.

        The name of the transport.

        :return: The transport_name of this TransportRocketChatPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportRocketChatPut.
