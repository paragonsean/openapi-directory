...
class TransportGotifyPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, gotify_api_url: str=None, gotify_app_token: str=None, gotify_priority: str=None, partition: str=None, transport_name: str=None):
        """TransportGotifyPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportGotifyPost.
        :param gotify_api_url: The gotify_api_url of this TransportGotifyPost.
        :param gotify_app_token: The gotify_app_token of this TransportGotifyPost.
        :param gotify_priority: The gotify_priority of this TransportGotifyPost.
        :param partition: The partition of this TransportGotifyPost.
        :param transport_name: The transport_name of this TransportGotifyPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportGotifyPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportGotify-post of this TransportGotifyPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportGotifyPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportGotifyPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportGotifyPost.
    ...
    def gotify_api_url(self):
        """Gets the gotify_api_url of this TransportGotifyPost.

        The API URL name for the Gotify service (https://example.com) - (do not include the path /message/createMessage).

        :return: The gotify_api_url of this TransportGotifyPost.
        :rtype: str
        """
    ...
    def gotify_api_url(self, gotify_api_url):
        """Sets the gotify_api_url of this TransportGotifyPost.
    ...
    def gotify_app_token(self):
        """Gets the gotify_app_token of this TransportGotifyPost.

        The app token for the Gotify service. Stored in encrypted format.

        :return: The gotify_app_token of this TransportGotifyPost.
        :rtype: str
        """
    ...
    def gotify_app_token(self, gotify_app_token):
        """Sets the gotify_app_token of this TransportGotifyPost.
    ...
    def gotify_priority(self):
        """Gets the gotify_priority of this TransportGotifyPost.

        The priority for the Gotify service.

        :return: The gotify_priority of this TransportGotifyPost.
        :rtype: str
        """
    ...
    def gotify_priority(self, gotify_priority):
        """Sets the gotify_priority of this TransportGotifyPost.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportGotifyPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportGotifyPost.

        The name of the transport.

        :return: The transport_name of this TransportGotifyPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportGotifyPost.
