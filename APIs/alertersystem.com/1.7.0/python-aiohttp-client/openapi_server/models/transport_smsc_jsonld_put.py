...
class TransportSmscJsonldPut(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data_segment_code: str=None, smsc_from: str=None, smsc_login: str=None, smsc_password: str=None, transport_name: str=None):
        """TransportSmscJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportSmscJsonldPut.
        :param smsc_from: The smsc_from of this TransportSmscJsonldPut.
        :param smsc_login: The smsc_login of this TransportSmscJsonldPut.
        :param smsc_password: The smsc_password of this TransportSmscJsonldPut.
        :param transport_name: The transport_name of this TransportSmscJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportSmscJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportSmsc.jsonld-put of this TransportSmscJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportSmscJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportSmscJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportSmscJsonldPut.
    ...
    @property
    def smsc_from(self):
        """Gets the smsc_from of this TransportSmscJsonldPut.

        The sender (NB: text identity, not a phone number) for the Smsc service.

        :return: The smsc_from of this TransportSmscJsonldPut.
        :rtype: str
        """
    ...
    def smsc_from(self, smsc_from):
        """Sets the smsc_from of this TransportSmscJsonldPut.
    ...
    @property
    def smsc_login(self):
        """Gets the smsc_login of this TransportSmscJsonldPut.

        The login for the Smsc service.

        :return: The smsc_login of this TransportSmscJsonldPut.
        :rtype: str
        """
    ...
    def smsc_login(self, smsc_login):
        """Sets the smsc_login of this TransportSmscJsonldPut.
    ...
    def smsc_password(self):
        """Gets the smsc_password of this TransportSmscJsonldPut.

        The API password for the Smsc service. Stored in encrypted format.

        :return: The smsc_password of this TransportSmscJsonldPut.
        :rtype: str
        """
    ...
    def smsc_password(self, smsc_password):
        """Sets the smsc_password of this TransportSmscJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportSmscJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportSmscJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportSmscJsonldPut.
