...
class TransportSmsFactorJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, sms_factor_push_type: str=None, sms_factor_sender: str=None, sms_factor_token: str=None, transport_name: str=None):
        """TransportSmsFactorJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportSmsFactorJsonldPut.
        :param sms_factor_push_type: The sms_factor_push_type of this TransportSmsFactorJsonldPut.
        :param sms_factor_sender: The sms_factor_sender of this TransportSmsFactorJsonldPut.
        :param sms_factor_token: The sms_factor_token of this TransportSmsFactorJsonldPut.
        :param transport_name: The transport_name of this TransportSmsFactorJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportSmsFactorJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportSmsFactor.jsonld-put of this TransportSmsFactorJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportSmsFactorJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportSmsFactorJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportSmsFactorJsonldPut.
    ...
    def sms_factor_push_type(self):
        """Gets the sms_factor_push_type of this TransportSmsFactorJsonldPut.

        The push type for the SMSFactor service.

        :return: The sms_factor_push_type of this TransportSmsFactorJsonldPut.
        :rtype: str
        """
    ...
    def sms_factor_push_type(self, sms_factor_push_type):
        """Sets the sms_factor_push_type of this TransportSmsFactorJsonldPut.
    ...
    def sms_factor_sender(self):
        """Gets the sms_factor_sender of this TransportSmsFactorJsonldPut.

        The sender value for the SMSFactor service.

        :return: The sms_factor_sender of this TransportSmsFactorJsonldPut.
        :rtype: str
        """
    ...
    def sms_factor_sender(self, sms_factor_sender):
        """Sets the sms_factor_sender of this TransportSmsFactorJsonldPut.
    ...
    def sms_factor_token(self):
        """Gets the sms_factor_token of this TransportSmsFactorJsonldPut.

        The token for the SMSFactor service. Stored in encrypted format.

        :return: The sms_factor_token of this TransportSmsFactorJsonldPut.
        :rtype: str
        """
    ...
    def sms_factor_token(self, sms_factor_token):
        """Sets the sms_factor_token of this TransportSmsFactorJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportSmsFactorJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportSmsFactorJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportSmsFactorJsonldPut.
