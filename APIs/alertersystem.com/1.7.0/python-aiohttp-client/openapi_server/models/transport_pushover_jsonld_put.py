...
class TransportPushoverJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, pushover_app_token: str=None, pushover_user_key: str=None, transport_name: str=None):
        """TransportPushoverJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportPushoverJsonldPut.
        :param pushover_app_token: The pushover_app_token of this TransportPushoverJsonldPut.
        :param pushover_user_key: The pushover_user_key of this TransportPushoverJsonldPut.
        :param transport_name: The transport_name of this TransportPushoverJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportPushoverJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportPushover.jsonld-put of this TransportPushoverJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportPushoverJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportPushoverJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportPushoverJsonldPut.
    ...
    def pushover_app_token(self):
        """Gets the pushover_app_token of this TransportPushoverJsonldPut.

        The app token for the Pushover service. Stored in encrypted format.

        :return: The pushover_app_token of this TransportPushoverJsonldPut.
        :rtype: str
        """
    ...
    def pushover_app_token(self, pushover_app_token):
        """Sets the pushover_app_token of this TransportPushoverJsonldPut.
    ...
    def pushover_user_key(self):
        """Gets the pushover_user_key of this TransportPushoverJsonldPut.

        The user key for the Pushover service.

        :return: The pushover_user_key of this TransportPushoverJsonldPut.
        :rtype: str
        """
    ...
    def pushover_user_key(self, pushover_user_key):
        """Sets the pushover_user_key of this TransportPushoverJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportPushoverJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportPushoverJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportPushoverJsonldPut.
