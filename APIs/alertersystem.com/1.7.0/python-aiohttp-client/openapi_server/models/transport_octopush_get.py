...
class TransportOctopushGet(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, created_at: datetime=None, data_segment_code: str=None, id: str=None, octopush_api_key: str=None, octopush_from: str=None, octopush_type: str=None, octopush_user_login: str=None, partition: str=None, resource_owner: str=None, transport_name: str=None):
        """TransportOctopushGet - a model defined in OpenAPI

        :param created_at: The created_at of this TransportOctopushGet.
        :param data_segment_code: The data_segment_code of this TransportOctopushGet.
        :param id: The id of this TransportOctopushGet.
        :param octopush_api_key: The octopush_api_key of this TransportOctopushGet.
        :param octopush_from: The octopush_from of this TransportOctopushGet.
        :param octopush_type: The octopush_type of this TransportOctopushGet.
        :param octopush_user_login: The octopush_user_login of this TransportOctopushGet.
        :param partition: The partition of this TransportOctopushGet.
        :param resource_owner: The resource_owner of this TransportOctopushGet.
        :param transport_name: The transport_name of this TransportOctopushGet.
        """
        self.openapi_types = {
            'created_at': datetime,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportOctopushGet':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportOctopush-get of this TransportOctopushGet.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def created_at(self):
        """Gets the created_at of this TransportOctopushGet.

        When the resource instance was created. This date-time is in the UTC timezone.

        :return: The created_at of this TransportOctopushGet.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this TransportOctopushGet.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportOctopushGet.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportOctopushGet.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportOctopushGet.
    ...
    @property
    def id(self):
        """Gets the id of this TransportOctopushGet.

        The unique identifier of the resource instance.

        :return: The id of this TransportOctopushGet.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TransportOctopushGet.
    ...
    def octopush_api_key(self):
        """Gets the octopush_api_key of this TransportOctopushGet.

        The API key for the Octopush service. Stored in encrypted format.

        :return: The octopush_api_key of this TransportOctopushGet.
        :rtype: str
        """
    ...
    def octopush_api_key(self, octopush_api_key):
        """Sets the octopush_api_key of this TransportOctopushGet.
    ...
    def octopush_from(self):
        """Gets the octopush_from of this TransportOctopushGet.

        The sender value for the Octopush service.

        :return: The octopush_from of this TransportOctopushGet.
        :rtype: str
        """
    ...
    def octopush_from(self, octopush_from):
        """Sets the octopush_from of this TransportOctopushGet.
    ...
    def octopush_type(self):
        """Gets the octopush_type of this TransportOctopushGet.

        The SMS type ('XXX' = SMS LowCost; 'FR' = SMS Premium; 'WWW' = SMS World) for the Octopush service.

        :return: The octopush_type of this TransportOctopushGet.
        :rtype: str
        """
    ...
    def octopush_type(self, octopush_type):
        """Sets the octopush_type of this TransportOctopushGet.
    ...
    def octopush_user_login(self):
        """Gets the octopush_user_login of this TransportOctopushGet.

        The user login (email) for the Octopush service.

        :return: The octopush_user_login of this TransportOctopushGet.
        :rtype: str
        """
    ...
    def octopush_user_login(self, octopush_user_login):
        """Sets the octopush_user_login of this TransportOctopushGet.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportOctopushGet.
    ...
    def resource_owner(self):
        """Gets the resource_owner of this TransportOctopushGet.

        The name of the person who owns this resource.

        :return: The resource_owner of this TransportOctopushGet.
        :rtype: str
        """
    ...
    def resource_owner(self, resource_owner):
        """Sets the resource_owner of this TransportOctopushGet.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportOctopushGet.

        The name of the transport.

        :return: The transport_name of this TransportOctopushGet.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportOctopushGet.
