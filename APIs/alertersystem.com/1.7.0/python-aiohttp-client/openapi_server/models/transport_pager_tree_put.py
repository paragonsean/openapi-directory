...
class TransportPagerTreePut(Model):
    ...
    def __init__(self, data_segment_code: str=None, pager_tree_access_token: str=None, pager_tree_account_user_id: str=None, pager_tree_router_id: str=None, pager_tree_team_id: str=None, pager_tree_urgency: str=None, transport_name: str=None):
        """TransportPagerTreePut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportPagerTreePut.
        :param pager_tree_access_token: The pager_tree_access_token of this TransportPagerTreePut.
        :param pager_tree_account_user_id: The pager_tree_account_user_id of this TransportPagerTreePut.
        :param pager_tree_router_id: The pager_tree_router_id of this TransportPagerTreePut.
        :param pager_tree_team_id: The pager_tree_team_id of this TransportPagerTreePut.
        :param pager_tree_urgency: The pager_tree_urgency of this TransportPagerTreePut.
        :param transport_name: The transport_name of this TransportPagerTreePut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportPagerTreePut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportPagerTree-put of this TransportPagerTreePut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportPagerTreePut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportPagerTreePut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportPagerTreePut.
    ...
    def pager_tree_access_token(self):
        """Gets the pager_tree_access_token of this TransportPagerTreePut.

        The access token for the Pager Tree service. Stored in encrypted format.

        :return: The pager_tree_access_token of this TransportPagerTreePut.
        :rtype: str
        """
    ...
    def pager_tree_access_token(self, pager_tree_access_token):
        """Sets the pager_tree_access_token of this TransportPagerTreePut.
    ...
    def pager_tree_account_user_id(self):
        """Gets the pager_tree_account_user_id of this TransportPagerTreePut.

        The account user ID for the Pager Tree service. (Must supply either team ID, router ID or account user ID.)

        :return: The pager_tree_account_user_id of this TransportPagerTreePut.
        :rtype: str
        """
    ...
    def pager_tree_account_user_id(self, pager_tree_account_user_id):
        """Sets the pager_tree_account_user_id of this TransportPagerTreePut.
    ...
    def pager_tree_router_id(self):
        """Gets the pager_tree_router_id of this TransportPagerTreePut.

        The router ID for the Pager Tree service. (Must supply either team ID, router ID or account user ID.)

        :return: The pager_tree_router_id of this TransportPagerTreePut.
        :rtype: str
        """
    ...
    def pager_tree_router_id(self, pager_tree_router_id):
        """Sets the pager_tree_router_id of this TransportPagerTreePut.
    ...
    def pager_tree_team_id(self):
        """Gets the pager_tree_team_id of this TransportPagerTreePut.

        The team ID for the Pager Tree service. (Must supply either team ID, router ID or account user ID.)

        :return: The pager_tree_team_id of this TransportPagerTreePut.
        :rtype: str
        """
    ...
    def pager_tree_team_id(self, pager_tree_team_id):
        """Sets the pager_tree_team_id of this TransportPagerTreePut.
    ...
    def pager_tree_urgency(self):
        """Gets the pager_tree_urgency of this TransportPagerTreePut.

        The urgency for the Pager Tree service.

        :return: The pager_tree_urgency of this TransportPagerTreePut.
        :rtype: str
        """
    ...
    def pager_tree_urgency(self, pager_tree_urgency):
        """Sets the pager_tree_urgency of this TransportPagerTreePut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportPagerTreePut.

        The name of the transport.

        :return: The transport_name of this TransportPagerTreePut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportPagerTreePut.
