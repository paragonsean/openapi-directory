...
class TransportSmscJsonldPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition: str=None, smsc_from: str=None, smsc_login: str=None, smsc_password: str=None, transport_name: str=None):
        """TransportSmscJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportSmscJsonldPost.
        :param partition: The partition of this TransportSmscJsonldPost.
        :param smsc_from: The smsc_from of this TransportSmscJsonldPost.
        :param smsc_login: The smsc_login of this TransportSmscJsonldPost.
        :param smsc_password: The smsc_password of this TransportSmscJsonldPost.
        :param transport_name: The transport_name of this TransportSmscJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportSmscJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportSmsc.jsonld-post of this TransportSmscJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportSmscJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportSmscJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportSmscJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportSmscJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportSmscJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportSmscJsonldPost.
    ...
    @property
    def smsc_from(self):
        """Gets the smsc_from of this TransportSmscJsonldPost.

        The sender (NB: text identity, not a phone number) for the Smsc service.

        :return: The smsc_from of this TransportSmscJsonldPost.
        :rtype: str
        """
    ...
    def smsc_from(self, smsc_from):
        """Sets the smsc_from of this TransportSmscJsonldPost.
    ...
    @property
    def smsc_login(self):
        """Gets the smsc_login of this TransportSmscJsonldPost.

        The login for the Smsc service.

        :return: The smsc_login of this TransportSmscJsonldPost.
        :rtype: str
        """
    ...
    def smsc_login(self, smsc_login):
        """Sets the smsc_login of this TransportSmscJsonldPost.
    ...
    def smsc_password(self):
        """Gets the smsc_password of this TransportSmscJsonldPost.

        The API password for the Smsc service. Stored in encrypted format.

        :return: The smsc_password of this TransportSmscJsonldPost.
        :rtype: str
        """
    ...
    def smsc_password(self, smsc_password):
        """Sets the smsc_password of this TransportSmscJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportSmscJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportSmscJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportSmscJsonldPost.
