...
class TransportFreshdeskJsonldGet(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, context: AlertLogJsonldGetContext=None, id: str=None, type: str=None, created_at: datetime=None, data_segment_code: str=None, freshdesk_api_key: str=None, freshdesk_email: str=None, freshdesk_host: str=None, freshdesk_priority: str=None, freshdesk_type: str=None, id: str=None, partition: str=None, resource_owner: str=None, transport_name: str=None):
        """TransportFreshdeskJsonldGet - a model defined in OpenAPI

        :param context: The context of this TransportFreshdeskJsonldGet.
        :param id: The id of this TransportFreshdeskJsonldGet.
        :param type: The type of this TransportFreshdeskJsonldGet.
        :param created_at: The created_at of this TransportFreshdeskJsonldGet.
        :param data_segment_code: The data_segment_code of this TransportFreshdeskJsonldGet.
        :param freshdesk_api_key: The freshdesk_api_key of this TransportFreshdeskJsonldGet.
        :param freshdesk_email: The freshdesk_email of this TransportFreshdeskJsonldGet.
        :param freshdesk_host: The freshdesk_host of this TransportFreshdeskJsonldGet.
        :param freshdesk_priority: The freshdesk_priority of this TransportFreshdeskJsonldGet.
        :param freshdesk_type: The freshdesk_type of this TransportFreshdeskJsonldGet.
        :param id: The id of this TransportFreshdeskJsonldGet.
        :param partition: The partition of this TransportFreshdeskJsonldGet.
        :param resource_owner: The resource_owner of this TransportFreshdeskJsonldGet.
        :param transport_name: The transport_name of this TransportFreshdeskJsonldGet.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportFreshdeskJsonldGet':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportFreshdesk.jsonld-get of this TransportFreshdeskJsonldGet.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def context(self):
        """Gets the context of this TransportFreshdeskJsonldGet.


        :return: The context of this TransportFreshdeskJsonldGet.
    ...
    def context(self, context):
        """Sets the context of this TransportFreshdeskJsonldGet.
    ...
    @property
    def id(self):
        """Gets the id of this TransportFreshdeskJsonldGet.


        :return: The id of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TransportFreshdeskJsonldGet.
    ...
    @property
    def type(self):
        """Gets the type of this TransportFreshdeskJsonldGet.


        :return: The type of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TransportFreshdeskJsonldGet.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this TransportFreshdeskJsonldGet.

        When the resource instance was created. This date-time is in the UTC timezone.

        :return: The created_at of this TransportFreshdeskJsonldGet.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this TransportFreshdeskJsonldGet.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportFreshdeskJsonldGet.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportFreshdeskJsonldGet.
    ...
    def freshdesk_api_key(self):
        """Gets the freshdesk_api_key of this TransportFreshdeskJsonldGet.

        The API key for the Freshdesk service. Stored in encrypted format.

        :return: The freshdesk_api_key of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
    ...
    def freshdesk_api_key(self, freshdesk_api_key):
        """Sets the freshdesk_api_key of this TransportFreshdeskJsonldGet.
    ...
    def freshdesk_email(self):
        """Gets the freshdesk_email of this TransportFreshdeskJsonldGet.

        The requester email address for the Freshdesk service.

        :return: The freshdesk_email of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
    ...
    def freshdesk_email(self, freshdesk_email):
        """Sets the freshdesk_email of this TransportFreshdeskJsonldGet.
    ...
    def freshdesk_host(self):
        """Gets the freshdesk_host of this TransportFreshdeskJsonldGet.

        The host name for the Freshdesk service (domain.freshdesk.com).

        :return: The freshdesk_host of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
    ...
    def freshdesk_host(self, freshdesk_host):
        """Sets the freshdesk_host of this TransportFreshdeskJsonldGet.
    ...
    def freshdesk_priority(self):
        """Gets the freshdesk_priority of this TransportFreshdeskJsonldGet.

        The ticket priority for the Freshdesk service.

        :return: The freshdesk_priority of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
    ...
    def freshdesk_priority(self, freshdesk_priority):
        """Sets the freshdesk_priority of this TransportFreshdeskJsonldGet.
    ...
    def freshdesk_type(self):
        """Gets the freshdesk_type of this TransportFreshdeskJsonldGet.

        The ticket type for the Freshdesk service.

        :return: The freshdesk_type of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
    ...
    def freshdesk_type(self, freshdesk_type):
        """Sets the freshdesk_type of this TransportFreshdeskJsonldGet.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportFreshdeskJsonldGet.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportFreshdeskJsonldGet.
    ...
    def resource_owner(self):
        """Gets the resource_owner of this TransportFreshdeskJsonldGet.

        The name of the person who owns this resource.

        :return: The resource_owner of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
    ...
    def resource_owner(self, resource_owner):
        """Sets the resource_owner of this TransportFreshdeskJsonldGet.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportFreshdeskJsonldGet.

        The name of the transport.

        :return: The transport_name of this TransportFreshdeskJsonldGet.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportFreshdeskJsonldGet.
