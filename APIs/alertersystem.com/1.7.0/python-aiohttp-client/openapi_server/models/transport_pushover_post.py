...
class TransportPushoverPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition: str=None, pushover_app_token: str=None, pushover_user_key: str=None, transport_name: str=None):
        """TransportPushoverPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportPushoverPost.
        :param partition: The partition of this TransportPushoverPost.
        :param pushover_app_token: The pushover_app_token of this TransportPushoverPost.
        :param pushover_user_key: The pushover_user_key of this TransportPushoverPost.
        :param transport_name: The transport_name of this TransportPushoverPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportPushoverPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportPushover-post of this TransportPushoverPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportPushoverPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportPushoverPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportPushoverPost.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportPushoverPost.
    ...
    def pushover_app_token(self):
        """Gets the pushover_app_token of this TransportPushoverPost.

        The app token for the Pushover service. Stored in encrypted format.

        :return: The pushover_app_token of this TransportPushoverPost.
        :rtype: str
        """
    ...
    def pushover_app_token(self, pushover_app_token):
        """Sets the pushover_app_token of this TransportPushoverPost.
    ...
    def pushover_user_key(self):
        """Gets the pushover_user_key of this TransportPushoverPost.

        The user key for the Pushover service.

        :return: The pushover_user_key of this TransportPushoverPost.
        :rtype: str
        """
    ...
    def pushover_user_key(self, pushover_user_key):
        """Sets the pushover_user_key of this TransportPushoverPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportPushoverPost.

        The name of the transport.

        :return: The transport_name of this TransportPushoverPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportPushoverPost.
