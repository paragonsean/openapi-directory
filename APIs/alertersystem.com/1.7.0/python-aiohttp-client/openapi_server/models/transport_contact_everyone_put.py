...
class TransportContactEveryonePut(Model):
    ...
    def __init__(self, contact_everyone_category: str=None, contact_everyone_diffusion_name: str=None, contact_everyone_token: str=None, data_segment_code: str=None, transport_name: str=None):
        """TransportContactEveryonePut - a model defined in OpenAPI

        :param contact_everyone_category: The contact_everyone_category of this TransportContactEveryonePut.
        :param contact_everyone_diffusion_name: The contact_everyone_diffusion_name of this TransportContactEveryonePut.
        :param contact_everyone_token: The contact_everyone_token of this TransportContactEveryonePut.
        :param data_segment_code: The data_segment_code of this TransportContactEveryonePut.
        :param transport_name: The transport_name of this TransportContactEveryonePut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportContactEveryonePut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportContactEveryone-put of this TransportContactEveryonePut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def contact_everyone_category(self):
        """Gets the contact_everyone_category of this TransportContactEveryonePut.

        The label of the category that will be displayed in the external service event logs of the ContactEveryone service.

        :return: The contact_everyone_category of this TransportContactEveryonePut.
        :rtype: str
        """
    ...
    def contact_everyone_category(self, contact_everyone_category):
        """Sets the contact_everyone_category of this TransportContactEveryonePut.
    ...
    def contact_everyone_diffusion_name(self):
        """Gets the contact_everyone_diffusion_name of this TransportContactEveryonePut.

        The label of the diffusion that will be displayed in the external service event logs of the ContactEveryone service.

        :return: The contact_everyone_diffusion_name of this TransportContactEveryonePut.
        :rtype: str
        """
    ...
    def contact_everyone_diffusion_name(self, contact_everyone_diffusion_name):
        """Sets the contact_everyone_diffusion_name of this TransportContactEveryonePut.
    ...
    def contact_everyone_token(self):
        """Gets the contact_everyone_token of this TransportContactEveryonePut.

        The token for the Contact Everyone service. Stored in encrypted format.

        :return: The contact_everyone_token of this TransportContactEveryonePut.
        :rtype: str
        """
    ...
    def contact_everyone_token(self, contact_everyone_token):
        """Sets the contact_everyone_token of this TransportContactEveryonePut.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportContactEveryonePut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportContactEveryonePut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportContactEveryonePut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportContactEveryonePut.

        The name of the transport.

        :return: The transport_name of this TransportContactEveryonePut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportContactEveryonePut.
