...
class TransportMercureGet(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, created_at: datetime=None, data_segment_code: str=None, id: str=None, mercure_hub_jwt_token: str=None, mercure_hub_url: str=None, mercure_topic: str=None, partition: str=None, resource_owner: str=None, transport_name: str=None):
        """TransportMercureGet - a model defined in OpenAPI

        :param created_at: The created_at of this TransportMercureGet.
        :param data_segment_code: The data_segment_code of this TransportMercureGet.
        :param id: The id of this TransportMercureGet.
        :param mercure_hub_jwt_token: The mercure_hub_jwt_token of this TransportMercureGet.
        :param mercure_hub_url: The mercure_hub_url of this TransportMercureGet.
        :param mercure_topic: The mercure_topic of this TransportMercureGet.
        :param partition: The partition of this TransportMercureGet.
        :param resource_owner: The resource_owner of this TransportMercureGet.
        :param transport_name: The transport_name of this TransportMercureGet.
        """
        self.openapi_types = {
            'created_at': datetime,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportMercureGet':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportMercure-get of this TransportMercureGet.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def created_at(self):
        """Gets the created_at of this TransportMercureGet.

        When the resource instance was created. This date-time is in the UTC timezone.

        :return: The created_at of this TransportMercureGet.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this TransportMercureGet.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportMercureGet.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportMercureGet.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportMercureGet.
    ...
    @property
    def id(self):
        """Gets the id of this TransportMercureGet.

        The unique identifier of the resource instance.

        :return: The id of this TransportMercureGet.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TransportMercureGet.
    ...
    def mercure_hub_jwt_token(self):
        """Gets the mercure_hub_jwt_token of this TransportMercureGet.

        The JWT token for the hub for the Mercure service. Stored in encrypted format.

        :return: The mercure_hub_jwt_token of this TransportMercureGet.
        :rtype: str
        """
    ...
    def mercure_hub_jwt_token(self, mercure_hub_jwt_token):
        """Sets the mercure_hub_jwt_token of this TransportMercureGet.
    ...
    def mercure_hub_url(self):
        """Gets the mercure_hub_url of this TransportMercureGet.

        The URL for the hub for the Mercure service.

        :return: The mercure_hub_url of this TransportMercureGet.
        :rtype: str
        """
    ...
    def mercure_hub_url(self, mercure_hub_url):
        """Sets the mercure_hub_url of this TransportMercureGet.
    ...
    def mercure_topic(self):
        """Gets the mercure_topic of this TransportMercureGet.

        The optional topic for the Mercure service.

        :return: The mercure_topic of this TransportMercureGet.
        :rtype: str
        """
    ...
    def mercure_topic(self, mercure_topic):
        """Sets the mercure_topic of this TransportMercureGet.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportMercureGet.
    ...
    def resource_owner(self):
        """Gets the resource_owner of this TransportMercureGet.

        The name of the person who owns this resource.

        :return: The resource_owner of this TransportMercureGet.
        :rtype: str
        """
    ...
    def resource_owner(self, resource_owner):
        """Sets the resource_owner of this TransportMercureGet.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportMercureGet.

        The name of the transport.

        :return: The transport_name of this TransportMercureGet.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportMercureGet.
