...
class TransportZendeskPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, transport_name: str=None, zendesk_email: str=None, zendesk_host: str=None, zendesk_token: str=None):
        """TransportZendeskPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportZendeskPut.
        :param transport_name: The transport_name of this TransportZendeskPut.
        :param zendesk_email: The zendesk_email of this TransportZendeskPut.
        :param zendesk_host: The zendesk_host of this TransportZendeskPut.
        :param zendesk_token: The zendesk_token of this TransportZendeskPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportZendeskPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportZendesk-put of this TransportZendeskPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportZendeskPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportZendeskPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportZendeskPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportZendeskPut.

        The name of the transport.

        :return: The transport_name of this TransportZendeskPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportZendeskPut.
    ...
    def zendesk_email(self):
        """Gets the zendesk_email of this TransportZendeskPut.

        The login email address for the Zendesk service.

        :return: The zendesk_email of this TransportZendeskPut.
        :rtype: str
        """
    ...
    def zendesk_email(self, zendesk_email):
        """Sets the zendesk_email of this TransportZendeskPut.
    ...
    def zendesk_host(self):
        """Gets the zendesk_host of this TransportZendeskPut.

        The host name for the Zendesk service (domain.zendesk.com).

        :return: The zendesk_host of this TransportZendeskPut.
        :rtype: str
        """
    ...
    def zendesk_host(self, zendesk_host):
        """Sets the zendesk_host of this TransportZendeskPut.
    ...
    def zendesk_token(self):
        """Gets the zendesk_token of this TransportZendeskPut.

        The token for the Zendesk service. Stored in encrypted format.

        :return: The zendesk_token of this TransportZendeskPut.
        :rtype: str
        """
    ...
    def zendesk_token(self, zendesk_token):
        """Sets the zendesk_token of this TransportZendeskPut.
