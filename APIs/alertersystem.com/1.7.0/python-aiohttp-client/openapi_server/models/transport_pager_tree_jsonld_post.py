...
class TransportPagerTreeJsonldPost(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data_segment_code: str=None, pager_tree_access_token: str=None, pager_tree_account_user_id: str=None, pager_tree_router_id: str=None, pager_tree_team_id: str=None, pager_tree_urgency: str=None, partition: str=None, transport_name: str=None):
        """TransportPagerTreeJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportPagerTreeJsonldPost.
        :param pager_tree_access_token: The pager_tree_access_token of this TransportPagerTreeJsonldPost.
        :param pager_tree_account_user_id: The pager_tree_account_user_id of this TransportPagerTreeJsonldPost.
        :param pager_tree_router_id: The pager_tree_router_id of this TransportPagerTreeJsonldPost.
        :param pager_tree_team_id: The pager_tree_team_id of this TransportPagerTreeJsonldPost.
        :param pager_tree_urgency: The pager_tree_urgency of this TransportPagerTreeJsonldPost.
        :param partition: The partition of this TransportPagerTreeJsonldPost.
        :param transport_name: The transport_name of this TransportPagerTreeJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportPagerTreeJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportPagerTree.jsonld-post of this TransportPagerTreeJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportPagerTreeJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportPagerTreeJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportPagerTreeJsonldPost.
    ...
    def pager_tree_access_token(self):
        """Gets the pager_tree_access_token of this TransportPagerTreeJsonldPost.

        The access token for the Pager Tree service. Stored in encrypted format.

        :return: The pager_tree_access_token of this TransportPagerTreeJsonldPost.
        :rtype: str
        """
    ...
    def pager_tree_access_token(self, pager_tree_access_token):
        """Sets the pager_tree_access_token of this TransportPagerTreeJsonldPost.
    ...
    def pager_tree_account_user_id(self):
        """Gets the pager_tree_account_user_id of this TransportPagerTreeJsonldPost.

        The account user ID for the Pager Tree service. (Must supply either team ID, router ID or account user ID.)

        :return: The pager_tree_account_user_id of this TransportPagerTreeJsonldPost.
        :rtype: str
        """
    ...
    def pager_tree_account_user_id(self, pager_tree_account_user_id):
        """Sets the pager_tree_account_user_id of this TransportPagerTreeJsonldPost.
    ...
    def pager_tree_router_id(self):
        """Gets the pager_tree_router_id of this TransportPagerTreeJsonldPost.

        The router ID for the Pager Tree service. (Must supply either team ID, router ID or account user ID.)

        :return: The pager_tree_router_id of this TransportPagerTreeJsonldPost.
        :rtype: str
        """
    ...
    def pager_tree_router_id(self, pager_tree_router_id):
        """Sets the pager_tree_router_id of this TransportPagerTreeJsonldPost.
    ...
    def pager_tree_team_id(self):
        """Gets the pager_tree_team_id of this TransportPagerTreeJsonldPost.

        The team ID for the Pager Tree service. (Must supply either team ID, router ID or account user ID.)

        :return: The pager_tree_team_id of this TransportPagerTreeJsonldPost.
        :rtype: str
        """
    ...
    def pager_tree_team_id(self, pager_tree_team_id):
        """Sets the pager_tree_team_id of this TransportPagerTreeJsonldPost.
    ...
    def pager_tree_urgency(self):
        """Gets the pager_tree_urgency of this TransportPagerTreeJsonldPost.

        The urgency for the Pager Tree service.

        :return: The pager_tree_urgency of this TransportPagerTreeJsonldPost.
        :rtype: str
        """
    ...
    def pager_tree_urgency(self, pager_tree_urgency):
        """Sets the pager_tree_urgency of this TransportPagerTreeJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportPagerTreeJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportPagerTreeJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportPagerTreeJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportPagerTreeJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportPagerTreeJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportPagerTreeJsonldPost.
