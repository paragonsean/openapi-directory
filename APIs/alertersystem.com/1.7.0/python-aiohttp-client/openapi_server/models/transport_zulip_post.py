...
class TransportZulipPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition: str=None, transport_name: str=None, zulip_channel: str=None, zulip_email: str=None, zulip_host: str=None, zulip_token: str=None):
        """TransportZulipPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportZulipPost.
        :param partition: The partition of this TransportZulipPost.
        :param transport_name: The transport_name of this TransportZulipPost.
        :param zulip_channel: The zulip_channel of this TransportZulipPost.
        :param zulip_email: The zulip_email of this TransportZulipPost.
        :param zulip_host: The zulip_host of this TransportZulipPost.
        :param zulip_token: The zulip_token of this TransportZulipPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportZulipPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportZulip-post of this TransportZulipPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportZulipPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportZulipPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportZulipPost.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportZulipPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportZulipPost.

        The name of the transport.

        :return: The transport_name of this TransportZulipPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportZulipPost.
    ...
    def zulip_channel(self):
        """Gets the zulip_channel of this TransportZulipPost.

        The channel for the Zulip service.

        :return: The zulip_channel of this TransportZulipPost.
        :rtype: str
        """
    ...
    def zulip_channel(self, zulip_channel):
        """Sets the zulip_channel of this TransportZulipPost.
    ...
    def zulip_email(self):
        """Gets the zulip_email of this TransportZulipPost.

        The email for the Zulip service.

        :return: The zulip_email of this TransportZulipPost.
        :rtype: str
        """
    ...
    def zulip_email(self, zulip_email):
        """Sets the zulip_email of this TransportZulipPost.
    ...
    @property
    def zulip_host(self):
        """Gets the zulip_host of this TransportZulipPost.

        The host for the Zulip service.

        :return: The zulip_host of this TransportZulipPost.
        :rtype: str
        """
    ...
    def zulip_host(self, zulip_host):
        """Sets the zulip_host of this TransportZulipPost.
    ...
    def zulip_token(self):
        """Gets the zulip_token of this TransportZulipPost.

        The token for the Zulip service. Stored in encrypted format.

        :return: The zulip_token of this TransportZulipPost.
        :rtype: str
        """
    ...
    def zulip_token(self, zulip_token):
        """Sets the zulip_token of this TransportZulipPost.
