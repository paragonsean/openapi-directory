...
class TransportGotifyJsonldPost(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data_segment_code: str=None, gotify_api_url: str=None, gotify_app_token: str=None, gotify_priority: str=None, partition: str=None, transport_name: str=None):
        """TransportGotifyJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportGotifyJsonldPost.
        :param gotify_api_url: The gotify_api_url of this TransportGotifyJsonldPost.
        :param gotify_app_token: The gotify_app_token of this TransportGotifyJsonldPost.
        :param gotify_priority: The gotify_priority of this TransportGotifyJsonldPost.
        :param partition: The partition of this TransportGotifyJsonldPost.
        :param transport_name: The transport_name of this TransportGotifyJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportGotifyJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportGotify.jsonld-post of this TransportGotifyJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportGotifyJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportGotifyJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportGotifyJsonldPost.
    ...
    def gotify_api_url(self):
        """Gets the gotify_api_url of this TransportGotifyJsonldPost.

        The API URL name for the Gotify service (https://example.com) - (do not include the path /message/createMessage).

        :return: The gotify_api_url of this TransportGotifyJsonldPost.
        :rtype: str
        """
    ...
    def gotify_api_url(self, gotify_api_url):
        """Sets the gotify_api_url of this TransportGotifyJsonldPost.
    ...
    def gotify_app_token(self):
        """Gets the gotify_app_token of this TransportGotifyJsonldPost.

        The app token for the Gotify service. Stored in encrypted format.

        :return: The gotify_app_token of this TransportGotifyJsonldPost.
        :rtype: str
        """
    ...
    def gotify_app_token(self, gotify_app_token):
        """Sets the gotify_app_token of this TransportGotifyJsonldPost.
    ...
    def gotify_priority(self):
        """Gets the gotify_priority of this TransportGotifyJsonldPost.

        The priority for the Gotify service.

        :return: The gotify_priority of this TransportGotifyJsonldPost.
        :rtype: str
        """
    ...
    def gotify_priority(self, gotify_priority):
        """Sets the gotify_priority of this TransportGotifyJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportGotifyJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportGotifyJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportGotifyJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportGotifyJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportGotifyJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportGotifyJsonldPost.
