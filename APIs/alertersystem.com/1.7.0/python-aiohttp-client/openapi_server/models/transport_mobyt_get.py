...
class TransportMobytGet(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, created_at: datetime=None, data_segment_code: str=None, id: str=None, mobyt_access_token: str=None, mobyt_from: str=None, mobyt_type_quality: str=None, mobyt_user_key: str=None, partition: str=None, resource_owner: str=None, transport_name: str=None):
        """TransportMobytGet - a model defined in OpenAPI

        :param created_at: The created_at of this TransportMobytGet.
        :param data_segment_code: The data_segment_code of this TransportMobytGet.
        :param id: The id of this TransportMobytGet.
        :param mobyt_access_token: The mobyt_access_token of this TransportMobytGet.
        :param mobyt_from: The mobyt_from of this TransportMobytGet.
        :param mobyt_type_quality: The mobyt_type_quality of this TransportMobytGet.
        :param mobyt_user_key: The mobyt_user_key of this TransportMobytGet.
        :param partition: The partition of this TransportMobytGet.
        :param resource_owner: The resource_owner of this TransportMobytGet.
        :param transport_name: The transport_name of this TransportMobytGet.
        """
        self.openapi_types = {
            'created_at': datetime,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportMobytGet':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportMobyt-get of this TransportMobytGet.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def created_at(self):
        """Gets the created_at of this TransportMobytGet.

        When the resource instance was created. This date-time is in the UTC timezone.

        :return: The created_at of this TransportMobytGet.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this TransportMobytGet.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportMobytGet.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportMobytGet.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportMobytGet.
    ...
    @property
    def id(self):
        """Gets the id of this TransportMobytGet.

        The unique identifier of the resource instance.

        :return: The id of this TransportMobytGet.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TransportMobytGet.
    ...
    def mobyt_access_token(self):
        """Gets the mobyt_access_token of this TransportMobytGet.

        The access token for the Mobyt service. Stored in encrypted format.

        :return: The mobyt_access_token of this TransportMobytGet.
        :rtype: str
        """
    ...
    def mobyt_access_token(self, mobyt_access_token):
        """Sets the mobyt_access_token of this TransportMobytGet.
    ...
    @property
    def mobyt_from(self):
        """Gets the mobyt_from of this TransportMobytGet.

        The sender for the Mobyt service.

        :return: The mobyt_from of this TransportMobytGet.
        :rtype: str
        """
    ...
    def mobyt_from(self, mobyt_from):
        """Sets the mobyt_from of this TransportMobytGet.
    ...
    def mobyt_type_quality(self):
        """Gets the mobyt_type_quality of this TransportMobytGet.

        The quality of your message: 'N' for high, 'L' for medium, 'LL' for low, for the Mobyt service.

        :return: The mobyt_type_quality of this TransportMobytGet.
        :rtype: str
        """
    ...
    def mobyt_type_quality(self, mobyt_type_quality):
        """Sets the mobyt_type_quality of this TransportMobytGet.
    ...
    def mobyt_user_key(self):
        """Gets the mobyt_user_key of this TransportMobytGet.

        The user key for the Mobyt service.

        :return: The mobyt_user_key of this TransportMobytGet.
        :rtype: str
        """
    ...
    def mobyt_user_key(self, mobyt_user_key):
        """Sets the mobyt_user_key of this TransportMobytGet.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportMobytGet.
    ...
    def resource_owner(self):
        """Gets the resource_owner of this TransportMobytGet.

        The name of the person who owns this resource.

        :return: The resource_owner of this TransportMobytGet.
        :rtype: str
        """
    ...
    def resource_owner(self, resource_owner):
        """Sets the resource_owner of this TransportMobytGet.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportMobytGet.

        The name of the transport.

        :return: The transport_name of this TransportMobytGet.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportMobytGet.
