...
class UserAccountJsonldPut(Model):
    ...
    def __init__(self, credits_overage_percent_trip_switch: int=None):
        """UserAccountJsonldPut - a model defined in OpenAPI

        :param credits_overage_percent_trip_switch: The credits_overage_percent_trip_switch of this UserAccountJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UserAccountJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UserAccount.jsonld-put of this UserAccountJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def credits_overage_percent_trip_switch(self):
        """Gets the credits_overage_percent_trip_switch of this UserAccountJsonldPut.
        ...
        :return: The credits_overage_percent_trip_switch of this UserAccountJsonldPut.
        :rtype: int
        """
    ...
    def credits_overage_percent_trip_switch(self, credits_overage_percent_trip_switch):
        """Sets the credits_overage_percent_trip_switch of this UserAccountJsonldPut.
