...
class PingJsonldPost(Model):
    ...
    def __init__(self, expect_next_ping_at: datetime=None, expect_next_ping_at_epoch: int=None, monitor: str=None, ping_custom_code: str=None, ping_custom_payload: str=None):
        """PingJsonldPost - a model defined in OpenAPI

        :param expect_next_ping_at: The expect_next_ping_at of this PingJsonldPost.
        :param expect_next_ping_at_epoch: The expect_next_ping_at_epoch of this PingJsonldPost.
        :param monitor: The monitor of this PingJsonldPost.
        :param ping_custom_code: The ping_custom_code of this PingJsonldPost.
        :param ping_custom_payload: The ping_custom_payload of this PingJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PingJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Ping.jsonld-post of this PingJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def expect_next_ping_at(self):
        """Gets the expect_next_ping_at of this PingJsonldPost.
        ...
        :return: The expect_next_ping_at of this PingJsonldPost.
        :rtype: datetime
        """
    ...
    def expect_next_ping_at(self, expect_next_ping_at):
        """Sets the expect_next_ping_at of this PingJsonldPost.
    ...
    def expect_next_ping_at_epoch(self):
        """Gets the expect_next_ping_at_epoch of this PingJsonldPost.
        ...
        :return: The expect_next_ping_at_epoch of this PingJsonldPost.
        :rtype: int
        """
    ...
    def expect_next_ping_at_epoch(self, expect_next_ping_at_epoch):
        """Sets the expect_next_ping_at_epoch of this PingJsonldPost.
    ...
    @property
    def monitor(self):
        """Gets the monitor of this PingJsonldPost.

        The monitor that is related to this resource instance.

        :return: The monitor of this PingJsonldPost.
        :rtype: str
        """
    ...
    def monitor(self, monitor):
        """Sets the monitor of this PingJsonldPost.
    ...
    def ping_custom_code(self, ping_custom_code):
        """Sets the ping_custom_code of this PingJsonldPost.
    ...
    def ping_custom_payload(self):
        """Gets the ping_custom_payload of this PingJsonldPost.
        ...
        :return: The ping_custom_payload of this PingJsonldPost.
        :rtype: str
        """
    ...
    def ping_custom_payload(self, ping_custom_payload):
        """Sets the ping_custom_payload of this PingJsonldPost.
