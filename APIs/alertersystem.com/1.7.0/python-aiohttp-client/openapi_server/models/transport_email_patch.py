...
class TransportEmailPatch(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data_segment_code: str=None, email_from_address: str=None, email_from_name: str=None, email_password: str=None, email_port: int=None, email_server: str=None, email_username: str=None, transport_name: str=None):
        """TransportEmailPatch - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportEmailPatch.
        :param email_from_address: The email_from_address of this TransportEmailPatch.
        :param email_from_name: The email_from_name of this TransportEmailPatch.
        :param email_password: The email_password of this TransportEmailPatch.
        :param email_port: The email_port of this TransportEmailPatch.
        :param email_server: The email_server of this TransportEmailPatch.
        :param email_username: The email_username of this TransportEmailPatch.
        :param transport_name: The transport_name of this TransportEmailPatch.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportEmailPatch':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportEmail-patch of this TransportEmailPatch.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportEmailPatch.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportEmailPatch.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportEmailPatch.
    ...
    def email_from_address(self):
        """Gets the email_from_address of this TransportEmailPatch.

        The sender email address for the SMTP Email service.

        :return: The email_from_address of this TransportEmailPatch.
        :rtype: str
        """
    ...
    def email_from_address(self, email_from_address):
        """Sets the email_from_address of this TransportEmailPatch.
    ...
    def email_from_name(self):
        """Gets the email_from_name of this TransportEmailPatch.

        The sender name for the SMTP Email service.

        :return: The email_from_name of this TransportEmailPatch.
        :rtype: str
        """
    ...
    def email_from_name(self, email_from_name):
        """Sets the email_from_name of this TransportEmailPatch.
    ...
    def email_password(self):
        """Gets the email_password of this TransportEmailPatch.

        The password for the SMTP Email service. Stored in encrypted format.

        :return: The email_password of this TransportEmailPatch.
        :rtype: str
        """
    ...
    def email_password(self, email_password):
        """Sets the email_password of this TransportEmailPatch.
    ...
    @property
    def email_port(self):
        """Gets the email_port of this TransportEmailPatch.

        The port for the SMTP Email service.

        :return: The email_port of this TransportEmailPatch.
        :rtype: int
        """
    ...
    def email_port(self, email_port):
        """Sets the email_port of this TransportEmailPatch.
    ...
    def email_server(self):
        """Gets the email_server of this TransportEmailPatch.

        The server for the SMTP Email service.

        :return: The email_server of this TransportEmailPatch.
        :rtype: str
        """
    ...
    def email_server(self, email_server):
        """Sets the email_server of this TransportEmailPatch.
    ...
    def email_username(self):
        """Gets the email_username of this TransportEmailPatch.

        The username for the SMTP Email service.

        :return: The email_username of this TransportEmailPatch.
        :rtype: str
        """
    ...
    def email_username(self, email_username):
        """Sets the email_username of this TransportEmailPatch.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportEmailPatch.

        The name of the transport.

        :return: The transport_name of this TransportEmailPatch.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportEmailPatch.
