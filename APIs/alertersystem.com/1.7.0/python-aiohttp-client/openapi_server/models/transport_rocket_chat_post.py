...
class TransportRocketChatPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition: str=None, rocket_chat_channel: str=None, rocket_chat_token: str=None, transport_name: str=None):
        """TransportRocketChatPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportRocketChatPost.
        :param partition: The partition of this TransportRocketChatPost.
        :param rocket_chat_channel: The rocket_chat_channel of this TransportRocketChatPost.
        :param rocket_chat_token: The rocket_chat_token of this TransportRocketChatPost.
        :param transport_name: The transport_name of this TransportRocketChatPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportRocketChatPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportRocketChat-post of this TransportRocketChatPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportRocketChatPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportRocketChatPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportRocketChatPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportRocketChatPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportRocketChatPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportRocketChatPost.
    ...
    def rocket_chat_channel(self):
        """Gets the rocket_chat_channel of this TransportRocketChatPost.

        The channel for the Rocket Chat service.

        :return: The rocket_chat_channel of this TransportRocketChatPost.
        :rtype: str
        """
    ...
    def rocket_chat_channel(self, rocket_chat_channel):
        """Sets the rocket_chat_channel of this TransportRocketChatPost.
    ...
    def rocket_chat_token(self):
        """Gets the rocket_chat_token of this TransportRocketChatPost.

        The access token for the Rocket Chat service. Stored in encrypted format.

        :return: The rocket_chat_token of this TransportRocketChatPost.
        :rtype: str
        """
    ...
    def rocket_chat_token(self, rocket_chat_token):
        """Sets the rocket_chat_token of this TransportRocketChatPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportRocketChatPost.

        The name of the transport.

        :return: The transport_name of this TransportRocketChatPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportRocketChatPost.
