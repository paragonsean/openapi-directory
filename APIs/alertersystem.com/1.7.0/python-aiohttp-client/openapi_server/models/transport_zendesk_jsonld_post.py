...
class TransportZendeskJsonldPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition: str=None, transport_name: str=None, zendesk_email: str=None, zendesk_host: str=None, zendesk_token: str=None):
        """TransportZendeskJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportZendeskJsonldPost.
        :param partition: The partition of this TransportZendeskJsonldPost.
        :param transport_name: The transport_name of this TransportZendeskJsonldPost.
        :param zendesk_email: The zendesk_email of this TransportZendeskJsonldPost.
        :param zendesk_host: The zendesk_host of this TransportZendeskJsonldPost.
        :param zendesk_token: The zendesk_token of this TransportZendeskJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportZendeskJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportZendesk.jsonld-post of this TransportZendeskJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportZendeskJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportZendeskJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportZendeskJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportZendeskJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportZendeskJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportZendeskJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportZendeskJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportZendeskJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportZendeskJsonldPost.
    ...
    def zendesk_email(self):
        """Gets the zendesk_email of this TransportZendeskJsonldPost.

        The login email address for the Zendesk service.

        :return: The zendesk_email of this TransportZendeskJsonldPost.
        :rtype: str
        """
    ...
    def zendesk_email(self, zendesk_email):
        """Sets the zendesk_email of this TransportZendeskJsonldPost.
    ...
    def zendesk_host(self):
        """Gets the zendesk_host of this TransportZendeskJsonldPost.

        The host name for the Zendesk service (domain.zendesk.com).

        :return: The zendesk_host of this TransportZendeskJsonldPost.
        :rtype: str
        """
    ...
    def zendesk_host(self, zendesk_host):
        """Sets the zendesk_host of this TransportZendeskJsonldPost.
    ...
    def zendesk_token(self):
        """Gets the zendesk_token of this TransportZendeskJsonldPost.

        The token for the Zendesk service. Stored in encrypted format.

        :return: The zendesk_token of this TransportZendeskJsonldPost.
        :rtype: str
        """
    ...
    def zendesk_token(self, zendesk_token):
        """Sets the zendesk_token of this TransportZendeskJsonldPost.
