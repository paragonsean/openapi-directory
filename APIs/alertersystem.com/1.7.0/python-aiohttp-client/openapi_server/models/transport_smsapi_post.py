...
class TransportSmsapiPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition: str=None, smsapi_from: str=None, smsapi_token: str=None, transport_name: str=None):
        """TransportSmsapiPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportSmsapiPost.
        :param partition: The partition of this TransportSmsapiPost.
        :param smsapi_from: The smsapi_from of this TransportSmsapiPost.
        :param smsapi_token: The smsapi_token of this TransportSmsapiPost.
        :param transport_name: The transport_name of this TransportSmsapiPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportSmsapiPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportSmsapi-post of this TransportSmsapiPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportSmsapiPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportSmsapiPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportSmsapiPost.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportSmsapiPost.
    ...
    def smsapi_from(self):
        """Gets the smsapi_from of this TransportSmsapiPost.

        The sender name for the SMS API service.

        :return: The smsapi_from of this TransportSmsapiPost.
        :rtype: str
        """
    ...
    def smsapi_from(self, smsapi_from):
        """Sets the smsapi_from of this TransportSmsapiPost.
    ...
    def smsapi_token(self):
        """Gets the smsapi_token of this TransportSmsapiPost.

        The API token for the SMS API service. Stored in encrypted format.

        :return: The smsapi_token of this TransportSmsapiPost.
        :rtype: str
        """
    ...
    def smsapi_token(self, smsapi_token):
        """Sets the smsapi_token of this TransportSmsapiPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportSmsapiPost.

        The name of the transport.

        :return: The transport_name of this TransportSmsapiPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportSmsapiPost.
