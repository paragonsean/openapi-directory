...
class TransportFreshdeskPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, freshdesk_api_key: str=None, freshdesk_email: str=None, freshdesk_host: str=None, freshdesk_priority: str=None, freshdesk_type: str=None, partition: str=None, transport_name: str=None):
        """TransportFreshdeskPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportFreshdeskPost.
        :param freshdesk_api_key: The freshdesk_api_key of this TransportFreshdeskPost.
        :param freshdesk_email: The freshdesk_email of this TransportFreshdeskPost.
        :param freshdesk_host: The freshdesk_host of this TransportFreshdeskPost.
        :param freshdesk_priority: The freshdesk_priority of this TransportFreshdeskPost.
        :param freshdesk_type: The freshdesk_type of this TransportFreshdeskPost.
        :param partition: The partition of this TransportFreshdeskPost.
        :param transport_name: The transport_name of this TransportFreshdeskPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportFreshdeskPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportFreshdesk-post of this TransportFreshdeskPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportFreshdeskPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportFreshdeskPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportFreshdeskPost.
    ...
    def freshdesk_api_key(self):
        """Gets the freshdesk_api_key of this TransportFreshdeskPost.

        The API key for the Freshdesk service. Stored in encrypted format.

        :return: The freshdesk_api_key of this TransportFreshdeskPost.
        :rtype: str
        """
    ...
    def freshdesk_api_key(self, freshdesk_api_key):
        """Sets the freshdesk_api_key of this TransportFreshdeskPost.
    ...
    def freshdesk_email(self):
        """Gets the freshdesk_email of this TransportFreshdeskPost.

        The requester email address for the Freshdesk service.

        :return: The freshdesk_email of this TransportFreshdeskPost.
        :rtype: str
        """
    ...
    def freshdesk_email(self, freshdesk_email):
        """Sets the freshdesk_email of this TransportFreshdeskPost.
    ...
    def freshdesk_host(self):
        """Gets the freshdesk_host of this TransportFreshdeskPost.

        The host name for the Freshdesk service (domain.freshdesk.com).

        :return: The freshdesk_host of this TransportFreshdeskPost.
        :rtype: str
        """
    ...
    def freshdesk_host(self, freshdesk_host):
        """Sets the freshdesk_host of this TransportFreshdeskPost.
    ...
    def freshdesk_priority(self):
        """Gets the freshdesk_priority of this TransportFreshdeskPost.

        The ticket priority for the Freshdesk service.

        :return: The freshdesk_priority of this TransportFreshdeskPost.
        :rtype: str
        """
    ...
    def freshdesk_priority(self, freshdesk_priority):
        """Sets the freshdesk_priority of this TransportFreshdeskPost.
    ...
    def freshdesk_type(self):
        """Gets the freshdesk_type of this TransportFreshdeskPost.

        The ticket type for the Freshdesk service.

        :return: The freshdesk_type of this TransportFreshdeskPost.
        :rtype: str
        """
    ...
    def freshdesk_type(self, freshdesk_type):
        """Sets the freshdesk_type of this TransportFreshdeskPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportFreshdeskPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportFreshdeskPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportFreshdeskPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportFreshdeskPost.

        The name of the transport.

        :return: The transport_name of this TransportFreshdeskPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportFreshdeskPost.
