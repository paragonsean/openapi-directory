...
class TransportAllMySmsJsonldPut(Model):
    ...
    def __init__(self, all_my_sms_api_key: str=None, all_my_sms_from: str=None, all_my_sms_login: str=None, data_segment_code: str=None, transport_name: str=None):
        """TransportAllMySmsJsonldPut - a model defined in OpenAPI

        :param all_my_sms_api_key: The all_my_sms_api_key of this TransportAllMySmsJsonldPut.
        :param all_my_sms_from: The all_my_sms_from of this TransportAllMySmsJsonldPut.
        :param all_my_sms_login: The all_my_sms_login of this TransportAllMySmsJsonldPut.
        :param data_segment_code: The data_segment_code of this TransportAllMySmsJsonldPut.
        :param transport_name: The transport_name of this TransportAllMySmsJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportAllMySmsJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportAllMySms.jsonld-put of this TransportAllMySmsJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def all_my_sms_api_key(self):
        """Gets the all_my_sms_api_key of this TransportAllMySmsJsonldPut.

        The API key for the Allmysms service. Stored in encrypted format.

        :return: The all_my_sms_api_key of this TransportAllMySmsJsonldPut.
        :rtype: str
        """
    ...
    def all_my_sms_api_key(self, all_my_sms_api_key):
        """Sets the all_my_sms_api_key of this TransportAllMySmsJsonldPut.
    ...
    def all_my_sms_from(self):
        """Gets the all_my_sms_from of this TransportAllMySmsJsonldPut.

        The sender value (default 36180) for the Allmysms service.

        :return: The all_my_sms_from of this TransportAllMySmsJsonldPut.
        :rtype: str
        """
    ...
    def all_my_sms_from(self, all_my_sms_from):
        """Sets the all_my_sms_from of this TransportAllMySmsJsonldPut.
    ...
    def all_my_sms_login(self):
        """Gets the all_my_sms_login of this TransportAllMySmsJsonldPut.

        The login credential for the Allmysms service.

        :return: The all_my_sms_login of this TransportAllMySmsJsonldPut.
        :rtype: str
        """
    ...
    def all_my_sms_login(self, all_my_sms_login):
        """Sets the all_my_sms_login of this TransportAllMySmsJsonldPut.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportAllMySmsJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportAllMySmsJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportAllMySmsJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportAllMySmsJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportAllMySmsJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportAllMySmsJsonldPut.
