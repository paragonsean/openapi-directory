...
class TransportRocketChatPatch(Model):
    ...
    def __init__(self, data_segment_code: str=None, rocket_chat_channel: str=None, rocket_chat_token: str=None, transport_name: str=None):
        """TransportRocketChatPatch - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportRocketChatPatch.
        :param rocket_chat_channel: The rocket_chat_channel of this TransportRocketChatPatch.
        :param rocket_chat_token: The rocket_chat_token of this TransportRocketChatPatch.
        :param transport_name: The transport_name of this TransportRocketChatPatch.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportRocketChatPatch':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportRocketChat-patch of this TransportRocketChatPatch.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportRocketChatPatch.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportRocketChatPatch.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportRocketChatPatch.
    ...
    def rocket_chat_channel(self):
        """Gets the rocket_chat_channel of this TransportRocketChatPatch.

        The channel for the Rocket Chat service.

        :return: The rocket_chat_channel of this TransportRocketChatPatch.
        :rtype: str
        """
    ...
    def rocket_chat_channel(self, rocket_chat_channel):
        """Sets the rocket_chat_channel of this TransportRocketChatPatch.
    ...
    def rocket_chat_token(self):
        """Gets the rocket_chat_token of this TransportRocketChatPatch.

        The access token for the Rocket Chat service. Stored in encrypted format.

        :return: The rocket_chat_token of this TransportRocketChatPatch.
        :rtype: str
        """
    ...
    def rocket_chat_token(self, rocket_chat_token):
        """Sets the rocket_chat_token of this TransportRocketChatPatch.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportRocketChatPatch.

        The name of the transport.

        :return: The transport_name of this TransportRocketChatPatch.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportRocketChatPatch.
