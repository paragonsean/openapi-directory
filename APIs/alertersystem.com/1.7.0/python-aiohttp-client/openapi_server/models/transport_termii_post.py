...
class TransportTermiiPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition: str=None, termii_api_key: str=None, termii_channel: str=None, termii_from: str=None, transport_name: str=None):
        """TransportTermiiPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportTermiiPost.
        :param partition: The partition of this TransportTermiiPost.
        :param termii_api_key: The termii_api_key of this TransportTermiiPost.
        :param termii_channel: The termii_channel of this TransportTermiiPost.
        :param termii_from: The termii_from of this TransportTermiiPost.
        :param transport_name: The transport_name of this TransportTermiiPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportTermiiPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportTermii-post of this TransportTermiiPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportTermiiPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportTermiiPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportTermiiPost.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportTermiiPost.
    ...
    def termii_api_key(self):
        """Gets the termii_api_key of this TransportTermiiPost.

        The API key for the Termii service. Stored in encrypted format.

        :return: The termii_api_key of this TransportTermiiPost.
        :rtype: str
        """
    ...
    def termii_api_key(self, termii_api_key):
        """Sets the termii_api_key of this TransportTermiiPost.
    ...
    def termii_channel(self):
        """Gets the termii_channel of this TransportTermiiPost.

        The channel for the Termii service.

        :return: The termii_channel of this TransportTermiiPost.
        :rtype: str
        """
    ...
    def termii_channel(self, termii_channel):
        """Sets the termii_channel of this TransportTermiiPost.
    ...
    def termii_from(self):
        """Gets the termii_from of this TransportTermiiPost.

        The sender value for the Termii service.

        :return: The termii_from of this TransportTermiiPost.
        :rtype: str
        """
    ...
    def termii_from(self, termii_from):
        """Sets the termii_from of this TransportTermiiPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportTermiiPost.

        The name of the transport.

        :return: The transport_name of this TransportTermiiPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportTermiiPost.
