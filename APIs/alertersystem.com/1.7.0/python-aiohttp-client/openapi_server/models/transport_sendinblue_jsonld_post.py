...
class TransportSendinblueJsonldPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition: str=None, sendinblue_api_key: str=None, sendinblue_sender_phone: str=None, transport_name: str=None):
        """TransportSendinblueJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportSendinblueJsonldPost.
        :param partition: The partition of this TransportSendinblueJsonldPost.
        :param sendinblue_api_key: The sendinblue_api_key of this TransportSendinblueJsonldPost.
        :param sendinblue_sender_phone: The sendinblue_sender_phone of this TransportSendinblueJsonldPost.
        :param transport_name: The transport_name of this TransportSendinblueJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportSendinblueJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportSendinblue.jsonld-post of this TransportSendinblueJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportSendinblueJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportSendinblueJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportSendinblueJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportSendinblueJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportSendinblueJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportSendinblueJsonldPost.
    ...
    def sendinblue_api_key(self):
        """Gets the sendinblue_api_key of this TransportSendinblueJsonldPost.

        The API key for the Sendinblue service. Stored in encrypted format.

        :return: The sendinblue_api_key of this TransportSendinblueJsonldPost.
        :rtype: str
        """
    ...
    def sendinblue_api_key(self, sendinblue_api_key):
        """Sets the sendinblue_api_key of this TransportSendinblueJsonldPost.
    ...
    def sendinblue_sender_phone(self):
        """Gets the sendinblue_sender_phone of this TransportSendinblueJsonldPost.

        The sender phone number for the Sendinblue service.

        :return: The sendinblue_sender_phone of this TransportSendinblueJsonldPost.
        :rtype: str
        """
    ...
    def sendinblue_sender_phone(self, sendinblue_sender_phone):
        """Sets the sendinblue_sender_phone of this TransportSendinblueJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportSendinblueJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportSendinblueJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportSendinblueJsonldPost.
