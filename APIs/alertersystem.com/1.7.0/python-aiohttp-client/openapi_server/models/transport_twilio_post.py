...
class TransportTwilioPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition: str=None, transport_name: str=None, twilio_from: str=None, twilio_sid: str=None, twilio_token: str=None):
        """TransportTwilioPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportTwilioPost.
        :param partition: The partition of this TransportTwilioPost.
        :param transport_name: The transport_name of this TransportTwilioPost.
        :param twilio_from: The twilio_from of this TransportTwilioPost.
        :param twilio_sid: The twilio_sid of this TransportTwilioPost.
        :param twilio_token: The twilio_token of this TransportTwilioPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportTwilioPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportTwilio-post of this TransportTwilioPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportTwilioPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportTwilioPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportTwilioPost.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportTwilioPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportTwilioPost.

        The name of the transport.

        :return: The transport_name of this TransportTwilioPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportTwilioPost.
    ...
    def twilio_from(self):
        """Gets the twilio_from of this TransportTwilioPost.

        The sender for the Twilio service.

        :return: The twilio_from of this TransportTwilioPost.
        :rtype: str
        """
    ...
    def twilio_from(self, twilio_from):
        """Sets the twilio_from of this TransportTwilioPost.
    ...
    @property
    def twilio_sid(self):
        """Gets the twilio_sid of this TransportTwilioPost.

        The SID for the Twilio service.

        :return: The twilio_sid of this TransportTwilioPost.
        :rtype: str
        """
    ...
    def twilio_sid(self, twilio_sid):
        """Sets the twilio_sid of this TransportTwilioPost.
    ...
    def twilio_token(self):
        """Gets the twilio_token of this TransportTwilioPost.

        The token for the Twilio service. Stored in encrypted format.

        :return: The twilio_token of this TransportTwilioPost.
        :rtype: str
        """
    ...
    def twilio_token(self, twilio_token):
        """Sets the twilio_token of this TransportTwilioPost.
