...
class TransportHelpScoutPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, help_scout_customer_email: str=None, help_scout_mailbox_id: int=None, help_scout_oauth_token: str=None, partition: str=None, transport_name: str=None):
        """TransportHelpScoutPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportHelpScoutPost.
        :param help_scout_customer_email: The help_scout_customer_email of this TransportHelpScoutPost.
        :param help_scout_mailbox_id: The help_scout_mailbox_id of this TransportHelpScoutPost.
        :param help_scout_oauth_token: The help_scout_oauth_token of this TransportHelpScoutPost.
        :param partition: The partition of this TransportHelpScoutPost.
        :param transport_name: The transport_name of this TransportHelpScoutPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportHelpScoutPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportHelpScout-post of this TransportHelpScoutPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportHelpScoutPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportHelpScoutPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportHelpScoutPost.
    ...
    def help_scout_customer_email(self):
        """Gets the help_scout_customer_email of this TransportHelpScoutPost.

        The requester customer email address for the HelpScout service.

        :return: The help_scout_customer_email of this TransportHelpScoutPost.
        :rtype: str
        """
    ...
    def help_scout_customer_email(self, help_scout_customer_email):
        """Sets the help_scout_customer_email of this TransportHelpScoutPost.
    ...
    def help_scout_mailbox_id(self):
        """Gets the help_scout_mailbox_id of this TransportHelpScoutPost.

        The mailbox ID for the HelpScout service.

        :return: The help_scout_mailbox_id of this TransportHelpScoutPost.
        :rtype: int
        """
    ...
    def help_scout_mailbox_id(self, help_scout_mailbox_id):
        """Sets the help_scout_mailbox_id of this TransportHelpScoutPost.
    ...
    def help_scout_oauth_token(self):
        """Gets the help_scout_oauth_token of this TransportHelpScoutPost.

        The OAuth token for the HelpScout service. Stored in encrypted format.

        :return: The help_scout_oauth_token of this TransportHelpScoutPost.
        :rtype: str
        """
    ...
    def help_scout_oauth_token(self, help_scout_oauth_token):
        """Sets the help_scout_oauth_token of this TransportHelpScoutPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportHelpScoutPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportHelpScoutPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportHelpScoutPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportHelpScoutPost.

        The name of the transport.

        :return: The transport_name of this TransportHelpScoutPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportHelpScoutPost.
