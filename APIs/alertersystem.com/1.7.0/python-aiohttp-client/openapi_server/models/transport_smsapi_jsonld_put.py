...
class TransportSmsapiJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, smsapi_from: str=None, smsapi_token: str=None, transport_name: str=None):
        """TransportSmsapiJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportSmsapiJsonldPut.
        :param smsapi_from: The smsapi_from of this TransportSmsapiJsonldPut.
        :param smsapi_token: The smsapi_token of this TransportSmsapiJsonldPut.
        :param transport_name: The transport_name of this TransportSmsapiJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportSmsapiJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportSmsapi.jsonld-put of this TransportSmsapiJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportSmsapiJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportSmsapiJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportSmsapiJsonldPut.
    ...
    def smsapi_from(self):
        """Gets the smsapi_from of this TransportSmsapiJsonldPut.

        The sender name for the SMS API service.

        :return: The smsapi_from of this TransportSmsapiJsonldPut.
        :rtype: str
        """
    ...
    def smsapi_from(self, smsapi_from):
        """Sets the smsapi_from of this TransportSmsapiJsonldPut.
    ...
    def smsapi_token(self):
        """Gets the smsapi_token of this TransportSmsapiJsonldPut.

        The API token for the SMS API service. Stored in encrypted format.

        :return: The smsapi_token of this TransportSmsapiJsonldPut.
        :rtype: str
        """
    ...
    def smsapi_token(self, smsapi_token):
        """Sets the smsapi_token of this TransportSmsapiJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportSmsapiJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportSmsapiJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportSmsapiJsonldPut.
