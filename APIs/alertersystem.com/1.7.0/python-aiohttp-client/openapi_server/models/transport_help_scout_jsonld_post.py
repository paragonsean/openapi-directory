...
class TransportHelpScoutJsonldPost(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data_segment_code: str=None, help_scout_customer_email: str=None, help_scout_mailbox_id: int=None, help_scout_oauth_token: str=None, partition: str=None, transport_name: str=None):
        """TransportHelpScoutJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportHelpScoutJsonldPost.
        :param help_scout_customer_email: The help_scout_customer_email of this TransportHelpScoutJsonldPost.
        :param help_scout_mailbox_id: The help_scout_mailbox_id of this TransportHelpScoutJsonldPost.
        :param help_scout_oauth_token: The help_scout_oauth_token of this TransportHelpScoutJsonldPost.
        :param partition: The partition of this TransportHelpScoutJsonldPost.
        :param transport_name: The transport_name of this TransportHelpScoutJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportHelpScoutJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportHelpScout.jsonld-post of this TransportHelpScoutJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportHelpScoutJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportHelpScoutJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportHelpScoutJsonldPost.
    ...
    def help_scout_customer_email(self):
        """Gets the help_scout_customer_email of this TransportHelpScoutJsonldPost.

        The requester customer email address for the HelpScout service.

        :return: The help_scout_customer_email of this TransportHelpScoutJsonldPost.
        :rtype: str
        """
    ...
    def help_scout_customer_email(self, help_scout_customer_email):
        """Sets the help_scout_customer_email of this TransportHelpScoutJsonldPost.
    ...
    def help_scout_mailbox_id(self):
        """Gets the help_scout_mailbox_id of this TransportHelpScoutJsonldPost.

        The mailbox ID for the HelpScout service.

        :return: The help_scout_mailbox_id of this TransportHelpScoutJsonldPost.
        :rtype: int
        """
    ...
    def help_scout_mailbox_id(self, help_scout_mailbox_id):
        """Sets the help_scout_mailbox_id of this TransportHelpScoutJsonldPost.
    ...
    def help_scout_oauth_token(self):
        """Gets the help_scout_oauth_token of this TransportHelpScoutJsonldPost.

        The OAuth token for the HelpScout service. Stored in encrypted format.

        :return: The help_scout_oauth_token of this TransportHelpScoutJsonldPost.
        :rtype: str
        """
    ...
    def help_scout_oauth_token(self, help_scout_oauth_token):
        """Sets the help_scout_oauth_token of this TransportHelpScoutJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportHelpScoutJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportHelpScoutJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportHelpScoutJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportHelpScoutJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportHelpScoutJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportHelpScoutJsonldPost.
