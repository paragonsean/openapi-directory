...
class TransportIqsmsPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, iqsms_from: str=None, iqsms_login: str=None, iqsms_password: str=None, partition: str=None, transport_name: str=None):
        """TransportIqsmsPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportIqsmsPost.
        :param iqsms_from: The iqsms_from of this TransportIqsmsPost.
        :param iqsms_login: The iqsms_login of this TransportIqsmsPost.
        :param iqsms_password: The iqsms_password of this TransportIqsmsPost.
        :param partition: The partition of this TransportIqsmsPost.
        :param transport_name: The transport_name of this TransportIqsmsPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportIqsmsPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportIqsms-post of this TransportIqsmsPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportIqsmsPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportIqsmsPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportIqsmsPost.
    ...
    @property
    def iqsms_from(self):
        """Gets the iqsms_from of this TransportIqsmsPost.

        The sender value for the Iqsms service.

        :return: The iqsms_from of this TransportIqsmsPost.
        :rtype: str
        """
    ...
    def iqsms_from(self, iqsms_from):
        """Sets the iqsms_from of this TransportIqsmsPost.
    ...
    def iqsms_login(self):
        """Gets the iqsms_login of this TransportIqsmsPost.

        The login for the Iqsms service.

        :return: The iqsms_login of this TransportIqsmsPost.
        :rtype: str
        """
    ...
    def iqsms_login(self, iqsms_login):
        """Sets the iqsms_login of this TransportIqsmsPost.
    ...
    def iqsms_password(self):
        """Gets the iqsms_password of this TransportIqsmsPost.

        The password for the Iqsms service. Stored in encrypted format.

        :return: The iqsms_password of this TransportIqsmsPost.
        :rtype: str
        """
    ...
    def iqsms_password(self, iqsms_password):
        """Sets the iqsms_password of this TransportIqsmsPost.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportIqsmsPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportIqsmsPost.

        The name of the transport.

        :return: The transport_name of this TransportIqsmsPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportIqsmsPost.
