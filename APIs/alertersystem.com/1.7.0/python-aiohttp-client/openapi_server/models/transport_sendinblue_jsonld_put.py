...
class TransportSendinblueJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, sendinblue_api_key: str=None, sendinblue_sender_phone: str=None, transport_name: str=None):
        """TransportSendinblueJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportSendinblueJsonldPut.
        :param sendinblue_api_key: The sendinblue_api_key of this TransportSendinblueJsonldPut.
        :param sendinblue_sender_phone: The sendinblue_sender_phone of this TransportSendinblueJsonldPut.
        :param transport_name: The transport_name of this TransportSendinblueJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportSendinblueJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportSendinblue.jsonld-put of this TransportSendinblueJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportSendinblueJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportSendinblueJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportSendinblueJsonldPut.
    ...
    def sendinblue_api_key(self):
        """Gets the sendinblue_api_key of this TransportSendinblueJsonldPut.

        The API key for the Sendinblue service. Stored in encrypted format.

        :return: The sendinblue_api_key of this TransportSendinblueJsonldPut.
        :rtype: str
        """
    ...
    def sendinblue_api_key(self, sendinblue_api_key):
        """Sets the sendinblue_api_key of this TransportSendinblueJsonldPut.
    ...
    def sendinblue_sender_phone(self):
        """Gets the sendinblue_sender_phone of this TransportSendinblueJsonldPut.

        The sender phone number for the Sendinblue service.

        :return: The sendinblue_sender_phone of this TransportSendinblueJsonldPut.
        :rtype: str
        """
    ...
    def sendinblue_sender_phone(self, sendinblue_sender_phone):
        """Sets the sendinblue_sender_phone of this TransportSendinblueJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportSendinblueJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportSendinblueJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportSendinblueJsonldPut.
