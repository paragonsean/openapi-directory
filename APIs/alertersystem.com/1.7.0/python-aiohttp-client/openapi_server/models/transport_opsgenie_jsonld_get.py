...
class TransportOpsgenieJsonldGet(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, context: AlertLogJsonldGetContext=None, id: str=None, type: str=None, created_at: datetime=None, data_segment_code: str=None, id: str=None, opsgenie_alias: str=None, opsgenie_api_key: str=None, opsgenie_entity: str=None, opsgenie_note: str=None, opsgenie_priority: str=None, opsgenie_user: str=None, partition: str=None, resource_owner: str=None, transport_name: str=None):
        """TransportOpsgenieJsonldGet - a model defined in OpenAPI

        :param context: The context of this TransportOpsgenieJsonldGet.
        :param id: The id of this TransportOpsgenieJsonldGet.
        :param type: The type of this TransportOpsgenieJsonldGet.
        :param created_at: The created_at of this TransportOpsgenieJsonldGet.
        :param data_segment_code: The data_segment_code of this TransportOpsgenieJsonldGet.
        :param id: The id of this TransportOpsgenieJsonldGet.
        :param opsgenie_alias: The opsgenie_alias of this TransportOpsgenieJsonldGet.
        :param opsgenie_api_key: The opsgenie_api_key of this TransportOpsgenieJsonldGet.
        :param opsgenie_entity: The opsgenie_entity of this TransportOpsgenieJsonldGet.
        :param opsgenie_note: The opsgenie_note of this TransportOpsgenieJsonldGet.
        :param opsgenie_priority: The opsgenie_priority of this TransportOpsgenieJsonldGet.
        :param opsgenie_user: The opsgenie_user of this TransportOpsgenieJsonldGet.
        :param partition: The partition of this TransportOpsgenieJsonldGet.
        :param resource_owner: The resource_owner of this TransportOpsgenieJsonldGet.
        :param transport_name: The transport_name of this TransportOpsgenieJsonldGet.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportOpsgenieJsonldGet':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportOpsgenie.jsonld-get of this TransportOpsgenieJsonldGet.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def context(self):
        """Gets the context of this TransportOpsgenieJsonldGet.


        :return: The context of this TransportOpsgenieJsonldGet.
    ...
    def context(self, context):
        """Sets the context of this TransportOpsgenieJsonldGet.
    ...
    @property
    def id(self):
        """Gets the id of this TransportOpsgenieJsonldGet.


        :return: The id of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TransportOpsgenieJsonldGet.
    ...
    @property
    def type(self):
        """Gets the type of this TransportOpsgenieJsonldGet.


        :return: The type of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TransportOpsgenieJsonldGet.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this TransportOpsgenieJsonldGet.

        When the resource instance was created. This date-time is in the UTC timezone.

        :return: The created_at of this TransportOpsgenieJsonldGet.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this TransportOpsgenieJsonldGet.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportOpsgenieJsonldGet.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportOpsgenieJsonldGet.
    ...
    def opsgenie_alias(self):
        """Gets the opsgenie_alias of this TransportOpsgenieJsonldGet.

        The alias for the Opsgenie service.

        :return: The opsgenie_alias of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
    ...
    def opsgenie_alias(self, opsgenie_alias):
        """Sets the opsgenie_alias of this TransportOpsgenieJsonldGet.
    ...
    def opsgenie_api_key(self):
        """Gets the opsgenie_api_key of this TransportOpsgenieJsonldGet.

        The API key for the Opsgenie service. Stored in encrypted format.

        :return: The opsgenie_api_key of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
    ...
    def opsgenie_api_key(self, opsgenie_api_key):
        """Sets the opsgenie_api_key of this TransportOpsgenieJsonldGet.
    ...
    def opsgenie_entity(self):
        """Gets the opsgenie_entity of this TransportOpsgenieJsonldGet.

        The entity for the Opsgenie service.

        :return: The opsgenie_entity of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
    ...
    def opsgenie_entity(self, opsgenie_entity):
        """Sets the opsgenie_entity of this TransportOpsgenieJsonldGet.
    ...
    def opsgenie_note(self):
        """Gets the opsgenie_note of this TransportOpsgenieJsonldGet.

        The note for the Opsgenie service.

        :return: The opsgenie_note of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
    ...
    def opsgenie_note(self, opsgenie_note):
        """Sets the opsgenie_note of this TransportOpsgenieJsonldGet.
    ...
    def opsgenie_priority(self):
        """Gets the opsgenie_priority of this TransportOpsgenieJsonldGet.

        The priority for the Opsgenie service.

        :return: The opsgenie_priority of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
    ...
    def opsgenie_priority(self, opsgenie_priority):
        """Sets the opsgenie_priority of this TransportOpsgenieJsonldGet.
    ...
    def opsgenie_user(self):
        """Gets the opsgenie_user of this TransportOpsgenieJsonldGet.

        The user for the Opsgenie service.

        :return: The opsgenie_user of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
    ...
    def opsgenie_user(self, opsgenie_user):
        """Sets the opsgenie_user of this TransportOpsgenieJsonldGet.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportOpsgenieJsonldGet.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportOpsgenieJsonldGet.
    ...
    def resource_owner(self):
        """Gets the resource_owner of this TransportOpsgenieJsonldGet.

        The name of the person who owns this resource.

        :return: The resource_owner of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
    ...
    def resource_owner(self, resource_owner):
        """Sets the resource_owner of this TransportOpsgenieJsonldGet.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportOpsgenieJsonldGet.

        The name of the transport.

        :return: The transport_name of this TransportOpsgenieJsonldGet.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportOpsgenieJsonldGet.
