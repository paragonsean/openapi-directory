...
class TransportIqsmsPatch(Model):
    ...
    def __init__(self, data_segment_code: str=None, iqsms_from: str=None, iqsms_login: str=None, iqsms_password: str=None, transport_name: str=None):
        """TransportIqsmsPatch - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportIqsmsPatch.
        :param iqsms_from: The iqsms_from of this TransportIqsmsPatch.
        :param iqsms_login: The iqsms_login of this TransportIqsmsPatch.
        :param iqsms_password: The iqsms_password of this TransportIqsmsPatch.
        :param transport_name: The transport_name of this TransportIqsmsPatch.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportIqsmsPatch':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportIqsms-patch of this TransportIqsmsPatch.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportIqsmsPatch.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportIqsmsPatch.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportIqsmsPatch.
    ...
    @property
    def iqsms_from(self):
        """Gets the iqsms_from of this TransportIqsmsPatch.

        The sender value for the Iqsms service.

        :return: The iqsms_from of this TransportIqsmsPatch.
        :rtype: str
        """
    ...
    def iqsms_from(self, iqsms_from):
        """Sets the iqsms_from of this TransportIqsmsPatch.
    ...
    def iqsms_login(self):
        """Gets the iqsms_login of this TransportIqsmsPatch.

        The login for the Iqsms service.

        :return: The iqsms_login of this TransportIqsmsPatch.
        :rtype: str
        """
    ...
    def iqsms_login(self, iqsms_login):
        """Sets the iqsms_login of this TransportIqsmsPatch.
    ...
    def iqsms_password(self):
        """Gets the iqsms_password of this TransportIqsmsPatch.

        The password for the Iqsms service. Stored in encrypted format.

        :return: The iqsms_password of this TransportIqsmsPatch.
        :rtype: str
        """
    ...
    def iqsms_password(self, iqsms_password):
        """Sets the iqsms_password of this TransportIqsmsPatch.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportIqsmsPatch.

        The name of the transport.

        :return: The transport_name of this TransportIqsmsPatch.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportIqsmsPatch.
