...
class TransportSmscPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, smsc_from: str=None, smsc_login: str=None, smsc_password: str=None, transport_name: str=None):
        """TransportSmscPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportSmscPut.
        :param smsc_from: The smsc_from of this TransportSmscPut.
        :param smsc_login: The smsc_login of this TransportSmscPut.
        :param smsc_password: The smsc_password of this TransportSmscPut.
        :param transport_name: The transport_name of this TransportSmscPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportSmscPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportSmsc-put of this TransportSmscPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportSmscPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportSmscPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportSmscPut.
    ...
    @property
    def smsc_from(self):
        """Gets the smsc_from of this TransportSmscPut.

        The sender (NB: text identity, not a phone number) for the Smsc service.

        :return: The smsc_from of this TransportSmscPut.
        :rtype: str
        """
    ...
    def smsc_from(self, smsc_from):
        """Sets the smsc_from of this TransportSmscPut.
    ...
    @property
    def smsc_login(self):
        """Gets the smsc_login of this TransportSmscPut.

        The login for the Smsc service.

        :return: The smsc_login of this TransportSmscPut.
        :rtype: str
        """
    ...
    def smsc_login(self, smsc_login):
        """Sets the smsc_login of this TransportSmscPut.
    ...
    def smsc_password(self):
        """Gets the smsc_password of this TransportSmscPut.

        The API password for the Smsc service. Stored in encrypted format.

        :return: The smsc_password of this TransportSmscPut.
        :rtype: str
        """
    ...
    def smsc_password(self, smsc_password):
        """Sets the smsc_password of this TransportSmscPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportSmscPut.

        The name of the transport.

        :return: The transport_name of this TransportSmscPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportSmscPut.
