...
class TransportTermiiJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, termii_api_key: str=None, termii_channel: str=None, termii_from: str=None, transport_name: str=None):
        """TransportTermiiJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportTermiiJsonldPut.
        :param termii_api_key: The termii_api_key of this TransportTermiiJsonldPut.
        :param termii_channel: The termii_channel of this TransportTermiiJsonldPut.
        :param termii_from: The termii_from of this TransportTermiiJsonldPut.
        :param transport_name: The transport_name of this TransportTermiiJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportTermiiJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportTermii.jsonld-put of this TransportTermiiJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportTermiiJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportTermiiJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportTermiiJsonldPut.
    ...
    def termii_api_key(self):
        """Gets the termii_api_key of this TransportTermiiJsonldPut.

        The API key for the Termii service. Stored in encrypted format.

        :return: The termii_api_key of this TransportTermiiJsonldPut.
        :rtype: str
        """
    ...
    def termii_api_key(self, termii_api_key):
        """Sets the termii_api_key of this TransportTermiiJsonldPut.
    ...
    def termii_channel(self):
        """Gets the termii_channel of this TransportTermiiJsonldPut.

        The channel for the Termii service.

        :return: The termii_channel of this TransportTermiiJsonldPut.
        :rtype: str
        """
    ...
    def termii_channel(self, termii_channel):
        """Sets the termii_channel of this TransportTermiiJsonldPut.
    ...
    def termii_from(self):
        """Gets the termii_from of this TransportTermiiJsonldPut.

        The sender value for the Termii service.

        :return: The termii_from of this TransportTermiiJsonldPut.
        :rtype: str
        """
    ...
    def termii_from(self, termii_from):
        """Sets the termii_from of this TransportTermiiJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportTermiiJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportTermiiJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportTermiiJsonldPut.
