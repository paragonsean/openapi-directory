...
class PartitionPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, partition_name: str=None, partition_notes: str=None):
        """PartitionPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this PartitionPost.
        :param partition_name: The partition_name of this PartitionPost.
        :param partition_notes: The partition_notes of this PartitionPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PartitionPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Partition-post of this PartitionPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this PartitionPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this PartitionPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this PartitionPost.
    ...
    def partition_name(self):
        """Gets the partition_name of this PartitionPost.

        The name of the partition. Max 255 characters.

        :return: The partition_name of this PartitionPost.
        :rtype: str
        """
    ...
    def partition_name(self, partition_name):
        """Sets the partition_name of this PartitionPost.
    ...
    def partition_notes(self, partition_notes):
        """Sets the partition_notes of this PartitionPost.
