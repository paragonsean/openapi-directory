...
class TransportIqsmsJsonldPost(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data_segment_code: str=None, iqsms_from: str=None, iqsms_login: str=None, iqsms_password: str=None, partition: str=None, transport_name: str=None):
        """TransportIqsmsJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportIqsmsJsonldPost.
        :param iqsms_from: The iqsms_from of this TransportIqsmsJsonldPost.
        :param iqsms_login: The iqsms_login of this TransportIqsmsJsonldPost.
        :param iqsms_password: The iqsms_password of this TransportIqsmsJsonldPost.
        :param partition: The partition of this TransportIqsmsJsonldPost.
        :param transport_name: The transport_name of this TransportIqsmsJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportIqsmsJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportIqsms.jsonld-post of this TransportIqsmsJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportIqsmsJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportIqsmsJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportIqsmsJsonldPost.
    ...
    @property
    def iqsms_from(self):
        """Gets the iqsms_from of this TransportIqsmsJsonldPost.

        The sender value for the Iqsms service.

        :return: The iqsms_from of this TransportIqsmsJsonldPost.
        :rtype: str
        """
    ...
    def iqsms_from(self, iqsms_from):
        """Sets the iqsms_from of this TransportIqsmsJsonldPost.
    ...
    def iqsms_login(self):
        """Gets the iqsms_login of this TransportIqsmsJsonldPost.

        The login for the Iqsms service.

        :return: The iqsms_login of this TransportIqsmsJsonldPost.
        :rtype: str
        """
    ...
    def iqsms_login(self, iqsms_login):
        """Sets the iqsms_login of this TransportIqsmsJsonldPost.
    ...
    def iqsms_password(self):
        """Gets the iqsms_password of this TransportIqsmsJsonldPost.

        The password for the Iqsms service. Stored in encrypted format.

        :return: The iqsms_password of this TransportIqsmsJsonldPost.
        :rtype: str
        """
    ...
    def iqsms_password(self, iqsms_password):
        """Sets the iqsms_password of this TransportIqsmsJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportIqsmsJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportIqsmsJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportIqsmsJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportIqsmsJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportIqsmsJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportIqsmsJsonldPost.
