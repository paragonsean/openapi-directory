...
class TransportEmailPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, email_from_address: str=None, email_from_name: str=None, email_password: str=None, email_port: int=None, email_server: str=None, email_username: str=None, partition: str=None, transport_name: str=None):
        """TransportEmailPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportEmailPost.
        :param email_from_address: The email_from_address of this TransportEmailPost.
        :param email_from_name: The email_from_name of this TransportEmailPost.
        :param email_password: The email_password of this TransportEmailPost.
        :param email_port: The email_port of this TransportEmailPost.
        :param email_server: The email_server of this TransportEmailPost.
        :param email_username: The email_username of this TransportEmailPost.
        :param partition: The partition of this TransportEmailPost.
        :param transport_name: The transport_name of this TransportEmailPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportEmailPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportEmail-post of this TransportEmailPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportEmailPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportEmailPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportEmailPost.
    ...
    def email_from_address(self):
        """Gets the email_from_address of this TransportEmailPost.

        The sender email address for the SMTP Email service.

        :return: The email_from_address of this TransportEmailPost.
        :rtype: str
        """
    ...
    def email_from_address(self, email_from_address):
        """Sets the email_from_address of this TransportEmailPost.
    ...
    def email_from_name(self):
        """Gets the email_from_name of this TransportEmailPost.

        The sender name for the SMTP Email service.

        :return: The email_from_name of this TransportEmailPost.
        :rtype: str
        """
    ...
    def email_from_name(self, email_from_name):
        """Sets the email_from_name of this TransportEmailPost.
    ...
    def email_password(self):
        """Gets the email_password of this TransportEmailPost.

        The password for the SMTP Email service. Stored in encrypted format.

        :return: The email_password of this TransportEmailPost.
        :rtype: str
        """
    ...
    def email_password(self, email_password):
        """Sets the email_password of this TransportEmailPost.
    ...
    @property
    def email_port(self):
        """Gets the email_port of this TransportEmailPost.

        The port for the SMTP Email service.

        :return: The email_port of this TransportEmailPost.
        :rtype: int
        """
    ...
    def email_port(self, email_port):
        """Sets the email_port of this TransportEmailPost.
    ...
    def email_server(self):
        """Gets the email_server of this TransportEmailPost.

        The server for the SMTP Email service.

        :return: The email_server of this TransportEmailPost.
        :rtype: str
        """
    ...
    def email_server(self, email_server):
        """Sets the email_server of this TransportEmailPost.
    ...
    def email_username(self):
        """Gets the email_username of this TransportEmailPost.

        The username for the SMTP Email service.

        :return: The email_username of this TransportEmailPost.
        :rtype: str
        """
    ...
    def email_username(self, email_username):
        """Sets the email_username of this TransportEmailPost.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportEmailPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportEmailPost.

        The name of the transport.

        :return: The transport_name of this TransportEmailPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportEmailPost.
