...
class TransportBandwidthJsonldPut(Model):
    ...
    def __init__(self, bandwidth_account_id: str=None, bandwidth_application_id: str=None, bandwidth_from: str=None, bandwidth_password: str=None, bandwidth_username: str=None, data_segment_code: str=None, transport_name: str=None):
        """TransportBandwidthJsonldPut - a model defined in OpenAPI

        :param bandwidth_account_id: The bandwidth_account_id of this TransportBandwidthJsonldPut.
        :param bandwidth_application_id: The bandwidth_application_id of this TransportBandwidthJsonldPut.
        :param bandwidth_from: The bandwidth_from of this TransportBandwidthJsonldPut.
        :param bandwidth_password: The bandwidth_password of this TransportBandwidthJsonldPut.
        :param bandwidth_username: The bandwidth_username of this TransportBandwidthJsonldPut.
        :param data_segment_code: The data_segment_code of this TransportBandwidthJsonldPut.
        :param transport_name: The transport_name of this TransportBandwidthJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportBandwidthJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportBandwidth.jsonld-put of this TransportBandwidthJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bandwidth_account_id(self):
        """Gets the bandwidth_account_id of this TransportBandwidthJsonldPut.

        The account ID value for the Bandwidth service.

        :return: The bandwidth_account_id of this TransportBandwidthJsonldPut.
        :rtype: str
        """
    ...
    def bandwidth_account_id(self, bandwidth_account_id):
        """Sets the bandwidth_account_id of this TransportBandwidthJsonldPut.
    ...
    def bandwidth_application_id(self):
        """Gets the bandwidth_application_id of this TransportBandwidthJsonldPut.

        The application ID value for the Bandwidth service.

        :return: The bandwidth_application_id of this TransportBandwidthJsonldPut.
        :rtype: str
        """
    ...
    def bandwidth_application_id(self, bandwidth_application_id):
        """Sets the bandwidth_application_id of this TransportBandwidthJsonldPut.
    ...
    def bandwidth_from(self):
        """Gets the bandwidth_from of this TransportBandwidthJsonldPut.

        The from value for the Bandwidth service.

        :return: The bandwidth_from of this TransportBandwidthJsonldPut.
        :rtype: str
        """
    ...
    def bandwidth_from(self, bandwidth_from):
        """Sets the bandwidth_from of this TransportBandwidthJsonldPut.
    ...
    def bandwidth_password(self):
        """Gets the bandwidth_password of this TransportBandwidthJsonldPut.

        The password for the Bandwidth service. Stored in encrypted format.

        :return: The bandwidth_password of this TransportBandwidthJsonldPut.
        :rtype: str
        """
    ...
    def bandwidth_password(self, bandwidth_password):
        """Sets the bandwidth_password of this TransportBandwidthJsonldPut.
    ...
    def bandwidth_username(self):
        """Gets the bandwidth_username of this TransportBandwidthJsonldPut.

        The username for the Bandwidth service.

        :return: The bandwidth_username of this TransportBandwidthJsonldPut.
        :rtype: str
        """
    ...
    def bandwidth_username(self, bandwidth_username):
        """Sets the bandwidth_username of this TransportBandwidthJsonldPut.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportBandwidthJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportBandwidthJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportBandwidthJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportBandwidthJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportBandwidthJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportBandwidthJsonldPut.
