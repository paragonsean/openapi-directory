...
class TransportFreshdeskPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, freshdesk_api_key: str=None, freshdesk_email: str=None, freshdesk_host: str=None, freshdesk_priority: str=None, freshdesk_type: str=None, transport_name: str=None):
        """TransportFreshdeskPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportFreshdeskPut.
        :param freshdesk_api_key: The freshdesk_api_key of this TransportFreshdeskPut.
        :param freshdesk_email: The freshdesk_email of this TransportFreshdeskPut.
        :param freshdesk_host: The freshdesk_host of this TransportFreshdeskPut.
        :param freshdesk_priority: The freshdesk_priority of this TransportFreshdeskPut.
        :param freshdesk_type: The freshdesk_type of this TransportFreshdeskPut.
        :param transport_name: The transport_name of this TransportFreshdeskPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportFreshdeskPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportFreshdesk-put of this TransportFreshdeskPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportFreshdeskPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportFreshdeskPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportFreshdeskPut.
    ...
    def freshdesk_api_key(self):
        """Gets the freshdesk_api_key of this TransportFreshdeskPut.

        The API key for the Freshdesk service. Stored in encrypted format.

        :return: The freshdesk_api_key of this TransportFreshdeskPut.
        :rtype: str
        """
    ...
    def freshdesk_api_key(self, freshdesk_api_key):
        """Sets the freshdesk_api_key of this TransportFreshdeskPut.
    ...
    def freshdesk_email(self):
        """Gets the freshdesk_email of this TransportFreshdeskPut.

        The requester email address for the Freshdesk service.

        :return: The freshdesk_email of this TransportFreshdeskPut.
        :rtype: str
        """
    ...
    def freshdesk_email(self, freshdesk_email):
        """Sets the freshdesk_email of this TransportFreshdeskPut.
    ...
    def freshdesk_host(self):
        """Gets the freshdesk_host of this TransportFreshdeskPut.

        The host name for the Freshdesk service (domain.freshdesk.com).

        :return: The freshdesk_host of this TransportFreshdeskPut.
        :rtype: str
        """
    ...
    def freshdesk_host(self, freshdesk_host):
        """Sets the freshdesk_host of this TransportFreshdeskPut.
    ...
    def freshdesk_priority(self):
        """Gets the freshdesk_priority of this TransportFreshdeskPut.

        The ticket priority for the Freshdesk service.

        :return: The freshdesk_priority of this TransportFreshdeskPut.
        :rtype: str
        """
    ...
    def freshdesk_priority(self, freshdesk_priority):
        """Sets the freshdesk_priority of this TransportFreshdeskPut.
    ...
    def freshdesk_type(self):
        """Gets the freshdesk_type of this TransportFreshdeskPut.

        The ticket type for the Freshdesk service.

        :return: The freshdesk_type of this TransportFreshdeskPut.
        :rtype: str
        """
    ...
    def freshdesk_type(self, freshdesk_type):
        """Sets the freshdesk_type of this TransportFreshdeskPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportFreshdeskPut.

        The name of the transport.

        :return: The transport_name of this TransportFreshdeskPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportFreshdeskPut.
