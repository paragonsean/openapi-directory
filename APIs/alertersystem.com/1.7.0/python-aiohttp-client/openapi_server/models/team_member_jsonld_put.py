...
class TeamMemberJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, team_member_role_code: str=None):
        """TeamMemberJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TeamMemberJsonldPut.
        :param team_member_role_code: The team_member_role_code of this TeamMemberJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TeamMemberJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TeamMember.jsonld-put of this TeamMemberJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TeamMemberJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TeamMemberJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TeamMemberJsonldPut.
    ...
    def team_member_role_code(self):
        """Gets the team_member_role_code of this TeamMemberJsonldPut.

        The role of the team member on the team.

        :return: The team_member_role_code of this TeamMemberJsonldPut.
        :rtype: str
        """
    ...
    def team_member_role_code(self, team_member_role_code):
        """Sets the team_member_role_code of this TeamMemberJsonldPut.
