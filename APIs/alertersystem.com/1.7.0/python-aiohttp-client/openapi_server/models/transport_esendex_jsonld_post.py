...
class TransportEsendexJsonldPost(Model):
    ...
    def __init__(self, data_segment_code: str=None, esendex_account_reference: str=None, esendex_from: str=None, esendex_password: str=None, esendex_username: str=None, partition: str=None, transport_name: str=None):
        """TransportEsendexJsonldPost - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportEsendexJsonldPost.
        :param esendex_account_reference: The esendex_account_reference of this TransportEsendexJsonldPost.
        :param esendex_from: The esendex_from of this TransportEsendexJsonldPost.
        :param esendex_password: The esendex_password of this TransportEsendexJsonldPost.
        :param esendex_username: The esendex_username of this TransportEsendexJsonldPost.
        :param partition: The partition of this TransportEsendexJsonldPost.
        :param transport_name: The transport_name of this TransportEsendexJsonldPost.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportEsendexJsonldPost':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportEsendex.jsonld-post of this TransportEsendexJsonldPost.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportEsendexJsonldPost.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportEsendexJsonldPost.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportEsendexJsonldPost.
    ...
    def esendex_account_reference(self):
        """Gets the esendex_account_reference of this TransportEsendexJsonldPost.

        The account reference that the message should be sent from for the Esendex service.

        :return: The esendex_account_reference of this TransportEsendexJsonldPost.
        :rtype: str
        """
    ...
    def esendex_account_reference(self, esendex_account_reference):
        """Sets the esendex_account_reference of this TransportEsendexJsonldPost.
    ...
    def esendex_from(self):
        """Gets the esendex_from of this TransportEsendexJsonldPost.

        The alphanumeric originator for the message to appear to originate from for the Esendex service.

        :return: The esendex_from of this TransportEsendexJsonldPost.
        :rtype: str
        """
    ...
    def esendex_from(self, esendex_from):
        """Sets the esendex_from of this TransportEsendexJsonldPost.
    ...
    def esendex_password(self):
        """Gets the esendex_password of this TransportEsendexJsonldPost.

        The API password for the Esendex service. Stored in encrypted format.

        :return: The esendex_password of this TransportEsendexJsonldPost.
        :rtype: str
        """
    ...
    def esendex_password(self, esendex_password):
        """Sets the esendex_password of this TransportEsendexJsonldPost.
    ...
    def esendex_username(self):
        """Gets the esendex_username of this TransportEsendexJsonldPost.

        The account email for the Esendex service.

        :return: The esendex_username of this TransportEsendexJsonldPost.
        :rtype: str
        """
    ...
    def esendex_username(self, esendex_username):
        """Sets the esendex_username of this TransportEsendexJsonldPost.
    ...
    @property
    def partition(self):
        """Gets the partition of this TransportEsendexJsonldPost.

        The partition that contains this resource instance. The resource cannot be moved to another partition.

        :return: The partition of this TransportEsendexJsonldPost.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this TransportEsendexJsonldPost.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportEsendexJsonldPost.

        The name of the transport.

        :return: The transport_name of this TransportEsendexJsonldPost.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportEsendexJsonldPost.
