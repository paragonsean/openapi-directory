...
class TransportOvhCloudJsonldPut(Model):
    ...
    def __init__(self, data_segment_code: str=None, ovh_cloud_application_key: str=None, ovh_cloud_application_secret: str=None, ovh_cloud_consumer_key: str=None, ovh_cloud_sender: str=None, ovh_cloud_service_name: str=None, transport_name: str=None):
        """TransportOvhCloudJsonldPut - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportOvhCloudJsonldPut.
        :param ovh_cloud_application_key: The ovh_cloud_application_key of this TransportOvhCloudJsonldPut.
        :param ovh_cloud_application_secret: The ovh_cloud_application_secret of this TransportOvhCloudJsonldPut.
        :param ovh_cloud_consumer_key: The ovh_cloud_consumer_key of this TransportOvhCloudJsonldPut.
        :param ovh_cloud_sender: The ovh_cloud_sender of this TransportOvhCloudJsonldPut.
        :param ovh_cloud_service_name: The ovh_cloud_service_name of this TransportOvhCloudJsonldPut.
        :param transport_name: The transport_name of this TransportOvhCloudJsonldPut.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportOvhCloudJsonldPut':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportOvhCloud.jsonld-put of this TransportOvhCloudJsonldPut.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportOvhCloudJsonldPut.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportOvhCloudJsonldPut.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportOvhCloudJsonldPut.
    ...
    def ovh_cloud_application_key(self):
        """Gets the ovh_cloud_application_key of this TransportOvhCloudJsonldPut.

        The application key for the OVHcloud service.

        :return: The ovh_cloud_application_key of this TransportOvhCloudJsonldPut.
        :rtype: str
        """
    ...
    def ovh_cloud_application_key(self, ovh_cloud_application_key):
        """Sets the ovh_cloud_application_key of this TransportOvhCloudJsonldPut.
    ...
    def ovh_cloud_application_secret(self):
        """Gets the ovh_cloud_application_secret of this TransportOvhCloudJsonldPut.

        The application secret for the OVHcloud service. Stored in encrypted format.

        :return: The ovh_cloud_application_secret of this TransportOvhCloudJsonldPut.
        :rtype: str
        """
    ...
    def ovh_cloud_application_secret(self, ovh_cloud_application_secret):
        """Sets the ovh_cloud_application_secret of this TransportOvhCloudJsonldPut.
    ...
    def ovh_cloud_consumer_key(self):
        """Gets the ovh_cloud_consumer_key of this TransportOvhCloudJsonldPut.

        The consumer key for the OVHcloud service.

        :return: The ovh_cloud_consumer_key of this TransportOvhCloudJsonldPut.
        :rtype: str
        """
    ...
    def ovh_cloud_consumer_key(self, ovh_cloud_consumer_key):
        """Sets the ovh_cloud_consumer_key of this TransportOvhCloudJsonldPut.
    ...
    def ovh_cloud_sender(self):
        """Gets the ovh_cloud_sender of this TransportOvhCloudJsonldPut.

        The optional sender for the OVHcloud service.

        :return: The ovh_cloud_sender of this TransportOvhCloudJsonldPut.
        :rtype: str
        """
    ...
    def ovh_cloud_sender(self, ovh_cloud_sender):
        """Sets the ovh_cloud_sender of this TransportOvhCloudJsonldPut.
    ...
    def ovh_cloud_service_name(self):
        """Gets the ovh_cloud_service_name of this TransportOvhCloudJsonldPut.

        The service name for the OVHcloud service.

        :return: The ovh_cloud_service_name of this TransportOvhCloudJsonldPut.
        :rtype: str
        """
    ...
    def ovh_cloud_service_name(self, ovh_cloud_service_name):
        """Sets the ovh_cloud_service_name of this TransportOvhCloudJsonldPut.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportOvhCloudJsonldPut.

        The name of the transport.

        :return: The transport_name of this TransportOvhCloudJsonldPut.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportOvhCloudJsonldPut.
