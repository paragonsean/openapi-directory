...
class TransportOctopushPatch(Model):
    ...
    def __init__(self, data_segment_code: str=None, octopush_api_key: str=None, octopush_from: str=None, octopush_type: str=None, octopush_user_login: str=None, transport_name: str=None):
        """TransportOctopushPatch - a model defined in OpenAPI

        :param data_segment_code: The data_segment_code of this TransportOctopushPatch.
        :param octopush_api_key: The octopush_api_key of this TransportOctopushPatch.
        :param octopush_from: The octopush_from of this TransportOctopushPatch.
        :param octopush_type: The octopush_type of this TransportOctopushPatch.
        :param octopush_user_login: The octopush_user_login of this TransportOctopushPatch.
        :param transport_name: The transport_name of this TransportOctopushPatch.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportOctopushPatch':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportOctopush-patch of this TransportOctopushPatch.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportOctopushPatch.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportOctopushPatch.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportOctopushPatch.
    ...
    def octopush_api_key(self):
        """Gets the octopush_api_key of this TransportOctopushPatch.

        The API key for the Octopush service. Stored in encrypted format.

        :return: The octopush_api_key of this TransportOctopushPatch.
        :rtype: str
        """
    ...
    def octopush_api_key(self, octopush_api_key):
        """Sets the octopush_api_key of this TransportOctopushPatch.
    ...
    def octopush_from(self):
        """Gets the octopush_from of this TransportOctopushPatch.

        The sender value for the Octopush service.

        :return: The octopush_from of this TransportOctopushPatch.
        :rtype: str
        """
    ...
    def octopush_from(self, octopush_from):
        """Sets the octopush_from of this TransportOctopushPatch.
    ...
    def octopush_type(self):
        """Gets the octopush_type of this TransportOctopushPatch.

        The SMS type ('XXX' = SMS LowCost; 'FR' = SMS Premium; 'WWW' = SMS World) for the Octopush service.

        :return: The octopush_type of this TransportOctopushPatch.
        :rtype: str
        """
    ...
    def octopush_type(self, octopush_type):
        """Sets the octopush_type of this TransportOctopushPatch.
    ...
    def octopush_user_login(self):
        """Gets the octopush_user_login of this TransportOctopushPatch.

        The user login (email) for the Octopush service.

        :return: The octopush_user_login of this TransportOctopushPatch.
        :rtype: str
        """
    ...
    def octopush_user_login(self, octopush_user_login):
        """Sets the octopush_user_login of this TransportOctopushPatch.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportOctopushPatch.

        The name of the transport.

        :return: The transport_name of this TransportOctopushPatch.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportOctopushPatch.
