...
class TransportContactEveryonePatch(Model):
    ...
    def __init__(self, contact_everyone_category: str=None, contact_everyone_diffusion_name: str=None, contact_everyone_token: str=None, data_segment_code: str=None, transport_name: str=None):
        """TransportContactEveryonePatch - a model defined in OpenAPI

        :param contact_everyone_category: The contact_everyone_category of this TransportContactEveryonePatch.
        :param contact_everyone_diffusion_name: The contact_everyone_diffusion_name of this TransportContactEveryonePatch.
        :param contact_everyone_token: The contact_everyone_token of this TransportContactEveryonePatch.
        :param data_segment_code: The data_segment_code of this TransportContactEveryonePatch.
        :param transport_name: The transport_name of this TransportContactEveryonePatch.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportContactEveryonePatch':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportContactEveryone-patch of this TransportContactEveryonePatch.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def contact_everyone_category(self):
        """Gets the contact_everyone_category of this TransportContactEveryonePatch.

        The label of the category that will be displayed in the external service event logs of the ContactEveryone service.

        :return: The contact_everyone_category of this TransportContactEveryonePatch.
        :rtype: str
        """
    ...
    def contact_everyone_category(self, contact_everyone_category):
        """Sets the contact_everyone_category of this TransportContactEveryonePatch.
    ...
    def contact_everyone_diffusion_name(self):
        """Gets the contact_everyone_diffusion_name of this TransportContactEveryonePatch.

        The label of the diffusion that will be displayed in the external service event logs of the ContactEveryone service.

        :return: The contact_everyone_diffusion_name of this TransportContactEveryonePatch.
        :rtype: str
        """
    ...
    def contact_everyone_diffusion_name(self, contact_everyone_diffusion_name):
        """Sets the contact_everyone_diffusion_name of this TransportContactEveryonePatch.
    ...
    def contact_everyone_token(self):
        """Gets the contact_everyone_token of this TransportContactEveryonePatch.

        The token for the Contact Everyone service. Stored in encrypted format.

        :return: The contact_everyone_token of this TransportContactEveryonePatch.
        :rtype: str
        """
    ...
    def contact_everyone_token(self, contact_everyone_token):
        """Sets the contact_everyone_token of this TransportContactEveryonePatch.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportContactEveryonePatch.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportContactEveryonePatch.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportContactEveryonePatch.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportContactEveryonePatch.

        The name of the transport.

        :return: The transport_name of this TransportContactEveryonePatch.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportContactEveryonePatch.
