...
class TransportPlivoGet(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, created_at: datetime=None, data_segment_code: str=None, id: str=None, partition: str=None, plivo_auth_id: str=None, plivo_auth_token: str=None, plivo_from: str=None, resource_owner: str=None, transport_name: str=None):
        """TransportPlivoGet - a model defined in OpenAPI

        :param created_at: The created_at of this TransportPlivoGet.
        :param data_segment_code: The data_segment_code of this TransportPlivoGet.
        :param id: The id of this TransportPlivoGet.
        :param partition: The partition of this TransportPlivoGet.
        :param plivo_auth_id: The plivo_auth_id of this TransportPlivoGet.
        :param plivo_auth_token: The plivo_auth_token of this TransportPlivoGet.
        :param plivo_from: The plivo_from of this TransportPlivoGet.
        :param resource_owner: The resource_owner of this TransportPlivoGet.
        :param transport_name: The transport_name of this TransportPlivoGet.
        """
        self.openapi_types = {
            'created_at': datetime,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TransportPlivoGet':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TransportPlivo-get of this TransportPlivoGet.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def created_at(self):
        """Gets the created_at of this TransportPlivoGet.

        When the resource instance was created. This date-time is in the UTC timezone.

        :return: The created_at of this TransportPlivoGet.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this TransportPlivoGet.
    ...
    def data_segment_code(self):
        """Gets the data_segment_code of this TransportPlivoGet.

        User-provided string on which to segment and filter data. Max 50 characters.

        :return: The data_segment_code of this TransportPlivoGet.
        :rtype: str
        """
    ...
    def data_segment_code(self, data_segment_code):
        """Sets the data_segment_code of this TransportPlivoGet.
    ...
    @property
    def id(self):
        """Gets the id of this TransportPlivoGet.

        The unique identifier of the resource instance.

        :return: The id of this TransportPlivoGet.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TransportPlivoGet.
    ...
    def partition(self, partition):
        """Sets the partition of this TransportPlivoGet.
    ...
    def plivo_auth_id(self):
        """Gets the plivo_auth_id of this TransportPlivoGet.

        The auth ID for the Plivo service.

        :return: The plivo_auth_id of this TransportPlivoGet.
        :rtype: str
        """
    ...
    def plivo_auth_id(self, plivo_auth_id):
        """Sets the plivo_auth_id of this TransportPlivoGet.
    ...
    def plivo_auth_token(self):
        """Gets the plivo_auth_token of this TransportPlivoGet.

        The auth token for the Plivo service. Stored in encrypted format.

        :return: The plivo_auth_token of this TransportPlivoGet.
        :rtype: str
        """
    ...
    def plivo_auth_token(self, plivo_auth_token):
        """Sets the plivo_auth_token of this TransportPlivoGet.
    ...
    @property
    def plivo_from(self):
        """Gets the plivo_from of this TransportPlivoGet.

        The sender value for the Plivo service.

        :return: The plivo_from of this TransportPlivoGet.
        :rtype: str
        """
    ...
    def plivo_from(self, plivo_from):
        """Sets the plivo_from of this TransportPlivoGet.
    ...
    def resource_owner(self):
        """Gets the resource_owner of this TransportPlivoGet.

        The name of the person who owns this resource.

        :return: The resource_owner of this TransportPlivoGet.
        :rtype: str
        """
    ...
    def resource_owner(self, resource_owner):
        """Sets the resource_owner of this TransportPlivoGet.
    ...
    def transport_name(self):
        """Gets the transport_name of this TransportPlivoGet.

        The name of the transport.

        :return: The transport_name of this TransportPlivoGet.
        :rtype: str
        """
    ...
    def transport_name(self, transport_name):
        """Sets the transport_name of this TransportPlivoGet.
