...
|**kazInfoTehFrom** | **String** | The from value for the KazInfoTeh service. |  |
|**kazInfoTehPassword** | **String** | The password for the KazInfoTeh service. Stored in encrypted format. |  |
|**kazInfoTehUsername** | **String** | The username for the KazInfoTeh service. |  |
