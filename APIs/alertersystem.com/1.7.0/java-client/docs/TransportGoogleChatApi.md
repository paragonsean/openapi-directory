...
<a id="apiTransportGoogleChatGetCollection"></a>
# **apiTransportGoogleChatGetCollection**
> List&lt;TransportGoogleChatGet&gt; apiTransportGoogleChatGetCollection(page, dataSegmentCode, dataSegmentCode2, partition, partition2, properties)
...
import org.openapitools.client.api.TransportGoogleChatApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TransportGoogleChatApi apiInstance = new TransportGoogleChatApi(defaultClient);
    ...
    try {
      List<TransportGoogleChatGet> result = apiInstance.apiTransportGoogleChatGetCollection(page, dataSegmentCode, dataSegmentCode2, partition, partition2, properties);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransportGoogleChatApi#apiTransportGoogleChatGetCollection");
...
<a id="apiTransportGoogleChatIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    TransportGoogleChatApi apiInstance = new TransportGoogleChatApi(defaultClient);
    String id = "id_example"; // String | TransportGoogleChat identifier
    try {
      apiInstance.apiTransportGoogleChatIdDelete(id);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransportGoogleChatApi#apiTransportGoogleChatIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="apiTransportGoogleChatIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | TransportGoogleChat identifier
    try {
      TransportGoogleChatGet result = apiInstance.apiTransportGoogleChatIdGet(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransportGoogleChatApi#apiTransportGoogleChatIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="apiTransportGoogleChatIdPatch"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    TransportGoogleChatApi apiInstance = new TransportGoogleChatApi(defaultClient);
    String id = "id_example"; // String | TransportGoogleChat identifier
    TransportGoogleChatPatch transportGoogleChatPatch = new TransportGoogleChatPatch(); // TransportGoogleChatPatch | The updated TransportGoogleChat resource
    try {
      TransportGoogleChatGet result = apiInstance.apiTransportGoogleChatIdPatch(id, transportGoogleChatPatch);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransportGoogleChatApi#apiTransportGoogleChatIdPatch");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="apiTransportGoogleChatIdPut"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    TransportGoogleChatApi apiInstance = new TransportGoogleChatApi(defaultClient);
    String id = "id_example"; // String | TransportGoogleChat identifier
    TransportGoogleChatPut transportGoogleChatPut = new TransportGoogleChatPut(); // TransportGoogleChatPut | The updated TransportGoogleChat resource
    try {
      TransportGoogleChatGet result = apiInstance.apiTransportGoogleChatIdPut(id, transportGoogleChatPut);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransportGoogleChatApi#apiTransportGoogleChatIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="apiTransportGoogleChatPost"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    TransportGoogleChatApi apiInstance = new TransportGoogleChatApi(defaultClient);
    TransportGoogleChatPost transportGoogleChatPost = new TransportGoogleChatPost(); // TransportGoogleChatPost | The new TransportGoogleChat resource
    try {
      TransportGoogleChatGet result = apiInstance.apiTransportGoogleChatPost(transportGoogleChatPost);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransportGoogleChatApi#apiTransportGoogleChatPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
