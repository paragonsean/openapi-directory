...
public class TransportBandwidthPut {
  ...
  public TransportBandwidthPut() {
  }

  public TransportBandwidthPut bandwidthAccountId(String bandwidthAccountId) {
  ...
  public TransportBandwidthPut bandwidthApplicationId(String bandwidthApplicationId) {
  ...
  public TransportBandwidthPut bandwidthFrom(String bandwidthFrom) {
  ...
  public TransportBandwidthPut bandwidthPassword(String bandwidthPassword) {
  ...
  public TransportBandwidthPut bandwidthUsername(String bandwidthUsername) {
  ...
  public TransportBandwidthPut dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportBandwidthPut transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportBandwidthPut transportBandwidthPut = (TransportBandwidthPut) o;
    return Objects.equals(this.bandwidthAccountId, transportBandwidthPut.bandwidthAccountId) &&
        Objects.equals(this.bandwidthApplicationId, transportBandwidthPut.bandwidthApplicationId) &&
        Objects.equals(this.bandwidthFrom, transportBandwidthPut.bandwidthFrom) &&
        Objects.equals(this.bandwidthPassword, transportBandwidthPut.bandwidthPassword) &&
        Objects.equals(this.bandwidthUsername, transportBandwidthPut.bandwidthUsername) &&
        Objects.equals(this.dataSegmentCode, transportBandwidthPut.dataSegmentCode) &&
        Objects.equals(this.transportName, transportBandwidthPut.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportBandwidthPut {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportBandwidthPut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportBandwidthPut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportBandwidthPut is not found in the empty JSON string", TransportBandwidthPut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportBandwidthPut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportBandwidthPut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportBandwidthPut.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportBandwidthPut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportBandwidthPut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportBandwidthPut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportBandwidthPut.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportBandwidthPut>() {
           @Override
           public void write(JsonWriter out, TransportBandwidthPut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportBandwidthPut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportBandwidthPut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportBandwidthPut
   * @throws IOException if the JSON string is invalid with respect to TransportBandwidthPut
   */
  public static TransportBandwidthPut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportBandwidthPut.class);
  }

  /**
   * Convert an instance of TransportBandwidthPut to an JSON string
   *
   * @return JSON string
   */
