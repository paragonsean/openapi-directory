...
public class TransportOrangeSmsJsonldPut {
  ...
  public TransportOrangeSmsJsonldPut() {
  }

  public TransportOrangeSmsJsonldPut dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportOrangeSmsJsonldPut orangeSmsClientId(String orangeSmsClientId) {
  ...
  public TransportOrangeSmsJsonldPut orangeSmsClientSecret(String orangeSmsClientSecret) {
  ...
  public TransportOrangeSmsJsonldPut orangeSmsFrom(String orangeSmsFrom) {
  ...
  public TransportOrangeSmsJsonldPut orangeSmsSenderName(String orangeSmsSenderName) {
  ...
  public TransportOrangeSmsJsonldPut transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportOrangeSmsJsonldPut transportOrangeSmsJsonldPut = (TransportOrangeSmsJsonldPut) o;
    return Objects.equals(this.dataSegmentCode, transportOrangeSmsJsonldPut.dataSegmentCode) &&
        Objects.equals(this.orangeSmsClientId, transportOrangeSmsJsonldPut.orangeSmsClientId) &&
        Objects.equals(this.orangeSmsClientSecret, transportOrangeSmsJsonldPut.orangeSmsClientSecret) &&
        Objects.equals(this.orangeSmsFrom, transportOrangeSmsJsonldPut.orangeSmsFrom) &&
        Objects.equals(this.orangeSmsSenderName, transportOrangeSmsJsonldPut.orangeSmsSenderName) &&
        Objects.equals(this.transportName, transportOrangeSmsJsonldPut.transportName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dataSegmentCode, orangeSmsClientId, orangeSmsClientSecret, orangeSmsFrom, orangeSmsSenderName, transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportOrangeSmsJsonldPut {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportOrangeSmsJsonldPut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportOrangeSmsJsonldPut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportOrangeSmsJsonldPut is not found in the empty JSON string", TransportOrangeSmsJsonldPut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportOrangeSmsJsonldPut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportOrangeSmsJsonldPut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportOrangeSmsJsonldPut.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportOrangeSmsJsonldPut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportOrangeSmsJsonldPut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportOrangeSmsJsonldPut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportOrangeSmsJsonldPut.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportOrangeSmsJsonldPut>() {
           @Override
           public void write(JsonWriter out, TransportOrangeSmsJsonldPut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportOrangeSmsJsonldPut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportOrangeSmsJsonldPut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportOrangeSmsJsonldPut
   * @throws IOException if the JSON string is invalid with respect to TransportOrangeSmsJsonldPut
   */
  public static TransportOrangeSmsJsonldPut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportOrangeSmsJsonldPut.class);
  }

  /**
   * Convert an instance of TransportOrangeSmsJsonldPut to an JSON string
   *
   * @return JSON string
   */
