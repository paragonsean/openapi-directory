...
public class TransportBandwidthJsonldPost {
  ...
  public TransportBandwidthJsonldPost() {
  }

  public TransportBandwidthJsonldPost bandwidthAccountId(String bandwidthAccountId) {
  ...
  public TransportBandwidthJsonldPost bandwidthApplicationId(String bandwidthApplicationId) {
  ...
  public TransportBandwidthJsonldPost bandwidthFrom(String bandwidthFrom) {
  ...
  public TransportBandwidthJsonldPost bandwidthPassword(String bandwidthPassword) {
  ...
  public TransportBandwidthJsonldPost bandwidthUsername(String bandwidthUsername) {
  ...
  public TransportBandwidthJsonldPost dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportBandwidthJsonldPost partition(String partition) {
  ...
  public TransportBandwidthJsonldPost transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportBandwidthJsonldPost transportBandwidthJsonldPost = (TransportBandwidthJsonldPost) o;
    return Objects.equals(this.bandwidthAccountId, transportBandwidthJsonldPost.bandwidthAccountId) &&
        Objects.equals(this.bandwidthApplicationId, transportBandwidthJsonldPost.bandwidthApplicationId) &&
        Objects.equals(this.bandwidthFrom, transportBandwidthJsonldPost.bandwidthFrom) &&
        Objects.equals(this.bandwidthPassword, transportBandwidthJsonldPost.bandwidthPassword) &&
        Objects.equals(this.bandwidthUsername, transportBandwidthJsonldPost.bandwidthUsername) &&
        Objects.equals(this.dataSegmentCode, transportBandwidthJsonldPost.dataSegmentCode) &&
        Objects.equals(this.partition, transportBandwidthJsonldPost.partition) &&
        Objects.equals(this.transportName, transportBandwidthJsonldPost.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportBandwidthJsonldPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportBandwidthJsonldPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportBandwidthJsonldPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportBandwidthJsonldPost is not found in the empty JSON string", TransportBandwidthJsonldPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportBandwidthJsonldPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportBandwidthJsonldPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportBandwidthJsonldPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportBandwidthJsonldPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportBandwidthJsonldPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportBandwidthJsonldPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportBandwidthJsonldPost.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportBandwidthJsonldPost>() {
           @Override
           public void write(JsonWriter out, TransportBandwidthJsonldPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportBandwidthJsonldPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportBandwidthJsonldPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportBandwidthJsonldPost
   * @throws IOException if the JSON string is invalid with respect to TransportBandwidthJsonldPost
   */
  public static TransportBandwidthJsonldPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportBandwidthJsonldPost.class);
  }

  /**
   * Convert an instance of TransportBandwidthJsonldPost to an JSON string
   *
   * @return JSON string
   */
