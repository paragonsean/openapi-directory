...
public class MonitorPost {
  ...
  public MonitorPost alertPayloadExtended(String alertPayloadExtended) {
  ...
  public MonitorPost alertPayloadShort(String alertPayloadShort) {
  ...
  public MonitorPost alertServices(List<String> alertServices) {
    this.alertServices = alertServices;
    return this;
  }

  public MonitorPost addAlertServicesItem(String alertServicesItem) {
  ...
  public MonitorPost allowUnauthenticatedPings(Boolean allowUnauthenticatedPings) {
  ...
  public MonitorPost contentCheckMustNotExist(Boolean contentCheckMustNotExist) {
  ...
  public MonitorPost contentCheckText(String contentCheckText) {
  ...
  public MonitorPost contentCheckUrl(URI contentCheckUrl) {
  ...
  public MonitorPost contentCheckXpathFilter(String contentCheckXpathFilter) {
  ...
  public MonitorPost dataSegmentCode(String dataSegmentCode) {
  ...
  public MonitorPost graceSeconds(Integer graceSeconds) {
  ...
  public MonitorPost intervalDays(Integer intervalDays) {
  ...
  public MonitorPost intervalHours(Integer intervalHours) {
  ...
  public MonitorPost intervalMinutes(Integer intervalMinutes) {
  ...
  public MonitorPost intervalMonths(Integer intervalMonths) {
  ...
  public MonitorPost intervalSeconds(Integer intervalSeconds) {
  ...
  public MonitorPost intervalYears(Integer intervalYears) {
  ...
  public MonitorPost isMonitorPaused(Boolean isMonitorPaused) {
  ...
  public MonitorPost monitorName(String monitorName) {
  ...
  public MonitorPost monitorNotes(String monitorNotes) {
  ...
  public MonitorPost monitorTypeCode(String monitorTypeCode) {
  ...
  public MonitorPost partition(String partition) {
  ...
  public MonitorPost publicDescription(String publicDescription) {
  ...
  public MonitorPost startMonitorAt(OffsetDateTime startMonitorAt) {
  ...
  public MonitorPost timezoneCode(String timezoneCode) {
  ...
  public MonitorPost webResponseSecondsLimit(Integer webResponseSecondsLimit) {
  ...
  public MonitorPost webResponseUrl(URI webResponseUrl) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorPost monitorPost = (MonitorPost) o;
    return Objects.equals(this.alertPayloadExtended, monitorPost.alertPayloadExtended) &&
        Objects.equals(this.alertPayloadShort, monitorPost.alertPayloadShort) &&
        Objects.equals(this.alertServices, monitorPost.alertServices) &&
        Objects.equals(this.allowUnauthenticatedPings, monitorPost.allowUnauthenticatedPings) &&
        Objects.equals(this.contentCheckMustNotExist, monitorPost.contentCheckMustNotExist) &&
        Objects.equals(this.contentCheckText, monitorPost.contentCheckText) &&
        Objects.equals(this.contentCheckUrl, monitorPost.contentCheckUrl) &&
        Objects.equals(this.contentCheckXpathFilter, monitorPost.contentCheckXpathFilter) &&
        Objects.equals(this.dataSegmentCode, monitorPost.dataSegmentCode) &&
        Objects.equals(this.graceSeconds, monitorPost.graceSeconds) &&
        Objects.equals(this.intervalDays, monitorPost.intervalDays) &&
        Objects.equals(this.intervalHours, monitorPost.intervalHours) &&
        Objects.equals(this.intervalMinutes, monitorPost.intervalMinutes) &&
        Objects.equals(this.intervalMonths, monitorPost.intervalMonths) &&
        Objects.equals(this.intervalSeconds, monitorPost.intervalSeconds) &&
        Objects.equals(this.intervalYears, monitorPost.intervalYears) &&
        Objects.equals(this.isMonitorPaused, monitorPost.isMonitorPaused) &&
        Objects.equals(this.monitorName, monitorPost.monitorName) &&
        Objects.equals(this.monitorNotes, monitorPost.monitorNotes) &&
        Objects.equals(this.monitorTypeCode, monitorPost.monitorTypeCode) &&
        Objects.equals(this.partition, monitorPost.partition) &&
        Objects.equals(this.publicDescription, monitorPost.publicDescription) &&
        Objects.equals(this.startMonitorAt, monitorPost.startMonitorAt) &&
        Objects.equals(this.timezoneCode, monitorPost.timezoneCode) &&
        Objects.equals(this.webResponseSecondsLimit, monitorPost.webResponseSecondsLimit) &&
        Objects.equals(this.webResponseUrl, monitorPost.webResponseUrl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorPost is not found in the empty JSON string", MonitorPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorPost.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorPost>() {
           @Override
           public void write(JsonWriter out, MonitorPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorPost
   * @throws IOException if the JSON string is invalid with respect to MonitorPost
   */
  public static MonitorPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorPost.class);
  }

  /**
   * Convert an instance of MonitorPost to an JSON string
   *
   * @return JSON string
   */
