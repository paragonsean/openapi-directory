...
public class TransportEmailPatch {
  ...
  public TransportEmailPatch() {
  }

  public TransportEmailPatch dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportEmailPatch emailFromAddress(String emailFromAddress) {
  ...
  public TransportEmailPatch emailFromName(String emailFromName) {
  ...
  public TransportEmailPatch emailPassword(String emailPassword) {
  ...
  public TransportEmailPatch emailPort(Integer emailPort) {
  ...
  public TransportEmailPatch emailServer(String emailServer) {
  ...
  public TransportEmailPatch emailUsername(String emailUsername) {
  ...
  public TransportEmailPatch transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportEmailPatch transportEmailPatch = (TransportEmailPatch) o;
    return Objects.equals(this.dataSegmentCode, transportEmailPatch.dataSegmentCode) &&
        Objects.equals(this.emailFromAddress, transportEmailPatch.emailFromAddress) &&
        Objects.equals(this.emailFromName, transportEmailPatch.emailFromName) &&
        Objects.equals(this.emailPassword, transportEmailPatch.emailPassword) &&
        Objects.equals(this.emailPort, transportEmailPatch.emailPort) &&
        Objects.equals(this.emailServer, transportEmailPatch.emailServer) &&
        Objects.equals(this.emailUsername, transportEmailPatch.emailUsername) &&
        Objects.equals(this.transportName, transportEmailPatch.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportEmailPatch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportEmailPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportEmailPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportEmailPatch is not found in the empty JSON string", TransportEmailPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportEmailPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportEmailPatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportEmailPatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportEmailPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportEmailPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportEmailPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportEmailPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportEmailPatch>() {
           @Override
           public void write(JsonWriter out, TransportEmailPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportEmailPatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportEmailPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportEmailPatch
   * @throws IOException if the JSON string is invalid with respect to TransportEmailPatch
   */
  public static TransportEmailPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportEmailPatch.class);
  }

  /**
   * Convert an instance of TransportEmailPatch to an JSON string
   *
   * @return JSON string
   */
