...
public class TransportOrangeSmsPut {
  ...
  public TransportOrangeSmsPut() {
  }

  public TransportOrangeSmsPut dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportOrangeSmsPut orangeSmsClientId(String orangeSmsClientId) {
  ...
  public TransportOrangeSmsPut orangeSmsClientSecret(String orangeSmsClientSecret) {
  ...
  public TransportOrangeSmsPut orangeSmsFrom(String orangeSmsFrom) {
  ...
  public TransportOrangeSmsPut orangeSmsSenderName(String orangeSmsSenderName) {
  ...
  public TransportOrangeSmsPut transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportOrangeSmsPut transportOrangeSmsPut = (TransportOrangeSmsPut) o;
    return Objects.equals(this.dataSegmentCode, transportOrangeSmsPut.dataSegmentCode) &&
        Objects.equals(this.orangeSmsClientId, transportOrangeSmsPut.orangeSmsClientId) &&
        Objects.equals(this.orangeSmsClientSecret, transportOrangeSmsPut.orangeSmsClientSecret) &&
        Objects.equals(this.orangeSmsFrom, transportOrangeSmsPut.orangeSmsFrom) &&
        Objects.equals(this.orangeSmsSenderName, transportOrangeSmsPut.orangeSmsSenderName) &&
        Objects.equals(this.transportName, transportOrangeSmsPut.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportOrangeSmsPut {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportOrangeSmsPut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportOrangeSmsPut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportOrangeSmsPut is not found in the empty JSON string", TransportOrangeSmsPut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportOrangeSmsPut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportOrangeSmsPut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportOrangeSmsPut.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportOrangeSmsPut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportOrangeSmsPut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportOrangeSmsPut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportOrangeSmsPut.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportOrangeSmsPut>() {
           @Override
           public void write(JsonWriter out, TransportOrangeSmsPut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportOrangeSmsPut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportOrangeSmsPut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportOrangeSmsPut
   * @throws IOException if the JSON string is invalid with respect to TransportOrangeSmsPut
   */
  public static TransportOrangeSmsPut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportOrangeSmsPut.class);
  }

  /**
   * Convert an instance of TransportOrangeSmsPut to an JSON string
   *
   * @return JSON string
   */
