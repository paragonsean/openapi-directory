...
public class PingPost {
  ...
  public PingPost expectNextPingAt(OffsetDateTime expectNextPingAt) {
  ...
  public PingPost expectNextPingAtEpoch(Integer expectNextPingAtEpoch) {
  ...
  public PingPost monitor(String monitor) {
  ...
  public PingPost pingCustomCode(String pingCustomCode) {
  ...
  public PingPost pingCustomPayload(String pingCustomPayload) {
  ...
  public boolean equals(Object o) {
    ...
    PingPost pingPost = (PingPost) o;
    return Objects.equals(this.expectNextPingAt, pingPost.expectNextPingAt) &&
        Objects.equals(this.expectNextPingAtEpoch, pingPost.expectNextPingAtEpoch) &&
        Objects.equals(this.monitor, pingPost.monitor) &&
        Objects.equals(this.pingCustomCode, pingPost.pingCustomCode) &&
        Objects.equals(this.pingCustomPayload, pingPost.pingCustomPayload);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PingPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PingPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PingPost is not found in the empty JSON string", PingPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PingPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PingPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PingPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PingPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PingPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PingPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PingPost.class));

       return (TypeAdapter<T>) new TypeAdapter<PingPost>() {
           @Override
           public void write(JsonWriter out, PingPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PingPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PingPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PingPost
   * @throws IOException if the JSON string is invalid with respect to PingPost
   */
  public static PingPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PingPost.class);
  }

  /**
   * Convert an instance of PingPost to an JSON string
   *
   * @return JSON string
   */
