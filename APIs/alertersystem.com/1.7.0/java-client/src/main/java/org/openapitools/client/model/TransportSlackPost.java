...
public class TransportSlackPost {
  ...
  public TransportSlackPost() {
  }

  public TransportSlackPost dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportSlackPost partition(String partition) {
  ...
  public TransportSlackPost slackChannel(String slackChannel) {
  ...
  public TransportSlackPost slackToken(String slackToken) {
  ...
  public TransportSlackPost transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportSlackPost transportSlackPost = (TransportSlackPost) o;
    return Objects.equals(this.dataSegmentCode, transportSlackPost.dataSegmentCode) &&
        Objects.equals(this.partition, transportSlackPost.partition) &&
        Objects.equals(this.slackChannel, transportSlackPost.slackChannel) &&
        Objects.equals(this.slackToken, transportSlackPost.slackToken) &&
        Objects.equals(this.transportName, transportSlackPost.transportName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dataSegmentCode, partition, slackChannel, slackToken, transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportSlackPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportSlackPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportSlackPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportSlackPost is not found in the empty JSON string", TransportSlackPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportSlackPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportSlackPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportSlackPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportSlackPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportSlackPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportSlackPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportSlackPost.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportSlackPost>() {
           @Override
           public void write(JsonWriter out, TransportSlackPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportSlackPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportSlackPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportSlackPost
   * @throws IOException if the JSON string is invalid with respect to TransportSlackPost
   */
  public static TransportSlackPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportSlackPost.class);
  }

  /**
   * Convert an instance of TransportSlackPost to an JSON string
   *
   * @return JSON string
   */
