...
public class TeamInvitationJsonldPost {
  ...
  public TeamInvitationJsonldPost() {
  }
  ...
  public TeamInvitationJsonldPost dataSegmentCode(String dataSegmentCode) {
  ...
  public TeamInvitationJsonldPost inviteeEmail(String inviteeEmail) {
  ...
  public TeamInvitationJsonldPost inviteeFirstName(String inviteeFirstName) {
  ...
  public TeamInvitationJsonldPost inviteeLastName(String inviteeLastName) {
  ...
  public TeamInvitationJsonldPost partition(String partition) {
  ...
  public TeamInvitationJsonldPost teamMemberRoleCode(String teamMemberRoleCode) {
  ...
  public boolean equals(Object o) {
    ...
    TeamInvitationJsonldPost teamInvitationJsonldPost = (TeamInvitationJsonldPost) o;
    return Objects.equals(this.dataSegmentCode, teamInvitationJsonldPost.dataSegmentCode) &&
        Objects.equals(this.id, teamInvitationJsonldPost.id) &&
        Objects.equals(this.inviteeEmail, teamInvitationJsonldPost.inviteeEmail) &&
        Objects.equals(this.inviteeFirstName, teamInvitationJsonldPost.inviteeFirstName) &&
        Objects.equals(this.inviteeLastName, teamInvitationJsonldPost.inviteeLastName) &&
        Objects.equals(this.partition, teamInvitationJsonldPost.partition) &&
        Objects.equals(this.teamMemberRoleCode, teamInvitationJsonldPost.teamMemberRoleCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TeamInvitationJsonldPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamInvitationJsonldPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamInvitationJsonldPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamInvitationJsonldPost is not found in the empty JSON string", TeamInvitationJsonldPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamInvitationJsonldPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamInvitationJsonldPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TeamInvitationJsonldPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamInvitationJsonldPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamInvitationJsonldPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamInvitationJsonldPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamInvitationJsonldPost.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamInvitationJsonldPost>() {
           @Override
           public void write(JsonWriter out, TeamInvitationJsonldPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TeamInvitationJsonldPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TeamInvitationJsonldPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TeamInvitationJsonldPost
   * @throws IOException if the JSON string is invalid with respect to TeamInvitationJsonldPost
   */
  public static TeamInvitationJsonldPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamInvitationJsonldPost.class);
  }

  /**
   * Convert an instance of TeamInvitationJsonldPost to an JSON string
   *
   * @return JSON string
   */
