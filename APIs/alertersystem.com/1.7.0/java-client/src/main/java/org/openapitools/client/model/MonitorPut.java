...
public class MonitorPut {
  ...
  public MonitorPut alertPayloadExtended(String alertPayloadExtended) {
  ...
  public MonitorPut alertPayloadShort(String alertPayloadShort) {
  ...
  public MonitorPut alertServices(List<String> alertServices) {
    this.alertServices = alertServices;
    return this;
  }

  public MonitorPut addAlertServicesItem(String alertServicesItem) {
  ...
  public MonitorPut allowUnauthenticatedPings(Boolean allowUnauthenticatedPings) {
  ...
  public MonitorPut contentCheckMustNotExist(Boolean contentCheckMustNotExist) {
  ...
  public MonitorPut contentCheckText(String contentCheckText) {
  ...
  public MonitorPut contentCheckUrl(URI contentCheckUrl) {
  ...
  public MonitorPut contentCheckXpathFilter(String contentCheckXpathFilter) {
  ...
  public MonitorPut dataSegmentCode(String dataSegmentCode) {
  ...
  public MonitorPut graceSeconds(Integer graceSeconds) {
  ...
  public MonitorPut intervalDays(Integer intervalDays) {
  ...
  public MonitorPut intervalHours(Integer intervalHours) {
  ...
  public MonitorPut intervalMinutes(Integer intervalMinutes) {
  ...
  public MonitorPut intervalMonths(Integer intervalMonths) {
  ...
  public MonitorPut intervalSeconds(Integer intervalSeconds) {
  ...
  public MonitorPut intervalYears(Integer intervalYears) {
  ...
  public MonitorPut isMonitorPaused(Boolean isMonitorPaused) {
  ...
  public MonitorPut monitorName(String monitorName) {
  ...
  public MonitorPut monitorNotes(String monitorNotes) {
  ...
  public MonitorPut publicDescription(String publicDescription) {
  ...
  public MonitorPut startMonitorAt(OffsetDateTime startMonitorAt) {
  ...
  public MonitorPut timezoneCode(String timezoneCode) {
  ...
  public MonitorPut webResponseSecondsLimit(Integer webResponseSecondsLimit) {
  ...
  public MonitorPut webResponseUrl(URI webResponseUrl) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorPut monitorPut = (MonitorPut) o;
    return Objects.equals(this.alertPayloadExtended, monitorPut.alertPayloadExtended) &&
        Objects.equals(this.alertPayloadShort, monitorPut.alertPayloadShort) &&
        Objects.equals(this.alertServices, monitorPut.alertServices) &&
        Objects.equals(this.allowUnauthenticatedPings, monitorPut.allowUnauthenticatedPings) &&
        Objects.equals(this.contentCheckMustNotExist, monitorPut.contentCheckMustNotExist) &&
        Objects.equals(this.contentCheckText, monitorPut.contentCheckText) &&
        Objects.equals(this.contentCheckUrl, monitorPut.contentCheckUrl) &&
        Objects.equals(this.contentCheckXpathFilter, monitorPut.contentCheckXpathFilter) &&
        Objects.equals(this.dataSegmentCode, monitorPut.dataSegmentCode) &&
        Objects.equals(this.graceSeconds, monitorPut.graceSeconds) &&
        Objects.equals(this.intervalDays, monitorPut.intervalDays) &&
        Objects.equals(this.intervalHours, monitorPut.intervalHours) &&
        Objects.equals(this.intervalMinutes, monitorPut.intervalMinutes) &&
        Objects.equals(this.intervalMonths, monitorPut.intervalMonths) &&
        Objects.equals(this.intervalSeconds, monitorPut.intervalSeconds) &&
        Objects.equals(this.intervalYears, monitorPut.intervalYears) &&
        Objects.equals(this.isMonitorPaused, monitorPut.isMonitorPaused) &&
        Objects.equals(this.monitorName, monitorPut.monitorName) &&
        Objects.equals(this.monitorNotes, monitorPut.monitorNotes) &&
        Objects.equals(this.publicDescription, monitorPut.publicDescription) &&
        Objects.equals(this.startMonitorAt, monitorPut.startMonitorAt) &&
        Objects.equals(this.timezoneCode, monitorPut.timezoneCode) &&
        Objects.equals(this.webResponseSecondsLimit, monitorPut.webResponseSecondsLimit) &&
        Objects.equals(this.webResponseUrl, monitorPut.webResponseUrl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorPut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorPut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorPut is not found in the empty JSON string", MonitorPut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorPut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorPut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorPut.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorPut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorPut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorPut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorPut.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorPut>() {
           @Override
           public void write(JsonWriter out, MonitorPut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorPut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorPut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorPut
   * @throws IOException if the JSON string is invalid with respect to MonitorPut
   */
  public static MonitorPut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorPut.class);
  }

  /**
   * Convert an instance of MonitorPut to an JSON string
   *
   * @return JSON string
   */
