...
public class MediaObjectJsonldGet {
  ...
  public MediaObjectJsonldGet atContext(AlertLogJsonldGetContext atContext) {
  ...
  public MediaObjectJsonldGet contentUrl(String contentUrl) {
  ...
  public MediaObjectJsonldGet dataSegmentCode(String dataSegmentCode) {
  ...
  public MediaObjectJsonldGet fileSize(Integer fileSize) {
  ...
  public MediaObjectJsonldGet keywords(String keywords) {
  ...
  public MediaObjectJsonldGet mimeType(String mimeType) {
  ...
  public MediaObjectJsonldGet originalName(String originalName) {
  ...
  public MediaObjectJsonldGet partition(String partition) {
  ...
  public MediaObjectJsonldGet resourceOwner(String resourceOwner) {
  ...
  public boolean equals(Object o) {
    ...
    MediaObjectJsonldGet mediaObjectJsonldGet = (MediaObjectJsonldGet) o;
    return Objects.equals(this.atContext, mediaObjectJsonldGet.atContext) &&
        Objects.equals(this.atId, mediaObjectJsonldGet.atId) &&
        Objects.equals(this.atType, mediaObjectJsonldGet.atType) &&
        Objects.equals(this.contentUrl, mediaObjectJsonldGet.contentUrl) &&
        Objects.equals(this.createdAt, mediaObjectJsonldGet.createdAt) &&
        Objects.equals(this.dataSegmentCode, mediaObjectJsonldGet.dataSegmentCode) &&
        Objects.equals(this.fileSize, mediaObjectJsonldGet.fileSize) &&
        Objects.equals(this.id, mediaObjectJsonldGet.id) &&
        Objects.equals(this.keywords, mediaObjectJsonldGet.keywords) &&
        Objects.equals(this.mimeType, mediaObjectJsonldGet.mimeType) &&
        Objects.equals(this.originalName, mediaObjectJsonldGet.originalName) &&
        Objects.equals(this.partition, mediaObjectJsonldGet.partition) &&
        Objects.equals(this.resourceOwner, mediaObjectJsonldGet.resourceOwner);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atContext, atId, atType, contentUrl, createdAt, dataSegmentCode, fileSize, id, keywords, mimeType, originalName, partition, resourceOwner);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediaObjectJsonldGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaObjectJsonldGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediaObjectJsonldGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediaObjectJsonldGet is not found in the empty JSON string", MediaObjectJsonldGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediaObjectJsonldGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediaObjectJsonldGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MediaObjectJsonldGet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaObjectJsonldGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaObjectJsonldGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaObjectJsonldGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaObjectJsonldGet.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaObjectJsonldGet>() {
           @Override
           public void write(JsonWriter out, MediaObjectJsonldGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaObjectJsonldGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaObjectJsonldGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaObjectJsonldGet
   * @throws IOException if the JSON string is invalid with respect to MediaObjectJsonldGet
   */
  public static MediaObjectJsonldGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaObjectJsonldGet.class);
  }

  /**
   * Convert an instance of MediaObjectJsonldGet to an JSON string
   *
   * @return JSON string
   */
