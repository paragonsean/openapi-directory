...
public class TeamMemberJsonldGet {
  ...
  public TeamMemberJsonldGet atContext(AlertLogJsonldGetContext atContext) {
  ...
  public TeamMemberJsonldGet dataSegmentCode(String dataSegmentCode) {
  ...
  public TeamMemberJsonldGet partition(String partition) {
  ...
  public TeamMemberJsonldGet resourceOwner(String resourceOwner) {
  ...
  public TeamMemberJsonldGet teamMemberRoleCode(String teamMemberRoleCode) {
  ...
  public TeamMemberJsonldGet userAccount(String userAccount) {
  ...
  public boolean equals(Object o) {
    ...
    TeamMemberJsonldGet teamMemberJsonldGet = (TeamMemberJsonldGet) o;
    return Objects.equals(this.atContext, teamMemberJsonldGet.atContext) &&
        Objects.equals(this.atId, teamMemberJsonldGet.atId) &&
        Objects.equals(this.atType, teamMemberJsonldGet.atType) &&
        Objects.equals(this.createdAt, teamMemberJsonldGet.createdAt) &&
        Objects.equals(this.dataSegmentCode, teamMemberJsonldGet.dataSegmentCode) &&
        Objects.equals(this.id, teamMemberJsonldGet.id) &&
        Objects.equals(this.partition, teamMemberJsonldGet.partition) &&
        Objects.equals(this.resourceOwner, teamMemberJsonldGet.resourceOwner) &&
        Objects.equals(this.teamMemberRoleCode, teamMemberJsonldGet.teamMemberRoleCode) &&
        Objects.equals(this.userAccount, teamMemberJsonldGet.userAccount);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atContext, atId, atType, createdAt, dataSegmentCode, id, partition, resourceOwner, teamMemberRoleCode, userAccount);
  }
  ...
  public String toString() {
    ...
    sb.append("class TeamMemberJsonldGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamMemberJsonldGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamMemberJsonldGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamMemberJsonldGet is not found in the empty JSON string", TeamMemberJsonldGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamMemberJsonldGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamMemberJsonldGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TeamMemberJsonldGet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamMemberJsonldGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamMemberJsonldGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamMemberJsonldGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamMemberJsonldGet.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamMemberJsonldGet>() {
           @Override
           public void write(JsonWriter out, TeamMemberJsonldGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TeamMemberJsonldGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TeamMemberJsonldGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TeamMemberJsonldGet
   * @throws IOException if the JSON string is invalid with respect to TeamMemberJsonldGet
   */
  public static TeamMemberJsonldGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamMemberJsonldGet.class);
  }

  /**
   * Convert an instance of TeamMemberJsonldGet to an JSON string
   *
   * @return JSON string
   */
