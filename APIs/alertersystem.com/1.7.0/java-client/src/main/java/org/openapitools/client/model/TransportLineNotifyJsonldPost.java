...
public class TransportLineNotifyJsonldPost {
  ...
  public TransportLineNotifyJsonldPost() {
  }

  public TransportLineNotifyJsonldPost dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportLineNotifyJsonldPost lineNotifyAccessToken(String lineNotifyAccessToken) {
  ...
  public TransportLineNotifyJsonldPost lineNotifyStickerId(String lineNotifyStickerId) {
  ...
  public TransportLineNotifyJsonldPost lineNotifyStickerPackageId(String lineNotifyStickerPackageId) {
  ...
  public TransportLineNotifyJsonldPost partition(String partition) {
  ...
  public TransportLineNotifyJsonldPost transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportLineNotifyJsonldPost transportLineNotifyJsonldPost = (TransportLineNotifyJsonldPost) o;
    return Objects.equals(this.dataSegmentCode, transportLineNotifyJsonldPost.dataSegmentCode) &&
        Objects.equals(this.lineNotifyAccessToken, transportLineNotifyJsonldPost.lineNotifyAccessToken) &&
        Objects.equals(this.lineNotifyStickerId, transportLineNotifyJsonldPost.lineNotifyStickerId) &&
        Objects.equals(this.lineNotifyStickerPackageId, transportLineNotifyJsonldPost.lineNotifyStickerPackageId) &&
        Objects.equals(this.partition, transportLineNotifyJsonldPost.partition) &&
        Objects.equals(this.transportName, transportLineNotifyJsonldPost.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportLineNotifyJsonldPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportLineNotifyJsonldPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportLineNotifyJsonldPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportLineNotifyJsonldPost is not found in the empty JSON string", TransportLineNotifyJsonldPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportLineNotifyJsonldPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportLineNotifyJsonldPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportLineNotifyJsonldPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportLineNotifyJsonldPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportLineNotifyJsonldPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportLineNotifyJsonldPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportLineNotifyJsonldPost.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportLineNotifyJsonldPost>() {
           @Override
           public void write(JsonWriter out, TransportLineNotifyJsonldPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportLineNotifyJsonldPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportLineNotifyJsonldPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportLineNotifyJsonldPost
   * @throws IOException if the JSON string is invalid with respect to TransportLineNotifyJsonldPost
   */
  public static TransportLineNotifyJsonldPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportLineNotifyJsonldPost.class);
  }

  /**
   * Convert an instance of TransportLineNotifyJsonldPost to an JSON string
   *
   * @return JSON string
   */
