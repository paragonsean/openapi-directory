...
public class TransportSlackGet {
  ...
  public TransportSlackGet createdAt(OffsetDateTime createdAt) {
  ...
  public TransportSlackGet dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportSlackGet partition(String partition) {
  ...
  public TransportSlackGet resourceOwner(String resourceOwner) {
  ...
  public TransportSlackGet slackChannel(String slackChannel) {
  ...
  public TransportSlackGet slackToken(String slackToken) {
  ...
  public TransportSlackGet transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportSlackGet transportSlackGet = (TransportSlackGet) o;
    return Objects.equals(this.createdAt, transportSlackGet.createdAt) &&
        Objects.equals(this.dataSegmentCode, transportSlackGet.dataSegmentCode) &&
        Objects.equals(this.id, transportSlackGet.id) &&
        Objects.equals(this.partition, transportSlackGet.partition) &&
        Objects.equals(this.resourceOwner, transportSlackGet.resourceOwner) &&
        Objects.equals(this.slackChannel, transportSlackGet.slackChannel) &&
        Objects.equals(this.slackToken, transportSlackGet.slackToken) &&
        Objects.equals(this.transportName, transportSlackGet.transportName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, dataSegmentCode, id, partition, resourceOwner, slackChannel, slackToken, transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportSlackGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportSlackGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportSlackGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportSlackGet is not found in the empty JSON string", TransportSlackGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportSlackGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportSlackGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportSlackGet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportSlackGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportSlackGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportSlackGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportSlackGet.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportSlackGet>() {
           @Override
           public void write(JsonWriter out, TransportSlackGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportSlackGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportSlackGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportSlackGet
   * @throws IOException if the JSON string is invalid with respect to TransportSlackGet
   */
  public static TransportSlackGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportSlackGet.class);
  }

  /**
   * Convert an instance of TransportSlackGet to an JSON string
   *
   * @return JSON string
   */
