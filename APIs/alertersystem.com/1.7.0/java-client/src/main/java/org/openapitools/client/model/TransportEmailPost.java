...
public class TransportEmailPost {
  ...
  public TransportEmailPost() {
  }

  public TransportEmailPost dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportEmailPost emailFromAddress(String emailFromAddress) {
  ...
  public TransportEmailPost emailFromName(String emailFromName) {
  ...
  public TransportEmailPost emailPassword(String emailPassword) {
  ...
  public TransportEmailPost emailPort(Integer emailPort) {
  ...
  public TransportEmailPost emailServer(String emailServer) {
  ...
  public TransportEmailPost emailUsername(String emailUsername) {
  ...
  public TransportEmailPost partition(String partition) {
  ...
  public TransportEmailPost transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportEmailPost transportEmailPost = (TransportEmailPost) o;
    return Objects.equals(this.dataSegmentCode, transportEmailPost.dataSegmentCode) &&
        Objects.equals(this.emailFromAddress, transportEmailPost.emailFromAddress) &&
        Objects.equals(this.emailFromName, transportEmailPost.emailFromName) &&
        Objects.equals(this.emailPassword, transportEmailPost.emailPassword) &&
        Objects.equals(this.emailPort, transportEmailPost.emailPort) &&
        Objects.equals(this.emailServer, transportEmailPost.emailServer) &&
        Objects.equals(this.emailUsername, transportEmailPost.emailUsername) &&
        Objects.equals(this.partition, transportEmailPost.partition) &&
        Objects.equals(this.transportName, transportEmailPost.transportName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dataSegmentCode, emailFromAddress, emailFromName, emailPassword, emailPort, emailServer, emailUsername, partition, transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportEmailPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportEmailPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportEmailPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportEmailPost is not found in the empty JSON string", TransportEmailPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportEmailPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportEmailPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportEmailPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportEmailPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportEmailPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportEmailPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportEmailPost.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportEmailPost>() {
           @Override
           public void write(JsonWriter out, TransportEmailPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportEmailPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportEmailPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportEmailPost
   * @throws IOException if the JSON string is invalid with respect to TransportEmailPost
   */
  public static TransportEmailPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportEmailPost.class);
  }

  /**
   * Convert an instance of TransportEmailPost to an JSON string
   *
   * @return JSON string
   */
