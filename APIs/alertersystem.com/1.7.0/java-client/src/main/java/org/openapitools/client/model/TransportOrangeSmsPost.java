...
public class TransportOrangeSmsPost {
  ...
  public TransportOrangeSmsPost() {
  }

  public TransportOrangeSmsPost dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportOrangeSmsPost orangeSmsClientId(String orangeSmsClientId) {
  ...
  public TransportOrangeSmsPost orangeSmsClientSecret(String orangeSmsClientSecret) {
  ...
  public TransportOrangeSmsPost orangeSmsFrom(String orangeSmsFrom) {
  ...
  public TransportOrangeSmsPost orangeSmsSenderName(String orangeSmsSenderName) {
  ...
  public TransportOrangeSmsPost partition(String partition) {
  ...
  public TransportOrangeSmsPost transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportOrangeSmsPost transportOrangeSmsPost = (TransportOrangeSmsPost) o;
    return Objects.equals(this.dataSegmentCode, transportOrangeSmsPost.dataSegmentCode) &&
        Objects.equals(this.orangeSmsClientId, transportOrangeSmsPost.orangeSmsClientId) &&
        Objects.equals(this.orangeSmsClientSecret, transportOrangeSmsPost.orangeSmsClientSecret) &&
        Objects.equals(this.orangeSmsFrom, transportOrangeSmsPost.orangeSmsFrom) &&
        Objects.equals(this.orangeSmsSenderName, transportOrangeSmsPost.orangeSmsSenderName) &&
        Objects.equals(this.partition, transportOrangeSmsPost.partition) &&
        Objects.equals(this.transportName, transportOrangeSmsPost.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportOrangeSmsPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportOrangeSmsPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportOrangeSmsPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportOrangeSmsPost is not found in the empty JSON string", TransportOrangeSmsPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportOrangeSmsPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportOrangeSmsPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportOrangeSmsPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportOrangeSmsPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportOrangeSmsPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportOrangeSmsPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportOrangeSmsPost.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportOrangeSmsPost>() {
           @Override
           public void write(JsonWriter out, TransportOrangeSmsPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportOrangeSmsPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportOrangeSmsPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportOrangeSmsPost
   * @throws IOException if the JSON string is invalid with respect to TransportOrangeSmsPost
   */
  public static TransportOrangeSmsPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportOrangeSmsPost.class);
  }

  /**
   * Convert an instance of TransportOrangeSmsPost to an JSON string
   *
   * @return JSON string
   */
