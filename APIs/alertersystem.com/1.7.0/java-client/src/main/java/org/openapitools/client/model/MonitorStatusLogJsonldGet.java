...
public class MonitorStatusLogJsonldGet {
  ...
  public MonitorStatusLogJsonldGet() {
  }
  ...
  public MonitorStatusLogJsonldGet atContext(AlertLogJsonldGetContext atContext) {
  ...
  public MonitorStatusLogJsonldGet dataSegmentCode(String dataSegmentCode) {
  ...
  public MonitorStatusLogJsonldGet monitor(String monitor) {
  ...
  public MonitorStatusLogJsonldGet monitorStatusCode(String monitorStatusCode) {
  ...
  public MonitorStatusLogJsonldGet partition(String partition) {
  ...
  public MonitorStatusLogJsonldGet ping(String ping) {
    this.ping = ping;
    return this;
  }
  ...
  public MonitorStatusLogJsonldGet resourceOwner(String resourceOwner) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorStatusLogJsonldGet monitorStatusLogJsonldGet = (MonitorStatusLogJsonldGet) o;
    return Objects.equals(this.atContext, monitorStatusLogJsonldGet.atContext) &&
        Objects.equals(this.atId, monitorStatusLogJsonldGet.atId) &&
        Objects.equals(this.atType, monitorStatusLogJsonldGet.atType) &&
        Objects.equals(this.createdAt, monitorStatusLogJsonldGet.createdAt) &&
        Objects.equals(this.dataSegmentCode, monitorStatusLogJsonldGet.dataSegmentCode) &&
        Objects.equals(this.id, monitorStatusLogJsonldGet.id) &&
        Objects.equals(this.monitor, monitorStatusLogJsonldGet.monitor) &&
        Objects.equals(this.monitorStatusCode, monitorStatusLogJsonldGet.monitorStatusCode) &&
        Objects.equals(this.partition, monitorStatusLogJsonldGet.partition) &&
        Objects.equals(this.ping, monitorStatusLogJsonldGet.ping) &&
        Objects.equals(this.resourceOwner, monitorStatusLogJsonldGet.resourceOwner);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atContext, atId, atType, createdAt, dataSegmentCode, id, monitor, monitorStatusCode, partition, ping, resourceOwner);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorStatusLogJsonldGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorStatusLogJsonldGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorStatusLogJsonldGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorStatusLogJsonldGet is not found in the empty JSON string", MonitorStatusLogJsonldGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorStatusLogJsonldGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorStatusLogJsonldGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorStatusLogJsonldGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorStatusLogJsonldGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorStatusLogJsonldGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorStatusLogJsonldGet.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorStatusLogJsonldGet>() {
           @Override
           public void write(JsonWriter out, MonitorStatusLogJsonldGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorStatusLogJsonldGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorStatusLogJsonldGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorStatusLogJsonldGet
   * @throws IOException if the JSON string is invalid with respect to MonitorStatusLogJsonldGet
   */
  public static MonitorStatusLogJsonldGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorStatusLogJsonldGet.class);
  }

  /**
   * Convert an instance of MonitorStatusLogJsonldGet to an JSON string
   *
   * @return JSON string
   */
