...
public class TransportOrangeSmsPatch {
  ...
  public TransportOrangeSmsPatch() {
  }

  public TransportOrangeSmsPatch dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportOrangeSmsPatch orangeSmsClientId(String orangeSmsClientId) {
  ...
  public TransportOrangeSmsPatch orangeSmsClientSecret(String orangeSmsClientSecret) {
  ...
  public TransportOrangeSmsPatch orangeSmsFrom(String orangeSmsFrom) {
  ...
  public TransportOrangeSmsPatch orangeSmsSenderName(String orangeSmsSenderName) {
  ...
  public TransportOrangeSmsPatch transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportOrangeSmsPatch transportOrangeSmsPatch = (TransportOrangeSmsPatch) o;
    return Objects.equals(this.dataSegmentCode, transportOrangeSmsPatch.dataSegmentCode) &&
        Objects.equals(this.orangeSmsClientId, transportOrangeSmsPatch.orangeSmsClientId) &&
        Objects.equals(this.orangeSmsClientSecret, transportOrangeSmsPatch.orangeSmsClientSecret) &&
        Objects.equals(this.orangeSmsFrom, transportOrangeSmsPatch.orangeSmsFrom) &&
        Objects.equals(this.orangeSmsSenderName, transportOrangeSmsPatch.orangeSmsSenderName) &&
        Objects.equals(this.transportName, transportOrangeSmsPatch.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportOrangeSmsPatch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportOrangeSmsPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportOrangeSmsPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportOrangeSmsPatch is not found in the empty JSON string", TransportOrangeSmsPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportOrangeSmsPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportOrangeSmsPatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportOrangeSmsPatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportOrangeSmsPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportOrangeSmsPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportOrangeSmsPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportOrangeSmsPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportOrangeSmsPatch>() {
           @Override
           public void write(JsonWriter out, TransportOrangeSmsPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportOrangeSmsPatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportOrangeSmsPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportOrangeSmsPatch
   * @throws IOException if the JSON string is invalid with respect to TransportOrangeSmsPatch
   */
  public static TransportOrangeSmsPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportOrangeSmsPatch.class);
  }

  /**
   * Convert an instance of TransportOrangeSmsPatch to an JSON string
   *
   * @return JSON string
   */
