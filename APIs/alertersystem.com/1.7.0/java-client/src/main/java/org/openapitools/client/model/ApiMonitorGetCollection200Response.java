...
public class ApiMonitorGetCollection200Response {
  ...
  private List<MonitorJsonldGet> hydraColonMember = new ArrayList<>();
  ...
  public ApiMonitorGetCollection200Response() {
  }

  public ApiMonitorGetCollection200Response hydraColonMember(List<MonitorJsonldGet> hydraColonMember) {
    this.hydraColonMember = hydraColonMember;
    return this;
  }

  public ApiMonitorGetCollection200Response addHydraColonMemberItem(MonitorJsonldGet hydraColonMemberItem) {
  ...
  public List<MonitorJsonldGet> getHydraColonMember() {
    return hydraColonMember;
  }

  public void setHydraColonMember(List<MonitorJsonldGet> hydraColonMember) {
    this.hydraColonMember = hydraColonMember;
  }


  public ApiMonitorGetCollection200Response hydraColonSearch(ApiAlertLogGetCollection200ResponseHydraSearch hydraColonSearch) {
  ...
  public ApiMonitorGetCollection200Response hydraColonTotalItems(Integer hydraColonTotalItems) {
  ...
  public ApiMonitorGetCollection200Response hydraColonView(ApiAlertLogGetCollection200ResponseHydraView hydraColonView) {
  ...
  public boolean equals(Object o) {
    ...
    ApiMonitorGetCollection200Response apiMonitorGetCollection200Response = (ApiMonitorGetCollection200Response) o;
    return Objects.equals(this.hydraColonMember, apiMonitorGetCollection200Response.hydraColonMember) &&
        Objects.equals(this.hydraColonSearch, apiMonitorGetCollection200Response.hydraColonSearch) &&
        Objects.equals(this.hydraColonTotalItems, apiMonitorGetCollection200Response.hydraColonTotalItems) &&
        Objects.equals(this.hydraColonView, apiMonitorGetCollection200Response.hydraColonView);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiMonitorGetCollection200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiMonitorGetCollection200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiMonitorGetCollection200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiMonitorGetCollection200Response is not found in the empty JSON string", ApiMonitorGetCollection200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiMonitorGetCollection200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiMonitorGetCollection200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiMonitorGetCollection200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayhydraColonMember.size(); i++) {
        MonitorJsonldGet.validateJsonElement(jsonArrayhydraColonMember.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiMonitorGetCollection200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiMonitorGetCollection200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiMonitorGetCollection200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiMonitorGetCollection200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiMonitorGetCollection200Response>() {
           @Override
           public void write(JsonWriter out, ApiMonitorGetCollection200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiMonitorGetCollection200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiMonitorGetCollection200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiMonitorGetCollection200Response
   * @throws IOException if the JSON string is invalid with respect to ApiMonitorGetCollection200Response
   */
  public static ApiMonitorGetCollection200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiMonitorGetCollection200Response.class);
  }

  /**
   * Convert an instance of ApiMonitorGetCollection200Response to an JSON string
   *
   * @return JSON string
   */
