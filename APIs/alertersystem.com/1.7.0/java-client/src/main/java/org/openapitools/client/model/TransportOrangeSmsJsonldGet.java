...
public class TransportOrangeSmsJsonldGet {
  ...
  public TransportOrangeSmsJsonldGet() {
  }
  ...
  public TransportOrangeSmsJsonldGet atContext(AlertLogJsonldGetContext atContext) {
  ...
  public TransportOrangeSmsJsonldGet createdAt(OffsetDateTime createdAt) {
  ...
  public TransportOrangeSmsJsonldGet dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportOrangeSmsJsonldGet orangeSmsClientId(String orangeSmsClientId) {
  ...
  public TransportOrangeSmsJsonldGet orangeSmsClientSecret(String orangeSmsClientSecret) {
  ...
  public TransportOrangeSmsJsonldGet orangeSmsFrom(String orangeSmsFrom) {
  ...
  public TransportOrangeSmsJsonldGet orangeSmsSenderName(String orangeSmsSenderName) {
  ...
  public TransportOrangeSmsJsonldGet partition(String partition) {
  ...
  public TransportOrangeSmsJsonldGet resourceOwner(String resourceOwner) {
  ...
  public TransportOrangeSmsJsonldGet transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportOrangeSmsJsonldGet transportOrangeSmsJsonldGet = (TransportOrangeSmsJsonldGet) o;
    return Objects.equals(this.atContext, transportOrangeSmsJsonldGet.atContext) &&
        Objects.equals(this.atId, transportOrangeSmsJsonldGet.atId) &&
        Objects.equals(this.atType, transportOrangeSmsJsonldGet.atType) &&
        Objects.equals(this.createdAt, transportOrangeSmsJsonldGet.createdAt) &&
        Objects.equals(this.dataSegmentCode, transportOrangeSmsJsonldGet.dataSegmentCode) &&
        Objects.equals(this.id, transportOrangeSmsJsonldGet.id) &&
        Objects.equals(this.orangeSmsClientId, transportOrangeSmsJsonldGet.orangeSmsClientId) &&
        Objects.equals(this.orangeSmsClientSecret, transportOrangeSmsJsonldGet.orangeSmsClientSecret) &&
        Objects.equals(this.orangeSmsFrom, transportOrangeSmsJsonldGet.orangeSmsFrom) &&
        Objects.equals(this.orangeSmsSenderName, transportOrangeSmsJsonldGet.orangeSmsSenderName) &&
        Objects.equals(this.partition, transportOrangeSmsJsonldGet.partition) &&
        Objects.equals(this.resourceOwner, transportOrangeSmsJsonldGet.resourceOwner) &&
        Objects.equals(this.transportName, transportOrangeSmsJsonldGet.transportName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atContext, atId, atType, createdAt, dataSegmentCode, id, orangeSmsClientId, orangeSmsClientSecret, orangeSmsFrom, orangeSmsSenderName, partition, resourceOwner, transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportOrangeSmsJsonldGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportOrangeSmsJsonldGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportOrangeSmsJsonldGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportOrangeSmsJsonldGet is not found in the empty JSON string", TransportOrangeSmsJsonldGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportOrangeSmsJsonldGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportOrangeSmsJsonldGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportOrangeSmsJsonldGet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportOrangeSmsJsonldGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportOrangeSmsJsonldGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportOrangeSmsJsonldGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportOrangeSmsJsonldGet.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportOrangeSmsJsonldGet>() {
           @Override
           public void write(JsonWriter out, TransportOrangeSmsJsonldGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportOrangeSmsJsonldGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportOrangeSmsJsonldGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportOrangeSmsJsonldGet
   * @throws IOException if the JSON string is invalid with respect to TransportOrangeSmsJsonldGet
   */
  public static TransportOrangeSmsJsonldGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportOrangeSmsJsonldGet.class);
  }

  /**
   * Convert an instance of TransportOrangeSmsJsonldGet to an JSON string
   *
   * @return JSON string
   */
