...
public class TransportEmailJsonldPost {
  ...
  public TransportEmailJsonldPost() {
  }

  public TransportEmailJsonldPost dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportEmailJsonldPost emailFromAddress(String emailFromAddress) {
  ...
  public TransportEmailJsonldPost emailFromName(String emailFromName) {
  ...
  public TransportEmailJsonldPost emailPassword(String emailPassword) {
  ...
  public TransportEmailJsonldPost emailPort(Integer emailPort) {
  ...
  public TransportEmailJsonldPost emailServer(String emailServer) {
  ...
  public TransportEmailJsonldPost emailUsername(String emailUsername) {
  ...
  public TransportEmailJsonldPost partition(String partition) {
  ...
  public TransportEmailJsonldPost transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportEmailJsonldPost transportEmailJsonldPost = (TransportEmailJsonldPost) o;
    return Objects.equals(this.dataSegmentCode, transportEmailJsonldPost.dataSegmentCode) &&
        Objects.equals(this.emailFromAddress, transportEmailJsonldPost.emailFromAddress) &&
        Objects.equals(this.emailFromName, transportEmailJsonldPost.emailFromName) &&
        Objects.equals(this.emailPassword, transportEmailJsonldPost.emailPassword) &&
        Objects.equals(this.emailPort, transportEmailJsonldPost.emailPort) &&
        Objects.equals(this.emailServer, transportEmailJsonldPost.emailServer) &&
        Objects.equals(this.emailUsername, transportEmailJsonldPost.emailUsername) &&
        Objects.equals(this.partition, transportEmailJsonldPost.partition) &&
        Objects.equals(this.transportName, transportEmailJsonldPost.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportEmailJsonldPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportEmailJsonldPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportEmailJsonldPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportEmailJsonldPost is not found in the empty JSON string", TransportEmailJsonldPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportEmailJsonldPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportEmailJsonldPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportEmailJsonldPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportEmailJsonldPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportEmailJsonldPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportEmailJsonldPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportEmailJsonldPost.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportEmailJsonldPost>() {
           @Override
           public void write(JsonWriter out, TransportEmailJsonldPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportEmailJsonldPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportEmailJsonldPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportEmailJsonldPost
   * @throws IOException if the JSON string is invalid with respect to TransportEmailJsonldPost
   */
  public static TransportEmailJsonldPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportEmailJsonldPost.class);
  }

  /**
   * Convert an instance of TransportEmailJsonldPost to an JSON string
   *
   * @return JSON string
   */
