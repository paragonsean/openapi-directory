...
public class TransportLineNotifyPut {
  ...
  public TransportLineNotifyPut() {
  }

  public TransportLineNotifyPut dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportLineNotifyPut lineNotifyAccessToken(String lineNotifyAccessToken) {
  ...
  public TransportLineNotifyPut lineNotifyStickerId(String lineNotifyStickerId) {
  ...
  public TransportLineNotifyPut lineNotifyStickerPackageId(String lineNotifyStickerPackageId) {
  ...
  public TransportLineNotifyPut transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportLineNotifyPut transportLineNotifyPut = (TransportLineNotifyPut) o;
    return Objects.equals(this.dataSegmentCode, transportLineNotifyPut.dataSegmentCode) &&
        Objects.equals(this.lineNotifyAccessToken, transportLineNotifyPut.lineNotifyAccessToken) &&
        Objects.equals(this.lineNotifyStickerId, transportLineNotifyPut.lineNotifyStickerId) &&
        Objects.equals(this.lineNotifyStickerPackageId, transportLineNotifyPut.lineNotifyStickerPackageId) &&
        Objects.equals(this.transportName, transportLineNotifyPut.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportLineNotifyPut {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportLineNotifyPut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportLineNotifyPut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportLineNotifyPut is not found in the empty JSON string", TransportLineNotifyPut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportLineNotifyPut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportLineNotifyPut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportLineNotifyPut.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportLineNotifyPut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportLineNotifyPut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportLineNotifyPut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportLineNotifyPut.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportLineNotifyPut>() {
           @Override
           public void write(JsonWriter out, TransportLineNotifyPut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportLineNotifyPut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportLineNotifyPut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportLineNotifyPut
   * @throws IOException if the JSON string is invalid with respect to TransportLineNotifyPut
   */
  public static TransportLineNotifyPut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportLineNotifyPut.class);
  }

  /**
   * Convert an instance of TransportLineNotifyPut to an JSON string
   *
   * @return JSON string
   */
