...
public class TransportBandwidthJsonldGet {
  ...
  public TransportBandwidthJsonldGet() {
  }
  ...
  public TransportBandwidthJsonldGet atContext(AlertLogJsonldGetContext atContext) {
  ...
  public TransportBandwidthJsonldGet bandwidthAccountId(String bandwidthAccountId) {
  ...
  public TransportBandwidthJsonldGet bandwidthApplicationId(String bandwidthApplicationId) {
  ...
  public TransportBandwidthJsonldGet bandwidthFrom(String bandwidthFrom) {
  ...
  public TransportBandwidthJsonldGet bandwidthPassword(String bandwidthPassword) {
  ...
  public TransportBandwidthJsonldGet bandwidthUsername(String bandwidthUsername) {
  ...
  public TransportBandwidthJsonldGet createdAt(OffsetDateTime createdAt) {
  ...
  public TransportBandwidthJsonldGet dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportBandwidthJsonldGet partition(String partition) {
  ...
  public TransportBandwidthJsonldGet resourceOwner(String resourceOwner) {
  ...
  public TransportBandwidthJsonldGet transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportBandwidthJsonldGet transportBandwidthJsonldGet = (TransportBandwidthJsonldGet) o;
    return Objects.equals(this.atContext, transportBandwidthJsonldGet.atContext) &&
        Objects.equals(this.atId, transportBandwidthJsonldGet.atId) &&
        Objects.equals(this.atType, transportBandwidthJsonldGet.atType) &&
        Objects.equals(this.bandwidthAccountId, transportBandwidthJsonldGet.bandwidthAccountId) &&
        Objects.equals(this.bandwidthApplicationId, transportBandwidthJsonldGet.bandwidthApplicationId) &&
        Objects.equals(this.bandwidthFrom, transportBandwidthJsonldGet.bandwidthFrom) &&
        Objects.equals(this.bandwidthPassword, transportBandwidthJsonldGet.bandwidthPassword) &&
        Objects.equals(this.bandwidthUsername, transportBandwidthJsonldGet.bandwidthUsername) &&
        Objects.equals(this.createdAt, transportBandwidthJsonldGet.createdAt) &&
        Objects.equals(this.dataSegmentCode, transportBandwidthJsonldGet.dataSegmentCode) &&
        Objects.equals(this.id, transportBandwidthJsonldGet.id) &&
        Objects.equals(this.partition, transportBandwidthJsonldGet.partition) &&
        Objects.equals(this.resourceOwner, transportBandwidthJsonldGet.resourceOwner) &&
        Objects.equals(this.transportName, transportBandwidthJsonldGet.transportName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atContext, atId, atType, bandwidthAccountId, bandwidthApplicationId, bandwidthFrom, bandwidthPassword, bandwidthUsername, createdAt, dataSegmentCode, id, partition, resourceOwner, transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportBandwidthJsonldGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportBandwidthJsonldGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportBandwidthJsonldGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportBandwidthJsonldGet is not found in the empty JSON string", TransportBandwidthJsonldGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportBandwidthJsonldGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportBandwidthJsonldGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportBandwidthJsonldGet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportBandwidthJsonldGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportBandwidthJsonldGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportBandwidthJsonldGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportBandwidthJsonldGet.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportBandwidthJsonldGet>() {
           @Override
           public void write(JsonWriter out, TransportBandwidthJsonldGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportBandwidthJsonldGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportBandwidthJsonldGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportBandwidthJsonldGet
   * @throws IOException if the JSON string is invalid with respect to TransportBandwidthJsonldGet
   */
  public static TransportBandwidthJsonldGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportBandwidthJsonldGet.class);
  }

  /**
   * Convert an instance of TransportBandwidthJsonldGet to an JSON string
   *
   * @return JSON string
   */
