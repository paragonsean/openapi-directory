...
public class MonitorGet {
  ...
  public MonitorGet alertPayloadExtended(String alertPayloadExtended) {
  ...
  public MonitorGet alertPayloadShort(String alertPayloadShort) {
  ...
  public MonitorGet alertServices(List<String> alertServices) {
    this.alertServices = alertServices;
    return this;
  }

  public MonitorGet addAlertServicesItem(String alertServicesItem) {
  ...
  public MonitorGet allowUnauthenticatedPings(Boolean allowUnauthenticatedPings) {
  ...
  public MonitorGet contentCheckMustNotExist(Boolean contentCheckMustNotExist) {
  ...
  public MonitorGet contentCheckText(String contentCheckText) {
  ...
  public MonitorGet contentCheckUrl(URI contentCheckUrl) {
  ...
  public MonitorGet contentCheckXpathFilter(String contentCheckXpathFilter) {
  ...
  public MonitorGet dataSegmentCode(String dataSegmentCode) {
  ...
  public MonitorGet graceSeconds(Integer graceSeconds) {
  ...
  public MonitorGet internalMonitorName(String internalMonitorName) {
  ...
  public MonitorGet intervalDays(Integer intervalDays) {
  ...
  public MonitorGet intervalHours(Integer intervalHours) {
  ...
  public MonitorGet intervalMinutes(Integer intervalMinutes) {
  ...
  public MonitorGet intervalMonths(Integer intervalMonths) {
  ...
  public MonitorGet intervalSeconds(Integer intervalSeconds) {
  ...
  public MonitorGet intervalYears(Integer intervalYears) {
  ...
  public MonitorGet isMonitorPaused(Boolean isMonitorPaused) {
  ...
  public MonitorGet lastPingAt(OffsetDateTime lastPingAt) {
  ...
  public MonitorGet monitorName(String monitorName) {
  ...
  public MonitorGet monitorNotes(String monitorNotes) {
  ...
  public MonitorGet monitorStatusCode(String monitorStatusCode) {
  ...
  public MonitorGet monitorTypeCode(String monitorTypeCode) {
  ...
  public MonitorGet nextPingAt(OffsetDateTime nextPingAt) {
  ...
  public MonitorGet partition(String partition) {
  ...
  public MonitorGet pingSecret(String pingSecret) {
  ...
  public MonitorGet publicDescription(String publicDescription) {
  ...
  public MonitorGet resourceOwner(String resourceOwner) {
  ...
  public MonitorGet startMonitorAt(OffsetDateTime startMonitorAt) {
  ...
  public MonitorGet startMonitorAtUtc(OffsetDateTime startMonitorAtUtc) {
  ...
  public MonitorGet systemMessages(List<String> systemMessages) {
    this.systemMessages = systemMessages;
    return this;
  }

  public MonitorGet addSystemMessagesItem(String systemMessagesItem) {
  ...
  public MonitorGet timezoneCode(String timezoneCode) {
  ...
  public MonitorGet webResponseSecondsLimit(Integer webResponseSecondsLimit) {
  ...
  public MonitorGet webResponseUrl(URI webResponseUrl) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorGet monitorGet = (MonitorGet) o;
    return Objects.equals(this.alertPayloadExtended, monitorGet.alertPayloadExtended) &&
        Objects.equals(this.alertPayloadShort, monitorGet.alertPayloadShort) &&
        Objects.equals(this.alertServices, monitorGet.alertServices) &&
        Objects.equals(this.allowUnauthenticatedPings, monitorGet.allowUnauthenticatedPings) &&
        Objects.equals(this.contentCheckMustNotExist, monitorGet.contentCheckMustNotExist) &&
        Objects.equals(this.contentCheckText, monitorGet.contentCheckText) &&
        Objects.equals(this.contentCheckUrl, monitorGet.contentCheckUrl) &&
        Objects.equals(this.contentCheckXpathFilter, monitorGet.contentCheckXpathFilter) &&
        Objects.equals(this.createdAt, monitorGet.createdAt) &&
        Objects.equals(this.dataSegmentCode, monitorGet.dataSegmentCode) &&
        Objects.equals(this.graceSeconds, monitorGet.graceSeconds) &&
        Objects.equals(this.humanizedInterval, monitorGet.humanizedInterval) &&
        Objects.equals(this.id, monitorGet.id) &&
        Objects.equals(this.internalMonitorName, monitorGet.internalMonitorName) &&
        Objects.equals(this.intervalDays, monitorGet.intervalDays) &&
        Objects.equals(this.intervalHours, monitorGet.intervalHours) &&
        Objects.equals(this.intervalMinutes, monitorGet.intervalMinutes) &&
        Objects.equals(this.intervalMonths, monitorGet.intervalMonths) &&
        Objects.equals(this.intervalSeconds, monitorGet.intervalSeconds) &&
        Objects.equals(this.intervalYears, monitorGet.intervalYears) &&
        Objects.equals(this.isMonitorPaused, monitorGet.isMonitorPaused) &&
        Objects.equals(this.lastPingAt, monitorGet.lastPingAt) &&
        Objects.equals(this.monitorName, monitorGet.monitorName) &&
        Objects.equals(this.monitorNotes, monitorGet.monitorNotes) &&
        Objects.equals(this.monitorStatusCode, monitorGet.monitorStatusCode) &&
        Objects.equals(this.monitorTypeCode, monitorGet.monitorTypeCode) &&
        Objects.equals(this.nextPingAt, monitorGet.nextPingAt) &&
        Objects.equals(this.partition, monitorGet.partition) &&
        Objects.equals(this.pingSecret, monitorGet.pingSecret) &&
        Objects.equals(this.publicDescription, monitorGet.publicDescription) &&
        Objects.equals(this.resourceOwner, monitorGet.resourceOwner) &&
        Objects.equals(this.startMonitorAt, monitorGet.startMonitorAt) &&
        Objects.equals(this.startMonitorAtUtc, monitorGet.startMonitorAtUtc) &&
        Objects.equals(this.systemMessages, monitorGet.systemMessages) &&
        Objects.equals(this.timezoneCode, monitorGet.timezoneCode) &&
        Objects.equals(this.webResponseSecondsLimit, monitorGet.webResponseSecondsLimit) &&
        Objects.equals(this.webResponseUrl, monitorGet.webResponseUrl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorGet is not found in the empty JSON string", MonitorGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorGet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorGet.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorGet>() {
           @Override
           public void write(JsonWriter out, MonitorGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorGet
   * @throws IOException if the JSON string is invalid with respect to MonitorGet
   */
  public static MonitorGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorGet.class);
  }

  /**
   * Convert an instance of MonitorGet to an JSON string
   *
   * @return JSON string
   */
