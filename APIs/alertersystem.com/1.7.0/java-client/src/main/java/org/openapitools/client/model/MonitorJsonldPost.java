...
public class MonitorJsonldPost {
  ...
  public MonitorJsonldPost() {
  }

  public MonitorJsonldPost alertPayloadExtended(String alertPayloadExtended) {
  ...
  public MonitorJsonldPost alertPayloadShort(String alertPayloadShort) {
  ...
  public MonitorJsonldPost alertServices(List<String> alertServices) {
    this.alertServices = alertServices;
    return this;
  }

  public MonitorJsonldPost addAlertServicesItem(String alertServicesItem) {
  ...
  public MonitorJsonldPost allowUnauthenticatedPings(Boolean allowUnauthenticatedPings) {
  ...
  public MonitorJsonldPost contentCheckMustNotExist(Boolean contentCheckMustNotExist) {
  ...
  public MonitorJsonldPost contentCheckText(String contentCheckText) {
  ...
  public MonitorJsonldPost contentCheckUrl(URI contentCheckUrl) {
  ...
  public MonitorJsonldPost contentCheckXpathFilter(String contentCheckXpathFilter) {
  ...
  public MonitorJsonldPost dataSegmentCode(String dataSegmentCode) {
  ...
  public MonitorJsonldPost graceSeconds(Integer graceSeconds) {
  ...
  public MonitorJsonldPost intervalDays(Integer intervalDays) {
  ...
  public MonitorJsonldPost intervalHours(Integer intervalHours) {
  ...
  public MonitorJsonldPost intervalMinutes(Integer intervalMinutes) {
  ...
  public MonitorJsonldPost intervalMonths(Integer intervalMonths) {
  ...
  public MonitorJsonldPost intervalSeconds(Integer intervalSeconds) {
  ...
  public MonitorJsonldPost intervalYears(Integer intervalYears) {
  ...
  public MonitorJsonldPost isMonitorPaused(Boolean isMonitorPaused) {
  ...
  public MonitorJsonldPost monitorName(String monitorName) {
  ...
  public MonitorJsonldPost monitorNotes(String monitorNotes) {
  ...
  public MonitorJsonldPost monitorTypeCode(String monitorTypeCode) {
  ...
  public MonitorJsonldPost partition(String partition) {
  ...
  public MonitorJsonldPost publicDescription(String publicDescription) {
  ...
  public MonitorJsonldPost startMonitorAt(OffsetDateTime startMonitorAt) {
  ...
  public MonitorJsonldPost timezoneCode(String timezoneCode) {
  ...
  public MonitorJsonldPost webResponseSecondsLimit(Integer webResponseSecondsLimit) {
  ...
  public MonitorJsonldPost webResponseUrl(URI webResponseUrl) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorJsonldPost monitorJsonldPost = (MonitorJsonldPost) o;
    return Objects.equals(this.alertPayloadExtended, monitorJsonldPost.alertPayloadExtended) &&
        Objects.equals(this.alertPayloadShort, monitorJsonldPost.alertPayloadShort) &&
        Objects.equals(this.alertServices, monitorJsonldPost.alertServices) &&
        Objects.equals(this.allowUnauthenticatedPings, monitorJsonldPost.allowUnauthenticatedPings) &&
        Objects.equals(this.contentCheckMustNotExist, monitorJsonldPost.contentCheckMustNotExist) &&
        Objects.equals(this.contentCheckText, monitorJsonldPost.contentCheckText) &&
        Objects.equals(this.contentCheckUrl, monitorJsonldPost.contentCheckUrl) &&
        Objects.equals(this.contentCheckXpathFilter, monitorJsonldPost.contentCheckXpathFilter) &&
        Objects.equals(this.dataSegmentCode, monitorJsonldPost.dataSegmentCode) &&
        Objects.equals(this.graceSeconds, monitorJsonldPost.graceSeconds) &&
        Objects.equals(this.intervalDays, monitorJsonldPost.intervalDays) &&
        Objects.equals(this.intervalHours, monitorJsonldPost.intervalHours) &&
        Objects.equals(this.intervalMinutes, monitorJsonldPost.intervalMinutes) &&
        Objects.equals(this.intervalMonths, monitorJsonldPost.intervalMonths) &&
        Objects.equals(this.intervalSeconds, monitorJsonldPost.intervalSeconds) &&
        Objects.equals(this.intervalYears, monitorJsonldPost.intervalYears) &&
        Objects.equals(this.isMonitorPaused, monitorJsonldPost.isMonitorPaused) &&
        Objects.equals(this.monitorName, monitorJsonldPost.monitorName) &&
        Objects.equals(this.monitorNotes, monitorJsonldPost.monitorNotes) &&
        Objects.equals(this.monitorTypeCode, monitorJsonldPost.monitorTypeCode) &&
        Objects.equals(this.partition, monitorJsonldPost.partition) &&
        Objects.equals(this.publicDescription, monitorJsonldPost.publicDescription) &&
        Objects.equals(this.startMonitorAt, monitorJsonldPost.startMonitorAt) &&
        Objects.equals(this.timezoneCode, monitorJsonldPost.timezoneCode) &&
        Objects.equals(this.webResponseSecondsLimit, monitorJsonldPost.webResponseSecondsLimit) &&
        Objects.equals(this.webResponseUrl, monitorJsonldPost.webResponseUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorJsonldPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorJsonldPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorJsonldPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorJsonldPost is not found in the empty JSON string", MonitorJsonldPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorJsonldPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorJsonldPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorJsonldPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorJsonldPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorJsonldPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorJsonldPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorJsonldPost.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorJsonldPost>() {
           @Override
           public void write(JsonWriter out, MonitorJsonldPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorJsonldPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorJsonldPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorJsonldPost
   * @throws IOException if the JSON string is invalid with respect to MonitorJsonldPost
   */
  public static MonitorJsonldPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorJsonldPost.class);
  }

  /**
   * Convert an instance of MonitorJsonldPost to an JSON string
   *
   * @return JSON string
   */
