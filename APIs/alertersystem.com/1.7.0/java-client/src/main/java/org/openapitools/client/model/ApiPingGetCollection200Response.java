...
public class ApiPingGetCollection200Response {
  ...
  private List<PingJsonldGet> hydraColonMember = new ArrayList<>();
  ...
  public ApiPingGetCollection200Response() {
  }

  public ApiPingGetCollection200Response hydraColonMember(List<PingJsonldGet> hydraColonMember) {
    this.hydraColonMember = hydraColonMember;
    return this;
  }

  public ApiPingGetCollection200Response addHydraColonMemberItem(PingJsonldGet hydraColonMemberItem) {
  ...
  public List<PingJsonldGet> getHydraColonMember() {
    return hydraColonMember;
  }

  public void setHydraColonMember(List<PingJsonldGet> hydraColonMember) {
    this.hydraColonMember = hydraColonMember;
  }


  public ApiPingGetCollection200Response hydraColonSearch(ApiAlertLogGetCollection200ResponseHydraSearch hydraColonSearch) {
  ...
  public ApiPingGetCollection200Response hydraColonTotalItems(Integer hydraColonTotalItems) {
  ...
  public ApiPingGetCollection200Response hydraColonView(ApiAlertLogGetCollection200ResponseHydraView hydraColonView) {
  ...
  public boolean equals(Object o) {
    ...
    ApiPingGetCollection200Response apiPingGetCollection200Response = (ApiPingGetCollection200Response) o;
    return Objects.equals(this.hydraColonMember, apiPingGetCollection200Response.hydraColonMember) &&
        Objects.equals(this.hydraColonSearch, apiPingGetCollection200Response.hydraColonSearch) &&
        Objects.equals(this.hydraColonTotalItems, apiPingGetCollection200Response.hydraColonTotalItems) &&
        Objects.equals(this.hydraColonView, apiPingGetCollection200Response.hydraColonView);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiPingGetCollection200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiPingGetCollection200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiPingGetCollection200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApiPingGetCollection200Response is not found in the empty JSON string", ApiPingGetCollection200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiPingGetCollection200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApiPingGetCollection200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiPingGetCollection200Response.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayhydraColonMember.size(); i++) {
        PingJsonldGet.validateJsonElement(jsonArrayhydraColonMember.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiPingGetCollection200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiPingGetCollection200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiPingGetCollection200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiPingGetCollection200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiPingGetCollection200Response>() {
           @Override
           public void write(JsonWriter out, ApiPingGetCollection200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiPingGetCollection200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiPingGetCollection200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiPingGetCollection200Response
   * @throws IOException if the JSON string is invalid with respect to ApiPingGetCollection200Response
   */
  public static ApiPingGetCollection200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiPingGetCollection200Response.class);
  }

  /**
   * Convert an instance of ApiPingGetCollection200Response to an JSON string
   *
   * @return JSON string
   */
