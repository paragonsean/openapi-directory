...
public class TransportLineNotifyPost {
  ...
  public TransportLineNotifyPost() {
  }

  public TransportLineNotifyPost dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportLineNotifyPost lineNotifyAccessToken(String lineNotifyAccessToken) {
  ...
  public TransportLineNotifyPost lineNotifyStickerId(String lineNotifyStickerId) {
  ...
  public TransportLineNotifyPost lineNotifyStickerPackageId(String lineNotifyStickerPackageId) {
  ...
  public TransportLineNotifyPost partition(String partition) {
  ...
  public TransportLineNotifyPost transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportLineNotifyPost transportLineNotifyPost = (TransportLineNotifyPost) o;
    return Objects.equals(this.dataSegmentCode, transportLineNotifyPost.dataSegmentCode) &&
        Objects.equals(this.lineNotifyAccessToken, transportLineNotifyPost.lineNotifyAccessToken) &&
        Objects.equals(this.lineNotifyStickerId, transportLineNotifyPost.lineNotifyStickerId) &&
        Objects.equals(this.lineNotifyStickerPackageId, transportLineNotifyPost.lineNotifyStickerPackageId) &&
        Objects.equals(this.partition, transportLineNotifyPost.partition) &&
        Objects.equals(this.transportName, transportLineNotifyPost.transportName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dataSegmentCode, lineNotifyAccessToken, lineNotifyStickerId, lineNotifyStickerPackageId, partition, transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportLineNotifyPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportLineNotifyPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportLineNotifyPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportLineNotifyPost is not found in the empty JSON string", TransportLineNotifyPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportLineNotifyPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportLineNotifyPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportLineNotifyPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportLineNotifyPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportLineNotifyPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportLineNotifyPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportLineNotifyPost.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportLineNotifyPost>() {
           @Override
           public void write(JsonWriter out, TransportLineNotifyPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportLineNotifyPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportLineNotifyPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportLineNotifyPost
   * @throws IOException if the JSON string is invalid with respect to TransportLineNotifyPost
   */
  public static TransportLineNotifyPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportLineNotifyPost.class);
  }

  /**
   * Convert an instance of TransportLineNotifyPost to an JSON string
   *
   * @return JSON string
   */
