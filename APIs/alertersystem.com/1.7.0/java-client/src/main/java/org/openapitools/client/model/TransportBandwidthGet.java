...
public class TransportBandwidthGet {
  ...
  public TransportBandwidthGet bandwidthAccountId(String bandwidthAccountId) {
  ...
  public TransportBandwidthGet bandwidthApplicationId(String bandwidthApplicationId) {
  ...
  public TransportBandwidthGet bandwidthFrom(String bandwidthFrom) {
  ...
  public TransportBandwidthGet bandwidthPassword(String bandwidthPassword) {
  ...
  public TransportBandwidthGet bandwidthUsername(String bandwidthUsername) {
  ...
  public TransportBandwidthGet createdAt(OffsetDateTime createdAt) {
  ...
  public TransportBandwidthGet dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportBandwidthGet partition(String partition) {
  ...
  public TransportBandwidthGet resourceOwner(String resourceOwner) {
  ...
  public TransportBandwidthGet transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportBandwidthGet transportBandwidthGet = (TransportBandwidthGet) o;
    return Objects.equals(this.bandwidthAccountId, transportBandwidthGet.bandwidthAccountId) &&
        Objects.equals(this.bandwidthApplicationId, transportBandwidthGet.bandwidthApplicationId) &&
        Objects.equals(this.bandwidthFrom, transportBandwidthGet.bandwidthFrom) &&
        Objects.equals(this.bandwidthPassword, transportBandwidthGet.bandwidthPassword) &&
        Objects.equals(this.bandwidthUsername, transportBandwidthGet.bandwidthUsername) &&
        Objects.equals(this.createdAt, transportBandwidthGet.createdAt) &&
        Objects.equals(this.dataSegmentCode, transportBandwidthGet.dataSegmentCode) &&
        Objects.equals(this.id, transportBandwidthGet.id) &&
        Objects.equals(this.partition, transportBandwidthGet.partition) &&
        Objects.equals(this.resourceOwner, transportBandwidthGet.resourceOwner) &&
        Objects.equals(this.transportName, transportBandwidthGet.transportName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bandwidthAccountId, bandwidthApplicationId, bandwidthFrom, bandwidthPassword, bandwidthUsername, createdAt, dataSegmentCode, id, partition, resourceOwner, transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportBandwidthGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportBandwidthGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportBandwidthGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportBandwidthGet is not found in the empty JSON string", TransportBandwidthGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportBandwidthGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportBandwidthGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportBandwidthGet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportBandwidthGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportBandwidthGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportBandwidthGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportBandwidthGet.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportBandwidthGet>() {
           @Override
           public void write(JsonWriter out, TransportBandwidthGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportBandwidthGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportBandwidthGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportBandwidthGet
   * @throws IOException if the JSON string is invalid with respect to TransportBandwidthGet
   */
  public static TransportBandwidthGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportBandwidthGet.class);
  }

  /**
   * Convert an instance of TransportBandwidthGet to an JSON string
   *
   * @return JSON string
   */
