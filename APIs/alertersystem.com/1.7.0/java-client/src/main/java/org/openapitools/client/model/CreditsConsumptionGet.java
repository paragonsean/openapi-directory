...
public class CreditsConsumptionGet {
  ...
  public CreditsConsumptionGet creditsConsumptionNotes(String creditsConsumptionNotes) {
  ...
  public CreditsConsumptionGet creditsEventId(UUID creditsEventId) {
  ...
  public CreditsConsumptionGet creditsEventIri(String creditsEventIri) {
  ...
  public boolean equals(Object o) {
    ...
    CreditsConsumptionGet creditsConsumptionGet = (CreditsConsumptionGet) o;
    return Objects.equals(this.createdAt, creditsConsumptionGet.createdAt) &&
        Objects.equals(this.creditsConsumptionEventCode, creditsConsumptionGet.creditsConsumptionEventCode) &&
        Objects.equals(this.creditsConsumptionNotes, creditsConsumptionGet.creditsConsumptionNotes) &&
        Objects.equals(this.creditsEventId, creditsConsumptionGet.creditsEventId) &&
        Objects.equals(this.creditsEventIri, creditsConsumptionGet.creditsEventIri) &&
        Objects.equals(this.creditsUsed, creditsConsumptionGet.creditsUsed) &&
        Objects.equals(this.id, creditsConsumptionGet.id);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, creditsConsumptionEventCode, creditsConsumptionNotes, creditsEventId, creditsEventIri, creditsUsed, id);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreditsConsumptionGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreditsConsumptionGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreditsConsumptionGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreditsConsumptionGet is not found in the empty JSON string", CreditsConsumptionGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreditsConsumptionGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreditsConsumptionGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreditsConsumptionGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreditsConsumptionGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreditsConsumptionGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreditsConsumptionGet.class));

       return (TypeAdapter<T>) new TypeAdapter<CreditsConsumptionGet>() {
           @Override
           public void write(JsonWriter out, CreditsConsumptionGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreditsConsumptionGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreditsConsumptionGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreditsConsumptionGet
   * @throws IOException if the JSON string is invalid with respect to CreditsConsumptionGet
   */
  public static CreditsConsumptionGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreditsConsumptionGet.class);
  }

  /**
   * Convert an instance of CreditsConsumptionGet to an JSON string
   *
   * @return JSON string
   */
