...
public class TransportSlackJsonldGet {
  ...
  public TransportSlackJsonldGet() {
  }
  ...
  public TransportSlackJsonldGet atContext(AlertLogJsonldGetContext atContext) {
  ...
  public TransportSlackJsonldGet createdAt(OffsetDateTime createdAt) {
  ...
  public TransportSlackJsonldGet dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportSlackJsonldGet partition(String partition) {
  ...
  public TransportSlackJsonldGet resourceOwner(String resourceOwner) {
  ...
  public TransportSlackJsonldGet slackChannel(String slackChannel) {
  ...
  public TransportSlackJsonldGet slackToken(String slackToken) {
  ...
  public TransportSlackJsonldGet transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportSlackJsonldGet transportSlackJsonldGet = (TransportSlackJsonldGet) o;
    return Objects.equals(this.atContext, transportSlackJsonldGet.atContext) &&
        Objects.equals(this.atId, transportSlackJsonldGet.atId) &&
        Objects.equals(this.atType, transportSlackJsonldGet.atType) &&
        Objects.equals(this.createdAt, transportSlackJsonldGet.createdAt) &&
        Objects.equals(this.dataSegmentCode, transportSlackJsonldGet.dataSegmentCode) &&
        Objects.equals(this.id, transportSlackJsonldGet.id) &&
        Objects.equals(this.partition, transportSlackJsonldGet.partition) &&
        Objects.equals(this.resourceOwner, transportSlackJsonldGet.resourceOwner) &&
        Objects.equals(this.slackChannel, transportSlackJsonldGet.slackChannel) &&
        Objects.equals(this.slackToken, transportSlackJsonldGet.slackToken) &&
        Objects.equals(this.transportName, transportSlackJsonldGet.transportName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atContext, atId, atType, createdAt, dataSegmentCode, id, partition, resourceOwner, slackChannel, slackToken, transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportSlackJsonldGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportSlackJsonldGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportSlackJsonldGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportSlackJsonldGet is not found in the empty JSON string", TransportSlackJsonldGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportSlackJsonldGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportSlackJsonldGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportSlackJsonldGet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportSlackJsonldGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportSlackJsonldGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportSlackJsonldGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportSlackJsonldGet.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportSlackJsonldGet>() {
           @Override
           public void write(JsonWriter out, TransportSlackJsonldGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportSlackJsonldGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportSlackJsonldGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportSlackJsonldGet
   * @throws IOException if the JSON string is invalid with respect to TransportSlackJsonldGet
   */
  public static TransportSlackJsonldGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportSlackJsonldGet.class);
  }

  /**
   * Convert an instance of TransportSlackJsonldGet to an JSON string
   *
   * @return JSON string
   */
