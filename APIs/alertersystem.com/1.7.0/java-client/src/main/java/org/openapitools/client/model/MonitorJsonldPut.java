...
public class MonitorJsonldPut {
  ...
  public MonitorJsonldPut() {
  }

  public MonitorJsonldPut alertPayloadExtended(String alertPayloadExtended) {
  ...
  public MonitorJsonldPut alertPayloadShort(String alertPayloadShort) {
  ...
  public MonitorJsonldPut alertServices(List<String> alertServices) {
    this.alertServices = alertServices;
    return this;
  }

  public MonitorJsonldPut addAlertServicesItem(String alertServicesItem) {
  ...
  public MonitorJsonldPut allowUnauthenticatedPings(Boolean allowUnauthenticatedPings) {
  ...
  public MonitorJsonldPut contentCheckMustNotExist(Boolean contentCheckMustNotExist) {
  ...
  public MonitorJsonldPut contentCheckText(String contentCheckText) {
  ...
  public MonitorJsonldPut contentCheckUrl(URI contentCheckUrl) {
  ...
  public MonitorJsonldPut contentCheckXpathFilter(String contentCheckXpathFilter) {
  ...
  public MonitorJsonldPut dataSegmentCode(String dataSegmentCode) {
  ...
  public MonitorJsonldPut graceSeconds(Integer graceSeconds) {
  ...
  public MonitorJsonldPut intervalDays(Integer intervalDays) {
  ...
  public MonitorJsonldPut intervalHours(Integer intervalHours) {
  ...
  public MonitorJsonldPut intervalMinutes(Integer intervalMinutes) {
  ...
  public MonitorJsonldPut intervalMonths(Integer intervalMonths) {
  ...
  public MonitorJsonldPut intervalSeconds(Integer intervalSeconds) {
  ...
  public MonitorJsonldPut intervalYears(Integer intervalYears) {
  ...
  public MonitorJsonldPut isMonitorPaused(Boolean isMonitorPaused) {
  ...
  public MonitorJsonldPut monitorName(String monitorName) {
  ...
  public MonitorJsonldPut monitorNotes(String monitorNotes) {
  ...
  public MonitorJsonldPut publicDescription(String publicDescription) {
  ...
  public MonitorJsonldPut startMonitorAt(OffsetDateTime startMonitorAt) {
  ...
  public MonitorJsonldPut timezoneCode(String timezoneCode) {
  ...
  public MonitorJsonldPut webResponseSecondsLimit(Integer webResponseSecondsLimit) {
  ...
  public MonitorJsonldPut webResponseUrl(URI webResponseUrl) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorJsonldPut monitorJsonldPut = (MonitorJsonldPut) o;
    return Objects.equals(this.alertPayloadExtended, monitorJsonldPut.alertPayloadExtended) &&
        Objects.equals(this.alertPayloadShort, monitorJsonldPut.alertPayloadShort) &&
        Objects.equals(this.alertServices, monitorJsonldPut.alertServices) &&
        Objects.equals(this.allowUnauthenticatedPings, monitorJsonldPut.allowUnauthenticatedPings) &&
        Objects.equals(this.contentCheckMustNotExist, monitorJsonldPut.contentCheckMustNotExist) &&
        Objects.equals(this.contentCheckText, monitorJsonldPut.contentCheckText) &&
        Objects.equals(this.contentCheckUrl, monitorJsonldPut.contentCheckUrl) &&
        Objects.equals(this.contentCheckXpathFilter, monitorJsonldPut.contentCheckXpathFilter) &&
        Objects.equals(this.dataSegmentCode, monitorJsonldPut.dataSegmentCode) &&
        Objects.equals(this.graceSeconds, monitorJsonldPut.graceSeconds) &&
        Objects.equals(this.intervalDays, monitorJsonldPut.intervalDays) &&
        Objects.equals(this.intervalHours, monitorJsonldPut.intervalHours) &&
        Objects.equals(this.intervalMinutes, monitorJsonldPut.intervalMinutes) &&
        Objects.equals(this.intervalMonths, monitorJsonldPut.intervalMonths) &&
        Objects.equals(this.intervalSeconds, monitorJsonldPut.intervalSeconds) &&
        Objects.equals(this.intervalYears, monitorJsonldPut.intervalYears) &&
        Objects.equals(this.isMonitorPaused, monitorJsonldPut.isMonitorPaused) &&
        Objects.equals(this.monitorName, monitorJsonldPut.monitorName) &&
        Objects.equals(this.monitorNotes, monitorJsonldPut.monitorNotes) &&
        Objects.equals(this.publicDescription, monitorJsonldPut.publicDescription) &&
        Objects.equals(this.startMonitorAt, monitorJsonldPut.startMonitorAt) &&
        Objects.equals(this.timezoneCode, monitorJsonldPut.timezoneCode) &&
        Objects.equals(this.webResponseSecondsLimit, monitorJsonldPut.webResponseSecondsLimit) &&
        Objects.equals(this.webResponseUrl, monitorJsonldPut.webResponseUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class MonitorJsonldPut {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MonitorJsonldPut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MonitorJsonldPut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorJsonldPut is not found in the empty JSON string", MonitorJsonldPut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MonitorJsonldPut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonitorJsonldPut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MonitorJsonldPut.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorJsonldPut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorJsonldPut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorJsonldPut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorJsonldPut.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorJsonldPut>() {
           @Override
           public void write(JsonWriter out, MonitorJsonldPut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MonitorJsonldPut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MonitorJsonldPut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MonitorJsonldPut
   * @throws IOException if the JSON string is invalid with respect to MonitorJsonldPut
   */
  public static MonitorJsonldPut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorJsonldPut.class);
  }

  /**
   * Convert an instance of MonitorJsonldPut to an JSON string
   *
   * @return JSON string
   */
