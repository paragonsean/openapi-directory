...
public class AlertLogJsonldGet {
  ...
  public AlertLogJsonldGet atContext(AlertLogJsonldGetContext atContext) {
  ...
  public AlertLogJsonldGet alertLogErrorMessage(String alertLogErrorMessage) {
  ...
  public AlertLogJsonldGet alertLogMessageId(String alertLogMessageId) {
  ...
  public AlertLogJsonldGet alertLogStatusCode(String alertLogStatusCode) {
  ...
  public AlertLogJsonldGet alertService(String alertService) {
  ...
  public AlertLogJsonldGet dataSegmentCode(String dataSegmentCode) {
  ...
  public AlertLogJsonldGet monitor(String monitor) {
  ...
  public AlertLogJsonldGet partition(String partition) {
  ...
  public AlertLogJsonldGet ping(String ping) {
    this.ping = ping;
    return this;
  }
  ...
  public AlertLogJsonldGet resourceOwner(String resourceOwner) {
  ...
  public AlertLogJsonldGet webhookResponseBody(String webhookResponseBody) {
  ...
  public AlertLogJsonldGet webhookResponseHeaders(List<String> webhookResponseHeaders) {
    this.webhookResponseHeaders = webhookResponseHeaders;
    return this;
  }

  public AlertLogJsonldGet addWebhookResponseHeadersItem(String webhookResponseHeadersItem) {
  ...
  public boolean equals(Object o) {
    ...
    AlertLogJsonldGet alertLogJsonldGet = (AlertLogJsonldGet) o;
    return Objects.equals(this.atContext, alertLogJsonldGet.atContext) &&
        Objects.equals(this.atId, alertLogJsonldGet.atId) &&
        Objects.equals(this.atType, alertLogJsonldGet.atType) &&
        Objects.equals(this.alertLogErrorMessage, alertLogJsonldGet.alertLogErrorMessage) &&
        Objects.equals(this.alertLogMessageId, alertLogJsonldGet.alertLogMessageId) &&
        Objects.equals(this.alertLogStatusCode, alertLogJsonldGet.alertLogStatusCode) &&
        Objects.equals(this.alertService, alertLogJsonldGet.alertService) &&
        Objects.equals(this.createdAt, alertLogJsonldGet.createdAt) &&
        Objects.equals(this.dataSegmentCode, alertLogJsonldGet.dataSegmentCode) &&
        Objects.equals(this.id, alertLogJsonldGet.id) &&
        Objects.equals(this.monitor, alertLogJsonldGet.monitor) &&
        Objects.equals(this.partition, alertLogJsonldGet.partition) &&
        Objects.equals(this.ping, alertLogJsonldGet.ping) &&
        Objects.equals(this.resourceOwner, alertLogJsonldGet.resourceOwner) &&
        Objects.equals(this.webhookResponseBody, alertLogJsonldGet.webhookResponseBody) &&
        Objects.equals(this.webhookResponseHeaders, alertLogJsonldGet.webhookResponseHeaders);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atContext, atId, atType, alertLogErrorMessage, alertLogMessageId, alertLogStatusCode, alertService, createdAt, dataSegmentCode, id, monitor, partition, ping, resourceOwner, webhookResponseBody, webhookResponseHeaders);
  }
  ...
  public String toString() {
    ...
    sb.append("class AlertLogJsonldGet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AlertLogJsonldGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlertLogJsonldGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlertLogJsonldGet is not found in the empty JSON string", AlertLogJsonldGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlertLogJsonldGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AlertLogJsonldGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlertLogJsonldGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlertLogJsonldGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlertLogJsonldGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlertLogJsonldGet.class));

       return (TypeAdapter<T>) new TypeAdapter<AlertLogJsonldGet>() {
           @Override
           public void write(JsonWriter out, AlertLogJsonldGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AlertLogJsonldGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AlertLogJsonldGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AlertLogJsonldGet
   * @throws IOException if the JSON string is invalid with respect to AlertLogJsonldGet
   */
  public static AlertLogJsonldGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlertLogJsonldGet.class);
  }

  /**
   * Convert an instance of AlertLogJsonldGet to an JSON string
   *
   * @return JSON string
   */
