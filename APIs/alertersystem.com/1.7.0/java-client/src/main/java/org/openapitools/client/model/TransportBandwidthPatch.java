...
public class TransportBandwidthPatch {
  ...
  public TransportBandwidthPatch() {
  }

  public TransportBandwidthPatch bandwidthAccountId(String bandwidthAccountId) {
  ...
  public TransportBandwidthPatch bandwidthApplicationId(String bandwidthApplicationId) {
  ...
  public TransportBandwidthPatch bandwidthFrom(String bandwidthFrom) {
  ...
  public TransportBandwidthPatch bandwidthPassword(String bandwidthPassword) {
  ...
  public TransportBandwidthPatch bandwidthUsername(String bandwidthUsername) {
  ...
  public TransportBandwidthPatch dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportBandwidthPatch transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportBandwidthPatch transportBandwidthPatch = (TransportBandwidthPatch) o;
    return Objects.equals(this.bandwidthAccountId, transportBandwidthPatch.bandwidthAccountId) &&
        Objects.equals(this.bandwidthApplicationId, transportBandwidthPatch.bandwidthApplicationId) &&
        Objects.equals(this.bandwidthFrom, transportBandwidthPatch.bandwidthFrom) &&
        Objects.equals(this.bandwidthPassword, transportBandwidthPatch.bandwidthPassword) &&
        Objects.equals(this.bandwidthUsername, transportBandwidthPatch.bandwidthUsername) &&
        Objects.equals(this.dataSegmentCode, transportBandwidthPatch.dataSegmentCode) &&
        Objects.equals(this.transportName, transportBandwidthPatch.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportBandwidthPatch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportBandwidthPatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportBandwidthPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportBandwidthPatch is not found in the empty JSON string", TransportBandwidthPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportBandwidthPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportBandwidthPatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportBandwidthPatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportBandwidthPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportBandwidthPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportBandwidthPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportBandwidthPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportBandwidthPatch>() {
           @Override
           public void write(JsonWriter out, TransportBandwidthPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportBandwidthPatch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportBandwidthPatch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportBandwidthPatch
   * @throws IOException if the JSON string is invalid with respect to TransportBandwidthPatch
   */
  public static TransportBandwidthPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportBandwidthPatch.class);
  }

  /**
   * Convert an instance of TransportBandwidthPatch to an JSON string
   *
   * @return JSON string
   */
