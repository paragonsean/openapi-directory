...
public class TransportBandwidthPost {
  ...
  public TransportBandwidthPost() {
  }

  public TransportBandwidthPost bandwidthAccountId(String bandwidthAccountId) {
  ...
  public TransportBandwidthPost bandwidthApplicationId(String bandwidthApplicationId) {
  ...
  public TransportBandwidthPost bandwidthFrom(String bandwidthFrom) {
  ...
  public TransportBandwidthPost bandwidthPassword(String bandwidthPassword) {
  ...
  public TransportBandwidthPost bandwidthUsername(String bandwidthUsername) {
  ...
  public TransportBandwidthPost dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportBandwidthPost partition(String partition) {
  ...
  public TransportBandwidthPost transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportBandwidthPost transportBandwidthPost = (TransportBandwidthPost) o;
    return Objects.equals(this.bandwidthAccountId, transportBandwidthPost.bandwidthAccountId) &&
        Objects.equals(this.bandwidthApplicationId, transportBandwidthPost.bandwidthApplicationId) &&
        Objects.equals(this.bandwidthFrom, transportBandwidthPost.bandwidthFrom) &&
        Objects.equals(this.bandwidthPassword, transportBandwidthPost.bandwidthPassword) &&
        Objects.equals(this.bandwidthUsername, transportBandwidthPost.bandwidthUsername) &&
        Objects.equals(this.dataSegmentCode, transportBandwidthPost.dataSegmentCode) &&
        Objects.equals(this.partition, transportBandwidthPost.partition) &&
        Objects.equals(this.transportName, transportBandwidthPost.transportName);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bandwidthAccountId, bandwidthApplicationId, bandwidthFrom, bandwidthPassword, bandwidthUsername, dataSegmentCode, partition, transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportBandwidthPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportBandwidthPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportBandwidthPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportBandwidthPost is not found in the empty JSON string", TransportBandwidthPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportBandwidthPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportBandwidthPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportBandwidthPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportBandwidthPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportBandwidthPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportBandwidthPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportBandwidthPost.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportBandwidthPost>() {
           @Override
           public void write(JsonWriter out, TransportBandwidthPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportBandwidthPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportBandwidthPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportBandwidthPost
   * @throws IOException if the JSON string is invalid with respect to TransportBandwidthPost
   */
  public static TransportBandwidthPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportBandwidthPost.class);
  }

  /**
   * Convert an instance of TransportBandwidthPost to an JSON string
   *
   * @return JSON string
   */
