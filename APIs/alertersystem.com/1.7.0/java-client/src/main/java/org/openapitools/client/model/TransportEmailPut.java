...
public class TransportEmailPut {
  ...
  public TransportEmailPut() {
  }

  public TransportEmailPut dataSegmentCode(String dataSegmentCode) {
  ...
  public TransportEmailPut emailFromAddress(String emailFromAddress) {
  ...
  public TransportEmailPut emailFromName(String emailFromName) {
  ...
  public TransportEmailPut emailPassword(String emailPassword) {
  ...
  public TransportEmailPut emailPort(Integer emailPort) {
  ...
  public TransportEmailPut emailServer(String emailServer) {
  ...
  public TransportEmailPut emailUsername(String emailUsername) {
  ...
  public TransportEmailPut transportName(String transportName) {
  ...
  public boolean equals(Object o) {
    ...
    TransportEmailPut transportEmailPut = (TransportEmailPut) o;
    return Objects.equals(this.dataSegmentCode, transportEmailPut.dataSegmentCode) &&
        Objects.equals(this.emailFromAddress, transportEmailPut.emailFromAddress) &&
        Objects.equals(this.emailFromName, transportEmailPut.emailFromName) &&
        Objects.equals(this.emailPassword, transportEmailPut.emailPassword) &&
        Objects.equals(this.emailPort, transportEmailPut.emailPort) &&
        Objects.equals(this.emailServer, transportEmailPut.emailServer) &&
        Objects.equals(this.emailUsername, transportEmailPut.emailUsername) &&
        Objects.equals(this.transportName, transportEmailPut.transportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransportEmailPut {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransportEmailPut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportEmailPut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportEmailPut is not found in the empty JSON string", TransportEmailPut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransportEmailPut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransportEmailPut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransportEmailPut.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransportEmailPut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransportEmailPut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransportEmailPut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransportEmailPut.class));

       return (TypeAdapter<T>) new TypeAdapter<TransportEmailPut>() {
           @Override
           public void write(JsonWriter out, TransportEmailPut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransportEmailPut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransportEmailPut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransportEmailPut
   * @throws IOException if the JSON string is invalid with respect to TransportEmailPut
   */
  public static TransportEmailPut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportEmailPut.class);
  }

  /**
   * Convert an instance of TransportEmailPut to an JSON string
   *
   * @return JSON string
   */
