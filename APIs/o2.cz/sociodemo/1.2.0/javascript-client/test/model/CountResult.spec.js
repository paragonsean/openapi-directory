...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SocioDemoApi.CountResult();
  });
  ...
  describe('CountResult', function() {
    it('should create an instance of CountResult', function() {
      // uncomment below and update the code to test CountResult
      //var instance = new SocioDemoApi.CountResult();
      //expect(instance).to.be.a(SocioDemoApi.CountResult);
    });
