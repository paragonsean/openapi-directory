...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MobilityApi.TransitApi();
  });
  ...
  describe('TransitApi', function() {
    describe('transit', function() {
      it('should call transit successfully', function(done) {
        //uncomment below and update the code to test transit
        //instance.transit(function(error) {
