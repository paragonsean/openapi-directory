...
Q_SIGNALS:
    ...
    void getInfoSignal(OAIInfoResult summary);


    void getInfoSignalFull(OAIHttpRequestWorker *worker, OAIInfoResult summary);

    Q_DECL_DEPRECATED_X("Use getInfoSignalError() instead")
    void getInfoSignalE(OAIInfoResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getInfoSignalError(OAIInfoResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
