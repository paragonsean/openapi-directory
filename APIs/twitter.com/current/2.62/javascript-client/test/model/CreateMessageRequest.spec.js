...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwitterApiV2.CreateMessageRequest();
  });
  ...
  describe('CreateMessageRequest', function() {
    it('should create an instance of CreateMessageRequest', function() {
      ...
      //var instance = new TwitterApiV2.CreateMessageRequest();
      //expect(instance).to.be.a(TwitterApiV2.CreateMessageRequest);
    });
