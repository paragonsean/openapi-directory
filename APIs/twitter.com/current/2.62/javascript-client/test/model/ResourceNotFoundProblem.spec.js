...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwitterApiV2.ResourceNotFoundProblem();
  });
  ...
  describe('ResourceNotFoundProblem', function() {
    it('should create an instance of ResourceNotFoundProblem', function() {
      // uncomment below and update the code to test ResourceNotFoundProblem
      //var instance = new TwitterApiV2.ResourceNotFoundProblem();
      //expect(instance).to.be.a(TwitterApiV2.ResourceNotFoundProblem);
    });
