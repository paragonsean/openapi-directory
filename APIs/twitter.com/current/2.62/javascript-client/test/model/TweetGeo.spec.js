...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwitterApiV2.TweetGeo();
  });
  ...
  describe('TweetGeo', function() {
    it('should create an instance of TweetGeo', function() {
      // uncomment below and update the code to test TweetGeo
      //var instance = new TwitterApiV2.TweetGeo();
      //expect(instance).to.be.a(TwitterApiV2.TweetGeo);
    });
