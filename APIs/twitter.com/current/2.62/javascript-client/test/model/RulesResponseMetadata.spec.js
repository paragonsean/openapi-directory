...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwitterApiV2.RulesResponseMetadata();
  });
  ...
  describe('RulesResponseMetadata', function() {
    it('should create an instance of RulesResponseMetadata', function() {
      // uncomment below and update the code to test RulesResponseMetadata
      //var instance = new TwitterApiV2.RulesResponseMetadata();
      //expect(instance).to.be.a(TwitterApiV2.RulesResponseMetadata);
    });
