...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwitterApiV2.DisallowedResourceProblem();
  });
  ...
  describe('DisallowedResourceProblem', function() {
    it('should create an instance of DisallowedResourceProblem', function() {
      // uncomment below and update the code to test DisallowedResourceProblem
      //var instance = new TwitterApiV2.DisallowedResourceProblem();
      //expect(instance).to.be.a(TwitterApiV2.DisallowedResourceProblem);
    });
