...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwitterApiV2.FieldUnauthorizedProblem();
  });
  ...
  describe('FieldUnauthorizedProblem', function() {
    it('should create an instance of FieldUnauthorizedProblem', function() {
      // uncomment below and update the code to test FieldUnauthorizedProblem
      //var instance = new TwitterApiV2.FieldUnauthorizedProblem();
      //expect(instance).to.be.a(TwitterApiV2.FieldUnauthorizedProblem);
    });
