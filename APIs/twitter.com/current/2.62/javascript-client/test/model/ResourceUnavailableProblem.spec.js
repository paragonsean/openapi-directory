...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwitterApiV2.ResourceUnavailableProblem();
  });
  ...
  describe('ResourceUnavailableProblem', function() {
    it('should create an instance of ResourceUnavailableProblem', function() {
      // uncomment below and update the code to test ResourceUnavailableProblem
      //var instance = new TwitterApiV2.ResourceUnavailableProblem();
      //expect(instance).to.be.a(TwitterApiV2.ResourceUnavailableProblem);
    });
