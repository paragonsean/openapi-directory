...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwitterApiV2.ResourceUnauthorizedProblem();
  });
  ...
  describe('ResourceUnauthorizedProblem', function() {
    it('should create an instance of ResourceUnauthorizedProblem', function() {
      // uncomment below and update the code to test ResourceUnauthorizedProblem
      //var instance = new TwitterApiV2.ResourceUnauthorizedProblem();
      //expect(instance).to.be.a(TwitterApiV2.ResourceUnauthorizedProblem);
    });
