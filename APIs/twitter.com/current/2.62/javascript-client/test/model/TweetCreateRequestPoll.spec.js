...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TwitterApiV2.TweetCreateRequestPoll();
  });
  ...
  describe('TweetCreateRequestPoll', function() {
    it('should create an instance of TweetCreateRequestPoll', function() {
      // uncomment below and update the code to test TweetCreateRequestPoll
      //var instance = new TwitterApiV2.TweetCreateRequestPoll();
      //expect(instance).to.be.a(TwitterApiV2.TweetCreateRequestPoll);
    });
