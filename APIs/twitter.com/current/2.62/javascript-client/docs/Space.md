...
**participantCount** | **Number** | The number of participants in a Space. | [optional] 
...
**subscriberCount** | **Number** | The number of people who have either purchased a ticket or set a reminder for this Space. | [optional] 
**title** | **String** | The title of the Space. | [optional] 
**topics** | [**[SpaceTopicsInner]**](SpaceTopicsInner.md) | The topics of a Space, as selected by its creator. | [optional] 
