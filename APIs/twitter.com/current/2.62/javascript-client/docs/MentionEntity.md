# TwitterApiV2.MentionEntity

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**end** | **Number** | Index (zero-based) at which position this entity ends.  The index is exclusive. | 
**start** | **Number** | Index (zero-based) at which position this entity starts.  The index is inclusive. | 
