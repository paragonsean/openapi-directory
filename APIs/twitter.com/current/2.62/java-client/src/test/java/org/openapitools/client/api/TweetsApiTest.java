...
public class TweetsApiTest {
     ...
     */
    @Test
    public void spaceBuyers_0Test() throws ApiException {
        String id = null;
        String paginationToken = null;
        Integer maxResults = null;
        Set<String> userFields = null;
        Set<String> expansions = null;
        Set<String> tweetFields = null;
        Get2SpacesIdBuyersResponse response = api.spaceBuyers_0(id, paginationToken, maxResults, userFields, expansions, tweetFields);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void spaceTweets_0Test() throws ApiException {
        String id = null;
        Integer maxResults = null;
        Set<String> tweetFields = null;
        Set<String> expansions = null;
        ...
        Set<String> userFields = null;
        Set<String> placeFields = null;
        Get2SpacesIdTweetsResponse response = api.spaceTweets_0(id, maxResults, tweetFields, expansions, mediaFields, pollFields, userFields, placeFields);
        // TODO: test validations
    }
