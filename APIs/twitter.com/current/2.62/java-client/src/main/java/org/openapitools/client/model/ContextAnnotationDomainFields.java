...
public class ContextAnnotationDomainFields {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextAnnotationDomainFields
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextAnnotationDomainFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextAnnotationDomainFields.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextAnnotationDomainFields` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
