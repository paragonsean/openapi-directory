...
public class Get2UsersIdListMembershipsResponse {
  ...
  private List<ModelList> data = new ArrayList<>();
   ...
   * @throws IOException if the JSON Element is invalid with respect to Get2UsersIdListMembershipsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Get2UsersIdListMembershipsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Get2UsersIdListMembershipsResponse is not found in the empty JSON string", Get2UsersIdListMembershipsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Get2UsersIdListMembershipsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Get2UsersIdListMembershipsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ModelList.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Get2UsersIdListMembershipsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Get2UsersIdListMembershipsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Get2UsersIdListMembershipsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Get2UsersIdListMembershipsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Get2UsersIdListMembershipsResponse>() {
           @Override
           public void write(JsonWriter out, Get2UsersIdListMembershipsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Get2UsersIdListMembershipsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Get2UsersIdListMembershipsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Get2UsersIdListMembershipsResponse
   * @throws IOException if the JSON string is invalid with respect to Get2UsersIdListMembershipsResponse
   */
  public static Get2UsersIdListMembershipsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Get2UsersIdListMembershipsResponse.class);
  }

  /**
   * Convert an instance of Get2UsersIdListMembershipsResponse to an JSON string
   *
   * @return JSON string
   */
