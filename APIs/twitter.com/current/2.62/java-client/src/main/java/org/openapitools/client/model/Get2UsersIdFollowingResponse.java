...
public class Get2UsersIdFollowingResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to Get2UsersIdFollowingResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Get2UsersIdFollowingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Get2UsersIdFollowingResponse is not found in the empty JSON string", Get2UsersIdFollowingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Get2UsersIdFollowingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Get2UsersIdFollowingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Get2UsersIdFollowingResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Get2UsersIdFollowingResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Get2UsersIdFollowingResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Get2UsersIdFollowingResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Get2UsersIdFollowingResponse>() {
           @Override
           public void write(JsonWriter out, Get2UsersIdFollowingResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Get2UsersIdFollowingResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Get2UsersIdFollowingResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Get2UsersIdFollowingResponse
   * @throws IOException if the JSON string is invalid with respect to Get2UsersIdFollowingResponse
   */
  public static Get2UsersIdFollowingResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Get2UsersIdFollowingResponse.class);
  }

  /**
   * Convert an instance of Get2UsersIdFollowingResponse to an JSON string
   *
   * @return JSON string
   */
