...
import org.openapitools.client.model.RulesRequestSummaryOneOf;
import org.openapitools.client.model.RulesRequestSummaryOneOf1;
...
public class RulesRequestSummary extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<RulesRequestSummary>() {
                ...
                public void write(JsonWriter out, RulesRequestSummary value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof RulesRequestSummaryOneOf) {
                        JsonElement element = adapterRulesRequestSummaryOneOf.toJsonTree((RulesRequestSummaryOneOf)value.getActualInstance());
                    ...
                    if (value.getActualInstance() instanceof RulesRequestSummaryOneOf1) {
                        JsonElement element = adapterRulesRequestSummaryOneOf1.toJsonTree((RulesRequestSummaryOneOf1)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                public RulesRequestSummary read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        RulesRequestSummaryOneOf.validateJsonElement(jsonElement);
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        RulesRequestSummaryOneOf1.validateJsonElement(jsonElement);
                    ...
                    throw new IOException(String.format("Failed deserialization for RulesRequestSummary: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public RulesRequestSummary(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("RulesRequestSummaryOneOf", RulesRequestSummaryOneOf.class);
        schemas.put("RulesRequestSummaryOneOf1", RulesRequestSummaryOneOf1.class);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to RulesRequestSummary
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for RulesRequestSummary with oneOf schemas: RulesRequestSummaryOneOf, RulesRequestSummaryOneOf1. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
