...
public class Get2UsersIdMutingResponse {
  ...
  public Get2UsersIdMutingResponse meta(Get2DmConversationsIdDmEventsResponseMeta meta) {
    this.meta = meta;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Get2UsersIdMutingResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Get2UsersIdMutingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Get2UsersIdMutingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Get2UsersIdMutingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
