...
public class Get2UsersIdPinnedListsResponse {
  ...
  public Get2UsersIdPinnedListsResponse data(List<ModelList> data) {
    this.data = data;
    return this;
  }

  public Get2UsersIdPinnedListsResponse addDataItem(ModelList dataItem) {
    if (this.data == null) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to Get2UsersIdPinnedListsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Get2UsersIdPinnedListsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Get2UsersIdPinnedListsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Get2UsersIdPinnedListsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        Get2ComplianceJobsResponseMeta.validateJsonElement(jsonObj.get("meta"));
      }
  }
