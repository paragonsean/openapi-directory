...
public class CreateDmConversationRequest {
  ...
  public enum ConversationTypeEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      ConversationTypeEnum.fromValue(value);
    }
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDmConversationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDmConversationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDmConversationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDmConversationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the required field `conversation_type`
      ConversationTypeEnum.validateJsonElement(jsonObj.get("conversation_type"));
      // validate the required field `message`
      CreateMessageRequest.validateJsonElement(jsonObj.get("message"));
