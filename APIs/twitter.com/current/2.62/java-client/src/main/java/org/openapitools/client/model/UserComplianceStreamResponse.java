...
public class UserComplianceStreamResponse extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserComplianceStreamResponse>() {
                ...
                public void write(JsonWriter out, UserComplianceStreamResponse value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof UserComplianceStreamResponseOneOf) {
                        JsonElement element = adapterUserComplianceStreamResponseOneOf.toJsonTree((UserComplianceStreamResponseOneOf)value.getActualInstance());
                ...
                public UserComplianceStreamResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UserComplianceStreamResponseOneOf.validateJsonElement(jsonElement);
                    ...
                    throw new IOException(String.format("Failed deserialization for UserComplianceStreamResponse: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserComplianceStreamResponse(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("UserComplianceStreamResponseOneOf", UserComplianceStreamResponseOneOf.class);
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserComplianceStreamResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserComplianceStreamResponse with oneOf schemas: TweetComplianceStreamResponseOneOf1, UserComplianceStreamResponseOneOf. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
