...
public class AddOrDeleteRulesRequest extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<AddOrDeleteRulesRequest>() {
                ...
                public void write(JsonWriter out, AddOrDeleteRulesRequest value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof AddRulesRequest) {
                        JsonElement element = adapterAddRulesRequest.toJsonTree((AddRulesRequest)value.getActualInstance());
                    ...
                    if (value.getActualInstance() instanceof DeleteRulesRequest) {
                        JsonElement element = adapterDeleteRulesRequest.toJsonTree((DeleteRulesRequest)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                public AddOrDeleteRulesRequest read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        AddRulesRequest.validateJsonElement(jsonElement);
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        DeleteRulesRequest.validateJsonElement(jsonElement);
                    ...
                    throw new IOException(String.format("Failed deserialization for AddOrDeleteRulesRequest: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AddOrDeleteRulesRequest(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("AddRulesRequest", AddRulesRequest.class);
        schemas.put("DeleteRulesRequest", DeleteRulesRequest.class);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to AddOrDeleteRulesRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for AddOrDeleteRulesRequest with oneOf schemas: AddRulesRequest, DeleteRulesRequest. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
