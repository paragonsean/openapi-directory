...
Twitter API v2
- API version: 2.62
  - Build date: 2024-10-12T10:06:49.009664-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:2.62"
  }
```
...
* `target/openapi-java-client-2.62.jar`
* `target/lib/*.jar`
...
*TweetsApi* | [**spaceBuyers_0**](docs/TweetsApi.md#spaceBuyers_0) | **GET** /2/spaces/{id}/buyers | Retrieve the list of Users who purchased a ticket to the given space
*TweetsApi* | [**spaceTweets_0**](docs/TweetsApi.md#spaceTweets_0) | **GET** /2/spaces/{id}/tweets | Retrieve Tweets from a Space.
