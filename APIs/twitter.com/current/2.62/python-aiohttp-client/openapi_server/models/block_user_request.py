...
class BlockUserRequest(Model):
    ...
    def __init__(self, target_user_id: str=None):
        """BlockUserRequest - a model defined in OpenAPI

        :param target_user_id: The target_user_id of this BlockUserRequest.
        """
        self.openapi_types = {
            'target_user_id': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BlockUserRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BlockUserRequest of this BlockUserRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def target_user_id(self):
        """Gets the target_user_id of this BlockUserRequest.

        Unique identifier of this User. This is returned as a string in order to avoid complications with languages and tools that cannot handle large integers.

        :return: The target_user_id of this BlockUserRequest.
        :rtype: str
        """
    ...
    def target_user_id(self, target_user_id):
        """Sets the target_user_id of this BlockUserRequest.
