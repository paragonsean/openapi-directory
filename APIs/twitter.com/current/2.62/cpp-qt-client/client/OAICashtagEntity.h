...
#ifndef OAICashtagEntity_H
#define OAICashtagEntity_H
...
class OAICashtagEntity : public OAIObject {
public:
    OAICashtagEntity();
    OAICashtagEntity(QString json);
    ~OAICashtagEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICashtagEntity)

#endif // OAICashtagEntity_H
