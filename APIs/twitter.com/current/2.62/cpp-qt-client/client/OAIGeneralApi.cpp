...
void OAIGeneralApi::getOpenApiSpec() {
    QString fullPath = QString(_serverConfigs["getOpenApiSpec"][_serverIndices.value("getOpenApiSpec")].URL()+"/2/openapi.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGeneralApi::getOpenApiSpecCallback);
...
void OAIGeneralApi::getOpenApiSpecCallback(OAIHttpRequestWorker *worker) {
