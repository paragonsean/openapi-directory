...
/*
 * OAIResourceUnavailableProblem.h
 *
 * A problem that indicates a particular Tweet, User, etc. is not available to you.
 */

#ifndef OAIResourceUnavailableProblem_H
#define OAIResourceUnavailableProblem_H
...
class OAIResourceUnavailableProblem : public OAIObject {
public:
    OAIResourceUnavailableProblem();
    OAIResourceUnavailableProblem(QString json);
    ~OAIResourceUnavailableProblem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceUnavailableProblem)

#endif // OAIResourceUnavailableProblem_H
