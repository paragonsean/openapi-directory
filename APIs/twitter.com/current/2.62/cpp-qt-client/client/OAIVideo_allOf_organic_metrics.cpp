...
OAIVideo_allOf_organic_metrics::OAIVideo_allOf_organic_metrics(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVideo_allOf_organic_metrics::OAIVideo_allOf_organic_metrics() {
    this->initializeModel();
}

OAIVideo_allOf_organic_metrics::~OAIVideo_allOf_organic_metrics() {}

void OAIVideo_allOf_organic_metrics::initializeModel() {
...
void OAIVideo_allOf_organic_metrics::fromJson(QString jsonString) {
...
void OAIVideo_allOf_organic_metrics::fromJsonObject(QJsonObject json) {
...
QString OAIVideo_allOf_organic_metrics::asJson() const {
...
QJsonObject OAIVideo_allOf_organic_metrics::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIVideo_allOf_organic_metrics::getPlayback0Count() const {
    return m_playback_0_count;
}
void OAIVideo_allOf_organic_metrics::setPlayback0Count(const qint32 &playback_0_count) {
    m_playback_0_count = playback_0_count;
    m_playback_0_count_isSet = true;
}

bool OAIVideo_allOf_organic_metrics::is_playback_0_count_Set() const{
    return m_playback_0_count_isSet;
}

bool OAIVideo_allOf_organic_metrics::is_playback_0_count_Valid() const{
    return m_playback_0_count_isValid;
}

qint32 OAIVideo_allOf_organic_metrics::getPlayback100Count() const {
    return m_playback_100_count;
}
void OAIVideo_allOf_organic_metrics::setPlayback100Count(const qint32 &playback_100_count) {
    m_playback_100_count = playback_100_count;
    m_playback_100_count_isSet = true;
}

bool OAIVideo_allOf_organic_metrics::is_playback_100_count_Set() const{
    return m_playback_100_count_isSet;
}

bool OAIVideo_allOf_organic_metrics::is_playback_100_count_Valid() const{
    return m_playback_100_count_isValid;
}

qint32 OAIVideo_allOf_organic_metrics::getPlayback25Count() const {
    return m_playback_25_count;
}
void OAIVideo_allOf_organic_metrics::setPlayback25Count(const qint32 &playback_25_count) {
    m_playback_25_count = playback_25_count;
    m_playback_25_count_isSet = true;
}

bool OAIVideo_allOf_organic_metrics::is_playback_25_count_Set() const{
    return m_playback_25_count_isSet;
}

bool OAIVideo_allOf_organic_metrics::is_playback_25_count_Valid() const{
    return m_playback_25_count_isValid;
}

qint32 OAIVideo_allOf_organic_metrics::getPlayback50Count() const {
    return m_playback_50_count;
}
void OAIVideo_allOf_organic_metrics::setPlayback50Count(const qint32 &playback_50_count) {
    m_playback_50_count = playback_50_count;
    m_playback_50_count_isSet = true;
}

bool OAIVideo_allOf_organic_metrics::is_playback_50_count_Set() const{
    return m_playback_50_count_isSet;
}

bool OAIVideo_allOf_organic_metrics::is_playback_50_count_Valid() const{
    return m_playback_50_count_isValid;
}

qint32 OAIVideo_allOf_organic_metrics::getPlayback75Count() const {
    return m_playback_75_count;
}
void OAIVideo_allOf_organic_metrics::setPlayback75Count(const qint32 &playback_75_count) {
    m_playback_75_count = playback_75_count;
    m_playback_75_count_isSet = true;
}

bool OAIVideo_allOf_organic_metrics::is_playback_75_count_Set() const{
    return m_playback_75_count_isSet;
}

bool OAIVideo_allOf_organic_metrics::is_playback_75_count_Valid() const{
    return m_playback_75_count_isValid;
}

qint32 OAIVideo_allOf_organic_metrics::getViewCount() const {
    return m_view_count;
}
void OAIVideo_allOf_organic_metrics::setViewCount(const qint32 &view_count) {
    m_view_count = view_count;
    m_view_count_isSet = true;
}

bool OAIVideo_allOf_organic_metrics::is_view_count_Set() const{
    return m_view_count_isSet;
}

bool OAIVideo_allOf_organic_metrics::is_view_count_Valid() const{
    return m_view_count_isValid;
}

bool OAIVideo_allOf_organic_metrics::isSet() const {
...
bool OAIVideo_allOf_organic_metrics::isValid() const {
