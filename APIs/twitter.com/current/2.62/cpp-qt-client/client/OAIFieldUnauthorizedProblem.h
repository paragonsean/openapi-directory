...
/*
 * OAIFieldUnauthorizedProblem.h
 *
 * A problem that indicates that you are not allowed to see a particular field on a Tweet, User, etc.
 */

#ifndef OAIFieldUnauthorizedProblem_H
#define OAIFieldUnauthorizedProblem_H
...
class OAIFieldUnauthorizedProblem : public OAIObject {
public:
    OAIFieldUnauthorizedProblem();
    OAIFieldUnauthorizedProblem(QString json);
    ~OAIFieldUnauthorizedProblem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldUnauthorizedProblem)

#endif // OAIFieldUnauthorizedProblem_H
