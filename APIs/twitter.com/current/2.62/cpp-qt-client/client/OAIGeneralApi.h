...
Q_SIGNALS:
    ...
    void getOpenApiSpecSignal(OAIObject summary);


    void getOpenApiSpecSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);

    Q_DECL_DEPRECATED_X("Use getOpenApiSpecSignalError() instead")
    void getOpenApiSpecSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getOpenApiSpecSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
