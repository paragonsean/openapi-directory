...
/*
 * OAIResourceUnauthorizedProblem.h
 *
 * A problem that indicates you are not allowed to see a particular Tweet, User, etc.
 */

#ifndef OAIResourceUnauthorizedProblem_H
#define OAIResourceUnauthorizedProblem_H
...
class OAIResourceUnauthorizedProblem : public OAIObject {
public:
    OAIResourceUnauthorizedProblem();
    OAIResourceUnauthorizedProblem(QString json);
    ~OAIResourceUnauthorizedProblem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceUnauthorizedProblem)

#endif // OAIResourceUnauthorizedProblem_H
