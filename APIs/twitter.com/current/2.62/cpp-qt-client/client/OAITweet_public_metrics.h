...
/*
 * OAITweet_public_metrics.h
 *
 * Engagement metrics for the Tweet at the time of the request.
 */

#ifndef OAITweet_public_metrics_H
#define OAITweet_public_metrics_H
...
class OAITweet_public_metrics : public OAIObject {
public:
    OAITweet_public_metrics();
    OAITweet_public_metrics(QString json);
    ~OAITweet_public_metrics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITweet_public_metrics)

#endif // OAITweet_public_metrics_H
