...
/*
 * OAIStreamingTweetResponse.h
 *
 * 
 */

#ifndef OAIStreamingTweetResponse_H
#define OAIStreamingTweetResponse_H
...
class OAIStreamingTweetResponse : public OAIObject {
public:
    OAIStreamingTweetResponse();
    OAIStreamingTweetResponse(QString json);
    ~OAIStreamingTweetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamingTweetResponse)

#endif // OAIStreamingTweetResponse_H
