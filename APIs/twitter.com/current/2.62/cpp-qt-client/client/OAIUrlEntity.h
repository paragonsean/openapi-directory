...
#ifndef OAIUrlEntity_H
#define OAIUrlEntity_H
...
class OAIUrlEntity : public OAIObject {
public:
    OAIUrlEntity();
    OAIUrlEntity(QString json);
    ~OAIUrlEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUrlEntity)

#endif // OAIUrlEntity_H
