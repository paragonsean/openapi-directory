...
OAITweet_organic_metrics::OAITweet_organic_metrics(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITweet_organic_metrics::OAITweet_organic_metrics() {
    this->initializeModel();
}

OAITweet_organic_metrics::~OAITweet_organic_metrics() {}

void OAITweet_organic_metrics::initializeModel() {
...
void OAITweet_organic_metrics::fromJson(QString jsonString) {
...
void OAITweet_organic_metrics::fromJsonObject(QJsonObject json) {
...
QString OAITweet_organic_metrics::asJson() const {
...
QJsonObject OAITweet_organic_metrics::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAITweet_organic_metrics::getImpressionCount() const {
    return m_impression_count;
}
void OAITweet_organic_metrics::setImpressionCount(const qint32 &impression_count) {
    m_impression_count = impression_count;
    m_impression_count_isSet = true;
}

bool OAITweet_organic_metrics::is_impression_count_Set() const{
    return m_impression_count_isSet;
}

bool OAITweet_organic_metrics::is_impression_count_Valid() const{
    return m_impression_count_isValid;
}

qint32 OAITweet_organic_metrics::getLikeCount() const {
    return m_like_count;
}
void OAITweet_organic_metrics::setLikeCount(const qint32 &like_count) {
    m_like_count = like_count;
    m_like_count_isSet = true;
}

bool OAITweet_organic_metrics::is_like_count_Set() const{
    return m_like_count_isSet;
}

bool OAITweet_organic_metrics::is_like_count_Valid() const{
    return m_like_count_isValid;
}

qint32 OAITweet_organic_metrics::getReplyCount() const {
    return m_reply_count;
}
void OAITweet_organic_metrics::setReplyCount(const qint32 &reply_count) {
    m_reply_count = reply_count;
    m_reply_count_isSet = true;
}

bool OAITweet_organic_metrics::is_reply_count_Set() const{
    return m_reply_count_isSet;
}

bool OAITweet_organic_metrics::is_reply_count_Valid() const{
    return m_reply_count_isValid;
}

qint32 OAITweet_organic_metrics::getRetweetCount() const {
    return m_retweet_count;
}
void OAITweet_organic_metrics::setRetweetCount(const qint32 &retweet_count) {
    m_retweet_count = retweet_count;
    m_retweet_count_isSet = true;
}

bool OAITweet_organic_metrics::is_retweet_count_Set() const{
    return m_retweet_count_isSet;
}

bool OAITweet_organic_metrics::is_retweet_count_Valid() const{
    return m_retweet_count_isValid;
}

bool OAITweet_organic_metrics::isSet() const {
...
bool OAITweet_organic_metrics::isValid() const {
