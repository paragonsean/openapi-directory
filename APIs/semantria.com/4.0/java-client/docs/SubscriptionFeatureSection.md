...
|**htmlProcessing** | **Boolean** | Identifies whether HTML processing feature is supported or not |  |
|**supportedLanguages** | **String** | Lists all languages which are allowed for current subscription |  |
