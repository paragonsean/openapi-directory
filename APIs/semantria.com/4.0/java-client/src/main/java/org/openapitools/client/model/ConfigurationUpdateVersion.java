...
public class ConfigurationUpdateVersion {
  ...
  public ConfigurationUpdateVersion() {
  }

  public ConfigurationUpdateVersion autoResponse(Boolean autoResponse) {
  ...
  public ConfigurationUpdateVersion callback(String callback) {
  ...
  public ConfigurationUpdateVersion categoriesThreshold(Double categoriesThreshold) {
  ...
  public ConfigurationUpdateVersion charsThreshold(Integer charsThreshold) {
  ...
  public ConfigurationUpdateVersion collection(ConfigurationCollectionSection collection) {
  ...
  public ConfigurationUpdateVersion configId(String configId) {
  ...
  public ConfigurationUpdateVersion document(ConfigurationDocumentSection document) {
  ...
  public ConfigurationUpdateVersion entitiesThreshold(Integer entitiesThreshold) {
  ...
  public ConfigurationUpdateVersion isPrimary(Boolean isPrimary) {
  ...
  public ConfigurationUpdateVersion language(String language) {
  ...
  public ConfigurationUpdateVersion name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ConfigurationUpdateVersion oneSentence(Boolean oneSentence) {
  ...
  public ConfigurationUpdateVersion processHtml(Boolean processHtml) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigurationUpdateVersion configurationUpdateVersion = (ConfigurationUpdateVersion) o;
    return Objects.equals(this.autoResponse, configurationUpdateVersion.autoResponse) &&
        Objects.equals(this.callback, configurationUpdateVersion.callback) &&
        Objects.equals(this.categoriesThreshold, configurationUpdateVersion.categoriesThreshold) &&
        Objects.equals(this.charsThreshold, configurationUpdateVersion.charsThreshold) &&
        Objects.equals(this.collection, configurationUpdateVersion.collection) &&
        Objects.equals(this.configId, configurationUpdateVersion.configId) &&
        Objects.equals(this.document, configurationUpdateVersion.document) &&
        Objects.equals(this.entitiesThreshold, configurationUpdateVersion.entitiesThreshold) &&
        Objects.equals(this.isPrimary, configurationUpdateVersion.isPrimary) &&
        Objects.equals(this.language, configurationUpdateVersion.language) &&
        Objects.equals(this.name, configurationUpdateVersion.name) &&
        Objects.equals(this.oneSentence, configurationUpdateVersion.oneSentence) &&
        Objects.equals(this.processHtml, configurationUpdateVersion.processHtml);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoResponse, callback, categoriesThreshold, charsThreshold, collection, configId, document, entitiesThreshold, isPrimary, language, name, oneSentence, processHtml);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConfigurationUpdateVersion {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfigurationUpdateVersion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfigurationUpdateVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigurationUpdateVersion is not found in the empty JSON string", ConfigurationUpdateVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfigurationUpdateVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfigurationUpdateVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConfigurationUpdateVersion.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigurationUpdateVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigurationUpdateVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigurationUpdateVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigurationUpdateVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigurationUpdateVersion>() {
           @Override
           public void write(JsonWriter out, ConfigurationUpdateVersion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfigurationUpdateVersion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfigurationUpdateVersion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfigurationUpdateVersion
   * @throws IOException if the JSON string is invalid with respect to ConfigurationUpdateVersion
   */
  public static ConfigurationUpdateVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfigurationUpdateVersion.class);
  }

  /**
   * Convert an instance of ConfigurationUpdateVersion to an JSON string
   *
   * @return JSON string
   */
