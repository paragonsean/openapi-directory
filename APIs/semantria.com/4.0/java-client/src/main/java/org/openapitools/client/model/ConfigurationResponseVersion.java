...
public class ConfigurationResponseVersion {
  ...
  public static final String SERIALIZED_NAME_FROM_TEMPLATE_CONFIG_ID = "from_template_config_id";
  @SerializedName(SERIALIZED_NAME_FROM_TEMPLATE_CONFIG_ID)
  private String fromTemplateConfigId;
  ...
  public ConfigurationResponseVersion() {
  }

  public ConfigurationResponseVersion autoResponse(Boolean autoResponse) {
  ...
  public ConfigurationResponseVersion callback(String callback) {
  ...
  public ConfigurationResponseVersion categoriesThreshold(Double categoriesThreshold) {
  ...
  public ConfigurationResponseVersion charsThreshold(Integer charsThreshold) {
  ...
  public ConfigurationResponseVersion collection(ConfigurationCollectionSection collection) {
  ...
  public ConfigurationResponseVersion configId(String configId) {
  ...
  public ConfigurationResponseVersion document(ConfigurationDocumentSection document) {
  ...
  public ConfigurationResponseVersion entitiesThreshold(Integer entitiesThreshold) {
  ...
  public ConfigurationResponseVersion fromTemplateConfigId(String fromTemplateConfigId) {
    this.fromTemplateConfigId = fromTemplateConfigId;
    return this;
  }

  /**
   * Unique identifier of configuration (template) the current configuration has been clonned from
   * @return fromTemplateConfigId
   */
  @javax.annotation.Nonnull
  public String getFromTemplateConfigId() {
    return fromTemplateConfigId;
  }

  public void setFromTemplateConfigId(String fromTemplateConfigId) {
    this.fromTemplateConfigId = fromTemplateConfigId;
  }


  public ConfigurationResponseVersion isPrimary(Boolean isPrimary) {
  ...
  public ConfigurationResponseVersion language(String language) {
  ...
  public ConfigurationResponseVersion modified(String modified) {
  ...
  public ConfigurationResponseVersion name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ConfigurationResponseVersion oneSentence(Boolean oneSentence) {
  ...
  public ConfigurationResponseVersion processHtml(Boolean processHtml) {
  ...
  public ConfigurationResponseVersion version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigurationResponseVersion configurationResponseVersion = (ConfigurationResponseVersion) o;
    return Objects.equals(this.autoResponse, configurationResponseVersion.autoResponse) &&
        Objects.equals(this.callback, configurationResponseVersion.callback) &&
        Objects.equals(this.categoriesThreshold, configurationResponseVersion.categoriesThreshold) &&
        Objects.equals(this.charsThreshold, configurationResponseVersion.charsThreshold) &&
        Objects.equals(this.collection, configurationResponseVersion.collection) &&
        Objects.equals(this.configId, configurationResponseVersion.configId) &&
        Objects.equals(this.document, configurationResponseVersion.document) &&
        Objects.equals(this.entitiesThreshold, configurationResponseVersion.entitiesThreshold) &&
        Objects.equals(this.fromTemplateConfigId, configurationResponseVersion.fromTemplateConfigId) &&
        Objects.equals(this.isPrimary, configurationResponseVersion.isPrimary) &&
        Objects.equals(this.language, configurationResponseVersion.language) &&
        Objects.equals(this.modified, configurationResponseVersion.modified) &&
        Objects.equals(this.name, configurationResponseVersion.name) &&
        Objects.equals(this.oneSentence, configurationResponseVersion.oneSentence) &&
        Objects.equals(this.processHtml, configurationResponseVersion.processHtml) &&
        Objects.equals(this.version, configurationResponseVersion.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoResponse, callback, categoriesThreshold, charsThreshold, collection, configId, document, entitiesThreshold, fromTemplateConfigId, isPrimary, language, modified, name, oneSentence, processHtml, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConfigurationResponseVersion {\n");
    ...
    sb.append("    fromTemplateConfigId: ").append(toIndentedString(fromTemplateConfigId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("from_template_config_id");
    ...
    openapiRequiredFields.add("from_template_config_id");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfigurationResponseVersion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfigurationResponseVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigurationResponseVersion is not found in the empty JSON string", ConfigurationResponseVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfigurationResponseVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfigurationResponseVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConfigurationResponseVersion.openapiRequiredFields) {
      ...
      if (!jsonObj.get("from_template_config_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `from_template_config_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("from_template_config_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigurationResponseVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigurationResponseVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigurationResponseVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigurationResponseVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigurationResponseVersion>() {
           @Override
           public void write(JsonWriter out, ConfigurationResponseVersion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfigurationResponseVersion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfigurationResponseVersion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfigurationResponseVersion
   * @throws IOException if the JSON string is invalid with respect to ConfigurationResponseVersion
   */
  public static ConfigurationResponseVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfigurationResponseVersion.class);
  }

  /**
   * Convert an instance of ConfigurationResponseVersion to an JSON string
   *
   * @return JSON string
   */
