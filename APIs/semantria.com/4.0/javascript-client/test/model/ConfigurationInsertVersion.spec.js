...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Semantria.ConfigurationInsertVersion();
  });
  ...
  describe('ConfigurationInsertVersion', function() {
    it('should create an instance of ConfigurationInsertVersion', function() {
      // uncomment below and update the code to test ConfigurationInsertVersion
      //var instance = new Semantria.ConfigurationInsertVersion();
      //expect(instance).to.be.a(Semantria.ConfigurationInsertVersion);
    });
