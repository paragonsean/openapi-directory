...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Semantria.StatisticConfiguration();
  });
  ...
  describe('StatisticConfiguration', function() {
    it('should create an instance of StatisticConfiguration', function() {
      // uncomment below and update the code to test StatisticConfiguration
      //var instance = new Semantria.StatisticConfiguration();
      //expect(instance).to.be.a(Semantria.StatisticConfiguration);
    });
