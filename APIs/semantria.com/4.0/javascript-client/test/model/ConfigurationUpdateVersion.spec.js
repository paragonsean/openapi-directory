...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Semantria.ConfigurationUpdateVersion();
  });
  ...
  describe('ConfigurationUpdateVersion', function() {
    it('should create an instance of ConfigurationUpdateVersion', function() {
      // uncomment below and update the code to test ConfigurationUpdateVersion
      //var instance = new Semantria.ConfigurationUpdateVersion();
      //expect(instance).to.be.a(Semantria.ConfigurationUpdateVersion);
    });
