...
/**
 * The FeatureTemplateSection model module.
 * @module model/FeatureTemplateSection
 * @version 4.0
 */
class FeatureTemplateSection {
    /**
     * Constructs a new <code>FeatureTemplateSection</code>.
     * @alias module:model/FeatureTemplateSection
     ...
     * @param type {module:model/FeatureTemplateSection.TypeEnum} The type of the vertical pack, can be either \"vertical-pack\" or \"language-default\"
    ...
    constructor(configId, description, id, isFree, language, name, type, version) { 
        ...
        FeatureTemplateSection.initialize(this, configId, description, id, isFree, language, name, type, version);
    }
    ...
    /**
     * Constructs a <code>FeatureTemplateSection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FeatureTemplateSection} obj Optional instance to populate.
     * @return {module:model/FeatureTemplateSection} The populated <code>FeatureTemplateSection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FeatureTemplateSection();
    ...
    /**
     * Validates the JSON data with respect to <code>FeatureTemplateSection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeatureTemplateSection</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FeatureTemplateSection.RequiredProperties) {
...
FeatureTemplateSection.RequiredProperties = ["config_id", "description", "id", "is_free", "language", "name", "type", "version"];

/**
 * Unique identifier of configuration associated with the vertical pack. Required for cloning
 * @member {String} config_id
 */
FeatureTemplateSection.prototype['config_id'] = undefined;

/**
 * Verbal description of template features, belonging to domain area, etc.
 * @member {String} description
 */
FeatureTemplateSection.prototype['description'] = undefined;

/**
 * Unique document identifier. Can be up to 36 alphanumeric characters
 * @member {String} id
 */
FeatureTemplateSection.prototype['id'] = undefined;

/**
 * Shows whether Vertical pack is free or requires subscription
 * @member {Boolean} is_free
 */
FeatureTemplateSection.prototype['is_free'] = undefined;

/**
 * The language supported by the vertical pack
 * @member {String} language
 */
FeatureTemplateSection.prototype['language'] = undefined;

/**
 * Name of the vertical pack
 * @member {String} name
 */
FeatureTemplateSection.prototype['name'] = undefined;

/**
 * The type of the vertical pack, can be either \"vertical-pack\" or \"language-default\"
 * @member {module:model/FeatureTemplateSection.TypeEnum} type
 */
FeatureTemplateSection.prototype['type'] = undefined;

/**
 * Version of the vertical pack, for versioning purposes.
 * @member {String} version
 */
FeatureTemplateSection.prototype['version'] = undefined;
 ...
 * @readonly
 */
FeatureTemplateSection['TypeEnum'] = {
...
export default FeatureTemplateSection;
