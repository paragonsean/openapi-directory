# Semantria.ConfigurationInsertVersion
...
**entitiesThreshold** | **Number** | Defines low threshold for evidence score of named and user entities to be reported in the output. | 
