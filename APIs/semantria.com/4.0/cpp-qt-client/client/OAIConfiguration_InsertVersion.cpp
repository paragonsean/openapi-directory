...
#include "OAIConfiguration_InsertVersion.h"
...
OAIConfiguration_InsertVersion::OAIConfiguration_InsertVersion(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfiguration_InsertVersion::OAIConfiguration_InsertVersion() {
    this->initializeModel();
}

OAIConfiguration_InsertVersion::~OAIConfiguration_InsertVersion() {}

void OAIConfiguration_InsertVersion::initializeModel() {
...
void OAIConfiguration_InsertVersion::fromJson(QString jsonString) {
...
void OAIConfiguration_InsertVersion::fromJsonObject(QJsonObject json) {
...
QString OAIConfiguration_InsertVersion::asJson() const {
...
QJsonObject OAIConfiguration_InsertVersion::asJsonObject() const {
    QJsonObject obj;
...
bool OAIConfiguration_InsertVersion::isAutoResponse() const {
    return m_auto_response;
}
void OAIConfiguration_InsertVersion::setAutoResponse(const bool &auto_response) {
    m_auto_response = auto_response;
    m_auto_response_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_auto_response_Set() const{
    return m_auto_response_isSet;
}

bool OAIConfiguration_InsertVersion::is_auto_response_Valid() const{
    return m_auto_response_isValid;
}

QString OAIConfiguration_InsertVersion::getCallback() const {
    return m_callback;
}
void OAIConfiguration_InsertVersion::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIConfiguration_InsertVersion::is_callback_Valid() const{
    return m_callback_isValid;
}

double OAIConfiguration_InsertVersion::getCategoriesThreshold() const {
    return m_categories_threshold;
}
void OAIConfiguration_InsertVersion::setCategoriesThreshold(const double &categories_threshold) {
    m_categories_threshold = categories_threshold;
    m_categories_threshold_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_categories_threshold_Set() const{
    return m_categories_threshold_isSet;
}

bool OAIConfiguration_InsertVersion::is_categories_threshold_Valid() const{
    return m_categories_threshold_isValid;
}

qint32 OAIConfiguration_InsertVersion::getCharsThreshold() const {
    return m_chars_threshold;
}
void OAIConfiguration_InsertVersion::setCharsThreshold(const qint32 &chars_threshold) {
    m_chars_threshold = chars_threshold;
    m_chars_threshold_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_chars_threshold_Set() const{
    return m_chars_threshold_isSet;
}

bool OAIConfiguration_InsertVersion::is_chars_threshold_Valid() const{
    return m_chars_threshold_isValid;
}

OAIConfigurationCollectionSection OAIConfiguration_InsertVersion::getCollection() const {
    return m_collection;
}
void OAIConfiguration_InsertVersion::setCollection(const OAIConfigurationCollectionSection &collection) {
    m_collection = collection;
    m_collection_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_collection_Set() const{
    return m_collection_isSet;
}

bool OAIConfiguration_InsertVersion::is_collection_Valid() const{
    return m_collection_isValid;
}

OAIConfigurationDocumentSection OAIConfiguration_InsertVersion::getDocument() const {
    return m_document;
}
void OAIConfiguration_InsertVersion::setDocument(const OAIConfigurationDocumentSection &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_document_Set() const{
    return m_document_isSet;
}

bool OAIConfiguration_InsertVersion::is_document_Valid() const{
    return m_document_isValid;
}

qint32 OAIConfiguration_InsertVersion::getEntitiesThreshold() const {
    return m_entities_threshold;
}
void OAIConfiguration_InsertVersion::setEntitiesThreshold(const qint32 &entities_threshold) {
    m_entities_threshold = entities_threshold;
    m_entities_threshold_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_entities_threshold_Set() const{
    return m_entities_threshold_isSet;
}

bool OAIConfiguration_InsertVersion::is_entities_threshold_Valid() const{
    return m_entities_threshold_isValid;
}

bool OAIConfiguration_InsertVersion::isIsPrimary() const {
    return m_is_primary;
}
void OAIConfiguration_InsertVersion::setIsPrimary(const bool &is_primary) {
    m_is_primary = is_primary;
    m_is_primary_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_is_primary_Set() const{
    return m_is_primary_isSet;
}

bool OAIConfiguration_InsertVersion::is_is_primary_Valid() const{
    return m_is_primary_isValid;
}

QString OAIConfiguration_InsertVersion::getLanguage() const {
    return m_language;
}
void OAIConfiguration_InsertVersion::setLanguage(const QString &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_language_Set() const{
    return m_language_isSet;
}

bool OAIConfiguration_InsertVersion::is_language_Valid() const{
    return m_language_isValid;
}

QString OAIConfiguration_InsertVersion::getName() const {
    return m_name;
}
void OAIConfiguration_InsertVersion::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_name_Set() const{
    return m_name_isSet;
}

bool OAIConfiguration_InsertVersion::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIConfiguration_InsertVersion::isOneSentence() const {
    return m_one_sentence;
}
void OAIConfiguration_InsertVersion::setOneSentence(const bool &one_sentence) {
    m_one_sentence = one_sentence;
    m_one_sentence_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_one_sentence_Set() const{
    return m_one_sentence_isSet;
}

bool OAIConfiguration_InsertVersion::is_one_sentence_Valid() const{
    return m_one_sentence_isValid;
}

bool OAIConfiguration_InsertVersion::isProcessHtml() const {
    return m_process_html;
}
void OAIConfiguration_InsertVersion::setProcessHtml(const bool &process_html) {
    m_process_html = process_html;
    m_process_html_isSet = true;
}

bool OAIConfiguration_InsertVersion::is_process_html_Set() const{
    return m_process_html_isSet;
}

bool OAIConfiguration_InsertVersion::is_process_html_Valid() const{
    return m_process_html_isValid;
}

bool OAIConfiguration_InsertVersion::isSet() const {
...
bool OAIConfiguration_InsertVersion::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_auto_response_isValid && m_callback_isValid && m_categories_threshold_isValid && m_chars_threshold_isValid && m_collection_isValid && m_document_isValid && m_entities_threshold_isValid && m_is_primary_isValid && m_language_isValid && m_name_isValid && m_one_sentence_isValid && m_process_html_isValid && true;
}
