...
namespace OpenAPI {
class OAIStatisticConfiguration;

class OAIStatistic : public OAIObject {
public:
    OAIStatistic();
    ...
    qint32 getCollsDocuments() const;
    void setCollsDocuments(const qint32 &colls_documents);
    bool is_colls_documents_Set() const;
    bool is_colls_documents_Valid() const;
    ...
    QList<OAIStatisticConfiguration> getConfigurations() const;
    void setConfigurations(const QList<OAIStatisticConfiguration> &configurations);
...
private:
    ...
    qint32 m_colls_documents;
    bool m_colls_documents_isSet;
    bool m_colls_documents_isValid;
    ...
    QList<OAIStatisticConfiguration> m_configurations;
