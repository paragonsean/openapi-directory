...
public:
    ...
    */
    virtual void getStatus(const QString &content_type);
...
Q_SIGNALS:
    ...
    void getStatusSignal(OAIStatus summary);


    void getStatusSignalFull(OAIHttpRequestWorker *worker, OAIStatus summary);

    Q_DECL_DEPRECATED_X("Use getStatusSignalError() instead")
    void getStatusSignalE(OAIStatus summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getStatusSignalError(OAIStatus summary, QNetworkReply::NetworkError error_type, const QString &error_str);
