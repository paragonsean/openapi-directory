...
void OAIAuthApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("authOauthTokenPost", defaultConf);
    _serverIndices.insert("authOauthTokenPost", 0);
}
...
void OAIAuthApi::authOauthTokenPost(const QString &client_id, const QString &client_secret, const QString &grant_type, const QString &scope) {
    QString fullPath = QString(_serverConfigs["authOauthTokenPost"][_serverIndices.value("authOauthTokenPost")].URL()+"/auth/oauth/token");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthApi::authOauthTokenPostCallback);
...
void OAIAuthApi::authOauthTokenPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT authOauthTokenPostSignal();
        Q_EMIT authOauthTokenPostSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT authOauthTokenPostSignalE(error_type, error_str);
        Q_EMIT authOauthTokenPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT authOauthTokenPostSignalError(error_type, error_str);
        Q_EMIT authOauthTokenPostSignalErrorFull(worker, error_type, error_str);
    }
}
