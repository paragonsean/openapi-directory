...
public class ExternalLink {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, externalLink.description) &&
        Objects.equals(this.linkType, externalLink.linkType) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExternalLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExternalLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExternalLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExternalLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
