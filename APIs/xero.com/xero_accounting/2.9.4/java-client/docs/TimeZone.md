...
* `CENTRALSTANDARDTIME_MEXICO_` (value: `"CENTRALSTANDARDTIME(MEXICO)"`)

* `CANADACENTRALSTANDARDTIME` (value: `"CANADACENTRALSTANDARDTIME"`)

* `USMOUNTAINSTANDARDTIME` (value: `"USMOUNTAINSTANDARDTIME"`)

* `MOUNTAINSTANDARDTIME_MEXICO_` (value: `"MOUNTAINSTANDARDTIME(MEXICO)"`)

* `MOUNTAINSTANDARDTIME` (value: `"MOUNTAINSTANDARDTIME"`)

* `PACIFICSTANDARDTIME_MEXICO_` (value: `"PACIFICSTANDARDTIME(MEXICO)"`)
