...
|**contactID** | **UUID** | Xero identifier |  [optional] |
...
|**contactStatus** | [**ContactStatusEnum**](#ContactStatusEnum) | Current status of a contact – see contact status types |  [optional] |
...
|**hasAttachments** | **Boolean** | A boolean to indicate if a contact has an attachment |  [optional] |
