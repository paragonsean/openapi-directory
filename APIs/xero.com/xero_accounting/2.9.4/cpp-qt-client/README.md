...
void Example::exampleFunction1(){
     OAIAccountingApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAccountingApi::createAccountSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAccountingApi::createAccountSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAccount oai_account = create(); // OAIAccount | Account object in body of request
      apiInstance.createAccount(xero_tenant_idoai_account);
