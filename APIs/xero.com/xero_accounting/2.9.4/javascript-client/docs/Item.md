...
**quantityOnHand** | **Number** | The quantity of the item on hand | [optional] 
**salesDetails** | [**Purchase**](Purchase.md) |  | [optional] 
**statusAttributeString** | **String** | Status of object | [optional] 
**totalCostPool** | **Number** | The value of the item on hand. Calculated using average cost accounting. | [optional] 
