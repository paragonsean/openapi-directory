...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroAccountingApi.Prepayment();
  });
  ...
  describe('Prepayment', function() {
    it('should create an instance of Prepayment', function() {
      // uncomment below and update the code to test Prepayment
      //var instance = new XeroAccountingApi.Prepayment();
      //expect(instance).to.be.a(XeroAccountingApi.Prepayment);
    });
