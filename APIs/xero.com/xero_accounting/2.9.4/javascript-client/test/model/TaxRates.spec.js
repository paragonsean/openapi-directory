...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroAccountingApi.TaxRates();
  });
  ...
  describe('TaxRates', function() {
    it('should create an instance of TaxRates', function() {
      // uncomment below and update the code to test TaxRates
      //var instance = new XeroAccountingApi.TaxRates();
      //expect(instance).to.be.a(XeroAccountingApi.TaxRates);
    });
