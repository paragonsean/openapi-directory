...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroAccountingApi.BalanceDetails();
  });
  ...
  describe('BalanceDetails', function() {
    it('should create an instance of BalanceDetails', function() {
      ...
      //var instance = new XeroAccountingApi.BalanceDetails();
      //expect(instance).to.be.a(XeroAccountingApi.BalanceDetails);
    });
