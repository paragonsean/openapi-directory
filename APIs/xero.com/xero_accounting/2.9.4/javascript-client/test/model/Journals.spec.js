...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroAccountingApi.Journals();
  });
  ...
  describe('Journals', function() {
    it('should create an instance of Journals', function() {
      // uncomment below and update the code to test Journals
      //var instance = new XeroAccountingApi.Journals();
      //expect(instance).to.be.a(XeroAccountingApi.Journals);
    });
