...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroAccountingApi.ManualJournalLine();
  });
  ...
  describe('ManualJournalLine', function() {
    it('should create an instance of ManualJournalLine', function() {
      // uncomment below and update the code to test ManualJournalLine
      //var instance = new XeroAccountingApi.ManualJournalLine();
      //expect(instance).to.be.a(XeroAccountingApi.ManualJournalLine);
    });
    ...
    it('should have the property isBlank (base name: "IsBlank")', function() {
      // uncomment below and update the code to test the property isBlank
      //var instance = new XeroAccountingApi.ManualJournalLine();
      //expect(instance).to.be();
    });
