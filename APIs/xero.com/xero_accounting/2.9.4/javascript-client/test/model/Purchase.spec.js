...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroAccountingApi.Purchase();
  });
  ...
  describe('Purchase', function() {
    it('should create an instance of Purchase', function() {
      ...
      //var instance = new XeroAccountingApi.Purchase();
      //expect(instance).to.be.a(XeroAccountingApi.Purchase);
    });
    ...
    it('should have the property cOGSAccountCode (base name: "COGSAccountCode")', function() {
      // uncomment below and update the code to test the property cOGSAccountCode
      //var instance = new XeroAccountingApi.Purchase();
      //expect(instance).to.be();
    });
