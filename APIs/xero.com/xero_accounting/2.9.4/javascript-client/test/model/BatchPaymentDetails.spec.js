...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroAccountingApi.BatchPaymentDetails();
  });
  ...
  describe('BatchPaymentDetails', function() {
    it('should create an instance of BatchPaymentDetails', function() {
      // uncomment below and update the code to test BatchPaymentDetails
      //var instance = new XeroAccountingApi.BatchPaymentDetails();
      //expect(instance).to.be.a(XeroAccountingApi.BatchPaymentDetails);
    });
