...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroAccountingApi.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new XeroAccountingApi.ValidationError();
      //expect(instance).to.be.a(XeroAccountingApi.ValidationError);
    });
