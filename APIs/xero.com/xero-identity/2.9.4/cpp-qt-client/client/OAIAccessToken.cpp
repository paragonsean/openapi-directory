...
double OAIAccessToken::getExpiresIn() const {
    return m_expires_in;
}
void OAIAccessToken::setExpiresIn(const double &expires_in) {
    m_expires_in = expires_in;
    m_expires_in_isSet = true;
}

bool OAIAccessToken::is_expires_in_Set() const{
    return m_expires_in_isSet;
}

bool OAIAccessToken::is_expires_in_Valid() const{
    return m_expires_in_isValid;
}

QString OAIAccessToken::getIdToken() const {
    return m_id_token;
}
void OAIAccessToken::setIdToken(const QString &id_token) {
    m_id_token = id_token;
    m_id_token_isSet = true;
}

bool OAIAccessToken::is_id_token_Set() const{
    return m_id_token_isSet;
}

bool OAIAccessToken::is_id_token_Valid() const{
    return m_id_token_isValid;
}

QString OAIAccessToken::getRefreshToken() const {
    return m_refresh_token;
}
void OAIAccessToken::setRefreshToken(const QString &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAIAccessToken::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAIAccessToken::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

QString OAIAccessToken::getTokenType() const {
    return m_token_type;
}
void OAIAccessToken::setTokenType(const QString &token_type) {
    m_token_type = token_type;
    m_token_type_isSet = true;
}

bool OAIAccessToken::is_token_type_Set() const{
    return m_token_type_isSet;
}

bool OAIAccessToken::is_token_type_Valid() const{
