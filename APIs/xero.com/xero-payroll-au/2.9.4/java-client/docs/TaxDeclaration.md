...
|------------ | ------------- | ------------- | -------------|
|**approvedWithholdingVariationPercentage** | **BigDecimal** | If the employee has approved withholding variation. e.g (0 - 100) |  [optional] |
...
|**employeeID** | **UUID** | Address line 1 for employee home address |  [optional] |
|**employmentBasis** | **EmploymentBasis** |  |  [optional] |
...
|**residencyStatus** | **ResidencyStatus** |  |  [optional] |
|**tfNExemptionType** | **TFNExemptionType** |  |  [optional] |
...
|**taxOffsetEstimatedAmount** | **BigDecimal** | If has tax offset estimated then the tax offset estimated amount. e.g 100 |  [optional] |
|**updatedDateUTC** | **String** | Last modified timestamp |  [optional] [readonly] |
|**upwardVariationTaxWithholdingAmount** | **BigDecimal** | If the employee has requested that additional tax be withheld each pay run. e.g 50 |  [optional] |
