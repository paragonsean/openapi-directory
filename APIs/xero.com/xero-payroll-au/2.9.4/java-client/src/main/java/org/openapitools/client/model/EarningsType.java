 ...
 */
@JsonAdapter(EarningsType.Adapter.class)
public enum EarningsType {
  ...
  public static class Adapter extends TypeAdapter<EarningsType> {
    @Override
    public void write(final JsonWriter jsonWriter, final EarningsType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EarningsType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EarningsType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EarningsType.fromValue(value);
  }
}
