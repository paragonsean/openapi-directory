...
public class ApiClient {
    ...
    private String basePath = "https://api.xero.com/payroll.xro/1.0";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.9.4/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.xero.com/payroll.xro/1.0
