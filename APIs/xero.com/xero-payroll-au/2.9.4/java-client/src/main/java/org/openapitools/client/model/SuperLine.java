...
public class SuperLine {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, superLine.amount) &&
        ...
        Objects.equals(this.superMembershipID, superLine.superMembershipID);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, calculationType, contributionType, expenseAccountCode, liabilityAccountCode, minimumMonthlyEarnings, percentage, superMembershipID);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SuperLine
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuperLine.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SuperLine is not found in the empty JSON string", SuperLine.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SuperLine.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SuperLine` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SuperLine.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SuperLine' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SuperLine> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SuperLine.class));

       return (TypeAdapter<T>) new TypeAdapter<SuperLine>() {
           @Override
           public void write(JsonWriter out, SuperLine value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SuperLine read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SuperLine given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SuperLine
   * @throws IOException if the JSON string is invalid with respect to SuperLine
   */
  public static SuperLine fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SuperLine.class);
  }

  /**
   * Convert an instance of SuperLine to an JSON string
   *
   * @return JSON string
   */
