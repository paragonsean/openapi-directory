...
/**
 * The SuperannuationLine model module.
 * @module model/SuperannuationLine
 * @version 2.9.4
 */
class SuperannuationLine {
    /**
     * Constructs a new <code>SuperannuationLine</code>.
     * @alias module:model/SuperannuationLine
     */
    constructor() { 
        
        SuperannuationLine.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SuperannuationLine</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SuperannuationLine} obj Optional instance to populate.
     * @return {module:model/SuperannuationLine} The populated <code>SuperannuationLine</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SuperannuationLine();
            ...
            if (data.hasOwnProperty('PaymentDateForThisPeriod')) {
                obj['PaymentDateForThisPeriod'] = ApiClient.convertToType(data['PaymentDateForThisPeriod'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SuperannuationLine</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SuperannuationLine</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['PaymentDateForThisPeriod'] && !(typeof data['PaymentDateForThisPeriod'] === 'string' || data['PaymentDateForThisPeriod'] instanceof String)) {
            throw new Error("Expected the field `PaymentDateForThisPeriod` to be a primitive type in the JSON string but got " + data['PaymentDateForThisPeriod']);
        }
        // ensure the json data is a string
 ...
 */
SuperannuationLine.prototype['Amount'] = undefined;

/**
 * @member {module:model/SuperannuationCalculationType} CalculationType
 */
SuperannuationLine.prototype['CalculationType'] = undefined;

/**
 * @member {module:model/SuperannuationContributionType} ContributionType
 */
SuperannuationLine.prototype['ContributionType'] = undefined;

/**
 * Superannuation expense account code.
 * @member {String} ExpenseAccountCode
 */
SuperannuationLine.prototype['ExpenseAccountCode'] = undefined;

/**
 * Superannuation liability account code
 * @member {String} LiabilityAccountCode
 */
SuperannuationLine.prototype['LiabilityAccountCode'] = undefined;

/**
 * Superannuation minimum monthly earnings.
 * @member {Number} MinimumMonthlyEarnings
 */
SuperannuationLine.prototype['MinimumMonthlyEarnings'] = undefined;

/**
 * Superannuation payment date for the current period (YYYY-MM-DD)
 * @member {String} PaymentDateForThisPeriod
 */
SuperannuationLine.prototype['PaymentDateForThisPeriod'] = undefined;

/**
 * Superannuation percentage
 * @member {Number} Percentage
 */
SuperannuationLine.prototype['Percentage'] = undefined;

/**
 * Xero identifier for payroll super fund membership ID.
 * @member {String} SuperMembershipID
 */
SuperannuationLine.prototype['SuperMembershipID'] = undefined;
...
export default SuperannuationLine;
