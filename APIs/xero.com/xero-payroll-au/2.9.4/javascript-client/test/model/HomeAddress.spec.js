...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroPayrollAuApi.HomeAddress();
  });
  ...
  describe('HomeAddress', function() {
    it('should create an instance of HomeAddress', function() {
      // uncomment below and update the code to test HomeAddress
      //var instance = new XeroPayrollAuApi.HomeAddress();
      //expect(instance).to.be.a(XeroPayrollAuApi.HomeAddress);
    });
