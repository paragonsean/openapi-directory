...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroPayrollAuApi.Timesheets();
  });
  ...
  describe('Timesheets', function() {
    it('should create an instance of Timesheets', function() {
      // uncomment below and update the code to test Timesheets
      //var instance = new XeroPayrollAuApi.Timesheets();
      //expect(instance).to.be.a(XeroPayrollAuApi.Timesheets);
    });
