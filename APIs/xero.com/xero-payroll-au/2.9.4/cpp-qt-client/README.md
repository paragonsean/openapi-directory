...
#include <iostream>
#include "../client/OAIPayrollAuApi.h"
...
QString Example::create(){
    QString obj;
QList&lt;OAIEmployee&gt; Example::create(){
    QList<OAIEmployee> obj;
 return obj;
}

void Example::exampleFunction1(){
     OAIPayrollAuApi apiInstance;
     
      //OAuth Authentication supported right now

      QEventLoop loop;
      connect(&apiInstance, &OAIPayrollAuApi::createEmployeeSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIPayrollAuApi::createEmployeeSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      QList<OAIEmployee> oai_employee = create(); // QList<OAIEmployee> | 
      apiInstance.createEmployee(xero_tenant_idoai_employee);
