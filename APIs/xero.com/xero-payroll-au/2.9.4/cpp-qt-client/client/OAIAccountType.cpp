...
void OAIAccountType::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("WAGESPAYABLELIABILITY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountType::WAGESPAYABLELIABILITY;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIAccountType::asJson() const {
    ...
    switch (m_value){
        ...
        case eOAIAccountType::WAGESEXPENSE:
            val = "WAGESEXPENSE";
            break;
        case eOAIAccountType::WAGESPAYABLELIABILITY:
            val = "WAGESPAYABLELIABILITY";
            break;
        default:
            break;
    }
