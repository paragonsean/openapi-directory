...
#ifndef OAIPayTemplate_H
#define OAIPayTemplate_H
...
class OAIPayTemplate : public OAIObject {
public:
    OAIPayTemplate();
    OAIPayTemplate(QString json);
    ~OAIPayTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayTemplate)

#endif // OAIPayTemplate_H
