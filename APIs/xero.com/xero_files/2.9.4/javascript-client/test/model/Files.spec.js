...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new XeroFilesApi.Files();
  });
  ...
  describe('Files', function() {
    it('should create an instance of Files', function() {
      // uncomment below and update the code to test Files
      //var instance = new XeroFilesApi.Files();
      //expect(instance).to.be.a(XeroFilesApi.Files);
    });
