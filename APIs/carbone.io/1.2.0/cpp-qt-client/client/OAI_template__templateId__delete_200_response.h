...
/*
 * OAI_template__templateId__delete_200_response.h
 *
 * 
 */

#ifndef OAI_template__templateId__delete_200_response_H
#define OAI_template__templateId__delete_200_response_H
...
class OAI_template__templateId__delete_200_response : public OAIObject {
public:
    OAI_template__templateId__delete_200_response();
    OAI_template__templateId__delete_200_response(QString json);
    ~OAI_template__templateId__delete_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_template__templateId__delete_200_response)

#endif // OAI_template__templateId__delete_200_response_H
