...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarboneApi.TemplateApi();
  });
  ...
  describe('TemplateApi', function() {
    describe('templatePost', function() {
      it('should call templatePost successfully', function(done) {
        //uncomment below and update the code to test templatePost
        //instance.templatePost(function(error) {
    ...
    describe('templateTemplateIdDelete', function() {
      it('should call templateTemplateIdDelete successfully', function(done) {
        //uncomment below and update the code to test templateTemplateIdDelete
        //instance.templateTemplateIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('templateTemplateIdGet', function() {
      it('should call templateTemplateIdGet successfully', function(done) {
        //uncomment below and update the code to test templateTemplateIdGet
        //instance.templateTemplateIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
