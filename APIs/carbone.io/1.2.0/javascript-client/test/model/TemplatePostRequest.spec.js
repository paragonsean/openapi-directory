...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarboneApi.TemplatePostRequest();
  });
  ...
  describe('TemplatePostRequest', function() {
    it('should create an instance of TemplatePostRequest', function() {
      // uncomment below and update the code to test TemplatePostRequest
      //var instance = new CarboneApi.TemplatePostRequest();
      //expect(instance).to.be.a(CarboneApi.TemplatePostRequest);
    });
