...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarboneApi.RenderTemplateIdPost200Response();
  });
  ...
  describe('RenderTemplateIdPost200Response', function() {
    it('should create an instance of RenderTemplateIdPost200Response', function() {
      // uncomment below and update the code to test RenderTemplateIdPost200Response
      //var instance = new CarboneApi.RenderTemplateIdPost200Response();
      //expect(instance).to.be.a(CarboneApi.RenderTemplateIdPost200Response);
    });
