...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarboneApi.RenderTemplateIdPost200ResponseData();
  });
  ...
  describe('RenderTemplateIdPost200ResponseData', function() {
    it('should create an instance of RenderTemplateIdPost200ResponseData', function() {
      // uncomment below and update the code to test RenderTemplateIdPost200ResponseData
      //var instance = new CarboneApi.RenderTemplateIdPost200ResponseData();
      //expect(instance).to.be.a(CarboneApi.RenderTemplateIdPost200ResponseData);
    });
