...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarboneApi.TemplateTemplateIdDelete200Response();
  });
  ...
  describe('TemplateTemplateIdDelete200Response', function() {
    it('should create an instance of TemplateTemplateIdDelete200Response', function() {
      // uncomment below and update the code to test TemplateTemplateIdDelete200Response
      //var instance = new CarboneApi.TemplateTemplateIdDelete200Response();
      //expect(instance).to.be.a(CarboneApi.TemplateTemplateIdDelete200Response);
    });
