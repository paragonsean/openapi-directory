...
void OAIAuthenticationApi::loginPost(const OAISample_1 &oai_sample_1) {
...

    {
        ...
        QByteArray output = oai_sample_1.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationApi::loginPostCallback);
...
void OAIAuthenticationApi::loginPostCallback(OAIHttpRequestWorker *worker) {
...
void OAIAuthenticationApi::logoutPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT logoutPostSignal();
        Q_EMIT logoutPostSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT logoutPostSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT logoutPostSignalError(error_type, error_str);
