...
#ifndef OAIUserRecord_H
#define OAIUserRecord_H
...
class OAIUserRecord : public OAIObject {
public:
    OAIUserRecord();
    OAIUserRecord(QString json);
    ~OAIUserRecord() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserRecord)

#endif // OAIUserRecord_H
