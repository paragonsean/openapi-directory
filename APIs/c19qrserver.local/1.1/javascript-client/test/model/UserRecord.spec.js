...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiForTheCovid19TrackingQrCodeSigninServer.UserRecord();
  });
  ...
  describe('UserRecord', function() {
    it('should create an instance of UserRecord', function() {
      ...
      //var instance = new ApiForTheCovid19TrackingQrCodeSigninServer.UserRecord();
      //expect(instance).to.be.a(ApiForTheCovid19TrackingQrCodeSigninServer.UserRecord);
    });
