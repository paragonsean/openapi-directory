...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiForTheCovid19TrackingQrCodeSigninServer.Signin();
  });
  ...
  describe('Signin', function() {
    it('should create an instance of Signin', function() {
      // uncomment below and update the code to test Signin
      //var instance = new ApiForTheCovid19TrackingQrCodeSigninServer.Signin();
      //expect(instance).to.be.a(ApiForTheCovid19TrackingQrCodeSigninServer.Signin);
    });
