...
public class ApiClient {
    ...
    private String basePath = "http://c19qrserver.local";
    ...
    public ApiClient() {
        ...
        authentications.put("TokenHeader", new ApiKeyAuth("header", "token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://c19qrserver.local
