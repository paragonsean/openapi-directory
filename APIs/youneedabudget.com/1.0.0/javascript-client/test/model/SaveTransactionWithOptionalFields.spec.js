...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YnabApiEndpoints.SaveTransactionWithOptionalFields();
  });
  ...
  describe('SaveTransactionWithOptionalFields', function() {
    it('should create an instance of SaveTransactionWithOptionalFields', function() {
      // uncomment below and update the code to test SaveTransactionWithOptionalFields
      //var instance = new YnabApiEndpoints.SaveTransactionWithOptionalFields();
      //expect(instance).to.be.a(YnabApiEndpoints.SaveTransactionWithOptionalFields);
    });
