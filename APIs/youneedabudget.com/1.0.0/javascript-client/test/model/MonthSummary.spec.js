...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YnabApiEndpoints.MonthSummary();
  });
  ...
  describe('MonthSummary', function() {
    it('should create an instance of MonthSummary', function() {
      // uncomment below and update the code to test MonthSummary
      //var instance = new YnabApiEndpoints.MonthSummary();
      //expect(instance).to.be.a(YnabApiEndpoints.MonthSummary);
    });
