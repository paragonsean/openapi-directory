...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YnabApiEndpoints.PostTransactionsWrapper();
  });
  ...
  describe('PostTransactionsWrapper', function() {
    it('should create an instance of PostTransactionsWrapper', function() {
      // uncomment below and update the code to test PostTransactionsWrapper
      //var instance = new YnabApiEndpoints.PostTransactionsWrapper();
      //expect(instance).to.be.a(YnabApiEndpoints.PostTransactionsWrapper);
    });
