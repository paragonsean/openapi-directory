...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YnabApiEndpoints.SaveTransaction();
  });
  ...
  describe('SaveTransaction', function() {
    it('should create an instance of SaveTransaction', function() {
      // uncomment below and update the code to test SaveTransaction
      //var instance = new YnabApiEndpoints.SaveTransaction();
      //expect(instance).to.be.a(YnabApiEndpoints.SaveTransaction);
    });
