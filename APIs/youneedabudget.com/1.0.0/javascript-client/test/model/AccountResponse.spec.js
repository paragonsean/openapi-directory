...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YnabApiEndpoints.AccountResponse();
  });
  ...
  describe('AccountResponse', function() {
    it('should create an instance of AccountResponse', function() {
      ...
      //var instance = new YnabApiEndpoints.AccountResponse();
      //expect(instance).to.be.a(YnabApiEndpoints.AccountResponse);
    });
