...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YnabApiEndpoints.TransactionResponse();
  });
  ...
  describe('TransactionResponse', function() {
    it('should create an instance of TransactionResponse', function() {
      ...
      //var instance = new YnabApiEndpoints.TransactionResponse();
      //expect(instance).to.be.a(YnabApiEndpoints.TransactionResponse);
    });
