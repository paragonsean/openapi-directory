...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YnabApiEndpoints.AccountsResponse();
  });
  ...
  describe('AccountsResponse', function() {
    it('should create an instance of AccountsResponse', function() {
      ...
      //var instance = new YnabApiEndpoints.AccountsResponse();
      //expect(instance).to.be.a(YnabApiEndpoints.AccountsResponse);
    });
