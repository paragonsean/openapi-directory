...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YnabApiEndpoints.SubTransaction();
  });
  ...
  describe('SubTransaction', function() {
    it('should create an instance of SubTransaction', function() {
      // uncomment below and update the code to test SubTransaction
      //var instance = new YnabApiEndpoints.SubTransaction();
      //expect(instance).to.be.a(YnabApiEndpoints.SubTransaction);
    });
