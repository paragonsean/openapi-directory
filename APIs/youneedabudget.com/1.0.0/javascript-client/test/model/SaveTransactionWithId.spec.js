...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YnabApiEndpoints.SaveTransactionWithId();
  });
  ...
  describe('SaveTransactionWithId', function() {
    it('should create an instance of SaveTransactionWithId', function() {
      // uncomment below and update the code to test SaveTransactionWithId
      //var instance = new YnabApiEndpoints.SaveTransactionWithId();
      //expect(instance).to.be.a(YnabApiEndpoints.SaveTransactionWithId);
    });
