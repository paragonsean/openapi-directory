...
/**
 * The SaveTransaction model module.
 * @module model/SaveTransaction
 * @version 1.0.0
 */
class SaveTransaction {
    /**
     * Constructs a new <code>SaveTransaction</code>.
     * @alias module:model/SaveTransaction
     * @implements module:model/SaveTransactionWithOptionalFields
     * @param accountId {String} 
     * @param amount {Number} The transaction amount in milliunits format.  Split transaction amounts cannot be changed and if a different amount is supplied it will be ignored.
     * @param date {Date} The transaction date in ISO format (e.g. 2016-12-01).  Future dates (scheduled transactions) are not permitted.  Split transaction dates cannot be changed and if a different date is supplied it will be ignored.
     */
    constructor(accountId, amount, date) { 
        SaveTransactionWithOptionalFields.initialize(this);
        SaveTransaction.initialize(this, accountId, amount, date);
    }
     ...
     */
    static initialize(obj, accountId, amount, date) { 
    ...
    /**
     * Constructs a <code>SaveTransaction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SaveTransaction} obj Optional instance to populate.
     * @return {module:model/SaveTransaction} The populated <code>SaveTransaction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SaveTransaction();
    ...
    /**
     * Validates the JSON data with respect to <code>SaveTransaction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SaveTransaction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SaveTransaction.RequiredProperties) {
...
SaveTransaction.RequiredProperties = ["account_id", "amount", "date"];

/**
 * @member {String} account_id
 */
SaveTransaction.prototype['account_id'] = undefined;

/**
 * The transaction amount in milliunits format.  Split transaction amounts cannot be changed and if a different amount is supplied it will be ignored.
 * @member {Number} amount
 */
SaveTransaction.prototype['amount'] = undefined;

/**
 * Whether or not the transaction is approved.  If not supplied, transaction will be unapproved by default.
 * @member {Boolean} approved
 */
SaveTransaction.prototype['approved'] = undefined;

/**
 * The category for the transaction.  To configure a split transaction, you can specify null for `category_id` and provide a `subtransactions` array as part of the transaction object.  If an existing transaction is a split, the `category_id` cannot be changed.  Credit Card Payment categories are not permitted and will be ignored if supplied.
 * @member {String} category_id
 */
SaveTransaction.prototype['category_id'] = undefined;

/**
 * The cleared status of the transaction
 * @member {module:model/SaveTransaction.ClearedEnum} cleared
 */
SaveTransaction.prototype['cleared'] = undefined;

/**
 * The transaction date in ISO format (e.g. 2016-12-01).  Future dates (scheduled transactions) are not permitted.  Split transaction dates cannot be changed and if a different date is supplied it will be ignored.
 * @member {Date} date
 */
SaveTransaction.prototype['date'] = undefined;

/**
 * The transaction flag
 * @member {module:model/SaveTransaction.FlagColorEnum} flag_color
 */
SaveTransaction.prototype['flag_color'] = undefined;
