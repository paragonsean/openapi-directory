...
import AccountResponseData from './AccountResponseData';
...
class AccountResponse {
     ...
     * @param data {module:model/AccountResponseData} 
     */
    constructor(data) { 
        
        AccountResponse.initialize(this, data);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = AccountResponseData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          AccountResponseData.validateJSON(data['data']);
        }
...
AccountResponse.RequiredProperties = ["data"];

/**
 * @member {module:model/AccountResponseData} data
 */
