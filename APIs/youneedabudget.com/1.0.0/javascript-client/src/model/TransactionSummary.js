...
class TransactionSummary {
     ...
     * @param cleared {module:model/TransactionSummary.ClearedEnum} The cleared status of the transaction
     ...
     * @param id {String} 
     */
    constructor(accountId, amount, approved, cleared, date, deleted, id) { 
     ...
     */
    static initialize(obj, accountId, amount, approved, cleared, date, deleted, id) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of TransactionSummary.RequiredProperties) {
...
TransactionSummary.RequiredProperties = ["account_id", "amount", "approved", "cleared", "date", "deleted", "id"];
 ...
 * @readonly
 */
TransactionSummary['ClearedEnum'] = {
 ...
 * @readonly
 */
TransactionSummary['DebtTransactionTypeEnum'] = {
 ...
 * @readonly
 */
TransactionSummary['FlagColorEnum'] = {
