...
/**
 * The SaveTransactionWithOptionalFields model module.
 * @module model/SaveTransactionWithOptionalFields
 * @version 1.0.0
 */
class SaveTransactionWithOptionalFields {
    /**
     * Constructs a new <code>SaveTransactionWithOptionalFields</code>.
     * @alias module:model/SaveTransactionWithOptionalFields
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SaveTransactionWithOptionalFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SaveTransactionWithOptionalFields} obj Optional instance to populate.
     * @return {module:model/SaveTransactionWithOptionalFields} The populated <code>SaveTransactionWithOptionalFields</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SaveTransactionWithOptionalFields();
    ...
    /**
     * Validates the JSON data with respect to <code>SaveTransactionWithOptionalFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SaveTransactionWithOptionalFields</code>.
     */
 ...
 * @readonly
 */
SaveTransactionWithOptionalFields['ClearedEnum'] = {
 ...
 * @readonly
 */
SaveTransactionWithOptionalFields['FlagColorEnum'] = {
...
export default SaveTransactionWithOptionalFields;
