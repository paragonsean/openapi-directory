...
/*
 * OAITransactionSummary.h
 *
 * 
 */

#ifndef OAITransactionSummary_H
#define OAITransactionSummary_H
...
class OAITransactionSummary : public OAIObject {
public:
    OAITransactionSummary();
    OAITransactionSummary(QString json);
    ~OAITransactionSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionSummary)

#endif // OAITransactionSummary_H
