...
/*
 * OAIScheduledSubTransaction.h
 *
 * 
 */

#ifndef OAIScheduledSubTransaction_H
#define OAIScheduledSubTransaction_H
...
class OAIScheduledSubTransaction : public OAIObject {
public:
    OAIScheduledSubTransaction();
    OAIScheduledSubTransaction(QString json);
    ~OAIScheduledSubTransaction() override;
    ...
    QString getScheduledTransactionId() const;
    void setScheduledTransactionId(const QString &scheduled_transaction_id);
    bool is_scheduled_transaction_id_Set() const;
    bool is_scheduled_transaction_id_Valid() const;
...
private:
    ...
    QString m_scheduled_transaction_id;
    bool m_scheduled_transaction_id_isSet;
    bool m_scheduled_transaction_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduledSubTransaction)

#endif // OAIScheduledSubTransaction_H
