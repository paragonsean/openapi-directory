...
/*
 * OAITransactionDetail.h
 *
 * 
 */

#ifndef OAITransactionDetail_H
#define OAITransactionDetail_H
...
class OAITransactionDetail : public OAIObject {
public:
    OAITransactionDetail();
    OAITransactionDetail(QString json);
    ~OAITransactionDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionDetail)

#endif // OAITransactionDetail_H
