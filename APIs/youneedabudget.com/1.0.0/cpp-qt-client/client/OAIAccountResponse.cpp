...
OAIAccountResponse_data OAIAccountResponse::getData() const {
    return m_data;
}
void OAIAccountResponse::setData(const OAIAccountResponse_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIAccountResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIAccountResponse::is_data_Valid() const{
