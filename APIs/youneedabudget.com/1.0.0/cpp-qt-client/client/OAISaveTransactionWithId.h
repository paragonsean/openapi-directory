...
/*
 * OAISaveTransactionWithId.h
 *
 * 
 */

#ifndef OAISaveTransactionWithId_H
#define OAISaveTransactionWithId_H
...
class OAISaveTransactionWithId : public OAIObject {
public:
    OAISaveTransactionWithId();
    OAISaveTransactionWithId(QString json);
    ~OAISaveTransactionWithId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISaveTransactionWithId)

#endif // OAISaveTransactionWithId_H
