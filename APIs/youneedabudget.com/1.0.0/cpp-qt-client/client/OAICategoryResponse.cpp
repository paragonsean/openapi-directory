...
OAICategoryResponse_data OAICategoryResponse::getData() const {
    return m_data;
}
void OAICategoryResponse::setData(const OAICategoryResponse_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICategoryResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAICategoryResponse::is_data_Valid() const{
