...
/*
 * OAISaveTransactionWithOptionalFields.h
 *
 * 
 */

#ifndef OAISaveTransactionWithOptionalFields_H
#define OAISaveTransactionWithOptionalFields_H
...
class OAISaveTransactionWithOptionalFields : public OAIObject {
public:
    OAISaveTransactionWithOptionalFields();
    OAISaveTransactionWithOptionalFields(QString json);
    ~OAISaveTransactionWithOptionalFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISaveTransactionWithOptionalFields)

#endif // OAISaveTransactionWithOptionalFields_H
