...
public class Example {
  public static void main(String[] args) {
    ...
    PostTransactionsWrapper postTransactionsWrapper = new PostTransactionsWrapper(); // PostTransactionsWrapper | The transaction or transactions to create.  To create a single transaction you can specify a value for the `transaction` object and to create multiple transactions you can specify an array of `transactions`.  It is expected that you will only provide a value for one of these objects.
    try {
      SaveTransactionsResponse result = apiInstance.createTransaction(budgetId, postTransactionsWrapper);
...
public class Example {
  public static void main(String[] args) {
    ...
    String budgetId = "budgetId_example"; // String | The id of the budget. \"last-used\" can be used to specify the last used budget and \"default\" can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget).
    String transactionId = "transactionId_example"; // String | The id of the transaction
    PutTransactionWrapper putTransactionWrapper = new PutTransactionWrapper(); // PutTransactionWrapper | The transaction to update
    try {
      TransactionResponse result = apiInstance.updateTransaction(budgetId, transactionId, putTransactionWrapper);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SaveTransactionsResponse result = apiInstance.updateTransactions(budgetId, patchTransactionsWrapper);
      System.out.println(result);
    } catch (ApiException e) {
