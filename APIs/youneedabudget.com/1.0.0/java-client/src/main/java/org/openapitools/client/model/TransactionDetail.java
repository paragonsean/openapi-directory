...
public class TransactionDetail {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, transactionDetail.accountId) &&
        ...
        Objects.equals(this.id, transactionDetail.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, approved, categoryId, cleared, date, debtTransactionType, deleted, flagColor, id, importId, importPayeeName, importPayeeNameOriginal, matchedTransactionId, memo, payeeId, transferAccountId, transferTransactionId, accountName, categoryName, payeeName, subtransactions);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransactionDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
