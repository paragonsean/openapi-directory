...
public class HybridTransaction {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, hybridTransaction.accountId) &&
        ...
        Objects.equals(this.id, hybridTransaction.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, approved, categoryId, cleared, date, debtTransactionType, deleted, flagColor, id, importId, importPayeeName, importPayeeNameOriginal, matchedTransactionId, memo, payeeId, transferAccountId, transferTransactionId, accountName, categoryName, parentTransactionId, payeeName, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to HybridTransaction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HybridTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HybridTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HybridTransaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
