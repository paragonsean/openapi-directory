...
public class CategoriesApi {
     ...
     * @param month The budget month in ISO format (e.g. 2016-12-01) (\&quot;current\&quot; can also be used to specify the current calendar month (UTC)) (required)
     * @param categoryId The id of the category (required)
     * @param patchMonthCategoryWrapper The category to update.  Only &#x60;budgeted&#x60; amount can be updated and any other fields specified will be ignored. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateMonthCategoryCall(String budgetId, LocalDate month, String categoryId, PatchMonthCategoryWrapper patchMonthCategoryWrapper, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = patchMonthCategoryWrapper;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateMonthCategoryValidateBeforeCall(String budgetId, LocalDate month, String categoryId, PatchMonthCategoryWrapper patchMonthCategoryWrapper, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'budgetId' is set
        if (budgetId == null) {
        ...
        if (patchMonthCategoryWrapper == null) {
            throw new ApiException("Missing the required parameter 'patchMonthCategoryWrapper' when calling updateMonthCategory(Async)");
        }

        return updateMonthCategoryCall(budgetId, month, categoryId, patchMonthCategoryWrapper, _callback);
     ...
     */
    public SaveCategoryResponse updateMonthCategory(String budgetId, LocalDate month, String categoryId, PatchMonthCategoryWrapper patchMonthCategoryWrapper) throws ApiException {
        ApiResponse<SaveCategoryResponse> localVarResp = updateMonthCategoryWithHttpInfo(budgetId, month, categoryId, patchMonthCategoryWrapper);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SaveCategoryResponse> updateMonthCategoryWithHttpInfo(String budgetId, LocalDate month, String categoryId, PatchMonthCategoryWrapper patchMonthCategoryWrapper) throws ApiException {
        okhttp3.Call localVarCall = updateMonthCategoryValidateBeforeCall(budgetId, month, categoryId, patchMonthCategoryWrapper, null);
     ...
     */
    public okhttp3.Call updateMonthCategoryAsync(String budgetId, LocalDate month, String categoryId, PatchMonthCategoryWrapper patchMonthCategoryWrapper, final ApiCallback<SaveCategoryResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateMonthCategoryValidateBeforeCall(budgetId, month, categoryId, patchMonthCategoryWrapper, _callback);
        Type localVarReturnType = new TypeToken<SaveCategoryResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
