...
public class TransactionsApi {
     ...
     */
    public okhttp3.Call createTransactionCall(String budgetId, PostTransactionsWrapper postTransactionsWrapper, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = postTransactionsWrapper;
    ...
    private okhttp3.Call createTransactionValidateBeforeCall(String budgetId, PostTransactionsWrapper postTransactionsWrapper, final ApiCallback _callback) throws ApiException {
        ...
        if (postTransactionsWrapper == null) {
            throw new ApiException("Missing the required parameter 'postTransactionsWrapper' when calling createTransaction(Async)");
        }

        return createTransactionCall(budgetId, postTransactionsWrapper, _callback);
     ...
     */
    public SaveTransactionsResponse createTransaction(String budgetId, PostTransactionsWrapper postTransactionsWrapper) throws ApiException {
        ApiResponse<SaveTransactionsResponse> localVarResp = createTransactionWithHttpInfo(budgetId, postTransactionsWrapper);
     ...
     */
    public ApiResponse<SaveTransactionsResponse> createTransactionWithHttpInfo(String budgetId, PostTransactionsWrapper postTransactionsWrapper) throws ApiException {
        okhttp3.Call localVarCall = createTransactionValidateBeforeCall(budgetId, postTransactionsWrapper, null);
     ...
     */
    public okhttp3.Call createTransactionAsync(String budgetId, PostTransactionsWrapper postTransactionsWrapper, final ApiCallback<SaveTransactionsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTransactionValidateBeforeCall(budgetId, postTransactionsWrapper, _callback);
        Type localVarReturnType = new TypeToken<SaveTransactionsResponse>(){}.getType();
     ...
     * @param budgetId The id of the budget. \&quot;last-used\&quot; can be used to specify the last used budget and \&quot;default\&quot; can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
     * @param transactionId The id of the transaction (required)
     * @param putTransactionWrapper The transaction to update (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateTransactionCall(String budgetId, String transactionId, PutTransactionWrapper putTransactionWrapper, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = putTransactionWrapper;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateTransactionValidateBeforeCall(String budgetId, String transactionId, PutTransactionWrapper putTransactionWrapper, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'budgetId' is set
        if (budgetId == null) {
        ...
        if (putTransactionWrapper == null) {
            throw new ApiException("Missing the required parameter 'putTransactionWrapper' when calling updateTransaction(Async)");
        }

        return updateTransactionCall(budgetId, transactionId, putTransactionWrapper, _callback);
     ...
     */
    public TransactionResponse updateTransaction(String budgetId, String transactionId, PutTransactionWrapper putTransactionWrapper) throws ApiException {
        ApiResponse<TransactionResponse> localVarResp = updateTransactionWithHttpInfo(budgetId, transactionId, putTransactionWrapper);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TransactionResponse> updateTransactionWithHttpInfo(String budgetId, String transactionId, PutTransactionWrapper putTransactionWrapper) throws ApiException {
        okhttp3.Call localVarCall = updateTransactionValidateBeforeCall(budgetId, transactionId, putTransactionWrapper, null);
        Type localVarReturnType = new TypeToken<TransactionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateTransactionAsync(String budgetId, String transactionId, PutTransactionWrapper putTransactionWrapper, final ApiCallback<TransactionResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateTransactionValidateBeforeCall(budgetId, transactionId, putTransactionWrapper, _callback);
        Type localVarReturnType = new TypeToken<TransactionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call updateTransactionsCall(String budgetId, PatchTransactionsWrapper patchTransactionsWrapper, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = patchTransactionsWrapper;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateTransactionsValidateBeforeCall(String budgetId, PatchTransactionsWrapper patchTransactionsWrapper, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'budgetId' is set
        if (budgetId == null) {
        ...
        if (patchTransactionsWrapper == null) {
            throw new ApiException("Missing the required parameter 'patchTransactionsWrapper' when calling updateTransactions(Async)");
        }

        return updateTransactionsCall(budgetId, patchTransactionsWrapper, _callback);
     ...
     */
    public SaveTransactionsResponse updateTransactions(String budgetId, PatchTransactionsWrapper patchTransactionsWrapper) throws ApiException {
        ApiResponse<SaveTransactionsResponse> localVarResp = updateTransactionsWithHttpInfo(budgetId, patchTransactionsWrapper);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SaveTransactionsResponse> updateTransactionsWithHttpInfo(String budgetId, PatchTransactionsWrapper patchTransactionsWrapper) throws ApiException {
        okhttp3.Call localVarCall = updateTransactionsValidateBeforeCall(budgetId, patchTransactionsWrapper, null);
        Type localVarReturnType = new TypeToken<SaveTransactionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateTransactionsAsync(String budgetId, PatchTransactionsWrapper patchTransactionsWrapper, final ApiCallback<SaveTransactionsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateTransactionsValidateBeforeCall(budgetId, patchTransactionsWrapper, _callback);
        Type localVarReturnType = new TypeToken<SaveTransactionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
