...
public class SaveTransactionWithId {
  ...
  public SaveTransactionWithId accountId(UUID accountId) {
  ...
  public SaveTransactionWithId amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public SaveTransactionWithId approved(Boolean approved) {
  ...
  public SaveTransactionWithId categoryId(UUID categoryId) {
  ...
  public SaveTransactionWithId cleared(ClearedEnum cleared) {
  ...
  public SaveTransactionWithId date(LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  public SaveTransactionWithId flagColor(FlagColorEnum flagColor) {
  ...
  public SaveTransactionWithId importId(String importId) {
  ...
  public SaveTransactionWithId memo(String memo) {
    this.memo = memo;
    return this;
  }
  ...
  public SaveTransactionWithId payeeId(UUID payeeId) {
  ...
  public SaveTransactionWithId payeeName(String payeeName) {
  ...
  public SaveTransactionWithId subtransactions(List<SaveSubTransaction> subtransactions) {
    this.subtransactions = subtransactions;
    return this;
  }

  public SaveTransactionWithId addSubtransactionsItem(SaveSubTransaction subtransactionsItem) {
  ...
  public SaveTransactionWithId id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SaveTransactionWithId saveTransactionWithId = (SaveTransactionWithId) o;
    return Objects.equals(this.accountId, saveTransactionWithId.accountId) &&
        Objects.equals(this.amount, saveTransactionWithId.amount) &&
        Objects.equals(this.approved, saveTransactionWithId.approved) &&
        Objects.equals(this.categoryId, saveTransactionWithId.categoryId) &&
        Objects.equals(this.cleared, saveTransactionWithId.cleared) &&
        Objects.equals(this.date, saveTransactionWithId.date) &&
        Objects.equals(this.flagColor, saveTransactionWithId.flagColor) &&
        Objects.equals(this.importId, saveTransactionWithId.importId) &&
        Objects.equals(this.memo, saveTransactionWithId.memo) &&
        Objects.equals(this.payeeId, saveTransactionWithId.payeeId) &&
        Objects.equals(this.payeeName, saveTransactionWithId.payeeName) &&
        Objects.equals(this.subtransactions, saveTransactionWithId.subtransactions) &&
        Objects.equals(this.id, saveTransactionWithId.id);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, approved, categoryId, cleared, date, flagColor, importId, memo, payeeId, payeeName, subtransactions, id);
  }
  ...
  public String toString() {
    ...
    sb.append("class SaveTransactionWithId {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SaveTransactionWithId
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SaveTransactionWithId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SaveTransactionWithId is not found in the empty JSON string", SaveTransactionWithId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SaveTransactionWithId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SaveTransactionWithId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SaveTransactionWithId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SaveTransactionWithId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SaveTransactionWithId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SaveTransactionWithId.class));

       return (TypeAdapter<T>) new TypeAdapter<SaveTransactionWithId>() {
           @Override
           public void write(JsonWriter out, SaveTransactionWithId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SaveTransactionWithId read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SaveTransactionWithId given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SaveTransactionWithId
   * @throws IOException if the JSON string is invalid with respect to SaveTransactionWithId
   */
  public static SaveTransactionWithId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SaveTransactionWithId.class);
  }

  /**
   * Convert an instance of SaveTransactionWithId to an JSON string
   *
   * @return JSON string
   */
