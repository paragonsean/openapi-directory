...
public class Category {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activity, category.activity) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activity, balance, budgeted, categoryGroupId, deleted, goalCadence, goalCadenceFrequency, goalCreationMonth, goalDay, goalMonthsToBudget, goalOverallFunded, goalOverallLeft, goalPercentageComplete, goalTarget, goalTargetMonth, goalType, goalUnderFunded, hidden, id, name, note, originalCategoryGroupId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `goal_type`
      if (jsonObj.get("goal_type") != null && !jsonObj.get("goal_type").isJsonNull()) {
        GoalTypeEnum.validateJsonElement(jsonObj.get("goal_type"));
      }
