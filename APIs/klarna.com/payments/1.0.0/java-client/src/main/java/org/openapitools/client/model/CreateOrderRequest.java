...
public class CreateOrderRequest {
  ...
  public CreateOrderRequest shippingAddress(Address shippingAddress) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorizationToken, createOrderRequest.authorizationToken) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorizationToken, autoCapture, billingAddress, customPaymentMethodIds, customer, locale, merchantData, merchantReference1, merchantReference2, merchantUrls, orderAmount, orderLines, orderTaxAmount, paymentMethodCategories, purchaseCountry, purchaseCurrency, shippingAddress, status);
  }
