...
public class Example {
  public static void main(String[] args) {
    ...
    SessionCreate sessionCreate = new SessionCreate(); // SessionCreate | session_request
    try {
      MerchantSession result = apiInstance.createCreditSession(sessionCreate);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SessionsApi#createCreditSession");
...
public class Example {
  public static void main(String[] args) {
    ...
    SessionsApi apiInstance = new SessionsApi(defaultClient);
    String sessionId = "sessionId_example"; // String | session_id
    try {
      SessionRead result = apiInstance.readCreditSession(sessionId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SessionsApi#readCreditSession");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    SessionsApi apiInstance = new SessionsApi(defaultClient);
    String sessionId = "sessionId_example"; // String | session_id
    Session session = new Session(); // Session | session_request
    try {
      apiInstance.updateCreditSession(sessionId, session);
    } catch (ApiException e) {
      System.err.println("Exception when calling SessionsApi#updateCreditSession");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
