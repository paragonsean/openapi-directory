...
void Example::exampleFunction1(){
     OAIOrdersApi apiInstance;
     
      QEventLoop loop;
      connect(&apiInstance, &OAIOrdersApi::cancelAuthorizationSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIOrdersApi::cancelAuthorizationSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString authorization_token = create(); // QString | 
