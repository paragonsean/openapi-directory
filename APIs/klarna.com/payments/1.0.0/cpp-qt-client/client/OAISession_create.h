...
#ifndef OAISession_create_H
#define OAISession_create_H
...
class OAISession_create : public OAIObject {
public:
    OAISession_create();
    OAISession_create(QString json);
    ~OAISession_create() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISession_create)

#endif // OAISession_create_H
