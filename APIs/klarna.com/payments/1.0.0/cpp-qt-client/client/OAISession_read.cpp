...
OAISession_read::OAISession_read(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISession_read::OAISession_read() {
    this->initializeModel();
}

OAISession_read::~OAISession_read() {}

void OAISession_read::initializeModel() {
...
void OAISession_read::fromJson(QString jsonString) {
...
void OAISession_read::fromJsonObject(QJsonObject json) {
...
QString OAISession_read::asJson() const {
...
QJsonObject OAISession_read::asJsonObject() const {
    QJsonObject obj;
...
QString OAISession_read::getAcquiringChannel() const {
    return m_acquiring_channel;
}
void OAISession_read::setAcquiringChannel(const QString &acquiring_channel) {
    m_acquiring_channel = acquiring_channel;
    m_acquiring_channel_isSet = true;
}

bool OAISession_read::is_acquiring_channel_Set() const{
    return m_acquiring_channel_isSet;
}

bool OAISession_read::is_acquiring_channel_Valid() const{
    return m_acquiring_channel_isValid;
}

OAIAttachment OAISession_read::getAttachment() const {
    return m_attachment;
}
void OAISession_read::setAttachment(const OAIAttachment &attachment) {
    m_attachment = attachment;
    m_attachment_isSet = true;
}

bool OAISession_read::is_attachment_Set() const{
    return m_attachment_isSet;
}

bool OAISession_read::is_attachment_Valid() const{
    return m_attachment_isValid;
}

QString OAISession_read::getAuthorizationToken() const {
    return m_authorization_token;
}
void OAISession_read::setAuthorizationToken(const QString &authorization_token) {
    m_authorization_token = authorization_token;
    m_authorization_token_isSet = true;
}

bool OAISession_read::is_authorization_token_Set() const{
    return m_authorization_token_isSet;
}

bool OAISession_read::is_authorization_token_Valid() const{
    return m_authorization_token_isValid;
}

OAIAddress OAISession_read::getBillingAddress() const {
    return m_billing_address;
}
void OAISession_read::setBillingAddress(const OAIAddress &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAISession_read::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAISession_read::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAISession_read::getClientToken() const {
    return m_client_token;
}
void OAISession_read::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAISession_read::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAISession_read::is_client_token_Valid() const{
    return m_client_token_isValid;
}

QList<QString> OAISession_read::getCustomPaymentMethodIds() const {
    return m_custom_payment_method_ids;
}
void OAISession_read::setCustomPaymentMethodIds(const QList<QString> &custom_payment_method_ids) {
    m_custom_payment_method_ids = custom_payment_method_ids;
    m_custom_payment_method_ids_isSet = true;
}

bool OAISession_read::is_custom_payment_method_ids_Set() const{
    return m_custom_payment_method_ids_isSet;
}

bool OAISession_read::is_custom_payment_method_ids_Valid() const{
    return m_custom_payment_method_ids_isValid;
}

OAICustomer_read OAISession_read::getCustomer() const {
    return m_customer;
}
void OAISession_read::setCustomer(const OAICustomer_read &customer) {
    m_customer = customer;
    m_customer_isSet = true;
}

bool OAISession_read::is_customer_Set() const{
    return m_customer_isSet;
}

bool OAISession_read::is_customer_Valid() const{
    return m_customer_isValid;
}

QString OAISession_read::getDesign() const {
    return m_design;
}
void OAISession_read::setDesign(const QString &design) {
    m_design = design;
    m_design_isSet = true;
}

bool OAISession_read::is_design_Set() const{
    return m_design_isSet;
}

bool OAISession_read::is_design_Valid() const{
    return m_design_isValid;
}

QDateTime OAISession_read::getExpiresAt() const {
    return m_expires_at;
}
void OAISession_read::setExpiresAt(const QDateTime &expires_at) {
    m_expires_at = expires_at;
    m_expires_at_isSet = true;
}

bool OAISession_read::is_expires_at_Set() const{
    return m_expires_at_isSet;
}

bool OAISession_read::is_expires_at_Valid() const{
    return m_expires_at_isValid;
}

QString OAISession_read::getIntent() const {
    return m_intent;
}
void OAISession_read::setIntent(const QString &intent) {
    m_intent = intent;
    m_intent_isSet = true;
}

bool OAISession_read::is_intent_Set() const{
    return m_intent_isSet;
}

bool OAISession_read::is_intent_Valid() const{
    return m_intent_isValid;
}

QString OAISession_read::getLocale() const {
    return m_locale;
}
void OAISession_read::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAISession_read::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAISession_read::is_locale_Valid() const{
    return m_locale_isValid;
}

QString OAISession_read::getMerchantData() const {
    return m_merchant_data;
}
void OAISession_read::setMerchantData(const QString &merchant_data) {
    m_merchant_data = merchant_data;
    m_merchant_data_isSet = true;
}

bool OAISession_read::is_merchant_data_Set() const{
    return m_merchant_data_isSet;
}

bool OAISession_read::is_merchant_data_Valid() const{
    return m_merchant_data_isValid;
}

QString OAISession_read::getMerchantReference1() const {
    return m_merchant_reference1;
}
void OAISession_read::setMerchantReference1(const QString &merchant_reference1) {
    m_merchant_reference1 = merchant_reference1;
    m_merchant_reference1_isSet = true;
}

bool OAISession_read::is_merchant_reference1_Set() const{
    return m_merchant_reference1_isSet;
}

bool OAISession_read::is_merchant_reference1_Valid() const{
    return m_merchant_reference1_isValid;
}

QString OAISession_read::getMerchantReference2() const {
    return m_merchant_reference2;
}
void OAISession_read::setMerchantReference2(const QString &merchant_reference2) {
    m_merchant_reference2 = merchant_reference2;
    m_merchant_reference2_isSet = true;
}

bool OAISession_read::is_merchant_reference2_Set() const{
    return m_merchant_reference2_isSet;
}

bool OAISession_read::is_merchant_reference2_Valid() const{
    return m_merchant_reference2_isValid;
}

OAIMerchant_urls OAISession_read::getMerchantUrls() const {
    return m_merchant_urls;
}
void OAISession_read::setMerchantUrls(const OAIMerchant_urls &merchant_urls) {
    m_merchant_urls = merchant_urls;
    m_merchant_urls_isSet = true;
}

bool OAISession_read::is_merchant_urls_Set() const{
    return m_merchant_urls_isSet;
}

bool OAISession_read::is_merchant_urls_Valid() const{
    return m_merchant_urls_isValid;
}

OAIOptions OAISession_read::getOptions() const {
    return m_options;
}
void OAISession_read::setOptions(const OAIOptions &options) {
    m_options = options;
    m_options_isSet = true;
}

bool OAISession_read::is_options_Set() const{
    return m_options_isSet;
}

bool OAISession_read::is_options_Valid() const{
    return m_options_isValid;
}

qint64 OAISession_read::getOrderAmount() const {
    return m_order_amount;
}
void OAISession_read::setOrderAmount(const qint64 &order_amount) {
    m_order_amount = order_amount;
    m_order_amount_isSet = true;
}

bool OAISession_read::is_order_amount_Set() const{
    return m_order_amount_isSet;
}

bool OAISession_read::is_order_amount_Valid() const{
    return m_order_amount_isValid;
}

QList<OAIOrder_line> OAISession_read::getOrderLines() const {
    return m_order_lines;
}
void OAISession_read::setOrderLines(const QList<OAIOrder_line> &order_lines) {
    m_order_lines = order_lines;
    m_order_lines_isSet = true;
}

bool OAISession_read::is_order_lines_Set() const{
    return m_order_lines_isSet;
}

bool OAISession_read::is_order_lines_Valid() const{
    return m_order_lines_isValid;
}

qint64 OAISession_read::getOrderTaxAmount() const {
    return m_order_tax_amount;
}
void OAISession_read::setOrderTaxAmount(const qint64 &order_tax_amount) {
    m_order_tax_amount = order_tax_amount;
    m_order_tax_amount_isSet = true;
}

bool OAISession_read::is_order_tax_amount_Set() const{
    return m_order_tax_amount_isSet;
}

bool OAISession_read::is_order_tax_amount_Valid() const{
    return m_order_tax_amount_isValid;
}

QSet<OAIPayment_method_category> OAISession_read::getPaymentMethodCategories() const {
    return m_payment_method_categories;
}
void OAISession_read::setPaymentMethodCategories(const QSet<OAIPayment_method_category> &payment_method_categories) {
    m_payment_method_categories = payment_method_categories;
    m_payment_method_categories_isSet = true;
}

bool OAISession_read::is_payment_method_categories_Set() const{
    return m_payment_method_categories_isSet;
}

bool OAISession_read::is_payment_method_categories_Valid() const{
    return m_payment_method_categories_isValid;
}

QString OAISession_read::getPurchaseCountry() const {
    return m_purchase_country;
}
void OAISession_read::setPurchaseCountry(const QString &purchase_country) {
    m_purchase_country = purchase_country;
    m_purchase_country_isSet = true;
}

bool OAISession_read::is_purchase_country_Set() const{
    return m_purchase_country_isSet;
}

bool OAISession_read::is_purchase_country_Valid() const{
    return m_purchase_country_isValid;
}

QString OAISession_read::getPurchaseCurrency() const {
    return m_purchase_currency;
}
void OAISession_read::setPurchaseCurrency(const QString &purchase_currency) {
    m_purchase_currency = purchase_currency;
    m_purchase_currency_isSet = true;
}

bool OAISession_read::is_purchase_currency_Set() const{
    return m_purchase_currency_isSet;
}

bool OAISession_read::is_purchase_currency_Valid() const{
    return m_purchase_currency_isValid;
}

OAIAddress OAISession_read::getShippingAddress() const {
    return m_shipping_address;
}
void OAISession_read::setShippingAddress(const OAIAddress &shipping_address) {
    m_shipping_address = shipping_address;
    m_shipping_address_isSet = true;
}

bool OAISession_read::is_shipping_address_Set() const{
    return m_shipping_address_isSet;
}

bool OAISession_read::is_shipping_address_Valid() const{
    return m_shipping_address_isValid;
}

QString OAISession_read::getStatus() const {
    return m_status;
}
void OAISession_read::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISession_read::is_status_Set() const{
    return m_status_isSet;
}

bool OAISession_read::is_status_Valid() const{
    return m_status_isValid;
}

bool OAISession_read::isSet() const {
...
bool OAISession_read::isValid() const {
