...
QString OAISession::getAcquiringChannel() const {
    return m_acquiring_channel;
}
void OAISession::setAcquiringChannel(const QString &acquiring_channel) {
    m_acquiring_channel = acquiring_channel;
    m_acquiring_channel_isSet = true;
}

bool OAISession::is_acquiring_channel_Set() const{
    return m_acquiring_channel_isSet;
}

bool OAISession::is_acquiring_channel_Valid() const{
    return m_acquiring_channel_isValid;
}

OAIAttachment OAISession::getAttachment() const {
    return m_attachment;
}
void OAISession::setAttachment(const OAIAttachment &attachment) {
    m_attachment = attachment;
    m_attachment_isSet = true;
}

bool OAISession::is_attachment_Set() const{
    return m_attachment_isSet;
}

bool OAISession::is_attachment_Valid() const{
    return m_attachment_isValid;
}

QString OAISession::getAuthorizationToken() const {
    return m_authorization_token;
}
void OAISession::setAuthorizationToken(const QString &authorization_token) {
    m_authorization_token = authorization_token;
    m_authorization_token_isSet = true;
}

bool OAISession::is_authorization_token_Set() const{
    return m_authorization_token_isSet;
}

bool OAISession::is_authorization_token_Valid() const{
    return m_authorization_token_isValid;
}

OAIAddress OAISession::getBillingAddress() const {
    return m_billing_address;
}
void OAISession::setBillingAddress(const OAIAddress &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAISession::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAISession::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QString OAISession::getClientToken() const {
    return m_client_token;
}
void OAISession::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAISession::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAISession::is_client_token_Valid() const{
    return m_client_token_isValid;
}

QList<QString> OAISession::getCustomPaymentMethodIds() const {
    return m_custom_payment_method_ids;
}
void OAISession::setCustomPaymentMethodIds(const QList<QString> &custom_payment_method_ids) {
    m_custom_payment_method_ids = custom_payment_method_ids;
    m_custom_payment_method_ids_isSet = true;
}

bool OAISession::is_custom_payment_method_ids_Set() const{
    return m_custom_payment_method_ids_isSet;
}

bool OAISession::is_custom_payment_method_ids_Valid() const{
    return m_custom_payment_method_ids_isValid;
}

OAICustomer OAISession::getCustomer() const {
    return m_customer;
}
void OAISession::setCustomer(const OAICustomer &customer) {
    m_customer = customer;
    m_customer_isSet = true;
}

bool OAISession::is_customer_Set() const{
    return m_customer_isSet;
}

bool OAISession::is_customer_Valid() const{
    return m_customer_isValid;
}

QString OAISession::getDesign() const {
    return m_design;
}
void OAISession::setDesign(const QString &design) {
    m_design = design;
    m_design_isSet = true;
}

bool OAISession::is_design_Set() const{
    return m_design_isSet;
}

bool OAISession::is_design_Valid() const{
    return m_design_isValid;
}

QDateTime OAISession::getExpiresAt() const {
    return m_expires_at;
}
void OAISession::setExpiresAt(const QDateTime &expires_at) {
    m_expires_at = expires_at;
    m_expires_at_isSet = true;
}

bool OAISession::is_expires_at_Set() const{
    return m_expires_at_isSet;
}

bool OAISession::is_expires_at_Valid() const{
    return m_expires_at_isValid;
}

QString OAISession::getIntent() const {
    return m_intent;
}
void OAISession::setIntent(const QString &intent) {
    m_intent = intent;
    m_intent_isSet = true;
}

bool OAISession::is_intent_Set() const{
    return m_intent_isSet;
}

bool OAISession::is_intent_Valid() const{
    return m_intent_isValid;
}

QString OAISession::getLocale() const {
    return m_locale;
}
void OAISession::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAISession::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAISession::is_locale_Valid() const{
    return m_locale_isValid;
}

QString OAISession::getMerchantData() const {
    return m_merchant_data;
}
void OAISession::setMerchantData(const QString &merchant_data) {
    m_merchant_data = merchant_data;
    m_merchant_data_isSet = true;
}

bool OAISession::is_merchant_data_Set() const{
    return m_merchant_data_isSet;
}

bool OAISession::is_merchant_data_Valid() const{
    return m_merchant_data_isValid;
}

QString OAISession::getMerchantReference1() const {
    return m_merchant_reference1;
}
void OAISession::setMerchantReference1(const QString &merchant_reference1) {
    m_merchant_reference1 = merchant_reference1;
    m_merchant_reference1_isSet = true;
}

bool OAISession::is_merchant_reference1_Set() const{
    return m_merchant_reference1_isSet;
}

bool OAISession::is_merchant_reference1_Valid() const{
    return m_merchant_reference1_isValid;
}

QString OAISession::getMerchantReference2() const {
    return m_merchant_reference2;
}
void OAISession::setMerchantReference2(const QString &merchant_reference2) {
    m_merchant_reference2 = merchant_reference2;
    m_merchant_reference2_isSet = true;
}

bool OAISession::is_merchant_reference2_Set() const{
    return m_merchant_reference2_isSet;
}

bool OAISession::is_merchant_reference2_Valid() const{
    return m_merchant_reference2_isValid;
}

OAIMerchant_urls OAISession::getMerchantUrls() const {
    return m_merchant_urls;
}
void OAISession::setMerchantUrls(const OAIMerchant_urls &merchant_urls) {
    m_merchant_urls = merchant_urls;
    m_merchant_urls_isSet = true;
}

bool OAISession::is_merchant_urls_Set() const{
    return m_merchant_urls_isSet;
}

bool OAISession::is_merchant_urls_Valid() const{
    return m_merchant_urls_isValid;
}

OAIOptions OAISession::getOptions() const {
    return m_options;
}
void OAISession::setOptions(const OAIOptions &options) {
    m_options = options;
    m_options_isSet = true;
}

bool OAISession::is_options_Set() const{
    return m_options_isSet;
}

bool OAISession::is_options_Valid() const{
    return m_options_isValid;
}

qint64 OAISession::getOrderAmount() const {
    return m_order_amount;
}
void OAISession::setOrderAmount(const qint64 &order_amount) {
    m_order_amount = order_amount;
    m_order_amount_isSet = true;
}

bool OAISession::is_order_amount_Set() const{
    return m_order_amount_isSet;
}

bool OAISession::is_order_amount_Valid() const{
    return m_order_amount_isValid;
}

QList<OAIOrder_line> OAISession::getOrderLines() const {
    return m_order_lines;
}
void OAISession::setOrderLines(const QList<OAIOrder_line> &order_lines) {
    m_order_lines = order_lines;
    m_order_lines_isSet = true;
}

bool OAISession::is_order_lines_Set() const{
    return m_order_lines_isSet;
}

bool OAISession::is_order_lines_Valid() const{
    return m_order_lines_isValid;
}

qint64 OAISession::getOrderTaxAmount() const {
    return m_order_tax_amount;
}
void OAISession::setOrderTaxAmount(const qint64 &order_tax_amount) {
    m_order_tax_amount = order_tax_amount;
    m_order_tax_amount_isSet = true;
}

bool OAISession::is_order_tax_amount_Set() const{
    return m_order_tax_amount_isSet;
}

bool OAISession::is_order_tax_amount_Valid() const{
    return m_order_tax_amount_isValid;
}

QSet<OAIPayment_method_category> OAISession::getPaymentMethodCategories() const {
    return m_payment_method_categories;
}
void OAISession::setPaymentMethodCategories(const QSet<OAIPayment_method_category> &payment_method_categories) {
    m_payment_method_categories = payment_method_categories;
    m_payment_method_categories_isSet = true;
}

bool OAISession::is_payment_method_categories_Set() const{
    return m_payment_method_categories_isSet;
}

bool OAISession::is_payment_method_categories_Valid() const{
    return m_payment_method_categories_isValid;
}

QString OAISession::getPurchaseCountry() const {
    return m_purchase_country;
}
void OAISession::setPurchaseCountry(const QString &purchase_country) {
    m_purchase_country = purchase_country;
    m_purchase_country_isSet = true;
}

bool OAISession::is_purchase_country_Set() const{
    return m_purchase_country_isSet;
}

bool OAISession::is_purchase_country_Valid() const{
    return m_purchase_country_isValid;
}

QString OAISession::getPurchaseCurrency() const {
    return m_purchase_currency;
}
void OAISession::setPurchaseCurrency(const QString &purchase_currency) {
    m_purchase_currency = purchase_currency;
    m_purchase_currency_isSet = true;
}

bool OAISession::is_purchase_currency_Set() const{
    return m_purchase_currency_isSet;
}

bool OAISession::is_purchase_currency_Valid() const{
    return m_purchase_currency_isValid;
}

OAIAddress OAISession::getShippingAddress() const {
    return m_shipping_address;
}
void OAISession::setShippingAddress(const OAIAddress &shipping_address) {
    m_shipping_address = shipping_address;
    m_shipping_address_isSet = true;
}

bool OAISession::is_shipping_address_Set() const{
    return m_shipping_address_isSet;
}

bool OAISession::is_shipping_address_Valid() const{
