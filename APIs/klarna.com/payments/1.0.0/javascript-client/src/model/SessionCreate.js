...
/**
 * The SessionCreate model module.
 * @module model/SessionCreate
 * @version 1.0.0
 */
class SessionCreate {
    /**
     * Constructs a new <code>SessionCreate</code>.
     * @alias module:model/SessionCreate
    ...
    constructor(orderAmount, orderLines, purchaseCountry, purchaseCurrency) { 
        ...
        SessionCreate.initialize(this, orderAmount, orderLines, purchaseCountry, purchaseCurrency);
    }
    ...
    /**
     * Constructs a <code>SessionCreate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SessionCreate} obj Optional instance to populate.
     * @return {module:model/SessionCreate} The populated <code>SessionCreate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SessionCreate();
    ...
    /**
     * Validates the JSON data with respect to <code>SessionCreate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SessionCreate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SessionCreate.RequiredProperties) {
...
SessionCreate.RequiredProperties = ["order_amount", "order_lines", "purchase_country", "purchase_currency"];
 ...
 * @member {module:model/SessionCreate.AcquiringChannelEnum} acquiring_channel
 */
SessionCreate.prototype['acquiring_channel'] = undefined;

/**
 * @member {module:model/Attachment} attachment
 */
SessionCreate.prototype['attachment'] = undefined;

/**
 * Authorization token.
 * @member {String} authorization_token
 */
SessionCreate.prototype['authorization_token'] = undefined;

/**
 * @member {module:model/Address} billing_address
 */
SessionCreate.prototype['billing_address'] = undefined;

/**
 * Token to be passed to the JS client
 * @member {String} client_token
 */
SessionCreate.prototype['client_token'] = undefined;
 ...
 */
SessionCreate.prototype['custom_payment_method_ids'] = undefined;

/**
 * @member {module:model/Customer} customer
 */
SessionCreate.prototype['customer'] = undefined;
 ...
 */
SessionCreate.prototype['design'] = undefined;

/**
 * Session expiration date
 * @member {Date} expires_at
 */
SessionCreate.prototype['expires_at'] = undefined;

/**
 * Intent for the session. The field is designed to let partners inform Klarna of the purpose of the customer’s session.
 * @member {module:model/SessionCreate.IntentEnum} intent
 */
SessionCreate.prototype['intent'] = undefined;
 ...
 */
SessionCreate.prototype['locale'] = undefined;
 ...
 */
SessionCreate.prototype['merchant_reference2'] = undefined;

/**
 * @member {module:model/MerchantUrls} merchant_urls
 */
SessionCreate.prototype['merchant_urls'] = undefined;

/**
 * @member {module:model/Options} options
 */
SessionCreate.prototype['options'] = undefined;
 ...
 */
SessionCreate.prototype['order_amount'] = undefined;
 ...
 */
SessionCreate.prototype['order_lines'] = undefined;
 ...
 */
SessionCreate.prototype['order_tax_amount'] = undefined;

/**
 * Available payment method categories
 * @member {Array.<module:model/PaymentMethodCategory>} payment_method_categories
 */
SessionCreate.prototype['payment_method_categories'] = undefined;
 ...
 */
SessionCreate.prototype['purchase_country'] = undefined;
 ...
 */
SessionCreate.prototype['purchase_currency'] = undefined;

/**
 * @member {module:model/Address} shipping_address
 */
SessionCreate.prototype['shipping_address'] = undefined;
 ...
 * @member {module:model/SessionCreate.StatusEnum} status
 */
SessionCreate.prototype['status'] = undefined;
 ...
 * @readonly
 */
SessionCreate['AcquiringChannelEnum'] = {
