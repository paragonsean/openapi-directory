...
/**
 * The SessionRead model module.
 * @module model/SessionRead
 * @version 1.0.0
 */
class SessionRead {
    /**
     * Constructs a new <code>SessionRead</code>.
     * @alias module:model/SessionRead
     */
    constructor() { 
        
        SessionRead.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SessionRead</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SessionRead} obj Optional instance to populate.
     * @return {module:model/SessionRead} The populated <code>SessionRead</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SessionRead();
            ...
            if (data.hasOwnProperty('customer')) {
                obj['customer'] = CustomerRead.constructFromObject(data['customer']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SessionRead</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SessionRead</code>.
     */
    static validateJSON(data) {
        ...
        if (data['customer']) { // data not null
          CustomerRead.validateJSON(data['customer']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/SessionRead.AcquiringChannelEnum} acquiring_channel
 */
SessionRead.prototype['acquiring_channel'] = undefined;

/**
 * @member {module:model/Attachment} attachment
 */
SessionRead.prototype['attachment'] = undefined;

/**
 * Authorization token.
 * @member {String} authorization_token
 */
SessionRead.prototype['authorization_token'] = undefined;

/**
 * @member {module:model/Address} billing_address
 */
SessionRead.prototype['billing_address'] = undefined;

/**
 * Token to be passed to the JS client
 * @member {String} client_token
 */
SessionRead.prototype['client_token'] = undefined;
 ...
 */
SessionRead.prototype['custom_payment_method_ids'] = undefined;

/**
 * @member {module:model/CustomerRead} customer
 */
SessionRead.prototype['customer'] = undefined;
 ...
 */
SessionRead.prototype['design'] = undefined;

/**
 * Session expiration date
 * @member {Date} expires_at
 */
SessionRead.prototype['expires_at'] = undefined;

/**
 * Intent for the session. The field is designed to let partners inform Klarna of the purpose of the customer’s session.
 * @member {module:model/SessionRead.IntentEnum} intent
 */
SessionRead.prototype['intent'] = undefined;
 ...
 */
SessionRead.prototype['locale'] = undefined;
 ...
 */
SessionRead.prototype['merchant_reference2'] = undefined;

/**
 * @member {module:model/MerchantUrls} merchant_urls
 */
SessionRead.prototype['merchant_urls'] = undefined;

/**
 * @member {module:model/Options} options
 */
SessionRead.prototype['options'] = undefined;
 ...
 */
SessionRead.prototype['order_amount'] = undefined;
 ...
 */
SessionRead.prototype['order_lines'] = undefined;
 ...
 */
SessionRead.prototype['purchase_country'] = undefined;
 ...
 */
SessionRead.prototype['purchase_currency'] = undefined;

/**
 * @member {module:model/Address} shipping_address
 */
SessionRead.prototype['shipping_address'] = undefined;
 ...
 * @member {module:model/SessionRead.StatusEnum} status
 */
SessionRead.prototype['status'] = undefined;
 ...
 * @readonly
 */
SessionRead['AcquiringChannelEnum'] = {
