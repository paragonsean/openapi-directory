...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KlarnaPaymentsApiV1.SessionCreate();
  });
  ...
  describe('SessionCreate', function() {
    it('should create an instance of SessionCreate', function() {
      // uncomment below and update the code to test SessionCreate
      //var instance = new KlarnaPaymentsApiV1.SessionCreate();
      //expect(instance).to.be.a(KlarnaPaymentsApiV1.SessionCreate);
    });
