...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KlarnaPaymentsApiV1.CreateOrderRequest();
  });
  ...
  describe('CreateOrderRequest', function() {
    it('should create an instance of CreateOrderRequest', function() {
      ...
      //var instance = new KlarnaPaymentsApiV1.CreateOrderRequest();
      //expect(instance).to.be.a(KlarnaPaymentsApiV1.CreateOrderRequest);
    });
    ...
    it('should have the property autoCapture (base name: "auto_capture")', function() {
