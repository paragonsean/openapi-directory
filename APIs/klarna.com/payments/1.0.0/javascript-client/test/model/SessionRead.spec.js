...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KlarnaPaymentsApiV1.SessionRead();
  });
  ...
  describe('SessionRead', function() {
    it('should create an instance of SessionRead', function() {
      // uncomment below and update the code to test SessionRead
      //var instance = new KlarnaPaymentsApiV1.SessionRead();
      //expect(instance).to.be.a(KlarnaPaymentsApiV1.SessionRead);
    });
