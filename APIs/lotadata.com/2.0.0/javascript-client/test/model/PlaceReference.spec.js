...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LotaData.PlaceReference();
  });
  ...
  describe('PlaceReference', function() {
    it('should create an instance of PlaceReference', function() {
      // uncomment below and update the code to test PlaceReference
      //var instance = new LotaData.PlaceReference();
      //expect(instance).to.be.a(LotaData.PlaceReference);
    });
