...
public class Example {
  public static void main(String[] args) {
    ...
    Organizations organizations = new Organizations(); // Organizations | Attributes of \"Organizations\" to be added.
    try {
      apiInstance.addOrganizations(key, token, organizations);
...
<a id="addOrganizationsLogoByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    OrganizationsLogo organizationsLogo = new OrganizationsLogo(); // OrganizationsLogo | Attributes of \"Organizations Logo\" to be added.
    try {
      apiInstance.addOrganizationsLogoByIdOrg(idOrg, key, token, organizationsLogo);
    } catch (ApiException e) {
...
<a id="deleteOrganizationsByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.deleteOrganizationsByIdOrg(idOrg, key, token);
    } catch (ApiException e) {
...
<a id="deleteOrganizationsLogoByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.deleteOrganizationsLogoByIdOrg(idOrg, key, token);
    } catch (ApiException e) {
...
<a id="deleteOrganizationsMembersAllByIdOrgByIdMember"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.deleteOrganizationsMembersAllByIdOrgByIdMember(idOrg, idMember, key, token);
    } catch (ApiException e) {
...
<a id="deleteOrganizationsMembersByIdOrgByIdMember"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.deleteOrganizationsMembersByIdOrgByIdMember(idOrg, idMember, key, token);
    } catch (ApiException e) {
...
<a id="deleteOrganizationsPrefsAssociatedDomainByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.deleteOrganizationsPrefsAssociatedDomainByIdOrg(idOrg, key, token);
    } catch (ApiException e) {
...
<a id="deleteOrganizationsPrefsOrgInviteRestrictByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.deleteOrganizationsPrefsOrgInviteRestrictByIdOrg(idOrg, value, key, token);
    } catch (ApiException e) {
...
<a id="getOrganizationsActionsByIdOrg"></a>
# **getOrganizationsActionsByIdOrg**
> getOrganizationsActionsByIdOrg(idOrg, key, token, entities, display, filter, fields, limit, format, since, before, page, idModels, member, memberFields, memberCreator, memberCreatorFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getOrganizationsActionsByIdOrg(idOrg, key, token, entities, display, filter, fields, limit, format, since, before, page, idModels, member, memberFields, memberCreator, memberCreatorFields);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#getOrganizationsActionsByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getOrganizationsBoardsByIdOrg"></a>
# **getOrganizationsBoardsByIdOrg**
> getOrganizationsBoardsByIdOrg(idOrg, key, token, filter, fields, actions, actionsEntities, actionsLimit, actionsFormat, actionsSince, actionFields, memberships, organization, organizationFields, lists)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getOrganizationsBoardsByIdOrg(idOrg, key, token, filter, fields, actions, actionsEntities, actionsLimit, actionsFormat, actionsSince, actionFields, memberships, organization, organizationFields, lists);
    } catch (ApiException e) {
...
<a id="getOrganizationsBoardsByIdOrgByFilter"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.getOrganizationsBoardsByIdOrgByFilter(idOrg, filter, key, token);
    } catch (ApiException e) {
...
<a id="getOrganizationsByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "name, displayName, desc, descData, url, website, logoHash, products and powerUps"; // String | all or a comma-separated list of: billableMemberCount, desc, descData, displayName, idBoards, invitations, invited, logoHash, memberships, name, powerUps, prefs, premiumFeatures, products, url or website
    try {
      apiInstance.getOrganizationsByIdOrg(idOrg, key, token, actions, actionsEntities, actionsDisplay, actionsLimit, actionFields, memberships, membershipsMember, membershipsMemberFields, members, memberFields, memberActivity, membersInvited, membersInvitedFields, boards, boardFields, boardActions, boardActionsEntities, boardActionsDisplay, boardActionsFormat, boardActionsSince, boardActionsLimit, boardActionFields, boardLists, paidAccount, fields);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#getOrganizationsByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getOrganizationsByIdOrgByField"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.getOrganizationsByIdOrgByField(idOrg, field, key, token);
    } catch (ApiException e) {
...
<a id="getOrganizationsDeltasByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.getOrganizationsDeltasByIdOrg(idOrg, tags, ixLastUpdate, key, token);
    } catch (ApiException e) {
...
<a id="getOrganizationsMembersByIdOrg"></a>
# **getOrganizationsMembersByIdOrg**
> getOrganizationsMembersByIdOrg(idOrg, key, token, filter, fields, activity)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getOrganizationsMembersByIdOrg(idOrg, key, token, filter, fields, activity);
    } catch (ApiException e) {
...
<a id="getOrganizationsMembersByIdOrgByFilter"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.getOrganizationsMembersByIdOrgByFilter(idOrg, filter, key, token);
    } catch (ApiException e) {
...
<a id="getOrganizationsMembersCardsByIdOrgByIdMember"></a>
# **getOrganizationsMembersCardsByIdOrgByIdMember**
> getOrganizationsMembersCardsByIdOrgByIdMember(idOrg, idMember, key, token, actions, attachments, attachmentFields, members, memberFields, checkItemStates, checklists, board, boardFields, _list, listFields, filter, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getOrganizationsMembersCardsByIdOrgByIdMember(idOrg, idMember, key, token, actions, attachments, attachmentFields, members, memberFields, checkItemStates, checklists, board, boardFields, _list, listFields, filter, fields);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#getOrganizationsMembersCardsByIdOrgByIdMember");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getOrganizationsMembersInvitedByIdOrg"></a>
# **getOrganizationsMembersInvitedByIdOrg**
> getOrganizationsMembersInvitedByIdOrg(idOrg, key, token, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getOrganizationsMembersInvitedByIdOrg(idOrg, key, token, fields);
    } catch (ApiException e) {
...
<a id="getOrganizationsMembersInvitedByIdOrgByField"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    try {
      apiInstance.getOrganizationsMembersInvitedByIdOrgByField(idOrg, field, key, token);
    } catch (ApiException e) {
...
<a id="getOrganizationsMembershipsByIdOrg"></a>
# **getOrganizationsMembershipsByIdOrg**
> getOrganizationsMembershipsByIdOrg(idOrg, key, token, filter, member, memberFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getOrganizationsMembershipsByIdOrg(idOrg, key, token, filter, member, memberFields);
    } catch (ApiException e) {
...
<a id="getOrganizationsMembershipsByIdOrgByIdMembership"></a>
# **getOrganizationsMembershipsByIdOrgByIdMembership**
> getOrganizationsMembershipsByIdOrgByIdMembership(idOrg, idMembership, key, token, member, memberFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String memberFields = "fullName and username"; // String | all or a comma-separated list of: avatarHash, bio, bioData, confirmed, fullName, idPremOrgsAdmin, initials, memberType, products, status, url or username
    try {
      apiInstance.getOrganizationsMembershipsByIdOrgByIdMembership(idOrg, idMembership, key, token, member, memberFields);
    } catch (ApiException e) {
...
<a id="updateOrganizationsByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    Organizations organizations = new Organizations(); // Organizations | Attributes of \"Organizations\" to be updated.
    try {
      apiInstance.updateOrganizationsByIdOrg(idOrg, key, token, organizations);
    } catch (ApiException e) {
...
<a id="updateOrganizationsDescByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    OrganizationsDesc organizationsDesc = new OrganizationsDesc(); // OrganizationsDesc | Attributes of \"Organizations Desc\" to be updated.
    try {
      apiInstance.updateOrganizationsDescByIdOrg(idOrg, key, token, organizationsDesc);
    } catch (ApiException e) {
...
<a id="updateOrganizationsDisplayNameByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    OrganizationsDisplayName organizationsDisplayName = new OrganizationsDisplayName(); // OrganizationsDisplayName | Attributes of \"Organizations Display Name\" to be updated.
    try {
      apiInstance.updateOrganizationsDisplayNameByIdOrg(idOrg, key, token, organizationsDisplayName);
    } catch (ApiException e) {
...
<a id="updateOrganizationsMembersByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    OrganizationsMembers organizationsMembers = new OrganizationsMembers(); // OrganizationsMembers | Attributes of \"Organizations Members\" to be updated.
    try {
      apiInstance.updateOrganizationsMembersByIdOrg(idOrg, key, token, organizationsMembers);
    } catch (ApiException e) {
...
<a id="updateOrganizationsMembersByIdOrgByIdMember"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    OrganizationsMembers organizationsMembers = new OrganizationsMembers(); // OrganizationsMembers | Attributes of \"Organizations Members\" to be updated.
    try {
      apiInstance.updateOrganizationsMembersByIdOrgByIdMember(idOrg, idMember, key, token, organizationsMembers);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsMembersByIdOrgByIdMember");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsMembersDeactivatedByIdOrgByIdMember"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    OrganizationsMembersDeactivated organizationsMembersDeactivated = new OrganizationsMembersDeactivated(); // OrganizationsMembersDeactivated | Attributes of \"Organizations Members Deactivated\" to be updated.
    try {
      apiInstance.updateOrganizationsMembersDeactivatedByIdOrgByIdMember(idOrg, idMember, key, token, organizationsMembersDeactivated);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsMembersDeactivatedByIdOrgByIdMember");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsMembershipsByIdOrgByIdMembership"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    OrganizationsMemberships organizationsMemberships = new OrganizationsMemberships(); // OrganizationsMemberships | Attributes of \"Organizations Memberships\" to be updated.
    try {
      apiInstance.updateOrganizationsMembershipsByIdOrgByIdMembership(idOrg, idMembership, key, token, organizationsMemberships);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsMembershipsByIdOrgByIdMembership");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsNameByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    OrganizationsName organizationsName = new OrganizationsName(); // OrganizationsName | Attributes of \"Organizations Name\" to be updated.
    try {
      apiInstance.updateOrganizationsNameByIdOrg(idOrg, key, token, organizationsName);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsNameByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsPrefsAssociatedDomainByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    PrefsAssociatedDomain prefsAssociatedDomain = new PrefsAssociatedDomain(); // PrefsAssociatedDomain | Attributes of \"Prefs Associated Domain\" to be updated.
    try {
      apiInstance.updateOrganizationsPrefsAssociatedDomainByIdOrg(idOrg, key, token, prefsAssociatedDomain);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsPrefsAssociatedDomainByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsPrefsBoardVisibilityRestrictOrgByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    PrefsBoardVisibilityRestrict prefsBoardVisibilityRestrict = new PrefsBoardVisibilityRestrict(); // PrefsBoardVisibilityRestrict | Attributes of \"Prefs Board Visibility Restrict\" to be updated.
    try {
      apiInstance.updateOrganizationsPrefsBoardVisibilityRestrictOrgByIdOrg(idOrg, key, token, prefsBoardVisibilityRestrict);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsPrefsBoardVisibilityRestrictOrgByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsPrefsBoardVisibilityRestrictPrivateByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    PrefsBoardVisibilityRestrict prefsBoardVisibilityRestrict = new PrefsBoardVisibilityRestrict(); // PrefsBoardVisibilityRestrict | Attributes of \"Prefs Board Visibility Restrict\" to be updated.
    try {
      apiInstance.updateOrganizationsPrefsBoardVisibilityRestrictPrivateByIdOrg(idOrg, key, token, prefsBoardVisibilityRestrict);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsPrefsBoardVisibilityRestrictPrivateByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsPrefsBoardVisibilityRestrictPublicByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    PrefsBoardVisibilityRestrict prefsBoardVisibilityRestrict = new PrefsBoardVisibilityRestrict(); // PrefsBoardVisibilityRestrict | Attributes of \"Prefs Board Visibility Restrict\" to be updated.
    try {
      apiInstance.updateOrganizationsPrefsBoardVisibilityRestrictPublicByIdOrg(idOrg, key, token, prefsBoardVisibilityRestrict);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsPrefsBoardVisibilityRestrictPublicByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsPrefsExternalMembersDisabledByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    PrefsExternalMembersDisabled prefsExternalMembersDisabled = new PrefsExternalMembersDisabled(); // PrefsExternalMembersDisabled | Attributes of \"Prefs External Members Disabled\" to be updated.
    try {
      apiInstance.updateOrganizationsPrefsExternalMembersDisabledByIdOrg(idOrg, key, token, prefsExternalMembersDisabled);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsPrefsExternalMembersDisabledByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsPrefsGoogleAppsVersionByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    PrefsGoogleAppsVersion prefsGoogleAppsVersion = new PrefsGoogleAppsVersion(); // PrefsGoogleAppsVersion | Attributes of \"Prefs Google Apps Version\" to be updated.
    try {
      apiInstance.updateOrganizationsPrefsGoogleAppsVersionByIdOrg(idOrg, key, token, prefsGoogleAppsVersion);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsPrefsGoogleAppsVersionByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsPrefsOrgInviteRestrictByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    PrefsOrgInviteRestrict prefsOrgInviteRestrict = new PrefsOrgInviteRestrict(); // PrefsOrgInviteRestrict | Attributes of \"Prefs Org Invite Restrict\" to be updated.
    try {
      apiInstance.updateOrganizationsPrefsOrgInviteRestrictByIdOrg(idOrg, key, token, prefsOrgInviteRestrict);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsPrefsOrgInviteRestrictByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsPrefsPermissionLevelByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.updateOrganizationsPrefsPermissionLevelByIdOrg(idOrg, key, token, prefsPermissionLevel);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsPrefsPermissionLevelByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateOrganizationsWebsiteByIdOrg"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "key_example"; // String | <a href=\"https://trello.com/1/appKey/generate\"  target=\"_blank\">Generate your application key</a>
    String token = "token_example"; // String | <a href=\"https://trello.com/docs/gettingstarted/index.html#getting-a-token-from-a-user\"  target=\"_blank\">Getting a token from a user</a>
    OrganizationsWebsite organizationsWebsite = new OrganizationsWebsite(); // OrganizationsWebsite | Attributes of \"Organizations Website\" to be updated.
    try {
      apiInstance.updateOrganizationsWebsiteByIdOrg(idOrg, key, token, organizationsWebsite);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganizationApi#updateOrganizationsWebsiteByIdOrg");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
