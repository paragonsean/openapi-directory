...
public class ApiClient {
    ...
    private String basePath = "https://trello.com/1";
    ...
    public ApiClient() {
        ...
        authentications.put("api_token", new ApiKeyAuth("query", "token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://trello.com/1
