...
public:
    ...
    /**
    * @param[in]  urls QString [required]
    * @param[in]  key QString [required]
    * @param[in]  token QString [required]
    */
    virtual void getBatch(const QString &urls, const QString &key, const QString &token);
...
Q_SIGNALS:
    ...
    void getBatchSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use getBatchSignalError() instead")
    void getBatchSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void getBatchSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
