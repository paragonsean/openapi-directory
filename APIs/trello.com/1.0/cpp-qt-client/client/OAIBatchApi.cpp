...
void OAIBatchApi::getBatch(const QString &urls, const QString &key, const QString &token) {
    QString fullPath = QString(_serverConfigs["getBatch"][_serverIndices.value("getBatch")].URL()+"/batch");
    ...
    
    {
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "urls", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("urls")).append(querySuffix).append(QUrl::toPercentEncoding(urls));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBatchApi::getBatchCallback);
...
void OAIBatchApi::getBatchCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getBatchSignal();
        Q_EMIT getBatchSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getBatchSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getBatchSignalError(error_type, error_str);
