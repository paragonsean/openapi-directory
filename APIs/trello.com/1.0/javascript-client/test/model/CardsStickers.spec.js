...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Trello.CardsStickers();
  });
  ...
  describe('CardsStickers', function() {
    it('should create an instance of CardsStickers', function() {
      // uncomment below and update the code to test CardsStickers
      //var instance = new Trello.CardsStickers();
      //expect(instance).to.be.a(Trello.CardsStickers);
    });
