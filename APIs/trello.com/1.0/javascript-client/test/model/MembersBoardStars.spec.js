...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Trello.MembersBoardStars();
  });
  ...
  describe('MembersBoardStars', function() {
    it('should create an instance of MembersBoardStars', function() {
      // uncomment below and update the code to test MembersBoardStars
      //var instance = new Trello.MembersBoardStars();
      //expect(instance).to.be.a(Trello.MembersBoardStars);
    });
