...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Trello.ChecklistsCheckItems();
  });
  ...
  describe('ChecklistsCheckItems', function() {
    it('should create an instance of ChecklistsCheckItems', function() {
      // uncomment below and update the code to test ChecklistsCheckItems
      //var instance = new Trello.ChecklistsCheckItems();
      //expect(instance).to.be.a(Trello.ChecklistsCheckItems);
    });
