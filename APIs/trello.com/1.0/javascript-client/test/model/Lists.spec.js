...
(function(root, factory) {
  ...
  describe('Lists', function() {
    it('should create an instance of Lists', function() {
      // uncomment below and update the code to test Lists
      //var instance = new Trello.Lists();
      //expect(instance).to.be.a(Trello.Lists);
    });
    ...
    it('should have the property idListSource (base name: "idListSource")', function() {
      // uncomment below and update the code to test the property idListSource
      //var instance = new Trello.Lists();
      //expect(instance).to.be();
    });
