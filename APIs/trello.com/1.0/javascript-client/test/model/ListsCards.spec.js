...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Trello.ListsCards();
  });
  ...
  describe('ListsCards', function() {
    it('should create an instance of ListsCards', function() {
      // uncomment below and update the code to test ListsCards
      //var instance = new Trello.ListsCards();
      //expect(instance).to.be.a(Trello.ListsCards);
    });
