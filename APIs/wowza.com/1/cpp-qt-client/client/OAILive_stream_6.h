...
#ifndef OAILive_stream_6_H
#define OAILive_stream_6_H
...
class OAILive_stream_6 : public OAIObject {
public:
    OAILive_stream_6();
    OAILive_stream_6(QString json);
    ~OAILive_stream_6() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILive_stream_6)

#endif // OAILive_stream_6_H
