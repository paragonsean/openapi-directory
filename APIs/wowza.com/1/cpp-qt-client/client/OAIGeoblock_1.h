...
#ifndef OAIGeoblock_1_H
#define OAIGeoblock_1_H
...
class OAIGeoblock_1 : public OAIObject {
public:
    OAIGeoblock_1();
    OAIGeoblock_1(QString json);
    ~OAIGeoblock_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoblock_1)

#endif // OAIGeoblock_1_H
