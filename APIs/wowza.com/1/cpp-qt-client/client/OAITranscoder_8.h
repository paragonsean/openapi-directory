...
#ifndef OAITranscoder_8_H
#define OAITranscoder_8_H
...
class OAITranscoder_8 : public OAIObject {
public:
    OAITranscoder_8();
    OAITranscoder_8(QString json);
    ~OAITranscoder_8() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscoder_8)

#endif // OAITranscoder_8_H
