...
QString OAIProperty::getSection() const {
    return m_section;
}
void OAIProperty::setSection(const QString &section) {
    m_section = section;
    m_section_isSet = true;
}

bool OAIProperty::is_section_Set() const{
    return m_section_isSet;
}

bool OAIProperty::is_section_Valid() const{
