...
OAISchedule_3::OAISchedule_3(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISchedule_3::OAISchedule_3() {
    this->initializeModel();
}

OAISchedule_3::~OAISchedule_3() {}

void OAISchedule_3::initializeModel() {
...
void OAISchedule_3::fromJson(QString jsonString) {
...
void OAISchedule_3::fromJsonObject(QJsonObject json) {
...
QString OAISchedule_3::asJson() const {
...
QJsonObject OAISchedule_3::asJsonObject() const {
    QJsonObject obj;
...
QString OAISchedule_3::getActionType() const {
    return m_action_type;
}
void OAISchedule_3::setActionType(const QString &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAISchedule_3::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAISchedule_3::is_action_type_Valid() const{
    return m_action_type_isValid;
}

QDate OAISchedule_3::getEndRepeat() const {
    return m_end_repeat;
}
void OAISchedule_3::setEndRepeat(const QDate &end_repeat) {
    m_end_repeat = end_repeat;
    m_end_repeat_isSet = true;
}

bool OAISchedule_3::is_end_repeat_Set() const{
    return m_end_repeat_isSet;
}

bool OAISchedule_3::is_end_repeat_Valid() const{
    return m_end_repeat_isValid;
}

QString OAISchedule_3::getName() const {
    return m_name;
}
void OAISchedule_3::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISchedule_3::is_name_Set() const{
    return m_name_isSet;
}

bool OAISchedule_3::is_name_Valid() const{
    return m_name_isValid;
}

QString OAISchedule_3::getRecurrenceData() const {
    return m_recurrence_data;
}
void OAISchedule_3::setRecurrenceData(const QString &recurrence_data) {
    m_recurrence_data = recurrence_data;
    m_recurrence_data_isSet = true;
}

bool OAISchedule_3::is_recurrence_data_Set() const{
    return m_recurrence_data_isSet;
}

bool OAISchedule_3::is_recurrence_data_Valid() const{
    return m_recurrence_data_isValid;
}

QString OAISchedule_3::getRecurrenceType() const {
    return m_recurrence_type;
}
void OAISchedule_3::setRecurrenceType(const QString &recurrence_type) {
    m_recurrence_type = recurrence_type;
    m_recurrence_type_isSet = true;
}

bool OAISchedule_3::is_recurrence_type_Set() const{
    return m_recurrence_type_isSet;
}

bool OAISchedule_3::is_recurrence_type_Valid() const{
    return m_recurrence_type_isValid;
}

QDate OAISchedule_3::getStartRepeat() const {
    return m_start_repeat;
}
void OAISchedule_3::setStartRepeat(const QDate &start_repeat) {
    m_start_repeat = start_repeat;
    m_start_repeat_isSet = true;
}

bool OAISchedule_3::is_start_repeat_Set() const{
    return m_start_repeat_isSet;
}

bool OAISchedule_3::is_start_repeat_Valid() const{
    return m_start_repeat_isValid;
}

QDateTime OAISchedule_3::getStartTranscoder() const {
    return m_start_transcoder;
}
void OAISchedule_3::setStartTranscoder(const QDateTime &start_transcoder) {
    m_start_transcoder = start_transcoder;
    m_start_transcoder_isSet = true;
}

bool OAISchedule_3::is_start_transcoder_Set() const{
    return m_start_transcoder_isSet;
}

bool OAISchedule_3::is_start_transcoder_Valid() const{
    return m_start_transcoder_isValid;
}

QDateTime OAISchedule_3::getStopTranscoder() const {
    return m_stop_transcoder;
}
void OAISchedule_3::setStopTranscoder(const QDateTime &stop_transcoder) {
    m_stop_transcoder = stop_transcoder;
    m_stop_transcoder_isSet = true;
}

bool OAISchedule_3::is_stop_transcoder_Set() const{
    return m_stop_transcoder_isSet;
}

bool OAISchedule_3::is_stop_transcoder_Valid() const{
    return m_stop_transcoder_isValid;
}

QString OAISchedule_3::getTranscoderId() const {
    return m_transcoder_id;
}
void OAISchedule_3::setTranscoderId(const QString &transcoder_id) {
    m_transcoder_id = transcoder_id;
    m_transcoder_id_isSet = true;
}

bool OAISchedule_3::is_transcoder_id_Set() const{
    return m_transcoder_id_isSet;
}

bool OAISchedule_3::is_transcoder_id_Valid() const{
    return m_transcoder_id_isValid;
}

bool OAISchedule_3::isSet() const {
...
bool OAISchedule_3::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_action_type_isValid && m_name_isValid && m_recurrence_type_isValid && m_transcoder_id_isValid && true;
}
