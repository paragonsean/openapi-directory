...
/*
 * OAIStream_source_1.h
 *
 * 
 */

#ifndef OAIStream_source_1_H
#define OAIStream_source_1_H
...
class OAIStream_source_1 : public OAIObject {
public:
    OAIStream_source_1();
    OAIStream_source_1(QString json);
    ~OAIStream_source_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStream_source_1)

#endif // OAIStream_source_1_H
