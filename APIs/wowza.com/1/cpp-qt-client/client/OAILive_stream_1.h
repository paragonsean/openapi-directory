...
#ifndef OAILive_stream_1_H
#define OAILive_stream_1_H
...
class OAILive_stream_1 : public OAIObject {
public:
    OAILive_stream_1();
    OAILive_stream_1(QString json);
    ~OAILive_stream_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILive_stream_1)

#endif // OAILive_stream_1_H
