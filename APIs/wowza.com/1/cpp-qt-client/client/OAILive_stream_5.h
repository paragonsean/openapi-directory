...
#ifndef OAILive_stream_5_H
#define OAILive_stream_5_H
...
class OAILive_stream_5 : public OAIObject {
public:
    OAILive_stream_5();
    OAILive_stream_5(QString json);
    ~OAILive_stream_5() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILive_stream_5)

#endif // OAILive_stream_5_H
