...
/*
 * OAIOutput_stream_targets.h
 *
 * 
 */

#ifndef OAIOutput_stream_targets_H
#define OAIOutput_stream_targets_H
...
class OAIOutput_stream_targets : public OAIObject {
public:
    OAIOutput_stream_targets();
    OAIOutput_stream_targets(QString json);
    ~OAIOutput_stream_targets() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutput_stream_targets)

#endif // OAIOutput_stream_targets_H
