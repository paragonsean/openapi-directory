...
#ifndef OAISchedule_3_H
#define OAISchedule_3_H
...
class OAISchedule_3 : public OAIObject {
public:
    OAISchedule_3();
    OAISchedule_3(QString json);
    ~OAISchedule_3() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISchedule_3)

#endif // OAISchedule_3_H
