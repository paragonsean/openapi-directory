...
/*
 * OAIStream_target_property.h
 *
 * 
 */

#ifndef OAIStream_target_property_H
#define OAIStream_target_property_H
...
class OAIStream_target_property : public OAIObject {
public:
    OAIStream_target_property();
    OAIStream_target_property(QString json);
    ~OAIStream_target_property() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStream_target_property)

#endif // OAIStream_target_property_H
