...
#ifndef OAIOutput_1_H
#define OAIOutput_1_H
...
class OAIOutput_1 : public OAIObject {
public:
    OAIOutput_1();
    OAIOutput_1(QString json);
    ~OAIOutput_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOutput_1)
