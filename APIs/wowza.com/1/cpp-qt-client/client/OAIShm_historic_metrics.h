...
/*
 * OAIShm_historic_metrics.h
 *
 * 
 */

#ifndef OAIShm_historic_metrics_H
#define OAIShm_historic_metrics_H
...
class OAIShm_historic_metrics : public OAIObject {
public:
    OAIShm_historic_metrics();
    OAIShm_historic_metrics(QString json);
    ~OAIShm_historic_metrics() override;
    ...
    OAICpu_idle_metric getCpuIdle() const;
    void setCpuIdle(const OAICpu_idle_metric &cpu_idle);
...
Q_DECLARE_METATYPE(OpenAPI::OAIShm_historic_metrics)

#endif // OAIShm_historic_metrics_H
