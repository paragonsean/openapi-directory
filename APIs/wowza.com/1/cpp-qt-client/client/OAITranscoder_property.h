...
/*
 * OAITranscoder_property.h
 *
 * 
 */

#ifndef OAITranscoder_property_H
#define OAITranscoder_property_H
...
class OAITranscoder_property : public OAIObject {
public:
    OAITranscoder_property();
    OAITranscoder_property(QString json);
    ~OAITranscoder_property() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscoder_property)

#endif // OAITranscoder_property_H
