...
OAITranscoder_9::OAITranscoder_9(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITranscoder_9::OAITranscoder_9() {
    this->initializeModel();
}

OAITranscoder_9::~OAITranscoder_9() {}

void OAITranscoder_9::initializeModel() {
    ...
    m_remove_watermark_image_isSet = false;
    m_remove_watermark_image_isValid = false;
...
void OAITranscoder_9::fromJson(QString jsonString) {
...
void OAITranscoder_9::fromJsonObject(QJsonObject json) {
    ...
    m_remove_watermark_image_isValid = ::OpenAPI::fromJsonValue(m_remove_watermark_image, json[QString("remove_watermark_image")]);
    m_remove_watermark_image_isSet = !json[QString("remove_watermark_image")].isNull() && m_remove_watermark_image_isValid;
...
QString OAITranscoder_9::asJson() const {
...
QJsonObject OAITranscoder_9::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_remove_watermark_image_isSet) {
        obj.insert(QString("remove_watermark_image"), ::OpenAPI::toJsonValue(m_remove_watermark_image));
    }
...
QString OAITranscoder_9::getBroadcastLocation() const {
    return m_broadcast_location;
}
void OAITranscoder_9::setBroadcastLocation(const QString &broadcast_location) {
    m_broadcast_location = broadcast_location;
    m_broadcast_location_isSet = true;
}

bool OAITranscoder_9::is_broadcast_location_Set() const{
    return m_broadcast_location_isSet;
}

bool OAITranscoder_9::is_broadcast_location_Valid() const{
    return m_broadcast_location_isValid;
}

qint32 OAITranscoder_9::getBufferSize() const {
    return m_buffer_size;
}
void OAITranscoder_9::setBufferSize(const qint32 &buffer_size) {
    m_buffer_size = buffer_size;
    m_buffer_size_isSet = true;
}

bool OAITranscoder_9::is_buffer_size_Set() const{
    return m_buffer_size_isSet;
}

bool OAITranscoder_9::is_buffer_size_Valid() const{
    return m_buffer_size_isValid;
}

QString OAITranscoder_9::getClosedCaptionType() const {
    return m_closed_caption_type;
}
void OAITranscoder_9::setClosedCaptionType(const QString &closed_caption_type) {
    m_closed_caption_type = closed_caption_type;
    m_closed_caption_type_isSet = true;
}

bool OAITranscoder_9::is_closed_caption_type_Set() const{
    return m_closed_caption_type_isSet;
}

bool OAITranscoder_9::is_closed_caption_type_Valid() const{
    return m_closed_caption_type_isValid;
}

QString OAITranscoder_9::getDeliveryMethod() const {
    return m_delivery_method;
}
void OAITranscoder_9::setDeliveryMethod(const QString &delivery_method) {
    m_delivery_method = delivery_method;
    m_delivery_method_isSet = true;
}

bool OAITranscoder_9::is_delivery_method_Set() const{
    return m_delivery_method_isSet;
}

bool OAITranscoder_9::is_delivery_method_Valid() const{
    return m_delivery_method_isValid;
}

QList<QString> OAITranscoder_9::getDeliveryProtocols() const {
    return m_delivery_protocols;
}
void OAITranscoder_9::setDeliveryProtocols(const QList<QString> &delivery_protocols) {
    m_delivery_protocols = delivery_protocols;
    m_delivery_protocols_isSet = true;
}

bool OAITranscoder_9::is_delivery_protocols_Set() const{
    return m_delivery_protocols_isSet;
}

bool OAITranscoder_9::is_delivery_protocols_Valid() const{
    return m_delivery_protocols_isValid;
}

QString OAITranscoder_9::getDescription() const {
    return m_description;
}
void OAITranscoder_9::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAITranscoder_9::is_description_Set() const{
    return m_description_isSet;
}

bool OAITranscoder_9::is_description_Valid() const{
    return m_description_isValid;
}

bool OAITranscoder_9::isDisableAuthentication() const {
    return m_disable_authentication;
}
void OAITranscoder_9::setDisableAuthentication(const bool &disable_authentication) {
    m_disable_authentication = disable_authentication;
    m_disable_authentication_isSet = true;
}

bool OAITranscoder_9::is_disable_authentication_Set() const{
    return m_disable_authentication_isSet;
}

bool OAITranscoder_9::is_disable_authentication_Valid() const{
    return m_disable_authentication_isValid;
}

qint32 OAITranscoder_9::getIdleTimeout() const {
    return m_idle_timeout;
}
void OAITranscoder_9::setIdleTimeout(const qint32 &idle_timeout) {
    m_idle_timeout = idle_timeout;
    m_idle_timeout_isSet = true;
}

bool OAITranscoder_9::is_idle_timeout_Set() const{
    return m_idle_timeout_isSet;
}

bool OAITranscoder_9::is_idle_timeout_Valid() const{
    return m_idle_timeout_isValid;
}

bool OAITranscoder_9::isLowLatency() const {
    return m_low_latency;
}
void OAITranscoder_9::setLowLatency(const bool &low_latency) {
    m_low_latency = low_latency;
    m_low_latency_isSet = true;
}

bool OAITranscoder_9::is_low_latency_Set() const{
    return m_low_latency_isSet;
}

bool OAITranscoder_9::is_low_latency_Valid() const{
    return m_low_latency_isValid;
}

QString OAITranscoder_9::getName() const {
    return m_name;
}
void OAITranscoder_9::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITranscoder_9::is_name_Set() const{
    return m_name_isSet;
}

bool OAITranscoder_9::is_name_Valid() const{
    return m_name_isValid;
}

QString OAITranscoder_9::getPassword() const {
    return m_password;
}
void OAITranscoder_9::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAITranscoder_9::is_password_Set() const{
    return m_password_isSet;
}

bool OAITranscoder_9::is_password_Valid() const{
    return m_password_isValid;
}

qint32 OAITranscoder_9::getPlayMaximumConnections() const {
    return m_play_maximum_connections;
}
void OAITranscoder_9::setPlayMaximumConnections(const qint32 &play_maximum_connections) {
    m_play_maximum_connections = play_maximum_connections;
    m_play_maximum_connections_isSet = true;
}

bool OAITranscoder_9::is_play_maximum_connections_Set() const{
    return m_play_maximum_connections_isSet;
}

bool OAITranscoder_9::is_play_maximum_connections_Valid() const{
    return m_play_maximum_connections_isValid;
}

QString OAITranscoder_9::getProtocol() const {
    return m_protocol;
}
void OAITranscoder_9::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAITranscoder_9::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAITranscoder_9::is_protocol_Valid() const{
    return m_protocol_isValid;
}

bool OAITranscoder_9::isRecording() const {
    return m_recording;
}
void OAITranscoder_9::setRecording(const bool &recording) {
    m_recording = recording;
    m_recording_isSet = true;
}

bool OAITranscoder_9::is_recording_Set() const{
    return m_recording_isSet;
}

bool OAITranscoder_9::is_recording_Valid() const{
    return m_recording_isValid;
}

bool OAITranscoder_9::isRemoveWatermarkImage() const {
    return m_remove_watermark_image;
}
void OAITranscoder_9::setRemoveWatermarkImage(const bool &remove_watermark_image) {
    m_remove_watermark_image = remove_watermark_image;
    m_remove_watermark_image_isSet = true;
}

bool OAITranscoder_9::is_remove_watermark_image_Set() const{
    return m_remove_watermark_image_isSet;
}

bool OAITranscoder_9::is_remove_watermark_image_Valid() const{
    return m_remove_watermark_image_isValid;
}

QString OAITranscoder_9::getSourceUrl() const {
    return m_source_url;
}
void OAITranscoder_9::setSourceUrl(const QString &source_url) {
    m_source_url = source_url;
    m_source_url_isSet = true;
}

bool OAITranscoder_9::is_source_url_Set() const{
    return m_source_url_isSet;
}

bool OAITranscoder_9::is_source_url_Valid() const{
    return m_source_url_isValid;
}

QString OAITranscoder_9::getStreamExtension() const {
    return m_stream_extension;
}
void OAITranscoder_9::setStreamExtension(const QString &stream_extension) {
    m_stream_extension = stream_extension;
    m_stream_extension_isSet = true;
}

bool OAITranscoder_9::is_stream_extension_Set() const{
    return m_stream_extension_isSet;
}

bool OAITranscoder_9::is_stream_extension_Valid() const{
    return m_stream_extension_isValid;
}

bool OAITranscoder_9::isStreamSmoother() const {
    return m_stream_smoother;
}
void OAITranscoder_9::setStreamSmoother(const bool &stream_smoother) {
    m_stream_smoother = stream_smoother;
    m_stream_smoother_isSet = true;
}

bool OAITranscoder_9::is_stream_smoother_Set() const{
    return m_stream_smoother_isSet;
}

bool OAITranscoder_9::is_stream_smoother_Valid() const{
    return m_stream_smoother_isValid;
}

QString OAITranscoder_9::getStreamSourceId() const {
    return m_stream_source_id;
}
void OAITranscoder_9::setStreamSourceId(const QString &stream_source_id) {
    m_stream_source_id = stream_source_id;
    m_stream_source_id_isSet = true;
}

bool OAITranscoder_9::is_stream_source_id_Set() const{
    return m_stream_source_id_isSet;
}

bool OAITranscoder_9::is_stream_source_id_Valid() const{
    return m_stream_source_id_isValid;
}

bool OAITranscoder_9::isSuppressStreamTargetStart() const {
    return m_suppress_stream_target_start;
}
void OAITranscoder_9::setSuppressStreamTargetStart(const bool &suppress_stream_target_start) {
    m_suppress_stream_target_start = suppress_stream_target_start;
    m_suppress_stream_target_start_isSet = true;
}

bool OAITranscoder_9::is_suppress_stream_target_start_Set() const{
    return m_suppress_stream_target_start_isSet;
}

bool OAITranscoder_9::is_suppress_stream_target_start_Valid() const{
    return m_suppress_stream_target_start_isValid;
}

QString OAITranscoder_9::getUsername() const {
    return m_username;
}
void OAITranscoder_9::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAITranscoder_9::is_username_Set() const{
    return m_username_isSet;
}

bool OAITranscoder_9::is_username_Valid() const{
    return m_username_isValid;
}

bool OAITranscoder_9::isVideoFallback() const {
    return m_video_fallback;
}
void OAITranscoder_9::setVideoFallback(const bool &video_fallback) {
    m_video_fallback = video_fallback;
    m_video_fallback_isSet = true;
}

bool OAITranscoder_9::is_video_fallback_Set() const{
    return m_video_fallback_isSet;
}

bool OAITranscoder_9::is_video_fallback_Valid() const{
    return m_video_fallback_isValid;
}

bool OAITranscoder_9::isWatermark() const {
    return m_watermark;
}
void OAITranscoder_9::setWatermark(const bool &watermark) {
    m_watermark = watermark;
    m_watermark_isSet = true;
}

bool OAITranscoder_9::is_watermark_Set() const{
    return m_watermark_isSet;
}

bool OAITranscoder_9::is_watermark_Valid() const{
    return m_watermark_isValid;
}

qint32 OAITranscoder_9::getWatermarkHeight() const {
    return m_watermark_height;
}
void OAITranscoder_9::setWatermarkHeight(const qint32 &watermark_height) {
    m_watermark_height = watermark_height;
    m_watermark_height_isSet = true;
}

bool OAITranscoder_9::is_watermark_height_Set() const{
    return m_watermark_height_isSet;
}

bool OAITranscoder_9::is_watermark_height_Valid() const{
    return m_watermark_height_isValid;
}

QString OAITranscoder_9::getWatermarkImage() const {
    return m_watermark_image;
}
void OAITranscoder_9::setWatermarkImage(const QString &watermark_image) {
    m_watermark_image = watermark_image;
    m_watermark_image_isSet = true;
}

bool OAITranscoder_9::is_watermark_image_Set() const{
    return m_watermark_image_isSet;
}

bool OAITranscoder_9::is_watermark_image_Valid() const{
    return m_watermark_image_isValid;
}

qint32 OAITranscoder_9::getWatermarkOpacity() const {
    return m_watermark_opacity;
}
void OAITranscoder_9::setWatermarkOpacity(const qint32 &watermark_opacity) {
    m_watermark_opacity = watermark_opacity;
    m_watermark_opacity_isSet = true;
}

bool OAITranscoder_9::is_watermark_opacity_Set() const{
    return m_watermark_opacity_isSet;
}

bool OAITranscoder_9::is_watermark_opacity_Valid() const{
    return m_watermark_opacity_isValid;
}

QString OAITranscoder_9::getWatermarkPosition() const {
    return m_watermark_position;
}
void OAITranscoder_9::setWatermarkPosition(const QString &watermark_position) {
    m_watermark_position = watermark_position;
    m_watermark_position_isSet = true;
}

bool OAITranscoder_9::is_watermark_position_Set() const{
    return m_watermark_position_isSet;
}

bool OAITranscoder_9::is_watermark_position_Valid() const{
    return m_watermark_position_isValid;
}

qint32 OAITranscoder_9::getWatermarkWidth() const {
    return m_watermark_width;
}
void OAITranscoder_9::setWatermarkWidth(const qint32 &watermark_width) {
    m_watermark_width = watermark_width;
    m_watermark_width_isSet = true;
}

bool OAITranscoder_9::is_watermark_width_Set() const{
    return m_watermark_width_isSet;
}

bool OAITranscoder_9::is_watermark_width_Valid() const{
    return m_watermark_width_isValid;
}

bool OAITranscoder_9::isSet() const {
...
bool OAITranscoder_9::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_delivery_method_isValid && m_name_isValid && m_protocol_isValid && true;
}
