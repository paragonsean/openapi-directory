...
#ifndef OAIGeoblock_H
#define OAIGeoblock_H
...
class OAIGeoblock : public OAIObject {
public:
    OAIGeoblock();
    OAIGeoblock(QString json);
    ~OAIGeoblock() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoblock)
