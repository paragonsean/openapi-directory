...
#ifndef OAILimits_1_H
#define OAILimits_1_H
...
class OAILimits_1 : public OAIObject {
public:
    OAILimits_1();
    OAILimits_1(QString json);
    ~OAILimits_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILimits_1)
