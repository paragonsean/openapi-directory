...
/*
 * OAICustom_stream_target.h
 *
 * 
 */

#ifndef OAICustom_stream_target_H
#define OAICustom_stream_target_H
...
class OAICustom_stream_target : public OAIObject {
public:
    OAICustom_stream_target();
    OAICustom_stream_target(QString json);
    ~OAICustom_stream_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustom_stream_target)

#endif // OAICustom_stream_target_H
