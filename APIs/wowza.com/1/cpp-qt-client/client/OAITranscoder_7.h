...
#ifndef OAITranscoder_7_H
#define OAITranscoder_7_H
...
class OAITranscoder_7 : public OAIObject {
public:
    OAITranscoder_7();
    OAITranscoder_7(QString json);
    ~OAITranscoder_7() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscoder_7)

#endif // OAITranscoder_7_H
