...
#ifndef OAITranscoder_4_H
#define OAITranscoder_4_H
...
class OAITranscoder_4 : public OAIObject {
public:
    OAITranscoder_4();
    OAITranscoder_4(QString json);
    ~OAITranscoder_4() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITranscoder_4)

#endif // OAITranscoder_4_H
