...
|------------ | ------------- | ------------- | -------------|
|**createdAt** | **OffsetDateTime** | The date and time that the output stream target was created. |  [optional] |
...
|**updatedAt** | **OffsetDateTime** | The date and time that the output stream target was updated. |  [optional] |
