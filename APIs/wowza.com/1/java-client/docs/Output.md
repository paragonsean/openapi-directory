...
|**createdAt** | **OffsetDateTime** | The date and time that the output rendition was created. |  [optional] |
...
|**streamFormat** | [**StreamFormatEnum**](#StreamFormatEnum) | The contents of the stream. The default is both audio and video (&lt;strong&gt;audiovideo&lt;/strong&gt;). |  [optional] |
|**transcoderId** | **String** | The unique alphanumeric string that identifies the transcoder. |  [optional] |
|**updatedAt** | **OffsetDateTime** | The date and time that the output rendition was updated. |  [optional] |
