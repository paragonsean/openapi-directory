...
|------------ | ------------- | ------------- | -------------|
|**createdAt** | **OffsetDateTime** | The date and time that the recording was created. |  [optional] |
...
|**transcodingUptimeId** | **OffsetDateTime** | The unique identifier associated with the transcoding uptime for this recording. |  [optional] |
|**updatedAt** | **OffsetDateTime** | The date and time that the recording was updated. |  [optional] |
