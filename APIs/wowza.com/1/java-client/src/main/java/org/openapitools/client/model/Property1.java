...
public class Property1 {
  ...
  public Property1 key(String key) {
    this.key = key;
    return this;
  }
  ...
  public Property1 section(String section) {
  ...
  public Property1 value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, property1.key) &&
        Objects.equals(this.section, property1.section) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to Property1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Property1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Property1 is not found in the empty JSON string", Property1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Property1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Property1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Property1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Property1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Property1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Property1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Property1.class));

       return (TypeAdapter<T>) new TypeAdapter<Property1>() {
           @Override
           public void write(JsonWriter out, Property1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Property1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Property1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Property1
   * @throws IOException if the JSON string is invalid with respect to Property1
   */
  public static Property1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Property1.class);
  }

  /**
   * Convert an instance of Property1 to an JSON string
   *
   * @return JSON string
   */
