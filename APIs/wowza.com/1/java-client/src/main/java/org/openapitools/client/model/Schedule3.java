...
public class Schedule3 {
  ...
  public Schedule3 actionType(ActionTypeEnum actionType) {
  ...
  public Schedule3 endRepeat(LocalDate endRepeat) {
  ...
  public Schedule3 recurrenceData(RecurrenceDataEnum recurrenceData) {
  ...
  public Schedule3 recurrenceType(RecurrenceTypeEnum recurrenceType) {
  ...
  public Schedule3 startRepeat(LocalDate startRepeat) {
  ...
  public Schedule3 startTranscoder(OffsetDateTime startTranscoder) {
  ...
  public Schedule3 stopTranscoder(OffsetDateTime stopTranscoder) {
  ...
  public Schedule3 transcoderId(String transcoderId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionType, schedule3.actionType) &&
        Objects.equals(this.endRepeat, schedule3.endRepeat) &&
        Objects.equals(this.name, schedule3.name) &&
        Objects.equals(this.recurrenceData, schedule3.recurrenceData) &&
        Objects.equals(this.recurrenceType, schedule3.recurrenceType) &&
        Objects.equals(this.startRepeat, schedule3.startRepeat) &&
        Objects.equals(this.startTranscoder, schedule3.startTranscoder) &&
        Objects.equals(this.stopTranscoder, schedule3.stopTranscoder) &&
        Objects.equals(this.transcoderId, schedule3.transcoderId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionType, endRepeat, name, recurrenceData, recurrenceType, startRepeat, startTranscoder, stopTranscoder, transcoderId);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("recurrence_type");
    openapiRequiredFields.add("transcoder_id");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Schedule3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Schedule3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Schedule3 is not found in the empty JSON string", Schedule3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Schedule3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Schedule3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Schedule3.openapiRequiredFields) {
      ...
      if (!jsonObj.get("recurrence_type").isJsonPrimitive()) {
      ...
      // validate the required field `recurrence_type`
      RecurrenceTypeEnum.validateJsonElement(jsonObj.get("recurrence_type"));
      if (!jsonObj.get("transcoder_id").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Schedule3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Schedule3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Schedule3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Schedule3.class));

       return (TypeAdapter<T>) new TypeAdapter<Schedule3>() {
           @Override
           public void write(JsonWriter out, Schedule3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Schedule3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Schedule3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Schedule3
   * @throws IOException if the JSON string is invalid with respect to Schedule3
   */
  public static Schedule3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Schedule3.class);
  }

  /**
   * Convert an instance of Schedule3 to an JSON string
   *
   * @return JSON string
   */
