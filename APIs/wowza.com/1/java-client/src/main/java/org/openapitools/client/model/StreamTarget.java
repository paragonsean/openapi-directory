...
public class StreamTarget {
  ...
  public static final String SERIALIZED_NAME_PLAYBACK_URLS = "playback_urls";
  @SerializedName(SERIALIZED_NAME_PLAYBACK_URLS)
  private HashOfPlaybackURLs playbackUrls;
  ...
  public static final String SERIALIZED_NAME_SECURE_INGEST_QUERY_PARAM = "secure_ingest_query_param";
  @SerializedName(SERIALIZED_NAME_SECURE_INGEST_QUERY_PARAM)
  private String secureIngestQueryParam;
  ...
  public StreamTarget chunkSize(ChunkSizeEnum chunkSize) {
  ...
  public StreamTarget enableHls(Boolean enableHls) {
  ...
  public StreamTarget enabled(Boolean enabled) {
  ...
  public StreamTarget ingestIpWhitelist(List<String> ingestIpWhitelist) {
    this.ingestIpWhitelist = ingestIpWhitelist;
    return this;
  }

  public StreamTarget addIngestIpWhitelistItem(String ingestIpWhitelistItem) {
  ...
  public StreamTarget playbackUrls(HashOfPlaybackURLs playbackUrls) {
   ...
   */
  @javax.annotation.Nullable
  public HashOfPlaybackURLs getPlaybackUrls() {
    return playbackUrls;
  }

  public void setPlaybackUrls(HashOfPlaybackURLs playbackUrls) {
    this.playbackUrls = playbackUrls;
  }
  ...
  public StreamTarget regionOverride(RegionOverrideEnum regionOverride) {
  ...
  public StreamTarget sourceDeliveryMethod(SourceDeliveryMethodEnum sourceDeliveryMethod) {
  ...
  public StreamTarget sourceUrl(String sourceUrl) {
  ...
  public StreamTarget useHttps(Boolean useHttps) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backupUrl, streamTarget.backupUrl) &&
        Objects.equals(this.chunkSize, streamTarget.chunkSize) &&
        ...
        Objects.equals(this.enableHls, streamTarget.enableHls) &&
        Objects.equals(this.enabled, streamTarget.enabled) &&
        ...
        Objects.equals(this.ingestIpWhitelist, streamTarget.ingestIpWhitelist) &&
        ...
        Objects.equals(this.playbackUrls, streamTarget.playbackUrls) &&
        Objects.equals(this.primaryUrl, streamTarget.primaryUrl) &&
        Objects.equals(this.provider, streamTarget.provider) &&
        Objects.equals(this.regionOverride, streamTarget.regionOverride) &&
        ...
        Objects.equals(this.sourceDeliveryMethod, streamTarget.sourceDeliveryMethod) &&
        Objects.equals(this.sourceUrl, streamTarget.sourceUrl) &&
        ...
        Objects.equals(this.useHttps, streamTarget.useHttps) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backupUrl, chunkSize, connectionCode, connectionCodeExpiresAt, createdAt, enableHls, enabled, hdsPlaybackUrl, hlsPlaybackUrl, id, ingestIpWhitelist, location, name, password, playbackUrls, primaryUrl, provider, regionOverride, rtmpPlaybackUrl, secureIngestQueryParam, sourceDeliveryMethod, sourceUrl, streamName, type, updatedAt, useCors, useHttps, useSecureIngest, username);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("playback_urls") != null && !jsonObj.get("playback_urls").isJsonNull()) {
        HashOfPlaybackURLs.validateJsonElement(jsonObj.get("playback_urls"));
      }
      ...
      if ((jsonObj.get("secure_ingest_query_param") != null && !jsonObj.get("secure_ingest_query_param").isJsonNull()) && !jsonObj.get("secure_ingest_query_param").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `secure_ingest_query_param` to be a primitive type in the JSON string but got `%s`", jsonObj.get("secure_ingest_query_param").toString()));
      }
      if ((jsonObj.get("source_delivery_method") != null && !jsonObj.get("source_delivery_method").isJsonNull()) && !jsonObj.get("source_delivery_method").isJsonPrimitive()) {
      ...
      // validate the optional field `source_delivery_method`
      if (jsonObj.get("source_delivery_method") != null && !jsonObj.get("source_delivery_method").isJsonNull()) {
