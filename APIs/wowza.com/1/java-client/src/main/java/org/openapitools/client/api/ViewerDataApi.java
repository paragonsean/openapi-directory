...
public class ViewerDataApi {
     ...
     */
    public okhttp3.Call showViewerDataStreamTargetCall(String id, OffsetDateTime from, OffsetDateTime to, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call showViewerDataStreamTargetValidateBeforeCall(String id, OffsetDateTime from, OffsetDateTime to, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling showViewerDataStreamTarget(Async)");
        }

        return showViewerDataStreamTargetCall(id, from, to, _callback);
     ...
     */
    public UsageViewerDataStreamTarget showViewerDataStreamTarget(String id, OffsetDateTime from, OffsetDateTime to) throws ApiException {
        ApiResponse<UsageViewerDataStreamTarget> localVarResp = showViewerDataStreamTargetWithHttpInfo(id, from, to);
    ...
    public ApiResponse<UsageViewerDataStreamTarget> showViewerDataStreamTargetWithHttpInfo(String id, OffsetDateTime from, OffsetDateTime to) throws ApiException {
        okhttp3.Call localVarCall = showViewerDataStreamTargetValidateBeforeCall(id, from, to, null);
     ...
     */
    public okhttp3.Call showViewerDataStreamTargetAsync(String id, OffsetDateTime from, OffsetDateTime to, final ApiCallback<UsageViewerDataStreamTarget> _callback) throws ApiException {

        okhttp3.Call localVarCall = showViewerDataStreamTargetValidateBeforeCall(id, from, to, _callback);
        Type localVarReturnType = new TypeToken<UsageViewerDataStreamTarget>(){}.getType();
