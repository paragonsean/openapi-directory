...
import org.openapitools.client.model.Error422InvalidTimeFormat;
import java.time.OffsetDateTime;
import org.openapitools.client.model.UsageTimeTranscoders;
...
public class ProcessingTimeApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 422 </td><td> Unauthorized </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call usageTimeTranscodersIndexCall(OffsetDateTime from, OffsetDateTime to, String transcoderType, String billingMode, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call usageTimeTranscodersIndexValidateBeforeCall(OffsetDateTime from, OffsetDateTime to, String transcoderType, String billingMode, final ApiCallback _callback) throws ApiException {
        return usageTimeTranscodersIndexCall(from, to, transcoderType, billingMode, _callback);
     ...
     */
    public UsageTimeTranscoders usageTimeTranscodersIndex(OffsetDateTime from, OffsetDateTime to, String transcoderType, String billingMode) throws ApiException {
        ApiResponse<UsageTimeTranscoders> localVarResp = usageTimeTranscodersIndexWithHttpInfo(from, to, transcoderType, billingMode);
    ...
    public ApiResponse<UsageTimeTranscoders> usageTimeTranscodersIndexWithHttpInfo(OffsetDateTime from, OffsetDateTime to, String transcoderType, String billingMode) throws ApiException {
        okhttp3.Call localVarCall = usageTimeTranscodersIndexValidateBeforeCall(from, to, transcoderType, billingMode, null);
     ...
     */
    public okhttp3.Call usageTimeTranscodersIndexAsync(OffsetDateTime from, OffsetDateTime to, String transcoderType, String billingMode, final ApiCallback<UsageTimeTranscoders> _callback) throws ApiException {

        okhttp3.Call localVarCall = usageTimeTranscodersIndexValidateBeforeCall(from, to, transcoderType, billingMode, _callback);
        Type localVarReturnType = new TypeToken<UsageTimeTranscoders>(){}.getType();
