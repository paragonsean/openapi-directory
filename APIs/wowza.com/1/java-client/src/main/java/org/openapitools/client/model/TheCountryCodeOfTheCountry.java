...
public class TheCountryCodeOfTheCountry {
  ...
  public TheCountryCodeOfTheCountry() {
  }
  ...
  public TheCountryCodeOfTheCountry protocols(List<ProtocolObject> protocols) {
    this.protocols = protocols;
    return this;
  }

  public TheCountryCodeOfTheCountry addProtocolsItem(ProtocolObject protocolsItem) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to TheCountryCodeOfTheCountry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TheCountryCodeOfTheCountry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TheCountryCodeOfTheCountry is not found in the empty JSON string", TheCountryCodeOfTheCountry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TheCountryCodeOfTheCountry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TheCountryCodeOfTheCountry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TheCountryCodeOfTheCountry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TheCountryCodeOfTheCountry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TheCountryCodeOfTheCountry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TheCountryCodeOfTheCountry.class));

       return (TypeAdapter<T>) new TypeAdapter<TheCountryCodeOfTheCountry>() {
           @Override
           public void write(JsonWriter out, TheCountryCodeOfTheCountry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TheCountryCodeOfTheCountry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TheCountryCodeOfTheCountry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TheCountryCodeOfTheCountry
   * @throws IOException if the JSON string is invalid with respect to TheCountryCodeOfTheCountry
   */
  public static TheCountryCodeOfTheCountry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TheCountryCodeOfTheCountry.class);
  }

  /**
   * Convert an instance of TheCountryCodeOfTheCountry to an JSON string
   *
   * @return JSON string
   */
