...
public class Transcoder9 {
  ...
  public static final String SERIALIZED_NAME_REMOVE_WATERMARK_IMAGE = "remove_watermark_image";
  @SerializedName(SERIALIZED_NAME_REMOVE_WATERMARK_IMAGE)
  private Boolean removeWatermarkImage;
  ...
  public Transcoder9 broadcastLocation(BroadcastLocationEnum broadcastLocation) {
  ...
  public Transcoder9 bufferSize(BufferSizeEnum bufferSize) {
  ...
  public Transcoder9 closedCaptionType(ClosedCaptionTypeEnum closedCaptionType) {
  ...
  public Transcoder9 deliveryMethod(DeliveryMethodEnum deliveryMethod) {
  ...
  public Transcoder9 deliveryProtocols(List<String> deliveryProtocols) {
    this.deliveryProtocols = deliveryProtocols;
    return this;
  }

  public Transcoder9 addDeliveryProtocolsItem(String deliveryProtocolsItem) {
  ...
  public Transcoder9 description(String description) {
  ...
  public Transcoder9 disableAuthentication(Boolean disableAuthentication) {
  ...
  public Transcoder9 idleTimeout(Integer idleTimeout) {
  ...
  public Transcoder9 lowLatency(Boolean lowLatency) {
  ...
  public Transcoder9 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Transcoder9 password(String password) {
  ...
  public Transcoder9 playMaximumConnections(PlayMaximumConnectionsEnum playMaximumConnections) {
  ...
  public Transcoder9 protocol(ProtocolEnum protocol) {
  ...
  public Transcoder9 recording(Boolean recording) {
  ...
  public Transcoder9 removeWatermarkImage(Boolean removeWatermarkImage) {
    this.removeWatermarkImage = removeWatermarkImage;
    return this;
  }

  /**
   * If &lt;strong&gt;true&lt;/strong&gt;, removes the watermark from the output. The default is &lt;strong&gt;false&lt;/strong&gt;.
   * @return removeWatermarkImage
   */
  @javax.annotation.Nullable
  public Boolean getRemoveWatermarkImage() {
    return removeWatermarkImage;
  }

  public void setRemoveWatermarkImage(Boolean removeWatermarkImage) {
    this.removeWatermarkImage = removeWatermarkImage;
  }


  public Transcoder9 sourceUrl(String sourceUrl) {
  ...
  public Transcoder9 streamExtension(String streamExtension) {
  ...
  public Transcoder9 streamSmoother(Boolean streamSmoother) {
  ...
  public Transcoder9 streamSourceId(String streamSourceId) {
  ...
  public Transcoder9 suppressStreamTargetStart(Boolean suppressStreamTargetStart) {
  ...
  public Transcoder9 username(String username) {
  ...
  public Transcoder9 videoFallback(Boolean videoFallback) {
  ...
  public Transcoder9 watermark(Boolean watermark) {
  ...
  public Transcoder9 watermarkHeight(Integer watermarkHeight) {
  ...
  public Transcoder9 watermarkImage(String watermarkImage) {
  ...
  public Transcoder9 watermarkOpacity(WatermarkOpacityEnum watermarkOpacity) {
  ...
  public Transcoder9 watermarkPosition(WatermarkPositionEnum watermarkPosition) {
  ...
  public Transcoder9 watermarkWidth(Integer watermarkWidth) {
  ...
  public boolean equals(Object o) {
    ...
    Transcoder9 transcoder9 = (Transcoder9) o;
    return Objects.equals(this.broadcastLocation, transcoder9.broadcastLocation) &&
        Objects.equals(this.bufferSize, transcoder9.bufferSize) &&
        Objects.equals(this.closedCaptionType, transcoder9.closedCaptionType) &&
        Objects.equals(this.deliveryMethod, transcoder9.deliveryMethod) &&
        Objects.equals(this.deliveryProtocols, transcoder9.deliveryProtocols) &&
        Objects.equals(this.description, transcoder9.description) &&
        Objects.equals(this.disableAuthentication, transcoder9.disableAuthentication) &&
        Objects.equals(this.idleTimeout, transcoder9.idleTimeout) &&
        Objects.equals(this.lowLatency, transcoder9.lowLatency) &&
        Objects.equals(this.name, transcoder9.name) &&
        Objects.equals(this.password, transcoder9.password) &&
        Objects.equals(this.playMaximumConnections, transcoder9.playMaximumConnections) &&
        Objects.equals(this.protocol, transcoder9.protocol) &&
        Objects.equals(this.recording, transcoder9.recording) &&
        Objects.equals(this.removeWatermarkImage, transcoder9.removeWatermarkImage) &&
        Objects.equals(this.sourceUrl, transcoder9.sourceUrl) &&
        Objects.equals(this.streamExtension, transcoder9.streamExtension) &&
        Objects.equals(this.streamSmoother, transcoder9.streamSmoother) &&
        Objects.equals(this.streamSourceId, transcoder9.streamSourceId) &&
        Objects.equals(this.suppressStreamTargetStart, transcoder9.suppressStreamTargetStart) &&
        Objects.equals(this.username, transcoder9.username) &&
        Objects.equals(this.videoFallback, transcoder9.videoFallback) &&
        Objects.equals(this.watermark, transcoder9.watermark) &&
        Objects.equals(this.watermarkHeight, transcoder9.watermarkHeight) &&
        Objects.equals(this.watermarkImage, transcoder9.watermarkImage) &&
        Objects.equals(this.watermarkOpacity, transcoder9.watermarkOpacity) &&
        Objects.equals(this.watermarkPosition, transcoder9.watermarkPosition) &&
        Objects.equals(this.watermarkWidth, transcoder9.watermarkWidth);
  }

  @Override
  public int hashCode() {
    return Objects.hash(broadcastLocation, bufferSize, closedCaptionType, deliveryMethod, deliveryProtocols, description, disableAuthentication, idleTimeout, lowLatency, name, password, playMaximumConnections, protocol, recording, removeWatermarkImage, sourceUrl, streamExtension, streamSmoother, streamSourceId, suppressStreamTargetStart, username, videoFallback, watermark, watermarkHeight, watermarkImage, watermarkOpacity, watermarkPosition, watermarkWidth);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Transcoder9 {\n");
    ...
    sb.append("    removeWatermarkImage: ").append(toIndentedString(removeWatermarkImage)).append("\n");
  ...
  static {
    ...
    openapiFields.add("remove_watermark_image");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Transcoder9
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Transcoder9.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Transcoder9 is not found in the empty JSON string", Transcoder9.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Transcoder9.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Transcoder9` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Transcoder9.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Transcoder9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Transcoder9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Transcoder9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Transcoder9.class));

       return (TypeAdapter<T>) new TypeAdapter<Transcoder9>() {
           @Override
           public void write(JsonWriter out, Transcoder9 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Transcoder9 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Transcoder9 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Transcoder9
   * @throws IOException if the JSON string is invalid with respect to Transcoder9
   */
  public static Transcoder9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Transcoder9.class);
  }

  /**
   * Convert an instance of Transcoder9 to an JSON string
   *
   * @return JSON string
   */
