...
public class Player3 {
  ...
  public static final String SERIALIZED_NAME_LOGO_IMAGE = "logo_image";
  ...
  public static final String SERIALIZED_NAME_REMOVE_LOGO_IMAGE = "remove_logo_image";
  @SerializedName(SERIALIZED_NAME_REMOVE_LOGO_IMAGE)
  private Boolean removeLogoImage;

  public static final String SERIALIZED_NAME_REMOVE_VIDEO_POSTER_IMAGE = "remove_video_poster_image";
  @SerializedName(SERIALIZED_NAME_REMOVE_VIDEO_POSTER_IMAGE)
  private Boolean removeVideoPosterImage;
  ...
  public static final String SERIALIZED_NAME_VIDEO_POSTER_IMAGE = "video_poster_image";
  @SerializedName(SERIALIZED_NAME_VIDEO_POSTER_IMAGE)
  ...
  public Player3 countdown(Boolean countdown) {
  ...
  public Player3 countdownAt(OffsetDateTime countdownAt) {
  ...
  public Player3 hostedPage(Boolean hostedPage) {
  ...
  public Player3 hostedPageDescription(String hostedPageDescription) {
  ...
  public Player3 hostedPageLogoImage(String hostedPageLogoImage) {
  ...
  public Player3 hostedPageSharingIcons(Boolean hostedPageSharingIcons) {
  ...
  public Player3 hostedPageTitle(String hostedPageTitle) {
  ...
  public Player3 logoImage(String logoImage) {
  ...
  public Player3 logoPosition(String logoPosition) {
  ...
  public Player3 removeHostedPageLogoImage(Boolean removeHostedPageLogoImage) {
  ...
  public Player3 removeLogoImage(Boolean removeLogoImage) {
    this.removeLogoImage = removeLogoImage;
    return this;
  }

  /**
   * If &lt;strong&gt;true&lt;/strong&gt;, removes the logo file from the output. The default is &lt;strong&gt;false&lt;/strong&gt;.
   * @return removeLogoImage
   */
  @javax.annotation.Nullable
  public Boolean getRemoveLogoImage() {
    return removeLogoImage;
  }

  public void setRemoveLogoImage(Boolean removeLogoImage) {
    this.removeLogoImage = removeLogoImage;
  }


  public Player3 removeVideoPosterImage(Boolean removeVideoPosterImage) {
    this.removeVideoPosterImage = removeVideoPosterImage;
    return this;
  }

  /**
   * If &lt;strong&gt;true&lt;/strong&gt;, removes the poster image from the output. The default is &lt;strong&gt;false&lt;/strong&gt;.
   * @return removeVideoPosterImage
   */
  @javax.annotation.Nullable
  public Boolean getRemoveVideoPosterImage() {
    return removeVideoPosterImage;
  }

  public void setRemoveVideoPosterImage(Boolean removeVideoPosterImage) {
    this.removeVideoPosterImage = removeVideoPosterImage;
  }


  public Player3 responsive(Boolean responsive) {
  ...
  public Player3 type(String type) {
    this.type = type;
    return this;
  }
  ...
  public Player3 videoPosterImage(String videoPosterImage) {
  ...
  public Player3 width(Integer width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Player3 player3 = (Player3) o;
    return Objects.equals(this.countdown, player3.countdown) &&
        Objects.equals(this.countdownAt, player3.countdownAt) &&
        Objects.equals(this.hostedPage, player3.hostedPage) &&
        Objects.equals(this.hostedPageDescription, player3.hostedPageDescription) &&
        Objects.equals(this.hostedPageLogoImage, player3.hostedPageLogoImage) &&
        Objects.equals(this.hostedPageSharingIcons, player3.hostedPageSharingIcons) &&
        Objects.equals(this.hostedPageTitle, player3.hostedPageTitle) &&
        Objects.equals(this.logoImage, player3.logoImage) &&
        Objects.equals(this.logoPosition, player3.logoPosition) &&
        Objects.equals(this.removeHostedPageLogoImage, player3.removeHostedPageLogoImage) &&
        Objects.equals(this.removeLogoImage, player3.removeLogoImage) &&
        Objects.equals(this.removeVideoPosterImage, player3.removeVideoPosterImage) &&
        Objects.equals(this.responsive, player3.responsive) &&
        Objects.equals(this.type, player3.type) &&
        Objects.equals(this.videoPosterImage, player3.videoPosterImage) &&
        Objects.equals(this.width, player3.width);
  }

  @Override
  public int hashCode() {
    return Objects.hash(countdown, countdownAt, hostedPage, hostedPageDescription, hostedPageLogoImage, hostedPageSharingIcons, hostedPageTitle, logoImage, logoPosition, removeHostedPageLogoImage, removeLogoImage, removeVideoPosterImage, responsive, type, videoPosterImage, width);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Player3 {\n");
    ...
    sb.append("    removeLogoImage: ").append(toIndentedString(removeLogoImage)).append("\n");
    sb.append("    removeVideoPosterImage: ").append(toIndentedString(removeVideoPosterImage)).append("\n");
    sb.append("    responsive: ").append(toIndentedString(responsive)).append("\n");
    sb.append("    type: ").append(toIndentedString(type)).append("\n");
    sb.append("    videoPosterImage: ").append(toIndentedString(videoPosterImage)).append("\n");
  ...
  static {
    ...
    openapiFields.add("logo_image");
    openapiFields.add("logo_position");
    openapiFields.add("remove_hosted_page_logo_image");
    openapiFields.add("remove_logo_image");
    openapiFields.add("remove_video_poster_image");
    openapiFields.add("responsive");
    openapiFields.add("type");
    openapiFields.add("video_poster_image");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Player3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Player3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Player3 is not found in the empty JSON string", Player3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Player3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Player3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("logo_image") != null && !jsonObj.get("logo_image").isJsonNull()) && !jsonObj.get("logo_image").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `logo_image` to be a primitive type in the JSON string but got `%s`", jsonObj.get("logo_image").toString()));
      }
      ...
      if ((jsonObj.get("video_poster_image") != null && !jsonObj.get("video_poster_image").isJsonNull()) && !jsonObj.get("video_poster_image").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `video_poster_image` to be a primitive type in the JSON string but got `%s`", jsonObj.get("video_poster_image").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Player3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Player3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Player3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Player3.class));

       return (TypeAdapter<T>) new TypeAdapter<Player3>() {
           @Override
           public void write(JsonWriter out, Player3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Player3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Player3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Player3
   * @throws IOException if the JSON string is invalid with respect to Player3
   */
  public static Player3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Player3.class);
  }

  /**
   * Convert an instance of Player3 to an JSON string
   *
   * @return JSON string
   */
