...
import org.openapitools.client.model.StreamTarget;
...
public class OutputStreamTarget {
  ...
  public static final String SERIALIZED_NAME_USE_STREAM_TARGET_BACKUP_URL = "use_stream_target_backup_url";
  @SerializedName(SERIALIZED_NAME_USE_STREAM_TARGET_BACKUP_URL)
  private Boolean useStreamTargetBackupUrl;
   ...
   */
  @javax.annotation.Nullable
  public Boolean getUseStreamTargetBackupUrl() {
    return useStreamTargetBackupUrl;
  }
  ...
  static {
    ...
    openapiFields.add("output_id");
    openapiFields.add("stream_target");
    openapiFields.add("stream_target_id");
    openapiFields.add("updated_at");
    openapiFields.add("use_stream_target_backup_url");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OutputStreamTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OutputStreamTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OutputStreamTarget is not found in the empty JSON string", OutputStreamTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OutputStreamTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OutputStreamTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("output_id") != null && !jsonObj.get("output_id").isJsonNull()) && !jsonObj.get("output_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `output_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("output_id").toString()));
      }
      // validate the optional field `stream_target`
      if (jsonObj.get("stream_target") != null && !jsonObj.get("stream_target").isJsonNull()) {
        StreamTarget.validateJsonElement(jsonObj.get("stream_target"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OutputStreamTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OutputStreamTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OutputStreamTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OutputStreamTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<OutputStreamTarget>() {
           @Override
           public void write(JsonWriter out, OutputStreamTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OutputStreamTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OutputStreamTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OutputStreamTarget
   * @throws IOException if the JSON string is invalid with respect to OutputStreamTarget
   */
  public static OutputStreamTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OutputStreamTarget.class);
  }

  /**
   * Convert an instance of OutputStreamTarget to an JSON string
   *
   * @return JSON string
   */
