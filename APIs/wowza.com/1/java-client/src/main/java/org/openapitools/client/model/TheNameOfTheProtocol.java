...
public class TheNameOfTheProtocol {
   ...
   * @throws IOException if the JSON Element is invalid with respect to TheNameOfTheProtocol
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TheNameOfTheProtocol.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TheNameOfTheProtocol is not found in the empty JSON string", TheNameOfTheProtocol.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TheNameOfTheProtocol.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TheNameOfTheProtocol` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TheNameOfTheProtocol.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TheNameOfTheProtocol' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TheNameOfTheProtocol> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TheNameOfTheProtocol.class));

       return (TypeAdapter<T>) new TypeAdapter<TheNameOfTheProtocol>() {
           @Override
           public void write(JsonWriter out, TheNameOfTheProtocol value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TheNameOfTheProtocol read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TheNameOfTheProtocol given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TheNameOfTheProtocol
   * @throws IOException if the JSON string is invalid with respect to TheNameOfTheProtocol
   */
  public static TheNameOfTheProtocol fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TheNameOfTheProtocol.class);
  }

  /**
   * Convert an instance of TheNameOfTheProtocol to an JSON string
   *
   * @return JSON string
   */
