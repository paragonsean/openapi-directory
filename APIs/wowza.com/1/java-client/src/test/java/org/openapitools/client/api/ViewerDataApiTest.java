...
import org.openapitools.client.model.UsageViewerDataStreamTarget;
...
/**
 * API tests for ViewerDataApi
 */
@Disabled
public class ViewerDataApiTest {

    private final ViewerDataApi api = new ViewerDataApi();
     ...
     */
    @Test
    public void showViewerDataStreamTargetTest() throws ApiException {
        String id = null;
        OffsetDateTime from = null;
        OffsetDateTime to = null;
        UsageViewerDataStreamTarget response = api.showViewerDataStreamTarget(id, from, to);
