...
export default class StorageApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the usageStoragePeakRecordingIndex operation.
     * @callback module:api/StorageApi~usageStoragePeakRecordingIndexCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UsageStoragePeakRecording} data The data returned by the service call.
     ...
     * @param {module:api/StorageApi~usageStoragePeakRecordingIndexCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UsageStoragePeakRecording}
     */
    usageStoragePeakRecordingIndex(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = UsageStoragePeakRecording;
      return this.apiClient.callApi(
        '/usage/storage/peak_recording', 'GET',
