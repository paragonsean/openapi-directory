...
/**
* ViewerData service.
* @module api/ViewerDataApi
* @version 1
*/
export default class ViewerDataApi {

    /**
    * Constructs a new ViewerDataApi. 
    * @alias module:api/ViewerDataApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the showViewerDataStreamTarget operation.
     * @callback module:api/ViewerDataApi~showViewerDataStreamTargetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UsageViewerDataStreamTarget} data The data returned by the service call.
     ...
     * @param {module:api/ViewerDataApi~showViewerDataStreamTargetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UsageViewerDataStreamTarget}
     */
    showViewerDataStreamTarget(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showViewerDataStreamTarget");
      }
      ...
      let returnType = UsageViewerDataStreamTarget;
      return this.apiClient.callApi(
        '/usage/viewer_data/stream_targets/{id}', 'GET',
