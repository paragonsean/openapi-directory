...
/**
* ProcessingTime service.
* @module api/ProcessingTimeApi
* @version 1
*/
export default class ProcessingTimeApi {

    /**
    * Constructs a new ProcessingTimeApi. 
    * @alias module:api/ProcessingTimeApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the usageTimeTranscodersIndex operation.
     * @callback module:api/ProcessingTimeApi~usageTimeTranscodersIndexCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UsageTimeTranscoders} data The data returned by the service call.
     ...
     * @param {module:api/ProcessingTimeApi~usageTimeTranscodersIndexCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UsageTimeTranscoders}
     */
    usageTimeTranscodersIndex(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = UsageTimeTranscoders;
      return this.apiClient.callApi(
        '/usage/time/transcoders', 'GET',
