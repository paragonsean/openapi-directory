...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api-sandbox.cloud.wowza.com/api/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api-sandbox.cloud.wowza.com/api/v1
         */
        ...
        this.authentications = {
            'wsc-access-key': {type: 'apiKey', 'in': 'header', name: 'wsc-access-key'},
            'wsc-api-key': {type: 'apiKey', 'in': 'header', name: 'wsc-api-key'}
        }
