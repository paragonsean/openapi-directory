...
/**
 * The Geoblock model module.
 * @module model/Geoblock
 * @version 1
 */
class Geoblock {
    /**
     * Constructs a new <code>Geoblock</code>.
     * @alias module:model/Geoblock
     */
    constructor() { 
        
        Geoblock.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Geoblock</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Geoblock} obj Optional instance to populate.
     * @return {module:model/Geoblock} The populated <code>Geoblock</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Geoblock();
    ...
    /**
     * Validates the JSON data with respect to <code>Geoblock</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Geoblock</code>.
     */
 ...
 */
Geoblock.prototype['countries'] = undefined;

/**
 * The date and time that the geo-blocking rendition was created.
 * @member {Date} created_at
 */
Geoblock.prototype['created_at'] = undefined;

/**
 * The state of the geo-blocking.
 * @member {module:model/Geoblock.StateEnum} state
 */
Geoblock.prototype['state'] = undefined;

/**
 * The unique alphanumeric string that identifies the stream target.
 * @member {String} stream_target_id
 */
Geoblock.prototype['stream_target_id'] = undefined;
 ...
 * @member {module:model/Geoblock.TypeEnum} type
 */
Geoblock.prototype['type'] = undefined;

/**
 * The date and time that the geo-blocking rendition was updated.
 * @member {Date} updated_at
 */
Geoblock.prototype['updated_at'] = undefined;
 ...
 */
Geoblock.prototype['whitelist'] = undefined;
