...
class Outputs {
     ...
     * @param outputs {Array.<module:model/Output>} 
     */
    constructor(outputs) { 
        
        Outputs.initialize(this, outputs);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Outputs.RequiredProperties) {
...
Outputs.RequiredProperties = ["outputs"];

/**
 * @member {Array.<module:model/Output>} outputs
 */
Outputs.prototype['outputs'] = undefined;
