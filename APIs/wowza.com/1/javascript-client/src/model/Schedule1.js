...
class Schedule1 {
    ...
    /**
     * Validates the JSON data with respect to <code>Schedule1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Schedule1</code>.
     */
 ...
 * @member {module:model/Schedule1.StateEnum} state
 */
Schedule1.prototype['state'] = undefined;
