...
/**
 * The Transcoder9 model module.
 * @module model/Transcoder9
 * @version 1
 */
class Transcoder9 {
    /**
     * Constructs a new <code>Transcoder9</code>.
     * @alias module:model/Transcoder9
     * @param deliveryMethod {module:model/Transcoder9.DeliveryMethodEnum} The type of connection between the source encoder and the transcoder. The default, <strong>pull</strong>, instructs the transcoder to pull the video from the source. <strong>push</strong> instructs the source to push the stream to the transcoder. <strong>cdn</strong> uses a stream source to deliver the stream to the transcoder.
     * @param name {String} A descriptive name for the transcoder. Maximum 200 characters.
     * @param protocol {module:model/Transcoder9.ProtocolEnum} The transport protocol for the source video. The default is <strong>rtmp</strong>.
     */
    constructor(deliveryMethod, name, protocol) { 
        
        Transcoder9.initialize(this, deliveryMethod, name, protocol);
    }
     ...
     */
    static initialize(obj, deliveryMethod, name, protocol) { 
    ...
    /**
     * Constructs a <code>Transcoder9</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Transcoder9} obj Optional instance to populate.
     * @return {module:model/Transcoder9} The populated <code>Transcoder9</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Transcoder9();
            ...
            if (data.hasOwnProperty('remove_watermark_image')) {
                obj['remove_watermark_image'] = ApiClient.convertToType(data['remove_watermark_image'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('watermark_image')) {
                obj['watermark_image'] = ApiClient.convertToType(data['watermark_image'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Transcoder9</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Transcoder9</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Transcoder9.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['watermark_image'] && !(typeof data['watermark_image'] === 'string' || data['watermark_image'] instanceof String)) {
            throw new Error("Expected the field `watermark_image` to be a primitive type in the JSON string but got " + data['watermark_image']);
        }
        // ensure the json data is a string
...
Transcoder9.RequiredProperties = ["delivery_method", "name", "protocol"];
 ...
 * @member {module:model/Transcoder9.BroadcastLocationEnum} broadcast_location
 */
Transcoder9.prototype['broadcast_location'] = undefined;
 ...
 * @member {module:model/Transcoder9.BufferSizeEnum} buffer_size
 */
Transcoder9.prototype['buffer_size'] = undefined;
 ...
 * @member {module:model/Transcoder9.ClosedCaptionTypeEnum} closed_caption_type
 */
Transcoder9.prototype['closed_caption_type'] = undefined;
 ...
 * @member {module:model/Transcoder9.DeliveryMethodEnum} delivery_method
 */
Transcoder9.prototype['delivery_method'] = undefined;
 ...
 */
Transcoder9.prototype['delivery_protocols'] = undefined;

/**
 * An optional description of the transcoder.
 * @member {String} description
 */
Transcoder9.prototype['description'] = undefined;
 ...
 */
Transcoder9.prototype['disable_authentication'] = undefined;
 ...
 */
Transcoder9.prototype['idle_timeout'] = undefined;
 ...
 */
Transcoder9.prototype['low_latency'] = undefined;

/**
 * A descriptive name for the transcoder. Maximum 200 characters.
 * @member {String} name
 */
Transcoder9.prototype['name'] = undefined;
 ...
 */
Transcoder9.prototype['password'] = undefined;

/**
 * The number of users who are allowed to connect directly to the transcoder.
 * @member {module:model/Transcoder9.PlayMaximumConnectionsEnum} play_maximum_connections
 */
Transcoder9.prototype['play_maximum_connections'] = undefined;

/**
 * The transport protocol for the source video. The default is <strong>rtmp</strong>.
 * @member {module:model/Transcoder9.ProtocolEnum} protocol
 */
Transcoder9.prototype['protocol'] = undefined;
 ...
 */
Transcoder9.prototype['recording'] = undefined;

/**
 * If <strong>true</strong>, removes the watermark from the output. The default is <strong>false</strong>.
 * @member {Boolean} remove_watermark_image
 */
Transcoder9.prototype['remove_watermark_image'] = undefined;
 ...
 */
Transcoder9.prototype['source_url'] = undefined;
 ...
 */
Transcoder9.prototype['stream_extension'] = undefined;
 ...
 */
Transcoder9.prototype['stream_smoother'] = undefined;
 ...
 */
Transcoder9.prototype['stream_source_id'] = undefined;
 ...
 */
Transcoder9.prototype['suppress_stream_target_start'] = undefined;
 ...
 */
Transcoder9.prototype['username'] = undefined;
 ...
 */
Transcoder9.prototype['video_fallback'] = undefined;
 ...
 */
Transcoder9.prototype['watermark'] = undefined;
 ...
 */
Transcoder9.prototype['watermark_height'] = undefined;
 ...
 * @member {String} watermark_image
 */
Transcoder9.prototype['watermark_image'] = undefined;
 ...
 * @member {module:model/Transcoder9.WatermarkOpacityEnum} watermark_opacity
 */
Transcoder9.prototype['watermark_opacity'] = undefined;

/**
 * The corner of the video frame in which you want the watermark to appear. The default is <strong>top-left</strong>.
 * @member {module:model/Transcoder9.WatermarkPositionEnum} watermark_position
 */
Transcoder9.prototype['watermark_position'] = undefined;
 ...
 */
Transcoder9.prototype['watermark_width'] = undefined;
 ...
 * @readonly
 */
Transcoder9['BroadcastLocationEnum'] = {
 ...
 * @readonly
 */
Transcoder9['ClosedCaptionTypeEnum'] = {
 ...
 * @readonly
 */
Transcoder9['DeliveryMethodEnum'] = {
 ...
 * @readonly
 */
Transcoder9['PlayMaximumConnectionsEnum'] = {
 ...
 * @readonly
 */
Transcoder9['WatermarkOpacityEnum'] = {
 ...
 * @readonly
 */
Transcoder9['WatermarkPositionEnum'] = {
