...
/**
 * The CpuMetric model module.
 * @module model/CpuMetric
 * @version 1
 */
class CpuMetric {
    /**
     * Constructs a new <code>CpuMetric</code>.
     * @alias module:model/CpuMetric
     */
    constructor() { 
        
        CpuMetric.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CpuMetric</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CpuMetric} obj Optional instance to populate.
     * @return {module:model/CpuMetric} The populated <code>CpuMetric</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CpuMetric();
    ...
    /**
     * Validates the JSON data with respect to <code>CpuMetric</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CpuMetric</code>.
     */
 ...
 * @member {String} units
 */
CpuMetric.prototype['units'] = undefined;

/**
 * The value of the associated key.
 * @member {Number} value
 */
CpuMetric.prototype['value'] = undefined;
