...
class Player1 {
    ...
    /**
     * Validates the JSON data with respect to <code>Player1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Player1</code>.
     */
 ...
 * @member {module:model/Player1.StateEnum} state
 */
Player1.prototype['state'] = undefined;
