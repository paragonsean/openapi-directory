...
/**
 * The Transcoder8 model module.
 * @module model/Transcoder8
 * @version 1
 */
class Transcoder8 {
    /**
     * Constructs a new <code>Transcoder8</code>.
     * @alias module:model/Transcoder8
     * @param billingMode {module:model/Transcoder8.BillingModeEnum} The billing mode for the transcoder. The default is <strong>pay_as_you_go</strong>.
     * @param broadcastLocation {module:model/Transcoder8.BroadcastLocationEnum} The location where Wowza Streaming Cloud transcodes your stream. Choose a location as close as possible to your video source.
     * @param deliveryMethod {module:model/Transcoder8.DeliveryMethodEnum} The type of connection between the source encoder and the transcoder. The default, <strong>pull</strong>, instructs the transcoder to pull the video from the source. <strong>push</strong> instructs the source to push the stream to the transcoder. <strong>cdn</strong> uses a stream source to deliver the stream to the transcoder.
     * @param name {String} A descriptive name for the transcoder. Maximum 200 characters.
     * @param protocol {module:model/Transcoder8.ProtocolEnum} The transport protocol for the source video. The default is <strong>rtmp</strong>.
     * @param transcoderType {module:model/Transcoder8.TranscoderTypeEnum} The type of transcoder, either <strong>transcoded</strong> for streams that are transcoded into adaptive bitrate renditions or <strong>passthrough</strong> for streams that aren't processed by the transcoder. The default is <strong>transcoded</strong>.
     */
    constructor(billingMode, broadcastLocation, deliveryMethod, name, protocol, transcoderType) { 
        
        Transcoder8.initialize(this, billingMode, broadcastLocation, deliveryMethod, name, protocol, transcoderType);
    }
     ...
     */
    static initialize(obj, billingMode, broadcastLocation, deliveryMethod, name, protocol, transcoderType) { 
    ...
    /**
     * Constructs a <code>Transcoder8</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Transcoder8} obj Optional instance to populate.
     * @return {module:model/Transcoder8} The populated <code>Transcoder8</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Transcoder8();
    ...
    /**
     * Validates the JSON data with respect to <code>Transcoder8</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Transcoder8</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Transcoder8.RequiredProperties) {
...
Transcoder8.RequiredProperties = ["billing_mode", "broadcast_location", "delivery_method", "name", "protocol", "transcoder_type"];

/**
 * The billing mode for the transcoder. The default is <strong>pay_as_you_go</strong>.
 * @member {module:model/Transcoder8.BillingModeEnum} billing_mode
 */
Transcoder8.prototype['billing_mode'] = undefined;
 ...
 * @member {module:model/Transcoder8.BroadcastLocationEnum} broadcast_location
 */
Transcoder8.prototype['broadcast_location'] = undefined;
 ...
 * @member {module:model/Transcoder8.BufferSizeEnum} buffer_size
 */
Transcoder8.prototype['buffer_size'] = undefined;
 ...
 * @member {module:model/Transcoder8.ClosedCaptionTypeEnum} closed_caption_type
 */
Transcoder8.prototype['closed_caption_type'] = undefined;
 ...
 * @member {module:model/Transcoder8.DeliveryMethodEnum} delivery_method
 */
Transcoder8.prototype['delivery_method'] = undefined;
 ...
 */
Transcoder8.prototype['delivery_protocols'] = undefined;

/**
 * An optional description of the transcoder.
 * @member {String} description
 */
Transcoder8.prototype['description'] = undefined;
 ...
 */
Transcoder8.prototype['disable_authentication'] = undefined;
 ...
 */
Transcoder8.prototype['idle_timeout'] = undefined;
 ...
 */
Transcoder8.prototype['low_latency'] = undefined;

/**
 * A descriptive name for the transcoder. Maximum 200 characters.
 * @member {String} name
 */
Transcoder8.prototype['name'] = undefined;
 ...
 */
Transcoder8.prototype['password'] = undefined;

/**
 * The number of users who are allowed to connect directly to the transcoder.
 * @member {module:model/Transcoder8.PlayMaximumConnectionsEnum} play_maximum_connections
 */
Transcoder8.prototype['play_maximum_connections'] = undefined;

/**
 * The transport protocol for the source video. The default is <strong>rtmp</strong>.
 * @member {module:model/Transcoder8.ProtocolEnum} protocol
 */
Transcoder8.prototype['protocol'] = undefined;
 ...
 */
Transcoder8.prototype['recording'] = undefined;
 ...
 */
Transcoder8.prototype['source_url'] = undefined;
 ...
 */
Transcoder8.prototype['stream_extension'] = undefined;
 ...
 */
Transcoder8.prototype['stream_smoother'] = undefined;
 ...
 */
Transcoder8.prototype['stream_source_id'] = undefined;
 ...
 */
Transcoder8.prototype['suppress_stream_target_start'] = undefined;
 ...
 * @member {module:model/Transcoder8.TranscoderTypeEnum} transcoder_type
 */
Transcoder8.prototype['transcoder_type'] = undefined;
 ...
 */
Transcoder8.prototype['username'] = undefined;
 ...
 */
Transcoder8.prototype['video_fallback'] = undefined;
 ...
 */
Transcoder8.prototype['watermark'] = undefined;
 ...
 */
Transcoder8.prototype['watermark_height'] = undefined;
 ...
 */
Transcoder8.prototype['watermark_image'] = undefined;
 ...
 * @member {module:model/Transcoder8.WatermarkOpacityEnum} watermark_opacity
 */
Transcoder8.prototype['watermark_opacity'] = undefined;

/**
 * The corner of the video frame in which you want the watermark to appear. The default is <strong>top-left</strong>.
 * @member {module:model/Transcoder8.WatermarkPositionEnum} watermark_position
 */
Transcoder8.prototype['watermark_position'] = undefined;
 ...
 */
Transcoder8.prototype['watermark_width'] = undefined;
 ...
 * @readonly
 */
Transcoder8['BroadcastLocationEnum'] = {
 ...
 * @readonly
 */
Transcoder8['ClosedCaptionTypeEnum'] = {
 ...
 * @readonly
 */
Transcoder8['DeliveryMethodEnum'] = {
 ...
 * @readonly
 */
Transcoder8['PlayMaximumConnectionsEnum'] = {
 ...
 * @readonly
 */
Transcoder8['TranscoderTypeEnum'] = {
 ...
 * @readonly
 */
Transcoder8['WatermarkOpacityEnum'] = {
 ...
 * @readonly
 */
Transcoder8['WatermarkPositionEnum'] = {
