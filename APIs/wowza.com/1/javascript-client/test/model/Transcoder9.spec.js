...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WowzaStreamingCloudRestApiReferenceDocumentation.Transcoder9();
  });
  ...
  describe('Transcoder9', function() {
    it('should create an instance of Transcoder9', function() {
      // uncomment below and update the code to test Transcoder9
      //var instance = new WowzaStreamingCloudRestApiReferenceDocumentation.Transcoder9();
      //expect(instance).to.be.a(WowzaStreamingCloudRestApiReferenceDocumentation.Transcoder9);
    });
    ...
    it('should have the property removeWatermarkImage (base name: "remove_watermark_image")', function() {
      // uncomment below and update the code to test the property removeWatermarkImage
      //var instance = new WowzaStreamingCloudRestApiReferenceDocumentation.Transcoder9();
      //expect(instance).to.be();
    });
