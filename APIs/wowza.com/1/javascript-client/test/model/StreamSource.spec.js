...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WowzaStreamingCloudRestApiReferenceDocumentation.StreamSource();
  });
  ...
  describe('StreamSource', function() {
    it('should create an instance of StreamSource', function() {
      // uncomment below and update the code to test StreamSource
      //var instance = new WowzaStreamingCloudRestApiReferenceDocumentation.StreamSource();
      //expect(instance).to.be.a(WowzaStreamingCloudRestApiReferenceDocumentation.StreamSource);
    });
