...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WowzaStreamingCloudRestApiReferenceDocumentation.Geoblock1();
  });
  ...
  describe('Geoblock1', function() {
    it('should create an instance of Geoblock1', function() {
      // uncomment below and update the code to test Geoblock1
      //var instance = new WowzaStreamingCloudRestApiReferenceDocumentation.Geoblock1();
      //expect(instance).to.be.a(WowzaStreamingCloudRestApiReferenceDocumentation.Geoblock1);
    });
