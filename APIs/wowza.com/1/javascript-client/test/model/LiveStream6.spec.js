...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WowzaStreamingCloudRestApiReferenceDocumentation.LiveStream6();
  });
  ...
  describe('LiveStream6', function() {
    it('should create an instance of LiveStream6', function() {
      // uncomment below and update the code to test LiveStream6
      //var instance = new WowzaStreamingCloudRestApiReferenceDocumentation.LiveStream6();
      //expect(instance).to.be.a(WowzaStreamingCloudRestApiReferenceDocumentation.LiveStream6);
    });
