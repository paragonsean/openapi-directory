...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WowzaStreamingCloudRestApiReferenceDocumentation.CustomStreamTarget();
  });
  ...
  describe('CustomStreamTarget', function() {
    it('should create an instance of CustomStreamTarget', function() {
      // uncomment below and update the code to test CustomStreamTarget
      //var instance = new WowzaStreamingCloudRestApiReferenceDocumentation.CustomStreamTarget();
      //expect(instance).to.be.a(WowzaStreamingCloudRestApiReferenceDocumentation.CustomStreamTarget);
    });
