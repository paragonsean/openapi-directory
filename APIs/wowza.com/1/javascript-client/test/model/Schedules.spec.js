...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WowzaStreamingCloudRestApiReferenceDocumentation.Schedules();
  });
  ...
  describe('Schedules', function() {
    it('should create an instance of Schedules', function() {
      // uncomment below and update the code to test Schedules
      //var instance = new WowzaStreamingCloudRestApiReferenceDocumentation.Schedules();
      //expect(instance).to.be.a(WowzaStreamingCloudRestApiReferenceDocumentation.Schedules);
    });
