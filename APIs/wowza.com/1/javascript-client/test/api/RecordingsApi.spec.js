...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WowzaStreamingCloudRestApiReferenceDocumentation.RecordingsApi();
  });
  ...
  describe('RecordingsApi', function() {
    ...
    describe('showRecording', function() {
      it('should call showRecording successfully', function(done) {
        //uncomment below and update the code to test showRecording
        //instance.showRecording(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('showRecordingState', function() {
      it('should call showRecordingState successfully', function(done) {
        //uncomment below and update the code to test showRecordingState
        //instance.showRecordingState(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
