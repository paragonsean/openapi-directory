# WowzaStreamingCloudRestApiReferenceDocumentation.Transcoder
...
**createdAt** | **Date** | The date and time that the transcoder was created. | [optional] 
...
**directPlaybackUrls** | [**[PlaybackUrl1]**](PlaybackUrl1.md) | An array of direct playback URLs the transcoder&#39;s delivery protocols. Each protocol has a URL for the source and a URL for each output rendition. | [optional] 
...
**outputs** | [**[Output]**](Output.md) | Output renditions associated with the transcoder. | [optional] 
...
**protocol** | **String** | The transport protocol for the source video. The default is &lt;strong&gt;rtmp&lt;/strong&gt;. | [optional] 
...
**sourcePort** | **Number** | The port used for RTMP pull connections to Wowza Streaming Cloud. | [optional] 
...
**updatedAt** | **Date** | The date and time that the transcoder was updated. | [optional] 
