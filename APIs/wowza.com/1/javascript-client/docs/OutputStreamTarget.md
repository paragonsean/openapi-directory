# WowzaStreamingCloudRestApiReferenceDocumentation.OutputStreamTarget

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**createdAt** | **Date** | The date and time that the output stream target was created. | [optional] 
...
**updatedAt** | **Date** | The date and time that the output stream target was updated. | [optional] 
