# WowzaStreamingCloudRestApiReferenceDocumentation.Uptime
...
**createdAt** | **Date** | The date and time that the uptime record was created. | [optional] 
**endedAt** | **Date** | The date and time that the transcoder was stopped for this uptime. If this value is not present, it indicates that the transcoder is currently running. | [optional] 
...
**startedAt** | **Date** | The date and time that the transcoder started for this uptime. | [optional] 
