# WowzaStreamingCloudRestApiReferenceDocumentation.Transcoder9

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**broadcastLocation** | **String** | The location where Wowza Streaming Cloud transcodes your stream. Choose a location as close as possible to your video source. | [optional] 
...
**removeWatermarkImage** | **Boolean** | If &lt;strong&gt;true&lt;/strong&gt;, removes the watermark from the output. The default is &lt;strong&gt;false&lt;/strong&gt;. | [optional] 
