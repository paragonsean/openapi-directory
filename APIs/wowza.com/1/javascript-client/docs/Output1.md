# WowzaStreamingCloudRestApiReferenceDocumentation.Output1
...
**streamFormat** | **String** | The contents of the stream. The default is both audio and video (&lt;strong&gt;audiovideo&lt;/strong&gt;). | 
