...
class TheCountryCodeOfTheCountry(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, name: str=None, percentage_viewers: int=None, percentage_viewing_time: int=None, protocols: List[ProtocolObject]=None, seconds_avg_viewing_time: int=None, seconds_total_viewing_time: int=None, total_unique_viewers: int=None):
        """TheCountryCodeOfTheCountry - a model defined in OpenAPI

        :param name: The name of this TheCountryCodeOfTheCountry.
        :param percentage_viewers: The percentage_viewers of this TheCountryCodeOfTheCountry.
        :param percentage_viewing_time: The percentage_viewing_time of this TheCountryCodeOfTheCountry.
        :param protocols: The protocols of this TheCountryCodeOfTheCountry.
        :param seconds_avg_viewing_time: The seconds_avg_viewing_time of this TheCountryCodeOfTheCountry.
        :param seconds_total_viewing_time: The seconds_total_viewing_time of this TheCountryCodeOfTheCountry.
        :param total_unique_viewers: The total_unique_viewers of this TheCountryCodeOfTheCountry.
        """
        self.openapi_types = {
            'name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TheCountryCodeOfTheCountry':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The The_country_code_of_the_country of this TheCountryCodeOfTheCountry.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this TheCountryCodeOfTheCountry.

        The name of the country.

        :return: The name of this TheCountryCodeOfTheCountry.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this TheCountryCodeOfTheCountry.
    ...
    def percentage_viewers(self):
        """Gets the percentage_viewers of this TheCountryCodeOfTheCountry.

        Total percentage of viewers (<strong>100</strong>).

        :return: The percentage_viewers of this TheCountryCodeOfTheCountry.
        :rtype: int
        """
    ...
    def percentage_viewers(self, percentage_viewers):
        """Sets the percentage_viewers of this TheCountryCodeOfTheCountry.
    ...
    def percentage_viewing_time(self):
        """Gets the percentage_viewing_time of this TheCountryCodeOfTheCountry.
        ...
        :return: The percentage_viewing_time of this TheCountryCodeOfTheCountry.
        :rtype: int
        """
    ...
    def percentage_viewing_time(self, percentage_viewing_time):
        """Sets the percentage_viewing_time of this TheCountryCodeOfTheCountry.
    ...
    @property
    def protocols(self):
        """Gets the protocols of this TheCountryCodeOfTheCountry.


        :return: The protocols of this TheCountryCodeOfTheCountry.
    ...
    def protocols(self, protocols):
        """Sets the protocols of this TheCountryCodeOfTheCountry.
    ...
    def seconds_avg_viewing_time(self):
        """Gets the seconds_avg_viewing_time of this TheCountryCodeOfTheCountry.

        The average length of time, in seconds, that viewers played the stream at the target.

        :return: The seconds_avg_viewing_time of this TheCountryCodeOfTheCountry.
        :rtype: int
        """
    ...
    def seconds_avg_viewing_time(self, seconds_avg_viewing_time):
        """Sets the seconds_avg_viewing_time of this TheCountryCodeOfTheCountry.
    ...
    def seconds_total_viewing_time(self):
        """Gets the seconds_total_viewing_time of this TheCountryCodeOfTheCountry.
        ...
        :return: The seconds_total_viewing_time of this TheCountryCodeOfTheCountry.
        :rtype: int
        """
    ...
    def seconds_total_viewing_time(self, seconds_total_viewing_time):
        """Sets the seconds_total_viewing_time of this TheCountryCodeOfTheCountry.
    ...
    def total_unique_viewers(self):
        """Gets the total_unique_viewers of this TheCountryCodeOfTheCountry.
        ...
        :return: The total_unique_viewers of this TheCountryCodeOfTheCountry.
        :rtype: int
        """
    ...
    def total_unique_viewers(self, total_unique_viewers):
        """Sets the total_unique_viewers of this TheCountryCodeOfTheCountry.
