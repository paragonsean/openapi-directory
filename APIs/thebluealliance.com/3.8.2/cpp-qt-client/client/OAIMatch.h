...
public:
    ...
    qint64 getPostResultTime() const;
    void setPostResultTime(const qint64 &post_result_time);
    bool is_post_result_time_Set() const;
    bool is_post_result_time_Valid() const;
    ...
    OAIObject getScoreBreakdown() const;
    void setScoreBreakdown(const OAIObject &score_breakdown);
    bool is_score_breakdown_Set() const;
    bool is_score_breakdown_Valid() const;
    ...
    QList<OAIMatch_videos_inner> getVideos() const;
    void setVideos(const QList<OAIMatch_videos_inner> &videos);
...
private:
    ...
    qint64 m_post_result_time;
    bool m_post_result_time_isSet;
    bool m_post_result_time_isValid;

    qint64 m_predicted_time;
    bool m_predicted_time_isSet;
    bool m_predicted_time_isValid;

    OAIObject m_score_breakdown;
    bool m_score_breakdown_isSet;
    bool m_score_breakdown_isValid;
    ...
    QList<OAIMatch_videos_inner> m_videos;
    bool m_videos_isSet;
