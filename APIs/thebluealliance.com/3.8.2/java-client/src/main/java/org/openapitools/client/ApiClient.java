...
public class ApiClient {
    ...
    private String basePath = "https://www.thebluealliance.com/api/v3";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKey", new ApiKeyAuth("header", "X-TBA-Auth-Key"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.8.2/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.thebluealliance.com/api/v3
