...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://www.thebluealliance.com/api/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
        ...
        this.authentications = {
            'apiKey': {type: 'apiKey', 'in': 'header', name: 'X-TBA-Auth-Key'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/3.8.2/Javascript'
        };
