...
class MatchScoreBreakdown2017Alliance {
    ...
    /**
     * Validates the JSON data with respect to <code>MatchScoreBreakdown2017Alliance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchScoreBreakdown2017Alliance</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['touchpadFar'] && !(typeof data['touchpadFar'] === 'string' || data['touchpadFar'] instanceof String)) {
            throw new Error("Expected the field `touchpadFar` to be a primitive type in the JSON string but got " + data['touchpadFar']);
        }
        // ensure the json data is a string
        if (data['touchpadMiddle'] && !(typeof data['touchpadMiddle'] === 'string' || data['touchpadMiddle'] instanceof String)) {
            throw new Error("Expected the field `touchpadMiddle` to be a primitive type in the JSON string but got " + data['touchpadMiddle']);
        }
        // ensure the json data is a string
        if (data['touchpadNear'] && !(typeof data['touchpadNear'] === 'string' || data['touchpadNear'] instanceof String)) {
            throw new Error("Expected the field `touchpadNear` to be a primitive type in the JSON string but got " + data['touchpadNear']);
        }
