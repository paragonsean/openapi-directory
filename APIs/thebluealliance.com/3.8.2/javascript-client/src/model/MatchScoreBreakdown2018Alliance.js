...
class MatchScoreBreakdown2018Alliance {
    ...
    /**
     * Validates the JSON data with respect to <code>MatchScoreBreakdown2018Alliance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchScoreBreakdown2018Alliance</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['autoRobot1'] && !(typeof data['autoRobot1'] === 'string' || data['autoRobot1'] instanceof String)) {
            throw new Error("Expected the field `autoRobot1` to be a primitive type in the JSON string but got " + data['autoRobot1']);
        }
        // ensure the json data is a string
        if (data['autoRobot2'] && !(typeof data['autoRobot2'] === 'string' || data['autoRobot2'] instanceof String)) {
            throw new Error("Expected the field `autoRobot2` to be a primitive type in the JSON string but got " + data['autoRobot2']);
        }
        // ensure the json data is a string
        if (data['autoRobot3'] && !(typeof data['autoRobot3'] === 'string' || data['autoRobot3'] instanceof String)) {
            throw new Error("Expected the field `autoRobot3` to be a primitive type in the JSON string but got " + data['autoRobot3']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['tba_gameData'] && !(typeof data['tba_gameData'] === 'string' || data['tba_gameData'] instanceof String)) {
            throw new Error("Expected the field `tba_gameData` to be a primitive type in the JSON string but got " + data['tba_gameData']);
        }
