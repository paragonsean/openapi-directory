...
class MatchScoreBreakdown2019 {
    ...
    /**
     * Validates the JSON data with respect to <code>MatchScoreBreakdown2019</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchScoreBreakdown2019</code>.
     */
    static validateJSON(data) {
        // validate the optional field `blue`
        if (data['blue']) { // data not null
          MatchScoreBreakdown2019Alliance.validateJSON(data['blue']);
        }
        // validate the optional field `red`
        if (data['red']) { // data not null
          MatchScoreBreakdown2019Alliance.validateJSON(data['red']);
        }
