...
class MatchSimple {
    ...
    constructor(compLevel, eventKey, key, matchNumber, setNumber) { 
        ...
        MatchSimple.initialize(this, compLevel, eventKey, key, matchNumber, setNumber);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MatchSimple</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchSimple</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MatchSimple.RequiredProperties) {
...
MatchSimple.RequiredProperties = ["comp_level", "event_key", "key", "match_number", "set_number"];
