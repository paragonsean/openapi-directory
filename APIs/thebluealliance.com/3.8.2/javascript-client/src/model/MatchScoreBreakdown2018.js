...
class MatchScoreBreakdown2018 {
    ...
    /**
     * Validates the JSON data with respect to <code>MatchScoreBreakdown2018</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchScoreBreakdown2018</code>.
     */
    static validateJSON(data) {
        // validate the optional field `blue`
        if (data['blue']) { // data not null
          MatchScoreBreakdown2018Alliance.validateJSON(data['blue']);
        }
        // validate the optional field `red`
        if (data['red']) { // data not null
          MatchScoreBreakdown2018Alliance.validateJSON(data['red']);
        }
