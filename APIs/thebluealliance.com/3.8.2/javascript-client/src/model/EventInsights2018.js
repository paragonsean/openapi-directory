...
class EventInsights2018 {
    ...
    /**
     * Validates the JSON data with respect to <code>EventInsights2018</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventInsights2018</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventInsights2018.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is an array
        if (!Array.isArray(data['auto_quest_achieved'])) {
            throw new Error("Expected the field `auto_quest_achieved` to be an array in the JSON data but got " + data['auto_quest_achieved']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['boost_played_counts'])) {
            throw new Error("Expected the field `boost_played_counts` to be an array in the JSON data but got " + data['boost_played_counts']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['climb_counts'])) {
            throw new Error("Expected the field `climb_counts` to be an array in the JSON data but got " + data['climb_counts']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['face_the_boss_achieved'])) {
            throw new Error("Expected the field `face_the_boss_achieved` to be an array in the JSON data but got " + data['face_the_boss_achieved']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['force_played_counts'])) {
            throw new Error("Expected the field `force_played_counts` to be an array in the JSON data but got " + data['force_played_counts']);
        }
        // ensure the json data is an array
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['levitate_played_counts'])) {
            throw new Error("Expected the field `levitate_played_counts` to be an array in the JSON data but got " + data['levitate_played_counts']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['run_counts_auto'])) {
            throw new Error("Expected the field `run_counts_auto` to be an array in the JSON data but got " + data['run_counts_auto']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['switch_owned_counts_auto'])) {
            throw new Error("Expected the field `switch_owned_counts_auto` to be an array in the JSON data but got " + data['switch_owned_counts_auto']);
        }
        // ensure the json data is an array
