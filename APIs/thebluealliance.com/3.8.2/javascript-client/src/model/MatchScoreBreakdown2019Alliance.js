...
class MatchScoreBreakdown2019Alliance {
    ...
    /**
     * Validates the JSON data with respect to <code>MatchScoreBreakdown2019Alliance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchScoreBreakdown2019Alliance</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['bay1'] && !(typeof data['bay1'] === 'string' || data['bay1'] instanceof String)) {
            throw new Error("Expected the field `bay1` to be a primitive type in the JSON string but got " + data['bay1']);
        }
        // ensure the json data is a string
        if (data['bay2'] && !(typeof data['bay2'] === 'string' || data['bay2'] instanceof String)) {
            throw new Error("Expected the field `bay2` to be a primitive type in the JSON string but got " + data['bay2']);
        }
        // ensure the json data is a string
        if (data['bay3'] && !(typeof data['bay3'] === 'string' || data['bay3'] instanceof String)) {
            throw new Error("Expected the field `bay3` to be a primitive type in the JSON string but got " + data['bay3']);
        }
        // ensure the json data is a string
        if (data['bay4'] && !(typeof data['bay4'] === 'string' || data['bay4'] instanceof String)) {
            throw new Error("Expected the field `bay4` to be a primitive type in the JSON string but got " + data['bay4']);
        }
        // ensure the json data is a string
        if (data['bay5'] && !(typeof data['bay5'] === 'string' || data['bay5'] instanceof String)) {
            throw new Error("Expected the field `bay5` to be a primitive type in the JSON string but got " + data['bay5']);
        }
        // ensure the json data is a string
        if (data['bay6'] && !(typeof data['bay6'] === 'string' || data['bay6'] instanceof String)) {
            throw new Error("Expected the field `bay6` to be a primitive type in the JSON string but got " + data['bay6']);
        }
        // ensure the json data is a string
        if (data['bay7'] && !(typeof data['bay7'] === 'string' || data['bay7'] instanceof String)) {
            throw new Error("Expected the field `bay7` to be a primitive type in the JSON string but got " + data['bay7']);
        }
        // ensure the json data is a string
        if (data['bay8'] && !(typeof data['bay8'] === 'string' || data['bay8'] instanceof String)) {
            throw new Error("Expected the field `bay8` to be a primitive type in the JSON string but got " + data['bay8']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['habLineRobot1'] && !(typeof data['habLineRobot1'] === 'string' || data['habLineRobot1'] instanceof String)) {
            throw new Error("Expected the field `habLineRobot1` to be a primitive type in the JSON string but got " + data['habLineRobot1']);
        }
        // ensure the json data is a string
        if (data['habLineRobot2'] && !(typeof data['habLineRobot2'] === 'string' || data['habLineRobot2'] instanceof String)) {
            throw new Error("Expected the field `habLineRobot2` to be a primitive type in the JSON string but got " + data['habLineRobot2']);
        }
        // ensure the json data is a string
        if (data['habLineRobot3'] && !(typeof data['habLineRobot3'] === 'string' || data['habLineRobot3'] instanceof String)) {
            throw new Error("Expected the field `habLineRobot3` to be a primitive type in the JSON string but got " + data['habLineRobot3']);
        }
        // ensure the json data is a string
        if (data['lowLeftRocketFar'] && !(typeof data['lowLeftRocketFar'] === 'string' || data['lowLeftRocketFar'] instanceof String)) {
            throw new Error("Expected the field `lowLeftRocketFar` to be a primitive type in the JSON string but got " + data['lowLeftRocketFar']);
        }
        // ensure the json data is a string
        if (data['lowLeftRocketNear'] && !(typeof data['lowLeftRocketNear'] === 'string' || data['lowLeftRocketNear'] instanceof String)) {
            throw new Error("Expected the field `lowLeftRocketNear` to be a primitive type in the JSON string but got " + data['lowLeftRocketNear']);
        }
        // ensure the json data is a string
        if (data['lowRightRocketFar'] && !(typeof data['lowRightRocketFar'] === 'string' || data['lowRightRocketFar'] instanceof String)) {
            throw new Error("Expected the field `lowRightRocketFar` to be a primitive type in the JSON string but got " + data['lowRightRocketFar']);
        }
        // ensure the json data is a string
        if (data['lowRightRocketNear'] && !(typeof data['lowRightRocketNear'] === 'string' || data['lowRightRocketNear'] instanceof String)) {
            throw new Error("Expected the field `lowRightRocketNear` to be a primitive type in the JSON string but got " + data['lowRightRocketNear']);
        }
        // ensure the json data is a string
        if (data['midLeftRocketFar'] && !(typeof data['midLeftRocketFar'] === 'string' || data['midLeftRocketFar'] instanceof String)) {
            throw new Error("Expected the field `midLeftRocketFar` to be a primitive type in the JSON string but got " + data['midLeftRocketFar']);
        }
        // ensure the json data is a string
        if (data['midLeftRocketNear'] && !(typeof data['midLeftRocketNear'] === 'string' || data['midLeftRocketNear'] instanceof String)) {
            throw new Error("Expected the field `midLeftRocketNear` to be a primitive type in the JSON string but got " + data['midLeftRocketNear']);
        }
        // ensure the json data is a string
        if (data['midRightRocketFar'] && !(typeof data['midRightRocketFar'] === 'string' || data['midRightRocketFar'] instanceof String)) {
            throw new Error("Expected the field `midRightRocketFar` to be a primitive type in the JSON string but got " + data['midRightRocketFar']);
        }
        // ensure the json data is a string
        if (data['midRightRocketNear'] && !(typeof data['midRightRocketNear'] === 'string' || data['midRightRocketNear'] instanceof String)) {
            throw new Error("Expected the field `midRightRocketNear` to be a primitive type in the JSON string but got " + data['midRightRocketNear']);
        }
        // ensure the json data is a string
        if (data['preMatchBay1'] && !(typeof data['preMatchBay1'] === 'string' || data['preMatchBay1'] instanceof String)) {
            throw new Error("Expected the field `preMatchBay1` to be a primitive type in the JSON string but got " + data['preMatchBay1']);
        }
        // ensure the json data is a string
        if (data['preMatchBay2'] && !(typeof data['preMatchBay2'] === 'string' || data['preMatchBay2'] instanceof String)) {
            throw new Error("Expected the field `preMatchBay2` to be a primitive type in the JSON string but got " + data['preMatchBay2']);
        }
        // ensure the json data is a string
        if (data['preMatchBay3'] && !(typeof data['preMatchBay3'] === 'string' || data['preMatchBay3'] instanceof String)) {
            throw new Error("Expected the field `preMatchBay3` to be a primitive type in the JSON string but got " + data['preMatchBay3']);
        }
        // ensure the json data is a string
        if (data['preMatchBay6'] && !(typeof data['preMatchBay6'] === 'string' || data['preMatchBay6'] instanceof String)) {
            throw new Error("Expected the field `preMatchBay6` to be a primitive type in the JSON string but got " + data['preMatchBay6']);
        }
        // ensure the json data is a string
        if (data['preMatchBay7'] && !(typeof data['preMatchBay7'] === 'string' || data['preMatchBay7'] instanceof String)) {
            throw new Error("Expected the field `preMatchBay7` to be a primitive type in the JSON string but got " + data['preMatchBay7']);
        }
        // ensure the json data is a string
        if (data['preMatchBay8'] && !(typeof data['preMatchBay8'] === 'string' || data['preMatchBay8'] instanceof String)) {
            throw new Error("Expected the field `preMatchBay8` to be a primitive type in the JSON string but got " + data['preMatchBay8']);
        }
        // ensure the json data is a string
        if (data['preMatchLevelRobot1'] && !(typeof data['preMatchLevelRobot1'] === 'string' || data['preMatchLevelRobot1'] instanceof String)) {
            throw new Error("Expected the field `preMatchLevelRobot1` to be a primitive type in the JSON string but got " + data['preMatchLevelRobot1']);
        }
        // ensure the json data is a string
        if (data['preMatchLevelRobot2'] && !(typeof data['preMatchLevelRobot2'] === 'string' || data['preMatchLevelRobot2'] instanceof String)) {
            throw new Error("Expected the field `preMatchLevelRobot2` to be a primitive type in the JSON string but got " + data['preMatchLevelRobot2']);
        }
        // ensure the json data is a string
        if (data['preMatchLevelRobot3'] && !(typeof data['preMatchLevelRobot3'] === 'string' || data['preMatchLevelRobot3'] instanceof String)) {
            throw new Error("Expected the field `preMatchLevelRobot3` to be a primitive type in the JSON string but got " + data['preMatchLevelRobot3']);
        }
        // ensure the json data is a string
        if (data['topLeftRocketFar'] && !(typeof data['topLeftRocketFar'] === 'string' || data['topLeftRocketFar'] instanceof String)) {
            throw new Error("Expected the field `topLeftRocketFar` to be a primitive type in the JSON string but got " + data['topLeftRocketFar']);
        }
        // ensure the json data is a string
        if (data['topLeftRocketNear'] && !(typeof data['topLeftRocketNear'] === 'string' || data['topLeftRocketNear'] instanceof String)) {
            throw new Error("Expected the field `topLeftRocketNear` to be a primitive type in the JSON string but got " + data['topLeftRocketNear']);
        }
        // ensure the json data is a string
        if (data['topRightRocketFar'] && !(typeof data['topRightRocketFar'] === 'string' || data['topRightRocketFar'] instanceof String)) {
            throw new Error("Expected the field `topRightRocketFar` to be a primitive type in the JSON string but got " + data['topRightRocketFar']);
        }
        // ensure the json data is a string
        if (data['topRightRocketNear'] && !(typeof data['topRightRocketNear'] === 'string' || data['topRightRocketNear'] instanceof String)) {
            throw new Error("Expected the field `topRightRocketNear` to be a primitive type in the JSON string but got " + data['topRightRocketNear']);
        }
