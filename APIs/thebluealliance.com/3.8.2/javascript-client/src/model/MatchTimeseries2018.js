...
class MatchTimeseries2018 {
    ...
    /**
     * Validates the JSON data with respect to <code>MatchTimeseries2018</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MatchTimeseries2018</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['blue_current_powerup'] && !(typeof data['blue_current_powerup'] === 'string' || data['blue_current_powerup'] instanceof String)) {
            throw new Error("Expected the field `blue_current_powerup` to be a primitive type in the JSON string but got " + data['blue_current_powerup']);
        }
        // ensure the json data is a string
        if (data['blue_powerup_time_remaining'] && !(typeof data['blue_powerup_time_remaining'] === 'string' || data['blue_powerup_time_remaining'] instanceof String)) {
            throw new Error("Expected the field `blue_powerup_time_remaining` to be a primitive type in the JSON string but got " + data['blue_powerup_time_remaining']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['match_id'] && !(typeof data['match_id'] === 'string' || data['match_id'] instanceof String)) {
            throw new Error("Expected the field `match_id` to be a primitive type in the JSON string but got " + data['match_id']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['red_current_powerup'] && !(typeof data['red_current_powerup'] === 'string' || data['red_current_powerup'] instanceof String)) {
            throw new Error("Expected the field `red_current_powerup` to be a primitive type in the JSON string but got " + data['red_current_powerup']);
        }
        // ensure the json data is a string
        if (data['red_powerup_time_remaining'] && !(typeof data['red_powerup_time_remaining'] === 'string' || data['red_powerup_time_remaining'] instanceof String)) {
            throw new Error("Expected the field `red_powerup_time_remaining` to be a primitive type in the JSON string but got " + data['red_powerup_time_remaining']);
        }
