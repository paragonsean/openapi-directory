...
export default class DistrictApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getEventDistrictPoints_0 operation.
     * @callback module:api/DistrictApi~getEventDistrictPoints_0Callback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [ifNoneMatch] Value of the `ETag` header in the most recently cached response by the client.
     * @param {module:api/DistrictApi~getEventDistrictPoints_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EventDistrictPoints}
     */
    getEventDistrictPoints_0(eventKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'eventKey' is set
      if (eventKey === undefined || eventKey === null) {
        throw new Error("Missing the required parameter 'eventKey' when calling getEventDistrictPoints_0");
      }
    ...
    /**
     * Callback function to receive the result of the getTeamDistricts_0 operation.
     * @callback module:api/DistrictApi~getTeamDistricts_0Callback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/DistrictList>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [ifNoneMatch] Value of the `ETag` header in the most recently cached response by the client.
     * @param {module:api/DistrictApi~getTeamDistricts_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/DistrictList>}
     */
    getTeamDistricts_0(teamKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'teamKey' is set
      if (teamKey === undefined || teamKey === null) {
        throw new Error("Missing the required parameter 'teamKey' when calling getTeamDistricts_0");
      }
