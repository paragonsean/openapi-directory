...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.TeamEventStatusAllianceBackup();
  });
  ...
  describe('TeamEventStatusAllianceBackup', function() {
    it('should create an instance of TeamEventStatusAllianceBackup', function() {
      ...
      //var instance = new TheBlueAllianceApiV3.TeamEventStatusAllianceBackup();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.TeamEventStatusAllianceBackup);
    });
