...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.MatchSimple();
  });
  ...
  describe('MatchSimple', function() {
    it('should create an instance of MatchSimple', function() {
      ...
      //var instance = new TheBlueAllianceApiV3.MatchSimple();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.MatchSimple);
    });
