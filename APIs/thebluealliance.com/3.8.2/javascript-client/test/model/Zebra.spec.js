...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.Zebra();
  });
  ...
  describe('Zebra', function() {
    it('should create an instance of Zebra', function() {
      // uncomment below and update the code to test Zebra
      //var instance = new TheBlueAllianceApiV3.Zebra();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.Zebra);
    });
