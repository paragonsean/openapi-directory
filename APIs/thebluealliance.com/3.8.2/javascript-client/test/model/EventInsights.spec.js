...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.EventInsights();
  });
  ...
  describe('EventInsights', function() {
    it('should create an instance of EventInsights', function() {
      // uncomment below and update the code to test EventInsights
      //var instance = new TheBlueAllianceApiV3.EventInsights();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.EventInsights);
    });
