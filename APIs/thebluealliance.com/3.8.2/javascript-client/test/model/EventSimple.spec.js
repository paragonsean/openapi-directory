...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.EventSimple();
  });
  ...
  describe('EventSimple', function() {
    it('should create an instance of EventSimple', function() {
      ...
      //var instance = new TheBlueAllianceApiV3.EventSimple();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.EventSimple);
    });
