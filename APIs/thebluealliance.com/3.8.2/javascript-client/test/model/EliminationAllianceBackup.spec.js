...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.EliminationAllianceBackup();
  });
  ...
  describe('EliminationAllianceBackup', function() {
    it('should create an instance of EliminationAllianceBackup', function() {
      ...
      //var instance = new TheBlueAllianceApiV3.EliminationAllianceBackup();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.EliminationAllianceBackup);
    });
