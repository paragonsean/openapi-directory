...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.EliminationAlliance();
  });
  ...
  describe('EliminationAlliance', function() {
    it('should create an instance of EliminationAlliance', function() {
      ...
      //var instance = new TheBlueAllianceApiV3.EliminationAlliance();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.EliminationAlliance);
    });
