...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.TeamEventStatusAlliance();
  });
  ...
  describe('TeamEventStatusAlliance', function() {
    it('should create an instance of TeamEventStatusAlliance', function() {
      ...
      //var instance = new TheBlueAllianceApiV3.TeamEventStatusAlliance();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.TeamEventStatusAlliance);
    });
