...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.MatchAlliances();
  });
  ...
  describe('MatchAlliances', function() {
    it('should create an instance of MatchAlliances', function() {
      // uncomment below and update the code to test MatchAlliances
      //var instance = new TheBlueAllianceApiV3.MatchAlliances();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.MatchAlliances);
    });
