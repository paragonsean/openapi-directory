...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.Team();
  });
  ...
  describe('Team', function() {
    it('should create an instance of Team', function() {
      ...
      //var instance = new TheBlueAllianceApiV3.Team();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.Team);
    });
    ...
    it('should have the property schoolName (base name: "school_name")', function() {
