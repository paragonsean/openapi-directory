...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.ZebraAlliances();
  });
  ...
  describe('ZebraAlliances', function() {
    it('should create an instance of ZebraAlliances', function() {
      ...
      //var instance = new TheBlueAllianceApiV3.ZebraAlliances();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.ZebraAlliances);
    });
