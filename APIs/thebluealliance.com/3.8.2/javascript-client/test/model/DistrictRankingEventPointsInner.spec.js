...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheBlueAllianceApiV3.DistrictRankingEventPointsInner();
  });
  ...
  describe('DistrictRankingEventPointsInner', function() {
    it('should create an instance of DistrictRankingEventPointsInner', function() {
      // uncomment below and update the code to test DistrictRankingEventPointsInner
      //var instance = new TheBlueAllianceApiV3.DistrictRankingEventPointsInner();
      //expect(instance).to.be.a(TheBlueAllianceApiV3.DistrictRankingEventPointsInner);
    });
