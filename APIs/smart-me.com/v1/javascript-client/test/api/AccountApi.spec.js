...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartMe.AccountApi();
  });
  ...
  describe('AccountApi', function() {
    describe('accountLogin', function() {
      it('should call accountLogin successfully', function(done) {
        ...
        //instance.accountLogin(function(error) {
    ...
    describe('apiAccountLoginPost', function() {
      it('should call apiAccountLoginPost successfully', function(done) {
        //uncomment below and update the code to test apiAccountLoginPost
        //instance.apiAccountLoginPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
