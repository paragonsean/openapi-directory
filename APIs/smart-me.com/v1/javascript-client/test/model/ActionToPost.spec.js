...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SmartMe.ActionToPost();
  });
  ...
  describe('ActionToPost', function() {
    it('should create an instance of ActionToPost', function() {
      // uncomment below and update the code to test ActionToPost
      //var instance = new SmartMe.ActionToPost();
      //expect(instance).to.be.a(SmartMe.ActionToPost);
    });
