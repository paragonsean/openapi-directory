...
Q_SIGNALS:
    ...
    void healthGetSignal(OAIObject summary);


    void healthGetSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);

    Q_DECL_DEPRECATED_X("Use healthGetSignalError() instead")
    void healthGetSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void healthGetSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
