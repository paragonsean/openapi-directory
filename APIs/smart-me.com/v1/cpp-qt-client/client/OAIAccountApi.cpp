...
void OAIAccountApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("accountLogin", defaultConf);
    _serverIndices.insert("accountLogin", 0);
    _serverConfigs.insert("apiAccountLoginPost", defaultConf);
    _serverIndices.insert("apiAccountLoginPost", 0);
}
...
void OAIAccountApi::accountLogin() {
    QString fullPath = QString(_serverConfigs["accountLogin"][_serverIndices.value("accountLogin")].URL()+"/api/Account/login");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountApi::accountLoginCallback);
...
void OAIAccountApi::accountLoginCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountLoginSignal(output);
        Q_EMIT accountLoginSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountLoginSignalE(output, error_type, error_str);
        Q_EMIT accountLoginSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountLoginSignalError(output, error_type, error_str);
        Q_EMIT accountLoginSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAccountApi::apiAccountLoginPost() {
    QString fullPath = QString(_serverConfigs["apiAccountLoginPost"][_serverIndices.value("apiAccountLoginPost")].URL()+"/api/Account/login");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountApi::apiAccountLoginPostCallback);
    connect(this, &OAIAccountApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAccountApi::apiAccountLoginPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apiAccountLoginPostSignal(output);
        Q_EMIT apiAccountLoginPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apiAccountLoginPostSignalE(output, error_type, error_str);
        Q_EMIT apiAccountLoginPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apiAccountLoginPostSignalError(output, error_type, error_str);
        Q_EMIT apiAccountLoginPostSignalErrorFull(worker, error_type, error_str);
    }
}
