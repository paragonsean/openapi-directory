...
void OAIUserApi::userDelete() {
    QString fullPath = QString(_serverConfigs["userDelete"][_serverIndices.value("userDelete")].URL()+"/api/User");
...
void OAIUserApi::userDeleteCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT userDeleteSignal(output);
        Q_EMIT userDeleteSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT userDeleteSignalE(output, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT userDeleteSignalError(output, error_type, error_str);
