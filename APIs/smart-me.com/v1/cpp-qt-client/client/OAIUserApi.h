...
Q_SIGNALS:
    ...
    void userDeleteSignal(OAIObject summary);
    void userGetSignal(OAIUser summary);


    void userDeleteSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void userGetSignalFull(OAIHttpRequestWorker *worker, OAIUser summary);

    Q_DECL_DEPRECATED_X("Use userDeleteSignalError() instead")
    void userDeleteSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void userDeleteSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
