...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkApi.SentCountsResponse();
  });
  ...
  describe('SentCountsResponse', function() {
    it('should create an instance of SentCountsResponse', function() {
      // uncomment below and update the code to test SentCountsResponse
      //var instance = new PostmarkApi.SentCountsResponse();
      //expect(instance).to.be.a(PostmarkApi.SentCountsResponse);
    });
