...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkApi.GetOutboundOpenCounts200Response();
  });
  ...
  describe('GetOutboundOpenCounts200Response', function() {
    it('should create an instance of GetOutboundOpenCounts200Response', function() {
      // uncomment below and update the code to test GetOutboundOpenCounts200Response
      //var instance = new PostmarkApi.GetOutboundOpenCounts200Response();
      //expect(instance).to.be.a(PostmarkApi.GetOutboundOpenCounts200Response);
    });
