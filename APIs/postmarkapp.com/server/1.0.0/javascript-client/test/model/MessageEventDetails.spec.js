...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkApi.MessageEventDetails();
  });
  ...
  describe('MessageEventDetails', function() {
    it('should create an instance of MessageEventDetails', function() {
      // uncomment below and update the code to test MessageEventDetails
      //var instance = new PostmarkApi.MessageEventDetails();
      //expect(instance).to.be.a(PostmarkApi.MessageEventDetails);
    });
