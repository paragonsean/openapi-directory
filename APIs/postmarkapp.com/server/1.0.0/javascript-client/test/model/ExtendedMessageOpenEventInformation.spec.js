...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkApi.ExtendedMessageOpenEventInformation();
  });
  ...
  describe('ExtendedMessageOpenEventInformation', function() {
    it('should create an instance of ExtendedMessageOpenEventInformation', function() {
      // uncomment below and update the code to test ExtendedMessageOpenEventInformation
      //var instance = new PostmarkApi.ExtendedMessageOpenEventInformation();
      //expect(instance).to.be.a(PostmarkApi.ExtendedMessageOpenEventInformation);
    });
    ...
    it('should have the property firstOpen (base name: "FirstOpen")', function() {
      // uncomment below and update the code to test the property firstOpen
      //var instance = new PostmarkApi.ExtendedMessageOpenEventInformation();
      //expect(instance).to.be();
    });
