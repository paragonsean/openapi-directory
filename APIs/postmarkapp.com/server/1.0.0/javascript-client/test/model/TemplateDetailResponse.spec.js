...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkApi.TemplateDetailResponse();
  });
  ...
  describe('TemplateDetailResponse', function() {
    it('should create an instance of TemplateDetailResponse', function() {
      // uncomment below and update the code to test TemplateDetailResponse
      //var instance = new PostmarkApi.TemplateDetailResponse();
      //expect(instance).to.be.a(PostmarkApi.TemplateDetailResponse);
    });
