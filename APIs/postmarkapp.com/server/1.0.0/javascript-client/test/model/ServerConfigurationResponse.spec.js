...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkApi.ServerConfigurationResponse();
  });
  ...
  describe('ServerConfigurationResponse', function() {
    it('should create an instance of ServerConfigurationResponse', function() {
      // uncomment below and update the code to test ServerConfigurationResponse
      //var instance = new PostmarkApi.ServerConfigurationResponse();
      //expect(instance).to.be.a(PostmarkApi.ServerConfigurationResponse);
    });
