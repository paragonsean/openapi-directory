# PostmarkApi.TemplateValidationRequest
...
**inlineCssForHtmlTestRender** | **Boolean** | When HtmlBody is specified, the test render will have style blocks inlined as style attributes on matching html elements. You may disable the css inlining behavior by passing false for this parameter.  | [optional] [default to true]
