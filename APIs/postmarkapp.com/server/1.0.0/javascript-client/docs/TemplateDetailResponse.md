# PostmarkApi.TemplateDetailResponse
...
**associatedServerId** | **Number** | The ID of the Server with which this template is associated. | [optional] 
...
**templateID** | **Number** | The ID associated with the template. | [optional] 
