...
OAIServerConfigurationResponse::OAIServerConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServerConfigurationResponse::OAIServerConfigurationResponse() {
    this->initializeModel();
}

OAIServerConfigurationResponse::~OAIServerConfigurationResponse() {}

void OAIServerConfigurationResponse::initializeModel() {
...
void OAIServerConfigurationResponse::fromJson(QString jsonString) {
...
void OAIServerConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIServerConfigurationResponse::asJson() const {
...
QJsonObject OAIServerConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIServerConfigurationResponse::getApiTokens() const {
    return m_api_tokens;
}
void OAIServerConfigurationResponse::setApiTokens(const QList<QString> &api_tokens) {
    m_api_tokens = api_tokens;
    m_api_tokens_isSet = true;
}

bool OAIServerConfigurationResponse::is_api_tokens_Set() const{
    return m_api_tokens_isSet;
}

bool OAIServerConfigurationResponse::is_api_tokens_Valid() const{
    return m_api_tokens_isValid;
}

QString OAIServerConfigurationResponse::getBounceHookUrl() const {
    return m_bounce_hook_url;
}
void OAIServerConfigurationResponse::setBounceHookUrl(const QString &bounce_hook_url) {
    m_bounce_hook_url = bounce_hook_url;
    m_bounce_hook_url_isSet = true;
}

bool OAIServerConfigurationResponse::is_bounce_hook_url_Set() const{
    return m_bounce_hook_url_isSet;
}

bool OAIServerConfigurationResponse::is_bounce_hook_url_Valid() const{
    return m_bounce_hook_url_isValid;
}

QString OAIServerConfigurationResponse::getClickHookUrl() const {
    return m_click_hook_url;
}
void OAIServerConfigurationResponse::setClickHookUrl(const QString &click_hook_url) {
    m_click_hook_url = click_hook_url;
    m_click_hook_url_isSet = true;
}

bool OAIServerConfigurationResponse::is_click_hook_url_Set() const{
    return m_click_hook_url_isSet;
}

bool OAIServerConfigurationResponse::is_click_hook_url_Valid() const{
    return m_click_hook_url_isValid;
}

QString OAIServerConfigurationResponse::getColor() const {
    return m_color;
}
void OAIServerConfigurationResponse::setColor(const QString &color) {
    m_color = color;
    m_color_isSet = true;
}

bool OAIServerConfigurationResponse::is_color_Set() const{
    return m_color_isSet;
}

bool OAIServerConfigurationResponse::is_color_Valid() const{
    return m_color_isValid;
}

QString OAIServerConfigurationResponse::getDeliveryHookUrl() const {
    return m_delivery_hook_url;
}
void OAIServerConfigurationResponse::setDeliveryHookUrl(const QString &delivery_hook_url) {
    m_delivery_hook_url = delivery_hook_url;
    m_delivery_hook_url_isSet = true;
}

bool OAIServerConfigurationResponse::is_delivery_hook_url_Set() const{
    return m_delivery_hook_url_isSet;
}

bool OAIServerConfigurationResponse::is_delivery_hook_url_Valid() const{
    return m_delivery_hook_url_isValid;
}

qint32 OAIServerConfigurationResponse::getId() const {
    return m_id;
}
void OAIServerConfigurationResponse::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIServerConfigurationResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIServerConfigurationResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIServerConfigurationResponse::getInboundAddress() const {
    return m_inbound_address;
}
void OAIServerConfigurationResponse::setInboundAddress(const QString &inbound_address) {
    m_inbound_address = inbound_address;
    m_inbound_address_isSet = true;
}

bool OAIServerConfigurationResponse::is_inbound_address_Set() const{
    return m_inbound_address_isSet;
}

bool OAIServerConfigurationResponse::is_inbound_address_Valid() const{
    return m_inbound_address_isValid;
}

QString OAIServerConfigurationResponse::getInboundDomain() const {
    return m_inbound_domain;
}
void OAIServerConfigurationResponse::setInboundDomain(const QString &inbound_domain) {
    m_inbound_domain = inbound_domain;
    m_inbound_domain_isSet = true;
}

bool OAIServerConfigurationResponse::is_inbound_domain_Set() const{
    return m_inbound_domain_isSet;
}

bool OAIServerConfigurationResponse::is_inbound_domain_Valid() const{
    return m_inbound_domain_isValid;
}

QString OAIServerConfigurationResponse::getInboundHash() const {
    return m_inbound_hash;
}
void OAIServerConfigurationResponse::setInboundHash(const QString &inbound_hash) {
    m_inbound_hash = inbound_hash;
    m_inbound_hash_isSet = true;
}

bool OAIServerConfigurationResponse::is_inbound_hash_Set() const{
    return m_inbound_hash_isSet;
}

bool OAIServerConfigurationResponse::is_inbound_hash_Valid() const{
    return m_inbound_hash_isValid;
}

QString OAIServerConfigurationResponse::getInboundHookUrl() const {
    return m_inbound_hook_url;
}
void OAIServerConfigurationResponse::setInboundHookUrl(const QString &inbound_hook_url) {
    m_inbound_hook_url = inbound_hook_url;
    m_inbound_hook_url_isSet = true;
}

bool OAIServerConfigurationResponse::is_inbound_hook_url_Set() const{
    return m_inbound_hook_url_isSet;
}

bool OAIServerConfigurationResponse::is_inbound_hook_url_Valid() const{
    return m_inbound_hook_url_isValid;
}

qint32 OAIServerConfigurationResponse::getInboundSpamThreshold() const {
    return m_inbound_spam_threshold;
}
void OAIServerConfigurationResponse::setInboundSpamThreshold(const qint32 &inbound_spam_threshold) {
    m_inbound_spam_threshold = inbound_spam_threshold;
    m_inbound_spam_threshold_isSet = true;
}

bool OAIServerConfigurationResponse::is_inbound_spam_threshold_Set() const{
    return m_inbound_spam_threshold_isSet;
}

bool OAIServerConfigurationResponse::is_inbound_spam_threshold_Valid() const{
    return m_inbound_spam_threshold_isValid;
}

QString OAIServerConfigurationResponse::getName() const {
    return m_name;
}
void OAIServerConfigurationResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIServerConfigurationResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIServerConfigurationResponse::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIServerConfigurationResponse::getOpenHookUrl() const {
    return m_open_hook_url;
}
void OAIServerConfigurationResponse::setOpenHookUrl(const QString &open_hook_url) {
    m_open_hook_url = open_hook_url;
    m_open_hook_url_isSet = true;
}

bool OAIServerConfigurationResponse::is_open_hook_url_Set() const{
    return m_open_hook_url_isSet;
}

bool OAIServerConfigurationResponse::is_open_hook_url_Valid() const{
    return m_open_hook_url_isValid;
}

bool OAIServerConfigurationResponse::isPostFirstOpenOnly() const {
    return m_post_first_open_only;
}
void OAIServerConfigurationResponse::setPostFirstOpenOnly(const bool &post_first_open_only) {
    m_post_first_open_only = post_first_open_only;
    m_post_first_open_only_isSet = true;
}

bool OAIServerConfigurationResponse::is_post_first_open_only_Set() const{
    return m_post_first_open_only_isSet;
}

bool OAIServerConfigurationResponse::is_post_first_open_only_Valid() const{
    return m_post_first_open_only_isValid;
}

bool OAIServerConfigurationResponse::isRawEmailEnabled() const {
    return m_raw_email_enabled;
}
void OAIServerConfigurationResponse::setRawEmailEnabled(const bool &raw_email_enabled) {
    m_raw_email_enabled = raw_email_enabled;
    m_raw_email_enabled_isSet = true;
}

bool OAIServerConfigurationResponse::is_raw_email_enabled_Set() const{
    return m_raw_email_enabled_isSet;
}

bool OAIServerConfigurationResponse::is_raw_email_enabled_Valid() const{
    return m_raw_email_enabled_isValid;
}

QString OAIServerConfigurationResponse::getServerLink() const {
    return m_server_link;
}
void OAIServerConfigurationResponse::setServerLink(const QString &server_link) {
    m_server_link = server_link;
    m_server_link_isSet = true;
}

bool OAIServerConfigurationResponse::is_server_link_Set() const{
    return m_server_link_isSet;
}

bool OAIServerConfigurationResponse::is_server_link_Valid() const{
    return m_server_link_isValid;
}

bool OAIServerConfigurationResponse::isSmtpApiActivated() const {
    return m_smtp_api_activated;
}
void OAIServerConfigurationResponse::setSmtpApiActivated(const bool &smtp_api_activated) {
    m_smtp_api_activated = smtp_api_activated;
    m_smtp_api_activated_isSet = true;
}

bool OAIServerConfigurationResponse::is_smtp_api_activated_Set() const{
    return m_smtp_api_activated_isSet;
}

bool OAIServerConfigurationResponse::is_smtp_api_activated_Valid() const{
    return m_smtp_api_activated_isValid;
}

QString OAIServerConfigurationResponse::getTrackLinks() const {
    return m_track_links;
}
void OAIServerConfigurationResponse::setTrackLinks(const QString &track_links) {
    m_track_links = track_links;
    m_track_links_isSet = true;
}

bool OAIServerConfigurationResponse::is_track_links_Set() const{
    return m_track_links_isSet;
}

bool OAIServerConfigurationResponse::is_track_links_Valid() const{
    return m_track_links_isValid;
}

bool OAIServerConfigurationResponse::isTrackOpens() const {
    return m_track_opens;
}
void OAIServerConfigurationResponse::setTrackOpens(const bool &track_opens) {
    m_track_opens = track_opens;
    m_track_opens_isSet = true;
}

bool OAIServerConfigurationResponse::is_track_opens_Set() const{
    return m_track_opens_isSet;
}

bool OAIServerConfigurationResponse::is_track_opens_Valid() const{
    return m_track_opens_isValid;
}

bool OAIServerConfigurationResponse::isSet() const {
...
bool OAIServerConfigurationResponse::isValid() const {
