...
public class OutboundMessageDetail {
  ...
  public OutboundMessageDetail() {
  }

  public OutboundMessageDetail attachments(List<Attachment> attachments) {
    this.attachments = attachments;
    return this;
  }

  public OutboundMessageDetail addAttachmentsItem(Attachment attachmentsItem) {
  ...
  public OutboundMessageDetail receivedAt(OffsetDateTime receivedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attachments, outboundMessageDetail.attachments) &&
        ...
        Objects.equals(this.tag, outboundMessageDetail.tag) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attachments, bcc, cc, from, messageID, receivedAt, recipients, status, subject, tag, to, trackLinks, trackOpens);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OutboundMessageDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OutboundMessageDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OutboundMessageDetail is not found in the empty JSON string", OutboundMessageDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OutboundMessageDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OutboundMessageDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OutboundMessageDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OutboundMessageDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OutboundMessageDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OutboundMessageDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<OutboundMessageDetail>() {
           @Override
           public void write(JsonWriter out, OutboundMessageDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OutboundMessageDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OutboundMessageDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OutboundMessageDetail
   * @throws IOException if the JSON string is invalid with respect to OutboundMessageDetail
   */
  public static OutboundMessageDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OutboundMessageDetail.class);
  }

  /**
   * Convert an instance of OutboundMessageDetail to an JSON string
   *
   * @return JSON string
   */
