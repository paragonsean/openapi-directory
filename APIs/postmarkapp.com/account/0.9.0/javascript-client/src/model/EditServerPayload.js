...
/**
 * The EditServerPayload model module.
 * @module model/EditServerPayload
 * @version 0.9.0
 */
class EditServerPayload {
    /**
     * Constructs a new <code>EditServerPayload</code>.
     * 
     * @alias module:model/EditServerPayload
     */
    constructor() { 
        
        EditServerPayload.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EditServerPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EditServerPayload} obj Optional instance to populate.
     * @return {module:model/EditServerPayload} The populated <code>EditServerPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EditServerPayload();
    ...
    /**
     * Validates the JSON data with respect to <code>EditServerPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EditServerPayload</code>.
     */
 ...
 */
EditServerPayload.prototype['BounceHookUrl'] = undefined;

/**
 * @member {String} ClickHookUrl
 */
EditServerPayload.prototype['ClickHookUrl'] = undefined;

/**
 * @member {String} Color
 */
EditServerPayload.prototype['Color'] = undefined;

/**
 * @member {String} DeliveryHookUrl
 */
EditServerPayload.prototype['DeliveryHookUrl'] = undefined;

/**
 * @member {String} InboundDomain
 */
EditServerPayload.prototype['InboundDomain'] = undefined;

/**
 * @member {String} InboundHookUrl
 */
EditServerPayload.prototype['InboundHookUrl'] = undefined;

/**
 * @member {Number} InboundSpamThreshold
 */
EditServerPayload.prototype['InboundSpamThreshold'] = undefined;

/**
 * @member {String} Name
 */
EditServerPayload.prototype['Name'] = undefined;

/**
 * @member {String} OpenHookUrl
 */
EditServerPayload.prototype['OpenHookUrl'] = undefined;

/**
 * @member {Boolean} PostFirstOpenOnly
 */
EditServerPayload.prototype['PostFirstOpenOnly'] = undefined;

/**
 * @member {Boolean} RawEmailEnabled
 */
EditServerPayload.prototype['RawEmailEnabled'] = undefined;

/**
 * @member {Boolean} SmtpApiActivated
 */
EditServerPayload.prototype['SmtpApiActivated'] = undefined;

/**
 * @member {module:model/EditServerPayload.TrackLinksEnum} TrackLinks
 */
EditServerPayload.prototype['TrackLinks'] = undefined;

/**
 * @member {Boolean} TrackOpens
 */
EditServerPayload.prototype['TrackOpens'] = undefined;
 ...
 * @readonly
 */
EditServerPayload['TrackLinksEnum'] = {
...
export default EditServerPayload;
