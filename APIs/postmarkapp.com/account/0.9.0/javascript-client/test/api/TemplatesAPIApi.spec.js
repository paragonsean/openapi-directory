...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkAccountLevelApi.TemplatesAPIApi();
  });
  ...
  describe('TemplatesAPIApi', function() {
    describe('pushTemplates', function() {
      it('should call pushTemplates successfully', function(done) {
        //uncomment below and update the code to test pushTemplates
        //instance.pushTemplates(function(error) {
