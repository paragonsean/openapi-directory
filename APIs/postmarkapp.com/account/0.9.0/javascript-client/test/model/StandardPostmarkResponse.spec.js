...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkAccountLevelApi.StandardPostmarkResponse();
  });
  ...
  describe('StandardPostmarkResponse', function() {
    it('should create an instance of StandardPostmarkResponse', function() {
      // uncomment below and update the code to test StandardPostmarkResponse
      //var instance = new PostmarkAccountLevelApi.StandardPostmarkResponse();
      //expect(instance).to.be.a(PostmarkAccountLevelApi.StandardPostmarkResponse);
    });
