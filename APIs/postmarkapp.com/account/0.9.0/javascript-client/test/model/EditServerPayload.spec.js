...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkAccountLevelApi.EditServerPayload();
  });
  ...
  describe('EditServerPayload', function() {
    it('should create an instance of EditServerPayload', function() {
      // uncomment below and update the code to test EditServerPayload
      //var instance = new PostmarkAccountLevelApi.EditServerPayload();
      //expect(instance).to.be.a(PostmarkAccountLevelApi.EditServerPayload);
    });
