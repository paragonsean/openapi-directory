...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkAccountLevelApi.ServerListingResponse();
  });
  ...
  describe('ServerListingResponse', function() {
    it('should create an instance of ServerListingResponse', function() {
      // uncomment below and update the code to test ServerListingResponse
      //var instance = new PostmarkAccountLevelApi.ServerListingResponse();
      //expect(instance).to.be.a(PostmarkAccountLevelApi.ServerListingResponse);
    });
