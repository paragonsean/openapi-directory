...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PostmarkAccountLevelApi.TemplatesPushResponse();
  });
  ...
  describe('TemplatesPushResponse', function() {
    it('should create an instance of TemplatesPushResponse', function() {
      // uncomment below and update the code to test TemplatesPushResponse
      //var instance = new PostmarkAccountLevelApi.TemplatesPushResponse();
      //expect(instance).to.be.a(PostmarkAccountLevelApi.TemplatesPushResponse);
    });
