# PostmarkAccountLevelApi.EditServerPayload
...
* `HtmlAndTextTracking` (value: `"HtmlAndTextTracking"`)

* `HtmlOnlyTracking` (value: `"HtmlOnlyTracking"`)

* `TextOnlyTracking` (value: `"TextOnlyTracking"`)
