...
public class DomainExtendedInformation {
  ...
  public DomainExtendedInformation() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dkIMHost, domainExtendedInformation.dkIMHost) &&
        ...
        Objects.equals(this.name, domainExtendedInformation.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dkIMHost, dkIMPendingHost, dkIMPendingTextValue, dkIMRevokedHost, dkIMRevokedTextValue, dkIMTestValue, dkIMUpdateStatus, dkIMVerified, ID, name, returnPathDomain, returnPathDomainCNAMEValue, returnPathDomainVerified, spFHost, spFTextValue, spFVerified, safeToRemoveRevokedKeyFromDNS, weakDKIM);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainExtendedInformation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainExtendedInformation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainExtendedInformation is not found in the empty JSON string", DomainExtendedInformation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainExtendedInformation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainExtendedInformation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainExtendedInformation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainExtendedInformation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainExtendedInformation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainExtendedInformation.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainExtendedInformation>() {
           @Override
           public void write(JsonWriter out, DomainExtendedInformation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainExtendedInformation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainExtendedInformation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainExtendedInformation
   * @throws IOException if the JSON string is invalid with respect to DomainExtendedInformation
   */
  public static DomainExtendedInformation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainExtendedInformation.class);
  }

  /**
   * Convert an instance of DomainExtendedInformation to an JSON string
   *
   * @return JSON string
   */
