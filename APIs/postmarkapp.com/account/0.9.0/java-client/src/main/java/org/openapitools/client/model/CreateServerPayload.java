...
public class CreateServerPayload {
  ...
  public CreateServerPayload clickHookUrl(String clickHookUrl) {
  ...
  public CreateServerPayload trackLinks(TrackLinksEnum trackLinks) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bounceHookUrl, createServerPayload.bounceHookUrl) &&
        Objects.equals(this.clickHookUrl, createServerPayload.clickHookUrl) &&
        ...
        Objects.equals(this.name, createServerPayload.name) &&
        ...
        Objects.equals(this.trackLinks, createServerPayload.trackLinks) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateServerPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateServerPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateServerPayload is not found in the empty JSON string", CreateServerPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateServerPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateServerPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateServerPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateServerPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateServerPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateServerPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateServerPayload>() {
           @Override
           public void write(JsonWriter out, CreateServerPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateServerPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateServerPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateServerPayload
   * @throws IOException if the JSON string is invalid with respect to CreateServerPayload
   */
  public static CreateServerPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateServerPayload.class);
  }

  /**
   * Convert an instance of CreateServerPayload to an JSON string
   *
   * @return JSON string
   */
