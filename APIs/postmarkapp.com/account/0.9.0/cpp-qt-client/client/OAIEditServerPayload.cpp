...
OAIEditServerPayload::OAIEditServerPayload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEditServerPayload::OAIEditServerPayload() {
    this->initializeModel();
}

OAIEditServerPayload::~OAIEditServerPayload() {}

void OAIEditServerPayload::initializeModel() {
...
void OAIEditServerPayload::fromJson(QString jsonString) {
...
void OAIEditServerPayload::fromJsonObject(QJsonObject json) {
...
QString OAIEditServerPayload::asJson() const {
...
QJsonObject OAIEditServerPayload::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEditServerPayload::getBounceHookUrl() const {
    return m_bounce_hook_url;
}
void OAIEditServerPayload::setBounceHookUrl(const QString &bounce_hook_url) {
    m_bounce_hook_url = bounce_hook_url;
    m_bounce_hook_url_isSet = true;
}

bool OAIEditServerPayload::is_bounce_hook_url_Set() const{
    return m_bounce_hook_url_isSet;
}

bool OAIEditServerPayload::is_bounce_hook_url_Valid() const{
    return m_bounce_hook_url_isValid;
}

QString OAIEditServerPayload::getClickHookUrl() const {
    return m_click_hook_url;
}
void OAIEditServerPayload::setClickHookUrl(const QString &click_hook_url) {
    m_click_hook_url = click_hook_url;
    m_click_hook_url_isSet = true;
}

bool OAIEditServerPayload::is_click_hook_url_Set() const{
    return m_click_hook_url_isSet;
}

bool OAIEditServerPayload::is_click_hook_url_Valid() const{
    return m_click_hook_url_isValid;
}

QString OAIEditServerPayload::getColor() const {
    return m_color;
}
void OAIEditServerPayload::setColor(const QString &color) {
    m_color = color;
    m_color_isSet = true;
}

bool OAIEditServerPayload::is_color_Set() const{
    return m_color_isSet;
}

bool OAIEditServerPayload::is_color_Valid() const{
    return m_color_isValid;
}

QString OAIEditServerPayload::getDeliveryHookUrl() const {
    return m_delivery_hook_url;
}
void OAIEditServerPayload::setDeliveryHookUrl(const QString &delivery_hook_url) {
    m_delivery_hook_url = delivery_hook_url;
    m_delivery_hook_url_isSet = true;
}

bool OAIEditServerPayload::is_delivery_hook_url_Set() const{
    return m_delivery_hook_url_isSet;
}

bool OAIEditServerPayload::is_delivery_hook_url_Valid() const{
    return m_delivery_hook_url_isValid;
}

QString OAIEditServerPayload::getInboundDomain() const {
    return m_inbound_domain;
}
void OAIEditServerPayload::setInboundDomain(const QString &inbound_domain) {
    m_inbound_domain = inbound_domain;
    m_inbound_domain_isSet = true;
}

bool OAIEditServerPayload::is_inbound_domain_Set() const{
    return m_inbound_domain_isSet;
}

bool OAIEditServerPayload::is_inbound_domain_Valid() const{
    return m_inbound_domain_isValid;
}

QString OAIEditServerPayload::getInboundHookUrl() const {
    return m_inbound_hook_url;
}
void OAIEditServerPayload::setInboundHookUrl(const QString &inbound_hook_url) {
    m_inbound_hook_url = inbound_hook_url;
    m_inbound_hook_url_isSet = true;
}

bool OAIEditServerPayload::is_inbound_hook_url_Set() const{
    return m_inbound_hook_url_isSet;
}

bool OAIEditServerPayload::is_inbound_hook_url_Valid() const{
    return m_inbound_hook_url_isValid;
}

qint32 OAIEditServerPayload::getInboundSpamThreshold() const {
    return m_inbound_spam_threshold;
}
void OAIEditServerPayload::setInboundSpamThreshold(const qint32 &inbound_spam_threshold) {
    m_inbound_spam_threshold = inbound_spam_threshold;
    m_inbound_spam_threshold_isSet = true;
}

bool OAIEditServerPayload::is_inbound_spam_threshold_Set() const{
    return m_inbound_spam_threshold_isSet;
}

bool OAIEditServerPayload::is_inbound_spam_threshold_Valid() const{
    return m_inbound_spam_threshold_isValid;
}

QString OAIEditServerPayload::getName() const {
    return m_name;
}
void OAIEditServerPayload::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIEditServerPayload::is_name_Set() const{
    return m_name_isSet;
}

bool OAIEditServerPayload::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIEditServerPayload::getOpenHookUrl() const {
    return m_open_hook_url;
}
void OAIEditServerPayload::setOpenHookUrl(const QString &open_hook_url) {
    m_open_hook_url = open_hook_url;
    m_open_hook_url_isSet = true;
}

bool OAIEditServerPayload::is_open_hook_url_Set() const{
    return m_open_hook_url_isSet;
}

bool OAIEditServerPayload::is_open_hook_url_Valid() const{
    return m_open_hook_url_isValid;
}

bool OAIEditServerPayload::isPostFirstOpenOnly() const {
    return m_post_first_open_only;
}
void OAIEditServerPayload::setPostFirstOpenOnly(const bool &post_first_open_only) {
    m_post_first_open_only = post_first_open_only;
    m_post_first_open_only_isSet = true;
}

bool OAIEditServerPayload::is_post_first_open_only_Set() const{
    return m_post_first_open_only_isSet;
}

bool OAIEditServerPayload::is_post_first_open_only_Valid() const{
    return m_post_first_open_only_isValid;
}

bool OAIEditServerPayload::isRawEmailEnabled() const {
    return m_raw_email_enabled;
}
void OAIEditServerPayload::setRawEmailEnabled(const bool &raw_email_enabled) {
    m_raw_email_enabled = raw_email_enabled;
    m_raw_email_enabled_isSet = true;
}

bool OAIEditServerPayload::is_raw_email_enabled_Set() const{
    return m_raw_email_enabled_isSet;
}

bool OAIEditServerPayload::is_raw_email_enabled_Valid() const{
    return m_raw_email_enabled_isValid;
}

bool OAIEditServerPayload::isSmtpApiActivated() const {
    return m_smtp_api_activated;
}
void OAIEditServerPayload::setSmtpApiActivated(const bool &smtp_api_activated) {
    m_smtp_api_activated = smtp_api_activated;
    m_smtp_api_activated_isSet = true;
}

bool OAIEditServerPayload::is_smtp_api_activated_Set() const{
    return m_smtp_api_activated_isSet;
}

bool OAIEditServerPayload::is_smtp_api_activated_Valid() const{
    return m_smtp_api_activated_isValid;
}

QString OAIEditServerPayload::getTrackLinks() const {
    return m_track_links;
}
void OAIEditServerPayload::setTrackLinks(const QString &track_links) {
    m_track_links = track_links;
    m_track_links_isSet = true;
}

bool OAIEditServerPayload::is_track_links_Set() const{
    return m_track_links_isSet;
}

bool OAIEditServerPayload::is_track_links_Valid() const{
    return m_track_links_isValid;
}

bool OAIEditServerPayload::isTrackOpens() const {
    return m_track_opens;
}
void OAIEditServerPayload::setTrackOpens(const bool &track_opens) {
    m_track_opens = track_opens;
    m_track_opens_isSet = true;
}

bool OAIEditServerPayload::is_track_opens_Set() const{
    return m_track_opens_isSet;
}

bool OAIEditServerPayload::is_track_opens_Valid() const{
    return m_track_opens_isValid;
}

bool OAIEditServerPayload::isSet() const {
...
bool OAIEditServerPayload::isValid() const {
