...
OAIVideo OAIVideoRating::getVideo() const {
    return m_video;
}
void OAIVideoRating::setVideo(const OAIVideo &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIVideoRating::is_video_Set() const{
    return m_video_isSet;
}

bool OAIVideoRating::is_video_Valid() const{
...
bool OAIVideoRating::isValid() const {
    ...
    return m_rating_isValid && m_video_isValid && true;
}
