...
/*
 * OAIVideoUploadRequestCommon.h
 *
 * 
 */

#ifndef OAIVideoUploadRequestCommon_H
#define OAIVideoUploadRequestCommon_H
...
class OAIVideoUploadRequestCommon : public OAIObject {
public:
    OAIVideoUploadRequestCommon();
    OAIVideoUploadRequestCommon(QString json);
    ~OAIVideoUploadRequestCommon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoUploadRequestCommon)

#endif // OAIVideoUploadRequestCommon_H
