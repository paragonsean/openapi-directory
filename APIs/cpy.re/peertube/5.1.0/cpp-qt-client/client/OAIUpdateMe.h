...
#ifndef OAIUpdateMe_H
#define OAIUpdateMe_H
...
class OAIUpdateMe : public OAIObject {
public:
    OAIUpdateMe();
    OAIUpdateMe(QString json);
    ~OAIUpdateMe() override;
    ...
    QString getDisplayNsfw() const;
    void setDisplayNsfw(const QString &display_nsfw);
    bool is_display_nsfw_Set() const;
    bool is_display_nsfw_Valid() const;
    ...
    QList<QString> getVideoLanguages() const;
    void setVideoLanguages(const QList<QString> &video_languages);
    bool is_video_languages_Set() const;
    bool is_video_languages_Valid() const;

    bool isVideosHistoryEnabled() const;
    void setVideosHistoryEnabled(const bool &videos_history_enabled);
    bool is_videos_history_enabled_Set() const;
    bool is_videos_history_enabled_Valid() const;
...
private:
    ...
    QString m_display_nsfw;
    bool m_display_nsfw_isSet;
    bool m_display_nsfw_isValid;
    ...
    QList<QString> m_video_languages;
    bool m_video_languages_isSet;
    bool m_video_languages_isValid;

    bool m_videos_history_enabled;
    bool m_videos_history_enabled_isSet;
    bool m_videos_history_enabled_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMe)
