...
QString OAIUserRole::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIUserRole::_0:
            val = QString::number(0);
            break;
        case eOAIUserRole::_1:
            val = QString::number(1);
            break;
        case eOAIUserRole::_2:
