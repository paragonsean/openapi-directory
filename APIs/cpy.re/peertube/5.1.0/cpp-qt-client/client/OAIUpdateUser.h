...
#ifndef OAIUpdateUser_H
#define OAIUpdateUser_H
...
class OAIUpdateUser : public OAIObject {
public:
    OAIUpdateUser();
    OAIUpdateUser(QString json);
    ~OAIUpdateUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUser)

#endif // OAIUpdateUser_H
