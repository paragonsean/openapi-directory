...
class OAIVideoFile;
class OAIVideoStreamingPlaylists;
...
public:
    ...
    QString getDescriptionPath() const;
    void setDescriptionPath(const QString &description_path);
    bool is_description_path_Set() const;
    bool is_description_path_Valid() const;
    ...
    QList<OAIVideoStreamingPlaylists> getStreamingPlaylists() const;
    void setStreamingPlaylists(const QList<OAIVideoStreamingPlaylists> &streaming_playlists);
    ...
    void setViewers(const qint32 &viewers);
...
private:
    ...
    QString m_description_path;
    bool m_description_path_isSet;
    bool m_description_path_isValid;
    ...
    QList<OAIVideoStreamingPlaylists> m_streaming_playlists;
