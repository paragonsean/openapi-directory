...
#ifndef OAIVideoBlacklist_H
#define OAIVideoBlacklist_H
...
class OAIVideoBlacklist : public OAIObject {
public:
    OAIVideoBlacklist();
    OAIVideoBlacklist(QString json);
    ~OAIVideoBlacklist() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoBlacklist)

#endif // OAIVideoBlacklist_H
