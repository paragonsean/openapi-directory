...
/*
 * OAIFileRedundancyInformation.h
 *
 * 
 */

#ifndef OAIFileRedundancyInformation_H
#define OAIFileRedundancyInformation_H
...
class OAIFileRedundancyInformation : public OAIObject {
public:
    OAIFileRedundancyInformation();
    OAIFileRedundancyInformation(QString json);
    ~OAIFileRedundancyInformation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileRedundancyInformation)

#endif // OAIFileRedundancyInformation_H
