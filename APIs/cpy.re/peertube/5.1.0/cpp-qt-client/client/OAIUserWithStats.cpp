...
OAIUserWithStats::OAIUserWithStats(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserWithStats::OAIUserWithStats() {
    this->initializeModel();
}

OAIUserWithStats::~OAIUserWithStats() {}

void OAIUserWithStats::initializeModel() {
...
void OAIUserWithStats::fromJson(QString jsonString) {
...
void OAIUserWithStats::fromJsonObject(QJsonObject json) {
...
QString OAIUserWithStats::asJson() const {
...
QJsonObject OAIUserWithStats::asJsonObject() const {
    QJsonObject obj;
    if (m_account.isSet()) {
...
OAIAccount OAIUserWithStats::getAccount() const {
    return m_account;
}
void OAIUserWithStats::setAccount(const OAIAccount &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAIUserWithStats::is_account_Set() const{
    return m_account_isSet;
}

bool OAIUserWithStats::is_account_Valid() const{
    return m_account_isValid;
}

bool OAIUserWithStats::isAutoPlayNextVideo() const {
    return m_auto_play_next_video;
}
void OAIUserWithStats::setAutoPlayNextVideo(const bool &auto_play_next_video) {
    m_auto_play_next_video = auto_play_next_video;
    m_auto_play_next_video_isSet = true;
}

bool OAIUserWithStats::is_auto_play_next_video_Set() const{
    return m_auto_play_next_video_isSet;
}

bool OAIUserWithStats::is_auto_play_next_video_Valid() const{
    return m_auto_play_next_video_isValid;
}

bool OAIUserWithStats::isAutoPlayNextVideoPlaylist() const {
    return m_auto_play_next_video_playlist;
}
void OAIUserWithStats::setAutoPlayNextVideoPlaylist(const bool &auto_play_next_video_playlist) {
    m_auto_play_next_video_playlist = auto_play_next_video_playlist;
    m_auto_play_next_video_playlist_isSet = true;
}

bool OAIUserWithStats::is_auto_play_next_video_playlist_Set() const{
    return m_auto_play_next_video_playlist_isSet;
}

bool OAIUserWithStats::is_auto_play_next_video_playlist_Valid() const{
    return m_auto_play_next_video_playlist_isValid;
}

bool OAIUserWithStats::isAutoPlayVideo() const {
    return m_auto_play_video;
}
void OAIUserWithStats::setAutoPlayVideo(const bool &auto_play_video) {
    m_auto_play_video = auto_play_video;
    m_auto_play_video_isSet = true;
}

bool OAIUserWithStats::is_auto_play_video_Set() const{
    return m_auto_play_video_isSet;
}

bool OAIUserWithStats::is_auto_play_video_Valid() const{
    return m_auto_play_video_isValid;
}

bool OAIUserWithStats::isBlocked() const {
    return m_blocked;
}
void OAIUserWithStats::setBlocked(const bool &blocked) {
    m_blocked = blocked;
    m_blocked_isSet = true;
}

bool OAIUserWithStats::is_blocked_Set() const{
    return m_blocked_isSet;
}

bool OAIUserWithStats::is_blocked_Valid() const{
    return m_blocked_isValid;
}

QString OAIUserWithStats::getBlockedReason() const {
    return m_blocked_reason;
}
void OAIUserWithStats::setBlockedReason(const QString &blocked_reason) {
    m_blocked_reason = blocked_reason;
    m_blocked_reason_isSet = true;
}

bool OAIUserWithStats::is_blocked_reason_Set() const{
    return m_blocked_reason_isSet;
}

bool OAIUserWithStats::is_blocked_reason_Valid() const{
    return m_blocked_reason_isValid;
}

QString OAIUserWithStats::getCreatedAt() const {
    return m_created_at;
}
void OAIUserWithStats::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIUserWithStats::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIUserWithStats::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIUserWithStats::getEmail() const {
    return m_email;
}
void OAIUserWithStats::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIUserWithStats::is_email_Set() const{
    return m_email_isSet;
}

bool OAIUserWithStats::is_email_Valid() const{
    return m_email_isValid;
}

bool OAIUserWithStats::isEmailVerified() const {
    return m_email_verified;
}
void OAIUserWithStats::setEmailVerified(const bool &email_verified) {
    m_email_verified = email_verified;
    m_email_verified_isSet = true;
}

bool OAIUserWithStats::is_email_verified_Set() const{
    return m_email_verified_isSet;
}

bool OAIUserWithStats::is_email_verified_Valid() const{
    return m_email_verified_isValid;
}

qint32 OAIUserWithStats::getId() const {
    return m_id;
}
void OAIUserWithStats::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUserWithStats::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUserWithStats::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIUserWithStats::getLastLoginDate() const {
    return m_last_login_date;
}
void OAIUserWithStats::setLastLoginDate(const QDateTime &last_login_date) {
    m_last_login_date = last_login_date;
    m_last_login_date_isSet = true;
}

bool OAIUserWithStats::is_last_login_date_Set() const{
    return m_last_login_date_isSet;
}

bool OAIUserWithStats::is_last_login_date_Valid() const{
    return m_last_login_date_isValid;
}

bool OAIUserWithStats::isNoAccountSetupWarningModal() const {
    return m_no_account_setup_warning_modal;
}
void OAIUserWithStats::setNoAccountSetupWarningModal(const bool &no_account_setup_warning_modal) {
    m_no_account_setup_warning_modal = no_account_setup_warning_modal;
    m_no_account_setup_warning_modal_isSet = true;
}

bool OAIUserWithStats::is_no_account_setup_warning_modal_Set() const{
    return m_no_account_setup_warning_modal_isSet;
}

bool OAIUserWithStats::is_no_account_setup_warning_modal_Valid() const{
    return m_no_account_setup_warning_modal_isValid;
}

bool OAIUserWithStats::isNoInstanceConfigWarningModal() const {
    return m_no_instance_config_warning_modal;
}
void OAIUserWithStats::setNoInstanceConfigWarningModal(const bool &no_instance_config_warning_modal) {
    m_no_instance_config_warning_modal = no_instance_config_warning_modal;
    m_no_instance_config_warning_modal_isSet = true;
}

bool OAIUserWithStats::is_no_instance_config_warning_modal_Set() const{
    return m_no_instance_config_warning_modal_isSet;
}

bool OAIUserWithStats::is_no_instance_config_warning_modal_Valid() const{
    return m_no_instance_config_warning_modal_isValid;
}

bool OAIUserWithStats::isNoWelcomeModal() const {
    return m_no_welcome_modal;
}
void OAIUserWithStats::setNoWelcomeModal(const bool &no_welcome_modal) {
    m_no_welcome_modal = no_welcome_modal;
    m_no_welcome_modal_isSet = true;
}

bool OAIUserWithStats::is_no_welcome_modal_Set() const{
    return m_no_welcome_modal_isSet;
}

bool OAIUserWithStats::is_no_welcome_modal_Valid() const{
    return m_no_welcome_modal_isValid;
}

OAINSFWPolicy OAIUserWithStats::getNsfwPolicy() const {
    return m_nsfw_policy;
}
void OAIUserWithStats::setNsfwPolicy(const OAINSFWPolicy &nsfw_policy) {
    m_nsfw_policy = nsfw_policy;
    m_nsfw_policy_isSet = true;
}

bool OAIUserWithStats::is_nsfw_policy_Set() const{
    return m_nsfw_policy_isSet;
}

bool OAIUserWithStats::is_nsfw_policy_Valid() const{
    return m_nsfw_policy_isValid;
}

bool OAIUserWithStats::isP2pEnabled() const {
    return m_p2p_enabled;
}
void OAIUserWithStats::setP2pEnabled(const bool &p2p_enabled) {
    m_p2p_enabled = p2p_enabled;
    m_p2p_enabled_isSet = true;
}

bool OAIUserWithStats::is_p2p_enabled_Set() const{
    return m_p2p_enabled_isSet;
}

bool OAIUserWithStats::is_p2p_enabled_Valid() const{
    return m_p2p_enabled_isValid;
}

QString OAIUserWithStats::getPluginAuth() const {
    return m_plugin_auth;
}
void OAIUserWithStats::setPluginAuth(const QString &plugin_auth) {
    m_plugin_auth = plugin_auth;
    m_plugin_auth_isSet = true;
}

bool OAIUserWithStats::is_plugin_auth_Set() const{
    return m_plugin_auth_isSet;
}

bool OAIUserWithStats::is_plugin_auth_Valid() const{
    return m_plugin_auth_isValid;
}

OAIUser_role OAIUserWithStats::getRole() const {
    return m_role;
}
void OAIUserWithStats::setRole(const OAIUser_role &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIUserWithStats::is_role_Set() const{
    return m_role_isSet;
}

bool OAIUserWithStats::is_role_Valid() const{
    return m_role_isValid;
}

QString OAIUserWithStats::getTheme() const {
    return m_theme;
}
void OAIUserWithStats::setTheme(const QString &theme) {
    m_theme = theme;
    m_theme_isSet = true;
}

bool OAIUserWithStats::is_theme_Set() const{
    return m_theme_isSet;
}

bool OAIUserWithStats::is_theme_Valid() const{
    return m_theme_isValid;
}

QString OAIUserWithStats::getUsername() const {
    return m_username;
}
void OAIUserWithStats::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIUserWithStats::is_username_Set() const{
    return m_username_isSet;
}

bool OAIUserWithStats::is_username_Valid() const{
    return m_username_isValid;
}

QList<OAIVideoChannel> OAIUserWithStats::getVideoChannels() const {
    return m_video_channels;
}
void OAIUserWithStats::setVideoChannels(const QList<OAIVideoChannel> &video_channels) {
    m_video_channels = video_channels;
    m_video_channels_isSet = true;
}

bool OAIUserWithStats::is_video_channels_Set() const{
    return m_video_channels_isSet;
}

bool OAIUserWithStats::is_video_channels_Valid() const{
    return m_video_channels_isValid;
}

qint32 OAIUserWithStats::getVideoQuota() const {
    return m_video_quota;
}
void OAIUserWithStats::setVideoQuota(const qint32 &video_quota) {
    m_video_quota = video_quota;
    m_video_quota_isSet = true;
}

bool OAIUserWithStats::is_video_quota_Set() const{
    return m_video_quota_isSet;
}

bool OAIUserWithStats::is_video_quota_Valid() const{
    return m_video_quota_isValid;
}

qint32 OAIUserWithStats::getVideoQuotaDaily() const {
    return m_video_quota_daily;
}
void OAIUserWithStats::setVideoQuotaDaily(const qint32 &video_quota_daily) {
    m_video_quota_daily = video_quota_daily;
    m_video_quota_daily_isSet = true;
}

bool OAIUserWithStats::is_video_quota_daily_Set() const{
    return m_video_quota_daily_isSet;
}

bool OAIUserWithStats::is_video_quota_daily_Valid() const{
    return m_video_quota_daily_isValid;
}

qint32 OAIUserWithStats::getAbusesAcceptedCount() const {
    return m_abuses_accepted_count;
}
void OAIUserWithStats::setAbusesAcceptedCount(const qint32 &abuses_accepted_count) {
    m_abuses_accepted_count = abuses_accepted_count;
    m_abuses_accepted_count_isSet = true;
}

bool OAIUserWithStats::is_abuses_accepted_count_Set() const{
    return m_abuses_accepted_count_isSet;
}

bool OAIUserWithStats::is_abuses_accepted_count_Valid() const{
    return m_abuses_accepted_count_isValid;
}

qint32 OAIUserWithStats::getAbusesCount() const {
    return m_abuses_count;
}
void OAIUserWithStats::setAbusesCount(const qint32 &abuses_count) {
    m_abuses_count = abuses_count;
    m_abuses_count_isSet = true;
}

bool OAIUserWithStats::is_abuses_count_Set() const{
    return m_abuses_count_isSet;
}

bool OAIUserWithStats::is_abuses_count_Valid() const{
    return m_abuses_count_isValid;
}

qint32 OAIUserWithStats::getAbusesCreatedCount() const {
    return m_abuses_created_count;
}
void OAIUserWithStats::setAbusesCreatedCount(const qint32 &abuses_created_count) {
    m_abuses_created_count = abuses_created_count;
    m_abuses_created_count_isSet = true;
}

bool OAIUserWithStats::is_abuses_created_count_Set() const{
    return m_abuses_created_count_isSet;
}

bool OAIUserWithStats::is_abuses_created_count_Valid() const{
    return m_abuses_created_count_isValid;
}

qint32 OAIUserWithStats::getVideoCommentsCount() const {
    return m_video_comments_count;
}
void OAIUserWithStats::setVideoCommentsCount(const qint32 &video_comments_count) {
    m_video_comments_count = video_comments_count;
    m_video_comments_count_isSet = true;
}

bool OAIUserWithStats::is_video_comments_count_Set() const{
    return m_video_comments_count_isSet;
}

bool OAIUserWithStats::is_video_comments_count_Valid() const{
    return m_video_comments_count_isValid;
}

qint32 OAIUserWithStats::getVideosCount() const {
    return m_videos_count;
}
void OAIUserWithStats::setVideosCount(const qint32 &videos_count) {
    m_videos_count = videos_count;
    m_videos_count_isSet = true;
}

bool OAIUserWithStats::is_videos_count_Set() const{
    return m_videos_count_isSet;
}

bool OAIUserWithStats::is_videos_count_Valid() const{
    return m_videos_count_isValid;
}

bool OAIUserWithStats::isSet() const {
...
bool OAIUserWithStats::isValid() const {
