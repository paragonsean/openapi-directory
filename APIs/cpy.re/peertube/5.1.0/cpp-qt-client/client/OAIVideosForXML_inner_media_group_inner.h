...
/*
 * OAIVideosForXML_inner_media_group_inner.h
 *
 * 
 */

#ifndef OAIVideosForXML_inner_media_group_inner_H
#define OAIVideosForXML_inner_media_group_inner_H

#include <QJsonObject>

#include "OAIMRSSGroupContent.h"
#include "OAIMRSSPeerLink.h"
#include <QString>
...
class OAIVideosForXML_inner_media_group_inner : public OAIObject {
public:
    OAIVideosForXML_inner_media_group_inner();
    OAIVideosForXML_inner_media_group_inner(QString json);
    ~OAIVideosForXML_inner_media_group_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideosForXML_inner_media_group_inner)

#endif // OAIVideosForXML_inner_media_group_inner_H
