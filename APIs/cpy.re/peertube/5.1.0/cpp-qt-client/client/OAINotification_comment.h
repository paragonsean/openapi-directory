...
/*
 * OAINotification_comment.h
 *
 * 
 */

#ifndef OAINotification_comment_H
#define OAINotification_comment_H
...
class OAINotification_comment : public OAIObject {
public:
    OAINotification_comment();
    OAINotification_comment(QString json);
    ~OAINotification_comment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotification_comment)

#endif // OAINotification_comment_H
