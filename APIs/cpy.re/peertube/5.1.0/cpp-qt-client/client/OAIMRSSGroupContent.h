...
/*
 * OAIMRSSGroupContent.h
 *
 * 
 */

#ifndef OAIMRSSGroupContent_H
#define OAIMRSSGroupContent_H
...
class OAIMRSSGroupContent : public OAIObject {
public:
    OAIMRSSGroupContent();
    OAIMRSSGroupContent(QString json);
    ~OAIMRSSGroupContent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMRSSGroupContent)

#endif // OAIMRSSGroupContent_H
