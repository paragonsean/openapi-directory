...
/*
 * OAIVideoCommentsForXML_inner.h
 *
 * 
 */

#ifndef OAIVideoCommentsForXML_inner_H
#define OAIVideoCommentsForXML_inner_H
...
class OAIVideoCommentsForXML_inner : public OAIObject {
public:
    OAIVideoCommentsForXML_inner();
    OAIVideoCommentsForXML_inner(QString json);
    ~OAIVideoCommentsForXML_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoCommentsForXML_inner)

#endif // OAIVideoCommentsForXML_inner_H
