...
#ifndef OAIVideoChannel_H
#define OAIVideoChannel_H
...
class OAIVideoChannel : public OAIObject {
public:
    OAIVideoChannel();
    OAIVideoChannel(QString json);
    ~OAIVideoChannel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoChannel)

#endif // OAIVideoChannel_H
