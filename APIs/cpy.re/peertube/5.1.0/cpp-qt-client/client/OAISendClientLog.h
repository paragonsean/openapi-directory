...
#ifndef OAISendClientLog_H
#define OAISendClientLog_H
...
class OAISendClientLog : public OAIObject {
public:
    OAISendClientLog();
    OAISendClientLog(QString json);
    ~OAISendClientLog() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendClientLog)

#endif // OAISendClientLog_H
