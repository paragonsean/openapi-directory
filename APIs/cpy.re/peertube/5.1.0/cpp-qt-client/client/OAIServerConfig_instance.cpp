...
OAIServerConfig_instance::OAIServerConfig_instance(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServerConfig_instance::OAIServerConfig_instance() {
    this->initializeModel();
}

OAIServerConfig_instance::~OAIServerConfig_instance() {}

void OAIServerConfig_instance::initializeModel() {
...
void OAIServerConfig_instance::fromJson(QString jsonString) {
...
void OAIServerConfig_instance::fromJsonObject(QJsonObject json) {
...
QString OAIServerConfig_instance::asJson() const {
...
QJsonObject OAIServerConfig_instance::asJsonObject() const {
    QJsonObject obj;
...
OAIServerConfig_instance_customizations OAIServerConfig_instance::getCustomizations() const {
    return m_customizations;
}
void OAIServerConfig_instance::setCustomizations(const OAIServerConfig_instance_customizations &customizations) {
    m_customizations = customizations;
    m_customizations_isSet = true;
}

bool OAIServerConfig_instance::is_customizations_Set() const{
    return m_customizations_isSet;
}

bool OAIServerConfig_instance::is_customizations_Valid() const{
    return m_customizations_isValid;
}

QString OAIServerConfig_instance::getDefaultClientRoute() const {
    return m_default_client_route;
}
void OAIServerConfig_instance::setDefaultClientRoute(const QString &default_client_route) {
    m_default_client_route = default_client_route;
    m_default_client_route_isSet = true;
}

bool OAIServerConfig_instance::is_default_client_route_Set() const{
    return m_default_client_route_isSet;
}

bool OAIServerConfig_instance::is_default_client_route_Valid() const{
    return m_default_client_route_isValid;
}

QString OAIServerConfig_instance::getDefaultNsfwPolicy() const {
    return m_default_nsfw_policy;
}
void OAIServerConfig_instance::setDefaultNsfwPolicy(const QString &default_nsfw_policy) {
    m_default_nsfw_policy = default_nsfw_policy;
    m_default_nsfw_policy_isSet = true;
}

bool OAIServerConfig_instance::is_default_nsfw_policy_Set() const{
    return m_default_nsfw_policy_isSet;
}

bool OAIServerConfig_instance::is_default_nsfw_policy_Valid() const{
    return m_default_nsfw_policy_isValid;
}

bool OAIServerConfig_instance::isIsNsfw() const {
    return m_is_nsfw;
}
void OAIServerConfig_instance::setIsNsfw(const bool &is_nsfw) {
    m_is_nsfw = is_nsfw;
    m_is_nsfw_isSet = true;
}

bool OAIServerConfig_instance::is_is_nsfw_Set() const{
    return m_is_nsfw_isSet;
}

bool OAIServerConfig_instance::is_is_nsfw_Valid() const{
    return m_is_nsfw_isValid;
}

QString OAIServerConfig_instance::getName() const {
    return m_name;
}
void OAIServerConfig_instance::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIServerConfig_instance::is_name_Set() const{
    return m_name_isSet;
}

bool OAIServerConfig_instance::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIServerConfig_instance::getShortDescription() const {
    return m_short_description;
}
void OAIServerConfig_instance::setShortDescription(const QString &short_description) {
    m_short_description = short_description;
    m_short_description_isSet = true;
}

bool OAIServerConfig_instance::is_short_description_Set() const{
    return m_short_description_isSet;
}

bool OAIServerConfig_instance::is_short_description_Valid() const{
    return m_short_description_isValid;
}

bool OAIServerConfig_instance::isSet() const {
...
bool OAIServerConfig_instance::isValid() const {
