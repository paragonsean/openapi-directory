...
#ifndef OAIUserWithStats_H
#define OAIUserWithStats_H
...
class OAIUserWithStats : public OAIObject {
public:
    OAIUserWithStats();
    OAIUserWithStats(QString json);
    ~OAIUserWithStats() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserWithStats)

#endif // OAIUserWithStats_H
