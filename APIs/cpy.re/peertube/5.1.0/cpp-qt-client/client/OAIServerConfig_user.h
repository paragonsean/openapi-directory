...
/*
 * OAIServerConfig_user.h
 *
 * 
 */

#ifndef OAIServerConfig_user_H
#define OAIServerConfig_user_H
...
class OAIServerConfig_user : public OAIObject {
public:
    OAIServerConfig_user();
    OAIServerConfig_user(QString json);
    ~OAIServerConfig_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerConfig_user)

#endif // OAIServerConfig_user_H
