...
OAIServerConfig_user::OAIServerConfig_user(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIServerConfig_user::OAIServerConfig_user() {
    this->initializeModel();
}

OAIServerConfig_user::~OAIServerConfig_user() {}

void OAIServerConfig_user::initializeModel() {
...
void OAIServerConfig_user::fromJson(QString jsonString) {
...
void OAIServerConfig_user::fromJsonObject(QJsonObject json) {
...
QString OAIServerConfig_user::asJson() const {
...
QJsonObject OAIServerConfig_user::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIServerConfig_user::getVideoQuota() const {
    return m_video_quota;
}
void OAIServerConfig_user::setVideoQuota(const qint32 &video_quota) {
    m_video_quota = video_quota;
    m_video_quota_isSet = true;
}

bool OAIServerConfig_user::is_video_quota_Set() const{
    return m_video_quota_isSet;
}

bool OAIServerConfig_user::is_video_quota_Valid() const{
    return m_video_quota_isValid;
}

qint32 OAIServerConfig_user::getVideoQuotaDaily() const {
    return m_video_quota_daily;
}
void OAIServerConfig_user::setVideoQuotaDaily(const qint32 &video_quota_daily) {
    m_video_quota_daily = video_quota_daily;
    m_video_quota_daily_isSet = true;
}

bool OAIServerConfig_user::is_video_quota_daily_Set() const{
    return m_video_quota_daily_isSet;
}

bool OAIServerConfig_user::is_video_quota_daily_Valid() const{
    return m_video_quota_daily_isValid;
}

bool OAIServerConfig_user::isSet() const {
...
bool OAIServerConfig_user::isValid() const {
