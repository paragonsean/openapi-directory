...
OAIVideoUploadApi::OAIVideoUploadApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIVideoUploadApi::~OAIVideoUploadApi() {
}

void OAIVideoUploadApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIVideoUploadApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIVideoUploadApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIVideoUploadApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIVideoUploadApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIVideoUploadApi::setUsername(const QString &username) {
    _username = username;
}

void OAIVideoUploadApi::setPassword(const QString &password) {
    _password = password;
}


void OAIVideoUploadApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIVideoUploadApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIVideoUploadApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIVideoUploadApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIVideoUploadApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIVideoUploadApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIVideoUploadApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIVideoUploadApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIVideoUploadApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIVideoUploadApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIVideoUploadApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIVideoUploadApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIVideoUploadApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIVideoUploadApi::importVideo(const qint32 &channel_id, const QString &name, const ::OpenAPI::OptionalParam<QString> &target_url, const ::OpenAPI::OptionalParam<QString> &magnet_uri, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &torrentfile, const ::OpenAPI::OptionalParam<qint32> &category, const ::OpenAPI::OptionalParam<bool> &comments_enabled, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<bool> &download_enabled, const ::OpenAPI::OptionalParam<QString> &language, const ::OpenAPI::OptionalParam<qint32> &licence, const ::OpenAPI::OptionalParam<bool> &nsfw, const ::OpenAPI::OptionalParam<QDateTime> &originally_published_at, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &previewfile, const ::OpenAPI::OptionalParam<OAIVideoPrivacySet> &privacy, const ::OpenAPI::OptionalParam<OAIVideoScheduledUpdate> &schedule_update, const ::OpenAPI::OptionalParam<QString> &support, const ::OpenAPI::OptionalParam<QSet<QString>> &tags, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &thumbnailfile, const ::OpenAPI::OptionalParam<bool> &wait_transcoding) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideoUploadApi::importVideoCallback);
    connect(this, &OAIVideoUploadApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideoUploadApi::importVideoCallback);
    connect(this, &OAIVideoUploadApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIVideoUploadApi::importVideoCallback(OAIHttpRequestWorker *worker) {
...
void OAIVideoUploadApi::uploadLegacy(const QString &name, const OAIHttpFileElement &videofile, const ::OpenAPI::OptionalParam<qint32> &category, const ::OpenAPI::OptionalParam<qint32> &channel_id, const ::OpenAPI::OptionalParam<bool> &comments_enabled, const ::OpenAPI::OptionalParam<QString> &description, const ::OpenAPI::OptionalParam<bool> &download_enabled, const ::OpenAPI::OptionalParam<QString> &language, const ::OpenAPI::OptionalParam<qint32> &licence, const ::OpenAPI::OptionalParam<bool> &nsfw, const ::OpenAPI::OptionalParam<QDateTime> &originally_published_at, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &previewfile, const ::OpenAPI::OptionalParam<OAIVideoPrivacySet> &privacy, const ::OpenAPI::OptionalParam<OAIVideoScheduledUpdate> &schedule_update, const ::OpenAPI::OptionalParam<QString> &support, const ::OpenAPI::OptionalParam<QSet<QString>> &tags, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &thumbnailfile, const ::OpenAPI::OptionalParam<bool> &wait_transcoding) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideoUploadApi::uploadLegacyCallback);
    connect(this, &OAIVideoUploadApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideoUploadApi::uploadLegacyCallback);
    connect(this, &OAIVideoUploadApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVideoUploadApi::uploadLegacyCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIVideoUploadApi::uploadResumableCancel(const QString &upload_id, const double &content_length) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideoUploadApi::uploadResumableCancelCallback);
    connect(this, &OAIVideoUploadApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideoUploadApi::uploadResumableCancelCallback);
    connect(this, &OAIVideoUploadApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVideoUploadApi::uploadResumableCancelCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIVideoUploadApi::uploadResumableInit(const double &x_upload_content_length, const QString &x_upload_content_type, const ::OpenAPI::OptionalParam<OAIVideoUploadRequestResumable> &oai_video_upload_request_resumable) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideoUploadApi::uploadResumableInitCallback);
    connect(this, &OAIVideoUploadApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideoUploadApi::uploadResumableInitCallback);
    connect(this, &OAIVideoUploadApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVideoUploadApi::uploadResumableInitCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIVideoUploadApi::uploadResumable(const QString &upload_id, const QString &content_range, const double &content_length, const ::OpenAPI::OptionalParam<OAIHttpFileElement> &body) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideoUploadApi::uploadResumableCallback);
    connect(this, &OAIVideoUploadApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideoUploadApi::uploadResumableCallback);
    connect(this, &OAIVideoUploadApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVideoUploadApi::uploadResumableCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIVideoUploadApi::tokenAvailable(){
