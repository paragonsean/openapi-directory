...
OAIAddUserResponse_user OAIAddUserResponse::getUser() const {
    return m_user;
}
void OAIAddUserResponse::setUser(const OAIAddUserResponse_user &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIAddUserResponse::is_user_Set() const{
    return m_user_isSet;
}

bool OAIAddUserResponse::is_user_Valid() const{
