...
#ifndef OAI_OAILiveVideosApi_H
#define OAI_OAILiveVideosApi_H
...
class OAILiveVideosApi : public QObject {
    Q_OBJECT

public:
    OAILiveVideosApi(const int timeOut = 0);
    ~OAILiveVideosApi();
    ...
    */
    virtual void apiV1VideosIdLiveSessionGet(const OAIGetLiveId_id_parameter &id);

    /**
    * @param[in]  id OAIGetLiveId_id_parameter [required]
    */
    virtual void apiV1VideosLiveIdSessionsGet(const OAIGetLiveId_id_parameter &id);
...
private:
    ...
    void apiV1VideosIdLiveSessionGetCallback(OAIHttpRequestWorker *worker);
    void apiV1VideosLiveIdSessionsGetCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void apiV1VideosIdLiveSessionGetSignal(OAILiveVideoSessionResponse summary);
    void apiV1VideosLiveIdSessionsGetSignal(OAI_api_v1_videos_live__id__sessions_get_200_response summary);
    ...
    void apiV1VideosIdLiveSessionGetSignalFull(OAIHttpRequestWorker *worker, OAILiveVideoSessionResponse summary);
    void apiV1VideosLiveIdSessionsGetSignalFull(OAIHttpRequestWorker *worker, OAI_api_v1_videos_live__id__sessions_get_200_response summary);
    ...
    Q_DECL_DEPRECATED_X("Use apiV1VideosIdLiveSessionGetSignalError() instead")
    void apiV1VideosIdLiveSessionGetSignalE(OAILiveVideoSessionResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV1VideosIdLiveSessionGetSignalError(OAILiveVideoSessionResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV1VideosLiveIdSessionsGetSignalError() instead")
    void apiV1VideosLiveIdSessionsGetSignalE(OAI_api_v1_videos_live__id__sessions_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV1VideosLiveIdSessionsGetSignalError(OAI_api_v1_videos_live__id__sessions_get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use apiV1VideosIdLiveSessionGetSignalErrorFull() instead")
    void apiV1VideosIdLiveSessionGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV1VideosIdLiveSessionGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apiV1VideosLiveIdSessionsGetSignalErrorFull() instead")
    void apiV1VideosLiveIdSessionsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV1VideosLiveIdSessionsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
