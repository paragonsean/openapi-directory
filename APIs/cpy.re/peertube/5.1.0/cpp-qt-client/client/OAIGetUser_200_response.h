...
/*
 * OAIGetUser_200_response.h
 *
 * 
 */

#ifndef OAIGetUser_200_response_H
#define OAIGetUser_200_response_H
...
class OAIGetUser_200_response : public OAIObject {
public:
    OAIGetUser_200_response();
    OAIGetUser_200_response(QString json);
    ~OAIGetUser_200_response() override;
    ...
    qint32 getAbusesAcceptedCount() const;
    void setAbusesAcceptedCount(const qint32 &abuses_accepted_count);
    bool is_abuses_accepted_count_Set() const;
    bool is_abuses_accepted_count_Valid() const;

    qint32 getAbusesCount() const;
    void setAbusesCount(const qint32 &abuses_count);
    bool is_abuses_count_Set() const;
    bool is_abuses_count_Valid() const;

    qint32 getAbusesCreatedCount() const;
    void setAbusesCreatedCount(const qint32 &abuses_created_count);
    bool is_abuses_created_count_Set() const;
    bool is_abuses_created_count_Valid() const;

    qint32 getVideoCommentsCount() const;
    void setVideoCommentsCount(const qint32 &video_comments_count);
    bool is_video_comments_count_Set() const;
    bool is_video_comments_count_Valid() const;

    qint32 getVideosCount() const;
    void setVideosCount(const qint32 &videos_count);
    bool is_videos_count_Set() const;
    bool is_videos_count_Valid() const;
...
private:
    ...
    qint32 m_abuses_accepted_count;
    bool m_abuses_accepted_count_isSet;
    bool m_abuses_accepted_count_isValid;

    qint32 m_abuses_count;
    bool m_abuses_count_isSet;
    bool m_abuses_count_isValid;

    qint32 m_abuses_created_count;
    bool m_abuses_created_count_isSet;
    bool m_abuses_created_count_isValid;

    qint32 m_video_comments_count;
    bool m_video_comments_count_isSet;
    bool m_video_comments_count_isValid;

    qint32 m_videos_count;
    bool m_videos_count_isSet;
    bool m_videos_count_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetUser_200_response)

#endif // OAIGetUser_200_response_H
