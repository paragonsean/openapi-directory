...
class OAIFollow : public OAIObject {
public:
    OAIFollow();
    OAIFollow(QString json);
    ~OAIFollow() override;
    ...
    OAIActor getFollower() const;
    void setFollower(const OAIActor &follower);
    bool is_follower_Set() const;
    bool is_follower_Valid() const;

    OAIActor getFollowing() const;
    void setFollowing(const OAIActor &following);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFollow)
