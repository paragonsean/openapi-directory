...
/*
 * OAIServerConfigCustom_user.h
 *
 * Settings that apply to new users, if registration is enabled
 */

#ifndef OAIServerConfigCustom_user_H
#define OAIServerConfigCustom_user_H
...
class OAIServerConfigCustom_user : public OAIObject {
public:
    OAIServerConfigCustom_user();
    OAIServerConfigCustom_user(QString json);
    ~OAIServerConfigCustom_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerConfigCustom_user)

#endif // OAIServerConfigCustom_user_H
