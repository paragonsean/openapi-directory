...
public:
    ...
    */
    virtual void apiV1AccountsNameRatingsGet(const QString &name, const ::OpenAPI::OptionalParam<qint32> &start = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &count = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &rating = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  name QString [required]
    */
    virtual void getAccount(const QString &name);
    ...
    * @param[in]  sort QString [optional]
    */
    virtual void getAccounts(const ::OpenAPI::OptionalParam<qint32> &start = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &count = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void apiV1AccountsNameRatingsGetCallback(OAIHttpRequestWorker *worker);
    ...
    void getAccountFollowersCallback(OAIHttpRequestWorker *worker);
    void getAccountVideosCallback(OAIHttpRequestWorker *worker);
    void getAccountsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void apiV1AccountsNameRatingsGetSignal(QList<OAIVideoRating> summary);
    ...
    void getAccountFollowersSignal(OAIGetAccountFollowers_200_response summary);
    void getAccountVideosSignal(OAIVideoListResponse summary);
    void getAccountsSignal(QList<OAIAccount> summary);


    void apiV1AccountsNameRatingsGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIVideoRating> summary);
    ...
    void getAccountFollowersSignalFull(OAIHttpRequestWorker *worker, OAIGetAccountFollowers_200_response summary);
    void getAccountVideosSignalFull(OAIHttpRequestWorker *worker, OAIVideoListResponse summary);
    void getAccountsSignalFull(OAIHttpRequestWorker *worker, QList<OAIAccount> summary);

    Q_DECL_DEPRECATED_X("Use apiV1AccountsNameRatingsGetSignalError() instead")
    void apiV1AccountsNameRatingsGetSignalE(QList<OAIVideoRating> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV1AccountsNameRatingsGetSignalError(QList<OAIVideoRating> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getAccountFollowersSignalError() instead")
    void getAccountFollowersSignalE(OAIGetAccountFollowers_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccountFollowersSignalError(OAIGetAccountFollowers_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void getAccountsSignalE(QList<OAIAccount> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccountsSignalError(QList<OAIAccount> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use apiV1AccountsNameRatingsGetSignalErrorFull() instead")
    void apiV1AccountsNameRatingsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apiV1AccountsNameRatingsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getAccountFollowersSignalErrorFull() instead")
    void getAccountFollowersSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAccountFollowersSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
