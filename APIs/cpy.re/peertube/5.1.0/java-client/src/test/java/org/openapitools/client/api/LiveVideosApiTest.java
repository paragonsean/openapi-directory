...
/**
 * API tests for LiveVideosApi
 */
@Disabled
public class LiveVideosApiTest {

    private final LiveVideosApi api = new LiveVideosApi();
     ...
     */
    @Test
    public void addLiveTest() throws ApiException {
        ...
        VideoUploadResponse response = api.addLive(channelId, name, category, commentsEnabled, description, downloadEnabled, language, latencyMode, licence, nsfw, permanentLive, previewfile, privacy, replaySettings, saveReplay, support, tags, thumbnailfile);
     ...
     */
    @Test
    public void apiV1VideosIdLiveSessionGetTest() throws ApiException {
        GetLiveIdIdParameter id = null;
        LiveVideoSessionResponse response = api.apiV1VideosIdLiveSessionGet(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void apiV1VideosLiveIdSessionsGetTest() throws ApiException {
        GetLiveIdIdParameter id = null;
        ApiV1VideosLiveIdSessionsGet200Response response = api.apiV1VideosLiveIdSessionsGet(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getLiveIdTest() throws ApiException {
        GetLiveIdIdParameter id = null;
        LiveVideoResponse response = api.getLiveId(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateLiveIdTest() throws ApiException {
        GetLiveIdIdParameter id = null;
