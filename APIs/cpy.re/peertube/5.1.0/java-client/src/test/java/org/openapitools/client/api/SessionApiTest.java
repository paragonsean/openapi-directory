...
public class SessionApiTest {
    ...
    public void getOAuthClientTest() throws ApiException {
        OAuthClient response = api.getOAuthClient();
    ...
    public void getOAuthTokenTest() throws ApiException {
        ...
        GetOAuthToken200Response response = api.getOAuthToken(clientId, clientSecret, grantType, password, username, refreshToken);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void revokeOAuthTokenTest() throws ApiException {
