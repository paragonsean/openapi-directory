...
public class AccountsApiTest {
     ...
     */
    @Test
    public void apiV1AccountsNameRatingsGetTest() throws ApiException {
        String name = null;
        Integer start = null;
        Integer count = null;
        String sort = null;
        String rating = null;
        List<VideoRating> response = api.apiV1AccountsNameRatingsGet(name, start, count, sort, rating);
     ...
     */
    @Test
    public void apiV1AccountsNameVideoChannelSyncsGet_1Test() throws ApiException {
        String name = null;
        Integer start = null;
        Integer count = null;
        String sort = null;
        VideoChannelSyncList response = api.apiV1AccountsNameVideoChannelSyncsGet_1(name, start, count, sort);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void apiV1AccountsNameVideoChannelsGet_0Test() throws ApiException {
        String name = null;
        Boolean withStats = null;
        Integer start = null;
        Integer count = null;
        String sort = null;
        VideoChannelList response = api.apiV1AccountsNameVideoChannelsGet_0(name, withStats, start, count, sort);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void apiV1AccountsNameVideoPlaylistsGet_0Test() throws ApiException {
        String name = null;
        Integer start = null;
        Integer count = null;
        String sort = null;
        ...
        ApiV1AccountsNameVideoPlaylistsGet200Response response = api.apiV1AccountsNameVideoPlaylistsGet_0(name, start, count, sort, search, playlistType);
        // TODO: test validations
    }
    ...
    public void getAccountTest() throws ApiException {
        String name = null;
        Account response = api.getAccount(name);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAccountFollowersTest() throws ApiException {
        String name = null;
        Integer start = null;
        Integer count = null;
        String sort = null;
        String search = null;
        GetAccountFollowers200Response response = api.getAccountFollowers(name, start, count, sort, search);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAccountVideosTest() throws ApiException {
        String name = null;
        ...
        VideoListResponse response = api.getAccountVideos(name, categoryOneOf, isLive, tagsOneOf, tagsAllOf, licenceOneOf, languageOneOf, nsfw, isLocal, include, privacyOneOf, hasHLSFiles, hasWebtorrentFiles, skipCount, start, count, sort, excludeAlreadyWatched);
        // TODO: test validations
    }
    ...
    public void getAccountsTest() throws ApiException {
        ...
        Integer count = null;
        String sort = null;
        List<Account> response = api.getAccounts(start, count, sort);
        // TODO: test validations
    }
