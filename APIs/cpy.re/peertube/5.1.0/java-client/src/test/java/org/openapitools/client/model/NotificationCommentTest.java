...
/**
 * Model tests for NotificationComment
 */
public class NotificationCommentTest {
    private final NotificationComment model = new NotificationComment();
