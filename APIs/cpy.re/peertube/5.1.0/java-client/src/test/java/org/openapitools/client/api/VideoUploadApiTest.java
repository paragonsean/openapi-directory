...
/**
 * API tests for VideoUploadApi
 */
@Disabled
public class VideoUploadApiTest {

    private final VideoUploadApi api = new VideoUploadApi();
     ...
     */
    @Test
    public void importVideo_0Test() throws ApiException {
        ...
        VideoUploadResponse response = api.importVideo_0(channelId, name, targetUrl, magnetUri, torrentfile, category, commentsEnabled, description, downloadEnabled, language, licence, nsfw, originallyPublishedAt, previewfile, privacy, scheduleUpdate, support, tags, thumbnailfile, waitTranscoding);
     ...
     */
    @Test
    public void uploadLegacy_0Test() throws ApiException {
        Integer channelId = null;
        String name = null;
        File videofile = null;
        Integer category = null;
        ...
        File thumbnailfile = null;
        Boolean waitTranscoding = null;
        VideoUploadResponse response = api.uploadLegacy_0(channelId, name, videofile, category, commentsEnabled, description, downloadEnabled, language, licence, nsfw, originallyPublishedAt, previewfile, privacy, scheduleUpdate, support, tags, thumbnailfile, waitTranscoding);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void uploadResumableCancel_0Test() throws ApiException {
     ...
     */
    @Test
    public void uploadResumableInit_0Test() throws ApiException {
     ...
     */
    @Test
    public void uploadResumable_0Test() throws ApiException {
        String uploadId = null;
        String contentRange = null;
        BigDecimal contentLength = null;
        File body = null;
        VideoUploadResponse response = api.uploadResumable_0(uploadId, contentRange, contentLength, body);
        // TODO: test validations
    }
