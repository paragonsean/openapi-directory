...
/**
 * API tests for MySubscriptionsApi
 */
@Disabled
public class MySubscriptionsApiTest {

    private final MySubscriptionsApi api = new MySubscriptionsApi();
     ...
     */
    @Test
    public void apiV1UsersMeSubscriptionsExistGetTest() throws ApiException {
        List<URI> uris = null;
        Object response = api.apiV1UsersMeSubscriptionsExistGet(uris);
     ...
     */
    @Test
    public void apiV1UsersMeSubscriptionsGetTest() throws ApiException {
        Integer start = null;
        Integer count = null;
        String sort = null;
        VideoChannelList response = api.apiV1UsersMeSubscriptionsGet(start, count, sort);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void apiV1UsersMeSubscriptionsPostTest() throws ApiException {
        ApiV1UsersMeSubscriptionsPostRequest apiV1UsersMeSubscriptionsPostRequest = null;
     ...
     */
    @Test
    public void apiV1UsersMeSubscriptionsSubscriptionHandleDeleteTest() throws ApiException {
        String subscriptionHandle = null;
     ...
     */
    @Test
    public void apiV1UsersMeSubscriptionsSubscriptionHandleGetTest() throws ApiException {
        String subscriptionHandle = null;
        VideoChannel response = api.apiV1UsersMeSubscriptionsSubscriptionHandleGet(subscriptionHandle);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void apiV1UsersMeSubscriptionsVideosGetTest() throws ApiException {
        ...
        VideoListResponse response = api.apiV1UsersMeSubscriptionsVideosGet(categoryOneOf, isLive, tagsOneOf, tagsAllOf, licenceOneOf, languageOneOf, nsfw, isLocal, include, privacyOneOf, hasHLSFiles, hasWebtorrentFiles, skipCount, start, count, sort, excludeAlreadyWatched);
        // TODO: test validations
    }
