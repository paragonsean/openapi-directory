...
public class SearchApiTest {
    ...
    public void searchChannelsTest() throws ApiException {
        ...
        String sort = null;
        VideoChannelList response = api.searchChannels(search, start, count, searchTarget, sort);
    ...
    public void searchPlaylistsTest() throws ApiException {
        ...
        String searchTarget = null;
        String sort = null;
        ApiV1AccountsNameVideoPlaylistsGet200Response response = api.searchPlaylists(search, start, count, searchTarget, sort);
        // TODO: test validations
    }
