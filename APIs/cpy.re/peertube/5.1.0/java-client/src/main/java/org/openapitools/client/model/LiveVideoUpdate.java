...
public class LiveVideoUpdate {
  ...
  public LiveVideoUpdate() {
  }

  public LiveVideoUpdate latencyMode(LiveVideoLatencyMode latencyMode) {
  ...
  public LiveVideoUpdate permanentLive(Boolean permanentLive) {
  ...
  public LiveVideoUpdate replaySettings(LiveVideoReplaySettings replaySettings) {
  ...
  public LiveVideoUpdate saveReplay(Boolean saveReplay) {
  ...
  public boolean equals(Object o) {
    ...
    LiveVideoUpdate liveVideoUpdate = (LiveVideoUpdate) o;
    return Objects.equals(this.latencyMode, liveVideoUpdate.latencyMode) &&
        Objects.equals(this.permanentLive, liveVideoUpdate.permanentLive) &&
        Objects.equals(this.replaySettings, liveVideoUpdate.replaySettings) &&
        Objects.equals(this.saveReplay, liveVideoUpdate.saveReplay);
  }

  @Override
  public int hashCode() {
    return Objects.hash(latencyMode, permanentLive, replaySettings, saveReplay);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LiveVideoUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LiveVideoUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LiveVideoUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LiveVideoUpdate is not found in the empty JSON string", LiveVideoUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LiveVideoUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LiveVideoUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LiveVideoUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LiveVideoUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LiveVideoUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LiveVideoUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<LiveVideoUpdate>() {
           @Override
           public void write(JsonWriter out, LiveVideoUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LiveVideoUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LiveVideoUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LiveVideoUpdate
   * @throws IOException if the JSON string is invalid with respect to LiveVideoUpdate
   */
  public static LiveVideoUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LiveVideoUpdate.class);
  }

  /**
   * Convert an instance of LiveVideoUpdate to an JSON string
   *
   * @return JSON string
   */
