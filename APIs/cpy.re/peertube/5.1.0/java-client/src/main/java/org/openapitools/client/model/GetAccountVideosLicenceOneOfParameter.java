...
public class GetAccountVideosLicenceOneOfParameter extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetAccountVideosLicenceOneOfParameter.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetAccountVideosLicenceOneOfParameter.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetAccountVideosLicenceOneOfParameter' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetAccountVideosLicenceOneOfParameter>() {
                @Override
                public void write(JsonWriter out, GetAccountVideosLicenceOneOfParameter value) throws IOException {
                ...
                @Override
                public GetAccountVideosLicenceOneOfParameter read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetAccountVideosLicenceOneOfParameter ret = new GetAccountVideosLicenceOneOfParameter();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetAccountVideosLicenceOneOfParameter: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetAccountVideosLicenceOneOfParameter() {
        super("oneOf", Boolean.FALSE);
    }

    public GetAccountVideosLicenceOneOfParameter(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetAccountVideosLicenceOneOfParameter.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetAccountVideosLicenceOneOfParameter
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for GetAccountVideosLicenceOneOfParameter with oneOf schemas: Integer, List<Integer>. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of GetAccountVideosLicenceOneOfParameter given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetAccountVideosLicenceOneOfParameter
     * @throws IOException if the JSON string is invalid with respect to GetAccountVideosLicenceOneOfParameter
     */
    public static GetAccountVideosLicenceOneOfParameter fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetAccountVideosLicenceOneOfParameter.class);
    }

    /**
     * Convert an instance of GetAccountVideosLicenceOneOfParameter to an JSON string
     *
     * @return JSON string
     */
