...
public class ServerConfigCustomInstance {
  ...
  public ServerConfigCustomInstance() {
  }

  public ServerConfigCustomInstance customizations(ServerConfigInstanceCustomizations customizations) {
  ...
  public ServerConfigCustomInstance defaultClientRoute(String defaultClientRoute) {
  ...
  public ServerConfigCustomInstance defaultNSFWPolicy(String defaultNSFWPolicy) {
  ...
  public ServerConfigCustomInstance description(String description) {
  ...
  public ServerConfigCustomInstance isNSFW(Boolean isNSFW) {
    this.isNSFW = isNSFW;
    return this;
  }
  ...
  public ServerConfigCustomInstance name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ServerConfigCustomInstance shortDescription(String shortDescription) {
  ...
  public ServerConfigCustomInstance terms(String terms) {
    this.terms = terms;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServerConfigCustomInstance serverConfigCustomInstance = (ServerConfigCustomInstance) o;
    return Objects.equals(this.customizations, serverConfigCustomInstance.customizations) &&
        Objects.equals(this.defaultClientRoute, serverConfigCustomInstance.defaultClientRoute) &&
        Objects.equals(this.defaultNSFWPolicy, serverConfigCustomInstance.defaultNSFWPolicy) &&
        Objects.equals(this.description, serverConfigCustomInstance.description) &&
        Objects.equals(this.isNSFW, serverConfigCustomInstance.isNSFW) &&
        Objects.equals(this.name, serverConfigCustomInstance.name) &&
        Objects.equals(this.shortDescription, serverConfigCustomInstance.shortDescription) &&
        Objects.equals(this.terms, serverConfigCustomInstance.terms);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customizations, defaultClientRoute, defaultNSFWPolicy, description, isNSFW, name, shortDescription, terms);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServerConfigCustomInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServerConfigCustomInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServerConfigCustomInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServerConfigCustomInstance is not found in the empty JSON string", ServerConfigCustomInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServerConfigCustomInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServerConfigCustomInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServerConfigCustomInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServerConfigCustomInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServerConfigCustomInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServerConfigCustomInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<ServerConfigCustomInstance>() {
           @Override
           public void write(JsonWriter out, ServerConfigCustomInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServerConfigCustomInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServerConfigCustomInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServerConfigCustomInstance
   * @throws IOException if the JSON string is invalid with respect to ServerConfigCustomInstance
   */
  public static ServerConfigCustomInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServerConfigCustomInstance.class);
  }

  /**
   * Convert an instance of ServerConfigCustomInstance to an JSON string
   *
   * @return JSON string
   */
