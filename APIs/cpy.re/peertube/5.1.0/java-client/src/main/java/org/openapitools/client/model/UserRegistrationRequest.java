...
public class UserRegistrationRequest {
  ...
  public UserRegistrationRequest channel(RegisterUserChannel channel) {
  ...
  public UserRegistrationRequest displayName(String displayName) {
  ...
  public UserRegistrationRequest registrationReason(String registrationReason) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.channel, userRegistrationRequest.channel) &&
        Objects.equals(this.displayName, userRegistrationRequest.displayName) &&
        ...
        Objects.equals(this.registrationReason, userRegistrationRequest.registrationReason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channel, displayName, email, password, username, registrationReason);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("registrationReason");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("registrationReason").isJsonPrimitive()) {
