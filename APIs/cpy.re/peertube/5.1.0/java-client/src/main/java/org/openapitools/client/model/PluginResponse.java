...
public class PluginResponse {
  ...
  public PluginResponse data(List<Plugin> data) {
    this.data = data;
    return this;
  }

  public PluginResponse addDataItem(Plugin dataItem) {
    if (this.data == null) {
  ...
  public PluginResponse total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, pluginResponse.data) &&
        Objects.equals(this.total, pluginResponse.total);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PluginResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PluginResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Plugin.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
