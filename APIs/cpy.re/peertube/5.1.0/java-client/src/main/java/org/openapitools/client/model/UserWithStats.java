...
public class UserWithStats {
  ...
  public static final String SERIALIZED_NAME_ABUSES_ACCEPTED_COUNT = "abusesAcceptedCount";
  @SerializedName(SERIALIZED_NAME_ABUSES_ACCEPTED_COUNT)
  private Integer abusesAcceptedCount;

  public static final String SERIALIZED_NAME_ABUSES_COUNT = "abusesCount";
  @SerializedName(SERIALIZED_NAME_ABUSES_COUNT)
  private Integer abusesCount;

  public static final String SERIALIZED_NAME_ABUSES_CREATED_COUNT = "abusesCreatedCount";
  @SerializedName(SERIALIZED_NAME_ABUSES_CREATED_COUNT)
  private Integer abusesCreatedCount;

  public static final String SERIALIZED_NAME_VIDEO_COMMENTS_COUNT = "videoCommentsCount";
  @SerializedName(SERIALIZED_NAME_VIDEO_COMMENTS_COUNT)
  private Integer videoCommentsCount;

  public static final String SERIALIZED_NAME_VIDEOS_COUNT = "videosCount";
  @SerializedName(SERIALIZED_NAME_VIDEOS_COUNT)
  ...
  public UserWithStats account(Account account) {
  ...
  public UserWithStats autoPlayNextVideo(Boolean autoPlayNextVideo) {
  ...
  public UserWithStats autoPlayNextVideoPlaylist(Boolean autoPlayNextVideoPlaylist) {
  ...
  public UserWithStats autoPlayVideo(Boolean autoPlayVideo) {
  ...
  public UserWithStats blocked(Boolean blocked) {
  ...
  public UserWithStats blockedReason(String blockedReason) {
  ...
  public UserWithStats createdAt(String createdAt) {
  ...
  public UserWithStats email(String email) {
    this.email = email;
    return this;
  }
  ...
  public UserWithStats emailVerified(Boolean emailVerified) {
  ...
  public UserWithStats lastLoginDate(OffsetDateTime lastLoginDate) {
  ...
  public UserWithStats noAccountSetupWarningModal(Boolean noAccountSetupWarningModal) {
  ...
  public UserWithStats noInstanceConfigWarningModal(Boolean noInstanceConfigWarningModal) {
  ...
  public UserWithStats noWelcomeModal(Boolean noWelcomeModal) {
  ...
  public UserWithStats nsfwPolicy(NSFWPolicy nsfwPolicy) {
  ...
  public UserWithStats p2pEnabled(Boolean p2pEnabled) {
  ...
  public UserWithStats pluginAuth(String pluginAuth) {
  ...
  public UserWithStats role(UserRole role) {
    this.role = role;
    return this;
  }
  ...
  public UserWithStats theme(String theme) {
    this.theme = theme;
    return this;
  }
  ...
  public UserWithStats username(String username) {
  ...
  public UserWithStats videoChannels(List<VideoChannel> videoChannels) {
    this.videoChannels = videoChannels;
    return this;
  }

  public UserWithStats addVideoChannelsItem(VideoChannel videoChannelsItem) {
  ...
  public UserWithStats videoQuota(Integer videoQuota) {
  ...
  public UserWithStats videoQuotaDaily(Integer videoQuotaDaily) {
  ...
  public UserWithStats abusesAcceptedCount(Integer abusesAcceptedCount) {
    this.abusesAcceptedCount = abusesAcceptedCount;
    return this;
  }

  /**
   * Count of reports/abuses created by the user and accepted/acted upon by the moderation team
   * @return abusesAcceptedCount
   */
  @javax.annotation.Nullable
  public Integer getAbusesAcceptedCount() {
    return abusesAcceptedCount;
  }

  public void setAbusesAcceptedCount(Integer abusesAcceptedCount) {
    this.abusesAcceptedCount = abusesAcceptedCount;
  }


  public UserWithStats abusesCount(Integer abusesCount) {
   ...
   */
  @javax.annotation.Nullable
  public Integer getAbusesCount() {
    return abusesCount;
  }

  public void setAbusesCount(Integer abusesCount) {
    this.abusesCount = abusesCount;
  }


  public UserWithStats abusesCreatedCount(Integer abusesCreatedCount) {
    this.abusesCreatedCount = abusesCreatedCount;
    return this;
  }

  /**
   * Count of reports/abuses created by the user
   * @return abusesCreatedCount
   */
  @javax.annotation.Nullable
  public Integer getAbusesCreatedCount() {
    return abusesCreatedCount;
  }

  public void setAbusesCreatedCount(Integer abusesCreatedCount) {
    this.abusesCreatedCount = abusesCreatedCount;
  }


  public UserWithStats videoCommentsCount(Integer videoCommentsCount) {
  ...
  public UserWithStats videosCount(Integer videosCount) {
  ...
  public boolean equals(Object o) {
    ...
    UserWithStats userWithStats = (UserWithStats) o;
    return Objects.equals(this.account, userWithStats.account) &&
        Objects.equals(this.autoPlayNextVideo, userWithStats.autoPlayNextVideo) &&
        Objects.equals(this.autoPlayNextVideoPlaylist, userWithStats.autoPlayNextVideoPlaylist) &&
        Objects.equals(this.autoPlayVideo, userWithStats.autoPlayVideo) &&
        Objects.equals(this.blocked, userWithStats.blocked) &&
        Objects.equals(this.blockedReason, userWithStats.blockedReason) &&
        Objects.equals(this.createdAt, userWithStats.createdAt) &&
        Objects.equals(this.email, userWithStats.email) &&
        Objects.equals(this.emailVerified, userWithStats.emailVerified) &&
        Objects.equals(this.id, userWithStats.id) &&
        Objects.equals(this.lastLoginDate, userWithStats.lastLoginDate) &&
        Objects.equals(this.noAccountSetupWarningModal, userWithStats.noAccountSetupWarningModal) &&
        Objects.equals(this.noInstanceConfigWarningModal, userWithStats.noInstanceConfigWarningModal) &&
        Objects.equals(this.noWelcomeModal, userWithStats.noWelcomeModal) &&
        Objects.equals(this.nsfwPolicy, userWithStats.nsfwPolicy) &&
        Objects.equals(this.p2pEnabled, userWithStats.p2pEnabled) &&
        Objects.equals(this.pluginAuth, userWithStats.pluginAuth) &&
        Objects.equals(this.role, userWithStats.role) &&
        Objects.equals(this.theme, userWithStats.theme) &&
        Objects.equals(this.username, userWithStats.username) &&
        Objects.equals(this.videoChannels, userWithStats.videoChannels) &&
        Objects.equals(this.videoQuota, userWithStats.videoQuota) &&
        Objects.equals(this.videoQuotaDaily, userWithStats.videoQuotaDaily) &&
        Objects.equals(this.abusesAcceptedCount, userWithStats.abusesAcceptedCount) &&
        Objects.equals(this.abusesCount, userWithStats.abusesCount) &&
        Objects.equals(this.abusesCreatedCount, userWithStats.abusesCreatedCount) &&
        Objects.equals(this.videoCommentsCount, userWithStats.videoCommentsCount) &&
        Objects.equals(this.videosCount, userWithStats.videosCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(account, autoPlayNextVideo, autoPlayNextVideoPlaylist, autoPlayVideo, blocked, blockedReason, createdAt, email, emailVerified, id, lastLoginDate, noAccountSetupWarningModal, noInstanceConfigWarningModal, noWelcomeModal, nsfwPolicy, p2pEnabled, pluginAuth, role, theme, username, videoChannels, videoQuota, videoQuotaDaily, abusesAcceptedCount, abusesCount, abusesCreatedCount, videoCommentsCount, videosCount);
  }
  ...
  public String toString() {
    ...
    sb.append("    abusesAcceptedCount: ").append(toIndentedString(abusesAcceptedCount)).append("\n");
    sb.append("    abusesCount: ").append(toIndentedString(abusesCount)).append("\n");
    sb.append("    abusesCreatedCount: ").append(toIndentedString(abusesCreatedCount)).append("\n");
    sb.append("    videoCommentsCount: ").append(toIndentedString(videoCommentsCount)).append("\n");
  ...
  static {
    ...
    openapiFields.add("abusesAcceptedCount");
    openapiFields.add("abusesCount");
    openapiFields.add("abusesCreatedCount");
    openapiFields.add("videoCommentsCount");
    openapiFields.add("videosCount");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserWithStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserWithStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserWithStats is not found in the empty JSON string", UserWithStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserWithStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserWithStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserWithStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserWithStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserWithStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserWithStats.class));

       return (TypeAdapter<T>) new TypeAdapter<UserWithStats>() {
           @Override
           public void write(JsonWriter out, UserWithStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserWithStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserWithStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserWithStats
   * @throws IOException if the JSON string is invalid with respect to UserWithStats
   */
  public static UserWithStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserWithStats.class);
  }

  /**
   * Convert an instance of UserWithStats to an JSON string
   *
   * @return JSON string
   */
