...
public class VideoUploadRequestCommon {
  ...
  public VideoUploadRequestCommon() {
  }

  public VideoUploadRequestCommon category(Integer category) {
  ...
  public VideoUploadRequestCommon channelId(Integer channelId) {
  ...
  public VideoUploadRequestCommon commentsEnabled(Boolean commentsEnabled) {
  ...
  public VideoUploadRequestCommon description(String description) {
  ...
  public VideoUploadRequestCommon downloadEnabled(Boolean downloadEnabled) {
  ...
  public VideoUploadRequestCommon language(String language) {
  ...
  public VideoUploadRequestCommon licence(Integer licence) {
  ...
  public VideoUploadRequestCommon name(String name) {
    this.name = name;
    return this;
  }
  ...
  public VideoUploadRequestCommon nsfw(Boolean nsfw) {
    this.nsfw = nsfw;
    return this;
  }
  ...
  public VideoUploadRequestCommon originallyPublishedAt(OffsetDateTime originallyPublishedAt) {
  ...
  public VideoUploadRequestCommon previewfile(File previewfile) {
  ...
  public VideoUploadRequestCommon privacy(VideoPrivacySet privacy) {
  ...
  public VideoUploadRequestCommon scheduleUpdate(VideoScheduledUpdate scheduleUpdate) {
  ...
  public VideoUploadRequestCommon support(String support) {
  ...
  public VideoUploadRequestCommon tags(Set<String> tags) {
    this.tags = tags;
    return this;
  }

  public VideoUploadRequestCommon addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public VideoUploadRequestCommon thumbnailfile(File thumbnailfile) {
  ...
  public VideoUploadRequestCommon waitTranscoding(Boolean waitTranscoding) {
  ...
  public boolean equals(Object o) {
    ...
    VideoUploadRequestCommon videoUploadRequestCommon = (VideoUploadRequestCommon) o;
    return Objects.equals(this.category, videoUploadRequestCommon.category) &&
        Objects.equals(this.channelId, videoUploadRequestCommon.channelId) &&
        Objects.equals(this.commentsEnabled, videoUploadRequestCommon.commentsEnabled) &&
        Objects.equals(this.description, videoUploadRequestCommon.description) &&
        Objects.equals(this.downloadEnabled, videoUploadRequestCommon.downloadEnabled) &&
        Objects.equals(this.language, videoUploadRequestCommon.language) &&
        Objects.equals(this.licence, videoUploadRequestCommon.licence) &&
        Objects.equals(this.name, videoUploadRequestCommon.name) &&
        Objects.equals(this.nsfw, videoUploadRequestCommon.nsfw) &&
        Objects.equals(this.originallyPublishedAt, videoUploadRequestCommon.originallyPublishedAt) &&
        Objects.equals(this.previewfile, videoUploadRequestCommon.previewfile) &&
        Objects.equals(this.privacy, videoUploadRequestCommon.privacy) &&
        Objects.equals(this.scheduleUpdate, videoUploadRequestCommon.scheduleUpdate) &&
        Objects.equals(this.support, videoUploadRequestCommon.support) &&
        Objects.equals(this.tags, videoUploadRequestCommon.tags) &&
        Objects.equals(this.thumbnailfile, videoUploadRequestCommon.thumbnailfile) &&
        Objects.equals(this.waitTranscoding, videoUploadRequestCommon.waitTranscoding);
  }

  @Override
  public int hashCode() {
    return Objects.hash(category, channelId, commentsEnabled, description, downloadEnabled, language, licence, name, nsfw, originallyPublishedAt, previewfile, privacy, scheduleUpdate, support, tags, thumbnailfile, waitTranscoding);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VideoUploadRequestCommon {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoUploadRequestCommon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoUploadRequestCommon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoUploadRequestCommon is not found in the empty JSON string", VideoUploadRequestCommon.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VideoUploadRequestCommon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoUploadRequestCommon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VideoUploadRequestCommon.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoUploadRequestCommon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoUploadRequestCommon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoUploadRequestCommon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoUploadRequestCommon.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoUploadRequestCommon>() {
           @Override
           public void write(JsonWriter out, VideoUploadRequestCommon value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VideoUploadRequestCommon read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VideoUploadRequestCommon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoUploadRequestCommon
   * @throws IOException if the JSON string is invalid with respect to VideoUploadRequestCommon
   */
  public static VideoUploadRequestCommon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoUploadRequestCommon.class);
  }

  /**
   * Convert an instance of VideoUploadRequestCommon to an JSON string
   *
   * @return JSON string
   */
