...
public class Actor {
  ...
  public Actor createdAt(OffsetDateTime createdAt) {
  ...
  public Actor followersCount(Integer followersCount) {
  ...
  public Actor followingCount(Integer followingCount) {
  ...
  public Actor hostRedundancyAllowed(Boolean hostRedundancyAllowed) {
  ...
  public Actor updatedAt(OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    Actor actor = (Actor) o;
    return Objects.equals(this.createdAt, actor.createdAt) &&
        Objects.equals(this.followersCount, actor.followersCount) &&
        Objects.equals(this.followingCount, actor.followingCount) &&
        Objects.equals(this.host, actor.host) &&
        Objects.equals(this.hostRedundancyAllowed, actor.hostRedundancyAllowed) &&
        Objects.equals(this.id, actor.id) &&
        Objects.equals(this.name, actor.name) &&
        Objects.equals(this.updatedAt, actor.updatedAt) &&
        Objects.equals(this.url, actor.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, followersCount, followingCount, host, hostRedundancyAllowed, id, name, updatedAt, url);
  }
