...
public class Account {
  ...
  public Account hostRedundancyAllowed(Boolean hostRedundancyAllowed) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, account.createdAt) &&
        ...
        Objects.equals(this.host, account.host) &&
        Objects.equals(this.hostRedundancyAllowed, account.hostRedundancyAllowed) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, followersCount, followingCount, host, hostRedundancyAllowed, id, name, updatedAt, url, description, displayName, userId);
  }
