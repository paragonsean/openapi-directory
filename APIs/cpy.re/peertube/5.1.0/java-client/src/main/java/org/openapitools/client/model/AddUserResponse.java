...
import org.openapitools.client.model.AddUserResponseUser;
...
public class AddUserResponse {
  ...
  private AddUserResponseUser user;

  public AddUserResponse() {
  }

  public AddUserResponse user(AddUserResponseUser user) {
    this.user = user;
    return this;
  }
  ...
  public AddUserResponseUser getUser() {
    return user;
  }

  public void setUser(AddUserResponseUser user) {
    this.user = user;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("user") != null && !jsonObj.get("user").isJsonNull()) {
        AddUserResponseUser.validateJsonElement(jsonObj.get("user"));
      }
  }
