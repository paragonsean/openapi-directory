...
public class VideoStreamingPlaylistsHLS {
  ...
  public VideoStreamingPlaylistsHLS() {
  }

  public VideoStreamingPlaylistsHLS files(List<VideoFile> files) {
    this.files = files;
    return this;
  }

  public VideoStreamingPlaylistsHLS addFilesItem(VideoFile filesItem) {
    if (this.files == null) {
  ...
  public VideoStreamingPlaylistsHLS playlistUrl(String playlistUrl) {
  ...
  public VideoStreamingPlaylistsHLS redundancies(List<VideoStreamingPlaylistsHLSRedundanciesInner> redundancies) {
    this.redundancies = redundancies;
    return this;
  }

  public VideoStreamingPlaylistsHLS addRedundanciesItem(VideoStreamingPlaylistsHLSRedundanciesInner redundanciesItem) {
  ...
  public VideoStreamingPlaylistsHLS segmentsSha256Url(String segmentsSha256Url) {
  ...
  public boolean equals(Object o) {
    ...
    VideoStreamingPlaylistsHLS videoStreamingPlaylistsHLS = (VideoStreamingPlaylistsHLS) o;
    return Objects.equals(this.files, videoStreamingPlaylistsHLS.files) &&
        Objects.equals(this.playlistUrl, videoStreamingPlaylistsHLS.playlistUrl) &&
        Objects.equals(this.redundancies, videoStreamingPlaylistsHLS.redundancies) &&
        Objects.equals(this.segmentsSha256Url, videoStreamingPlaylistsHLS.segmentsSha256Url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(files, playlistUrl, redundancies, segmentsSha256Url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VideoStreamingPlaylistsHLS {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoStreamingPlaylistsHLS
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoStreamingPlaylistsHLS.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoStreamingPlaylistsHLS is not found in the empty JSON string", VideoStreamingPlaylistsHLS.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VideoStreamingPlaylistsHLS.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoStreamingPlaylistsHLS` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoStreamingPlaylistsHLS.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoStreamingPlaylistsHLS' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoStreamingPlaylistsHLS> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoStreamingPlaylistsHLS.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoStreamingPlaylistsHLS>() {
           @Override
           public void write(JsonWriter out, VideoStreamingPlaylistsHLS value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VideoStreamingPlaylistsHLS read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VideoStreamingPlaylistsHLS given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoStreamingPlaylistsHLS
   * @throws IOException if the JSON string is invalid with respect to VideoStreamingPlaylistsHLS
   */
  public static VideoStreamingPlaylistsHLS fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoStreamingPlaylistsHLS.class);
  }

  /**
   * Convert an instance of VideoStreamingPlaylistsHLS to an JSON string
   *
   * @return JSON string
   */
