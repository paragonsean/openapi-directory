...
public class VideoChannel {
  ...
  public VideoChannel createdAt(OffsetDateTime createdAt) {
  ...
  public VideoChannel followersCount(Integer followersCount) {
  ...
  public VideoChannel followingCount(Integer followingCount) {
  ...
  public VideoChannel host(String host) {
    this.host = host;
    return this;
  }
  ...
  public VideoChannel hostRedundancyAllowed(Boolean hostRedundancyAllowed) {
  ...
  public VideoChannel id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public VideoChannel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public VideoChannel url(String url) {
    this.url = url;
    return this;
  }
  ...
  public VideoChannel banners(List<ActorImage> banners) {
    this.banners = banners;
    return this;
  }

  public VideoChannel addBannersItem(ActorImage bannersItem) {
  ...
  public VideoChannel description(String description) {
  ...
  public VideoChannel displayName(String displayName) {
  ...
  public VideoChannel ownerAccount(VideoChannelAllOfOwnerAccount ownerAccount) {
  ...
  public VideoChannel support(String support) {
  ...
  public boolean equals(Object o) {
    ...
    VideoChannel videoChannel = (VideoChannel) o;
    return Objects.equals(this.createdAt, videoChannel.createdAt) &&
        Objects.equals(this.followersCount, videoChannel.followersCount) &&
        Objects.equals(this.followingCount, videoChannel.followingCount) &&
        Objects.equals(this.host, videoChannel.host) &&
        Objects.equals(this.hostRedundancyAllowed, videoChannel.hostRedundancyAllowed) &&
        Objects.equals(this.id, videoChannel.id) &&
        Objects.equals(this.name, videoChannel.name) &&
        Objects.equals(this.updatedAt, videoChannel.updatedAt) &&
        Objects.equals(this.url, videoChannel.url) &&
        Objects.equals(this.banners, videoChannel.banners) &&
        Objects.equals(this.description, videoChannel.description) &&
        Objects.equals(this.displayName, videoChannel.displayName) &&
        Objects.equals(this.isLocal, videoChannel.isLocal) &&
        Objects.equals(this.ownerAccount, videoChannel.ownerAccount) &&
        Objects.equals(this.support, videoChannel.support);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VideoChannel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VideoChannel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoChannel is not found in the empty JSON string", VideoChannel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VideoChannel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoChannel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoChannel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoChannel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoChannel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoChannel.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoChannel>() {
           @Override
           public void write(JsonWriter out, VideoChannel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VideoChannel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VideoChannel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VideoChannel
   * @throws IOException if the JSON string is invalid with respect to VideoChannel
   */
  public static VideoChannel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoChannel.class);
  }

  /**
   * Convert an instance of VideoChannel to an JSON string
   *
   * @return JSON string
   */
