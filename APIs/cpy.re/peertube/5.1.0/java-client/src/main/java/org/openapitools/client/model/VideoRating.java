...
public class VideoRating {
  ...
  public VideoRating video(Video video) {
    this.video = video;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rating, videoRating.rating) &&
        Objects.equals(this.video, videoRating.video);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rating, video);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : VideoRating.openapiRequiredFields) {
