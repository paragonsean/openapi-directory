...
|**fps** | **BigDecimal** | Frames per second of the video file |  [optional] |
|**id** | **Integer** |  |  [optional] |
|**magnetUri** | **URI** | magnet URI allowing to resolve the video via BitTorrent without a metainfo file |  [optional] |
