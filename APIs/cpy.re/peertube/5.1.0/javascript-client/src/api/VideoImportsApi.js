...
/**
* VideoImports service.
* @module api/VideoImportsApi
* @version 5.1.0
*/
export default class VideoImportsApi {

    /**
    * Constructs a new VideoImportsApi. 
    * @alias module:api/VideoImportsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiV1VideosImportsIdCancelPost operation.
     * @callback module:api/VideoImportsApi~apiV1VideosImportsIdCancelPostCallback
     ...
     * @param {module:api/VideoImportsApi~apiV1VideosImportsIdCancelPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
    apiV1VideosImportsIdCancelPost(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling apiV1VideosImportsIdCancelPost");
      }
    ...
    /**
     * Callback function to receive the result of the apiV1VideosImportsIdDelete operation.
     * @callback module:api/VideoImportsApi~apiV1VideosImportsIdDeleteCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id Entity id
     * @param {module:api/VideoImportsApi~apiV1VideosImportsIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    apiV1VideosImportsIdDelete(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling apiV1VideosImportsIdDelete");
      }
    ...
    /**
     * Callback function to receive the result of the importVideo operation.
     * @callback module:api/VideoImportsApi~importVideoCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/VideoImportsApi~importVideoCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VideoUploadResponse}
     */
    importVideo(channelId, name, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'channelId' is set
      if (channelId === undefined || channelId === null) {
        throw new Error("Missing the required parameter 'channelId' when calling importVideo");
      }
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling importVideo");
      }
