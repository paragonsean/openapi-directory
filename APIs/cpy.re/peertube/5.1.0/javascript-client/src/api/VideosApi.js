...
export default class VideosApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addVideoPlaylistVideo operation.
     * @callback module:api/VideosApi~addVideoPlaylistVideoCallback
     ...
     * @param {module:api/VideosApi~addVideoPlaylistVideoCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AddVideoPlaylistVideo200Response}
     */
    addVideoPlaylistVideo(playlistId, opts, callback) {
      opts = opts || {};
      let postBody = opts['addVideoPlaylistVideoRequest'];
      // verify the required parameter 'playlistId' is set
      if (playlistId === undefined || playlistId === null) {
        throw new Error("Missing the required parameter 'playlistId' when calling addVideoPlaylistVideo");
      }
    ...
    /**
     * Callback function to receive the result of the apiV1UsersMeSubscriptionsVideosGet_0 operation.
     * @callback module:api/VideosApi~apiV1UsersMeSubscriptionsVideosGet_0Callback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/VideosApi~apiV1UsersMeSubscriptionsVideosGet_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VideoListResponse}
     */
    apiV1UsersMeSubscriptionsVideosGet_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the apiV1UsersMeVideosGet_0 operation.
     * @callback module:api/VideosApi~apiV1UsersMeVideosGet_0Callback
     * @param {String} error Error message, if any.
     * @param {module:model/VideoListResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/VideosApi~apiV1UsersMeVideosGet_0Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VideoListResponse}
     */
    apiV1UsersMeVideosGet_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the apiV1UsersMeVideosImportsGet operation.
     * @callback module:api/VideosApi~apiV1UsersMeVideosImportsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/VideosApi~apiV1UsersMeVideosImportsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VideoImportsList}
     */
    apiV1UsersMeVideosImportsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getVideoPlaylistVideos operation.
     * @callback module:api/VideosApi~getVideoPlaylistVideosCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VideoListResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [start] Offset used to paginate results
     * @param {Number} [count = 15)] Number of items to return
     * @param {module:api/VideosApi~getVideoPlaylistVideosCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VideoListResponse}
     */
    getVideoPlaylistVideos(playlistId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'playlistId' is set
      if (playlistId === undefined || playlistId === null) {
        throw new Error("Missing the required parameter 'playlistId' when calling getVideoPlaylistVideos");
      }
