...
class Plugin {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('peertubeEngine')) {
                obj['peertubeEngine'] = ApiClient.convertToType(data['peertubeEngine'], 'String');
            }
            ...
            if (data.hasOwnProperty('uninstalled')) {
                obj['uninstalled'] = ApiClient.convertToType(data['uninstalled'], 'Boolean');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['peertubeEngine'] && !(typeof data['peertubeEngine'] === 'string' || data['peertubeEngine'] instanceof String)) {
            throw new Error("Expected the field `peertubeEngine` to be a primitive type in the JSON string but got " + data['peertubeEngine']);
        }
        // ensure the json data is a string
 ...
 */
Plugin.prototype['createdAt'] = undefined;
 ...
 */
Plugin.prototype['homepage'] = undefined;

/**
 * @member {String} latestVersion
 */
Plugin.prototype['latestVersion'] = undefined;
...
/**
 * @member {String} peertubeEngine
 */
Plugin.prototype['peertubeEngine'] = undefined;
...
/**
 * - `1`: PLUGIN - `2`: THEME 
 * @member {module:model/Plugin.TypeEnum} type
 */
Plugin.prototype['type'] = undefined;

/**
 * @member {Boolean} uninstalled
 */
Plugin.prototype['uninstalled'] = undefined;

/**
 * @member {Date} updatedAt
 */
Plugin.prototype['updatedAt'] = undefined;
