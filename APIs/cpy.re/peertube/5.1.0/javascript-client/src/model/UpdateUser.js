...
class UpdateUser {
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUser</code>.
     */
 ...
 */
UpdateUser.prototype['adminFlags'] = undefined;

/**
 * The updated email of the user
 * @member {String} email
 */
UpdateUser.prototype['email'] = undefined;

/**
 * Set the email as verified
 * @member {Boolean} emailVerified
 */
UpdateUser.prototype['emailVerified'] = undefined;

/**
 * @member {String} password
 */
UpdateUser.prototype['password'] = undefined;

/**
 * The auth plugin to use to authenticate the user
 * @member {String} pluginAuth
 */
UpdateUser.prototype['pluginAuth'] = undefined;

/**
 * @member {module:model/UserRole} role
 */
UpdateUser.prototype['role'] = undefined;

/**
 * The updated video quota of the user in bytes
 * @member {Number} videoQuota
 */
UpdateUser.prototype['videoQuota'] = undefined;

/**
 * The updated daily video quota of the user in bytes
 * @member {Number} videoQuotaDaily
 */
UpdateUser.prototype['videoQuotaDaily'] = undefined;
