...
/**
 * The VideoStreamingPlaylistsHLS model module.
 * @module model/VideoStreamingPlaylistsHLS
 * @version 5.1.0
 */
class VideoStreamingPlaylistsHLS {
    /**
     * Constructs a new <code>VideoStreamingPlaylistsHLS</code>.
     * @alias module:model/VideoStreamingPlaylistsHLS
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>VideoStreamingPlaylistsHLS</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VideoStreamingPlaylistsHLS} obj Optional instance to populate.
     * @return {module:model/VideoStreamingPlaylistsHLS} The populated <code>VideoStreamingPlaylistsHLS</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VideoStreamingPlaylistsHLS();
    ...
    /**
     * Validates the JSON data with respect to <code>VideoStreamingPlaylistsHLS</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VideoStreamingPlaylistsHLS</code>.
     */
...
export default VideoStreamingPlaylistsHLS;
