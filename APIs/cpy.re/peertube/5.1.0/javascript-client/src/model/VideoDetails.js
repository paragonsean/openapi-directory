...
class VideoDetails {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('channel')) {
                obj['channel'] = VideoChannel.constructFromObject(data['channel']);
            }
            ...
            if (data.hasOwnProperty('descriptionPath')) {
                obj['descriptionPath'] = ApiClient.convertToType(data['descriptionPath'], 'String');
            }
            ...
            if (data.hasOwnProperty('streamingPlaylists')) {
                obj['streamingPlaylists'] = ApiClient.convertToType(data['streamingPlaylists'], [VideoStreamingPlaylists]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['channel']) { // data not null
          VideoChannel.validateJSON(data['channel']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['descriptionPath'] && !(typeof data['descriptionPath'] === 'string' || data['descriptionPath'] instanceof String)) {
            throw new Error("Expected the field `descriptionPath` to be a primitive type in the JSON string but got " + data['descriptionPath']);
        }
        ...
        if (data['streamingPlaylists']) { // data not null
            ...
            for (const item of data['streamingPlaylists']) {
                VideoStreamingPlaylists.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
VideoDetails.prototype['account'] = undefined;

/**
 * @member {Boolean} blacklisted
 */
VideoDetails.prototype['blacklisted'] = undefined;

/**
 * @member {String} blacklistedReason
 */
VideoDetails.prototype['blacklistedReason'] = undefined;

/**
 * category in which the video is classified
 * @member {module:model/VideoConstantNumberCategory} category
 */
VideoDetails.prototype['category'] = undefined;

/**
 * @member {module:model/VideoChannel} channel
 */
VideoDetails.prototype['channel'] = undefined;

/**
 * time at which the video object was first drafted
 * @member {Date} createdAt
 */
VideoDetails.prototype['createdAt'] = undefined;
 ...
 */
VideoDetails.prototype['description'] = undefined;

/**
 * @member {Number} dislikes
 */
VideoDetails.prototype['dislikes'] = undefined;

/**
 * duration of the video in seconds
 * @member {Number} duration
 */
VideoDetails.prototype['duration'] = undefined;

/**
 * @member {String} embedPath
 */
VideoDetails.prototype['embedPath'] = undefined;

/**
 * object id for the video
 * @member {Number} id
 */
VideoDetails.prototype['id'] = undefined;

/**
 * @member {Boolean} isLive
 */
VideoDetails.prototype['isLive'] = undefined;

/**
 * @member {Boolean} isLocal
 */
VideoDetails.prototype['isLocal'] = undefined;

/**
 * main language used in the video
 * @member {module:model/VideoConstantStringLanguage} language
 */
VideoDetails.prototype['language'] = undefined;

/**
 * licence under which the video is distributed
 * @member {module:model/VideoConstantNumberLicence} licence
 */
VideoDetails.prototype['licence'] = undefined;

/**
 * @member {Number} likes
 */
VideoDetails.prototype['likes'] = undefined;

/**
 * title of the video
 * @member {String} name
 */
VideoDetails.prototype['name'] = undefined;

/**
 * @member {Boolean} nsfw
 */
VideoDetails.prototype['nsfw'] = undefined;
 ...
 */
VideoDetails.prototype['originallyPublishedAt'] = undefined;

/**
 * @member {String} previewPath
 */
VideoDetails.prototype['previewPath'] = undefined;

/**
 * privacy policy used to distribute the video
 * @member {module:model/VideoPrivacyConstant} privacy
 */
VideoDetails.prototype['privacy'] = undefined;
 ...
 */
VideoDetails.prototype['state'] = undefined;

/**
 * @member {String} thumbnailPath
 */
VideoDetails.prototype['thumbnailPath'] = undefined;

/**
 * last time the video's metadata was modified
 * @member {Date} updatedAt
 */
VideoDetails.prototype['updatedAt'] = undefined;

/**
 * @member {module:model/VideoUserHistory} userHistory
 */
VideoDetails.prototype['userHistory'] = undefined;

/**
 * universal identifier for the video, that can be used across instances
 * @member {String} uuid
 */
VideoDetails.prototype['uuid'] = undefined;

/**
 * @member {Number} views
 */
VideoDetails.prototype['views'] = undefined;

/**
 * @member {Boolean} waitTranscoding
 */
VideoDetails.prototype['waitTranscoding'] = undefined;

/**
 * @member {Boolean} commentsEnabled
 */
VideoDetails.prototype['commentsEnabled'] = undefined;

/**
 * path at which to get the full description of maximum `10000` characters
 * @member {String} descriptionPath
 */
VideoDetails.prototype['descriptionPath'] = undefined;

/**
 * @member {Boolean} downloadEnabled
 */
VideoDetails.prototype['downloadEnabled'] = undefined;
 ...
 */
VideoDetails.prototype['files'] = undefined;
 ...
 * @member {Array.<module:model/VideoStreamingPlaylists>} streamingPlaylists
 */
VideoDetails.prototype['streamingPlaylists'] = undefined;

/**
 * A text tell the audience how to support the video creator
 * @member {String} support
 */
VideoDetails.prototype['support'] = undefined;

/**
 * @member {Array.<String>} tags
 */
VideoDetails.prototype['tags'] = undefined;

/**
 * @member {Array.<String>} trackerUrls
 */
VideoDetails.prototype['trackerUrls'] = undefined;

/**
 * If the video is a live, you have the amount of current viewers
 * @member {Number} viewers
 */
VideoDetails.prototype['viewers'] = undefined;
