...
/**
 * The VideoChannel model module.
 * @module model/VideoChannel
 * @version 5.1.0
 */
class VideoChannel {
    /**
     * Constructs a new <code>VideoChannel</code>.
     * @alias module:model/VideoChannel
     * @implements module:model/Actor
     */
    constructor() { 
        Actor.initialize(this);
        VideoChannel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VideoChannel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VideoChannel} obj Optional instance to populate.
     * @return {module:model/VideoChannel} The populated <code>VideoChannel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VideoChannel();
    ...
    /**
     * Validates the JSON data with respect to <code>VideoChannel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VideoChannel</code>.
     */
