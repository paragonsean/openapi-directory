...
import UserAdminFlags from './UserAdminFlags';
...
class AddUser {
     ...
     * @param username {String} immutable name of the user, used to find or mention its actor
     */
    constructor(email, password, role, username) { 
        
        AddUser.initialize(this, email, password, role, username);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('adminFlags')) {
                obj['adminFlags'] = UserAdminFlags.constructFromObject(data['adminFlags']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of AddUser.RequiredProperties) {
...
AddUser.RequiredProperties = ["email", "password", "role", "username"];

/**
 * @member {module:model/UserAdminFlags} adminFlags
 */
AddUser.prototype['adminFlags'] = undefined;

/**
 * immutable name of the channel, used to interact with its actor
 * @member {String} channelName
 */
AddUser.prototype['channelName'] = undefined;

/**
 * The user email
 * @member {String} email
 */
AddUser.prototype['email'] = undefined;

/**
 * @member {String} password
 */
AddUser.prototype['password'] = undefined;

/**
 * @member {module:model/UserRole} role
 */
AddUser.prototype['role'] = undefined;

/**
 * immutable name of the user, used to find or mention its actor
 * @member {String} username
 */
AddUser.prototype['username'] = undefined;

/**
 * The user video quota in bytes
 * @member {Number} videoQuota
 */
AddUser.prototype['videoQuota'] = undefined;

/**
 * The user daily video quota in bytes
 * @member {Number} videoQuotaDaily
 */
AddUser.prototype['videoQuotaDaily'] = undefined;
