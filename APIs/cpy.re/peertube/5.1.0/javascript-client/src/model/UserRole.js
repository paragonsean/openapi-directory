    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('id')) {
                obj['id'] = UserRole.constructFromObject(data['id']);
            }
...
/**
 * @member {module:model/UserRole} id
 */
UserRole.prototype['id'] = undefined;

/**
 * @member {module:model/UserRole.LabelEnum} label
 */
UserRole.prototype['label'] = undefined;
