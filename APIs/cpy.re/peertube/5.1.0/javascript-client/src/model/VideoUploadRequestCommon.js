...
/**
 * The VideoUploadRequestCommon model module.
 * @module model/VideoUploadRequestCommon
 * @version 5.1.0
 */
class VideoUploadRequestCommon {
    /**
     * Constructs a new <code>VideoUploadRequestCommon</code>.
     * @alias module:model/VideoUploadRequestCommon
     ...
     */
    static initialize(obj, channelId, name) { 
        obj['channelId'] = channelId;
        obj['name'] = name;
    }

    /**
     * Constructs a <code>VideoUploadRequestCommon</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VideoUploadRequestCommon} obj Optional instance to populate.
     * @return {module:model/VideoUploadRequestCommon} The populated <code>VideoUploadRequestCommon</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VideoUploadRequestCommon();
    ...
    /**
     * Validates the JSON data with respect to <code>VideoUploadRequestCommon</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VideoUploadRequestCommon</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VideoUploadRequestCommon.RequiredProperties) {
...
VideoUploadRequestCommon.RequiredProperties = ["channelId", "name"];
...
export default VideoUploadRequestCommon;
