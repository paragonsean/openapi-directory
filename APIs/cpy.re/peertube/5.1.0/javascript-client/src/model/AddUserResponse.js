...
import AddUserResponseUser from './AddUserResponseUser';
...
class AddUserResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('user')) {
                obj['user'] = AddUserResponseUser.constructFromObject(data['user']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['user']) { // data not null
          AddUserResponseUser.validateJSON(data['user']);
        }
...
/**
 * @member {module:model/AddUserResponseUser} user
 */
AddUserResponse.prototype['user'] = undefined;
