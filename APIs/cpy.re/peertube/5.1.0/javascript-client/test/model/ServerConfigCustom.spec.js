...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PeerTube.ServerConfigCustom();
  });
  ...
  describe('ServerConfigCustom', function() {
    it('should create an instance of ServerConfigCustom', function() {
      // uncomment below and update the code to test ServerConfigCustom
      //var instance = new PeerTube.ServerConfigCustom();
      //expect(instance).to.be.a(PeerTube.ServerConfigCustom);
    });
