...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PeerTube.MRSSGroupContent();
  });
  ...
  describe('MRSSGroupContent', function() {
    it('should create an instance of MRSSGroupContent', function() {
      // uncomment below and update the code to test MRSSGroupContent
      //var instance = new PeerTube.MRSSGroupContent();
      //expect(instance).to.be.a(PeerTube.MRSSGroupContent);
    });
