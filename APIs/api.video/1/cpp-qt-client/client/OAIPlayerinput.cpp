...
OAIPlayerinput::OAIPlayerinput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlayerinput::OAIPlayerinput() {
    this->initializeModel();
}

OAIPlayerinput::~OAIPlayerinput() {}

void OAIPlayerinput::initializeModel() {
...
void OAIPlayerinput::fromJson(QString jsonString) {
...
void OAIPlayerinput::fromJsonObject(QJsonObject json) {
...
QString OAIPlayerinput::asJson() const {
...
QJsonObject OAIPlayerinput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPlayerinput::getBackgroundBottom() const {
    return m_background_bottom;
}
void OAIPlayerinput::setBackgroundBottom(const QString &background_bottom) {
    m_background_bottom = background_bottom;
    m_background_bottom_isSet = true;
}

bool OAIPlayerinput::is_background_bottom_Set() const{
    return m_background_bottom_isSet;
}

bool OAIPlayerinput::is_background_bottom_Valid() const{
    return m_background_bottom_isValid;
}

QString OAIPlayerinput::getBackgroundText() const {
    return m_background_text;
}
void OAIPlayerinput::setBackgroundText(const QString &background_text) {
    m_background_text = background_text;
    m_background_text_isSet = true;
}

bool OAIPlayerinput::is_background_text_Set() const{
    return m_background_text_isSet;
}

bool OAIPlayerinput::is_background_text_Valid() const{
    return m_background_text_isValid;
}

QString OAIPlayerinput::getBackgroundTop() const {
    return m_background_top;
}
void OAIPlayerinput::setBackgroundTop(const QString &background_top) {
    m_background_top = background_top;
    m_background_top_isSet = true;
}

bool OAIPlayerinput::is_background_top_Set() const{
    return m_background_top_isSet;
}

bool OAIPlayerinput::is_background_top_Valid() const{
    return m_background_top_isValid;
}

bool OAIPlayerinput::isEnableApi() const {
    return m_enable_api;
}
void OAIPlayerinput::setEnableApi(const bool &enable_api) {
    m_enable_api = enable_api;
    m_enable_api_isSet = true;
}

bool OAIPlayerinput::is_enable_api_Set() const{
    return m_enable_api_isSet;
}

bool OAIPlayerinput::is_enable_api_Valid() const{
    return m_enable_api_isValid;
}

bool OAIPlayerinput::isEnableControls() const {
    return m_enable_controls;
}
void OAIPlayerinput::setEnableControls(const bool &enable_controls) {
    m_enable_controls = enable_controls;
    m_enable_controls_isSet = true;
}

bool OAIPlayerinput::is_enable_controls_Set() const{
    return m_enable_controls_isSet;
}

bool OAIPlayerinput::is_enable_controls_Valid() const{
    return m_enable_controls_isValid;
}

bool OAIPlayerinput::isForceAutoplay() const {
    return m_force_autoplay;
}
void OAIPlayerinput::setForceAutoplay(const bool &force_autoplay) {
    m_force_autoplay = force_autoplay;
    m_force_autoplay_isSet = true;
}

bool OAIPlayerinput::is_force_autoplay_Set() const{
    return m_force_autoplay_isSet;
}

bool OAIPlayerinput::is_force_autoplay_Valid() const{
    return m_force_autoplay_isValid;
}

bool OAIPlayerinput::isForceLoop() const {
    return m_force_loop;
}
void OAIPlayerinput::setForceLoop(const bool &force_loop) {
    m_force_loop = force_loop;
    m_force_loop_isSet = true;
}

bool OAIPlayerinput::is_force_loop_Set() const{
    return m_force_loop_isSet;
}

bool OAIPlayerinput::is_force_loop_Valid() const{
    return m_force_loop_isValid;
}

bool OAIPlayerinput::isHideTitle() const {
    return m_hide_title;
}
void OAIPlayerinput::setHideTitle(const bool &hide_title) {
    m_hide_title = hide_title;
    m_hide_title_isSet = true;
}

bool OAIPlayerinput::is_hide_title_Set() const{
    return m_hide_title_isSet;
}

bool OAIPlayerinput::is_hide_title_Valid() const{
    return m_hide_title_isValid;
}

QString OAIPlayerinput::getLink() const {
    return m_link;
}
void OAIPlayerinput::setLink(const QString &link) {
    m_link = link;
    m_link_isSet = true;
}

bool OAIPlayerinput::is_link_Set() const{
    return m_link_isSet;
}

bool OAIPlayerinput::is_link_Valid() const{
    return m_link_isValid;
}

QString OAIPlayerinput::getLinkHover() const {
    return m_link_hover;
}
void OAIPlayerinput::setLinkHover(const QString &link_hover) {
    m_link_hover = link_hover;
    m_link_hover_isSet = true;
}

bool OAIPlayerinput::is_link_hover_Set() const{
    return m_link_hover_isSet;
}

bool OAIPlayerinput::is_link_hover_Valid() const{
    return m_link_hover_isValid;
}

QString OAIPlayerinput::getText() const {
    return m_text;
}
void OAIPlayerinput::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIPlayerinput::is_text_Set() const{
    return m_text_isSet;
}

bool OAIPlayerinput::is_text_Valid() const{
    return m_text_isValid;
}

QString OAIPlayerinput::getTrackBackground() const {
    return m_track_background;
}
void OAIPlayerinput::setTrackBackground(const QString &track_background) {
    m_track_background = track_background;
    m_track_background_isSet = true;
}

bool OAIPlayerinput::is_track_background_Set() const{
    return m_track_background_isSet;
}

bool OAIPlayerinput::is_track_background_Valid() const{
    return m_track_background_isValid;
}

QString OAIPlayerinput::getTrackPlayed() const {
    return m_track_played;
}
void OAIPlayerinput::setTrackPlayed(const QString &track_played) {
    m_track_played = track_played;
    m_track_played_isSet = true;
}

bool OAIPlayerinput::is_track_played_Set() const{
    return m_track_played_isSet;
}

bool OAIPlayerinput::is_track_played_Valid() const{
    return m_track_played_isValid;
}

QString OAIPlayerinput::getTrackUnplayed() const {
    return m_track_unplayed;
}
void OAIPlayerinput::setTrackUnplayed(const QString &track_unplayed) {
    m_track_unplayed = track_unplayed;
    m_track_unplayed_isSet = true;
}

bool OAIPlayerinput::is_track_unplayed_Set() const{
    return m_track_unplayed_isSet;
}

bool OAIPlayerinput::is_track_unplayed_Valid() const{
    return m_track_unplayed_isValid;
}

bool OAIPlayerinput::isSet() const {
...
bool OAIPlayerinput::isValid() const {
