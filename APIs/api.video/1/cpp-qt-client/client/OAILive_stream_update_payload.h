...
/*
 * OAILive_stream_update_payload.h
 *
 * 
 */

#ifndef OAILive_stream_update_payload_H
#define OAILive_stream_update_payload_H
...
class OAILive_stream_update_payload : public OAIObject {
public:
    OAILive_stream_update_payload();
    OAILive_stream_update_payload(QString json);
    ~OAILive_stream_update_payload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILive_stream_update_payload)

#endif // OAILive_stream_update_payload_H
