...
/*
 * OAIPlayerCreationPayload.h
 *
 * 
 */

#ifndef OAIPlayerCreationPayload_H
#define OAIPlayerCreationPayload_H
...
class OAIPlayerCreationPayload : public OAIObject {
public:
    OAIPlayerCreationPayload();
    OAIPlayerCreationPayload(QString json);
    ~OAIPlayerCreationPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlayerCreationPayload)

#endif // OAIPlayerCreationPayload_H
