...
/*
 * OAIVideo_update_payload.h
 *
 * 
 */

#ifndef OAIVideo_update_payload_H
#define OAIVideo_update_payload_H
...
class OAIVideo_update_payload : public OAIObject {
public:
    OAIVideo_update_payload();
    OAIVideo_update_payload(QString json);
    ~OAIVideo_update_payload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideo_update_payload)

#endif // OAIVideo_update_payload_H
