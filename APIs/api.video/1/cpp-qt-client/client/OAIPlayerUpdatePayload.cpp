...
OAIPlayerUpdatePayload::OAIPlayerUpdatePayload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPlayerUpdatePayload::OAIPlayerUpdatePayload() {
    this->initializeModel();
}

OAIPlayerUpdatePayload::~OAIPlayerUpdatePayload() {}

void OAIPlayerUpdatePayload::initializeModel() {
...
void OAIPlayerUpdatePayload::fromJson(QString jsonString) {
...
void OAIPlayerUpdatePayload::fromJsonObject(QJsonObject json) {
...
QString OAIPlayerUpdatePayload::asJson() const {
...
QJsonObject OAIPlayerUpdatePayload::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPlayerUpdatePayload::getBackgroundBottom() const {
    return m_background_bottom;
}
void OAIPlayerUpdatePayload::setBackgroundBottom(const QString &background_bottom) {
    m_background_bottom = background_bottom;
    m_background_bottom_isSet = true;
}

bool OAIPlayerUpdatePayload::is_background_bottom_Set() const{
    return m_background_bottom_isSet;
}

bool OAIPlayerUpdatePayload::is_background_bottom_Valid() const{
    return m_background_bottom_isValid;
}

QString OAIPlayerUpdatePayload::getBackgroundText() const {
    return m_background_text;
}
void OAIPlayerUpdatePayload::setBackgroundText(const QString &background_text) {
    m_background_text = background_text;
    m_background_text_isSet = true;
}

bool OAIPlayerUpdatePayload::is_background_text_Set() const{
    return m_background_text_isSet;
}

bool OAIPlayerUpdatePayload::is_background_text_Valid() const{
    return m_background_text_isValid;
}

QString OAIPlayerUpdatePayload::getBackgroundTop() const {
    return m_background_top;
}
void OAIPlayerUpdatePayload::setBackgroundTop(const QString &background_top) {
    m_background_top = background_top;
    m_background_top_isSet = true;
}

bool OAIPlayerUpdatePayload::is_background_top_Set() const{
    return m_background_top_isSet;
}

bool OAIPlayerUpdatePayload::is_background_top_Valid() const{
    return m_background_top_isValid;
}

bool OAIPlayerUpdatePayload::isEnableApi() const {
    return m_enable_api;
}
void OAIPlayerUpdatePayload::setEnableApi(const bool &enable_api) {
    m_enable_api = enable_api;
    m_enable_api_isSet = true;
}

bool OAIPlayerUpdatePayload::is_enable_api_Set() const{
    return m_enable_api_isSet;
}

bool OAIPlayerUpdatePayload::is_enable_api_Valid() const{
    return m_enable_api_isValid;
}

bool OAIPlayerUpdatePayload::isEnableControls() const {
    return m_enable_controls;
}
void OAIPlayerUpdatePayload::setEnableControls(const bool &enable_controls) {
    m_enable_controls = enable_controls;
    m_enable_controls_isSet = true;
}

bool OAIPlayerUpdatePayload::is_enable_controls_Set() const{
    return m_enable_controls_isSet;
}

bool OAIPlayerUpdatePayload::is_enable_controls_Valid() const{
    return m_enable_controls_isValid;
}

bool OAIPlayerUpdatePayload::isForceAutoplay() const {
    return m_force_autoplay;
}
void OAIPlayerUpdatePayload::setForceAutoplay(const bool &force_autoplay) {
    m_force_autoplay = force_autoplay;
    m_force_autoplay_isSet = true;
}

bool OAIPlayerUpdatePayload::is_force_autoplay_Set() const{
    return m_force_autoplay_isSet;
}

bool OAIPlayerUpdatePayload::is_force_autoplay_Valid() const{
    return m_force_autoplay_isValid;
}

bool OAIPlayerUpdatePayload::isForceLoop() const {
    return m_force_loop;
}
void OAIPlayerUpdatePayload::setForceLoop(const bool &force_loop) {
    m_force_loop = force_loop;
    m_force_loop_isSet = true;
}

bool OAIPlayerUpdatePayload::is_force_loop_Set() const{
    return m_force_loop_isSet;
}

bool OAIPlayerUpdatePayload::is_force_loop_Valid() const{
    return m_force_loop_isValid;
}

bool OAIPlayerUpdatePayload::isHideTitle() const {
    return m_hide_title;
}
void OAIPlayerUpdatePayload::setHideTitle(const bool &hide_title) {
    m_hide_title = hide_title;
    m_hide_title_isSet = true;
}

bool OAIPlayerUpdatePayload::is_hide_title_Set() const{
    return m_hide_title_isSet;
}

bool OAIPlayerUpdatePayload::is_hide_title_Valid() const{
    return m_hide_title_isValid;
}

QString OAIPlayerUpdatePayload::getLink() const {
    return m_link;
}
void OAIPlayerUpdatePayload::setLink(const QString &link) {
    m_link = link;
    m_link_isSet = true;
}

bool OAIPlayerUpdatePayload::is_link_Set() const{
    return m_link_isSet;
}

bool OAIPlayerUpdatePayload::is_link_Valid() const{
    return m_link_isValid;
}

QString OAIPlayerUpdatePayload::getLinkHover() const {
    return m_link_hover;
}
void OAIPlayerUpdatePayload::setLinkHover(const QString &link_hover) {
    m_link_hover = link_hover;
    m_link_hover_isSet = true;
}

bool OAIPlayerUpdatePayload::is_link_hover_Set() const{
    return m_link_hover_isSet;
}

bool OAIPlayerUpdatePayload::is_link_hover_Valid() const{
    return m_link_hover_isValid;
}

QString OAIPlayerUpdatePayload::getText() const {
    return m_text;
}
void OAIPlayerUpdatePayload::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIPlayerUpdatePayload::is_text_Set() const{
    return m_text_isSet;
}

bool OAIPlayerUpdatePayload::is_text_Valid() const{
    return m_text_isValid;
}

QString OAIPlayerUpdatePayload::getTrackBackground() const {
    return m_track_background;
}
void OAIPlayerUpdatePayload::setTrackBackground(const QString &track_background) {
    m_track_background = track_background;
    m_track_background_isSet = true;
}

bool OAIPlayerUpdatePayload::is_track_background_Set() const{
    return m_track_background_isSet;
}

bool OAIPlayerUpdatePayload::is_track_background_Valid() const{
    return m_track_background_isValid;
}

QString OAIPlayerUpdatePayload::getTrackPlayed() const {
    return m_track_played;
}
void OAIPlayerUpdatePayload::setTrackPlayed(const QString &track_played) {
    m_track_played = track_played;
    m_track_played_isSet = true;
}

bool OAIPlayerUpdatePayload::is_track_played_Set() const{
    return m_track_played_isSet;
}

bool OAIPlayerUpdatePayload::is_track_played_Valid() const{
    return m_track_played_isValid;
}

QString OAIPlayerUpdatePayload::getTrackUnplayed() const {
    return m_track_unplayed;
}
void OAIPlayerUpdatePayload::setTrackUnplayed(const QString &track_unplayed) {
    m_track_unplayed = track_unplayed;
    m_track_unplayed_isSet = true;
}

bool OAIPlayerUpdatePayload::is_track_unplayed_Set() const{
    return m_track_unplayed_isSet;
}

bool OAIPlayerUpdatePayload::is_track_unplayed_Valid() const{
    return m_track_unplayed_isValid;
}

bool OAIPlayerUpdatePayload::isSet() const {
...
bool OAIPlayerUpdatePayload::isValid() const {
