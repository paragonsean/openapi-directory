...
/*
 * OAIVideo_session_referrer.h
 *
 * 
 */

#ifndef OAIVideo_session_referrer_H
#define OAIVideo_session_referrer_H
...
class OAIVideo_session_referrer : public OAIObject {
public:
    OAIVideo_session_referrer();
    OAIVideo_session_referrer(QString json);
    ~OAIVideo_session_referrer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideo_session_referrer)

#endif // OAIVideo_session_referrer_H
