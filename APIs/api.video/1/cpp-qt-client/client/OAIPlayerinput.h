...
#ifndef OAIPlayerinput_H
#define OAIPlayerinput_H
...
class OAIPlayerinput : public OAIObject {
public:
    OAIPlayerinput();
    OAIPlayerinput(QString json);
    ~OAIPlayerinput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlayerinput)

#endif // OAIPlayerinput_H
