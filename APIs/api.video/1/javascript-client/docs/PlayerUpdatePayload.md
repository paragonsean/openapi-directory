...
**enableApi** | **Boolean** | enable/disable player SDK access. Default: true | [optional] [default to true]
**enableControls** | **Boolean** | enable/disable player controls. Default: true | [optional] [default to true]
**forceAutoplay** | **Boolean** | enable/disable player autoplay. Default: false | [optional] [default to false]
**forceLoop** | **Boolean** | enable/disable looping. Default: false | [optional] [default to false]
**hideTitle** | **Boolean** | enable/disable title. Default: false | [optional] [default to false]
