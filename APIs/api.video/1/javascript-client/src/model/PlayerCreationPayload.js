...
/**
 * The PlayerCreationPayload model module.
 * @module model/PlayerCreationPayload
 * @version 1
 */
class PlayerCreationPayload {
    /**
     * Constructs a new <code>PlayerCreationPayload</code>.
     * @alias module:model/PlayerCreationPayload
     * @implements module:model/Playerinput
     */
    constructor() { 
        Playerinput.initialize(this);
        PlayerCreationPayload.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PlayerCreationPayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlayerCreationPayload} obj Optional instance to populate.
     * @return {module:model/PlayerCreationPayload} The populated <code>PlayerCreationPayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlayerCreationPayload();
    ...
    /**
     * Validates the JSON data with respect to <code>PlayerCreationPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlayerCreationPayload</code>.
     */
 ...
 */
PlayerCreationPayload.prototype['backgroundBottom'] = undefined;

/**
 * RGBA color for title text. Default: rgba(255, 255, 255, 1)
 * @member {String} backgroundText
 */
PlayerCreationPayload.prototype['backgroundText'] = undefined;

/**
 * RGBA color: top 50% of background. Default: rgba(0, 0, 0, .7)
 * @member {String} backgroundTop
 */
PlayerCreationPayload.prototype['backgroundTop'] = undefined;
 ...
 * @default true
 */
PlayerCreationPayload.prototype['enableApi'] = true;
 ...
 * @default true
 */
PlayerCreationPayload.prototype['enableControls'] = true;
 ...
 * @default false
 */
PlayerCreationPayload.prototype['forceAutoplay'] = false;
 ...
 * @default false
 */
PlayerCreationPayload.prototype['forceLoop'] = false;
 ...
 * @default false
 */
PlayerCreationPayload.prototype['hideTitle'] = false;

/**
 * RGBA color for all controls. Default: rgba(255, 255, 255, 1)
 * @member {String} link
 */
PlayerCreationPayload.prototype['link'] = undefined;

/**
 * RGBA color for all controls when hovered. Default: rgba(255, 255, 255, 1)
 * @member {String} linkHover
 */
PlayerCreationPayload.prototype['linkHover'] = undefined;

/**
 * RGBA color for timer text. Default: rgba(255, 255, 255, 1)
 * @member {String} text
 */
PlayerCreationPayload.prototype['text'] = undefined;

/**
 * RGBA color playback bar: background. Default: rgba(255, 255, 255, .2)
 * @member {String} trackBackground
 */
PlayerCreationPayload.prototype['trackBackground'] = undefined;

/**
 * RGBA color playback bar: played content. Default: rgba(88, 131, 255, .95)
 * @member {String} trackPlayed
 */
PlayerCreationPayload.prototype['trackPlayed'] = undefined;

/**
 * RGBA color playback bar: downloaded but unplayed (buffered) content. Default: rgba(255, 255, 255, .35)
 * @member {String} trackUnplayed
 */
PlayerCreationPayload.prototype['trackUnplayed'] = undefined;
...
export default PlayerCreationPayload;
