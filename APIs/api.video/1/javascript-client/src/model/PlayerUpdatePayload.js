...
/**
 * The PlayerUpdatePayload model module.
 * @module model/PlayerUpdatePayload
 * @version 1
 */
class PlayerUpdatePayload {
    /**
     * Constructs a new <code>PlayerUpdatePayload</code>.
     * @alias module:model/PlayerUpdatePayload
     * @implements module:model/Playerinput
     */
    constructor() { 
        Playerinput.initialize(this);
        PlayerUpdatePayload.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PlayerUpdatePayload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PlayerUpdatePayload} obj Optional instance to populate.
     * @return {module:model/PlayerUpdatePayload} The populated <code>PlayerUpdatePayload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlayerUpdatePayload();
            Playerinput.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PlayerUpdatePayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlayerUpdatePayload</code>.
     */
 ...
 */
PlayerUpdatePayload.prototype['backgroundBottom'] = undefined;

/**
 * RGBA color for title text. Default: rgba(255, 255, 255, 1)
 * @member {String} backgroundText
 */
PlayerUpdatePayload.prototype['backgroundText'] = undefined;

/**
 * RGBA color: top 50% of background. Default: rgba(0, 0, 0, .7)
 * @member {String} backgroundTop
 */
PlayerUpdatePayload.prototype['backgroundTop'] = undefined;
 ...
 * @default true
 */
PlayerUpdatePayload.prototype['enableApi'] = true;
 ...
 * @default true
 */
PlayerUpdatePayload.prototype['enableControls'] = true;
 ...
 * @default false
 */
PlayerUpdatePayload.prototype['forceAutoplay'] = false;
 ...
 * @default false
 */
PlayerUpdatePayload.prototype['forceLoop'] = false;
 ...
 * @default false
 */
PlayerUpdatePayload.prototype['hideTitle'] = false;

/**
 * RGBA color for all controls. Default: rgba(255, 255, 255, 1)
 * @member {String} link
 */
PlayerUpdatePayload.prototype['link'] = undefined;

/**
 * RGBA color for all controls when hovered. Default: rgba(255, 255, 255, 1)
 * @member {String} linkHover
 */
PlayerUpdatePayload.prototype['linkHover'] = undefined;

/**
 * RGBA color for timer text. Default: rgba(255, 255, 255, 1)
 * @member {String} text
 */
PlayerUpdatePayload.prototype['text'] = undefined;

/**
 * RGBA color playback bar: background. Default: rgba(255, 255, 255, .2)
 * @member {String} trackBackground
 */
PlayerUpdatePayload.prototype['trackBackground'] = undefined;

/**
 * RGBA color playback bar: played content. Default: rgba(88, 131, 255, .95)
 * @member {String} trackPlayed
 */
PlayerUpdatePayload.prototype['trackPlayed'] = undefined;

/**
 * RGBA color playback bar: downloaded but unplayed (buffered) content. Default: rgba(255, 255, 255, .35)
 * @member {String} trackUnplayed
 */
PlayerUpdatePayload.prototype['trackUnplayed'] = undefined;


// Implement Playerinput interface:
/**
 * RGBA color: bottom 50% of background. Default: rgba(0, 0, 0, .7)
 * @member {String} backgroundBottom
 */
...
export default PlayerUpdatePayload;
