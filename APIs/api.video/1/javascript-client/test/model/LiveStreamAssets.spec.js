...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiVideo.LiveStreamAssets();
  });
  ...
  describe('LiveStreamAssets', function() {
    it('should create an instance of LiveStreamAssets', function() {
      // uncomment below and update the code to test LiveStreamAssets
      //var instance = new ApiVideo.LiveStreamAssets();
      //expect(instance).to.be.a(ApiVideo.LiveStreamAssets);
    });
