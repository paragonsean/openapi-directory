...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiVideo.VideoSession();
  });
  ...
  describe('VideoSession', function() {
    it('should create an instance of VideoSession', function() {
      // uncomment below and update the code to test VideoSession
      //var instance = new ApiVideo.VideoSession();
      //expect(instance).to.be.a(ApiVideo.VideoSession);
    });
