...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiVideo.Playerinput();
  });
  ...
  describe('Playerinput', function() {
    it('should create an instance of Playerinput', function() {
      // uncomment below and update the code to test Playerinput
      //var instance = new ApiVideo.Playerinput();
      //expect(instance).to.be.a(ApiVideo.Playerinput);
    });
