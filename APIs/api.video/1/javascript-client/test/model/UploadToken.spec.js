...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiVideo.UploadToken();
  });
  ...
  describe('UploadToken', function() {
    it('should create an instance of UploadToken', function() {
      // uncomment below and update the code to test UploadToken
      //var instance = new ApiVideo.UploadToken();
      //expect(instance).to.be.a(ApiVideo.UploadToken);
    });
