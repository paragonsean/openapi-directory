...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiVideo.LiveStreamCreatePayload();
  });
  ...
  describe('LiveStreamCreatePayload', function() {
    it('should create an instance of LiveStreamCreatePayload', function() {
      // uncomment below and update the code to test LiveStreamCreatePayload
      //var instance = new ApiVideo.LiveStreamCreatePayload();
      //expect(instance).to.be.a(ApiVideo.LiveStreamCreatePayload);
    });
