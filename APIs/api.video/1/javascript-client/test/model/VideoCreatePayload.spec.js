...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiVideo.VideoCreatePayload();
  });
  ...
  describe('VideoCreatePayload', function() {
    it('should create an instance of VideoCreatePayload', function() {
      // uncomment below and update the code to test VideoCreatePayload
      //var instance = new ApiVideo.VideoCreatePayload();
      //expect(instance).to.be.a(ApiVideo.VideoCreatePayload);
    });
