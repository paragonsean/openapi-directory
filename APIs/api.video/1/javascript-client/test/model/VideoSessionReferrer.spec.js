...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiVideo.VideoSessionReferrer();
  });
  ...
  describe('VideoSessionReferrer', function() {
    it('should create an instance of VideoSessionReferrer', function() {
      // uncomment below and update the code to test VideoSessionReferrer
      //var instance = new ApiVideo.VideoSessionReferrer();
      //expect(instance).to.be.a(ApiVideo.VideoSessionReferrer);
    });
