...
public class SubscriptionResponseModel {
  ...
  public SubscriptionResponseModel availableModels(List<TTSModelResponseModel> availableModels) {
    this.availableModels = availableModels;
    return this;
  }

  public SubscriptionResponseModel addAvailableModelsItem(TTSModelResponseModel availableModelsItem) {
  ...
  public SubscriptionResponseModel canUseDelayedPaymentMethods(Boolean canUseDelayedPaymentMethods) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowedToExtendCharacterLimit, subscriptionResponseModel.allowedToExtendCharacterLimit) &&
        Objects.equals(this.availableModels, subscriptionResponseModel.availableModels) &&
        ...
        Objects.equals(this.canUseDelayedPaymentMethods, subscriptionResponseModel.canUseDelayedPaymentMethods) &&
        ...
        Objects.equals(this.tier, subscriptionResponseModel.tier) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubscriptionResponseModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscriptionResponseModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscriptionResponseModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubscriptionResponseModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
