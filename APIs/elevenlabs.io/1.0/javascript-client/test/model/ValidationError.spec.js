...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElevenLabsApiDocumentation.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new ElevenLabsApiDocumentation.ValidationError();
      //expect(instance).to.be.a(ElevenLabsApiDocumentation.ValidationError);
    });
