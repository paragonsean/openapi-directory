...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElevenLabsApiDocumentation.ExtendedSubscriptionResponseModel();
  });
  ...
  describe('ExtendedSubscriptionResponseModel', function() {
    it('should create an instance of ExtendedSubscriptionResponseModel', function() {
      // uncomment below and update the code to test ExtendedSubscriptionResponseModel
      //var instance = new ElevenLabsApiDocumentation.ExtendedSubscriptionResponseModel();
      //expect(instance).to.be.a(ElevenLabsApiDocumentation.ExtendedSubscriptionResponseModel);
    });
    ...
    it('should have the property nextInvoice (base name: "next_invoice")', function() {
      // uncomment below and update the code to test the property nextInvoice
      //var instance = new ElevenLabsApiDocumentation.ExtendedSubscriptionResponseModel();
      //expect(instance).to.be();
    });
