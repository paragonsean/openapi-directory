...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElevenLabsApiDocumentation.LocationInner();
  });
  ...
  describe('LocationInner', function() {
    it('should create an instance of LocationInner', function() {
      ...
      //var instance = new ElevenLabsApiDocumentation.LocationInner();
      //expect(instance).to.be.a(ElevenLabsApiDocumentation.LocationInner);
    });
