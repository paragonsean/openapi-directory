...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ElevenLabsApiDocumentation.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new ElevenLabsApiDocumentation.HTTPValidationError();
      //expect(instance).to.be.a(ElevenLabsApiDocumentation.HTTPValidationError);
    });
