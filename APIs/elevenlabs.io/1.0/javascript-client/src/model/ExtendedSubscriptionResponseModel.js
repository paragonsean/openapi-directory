...
/**
 * The ExtendedSubscriptionResponseModel model module.
 * @module model/ExtendedSubscriptionResponseModel
 * @version 1.0
 */
class ExtendedSubscriptionResponseModel {
    /**
     * Constructs a new <code>ExtendedSubscriptionResponseModel</code>.
     * @alias module:model/ExtendedSubscriptionResponseModel
     ...
     * @param currency {module:model/ExtendedSubscriptionResponseModel.CurrencyEnum} 
     * @param nextCharacterCountResetUnix {Number} 
     * @param nextInvoice {module:model/InvoiceResponseModel} 
     * @param professionalVoiceLimit {Number} 
     * @param status {module:model/ExtendedSubscriptionResponseModel.StatusEnum} 
     * @param tier {String} 
     * @param voiceLimit {Number} 
     */
    constructor(allowedToExtendCharacterLimit, availableModels, canExtendCharacterLimit, canExtendVoiceLimit, canUseDelayedPaymentMethods, canUseInstantVoiceCloning, canUseProfessionalVoiceCloning, characterCount, characterLimit, currency, nextCharacterCountResetUnix, nextInvoice, professionalVoiceLimit, status, tier, voiceLimit) { 
        
        ExtendedSubscriptionResponseModel.initialize(this, allowedToExtendCharacterLimit, availableModels, canExtendCharacterLimit, canExtendVoiceLimit, canUseDelayedPaymentMethods, canUseInstantVoiceCloning, canUseProfessionalVoiceCloning, characterCount, characterLimit, currency, nextCharacterCountResetUnix, nextInvoice, professionalVoiceLimit, status, tier, voiceLimit);
    }
    ...
    /**
     * Constructs a <code>ExtendedSubscriptionResponseModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtendedSubscriptionResponseModel} obj Optional instance to populate.
     * @return {module:model/ExtendedSubscriptionResponseModel} The populated <code>ExtendedSubscriptionResponseModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtendedSubscriptionResponseModel();
            ...
            if (data.hasOwnProperty('next_invoice')) {
                obj['next_invoice'] = InvoiceResponseModel.constructFromObject(data['next_invoice']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ExtendedSubscriptionResponseModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtendedSubscriptionResponseModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExtendedSubscriptionResponseModel.RequiredProperties) {
        ...
        // validate the optional field `next_invoice`
        if (data['next_invoice']) { // data not null
          InvoiceResponseModel.validateJSON(data['next_invoice']);
        }
        // ensure the json data is a string
...
ExtendedSubscriptionResponseModel.RequiredProperties = ["allowed_to_extend_character_limit", "available_models", "can_extend_character_limit", "can_extend_voice_limit", "can_use_delayed_payment_methods", "can_use_instant_voice_cloning", "can_use_professional_voice_cloning", "character_count", "character_limit", "currency", "next_character_count_reset_unix", "next_invoice", "professional_voice_limit", "status", "tier", "voice_limit"];

/**
 * @member {Boolean} allowed_to_extend_character_limit
 */
ExtendedSubscriptionResponseModel.prototype['allowed_to_extend_character_limit'] = undefined;

/**
 * @member {Array.<module:model/TTSModelResponseModel>} available_models
 */
ExtendedSubscriptionResponseModel.prototype['available_models'] = undefined;

/**
 * @member {Boolean} can_extend_character_limit
 */
ExtendedSubscriptionResponseModel.prototype['can_extend_character_limit'] = undefined;

/**
 * @member {Boolean} can_extend_voice_limit
 */
ExtendedSubscriptionResponseModel.prototype['can_extend_voice_limit'] = undefined;

/**
 * @member {Boolean} can_use_delayed_payment_methods
 */
ExtendedSubscriptionResponseModel.prototype['can_use_delayed_payment_methods'] = undefined;

/**
 * @member {Boolean} can_use_instant_voice_cloning
 */
ExtendedSubscriptionResponseModel.prototype['can_use_instant_voice_cloning'] = undefined;

/**
 * @member {Boolean} can_use_professional_voice_cloning
 */
ExtendedSubscriptionResponseModel.prototype['can_use_professional_voice_cloning'] = undefined;

/**
 * @member {Number} character_count
 */
ExtendedSubscriptionResponseModel.prototype['character_count'] = undefined;

/**
 * @member {Number} character_limit
 */
ExtendedSubscriptionResponseModel.prototype['character_limit'] = undefined;

/**
 * @member {module:model/ExtendedSubscriptionResponseModel.CurrencyEnum} currency
 */
ExtendedSubscriptionResponseModel.prototype['currency'] = undefined;

/**
 * @member {Number} next_character_count_reset_unix
 */
ExtendedSubscriptionResponseModel.prototype['next_character_count_reset_unix'] = undefined;

/**
 * @member {module:model/InvoiceResponseModel} next_invoice
 */
ExtendedSubscriptionResponseModel.prototype['next_invoice'] = undefined;

/**
 * @member {Number} professional_voice_limit
 */
ExtendedSubscriptionResponseModel.prototype['professional_voice_limit'] = undefined;

/**
 * @member {module:model/ExtendedSubscriptionResponseModel.StatusEnum} status
 */
ExtendedSubscriptionResponseModel.prototype['status'] = undefined;

/**
 * @member {String} tier
 */
ExtendedSubscriptionResponseModel.prototype['tier'] = undefined;

/**
 * @member {Number} voice_limit
 */
ExtendedSubscriptionResponseModel.prototype['voice_limit'] = undefined;
 ...
 * @readonly
 */
ExtendedSubscriptionResponseModel['CurrencyEnum'] = {
 ...
 * @readonly
 */
ExtendedSubscriptionResponseModel['StatusEnum'] = {
...
export default ExtendedSubscriptionResponseModel;
