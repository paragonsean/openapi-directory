...
/*
 * OAIExtendedSubscriptionResponseModel.h
 *
 * 
 */

#ifndef OAIExtendedSubscriptionResponseModel_H
#define OAIExtendedSubscriptionResponseModel_H
...
class OAIInvoiceResponseModel;

class OAIExtendedSubscriptionResponseModel : public OAIObject {
public:
    OAIExtendedSubscriptionResponseModel();
    OAIExtendedSubscriptionResponseModel(QString json);
    ~OAIExtendedSubscriptionResponseModel() override;
    ...
    OAIInvoiceResponseModel getNextInvoice() const;
    void setNextInvoice(const OAIInvoiceResponseModel &next_invoice);
    bool is_next_invoice_Set() const;
    bool is_next_invoice_Valid() const;
...
private:
    ...
    OAIInvoiceResponseModel m_next_invoice;
    bool m_next_invoice_isSet;
    bool m_next_invoice_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtendedSubscriptionResponseModel)

#endif // OAIExtendedSubscriptionResponseModel_H
