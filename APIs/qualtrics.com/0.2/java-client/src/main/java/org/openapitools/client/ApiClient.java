...
public class ApiClient {
    ...
    private String basePath = "https://fra1.qualtrics.com/API/v3";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("header", "X-API-TOKEN"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://fra1.qualtrics.com/API/v3
