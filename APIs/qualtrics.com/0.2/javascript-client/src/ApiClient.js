...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://fra1.qualtrics.com/API/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://fra1.qualtrics.com/API/v3
         */
        ...
        this.authentications = {
            'api_key': {type: 'apiKey', 'in': 'header', name: 'X-API-TOKEN'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/0.2/Javascript'
        };
