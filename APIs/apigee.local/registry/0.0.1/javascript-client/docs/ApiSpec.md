...
**createTime** | **Date** | Output only. Creation timestamp; when the spec resource was created. | [optional] [readonly] 
...
**sizeBytes** | **Number** | Output only. The size of the spec file in bytes. If the spec is gzipped, this is the size of the uncompressed spec. | [optional] [readonly] 
