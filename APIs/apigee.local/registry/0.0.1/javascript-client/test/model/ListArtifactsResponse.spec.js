...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RegistryApi.ListArtifactsResponse();
  });
  ...
  describe('ListArtifactsResponse', function() {
    it('should create an instance of ListArtifactsResponse', function() {
      ...
      //var instance = new RegistryApi.ListArtifactsResponse();
      //expect(instance).to.be.a(RegistryApi.ListArtifactsResponse);
    });
