...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RegistryApi.ApiSpec();
  });
  ...
  describe('ApiSpec', function() {
    it('should create an instance of ApiSpec', function() {
      // uncomment below and update the code to test ApiSpec
      //var instance = new RegistryApi.ApiSpec();
      //expect(instance).to.be.a(RegistryApi.ApiSpec);
    });
