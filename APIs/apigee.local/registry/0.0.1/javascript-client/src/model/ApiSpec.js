    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('revisionCreateTime')) {
                obj['revisionCreateTime'] = ApiClient.convertToType(data['revisionCreateTime'], 'Date');
            }
            ...
            if (data.hasOwnProperty('revisionUpdateTime')) {
                obj['revisionUpdateTime'] = ApiClient.convertToType(data['revisionUpdateTime'], 'Date');
            }
 ...
 * @member {Date} revisionCreateTime
 */
 ...
 * @member {Date} revisionUpdateTime
 */
