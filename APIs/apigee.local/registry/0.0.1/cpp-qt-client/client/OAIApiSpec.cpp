...
QString OAIApiSpec::getContents() const {
    return m_contents;
}
void OAIApiSpec::setContents(const QString &contents) {
    m_contents = contents;
...
QDateTime OAIApiSpec::getCreateTime() const {
    return m_create_time;
}
void OAIApiSpec::setCreateTime(const QDateTime &create_time) {
...
QDateTime OAIApiSpec::getRevisionCreateTime() const {
    return m_revision_create_time;
}
void OAIApiSpec::setRevisionCreateTime(const QDateTime &revision_create_time) {
...
QDateTime OAIApiSpec::getRevisionUpdateTime() const {
    return m_revision_update_time;
}
void OAIApiSpec::setRevisionUpdateTime(const QDateTime &revision_update_time) {
