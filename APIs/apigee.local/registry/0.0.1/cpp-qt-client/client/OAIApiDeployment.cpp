...
QDateTime OAIApiDeployment::getCreateTime() const {
    return m_create_time;
}
void OAIApiDeployment::setCreateTime(const QDateTime &create_time) {
...
QDateTime OAIApiDeployment::getRevisionCreateTime() const {
    return m_revision_create_time;
}
void OAIApiDeployment::setRevisionCreateTime(const QDateTime &revision_create_time) {
...
QDateTime OAIApiDeployment::getRevisionUpdateTime() const {
    return m_revision_update_time;
}
void OAIApiDeployment::setRevisionUpdateTime(const QDateTime &revision_update_time) {
