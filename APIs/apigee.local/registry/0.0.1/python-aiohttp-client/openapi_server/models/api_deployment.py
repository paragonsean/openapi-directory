...
class ApiDeployment(Model):
    ...
    def __init__(self, access_guidance: str=None, annotations: Dict[str, str]=None, api_spec_revision: str=None, create_time: datetime=None, description: str=None, display_name: str=None, endpoint_uri: str=None, external_channel_uri: str=None, intended_audience: str=None, labels: Dict[str, str]=None, name: str=None, revision_create_time: datetime=None, revision_id: str=None, revision_update_time: datetime=None):
