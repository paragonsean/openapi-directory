...
class Api(Model):
    ...
    def __init__(self, annotations: Dict[str, str]=None, availability: str=None, create_time: datetime=None, description: str=None, display_name: str=None, labels: Dict[str, str]=None, name: str=None, recommended_deployment: str=None, recommended_version: str=None, update_time: datetime=None):
