...
class ApiSpec(Model):
    ...
    def __init__(self, annotations: Dict[str, str]=None, contents: str=None, create_time: datetime=None, description: str=None, filename: str=None, hash: str=None, labels: Dict[str, str]=None, mime_type: str=None, name: str=None, revision_create_time: datetime=None, revision_id: str=None, revision_update_time: datetime=None, size_bytes: int=None, source_uri: str=None):
    ...
    def revision_update_time(self, revision_update_time):
        ...
        :param revision_update_time: The revision_update_time of this ApiSpec.
        :type revision_update_time: datetime
        """
