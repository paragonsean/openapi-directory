...
public class ApiClient {
    ...
    private String basePath = "https://cenit.io/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("X-User-Access-Key", new ApiKeyAuth("header", "X-User-Access-Key"));
        authentications.put("X-User-Access-Token", new ApiKeyAuth("header", "X-User-Access-Token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cenit.io/api/v1
