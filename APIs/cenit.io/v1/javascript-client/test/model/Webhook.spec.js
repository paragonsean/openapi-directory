...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CenitIoRestApiSpecification.Webhook();
  });
  ...
  describe('Webhook', function() {
    it('should create an instance of Webhook', function() {
      ...
      //var instance = new CenitIoRestApiSpecification.Webhook();
      //expect(instance).to.be.a(CenitIoRestApiSpecification.Webhook);
    });
