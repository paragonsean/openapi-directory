...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CenitIoRestApiSpecification.Observer();
  });
  ...
  describe('Observer', function() {
    it('should create an instance of Observer', function() {
      // uncomment below and update the code to test Observer
      //var instance = new CenitIoRestApiSpecification.Observer();
      //expect(instance).to.be.a(CenitIoRestApiSpecification.Observer);
    });
