...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CenitIoRestApiSpecification.Schema();
  });
  ...
  describe('Schema', function() {
    it('should create an instance of Schema', function() {
      ...
      //var instance = new CenitIoRestApiSpecification.Schema();
      //expect(instance).to.be.a(CenitIoRestApiSpecification.Schema);
    });
