# CenitIoRestApiSpecification.NamespaceApi
...
let apiInstance = new CenitIoRestApiSpecification.NamespaceApi();
apiInstance.setupNamespaceGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new CenitIoRestApiSpecification.NamespaceApi();
let id = "id_example"; // String | Namespace ID.
apiInstance.setupNamespaceIdDelete(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new CenitIoRestApiSpecification.NamespaceApi();
let id = "id_example"; // String | Namespace ID.
apiInstance.setupNamespaceIdGet(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new CenitIoRestApiSpecification.NamespaceApi();
apiInstance.setupNamespacePost((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
