# CenitIoRestApiSpecification.SchedulerApi
...
let apiInstance = new CenitIoRestApiSpecification.SchedulerApi();
apiInstance.setupSchedulerGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new CenitIoRestApiSpecification.SchedulerApi();
let id = "id_example"; // String | Scheduler ID
apiInstance.setupSchedulerIdDelete(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new CenitIoRestApiSpecification.SchedulerApi();
let id = "id_example"; // String | Scheduler ID
apiInstance.setupSchedulerIdGet(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new CenitIoRestApiSpecification.SchedulerApi();
apiInstance.setupSchedulerPost((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
