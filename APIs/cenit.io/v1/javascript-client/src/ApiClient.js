...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://cenit.io/api/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://cenit.io/api/v1
         */
        ...
        this.authentications = {
            'X-User-Access-Key': {type: 'apiKey', 'in': 'header', name: 'X-User-Access-Key'},
            'X-User-Access-Token': {type: 'apiKey', 'in': 'header', name: 'X-User-Access-Token'}
        }
