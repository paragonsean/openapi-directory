...
void Example::exampleFunction1(){
     OAIBalanceApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIBalanceApi::balanceLookupSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIBalanceApi::balanceLookupSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString api_key = create(); // QString | The API key, which you can get from bintable.com website.
      apiInstance.balanceLookup(api_key);
