...
/*
 * OAIGetAllVerificationsResponse_list_inner.h
 *
 * 
 */

#ifndef OAIGetAllVerificationsResponse_list_inner_H
#define OAIGetAllVerificationsResponse_list_inner_H
...
class OAIGetAllVerificationsResponse_list_inner : public OAIObject {
public:
    OAIGetAllVerificationsResponse_list_inner();
    OAIGetAllVerificationsResponse_list_inner(QString json);
    ~OAIGetAllVerificationsResponse_list_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAllVerificationsResponse_list_inner)

#endif // OAIGetAllVerificationsResponse_list_inner_H
