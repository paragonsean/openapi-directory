...
/*
 * OAIGetAllTriggersResponse_list_inner.h
 *
 * 
 */

#ifndef OAIGetAllTriggersResponse_list_inner_H
#define OAIGetAllTriggersResponse_list_inner_H
...
class OAIGetAllTriggersResponse_list_inner : public OAIObject {
public:
    OAIGetAllTriggersResponse_list_inner();
    OAIGetAllTriggersResponse_list_inner(QString json);
    ~OAIGetAllTriggersResponse_list_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAllTriggersResponse_list_inner)

#endif // OAIGetAllTriggersResponse_list_inner_H
