...
#ifndef OAI_OAISendApi_H
#define OAI_OAISendApi_H
...
class OAISendApi : public QObject {
    Q_OBJECT

public:
    OAISendApi(const int timeOut = 0);
    ~OAISendApi();
    ...
    /**
    * @param[in]  oai_send_request OAISendRequest [required]
    */
    virtual void send(const OAISendRequest &oai_send_request);
