...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mailscript.WorkflowsApi();
  });
  ...
  describe('WorkflowsApi', function() {
    ...
    describe('setWorkflow', function() {
      it('should call setWorkflow successfully', function(done) {
        //uncomment below and update the code to test setWorkflow
        //instance.setWorkflow(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
