...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mailscript.IntegrationsApi();
  });
  ...
  describe('IntegrationsApi', function() {
    ...
    describe('getAllIntegrations', function() {
      it('should call getAllIntegrations successfully', function(done) {
        //uncomment below and update the code to test getAllIntegrations
        //instance.getAllIntegrations(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
