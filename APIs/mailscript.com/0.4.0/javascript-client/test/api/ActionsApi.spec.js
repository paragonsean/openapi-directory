...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mailscript.ActionsApi();
  });
  ...
  describe('ActionsApi', function() {
    ...
    describe('getAllActions', function() {
      it('should call getAllActions successfully', function(done) {
        //uncomment below and update the code to test getAllActions
        //instance.getAllActions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
