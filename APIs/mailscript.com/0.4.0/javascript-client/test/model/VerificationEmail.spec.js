...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mailscript.VerificationEmail();
  });
  ...
  describe('VerificationEmail', function() {
    it('should create an instance of VerificationEmail', function() {
      // uncomment below and update the code to test VerificationEmail
      //var instance = new Mailscript.VerificationEmail();
      //expect(instance).to.be.a(Mailscript.VerificationEmail);
    });
