...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mailscript.VerificationSms();
  });
  ...
  describe('VerificationSms', function() {
    it('should create an instance of VerificationSms', function() {
      // uncomment below and update the code to test VerificationSms
      //var instance = new Mailscript.VerificationSms();
      //expect(instance).to.be.a(Mailscript.VerificationSms);
    });
