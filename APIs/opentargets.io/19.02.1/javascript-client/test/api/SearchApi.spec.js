...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenTargetsPlatformRestApi.SearchApi();
  });
  ...
  describe('SearchApi', function() {
    describe('getSearch_0', function() {
      it('should call getSearch_0 successfully', function(done) {
        //uncomment below and update the code to test getSearch_0
        //instance.getSearch_0(function(error) {
