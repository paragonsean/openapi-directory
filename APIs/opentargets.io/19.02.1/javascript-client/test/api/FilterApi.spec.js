...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenTargetsPlatformRestApi.FilterApi();
  });
  ...
  describe('FilterApi', function() {
    describe('getAssociationFilter_0', function() {
      it('should call getAssociationFilter_0 successfully', function(done) {
        //uncomment below and update the code to test getAssociationFilter_0
        //instance.getAssociationFilter_0(function(error) {
    ...
    describe('getEvidenceFilter_0', function() {
      it('should call getEvidenceFilter_0 successfully', function(done) {
        //uncomment below and update the code to test getEvidenceFilter_0
        //instance.getEvidenceFilter_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postAssociationFilter_0', function() {
      it('should call postAssociationFilter_0 successfully', function(done) {
        //uncomment below and update the code to test postAssociationFilter_0
        //instance.postAssociationFilter_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postEvidenceFilter_0', function() {
      it('should call postEvidenceFilter_0 successfully', function(done) {
        //uncomment below and update the code to test postEvidenceFilter_0
        //instance.postEvidenceFilter_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
