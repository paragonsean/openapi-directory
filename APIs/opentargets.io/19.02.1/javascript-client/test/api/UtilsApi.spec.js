...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenTargetsPlatformRestApi.UtilsApi();
  });
  ...
  describe('UtilsApi', function() {
    describe('getDataMetrics_0', function() {
      it('should call getDataMetrics_0 successfully', function(done) {
        //uncomment below and update the code to test getDataMetrics_0
        //instance.getDataMetrics_0(function(error) {
    ...
    describe('getDataStats_0', function() {
      it('should call getDataStats_0 successfully', function(done) {
        //uncomment below and update the code to test getDataStats_0
        //instance.getDataStats_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPing_0', function() {
      it('should call getPing_0 successfully', function(done) {
        //uncomment below and update the code to test getPing_0
        //instance.getPing_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getTherapeuticAreas_0', function() {
      it('should call getTherapeuticAreas_0 successfully', function(done) {
        //uncomment below and update the code to test getTherapeuticAreas_0
        //instance.getTherapeuticAreas_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getVersion_0', function() {
      it('should call getVersion_0 successfully', function(done) {
        //uncomment below and update the code to test getVersion_0
        //instance.getVersion_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
