...
public class ApiClient {
    ...
    private String basePath = "http://platform-api.opentargets.io/v3";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/19.02.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://platform-api.opentargets.io/v3
