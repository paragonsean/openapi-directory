...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AucklandMuseumApi.SearchApi();
  });
  ...
  describe('SearchApi', function() {
    ...
    describe('postSearch', function() {
      it('should call postSearch successfully', function(done) {
        //uncomment below and update the code to test postSearch
        //instance.postSearch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
