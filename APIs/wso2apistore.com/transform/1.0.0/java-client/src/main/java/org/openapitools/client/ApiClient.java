...
public class ApiClient {
    ...
    private String basePath = "https://gateway.wso2apistore.com/transform/1.0.0";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://gateway.wso2apistore.com/transform/1.0.0
