...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://gateway.wso2apistore.com/transform/1.0.0"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("http://gateway.wso2apistore.com/transform/1.0.0"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("jsontoxmlPost", defaultConf);
    _serverIndices.insert("jsontoxmlPost", 0);
    _serverConfigs.insert("xmltojsonPost", defaultConf);
    _serverIndices.insert("xmltojsonPost", 0);
}
...
void OAIDefaultApi::jsontoxmlPost(const QString &body) {
    QString fullPath = QString(_serverConfigs["jsontoxmlPost"][_serverIndices.value("jsontoxmlPost")].URL()+"/jsontoxml");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::jsontoxmlPostCallback);
...
void OAIDefaultApi::jsontoxmlPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT jsontoxmlPostSignal();
        Q_EMIT jsontoxmlPostSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT jsontoxmlPostSignalE(error_type, error_str);
        Q_EMIT jsontoxmlPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT jsontoxmlPostSignalError(error_type, error_str);
        Q_EMIT jsontoxmlPostSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::xmltojsonPost(const QString &body) {
    QString fullPath = QString(_serverConfigs["xmltojsonPost"][_serverIndices.value("xmltojsonPost")].URL()+"/xmltojson");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::xmltojsonPostCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::xmltojsonPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT xmltojsonPostSignal();
        Q_EMIT xmltojsonPostSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT xmltojsonPostSignalE(error_type, error_str);
        Q_EMIT xmltojsonPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT xmltojsonPostSignalError(error_type, error_str);
        Q_EMIT xmltojsonPostSignalErrorFull(worker, error_type, error_str);
    }
}
