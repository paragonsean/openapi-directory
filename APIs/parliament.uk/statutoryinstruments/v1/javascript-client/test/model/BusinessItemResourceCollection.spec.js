...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StatutoryInstrumentsApi.BusinessItemResourceCollection();
  });
  ...
  describe('BusinessItemResourceCollection', function() {
    it('should create an instance of BusinessItemResourceCollection', function() {
      ...
      //var instance = new StatutoryInstrumentsApi.BusinessItemResourceCollection();
      //expect(instance).to.be.a(StatutoryInstrumentsApi.BusinessItemResourceCollection);
    });
