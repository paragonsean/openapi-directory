...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StatutoryInstrumentsApi.LayingBodyResourceCollection();
  });
  ...
  describe('LayingBodyResourceCollection', function() {
    it('should create an instance of LayingBodyResourceCollection', function() {
      // uncomment below and update the code to test LayingBodyResourceCollection
      //var instance = new StatutoryInstrumentsApi.LayingBodyResourceCollection();
      //expect(instance).to.be.a(StatutoryInstrumentsApi.LayingBodyResourceCollection);
    });
