...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StatutoryInstrumentsApi.Department();
  });
  ...
  describe('Department', function() {
    it('should create an instance of Department', function() {
      ...
      //var instance = new StatutoryInstrumentsApi.Department();
      //expect(instance).to.be.a(StatutoryInstrumentsApi.Department);
    });
