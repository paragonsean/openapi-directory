...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StatutoryInstrumentsApi.LayingBody();
  });
  ...
  describe('LayingBody', function() {
    it('should create an instance of LayingBody', function() {
      // uncomment below and update the code to test LayingBody
      //var instance = new StatutoryInstrumentsApi.LayingBody();
      //expect(instance).to.be.a(StatutoryInstrumentsApi.LayingBody);
    });
