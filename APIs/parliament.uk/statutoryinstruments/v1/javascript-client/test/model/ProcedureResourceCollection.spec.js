...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StatutoryInstrumentsApi.ProcedureResourceCollection();
  });
  ...
  describe('ProcedureResourceCollection', function() {
    it('should create an instance of ProcedureResourceCollection', function() {
      // uncomment below and update the code to test ProcedureResourceCollection
      //var instance = new StatutoryInstrumentsApi.ProcedureResourceCollection();
      //expect(instance).to.be.a(StatutoryInstrumentsApi.ProcedureResourceCollection);
    });
