...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StatutoryInstrumentsApi.Procedure();
  });
  ...
  describe('Procedure', function() {
    it('should create an instance of Procedure', function() {
      // uncomment below and update the code to test Procedure
      //var instance = new StatutoryInstrumentsApi.Procedure();
      //expect(instance).to.be.a(StatutoryInstrumentsApi.Procedure);
    });
