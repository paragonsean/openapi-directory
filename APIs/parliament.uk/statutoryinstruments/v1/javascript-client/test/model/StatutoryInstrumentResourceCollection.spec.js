...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StatutoryInstrumentsApi.StatutoryInstrumentResourceCollection();
  });
  ...
  describe('StatutoryInstrumentResourceCollection', function() {
    it('should create an instance of StatutoryInstrumentResourceCollection', function() {
      // uncomment below and update the code to test StatutoryInstrumentResourceCollection
      //var instance = new StatutoryInstrumentsApi.StatutoryInstrumentResourceCollection();
      //expect(instance).to.be.a(StatutoryInstrumentsApi.StatutoryInstrumentResourceCollection);
    });
