...
#ifndef OAILayingBody_H
#define OAILayingBody_H
...
class OAILayingBody : public OAIObject {
public:
    OAILayingBody();
    OAILayingBody(QString json);
    ~OAILayingBody() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILayingBody)

#endif // OAILayingBody_H
