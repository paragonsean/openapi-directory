...
/*
 * OAIProcedureResourceCollection.h
 *
 * 
 */

#ifndef OAIProcedureResourceCollection_H
#define OAIProcedureResourceCollection_H
...
namespace OpenAPI {
class OAIProcedureResource;
class OAILink;

class OAIProcedureResourceCollection : public OAIObject {
public:
    OAIProcedureResourceCollection();
    OAIProcedureResourceCollection(QString json);
    ~OAIProcedureResourceCollection() override;
    ...
    QList<OAIProcedureResource> getItems() const;
    void setItems(const QList<OAIProcedureResource> &items);
...
private:
    ...
    QList<OAIProcedureResource> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProcedureResourceCollection)

#endif // OAIProcedureResourceCollection_H
