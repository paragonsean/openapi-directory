...
/*
 * OAILayingBodyResourceCollection.h
 *
 * 
 */

#ifndef OAILayingBodyResourceCollection_H
#define OAILayingBodyResourceCollection_H
...
namespace OpenAPI {
class OAILayingBodyResource;
class OAILink;

class OAILayingBodyResourceCollection : public OAIObject {
public:
    OAILayingBodyResourceCollection();
    OAILayingBodyResourceCollection(QString json);
    ~OAILayingBodyResourceCollection() override;
    ...
    QList<OAILayingBodyResource> getItems() const;
    void setItems(const QList<OAILayingBodyResource> &items);
...
private:
    ...
    QList<OAILayingBodyResource> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAILayingBodyResourceCollection)

#endif // OAILayingBodyResourceCollection_H
