...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErskineMayApi.ErskineMaySectionSearchResultErskineMaySearch();
  });
  ...
  describe('ErskineMaySectionSearchResultErskineMaySearch', function() {
    it('should create an instance of ErskineMaySectionSearchResultErskineMaySearch', function() {
      // uncomment below and update the code to test ErskineMaySectionSearchResultErskineMaySearch
      //var instance = new ErskineMayApi.ErskineMaySectionSearchResultErskineMaySearch();
      //expect(instance).to.be.a(ErskineMayApi.ErskineMaySectionSearchResultErskineMaySearch);
    });
