...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ErskineMayApi.ErskineMayIndexTermSearchResultErskineMaySearch();
  });
  ...
  describe('ErskineMayIndexTermSearchResultErskineMaySearch', function() {
    it('should create an instance of ErskineMayIndexTermSearchResultErskineMaySearch', function() {
      // uncomment below and update the code to test ErskineMayIndexTermSearchResultErskineMaySearch
      //var instance = new ErskineMayApi.ErskineMayIndexTermSearchResultErskineMaySearch();
      //expect(instance).to.be.a(ErskineMayApi.ErskineMayIndexTermSearchResultErskineMaySearch);
    });
