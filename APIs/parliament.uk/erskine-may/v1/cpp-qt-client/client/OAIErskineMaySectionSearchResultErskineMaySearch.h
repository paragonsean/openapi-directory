...
/*
 * OAIErskineMaySectionSearchResultErskineMaySearch.h
 *
 * 
 */

#ifndef OAIErskineMaySectionSearchResultErskineMaySearch_H
#define OAIErskineMaySectionSearchResultErskineMaySearch_H
...
namespace OpenAPI {
class OAIErskineMaySectionSearchResult;

class OAIErskineMaySectionSearchResultErskineMaySearch : public OAIObject {
public:
    OAIErskineMaySectionSearchResultErskineMaySearch();
    OAIErskineMaySectionSearchResultErskineMaySearch(QString json);
    ~OAIErskineMaySectionSearchResultErskineMaySearch() override;
    ...
    QList<OAIErskineMaySectionSearchResult> getSearchResults() const;
    void setSearchResults(const QList<OAIErskineMaySectionSearchResult> &search_results);
...
private:
    ...
    QList<OAIErskineMaySectionSearchResult> m_search_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErskineMaySectionSearchResultErskineMaySearch)

#endif // OAIErskineMaySectionSearchResultErskineMaySearch_H
