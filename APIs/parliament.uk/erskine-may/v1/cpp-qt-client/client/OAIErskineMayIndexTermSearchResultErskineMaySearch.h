...
/*
 * OAIErskineMayIndexTermSearchResultErskineMaySearch.h
 *
 * 
 */

#ifndef OAIErskineMayIndexTermSearchResultErskineMaySearch_H
#define OAIErskineMayIndexTermSearchResultErskineMaySearch_H
...
namespace OpenAPI {
class OAIErskineMayIndexTermSearchResult;

class OAIErskineMayIndexTermSearchResultErskineMaySearch : public OAIObject {
public:
    OAIErskineMayIndexTermSearchResultErskineMaySearch();
    OAIErskineMayIndexTermSearchResultErskineMaySearch(QString json);
    ~OAIErskineMayIndexTermSearchResultErskineMaySearch() override;
    ...
    QList<OAIErskineMayIndexTermSearchResult> getSearchResults() const;
    void setSearchResults(const QList<OAIErskineMayIndexTermSearchResult> &search_results);
...
private:
    ...
    QList<OAIErskineMayIndexTermSearchResult> m_search_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErskineMayIndexTermSearchResultErskineMaySearch)

#endif // OAIErskineMayIndexTermSearchResultErskineMaySearch_H
