...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MembersApi.MembersStaff();
  });
  ...
  describe('MembersStaff', function() {
    it('should create an instance of MembersStaff', function() {
      // uncomment below and update the code to test MembersStaff
      //var instance = new MembersApi.MembersStaff();
      //expect(instance).to.be.a(MembersApi.MembersStaff);
    });
