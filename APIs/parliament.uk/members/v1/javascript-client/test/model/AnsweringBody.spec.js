...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MembersApi.AnsweringBody();
  });
  ...
  describe('AnsweringBody', function() {
    it('should create an instance of AnsweringBody', function() {
      // uncomment below and update the code to test AnsweringBody
      //var instance = new MembersApi.AnsweringBody();
      //expect(instance).to.be.a(MembersApi.AnsweringBody);
    });
