...
/*
 * OAIPublishedEarlyDayMotionDetails.h
 *
 * 
 */

#ifndef OAIPublishedEarlyDayMotionDetails_H
#define OAIPublishedEarlyDayMotionDetails_H
...
class OAIPublishedEarlyDayMotionSponsor;

class OAIPublishedEarlyDayMotionDetails : public OAIObject {
public:
    OAIPublishedEarlyDayMotionDetails();
    OAIPublishedEarlyDayMotionDetails(QString json);
    ~OAIPublishedEarlyDayMotionDetails() override;
    ...
    QList<OAIPublishedEarlyDayMotionDetails> getAmendments() const;
    void setAmendments(const QList<OAIPublishedEarlyDayMotionDetails> &amendments);
    bool is_amendments_Set() const;
    bool is_amendments_Valid() const;
    ...
    QList<OAIPublishedEarlyDayMotionSponsor> getSponsors() const;
    void setSponsors(const QList<OAIPublishedEarlyDayMotionSponsor> &sponsors);
...
private:
    ...
    QList<OAIPublishedEarlyDayMotionDetails> m_amendments;
    bool m_amendments_isSet;
    bool m_amendments_isValid;
    ...
    QList<OAIPublishedEarlyDayMotionSponsor> m_sponsors;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishedEarlyDayMotionDetails)

#endif // OAIPublishedEarlyDayMotionDetails_H
