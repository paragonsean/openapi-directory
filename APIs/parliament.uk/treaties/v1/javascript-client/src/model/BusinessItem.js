...
class BusinessItem {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('treatyId')) {
                obj['treatyId'] = ApiClient.convertToType(data['treatyId'], 'String');
            }
            if (data.hasOwnProperty('treatyUri')) {
                obj['treatyUri'] = ApiClient.convertToType(data['treatyUri'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['treatyId'] && !(typeof data['treatyId'] === 'string' || data['treatyId'] instanceof String)) {
            throw new Error("Expected the field `treatyId` to be a primitive type in the JSON string but got " + data['treatyId']);
        }
        // ensure the json data is a string
        if (data['treatyUri'] && !(typeof data['treatyUri'] === 'string' || data['treatyUri'] instanceof String)) {
            throw new Error("Expected the field `treatyUri` to be a primitive type in the JSON string but got " + data['treatyUri']);
        }
        // ensure the json data is a string
...
/**
 * @member {String} treatyId
 */
BusinessItem.prototype['treatyId'] = undefined;

/**
 * @member {String} treatyUri
 */
BusinessItem.prototype['treatyUri'] = undefined;
