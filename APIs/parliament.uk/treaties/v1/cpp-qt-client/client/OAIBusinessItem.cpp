...
void OAIBusinessItem::initializeModel() {
    ...
    m_treaty_id_isSet = false;
    m_treaty_id_isValid = false;

    m_treaty_uri_isSet = false;
    m_treaty_uri_isValid = false;
...
void OAIBusinessItem::fromJsonObject(QJsonObject json) {
    ...
    m_treaty_id_isValid = ::OpenAPI::fromJsonValue(m_treaty_id, json[QString("treatyId")]);
    m_treaty_id_isSet = !json[QString("treatyId")].isNull() && m_treaty_id_isValid;

    m_treaty_uri_isValid = ::OpenAPI::fromJsonValue(m_treaty_uri, json[QString("treatyUri")]);
    m_treaty_uri_isSet = !json[QString("treatyUri")].isNull() && m_treaty_uri_isValid;
...
QJsonObject OAIBusinessItem::asJsonObject() const {
    ...
    if (m_treaty_id_isSet) {
        obj.insert(QString("treatyId"), ::OpenAPI::toJsonValue(m_treaty_id));
    }
    if (m_treaty_uri_isSet) {
        obj.insert(QString("treatyUri"), ::OpenAPI::toJsonValue(m_treaty_uri));
    }
...
QString OAIBusinessItem::getTreatyId() const {
    return m_treaty_id;
}
void OAIBusinessItem::setTreatyId(const QString &treaty_id) {
    m_treaty_id = treaty_id;
    m_treaty_id_isSet = true;
}

bool OAIBusinessItem::is_treaty_id_Set() const{
    return m_treaty_id_isSet;
}

bool OAIBusinessItem::is_treaty_id_Valid() const{
    return m_treaty_id_isValid;
}

QString OAIBusinessItem::getTreatyUri() const {
    return m_treaty_uri;
}
void OAIBusinessItem::setTreatyUri(const QString &treaty_uri) {
    m_treaty_uri = treaty_uri;
    m_treaty_uri_isSet = true;
}

bool OAIBusinessItem::is_treaty_uri_Set() const{
    return m_treaty_uri_isSet;
}

bool OAIBusinessItem::is_treaty_uri_Valid() const{
    return m_treaty_uri_isValid;
}
