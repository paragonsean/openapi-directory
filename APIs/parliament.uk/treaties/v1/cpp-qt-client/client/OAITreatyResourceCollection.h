...
/*
 * OAITreatyResourceCollection.h
 *
 * 
 */

#ifndef OAITreatyResourceCollection_H
#define OAITreatyResourceCollection_H
...
namespace OpenAPI {
class OAITreatyResource;
class OAILink;

class OAITreatyResourceCollection : public OAIObject {
public:
    OAITreatyResourceCollection();
    OAITreatyResourceCollection(QString json);
    ~OAITreatyResourceCollection() override;
    ...
    QList<OAITreatyResource> getItems() const;
    void setItems(const QList<OAITreatyResource> &items);
...
private:
    ...
    QList<OAITreatyResource> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITreatyResourceCollection)

#endif // OAITreatyResourceCollection_H
