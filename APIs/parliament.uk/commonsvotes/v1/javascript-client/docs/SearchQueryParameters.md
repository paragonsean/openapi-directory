# CommonsVotesApi.SearchQueryParameters
...
**skip** | **Number** | The number of records to skip. Default is 0 | [optional] 
**startDate** | **Date** | Divisions where division date in one or after date provided. Date format is yyyy-MM-dd | [optional] 
**take** | **Number** | The number of records to return per page. Default is 25 | [optional] 
