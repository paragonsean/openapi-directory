...
/*
 * OAISearchQueryParameters.h
 *
 * 
 */

#ifndef OAISearchQueryParameters_H
#define OAISearchQueryParameters_H
...
class OAISearchQueryParameters : public OAIObject {
public:
    OAISearchQueryParameters();
    OAISearchQueryParameters(QString json);
    ~OAISearchQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchQueryParameters)

#endif // OAISearchQueryParameters_H
