...
/*
 * OAIMemberSearchQueryParameters.h
 *
 * 
 */

#ifndef OAIMemberSearchQueryParameters_H
#define OAIMemberSearchQueryParameters_H
...
class OAIMemberSearchQueryParameters : public OAIObject {
public:
    OAIMemberSearchQueryParameters();
    OAIMemberSearchQueryParameters(QString json);
    ~OAIMemberSearchQueryParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberSearchQueryParameters)

#endif // OAIMemberSearchQueryParameters_H
