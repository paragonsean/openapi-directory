...
#ifndef OAIRecordedMember_H
#define OAIRecordedMember_H
...
class OAIRecordedMember : public OAIObject {
public:
    OAIRecordedMember();
    OAIRecordedMember(QString json);
    ~OAIRecordedMember() override;
    ...
    void setProxyName(const QString &proxy_name);
    bool is_proxy_name_Set() const;
    bool is_proxy_name_Valid() const;

    QString getSubParty() const;
    void setSubParty(const QString &sub_party);
    bool is_sub_party_Set() const;
    bool is_sub_party_Valid() const;
...
private:
    ...
    bool m_proxy_name_isSet;
    bool m_proxy_name_isValid;

    QString m_sub_party;
    bool m_sub_party_isSet;
    bool m_sub_party_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRecordedMember)

#endif // OAIRecordedMember_H
