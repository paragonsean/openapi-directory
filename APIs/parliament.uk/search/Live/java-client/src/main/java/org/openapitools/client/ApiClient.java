...
public class ApiClient {
    ...
    private String basePath = "https://api.parliament.uk/search";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/Live/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.parliament.uk/search
