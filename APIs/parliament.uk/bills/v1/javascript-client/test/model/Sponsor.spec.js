...
(function(root, factory) {
  ...
  describe('Sponsor', function() {
    it('should create an instance of Sponsor', function() {
      // uncomment below and update the code to test Sponsor
      //var instance = new BillsApi.Sponsor();
      //expect(instance).to.be.a(BillsApi.Sponsor);
    });
