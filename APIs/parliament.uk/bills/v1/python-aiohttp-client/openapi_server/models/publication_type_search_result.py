...
class PublicationTypeSearchResult(Model):
    ...
    def __init__(self, items: List[PublicationType]=None, items_per_page: int=None, total_results: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PublicationTypeSearchResult':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PublicationTypeSearchResult of this PublicationTypeSearchResult.
        """
