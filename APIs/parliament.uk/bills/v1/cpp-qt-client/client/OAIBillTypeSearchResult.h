...
/*
 * OAIBillTypeSearchResult.h
 *
 * 
 */

#ifndef OAIBillTypeSearchResult_H
#define OAIBillTypeSearchResult_H
...
class OAIBillTypeSearchResult : public OAIObject {
public:
    OAIBillTypeSearchResult();
    OAIBillTypeSearchResult(QString json);
    ~OAIBillTypeSearchResult() override;
    ...
    QList<OAIBillType> getItems() const;
    void setItems(const QList<OAIBillType> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBillTypeSearchResult)

#endif // OAIBillTypeSearchResult_H
