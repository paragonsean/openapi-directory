...
/*
 * OAIStageSummarySearchResult.h
 *
 * 
 */

#ifndef OAIStageSummarySearchResult_H
#define OAIStageSummarySearchResult_H
...
class OAIStageSummarySearchResult : public OAIObject {
public:
    OAIStageSummarySearchResult();
    OAIStageSummarySearchResult(QString json);
    ~OAIStageSummarySearchResult() override;
    ...
    QList<OAIStageSummary> getItems() const;
    void setItems(const QList<OAIStageSummary> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStageSummarySearchResult)

#endif // OAIStageSummarySearchResult_H
