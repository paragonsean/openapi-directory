...
public class Publication {
  ...
  public Publication files(List<PublicationDocument> files) {
    this.files = files;
    return this;
  }
  ...
  public Publication links(List<PublicationLink> links) {
    this.links = links;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayDate, publication.displayDate) &&
        Objects.equals(this.files, publication.files) &&
        Objects.equals(this.id, publication.id) &&
        Objects.equals(this.links, publication.links) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(displayDate, files, id, links, publicationType, title);
  }
