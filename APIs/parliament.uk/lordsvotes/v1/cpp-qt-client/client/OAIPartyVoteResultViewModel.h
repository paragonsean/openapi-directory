...
/*
 * OAIPartyVoteResultViewModel.h
 *
 * 
 */

#ifndef OAIPartyVoteResultViewModel_H
#define OAIPartyVoteResultViewModel_H
...
class OAIPartyVoteResultViewModel : public OAIObject {
public:
    OAIPartyVoteResultViewModel();
    OAIPartyVoteResultViewModel(QString json);
    ~OAIPartyVoteResultViewModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartyVoteResultViewModel)

#endif // OAIPartyVoteResultViewModel_H
