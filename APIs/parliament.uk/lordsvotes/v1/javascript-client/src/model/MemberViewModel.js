...
class MemberViewModel {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('partyIsMainParty')) {
                obj['partyIsMainParty'] = ApiClient.convertToType(data['partyIsMainParty'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 */
MemberViewModel.prototype['memberId'] = undefined;
...
/**
 * @member {Boolean} partyIsMainParty
 */
MemberViewModel.prototype['partyIsMainParty'] = undefined;
