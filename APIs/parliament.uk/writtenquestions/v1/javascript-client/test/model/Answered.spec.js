...
(function(root, factory) {
  ...
  describe('Answered', function() {
    it('should create an instance of Answered', function() {
      // uncomment below and update the code to test Answered
      //var instance = new WrittenQuestionsServiceApi.Answered();
      //expect(instance).to.be.a(WrittenQuestionsServiceApi.Answered);
    });
