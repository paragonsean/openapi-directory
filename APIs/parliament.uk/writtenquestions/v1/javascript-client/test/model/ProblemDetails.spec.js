...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WrittenQuestionsServiceApi.ProblemDetails();
  });
  ...
  describe('ProblemDetails', function() {
    it('should create an instance of ProblemDetails', function() {
      ...
      //var instance = new WrittenQuestionsServiceApi.ProblemDetails();
      //expect(instance).to.be.a(WrittenQuestionsServiceApi.ProblemDetails);
    });
