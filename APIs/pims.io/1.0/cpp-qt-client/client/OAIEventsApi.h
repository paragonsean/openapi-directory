...
public:
    ...
    * @param[in]  from_datetime QDate [optional]
    * @param[in]  to_datetime QDate [optional]
    * @param[in]  city QString [optional]
    * @param[in]  sort QString [optional]
    * @param[in]  page_size qint32 [optional]
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchAllEvents(const ::OpenAPI::OptionalParam<QString> &label = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QDate> &from_datetime = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QDate> &to_datetime = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QString> &city = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  series_id qint32 [required]
    * @param[in]  from_datetime QDate [optional]
    * @param[in]  to_datetime QDate [optional]
    * @param[in]  city QString [optional]
    * @param[in]  sort QString [optional]
    ...
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchAllSeriesEvents(const qint32 &series_id, const ::OpenAPI::OptionalParam<QDate> &from_datetime = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QDate> &to_datetime = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QString> &city = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  venue_id qint32 [required]
    * @param[in]  from_datetime QDate [optional]
    * @param[in]  to_datetime QDate [optional]
    * @param[in]  city QString [optional]
    * @param[in]  sort QString [optional]
    ...
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchAllVenuesEvents(const qint32 &venue_id, const ::OpenAPI::OptionalParam<QDate> &from_datetime = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QDate> &to_datetime = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QString> &city = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  event_id qint32 [required]
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchOneEvent(const qint32 &event_id, const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void fetchAllEventsCallback(OAIHttpRequestWorker *worker);
    void fetchAllSeriesEventsCallback(OAIHttpRequestWorker *worker);
    void fetchAllVenuesEventsCallback(OAIHttpRequestWorker *worker);
    void fetchOneEventCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAllEventsSignal(QList<OAIEventsEntity> summary);
    void fetchAllSeriesEventsSignal(QList<OAIEventsEntity> summary);
    void fetchAllVenuesEventsSignal(QList<OAIEventsEntity> summary);
    void fetchOneEventSignal(OAIEventsEntity summary);


    void fetchAllEventsSignalFull(OAIHttpRequestWorker *worker, QList<OAIEventsEntity> summary);
    void fetchAllSeriesEventsSignalFull(OAIHttpRequestWorker *worker, QList<OAIEventsEntity> summary);
    void fetchAllVenuesEventsSignalFull(OAIHttpRequestWorker *worker, QList<OAIEventsEntity> summary);
    void fetchOneEventSignalFull(OAIHttpRequestWorker *worker, OAIEventsEntity summary);

    Q_DECL_DEPRECATED_X("Use fetchAllEventsSignalError() instead")
    void fetchAllEventsSignalE(QList<OAIEventsEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllEventsSignalError(QList<OAIEventsEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllSeriesEventsSignalError() instead")
    void fetchAllSeriesEventsSignalE(QList<OAIEventsEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllSeriesEventsSignalError(QList<OAIEventsEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllVenuesEventsSignalError() instead")
    void fetchAllVenuesEventsSignalE(QList<OAIEventsEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllVenuesEventsSignalError(QList<OAIEventsEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneEventSignalError() instead")
    void fetchOneEventSignalE(OAIEventsEntity summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneEventSignalError(OAIEventsEntity summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAllEventsSignalErrorFull() instead")
    void fetchAllEventsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllEventsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllSeriesEventsSignalErrorFull() instead")
    void fetchAllSeriesEventsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllSeriesEventsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllVenuesEventsSignalErrorFull() instead")
    void fetchAllVenuesEventsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllVenuesEventsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneEventSignalErrorFull() instead")
    void fetchOneEventSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneEventSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
