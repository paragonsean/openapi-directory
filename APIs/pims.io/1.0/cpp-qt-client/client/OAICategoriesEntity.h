...
/*
 * OAICategoriesEntity.h
 *
 * 
 */

#ifndef OAICategoriesEntity_H
#define OAICategoriesEntity_H
...
class OAICategoriesEntity : public OAIObject {
public:
    OAICategoriesEntity();
    OAICategoriesEntity(QString json);
    ~OAICategoriesEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICategoriesEntity)

#endif // OAICategoriesEntity_H
