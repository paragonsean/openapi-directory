...
/*
 * OAIEventsCategoriesEntity_event_price_ranges_inner.h
 *
 * 
 */

#ifndef OAIEventsCategoriesEntity_event_price_ranges_inner_H
#define OAIEventsCategoriesEntity_event_price_ranges_inner_H

#include <QJsonObject>

#include "OAIPriceRangesEntity.h"
#include <QString>
...
namespace OpenAPI {
class OAIPriceRangesEntity;

class OAIEventsCategoriesEntity_event_price_ranges_inner : public OAIObject {
public:
    OAIEventsCategoriesEntity_event_price_ranges_inner();
    OAIEventsCategoriesEntity_event_price_ranges_inner(QString json);
    ~OAIEventsCategoriesEntity_event_price_ranges_inner() override;
    ...
    OAIPriceRangesEntity getPriceRange() const;
    void setPriceRange(const OAIPriceRangesEntity &price_range);
    bool is_price_range_Set() const;
    bool is_price_range_Valid() const;

    float getPublicPrice() const;
    void setPublicPrice(const float &public_price);
    bool is_public_price_Set() const;
    bool is_public_price_Valid() const;
...
private:
    ...
    OAIPriceRangesEntity m_price_range;
    bool m_price_range_isSet;
    bool m_price_range_isValid;

    float m_public_price;
    bool m_public_price_isSet;
    bool m_public_price_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEventsCategoriesEntity_event_price_ranges_inner)

#endif // OAIEventsCategoriesEntity_event_price_ranges_inner_H
