...
#include "OAIPromotionsEntity_cost_state.h"
...
OAIPromotionsEntity_cost_state::OAIPromotionsEntity_cost_state(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPromotionsEntity_cost_state::OAIPromotionsEntity_cost_state() {
    this->initializeModel();
}

OAIPromotionsEntity_cost_state::~OAIPromotionsEntity_cost_state() {}

void OAIPromotionsEntity_cost_state::initializeModel() {
...
void OAIPromotionsEntity_cost_state::fromJson(QString jsonString) {
...
void OAIPromotionsEntity_cost_state::fromJsonObject(QJsonObject json) {
...
QString OAIPromotionsEntity_cost_state::asJson() const {
...
QJsonObject OAIPromotionsEntity_cost_state::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIPromotionsEntity_cost_state::getId() const {
    return m_id;
}
void OAIPromotionsEntity_cost_state::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPromotionsEntity_cost_state::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPromotionsEntity_cost_state::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPromotionsEntity_cost_state::getLabel() const {
    return m_label;
}
void OAIPromotionsEntity_cost_state::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPromotionsEntity_cost_state::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPromotionsEntity_cost_state::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIPromotionsEntity_cost_state::isSet() const {
...
bool OAIPromotionsEntity_cost_state::isValid() const {
