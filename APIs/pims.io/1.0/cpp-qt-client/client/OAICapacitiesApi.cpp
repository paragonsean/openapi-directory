...
void OAICapacitiesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("fetchAllEventsCapacities", defaultConf);
    _serverIndices.insert("fetchAllEventsCapacities", 0);
    _serverConfigs.insert("fetchOneEventCapacity", defaultConf);
    _serverIndices.insert("fetchOneEventCapacity", 0);
}
...
void OAICapacitiesApi::fetchAllEventsCapacities(const qint32 &event_id, const ::OpenAPI::OptionalParam<bool> &show_ignored, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["fetchAllEventsCapacities"][_serverIndices.value("fetchAllEventsCapacities")].URL()+"/events/{event_id}/capacities");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICapacitiesApi::fetchAllEventsCapacitiesCallback);
...
void OAICapacitiesApi::fetchAllEventsCapacitiesCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIEventsCapacitiesEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIEventsCapacitiesEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllEventsCapacitiesSignal(output);
        Q_EMIT fetchAllEventsCapacitiesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllEventsCapacitiesSignalE(output, error_type, error_str);
        Q_EMIT fetchAllEventsCapacitiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllEventsCapacitiesSignalError(output, error_type, error_str);
        Q_EMIT fetchAllEventsCapacitiesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICapacitiesApi::fetchOneEventCapacity(const qint32 &event_id, const qint32 &capacity_id, const ::OpenAPI::OptionalParam<bool> &show_ignored) {
    QString fullPath = QString(_serverConfigs["fetchOneEventCapacity"][_serverIndices.value("fetchOneEventCapacity")].URL()+"/events/{event_id}/capacities/{capacity_id}");
    ...
    {
        QString capacity_idPathParam("{");
        capacity_idPathParam.append("capacity_id").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "capacity_id", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"capacity_id"+pathSuffix : pathPrefix;
        fullPath.replace(capacity_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(capacity_id)));
    }
    QString queryPrefix, querySuffix, queryDelimiter, queryStyle;
    if (show_ignored.hasValue())
    {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICapacitiesApi::fetchOneEventCapacityCallback);
    connect(this, &OAICapacitiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICapacitiesApi::fetchOneEventCapacityCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEventsCapacitiesEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOneEventCapacitySignal(output);
        Q_EMIT fetchOneEventCapacitySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOneEventCapacitySignalE(output, error_type, error_str);
        Q_EMIT fetchOneEventCapacitySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOneEventCapacitySignalError(output, error_type, error_str);
        Q_EMIT fetchOneEventCapacitySignalErrorFull(worker, error_type, error_str);
    }
}
