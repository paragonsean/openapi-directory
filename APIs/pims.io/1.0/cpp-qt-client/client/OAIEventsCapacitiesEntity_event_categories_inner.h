...
/*
 * OAIEventsCapacitiesEntity_event_categories_inner.h
 *
 * 
 */

#ifndef OAIEventsCapacitiesEntity_event_categories_inner_H
#define OAIEventsCapacitiesEntity_event_categories_inner_H
...
class OAIEventsCapacitiesEntity_event_categories_inner : public OAIObject {
public:
    OAIEventsCapacitiesEntity_event_categories_inner();
    OAIEventsCapacitiesEntity_event_categories_inner(QString json);
    ~OAIEventsCapacitiesEntity_event_categories_inner() override;
    ...
    qint32 getComps() const;
    void setComps(const qint32 &comps);
    bool is_comps_Set() const;
    bool is_comps_Valid() const;

    qint32 getHolds() const;
    void setHolds(const qint32 &holds);
    ...
    qint32 getSellableCapacity() const;
    void setSellableCapacity(const qint32 &sellable_capacity);
    bool is_sellable_capacity_Set() const;
    bool is_sellable_capacity_Valid() const;

    qint32 getTotalCapacity() const;
    void setTotalCapacity(const qint32 &total_capacity);
...
private:
    ...
    qint32 m_sellable_capacity;
    bool m_sellable_capacity_isSet;
    bool m_sellable_capacity_isValid;

    qint32 m_total_capacity;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsCapacitiesEntity_event_categories_inner)

#endif // OAIEventsCapacitiesEntity_event_categories_inner_H
