...
OAISeriesEntity::OAISeriesEntity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISeriesEntity::OAISeriesEntity() {
    this->initializeModel();
}

OAISeriesEntity::~OAISeriesEntity() {}

void OAISeriesEntity::initializeModel() {
...
void OAISeriesEntity::fromJson(QString jsonString) {
...
void OAISeriesEntity::fromJsonObject(QJsonObject json) {
...
QString OAISeriesEntity::asJson() const {
...
QJsonObject OAISeriesEntity::asJsonObject() const {
    QJsonObject obj;
    if (m_contract.isSet()) {
...
OAISeriesEntity_contract OAISeriesEntity::getContract() const {
    return m_contract;
}
void OAISeriesEntity::setContract(const OAISeriesEntity_contract &contract) {
    m_contract = contract;
    m_contract_isSet = true;
}

bool OAISeriesEntity::is_contract_Set() const{
    return m_contract_isSet;
}

bool OAISeriesEntity::is_contract_Valid() const{
    return m_contract_isValid;
}

qint32 OAISeriesEntity::getCostingCapacity() const {
    return m_costing_capacity;
}
void OAISeriesEntity::setCostingCapacity(const qint32 &costing_capacity) {
    m_costing_capacity = costing_capacity;
    m_costing_capacity_isSet = true;
}

bool OAISeriesEntity::is_costing_capacity_Set() const{
    return m_costing_capacity_isSet;
}

bool OAISeriesEntity::is_costing_capacity_Valid() const{
    return m_costing_capacity_isValid;
}

qint64 OAISeriesEntity::getCreationTimestamp() const {
    return m_creation_timestamp;
}
void OAISeriesEntity::setCreationTimestamp(const qint64 &creation_timestamp) {
    m_creation_timestamp = creation_timestamp;
    m_creation_timestamp_isSet = true;
}

bool OAISeriesEntity::is_creation_timestamp_Set() const{
    return m_creation_timestamp_isSet;
}

bool OAISeriesEntity::is_creation_timestamp_Valid() const{
    return m_creation_timestamp_isValid;
}

QDate OAISeriesEntity::getFirstDate() const {
    return m_first_date;
}
void OAISeriesEntity::setFirstDate(const QDate &first_date) {
    m_first_date = first_date;
    m_first_date_isSet = true;
}

bool OAISeriesEntity::is_first_date_Set() const{
    return m_first_date_isSet;
}

bool OAISeriesEntity::is_first_date_Valid() const{
    return m_first_date_isValid;
}

qint32 OAISeriesEntity::getId() const {
    return m_id;
}
void OAISeriesEntity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISeriesEntity::is_id_Set() const{
    return m_id_isSet;
}

bool OAISeriesEntity::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISeriesEntity::getLabel() const {
    return m_label;
}
void OAISeriesEntity::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAISeriesEntity::is_label_Set() const{
    return m_label_isSet;
}

bool OAISeriesEntity::is_label_Valid() const{
    return m_label_isValid;
}

QDate OAISeriesEntity::getLastDate() const {
    return m_last_date;
}
void OAISeriesEntity::setLastDate(const QDate &last_date) {
    m_last_date = last_date;
    m_last_date_isSet = true;
}

bool OAISeriesEntity::is_last_date_Set() const{
    return m_last_date_isSet;
}

bool OAISeriesEntity::is_last_date_Valid() const{
    return m_last_date_isValid;
}

qint64 OAISeriesEntity::getLastUpdateTimestamp() const {
    return m_last_update_timestamp;
}
void OAISeriesEntity::setLastUpdateTimestamp(const qint64 &last_update_timestamp) {
    m_last_update_timestamp = last_update_timestamp;
    m_last_update_timestamp_isSet = true;
}

bool OAISeriesEntity::is_last_update_timestamp_Set() const{
    return m_last_update_timestamp_isSet;
}

bool OAISeriesEntity::is_last_update_timestamp_Valid() const{
    return m_last_update_timestamp_isValid;
}

OAISeriesEntity_type OAISeriesEntity::getType() const {
    return m_type;
}
void OAISeriesEntity::setType(const OAISeriesEntity_type &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISeriesEntity::is_type_Set() const{
    return m_type_isSet;
}

bool OAISeriesEntity::is_type_Valid() const{
    return m_type_isValid;
}

OAIVenuesEntity OAISeriesEntity::getVenue() const {
    return m_venue;
}
void OAISeriesEntity::setVenue(const OAIVenuesEntity &venue) {
    m_venue = venue;
    m_venue_isSet = true;
}

bool OAISeriesEntity::is_venue_Set() const{
    return m_venue_isSet;
}

bool OAISeriesEntity::is_venue_Valid() const{
    return m_venue_isValid;
}

bool OAISeriesEntity::isSet() const {
...
bool OAISeriesEntity::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_creation_timestamp_isValid && m_first_date_isValid && m_id_isValid && m_label_isValid && m_last_date_isValid && m_last_update_timestamp_isValid && m_type_isValid && true;
}
