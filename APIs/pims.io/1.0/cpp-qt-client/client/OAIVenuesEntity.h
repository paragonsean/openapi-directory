...
#ifndef OAIVenuesEntity_H
#define OAIVenuesEntity_H

#include <QJsonObject>

#include "OAIVenuesEntity_type.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIVenuesEntity_type;

class OAIVenuesEntity : public OAIObject {
public:
    OAIVenuesEntity();
    OAIVenuesEntity(QString json);
    ~OAIVenuesEntity() override;
    ...
    QList<QString> getAlternativeLabels() const;
    void setAlternativeLabels(const QList<QString> &alternative_labels);
    bool is_alternative_labels_Set() const;
    bool is_alternative_labels_Valid() const;
    ...
    QString getFirstAddress() const;
    void setFirstAddress(const QString &first_address);
    bool is_first_address_Set() const;
    bool is_first_address_Valid() const;
    ...
    QString getMajorCity() const;
    void setMajorCity(const QString &major_city);
    bool is_major_city_Set() const;
    bool is_major_city_Valid() const;

    QString getSecondAddress() const;
    void setSecondAddress(const QString &second_address);
    bool is_second_address_Set() const;
    bool is_second_address_Valid() const;

    OAIVenuesEntity_type getType() const;
    void setType(const OAIVenuesEntity_type &type);
...
private:
    ...
    QList<QString> m_alternative_labels;
    bool m_alternative_labels_isSet;
    bool m_alternative_labels_isValid;
    ...
    bool m_first_address_isSet;
    bool m_first_address_isValid;
    ...
    QString m_major_city;
    bool m_major_city_isSet;
    bool m_major_city_isValid;

    QString m_second_address;
    bool m_second_address_isSet;
    bool m_second_address_isValid;

    OAIVenuesEntity_type m_type;
    bool m_type_isSet;
    bool m_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVenuesEntity)

#endif // OAIVenuesEntity_H
