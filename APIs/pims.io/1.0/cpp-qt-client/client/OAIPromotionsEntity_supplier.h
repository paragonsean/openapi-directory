...
/*
 * OAIPromotionsEntity_supplier.h
 *
 * Supplier of the promotion.
 */

#ifndef OAIPromotionsEntity_supplier_H
#define OAIPromotionsEntity_supplier_H
...
class OAIPromotionsEntity_supplier : public OAIObject {
public:
    OAIPromotionsEntity_supplier();
    OAIPromotionsEntity_supplier(QString json);
    ~OAIPromotionsEntity_supplier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPromotionsEntity_supplier)

#endif // OAIPromotionsEntity_supplier_H
