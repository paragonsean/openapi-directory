...
OAIPromotionsEntity_type::OAIPromotionsEntity_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPromotionsEntity_type::OAIPromotionsEntity_type() {
    this->initializeModel();
}

OAIPromotionsEntity_type::~OAIPromotionsEntity_type() {}

void OAIPromotionsEntity_type::initializeModel() {
...
void OAIPromotionsEntity_type::fromJson(QString jsonString) {
...
void OAIPromotionsEntity_type::fromJsonObject(QJsonObject json) {
...
QString OAIPromotionsEntity_type::asJson() const {
...
QJsonObject OAIPromotionsEntity_type::asJsonObject() const {
    QJsonObject obj;
    if (m_family.isSet()) {
...
OAIPromotionsEntity_type_family OAIPromotionsEntity_type::getFamily() const {
    return m_family;
}
void OAIPromotionsEntity_type::setFamily(const OAIPromotionsEntity_type_family &family) {
    m_family = family;
    m_family_isSet = true;
}

bool OAIPromotionsEntity_type::is_family_Set() const{
    return m_family_isSet;
}

bool OAIPromotionsEntity_type::is_family_Valid() const{
    return m_family_isValid;
}

QString OAIPromotionsEntity_type::getId() const {
    return m_id;
}
void OAIPromotionsEntity_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPromotionsEntity_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPromotionsEntity_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPromotionsEntity_type::getLabel() const {
    return m_label;
}
void OAIPromotionsEntity_type::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPromotionsEntity_type::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPromotionsEntity_type::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIPromotionsEntity_type::isSet() const {
...
bool OAIPromotionsEntity_type::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_family_isValid && m_id_isValid && m_label_isValid && true;
}
