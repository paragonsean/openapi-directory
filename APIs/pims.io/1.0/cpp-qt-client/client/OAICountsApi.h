...
public:
    ...
    * @param[in]  show_not_approved bool [optional]
    * @param[in]  sort QString [optional]
    * @param[in]  page_size qint32 [optional]
    */
    virtual void fetchAllDetailedTicketCounts(const qint32 &event_id, const ::OpenAPI::OptionalParam<QDate> &from_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QDate> &to_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<bool> &show_ignored = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &show_not_approved = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  page_size qint32 [optional]
    */
    virtual void fetchAllTicketCounts(const qint32 &event_id, const ::OpenAPI::OptionalParam<QDate> &from_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QDate> &to_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<bool> &show_ignored = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &show_not_approved = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  event_id qint32 [required]
    * @param[in]  ticket_count_id qint32 [required]
    * @param[in]  show_ignored bool [optional]
    */
    virtual void fetchOneDetailedTicketCount(const qint32 &event_id, const qint32 &ticket_count_id, const ::OpenAPI::OptionalParam<bool> &show_ignored = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  show_ignored bool [optional]
    */
    virtual void fetchOneTicketCount(const qint32 &event_id, const qint32 &ticket_count_id, const ::OpenAPI::OptionalParam<bool> &show_ignored = ::OpenAPI::OptionalParam<bool>());
...
private:
    ...
    void fetchAllDetailedTicketCountsCallback(OAIHttpRequestWorker *worker);
    void fetchAllTicketCountsCallback(OAIHttpRequestWorker *worker);
    void fetchOneDetailedTicketCountCallback(OAIHttpRequestWorker *worker);
    void fetchOneTicketCountCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAllDetailedTicketCountsSignal(QList<OAITicketCountsDetailedEntity> summary);
    void fetchAllTicketCountsSignal(QList<OAITicketCountsEntity> summary);
    void fetchOneDetailedTicketCountSignal(OAITicketCountsDetailedEntity summary);
    void fetchOneTicketCountSignal(OAITicketCountsEntity summary);


    void fetchAllDetailedTicketCountsSignalFull(OAIHttpRequestWorker *worker, QList<OAITicketCountsDetailedEntity> summary);
    void fetchAllTicketCountsSignalFull(OAIHttpRequestWorker *worker, QList<OAITicketCountsEntity> summary);
    void fetchOneDetailedTicketCountSignalFull(OAIHttpRequestWorker *worker, OAITicketCountsDetailedEntity summary);
    void fetchOneTicketCountSignalFull(OAIHttpRequestWorker *worker, OAITicketCountsEntity summary);

    Q_DECL_DEPRECATED_X("Use fetchAllDetailedTicketCountsSignalError() instead")
    void fetchAllDetailedTicketCountsSignalE(QList<OAITicketCountsDetailedEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllDetailedTicketCountsSignalError(QList<OAITicketCountsDetailedEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllTicketCountsSignalError() instead")
    void fetchAllTicketCountsSignalE(QList<OAITicketCountsEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllTicketCountsSignalError(QList<OAITicketCountsEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneDetailedTicketCountSignalError() instead")
    void fetchOneDetailedTicketCountSignalE(OAITicketCountsDetailedEntity summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneDetailedTicketCountSignalError(OAITicketCountsDetailedEntity summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneTicketCountSignalError() instead")
    void fetchOneTicketCountSignalE(OAITicketCountsEntity summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneTicketCountSignalError(OAITicketCountsEntity summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAllDetailedTicketCountsSignalErrorFull() instead")
    void fetchAllDetailedTicketCountsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllDetailedTicketCountsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllTicketCountsSignalErrorFull() instead")
    void fetchAllTicketCountsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllTicketCountsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneDetailedTicketCountSignalErrorFull() instead")
    void fetchOneDetailedTicketCountSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneDetailedTicketCountSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneTicketCountSignalErrorFull() instead")
    void fetchOneTicketCountSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneTicketCountSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
