...
/*
 * OAITicketCountsEntity.h
 *
 * 
 */

#ifndef OAITicketCountsEntity_H
#define OAITicketCountsEntity_H
...
class OAITicketCountsEntity : public OAIObject {
public:
    OAITicketCountsEntity();
    OAITicketCountsEntity(QString json);
    ~OAITicketCountsEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITicketCountsEntity)

#endif // OAITicketCountsEntity_H
