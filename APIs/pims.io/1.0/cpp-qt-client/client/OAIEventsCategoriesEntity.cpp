...
#include "OAIEventsCategoriesEntity.h"
...
OAIEventsCategoriesEntity::OAIEventsCategoriesEntity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventsCategoriesEntity::OAIEventsCategoriesEntity() {
    this->initializeModel();
}

OAIEventsCategoriesEntity::~OAIEventsCategoriesEntity() {}

void OAIEventsCategoriesEntity::initializeModel() {

    m_category_isSet = false;
    m_category_isValid = false;

    m_event_price_ranges_isSet = false;
    m_event_price_ranges_isValid = false;
...
void OAIEventsCategoriesEntity::fromJson(QString jsonString) {
...
void OAIEventsCategoriesEntity::fromJsonObject(QJsonObject json) {

    m_category_isValid = ::OpenAPI::fromJsonValue(m_category, json[QString("category")]);
    m_category_isSet = !json[QString("category")].isNull() && m_category_isValid;

    m_event_price_ranges_isValid = ::OpenAPI::fromJsonValue(m_event_price_ranges, json[QString("event_price_ranges")]);
    m_event_price_ranges_isSet = !json[QString("event_price_ranges")].isNull() && m_event_price_ranges_isValid;
...
QString OAIEventsCategoriesEntity::asJson() const {
...
QJsonObject OAIEventsCategoriesEntity::asJsonObject() const {
    QJsonObject obj;
    if (m_category.isSet()) {
        obj.insert(QString("category"), ::OpenAPI::toJsonValue(m_category));
    }
    if (m_event_price_ranges.size() > 0) {
        obj.insert(QString("event_price_ranges"), ::OpenAPI::toJsonValue(m_event_price_ranges));
    }
    if (m_id_isSet) {
...
OAICategoriesEntity OAIEventsCategoriesEntity::getCategory() const {
    return m_category;
}
void OAIEventsCategoriesEntity::setCategory(const OAICategoriesEntity &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIEventsCategoriesEntity::is_category_Set() const{
    return m_category_isSet;
}

bool OAIEventsCategoriesEntity::is_category_Valid() const{
    return m_category_isValid;
}

QList<OAIEventsCategoriesEntity_event_price_ranges_inner> OAIEventsCategoriesEntity::getEventPriceRanges() const {
    return m_event_price_ranges;
}
void OAIEventsCategoriesEntity::setEventPriceRanges(const QList<OAIEventsCategoriesEntity_event_price_ranges_inner> &event_price_ranges) {
    m_event_price_ranges = event_price_ranges;
    m_event_price_ranges_isSet = true;
}

bool OAIEventsCategoriesEntity::is_event_price_ranges_Set() const{
    return m_event_price_ranges_isSet;
}

bool OAIEventsCategoriesEntity::is_event_price_ranges_Valid() const{
    return m_event_price_ranges_isValid;
}

qint32 OAIEventsCategoriesEntity::getId() const {
    return m_id;
}
void OAIEventsCategoriesEntity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEventsCategoriesEntity::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEventsCategoriesEntity::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEventsCategoriesEntity::isIgnored() const {
    return m_ignored;
}
void OAIEventsCategoriesEntity::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAIEventsCategoriesEntity::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAIEventsCategoriesEntity::is_ignored_Valid() const{
    return m_ignored_isValid;
}

bool OAIEventsCategoriesEntity::isSet() const {
...
bool OAIEventsCategoriesEntity::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_category_isValid && m_id_isValid && m_ignored_isValid && true;
}
