...
#include "OAIPromotionsEntity_cost_type.h"
...
OAIPromotionsEntity_cost_type::OAIPromotionsEntity_cost_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPromotionsEntity_cost_type::OAIPromotionsEntity_cost_type() {
    this->initializeModel();
}

OAIPromotionsEntity_cost_type::~OAIPromotionsEntity_cost_type() {}

void OAIPromotionsEntity_cost_type::initializeModel() {
...
void OAIPromotionsEntity_cost_type::fromJson(QString jsonString) {
...
void OAIPromotionsEntity_cost_type::fromJsonObject(QJsonObject json) {
...
QString OAIPromotionsEntity_cost_type::asJson() const {
...
QJsonObject OAIPromotionsEntity_cost_type::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIPromotionsEntity_cost_type::getId() const {
    return m_id;
}
void OAIPromotionsEntity_cost_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPromotionsEntity_cost_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPromotionsEntity_cost_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPromotionsEntity_cost_type::getLabel() const {
    return m_label;
}
void OAIPromotionsEntity_cost_type::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPromotionsEntity_cost_type::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPromotionsEntity_cost_type::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIPromotionsEntity_cost_type::isSet() const {
...
bool OAIPromotionsEntity_cost_type::isValid() const {
