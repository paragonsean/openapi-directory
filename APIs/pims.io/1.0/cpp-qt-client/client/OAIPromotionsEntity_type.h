...
/*
 * OAIPromotionsEntity_type.h
 *
 * Type of the promotion.
 */

#ifndef OAIPromotionsEntity_type_H
#define OAIPromotionsEntity_type_H
...
namespace OpenAPI {
class OAIPromotionsEntity_type_family;

class OAIPromotionsEntity_type : public OAIObject {
public:
    OAIPromotionsEntity_type();
    OAIPromotionsEntity_type(QString json);
    ~OAIPromotionsEntity_type() override;
    ...
    OAIPromotionsEntity_type_family getFamily() const;
    void setFamily(const OAIPromotionsEntity_type_family &family);
...
private:
    ...
    OAIPromotionsEntity_type_family m_family;
    bool m_family_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPromotionsEntity_type)

#endif // OAIPromotionsEntity_type_H
