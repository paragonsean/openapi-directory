...
/*
 * OAIPromotionsEntity_cost_state.h
 *
 * State of the promotion cost. *This object may be omitted according to the customer configuration.*
 */

#ifndef OAIPromotionsEntity_cost_state_H
#define OAIPromotionsEntity_cost_state_H
...
class OAIPromotionsEntity_cost_state : public OAIObject {
public:
    OAIPromotionsEntity_cost_state();
    OAIPromotionsEntity_cost_state(QString json);
    ~OAIPromotionsEntity_cost_state() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPromotionsEntity_cost_state)

#endif // OAIPromotionsEntity_cost_state_H
