...
/*
 * OAIPriceRangesEntity.h
 *
 * 
 */

#ifndef OAIPriceRangesEntity_H
#define OAIPriceRangesEntity_H
...
class OAIPriceRangesEntity : public OAIObject {
public:
    OAIPriceRangesEntity();
    OAIPriceRangesEntity(QString json);
    ~OAIPriceRangesEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPriceRangesEntity)

#endif // OAIPriceRangesEntity_H
