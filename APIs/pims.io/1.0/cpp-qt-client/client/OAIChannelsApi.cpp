...
void OAIChannelsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("fetchAllChannels", defaultConf);
    _serverIndices.insert("fetchAllChannels", 0);
    _serverConfigs.insert("fetchAllEventsChannels", defaultConf);
    _serverIndices.insert("fetchAllEventsChannels", 0);
    _serverConfigs.insert("fetchOneChannel", defaultConf);
    _serverIndices.insert("fetchOneChannel", 0);
    _serverConfigs.insert("fetchOneEventChannel", defaultConf);
    _serverIndices.insert("fetchOneEventChannel", 0);
}
...
void OAIChannelsApi::fetchAllChannels(const ::OpenAPI::OptionalParam<QString> &label, const ::OpenAPI::OptionalParam<bool> &show_ignored, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllChannels"][_serverIndices.value("fetchAllChannels")].URL()+"/channels");
    ...
    if (show_ignored.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "show_ignored", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("show_ignored")).append(querySuffix).append(QUrl::toPercentEncoding(show_ignored.stringValue()));
    }
    if (sort.hasValue())
    {
        queryStyle = "";
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIChannelsApi::fetchAllChannelsCallback);
...
void OAIChannelsApi::fetchAllChannelsCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIChannelsEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIChannelsEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllChannelsSignal(output);
        Q_EMIT fetchAllChannelsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllChannelsSignalE(output, error_type, error_str);
        Q_EMIT fetchAllChannelsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllChannelsSignalError(output, error_type, error_str);
        Q_EMIT fetchAllChannelsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIChannelsApi::fetchAllEventsChannels(const qint32 &event_id, const ::OpenAPI::OptionalParam<bool> &show_ignored, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["fetchAllEventsChannels"][_serverIndices.value("fetchAllEventsChannels")].URL()+"/events/{event_id}/channels");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIChannelsApi::fetchAllEventsChannelsCallback);
    connect(this, &OAIChannelsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIChannelsApi::fetchAllEventsChannelsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIEventsChannelsEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIEventsChannelsEntity val;
        ::OpenAPI::fromJsonValue(val, obj);
        output.append(val);
    }
    worker->deleteLater();
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllEventsChannelsSignal(output);
        Q_EMIT fetchAllEventsChannelsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllEventsChannelsSignalE(output, error_type, error_str);
        Q_EMIT fetchAllEventsChannelsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllEventsChannelsSignalError(output, error_type, error_str);
        Q_EMIT fetchAllEventsChannelsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIChannelsApi::fetchOneChannel(const qint32 &channel_id, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchOneChannel"][_serverIndices.value("fetchOneChannel")].URL()+"/channels/{channel_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIChannelsApi::fetchOneChannelCallback);
    connect(this, &OAIChannelsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIChannelsApi::fetchOneChannelCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIChannelsEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOneChannelSignal(output);
        Q_EMIT fetchOneChannelSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOneChannelSignalE(output, error_type, error_str);
        Q_EMIT fetchOneChannelSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOneChannelSignalError(output, error_type, error_str);
        Q_EMIT fetchOneChannelSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIChannelsApi::fetchOneEventChannel(const qint32 &event_id, const qint32 &channel_id) {
    QString fullPath = QString(_serverConfigs["fetchOneEventChannel"][_serverIndices.value("fetchOneEventChannel")].URL()+"/events/{event_id}/channels/{channel_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIChannelsApi::fetchOneEventChannelCallback);
    connect(this, &OAIChannelsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIChannelsApi::fetchOneEventChannelCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEventsChannelsEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOneEventChannelSignal(output);
        Q_EMIT fetchOneEventChannelSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOneEventChannelSignalE(output, error_type, error_str);
        Q_EMIT fetchOneEventChannelSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOneEventChannelSignalError(output, error_type, error_str);
        Q_EMIT fetchOneEventChannelSignalErrorFull(worker, error_type, error_str);
    }
}
