...
#include "OAISeriesEntity_contract.h"
...
OAISeriesEntity_contract::OAISeriesEntity_contract(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISeriesEntity_contract::OAISeriesEntity_contract() {
    this->initializeModel();
}

OAISeriesEntity_contract::~OAISeriesEntity_contract() {}

void OAISeriesEntity_contract::initializeModel() {
...
void OAISeriesEntity_contract::fromJson(QString jsonString) {
...
void OAISeriesEntity_contract::fromJsonObject(QJsonObject json) {
...
QString OAISeriesEntity_contract::asJson() const {
...
QJsonObject OAISeriesEntity_contract::asJsonObject() const {
    QJsonObject obj;
    if (m_partner.isSet()) {
...
OAISeriesEntity_contract_partner OAISeriesEntity_contract::getPartner() const {
    return m_partner;
}
void OAISeriesEntity_contract::setPartner(const OAISeriesEntity_contract_partner &partner) {
    m_partner = partner;
    m_partner_isSet = true;
}

bool OAISeriesEntity_contract::is_partner_Set() const{
    return m_partner_isSet;
}

bool OAISeriesEntity_contract::is_partner_Valid() const{
    return m_partner_isValid;
}

OAISeriesEntity_contract_type OAISeriesEntity_contract::getType() const {
    return m_type;
}
void OAISeriesEntity_contract::setType(const OAISeriesEntity_contract_type &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISeriesEntity_contract::is_type_Set() const{
    return m_type_isSet;
}

bool OAISeriesEntity_contract::is_type_Valid() const{
    return m_type_isValid;
}

bool OAISeriesEntity_contract::isSet() const {
...
bool OAISeriesEntity_contract::isValid() const {
