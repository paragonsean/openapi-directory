...
OAIEventsCategoriesEntity_event_price_ranges_inner::OAIEventsCategoriesEntity_event_price_ranges_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventsCategoriesEntity_event_price_ranges_inner::OAIEventsCategoriesEntity_event_price_ranges_inner() {
    this->initializeModel();
}

OAIEventsCategoriesEntity_event_price_ranges_inner::~OAIEventsCategoriesEntity_event_price_ranges_inner() {}

void OAIEventsCategoriesEntity_event_price_ranges_inner::initializeModel() {
    ...
    m_public_price_isSet = false;
    m_public_price_isValid = false;
}

void OAIEventsCategoriesEntity_event_price_ranges_inner::fromJson(QString jsonString) {
...
void OAIEventsCategoriesEntity_event_price_ranges_inner::fromJsonObject(QJsonObject json) {
    ...
    m_public_price_isValid = ::OpenAPI::fromJsonValue(m_public_price, json[QString("public_price")]);
    m_public_price_isSet = !json[QString("public_price")].isNull() && m_public_price_isValid;
}

QString OAIEventsCategoriesEntity_event_price_ranges_inner::asJson() const {
...
QJsonObject OAIEventsCategoriesEntity_event_price_ranges_inner::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_public_price_isSet) {
        obj.insert(QString("public_price"), ::OpenAPI::toJsonValue(m_public_price));
    }
    return obj;
}

float OAIEventsCategoriesEntity_event_price_ranges_inner::getBasePrice() const {
    return m_base_price;
}
void OAIEventsCategoriesEntity_event_price_ranges_inner::setBasePrice(const float &base_price) {
    m_base_price = base_price;
    m_base_price_isSet = true;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_base_price_Set() const{
    return m_base_price_isSet;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_base_price_Valid() const{
    return m_base_price_isValid;
}

QString OAIEventsCategoriesEntity_event_price_ranges_inner::getCurrency() const {
    return m_currency;
}
void OAIEventsCategoriesEntity_event_price_ranges_inner::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_currency_Valid() const{
    return m_currency_isValid;
}

qint32 OAIEventsCategoriesEntity_event_price_ranges_inner::getId() const {
    return m_id;
}
void OAIEventsCategoriesEntity_event_price_ranges_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::isIgnored() const {
    return m_ignored;
}
void OAIEventsCategoriesEntity_event_price_ranges_inner::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_ignored_Valid() const{
    return m_ignored_isValid;
}

OAIPriceRangesEntity OAIEventsCategoriesEntity_event_price_ranges_inner::getPriceRange() const {
    return m_price_range;
}
void OAIEventsCategoriesEntity_event_price_ranges_inner::setPriceRange(const OAIPriceRangesEntity &price_range) {
    m_price_range = price_range;
    m_price_range_isSet = true;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_price_range_Set() const{
    return m_price_range_isSet;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_price_range_Valid() const{
    return m_price_range_isValid;
}

float OAIEventsCategoriesEntity_event_price_ranges_inner::getPublicPrice() const {
    return m_public_price;
}
void OAIEventsCategoriesEntity_event_price_ranges_inner::setPublicPrice(const float &public_price) {
    m_public_price = public_price;
    m_public_price_isSet = true;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_public_price_Set() const{
    return m_public_price_isSet;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::is_public_price_Valid() const{
    return m_public_price_isValid;
}

bool OAIEventsCategoriesEntity_event_price_ranges_inner::isSet() const {
...
bool OAIEventsCategoriesEntity_event_price_ranges_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_base_price_isValid && m_currency_isValid && m_id_isValid && m_price_range_isValid && m_public_price_isValid && true;
}
