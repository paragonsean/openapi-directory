...
/*
 * OAIVenuesEntity_type.h
 *
 * 
 */

#ifndef OAIVenuesEntity_type_H
#define OAIVenuesEntity_type_H
...
class OAIVenuesEntity_type : public OAIObject {
public:
    OAIVenuesEntity_type();
    OAIVenuesEntity_type(QString json);
    ~OAIVenuesEntity_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVenuesEntity_type)

#endif // OAIVenuesEntity_type_H
