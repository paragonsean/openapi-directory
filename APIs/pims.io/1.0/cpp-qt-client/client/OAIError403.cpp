...
QString OAIError403::getDetail() const {
    return m_detail;
}
void OAIError403::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIError403::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIError403::is_detail_Valid() const{
    return m_detail_isValid;
}

qint32 OAIError403::getStatus() const {
    return m_status;
}
void OAIError403::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIError403::is_status_Set() const{
    return m_status_isSet;
}

bool OAIError403::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIError403::getTitle() const {
    return m_title;
}
void OAIError403::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIError403::is_title_Set() const{
    return m_title_isSet;
}

bool OAIError403::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIError403::getType() const {
    return m_type;
}
void OAIError403::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIError403::is_type_Set() const{
    return m_type_isSet;
}

bool OAIError403::is_type_Valid() const{
