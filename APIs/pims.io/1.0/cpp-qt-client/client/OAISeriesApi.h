...
public:
    ...
    */
    virtual void fetchAllSeries(const ::OpenAPI::OptionalParam<QString> &label = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QDate> &from_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QDate> &to_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QString> &type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  series_id qint32 [required]
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchOneSeries(const qint32 &series_id, const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void fetchAllSeriesCallback(OAIHttpRequestWorker *worker);
    void fetchOneSeriesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAllSeriesSignal(QList<OAISeriesEntity> summary);
    void fetchOneSeriesSignal(OAISeriesEntity summary);


    void fetchAllSeriesSignalFull(OAIHttpRequestWorker *worker, QList<OAISeriesEntity> summary);
    void fetchOneSeriesSignalFull(OAIHttpRequestWorker *worker, OAISeriesEntity summary);

    Q_DECL_DEPRECATED_X("Use fetchAllSeriesSignalError() instead")
    void fetchAllSeriesSignalE(QList<OAISeriesEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllSeriesSignalError(QList<OAISeriesEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneSeriesSignalError() instead")
    void fetchOneSeriesSignalE(OAISeriesEntity summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneSeriesSignalError(OAISeriesEntity summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAllSeriesSignalErrorFull() instead")
    void fetchAllSeriesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllSeriesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneSeriesSignalErrorFull() instead")
    void fetchOneSeriesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneSeriesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
