...
/*
 * OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner.h
 *
 * 
 */

#ifndef OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner_H
#define OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner_H
...
class OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner : public OAIObject {
public:
    OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner();
    OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner(QString json);
    ~OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner() override;
    ...
    void setGross(const float &gross);
    ...
    qint32 getReservations() const;
    void setReservations(const qint32 &reservations);
    bool is_reservations_Set() const;
    bool is_reservations_Valid() const;

    qint32 getSales() const;
    void setSales(const qint32 &sales);
...
Q_DECLARE_METATYPE(OpenAPI::OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner)

#endif // OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner_H
