...
#ifndef OAI_OAIPriceRangesApi_H
#define OAI_OAIPriceRangesApi_H
...
class OAIPriceRangesApi : public QObject {
    Q_OBJECT

public:
    OAIPriceRangesApi(const int timeOut = 0);
    ~OAIPriceRangesApi();
    ...
    */
    virtual void fetchAllPriceRanges(const ::OpenAPI::OptionalParam<QString> &label = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &show_ignored = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  price_range_id qint32 [required]
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchOnePriceRange(const qint32 &price_range_id, const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void fetchAllPriceRangesCallback(OAIHttpRequestWorker *worker);
    void fetchOnePriceRangeCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAllPriceRangesSignal(QList<OAIPriceRangesEntity> summary);
    void fetchOnePriceRangeSignal(OAIVenuesEntity summary);


    void fetchAllPriceRangesSignalFull(OAIHttpRequestWorker *worker, QList<OAIPriceRangesEntity> summary);
    void fetchOnePriceRangeSignalFull(OAIHttpRequestWorker *worker, OAIVenuesEntity summary);

    Q_DECL_DEPRECATED_X("Use fetchAllPriceRangesSignalError() instead")
    void fetchAllPriceRangesSignalE(QList<OAIPriceRangesEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllPriceRangesSignalError(QList<OAIPriceRangesEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOnePriceRangeSignalError() instead")
    void fetchOnePriceRangeSignalE(OAIVenuesEntity summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOnePriceRangeSignalError(OAIVenuesEntity summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAllPriceRangesSignalErrorFull() instead")
    void fetchAllPriceRangesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllPriceRangesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOnePriceRangeSignalErrorFull() instead")
    void fetchOnePriceRangeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOnePriceRangeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
