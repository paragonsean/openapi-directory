...
void OAIEventsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("fetchAllEvents", defaultConf);
    _serverIndices.insert("fetchAllEvents", 0);
    _serverConfigs.insert("fetchAllSeriesEvents", defaultConf);
    _serverIndices.insert("fetchAllSeriesEvents", 0);
    _serverConfigs.insert("fetchAllVenuesEvents", defaultConf);
    _serverIndices.insert("fetchAllVenuesEvents", 0);
    _serverConfigs.insert("fetchOneEvent", defaultConf);
    _serverIndices.insert("fetchOneEvent", 0);
}
...
void OAIEventsApi::fetchAllEvents(const ::OpenAPI::OptionalParam<QString> &label, const ::OpenAPI::OptionalParam<QDate> &from_datetime, const ::OpenAPI::OptionalParam<QDate> &to_datetime, const ::OpenAPI::OptionalParam<QString> &city, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllEvents"][_serverIndices.value("fetchAllEvents")].URL()+"/events");
    ...
    if (from_datetime.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("from_datetime")).append(querySuffix).append(QUrl::toPercentEncoding(from_datetime.stringValue()));
    }
    if (to_datetime.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("to_datetime")).append(querySuffix).append(QUrl::toPercentEncoding(to_datetime.stringValue()));
    }
    if (city.hasValue())
    {
        queryStyle = "";
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::fetchAllEventsCallback);
...
void OAIEventsApi::fetchAllEventsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllEventsSignal(output);
        Q_EMIT fetchAllEventsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllEventsSignalE(output, error_type, error_str);
        Q_EMIT fetchAllEventsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllEventsSignalError(output, error_type, error_str);
        Q_EMIT fetchAllEventsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEventsApi::fetchAllSeriesEvents(const qint32 &series_id, const ::OpenAPI::OptionalParam<QDate> &from_datetime, const ::OpenAPI::OptionalParam<QDate> &to_datetime, const ::OpenAPI::OptionalParam<QString> &city, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllSeriesEvents"][_serverIndices.value("fetchAllSeriesEvents")].URL()+"/series/{series_id}/events");
    ...
    
    {
        ...
        series_idPathParam.append("series_id").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "series_id", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"series_id"+pathSuffix : pathPrefix;
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::fetchAllSeriesEventsCallback);
    connect(this, &OAIEventsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEventsApi::fetchAllSeriesEventsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllSeriesEventsSignal(output);
        Q_EMIT fetchAllSeriesEventsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllSeriesEventsSignalE(output, error_type, error_str);
        Q_EMIT fetchAllSeriesEventsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllSeriesEventsSignalError(output, error_type, error_str);
        Q_EMIT fetchAllSeriesEventsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEventsApi::fetchAllVenuesEvents(const qint32 &venue_id, const ::OpenAPI::OptionalParam<QDate> &from_datetime, const ::OpenAPI::OptionalParam<QDate> &to_datetime, const ::OpenAPI::OptionalParam<QString> &city, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllVenuesEvents"][_serverIndices.value("fetchAllVenuesEvents")].URL()+"/venues/{venue_id}/events");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::fetchAllVenuesEventsCallback);
    connect(this, &OAIEventsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEventsApi::fetchAllVenuesEventsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllVenuesEventsSignal(output);
        Q_EMIT fetchAllVenuesEventsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllVenuesEventsSignalE(output, error_type, error_str);
        Q_EMIT fetchAllVenuesEventsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllVenuesEventsSignalError(output, error_type, error_str);
        Q_EMIT fetchAllVenuesEventsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEventsApi::fetchOneEvent(const qint32 &event_id, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchOneEvent"][_serverIndices.value("fetchOneEvent")].URL()+"/events/{event_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEventsApi::fetchOneEventCallback);
    connect(this, &OAIEventsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEventsApi::fetchOneEventCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEventsEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOneEventSignal(output);
        Q_EMIT fetchOneEventSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOneEventSignalE(output, error_type, error_str);
        Q_EMIT fetchOneEventSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOneEventSignalError(output, error_type, error_str);
        Q_EMIT fetchOneEventSignalErrorFull(worker, error_type, error_str);
    }
}
