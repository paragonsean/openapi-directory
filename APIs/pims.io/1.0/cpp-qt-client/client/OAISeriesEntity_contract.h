...
/*
 * OAISeriesEntity_contract.h
 *
 * Contract of the series.
 */

#ifndef OAISeriesEntity_contract_H
#define OAISeriesEntity_contract_H
...
namespace OpenAPI {
class OAISeriesEntity_contract_partner;
class OAISeriesEntity_contract_type;

class OAISeriesEntity_contract : public OAIObject {
public:
    OAISeriesEntity_contract();
    OAISeriesEntity_contract(QString json);
    ~OAISeriesEntity_contract() override;
    ...
    OAISeriesEntity_contract_partner getPartner() const;
    void setPartner(const OAISeriesEntity_contract_partner &partner);
    bool is_partner_Set() const;
    bool is_partner_Valid() const;

    OAISeriesEntity_contract_type getType() const;
    void setType(const OAISeriesEntity_contract_type &type);
...
private:
    ...
    OAISeriesEntity_contract_partner m_partner;
    bool m_partner_isSet;
    bool m_partner_isValid;

    OAISeriesEntity_contract_type m_type;
    bool m_type_isSet;
    bool m_type_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAISeriesEntity_contract)

#endif // OAISeriesEntity_contract_H
