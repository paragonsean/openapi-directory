...
/*
 * OAIEventsCategoriesEntity.h
 *
 * 
 */

#ifndef OAIEventsCategoriesEntity_H
#define OAIEventsCategoriesEntity_H

#include <QJsonObject>

#include "OAICategoriesEntity.h"
#include "OAIEventsCategoriesEntity_event_price_ranges_inner.h"
#include <QList>
...
namespace OpenAPI {
class OAICategoriesEntity;
class OAIEventsCategoriesEntity_event_price_ranges_inner;

class OAIEventsCategoriesEntity : public OAIObject {
public:
    OAIEventsCategoriesEntity();
    OAIEventsCategoriesEntity(QString json);
    ~OAIEventsCategoriesEntity() override;
    ...
    OAICategoriesEntity getCategory() const;
    void setCategory(const OAICategoriesEntity &category);
    bool is_category_Set() const;
    bool is_category_Valid() const;

    QList<OAIEventsCategoriesEntity_event_price_ranges_inner> getEventPriceRanges() const;
    void setEventPriceRanges(const QList<OAIEventsCategoriesEntity_event_price_ranges_inner> &event_price_ranges);
...
private:
    ...
    OAICategoriesEntity m_category;
    bool m_category_isSet;
    bool m_category_isValid;

    QList<OAIEventsCategoriesEntity_event_price_ranges_inner> m_event_price_ranges;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsCategoriesEntity)

#endif // OAIEventsCategoriesEntity_H
