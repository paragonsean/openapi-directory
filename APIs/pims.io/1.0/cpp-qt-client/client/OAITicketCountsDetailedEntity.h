...
/*
 * OAITicketCountsDetailedEntity.h
 *
 * 
 */

#ifndef OAITicketCountsDetailedEntity_H
#define OAITicketCountsDetailedEntity_H
...
namespace OpenAPI {
class OAITicketCountsDetailedEntity_event_channels_inner;

class OAITicketCountsDetailedEntity : public OAIObject {
public:
    OAITicketCountsDetailedEntity();
    OAITicketCountsDetailedEntity(QString json);
    ~OAITicketCountsDetailedEntity() override;
    ...
    QList<OAITicketCountsDetailedEntity_event_channels_inner> getEventChannels() const;
    void setEventChannels(const QList<OAITicketCountsDetailedEntity_event_channels_inner> &event_channels);
    bool is_event_channels_Set() const;
    bool is_event_channels_Valid() const;
...
private:
    ...
    QList<OAITicketCountsDetailedEntity_event_channels_inner> m_event_channels;
    bool m_event_channels_isSet;
    bool m_event_channels_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITicketCountsDetailedEntity)

#endif // OAITicketCountsDetailedEntity_H
