...
OAIEventsChannelsEntity::OAIEventsChannelsEntity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventsChannelsEntity::OAIEventsChannelsEntity() {
    this->initializeModel();
}

OAIEventsChannelsEntity::~OAIEventsChannelsEntity() {}

void OAIEventsChannelsEntity::initializeModel() {
...
void OAIEventsChannelsEntity::fromJson(QString jsonString) {
...
void OAIEventsChannelsEntity::fromJsonObject(QJsonObject json) {
...
QString OAIEventsChannelsEntity::asJson() const {
...
QJsonObject OAIEventsChannelsEntity::asJsonObject() const {
    QJsonObject obj;
    if (m_channel.isSet()) {
...
OAIChannelsEntity OAIEventsChannelsEntity::getChannel() const {
    return m_channel;
}
void OAIEventsChannelsEntity::setChannel(const OAIChannelsEntity &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAIEventsChannelsEntity::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAIEventsChannelsEntity::is_channel_Valid() const{
    return m_channel_isValid;
}

qint32 OAIEventsChannelsEntity::getId() const {
    return m_id;
}
void OAIEventsChannelsEntity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEventsChannelsEntity::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEventsChannelsEntity::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEventsChannelsEntity::isIgnored() const {
    return m_ignored;
}
void OAIEventsChannelsEntity::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAIEventsChannelsEntity::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAIEventsChannelsEntity::is_ignored_Valid() const{
    return m_ignored_isValid;
}

bool OAIEventsChannelsEntity::isSet() const {
...
bool OAIEventsChannelsEntity::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_channel_isValid && m_id_isValid && m_ignored_isValid && true;
}
