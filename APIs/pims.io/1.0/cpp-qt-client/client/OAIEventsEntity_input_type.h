...
/*
 * OAIEventsEntity_input_type.h
 *
 * Input type of the event.
 */

#ifndef OAIEventsEntity_input_type_H
#define OAIEventsEntity_input_type_H
...
class OAIEventsEntity_input_type : public OAIObject {
public:
    OAIEventsEntity_input_type();
    OAIEventsEntity_input_type(QString json);
    ~OAIEventsEntity_input_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsEntity_input_type)

#endif // OAIEventsEntity_input_type_H
