...
#include "OAIEventsEntity_contract_type.h"
...
OAIEventsEntity_contract_type::OAIEventsEntity_contract_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventsEntity_contract_type::OAIEventsEntity_contract_type() {
    this->initializeModel();
}

OAIEventsEntity_contract_type::~OAIEventsEntity_contract_type() {}

void OAIEventsEntity_contract_type::initializeModel() {
...
void OAIEventsEntity_contract_type::fromJson(QString jsonString) {
...
void OAIEventsEntity_contract_type::fromJsonObject(QJsonObject json) {
...
QString OAIEventsEntity_contract_type::asJson() const {
...
QJsonObject OAIEventsEntity_contract_type::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIEventsEntity_contract_type::getId() const {
    return m_id;
}
void OAIEventsEntity_contract_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEventsEntity_contract_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEventsEntity_contract_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIEventsEntity_contract_type::getLabel() const {
    return m_label;
}
void OAIEventsEntity_contract_type::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIEventsEntity_contract_type::is_label_Set() const{
    return m_label_isSet;
}

bool OAIEventsEntity_contract_type::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIEventsEntity_contract_type::isSet() const {
...
bool OAIEventsEntity_contract_type::isValid() const {
