...
/*
 * OAIEventsCapacitiesEntity.h
 *
 * 
 */

#ifndef OAIEventsCapacitiesEntity_H
#define OAIEventsCapacitiesEntity_H
...
namespace OpenAPI {
class OAIEventsCapacitiesEntity_event_categories_inner;

class OAIEventsCapacitiesEntity : public OAIObject {
public:
    OAIEventsCapacitiesEntity();
    OAIEventsCapacitiesEntity(QString json);
    ~OAIEventsCapacitiesEntity() override;
    ...
    QList<OAIEventsCapacitiesEntity_event_categories_inner> getEventCategories() const;
    void setEventCategories(const QList<OAIEventsCapacitiesEntity_event_categories_inner> &event_categories);
...
private:
    ...
    QList<OAIEventsCapacitiesEntity_event_categories_inner> m_event_categories;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsCapacitiesEntity)

#endif // OAIEventsCapacitiesEntity_H
