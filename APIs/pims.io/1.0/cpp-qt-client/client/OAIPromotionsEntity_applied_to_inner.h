...
/*
 * OAIPromotionsEntity_applied_to_inner.h
 *
 * 
 */

#ifndef OAIPromotionsEntity_applied_to_inner_H
#define OAIPromotionsEntity_applied_to_inner_H
...
class OAIPromotionsEntity_applied_to_inner : public OAIObject {
public:
    OAIPromotionsEntity_applied_to_inner();
    OAIPromotionsEntity_applied_to_inner(QString json);
    ~OAIPromotionsEntity_applied_to_inner() override;
    ...
    float getValorizedQuantity() const;
    void setValorizedQuantity(const float &valorized_quantity);
    bool is_valorized_quantity_Set() const;
    bool is_valorized_quantity_Valid() const;

    float getValorizedUnitCost() const;
    void setValorizedUnitCost(const float &valorized_unit_cost);
    bool is_valorized_unit_cost_Set() const;
    bool is_valorized_unit_cost_Valid() const;
...
private:
    ...
    float m_valorized_quantity;
    bool m_valorized_quantity_isSet;
    bool m_valorized_quantity_isValid;

    float m_valorized_unit_cost;
    bool m_valorized_unit_cost_isSet;
    bool m_valorized_unit_cost_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPromotionsEntity_applied_to_inner)

#endif // OAIPromotionsEntity_applied_to_inner_H
