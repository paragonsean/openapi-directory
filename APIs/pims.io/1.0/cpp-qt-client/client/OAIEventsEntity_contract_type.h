...
/*
 * OAIEventsEntity_contract_type.h
 *
 * Contract type.
 */

#ifndef OAIEventsEntity_contract_type_H
#define OAIEventsEntity_contract_type_H
...
class OAIEventsEntity_contract_type : public OAIObject {
public:
    OAIEventsEntity_contract_type();
    OAIEventsEntity_contract_type(QString json);
    ~OAIEventsEntity_contract_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsEntity_contract_type)

#endif // OAIEventsEntity_contract_type_H
