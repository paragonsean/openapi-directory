...
OAICategoriesEntity::OAICategoriesEntity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICategoriesEntity::OAICategoriesEntity() {
    this->initializeModel();
}

OAICategoriesEntity::~OAICategoriesEntity() {}

void OAICategoriesEntity::initializeModel() {
...
void OAICategoriesEntity::fromJson(QString jsonString) {
...
void OAICategoriesEntity::fromJsonObject(QJsonObject json) {
...
QString OAICategoriesEntity::asJson() const {
...
QJsonObject OAICategoriesEntity::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAICategoriesEntity::getId() const {
    return m_id;
}
void OAICategoriesEntity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICategoriesEntity::is_id_Set() const{
    return m_id_isSet;
}

bool OAICategoriesEntity::is_id_Valid() const{
    return m_id_isValid;
}

bool OAICategoriesEntity::isIgnored() const {
    return m_ignored;
}
void OAICategoriesEntity::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAICategoriesEntity::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAICategoriesEntity::is_ignored_Valid() const{
    return m_ignored_isValid;
}

QString OAICategoriesEntity::getLabel() const {
    return m_label;
}
void OAICategoriesEntity::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICategoriesEntity::is_label_Set() const{
    return m_label_isSet;
}

bool OAICategoriesEntity::is_label_Valid() const{
    return m_label_isValid;
}

qint64 OAICategoriesEntity::getLastUpdateTimestamp() const {
    return m_last_update_timestamp;
}
void OAICategoriesEntity::setLastUpdateTimestamp(const qint64 &last_update_timestamp) {
    m_last_update_timestamp = last_update_timestamp;
    m_last_update_timestamp_isSet = true;
}

bool OAICategoriesEntity::is_last_update_timestamp_Set() const{
    return m_last_update_timestamp_isSet;
}

bool OAICategoriesEntity::is_last_update_timestamp_Valid() const{
    return m_last_update_timestamp_isValid;
}

QString OAICategoriesEntity::getShortLabel() const {
    return m_short_label;
}
void OAICategoriesEntity::setShortLabel(const QString &short_label) {
    m_short_label = short_label;
    m_short_label_isSet = true;
}

bool OAICategoriesEntity::is_short_label_Set() const{
    return m_short_label_isSet;
}

bool OAICategoriesEntity::is_short_label_Valid() const{
    return m_short_label_isValid;
}

bool OAICategoriesEntity::isSet() const {
...
bool OAICategoriesEntity::isValid() const {
