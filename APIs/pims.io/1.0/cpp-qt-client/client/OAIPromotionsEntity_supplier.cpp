...
OAIPromotionsEntity_supplier::OAIPromotionsEntity_supplier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPromotionsEntity_supplier::OAIPromotionsEntity_supplier() {
    this->initializeModel();
}

OAIPromotionsEntity_supplier::~OAIPromotionsEntity_supplier() {}

void OAIPromotionsEntity_supplier::initializeModel() {
...
void OAIPromotionsEntity_supplier::fromJson(QString jsonString) {
...
void OAIPromotionsEntity_supplier::fromJsonObject(QJsonObject json) {
...
QString OAIPromotionsEntity_supplier::asJson() const {
...
QJsonObject OAIPromotionsEntity_supplier::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIPromotionsEntity_supplier::getId() const {
    return m_id;
}
void OAIPromotionsEntity_supplier::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPromotionsEntity_supplier::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPromotionsEntity_supplier::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPromotionsEntity_supplier::getLabel() const {
    return m_label;
}
void OAIPromotionsEntity_supplier::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPromotionsEntity_supplier::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPromotionsEntity_supplier::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIPromotionsEntity_supplier::isSet() const {
...
bool OAIPromotionsEntity_supplier::isValid() const {
