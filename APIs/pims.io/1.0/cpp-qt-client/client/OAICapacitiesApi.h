...
#include "OAIEventsCapacitiesEntity.h"
#include <QString>
...
public:
    ...
    */
    virtual void fetchAllEventsCapacities(const qint32 &event_id, const ::OpenAPI::OptionalParam<bool> &show_ignored = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  event_id qint32 [required]
    * @param[in]  capacity_id qint32 [required]
    * @param[in]  show_ignored bool [optional]
    */
    virtual void fetchOneEventCapacity(const qint32 &event_id, const qint32 &capacity_id, const ::OpenAPI::OptionalParam<bool> &show_ignored = ::OpenAPI::OptionalParam<bool>());
...
private:
    ...
    void fetchAllEventsCapacitiesCallback(OAIHttpRequestWorker *worker);
    void fetchOneEventCapacityCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAllEventsCapacitiesSignal(QList<OAIEventsCapacitiesEntity> summary);
    void fetchOneEventCapacitySignal(OAIEventsCapacitiesEntity summary);


    void fetchAllEventsCapacitiesSignalFull(OAIHttpRequestWorker *worker, QList<OAIEventsCapacitiesEntity> summary);
    void fetchOneEventCapacitySignalFull(OAIHttpRequestWorker *worker, OAIEventsCapacitiesEntity summary);

    Q_DECL_DEPRECATED_X("Use fetchAllEventsCapacitiesSignalError() instead")
    void fetchAllEventsCapacitiesSignalE(QList<OAIEventsCapacitiesEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllEventsCapacitiesSignalError(QList<OAIEventsCapacitiesEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneEventCapacitySignalError() instead")
    void fetchOneEventCapacitySignalE(OAIEventsCapacitiesEntity summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneEventCapacitySignalError(OAIEventsCapacitiesEntity summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAllEventsCapacitiesSignalErrorFull() instead")
    void fetchAllEventsCapacitiesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllEventsCapacitiesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneEventCapacitySignalErrorFull() instead")
    void fetchOneEventCapacitySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneEventCapacitySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
