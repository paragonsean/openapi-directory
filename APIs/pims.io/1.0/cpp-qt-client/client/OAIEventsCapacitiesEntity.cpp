...
OAIEventsCapacitiesEntity::OAIEventsCapacitiesEntity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventsCapacitiesEntity::OAIEventsCapacitiesEntity() {
    this->initializeModel();
}

OAIEventsCapacitiesEntity::~OAIEventsCapacitiesEntity() {}

void OAIEventsCapacitiesEntity::initializeModel() {
...
void OAIEventsCapacitiesEntity::fromJson(QString jsonString) {
...
void OAIEventsCapacitiesEntity::fromJsonObject(QJsonObject json) {

    m_date_isValid = ::OpenAPI::fromJsonValue(m_date, json[QString("date")]);
    m_date_isSet = !json[QString("date")].isNull() && m_date_isValid;

    m_event_categories_isValid = ::OpenAPI::fromJsonValue(m_event_categories, json[QString("event_categories")]);
    m_event_categories_isSet = !json[QString("event_categories")].isNull() && m_event_categories_isValid;

    m_id_isValid = ::OpenAPI::fromJsonValue(m_id, json[QString("id")]);
    m_id_isSet = !json[QString("id")].isNull() && m_id_isValid;
}

QString OAIEventsCapacitiesEntity::asJson() const {
...
QJsonObject OAIEventsCapacitiesEntity::asJsonObject() const {
    QJsonObject obj;
    if (m_date_isSet) {
        obj.insert(QString("date"), ::OpenAPI::toJsonValue(m_date));
    }
    if (m_event_categories.size() > 0) {
        obj.insert(QString("event_categories"), ::OpenAPI::toJsonValue(m_event_categories));
    }
    if (m_id_isSet) {
...
QDate OAIEventsCapacitiesEntity::getDate() const {
    return m_date;
}
void OAIEventsCapacitiesEntity::setDate(const QDate &date) {
    m_date = date;
    m_date_isSet = true;
}

bool OAIEventsCapacitiesEntity::is_date_Set() const{
    return m_date_isSet;
}

bool OAIEventsCapacitiesEntity::is_date_Valid() const{
    return m_date_isValid;
}

QList<OAIEventsCapacitiesEntity_event_categories_inner> OAIEventsCapacitiesEntity::getEventCategories() const {
    return m_event_categories;
}
void OAIEventsCapacitiesEntity::setEventCategories(const QList<OAIEventsCapacitiesEntity_event_categories_inner> &event_categories) {
    m_event_categories = event_categories;
    m_event_categories_isSet = true;
}

bool OAIEventsCapacitiesEntity::is_event_categories_Set() const{
    return m_event_categories_isSet;
}

bool OAIEventsCapacitiesEntity::is_event_categories_Valid() const{
    return m_event_categories_isValid;
}

qint32 OAIEventsCapacitiesEntity::getId() const {
    return m_id;
}
void OAIEventsCapacitiesEntity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEventsCapacitiesEntity::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEventsCapacitiesEntity::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIEventsCapacitiesEntity::isSet() const {
...
bool OAIEventsCapacitiesEntity::isValid() const {
