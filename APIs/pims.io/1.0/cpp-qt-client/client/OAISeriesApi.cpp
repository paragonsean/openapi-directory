...
void OAISeriesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("fetchAllSeries", defaultConf);
    _serverIndices.insert("fetchAllSeries", 0);
    _serverConfigs.insert("fetchOneSeries", defaultConf);
    _serverIndices.insert("fetchOneSeries", 0);
}
...
void OAISeriesApi::fetchAllSeries(const ::OpenAPI::OptionalParam<QString> &label, const ::OpenAPI::OptionalParam<QDate> &from_date, const ::OpenAPI::OptionalParam<QDate> &to_date, const ::OpenAPI::OptionalParam<QString> &type, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllSeries"][_serverIndices.value("fetchAllSeries")].URL()+"/series");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeriesApi::fetchAllSeriesCallback);
...
void OAISeriesApi::fetchAllSeriesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllSeriesSignal(output);
        Q_EMIT fetchAllSeriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllSeriesSignalE(output, error_type, error_str);
        Q_EMIT fetchAllSeriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllSeriesSignalError(output, error_type, error_str);
        Q_EMIT fetchAllSeriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISeriesApi::fetchOneSeries(const qint32 &series_id, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchOneSeries"][_serverIndices.value("fetchOneSeries")].URL()+"/series/{series_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISeriesApi::fetchOneSeriesCallback);
    connect(this, &OAISeriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISeriesApi::fetchOneSeriesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISeriesEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOneSeriesSignal(output);
        Q_EMIT fetchOneSeriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOneSeriesSignalE(output, error_type, error_str);
        Q_EMIT fetchOneSeriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOneSeriesSignalError(output, error_type, error_str);
        Q_EMIT fetchOneSeriesSignalErrorFull(worker, error_type, error_str);
    }
}
