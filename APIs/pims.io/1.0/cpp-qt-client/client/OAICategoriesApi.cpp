...
void OAICategoriesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("fetchAllCategories", defaultConf);
    _serverIndices.insert("fetchAllCategories", 0);
    _serverConfigs.insert("fetchAllEventsCategories", defaultConf);
    _serverIndices.insert("fetchAllEventsCategories", 0);
    _serverConfigs.insert("fetchOneCategory", defaultConf);
    _serverIndices.insert("fetchOneCategory", 0);
    _serverConfigs.insert("fetchOneEventCategory", defaultConf);
    _serverIndices.insert("fetchOneEventCategory", 0);
}
...
void OAICategoriesApi::fetchAllCategories(const ::OpenAPI::OptionalParam<QString> &label, const ::OpenAPI::OptionalParam<bool> &show_ignored, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllCategories"][_serverIndices.value("fetchAllCategories")].URL()+"/categories");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICategoriesApi::fetchAllCategoriesCallback);
...
void OAICategoriesApi::fetchAllCategoriesCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAICategoriesEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAICategoriesEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllCategoriesSignal(output);
        Q_EMIT fetchAllCategoriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllCategoriesSignalE(output, error_type, error_str);
        Q_EMIT fetchAllCategoriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllCategoriesSignalError(output, error_type, error_str);
        Q_EMIT fetchAllCategoriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICategoriesApi::fetchAllEventsCategories(const qint32 &event_id, const ::OpenAPI::OptionalParam<bool> &show_ignored, const ::OpenAPI::OptionalParam<qint32> &page_size) {
    QString fullPath = QString(_serverConfigs["fetchAllEventsCategories"][_serverIndices.value("fetchAllEventsCategories")].URL()+"/events/{event_id}/categories");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICategoriesApi::fetchAllEventsCategoriesCallback);
    connect(this, &OAICategoriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICategoriesApi::fetchAllEventsCategoriesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAIEventsCategoriesEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIEventsCategoriesEntity val;
        ::OpenAPI::fromJsonValue(val, obj);
        output.append(val);
    }
    worker->deleteLater();
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllEventsCategoriesSignal(output);
        Q_EMIT fetchAllEventsCategoriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllEventsCategoriesSignalE(output, error_type, error_str);
        Q_EMIT fetchAllEventsCategoriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllEventsCategoriesSignalError(output, error_type, error_str);
        Q_EMIT fetchAllEventsCategoriesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICategoriesApi::fetchOneCategory(const qint32 &category_id, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchOneCategory"][_serverIndices.value("fetchOneCategory")].URL()+"/categories/{category_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICategoriesApi::fetchOneCategoryCallback);
    connect(this, &OAICategoriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICategoriesApi::fetchOneCategoryCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICategoriesEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOneCategorySignal(output);
        Q_EMIT fetchOneCategorySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOneCategorySignalE(output, error_type, error_str);
        Q_EMIT fetchOneCategorySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOneCategorySignalError(output, error_type, error_str);
        Q_EMIT fetchOneCategorySignalErrorFull(worker, error_type, error_str);
    }
}

void OAICategoriesApi::fetchOneEventCategory(const qint32 &event_id, const double &category_id, const ::OpenAPI::OptionalParam<bool> &show_ignored) {
    QString fullPath = QString(_serverConfigs["fetchOneEventCategory"][_serverIndices.value("fetchOneEventCategory")].URL()+"/events/{event_id}/categories/{category_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICategoriesApi::fetchOneEventCategoryCallback);
    connect(this, &OAICategoriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICategoriesApi::fetchOneEventCategoryCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIEventsCategoriesEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOneEventCategorySignal(output);
        Q_EMIT fetchOneEventCategorySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOneEventCategorySignalE(output, error_type, error_str);
        Q_EMIT fetchOneEventCategorySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOneEventCategorySignalError(output, error_type, error_str);
        Q_EMIT fetchOneEventCategorySignalErrorFull(worker, error_type, error_str);
    }
}
