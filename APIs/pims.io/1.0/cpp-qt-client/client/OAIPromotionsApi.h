...
public:
    ...
    * @param[in]  family QString [optional]
    * @param[in]  sort QString [optional]
    * @param[in]  page_size qint32 [optional]
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchAllEventsPromotions(const qint32 &event_id, const ::OpenAPI::OptionalParam<QString> &label = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QDate> &from_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QDate> &to_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QString> &type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &family = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchAllPromotions(const ::OpenAPI::OptionalParam<QString> &label = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QDate> &from_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QDate> &to_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QString> &type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &family = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchAllSeriesPromotions(const qint32 &series_id, const ::OpenAPI::OptionalParam<QString> &label = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QDate> &from_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QDate> &to_date = ::OpenAPI::OptionalParam<QDate>(), const ::OpenAPI::OptionalParam<QString> &type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &family = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  promotion_id qint32 [required]
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchOnePromotion(const qint32 &promotion_id, const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void fetchAllEventsPromotionsCallback(OAIHttpRequestWorker *worker);
    void fetchAllPromotionsCallback(OAIHttpRequestWorker *worker);
    void fetchAllSeriesPromotionsCallback(OAIHttpRequestWorker *worker);
    void fetchOnePromotionCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAllEventsPromotionsSignal(QList<OAIPromotionsEntity> summary);
    void fetchAllPromotionsSignal(QList<OAIPromotionsEntity> summary);
    void fetchAllSeriesPromotionsSignal(QList<OAIPromotionsEntity> summary);
    void fetchOnePromotionSignal(OAIPromotionsEntity summary);


    void fetchAllEventsPromotionsSignalFull(OAIHttpRequestWorker *worker, QList<OAIPromotionsEntity> summary);
    void fetchAllPromotionsSignalFull(OAIHttpRequestWorker *worker, QList<OAIPromotionsEntity> summary);
    void fetchAllSeriesPromotionsSignalFull(OAIHttpRequestWorker *worker, QList<OAIPromotionsEntity> summary);
    void fetchOnePromotionSignalFull(OAIHttpRequestWorker *worker, OAIPromotionsEntity summary);

    Q_DECL_DEPRECATED_X("Use fetchAllEventsPromotionsSignalError() instead")
    void fetchAllEventsPromotionsSignalE(QList<OAIPromotionsEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllEventsPromotionsSignalError(QList<OAIPromotionsEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllPromotionsSignalError() instead")
    void fetchAllPromotionsSignalE(QList<OAIPromotionsEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllPromotionsSignalError(QList<OAIPromotionsEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllSeriesPromotionsSignalError() instead")
    void fetchAllSeriesPromotionsSignalE(QList<OAIPromotionsEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllSeriesPromotionsSignalError(QList<OAIPromotionsEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOnePromotionSignalError() instead")
    void fetchOnePromotionSignalE(OAIPromotionsEntity summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOnePromotionSignalError(OAIPromotionsEntity summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAllEventsPromotionsSignalErrorFull() instead")
    void fetchAllEventsPromotionsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllEventsPromotionsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllPromotionsSignalErrorFull() instead")
    void fetchAllPromotionsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllPromotionsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllSeriesPromotionsSignalErrorFull() instead")
    void fetchAllSeriesPromotionsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllSeriesPromotionsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOnePromotionSignalErrorFull() instead")
    void fetchOnePromotionSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOnePromotionSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
