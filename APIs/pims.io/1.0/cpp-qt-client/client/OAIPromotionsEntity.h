...
/*
 * OAIPromotionsEntity.h
 *
 * 
 */

#ifndef OAIPromotionsEntity_H
#define OAIPromotionsEntity_H

#include <QJsonObject>

#include "OAIPromotionsEntity_applied_to_inner.h"
#include "OAIPromotionsEntity_cost.h"
#include "OAIPromotionsEntity_supplier.h"
#include "OAIPromotionsEntity_type.h"
#include <QDate>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIPromotionsEntity_applied_to_inner;
class OAIPromotionsEntity_cost;
class OAIPromotionsEntity_supplier;
class OAIPromotionsEntity_type;

class OAIPromotionsEntity : public OAIObject {
public:
    OAIPromotionsEntity();
    OAIPromotionsEntity(QString json);
    ~OAIPromotionsEntity() override;
    ...
    QList<OAIPromotionsEntity_applied_to_inner> getAppliedTo() const;
    void setAppliedTo(const QList<OAIPromotionsEntity_applied_to_inner> &applied_to);
    ...
    OAIPromotionsEntity_cost getCost() const;
    void setCost(const OAIPromotionsEntity_cost &cost);
    ...
    OAIPromotionsEntity_supplier getSupplier() const;
    void setSupplier(const OAIPromotionsEntity_supplier &supplier);
    bool is_supplier_Set() const;
    bool is_supplier_Valid() const;

    OAIPromotionsEntity_type getType() const;
    void setType(const OAIPromotionsEntity_type &type);
...
private:
    ...
    QList<OAIPromotionsEntity_applied_to_inner> m_applied_to;
    ...
    OAIPromotionsEntity_cost m_cost;
    bool m_cost_isSet;
    bool m_cost_isValid;
    ...
    OAIPromotionsEntity_supplier m_supplier;
    bool m_supplier_isSet;
    bool m_supplier_isValid;

    OAIPromotionsEntity_type m_type;
    bool m_type_isSet;
    bool m_type_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIPromotionsEntity)

#endif // OAIPromotionsEntity_H
