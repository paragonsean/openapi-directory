...
/*
 * OAIEventsEntity_contract.h
 *
 * Contract of the series.
 */

#ifndef OAIEventsEntity_contract_H
#define OAIEventsEntity_contract_H
...
namespace OpenAPI {
class OAIEventsEntity_contract_partner;
class OAIEventsEntity_contract_type;

class OAIEventsEntity_contract : public OAIObject {
public:
    OAIEventsEntity_contract();
    OAIEventsEntity_contract(QString json);
    ~OAIEventsEntity_contract() override;
    ...
    OAIEventsEntity_contract_partner getPartner() const;
    void setPartner(const OAIEventsEntity_contract_partner &partner);
    bool is_partner_Set() const;
    bool is_partner_Valid() const;

    OAIEventsEntity_contract_type getType() const;
    void setType(const OAIEventsEntity_contract_type &type);
...
private:
    ...
    OAIEventsEntity_contract_partner m_partner;
    bool m_partner_isSet;
    bool m_partner_isValid;

    OAIEventsEntity_contract_type m_type;
    bool m_type_isSet;
    bool m_type_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsEntity_contract)

#endif // OAIEventsEntity_contract_H
