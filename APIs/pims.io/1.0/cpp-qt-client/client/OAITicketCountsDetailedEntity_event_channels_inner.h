...
/*
 * OAITicketCountsDetailedEntity_event_channels_inner.h
 *
 * 
 */

#ifndef OAITicketCountsDetailedEntity_event_channels_inner_H
#define OAITicketCountsDetailedEntity_event_channels_inner_H
...
namespace OpenAPI {
class OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner;

class OAITicketCountsDetailedEntity_event_channels_inner : public OAIObject {
public:
    OAITicketCountsDetailedEntity_event_channels_inner();
    OAITicketCountsDetailedEntity_event_channels_inner(QString json);
    ~OAITicketCountsDetailedEntity_event_channels_inner() override;
    ...
    QList<OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner> getEventCategories() const;
    void setEventCategories(const QList<OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner> &event_categories);
...
private:
    ...
    QList<OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner> m_event_categories;
...
Q_DECLARE_METATYPE(OpenAPI::OAITicketCountsDetailedEntity_event_channels_inner)

#endif // OAITicketCountsDetailedEntity_event_channels_inner_H
