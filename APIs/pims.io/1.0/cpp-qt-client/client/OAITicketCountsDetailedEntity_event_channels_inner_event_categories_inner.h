...
/*
 * OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner.h
 *
 * 
 */

#ifndef OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_H
#define OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_H

#include <QJsonObject>

#include "OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner.h"
#include <QList>
...
namespace OpenAPI {
class OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner;

class OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner : public OAIObject {
public:
    OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner();
    OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner(QString json);
    ~OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner() override;
    ...
    QList<OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner> getEventPriceRanges() const;
    void setEventPriceRanges(const QList<OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner> &event_price_ranges);
    bool is_event_price_ranges_Set() const;
    bool is_event_price_ranges_Valid() const;
...
private:
    ...
    QList<OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner> m_event_price_ranges;
    bool m_event_price_ranges_isSet;
    bool m_event_price_ranges_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner)

#endif // OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_H
