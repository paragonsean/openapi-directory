...
#ifndef OAIError422_H
#define OAIError422_H
...
class OAIError422 : public OAIObject {
public:
    OAIError422();
    OAIError422(QString json);
    ~OAIError422() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIError422)
