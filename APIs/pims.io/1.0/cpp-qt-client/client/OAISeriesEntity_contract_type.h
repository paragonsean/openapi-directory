...
/*
 * OAISeriesEntity_contract_type.h
 *
 * Contract type.
 */

#ifndef OAISeriesEntity_contract_type_H
#define OAISeriesEntity_contract_type_H
...
class OAISeriesEntity_contract_type : public OAIObject {
public:
    OAISeriesEntity_contract_type();
    OAISeriesEntity_contract_type(QString json);
    ~OAISeriesEntity_contract_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISeriesEntity_contract_type)

#endif // OAISeriesEntity_contract_type_H
