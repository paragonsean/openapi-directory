...
#ifndef OAIError404_H
#define OAIError404_H
...
class OAIError404 : public OAIObject {
public:
    OAIError404();
    OAIError404(QString json);
    ~OAIError404() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIError404)
