...
#include "OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner.h"
...
OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner() {
    this->initializeModel();
}

OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::~OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner() {}

void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::initializeModel() {
...
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::fromJson(QString jsonString) {
...
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::fromJsonObject(QJsonObject json) {
...
QString OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::asJson() const {
...
QJsonObject OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::asJsonObject() const {
    QJsonObject obj;
...
QList<OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner> OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::getEventPriceRanges() const {
    return m_event_price_ranges;
}
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::setEventPriceRanges(const QList<OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner> &event_price_ranges) {
    m_event_price_ranges = event_price_ranges;
    m_event_price_ranges_isSet = true;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::is_event_price_ranges_Set() const{
    return m_event_price_ranges_isSet;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::is_event_price_ranges_Valid() const{
    return m_event_price_ranges_isValid;
}

qint32 OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::getId() const {
    return m_id;
}
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::is_id_Valid() const{
    return m_id_isValid;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::isSet() const {
...
bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_event_price_ranges_isValid && m_id_isValid && true;
}
