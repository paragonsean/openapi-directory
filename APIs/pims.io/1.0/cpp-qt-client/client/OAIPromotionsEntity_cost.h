...
/*
 * OAIPromotionsEntity_cost.h
 *
 * Cost of the promotion.
 */

#ifndef OAIPromotionsEntity_cost_H
#define OAIPromotionsEntity_cost_H
...
namespace OpenAPI {
class OAIPromotionsEntity_cost_state;
class OAIPromotionsEntity_cost_type;

class OAIPromotionsEntity_cost : public OAIObject {
public:
    OAIPromotionsEntity_cost();
    OAIPromotionsEntity_cost(QString json);
    ~OAIPromotionsEntity_cost() override;
    ...
    OAIPromotionsEntity_cost_state getState() const;
    void setState(const OAIPromotionsEntity_cost_state &state);
    bool is_state_Set() const;
    bool is_state_Valid() const;

    OAIPromotionsEntity_cost_type getType() const;
    void setType(const OAIPromotionsEntity_cost_type &type);
...
private:
    ...
    OAIPromotionsEntity_cost_state m_state;
    bool m_state_isSet;
    bool m_state_isValid;

    OAIPromotionsEntity_cost_type m_type;
    bool m_type_isSet;
    bool m_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPromotionsEntity_cost)

#endif // OAIPromotionsEntity_cost_H
