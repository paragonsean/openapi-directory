...
#ifndef OAISeriesEntity_H
#define OAISeriesEntity_H
...
namespace OpenAPI {
class OAISeriesEntity_contract;
class OAISeriesEntity_type;
class OAIVenuesEntity;

class OAISeriesEntity : public OAIObject {
public:
    OAISeriesEntity();
    OAISeriesEntity(QString json);
    ~OAISeriesEntity() override;
    ...
    OAISeriesEntity_contract getContract() const;
    void setContract(const OAISeriesEntity_contract &contract);
    ...
    OAISeriesEntity_type getType() const;
    void setType(const OAISeriesEntity_type &type);
...
private:
    ...
    OAISeriesEntity_contract m_contract;
...
Q_DECLARE_METATYPE(OpenAPI::OAISeriesEntity)

#endif // OAISeriesEntity_H
