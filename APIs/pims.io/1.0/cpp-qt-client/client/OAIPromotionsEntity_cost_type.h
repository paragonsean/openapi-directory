...
/*
 * OAIPromotionsEntity_cost_type.h
 *
 * Type of the promotion cost.
 */

#ifndef OAIPromotionsEntity_cost_type_H
#define OAIPromotionsEntity_cost_type_H
...
class OAIPromotionsEntity_cost_type : public OAIObject {
public:
    OAIPromotionsEntity_cost_type();
    OAIPromotionsEntity_cost_type(QString json);
    ~OAIPromotionsEntity_cost_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPromotionsEntity_cost_type)

#endif // OAIPromotionsEntity_cost_type_H
