...
OAIEventsEntity_contract::OAIEventsEntity_contract(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventsEntity_contract::OAIEventsEntity_contract() {
    this->initializeModel();
}

OAIEventsEntity_contract::~OAIEventsEntity_contract() {}

void OAIEventsEntity_contract::initializeModel() {
...
void OAIEventsEntity_contract::fromJson(QString jsonString) {
...
void OAIEventsEntity_contract::fromJsonObject(QJsonObject json) {
...
QString OAIEventsEntity_contract::asJson() const {
...
QJsonObject OAIEventsEntity_contract::asJsonObject() const {
    QJsonObject obj;
    if (m_partner.isSet()) {
...
OAIEventsEntity_contract_partner OAIEventsEntity_contract::getPartner() const {
    return m_partner;
}
void OAIEventsEntity_contract::setPartner(const OAIEventsEntity_contract_partner &partner) {
    m_partner = partner;
    m_partner_isSet = true;
}

bool OAIEventsEntity_contract::is_partner_Set() const{
    return m_partner_isSet;
}

bool OAIEventsEntity_contract::is_partner_Valid() const{
    return m_partner_isValid;
}

OAIEventsEntity_contract_type OAIEventsEntity_contract::getType() const {
    return m_type;
}
void OAIEventsEntity_contract::setType(const OAIEventsEntity_contract_type &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIEventsEntity_contract::is_type_Set() const{
    return m_type_isSet;
}

bool OAIEventsEntity_contract::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIEventsEntity_contract::isSet() const {
...
bool OAIEventsEntity_contract::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_partner_isValid && m_type_isValid && true;
}
