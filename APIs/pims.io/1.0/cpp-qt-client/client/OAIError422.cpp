...
OAIError422::OAIError422(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIError422::OAIError422() {
    this->initializeModel();
}

OAIError422::~OAIError422() {}

void OAIError422::initializeModel() {
...
void OAIError422::fromJson(QString jsonString) {
...
void OAIError422::fromJsonObject(QJsonObject json) {
...
QString OAIError422::asJson() const {
...
QJsonObject OAIError422::asJsonObject() const {
    QJsonObject obj;
    if (m_detail_isSet) {
...
QString OAIError422::getDetail() const {
    return m_detail;
}
void OAIError422::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIError422::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIError422::is_detail_Valid() const{
    return m_detail_isValid;
}

qint32 OAIError422::getStatus() const {
    return m_status;
}
void OAIError422::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIError422::is_status_Set() const{
    return m_status_isSet;
}

bool OAIError422::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIError422::getTitle() const {
    return m_title;
}
void OAIError422::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIError422::is_title_Set() const{
    return m_title_isSet;
}

bool OAIError422::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIError422::getType() const {
    return m_type;
}
void OAIError422::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIError422::is_type_Set() const{
    return m_type_isSet;
}

bool OAIError422::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIError422::isSet() const {
...
bool OAIError422::isValid() const {
