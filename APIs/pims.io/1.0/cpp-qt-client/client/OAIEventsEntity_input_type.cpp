...
OAIEventsEntity_input_type::OAIEventsEntity_input_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventsEntity_input_type::OAIEventsEntity_input_type() {
    this->initializeModel();
}

OAIEventsEntity_input_type::~OAIEventsEntity_input_type() {}

void OAIEventsEntity_input_type::initializeModel() {
...
void OAIEventsEntity_input_type::fromJson(QString jsonString) {
...
void OAIEventsEntity_input_type::fromJsonObject(QJsonObject json) {
...
QString OAIEventsEntity_input_type::asJson() const {
...
QJsonObject OAIEventsEntity_input_type::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIEventsEntity_input_type::getId() const {
    return m_id;
}
void OAIEventsEntity_input_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEventsEntity_input_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEventsEntity_input_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIEventsEntity_input_type::getLabel() const {
    return m_label;
}
void OAIEventsEntity_input_type::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIEventsEntity_input_type::is_label_Set() const{
    return m_label_isSet;
}

bool OAIEventsEntity_input_type::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIEventsEntity_input_type::isSet() const {
...
bool OAIEventsEntity_input_type::isValid() const {
