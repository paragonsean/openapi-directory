...
OAIPriceRangesApi::OAIPriceRangesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIPriceRangesApi::~OAIPriceRangesApi() {
}

void OAIPriceRangesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("fetchAllPriceRanges", defaultConf);
    _serverIndices.insert("fetchAllPriceRanges", 0);
    _serverConfigs.insert("fetchOnePriceRange", defaultConf);
    _serverIndices.insert("fetchOnePriceRange", 0);
}
...
*/
int OAIPriceRangesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIPriceRangesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIPriceRangesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIPriceRangesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIPriceRangesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIPriceRangesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIPriceRangesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIPriceRangesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIPriceRangesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIPriceRangesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPriceRangesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPriceRangesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIPriceRangesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIPriceRangesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIPriceRangesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIPriceRangesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIPriceRangesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIPriceRangesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIPriceRangesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIPriceRangesApi::fetchAllPriceRanges(const ::OpenAPI::OptionalParam<QString> &label, const ::OpenAPI::OptionalParam<bool> &show_ignored, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllPriceRanges"][_serverIndices.value("fetchAllPriceRanges")].URL()+"/price-ranges");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPriceRangesApi::fetchAllPriceRangesCallback);
    connect(this, &OAIPriceRangesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIPriceRangesApi::fetchAllPriceRangesCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIPriceRangesEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIPriceRangesEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllPriceRangesSignal(output);
        Q_EMIT fetchAllPriceRangesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllPriceRangesSignalE(output, error_type, error_str);
        Q_EMIT fetchAllPriceRangesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllPriceRangesSignalError(output, error_type, error_str);
        Q_EMIT fetchAllPriceRangesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPriceRangesApi::fetchOnePriceRange(const qint32 &price_range_id, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchOnePriceRange"][_serverIndices.value("fetchOnePriceRange")].URL()+"/price-ranges/{price_range_id}");
    ...
    {
        QString price_range_idPathParam("{");
        price_range_idPathParam.append("price_range_id").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "price_range_id", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"price_range_id"+pathSuffix : pathPrefix;
        fullPath.replace(price_range_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(price_range_id)));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPriceRangesApi::fetchOnePriceRangeCallback);
    connect(this, &OAIPriceRangesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPriceRangesApi::fetchOnePriceRangeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOnePriceRangeSignal(output);
        Q_EMIT fetchOnePriceRangeSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOnePriceRangeSignalE(output, error_type, error_str);
        Q_EMIT fetchOnePriceRangeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOnePriceRangeSignalError(output, error_type, error_str);
        Q_EMIT fetchOnePriceRangeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPriceRangesApi::tokenAvailable(){
