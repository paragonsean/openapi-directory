...
QString OAIError404::getDetail() const {
    return m_detail;
}
void OAIError404::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIError404::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIError404::is_detail_Valid() const{
    return m_detail_isValid;
}

qint32 OAIError404::getStatus() const {
    return m_status;
}
void OAIError404::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIError404::is_status_Set() const{
    return m_status_isSet;
}

bool OAIError404::is_status_Valid() const{
...
QString OAIError404::getType() const {
    return m_type;
}
void OAIError404::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIError404::is_type_Set() const{
    return m_type_isSet;
}

bool OAIError404::is_type_Valid() const{
