...
OAIChannelsEntity::OAIChannelsEntity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChannelsEntity::OAIChannelsEntity() {
    this->initializeModel();
}

OAIChannelsEntity::~OAIChannelsEntity() {}

void OAIChannelsEntity::initializeModel() {
    ...
    m_short_label_isSet = false;
    m_short_label_isValid = false;
}

void OAIChannelsEntity::fromJson(QString jsonString) {
...
void OAIChannelsEntity::fromJsonObject(QJsonObject json) {
    ...
    m_short_label_isValid = ::OpenAPI::fromJsonValue(m_short_label, json[QString("short_label")]);
    m_short_label_isSet = !json[QString("short_label")].isNull() && m_short_label_isValid;
}

QString OAIChannelsEntity::asJson() const {
...
QJsonObject OAIChannelsEntity::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
    ...
    if (m_short_label_isSet) {
        obj.insert(QString("short_label"), ::OpenAPI::toJsonValue(m_short_label));
    }
    return obj;
}

qint32 OAIChannelsEntity::getId() const {
    return m_id;
}
void OAIChannelsEntity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIChannelsEntity::is_id_Set() const{
    return m_id_isSet;
}

bool OAIChannelsEntity::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIChannelsEntity::isIgnored() const {
    return m_ignored;
}
void OAIChannelsEntity::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAIChannelsEntity::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAIChannelsEntity::is_ignored_Valid() const{
    return m_ignored_isValid;
}

QString OAIChannelsEntity::getLabel() const {
    return m_label;
}
void OAIChannelsEntity::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIChannelsEntity::is_label_Set() const{
    return m_label_isSet;
}

bool OAIChannelsEntity::is_label_Valid() const{
    return m_label_isValid;
}

qint64 OAIChannelsEntity::getLastUpdateTimestamp() const {
    return m_last_update_timestamp;
}
void OAIChannelsEntity::setLastUpdateTimestamp(const qint64 &last_update_timestamp) {
    m_last_update_timestamp = last_update_timestamp;
    m_last_update_timestamp_isSet = true;
}

bool OAIChannelsEntity::is_last_update_timestamp_Set() const{
    return m_last_update_timestamp_isSet;
}

bool OAIChannelsEntity::is_last_update_timestamp_Valid() const{
    return m_last_update_timestamp_isValid;
}

QString OAIChannelsEntity::getShortLabel() const {
    return m_short_label;
}
void OAIChannelsEntity::setShortLabel(const QString &short_label) {
    m_short_label = short_label;
    m_short_label_isSet = true;
}

bool OAIChannelsEntity::is_short_label_Set() const{
    return m_short_label_isSet;
}

bool OAIChannelsEntity::is_short_label_Valid() const{
    return m_short_label_isValid;
}

bool OAIChannelsEntity::isSet() const {
...
bool OAIChannelsEntity::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_ignored_isValid && m_label_isValid && m_last_update_timestamp_isValid && m_short_label_isValid && true;
}
