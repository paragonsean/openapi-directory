...
OAIVenuesApi::OAIVenuesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIVenuesApi::~OAIVenuesApi() {
}

void OAIVenuesApi::initializeServerConfigs() {
    //Default server
    QList<OAIServerConfiguration> defaultConf = QList<OAIServerConfiguration>();
    //varying endpoint server
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://demo.pims.io/api/v1"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("fetchAllVenues", defaultConf);
    _serverIndices.insert("fetchAllVenues", 0);
    _serverConfigs.insert("fetchOneVenue", defaultConf);
    _serverIndices.insert("fetchOneVenue", 0);
}
...
*/
int OAIVenuesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIVenuesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIVenuesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIVenuesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIVenuesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIVenuesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIVenuesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIVenuesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIVenuesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIVenuesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIVenuesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIVenuesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIVenuesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIVenuesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIVenuesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIVenuesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIVenuesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIVenuesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIVenuesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIVenuesApi::fetchAllVenues(const ::OpenAPI::OptionalParam<QString> &label, const ::OpenAPI::OptionalParam<QString> &city, const ::OpenAPI::OptionalParam<QString> &country_code, const ::OpenAPI::OptionalParam<QString> &type, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllVenues"][_serverIndices.value("fetchAllVenues")].URL()+"/venues");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVenuesApi::fetchAllVenuesCallback);
    connect(this, &OAIVenuesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIVenuesApi::fetchAllVenuesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllVenuesSignal(output);
        Q_EMIT fetchAllVenuesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllVenuesSignalE(output, error_type, error_str);
        Q_EMIT fetchAllVenuesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllVenuesSignalError(output, error_type, error_str);
        Q_EMIT fetchAllVenuesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVenuesApi::fetchOneVenue(const qint32 &venue_id, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchOneVenue"][_serverIndices.value("fetchOneVenue")].URL()+"/venues/{venue_id}");
    ...
    {
        QString venue_idPathParam("{");
        venue_idPathParam.append("venue_id").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "venue_id", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"venue_id"+pathSuffix : pathPrefix;
        fullPath.replace(venue_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(venue_id)));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVenuesApi::fetchOneVenueCallback);
    connect(this, &OAIVenuesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIVenuesApi::fetchOneVenueCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIVenuesEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOneVenueSignal(output);
        Q_EMIT fetchOneVenueSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOneVenueSignalE(output, error_type, error_str);
        Q_EMIT fetchOneVenueSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOneVenueSignalError(output, error_type, error_str);
        Q_EMIT fetchOneVenueSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIVenuesApi::tokenAvailable(){
