...
/*
 * OAIPromotionsEntity_type_family.h
 *
 * Family the promotion type belongs to.
 */

#ifndef OAIPromotionsEntity_type_family_H
#define OAIPromotionsEntity_type_family_H
...
class OAIPromotionsEntity_type_family : public OAIObject {
public:
    OAIPromotionsEntity_type_family();
    OAIPromotionsEntity_type_family(QString json);
    ~OAIPromotionsEntity_type_family() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPromotionsEntity_type_family)

#endif // OAIPromotionsEntity_type_family_H
