...
#ifndef OAIChannelsEntity_H
#define OAIChannelsEntity_H
...
class OAIChannelsEntity : public OAIObject {
public:
    OAIChannelsEntity();
    OAIChannelsEntity(QString json);
    ~OAIChannelsEntity() override;
    ...
    void setShortLabel(const QString &short_label);
    bool is_short_label_Set() const;
    bool is_short_label_Valid() const;
...
private:
    ...
    QString m_short_label;
    bool m_short_label_isSet;
    bool m_short_label_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIChannelsEntity)

#endif // OAIChannelsEntity_H
