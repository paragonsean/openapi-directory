...
QString OAIError500::getDetail() const {
    return m_detail;
}
void OAIError500::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIError500::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIError500::is_detail_Valid() const{
    return m_detail_isValid;
}

qint32 OAIError500::getStatus() const {
    return m_status;
}
void OAIError500::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIError500::is_status_Set() const{
    return m_status_isSet;
}

bool OAIError500::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIError500::getTitle() const {
    return m_title;
}
void OAIError500::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIError500::is_title_Set() const{
    return m_title_isSet;
}

bool OAIError500::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIError500::getType() const {
    return m_type;
}
void OAIError500::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIError500::is_type_Set() const{
    return m_type_isSet;
}

bool OAIError500::is_type_Valid() const{
