...
OAIVenuesEntity_type::OAIVenuesEntity_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVenuesEntity_type::OAIVenuesEntity_type() {
    this->initializeModel();
}

OAIVenuesEntity_type::~OAIVenuesEntity_type() {}

void OAIVenuesEntity_type::initializeModel() {
...
void OAIVenuesEntity_type::fromJson(QString jsonString) {
...
void OAIVenuesEntity_type::fromJsonObject(QJsonObject json) {
...
QString OAIVenuesEntity_type::asJson() const {
...
QJsonObject OAIVenuesEntity_type::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIVenuesEntity_type::getId() const {
    return m_id;
}
void OAIVenuesEntity_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIVenuesEntity_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAIVenuesEntity_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIVenuesEntity_type::getLabel() const {
    return m_label;
}
void OAIVenuesEntity_type::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIVenuesEntity_type::is_label_Set() const{
    return m_label_isSet;
}

bool OAIVenuesEntity_type::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIVenuesEntity_type::isSet() const {
...
bool OAIVenuesEntity_type::isValid() const {
