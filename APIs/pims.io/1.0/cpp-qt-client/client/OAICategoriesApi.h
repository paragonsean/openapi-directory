...
public:
    ...
    */
    virtual void fetchAllCategories(const ::OpenAPI::OptionalParam<QString> &label = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &show_ignored = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  page_size qint32 [optional]
    */
    virtual void fetchAllEventsCategories(const qint32 &event_id, const ::OpenAPI::OptionalParam<bool> &show_ignored = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>());

    /**
    * @param[in]  category_id qint32 [required]
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchOneCategory(const qint32 &category_id, const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  event_id qint32 [required]
    * @param[in]  category_id double [required]
    * @param[in]  show_ignored bool [optional]
    */
    virtual void fetchOneEventCategory(const qint32 &event_id, const double &category_id, const ::OpenAPI::OptionalParam<bool> &show_ignored = ::OpenAPI::OptionalParam<bool>());
...
private:
    ...
    void fetchAllCategoriesCallback(OAIHttpRequestWorker *worker);
    void fetchAllEventsCategoriesCallback(OAIHttpRequestWorker *worker);
    void fetchOneCategoryCallback(OAIHttpRequestWorker *worker);
    void fetchOneEventCategoryCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAllCategoriesSignal(QList<OAICategoriesEntity> summary);
    void fetchAllEventsCategoriesSignal(QList<OAIEventsCategoriesEntity> summary);
    void fetchOneCategorySignal(OAICategoriesEntity summary);
    void fetchOneEventCategorySignal(OAIEventsCategoriesEntity summary);


    void fetchAllCategoriesSignalFull(OAIHttpRequestWorker *worker, QList<OAICategoriesEntity> summary);
    void fetchAllEventsCategoriesSignalFull(OAIHttpRequestWorker *worker, QList<OAIEventsCategoriesEntity> summary);
    void fetchOneCategorySignalFull(OAIHttpRequestWorker *worker, OAICategoriesEntity summary);
    void fetchOneEventCategorySignalFull(OAIHttpRequestWorker *worker, OAIEventsCategoriesEntity summary);

    Q_DECL_DEPRECATED_X("Use fetchAllCategoriesSignalError() instead")
    void fetchAllCategoriesSignalE(QList<OAICategoriesEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllCategoriesSignalError(QList<OAICategoriesEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllEventsCategoriesSignalError() instead")
    void fetchAllEventsCategoriesSignalE(QList<OAIEventsCategoriesEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllEventsCategoriesSignalError(QList<OAIEventsCategoriesEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneCategorySignalError() instead")
    void fetchOneCategorySignalE(OAICategoriesEntity summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneCategorySignalError(OAICategoriesEntity summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneEventCategorySignalError() instead")
    void fetchOneEventCategorySignalE(OAIEventsCategoriesEntity summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneEventCategorySignalError(OAIEventsCategoriesEntity summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAllCategoriesSignalErrorFull() instead")
    void fetchAllCategoriesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllCategoriesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchAllEventsCategoriesSignalErrorFull() instead")
    void fetchAllEventsCategoriesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllEventsCategoriesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneCategorySignalErrorFull() instead")
    void fetchOneCategorySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneCategorySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneEventCategorySignalErrorFull() instead")
    void fetchOneEventCategorySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneEventCategorySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
