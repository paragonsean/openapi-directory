...
#include "OAISeriesEntity_contract_partner.h"
...
OAISeriesEntity_contract_partner::OAISeriesEntity_contract_partner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISeriesEntity_contract_partner::OAISeriesEntity_contract_partner() {
    this->initializeModel();
}

OAISeriesEntity_contract_partner::~OAISeriesEntity_contract_partner() {}

void OAISeriesEntity_contract_partner::initializeModel() {
...
void OAISeriesEntity_contract_partner::fromJson(QString jsonString) {
...
void OAISeriesEntity_contract_partner::fromJsonObject(QJsonObject json) {
...
QString OAISeriesEntity_contract_partner::asJson() const {
...
QJsonObject OAISeriesEntity_contract_partner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAISeriesEntity_contract_partner::getId() const {
    return m_id;
}
void OAISeriesEntity_contract_partner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISeriesEntity_contract_partner::is_id_Set() const{
    return m_id_isSet;
}

bool OAISeriesEntity_contract_partner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISeriesEntity_contract_partner::getLabel() const {
    return m_label;
}
void OAISeriesEntity_contract_partner::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAISeriesEntity_contract_partner::is_label_Set() const{
    return m_label_isSet;
}

bool OAISeriesEntity_contract_partner::is_label_Valid() const{
    return m_label_isValid;
}

bool OAISeriesEntity_contract_partner::isSet() const {
...
bool OAISeriesEntity_contract_partner::isValid() const {
