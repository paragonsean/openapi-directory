...
OAIPriceRangesEntity::OAIPriceRangesEntity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPriceRangesEntity::OAIPriceRangesEntity() {
    this->initializeModel();
}

OAIPriceRangesEntity::~OAIPriceRangesEntity() {}

void OAIPriceRangesEntity::initializeModel() {
...
void OAIPriceRangesEntity::fromJson(QString jsonString) {
...
void OAIPriceRangesEntity::fromJsonObject(QJsonObject json) {
...
QString OAIPriceRangesEntity::asJson() const {
...
QJsonObject OAIPriceRangesEntity::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIPriceRangesEntity::getId() const {
    return m_id;
}
void OAIPriceRangesEntity::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPriceRangesEntity::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPriceRangesEntity::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIPriceRangesEntity::isIgnored() const {
    return m_ignored;
}
void OAIPriceRangesEntity::setIgnored(const bool &ignored) {
    m_ignored = ignored;
    m_ignored_isSet = true;
}

bool OAIPriceRangesEntity::is_ignored_Set() const{
    return m_ignored_isSet;
}

bool OAIPriceRangesEntity::is_ignored_Valid() const{
    return m_ignored_isValid;
}

QString OAIPriceRangesEntity::getLabel() const {
    return m_label;
}
void OAIPriceRangesEntity::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPriceRangesEntity::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPriceRangesEntity::is_label_Valid() const{
    return m_label_isValid;
}

qint64 OAIPriceRangesEntity::getLastUpdateTimestamp() const {
    return m_last_update_timestamp;
}
void OAIPriceRangesEntity::setLastUpdateTimestamp(const qint64 &last_update_timestamp) {
    m_last_update_timestamp = last_update_timestamp;
    m_last_update_timestamp_isSet = true;
}

bool OAIPriceRangesEntity::is_last_update_timestamp_Set() const{
    return m_last_update_timestamp_isSet;
}

bool OAIPriceRangesEntity::is_last_update_timestamp_Valid() const{
    return m_last_update_timestamp_isValid;
}

QString OAIPriceRangesEntity::getShortLabel() const {
    return m_short_label;
}
void OAIPriceRangesEntity::setShortLabel(const QString &short_label) {
    m_short_label = short_label;
    m_short_label_isSet = true;
}

bool OAIPriceRangesEntity::is_short_label_Set() const{
    return m_short_label_isSet;
}

bool OAIPriceRangesEntity::is_short_label_Valid() const{
    return m_short_label_isValid;
}

bool OAIPriceRangesEntity::isSet() const {
...
bool OAIPriceRangesEntity::isValid() const {
