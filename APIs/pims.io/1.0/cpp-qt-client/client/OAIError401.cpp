...
QString OAIError401::getDetail() const {
    return m_detail;
}
void OAIError401::setDetail(const QString &detail) {
    m_detail = detail;
    m_detail_isSet = true;
}

bool OAIError401::is_detail_Set() const{
    return m_detail_isSet;
}

bool OAIError401::is_detail_Valid() const{
    return m_detail_isValid;
}

qint32 OAIError401::getStatus() const {
    return m_status;
}
void OAIError401::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIError401::is_status_Set() const{
    return m_status_isSet;
}

bool OAIError401::is_status_Valid() const{
...
QString OAIError401::getType() const {
    return m_type;
}
void OAIError401::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIError401::is_type_Set() const{
    return m_type_isSet;
}

bool OAIError401::is_type_Valid() const{
