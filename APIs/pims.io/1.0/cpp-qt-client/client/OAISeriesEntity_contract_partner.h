...
/*
 * OAISeriesEntity_contract_partner.h
 *
 * Contract partner.
 */

#ifndef OAISeriesEntity_contract_partner_H
#define OAISeriesEntity_contract_partner_H
...
class OAISeriesEntity_contract_partner : public OAIObject {
public:
    OAISeriesEntity_contract_partner();
    OAISeriesEntity_contract_partner(QString json);
    ~OAISeriesEntity_contract_partner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISeriesEntity_contract_partner)

#endif // OAISeriesEntity_contract_partner_H
