...
OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner() {
    this->initializeModel();
}

OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::~OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner() {}

void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::initializeModel() {
...
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::fromJson(QString jsonString) {
...
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::fromJsonObject(QJsonObject json) {
...
QString OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::asJson() const {
...
QJsonObject OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_currency_isSet) {
...
QString OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::getCurrency() const {
    return m_currency;
}
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::is_currency_Valid() const{
    return m_currency_isValid;
}

float OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::getGross() const {
    return m_gross;
}
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::setGross(const float &gross) {
    m_gross = gross;
    m_gross_isSet = true;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::is_gross_Set() const{
    return m_gross_isSet;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::is_gross_Valid() const{
    return m_gross_isValid;
}

qint32 OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::getId() const {
    return m_id;
}
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::getReservations() const {
    return m_reservations;
}
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::setReservations(const qint32 &reservations) {
    m_reservations = reservations;
    m_reservations_isSet = true;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::is_reservations_Set() const{
    return m_reservations_isSet;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::is_reservations_Valid() const{
    return m_reservations_isValid;
}

qint32 OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::getSales() const {
    return m_sales;
}
void OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::setSales(const qint32 &sales) {
    m_sales = sales;
    m_sales_isSet = true;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::is_sales_Set() const{
    return m_sales_isSet;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::is_sales_Valid() const{
    return m_sales_isValid;
}

bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::isSet() const {
...
bool OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner_event_price_ranges_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_currency_isValid && m_gross_isValid && m_id_isValid && m_sales_isValid && true;
}
