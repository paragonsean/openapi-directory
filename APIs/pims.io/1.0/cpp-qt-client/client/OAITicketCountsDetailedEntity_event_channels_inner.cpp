...
#include "OAITicketCountsDetailedEntity_event_channels_inner.h"
...
OAITicketCountsDetailedEntity_event_channels_inner::OAITicketCountsDetailedEntity_event_channels_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITicketCountsDetailedEntity_event_channels_inner::OAITicketCountsDetailedEntity_event_channels_inner() {
    this->initializeModel();
}

OAITicketCountsDetailedEntity_event_channels_inner::~OAITicketCountsDetailedEntity_event_channels_inner() {}

void OAITicketCountsDetailedEntity_event_channels_inner::initializeModel() {
...
void OAITicketCountsDetailedEntity_event_channels_inner::fromJson(QString jsonString) {
...
void OAITicketCountsDetailedEntity_event_channels_inner::fromJsonObject(QJsonObject json) {
...
QString OAITicketCountsDetailedEntity_event_channels_inner::asJson() const {
...
QJsonObject OAITicketCountsDetailedEntity_event_channels_inner::asJsonObject() const {
    QJsonObject obj;
...
QList<OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner> OAITicketCountsDetailedEntity_event_channels_inner::getEventCategories() const {
    return m_event_categories;
}
void OAITicketCountsDetailedEntity_event_channels_inner::setEventCategories(const QList<OAITicketCountsDetailedEntity_event_channels_inner_event_categories_inner> &event_categories) {
    m_event_categories = event_categories;
    m_event_categories_isSet = true;
}

bool OAITicketCountsDetailedEntity_event_channels_inner::is_event_categories_Set() const{
    return m_event_categories_isSet;
}

bool OAITicketCountsDetailedEntity_event_channels_inner::is_event_categories_Valid() const{
    return m_event_categories_isValid;
}

qint32 OAITicketCountsDetailedEntity_event_channels_inner::getId() const {
    return m_id;
}
void OAITicketCountsDetailedEntity_event_channels_inner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAITicketCountsDetailedEntity_event_channels_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAITicketCountsDetailedEntity_event_channels_inner::is_id_Valid() const{
    return m_id_isValid;
}

bool OAITicketCountsDetailedEntity_event_channels_inner::isSet() const {
...
bool OAITicketCountsDetailedEntity_event_channels_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_event_categories_isValid && m_id_isValid && true;
}
