...
void OAIPromotionsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("fetchAllEventsPromotions", defaultConf);
    _serverIndices.insert("fetchAllEventsPromotions", 0);
    _serverConfigs.insert("fetchAllPromotions", defaultConf);
    _serverIndices.insert("fetchAllPromotions", 0);
    _serverConfigs.insert("fetchAllSeriesPromotions", defaultConf);
    _serverIndices.insert("fetchAllSeriesPromotions", 0);
    _serverConfigs.insert("fetchOnePromotion", defaultConf);
    _serverIndices.insert("fetchOnePromotion", 0);
}
...
void OAIPromotionsApi::fetchAllEventsPromotions(const qint32 &event_id, const ::OpenAPI::OptionalParam<QString> &label, const ::OpenAPI::OptionalParam<QDate> &from_date, const ::OpenAPI::OptionalParam<QDate> &to_date, const ::OpenAPI::OptionalParam<QString> &type, const ::OpenAPI::OptionalParam<QString> &family, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllEventsPromotions"][_serverIndices.value("fetchAllEventsPromotions")].URL()+"/events/{event_id}/promotions");
    ...
    if (family.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "family", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPromotionsApi::fetchAllEventsPromotionsCallback);
...
void OAIPromotionsApi::fetchAllEventsPromotionsCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIPromotionsEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIPromotionsEntity val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllEventsPromotionsSignal(output);
        Q_EMIT fetchAllEventsPromotionsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllEventsPromotionsSignalE(output, error_type, error_str);
        Q_EMIT fetchAllEventsPromotionsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllEventsPromotionsSignalError(output, error_type, error_str);
        Q_EMIT fetchAllEventsPromotionsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPromotionsApi::fetchAllPromotions(const ::OpenAPI::OptionalParam<QString> &label, const ::OpenAPI::OptionalParam<QDate> &from_date, const ::OpenAPI::OptionalParam<QDate> &to_date, const ::OpenAPI::OptionalParam<QString> &type, const ::OpenAPI::OptionalParam<QString> &family, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllPromotions"][_serverIndices.value("fetchAllPromotions")].URL()+"/promotions");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPromotionsApi::fetchAllPromotionsCallback);
    connect(this, &OAIPromotionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPromotionsApi::fetchAllPromotionsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllPromotionsSignal(output);
        Q_EMIT fetchAllPromotionsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllPromotionsSignalE(output, error_type, error_str);
        Q_EMIT fetchAllPromotionsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllPromotionsSignalError(output, error_type, error_str);
        Q_EMIT fetchAllPromotionsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPromotionsApi::fetchAllSeriesPromotions(const qint32 &series_id, const ::OpenAPI::OptionalParam<QString> &label, const ::OpenAPI::OptionalParam<QDate> &from_date, const ::OpenAPI::OptionalParam<QDate> &to_date, const ::OpenAPI::OptionalParam<QString> &type, const ::OpenAPI::OptionalParam<QString> &family, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchAllSeriesPromotions"][_serverIndices.value("fetchAllSeriesPromotions")].URL()+"/series/{series_id}/promotions");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPromotionsApi::fetchAllSeriesPromotionsCallback);
    connect(this, &OAIPromotionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPromotionsApi::fetchAllSeriesPromotionsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchAllSeriesPromotionsSignal(output);
        Q_EMIT fetchAllSeriesPromotionsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchAllSeriesPromotionsSignalE(output, error_type, error_str);
        Q_EMIT fetchAllSeriesPromotionsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchAllSeriesPromotionsSignalError(output, error_type, error_str);
        Q_EMIT fetchAllSeriesPromotionsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPromotionsApi::fetchOnePromotion(const qint32 &promotion_id, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["fetchOnePromotion"][_serverIndices.value("fetchOnePromotion")].URL()+"/promotions/{promotion_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPromotionsApi::fetchOnePromotionCallback);
    connect(this, &OAIPromotionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPromotionsApi::fetchOnePromotionCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIPromotionsEntity output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fetchOnePromotionSignal(output);
        Q_EMIT fetchOnePromotionSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fetchOnePromotionSignalE(output, error_type, error_str);
        Q_EMIT fetchOnePromotionSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fetchOnePromotionSignalError(output, error_type, error_str);
        Q_EMIT fetchOnePromotionSignalErrorFull(worker, error_type, error_str);
    }
}
