...
#include "OAISeriesEntity_type.h"
...
OAISeriesEntity_type::OAISeriesEntity_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISeriesEntity_type::OAISeriesEntity_type() {
    this->initializeModel();
}

OAISeriesEntity_type::~OAISeriesEntity_type() {}

void OAISeriesEntity_type::initializeModel() {
...
void OAISeriesEntity_type::fromJson(QString jsonString) {
...
void OAISeriesEntity_type::fromJsonObject(QJsonObject json) {
...
QString OAISeriesEntity_type::asJson() const {
...
QJsonObject OAISeriesEntity_type::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAISeriesEntity_type::getId() const {
    return m_id;
}
void OAISeriesEntity_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISeriesEntity_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAISeriesEntity_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISeriesEntity_type::getLabel() const {
    return m_label;
}
void OAISeriesEntity_type::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAISeriesEntity_type::is_label_Set() const{
    return m_label_isSet;
}

bool OAISeriesEntity_type::is_label_Valid() const{
    return m_label_isValid;
}

bool OAISeriesEntity_type::isSet() const {
...
bool OAISeriesEntity_type::isValid() const {
