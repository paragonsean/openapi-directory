...
#include "OAIPromotionsEntity_type_family.h"
...
OAIPromotionsEntity_type_family::OAIPromotionsEntity_type_family(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPromotionsEntity_type_family::OAIPromotionsEntity_type_family() {
    this->initializeModel();
}

OAIPromotionsEntity_type_family::~OAIPromotionsEntity_type_family() {}

void OAIPromotionsEntity_type_family::initializeModel() {
...
void OAIPromotionsEntity_type_family::fromJson(QString jsonString) {
...
void OAIPromotionsEntity_type_family::fromJsonObject(QJsonObject json) {
...
QString OAIPromotionsEntity_type_family::asJson() const {
...
QJsonObject OAIPromotionsEntity_type_family::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIPromotionsEntity_type_family::getId() const {
    return m_id;
}
void OAIPromotionsEntity_type_family::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPromotionsEntity_type_family::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPromotionsEntity_type_family::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPromotionsEntity_type_family::getLabel() const {
    return m_label;
}
void OAIPromotionsEntity_type_family::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIPromotionsEntity_type_family::is_label_Set() const{
    return m_label_isSet;
}

bool OAIPromotionsEntity_type_family::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIPromotionsEntity_type_family::isSet() const {
...
bool OAIPromotionsEntity_type_family::isValid() const {
