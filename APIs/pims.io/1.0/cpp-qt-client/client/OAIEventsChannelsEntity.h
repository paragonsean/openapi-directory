...
/*
 * OAIEventsChannelsEntity.h
 *
 * 
 */

#ifndef OAIEventsChannelsEntity_H
#define OAIEventsChannelsEntity_H
...
namespace OpenAPI {
class OAIChannelsEntity;

class OAIEventsChannelsEntity : public OAIObject {
public:
    OAIEventsChannelsEntity();
    OAIEventsChannelsEntity(QString json);
    ~OAIEventsChannelsEntity() override;
    ...
    OAIChannelsEntity getChannel() const;
    void setChannel(const OAIChannelsEntity &channel);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsChannelsEntity)

#endif // OAIEventsChannelsEntity_H
