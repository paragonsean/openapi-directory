...
/*
 * OAISeriesEntity_type.h
 *
 * Type of the series
 */

#ifndef OAISeriesEntity_type_H
#define OAISeriesEntity_type_H
...
class OAISeriesEntity_type : public OAIObject {
public:
    OAISeriesEntity_type();
    OAISeriesEntity_type(QString json);
    ~OAISeriesEntity_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISeriesEntity_type)

#endif // OAISeriesEntity_type_H
