...
/*
 * OAIEventsEntity_contract_partner.h
 *
 * Contract partner.
 */

#ifndef OAIEventsEntity_contract_partner_H
#define OAIEventsEntity_contract_partner_H
...
class OAIEventsEntity_contract_partner : public OAIObject {
public:
    OAIEventsEntity_contract_partner();
    OAIEventsEntity_contract_partner(QString json);
    ~OAIEventsEntity_contract_partner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventsEntity_contract_partner)

#endif // OAIEventsEntity_contract_partner_H
