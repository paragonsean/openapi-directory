...
public:
    ...
    */
    virtual void fetchAllVenues(const ::OpenAPI::OptionalParam<QString> &label = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &city = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &country_code = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &sort = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  venue_id qint32 [required]
    * @param[in]  accept_language QString [optional]
    */
    virtual void fetchOneVenue(const qint32 &venue_id, const ::OpenAPI::OptionalParam<QString> &accept_language = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void fetchAllVenuesCallback(OAIHttpRequestWorker *worker);
    void fetchOneVenueCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAllVenuesSignal(QList<OAIVenuesEntity> summary);
    void fetchOneVenueSignal(OAIVenuesEntity summary);


    void fetchAllVenuesSignalFull(OAIHttpRequestWorker *worker, QList<OAIVenuesEntity> summary);
    void fetchOneVenueSignalFull(OAIHttpRequestWorker *worker, OAIVenuesEntity summary);

    Q_DECL_DEPRECATED_X("Use fetchAllVenuesSignalError() instead")
    void fetchAllVenuesSignalE(QList<OAIVenuesEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllVenuesSignalError(QList<OAIVenuesEntity> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneVenueSignalError() instead")
    void fetchOneVenueSignalE(OAIVenuesEntity summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneVenueSignalError(OAIVenuesEntity summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAllVenuesSignalErrorFull() instead")
    void fetchAllVenuesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAllVenuesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchOneVenueSignalErrorFull() instead")
    void fetchOneVenueSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchOneVenueSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
