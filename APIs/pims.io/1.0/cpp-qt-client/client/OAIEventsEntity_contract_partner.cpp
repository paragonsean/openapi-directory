...
#include "OAIEventsEntity_contract_partner.h"
...
OAIEventsEntity_contract_partner::OAIEventsEntity_contract_partner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventsEntity_contract_partner::OAIEventsEntity_contract_partner() {
    this->initializeModel();
}

OAIEventsEntity_contract_partner::~OAIEventsEntity_contract_partner() {}

void OAIEventsEntity_contract_partner::initializeModel() {
...
void OAIEventsEntity_contract_partner::fromJson(QString jsonString) {
...
void OAIEventsEntity_contract_partner::fromJsonObject(QJsonObject json) {
...
QString OAIEventsEntity_contract_partner::asJson() const {
...
QJsonObject OAIEventsEntity_contract_partner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint32 OAIEventsEntity_contract_partner::getId() const {
    return m_id;
}
void OAIEventsEntity_contract_partner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEventsEntity_contract_partner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEventsEntity_contract_partner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIEventsEntity_contract_partner::getLabel() const {
    return m_label;
}
void OAIEventsEntity_contract_partner::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIEventsEntity_contract_partner::is_label_Set() const{
    return m_label_isSet;
}

bool OAIEventsEntity_contract_partner::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIEventsEntity_contract_partner::isSet() const {
...
bool OAIEventsEntity_contract_partner::isValid() const {
