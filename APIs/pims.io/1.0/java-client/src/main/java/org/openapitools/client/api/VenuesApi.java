...
public class VenuesApi {
    ...
    /**
     * Build call for fetchAllVenues
     * @param label Find only the venues whose label contains this value. (optional)
     * @param city Find only the venues whose city contains this value. (optional)
     * @param countryCode Find only the venues whose country_code is equal to this value. (optional)
     * @param type Find only the venues whose type is equal to this value. (optional)
     * @param sort Sort the venues in the corresponding order. (optional, default to label)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Successful operation, gives an array of venues </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call fetchAllVenuesCall(String label, String city, String countryCode, String type, String sort, Integer pageSize, String acceptLanguage, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call fetchAllVenuesValidateBeforeCall(String label, String city, String countryCode, String type, String sort, Integer pageSize, String acceptLanguage, final ApiCallback _callback) throws ApiException {
        return fetchAllVenuesCall(label, city, countryCode, type, sort, pageSize, acceptLanguage, _callback);
     ...
     */
    public List<VenuesEntity> fetchAllVenues(String label, String city, String countryCode, String type, String sort, Integer pageSize, String acceptLanguage) throws ApiException {
        ApiResponse<List<VenuesEntity>> localVarResp = fetchAllVenuesWithHttpInfo(label, city, countryCode, type, sort, pageSize, acceptLanguage);
     ...
     * @param pageSize Pagination size, i.e. maximum number of items to be displayed in the response. (optional, default to 25)
     * @param acceptLanguage Language used for the translatable labels. (optional, default to en)
     * @return ApiResponse&lt;List&lt;VenuesEntity&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<VenuesEntity>> fetchAllVenuesWithHttpInfo(String label, String city, String countryCode, String type, String sort, Integer pageSize, String acceptLanguage) throws ApiException {
        okhttp3.Call localVarCall = fetchAllVenuesValidateBeforeCall(label, city, countryCode, type, sort, pageSize, acceptLanguage, null);
        Type localVarReturnType = new TypeToken<List<VenuesEntity>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Find all venues (asynchronously)
     * 
     * @param label Find only the venues whose label contains this value. (optional)
     * @param city Find only the venues whose city contains this value. (optional)
     * @param countryCode Find only the venues whose country_code is equal to this value. (optional)
     ...
     */
    public okhttp3.Call fetchAllVenuesAsync(String label, String city, String countryCode, String type, String sort, Integer pageSize, String acceptLanguage, final ApiCallback<List<VenuesEntity>> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchAllVenuesValidateBeforeCall(label, city, countryCode, type, sort, pageSize, acceptLanguage, _callback);
        Type localVarReturnType = new TypeToken<List<VenuesEntity>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for fetchOneVenue
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successful operation, gives one venue </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized, no authentication was made </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden, the authentication is wrong </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call fetchOneVenueCall(Integer venueId, String acceptLanguage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/venues/{venue_id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fetchOneVenueValidateBeforeCall(Integer venueId, String acceptLanguage, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'venueId' is set
        if (venueId == null) {
            throw new ApiException("Missing the required parameter 'venueId' when calling fetchOneVenue(Async)");
        }

        return fetchOneVenueCall(venueId, acceptLanguage, _callback);
     ...
     */
    public VenuesEntity fetchOneVenue(Integer venueId, String acceptLanguage) throws ApiException {
        ApiResponse<VenuesEntity> localVarResp = fetchOneVenueWithHttpInfo(venueId, acceptLanguage);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VenuesEntity> fetchOneVenueWithHttpInfo(Integer venueId, String acceptLanguage) throws ApiException {
        okhttp3.Call localVarCall = fetchOneVenueValidateBeforeCall(venueId, acceptLanguage, null);
        Type localVarReturnType = new TypeToken<VenuesEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get one venue by ID (asynchronously)
     * 
     * @param venueId ID of the targeted venue. (required)
     * @param acceptLanguage Language used for the translatable labels. (optional, default to en)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call fetchOneVenueAsync(Integer venueId, String acceptLanguage, final ApiCallback<VenuesEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchOneVenueValidateBeforeCall(venueId, acceptLanguage, _callback);
        Type localVarReturnType = new TypeToken<VenuesEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
