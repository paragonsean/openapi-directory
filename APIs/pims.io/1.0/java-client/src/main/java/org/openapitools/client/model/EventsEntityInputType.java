...
public class EventsEntityInputType {
  /**
  ...
  public EventsEntityInputType() {
  }

  public EventsEntityInputType id(IdEnum id) {
    this.id = id;
    return this;
  }
  ...
  public EventsEntityInputType label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EventsEntityInputType eventsEntityInputType = (EventsEntityInputType) o;
    return Objects.equals(this.id, eventsEntityInputType.id) &&
        Objects.equals(this.label, eventsEntityInputType.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsEntityInputType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventsEntityInputType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventsEntityInputType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsEntityInputType is not found in the empty JSON string", EventsEntityInputType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventsEntityInputType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventsEntityInputType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventsEntityInputType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsEntityInputType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsEntityInputType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsEntityInputType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsEntityInputType.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsEntityInputType>() {
           @Override
           public void write(JsonWriter out, EventsEntityInputType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventsEntityInputType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventsEntityInputType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventsEntityInputType
   * @throws IOException if the JSON string is invalid with respect to EventsEntityInputType
   */
  public static EventsEntityInputType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsEntityInputType.class);
  }

  /**
   * Convert an instance of EventsEntityInputType to an JSON string
   *
   * @return JSON string
   */
