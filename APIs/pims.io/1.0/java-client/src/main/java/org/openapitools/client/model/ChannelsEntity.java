...
public class ChannelsEntity {
  ...
  public ChannelsEntity id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ChannelsEntity ignored(Boolean ignored) {
  ...
  public ChannelsEntity label(String label) {
    this.label = label;
    return this;
  }
  ...
  public ChannelsEntity lastUpdateTimestamp(Long lastUpdateTimestamp) {
  ...
  public ChannelsEntity shortLabel(String shortLabel) {
  ...
  public boolean equals(Object o) {
    ...
    ChannelsEntity channelsEntity = (ChannelsEntity) o;
    return Objects.equals(this.id, channelsEntity.id) &&
        Objects.equals(this.ignored, channelsEntity.ignored) &&
        Objects.equals(this.label, channelsEntity.label) &&
        Objects.equals(this.lastUpdateTimestamp, channelsEntity.lastUpdateTimestamp) &&
        Objects.equals(this.shortLabel, channelsEntity.shortLabel);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChannelsEntity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChannelsEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelsEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelsEntity is not found in the empty JSON string", ChannelsEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChannelsEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelsEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ChannelsEntity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelsEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelsEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelsEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelsEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelsEntity>() {
           @Override
           public void write(JsonWriter out, ChannelsEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelsEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChannelsEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChannelsEntity
   * @throws IOException if the JSON string is invalid with respect to ChannelsEntity
   */
  public static ChannelsEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChannelsEntity.class);
  }

  /**
   * Convert an instance of ChannelsEntity to an JSON string
   *
   * @return JSON string
   */
