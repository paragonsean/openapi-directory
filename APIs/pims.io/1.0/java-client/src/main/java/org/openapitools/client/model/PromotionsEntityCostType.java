...
public class PromotionsEntityCostType {
  /**
  ...
  public PromotionsEntityCostType() {
  }

  public PromotionsEntityCostType id(IdEnum id) {
    this.id = id;
    return this;
  }
  ...
  public PromotionsEntityCostType label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PromotionsEntityCostType promotionsEntityCostType = (PromotionsEntityCostType) o;
    return Objects.equals(this.id, promotionsEntityCostType.id) &&
        Objects.equals(this.label, promotionsEntityCostType.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class PromotionsEntityCostType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromotionsEntityCostType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromotionsEntityCostType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PromotionsEntityCostType is not found in the empty JSON string", PromotionsEntityCostType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PromotionsEntityCostType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PromotionsEntityCostType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PromotionsEntityCostType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromotionsEntityCostType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromotionsEntityCostType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromotionsEntityCostType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromotionsEntityCostType.class));

       return (TypeAdapter<T>) new TypeAdapter<PromotionsEntityCostType>() {
           @Override
           public void write(JsonWriter out, PromotionsEntityCostType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PromotionsEntityCostType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PromotionsEntityCostType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromotionsEntityCostType
   * @throws IOException if the JSON string is invalid with respect to PromotionsEntityCostType
   */
  public static PromotionsEntityCostType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromotionsEntityCostType.class);
  }

  /**
   * Convert an instance of PromotionsEntityCostType to an JSON string
   *
   * @return JSON string
   */
