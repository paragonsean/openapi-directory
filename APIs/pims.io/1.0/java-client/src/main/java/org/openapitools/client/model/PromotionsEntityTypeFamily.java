...
public class PromotionsEntityTypeFamily {
  ...
  public PromotionsEntityTypeFamily() {
  }

  public PromotionsEntityTypeFamily id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PromotionsEntityTypeFamily label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PromotionsEntityTypeFamily promotionsEntityTypeFamily = (PromotionsEntityTypeFamily) o;
    return Objects.equals(this.id, promotionsEntityTypeFamily.id) &&
        Objects.equals(this.label, promotionsEntityTypeFamily.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class PromotionsEntityTypeFamily {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromotionsEntityTypeFamily
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromotionsEntityTypeFamily.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PromotionsEntityTypeFamily is not found in the empty JSON string", PromotionsEntityTypeFamily.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PromotionsEntityTypeFamily.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PromotionsEntityTypeFamily` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PromotionsEntityTypeFamily.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromotionsEntityTypeFamily.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromotionsEntityTypeFamily' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromotionsEntityTypeFamily> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromotionsEntityTypeFamily.class));

       return (TypeAdapter<T>) new TypeAdapter<PromotionsEntityTypeFamily>() {
           @Override
           public void write(JsonWriter out, PromotionsEntityTypeFamily value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PromotionsEntityTypeFamily read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PromotionsEntityTypeFamily given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromotionsEntityTypeFamily
   * @throws IOException if the JSON string is invalid with respect to PromotionsEntityTypeFamily
   */
  public static PromotionsEntityTypeFamily fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromotionsEntityTypeFamily.class);
  }

  /**
   * Convert an instance of PromotionsEntityTypeFamily to an JSON string
   *
   * @return JSON string
   */
