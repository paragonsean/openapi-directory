...
public class PromotionsEntityCostState {
  /**
  ...
  public PromotionsEntityCostState() {
  }

  public PromotionsEntityCostState id(IdEnum id) {
    this.id = id;
    return this;
  }
  ...
  public PromotionsEntityCostState label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PromotionsEntityCostState promotionsEntityCostState = (PromotionsEntityCostState) o;
    return Objects.equals(this.id, promotionsEntityCostState.id) &&
        Objects.equals(this.label, promotionsEntityCostState.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class PromotionsEntityCostState {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromotionsEntityCostState
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromotionsEntityCostState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PromotionsEntityCostState is not found in the empty JSON string", PromotionsEntityCostState.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PromotionsEntityCostState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PromotionsEntityCostState` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PromotionsEntityCostState.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromotionsEntityCostState.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromotionsEntityCostState' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromotionsEntityCostState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromotionsEntityCostState.class));

       return (TypeAdapter<T>) new TypeAdapter<PromotionsEntityCostState>() {
           @Override
           public void write(JsonWriter out, PromotionsEntityCostState value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PromotionsEntityCostState read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PromotionsEntityCostState given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromotionsEntityCostState
   * @throws IOException if the JSON string is invalid with respect to PromotionsEntityCostState
   */
  public static PromotionsEntityCostState fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromotionsEntityCostState.class);
  }

  /**
   * Convert an instance of PromotionsEntityCostState to an JSON string
   *
   * @return JSON string
   */
