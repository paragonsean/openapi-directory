...
public class Error422 {
  ...
  public Error422 detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public Error422 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public Error422 title(String title) {
    this.title = title;
    return this;
  }
  ...
  public Error422 type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.detail, error422.detail) &&
        Objects.equals(this.status, error422.status) &&
        Objects.equals(this.title, error422.title) &&
        Objects.equals(this.type, error422.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Error422
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Error422.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Error422.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Error422` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Error422.openapiRequiredFields) {
