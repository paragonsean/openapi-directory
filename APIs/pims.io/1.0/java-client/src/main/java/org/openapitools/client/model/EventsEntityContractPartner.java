...
public class EventsEntityContractPartner {
  ...
  public EventsEntityContractPartner() {
  }

  public EventsEntityContractPartner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public EventsEntityContractPartner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EventsEntityContractPartner eventsEntityContractPartner = (EventsEntityContractPartner) o;
    return Objects.equals(this.id, eventsEntityContractPartner.id) &&
        Objects.equals(this.label, eventsEntityContractPartner.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsEntityContractPartner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventsEntityContractPartner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventsEntityContractPartner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsEntityContractPartner is not found in the empty JSON string", EventsEntityContractPartner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventsEntityContractPartner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventsEntityContractPartner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventsEntityContractPartner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsEntityContractPartner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsEntityContractPartner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsEntityContractPartner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsEntityContractPartner.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsEntityContractPartner>() {
           @Override
           public void write(JsonWriter out, EventsEntityContractPartner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventsEntityContractPartner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventsEntityContractPartner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventsEntityContractPartner
   * @throws IOException if the JSON string is invalid with respect to EventsEntityContractPartner
   */
  public static EventsEntityContractPartner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsEntityContractPartner.class);
  }

  /**
   * Convert an instance of EventsEntityContractPartner to an JSON string
   *
   * @return JSON string
   */
