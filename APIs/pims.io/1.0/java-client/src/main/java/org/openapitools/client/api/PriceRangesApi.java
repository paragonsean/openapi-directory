...
import org.openapitools.client.model.PriceRangesEntity;
...
public class PriceRangesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PriceRangesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PriceRangesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for fetchAllPriceRanges
     * @param label Find only the price ranges whose label contains this value. (optional)
     * @param showIgnored If set to &#x60;false&#x60;, show only the price ranges which are not ignored. If set to &#x60;true&#x60;, show all price ranges. (optional, default to false)
     * @param sort Sort the price ranges in the corresponding order. (optional, default to label)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Successful operation, gives an array of price ranges </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call fetchAllPriceRangesCall(String label, Boolean showIgnored, String sort, Integer pageSize, String acceptLanguage, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/price-ranges";
    ...
    private okhttp3.Call fetchAllPriceRangesValidateBeforeCall(String label, Boolean showIgnored, String sort, Integer pageSize, String acceptLanguage, final ApiCallback _callback) throws ApiException {
        return fetchAllPriceRangesCall(label, showIgnored, sort, pageSize, acceptLanguage, _callback);
     ...
     */
    public List<PriceRangesEntity> fetchAllPriceRanges(String label, Boolean showIgnored, String sort, Integer pageSize, String acceptLanguage) throws ApiException {
        ApiResponse<List<PriceRangesEntity>> localVarResp = fetchAllPriceRangesWithHttpInfo(label, showIgnored, sort, pageSize, acceptLanguage);
     ...
     * @param pageSize Pagination size, i.e. maximum number of items to be displayed in the response. (optional, default to 25)
     * @param acceptLanguage Language used for the translatable labels. (optional, default to en)
     * @return ApiResponse&lt;List&lt;PriceRangesEntity&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<PriceRangesEntity>> fetchAllPriceRangesWithHttpInfo(String label, Boolean showIgnored, String sort, Integer pageSize, String acceptLanguage) throws ApiException {
        okhttp3.Call localVarCall = fetchAllPriceRangesValidateBeforeCall(label, showIgnored, sort, pageSize, acceptLanguage, null);
        Type localVarReturnType = new TypeToken<List<PriceRangesEntity>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Find all price ranges (asynchronously)
     * 
     * @param label Find only the price ranges whose label contains this value. (optional)
     * @param showIgnored If set to &#x60;false&#x60;, show only the price ranges which are not ignored. If set to &#x60;true&#x60;, show all price ranges. (optional, default to false)
     * @param sort Sort the price ranges in the corresponding order. (optional, default to label)
     ...
     */
    public okhttp3.Call fetchAllPriceRangesAsync(String label, Boolean showIgnored, String sort, Integer pageSize, String acceptLanguage, final ApiCallback<List<PriceRangesEntity>> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchAllPriceRangesValidateBeforeCall(label, showIgnored, sort, pageSize, acceptLanguage, _callback);
        Type localVarReturnType = new TypeToken<List<PriceRangesEntity>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for fetchOnePriceRange
     * @param priceRangeId ID of the targeted price range. (required)
     * @param acceptLanguage Language used for the translatable labels. (optional, default to en)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successful operation, gives one price range </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized, no authentication was made </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden, the authentication is wrong </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call fetchOnePriceRangeCall(Integer priceRangeId, String acceptLanguage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/price-ranges/{price_range_id}"
            .replace("{" + "price_range_id" + "}", localVarApiClient.escapeString(priceRangeId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fetchOnePriceRangeValidateBeforeCall(Integer priceRangeId, String acceptLanguage, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'priceRangeId' is set
        if (priceRangeId == null) {
            throw new ApiException("Missing the required parameter 'priceRangeId' when calling fetchOnePriceRange(Async)");
        }

        return fetchOnePriceRangeCall(priceRangeId, acceptLanguage, _callback);
     ...
     */
    public VenuesEntity fetchOnePriceRange(Integer priceRangeId, String acceptLanguage) throws ApiException {
        ApiResponse<VenuesEntity> localVarResp = fetchOnePriceRangeWithHttpInfo(priceRangeId, acceptLanguage);
        return localVarResp.getData();
    }
     ...
     * @param priceRangeId ID of the targeted price range. (required)
     * @param acceptLanguage Language used for the translatable labels. (optional, default to en)
     * @return ApiResponse&lt;VenuesEntity&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<VenuesEntity> fetchOnePriceRangeWithHttpInfo(Integer priceRangeId, String acceptLanguage) throws ApiException {
        okhttp3.Call localVarCall = fetchOnePriceRangeValidateBeforeCall(priceRangeId, acceptLanguage, null);
        Type localVarReturnType = new TypeToken<VenuesEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get one price range by ID (asynchronously)
     * 
     * @param priceRangeId ID of the targeted price range. (required)
     * @param acceptLanguage Language used for the translatable labels. (optional, default to en)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call fetchOnePriceRangeAsync(Integer priceRangeId, String acceptLanguage, final ApiCallback<VenuesEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchOnePriceRangeValidateBeforeCall(priceRangeId, acceptLanguage, _callback);
        Type localVarReturnType = new TypeToken<VenuesEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
