...
public class EventsCategoriesEntityEventPriceRangesInner {
  ...
  private PriceRangesEntity priceRange;

  public static final String SERIALIZED_NAME_PUBLIC_PRICE = "public_price";
  @SerializedName(SERIALIZED_NAME_PUBLIC_PRICE)
  private Float publicPrice;

  public EventsCategoriesEntityEventPriceRangesInner() {
  }

  public EventsCategoriesEntityEventPriceRangesInner basePrice(Float basePrice) {
  ...
  public EventsCategoriesEntityEventPriceRangesInner currency(String currency) {
  ...
  public EventsCategoriesEntityEventPriceRangesInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public EventsCategoriesEntityEventPriceRangesInner ignored(Boolean ignored) {
  ...
  public EventsCategoriesEntityEventPriceRangesInner priceRange(PriceRangesEntity priceRange) {
   ...
   */
  @javax.annotation.Nonnull
  public PriceRangesEntity getPriceRange() {
    return priceRange;
  }

  public void setPriceRange(PriceRangesEntity priceRange) {
    this.priceRange = priceRange;
  }


  public EventsCategoriesEntityEventPriceRangesInner publicPrice(Float publicPrice) {
  ...
  public boolean equals(Object o) {
    ...
    EventsCategoriesEntityEventPriceRangesInner eventsCategoriesEntityEventPriceRangesInner = (EventsCategoriesEntityEventPriceRangesInner) o;
    return Objects.equals(this.basePrice, eventsCategoriesEntityEventPriceRangesInner.basePrice) &&
        Objects.equals(this.currency, eventsCategoriesEntityEventPriceRangesInner.currency) &&
        Objects.equals(this.id, eventsCategoriesEntityEventPriceRangesInner.id) &&
        Objects.equals(this.ignored, eventsCategoriesEntityEventPriceRangesInner.ignored) &&
        Objects.equals(this.priceRange, eventsCategoriesEntityEventPriceRangesInner.priceRange) &&
        Objects.equals(this.publicPrice, eventsCategoriesEntityEventPriceRangesInner.publicPrice);
  }

  @Override
  public int hashCode() {
    return Objects.hash(basePrice, currency, id, ignored, priceRange, publicPrice);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EventsCategoriesEntityEventPriceRangesInner {\n");
    ...
    sb.append("    publicPrice: ").append(toIndentedString(publicPrice)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("public_price");
    ...
    openapiRequiredFields.add("price_range");
    openapiRequiredFields.add("public_price");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventsCategoriesEntityEventPriceRangesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventsCategoriesEntityEventPriceRangesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsCategoriesEntityEventPriceRangesInner is not found in the empty JSON string", EventsCategoriesEntityEventPriceRangesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventsCategoriesEntityEventPriceRangesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventsCategoriesEntityEventPriceRangesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventsCategoriesEntityEventPriceRangesInner.openapiRequiredFields) {
      ...
      // validate the required field `price_range`
      PriceRangesEntity.validateJsonElement(jsonObj.get("price_range"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsCategoriesEntityEventPriceRangesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsCategoriesEntityEventPriceRangesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsCategoriesEntityEventPriceRangesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsCategoriesEntityEventPriceRangesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsCategoriesEntityEventPriceRangesInner>() {
           @Override
           public void write(JsonWriter out, EventsCategoriesEntityEventPriceRangesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventsCategoriesEntityEventPriceRangesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventsCategoriesEntityEventPriceRangesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventsCategoriesEntityEventPriceRangesInner
   * @throws IOException if the JSON string is invalid with respect to EventsCategoriesEntityEventPriceRangesInner
   */
  public static EventsCategoriesEntityEventPriceRangesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsCategoriesEntityEventPriceRangesInner.class);
  }

  /**
   * Convert an instance of EventsCategoriesEntityEventPriceRangesInner to an JSON string
   *
   * @return JSON string
   */
