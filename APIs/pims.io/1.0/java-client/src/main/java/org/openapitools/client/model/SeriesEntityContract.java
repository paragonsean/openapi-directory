...
import org.openapitools.client.model.SeriesEntityContractPartner;
import org.openapitools.client.model.SeriesEntityContractType;
...
public class SeriesEntityContract {
  public static final String SERIALIZED_NAME_PARTNER = "partner";
  @SerializedName(SERIALIZED_NAME_PARTNER)
  private SeriesEntityContractPartner partner;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private SeriesEntityContractType type;

  public SeriesEntityContract() {
  }

  public SeriesEntityContract partner(SeriesEntityContractPartner partner) {
  ...
  public SeriesEntityContractPartner getPartner() {
    return partner;
  }

  public void setPartner(SeriesEntityContractPartner partner) {
    this.partner = partner;
  }


  public SeriesEntityContract type(SeriesEntityContractType type) {
    this.type = type;
    return this;
  }
  ...
  public SeriesEntityContractType getType() {
    return type;
  }

  public void setType(SeriesEntityContractType type) {
    this.type = type;
  }
  ...
  public boolean equals(Object o) {
    ...
    SeriesEntityContract seriesEntityContract = (SeriesEntityContract) o;
    return Objects.equals(this.partner, seriesEntityContract.partner) &&
        Objects.equals(this.type, seriesEntityContract.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(partner, type);
  }
  ...
  public String toString() {
    ...
    sb.append("class SeriesEntityContract {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SeriesEntityContract
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SeriesEntityContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SeriesEntityContract is not found in the empty JSON string", SeriesEntityContract.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SeriesEntityContract.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SeriesEntityContract` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SeriesEntityContract.openapiRequiredFields) {
      ...
      if (jsonObj.get("partner") != null && !jsonObj.get("partner").isJsonNull()) {
        SeriesEntityContractPartner.validateJsonElement(jsonObj.get("partner"));
      }
      // validate the required field `type`
      SeriesEntityContractType.validateJsonElement(jsonObj.get("type"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SeriesEntityContract.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SeriesEntityContract' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SeriesEntityContract> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SeriesEntityContract.class));

       return (TypeAdapter<T>) new TypeAdapter<SeriesEntityContract>() {
           @Override
           public void write(JsonWriter out, SeriesEntityContract value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SeriesEntityContract read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SeriesEntityContract given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SeriesEntityContract
   * @throws IOException if the JSON string is invalid with respect to SeriesEntityContract
   */
  public static SeriesEntityContract fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SeriesEntityContract.class);
  }

  /**
   * Convert an instance of SeriesEntityContract to an JSON string
   *
   * @return JSON string
   */
