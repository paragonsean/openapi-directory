...
import org.openapitools.client.model.PromotionsEntityCostState;
import org.openapitools.client.model.PromotionsEntityCostType;
...
public class PromotionsEntityCost {
  ...
  private PromotionsEntityCostState state;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private PromotionsEntityCostType type;
  ...
  public PromotionsEntityCost() {
  }

  public PromotionsEntityCost currency(String currency) {
  ...
  public PromotionsEntityCost exchange(String exchange) {
  ...
  public PromotionsEntityCost quantity(Float quantity) {
  ...
  public PromotionsEntityCost state(PromotionsEntityCostState state) {
    this.state = state;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PromotionsEntityCostState getState() {
    return state;
  }

  public void setState(PromotionsEntityCostState state) {
    this.state = state;
  }


  public PromotionsEntityCost type(PromotionsEntityCostType type) {
    this.type = type;
    return this;
  }
  ...
  public PromotionsEntityCostType getType() {
    return type;
  }

  public void setType(PromotionsEntityCostType type) {
    this.type = type;
  }


  public PromotionsEntityCost unitCost(Float unitCost) {
  ...
  public PromotionsEntityCost valorizedQuantity(Float valorizedQuantity) {
  ...
  public PromotionsEntityCost valorizedUnitCost(Float valorizedUnitCost) {
  ...
  public boolean equals(Object o) {
    ...
    PromotionsEntityCost promotionsEntityCost = (PromotionsEntityCost) o;
    return Objects.equals(this.currency, promotionsEntityCost.currency) &&
        Objects.equals(this.exchange, promotionsEntityCost.exchange) &&
        Objects.equals(this.quantity, promotionsEntityCost.quantity) &&
        Objects.equals(this.state, promotionsEntityCost.state) &&
        Objects.equals(this.type, promotionsEntityCost.type) &&
        Objects.equals(this.unitCost, promotionsEntityCost.unitCost) &&
        Objects.equals(this.valorizedQuantity, promotionsEntityCost.valorizedQuantity) &&
        Objects.equals(this.valorizedUnitCost, promotionsEntityCost.valorizedUnitCost);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currency, exchange, quantity, state, type, unitCost, valorizedQuantity, valorizedUnitCost);
  }
  ...
  public String toString() {
    ...
    sb.append("class PromotionsEntityCost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromotionsEntityCost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromotionsEntityCost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PromotionsEntityCost is not found in the empty JSON string", PromotionsEntityCost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PromotionsEntityCost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PromotionsEntityCost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PromotionsEntityCost.openapiRequiredFields) {
      ...
      if (jsonObj.get("state") != null && !jsonObj.get("state").isJsonNull()) {
        PromotionsEntityCostState.validateJsonElement(jsonObj.get("state"));
      }
      // validate the required field `type`
      PromotionsEntityCostType.validateJsonElement(jsonObj.get("type"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromotionsEntityCost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromotionsEntityCost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromotionsEntityCost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromotionsEntityCost.class));

       return (TypeAdapter<T>) new TypeAdapter<PromotionsEntityCost>() {
           @Override
           public void write(JsonWriter out, PromotionsEntityCost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PromotionsEntityCost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PromotionsEntityCost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromotionsEntityCost
   * @throws IOException if the JSON string is invalid with respect to PromotionsEntityCost
   */
  public static PromotionsEntityCost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromotionsEntityCost.class);
  }

  /**
   * Convert an instance of PromotionsEntityCost to an JSON string
   *
   * @return JSON string
   */
