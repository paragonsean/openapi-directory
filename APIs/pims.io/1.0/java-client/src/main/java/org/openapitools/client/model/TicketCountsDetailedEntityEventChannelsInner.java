...
import org.openapitools.client.model.TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner;
...
public class TicketCountsDetailedEntityEventChannelsInner {
  ...
  private List<TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner> eventCategories = new ArrayList<>();

  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Integer id;

  public TicketCountsDetailedEntityEventChannelsInner() {
  }

  public TicketCountsDetailedEntityEventChannelsInner eventCategories(List<TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner> eventCategories) {
    this.eventCategories = eventCategories;
    return this;
  }

  public TicketCountsDetailedEntityEventChannelsInner addEventCategoriesItem(TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner eventCategoriesItem) {
  ...
  public List<TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner> getEventCategories() {
    return eventCategories;
  }

  public void setEventCategories(List<TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner> eventCategories) {
    this.eventCategories = eventCategories;
  }


  public TicketCountsDetailedEntityEventChannelsInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TicketCountsDetailedEntityEventChannelsInner ticketCountsDetailedEntityEventChannelsInner = (TicketCountsDetailedEntityEventChannelsInner) o;
    return Objects.equals(this.eventCategories, ticketCountsDetailedEntityEventChannelsInner.eventCategories) &&
        Objects.equals(this.id, ticketCountsDetailedEntityEventChannelsInner.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventCategories, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TicketCountsDetailedEntityEventChannelsInner {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("event_categories");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TicketCountsDetailedEntityEventChannelsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TicketCountsDetailedEntityEventChannelsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TicketCountsDetailedEntityEventChannelsInner is not found in the empty JSON string", TicketCountsDetailedEntityEventChannelsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TicketCountsDetailedEntityEventChannelsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TicketCountsDetailedEntityEventChannelsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TicketCountsDetailedEntityEventChannelsInner.openapiRequiredFields) {
      ...
      // validate the required field `event_categories` (array)
      for (int i = 0; i < jsonArrayeventCategories.size(); i++) {
        TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.validateJsonElement(jsonArrayeventCategories.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TicketCountsDetailedEntityEventChannelsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TicketCountsDetailedEntityEventChannelsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TicketCountsDetailedEntityEventChannelsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TicketCountsDetailedEntityEventChannelsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<TicketCountsDetailedEntityEventChannelsInner>() {
           @Override
           public void write(JsonWriter out, TicketCountsDetailedEntityEventChannelsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TicketCountsDetailedEntityEventChannelsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TicketCountsDetailedEntityEventChannelsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TicketCountsDetailedEntityEventChannelsInner
   * @throws IOException if the JSON string is invalid with respect to TicketCountsDetailedEntityEventChannelsInner
   */
  public static TicketCountsDetailedEntityEventChannelsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TicketCountsDetailedEntityEventChannelsInner.class);
  }

  /**
   * Convert an instance of TicketCountsDetailedEntityEventChannelsInner to an JSON string
   *
   * @return JSON string
   */
