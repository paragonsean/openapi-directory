...
public class SeriesEntityContractType {
  /**
  ...
  public SeriesEntityContractType() {
  }

  public SeriesEntityContractType id(IdEnum id) {
    this.id = id;
    return this;
  }
  ...
  public SeriesEntityContractType label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SeriesEntityContractType seriesEntityContractType = (SeriesEntityContractType) o;
    return Objects.equals(this.id, seriesEntityContractType.id) &&
        Objects.equals(this.label, seriesEntityContractType.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class SeriesEntityContractType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SeriesEntityContractType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SeriesEntityContractType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SeriesEntityContractType is not found in the empty JSON string", SeriesEntityContractType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SeriesEntityContractType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SeriesEntityContractType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SeriesEntityContractType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SeriesEntityContractType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SeriesEntityContractType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SeriesEntityContractType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SeriesEntityContractType.class));

       return (TypeAdapter<T>) new TypeAdapter<SeriesEntityContractType>() {
           @Override
           public void write(JsonWriter out, SeriesEntityContractType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SeriesEntityContractType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SeriesEntityContractType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SeriesEntityContractType
   * @throws IOException if the JSON string is invalid with respect to SeriesEntityContractType
   */
  public static SeriesEntityContractType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SeriesEntityContractType.class);
  }

  /**
   * Convert an instance of SeriesEntityContractType to an JSON string
   *
   * @return JSON string
   */
