...
import org.openapitools.client.model.TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner;
...
public class TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner {
  public static final String SERIALIZED_NAME_EVENT_PRICE_RANGES = "event_price_ranges";
  @SerializedName(SERIALIZED_NAME_EVENT_PRICE_RANGES)
  private List<TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner> eventPriceRanges = new ArrayList<>();

  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Integer id;

  public TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner() {
  }

  public TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner eventPriceRanges(List<TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner> eventPriceRanges) {
    this.eventPriceRanges = eventPriceRanges;
    return this;
  }

  public TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner addEventPriceRangesItem(TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner eventPriceRangesItem) {
    if (this.eventPriceRanges == null) {
      this.eventPriceRanges = new ArrayList<>();
    }
    this.eventPriceRanges.add(eventPriceRangesItem);
    return this;
  }

  /**
   * Array of event price ranges which where sold.
   * @return eventPriceRanges
   */
  @javax.annotation.Nonnull
  public List<TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner> getEventPriceRanges() {
    return eventPriceRanges;
  }

  public void setEventPriceRanges(List<TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner> eventPriceRanges) {
    this.eventPriceRanges = eventPriceRanges;
  }


  public TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner ticketCountsDetailedEntityEventChannelsInnerEventCategoriesInner = (TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner) o;
    return Objects.equals(this.eventPriceRanges, ticketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.eventPriceRanges) &&
        Objects.equals(this.id, ticketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventPriceRanges, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner {\n");
    sb.append("    eventPriceRanges: ").append(toIndentedString(eventPriceRanges)).append("\n");
  ...
  static {
    ...
    openapiFields.add("event_price_ranges");
    openapiFields.add("id");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("event_price_ranges");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner is not found in the empty JSON string", TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.openapiRequiredFields) {
      ...
      if (!jsonObj.get("event_price_ranges").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `event_price_ranges` to be an array in the JSON string but got `%s`", jsonObj.get("event_price_ranges").toString()));
      }

      JsonArray jsonArrayeventPriceRanges = jsonObj.getAsJsonArray("event_price_ranges");
      // validate the required field `event_price_ranges` (array)
      for (int i = 0; i < jsonArrayeventPriceRanges.size(); i++) {
        TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner.validateJsonElement(jsonArrayeventPriceRanges.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner>() {
           @Override
           public void write(JsonWriter out, TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner
   * @throws IOException if the JSON string is invalid with respect to TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner
   */
  public static TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.class);
  }

  /**
   * Convert an instance of TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner to an JSON string
   *
   * @return JSON string
   */
