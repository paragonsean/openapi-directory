...
public class PriceRangesEntity {
  ...
  public PriceRangesEntity() {
  }

  public PriceRangesEntity id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public PriceRangesEntity ignored(Boolean ignored) {
  ...
  public PriceRangesEntity label(String label) {
    this.label = label;
    return this;
  }
  ...
  public PriceRangesEntity lastUpdateTimestamp(Long lastUpdateTimestamp) {
  ...
  public PriceRangesEntity shortLabel(String shortLabel) {
  ...
  public boolean equals(Object o) {
    ...
    PriceRangesEntity priceRangesEntity = (PriceRangesEntity) o;
    return Objects.equals(this.id, priceRangesEntity.id) &&
        Objects.equals(this.ignored, priceRangesEntity.ignored) &&
        Objects.equals(this.label, priceRangesEntity.label) &&
        Objects.equals(this.lastUpdateTimestamp, priceRangesEntity.lastUpdateTimestamp) &&
        Objects.equals(this.shortLabel, priceRangesEntity.shortLabel);
  }
  ...
  public String toString() {
    ...
    sb.append("class PriceRangesEntity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PriceRangesEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PriceRangesEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PriceRangesEntity is not found in the empty JSON string", PriceRangesEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PriceRangesEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PriceRangesEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PriceRangesEntity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PriceRangesEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PriceRangesEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PriceRangesEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PriceRangesEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<PriceRangesEntity>() {
           @Override
           public void write(JsonWriter out, PriceRangesEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PriceRangesEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PriceRangesEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PriceRangesEntity
   * @throws IOException if the JSON string is invalid with respect to PriceRangesEntity
   */
  public static PriceRangesEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PriceRangesEntity.class);
  }

  /**
   * Convert an instance of PriceRangesEntity to an JSON string
   *
   * @return JSON string
   */
