...
import org.openapitools.client.model.EventsEntityContractPartner;
import org.openapitools.client.model.EventsEntityContractType;
...
public class EventsEntityContract {
  public static final String SERIALIZED_NAME_PARTNER = "partner";
  @SerializedName(SERIALIZED_NAME_PARTNER)
  private EventsEntityContractPartner partner;

  public static final String SERIALIZED_NAME_TYPE = "type";
  @SerializedName(SERIALIZED_NAME_TYPE)
  private EventsEntityContractType type;

  public EventsEntityContract() {
  }

  public EventsEntityContract partner(EventsEntityContractPartner partner) {
  ...
  public EventsEntityContractPartner getPartner() {
    return partner;
  }

  public void setPartner(EventsEntityContractPartner partner) {
    this.partner = partner;
  }


  public EventsEntityContract type(EventsEntityContractType type) {
    this.type = type;
    return this;
  }
  ...
  public EventsEntityContractType getType() {
    return type;
  }

  public void setType(EventsEntityContractType type) {
    this.type = type;
  }
  ...
  public boolean equals(Object o) {
    ...
    EventsEntityContract eventsEntityContract = (EventsEntityContract) o;
    return Objects.equals(this.partner, eventsEntityContract.partner) &&
        Objects.equals(this.type, eventsEntityContract.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsEntityContract {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventsEntityContract
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventsEntityContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsEntityContract is not found in the empty JSON string", EventsEntityContract.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventsEntityContract.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventsEntityContract` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventsEntityContract.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `partner`
      EventsEntityContractPartner.validateJsonElement(jsonObj.get("partner"));
      // validate the required field `type`
      EventsEntityContractType.validateJsonElement(jsonObj.get("type"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsEntityContract.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsEntityContract' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsEntityContract> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsEntityContract.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsEntityContract>() {
           @Override
           public void write(JsonWriter out, EventsEntityContract value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventsEntityContract read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventsEntityContract given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventsEntityContract
   * @throws IOException if the JSON string is invalid with respect to EventsEntityContract
   */
  public static EventsEntityContract fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsEntityContract.class);
  }

  /**
   * Convert an instance of EventsEntityContract to an JSON string
   *
   * @return JSON string
   */
