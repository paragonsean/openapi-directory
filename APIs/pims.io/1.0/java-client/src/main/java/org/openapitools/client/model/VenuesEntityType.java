...
public class VenuesEntityType {
  ...
  public VenuesEntityType() {
  }

  public VenuesEntityType id(IdEnum id) {
    this.id = id;
    return this;
  }
  ...
  public VenuesEntityType label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VenuesEntityType venuesEntityType = (VenuesEntityType) o;
    return Objects.equals(this.id, venuesEntityType.id) &&
        Objects.equals(this.label, venuesEntityType.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class VenuesEntityType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VenuesEntityType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VenuesEntityType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VenuesEntityType is not found in the empty JSON string", VenuesEntityType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VenuesEntityType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VenuesEntityType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VenuesEntityType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VenuesEntityType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VenuesEntityType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VenuesEntityType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VenuesEntityType.class));

       return (TypeAdapter<T>) new TypeAdapter<VenuesEntityType>() {
           @Override
           public void write(JsonWriter out, VenuesEntityType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VenuesEntityType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VenuesEntityType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VenuesEntityType
   * @throws IOException if the JSON string is invalid with respect to VenuesEntityType
   */
  public static VenuesEntityType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VenuesEntityType.class);
  }

  /**
   * Convert an instance of VenuesEntityType to an JSON string
   *
   * @return JSON string
   */
