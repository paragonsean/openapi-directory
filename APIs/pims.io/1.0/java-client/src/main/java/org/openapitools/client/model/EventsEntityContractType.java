...
public class EventsEntityContractType {
  /**
  ...
  public EventsEntityContractType() {
  }

  public EventsEntityContractType id(IdEnum id) {
    this.id = id;
    return this;
  }
  ...
  public EventsEntityContractType label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EventsEntityContractType eventsEntityContractType = (EventsEntityContractType) o;
    return Objects.equals(this.id, eventsEntityContractType.id) &&
        Objects.equals(this.label, eventsEntityContractType.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsEntityContractType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventsEntityContractType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventsEntityContractType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsEntityContractType is not found in the empty JSON string", EventsEntityContractType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventsEntityContractType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventsEntityContractType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventsEntityContractType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsEntityContractType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsEntityContractType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsEntityContractType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsEntityContractType.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsEntityContractType>() {
           @Override
           public void write(JsonWriter out, EventsEntityContractType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventsEntityContractType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventsEntityContractType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventsEntityContractType
   * @throws IOException if the JSON string is invalid with respect to EventsEntityContractType
   */
  public static EventsEntityContractType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsEntityContractType.class);
  }

  /**
   * Convert an instance of EventsEntityContractType to an JSON string
   *
   * @return JSON string
   */
