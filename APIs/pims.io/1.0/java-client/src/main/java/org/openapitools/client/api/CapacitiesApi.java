...
import org.openapitools.client.model.EventsCapacitiesEntity;
...
public class CapacitiesApi {
    ...
    /**
     * Build call for fetchAllEventsCapacities
     * @param eventId ID of the targeted event. (required)
     * @param showIgnored If set to &#x60;false&#x60;, show only the [event-]categories which are not ignored. If set to &#x60;true&#x60;, show everything. (optional, default to false)
     * @param sort Sort the capacities in the corresponding order. (optional, default to date)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Successful operation, gives an array of events capacities </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call fetchAllEventsCapacitiesCall(Integer eventId, Boolean showIgnored, String sort, Integer pageSize, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/events/{event_id}/capacities"
    ...
    private okhttp3.Call fetchAllEventsCapacitiesValidateBeforeCall(Integer eventId, Boolean showIgnored, String sort, Integer pageSize, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'eventId' is set
        if (eventId == null) {
            throw new ApiException("Missing the required parameter 'eventId' when calling fetchAllEventsCapacities(Async)");
        }

        return fetchAllEventsCapacitiesCall(eventId, showIgnored, sort, pageSize, _callback);
     ...
     * @param sort Sort the capacities in the corresponding order. (optional, default to date)
     * @param pageSize Pagination size, i.e. maximum number of items to be displayed in the response. (optional, default to 25)
     * @return List&lt;EventsCapacitiesEntity&gt;
     ...
     */
    public List<EventsCapacitiesEntity> fetchAllEventsCapacities(Integer eventId, Boolean showIgnored, String sort, Integer pageSize) throws ApiException {
        ApiResponse<List<EventsCapacitiesEntity>> localVarResp = fetchAllEventsCapacitiesWithHttpInfo(eventId, showIgnored, sort, pageSize);
     ...
     * @param sort Sort the capacities in the corresponding order. (optional, default to date)
     * @param pageSize Pagination size, i.e. maximum number of items to be displayed in the response. (optional, default to 25)
     * @return ApiResponse&lt;List&lt;EventsCapacitiesEntity&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<EventsCapacitiesEntity>> fetchAllEventsCapacitiesWithHttpInfo(Integer eventId, Boolean showIgnored, String sort, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = fetchAllEventsCapacitiesValidateBeforeCall(eventId, showIgnored, sort, pageSize, null);
        Type localVarReturnType = new TypeToken<List<EventsCapacitiesEntity>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Find all capacities for one event (asynchronously)
     * 
     * @param eventId ID of the targeted event. (required)
     * @param showIgnored If set to &#x60;false&#x60;, show only the [event-]categories which are not ignored. If set to &#x60;true&#x60;, show everything. (optional, default to false)
     * @param sort Sort the capacities in the corresponding order. (optional, default to date)
     ...
     */
    public okhttp3.Call fetchAllEventsCapacitiesAsync(Integer eventId, Boolean showIgnored, String sort, Integer pageSize, final ApiCallback<List<EventsCapacitiesEntity>> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchAllEventsCapacitiesValidateBeforeCall(eventId, showIgnored, sort, pageSize, _callback);
        Type localVarReturnType = new TypeToken<List<EventsCapacitiesEntity>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for fetchOneEventCapacity
     * @param eventId ID of the targeted event. (required)
     * @param capacityId ID of the targeted capacity. (required)
     * @param showIgnored If set to &#x60;false&#x60;, show only the [event-]categories which are not ignored. If set to &#x60;true&#x60;, show everything. (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successful operation, gives one event capacity </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized, no authentication was made </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden, the authentication is wrong </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call fetchOneEventCapacityCall(Integer eventId, Integer capacityId, Boolean showIgnored, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/events/{event_id}/capacities/{capacity_id}"
            .replace("{" + "event_id" + "}", localVarApiClient.escapeString(eventId.toString()))
            .replace("{" + "capacity_id" + "}", localVarApiClient.escapeString(capacityId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fetchOneEventCapacityValidateBeforeCall(Integer eventId, Integer capacityId, Boolean showIgnored, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'eventId' is set
        if (eventId == null) {
            throw new ApiException("Missing the required parameter 'eventId' when calling fetchOneEventCapacity(Async)");
        }

        // verify the required parameter 'capacityId' is set
        if (capacityId == null) {
            throw new ApiException("Missing the required parameter 'capacityId' when calling fetchOneEventCapacity(Async)");
        }

        return fetchOneEventCapacityCall(eventId, capacityId, showIgnored, _callback);
     ...
     */
    public EventsCapacitiesEntity fetchOneEventCapacity(Integer eventId, Integer capacityId, Boolean showIgnored) throws ApiException {
        ApiResponse<EventsCapacitiesEntity> localVarResp = fetchOneEventCapacityWithHttpInfo(eventId, capacityId, showIgnored);
        return localVarResp.getData();
    }
     ...
     * @param capacityId ID of the targeted capacity. (required)
     * @param showIgnored If set to &#x60;false&#x60;, show only the [event-]categories which are not ignored. If set to &#x60;true&#x60;, show everything. (optional, default to false)
     * @return ApiResponse&lt;EventsCapacitiesEntity&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<EventsCapacitiesEntity> fetchOneEventCapacityWithHttpInfo(Integer eventId, Integer capacityId, Boolean showIgnored) throws ApiException {
        okhttp3.Call localVarCall = fetchOneEventCapacityValidateBeforeCall(eventId, capacityId, showIgnored, null);
        Type localVarReturnType = new TypeToken<EventsCapacitiesEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get one capacity by ID (asynchronously)
     * 
     * @param eventId ID of the targeted event. (required)
     * @param capacityId ID of the targeted capacity. (required)
     * @param showIgnored If set to &#x60;false&#x60;, show only the [event-]categories which are not ignored. If set to &#x60;true&#x60;, show everything. (optional, default to false)
     ...
     */
    public okhttp3.Call fetchOneEventCapacityAsync(Integer eventId, Integer capacityId, Boolean showIgnored, final ApiCallback<EventsCapacitiesEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchOneEventCapacityValidateBeforeCall(eventId, capacityId, showIgnored, _callback);
        Type localVarReturnType = new TypeToken<EventsCapacitiesEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
