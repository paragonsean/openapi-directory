...
public class EventsChannelsEntity {
  ...
  public EventsChannelsEntity() {
  }

  public EventsChannelsEntity channel(ChannelsEntity channel) {
  ...
  public void setChannel(ChannelsEntity channel) {
    this.channel = channel;
  }


  public EventsChannelsEntity id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public EventsChannelsEntity ignored(Boolean ignored) {
  ...
  public boolean equals(Object o) {
    ...
    EventsChannelsEntity eventsChannelsEntity = (EventsChannelsEntity) o;
    return Objects.equals(this.channel, eventsChannelsEntity.channel) &&
        Objects.equals(this.id, eventsChannelsEntity.id) &&
        Objects.equals(this.ignored, eventsChannelsEntity.ignored);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channel, id, ignored);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EventsChannelsEntity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventsChannelsEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventsChannelsEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsChannelsEntity is not found in the empty JSON string", EventsChannelsEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventsChannelsEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventsChannelsEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventsChannelsEntity.openapiRequiredFields) {
      ...
      ChannelsEntity.validateJsonElement(jsonObj.get("channel"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsChannelsEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsChannelsEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsChannelsEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsChannelsEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsChannelsEntity>() {
           @Override
           public void write(JsonWriter out, EventsChannelsEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventsChannelsEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventsChannelsEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventsChannelsEntity
   * @throws IOException if the JSON string is invalid with respect to EventsChannelsEntity
   */
  public static EventsChannelsEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsChannelsEntity.class);
  }

  /**
   * Convert an instance of EventsChannelsEntity to an JSON string
   *
   * @return JSON string
   */
