...
public class PromotionsEntitySupplier {
  ...
  public PromotionsEntitySupplier() {
  }

  public PromotionsEntitySupplier id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public PromotionsEntitySupplier label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PromotionsEntitySupplier promotionsEntitySupplier = (PromotionsEntitySupplier) o;
    return Objects.equals(this.id, promotionsEntitySupplier.id) &&
        Objects.equals(this.label, promotionsEntitySupplier.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class PromotionsEntitySupplier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PromotionsEntitySupplier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PromotionsEntitySupplier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PromotionsEntitySupplier is not found in the empty JSON string", PromotionsEntitySupplier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PromotionsEntitySupplier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PromotionsEntitySupplier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PromotionsEntitySupplier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PromotionsEntitySupplier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PromotionsEntitySupplier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PromotionsEntitySupplier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PromotionsEntitySupplier.class));

       return (TypeAdapter<T>) new TypeAdapter<PromotionsEntitySupplier>() {
           @Override
           public void write(JsonWriter out, PromotionsEntitySupplier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PromotionsEntitySupplier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PromotionsEntitySupplier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PromotionsEntitySupplier
   * @throws IOException if the JSON string is invalid with respect to PromotionsEntitySupplier
   */
  public static PromotionsEntitySupplier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PromotionsEntitySupplier.class);
  }

  /**
   * Convert an instance of PromotionsEntitySupplier to an JSON string
   *
   * @return JSON string
   */
