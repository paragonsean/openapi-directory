...
public class CategoriesEntity {
  ...
  public static final String SERIALIZED_NAME_SHORT_LABEL = "short_label";
  ...
  public CategoriesEntity id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public CategoriesEntity ignored(Boolean ignored) {
  ...
  public CategoriesEntity label(String label) {
    this.label = label;
    return this;
  }
  ...
  public CategoriesEntity lastUpdateTimestamp(Long lastUpdateTimestamp) {
  ...
  public CategoriesEntity shortLabel(String shortLabel) {
  ...
  public boolean equals(Object o) {
    ...
    CategoriesEntity categoriesEntity = (CategoriesEntity) o;
    return Objects.equals(this.id, categoriesEntity.id) &&
        Objects.equals(this.ignored, categoriesEntity.ignored) &&
        Objects.equals(this.label, categoriesEntity.label) &&
        Objects.equals(this.lastUpdateTimestamp, categoriesEntity.lastUpdateTimestamp) &&
        Objects.equals(this.shortLabel, categoriesEntity.shortLabel);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, ignored, label, lastUpdateTimestamp, shortLabel);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CategoriesEntity {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("short_label");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CategoriesEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CategoriesEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CategoriesEntity is not found in the empty JSON string", CategoriesEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CategoriesEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CategoriesEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CategoriesEntity.openapiRequiredFields) {
      ...
      if ((jsonObj.get("short_label") != null && !jsonObj.get("short_label").isJsonNull()) && !jsonObj.get("short_label").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `short_label` to be a primitive type in the JSON string but got `%s`", jsonObj.get("short_label").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CategoriesEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CategoriesEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CategoriesEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CategoriesEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<CategoriesEntity>() {
           @Override
           public void write(JsonWriter out, CategoriesEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CategoriesEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CategoriesEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CategoriesEntity
   * @throws IOException if the JSON string is invalid with respect to CategoriesEntity
   */
  public static CategoriesEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CategoriesEntity.class);
  }

  /**
   * Convert an instance of CategoriesEntity to an JSON string
   *
   * @return JSON string
   */
