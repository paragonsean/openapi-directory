...
import org.openapitools.client.model.TicketCountsDetailedEntityEventChannelsInner;
...
public class TicketCountsDetailedEntity {
  ...
  public static final String SERIALIZED_NAME_EVENT_CHANNELS = "event_channels";
  @SerializedName(SERIALIZED_NAME_EVENT_CHANNELS)
  private List<TicketCountsDetailedEntityEventChannelsInner> eventChannels = new ArrayList<>();
  ...
  public TicketCountsDetailedEntity() {
  }

  public TicketCountsDetailedEntity approved(Boolean approved) {
  ...
  public TicketCountsDetailedEntity comment(String comment) {
  ...
  public TicketCountsDetailedEntity date(LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  public TicketCountsDetailedEntity eventChannels(List<TicketCountsDetailedEntityEventChannelsInner> eventChannels) {
    this.eventChannels = eventChannels;
    return this;
  }

  public TicketCountsDetailedEntity addEventChannelsItem(TicketCountsDetailedEntityEventChannelsInner eventChannelsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<TicketCountsDetailedEntityEventChannelsInner> getEventChannels() {
    return eventChannels;
  }

  public void setEventChannels(List<TicketCountsDetailedEntityEventChannelsInner> eventChannels) {
    this.eventChannels = eventChannels;
  }


  public TicketCountsDetailedEntity _final(Boolean _final) {
    this._final = _final;
    return this;
  }
  ...
  public TicketCountsDetailedEntity id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TicketCountsDetailedEntity ticketCountsDetailedEntity = (TicketCountsDetailedEntity) o;
    return Objects.equals(this.approved, ticketCountsDetailedEntity.approved) &&
        Objects.equals(this.comment, ticketCountsDetailedEntity.comment) &&
        Objects.equals(this.date, ticketCountsDetailedEntity.date) &&
        Objects.equals(this.eventChannels, ticketCountsDetailedEntity.eventChannels) &&
        Objects.equals(this._final, ticketCountsDetailedEntity._final) &&
        Objects.equals(this.id, ticketCountsDetailedEntity.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(approved, comment, date, eventChannels, _final, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TicketCountsDetailedEntity {\n");
  ...
  static {
    ...
    openapiFields.add("event_channels");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TicketCountsDetailedEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TicketCountsDetailedEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TicketCountsDetailedEntity is not found in the empty JSON string", TicketCountsDetailedEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TicketCountsDetailedEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TicketCountsDetailedEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TicketCountsDetailedEntity.openapiRequiredFields) {
      ...
      if (jsonObj.get("event_channels") != null && !jsonObj.get("event_channels").isJsonNull()) {
        JsonArray jsonArrayeventChannels = jsonObj.getAsJsonArray("event_channels");
        if (jsonArrayeventChannels != null) {
          // ensure the json data is an array
          if (!jsonObj.get("event_channels").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `event_channels` to be an array in the JSON string but got `%s`", jsonObj.get("event_channels").toString()));
          }

          // validate the optional field `event_channels` (array)
          for (int i = 0; i < jsonArrayeventChannels.size(); i++) {
            TicketCountsDetailedEntityEventChannelsInner.validateJsonElement(jsonArrayeventChannels.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TicketCountsDetailedEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TicketCountsDetailedEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TicketCountsDetailedEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TicketCountsDetailedEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<TicketCountsDetailedEntity>() {
           @Override
           public void write(JsonWriter out, TicketCountsDetailedEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TicketCountsDetailedEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TicketCountsDetailedEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TicketCountsDetailedEntity
   * @throws IOException if the JSON string is invalid with respect to TicketCountsDetailedEntity
   */
  public static TicketCountsDetailedEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TicketCountsDetailedEntity.class);
  }

  /**
   * Convert an instance of TicketCountsDetailedEntity to an JSON string
   *
   * @return JSON string
   */
