...
public class SeriesEntityContractPartner {
  ...
  public SeriesEntityContractPartner() {
  }

  public SeriesEntityContractPartner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public SeriesEntityContractPartner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SeriesEntityContractPartner seriesEntityContractPartner = (SeriesEntityContractPartner) o;
    return Objects.equals(this.id, seriesEntityContractPartner.id) &&
        Objects.equals(this.label, seriesEntityContractPartner.label);
  }
  ...
  public String toString() {
    ...
    sb.append("class SeriesEntityContractPartner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SeriesEntityContractPartner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SeriesEntityContractPartner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SeriesEntityContractPartner is not found in the empty JSON string", SeriesEntityContractPartner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SeriesEntityContractPartner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SeriesEntityContractPartner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SeriesEntityContractPartner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SeriesEntityContractPartner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SeriesEntityContractPartner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SeriesEntityContractPartner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SeriesEntityContractPartner.class));

       return (TypeAdapter<T>) new TypeAdapter<SeriesEntityContractPartner>() {
           @Override
           public void write(JsonWriter out, SeriesEntityContractPartner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SeriesEntityContractPartner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SeriesEntityContractPartner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SeriesEntityContractPartner
   * @throws IOException if the JSON string is invalid with respect to SeriesEntityContractPartner
   */
  public static SeriesEntityContractPartner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SeriesEntityContractPartner.class);
  }

  /**
   * Convert an instance of SeriesEntityContractPartner to an JSON string
   *
   * @return JSON string
   */
