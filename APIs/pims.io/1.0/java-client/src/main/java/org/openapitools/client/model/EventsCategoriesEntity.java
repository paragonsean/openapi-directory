...
public class EventsCategoriesEntity {
  ...
  private List<EventsCategoriesEntityEventPriceRangesInner> eventPriceRanges = new ArrayList<>();
  ...
  public EventsCategoriesEntity category(CategoriesEntity category) {
  ...
  public EventsCategoriesEntity eventPriceRanges(List<EventsCategoriesEntityEventPriceRangesInner> eventPriceRanges) {
    this.eventPriceRanges = eventPriceRanges;
    return this;
  }

  public EventsCategoriesEntity addEventPriceRangesItem(EventsCategoriesEntityEventPriceRangesInner eventPriceRangesItem) {
  ...
  public List<EventsCategoriesEntityEventPriceRangesInner> getEventPriceRanges() {
    return eventPriceRanges;
  }

  public void setEventPriceRanges(List<EventsCategoriesEntityEventPriceRangesInner> eventPriceRanges) {
    this.eventPriceRanges = eventPriceRanges;
  }


  public EventsCategoriesEntity id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public EventsCategoriesEntity ignored(Boolean ignored) {
  ...
  public boolean equals(Object o) {
    ...
    EventsCategoriesEntity eventsCategoriesEntity = (EventsCategoriesEntity) o;
    return Objects.equals(this.category, eventsCategoriesEntity.category) &&
        Objects.equals(this.eventPriceRanges, eventsCategoriesEntity.eventPriceRanges) &&
        Objects.equals(this.id, eventsCategoriesEntity.id) &&
        Objects.equals(this.ignored, eventsCategoriesEntity.ignored);
  }

  @Override
  public int hashCode() {
    return Objects.hash(category, eventPriceRanges, id, ignored);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EventsCategoriesEntity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventsCategoriesEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventsCategoriesEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsCategoriesEntity is not found in the empty JSON string", EventsCategoriesEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventsCategoriesEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventsCategoriesEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventsCategoriesEntity.openapiRequiredFields) {
      ...
      CategoriesEntity.validateJsonElement(jsonObj.get("category"));
      if (jsonObj.get("event_price_ranges") != null && !jsonObj.get("event_price_ranges").isJsonNull()) {
        JsonArray jsonArrayeventPriceRanges = jsonObj.getAsJsonArray("event_price_ranges");
        if (jsonArrayeventPriceRanges != null) {
          ...
          for (int i = 0; i < jsonArrayeventPriceRanges.size(); i++) {
            EventsCategoriesEntityEventPriceRangesInner.validateJsonElement(jsonArrayeventPriceRanges.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsCategoriesEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsCategoriesEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsCategoriesEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsCategoriesEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsCategoriesEntity>() {
           @Override
           public void write(JsonWriter out, EventsCategoriesEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventsCategoriesEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventsCategoriesEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventsCategoriesEntity
   * @throws IOException if the JSON string is invalid with respect to EventsCategoriesEntity
   */
  public static EventsCategoriesEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsCategoriesEntity.class);
  }

  /**
   * Convert an instance of EventsCategoriesEntity to an JSON string
   *
   * @return JSON string
   */
