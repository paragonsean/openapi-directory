...
public class VenuesApiTest {
     ...
     */
    @Test
    public void fetchAllVenuesTest() throws ApiException {
        String label = null;
        String city = null;
        ...
        List<VenuesEntity> response = api.fetchAllVenues(label, city, countryCode, type, sort, pageSize, acceptLanguage);
     ...
     */
    @Test
    public void fetchOneVenueTest() throws ApiException {
        Integer venueId = null;
        String acceptLanguage = null;
        VenuesEntity response = api.fetchOneVenue(venueId, acceptLanguage);
        // TODO: test validations
    }
