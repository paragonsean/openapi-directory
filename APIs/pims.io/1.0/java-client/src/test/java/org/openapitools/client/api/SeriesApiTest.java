...
public class SeriesApiTest {
     ...
     */
    @Test
    public void fetchAllSeriesTest() throws ApiException {
        String label = null;
        ...
        List<SeriesEntity> response = api.fetchAllSeries(label, fromDate, toDate, type, sort, pageSize, acceptLanguage);
     ...
     */
    @Test
    public void fetchOneSeriesTest() throws ApiException {
        Integer seriesId = null;
        String acceptLanguage = null;
        SeriesEntity response = api.fetchOneSeries(seriesId, acceptLanguage);
        // TODO: test validations
    }
