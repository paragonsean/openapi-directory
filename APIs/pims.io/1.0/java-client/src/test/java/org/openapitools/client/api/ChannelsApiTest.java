...
public class ChannelsApiTest {
     ...
     */
    @Test
    public void fetchAllChannelsTest() throws ApiException {
        String label = null;
        Boolean showIgnored = null;
        String sort = null;
        Integer pageSize = null;
        String acceptLanguage = null;
        List<ChannelsEntity> response = api.fetchAllChannels(label, showIgnored, sort, pageSize, acceptLanguage);
     ...
     */
    @Test
    public void fetchAllEventsChannelsTest() throws ApiException {
        Integer eventId = null;
        Boolean showIgnored = null;
        Integer pageSize = null;
        List<EventsChannelsEntity> response = api.fetchAllEventsChannels(eventId, showIgnored, pageSize);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void fetchOneChannelTest() throws ApiException {
        Integer channelId = null;
        String acceptLanguage = null;
        ChannelsEntity response = api.fetchOneChannel(channelId, acceptLanguage);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void fetchOneEventChannelTest() throws ApiException {
        Integer eventId = null;
        Integer channelId = null;
        EventsChannelsEntity response = api.fetchOneEventChannel(eventId, channelId);
        // TODO: test validations
    }
