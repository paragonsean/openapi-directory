...
public class CapacitiesApiTest {
     ...
     */
    @Test
    public void fetchAllEventsCapacitiesTest() throws ApiException {
        Integer eventId = null;
        Boolean showIgnored = null;
        String sort = null;
        Integer pageSize = null;
        List<EventsCapacitiesEntity> response = api.fetchAllEventsCapacities(eventId, showIgnored, sort, pageSize);
     ...
     */
    @Test
    public void fetchOneEventCapacityTest() throws ApiException {
        Integer eventId = null;
        Integer capacityId = null;
        Boolean showIgnored = null;
        EventsCapacitiesEntity response = api.fetchOneEventCapacity(eventId, capacityId, showIgnored);
        // TODO: test validations
    }
