...
/**
 * API tests for CountsApi
 */
@Disabled
public class CountsApiTest {

    private final CountsApi api = new CountsApi();
     ...
     */
    @Test
    public void fetchAllDetailedTicketCountsTest() throws ApiException {
        Integer eventId = null;
        LocalDate fromDate = null;
        LocalDate toDate = null;
        Boolean showIgnored = null;
        Boolean showNotApproved = null;
        String sort = null;
        Integer pageSize = null;
        List<TicketCountsDetailedEntity> response = api.fetchAllDetailedTicketCounts(eventId, fromDate, toDate, showIgnored, showNotApproved, sort, pageSize);
     ...
     */
    @Test
    public void fetchAllTicketCountsTest() throws ApiException {
        Integer eventId = null;
        LocalDate fromDate = null;
        LocalDate toDate = null;
        Boolean showIgnored = null;
        ...
        String sort = null;
        Integer pageSize = null;
        List<TicketCountsEntity> response = api.fetchAllTicketCounts(eventId, fromDate, toDate, showIgnored, showNotApproved, sort, pageSize);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void fetchOneDetailedTicketCountTest() throws ApiException {
        Integer eventId = null;
        Integer ticketCountId = null;
        Boolean showIgnored = null;
        TicketCountsDetailedEntity response = api.fetchOneDetailedTicketCount(eventId, ticketCountId, showIgnored);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void fetchOneTicketCountTest() throws ApiException {
        Integer eventId = null;
        Integer ticketCountId = null;
        Boolean showIgnored = null;
        TicketCountsEntity response = api.fetchOneTicketCount(eventId, ticketCountId, showIgnored);
        // TODO: test validations
    }
