...
/**
 * API tests for PriceRangesApi
 */
@Disabled
public class PriceRangesApiTest {

    private final PriceRangesApi api = new PriceRangesApi();
     ...
     */
    @Test
    public void fetchAllPriceRangesTest() throws ApiException {
        String label = null;
        Boolean showIgnored = null;
        String sort = null;
        Integer pageSize = null;
        String acceptLanguage = null;
        List<PriceRangesEntity> response = api.fetchAllPriceRanges(label, showIgnored, sort, pageSize, acceptLanguage);
     ...
     */
    @Test
    public void fetchOnePriceRangeTest() throws ApiException {
        Integer priceRangeId = null;
        String acceptLanguage = null;
        VenuesEntity response = api.fetchOnePriceRange(priceRangeId, acceptLanguage);
        // TODO: test validations
    }
