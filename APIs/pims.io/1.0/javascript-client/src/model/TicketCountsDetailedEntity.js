...
import TicketCountsDetailedEntityEventChannelsInner from './TicketCountsDetailedEntityEventChannelsInner';

/**
 * The TicketCountsDetailedEntity model module.
 * @module model/TicketCountsDetailedEntity
 * @version 1.0
 */
class TicketCountsDetailedEntity {
    /**
     * Constructs a new <code>TicketCountsDetailedEntity</code>.
     * @alias module:model/TicketCountsDetailedEntity
     * @param approved {Boolean} Defines whether this ticket count is approved or not.
     * @param comment {String} Comment for the ticket count.
     * @param date {Date} Date of the ticket count.
     * @param _final {Boolean} Whether this ticket count is the last and final one of its event or not. If it is, it means that no further ticket counts will be added for the event it belongs to.
     * @param id {Number} Unique ID of the ticket count.
     */
    constructor(approved, comment, date, _final, id) { 
        
        TicketCountsDetailedEntity.initialize(this, approved, comment, date, _final, id);
    }
     ...
     */
    static initialize(obj, approved, comment, date, _final, id) { 
    ...
    /**
     * Constructs a <code>TicketCountsDetailedEntity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TicketCountsDetailedEntity} obj Optional instance to populate.
     * @return {module:model/TicketCountsDetailedEntity} The populated <code>TicketCountsDetailedEntity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TicketCountsDetailedEntity();
            ...
            if (data.hasOwnProperty('event_channels')) {
                obj['event_channels'] = ApiClient.convertToType(data['event_channels'], [TicketCountsDetailedEntityEventChannelsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TicketCountsDetailedEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TicketCountsDetailedEntity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TicketCountsDetailedEntity.RequiredProperties) {
        ...
        if (data['event_channels']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['event_channels'])) {
                throw new Error("Expected the field `event_channels` to be an array in the JSON data but got " + data['event_channels']);
            }
            // validate the optional field `event_channels` (array)
            for (const item of data['event_channels']) {
                TicketCountsDetailedEntityEventChannelsInner.validateJSON(item);
            };
        }
...
TicketCountsDetailedEntity.RequiredProperties = ["approved", "comment", "date", "final", "id"];

/**
 * Defines whether this ticket count is approved or not.
 * @member {Boolean} approved
 */
TicketCountsDetailedEntity.prototype['approved'] = undefined;

/**
 * Comment for the ticket count.
 * @member {String} comment
 */
TicketCountsDetailedEntity.prototype['comment'] = undefined;

/**
 * Date of the ticket count.
 * @member {Date} date
 */
TicketCountsDetailedEntity.prototype['date'] = undefined;

/**
 * Array of event channels where the sales were made.
 * @member {Array.<module:model/TicketCountsDetailedEntityEventChannelsInner>} event_channels
 */
TicketCountsDetailedEntity.prototype['event_channels'] = undefined;
 ...
 */
TicketCountsDetailedEntity.prototype['final'] = undefined;

/**
 * Unique ID of the ticket count.
 * @member {Number} id
 */
TicketCountsDetailedEntity.prototype['id'] = undefined;
...
export default TicketCountsDetailedEntity;
