...
/**
 * The PromotionsEntityTypeFamily model module.
 * @module model/PromotionsEntityTypeFamily
 * @version 1.0
 */
class PromotionsEntityTypeFamily {
    /**
     * Constructs a new <code>PromotionsEntityTypeFamily</code>.
     * Family the promotion type belongs to.
     * @alias module:model/PromotionsEntityTypeFamily
     * @param id {String} String identifying the promotion family.
     * @param label {String} Label of the promotion family. This value is translated according to the 'Accept-Language' header.
     */
    constructor(id, label) { 
        
        PromotionsEntityTypeFamily.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>PromotionsEntityTypeFamily</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionsEntityTypeFamily} obj Optional instance to populate.
     * @return {module:model/PromotionsEntityTypeFamily} The populated <code>PromotionsEntityTypeFamily</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsEntityTypeFamily();
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsEntityTypeFamily</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsEntityTypeFamily</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PromotionsEntityTypeFamily.RequiredProperties) {
...
PromotionsEntityTypeFamily.RequiredProperties = ["id", "label"];

/**
 * String identifying the promotion family.
 * @member {String} id
 */
PromotionsEntityTypeFamily.prototype['id'] = undefined;

/**
 * Label of the promotion family. This value is translated according to the 'Accept-Language' header.
 * @member {String} label
 */
PromotionsEntityTypeFamily.prototype['label'] = undefined;
...
export default PromotionsEntityTypeFamily;
