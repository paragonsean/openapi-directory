...
import EventsCapacitiesEntityEventCategoriesInner from './EventsCapacitiesEntityEventCategoriesInner';

/**
 * The EventsCapacitiesEntity model module.
 * @module model/EventsCapacitiesEntity
 * @version 1.0
 */
class EventsCapacitiesEntity {
    /**
     * Constructs a new <code>EventsCapacitiesEntity</code>.
     * @alias module:model/EventsCapacitiesEntity
     * @param date {Date} Date from which the capacity is active.
     * @param id {Number} Unique ID of the event capacity.
     */
    constructor(date, id) { 
        
        EventsCapacitiesEntity.initialize(this, date, id);
    }
    ...
    /**
     * Constructs a <code>EventsCapacitiesEntity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsCapacitiesEntity} obj Optional instance to populate.
     * @return {module:model/EventsCapacitiesEntity} The populated <code>EventsCapacitiesEntity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsCapacitiesEntity();

            if (data.hasOwnProperty('date')) {
                obj['date'] = ApiClient.convertToType(data['date'], 'Date');
            }
            if (data.hasOwnProperty('event_categories')) {
                obj['event_categories'] = ApiClient.convertToType(data['event_categories'], [EventsCapacitiesEntityEventCategoriesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EventsCapacitiesEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsCapacitiesEntity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventsCapacitiesEntity.RequiredProperties) {
        ...
        if (data['event_categories']) { // data not null
            ...
            for (const item of data['event_categories']) {
                EventsCapacitiesEntityEventCategoriesInner.validateJSON(item);
            };
        }
...
EventsCapacitiesEntity.RequiredProperties = ["date", "id"];

/**
 * Date from which the capacity is active.
 * @member {Date} date
 */
EventsCapacitiesEntity.prototype['date'] = undefined;

/**
 * Array of categories with their detailed capacities.
 * @member {Array.<module:model/EventsCapacitiesEntityEventCategoriesInner>} event_categories
 */
EventsCapacitiesEntity.prototype['event_categories'] = undefined;

/**
 * Unique ID of the event capacity.
 * @member {Number} id
 */
EventsCapacitiesEntity.prototype['id'] = undefined;
...
export default EventsCapacitiesEntity;
