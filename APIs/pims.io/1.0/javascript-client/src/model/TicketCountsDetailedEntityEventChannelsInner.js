...
import TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner from './TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner';

/**
 * The TicketCountsDetailedEntityEventChannelsInner model module.
 * @module model/TicketCountsDetailedEntityEventChannelsInner
 * @version 1.0
 */
class TicketCountsDetailedEntityEventChannelsInner {
    /**
     * Constructs a new <code>TicketCountsDetailedEntityEventChannelsInner</code>.
     * @alias module:model/TicketCountsDetailedEntityEventChannelsInner
     * @param eventCategories {Array.<module:model/TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner>} Array of event categories which where sold.
     * @param id {Number} ID of the event channel.
     */
    constructor(eventCategories, id) { 
        
        TicketCountsDetailedEntityEventChannelsInner.initialize(this, eventCategories, id);
    }
     ...
     */
    static initialize(obj, eventCategories, id) { 
        obj['event_categories'] = eventCategories;
        obj['id'] = id;
    }

    /**
     * Constructs a <code>TicketCountsDetailedEntityEventChannelsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TicketCountsDetailedEntityEventChannelsInner} obj Optional instance to populate.
     * @return {module:model/TicketCountsDetailedEntityEventChannelsInner} The populated <code>TicketCountsDetailedEntityEventChannelsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TicketCountsDetailedEntityEventChannelsInner();

            if (data.hasOwnProperty('event_categories')) {
                obj['event_categories'] = ApiClient.convertToType(data['event_categories'], [TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TicketCountsDetailedEntityEventChannelsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TicketCountsDetailedEntityEventChannelsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TicketCountsDetailedEntityEventChannelsInner.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['event_categories']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['event_categories'])) {
                throw new Error("Expected the field `event_categories` to be an array in the JSON data but got " + data['event_categories']);
            }
            // validate the optional field `event_categories` (array)
            for (const item of data['event_categories']) {
                TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.validateJSON(item);
            };
        }
...
TicketCountsDetailedEntityEventChannelsInner.RequiredProperties = ["event_categories", "id"];

/**
 * Array of event categories which where sold.
 * @member {Array.<module:model/TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner>} event_categories
 */
TicketCountsDetailedEntityEventChannelsInner.prototype['event_categories'] = undefined;

/**
 * ID of the event channel.
 * @member {Number} id
 */
TicketCountsDetailedEntityEventChannelsInner.prototype['id'] = undefined;
...
export default TicketCountsDetailedEntityEventChannelsInner;
