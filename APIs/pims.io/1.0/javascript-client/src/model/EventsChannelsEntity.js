...
import ChannelsEntity from './ChannelsEntity';

/**
 * The EventsChannelsEntity model module.
 * @module model/EventsChannelsEntity
 * @version 1.0
 */
class EventsChannelsEntity {
    /**
     * Constructs a new <code>EventsChannelsEntity</code>.
     * @alias module:model/EventsChannelsEntity
     * @param channel {module:model/ChannelsEntity} 
     * @param id {Number} Unique ID of the event channel.
     * @param ignored {Boolean} Defines whether this event channel is ignored or not.
     */
    constructor(channel, id, ignored) { 
        
        EventsChannelsEntity.initialize(this, channel, id, ignored);
    }
     ...
     */
    static initialize(obj, channel, id, ignored) { 
        obj['channel'] = channel;
        obj['id'] = id;
        obj['ignored'] = ignored;
    }
    ...
    /**
     * Constructs a <code>EventsChannelsEntity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsChannelsEntity} obj Optional instance to populate.
     * @return {module:model/EventsChannelsEntity} The populated <code>EventsChannelsEntity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsChannelsEntity();

            if (data.hasOwnProperty('channel')) {
                obj['channel'] = ChannelsEntity.constructFromObject(data['channel']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EventsChannelsEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsChannelsEntity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventsChannelsEntity.RequiredProperties) {
        ...
        if (data['channel']) { // data not null
          ChannelsEntity.validateJSON(data['channel']);
        }
...
EventsChannelsEntity.RequiredProperties = ["channel", "id", "ignored"];

/**
 * @member {module:model/ChannelsEntity} channel
 */
EventsChannelsEntity.prototype['channel'] = undefined;

/**
 * Unique ID of the event channel.
 * @member {Number} id
 */
EventsChannelsEntity.prototype['id'] = undefined;

/**
 * Defines whether this event channel is ignored or not.
 * @member {Boolean} ignored
 */
EventsChannelsEntity.prototype['ignored'] = undefined;
...
export default EventsChannelsEntity;
