...
/**
 * The PriceRangesEntity model module.
 * @module model/PriceRangesEntity
 * @version 1.0
 */
class PriceRangesEntity {
    /**
     * Constructs a new <code>PriceRangesEntity</code>.
     * @alias module:model/PriceRangesEntity
     * @param id {Number} Unique ID of the price range.
     * @param ignored {Boolean} Defines whether this price range is ignored or not.
     * @param label {String} Full label of the price range.
     * @param lastUpdateTimestamp {Number} Timestamp for when the price range was last updated in the customer's database.
     * @param shortLabel {String} Short label of the price range (generally less than 5 characters).
     */
    constructor(id, ignored, label, lastUpdateTimestamp, shortLabel) { 
        
        PriceRangesEntity.initialize(this, id, ignored, label, lastUpdateTimestamp, shortLabel);
    }
    ...
    /**
     * Constructs a <code>PriceRangesEntity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PriceRangesEntity} obj Optional instance to populate.
     * @return {module:model/PriceRangesEntity} The populated <code>PriceRangesEntity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PriceRangesEntity();
    ...
    /**
     * Validates the JSON data with respect to <code>PriceRangesEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PriceRangesEntity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PriceRangesEntity.RequiredProperties) {
...
export default PriceRangesEntity;
