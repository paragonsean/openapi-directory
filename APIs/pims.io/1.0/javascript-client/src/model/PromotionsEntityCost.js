...
import PromotionsEntityCostState from './PromotionsEntityCostState';
import PromotionsEntityCostType from './PromotionsEntityCostType';

/**
 * The PromotionsEntityCost model module.
 * @module model/PromotionsEntityCost
 * @version 1.0
 */
class PromotionsEntityCost {
    /**
     * Constructs a new <code>PromotionsEntityCost</code>.
     * Cost of the promotion.
     * @alias module:model/PromotionsEntityCost
     * @param type {module:model/PromotionsEntityCostType} 
     */
    constructor(type) { 
        
        PromotionsEntityCost.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>PromotionsEntityCost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionsEntityCost} obj Optional instance to populate.
     * @return {module:model/PromotionsEntityCost} The populated <code>PromotionsEntityCost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsEntityCost();
            ...
            if (data.hasOwnProperty('state')) {
                obj['state'] = PromotionsEntityCostState.constructFromObject(data['state']);
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = PromotionsEntityCostType.constructFromObject(data['type']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsEntityCost</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsEntityCost</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PromotionsEntityCost.RequiredProperties) {
        ...
        if (data['state']) { // data not null
          PromotionsEntityCostState.validateJSON(data['state']);
        }
        // validate the optional field `type`
        if (data['type']) { // data not null
          PromotionsEntityCostType.validateJSON(data['type']);
        }
...
PromotionsEntityCost.RequiredProperties = ["type"];

/**
 * Currency of the unit_cost (<a href='https://en.wikipedia.org/wiki/ISO_4217#Active_codes'>ISO 4212 alphabetic code</a>).
 * @member {String} currency
 */
PromotionsEntityCost.prototype['currency'] = undefined;

/**
 * What was offered in exchange of the promotion.
 * @member {String} exchange
 */
PromotionsEntityCost.prototype['exchange'] = undefined;

/**
 * Quantity of the promotion (see unit_cost).
 * @member {Number} quantity
 */
PromotionsEntityCost.prototype['quantity'] = undefined;

/**
 * @member {module:model/PromotionsEntityCostState} state
 */
PromotionsEntityCost.prototype['state'] = undefined;

/**
 * @member {module:model/PromotionsEntityCostType} type
 */
PromotionsEntityCost.prototype['type'] = undefined;
 ...
 */
PromotionsEntityCost.prototype['unit_cost'] = undefined;
 ...
 */
PromotionsEntityCost.prototype['valorized_quantity'] = undefined;
 ...
 */
PromotionsEntityCost.prototype['valorized_unit_cost'] = undefined;
...
export default PromotionsEntityCost;
