...
class Error500 {
    ...
    constructor(detail, status, title, type) { 
        ...
        Error500.initialize(this, detail, status, title, type);
    }
...
Error500.RequiredProperties = ["detail", "status", "title", "type"];

/**
 * Description of the error.
 * @member {String} detail
 */
Error500.prototype['detail'] = undefined;

/**
 * Status code of the error.
 * @member {Number} status
 */
Error500.prototype['status'] = undefined;

/**
 * Message corresponding to the status code.
 * @member {String} title
 */
Error500.prototype['title'] = undefined;

/**
 * Link to RFC 2616 about status codes definitions.
 * @member {String} type
 */
Error500.prototype['type'] = undefined;
