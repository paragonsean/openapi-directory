...
/**
 * The EventsCapacitiesEntityEventCategoriesInner model module.
 * @module model/EventsCapacitiesEntityEventCategoriesInner
 * @version 1.0
 */
class EventsCapacitiesEntityEventCategoriesInner {
    /**
     * Constructs a new <code>EventsCapacitiesEntityEventCategoriesInner</code>.
     * @alias module:model/EventsCapacitiesEntityEventCategoriesInner
     * @param comps {Number} Number of comps in the category.
     * @param holds {Number} Number of *holds* in the category. <span class=\"definition\">Holds</span> are seats/places that are not in sale at the date of the capacity, but will eventually be later.
     * @param id {Number} Unique ID of the event category.
     * @param kills {Number} Number of *kills* in the category. <span class=\"definition\">Kills</span> are seats/places that will not be sold for technical reasons.
     * @param sellableCapacity {Number} Number of sellable seats/places in the category. This is calculated by the formula: `total_capacity - kills - comps - holds`.
     * @param totalCapacity {Number} Total number of seats/places in the category.
     */
    constructor(comps, holds, id, kills, sellableCapacity, totalCapacity) { 
        
        EventsCapacitiesEntityEventCategoriesInner.initialize(this, comps, holds, id, kills, sellableCapacity, totalCapacity);
    }
     ...
     */
    static initialize(obj, comps, holds, id, kills, sellableCapacity, totalCapacity) { 
        obj['comps'] = comps;
        obj['holds'] = holds;
        obj['id'] = id;
        obj['kills'] = kills;
        obj['sellable_capacity'] = sellableCapacity;
        obj['total_capacity'] = totalCapacity;
    }

    /**
     * Constructs a <code>EventsCapacitiesEntityEventCategoriesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsCapacitiesEntityEventCategoriesInner} obj Optional instance to populate.
     * @return {module:model/EventsCapacitiesEntityEventCategoriesInner} The populated <code>EventsCapacitiesEntityEventCategoriesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsCapacitiesEntityEventCategoriesInner();

            if (data.hasOwnProperty('comps')) {
                obj['comps'] = ApiClient.convertToType(data['comps'], 'Number');
            }
            ...
            if (data.hasOwnProperty('sellable_capacity')) {
                obj['sellable_capacity'] = ApiClient.convertToType(data['sellable_capacity'], 'Number');
            }
            if (data.hasOwnProperty('total_capacity')) {
                obj['total_capacity'] = ApiClient.convertToType(data['total_capacity'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EventsCapacitiesEntityEventCategoriesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsCapacitiesEntityEventCategoriesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventsCapacitiesEntityEventCategoriesInner.RequiredProperties) {
...
EventsCapacitiesEntityEventCategoriesInner.RequiredProperties = ["comps", "holds", "id", "kills", "sellable_capacity", "total_capacity"];

/**
 * Number of comps in the category.
 * @member {Number} comps
 */
EventsCapacitiesEntityEventCategoriesInner.prototype['comps'] = undefined;
 ...
 * @member {Number} holds
 */
EventsCapacitiesEntityEventCategoriesInner.prototype['holds'] = undefined;

/**
 * Unique ID of the event category.
 * @member {Number} id
 */
EventsCapacitiesEntityEventCategoriesInner.prototype['id'] = undefined;
 ...
 * @member {Number} kills
 */
EventsCapacitiesEntityEventCategoriesInner.prototype['kills'] = undefined;

/**
 * Number of sellable seats/places in the category. This is calculated by the formula: `total_capacity - kills - comps - holds`.
 * @member {Number} sellable_capacity
 */
EventsCapacitiesEntityEventCategoriesInner.prototype['sellable_capacity'] = undefined;

/**
 * Total number of seats/places in the category.
 * @member {Number} total_capacity
 */
EventsCapacitiesEntityEventCategoriesInner.prototype['total_capacity'] = undefined;
...
export default EventsCapacitiesEntityEventCategoriesInner;
