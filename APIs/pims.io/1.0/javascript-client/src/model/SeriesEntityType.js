...
/**
 * The SeriesEntityType model module.
 * @module model/SeriesEntityType
 * @version 1.0
 */
class SeriesEntityType {
    /**
     * Constructs a new <code>SeriesEntityType</code>.
     * Type of the series
     * @alias module:model/SeriesEntityType
     * @param id {module:model/SeriesEntityType.IdEnum} String identifying the series type.
     * @param label {String} Label of the series type. This value is translated according to the 'Accept-Language' header.
     */
    constructor(id, label) { 
        
        SeriesEntityType.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>SeriesEntityType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SeriesEntityType} obj Optional instance to populate.
     * @return {module:model/SeriesEntityType} The populated <code>SeriesEntityType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SeriesEntityType();
    ...
    /**
     * Validates the JSON data with respect to <code>SeriesEntityType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SeriesEntityType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SeriesEntityType.RequiredProperties) {
...
SeriesEntityType.RequiredProperties = ["id", "label"];

/**
 * String identifying the series type.
 * @member {module:model/SeriesEntityType.IdEnum} id
 */
SeriesEntityType.prototype['id'] = undefined;

/**
 * Label of the series type. This value is translated according to the 'Accept-Language' header.
 * @member {String} label
 */
SeriesEntityType.prototype['label'] = undefined;
...
export default SeriesEntityType;
