...
import PromotionsEntityTypeFamily from './PromotionsEntityTypeFamily';

/**
 * The PromotionsEntityType model module.
 * @module model/PromotionsEntityType
 * @version 1.0
 */
class PromotionsEntityType {
    /**
     * Constructs a new <code>PromotionsEntityType</code>.
     * Type of the promotion.
     * @alias module:model/PromotionsEntityType
     * @param family {module:model/PromotionsEntityTypeFamily} 
     * @param id {String} String identifying the promotion type.
     * @param label {String} Label of the promotion type. This value is translated according to the 'Accept-Language' header.
     */
    constructor(family, id, label) { 
        
        PromotionsEntityType.initialize(this, family, id, label);
    }
     ...
     */
    static initialize(obj, family, id, label) { 
        obj['family'] = family;
        obj['id'] = id;
        obj['label'] = label;
    }
    ...
    /**
     * Constructs a <code>PromotionsEntityType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionsEntityType} obj Optional instance to populate.
     * @return {module:model/PromotionsEntityType} The populated <code>PromotionsEntityType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsEntityType();

            if (data.hasOwnProperty('family')) {
                obj['family'] = PromotionsEntityTypeFamily.constructFromObject(data['family']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsEntityType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsEntityType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PromotionsEntityType.RequiredProperties) {
        ...
        if (data['family']) { // data not null
          PromotionsEntityTypeFamily.validateJSON(data['family']);
        }
...
PromotionsEntityType.RequiredProperties = ["family", "id", "label"];

/**
 * @member {module:model/PromotionsEntityTypeFamily} family
 */
PromotionsEntityType.prototype['family'] = undefined;

/**
 * String identifying the promotion type.
 * @member {String} id
 */
PromotionsEntityType.prototype['id'] = undefined;

/**
 * Label of the promotion type. This value is translated according to the 'Accept-Language' header.
 * @member {String} label
 */
PromotionsEntityType.prototype['label'] = undefined;
...
export default PromotionsEntityType;
