...
/**
 * The Error422 model module.
 * @module model/Error422
 * @version 1.0
 */
class Error422 {
    /**
     * Constructs a new <code>Error422</code>.
     * @alias module:model/Error422
     * @param detail {String} Description of the error.
     * @param status {Number} Status code of the error.
     * @param title {String} Message corresponding to the status code.
     * @param type {String} Link to RFC 2616 about status codes definitions.
     */
    constructor(detail, status, title, type) { 
        
        Error422.initialize(this, detail, status, title, type);
    }
    ...
    /**
     * Constructs a <code>Error422</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Error422} obj Optional instance to populate.
     * @return {module:model/Error422} The populated <code>Error422</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Error422();
    ...
    /**
     * Validates the JSON data with respect to <code>Error422</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Error422</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Error422.RequiredProperties) {
...
Error422.RequiredProperties = ["detail", "status", "title", "type"];

/**
 * Description of the error.
 * @member {String} detail
 */
Error422.prototype['detail'] = undefined;

/**
 * Status code of the error.
 * @member {Number} status
 */
Error422.prototype['status'] = undefined;

/**
 * Message corresponding to the status code.
 * @member {String} title
 */
Error422.prototype['title'] = undefined;

/**
 * Link to RFC 2616 about status codes definitions.
 * @member {String} type
 */
Error422.prototype['type'] = undefined;
