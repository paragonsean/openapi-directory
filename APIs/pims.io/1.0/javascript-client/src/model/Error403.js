...
class Error403 {
    ...
    constructor(detail, status, title, type) { 
        ...
        Error403.initialize(this, detail, status, title, type);
    }
...
Error403.RequiredProperties = ["detail", "status", "title", "type"];

/**
 * Description of the error.
 * @member {String} detail
 */
Error403.prototype['detail'] = undefined;

/**
 * Status code of the error.
 * @member {Number} status
 */
Error403.prototype['status'] = undefined;

/**
 * Message corresponding to the status code.
 * @member {String} title
 */
Error403.prototype['title'] = undefined;

/**
 * Link to RFC 2616 about status codes definitions.
 * @member {String} type
 */
Error403.prototype['type'] = undefined;
