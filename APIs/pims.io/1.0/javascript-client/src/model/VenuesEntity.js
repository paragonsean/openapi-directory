...
import VenuesEntityType from './VenuesEntityType';

/**
 * The VenuesEntity model module.
 * @module model/VenuesEntity
 * @version 1.0
 */
class VenuesEntity {
    /**
     * Constructs a new <code>VenuesEntity</code>.
     * @alias module:model/VenuesEntity
     * @param city {String} City in which the venue is.
     * @param countryCode {String} Country in which the venue is (<a href='https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3'>ISO 3166-1 alpha-3 code</a>).
     * @param creationTimestamp {Number} Timestamp for when the venue was created in the customer's database.
     * @param firstAddress {String} First address field of the venue.
     * @param id {Number} Unique ID of the venue.
     * @param label {String} Name of the venue.
     * @param lastUpdateTimestamp {Number} Timestamp for when the venue was last updated in the customer's database.
     * @param majorCity {String} Major city or metropolitan area the venue belongs to.
     * @param secondAddress {String} Second address field of the venue.
     * @param type {module:model/VenuesEntityType} 
     * @param zipCode {String} ZIP code of the venue.
     */
    constructor(city, countryCode, creationTimestamp, firstAddress, id, label, lastUpdateTimestamp, majorCity, secondAddress, type, zipCode) { 
        
        VenuesEntity.initialize(this, city, countryCode, creationTimestamp, firstAddress, id, label, lastUpdateTimestamp, majorCity, secondAddress, type, zipCode);
    }
     ...
     */
    static initialize(obj, city, countryCode, creationTimestamp, firstAddress, id, label, lastUpdateTimestamp, majorCity, secondAddress, type, zipCode) { 
        obj['city'] = city;
        obj['country_code'] = countryCode;
        obj['creation_timestamp'] = creationTimestamp;
        obj['first_address'] = firstAddress;
        obj['id'] = id;
        obj['label'] = label;
        obj['last_update_timestamp'] = lastUpdateTimestamp;
        obj['major_city'] = majorCity;
        obj['second_address'] = secondAddress;
        obj['type'] = type;
        obj['zip_code'] = zipCode;
    }

    /**
     * Constructs a <code>VenuesEntity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VenuesEntity} obj Optional instance to populate.
     * @return {module:model/VenuesEntity} The populated <code>VenuesEntity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VenuesEntity();

            if (data.hasOwnProperty('alternative_labels')) {
                obj['alternative_labels'] = ApiClient.convertToType(data['alternative_labels'], ['String']);
            }
            ...
            if (data.hasOwnProperty('first_address')) {
                obj['first_address'] = ApiClient.convertToType(data['first_address'], 'String');
            }
            ...
            if (data.hasOwnProperty('major_city')) {
                obj['major_city'] = ApiClient.convertToType(data['major_city'], 'String');
            }
            if (data.hasOwnProperty('second_address')) {
                obj['second_address'] = ApiClient.convertToType(data['second_address'], 'String');
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = VenuesEntityType.constructFromObject(data['type']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VenuesEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VenuesEntity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VenuesEntity.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is an array
        if (!Array.isArray(data['alternative_labels'])) {
            throw new Error("Expected the field `alternative_labels` to be an array in the JSON data but got " + data['alternative_labels']);
        }
        ...
        // ensure the json data is a string
        if (data['first_address'] && !(typeof data['first_address'] === 'string' || data['first_address'] instanceof String)) {
            throw new Error("Expected the field `first_address` to be a primitive type in the JSON string but got " + data['first_address']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['major_city'] && !(typeof data['major_city'] === 'string' || data['major_city'] instanceof String)) {
            throw new Error("Expected the field `major_city` to be a primitive type in the JSON string but got " + data['major_city']);
        }
        // ensure the json data is a string
        if (data['second_address'] && !(typeof data['second_address'] === 'string' || data['second_address'] instanceof String)) {
            throw new Error("Expected the field `second_address` to be a primitive type in the JSON string but got " + data['second_address']);
        }
        // validate the optional field `type`
        if (data['type']) { // data not null
          VenuesEntityType.validateJSON(data['type']);
        }
        // ensure the json data is a string
...
VenuesEntity.RequiredProperties = ["city", "country_code", "creation_timestamp", "first_address", "id", "label", "last_update_timestamp", "major_city", "second_address", "type", "zip_code"];

/**
 * Array of alternative/old names of the venue.
 * @member {Array.<String>} alternative_labels
 */
VenuesEntity.prototype['alternative_labels'] = undefined;

/**
 * City in which the venue is.
 * @member {String} city
 */
VenuesEntity.prototype['city'] = undefined;

/**
 * Country in which the venue is (<a href='https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3'>ISO 3166-1 alpha-3 code</a>).
 * @member {String} country_code
 */
VenuesEntity.prototype['country_code'] = undefined;

/**
 * Timestamp for when the venue was created in the customer's database.
 * @member {Number} creation_timestamp
 */
VenuesEntity.prototype['creation_timestamp'] = undefined;

/**
 * First address field of the venue.
 * @member {String} first_address
 */
VenuesEntity.prototype['first_address'] = undefined;

/**
 * Unique ID of the venue.
 * @member {Number} id
 */
VenuesEntity.prototype['id'] = undefined;

/**
 * Name of the venue.
 * @member {String} label
 */
VenuesEntity.prototype['label'] = undefined;

/**
 * Timestamp for when the venue was last updated in the customer's database.
 * @member {Number} last_update_timestamp
 */
VenuesEntity.prototype['last_update_timestamp'] = undefined;

/**
 * Major city or metropolitan area the venue belongs to.
 * @member {String} major_city
 */
VenuesEntity.prototype['major_city'] = undefined;

/**
 * Second address field of the venue.
 * @member {String} second_address
 */
VenuesEntity.prototype['second_address'] = undefined;

/**
 * @member {module:model/VenuesEntityType} type
 */
VenuesEntity.prototype['type'] = undefined;

/**
 * ZIP code of the venue.
 * @member {String} zip_code
 */
VenuesEntity.prototype['zip_code'] = undefined;
