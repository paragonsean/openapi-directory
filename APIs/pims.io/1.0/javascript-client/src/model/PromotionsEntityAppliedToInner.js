...
/**
 * The PromotionsEntityAppliedToInner model module.
 * @module model/PromotionsEntityAppliedToInner
 * @version 1.0
 */
class PromotionsEntityAppliedToInner {
    /**
     * Constructs a new <code>PromotionsEntityAppliedToInner</code>.
     * @alias module:model/PromotionsEntityAppliedToInner
     */
    constructor() { 
        
        PromotionsEntityAppliedToInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PromotionsEntityAppliedToInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionsEntityAppliedToInner} obj Optional instance to populate.
     * @return {module:model/PromotionsEntityAppliedToInner} The populated <code>PromotionsEntityAppliedToInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsEntityAppliedToInner();
            ...
            if (data.hasOwnProperty('valorized_quantity')) {
                obj['valorized_quantity'] = ApiClient.convertToType(data['valorized_quantity'], 'Number');
            }
            if (data.hasOwnProperty('valorized_unit_cost')) {
                obj['valorized_unit_cost'] = ApiClient.convertToType(data['valorized_unit_cost'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsEntityAppliedToInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsEntityAppliedToInner</code>.
     */
 ...
 */
PromotionsEntityAppliedToInner.prototype['event_id'] = undefined;

/**
 * Quantity share of the promotion devoted to this event/series.
 * @member {Number} quantity
 */
PromotionsEntityAppliedToInner.prototype['quantity'] = undefined;
 ...
 */
PromotionsEntityAppliedToInner.prototype['series_id'] = undefined;
 ...
 */
PromotionsEntityAppliedToInner.prototype['unit_cost'] = undefined;
 ...
 * @member {Number} valorized_quantity
 */
PromotionsEntityAppliedToInner.prototype['valorized_quantity'] = undefined;
 ...
 * @member {Number} valorized_unit_cost
 */
PromotionsEntityAppliedToInner.prototype['valorized_unit_cost'] = undefined;
...
export default PromotionsEntityAppliedToInner;
