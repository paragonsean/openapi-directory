...
import TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner from './TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner';

/**
 * The TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner model module.
 * @module model/TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner
 * @version 1.0
 */
class TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner {
    /**
     * Constructs a new <code>TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner</code>.
     * @alias module:model/TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner
     * @param eventPriceRanges {Array.<module:model/TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner>} Array of event price ranges which where sold.
     * @param id {Number} ID of the event category.
     */
    constructor(eventPriceRanges, id) { 
        
        TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.initialize(this, eventPriceRanges, id);
    }
     ...
     */
    static initialize(obj, eventPriceRanges, id) { 
        obj['event_price_ranges'] = eventPriceRanges;
        obj['id'] = id;
    }

    /**
     * Constructs a <code>TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner} obj Optional instance to populate.
     * @return {module:model/TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner} The populated <code>TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner();

            if (data.hasOwnProperty('event_price_ranges')) {
                obj['event_price_ranges'] = ApiClient.convertToType(data['event_price_ranges'], [TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.RequiredProperties) {
        ...
        if (data['event_price_ranges']) { // data not null
            ...
            for (const item of data['event_price_ranges']) {
                TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner.validateJSON(item);
            };
        }
...
TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.RequiredProperties = ["event_price_ranges", "id"];

/**
 * Array of event price ranges which where sold.
 * @member {Array.<module:model/TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner>} event_price_ranges
 */
TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.prototype['event_price_ranges'] = undefined;

/**
 * ID of the event category.
 * @member {Number} id
 */
TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner.prototype['id'] = undefined;
...
export default TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner;
