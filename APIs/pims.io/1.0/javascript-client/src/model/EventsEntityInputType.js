...
/**
 * The EventsEntityInputType model module.
 * @module model/EventsEntityInputType
 * @version 1.0
 */
class EventsEntityInputType {
    /**
     * Constructs a new <code>EventsEntityInputType</code>.
     * Input type of the event.
     * @alias module:model/EventsEntityInputType
     * @param id {module:model/EventsEntityInputType.IdEnum} String identifying the input type of the event.
     * @param label {String} Label of the input type. This value is translated according to the 'Accept-Language' header.
     */
    constructor(id, label) { 
        
        EventsEntityInputType.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>EventsEntityInputType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsEntityInputType} obj Optional instance to populate.
     * @return {module:model/EventsEntityInputType} The populated <code>EventsEntityInputType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsEntityInputType();
    ...
    /**
     * Validates the JSON data with respect to <code>EventsEntityInputType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsEntityInputType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventsEntityInputType.RequiredProperties) {
...
EventsEntityInputType.RequiredProperties = ["id", "label"];

/**
 * String identifying the input type of the event.
 * @member {module:model/EventsEntityInputType.IdEnum} id
 */
EventsEntityInputType.prototype['id'] = undefined;

/**
 * Label of the input type. This value is translated according to the 'Accept-Language' header.
 * @member {String} label
 */
EventsEntityInputType.prototype['label'] = undefined;
...
export default EventsEntityInputType;
