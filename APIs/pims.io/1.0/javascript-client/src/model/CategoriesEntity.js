...
/**
 * The CategoriesEntity model module.
 * @module model/CategoriesEntity
 * @version 1.0
 */
class CategoriesEntity {
    /**
     * Constructs a new <code>CategoriesEntity</code>.
     * @alias module:model/CategoriesEntity
     * @param id {Number} Unique ID of the category.
     * @param ignored {Boolean} Defines whether this category is ignored or not.
     * @param label {String} Full label of the category.
     * @param lastUpdateTimestamp {Number} Timestamp for when the category was last updated in the customer's database.
     * @param shortLabel {String} Short label of the category (generally less than 5 characters).
     */
    constructor(id, ignored, label, lastUpdateTimestamp, shortLabel) { 
        
        CategoriesEntity.initialize(this, id, ignored, label, lastUpdateTimestamp, shortLabel);
    }
    ...
    /**
     * Constructs a <code>CategoriesEntity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoriesEntity} obj Optional instance to populate.
     * @return {module:model/CategoriesEntity} The populated <code>CategoriesEntity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoriesEntity();
    ...
    /**
     * Validates the JSON data with respect to <code>CategoriesEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoriesEntity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CategoriesEntity.RequiredProperties) {
...
CategoriesEntity.RequiredProperties = ["id", "ignored", "label", "last_update_timestamp", "short_label"];

/**
 * Unique ID of the category.
 * @member {Number} id
 */
CategoriesEntity.prototype['id'] = undefined;

/**
 * Defines whether this category is ignored or not.
 * @member {Boolean} ignored
 */
CategoriesEntity.prototype['ignored'] = undefined;

/**
 * Full label of the category.
 * @member {String} label
 */
CategoriesEntity.prototype['label'] = undefined;

/**
 * Timestamp for when the category was last updated in the customer's database.
 * @member {Number} last_update_timestamp
 */
CategoriesEntity.prototype['last_update_timestamp'] = undefined;

/**
 * Short label of the category (generally less than 5 characters).
 * @member {String} short_label
 */
CategoriesEntity.prototype['short_label'] = undefined;
