...
/**
 * The PromotionsEntitySupplier model module.
 * @module model/PromotionsEntitySupplier
 * @version 1.0
 */
class PromotionsEntitySupplier {
    /**
     * Constructs a new <code>PromotionsEntitySupplier</code>.
     * Supplier of the promotion.
     * @alias module:model/PromotionsEntitySupplier
     * @param id {Number} Unique ID of the supplier.
     * @param label {String} Name of the supplier.
     */
    constructor(id, label) { 
        
        PromotionsEntitySupplier.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>PromotionsEntitySupplier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionsEntitySupplier} obj Optional instance to populate.
     * @return {module:model/PromotionsEntitySupplier} The populated <code>PromotionsEntitySupplier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsEntitySupplier();
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsEntitySupplier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsEntitySupplier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PromotionsEntitySupplier.RequiredProperties) {
...
PromotionsEntitySupplier.RequiredProperties = ["id", "label"];

/**
 * Unique ID of the supplier.
 * @member {Number} id
 */
PromotionsEntitySupplier.prototype['id'] = undefined;

/**
 * Name of the supplier.
 * @member {String} label
 */
PromotionsEntitySupplier.prototype['label'] = undefined;
...
export default PromotionsEntitySupplier;
