...
class Error404 {
    ...
    constructor(detail, status, title, type) { 
        ...
        Error404.initialize(this, detail, status, title, type);
    }
...
Error404.RequiredProperties = ["detail", "status", "title", "type"];

/**
 * Description of the error.
 * @member {String} detail
 */
Error404.prototype['detail'] = undefined;

/**
 * Status code of the error.
 * @member {Number} status
 */
Error404.prototype['status'] = undefined;
 ...
 * @member {String} type
 */
Error404.prototype['type'] = undefined;
