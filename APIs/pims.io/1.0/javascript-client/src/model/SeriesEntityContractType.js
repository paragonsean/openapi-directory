...
/**
 * The SeriesEntityContractType model module.
 * @module model/SeriesEntityContractType
 * @version 1.0
 */
class SeriesEntityContractType {
    /**
     * Constructs a new <code>SeriesEntityContractType</code>.
     * Contract type.
     * @alias module:model/SeriesEntityContractType
     * @param id {module:model/SeriesEntityContractType.IdEnum} String identifying the contract type.
     * @param label {String} Label of the contract type. This value is translated according to the 'Accept-Language' header.
     */
    constructor(id, label) { 
        
        SeriesEntityContractType.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>SeriesEntityContractType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SeriesEntityContractType} obj Optional instance to populate.
     * @return {module:model/SeriesEntityContractType} The populated <code>SeriesEntityContractType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SeriesEntityContractType();
    ...
    /**
     * Validates the JSON data with respect to <code>SeriesEntityContractType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SeriesEntityContractType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SeriesEntityContractType.RequiredProperties) {
...
SeriesEntityContractType.RequiredProperties = ["id", "label"];

/**
 * String identifying the contract type.
 * @member {module:model/SeriesEntityContractType.IdEnum} id
 */
SeriesEntityContractType.prototype['id'] = undefined;

/**
 * Label of the contract type. This value is translated according to the 'Accept-Language' header.
 * @member {String} label
 */
SeriesEntityContractType.prototype['label'] = undefined;
 ...
 * @readonly
 */
SeriesEntityContractType['IdEnum'] = {
...
export default SeriesEntityContractType;
