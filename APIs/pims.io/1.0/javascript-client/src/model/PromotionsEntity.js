...
import PromotionsEntityAppliedToInner from './PromotionsEntityAppliedToInner';
import PromotionsEntityCost from './PromotionsEntityCost';
import PromotionsEntitySupplier from './PromotionsEntitySupplier';
import PromotionsEntityType from './PromotionsEntityType';

/**
 * The PromotionsEntity model module.
 * @module model/PromotionsEntity
 * @version 1.0
 */
class PromotionsEntity {
    /**
     * Constructs a new <code>PromotionsEntity</code>.
     * @alias module:model/PromotionsEntity
     * @param appliedTo {Array.<module:model/PromotionsEntityAppliedToInner>} List of events and/or series where the promotion is applied. A promotion can be applied on several events, and its costs can be split between those events.
     * @param comments {String} Comments on the promotion.
     * @param cost {module:model/PromotionsEntityCost} 
     * @param endDate {Date} Date the promotion ends. (If null, has the same value as start_date.)
     * @param id {Number} Unique ID of the promotion.
     * @param label {String} Label of the promotion.
     * @param startDate {Date} Date the promotion begins.
     * @param supplier {module:model/PromotionsEntitySupplier} 
     * @param type {module:model/PromotionsEntityType} 
     */
    constructor(appliedTo, comments, cost, endDate, id, label, startDate, supplier, type) { 
        
        PromotionsEntity.initialize(this, appliedTo, comments, cost, endDate, id, label, startDate, supplier, type);
    }
     ...
     */
    static initialize(obj, appliedTo, comments, cost, endDate, id, label, startDate, supplier, type) { 
        obj['applied_to'] = appliedTo;
    ...
    /**
     * Constructs a <code>PromotionsEntity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionsEntity} obj Optional instance to populate.
     * @return {module:model/PromotionsEntity} The populated <code>PromotionsEntity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsEntity();

            if (data.hasOwnProperty('applied_to')) {
                obj['applied_to'] = ApiClient.convertToType(data['applied_to'], [PromotionsEntityAppliedToInner]);
            }
            if (data.hasOwnProperty('comments')) {
                obj['comments'] = ApiClient.convertToType(data['comments'], 'String');
            }
            if (data.hasOwnProperty('cost')) {
                obj['cost'] = PromotionsEntityCost.constructFromObject(data['cost']);
            }
            ...
            if (data.hasOwnProperty('supplier')) {
                obj['supplier'] = PromotionsEntitySupplier.constructFromObject(data['supplier']);
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = PromotionsEntityType.constructFromObject(data['type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsEntity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PromotionsEntity.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        if (data['applied_to']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['applied_to'])) {
                throw new Error("Expected the field `applied_to` to be an array in the JSON data but got " + data['applied_to']);
            }
            // validate the optional field `applied_to` (array)
            for (const item of data['applied_to']) {
                PromotionsEntityAppliedToInner.validateJSON(item);
            };
        }
        ...
        if (data['cost']) { // data not null
          PromotionsEntityCost.validateJSON(data['cost']);
        }
        // ensure the json data is a string
        ...
        if (data['supplier']) { // data not null
          PromotionsEntitySupplier.validateJSON(data['supplier']);
        }
        // validate the optional field `type`
        if (data['type']) { // data not null
          PromotionsEntityType.validateJSON(data['type']);
        }
...
PromotionsEntity.RequiredProperties = ["applied_to", "comments", "cost", "end_date", "id", "label", "start_date", "supplier", "type"];
 ...
 * @member {Array.<module:model/PromotionsEntityAppliedToInner>} applied_to
 */
PromotionsEntity.prototype['applied_to'] = undefined;

/**
 * Comments on the promotion.
 * @member {String} comments
 */
PromotionsEntity.prototype['comments'] = undefined;

/**
 * @member {module:model/PromotionsEntityCost} cost
 */
PromotionsEntity.prototype['cost'] = undefined;

/**
 * Date the promotion ends. (If null, has the same value as start_date.)
 * @member {Date} end_date
 */
PromotionsEntity.prototype['end_date'] = undefined;

/**
 * File associated to the promotion.
 * @member {String} file
 */
PromotionsEntity.prototype['file'] = undefined;

/**
 * Unique ID of the promotion.
 * @member {Number} id
 */
PromotionsEntity.prototype['id'] = undefined;

/**
 * Label of the promotion.
 * @member {String} label
 */
PromotionsEntity.prototype['label'] = undefined;

/**
 * Date the promotion begins.
 * @member {Date} start_date
 */
PromotionsEntity.prototype['start_date'] = undefined;

/**
 * @member {module:model/PromotionsEntitySupplier} supplier
 */
PromotionsEntity.prototype['supplier'] = undefined;

/**
 * @member {module:model/PromotionsEntityType} type
 */
PromotionsEntity.prototype['type'] = undefined;
...
export default PromotionsEntity;
