...
import PriceRangesEntity from './PriceRangesEntity';

/**
 * The EventsCategoriesEntityEventPriceRangesInner model module.
 * @module model/EventsCategoriesEntityEventPriceRangesInner
 * @version 1.0
 */
class EventsCategoriesEntityEventPriceRangesInner {
    /**
     * Constructs a new <code>EventsCategoriesEntityEventPriceRangesInner</code>.
     * @alias module:model/EventsCategoriesEntityEventPriceRangesInner
     * @param basePrice {Number} Base price of the event price range (i.e. including VAT but excluding all commissions).
     * @param currency {String} Currency of the prices.
     * @param id {Number} ID of the event price range.
     * @param priceRange {module:model/PriceRangesEntity} 
     * @param publicPrice {Number} Public price of the event price range (i.e. including VAT and all commissions).
     */
    constructor(basePrice, currency, id, priceRange, publicPrice) { 
        
        EventsCategoriesEntityEventPriceRangesInner.initialize(this, basePrice, currency, id, priceRange, publicPrice);
    }
     ...
     */
    static initialize(obj, basePrice, currency, id, priceRange, publicPrice) { 
        obj['base_price'] = basePrice;
        obj['currency'] = currency;
        obj['id'] = id;
        obj['price_range'] = priceRange;
        obj['public_price'] = publicPrice;
    }

    /**
     * Constructs a <code>EventsCategoriesEntityEventPriceRangesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsCategoriesEntityEventPriceRangesInner} obj Optional instance to populate.
     * @return {module:model/EventsCategoriesEntityEventPriceRangesInner} The populated <code>EventsCategoriesEntityEventPriceRangesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsCategoriesEntityEventPriceRangesInner();
            ...
            if (data.hasOwnProperty('price_range')) {
                obj['price_range'] = PriceRangesEntity.constructFromObject(data['price_range']);
            }
            if (data.hasOwnProperty('public_price')) {
                obj['public_price'] = ApiClient.convertToType(data['public_price'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EventsCategoriesEntityEventPriceRangesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsCategoriesEntityEventPriceRangesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventsCategoriesEntityEventPriceRangesInner.RequiredProperties) {
        ...
        if (data['price_range']) { // data not null
          PriceRangesEntity.validateJSON(data['price_range']);
        }
...
EventsCategoriesEntityEventPriceRangesInner.RequiredProperties = ["base_price", "currency", "id", "price_range", "public_price"];

/**
 * Base price of the event price range (i.e. including VAT but excluding all commissions).
 * @member {Number} base_price
 */
EventsCategoriesEntityEventPriceRangesInner.prototype['base_price'] = undefined;

/**
 * Currency of the prices.
 * @member {String} currency
 */
EventsCategoriesEntityEventPriceRangesInner.prototype['currency'] = undefined;

/**
 * ID of the event price range.
 * @member {Number} id
 */
EventsCategoriesEntityEventPriceRangesInner.prototype['id'] = undefined;

/**
 * Defines whether this event price range is ignored or not.
 * @member {Boolean} ignored
 */
EventsCategoriesEntityEventPriceRangesInner.prototype['ignored'] = undefined;

/**
 * @member {module:model/PriceRangesEntity} price_range
 */
EventsCategoriesEntityEventPriceRangesInner.prototype['price_range'] = undefined;

/**
 * Public price of the event price range (i.e. including VAT and all commissions).
 * @member {Number} public_price
 */
EventsCategoriesEntityEventPriceRangesInner.prototype['public_price'] = undefined;
...
export default EventsCategoriesEntityEventPriceRangesInner;
