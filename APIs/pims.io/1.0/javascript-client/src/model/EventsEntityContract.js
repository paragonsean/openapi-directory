...
import EventsEntityContractPartner from './EventsEntityContractPartner';
import EventsEntityContractType from './EventsEntityContractType';

/**
 * The EventsEntityContract model module.
 * @module model/EventsEntityContract
 * @version 1.0
 */
class EventsEntityContract {
    /**
     * Constructs a new <code>EventsEntityContract</code>.
     * Contract of the series.
     * @alias module:model/EventsEntityContract
     * @param partner {module:model/EventsEntityContractPartner} 
     * @param type {module:model/EventsEntityContractType} 
     */
    constructor(partner, type) { 
        
        EventsEntityContract.initialize(this, partner, type);
    }
     ...
     */
    static initialize(obj, partner, type) { 
        obj['partner'] = partner;
        obj['type'] = type;
    }

    /**
     * Constructs a <code>EventsEntityContract</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsEntityContract} obj Optional instance to populate.
     * @return {module:model/EventsEntityContract} The populated <code>EventsEntityContract</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsEntityContract();

            if (data.hasOwnProperty('partner')) {
                obj['partner'] = EventsEntityContractPartner.constructFromObject(data['partner']);
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = EventsEntityContractType.constructFromObject(data['type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EventsEntityContract</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsEntityContract</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventsEntityContract.RequiredProperties) {
        ...
        if (data['partner']) { // data not null
          EventsEntityContractPartner.validateJSON(data['partner']);
        }
        // validate the optional field `type`
        if (data['type']) { // data not null
          EventsEntityContractType.validateJSON(data['type']);
        }
...
EventsEntityContract.RequiredProperties = ["partner", "type"];

/**
 * @member {module:model/EventsEntityContractPartner} partner
 */
EventsEntityContract.prototype['partner'] = undefined;

/**
 * @member {module:model/EventsEntityContractType} type
 */
EventsEntityContract.prototype['type'] = undefined;
...
export default EventsEntityContract;
