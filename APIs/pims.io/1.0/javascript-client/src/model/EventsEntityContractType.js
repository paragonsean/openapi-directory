...
/**
 * The EventsEntityContractType model module.
 * @module model/EventsEntityContractType
 * @version 1.0
 */
class EventsEntityContractType {
    /**
     * Constructs a new <code>EventsEntityContractType</code>.
     * Contract type.
     * @alias module:model/EventsEntityContractType
     * @param id {module:model/EventsEntityContractType.IdEnum} String identifying the contract type.
     * @param label {String} Label of the contract type. This value is translated according to the 'Accept-Language' header.
     */
    constructor(id, label) { 
        
        EventsEntityContractType.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>EventsEntityContractType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsEntityContractType} obj Optional instance to populate.
     * @return {module:model/EventsEntityContractType} The populated <code>EventsEntityContractType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsEntityContractType();
    ...
    /**
     * Validates the JSON data with respect to <code>EventsEntityContractType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsEntityContractType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventsEntityContractType.RequiredProperties) {
...
EventsEntityContractType.RequiredProperties = ["id", "label"];

/**
 * String identifying the contract type.
 * @member {module:model/EventsEntityContractType.IdEnum} id
 */
EventsEntityContractType.prototype['id'] = undefined;

/**
 * Label of the contract type. This value is translated according to the 'Accept-Language' header.
 * @member {String} label
 */
EventsEntityContractType.prototype['label'] = undefined;
 ...
 * @readonly
 */
EventsEntityContractType['IdEnum'] = {
...
export default EventsEntityContractType;
