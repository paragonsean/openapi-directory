...
/**
 * The SeriesEntityContractPartner model module.
 * @module model/SeriesEntityContractPartner
 * @version 1.0
 */
class SeriesEntityContractPartner {
    /**
     * Constructs a new <code>SeriesEntityContractPartner</code>.
     * Contract partner.
     * @alias module:model/SeriesEntityContractPartner
     * @param id {Number} Unique ID identifying the contract partner.
     * @param label {String} Label of the contract partner.
     */
    constructor(id, label) { 
        
        SeriesEntityContractPartner.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>SeriesEntityContractPartner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SeriesEntityContractPartner} obj Optional instance to populate.
     * @return {module:model/SeriesEntityContractPartner} The populated <code>SeriesEntityContractPartner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SeriesEntityContractPartner();
    ...
    /**
     * Validates the JSON data with respect to <code>SeriesEntityContractPartner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SeriesEntityContractPartner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SeriesEntityContractPartner.RequiredProperties) {
...
SeriesEntityContractPartner.RequiredProperties = ["id", "label"];

/**
 * Unique ID identifying the contract partner.
 * @member {Number} id
 */
SeriesEntityContractPartner.prototype['id'] = undefined;

/**
 * Label of the contract partner.
 * @member {String} label
 */
SeriesEntityContractPartner.prototype['label'] = undefined;
...
export default SeriesEntityContractPartner;
