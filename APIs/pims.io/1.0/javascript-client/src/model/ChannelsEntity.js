...
/**
 * The ChannelsEntity model module.
 * @module model/ChannelsEntity
 * @version 1.0
 */
class ChannelsEntity {
    /**
     * Constructs a new <code>ChannelsEntity</code>.
     * @alias module:model/ChannelsEntity
     * @param id {Number} Unique ID of the channel.
     * @param ignored {Boolean} Defines whether this channel is ignored or not.
     * @param label {String} Full label of the channel.
     * @param lastUpdateTimestamp {Number} Timestamp for when the channel was last updated in the customer's database.
     * @param shortLabel {String} Short label of the channel (generally less than 5 characters).
     */
    constructor(id, ignored, label, lastUpdateTimestamp, shortLabel) { 
        
        ChannelsEntity.initialize(this, id, ignored, label, lastUpdateTimestamp, shortLabel);
    }
     ...
     */
    static initialize(obj, id, ignored, label, lastUpdateTimestamp, shortLabel) { 
        obj['id'] = id;
        obj['ignored'] = ignored;
        obj['label'] = label;
        obj['last_update_timestamp'] = lastUpdateTimestamp;
        obj['short_label'] = shortLabel;
    }

    /**
     * Constructs a <code>ChannelsEntity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChannelsEntity} obj Optional instance to populate.
     * @return {module:model/ChannelsEntity} The populated <code>ChannelsEntity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChannelsEntity();
            ...
            if (data.hasOwnProperty('short_label')) {
                obj['short_label'] = ApiClient.convertToType(data['short_label'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ChannelsEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChannelsEntity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ChannelsEntity.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['short_label'] && !(typeof data['short_label'] === 'string' || data['short_label'] instanceof String)) {
            throw new Error("Expected the field `short_label` to be a primitive type in the JSON string but got " + data['short_label']);
        }
...
ChannelsEntity.RequiredProperties = ["id", "ignored", "label", "last_update_timestamp", "short_label"];

/**
 * Unique ID of the channel.
 * @member {Number} id
 */
ChannelsEntity.prototype['id'] = undefined;

/**
 * Defines whether this channel is ignored or not.
 * @member {Boolean} ignored
 */
ChannelsEntity.prototype['ignored'] = undefined;

/**
 * Full label of the channel.
 * @member {String} label
 */
ChannelsEntity.prototype['label'] = undefined;

/**
 * Timestamp for when the channel was last updated in the customer's database.
 * @member {Number} last_update_timestamp
 */
ChannelsEntity.prototype['last_update_timestamp'] = undefined;

/**
 * Short label of the channel (generally less than 5 characters).
 * @member {String} short_label
 */
ChannelsEntity.prototype['short_label'] = undefined;
