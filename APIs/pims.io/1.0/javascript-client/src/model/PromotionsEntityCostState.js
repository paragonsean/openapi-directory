...
/**
 * The PromotionsEntityCostState model module.
 * @module model/PromotionsEntityCostState
 * @version 1.0
 */
class PromotionsEntityCostState {
    /**
     * Constructs a new <code>PromotionsEntityCostState</code>.
     * State of the promotion cost. *This object may be omitted according to the customer configuration.*
     * @alias module:model/PromotionsEntityCostState
     * @param id {module:model/PromotionsEntityCostState.IdEnum} String identifying the state of the promotion cost.
     * @param label {String} Label of the state of the promotion cost. This value is translated according to the 'Accept-Language' header.
     */
    constructor(id, label) { 
        
        PromotionsEntityCostState.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>PromotionsEntityCostState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionsEntityCostState} obj Optional instance to populate.
     * @return {module:model/PromotionsEntityCostState} The populated <code>PromotionsEntityCostState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsEntityCostState();
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsEntityCostState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsEntityCostState</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PromotionsEntityCostState.RequiredProperties) {
...
PromotionsEntityCostState.RequiredProperties = ["id", "label"];

/**
 * String identifying the state of the promotion cost.
 * @member {module:model/PromotionsEntityCostState.IdEnum} id
 */
PromotionsEntityCostState.prototype['id'] = undefined;

/**
 * Label of the state of the promotion cost. This value is translated according to the 'Accept-Language' header.
 * @member {String} label
 */
PromotionsEntityCostState.prototype['label'] = undefined;
 ...
 * @readonly
 */
PromotionsEntityCostState['IdEnum'] = {
...
export default PromotionsEntityCostState;
