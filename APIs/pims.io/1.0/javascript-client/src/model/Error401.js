...
class Error401 {
    ...
    constructor(detail, status, title, type) { 
        ...
        Error401.initialize(this, detail, status, title, type);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Error401</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Error401</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Error401.RequiredProperties) {
...
Error401.RequiredProperties = ["detail", "status", "title", "type"];

/**
 * Description of the error.
 * @member {String} detail
 */
Error401.prototype['detail'] = undefined;

/**
 * Status code of the error.
 * @member {Number} status
 */
Error401.prototype['status'] = undefined;

/**
 * Message corresponding to the status code.
 * @member {String} title
 */
Error401.prototype['title'] = undefined;

/**
 * Link to RFC 2616 about status codes definitions.
 * @member {String} type
 */
Error401.prototype['type'] = undefined;
