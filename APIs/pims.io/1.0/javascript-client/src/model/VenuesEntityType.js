...
/**
 * The VenuesEntityType model module.
 * @module model/VenuesEntityType
 * @version 1.0
 */
class VenuesEntityType {
    /**
     * Constructs a new <code>VenuesEntityType</code>.
     * @alias module:model/VenuesEntityType
     * @param id {module:model/VenuesEntityType.IdEnum} String identifying the venue type.
     * @param label {String} Label of the venue type. This value is translated according to the 'Accept-Language' header.
     */
    constructor(id, label) { 
        
        VenuesEntityType.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>VenuesEntityType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VenuesEntityType} obj Optional instance to populate.
     * @return {module:model/VenuesEntityType} The populated <code>VenuesEntityType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VenuesEntityType();
    ...
    /**
     * Validates the JSON data with respect to <code>VenuesEntityType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VenuesEntityType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VenuesEntityType.RequiredProperties) {
...
VenuesEntityType.RequiredProperties = ["id", "label"];

/**
 * String identifying the venue type.
 * @member {module:model/VenuesEntityType.IdEnum} id
 */
VenuesEntityType.prototype['id'] = undefined;

/**
 * Label of the venue type. This value is translated according to the 'Accept-Language' header.
 * @member {String} label
 */
VenuesEntityType.prototype['label'] = undefined;
...
export default VenuesEntityType;
