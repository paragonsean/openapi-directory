...
/**
 * The TicketCountsEntity model module.
 * @module model/TicketCountsEntity
 * @version 1.0
 */
class TicketCountsEntity {
    /**
     * Constructs a new <code>TicketCountsEntity</code>.
     * @alias module:model/TicketCountsEntity
     ...
     * @param sales {Number} Ticket sales (= number of sold tickets).
     */
    constructor(approved, comment, date, _final, id, sales) { 
        
        TicketCountsEntity.initialize(this, approved, comment, date, _final, id, sales);
    }
     ...
     */
    static initialize(obj, approved, comment, date, _final, id, sales) { 
    ...
    /**
     * Constructs a <code>TicketCountsEntity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TicketCountsEntity} obj Optional instance to populate.
     * @return {module:model/TicketCountsEntity} The populated <code>TicketCountsEntity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TicketCountsEntity();
            ...
            if (data.hasOwnProperty('reservations')) {
                obj['reservations'] = ApiClient.convertToType(data['reservations'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TicketCountsEntity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TicketCountsEntity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TicketCountsEntity.RequiredProperties) {
...
TicketCountsEntity.RequiredProperties = ["approved", "comment", "date", "final", "id", "sales"];

/**
 * Defines whether this ticket count is approved or not.
 * @member {Boolean} approved
 */
TicketCountsEntity.prototype['approved'] = undefined;

/**
 * Comment for the ticket count.
 * @member {String} comment
 */
TicketCountsEntity.prototype['comment'] = undefined;

/**
 * Currency of the gross (<a href='https://en.wikipedia.org/wiki/ISO_4217#Active_codes'>ISO 4212 alphabetic code</a>).
 * @member {String} currency
 */
TicketCountsEntity.prototype['currency'] = undefined;

/**
 * Date of the ticket count.
 * @member {Date} date
 */
TicketCountsEntity.prototype['date'] = undefined;
...
export default TicketCountsEntity;
