...
import SeriesEntityContractPartner from './SeriesEntityContractPartner';
import SeriesEntityContractType from './SeriesEntityContractType';

/**
 * The SeriesEntityContract model module.
 * @module model/SeriesEntityContract
 * @version 1.0
 */
class SeriesEntityContract {
    /**
     * Constructs a new <code>SeriesEntityContract</code>.
     * Contract of the series.
     * @alias module:model/SeriesEntityContract
     * @param type {module:model/SeriesEntityContractType} 
     */
    constructor(type) { 
        
        SeriesEntityContract.initialize(this, type);
    }
    ...
    /**
     * Constructs a <code>SeriesEntityContract</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SeriesEntityContract} obj Optional instance to populate.
     * @return {module:model/SeriesEntityContract} The populated <code>SeriesEntityContract</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SeriesEntityContract();

            if (data.hasOwnProperty('partner')) {
                obj['partner'] = SeriesEntityContractPartner.constructFromObject(data['partner']);
            }
            if (data.hasOwnProperty('type')) {
                obj['type'] = SeriesEntityContractType.constructFromObject(data['type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SeriesEntityContract</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SeriesEntityContract</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SeriesEntityContract.RequiredProperties) {
        ...
        if (data['partner']) { // data not null
          SeriesEntityContractPartner.validateJSON(data['partner']);
        }
        // validate the optional field `type`
        if (data['type']) { // data not null
          SeriesEntityContractType.validateJSON(data['type']);
        }
...
SeriesEntityContract.RequiredProperties = ["type"];

/**
 * @member {module:model/SeriesEntityContractPartner} partner
 */
SeriesEntityContract.prototype['partner'] = undefined;

/**
 * @member {module:model/SeriesEntityContractType} type
 */
SeriesEntityContract.prototype['type'] = undefined;
...
export default SeriesEntityContract;
