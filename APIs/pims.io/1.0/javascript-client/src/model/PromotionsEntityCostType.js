...
/**
 * The PromotionsEntityCostType model module.
 * @module model/PromotionsEntityCostType
 * @version 1.0
 */
class PromotionsEntityCostType {
    /**
     * Constructs a new <code>PromotionsEntityCostType</code>.
     * Type of the promotion cost.
     * @alias module:model/PromotionsEntityCostType
     * @param id {module:model/PromotionsEntityCostType.IdEnum} String identifying the type of the promotion cost.
     * @param label {String} Label of the type of the promotion cost. This value is translated according to the 'Accept-Language' header.
     */
    constructor(id, label) { 
        
        PromotionsEntityCostType.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>PromotionsEntityCostType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionsEntityCostType} obj Optional instance to populate.
     * @return {module:model/PromotionsEntityCostType} The populated <code>PromotionsEntityCostType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionsEntityCostType();
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionsEntityCostType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionsEntityCostType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PromotionsEntityCostType.RequiredProperties) {
...
PromotionsEntityCostType.RequiredProperties = ["id", "label"];

/**
 * String identifying the type of the promotion cost.
 * @member {module:model/PromotionsEntityCostType.IdEnum} id
 */
PromotionsEntityCostType.prototype['id'] = undefined;

/**
 * Label of the type of the promotion cost. This value is translated according to the 'Accept-Language' header.
 * @member {String} label
 */
PromotionsEntityCostType.prototype['label'] = undefined;
 ...
 * @readonly
 */
PromotionsEntityCostType['IdEnum'] = {
...
export default PromotionsEntityCostType;
