...
/**
 * The EventsEntityContractPartner model module.
 * @module model/EventsEntityContractPartner
 * @version 1.0
 */
class EventsEntityContractPartner {
    /**
     * Constructs a new <code>EventsEntityContractPartner</code>.
     * Contract partner.
     * @alias module:model/EventsEntityContractPartner
     * @param id {Number} Unique ID identifying the contract partner.
     * @param label {String} Label of the contract partner.
     */
    constructor(id, label) { 
        
        EventsEntityContractPartner.initialize(this, id, label);
    }
    ...
    /**
     * Constructs a <code>EventsEntityContractPartner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventsEntityContractPartner} obj Optional instance to populate.
     * @return {module:model/EventsEntityContractPartner} The populated <code>EventsEntityContractPartner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventsEntityContractPartner();
    ...
    /**
     * Validates the JSON data with respect to <code>EventsEntityContractPartner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventsEntityContractPartner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventsEntityContractPartner.RequiredProperties) {
...
EventsEntityContractPartner.RequiredProperties = ["id", "label"];

/**
 * Unique ID identifying the contract partner.
 * @member {Number} id
 */
EventsEntityContractPartner.prototype['id'] = undefined;

/**
 * Label of the contract partner.
 * @member {String} label
 */
EventsEntityContractPartner.prototype['label'] = undefined;
...
export default EventsEntityContractPartner;
