...
/**
* PriceRanges service.
* @module api/PriceRangesApi
* @version 1.0
*/
export default class PriceRangesApi {

    /**
    * Constructs a new PriceRangesApi. 
    * @alias module:api/PriceRangesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchAllPriceRanges operation.
     * @callback module:api/PriceRangesApi~fetchAllPriceRangesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/PriceRangesEntity>} data The data returned by the service call.
     ...
     * @param {String} [label] Find only the price ranges whose label contains this value.
     * @param {Boolean} [showIgnored = false)] If set to `false`, show only the price ranges which are not ignored. If set to `true`, show all price ranges.
     * @param {module:model/String} [sort = 'label')] Sort the price ranges in the corresponding order.
     ...
     * @param {module:api/PriceRangesApi~fetchAllPriceRangesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/PriceRangesEntity>}
     */
    fetchAllPriceRanges(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = [PriceRangesEntity];
    ...
    /**
     * Callback function to receive the result of the fetchOnePriceRange operation.
     * @callback module:api/PriceRangesApi~fetchOnePriceRangeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VenuesEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Get one price range by ID
     * @param {Number} priceRangeId ID of the targeted price range.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [acceptLanguage = 'en')] Language used for the translatable labels.
     * @param {module:api/PriceRangesApi~fetchOnePriceRangeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VenuesEntity}
     */
    fetchOnePriceRange(priceRangeId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'priceRangeId' is set
      if (priceRangeId === undefined || priceRangeId === null) {
        throw new Error("Missing the required parameter 'priceRangeId' when calling fetchOnePriceRange");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/hal+json'];
      let returnType = VenuesEntity;
      return this.apiClient.callApi(
        '/price-ranges/{price_range_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
