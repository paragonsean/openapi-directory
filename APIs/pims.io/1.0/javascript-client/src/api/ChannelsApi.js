...
export default class ChannelsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchAllChannels operation.
     * @callback module:api/ChannelsApi~fetchAllChannelsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ChannelsEntity>} data The data returned by the service call.
     ...
     * @param {String} [label] Find only the channels whose label contains this value.
     * @param {Boolean} [showIgnored = false)] If set to `false`, show only the channels which are not ignored. If set to `true`, show all channels.
     * @param {module:model/String} [sort = 'label')] Sort the channels in the corresponding order.
     ...
     * @param {module:api/ChannelsApi~fetchAllChannelsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ChannelsEntity>}
     */
    fetchAllChannels(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the fetchAllEventsChannels operation.
     * @callback module:api/ChannelsApi~fetchAllEventsChannelsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/EventsChannelsEntity>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Boolean} [showIgnored = false)] If set to `false`, show only the [event-]channels which are not ignored. If set to `true`, show everything.
     * @param {Number} [pageSize = 25)] Pagination size, i.e. maximum number of items to be displayed in the response.
     * @param {module:api/ChannelsApi~fetchAllEventsChannelsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/EventsChannelsEntity>}
     */
    fetchAllEventsChannels(eventId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'eventId' is set
      if (eventId === undefined || eventId === null) {
        throw new Error("Missing the required parameter 'eventId' when calling fetchAllEventsChannels");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/hal+json'];
      let returnType = [EventsChannelsEntity];
      return this.apiClient.callApi(
        '/events/{event_id}/channels', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the fetchOneChannel operation.
     * @callback module:api/ChannelsApi~fetchOneChannelCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ChannelsEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Get one channel by ID
     * @param {Number} channelId ID of the targeted channel.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [acceptLanguage = 'en')] Language used for the translatable labels.
     * @param {module:api/ChannelsApi~fetchOneChannelCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ChannelsEntity}
     */
    fetchOneChannel(channelId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'channelId' is set
      if (channelId === undefined || channelId === null) {
        throw new Error("Missing the required parameter 'channelId' when calling fetchOneChannel");
      }
    ...
    /**
     * Callback function to receive the result of the fetchOneEventChannel operation.
     * @callback module:api/ChannelsApi~fetchOneEventChannelCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EventsChannelsEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} eventId ID of the targeted event.
     * @param {Number} channelId ID of the targeted event channel.
     * @param {module:api/ChannelsApi~fetchOneEventChannelCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EventsChannelsEntity}
     */
    fetchOneEventChannel(eventId, channelId, callback) {
      let postBody = null;
      // verify the required parameter 'eventId' is set
      if (eventId === undefined || eventId === null) {
        throw new Error("Missing the required parameter 'eventId' when calling fetchOneEventChannel");
      }
      // verify the required parameter 'channelId' is set
      if (channelId === undefined || channelId === null) {
        throw new Error("Missing the required parameter 'channelId' when calling fetchOneEventChannel");
      }
      ...
      let returnType = EventsChannelsEntity;
      return this.apiClient.callApi(
        '/events/{event_id}/channels/{channel_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
