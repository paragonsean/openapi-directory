...
export default class EventsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchAllEvents operation.
     * @callback module:api/EventsApi~fetchAllEventsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/EventsEntity>} data The data returned by the service call.
     ...
     * @param {String} [label] Find only the events whose label contains this value.
     * @param {Date} [fromDatetime] Find only the events starting after this date.
     * @param {Date} [toDatetime] Find only the events starting before this date.
     * @param {String} [city] Find only the events whose venue city (or metropolitan area) contains this value.
     * @param {module:model/String} [sort = 'label')] Sort the events in the corresponding order.
     ...
     * @param {module:api/EventsApi~fetchAllEventsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/EventsEntity>}
     */
    fetchAllEvents(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the fetchAllSeriesEvents operation.
     * @callback module:api/EventsApi~fetchAllSeriesEventsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/EventsEntity>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [pageSize = 25)] Pagination size, i.e. maximum number of items to be displayed in the response.
     * @param {module:model/String} [acceptLanguage = 'en')] Language used for the translatable labels.
     * @param {module:api/EventsApi~fetchAllSeriesEventsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/EventsEntity>}
     */
    fetchAllSeriesEvents(seriesId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'seriesId' is set
      if (seriesId === undefined || seriesId === null) {
        throw new Error("Missing the required parameter 'seriesId' when calling fetchAllSeriesEvents");
      }
    ...
    /**
     * Callback function to receive the result of the fetchAllVenuesEvents operation.
     * @callback module:api/EventsApi~fetchAllVenuesEventsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/EventsEntity>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} venueId ID of the targeted venue.
     * @param {Object} opts Optional parameters
     * @param {Date} [fromDatetime] Find only the events starting after this date.
     * @param {Date} [toDatetime] Find only the events starting before this date.
     * @param {String} [city] Find only the events whose venue city (or metropolitan area) contains this value.
     ...
     * @param {Number} [pageSize = 25)] Pagination size, i.e. maximum number of items to be displayed in the response.
     * @param {module:model/String} [acceptLanguage = 'en')] Language used for the translatable labels.
     * @param {module:api/EventsApi~fetchAllVenuesEventsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/EventsEntity>}
     */
    fetchAllVenuesEvents(venueId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'venueId' is set
      if (venueId === undefined || venueId === null) {
        throw new Error("Missing the required parameter 'venueId' when calling fetchAllVenuesEvents");
      }
    ...
    /**
     * Callback function to receive the result of the fetchOneEvent operation.
     * @callback module:api/EventsApi~fetchOneEventCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EventsEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [acceptLanguage = 'en')] Language used for the translatable labels.
     * @param {module:api/EventsApi~fetchOneEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EventsEntity}
     */
    fetchOneEvent(eventId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'eventId' is set
      if (eventId === undefined || eventId === null) {
        throw new Error("Missing the required parameter 'eventId' when calling fetchOneEvent");
      }
