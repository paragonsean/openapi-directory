...
/**
* Counts service.
* @module api/CountsApi
* @version 1.0
*/
export default class CountsApi {

    /**
    * Constructs a new CountsApi. 
    * @alias module:api/CountsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchAllDetailedTicketCounts operation.
     * @callback module:api/CountsApi~fetchAllDetailedTicketCountsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/TicketCountsDetailedEntity>} data The data returned by the service call.
     ...
     * @param {Date} [fromDate] Find only the ticket counts after this date.
     * @param {Date} [toDate] Find only the ticket counts before this date.
     * @param {Boolean} [showIgnored = false)] If set to `false`, show only the [event-]categories/[event-]price ranges/[event]channels which are not ignored. If set to `true`, show everything.
     * @param {Boolean} [showNotApproved = false)] If set to `false`, show only the approved ticket counts. If set to `true`, show all the ticket counts.
     * @param {module:model/String} [sort = 'date')] Sort the ticket counts in the corresponding order.
     * @param {Number} [pageSize = 25)] Pagination size, i.e. maximum number of items to be displayed in the response.
     * @param {module:api/CountsApi~fetchAllDetailedTicketCountsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/TicketCountsDetailedEntity>}
     */
    fetchAllDetailedTicketCounts(eventId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'eventId' is set
      if (eventId === undefined || eventId === null) {
        throw new Error("Missing the required parameter 'eventId' when calling fetchAllDetailedTicketCounts");
      }
      ...
      let queryParams = {
        ...
        'show_not_approved': opts['showNotApproved'],
        'sort': opts['sort'],
      ...
      let returnType = [TicketCountsDetailedEntity];
      return this.apiClient.callApi(
        '/events/{event_id}/ticket-counts/detailed', 'GET',
    ...
    /**
     * Callback function to receive the result of the fetchAllTicketCounts operation.
     * @callback module:api/CountsApi~fetchAllTicketCountsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/TicketCountsEntity>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} [sort = 'date')] Sort the ticket counts in the corresponding order.
     * @param {Number} [pageSize = 25)] Pagination size, i.e. maximum number of items to be displayed in the response.
     * @param {module:api/CountsApi~fetchAllTicketCountsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/TicketCountsEntity>}
     */
    fetchAllTicketCounts(eventId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'eventId' is set
      if (eventId === undefined || eventId === null) {
        throw new Error("Missing the required parameter 'eventId' when calling fetchAllTicketCounts");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/hal+json'];
      let returnType = [TicketCountsEntity];
      return this.apiClient.callApi(
        '/events/{event_id}/ticket-counts', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the fetchOneDetailedTicketCount operation.
     * @callback module:api/CountsApi~fetchOneDetailedTicketCountCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TicketCountsDetailedEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} eventId ID of the targeted event.
     * @param {Number} ticketCountId ID of the targeted ticket count.
     * @param {Object} opts Optional parameters
     * @param {Boolean} [showIgnored = false)] If set to `false`, show only the [event-]categories/[event-]price ranges/[event]channels which are not ignored. If set to `true`, show everything.
     * @param {module:api/CountsApi~fetchOneDetailedTicketCountCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TicketCountsDetailedEntity}
     */
    fetchOneDetailedTicketCount(eventId, ticketCountId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'eventId' is set
      if (eventId === undefined || eventId === null) {
        throw new Error("Missing the required parameter 'eventId' when calling fetchOneDetailedTicketCount");
      }
      // verify the required parameter 'ticketCountId' is set
      if (ticketCountId === undefined || ticketCountId === null) {
        throw new Error("Missing the required parameter 'ticketCountId' when calling fetchOneDetailedTicketCount");
      }

      let pathParams = {
        'event_id': eventId,
        'ticket_count_id': ticketCountId
      };
      let queryParams = {
        'show_ignored': opts['showIgnored']
      };
      ...
      let returnType = TicketCountsDetailedEntity;
      return this.apiClient.callApi(
        '/events/{event_id}/ticket-counts/detailed/{ticket_count_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the fetchOneTicketCount operation.
     * @callback module:api/CountsApi~fetchOneTicketCountCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TicketCountsEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Boolean} [showIgnored = false)] If set to `false`, show only the [event-]categories/[event-]price ranges/[event]channels which are not ignored. If set to `true`, show everything.
     * @param {module:api/CountsApi~fetchOneTicketCountCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TicketCountsEntity}
     */
    fetchOneTicketCount(eventId, ticketCountId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'eventId' is set
      if (eventId === undefined || eventId === null) {
        throw new Error("Missing the required parameter 'eventId' when calling fetchOneTicketCount");
      }
      // verify the required parameter 'ticketCountId' is set
      if (ticketCountId === undefined || ticketCountId === null) {
        throw new Error("Missing the required parameter 'ticketCountId' when calling fetchOneTicketCount");
      }
      ...
      let returnType = TicketCountsEntity;
      return this.apiClient.callApi(
        '/events/{event_id}/ticket-counts/{ticket_count_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
