...
export default class SeriesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchAllSeries operation.
     * @callback module:api/SeriesApi~fetchAllSeriesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/SeriesEntity>} data The data returned by the service call.
     ...
     * @param {String} [label] Find only the venues whose label contains this value.
     * @param {Date} [fromDate] Find only the series starting after this date.
     * @param {Date} [toDate] Find only the series ending before this date.
     * @param {module:model/String} [type] Find only the series whose type is equal to this value.
     * @param {module:model/String} [sort = 'first_date')] Sort the series in the corresponding order.
     ...
     * @param {module:api/SeriesApi~fetchAllSeriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/SeriesEntity>}
     */
    fetchAllSeries(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the fetchOneSeries operation.
     * @callback module:api/SeriesApi~fetchOneSeriesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SeriesEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [acceptLanguage = 'en')] Language used for the translatable labels.
     * @param {module:api/SeriesApi~fetchOneSeriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SeriesEntity}
     */
    fetchOneSeries(seriesId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'seriesId' is set
      if (seriesId === undefined || seriesId === null) {
        throw new Error("Missing the required parameter 'seriesId' when calling fetchOneSeries");
      }
