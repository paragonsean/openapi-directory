...
export default class CapacitiesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchAllEventsCapacities operation.
     * @callback module:api/CapacitiesApi~fetchAllEventsCapacitiesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/EventsCapacitiesEntity>} data The data returned by the service call.
     ...
     * @param {Boolean} [showIgnored = false)] If set to `false`, show only the [event-]categories which are not ignored. If set to `true`, show everything.
     * @param {module:model/String} [sort = 'date')] Sort the capacities in the corresponding order.
     * @param {Number} [pageSize = 25)] Pagination size, i.e. maximum number of items to be displayed in the response.
     * @param {module:api/CapacitiesApi~fetchAllEventsCapacitiesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/EventsCapacitiesEntity>}
     */
    fetchAllEventsCapacities(eventId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'eventId' is set
      if (eventId === undefined || eventId === null) {
        throw new Error("Missing the required parameter 'eventId' when calling fetchAllEventsCapacities");
      }
      ...
      let returnType = [EventsCapacitiesEntity];
      return this.apiClient.callApi(
        '/events/{event_id}/capacities', 'GET',
    ...
    /**
     * Callback function to receive the result of the fetchOneEventCapacity operation.
     * @callback module:api/CapacitiesApi~fetchOneEventCapacityCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EventsCapacitiesEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} eventId ID of the targeted event.
     * @param {Number} capacityId ID of the targeted capacity.
     * @param {Object} opts Optional parameters
     * @param {Boolean} [showIgnored = false)] If set to `false`, show only the [event-]categories which are not ignored. If set to `true`, show everything.
     * @param {module:api/CapacitiesApi~fetchOneEventCapacityCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EventsCapacitiesEntity}
     */
    fetchOneEventCapacity(eventId, capacityId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'eventId' is set
      if (eventId === undefined || eventId === null) {
        throw new Error("Missing the required parameter 'eventId' when calling fetchOneEventCapacity");
      }
      // verify the required parameter 'capacityId' is set
      if (capacityId === undefined || capacityId === null) {
        throw new Error("Missing the required parameter 'capacityId' when calling fetchOneEventCapacity");
      }
      ...
      let returnType = EventsCapacitiesEntity;
      return this.apiClient.callApi(
        '/events/{event_id}/capacities/{capacity_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
