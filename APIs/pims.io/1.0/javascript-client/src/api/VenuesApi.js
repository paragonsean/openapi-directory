...
export default class VenuesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the fetchAllVenues operation.
     * @callback module:api/VenuesApi~fetchAllVenuesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/VenuesEntity>} data The data returned by the service call.
     ...
     * @param {String} [city] Find only the venues whose city contains this value.
     * @param {String} [countryCode] Find only the venues whose country_code is equal to this value.
     * @param {module:model/String} [type] Find only the venues whose type is equal to this value.
     * @param {module:model/String} [sort = 'label')] Sort the venues in the corresponding order.
     ...
     * @param {module:api/VenuesApi~fetchAllVenuesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/VenuesEntity>}
     */
    fetchAllVenues(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the fetchOneVenue operation.
     * @callback module:api/VenuesApi~fetchOneVenueCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [acceptLanguage = 'en')] Language used for the translatable labels.
     * @param {module:api/VenuesApi~fetchOneVenueCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VenuesEntity}
     */
    fetchOneVenue(venueId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'venueId' is set
      if (venueId === undefined || venueId === null) {
        throw new Error("Missing the required parameter 'venueId' when calling fetchOneVenue");
      }
