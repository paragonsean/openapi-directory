...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.CapacitiesApi();
  });
  ...
  describe('CapacitiesApi', function() {
    describe('fetchAllEventsCapacities', function() {
      it('should call fetchAllEventsCapacities successfully', function(done) {
        //uncomment below and update the code to test fetchAllEventsCapacities
        //instance.fetchAllEventsCapacities(function(error) {
    ...
    describe('fetchOneEventCapacity', function() {
      it('should call fetchOneEventCapacity successfully', function(done) {
        //uncomment below and update the code to test fetchOneEventCapacity
        //instance.fetchOneEventCapacity(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
