...
(function(root, factory) {
  ...
  describe('CountsApi', function() {
    describe('fetchAllDetailedTicketCounts', function() {
      it('should call fetchAllDetailedTicketCounts successfully', function(done) {
        //uncomment below and update the code to test fetchAllDetailedTicketCounts
        //instance.fetchAllDetailedTicketCounts(function(error) {
    ...
    describe('fetchAllTicketCounts', function() {
      it('should call fetchAllTicketCounts successfully', function(done) {
        //uncomment below and update the code to test fetchAllTicketCounts
        //instance.fetchAllTicketCounts(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchOneDetailedTicketCount', function() {
      it('should call fetchOneDetailedTicketCount successfully', function(done) {
        //uncomment below and update the code to test fetchOneDetailedTicketCount
        //instance.fetchOneDetailedTicketCount(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchOneTicketCount', function() {
      it('should call fetchOneTicketCount successfully', function(done) {
        //uncomment below and update the code to test fetchOneTicketCount
        //instance.fetchOneTicketCount(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
