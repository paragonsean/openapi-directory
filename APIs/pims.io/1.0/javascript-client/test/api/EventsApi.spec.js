...
(function(root, factory) {
  ...
  describe('EventsApi', function() {
    describe('fetchAllEvents', function() {
      it('should call fetchAllEvents successfully', function(done) {
        //uncomment below and update the code to test fetchAllEvents
        //instance.fetchAllEvents(function(error) {
    ...
    describe('fetchAllSeriesEvents', function() {
      it('should call fetchAllSeriesEvents successfully', function(done) {
        //uncomment below and update the code to test fetchAllSeriesEvents
        //instance.fetchAllSeriesEvents(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchAllVenuesEvents', function() {
      it('should call fetchAllVenuesEvents successfully', function(done) {
        //uncomment below and update the code to test fetchAllVenuesEvents
        //instance.fetchAllVenuesEvents(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchOneEvent', function() {
      it('should call fetchOneEvent successfully', function(done) {
        //uncomment below and update the code to test fetchOneEvent
        //instance.fetchOneEvent(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
