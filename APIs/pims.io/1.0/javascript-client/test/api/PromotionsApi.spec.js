...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PromotionsApi();
  });
  ...
  describe('PromotionsApi', function() {
    describe('fetchAllEventsPromotions', function() {
      it('should call fetchAllEventsPromotions successfully', function(done) {
        //uncomment below and update the code to test fetchAllEventsPromotions
        //instance.fetchAllEventsPromotions(function(error) {
    ...
    describe('fetchAllPromotions', function() {
      it('should call fetchAllPromotions successfully', function(done) {
        //uncomment below and update the code to test fetchAllPromotions
        //instance.fetchAllPromotions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchAllSeriesPromotions', function() {
      it('should call fetchAllSeriesPromotions successfully', function(done) {
        //uncomment below and update the code to test fetchAllSeriesPromotions
        //instance.fetchAllSeriesPromotions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchOnePromotion', function() {
      it('should call fetchOnePromotion successfully', function(done) {
        //uncomment below and update the code to test fetchOnePromotion
        //instance.fetchOnePromotion(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
