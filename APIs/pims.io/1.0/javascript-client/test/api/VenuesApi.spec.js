...
(function(root, factory) {
  ...
  describe('VenuesApi', function() {
    describe('fetchAllVenues', function() {
      it('should call fetchAllVenues successfully', function(done) {
        //uncomment below and update the code to test fetchAllVenues
        //instance.fetchAllVenues(function(error) {
    ...
    describe('fetchOneVenue', function() {
      it('should call fetchOneVenue successfully', function(done) {
        //uncomment below and update the code to test fetchOneVenue
        //instance.fetchOneVenue(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
