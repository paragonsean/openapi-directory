...
(function(root, factory) {
  ...
  describe('SeriesApi', function() {
    describe('fetchAllSeries', function() {
      it('should call fetchAllSeries successfully', function(done) {
        //uncomment below and update the code to test fetchAllSeries
        //instance.fetchAllSeries(function(error) {
    ...
    describe('fetchOneSeries', function() {
      it('should call fetchOneSeries successfully', function(done) {
        //uncomment below and update the code to test fetchOneSeries
        //instance.fetchOneSeries(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
