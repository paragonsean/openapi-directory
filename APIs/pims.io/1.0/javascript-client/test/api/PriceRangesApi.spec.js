...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PriceRangesApi();
  });
  ...
  describe('PriceRangesApi', function() {
    describe('fetchAllPriceRanges', function() {
      it('should call fetchAllPriceRanges successfully', function(done) {
        //uncomment below and update the code to test fetchAllPriceRanges
        //instance.fetchAllPriceRanges(function(error) {
    ...
    describe('fetchOnePriceRange', function() {
      it('should call fetchOnePriceRange successfully', function(done) {
        //uncomment below and update the code to test fetchOnePriceRange
        //instance.fetchOnePriceRange(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
