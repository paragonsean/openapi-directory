...
(function(root, factory) {
  ...
  describe('ChannelsApi', function() {
    describe('fetchAllChannels', function() {
      it('should call fetchAllChannels successfully', function(done) {
        //uncomment below and update the code to test fetchAllChannels
        //instance.fetchAllChannels(function(error) {
    ...
    describe('fetchAllEventsChannels', function() {
      it('should call fetchAllEventsChannels successfully', function(done) {
        //uncomment below and update the code to test fetchAllEventsChannels
        //instance.fetchAllEventsChannels(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchOneChannel', function() {
      it('should call fetchOneChannel successfully', function(done) {
        //uncomment below and update the code to test fetchOneChannel
        //instance.fetchOneChannel(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchOneEventChannel', function() {
      it('should call fetchOneEventChannel successfully', function(done) {
        //uncomment below and update the code to test fetchOneEventChannel
        //instance.fetchOneEventChannel(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
