...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.CategoriesApi();
  });
  ...
  describe('CategoriesApi', function() {
    describe('fetchAllCategories', function() {
      it('should call fetchAllCategories successfully', function(done) {
        //uncomment below and update the code to test fetchAllCategories
        //instance.fetchAllCategories(function(error) {
    ...
    describe('fetchAllEventsCategories', function() {
      it('should call fetchAllEventsCategories successfully', function(done) {
        //uncomment below and update the code to test fetchAllEventsCategories
        //instance.fetchAllEventsCategories(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchOneCategory', function() {
      it('should call fetchOneCategory successfully', function(done) {
        //uncomment below and update the code to test fetchOneCategory
        //instance.fetchOneCategory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fetchOneEventCategory', function() {
      it('should call fetchOneEventCategory successfully', function(done) {
        //uncomment below and update the code to test fetchOneEventCategory
        //instance.fetchOneEventCategory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
