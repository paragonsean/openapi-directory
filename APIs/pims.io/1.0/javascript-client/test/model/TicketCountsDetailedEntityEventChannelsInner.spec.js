...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.TicketCountsDetailedEntityEventChannelsInner();
  });
  ...
  describe('TicketCountsDetailedEntityEventChannelsInner', function() {
    it('should create an instance of TicketCountsDetailedEntityEventChannelsInner', function() {
      // uncomment below and update the code to test TicketCountsDetailedEntityEventChannelsInner
      //var instance = new Pims.TicketCountsDetailedEntityEventChannelsInner();
      //expect(instance).to.be.a(Pims.TicketCountsDetailedEntityEventChannelsInner);
    });
