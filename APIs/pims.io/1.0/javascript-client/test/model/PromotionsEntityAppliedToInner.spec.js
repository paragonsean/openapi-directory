...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PromotionsEntityAppliedToInner();
  });
  ...
  describe('PromotionsEntityAppliedToInner', function() {
    it('should create an instance of PromotionsEntityAppliedToInner', function() {
      // uncomment below and update the code to test PromotionsEntityAppliedToInner
      //var instance = new Pims.PromotionsEntityAppliedToInner();
      //expect(instance).to.be.a(Pims.PromotionsEntityAppliedToInner);
    });
    ...
    it('should have the property valorizedQuantity (base name: "valorized_quantity")', function() {
      // uncomment below and update the code to test the property valorizedQuantity
      //var instance = new Pims.PromotionsEntityAppliedToInner();
      //expect(instance).to.be();
    });

    it('should have the property valorizedUnitCost (base name: "valorized_unit_cost")', function() {
      // uncomment below and update the code to test the property valorizedUnitCost
      //var instance = new Pims.PromotionsEntityAppliedToInner();
      //expect(instance).to.be();
    });
