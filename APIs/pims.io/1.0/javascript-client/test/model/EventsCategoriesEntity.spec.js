...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.EventsCategoriesEntity();
  });
  ...
  describe('EventsCategoriesEntity', function() {
    it('should create an instance of EventsCategoriesEntity', function() {
      // uncomment below and update the code to test EventsCategoriesEntity
      //var instance = new Pims.EventsCategoriesEntity();
      //expect(instance).to.be.a(Pims.EventsCategoriesEntity);
    });
