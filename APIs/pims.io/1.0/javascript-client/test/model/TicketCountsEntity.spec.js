...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.TicketCountsEntity();
  });
  ...
  describe('TicketCountsEntity', function() {
    it('should create an instance of TicketCountsEntity', function() {
      // uncomment below and update the code to test TicketCountsEntity
      //var instance = new Pims.TicketCountsEntity();
      //expect(instance).to.be.a(Pims.TicketCountsEntity);
    });
