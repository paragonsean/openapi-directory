...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.CategoriesEntity();
  });
  ...
  describe('CategoriesEntity', function() {
    it('should create an instance of CategoriesEntity', function() {
      // uncomment below and update the code to test CategoriesEntity
      //var instance = new Pims.CategoriesEntity();
      //expect(instance).to.be.a(Pims.CategoriesEntity);
    });
    ...
    it('should have the property shortLabel (base name: "short_label")', function() {
      // uncomment below and update the code to test the property shortLabel
      //var instance = new Pims.CategoriesEntity();
      //expect(instance).to.be();
    });
