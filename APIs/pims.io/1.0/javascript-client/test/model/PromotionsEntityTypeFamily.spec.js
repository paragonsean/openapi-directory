...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PromotionsEntityTypeFamily();
  });
  ...
  describe('PromotionsEntityTypeFamily', function() {
    it('should create an instance of PromotionsEntityTypeFamily', function() {
      // uncomment below and update the code to test PromotionsEntityTypeFamily
      //var instance = new Pims.PromotionsEntityTypeFamily();
      //expect(instance).to.be.a(Pims.PromotionsEntityTypeFamily);
    });
