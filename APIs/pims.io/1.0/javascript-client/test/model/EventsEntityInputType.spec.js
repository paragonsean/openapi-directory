...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.EventsEntityInputType();
  });
  ...
  describe('EventsEntityInputType', function() {
    it('should create an instance of EventsEntityInputType', function() {
      // uncomment below and update the code to test EventsEntityInputType
      //var instance = new Pims.EventsEntityInputType();
      //expect(instance).to.be.a(Pims.EventsEntityInputType);
    });
