...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.EventsChannelsEntity();
  });
  ...
  describe('EventsChannelsEntity', function() {
    it('should create an instance of EventsChannelsEntity', function() {
      // uncomment below and update the code to test EventsChannelsEntity
      //var instance = new Pims.EventsChannelsEntity();
      //expect(instance).to.be.a(Pims.EventsChannelsEntity);
    });
