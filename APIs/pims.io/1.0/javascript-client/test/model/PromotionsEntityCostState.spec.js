...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PromotionsEntityCostState();
  });
  ...
  describe('PromotionsEntityCostState', function() {
    it('should create an instance of PromotionsEntityCostState', function() {
      // uncomment below and update the code to test PromotionsEntityCostState
      //var instance = new Pims.PromotionsEntityCostState();
      //expect(instance).to.be.a(Pims.PromotionsEntityCostState);
    });
