...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PromotionsEntityCost();
  });
  ...
  describe('PromotionsEntityCost', function() {
    it('should create an instance of PromotionsEntityCost', function() {
      // uncomment below and update the code to test PromotionsEntityCost
      //var instance = new Pims.PromotionsEntityCost();
      //expect(instance).to.be.a(Pims.PromotionsEntityCost);
    });
