...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.EventsCapacitiesEntityEventCategoriesInner();
  });
  ...
  describe('EventsCapacitiesEntityEventCategoriesInner', function() {
    it('should create an instance of EventsCapacitiesEntityEventCategoriesInner', function() {
      // uncomment below and update the code to test EventsCapacitiesEntityEventCategoriesInner
      //var instance = new Pims.EventsCapacitiesEntityEventCategoriesInner();
      //expect(instance).to.be.a(Pims.EventsCapacitiesEntityEventCategoriesInner);
    });

    it('should have the property comps (base name: "comps")', function() {
      // uncomment below and update the code to test the property comps
      //var instance = new Pims.EventsCapacitiesEntityEventCategoriesInner();
    ...
    it('should have the property sellableCapacity (base name: "sellable_capacity")', function() {
      // uncomment below and update the code to test the property sellableCapacity
      //var instance = new Pims.EventsCapacitiesEntityEventCategoriesInner();
      //expect(instance).to.be();
    });
