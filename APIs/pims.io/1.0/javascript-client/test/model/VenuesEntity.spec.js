...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.VenuesEntity();
  });
  ...
  describe('VenuesEntity', function() {
    it('should create an instance of VenuesEntity', function() {
      // uncomment below and update the code to test VenuesEntity
      //var instance = new Pims.VenuesEntity();
      //expect(instance).to.be.a(Pims.VenuesEntity);
    });

    it('should have the property alternativeLabels (base name: "alternative_labels")', function() {
      // uncomment below and update the code to test the property alternativeLabels
      //var instance = new Pims.VenuesEntity();
    ...
    it('should have the property firstAddress (base name: "first_address")', function() {
      // uncomment below and update the code to test the property firstAddress
      //var instance = new Pims.VenuesEntity();
      //expect(instance).to.be();
    });
    ...
    it('should have the property majorCity (base name: "major_city")', function() {
      // uncomment below and update the code to test the property majorCity
      //var instance = new Pims.VenuesEntity();
      //expect(instance).to.be();
    });

    it('should have the property secondAddress (base name: "second_address")', function() {
      // uncomment below and update the code to test the property secondAddress
      //var instance = new Pims.VenuesEntity();
      //expect(instance).to.be();
    });
