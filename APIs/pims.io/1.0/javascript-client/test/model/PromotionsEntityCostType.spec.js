...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PromotionsEntityCostType();
  });
  ...
  describe('PromotionsEntityCostType', function() {
    it('should create an instance of PromotionsEntityCostType', function() {
      // uncomment below and update the code to test PromotionsEntityCostType
      //var instance = new Pims.PromotionsEntityCostType();
      //expect(instance).to.be.a(Pims.PromotionsEntityCostType);
    });
