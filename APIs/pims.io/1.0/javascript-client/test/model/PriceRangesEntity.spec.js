...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PriceRangesEntity();
  });
  ...
  describe('PriceRangesEntity', function() {
    it('should create an instance of PriceRangesEntity', function() {
      // uncomment below and update the code to test PriceRangesEntity
      //var instance = new Pims.PriceRangesEntity();
      //expect(instance).to.be.a(Pims.PriceRangesEntity);
    });
