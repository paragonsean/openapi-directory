...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.EventsCategoriesEntityEventPriceRangesInner();
  });
  ...
  describe('EventsCategoriesEntityEventPriceRangesInner', function() {
    it('should create an instance of EventsCategoriesEntityEventPriceRangesInner', function() {
      // uncomment below and update the code to test EventsCategoriesEntityEventPriceRangesInner
      //var instance = new Pims.EventsCategoriesEntityEventPriceRangesInner();
      //expect(instance).to.be.a(Pims.EventsCategoriesEntityEventPriceRangesInner);
    });
    ...
    it('should have the property publicPrice (base name: "public_price")', function() {
      // uncomment below and update the code to test the property publicPrice
      //var instance = new Pims.EventsCategoriesEntityEventPriceRangesInner();
      //expect(instance).to.be();
    });
