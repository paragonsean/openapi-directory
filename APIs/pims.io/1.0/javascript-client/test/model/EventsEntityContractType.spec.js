...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.EventsEntityContractType();
  });
  ...
  describe('EventsEntityContractType', function() {
    it('should create an instance of EventsEntityContractType', function() {
      // uncomment below and update the code to test EventsEntityContractType
      //var instance = new Pims.EventsEntityContractType();
      //expect(instance).to.be.a(Pims.EventsEntityContractType);
    });
