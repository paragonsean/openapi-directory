...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.SeriesEntityContractType();
  });
  ...
  describe('SeriesEntityContractType', function() {
    it('should create an instance of SeriesEntityContractType', function() {
      // uncomment below and update the code to test SeriesEntityContractType
      //var instance = new Pims.SeriesEntityContractType();
      //expect(instance).to.be.a(Pims.SeriesEntityContractType);
    });
