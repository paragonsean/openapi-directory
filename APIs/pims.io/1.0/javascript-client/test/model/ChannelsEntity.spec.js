...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.ChannelsEntity();
  });
  ...
  describe('ChannelsEntity', function() {
    it('should create an instance of ChannelsEntity', function() {
      // uncomment below and update the code to test ChannelsEntity
      //var instance = new Pims.ChannelsEntity();
      //expect(instance).to.be.a(Pims.ChannelsEntity);
    });
