...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner();
  });
  ...
  describe('TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner', function() {
    it('should create an instance of TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner', function() {
      // uncomment below and update the code to test TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner
      //var instance = new Pims.TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner();
      //expect(instance).to.be.a(Pims.TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInnerEventPriceRangesInner);
    });
