...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.EventsEntityContract();
  });
  ...
  describe('EventsEntityContract', function() {
    it('should create an instance of EventsEntityContract', function() {
      // uncomment below and update the code to test EventsEntityContract
      //var instance = new Pims.EventsEntityContract();
      //expect(instance).to.be.a(Pims.EventsEntityContract);
    });
