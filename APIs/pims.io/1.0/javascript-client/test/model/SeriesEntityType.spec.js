...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.SeriesEntityType();
  });
  ...
  describe('SeriesEntityType', function() {
    it('should create an instance of SeriesEntityType', function() {
      // uncomment below and update the code to test SeriesEntityType
      //var instance = new Pims.SeriesEntityType();
      //expect(instance).to.be.a(Pims.SeriesEntityType);
    });
