...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.Pims);
  }
}(this, function(expect, Pims) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new Pims.EventsEntity();
  });
  ...
  describe('EventsEntity', function() {
    it('should create an instance of EventsEntity', function() {
      // uncomment below and update the code to test EventsEntity
      //var instance = new Pims.EventsEntity();
      //expect(instance).to.be.a(Pims.EventsEntity);
    });

    it('should have the property breakEven (base name: "break_even")', function() {
      // uncomment below and update the code to test the property breakEven
      //var instance = new Pims.EventsEntity();
      //expect(instance).to.be();
    });

    it('should have the property cancellationDate (base name: "cancellation_date")', function() {
    ...
    it('should have the property costingCapacity (base name: "costing_capacity")', function() {
      // uncomment below and update the code to test the property costingCapacity
      //var instance = new Pims.EventsEntity();
      //expect(instance).to.be();
    });
    ...
    it('should have the property generalSalesDate (base name: "general_sales_date")', function() {
      // uncomment below and update the code to test the property generalSalesDate
      //var instance = new Pims.EventsEntity();
      //expect(instance).to.be();
    });
    ...
    it('should have the property maxCapacity (base name: "max_capacity")', function() {
      // uncomment below and update the code to test the property maxCapacity
      //var instance = new Pims.EventsEntity();
      //expect(instance).to.be();
    });

    it('should have the property presalesDate (base name: "presales_date")', function() {
      // uncomment below and update the code to test the property presalesDate
      //var instance = new Pims.EventsEntity();
      //expect(instance).to.be();
    });
    ...
    it('should have the property soldOutDate (base name: "sold_out_date")', function() {
      // uncomment below and update the code to test the property soldOutDate
      //var instance = new Pims.EventsEntity();
      //expect(instance).to.be();
    });
