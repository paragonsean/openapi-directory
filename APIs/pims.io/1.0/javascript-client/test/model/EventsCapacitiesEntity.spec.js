...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.EventsCapacitiesEntity();
  });
  ...
  describe('EventsCapacitiesEntity', function() {
    it('should create an instance of EventsCapacitiesEntity', function() {
      // uncomment below and update the code to test EventsCapacitiesEntity
      //var instance = new Pims.EventsCapacitiesEntity();
      //expect(instance).to.be.a(Pims.EventsCapacitiesEntity);
    });
