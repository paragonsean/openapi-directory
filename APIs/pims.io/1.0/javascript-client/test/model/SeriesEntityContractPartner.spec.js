...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.SeriesEntityContractPartner();
  });
  ...
  describe('SeriesEntityContractPartner', function() {
    it('should create an instance of SeriesEntityContractPartner', function() {
      // uncomment below and update the code to test SeriesEntityContractPartner
      //var instance = new Pims.SeriesEntityContractPartner();
      //expect(instance).to.be.a(Pims.SeriesEntityContractPartner);
    });
