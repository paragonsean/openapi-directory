...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.TicketCountsDetailedEntity();
  });
  ...
  describe('TicketCountsDetailedEntity', function() {
    it('should create an instance of TicketCountsDetailedEntity', function() {
      // uncomment below and update the code to test TicketCountsDetailedEntity
      //var instance = new Pims.TicketCountsDetailedEntity();
      //expect(instance).to.be.a(Pims.TicketCountsDetailedEntity);
    });
    ...
    it('should have the property eventChannels (base name: "event_channels")', function() {
      // uncomment below and update the code to test the property eventChannels
      //var instance = new Pims.TicketCountsDetailedEntity();
      //expect(instance).to.be();
    });
