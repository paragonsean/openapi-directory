...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.VenuesEntityType();
  });
  ...
  describe('VenuesEntityType', function() {
    it('should create an instance of VenuesEntityType', function() {
      // uncomment below and update the code to test VenuesEntityType
      //var instance = new Pims.VenuesEntityType();
      //expect(instance).to.be.a(Pims.VenuesEntityType);
    });
