...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.SeriesEntityContract();
  });
  ...
  describe('SeriesEntityContract', function() {
    it('should create an instance of SeriesEntityContract', function() {
      // uncomment below and update the code to test SeriesEntityContract
      //var instance = new Pims.SeriesEntityContract();
      //expect(instance).to.be.a(Pims.SeriesEntityContract);
    });
