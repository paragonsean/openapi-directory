...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PromotionsEntityType();
  });
  ...
  describe('PromotionsEntityType', function() {
    it('should create an instance of PromotionsEntityType', function() {
      // uncomment below and update the code to test PromotionsEntityType
      //var instance = new Pims.PromotionsEntityType();
      //expect(instance).to.be.a(Pims.PromotionsEntityType);
    });
