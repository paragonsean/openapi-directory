...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PromotionsEntitySupplier();
  });
  ...
  describe('PromotionsEntitySupplier', function() {
    it('should create an instance of PromotionsEntitySupplier', function() {
      // uncomment below and update the code to test PromotionsEntitySupplier
      //var instance = new Pims.PromotionsEntitySupplier();
      //expect(instance).to.be.a(Pims.PromotionsEntitySupplier);
    });
