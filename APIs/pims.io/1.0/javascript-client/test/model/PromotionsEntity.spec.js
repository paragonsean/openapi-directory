...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.PromotionsEntity();
  });
  ...
  describe('PromotionsEntity', function() {
    it('should create an instance of PromotionsEntity', function() {
      // uncomment below and update the code to test PromotionsEntity
      //var instance = new Pims.PromotionsEntity();
      //expect(instance).to.be.a(Pims.PromotionsEntity);
    });

    it('should have the property appliedTo (base name: "applied_to")', function() {
