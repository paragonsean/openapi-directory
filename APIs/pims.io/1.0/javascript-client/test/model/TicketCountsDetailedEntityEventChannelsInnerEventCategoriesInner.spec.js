...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner();
  });
  ...
  describe('TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner', function() {
    it('should create an instance of TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner', function() {
      // uncomment below and update the code to test TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner
      //var instance = new Pims.TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner();
      //expect(instance).to.be.a(Pims.TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner);
    });

    it('should have the property eventPriceRanges (base name: "event_price_ranges")', function() {
      // uncomment below and update the code to test the property eventPriceRanges
      //var instance = new Pims.TicketCountsDetailedEntityEventChannelsInnerEventCategoriesInner();
