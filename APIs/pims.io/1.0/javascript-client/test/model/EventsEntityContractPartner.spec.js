...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.EventsEntityContractPartner();
  });
  ...
  describe('EventsEntityContractPartner', function() {
    it('should create an instance of EventsEntityContractPartner', function() {
      // uncomment below and update the code to test EventsEntityContractPartner
      //var instance = new Pims.EventsEntityContractPartner();
      //expect(instance).to.be.a(Pims.EventsEntityContractPartner);
    });
