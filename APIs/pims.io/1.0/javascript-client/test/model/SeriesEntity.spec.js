...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Pims.SeriesEntity();
  });
  ...
  describe('SeriesEntity', function() {
    it('should create an instance of SeriesEntity', function() {
      // uncomment below and update the code to test SeriesEntity
      //var instance = new Pims.SeriesEntity();
      //expect(instance).to.be.a(Pims.SeriesEntity);
    });
