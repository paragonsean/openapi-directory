...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToTraining.Attendee();
  });
  ...
  describe('Attendee', function() {
    it('should create an instance of Attendee', function() {
      ...
      //var instance = new GoToTraining.Attendee();
      //expect(instance).to.be.a(GoToTraining.Attendee);
    });
    ...
    it('should have the property inSessionTimes (base name: "inSessionTimes")', function() {
      // uncomment below and update the code to test the property inSessionTimes
      //var instance = new GoToTraining.Attendee();
      //expect(instance).to.be();
    });
    ...
    it('should have the property timeInSession (base name: "timeInSession")', function() {
      // uncomment below and update the code to test the property timeInSession
      //var instance = new GoToTraining.Attendee();
      //expect(instance).to.be();
    });
