...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToTraining.RegistrantReqCreate();
  });
  ...
  describe('RegistrantReqCreate', function() {
    it('should create an instance of RegistrantReqCreate', function() {
      // uncomment below and update the code to test RegistrantReqCreate
      //var instance = new GoToTraining.RegistrantReqCreate();
      //expect(instance).to.be.a(GoToTraining.RegistrantReqCreate);
    });
