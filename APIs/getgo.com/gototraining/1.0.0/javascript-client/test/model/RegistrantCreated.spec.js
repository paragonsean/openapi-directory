...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToTraining.RegistrantCreated();
  });
  ...
  describe('RegistrantCreated', function() {
    it('should create an instance of RegistrantCreated', function() {
      // uncomment below and update the code to test RegistrantCreated
      //var instance = new GoToTraining.RegistrantCreated();
      //expect(instance).to.be.a(GoToTraining.RegistrantCreated);
    });
