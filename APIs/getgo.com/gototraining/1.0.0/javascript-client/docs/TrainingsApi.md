...
let apiInstance = new GoToTraining.TrainingsApi();
...
apiInstance.cancelTraining(authorization, organizerKey, trainingKey, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [Training] getAllTrainings(authorization, organizerKey)
...
let authorization = "authorization_example"; // String | Access token
let organizerKey = 789; // Number | The key of the training organizer
apiInstance.getAllTrainings(authorization, organizerKey, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let organizerKey = 789; // Number | The key of the training organizer
let trainingKey = 789; // Number | The key of the training
apiInstance.getManageTrainingURL(authorization, organizerKey, trainingKey, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Organizer] getOrganisersForTraining(authorization, organizerKey, trainingKey)
...
let organizerKey = 789; // Number | The key of the training organizer
let trainingKey = 789; // Number | The key of the training
apiInstance.getOrganisersForTraining(authorization, organizerKey, trainingKey, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let organizerKey = 789; // Number | The key of the training organizer
let trainingKey = 789; // Number | The key of the training
apiInstance.getStartUrl(authorization, organizerKey, trainingKey, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let organizerKey = 789; // Number | The key of the training organizer
let trainingKey = 789; // Number | The key of the training
apiInstance.getTraining(authorization, organizerKey, trainingKey, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let authorization = "authorization_example"; // String | Access token
let organizerKey = 789; // Number | The key of the training organizer
let body = new GoToTraining.TrainingReqCreate(); // TrainingReqCreate | The details of the training to create
apiInstance.scheduleTraining(authorization, organizerKey, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let authorization = "authorization_example"; // String | Access token
let trainingKey = 789; // Number | The key of the training
apiInstance.startTraining(authorization, trainingKey, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let organizerKey = 789; // Number | The key of the training organizer
let trainingKey = 789; // Number | The key of the training
let body = new GoToTraining.TrainingOrganizers(); // TrainingOrganizers | The details of the training to create
apiInstance.updateOrganisersForTraining(authorization, organizerKey, trainingKey, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let organizerKey = 789; // Number | The key of the training organizer
let trainingKey = 789; // Number | The key of the training
let body = new GoToTraining.RegistrationSettings(); // RegistrationSettings | The new registration settings for the training
apiInstance.updateRegistrationSettingsForTraining(authorization, organizerKey, trainingKey, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let organizerKey = 789; // Number | The key of the training organizer
let trainingKey = 789; // Number | The key of the training
let body = new GoToTraining.TrainingNameDescription(); // TrainingNameDescription | The new name and description for the training
apiInstance.updateTrainingNameDescription(authorization, organizerKey, trainingKey, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let organizerKey = 789; // Number | The key of the training organizer
let trainingKey = 789; // Number | The key of the training
let body = new GoToTraining.TrainingTimes(); // TrainingTimes | The new start and end times for the scheduled training
apiInstance.updateTrainingTimes(authorization, organizerKey, trainingKey, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
