...
/*
 * OAIRegistrantReqCreate.h
 *
 * Details required to make a new training registration.
 */

#ifndef OAIRegistrantReqCreate_H
#define OAIRegistrantReqCreate_H
...
class OAIRegistrantReqCreate : public OAIObject {
public:
    OAIRegistrantReqCreate();
    OAIRegistrantReqCreate(QString json);
    ~OAIRegistrantReqCreate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegistrantReqCreate)

#endif // OAIRegistrantReqCreate_H
