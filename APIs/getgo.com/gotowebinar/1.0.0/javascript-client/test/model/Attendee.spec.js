...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToWebinar.Attendee();
  });
  ...
  describe('Attendee', function() {
    it('should create an instance of Attendee', function() {
      ...
      //var instance = new GoToWebinar.Attendee();
      //expect(instance).to.be.a(GoToWebinar.Attendee);
    });
    ...
    it('should have the property attendanceTimeInSeconds (base name: "attendanceTimeInSeconds")', function() {
      // uncomment below and update the code to test the property attendanceTimeInSeconds
      //var instance = new GoToWebinar.Attendee();
      //expect(instance).to.be();
    });
