...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToWebinar.CustomAnswers();
  });
  ...
  describe('CustomAnswers', function() {
    it('should create an instance of CustomAnswers', function() {
      // uncomment below and update the code to test CustomAnswers
      //var instance = new GoToWebinar.CustomAnswers();
      //expect(instance).to.be.a(GoToWebinar.CustomAnswers);
    });
