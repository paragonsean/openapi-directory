...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoToWebinar.CoorganizerReqCreate();
  });
  ...
  describe('CoorganizerReqCreate', function() {
    it('should create an instance of CoorganizerReqCreate', function() {
      // uncomment below and update the code to test CoorganizerReqCreate
      //var instance = new GoToWebinar.CoorganizerReqCreate();
      //expect(instance).to.be.a(GoToWebinar.CoorganizerReqCreate);
    });
