...
**organizerKey** | **Number** | The key of the webinar organizer | 
...
**times** | [**[DateTimeRange]**](DateTimeRange.md) | Array with startTime and endTime for the webinar sessions | 
**webinarID** | **String** | The 9-digit webinar ID | 
**webinarKey** | **Number** | The unique key of the webinar | 
