...
/**
 * The UpcomingWebinar model module.
 * @module model/UpcomingWebinar
 * @version 1.0.0
 */
class UpcomingWebinar {
    /**
     * Constructs a new <code>UpcomingWebinar</code>.
     * Describes a scheduled webinar
     * @alias module:model/UpcomingWebinar
     ...
     */
    constructor(description, inSession, organizerKey, registrationUrl, subject, timeZone, times, webinarID, webinarKey) { 
        
        UpcomingWebinar.initialize(this, description, inSession, organizerKey, registrationUrl, subject, timeZone, times, webinarID, webinarKey);
    }
     ...
     */
    static initialize(obj, description, inSession, organizerKey, registrationUrl, subject, timeZone, times, webinarID, webinarKey) { 
    ...
    /**
     * Constructs a <code>UpcomingWebinar</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpcomingWebinar} obj Optional instance to populate.
     * @return {module:model/UpcomingWebinar} The populated <code>UpcomingWebinar</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpcomingWebinar();
    ...
    /**
     * Validates the JSON data with respect to <code>UpcomingWebinar</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpcomingWebinar</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpcomingWebinar.RequiredProperties) {
...
UpcomingWebinar.RequiredProperties = ["description", "inSession", "organizerKey", "registrationUrl", "subject", "timeZone", "times", "webinarID", "webinarKey"];

/**
 * A short description of the webinar
 * @member {String} description
 */
UpcomingWebinar.prototype['description'] = undefined;

/**
 * Indicates whether there is a webinar session currently in progress
 * @member {Boolean} inSession
 */
UpcomingWebinar.prototype['inSession'] = undefined;

/**
 * The key of the webinar organizer
 * @member {Number} organizerKey
 */
UpcomingWebinar.prototype['organizerKey'] = undefined;

/**
 * The URL the webinar invitees can use to register
 * @member {String} registrationUrl
 */
UpcomingWebinar.prototype['registrationUrl'] = undefined;

/**
 * The webinar subject
 * @member {String} subject
 */
UpcomingWebinar.prototype['subject'] = undefined;

/**
 * The timezone where the webinar is taking place
 * @member {String} timeZone
 */
UpcomingWebinar.prototype['timeZone'] = undefined;

/**
 * Array with startTime and endTime for the webinar sessions
 * @member {Array.<module:model/DateTimeRange>} times
 */
UpcomingWebinar.prototype['times'] = undefined;

/**
 * The 9-digit webinar ID
 * @member {String} webinarID
 */
UpcomingWebinar.prototype['webinarID'] = undefined;

/**
 * The unique key of the webinar
 * @member {Number} webinarKey
 */
UpcomingWebinar.prototype['webinarKey'] = undefined;
