...
public class RegistrantDetailed {
  ...
  public static final String SERIALIZED_NAME_IMPLEMENTATION_TIME_FRAME = "implementationTimeFrame";
  @SerializedName(SERIALIZED_NAME_IMPLEMENTATION_TIME_FRAME)
  ...
  public RegistrantDetailed() {
  }

  public RegistrantDetailed address(String address) {
  ...
  public RegistrantDetailed city(String city) {
    this.city = city;
    return this;
  }
  ...
  public RegistrantDetailed country(String country) {
  ...
  public RegistrantDetailed email(String email) {
    this.email = email;
    return this;
  }
  ...
  public RegistrantDetailed employeeCount(String employeeCount) {
  ...
  public RegistrantDetailed firstName(String firstName) {
  ...
  public RegistrantDetailed implementationTimeFrame(String implementationTimeFrame) {
    this.implementationTimeFrame = implementationTimeFrame;
    return this;
  }

  /**
   * The time frame within which the product will be purchased
   * @return implementationTimeFrame
   */
  @javax.annotation.Nullable
  ...
  public void setImplementationTimeFrame(String implementationTimeFrame) {
    this.implementationTimeFrame = implementationTimeFrame;
  }


  public RegistrantDetailed industry(String industry) {
  ...
  public RegistrantDetailed jobTitle(String jobTitle) {
  ...
  public RegistrantDetailed joinUrl(String joinUrl) {
  ...
  public RegistrantDetailed lastName(String lastName) {
  ...
  public RegistrantDetailed numberOfEmployees(String numberOfEmployees) {
  ...
  public RegistrantDetailed organization(String organization) {
  ...
  public RegistrantDetailed phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public RegistrantDetailed purchasingRole(String purchasingRole) {
  ...
  public RegistrantDetailed purchasingTimeFrame(String purchasingTimeFrame) {
  ...
  public RegistrantDetailed questionsAndComments(String questionsAndComments) {
  ...
  public RegistrantDetailed registrantKey(Long registrantKey) {
  ...
  public RegistrantDetailed registrationDate(OffsetDateTime registrationDate) {
  ...
  public RegistrantDetailed responses(List<CustomAnswers> responses) {
    this.responses = responses;
    return this;
  }

  public RegistrantDetailed addResponsesItem(CustomAnswers responsesItem) {
  ...
  public void setResponses(List<CustomAnswers> responses) {
    this.responses = responses;
  }


  public RegistrantDetailed source(String source) {
    this.source = source;
    return this;
  }
  ...
  public RegistrantDetailed state(String state) {
    this.state = state;
    return this;
  }
  ...
  public RegistrantDetailed status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public RegistrantDetailed timeZone(String timeZone) {
  ...
  public RegistrantDetailed type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public RegistrantDetailed unsubscribed(Boolean unsubscribed) {
  ...
  public RegistrantDetailed zipCode(String zipCode) {
  ...
  public boolean equals(Object o) {
    ...
    RegistrantDetailed registrantDetailed = (RegistrantDetailed) o;
    return Objects.equals(this.address, registrantDetailed.address) &&
        Objects.equals(this.city, registrantDetailed.city) &&
        Objects.equals(this.country, registrantDetailed.country) &&
        Objects.equals(this.email, registrantDetailed.email) &&
        Objects.equals(this.employeeCount, registrantDetailed.employeeCount) &&
        Objects.equals(this.firstName, registrantDetailed.firstName) &&
        Objects.equals(this.implementationTimeFrame, registrantDetailed.implementationTimeFrame) &&
        Objects.equals(this.industry, registrantDetailed.industry) &&
        Objects.equals(this.jobTitle, registrantDetailed.jobTitle) &&
        Objects.equals(this.joinUrl, registrantDetailed.joinUrl) &&
        Objects.equals(this.lastName, registrantDetailed.lastName) &&
        Objects.equals(this.numberOfEmployees, registrantDetailed.numberOfEmployees) &&
        Objects.equals(this.organization, registrantDetailed.organization) &&
        Objects.equals(this.phone, registrantDetailed.phone) &&
        Objects.equals(this.purchasingRole, registrantDetailed.purchasingRole) &&
        Objects.equals(this.purchasingTimeFrame, registrantDetailed.purchasingTimeFrame) &&
        Objects.equals(this.questionsAndComments, registrantDetailed.questionsAndComments) &&
        Objects.equals(this.registrantKey, registrantDetailed.registrantKey) &&
        Objects.equals(this.registrationDate, registrantDetailed.registrationDate) &&
        Objects.equals(this.responses, registrantDetailed.responses) &&
        Objects.equals(this.source, registrantDetailed.source) &&
        Objects.equals(this.state, registrantDetailed.state) &&
        Objects.equals(this.status, registrantDetailed.status) &&
        Objects.equals(this.timeZone, registrantDetailed.timeZone) &&
        Objects.equals(this.type, registrantDetailed.type) &&
        Objects.equals(this.unsubscribed, registrantDetailed.unsubscribed) &&
        Objects.equals(this.zipCode, registrantDetailed.zipCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, city, country, email, employeeCount, firstName, implementationTimeFrame, industry, jobTitle, joinUrl, lastName, numberOfEmployees, organization, phone, purchasingRole, purchasingTimeFrame, questionsAndComments, registrantKey, registrationDate, responses, source, state, status, timeZone, type, unsubscribed, zipCode);
  }
  ...
  public String toString() {
    ...
    sb.append("    implementationTimeFrame: ").append(toIndentedString(implementationTimeFrame)).append("\n");
  ...
  static {
    ...
    openapiFields.add("employeeCount");
    openapiFields.add("firstName");
    openapiFields.add("implementationTimeFrame");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegistrantDetailed
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegistrantDetailed.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegistrantDetailed is not found in the empty JSON string", RegistrantDetailed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegistrantDetailed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegistrantDetailed` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RegistrantDetailed.openapiRequiredFields) {
      ...
      if ((jsonObj.get("implementationTimeFrame") != null && !jsonObj.get("implementationTimeFrame").isJsonNull()) && !jsonObj.get("implementationTimeFrame").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `implementationTimeFrame` to be a primitive type in the JSON string but got `%s`", jsonObj.get("implementationTimeFrame").toString()));
      }
      ...
      if (jsonObj.get("responses") != null && !jsonObj.get("responses").isJsonNull()) {
        ...
        if (jsonArrayresponses != null) {
          ...
          for (int i = 0; i < jsonArrayresponses.size(); i++) {
            CustomAnswers.validateJsonElement(jsonArrayresponses.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegistrantDetailed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegistrantDetailed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegistrantDetailed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegistrantDetailed.class));

       return (TypeAdapter<T>) new TypeAdapter<RegistrantDetailed>() {
           @Override
           public void write(JsonWriter out, RegistrantDetailed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegistrantDetailed read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegistrantDetailed given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegistrantDetailed
   * @throws IOException if the JSON string is invalid with respect to RegistrantDetailed
   */
  public static RegistrantDetailed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegistrantDetailed.class);
  }

  /**
   * Convert an instance of RegistrantDetailed to an JSON string
   *
   * @return JSON string
   */
