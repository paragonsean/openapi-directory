...
public class Webinar {
  ...
  public Webinar inSession(Boolean inSession) {
  ...
  public Webinar numberOfRegistrants(Integer numberOfRegistrants) {
  ...
  public Webinar organizerKey(Long organizerKey) {
  ...
  public Webinar registrationUrl(String registrationUrl) {
  ...
  public Webinar subject(String subject) {
  ...
  public Webinar times(List<DateTimeRange> times) {
    this.times = times;
    return this;
  }

  public Webinar addTimesItem(DateTimeRange timesItem) {
    if (this.times == null) {
  ...
  public Webinar webinarID(String webinarID) {
  ...
  public Webinar webinarKey(Long webinarKey) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, webinar.description) &&
        Objects.equals(this.inSession, webinar.inSession) &&
        Objects.equals(this.numberOfRegistrants, webinar.numberOfRegistrants) &&
        Objects.equals(this.organizerKey, webinar.organizerKey) &&
        Objects.equals(this.registrationUrl, webinar.registrationUrl) &&
        Objects.equals(this.subject, webinar.subject) &&
        Objects.equals(this.timeZone, webinar.timeZone) &&
        Objects.equals(this.times, webinar.times) &&
        Objects.equals(this.webinarID, webinar.webinarID) &&
        Objects.equals(this.webinarKey, webinar.webinarKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, inSession, numberOfRegistrants, organizerKey, registrationUrl, subject, timeZone, times, webinarID, webinarKey);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Webinar
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Webinar.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Webinar.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Webinar` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
