...
public class UpcomingWebinar {
  ...
  public UpcomingWebinar description(String description) {
  ...
  public UpcomingWebinar inSession(Boolean inSession) {
  ...
  public UpcomingWebinar organizerKey(Long organizerKey) {
  ...
  public UpcomingWebinar registrationUrl(String registrationUrl) {
  ...
  public UpcomingWebinar subject(String subject) {
  ...
  public UpcomingWebinar timeZone(String timeZone) {
  ...
  public UpcomingWebinar times(List<DateTimeRange> times) {
    this.times = times;
    return this;
  }

  public UpcomingWebinar addTimesItem(DateTimeRange timesItem) {
    if (this.times == null) {
  ...
  public UpcomingWebinar webinarID(String webinarID) {
  ...
  public UpcomingWebinar webinarKey(Long webinarKey) {
  ...
  public boolean equals(Object o) {
    ...
    UpcomingWebinar upcomingWebinar = (UpcomingWebinar) o;
    return Objects.equals(this.description, upcomingWebinar.description) &&
        Objects.equals(this.inSession, upcomingWebinar.inSession) &&
        Objects.equals(this.organizerKey, upcomingWebinar.organizerKey) &&
        Objects.equals(this.registrationUrl, upcomingWebinar.registrationUrl) &&
        Objects.equals(this.subject, upcomingWebinar.subject) &&
        Objects.equals(this.timeZone, upcomingWebinar.timeZone) &&
        Objects.equals(this.times, upcomingWebinar.times) &&
        Objects.equals(this.webinarID, upcomingWebinar.webinarID) &&
        Objects.equals(this.webinarKey, upcomingWebinar.webinarKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, inSession, organizerKey, registrationUrl, subject, timeZone, times, webinarID, webinarKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpcomingWebinar {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpcomingWebinar
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpcomingWebinar.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpcomingWebinar is not found in the empty JSON string", UpcomingWebinar.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpcomingWebinar.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpcomingWebinar` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpcomingWebinar.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpcomingWebinar.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpcomingWebinar' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpcomingWebinar> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpcomingWebinar.class));

       return (TypeAdapter<T>) new TypeAdapter<UpcomingWebinar>() {
           @Override
           public void write(JsonWriter out, UpcomingWebinar value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpcomingWebinar read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpcomingWebinar given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpcomingWebinar
   * @throws IOException if the JSON string is invalid with respect to UpcomingWebinar
   */
  public static UpcomingWebinar fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpcomingWebinar.class);
  }

  /**
   * Convert an instance of UpcomingWebinar to an JSON string
   *
   * @return JSON string
   */
