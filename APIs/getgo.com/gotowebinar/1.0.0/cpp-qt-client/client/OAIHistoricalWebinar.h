...
/*
 * OAIHistoricalWebinar.h
 *
 * Describes a completed webinar
 */

#ifndef OAIHistoricalWebinar_H
#define OAIHistoricalWebinar_H
...
class OAIHistoricalWebinar : public OAIObject {
public:
    OAIHistoricalWebinar();
    OAIHistoricalWebinar(QString json);
    ~OAIHistoricalWebinar() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoricalWebinar)

#endif // OAIHistoricalWebinar_H
