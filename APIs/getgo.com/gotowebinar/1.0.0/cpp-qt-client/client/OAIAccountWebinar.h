...
#ifndef OAIAccountWebinar_H
#define OAIAccountWebinar_H
...
class OAIAccountWebinar : public OAIObject {
public:
    OAIAccountWebinar();
    OAIAccountWebinar(QString json);
    ~OAIAccountWebinar() override;
    ...
    void setImpromptu(const bool &impromptu);
    bool is_impromptu_Set() const;
    bool is_impromptu_Valid() const;
...
private:
    ...
    bool m_impromptu;
    bool m_impromptu_isSet;
    bool m_impromptu_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountWebinar)

#endif // OAIAccountWebinar_H
