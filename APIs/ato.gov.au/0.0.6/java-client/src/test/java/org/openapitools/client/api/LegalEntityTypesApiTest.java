...
/**
 * API tests for LegalEntityTypesApi
 */
@Disabled
public class LegalEntityTypesApiTest {

    private final LegalEntityTypesApi api = new LegalEntityTypesApi();
     ...
     */
    @Test
    public void classificationsLegalEntityTypesGetTest() throws ApiException {
        String apiKey = null;
        List<LegalEntityType> response = api.classificationsLegalEntityTypesGet(apiKey);
