...
import org.openapitools.client.model.RegisteredIdentifierType;
...
/**
 * API tests for RegisteredIdentifierTypesApi
 */
@Disabled
public class RegisteredIdentifierTypesApiTest {

    private final RegisteredIdentifierTypesApi api = new RegisteredIdentifierTypesApi();
     ...
     */
    @Test
    public void classificationsRegisteredIdentifierTypesGetTest() throws ApiException {
        String apiKey = null;
        List<RegisteredIdentifierType> response = api.classificationsRegisteredIdentifierTypesGet(apiKey);
