...
/**
 * Model tests for IndividualAddress
 */
public class IndividualAddressTest {
    private final IndividualAddress model = new IndividualAddress();
