...
/**
 * API tests for GendersApi
 */
@Disabled
public class GendersApiTest {

    private final GendersApi api = new GendersApi();
     ...
     */
    @Test
    public void classificationsGendersGetTest() throws ApiException {
        String apiKey = null;
        List<Gender> response = api.classificationsGendersGet(apiKey);
