...
/**
 * API tests for BusinessNamesApi
 */
@Disabled
public class BusinessNamesApiTest {

    private final BusinessNamesApi api = new BusinessNamesApi();
     ...
     */
    @Test
    public void businessNamesGetTest() throws ApiException {
        String apiKey = null;
        List<BusinessName> response = api.businessNamesGet(apiKey);
