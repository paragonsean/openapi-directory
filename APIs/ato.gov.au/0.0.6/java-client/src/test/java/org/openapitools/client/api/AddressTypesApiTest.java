...
/**
 * API tests for AddressTypesApi
 */
@Disabled
public class AddressTypesApiTest {

    private final AddressTypesApi api = new AddressTypesApi();
     ...
     */
    @Test
    public void classificationsAddressTypesGetTest() throws ApiException {
        String apiKey = null;
        List<AddressType> response = api.classificationsAddressTypesGet(apiKey);
