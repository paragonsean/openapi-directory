...
/**
 * API tests for BusinessNameLifecycleStatesApi
 */
@Disabled
public class BusinessNameLifecycleStatesApiTest {

    private final BusinessNameLifecycleStatesApi api = new BusinessNameLifecycleStatesApi();
     ...
     */
    @Test
    public void classificationsBusinessNameLifecycleStatesGetTest() throws ApiException {
        String apiKey = null;
        List<BusinessNameLifecycleState> response = api.classificationsBusinessNameLifecycleStatesGet(apiKey);
