...
/**
 * Model tests for FailedPrecondition
 */
public class FailedPreconditionTest {
    private final FailedPrecondition model = new FailedPrecondition();
