...
/**
 * API tests for LicenseLifecycleStatesApi
 */
@Disabled
public class LicenseLifecycleStatesApiTest {

    private final LicenseLifecycleStatesApi api = new LicenseLifecycleStatesApi();
     ...
     */
    @Test
    public void classificationsLicenseLifecycleStatesGetTest() throws ApiException {
        String apiKey = null;
        List<LicenseLifecycleState> response = api.classificationsLicenseLifecycleStatesGet(apiKey);
