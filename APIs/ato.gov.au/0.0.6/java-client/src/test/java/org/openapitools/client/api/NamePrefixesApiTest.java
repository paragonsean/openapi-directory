...
/**
 * API tests for NamePrefixesApi
 */
@Disabled
public class NamePrefixesApiTest {

    private final NamePrefixesApi api = new NamePrefixesApi();
     ...
     */
    @Test
    public void classificationsNamePrefixesGetTest() throws ApiException {
        String apiKey = null;
        List<NamePrefix> response = api.classificationsNamePrefixesGet(apiKey);
