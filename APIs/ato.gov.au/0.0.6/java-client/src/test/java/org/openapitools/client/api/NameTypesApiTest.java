...
/**
 * API tests for NameTypesApi
 */
@Disabled
public class NameTypesApiTest {

    private final NameTypesApi api = new NameTypesApi();
     ...
     */
    @Test
    public void classificationsNameTypesGetTest() throws ApiException {
        String apiKey = null;
        List<NameType> response = api.classificationsNameTypesGet(apiKey);
