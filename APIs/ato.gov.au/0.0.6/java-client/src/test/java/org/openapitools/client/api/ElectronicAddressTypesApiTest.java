...
/**
 * API tests for ElectronicAddressTypesApi
 */
@Disabled
public class ElectronicAddressTypesApiTest {

    private final ElectronicAddressTypesApi api = new ElectronicAddressTypesApi();
     ...
     */
    @Test
    public void classificationsElectronicAddressTypesGetTest() throws ApiException {
        String apiKey = null;
        List<ElectronicAddressType> response = api.classificationsElectronicAddressTypesGet(apiKey);
