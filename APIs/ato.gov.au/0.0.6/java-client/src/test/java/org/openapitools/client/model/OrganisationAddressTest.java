...
/**
 * Model tests for OrganisationAddress
 */
public class OrganisationAddressTest {
    private final OrganisationAddress model = new OrganisationAddress();
