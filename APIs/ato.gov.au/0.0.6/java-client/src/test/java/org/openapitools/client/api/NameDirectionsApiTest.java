...
import org.openapitools.client.model.NameDirection;
...
/**
 * API tests for NameDirectionsApi
 */
@Disabled
public class NameDirectionsApiTest {

    private final NameDirectionsApi api = new NameDirectionsApi();
     ...
     */
    @Test
    public void classificationsNameDirectionsGetTest() throws ApiException {
        String apiKey = null;
        List<NameDirection> response = api.classificationsNameDirectionsGet(apiKey);
