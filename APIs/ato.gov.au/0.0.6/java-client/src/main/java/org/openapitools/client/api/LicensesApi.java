...
public class LicensesApi {
     ...
     */
    public okhttp3.Call licensesGetCall(String apiKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call licensesGetValidateBeforeCall(String apiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiKey' is set
        if (apiKey == null) {
            throw new ApiException("Missing the required parameter 'apiKey' when calling licensesGet(Async)");
        }

        return licensesGetCall(apiKey, _callback);
     ...
     */
    public List<License> licensesGet(String apiKey) throws ApiException {
        ApiResponse<List<License>> localVarResp = licensesGetWithHttpInfo(apiKey);
     ...
     */
    public ApiResponse<List<License>> licensesGetWithHttpInfo(String apiKey) throws ApiException {
        okhttp3.Call localVarCall = licensesGetValidateBeforeCall(apiKey, null);
     ...
     */
    public okhttp3.Call licensesGetAsync(String apiKey, final ApiCallback<List<License>> _callback) throws ApiException {

        okhttp3.Call localVarCall = licensesGetValidateBeforeCall(apiKey, _callback);
        Type localVarReturnType = new TypeToken<List<License>>(){}.getType();
