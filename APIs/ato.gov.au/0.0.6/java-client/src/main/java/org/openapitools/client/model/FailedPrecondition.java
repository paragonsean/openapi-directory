...
public class FailedPrecondition {
  ...
  public FailedPrecondition code(String code) {
    this.code = code;
    return this;
  }
  ...
  public FailedPrecondition details(List<ErrorDetails> details) {
    this.details = details;
    return this;
  }

  public FailedPrecondition addDetailsItem(ErrorDetails detailsItem) {
  ...
  public FailedPrecondition message(String message) {
  ...
  public FailedPrecondition status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FailedPrecondition failedPrecondition = (FailedPrecondition) o;
    return Objects.equals(this.code, failedPrecondition.code) &&
        Objects.equals(this.details, failedPrecondition.details) &&
        Objects.equals(this.message, failedPrecondition.message) &&
        Objects.equals(this.status, failedPrecondition.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class FailedPrecondition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FailedPrecondition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FailedPrecondition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FailedPrecondition is not found in the empty JSON string", FailedPrecondition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FailedPrecondition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FailedPrecondition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FailedPrecondition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FailedPrecondition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FailedPrecondition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FailedPrecondition.class));

       return (TypeAdapter<T>) new TypeAdapter<FailedPrecondition>() {
           @Override
           public void write(JsonWriter out, FailedPrecondition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FailedPrecondition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FailedPrecondition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FailedPrecondition
   * @throws IOException if the JSON string is invalid with respect to FailedPrecondition
   */
  public static FailedPrecondition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FailedPrecondition.class);
  }

  /**
   * Convert an instance of FailedPrecondition to an JSON string
   *
   * @return JSON string
   */
