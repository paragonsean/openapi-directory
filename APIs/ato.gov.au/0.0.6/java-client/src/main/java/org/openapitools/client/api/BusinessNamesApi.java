...
public class BusinessNamesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public BusinessNamesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public BusinessNamesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for businessNamesGet
     ...
     */
    public okhttp3.Call businessNamesGetCall(String apiKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/business-names";
    ...
    private okhttp3.Call businessNamesGetValidateBeforeCall(String apiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiKey' is set
        if (apiKey == null) {
            throw new ApiException("Missing the required parameter 'apiKey' when calling businessNamesGet(Async)");
        }

        return businessNamesGetCall(apiKey, _callback);
     ...
     */
    public List<BusinessName> businessNamesGet(String apiKey) throws ApiException {
        ApiResponse<List<BusinessName>> localVarResp = businessNamesGetWithHttpInfo(apiKey);
     ...
     */
    public ApiResponse<List<BusinessName>> businessNamesGetWithHttpInfo(String apiKey) throws ApiException {
        okhttp3.Call localVarCall = businessNamesGetValidateBeforeCall(apiKey, null);
     ...
     */
    public okhttp3.Call businessNamesGetAsync(String apiKey, final ApiCallback<List<BusinessName>> _callback) throws ApiException {

        okhttp3.Call localVarCall = businessNamesGetValidateBeforeCall(apiKey, _callback);
        Type localVarReturnType = new TypeToken<List<BusinessName>>(){}.getType();
