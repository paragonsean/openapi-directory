...
public class NamePrefix {
  ...
  public NamePrefix description(String description) {
  ...
  public NamePrefix name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NamePrefix namePrefix = (NamePrefix) o;
    return Objects.equals(this.description, namePrefix.description) &&
        Objects.equals(this.id, namePrefix.id) &&
        Objects.equals(this.name, namePrefix.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NamePrefix
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NamePrefix.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NamePrefix is not found in the empty JSON string", NamePrefix.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NamePrefix.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NamePrefix` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NamePrefix.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NamePrefix' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NamePrefix> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NamePrefix.class));

       return (TypeAdapter<T>) new TypeAdapter<NamePrefix>() {
           @Override
           public void write(JsonWriter out, NamePrefix value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NamePrefix read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NamePrefix given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NamePrefix
   * @throws IOException if the JSON string is invalid with respect to NamePrefix
   */
  public static NamePrefix fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NamePrefix.class);
  }

  /**
   * Convert an instance of NamePrefix to an JSON string
   *
   * @return JSON string
   */
