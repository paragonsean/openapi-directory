...
public class BusinessNameLifecycleState {
  ...
  public BusinessNameLifecycleState description(String description) {
  ...
  public BusinessNameLifecycleState name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BusinessNameLifecycleState businessNameLifecycleState = (BusinessNameLifecycleState) o;
    return Objects.equals(this.description, businessNameLifecycleState.description) &&
        Objects.equals(this.id, businessNameLifecycleState.id) &&
        Objects.equals(this.name, businessNameLifecycleState.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class BusinessNameLifecycleState {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BusinessNameLifecycleState
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessNameLifecycleState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessNameLifecycleState is not found in the empty JSON string", BusinessNameLifecycleState.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BusinessNameLifecycleState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BusinessNameLifecycleState` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessNameLifecycleState.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessNameLifecycleState' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessNameLifecycleState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessNameLifecycleState.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessNameLifecycleState>() {
           @Override
           public void write(JsonWriter out, BusinessNameLifecycleState value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BusinessNameLifecycleState read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BusinessNameLifecycleState given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BusinessNameLifecycleState
   * @throws IOException if the JSON string is invalid with respect to BusinessNameLifecycleState
   */
  public static BusinessNameLifecycleState fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessNameLifecycleState.class);
  }

  /**
   * Convert an instance of BusinessNameLifecycleState to an JSON string
   *
   * @return JSON string
   */
