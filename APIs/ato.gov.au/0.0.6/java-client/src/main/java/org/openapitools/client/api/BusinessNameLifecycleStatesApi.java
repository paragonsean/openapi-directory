...
import org.openapitools.client.model.BusinessNameLifecycleState;
...
public class BusinessNameLifecycleStatesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public BusinessNameLifecycleStatesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public BusinessNameLifecycleStatesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for classificationsBusinessNameLifecycleStatesGet
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Business name lifecycle states were retrieved successfully </td><td>  * Link - Information about pagination is provided in the [Link](https://tools.ietf.org/html/rfc5988#page-6) header. For example:      Link: &lt;https://api.abr.ato.gov.au/individuals?page&#x3D;2&gt;; rel&#x3D;\&quot;next\&quot;,           &lt;https://api.abr.ato.gov.au/individuals?page&#x3D;34&gt;; rel&#x3D;\&quot;last\&quot;  &#x60;rel&#x3D;\&quot;next\&quot;&#x60; states that the next page is &#x60;page&#x3D;2&#x60;. This makes sense, since by default, all paginated queries start at page &#x60;1&#x60;. &#x60;rel&#x3D;\&quot;last\&quot;&#x60; provides some more information, stating that the last page of results is on &#x60;page 34&#x60;. Accordingly, we have 33 more pages of information that we can consume.  <br>  </td></tr>
     ...
     */
    public okhttp3.Call classificationsBusinessNameLifecycleStatesGetCall(String apiKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/classifications/business-name-lifecycle-states";
    ...
    private okhttp3.Call classificationsBusinessNameLifecycleStatesGetValidateBeforeCall(String apiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiKey' is set
        if (apiKey == null) {
            throw new ApiException("Missing the required parameter 'apiKey' when calling classificationsBusinessNameLifecycleStatesGet(Async)");
        }

        return classificationsBusinessNameLifecycleStatesGetCall(apiKey, _callback);
     ...
     * 
     * @param apiKey The API key. (required)
     * @return List&lt;BusinessNameLifecycleState&gt;
     ...
     */
    public List<BusinessNameLifecycleState> classificationsBusinessNameLifecycleStatesGet(String apiKey) throws ApiException {
        ApiResponse<List<BusinessNameLifecycleState>> localVarResp = classificationsBusinessNameLifecycleStatesGetWithHttpInfo(apiKey);
     ...
     * 
     * @param apiKey The API key. (required)
     * @return ApiResponse&lt;List&lt;BusinessNameLifecycleState&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<BusinessNameLifecycleState>> classificationsBusinessNameLifecycleStatesGetWithHttpInfo(String apiKey) throws ApiException {
        okhttp3.Call localVarCall = classificationsBusinessNameLifecycleStatesGetValidateBeforeCall(apiKey, null);
        Type localVarReturnType = new TypeToken<List<BusinessNameLifecycleState>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a list of business name lifecycle states (asynchronously)
     * 
     * @param apiKey The API key. (required)
     ...
     */
    public okhttp3.Call classificationsBusinessNameLifecycleStatesGetAsync(String apiKey, final ApiCallback<List<BusinessNameLifecycleState>> _callback) throws ApiException {

        okhttp3.Call localVarCall = classificationsBusinessNameLifecycleStatesGetValidateBeforeCall(apiKey, _callback);
        Type localVarReturnType = new TypeToken<List<BusinessNameLifecycleState>>(){}.getType();
