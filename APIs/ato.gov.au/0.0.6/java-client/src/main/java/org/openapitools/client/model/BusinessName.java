...
public class BusinessName {
  ...
  public BusinessName lifecycleState(LifecycleStateEnum lifecycleState) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fromDate, businessName.fromDate) &&
        Objects.equals(this.id, businessName.id) &&
        Objects.equals(this.lifecycleState, businessName.lifecycleState) &&
        Objects.equals(this.name, businessName.name) &&
        Objects.equals(this.toDate, businessName.toDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fromDate, id, lifecycleState, name, toDate);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BusinessName
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BusinessName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BusinessName` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
