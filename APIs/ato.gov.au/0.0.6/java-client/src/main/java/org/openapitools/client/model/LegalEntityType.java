...
public class LegalEntityType {
  ...
  public LegalEntityType description(String description) {
  ...
  public LegalEntityType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, legalEntityType.description) &&
        Objects.equals(this.id, legalEntityType.id) &&
        Objects.equals(this.name, legalEntityType.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LegalEntityType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LegalEntityType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalEntityType is not found in the empty JSON string", LegalEntityType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LegalEntityType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LegalEntityType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalEntityType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalEntityType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalEntityType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalEntityType.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalEntityType>() {
           @Override
           public void write(JsonWriter out, LegalEntityType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LegalEntityType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LegalEntityType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LegalEntityType
   * @throws IOException if the JSON string is invalid with respect to LegalEntityType
   */
  public static LegalEntityType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalEntityType.class);
  }

  /**
   * Convert an instance of LegalEntityType to an JSON string
   *
   * @return JSON string
   */
