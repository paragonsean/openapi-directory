...
public class NameType {
  ...
  public NameType description(String description) {
  ...
  public NameType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, nameType.description) &&
        Objects.equals(this.id, nameType.id) &&
        Objects.equals(this.name, nameType.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NameType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NameType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NameType is not found in the empty JSON string", NameType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NameType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NameType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NameType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NameType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NameType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NameType.class));

       return (TypeAdapter<T>) new TypeAdapter<NameType>() {
           @Override
           public void write(JsonWriter out, NameType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NameType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NameType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NameType
   * @throws IOException if the JSON string is invalid with respect to NameType
   */
  public static NameType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NameType.class);
  }

  /**
   * Convert an instance of NameType to an JSON string
   *
   * @return JSON string
   */
