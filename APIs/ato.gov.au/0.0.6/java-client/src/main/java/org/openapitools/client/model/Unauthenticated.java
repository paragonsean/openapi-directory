...
public class Unauthenticated {
  ...
  public Unauthenticated details(ErrorDetails details) {
  ...
  public Unauthenticated message(String message) {
  ...
  public Unauthenticated status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, unauthenticated.code) &&
        Objects.equals(this.details, unauthenticated.details) &&
        Objects.equals(this.message, unauthenticated.message) &&
        Objects.equals(this.status, unauthenticated.status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Unauthenticated
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Unauthenticated.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Unauthenticated.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Unauthenticated` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
