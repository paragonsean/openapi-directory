...
public class RegisteredIdentifier {
  ...
  private IdentifierTypeEnum identifierType = IdentifierTypeEnum.ACN;
  ...
  public RegisteredIdentifier identifier(String identifier) {
  ...
  public RegisteredIdentifier identifierType(IdentifierTypeEnum identifierType) {
  ...
  public boolean equals(Object o) {
    ...
    RegisteredIdentifier registeredIdentifier = (RegisteredIdentifier) o;
    return Objects.equals(this.fromDate, registeredIdentifier.fromDate) &&
        Objects.equals(this.id, registeredIdentifier.id) &&
        Objects.equals(this.identifier, registeredIdentifier.identifier) &&
        Objects.equals(this.identifierType, registeredIdentifier.identifierType) &&
        Objects.equals(this.toDate, registeredIdentifier.toDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fromDate, id, identifier, identifierType, toDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegisteredIdentifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisteredIdentifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisteredIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegisteredIdentifier is not found in the empty JSON string", RegisteredIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisteredIdentifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegisteredIdentifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("identifierType") != null && !jsonObj.get("identifierType").isJsonNull()) {
        IdentifierTypeEnum.validateJsonElement(jsonObj.get("identifierType"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisteredIdentifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisteredIdentifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisteredIdentifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisteredIdentifier.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisteredIdentifier>() {
           @Override
           public void write(JsonWriter out, RegisteredIdentifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisteredIdentifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisteredIdentifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisteredIdentifier
   * @throws IOException if the JSON string is invalid with respect to RegisteredIdentifier
   */
  public static RegisteredIdentifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisteredIdentifier.class);
  }

  /**
   * Convert an instance of RegisteredIdentifier to an JSON string
   *
   * @return JSON string
   */
