...
public class NameDirection {
  ...
  public NameDirection description(String description) {
  ...
  public NameDirection name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NameDirection nameDirection = (NameDirection) o;
    return Objects.equals(this.description, nameDirection.description) &&
        Objects.equals(this.id, nameDirection.id) &&
        Objects.equals(this.name, nameDirection.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NameDirection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NameDirection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NameDirection is not found in the empty JSON string", NameDirection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NameDirection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NameDirection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NameDirection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NameDirection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NameDirection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NameDirection.class));

       return (TypeAdapter<T>) new TypeAdapter<NameDirection>() {
           @Override
           public void write(JsonWriter out, NameDirection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NameDirection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NameDirection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NameDirection
   * @throws IOException if the JSON string is invalid with respect to NameDirection
   */
  public static NameDirection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NameDirection.class);
  }

  /**
   * Convert an instance of NameDirection to an JSON string
   *
   * @return JSON string
   */
