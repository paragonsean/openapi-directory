...
public class ElectronicAddressType {
  ...
  public ElectronicAddressType description(String description) {
  ...
  public ElectronicAddressType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ElectronicAddressType electronicAddressType = (ElectronicAddressType) o;
    return Objects.equals(this.description, electronicAddressType.description) &&
        Objects.equals(this.id, electronicAddressType.id) &&
        Objects.equals(this.name, electronicAddressType.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ElectronicAddressType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ElectronicAddressType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ElectronicAddressType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ElectronicAddressType is not found in the empty JSON string", ElectronicAddressType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ElectronicAddressType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ElectronicAddressType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ElectronicAddressType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ElectronicAddressType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ElectronicAddressType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ElectronicAddressType.class));

       return (TypeAdapter<T>) new TypeAdapter<ElectronicAddressType>() {
           @Override
           public void write(JsonWriter out, ElectronicAddressType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ElectronicAddressType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ElectronicAddressType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ElectronicAddressType
   * @throws IOException if the JSON string is invalid with respect to ElectronicAddressType
   */
  public static ElectronicAddressType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ElectronicAddressType.class);
  }

  /**
   * Convert an instance of ElectronicAddressType to an JSON string
   *
   * @return JSON string
   */
