...
public class RegisteredIdentifierType {
  ...
  public RegisteredIdentifierType description(String description) {
  ...
  public RegisteredIdentifierType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegisteredIdentifierType registeredIdentifierType = (RegisteredIdentifierType) o;
    return Objects.equals(this.description, registeredIdentifierType.description) &&
        Objects.equals(this.id, registeredIdentifierType.id) &&
        Objects.equals(this.name, registeredIdentifierType.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegisteredIdentifierType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisteredIdentifierType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisteredIdentifierType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegisteredIdentifierType is not found in the empty JSON string", RegisteredIdentifierType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisteredIdentifierType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegisteredIdentifierType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisteredIdentifierType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisteredIdentifierType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisteredIdentifierType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisteredIdentifierType.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisteredIdentifierType>() {
           @Override
           public void write(JsonWriter out, RegisteredIdentifierType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisteredIdentifierType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisteredIdentifierType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisteredIdentifierType
   * @throws IOException if the JSON string is invalid with respect to RegisteredIdentifierType
   */
  public static RegisteredIdentifierType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisteredIdentifierType.class);
  }

  /**
   * Convert an instance of RegisteredIdentifierType to an JSON string
   *
   * @return JSON string
   */
