...
public class RolesApi {
    ...
    /**
     * Build call for classificationsRolesGet
     ...
     */
    public okhttp3.Call classificationsRolesGetCall(String apiKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/classifications/roles";
    ...
    private okhttp3.Call classificationsRolesGetValidateBeforeCall(String apiKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'apiKey' is set
        if (apiKey == null) {
            throw new ApiException("Missing the required parameter 'apiKey' when calling classificationsRolesGet(Async)");
        }

        return classificationsRolesGetCall(apiKey, _callback);
     ...
     */
    public List<Role> classificationsRolesGet(String apiKey) throws ApiException {
        ApiResponse<List<Role>> localVarResp = classificationsRolesGetWithHttpInfo(apiKey);
     ...
     */
    public ApiResponse<List<Role>> classificationsRolesGetWithHttpInfo(String apiKey) throws ApiException {
        okhttp3.Call localVarCall = classificationsRolesGetValidateBeforeCall(apiKey, null);
     ...
     */
    public okhttp3.Call classificationsRolesGetAsync(String apiKey, final ApiCallback<List<Role>> _callback) throws ApiException {

        okhttp3.Call localVarCall = classificationsRolesGetValidateBeforeCall(apiKey, _callback);
        Type localVarReturnType = new TypeToken<List<Role>>(){}.getType();
