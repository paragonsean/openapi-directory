...
public class OrganisationName {
  ...
  public OrganisationName name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrganisationName organisationName = (OrganisationName) o;
    return Objects.equals(this.fromDate, organisationName.fromDate) &&
        Objects.equals(this.id, organisationName.id) &&
        Objects.equals(this.name, organisationName.name) &&
        Objects.equals(this.toDate, organisationName.toDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fromDate, id, name, toDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrganisationName {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganisationName
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganisationName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganisationName is not found in the empty JSON string", OrganisationName.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganisationName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganisationName` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganisationName.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganisationName' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganisationName> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganisationName.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganisationName>() {
           @Override
           public void write(JsonWriter out, OrganisationName value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganisationName read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganisationName given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganisationName
   * @throws IOException if the JSON string is invalid with respect to OrganisationName
   */
  public static OrganisationName fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganisationName.class);
  }

  /**
   * Convert an instance of OrganisationName to an JSON string
   *
   * @return JSON string
   */
