...
public class PermissionDenied {
  ...
  public PermissionDenied code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PermissionDenied details(List<ErrorDetails> details) {
    this.details = details;
    return this;
  }

  public PermissionDenied addDetailsItem(ErrorDetails detailsItem) {
  ...
  public PermissionDenied status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, permissionDenied.code) &&
        Objects.equals(this.details, permissionDenied.details) &&
        Objects.equals(this.message, permissionDenied.message) &&
        Objects.equals(this.status, permissionDenied.status);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PermissionDenied
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PermissionDenied.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PermissionDenied.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PermissionDenied` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
