...
public class LicenseLifecycleState {
  ...
  public LicenseLifecycleState description(String description) {
  ...
  public LicenseLifecycleState name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LicenseLifecycleState licenseLifecycleState = (LicenseLifecycleState) o;
    return Objects.equals(this.description, licenseLifecycleState.description) &&
        Objects.equals(this.id, licenseLifecycleState.id) &&
        Objects.equals(this.name, licenseLifecycleState.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class LicenseLifecycleState {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LicenseLifecycleState
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LicenseLifecycleState.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LicenseLifecycleState is not found in the empty JSON string", LicenseLifecycleState.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LicenseLifecycleState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LicenseLifecycleState` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LicenseLifecycleState.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LicenseLifecycleState' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LicenseLifecycleState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LicenseLifecycleState.class));

       return (TypeAdapter<T>) new TypeAdapter<LicenseLifecycleState>() {
           @Override
           public void write(JsonWriter out, LicenseLifecycleState value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LicenseLifecycleState read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LicenseLifecycleState given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LicenseLifecycleState
   * @throws IOException if the JSON string is invalid with respect to LicenseLifecycleState
   */
  public static LicenseLifecycleState fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LicenseLifecycleState.class);
  }

  /**
   * Convert an instance of LicenseLifecycleState to an JSON string
   *
   * @return JSON string
   */
