...
public class IndividualAddress {
  ...
  private AddressTypeEnum addressType = AddressTypeEnum.PRINCIPAL_PLACE_OF_RESIDENCE;
  ...
  public IndividualAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  public IndividualAddress country(String country) {
  ...
  public IndividualAddress line1(String line1) {
    this.line1 = line1;
    return this;
  }
  ...
  public IndividualAddress line2(String line2) {
    this.line2 = line2;
    return this;
  }
  ...
  public IndividualAddress line3(String line3) {
    this.line3 = line3;
    return this;
  }
  ...
  public IndividualAddress name(String name) {
    this.name = name;
    return this;
  }
  ...
  public IndividualAddress postalCode(String postalCode) {
  ...
  public IndividualAddress suburb(String suburb) {
    this.suburb = suburb;
    return this;
  }
  ...
  public IndividualAddress addressType(AddressTypeEnum addressType) {
  ...
  public boolean equals(Object o) {
    ...
    IndividualAddress individualAddress = (IndividualAddress) o;
    return Objects.equals(this.city, individualAddress.city) &&
        Objects.equals(this.country, individualAddress.country) &&
        Objects.equals(this.fromDate, individualAddress.fromDate) &&
        Objects.equals(this.id, individualAddress.id) &&
        Objects.equals(this.line1, individualAddress.line1) &&
        Objects.equals(this.line2, individualAddress.line2) &&
        Objects.equals(this.line3, individualAddress.line3) &&
        Objects.equals(this.name, individualAddress.name) &&
        Objects.equals(this.postalCode, individualAddress.postalCode) &&
        Objects.equals(this.suburb, individualAddress.suburb) &&
        Objects.equals(this.toDate, individualAddress.toDate) &&
        Objects.equals(this.addressType, individualAddress.addressType);
  }
  ...
  public String toString() {
    ...
    sb.append("class IndividualAddress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IndividualAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IndividualAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IndividualAddress is not found in the empty JSON string", IndividualAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IndividualAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IndividualAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IndividualAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IndividualAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IndividualAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IndividualAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<IndividualAddress>() {
           @Override
           public void write(JsonWriter out, IndividualAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IndividualAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IndividualAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IndividualAddress
   * @throws IOException if the JSON string is invalid with respect to IndividualAddress
   */
  public static IndividualAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IndividualAddress.class);
  }

  /**
   * Convert an instance of IndividualAddress to an JSON string
   *
   * @return JSON string
   */
