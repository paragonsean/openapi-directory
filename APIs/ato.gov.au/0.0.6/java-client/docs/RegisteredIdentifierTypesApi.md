...
<a id="classificationsRegisteredIdentifierTypesGet"></a>
# **classificationsRegisteredIdentifierTypesGet**
> List&lt;RegisteredIdentifierType&gt; classificationsRegisteredIdentifierTypesGet(apiKey)
...
import org.openapitools.client.api.RegisteredIdentifierTypesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    RegisteredIdentifierTypesApi apiInstance = new RegisteredIdentifierTypesApi(defaultClient);
    String apiKey = "apiKey_example"; // String | The API key.
    try {
      List<RegisteredIdentifierType> result = apiInstance.classificationsRegisteredIdentifierTypesGet(apiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RegisteredIdentifierTypesApi#classificationsRegisteredIdentifierTypesGet");
...
[**List&lt;RegisteredIdentifierType&gt;**](RegisteredIdentifierType.md)
