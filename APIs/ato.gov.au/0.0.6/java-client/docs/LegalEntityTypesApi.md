...
<a id="classificationsLegalEntityTypesGet"></a>
# **classificationsLegalEntityTypesGet**
> List&lt;LegalEntityType&gt; classificationsLegalEntityTypesGet(apiKey)
...
import org.openapitools.client.api.LegalEntityTypesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    LegalEntityTypesApi apiInstance = new LegalEntityTypesApi(defaultClient);
    String apiKey = "apiKey_example"; // String | The API key.
    try {
      List<LegalEntityType> result = apiInstance.classificationsLegalEntityTypesGet(apiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LegalEntityTypesApi#classificationsLegalEntityTypesGet");
...
[**List&lt;LegalEntityType&gt;**](LegalEntityType.md)
