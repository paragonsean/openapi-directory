...
<a id="classificationsNameTypesGet"></a>
# **classificationsNameTypesGet**
> List&lt;NameType&gt; classificationsNameTypesGet(apiKey)
...
import org.openapitools.client.api.NameTypesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    NameTypesApi apiInstance = new NameTypesApi(defaultClient);
    String apiKey = "apiKey_example"; // String | The API key.
    try {
      List<NameType> result = apiInstance.classificationsNameTypesGet(apiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling NameTypesApi#classificationsNameTypesGet");
