...
<a id="classificationsLicenseLifecycleStatesGet"></a>
# **classificationsLicenseLifecycleStatesGet**
> List&lt;LicenseLifecycleState&gt; classificationsLicenseLifecycleStatesGet(apiKey)
...
import org.openapitools.client.api.LicenseLifecycleStatesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    LicenseLifecycleStatesApi apiInstance = new LicenseLifecycleStatesApi(defaultClient);
    String apiKey = "apiKey_example"; // String | The API key.
    try {
      List<LicenseLifecycleState> result = apiInstance.classificationsLicenseLifecycleStatesGet(apiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LicenseLifecycleStatesApi#classificationsLicenseLifecycleStatesGet");
...
[**List&lt;LicenseLifecycleState&gt;**](LicenseLifecycleState.md)
