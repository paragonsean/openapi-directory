...
<a id="classificationsNamePrefixesGet"></a>
# **classificationsNamePrefixesGet**
> List&lt;NamePrefix&gt; classificationsNamePrefixesGet(apiKey)
...
import org.openapitools.client.api.NamePrefixesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    NamePrefixesApi apiInstance = new NamePrefixesApi(defaultClient);
    String apiKey = "apiKey_example"; // String | The API key.
    try {
      List<NamePrefix> result = apiInstance.classificationsNamePrefixesGet(apiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling NamePrefixesApi#classificationsNamePrefixesGet");
