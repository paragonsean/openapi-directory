...
<a id="classificationsLicenseTypesGet"></a>
# **classificationsLicenseTypesGet**
> List&lt;LicenseType&gt; classificationsLicenseTypesGet(apiKey)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<LicenseType> result = apiInstance.classificationsLicenseTypesGet(apiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LicenseTypesApi#classificationsLicenseTypesGet");
...
[**List&lt;LicenseType&gt;**](LicenseType.md)
