...
<a id="classificationsRolesGet"></a>
# **classificationsRolesGet**
> List&lt;Role&gt; classificationsRolesGet(apiKey)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Role> result = apiInstance.classificationsRolesGet(apiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RolesApi#classificationsRolesGet");
