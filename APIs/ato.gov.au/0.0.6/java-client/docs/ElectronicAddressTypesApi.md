...
<a id="classificationsElectronicAddressTypesGet"></a>
# **classificationsElectronicAddressTypesGet**
> List&lt;ElectronicAddressType&gt; classificationsElectronicAddressTypesGet(apiKey)
...
import org.openapitools.client.api.ElectronicAddressTypesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ElectronicAddressTypesApi apiInstance = new ElectronicAddressTypesApi(defaultClient);
    String apiKey = "apiKey_example"; // String | The API key.
    try {
      List<ElectronicAddressType> result = apiInstance.classificationsElectronicAddressTypesGet(apiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ElectronicAddressTypesApi#classificationsElectronicAddressTypesGet");
...
[**List&lt;ElectronicAddressType&gt;**](ElectronicAddressType.md)
