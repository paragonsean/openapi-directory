...
<a id="individualsPartyIdBusinessNamesGet"></a>
# **individualsPartyIdBusinessNamesGet**
> List&lt;BusinessName&gt; individualsPartyIdBusinessNamesGet(apiKey, partyId)
...
import org.openapitools.client.api.IndividualsBusinessNamesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    IndividualsBusinessNamesApi apiInstance = new IndividualsBusinessNamesApi(defaultClient);
    String apiKey = "apiKey_example"; // String | The API key.
    String partyId = "partyId_example"; // String | The party identifier.
    try {
      List<BusinessName> result = apiInstance.individualsPartyIdBusinessNamesGet(apiKey, partyId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IndividualsBusinessNamesApi#individualsPartyIdBusinessNamesGet");
...
<a id="individualsPartyIdBusinessNamesPost"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      BusinessName result = apiInstance.individualsPartyIdBusinessNamesPost(apiKey, partyId, businessName);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IndividualsBusinessNamesApi#individualsPartyIdBusinessNamesPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="individualsPartyIdBusinessNamesProductIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.individualsPartyIdBusinessNamesProductIdDelete(apiKey, partyId, productId);
    } catch (ApiException e) {
      System.err.println("Exception when calling IndividualsBusinessNamesApi#individualsPartyIdBusinessNamesProductIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="individualsPartyIdBusinessNamesProductIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String productId = "productId_example"; // String | The product identifier.
    try {
      BusinessName result = apiInstance.individualsPartyIdBusinessNamesProductIdGet(apiKey, partyId, productId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IndividualsBusinessNamesApi#individualsPartyIdBusinessNamesProductIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="individualsPartyIdBusinessNamesProductIdPut"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    BusinessName businessName = new BusinessName(); // BusinessName | Business Name resource
    try {
      BusinessName result = apiInstance.individualsPartyIdBusinessNamesProductIdPut(apiKey, partyId, productId, businessName);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IndividualsBusinessNamesApi#individualsPartyIdBusinessNamesProductIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
