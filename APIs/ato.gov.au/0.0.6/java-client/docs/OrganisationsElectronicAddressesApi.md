...
<a id="organisationsPartyIdElectronicAddressesAddressIdDelete"></a>
...
import org.openapitools.client.api.OrganisationsElectronicAddressesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    OrganisationsElectronicAddressesApi apiInstance = new OrganisationsElectronicAddressesApi(defaultClient);
    ...
    try {
      apiInstance.organisationsPartyIdElectronicAddressesAddressIdDelete(apiKey, partyId, addressId);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganisationsElectronicAddressesApi#organisationsPartyIdElectronicAddressesAddressIdDelete");
...
<a id="organisationsPartyIdElectronicAddressesAddressIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String addressId = "addressId_example"; // String | The address identifier.
    try {
      ElectronicAddress result = apiInstance.organisationsPartyIdElectronicAddressesAddressIdGet(apiKey, partyId, addressId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganisationsElectronicAddressesApi#organisationsPartyIdElectronicAddressesAddressIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="organisationsPartyIdElectronicAddressesAddressIdPut"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ElectronicAddress result = apiInstance.organisationsPartyIdElectronicAddressesAddressIdPut(apiKey, partyId, addressId, electronicAddress);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganisationsElectronicAddressesApi#organisationsPartyIdElectronicAddressesAddressIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="organisationsPartyIdElectronicAddressesGet"></a>
# **organisationsPartyIdElectronicAddressesGet**
> List&lt;ElectronicAddress&gt; organisationsPartyIdElectronicAddressesGet(apiKey, partyId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String partyId = "partyId_example"; // String | The party identifier.
    try {
      List<ElectronicAddress> result = apiInstance.organisationsPartyIdElectronicAddressesGet(apiKey, partyId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganisationsElectronicAddressesApi#organisationsPartyIdElectronicAddressesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="organisationsPartyIdElectronicAddressesPost"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    ElectronicAddress electronicAddress = new ElectronicAddress(); // ElectronicAddress | Electronic Address resource
    try {
      ElectronicAddress result = apiInstance.organisationsPartyIdElectronicAddressesPost(apiKey, partyId, electronicAddress);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganisationsElectronicAddressesApi#organisationsPartyIdElectronicAddressesPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
