...
<a id="individualsPartyIdRolesGet"></a>
# **individualsPartyIdRolesGet**
> List&lt;PartyRole&gt; individualsPartyIdRolesGet(apiKey, partyId)
...
import org.openapitools.client.api.IndividualsRolesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    IndividualsRolesApi apiInstance = new IndividualsRolesApi(defaultClient);
    String apiKey = "apiKey_example"; // String | The API key.
    String partyId = "partyId_example"; // String | The party identifier.
    try {
      List<PartyRole> result = apiInstance.individualsPartyIdRolesGet(apiKey, partyId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IndividualsRolesApi#individualsPartyIdRolesGet");
...
<a id="individualsPartyIdRolesPost"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PartyRole result = apiInstance.individualsPartyIdRolesPost(apiKey, partyId, partyRole);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IndividualsRolesApi#individualsPartyIdRolesPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="individualsPartyIdRolesRoleIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.individualsPartyIdRolesRoleIdDelete(apiKey, partyId, roleId);
    } catch (ApiException e) {
      System.err.println("Exception when calling IndividualsRolesApi#individualsPartyIdRolesRoleIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="individualsPartyIdRolesRoleIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String roleId = "roleId_example"; // String | The role identifier.
    try {
      PartyRole result = apiInstance.individualsPartyIdRolesRoleIdGet(apiKey, partyId, roleId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IndividualsRolesApi#individualsPartyIdRolesRoleIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="individualsPartyIdRolesRoleIdPut"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    PartyRole partyRole = new PartyRole(); // PartyRole | Role resource
    try {
      PartyRole result = apiInstance.individualsPartyIdRolesRoleIdPut(apiKey, partyId, roleId, partyRole);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IndividualsRolesApi#individualsPartyIdRolesRoleIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
