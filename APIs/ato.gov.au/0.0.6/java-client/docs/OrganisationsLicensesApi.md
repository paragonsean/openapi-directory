...
<a id="organisationsPartyIdLicensesGet"></a>
# **organisationsPartyIdLicensesGet**
> List&lt;License&gt; organisationsPartyIdLicensesGet(apiKey, partyId)
...
import org.openapitools.client.api.OrganisationsLicensesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    OrganisationsLicensesApi apiInstance = new OrganisationsLicensesApi(defaultClient);
    String apiKey = "apiKey_example"; // String | The API key.
    String partyId = "partyId_example"; // String | The party identifier.
    try {
      List<License> result = apiInstance.organisationsPartyIdLicensesGet(apiKey, partyId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganisationsLicensesApi#organisationsPartyIdLicensesGet");
...
<a id="organisationsPartyIdLicensesPost"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      License result = apiInstance.organisationsPartyIdLicensesPost(apiKey, partyId, license);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganisationsLicensesApi#organisationsPartyIdLicensesPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="organisationsPartyIdLicensesProductIdDelete"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.organisationsPartyIdLicensesProductIdDelete(apiKey, partyId, productId);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganisationsLicensesApi#organisationsPartyIdLicensesProductIdDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="organisationsPartyIdLicensesProductIdGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String productId = "productId_example"; // String | The product identifier.
    try {
      License result = apiInstance.organisationsPartyIdLicensesProductIdGet(apiKey, partyId, productId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganisationsLicensesApi#organisationsPartyIdLicensesProductIdGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="organisationsPartyIdLicensesProductIdPut"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    License license = new License(); // License | License resource
    try {
      License result = apiInstance.organisationsPartyIdLicensesProductIdPut(apiKey, partyId, productId, license);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrganisationsLicensesApi#organisationsPartyIdLicensesProductIdPut");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
