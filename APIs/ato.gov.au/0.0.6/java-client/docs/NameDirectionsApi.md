...
<a id="classificationsNameDirectionsGet"></a>
# **classificationsNameDirectionsGet**
> List&lt;NameDirection&gt; classificationsNameDirectionsGet(apiKey)
...
import org.openapitools.client.api.NameDirectionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    NameDirectionsApi apiInstance = new NameDirectionsApi(defaultClient);
    String apiKey = "apiKey_example"; // String | The API key.
    try {
      List<NameDirection> result = apiInstance.classificationsNameDirectionsGet(apiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling NameDirectionsApi#classificationsNameDirectionsGet");
...
[**List&lt;NameDirection&gt;**](NameDirection.md)
