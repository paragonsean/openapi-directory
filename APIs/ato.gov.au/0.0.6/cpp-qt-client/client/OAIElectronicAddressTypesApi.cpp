...
#include "OAIElectronicAddressTypesApi.h"
...
OAIElectronicAddressTypesApi::OAIElectronicAddressTypesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIElectronicAddressTypesApi::~OAIElectronicAddressTypesApi() {
}

void OAIElectronicAddressTypesApi::initializeServerConfigs() {
    //Default server
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("classificationsElectronicAddressTypesGet", defaultConf);
    _serverIndices.insert("classificationsElectronicAddressTypesGet", 0);
}
...
*/
int OAIElectronicAddressTypesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIElectronicAddressTypesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIElectronicAddressTypesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIElectronicAddressTypesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIElectronicAddressTypesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIElectronicAddressTypesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIElectronicAddressTypesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIElectronicAddressTypesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIElectronicAddressTypesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIElectronicAddressTypesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIElectronicAddressTypesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIElectronicAddressTypesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIElectronicAddressTypesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIElectronicAddressTypesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIElectronicAddressTypesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIElectronicAddressTypesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIElectronicAddressTypesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIElectronicAddressTypesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIElectronicAddressTypesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIElectronicAddressTypesApi::classificationsElectronicAddressTypesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["classificationsElectronicAddressTypesGet"][_serverIndices.value("classificationsElectronicAddressTypesGet")].URL()+"/classifications/electronic-address-types");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIElectronicAddressTypesApi::classificationsElectronicAddressTypesGetCallback);
    connect(this, &OAIElectronicAddressTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIElectronicAddressTypesApi::classificationsElectronicAddressTypesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIElectronic_address_type> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIElectronic_address_type val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT classificationsElectronicAddressTypesGetSignal(output);
        Q_EMIT classificationsElectronicAddressTypesGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT classificationsElectronicAddressTypesGetSignalE(output, error_type, error_str);
        Q_EMIT classificationsElectronicAddressTypesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT classificationsElectronicAddressTypesGetSignalError(output, error_type, error_str);
        Q_EMIT classificationsElectronicAddressTypesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIElectronicAddressTypesApi::tokenAvailable(){
