...
/*
 * OAIIndividual_name.h
 *
 * The Individual Name resource.
 */

#ifndef OAIIndividual_name_H
#define OAIIndividual_name_H
...
class OAIIndividual_name : public OAIObject {
public:
    OAIIndividual_name();
    OAIIndividual_name(QString json);
    ~OAIIndividual_name() override;
    ...
    QString getFormalSalutation() const;
    void setFormalSalutation(const QString &formal_salutation);
    bool is_formal_salutation_Set() const;
    bool is_formal_salutation_Valid() const;
    ...
    QString getInformalSalutation() const;
    void setInformalSalutation(const QString &informal_salutation);
    bool is_informal_salutation_Set() const;
    bool is_informal_salutation_Valid() const;
    ...
    QString getNameType() const;
    void setNameType(const QString &name_type);
    bool is_name_type_Set() const;
    bool is_name_type_Valid() const;
...
private:
    ...
    QString m_formal_salutation;
    bool m_formal_salutation_isSet;
    bool m_formal_salutation_isValid;
    ...
    QString m_informal_salutation;
    bool m_informal_salutation_isSet;
    bool m_informal_salutation_isValid;
    ...
    QString m_name_type;
    bool m_name_type_isSet;
    bool m_name_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIndividual_name)

#endif // OAIIndividual_name_H
