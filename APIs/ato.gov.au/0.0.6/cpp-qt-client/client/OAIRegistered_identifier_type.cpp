...
OAIRegistered_identifier_type::OAIRegistered_identifier_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegistered_identifier_type::OAIRegistered_identifier_type() {
    this->initializeModel();
}

OAIRegistered_identifier_type::~OAIRegistered_identifier_type() {}

void OAIRegistered_identifier_type::initializeModel() {
...
void OAIRegistered_identifier_type::fromJson(QString jsonString) {
...
void OAIRegistered_identifier_type::fromJsonObject(QJsonObject json) {
...
QString OAIRegistered_identifier_type::asJson() const {
...
QJsonObject OAIRegistered_identifier_type::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRegistered_identifier_type::getDescription() const {
    return m_description;
}
void OAIRegistered_identifier_type::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIRegistered_identifier_type::is_description_Set() const{
    return m_description_isSet;
}

bool OAIRegistered_identifier_type::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIRegistered_identifier_type::getId() const {
    return m_id;
}
void OAIRegistered_identifier_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRegistered_identifier_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRegistered_identifier_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIRegistered_identifier_type::getName() const {
    return m_name;
}
void OAIRegistered_identifier_type::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRegistered_identifier_type::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRegistered_identifier_type::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIRegistered_identifier_type::isSet() const {
...
bool OAIRegistered_identifier_type::isValid() const {
