...
#ifndef OAIName_direction_H
#define OAIName_direction_H
...
class OAIName_direction : public OAIObject {
public:
    OAIName_direction();
    OAIName_direction(QString json);
    ~OAIName_direction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIName_direction)

#endif // OAIName_direction_H
