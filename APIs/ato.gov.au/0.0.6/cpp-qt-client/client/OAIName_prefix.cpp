...
OAIName_prefix::OAIName_prefix(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIName_prefix::OAIName_prefix() {
    this->initializeModel();
}

OAIName_prefix::~OAIName_prefix() {}

void OAIName_prefix::initializeModel() {
...
void OAIName_prefix::fromJson(QString jsonString) {
...
void OAIName_prefix::fromJsonObject(QJsonObject json) {
...
QString OAIName_prefix::asJson() const {
...
QJsonObject OAIName_prefix::asJsonObject() const {
    QJsonObject obj;
...
QString OAIName_prefix::getDescription() const {
    return m_description;
}
void OAIName_prefix::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIName_prefix::is_description_Set() const{
    return m_description_isSet;
}

bool OAIName_prefix::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIName_prefix::getId() const {
    return m_id;
}
void OAIName_prefix::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIName_prefix::is_id_Set() const{
    return m_id_isSet;
}

bool OAIName_prefix::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIName_prefix::getName() const {
    return m_name;
}
void OAIName_prefix::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIName_prefix::is_name_Set() const{
    return m_name_isSet;
}

bool OAIName_prefix::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIName_prefix::isSet() const {
...
bool OAIName_prefix::isValid() const {
