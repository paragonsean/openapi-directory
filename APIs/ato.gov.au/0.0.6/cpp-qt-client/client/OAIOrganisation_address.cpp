...
OAIOrganisation_address::OAIOrganisation_address(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganisation_address::OAIOrganisation_address() {
    this->initializeModel();
}

OAIOrganisation_address::~OAIOrganisation_address() {}

void OAIOrganisation_address::initializeModel() {
...
void OAIOrganisation_address::fromJson(QString jsonString) {
...
void OAIOrganisation_address::fromJsonObject(QJsonObject json) {
...
QString OAIOrganisation_address::asJson() const {
...
QJsonObject OAIOrganisation_address::asJsonObject() const {
    QJsonObject obj;
    if (m_city_isSet) {
...
QString OAIOrganisation_address::getCity() const {
    return m_city;
}
void OAIOrganisation_address::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIOrganisation_address::is_city_Set() const{
    return m_city_isSet;
}

bool OAIOrganisation_address::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIOrganisation_address::getCountry() const {
    return m_country;
}
void OAIOrganisation_address::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIOrganisation_address::is_country_Set() const{
    return m_country_isSet;
}

bool OAIOrganisation_address::is_country_Valid() const{
    return m_country_isValid;
}

QDateTime OAIOrganisation_address::getFromDate() const {
    return m_from_date;
}
void OAIOrganisation_address::setFromDate(const QDateTime &from_date) {
    m_from_date = from_date;
    m_from_date_isSet = true;
}

bool OAIOrganisation_address::is_from_date_Set() const{
    return m_from_date_isSet;
}

bool OAIOrganisation_address::is_from_date_Valid() const{
    return m_from_date_isValid;
}

OAIAddressId OAIOrganisation_address::getId() const {
    return m_id;
}
void OAIOrganisation_address::setId(const OAIAddressId &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOrganisation_address::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOrganisation_address::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIOrganisation_address::getLine1() const {
    return m_line1;
}
void OAIOrganisation_address::setLine1(const QString &line1) {
    m_line1 = line1;
    m_line1_isSet = true;
}

bool OAIOrganisation_address::is_line1_Set() const{
    return m_line1_isSet;
}

bool OAIOrganisation_address::is_line1_Valid() const{
    return m_line1_isValid;
}

QString OAIOrganisation_address::getLine2() const {
    return m_line2;
}
void OAIOrganisation_address::setLine2(const QString &line2) {
    m_line2 = line2;
    m_line2_isSet = true;
}

bool OAIOrganisation_address::is_line2_Set() const{
    return m_line2_isSet;
}

bool OAIOrganisation_address::is_line2_Valid() const{
    return m_line2_isValid;
}

QString OAIOrganisation_address::getLine3() const {
    return m_line3;
}
void OAIOrganisation_address::setLine3(const QString &line3) {
    m_line3 = line3;
    m_line3_isSet = true;
}

bool OAIOrganisation_address::is_line3_Set() const{
    return m_line3_isSet;
}

bool OAIOrganisation_address::is_line3_Valid() const{
    return m_line3_isValid;
}

QString OAIOrganisation_address::getName() const {
    return m_name;
}
void OAIOrganisation_address::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIOrganisation_address::is_name_Set() const{
    return m_name_isSet;
}

bool OAIOrganisation_address::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIOrganisation_address::getPostalCode() const {
    return m_postal_code;
}
void OAIOrganisation_address::setPostalCode(const QString &postal_code) {
    m_postal_code = postal_code;
    m_postal_code_isSet = true;
}

bool OAIOrganisation_address::is_postal_code_Set() const{
    return m_postal_code_isSet;
}

bool OAIOrganisation_address::is_postal_code_Valid() const{
    return m_postal_code_isValid;
}

QString OAIOrganisation_address::getSuburb() const {
    return m_suburb;
}
void OAIOrganisation_address::setSuburb(const QString &suburb) {
    m_suburb = suburb;
    m_suburb_isSet = true;
}

bool OAIOrganisation_address::is_suburb_Set() const{
    return m_suburb_isSet;
}

bool OAIOrganisation_address::is_suburb_Valid() const{
    return m_suburb_isValid;
}

QDateTime OAIOrganisation_address::getToDate() const {
    return m_to_date;
}
void OAIOrganisation_address::setToDate(const QDateTime &to_date) {
    m_to_date = to_date;
    m_to_date_isSet = true;
}

bool OAIOrganisation_address::is_to_date_Set() const{
    return m_to_date_isSet;
}

bool OAIOrganisation_address::is_to_date_Valid() const{
    return m_to_date_isValid;
}

QString OAIOrganisation_address::getAddressType() const {
    return m_address_type;
}
void OAIOrganisation_address::setAddressType(const QString &address_type) {
    m_address_type = address_type;
    m_address_type_isSet = true;
}

bool OAIOrganisation_address::is_address_type_Set() const{
    return m_address_type_isSet;
}

bool OAIOrganisation_address::is_address_type_Valid() const{
    return m_address_type_isValid;
}

bool OAIOrganisation_address::isSet() const {
...
bool OAIOrganisation_address::isValid() const {
