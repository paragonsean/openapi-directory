...
/*
 * OAILicense_lifecycle_state.h
 *
 * 
 */

#ifndef OAILicense_lifecycle_state_H
#define OAILicense_lifecycle_state_H
...
class OAILicense_lifecycle_state : public OAIObject {
public:
    OAILicense_lifecycle_state();
    OAILicense_lifecycle_state(QString json);
    ~OAILicense_lifecycle_state() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicense_lifecycle_state)

#endif // OAILicense_lifecycle_state_H
