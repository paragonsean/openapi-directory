...
/*
 * OAIInvalid_argument.h
 *
 * 
 */

#ifndef OAIInvalid_argument_H
#define OAIInvalid_argument_H
...
class OAIInvalid_argument : public OAIObject {
public:
    OAIInvalid_argument();
    OAIInvalid_argument(QString json);
    ~OAIInvalid_argument() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvalid_argument)

#endif // OAIInvalid_argument_H
