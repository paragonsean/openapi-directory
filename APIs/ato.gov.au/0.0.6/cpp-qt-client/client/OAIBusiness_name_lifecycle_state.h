...
/*
 * OAIBusiness_name_lifecycle_state.h
 *
 * 
 */

#ifndef OAIBusiness_name_lifecycle_state_H
#define OAIBusiness_name_lifecycle_state_H
...
class OAIBusiness_name_lifecycle_state : public OAIObject {
public:
    OAIBusiness_name_lifecycle_state();
    OAIBusiness_name_lifecycle_state(QString json);
    ~OAIBusiness_name_lifecycle_state() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBusiness_name_lifecycle_state)

#endif // OAIBusiness_name_lifecycle_state_H
