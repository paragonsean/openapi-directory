...
OAIBusinessNamesApi::OAIBusinessNamesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIBusinessNamesApi::~OAIBusinessNamesApi() {
}

void OAIBusinessNamesApi::initializeServerConfigs() {
    //Default server
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("businessNamesGet", defaultConf);
    _serverIndices.insert("businessNamesGet", 0);
}
...
*/
int OAIBusinessNamesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIBusinessNamesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIBusinessNamesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIBusinessNamesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIBusinessNamesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIBusinessNamesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIBusinessNamesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIBusinessNamesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIBusinessNamesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIBusinessNamesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBusinessNamesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBusinessNamesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIBusinessNamesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIBusinessNamesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIBusinessNamesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIBusinessNamesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIBusinessNamesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIBusinessNamesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIBusinessNamesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIBusinessNamesApi::businessNamesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["businessNamesGet"][_serverIndices.value("businessNamesGet")].URL()+"/business-names");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBusinessNamesApi::businessNamesGetCallback);
    connect(this, &OAIBusinessNamesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIBusinessNamesApi::businessNamesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT businessNamesGetSignal(output);
        Q_EMIT businessNamesGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT businessNamesGetSignalE(output, error_type, error_str);
        Q_EMIT businessNamesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT businessNamesGetSignalError(output, error_type, error_str);
        Q_EMIT businessNamesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBusinessNamesApi::tokenAvailable(){
