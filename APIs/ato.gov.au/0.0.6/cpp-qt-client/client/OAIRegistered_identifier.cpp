...
OAIRegistered_identifier::OAIRegistered_identifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRegistered_identifier::OAIRegistered_identifier() {
    this->initializeModel();
}

OAIRegistered_identifier::~OAIRegistered_identifier() {}

void OAIRegistered_identifier::initializeModel() {
...
void OAIRegistered_identifier::fromJson(QString jsonString) {
...
void OAIRegistered_identifier::fromJsonObject(QJsonObject json) {
...
QString OAIRegistered_identifier::asJson() const {
...
QJsonObject OAIRegistered_identifier::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIRegistered_identifier::getFromDate() const {
    return m_from_date;
}
void OAIRegistered_identifier::setFromDate(const QDateTime &from_date) {
    m_from_date = from_date;
    m_from_date_isSet = true;
}

bool OAIRegistered_identifier::is_from_date_Set() const{
    return m_from_date_isSet;
}

bool OAIRegistered_identifier::is_from_date_Valid() const{
    return m_from_date_isValid;
}

QString OAIRegistered_identifier::getId() const {
    return m_id;
}
void OAIRegistered_identifier::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRegistered_identifier::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRegistered_identifier::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIRegistered_identifier::getIdentifier() const {
    return m_identifier;
}
void OAIRegistered_identifier::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIRegistered_identifier::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIRegistered_identifier::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QString OAIRegistered_identifier::getIdentifierType() const {
    return m_identifier_type;
}
void OAIRegistered_identifier::setIdentifierType(const QString &identifier_type) {
    m_identifier_type = identifier_type;
    m_identifier_type_isSet = true;
}

bool OAIRegistered_identifier::is_identifier_type_Set() const{
    return m_identifier_type_isSet;
}

bool OAIRegistered_identifier::is_identifier_type_Valid() const{
    return m_identifier_type_isValid;
}

QDateTime OAIRegistered_identifier::getToDate() const {
    return m_to_date;
}
void OAIRegistered_identifier::setToDate(const QDateTime &to_date) {
    m_to_date = to_date;
    m_to_date_isSet = true;
}

bool OAIRegistered_identifier::is_to_date_Set() const{
    return m_to_date_isSet;
}

bool OAIRegistered_identifier::is_to_date_Valid() const{
    return m_to_date_isValid;
}

bool OAIRegistered_identifier::isSet() const {
...
bool OAIRegistered_identifier::isValid() const {
