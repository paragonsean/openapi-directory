...
OAIName_type::OAIName_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIName_type::OAIName_type() {
    this->initializeModel();
}

OAIName_type::~OAIName_type() {}

void OAIName_type::initializeModel() {
...
void OAIName_type::fromJson(QString jsonString) {
...
void OAIName_type::fromJsonObject(QJsonObject json) {
...
QString OAIName_type::asJson() const {
...
QJsonObject OAIName_type::asJsonObject() const {
    QJsonObject obj;
...
QString OAIName_type::getDescription() const {
    return m_description;
}
void OAIName_type::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIName_type::is_description_Set() const{
    return m_description_isSet;
}

bool OAIName_type::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIName_type::getId() const {
    return m_id;
}
void OAIName_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIName_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAIName_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIName_type::getName() const {
    return m_name;
}
void OAIName_type::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIName_type::is_name_Set() const{
    return m_name_isSet;
}

bool OAIName_type::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIName_type::isSet() const {
...
bool OAIName_type::isValid() const {
