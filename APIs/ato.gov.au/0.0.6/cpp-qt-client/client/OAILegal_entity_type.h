...
/*
 * OAILegal_entity_type.h
 *
 * 
 */

#ifndef OAILegal_entity_type_H
#define OAILegal_entity_type_H
...
class OAILegal_entity_type : public OAIObject {
public:
    OAILegal_entity_type();
    OAILegal_entity_type(QString json);
    ~OAILegal_entity_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILegal_entity_type)

#endif // OAILegal_entity_type_H
