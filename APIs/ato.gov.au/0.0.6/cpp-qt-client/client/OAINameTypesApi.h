...
#ifndef OAI_OAINameTypesApi_H
#define OAI_OAINameTypesApi_H
...
class OAINameTypesApi : public QObject {
    Q_OBJECT

public:
    OAINameTypesApi(const int timeOut = 0);
    ~OAINameTypesApi();
    ...
    */
    virtual void classificationsNameTypesGet(const QString &api_key);
...
private:
    ...
    void classificationsNameTypesGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsNameTypesGetSignal(QList<OAIName_type> summary);


    void classificationsNameTypesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIName_type> summary);

    Q_DECL_DEPRECATED_X("Use classificationsNameTypesGetSignalError() instead")
    void classificationsNameTypesGetSignalE(QList<OAIName_type> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsNameTypesGetSignalError(QList<OAIName_type> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsNameTypesGetSignalErrorFull() instead")
    void classificationsNameTypesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsNameTypesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
