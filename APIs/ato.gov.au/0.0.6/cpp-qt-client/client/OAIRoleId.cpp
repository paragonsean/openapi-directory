...
OAIRoleId::OAIRoleId(QString json) {
...
void OAIRoleId::initializeModel() {

}

void OAIRoleId::fromJson(QString jsonString) {
...
void OAIRoleId::fromJsonObject(QJsonObject json) {

}

QString OAIRoleId::asJson() const {
...
QJsonObject OAIRoleId::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAIRoleId::isSet() const {
