...
OAILicense_type::OAILicense_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILicense_type::OAILicense_type() {
    this->initializeModel();
}

OAILicense_type::~OAILicense_type() {}

void OAILicense_type::initializeModel() {
...
void OAILicense_type::fromJson(QString jsonString) {
...
void OAILicense_type::fromJsonObject(QJsonObject json) {
...
QString OAILicense_type::asJson() const {
...
QJsonObject OAILicense_type::asJsonObject() const {
    QJsonObject obj;
...
QString OAILicense_type::getDescription() const {
    return m_description;
}
void OAILicense_type::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAILicense_type::is_description_Set() const{
    return m_description_isSet;
}

bool OAILicense_type::is_description_Valid() const{
    return m_description_isValid;
}

QString OAILicense_type::getId() const {
    return m_id;
}
void OAILicense_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILicense_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAILicense_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILicense_type::getName() const {
    return m_name;
}
void OAILicense_type::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILicense_type::is_name_Set() const{
    return m_name_isSet;
}

bool OAILicense_type::is_name_Valid() const{
    return m_name_isValid;
}

bool OAILicense_type::isSet() const {
...
bool OAILicense_type::isValid() const {
