...
/*
 * OAIRegistered_identifier.h
 *
 * The Registered Identifier resource.
 */

#ifndef OAIRegistered_identifier_H
#define OAIRegistered_identifier_H
...
class OAIRegistered_identifier : public OAIObject {
public:
    OAIRegistered_identifier();
    OAIRegistered_identifier(QString json);
    ~OAIRegistered_identifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegistered_identifier)

#endif // OAIRegistered_identifier_H
