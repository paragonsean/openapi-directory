...
namespace OpenAPI {
class OAIIndividual_address;
class OAIElectronic_address;
class OAIIndividual_name;
...
public:
    ...
    QList<OAIIndividual_address> getAddresses() const;
    void setAddresses(const QList<OAIIndividual_address> &addresses);
    ...
    QList<OAIIndividual_name> getNames() const;
    void setNames(const QList<OAIIndividual_name> &names);
    bool is_names_Set() const;
    bool is_names_Valid() const;

    QString getPlaceOfBirth() const;
    void setPlaceOfBirth(const QString &place_of_birth);
    bool is_place_of_birth_Set() const;
    bool is_place_of_birth_Valid() const;
...
private:
    ...
    QList<OAIIndividual_address> m_addresses;
    ...
    QList<OAIIndividual_name> m_names;
    bool m_names_isSet;
    bool m_names_isValid;

    QString m_place_of_birth;
    bool m_place_of_birth_isSet;
    bool m_place_of_birth_isValid;
