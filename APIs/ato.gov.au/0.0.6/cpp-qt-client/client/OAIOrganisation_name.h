...
/*
 * OAIOrganisation_name.h
 *
 * The Organisation Name resource.
 */

#ifndef OAIOrganisation_name_H
#define OAIOrganisation_name_H
...
class OAIOrganisation_name : public OAIObject {
public:
    OAIOrganisation_name();
    OAIOrganisation_name(QString json);
    ~OAIOrganisation_name() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganisation_name)

#endif // OAIOrganisation_name_H
