...
#ifndef OAIBusiness_name_H
#define OAIBusiness_name_H
...
class OAIBusiness_name : public OAIObject {
public:
    OAIBusiness_name();
    OAIBusiness_name(QString json);
    ~OAIBusiness_name() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBusiness_name)

#endif // OAIBusiness_name_H
