...
#include "OAILegal_entity_type.h"
...
OAILegal_entity_type::OAILegal_entity_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILegal_entity_type::OAILegal_entity_type() {
    this->initializeModel();
}

OAILegal_entity_type::~OAILegal_entity_type() {}

void OAILegal_entity_type::initializeModel() {
...
void OAILegal_entity_type::fromJson(QString jsonString) {
...
void OAILegal_entity_type::fromJsonObject(QJsonObject json) {
...
QString OAILegal_entity_type::asJson() const {
...
QJsonObject OAILegal_entity_type::asJsonObject() const {
    QJsonObject obj;
...
QString OAILegal_entity_type::getDescription() const {
    return m_description;
}
void OAILegal_entity_type::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAILegal_entity_type::is_description_Set() const{
    return m_description_isSet;
}

bool OAILegal_entity_type::is_description_Valid() const{
    return m_description_isValid;
}

QString OAILegal_entity_type::getId() const {
    return m_id;
}
void OAILegal_entity_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILegal_entity_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAILegal_entity_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILegal_entity_type::getName() const {
    return m_name;
}
void OAILegal_entity_type::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILegal_entity_type::is_name_Set() const{
    return m_name_isSet;
}

bool OAILegal_entity_type::is_name_Valid() const{
    return m_name_isValid;
}

bool OAILegal_entity_type::isSet() const {
...
bool OAILegal_entity_type::isValid() const {
