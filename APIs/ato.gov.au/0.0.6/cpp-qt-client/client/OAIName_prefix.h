...
#ifndef OAIName_prefix_H
#define OAIName_prefix_H
...
class OAIName_prefix : public OAIObject {
public:
    OAIName_prefix();
    OAIName_prefix(QString json);
    ~OAIName_prefix() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIName_prefix)

#endif // OAIName_prefix_H
