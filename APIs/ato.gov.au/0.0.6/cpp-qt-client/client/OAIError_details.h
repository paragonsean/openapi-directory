...
#ifndef OAIError_details_H
#define OAIError_details_H
...
class OAIError_details : public OAIObject {
public:
    OAIError_details();
    OAIError_details(QString json);
    ~OAIError_details() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIError_details)

#endif // OAIError_details_H
