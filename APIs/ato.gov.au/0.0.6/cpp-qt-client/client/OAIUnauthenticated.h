...
/*
 * OAIUnauthenticated.h
 *
 * 
 */

#ifndef OAIUnauthenticated_H
#define OAIUnauthenticated_H
...
class OAIUnauthenticated : public OAIObject {
public:
    OAIUnauthenticated();
    OAIUnauthenticated(QString json);
    ~OAIUnauthenticated() override;
    ...
    OAIError_details getDetails() const;
    void setDetails(const OAIError_details &details);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnauthenticated)

#endif // OAIUnauthenticated_H
