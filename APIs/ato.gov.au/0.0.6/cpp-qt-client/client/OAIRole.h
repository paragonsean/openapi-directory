...
public:
    ...
    QString getReciprocalRole() const;
    void setReciprocalRole(const QString &reciprocal_role);
    bool is_reciprocal_role_Set() const;
    bool is_reciprocal_role_Valid() const;

    QString getReciprocalRoleDescription() const;
    void setReciprocalRoleDescription(const QString &reciprocal_role_description);
    bool is_reciprocal_role_description_Set() const;
    bool is_reciprocal_role_description_Valid() const;
...
private:
    ...
    QString m_reciprocal_role;
    bool m_reciprocal_role_isSet;
    bool m_reciprocal_role_isValid;

    QString m_reciprocal_role_description;
    bool m_reciprocal_role_description_isSet;
    bool m_reciprocal_role_description_isValid;
