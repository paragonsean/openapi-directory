...
/*
 * OAIElectronic_address_type.h
 *
 * 
 */

#ifndef OAIElectronic_address_type_H
#define OAIElectronic_address_type_H
...
class OAIElectronic_address_type : public OAIObject {
public:
    OAIElectronic_address_type();
    OAIElectronic_address_type(QString json);
    ~OAIElectronic_address_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElectronic_address_type)

#endif // OAIElectronic_address_type_H
