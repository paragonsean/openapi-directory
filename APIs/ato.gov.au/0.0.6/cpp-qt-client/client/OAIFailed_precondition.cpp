...
OAIFailed_precondition::OAIFailed_precondition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFailed_precondition::OAIFailed_precondition() {
    this->initializeModel();
}

OAIFailed_precondition::~OAIFailed_precondition() {}

void OAIFailed_precondition::initializeModel() {
...
void OAIFailed_precondition::fromJson(QString jsonString) {
...
void OAIFailed_precondition::fromJsonObject(QJsonObject json) {
...
QString OAIFailed_precondition::asJson() const {
...
QJsonObject OAIFailed_precondition::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIFailed_precondition::getCode() const {
    return m_code;
}
void OAIFailed_precondition::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIFailed_precondition::is_code_Set() const{
    return m_code_isSet;
}

bool OAIFailed_precondition::is_code_Valid() const{
    return m_code_isValid;
}

QList<OAIError_details> OAIFailed_precondition::getDetails() const {
    return m_details;
}
void OAIFailed_precondition::setDetails(const QList<OAIError_details> &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIFailed_precondition::is_details_Set() const{
    return m_details_isSet;
}

bool OAIFailed_precondition::is_details_Valid() const{
    return m_details_isValid;
}

QString OAIFailed_precondition::getMessage() const {
    return m_message;
}
void OAIFailed_precondition::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIFailed_precondition::is_message_Set() const{
    return m_message_isSet;
}

bool OAIFailed_precondition::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIFailed_precondition::getStatus() const {
    return m_status;
}
void OAIFailed_precondition::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIFailed_precondition::is_status_Set() const{
    return m_status_isSet;
}

bool OAIFailed_precondition::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIFailed_precondition::isSet() const {
...
bool OAIFailed_precondition::isValid() const {
