...
/*
 * OAIFailed_precondition.h
 *
 * 
 */

#ifndef OAIFailed_precondition_H
#define OAIFailed_precondition_H
...
class OAIFailed_precondition : public OAIObject {
public:
    OAIFailed_precondition();
    OAIFailed_precondition(QString json);
    ~OAIFailed_precondition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFailed_precondition)

#endif // OAIFailed_precondition_H
