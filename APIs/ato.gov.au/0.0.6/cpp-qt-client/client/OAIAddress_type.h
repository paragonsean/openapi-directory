...
#ifndef OAIAddress_type_H
#define OAIAddress_type_H
...
class OAIAddress_type : public OAIObject {
public:
    OAIAddress_type();
    OAIAddress_type(QString json);
    ~OAIAddress_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddress_type)

#endif // OAIAddress_type_H
