...
#include "OAIRegisteredIdentifierTypesApi.h"
...
OAIRegisteredIdentifierTypesApi::OAIRegisteredIdentifierTypesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIRegisteredIdentifierTypesApi::~OAIRegisteredIdentifierTypesApi() {
}

void OAIRegisteredIdentifierTypesApi::initializeServerConfigs() {
    //Default server
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("classificationsRegisteredIdentifierTypesGet", defaultConf);
    _serverIndices.insert("classificationsRegisteredIdentifierTypesGet", 0);
}
...
*/
int OAIRegisteredIdentifierTypesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIRegisteredIdentifierTypesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIRegisteredIdentifierTypesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIRegisteredIdentifierTypesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIRegisteredIdentifierTypesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIRegisteredIdentifierTypesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIRegisteredIdentifierTypesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIRegisteredIdentifierTypesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIRegisteredIdentifierTypesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIRegisteredIdentifierTypesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIRegisteredIdentifierTypesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIRegisteredIdentifierTypesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIRegisteredIdentifierTypesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIRegisteredIdentifierTypesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIRegisteredIdentifierTypesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIRegisteredIdentifierTypesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIRegisteredIdentifierTypesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIRegisteredIdentifierTypesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIRegisteredIdentifierTypesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIRegisteredIdentifierTypesApi::classificationsRegisteredIdentifierTypesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["classificationsRegisteredIdentifierTypesGet"][_serverIndices.value("classificationsRegisteredIdentifierTypesGet")].URL()+"/classifications/registered-identifier-types");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRegisteredIdentifierTypesApi::classificationsRegisteredIdentifierTypesGetCallback);
    connect(this, &OAIRegisteredIdentifierTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIRegisteredIdentifierTypesApi::classificationsRegisteredIdentifierTypesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIRegistered_identifier_type> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIRegistered_identifier_type val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT classificationsRegisteredIdentifierTypesGetSignal(output);
        Q_EMIT classificationsRegisteredIdentifierTypesGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT classificationsRegisteredIdentifierTypesGetSignalE(output, error_type, error_str);
        Q_EMIT classificationsRegisteredIdentifierTypesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT classificationsRegisteredIdentifierTypesGetSignalError(output, error_type, error_str);
        Q_EMIT classificationsRegisteredIdentifierTypesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIRegisteredIdentifierTypesApi::tokenAvailable(){
