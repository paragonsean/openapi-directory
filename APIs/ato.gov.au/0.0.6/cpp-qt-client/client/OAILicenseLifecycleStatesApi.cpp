...
#include "OAILicenseLifecycleStatesApi.h"
...
OAILicenseLifecycleStatesApi::OAILicenseLifecycleStatesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAILicenseLifecycleStatesApi::~OAILicenseLifecycleStatesApi() {
}

void OAILicenseLifecycleStatesApi::initializeServerConfigs() {
    //Default server
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("classificationsLicenseLifecycleStatesGet", defaultConf);
    _serverIndices.insert("classificationsLicenseLifecycleStatesGet", 0);
}
...
*/
int OAILicenseLifecycleStatesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAILicenseLifecycleStatesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAILicenseLifecycleStatesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAILicenseLifecycleStatesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAILicenseLifecycleStatesApi::setUsername(const QString &username) {
    _username = username;
}

void OAILicenseLifecycleStatesApi::setPassword(const QString &password) {
    _password = password;
}


void OAILicenseLifecycleStatesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAILicenseLifecycleStatesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAILicenseLifecycleStatesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAILicenseLifecycleStatesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILicenseLifecycleStatesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILicenseLifecycleStatesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAILicenseLifecycleStatesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAILicenseLifecycleStatesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAILicenseLifecycleStatesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAILicenseLifecycleStatesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAILicenseLifecycleStatesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAILicenseLifecycleStatesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAILicenseLifecycleStatesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAILicenseLifecycleStatesApi::classificationsLicenseLifecycleStatesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["classificationsLicenseLifecycleStatesGet"][_serverIndices.value("classificationsLicenseLifecycleStatesGet")].URL()+"/classifications/license-lifecycle-states");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILicenseLifecycleStatesApi::classificationsLicenseLifecycleStatesGetCallback);
    connect(this, &OAILicenseLifecycleStatesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAILicenseLifecycleStatesApi::classificationsLicenseLifecycleStatesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAILicense_lifecycle_state> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAILicense_lifecycle_state val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT classificationsLicenseLifecycleStatesGetSignal(output);
        Q_EMIT classificationsLicenseLifecycleStatesGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT classificationsLicenseLifecycleStatesGetSignalE(output, error_type, error_str);
        Q_EMIT classificationsLicenseLifecycleStatesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT classificationsLicenseLifecycleStatesGetSignalError(output, error_type, error_str);
        Q_EMIT classificationsLicenseLifecycleStatesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILicenseLifecycleStatesApi::tokenAvailable(){
