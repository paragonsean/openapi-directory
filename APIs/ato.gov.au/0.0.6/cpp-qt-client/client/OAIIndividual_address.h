...
/*
 * OAIIndividual_address.h
 *
 * 
 */

#ifndef OAIIndividual_address_H
#define OAIIndividual_address_H
...
class OAIIndividual_address : public OAIObject {
public:
    OAIIndividual_address();
    OAIIndividual_address(QString json);
    ~OAIIndividual_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIndividual_address)

#endif // OAIIndividual_address_H
