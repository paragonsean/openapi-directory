...
/*
 * OAIRegistered_identifier_type.h
 *
 * 
 */

#ifndef OAIRegistered_identifier_type_H
#define OAIRegistered_identifier_type_H
...
class OAIRegistered_identifier_type : public OAIObject {
public:
    OAIRegistered_identifier_type();
    OAIRegistered_identifier_type(QString json);
    ~OAIRegistered_identifier_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegistered_identifier_type)

#endif // OAIRegistered_identifier_type_H
