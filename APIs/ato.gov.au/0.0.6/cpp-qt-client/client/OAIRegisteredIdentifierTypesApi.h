...
#ifndef OAI_OAIRegisteredIdentifierTypesApi_H
#define OAI_OAIRegisteredIdentifierTypesApi_H
...
#include "OAIRegistered_identifier_type.h"
...
class OAIRegisteredIdentifierTypesApi : public QObject {
    Q_OBJECT

public:
    OAIRegisteredIdentifierTypesApi(const int timeOut = 0);
    ~OAIRegisteredIdentifierTypesApi();
    ...
    */
    virtual void classificationsRegisteredIdentifierTypesGet(const QString &api_key);
...
private:
    ...
    void classificationsRegisteredIdentifierTypesGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsRegisteredIdentifierTypesGetSignal(QList<OAIRegistered_identifier_type> summary);


    void classificationsRegisteredIdentifierTypesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIRegistered_identifier_type> summary);

    Q_DECL_DEPRECATED_X("Use classificationsRegisteredIdentifierTypesGetSignalError() instead")
    void classificationsRegisteredIdentifierTypesGetSignalE(QList<OAIRegistered_identifier_type> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsRegisteredIdentifierTypesGetSignalError(QList<OAIRegistered_identifier_type> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsRegisteredIdentifierTypesGetSignalErrorFull() instead")
    void classificationsRegisteredIdentifierTypesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsRegisteredIdentifierTypesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
