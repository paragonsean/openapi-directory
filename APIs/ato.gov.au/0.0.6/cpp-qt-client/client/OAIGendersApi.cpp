...
OAIGendersApi::OAIGendersApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIGendersApi::~OAIGendersApi() {
}

void OAIGendersApi::initializeServerConfigs() {
    //Default server
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("classificationsGendersGet", defaultConf);
    _serverIndices.insert("classificationsGendersGet", 0);
}
...
*/
int OAIGendersApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIGendersApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIGendersApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIGendersApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIGendersApi::setUsername(const QString &username) {
    _username = username;
}

void OAIGendersApi::setPassword(const QString &password) {
    _password = password;
}


void OAIGendersApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIGendersApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIGendersApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIGendersApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIGendersApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIGendersApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIGendersApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIGendersApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIGendersApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIGendersApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIGendersApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIGendersApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIGendersApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIGendersApi::classificationsGendersGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["classificationsGendersGet"][_serverIndices.value("classificationsGendersGet")].URL()+"/classifications/genders");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGendersApi::classificationsGendersGetCallback);
    connect(this, &OAIGendersApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIGendersApi::classificationsGendersGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT classificationsGendersGetSignal(output);
        Q_EMIT classificationsGendersGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT classificationsGendersGetSignalE(output, error_type, error_str);
        Q_EMIT classificationsGendersGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT classificationsGendersGetSignalError(output, error_type, error_str);
        Q_EMIT classificationsGendersGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGendersApi::tokenAvailable(){
