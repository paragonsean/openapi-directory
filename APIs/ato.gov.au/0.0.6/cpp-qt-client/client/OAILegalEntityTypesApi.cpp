...
#include "OAILegalEntityTypesApi.h"
...
OAILegalEntityTypesApi::OAILegalEntityTypesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAILegalEntityTypesApi::~OAILegalEntityTypesApi() {
}

void OAILegalEntityTypesApi::initializeServerConfigs() {
    //Default server
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("classificationsLegalEntityTypesGet", defaultConf);
    _serverIndices.insert("classificationsLegalEntityTypesGet", 0);
}
...
*/
int OAILegalEntityTypesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAILegalEntityTypesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAILegalEntityTypesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAILegalEntityTypesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAILegalEntityTypesApi::setUsername(const QString &username) {
    _username = username;
}

void OAILegalEntityTypesApi::setPassword(const QString &password) {
    _password = password;
}


void OAILegalEntityTypesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAILegalEntityTypesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAILegalEntityTypesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAILegalEntityTypesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILegalEntityTypesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILegalEntityTypesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAILegalEntityTypesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAILegalEntityTypesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAILegalEntityTypesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAILegalEntityTypesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAILegalEntityTypesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAILegalEntityTypesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAILegalEntityTypesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAILegalEntityTypesApi::classificationsLegalEntityTypesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["classificationsLegalEntityTypesGet"][_serverIndices.value("classificationsLegalEntityTypesGet")].URL()+"/classifications/legal-entity-types");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILegalEntityTypesApi::classificationsLegalEntityTypesGetCallback);
    connect(this, &OAILegalEntityTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAILegalEntityTypesApi::classificationsLegalEntityTypesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAILegal_entity_type> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAILegal_entity_type val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT classificationsLegalEntityTypesGetSignal(output);
        Q_EMIT classificationsLegalEntityTypesGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT classificationsLegalEntityTypesGetSignalE(output, error_type, error_str);
        Q_EMIT classificationsLegalEntityTypesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT classificationsLegalEntityTypesGetSignalError(output, error_type, error_str);
        Q_EMIT classificationsLegalEntityTypesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILegalEntityTypesApi::tokenAvailable(){
