...
OAIAddressId::OAIAddressId(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddressId::OAIAddressId() {
    this->initializeModel();
}

OAIAddressId::~OAIAddressId() {}

void OAIAddressId::initializeModel() {

}

void OAIAddressId::fromJson(QString jsonString) {
...
void OAIAddressId::fromJsonObject(QJsonObject json) {

}

QString OAIAddressId::asJson() const {
...
QJsonObject OAIAddressId::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAIAddressId::isSet() const {
...
bool OAIAddressId::isValid() const {
