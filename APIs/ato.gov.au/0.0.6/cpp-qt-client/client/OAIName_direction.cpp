...
OAIName_direction::OAIName_direction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIName_direction::OAIName_direction() {
    this->initializeModel();
}

OAIName_direction::~OAIName_direction() {}

void OAIName_direction::initializeModel() {
...
void OAIName_direction::fromJson(QString jsonString) {
...
void OAIName_direction::fromJsonObject(QJsonObject json) {
...
QString OAIName_direction::asJson() const {
...
QJsonObject OAIName_direction::asJsonObject() const {
    QJsonObject obj;
...
QString OAIName_direction::getDescription() const {
    return m_description;
}
void OAIName_direction::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIName_direction::is_description_Set() const{
    return m_description_isSet;
}

bool OAIName_direction::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIName_direction::getId() const {
    return m_id;
}
void OAIName_direction::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIName_direction::is_id_Set() const{
    return m_id_isSet;
}

bool OAIName_direction::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIName_direction::getName() const {
    return m_name;
}
void OAIName_direction::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIName_direction::is_name_Set() const{
    return m_name_isSet;
}

bool OAIName_direction::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIName_direction::isSet() const {
...
bool OAIName_direction::isValid() const {
