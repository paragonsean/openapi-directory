...
QString OAIUnauthenticated::getCode() const {
    return m_code;
}
void OAIUnauthenticated::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIUnauthenticated::is_code_Set() const{
    return m_code_isSet;
}

bool OAIUnauthenticated::is_code_Valid() const{
    return m_code_isValid;
}

OAIError_details OAIUnauthenticated::getDetails() const {
    return m_details;
}
void OAIUnauthenticated::setDetails(const OAIError_details &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIUnauthenticated::is_details_Set() const{
    return m_details_isSet;
}

bool OAIUnauthenticated::is_details_Valid() const{
    return m_details_isValid;
}

QString OAIUnauthenticated::getMessage() const {
    return m_message;
}
void OAIUnauthenticated::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIUnauthenticated::is_message_Set() const{
    return m_message_isSet;
}

bool OAIUnauthenticated::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIUnauthenticated::getStatus() const {
    return m_status;
}
void OAIUnauthenticated::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUnauthenticated::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUnauthenticated::is_status_Valid() const{
