...
QString OAIType::getDescription() const {
    return m_description;
}
void OAIType::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIType::is_description_Set() const{
    return m_description_isSet;
}

bool OAIType::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIType::getId() const {
    return m_id;
}
void OAIType::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIType::is_id_Set() const{
    return m_id_isSet;
}

bool OAIType::is_id_Valid() const{
    return m_id_isValid;
}
