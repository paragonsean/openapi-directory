...
#ifndef OAI_OAIGendersApi_H
#define OAI_OAIGendersApi_H
...
class OAIGendersApi : public QObject {
    Q_OBJECT

public:
    OAIGendersApi(const int timeOut = 0);
    ~OAIGendersApi();
    ...
    */
    virtual void classificationsGendersGet(const QString &api_key);
...
private:
    ...
    void classificationsGendersGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsGendersGetSignal(QList<OAIGender> summary);


    void classificationsGendersGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIGender> summary);

    Q_DECL_DEPRECATED_X("Use classificationsGendersGetSignalError() instead")
    void classificationsGendersGetSignalE(QList<OAIGender> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsGendersGetSignalError(QList<OAIGender> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsGendersGetSignalErrorFull() instead")
    void classificationsGendersGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsGendersGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
