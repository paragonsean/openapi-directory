...
OAIAddress_type::OAIAddress_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddress_type::OAIAddress_type() {
    this->initializeModel();
}

OAIAddress_type::~OAIAddress_type() {}

void OAIAddress_type::initializeModel() {
...
void OAIAddress_type::fromJson(QString jsonString) {
...
void OAIAddress_type::fromJsonObject(QJsonObject json) {
...
QString OAIAddress_type::asJson() const {
...
QJsonObject OAIAddress_type::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddress_type::getDescription() const {
    return m_description;
}
void OAIAddress_type::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIAddress_type::is_description_Set() const{
    return m_description_isSet;
}

bool OAIAddress_type::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIAddress_type::getId() const {
    return m_id;
}
void OAIAddress_type::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAddress_type::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAddress_type::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAddress_type::getName() const {
    return m_name;
}
void OAIAddress_type::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAddress_type::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAddress_type::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIAddress_type::isSet() const {
...
bool OAIAddress_type::isValid() const {
