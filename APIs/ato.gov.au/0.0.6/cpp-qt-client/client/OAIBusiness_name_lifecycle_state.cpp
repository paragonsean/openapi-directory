...
OAIBusiness_name_lifecycle_state::OAIBusiness_name_lifecycle_state(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBusiness_name_lifecycle_state::OAIBusiness_name_lifecycle_state() {
    this->initializeModel();
}

OAIBusiness_name_lifecycle_state::~OAIBusiness_name_lifecycle_state() {}

void OAIBusiness_name_lifecycle_state::initializeModel() {
...
void OAIBusiness_name_lifecycle_state::fromJson(QString jsonString) {
...
void OAIBusiness_name_lifecycle_state::fromJsonObject(QJsonObject json) {
...
QString OAIBusiness_name_lifecycle_state::asJson() const {
...
QJsonObject OAIBusiness_name_lifecycle_state::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBusiness_name_lifecycle_state::getDescription() const {
    return m_description;
}
void OAIBusiness_name_lifecycle_state::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIBusiness_name_lifecycle_state::is_description_Set() const{
    return m_description_isSet;
}

bool OAIBusiness_name_lifecycle_state::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIBusiness_name_lifecycle_state::getId() const {
    return m_id;
}
void OAIBusiness_name_lifecycle_state::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBusiness_name_lifecycle_state::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBusiness_name_lifecycle_state::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIBusiness_name_lifecycle_state::getName() const {
    return m_name;
}
void OAIBusiness_name_lifecycle_state::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIBusiness_name_lifecycle_state::is_name_Set() const{
    return m_name_isSet;
}

bool OAIBusiness_name_lifecycle_state::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIBusiness_name_lifecycle_state::isSet() const {
...
bool OAIBusiness_name_lifecycle_state::isValid() const {
