...
QDateTime OAIAddress::getFromDate() const {
    return m_from_date;
}
void OAIAddress::setFromDate(const QDateTime &from_date) {
    m_from_date = from_date;
    m_from_date_isSet = true;
}

bool OAIAddress::is_from_date_Set() const{
    return m_from_date_isSet;
}

bool OAIAddress::is_from_date_Valid() const{
    return m_from_date_isValid;
}

OAIAddressId OAIAddress::getId() const {
    return m_id;
}
void OAIAddress::setId(const OAIAddressId &id) {
    m_id = id;
    m_id_isSet = true;
}
...
bool OAIAddress::is_suburb_Set() const{
    return m_suburb_isSet;
}

bool OAIAddress::is_suburb_Valid() const{
    return m_suburb_isValid;
}

QDateTime OAIAddress::getToDate() const {
    return m_to_date;
}
void OAIAddress::setToDate(const QDateTime &to_date) {
    m_to_date = to_date;
    m_to_date_isSet = true;
}

bool OAIAddress::is_to_date_Set() const{
    return m_to_date_isSet;
}

bool OAIAddress::is_to_date_Valid() const{
