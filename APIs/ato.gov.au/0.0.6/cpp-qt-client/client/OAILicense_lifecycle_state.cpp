...
OAILicense_lifecycle_state::OAILicense_lifecycle_state(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILicense_lifecycle_state::OAILicense_lifecycle_state() {
    this->initializeModel();
}

OAILicense_lifecycle_state::~OAILicense_lifecycle_state() {}

void OAILicense_lifecycle_state::initializeModel() {
...
void OAILicense_lifecycle_state::fromJson(QString jsonString) {
...
void OAILicense_lifecycle_state::fromJsonObject(QJsonObject json) {
...
QString OAILicense_lifecycle_state::asJson() const {
...
QJsonObject OAILicense_lifecycle_state::asJsonObject() const {
    QJsonObject obj;
...
QString OAILicense_lifecycle_state::getDescription() const {
    return m_description;
}
void OAILicense_lifecycle_state::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAILicense_lifecycle_state::is_description_Set() const{
    return m_description_isSet;
}

bool OAILicense_lifecycle_state::is_description_Valid() const{
    return m_description_isValid;
}

QString OAILicense_lifecycle_state::getId() const {
    return m_id;
}
void OAILicense_lifecycle_state::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILicense_lifecycle_state::is_id_Set() const{
    return m_id_isSet;
}

bool OAILicense_lifecycle_state::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILicense_lifecycle_state::getName() const {
    return m_name;
}
void OAILicense_lifecycle_state::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILicense_lifecycle_state::is_name_Set() const{
    return m_name_isSet;
}

bool OAILicense_lifecycle_state::is_name_Valid() const{
    return m_name_isValid;
}

bool OAILicense_lifecycle_state::isSet() const {
...
bool OAILicense_lifecycle_state::isValid() const {
