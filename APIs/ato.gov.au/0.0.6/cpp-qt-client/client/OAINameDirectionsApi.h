...
#ifndef OAI_OAINameDirectionsApi_H
#define OAI_OAINameDirectionsApi_H
...
class OAINameDirectionsApi : public QObject {
    Q_OBJECT

public:
    OAINameDirectionsApi(const int timeOut = 0);
    ~OAINameDirectionsApi();
    ...
    */
    virtual void classificationsNameDirectionsGet(const QString &api_key);
...
private:
    ...
    void classificationsNameDirectionsGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsNameDirectionsGetSignal(QList<OAIName_direction> summary);


    void classificationsNameDirectionsGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIName_direction> summary);

    Q_DECL_DEPRECATED_X("Use classificationsNameDirectionsGetSignalError() instead")
    void classificationsNameDirectionsGetSignalE(QList<OAIName_direction> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsNameDirectionsGetSignalError(QList<OAIName_direction> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsNameDirectionsGetSignalErrorFull() instead")
    void classificationsNameDirectionsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsNameDirectionsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
