...
/*
 * OAIElectronic_address.h
 *
 * The Electronic Address resource.
 */

#ifndef OAIElectronic_address_H
#define OAIElectronic_address_H
...
class OAIElectronic_address : public OAIObject {
public:
    OAIElectronic_address();
    OAIElectronic_address(QString json);
    ~OAIElectronic_address() override;
    ...
    QString getElectronicAddressType() const;
    void setElectronicAddressType(const QString &electronic_address_type);
    bool is_electronic_address_type_Set() const;
    bool is_electronic_address_type_Valid() const;
...
private:
    ...
    QString m_electronic_address_type;
    bool m_electronic_address_type_isSet;
    bool m_electronic_address_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIElectronic_address)

#endif // OAIElectronic_address_H
