...
#ifndef OAIName_type_H
#define OAIName_type_H
...
class OAIName_type : public OAIObject {
public:
    OAIName_type();
    OAIName_type(QString json);
    ~OAIName_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIName_type)

#endif // OAIName_type_H
