...
/*
 * OAIPermission_denied.h
 *
 * 
 */

#ifndef OAIPermission_denied_H
#define OAIPermission_denied_H
...
namespace OpenAPI {
class OAIError_details;

class OAIPermission_denied : public OAIObject {
public:
    OAIPermission_denied();
    OAIPermission_denied(QString json);
    ~OAIPermission_denied() override;
    ...
    QList<OAIError_details> getDetails() const;
    void setDetails(const QList<OAIError_details> &details);
...
private:
    ...
    QList<OAIError_details> m_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPermission_denied)

#endif // OAIPermission_denied_H
