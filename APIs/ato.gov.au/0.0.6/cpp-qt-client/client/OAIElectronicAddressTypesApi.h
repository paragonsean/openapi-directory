...
#ifndef OAI_OAIElectronicAddressTypesApi_H
#define OAI_OAIElectronicAddressTypesApi_H
...
class OAIElectronicAddressTypesApi : public QObject {
    Q_OBJECT

public:
    OAIElectronicAddressTypesApi(const int timeOut = 0);
    ~OAIElectronicAddressTypesApi();
    ...
    */
    virtual void classificationsElectronicAddressTypesGet(const QString &api_key);
...
private:
    ...
    void classificationsElectronicAddressTypesGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsElectronicAddressTypesGetSignal(QList<OAIElectronic_address_type> summary);


    void classificationsElectronicAddressTypesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIElectronic_address_type> summary);

    Q_DECL_DEPRECATED_X("Use classificationsElectronicAddressTypesGetSignalError() instead")
    void classificationsElectronicAddressTypesGetSignalE(QList<OAIElectronic_address_type> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsElectronicAddressTypesGetSignalError(QList<OAIElectronic_address_type> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsElectronicAddressTypesGetSignalErrorFull() instead")
    void classificationsElectronicAddressTypesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsElectronicAddressTypesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
