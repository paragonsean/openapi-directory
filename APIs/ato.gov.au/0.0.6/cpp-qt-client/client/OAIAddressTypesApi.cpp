...
OAIAddressTypesApi::OAIAddressTypesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIAddressTypesApi::~OAIAddressTypesApi() {
}

void OAIAddressTypesApi::initializeServerConfigs() {
    //Default server
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("classificationsAddressTypesGet", defaultConf);
    _serverIndices.insert("classificationsAddressTypesGet", 0);
}
...
*/
int OAIAddressTypesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIAddressTypesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIAddressTypesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIAddressTypesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIAddressTypesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIAddressTypesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIAddressTypesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIAddressTypesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIAddressTypesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIAddressTypesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAddressTypesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAddressTypesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIAddressTypesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIAddressTypesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIAddressTypesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIAddressTypesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIAddressTypesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIAddressTypesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIAddressTypesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIAddressTypesApi::classificationsAddressTypesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["classificationsAddressTypesGet"][_serverIndices.value("classificationsAddressTypesGet")].URL()+"/classifications/address-types");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAddressTypesApi::classificationsAddressTypesGetCallback);
    connect(this, &OAIAddressTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIAddressTypesApi::classificationsAddressTypesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT classificationsAddressTypesGetSignal(output);
        Q_EMIT classificationsAddressTypesGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT classificationsAddressTypesGetSignalE(output, error_type, error_str);
        Q_EMIT classificationsAddressTypesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT classificationsAddressTypesGetSignalError(output, error_type, error_str);
        Q_EMIT classificationsAddressTypesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAddressTypesApi::tokenAvailable(){
