...
OAIOrganisation_name::OAIOrganisation_name(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganisation_name::OAIOrganisation_name() {
    this->initializeModel();
}

OAIOrganisation_name::~OAIOrganisation_name() {}

void OAIOrganisation_name::initializeModel() {
...
void OAIOrganisation_name::fromJson(QString jsonString) {
...
void OAIOrganisation_name::fromJsonObject(QJsonObject json) {
...
QString OAIOrganisation_name::asJson() const {
...
QJsonObject OAIOrganisation_name::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIOrganisation_name::getFromDate() const {
    return m_from_date;
}
void OAIOrganisation_name::setFromDate(const QDateTime &from_date) {
    m_from_date = from_date;
    m_from_date_isSet = true;
}

bool OAIOrganisation_name::is_from_date_Set() const{
    return m_from_date_isSet;
}

bool OAIOrganisation_name::is_from_date_Valid() const{
    return m_from_date_isValid;
}

QString OAIOrganisation_name::getId() const {
    return m_id;
}
void OAIOrganisation_name::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOrganisation_name::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOrganisation_name::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIOrganisation_name::getName() const {
    return m_name;
}
void OAIOrganisation_name::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIOrganisation_name::is_name_Set() const{
    return m_name_isSet;
}

bool OAIOrganisation_name::is_name_Valid() const{
    return m_name_isValid;
}

QDateTime OAIOrganisation_name::getToDate() const {
    return m_to_date;
}
void OAIOrganisation_name::setToDate(const QDateTime &to_date) {
    m_to_date = to_date;
    m_to_date_isSet = true;
}

bool OAIOrganisation_name::is_to_date_Set() const{
    return m_to_date_isSet;
}

bool OAIOrganisation_name::is_to_date_Valid() const{
    return m_to_date_isValid;
}

bool OAIOrganisation_name::isSet() const {
...
bool OAIOrganisation_name::isValid() const {
