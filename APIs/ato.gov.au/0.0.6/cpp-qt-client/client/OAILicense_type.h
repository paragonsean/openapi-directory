...
#ifndef OAILicense_type_H
#define OAILicense_type_H
...
class OAILicense_type : public OAIObject {
public:
    OAILicense_type();
    OAILicense_type(QString json);
    ~OAILicense_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicense_type)

#endif // OAILicense_type_H
