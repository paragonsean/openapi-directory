...
#ifndef OAI_OAILegalEntityTypesApi_H
#define OAI_OAILegalEntityTypesApi_H
...
class OAILegalEntityTypesApi : public QObject {
    Q_OBJECT

public:
    OAILegalEntityTypesApi(const int timeOut = 0);
    ~OAILegalEntityTypesApi();
    ...
    */
    virtual void classificationsLegalEntityTypesGet(const QString &api_key);
...
private:
    ...
    void classificationsLegalEntityTypesGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsLegalEntityTypesGetSignal(QList<OAILegal_entity_type> summary);


    void classificationsLegalEntityTypesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAILegal_entity_type> summary);

    Q_DECL_DEPRECATED_X("Use classificationsLegalEntityTypesGetSignalError() instead")
    void classificationsLegalEntityTypesGetSignalE(QList<OAILegal_entity_type> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsLegalEntityTypesGetSignalError(QList<OAILegal_entity_type> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsLegalEntityTypesGetSignalErrorFull() instead")
    void classificationsLegalEntityTypesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsLegalEntityTypesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
