...
public:
    ...
    */
    virtual void licensesGet(const QString &api_key);
...
Q_SIGNALS:
    ...
    void licensesGetSignal(QList<OAILicense> summary);


    void licensesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAILicense> summary);

    Q_DECL_DEPRECATED_X("Use licensesGetSignalError() instead")
    void licensesGetSignalE(QList<OAILicense> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void licensesGetSignalError(QList<OAILicense> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
