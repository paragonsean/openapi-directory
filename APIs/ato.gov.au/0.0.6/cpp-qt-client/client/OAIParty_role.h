...
#ifndef OAIParty_role_H
#define OAIParty_role_H
...
class OAIParty_role : public OAIObject {
public:
    OAIParty_role();
    OAIParty_role(QString json);
    ~OAIParty_role() override;
    ...
    OAIRoleId getId() const;
    void setId(const OAIRoleId &id);
    bool is_id_Set() const;
    bool is_id_Valid() const;

    QString getPartyRoleType() const;
    void setPartyRoleType(const QString &party_role_type);
    bool is_party_role_type_Set() const;
    bool is_party_role_type_Valid() const;

    OAIPartyId getRelatedPartyId() const;
    void setRelatedPartyId(const OAIPartyId &related_party_id);
    bool is_related_party_id_Set() const;
    bool is_related_party_id_Valid() const;

    QString getRelatedPartyRoleType() const;
    void setRelatedPartyRoleType(const QString &related_party_role_type);
    bool is_related_party_role_type_Set() const;
    bool is_related_party_role_type_Valid() const;
...
private:
    ...
    QString m_party_role_type;
    bool m_party_role_type_isSet;
    bool m_party_role_type_isValid;

    OAIPartyId m_related_party_id;
    bool m_related_party_id_isSet;
    bool m_related_party_id_isValid;

    QString m_related_party_role_type;
    bool m_related_party_role_type_isSet;
    bool m_related_party_role_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParty_role)

#endif // OAIParty_role_H
