...
void OAILicensesApi::licensesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["licensesGet"][_serverIndices.value("licensesGet")].URL()+"/licenses");
