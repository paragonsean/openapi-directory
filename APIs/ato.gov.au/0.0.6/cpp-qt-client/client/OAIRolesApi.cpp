...
void OAIRolesApi::initializeServerConfigs() {
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("classificationsRolesGet", defaultConf);
    _serverIndices.insert("classificationsRolesGet", 0);
}
...
void OAIRolesApi::classificationsRolesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["classificationsRolesGet"][_serverIndices.value("classificationsRolesGet")].URL()+"/classifications/roles");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRolesApi::classificationsRolesGetCallback);
...
void OAIRolesApi::classificationsRolesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT classificationsRolesGetSignal(output);
        Q_EMIT classificationsRolesGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT classificationsRolesGetSignalE(output, error_type, error_str);
        Q_EMIT classificationsRolesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT classificationsRolesGetSignalError(output, error_type, error_str);
        Q_EMIT classificationsRolesGetSignalErrorFull(worker, error_type, error_str);
    }
}
