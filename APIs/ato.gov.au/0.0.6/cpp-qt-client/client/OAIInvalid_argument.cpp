...
OAIInvalid_argument::OAIInvalid_argument(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInvalid_argument::OAIInvalid_argument() {
    this->initializeModel();
}

OAIInvalid_argument::~OAIInvalid_argument() {}

void OAIInvalid_argument::initializeModel() {
...
void OAIInvalid_argument::fromJson(QString jsonString) {
...
void OAIInvalid_argument::fromJsonObject(QJsonObject json) {
...
QString OAIInvalid_argument::asJson() const {
...
QJsonObject OAIInvalid_argument::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIInvalid_argument::getCode() const {
    return m_code;
}
void OAIInvalid_argument::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIInvalid_argument::is_code_Set() const{
    return m_code_isSet;
}

bool OAIInvalid_argument::is_code_Valid() const{
    return m_code_isValid;
}

QList<OAIError_details> OAIInvalid_argument::getDetails() const {
    return m_details;
}
void OAIInvalid_argument::setDetails(const QList<OAIError_details> &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIInvalid_argument::is_details_Set() const{
    return m_details_isSet;
}

bool OAIInvalid_argument::is_details_Valid() const{
    return m_details_isValid;
}

QString OAIInvalid_argument::getMessage() const {
    return m_message;
}
void OAIInvalid_argument::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIInvalid_argument::is_message_Set() const{
    return m_message_isSet;
}

bool OAIInvalid_argument::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIInvalid_argument::getStatus() const {
    return m_status;
}
void OAIInvalid_argument::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIInvalid_argument::is_status_Set() const{
    return m_status_isSet;
}

bool OAIInvalid_argument::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIInvalid_argument::isSet() const {
...
bool OAIInvalid_argument::isValid() const {
