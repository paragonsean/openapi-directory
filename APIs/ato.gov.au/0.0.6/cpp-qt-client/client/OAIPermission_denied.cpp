...
#include "OAIPermission_denied.h"
...
OAIPermission_denied::OAIPermission_denied(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPermission_denied::OAIPermission_denied() {
    this->initializeModel();
}

OAIPermission_denied::~OAIPermission_denied() {}

void OAIPermission_denied::initializeModel() {
...
void OAIPermission_denied::fromJson(QString jsonString) {
...
void OAIPermission_denied::fromJsonObject(QJsonObject json) {
...
QString OAIPermission_denied::asJson() const {
...
QJsonObject OAIPermission_denied::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIPermission_denied::getCode() const {
    return m_code;
}
void OAIPermission_denied::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIPermission_denied::is_code_Set() const{
    return m_code_isSet;
}

bool OAIPermission_denied::is_code_Valid() const{
    return m_code_isValid;
}

QList<OAIError_details> OAIPermission_denied::getDetails() const {
    return m_details;
}
void OAIPermission_denied::setDetails(const QList<OAIError_details> &details) {
    m_details = details;
    m_details_isSet = true;
}

bool OAIPermission_denied::is_details_Set() const{
    return m_details_isSet;
}

bool OAIPermission_denied::is_details_Valid() const{
    return m_details_isValid;
}

QString OAIPermission_denied::getMessage() const {
    return m_message;
}
void OAIPermission_denied::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIPermission_denied::is_message_Set() const{
    return m_message_isSet;
}

bool OAIPermission_denied::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIPermission_denied::getStatus() const {
    return m_status;
}
void OAIPermission_denied::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPermission_denied::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPermission_denied::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIPermission_denied::isSet() const {
...
bool OAIPermission_denied::isValid() const {
