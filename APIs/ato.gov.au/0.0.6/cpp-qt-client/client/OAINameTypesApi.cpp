...
OAINameTypesApi::OAINameTypesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAINameTypesApi::~OAINameTypesApi() {
}

void OAINameTypesApi::initializeServerConfigs() {
    //Default server
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("classificationsNameTypesGet", defaultConf);
    _serverIndices.insert("classificationsNameTypesGet", 0);
}
...
*/
int OAINameTypesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAINameTypesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAINameTypesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAINameTypesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAINameTypesApi::setUsername(const QString &username) {
    _username = username;
}

void OAINameTypesApi::setPassword(const QString &password) {
    _password = password;
}


void OAINameTypesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAINameTypesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAINameTypesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAINameTypesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAINameTypesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAINameTypesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAINameTypesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAINameTypesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAINameTypesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAINameTypesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAINameTypesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAINameTypesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAINameTypesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAINameTypesApi::classificationsNameTypesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["classificationsNameTypesGet"][_serverIndices.value("classificationsNameTypesGet")].URL()+"/classifications/name-types");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINameTypesApi::classificationsNameTypesGetCallback);
    connect(this, &OAINameTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAINameTypesApi::classificationsNameTypesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT classificationsNameTypesGetSignal(output);
        Q_EMIT classificationsNameTypesGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT classificationsNameTypesGetSignalE(output, error_type, error_str);
        Q_EMIT classificationsNameTypesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT classificationsNameTypesGetSignalError(output, error_type, error_str);
        Q_EMIT classificationsNameTypesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAINameTypesApi::tokenAvailable(){
