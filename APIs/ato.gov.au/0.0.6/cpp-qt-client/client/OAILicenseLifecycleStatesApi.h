...
#ifndef OAI_OAILicenseLifecycleStatesApi_H
#define OAI_OAILicenseLifecycleStatesApi_H
...
#include "OAILicense_lifecycle_state.h"
...
class OAILicenseLifecycleStatesApi : public QObject {
    Q_OBJECT

public:
    OAILicenseLifecycleStatesApi(const int timeOut = 0);
    ~OAILicenseLifecycleStatesApi();
    ...
    */
    virtual void classificationsLicenseLifecycleStatesGet(const QString &api_key);
...
private:
    ...
    void classificationsLicenseLifecycleStatesGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsLicenseLifecycleStatesGetSignal(QList<OAILicense_lifecycle_state> summary);


    void classificationsLicenseLifecycleStatesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAILicense_lifecycle_state> summary);

    Q_DECL_DEPRECATED_X("Use classificationsLicenseLifecycleStatesGetSignalError() instead")
    void classificationsLicenseLifecycleStatesGetSignalE(QList<OAILicense_lifecycle_state> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsLicenseLifecycleStatesGetSignalError(QList<OAILicense_lifecycle_state> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsLicenseLifecycleStatesGetSignalErrorFull() instead")
    void classificationsLicenseLifecycleStatesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsLicenseLifecycleStatesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
