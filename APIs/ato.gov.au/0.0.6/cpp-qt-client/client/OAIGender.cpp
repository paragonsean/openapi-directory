...
QString OAIGender::getGender() const {
    return m_gender;
}
void OAIGender::setGender(const QString &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAIGender::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAIGender::is_gender_Valid() const{
    return m_gender_isValid;
}

QString OAIGender::getId() const {
    return m_id;
}
void OAIGender::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGender::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGender::is_id_Valid() const{
    return m_id_isValid;
}
