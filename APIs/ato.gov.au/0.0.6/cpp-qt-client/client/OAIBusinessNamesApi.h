...
#ifndef OAI_OAIBusinessNamesApi_H
#define OAI_OAIBusinessNamesApi_H
...
class OAIBusinessNamesApi : public QObject {
    Q_OBJECT

public:
    OAIBusinessNamesApi(const int timeOut = 0);
    ~OAIBusinessNamesApi();
    ...
    */
    virtual void businessNamesGet(const QString &api_key);
...
private:
    ...
    void businessNamesGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void businessNamesGetSignal(QList<OAIBusiness_name> summary);


    void businessNamesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIBusiness_name> summary);

    Q_DECL_DEPRECATED_X("Use businessNamesGetSignalError() instead")
    void businessNamesGetSignalE(QList<OAIBusiness_name> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void businessNamesGetSignalError(QList<OAIBusiness_name> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use businessNamesGetSignalErrorFull() instead")
    void businessNamesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void businessNamesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
