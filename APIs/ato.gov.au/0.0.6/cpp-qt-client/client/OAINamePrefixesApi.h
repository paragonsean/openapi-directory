...
#ifndef OAI_OAINamePrefixesApi_H
#define OAI_OAINamePrefixesApi_H
...
class OAINamePrefixesApi : public QObject {
    Q_OBJECT

public:
    OAINamePrefixesApi(const int timeOut = 0);
    ~OAINamePrefixesApi();
    ...
    */
    virtual void classificationsNamePrefixesGet(const QString &api_key);
...
private:
    ...
    void classificationsNamePrefixesGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsNamePrefixesGetSignal(QList<OAIName_prefix> summary);


    void classificationsNamePrefixesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIName_prefix> summary);

    Q_DECL_DEPRECATED_X("Use classificationsNamePrefixesGetSignalError() instead")
    void classificationsNamePrefixesGetSignalE(QList<OAIName_prefix> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsNamePrefixesGetSignalError(QList<OAIName_prefix> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsNamePrefixesGetSignalErrorFull() instead")
    void classificationsNamePrefixesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsNamePrefixesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
