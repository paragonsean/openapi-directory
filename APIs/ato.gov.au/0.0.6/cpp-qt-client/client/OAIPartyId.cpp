...
OAIPartyId::OAIPartyId(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPartyId::OAIPartyId() {
    this->initializeModel();
}

OAIPartyId::~OAIPartyId() {}

void OAIPartyId::initializeModel() {

}

void OAIPartyId::fromJson(QString jsonString) {
...
void OAIPartyId::fromJsonObject(QJsonObject json) {

}

QString OAIPartyId::asJson() const {
...
QJsonObject OAIPartyId::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAIPartyId::isSet() const {
