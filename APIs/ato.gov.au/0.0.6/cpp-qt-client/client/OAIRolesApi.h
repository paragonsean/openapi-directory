...
public:
    ...
    */
    virtual void classificationsRolesGet(const QString &api_key);
...
private:
    ...
    void classificationsRolesGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsRolesGetSignal(QList<OAIRole> summary);


    void classificationsRolesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIRole> summary);

    Q_DECL_DEPRECATED_X("Use classificationsRolesGetSignalError() instead")
    void classificationsRolesGetSignalE(QList<OAIRole> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsRolesGetSignalError(QList<OAIRole> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsRolesGetSignalErrorFull() instead")
    void classificationsRolesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsRolesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
