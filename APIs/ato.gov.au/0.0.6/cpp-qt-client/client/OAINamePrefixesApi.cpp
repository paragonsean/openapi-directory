...
OAINamePrefixesApi::OAINamePrefixesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAINamePrefixesApi::~OAINamePrefixesApi() {
}

void OAINamePrefixesApi::initializeServerConfigs() {
    //Default server
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("classificationsNamePrefixesGet", defaultConf);
    _serverIndices.insert("classificationsNamePrefixesGet", 0);
}
...
*/
int OAINamePrefixesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAINamePrefixesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAINamePrefixesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAINamePrefixesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAINamePrefixesApi::setUsername(const QString &username) {
    _username = username;
}

void OAINamePrefixesApi::setPassword(const QString &password) {
    _password = password;
}


void OAINamePrefixesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAINamePrefixesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAINamePrefixesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAINamePrefixesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAINamePrefixesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAINamePrefixesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAINamePrefixesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAINamePrefixesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAINamePrefixesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAINamePrefixesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAINamePrefixesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAINamePrefixesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAINamePrefixesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAINamePrefixesApi::classificationsNamePrefixesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["classificationsNamePrefixesGet"][_serverIndices.value("classificationsNamePrefixesGet")].URL()+"/classifications/name-prefixes");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINamePrefixesApi::classificationsNamePrefixesGetCallback);
    connect(this, &OAINamePrefixesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAINamePrefixesApi::classificationsNamePrefixesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT classificationsNamePrefixesGetSignal(output);
        Q_EMIT classificationsNamePrefixesGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT classificationsNamePrefixesGetSignalE(output, error_type, error_str);
        Q_EMIT classificationsNamePrefixesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT classificationsNamePrefixesGetSignalError(output, error_type, error_str);
        Q_EMIT classificationsNamePrefixesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAINamePrefixesApi::tokenAvailable(){
