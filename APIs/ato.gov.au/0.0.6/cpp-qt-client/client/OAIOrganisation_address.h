...
/*
 * OAIOrganisation_address.h
 *
 * 
 */

#ifndef OAIOrganisation_address_H
#define OAIOrganisation_address_H
...
class OAIOrganisation_address : public OAIObject {
public:
    OAIOrganisation_address();
    OAIOrganisation_address(QString json);
    ~OAIOrganisation_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganisation_address)

#endif // OAIOrganisation_address_H
