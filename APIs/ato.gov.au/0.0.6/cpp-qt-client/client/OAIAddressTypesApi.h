...
#ifndef OAI_OAIAddressTypesApi_H
#define OAI_OAIAddressTypesApi_H
...
class OAIAddressTypesApi : public QObject {
    Q_OBJECT

public:
    OAIAddressTypesApi(const int timeOut = 0);
    ~OAIAddressTypesApi();
    ...
    */
    virtual void classificationsAddressTypesGet(const QString &api_key);
...
private:
    ...
    void classificationsAddressTypesGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsAddressTypesGetSignal(QList<OAIAddress_type> summary);


    void classificationsAddressTypesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIAddress_type> summary);

    Q_DECL_DEPRECATED_X("Use classificationsAddressTypesGetSignalError() instead")
    void classificationsAddressTypesGetSignalE(QList<OAIAddress_type> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsAddressTypesGetSignalError(QList<OAIAddress_type> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsAddressTypesGetSignalErrorFull() instead")
    void classificationsAddressTypesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsAddressTypesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
