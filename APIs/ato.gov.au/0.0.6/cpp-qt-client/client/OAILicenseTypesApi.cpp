...
OAILicenseTypesApi::OAILicenseTypesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAILicenseTypesApi::~OAILicenseTypesApi() {
}

void OAILicenseTypesApi::initializeServerConfigs() {
    //Default server
    ...
    "Sandbox API Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("classificationsLicenseTypesGet", defaultConf);
    _serverIndices.insert("classificationsLicenseTypesGet", 0);
}
...
*/
int OAILicenseTypesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAILicenseTypesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAILicenseTypesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAILicenseTypesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAILicenseTypesApi::setUsername(const QString &username) {
    _username = username;
}

void OAILicenseTypesApi::setPassword(const QString &password) {
    _password = password;
}


void OAILicenseTypesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAILicenseTypesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAILicenseTypesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAILicenseTypesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILicenseTypesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILicenseTypesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAILicenseTypesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAILicenseTypesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAILicenseTypesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAILicenseTypesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAILicenseTypesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAILicenseTypesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAILicenseTypesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAILicenseTypesApi::classificationsLicenseTypesGet(const QString &api_key) {
    QString fullPath = QString(_serverConfigs["classificationsLicenseTypesGet"][_serverIndices.value("classificationsLicenseTypesGet")].URL()+"/classifications/license-types");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILicenseTypesApi::classificationsLicenseTypesGetCallback);
    connect(this, &OAILicenseTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAILicenseTypesApi::classificationsLicenseTypesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT classificationsLicenseTypesGetSignal(output);
        Q_EMIT classificationsLicenseTypesGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT classificationsLicenseTypesGetSignalE(output, error_type, error_str);
        Q_EMIT classificationsLicenseTypesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT classificationsLicenseTypesGetSignalError(output, error_type, error_str);
        Q_EMIT classificationsLicenseTypesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILicenseTypesApi::tokenAvailable(){
