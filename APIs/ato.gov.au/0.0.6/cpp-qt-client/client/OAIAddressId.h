...
#ifndef OAIAddressId_H
#define OAIAddressId_H
...
class OAIAddressId : public OAIObject {
public:
    OAIAddressId();
    OAIAddressId(QString json);
    ~OAIAddressId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressId)

#endif // OAIAddressId_H
