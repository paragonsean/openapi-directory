...
#ifndef OAI_OAILicenseTypesApi_H
#define OAI_OAILicenseTypesApi_H
...
class OAILicenseTypesApi : public QObject {
    Q_OBJECT

public:
    OAILicenseTypesApi(const int timeOut = 0);
    ~OAILicenseTypesApi();
    ...
    */
    virtual void classificationsLicenseTypesGet(const QString &api_key);
...
private:
    ...
    void classificationsLicenseTypesGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void classificationsLicenseTypesGetSignal(QList<OAILicense_type> summary);


    void classificationsLicenseTypesGetSignalFull(OAIHttpRequestWorker *worker, QList<OAILicense_type> summary);

    Q_DECL_DEPRECATED_X("Use classificationsLicenseTypesGetSignalError() instead")
    void classificationsLicenseTypesGetSignalE(QList<OAILicense_type> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsLicenseTypesGetSignalError(QList<OAILicense_type> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use classificationsLicenseTypesGetSignalErrorFull() instead")
    void classificationsLicenseTypesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void classificationsLicenseTypesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
