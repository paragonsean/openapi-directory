...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.RegisteredIdentifierTypesApi();
  });
  ...
  describe('RegisteredIdentifierTypesApi', function() {
    describe('classificationsRegisteredIdentifierTypesGet', function() {
      it('should call classificationsRegisteredIdentifierTypesGet successfully', function(done) {
        //uncomment below and update the code to test classificationsRegisteredIdentifierTypesGet
        //instance.classificationsRegisteredIdentifierTypesGet(function(error) {
