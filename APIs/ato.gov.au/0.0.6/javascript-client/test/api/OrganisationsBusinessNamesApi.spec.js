...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.BusinessRegistries);
  }
}(this, function(expect, BusinessRegistries) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new BusinessRegistries.OrganisationsBusinessNamesApi();
  });
  ...
  describe('OrganisationsBusinessNamesApi', function() {
    describe('organisationsPartyIdBusinessNamesGet', function() {
      it('should call organisationsPartyIdBusinessNamesGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdBusinessNamesGet
        //instance.organisationsPartyIdBusinessNamesGet(function(error) {
    ...
    describe('organisationsPartyIdBusinessNamesPost', function() {
      it('should call organisationsPartyIdBusinessNamesPost successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdBusinessNamesPost
        //instance.organisationsPartyIdBusinessNamesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdBusinessNamesProductIdDelete', function() {
      it('should call organisationsPartyIdBusinessNamesProductIdDelete successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdBusinessNamesProductIdDelete
        //instance.organisationsPartyIdBusinessNamesProductIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdBusinessNamesProductIdGet', function() {
      it('should call organisationsPartyIdBusinessNamesProductIdGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdBusinessNamesProductIdGet
        //instance.organisationsPartyIdBusinessNamesProductIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdBusinessNamesProductIdPut', function() {
      it('should call organisationsPartyIdBusinessNamesProductIdPut successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdBusinessNamesProductIdPut
        //instance.organisationsPartyIdBusinessNamesProductIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
