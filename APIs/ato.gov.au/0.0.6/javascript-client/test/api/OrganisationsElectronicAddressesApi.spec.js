...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.OrganisationsElectronicAddressesApi();
  });
  ...
  describe('OrganisationsElectronicAddressesApi', function() {
    describe('organisationsPartyIdElectronicAddressesAddressIdDelete', function() {
      it('should call organisationsPartyIdElectronicAddressesAddressIdDelete successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdElectronicAddressesAddressIdDelete
        //instance.organisationsPartyIdElectronicAddressesAddressIdDelete(function(error) {
    ...
    describe('organisationsPartyIdElectronicAddressesAddressIdGet', function() {
      it('should call organisationsPartyIdElectronicAddressesAddressIdGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdElectronicAddressesAddressIdGet
        //instance.organisationsPartyIdElectronicAddressesAddressIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdElectronicAddressesAddressIdPut', function() {
      it('should call organisationsPartyIdElectronicAddressesAddressIdPut successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdElectronicAddressesAddressIdPut
        //instance.organisationsPartyIdElectronicAddressesAddressIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdElectronicAddressesGet', function() {
      it('should call organisationsPartyIdElectronicAddressesGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdElectronicAddressesGet
        //instance.organisationsPartyIdElectronicAddressesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdElectronicAddressesPost', function() {
      it('should call organisationsPartyIdElectronicAddressesPost successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdElectronicAddressesPost
        //instance.organisationsPartyIdElectronicAddressesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
