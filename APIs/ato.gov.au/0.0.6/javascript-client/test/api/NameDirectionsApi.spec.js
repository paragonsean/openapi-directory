...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.NameDirectionsApi();
  });
  ...
  describe('NameDirectionsApi', function() {
    describe('classificationsNameDirectionsGet', function() {
      it('should call classificationsNameDirectionsGet successfully', function(done) {
        //uncomment below and update the code to test classificationsNameDirectionsGet
        //instance.classificationsNameDirectionsGet(function(error) {
