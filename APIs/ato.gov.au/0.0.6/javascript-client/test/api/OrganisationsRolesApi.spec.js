...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.OrganisationsRolesApi();
  });
  ...
  describe('OrganisationsRolesApi', function() {
    describe('organisationsPartyIdRolesGet', function() {
      it('should call organisationsPartyIdRolesGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdRolesGet
        //instance.organisationsPartyIdRolesGet(function(error) {
    ...
    describe('organisationsPartyIdRolesPost', function() {
      it('should call organisationsPartyIdRolesPost successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdRolesPost
        //instance.organisationsPartyIdRolesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdRolesRoleIdDelete', function() {
      it('should call organisationsPartyIdRolesRoleIdDelete successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdRolesRoleIdDelete
        //instance.organisationsPartyIdRolesRoleIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdRolesRoleIdGet', function() {
      it('should call organisationsPartyIdRolesRoleIdGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdRolesRoleIdGet
        //instance.organisationsPartyIdRolesRoleIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdRolesRoleIdPut', function() {
      it('should call organisationsPartyIdRolesRoleIdPut successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdRolesRoleIdPut
        //instance.organisationsPartyIdRolesRoleIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
