...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.OrganisationsApi();
  });
  ...
  describe('OrganisationsApi', function() {
    describe('organisationsGet', function() {
      it('should call organisationsGet successfully', function(done) {
        //uncomment below and update the code to test organisationsGet
        //instance.organisationsGet(function(error) {
    ...
    describe('organisationsPartyIdDelete', function() {
      it('should call organisationsPartyIdDelete successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdDelete
        //instance.organisationsPartyIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdGet', function() {
      it('should call organisationsPartyIdGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdGet
        //instance.organisationsPartyIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdPut', function() {
      it('should call organisationsPartyIdPut successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdPut
        //instance.organisationsPartyIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPost', function() {
      it('should call organisationsPost successfully', function(done) {
        //uncomment below and update the code to test organisationsPost
        //instance.organisationsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
