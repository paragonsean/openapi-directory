...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.BusinessNamesApi();
  });
  ...
  describe('BusinessNamesApi', function() {
    describe('businessNamesGet', function() {
      it('should call businessNamesGet successfully', function(done) {
        //uncomment below and update the code to test businessNamesGet
        //instance.businessNamesGet(function(error) {
