...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.IndividualsBusinessNamesApi();
  });
  ...
  describe('IndividualsBusinessNamesApi', function() {
    describe('individualsPartyIdBusinessNamesGet', function() {
      it('should call individualsPartyIdBusinessNamesGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdBusinessNamesGet
        //instance.individualsPartyIdBusinessNamesGet(function(error) {
    ...
    describe('individualsPartyIdBusinessNamesPost', function() {
      it('should call individualsPartyIdBusinessNamesPost successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdBusinessNamesPost
        //instance.individualsPartyIdBusinessNamesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdBusinessNamesProductIdDelete', function() {
      it('should call individualsPartyIdBusinessNamesProductIdDelete successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdBusinessNamesProductIdDelete
        //instance.individualsPartyIdBusinessNamesProductIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdBusinessNamesProductIdGet', function() {
      it('should call individualsPartyIdBusinessNamesProductIdGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdBusinessNamesProductIdGet
        //instance.individualsPartyIdBusinessNamesProductIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdBusinessNamesProductIdPut', function() {
      it('should call individualsPartyIdBusinessNamesProductIdPut successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdBusinessNamesProductIdPut
        //instance.individualsPartyIdBusinessNamesProductIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
