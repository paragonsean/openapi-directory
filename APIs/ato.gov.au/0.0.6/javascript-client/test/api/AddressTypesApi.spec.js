...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.AddressTypesApi();
  });
  ...
  describe('AddressTypesApi', function() {
    describe('classificationsAddressTypesGet', function() {
      it('should call classificationsAddressTypesGet successfully', function(done) {
        //uncomment below and update the code to test classificationsAddressTypesGet
        //instance.classificationsAddressTypesGet(function(error) {
