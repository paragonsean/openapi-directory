...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.BusinessNameLifecycleStatesApi();
  });
  ...
  describe('BusinessNameLifecycleStatesApi', function() {
    describe('classificationsBusinessNameLifecycleStatesGet', function() {
      it('should call classificationsBusinessNameLifecycleStatesGet successfully', function(done) {
        //uncomment below and update the code to test classificationsBusinessNameLifecycleStatesGet
        //instance.classificationsBusinessNameLifecycleStatesGet(function(error) {
