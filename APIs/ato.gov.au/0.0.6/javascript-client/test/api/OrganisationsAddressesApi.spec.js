...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.OrganisationsAddressesApi();
  });
  ...
  describe('OrganisationsAddressesApi', function() {
    describe('organisationsPartyIdAddressesAddressIdDelete', function() {
      it('should call organisationsPartyIdAddressesAddressIdDelete successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdAddressesAddressIdDelete
        //instance.organisationsPartyIdAddressesAddressIdDelete(function(error) {
    ...
    describe('organisationsPartyIdAddressesAddressIdGet', function() {
      it('should call organisationsPartyIdAddressesAddressIdGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdAddressesAddressIdGet
        //instance.organisationsPartyIdAddressesAddressIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdAddressesAddressIdPut', function() {
      it('should call organisationsPartyIdAddressesAddressIdPut successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdAddressesAddressIdPut
        //instance.organisationsPartyIdAddressesAddressIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdAddressesGet', function() {
      it('should call organisationsPartyIdAddressesGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdAddressesGet
        //instance.organisationsPartyIdAddressesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdAddressesPost', function() {
      it('should call organisationsPartyIdAddressesPost successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdAddressesPost
        //instance.organisationsPartyIdAddressesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
