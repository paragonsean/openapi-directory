...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.LicenseTypesApi();
  });
  ...
  describe('LicenseTypesApi', function() {
    describe('classificationsLicenseTypesGet', function() {
      it('should call classificationsLicenseTypesGet successfully', function(done) {
        //uncomment below and update the code to test classificationsLicenseTypesGet
        //instance.classificationsLicenseTypesGet(function(error) {
