...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.IndividualsApi();
  });
  ...
  describe('IndividualsApi', function() {
    describe('individualsGet', function() {
      it('should call individualsGet successfully', function(done) {
        //uncomment below and update the code to test individualsGet
        //instance.individualsGet(function(error) {
    ...
    describe('individualsPartyIdDelete', function() {
      it('should call individualsPartyIdDelete successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdDelete
        //instance.individualsPartyIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdGet', function() {
      it('should call individualsPartyIdGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdGet
        //instance.individualsPartyIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdPut', function() {
      it('should call individualsPartyIdPut successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdPut
        //instance.individualsPartyIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPost', function() {
      it('should call individualsPost successfully', function(done) {
        //uncomment below and update the code to test individualsPost
        //instance.individualsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
