...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.IndividualsElectronicAddressesApi();
  });
  ...
  describe('IndividualsElectronicAddressesApi', function() {
    describe('individualsPartyIdElectronicAddressesAddressIdDelete', function() {
      it('should call individualsPartyIdElectronicAddressesAddressIdDelete successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdElectronicAddressesAddressIdDelete
        //instance.individualsPartyIdElectronicAddressesAddressIdDelete(function(error) {
    ...
    describe('individualsPartyIdElectronicAddressesAddressIdGet', function() {
      it('should call individualsPartyIdElectronicAddressesAddressIdGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdElectronicAddressesAddressIdGet
        //instance.individualsPartyIdElectronicAddressesAddressIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdElectronicAddressesAddressIdPut', function() {
      it('should call individualsPartyIdElectronicAddressesAddressIdPut successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdElectronicAddressesAddressIdPut
        //instance.individualsPartyIdElectronicAddressesAddressIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdElectronicAddressesGet', function() {
      it('should call individualsPartyIdElectronicAddressesGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdElectronicAddressesGet
        //instance.individualsPartyIdElectronicAddressesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdElectronicAddressesPost', function() {
      it('should call individualsPartyIdElectronicAddressesPost successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdElectronicAddressesPost
        //instance.individualsPartyIdElectronicAddressesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
