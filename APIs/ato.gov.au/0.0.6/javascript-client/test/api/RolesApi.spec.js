...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.RolesApi();
  });
  ...
  describe('RolesApi', function() {
    describe('classificationsRolesGet', function() {
      it('should call classificationsRolesGet successfully', function(done) {
        //uncomment below and update the code to test classificationsRolesGet
        //instance.classificationsRolesGet(function(error) {
