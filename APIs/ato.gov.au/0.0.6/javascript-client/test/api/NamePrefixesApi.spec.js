...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.NamePrefixesApi();
  });
  ...
  describe('NamePrefixesApi', function() {
    describe('classificationsNamePrefixesGet', function() {
      it('should call classificationsNamePrefixesGet successfully', function(done) {
        //uncomment below and update the code to test classificationsNamePrefixesGet
        //instance.classificationsNamePrefixesGet(function(error) {
