...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.OrganisationsLicensesApi();
  });
  ...
  describe('OrganisationsLicensesApi', function() {
    describe('organisationsPartyIdLicensesGet', function() {
      it('should call organisationsPartyIdLicensesGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdLicensesGet
        //instance.organisationsPartyIdLicensesGet(function(error) {
    ...
    describe('organisationsPartyIdLicensesPost', function() {
      it('should call organisationsPartyIdLicensesPost successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdLicensesPost
        //instance.organisationsPartyIdLicensesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdLicensesProductIdDelete', function() {
      it('should call organisationsPartyIdLicensesProductIdDelete successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdLicensesProductIdDelete
        //instance.organisationsPartyIdLicensesProductIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdLicensesProductIdGet', function() {
      it('should call organisationsPartyIdLicensesProductIdGet successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdLicensesProductIdGet
        //instance.organisationsPartyIdLicensesProductIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('organisationsPartyIdLicensesProductIdPut', function() {
      it('should call organisationsPartyIdLicensesProductIdPut successfully', function(done) {
        //uncomment below and update the code to test organisationsPartyIdLicensesProductIdPut
        //instance.organisationsPartyIdLicensesProductIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
