...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.GendersApi();
  });
  ...
  describe('GendersApi', function() {
    describe('classificationsGendersGet', function() {
      it('should call classificationsGendersGet successfully', function(done) {
        //uncomment below and update the code to test classificationsGendersGet
        //instance.classificationsGendersGet(function(error) {
