...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.LegalEntityTypesApi();
  });
  ...
  describe('LegalEntityTypesApi', function() {
    describe('classificationsLegalEntityTypesGet', function() {
      it('should call classificationsLegalEntityTypesGet successfully', function(done) {
        //uncomment below and update the code to test classificationsLegalEntityTypesGet
        //instance.classificationsLegalEntityTypesGet(function(error) {
