...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.NameTypesApi();
  });
  ...
  describe('NameTypesApi', function() {
    describe('classificationsNameTypesGet', function() {
      it('should call classificationsNameTypesGet successfully', function(done) {
        //uncomment below and update the code to test classificationsNameTypesGet
        //instance.classificationsNameTypesGet(function(error) {
