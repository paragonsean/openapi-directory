...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.LicenseLifecycleStatesApi();
  });
  ...
  describe('LicenseLifecycleStatesApi', function() {
    describe('classificationsLicenseLifecycleStatesGet', function() {
      it('should call classificationsLicenseLifecycleStatesGet successfully', function(done) {
        //uncomment below and update the code to test classificationsLicenseLifecycleStatesGet
        //instance.classificationsLicenseLifecycleStatesGet(function(error) {
