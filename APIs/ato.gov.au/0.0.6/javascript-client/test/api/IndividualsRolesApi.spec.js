...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.IndividualsRolesApi();
  });
  ...
  describe('IndividualsRolesApi', function() {
    describe('individualsPartyIdRolesGet', function() {
      it('should call individualsPartyIdRolesGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdRolesGet
        //instance.individualsPartyIdRolesGet(function(error) {
    ...
    describe('individualsPartyIdRolesPost', function() {
      it('should call individualsPartyIdRolesPost successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdRolesPost
        //instance.individualsPartyIdRolesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdRolesRoleIdDelete', function() {
      it('should call individualsPartyIdRolesRoleIdDelete successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdRolesRoleIdDelete
        //instance.individualsPartyIdRolesRoleIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdRolesRoleIdGet', function() {
      it('should call individualsPartyIdRolesRoleIdGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdRolesRoleIdGet
        //instance.individualsPartyIdRolesRoleIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdRolesRoleIdPut', function() {
      it('should call individualsPartyIdRolesRoleIdPut successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdRolesRoleIdPut
        //instance.individualsPartyIdRolesRoleIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
