...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.ElectronicAddressTypesApi();
  });
  ...
  describe('ElectronicAddressTypesApi', function() {
    describe('classificationsElectronicAddressTypesGet', function() {
      it('should call classificationsElectronicAddressTypesGet successfully', function(done) {
        //uncomment below and update the code to test classificationsElectronicAddressTypesGet
        //instance.classificationsElectronicAddressTypesGet(function(error) {
