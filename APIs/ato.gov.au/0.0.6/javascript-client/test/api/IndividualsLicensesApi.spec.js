...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.IndividualsLicensesApi();
  });
  ...
  describe('IndividualsLicensesApi', function() {
    describe('individualsPartyIdLicensesGet', function() {
      it('should call individualsPartyIdLicensesGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdLicensesGet
        //instance.individualsPartyIdLicensesGet(function(error) {
    ...
    describe('individualsPartyIdLicensesPost', function() {
      it('should call individualsPartyIdLicensesPost successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdLicensesPost
        //instance.individualsPartyIdLicensesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdLicensesProductIdDelete', function() {
      it('should call individualsPartyIdLicensesProductIdDelete successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdLicensesProductIdDelete
        //instance.individualsPartyIdLicensesProductIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdLicensesProductIdGet', function() {
      it('should call individualsPartyIdLicensesProductIdGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdLicensesProductIdGet
        //instance.individualsPartyIdLicensesProductIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdLicensesProductIdPut', function() {
      it('should call individualsPartyIdLicensesProductIdPut successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdLicensesProductIdPut
        //instance.individualsPartyIdLicensesProductIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
