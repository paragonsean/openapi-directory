...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.IndividualsAddressesApi();
  });
  ...
  describe('IndividualsAddressesApi', function() {
    describe('individualsPartyIdAddressesAddressIdDelete', function() {
      it('should call individualsPartyIdAddressesAddressIdDelete successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdAddressesAddressIdDelete
        //instance.individualsPartyIdAddressesAddressIdDelete(function(error) {
    ...
    describe('individualsPartyIdAddressesAddressIdGet', function() {
      it('should call individualsPartyIdAddressesAddressIdGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdAddressesAddressIdGet
        //instance.individualsPartyIdAddressesAddressIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdAddressesAddressIdPut', function() {
      it('should call individualsPartyIdAddressesAddressIdPut successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdAddressesAddressIdPut
        //instance.individualsPartyIdAddressesAddressIdPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdAddressesGet', function() {
      it('should call individualsPartyIdAddressesGet successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdAddressesGet
        //instance.individualsPartyIdAddressesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('individualsPartyIdAddressesPost', function() {
      it('should call individualsPartyIdAddressesPost successfully', function(done) {
        //uncomment below and update the code to test individualsPartyIdAddressesPost
        //instance.individualsPartyIdAddressesPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
