...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.NamePrefix();
  });
  ...
  describe('NamePrefix', function() {
    it('should create an instance of NamePrefix', function() {
      // uncomment below and update the code to test NamePrefix
      //var instance = new BusinessRegistries.NamePrefix();
      //expect(instance).to.be.a(BusinessRegistries.NamePrefix);
    });
