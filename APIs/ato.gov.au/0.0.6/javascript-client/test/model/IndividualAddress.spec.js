...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.IndividualAddress();
  });
  ...
  describe('IndividualAddress', function() {
    it('should create an instance of IndividualAddress', function() {
      // uncomment below and update the code to test IndividualAddress
      //var instance = new BusinessRegistries.IndividualAddress();
      //expect(instance).to.be.a(BusinessRegistries.IndividualAddress);
    });
