...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.RegisteredIdentifier();
  });
  ...
  describe('RegisteredIdentifier', function() {
    it('should create an instance of RegisteredIdentifier', function() {
      // uncomment below and update the code to test RegisteredIdentifier
      //var instance = new BusinessRegistries.RegisteredIdentifier();
      //expect(instance).to.be.a(BusinessRegistries.RegisteredIdentifier);
    });
