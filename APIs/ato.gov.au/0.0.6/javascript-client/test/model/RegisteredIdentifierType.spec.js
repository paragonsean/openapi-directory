...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.RegisteredIdentifierType();
  });
  ...
  describe('RegisteredIdentifierType', function() {
    it('should create an instance of RegisteredIdentifierType', function() {
      // uncomment below and update the code to test RegisteredIdentifierType
      //var instance = new BusinessRegistries.RegisteredIdentifierType();
      //expect(instance).to.be.a(BusinessRegistries.RegisteredIdentifierType);
    });
