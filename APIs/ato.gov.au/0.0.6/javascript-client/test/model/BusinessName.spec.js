...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.BusinessName();
  });
  ...
  describe('BusinessName', function() {
    it('should create an instance of BusinessName', function() {
      // uncomment below and update the code to test BusinessName
      //var instance = new BusinessRegistries.BusinessName();
      //expect(instance).to.be.a(BusinessRegistries.BusinessName);
    });
