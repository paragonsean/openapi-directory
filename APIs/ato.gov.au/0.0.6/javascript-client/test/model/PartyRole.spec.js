...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.PartyRole();
  });
  ...
  describe('PartyRole', function() {
    it('should create an instance of PartyRole', function() {
      // uncomment below and update the code to test PartyRole
      //var instance = new BusinessRegistries.PartyRole();
      //expect(instance).to.be.a(BusinessRegistries.PartyRole);
    });
    ...
    it('should have the property partyRoleType (base name: "partyRoleType")', function() {
      // uncomment below and update the code to test the property partyRoleType
      //var instance = new BusinessRegistries.PartyRole();
      //expect(instance).to.be();
    });

    it('should have the property relatedPartyId (base name: "relatedPartyId")', function() {
      // uncomment below and update the code to test the property relatedPartyId
      //var instance = new BusinessRegistries.PartyRole();
      //expect(instance).to.be();
    });

    it('should have the property relatedPartyRoleType (base name: "relatedPartyRoleType")', function() {
      // uncomment below and update the code to test the property relatedPartyRoleType
      //var instance = new BusinessRegistries.PartyRole();
      //expect(instance).to.be();
    });
