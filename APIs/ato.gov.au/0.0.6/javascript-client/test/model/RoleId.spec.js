...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.RoleId();
  });
  ...
  describe('RoleId', function() {
    it('should create an instance of RoleId', function() {
      // uncomment below and update the code to test RoleId
      //var instance = new BusinessRegistries.RoleId();
      //expect(instance).to.be.a(BusinessRegistries.RoleId);
    });
