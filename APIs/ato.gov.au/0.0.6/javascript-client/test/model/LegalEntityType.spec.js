...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.LegalEntityType();
  });
  ...
  describe('LegalEntityType', function() {
    it('should create an instance of LegalEntityType', function() {
      // uncomment below and update the code to test LegalEntityType
      //var instance = new BusinessRegistries.LegalEntityType();
      //expect(instance).to.be.a(BusinessRegistries.LegalEntityType);
    });
