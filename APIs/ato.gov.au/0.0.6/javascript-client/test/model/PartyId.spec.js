...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.PartyId();
  });
  ...
  describe('PartyId', function() {
    it('should create an instance of PartyId', function() {
      // uncomment below and update the code to test PartyId
      //var instance = new BusinessRegistries.PartyId();
      //expect(instance).to.be.a(BusinessRegistries.PartyId);
    });
