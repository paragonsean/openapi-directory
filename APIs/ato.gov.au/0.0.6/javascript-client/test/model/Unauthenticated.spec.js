...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.Unauthenticated();
  });
  ...
  describe('Unauthenticated', function() {
    it('should create an instance of Unauthenticated', function() {
      // uncomment below and update the code to test Unauthenticated
      //var instance = new BusinessRegistries.Unauthenticated();
      //expect(instance).to.be.a(BusinessRegistries.Unauthenticated);
    });
