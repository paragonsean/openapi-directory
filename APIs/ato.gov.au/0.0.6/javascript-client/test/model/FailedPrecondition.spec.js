...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.FailedPrecondition();
  });
  ...
  describe('FailedPrecondition', function() {
    it('should create an instance of FailedPrecondition', function() {
      // uncomment below and update the code to test FailedPrecondition
      //var instance = new BusinessRegistries.FailedPrecondition();
      //expect(instance).to.be.a(BusinessRegistries.FailedPrecondition);
    });
