...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.ElectronicAddressType();
  });
  ...
  describe('ElectronicAddressType', function() {
    it('should create an instance of ElectronicAddressType', function() {
      // uncomment below and update the code to test ElectronicAddressType
      //var instance = new BusinessRegistries.ElectronicAddressType();
      //expect(instance).to.be.a(BusinessRegistries.ElectronicAddressType);
    });
