...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.AddressId();
  });
  ...
  describe('AddressId', function() {
    it('should create an instance of AddressId', function() {
      // uncomment below and update the code to test AddressId
      //var instance = new BusinessRegistries.AddressId();
      //expect(instance).to.be.a(BusinessRegistries.AddressId);
    });
