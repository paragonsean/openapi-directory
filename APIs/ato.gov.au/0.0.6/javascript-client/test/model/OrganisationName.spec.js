...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.OrganisationName();
  });
  ...
  describe('OrganisationName', function() {
    it('should create an instance of OrganisationName', function() {
      // uncomment below and update the code to test OrganisationName
      //var instance = new BusinessRegistries.OrganisationName();
      //expect(instance).to.be.a(BusinessRegistries.OrganisationName);
    });
