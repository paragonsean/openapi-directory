...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.LicenseLifecycleState();
  });
  ...
  describe('LicenseLifecycleState', function() {
    it('should create an instance of LicenseLifecycleState', function() {
      // uncomment below and update the code to test LicenseLifecycleState
      //var instance = new BusinessRegistries.LicenseLifecycleState();
      //expect(instance).to.be.a(BusinessRegistries.LicenseLifecycleState);
    });
