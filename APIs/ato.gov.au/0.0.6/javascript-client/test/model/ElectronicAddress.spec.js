...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.ElectronicAddress();
  });
  ...
  describe('ElectronicAddress', function() {
    it('should create an instance of ElectronicAddress', function() {
      // uncomment below and update the code to test ElectronicAddress
      //var instance = new BusinessRegistries.ElectronicAddress();
      //expect(instance).to.be.a(BusinessRegistries.ElectronicAddress);
    });
    ...
    it('should have the property electronicAddressType (base name: "electronicAddressType")', function() {
      // uncomment below and update the code to test the property electronicAddressType
      //var instance = new BusinessRegistries.ElectronicAddress();
      //expect(instance).to.be();
    });
