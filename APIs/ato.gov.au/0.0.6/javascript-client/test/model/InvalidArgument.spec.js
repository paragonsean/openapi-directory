...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.InvalidArgument();
  });
  ...
  describe('InvalidArgument', function() {
    it('should create an instance of InvalidArgument', function() {
      ...
      //var instance = new BusinessRegistries.InvalidArgument();
      //expect(instance).to.be.a(BusinessRegistries.InvalidArgument);
    });
