...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.NameDirection();
  });
  ...
  describe('NameDirection', function() {
    it('should create an instance of NameDirection', function() {
      // uncomment below and update the code to test NameDirection
      //var instance = new BusinessRegistries.NameDirection();
      //expect(instance).to.be.a(BusinessRegistries.NameDirection);
    });
