...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.PermissionDenied();
  });
  ...
  describe('PermissionDenied', function() {
    it('should create an instance of PermissionDenied', function() {
      // uncomment below and update the code to test PermissionDenied
      //var instance = new BusinessRegistries.PermissionDenied();
      //expect(instance).to.be.a(BusinessRegistries.PermissionDenied);
    });
