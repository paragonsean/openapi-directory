...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.OrganisationAddress();
  });
  ...
  describe('OrganisationAddress', function() {
    it('should create an instance of OrganisationAddress', function() {
      // uncomment below and update the code to test OrganisationAddress
      //var instance = new BusinessRegistries.OrganisationAddress();
      //expect(instance).to.be.a(BusinessRegistries.OrganisationAddress);
    });
