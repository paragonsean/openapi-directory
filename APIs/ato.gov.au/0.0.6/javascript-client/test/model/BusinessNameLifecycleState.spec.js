...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BusinessRegistries.BusinessNameLifecycleState();
  });
  ...
  describe('BusinessNameLifecycleState', function() {
    it('should create an instance of BusinessNameLifecycleState', function() {
      // uncomment below and update the code to test BusinessNameLifecycleState
      //var instance = new BusinessRegistries.BusinessNameLifecycleState();
      //expect(instance).to.be.a(BusinessRegistries.BusinessNameLifecycleState);
    });
