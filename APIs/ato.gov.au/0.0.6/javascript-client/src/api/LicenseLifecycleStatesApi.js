...
/**
* LicenseLifecycleStates service.
* @module api/LicenseLifecycleStatesApi
* @version 0.0.6
*/
export default class LicenseLifecycleStatesApi {

    /**
    * Constructs a new LicenseLifecycleStatesApi. 
    * @alias module:api/LicenseLifecycleStatesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsLicenseLifecycleStatesGet operation.
     * @callback module:api/LicenseLifecycleStatesApi~classificationsLicenseLifecycleStatesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/LicenseLifecycleState>} data The data returned by the service call.
     ...
     * @param {module:api/LicenseLifecycleStatesApi~classificationsLicenseLifecycleStatesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/LicenseLifecycleState>}
     */
    classificationsLicenseLifecycleStatesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsLicenseLifecycleStatesGet");
      }
      ...
      let returnType = [LicenseLifecycleState];
      return this.apiClient.callApi(
        '/classifications/license-lifecycle-states', 'GET',
