...
/**
* NameTypes service.
* @module api/NameTypesApi
* @version 0.0.6
*/
export default class NameTypesApi {

    /**
    * Constructs a new NameTypesApi. 
    * @alias module:api/NameTypesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsNameTypesGet operation.
     * @callback module:api/NameTypesApi~classificationsNameTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/NameType>} data The data returned by the service call.
     ...
     * @param {module:api/NameTypesApi~classificationsNameTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/NameType>}
     */
    classificationsNameTypesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsNameTypesGet");
      }
      ...
      let returnType = [NameType];
      return this.apiClient.callApi(
        '/classifications/name-types', 'GET',
