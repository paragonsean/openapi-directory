...
/**
* IndividualsRoles service.
* @module api/IndividualsRolesApi
* @version 0.0.6
*/
export default class IndividualsRolesApi {

    /**
    * Constructs a new IndividualsRolesApi. 
    * @alias module:api/IndividualsRolesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the individualsPartyIdRolesGet operation.
     * @callback module:api/IndividualsRolesApi~individualsPartyIdRolesGetCallback
     ...
     * @param {module:api/IndividualsRolesApi~individualsPartyIdRolesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/PartyRole>}
     */
    individualsPartyIdRolesGet(apiKey, partyId, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling individualsPartyIdRolesGet");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling individualsPartyIdRolesGet");
      }
    ...
    /**
     * Callback function to receive the result of the individualsPartyIdRolesPost operation.
     * @callback module:api/IndividualsRolesApi~individualsPartyIdRolesPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/IndividualsRolesApi~individualsPartyIdRolesPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PartyRole}
     */
    individualsPartyIdRolesPost(apiKey, partyId, partyRole, callback) {
      let postBody = partyRole;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling individualsPartyIdRolesPost");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling individualsPartyIdRolesPost");
      }
      // verify the required parameter 'partyRole' is set
      if (partyRole === undefined || partyRole === null) {
        throw new Error("Missing the required parameter 'partyRole' when calling individualsPartyIdRolesPost");
      }
    ...
    /**
     * Callback function to receive the result of the individualsPartyIdRolesRoleIdDelete operation.
     * @callback module:api/IndividualsRolesApi~individualsPartyIdRolesRoleIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/IndividualsRolesApi~individualsPartyIdRolesRoleIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    individualsPartyIdRolesRoleIdDelete(apiKey, partyId, roleId, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling individualsPartyIdRolesRoleIdDelete");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling individualsPartyIdRolesRoleIdDelete");
      }
      // verify the required parameter 'roleId' is set
      if (roleId === undefined || roleId === null) {
        throw new Error("Missing the required parameter 'roleId' when calling individualsPartyIdRolesRoleIdDelete");
      }
    ...
    /**
     * Callback function to receive the result of the individualsPartyIdRolesRoleIdGet operation.
     * @callback module:api/IndividualsRolesApi~individualsPartyIdRolesRoleIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PartyRole} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} partyId The party identifier.
     * @param {String} roleId The role identifier.
     * @param {module:api/IndividualsRolesApi~individualsPartyIdRolesRoleIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PartyRole}
     */
    individualsPartyIdRolesRoleIdGet(apiKey, partyId, roleId, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling individualsPartyIdRolesRoleIdGet");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling individualsPartyIdRolesRoleIdGet");
      }
      // verify the required parameter 'roleId' is set
      if (roleId === undefined || roleId === null) {
        throw new Error("Missing the required parameter 'roleId' when calling individualsPartyIdRolesRoleIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the individualsPartyIdRolesRoleIdPut operation.
     * @callback module:api/IndividualsRolesApi~individualsPartyIdRolesRoleIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PartyRole} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} roleId The role identifier.
     * @param {module:model/PartyRole} partyRole Role resource
     * @param {module:api/IndividualsRolesApi~individualsPartyIdRolesRoleIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PartyRole}
     */
    individualsPartyIdRolesRoleIdPut(apiKey, partyId, roleId, partyRole, callback) {
      let postBody = partyRole;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling individualsPartyIdRolesRoleIdPut");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling individualsPartyIdRolesRoleIdPut");
      }
      // verify the required parameter 'roleId' is set
      if (roleId === undefined || roleId === null) {
        throw new Error("Missing the required parameter 'roleId' when calling individualsPartyIdRolesRoleIdPut");
      }
      // verify the required parameter 'partyRole' is set
      if (partyRole === undefined || partyRole === null) {
        throw new Error("Missing the required parameter 'partyRole' when calling individualsPartyIdRolesRoleIdPut");
      }
