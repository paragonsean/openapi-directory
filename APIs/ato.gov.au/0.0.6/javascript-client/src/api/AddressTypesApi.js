...
/**
* AddressTypes service.
* @module api/AddressTypesApi
* @version 0.0.6
*/
export default class AddressTypesApi {

    /**
    * Constructs a new AddressTypesApi. 
    * @alias module:api/AddressTypesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsAddressTypesGet operation.
     * @callback module:api/AddressTypesApi~classificationsAddressTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/AddressType>} data The data returned by the service call.
     ...
     * @param {module:api/AddressTypesApi~classificationsAddressTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/AddressType>}
     */
    classificationsAddressTypesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsAddressTypesGet");
      }
      ...
      let returnType = [AddressType];
      return this.apiClient.callApi(
        '/classifications/address-types', 'GET',
