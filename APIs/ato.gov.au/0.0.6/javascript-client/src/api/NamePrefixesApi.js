...
/**
* NamePrefixes service.
* @module api/NamePrefixesApi
* @version 0.0.6
*/
export default class NamePrefixesApi {

    /**
    * Constructs a new NamePrefixesApi. 
    * @alias module:api/NamePrefixesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsNamePrefixesGet operation.
     * @callback module:api/NamePrefixesApi~classificationsNamePrefixesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/NamePrefix>} data The data returned by the service call.
     ...
     * @param {module:api/NamePrefixesApi~classificationsNamePrefixesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/NamePrefix>}
     */
    classificationsNamePrefixesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsNamePrefixesGet");
      }
      ...
      let returnType = [NamePrefix];
      return this.apiClient.callApi(
        '/classifications/name-prefixes', 'GET',
