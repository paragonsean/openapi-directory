...
/**
* Individuals service.
* @module api/IndividualsApi
* @version 0.0.6
*/
export default class IndividualsApi {

    /**
    * Constructs a new IndividualsApi. 
    * @alias module:api/IndividualsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the individualsGet operation.
     * @callback module:api/IndividualsApi~individualsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Individual>} data The data returned by the service call.
     ...
     * @param {module:api/IndividualsApi~individualsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Individual>}
     */
    individualsGet(apiKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling individualsGet");
      }
      ...
      let queryParams = {
        ...
        'placeOfBirth': opts['placeOfBirth']
      };
      let headerParams = {
        'apiKey': apiKey
      };
    ...
    /**
     * Callback function to receive the result of the individualsPartyIdDelete operation.
     * @callback module:api/IndividualsApi~individualsPartyIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/IndividualsApi~individualsPartyIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    individualsPartyIdDelete(apiKey, partyId, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling individualsPartyIdDelete");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling individualsPartyIdDelete");
      }
    ...
    /**
     * Callback function to receive the result of the individualsPartyIdGet operation.
     * @callback module:api/IndividualsApi~individualsPartyIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Individual} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiKey The API key.
     * @param {String} partyId The party identifier.
     * @param {module:api/IndividualsApi~individualsPartyIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Individual}
     */
    individualsPartyIdGet(apiKey, partyId, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling individualsPartyIdGet");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling individualsPartyIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the individualsPartyIdPut operation.
     * @callback module:api/IndividualsApi~individualsPartyIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Individual} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiKey The API key.
     * @param {String} partyId The party identifier.
     * @param {module:model/Individual} individual Individual resource
     * @param {module:api/IndividualsApi~individualsPartyIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Individual}
     */
    individualsPartyIdPut(apiKey, partyId, individual, callback) {
      let postBody = individual;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling individualsPartyIdPut");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling individualsPartyIdPut");
      }
      // verify the required parameter 'individual' is set
      if (individual === undefined || individual === null) {
        throw new Error("Missing the required parameter 'individual' when calling individualsPartyIdPut");
      }
    ...
    /**
     * Callback function to receive the result of the individualsPost operation.
     * @callback module:api/IndividualsApi~individualsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Individual} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiKey The API key.
     * @param {module:model/Individual} individual Individual resource
     * @param {module:api/IndividualsApi~individualsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Individual}
     */
    individualsPost(apiKey, individual, callback) {
      let postBody = individual;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling individualsPost");
      }
      // verify the required parameter 'individual' is set
      if (individual === undefined || individual === null) {
        throw new Error("Missing the required parameter 'individual' when calling individualsPost");
      }
