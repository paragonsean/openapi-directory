...
* @module api/LicenseTypesApi
* @version 0.0.6
*/
export default class LicenseTypesApi {

    /**
    * Constructs a new LicenseTypesApi. 
    * @alias module:api/LicenseTypesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsLicenseTypesGet operation.
     * @callback module:api/LicenseTypesApi~classificationsLicenseTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/LicenseType>} data The data returned by the service call.
     ...
     * @param {module:api/LicenseTypesApi~classificationsLicenseTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/LicenseType>}
     */
    classificationsLicenseTypesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsLicenseTypesGet");
      }
      ...
      let returnType = [LicenseType];
      return this.apiClient.callApi(
        '/classifications/license-types', 'GET',
