...
export default class OrganisationsApi {
    ...
    */
     ...
     */
    organisationsGet(apiKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling organisationsGet");
      }

      let pathParams = {
      };
      let queryParams = {
        'registeredIdentifier': opts['registeredIdentifier'],
    ...
    /**
     * Callback function to receive the result of the organisationsPartyIdDelete operation.
     * @callback module:api/OrganisationsApi~organisationsPartyIdDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/OrganisationsApi~organisationsPartyIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    organisationsPartyIdDelete(apiKey, partyId, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling organisationsPartyIdDelete");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling organisationsPartyIdDelete");
      }
    ...
    /**
     * Callback function to receive the result of the organisationsPartyIdGet operation.
     * @callback module:api/OrganisationsApi~organisationsPartyIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apiKey The API key.
     * @param {String} partyId The party identifier.
     * @param {module:api/OrganisationsApi~organisationsPartyIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Organisation}
     */
    organisationsPartyIdGet(apiKey, partyId, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling organisationsPartyIdGet");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling organisationsPartyIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the organisationsPartyIdPut operation.
     * @callback module:api/OrganisationsApi~organisationsPartyIdPutCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Organisation} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apiKey The API key.
     * @param {String} partyId The party identifier.
     * @param {module:model/Organisation} organisation Organisation resource
     * @param {module:api/OrganisationsApi~organisationsPartyIdPutCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Organisation}
     */
    organisationsPartyIdPut(apiKey, partyId, organisation, callback) {
      let postBody = organisation;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling organisationsPartyIdPut");
      }
      // verify the required parameter 'partyId' is set
      if (partyId === undefined || partyId === null) {
        throw new Error("Missing the required parameter 'partyId' when calling organisationsPartyIdPut");
      }
      // verify the required parameter 'organisation' is set
      if (organisation === undefined || organisation === null) {
        throw new Error("Missing the required parameter 'organisation' when calling organisationsPartyIdPut");
      }
     ...
     * data is of type: {@link module:model/Organisation}
     */
    organisationsPost(apiKey, organisation, callback) {
      let postBody = organisation;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling organisationsPost");
      }
      // verify the required parameter 'organisation' is set
      if (organisation === undefined || organisation === null) {
        throw new Error("Missing the required parameter 'organisation' when calling organisationsPost");
      }
