...
/**
* BusinessNames service.
* @module api/BusinessNamesApi
* @version 0.0.6
*/
export default class BusinessNamesApi {

    /**
    * Constructs a new BusinessNamesApi. 
    * @alias module:api/BusinessNamesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the businessNamesGet operation.
     * @callback module:api/BusinessNamesApi~businessNamesGetCallback
     ...
     * @param {module:api/BusinessNamesApi~businessNamesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/BusinessName>}
     */
    businessNamesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling businessNamesGet");
      }
