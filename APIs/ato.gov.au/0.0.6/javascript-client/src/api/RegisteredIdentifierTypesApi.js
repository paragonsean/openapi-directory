...
/**
* RegisteredIdentifierTypes service.
* @module api/RegisteredIdentifierTypesApi
* @version 0.0.6
*/
export default class RegisteredIdentifierTypesApi {

    /**
    * Constructs a new RegisteredIdentifierTypesApi. 
    * @alias module:api/RegisteredIdentifierTypesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsRegisteredIdentifierTypesGet operation.
     * @callback module:api/RegisteredIdentifierTypesApi~classificationsRegisteredIdentifierTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/RegisteredIdentifierType>} data The data returned by the service call.
     ...
     * @param {module:api/RegisteredIdentifierTypesApi~classificationsRegisteredIdentifierTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/RegisteredIdentifierType>}
     */
    classificationsRegisteredIdentifierTypesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsRegisteredIdentifierTypesGet");
      }
      ...
      let returnType = [RegisteredIdentifierType];
      return this.apiClient.callApi(
        '/classifications/registered-identifier-types', 'GET',
