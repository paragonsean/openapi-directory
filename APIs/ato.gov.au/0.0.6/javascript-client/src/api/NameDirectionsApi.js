...
/**
* NameDirections service.
* @module api/NameDirectionsApi
* @version 0.0.6
*/
export default class NameDirectionsApi {

    /**
    * Constructs a new NameDirectionsApi. 
    * @alias module:api/NameDirectionsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsNameDirectionsGet operation.
     * @callback module:api/NameDirectionsApi~classificationsNameDirectionsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/NameDirection>} data The data returned by the service call.
     ...
     * @param {module:api/NameDirectionsApi~classificationsNameDirectionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/NameDirection>}
     */
    classificationsNameDirectionsGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsNameDirectionsGet");
      }
      ...
      let returnType = [NameDirection];
      return this.apiClient.callApi(
        '/classifications/name-directions', 'GET',
