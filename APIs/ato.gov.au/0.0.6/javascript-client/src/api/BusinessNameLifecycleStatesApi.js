...
/**
* BusinessNameLifecycleStates service.
* @module api/BusinessNameLifecycleStatesApi
* @version 0.0.6
*/
export default class BusinessNameLifecycleStatesApi {

    /**
    * Constructs a new BusinessNameLifecycleStatesApi. 
    * @alias module:api/BusinessNameLifecycleStatesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsBusinessNameLifecycleStatesGet operation.
     * @callback module:api/BusinessNameLifecycleStatesApi~classificationsBusinessNameLifecycleStatesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/BusinessNameLifecycleState>} data The data returned by the service call.
     ...
     * @param {module:api/BusinessNameLifecycleStatesApi~classificationsBusinessNameLifecycleStatesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/BusinessNameLifecycleState>}
     */
    classificationsBusinessNameLifecycleStatesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsBusinessNameLifecycleStatesGet");
      }
      ...
      let returnType = [BusinessNameLifecycleState];
      return this.apiClient.callApi(
        '/classifications/business-name-lifecycle-states', 'GET',
