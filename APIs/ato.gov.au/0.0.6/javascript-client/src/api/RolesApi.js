...
export default class RolesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsRolesGet operation.
     * @callback module:api/RolesApi~classificationsRolesGetCallback
     ...
     * @param {module:api/RolesApi~classificationsRolesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Role>}
     */
    classificationsRolesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsRolesGet");
      }
