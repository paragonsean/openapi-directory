...
/**
* LegalEntityTypes service.
* @module api/LegalEntityTypesApi
* @version 0.0.6
*/
export default class LegalEntityTypesApi {

    /**
    * Constructs a new LegalEntityTypesApi. 
    * @alias module:api/LegalEntityTypesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsLegalEntityTypesGet operation.
     * @callback module:api/LegalEntityTypesApi~classificationsLegalEntityTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/LegalEntityType>} data The data returned by the service call.
     ...
     * @param {module:api/LegalEntityTypesApi~classificationsLegalEntityTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/LegalEntityType>}
     */
    classificationsLegalEntityTypesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsLegalEntityTypesGet");
      }
      ...
      let returnType = [LegalEntityType];
      return this.apiClient.callApi(
        '/classifications/legal-entity-types', 'GET',
