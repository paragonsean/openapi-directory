...
/**
* ElectronicAddressTypes service.
* @module api/ElectronicAddressTypesApi
* @version 0.0.6
*/
export default class ElectronicAddressTypesApi {

    /**
    * Constructs a new ElectronicAddressTypesApi. 
    * @alias module:api/ElectronicAddressTypesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the classificationsElectronicAddressTypesGet operation.
     * @callback module:api/ElectronicAddressTypesApi~classificationsElectronicAddressTypesGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ElectronicAddressType>} data The data returned by the service call.
     ...
     * @param {module:api/ElectronicAddressTypesApi~classificationsElectronicAddressTypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ElectronicAddressType>}
     */
    classificationsElectronicAddressTypesGet(apiKey, callback) {
      let postBody = null;
      // verify the required parameter 'apiKey' is set
      if (apiKey === undefined || apiKey === null) {
        throw new Error("Missing the required parameter 'apiKey' when calling classificationsElectronicAddressTypesGet");
      }
      ...
      let returnType = [ElectronicAddressType];
      return this.apiClient.callApi(
        '/classifications/electronic-address-types', 'GET',
