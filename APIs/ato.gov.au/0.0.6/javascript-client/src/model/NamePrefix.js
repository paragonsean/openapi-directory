...
/**
 * The NamePrefix model module.
 * @module model/NamePrefix
 * @version 0.0.6
 */
class NamePrefix {
    /**
     * Constructs a new <code>NamePrefix</code>.
     * @alias module:model/NamePrefix
     * @implements module:model/Type
     */
    constructor() { 
        Type.initialize(this);
        NamePrefix.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NamePrefix</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NamePrefix} obj Optional instance to populate.
     * @return {module:model/NamePrefix} The populated <code>NamePrefix</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NamePrefix();
    ...
    /**
     * Validates the JSON data with respect to <code>NamePrefix</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NamePrefix</code>.
     */
 ...
 */
NamePrefix.prototype['description'] = undefined;

/**
 * The resource's unique identifier.
 * @member {String} id
 */
NamePrefix.prototype['id'] = undefined;

/**
 * The scheme value.
 * @member {String} name
 */
NamePrefix.prototype['name'] = undefined;
