...
/**
 * The BusinessNameLifecycleState model module.
 * @module model/BusinessNameLifecycleState
 * @version 0.0.6
 */
class BusinessNameLifecycleState {
    /**
     * Constructs a new <code>BusinessNameLifecycleState</code>.
     * @alias module:model/BusinessNameLifecycleState
     * @implements module:model/Type
     */
    constructor() { 
        Type.initialize(this);
        BusinessNameLifecycleState.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BusinessNameLifecycleState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BusinessNameLifecycleState} obj Optional instance to populate.
     * @return {module:model/BusinessNameLifecycleState} The populated <code>BusinessNameLifecycleState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BusinessNameLifecycleState();
    ...
    /**
     * Validates the JSON data with respect to <code>BusinessNameLifecycleState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BusinessNameLifecycleState</code>.
     */
 ...
 */
BusinessNameLifecycleState.prototype['description'] = undefined;

/**
 * The resource's unique identifier.
 * @member {String} id
 */
BusinessNameLifecycleState.prototype['id'] = undefined;

/**
 * The scheme value.
 * @member {String} name
 */
BusinessNameLifecycleState.prototype['name'] = undefined;
...
export default BusinessNameLifecycleState;
