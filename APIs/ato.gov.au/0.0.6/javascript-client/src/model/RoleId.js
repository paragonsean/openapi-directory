...
/**
 * The RoleId model module.
 * @module model/RoleId
 * @version 0.0.6
 */
class RoleId {
    /**
     * Constructs a new <code>RoleId</code>.
     * @alias module:model/RoleId
     */
    constructor() { 
        
        RoleId.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RoleId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RoleId} obj Optional instance to populate.
     * @return {module:model/RoleId} The populated <code>RoleId</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>RoleId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RoleId</code>.
     */
