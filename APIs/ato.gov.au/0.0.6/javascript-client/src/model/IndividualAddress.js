...
/**
 * The IndividualAddress model module.
 * @module model/IndividualAddress
 * @version 0.0.6
 */
class IndividualAddress {
    /**
     * Constructs a new <code>IndividualAddress</code>.
     * @alias module:model/IndividualAddress
     * @implements module:model/Address
     */
    constructor() { 
        Address.initialize(this);
        IndividualAddress.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['addressType'] = 'Principal Place of Residence';
    }

    /**
     * Constructs a <code>IndividualAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IndividualAddress} obj Optional instance to populate.
     * @return {module:model/IndividualAddress} The populated <code>IndividualAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IndividualAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>IndividualAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IndividualAddress</code>.
     */
 ...
 * @member {String} city
 */
IndividualAddress.prototype['city'] = undefined;

/**
 * The country.
 * @member {String} country
 */
IndividualAddress.prototype['country'] = undefined;
 ...
 */
IndividualAddress.prototype['fromDate'] = undefined;

/**
 * The resource's unique identifier.
 * @member {module:model/AddressId} id
 */
IndividualAddress.prototype['id'] = undefined;

/**
 * The address line 1.
 * @member {String} line1
 */
IndividualAddress.prototype['line1'] = undefined;

/**
 * The address line 2.
 * @member {String} line2
 */
IndividualAddress.prototype['line2'] = undefined;

/**
 * The address line 3.
 * @member {String} line3
 */
IndividualAddress.prototype['line3'] = undefined;

/**
 * The address name.
 * @member {String} name
 */
IndividualAddress.prototype['name'] = undefined;

/**
 * The postal code.
 * @member {String} postalCode
 */
IndividualAddress.prototype['postalCode'] = undefined;

/**
 * The suburb.
 * @member {String} suburb
 */
IndividualAddress.prototype['suburb'] = undefined;

/**
 * The date and time the resource became inactive in the format defined by [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601).
 * @member {Date} toDate
 */
IndividualAddress.prototype['toDate'] = undefined;

/**
 * The address type.
 * @member {module:model/IndividualAddress.AddressTypeEnum} addressType
 * @default 'Principal Place of Residence'
 */
IndividualAddress.prototype['addressType'] = 'Principal Place of Residence';
 ...
 * @readonly
 */
IndividualAddress['AddressTypeEnum'] = {
