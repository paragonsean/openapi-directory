...
/**
 * The RegisteredIdentifierType model module.
 * @module model/RegisteredIdentifierType
 * @version 0.0.6
 */
class RegisteredIdentifierType {
    /**
     * Constructs a new <code>RegisteredIdentifierType</code>.
     * @alias module:model/RegisteredIdentifierType
     * @implements module:model/Type
     */
    constructor() { 
        Type.initialize(this);
        RegisteredIdentifierType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegisteredIdentifierType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisteredIdentifierType} obj Optional instance to populate.
     * @return {module:model/RegisteredIdentifierType} The populated <code>RegisteredIdentifierType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisteredIdentifierType();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisteredIdentifierType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisteredIdentifierType</code>.
     */
 ...
 */
RegisteredIdentifierType.prototype['description'] = undefined;

/**
 * The resource's unique identifier.
 * @member {String} id
 */
RegisteredIdentifierType.prototype['id'] = undefined;

/**
 * The scheme value.
 * @member {String} name
 */
RegisteredIdentifierType.prototype['name'] = undefined;
...
export default RegisteredIdentifierType;
