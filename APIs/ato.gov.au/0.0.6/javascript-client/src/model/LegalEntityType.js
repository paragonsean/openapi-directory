...
/**
 * The LegalEntityType model module.
 * @module model/LegalEntityType
 * @version 0.0.6
 */
class LegalEntityType {
    /**
     * Constructs a new <code>LegalEntityType</code>.
     * @alias module:model/LegalEntityType
     * @implements module:model/Type
     */
    constructor() { 
        Type.initialize(this);
        LegalEntityType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LegalEntityType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LegalEntityType} obj Optional instance to populate.
     * @return {module:model/LegalEntityType} The populated <code>LegalEntityType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LegalEntityType();
    ...
    /**
     * Validates the JSON data with respect to <code>LegalEntityType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LegalEntityType</code>.
     */
 ...
 */
LegalEntityType.prototype['description'] = undefined;

/**
 * The resource's unique identifier.
 * @member {String} id
 */
LegalEntityType.prototype['id'] = undefined;

/**
 * The scheme value.
 * @member {String} name
 */
LegalEntityType.prototype['name'] = undefined;
