...
/**
 * The PermissionDenied model module.
 * @module model/PermissionDenied
 * @version 0.0.6
 */
class PermissionDenied {
    /**
     * Constructs a new <code>PermissionDenied</code>.
     * @alias module:model/PermissionDenied
     */
    constructor() { 
        
        PermissionDenied.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PermissionDenied</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PermissionDenied} obj Optional instance to populate.
     * @return {module:model/PermissionDenied} The populated <code>PermissionDenied</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PermissionDenied();
    ...
    /**
     * Validates the JSON data with respect to <code>PermissionDenied</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PermissionDenied</code>.
     */
 ...
 * @member {String} code
 */
PermissionDenied.prototype['code'] = undefined;

/**
 * @member {Array.<module:model/ErrorDetails>} details
 */
PermissionDenied.prototype['details'] = undefined;

/**
 * The error message.
 * @member {String} message
 */
PermissionDenied.prototype['message'] = undefined;

/**
 * The error status.
 * @member {String} status
 */
PermissionDenied.prototype['status'] = undefined;
