...
/**
 * The LicenseLifecycleState model module.
 * @module model/LicenseLifecycleState
 * @version 0.0.6
 */
class LicenseLifecycleState {
    /**
     * Constructs a new <code>LicenseLifecycleState</code>.
     * @alias module:model/LicenseLifecycleState
     * @implements module:model/Type
     */
    constructor() { 
        Type.initialize(this);
        LicenseLifecycleState.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LicenseLifecycleState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LicenseLifecycleState} obj Optional instance to populate.
     * @return {module:model/LicenseLifecycleState} The populated <code>LicenseLifecycleState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LicenseLifecycleState();
    ...
    /**
     * Validates the JSON data with respect to <code>LicenseLifecycleState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LicenseLifecycleState</code>.
     */
 ...
 */
LicenseLifecycleState.prototype['description'] = undefined;

/**
 * The resource's unique identifier.
 * @member {String} id
 */
LicenseLifecycleState.prototype['id'] = undefined;

/**
 * The scheme value.
 * @member {String} name
 */
LicenseLifecycleState.prototype['name'] = undefined;
...
export default LicenseLifecycleState;
