...
/**
 * The NameDirection model module.
 * @module model/NameDirection
 * @version 0.0.6
 */
class NameDirection {
    /**
     * Constructs a new <code>NameDirection</code>.
     * @alias module:model/NameDirection
     * @implements module:model/Type
     */
    constructor() { 
        Type.initialize(this);
        NameDirection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NameDirection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NameDirection} obj Optional instance to populate.
     * @return {module:model/NameDirection} The populated <code>NameDirection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NameDirection();
    ...
    /**
     * Validates the JSON data with respect to <code>NameDirection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NameDirection</code>.
     */
 ...
 */
NameDirection.prototype['description'] = undefined;

/**
 * The resource's unique identifier.
 * @member {String} id
 */
NameDirection.prototype['id'] = undefined;

/**
 * The scheme value.
 * @member {String} name
 */
NameDirection.prototype['name'] = undefined;
