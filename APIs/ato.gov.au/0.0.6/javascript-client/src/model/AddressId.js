...
/**
 * The AddressId model module.
 * @module model/AddressId
 * @version 0.0.6
 */
class AddressId {
    /**
     * Constructs a new <code>AddressId</code>.
     * @alias module:model/AddressId
     */
    constructor() { 
        
        AddressId.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddressId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddressId} obj Optional instance to populate.
     * @return {module:model/AddressId} The populated <code>AddressId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddressId();
    ...
    /**
     * Validates the JSON data with respect to <code>AddressId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressId</code>.
     */
