...
/**
 * The PartyId model module.
 * @module model/PartyId
 * @version 0.0.6
 */
class PartyId {
    /**
     * Constructs a new <code>PartyId</code>.
     * @alias module:model/PartyId
     */
    constructor() { 
        
        PartyId.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PartyId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PartyId} obj Optional instance to populate.
     * @return {module:model/PartyId} The populated <code>PartyId</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PartyId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PartyId</code>.
     */
