...
class Role {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('reciprocalRole')) {
                obj['reciprocalRole'] = ApiClient.convertToType(data['reciprocalRole'], 'String');
            }
            if (data.hasOwnProperty('reciprocalRoleDescription')) {
                obj['reciprocalRoleDescription'] = ApiClient.convertToType(data['reciprocalRoleDescription'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['reciprocalRole'] && !(typeof data['reciprocalRole'] === 'string' || data['reciprocalRole'] instanceof String)) {
            throw new Error("Expected the field `reciprocalRole` to be a primitive type in the JSON string but got " + data['reciprocalRole']);
        }
        // ensure the json data is a string
        if (data['reciprocalRoleDescription'] && !(typeof data['reciprocalRoleDescription'] === 'string' || data['reciprocalRoleDescription'] instanceof String)) {
            throw new Error("Expected the field `reciprocalRoleDescription` to be a primitive type in the JSON string but got " + data['reciprocalRoleDescription']);
        }
        // ensure the json data is a string
 ...
 * @member {String} reciprocalRole
 */
Role.prototype['reciprocalRole'] = undefined;

/**
 * The reciprocal role description.
 * @member {String} reciprocalRoleDescription
 */
Role.prototype['reciprocalRoleDescription'] = undefined;

/**
 * The relationship name.
 * @member {String} relationship
 */
Role.prototype['relationship'] = undefined;
 ...
 */
Role.prototype['roleDescription'] = undefined;
