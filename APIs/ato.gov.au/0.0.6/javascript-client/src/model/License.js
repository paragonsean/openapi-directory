...
class License {
    ...
    static initialize(obj) { 
        obj['licenseType'] = 'Australian Financial Services License';
 ...
 */
License.prototype['fromDate'] = undefined;
 ...
 */
License.prototype['licenseType'] = 'Australian Financial Services License';

/**
 * The business name's lifecycle state.
 * @member {module:model/License.LifecycleStateEnum} lifecycleState
 * @default 'Pending Approval'
 */
License.prototype['lifecycleState'] = 'Pending Approval';

/**
 * The date and time the resource became inactive in the format defined by [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601).
 * @member {Date} toDate
 */
License.prototype['toDate'] = undefined;
...
License['LicenseTypeEnum'] = {
     ...
     * @const
     */
    "Australian Financial Services License": "Australian Financial Services License",

    /**
     * value: "License 2B"
     * @const
     */
    "License 2B": "License 2B"
};
