...
/**
 * The FailedPrecondition model module.
 * @module model/FailedPrecondition
 * @version 0.0.6
 */
class FailedPrecondition {
    /**
     * Constructs a new <code>FailedPrecondition</code>.
     * @alias module:model/FailedPrecondition
     */
    constructor() { 
        
        FailedPrecondition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FailedPrecondition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FailedPrecondition} obj Optional instance to populate.
     * @return {module:model/FailedPrecondition} The populated <code>FailedPrecondition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FailedPrecondition();
    ...
    /**
     * Validates the JSON data with respect to <code>FailedPrecondition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FailedPrecondition</code>.
     */
 ...
 * @member {String} code
 */
FailedPrecondition.prototype['code'] = undefined;

/**
 * @member {Array.<module:model/ErrorDetails>} details
 */
FailedPrecondition.prototype['details'] = undefined;

/**
 * The error message.
 * @member {String} message
 */
FailedPrecondition.prototype['message'] = undefined;

/**
 * The error status.
 * @member {String} status
 */
FailedPrecondition.prototype['status'] = undefined;
...
export default FailedPrecondition;
