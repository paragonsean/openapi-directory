...
/**
 * The NameType model module.
 * @module model/NameType
 * @version 0.0.6
 */
class NameType {
    /**
     * Constructs a new <code>NameType</code>.
     * @alias module:model/NameType
     * @implements module:model/Type
     */
    constructor() { 
        Type.initialize(this);
        NameType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NameType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NameType} obj Optional instance to populate.
     * @return {module:model/NameType} The populated <code>NameType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NameType();
    ...
    /**
     * Validates the JSON data with respect to <code>NameType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NameType</code>.
     */
 ...
 */
NameType.prototype['description'] = undefined;

/**
 * The resource's unique identifier.
 * @member {String} id
 */
NameType.prototype['id'] = undefined;

/**
 * The scheme value.
 * @member {String} name
 */
NameType.prototype['name'] = undefined;
