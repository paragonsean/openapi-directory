...
/**
 * The OrganisationName model module.
 * @module model/OrganisationName
 * @version 0.0.6
 */
class OrganisationName {
    /**
     * Constructs a new <code>OrganisationName</code>.
     * The Organisation Name resource.
     * @alias module:model/OrganisationName
     */
    constructor() { 
        
        OrganisationName.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganisationName</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganisationName} obj Optional instance to populate.
     * @return {module:model/OrganisationName} The populated <code>OrganisationName</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganisationName();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganisationName</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganisationName</code>.
     */
 ...
 */
OrganisationName.prototype['fromDate'] = undefined;

/**
 * The resource's unique identifier.
 * @member {String} id
 */
OrganisationName.prototype['id'] = undefined;

/**
 * The organisation's name.
 * @member {String} name
 */
OrganisationName.prototype['name'] = undefined;

/**
 * The date and time the resource became inactive in the format defined by [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601).
 * @member {Date} toDate
 */
OrganisationName.prototype['toDate'] = undefined;
