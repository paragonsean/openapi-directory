...
/**
 * The LicenseType model module.
 * @module model/LicenseType
 * @version 0.0.6
 */
class LicenseType {
    /**
     * Constructs a new <code>LicenseType</code>.
     * @alias module:model/LicenseType
     * @implements module:model/Type
     */
    constructor() { 
        Type.initialize(this);
        LicenseType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LicenseType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LicenseType} obj Optional instance to populate.
     * @return {module:model/LicenseType} The populated <code>LicenseType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LicenseType();
    ...
    /**
     * Validates the JSON data with respect to <code>LicenseType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LicenseType</code>.
     */
 ...
 */
LicenseType.prototype['description'] = undefined;

/**
 * The resource's unique identifier.
 * @member {String} id
 */
LicenseType.prototype['id'] = undefined;

/**
 * The scheme value.
 * @member {String} name
 */
LicenseType.prototype['name'] = undefined;
