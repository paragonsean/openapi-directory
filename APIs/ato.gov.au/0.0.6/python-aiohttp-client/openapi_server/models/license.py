...
class License(Model):
    ...
    def __init__(self, from_date: datetime=None, id: str=None, license_type: str='Australian Financial Services License', lifecycle_state: str='Pending Approval', to_date: datetime=None):
        """License - a model defined in OpenAPI

        :param from_date: The from_date of this License.
        :param id: The id of this License.
        :param license_type: The license_type of this License.
        :param lifecycle_state: The lifecycle_state of this License.
        :param to_date: The to_date of this License.
        """
        self.openapi_types = {
            'from_date': datetime,
            'id': str,
    ...
    def from_date(self, from_date):
        """Sets the from_date of this License.
    ...
    def license_type(self):
        """Gets the license_type of this License.

        The license type.

        :return: The license_type of this License.
        :rtype: str
        """
    ...
    def license_type(self, license_type):
        ...
        """
        allowed_values = ["Australian Financial Services License", "License 2B"]  # noqa: E501
    ...
    def lifecycle_state(self):
        """Gets the lifecycle_state of this License.

        The business name's lifecycle state.

        :return: The lifecycle_state of this License.
        :rtype: str
        """
    ...
    def lifecycle_state(self, lifecycle_state):
        """Sets the lifecycle_state of this License.
    ...
    def to_date(self, to_date):
        """Sets the to_date of this License.
