...
OAITaxRatesByCountryCode_200_response::OAITaxRatesByCountryCode_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITaxRatesByCountryCode_200_response::OAITaxRatesByCountryCode_200_response() {
    this->initializeModel();
}

OAITaxRatesByCountryCode_200_response::~OAITaxRatesByCountryCode_200_response() {}

void OAITaxRatesByCountryCode_200_response::initializeModel() {
...
void OAITaxRatesByCountryCode_200_response::fromJson(QString jsonString) {
...
void OAITaxRatesByCountryCode_200_response::fromJsonObject(QJsonObject json) {
...
QString OAITaxRatesByCountryCode_200_response::asJson() const {
...
QJsonObject OAITaxRatesByCountryCode_200_response::asJsonObject() const {
    QJsonObject obj;
...
QString OAITaxRatesByCountryCode_200_response::getCountryName() const {
    return m_country_name;
}
void OAITaxRatesByCountryCode_200_response::setCountryName(const QString &country_name) {
    m_country_name = country_name;
    m_country_name_isSet = true;
}

bool OAITaxRatesByCountryCode_200_response::is_country_name_Set() const{
    return m_country_name_isSet;
}

bool OAITaxRatesByCountryCode_200_response::is_country_name_Valid() const{
    return m_country_name_isValid;
}

QList<OAITaxRatesByCountryCode_200_response_taxes_inner> OAITaxRatesByCountryCode_200_response::getTaxes() const {
    return m_taxes;
}
void OAITaxRatesByCountryCode_200_response::setTaxes(const QList<OAITaxRatesByCountryCode_200_response_taxes_inner> &taxes) {
    m_taxes = taxes;
    m_taxes_isSet = true;
}

bool OAITaxRatesByCountryCode_200_response::is_taxes_Set() const{
    return m_taxes_isSet;
}

bool OAITaxRatesByCountryCode_200_response::is_taxes_Valid() const{
    return m_taxes_isValid;
}

bool OAITaxRatesByCountryCode_200_response::isSet() const {
...
bool OAITaxRatesByCountryCode_200_response::isValid() const {
