...
/*
 * OAITaxRatesByCountryCode_200_response_taxes_inner.h
 *
 * 
 */

#ifndef OAITaxRatesByCountryCode_200_response_taxes_inner_H
#define OAITaxRatesByCountryCode_200_response_taxes_inner_H
...
class OAITaxRatesByCountryCode_200_response_taxes_inner : public OAIObject {
public:
    OAITaxRatesByCountryCode_200_response_taxes_inner();
    OAITaxRatesByCountryCode_200_response_taxes_inner(QString json);
    ~OAITaxRatesByCountryCode_200_response_taxes_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaxRatesByCountryCode_200_response_taxes_inner)

#endif // OAITaxRatesByCountryCode_200_response_taxes_inner_H
