...
OAIV3TaxApi::OAIV3TaxApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIV3TaxApi::~OAIV3TaxApi() {
}

void OAIV3TaxApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("allTaxRates", defaultConf);
    _serverIndices.insert("allTaxRates", 0);
}
...
*/
int OAIV3TaxApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIV3TaxApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIV3TaxApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIV3TaxApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIV3TaxApi::setUsername(const QString &username) {
    _username = username;
}

void OAIV3TaxApi::setPassword(const QString &password) {
    _password = password;
}


void OAIV3TaxApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIV3TaxApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIV3TaxApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIV3TaxApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIV3TaxApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIV3TaxApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIV3TaxApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIV3TaxApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIV3TaxApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIV3TaxApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIV3TaxApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIV3TaxApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIV3TaxApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIV3TaxApi::allTaxRates(const ::OpenAPI::OptionalParam<QString> &domain, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<QString> &product_code) {
    QString fullPath = QString(_serverConfigs["allTaxRates"][_serverIndices.value("allTaxRates")].URL()+"/v3/tax/rates");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV3TaxApi::allTaxRatesCallback);
    connect(this, &OAIV3TaxApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIV3TaxApi::allTaxRatesCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIAllTaxRates_200_response_inner> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIAllTaxRates_200_response_inner val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT allTaxRatesSignal(output);
        Q_EMIT allTaxRatesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT allTaxRatesSignalE(output, error_type, error_str);
        Q_EMIT allTaxRatesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT allTaxRatesSignalError(output, error_type, error_str);
        Q_EMIT allTaxRatesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIV3TaxApi::tokenAvailable(){
