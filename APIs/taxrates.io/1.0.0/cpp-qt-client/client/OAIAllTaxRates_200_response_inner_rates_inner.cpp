...
#include "OAIAllTaxRates_200_response_inner_rates_inner.h"
...
OAIAllTaxRates_200_response_inner_rates_inner::OAIAllTaxRates_200_response_inner_rates_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAllTaxRates_200_response_inner_rates_inner::OAIAllTaxRates_200_response_inner_rates_inner() {
    this->initializeModel();
}

OAIAllTaxRates_200_response_inner_rates_inner::~OAIAllTaxRates_200_response_inner_rates_inner() {}

void OAIAllTaxRates_200_response_inner_rates_inner::initializeModel() {
...
void OAIAllTaxRates_200_response_inner_rates_inner::fromJson(QString jsonString) {
...
void OAIAllTaxRates_200_response_inner_rates_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAllTaxRates_200_response_inner_rates_inner::asJson() const {
...
QJsonObject OAIAllTaxRates_200_response_inner_rates_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAllTaxRates_200_response_inner_rates_inner::getDataName() const {
    return m_data_name;
}
void OAIAllTaxRates_200_response_inner_rates_inner::setDataName(const QString &data_name) {
    m_data_name = data_name;
    m_data_name_isSet = true;
}

bool OAIAllTaxRates_200_response_inner_rates_inner::is_data_name_Set() const{
    return m_data_name_isSet;
}

bool OAIAllTaxRates_200_response_inner_rates_inner::is_data_name_Valid() const{
    return m_data_name_isValid;
}

QString OAIAllTaxRates_200_response_inner_rates_inner::getDataValue() const {
    return m_data_value;
}
void OAIAllTaxRates_200_response_inner_rates_inner::setDataValue(const QString &data_value) {
    m_data_value = data_value;
    m_data_value_isSet = true;
}

bool OAIAllTaxRates_200_response_inner_rates_inner::is_data_value_Set() const{
    return m_data_value_isSet;
}

bool OAIAllTaxRates_200_response_inner_rates_inner::is_data_value_Valid() const{
    return m_data_value_isValid;
}

QString OAIAllTaxRates_200_response_inner_rates_inner::getProductCode() const {
    return m_product_code;
}
void OAIAllTaxRates_200_response_inner_rates_inner::setProductCode(const QString &product_code) {
    m_product_code = product_code;
    m_product_code_isSet = true;
}

bool OAIAllTaxRates_200_response_inner_rates_inner::is_product_code_Set() const{
    return m_product_code_isSet;
}

bool OAIAllTaxRates_200_response_inner_rates_inner::is_product_code_Valid() const{
    return m_product_code_isValid;
}

QString OAIAllTaxRates_200_response_inner_rates_inner::getType() const {
    return m_type;
}
void OAIAllTaxRates_200_response_inner_rates_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAllTaxRates_200_response_inner_rates_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAllTaxRates_200_response_inner_rates_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAllTaxRates_200_response_inner_rates_inner::isSet() const {
...
bool OAIAllTaxRates_200_response_inner_rates_inner::isValid() const {
