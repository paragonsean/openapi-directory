...
#ifndef OAI_OAIV3TaxApi_H
#define OAI_OAIV3TaxApi_H
...
#include "OAIAllTaxRates_200_response_inner.h"
...
class OAIV3TaxApi : public QObject {
    Q_OBJECT

public:
    OAIV3TaxApi(const int timeOut = 0);
    ~OAIV3TaxApi();
    ...
    */
    virtual void allTaxRates(const ::OpenAPI::OptionalParam<QString> &domain = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &cursor = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &product_code = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void allTaxRatesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void allTaxRatesSignal(QList<OAIAllTaxRates_200_response_inner> summary);


    void allTaxRatesSignalFull(OAIHttpRequestWorker *worker, QList<OAIAllTaxRates_200_response_inner> summary);

    Q_DECL_DEPRECATED_X("Use allTaxRatesSignalError() instead")
    void allTaxRatesSignalE(QList<OAIAllTaxRates_200_response_inner> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void allTaxRatesSignalError(QList<OAIAllTaxRates_200_response_inner> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use allTaxRatesSignalErrorFull() instead")
    void allTaxRatesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void allTaxRatesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
