...
/*
 * OAIAllTaxRates_200_response_inner.h
 *
 * 
 */

#ifndef OAIAllTaxRates_200_response_inner_H
#define OAIAllTaxRates_200_response_inner_H
...
namespace OpenAPI {
class OAIAllTaxRates_200_response_inner_rates_inner;

class OAIAllTaxRates_200_response_inner : public OAIObject {
public:
    OAIAllTaxRates_200_response_inner();
    OAIAllTaxRates_200_response_inner(QString json);
    ~OAIAllTaxRates_200_response_inner() override;
    ...
    QList<OAIAllTaxRates_200_response_inner_rates_inner> getRates() const;
    void setRates(const QList<OAIAllTaxRates_200_response_inner_rates_inner> &rates);
...
private:
    ...
    QList<OAIAllTaxRates_200_response_inner_rates_inner> m_rates;
    bool m_rates_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAllTaxRates_200_response_inner)

#endif // OAIAllTaxRates_200_response_inner_H
