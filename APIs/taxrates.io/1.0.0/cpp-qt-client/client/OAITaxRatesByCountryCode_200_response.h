...
/*
 * OAITaxRatesByCountryCode_200_response.h
 *
 * 
 */

#ifndef OAITaxRatesByCountryCode_200_response_H
#define OAITaxRatesByCountryCode_200_response_H
...
namespace OpenAPI {
class OAITaxRatesByCountryCode_200_response_taxes_inner;

class OAITaxRatesByCountryCode_200_response : public OAIObject {
public:
    OAITaxRatesByCountryCode_200_response();
    OAITaxRatesByCountryCode_200_response(QString json);
    ~OAITaxRatesByCountryCode_200_response() override;
    ...
    QList<OAITaxRatesByCountryCode_200_response_taxes_inner> getTaxes() const;
    void setTaxes(const QList<OAITaxRatesByCountryCode_200_response_taxes_inner> &taxes);
...
private:
    ...
    QList<OAITaxRatesByCountryCode_200_response_taxes_inner> m_taxes;
    bool m_taxes_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaxRatesByCountryCode_200_response)

#endif // OAITaxRatesByCountryCode_200_response_H
