...
OAIAllTaxRates_200_response_inner::OAIAllTaxRates_200_response_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAllTaxRates_200_response_inner::OAIAllTaxRates_200_response_inner() {
    this->initializeModel();
}

OAIAllTaxRates_200_response_inner::~OAIAllTaxRates_200_response_inner() {}

void OAIAllTaxRates_200_response_inner::initializeModel() {
...
void OAIAllTaxRates_200_response_inner::fromJson(QString jsonString) {
...
void OAIAllTaxRates_200_response_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAllTaxRates_200_response_inner::asJson() const {
...
QJsonObject OAIAllTaxRates_200_response_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIAllTaxRates_200_response_inner::getId() const {
    return m_id;
}
void OAIAllTaxRates_200_response_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAllTaxRates_200_response_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAllTaxRates_200_response_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIAllTaxRates_200_response_inner::getName() const {
    return m_name;
}
void OAIAllTaxRates_200_response_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAllTaxRates_200_response_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAllTaxRates_200_response_inner::is_name_Valid() const{
    return m_name_isValid;
}

QList<OAIAllTaxRates_200_response_inner_rates_inner> OAIAllTaxRates_200_response_inner::getRates() const {
    return m_rates;
}
void OAIAllTaxRates_200_response_inner::setRates(const QList<OAIAllTaxRates_200_response_inner_rates_inner> &rates) {
    m_rates = rates;
    m_rates_isSet = true;
}

bool OAIAllTaxRates_200_response_inner::is_rates_Set() const{
    return m_rates_isSet;
}

bool OAIAllTaxRates_200_response_inner::is_rates_Valid() const{
    return m_rates_isValid;
}

QString OAIAllTaxRates_200_response_inner::getState() const {
    return m_state;
}
void OAIAllTaxRates_200_response_inner::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIAllTaxRates_200_response_inner::is_state_Set() const{
    return m_state_isSet;
}

bool OAIAllTaxRates_200_response_inner::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIAllTaxRates_200_response_inner::getZip() const {
    return m_zip;
}
void OAIAllTaxRates_200_response_inner::setZip(const QString &zip) {
    m_zip = zip;
    m_zip_isSet = true;
}

bool OAIAllTaxRates_200_response_inner::is_zip_Set() const{
    return m_zip_isSet;
}

bool OAIAllTaxRates_200_response_inner::is_zip_Valid() const{
    return m_zip_isValid;
}

bool OAIAllTaxRates_200_response_inner::isSet() const {
...
bool OAIAllTaxRates_200_response_inner::isValid() const {
