...
/*
 * OAITaxRatesByCountryCode_500_response.h
 *
 * 
 */

#ifndef OAITaxRatesByCountryCode_500_response_H
#define OAITaxRatesByCountryCode_500_response_H
...
class OAITaxRatesByCountryCode_500_response : public OAIObject {
public:
    OAITaxRatesByCountryCode_500_response();
    OAITaxRatesByCountryCode_500_response(QString json);
    ~OAITaxRatesByCountryCode_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaxRatesByCountryCode_500_response)

#endif // OAITaxRatesByCountryCode_500_response_H
