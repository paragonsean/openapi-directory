...
#ifndef OAI_OAIV1TaxApi_H
#define OAI_OAIV1TaxApi_H
...
#include "OAITaxRatesByCountryCode_200_response.h"
#include "OAITaxRatesByCountryCode_500_response.h"
#include <QString>
...
class OAIV1TaxApi : public QObject {
    Q_OBJECT

public:
    OAIV1TaxApi(const int timeOut = 0);
    ~OAIV1TaxApi();
    ...
    * @param[in]  product_codes QString [optional]
    * @param[in]  province_ QString [optional]
    * @param[in]  date QString [optional]
    */
    virtual void taxRatesByCountryCode(const ::OpenAPI::OptionalParam<QString> &domain = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &country_code = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &zip = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &product_codes = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &province_ = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &date = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void taxRatesByIpAddress(const ::OpenAPI::OptionalParam<QString> &domain = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &ip = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &zip = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &product_code = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void taxRatesByCountryCodeCallback(OAIHttpRequestWorker *worker);
    void taxRatesByIpAddressCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void taxRatesByCountryCodeSignal(OAITaxRatesByCountryCode_200_response summary);
    void taxRatesByIpAddressSignal(QList<OAITaxRatesByCountryCode_200_response> summary);


    void taxRatesByCountryCodeSignalFull(OAIHttpRequestWorker *worker, OAITaxRatesByCountryCode_200_response summary);
    void taxRatesByIpAddressSignalFull(OAIHttpRequestWorker *worker, QList<OAITaxRatesByCountryCode_200_response> summary);

    Q_DECL_DEPRECATED_X("Use taxRatesByCountryCodeSignalError() instead")
    void taxRatesByCountryCodeSignalE(OAITaxRatesByCountryCode_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void taxRatesByCountryCodeSignalError(OAITaxRatesByCountryCode_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use taxRatesByIpAddressSignalError() instead")
    void taxRatesByIpAddressSignalE(QList<OAITaxRatesByCountryCode_200_response> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void taxRatesByIpAddressSignalError(QList<OAITaxRatesByCountryCode_200_response> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use taxRatesByCountryCodeSignalErrorFull() instead")
    void taxRatesByCountryCodeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void taxRatesByCountryCodeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use taxRatesByIpAddressSignalErrorFull() instead")
    void taxRatesByIpAddressSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void taxRatesByIpAddressSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
