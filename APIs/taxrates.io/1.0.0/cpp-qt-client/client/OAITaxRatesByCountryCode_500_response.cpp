...
OAITaxRatesByCountryCode_500_response::OAITaxRatesByCountryCode_500_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITaxRatesByCountryCode_500_response::OAITaxRatesByCountryCode_500_response() {
    this->initializeModel();
}

OAITaxRatesByCountryCode_500_response::~OAITaxRatesByCountryCode_500_response() {}

void OAITaxRatesByCountryCode_500_response::initializeModel() {
...
void OAITaxRatesByCountryCode_500_response::fromJson(QString jsonString) {
...
void OAITaxRatesByCountryCode_500_response::fromJsonObject(QJsonObject json) {
...
QString OAITaxRatesByCountryCode_500_response::asJson() const {
...
QJsonObject OAITaxRatesByCountryCode_500_response::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAITaxRatesByCountryCode_500_response::getCode() const {
    return m_code;
}
void OAITaxRatesByCountryCode_500_response::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAITaxRatesByCountryCode_500_response::is_code_Set() const{
    return m_code_isSet;
}

bool OAITaxRatesByCountryCode_500_response::is_code_Valid() const{
    return m_code_isValid;
}

QString OAITaxRatesByCountryCode_500_response::getFields() const {
    return m_fields;
}
void OAITaxRatesByCountryCode_500_response::setFields(const QString &fields) {
    m_fields = fields;
    m_fields_isSet = true;
}

bool OAITaxRatesByCountryCode_500_response::is_fields_Set() const{
    return m_fields_isSet;
}

bool OAITaxRatesByCountryCode_500_response::is_fields_Valid() const{
    return m_fields_isValid;
}

QString OAITaxRatesByCountryCode_500_response::getMessage() const {
    return m_message;
}
void OAITaxRatesByCountryCode_500_response::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAITaxRatesByCountryCode_500_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAITaxRatesByCountryCode_500_response::is_message_Valid() const{
    return m_message_isValid;
}

bool OAITaxRatesByCountryCode_500_response::isSet() const {
...
bool OAITaxRatesByCountryCode_500_response::isValid() const {
