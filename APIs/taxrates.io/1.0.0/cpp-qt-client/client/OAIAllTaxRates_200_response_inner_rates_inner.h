...
/*
 * OAIAllTaxRates_200_response_inner_rates_inner.h
 *
 * 
 */

#ifndef OAIAllTaxRates_200_response_inner_rates_inner_H
#define OAIAllTaxRates_200_response_inner_rates_inner_H
...
class OAIAllTaxRates_200_response_inner_rates_inner : public OAIObject {
public:
    OAIAllTaxRates_200_response_inner_rates_inner();
    OAIAllTaxRates_200_response_inner_rates_inner(QString json);
    ~OAIAllTaxRates_200_response_inner_rates_inner() override;
    ...
    bool is_data_name_Set() const;
    bool is_data_name_Valid() const;

    QString getDataValue() const;
    void setDataValue(const QString &data_value);
...
private:
    ...
    QString m_data_name;
    bool m_data_name_isSet;
    bool m_data_name_isValid;

    QString m_data_value;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAllTaxRates_200_response_inner_rates_inner)

#endif // OAIAllTaxRates_200_response_inner_rates_inner_H
