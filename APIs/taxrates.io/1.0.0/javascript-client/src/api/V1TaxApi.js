...
import TaxRatesByCountryCode200Response from '../model/TaxRatesByCountryCode200Response';
...
* @version 1.0.0
*/
export default class V1TaxApi {

    /**
    * Constructs a new V1TaxApi. 
    * @alias module:api/V1TaxApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the taxRatesByCountryCode operation.
     * @callback module:api/V1TaxApi~taxRatesByCountryCodeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TaxRatesByCountryCode200Response} data The data returned by the service call.
     ...
     * @param {String} [productCodes] Use one or many product code/s.
     * @param {String} [province] Use for Canada
     * @param {String} [date] 
     * @param {module:api/V1TaxApi~taxRatesByCountryCodeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TaxRatesByCountryCode200Response}
     */
    taxRatesByCountryCode(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = TaxRatesByCountryCode200Response;
    ...
    /**
     * Callback function to receive the result of the taxRatesByIpAddress operation.
     * @callback module:api/V1TaxApi~taxRatesByIpAddressCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/TaxRatesByCountryCode200Response>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [productCode] Your can filter your taxes by product code
     * @param {module:api/V1TaxApi~taxRatesByIpAddressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/TaxRatesByCountryCode200Response>}
     */
    taxRatesByIpAddress(opts, callback) {
      opts = opts || {};
      let postBody = null;
