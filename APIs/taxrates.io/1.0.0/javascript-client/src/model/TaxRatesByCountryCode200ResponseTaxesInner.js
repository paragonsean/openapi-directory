...
/**
 * The TaxRatesByCountryCode200ResponseTaxesInner model module.
 * @module model/TaxRatesByCountryCode200ResponseTaxesInner
 * @version 1.0.0
 */
class TaxRatesByCountryCode200ResponseTaxesInner {
    /**
     * Constructs a new <code>TaxRatesByCountryCode200ResponseTaxesInner</code>.
     * @alias module:model/TaxRatesByCountryCode200ResponseTaxesInner
     */
    constructor() { 
        
        TaxRatesByCountryCode200ResponseTaxesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TaxRatesByCountryCode200ResponseTaxesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TaxRatesByCountryCode200ResponseTaxesInner} obj Optional instance to populate.
     * @return {module:model/TaxRatesByCountryCode200ResponseTaxesInner} The populated <code>TaxRatesByCountryCode200ResponseTaxesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TaxRatesByCountryCode200ResponseTaxesInner();
            ...
            if (data.hasOwnProperty('data_name')) {
                obj['data_name'] = ApiClient.convertToType(data['data_name'], 'String');
            }
            if (data.hasOwnProperty('data_value')) {
                obj['data_value'] = ApiClient.convertToType(data['data_value'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TaxRatesByCountryCode200ResponseTaxesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TaxRatesByCountryCode200ResponseTaxesInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['data_name'] && !(typeof data['data_name'] === 'string' || data['data_name'] instanceof String)) {
            throw new Error("Expected the field `data_name` to be a primitive type in the JSON string but got " + data['data_name']);
        }
        // ensure the json data is a string
        if (data['data_value'] && !(typeof data['data_value'] === 'string' || data['data_value'] instanceof String)) {
            throw new Error("Expected the field `data_value` to be a primitive type in the JSON string but got " + data['data_value']);
        }
 ...
 */
TaxRatesByCountryCode200ResponseTaxesInner.prototype['Country'] = undefined;

/**
 * @member {String} Type
 */
TaxRatesByCountryCode200ResponseTaxesInner.prototype['Type'] = undefined;

/**
 * @member {String} data_name
 */
TaxRatesByCountryCode200ResponseTaxesInner.prototype['data_name'] = undefined;

/**
 * @member {String} data_value
 */
TaxRatesByCountryCode200ResponseTaxesInner.prototype['data_value'] = undefined;
...
export default TaxRatesByCountryCode200ResponseTaxesInner;
