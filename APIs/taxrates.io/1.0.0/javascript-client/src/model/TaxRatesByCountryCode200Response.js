...
import TaxRatesByCountryCode200ResponseTaxesInner from './TaxRatesByCountryCode200ResponseTaxesInner';

/**
 * The TaxRatesByCountryCode200Response model module.
 * @module model/TaxRatesByCountryCode200Response
 * @version 1.0.0
 */
class TaxRatesByCountryCode200Response {
    /**
     * Constructs a new <code>TaxRatesByCountryCode200Response</code>.
     * @alias module:model/TaxRatesByCountryCode200Response
     */
    constructor() { 
        
        TaxRatesByCountryCode200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TaxRatesByCountryCode200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TaxRatesByCountryCode200Response} obj Optional instance to populate.
     * @return {module:model/TaxRatesByCountryCode200Response} The populated <code>TaxRatesByCountryCode200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TaxRatesByCountryCode200Response();

            if (data.hasOwnProperty('country_name')) {
                obj['country_name'] = ApiClient.convertToType(data['country_name'], 'String');
            }
            if (data.hasOwnProperty('taxes')) {
                obj['taxes'] = ApiClient.convertToType(data['taxes'], [TaxRatesByCountryCode200ResponseTaxesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TaxRatesByCountryCode200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TaxRatesByCountryCode200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['taxes']) { // data not null
            ...
            for (const item of data['taxes']) {
                TaxRatesByCountryCode200ResponseTaxesInner.validateJSON(item);
            };
        }
 ...
 */
TaxRatesByCountryCode200Response.prototype['country_name'] = undefined;

/**
 * @member {Array.<module:model/TaxRatesByCountryCode200ResponseTaxesInner>} taxes
 */
TaxRatesByCountryCode200Response.prototype['taxes'] = undefined;
...
export default TaxRatesByCountryCode200Response;
