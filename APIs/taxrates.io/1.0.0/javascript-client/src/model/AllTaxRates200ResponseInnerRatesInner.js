...
/**
 * The AllTaxRates200ResponseInnerRatesInner model module.
 * @module model/AllTaxRates200ResponseInnerRatesInner
 * @version 1.0.0
 */
class AllTaxRates200ResponseInnerRatesInner {
    /**
     * Constructs a new <code>AllTaxRates200ResponseInnerRatesInner</code>.
     * @alias module:model/AllTaxRates200ResponseInnerRatesInner
     */
    constructor() { 
        
        AllTaxRates200ResponseInnerRatesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AllTaxRates200ResponseInnerRatesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllTaxRates200ResponseInnerRatesInner} obj Optional instance to populate.
     * @return {module:model/AllTaxRates200ResponseInnerRatesInner} The populated <code>AllTaxRates200ResponseInnerRatesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllTaxRates200ResponseInnerRatesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>AllTaxRates200ResponseInnerRatesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllTaxRates200ResponseInnerRatesInner</code>.
     */
 ...
 */
AllTaxRates200ResponseInnerRatesInner.prototype['data_name'] = undefined;

/**
 * @member {String} data_value
 */
AllTaxRates200ResponseInnerRatesInner.prototype['data_value'] = undefined;

/**
 * @member {String} product_code
 */
AllTaxRates200ResponseInnerRatesInner.prototype['product_code'] = undefined;

/**
 * @member {String} type
 */
AllTaxRates200ResponseInnerRatesInner.prototype['type'] = undefined;
...
export default AllTaxRates200ResponseInnerRatesInner;
