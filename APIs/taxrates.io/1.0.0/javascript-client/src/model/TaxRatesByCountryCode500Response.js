...
/**
 * The TaxRatesByCountryCode500Response model module.
 * @module model/TaxRatesByCountryCode500Response
 * @version 1.0.0
 */
class TaxRatesByCountryCode500Response {
    /**
     * Constructs a new <code>TaxRatesByCountryCode500Response</code>.
     * @alias module:model/TaxRatesByCountryCode500Response
     */
    constructor() { 
        
        TaxRatesByCountryCode500Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TaxRatesByCountryCode500Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TaxRatesByCountryCode500Response} obj Optional instance to populate.
     * @return {module:model/TaxRatesByCountryCode500Response} The populated <code>TaxRatesByCountryCode500Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TaxRatesByCountryCode500Response();
    ...
    /**
     * Validates the JSON data with respect to <code>TaxRatesByCountryCode500Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TaxRatesByCountryCode500Response</code>.
     */
 ...
 * @member {String} code
 */
TaxRatesByCountryCode500Response.prototype['code'] = undefined;

/**
 * @member {String} fields
 */
TaxRatesByCountryCode500Response.prototype['fields'] = undefined;

/**
 * @member {String} message
 */
TaxRatesByCountryCode500Response.prototype['message'] = undefined;
...
export default TaxRatesByCountryCode500Response;
