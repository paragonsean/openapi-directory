...
import AllTaxRates200ResponseInnerRatesInner from './AllTaxRates200ResponseInnerRatesInner';

/**
 * The AllTaxRates200ResponseInner model module.
 * @module model/AllTaxRates200ResponseInner
 * @version 1.0.0
 */
class AllTaxRates200ResponseInner {
    /**
     * Constructs a new <code>AllTaxRates200ResponseInner</code>.
     * @alias module:model/AllTaxRates200ResponseInner
     */
    constructor() { 
        
        AllTaxRates200ResponseInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AllTaxRates200ResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AllTaxRates200ResponseInner} obj Optional instance to populate.
     * @return {module:model/AllTaxRates200ResponseInner} The populated <code>AllTaxRates200ResponseInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AllTaxRates200ResponseInner();
            ...
            if (data.hasOwnProperty('rates')) {
                obj['rates'] = ApiClient.convertToType(data['rates'], [AllTaxRates200ResponseInnerRatesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AllTaxRates200ResponseInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AllTaxRates200ResponseInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['rates']) { // data not null
            ...
            for (const item of data['rates']) {
                AllTaxRates200ResponseInnerRatesInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {String} id
 */
AllTaxRates200ResponseInner.prototype['id'] = undefined;

/**
 * @member {String} name
 */
AllTaxRates200ResponseInner.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/AllTaxRates200ResponseInnerRatesInner>} rates
 */
AllTaxRates200ResponseInner.prototype['rates'] = undefined;

/**
 * @member {String} state
 */
AllTaxRates200ResponseInner.prototype['state'] = undefined;

/**
 * @member {String} zip
 */
AllTaxRates200ResponseInner.prototype['zip'] = undefined;
...
export default AllTaxRates200ResponseInner;
