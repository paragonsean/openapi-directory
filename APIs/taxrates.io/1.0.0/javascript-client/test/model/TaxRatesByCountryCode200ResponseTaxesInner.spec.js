...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaxratesIoApi.TaxRatesByCountryCode200ResponseTaxesInner();
  });
  ...
  describe('TaxRatesByCountryCode200ResponseTaxesInner', function() {
    it('should create an instance of TaxRatesByCountryCode200ResponseTaxesInner', function() {
      // uncomment below and update the code to test TaxRatesByCountryCode200ResponseTaxesInner
      //var instance = new TaxratesIoApi.TaxRatesByCountryCode200ResponseTaxesInner();
      //expect(instance).to.be.a(TaxratesIoApi.TaxRatesByCountryCode200ResponseTaxesInner);
    });
