...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.TaxratesIoApi);
  }
}(this, function(expect, TaxratesIoApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new TaxratesIoApi.AllTaxRates200ResponseInnerRatesInner();
  });
  ...
  describe('AllTaxRates200ResponseInnerRatesInner', function() {
    it('should create an instance of AllTaxRates200ResponseInnerRatesInner', function() {
      // uncomment below and update the code to test AllTaxRates200ResponseInnerRatesInner
      //var instance = new TaxratesIoApi.AllTaxRates200ResponseInnerRatesInner();
      //expect(instance).to.be.a(TaxratesIoApi.AllTaxRates200ResponseInnerRatesInner);
    });

    it('should have the property dataName (base name: "data_name")', function() {
      // uncomment below and update the code to test the property dataName
      //var instance = new TaxratesIoApi.AllTaxRates200ResponseInnerRatesInner();
      //expect(instance).to.be();
    });

    it('should have the property dataValue (base name: "data_value")', function() {
