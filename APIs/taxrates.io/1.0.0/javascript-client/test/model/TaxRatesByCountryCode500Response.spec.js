...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaxratesIoApi.TaxRatesByCountryCode500Response();
  });
  ...
  describe('TaxRatesByCountryCode500Response', function() {
    it('should create an instance of TaxRatesByCountryCode500Response', function() {
      // uncomment below and update the code to test TaxRatesByCountryCode500Response
      //var instance = new TaxratesIoApi.TaxRatesByCountryCode500Response();
      //expect(instance).to.be.a(TaxratesIoApi.TaxRatesByCountryCode500Response);
    });
