...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaxratesIoApi.TaxRatesByCountryCode200Response();
  });
  ...
  describe('TaxRatesByCountryCode200Response', function() {
    it('should create an instance of TaxRatesByCountryCode200Response', function() {
      // uncomment below and update the code to test TaxRatesByCountryCode200Response
      //var instance = new TaxratesIoApi.TaxRatesByCountryCode200Response();
      //expect(instance).to.be.a(TaxratesIoApi.TaxRatesByCountryCode200Response);
    });
