...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaxratesIoApi.V1TaxApi();
  });
  ...
  describe('V1TaxApi', function() {
    describe('taxRatesByCountryCode', function() {
      it('should call taxRatesByCountryCode successfully', function(done) {
        //uncomment below and update the code to test taxRatesByCountryCode
        //instance.taxRatesByCountryCode(function(error) {
    ...
    describe('taxRatesByIpAddress', function() {
      it('should call taxRatesByIpAddress successfully', function(done) {
        //uncomment below and update the code to test taxRatesByIpAddress
        //instance.taxRatesByIpAddress(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
