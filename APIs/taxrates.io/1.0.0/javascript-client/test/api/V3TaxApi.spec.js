...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TaxratesIoApi.V3TaxApi();
  });
  ...
  describe('V3TaxApi', function() {
    describe('allTaxRates', function() {
      it('should call allTaxRates successfully', function(done) {
        //uncomment below and update the code to test allTaxRates
        //instance.allTaxRates(function(error) {
