...
<a id="allTaxRates"></a>
# **allTaxRates**
> List&lt;AllTaxRates200ResponseInner&gt; allTaxRates(domain, filter, cursor, productCode)
...
import org.openapitools.client.api.V3TaxApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    V3TaxApi apiInstance = new V3TaxApi(defaultClient);
    String domain = "<string>"; // String | Domain name: api.taxrates.io
    String filter = ""; // String | You can filter your taxes by one of following types: 'standard', 'CombinedRate', 'CountyRate', 'CityRate', 'SPDRate' and 'MTARate'.
    String cursor = ""; // String | Cursor shows from which record you want to get information. Default value is 0, next value can be retrieved from X-Cursor-Next header.
    String productCode = "C012"; // String | 
    try {
      List<AllTaxRates200ResponseInner> result = apiInstance.allTaxRates(domain, filter, cursor, productCode);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling V3TaxApi#allTaxRates");
...
[**List&lt;AllTaxRates200ResponseInner&gt;**](AllTaxRates200ResponseInner.md)
...
|-------------|-------------|------------------|
| **200** | An array of locations with tax rates |  -  |
| **404** | No configured tax rates found. Have you added any country to your account? |  -  |
