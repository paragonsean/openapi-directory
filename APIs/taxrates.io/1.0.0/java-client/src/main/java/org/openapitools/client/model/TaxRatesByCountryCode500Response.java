...
public class TaxRatesByCountryCode500Response {
  ...
  public TaxRatesByCountryCode500Response() {
  }

  public TaxRatesByCountryCode500Response code(String code) {
    this.code = code;
    return this;
  }
  ...
  public TaxRatesByCountryCode500Response fields(String fields) {
    this.fields = fields;
    return this;
  }
  ...
  public TaxRatesByCountryCode500Response message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    TaxRatesByCountryCode500Response taxRatesByCountryCode500Response = (TaxRatesByCountryCode500Response) o;
    return Objects.equals(this.code, taxRatesByCountryCode500Response.code) &&
        Objects.equals(this.fields, taxRatesByCountryCode500Response.fields) &&
        Objects.equals(this.message, taxRatesByCountryCode500Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class TaxRatesByCountryCode500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TaxRatesByCountryCode500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TaxRatesByCountryCode500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaxRatesByCountryCode500Response is not found in the empty JSON string", TaxRatesByCountryCode500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TaxRatesByCountryCode500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaxRatesByCountryCode500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaxRatesByCountryCode500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaxRatesByCountryCode500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaxRatesByCountryCode500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaxRatesByCountryCode500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<TaxRatesByCountryCode500Response>() {
           @Override
           public void write(JsonWriter out, TaxRatesByCountryCode500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaxRatesByCountryCode500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TaxRatesByCountryCode500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TaxRatesByCountryCode500Response
   * @throws IOException if the JSON string is invalid with respect to TaxRatesByCountryCode500Response
   */
  public static TaxRatesByCountryCode500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaxRatesByCountryCode500Response.class);
  }

  /**
   * Convert an instance of TaxRatesByCountryCode500Response to an JSON string
   *
   * @return JSON string
   */
