...
public class AllTaxRates200ResponseInner {
  ...
  private List<AllTaxRates200ResponseInnerRatesInner> rates = new ArrayList<>();
  ...
  public AllTaxRates200ResponseInner() {
  }

  public AllTaxRates200ResponseInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AllTaxRates200ResponseInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AllTaxRates200ResponseInner rates(List<AllTaxRates200ResponseInnerRatesInner> rates) {
    this.rates = rates;
    return this;
  }

  public AllTaxRates200ResponseInner addRatesItem(AllTaxRates200ResponseInnerRatesInner ratesItem) {
    if (this.rates == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<AllTaxRates200ResponseInnerRatesInner> getRates() {
    return rates;
  }

  public void setRates(List<AllTaxRates200ResponseInnerRatesInner> rates) {
    this.rates = rates;
  }


  public AllTaxRates200ResponseInner state(String state) {
    this.state = state;
    return this;
  }
  ...
  public AllTaxRates200ResponseInner zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AllTaxRates200ResponseInner allTaxRates200ResponseInner = (AllTaxRates200ResponseInner) o;
    return Objects.equals(this.id, allTaxRates200ResponseInner.id) &&
        Objects.equals(this.name, allTaxRates200ResponseInner.name) &&
        Objects.equals(this.rates, allTaxRates200ResponseInner.rates) &&
        Objects.equals(this.state, allTaxRates200ResponseInner.state) &&
        Objects.equals(this.zip, allTaxRates200ResponseInner.zip);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, rates, state, zip);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AllTaxRates200ResponseInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AllTaxRates200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AllTaxRates200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AllTaxRates200ResponseInner is not found in the empty JSON string", AllTaxRates200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AllTaxRates200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AllTaxRates200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("rates") != null && !jsonObj.get("rates").isJsonNull()) {
        ...
        if (jsonArrayrates != null) {
          ...
          for (int i = 0; i < jsonArrayrates.size(); i++) {
            AllTaxRates200ResponseInnerRatesInner.validateJsonElement(jsonArrayrates.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AllTaxRates200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AllTaxRates200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AllTaxRates200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AllTaxRates200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AllTaxRates200ResponseInner>() {
           @Override
           public void write(JsonWriter out, AllTaxRates200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AllTaxRates200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AllTaxRates200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AllTaxRates200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to AllTaxRates200ResponseInner
   */
  public static AllTaxRates200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllTaxRates200ResponseInner.class);
  }

  /**
   * Convert an instance of AllTaxRates200ResponseInner to an JSON string
   *
   * @return JSON string
   */
