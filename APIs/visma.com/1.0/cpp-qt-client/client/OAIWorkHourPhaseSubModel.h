...
/*
 * OAIWorkHourPhaseSubModel.h
 *
 * 
 */

#ifndef OAIWorkHourPhaseSubModel_H
#define OAIWorkHourPhaseSubModel_H
...
class OAIWorkHourPhaseSubModel : public OAIObject {
public:
    OAIWorkHourPhaseSubModel();
    OAIWorkHourPhaseSubModel(QString json);
    ~OAIWorkHourPhaseSubModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkHourPhaseSubModel)

#endif // OAIWorkHourPhaseSubModel_H
