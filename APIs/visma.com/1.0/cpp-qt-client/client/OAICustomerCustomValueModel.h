...
/*
 * OAICustomerCustomValueModel.h
 *
 * 
 */

#ifndef OAICustomerCustomValueModel_H
#define OAICustomerCustomValueModel_H
...
class OAICustomerCustomValueModel : public OAIObject {
public:
    OAICustomerCustomValueModel();
    OAICustomerCustomValueModel(QString json);
    ~OAICustomerCustomValueModel() override;
    ...
    OAICustomPropertyShortModel getCustomProperty() const;
    void setCustomProperty(const OAICustomPropertyShortModel &custom_property);
    bool is_custom_property_Set() const;
    bool is_custom_property_Valid() const;

    QString getCustomerGuid() const;
    void setCustomerGuid(const QString &customer_guid);
    bool is_customer_guid_Set() const;
    bool is_customer_guid_Valid() const;
...
private:
    ...
    OAICustomPropertyShortModel m_custom_property;
    bool m_custom_property_isSet;
    bool m_custom_property_isValid;

    QString m_customer_guid;
    bool m_customer_guid_isSet;
    bool m_customer_guid_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerCustomValueModel)

#endif // OAICustomerCustomValueModel_H
