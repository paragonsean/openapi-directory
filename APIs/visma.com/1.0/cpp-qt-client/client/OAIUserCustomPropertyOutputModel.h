...
/*
 * OAIUserCustomPropertyOutputModel.h
 *
 * 
 */

#ifndef OAIUserCustomPropertyOutputModel_H
#define OAIUserCustomPropertyOutputModel_H
...
class OAIUserCustomPropertyOutputModel : public OAIObject {
public:
    OAIUserCustomPropertyOutputModel();
    OAIUserCustomPropertyOutputModel(QString json);
    ~OAIUserCustomPropertyOutputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserCustomPropertyOutputModel)

#endif // OAIUserCustomPropertyOutputModel_H
