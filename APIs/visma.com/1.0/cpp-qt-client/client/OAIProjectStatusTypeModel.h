...
/*
 * OAIProjectStatusTypeModel.h
 *
 * 
 */

#ifndef OAIProjectStatusTypeModel_H
#define OAIProjectStatusTypeModel_H
...
class OAIProjectStatusTypeModel : public OAIObject {
public:
    OAIProjectStatusTypeModel();
    OAIProjectStatusTypeModel(QString json);
    ~OAIProjectStatusTypeModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectStatusTypeModel)

#endif // OAIProjectStatusTypeModel_H
