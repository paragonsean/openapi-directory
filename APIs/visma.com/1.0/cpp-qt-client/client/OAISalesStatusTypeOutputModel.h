...
/*
 * OAISalesStatusTypeOutputModel.h
 *
 * 
 */

#ifndef OAISalesStatusTypeOutputModel_H
#define OAISalesStatusTypeOutputModel_H
...
class OAISalesStatusTypeOutputModel : public OAIObject {
public:
    OAISalesStatusTypeOutputModel();
    OAISalesStatusTypeOutputModel(QString json);
    ~OAISalesStatusTypeOutputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesStatusTypeOutputModel)

#endif // OAISalesStatusTypeOutputModel_H
