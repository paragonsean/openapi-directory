...
/*
 * OAISalesAccountModel.h
 *
 * 
 */

#ifndef OAISalesAccountModel_H
#define OAISalesAccountModel_H
...
class OAISalesAccountModel : public OAIObject {
public:
    OAISalesAccountModel();
    OAISalesAccountModel(QString json);
    ~OAISalesAccountModel() override;
    ...
    bool isIsProductDefault() const;
    void setIsProductDefault(const bool &is_product_default);
    bool is_is_product_default_Set() const;
    bool is_is_product_default_Valid() const;
    ...
    bool isIsWorkTypeDefault() const;
    void setIsWorkTypeDefault(const bool &is_work_type_default);
    bool is_is_work_type_default_Set() const;
    bool is_is_work_type_default_Valid() const;
...
private:
    ...
    bool m_is_product_default;
    bool m_is_product_default_isSet;
    bool m_is_product_default_isValid;

    bool m_is_travel_type_default;
    bool m_is_travel_type_default_isSet;
    bool m_is_travel_type_default_isValid;

    bool m_is_work_type_default;
    bool m_is_work_type_default_isSet;
    bool m_is_work_type_default_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesAccountModel)

#endif // OAISalesAccountModel_H
