...
/*
 * OAICommunicationTypeModel.h
 *
 * 
 */

#ifndef OAICommunicationTypeModel_H
#define OAICommunicationTypeModel_H
...
class OAICommunicationTypeModel : public OAIObject {
public:
    OAICommunicationTypeModel();
    OAICommunicationTypeModel(QString json);
    ~OAICommunicationTypeModel() override;
    ...
    OAICommunicationMethodType getType() const;
    void setType(const OAICommunicationMethodType &type);
...
private:
    ...
    OAICommunicationMethodType m_type;
    bool m_type_isSet;
    bool m_type_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAICommunicationTypeModel)

#endif // OAICommunicationTypeModel_H
