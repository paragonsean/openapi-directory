...
#ifndef OAIKeywordModel_H
#define OAIKeywordModel_H
...
class OAIKeywordModel : public OAIObject {
public:
    OAIKeywordModel();
    OAIKeywordModel(QString json);
    ~OAIKeywordModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeywordModel)

#endif // OAIKeywordModel_H
