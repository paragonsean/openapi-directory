...
OAIWorkHourOutputModel::OAIWorkHourOutputModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWorkHourOutputModel::OAIWorkHourOutputModel() {
    this->initializeModel();
}

OAIWorkHourOutputModel::~OAIWorkHourOutputModel() {}

void OAIWorkHourOutputModel::initializeModel() {

    m_billable_status_isSet = false;
    m_billable_status_isValid = false;
...
void OAIWorkHourOutputModel::fromJson(QString jsonString) {
...
void OAIWorkHourOutputModel::fromJsonObject(QJsonObject json) {

    m_billable_status_isValid = ::OpenAPI::fromJsonValue(m_billable_status, json[QString("billableStatus")]);
    m_billable_status_isSet = !json[QString("billableStatus")].isNull() && m_billable_status_isValid;
...
QString OAIWorkHourOutputModel::asJson() const {
...
QJsonObject OAIWorkHourOutputModel::asJsonObject() const {
    QJsonObject obj;
    if (m_billable_status.isSet()) {
        obj.insert(QString("billableStatus"), ::OpenAPI::toJsonValue(m_billable_status));
    }
...
OAIBillableStatusType OAIWorkHourOutputModel::getBillableStatus() const {
    return m_billable_status;
}
void OAIWorkHourOutputModel::setBillableStatus(const OAIBillableStatusType &billable_status) {
    m_billable_status = billable_status;
    m_billable_status_isSet = true;
}

bool OAIWorkHourOutputModel::is_billable_status_Set() const{
    return m_billable_status_isSet;
}

bool OAIWorkHourOutputModel::is_billable_status_Valid() const{
    return m_billable_status_isValid;
}

OAIUserWithFirstNameLastNameAndPhotoFileModel OAIWorkHourOutputModel::getCreatedBy() const {
    return m_created_by;
}
void OAIWorkHourOutputModel::setCreatedBy(const OAIUserWithFirstNameLastNameAndPhotoFileModel &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIWorkHourOutputModel::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIWorkHourOutputModel::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QDateTime OAIWorkHourOutputModel::getCreatedDateTime() const {
    return m_created_date_time;
}
void OAIWorkHourOutputModel::setCreatedDateTime(const QDateTime &created_date_time) {
    m_created_date_time = created_date_time;
    m_created_date_time_isSet = true;
}

bool OAIWorkHourOutputModel::is_created_date_time_Set() const{
    return m_created_date_time_isSet;
}

bool OAIWorkHourOutputModel::is_created_date_time_Valid() const{
    return m_created_date_time_isValid;
}

OAIWorkHourCustomerSubModel OAIWorkHourOutputModel::getCustomer() const {
    return m_customer;
}
void OAIWorkHourOutputModel::setCustomer(const OAIWorkHourCustomerSubModel &customer) {
    m_customer = customer;
    m_customer_isSet = true;
}

bool OAIWorkHourOutputModel::is_customer_Set() const{
    return m_customer_isSet;
}

bool OAIWorkHourOutputModel::is_customer_Valid() const{
    return m_customer_isValid;
}

QString OAIWorkHourOutputModel::getDescription() const {
    return m_description;
}
void OAIWorkHourOutputModel::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIWorkHourOutputModel::is_description_Set() const{
    return m_description_isSet;
}

bool OAIWorkHourOutputModel::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIWorkHourOutputModel::getEndTime() const {
    return m_end_time;
}
void OAIWorkHourOutputModel::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIWorkHourOutputModel::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIWorkHourOutputModel::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QDate OAIWorkHourOutputModel::getEventDate() const {
    return m_event_date;
}
void OAIWorkHourOutputModel::setEventDate(const QDate &event_date) {
    m_event_date = event_date;
    m_event_date_isSet = true;
}

bool OAIWorkHourOutputModel::is_event_date_Set() const{
    return m_event_date_isSet;
}

bool OAIWorkHourOutputModel::is_event_date_Valid() const{
    return m_event_date_isValid;
}

QString OAIWorkHourOutputModel::getGuid() const {
    return m_guid;
}
void OAIWorkHourOutputModel::setGuid(const QString &guid) {
    m_guid = guid;
    m_guid_isSet = true;
}

bool OAIWorkHourOutputModel::is_guid_Set() const{
    return m_guid_isSet;
}

bool OAIWorkHourOutputModel::is_guid_Valid() const{
    return m_guid_isValid;
}

OAIWorkHourInvoiceSubModel OAIWorkHourOutputModel::getInvoice() const {
    return m_invoice;
}
void OAIWorkHourOutputModel::setInvoice(const OAIWorkHourInvoiceSubModel &invoice) {
    m_invoice = invoice;
    m_invoice_isSet = true;
}

bool OAIWorkHourOutputModel::is_invoice_Set() const{
    return m_invoice_isSet;
}

bool OAIWorkHourOutputModel::is_invoice_Valid() const{
    return m_invoice_isValid;
}

double OAIWorkHourOutputModel::getInvoiceQuantity() const {
    return m_invoice_quantity;
}
void OAIWorkHourOutputModel::setInvoiceQuantity(const double &invoice_quantity) {
    m_invoice_quantity = invoice_quantity;
    m_invoice_quantity_isSet = true;
}

bool OAIWorkHourOutputModel::is_invoice_quantity_Set() const{
    return m_invoice_quantity_isSet;
}

bool OAIWorkHourOutputModel::is_invoice_quantity_Valid() const{
    return m_invoice_quantity_isValid;
}

QString OAIWorkHourOutputModel::getInvoiceRowComment() const {
    return m_invoice_row_comment;
}
void OAIWorkHourOutputModel::setInvoiceRowComment(const QString &invoice_row_comment) {
    m_invoice_row_comment = invoice_row_comment;
    m_invoice_row_comment_isSet = true;
}

bool OAIWorkHourOutputModel::is_invoice_row_comment_Set() const{
    return m_invoice_row_comment_isSet;
}

bool OAIWorkHourOutputModel::is_invoice_row_comment_Valid() const{
    return m_invoice_row_comment_isValid;
}

QString OAIWorkHourOutputModel::getInvoiceRowDescription() const {
    return m_invoice_row_description;
}
void OAIWorkHourOutputModel::setInvoiceRowDescription(const QString &invoice_row_description) {
    m_invoice_row_description = invoice_row_description;
    m_invoice_row_description_isSet = true;
}

bool OAIWorkHourOutputModel::is_invoice_row_description_Set() const{
    return m_invoice_row_description_isSet;
}

bool OAIWorkHourOutputModel::is_invoice_row_description_Valid() const{
    return m_invoice_row_description_isValid;
}

QString OAIWorkHourOutputModel::getInvoiceRowGuid() const {
    return m_invoice_row_guid;
}
void OAIWorkHourOutputModel::setInvoiceRowGuid(const QString &invoice_row_guid) {
    m_invoice_row_guid = invoice_row_guid;
    m_invoice_row_guid_isSet = true;
}

bool OAIWorkHourOutputModel::is_invoice_row_guid_Set() const{
    return m_invoice_row_guid_isSet;
}

bool OAIWorkHourOutputModel::is_invoice_row_guid_Valid() const{
    return m_invoice_row_guid_isValid;
}

bool OAIWorkHourOutputModel::isIsApproved() const {
    return m_is_approved;
}
void OAIWorkHourOutputModel::setIsApproved(const bool &is_approved) {
    m_is_approved = is_approved;
    m_is_approved_isSet = true;
}

bool OAIWorkHourOutputModel::is_is_approved_Set() const{
    return m_is_approved_isSet;
}

bool OAIWorkHourOutputModel::is_is_approved_Valid() const{
    return m_is_approved_isValid;
}

bool OAIWorkHourOutputModel::isIsBillable() const {
    return m_is_billable;
}
void OAIWorkHourOutputModel::setIsBillable(const bool &is_billable) {
    m_is_billable = is_billable;
    m_is_billable_isSet = true;
}

bool OAIWorkHourOutputModel::is_is_billable_Set() const{
    return m_is_billable_isSet;
}

bool OAIWorkHourOutputModel::is_is_billable_Valid() const{
    return m_is_billable_isValid;
}

bool OAIWorkHourOutputModel::isIsModifiable() const {
    return m_is_modifiable;
}
void OAIWorkHourOutputModel::setIsModifiable(const bool &is_modifiable) {
    m_is_modifiable = is_modifiable;
    m_is_modifiable_isSet = true;
}

bool OAIWorkHourOutputModel::is_is_modifiable_Set() const{
    return m_is_modifiable_isSet;
}

bool OAIWorkHourOutputModel::is_is_modifiable_Valid() const{
    return m_is_modifiable_isValid;
}

bool OAIWorkHourOutputModel::isIsProductive() const {
    return m_is_productive;
}
void OAIWorkHourOutputModel::setIsProductive(const bool &is_productive) {
    m_is_productive = is_productive;
    m_is_productive_isSet = true;
}

bool OAIWorkHourOutputModel::is_is_productive_Set() const{
    return m_is_productive_isSet;
}

bool OAIWorkHourOutputModel::is_is_productive_Valid() const{
    return m_is_productive_isValid;
}

OAIUserWithFirstNameLastNameAndPhotoFileModel OAIWorkHourOutputModel::getLastUpdatedBy() const {
    return m_last_updated_by;
}
void OAIWorkHourOutputModel::setLastUpdatedBy(const OAIUserWithFirstNameLastNameAndPhotoFileModel &last_updated_by) {
    m_last_updated_by = last_updated_by;
    m_last_updated_by_isSet = true;
}

bool OAIWorkHourOutputModel::is_last_updated_by_Set() const{
    return m_last_updated_by_isSet;
}

bool OAIWorkHourOutputModel::is_last_updated_by_Valid() const{
    return m_last_updated_by_isValid;
}

QDateTime OAIWorkHourOutputModel::getLastUpdatedDateTime() const {
    return m_last_updated_date_time;
}
void OAIWorkHourOutputModel::setLastUpdatedDateTime(const QDateTime &last_updated_date_time) {
    m_last_updated_date_time = last_updated_date_time;
    m_last_updated_date_time_isSet = true;
}

bool OAIWorkHourOutputModel::is_last_updated_date_time_Set() const{
    return m_last_updated_date_time_isSet;
}

bool OAIWorkHourOutputModel::is_last_updated_date_time_Valid() const{
    return m_last_updated_date_time_isValid;
}

OAIModelWithName OAIWorkHourOutputModel::getOvertime() const {
    return m_overtime;
}
void OAIWorkHourOutputModel::setOvertime(const OAIModelWithName &overtime) {
    m_overtime = overtime;
    m_overtime_isSet = true;
}

bool OAIWorkHourOutputModel::is_overtime_Set() const{
    return m_overtime_isSet;
}

bool OAIWorkHourOutputModel::is_overtime_Valid() const{
    return m_overtime_isValid;
}

OAIWorkHourPhaseSubModel OAIWorkHourOutputModel::getPhase() const {
    return m_phase;
}
void OAIWorkHourOutputModel::setPhase(const OAIWorkHourPhaseSubModel &phase) {
    m_phase = phase;
    m_phase_isSet = true;
}

bool OAIWorkHourOutputModel::is_phase_Set() const{
    return m_phase_isSet;
}

bool OAIWorkHourOutputModel::is_phase_Valid() const{
    return m_phase_isValid;
}

double OAIWorkHourOutputModel::getPlannedInvoiceQuantity() const {
    return m_planned_invoice_quantity;
}
void OAIWorkHourOutputModel::setPlannedInvoiceQuantity(const double &planned_invoice_quantity) {
    m_planned_invoice_quantity = planned_invoice_quantity;
    m_planned_invoice_quantity_isSet = true;
}

bool OAIWorkHourOutputModel::is_planned_invoice_quantity_Set() const{
    return m_planned_invoice_quantity_isSet;
}

bool OAIWorkHourOutputModel::is_planned_invoice_quantity_Valid() const{
    return m_planned_invoice_quantity_isValid;
}

OAIWorkHourProjectSubModel OAIWorkHourOutputModel::getProject() const {
    return m_project;
}
void OAIWorkHourOutputModel::setProject(const OAIWorkHourProjectSubModel &project) {
    m_project = project;
    m_project_isSet = true;
}

bool OAIWorkHourOutputModel::is_project_Set() const{
    return m_project_isSet;
}

bool OAIWorkHourOutputModel::is_project_Valid() const{
    return m_project_isValid;
}

double OAIWorkHourOutputModel::getQuantity() const {
    return m_quantity;
}
void OAIWorkHourOutputModel::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIWorkHourOutputModel::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIWorkHourOutputModel::is_quantity_Valid() const{
    return m_quantity_isValid;
}

QDateTime OAIWorkHourOutputModel::getStartTime() const {
    return m_start_time;
}
void OAIWorkHourOutputModel::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIWorkHourOutputModel::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIWorkHourOutputModel::is_start_time_Valid() const{
    return m_start_time_isValid;
}

OAIMoneyOutputModel OAIWorkHourOutputModel::getUnitCost() const {
    return m_unit_cost;
}
void OAIWorkHourOutputModel::setUnitCost(const OAIMoneyOutputModel &unit_cost) {
    m_unit_cost = unit_cost;
    m_unit_cost_isSet = true;
}

bool OAIWorkHourOutputModel::is_unit_cost_Set() const{
    return m_unit_cost_isSet;
}

bool OAIWorkHourOutputModel::is_unit_cost_Valid() const{
    return m_unit_cost_isValid;
}

OAIMoneyOutputModel OAIWorkHourOutputModel::getUnitPrice() const {
    return m_unit_price;
}
void OAIWorkHourOutputModel::setUnitPrice(const OAIMoneyOutputModel &unit_price) {
    m_unit_price = unit_price;
    m_unit_price_isSet = true;
}

bool OAIWorkHourOutputModel::is_unit_price_Set() const{
    return m_unit_price_isSet;
}

bool OAIWorkHourOutputModel::is_unit_price_Valid() const{
    return m_unit_price_isValid;
}

OAIUserWithFirstNameLastNamePhotoFileModelAndRequiredGuid OAIWorkHourOutputModel::getUser() const {
    return m_user;
}
void OAIWorkHourOutputModel::setUser(const OAIUserWithFirstNameLastNamePhotoFileModelAndRequiredGuid &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIWorkHourOutputModel::is_user_Set() const{
    return m_user_isSet;
}

bool OAIWorkHourOutputModel::is_user_Valid() const{
    return m_user_isValid;
}

OAIWorkHourWorkTypeSubModel OAIWorkHourOutputModel::getWorkType() const {
    return m_work_type;
}
void OAIWorkHourOutputModel::setWorkType(const OAIWorkHourWorkTypeSubModel &work_type) {
    m_work_type = work_type;
    m_work_type_isSet = true;
}

bool OAIWorkHourOutputModel::is_work_type_Set() const{
    return m_work_type_isSet;
}

bool OAIWorkHourOutputModel::is_work_type_Valid() const{
    return m_work_type_isValid;
}

bool OAIWorkHourOutputModel::isSet() const {
...
bool OAIWorkHourOutputModel::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_event_date_isValid && true;
}
