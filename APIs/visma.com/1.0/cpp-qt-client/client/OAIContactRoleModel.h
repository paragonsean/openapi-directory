...
/*
 * OAIContactRoleModel.h
 *
 * 
 */

#ifndef OAIContactRoleModel_H
#define OAIContactRoleModel_H
...
class OAIContactRoleModel : public OAIObject {
public:
    OAIContactRoleModel();
    OAIContactRoleModel(QString json);
    ~OAIContactRoleModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactRoleModel)

#endif // OAIContactRoleModel_H
