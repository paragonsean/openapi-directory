...
/*
 * OAIMarketSegmentModel.h
 *
 * 
 */

#ifndef OAIMarketSegmentModel_H
#define OAIMarketSegmentModel_H
...
class OAIMarketSegmentModel : public OAIObject {
public:
    OAIMarketSegmentModel();
    OAIMarketSegmentModel(QString json);
    ~OAIMarketSegmentModel() override;
    ...
    OAIModelWithName getParentMarketSegment() const;
    void setParentMarketSegment(const OAIModelWithName &parent_market_segment);
...
private:
    ...
    OAIModelWithName m_parent_market_segment;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarketSegmentModel)

#endif // OAIMarketSegmentModel_H
