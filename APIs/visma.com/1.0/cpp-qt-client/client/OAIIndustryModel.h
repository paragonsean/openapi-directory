...
#ifndef OAIIndustryModel_H
#define OAIIndustryModel_H
...
class OAIIndustryModel : public OAIObject {
public:
    OAIIndustryModel();
    OAIIndustryModel(QString json);
    ~OAIIndustryModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIndustryModel)

#endif // OAIIndustryModel_H
