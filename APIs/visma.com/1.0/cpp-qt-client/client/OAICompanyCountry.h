...
#ifndef OAICompanyCountry_H
#define OAICompanyCountry_H
...
class OAICompanyCountry : public OAIObject {
public:
    OAICompanyCountry();
    OAICompanyCountry(QString json);
    ~OAICompanyCountry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanyCountry)

#endif // OAICompanyCountry_H
