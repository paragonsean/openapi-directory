...
/*
 * OAIPhaseOutputModel.h
 *
 * 
 */

#ifndef OAIPhaseOutputModel_H
#define OAIPhaseOutputModel_H
...
class OAIPhaseOutputModel : public OAIObject {
public:
    OAIPhaseOutputModel();
    OAIPhaseOutputModel(QString json);
    ~OAIPhaseOutputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhaseOutputModel)

#endif // OAIPhaseOutputModel_H
