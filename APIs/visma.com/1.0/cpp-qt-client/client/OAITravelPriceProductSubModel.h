...
/*
 * OAITravelPriceProductSubModel.h
 *
 * 
 */

#ifndef OAITravelPriceProductSubModel_H
#define OAITravelPriceProductSubModel_H
...
class OAITravelPriceProductSubModel : public OAIObject {
public:
    OAITravelPriceProductSubModel();
    OAITravelPriceProductSubModel(QString json);
    ~OAITravelPriceProductSubModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITravelPriceProductSubModel)

#endif // OAITravelPriceProductSubModel_H
