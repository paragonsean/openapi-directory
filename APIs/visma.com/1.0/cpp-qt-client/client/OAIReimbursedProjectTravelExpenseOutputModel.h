...
/*
 * OAIReimbursedProjectTravelExpenseOutputModel.h
 *
 * 
 */

#ifndef OAIReimbursedProjectTravelExpenseOutputModel_H
#define OAIReimbursedProjectTravelExpenseOutputModel_H
...
class OAIReimbursedProjectTravelExpenseOutputModel : public OAIObject {
public:
    OAIReimbursedProjectTravelExpenseOutputModel();
    OAIReimbursedProjectTravelExpenseOutputModel(QString json);
    ~OAIReimbursedProjectTravelExpenseOutputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReimbursedProjectTravelExpenseOutputModel)

#endif // OAIReimbursedProjectTravelExpenseOutputModel_H
