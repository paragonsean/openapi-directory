...
/*
 * OAIRoleOutputModel.h
 *
 * 
 */

#ifndef OAIRoleOutputModel_H
#define OAIRoleOutputModel_H
...
class OAIRoleOutputModel : public OAIObject {
public:
    OAIRoleOutputModel();
    OAIRoleOutputModel(QString json);
    ~OAIRoleOutputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoleOutputModel)

#endif // OAIRoleOutputModel_H
