...
/*
 * OAIPhaseStatusTypeModel.h
 *
 * 
 */

#ifndef OAIPhaseStatusTypeModel_H
#define OAIPhaseStatusTypeModel_H
...
class OAIPhaseStatusTypeModel : public OAIObject {
public:
    OAIPhaseStatusTypeModel();
    OAIPhaseStatusTypeModel(QString json);
    ~OAIPhaseStatusTypeModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhaseStatusTypeModel)

#endif // OAIPhaseStatusTypeModel_H
