...
/*
 * OAILeadSourceModel.h
 *
 * 
 */

#ifndef OAILeadSourceModel_H
#define OAILeadSourceModel_H
...
class OAILeadSourceModel : public OAIObject {
public:
    OAILeadSourceModel();
    OAILeadSourceModel(QString json);
    ~OAILeadSourceModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILeadSourceModel)

#endif // OAILeadSourceModel_H
