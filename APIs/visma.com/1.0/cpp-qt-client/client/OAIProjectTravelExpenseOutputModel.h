...
/*
 * OAIProjectTravelExpenseOutputModel.h
 *
 * 
 */

#ifndef OAIProjectTravelExpenseOutputModel_H
#define OAIProjectTravelExpenseOutputModel_H
...
class OAIInvoiceSubModel;
class OAIModelBaseWithRequiredGuid;
class OAIProjectTravelExpenseProjectSubModel;
class OAITravelExpenseSubModel;
class OAITravelReimbursementSubModel;
class OAIMoneyOutputModel;
class OAIUserRequiredSubModel;

class OAIProjectTravelExpenseOutputModel : public OAIObject {
public:
    OAIProjectTravelExpenseOutputModel();
    OAIProjectTravelExpenseOutputModel(QString json);
    ~OAIProjectTravelExpenseOutputModel() override;
    ...
    OAIModelWithName getBillingDependencyPhase() const;
    void setBillingDependencyPhase(const OAIModelWithName &billing_dependency_phase);
    ...
    OAIModelWithName getCostAccount() const;
    void setCostAccount(const OAIModelWithName &cost_account);
    bool is_cost_account_Set() const;
    bool is_cost_account_Valid() const;

    OAIModelWithName getCostCenter() const;
    void setCostCenter(const OAIModelWithName &cost_center);
    ...
    OAIInvoiceSubModel getInvoice() const;
    void setInvoice(const OAIInvoiceSubModel &invoice);
    ...
    OAIProjectTravelExpenseProjectSubModel getProject() const;
    void setProject(const OAIProjectTravelExpenseProjectSubModel &project);
    ...
    OAIModelWithName getSalesAccount() const;
    void setSalesAccount(const OAIModelWithName &sales_account);
    ...
    OAITravelExpenseSubModel getTravelExpense() const;
    void setTravelExpense(const OAITravelExpenseSubModel &travel_expense);
    bool is_travel_expense_Set() const;
    bool is_travel_expense_Valid() const;

    OAITravelReimbursementSubModel getTravelReimbursement() const;
    void setTravelReimbursement(const OAITravelReimbursementSubModel &travel_reimbursement);
    ...
    OAIMoneyOutputModel getUnitCostExcludingPurchaseVat() const;
    void setUnitCostExcludingPurchaseVat(const OAIMoneyOutputModel &unit_cost_excluding_purchase_vat);
    bool is_unit_cost_excluding_purchase_vat_Set() const;
    bool is_unit_cost_excluding_purchase_vat_Valid() const;
    ...
    OAIUserRequiredSubModel getUser() const;
    void setUser(const OAIUserRequiredSubModel &user);
...
private:
    ...
    OAIModelWithName m_billing_dependency_phase;
    ...
    OAIModelWithName m_cost_account;
    bool m_cost_account_isSet;
    bool m_cost_account_isValid;

    OAIModelWithName m_cost_center;
    ...
    OAIProjectTravelExpenseProjectSubModel m_project;
    ...
    OAIModelWithName m_sales_account;
    ...
    OAITravelExpenseSubModel m_travel_expense;
    bool m_travel_expense_isSet;
    bool m_travel_expense_isValid;

    OAITravelReimbursementSubModel m_travel_reimbursement;
    ...
    OAIMoneyOutputModel m_unit_cost_excluding_purchase_vat;
    bool m_unit_cost_excluding_purchase_vat_isSet;
    bool m_unit_cost_excluding_purchase_vat_isValid;

    OAIMoneyOutputModel m_unit_price;
    bool m_unit_price_isSet;
    bool m_unit_price_isValid;

    OAIUserRequiredSubModel m_user;
    bool m_user_isSet;
    bool m_user_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectTravelExpenseOutputModel)

#endif // OAIProjectTravelExpenseOutputModel_H
