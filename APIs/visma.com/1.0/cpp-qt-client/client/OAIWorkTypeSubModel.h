...
/*
 * OAIWorkTypeSubModel.h
 *
 * 
 */

#ifndef OAIWorkTypeSubModel_H
#define OAIWorkTypeSubModel_H
...
class OAIWorkTypeSubModel : public OAIObject {
public:
    OAIWorkTypeSubModel();
    OAIWorkTypeSubModel(QString json);
    ~OAIWorkTypeSubModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkTypeSubModel)

#endif // OAIWorkTypeSubModel_H
