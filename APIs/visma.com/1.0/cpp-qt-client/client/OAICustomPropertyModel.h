...
/*
 * OAICustomPropertyModel.h
 *
 * 
 */

#ifndef OAICustomPropertyModel_H
#define OAICustomPropertyModel_H
...
class OAICustomPropertyModel : public OAIObject {
public:
    OAICustomPropertyModel();
    OAICustomPropertyModel(QString json);
    ~OAICustomPropertyModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomPropertyModel)

#endif // OAICustomPropertyModel_H
