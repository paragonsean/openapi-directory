...
/*
 * OAIPriceListOutputModel.h
 *
 * 
 */

#ifndef OAIPriceListOutputModel_H
#define OAIPriceListOutputModel_H
...
class OAIPriceListCurrency2;

class OAIPriceListOutputModel : public OAIObject {
public:
    OAIPriceListOutputModel();
    OAIPriceListOutputModel(QString json);
    ~OAIPriceListOutputModel() override;
    ...
    OAIPriceListCurrency2 getCurrency() const;
    void setCurrency(const OAIPriceListCurrency2 &currency);
...
private:
    ...
    OAIPriceListCurrency2 m_currency;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPriceListOutputModel)

#endif // OAIPriceListOutputModel_H
