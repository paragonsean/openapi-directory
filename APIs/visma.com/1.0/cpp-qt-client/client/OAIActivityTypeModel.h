...
/*
 * OAIActivityTypeModel.h
 *
 * 
 */

#ifndef OAIActivityTypeModel_H
#define OAIActivityTypeModel_H
...
class OAIActivityTypeModel : public OAIObject {
public:
    OAIActivityTypeModel();
    OAIActivityTypeModel(QString json);
    ~OAIActivityTypeModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityTypeModel)

#endif // OAIActivityTypeModel_H
