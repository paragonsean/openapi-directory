...
/*
 * OAIProjectKeywordModel.h
 *
 * 
 */

#ifndef OAIProjectKeywordModel_H
#define OAIProjectKeywordModel_H
...
class OAIProjectKeywordModel : public OAIObject {
public:
    OAIProjectKeywordModel();
    OAIProjectKeywordModel(QString json);
    ~OAIProjectKeywordModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectKeywordModel)

#endif // OAIProjectKeywordModel_H
