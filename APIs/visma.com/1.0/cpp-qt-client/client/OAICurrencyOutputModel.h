...
/*
 * OAICurrencyOutputModel.h
 *
 * 
 */

#ifndef OAICurrencyOutputModel_H
#define OAICurrencyOutputModel_H
...
class OAICurrencyOutputModel : public OAIObject {
public:
    OAICurrencyOutputModel();
    OAICurrencyOutputModel(QString json);
    ~OAICurrencyOutputModel() override;
    ...
    bool isIsOrganizationCurrency() const;
    void setIsOrganizationCurrency(const bool &is_organization_currency);
    bool is_is_organization_currency_Set() const;
    bool is_is_organization_currency_Valid() const;
...
private:
    ...
    bool m_is_organization_currency;
    bool m_is_organization_currency_isSet;
    bool m_is_organization_currency_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyOutputModel)

#endif // OAICurrencyOutputModel_H
