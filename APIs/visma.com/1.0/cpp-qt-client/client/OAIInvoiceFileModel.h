...
/*
 * OAIInvoiceFileModel.h
 *
 * 
 */

#ifndef OAIInvoiceFileModel_H
#define OAIInvoiceFileModel_H
...
class OAIInvoiceFileModel : public OAIObject {
public:
    OAIInvoiceFileModel();
    OAIInvoiceFileModel(QString json);
    ~OAIInvoiceFileModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceFileModel)

#endif // OAIInvoiceFileModel_H
