...
/*
 * OAIUserCustomPropertySelectionItemOutputModel.h
 *
 * 
 */

#ifndef OAIUserCustomPropertySelectionItemOutputModel_H
#define OAIUserCustomPropertySelectionItemOutputModel_H
...
class OAIUserCustomPropertySelectionItemOutputModel : public OAIObject {
public:
    OAIUserCustomPropertySelectionItemOutputModel();
    OAIUserCustomPropertySelectionItemOutputModel(QString json);
    ~OAIUserCustomPropertySelectionItemOutputModel() override;
    ...
    OAICustomPropertyShortModel getUserCustomProperty() const;
    void setUserCustomProperty(const OAICustomPropertyShortModel &user_custom_property);
    bool is_user_custom_property_Set() const;
    bool is_user_custom_property_Valid() const;
...
private:
    ...
    OAICustomPropertyShortModel m_user_custom_property;
    bool m_user_custom_property_isSet;
    bool m_user_custom_property_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUserCustomPropertySelectionItemOutputModel)

#endif // OAIUserCustomPropertySelectionItemOutputModel_H
