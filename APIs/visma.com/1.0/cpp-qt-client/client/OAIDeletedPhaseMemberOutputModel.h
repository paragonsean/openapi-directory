...
/*
 * OAIDeletedPhaseMemberOutputModel.h
 *
 * 
 */

#ifndef OAIDeletedPhaseMemberOutputModel_H
#define OAIDeletedPhaseMemberOutputModel_H
...
class OAIDeletedPhaseMemberOutputModel : public OAIObject {
public:
    OAIDeletedPhaseMemberOutputModel();
    OAIDeletedPhaseMemberOutputModel(QString json);
    ~OAIDeletedPhaseMemberOutputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletedPhaseMemberOutputModel)

#endif // OAIDeletedPhaseMemberOutputModel_H
