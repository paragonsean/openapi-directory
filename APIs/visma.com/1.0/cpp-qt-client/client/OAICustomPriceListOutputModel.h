...
/*
 * OAICustomPriceListOutputModel.h
 *
 * 
 */

#ifndef OAICustomPriceListOutputModel_H
#define OAICustomPriceListOutputModel_H
...
class OAIPriceListCurrency3;

class OAICustomPriceListOutputModel : public OAIObject {
public:
    OAICustomPriceListOutputModel();
    OAICustomPriceListOutputModel(QString json);
    ~OAICustomPriceListOutputModel() override;
    ...
    OAIPriceListCurrency3 getCurrency() const;
    void setCurrency(const OAIPriceListCurrency3 &currency);
...
private:
    ...
    OAIPriceListCurrency3 m_currency;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomPriceListOutputModel)

#endif // OAICustomPriceListOutputModel_H
