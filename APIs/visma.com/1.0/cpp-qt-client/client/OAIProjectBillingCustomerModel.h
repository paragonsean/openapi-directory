...
/*
 * OAIProjectBillingCustomerModel.h
 *
 * 
 */

#ifndef OAIProjectBillingCustomerModel_H
#define OAIProjectBillingCustomerModel_H
...
class OAIProjectBillingCustomerModel : public OAIObject {
public:
    OAIProjectBillingCustomerModel();
    OAIProjectBillingCustomerModel(QString json);
    ~OAIProjectBillingCustomerModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectBillingCustomerModel)

#endif // OAIProjectBillingCustomerModel_H
