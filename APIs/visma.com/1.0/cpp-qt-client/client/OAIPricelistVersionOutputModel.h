...
/*
 * OAIPricelistVersionOutputModel.h
 *
 * 
 */

#ifndef OAIPricelistVersionOutputModel_H
#define OAIPricelistVersionOutputModel_H
...
class OAIPricelistVersionOutputModel : public OAIObject {
public:
    OAIPricelistVersionOutputModel();
    OAIPricelistVersionOutputModel(QString json);
    ~OAIPricelistVersionOutputModel() override;
    ...
    QString getPricelistGuid() const;
    void setPricelistGuid(const QString &pricelist_guid);
    bool is_pricelist_guid_Set() const;
    bool is_pricelist_guid_Valid() const;
...
private:
    ...
    QString m_pricelist_guid;
    bool m_pricelist_guid_isSet;
    bool m_pricelist_guid_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPricelistVersionOutputModel)

#endif // OAIPricelistVersionOutputModel_H
