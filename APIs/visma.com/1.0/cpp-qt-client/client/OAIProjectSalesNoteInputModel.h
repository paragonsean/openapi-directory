...
/*
 * OAIProjectSalesNoteInputModel.h
 *
 * 
 */

#ifndef OAIProjectSalesNoteInputModel_H
#define OAIProjectSalesNoteInputModel_H
...
class OAIProjectSalesNoteInputModel : public OAIObject {
public:
    OAIProjectSalesNoteInputModel();
    OAIProjectSalesNoteInputModel(QString json);
    ~OAIProjectSalesNoteInputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectSalesNoteInputModel)

#endif // OAIProjectSalesNoteInputModel_H
