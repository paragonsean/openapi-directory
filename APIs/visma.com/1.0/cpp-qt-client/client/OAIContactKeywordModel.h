...
/*
 * OAIContactKeywordModel.h
 *
 * 
 */

#ifndef OAIContactKeywordModel_H
#define OAIContactKeywordModel_H
...
class OAIContactKeywordModel : public OAIObject {
public:
    OAIContactKeywordModel();
    OAIContactKeywordModel(QString json);
    ~OAIContactKeywordModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContactKeywordModel)

#endif // OAIContactKeywordModel_H
