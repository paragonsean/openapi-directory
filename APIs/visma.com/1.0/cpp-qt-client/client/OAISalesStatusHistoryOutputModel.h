...
/*
 * OAISalesStatusHistoryOutputModel.h
 *
 * 
 */

#ifndef OAISalesStatusHistoryOutputModel_H
#define OAISalesStatusHistoryOutputModel_H
...
class OAISalesStatusHistoryOutputModel : public OAIObject {
public:
    OAISalesStatusHistoryOutputModel();
    OAISalesStatusHistoryOutputModel(QString json);
    ~OAISalesStatusHistoryOutputModel() override;
    ...
    OAIModelWithName getSalesStatusType() const;
    void setSalesStatusType(const OAIModelWithName &sales_status_type);
    bool is_sales_status_type_Set() const;
    bool is_sales_status_type_Valid() const;
...
private:
    ...
    OAIModelWithName m_sales_status_type;
    bool m_sales_status_type_isSet;
    bool m_sales_status_type_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISalesStatusHistoryOutputModel)

#endif // OAISalesStatusHistoryOutputModel_H
