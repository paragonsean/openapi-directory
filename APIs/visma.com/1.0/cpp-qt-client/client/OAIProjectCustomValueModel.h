...
/*
 * OAIProjectCustomValueModel.h
 *
 * 
 */

#ifndef OAIProjectCustomValueModel_H
#define OAIProjectCustomValueModel_H
...
class OAIProjectCustomValueModel : public OAIObject {
public:
    OAIProjectCustomValueModel();
    OAIProjectCustomValueModel(QString json);
    ~OAIProjectCustomValueModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectCustomValueModel)

#endif // OAIProjectCustomValueModel_H
