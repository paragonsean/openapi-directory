...
#ifndef OAIFileModel_H
#define OAIFileModel_H
...
class OAIFileModel : public OAIObject {
public:
    OAIFileModel();
    OAIFileModel(QString json);
    ~OAIFileModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileModel)

#endif // OAIFileModel_H
