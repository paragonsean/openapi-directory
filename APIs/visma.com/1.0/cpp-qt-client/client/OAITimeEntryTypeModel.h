...
/*
 * OAITimeEntryTypeModel.h
 *
 * 
 */

#ifndef OAITimeEntryTypeModel_H
#define OAITimeEntryTypeModel_H
...
class OAITimeEntryTypeModel : public OAIObject {
public:
    OAITimeEntryTypeModel();
    OAITimeEntryTypeModel(QString json);
    ~OAITimeEntryTypeModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeEntryTypeModel)

#endif // OAITimeEntryTypeModel_H
