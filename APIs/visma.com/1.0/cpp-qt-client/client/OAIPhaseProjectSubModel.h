...
/*
 * OAIPhaseProjectSubModel.h
 *
 * 
 */

#ifndef OAIPhaseProjectSubModel_H
#define OAIPhaseProjectSubModel_H
...
class OAIPhaseProjectSubModel : public OAIObject {
public:
    OAIPhaseProjectSubModel();
    OAIPhaseProjectSubModel(QString json);
    ~OAIPhaseProjectSubModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhaseProjectSubModel)

#endif // OAIPhaseProjectSubModel_H
