...
/*
 * OAICostAccountModel.h
 *
 * 
 */

#ifndef OAICostAccountModel_H
#define OAICostAccountModel_H
...
class OAICostAccountModel : public OAIObject {
public:
    OAICostAccountModel();
    OAICostAccountModel(QString json);
    ~OAICostAccountModel() override;
    ...
    bool isIsTravelTypeDefault() const;
    void setIsTravelTypeDefault(const bool &is_travel_type_default);
    bool is_is_travel_type_default_Set() const;
    bool is_is_travel_type_default_Valid() const;
...
private:
    ...
    bool m_is_travel_type_default;
    bool m_is_travel_type_default_isSet;
    bool m_is_travel_type_default_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICostAccountModel)

#endif // OAICostAccountModel_H
