...
OAIProjectFeeInputModel::OAIProjectFeeInputModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectFeeInputModel::OAIProjectFeeInputModel() {
    this->initializeModel();
}

OAIProjectFeeInputModel::~OAIProjectFeeInputModel() {}

void OAIProjectFeeInputModel::initializeModel() {
...
void OAIProjectFeeInputModel::fromJson(QString jsonString) {
...
void OAIProjectFeeInputModel::fromJsonObject(QJsonObject json) {
...
QString OAIProjectFeeInputModel::asJson() const {
...
QJsonObject OAIProjectFeeInputModel::asJsonObject() const {
    QJsonObject obj;
...
OAISimpleInputModel OAIProjectFeeInputModel::getBillingDependencyPhase() const {
    return m_billing_dependency_phase;
}
void OAIProjectFeeInputModel::setBillingDependencyPhase(const OAISimpleInputModel &billing_dependency_phase) {
    m_billing_dependency_phase = billing_dependency_phase;
    m_billing_dependency_phase_isSet = true;
}

bool OAIProjectFeeInputModel::is_billing_dependency_phase_Set() const{
    return m_billing_dependency_phase_isSet;
}

bool OAIProjectFeeInputModel::is_billing_dependency_phase_Valid() const{
    return m_billing_dependency_phase_isValid;
}

OAIProjectFeeBillingScheduleType OAIProjectFeeInputModel::getBillingSchedule() const {
    return m_billing_schedule;
}
void OAIProjectFeeInputModel::setBillingSchedule(const OAIProjectFeeBillingScheduleType &billing_schedule) {
    m_billing_schedule = billing_schedule;
    m_billing_schedule_isSet = true;
}

bool OAIProjectFeeInputModel::is_billing_schedule_Set() const{
    return m_billing_schedule_isSet;
}

bool OAIProjectFeeInputModel::is_billing_schedule_Valid() const{
    return m_billing_schedule_isValid;
}

OAISimpleInputModel OAIProjectFeeInputModel::getCostCenter() const {
    return m_cost_center;
}
void OAIProjectFeeInputModel::setCostCenter(const OAISimpleInputModel &cost_center) {
    m_cost_center = cost_center;
    m_cost_center_isSet = true;
}

bool OAIProjectFeeInputModel::is_cost_center_Set() const{
    return m_cost_center_isSet;
}

bool OAIProjectFeeInputModel::is_cost_center_Valid() const{
    return m_cost_center_isValid;
}

QString OAIProjectFeeInputModel::getDescription() const {
    return m_description;
}
void OAIProjectFeeInputModel::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIProjectFeeInputModel::is_description_Set() const{
    return m_description_isSet;
}

bool OAIProjectFeeInputModel::is_description_Valid() const{
    return m_description_isValid;
}

QDate OAIProjectFeeInputModel::getDisplayPeriodStartDate() const {
    return m_display_period_start_date;
}
void OAIProjectFeeInputModel::setDisplayPeriodStartDate(const QDate &display_period_start_date) {
    m_display_period_start_date = display_period_start_date;
    m_display_period_start_date_isSet = true;
}

bool OAIProjectFeeInputModel::is_display_period_start_date_Set() const{
    return m_display_period_start_date_isSet;
}

bool OAIProjectFeeInputModel::is_display_period_start_date_Valid() const{
    return m_display_period_start_date_isValid;
}

QDate OAIProjectFeeInputModel::getEventDate() const {
    return m_event_date;
}
void OAIProjectFeeInputModel::setEventDate(const QDate &event_date) {
    m_event_date = event_date;
    m_event_date_isSet = true;
}

bool OAIProjectFeeInputModel::is_event_date_Set() const{
    return m_event_date_isSet;
}

bool OAIProjectFeeInputModel::is_event_date_Valid() const{
    return m_event_date_isValid;
}

bool OAIProjectFeeInputModel::isHasVolumePricing() const {
    return m_has_volume_pricing;
}
void OAIProjectFeeInputModel::setHasVolumePricing(const bool &has_volume_pricing) {
    m_has_volume_pricing = has_volume_pricing;
    m_has_volume_pricing_isSet = true;
}

bool OAIProjectFeeInputModel::is_has_volume_pricing_Set() const{
    return m_has_volume_pricing_isSet;
}

bool OAIProjectFeeInputModel::is_has_volume_pricing_Valid() const{
    return m_has_volume_pricing_isValid;
}

OAISimpleInputModel OAIProjectFeeInputModel::getInvoice() const {
    return m_invoice;
}
void OAIProjectFeeInputModel::setInvoice(const OAISimpleInputModel &invoice) {
    m_invoice = invoice;
    m_invoice_isSet = true;
}

bool OAIProjectFeeInputModel::is_invoice_Set() const{
    return m_invoice_isSet;
}

bool OAIProjectFeeInputModel::is_invoice_Valid() const{
    return m_invoice_isValid;
}

double OAIProjectFeeInputModel::getInvoiceQuantity() const {
    return m_invoice_quantity;
}
void OAIProjectFeeInputModel::setInvoiceQuantity(const double &invoice_quantity) {
    m_invoice_quantity = invoice_quantity;
    m_invoice_quantity_isSet = true;
}

bool OAIProjectFeeInputModel::is_invoice_quantity_Set() const{
    return m_invoice_quantity_isSet;
}

bool OAIProjectFeeInputModel::is_invoice_quantity_Valid() const{
    return m_invoice_quantity_isValid;
}

QString OAIProjectFeeInputModel::getInvoiceRowComment() const {
    return m_invoice_row_comment;
}
void OAIProjectFeeInputModel::setInvoiceRowComment(const QString &invoice_row_comment) {
    m_invoice_row_comment = invoice_row_comment;
    m_invoice_row_comment_isSet = true;
}

bool OAIProjectFeeInputModel::is_invoice_row_comment_Set() const{
    return m_invoice_row_comment_isSet;
}

bool OAIProjectFeeInputModel::is_invoice_row_comment_Valid() const{
    return m_invoice_row_comment_isValid;
}

QString OAIProjectFeeInputModel::getInvoiceRowDescription() const {
    return m_invoice_row_description;
}
void OAIProjectFeeInputModel::setInvoiceRowDescription(const QString &invoice_row_description) {
    m_invoice_row_description = invoice_row_description;
    m_invoice_row_description_isSet = true;
}

bool OAIProjectFeeInputModel::is_invoice_row_description_Set() const{
    return m_invoice_row_description_isSet;
}

bool OAIProjectFeeInputModel::is_invoice_row_description_Valid() const{
    return m_invoice_row_description_isValid;
}

bool OAIProjectFeeInputModel::isIsBillable() const {
    return m_is_billable;
}
void OAIProjectFeeInputModel::setIsBillable(const bool &is_billable) {
    m_is_billable = is_billable;
    m_is_billable_isSet = true;
}

bool OAIProjectFeeInputModel::is_is_billable_Set() const{
    return m_is_billable_isSet;
}

bool OAIProjectFeeInputModel::is_is_billable_Valid() const{
    return m_is_billable_isValid;
}

QString OAIProjectFeeInputModel::getMeasurementUnit() const {
    return m_measurement_unit;
}
void OAIProjectFeeInputModel::setMeasurementUnit(const QString &measurement_unit) {
    m_measurement_unit = measurement_unit;
    m_measurement_unit_isSet = true;
}

bool OAIProjectFeeInputModel::is_measurement_unit_Set() const{
    return m_measurement_unit_isSet;
}

bool OAIProjectFeeInputModel::is_measurement_unit_Valid() const{
    return m_measurement_unit_isValid;
}

QString OAIProjectFeeInputModel::getName() const {
    return m_name;
}
void OAIProjectFeeInputModel::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProjectFeeInputModel::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProjectFeeInputModel::is_name_Valid() const{
    return m_name_isValid;
}

OAISimpleInputModel OAIProjectFeeInputModel::getPhase() const {
    return m_phase;
}
void OAIProjectFeeInputModel::setPhase(const OAISimpleInputModel &phase) {
    m_phase = phase;
    m_phase_isSet = true;
}

bool OAIProjectFeeInputModel::is_phase_Set() const{
    return m_phase_isSet;
}

bool OAIProjectFeeInputModel::is_phase_Valid() const{
    return m_phase_isValid;
}

QDate OAIProjectFeeInputModel::getPlannedBillingDate() const {
    return m_planned_billing_date;
}
void OAIProjectFeeInputModel::setPlannedBillingDate(const QDate &planned_billing_date) {
    m_planned_billing_date = planned_billing_date;
    m_planned_billing_date_isSet = true;
}

bool OAIProjectFeeInputModel::is_planned_billing_date_Set() const{
    return m_planned_billing_date_isSet;
}

bool OAIProjectFeeInputModel::is_planned_billing_date_Valid() const{
    return m_planned_billing_date_isValid;
}

OAISimpleInputModel OAIProjectFeeInputModel::getProduct() const {
    return m_product;
}
void OAIProjectFeeInputModel::setProduct(const OAISimpleInputModel &product) {
    m_product = product;
    m_product_isSet = true;
}

bool OAIProjectFeeInputModel::is_product_Set() const{
    return m_product_isSet;
}

bool OAIProjectFeeInputModel::is_product_Valid() const{
    return m_product_isValid;
}

OAIProductType OAIProjectFeeInputModel::getProductType() const {
    return m_product_type;
}
void OAIProjectFeeInputModel::setProductType(const OAIProductType &product_type) {
    m_product_type = product_type;
    m_product_type_isSet = true;
}

bool OAIProjectFeeInputModel::is_product_type_Set() const{
    return m_product_type_isSet;
}

bool OAIProjectFeeInputModel::is_product_type_Valid() const{
    return m_product_type_isValid;
}

OAISimpleInputRequiredModel OAIProjectFeeInputModel::getProject() const {
    return m_project;
}
void OAIProjectFeeInputModel::setProject(const OAISimpleInputRequiredModel &project) {
    m_project = project;
    m_project_isSet = true;
}

bool OAIProjectFeeInputModel::is_project_Set() const{
    return m_project_isSet;
}

bool OAIProjectFeeInputModel::is_project_Valid() const{
    return m_project_isValid;
}

double OAIProjectFeeInputModel::getQuantity() const {
    return m_quantity;
}
void OAIProjectFeeInputModel::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIProjectFeeInputModel::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIProjectFeeInputModel::is_quantity_Valid() const{
    return m_quantity_isValid;
}

OAISimpleInputModel OAIProjectFeeInputModel::getSalesAccount() const {
    return m_sales_account;
}
void OAIProjectFeeInputModel::setSalesAccount(const OAISimpleInputModel &sales_account) {
    m_sales_account = sales_account;
    m_sales_account_isSet = true;
}

bool OAIProjectFeeInputModel::is_sales_account_Set() const{
    return m_sales_account_isSet;
}

bool OAIProjectFeeInputModel::is_sales_account_Valid() const{
    return m_sales_account_isValid;
}

OAIMoneyInputModelWithNullableAmount OAIProjectFeeInputModel::getUnitCost() const {
    return m_unit_cost;
}
void OAIProjectFeeInputModel::setUnitCost(const OAIMoneyInputModelWithNullableAmount &unit_cost) {
    m_unit_cost = unit_cost;
    m_unit_cost_isSet = true;
}

bool OAIProjectFeeInputModel::is_unit_cost_Set() const{
    return m_unit_cost_isSet;
}

bool OAIProjectFeeInputModel::is_unit_cost_Valid() const{
    return m_unit_cost_isValid;
}

OAIMoneyInputModelWithNullableAmount OAIProjectFeeInputModel::getUnitPrice() const {
    return m_unit_price;
}
void OAIProjectFeeInputModel::setUnitPrice(const OAIMoneyInputModelWithNullableAmount &unit_price) {
    m_unit_price = unit_price;
    m_unit_price_isSet = true;
}

bool OAIProjectFeeInputModel::is_unit_price_Set() const{
    return m_unit_price_isSet;
}

bool OAIProjectFeeInputModel::is_unit_price_Valid() const{
    return m_unit_price_isValid;
}

OAISimpleInputModel OAIProjectFeeInputModel::getUser() const {
    return m_user;
}
void OAIProjectFeeInputModel::setUser(const OAISimpleInputModel &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIProjectFeeInputModel::is_user_Set() const{
    return m_user_isSet;
}

bool OAIProjectFeeInputModel::is_user_Valid() const{
    return m_user_isValid;
}

double OAIProjectFeeInputModel::getVatRate() const {
    return m_vat_rate;
}
void OAIProjectFeeInputModel::setVatRate(const double &vat_rate) {
    m_vat_rate = vat_rate;
    m_vat_rate_isSet = true;
}

bool OAIProjectFeeInputModel::is_vat_rate_Set() const{
    return m_vat_rate_isSet;
}

bool OAIProjectFeeInputModel::is_vat_rate_Valid() const{
    return m_vat_rate_isValid;
}

bool OAIProjectFeeInputModel::isSet() const {
...
bool OAIProjectFeeInputModel::isValid() const {
