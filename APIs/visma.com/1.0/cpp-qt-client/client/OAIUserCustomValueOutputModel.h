...
/*
 * OAIUserCustomValueOutputModel.h
 *
 * 
 */

#ifndef OAIUserCustomValueOutputModel_H
#define OAIUserCustomValueOutputModel_H
...
class OAIUserCustomValueOutputModel : public OAIObject {
public:
    OAIUserCustomValueOutputModel();
    OAIUserCustomValueOutputModel(QString json);
    ~OAIUserCustomValueOutputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserCustomValueOutputModel)

#endif // OAIUserCustomValueOutputModel_H
