...
/*
 * OAIVatRateOutputModel.h
 *
 * 
 */

#ifndef OAIVatRateOutputModel_H
#define OAIVatRateOutputModel_H
...
class OAIVatRateOutputModel : public OAIObject {
public:
    OAIVatRateOutputModel();
    OAIVatRateOutputModel(QString json);
    ~OAIVatRateOutputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVatRateOutputModel)

#endif // OAIVatRateOutputModel_H
