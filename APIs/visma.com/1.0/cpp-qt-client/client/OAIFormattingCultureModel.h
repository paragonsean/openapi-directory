...
/*
 * OAIFormattingCultureModel.h
 *
 * 
 */

#ifndef OAIFormattingCultureModel_H
#define OAIFormattingCultureModel_H
...
class OAIFormattingCultureModel : public OAIObject {
public:
    OAIFormattingCultureModel();
    OAIFormattingCultureModel(QString json);
    ~OAIFormattingCultureModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormattingCultureModel)

#endif // OAIFormattingCultureModel_H
