...
#ifndef OAIPriceListModel_H
#define OAIPriceListModel_H
...
class OAIPriceListCurrency;

class OAIPriceListModel : public OAIObject {
public:
    OAIPriceListModel();
    OAIPriceListModel(QString json);
    ~OAIPriceListModel() override;
    ...
    OAIPriceListCurrency getCurrency() const;
    void setCurrency(const OAIPriceListCurrency &currency);
...
private:
    ...
    OAIPriceListCurrency m_currency;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPriceListModel)

#endif // OAIPriceListModel_H
