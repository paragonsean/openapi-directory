...
/*
 * OAICustomerLanguage.h
 *
 * 
 */

#ifndef OAICustomerLanguage_H
#define OAICustomerLanguage_H
...
class OAICustomerLanguage : public OAIObject {
public:
    OAICustomerLanguage();
    OAICustomerLanguage(QString json);
    ~OAICustomerLanguage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerLanguage)

#endif // OAICustomerLanguage_H
