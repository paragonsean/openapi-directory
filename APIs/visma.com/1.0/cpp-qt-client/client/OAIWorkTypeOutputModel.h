...
/*
 * OAIWorkTypeOutputModel.h
 *
 * 
 */

#ifndef OAIWorkTypeOutputModel_H
#define OAIWorkTypeOutputModel_H
...
class OAIWorkTypeOutputModel : public OAIObject {
public:
    OAIWorkTypeOutputModel();
    OAIWorkTypeOutputModel(QString json);
    ~OAIWorkTypeOutputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkTypeOutputModel)

#endif // OAIWorkTypeOutputModel_H
