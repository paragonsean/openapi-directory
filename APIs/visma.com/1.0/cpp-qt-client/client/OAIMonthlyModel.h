...
#ifndef OAIMonthlyModel_H
#define OAIMonthlyModel_H
...
class OAIMonthlyModel : public OAIObject {
public:
    OAIMonthlyModel();
    OAIMonthlyModel(QString json);
    ~OAIMonthlyModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonthlyModel)

#endif // OAIMonthlyModel_H
