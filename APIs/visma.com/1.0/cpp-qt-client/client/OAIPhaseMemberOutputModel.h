...
/*
 * OAIPhaseMemberOutputModel.h
 *
 * 
 */

#ifndef OAIPhaseMemberOutputModel_H
#define OAIPhaseMemberOutputModel_H
...
class OAIPhaseMemberOutputModel : public OAIObject {
public:
    OAIPhaseMemberOutputModel();
    OAIPhaseMemberOutputModel(QString json);
    ~OAIPhaseMemberOutputModel() override;
    ...
    QString getCurrentWorkContractTitle() const;
    void setCurrentWorkContractTitle(const QString &current_work_contract_title);
    bool is_current_work_contract_title_Set() const;
    bool is_current_work_contract_title_Valid() const;
...
private:
    ...
    QString m_current_work_contract_title;
    bool m_current_work_contract_title_isSet;
    bool m_current_work_contract_title_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhaseMemberOutputModel)

#endif // OAIPhaseMemberOutputModel_H
