...
/*
 * OAIDeletedProjectFeeModel.h
 *
 * 
 */

#ifndef OAIDeletedProjectFeeModel_H
#define OAIDeletedProjectFeeModel_H
...
class OAIDeletedProjectFeeModel : public OAIObject {
public:
    OAIDeletedProjectFeeModel();
    OAIDeletedProjectFeeModel(QString json);
    ~OAIDeletedProjectFeeModel() override;
    ...
    OAIModelBaseReadOnly getProduct() const;
    void setProduct(const OAIModelBaseReadOnly &product);
...
private:
    ...
    OAIModelBaseReadOnly m_product;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletedProjectFeeModel)

#endif // OAIDeletedProjectFeeModel_H
