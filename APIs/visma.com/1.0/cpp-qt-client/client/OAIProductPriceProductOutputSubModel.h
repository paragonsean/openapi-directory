...
/*
 * OAIProductPriceProductOutputSubModel.h
 *
 * 
 */

#ifndef OAIProductPriceProductOutputSubModel_H
#define OAIProductPriceProductOutputSubModel_H
...
class OAIProductPriceProductOutputSubModel : public OAIObject {
public:
    OAIProductPriceProductOutputSubModel();
    OAIProductPriceProductOutputSubModel(QString json);
    ~OAIProductPriceProductOutputSubModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductPriceProductOutputSubModel)

#endif // OAIProductPriceProductOutputSubModel_H
