...
/*
 * OAICustomerCountry.h
 *
 * 
 */

#ifndef OAICustomerCountry_H
#define OAICustomerCountry_H
...
class OAICustomerCountry : public OAIObject {
public:
    OAICustomerCountry();
    OAICustomerCountry(QString json);
    ~OAICustomerCountry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerCountry)

#endif // OAICustomerCountry_H
