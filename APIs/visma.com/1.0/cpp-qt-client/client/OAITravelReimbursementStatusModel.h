...
/*
 * OAITravelReimbursementStatusModel.h
 *
 * 
 */

#ifndef OAITravelReimbursementStatusModel_H
#define OAITravelReimbursementStatusModel_H
...
class OAITravelReimbursementStatusModel : public OAIObject {
public:
    OAITravelReimbursementStatusModel();
    OAITravelReimbursementStatusModel(QString json);
    ~OAITravelReimbursementStatusModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITravelReimbursementStatusModel)

#endif // OAITravelReimbursementStatusModel_H
