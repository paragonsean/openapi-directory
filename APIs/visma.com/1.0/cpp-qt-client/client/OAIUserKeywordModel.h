...
/*
 * OAIUserKeywordModel.h
 *
 * 
 */

#ifndef OAIUserKeywordModel_H
#define OAIUserKeywordModel_H
...
class OAIUserKeywordModel : public OAIObject {
public:
    OAIUserKeywordModel();
    OAIUserKeywordModel(QString json);
    ~OAIUserKeywordModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserKeywordModel)

#endif // OAIUserKeywordModel_H
