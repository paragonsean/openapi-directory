...
/*
 * OAIProjectForecastInputModel.h
 *
 * 
 */

#ifndef OAIProjectForecastInputModel_H
#define OAIProjectForecastInputModel_H
...
class OAIProjectForecastInputModel : public OAIObject {
public:
    OAIProjectForecastInputModel();
    OAIProjectForecastInputModel(QString json);
    ~OAIProjectForecastInputModel() override;
    ...
    OAIMoneyInputModelWithNullableAmount getBillingForecast() const;
    void setBillingForecast(const OAIMoneyInputModelWithNullableAmount &billing_forecast);
    ...
    OAIMoneyInputModelWithNullableAmount getExpenseForecast() const;
    void setExpenseForecast(const OAIMoneyInputModelWithNullableAmount &expense_forecast);
    ...
    OAIMoneyInputModelWithNullableAmount getLaborExpenseForecast() const;
    void setLaborExpenseForecast(const OAIMoneyInputModelWithNullableAmount &labor_expense_forecast);
    ...
    OAIMoneyInputModelWithNullableAmount getRevenueForecast() const;
    void setRevenueForecast(const OAIMoneyInputModelWithNullableAmount &revenue_forecast);
...
private:
    ...
    OAIMoneyInputModelWithNullableAmount m_billing_forecast;
    ...
    OAIMoneyInputModelWithNullableAmount m_expense_forecast;
    ...
    OAIMoneyInputModelWithNullableAmount m_labor_expense_forecast;
    ...
    OAIMoneyInputModelWithNullableAmount m_revenue_forecast;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectForecastInputModel)

#endif // OAIProjectForecastInputModel_H
