...
/*
 * OAICustomerSalesNoteInputModel.h
 *
 * 
 */

#ifndef OAICustomerSalesNoteInputModel_H
#define OAICustomerSalesNoteInputModel_H
...
class OAICustomerSalesNoteInputModel : public OAIObject {
public:
    OAICustomerSalesNoteInputModel();
    OAICustomerSalesNoteInputModel(QString json);
    ~OAICustomerSalesNoteInputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerSalesNoteInputModel)

#endif // OAICustomerSalesNoteInputModel_H
