...
/*
 * OAIProductCategoryModel.h
 *
 * 
 */

#ifndef OAIProductCategoryModel_H
#define OAIProductCategoryModel_H
...
class OAIProductCategoryModel : public OAIObject {
public:
    OAIProductCategoryModel();
    OAIProductCategoryModel(QString json);
    ~OAIProductCategoryModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductCategoryModel)

#endif // OAIProductCategoryModel_H
