...
#ifndef OAIOvertimeModel_H
#define OAIOvertimeModel_H
...
class OAIOvertimeModel : public OAIObject {
public:
    OAIOvertimeModel();
    OAIOvertimeModel(QString json);
    ~OAIOvertimeModel() override;
    ...
    bool isIncludeInFlextime() const;
    void setIncludeInFlextime(const bool &include_in_flextime);
    bool is_include_in_flextime_Set() const;
    bool is_include_in_flextime_Valid() const;
    ...
    bool isMultipliesUnitCost() const;
    void setMultipliesUnitCost(const bool &multiplies_unit_cost);
    bool is_multiplies_unit_cost_Set() const;
    bool is_multiplies_unit_cost_Valid() const;
...
private:
    ...
    bool m_include_in_flextime;
    bool m_include_in_flextime_isSet;
    bool m_include_in_flextime_isValid;
    ...
    bool m_multiplies_unit_cost;
    bool m_multiplies_unit_cost_isSet;
    bool m_multiplies_unit_cost_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOvertimeModel)

#endif // OAIOvertimeModel_H
