...
/*
 * OAIFileKeywordModel.h
 *
 * 
 */

#ifndef OAIFileKeywordModel_H
#define OAIFileKeywordModel_H
...
class OAIFileKeywordModel : public OAIObject {
public:
    OAIFileKeywordModel();
    OAIFileKeywordModel(QString json);
    ~OAIFileKeywordModel() override;
    ...
    OAIKeywordCategory getCategory() const;
    void setCategory(const OAIKeywordCategory &category);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileKeywordModel)

#endif // OAIFileKeywordModel_H
