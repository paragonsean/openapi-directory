...
#ifndef OAIRoleInputModel_H
#define OAIRoleInputModel_H
...
class OAIRoleInputModel : public OAIObject {
public:
    OAIRoleInputModel();
    OAIRoleInputModel(QString json);
    ~OAIRoleInputModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoleInputModel)

#endif // OAIRoleInputModel_H
