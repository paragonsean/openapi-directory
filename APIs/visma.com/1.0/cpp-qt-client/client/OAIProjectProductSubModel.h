...
/*
 * OAIProjectProductSubModel.h
 *
 * 
 */

#ifndef OAIProjectProductSubModel_H
#define OAIProjectProductSubModel_H
...
class OAIProjectProductSubModel : public OAIObject {
public:
    OAIProjectProductSubModel();
    OAIProjectProductSubModel(QString json);
    ~OAIProjectProductSubModel() override;
    ...
    OAITypeOfProduct getProductType() const;
    void setProductType(const OAITypeOfProduct &product_type);
...
private:
    ...
    OAITypeOfProduct m_product_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectProductSubModel)

#endif // OAIProjectProductSubModel_H
