...
/*
 * OAIProjectTaskStatusModel.h
 *
 * 
 */

#ifndef OAIProjectTaskStatusModel_H
#define OAIProjectTaskStatusModel_H
...
class OAIProjectTaskStatusModel : public OAIObject {
public:
    OAIProjectTaskStatusModel();
    OAIProjectTaskStatusModel(QString json);
    ~OAIProjectTaskStatusModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectTaskStatusModel)

#endif // OAIProjectTaskStatusModel_H
