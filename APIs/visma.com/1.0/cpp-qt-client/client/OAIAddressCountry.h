...
#ifndef OAIAddressCountry_H
#define OAIAddressCountry_H
...
class OAIAddressCountry : public OAIObject {
public:
    OAIAddressCountry();
    OAIAddressCountry(QString json);
    ~OAIAddressCountry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressCountry)

#endif // OAIAddressCountry_H
