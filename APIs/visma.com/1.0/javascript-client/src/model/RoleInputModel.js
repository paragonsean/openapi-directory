...
/**
 * The RoleInputModel model module.
 * @module model/RoleInputModel
 * @version 1.0
 */
class RoleInputModel {
    /**
     * Constructs a new <code>RoleInputModel</code>.
     * @alias module:model/RoleInputModel
     * @param name {String} 
     */
    constructor(name) { 
        
        RoleInputModel.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>RoleInputModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RoleInputModel} obj Optional instance to populate.
     * @return {module:model/RoleInputModel} The populated <code>RoleInputModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RoleInputModel();
    ...
    /**
     * Validates the JSON data with respect to <code>RoleInputModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RoleInputModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RoleInputModel.RequiredProperties) {
...
RoleInputModel.RequiredProperties = ["name"];

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} createdBy
 */
RoleInputModel.prototype['createdBy'] = undefined;

/**
 * @member {Date} createdDateTime
 */
RoleInputModel.prototype['createdDateTime'] = undefined;

/**
 * @member {String} guid
 */
RoleInputModel.prototype['guid'] = undefined;

/**
 * @member {Boolean} isActive
 * @default true
 */
RoleInputModel.prototype['isActive'] = true;

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} lastUpdatedBy
 */
RoleInputModel.prototype['lastUpdatedBy'] = undefined;

/**
 * @member {Date} lastUpdatedDateTime
 */
RoleInputModel.prototype['lastUpdatedDateTime'] = undefined;

/**
 * @member {String} name
 */
RoleInputModel.prototype['name'] = undefined;
