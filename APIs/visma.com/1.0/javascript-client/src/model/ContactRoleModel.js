...
/**
 * The ContactRoleModel model module.
 * @module model/ContactRoleModel
 * @version 1.0
 */
class ContactRoleModel {
    /**
     * Constructs a new <code>ContactRoleModel</code>.
     * @alias module:model/ContactRoleModel
     * @param name {String} 
     */
    constructor(name) { 
        
        ContactRoleModel.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>ContactRoleModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactRoleModel} obj Optional instance to populate.
     * @return {module:model/ContactRoleModel} The populated <code>ContactRoleModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactRoleModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactRoleModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactRoleModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ContactRoleModel.RequiredProperties) {
...
ContactRoleModel.RequiredProperties = ["name"];

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} createdBy
 */
ContactRoleModel.prototype['createdBy'] = undefined;

/**
 * @member {Date} createdDateTime
 */
ContactRoleModel.prototype['createdDateTime'] = undefined;

/**
 * @member {String} guid
 */
ContactRoleModel.prototype['guid'] = undefined;

/**
 * @member {Boolean} isActive
 * @default true
 */
ContactRoleModel.prototype['isActive'] = true;

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} lastUpdatedBy
 */
ContactRoleModel.prototype['lastUpdatedBy'] = undefined;

/**
 * @member {Date} lastUpdatedDateTime
 */
ContactRoleModel.prototype['lastUpdatedDateTime'] = undefined;

/**
 * @member {String} name
 */
ContactRoleModel.prototype['name'] = undefined;
...
export default ContactRoleModel;
