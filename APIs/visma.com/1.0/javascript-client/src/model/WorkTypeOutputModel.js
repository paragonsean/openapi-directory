...
/**
 * The WorkTypeOutputModel model module.
 * @module model/WorkTypeOutputModel
 * @version 1.0
 */
class WorkTypeOutputModel {
    /**
     * Constructs a new <code>WorkTypeOutputModel</code>.
     * @alias module:model/WorkTypeOutputModel
     * @param name {String} 
     */
    constructor(name) { 
        
        WorkTypeOutputModel.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>WorkTypeOutputModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorkTypeOutputModel} obj Optional instance to populate.
     * @return {module:model/WorkTypeOutputModel} The populated <code>WorkTypeOutputModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkTypeOutputModel();
    ...
    /**
     * Validates the JSON data with respect to <code>WorkTypeOutputModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkTypeOutputModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WorkTypeOutputModel.RequiredProperties) {
...
WorkTypeOutputModel.RequiredProperties = ["name"];

/**
 * @member {String} code
 */
WorkTypeOutputModel.prototype['code'] = undefined;

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} createdBy
 */
WorkTypeOutputModel.prototype['createdBy'] = undefined;

/**
 * @member {Date} createdDateTime
 */
WorkTypeOutputModel.prototype['createdDateTime'] = undefined;

/**
 * @member {String} guid
 */
WorkTypeOutputModel.prototype['guid'] = undefined;

/**
 * @member {module:model/MoneyOutputModel} hourCost
 */
WorkTypeOutputModel.prototype['hourCost'] = undefined;

/**
 * @member {Boolean} isActive
 * @default true
 */
WorkTypeOutputModel.prototype['isActive'] = true;

/**
 * @member {Boolean} isDefault
 */
WorkTypeOutputModel.prototype['isDefault'] = undefined;

/**
 * @member {Boolean} isProductive
 */
WorkTypeOutputModel.prototype['isProductive'] = undefined;

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} lastUpdatedBy
 */
WorkTypeOutputModel.prototype['lastUpdatedBy'] = undefined;

/**
 * @member {Date} lastUpdatedDateTime
 */
WorkTypeOutputModel.prototype['lastUpdatedDateTime'] = undefined;

/**
 * @member {String} name
 */
WorkTypeOutputModel.prototype['name'] = undefined;

/**
 * @member {module:model/ModelWithName} salesAccount
 */
WorkTypeOutputModel.prototype['salesAccount'] = undefined;
...
export default WorkTypeOutputModel;
