...
/**
 * The FileModel model module.
 * @module model/FileModel
 * @version 1.0
 */
class FileModel {
    /**
     * Constructs a new <code>FileModel</code>.
     * @alias module:model/FileModel
     * @param name {String} 
     */
    constructor(name) { 
        
        FileModel.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>FileModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileModel} obj Optional instance to populate.
     * @return {module:model/FileModel} The populated <code>FileModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileModel();
    ...
    /**
     * Validates the JSON data with respect to <code>FileModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FileModel.RequiredProperties) {
...
FileModel.RequiredProperties = ["name"];

/**
 * @member {module:model/FileCategory} category
 */
FileModel.prototype['category'] = undefined;

/**
 * @member {String} contentType
 */
FileModel.prototype['contentType'] = undefined;

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} createdBy
 */
FileModel.prototype['createdBy'] = undefined;

/**
 * @member {Date} createdDateTime
 */
FileModel.prototype['createdDateTime'] = undefined;

/**
 * @member {String} description
 */
FileModel.prototype['description'] = undefined;

/**
 * @member {String} guid
 */
FileModel.prototype['guid'] = undefined;

/**
 * @member {Boolean} isInternal
 */
FileModel.prototype['isInternal'] = undefined;

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} lastUpdatedBy
 */
FileModel.prototype['lastUpdatedBy'] = undefined;

/**
 * @member {Date} lastUpdatedDateTime
 */
FileModel.prototype['lastUpdatedDateTime'] = undefined;

/**
 * @member {String} name
 */
FileModel.prototype['name'] = undefined;

/**
 * @member {Number} size
 */
FileModel.prototype['size'] = undefined;
