...
/**
 * The IndustryModel model module.
 * @module model/IndustryModel
 * @version 1.0
 */
class IndustryModel {
    /**
     * Constructs a new <code>IndustryModel</code>.
     * @alias module:model/IndustryModel
     * @param name {String} 
     */
    constructor(name) { 
        
        IndustryModel.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>IndustryModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IndustryModel} obj Optional instance to populate.
     * @return {module:model/IndustryModel} The populated <code>IndustryModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IndustryModel();
    ...
    /**
     * Validates the JSON data with respect to <code>IndustryModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IndustryModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IndustryModel.RequiredProperties) {
...
IndustryModel.RequiredProperties = ["name"];

/**
 * @member {String} code
 */
IndustryModel.prototype['code'] = undefined;

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} createdBy
 */
IndustryModel.prototype['createdBy'] = undefined;

/**
 * @member {Date} createdDateTime
 */
IndustryModel.prototype['createdDateTime'] = undefined;

/**
 * @member {String} guid
 */
IndustryModel.prototype['guid'] = undefined;

/**
 * @member {Boolean} isActive
 * @default true
 */
IndustryModel.prototype['isActive'] = true;

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} lastUpdatedBy
 */
IndustryModel.prototype['lastUpdatedBy'] = undefined;

/**
 * @member {Date} lastUpdatedDateTime
 */
IndustryModel.prototype['lastUpdatedDateTime'] = undefined;

/**
 * @member {String} name
 */
IndustryModel.prototype['name'] = undefined;
