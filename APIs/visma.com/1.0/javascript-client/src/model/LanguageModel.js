...
class LanguageModel {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('isInvoiceLanguage')) {
                obj['isInvoiceLanguage'] = ApiClient.convertToType(data['isInvoiceLanguage'], 'Boolean');
            }
 ...
 * @member {String} code
 */
LanguageModel.prototype['code'] = undefined;

/**
 * @member {String} englishName
 */
LanguageModel.prototype['englishName'] = undefined;

/**
 * @member {String} guid
 */
LanguageModel.prototype['guid'] = undefined;

/**
 * @member {Boolean} isInvoiceLanguage
 */
LanguageModel.prototype['isInvoiceLanguage'] = undefined;

/**
 * @member {String} name
 */
LanguageModel.prototype['name'] = undefined;
