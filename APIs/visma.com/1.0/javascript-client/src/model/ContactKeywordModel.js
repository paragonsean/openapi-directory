...
/**
 * The ContactKeywordModel model module.
 * @module model/ContactKeywordModel
 * @version 1.0
 */
class ContactKeywordModel {
    /**
     * Constructs a new <code>ContactKeywordModel</code>.
     * @alias module:model/ContactKeywordModel
     * @param keyword {String} 
     */
    constructor(keyword) { 
        
        ContactKeywordModel.initialize(this, keyword);
    }
    ...
    /**
     * Constructs a <code>ContactKeywordModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContactKeywordModel} obj Optional instance to populate.
     * @return {module:model/ContactKeywordModel} The populated <code>ContactKeywordModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContactKeywordModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ContactKeywordModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContactKeywordModel</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ContactKeywordModel.RequiredProperties) {
...
ContactKeywordModel.RequiredProperties = ["keyword"];

/**
 * @member {module:model/KeywordCategory} category
 */
ContactKeywordModel.prototype['category'] = undefined;

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} createdBy
 */
ContactKeywordModel.prototype['createdBy'] = undefined;

/**
 * @member {Date} createdDateTime
 */
ContactKeywordModel.prototype['createdDateTime'] = undefined;

/**
 * @member {String} guid
 */
ContactKeywordModel.prototype['guid'] = undefined;

/**
 * @member {Boolean} isActive
 * @default true
 */
ContactKeywordModel.prototype['isActive'] = true;

/**
 * @member {String} keyword
 */
ContactKeywordModel.prototype['keyword'] = undefined;

/**
 * @member {module:model/UserWithFirstNameLastNameAndPhotoFileModel} lastUpdatedBy
 */
ContactKeywordModel.prototype['lastUpdatedBy'] = undefined;

/**
 * @member {Date} lastUpdatedDateTime
 */
ContactKeywordModel.prototype['lastUpdatedDateTime'] = undefined;
...
export default ContactKeywordModel;
