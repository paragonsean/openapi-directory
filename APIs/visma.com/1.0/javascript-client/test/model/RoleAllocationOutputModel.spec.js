...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.RoleAllocationOutputModel();
  });
  ...
  describe('RoleAllocationOutputModel', function() {
    it('should create an instance of RoleAllocationOutputModel', function() {
      // uncomment below and update the code to test RoleAllocationOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.RoleAllocationOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.RoleAllocationOutputModel);
    });
