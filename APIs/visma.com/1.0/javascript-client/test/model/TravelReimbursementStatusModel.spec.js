...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.TravelReimbursementStatusModel();
  });
  ...
  describe('TravelReimbursementStatusModel', function() {
    it('should create an instance of TravelReimbursementStatusModel', function() {
      // uncomment below and update the code to test TravelReimbursementStatusModel
      //var instance = new SeveraPublicRestApiDocumentation.TravelReimbursementStatusModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.TravelReimbursementStatusModel);
    });
