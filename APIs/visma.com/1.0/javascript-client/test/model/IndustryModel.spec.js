...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.IndustryModel();
  });
  ...
  describe('IndustryModel', function() {
    it('should create an instance of IndustryModel', function() {
      // uncomment below and update the code to test IndustryModel
      //var instance = new SeveraPublicRestApiDocumentation.IndustryModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.IndustryModel);
    });
