...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ErrorModel();
  });
  ...
  describe('ErrorModel', function() {
    it('should create an instance of ErrorModel', function() {
      ...
      //var instance = new SeveraPublicRestApiDocumentation.ErrorModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ErrorModel);
    });
