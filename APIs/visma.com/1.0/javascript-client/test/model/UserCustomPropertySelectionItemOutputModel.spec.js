...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.UserCustomPropertySelectionItemOutputModel();
  });
  ...
  describe('UserCustomPropertySelectionItemOutputModel', function() {
    it('should create an instance of UserCustomPropertySelectionItemOutputModel', function() {
      // uncomment below and update the code to test UserCustomPropertySelectionItemOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.UserCustomPropertySelectionItemOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.UserCustomPropertySelectionItemOutputModel);
    });
    ...
    it('should have the property userCustomProperty (base name: "userCustomProperty")', function() {
      // uncomment below and update the code to test the property userCustomProperty
      //var instance = new SeveraPublicRestApiDocumentation.UserCustomPropertySelectionItemOutputModel();
      //expect(instance).to.be();
    });
