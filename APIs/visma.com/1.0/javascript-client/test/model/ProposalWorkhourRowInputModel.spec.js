...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProposalWorkhourRowInputModel();
  });
  ...
  describe('ProposalWorkhourRowInputModel', function() {
    it('should create an instance of ProposalWorkhourRowInputModel', function() {
      // uncomment below and update the code to test ProposalWorkhourRowInputModel
      //var instance = new SeveraPublicRestApiDocumentation.ProposalWorkhourRowInputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProposalWorkhourRowInputModel);
    });
