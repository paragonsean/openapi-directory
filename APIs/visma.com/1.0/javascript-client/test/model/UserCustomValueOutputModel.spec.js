...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.UserCustomValueOutputModel();
  });
  ...
  describe('UserCustomValueOutputModel', function() {
    it('should create an instance of UserCustomValueOutputModel', function() {
      // uncomment below and update the code to test UserCustomValueOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.UserCustomValueOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.UserCustomValueOutputModel);
    });
    ...
    it('should have the property customProperty (base name: "customProperty")', function() {
      // uncomment below and update the code to test the property customProperty
      //var instance = new SeveraPublicRestApiDocumentation.UserCustomValueOutputModel();
      //expect(instance).to.be();
    });
