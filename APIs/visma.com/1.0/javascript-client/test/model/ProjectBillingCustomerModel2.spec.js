...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectBillingCustomerModel2();
  });
  ...
  describe('ProjectBillingCustomerModel2', function() {
    it('should create an instance of ProjectBillingCustomerModel2', function() {
      // uncomment below and update the code to test ProjectBillingCustomerModel2
      //var instance = new SeveraPublicRestApiDocumentation.ProjectBillingCustomerModel2();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectBillingCustomerModel2);
    });
