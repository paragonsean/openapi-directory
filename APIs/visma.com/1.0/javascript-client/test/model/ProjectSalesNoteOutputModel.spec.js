...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectSalesNoteOutputModel();
  });
  ...
  describe('ProjectSalesNoteOutputModel', function() {
    it('should create an instance of ProjectSalesNoteOutputModel', function() {
      // uncomment below and update the code to test ProjectSalesNoteOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectSalesNoteOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectSalesNoteOutputModel);
    });
