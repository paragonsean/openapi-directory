...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.TravelReimbursementSubModel();
  });
  ...
  describe('TravelReimbursementSubModel', function() {
    it('should create an instance of TravelReimbursementSubModel', function() {
      // uncomment below and update the code to test TravelReimbursementSubModel
      //var instance = new SeveraPublicRestApiDocumentation.TravelReimbursementSubModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.TravelReimbursementSubModel);
    });
