...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.FlextimeAdjustmentOutputModel();
  });
  ...
  describe('FlextimeAdjustmentOutputModel', function() {
    it('should create an instance of FlextimeAdjustmentOutputModel', function() {
      // uncomment below and update the code to test FlextimeAdjustmentOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.FlextimeAdjustmentOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.FlextimeAdjustmentOutputModel);
    });
