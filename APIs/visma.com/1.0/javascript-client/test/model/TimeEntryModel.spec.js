...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.TimeEntryModel();
  });
  ...
  describe('TimeEntryModel', function() {
    it('should create an instance of TimeEntryModel', function() {
      // uncomment below and update the code to test TimeEntryModel
      //var instance = new SeveraPublicRestApiDocumentation.TimeEntryModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.TimeEntryModel);
    });
    ...
    it('should have the property timeEntryType (base name: "timeEntryType")', function() {
      // uncomment below and update the code to test the property timeEntryType
      //var instance = new SeveraPublicRestApiDocumentation.TimeEntryModel();
      //expect(instance).to.be();
    });
