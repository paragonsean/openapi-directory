...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.PhaseMemberOutputModel();
  });
  ...
  describe('PhaseMemberOutputModel', function() {
    it('should create an instance of PhaseMemberOutputModel', function() {
      // uncomment below and update the code to test PhaseMemberOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.PhaseMemberOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.PhaseMemberOutputModel);
    });
