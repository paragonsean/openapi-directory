...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.CustomerSalesNoteOutputModel();
  });
  ...
  describe('CustomerSalesNoteOutputModel', function() {
    it('should create an instance of CustomerSalesNoteOutputModel', function() {
      // uncomment below and update the code to test CustomerSalesNoteOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.CustomerSalesNoteOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.CustomerSalesNoteOutputModel);
    });
