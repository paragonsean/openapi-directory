...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.FileKeywordModel();
  });
  ...
  describe('FileKeywordModel', function() {
    it('should create an instance of FileKeywordModel', function() {
      // uncomment below and update the code to test FileKeywordModel
      //var instance = new SeveraPublicRestApiDocumentation.FileKeywordModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.FileKeywordModel);
    });
