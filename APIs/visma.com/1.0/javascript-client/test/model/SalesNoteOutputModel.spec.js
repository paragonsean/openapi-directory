...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.SalesNoteOutputModel();
  });
  ...
  describe('SalesNoteOutputModel', function() {
    it('should create an instance of SalesNoteOutputModel', function() {
      // uncomment below and update the code to test SalesNoteOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.SalesNoteOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.SalesNoteOutputModel);
    });
