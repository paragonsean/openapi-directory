...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.TravelExpenseTypeCountrySettingsModel();
  });
  ...
  describe('TravelExpenseTypeCountrySettingsModel', function() {
    it('should create an instance of TravelExpenseTypeCountrySettingsModel', function() {
      // uncomment below and update the code to test TravelExpenseTypeCountrySettingsModel
      //var instance = new SeveraPublicRestApiDocumentation.TravelExpenseTypeCountrySettingsModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.TravelExpenseTypeCountrySettingsModel);
    });
