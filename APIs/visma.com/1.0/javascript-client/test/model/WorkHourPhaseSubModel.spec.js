...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.WorkHourPhaseSubModel();
  });
  ...
  describe('WorkHourPhaseSubModel', function() {
    it('should create an instance of WorkHourPhaseSubModel', function() {
      // uncomment below and update the code to test WorkHourPhaseSubModel
      //var instance = new SeveraPublicRestApiDocumentation.WorkHourPhaseSubModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.WorkHourPhaseSubModel);
    });
