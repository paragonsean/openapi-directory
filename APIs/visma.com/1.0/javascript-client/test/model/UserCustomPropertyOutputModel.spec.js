...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.UserCustomPropertyOutputModel();
  });
  ...
  describe('UserCustomPropertyOutputModel', function() {
    it('should create an instance of UserCustomPropertyOutputModel', function() {
      // uncomment below and update the code to test UserCustomPropertyOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.UserCustomPropertyOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.UserCustomPropertyOutputModel);
    });
