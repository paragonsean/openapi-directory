...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.WorkHourInputModel();
  });
  ...
  describe('WorkHourInputModel', function() {
    it('should create an instance of WorkHourInputModel', function() {
      // uncomment below and update the code to test WorkHourInputModel
      //var instance = new SeveraPublicRestApiDocumentation.WorkHourInputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.WorkHourInputModel);
    });
    ...
    it('should have the property plannedInvoiceQuantity (base name: "plannedInvoiceQuantity")', function() {
      // uncomment below and update the code to test the property plannedInvoiceQuantity
      //var instance = new SeveraPublicRestApiDocumentation.WorkHourInputModel();
      //expect(instance).to.be();
    });
