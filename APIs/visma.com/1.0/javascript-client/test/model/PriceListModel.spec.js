...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.PriceListModel();
  });
  ...
  describe('PriceListModel', function() {
    it('should create an instance of PriceListModel', function() {
      // uncomment below and update the code to test PriceListModel
      //var instance = new SeveraPublicRestApiDocumentation.PriceListModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.PriceListModel);
    });
