...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectMemberCostExceptionOutputModel();
  });
  ...
  describe('ProjectMemberCostExceptionOutputModel', function() {
    it('should create an instance of ProjectMemberCostExceptionOutputModel', function() {
      // uncomment below and update the code to test ProjectMemberCostExceptionOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectMemberCostExceptionOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectMemberCostExceptionOutputModel);
    });
