...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ContactKeywordModel();
  });
  ...
  describe('ContactKeywordModel', function() {
    it('should create an instance of ContactKeywordModel', function() {
      // uncomment below and update the code to test ContactKeywordModel
      //var instance = new SeveraPublicRestApiDocumentation.ContactKeywordModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ContactKeywordModel);
    });
