...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.PriceListOutputModel();
  });
  ...
  describe('PriceListOutputModel', function() {
    it('should create an instance of PriceListOutputModel', function() {
      // uncomment below and update the code to test PriceListOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.PriceListOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.PriceListOutputModel);
    });
