...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.DeletedPhaseMemberOutputModel();
  });
  ...
  describe('DeletedPhaseMemberOutputModel', function() {
    it('should create an instance of DeletedPhaseMemberOutputModel', function() {
      // uncomment below and update the code to test DeletedPhaseMemberOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.DeletedPhaseMemberOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.DeletedPhaseMemberOutputModel);
    });
    ...
    it('should have the property currentWorkContractTitle (base name: "currentWorkContractTitle")', function() {
      // uncomment below and update the code to test the property currentWorkContractTitle
      //var instance = new SeveraPublicRestApiDocumentation.DeletedPhaseMemberOutputModel();
      //expect(instance).to.be();
    });
