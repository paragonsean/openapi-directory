...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectWorkHourPriceOutputModel();
  });
  ...
  describe('ProjectWorkHourPriceOutputModel', function() {
    it('should create an instance of ProjectWorkHourPriceOutputModel', function() {
      // uncomment below and update the code to test ProjectWorkHourPriceOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectWorkHourPriceOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectWorkHourPriceOutputModel);
    });
