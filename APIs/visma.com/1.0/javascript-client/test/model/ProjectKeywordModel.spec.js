...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectKeywordModel();
  });
  ...
  describe('ProjectKeywordModel', function() {
    it('should create an instance of ProjectKeywordModel', function() {
      // uncomment below and update the code to test ProjectKeywordModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectKeywordModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectKeywordModel);
    });
