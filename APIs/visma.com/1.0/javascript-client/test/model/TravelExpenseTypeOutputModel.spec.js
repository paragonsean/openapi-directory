...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.TravelExpenseTypeOutputModel();
  });
  ...
  describe('TravelExpenseTypeOutputModel', function() {
    it('should create an instance of TravelExpenseTypeOutputModel', function() {
      // uncomment below and update the code to test TravelExpenseTypeOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.TravelExpenseTypeOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.TravelExpenseTypeOutputModel);
    });
    ...
    it('should have the property expenseClass (base name: "expenseClass")', function() {
      // uncomment below and update the code to test the property expenseClass
      //var instance = new SeveraPublicRestApiDocumentation.TravelExpenseTypeOutputModel();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isDailyAllowance (base name: "isDailyAllowance")', function() {
      // uncomment below and update the code to test the property isDailyAllowance
      //var instance = new SeveraPublicRestApiDocumentation.TravelExpenseTypeOutputModel();
      //expect(instance).to.be();
    });

    it('should have the property isMileage (base name: "isMileage")', function() {
      // uncomment below and update the code to test the property isMileage
      //var instance = new SeveraPublicRestApiDocumentation.TravelExpenseTypeOutputModel();
      //expect(instance).to.be();
    });
