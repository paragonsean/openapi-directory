...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.PhaseStatusTypeModel();
  });
  ...
  describe('PhaseStatusTypeModel', function() {
    it('should create an instance of PhaseStatusTypeModel', function() {
      // uncomment below and update the code to test PhaseStatusTypeModel
      //var instance = new SeveraPublicRestApiDocumentation.PhaseStatusTypeModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.PhaseStatusTypeModel);
    });
