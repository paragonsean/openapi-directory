...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.CustomerCustomPropertySelectionItemOutputModel();
  });
  ...
  describe('CustomerCustomPropertySelectionItemOutputModel', function() {
    it('should create an instance of CustomerCustomPropertySelectionItemOutputModel', function() {
      // uncomment below and update the code to test CustomerCustomPropertySelectionItemOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.CustomerCustomPropertySelectionItemOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.CustomerCustomPropertySelectionItemOutputModel);
    });
    ...
    it('should have the property customerCustomProperty (base name: "customerCustomProperty")', function() {
      // uncomment below and update the code to test the property customerCustomProperty
      //var instance = new SeveraPublicRestApiDocumentation.CustomerCustomPropertySelectionItemOutputModel();
      //expect(instance).to.be();
    });
