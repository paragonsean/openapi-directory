...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.KeywordModel();
  });
  ...
  describe('KeywordModel', function() {
    it('should create an instance of KeywordModel', function() {
      // uncomment below and update the code to test KeywordModel
      //var instance = new SeveraPublicRestApiDocumentation.KeywordModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.KeywordModel);
    });
