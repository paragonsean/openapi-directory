...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProductPriceProductOutputSubModel();
  });
  ...
  describe('ProductPriceProductOutputSubModel', function() {
    it('should create an instance of ProductPriceProductOutputSubModel', function() {
      // uncomment below and update the code to test ProductPriceProductOutputSubModel
      //var instance = new SeveraPublicRestApiDocumentation.ProductPriceProductOutputSubModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProductPriceProductOutputSubModel);
    });
