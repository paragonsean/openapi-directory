...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.PricelistVersionOutputModel();
  });
  ...
  describe('PricelistVersionOutputModel', function() {
    it('should create an instance of PricelistVersionOutputModel', function() {
      // uncomment below and update the code to test PricelistVersionOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.PricelistVersionOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.PricelistVersionOutputModel);
    });
    ...
    it('should have the property pricelistGuid (base name: "pricelistGuid")', function() {
      // uncomment below and update the code to test the property pricelistGuid
      //var instance = new SeveraPublicRestApiDocumentation.PricelistVersionOutputModel();
      //expect(instance).to.be();
    });
