...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.BankAccountOutputModel();
  });
  ...
  describe('BankAccountOutputModel', function() {
    it('should create an instance of BankAccountOutputModel', function() {
      // uncomment below and update the code to test BankAccountOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.BankAccountOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.BankAccountOutputModel);
    });
    ...
    it('should have the property accountNumberFormat (base name: "accountNumberFormat")', function() {
      // uncomment below and update the code to test the property accountNumberFormat
      //var instance = new SeveraPublicRestApiDocumentation.BankAccountOutputModel();
      //expect(instance).to.be();
    });
