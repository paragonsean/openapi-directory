...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.RoleOutputModel();
  });
  ...
  describe('RoleOutputModel', function() {
    it('should create an instance of RoleOutputModel', function() {
      // uncomment below and update the code to test RoleOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.RoleOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.RoleOutputModel);
    });
