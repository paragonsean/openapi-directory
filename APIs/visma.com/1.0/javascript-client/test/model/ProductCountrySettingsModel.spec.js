...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProductCountrySettingsModel();
  });
  ...
  describe('ProductCountrySettingsModel', function() {
    it('should create an instance of ProductCountrySettingsModel', function() {
      // uncomment below and update the code to test ProductCountrySettingsModel
      //var instance = new SeveraPublicRestApiDocumentation.ProductCountrySettingsModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProductCountrySettingsModel);
    });
