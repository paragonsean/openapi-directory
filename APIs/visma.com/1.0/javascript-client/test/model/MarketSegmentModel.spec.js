...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.MarketSegmentModel();
  });
  ...
  describe('MarketSegmentModel', function() {
    it('should create an instance of MarketSegmentModel', function() {
      // uncomment below and update the code to test MarketSegmentModel
      //var instance = new SeveraPublicRestApiDocumentation.MarketSegmentModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.MarketSegmentModel);
    });
    ...
    it('should have the property parentMarketSegment (base name: "parentMarketSegment")', function() {
      // uncomment below and update the code to test the property parentMarketSegment
      //var instance = new SeveraPublicRestApiDocumentation.MarketSegmentModel();
      //expect(instance).to.be();
    });
