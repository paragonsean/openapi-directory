...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ActivityRecurrenceModel();
  });
  ...
  describe('ActivityRecurrenceModel', function() {
    it('should create an instance of ActivityRecurrenceModel', function() {
      // uncomment below and update the code to test ActivityRecurrenceModel
      //var instance = new SeveraPublicRestApiDocumentation.ActivityRecurrenceModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ActivityRecurrenceModel);
    });
    ...
    it('should have the property lastOccurrenceDateTime (base name: "lastOccurrenceDateTime")', function() {
      // uncomment below and update the code to test the property lastOccurrenceDateTime
      //var instance = new SeveraPublicRestApiDocumentation.ActivityRecurrenceModel();
      //expect(instance).to.be();
    });
