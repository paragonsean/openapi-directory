...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.DeletedWorkHourModel();
  });
  ...
  describe('DeletedWorkHourModel', function() {
    it('should create an instance of DeletedWorkHourModel', function() {
      // uncomment below and update the code to test DeletedWorkHourModel
      //var instance = new SeveraPublicRestApiDocumentation.DeletedWorkHourModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.DeletedWorkHourModel);
    });
