...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.CostCenterModel();
  });
  ...
  describe('CostCenterModel', function() {
    it('should create an instance of CostCenterModel', function() {
      // uncomment below and update the code to test CostCenterModel
      //var instance = new SeveraPublicRestApiDocumentation.CostCenterModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.CostCenterModel);
    });
