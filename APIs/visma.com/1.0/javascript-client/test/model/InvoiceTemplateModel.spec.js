...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.InvoiceTemplateModel();
  });
  ...
  describe('InvoiceTemplateModel', function() {
    it('should create an instance of InvoiceTemplateModel', function() {
      // uncomment below and update the code to test InvoiceTemplateModel
      //var instance = new SeveraPublicRestApiDocumentation.InvoiceTemplateModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.InvoiceTemplateModel);
    });
