...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectInputModelBase();
  });
  ...
  describe('ProjectInputModelBase', function() {
    it('should create an instance of ProjectInputModelBase', function() {
      // uncomment below and update the code to test ProjectInputModelBase
      //var instance = new SeveraPublicRestApiDocumentation.ProjectInputModelBase();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectInputModelBase);
    });
