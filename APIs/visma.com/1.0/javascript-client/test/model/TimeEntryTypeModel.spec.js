...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.TimeEntryTypeModel();
  });
  ...
  describe('TimeEntryTypeModel', function() {
    it('should create an instance of TimeEntryTypeModel', function() {
      // uncomment below and update the code to test TimeEntryTypeModel
      //var instance = new SeveraPublicRestApiDocumentation.TimeEntryTypeModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.TimeEntryTypeModel);
    });
