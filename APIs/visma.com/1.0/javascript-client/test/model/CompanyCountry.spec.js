...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.CompanyCountry();
  });
  ...
  describe('CompanyCountry', function() {
    it('should create an instance of CompanyCountry', function() {
      // uncomment below and update the code to test CompanyCountry
      //var instance = new SeveraPublicRestApiDocumentation.CompanyCountry();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.CompanyCountry);
    });
