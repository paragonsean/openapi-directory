...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.WorkHourPriceOutputModel();
  });
  ...
  describe('WorkHourPriceOutputModel', function() {
    it('should create an instance of WorkHourPriceOutputModel', function() {
      // uncomment below and update the code to test WorkHourPriceOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.WorkHourPriceOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.WorkHourPriceOutputModel);
    });
    ...
    it('should have the property pricelistVersion (base name: "pricelistVersion")', function() {
      // uncomment below and update the code to test the property pricelistVersion
      //var instance = new SeveraPublicRestApiDocumentation.WorkHourPriceOutputModel();
      //expect(instance).to.be();
    });
