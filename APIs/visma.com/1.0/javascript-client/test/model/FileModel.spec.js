...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.FileModel();
  });
  ...
  describe('FileModel', function() {
    it('should create an instance of FileModel', function() {
      // uncomment below and update the code to test FileModel
      //var instance = new SeveraPublicRestApiDocumentation.FileModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.FileModel);
    });
