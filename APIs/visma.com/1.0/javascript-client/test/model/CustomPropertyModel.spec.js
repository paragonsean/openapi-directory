...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.CustomPropertyModel();
  });
  ...
  describe('CustomPropertyModel', function() {
    it('should create an instance of CustomPropertyModel', function() {
      // uncomment below and update the code to test CustomPropertyModel
      //var instance = new SeveraPublicRestApiDocumentation.CustomPropertyModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.CustomPropertyModel);
    });
