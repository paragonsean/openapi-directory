...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.InvoiceFileModel();
  });
  ...
  describe('InvoiceFileModel', function() {
    it('should create an instance of InvoiceFileModel', function() {
      // uncomment below and update the code to test InvoiceFileModel
      //var instance = new SeveraPublicRestApiDocumentation.InvoiceFileModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.InvoiceFileModel);
    });
