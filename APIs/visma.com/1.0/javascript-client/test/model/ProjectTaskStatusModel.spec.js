...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectTaskStatusModel();
  });
  ...
  describe('ProjectTaskStatusModel', function() {
    it('should create an instance of ProjectTaskStatusModel', function() {
      // uncomment below and update the code to test ProjectTaskStatusModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectTaskStatusModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectTaskStatusModel);
    });
