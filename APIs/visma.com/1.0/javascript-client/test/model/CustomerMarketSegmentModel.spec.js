...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.CustomerMarketSegmentModel();
  });
  ...
  describe('CustomerMarketSegmentModel', function() {
    it('should create an instance of CustomerMarketSegmentModel', function() {
      // uncomment below and update the code to test CustomerMarketSegmentModel
      //var instance = new SeveraPublicRestApiDocumentation.CustomerMarketSegmentModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.CustomerMarketSegmentModel);
    });
