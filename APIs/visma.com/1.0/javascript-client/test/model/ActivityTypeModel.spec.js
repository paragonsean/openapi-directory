...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ActivityTypeModel();
  });
  ...
  describe('ActivityTypeModel', function() {
    it('should create an instance of ActivityTypeModel', function() {
      // uncomment below and update the code to test ActivityTypeModel
      //var instance = new SeveraPublicRestApiDocumentation.ActivityTypeModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ActivityTypeModel);
    });
