...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.UserKeywordModel();
  });
  ...
  describe('UserKeywordModel', function() {
    it('should create an instance of UserKeywordModel', function() {
      // uncomment below and update the code to test UserKeywordModel
      //var instance = new SeveraPublicRestApiDocumentation.UserKeywordModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.UserKeywordModel);
    });
