...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectProductSubModel();
  });
  ...
  describe('ProjectProductSubModel', function() {
    it('should create an instance of ProjectProductSubModel', function() {
      // uncomment below and update the code to test ProjectProductSubModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectProductSubModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectProductSubModel);
    });
