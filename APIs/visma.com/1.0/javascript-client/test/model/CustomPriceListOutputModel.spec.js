...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.CustomPriceListOutputModel();
  });
  ...
  describe('CustomPriceListOutputModel', function() {
    it('should create an instance of CustomPriceListOutputModel', function() {
      // uncomment below and update the code to test CustomPriceListOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.CustomPriceListOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.CustomPriceListOutputModel);
    });
