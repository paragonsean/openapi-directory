...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.WorkHourOutputModel();
  });
  ...
  describe('WorkHourOutputModel', function() {
    it('should create an instance of WorkHourOutputModel', function() {
      // uncomment below and update the code to test WorkHourOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.WorkHourOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.WorkHourOutputModel);
    });

    it('should have the property billableStatus (base name: "billableStatus")', function() {
      // uncomment below and update the code to test the property billableStatus
      //var instance = new SeveraPublicRestApiDocumentation.WorkHourOutputModel();
