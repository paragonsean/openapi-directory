...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectWorkHourPriceInputModel();
  });
  ...
  describe('ProjectWorkHourPriceInputModel', function() {
    it('should create an instance of ProjectWorkHourPriceInputModel', function() {
      // uncomment below and update the code to test ProjectWorkHourPriceInputModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectWorkHourPriceInputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectWorkHourPriceInputModel);
    });
