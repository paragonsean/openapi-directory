...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectBillingCustomerModel();
  });
  ...
  describe('ProjectBillingCustomerModel', function() {
    it('should create an instance of ProjectBillingCustomerModel', function() {
      // uncomment below and update the code to test ProjectBillingCustomerModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectBillingCustomerModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectBillingCustomerModel);
    });
