...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.UsageModel();
  });
  ...
  describe('UsageModel', function() {
    it('should create an instance of UsageModel', function() {
      ...
      //var instance = new SeveraPublicRestApiDocumentation.UsageModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.UsageModel);
    });
