...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProductCategoryModel();
  });
  ...
  describe('ProductCategoryModel', function() {
    it('should create an instance of ProductCategoryModel', function() {
      // uncomment below and update the code to test ProductCategoryModel
      //var instance = new SeveraPublicRestApiDocumentation.ProductCategoryModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProductCategoryModel);
    });
