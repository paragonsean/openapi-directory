...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ContactCommunicationModel();
  });
  ...
  describe('ContactCommunicationModel', function() {
    it('should create an instance of ContactCommunicationModel', function() {
      // uncomment below and update the code to test ContactCommunicationModel
      //var instance = new SeveraPublicRestApiDocumentation.ContactCommunicationModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ContactCommunicationModel);
    });
    ...
    it('should have the property isForbiddenToUse (base name: "isForbiddenToUse")', function() {
      // uncomment below and update the code to test the property isForbiddenToUse
      //var instance = new SeveraPublicRestApiDocumentation.ContactCommunicationModel();
      //expect(instance).to.be();
    });
