...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectCustomPropertySelectionItemOutputModel();
  });
  ...
  describe('ProjectCustomPropertySelectionItemOutputModel', function() {
    it('should create an instance of ProjectCustomPropertySelectionItemOutputModel', function() {
      // uncomment below and update the code to test ProjectCustomPropertySelectionItemOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectCustomPropertySelectionItemOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectCustomPropertySelectionItemOutputModel);
    });
