...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.CostAccountModel();
  });
  ...
  describe('CostAccountModel', function() {
    it('should create an instance of CostAccountModel', function() {
      // uncomment below and update the code to test CostAccountModel
      //var instance = new SeveraPublicRestApiDocumentation.CostAccountModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.CostAccountModel);
    });
    ...
    it('should have the property isTravelTypeDefault (base name: "isTravelTypeDefault")', function() {
      // uncomment below and update the code to test the property isTravelTypeDefault
      //var instance = new SeveraPublicRestApiDocumentation.CostAccountModel();
      //expect(instance).to.be();
    });
