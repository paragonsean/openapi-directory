...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.UserOutputModel();
  });
  ...
  describe('UserOutputModel', function() {
    it('should create an instance of UserOutputModel', function() {
      // uncomment below and update the code to test UserOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.UserOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.UserOutputModel);
    });
    ...
    it('should have the property workContract (base name: "workContract")', function() {
      // uncomment below and update the code to test the property workContract
      //var instance = new SeveraPublicRestApiDocumentation.UserOutputModel();
      //expect(instance).to.be();
    });
