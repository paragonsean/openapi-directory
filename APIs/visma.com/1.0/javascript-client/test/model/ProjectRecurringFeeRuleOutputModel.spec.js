...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectRecurringFeeRuleOutputModel();
  });
  ...
  describe('ProjectRecurringFeeRuleOutputModel', function() {
    it('should create an instance of ProjectRecurringFeeRuleOutputModel', function() {
      // uncomment below and update the code to test ProjectRecurringFeeRuleOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectRecurringFeeRuleOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectRecurringFeeRuleOutputModel);
    });
    ...
    it('should have the property generatedTimes (base name: "generatedTimes")', function() {
      // uncomment below and update the code to test the property generatedTimes
      //var instance = new SeveraPublicRestApiDocumentation.ProjectRecurringFeeRuleOutputModel();
      //expect(instance).to.be();
    });
