...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.InvoiceStatusModel();
  });
  ...
  describe('InvoiceStatusModel', function() {
    it('should create an instance of InvoiceStatusModel', function() {
      // uncomment below and update the code to test InvoiceStatusModel
      //var instance = new SeveraPublicRestApiDocumentation.InvoiceStatusModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.InvoiceStatusModel);
    });
    ...
    it('should have the property hasInvoiceNumber (base name: "hasInvoiceNumber")', function() {
      // uncomment below and update the code to test the property hasInvoiceNumber
      //var instance = new SeveraPublicRestApiDocumentation.InvoiceStatusModel();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isDefaultForCreditNote (base name: "isDefaultForCreditNote")', function() {
      // uncomment below and update the code to test the property isDefaultForCreditNote
      //var instance = new SeveraPublicRestApiDocumentation.InvoiceStatusModel();
      //expect(instance).to.be();
    });
