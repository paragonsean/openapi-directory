...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectCustomValueModel();
  });
  ...
  describe('ProjectCustomValueModel', function() {
    it('should create an instance of ProjectCustomValueModel', function() {
      // uncomment below and update the code to test ProjectCustomValueModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectCustomValueModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectCustomValueModel);
    });
