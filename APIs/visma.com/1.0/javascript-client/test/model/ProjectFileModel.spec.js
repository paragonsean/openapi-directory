...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectFileModel();
  });
  ...
  describe('ProjectFileModel', function() {
    it('should create an instance of ProjectFileModel', function() {
      // uncomment below and update the code to test ProjectFileModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectFileModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectFileModel);
    });
