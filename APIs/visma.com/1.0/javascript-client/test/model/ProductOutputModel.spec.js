...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProductOutputModel();
  });
  ...
  describe('ProductOutputModel', function() {
    it('should create an instance of ProductOutputModel', function() {
      // uncomment below and update the code to test ProductOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.ProductOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProductOutputModel);
    });
