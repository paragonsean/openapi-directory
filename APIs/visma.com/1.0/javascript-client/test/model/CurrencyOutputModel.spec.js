...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.CurrencyOutputModel();
  });
  ...
  describe('CurrencyOutputModel', function() {
    it('should create an instance of CurrencyOutputModel', function() {
      // uncomment below and update the code to test CurrencyOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.CurrencyOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.CurrencyOutputModel);
    });
    ...
    it('should have the property isOrganizationCurrency (base name: "isOrganizationCurrency")', function() {
      // uncomment below and update the code to test the property isOrganizationCurrency
      //var instance = new SeveraPublicRestApiDocumentation.CurrencyOutputModel();
      //expect(instance).to.be();
    });
