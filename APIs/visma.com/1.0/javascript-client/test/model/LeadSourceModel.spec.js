...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.LeadSourceModel();
  });
  ...
  describe('LeadSourceModel', function() {
    it('should create an instance of LeadSourceModel', function() {
      // uncomment below and update the code to test LeadSourceModel
      //var instance = new SeveraPublicRestApiDocumentation.LeadSourceModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.LeadSourceModel);
    });
