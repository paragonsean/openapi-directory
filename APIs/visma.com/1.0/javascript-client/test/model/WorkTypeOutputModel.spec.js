...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.WorkTypeOutputModel();
  });
  ...
  describe('WorkTypeOutputModel', function() {
    it('should create an instance of WorkTypeOutputModel', function() {
      // uncomment below and update the code to test WorkTypeOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.WorkTypeOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.WorkTypeOutputModel);
    });
