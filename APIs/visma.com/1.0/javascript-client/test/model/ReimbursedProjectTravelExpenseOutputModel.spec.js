...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ReimbursedProjectTravelExpenseOutputModel();
  });
  ...
  describe('ReimbursedProjectTravelExpenseOutputModel', function() {
    it('should create an instance of ReimbursedProjectTravelExpenseOutputModel', function() {
      // uncomment below and update the code to test ReimbursedProjectTravelExpenseOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.ReimbursedProjectTravelExpenseOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ReimbursedProjectTravelExpenseOutputModel);
    });
