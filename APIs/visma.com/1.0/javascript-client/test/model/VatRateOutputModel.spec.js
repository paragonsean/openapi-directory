...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.VatRateOutputModel();
  });
  ...
  describe('VatRateOutputModel', function() {
    it('should create an instance of VatRateOutputModel', function() {
      // uncomment below and update the code to test VatRateOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.VatRateOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.VatRateOutputModel);
    });
