...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.SalesStatusHistoryOutputModel();
  });
  ...
  describe('SalesStatusHistoryOutputModel', function() {
    it('should create an instance of SalesStatusHistoryOutputModel', function() {
      // uncomment below and update the code to test SalesStatusHistoryOutputModel
      //var instance = new SeveraPublicRestApiDocumentation.SalesStatusHistoryOutputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.SalesStatusHistoryOutputModel);
    });
    ...
    it('should have the property salesStatusType (base name: "salesStatusType")', function() {
      // uncomment below and update the code to test the property salesStatusType
      //var instance = new SeveraPublicRestApiDocumentation.SalesStatusHistoryOutputModel();
      //expect(instance).to.be();
    });
