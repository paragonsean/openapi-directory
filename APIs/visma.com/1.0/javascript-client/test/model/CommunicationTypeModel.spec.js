...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.CommunicationTypeModel();
  });
  ...
  describe('CommunicationTypeModel', function() {
    it('should create an instance of CommunicationTypeModel', function() {
      // uncomment below and update the code to test CommunicationTypeModel
      //var instance = new SeveraPublicRestApiDocumentation.CommunicationTypeModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.CommunicationTypeModel);
    });
