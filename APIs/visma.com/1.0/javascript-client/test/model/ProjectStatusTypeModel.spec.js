...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.ProjectStatusTypeModel();
  });
  ...
  describe('ProjectStatusTypeModel', function() {
    it('should create an instance of ProjectStatusTypeModel', function() {
      // uncomment below and update the code to test ProjectStatusTypeModel
      //var instance = new SeveraPublicRestApiDocumentation.ProjectStatusTypeModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.ProjectStatusTypeModel);
    });
