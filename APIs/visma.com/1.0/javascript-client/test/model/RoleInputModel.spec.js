...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.RoleInputModel();
  });
  ...
  describe('RoleInputModel', function() {
    it('should create an instance of RoleInputModel', function() {
      // uncomment below and update the code to test RoleInputModel
      //var instance = new SeveraPublicRestApiDocumentation.RoleInputModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.RoleInputModel);
    });
