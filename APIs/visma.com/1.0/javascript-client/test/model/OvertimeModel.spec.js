...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.OvertimeModel();
  });
  ...
  describe('OvertimeModel', function() {
    it('should create an instance of OvertimeModel', function() {
      // uncomment below and update the code to test OvertimeModel
      //var instance = new SeveraPublicRestApiDocumentation.OvertimeModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.OvertimeModel);
    });
    ...
    it('should have the property includeInFlextime (base name: "includeInFlextime")', function() {
      // uncomment below and update the code to test the property includeInFlextime
      //var instance = new SeveraPublicRestApiDocumentation.OvertimeModel();
      //expect(instance).to.be();
    });
    ...
    it('should have the property multipliesUnitCost (base name: "multipliesUnitCost")', function() {
      // uncomment below and update the code to test the property multipliesUnitCost
      //var instance = new SeveraPublicRestApiDocumentation.OvertimeModel();
      //expect(instance).to.be();
    });
