...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeveraPublicRestApiDocumentation.PhaseProjectSubModel();
  });
  ...
  describe('PhaseProjectSubModel', function() {
    it('should create an instance of PhaseProjectSubModel', function() {
      // uncomment below and update the code to test PhaseProjectSubModel
      //var instance = new SeveraPublicRestApiDocumentation.PhaseProjectSubModel();
      //expect(instance).to.be.a(SeveraPublicRestApiDocumentation.PhaseProjectSubModel);
    });
