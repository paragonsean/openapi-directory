...
public class PhaseOutputModel {
  ...
  public PhaseOutputModel code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PhaseOutputModel createdBy(UserWithFirstNameLastNameAndPhotoFileModel createdBy) {
  ...
  public PhaseOutputModel currencyCode(CurrencyBaseModel currencyCode) {
  ...
  public PhaseOutputModel deadline(LocalDate deadline) {
  ...
  public PhaseOutputModel defaultWorkType(ModelWithName defaultWorkType) {
  ...
  public PhaseOutputModel isCompleted(Boolean isCompleted) {
  ...
  public PhaseOutputModel isLocked(Boolean isLocked) {
  ...
  public PhaseOutputModel lastUpdatedBy(UserWithFirstNameLastNameAndPhotoFileModel lastUpdatedBy) {
  ...
  public PhaseOutputModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PhaseOutputModel originalDeadline(LocalDate originalDeadline) {
  ...
  public PhaseOutputModel originalStartDate(LocalDate originalStartDate) {
  ...
  public PhaseOutputModel originalWorkHoursEstimate(Double originalWorkHoursEstimate) {
  ...
  public PhaseOutputModel parentPhase(ModelBaseWithRequiredGuid parentPhase) {
  ...
  public PhaseOutputModel phaseStatus(PhaseStatusOutputModel phaseStatus) {
  ...
  public PhaseOutputModel project(PhaseProjectSubModel project) {
  ...
  public PhaseOutputModel sortOrder(Integer sortOrder) {
  ...
  public PhaseOutputModel startDate(LocalDate startDate) {
  ...
  public PhaseOutputModel workHoursEstimate(Double workHoursEstimate) {
  ...
  public boolean equals(Object o) {
    ...
    PhaseOutputModel phaseOutputModel = (PhaseOutputModel) o;
    return Objects.equals(this.code, phaseOutputModel.code) &&
        Objects.equals(this.createdBy, phaseOutputModel.createdBy) &&
        Objects.equals(this.createdDateTime, phaseOutputModel.createdDateTime) &&
        Objects.equals(this.currencyCode, phaseOutputModel.currencyCode) &&
        Objects.equals(this.deadline, phaseOutputModel.deadline) &&
        Objects.equals(this.defaultWorkType, phaseOutputModel.defaultWorkType) &&
        Objects.equals(this.guid, phaseOutputModel.guid) &&
        Objects.equals(this.isCompleted, phaseOutputModel.isCompleted) &&
        Objects.equals(this.isLocked, phaseOutputModel.isLocked) &&
        Objects.equals(this.lastUpdatedBy, phaseOutputModel.lastUpdatedBy) &&
        Objects.equals(this.lastUpdatedDateTime, phaseOutputModel.lastUpdatedDateTime) &&
        Objects.equals(this.name, phaseOutputModel.name) &&
        Objects.equals(this.originalDeadline, phaseOutputModel.originalDeadline) &&
        Objects.equals(this.originalStartDate, phaseOutputModel.originalStartDate) &&
        Objects.equals(this.originalWorkHoursEstimate, phaseOutputModel.originalWorkHoursEstimate) &&
        Objects.equals(this.parentPhase, phaseOutputModel.parentPhase) &&
        Objects.equals(this.phaseStatus, phaseOutputModel.phaseStatus) &&
        Objects.equals(this.project, phaseOutputModel.project) &&
        Objects.equals(this.sortOrder, phaseOutputModel.sortOrder) &&
        Objects.equals(this.startDate, phaseOutputModel.startDate) &&
        Objects.equals(this.workHoursEstimate, phaseOutputModel.workHoursEstimate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, createdBy, createdDateTime, currencyCode, deadline, defaultWorkType, guid, isCompleted, isLocked, lastUpdatedBy, lastUpdatedDateTime, name, originalDeadline, originalStartDate, originalWorkHoursEstimate, parentPhase, phaseStatus, project, sortOrder, startDate, workHoursEstimate);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhaseOutputModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PhaseOutputModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PhaseOutputModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PhaseOutputModel is not found in the empty JSON string", PhaseOutputModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PhaseOutputModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PhaseOutputModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PhaseOutputModel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PhaseOutputModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PhaseOutputModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PhaseOutputModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PhaseOutputModel.class));

       return (TypeAdapter<T>) new TypeAdapter<PhaseOutputModel>() {
           @Override
           public void write(JsonWriter out, PhaseOutputModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PhaseOutputModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PhaseOutputModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PhaseOutputModel
   * @throws IOException if the JSON string is invalid with respect to PhaseOutputModel
   */
  public static PhaseOutputModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PhaseOutputModel.class);
  }

  /**
   * Convert an instance of PhaseOutputModel to an JSON string
   *
   * @return JSON string
   */
