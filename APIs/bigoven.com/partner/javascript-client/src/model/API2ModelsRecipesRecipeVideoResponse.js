...
/**
 * The API2ModelsRecipesRecipeVideoResponse model module.
 * @module model/API2ModelsRecipesRecipeVideoResponse
 * @version partner
 */
class API2ModelsRecipesRecipeVideoResponse {
    /**
     * Constructs a new <code>API2ModelsRecipesRecipeVideoResponse</code>.
     * DTO used to return the details of a recipe video
     * @alias module:model/API2ModelsRecipesRecipeVideoResponse
     */
    constructor() { 
        
        API2ModelsRecipesRecipeVideoResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ModelsRecipesRecipeVideoResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ModelsRecipesRecipeVideoResponse} obj Optional instance to populate.
     * @return {module:model/API2ModelsRecipesRecipeVideoResponse} The populated <code>API2ModelsRecipesRecipeVideoResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ModelsRecipesRecipeVideoResponse();

            if (data.hasOwnProperty('InsertedOn')) {
                obj['InsertedOn'] = ApiClient.convertToType(data['InsertedOn'], 'Date');
            }
            if (data.hasOwnProperty('IsPrimaryVideo')) {
                obj['IsPrimaryVideo'] = ApiClient.convertToType(data['IsPrimaryVideo'], 'Boolean');
            }
            if (data.hasOwnProperty('MediaId')) {
                obj['MediaId'] = ApiClient.convertToType(data['MediaId'], 'String');
            }
            if (data.hasOwnProperty('VidId')) {
                obj['VidId'] = ApiClient.convertToType(data['VidId'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>API2ModelsRecipesRecipeVideoResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ModelsRecipesRecipeVideoResponse</code>.
     */
 ...
 * @member {Date} InsertedOn
 */
API2ModelsRecipesRecipeVideoResponse.prototype['InsertedOn'] = undefined;

/**
 * Gets or sets a value indicating whether the video is the primary video of the recipe.
 * @member {Boolean} IsPrimaryVideo
 */
API2ModelsRecipesRecipeVideoResponse.prototype['IsPrimaryVideo'] = undefined;

/**
 * Gets or sets the JWPlayer media id.
 * @member {String} MediaId
 */
API2ModelsRecipesRecipeVideoResponse.prototype['MediaId'] = undefined;

/**
 * Gets or sets the video id.
 * @member {Number} VidId
 */
API2ModelsRecipesRecipeVideoResponse.prototype['VidId'] = undefined;
...
export default API2ModelsRecipesRecipeVideoResponse;
