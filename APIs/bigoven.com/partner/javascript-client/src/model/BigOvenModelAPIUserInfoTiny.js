...
/**
 * The BigOvenModelAPIUserInfoTiny model module.
 * @module model/BigOvenModelAPIUserInfoTiny
 * @version partner
 */
class BigOvenModelAPIUserInfoTiny {
    /**
     * Constructs a new <code>BigOvenModelAPIUserInfoTiny</code>.
     * @alias module:model/BigOvenModelAPIUserInfoTiny
     */
    constructor() { 
        
        BigOvenModelAPIUserInfoTiny.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelAPIUserInfoTiny</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelAPIUserInfoTiny} obj Optional instance to populate.
     * @return {module:model/BigOvenModelAPIUserInfoTiny} The populated <code>BigOvenModelAPIUserInfoTiny</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelAPIUserInfoTiny();
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelAPIUserInfoTiny</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelAPIUserInfoTiny</code>.
     */
 ...
 */
BigOvenModelAPIUserInfoTiny.prototype['FirstName'] = undefined;

/**
 * @member {String} LastName
 */
BigOvenModelAPIUserInfoTiny.prototype['LastName'] = undefined;

/**
 * @member {String} PhotoUrl
 */
BigOvenModelAPIUserInfoTiny.prototype['PhotoUrl'] = undefined;

/**
 * @member {Number} UserID
 */
BigOvenModelAPIUserInfoTiny.prototype['UserID'] = undefined;

/**
 * @member {String} UserName
 */
BigOvenModelAPIUserInfoTiny.prototype['UserName'] = undefined;
...
export default BigOvenModelAPIUserInfoTiny;
