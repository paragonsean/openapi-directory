...
/**
 * The API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest model module.
 * @module model/API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest
 * @version partner
 */
class API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest {
    /**
     * Constructs a new <code>API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest</code>.
     * 
     * @alias module:model/API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest
     */
    constructor() { 
        
        API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest} obj Optional instance to populate.
     * @return {module:model/API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest} The populated <code>API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest</code>.
     */
 ...
 */
API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest.prototype['department'] = undefined;

/**
 * Gets or sets the unique identifier.
 * @member {String} guid
 */
API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest.prototype['guid'] = undefined;

/**
 * Gets or sets the ischecked.
 * @member {Boolean} ischecked
 */
API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest.prototype['ischecked'] = undefined;

/**
 * Gets or sets the name.
 * @member {String} name
 */
API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest.prototype['name'] = undefined;

/**
 * Gets or sets the notes.
 * @member {String} notes
 */
API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest.prototype['notes'] = undefined;

/**
 * Gets or sets the quantity.
 * @member {String} quantity
 */
API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest.prototype['quantity'] = undefined;

/**
 * Gets or sets the unit.
 * @member {String} unit
 */
API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest.prototype['unit'] = undefined;
...
export default API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest;
