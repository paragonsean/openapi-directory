...
/**
 * The API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest model module.
 * @module model/API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest
 * @version partner
 */
class API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest {
    /**
     * Constructs a new <code>API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest</code>.
     * 
     * @alias module:model/API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest
     */
    constructor() { 
        
        API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest} obj Optional instance to populate.
     * @return {module:model/API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest} The populated <code>API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest</code>.
     */
 ...
 */
API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest.prototype['department'] = undefined;

/**
 * Gets or sets the name.
 * @member {String} name
 */
API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest.prototype['name'] = undefined;

/**
 * Gets or sets the notes.
 * @member {String} notes
 */
API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest.prototype['notes'] = undefined;

/**
 * Gets or sets the quantity.
 * @member {String} quantity
 */
API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest.prototype['quantity'] = undefined;

/**
 * Gets or sets the unit.
 * @member {String} unit
 */
API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest.prototype['unit'] = undefined;
...
export default API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest;
