...
/**
 * The API2ControllersWebAPIMeControllerPreferenceOptions model module.
 * @module model/API2ControllersWebAPIMeControllerPreferenceOptions
 * @version partner
 */
class API2ControllersWebAPIMeControllerPreferenceOptions {
    /**
     * Constructs a new <code>API2ControllersWebAPIMeControllerPreferenceOptions</code>.
     * 
     * @alias module:model/API2ControllersWebAPIMeControllerPreferenceOptions
     */
    constructor() { 
        
        API2ControllersWebAPIMeControllerPreferenceOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ControllersWebAPIMeControllerPreferenceOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ControllersWebAPIMeControllerPreferenceOptions} obj Optional instance to populate.
     * @return {module:model/API2ControllersWebAPIMeControllerPreferenceOptions} The populated <code>API2ControllersWebAPIMeControllerPreferenceOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ControllersWebAPIMeControllerPreferenceOptions();

            if (data.hasOwnProperty('EatingStyle')) {
                obj['EatingStyle'] = API2ControllersWebAPIMeControllerEatingStyle.constructFromObject(data['EatingStyle']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>API2ControllersWebAPIMeControllerPreferenceOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ControllersWebAPIMeControllerPreferenceOptions</code>.
     */
    static validateJSON(data) {
        // validate the optional field `EatingStyle`
        if (data['EatingStyle']) { // data not null
          API2ControllersWebAPIMeControllerEatingStyle.validateJSON(data['EatingStyle']);
        }
...
/**
 * @member {module:model/API2ControllersWebAPIMeControllerEatingStyle} EatingStyle
 */
API2ControllersWebAPIMeControllerPreferenceOptions.prototype['EatingStyle'] = undefined;
...
export default API2ControllersWebAPIMeControllerPreferenceOptions;
