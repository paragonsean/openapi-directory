...
/**
 * The API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest model module.
 * @module model/API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest
 * @version partner
 */
class API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest {
    /**
     * Constructs a new <code>API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest</code>.
     * 
     * @alias module:model/API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest
     */
    constructor() { 
        
        API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest} obj Optional instance to populate.
     * @return {module:model/API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest} The populated <code>API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest();

            if (data.hasOwnProperty('markAsPending')) {
                obj['markAsPending'] = ApiClient.convertToType(data['markAsPending'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest</code>.
     */
 ...
 * @member {Boolean} markAsPending
 */
API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest.prototype['markAsPending'] = undefined;

/**
 * Gets or sets the recipe identifier.
 * @member {Number} recipeId
 */
API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest.prototype['recipeId'] = undefined;

/**
 * Gets or sets the scale.
 * @member {Number} scale
 */
API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest.prototype['scale'] = undefined;
...
export default API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest;
