...
/**
 * The BigOvenModelRecipeCategory model module.
 * @module model/BigOvenModelRecipeCategory
 * @version partner
 */
class BigOvenModelRecipeCategory {
    /**
     * Constructs a new <code>BigOvenModelRecipeCategory</code>.
     * @alias module:model/BigOvenModelRecipeCategory
     */
    constructor() { 
        
        BigOvenModelRecipeCategory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelRecipeCategory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelRecipeCategory} obj Optional instance to populate.
     * @return {module:model/BigOvenModelRecipeCategory} The populated <code>BigOvenModelRecipeCategory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelRecipeCategory();

            if (data.hasOwnProperty('Category')) {
                obj['Category'] = ApiClient.convertToType(data['Category'], 'String');
            }
            if (data.hasOwnProperty('DefaultActiveMinutes')) {
                obj['DefaultActiveMinutes'] = ApiClient.convertToType(data['DefaultActiveMinutes'], 'Number');
            }
            if (data.hasOwnProperty('DefaultTotalMinutes')) {
                obj['DefaultTotalMinutes'] = ApiClient.convertToType(data['DefaultTotalMinutes'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelRecipeCategory</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelRecipeCategory</code>.
     */
 ...
 */
BigOvenModelRecipeCategory.prototype['Category'] = undefined;

/**
 * @member {Number} DefaultActiveMinutes
 */
BigOvenModelRecipeCategory.prototype['DefaultActiveMinutes'] = undefined;

/**
 * @member {Number} DefaultTotalMinutes
 */
BigOvenModelRecipeCategory.prototype['DefaultTotalMinutes'] = undefined;

/**
 * @member {Number} ID
 */
BigOvenModelRecipeCategory.prototype['ID'] = undefined;

/**
 * @member {Number} ParentID
 */
BigOvenModelRecipeCategory.prototype['ParentID'] = undefined;

/**
 * @member {String} PrimaryImage
 */
BigOvenModelRecipeCategory.prototype['PrimaryImage'] = undefined;

/**
 * @member {String} ShortDescription
 */
BigOvenModelRecipeCategory.prototype['ShortDescription'] = undefined;
...
export default BigOvenModelRecipeCategory;
