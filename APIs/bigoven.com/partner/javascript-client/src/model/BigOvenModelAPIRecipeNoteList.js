...
/**
 * The BigOvenModelAPIRecipeNoteList model module.
 * @module model/BigOvenModelAPIRecipeNoteList
 * @version partner
 */
class BigOvenModelAPIRecipeNoteList {
    /**
     * Constructs a new <code>BigOvenModelAPIRecipeNoteList</code>.
     * @alias module:model/BigOvenModelAPIRecipeNoteList
     */
    constructor() { 
        
        BigOvenModelAPIRecipeNoteList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelAPIRecipeNoteList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelAPIRecipeNoteList} obj Optional instance to populate.
     * @return {module:model/BigOvenModelAPIRecipeNoteList} The populated <code>BigOvenModelAPIRecipeNoteList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelAPIRecipeNoteList();

            if (data.hasOwnProperty('ResultCount')) {
                obj['ResultCount'] = ApiClient.convertToType(data['ResultCount'], 'Number');
            }
            if (data.hasOwnProperty('Results')) {
                obj['Results'] = ApiClient.convertToType(data['Results'], [BigOvenModelAPIRecipeNote]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelAPIRecipeNoteList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelAPIRecipeNoteList</code>.
     */
    static validateJSON(data) {
        if (data['Results']) { // data not null
            ...
            for (const item of data['Results']) {
                BigOvenModelAPIRecipeNote.validateJSON(item);
            };
        }
 ...
 */
BigOvenModelAPIRecipeNoteList.prototype['ResultCount'] = undefined;

/**
 * @member {Array.<module:model/BigOvenModelAPIRecipeNote>} Results
 */
BigOvenModelAPIRecipeNoteList.prototype['Results'] = undefined;
...
export default BigOvenModelAPIRecipeNoteList;
