...
/**
 * The BigOvenModelAPI2UserInfoTinyx model module.
 * @module model/BigOvenModelAPI2UserInfoTinyx
 * @version partner
 */
class BigOvenModelAPI2UserInfoTinyx {
    /**
     * Constructs a new <code>BigOvenModelAPI2UserInfoTinyx</code>.
     * @alias module:model/BigOvenModelAPI2UserInfoTinyx
     */
    constructor() { 
        
        BigOvenModelAPI2UserInfoTinyx.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelAPI2UserInfoTinyx</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelAPI2UserInfoTinyx} obj Optional instance to populate.
     * @return {module:model/BigOvenModelAPI2UserInfoTinyx} The populated <code>BigOvenModelAPI2UserInfoTinyx</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelAPI2UserInfoTinyx();
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelAPI2UserInfoTinyx</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelAPI2UserInfoTinyx</code>.
     */
 ...
 */
BigOvenModelAPI2UserInfoTinyx.prototype['FirstName'] = undefined;

/**
 * @member {String} LastName
 */
BigOvenModelAPI2UserInfoTinyx.prototype['LastName'] = undefined;

/**
 * @member {String} PhotoUrl
 */
BigOvenModelAPI2UserInfoTinyx.prototype['PhotoUrl'] = undefined;

/**
 * @member {Number} UserID
 */
BigOvenModelAPI2UserInfoTinyx.prototype['UserID'] = undefined;

/**
 * @member {String} UserName
 */
BigOvenModelAPI2UserInfoTinyx.prototype['UserName'] = undefined;
...
export default BigOvenModelAPI2UserInfoTinyx;
