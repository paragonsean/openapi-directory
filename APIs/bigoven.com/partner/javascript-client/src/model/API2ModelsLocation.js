...
/**
 * The API2ModelsLocation model module.
 * @module model/API2ModelsLocation
 * @version partner
 */
class API2ModelsLocation {
    /**
     * Constructs a new <code>API2ModelsLocation</code>.
     * 
     * @alias module:model/API2ModelsLocation
     */
    constructor() { 
        
        API2ModelsLocation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ModelsLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ModelsLocation} obj Optional instance to populate.
     * @return {module:model/API2ModelsLocation} The populated <code>API2ModelsLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ModelsLocation();
            ...
            if (data.hasOwnProperty('DMA')) {
                obj['DMA'] = ApiClient.convertToType(data['DMA'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>API2ModelsLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ModelsLocation</code>.
     */
 ...
 * @member {String} City
 */
API2ModelsLocation.prototype['City'] = undefined;

/**
 * 
 * @member {String} Country
 */
API2ModelsLocation.prototype['Country'] = undefined;

/**
 * 
 * @member {Number} DMA
 */
API2ModelsLocation.prototype['DMA'] = undefined;
...
export default API2ModelsLocation;
