...
/**
 * The BigOvenModelRecipeInfoReviewTuple2 model module.
 * @module model/BigOvenModelRecipeInfoReviewTuple2
 * @version partner
 */
class BigOvenModelRecipeInfoReviewTuple2 {
    /**
     * Constructs a new <code>BigOvenModelRecipeInfoReviewTuple2</code>.
     * @alias module:model/BigOvenModelRecipeInfoReviewTuple2
     */
    constructor() { 
        
        BigOvenModelRecipeInfoReviewTuple2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelRecipeInfoReviewTuple2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelRecipeInfoReviewTuple2} obj Optional instance to populate.
     * @return {module:model/BigOvenModelRecipeInfoReviewTuple2} The populated <code>BigOvenModelRecipeInfoReviewTuple2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelRecipeInfoReviewTuple2();

            if (data.hasOwnProperty('RecipeInfo')) {
                obj['RecipeInfo'] = BigOvenModelAPI2RecipeInfox.constructFromObject(data['RecipeInfo']);
            }
            if (data.hasOwnProperty('Review')) {
                obj['Review'] = BigOvenModelAPIReview.constructFromObject(data['Review']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelRecipeInfoReviewTuple2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelRecipeInfoReviewTuple2</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Review']) { // data not null
          BigOvenModelAPIReview.validateJSON(data['Review']);
        }
 ...
 */
BigOvenModelRecipeInfoReviewTuple2.prototype['RecipeInfo'] = undefined;

/**
 * @member {module:model/BigOvenModelAPIReview} Review
 */
BigOvenModelRecipeInfoReviewTuple2.prototype['Review'] = undefined;
...
export default BigOvenModelRecipeInfoReviewTuple2;
