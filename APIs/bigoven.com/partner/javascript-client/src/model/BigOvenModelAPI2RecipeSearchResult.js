...
/**
 * The BigOvenModelAPI2RecipeSearchResult model module.
 * @module model/BigOvenModelAPI2RecipeSearchResult
 * @version partner
 */
class BigOvenModelAPI2RecipeSearchResult {
    /**
     * Constructs a new <code>BigOvenModelAPI2RecipeSearchResult</code>.
     * @alias module:model/BigOvenModelAPI2RecipeSearchResult
     */
    constructor() { 
        
        BigOvenModelAPI2RecipeSearchResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelAPI2RecipeSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelAPI2RecipeSearchResult} obj Optional instance to populate.
     * @return {module:model/BigOvenModelAPI2RecipeSearchResult} The populated <code>BigOvenModelAPI2RecipeSearchResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelAPI2RecipeSearchResult();
            ...
            if (data.hasOwnProperty('SpellSuggest')) {
                obj['SpellSuggest'] = ApiClient.convertToType(data['SpellSuggest'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelAPI2RecipeSearchResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelAPI2RecipeSearchResult</code>.
     */
    static validateJSON(data) {
        ...
        if (data['SpellSuggest'] && !(typeof data['SpellSuggest'] === 'string' || data['SpellSuggest'] instanceof String)) {
            throw new Error("Expected the field `SpellSuggest` to be a primitive type in the JSON string but got " + data['SpellSuggest']);
        }
 ...
 */
BigOvenModelAPI2RecipeSearchResult.prototype['ResultCount'] = undefined;

/**
 * @member {Array.<module:model/BigOvenModelAPI2RecipeInfox>} Results
 */
BigOvenModelAPI2RecipeSearchResult.prototype['Results'] = undefined;

/**
 * @member {String} SpellSuggest
 */
BigOvenModelAPI2RecipeSearchResult.prototype['SpellSuggest'] = undefined;
...
export default BigOvenModelAPI2RecipeSearchResult;
