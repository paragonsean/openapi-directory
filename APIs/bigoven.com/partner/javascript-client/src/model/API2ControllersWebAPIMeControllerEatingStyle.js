...
/**
 * The API2ControllersWebAPIMeControllerEatingStyle model module.
 * @module model/API2ControllersWebAPIMeControllerEatingStyle
 * @version partner
 */
class API2ControllersWebAPIMeControllerEatingStyle {
    /**
     * Constructs a new <code>API2ControllersWebAPIMeControllerEatingStyle</code>.
     * 
     * @alias module:model/API2ControllersWebAPIMeControllerEatingStyle
     */
    constructor() { 
        
        API2ControllersWebAPIMeControllerEatingStyle.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ControllersWebAPIMeControllerEatingStyle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ControllersWebAPIMeControllerEatingStyle} obj Optional instance to populate.
     * @return {module:model/API2ControllersWebAPIMeControllerEatingStyle} The populated <code>API2ControllersWebAPIMeControllerEatingStyle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ControllersWebAPIMeControllerEatingStyle();

            if (data.hasOwnProperty('Options')) {
                obj['Options'] = ApiClient.convertToType(data['Options'], [API2ControllersWebAPIMeControllerOption]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>API2ControllersWebAPIMeControllerEatingStyle</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ControllersWebAPIMeControllerEatingStyle</code>.
     */
    static validateJSON(data) {
        if (data['Options']) { // data not null
            ...
            for (const item of data['Options']) {
                API2ControllersWebAPIMeControllerOption.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/API2ControllersWebAPIMeControllerOption>} Options
 */
API2ControllersWebAPIMeControllerEatingStyle.prototype['Options'] = undefined;
...
export default API2ControllersWebAPIMeControllerEatingStyle;
