...
/**
 * The BigOvenModelAPIIngredientInfo model module.
 * @module model/BigOvenModelAPIIngredientInfo
 * @version partner
 */
class BigOvenModelAPIIngredientInfo {
    /**
     * Constructs a new <code>BigOvenModelAPIIngredientInfo</code>.
     * @alias module:model/BigOvenModelAPIIngredientInfo
     */
    constructor() { 
        
        BigOvenModelAPIIngredientInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelAPIIngredientInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelAPIIngredientInfo} obj Optional instance to populate.
     * @return {module:model/BigOvenModelAPIIngredientInfo} The populated <code>BigOvenModelAPIIngredientInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelAPIIngredientInfo();

            if (data.hasOwnProperty('Department')) {
                obj['Department'] = ApiClient.convertToType(data['Department'], 'String');
            }
            if (data.hasOwnProperty('MasterIngredientID')) {
                obj['MasterIngredientID'] = ApiClient.convertToType(data['MasterIngredientID'], 'Number');
            }
            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], 'String');
            }
            if (data.hasOwnProperty('UsuallyOnHand')) {
                obj['UsuallyOnHand'] = ApiClient.convertToType(data['UsuallyOnHand'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelAPIIngredientInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelAPIIngredientInfo</code>.
     */
 ...
 */
BigOvenModelAPIIngredientInfo.prototype['Department'] = undefined;

/**
 * @member {Number} MasterIngredientID
 */
BigOvenModelAPIIngredientInfo.prototype['MasterIngredientID'] = undefined;

/**
 * @member {String} Name
 */
BigOvenModelAPIIngredientInfo.prototype['Name'] = undefined;

/**
 * @member {Boolean} UsuallyOnHand
 */
BigOvenModelAPIIngredientInfo.prototype['UsuallyOnHand'] = undefined;
...
export default BigOvenModelAPIIngredientInfo;
