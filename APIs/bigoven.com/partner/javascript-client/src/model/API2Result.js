...
/**
 * The API2Result model module.
 * @module model/API2Result
 * @version partner
 */
class API2Result {
    /**
     * Constructs a new <code>API2Result</code>.
     * @alias module:model/API2Result
     */
    constructor() { 
        
        API2Result.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2Result</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2Result} obj Optional instance to populate.
     * @return {module:model/API2Result} The populated <code>API2Result</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2Result();
    ...
    /**
     * Validates the JSON data with respect to <code>API2Result</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2Result</code>.
     */
 ...
 * @member {Object} Data
 */
API2Result.prototype['Data'] = undefined;

/**
 * @member {String} Message
 */
API2Result.prototype['Message'] = undefined;

/**
 * @member {Number} StatusCode
 */
API2Result.prototype['StatusCode'] = undefined;
