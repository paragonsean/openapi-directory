...
/**
 * The API2ControllersWebAPIReviewControllerPostReplyReq model module.
 * @module model/API2ControllersWebAPIReviewControllerPostReplyReq
 * @version partner
 */
class API2ControllersWebAPIReviewControllerPostReplyReq {
    /**
     * Constructs a new <code>API2ControllersWebAPIReviewControllerPostReplyReq</code>.
     * Reply request parameters
     * @alias module:model/API2ControllersWebAPIReviewControllerPostReplyReq
     */
    constructor() { 
        
        API2ControllersWebAPIReviewControllerPostReplyReq.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ControllersWebAPIReviewControllerPostReplyReq</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ControllersWebAPIReviewControllerPostReplyReq} obj Optional instance to populate.
     * @return {module:model/API2ControllersWebAPIReviewControllerPostReplyReq} The populated <code>API2ControllersWebAPIReviewControllerPostReplyReq</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ControllersWebAPIReviewControllerPostReplyReq();
    ...
    /**
     * Validates the JSON data with respect to <code>API2ControllersWebAPIReviewControllerPostReplyReq</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ControllersWebAPIReviewControllerPostReplyReq</code>.
     */
 ...
 */
API2ControllersWebAPIReviewControllerPostReplyReq.prototype['Comment'] = undefined;
...
export default API2ControllersWebAPIReviewControllerPostReplyReq;
