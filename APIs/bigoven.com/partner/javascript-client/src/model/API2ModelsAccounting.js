...
/**
 * The API2ModelsAccounting model module.
 * @module model/API2ModelsAccounting
 * @version partner
 */
class API2ModelsAccounting {
    /**
     * Constructs a new <code>API2ModelsAccounting</code>.
     * 
     * @alias module:model/API2ModelsAccounting
     */
    constructor() { 
        
        API2ModelsAccounting.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ModelsAccounting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ModelsAccounting} obj Optional instance to populate.
     * @return {module:model/API2ModelsAccounting} The populated <code>API2ModelsAccounting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ModelsAccounting();
            ...
            if (data.hasOwnProperty('UserLevel')) {
                obj['UserLevel'] = ApiClient.convertToType(data['UserLevel'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>API2ModelsAccounting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ModelsAccounting</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['UserLevel'] && !(typeof data['UserLevel'] === 'string' || data['UserLevel'] instanceof String)) {
            throw new Error("Expected the field `UserLevel` to be a primitive type in the JSON string but got " + data['UserLevel']);
        }
 ...
 */
API2ModelsAccounting.prototype['CreditBalance'] = undefined;

/**
 * 
 * @member {Date} MemberSince
 */
API2ModelsAccounting.prototype['MemberSince'] = undefined;

/**
 * 
 * @member {Date} PremiumExpiryDate
 */
API2ModelsAccounting.prototype['PremiumExpiryDate'] = undefined;

/**
 * 
 * @member {String} UserLevel
 */
API2ModelsAccounting.prototype['UserLevel'] = undefined;
...
export default API2ModelsAccounting;
