...
/**
 * The API2ModelsRecipesFeedbackDTO model module.
 * @module model/API2ModelsRecipesFeedbackDTO
 * @version partner
 */
class API2ModelsRecipesFeedbackDTO {
    /**
     * Constructs a new <code>API2ModelsRecipesFeedbackDTO</code>.
     * @alias module:model/API2ModelsRecipesFeedbackDTO
     */
    constructor() { 
        
        API2ModelsRecipesFeedbackDTO.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ModelsRecipesFeedbackDTO</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ModelsRecipesFeedbackDTO} obj Optional instance to populate.
     * @return {module:model/API2ModelsRecipesFeedbackDTO} The populated <code>API2ModelsRecipesFeedbackDTO</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ModelsRecipesFeedbackDTO();
    ...
    /**
     * Validates the JSON data with respect to <code>API2ModelsRecipesFeedbackDTO</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ModelsRecipesFeedbackDTO</code>.
     */
 ...
 */
API2ModelsRecipesFeedbackDTO.prototype['feedback'] = undefined;
...
export default API2ModelsRecipesFeedbackDTO;
