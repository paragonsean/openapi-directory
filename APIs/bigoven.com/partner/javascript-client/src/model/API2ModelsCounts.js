...
/**
 * The API2ModelsCounts model module.
 * @module model/API2ModelsCounts
 * @version partner
 */
class API2ModelsCounts {
    /**
     * Constructs a new <code>API2ModelsCounts</code>.
     * 
     * @alias module:model/API2ModelsCounts
     */
    constructor() { 
        
        API2ModelsCounts.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ModelsCounts</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ModelsCounts} obj Optional instance to populate.
     * @return {module:model/API2ModelsCounts} The populated <code>API2ModelsCounts</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ModelsCounts();
            ...
            if (data.hasOwnProperty('PrivateRecipeCount')) {
                obj['PrivateRecipeCount'] = ApiClient.convertToType(data['PrivateRecipeCount'], 'Number');
            }
            if (data.hasOwnProperty('PublicRecipeCount')) {
                obj['PublicRecipeCount'] = ApiClient.convertToType(data['PublicRecipeCount'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>API2ModelsCounts</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ModelsCounts</code>.
     */
 ...
 */
API2ModelsCounts.prototype['AddedCount'] = undefined;

/**
 * 
 * @member {Number} FollowersCount
 */
API2ModelsCounts.prototype['FollowersCount'] = undefined;

/**
 * 
 * @member {Number} FollowingCount
 */
API2ModelsCounts.prototype['FollowingCount'] = undefined;

/**
 * 
 * @member {Number} PrivateRecipeCount
 */
API2ModelsCounts.prototype['PrivateRecipeCount'] = undefined;

/**
 * 
 * @member {Number} PublicRecipeCount
 */
API2ModelsCounts.prototype['PublicRecipeCount'] = undefined;

/**
 * 
 * @member {Number} TotalRecipes
 */
API2ModelsCounts.prototype['TotalRecipes'] = undefined;
...
export default API2ModelsCounts;
