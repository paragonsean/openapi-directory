...
/**
 * The BigOvenResult model module.
 * @module model/BigOvenResult
 * @version partner
 */
class BigOvenResult {
    /**
     * Constructs a new <code>BigOvenResult</code>.
     * @alias module:model/BigOvenResult
     */
    constructor() { 
        
        BigOvenResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenResult} obj Optional instance to populate.
     * @return {module:model/BigOvenResult} The populated <code>BigOvenResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenResult();
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenResult</code>.
     */
 ...
 * @member {Object} Data
 */
BigOvenResult.prototype['Data'] = undefined;

/**
 * @member {String} Message
 */
BigOvenResult.prototype['Message'] = undefined;

/**
 * @member {Number} StatusCode
 */
BigOvenResult.prototype['StatusCode'] = undefined;
