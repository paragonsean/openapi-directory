...
/**
 * The BigOvenModelAPI2GroceryList model module.
 * @module model/BigOvenModelAPI2GroceryList
 * @version partner
 */
class BigOvenModelAPI2GroceryList {
    /**
     * Constructs a new <code>BigOvenModelAPI2GroceryList</code>.
     * @alias module:model/BigOvenModelAPI2GroceryList
     */
    constructor() { 
        
        BigOvenModelAPI2GroceryList.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelAPI2GroceryList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelAPI2GroceryList} obj Optional instance to populate.
     * @return {module:model/BigOvenModelAPI2GroceryList} The populated <code>BigOvenModelAPI2GroceryList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelAPI2GroceryList();
            ...
            if (data.hasOwnProperty('Recipes')) {
                obj['Recipes'] = ApiClient.convertToType(data['Recipes'], [BigOvenModelAPI2RecipeInfox]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelAPI2GroceryList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelAPI2GroceryList</code>.
     */
 ...
 */
BigOvenModelAPI2GroceryList.prototype['Items'] = undefined;

/**
 * @member {Date} LastModified
 */
BigOvenModelAPI2GroceryList.prototype['LastModified'] = undefined;

/**
 * @member {Array.<module:model/BigOvenModelAPI2RecipeInfox>} Recipes
 */
BigOvenModelAPI2GroceryList.prototype['Recipes'] = undefined;

/**
 * @member {String} VersionGuid
 */
BigOvenModelAPI2GroceryList.prototype['VersionGuid'] = undefined;
...
export default BigOvenModelAPI2GroceryList;
