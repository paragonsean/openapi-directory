...
/**
 * The BigOvenModelAPI2Photo model module.
 * @module model/BigOvenModelAPI2Photo
 * @version partner
 */
class BigOvenModelAPI2Photo {
    /**
     * Constructs a new <code>BigOvenModelAPI2Photo</code>.
     * @alias module:model/BigOvenModelAPI2Photo
     */
    constructor() { 
        
        BigOvenModelAPI2Photo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelAPI2Photo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelAPI2Photo} obj Optional instance to populate.
     * @return {module:model/BigOvenModelAPI2Photo} The populated <code>BigOvenModelAPI2Photo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelAPI2Photo();
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelAPI2Photo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelAPI2Photo</code>.
     */
 ...
 */
BigOvenModelAPI2Photo.prototype['Caption'] = undefined;

/**
 * @member {String} CreationDate
 */
BigOvenModelAPI2Photo.prototype['CreationDate'] = undefined;

/**
 * @member {Number} ImageID
 */
BigOvenModelAPI2Photo.prototype['ImageID'] = undefined;

/**
 * @member {Boolean} IsPrimary
 */
BigOvenModelAPI2Photo.prototype['IsPrimary'] = undefined;

/**
 * @member {Number} MaxImageSquare
 */
BigOvenModelAPI2Photo.prototype['MaxImageSquare'] = undefined;

/**
 * @member {String} PhotoUrl
 */
BigOvenModelAPI2Photo.prototype['PhotoUrl'] = undefined;

/**
 * @member {module:model/BigOvenModelAPI2UserInfoTinyx} Poster
 */
BigOvenModelAPI2Photo.prototype['Poster'] = undefined;
...
export default BigOvenModelAPI2Photo;
