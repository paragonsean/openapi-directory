...
/**
 * The BigOvenModelAPI2RecipeNote model module.
 * @module model/BigOvenModelAPI2RecipeNote
 * @version partner
 */
class BigOvenModelAPI2RecipeNote {
    /**
     * Constructs a new <code>BigOvenModelAPI2RecipeNote</code>.
     * @alias module:model/BigOvenModelAPI2RecipeNote
     */
    constructor() { 
        
        BigOvenModelAPI2RecipeNote.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelAPI2RecipeNote</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelAPI2RecipeNote} obj Optional instance to populate.
     * @return {module:model/BigOvenModelAPI2RecipeNote} The populated <code>BigOvenModelAPI2RecipeNote</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelAPI2RecipeNote();
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelAPI2RecipeNote</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelAPI2RecipeNote</code>.
     */
 ...
 */
BigOvenModelAPI2RecipeNote.prototype['CreationDate'] = undefined;

/**
 * @member {String} Date
 */
BigOvenModelAPI2RecipeNote.prototype['Date'] = undefined;

/**
 * @member {Date} DateDT
 */
BigOvenModelAPI2RecipeNote.prototype['DateDT'] = undefined;

/**
 * @member {String} GUID
 */
BigOvenModelAPI2RecipeNote.prototype['GUID'] = undefined;

/**
 * @member {Number} ID
 */
BigOvenModelAPI2RecipeNote.prototype['ID'] = undefined;

/**
 * @member {String} Notes
 */
BigOvenModelAPI2RecipeNote.prototype['Notes'] = undefined;

/**
 * @member {String} People
 */
BigOvenModelAPI2RecipeNote.prototype['People'] = undefined;

/**
 * @member {Number} RecipeID
 */
BigOvenModelAPI2RecipeNote.prototype['RecipeID'] = undefined;

/**
 * @member {Number} UserID
 */
BigOvenModelAPI2RecipeNote.prototype['UserID'] = undefined;

/**
 * @member {String} Variations
 */
BigOvenModelAPI2RecipeNote.prototype['Variations'] = undefined;
...
export default BigOvenModelAPI2RecipeNote;
