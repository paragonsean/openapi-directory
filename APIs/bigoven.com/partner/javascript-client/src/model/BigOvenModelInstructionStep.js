...
/**
 * The BigOvenModelInstructionStep model module.
 * @module model/BigOvenModelInstructionStep
 * @version partner
 */
class BigOvenModelInstructionStep {
    /**
     * Constructs a new <code>BigOvenModelInstructionStep</code>.
     * @alias module:model/BigOvenModelInstructionStep
     */
    constructor() { 
        
        BigOvenModelInstructionStep.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelInstructionStep</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelInstructionStep} obj Optional instance to populate.
     * @return {module:model/BigOvenModelInstructionStep} The populated <code>BigOvenModelInstructionStep</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelInstructionStep();

            if (data.hasOwnProperty('EndGantt')) {
                obj['EndGantt'] = ApiClient.convertToType(data['EndGantt'], 'Number');
            }
            if (data.hasOwnProperty('StartGantt')) {
                obj['StartGantt'] = ApiClient.convertToType(data['StartGantt'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelInstructionStep</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelInstructionStep</code>.
     */
...
/**
 * @member {Number} EndGantt
 */
BigOvenModelInstructionStep.prototype['EndGantt'] = undefined;

/**
 * @member {Number} StartGantt
 */
BigOvenModelInstructionStep.prototype['StartGantt'] = undefined;

/**
 * @member {String} Text
 */
BigOvenModelInstructionStep.prototype['Text'] = undefined;
...
export default BigOvenModelInstructionStep;
