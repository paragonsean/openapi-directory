...
/**
 * The BigOvenModelAPIReply model module.
 * @module model/BigOvenModelAPIReply
 * @version partner
 */
class BigOvenModelAPIReply {
    /**
     * Constructs a new <code>BigOvenModelAPIReply</code>.
     * @alias module:model/BigOvenModelAPIReply
     */
    constructor() { 
        
        BigOvenModelAPIReply.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelAPIReply</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelAPIReply} obj Optional instance to populate.
     * @return {module:model/BigOvenModelAPIReply} The populated <code>BigOvenModelAPIReply</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelAPIReply();
            ...
            if (data.hasOwnProperty('Poster')) {
                obj['Poster'] = BigOvenModelAPIUserInfoTiny.constructFromObject(data['Poster']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelAPIReply</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelAPIReply</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Poster']) { // data not null
          BigOvenModelAPIUserInfoTiny.validateJSON(data['Poster']);
        }
        // ensure the json data is a string
 ...
 */
BigOvenModelAPIReply.prototype['Comment'] = undefined;

/**
 * @member {Date} CreationDate
 */
BigOvenModelAPIReply.prototype['CreationDate'] = undefined;

/**
 * @member {String} ID
 */
BigOvenModelAPIReply.prototype['ID'] = undefined;

/**
 * @member {Date} LastModified
 */
BigOvenModelAPIReply.prototype['LastModified'] = undefined;

/**
 * @member {module:model/BigOvenModelAPIUserInfoTiny} Poster
 */
BigOvenModelAPIReply.prototype['Poster'] = undefined;

/**
 * @member {String} ReviewID
 */
BigOvenModelAPIReply.prototype['ReviewID'] = undefined;
...
export default BigOvenModelAPIReply;
