...
/**
 * The API2ModelsPersonal model module.
 * @module model/API2ModelsPersonal
 * @version partner
 */
class API2ModelsPersonal {
    /**
     * Constructs a new <code>API2ModelsPersonal</code>.
     * Personal level info -- email, location, etc.
     * @alias module:model/API2ModelsPersonal
     */
    constructor() { 
        
        API2ModelsPersonal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ModelsPersonal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ModelsPersonal} obj Optional instance to populate.
     * @return {module:model/API2ModelsPersonal} The populated <code>API2ModelsPersonal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ModelsPersonal();

            if (data.hasOwnProperty('Email')) {
                obj['Email'] = ApiClient.convertToType(data['Email'], 'String');
            }
            if (data.hasOwnProperty('Location')) {
                obj['Location'] = API2ModelsLocation.constructFromObject(data['Location']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>API2ModelsPersonal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ModelsPersonal</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Location']) { // data not null
          API2ModelsLocation.validateJSON(data['Location']);
        }
 ...
 * @member {String} Email
 */
API2ModelsPersonal.prototype['Email'] = undefined;

/**
 * @member {module:model/API2ModelsLocation} Location
 */
API2ModelsPersonal.prototype['Location'] = undefined;
...
export default API2ModelsPersonal;
