...
/**
 * The API2ControllersWebAPIGroceryListControllerDepartmentModel model module.
 * @module model/API2ControllersWebAPIGroceryListControllerDepartmentModel
 * @version partner
 */
class API2ControllersWebAPIGroceryListControllerDepartmentModel {
    /**
     * Constructs a new <code>API2ControllersWebAPIGroceryListControllerDepartmentModel</code>.
     * 
     * @alias module:model/API2ControllersWebAPIGroceryListControllerDepartmentModel
     */
    constructor() { 
        
        API2ControllersWebAPIGroceryListControllerDepartmentModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ControllersWebAPIGroceryListControllerDepartmentModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ControllersWebAPIGroceryListControllerDepartmentModel} obj Optional instance to populate.
     * @return {module:model/API2ControllersWebAPIGroceryListControllerDepartmentModel} The populated <code>API2ControllersWebAPIGroceryListControllerDepartmentModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ControllersWebAPIGroceryListControllerDepartmentModel();
    ...
    /**
     * Validates the JSON data with respect to <code>API2ControllersWebAPIGroceryListControllerDepartmentModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ControllersWebAPIGroceryListControllerDepartmentModel</code>.
     */
 ...
 * @member {String} items
 */
API2ControllersWebAPIGroceryListControllerDepartmentModel.prototype['items'] = undefined;
...
export default API2ControllersWebAPIGroceryListControllerDepartmentModel;
