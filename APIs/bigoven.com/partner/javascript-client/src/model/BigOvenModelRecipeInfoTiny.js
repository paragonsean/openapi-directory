...
/**
 * The BigOvenModelRecipeInfoTiny model module.
 * @module model/BigOvenModelRecipeInfoTiny
 * @version partner
 */
class BigOvenModelRecipeInfoTiny {
    /**
     * Constructs a new <code>BigOvenModelRecipeInfoTiny</code>.
     * @alias module:model/BigOvenModelRecipeInfoTiny
     */
    constructor() { 
        
        BigOvenModelRecipeInfoTiny.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BigOvenModelRecipeInfoTiny</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BigOvenModelRecipeInfoTiny} obj Optional instance to populate.
     * @return {module:model/BigOvenModelRecipeInfoTiny} The populated <code>BigOvenModelRecipeInfoTiny</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BigOvenModelRecipeInfoTiny();
    ...
    /**
     * Validates the JSON data with respect to <code>BigOvenModelRecipeInfoTiny</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BigOvenModelRecipeInfoTiny</code>.
     */
 ...
 */
BigOvenModelRecipeInfoTiny.prototype['ImageURL'] = undefined;

/**
 * @member {Number} QualityScore
 */
BigOvenModelRecipeInfoTiny.prototype['QualityScore'] = undefined;

/**
 * @member {Number} RecipeID
 */
BigOvenModelRecipeInfoTiny.prototype['RecipeID'] = undefined;

/**
 * @member {Number} Servings
 */
BigOvenModelRecipeInfoTiny.prototype['Servings'] = undefined;

/**
 * @member {String} Title
 */
BigOvenModelRecipeInfoTiny.prototype['Title'] = undefined;
...
export default BigOvenModelRecipeInfoTiny;
