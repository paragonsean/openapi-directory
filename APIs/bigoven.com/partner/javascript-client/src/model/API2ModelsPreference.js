...
/**
 * The API2ModelsPreference model module.
 * @module model/API2ModelsPreference
 * @version partner
 */
class API2ModelsPreference {
    /**
     * Constructs a new <code>API2ModelsPreference</code>.
     * 
     * @alias module:model/API2ModelsPreference
     */
    constructor() { 
        
        API2ModelsPreference.initialize(this);
    }
    ...
    /**
     * Constructs a <code>API2ModelsPreference</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/API2ModelsPreference} obj Optional instance to populate.
     * @return {module:model/API2ModelsPreference} The populated <code>API2ModelsPreference</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new API2ModelsPreference();

            if (data.hasOwnProperty('EatingStyle')) {
                obj['EatingStyle'] = ApiClient.convertToType(data['EatingStyle'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>API2ModelsPreference</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>API2ModelsPreference</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['EatingStyle'] && !(typeof data['EatingStyle'] === 'string' || data['EatingStyle'] instanceof String)) {
            throw new Error("Expected the field `EatingStyle` to be a primitive type in the JSON string but got " + data['EatingStyle']);
        }
...
/**
 * 
 * @member {String} EatingStyle
 */
API2ModelsPreference.prototype['EatingStyle'] = undefined;
...
export default API2ModelsPreference;
