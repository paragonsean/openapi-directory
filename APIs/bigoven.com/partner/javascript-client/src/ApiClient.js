...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api2.bigoven.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api2.bigoven.com
         */
        ...
        this.authentications = {
            'api_key': {type: 'apiKey', 'in': 'header', name: 'X-BigOven-API-Key'},
            'basic': {type: 'basic'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/partner/Javascript'
        };
