...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsLocation();
  });
  ...
  describe('API2ModelsLocation', function() {
    it('should create an instance of API2ModelsLocation', function() {
      // uncomment below and update the code to test API2ModelsLocation
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsLocation();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ModelsLocation);
    });
