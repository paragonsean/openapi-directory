...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsPersonal();
  });
  ...
  describe('API2ModelsPersonal', function() {
    it('should create an instance of API2ModelsPersonal', function() {
      // uncomment below and update the code to test API2ModelsPersonal
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsPersonal();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ModelsPersonal);
    });
