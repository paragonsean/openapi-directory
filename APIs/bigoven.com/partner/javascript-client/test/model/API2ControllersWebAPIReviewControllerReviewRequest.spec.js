...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIReviewControllerReviewRequest();
  });
  ...
  describe('API2ControllersWebAPIReviewControllerReviewRequest', function() {
    it('should create an instance of API2ControllersWebAPIReviewControllerReviewRequest', function() {
      // uncomment below and update the code to test API2ControllersWebAPIReviewControllerReviewRequest
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIReviewControllerReviewRequest();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIReviewControllerReviewRequest);
    });
    ...
    it('should have the property makeAgain (base name: "MakeAgain")', function() {
      // uncomment below and update the code to test the property makeAgain
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIReviewControllerReviewRequest();
      //expect(instance).to.be();
    });
