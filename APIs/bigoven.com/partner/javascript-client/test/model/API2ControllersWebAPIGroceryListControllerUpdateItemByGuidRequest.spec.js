...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest();
  });
  ...
  describe('API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest', function() {
    it('should create an instance of API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest', function() {
      // uncomment below and update the code to test API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerUpdateItemByGuidRequest);
    });
