...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest();
  });
  ...
  describe('API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest', function() {
    it('should create an instance of API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest', function() {
      // uncomment below and update the code to test API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest);
    });

    it('should have the property markAsPending (base name: "markAsPending")', function() {
      // uncomment below and update the code to test the property markAsPending
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostGroceryListRecipeRequest();
