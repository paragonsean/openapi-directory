...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIGroceryItem();
  });
  ...
  describe('BigOvenModelAPIGroceryItem', function() {
    it('should create an instance of BigOvenModelAPIGroceryItem', function() {
      // uncomment below and update the code to test BigOvenModelAPIGroceryItem
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIGroceryItem();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPIGroceryItem);
    });

    it('should have the property bigOvenObject (base name: "BigOvenObject")', function() {
      // uncomment below and update the code to test the property bigOvenObject
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIGroceryItem();
    ...
    it('should have the property isChecked (base name: "IsChecked")', function() {
      // uncomment below and update the code to test the property isChecked
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIGroceryItem();
      //expect(instance).to.be();
    });
    ...
    it('should have the property localStatus (base name: "LocalStatus")', function() {
      // uncomment below and update the code to test the property localStatus
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIGroceryItem();
      //expect(instance).to.be();
    });
    ...
    it('should have the property thirdPartyURL (base name: "ThirdPartyURL")', function() {
      // uncomment below and update the code to test the property thirdPartyURL
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIGroceryItem();
      //expect(instance).to.be();
    });
