...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2Result();
  });
  ...
  describe('API2Result', function() {
    it('should create an instance of API2Result', function() {
      // uncomment below and update the code to test API2Result
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2Result();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2Result);
    });
