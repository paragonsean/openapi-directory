...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIReviewControllerPostReplyReq();
  });
  ...
  describe('API2ControllersWebAPIReviewControllerPostReplyReq', function() {
    it('should create an instance of API2ControllersWebAPIReviewControllerPostReplyReq', function() {
      // uncomment below and update the code to test API2ControllersWebAPIReviewControllerPostReplyReq
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIReviewControllerPostReplyReq();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIReviewControllerPostReplyReq);
    });
