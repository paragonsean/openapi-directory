...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIRecipeNoteList();
  });
  ...
  describe('BigOvenModelAPIRecipeNoteList', function() {
    it('should create an instance of BigOvenModelAPIRecipeNoteList', function() {
      // uncomment below and update the code to test BigOvenModelAPIRecipeNoteList
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIRecipeNoteList();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPIRecipeNoteList);
    });
