...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2RecipeSearchResult();
  });
  ...
  describe('BigOvenModelAPI2RecipeSearchResult', function() {
    it('should create an instance of BigOvenModelAPI2RecipeSearchResult', function() {
      // uncomment below and update the code to test BigOvenModelAPI2RecipeSearchResult
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2RecipeSearchResult();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2RecipeSearchResult);
    });
    ...
    it('should have the property spellSuggest (base name: "SpellSuggest")', function() {
      // uncomment below and update the code to test the property spellSuggest
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2RecipeSearchResult();
      //expect(instance).to.be();
    });
