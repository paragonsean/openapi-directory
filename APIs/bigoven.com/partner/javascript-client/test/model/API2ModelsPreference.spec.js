...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsPreference();
  });
  ...
  describe('API2ModelsPreference', function() {
    it('should create an instance of API2ModelsPreference', function() {
      // uncomment below and update the code to test API2ModelsPreference
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsPreference();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ModelsPreference);
    });
