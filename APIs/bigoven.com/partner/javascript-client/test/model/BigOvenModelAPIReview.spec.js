...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIReview();
  });
  ...
  describe('BigOvenModelAPIReview', function() {
    it('should create an instance of BigOvenModelAPIReview', function() {
      // uncomment below and update the code to test BigOvenModelAPIReview
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIReview();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPIReview);
    });
    ...
    it('should have the property featuredReply (base name: "FeaturedReply")', function() {
      // uncomment below and update the code to test the property featuredReply
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIReview();
      //expect(instance).to.be();
    });
