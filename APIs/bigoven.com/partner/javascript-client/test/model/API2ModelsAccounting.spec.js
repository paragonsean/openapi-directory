...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsAccounting();
  });
  ...
  describe('API2ModelsAccounting', function() {
    it('should create an instance of API2ModelsAccounting', function() {
      // uncomment below and update the code to test API2ModelsAccounting
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsAccounting();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ModelsAccounting);
    });
