...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2GroceryListDepartmentResult();
  });
  ...
  describe('API2GroceryListDepartmentResult', function() {
    it('should create an instance of API2GroceryListDepartmentResult', function() {
      // uncomment below and update the code to test API2GroceryListDepartmentResult
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2GroceryListDepartmentResult();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2GroceryListDepartmentResult);
    });
