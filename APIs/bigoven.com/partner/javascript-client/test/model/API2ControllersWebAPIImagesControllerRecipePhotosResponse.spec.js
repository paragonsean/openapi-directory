...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIImagesControllerRecipePhotosResponse();
  });
  ...
  describe('API2ControllersWebAPIImagesControllerRecipePhotosResponse', function() {
    it('should create an instance of API2ControllersWebAPIImagesControllerRecipePhotosResponse', function() {
      // uncomment below and update the code to test API2ControllersWebAPIImagesControllerRecipePhotosResponse
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIImagesControllerRecipePhotosResponse();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIImagesControllerRecipePhotosResponse);
    });
