...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIMeControllerPreferenceOptions();
  });
  ...
  describe('API2ControllersWebAPIMeControllerPreferenceOptions', function() {
    it('should create an instance of API2ControllersWebAPIMeControllerPreferenceOptions', function() {
      // uncomment below and update the code to test API2ControllersWebAPIMeControllerPreferenceOptions
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIMeControllerPreferenceOptions();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIMeControllerPreferenceOptions);
    });

    it('should have the property eatingStyle (base name: "EatingStyle")', function() {
      // uncomment below and update the code to test the property eatingStyle
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIMeControllerPreferenceOptions();
