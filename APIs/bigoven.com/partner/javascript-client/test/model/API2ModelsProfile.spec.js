...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsProfile();
  });
  ...
  describe('API2ModelsProfile', function() {
    it('should create an instance of API2ModelsProfile', function() {
      // uncomment below and update the code to test API2ModelsProfile
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsProfile();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ModelsProfile);
    });
