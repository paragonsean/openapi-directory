...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostGroceryListSyncRequest();
  });
  ...
  describe('API2ControllersWebAPIGroceryListControllerPostGroceryListSyncRequest', function() {
    it('should create an instance of API2ControllersWebAPIGroceryListControllerPostGroceryListSyncRequest', function() {
      // uncomment below and update the code to test API2ControllersWebAPIGroceryListControllerPostGroceryListSyncRequest
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostGroceryListSyncRequest();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostGroceryListSyncRequest);
    });
