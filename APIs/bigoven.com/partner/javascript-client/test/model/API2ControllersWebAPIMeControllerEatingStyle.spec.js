...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIMeControllerEatingStyle();
  });
  ...
  describe('API2ControllersWebAPIMeControllerEatingStyle', function() {
    it('should create an instance of API2ControllersWebAPIMeControllerEatingStyle', function() {
      // uncomment below and update the code to test API2ControllersWebAPIMeControllerEatingStyle
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIMeControllerEatingStyle();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIMeControllerEatingStyle);
    });
