...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsRecipesFeedbackDTO();
  });
  ...
  describe('API2ModelsRecipesFeedbackDTO', function() {
    it('should create an instance of API2ModelsRecipesFeedbackDTO', function() {
      // uncomment below and update the code to test API2ModelsRecipesFeedbackDTO
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsRecipesFeedbackDTO();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ModelsRecipesFeedbackDTO);
    });
