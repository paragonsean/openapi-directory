...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIMeControllerOption();
  });
  ...
  describe('API2ControllersWebAPIMeControllerOption', function() {
    it('should create an instance of API2ControllersWebAPIMeControllerOption', function() {
      // uncomment below and update the code to test API2ControllersWebAPIMeControllerOption
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIMeControllerOption();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIMeControllerOption);
    });
