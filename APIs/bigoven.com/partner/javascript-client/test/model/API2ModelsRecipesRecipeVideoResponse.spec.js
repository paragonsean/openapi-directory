...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsRecipesRecipeVideoResponse();
  });
  ...
  describe('API2ModelsRecipesRecipeVideoResponse', function() {
    it('should create an instance of API2ModelsRecipesRecipeVideoResponse', function() {
      // uncomment below and update the code to test API2ModelsRecipesRecipeVideoResponse
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsRecipesRecipeVideoResponse();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ModelsRecipesRecipeVideoResponse);
    });

    it('should have the property insertedOn (base name: "InsertedOn")', function() {
      // uncomment below and update the code to test the property insertedOn
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsRecipesRecipeVideoResponse();
      //expect(instance).to.be();
    });

    it('should have the property isPrimaryVideo (base name: "IsPrimaryVideo")', function() {
      // uncomment below and update the code to test the property isPrimaryVideo
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsRecipesRecipeVideoResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property vidId (base name: "VidId")', function() {
