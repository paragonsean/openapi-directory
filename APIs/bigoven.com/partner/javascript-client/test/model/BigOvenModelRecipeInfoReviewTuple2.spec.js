...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeInfoReviewTuple2();
  });
  ...
  describe('BigOvenModelRecipeInfoReviewTuple2', function() {
    it('should create an instance of BigOvenModelRecipeInfoReviewTuple2', function() {
      // uncomment below and update the code to test BigOvenModelRecipeInfoReviewTuple2
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeInfoReviewTuple2();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeInfoReviewTuple2);
    });
