...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2RecipeInfox();
  });
  ...
  describe('BigOvenModelAPI2RecipeInfox', function() {
    it('should create an instance of BigOvenModelAPI2RecipeInfox', function() {
      // uncomment below and update the code to test BigOvenModelAPI2RecipeInfox
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2RecipeInfox();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2RecipeInfox);
    });
