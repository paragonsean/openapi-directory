...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIGroceryGroceryList();
  });
  ...
  describe('BigOvenModelAPIGroceryGroceryList', function() {
    it('should create an instance of BigOvenModelAPIGroceryGroceryList', function() {
      // uncomment below and update the code to test BigOvenModelAPIGroceryGroceryList
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIGroceryGroceryList();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPIGroceryGroceryList);
    });
