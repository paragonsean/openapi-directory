...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2Photo();
  });
  ...
  describe('BigOvenModelAPI2Photo', function() {
    it('should create an instance of BigOvenModelAPI2Photo', function() {
      // uncomment below and update the code to test BigOvenModelAPI2Photo
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2Photo();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2Photo);
    });
