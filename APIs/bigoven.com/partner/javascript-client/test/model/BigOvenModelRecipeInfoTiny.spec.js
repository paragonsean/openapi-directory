...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeInfoTiny();
  });
  ...
  describe('BigOvenModelRecipeInfoTiny', function() {
    it('should create an instance of BigOvenModelRecipeInfoTiny', function() {
      // uncomment below and update the code to test BigOvenModelRecipeInfoTiny
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeInfoTiny();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeInfoTiny);
    });
