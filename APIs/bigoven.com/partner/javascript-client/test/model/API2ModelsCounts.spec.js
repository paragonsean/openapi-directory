...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsCounts();
  });
  ...
  describe('API2ModelsCounts', function() {
    it('should create an instance of API2ModelsCounts', function() {
      // uncomment below and update the code to test API2ModelsCounts
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsCounts();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ModelsCounts);
    });

    it('should have the property addedCount (base name: "AddedCount")', function() {
      // uncomment below and update the code to test the property addedCount
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsCounts();
    ...
    it('should have the property privateRecipeCount (base name: "PrivateRecipeCount")', function() {
      // uncomment below and update the code to test the property privateRecipeCount
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsCounts();
      //expect(instance).to.be();
    });

    it('should have the property publicRecipeCount (base name: "PublicRecipeCount")', function() {
      // uncomment below and update the code to test the property publicRecipeCount
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsCounts();
      //expect(instance).to.be();
    });

    it('should have the property totalRecipes (base name: "TotalRecipes")', function() {
      // uncomment below and update the code to test the property totalRecipes
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsCounts();
      //expect(instance).to.be();
    });
