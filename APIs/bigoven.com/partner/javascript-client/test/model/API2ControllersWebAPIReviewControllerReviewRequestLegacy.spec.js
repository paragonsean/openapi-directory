...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIReviewControllerReviewRequestLegacy();
  });
  ...
  describe('API2ControllersWebAPIReviewControllerReviewRequestLegacy', function() {
    it('should create an instance of API2ControllersWebAPIReviewControllerReviewRequestLegacy', function() {
      // uncomment below and update the code to test API2ControllersWebAPIReviewControllerReviewRequestLegacy
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIReviewControllerReviewRequestLegacy();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIReviewControllerReviewRequestLegacy);
    });
