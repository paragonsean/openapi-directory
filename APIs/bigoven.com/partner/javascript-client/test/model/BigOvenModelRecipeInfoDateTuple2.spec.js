...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeInfoDateTuple2();
  });
  ...
  describe('BigOvenModelRecipeInfoDateTuple2', function() {
    it('should create an instance of BigOvenModelRecipeInfoDateTuple2', function() {
      // uncomment below and update the code to test BigOvenModelRecipeInfoDateTuple2
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeInfoDateTuple2();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeInfoDateTuple2);
    });
    ...
    it('should have the property recipeInfo (base name: "recipeInfo")', function() {
      // uncomment below and update the code to test the property recipeInfo
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeInfoDateTuple2();
      //expect(instance).to.be();
    });
