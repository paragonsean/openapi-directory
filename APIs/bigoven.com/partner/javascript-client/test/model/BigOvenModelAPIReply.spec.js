...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIReply();
  });
  ...
  describe('BigOvenModelAPIReply', function() {
    it('should create an instance of BigOvenModelAPIReply', function() {
      // uncomment below and update the code to test BigOvenModelAPIReply
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIReply();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPIReply);
    });
