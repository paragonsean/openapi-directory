...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIIngredientInfo();
  });
  ...
  describe('BigOvenModelAPIIngredientInfo', function() {
    it('should create an instance of BigOvenModelAPIIngredientInfo', function() {
      // uncomment below and update the code to test BigOvenModelAPIIngredientInfo
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIIngredientInfo();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPIIngredientInfo);
    });
    ...
    it('should have the property masterIngredientID (base name: "MasterIngredientID")', function() {
      // uncomment below and update the code to test the property masterIngredientID
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIIngredientInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property usuallyOnHand (base name: "UsuallyOnHand")', function() {
      // uncomment below and update the code to test the property usuallyOnHand
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIIngredientInfo();
      //expect(instance).to.be();
    });
