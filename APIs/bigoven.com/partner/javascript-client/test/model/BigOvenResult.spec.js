...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenResult();
  });
  ...
  describe('BigOvenResult', function() {
    it('should create an instance of BigOvenResult', function() {
      // uncomment below and update the code to test BigOvenResult
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenResult();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenResult);
    });
