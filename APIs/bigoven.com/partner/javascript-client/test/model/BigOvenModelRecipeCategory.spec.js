...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeCategory();
  });
  ...
  describe('BigOvenModelRecipeCategory', function() {
    it('should create an instance of BigOvenModelRecipeCategory', function() {
      // uncomment below and update the code to test BigOvenModelRecipeCategory
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeCategory();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeCategory);
    });
    ...
    it('should have the property defaultActiveMinutes (base name: "DefaultActiveMinutes")', function() {
      // uncomment below and update the code to test the property defaultActiveMinutes
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeCategory();
      //expect(instance).to.be();
    });

    it('should have the property defaultTotalMinutes (base name: "DefaultTotalMinutes")', function() {
      // uncomment below and update the code to test the property defaultTotalMinutes
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelRecipeCategory();
      //expect(instance).to.be();
    });
