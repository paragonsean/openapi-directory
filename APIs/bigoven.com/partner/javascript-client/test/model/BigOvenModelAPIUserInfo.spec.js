...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIUserInfo();
  });
  ...
  describe('BigOvenModelAPIUserInfo', function() {
    it('should create an instance of BigOvenModelAPIUserInfo', function() {
      // uncomment below and update the code to test BigOvenModelAPIUserInfo
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIUserInfo();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPIUserInfo);
    });
    ...
    it('should have the property isKitchenHelper (base name: "IsKitchenHelper")', function() {
      // uncomment below and update the code to test the property isKitchenHelper
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIUserInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isUsingRecurly (base name: "IsUsingRecurly")', function() {
      // uncomment below and update the code to test the property isUsingRecurly
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIUserInfo();
      //expect(instance).to.be();
    });
    ...
    it('should have the property photoUrl48 (base name: "PhotoUrl48")', function() {
      // uncomment below and update the code to test the property photoUrl48
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIUserInfo();
      //expect(instance).to.be();
    });

    it('should have the property premiumExpiryDate (base name: "PremiumExpiryDate")', function() {
      // uncomment below and update the code to test the property premiumExpiryDate
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPIUserInfo();
      //expect(instance).to.be();
    });
