...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelInstructionStep();
  });
  ...
  describe('BigOvenModelInstructionStep', function() {
    it('should create an instance of BigOvenModelInstructionStep', function() {
      // uncomment below and update the code to test BigOvenModelInstructionStep
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelInstructionStep();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelInstructionStep);
    });

    it('should have the property endGantt (base name: "EndGantt")', function() {
      // uncomment below and update the code to test the property endGantt
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelInstructionStep();
      //expect(instance).to.be();
    });

    it('should have the property startGantt (base name: "StartGantt")', function() {
      // uncomment below and update the code to test the property startGantt
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelInstructionStep();
      //expect(instance).to.be();
    });
