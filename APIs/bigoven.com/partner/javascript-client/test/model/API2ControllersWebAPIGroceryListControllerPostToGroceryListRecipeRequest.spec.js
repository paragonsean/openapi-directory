...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest();
  });
  ...
  describe('API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest', function() {
    it('should create an instance of API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest', function() {
      // uncomment below and update the code to test API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostToGroceryListRecipeRequest);
    });
