...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest();
  });
  ...
  describe('API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest', function() {
    it('should create an instance of API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest', function() {
      // uncomment below and update the code to test API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerPostGroceryListAddLineRequest);
    });
