...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsBigOvenUser();
  });
  ...
  describe('API2ModelsBigOvenUser', function() {
    it('should create an instance of API2ModelsBigOvenUser', function() {
      // uncomment below and update the code to test API2ModelsBigOvenUser
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsBigOvenUser();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ModelsBigOvenUser);
    });
    ...
    it('should have the property bOAuthToken (base name: "BOAuthToken")', function() {
      // uncomment below and update the code to test the property bOAuthToken
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsBigOvenUser();
      //expect(instance).to.be();
    });

    it('should have the property lastChangeLogID (base name: "LastChangeLogID")', function() {
      // uncomment below and update the code to test the property lastChangeLogID
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ModelsBigOvenUser();
      //expect(instance).to.be();
    });
