...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2CollectionInfo();
  });
  ...
  describe('BigOvenModelAPI2CollectionInfo', function() {
    it('should create an instance of BigOvenModelAPI2CollectionInfo', function() {
      // uncomment below and update the code to test BigOvenModelAPI2CollectionInfo
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2CollectionInfo();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2CollectionInfo);
    });
    ...
    it('should have the property isFiltered (base name: "IsFiltered")', function() {
      // uncomment below and update the code to test the property isFiltered
      //var instance = new 1000000RecipeAndGroceryListApiV2.BigOvenModelAPI2CollectionInfo();
      //expect(instance).to.be();
    });
