...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerDepartmentModel();
  });
  ...
  describe('API2ControllersWebAPIGroceryListControllerDepartmentModel', function() {
    it('should create an instance of API2ControllersWebAPIGroceryListControllerDepartmentModel', function() {
      // uncomment below and update the code to test API2ControllersWebAPIGroceryListControllerDepartmentModel
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerDepartmentModel();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPIGroceryListControllerDepartmentModel);
    });
