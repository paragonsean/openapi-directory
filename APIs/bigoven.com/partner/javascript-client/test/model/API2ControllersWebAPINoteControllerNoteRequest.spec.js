...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPINoteControllerNoteRequest();
  });
  ...
  describe('API2ControllersWebAPINoteControllerNoteRequest', function() {
    it('should create an instance of API2ControllersWebAPINoteControllerNoteRequest', function() {
      // uncomment below and update the code to test API2ControllersWebAPINoteControllerNoteRequest
      //var instance = new 1000000RecipeAndGroceryListApiV2.API2ControllersWebAPINoteControllerNoteRequest();
      //expect(instance).to.be.a(1000000RecipeAndGroceryListApiV2.API2ControllersWebAPINoteControllerNoteRequest);
    });
