...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.MeApi();
  });
  ...
  describe('MeApi', function() {
    describe('meGetOptions', function() {
      it('should call meGetOptions successfully', function(done) {
        //uncomment below and update the code to test meGetOptions
        //instance.meGetOptions(function(error) {
    ...
    describe('meIndex', function() {
      it('should call meIndex successfully', function(done) {
        //uncomment below and update the code to test meIndex
        //instance.meIndex(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('meProfilePut', function() {
      it('should call meProfilePut successfully', function(done) {
        //uncomment below and update the code to test meProfilePut
        //instance.meProfilePut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('mePutMe', function() {
      it('should call mePutMe successfully', function(done) {
        //uncomment below and update the code to test mePutMe
        //instance.mePutMe(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('mePutMePersonal', function() {
      it('should call mePutMePersonal successfully', function(done) {
        //uncomment below and update the code to test mePutMePersonal
        //instance.mePutMePersonal(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('mePutMePreferences', function() {
      it('should call mePutMePreferences successfully', function(done) {
        //uncomment below and update the code to test mePutMePreferences
        //instance.mePutMePreferences(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('meSkinny', function() {
      it('should call meSkinny successfully', function(done) {
        //uncomment below and update the code to test meSkinny
        //instance.meSkinny(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
