...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.NoteApi();
  });
  ...
  describe('NoteApi', function() {
    describe('noteDelete', function() {
      it('should call noteDelete successfully', function(done) {
        //uncomment below and update the code to test noteDelete
        //instance.noteDelete(function(error) {
    ...
    describe('noteGet', function() {
      it('should call noteGet successfully', function(done) {
        //uncomment below and update the code to test noteGet
        //instance.noteGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('noteGetNotes', function() {
      it('should call noteGetNotes successfully', function(done) {
        //uncomment below and update the code to test noteGetNotes
        //instance.noteGetNotes(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('notePost', function() {
      it('should call notePost successfully', function(done) {
        //uncomment below and update the code to test notePost
        //instance.notePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('notePut', function() {
      it('should call notePut successfully', function(done) {
        //uncomment below and update the code to test notePut
        //instance.notePut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
