...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.CollectionApi();
  });
  ...
  describe('CollectionApi', function() {
    describe('collectionCollections', function() {
      it('should call collectionCollections successfully', function(done) {
        //uncomment below and update the code to test collectionCollections
        //instance.collectionCollections(function(error) {
    ...
    describe('collectionGetCollection', function() {
      it('should call collectionGetCollection successfully', function(done) {
        //uncomment below and update the code to test collectionGetCollection
        //instance.collectionGetCollection(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('collectionGetCollectionMeta', function() {
      it('should call collectionGetCollectionMeta successfully', function(done) {
        //uncomment below and update the code to test collectionGetCollectionMeta
        //instance.collectionGetCollectionMeta(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
