...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 1000000RecipeAndGroceryListApiV2.ImagesApi();
  });
  ...
  describe('ImagesApi', function() {
    ...
    describe('imagesGetPendingByUser', function() {
      it('should call imagesGetPendingByUser successfully', function(done) {
        //uncomment below and update the code to test imagesGetPendingByUser
        //instance.imagesGetPendingByUser(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('imagesGetRecipePhotos', function() {
      it('should call imagesGetRecipePhotos successfully', function(done) {
        //uncomment below and update the code to test imagesGetRecipePhotos
        //instance.imagesGetRecipePhotos(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('imagesGetScanImages', function() {
      it('should call imagesGetScanImages successfully', function(done) {
        //uncomment below and update the code to test imagesGetScanImages
        //instance.imagesGetScanImages(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('imagesUploadRecipeImage', function() {
      it('should call imagesUploadRecipeImage successfully', function(done) {
        //uncomment below and update the code to test imagesUploadRecipeImage
        //instance.imagesUploadRecipeImage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('imagesUploadUserAvatar', function() {
      it('should call imagesUploadUserAvatar successfully', function(done) {
        //uncomment below and update the code to test imagesUploadUserAvatar
        //instance.imagesUploadUserAvatar(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
