...
/*
 * OAIAPI2_Models_Location.h
 *
 * 
 */

#ifndef OAIAPI2_Models_Location_H
#define OAIAPI2_Models_Location_H
...
class OAIAPI2_Models_Location : public OAIObject {
public:
    OAIAPI2_Models_Location();
    OAIAPI2_Models_Location(QString json);
    ~OAIAPI2_Models_Location() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Models_Location)

#endif // OAIAPI2_Models_Location_H
