...
/*
 * OAIAPI2_Controllers_WebAPI_NoteController_NoteRequest.h
 *
 * 
 */

#ifndef OAIAPI2_Controllers_WebAPI_NoteController_NoteRequest_H
#define OAIAPI2_Controllers_WebAPI_NoteController_NoteRequest_H
...
class OAIAPI2_Controllers_WebAPI_NoteController_NoteRequest : public OAIObject {
public:
    OAIAPI2_Controllers_WebAPI_NoteController_NoteRequest();
    OAIAPI2_Controllers_WebAPI_NoteController_NoteRequest(QString json);
    ~OAIAPI2_Controllers_WebAPI_NoteController_NoteRequest() override;
    ...
    QString getDateDt() const;
    void setDateDt(const QString &date_dt);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Controllers_WebAPI_NoteController_NoteRequest)

#endif // OAIAPI2_Controllers_WebAPI_NoteController_NoteRequest_H
