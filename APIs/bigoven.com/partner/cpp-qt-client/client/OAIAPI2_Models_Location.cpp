...
#include "OAIAPI2_Models_Location.h"
...
OAIAPI2_Models_Location::OAIAPI2_Models_Location(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPI2_Models_Location::OAIAPI2_Models_Location() {
    this->initializeModel();
}

OAIAPI2_Models_Location::~OAIAPI2_Models_Location() {}

void OAIAPI2_Models_Location::initializeModel() {
...
void OAIAPI2_Models_Location::fromJson(QString jsonString) {
...
void OAIAPI2_Models_Location::fromJsonObject(QJsonObject json) {
...
QString OAIAPI2_Models_Location::asJson() const {
...
QJsonObject OAIAPI2_Models_Location::asJsonObject() const {
    QJsonObject obj;
    if (m_city_isSet) {
...
QString OAIAPI2_Models_Location::getCity() const {
    return m_city;
}
void OAIAPI2_Models_Location::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIAPI2_Models_Location::is_city_Set() const{
    return m_city_isSet;
}

bool OAIAPI2_Models_Location::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIAPI2_Models_Location::getCountry() const {
    return m_country;
}
void OAIAPI2_Models_Location::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIAPI2_Models_Location::is_country_Set() const{
    return m_country_isSet;
}

bool OAIAPI2_Models_Location::is_country_Valid() const{
    return m_country_isValid;
}

qint32 OAIAPI2_Models_Location::getDma() const {
    return m_dma;
}
void OAIAPI2_Models_Location::setDma(const qint32 &dma) {
    m_dma = dma;
    m_dma_isSet = true;
}

bool OAIAPI2_Models_Location::is_dma_Set() const{
    return m_dma_isSet;
}

bool OAIAPI2_Models_Location::is_dma_Valid() const{
    return m_dma_isValid;
}

bool OAIAPI2_Models_Location::isSet() const {
...
bool OAIAPI2_Models_Location::isValid() const {
