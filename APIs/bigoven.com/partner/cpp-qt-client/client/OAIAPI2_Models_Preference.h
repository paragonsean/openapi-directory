...
/*
 * OAIAPI2_Models_Preference.h
 *
 * 
 */

#ifndef OAIAPI2_Models_Preference_H
#define OAIAPI2_Models_Preference_H
...
class OAIAPI2_Models_Preference : public OAIObject {
public:
    OAIAPI2_Models_Preference();
    OAIAPI2_Models_Preference(QString json);
    ~OAIAPI2_Models_Preference() override;
    ...
    QString getEatingStyle() const;
    void setEatingStyle(const QString &eating_style);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Models_Preference)

#endif // OAIAPI2_Models_Preference_H
