...
/*
 * OAIBigOven_Model_RecipeInfoDateTuple2.h
 *
 * 
 */

#ifndef OAIBigOven_Model_RecipeInfoDateTuple2_H
#define OAIBigOven_Model_RecipeInfoDateTuple2_H
...
class OAIBigOven_Model_RecipeInfoDateTuple2 : public OAIObject {
public:
    OAIBigOven_Model_RecipeInfoDateTuple2();
    OAIBigOven_Model_RecipeInfoDateTuple2(QString json);
    ~OAIBigOven_Model_RecipeInfoDateTuple2() override;
    ...
    OAIBigOven_Model_API2_RecipeInfox getRecipeInfo() const;
    void setRecipeInfo(const OAIBigOven_Model_API2_RecipeInfox &recipe_info);
    bool is_recipe_info_Set() const;
    bool is_recipe_info_Valid() const;
...
private:
    ...
    OAIBigOven_Model_API2_RecipeInfox m_recipe_info;
    bool m_recipe_info_isSet;
    bool m_recipe_info_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_RecipeInfoDateTuple2)

#endif // OAIBigOven_Model_RecipeInfoDateTuple2_H
