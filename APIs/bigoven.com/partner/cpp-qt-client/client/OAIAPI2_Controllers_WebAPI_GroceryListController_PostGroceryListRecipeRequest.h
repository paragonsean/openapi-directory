...
/*
 * OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListRecipeRequest.h
 *
 * 
 */

#ifndef OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListRecipeRequest_H
#define OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListRecipeRequest_H
...
class OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListRecipeRequest : public OAIObject {
public:
    OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListRecipeRequest();
    OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListRecipeRequest(QString json);
    ~OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListRecipeRequest() override;
    ...
    bool isMarkAsPending() const;
    void setMarkAsPending(const bool &mark_as_pending);
    bool is_mark_as_pending_Set() const;
    bool is_mark_as_pending_Valid() const;
...
private:
    ...
    bool m_mark_as_pending;
    bool m_mark_as_pending_isSet;
    bool m_mark_as_pending_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListRecipeRequest)

#endif // OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListRecipeRequest_H
