...
/*
 * OAIBigOven_Model_API_RecipeNoteList.h
 *
 * 
 */

#ifndef OAIBigOven_Model_API_RecipeNoteList_H
#define OAIBigOven_Model_API_RecipeNoteList_H
...
namespace OpenAPI {
class OAIBigOven_Model_API_RecipeNote;

class OAIBigOven_Model_API_RecipeNoteList : public OAIObject {
public:
    OAIBigOven_Model_API_RecipeNoteList();
    OAIBigOven_Model_API_RecipeNoteList(QString json);
    ~OAIBigOven_Model_API_RecipeNoteList() override;
    ...
    QList<OAIBigOven_Model_API_RecipeNote> getResults() const;
    void setResults(const QList<OAIBigOven_Model_API_RecipeNote> &results);
...
private:
    ...
    QList<OAIBigOven_Model_API_RecipeNote> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_API_RecipeNoteList)

#endif // OAIBigOven_Model_API_RecipeNoteList_H
