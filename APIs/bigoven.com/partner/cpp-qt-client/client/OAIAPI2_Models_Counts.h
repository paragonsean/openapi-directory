...
/*
 * OAIAPI2_Models_Counts.h
 *
 * 
 */

#ifndef OAIAPI2_Models_Counts_H
#define OAIAPI2_Models_Counts_H
...
class OAIAPI2_Models_Counts : public OAIObject {
public:
    OAIAPI2_Models_Counts();
    OAIAPI2_Models_Counts(QString json);
    ~OAIAPI2_Models_Counts() override;
    ...
    qint64 getAddedCount() const;
    void setAddedCount(const qint64 &added_count);
    bool is_added_count_Set() const;
    bool is_added_count_Valid() const;
    ...
    qint64 getPrivateRecipeCount() const;
    void setPrivateRecipeCount(const qint64 &private_recipe_count);
    bool is_private_recipe_count_Set() const;
    bool is_private_recipe_count_Valid() const;

    qint64 getPublicRecipeCount() const;
    void setPublicRecipeCount(const qint64 &public_recipe_count);
    bool is_public_recipe_count_Set() const;
    bool is_public_recipe_count_Valid() const;

    qint64 getTotalRecipes() const;
    void setTotalRecipes(const qint64 &total_recipes);
    bool is_total_recipes_Set() const;
    bool is_total_recipes_Valid() const;
...
private:
    ...
    qint64 m_added_count;
    bool m_added_count_isSet;
    bool m_added_count_isValid;
    ...
    qint64 m_private_recipe_count;
    bool m_private_recipe_count_isSet;
    bool m_private_recipe_count_isValid;

    qint64 m_public_recipe_count;
    bool m_public_recipe_count_isSet;
    bool m_public_recipe_count_isValid;

    qint64 m_total_recipes;
    bool m_total_recipes_isSet;
    bool m_total_recipes_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Models_Counts)

#endif // OAIAPI2_Models_Counts_H
