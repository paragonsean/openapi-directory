...
/*
 * OAIBigOven_Model_RecipeInfoReviewTuple2.h
 *
 * 
 */

#ifndef OAIBigOven_Model_RecipeInfoReviewTuple2_H
#define OAIBigOven_Model_RecipeInfoReviewTuple2_H
...
class OAIBigOven_Model_API_Review;

class OAIBigOven_Model_RecipeInfoReviewTuple2 : public OAIObject {
public:
    OAIBigOven_Model_RecipeInfoReviewTuple2();
    OAIBigOven_Model_RecipeInfoReviewTuple2(QString json);
    ~OAIBigOven_Model_RecipeInfoReviewTuple2() override;
    ...
    OAIBigOven_Model_API_Review getReview() const;
    void setReview(const OAIBigOven_Model_API_Review &review);
...
private:
    ...
    OAIBigOven_Model_API_Review m_review;
    bool m_review_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_RecipeInfoReviewTuple2)

#endif // OAIBigOven_Model_RecipeInfoReviewTuple2_H
