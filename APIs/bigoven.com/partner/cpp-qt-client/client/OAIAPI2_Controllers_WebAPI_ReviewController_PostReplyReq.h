...
/*
 * OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq.h
 *
 * Reply request parameters
 */

#ifndef OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq_H
#define OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq_H
...
class OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq : public OAIObject {
public:
    OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq();
    OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq(QString json);
    ~OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq)

#endif // OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq_H
