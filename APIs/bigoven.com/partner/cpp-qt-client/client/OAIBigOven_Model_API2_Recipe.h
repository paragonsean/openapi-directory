...
/*
 * OAIBigOven_Model_API2_Recipe.h
 *
 * 
 */

#ifndef OAIBigOven_Model_API2_Recipe_H
#define OAIBigOven_Model_API2_Recipe_H
...
class OAIBigOven_Model_API2_Recipe : public OAIObject {
public:
    OAIBigOven_Model_API2_Recipe();
    OAIBigOven_Model_API2_Recipe(QString json);
    ~OAIBigOven_Model_API2_Recipe() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_API2_Recipe)

#endif // OAIBigOven_Model_API2_Recipe_H
