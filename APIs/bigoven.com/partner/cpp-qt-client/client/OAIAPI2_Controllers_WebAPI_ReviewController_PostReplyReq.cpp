...
OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq() {
    this->initializeModel();
}

OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::~OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq() {}

void OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::initializeModel() {

    m_comment_isSet = false;
    m_comment_isValid = false;
}

void OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::fromJson(QString jsonString) {
...
void OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::fromJsonObject(QJsonObject json) {

    m_comment_isValid = ::OpenAPI::fromJsonValue(m_comment, json[QString("Comment")]);
    m_comment_isSet = !json[QString("Comment")].isNull() && m_comment_isValid;
}

QString OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::asJson() const {
...
QJsonObject OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::asJsonObject() const {
    QJsonObject obj;
    if (m_comment_isSet) {
...
QString OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::getComment() const {
    return m_comment;
}
void OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::setComment(const QString &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::is_comment_Valid() const{
    return m_comment_isValid;
}

bool OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::isSet() const {
...
bool OAIAPI2_Controllers_WebAPI_ReviewController_PostReplyReq::isValid() const {
