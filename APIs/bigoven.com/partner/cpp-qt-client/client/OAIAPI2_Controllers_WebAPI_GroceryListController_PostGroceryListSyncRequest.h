...
/*
 * OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListSyncRequest.h
 *
 * 
 */

#ifndef OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListSyncRequest_H
#define OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListSyncRequest_H
...
namespace OpenAPI {
class OAIBigOven_Model_API_Grocery_GroceryList;

class OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListSyncRequest : public OAIObject {
public:
    OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListSyncRequest();
    OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListSyncRequest(QString json);
    ~OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListSyncRequest() override;
    ...
    OAIBigOven_Model_API_Grocery_GroceryList getList() const;
    void setList(const OAIBigOven_Model_API_Grocery_GroceryList &list);
...
private:
    ...
    OAIBigOven_Model_API_Grocery_GroceryList m_list;
    bool m_list_isSet;
    bool m_list_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListSyncRequest)

#endif // OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListSyncRequest_H
