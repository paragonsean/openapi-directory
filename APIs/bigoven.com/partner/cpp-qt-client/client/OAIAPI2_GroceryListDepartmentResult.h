...
/*
 * OAIAPI2_GroceryListDepartmentResult.h
 *
 * 
 */

#ifndef OAIAPI2_GroceryListDepartmentResult_H
#define OAIAPI2_GroceryListDepartmentResult_H
...
class OAIAPI2_GroceryListDepartmentResult : public OAIObject {
public:
    OAIAPI2_GroceryListDepartmentResult();
    OAIAPI2_GroceryListDepartmentResult(QString json);
    ~OAIAPI2_GroceryListDepartmentResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_GroceryListDepartmentResult)

#endif // OAIAPI2_GroceryListDepartmentResult_H
