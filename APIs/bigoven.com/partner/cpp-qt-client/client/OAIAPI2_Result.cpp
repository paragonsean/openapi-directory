...
OAIAPI2_Result::OAIAPI2_Result(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPI2_Result::OAIAPI2_Result() {
    this->initializeModel();
}

OAIAPI2_Result::~OAIAPI2_Result() {}

void OAIAPI2_Result::initializeModel() {
...
void OAIAPI2_Result::fromJson(QString jsonString) {
...
void OAIAPI2_Result::fromJsonObject(QJsonObject json) {
...
QString OAIAPI2_Result::asJson() const {
...
QJsonObject OAIAPI2_Result::asJsonObject() const {
    QJsonObject obj;
    if (m_data_isSet) {
...
OAIObject OAIAPI2_Result::getData() const {
    return m_data;
}
void OAIAPI2_Result::setData(const OAIObject &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIAPI2_Result::is_data_Set() const{
    return m_data_isSet;
}

bool OAIAPI2_Result::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIAPI2_Result::getMessage() const {
    return m_message;
}
void OAIAPI2_Result::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIAPI2_Result::is_message_Set() const{
    return m_message_isSet;
}

bool OAIAPI2_Result::is_message_Valid() const{
    return m_message_isValid;
}

qint32 OAIAPI2_Result::getStatusCode() const {
    return m_status_code;
}
void OAIAPI2_Result::setStatusCode(const qint32 &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAIAPI2_Result::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAIAPI2_Result::is_status_code_Valid() const{
    return m_status_code_isValid;
}

bool OAIAPI2_Result::isSet() const {
...
bool OAIAPI2_Result::isValid() const {
