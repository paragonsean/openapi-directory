...
/*
 * OAIBigOven_Model_API_Reply.h
 *
 * 
 */

#ifndef OAIBigOven_Model_API_Reply_H
#define OAIBigOven_Model_API_Reply_H
...
namespace OpenAPI {
class OAIBigOven_Model_API_UserInfoTiny;

class OAIBigOven_Model_API_Reply : public OAIObject {
public:
    OAIBigOven_Model_API_Reply();
    OAIBigOven_Model_API_Reply(QString json);
    ~OAIBigOven_Model_API_Reply() override;
    ...
    OAIBigOven_Model_API_UserInfoTiny getPoster() const;
    void setPoster(const OAIBigOven_Model_API_UserInfoTiny &poster);
...
private:
    ...
    OAIBigOven_Model_API_UserInfoTiny m_poster;
    bool m_poster_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_API_Reply)

#endif // OAIBigOven_Model_API_Reply_H
