...
/*
 * OAIAPI2_Controllers_WebAPI_ImagesController_RecipePhotosResponse.h
 *
 * 
 */

#ifndef OAIAPI2_Controllers_WebAPI_ImagesController_RecipePhotosResponse_H
#define OAIAPI2_Controllers_WebAPI_ImagesController_RecipePhotosResponse_H
...
namespace OpenAPI {
class OAIBigOven_Model_API2_Photo;

class OAIAPI2_Controllers_WebAPI_ImagesController_RecipePhotosResponse : public OAIObject {
public:
    OAIAPI2_Controllers_WebAPI_ImagesController_RecipePhotosResponse();
    OAIAPI2_Controllers_WebAPI_ImagesController_RecipePhotosResponse(QString json);
    ~OAIAPI2_Controllers_WebAPI_ImagesController_RecipePhotosResponse() override;
    ...
    QList<OAIBigOven_Model_API2_Photo> getResults() const;
    void setResults(const QList<OAIBigOven_Model_API2_Photo> &results);
...
private:
    ...
    QList<OAIBigOven_Model_API2_Photo> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Controllers_WebAPI_ImagesController_RecipePhotosResponse)

#endif // OAIAPI2_Controllers_WebAPI_ImagesController_RecipePhotosResponse_H
