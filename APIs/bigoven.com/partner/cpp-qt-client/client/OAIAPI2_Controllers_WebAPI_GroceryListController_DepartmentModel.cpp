...
OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel() {
    this->initializeModel();
}

OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::~OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel() {}

void OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::initializeModel() {

    m_items_isSet = false;
    m_items_isValid = false;
}

void OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::fromJson(QString jsonString) {
...
void OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::fromJsonObject(QJsonObject json) {

    m_items_isValid = ::OpenAPI::fromJsonValue(m_items, json[QString("items")]);
    m_items_isSet = !json[QString("items")].isNull() && m_items_isValid;
}

QString OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::asJson() const {
...
QJsonObject OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::asJsonObject() const {
    QJsonObject obj;
    if (m_items_isSet) {
...
QString OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::getItems() const {
    return m_items;
}
void OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::setItems(const QString &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::is_items_Set() const{
    return m_items_isSet;
}

bool OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::is_items_Valid() const{
    return m_items_isValid;
}

bool OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::isSet() const {
...
bool OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel::isValid() const {
