...
/*
 * OAIBigOven_Model_API_IngredientInfo.h
 *
 * 
 */

#ifndef OAIBigOven_Model_API_IngredientInfo_H
#define OAIBigOven_Model_API_IngredientInfo_H
...
class OAIBigOven_Model_API_IngredientInfo : public OAIObject {
public:
    OAIBigOven_Model_API_IngredientInfo();
    OAIBigOven_Model_API_IngredientInfo(QString json);
    ~OAIBigOven_Model_API_IngredientInfo() override;
    ...
    qint32 getMasterIngredientId() const;
    void setMasterIngredientId(const qint32 &master_ingredient_id);
    bool is_master_ingredient_id_Set() const;
    bool is_master_ingredient_id_Valid() const;
    ...
    bool isUsuallyOnHand() const;
    void setUsuallyOnHand(const bool &usually_on_hand);
    bool is_usually_on_hand_Set() const;
    bool is_usually_on_hand_Valid() const;
...
private:
    ...
    qint32 m_master_ingredient_id;
    bool m_master_ingredient_id_isSet;
    bool m_master_ingredient_id_isValid;

    QString m_name;
    bool m_name_isSet;
    bool m_name_isValid;

    bool m_usually_on_hand;
    bool m_usually_on_hand_isSet;
    bool m_usually_on_hand_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_API_IngredientInfo)

#endif // OAIBigOven_Model_API_IngredientInfo_H
