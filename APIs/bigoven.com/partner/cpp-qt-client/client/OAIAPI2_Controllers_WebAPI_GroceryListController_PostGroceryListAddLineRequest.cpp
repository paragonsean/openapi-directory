...
OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest() {
    this->initializeModel();
}

OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::~OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest() {}

void OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::initializeModel() {

    m_text_isSet = false;
    m_text_isValid = false;
}

void OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::fromJson(QString jsonString) {
...
void OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::fromJsonObject(QJsonObject json) {

    m_text_isValid = ::OpenAPI::fromJsonValue(m_text, json[QString("text")]);
    m_text_isSet = !json[QString("text")].isNull() && m_text_isValid;
}

QString OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::asJson() const {
...
QJsonObject OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_text_isSet) {
...
QString OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::getText() const {
    return m_text;
}
void OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::is_text_Set() const{
    return m_text_isSet;
}

bool OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::is_text_Valid() const{
    return m_text_isValid;
}

bool OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::isSet() const {
...
bool OAIAPI2_Controllers_WebAPI_GroceryListController_PostGroceryListAddLineRequest::isValid() const {
