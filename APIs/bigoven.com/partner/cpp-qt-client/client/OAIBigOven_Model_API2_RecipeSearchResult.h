...
/*
 * OAIBigOven_Model_API2_RecipeSearchResult.h
 *
 * 
 */

#ifndef OAIBigOven_Model_API2_RecipeSearchResult_H
#define OAIBigOven_Model_API2_RecipeSearchResult_H
...
class OAIBigOven_Model_API2_RecipeSearchResult : public OAIObject {
public:
    OAIBigOven_Model_API2_RecipeSearchResult();
    OAIBigOven_Model_API2_RecipeSearchResult(QString json);
    ~OAIBigOven_Model_API2_RecipeSearchResult() override;
    ...
    QString getSpellSuggest() const;
    void setSpellSuggest(const QString &spell_suggest);
    bool is_spell_suggest_Set() const;
    bool is_spell_suggest_Valid() const;
...
private:
    ...
    QString m_spell_suggest;
    bool m_spell_suggest_isSet;
    bool m_spell_suggest_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_API2_RecipeSearchResult)

#endif // OAIBigOven_Model_API2_RecipeSearchResult_H
