...
/*
 * OAIBigOven_Model_API_Grocery_GroceryList.h
 *
 * 
 */

#ifndef OAIBigOven_Model_API_Grocery_GroceryList_H
#define OAIBigOven_Model_API_Grocery_GroceryList_H
...
class OAIBigOven_Model_API_RecipeInfo;

class OAIBigOven_Model_API_Grocery_GroceryList : public OAIObject {
public:
    OAIBigOven_Model_API_Grocery_GroceryList();
    OAIBigOven_Model_API_Grocery_GroceryList(QString json);
    ~OAIBigOven_Model_API_Grocery_GroceryList() override;
    ...
    QList<OAIBigOven_Model_API_RecipeInfo> getRecipes() const;
    void setRecipes(const QList<OAIBigOven_Model_API_RecipeInfo> &recipes);
...
private:
    ...
    QList<OAIBigOven_Model_API_RecipeInfo> m_recipes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_API_Grocery_GroceryList)

#endif // OAIBigOven_Model_API_Grocery_GroceryList_H
