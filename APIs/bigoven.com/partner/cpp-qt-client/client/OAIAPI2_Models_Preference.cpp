...
OAIAPI2_Models_Preference::OAIAPI2_Models_Preference(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPI2_Models_Preference::OAIAPI2_Models_Preference() {
    this->initializeModel();
}

OAIAPI2_Models_Preference::~OAIAPI2_Models_Preference() {}

void OAIAPI2_Models_Preference::initializeModel() {

    m_eating_style_isSet = false;
    m_eating_style_isValid = false;
}

void OAIAPI2_Models_Preference::fromJson(QString jsonString) {
...
void OAIAPI2_Models_Preference::fromJsonObject(QJsonObject json) {

    m_eating_style_isValid = ::OpenAPI::fromJsonValue(m_eating_style, json[QString("EatingStyle")]);
    m_eating_style_isSet = !json[QString("EatingStyle")].isNull() && m_eating_style_isValid;
}

QString OAIAPI2_Models_Preference::asJson() const {
...
QJsonObject OAIAPI2_Models_Preference::asJsonObject() const {
    QJsonObject obj;
    if (m_eating_style_isSet) {
        obj.insert(QString("EatingStyle"), ::OpenAPI::toJsonValue(m_eating_style));
    }
    return obj;
}

QString OAIAPI2_Models_Preference::getEatingStyle() const {
    return m_eating_style;
}
void OAIAPI2_Models_Preference::setEatingStyle(const QString &eating_style) {
    m_eating_style = eating_style;
    m_eating_style_isSet = true;
}

bool OAIAPI2_Models_Preference::is_eating_style_Set() const{
    return m_eating_style_isSet;
}

bool OAIAPI2_Models_Preference::is_eating_style_Valid() const{
    return m_eating_style_isValid;
}

bool OAIAPI2_Models_Preference::isSet() const {
...
bool OAIAPI2_Models_Preference::isValid() const {
