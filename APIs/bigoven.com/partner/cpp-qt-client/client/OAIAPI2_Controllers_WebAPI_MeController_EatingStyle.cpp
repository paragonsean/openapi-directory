...
OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::OAIAPI2_Controllers_WebAPI_MeController_EatingStyle(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::OAIAPI2_Controllers_WebAPI_MeController_EatingStyle() {
    this->initializeModel();
}

OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::~OAIAPI2_Controllers_WebAPI_MeController_EatingStyle() {}

void OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::initializeModel() {

    m_options_isSet = false;
    m_options_isValid = false;
}

void OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::fromJson(QString jsonString) {
...
void OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::fromJsonObject(QJsonObject json) {

    m_options_isValid = ::OpenAPI::fromJsonValue(m_options, json[QString("Options")]);
    m_options_isSet = !json[QString("Options")].isNull() && m_options_isValid;
}

QString OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::asJson() const {
...
QJsonObject OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::asJsonObject() const {
    QJsonObject obj;
    if (m_options.size() > 0) {
...
QList<OAIAPI2_Controllers_WebAPI_MeController_Option> OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::getOptions() const {
    return m_options;
}
void OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::setOptions(const QList<OAIAPI2_Controllers_WebAPI_MeController_Option> &options) {
    m_options = options;
    m_options_isSet = true;
}

bool OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::is_options_Set() const{
    return m_options_isSet;
}

bool OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::is_options_Valid() const{
    return m_options_isValid;
}

bool OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::isSet() const {
...
bool OAIAPI2_Controllers_WebAPI_MeController_EatingStyle::isValid() const {
