...
OAIAPI2_Models_Personal::OAIAPI2_Models_Personal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAPI2_Models_Personal::OAIAPI2_Models_Personal() {
    this->initializeModel();
}

OAIAPI2_Models_Personal::~OAIAPI2_Models_Personal() {}

void OAIAPI2_Models_Personal::initializeModel() {
...
void OAIAPI2_Models_Personal::fromJson(QString jsonString) {
...
void OAIAPI2_Models_Personal::fromJsonObject(QJsonObject json) {
...
QString OAIAPI2_Models_Personal::asJson() const {
...
QJsonObject OAIAPI2_Models_Personal::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
...
QString OAIAPI2_Models_Personal::getEmail() const {
    return m_email;
}
void OAIAPI2_Models_Personal::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIAPI2_Models_Personal::is_email_Set() const{
    return m_email_isSet;
}

bool OAIAPI2_Models_Personal::is_email_Valid() const{
    return m_email_isValid;
}

OAIAPI2_Models_Location OAIAPI2_Models_Personal::getLocation() const {
    return m_location;
}
void OAIAPI2_Models_Personal::setLocation(const OAIAPI2_Models_Location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIAPI2_Models_Personal::is_location_Set() const{
    return m_location_isSet;
}

bool OAIAPI2_Models_Personal::is_location_Valid() const{
    return m_location_isValid;
}

bool OAIAPI2_Models_Personal::isSet() const {
...
bool OAIAPI2_Models_Personal::isValid() const {
