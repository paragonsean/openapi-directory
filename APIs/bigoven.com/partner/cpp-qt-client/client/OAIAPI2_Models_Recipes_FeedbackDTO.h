...
/*
 * OAIAPI2_Models_Recipes_FeedbackDTO.h
 *
 * 
 */

#ifndef OAIAPI2_Models_Recipes_FeedbackDTO_H
#define OAIAPI2_Models_Recipes_FeedbackDTO_H
...
class OAIAPI2_Models_Recipes_FeedbackDTO : public OAIObject {
public:
    OAIAPI2_Models_Recipes_FeedbackDTO();
    OAIAPI2_Models_Recipes_FeedbackDTO(QString json);
    ~OAIAPI2_Models_Recipes_FeedbackDTO() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Models_Recipes_FeedbackDTO)

#endif // OAIAPI2_Models_Recipes_FeedbackDTO_H
