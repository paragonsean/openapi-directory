...
OAIBigOven_Model_API_Recipe::OAIBigOven_Model_API_Recipe(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBigOven_Model_API_Recipe::OAIBigOven_Model_API_Recipe() {
    this->initializeModel();
}

OAIBigOven_Model_API_Recipe::~OAIBigOven_Model_API_Recipe() {}

void OAIBigOven_Model_API_Recipe::initializeModel() {
...
void OAIBigOven_Model_API_Recipe::fromJson(QString jsonString) {
...
void OAIBigOven_Model_API_Recipe::fromJsonObject(QJsonObject json) {
...
QString OAIBigOven_Model_API_Recipe::asJson() const {
...
QJsonObject OAIBigOven_Model_API_Recipe::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIBigOven_Model_API_Recipe::getActiveMinutes() const {
    return m_active_minutes;
}
void OAIBigOven_Model_API_Recipe::setActiveMinutes(const qint32 &active_minutes) {
    m_active_minutes = active_minutes;
    m_active_minutes_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_active_minutes_Set() const{
    return m_active_minutes_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_active_minutes_Valid() const{
    return m_active_minutes_isValid;
}

QString OAIBigOven_Model_API_Recipe::getAdTags() const {
    return m_ad_tags;
}
void OAIBigOven_Model_API_Recipe::setAdTags(const QString &ad_tags) {
    m_ad_tags = ad_tags;
    m_ad_tags_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_ad_tags_Set() const{
    return m_ad_tags_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_ad_tags_Valid() const{
    return m_ad_tags_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getAdminBoost() const {
    return m_admin_boost;
}
void OAIBigOven_Model_API_Recipe::setAdminBoost(const qint32 &admin_boost) {
    m_admin_boost = admin_boost;
    m_admin_boost_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_admin_boost_Set() const{
    return m_admin_boost_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_admin_boost_Valid() const{
    return m_admin_boost_isValid;
}

QString OAIBigOven_Model_API_Recipe::getAllCategoriesText() const {
    return m_all_categories_text;
}
void OAIBigOven_Model_API_Recipe::setAllCategoriesText(const QString &all_categories_text) {
    m_all_categories_text = all_categories_text;
    m_all_categories_text_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_all_categories_text_Set() const{
    return m_all_categories_text_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_all_categories_text_Valid() const{
    return m_all_categories_text_isValid;
}

QString OAIBigOven_Model_API_Recipe::getBookmarkImageUrl() const {
    return m_bookmark_image_url;
}
void OAIBigOven_Model_API_Recipe::setBookmarkImageUrl(const QString &bookmark_image_url) {
    m_bookmark_image_url = bookmark_image_url;
    m_bookmark_image_url_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_bookmark_image_url_Set() const{
    return m_bookmark_image_url_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_bookmark_image_url_Valid() const{
    return m_bookmark_image_url_isValid;
}

QString OAIBigOven_Model_API_Recipe::getBookmarkSiteLogo() const {
    return m_bookmark_site_logo;
}
void OAIBigOven_Model_API_Recipe::setBookmarkSiteLogo(const QString &bookmark_site_logo) {
    m_bookmark_site_logo = bookmark_site_logo;
    m_bookmark_site_logo_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_bookmark_site_logo_Set() const{
    return m_bookmark_site_logo_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_bookmark_site_logo_Valid() const{
    return m_bookmark_site_logo_isValid;
}

QString OAIBigOven_Model_API_Recipe::getBookmarkUrl() const {
    return m_bookmark_url;
}
void OAIBigOven_Model_API_Recipe::setBookmarkUrl(const QString &bookmark_url) {
    m_bookmark_url = bookmark_url;
    m_bookmark_url_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_bookmark_url_Set() const{
    return m_bookmark_url_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_bookmark_url_Valid() const{
    return m_bookmark_url_isValid;
}

QString OAIBigOven_Model_API_Recipe::getCategory() const {
    return m_category;
}
void OAIBigOven_Model_API_Recipe::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_category_Set() const{
    return m_category_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_category_Valid() const{
    return m_category_isValid;
}

QString OAIBigOven_Model_API_Recipe::getCollection() const {
    return m_collection;
}
void OAIBigOven_Model_API_Recipe::setCollection(const QString &collection) {
    m_collection = collection;
    m_collection_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_collection_Set() const{
    return m_collection_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_collection_Valid() const{
    return m_collection_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getCollectionId() const {
    return m_collection_id;
}
void OAIBigOven_Model_API_Recipe::setCollectionId(const qint32 &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QDateTime OAIBigOven_Model_API_Recipe::getCreationDate() const {
    return m_creation_date;
}
void OAIBigOven_Model_API_Recipe::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QString OAIBigOven_Model_API_Recipe::getCuisine() const {
    return m_cuisine;
}
void OAIBigOven_Model_API_Recipe::setCuisine(const QString &cuisine) {
    m_cuisine = cuisine;
    m_cuisine_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_cuisine_Set() const{
    return m_cuisine_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_cuisine_Valid() const{
    return m_cuisine_isValid;
}

QString OAIBigOven_Model_API_Recipe::getDescription() const {
    return m_description;
}
void OAIBigOven_Model_API_Recipe::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_description_Set() const{
    return m_description_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getFavoriteCount() const {
    return m_favorite_count;
}
void OAIBigOven_Model_API_Recipe::setFavoriteCount(const qint32 &favorite_count) {
    m_favorite_count = favorite_count;
    m_favorite_count_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_favorite_count_Set() const{
    return m_favorite_count_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_favorite_count_Valid() const{
    return m_favorite_count_isValid;
}

QString OAIBigOven_Model_API_Recipe::getHeroPhotoUrl() const {
    return m_hero_photo_url;
}
void OAIBigOven_Model_API_Recipe::setHeroPhotoUrl(const QString &hero_photo_url) {
    m_hero_photo_url = hero_photo_url;
    m_hero_photo_url_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_hero_photo_url_Set() const{
    return m_hero_photo_url_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_hero_photo_url_Valid() const{
    return m_hero_photo_url_isValid;
}

QList<qint32> OAIBigOven_Model_API_Recipe::getImageSquares() const {
    return m_image_squares;
}
void OAIBigOven_Model_API_Recipe::setImageSquares(const QList<qint32> &image_squares) {
    m_image_squares = image_squares;
    m_image_squares_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_image_squares_Set() const{
    return m_image_squares_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_image_squares_Valid() const{
    return m_image_squares_isValid;
}

QString OAIBigOven_Model_API_Recipe::getImageUrl() const {
    return m_image_url;
}
void OAIBigOven_Model_API_Recipe::setImageUrl(const QString &image_url) {
    m_image_url = image_url;
    m_image_url_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_image_url_Set() const{
    return m_image_url_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_image_url_Valid() const{
    return m_image_url_isValid;
}

QList<OAIBigOven_Model_API_Ingredient> OAIBigOven_Model_API_Recipe::getIngredients() const {
    return m_ingredients;
}
void OAIBigOven_Model_API_Recipe::setIngredients(const QList<OAIBigOven_Model_API_Ingredient> &ingredients) {
    m_ingredients = ingredients;
    m_ingredients_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_ingredients_Set() const{
    return m_ingredients_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_ingredients_Valid() const{
    return m_ingredients_isValid;
}

QString OAIBigOven_Model_API_Recipe::getIngredientsTextBlock() const {
    return m_ingredients_text_block;
}
void OAIBigOven_Model_API_Recipe::setIngredientsTextBlock(const QString &ingredients_text_block) {
    m_ingredients_text_block = ingredients_text_block;
    m_ingredients_text_block_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_ingredients_text_block_Set() const{
    return m_ingredients_text_block_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_ingredients_text_block_Valid() const{
    return m_ingredients_text_block_isValid;
}

QString OAIBigOven_Model_API_Recipe::getInstructions() const {
    return m_instructions;
}
void OAIBigOven_Model_API_Recipe::setInstructions(const QString &instructions) {
    m_instructions = instructions;
    m_instructions_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_instructions_Set() const{
    return m_instructions_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_instructions_Valid() const{
    return m_instructions_isValid;
}

bool OAIBigOven_Model_API_Recipe::isIsBookmark() const {
    return m_is_bookmark;
}
void OAIBigOven_Model_API_Recipe::setIsBookmark(const bool &is_bookmark) {
    m_is_bookmark = is_bookmark;
    m_is_bookmark_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_is_bookmark_Set() const{
    return m_is_bookmark_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_is_bookmark_Valid() const{
    return m_is_bookmark_isValid;
}

bool OAIBigOven_Model_API_Recipe::isIsPrivate() const {
    return m_is_private;
}
void OAIBigOven_Model_API_Recipe::setIsPrivate(const bool &is_private) {
    m_is_private = is_private;
    m_is_private_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_is_private_Set() const{
    return m_is_private_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_is_private_Valid() const{
    return m_is_private_isValid;
}

bool OAIBigOven_Model_API_Recipe::isIsRecipeScan() const {
    return m_is_recipe_scan;
}
void OAIBigOven_Model_API_Recipe::setIsRecipeScan(const bool &is_recipe_scan) {
    m_is_recipe_scan = is_recipe_scan;
    m_is_recipe_scan_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_is_recipe_scan_Set() const{
    return m_is_recipe_scan_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_is_recipe_scan_Valid() const{
    return m_is_recipe_scan_isValid;
}

bool OAIBigOven_Model_API_Recipe::isIsSponsored() const {
    return m_is_sponsored;
}
void OAIBigOven_Model_API_Recipe::setIsSponsored(const bool &is_sponsored) {
    m_is_sponsored = is_sponsored;
    m_is_sponsored_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_is_sponsored_Set() const{
    return m_is_sponsored_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_is_sponsored_Valid() const{
    return m_is_sponsored_isValid;
}

QDateTime OAIBigOven_Model_API_Recipe::getLastModified() const {
    return m_last_modified;
}
void OAIBigOven_Model_API_Recipe::setLastModified(const QDateTime &last_modified) {
    m_last_modified = last_modified;
    m_last_modified_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_last_modified_Set() const{
    return m_last_modified_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_last_modified_Valid() const{
    return m_last_modified_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getMaxImageSquare() const {
    return m_max_image_square;
}
void OAIBigOven_Model_API_Recipe::setMaxImageSquare(const qint32 &max_image_square) {
    m_max_image_square = max_image_square;
    m_max_image_square_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_max_image_square_Set() const{
    return m_max_image_square_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_max_image_square_Valid() const{
    return m_max_image_square_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getMedalCount() const {
    return m_medal_count;
}
void OAIBigOven_Model_API_Recipe::setMedalCount(const qint32 &medal_count) {
    m_medal_count = medal_count;
    m_medal_count_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_medal_count_Set() const{
    return m_medal_count_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_medal_count_Valid() const{
    return m_medal_count_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getMenuCount() const {
    return m_menu_count;
}
void OAIBigOven_Model_API_Recipe::setMenuCount(const qint32 &menu_count) {
    m_menu_count = menu_count;
    m_menu_count_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_menu_count_Set() const{
    return m_menu_count_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_menu_count_Valid() const{
    return m_menu_count_isValid;
}

QString OAIBigOven_Model_API_Recipe::getMicrocategory() const {
    return m_microcategory;
}
void OAIBigOven_Model_API_Recipe::setMicrocategory(const QString &microcategory) {
    m_microcategory = microcategory;
    m_microcategory_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_microcategory_Set() const{
    return m_microcategory_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_microcategory_Valid() const{
    return m_microcategory_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getNotesCount() const {
    return m_notes_count;
}
void OAIBigOven_Model_API_Recipe::setNotesCount(const qint32 &notes_count) {
    m_notes_count = notes_count;
    m_notes_count_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_notes_count_Set() const{
    return m_notes_count_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_notes_count_Valid() const{
    return m_notes_count_isValid;
}

OAIBigOven_Model_API_NutritionInfo OAIBigOven_Model_API_Recipe::getNutritionInfo() const {
    return m_nutrition_info;
}
void OAIBigOven_Model_API_Recipe::setNutritionInfo(const OAIBigOven_Model_API_NutritionInfo &nutrition_info) {
    m_nutrition_info = nutrition_info;
    m_nutrition_info_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_nutrition_info_Set() const{
    return m_nutrition_info_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_nutrition_info_Valid() const{
    return m_nutrition_info_isValid;
}

OAIBigOven_Model_API_UserInfo OAIBigOven_Model_API_Recipe::getPoster() const {
    return m_poster;
}
void OAIBigOven_Model_API_Recipe::setPoster(const OAIBigOven_Model_API_UserInfo &poster) {
    m_poster = poster;
    m_poster_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_poster_Set() const{
    return m_poster_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_poster_Valid() const{
    return m_poster_isValid;
}

QString OAIBigOven_Model_API_Recipe::getPrimaryIngredient() const {
    return m_primary_ingredient;
}
void OAIBigOven_Model_API_Recipe::setPrimaryIngredient(const QString &primary_ingredient) {
    m_primary_ingredient = primary_ingredient;
    m_primary_ingredient_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_primary_ingredient_Set() const{
    return m_primary_ingredient_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_primary_ingredient_Valid() const{
    return m_primary_ingredient_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getRecipeId() const {
    return m_recipe_id;
}
void OAIBigOven_Model_API_Recipe::setRecipeId(const qint32 &recipe_id) {
    m_recipe_id = recipe_id;
    m_recipe_id_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_recipe_id_Set() const{
    return m_recipe_id_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_recipe_id_Valid() const{
    return m_recipe_id_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getReviewCount() const {
    return m_review_count;
}
void OAIBigOven_Model_API_Recipe::setReviewCount(const qint32 &review_count) {
    m_review_count = review_count;
    m_review_count_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_review_count_Set() const{
    return m_review_count_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_review_count_Valid() const{
    return m_review_count_isValid;
}

double OAIBigOven_Model_API_Recipe::getStarRating() const {
    return m_star_rating;
}
void OAIBigOven_Model_API_Recipe::setStarRating(const double &star_rating) {
    m_star_rating = star_rating;
    m_star_rating_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_star_rating_Set() const{
    return m_star_rating_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_star_rating_Valid() const{
    return m_star_rating_isValid;
}

QString OAIBigOven_Model_API_Recipe::getSubcategory() const {
    return m_subcategory;
}
void OAIBigOven_Model_API_Recipe::setSubcategory(const QString &subcategory) {
    m_subcategory = subcategory;
    m_subcategory_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_subcategory_Set() const{
    return m_subcategory_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_subcategory_Valid() const{
    return m_subcategory_isValid;
}

QString OAIBigOven_Model_API_Recipe::getTitle() const {
    return m_title;
}
void OAIBigOven_Model_API_Recipe::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_title_Set() const{
    return m_title_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_title_Valid() const{
    return m_title_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getTotalMinutes() const {
    return m_total_minutes;
}
void OAIBigOven_Model_API_Recipe::setTotalMinutes(const qint32 &total_minutes) {
    m_total_minutes = total_minutes;
    m_total_minutes_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_total_minutes_Set() const{
    return m_total_minutes_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_total_minutes_Valid() const{
    return m_total_minutes_isValid;
}

qint32 OAIBigOven_Model_API_Recipe::getVariantOfRecipeId() const {
    return m_variant_of_recipe_id;
}
void OAIBigOven_Model_API_Recipe::setVariantOfRecipeId(const qint32 &variant_of_recipe_id) {
    m_variant_of_recipe_id = variant_of_recipe_id;
    m_variant_of_recipe_id_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_variant_of_recipe_id_Set() const{
    return m_variant_of_recipe_id_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_variant_of_recipe_id_Valid() const{
    return m_variant_of_recipe_id_isValid;
}

QString OAIBigOven_Model_API_Recipe::getVerifiedByClass() const {
    return m_verified_by_class;
}
void OAIBigOven_Model_API_Recipe::setVerifiedByClass(const QString &verified_by_class) {
    m_verified_by_class = verified_by_class;
    m_verified_by_class_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_verified_by_class_Set() const{
    return m_verified_by_class_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_verified_by_class_Valid() const{
    return m_verified_by_class_isValid;
}

QDateTime OAIBigOven_Model_API_Recipe::getVerifiedDateTime() const {
    return m_verified_date_time;
}
void OAIBigOven_Model_API_Recipe::setVerifiedDateTime(const QDateTime &verified_date_time) {
    m_verified_date_time = verified_date_time;
    m_verified_date_time_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_verified_date_time_Set() const{
    return m_verified_date_time_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_verified_date_time_Valid() const{
    return m_verified_date_time_isValid;
}

QString OAIBigOven_Model_API_Recipe::getWebUrl() const {
    return m_web_url;
}
void OAIBigOven_Model_API_Recipe::setWebUrl(const QString &web_url) {
    m_web_url = web_url;
    m_web_url_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_web_url_Set() const{
    return m_web_url_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_web_url_Valid() const{
    return m_web_url_isValid;
}

double OAIBigOven_Model_API_Recipe::getYieldNumber() const {
    return m_yield_number;
}
void OAIBigOven_Model_API_Recipe::setYieldNumber(const double &yield_number) {
    m_yield_number = yield_number;
    m_yield_number_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_yield_number_Set() const{
    return m_yield_number_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_yield_number_Valid() const{
    return m_yield_number_isValid;
}

QString OAIBigOven_Model_API_Recipe::getYieldUnit() const {
    return m_yield_unit;
}
void OAIBigOven_Model_API_Recipe::setYieldUnit(const QString &yield_unit) {
    m_yield_unit = yield_unit;
    m_yield_unit_isSet = true;
}

bool OAIBigOven_Model_API_Recipe::is_yield_unit_Set() const{
    return m_yield_unit_isSet;
}

bool OAIBigOven_Model_API_Recipe::is_yield_unit_Valid() const{
    return m_yield_unit_isValid;
}

bool OAIBigOven_Model_API_Recipe::isSet() const {
...
bool OAIBigOven_Model_API_Recipe::isValid() const {
