...
OAIBigOven_Model_API_RecipeNoteList::OAIBigOven_Model_API_RecipeNoteList(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBigOven_Model_API_RecipeNoteList::OAIBigOven_Model_API_RecipeNoteList() {
    this->initializeModel();
}

OAIBigOven_Model_API_RecipeNoteList::~OAIBigOven_Model_API_RecipeNoteList() {}

void OAIBigOven_Model_API_RecipeNoteList::initializeModel() {
...
void OAIBigOven_Model_API_RecipeNoteList::fromJson(QString jsonString) {
...
void OAIBigOven_Model_API_RecipeNoteList::fromJsonObject(QJsonObject json) {
...
QString OAIBigOven_Model_API_RecipeNoteList::asJson() const {
...
QJsonObject OAIBigOven_Model_API_RecipeNoteList::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIBigOven_Model_API_RecipeNoteList::getResultCount() const {
    return m_result_count;
}
void OAIBigOven_Model_API_RecipeNoteList::setResultCount(const qint32 &result_count) {
    m_result_count = result_count;
    m_result_count_isSet = true;
}

bool OAIBigOven_Model_API_RecipeNoteList::is_result_count_Set() const{
    return m_result_count_isSet;
}

bool OAIBigOven_Model_API_RecipeNoteList::is_result_count_Valid() const{
    return m_result_count_isValid;
}

QList<OAIBigOven_Model_API_RecipeNote> OAIBigOven_Model_API_RecipeNoteList::getResults() const {
    return m_results;
}
void OAIBigOven_Model_API_RecipeNoteList::setResults(const QList<OAIBigOven_Model_API_RecipeNote> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIBigOven_Model_API_RecipeNoteList::is_results_Set() const{
    return m_results_isSet;
}

bool OAIBigOven_Model_API_RecipeNoteList::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIBigOven_Model_API_RecipeNoteList::isSet() const {
...
bool OAIBigOven_Model_API_RecipeNoteList::isValid() const {
