...
/*
 * OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel.h
 *
 * 
 */

#ifndef OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel_H
#define OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel_H
...
class OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel : public OAIObject {
public:
    OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel();
    OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel(QString json);
    ~OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel)

#endif // OAIAPI2_Controllers_WebAPI_GroceryListController_DepartmentModel_H
