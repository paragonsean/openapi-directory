...
/*
 * OAIAPI2_Controllers_WebAPI_MeController_Option.h
 *
 * 
 */

#ifndef OAIAPI2_Controllers_WebAPI_MeController_Option_H
#define OAIAPI2_Controllers_WebAPI_MeController_Option_H
...
class OAIAPI2_Controllers_WebAPI_MeController_Option : public OAIObject {
public:
    OAIAPI2_Controllers_WebAPI_MeController_Option();
    OAIAPI2_Controllers_WebAPI_MeController_Option(QString json);
    ~OAIAPI2_Controllers_WebAPI_MeController_Option() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Controllers_WebAPI_MeController_Option)

#endif // OAIAPI2_Controllers_WebAPI_MeController_Option_H
