...
/*
 * OAIAPI2_Controllers_WebAPI_GroceryListController_UpdateItemByGuidRequest.h
 *
 * 
 */

#ifndef OAIAPI2_Controllers_WebAPI_GroceryListController_UpdateItemByGuidRequest_H
#define OAIAPI2_Controllers_WebAPI_GroceryListController_UpdateItemByGuidRequest_H
...
class OAIAPI2_Controllers_WebAPI_GroceryListController_UpdateItemByGuidRequest : public OAIObject {
public:
    OAIAPI2_Controllers_WebAPI_GroceryListController_UpdateItemByGuidRequest();
    OAIAPI2_Controllers_WebAPI_GroceryListController_UpdateItemByGuidRequest(QString json);
    ~OAIAPI2_Controllers_WebAPI_GroceryListController_UpdateItemByGuidRequest() override;
    ...
    bool is_ischecked_Set() const;
    bool is_ischecked_Valid() const;
...
private:
    ...
    bool m_ischecked;
    bool m_ischecked_isSet;
    bool m_ischecked_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Controllers_WebAPI_GroceryListController_UpdateItemByGuidRequest)

#endif // OAIAPI2_Controllers_WebAPI_GroceryListController_UpdateItemByGuidRequest_H
