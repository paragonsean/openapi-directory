...
/*
 * OAIAPI2_Controllers_WebAPI_MeController_PreferenceOptions.h
 *
 * 
 */

#ifndef OAIAPI2_Controllers_WebAPI_MeController_PreferenceOptions_H
#define OAIAPI2_Controllers_WebAPI_MeController_PreferenceOptions_H

#include <QJsonObject>

#include "OAIAPI2_Controllers_WebAPI_MeController_EatingStyle.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIAPI2_Controllers_WebAPI_MeController_EatingStyle;

class OAIAPI2_Controllers_WebAPI_MeController_PreferenceOptions : public OAIObject {
public:
    OAIAPI2_Controllers_WebAPI_MeController_PreferenceOptions();
    OAIAPI2_Controllers_WebAPI_MeController_PreferenceOptions(QString json);
    ~OAIAPI2_Controllers_WebAPI_MeController_PreferenceOptions() override;
    ...
    OAIAPI2_Controllers_WebAPI_MeController_EatingStyle getEatingStyle() const;
    void setEatingStyle(const OAIAPI2_Controllers_WebAPI_MeController_EatingStyle &eating_style);
    bool is_eating_style_Set() const;
    bool is_eating_style_Valid() const;
...
private:
    ...
    OAIAPI2_Controllers_WebAPI_MeController_EatingStyle m_eating_style;
    bool m_eating_style_isSet;
    bool m_eating_style_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Controllers_WebAPI_MeController_PreferenceOptions)

#endif // OAIAPI2_Controllers_WebAPI_MeController_PreferenceOptions_H
