...
/*
 * OAIBigOven_Model_API2_RecipeNote.h
 *
 * 
 */

#ifndef OAIBigOven_Model_API2_RecipeNote_H
#define OAIBigOven_Model_API2_RecipeNote_H
...
class OAIBigOven_Model_API2_RecipeNote : public OAIObject {
public:
    OAIBigOven_Model_API2_RecipeNote();
    OAIBigOven_Model_API2_RecipeNote(QString json);
    ~OAIBigOven_Model_API2_RecipeNote() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_API2_RecipeNote)

#endif // OAIBigOven_Model_API2_RecipeNote_H
