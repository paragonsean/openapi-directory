...
/*
 * OAIAPI2_Models_Recipes_RecipeVideoResponse.h
 *
 * DTO used to return the details of a recipe video
 */

#ifndef OAIAPI2_Models_Recipes_RecipeVideoResponse_H
#define OAIAPI2_Models_Recipes_RecipeVideoResponse_H
...
class OAIAPI2_Models_Recipes_RecipeVideoResponse : public OAIObject {
public:
    OAIAPI2_Models_Recipes_RecipeVideoResponse();
    OAIAPI2_Models_Recipes_RecipeVideoResponse(QString json);
    ~OAIAPI2_Models_Recipes_RecipeVideoResponse() override;
    ...
    QDateTime getInsertedOn() const;
    void setInsertedOn(const QDateTime &inserted_on);
    bool is_inserted_on_Set() const;
    bool is_inserted_on_Valid() const;

    bool isIsPrimaryVideo() const;
    void setIsPrimaryVideo(const bool &is_primary_video);
    bool is_is_primary_video_Set() const;
    bool is_is_primary_video_Valid() const;
    ...
    qint32 getVidId() const;
    void setVidId(const qint32 &vid_id);
    bool is_vid_id_Set() const;
    bool is_vid_id_Valid() const;
...
private:
    ...
    QDateTime m_inserted_on;
    bool m_inserted_on_isSet;
    bool m_inserted_on_isValid;

    bool m_is_primary_video;
    bool m_is_primary_video_isSet;
    bool m_is_primary_video_isValid;
    ...
    qint32 m_vid_id;
    bool m_vid_id_isSet;
    bool m_vid_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Models_Recipes_RecipeVideoResponse)

#endif // OAIAPI2_Models_Recipes_RecipeVideoResponse_H
