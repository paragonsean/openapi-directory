...
/*
 * OAIBigOven_Model_API_Recipe.h
 *
 * 
 */

#ifndef OAIBigOven_Model_API_Recipe_H
#define OAIBigOven_Model_API_Recipe_H
...
class OAIBigOven_Model_API_Recipe : public OAIObject {
public:
    OAIBigOven_Model_API_Recipe();
    OAIBigOven_Model_API_Recipe(QString json);
    ~OAIBigOven_Model_API_Recipe() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_API_Recipe)

#endif // OAIBigOven_Model_API_Recipe_H
