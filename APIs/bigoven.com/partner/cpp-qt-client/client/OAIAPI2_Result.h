...
#ifndef OAIAPI2_Result_H
#define OAIAPI2_Result_H
...
class OAIAPI2_Result : public OAIObject {
public:
    OAIAPI2_Result();
    OAIAPI2_Result(QString json);
    ~OAIAPI2_Result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Result)

#endif // OAIAPI2_Result_H
