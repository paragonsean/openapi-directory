...
/*
 * OAIBigOven_Model_API2_Photo.h
 *
 * 
 */

#ifndef OAIBigOven_Model_API2_Photo_H
#define OAIBigOven_Model_API2_Photo_H
...
class OAIBigOven_Model_API2_Photo : public OAIObject {
public:
    OAIBigOven_Model_API2_Photo();
    OAIBigOven_Model_API2_Photo(QString json);
    ~OAIBigOven_Model_API2_Photo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_API2_Photo)

#endif // OAIBigOven_Model_API2_Photo_H
