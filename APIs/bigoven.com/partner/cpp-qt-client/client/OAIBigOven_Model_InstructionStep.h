...
/*
 * OAIBigOven_Model_InstructionStep.h
 *
 * 
 */

#ifndef OAIBigOven_Model_InstructionStep_H
#define OAIBigOven_Model_InstructionStep_H
...
class OAIBigOven_Model_InstructionStep : public OAIObject {
public:
    OAIBigOven_Model_InstructionStep();
    OAIBigOven_Model_InstructionStep(QString json);
    ~OAIBigOven_Model_InstructionStep() override;
    ...
    qint32 getEndGantt() const;
    void setEndGantt(const qint32 &end_gantt);
    bool is_end_gantt_Set() const;
    bool is_end_gantt_Valid() const;

    qint32 getStartGantt() const;
    void setStartGantt(const qint32 &start_gantt);
    bool is_start_gantt_Set() const;
    bool is_start_gantt_Valid() const;
...
private:
    ...
    qint32 m_end_gantt;
    bool m_end_gantt_isSet;
    bool m_end_gantt_isValid;

    qint32 m_start_gantt;
    bool m_start_gantt_isSet;
    bool m_start_gantt_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBigOven_Model_InstructionStep)

#endif // OAIBigOven_Model_InstructionStep_H
