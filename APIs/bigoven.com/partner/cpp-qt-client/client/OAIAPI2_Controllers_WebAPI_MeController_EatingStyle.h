...
/*
 * OAIAPI2_Controllers_WebAPI_MeController_EatingStyle.h
 *
 * 
 */

#ifndef OAIAPI2_Controllers_WebAPI_MeController_EatingStyle_H
#define OAIAPI2_Controllers_WebAPI_MeController_EatingStyle_H
...
namespace OpenAPI {
class OAIAPI2_Controllers_WebAPI_MeController_Option;

class OAIAPI2_Controllers_WebAPI_MeController_EatingStyle : public OAIObject {
public:
    OAIAPI2_Controllers_WebAPI_MeController_EatingStyle();
    OAIAPI2_Controllers_WebAPI_MeController_EatingStyle(QString json);
    ~OAIAPI2_Controllers_WebAPI_MeController_EatingStyle() override;
    ...
    QList<OAIAPI2_Controllers_WebAPI_MeController_Option> getOptions() const;
    void setOptions(const QList<OAIAPI2_Controllers_WebAPI_MeController_Option> &options);
...
private:
    ...
    QList<OAIAPI2_Controllers_WebAPI_MeController_Option> m_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Controllers_WebAPI_MeController_EatingStyle)

#endif // OAIAPI2_Controllers_WebAPI_MeController_EatingStyle_H
