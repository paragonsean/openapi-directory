...
/*
 * OAIAPI2_Models_Accounting.h
 *
 * 
 */

#ifndef OAIAPI2_Models_Accounting_H
#define OAIAPI2_Models_Accounting_H
...
class OAIAPI2_Models_Accounting : public OAIObject {
public:
    OAIAPI2_Models_Accounting();
    OAIAPI2_Models_Accounting(QString json);
    ~OAIAPI2_Models_Accounting() override;
    ...
    qint32 getCreditBalance() const;
    void setCreditBalance(const qint32 &credit_balance);
    ...
    void setUserLevel(const QString &user_level);
    bool is_user_level_Set() const;
    bool is_user_level_Valid() const;
...
private:
    ...
    QString m_user_level;
    bool m_user_level_isSet;
    bool m_user_level_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Models_Accounting)

#endif // OAIAPI2_Models_Accounting_H
