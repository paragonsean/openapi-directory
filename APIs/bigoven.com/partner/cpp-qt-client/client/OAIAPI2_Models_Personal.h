...
/*
 * OAIAPI2_Models_Personal.h
 *
 * Personal level info -- email, location, etc.
 */

#ifndef OAIAPI2_Models_Personal_H
#define OAIAPI2_Models_Personal_H
...
namespace OpenAPI {
class OAIAPI2_Models_Location;

class OAIAPI2_Models_Personal : public OAIObject {
public:
    OAIAPI2_Models_Personal();
    OAIAPI2_Models_Personal(QString json);
    ~OAIAPI2_Models_Personal() override;
    ...
    OAIAPI2_Models_Location getLocation() const;
    void setLocation(const OAIAPI2_Models_Location &location);
...
private:
    ...
    OAIAPI2_Models_Location m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPI2_Models_Personal)

#endif // OAIAPI2_Models_Personal_H
