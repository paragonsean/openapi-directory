...
public class CollectionApiTest {
     ...
     */
    @Test
    public void collectionCollectionsTest() throws ApiException {
        String test = null;
        List<BigOvenModelAPI2CollectionInfo> response = api.collectionCollections(test);
     ...
     */
    @Test
    public void collectionGetCollectionTest() throws ApiException {
        Integer id = null;
        Integer rpp = null;
        Integer pg = null;
        Boolean test = null;
        String sessionForLogging = null;
        BigOvenModelAPI2RecipeSearchResult response = api.collectionGetCollection(id, rpp, pg, test, sessionForLogging);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void collectionGetCollectionMetaTest() throws ApiException {
        Integer id = null;
        BigOvenModelAPI2CollectionInfo response = api.collectionGetCollectionMeta(id);
        // TODO: test validations
    }
