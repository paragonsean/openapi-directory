...
public class API2GroceryListDepartmentResult {
  ...
  public API2GroceryListDepartmentResult() {
  }

  public API2GroceryListDepartmentResult dept(String dept) {
    this.dept = dept;
    return this;
  }
  ...
  public API2GroceryListDepartmentResult item(String item) {
    this.item = item;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    API2GroceryListDepartmentResult apI2GroceryListDepartmentResult = (API2GroceryListDepartmentResult) o;
    return Objects.equals(this.dept, apI2GroceryListDepartmentResult.dept) &&
        Objects.equals(this.item, apI2GroceryListDepartmentResult.item);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dept, item);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class API2GroceryListDepartmentResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to API2GroceryListDepartmentResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!API2GroceryListDepartmentResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in API2GroceryListDepartmentResult is not found in the empty JSON string", API2GroceryListDepartmentResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!API2GroceryListDepartmentResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `API2GroceryListDepartmentResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!API2GroceryListDepartmentResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'API2GroceryListDepartmentResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<API2GroceryListDepartmentResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(API2GroceryListDepartmentResult.class));

       return (TypeAdapter<T>) new TypeAdapter<API2GroceryListDepartmentResult>() {
           @Override
           public void write(JsonWriter out, API2GroceryListDepartmentResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public API2GroceryListDepartmentResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of API2GroceryListDepartmentResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of API2GroceryListDepartmentResult
   * @throws IOException if the JSON string is invalid with respect to API2GroceryListDepartmentResult
   */
  public static API2GroceryListDepartmentResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, API2GroceryListDepartmentResult.class);
  }

  /**
   * Convert an instance of API2GroceryListDepartmentResult to an JSON string
   *
   * @return JSON string
   */
