...
public class API2ModelsRecipesFeedbackDTO {
  ...
  public API2ModelsRecipesFeedbackDTO() {
  }

  public API2ModelsRecipesFeedbackDTO feedback(String feedback) {
  ...
  public boolean equals(Object o) {
    ...
    API2ModelsRecipesFeedbackDTO apI2ModelsRecipesFeedbackDTO = (API2ModelsRecipesFeedbackDTO) o;
    return Objects.equals(this.feedback, apI2ModelsRecipesFeedbackDTO.feedback);
  }
  ...
  public String toString() {
    ...
    sb.append("class API2ModelsRecipesFeedbackDTO {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to API2ModelsRecipesFeedbackDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!API2ModelsRecipesFeedbackDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in API2ModelsRecipesFeedbackDTO is not found in the empty JSON string", API2ModelsRecipesFeedbackDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!API2ModelsRecipesFeedbackDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `API2ModelsRecipesFeedbackDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!API2ModelsRecipesFeedbackDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'API2ModelsRecipesFeedbackDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<API2ModelsRecipesFeedbackDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(API2ModelsRecipesFeedbackDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<API2ModelsRecipesFeedbackDTO>() {
           @Override
           public void write(JsonWriter out, API2ModelsRecipesFeedbackDTO value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public API2ModelsRecipesFeedbackDTO read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of API2ModelsRecipesFeedbackDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of API2ModelsRecipesFeedbackDTO
   * @throws IOException if the JSON string is invalid with respect to API2ModelsRecipesFeedbackDTO
   */
  public static API2ModelsRecipesFeedbackDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, API2ModelsRecipesFeedbackDTO.class);
  }

  /**
   * Convert an instance of API2ModelsRecipesFeedbackDTO to an JSON string
   *
   * @return JSON string
   */
