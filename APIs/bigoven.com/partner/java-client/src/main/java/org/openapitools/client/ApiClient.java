...
public class ApiClient {
    ...
    private String basePath = "https://api2.bigoven.com";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("header", "X-BigOven-API-Key"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/partner/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api2.bigoven.com
