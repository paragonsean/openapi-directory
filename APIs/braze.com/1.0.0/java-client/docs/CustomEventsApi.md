...
<a id="customEventsAnalytics_0"></a>
# **customEventsAnalytics_0**
> customEventsAnalytics_0(event, length, unit, endingAt, appId, segmentId)
...
import org.openapitools.client.api.CustomEventsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.customEventsAnalytics_0(event, length, unit, endingAt, appId, segmentId);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomEventsApi#customEventsAnalytics_0");
...
<a id="customEventsList_0"></a>
# **customEventsList_0**
> customEventsList_0(page)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.customEventsList_0(page);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomEventsApi#customEventsList_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
