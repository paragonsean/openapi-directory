...
|------------- | ------------- | -------------|
| [**listUsersSubscriptionGroupSms_0**](SmsApi.md#listUsersSubscriptionGroupSms_0) | **GET** /subscription/user/status | List User&#39;s Subscription Group - SMS |
| [**listUsersSubscriptionGroupStatusSms_0**](SmsApi.md#listUsersSubscriptionGroupStatusSms_0) | **GET** /subscription/status/get | List User&#39;s  Subscription Group Status - SMS |


<a id="listUsersSubscriptionGroupSms_0"></a>
# **listUsersSubscriptionGroupSms_0**
> listUsersSubscriptionGroupSms_0(externalId, limit, offset, phone)
...
public class Example {
  public static void main(String[] args) {
    ...
    String externalId = "{{external_id}}"; // String | (Required*) String  The external_id of the user. Must include at least one and at most 50 `external_ids`.
    String limit = "100"; // String | (Optional) Integer  The limit on the maximum number of results returned. Default (and max) limit is 100.
    String offset = "1"; // String | (Optional) Integer  Number of templates to skip before returning rest of the templates that fit the search criteria.
    String phone = "+11112223333"; // String | (Required*) String  The phone number of the user (must include at least one phone number and at most 50 phone numbers). The recommendation is to provide this in the E.164 format. 
    try {
      apiInstance.listUsersSubscriptionGroupSms_0(externalId, limit, offset, phone);
    } catch (ApiException e) {
      System.err.println("Exception when calling SmsApi#listUsersSubscriptionGroupSms_0");
...
<a id="listUsersSubscriptionGroupStatusSms_0"></a>
# **listUsersSubscriptionGroupStatusSms_0**
> listUsersSubscriptionGroupStatusSms_0(subscriptionGroupId, externalId, phone)
...
public class Example {
  public static void main(String[] args) {
    ...
    SmsApi apiInstance = new SmsApi(defaultClient);
    String subscriptionGroupId = "{{subscription_group_id}}"; // String | (Required) String  The `id` of your subscription group.
    String externalId = "{{external_identifier}}"; // String | (Required*) String  The `external_id` of the user (must include at least one and at most 50 `external_ids`).  Only external_id or phone is accepted for SMS subscription groups 
    String phone = "+11112223333"; // String | (Required*) String  The phone number of the user (must include at least one phone number and at most 50 phone numbers). The recommendation is to provide this in the E.164 format.  Only external_id or phone is accepted for SMS subscription groups 
    try {
      apiInstance.listUsersSubscriptionGroupStatusSms_0(subscriptionGroupId, externalId, phone);
    } catch (ApiException e) {
      System.err.println("Exception when calling SmsApi#listUsersSubscriptionGroupStatusSms_0");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
