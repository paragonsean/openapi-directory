...
<a id="appSessionsByTime"></a>
# **appSessionsByTime**
> appSessionsByTime(length, unit, endingAt, appId, segmentId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.appSessionsByTime(length, unit, endingAt, appId, segmentId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#appSessionsByTime");
...
<a id="campaignAnalytics"></a>
# **campaignAnalytics**
> campaignAnalytics(campaignId, length, endingAt)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.campaignAnalytics(campaignId, length, endingAt);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#campaignAnalytics");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String campaignId = "{{campaign_identifier}}"; // String | (Required) String  Campaign API identifier
    try {
      apiInstance.campaignDetails(campaignId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#campaignDetails");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="campaignList"></a>
# **campaignList**
> campaignList(page, includeArchived, sortDirection, lastEditTimeGt)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.campaignList(page, includeArchived, sortDirection, lastEditTimeGt);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#campaignList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="canvasDataAnalyticsSummary"></a>
# **canvasDataAnalyticsSummary**
> canvasDataAnalyticsSummary(canvasId, endingAt, startingAt, length, includeVariantBreakdown, includeStepBreakdown, includeDeletedStepData)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.canvasDataAnalyticsSummary(canvasId, endingAt, startingAt, length, includeVariantBreakdown, includeStepBreakdown, includeDeletedStepData);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#canvasDataAnalyticsSummary");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="canvasDataSeriesAnalytics"></a>
# **canvasDataSeriesAnalytics**
> canvasDataSeriesAnalytics(canvasId, endingAt, startingAt, length, includeVariantBreakdown, includeStepBreakdown, includeDeletedStepData)
...
public class Example {
  public static void main(String[] args) {
    ...
    String includeDeletedStepData = "true"; // String | (Optional) Boolean  Whether or not to include step stats for deleted steps (defaults to false)
    try {
      apiInstance.canvasDataSeriesAnalytics(canvasId, endingAt, startingAt, length, includeVariantBreakdown, includeStepBreakdown, includeDeletedStepData);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#canvasDataSeriesAnalytics");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="canvasDetails"></a>
# **canvasDetails**
> canvasDetails(canvasId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.canvasDetails(canvasId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#canvasDetails");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="canvasList"></a>
# **canvasList**
> canvasList(page, includeArchived, sortDirection, lastEditTimeGt)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.canvasList(page, includeArchived, sortDirection, lastEditTimeGt);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#canvasList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="customEventsAnalytics"></a>
# **customEventsAnalytics**
> customEventsAnalytics(event, length, unit, endingAt, appId, segmentId)
...
public class Example {
  public static void main(String[] args) {
    ...
    ExportApi apiInstance = new ExportApi(defaultClient);
    String event = "event_name"; // String | (Required) String  The name of the custom event for which to return analytics 
    String length = "24"; // String | (Required) Integer  Max number of units (days or hours) before ending_at to include in the returned series - must be between 1 and 100 inclusive
    String unit = "hour"; // String | (Optional) String  Unit of time between data points - can be \"day\" or \"hour\" (defaults to \"day\")
    String endingAt = "2014-12-10T23:59:59-05:00"; // String | (Optional) DateTime (ISO 8601 string)  Point in time when the data series should end - defaults to time of the request
    String appId = "{{app_identifier}}"; // String | (Optional) String  App API identifier retrieved from the Developer Console to limit analytics to a specific app
    String segmentId = "{{segment_identifier}}"; // String | (Optional) String  Segment API identifier indicating the analytics enabled segment for which event analytics should be returned
    try {
      apiInstance.customEventsAnalytics(event, length, unit, endingAt, appId, segmentId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#customEventsAnalytics");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="customEventsList"></a>
# **customEventsList**
> customEventsList(page)
...
public class Example {
  public static void main(String[] args) {
    ...
    ExportApi apiInstance = new ExportApi(defaultClient);
    String page = "3"; // String | (Optional) Integer  The page of event names to return, defaults to 0 (returns the first set of up to 250)
    try {
      apiInstance.customEventsList(page);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#customEventsList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="dailyActiveUsersByDate"></a>
# **dailyActiveUsersByDate**
> dailyActiveUsersByDate(length, endingAt, appId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.dailyActiveUsersByDate(length, endingAt, appId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#dailyActiveUsersByDate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="dailyNewUsersByDate"></a>
# **dailyNewUsersByDate**
> dailyNewUsersByDate(length, endingAt, appId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String appId = "{{app_identifier}}"; // String | (Optional) String  App API identifier; if excluded, results for all apps in app group will be returned
    try {
      apiInstance.dailyNewUsersByDate(length, endingAt, appId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#dailyNewUsersByDate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="kpIsForDailyAppUninstallsByDate"></a>
# **kpIsForDailyAppUninstallsByDate**
> kpIsForDailyAppUninstallsByDate(length, endingAt, appId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String appId = "{{app_identifier}}"; // String | (Optional) String  App API identifier; if excluded, results for all apps in app group will be returned
    try {
      apiInstance.kpIsForDailyAppUninstallsByDate(length, endingAt, appId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#kpIsForDailyAppUninstallsByDate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="monthlyActiveUsersForLast30Days"></a>
# **monthlyActiveUsersForLast30Days**
> monthlyActiveUsersForLast30Days(length, endingAt, appId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String appId = "{{app_identifier}}"; // String | (Optional) String  App API identifier; if excluded, results for all apps in app group will be returned
    try {
      apiInstance.monthlyActiveUsersForLast30Days(length, endingAt, appId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#monthlyActiveUsersForLast30Days");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="newsFeedCardAnalytics"></a>
# **newsFeedCardAnalytics**
> newsFeedCardAnalytics(cardId, length, unit, endingAt)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.newsFeedCardAnalytics(cardId, length, unit, endingAt);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#newsFeedCardAnalytics");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="newsFeedCardsDetails"></a>
# **newsFeedCardsDetails**
> newsFeedCardsDetails(cardId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String cardId = "{{card_identifier}}"; // String | (Required) String  Card API identifier 
    try {
      apiInstance.newsFeedCardsDetails(cardId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#newsFeedCardsDetails");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="newsFeedCardsList"></a>
# **newsFeedCardsList**
> newsFeedCardsList(page, includeArchived, sortDirection)
...
public class Example {
  public static void main(String[] args) {
    ...
    String sortDirection = "desc"; // String | (Optional) String  Pass in the value `desc` to sort by creation time from newest to oldest. Pass in `asc` to sort from oldest to newest. If sort_direction is not included, the default order is oldest to newest.
    try {
      apiInstance.newsFeedCardsList(page, includeArchived, sortDirection);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#newsFeedCardsList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="segmentAnalytics"></a>
# **segmentAnalytics**
> segmentAnalytics(segmentId, length, endingAt)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.segmentAnalytics(segmentId, length, endingAt);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#segmentAnalytics");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String segmentId = "{{segment_identifier}}"; // String | (Required) String  Segment API identifier
    try {
      apiInstance.segmentDetails(segmentId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#segmentDetails");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="segmentList"></a>
# **segmentList**
> segmentList(page, sortDirection)
...
public class Example {
  public static void main(String[] args) {
    ...
    String sortDirection = "desc"; // String | (Optional) String  Pass in the value `desc` to sort by creation time from newest to oldest. Pass in `asc` to sort from oldest to newest. If `sort_direction` is not included, the default order is oldest to newest.
    try {
      apiInstance.segmentList(page, sortDirection);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#segmentList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="sendAnalytics"></a>
# **sendAnalytics**
> sendAnalytics(campaignId, sendId, length, endingAt)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.sendAnalytics(campaignId, sendId, length, endingAt);
    } catch (ApiException e) {
      System.err.println("Exception when calling ExportApi#sendAnalytics");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
