...
<a id="listAvailableContentBlocks"></a>
# **listAvailableContentBlocks**
> listAvailableContentBlocks(modifiedAfter, modifiedBefore, limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.listAvailableContentBlocks(modifiedAfter, modifiedBefore, limit, offset);
    } catch (ApiException e) {
      System.err.println("Exception when calling TemplatesApi#listAvailableContentBlocks");
...
<a id="listAvailableEmailTemplates"></a>
# **listAvailableEmailTemplates**
> listAvailableEmailTemplates(modifiedAfter, modifiedBefore, limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.listAvailableEmailTemplates(modifiedAfter, modifiedBefore, limit, offset);
    } catch (ApiException e) {
      System.err.println("Exception when calling TemplatesApi#listAvailableEmailTemplates");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="seeContentBlockInformation"></a>
# **seeContentBlockInformation**
> seeContentBlockInformation(contentBlockId, includeInclusionData)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.seeContentBlockInformation(contentBlockId, includeInclusionData);
    } catch (ApiException e) {
      System.err.println("Exception when calling TemplatesApi#seeContentBlockInformation");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="seeEmailTemplateInformation"></a>
# **seeEmailTemplateInformation**
> seeEmailTemplateInformation(emailTemplateId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.seeEmailTemplateInformation(emailTemplateId);
    } catch (ApiException e) {
      System.err.println("Exception when calling TemplatesApi#seeEmailTemplateInformation");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
