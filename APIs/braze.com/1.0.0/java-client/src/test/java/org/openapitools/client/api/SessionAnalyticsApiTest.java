...
/**
 * API tests for SessionAnalyticsApi
 */
@Disabled
public class SessionAnalyticsApiTest {

    private final SessionAnalyticsApi api = new SessionAnalyticsApi();
     ...
     */
    @Test
    public void appSessionsByTime_0Test() throws ApiException {
        String length = null;
        String unit = null;
        String endingAt = null;
        String appId = null;
        String segmentId = null;
        api.appSessionsByTime_0(length, unit, endingAt, appId, segmentId);
