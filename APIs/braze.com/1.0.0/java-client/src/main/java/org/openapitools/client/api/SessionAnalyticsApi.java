...
public class SessionAnalyticsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SessionAnalyticsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public SessionAnalyticsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for appSessionsByTime_0
     ...
     */
    public okhttp3.Call appSessionsByTime_0Call(String length, String unit, String endingAt, String appId, String segmentId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call appSessionsByTime_0ValidateBeforeCall(String length, String unit, String endingAt, String appId, String segmentId, final ApiCallback _callback) throws ApiException {
        return appSessionsByTime_0Call(length, unit, endingAt, appId, segmentId, _callback);
     ...
     */
    public void appSessionsByTime_0(String length, String unit, String endingAt, String appId, String segmentId) throws ApiException {
        appSessionsByTime_0WithHttpInfo(length, unit, endingAt, appId, segmentId);
    }
     ...
     */
    public ApiResponse<Void> appSessionsByTime_0WithHttpInfo(String length, String unit, String endingAt, String appId, String segmentId) throws ApiException {
        okhttp3.Call localVarCall = appSessionsByTime_0ValidateBeforeCall(length, unit, endingAt, appId, segmentId, null);
     ...
     */
    public okhttp3.Call appSessionsByTime_0Async(String length, String unit, String endingAt, String appId, String segmentId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = appSessionsByTime_0ValidateBeforeCall(length, unit, endingAt, appId, segmentId, _callback);
