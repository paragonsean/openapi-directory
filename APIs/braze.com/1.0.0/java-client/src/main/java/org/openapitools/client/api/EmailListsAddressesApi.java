...
public class EmailListsAddressesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public EmailListsAddressesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public EmailListsAddressesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for queryHardBouncedEmails
     * @param startDate (Optional*) String in YYYY-MM-DD format   Start date of the range to retrieve hard bounces, must be earlier than &#x60;end_date&#x60;. This is treated as midnight in UTC time by the API.  *You must provide either an &#x60;email&#x60; or a &#x60;start_date&#x60;, and an &#x60;end_date&#x60;.  (optional)
     * @param endDate (Optional*) String in YYYY-MM-DD format  String in YYYY-MM-DD format. End date of the range to retrieve hard bounces. This is treated as midnight in UTC time by the API.  *You must provide either an &#x60;email&#x60; or a &#x60;start_date&#x60;, and an &#x60;end_date&#x60;. (optional)
     * @param limit (Optional) Integer  Optional field to limit the number of results returned. Defaults to 100, maximum is 500. (optional)
     * @param offset (Optional) Integer  Optional beginning point in the list to retrieve from. (optional)
     * @param email (Optional*) String  If provided, we will return whether or not the user has hard bounced.  *You must provide either an &#x60;email&#x60; or a &#x60;start_date&#x60;, and an &#x60;end_date&#x60;. (optional)
     ...
     */
    public okhttp3.Call queryHardBouncedEmailsCall(String startDate, String endDate, String limit, String offset, String email, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/email/hard_bounces";
    ...
    private okhttp3.Call queryHardBouncedEmailsValidateBeforeCall(String startDate, String endDate, String limit, String offset, String email, final ApiCallback _callback) throws ApiException {
        return queryHardBouncedEmailsCall(startDate, endDate, limit, offset, email, _callback);
     ...
     */
    public void queryHardBouncedEmails(String startDate, String endDate, String limit, String offset, String email) throws ApiException {
        queryHardBouncedEmailsWithHttpInfo(startDate, endDate, limit, offset, email);
    }
     ...
     */
    public ApiResponse<Void> queryHardBouncedEmailsWithHttpInfo(String startDate, String endDate, String limit, String offset, String email) throws ApiException {
        okhttp3.Call localVarCall = queryHardBouncedEmailsValidateBeforeCall(startDate, endDate, limit, offset, email, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Query Hard Bounced Emails (asynchronously)
     * This endpoint allows you to pull a list of email addresses that have “hard bounced” your email messages within a certain time frame.  &gt; You must provide an &#x60;end_date&#x60;, as well as either an &#x60;email&#x60; or a &#x60;start_date&#x60;.&lt;br&gt;&lt;br&gt;If your date range has more than &#x60;limit&#x60; number of hard bounces, you will need to make multiple API calls, each time increasing the &#x60;offset&#x60; until a call returns either fewer than &#x60;limit&#x60; or zero results.  ## Response  Entries are listed in descending order.  &#x60;&#x60;&#x60;json Content-Type: application/json Authorization: Bearer YOUR-REST-API-KEY {   \&quot;emails\&quot;: [     {       \&quot;email\&quot;: \&quot;example1@braze.com\&quot;,       \&quot;hard_bounced_at\&quot;: \&quot;2016-08-25 15:24:32 +0000\&quot;     },     {       \&quot;email\&quot;: \&quot;example2@braze.com\&quot;,       \&quot;hard_bounced_at\&quot;: \&quot;2016-08-24 17:41:58 +0000\&quot;     },     {       \&quot;email\&quot;: \&quot;example3@braze.com\&quot;,       \&quot;hard_bounced_at\&quot;: \&quot;2016-08-24 12:01:13 +0000\&quot;     }   ],   \&quot;message\&quot;: \&quot;success\&quot; } &#x60;&#x60;&#x60;
     * @param startDate (Optional*) String in YYYY-MM-DD format   Start date of the range to retrieve hard bounces, must be earlier than &#x60;end_date&#x60;. This is treated as midnight in UTC time by the API.  *You must provide either an &#x60;email&#x60; or a &#x60;start_date&#x60;, and an &#x60;end_date&#x60;.  (optional)
     * @param endDate (Optional*) String in YYYY-MM-DD format  String in YYYY-MM-DD format. End date of the range to retrieve hard bounces. This is treated as midnight in UTC time by the API.  *You must provide either an &#x60;email&#x60; or a &#x60;start_date&#x60;, and an &#x60;end_date&#x60;. (optional)
     * @param limit (Optional) Integer  Optional field to limit the number of results returned. Defaults to 100, maximum is 500. (optional)
     ...
     */
    public okhttp3.Call queryHardBouncedEmailsAsync(String startDate, String endDate, String limit, String offset, String email, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryHardBouncedEmailsValidateBeforeCall(startDate, endDate, limit, offset, email, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for queryListOfUnsubscribedEmailAddresses
     * @param startDate (Optional*) String in YYYY-MM-DD format  Start date of the range to retrieve unsubscribes, must be earlier than end_date. This is treated as midnight in UTC time by the API. (optional)
     * @param endDate (Optional*)  String in YYYY-MM-DD format  End date of the range to retrieve unsubscribes. This is treated as midnight in UTC time by the API. (optional)
     * @param limit (Optional) Integer  Optional field to limit the number of results returned. Limit must be greater than 1. Defaults to 100, maximum is 500. (optional)
     * @param offset (Optional) Integer   Optional beginning point in the list to retrieve from (optional)
     * @param sortDirection (Optional) String  Pass in the value &#x60;asc&#x60; to sort unsubscribes from oldest to newest. Pass in &#x60;desc&#x60; to sort from newest to oldest. If sort_direction is not included, the default order is newest to oldest. (optional)
     * @param email (Optional*) String  If provided, we will return whether or not the user has unsubscribed (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call queryListOfUnsubscribedEmailAddressesCall(String startDate, String endDate, String limit, String offset, String sortDirection, String email, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/email/unsubscribes";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryListOfUnsubscribedEmailAddressesValidateBeforeCall(String startDate, String endDate, String limit, String offset, String sortDirection, String email, final ApiCallback _callback) throws ApiException {
        return queryListOfUnsubscribedEmailAddressesCall(startDate, endDate, limit, offset, sortDirection, email, _callback);
     ...
     */
    public void queryListOfUnsubscribedEmailAddresses(String startDate, String endDate, String limit, String offset, String sortDirection, String email) throws ApiException {
        queryListOfUnsubscribedEmailAddressesWithHttpInfo(startDate, endDate, limit, offset, sortDirection, email);
    }
     ...
     */
    public ApiResponse<Void> queryListOfUnsubscribedEmailAddressesWithHttpInfo(String startDate, String endDate, String limit, String offset, String sortDirection, String email) throws ApiException {
        okhttp3.Call localVarCall = queryListOfUnsubscribedEmailAddressesValidateBeforeCall(startDate, endDate, limit, offset, sortDirection, email, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Query List of Unsubscribed Email Addresses (asynchronously)
     * Use the /email/unsubscribes endpoint to return emails that have unsubscribed during the time period from &#x60;start_date&#x60; to &#x60;end_date&#x60;. You can use this endpoint to set up a bi-directional sync between Braze and other email systems or your own database.  &gt; You must provide either an email or a start_date and an end_date. &lt;br&gt;&lt;br&gt;If your date range has more than &#x60;limit&#x60; number of unsubscribes, you will need to make multiple API calls, each time increasing the &#x60;offset&#x60; until a call returns either fewer than &#x60;limit&#x60; or zero results.
     * @param startDate (Optional*) String in YYYY-MM-DD format  Start date of the range to retrieve unsubscribes, must be earlier than end_date. This is treated as midnight in UTC time by the API. (optional)
     * @param endDate (Optional*)  String in YYYY-MM-DD format  End date of the range to retrieve unsubscribes. This is treated as midnight in UTC time by the API. (optional)
     * @param limit (Optional) Integer  Optional field to limit the number of results returned. Limit must be greater than 1. Defaults to 100, maximum is 500. (optional)
     ...
     */
    public okhttp3.Call queryListOfUnsubscribedEmailAddressesAsync(String startDate, String endDate, String limit, String offset, String sortDirection, String email, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryListOfUnsubscribedEmailAddressesValidateBeforeCall(startDate, endDate, limit, offset, sortDirection, email, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
