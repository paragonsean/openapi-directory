...
public class ScheduleApiTriggeredCanvasesRequestAudience {
  public static final String SERIALIZED_NAME_A_N_D = "AND";
  @SerializedName(SERIALIZED_NAME_A_N_D)
  private List<ScheduleApiTriggeredCanvasesRequestAudienceANDInner> AND = new ArrayList<>();

  public ScheduleApiTriggeredCanvasesRequestAudience() {
  }

  public ScheduleApiTriggeredCanvasesRequestAudience AND(List<ScheduleApiTriggeredCanvasesRequestAudienceANDInner> AND) {
    this.AND = AND;
    return this;
  }

  public ScheduleApiTriggeredCanvasesRequestAudience addANDItem(ScheduleApiTriggeredCanvasesRequestAudienceANDInner ANDItem) {
    if (this.AND == null) {
  ...
  public List<ScheduleApiTriggeredCanvasesRequestAudienceANDInner> getAND() {
    return AND;
  }

  public void setAND(List<ScheduleApiTriggeredCanvasesRequestAudienceANDInner> AND) {
    this.AND = AND;
  }
  ...
  public boolean equals(Object o) {
    ...
    ScheduleApiTriggeredCanvasesRequestAudience scheduleApiTriggeredCanvasesRequestAudience = (ScheduleApiTriggeredCanvasesRequestAudience) o;
    return Objects.equals(this.AND, scheduleApiTriggeredCanvasesRequestAudience.AND);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleApiTriggeredCanvasesRequestAudience {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduleApiTriggeredCanvasesRequestAudience
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScheduleApiTriggeredCanvasesRequestAudience.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScheduleApiTriggeredCanvasesRequestAudience is not found in the empty JSON string", ScheduleApiTriggeredCanvasesRequestAudience.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduleApiTriggeredCanvasesRequestAudience.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduleApiTriggeredCanvasesRequestAudience` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("AND") != null && !jsonObj.get("AND").isJsonNull()) {
        ...
        if (jsonArrayAND != null) {
          ...
          for (int i = 0; i < jsonArrayAND.size(); i++) {
            ScheduleApiTriggeredCanvasesRequestAudienceANDInner.validateJsonElement(jsonArrayAND.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduleApiTriggeredCanvasesRequestAudience.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduleApiTriggeredCanvasesRequestAudience' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduleApiTriggeredCanvasesRequestAudience> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduleApiTriggeredCanvasesRequestAudience.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduleApiTriggeredCanvasesRequestAudience>() {
           @Override
           public void write(JsonWriter out, ScheduleApiTriggeredCanvasesRequestAudience value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScheduleApiTriggeredCanvasesRequestAudience read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScheduleApiTriggeredCanvasesRequestAudience given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduleApiTriggeredCanvasesRequestAudience
   * @throws IOException if the JSON string is invalid with respect to ScheduleApiTriggeredCanvasesRequestAudience
   */
  public static ScheduleApiTriggeredCanvasesRequestAudience fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduleApiTriggeredCanvasesRequestAudience.class);
  }

  /**
   * Convert an instance of ScheduleApiTriggeredCanvasesRequestAudience to an JSON string
   *
   * @return JSON string
   */
