...
async def list_users_subscription_group_sms(request: web.Request, external_id=None, limit=None, offset=None, phone=None) -> web.Response:
...
async def list_users_subscription_group_status_sms(request: web.Request, subscription_group_id=None, external_id=None, phone=None) -> web.Response:
