...
async def test_list_available_content_blocks_0(client):
    """Test case for list_available_content_blocks_0
...
async def test_see_content_block_information_0(client):
    """Test case for see_content_block_information_0
