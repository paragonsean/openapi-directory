...
/*
 * OAIScheduleApiTriggeredCanvases_request_recipients_inner.h
 *
 * 
 */

#ifndef OAIScheduleApiTriggeredCanvases_request_recipients_inner_H
#define OAIScheduleApiTriggeredCanvases_request_recipients_inner_H
...
class OAIScheduleApiTriggeredCanvases_request_recipients_inner : public OAIObject {
public:
    OAIScheduleApiTriggeredCanvases_request_recipients_inner();
    OAIScheduleApiTriggeredCanvases_request_recipients_inner(QString json);
    ~OAIScheduleApiTriggeredCanvases_request_recipients_inner() override;
    ...
    QString getTriggerProperties() const;
    void setTriggerProperties(const QString &trigger_properties);
    bool is_trigger_properties_Set() const;
    bool is_trigger_properties_Valid() const;

    QString getUserAlias() const;
    void setUserAlias(const QString &user_alias);
    bool is_user_alias_Set() const;
    bool is_user_alias_Valid() const;
...
private:
    ...
    QString m_trigger_properties;
    bool m_trigger_properties_isSet;
    bool m_trigger_properties_isValid;

    QString m_user_alias;
    bool m_user_alias_isSet;
    bool m_user_alias_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIScheduleApiTriggeredCanvases_request_recipients_inner)

#endif // OAIScheduleApiTriggeredCanvases_request_recipients_inner_H
