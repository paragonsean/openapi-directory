...
/*
 * OAIScheduleApiTriggeredCanvases_request.h
 *
 * 
 */

#ifndef OAIScheduleApiTriggeredCanvases_request_H
#define OAIScheduleApiTriggeredCanvases_request_H

#include <QJsonObject>

#include "OAIObject.h"
#include "OAIScheduleApiTriggeredCanvases_request_audience.h"
...
namespace OpenAPI {
class OAIScheduleApiTriggeredCanvases_request_audience;
class OAIScheduleApiTriggeredCanvases_request_recipients_inner;
class OAIScheduleApiTriggeredCanvases_request_schedule;

class OAIScheduleApiTriggeredCanvases_request : public OAIObject {
public:
    OAIScheduleApiTriggeredCanvases_request();
    OAIScheduleApiTriggeredCanvases_request(QString json);
    ~OAIScheduleApiTriggeredCanvases_request() override;
    ...
    OAIScheduleApiTriggeredCanvases_request_audience getAudience() const;
    void setAudience(const OAIScheduleApiTriggeredCanvases_request_audience &audience);
    ...
    OAIObject getCanvasEntryProperties() const;
    void setCanvasEntryProperties(const OAIObject &canvas_entry_properties);
    bool is_canvas_entry_properties_Set() const;
    bool is_canvas_entry_properties_Valid() const;

    QString getCanvasId() const;
    void setCanvasId(const QString &canvas_id);
    bool is_canvas_id_Set() const;
    bool is_canvas_id_Valid() const;

    QList<OAIScheduleApiTriggeredCanvases_request_recipients_inner> getRecipients() const;
    void setRecipients(const QList<OAIScheduleApiTriggeredCanvases_request_recipients_inner> &recipients);
    bool is_recipients_Set() const;
    bool is_recipients_Valid() const;

    OAIScheduleApiTriggeredCanvases_request_schedule getSchedule() const;
    void setSchedule(const OAIScheduleApiTriggeredCanvases_request_schedule &schedule);
...
private:
    ...
    OAIScheduleApiTriggeredCanvases_request_audience m_audience;
    ...
    OAIObject m_canvas_entry_properties;
    bool m_canvas_entry_properties_isSet;
    bool m_canvas_entry_properties_isValid;

    QString m_canvas_id;
    bool m_canvas_id_isSet;
    bool m_canvas_id_isValid;

    QList<OAIScheduleApiTriggeredCanvases_request_recipients_inner> m_recipients;
    bool m_recipients_isSet;
    bool m_recipients_isValid;

    OAIScheduleApiTriggeredCanvases_request_schedule m_schedule;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleApiTriggeredCanvases_request)

#endif // OAIScheduleApiTriggeredCanvases_request_H
