...
#include "OAIScheduleApiTriggeredCanvases_request_schedule.h"
...
OAIScheduleApiTriggeredCanvases_request_schedule::OAIScheduleApiTriggeredCanvases_request_schedule(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScheduleApiTriggeredCanvases_request_schedule::OAIScheduleApiTriggeredCanvases_request_schedule() {
    this->initializeModel();
}

OAIScheduleApiTriggeredCanvases_request_schedule::~OAIScheduleApiTriggeredCanvases_request_schedule() {}

void OAIScheduleApiTriggeredCanvases_request_schedule::initializeModel() {

    m_at_optimal_time_isSet = false;
    m_at_optimal_time_isValid = false;

    m_in_local_time_isSet = false;
    m_in_local_time_isValid = false;

    m_time_isSet = false;
    m_time_isValid = false;
}

void OAIScheduleApiTriggeredCanvases_request_schedule::fromJson(QString jsonString) {
...
void OAIScheduleApiTriggeredCanvases_request_schedule::fromJsonObject(QJsonObject json) {

    m_at_optimal_time_isValid = ::OpenAPI::fromJsonValue(m_at_optimal_time, json[QString("at_optimal_time")]);
    m_at_optimal_time_isSet = !json[QString("at_optimal_time")].isNull() && m_at_optimal_time_isValid;

    m_in_local_time_isValid = ::OpenAPI::fromJsonValue(m_in_local_time, json[QString("in_local_time")]);
    m_in_local_time_isSet = !json[QString("in_local_time")].isNull() && m_in_local_time_isValid;

    m_time_isValid = ::OpenAPI::fromJsonValue(m_time, json[QString("time")]);
    m_time_isSet = !json[QString("time")].isNull() && m_time_isValid;
}

QString OAIScheduleApiTriggeredCanvases_request_schedule::asJson() const {
...
QJsonObject OAIScheduleApiTriggeredCanvases_request_schedule::asJsonObject() const {
    QJsonObject obj;
    if (m_at_optimal_time_isSet) {
        obj.insert(QString("at_optimal_time"), ::OpenAPI::toJsonValue(m_at_optimal_time));
    }
    if (m_in_local_time_isSet) {
        obj.insert(QString("in_local_time"), ::OpenAPI::toJsonValue(m_in_local_time));
    }
    if (m_time_isSet) {
...
bool OAIScheduleApiTriggeredCanvases_request_schedule::isAtOptimalTime() const {
    return m_at_optimal_time;
}
void OAIScheduleApiTriggeredCanvases_request_schedule::setAtOptimalTime(const bool &at_optimal_time) {
    m_at_optimal_time = at_optimal_time;
    m_at_optimal_time_isSet = true;
}

bool OAIScheduleApiTriggeredCanvases_request_schedule::is_at_optimal_time_Set() const{
    return m_at_optimal_time_isSet;
}

bool OAIScheduleApiTriggeredCanvases_request_schedule::is_at_optimal_time_Valid() const{
    return m_at_optimal_time_isValid;
}

bool OAIScheduleApiTriggeredCanvases_request_schedule::isInLocalTime() const {
    return m_in_local_time;
}
void OAIScheduleApiTriggeredCanvases_request_schedule::setInLocalTime(const bool &in_local_time) {
    m_in_local_time = in_local_time;
    m_in_local_time_isSet = true;
}

bool OAIScheduleApiTriggeredCanvases_request_schedule::is_in_local_time_Set() const{
    return m_in_local_time_isSet;
}

bool OAIScheduleApiTriggeredCanvases_request_schedule::is_in_local_time_Valid() const{
    return m_in_local_time_isValid;
}

QString OAIScheduleApiTriggeredCanvases_request_schedule::getTime() const {
    return m_time;
}
void OAIScheduleApiTriggeredCanvases_request_schedule::setTime(const QString &time) {
    m_time = time;
    m_time_isSet = true;
}

bool OAIScheduleApiTriggeredCanvases_request_schedule::is_time_Set() const{
    return m_time_isSet;
}

bool OAIScheduleApiTriggeredCanvases_request_schedule::is_time_Valid() const{
    return m_time_isValid;
}

bool OAIScheduleApiTriggeredCanvases_request_schedule::isSet() const {
...
bool OAIScheduleApiTriggeredCanvases_request_schedule::isValid() const {
