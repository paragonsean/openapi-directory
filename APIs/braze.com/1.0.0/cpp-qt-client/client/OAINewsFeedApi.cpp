...
OAINewsFeedApi::OAINewsFeedApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAINewsFeedApi::~OAINewsFeedApi() {
}

void OAINewsFeedApi::initializeServerConfigs() {
    //Default server
...
*/
int OAINewsFeedApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAINewsFeedApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAINewsFeedApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAINewsFeedApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAINewsFeedApi::setUsername(const QString &username) {
    _username = username;
}

void OAINewsFeedApi::setPassword(const QString &password) {
    _password = password;
}


void OAINewsFeedApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAINewsFeedApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAINewsFeedApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAINewsFeedApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAINewsFeedApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAINewsFeedApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAINewsFeedApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAINewsFeedApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAINewsFeedApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAINewsFeedApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAINewsFeedApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAINewsFeedApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAINewsFeedApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAINewsFeedApi::newsFeedCardAnalytics(const ::OpenAPI::OptionalParam<QString> &card_id, const ::OpenAPI::OptionalParam<QString> &length, const ::OpenAPI::OptionalParam<QString> &unit, const ::OpenAPI::OptionalParam<QString> &ending_at) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINewsFeedApi::newsFeedCardAnalyticsCallback);
    connect(this, &OAINewsFeedApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAINewsFeedApi::newsFeedCardAnalyticsCallback(OAIHttpRequestWorker *worker) {
...
void OAINewsFeedApi::newsFeedCardsDetails(const ::OpenAPI::OptionalParam<QString> &card_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINewsFeedApi::newsFeedCardsDetailsCallback);
    connect(this, &OAINewsFeedApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAINewsFeedApi::newsFeedCardsDetailsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAINewsFeedApi::newsFeedCardsList(const ::OpenAPI::OptionalParam<QString> &page, const ::OpenAPI::OptionalParam<QString> &include_archived, const ::OpenAPI::OptionalParam<QString> &sort_direction) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINewsFeedApi::newsFeedCardsListCallback);
    connect(this, &OAINewsFeedApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAINewsFeedApi::newsFeedCardsListCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAINewsFeedApi::tokenAvailable(){
