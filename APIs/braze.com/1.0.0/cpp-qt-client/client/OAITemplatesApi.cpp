...
void OAITemplatesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("listAvailableContentBlocks", defaultConf);
    _serverIndices.insert("listAvailableContentBlocks", 0);
    _serverConfigs.insert("listAvailableEmailTemplates", defaultConf);
    _serverIndices.insert("listAvailableEmailTemplates", 0);
    _serverConfigs.insert("seeContentBlockInformation", defaultConf);
    _serverIndices.insert("seeContentBlockInformation", 0);
...
void OAITemplatesApi::listAvailableContentBlocks(const ::OpenAPI::OptionalParam<QString> &modified_after, const ::OpenAPI::OptionalParam<QString> &modified_before, const ::OpenAPI::OptionalParam<QString> &limit, const ::OpenAPI::OptionalParam<QString> &offset) {
    QString fullPath = QString(_serverConfigs["listAvailableContentBlocks"][_serverIndices.value("listAvailableContentBlocks")].URL()+"/content_blocks/list");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITemplatesApi::listAvailableContentBlocksCallback);
...
void OAITemplatesApi::listAvailableContentBlocksCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT listAvailableContentBlocksSignal();
        Q_EMIT listAvailableContentBlocksSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT listAvailableContentBlocksSignalE(error_type, error_str);
        Q_EMIT listAvailableContentBlocksSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT listAvailableContentBlocksSignalError(error_type, error_str);
        Q_EMIT listAvailableContentBlocksSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITemplatesApi::listAvailableEmailTemplates(const ::OpenAPI::OptionalParam<QString> &modified_after, const ::OpenAPI::OptionalParam<QString> &modified_before, const ::OpenAPI::OptionalParam<QString> &limit, const ::OpenAPI::OptionalParam<QString> &offset) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITemplatesApi::listAvailableEmailTemplatesCallback);
    connect(this, &OAITemplatesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITemplatesApi::listAvailableEmailTemplatesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAITemplatesApi::seeContentBlockInformation(const ::OpenAPI::OptionalParam<QString> &content_block_id, const ::OpenAPI::OptionalParam<QString> &include_inclusion_data) {
    QString fullPath = QString(_serverConfigs["seeContentBlockInformation"][_serverIndices.value("seeContentBlockInformation")].URL()+"/content_blocks/info");
    
    QString queryPrefix, querySuffix, queryDelimiter, queryStyle;
    if (content_block_id.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "content_block_id", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("content_block_id")).append(querySuffix).append(QUrl::toPercentEncoding(content_block_id.stringValue()));
    }
    if (include_inclusion_data.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "include_inclusion_data", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("include_inclusion_data")).append(querySuffix).append(QUrl::toPercentEncoding(include_inclusion_data.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITemplatesApi::seeContentBlockInformationCallback);
    connect(this, &OAITemplatesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITemplatesApi::seeContentBlockInformationCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT seeContentBlockInformationSignal();
        Q_EMIT seeContentBlockInformationSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT seeContentBlockInformationSignalE(error_type, error_str);
        Q_EMIT seeContentBlockInformationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT seeContentBlockInformationSignalError(error_type, error_str);
        Q_EMIT seeContentBlockInformationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITemplatesApi::seeEmailTemplateInformation(const ::OpenAPI::OptionalParam<QString> &email_template_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITemplatesApi::seeEmailTemplateInformationCallback);
    connect(this, &OAITemplatesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAITemplatesApi::seeEmailTemplateInformationCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
