...
#ifndef OAI_OAIScheduleMesagesApi_H
#define OAI_OAIScheduleMesagesApi_H
...
class OAIScheduleMesagesApi : public QObject {
    Q_OBJECT

public:
    OAIScheduleMesagesApi(const int timeOut = 0);
    ~OAIScheduleMesagesApi();
