...
#include "OAIScheduleMesagesApi.h"
...
OAIScheduleMesagesApi::OAIScheduleMesagesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIScheduleMesagesApi::~OAIScheduleMesagesApi() {
}

void OAIScheduleMesagesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("getUpcomingScheduledCampaignsAndCanvases", defaultConf);
    _serverIndices.insert("getUpcomingScheduledCampaignsAndCanvases", 0);
    _serverConfigs.insert("scheduleApiTriggeredCanvases", defaultConf);
    _serverIndices.insert("scheduleApiTriggeredCanvases", 0);
}
...
*/
int OAIScheduleMesagesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIScheduleMesagesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIScheduleMesagesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIScheduleMesagesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIScheduleMesagesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIScheduleMesagesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIScheduleMesagesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIScheduleMesagesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIScheduleMesagesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIScheduleMesagesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIScheduleMesagesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIScheduleMesagesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIScheduleMesagesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIScheduleMesagesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIScheduleMesagesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIScheduleMesagesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIScheduleMesagesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIScheduleMesagesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIScheduleMesagesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIScheduleMesagesApi::getUpcomingScheduledCampaignsAndCanvases(const ::OpenAPI::OptionalParam<QString> &end_time) {
    QString fullPath = QString(_serverConfigs["getUpcomingScheduledCampaignsAndCanvases"][_serverIndices.value("getUpcomingScheduledCampaignsAndCanvases")].URL()+"/messages/scheduled_broadcasts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScheduleMesagesApi::getUpcomingScheduledCampaignsAndCanvasesCallback);
    connect(this, &OAIScheduleMesagesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIScheduleMesagesApi::getUpcomingScheduledCampaignsAndCanvasesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getUpcomingScheduledCampaignsAndCanvasesSignal();
        Q_EMIT getUpcomingScheduledCampaignsAndCanvasesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getUpcomingScheduledCampaignsAndCanvasesSignalE(error_type, error_str);
        Q_EMIT getUpcomingScheduledCampaignsAndCanvasesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getUpcomingScheduledCampaignsAndCanvasesSignalError(error_type, error_str);
        Q_EMIT getUpcomingScheduledCampaignsAndCanvasesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScheduleMesagesApi::scheduleApiTriggeredCanvases(const ::OpenAPI::OptionalParam<OAIScheduleApiTriggeredCanvases_request> &oai_schedule_api_triggered_canvases_request) {
    QString fullPath = QString(_serverConfigs["scheduleApiTriggeredCanvases"][_serverIndices.value("scheduleApiTriggeredCanvases")].URL()+"/canvas/trigger/schedule/create");
    ...
    if (oai_schedule_api_triggered_canvases_request.hasValue()){

        
        QByteArray output = oai_schedule_api_triggered_canvases_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScheduleMesagesApi::scheduleApiTriggeredCanvasesCallback);
    connect(this, &OAIScheduleMesagesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIScheduleMesagesApi::scheduleApiTriggeredCanvasesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT scheduleApiTriggeredCanvasesSignal();
        Q_EMIT scheduleApiTriggeredCanvasesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT scheduleApiTriggeredCanvasesSignalE(error_type, error_str);
        Q_EMIT scheduleApiTriggeredCanvasesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT scheduleApiTriggeredCanvasesSignalError(error_type, error_str);
        Q_EMIT scheduleApiTriggeredCanvasesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScheduleMesagesApi::tokenAvailable(){
