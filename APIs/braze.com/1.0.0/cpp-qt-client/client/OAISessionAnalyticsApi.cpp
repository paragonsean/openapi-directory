...
#include "OAISessionAnalyticsApi.h"
...
OAISessionAnalyticsApi::OAISessionAnalyticsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAISessionAnalyticsApi::~OAISessionAnalyticsApi() {
}

void OAISessionAnalyticsApi::initializeServerConfigs() {
    //Default server
...
*/
int OAISessionAnalyticsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAISessionAnalyticsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAISessionAnalyticsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAISessionAnalyticsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAISessionAnalyticsApi::setUsername(const QString &username) {
    _username = username;
}

void OAISessionAnalyticsApi::setPassword(const QString &password) {
    _password = password;
}


void OAISessionAnalyticsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAISessionAnalyticsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAISessionAnalyticsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAISessionAnalyticsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAISessionAnalyticsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAISessionAnalyticsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAISessionAnalyticsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAISessionAnalyticsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAISessionAnalyticsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAISessionAnalyticsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAISessionAnalyticsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAISessionAnalyticsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAISessionAnalyticsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAISessionAnalyticsApi::appSessionsByTime(const ::OpenAPI::OptionalParam<QString> &length, const ::OpenAPI::OptionalParam<QString> &unit, const ::OpenAPI::OptionalParam<QString> &ending_at, const ::OpenAPI::OptionalParam<QString> &app_id, const ::OpenAPI::OptionalParam<QString> &segment_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISessionAnalyticsApi::appSessionsByTimeCallback);
    connect(this, &OAISessionAnalyticsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAISessionAnalyticsApi::appSessionsByTimeCallback(OAIHttpRequestWorker *worker) {
...
void OAISessionAnalyticsApi::tokenAvailable(){
