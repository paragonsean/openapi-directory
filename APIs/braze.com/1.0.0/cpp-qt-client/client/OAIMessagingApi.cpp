...
void OAIMessagingApi::getUpcomingScheduledCampaignsAndCanvases(const ::OpenAPI::OptionalParam<QString> &end_time) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMessagingApi::getUpcomingScheduledCampaignsAndCanvasesCallback);
...
void OAIMessagingApi::getUpcomingScheduledCampaignsAndCanvasesCallback(OAIHttpRequestWorker *worker) {
...
void OAIMessagingApi::scheduleApiTriggeredCanvases(const ::OpenAPI::OptionalParam<OAIScheduleApiTriggeredCanvases_request> &oai_schedule_api_triggered_canvases_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMessagingApi::scheduleApiTriggeredCanvasesCallback);
    connect(this, &OAIMessagingApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMessagingApi::scheduleApiTriggeredCanvasesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
