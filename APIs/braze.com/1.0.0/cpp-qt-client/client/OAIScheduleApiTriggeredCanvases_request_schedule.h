...
/*
 * OAIScheduleApiTriggeredCanvases_request_schedule.h
 *
 * 
 */

#ifndef OAIScheduleApiTriggeredCanvases_request_schedule_H
#define OAIScheduleApiTriggeredCanvases_request_schedule_H
...
class OAIScheduleApiTriggeredCanvases_request_schedule : public OAIObject {
public:
    OAIScheduleApiTriggeredCanvases_request_schedule();
    OAIScheduleApiTriggeredCanvases_request_schedule(QString json);
    ~OAIScheduleApiTriggeredCanvases_request_schedule() override;
    ...
    bool isAtOptimalTime() const;
    void setAtOptimalTime(const bool &at_optimal_time);
    bool is_at_optimal_time_Set() const;
    bool is_at_optimal_time_Valid() const;

    bool isInLocalTime() const;
    void setInLocalTime(const bool &in_local_time);
    bool is_in_local_time_Set() const;
    bool is_in_local_time_Valid() const;
...
private:
    ...
    bool m_at_optimal_time;
    bool m_at_optimal_time_isSet;
    bool m_at_optimal_time_isValid;

    bool m_in_local_time;
    bool m_in_local_time_isSet;
    bool m_in_local_time_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleApiTriggeredCanvases_request_schedule)

#endif // OAIScheduleApiTriggeredCanvases_request_schedule_H
