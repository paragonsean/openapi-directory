...
/*
 * OAIScheduleApiTriggeredCanvases_request_audience_AND_inner.h
 *
 * 
 */

#ifndef OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_H
#define OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_H

#include <QJsonObject>

#include "OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute;

class OAIScheduleApiTriggeredCanvases_request_audience_AND_inner : public OAIObject {
public:
    OAIScheduleApiTriggeredCanvases_request_audience_AND_inner();
    OAIScheduleApiTriggeredCanvases_request_audience_AND_inner(QString json);
    ~OAIScheduleApiTriggeredCanvases_request_audience_AND_inner() override;
    ...
    OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute getCustomAttribute() const;
    void setCustomAttribute(const OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute &custom_attribute);
    bool is_custom_attribute_Set() const;
    bool is_custom_attribute_Valid() const;
...
private:
    ...
    OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute m_custom_attribute;
    bool m_custom_attribute_isSet;
    bool m_custom_attribute_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIScheduleApiTriggeredCanvases_request_audience_AND_inner)

#endif // OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_H
