...
/*
 * OAIScheduleApiTriggeredCanvases_request_audience.h
 *
 * 
 */

#ifndef OAIScheduleApiTriggeredCanvases_request_audience_H
#define OAIScheduleApiTriggeredCanvases_request_audience_H

#include <QJsonObject>

#include "OAIScheduleApiTriggeredCanvases_request_audience_AND_inner.h"
#include <QList>
...
namespace OpenAPI {
class OAIScheduleApiTriggeredCanvases_request_audience_AND_inner;

class OAIScheduleApiTriggeredCanvases_request_audience : public OAIObject {
public:
    OAIScheduleApiTriggeredCanvases_request_audience();
    OAIScheduleApiTriggeredCanvases_request_audience(QString json);
    ~OAIScheduleApiTriggeredCanvases_request_audience() override;
    ...
    QList<OAIScheduleApiTriggeredCanvases_request_audience_AND_inner> getRAnd() const;
    void setRAnd(const QList<OAIScheduleApiTriggeredCanvases_request_audience_AND_inner> &r_and);
...
private:
    ...
    QList<OAIScheduleApiTriggeredCanvases_request_audience_AND_inner> m_r_and;
    bool m_r_and_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleApiTriggeredCanvases_request_audience)

#endif // OAIScheduleApiTriggeredCanvases_request_audience_H
