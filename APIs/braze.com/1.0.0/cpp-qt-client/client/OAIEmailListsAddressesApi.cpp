...
#include "OAIEmailListsAddressesApi.h"
...
OAIEmailListsAddressesApi::OAIEmailListsAddressesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIEmailListsAddressesApi::~OAIEmailListsAddressesApi() {
}

void OAIEmailListsAddressesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("queryHardBouncedEmails", defaultConf);
    _serverIndices.insert("queryHardBouncedEmails", 0);
    _serverConfigs.insert("queryListOfUnsubscribedEmailAddresses", defaultConf);
    _serverIndices.insert("queryListOfUnsubscribedEmailAddresses", 0);
}
...
*/
int OAIEmailListsAddressesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIEmailListsAddressesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIEmailListsAddressesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIEmailListsAddressesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIEmailListsAddressesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIEmailListsAddressesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIEmailListsAddressesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIEmailListsAddressesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIEmailListsAddressesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIEmailListsAddressesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEmailListsAddressesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEmailListsAddressesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIEmailListsAddressesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIEmailListsAddressesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIEmailListsAddressesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIEmailListsAddressesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIEmailListsAddressesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIEmailListsAddressesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIEmailListsAddressesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIEmailListsAddressesApi::queryHardBouncedEmails(const ::OpenAPI::OptionalParam<QString> &start_date, const ::OpenAPI::OptionalParam<QString> &end_date, const ::OpenAPI::OptionalParam<QString> &limit, const ::OpenAPI::OptionalParam<QString> &offset, const ::OpenAPI::OptionalParam<QString> &email) {
    QString fullPath = QString(_serverConfigs["queryHardBouncedEmails"][_serverIndices.value("queryHardBouncedEmails")].URL()+"/email/hard_bounces");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmailListsAddressesApi::queryHardBouncedEmailsCallback);
    connect(this, &OAIEmailListsAddressesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIEmailListsAddressesApi::queryHardBouncedEmailsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT queryHardBouncedEmailsSignal();
        Q_EMIT queryHardBouncedEmailsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT queryHardBouncedEmailsSignalE(error_type, error_str);
        Q_EMIT queryHardBouncedEmailsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT queryHardBouncedEmailsSignalError(error_type, error_str);
        Q_EMIT queryHardBouncedEmailsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmailListsAddressesApi::queryListOfUnsubscribedEmailAddresses(const ::OpenAPI::OptionalParam<QString> &start_date, const ::OpenAPI::OptionalParam<QString> &end_date, const ::OpenAPI::OptionalParam<QString> &limit, const ::OpenAPI::OptionalParam<QString> &offset, const ::OpenAPI::OptionalParam<QString> &sort_direction, const ::OpenAPI::OptionalParam<QString> &email) {
    QString fullPath = QString(_serverConfigs["queryListOfUnsubscribedEmailAddresses"][_serverIndices.value("queryListOfUnsubscribedEmailAddresses")].URL()+"/email/unsubscribes");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmailListsAddressesApi::queryListOfUnsubscribedEmailAddressesCallback);
    connect(this, &OAIEmailListsAddressesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmailListsAddressesApi::queryListOfUnsubscribedEmailAddressesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT queryListOfUnsubscribedEmailAddressesSignal();
        Q_EMIT queryListOfUnsubscribedEmailAddressesSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT queryListOfUnsubscribedEmailAddressesSignalE(error_type, error_str);
        Q_EMIT queryListOfUnsubscribedEmailAddressesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT queryListOfUnsubscribedEmailAddressesSignalError(error_type, error_str);
        Q_EMIT queryListOfUnsubscribedEmailAddressesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmailListsAddressesApi::tokenAvailable(){
