...
/*
 * OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute.h
 *
 * 
 */

#ifndef OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute_H
#define OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute_H
...
class OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute : public OAIObject {
public:
    OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute();
    OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute(QString json);
    ~OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute() override;
    ...
    QString getCustomAttributeName() const;
    void setCustomAttributeName(const QString &custom_attribute_name);
    bool is_custom_attribute_name_Set() const;
    bool is_custom_attribute_name_Valid() const;
...
private:
    ...
    QString m_custom_attribute_name;
    bool m_custom_attribute_name_isSet;
    bool m_custom_attribute_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute)

#endif // OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute_H
