...
OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::OAIScheduleApiTriggeredCanvases_request_audience_AND_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::OAIScheduleApiTriggeredCanvases_request_audience_AND_inner() {
    this->initializeModel();
}

OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::~OAIScheduleApiTriggeredCanvases_request_audience_AND_inner() {}

void OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::initializeModel() {

    m_custom_attribute_isSet = false;
    m_custom_attribute_isValid = false;
}

void OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::fromJson(QString jsonString) {
...
void OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::fromJsonObject(QJsonObject json) {

    m_custom_attribute_isValid = ::OpenAPI::fromJsonValue(m_custom_attribute, json[QString("custom_attribute")]);
    m_custom_attribute_isSet = !json[QString("custom_attribute")].isNull() && m_custom_attribute_isValid;
}

QString OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::asJson() const {
...
QJsonObject OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_custom_attribute.isSet()) {
        obj.insert(QString("custom_attribute"), ::OpenAPI::toJsonValue(m_custom_attribute));
    }
    return obj;
}

OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::getCustomAttribute() const {
    return m_custom_attribute;
}
void OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::setCustomAttribute(const OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute &custom_attribute) {
    m_custom_attribute = custom_attribute;
    m_custom_attribute_isSet = true;
}

bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::is_custom_attribute_Set() const{
    return m_custom_attribute_isSet;
}

bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::is_custom_attribute_Valid() const{
    return m_custom_attribute_isValid;
}

bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::isSet() const {
...
bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner::isValid() const {
