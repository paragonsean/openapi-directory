...
void OAISMSApi::listUsersSubscriptionGroupSms(const ::OpenAPI::OptionalParam<QString> &external_id, const ::OpenAPI::OptionalParam<QString> &limit, const ::OpenAPI::OptionalParam<QString> &offset, const ::OpenAPI::OptionalParam<QString> &phone) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISMSApi::listUsersSubscriptionGroupSmsCallback);
...
void OAISMSApi::listUsersSubscriptionGroupSmsCallback(OAIHttpRequestWorker *worker) {
...
void OAISMSApi::listUsersSubscriptionGroupStatusSms(const ::OpenAPI::OptionalParam<QString> &subscription_group_id, const ::OpenAPI::OptionalParam<QString> &external_id, const ::OpenAPI::OptionalParam<QString> &phone) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISMSApi::listUsersSubscriptionGroupStatusSmsCallback);
    connect(this, &OAISMSApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISMSApi::listUsersSubscriptionGroupStatusSmsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
