...
void OAICustomEventsApi::customEventsAnalytics(const ::OpenAPI::OptionalParam<QString> &event, const ::OpenAPI::OptionalParam<QString> &length, const ::OpenAPI::OptionalParam<QString> &unit, const ::OpenAPI::OptionalParam<QString> &ending_at, const ::OpenAPI::OptionalParam<QString> &app_id, const ::OpenAPI::OptionalParam<QString> &segment_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICustomEventsApi::customEventsAnalyticsCallback);
...
void OAICustomEventsApi::customEventsAnalyticsCallback(OAIHttpRequestWorker *worker) {
...
void OAICustomEventsApi::customEventsList(const ::OpenAPI::OptionalParam<QString> &page) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICustomEventsApi::customEventsListCallback);
    connect(this, &OAICustomEventsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICustomEventsApi::customEventsListCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
