...
#ifndef OAI_OAISessionAnalyticsApi_H
#define OAI_OAISessionAnalyticsApi_H
...
class OAISessionAnalyticsApi : public QObject {
    Q_OBJECT

public:
    OAISessionAnalyticsApi(const int timeOut = 0);
    ~OAISessionAnalyticsApi();
