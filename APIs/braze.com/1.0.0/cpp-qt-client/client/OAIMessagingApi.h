...
public:
    ...
    */
    virtual void getUpcomingScheduledCampaignsAndCanvases(const ::OpenAPI::OptionalParam<QString> &end_time = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  oai_schedule_api_triggered_canvases_request OAIScheduleApiTriggeredCanvases_request [optional]
    */
    virtual void scheduleApiTriggeredCanvases(const ::OpenAPI::OptionalParam<OAIScheduleApiTriggeredCanvases_request> &oai_schedule_api_triggered_canvases_request = ::OpenAPI::OptionalParam<OAIScheduleApiTriggeredCanvases_request>());
...
private:
    ...
    void getUpcomingScheduledCampaignsAndCanvasesCallback(OAIHttpRequestWorker *worker);
    void scheduleApiTriggeredCanvasesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getUpcomingScheduledCampaignsAndCanvasesSignal();
    void scheduleApiTriggeredCanvasesSignal();


    void getUpcomingScheduledCampaignsAndCanvasesSignalFull(OAIHttpRequestWorker *worker);
    void scheduleApiTriggeredCanvasesSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use getUpcomingScheduledCampaignsAndCanvasesSignalError() instead")
    void getUpcomingScheduledCampaignsAndCanvasesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void getUpcomingScheduledCampaignsAndCanvasesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use scheduleApiTriggeredCanvasesSignalError() instead")
    void scheduleApiTriggeredCanvasesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void scheduleApiTriggeredCanvasesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getUpcomingScheduledCampaignsAndCanvasesSignalErrorFull() instead")
    void getUpcomingScheduledCampaignsAndCanvasesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getUpcomingScheduledCampaignsAndCanvasesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use scheduleApiTriggeredCanvasesSignalErrorFull() instead")
    void scheduleApiTriggeredCanvasesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void scheduleApiTriggeredCanvasesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
