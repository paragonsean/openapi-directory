...
#ifndef OAI_OAISubscriptionGroupsApi_H
#define OAI_OAISubscriptionGroupsApi_H
...
class OAISubscriptionGroupsApi : public QObject {
    Q_OBJECT

public:
    OAISubscriptionGroupsApi(const int timeOut = 0);
    ~OAISubscriptionGroupsApi();
    ...
    */
    virtual void listUsersSubscriptionGroupSms(const ::OpenAPI::OptionalParam<QString> &external_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &limit = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &offset = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &phone = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  subscription_group_id QString [optional]
    * @param[in]  external_id QString [optional]
    * @param[in]  phone QString [optional]
    */
    virtual void listUsersSubscriptionGroupStatusSms(const ::OpenAPI::OptionalParam<QString> &subscription_group_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &external_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &phone = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void listUsersSubscriptionGroupSmsCallback(OAIHttpRequestWorker *worker);
    void listUsersSubscriptionGroupStatusSmsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void listUsersSubscriptionGroupSmsSignal();
    void listUsersSubscriptionGroupStatusSmsSignal();


    void listUsersSubscriptionGroupSmsSignalFull(OAIHttpRequestWorker *worker);
    void listUsersSubscriptionGroupStatusSmsSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use listUsersSubscriptionGroupSmsSignalError() instead")
    void listUsersSubscriptionGroupSmsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void listUsersSubscriptionGroupSmsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use listUsersSubscriptionGroupStatusSmsSignalError() instead")
    void listUsersSubscriptionGroupStatusSmsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void listUsersSubscriptionGroupStatusSmsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use listUsersSubscriptionGroupSmsSignalErrorFull() instead")
    void listUsersSubscriptionGroupSmsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void listUsersSubscriptionGroupSmsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use listUsersSubscriptionGroupStatusSmsSignalErrorFull() instead")
    void listUsersSubscriptionGroupStatusSmsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void listUsersSubscriptionGroupStatusSmsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
