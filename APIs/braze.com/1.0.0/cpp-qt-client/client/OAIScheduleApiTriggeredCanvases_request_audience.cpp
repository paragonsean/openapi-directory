...
OAIScheduleApiTriggeredCanvases_request_audience::OAIScheduleApiTriggeredCanvases_request_audience(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScheduleApiTriggeredCanvases_request_audience::OAIScheduleApiTriggeredCanvases_request_audience() {
    this->initializeModel();
}

OAIScheduleApiTriggeredCanvases_request_audience::~OAIScheduleApiTriggeredCanvases_request_audience() {}

void OAIScheduleApiTriggeredCanvases_request_audience::initializeModel() {

    m_r_and_isSet = false;
    m_r_and_isValid = false;
}

void OAIScheduleApiTriggeredCanvases_request_audience::fromJson(QString jsonString) {
...
void OAIScheduleApiTriggeredCanvases_request_audience::fromJsonObject(QJsonObject json) {

    m_r_and_isValid = ::OpenAPI::fromJsonValue(m_r_and, json[QString("AND")]);
    m_r_and_isSet = !json[QString("AND")].isNull() && m_r_and_isValid;
}

QString OAIScheduleApiTriggeredCanvases_request_audience::asJson() const {
...
QJsonObject OAIScheduleApiTriggeredCanvases_request_audience::asJsonObject() const {
    QJsonObject obj;
    if (m_r_and.size() > 0) {
...
QList<OAIScheduleApiTriggeredCanvases_request_audience_AND_inner> OAIScheduleApiTriggeredCanvases_request_audience::getRAnd() const {
    return m_r_and;
}
void OAIScheduleApiTriggeredCanvases_request_audience::setRAnd(const QList<OAIScheduleApiTriggeredCanvases_request_audience_AND_inner> &r_and) {
    m_r_and = r_and;
    m_r_and_isSet = true;
}

bool OAIScheduleApiTriggeredCanvases_request_audience::is_r_and_Set() const{
    return m_r_and_isSet;
}

bool OAIScheduleApiTriggeredCanvases_request_audience::is_r_and_Valid() const{
    return m_r_and_isValid;
}

bool OAIScheduleApiTriggeredCanvases_request_audience::isSet() const {
...
bool OAIScheduleApiTriggeredCanvases_request_audience::isValid() const {
