...
OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute() {
    this->initializeModel();
}

OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::~OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute() {}

void OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::initializeModel() {

    m_comparison_isSet = false;
    m_comparison_isValid = false;

    m_custom_attribute_name_isSet = false;
    m_custom_attribute_name_isValid = false;

    m_value_isSet = false;
    m_value_isValid = false;
}

void OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::fromJson(QString jsonString) {
...
void OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::fromJsonObject(QJsonObject json) {
    ...
    m_custom_attribute_name_isValid = ::OpenAPI::fromJsonValue(m_custom_attribute_name, json[QString("custom_attribute_name")]);
    m_custom_attribute_name_isSet = !json[QString("custom_attribute_name")].isNull() && m_custom_attribute_name_isValid;

    m_value_isValid = ::OpenAPI::fromJsonValue(m_value, json[QString("value")]);
    m_value_isSet = !json[QString("value")].isNull() && m_value_isValid;
}

QString OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::asJson() const {
...
QJsonObject OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::asJsonObject() const {
    QJsonObject obj;
    if (m_comparison_isSet) {
        obj.insert(QString("comparison"), ::OpenAPI::toJsonValue(m_comparison));
    }
    if (m_custom_attribute_name_isSet) {
        obj.insert(QString("custom_attribute_name"), ::OpenAPI::toJsonValue(m_custom_attribute_name));
    }
    if (m_value_isSet) {
...
QString OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::getComparison() const {
    return m_comparison;
}
void OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::setComparison(const QString &comparison) {
    m_comparison = comparison;
    m_comparison_isSet = true;
}

bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::is_comparison_Set() const{
    return m_comparison_isSet;
}

bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::is_comparison_Valid() const{
    return m_comparison_isValid;
}

QString OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::getCustomAttributeName() const {
    return m_custom_attribute_name;
}
void OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::setCustomAttributeName(const QString &custom_attribute_name) {
    m_custom_attribute_name = custom_attribute_name;
    m_custom_attribute_name_isSet = true;
}

bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::is_custom_attribute_name_Set() const{
    return m_custom_attribute_name_isSet;
}

bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::is_custom_attribute_name_Valid() const{
    return m_custom_attribute_name_isValid;
}

QString OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::getValue() const {
    return m_value;
}
void OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::is_value_Set() const{
    return m_value_isSet;
}

bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::isSet() const {
...
bool OAIScheduleApiTriggeredCanvases_request_audience_AND_inner_custom_attribute::isValid() const {
