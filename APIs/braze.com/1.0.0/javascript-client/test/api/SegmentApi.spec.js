...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.SegmentApi();
  });
  ...
  describe('SegmentApi', function() {
    describe('segmentAnalytics_0', function() {
      it('should call segmentAnalytics_0 successfully', function(done) {
        //uncomment below and update the code to test segmentAnalytics_0
        //instance.segmentAnalytics_0(function(error) {
    ...
    describe('segmentDetails_0', function() {
      it('should call segmentDetails_0 successfully', function(done) {
        //uncomment below and update the code to test segmentDetails_0
        //instance.segmentDetails_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('segmentList_0', function() {
      it('should call segmentList_0 successfully', function(done) {
        //uncomment below and update the code to test segmentList_0
        //instance.segmentList_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
