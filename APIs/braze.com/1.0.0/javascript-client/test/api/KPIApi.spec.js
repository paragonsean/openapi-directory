...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.KPIApi();
  });
  ...
  describe('KPIApi', function() {
    describe('dailyActiveUsersByDate_0', function() {
      it('should call dailyActiveUsersByDate_0 successfully', function(done) {
        //uncomment below and update the code to test dailyActiveUsersByDate_0
        //instance.dailyActiveUsersByDate_0(function(error) {
    ...
    describe('dailyNewUsersByDate_0', function() {
      it('should call dailyNewUsersByDate_0 successfully', function(done) {
        //uncomment below and update the code to test dailyNewUsersByDate_0
        //instance.dailyNewUsersByDate_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('kpIsForDailyAppUninstallsByDate_0', function() {
      it('should call kpIsForDailyAppUninstallsByDate_0 successfully', function(done) {
        //uncomment below and update the code to test kpIsForDailyAppUninstallsByDate_0
        //instance.kpIsForDailyAppUninstallsByDate_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('monthlyActiveUsersForLast30Days_0', function() {
      it('should call monthlyActiveUsersForLast30Days_0 successfully', function(done) {
        //uncomment below and update the code to test monthlyActiveUsersForLast30Days_0
        //instance.monthlyActiveUsersForLast30Days_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
