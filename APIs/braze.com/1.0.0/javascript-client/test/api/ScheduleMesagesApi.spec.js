...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.ScheduleMesagesApi();
  });
  ...
  describe('ScheduleMesagesApi', function() {
    describe('getUpcomingScheduledCampaignsAndCanvases_0', function() {
      it('should call getUpcomingScheduledCampaignsAndCanvases_0 successfully', function(done) {
        //uncomment below and update the code to test getUpcomingScheduledCampaignsAndCanvases_0
        //instance.getUpcomingScheduledCampaignsAndCanvases_0(function(error) {
    ...
    describe('scheduleApiTriggeredCanvases_0', function() {
      it('should call scheduleApiTriggeredCanvases_0 successfully', function(done) {
        //uncomment below and update the code to test scheduleApiTriggeredCanvases_0
        //instance.scheduleApiTriggeredCanvases_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
