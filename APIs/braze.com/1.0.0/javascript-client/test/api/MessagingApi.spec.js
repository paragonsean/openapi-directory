...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.MessagingApi();
  });
  ...
  describe('MessagingApi', function() {
    describe('getUpcomingScheduledCampaignsAndCanvases', function() {
      it('should call getUpcomingScheduledCampaignsAndCanvases successfully', function(done) {
        //uncomment below and update the code to test getUpcomingScheduledCampaignsAndCanvases
        //instance.getUpcomingScheduledCampaignsAndCanvases(function(error) {
    ...
    describe('scheduleApiTriggeredCanvases', function() {
      it('should call scheduleApiTriggeredCanvases successfully', function(done) {
        //uncomment below and update the code to test scheduleApiTriggeredCanvases
        //instance.scheduleApiTriggeredCanvases(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
