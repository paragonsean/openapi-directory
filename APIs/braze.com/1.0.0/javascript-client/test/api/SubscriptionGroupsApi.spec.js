...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.SubscriptionGroupsApi();
  });
  ...
  describe('SubscriptionGroupsApi', function() {
    describe('listUsersSubscriptionGroupSms', function() {
      it('should call listUsersSubscriptionGroupSms successfully', function(done) {
        //uncomment below and update the code to test listUsersSubscriptionGroupSms
        //instance.listUsersSubscriptionGroupSms(function(error) {
    ...
    describe('listUsersSubscriptionGroupStatusSms', function() {
      it('should call listUsersSubscriptionGroupStatusSms successfully', function(done) {
        //uncomment below and update the code to test listUsersSubscriptionGroupStatusSms
        //instance.listUsersSubscriptionGroupStatusSms(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
