...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.CustomEventsApi();
  });
  ...
  describe('CustomEventsApi', function() {
    describe('customEventsAnalytics_0', function() {
      it('should call customEventsAnalytics_0 successfully', function(done) {
        //uncomment below and update the code to test customEventsAnalytics_0
        //instance.customEventsAnalytics_0(function(error) {
    ...
    describe('customEventsList_0', function() {
      it('should call customEventsList_0 successfully', function(done) {
        //uncomment below and update the code to test customEventsList_0
        //instance.customEventsList_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
