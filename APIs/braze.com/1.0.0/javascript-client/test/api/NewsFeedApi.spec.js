...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.NewsFeedApi();
  });
  ...
  describe('NewsFeedApi', function() {
    describe('newsFeedCardAnalytics_0', function() {
      it('should call newsFeedCardAnalytics_0 successfully', function(done) {
        //uncomment below and update the code to test newsFeedCardAnalytics_0
        //instance.newsFeedCardAnalytics_0(function(error) {
    ...
    describe('newsFeedCardsDetails_0', function() {
      it('should call newsFeedCardsDetails_0 successfully', function(done) {
        //uncomment below and update the code to test newsFeedCardsDetails_0
        //instance.newsFeedCardsDetails_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('newsFeedCardsList_0', function() {
      it('should call newsFeedCardsList_0 successfully', function(done) {
        //uncomment below and update the code to test newsFeedCardsList_0
        //instance.newsFeedCardsList_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
