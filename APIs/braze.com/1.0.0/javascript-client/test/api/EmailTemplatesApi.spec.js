...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.EmailTemplatesApi();
  });
  ...
  describe('EmailTemplatesApi', function() {
    describe('listAvailableEmailTemplates_0', function() {
      it('should call listAvailableEmailTemplates_0 successfully', function(done) {
        //uncomment below and update the code to test listAvailableEmailTemplates_0
        //instance.listAvailableEmailTemplates_0(function(error) {
    ...
    describe('seeEmailTemplateInformation_0', function() {
      it('should call seeEmailTemplateInformation_0 successfully', function(done) {
        //uncomment below and update the code to test seeEmailTemplateInformation_0
        //instance.seeEmailTemplateInformation_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
