...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.CanvasApi();
  });
  ...
  describe('CanvasApi', function() {
    describe('canvasDataAnalyticsSummary_0', function() {
      it('should call canvasDataAnalyticsSummary_0 successfully', function(done) {
        //uncomment below and update the code to test canvasDataAnalyticsSummary_0
        //instance.canvasDataAnalyticsSummary_0(function(error) {
    ...
    describe('canvasDataSeriesAnalytics_0', function() {
      it('should call canvasDataSeriesAnalytics_0 successfully', function(done) {
        //uncomment below and update the code to test canvasDataSeriesAnalytics_0
        //instance.canvasDataSeriesAnalytics_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('canvasDetails_0', function() {
      it('should call canvasDetails_0 successfully', function(done) {
        //uncomment below and update the code to test canvasDetails_0
        //instance.canvasDetails_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('canvasList_0', function() {
      it('should call canvasList_0 successfully', function(done) {
        //uncomment below and update the code to test canvasList_0
        //instance.canvasList_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
