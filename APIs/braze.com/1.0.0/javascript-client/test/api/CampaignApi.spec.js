...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.CampaignApi();
  });
  ...
  describe('CampaignApi', function() {
    describe('campaignAnalytics_0', function() {
      it('should call campaignAnalytics_0 successfully', function(done) {
        //uncomment below and update the code to test campaignAnalytics_0
        //instance.campaignAnalytics_0(function(error) {
    ...
    describe('campaignDetails_0', function() {
      it('should call campaignDetails_0 successfully', function(done) {
        //uncomment below and update the code to test campaignDetails_0
        //instance.campaignDetails_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('campaignList_0', function() {
      it('should call campaignList_0 successfully', function(done) {
        //uncomment below and update the code to test campaignList_0
        //instance.campaignList_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sendAnalytics_0', function() {
      it('should call sendAnalytics_0 successfully', function(done) {
        //uncomment below and update the code to test sendAnalytics_0
        //instance.sendAnalytics_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
