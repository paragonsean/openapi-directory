...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.ContentBlocksApi();
  });
  ...
  describe('ContentBlocksApi', function() {
    describe('listAvailableContentBlocks_0', function() {
      it('should call listAvailableContentBlocks_0 successfully', function(done) {
        //uncomment below and update the code to test listAvailableContentBlocks_0
        //instance.listAvailableContentBlocks_0(function(error) {
    ...
    describe('seeContentBlockInformation_0', function() {
      it('should call seeContentBlockInformation_0 successfully', function(done) {
        //uncomment below and update the code to test seeContentBlockInformation_0
        //instance.seeContentBlockInformation_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
