...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.SessionAnalyticsApi();
  });
  ...
  describe('SessionAnalyticsApi', function() {
    describe('appSessionsByTime_0', function() {
      it('should call appSessionsByTime_0 successfully', function(done) {
        //uncomment below and update the code to test appSessionsByTime_0
        //instance.appSessionsByTime_0(function(error) {
