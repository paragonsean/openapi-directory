...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.EmailListsAddressesApi();
  });
  ...
  describe('EmailListsAddressesApi', function() {
    describe('queryHardBouncedEmails', function() {
      it('should call queryHardBouncedEmails successfully', function(done) {
        //uncomment below and update the code to test queryHardBouncedEmails
        //instance.queryHardBouncedEmails(function(error) {
    ...
    describe('queryListOfUnsubscribedEmailAddresses', function() {
      it('should call queryListOfUnsubscribedEmailAddresses successfully', function(done) {
        //uncomment below and update the code to test queryListOfUnsubscribedEmailAddresses
        //instance.queryListOfUnsubscribedEmailAddresses(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
