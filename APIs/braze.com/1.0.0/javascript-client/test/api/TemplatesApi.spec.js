...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.TemplatesApi();
  });
  ...
  describe('TemplatesApi', function() {
    describe('listAvailableContentBlocks', function() {
      it('should call listAvailableContentBlocks successfully', function(done) {
        //uncomment below and update the code to test listAvailableContentBlocks
        //instance.listAvailableContentBlocks(function(error) {
    ...
    describe('listAvailableEmailTemplates', function() {
      it('should call listAvailableEmailTemplates successfully', function(done) {
        //uncomment below and update the code to test listAvailableEmailTemplates
        //instance.listAvailableEmailTemplates(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('seeContentBlockInformation', function() {
      it('should call seeContentBlockInformation successfully', function(done) {
        //uncomment below and update the code to test seeContentBlockInformation
        //instance.seeContentBlockInformation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('seeEmailTemplateInformation', function() {
      it('should call seeEmailTemplateInformation successfully', function(done) {
        //uncomment below and update the code to test seeEmailTemplateInformation
        //instance.seeEmailTemplateInformation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
