...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.SMSApi();
  });
  ...
  describe('SMSApi', function() {
    describe('listUsersSubscriptionGroupSms_0', function() {
      it('should call listUsersSubscriptionGroupSms_0 successfully', function(done) {
        //uncomment below and update the code to test listUsersSubscriptionGroupSms_0
        //instance.listUsersSubscriptionGroupSms_0(function(error) {
    ...
    describe('listUsersSubscriptionGroupStatusSms_0', function() {
      it('should call listUsersSubscriptionGroupStatusSms_0 successfully', function(done) {
        //uncomment below and update the code to test listUsersSubscriptionGroupStatusSms_0
        //instance.listUsersSubscriptionGroupStatusSms_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
