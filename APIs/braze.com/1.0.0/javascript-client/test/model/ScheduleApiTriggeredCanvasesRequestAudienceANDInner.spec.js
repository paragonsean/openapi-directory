...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestAudienceANDInner();
  });
  ...
  describe('ScheduleApiTriggeredCanvasesRequestAudienceANDInner', function() {
    it('should create an instance of ScheduleApiTriggeredCanvasesRequestAudienceANDInner', function() {
      // uncomment below and update the code to test ScheduleApiTriggeredCanvasesRequestAudienceANDInner
      //var instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestAudienceANDInner();
      //expect(instance).to.be.a(BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestAudienceANDInner);
    });

    it('should have the property customAttribute (base name: "custom_attribute")', function() {
      // uncomment below and update the code to test the property customAttribute
      //var instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestAudienceANDInner();
