...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestRecipientsInner();
  });
  ...
  describe('ScheduleApiTriggeredCanvasesRequestRecipientsInner', function() {
    it('should create an instance of ScheduleApiTriggeredCanvasesRequestRecipientsInner', function() {
      // uncomment below and update the code to test ScheduleApiTriggeredCanvasesRequestRecipientsInner
      //var instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestRecipientsInner();
      //expect(instance).to.be.a(BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestRecipientsInner);
    });

    it('should have the property canvasEntryProperties (base name: "canvas_entry_properties")', function() {
      // uncomment below and update the code to test the property canvasEntryProperties
      //var instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestRecipientsInner();
    ...
    it('should have the property triggerProperties (base name: "trigger_properties")', function() {
      // uncomment below and update the code to test the property triggerProperties
      //var instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestRecipientsInner();
      //expect(instance).to.be();
    });

    it('should have the property userAlias (base name: "user_alias")', function() {
      // uncomment below and update the code to test the property userAlias
      //var instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestRecipientsInner();
      //expect(instance).to.be();
    });
