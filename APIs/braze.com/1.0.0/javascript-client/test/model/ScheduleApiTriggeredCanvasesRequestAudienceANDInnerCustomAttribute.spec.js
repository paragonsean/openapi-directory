...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute();
  });
  ...
  describe('ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute', function() {
    it('should create an instance of ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute', function() {
      // uncomment below and update the code to test ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute
      //var instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute();
      //expect(instance).to.be.a(BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute);
    });
    ...
    it('should have the property customAttributeName (base name: "custom_attribute_name")', function() {
