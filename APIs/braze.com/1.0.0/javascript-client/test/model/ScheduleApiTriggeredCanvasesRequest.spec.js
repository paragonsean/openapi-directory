...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequest();
  });
  ...
  describe('ScheduleApiTriggeredCanvasesRequest', function() {
    it('should create an instance of ScheduleApiTriggeredCanvasesRequest', function() {
      // uncomment below and update the code to test ScheduleApiTriggeredCanvasesRequest
      //var instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequest();
      //expect(instance).to.be.a(BrazeEndpoints.ScheduleApiTriggeredCanvasesRequest);
    });
    ...
    it('should have the property canvasId (base name: "canvas_id")', function() {
      // uncomment below and update the code to test the property canvasId
      //var instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequest();
      //expect(instance).to.be();
    });
