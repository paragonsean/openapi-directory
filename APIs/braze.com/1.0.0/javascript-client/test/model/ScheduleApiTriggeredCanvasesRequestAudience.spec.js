...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestAudience();
  });
  ...
  describe('ScheduleApiTriggeredCanvasesRequestAudience', function() {
    it('should create an instance of ScheduleApiTriggeredCanvasesRequestAudience', function() {
      // uncomment below and update the code to test ScheduleApiTriggeredCanvasesRequestAudience
      //var instance = new BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestAudience();
      //expect(instance).to.be.a(BrazeEndpoints.ScheduleApiTriggeredCanvasesRequestAudience);
    });
