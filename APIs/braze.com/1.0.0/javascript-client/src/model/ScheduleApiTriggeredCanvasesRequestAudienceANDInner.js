...
import ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute from './ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute';

/**
 * The ScheduleApiTriggeredCanvasesRequestAudienceANDInner model module.
 * @module model/ScheduleApiTriggeredCanvasesRequestAudienceANDInner
 * @version 1.0.0
 */
class ScheduleApiTriggeredCanvasesRequestAudienceANDInner {
    /**
     * Constructs a new <code>ScheduleApiTriggeredCanvasesRequestAudienceANDInner</code>.
     * @alias module:model/ScheduleApiTriggeredCanvasesRequestAudienceANDInner
     */
    constructor() { 
        
        ScheduleApiTriggeredCanvasesRequestAudienceANDInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScheduleApiTriggeredCanvasesRequestAudienceANDInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleApiTriggeredCanvasesRequestAudienceANDInner} obj Optional instance to populate.
     * @return {module:model/ScheduleApiTriggeredCanvasesRequestAudienceANDInner} The populated <code>ScheduleApiTriggeredCanvasesRequestAudienceANDInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleApiTriggeredCanvasesRequestAudienceANDInner();

            if (data.hasOwnProperty('custom_attribute')) {
                obj['custom_attribute'] = ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute.constructFromObject(data['custom_attribute']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleApiTriggeredCanvasesRequestAudienceANDInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleApiTriggeredCanvasesRequestAudienceANDInner</code>.
     */
    static validateJSON(data) {
        // validate the optional field `custom_attribute`
        if (data['custom_attribute']) { // data not null
          ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute.validateJSON(data['custom_attribute']);
        }
...
/**
 * @member {module:model/ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute} custom_attribute
 */
ScheduleApiTriggeredCanvasesRequestAudienceANDInner.prototype['custom_attribute'] = undefined;
...
export default ScheduleApiTriggeredCanvasesRequestAudienceANDInner;
