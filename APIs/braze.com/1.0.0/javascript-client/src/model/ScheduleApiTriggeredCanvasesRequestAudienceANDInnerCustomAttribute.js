...
/**
 * The ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute model module.
 * @module model/ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute
 * @version 1.0.0
 */
class ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute {
    /**
     * Constructs a new <code>ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute</code>.
     * @alias module:model/ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute
     */
    constructor() { 
        
        ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute} obj Optional instance to populate.
     * @return {module:model/ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute} The populated <code>ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute();

            if (data.hasOwnProperty('comparison')) {
                obj['comparison'] = ApiClient.convertToType(data['comparison'], 'String');
            }
            if (data.hasOwnProperty('custom_attribute_name')) {
                obj['custom_attribute_name'] = ApiClient.convertToType(data['custom_attribute_name'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['custom_attribute_name'] && !(typeof data['custom_attribute_name'] === 'string' || data['custom_attribute_name'] instanceof String)) {
            throw new Error("Expected the field `custom_attribute_name` to be a primitive type in the JSON string but got " + data['custom_attribute_name']);
        }
        // ensure the json data is a string
 ...
 */
ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute.prototype['comparison'] = undefined;

/**
 * @member {String} custom_attribute_name
 */
ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute.prototype['custom_attribute_name'] = undefined;

/**
 * @member {String} value
 */
ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute.prototype['value'] = undefined;
...
export default ScheduleApiTriggeredCanvasesRequestAudienceANDInnerCustomAttribute;
