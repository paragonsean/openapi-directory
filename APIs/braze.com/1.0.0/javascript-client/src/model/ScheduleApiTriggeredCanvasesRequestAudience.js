...
import ScheduleApiTriggeredCanvasesRequestAudienceANDInner from './ScheduleApiTriggeredCanvasesRequestAudienceANDInner';

/**
 * The ScheduleApiTriggeredCanvasesRequestAudience model module.
 * @module model/ScheduleApiTriggeredCanvasesRequestAudience
 * @version 1.0.0
 */
class ScheduleApiTriggeredCanvasesRequestAudience {
    /**
     * Constructs a new <code>ScheduleApiTriggeredCanvasesRequestAudience</code>.
     * @alias module:model/ScheduleApiTriggeredCanvasesRequestAudience
     */
    constructor() { 
        
        ScheduleApiTriggeredCanvasesRequestAudience.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScheduleApiTriggeredCanvasesRequestAudience</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleApiTriggeredCanvasesRequestAudience} obj Optional instance to populate.
     * @return {module:model/ScheduleApiTriggeredCanvasesRequestAudience} The populated <code>ScheduleApiTriggeredCanvasesRequestAudience</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleApiTriggeredCanvasesRequestAudience();

            if (data.hasOwnProperty('AND')) {
                obj['AND'] = ApiClient.convertToType(data['AND'], [ScheduleApiTriggeredCanvasesRequestAudienceANDInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleApiTriggeredCanvasesRequestAudience</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleApiTriggeredCanvasesRequestAudience</code>.
     */
    static validateJSON(data) {
        if (data['AND']) { // data not null
            ...
            for (const item of data['AND']) {
                ScheduleApiTriggeredCanvasesRequestAudienceANDInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/ScheduleApiTriggeredCanvasesRequestAudienceANDInner>} AND
 */
ScheduleApiTriggeredCanvasesRequestAudience.prototype['AND'] = undefined;
...
export default ScheduleApiTriggeredCanvasesRequestAudience;
