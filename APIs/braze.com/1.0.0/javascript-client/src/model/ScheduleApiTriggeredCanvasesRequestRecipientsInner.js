...
/**
 * The ScheduleApiTriggeredCanvasesRequestRecipientsInner model module.
 * @module model/ScheduleApiTriggeredCanvasesRequestRecipientsInner
 * @version 1.0.0
 */
class ScheduleApiTriggeredCanvasesRequestRecipientsInner {
    /**
     * Constructs a new <code>ScheduleApiTriggeredCanvasesRequestRecipientsInner</code>.
     * @alias module:model/ScheduleApiTriggeredCanvasesRequestRecipientsInner
     */
    constructor() { 
        
        ScheduleApiTriggeredCanvasesRequestRecipientsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScheduleApiTriggeredCanvasesRequestRecipientsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleApiTriggeredCanvasesRequestRecipientsInner} obj Optional instance to populate.
     * @return {module:model/ScheduleApiTriggeredCanvasesRequestRecipientsInner} The populated <code>ScheduleApiTriggeredCanvasesRequestRecipientsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleApiTriggeredCanvasesRequestRecipientsInner();
            ...
            if (data.hasOwnProperty('trigger_properties')) {
                obj['trigger_properties'] = ApiClient.convertToType(data['trigger_properties'], 'String');
            }
            if (data.hasOwnProperty('user_alias')) {
                obj['user_alias'] = ApiClient.convertToType(data['user_alias'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleApiTriggeredCanvasesRequestRecipientsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleApiTriggeredCanvasesRequestRecipientsInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['trigger_properties'] && !(typeof data['trigger_properties'] === 'string' || data['trigger_properties'] instanceof String)) {
            throw new Error("Expected the field `trigger_properties` to be a primitive type in the JSON string but got " + data['trigger_properties']);
        }
        // ensure the json data is a string
        if (data['user_alias'] && !(typeof data['user_alias'] === 'string' || data['user_alias'] instanceof String)) {
            throw new Error("Expected the field `user_alias` to be a primitive type in the JSON string but got " + data['user_alias']);
        }
 ...
 */
ScheduleApiTriggeredCanvasesRequestRecipientsInner.prototype['canvas_entry_properties'] = undefined;

/**
 * @member {String} external_user_id
 */
ScheduleApiTriggeredCanvasesRequestRecipientsInner.prototype['external_user_id'] = undefined;

/**
 * @member {String} trigger_properties
 */
ScheduleApiTriggeredCanvasesRequestRecipientsInner.prototype['trigger_properties'] = undefined;

/**
 * @member {String} user_alias
 */
ScheduleApiTriggeredCanvasesRequestRecipientsInner.prototype['user_alias'] = undefined;
...
export default ScheduleApiTriggeredCanvasesRequestRecipientsInner;
