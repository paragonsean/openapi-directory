...
/**
 * The ScheduleApiTriggeredCanvasesRequestSchedule model module.
 * @module model/ScheduleApiTriggeredCanvasesRequestSchedule
 * @version 1.0.0
 */
class ScheduleApiTriggeredCanvasesRequestSchedule {
    /**
     * Constructs a new <code>ScheduleApiTriggeredCanvasesRequestSchedule</code>.
     * @alias module:model/ScheduleApiTriggeredCanvasesRequestSchedule
     */
    constructor() { 
        
        ScheduleApiTriggeredCanvasesRequestSchedule.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScheduleApiTriggeredCanvasesRequestSchedule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScheduleApiTriggeredCanvasesRequestSchedule} obj Optional instance to populate.
     * @return {module:model/ScheduleApiTriggeredCanvasesRequestSchedule} The populated <code>ScheduleApiTriggeredCanvasesRequestSchedule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScheduleApiTriggeredCanvasesRequestSchedule();

            if (data.hasOwnProperty('at_optimal_time')) {
                obj['at_optimal_time'] = ApiClient.convertToType(data['at_optimal_time'], 'Boolean');
            }
            if (data.hasOwnProperty('in_local_time')) {
                obj['in_local_time'] = ApiClient.convertToType(data['in_local_time'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ScheduleApiTriggeredCanvasesRequestSchedule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScheduleApiTriggeredCanvasesRequestSchedule</code>.
     */
...
/**
 * @member {Boolean} at_optimal_time
 */
ScheduleApiTriggeredCanvasesRequestSchedule.prototype['at_optimal_time'] = undefined;

/**
 * @member {Boolean} in_local_time
 */
ScheduleApiTriggeredCanvasesRequestSchedule.prototype['in_local_time'] = undefined;

/**
 * @member {String} time
 */
ScheduleApiTriggeredCanvasesRequestSchedule.prototype['time'] = undefined;
...
export default ScheduleApiTriggeredCanvasesRequestSchedule;
