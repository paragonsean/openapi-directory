...
export default class SubscriptionGroupsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the listUsersSubscriptionGroupSms operation.
     * @callback module:api/SubscriptionGroupsApi~listUsersSubscriptionGroupSmsCallback
     ...
     * @param {module:api/SubscriptionGroupsApi~listUsersSubscriptionGroupSmsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    listUsersSubscriptionGroupSms(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the listUsersSubscriptionGroupStatusSms operation.
     * @callback module:api/SubscriptionGroupsApi~listUsersSubscriptionGroupStatusSmsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SubscriptionGroupsApi~listUsersSubscriptionGroupStatusSmsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    listUsersSubscriptionGroupStatusSms(opts, callback) {
      opts = opts || {};
      let postBody = null;
