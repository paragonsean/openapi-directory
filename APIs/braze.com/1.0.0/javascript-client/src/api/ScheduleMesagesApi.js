...
/**
* ScheduleMesages service.
* @module api/ScheduleMesagesApi
* @version 1.0.0
*/
export default class ScheduleMesagesApi {

    /**
    * Constructs a new ScheduleMesagesApi. 
    * @alias module:api/ScheduleMesagesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getUpcomingScheduledCampaignsAndCanvases_0 operation.
     * @callback module:api/ScheduleMesagesApi~getUpcomingScheduledCampaignsAndCanvases_0Callback
     ...
     * @param {String} [endTime] (Required) String in ISO 8601 format  End date of the range to retrieve upcoming scheduled Campaigns and Canvases. This is treated as midnight in UTC time by the API.
     * @param {module:api/ScheduleMesagesApi~getUpcomingScheduledCampaignsAndCanvases_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    getUpcomingScheduledCampaignsAndCanvases_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/messages/scheduled_broadcasts', 'GET',
    ...
    /**
     * Callback function to receive the result of the scheduleApiTriggeredCanvases_0 operation.
     * @callback module:api/ScheduleMesagesApi~scheduleApiTriggeredCanvases_0Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ScheduleApiTriggeredCanvasesRequest} [scheduleApiTriggeredCanvasesRequest] 
     * @param {module:api/ScheduleMesagesApi~scheduleApiTriggeredCanvases_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    scheduleApiTriggeredCanvases_0(opts, callback) {
      opts = opts || {};
      let postBody = opts['scheduleApiTriggeredCanvasesRequest'];
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/canvas/trigger/schedule/create', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
