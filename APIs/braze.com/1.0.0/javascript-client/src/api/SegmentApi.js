...
export default class SegmentApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the segmentAnalytics_0 operation.
     * @callback module:api/SegmentApi~segmentAnalytics_0Callback
     ...
     * @param {module:api/SegmentApi~segmentAnalytics_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    segmentAnalytics_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the segmentDetails_0 operation.
     * @callback module:api/SegmentApi~segmentDetails_0Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [segmentId] (Required) String  Segment API identifier
     * @param {module:api/SegmentApi~segmentDetails_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    segmentDetails_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the segmentList_0 operation.
     * @callback module:api/SegmentApi~segmentList_0Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SegmentApi~segmentList_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    segmentList_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
