...
/**
* CustomEvents service.
* @module api/CustomEventsApi
* @version 1.0.0
*/
export default class CustomEventsApi {

    /**
    * Constructs a new CustomEventsApi. 
    * @alias module:api/CustomEventsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the customEventsAnalytics_0 operation.
     * @callback module:api/CustomEventsApi~customEventsAnalytics_0Callback
     ...
     * @param {module:api/CustomEventsApi~customEventsAnalytics_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    customEventsAnalytics_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the customEventsList_0 operation.
     * @callback module:api/CustomEventsApi~customEventsList_0Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CustomEventsApi~customEventsList_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    customEventsList_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
