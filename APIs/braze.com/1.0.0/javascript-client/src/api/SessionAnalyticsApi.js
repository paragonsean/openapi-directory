...
* @module api/SessionAnalyticsApi
* @version 1.0.0
*/
export default class SessionAnalyticsApi {

    /**
    * Constructs a new SessionAnalyticsApi. 
    * @alias module:api/SessionAnalyticsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the appSessionsByTime_0 operation.
     * @callback module:api/SessionAnalyticsApi~appSessionsByTime_0Callback
     ...
     * @param {module:api/SessionAnalyticsApi~appSessionsByTime_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    appSessionsByTime_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
