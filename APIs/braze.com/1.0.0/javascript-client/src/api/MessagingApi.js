...
export default class MessagingApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getUpcomingScheduledCampaignsAndCanvases operation.
     * @callback module:api/MessagingApi~getUpcomingScheduledCampaignsAndCanvasesCallback
     ...
     * @param {module:api/MessagingApi~getUpcomingScheduledCampaignsAndCanvasesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getUpcomingScheduledCampaignsAndCanvases(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the scheduleApiTriggeredCanvases operation.
     * @callback module:api/MessagingApi~scheduleApiTriggeredCanvasesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MessagingApi~scheduleApiTriggeredCanvasesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    scheduleApiTriggeredCanvases(opts, callback) {
      opts = opts || {};
