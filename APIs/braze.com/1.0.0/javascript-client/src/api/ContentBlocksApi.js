...
* @module api/ContentBlocksApi
* @version 1.0.0
*/
export default class ContentBlocksApi {

    /**
    * Constructs a new ContentBlocksApi. 
    * @alias module:api/ContentBlocksApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the listAvailableContentBlocks_0 operation.
     * @callback module:api/ContentBlocksApi~listAvailableContentBlocks_0Callback
     ...
     * @param {module:api/ContentBlocksApi~listAvailableContentBlocks_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    listAvailableContentBlocks_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the seeContentBlockInformation_0 operation.
     * @callback module:api/ContentBlocksApi~seeContentBlockInformation_0Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ContentBlocksApi~seeContentBlockInformation_0Callback} callback The callback function, accepting three arguments: error, data, response
     */
    seeContentBlockInformation_0(opts, callback) {
      opts = opts || {};
      let postBody = null;
