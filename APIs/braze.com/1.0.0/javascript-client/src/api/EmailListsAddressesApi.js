...
/**
* EmailListsAddresses service.
* @module api/EmailListsAddressesApi
* @version 1.0.0
*/
export default class EmailListsAddressesApi {

    /**
    * Constructs a new EmailListsAddressesApi. 
    * @alias module:api/EmailListsAddressesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the queryHardBouncedEmails operation.
     * @callback module:api/EmailListsAddressesApi~queryHardBouncedEmailsCallback
     ...
     * @param {String} [startDate] (Optional*) String in YYYY-MM-DD format   Start date of the range to retrieve hard bounces, must be earlier than `end_date`. This is treated as midnight in UTC time by the API.  *You must provide either an `email` or a `start_date`, and an `end_date`. 
     * @param {String} [endDate] (Optional*) String in YYYY-MM-DD format  String in YYYY-MM-DD format. End date of the range to retrieve hard bounces. This is treated as midnight in UTC time by the API.  *You must provide either an `email` or a `start_date`, and an `end_date`.
     * @param {String} [limit] (Optional) Integer  Optional field to limit the number of results returned. Defaults to 100, maximum is 500.
     * @param {String} [offset] (Optional) Integer  Optional beginning point in the list to retrieve from.
     * @param {String} [email] (Optional*) String  If provided, we will return whether or not the user has hard bounced.  *You must provide either an `email` or a `start_date`, and an `end_date`.
     * @param {module:api/EmailListsAddressesApi~queryHardBouncedEmailsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    queryHardBouncedEmails(opts, callback) {
      opts = opts || {};
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the queryListOfUnsubscribedEmailAddresses operation.
     * @callback module:api/EmailListsAddressesApi~queryListOfUnsubscribedEmailAddressesCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [startDate] (Optional*) String in YYYY-MM-DD format  Start date of the range to retrieve unsubscribes, must be earlier than end_date. This is treated as midnight in UTC time by the API.
     * @param {String} [endDate] (Optional*)  String in YYYY-MM-DD format  End date of the range to retrieve unsubscribes. This is treated as midnight in UTC time by the API.
     * @param {String} [limit] (Optional) Integer  Optional field to limit the number of results returned. Limit must be greater than 1. Defaults to 100, maximum is 500.
     * @param {String} [offset] (Optional) Integer   Optional beginning point in the list to retrieve from
     * @param {String} [sortDirection] (Optional) String  Pass in the value `asc` to sort unsubscribes from oldest to newest. Pass in `desc` to sort from newest to oldest. If sort_direction is not included, the default order is newest to oldest.
     * @param {String} [email] (Optional*) String  If provided, we will return whether or not the user has unsubscribed
     * @param {module:api/EmailListsAddressesApi~queryListOfUnsubscribedEmailAddressesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    queryListOfUnsubscribedEmailAddresses(opts, callback) {
      opts = opts || {};
      let postBody = null;
