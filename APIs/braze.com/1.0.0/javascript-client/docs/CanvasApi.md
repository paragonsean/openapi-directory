...
> canvasDataAnalyticsSummary_0(opts)
...
let apiInstance = new BrazeEndpoints.CanvasApi();
let opts = {
...
apiInstance.canvasDataAnalyticsSummary_0(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> canvasDataSeriesAnalytics_0(opts)
...
apiInstance.canvasDataSeriesAnalytics_0(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.canvasDetails_0(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.canvasList_0(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
