# BrazeEndpoints.SessionAnalyticsApi
...
let apiInstance = new BrazeEndpoints.SessionAnalyticsApi();
let opts = {
...
apiInstance.appSessionsByTime_0(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
