...
> listUsersSubscriptionGroupSms_0(opts)
...
let apiInstance = new BrazeEndpoints.SMSApi();
let opts = {
...
apiInstance.listUsersSubscriptionGroupSms_0(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> listUsersSubscriptionGroupStatusSms_0(opts)
...
apiInstance.listUsersSubscriptionGroupStatusSms_0(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
