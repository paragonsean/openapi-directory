# BrazeEndpoints.ContentBlocksApi
...
> listAvailableContentBlocks_0(opts)
...
let apiInstance = new BrazeEndpoints.ContentBlocksApi();
let opts = {
...
apiInstance.listAvailableContentBlocks_0(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> seeContentBlockInformation_0(opts)
...
apiInstance.seeContentBlockInformation_0(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
