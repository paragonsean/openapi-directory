...
#ifndef OAI_OAISimilarApi_H
#define OAI_OAISimilarApi_H
...
class OAISimilarApi : public QObject {
    Q_OBJECT

public:
    OAISimilarApi(const int timeOut = 0);
    ~OAISimilarApi();
    ...
    */
    virtual void similarGet(const QString &link, const ::OpenAPI::OptionalParam<QString> &page = ::OpenAPI::OptionalParam<QString>());
...
Q_SIGNALS:
    ...
    void similarGetSignal(OAI_similar_get_200_response summary);


    void similarGetSignalFull(OAIHttpRequestWorker *worker, OAI_similar_get_200_response summary);

    Q_DECL_DEPRECATED_X("Use similarGetSignalError() instead")
    void similarGetSignalE(OAI_similar_get_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void similarGetSignalError(OAI_similar_get_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
