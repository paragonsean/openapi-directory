...
/*
 * OAIContentProSnippets.h
 *
 * 
 */

#ifndef OAIContentProSnippets_H
#define OAIContentProSnippets_H
...
class OAIContentProSnippets : public OAIObject {
public:
    OAIContentProSnippets();
    OAIContentProSnippets(QString json);
    ~OAIContentProSnippets() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContentProSnippets)

#endif // OAIContentProSnippets_H
