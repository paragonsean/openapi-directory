...
#ifndef OAISimilarCompany_H
#define OAISimilarCompany_H
...
class OAISimilarCompany : public OAIObject {
public:
    OAISimilarCompany();
    OAISimilarCompany(QString json);
    ~OAISimilarCompany() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimilarCompany)

#endif // OAISimilarCompany_H
