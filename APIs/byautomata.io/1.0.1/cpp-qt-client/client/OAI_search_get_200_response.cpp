...
QString OAI_search_get_200_response::getCallsPerMonth() const {
    return m_calls_per_month;
}
void OAI_search_get_200_response::setCallsPerMonth(const QString &calls_per_month) {
    m_calls_per_month = calls_per_month;
    m_calls_per_month_isSet = true;
}

bool OAI_search_get_200_response::is_calls_per_month_Set() const{
    return m_calls_per_month_isSet;
}

bool OAI_search_get_200_response::is_calls_per_month_Valid() const{
    return m_calls_per_month_isValid;
}

QList<OAISimilarCompanySearch> OAI_search_get_200_response::getCompanies() const {
    return m_companies;
}
void OAI_search_get_200_response::setCompanies(const QList<OAISimilarCompanySearch> &companies) {
    m_companies = companies;
    m_companies_isSet = true;
}

bool OAI_search_get_200_response::is_companies_Set() const{
    return m_companies_isSet;
}

bool OAI_search_get_200_response::is_companies_Valid() const{
    return m_companies_isValid;
}

QString OAI_search_get_200_response::getCountRemaining() const {
    return m_count_remaining;
}
void OAI_search_get_200_response::setCountRemaining(const QString &count_remaining) {
    m_count_remaining = count_remaining;
    m_count_remaining_isSet = true;
}

bool OAI_search_get_200_response::is_count_remaining_Set() const{
    return m_count_remaining_isSet;
}

bool OAI_search_get_200_response::is_count_remaining_Valid() const{
    return m_count_remaining_isValid;
}

QString OAI_search_get_200_response::getRenewalDate() const {
    return m_renewal_date;
}
void OAI_search_get_200_response::setRenewalDate(const QString &renewal_date) {
    m_renewal_date = renewal_date;
    m_renewal_date_isSet = true;
}

bool OAI_search_get_200_response::is_renewal_date_Set() const{
    return m_renewal_date_isSet;
}

bool OAI_search_get_200_response::is_renewal_date_Valid() const{
