...
/*
 * OAIContentProCompany.h
 *
 * 
 */

#ifndef OAIContentProCompany_H
#define OAIContentProCompany_H
...
class OAIContentProCompany : public OAIObject {
public:
    OAIContentProCompany();
    OAIContentProCompany(QString json);
    ~OAIContentProCompany() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContentProCompany)

#endif // OAIContentProCompany_H
