...
/*
 * OAISimilarCompanySearch.h
 *
 * 
 */

#ifndef OAISimilarCompanySearch_H
#define OAISimilarCompanySearch_H
...
class OAISimilarCompanySearch : public OAIObject {
public:
    OAISimilarCompanySearch();
    OAISimilarCompanySearch(QString json);
    ~OAISimilarCompanySearch() override;
    ...
    QList<OAISnippet> getSnippets() const;
    void setSnippets(const QList<OAISnippet> &snippets);
...
Q_DECLARE_METATYPE(OpenAPI::OAISimilarCompanySearch)

#endif // OAISimilarCompanySearch_H
