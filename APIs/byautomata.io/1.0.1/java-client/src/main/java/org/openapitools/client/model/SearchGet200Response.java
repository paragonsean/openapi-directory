...
public class SearchGet200Response {
  ...
  private List<SimilarCompanySearch> companies = new ArrayList<>();
  ...
  public SearchGet200Response callsPerMonth(String callsPerMonth) {
  ...
  public SearchGet200Response companies(List<SimilarCompanySearch> companies) {
    this.companies = companies;
    return this;
  }

  public SearchGet200Response addCompaniesItem(SimilarCompanySearch companiesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SimilarCompanySearch> getCompanies() {
    return companies;
  }

  public void setCompanies(List<SimilarCompanySearch> companies) {
    this.companies = companies;
  }


  public SearchGet200Response countRemaining(String countRemaining) {
  ...
  public SearchGet200Response renewalDate(String renewalDate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.callsPerMonth, searchGet200Response.callsPerMonth) &&
        Objects.equals(this.companies, searchGet200Response.companies) &&
        Objects.equals(this.countRemaining, searchGet200Response.countRemaining) &&
        Objects.equals(this.renewalDate, searchGet200Response.renewalDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(callsPerMonth, companies, countRemaining, renewalDate);
  }
      ...
      if (jsonObj.get("companies") != null && !jsonObj.get("companies").isJsonNull()) {
        ...
        if (jsonArraycompanies != null) {
          ...
          for (int i = 0; i < jsonArraycompanies.size(); i++) {
            SimilarCompanySearch.validateJsonElement(jsonArraycompanies.get(i));
          };
        }
      }
