...
public class SimilarCompany {
  ...
  public SimilarCompany companyName(String companyName) {
  ...
  public SimilarCompany description(String description) {
  ...
  public SimilarCompany employee(String employee) {
  ...
  public SimilarCompany industry(String industry) {
  ...
  public SimilarCompany linkedin(String linkedin) {
  ...
  public SimilarCompany title(String title) {
    this.title = title;
    return this;
  }
  ...
  public SimilarCompany twitter(String twitter) {
  ...
  public SimilarCompany website(String website) {
  ...
  public boolean equals(Object o) {
    ...
    SimilarCompany similarCompany = (SimilarCompany) o;
    return Objects.equals(this.companyName, similarCompany.companyName) &&
        Objects.equals(this.description, similarCompany.description) &&
        Objects.equals(this.employee, similarCompany.employee) &&
        Objects.equals(this.industry, similarCompany.industry) &&
        Objects.equals(this.linkedin, similarCompany.linkedin) &&
        Objects.equals(this.title, similarCompany.title) &&
        Objects.equals(this.twitter, similarCompany.twitter) &&
        Objects.equals(this.website, similarCompany.website);
  }

  @Override
  public int hashCode() {
    return Objects.hash(companyName, description, employee, industry, linkedin, title, twitter, website);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SimilarCompany {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimilarCompany
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimilarCompany.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimilarCompany is not found in the empty JSON string", SimilarCompany.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimilarCompany.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimilarCompany` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimilarCompany.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimilarCompany' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimilarCompany> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimilarCompany.class));

       return (TypeAdapter<T>) new TypeAdapter<SimilarCompany>() {
           @Override
           public void write(JsonWriter out, SimilarCompany value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SimilarCompany read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SimilarCompany given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SimilarCompany
   * @throws IOException if the JSON string is invalid with respect to SimilarCompany
   */
  public static SimilarCompany fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimilarCompany.class);
  }

  /**
   * Convert an instance of SimilarCompany to an JSON string
   *
   * @return JSON string
   */
