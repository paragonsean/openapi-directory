...
/**
 * API tests for ContentproSimilarTextApi
 */
@Disabled
public class ContentproSimilarTextApiTest {

    private final ContentproSimilarTextApi api = new ContentproSimilarTextApi();
     ...
     */
    @Test
    public void contentproSimilarTextPostTest() throws ApiException {
        ContentproSimilarTextPostRequest contentproSimilarTextPostRequest = null;
        ContentproSearchGet200Response response = api.contentproSimilarTextPost(contentproSimilarTextPostRequest);
