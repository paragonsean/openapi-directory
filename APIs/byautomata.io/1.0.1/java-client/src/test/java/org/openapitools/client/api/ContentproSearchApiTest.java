...
/**
 * API tests for ContentproSearchApi
 */
@Disabled
public class ContentproSearchApiTest {

    private final ContentproSearchApi api = new ContentproSearchApi();
     ...
     */
    @Test
    public void contentproSearchGetTest() throws ApiException {
        String terms = null;
        ContentproSearchGet200Response response = api.contentproSearchGet(terms);
