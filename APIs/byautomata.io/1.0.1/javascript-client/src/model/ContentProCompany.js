...
/**
 * The ContentProCompany model module.
 * @module model/ContentProCompany
 * @version 1.0.1
 */
class ContentProCompany {
    /**
     * Constructs a new <code>ContentProCompany</code>.
     * @alias module:model/ContentProCompany
     */
    constructor() { 
        
        ContentProCompany.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentProCompany</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentProCompany} obj Optional instance to populate.
     * @return {module:model/ContentProCompany} The populated <code>ContentProCompany</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentProCompany();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentProCompany</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentProCompany</code>.
     */
 ...
 */
ContentProCompany.prototype['companyName'] = undefined;

/**
 * @member {String} description
 */
ContentProCompany.prototype['description'] = undefined;

/**
 * @member {String} employee
 */
ContentProCompany.prototype['employee'] = undefined;

/**
 * @member {String} industry
 */
ContentProCompany.prototype['industry'] = undefined;

/**
 * @member {String} linkedin
 */
ContentProCompany.prototype['linkedin'] = undefined;

/**
 * @member {String} twitter
 */
ContentProCompany.prototype['twitter'] = undefined;

/**
 * @member {String} website
 */
ContentProCompany.prototype['website'] = undefined;
...
export default ContentProCompany;
