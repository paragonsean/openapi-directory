...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomataMarketIntelligenceApi.ContentproSimilarTextPostRequest();
  });
  ...
  describe('ContentproSimilarTextPostRequest', function() {
    it('should create an instance of ContentproSimilarTextPostRequest', function() {
      // uncomment below and update the code to test ContentproSimilarTextPostRequest
      //var instance = new AutomataMarketIntelligenceApi.ContentproSimilarTextPostRequest();
      //expect(instance).to.be.a(AutomataMarketIntelligenceApi.ContentproSimilarTextPostRequest);
    });
