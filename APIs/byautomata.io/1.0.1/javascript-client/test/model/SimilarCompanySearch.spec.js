...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomataMarketIntelligenceApi.SimilarCompanySearch();
  });
  ...
  describe('SimilarCompanySearch', function() {
    it('should create an instance of SimilarCompanySearch', function() {
      // uncomment below and update the code to test SimilarCompanySearch
      //var instance = new AutomataMarketIntelligenceApi.SimilarCompanySearch();
      //expect(instance).to.be.a(AutomataMarketIntelligenceApi.SimilarCompanySearch);
    });
