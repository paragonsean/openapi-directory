...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomataMarketIntelligenceApi.ContentProSnippets();
  });
  ...
  describe('ContentProSnippets', function() {
    it('should create an instance of ContentProSnippets', function() {
      // uncomment below and update the code to test ContentProSnippets
      //var instance = new AutomataMarketIntelligenceApi.ContentProSnippets();
      //expect(instance).to.be.a(AutomataMarketIntelligenceApi.ContentProSnippets);
    });
