...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomataMarketIntelligenceApi.ContentproSearchGet200ResponseDataInner();
  });
  ...
  describe('ContentproSearchGet200ResponseDataInner', function() {
    it('should create an instance of ContentproSearchGet200ResponseDataInner', function() {
      // uncomment below and update the code to test ContentproSearchGet200ResponseDataInner
      //var instance = new AutomataMarketIntelligenceApi.ContentproSearchGet200ResponseDataInner();
      //expect(instance).to.be.a(AutomataMarketIntelligenceApi.ContentproSearchGet200ResponseDataInner);
    });
