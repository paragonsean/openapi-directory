...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomataMarketIntelligenceApi.InputCompany();
  });
  ...
  describe('InputCompany', function() {
    it('should create an instance of InputCompany', function() {
      // uncomment below and update the code to test InputCompany
      //var instance = new AutomataMarketIntelligenceApi.InputCompany();
      //expect(instance).to.be.a(AutomataMarketIntelligenceApi.InputCompany);
    });
