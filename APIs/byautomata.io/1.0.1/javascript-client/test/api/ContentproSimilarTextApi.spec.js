...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutomataMarketIntelligenceApi.ContentproSimilarTextApi();
  });
  ...
  describe('ContentproSimilarTextApi', function() {
    describe('contentproSimilarTextPost', function() {
      it('should call contentproSimilarTextPost successfully', function(done) {
        //uncomment below and update the code to test contentproSimilarTextPost
        //instance.contentproSimilarTextPost(function(error) {
