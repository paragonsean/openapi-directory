...
public class ApiClient {
    ...
    private String basePath = "https://www.haloapi.com/stats";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKeyQuery", new ApiKeyAuth("query", "subscription-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.haloapi.com/stats
