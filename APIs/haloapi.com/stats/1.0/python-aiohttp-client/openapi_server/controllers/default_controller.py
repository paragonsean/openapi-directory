...
async def halo5_company(request: web.Request, company_id) -> web.Response:
    """Halo 5 - Company
    ...
    :param company_id: The ID for the Company. The Company ID for a player can be retrieved from the Profile APIs via the \&quot;Halo 5 - Player Apperance\&quot; Endpoint.
    :type company_id: str
...
async def halo5_company_commendations(request: web.Request, company_id) -> web.Response:
...
async def halo5_leaderboard_player_csr(request: web.Request, season_id, playlist_id, count=None) -> web.Response:
    ...
    :param season_id: The ID for the Season.
    :type season_id: str
    :param playlist_id: The ID for the Playlist.
...
async def halo5_match_events(request: web.Request, match_id) -> web.Response:
    """Halo 5 - Match Events
    ...
    :param match_id: An ID that uniquely identifies a Match. Match IDs can be retrieved from the \&quot;Halo 5 - Player Match History\&quot; Endpoint.
    :type match_id: str
...
async def halo5_match_result_arena(request: web.Request, match_id) -> web.Response:
...
async def halo5_match_result_campaign(request: web.Request, match_id) -> web.Response:
...
async def halo5_match_result_custom(request: web.Request, match_id) -> web.Response:
...
async def halo5_match_result_custom_local(request: web.Request, match_id) -> web.Response:
...
async def halo5_match_result_warzone(request: web.Request, match_id) -> web.Response:
...
async def halo5_pc_match_result_custom(request: web.Request, match_id) -> web.Response:
    """Halo 5 PC - Match Result - Custom

    &lt;p&gt;Retrieves detailed statistics for a Match with the Custom Game Mode. Games with the Custom Game Mode are played on Xbox Live Servers. For games played on Local Servers, use the \&quot;Halo 5 - Match Result - Custom Local\&quot; Endpoint.&lt;/p&gt; &lt;br /&gt; &lt;h4&gt;Changelog&lt;/h4&gt; &lt;div class&#x3D;\&quot;panel-body\&quot;&gt;     &lt;p&gt;&lt;strong&gt;December 12, 2018:&lt;/strong&gt;&lt;/p&gt;     &lt;ul&gt;         &lt;li&gt;Updated the documentation for \&quot;PlayerScore\&quot;.&lt;/li&gt;     &lt;/ul&gt; &lt;/div&gt; &lt;div class&#x3D;\&quot;panel-body\&quot;&gt;     &lt;p&gt;&lt;strong&gt;December 22, 2017:&lt;/strong&gt;&lt;/p&gt;     &lt;ul&gt;         &lt;li&gt;Added Game Mode clarifications to the Endpoint description.&lt;/li&gt;         &lt;li&gt;Added documentation for \&quot;PresentInMatch\&quot;.&lt;/li&gt;     &lt;/ul&gt; &lt;/div&gt; &lt;div class&#x3D;\&quot;panel-body\&quot;&gt;     &lt;p&gt;&lt;strong&gt;February 21, 2017:&lt;/strong&gt;&lt;/p&gt;     &lt;ul&gt;         &lt;li&gt;Renamed Endpoint from \&quot;Post-Game Carnage Report: Custom\&quot; to \&quot;Halo 5 - Match Result - Custom\&quot;.&lt;/li&gt;         &lt;li&gt;Removed \&quot;{title}\&quot; Request Parameter.&lt;/li&gt;         &lt;li&gt;Updated the documentation for \&quot;GameVariantResourceId\&quot; and \&quot;MapVariantResourceId\&quot; to reference the UGC API.&lt;/li&gt;     &lt;/ul&gt; &lt;/div&gt; &lt;div class&#x3D;\&quot;panel-body\&quot;&gt;     &lt;p&gt;&lt;strong&gt;May 16, 2016:&lt;/strong&gt;&lt;/p&gt;     &lt;ul&gt;         &lt;li&gt;Documented HTTP 503 Response Code.&lt;/li&gt;     &lt;/ul&gt; &lt;/div&gt; &lt;div class&#x3D;\&quot;panel-body\&quot;&gt;     &lt;p&gt;&lt;strong&gt;April 20, 2016:&lt;/strong&gt;&lt;/p&gt;     &lt;ul&gt;         &lt;li&gt;Added documentation for the \&quot;GameVariantResourceId\&quot;, \&quot;MapVariantResourceId\&quot;, and \&quot;PlayerScore\&quot; fields.&lt;/li&gt;         &lt;li&gt;Updated the documentation for the \&quot;MapVariantId\&quot; and \&quot;GameVariantId\&quot; fields with the recommendation of using the \&quot;MapVariantResourceId\&quot; and \&quot;GameVariantResourceId\&quot; fields, respectively.&lt;/li&gt;     &lt;/ul&gt; &lt;/div&gt; 

    :param match_id: An ID that uniquely identifies a Match. Match IDs can be retrieved from the \&quot;Halo 5 PC - Player Match History\&quot; Endpoint.
    :type match_id: str
...
async def halo5_pc_player_match_history(request: web.Request, player, modes=None, start=None, count=None, include_times=None) -> web.Response:
...
async def halo5_pc_player_service_records_custom(request: web.Request, players) -> web.Response:
    ...
    :param players: A comma-separated list of Gamertags. Up to 32 Gamertags may be specified.
    :type players: str
...
async def halo5_player_commendations(request: web.Request, player) -> web.Response:
...
async def halo5_player_match_history(request: web.Request, player, modes=None, start=None, count=None, include_times=None) -> web.Response:
...
async def halo5_player_service_records_arena(request: web.Request, players, season_id=None) -> web.Response:
...
async def halo5_player_service_records_campaign(request: web.Request, players) -> web.Response:
...
async def halo5_player_service_records_custom(request: web.Request, players) -> web.Response:
...
async def halo5_player_service_records_custom_local(request: web.Request, players) -> web.Response:
...
async def halo5_player_service_records_warzone(request: web.Request, players) -> web.Response:
...
async def halo_wars2_leaderboard_player_csr(request: web.Request, season_id, playlist_id, count=None) -> web.Response:
...
async def halo_wars2_match_events(request: web.Request, match_id) -> web.Response:
    ...
    :param match_id: An ID that uniquely identifies a Match. Match IDs can be retrieved from the \&quot;Halo Wars 2 - Player Match History\&quot; Endpoint.
    :type match_id: str
...
async def halo_wars2_match_result(request: web.Request, match_id) -> web.Response:
...
async def halo_wars2_player_campaign_progress(request: web.Request, player) -> web.Response:
...
async def halo_wars2_player_match_history(request: web.Request, player, match_type=None, start=None, count=None) -> web.Response:
...
async def halo_wars2_player_playlist_ratings(request: web.Request, playlist_id, players) -> web.Response:
    ...
    :param playlist_id: The ID of the Playlist to get Ratings for.
    :type playlist_id: str
    :param players: A comma-separated list of Gamertags. Up to 6 Gamertags may be specified.
    :type players: str
...
async def halo_wars2_player_season_stats_summary(request: web.Request, player, season_id) -> web.Response:
    ...
    :param player: The Player&#39;s Gamertag.
    :type player: str
    :param season_id: A Season ID or \&quot;current\&quot; for the current Season. Seasons are available via the Metadata API.
    :type season_id: str
...
async def halo_wars2_player_stats_summary(request: web.Request, player) -> web.Response:
...
async def halo_wars2_player_xps(request: web.Request, players) -> web.Response:
