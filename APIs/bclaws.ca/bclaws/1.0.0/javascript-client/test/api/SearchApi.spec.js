...
(function(root, factory) {
  ...
  describe('SearchApi', function() {
    describe('searchAspectIdFullsearchGet', function() {
      it('should call searchAspectIdFullsearchGet successfully', function(done) {
        //uncomment below and update the code to test searchAspectIdFullsearchGet
        //instance.searchAspectIdFullsearchGet(function(error) {
