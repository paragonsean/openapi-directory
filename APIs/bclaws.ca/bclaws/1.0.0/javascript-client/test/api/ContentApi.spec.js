...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BcLaws.ContentApi();
  });
  ...
  describe('ContentApi', function() {
    describe('contentAspectIdCivixDocumentIdGet', function() {
      it('should call contentAspectIdCivixDocumentIdGet successfully', function(done) {
        //uncomment below and update the code to test contentAspectIdCivixDocumentIdGet
        //instance.contentAspectIdCivixDocumentIdGet(function(error) {
    ...
    describe('contentAspectIdGet', function() {
      it('should call contentAspectIdGet successfully', function(done) {
        //uncomment below and update the code to test contentAspectIdGet
        //instance.contentAspectIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
