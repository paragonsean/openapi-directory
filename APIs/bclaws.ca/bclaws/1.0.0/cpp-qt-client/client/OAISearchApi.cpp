...
void OAISearchApi::initializeServerConfigs() {
    ...
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("searchAspectIdFullsearchGet", defaultConf);
    _serverIndices.insert("searchAspectIdFullsearchGet", 0);
}
...
void OAISearchApi::searchAspectIdFullsearchGet(const QString &aspect_id, const QString &q, const QString &s, const qint32 &e, const qint32 &n_frag, const qint32 &l_frag) {
    QString fullPath = QString(_serverConfigs["searchAspectIdFullsearchGet"][_serverIndices.value("searchAspectIdFullsearchGet")].URL()+"/search/{aspectId}/fullsearch");
    ...
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("e")).append(querySuffix).append(QUrl::toPercentEncoding(e));
    }
    
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "nFrag", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("nFrag")).append(querySuffix).append(QUrl::toPercentEncoding(n_frag));
    }
    
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "lFrag", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("lFrag")).append(querySuffix).append(QUrl::toPercentEncoding(l_frag));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::searchAspectIdFullsearchGetCallback);
...
void OAISearchApi::searchAspectIdFullsearchGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchAspectIdFullsearchGetSignal();
        Q_EMIT searchAspectIdFullsearchGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchAspectIdFullsearchGetSignalE(error_type, error_str);
        Q_EMIT searchAspectIdFullsearchGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchAspectIdFullsearchGetSignalError(error_type, error_str);
        Q_EMIT searchAspectIdFullsearchGetSignalErrorFull(worker, error_type, error_str);
    }
}
