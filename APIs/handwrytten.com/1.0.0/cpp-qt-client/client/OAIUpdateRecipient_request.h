...
/*
 * OAIUpdateRecipient_request.h
 *
 * 
 */

#ifndef OAIUpdateRecipient_request_H
#define OAIUpdateRecipient_request_H
...
class OAIUpdateRecipient_request : public OAIObject {
public:
    OAIUpdateRecipient_request();
    OAIUpdateRecipient_request(QString json);
    ~OAIUpdateRecipient_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRecipient_request)

#endif // OAIUpdateRecipient_request_H
