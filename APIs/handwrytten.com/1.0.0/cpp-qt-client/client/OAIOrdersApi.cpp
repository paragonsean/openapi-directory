...
void OAIOrdersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("singleStepOrder", defaultConf);
    _serverIndices.insert("singleStepOrder", 0);
}
...
void OAIOrdersApi::singleStepOrder(const OAISingleStepOrder_request &body) {
    QString fullPath = QString(_serverConfigs["singleStepOrder"][_serverIndices.value("singleStepOrder")].URL()+"/orders/singleStepOrder");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::singleStepOrderCallback);
...
void OAIOrdersApi::singleStepOrderCallback(OAIHttpRequestWorker *worker) {
    ...
    OAISingleStepOrder_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT singleStepOrderSignal(output);
        Q_EMIT singleStepOrderSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT singleStepOrderSignalE(output, error_type, error_str);
        Q_EMIT singleStepOrderSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT singleStepOrderSignalError(output, error_type, error_str);
        Q_EMIT singleStepOrderSignalErrorFull(worker, error_type, error_str);
    }
}
