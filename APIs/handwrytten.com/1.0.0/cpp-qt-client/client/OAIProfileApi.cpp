...
void OAIProfileApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("updateUserAddress", defaultConf);
    _serverIndices.insert("updateUserAddress", 0);
    _serverConfigs.insert("userAddress", defaultConf);
    _serverIndices.insert("userAddress", 0);
}
...
void OAIProfileApi::updateUserAddress(const OAIUpdateUserAddress_request &body) {
    QString fullPath = QString(_serverConfigs["updateUserAddress"][_serverIndices.value("updateUserAddress")].URL()+"/profile/updateAddress");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProfileApi::updateUserAddressCallback);
...
void OAIProfileApi::updateUserAddressCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIUserAddress_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT updateUserAddressSignal(output);
        Q_EMIT updateUserAddressSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT updateUserAddressSignalE(output, error_type, error_str);
        Q_EMIT updateUserAddressSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT updateUserAddressSignalError(output, error_type, error_str);
        Q_EMIT updateUserAddressSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProfileApi::userAddress(const ::OpenAPI::OptionalParam<OAIUserAddress_request> &body) {
    QString fullPath = QString(_serverConfigs["userAddress"][_serverIndices.value("userAddress")].URL()+"/profile/address");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProfileApi::userAddressCallback);
    connect(this, &OAIProfileApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProfileApi::userAddressCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT userAddressSignal(output);
        Q_EMIT userAddressSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT userAddressSignalE(output, error_type, error_str);
        Q_EMIT userAddressSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT userAddressSignalError(output, error_type, error_str);
        Q_EMIT userAddressSignalErrorFull(worker, error_type, error_str);
    }
}
