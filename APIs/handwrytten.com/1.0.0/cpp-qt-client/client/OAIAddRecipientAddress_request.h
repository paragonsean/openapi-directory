...
/*
 * OAIAddRecipientAddress_request.h
 *
 * 
 */

#ifndef OAIAddRecipientAddress_request_H
#define OAIAddRecipientAddress_request_H
...
class OAIAddRecipientAddress_request : public OAIObject {
public:
    OAIAddRecipientAddress_request();
    OAIAddRecipientAddress_request(QString json);
    ~OAIAddRecipientAddress_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddRecipientAddress_request)

#endif // OAIAddRecipientAddress_request_H
