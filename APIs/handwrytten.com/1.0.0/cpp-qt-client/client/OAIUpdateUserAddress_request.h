...
/*
 * OAIUpdateUserAddress_request.h
 *
 * 
 */

#ifndef OAIUpdateUserAddress_request_H
#define OAIUpdateUserAddress_request_H
...
class OAIUpdateUserAddress_request : public OAIObject {
public:
    OAIUpdateUserAddress_request();
    OAIUpdateUserAddress_request(QString json);
    ~OAIUpdateUserAddress_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserAddress_request)

#endif // OAIUpdateUserAddress_request_H
