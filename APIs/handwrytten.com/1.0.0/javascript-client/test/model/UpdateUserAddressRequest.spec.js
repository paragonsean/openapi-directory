...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HandwryttenApi.UpdateUserAddressRequest();
  });
  ...
  describe('UpdateUserAddressRequest', function() {
    it('should create an instance of UpdateUserAddressRequest', function() {
      // uncomment below and update the code to test UpdateUserAddressRequest
      //var instance = new HandwryttenApi.UpdateUserAddressRequest();
      //expect(instance).to.be.a(HandwryttenApi.UpdateUserAddressRequest);
    });
