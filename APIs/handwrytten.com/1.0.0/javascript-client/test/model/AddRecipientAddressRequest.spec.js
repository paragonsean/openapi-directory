...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HandwryttenApi.AddRecipientAddressRequest();
  });
  ...
  describe('AddRecipientAddressRequest', function() {
    it('should create an instance of AddRecipientAddressRequest', function() {
      // uncomment below and update the code to test AddRecipientAddressRequest
      //var instance = new HandwryttenApi.AddRecipientAddressRequest();
      //expect(instance).to.be.a(HandwryttenApi.AddRecipientAddressRequest);
    });
