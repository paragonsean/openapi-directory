...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HandwryttenApi.UpdateRecipientRequest();
  });
  ...
  describe('UpdateRecipientRequest', function() {
    it('should create an instance of UpdateRecipientRequest', function() {
      // uncomment below and update the code to test UpdateRecipientRequest
      //var instance = new HandwryttenApi.UpdateRecipientRequest();
      //expect(instance).to.be.a(HandwryttenApi.UpdateRecipientRequest);
    });
