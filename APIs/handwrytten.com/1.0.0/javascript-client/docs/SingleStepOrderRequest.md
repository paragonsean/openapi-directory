# HandwryttenApi.SingleStepOrderRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**cardId** | **Number** | the id of the card you want to send | 
**creditCardId** | **Number** | the credit card id to charge for the order.  Currently this is required, even for invoiced accounts, it just won&#39;t be charged. | [optional] 
**denominationId** | **Number** | Optional.  Use if sending a gift card | [optional] 
...
**recipientCountryId** | **Number** | alternate way to specify country.  Optional and defaults to 1 | [optional] 
...
**senderCountryId** | **Number** | alternate way to specify country.  Optional and defaults to 1 | [optional] 
