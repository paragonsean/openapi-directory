...
public class PostSearchResult {
  ...
  public static final String SERIALIZED_NAME_SEARCH_CONTENT = "search_content";
  @SerializedName(SERIALIZED_NAME_SEARCH_CONTENT)
  private String searchContent;

  public static final String SERIALIZED_NAME_SEARCH_TITLE = "search_title";
  @SerializedName(SERIALIZED_NAME_SEARCH_TITLE)
  private String searchTitle;

  public PostSearchResult() {
  }

  public PostSearchResult content(String content) {
  ...
  public PostSearchResult date(OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public PostSearchResult expiration(OffsetDateTime expiration) {
  ...
  public PostSearchResult footer(String footer) {
    this.footer = footer;
    return this;
  }
  ...
  public PostSearchResult groupId(String groupId) {
  ...
  public PostSearchResult latitude(BigDecimal latitude) {
  ...
  public PostSearchResult longitude(BigDecimal longitude) {
  ...
  public PostSearchResult outcome(String outcome) {
  ...
  public PostSearchResult photos(List<Photo> photos) {
    this.photos = photos;
    return this;
  }

  public PostSearchResult addPhotosItem(Photo photosItem) {
    if (this.photos == null) {
  ...
  public PostSearchResult postId(String postId) {
    this.postId = postId;
    return this;
  }
  ...
  public PostSearchResult repostCount(Integer repostCount) {
  ...
  public PostSearchResult reselling(Boolean reselling) {
  ...
  public PostSearchResult source(String source) {
    this.source = source;
    return this;
  }
  ...
  public PostSearchResult title(String title) {
    this.title = title;
    return this;
  }
  ...
  public PostSearchResult type(String type) {
    this.type = type;
    return this;
  }
  ...
  public PostSearchResult url(String url) {
    this.url = url;
    return this;
  }
  ...
  public PostSearchResult userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public PostSearchResult searchContent(String searchContent) {
  ...
  public PostSearchResult searchTitle(String searchTitle) {
  ...
  public boolean equals(Object o) {
    ...
    PostSearchResult postSearchResult = (PostSearchResult) o;
    return Objects.equals(this.content, postSearchResult.content) &&
        Objects.equals(this.date, postSearchResult.date) &&
        Objects.equals(this.expiration, postSearchResult.expiration) &&
        Objects.equals(this.footer, postSearchResult.footer) &&
        Objects.equals(this.groupId, postSearchResult.groupId) &&
        Objects.equals(this.latitude, postSearchResult.latitude) &&
        Objects.equals(this.longitude, postSearchResult.longitude) &&
        Objects.equals(this.outcome, postSearchResult.outcome) &&
        Objects.equals(this.photos, postSearchResult.photos) &&
        Objects.equals(this.postId, postSearchResult.postId) &&
        Objects.equals(this.repostCount, postSearchResult.repostCount) &&
        Objects.equals(this.reselling, postSearchResult.reselling) &&
        Objects.equals(this.source, postSearchResult.source) &&
        Objects.equals(this.title, postSearchResult.title) &&
        Objects.equals(this.type, postSearchResult.type) &&
        Objects.equals(this.url, postSearchResult.url) &&
        Objects.equals(this.userId, postSearchResult.userId) &&
        Objects.equals(this.searchContent, postSearchResult.searchContent) &&
        Objects.equals(this.searchTitle, postSearchResult.searchTitle);
  }

  @Override
  public int hashCode() {
    return Objects.hash(content, date, expiration, footer, groupId, latitude, longitude, outcome, photos, postId, repostCount, reselling, source, title, type, url, userId, searchContent, searchTitle);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PostSearchResult {\n");
    ...
    sb.append("    searchTitle: ").append(toIndentedString(searchTitle)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("search_content");
    openapiFields.add("search_title");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostSearchResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostSearchResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostSearchResult is not found in the empty JSON string", PostSearchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostSearchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostSearchResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("search_content") != null && !jsonObj.get("search_content").isJsonNull()) && !jsonObj.get("search_content").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `search_content` to be a primitive type in the JSON string but got `%s`", jsonObj.get("search_content").toString()));
      }
      if ((jsonObj.get("search_title") != null && !jsonObj.get("search_title").isJsonNull()) && !jsonObj.get("search_title").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `search_title` to be a primitive type in the JSON string but got `%s`", jsonObj.get("search_title").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostSearchResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostSearchResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostSearchResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostSearchResult.class));

       return (TypeAdapter<T>) new TypeAdapter<PostSearchResult>() {
           @Override
           public void write(JsonWriter out, PostSearchResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostSearchResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostSearchResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostSearchResult
   * @throws IOException if the JSON string is invalid with respect to PostSearchResult
   */
  public static PostSearchResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostSearchResult.class);
  }

  /**
   * Convert an instance of PostSearchResult to an JSON string
   *
   * @return JSON string
   */
