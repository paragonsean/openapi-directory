...
**date** | **Date** | The UTC date and time when the post was published. | [optional] 
**expiration** | **Date** | The UTC date and time when the post will expire.   Currently only offer and wanted posts expire.  For all other posts, expiration is always null.  | [optional] 
...
**latitude** | **Number** | May be null if a post hasn&#39;t been mapped. | [optional] 
**longitude** | **Number** | May be null if a post hasn&#39;t been mapped. | [optional] 
