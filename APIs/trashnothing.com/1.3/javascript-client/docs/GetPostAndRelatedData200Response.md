# TrashNothing.GetPostAndRelatedData200Response
...
**authorOfferCount** | **Number** | Count of offer posts made by the post author in the last 90 days. | [optional] 
**authorPosts** | [**[Post]**](Post.md) | Other active posts from the post author in the last 90 days. A maximum of 30 posts will be returned.  | [optional] 
**authorWantedCount** | **Number** | Count of wanted posts made by the post author in the last 90 days. | [optional] 
...
**feedback** | [**[Feedback]**](Feedback.md) | Feedback the current user has left on the post author. | [optional] 
**groups** | [**[Group]**](Group.md) | The groups the post is published on. | [optional] 
