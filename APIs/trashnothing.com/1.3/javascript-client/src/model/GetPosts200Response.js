...
/**
 * The GetPosts200Response model module.
 * @module model/GetPosts200Response
 * @version 1.3
 */
class GetPosts200Response {
    /**
     * Constructs a new <code>GetPosts200Response</code>.
     * @alias module:model/GetPosts200Response
     */
    constructor() { 
        
        GetPosts200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPosts200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPosts200Response} obj Optional instance to populate.
     * @return {module:model/GetPosts200Response} The populated <code>GetPosts200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPosts200Response();
            ...
            if (data.hasOwnProperty('last_listings_view')) {
                obj['last_listings_view'] = ApiClient.convertToType(data['last_listings_view'], 'Date');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPosts200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPosts200Response</code>.
     */
 ...
 */
GetPosts200Response.prototype['end_index'] = undefined;
 ...
 */
GetPosts200Response.prototype['group_ids'] = undefined;
 ...
 * @member {Date} last_listings_view
 */
GetPosts200Response.prototype['last_listings_view'] = undefined;

/**
 * The total number of pages available.
 * @member {Number} num_pages
 */
GetPosts200Response.prototype['num_pages'] = undefined;

/**
 * The total number of posts available.
 * @member {Number} num_posts
 */
GetPosts200Response.prototype['num_posts'] = undefined;

/**
 * The page number of the posts being returned.
 * @member {Number} page
 */
GetPosts200Response.prototype['page'] = undefined;

/**
 * The number of posts being returned per page.
 * @member {Number} per_page
 */
GetPosts200Response.prototype['per_page'] = undefined;

/**
 * @member {Array.<module:model/Post>} posts
 */
GetPosts200Response.prototype['posts'] = undefined;

/**
 * The index of the first post being returned (an integer between 1 and num_posts).
 * @member {Number} start_index
 */
GetPosts200Response.prototype['start_index'] = undefined;
...
export default GetPosts200Response;
