...
/**
 * The PostSearchResult model module.
 * @module model/PostSearchResult
 * @version 1.3
 */
class PostSearchResult {
    /**
     * Constructs a new <code>PostSearchResult</code>.
     * @alias module:model/PostSearchResult
     * @implements module:model/Post
     */
    constructor() { 
        Post.initialize(this);
        PostSearchResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PostSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostSearchResult} obj Optional instance to populate.
     * @return {module:model/PostSearchResult} The populated <code>PostSearchResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostSearchResult();
            Post.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('search_content')) {
                obj['search_content'] = ApiClient.convertToType(data['search_content'], 'String');
            }
            if (data.hasOwnProperty('search_title')) {
                obj['search_title'] = ApiClient.convertToType(data['search_title'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PostSearchResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostSearchResult</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['search_content'] && !(typeof data['search_content'] === 'string' || data['search_content'] instanceof String)) {
            throw new Error("Expected the field `search_content` to be a primitive type in the JSON string but got " + data['search_content']);
        }
        // ensure the json data is a string
        if (data['search_title'] && !(typeof data['search_title'] === 'string' || data['search_title'] instanceof String)) {
            throw new Error("Expected the field `search_title` to be a primitive type in the JSON string but got " + data['search_title']);
        }
 ...
 */
PostSearchResult.prototype['content'] = undefined;

/**
 * The UTC date and time when the post was published.
 * @member {Date} date
 */
PostSearchResult.prototype['date'] = undefined;
 ...
 */
PostSearchResult.prototype['expiration'] = undefined;
 ...
 */
PostSearchResult.prototype['footer'] = undefined;

/**
 * The group ID of the post.  For public posts, this is always null. 
 * @member {String} group_id
 */
PostSearchResult.prototype['group_id'] = undefined;

/**
 * May be null if a post hasn't been mapped.
 * @member {Number} latitude
 */
PostSearchResult.prototype['latitude'] = undefined;

/**
 * May be null if a post hasn't been mapped.
 * @member {Number} longitude
 */
PostSearchResult.prototype['longitude'] = undefined;
 ...
 */
PostSearchResult.prototype['outcome'] = undefined;
 ...
 */
PostSearchResult.prototype['photos'] = undefined;

/**
 * @member {String} post_id
 */
PostSearchResult.prototype['post_id'] = undefined;
 ...
 */
PostSearchResult.prototype['repost_count'] = undefined;
 ...
 */
PostSearchResult.prototype['reselling'] = undefined;
 ...
 */
PostSearchResult.prototype['source'] = undefined;

/**
 * @member {String} title
 */
PostSearchResult.prototype['title'] = undefined;

/**
 * The type of post.  One of: offer, taken, wanted, received, admin 
 * @member {String} type
 */
PostSearchResult.prototype['type'] = undefined;

/**
 * The link to use to view the post on the trash nothing site.
 * @member {String} url
 */
PostSearchResult.prototype['url'] = undefined;

/**
 * @member {String} user_id
 */
PostSearchResult.prototype['user_id'] = undefined;
 ...
 * @member {String} search_content
 */
PostSearchResult.prototype['search_content'] = undefined;
 ...
 * @member {String} search_title
 */
PostSearchResult.prototype['search_title'] = undefined;
