...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrashNothing.GroupMembershipQuestionnaire();
  });
  ...
  describe('GroupMembershipQuestionnaire', function() {
    it('should create an instance of GroupMembershipQuestionnaire', function() {
      // uncomment below and update the code to test GroupMembershipQuestionnaire
      //var instance = new TrashNothing.GroupMembershipQuestionnaire();
      //expect(instance).to.be.a(TrashNothing.GroupMembershipQuestionnaire);
    });
