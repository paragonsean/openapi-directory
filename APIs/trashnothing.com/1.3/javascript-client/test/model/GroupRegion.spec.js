...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrashNothing.GroupRegion();
  });
  ...
  describe('GroupRegion', function() {
    it('should create an instance of GroupRegion', function() {
      // uncomment below and update the code to test GroupRegion
      //var instance = new TrashNothing.GroupRegion();
      //expect(instance).to.be.a(TrashNothing.GroupRegion);
    });
