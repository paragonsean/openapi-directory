...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrashNothing.GetPosts200Response();
  });
  ...
  describe('GetPosts200Response', function() {
    it('should create an instance of GetPosts200Response', function() {
      // uncomment below and update the code to test GetPosts200Response
      //var instance = new TrashNothing.GetPosts200Response();
      //expect(instance).to.be.a(TrashNothing.GetPosts200Response);
    });
    ...
    it('should have the property lastListingsView (base name: "last_listings_view")', function() {
      // uncomment below and update the code to test the property lastListingsView
      //var instance = new TrashNothing.GetPosts200Response();
      //expect(instance).to.be();
    });
