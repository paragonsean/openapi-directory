...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrashNothing.PostSearchResult();
  });
  ...
  describe('PostSearchResult', function() {
    it('should create an instance of PostSearchResult', function() {
      // uncomment below and update the code to test PostSearchResult
      //var instance = new TrashNothing.PostSearchResult();
      //expect(instance).to.be.a(TrashNothing.PostSearchResult);
    });
    ...
    it('should have the property searchContent (base name: "search_content")', function() {
      // uncomment below and update the code to test the property searchContent
      //var instance = new TrashNothing.PostSearchResult();
      //expect(instance).to.be();
    });

    it('should have the property searchTitle (base name: "search_title")', function() {
      // uncomment below and update the code to test the property searchTitle
      //var instance = new TrashNothing.PostSearchResult();
      //expect(instance).to.be();
    });
