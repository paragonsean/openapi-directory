...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrashNothing.SearchGroups200Response();
  });
  ...
  describe('SearchGroups200Response', function() {
    it('should create an instance of SearchGroups200Response', function() {
      // uncomment below and update the code to test SearchGroups200Response
      //var instance = new TrashNothing.SearchGroups200Response();
      //expect(instance).to.be.a(TrashNothing.SearchGroups200Response);
    });
    ...
    it('should have the property numGroups (base name: "num_groups")', function() {
