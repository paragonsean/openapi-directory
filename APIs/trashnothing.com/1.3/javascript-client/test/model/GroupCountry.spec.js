...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrashNothing.GroupCountry();
  });
  ...
  describe('GroupCountry', function() {
    it('should create an instance of GroupCountry', function() {
      // uncomment below and update the code to test GroupCountry
      //var instance = new TrashNothing.GroupCountry();
      //expect(instance).to.be.a(TrashNothing.GroupCountry);
    });
