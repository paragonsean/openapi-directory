...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrashNothing.UserFeedback();
  });
  ...
  describe('UserFeedback', function() {
    it('should create an instance of UserFeedback', function() {
      // uncomment below and update the code to test UserFeedback
      //var instance = new TrashNothing.UserFeedback();
      //expect(instance).to.be.a(TrashNothing.UserFeedback);
    });

    it('should have the property percentPositive (base name: "percent_positive")', function() {
      // uncomment below and update the code to test the property percentPositive
      //var instance = new TrashNothing.UserFeedback();
