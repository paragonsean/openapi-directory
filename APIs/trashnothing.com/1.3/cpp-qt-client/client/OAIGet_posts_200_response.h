...
/*
 * OAIGet_posts_200_response.h
 *
 * 
 */

#ifndef OAIGet_posts_200_response_H
#define OAIGet_posts_200_response_H
...
class OAIGet_posts_200_response : public OAIObject {
public:
    OAIGet_posts_200_response();
    OAIGet_posts_200_response(QString json);
    ~OAIGet_posts_200_response() override;
    ...
    QDateTime getLastListingsView() const;
    void setLastListingsView(const QDateTime &last_listings_view);
    bool is_last_listings_view_Set() const;
    bool is_last_listings_view_Valid() const;
...
private:
    ...
    QDateTime m_last_listings_view;
    bool m_last_listings_view_isSet;
    bool m_last_listings_view_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_posts_200_response)

#endif // OAIGet_posts_200_response_H
