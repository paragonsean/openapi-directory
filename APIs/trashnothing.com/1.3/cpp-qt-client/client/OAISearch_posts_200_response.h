...
/*
 * OAISearch_posts_200_response.h
 *
 * 
 */

#ifndef OAISearch_posts_200_response_H
#define OAISearch_posts_200_response_H
...
namespace OpenAPI {
class OAIPostSearchResult;

class OAISearch_posts_200_response : public OAIObject {
public:
    OAISearch_posts_200_response();
    OAISearch_posts_200_response(QString json);
    ~OAISearch_posts_200_response() override;
    ...
    qint32 getNumPosts() const;
    void setNumPosts(const qint32 &num_posts);
    bool is_num_posts_Set() const;
    bool is_num_posts_Valid() const;
    ...
    QList<OAIPostSearchResult> getPosts() const;
    void setPosts(const QList<OAIPostSearchResult> &posts);
...
private:
    ...
    qint32 m_num_posts;
    bool m_num_posts_isSet;
    bool m_num_posts_isValid;
    ...
    QList<OAIPostSearchResult> m_posts;
    bool m_posts_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearch_posts_200_response)

#endif // OAISearch_posts_200_response_H
