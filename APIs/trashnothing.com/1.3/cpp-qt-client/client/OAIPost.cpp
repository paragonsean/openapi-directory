...
QDateTime OAIPost::getDate() const {
    return m_date;
}
void OAIPost::setDate(const QDateTime &date) {
    m_date = date;
    m_date_isSet = true;
}

bool OAIPost::is_date_Set() const{
    return m_date_isSet;
}

bool OAIPost::is_date_Valid() const{
    return m_date_isValid;
}

QDateTime OAIPost::getExpiration() const {
    return m_expiration;
}
void OAIPost::setExpiration(const QDateTime &expiration) {
    m_expiration = expiration;
    m_expiration_isSet = true;
}

bool OAIPost::is_expiration_Set() const{
    return m_expiration_isSet;
}

bool OAIPost::is_expiration_Valid() const{
    return m_expiration_isValid;
}

QString OAIPost::getFooter() const {
    return m_footer;
}
void OAIPost::setFooter(const QString &footer) {
    m_footer = footer;
    m_footer_isSet = true;
}

bool OAIPost::is_footer_Set() const{
    return m_footer_isSet;
}

bool OAIPost::is_footer_Valid() const{
    return m_footer_isValid;
}

QString OAIPost::getGroupId() const {
    return m_group_id;
}
void OAIPost::setGroupId(const QString &group_id) {
    m_group_id = group_id;
    m_group_id_isSet = true;
}

bool OAIPost::is_group_id_Set() const{
    return m_group_id_isSet;
}

bool OAIPost::is_group_id_Valid() const{
    return m_group_id_isValid;
}

double OAIPost::getLatitude() const {
    return m_latitude;
}
void OAIPost::setLatitude(const double &latitude) {
    m_latitude = latitude;
    m_latitude_isSet = true;
}

bool OAIPost::is_latitude_Set() const{
    return m_latitude_isSet;
}

bool OAIPost::is_latitude_Valid() const{
    return m_latitude_isValid;
}

double OAIPost::getLongitude() const {
    return m_longitude;
}
void OAIPost::setLongitude(const double &longitude) {
    m_longitude = longitude;
    m_longitude_isSet = true;
}

bool OAIPost::is_longitude_Set() const{
    return m_longitude_isSet;
}

bool OAIPost::is_longitude_Valid() const{
    return m_longitude_isValid;
}

QString OAIPost::getOutcome() const {
    return m_outcome;
}
void OAIPost::setOutcome(const QString &outcome) {
    m_outcome = outcome;
    m_outcome_isSet = true;
}

bool OAIPost::is_outcome_Set() const{
    return m_outcome_isSet;
}

bool OAIPost::is_outcome_Valid() const{
    return m_outcome_isValid;
}

QList<OAIPhoto> OAIPost::getPhotos() const {
    return m_photos;
}
void OAIPost::setPhotos(const QList<OAIPhoto> &photos) {
    m_photos = photos;
    m_photos_isSet = true;
}

bool OAIPost::is_photos_Set() const{
    return m_photos_isSet;
}

bool OAIPost::is_photos_Valid() const{
    return m_photos_isValid;
}

QString OAIPost::getPostId() const {
    return m_post_id;
}
void OAIPost::setPostId(const QString &post_id) {
    m_post_id = post_id;
    m_post_id_isSet = true;
}

bool OAIPost::is_post_id_Set() const{
    return m_post_id_isSet;
}

bool OAIPost::is_post_id_Valid() const{
    return m_post_id_isValid;
}

qint32 OAIPost::getRepostCount() const {
    return m_repost_count;
}
void OAIPost::setRepostCount(const qint32 &repost_count) {
    m_repost_count = repost_count;
    m_repost_count_isSet = true;
}

bool OAIPost::is_repost_count_Set() const{
    return m_repost_count_isSet;
}

bool OAIPost::is_repost_count_Valid() const{
    return m_repost_count_isValid;
}

bool OAIPost::isReselling() const {
    return m_reselling;
}
void OAIPost::setReselling(const bool &reselling) {
    m_reselling = reselling;
    m_reselling_isSet = true;
}

bool OAIPost::is_reselling_Set() const{
    return m_reselling_isSet;
}

bool OAIPost::is_reselling_Valid() const{
    return m_reselling_isValid;
}

QString OAIPost::getSource() const {
    return m_source;
}
void OAIPost::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIPost::is_source_Set() const{
    return m_source_isSet;
}

bool OAIPost::is_source_Valid() const{
...
QString OAIPost::getType() const {
    return m_type;
}
void OAIPost::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPost::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPost::is_type_Valid() const{
...
QString OAIPost::getUserId() const {
    return m_user_id;
}
void OAIPost::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIPost::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIPost::is_user_id_Valid() const{
