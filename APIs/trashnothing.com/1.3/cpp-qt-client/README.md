...
void Example::exampleFunction1(){
     OAIGroupsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIGroupsApi::getGroupSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIGroupsApi::getGroupSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString group_id = create(); // QString | The ID of the group to retrieve.
      apiInstance.getGroup(group_id);
