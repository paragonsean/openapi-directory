...
public class JettisonRequest {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JettisonRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JettisonRequest is not found in the empty JSON string", JettisonRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JettisonRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JettisonRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JettisonRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JettisonRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<JettisonRequest>() {
           @Override
           public void write(JsonWriter out, JettisonRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JettisonRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JettisonRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JettisonRequest
   * @throws IOException if the JSON string is invalid with respect to JettisonRequest
   */
  public static JettisonRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JettisonRequest.class);
  }

  /**
   * Convert an instance of JettisonRequest to an JSON string
   *
   * @return JSON string
   */
