...
public class NavigateShip200ResponseData {
  ...
  public NavigateShip200ResponseData fuel(Object fuel) {
    this.fuel = fuel;
    return this;
  }
  ...
  public NavigateShip200ResponseData nav(Object nav) {
    this.nav = nav;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NavigateShip200ResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NavigateShip200ResponseData is not found in the empty JSON string", NavigateShip200ResponseData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NavigateShip200ResponseData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NavigateShip200ResponseData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
