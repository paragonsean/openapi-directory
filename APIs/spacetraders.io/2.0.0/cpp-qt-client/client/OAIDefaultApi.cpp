...
void OAIDefaultApi::r_register(const ::OpenAPI::OptionalParam<OAIRegister_request> &oai_register_request) {
    ...
    if (oai_register_request.hasValue()){

        
        QByteArray output = oai_register_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::r_registerCallback);
...
void OAIDefaultApi::r_registerCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIRegister_201_response output(QString(worker->response));
    worker->deleteLater();
