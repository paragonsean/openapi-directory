...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.Register201ResponseDataShip();
  });
  ...
  describe('Register201ResponseDataShip', function() {
    it('should create an instance of Register201ResponseDataShip', function() {
      // uncomment below and update the code to test Register201ResponseDataShip
      //var instance = new SpaceTradersApi.Register201ResponseDataShip();
      //expect(instance).to.be.a(SpaceTradersApi.Register201ResponseDataShip);
    });
