...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.CreateSurvey201ResponseDataSurveysInner();
  });
  ...
  describe('CreateSurvey201ResponseDataSurveysInner', function() {
    it('should create an instance of CreateSurvey201ResponseDataSurveysInner', function() {
      // uncomment below and update the code to test CreateSurvey201ResponseDataSurveysInner
      //var instance = new SpaceTradersApi.CreateSurvey201ResponseDataSurveysInner();
      //expect(instance).to.be.a(SpaceTradersApi.CreateSurvey201ResponseDataSurveysInner);
    });
