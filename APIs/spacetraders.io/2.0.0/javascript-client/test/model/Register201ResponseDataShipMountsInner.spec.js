...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.Register201ResponseDataShipMountsInner();
  });
  ...
  describe('Register201ResponseDataShipMountsInner', function() {
    it('should create an instance of Register201ResponseDataShipMountsInner', function() {
      // uncomment below and update the code to test Register201ResponseDataShipMountsInner
      //var instance = new SpaceTradersApi.Register201ResponseDataShipMountsInner();
      //expect(instance).to.be.a(SpaceTradersApi.Register201ResponseDataShipMountsInner);
    });
