...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.Register201ResponseDataShipFrame();
  });
  ...
  describe('Register201ResponseDataShipFrame', function() {
    it('should create an instance of Register201ResponseDataShipFrame', function() {
      // uncomment below and update the code to test Register201ResponseDataShipFrame
      //var instance = new SpaceTradersApi.Register201ResponseDataShipFrame();
      //expect(instance).to.be.a(SpaceTradersApi.Register201ResponseDataShipFrame);
    });
