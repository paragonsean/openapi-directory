...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.Register201ResponseDataShipCargo();
  });
  ...
  describe('Register201ResponseDataShipCargo', function() {
    it('should create an instance of Register201ResponseDataShipCargo', function() {
      // uncomment below and update the code to test Register201ResponseDataShipCargo
      //var instance = new SpaceTradersApi.Register201ResponseDataShipCargo();
      //expect(instance).to.be.a(SpaceTradersApi.Register201ResponseDataShipCargo);
    });
