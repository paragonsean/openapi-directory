...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.Register201ResponseDataShipNavRoute();
  });
  ...
  describe('Register201ResponseDataShipNavRoute', function() {
    it('should create an instance of Register201ResponseDataShipNavRoute', function() {
      // uncomment below and update the code to test Register201ResponseDataShipNavRoute
      //var instance = new SpaceTradersApi.Register201ResponseDataShipNavRoute();
      //expect(instance).to.be.a(SpaceTradersApi.Register201ResponseDataShipNavRoute);
    });
