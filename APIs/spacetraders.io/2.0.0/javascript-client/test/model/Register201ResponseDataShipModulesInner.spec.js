...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.Register201ResponseDataShipModulesInner();
  });
  ...
  describe('Register201ResponseDataShipModulesInner', function() {
    it('should create an instance of Register201ResponseDataShipModulesInner', function() {
      // uncomment below and update the code to test Register201ResponseDataShipModulesInner
      //var instance = new SpaceTradersApi.Register201ResponseDataShipModulesInner();
      //expect(instance).to.be.a(SpaceTradersApi.Register201ResponseDataShipModulesInner);
    });
