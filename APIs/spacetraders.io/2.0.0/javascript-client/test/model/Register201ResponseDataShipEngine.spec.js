...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.Register201ResponseDataShipEngine();
  });
  ...
  describe('Register201ResponseDataShipEngine', function() {
    it('should create an instance of Register201ResponseDataShipEngine', function() {
      // uncomment below and update the code to test Register201ResponseDataShipEngine
      //var instance = new SpaceTradersApi.Register201ResponseDataShipEngine();
      //expect(instance).to.be.a(SpaceTradersApi.Register201ResponseDataShipEngine);
    });
