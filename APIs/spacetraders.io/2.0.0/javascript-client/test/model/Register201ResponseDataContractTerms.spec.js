...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.Register201ResponseDataContractTerms();
  });
  ...
  describe('Register201ResponseDataContractTerms', function() {
    it('should create an instance of Register201ResponseDataContractTerms', function() {
      // uncomment below and update the code to test Register201ResponseDataContractTerms
      //var instance = new SpaceTradersApi.Register201ResponseDataContractTerms();
      //expect(instance).to.be.a(SpaceTradersApi.Register201ResponseDataContractTerms);
    });
