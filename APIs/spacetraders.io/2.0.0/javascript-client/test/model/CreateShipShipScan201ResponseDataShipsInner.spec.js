...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.CreateShipShipScan201ResponseDataShipsInner();
  });
  ...
  describe('CreateShipShipScan201ResponseDataShipsInner', function() {
    it('should create an instance of CreateShipShipScan201ResponseDataShipsInner', function() {
      // uncomment below and update the code to test CreateShipShipScan201ResponseDataShipsInner
      //var instance = new SpaceTradersApi.CreateShipShipScan201ResponseDataShipsInner();
      //expect(instance).to.be.a(SpaceTradersApi.CreateShipShipScan201ResponseDataShipsInner);
    });
