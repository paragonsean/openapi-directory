...
**actions** | [**[Action]**](Action.md) | list of actions combined in the loop are executed step-by-step | [optional] 
**times** | **Number** | The number of times to scroll down a web page. | [optional] 
**scrollByPixels** | **Number** | Scrolls a web page by the number of pixels specified by &#39;scrollByPixels&#39; parameter. | [optional] 
