...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowKitWebScraper.Scroll();
  });
  ...
  describe('Scroll', function() {
    it('should create an instance of Scroll', function() {
      // uncomment below and update the code to test Scroll
      //var instance = new DataflowKitWebScraper.Scroll();
      //expect(instance).to.be.a(DataflowKitWebScraper.Scroll);
    });
