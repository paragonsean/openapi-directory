...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowKitWebScraper.Getcontent();
  });
  ...
  describe('Getcontent', function() {
    it('should create an instance of Getcontent', function() {
      // uncomment below and update the code to test Getcontent
      //var instance = new DataflowKitWebScraper.Getcontent();
      //expect(instance).to.be.a(DataflowKitWebScraper.Getcontent);
    });
