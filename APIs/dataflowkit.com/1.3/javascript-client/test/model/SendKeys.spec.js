...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowKitWebScraper.SendKeys();
  });
  ...
  describe('SendKeys', function() {
    it('should create an instance of SendKeys', function() {
      // uncomment below and update the code to test SendKeys
      //var instance = new DataflowKitWebScraper.SendKeys();
      //expect(instance).to.be.a(DataflowKitWebScraper.SendKeys);
    });
