...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowKitWebScraper.DoubleClick();
  });
  ...
  describe('DoubleClick', function() {
    it('should create an instance of DoubleClick', function() {
      // uncomment below and update the code to test DoubleClick
      //var instance = new DataflowKitWebScraper.DoubleClick();
      //expect(instance).to.be.a(DataflowKitWebScraper.DoubleClick);
    });
