...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowKitWebScraper.Fetchrequest();
  });
  ...
  describe('Fetchrequest', function() {
    it('should create an instance of Fetchrequest', function() {
      ...
      //var instance = new DataflowKitWebScraper.Fetchrequest();
      //expect(instance).to.be.a(DataflowKitWebScraper.Fetchrequest);
    });
