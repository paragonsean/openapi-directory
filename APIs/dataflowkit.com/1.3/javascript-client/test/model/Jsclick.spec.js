...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowKitWebScraper.Jsclick();
  });
  ...
  describe('Jsclick', function() {
    it('should create an instance of Jsclick', function() {
      // uncomment below and update the code to test Jsclick
      //var instance = new DataflowKitWebScraper.Jsclick();
      //expect(instance).to.be.a(DataflowKitWebScraper.Jsclick);
    });
