...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowKitWebScraper.Pause();
  });
  ...
  describe('Pause', function() {
    it('should create an instance of Pause', function() {
      // uncomment below and update the code to test Pause
      //var instance = new DataflowKitWebScraper.Pause();
      //expect(instance).to.be.a(DataflowKitWebScraper.Pause);
    });
