...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowKitWebScraper.LoopTimes();
  });
  ...
  describe('LoopTimes', function() {
    it('should create an instance of LoopTimes', function() {
      // uncomment below and update the code to test LoopTimes
      //var instance = new DataflowKitWebScraper.LoopTimes();
      //expect(instance).to.be.a(DataflowKitWebScraper.LoopTimes);
    });
