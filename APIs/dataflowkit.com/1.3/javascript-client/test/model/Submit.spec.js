...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowKitWebScraper.Submit();
  });
  ...
  describe('Submit', function() {
    it('should create an instance of Submit', function() {
      // uncomment below and update the code to test Submit
      //var instance = new DataflowKitWebScraper.Submit();
      //expect(instance).to.be.a(DataflowKitWebScraper.Submit);
    });
