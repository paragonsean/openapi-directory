...
/**
 * API tests for UrlToPdfApi
 */
@Disabled
public class UrlToPdfApiTest {

    private final UrlToPdfApi api = new UrlToPdfApi();
     ...
     */
    @Test
    public void urlToPdfTest() throws ApiException {
        Url2pdfrequest url2pdfrequest = null;
        File response = api.urlToPdf(url2pdfrequest);
