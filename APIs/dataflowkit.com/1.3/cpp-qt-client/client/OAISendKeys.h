...
#ifndef OAISendKeys_H
#define OAISendKeys_H
...
class OAISendKeys : public OAIObject {
public:
    OAISendKeys();
    OAISendKeys(QString json);
    ~OAISendKeys() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendKeys)
