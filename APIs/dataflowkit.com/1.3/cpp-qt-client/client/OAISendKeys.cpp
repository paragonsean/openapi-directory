...
OAISendKeys::OAISendKeys(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendKeys::OAISendKeys() {
    this->initializeModel();
}

OAISendKeys::~OAISendKeys() {}

void OAISendKeys::initializeModel() {
...
void OAISendKeys::fromJson(QString jsonString) {
...
void OAISendKeys::fromJsonObject(QJsonObject json) {
...
QString OAISendKeys::asJson() const {
...
QJsonObject OAISendKeys::asJsonObject() const {
    QJsonObject obj;
...
bool OAISendKeys::isIgnoreIfNotPresent() const {
    return m_ignore_if_not_present;
}
void OAISendKeys::setIgnoreIfNotPresent(const bool &ignore_if_not_present) {
    m_ignore_if_not_present = ignore_if_not_present;
    m_ignore_if_not_present_isSet = true;
}

bool OAISendKeys::is_ignore_if_not_present_Set() const{
    return m_ignore_if_not_present_isSet;
}

bool OAISendKeys::is_ignore_if_not_present_Valid() const{
    return m_ignore_if_not_present_isValid;
}

QString OAISendKeys::getSelector() const {
    return m_selector;
}
void OAISendKeys::setSelector(const QString &selector) {
    m_selector = selector;
    m_selector_isSet = true;
}

bool OAISendKeys::is_selector_Set() const{
    return m_selector_isSet;
}

bool OAISendKeys::is_selector_Valid() const{
    return m_selector_isValid;
}

QString OAISendKeys::getValue() const {
    return m_value;
}
void OAISendKeys::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAISendKeys::is_value_Set() const{
    return m_value_isSet;
}

bool OAISendKeys::is_value_Valid() const{
    return m_value_isValid;
}

bool OAISendKeys::isSet() const {
...
bool OAISendKeys::isValid() const {
