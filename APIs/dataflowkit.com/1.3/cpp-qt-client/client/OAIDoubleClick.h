...
#ifndef OAIDoubleClick_H
#define OAIDoubleClick_H
...
class OAIDoubleClick : public OAIObject {
public:
    OAIDoubleClick();
    OAIDoubleClick(QString json);
    ~OAIDoubleClick() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDoubleClick)

#endif // OAIDoubleClick_H
