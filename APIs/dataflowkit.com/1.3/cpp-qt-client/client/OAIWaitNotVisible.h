...
#ifndef OAIWaitNotVisible_H
#define OAIWaitNotVisible_H
...
class OAIWaitNotVisible : public OAIObject {
public:
    OAIWaitNotVisible();
    OAIWaitNotVisible(QString json);
    ~OAIWaitNotVisible() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWaitNotVisible)

#endif // OAIWaitNotVisible_H
