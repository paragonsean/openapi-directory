...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ColorNameApi.ColorLab();
  });
  ...
  describe('ColorLab', function() {
    it('should create an instance of ColorLab', function() {
      // uncomment below and update the code to test ColorLab
      //var instance = new ColorNameApi.ColorLab();
      //expect(instance).to.be.a(ColorNameApi.ColorLab);
    });
