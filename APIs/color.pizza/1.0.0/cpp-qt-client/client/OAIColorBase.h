...
#ifndef OAIColorBase_H
#define OAIColorBase_H
...
class OAIColor_lab;
class OAIColor_rgb;
class OAIColorBase_swatchImg;

class OAIColorBase : public OAIObject {
public:
    OAIColorBase();
    OAIColorBase(QString json);
    ~OAIColorBase() override;
    ...
    OAIColorBase_swatchImg getSwatchImg() const;
    void setSwatchImg(const OAIColorBase_swatchImg &swatch_img);
...
private:
    ...
    OAIColorBase_swatchImg m_swatch_img;
...
Q_DECLARE_METATYPE(OpenAPI::OAIColorBase)

#endif // OAIColorBase_H
