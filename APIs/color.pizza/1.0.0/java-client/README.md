...
Color Name API
- API version: 1.0.0
  - Build date: 2024-10-12T11:17:38.891030-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**listsGet**](docs/DefaultApi.md#listsGet) | **GET** /lists/ | Get all colors of the default color name list
*DefaultApi* | [**namesGet**](docs/DefaultApi.md#namesGet) | **GET** /names/ | Get all colors of the default color name list
*DefaultApi* | [**rootGet**](docs/DefaultApi.md#rootGet) | **GET** / | Get all colors of the default color name list
*DefaultApi* | [**swatchGet**](docs/DefaultApi.md#swatchGet) | **GET** /swatch/ | Generate a color swatch for any color
