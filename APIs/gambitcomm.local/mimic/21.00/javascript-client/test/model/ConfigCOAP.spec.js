...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MimicRestApi.ConfigCOAP();
  });
  ...
  describe('ConfigCOAP', function() {
    it('should create an instance of ConfigCOAP', function() {
      // uncomment below and update the code to test ConfigCOAP
      //var instance = new MimicRestApi.ConfigCOAP();
      //expect(instance).to.be.a(MimicRestApi.ConfigCOAP);
    });
