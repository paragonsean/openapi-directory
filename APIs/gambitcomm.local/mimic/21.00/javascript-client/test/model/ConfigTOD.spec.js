...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MimicRestApi.ConfigTOD();
  });
  ...
  describe('ConfigTOD', function() {
    it('should create an instance of ConfigTOD', function() {
      // uncomment below and update the code to test ConfigTOD
      //var instance = new MimicRestApi.ConfigTOD();
      //expect(instance).to.be.a(MimicRestApi.ConfigTOD);
    });
