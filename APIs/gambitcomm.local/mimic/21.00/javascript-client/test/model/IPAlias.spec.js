...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MimicRestApi.IPAlias();
  });
  ...
  describe('IPAlias', function() {
    it('should create an instance of IPAlias', function() {
      // uncomment below and update the code to test IPAlias
      //var instance = new MimicRestApi.IPAlias();
      //expect(instance).to.be.a(MimicRestApi.IPAlias);
    });
