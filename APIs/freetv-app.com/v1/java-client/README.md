...
News Plugin
- API version: v1
  - Build date: 2024-10-12T12:00:07.866601-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**getLatestNews**](docs/DefaultApi.md#getLatestNews) | **GET** /services?funcs&#x3D;GetLatestNewsForChatGPT&amp;mobile&#x3D;1 | 
