...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://staging2.freetv-app.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("getLatestNews", defaultConf);
    _serverIndices.insert("getLatestNews", 0);
}
...
void OAIDefaultApi::getLatestNews(const QString &language, const ::OpenAPI::OptionalParam<QString> &category, const ::OpenAPI::OptionalParam<QString> &keyword) {
    QString fullPath = QString(_serverConfigs["getLatestNews"][_serverIndices.value("getLatestNews")].URL()+"/services?funcs=GetLatestNewsForChatGPT&mobile=1");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getLatestNewsCallback);
...
void OAIDefaultApi::getLatestNewsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAILatestNewsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getLatestNewsSignal(output);
        Q_EMIT getLatestNewsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getLatestNewsSignalE(output, error_type, error_str);
        Q_EMIT getLatestNewsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getLatestNewsSignalError(output, error_type, error_str);
        Q_EMIT getLatestNewsSignalErrorFull(worker, error_type, error_str);
    }
}
