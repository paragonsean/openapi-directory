...
/*
 * OAIQuoteResponse_contents.h
 *
 * 
 */

#ifndef OAIQuoteResponse_contents_H
#define OAIQuoteResponse_contents_H
...
class OAIQuoteResponse_contents : public OAIObject {
public:
    OAIQuoteResponse_contents();
    OAIQuoteResponse_contents(QString json);
    ~OAIQuoteResponse_contents() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuoteResponse_contents)

#endif // OAIQuoteResponse_contents_H
