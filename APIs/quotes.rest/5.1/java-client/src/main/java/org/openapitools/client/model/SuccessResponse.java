...
public class SuccessResponse {
  ...
  public SuccessResponse contents(List<Object> contents) {
    this.contents = contents;
    return this;
  }

  public SuccessResponse addContentsItem(Object contentsItem) {
  ...
  public SuccessResponse success(String success) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contents, successResponse.contents) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuccessResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SuccessResponse is not found in the empty JSON string", SuccessResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SuccessResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SuccessResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
