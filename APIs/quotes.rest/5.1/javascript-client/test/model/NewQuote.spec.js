...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheySaidSoQuotesApi.NewQuote();
  });
  ...
  describe('NewQuote', function() {
    it('should create an instance of NewQuote', function() {
      // uncomment below and update the code to test NewQuote
      //var instance = new TheySaidSoQuotesApi.NewQuote();
      //expect(instance).to.be.a(TheySaidSoQuotesApi.NewQuote);
    });
