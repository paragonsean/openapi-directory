...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheySaidSoQuotesApi.QuoteResponse();
  });
  ...
  describe('QuoteResponse', function() {
    it('should create an instance of QuoteResponse', function() {
      // uncomment below and update the code to test QuoteResponse
      //var instance = new TheySaidSoQuotesApi.QuoteResponse();
      //expect(instance).to.be.a(TheySaidSoQuotesApi.QuoteResponse);
    });
