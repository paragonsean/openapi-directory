...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheySaidSoQuotesApi.SuccessResponse();
  });
  ...
  describe('SuccessResponse', function() {
    it('should create an instance of SuccessResponse', function() {
      ...
      //var instance = new TheySaidSoQuotesApi.SuccessResponse();
      //expect(instance).to.be.a(TheySaidSoQuotesApi.SuccessResponse);
    });
