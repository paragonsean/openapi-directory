...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheySaidSoQuotesApi.QODResponse();
  });
  ...
  describe('QODResponse', function() {
    it('should create an instance of QODResponse', function() {
      // uncomment below and update the code to test QODResponse
      //var instance = new TheySaidSoQuotesApi.QODResponse();
      //expect(instance).to.be.a(TheySaidSoQuotesApi.QODResponse);
    });
