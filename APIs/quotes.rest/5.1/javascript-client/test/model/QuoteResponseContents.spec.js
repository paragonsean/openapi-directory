...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheySaidSoQuotesApi.QuoteResponseContents();
  });
  ...
  describe('QuoteResponseContents', function() {
    it('should create an instance of QuoteResponseContents', function() {
      // uncomment below and update the code to test QuoteResponseContents
      //var instance = new TheySaidSoQuotesApi.QuoteResponseContents();
      //expect(instance).to.be.a(TheySaidSoQuotesApi.QuoteResponseContents);
    });
