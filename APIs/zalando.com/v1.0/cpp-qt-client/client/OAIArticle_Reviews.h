...
/*
 * OAIArticle_Reviews.h
 *
 * Zalando API Paged Article Reviews Schema
 */

#ifndef OAIArticle_Reviews_H
#define OAIArticle_Reviews_H
...
namespace OpenAPI {
class OAIArticle_Review;

class OAIArticle_Reviews : public OAIObject {
public:
    OAIArticle_Reviews();
    OAIArticle_Reviews(QString json);
    ~OAIArticle_Reviews() override;
    ...
    QList<OAIArticle_Review> getContent() const;
    void setContent(const QList<OAIArticle_Review> &content);
...
private:
    ...
    QList<OAIArticle_Review> m_content;
...
Q_DECLARE_METATYPE(OpenAPI::OAIArticle_Reviews)

#endif // OAIArticle_Reviews_H
