...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZalandoShop.CategoriesApi();
  });
  ...
  describe('CategoriesApi', function() {
    ...
    describe('categoriesKeyGet', function() {
      it('should call categoriesKeyGet successfully', function(done) {
        //uncomment below and update the code to test categoriesKeyGet
        //instance.categoriesKeyGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
