...
class Categories {
    ...
    constructor(page, size, totalElements, totalPages) { 
        ...
        Categories.initialize(this, page, size, totalElements, totalPages);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [Category]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Categories.RequiredProperties) {
...
Categories.RequiredProperties = ["page", "size", "totalElements", "totalPages"];

/**
 * @member {Array.<module:model/Category>} content
 */
Categories.prototype['content'] = undefined;
