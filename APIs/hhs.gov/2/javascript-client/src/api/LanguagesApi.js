...
export default class LanguagesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the resourcesLanguagesIdJsonGet operation.
     * @callback module:api/LanguagesApi~resourcesLanguagesIdJsonGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/LanguageWrapped>} data The data returned by the service call.
     ...
     * @param {Number} id The id of the language to look up
     * @param {module:api/LanguagesApi~resourcesLanguagesIdJsonGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/LanguageWrapped>}
     */
    resourcesLanguagesIdJsonGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling resourcesLanguagesIdJsonGet");
      }
      ...
      let returnType = [LanguageWrapped];
      return this.apiClient.callApi(
        '/resources/languages/{id}.json', 'GET',
    ...
    /**
     * Callback function to receive the result of the resourcesLanguagesJsonGet operation.
     * @callback module:api/LanguagesApi~resourcesLanguagesJsonGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/LanguageWrapped>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/LanguagesApi~resourcesLanguagesJsonGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/LanguageWrapped>}
     */
    resourcesLanguagesJsonGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
