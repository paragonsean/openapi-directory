...
/**
 * The MetaWrapped model module.
 * @module model/MetaWrapped
 * @version 2
 */
class MetaWrapped {
    /**
     * Constructs a new <code>MetaWrapped</code>.
     * @alias module:model/MetaWrapped
     */
    constructor() { 
        
        MetaWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MetaWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MetaWrapped} obj Optional instance to populate.
     * @return {module:model/MetaWrapped} The populated <code>MetaWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetaWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [Meta]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MetaWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetaWrapped</code>.
     */
 ...
 */
MetaWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
MetaWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Meta>} results
 */
MetaWrapped.prototype['results'] = undefined;
