...
/**
 * The PaginationWrapped model module.
 * @module model/PaginationWrapped
 * @version 2
 */
class PaginationWrapped {
    /**
     * Constructs a new <code>PaginationWrapped</code>.
     * @alias module:model/PaginationWrapped
     */
    constructor() { 
        
        PaginationWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaginationWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaginationWrapped} obj Optional instance to populate.
     * @return {module:model/PaginationWrapped} The populated <code>PaginationWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaginationWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [Pagination]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaginationWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaginationWrapped</code>.
     */
 ...
 */
PaginationWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
PaginationWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Pagination>} results
 */
PaginationWrapped.prototype['results'] = undefined;
