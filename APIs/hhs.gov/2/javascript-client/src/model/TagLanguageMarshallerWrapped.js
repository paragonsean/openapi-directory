...
/**
 * The TagLanguageMarshallerWrapped model module.
 * @module model/TagLanguageMarshallerWrapped
 * @version 2
 */
class TagLanguageMarshallerWrapped {
    /**
     * Constructs a new <code>TagLanguageMarshallerWrapped</code>.
     * @alias module:model/TagLanguageMarshallerWrapped
     */
    constructor() { 
        
        TagLanguageMarshallerWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TagLanguageMarshallerWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagLanguageMarshallerWrapped} obj Optional instance to populate.
     * @return {module:model/TagLanguageMarshallerWrapped} The populated <code>TagLanguageMarshallerWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagLanguageMarshallerWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [TagLanguageMarshaller]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TagLanguageMarshallerWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagLanguageMarshallerWrapped</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                TagLanguageMarshaller.validateJSON(item);
            };
        }
 ...
 */
TagLanguageMarshallerWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
TagLanguageMarshallerWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/TagLanguageMarshaller>} results
 */
TagLanguageMarshallerWrapped.prototype['results'] = undefined;
...
export default TagLanguageMarshallerWrapped;
