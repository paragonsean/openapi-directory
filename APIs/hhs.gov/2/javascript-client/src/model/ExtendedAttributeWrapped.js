...
/**
 * The ExtendedAttributeWrapped model module.
 * @module model/ExtendedAttributeWrapped
 * @version 2
 */
class ExtendedAttributeWrapped {
    /**
     * Constructs a new <code>ExtendedAttributeWrapped</code>.
     * @alias module:model/ExtendedAttributeWrapped
     */
    constructor() { 
        
        ExtendedAttributeWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExtendedAttributeWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtendedAttributeWrapped} obj Optional instance to populate.
     * @return {module:model/ExtendedAttributeWrapped} The populated <code>ExtendedAttributeWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtendedAttributeWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [ExtendedAttribute]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExtendedAttributeWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtendedAttributeWrapped</code>.
     */
 ...
 */
ExtendedAttributeWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
ExtendedAttributeWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/ExtendedAttribute>} results
 */
ExtendedAttributeWrapped.prototype['results'] = undefined;
...
export default ExtendedAttributeWrapped;
