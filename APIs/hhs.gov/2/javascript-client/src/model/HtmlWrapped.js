...
/**
 * The HtmlWrapped model module.
 * @module model/HtmlWrapped
 * @version 2
 */
class HtmlWrapped {
    /**
     * Constructs a new <code>HtmlWrapped</code>.
     * @alias module:model/HtmlWrapped
     */
    constructor() { 
        
        HtmlWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HtmlWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HtmlWrapped} obj Optional instance to populate.
     * @return {module:model/HtmlWrapped} The populated <code>HtmlWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HtmlWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [Html]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>HtmlWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HtmlWrapped</code>.
     */
 ...
 */
HtmlWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
HtmlWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Html>} results
 */
HtmlWrapped.prototype['results'] = undefined;
