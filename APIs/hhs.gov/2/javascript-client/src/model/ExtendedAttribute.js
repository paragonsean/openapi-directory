...
/**
 * The ExtendedAttribute model module.
 * @module model/ExtendedAttribute
 * @version 2
 */
class ExtendedAttribute {
    /**
     * Constructs a new <code>ExtendedAttribute</code>.
     * @alias module:model/ExtendedAttribute
     */
    constructor() { 
        
        ExtendedAttribute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExtendedAttribute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtendedAttribute} obj Optional instance to populate.
     * @return {module:model/ExtendedAttribute} The populated <code>ExtendedAttribute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtendedAttribute();
    ...
    /**
     * Validates the JSON data with respect to <code>ExtendedAttribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtendedAttribute</code>.
     */
 ...
 * @member {Number} id
 */
ExtendedAttribute.prototype['id'] = undefined;

/**
 * @member {String} name
 */
ExtendedAttribute.prototype['name'] = undefined;

/**
 * @member {String} value
 */
ExtendedAttribute.prototype['value'] = undefined;
