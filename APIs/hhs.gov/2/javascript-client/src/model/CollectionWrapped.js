...
/**
 * The CollectionWrapped model module.
 * @module model/CollectionWrapped
 * @version 2
 */
class CollectionWrapped {
    /**
     * Constructs a new <code>CollectionWrapped</code>.
     * @alias module:model/CollectionWrapped
     */
    constructor() { 
        
        CollectionWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CollectionWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CollectionWrapped} obj Optional instance to populate.
     * @return {module:model/CollectionWrapped} The populated <code>CollectionWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CollectionWrapped();
    ...
    /**
     * Validates the JSON data with respect to <code>CollectionWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CollectionWrapped</code>.
     */
 ...
 */
CollectionWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
CollectionWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Collection>} results
 */
CollectionWrapped.prototype['results'] = undefined;
...
export default CollectionWrapped;
