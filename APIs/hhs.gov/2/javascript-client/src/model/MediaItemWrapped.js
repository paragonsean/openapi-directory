...
/**
 * The MediaItemWrapped model module.
 * @module model/MediaItemWrapped
 * @version 2
 */
class MediaItemWrapped {
    /**
     * Constructs a new <code>MediaItemWrapped</code>.
     * @alias module:model/MediaItemWrapped
     */
    constructor() { 
        
        MediaItemWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediaItemWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediaItemWrapped} obj Optional instance to populate.
     * @return {module:model/MediaItemWrapped} The populated <code>MediaItemWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediaItemWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [MediaItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediaItemWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediaItemWrapped</code>.
     */
 ...
 */
MediaItemWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
MediaItemWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/MediaItem>} results
 */
MediaItemWrapped.prototype['results'] = undefined;
...
export default MediaItemWrapped;
