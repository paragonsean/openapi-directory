...
/**
 * The TagMarshallerWrapped model module.
 * @module model/TagMarshallerWrapped
 * @version 2
 */
class TagMarshallerWrapped {
    /**
     * Constructs a new <code>TagMarshallerWrapped</code>.
     * @alias module:model/TagMarshallerWrapped
     */
    constructor() { 
        
        TagMarshallerWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TagMarshallerWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagMarshallerWrapped} obj Optional instance to populate.
     * @return {module:model/TagMarshallerWrapped} The populated <code>TagMarshallerWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagMarshallerWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [TagMarshaller]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TagMarshallerWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagMarshallerWrapped</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                TagMarshaller.validateJSON(item);
            };
        }
 ...
 */
TagMarshallerWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
TagMarshallerWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/TagMarshaller>} results
 */
TagMarshallerWrapped.prototype['results'] = undefined;
...
export default TagMarshallerWrapped;
