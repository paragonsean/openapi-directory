...
/**
 * The CampaignWrapped model module.
 * @module model/CampaignWrapped
 * @version 2
 */
class CampaignWrapped {
    /**
     * Constructs a new <code>CampaignWrapped</code>.
     * @alias module:model/CampaignWrapped
     */
    constructor() { 
        
        CampaignWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CampaignWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CampaignWrapped} obj Optional instance to populate.
     * @return {module:model/CampaignWrapped} The populated <code>CampaignWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignWrapped();
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignWrapped</code>.
     */
 ...
 */
CampaignWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
CampaignWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Campaign>} results
 */
CampaignWrapped.prototype['results'] = undefined;
...
export default CampaignWrapped;
