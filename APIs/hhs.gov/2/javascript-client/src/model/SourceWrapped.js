...
/**
 * The SourceWrapped model module.
 * @module model/SourceWrapped
 * @version 2
 */
class SourceWrapped {
    /**
     * Constructs a new <code>SourceWrapped</code>.
     * @alias module:model/SourceWrapped
     */
    constructor() { 
        
        SourceWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SourceWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SourceWrapped} obj Optional instance to populate.
     * @return {module:model/SourceWrapped} The populated <code>SourceWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SourceWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [Source]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SourceWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SourceWrapped</code>.
     */
 ...
 */
SourceWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
SourceWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Source>} results
 */
SourceWrapped.prototype['results'] = undefined;
