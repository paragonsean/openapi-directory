...
/**
 * The ImageWrapped model module.
 * @module model/ImageWrapped
 * @version 2
 */
class ImageWrapped {
    /**
     * Constructs a new <code>ImageWrapped</code>.
     * @alias module:model/ImageWrapped
     */
    constructor() { 
        
        ImageWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImageWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageWrapped} obj Optional instance to populate.
     * @return {module:model/ImageWrapped} The populated <code>ImageWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageWrapped();
    ...
    /**
     * Validates the JSON data with respect to <code>ImageWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageWrapped</code>.
     */
 ...
 */
ImageWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
ImageWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Image>} results
 */
ImageWrapped.prototype['results'] = undefined;
