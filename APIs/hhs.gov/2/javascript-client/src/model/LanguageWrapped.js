...
/**
 * The LanguageWrapped model module.
 * @module model/LanguageWrapped
 * @version 2
 */
class LanguageWrapped {
    /**
     * Constructs a new <code>LanguageWrapped</code>.
     * @alias module:model/LanguageWrapped
     */
    constructor() { 
        
        LanguageWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LanguageWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LanguageWrapped} obj Optional instance to populate.
     * @return {module:model/LanguageWrapped} The populated <code>LanguageWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LanguageWrapped();
    ...
    /**
     * Validates the JSON data with respect to <code>LanguageWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LanguageWrapped</code>.
     */
 ...
 */
LanguageWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
LanguageWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Language>} results
 */
LanguageWrapped.prototype['results'] = undefined;
...
export default LanguageWrapped;
