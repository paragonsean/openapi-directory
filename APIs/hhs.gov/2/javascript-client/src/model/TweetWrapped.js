...
/**
 * The TweetWrapped model module.
 * @module model/TweetWrapped
 * @version 2
 */
class TweetWrapped {
    /**
     * Constructs a new <code>TweetWrapped</code>.
     * @alias module:model/TweetWrapped
     */
    constructor() { 
        
        TweetWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TweetWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TweetWrapped} obj Optional instance to populate.
     * @return {module:model/TweetWrapped} The populated <code>TweetWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TweetWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [Tweet]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TweetWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TweetWrapped</code>.
     */
 ...
 */
TweetWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
TweetWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Tweet>} results
 */
TweetWrapped.prototype['results'] = undefined;
