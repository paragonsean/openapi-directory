...
/**
 * The TagLanguageMarshaller model module.
 * @module model/TagLanguageMarshaller
 * @version 2
 */
class TagLanguageMarshaller {
    /**
     * Constructs a new <code>TagLanguageMarshaller</code>.
     * @alias module:model/TagLanguageMarshaller
     */
    constructor() { 
        
        TagLanguageMarshaller.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TagLanguageMarshaller</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagLanguageMarshaller} obj Optional instance to populate.
     * @return {module:model/TagLanguageMarshaller} The populated <code>TagLanguageMarshaller</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagLanguageMarshaller();
    ...
    /**
     * Validates the JSON data with respect to <code>TagLanguageMarshaller</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagLanguageMarshaller</code>.
     */
 ...
 * @member {Number} id
 */
TagLanguageMarshaller.prototype['id'] = undefined;

/**
 * @member {Boolean} isActive
 */
TagLanguageMarshaller.prototype['isActive'] = undefined;

/**
 * @member {String} isoCode
 */
TagLanguageMarshaller.prototype['isoCode'] = undefined;

/**
 * @member {String} name
 */
TagLanguageMarshaller.prototype['name'] = undefined;
...
export default TagLanguageMarshaller;
