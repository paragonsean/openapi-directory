...
/**
 * The VideoWrapped model module.
 * @module model/VideoWrapped
 * @version 2
 */
class VideoWrapped {
    /**
     * Constructs a new <code>VideoWrapped</code>.
     * @alias module:model/VideoWrapped
     */
    constructor() { 
        
        VideoWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VideoWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VideoWrapped} obj Optional instance to populate.
     * @return {module:model/VideoWrapped} The populated <code>VideoWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VideoWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [Video]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VideoWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VideoWrapped</code>.
     */
 ...
 */
VideoWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
VideoWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Video>} results
 */
VideoWrapped.prototype['results'] = undefined;
