...
/**
 * The TagTypeMarshaller model module.
 * @module model/TagTypeMarshaller
 * @version 2
 */
class TagTypeMarshaller {
    /**
     * Constructs a new <code>TagTypeMarshaller</code>.
     * @alias module:model/TagTypeMarshaller
     */
    constructor() { 
        
        TagTypeMarshaller.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TagTypeMarshaller</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagTypeMarshaller} obj Optional instance to populate.
     * @return {module:model/TagTypeMarshaller} The populated <code>TagTypeMarshaller</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagTypeMarshaller();
    ...
    /**
     * Validates the JSON data with respect to <code>TagTypeMarshaller</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagTypeMarshaller</code>.
     */
 ...
 * @member {Number} id
 */
TagTypeMarshaller.prototype['id'] = undefined;

/**
 * @member {String} name
 */
TagTypeMarshaller.prototype['name'] = undefined;
...
export default TagTypeMarshaller;
