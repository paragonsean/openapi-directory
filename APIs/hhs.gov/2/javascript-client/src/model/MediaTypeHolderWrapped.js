...
/**
 * The MediaTypeHolderWrapped model module.
 * @module model/MediaTypeHolderWrapped
 * @version 2
 */
class MediaTypeHolderWrapped {
    /**
     * Constructs a new <code>MediaTypeHolderWrapped</code>.
     * @alias module:model/MediaTypeHolderWrapped
     */
    constructor() { 
        
        MediaTypeHolderWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MediaTypeHolderWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MediaTypeHolderWrapped} obj Optional instance to populate.
     * @return {module:model/MediaTypeHolderWrapped} The populated <code>MediaTypeHolderWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediaTypeHolderWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [MediaTypeHolder]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MediaTypeHolderWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MediaTypeHolderWrapped</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                MediaTypeHolder.validateJSON(item);
            };
        }
 ...
 */
MediaTypeHolderWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
MediaTypeHolderWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/MediaTypeHolder>} results
 */
MediaTypeHolderWrapped.prototype['results'] = undefined;
...
export default MediaTypeHolderWrapped;
