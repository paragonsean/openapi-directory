...
/**
 * The AlternateImageWrapped model module.
 * @module model/AlternateImageWrapped
 * @version 2
 */
class AlternateImageWrapped {
    /**
     * Constructs a new <code>AlternateImageWrapped</code>.
     * @alias module:model/AlternateImageWrapped
     */
    constructor() { 
        
        AlternateImageWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AlternateImageWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AlternateImageWrapped} obj Optional instance to populate.
     * @return {module:model/AlternateImageWrapped} The populated <code>AlternateImageWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AlternateImageWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [AlternateImage]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AlternateImageWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AlternateImageWrapped</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                AlternateImage.validateJSON(item);
            };
        }
 ...
 */
AlternateImageWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
AlternateImageWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/AlternateImage>} results
 */
AlternateImageWrapped.prototype['results'] = undefined;
...
export default AlternateImageWrapped;
