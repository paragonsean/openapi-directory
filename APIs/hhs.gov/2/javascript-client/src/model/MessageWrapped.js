...
/**
 * The MessageWrapped model module.
 * @module model/MessageWrapped
 * @version 2
 */
class MessageWrapped {
    /**
     * Constructs a new <code>MessageWrapped</code>.
     * @alias module:model/MessageWrapped
     */
    constructor() { 
        
        MessageWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MessageWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageWrapped} obj Optional instance to populate.
     * @return {module:model/MessageWrapped} The populated <code>MessageWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageWrapped();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageWrapped</code>.
     */
 ...
 */
MessageWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
MessageWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/Message>} results
 */
MessageWrapped.prototype['results'] = undefined;
