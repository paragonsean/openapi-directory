...
/**
 * The SyndicateMarshallerWrapped model module.
 * @module model/SyndicateMarshallerWrapped
 * @version 2
 */
class SyndicateMarshallerWrapped {
    /**
     * Constructs a new <code>SyndicateMarshallerWrapped</code>.
     * @alias module:model/SyndicateMarshallerWrapped
     */
    constructor() { 
        
        SyndicateMarshallerWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SyndicateMarshallerWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyndicateMarshallerWrapped} obj Optional instance to populate.
     * @return {module:model/SyndicateMarshallerWrapped} The populated <code>SyndicateMarshallerWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SyndicateMarshallerWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [SyndicateMarshaller]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SyndicateMarshallerWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SyndicateMarshallerWrapped</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                SyndicateMarshaller.validateJSON(item);
            };
        }
 ...
 */
SyndicateMarshallerWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
SyndicateMarshallerWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/SyndicateMarshaller>} results
 */
SyndicateMarshallerWrapped.prototype['results'] = undefined;
...
export default SyndicateMarshallerWrapped;
