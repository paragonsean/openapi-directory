...
/**
 * The PDFWrapped model module.
 * @module model/PDFWrapped
 * @version 2
 */
class PDFWrapped {
    /**
     * Constructs a new <code>PDFWrapped</code>.
     * @alias module:model/PDFWrapped
     */
    constructor() { 
        
        PDFWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PDFWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PDFWrapped} obj Optional instance to populate.
     * @return {module:model/PDFWrapped} The populated <code>PDFWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PDFWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [PDF]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PDFWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PDFWrapped</code>.
     */
 ...
 */
PDFWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
PDFWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/PDF>} results
 */
PDFWrapped.prototype['results'] = undefined;
