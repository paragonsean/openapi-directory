...
/**
 * The YoutubeMetadataWrapped model module.
 * @module model/YoutubeMetadataWrapped
 * @version 2
 */
class YoutubeMetadataWrapped {
    /**
     * Constructs a new <code>YoutubeMetadataWrapped</code>.
     * @alias module:model/YoutubeMetadataWrapped
     */
    constructor() { 
        
        YoutubeMetadataWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>YoutubeMetadataWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/YoutubeMetadataWrapped} obj Optional instance to populate.
     * @return {module:model/YoutubeMetadataWrapped} The populated <code>YoutubeMetadataWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new YoutubeMetadataWrapped();
    ...
    /**
     * Validates the JSON data with respect to <code>YoutubeMetadataWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>YoutubeMetadataWrapped</code>.
     */
 ...
 */
YoutubeMetadataWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
YoutubeMetadataWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<Object>} results
 */
YoutubeMetadataWrapped.prototype['results'] = undefined;
...
export default YoutubeMetadataWrapped;
