...
/**
 * The TagTypeMarshallerWrapped model module.
 * @module model/TagTypeMarshallerWrapped
 * @version 2
 */
class TagTypeMarshallerWrapped {
    /**
     * Constructs a new <code>TagTypeMarshallerWrapped</code>.
     * @alias module:model/TagTypeMarshallerWrapped
     */
    constructor() { 
        
        TagTypeMarshallerWrapped.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TagTypeMarshallerWrapped</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagTypeMarshallerWrapped} obj Optional instance to populate.
     * @return {module:model/TagTypeMarshallerWrapped} The populated <code>TagTypeMarshallerWrapped</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagTypeMarshallerWrapped();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [TagTypeMarshaller]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TagTypeMarshallerWrapped</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TagTypeMarshallerWrapped</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                TagTypeMarshaller.validateJSON(item);
            };
        }
 ...
 */
TagTypeMarshallerWrapped.prototype['callback'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
TagTypeMarshallerWrapped.prototype['meta'] = undefined;

/**
 * @member {Array.<module:model/TagTypeMarshaller>} results
 */
TagTypeMarshallerWrapped.prototype['results'] = undefined;
...
export default TagTypeMarshallerWrapped;
