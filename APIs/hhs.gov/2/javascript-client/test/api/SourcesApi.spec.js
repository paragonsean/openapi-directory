...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.SourcesApi();
  });
  ...
  describe('SourcesApi', function() {
    describe('resourcesSourcesIdJsonGet', function() {
      it('should call resourcesSourcesIdJsonGet successfully', function(done) {
        //uncomment below and update the code to test resourcesSourcesIdJsonGet
        //instance.resourcesSourcesIdJsonGet(function(error) {
    ...
    describe('resourcesSourcesIdSyndicateFormatGet', function() {
      it('should call resourcesSourcesIdSyndicateFormatGet successfully', function(done) {
        //uncomment below and update the code to test resourcesSourcesIdSyndicateFormatGet
        //instance.resourcesSourcesIdSyndicateFormatGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('resourcesSourcesJsonGet', function() {
      it('should call resourcesSourcesJsonGet successfully', function(done) {
        //uncomment below and update the code to test resourcesSourcesJsonGet
        //instance.resourcesSourcesJsonGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
