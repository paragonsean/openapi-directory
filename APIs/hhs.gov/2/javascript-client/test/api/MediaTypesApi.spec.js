...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.MediaTypesApi();
  });
  ...
  describe('MediaTypesApi', function() {
    describe('resourcesMediaTypesFormatGet', function() {
      it('should call resourcesMediaTypesFormatGet successfully', function(done) {
        //uncomment below and update the code to test resourcesMediaTypesFormatGet
        //instance.resourcesMediaTypesFormatGet(function(error) {
