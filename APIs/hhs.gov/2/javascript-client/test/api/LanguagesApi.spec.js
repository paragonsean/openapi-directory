...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.LanguagesApi();
  });
  ...
  describe('LanguagesApi', function() {
    describe('resourcesLanguagesIdJsonGet', function() {
      it('should call resourcesLanguagesIdJsonGet successfully', function(done) {
        //uncomment below and update the code to test resourcesLanguagesIdJsonGet
        //instance.resourcesLanguagesIdJsonGet(function(error) {
    ...
    describe('resourcesLanguagesJsonGet', function() {
      it('should call resourcesLanguagesJsonGet successfully', function(done) {
        //uncomment below and update the code to test resourcesLanguagesJsonGet
        //instance.resourcesLanguagesJsonGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
