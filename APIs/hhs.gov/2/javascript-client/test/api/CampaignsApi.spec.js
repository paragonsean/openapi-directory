...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.CampaignsApi();
  });
  ...
  describe('CampaignsApi', function() {
    describe('resourcesCampaignsIdJsonGet', function() {
      it('should call resourcesCampaignsIdJsonGet successfully', function(done) {
        //uncomment below and update the code to test resourcesCampaignsIdJsonGet
        //instance.resourcesCampaignsIdJsonGet(function(error) {
    ...
    describe('resourcesCampaignsIdMediaJsonGet', function() {
      it('should call resourcesCampaignsIdMediaJsonGet successfully', function(done) {
        //uncomment below and update the code to test resourcesCampaignsIdMediaJsonGet
        //instance.resourcesCampaignsIdMediaJsonGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('resourcesCampaignsIdSyndicateFormatGet', function() {
      it('should call resourcesCampaignsIdSyndicateFormatGet successfully', function(done) {
        //uncomment below and update the code to test resourcesCampaignsIdSyndicateFormatGet
        //instance.resourcesCampaignsIdSyndicateFormatGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('resourcesCampaignsJsonGet', function() {
      it('should call resourcesCampaignsJsonGet successfully', function(done) {
        //uncomment below and update the code to test resourcesCampaignsJsonGet
        //instance.resourcesCampaignsJsonGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
