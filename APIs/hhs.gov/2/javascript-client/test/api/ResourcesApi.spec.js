...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.ResourcesApi();
  });
  ...
  describe('ResourcesApi', function() {
    describe('resourcesJsonGet', function() {
      it('should call resourcesJsonGet successfully', function(done) {
        //uncomment below and update the code to test resourcesJsonGet
        //instance.resourcesJsonGet(function(error) {
