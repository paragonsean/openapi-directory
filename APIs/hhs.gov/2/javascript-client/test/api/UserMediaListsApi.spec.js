...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.UserMediaListsApi();
  });
  ...
  describe('UserMediaListsApi', function() {
    describe('resourcesUserMediaListsIdJsonGet', function() {
      it('should call resourcesUserMediaListsIdJsonGet successfully', function(done) {
        //uncomment below and update the code to test resourcesUserMediaListsIdJsonGet
        //instance.resourcesUserMediaListsIdJsonGet(function(error) {
