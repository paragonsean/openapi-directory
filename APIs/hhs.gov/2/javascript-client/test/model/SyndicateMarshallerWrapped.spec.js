...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.SyndicateMarshallerWrapped();
  });
  ...
  describe('SyndicateMarshallerWrapped', function() {
    it('should create an instance of SyndicateMarshallerWrapped', function() {
      // uncomment below and update the code to test SyndicateMarshallerWrapped
      //var instance = new HhsMediaServicesApi.SyndicateMarshallerWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.SyndicateMarshallerWrapped);
    });
