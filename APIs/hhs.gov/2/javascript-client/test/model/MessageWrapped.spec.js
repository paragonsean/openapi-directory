...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.MessageWrapped();
  });
  ...
  describe('MessageWrapped', function() {
    it('should create an instance of MessageWrapped', function() {
      // uncomment below and update the code to test MessageWrapped
      //var instance = new HhsMediaServicesApi.MessageWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.MessageWrapped);
    });
