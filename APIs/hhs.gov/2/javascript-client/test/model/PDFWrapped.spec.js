...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.PDFWrapped();
  });
  ...
  describe('PDFWrapped', function() {
    it('should create an instance of PDFWrapped', function() {
      // uncomment below and update the code to test PDFWrapped
      //var instance = new HhsMediaServicesApi.PDFWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.PDFWrapped);
    });
