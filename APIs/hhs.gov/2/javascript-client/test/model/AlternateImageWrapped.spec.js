...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.AlternateImageWrapped();
  });
  ...
  describe('AlternateImageWrapped', function() {
    it('should create an instance of AlternateImageWrapped', function() {
      // uncomment below and update the code to test AlternateImageWrapped
      //var instance = new HhsMediaServicesApi.AlternateImageWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.AlternateImageWrapped);
    });
