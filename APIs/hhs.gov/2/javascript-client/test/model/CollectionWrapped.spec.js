...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.CollectionWrapped();
  });
  ...
  describe('CollectionWrapped', function() {
    it('should create an instance of CollectionWrapped', function() {
      // uncomment below and update the code to test CollectionWrapped
      //var instance = new HhsMediaServicesApi.CollectionWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.CollectionWrapped);
    });
