...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.ImageWrapped();
  });
  ...
  describe('ImageWrapped', function() {
    it('should create an instance of ImageWrapped', function() {
      // uncomment below and update the code to test ImageWrapped
      //var instance = new HhsMediaServicesApi.ImageWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.ImageWrapped);
    });
