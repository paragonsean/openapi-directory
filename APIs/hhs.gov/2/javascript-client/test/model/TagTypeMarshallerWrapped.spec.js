...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.TagTypeMarshallerWrapped();
  });
  ...
  describe('TagTypeMarshallerWrapped', function() {
    it('should create an instance of TagTypeMarshallerWrapped', function() {
      // uncomment below and update the code to test TagTypeMarshallerWrapped
      //var instance = new HhsMediaServicesApi.TagTypeMarshallerWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.TagTypeMarshallerWrapped);
    });
