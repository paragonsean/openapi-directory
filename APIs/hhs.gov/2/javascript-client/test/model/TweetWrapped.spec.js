...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.TweetWrapped();
  });
  ...
  describe('TweetWrapped', function() {
    it('should create an instance of TweetWrapped', function() {
      // uncomment below and update the code to test TweetWrapped
      //var instance = new HhsMediaServicesApi.TweetWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.TweetWrapped);
    });
