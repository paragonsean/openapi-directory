...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.PaginationWrapped();
  });
  ...
  describe('PaginationWrapped', function() {
    it('should create an instance of PaginationWrapped', function() {
      // uncomment below and update the code to test PaginationWrapped
      //var instance = new HhsMediaServicesApi.PaginationWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.PaginationWrapped);
    });
