...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.HtmlWrapped();
  });
  ...
  describe('HtmlWrapped', function() {
    it('should create an instance of HtmlWrapped', function() {
      // uncomment below and update the code to test HtmlWrapped
      //var instance = new HhsMediaServicesApi.HtmlWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.HtmlWrapped);
    });
