...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.MetaWrapped();
  });
  ...
  describe('MetaWrapped', function() {
    it('should create an instance of MetaWrapped', function() {
      // uncomment below and update the code to test MetaWrapped
      //var instance = new HhsMediaServicesApi.MetaWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.MetaWrapped);
    });
