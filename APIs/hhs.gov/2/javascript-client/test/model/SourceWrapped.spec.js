...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.SourceWrapped();
  });
  ...
  describe('SourceWrapped', function() {
    it('should create an instance of SourceWrapped', function() {
      // uncomment below and update the code to test SourceWrapped
      //var instance = new HhsMediaServicesApi.SourceWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.SourceWrapped);
    });
