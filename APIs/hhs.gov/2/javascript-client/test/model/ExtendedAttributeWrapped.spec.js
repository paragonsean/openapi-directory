...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.ExtendedAttributeWrapped();
  });
  ...
  describe('ExtendedAttributeWrapped', function() {
    it('should create an instance of ExtendedAttributeWrapped', function() {
      // uncomment below and update the code to test ExtendedAttributeWrapped
      //var instance = new HhsMediaServicesApi.ExtendedAttributeWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.ExtendedAttributeWrapped);
    });
