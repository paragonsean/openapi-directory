...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.SyndicateMarshaller();
  });
  ...
  describe('SyndicateMarshaller', function() {
    it('should create an instance of SyndicateMarshaller', function() {
      // uncomment below and update the code to test SyndicateMarshaller
      //var instance = new HhsMediaServicesApi.SyndicateMarshaller();
      //expect(instance).to.be.a(HhsMediaServicesApi.SyndicateMarshaller);
    });
