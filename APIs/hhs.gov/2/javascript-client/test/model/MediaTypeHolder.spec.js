...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.MediaTypeHolder();
  });
  ...
  describe('MediaTypeHolder', function() {
    it('should create an instance of MediaTypeHolder', function() {
      // uncomment below and update the code to test MediaTypeHolder
      //var instance = new HhsMediaServicesApi.MediaTypeHolder();
      //expect(instance).to.be.a(HhsMediaServicesApi.MediaTypeHolder);
    });
