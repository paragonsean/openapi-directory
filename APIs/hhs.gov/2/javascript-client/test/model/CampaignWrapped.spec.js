...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.CampaignWrapped();
  });
  ...
  describe('CampaignWrapped', function() {
    it('should create an instance of CampaignWrapped', function() {
      // uncomment below and update the code to test CampaignWrapped
      //var instance = new HhsMediaServicesApi.CampaignWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.CampaignWrapped);
    });
