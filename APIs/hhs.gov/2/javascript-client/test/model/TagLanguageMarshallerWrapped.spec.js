...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.TagLanguageMarshallerWrapped();
  });
  ...
  describe('TagLanguageMarshallerWrapped', function() {
    it('should create an instance of TagLanguageMarshallerWrapped', function() {
      // uncomment below and update the code to test TagLanguageMarshallerWrapped
      //var instance = new HhsMediaServicesApi.TagLanguageMarshallerWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.TagLanguageMarshallerWrapped);
    });
