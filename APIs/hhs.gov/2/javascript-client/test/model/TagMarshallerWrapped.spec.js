...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.TagMarshallerWrapped();
  });
  ...
  describe('TagMarshallerWrapped', function() {
    it('should create an instance of TagMarshallerWrapped', function() {
      // uncomment below and update the code to test TagMarshallerWrapped
      //var instance = new HhsMediaServicesApi.TagMarshallerWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.TagMarshallerWrapped);
    });
