...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.TagTypeMarshaller();
  });
  ...
  describe('TagTypeMarshaller', function() {
    it('should create an instance of TagTypeMarshaller', function() {
      // uncomment below and update the code to test TagTypeMarshaller
      //var instance = new HhsMediaServicesApi.TagTypeMarshaller();
      //expect(instance).to.be.a(HhsMediaServicesApi.TagTypeMarshaller);
    });
