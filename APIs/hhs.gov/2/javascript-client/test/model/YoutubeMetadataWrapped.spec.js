...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.YoutubeMetadataWrapped();
  });
  ...
  describe('YoutubeMetadataWrapped', function() {
    it('should create an instance of YoutubeMetadataWrapped', function() {
      // uncomment below and update the code to test YoutubeMetadataWrapped
      //var instance = new HhsMediaServicesApi.YoutubeMetadataWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.YoutubeMetadataWrapped);
    });
