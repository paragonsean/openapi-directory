...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.ResourcesMediaIdYoutubeMetaDataJsonGet200Response();
  });
  ...
  describe('ResourcesMediaIdYoutubeMetaDataJsonGet200Response', function() {
    it('should create an instance of ResourcesMediaIdYoutubeMetaDataJsonGet200Response', function() {
      // uncomment below and update the code to test ResourcesMediaIdYoutubeMetaDataJsonGet200Response
      //var instance = new HhsMediaServicesApi.ResourcesMediaIdYoutubeMetaDataJsonGet200Response();
      //expect(instance).to.be.a(HhsMediaServicesApi.ResourcesMediaIdYoutubeMetaDataJsonGet200Response);
    });
