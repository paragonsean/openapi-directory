...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.MediaItemWrapped();
  });
  ...
  describe('MediaItemWrapped', function() {
    it('should create an instance of MediaItemWrapped', function() {
      // uncomment below and update the code to test MediaItemWrapped
      //var instance = new HhsMediaServicesApi.MediaItemWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.MediaItemWrapped);
    });
