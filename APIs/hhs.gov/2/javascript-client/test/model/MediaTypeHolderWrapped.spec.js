...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.MediaTypeHolderWrapped();
  });
  ...
  describe('MediaTypeHolderWrapped', function() {
    it('should create an instance of MediaTypeHolderWrapped', function() {
      // uncomment below and update the code to test MediaTypeHolderWrapped
      //var instance = new HhsMediaServicesApi.MediaTypeHolderWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.MediaTypeHolderWrapped);
    });
