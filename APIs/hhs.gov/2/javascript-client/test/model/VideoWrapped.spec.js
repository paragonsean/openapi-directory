...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.VideoWrapped();
  });
  ...
  describe('VideoWrapped', function() {
    it('should create an instance of VideoWrapped', function() {
      // uncomment below and update the code to test VideoWrapped
      //var instance = new HhsMediaServicesApi.VideoWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.VideoWrapped);
    });
