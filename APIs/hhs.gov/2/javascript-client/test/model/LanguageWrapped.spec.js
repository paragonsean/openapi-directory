...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.LanguageWrapped();
  });
  ...
  describe('LanguageWrapped', function() {
    it('should create an instance of LanguageWrapped', function() {
      // uncomment below and update the code to test LanguageWrapped
      //var instance = new HhsMediaServicesApi.LanguageWrapped();
      //expect(instance).to.be.a(HhsMediaServicesApi.LanguageWrapped);
    });
