...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.TagMarshaller();
  });
  ...
  describe('TagMarshaller', function() {
    it('should create an instance of TagMarshaller', function() {
      // uncomment below and update the code to test TagMarshaller
      //var instance = new HhsMediaServicesApi.TagMarshaller();
      //expect(instance).to.be.a(HhsMediaServicesApi.TagMarshaller);
    });
