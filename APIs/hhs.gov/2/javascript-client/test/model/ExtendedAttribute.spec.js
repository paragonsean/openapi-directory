...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.ExtendedAttribute();
  });
  ...
  describe('ExtendedAttribute', function() {
    it('should create an instance of ExtendedAttribute', function() {
      // uncomment below and update the code to test ExtendedAttribute
      //var instance = new HhsMediaServicesApi.ExtendedAttribute();
      //expect(instance).to.be.a(HhsMediaServicesApi.ExtendedAttribute);
    });
