...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HhsMediaServicesApi.AlternateImage();
  });
  ...
  describe('AlternateImage', function() {
    it('should create an instance of AlternateImage', function() {
      // uncomment below and update the code to test AlternateImage
      //var instance = new HhsMediaServicesApi.AlternateImage();
      //expect(instance).to.be.a(HhsMediaServicesApi.AlternateImage);
    });
