...
QList<OAICampaign> OAICollection::getCampaigns() const {
    return m_campaigns;
}
void OAICollection::setCampaigns(const QList<OAICampaign> &campaigns) {
    m_campaigns = campaigns;
    m_campaigns_isSet = true;
}

bool OAICollection::is_campaigns_Set() const{
    return m_campaigns_isSet;
}

bool OAICollection::is_campaigns_Valid() const{
    return m_campaigns_isValid;
}

QString OAICollection::getCreatedBy() const {
    return m_created_by;
}
void OAICollection::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAICollection::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAICollection::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QString OAICollection::getCustomAttributionUrl() const {
    return m_custom_attribution_url;
}
void OAICollection::setCustomAttributionUrl(const QString &custom_attribution_url) {
    m_custom_attribution_url = custom_attribution_url;
    m_custom_attribution_url_isSet = true;
}

bool OAICollection::is_custom_attribution_url_Set() const{
    return m_custom_attribution_url_isSet;
}

bool OAICollection::is_custom_attribution_url_Valid() const{
    return m_custom_attribution_url_isValid;
}

QString OAICollection::getCustomPreviewUrl() const {
    return m_custom_preview_url;
}
void OAICollection::setCustomPreviewUrl(const QString &custom_preview_url) {
    m_custom_preview_url = custom_preview_url;
    m_custom_preview_url_isSet = true;
}

bool OAICollection::is_custom_preview_url_Set() const{
    return m_custom_preview_url_isSet;
}

bool OAICollection::is_custom_preview_url_Valid() const{
    return m_custom_preview_url_isValid;
}

QString OAICollection::getCustomThumbnailUrl() const {
    return m_custom_thumbnail_url;
}
void OAICollection::setCustomThumbnailUrl(const QString &custom_thumbnail_url) {
    m_custom_thumbnail_url = custom_thumbnail_url;
    m_custom_thumbnail_url_isSet = true;
}

bool OAICollection::is_custom_thumbnail_url_Set() const{
    return m_custom_thumbnail_url_isSet;
}

bool OAICollection::is_custom_thumbnail_url_Valid() const{
    return m_custom_thumbnail_url_isValid;
}

QDate OAICollection::getDateContentAuthored() const {
    return m_date_content_authored;
}
void OAICollection::setDateContentAuthored(const QDate &date_content_authored) {
    m_date_content_authored = date_content_authored;
    m_date_content_authored_isSet = true;
}

bool OAICollection::is_date_content_authored_Set() const{
    return m_date_content_authored_isSet;
}

bool OAICollection::is_date_content_authored_Valid() const{
    return m_date_content_authored_isValid;
}

QDate OAICollection::getDateContentPublished() const {
    return m_date_content_published;
}
void OAICollection::setDateContentPublished(const QDate &date_content_published) {
    m_date_content_published = date_content_published;
    m_date_content_published_isSet = true;
}

bool OAICollection::is_date_content_published_Set() const{
    return m_date_content_published_isSet;
}

bool OAICollection::is_date_content_published_Valid() const{
    return m_date_content_published_isValid;
}

QDate OAICollection::getDateContentReviewed() const {
    return m_date_content_reviewed;
}
void OAICollection::setDateContentReviewed(const QDate &date_content_reviewed) {
    m_date_content_reviewed = date_content_reviewed;
    m_date_content_reviewed_isSet = true;
}

bool OAICollection::is_date_content_reviewed_Set() const{
    return m_date_content_reviewed_isSet;
}

bool OAICollection::is_date_content_reviewed_Valid() const{
    return m_date_content_reviewed_isValid;
}

QDate OAICollection::getDateContentUpdated() const {
    return m_date_content_updated;
}
void OAICollection::setDateContentUpdated(const QDate &date_content_updated) {
    m_date_content_updated = date_content_updated;
    m_date_content_updated_isSet = true;
}

bool OAICollection::is_date_content_updated_Set() const{
    return m_date_content_updated_isSet;
}

bool OAICollection::is_date_content_updated_Valid() const{
    return m_date_content_updated_isValid;
}

QDate OAICollection::getDateSyndicationCaptured() const {
    return m_date_syndication_captured;
}
void OAICollection::setDateSyndicationCaptured(const QDate &date_syndication_captured) {
    m_date_syndication_captured = date_syndication_captured;
    m_date_syndication_captured_isSet = true;
}

bool OAICollection::is_date_syndication_captured_Set() const{
    return m_date_syndication_captured_isSet;
}

bool OAICollection::is_date_syndication_captured_Valid() const{
    return m_date_syndication_captured_isValid;
}

QDate OAICollection::getDateSyndicationUpdated() const {
    return m_date_syndication_updated;
}
void OAICollection::setDateSyndicationUpdated(const QDate &date_syndication_updated) {
    m_date_syndication_updated = date_syndication_updated;
    m_date_syndication_updated_isSet = true;
}

bool OAICollection::is_date_syndication_updated_Set() const{
    return m_date_syndication_updated_isSet;
}

bool OAICollection::is_date_syndication_updated_Valid() const{
    return m_date_syndication_updated_isValid;
}

QDate OAICollection::getDateSyndicationVisible() const {
    return m_date_syndication_visible;
}
void OAICollection::setDateSyndicationVisible(const QDate &date_syndication_visible) {
    m_date_syndication_visible = date_syndication_visible;
    m_date_syndication_visible_isSet = true;
}

bool OAICollection::is_date_syndication_visible_Set() const{
    return m_date_syndication_visible_isSet;
}

bool OAICollection::is_date_syndication_visible_Valid() const{
...
QList<OAIExtendedAttribute> OAICollection::getExtendedAttributes() const {
    return m_extended_attributes;
}
void OAICollection::setExtendedAttributes(const QList<OAIExtendedAttribute> &extended_attributes) {
    m_extended_attributes = extended_attributes;
    m_extended_attributes_isSet = true;
}

bool OAICollection::is_extended_attributes_Set() const{
    return m_extended_attributes_isSet;
}

bool OAICollection::is_extended_attributes_Valid() const{
    return m_extended_attributes_isValid;
}

QString OAICollection::getExternalGuid() const {
    return m_external_guid;
}
void OAICollection::setExternalGuid(const QString &external_guid) {
    m_external_guid = external_guid;
    m_external_guid_isSet = true;
}

bool OAICollection::is_external_guid_Set() const{
    return m_external_guid_isSet;
}

bool OAICollection::is_external_guid_Valid() const{
    return m_external_guid_isValid;
}

QString OAICollection::getForeignSyndicationApiUrl() const {
    return m_foreign_syndication_api_url;
}
void OAICollection::setForeignSyndicationApiUrl(const QString &foreign_syndication_api_url) {
    m_foreign_syndication_api_url = foreign_syndication_api_url;
    m_foreign_syndication_api_url_isSet = true;
}

bool OAICollection::is_foreign_syndication_api_url_Set() const{
    return m_foreign_syndication_api_url_isSet;
}

bool OAICollection::is_foreign_syndication_api_url_Valid() const{
    return m_foreign_syndication_api_url_isValid;
}

QString OAICollection::getHash() const {
    return m_hash;
}
void OAICollection::setHash(const QString &hash) {
    m_hash = hash;
    m_hash_isSet = true;
}

bool OAICollection::is_hash_Set() const{
    return m_hash_isSet;
}

bool OAICollection::is_hash_Valid() const{
...
OAILanguage OAICollection::getLanguage() const {
    return m_language;
}
void OAICollection::setLanguage(const OAILanguage &language) {
    m_language = language;
...
QString OAICollection::getMediaType() const {
    return m_media_type;
}
void OAICollection::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAICollection::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAICollection::is_media_type_Valid() const{
...
OAISource OAICollection::getSource() const {
    return m_source;
}
void OAICollection::setSource(const OAISource &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAICollection::is_source_Set() const{
    return m_source_isSet;
}

bool OAICollection::is_source_Valid() const{
    return m_source_isValid;
}

QString OAICollection::getSourceUrl() const {
    return m_source_url;
}
void OAICollection::setSourceUrl(const QString &source_url) {
    m_source_url = source_url;
    m_source_url_isSet = true;
}

bool OAICollection::is_source_url_Set() const{
    return m_source_url_isSet;
}

bool OAICollection::is_source_url_Valid() const{
    return m_source_url_isValid;
}

QString OAICollection::getTargetUrl() const {
    return m_target_url;
}
void OAICollection::setTargetUrl(const QString &target_url) {
    m_target_url = target_url;
    m_target_url_isSet = true;
}

bool OAICollection::is_target_url_Set() const{
    return m_target_url_isSet;
}

bool OAICollection::is_target_url_Valid() const{
