...
QList<OAICampaign> OAIMediaItem::getCampaigns() const {
    return m_campaigns;
}
void OAIMediaItem::setCampaigns(const QList<OAICampaign> &campaigns) {
    m_campaigns = campaigns;
    m_campaigns_isSet = true;
}

bool OAIMediaItem::is_campaigns_Set() const{
    return m_campaigns_isSet;
}

bool OAIMediaItem::is_campaigns_Valid() const{
    return m_campaigns_isValid;
}

QString OAIMediaItem::getCreatedBy() const {
    return m_created_by;
}
void OAIMediaItem::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIMediaItem::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIMediaItem::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QString OAIMediaItem::getCustomAttributionUrl() const {
    return m_custom_attribution_url;
}
void OAIMediaItem::setCustomAttributionUrl(const QString &custom_attribution_url) {
    m_custom_attribution_url = custom_attribution_url;
    m_custom_attribution_url_isSet = true;
}

bool OAIMediaItem::is_custom_attribution_url_Set() const{
    return m_custom_attribution_url_isSet;
}

bool OAIMediaItem::is_custom_attribution_url_Valid() const{
    return m_custom_attribution_url_isValid;
}

QString OAIMediaItem::getCustomPreviewUrl() const {
    return m_custom_preview_url;
}
void OAIMediaItem::setCustomPreviewUrl(const QString &custom_preview_url) {
    m_custom_preview_url = custom_preview_url;
    m_custom_preview_url_isSet = true;
}

bool OAIMediaItem::is_custom_preview_url_Set() const{
    return m_custom_preview_url_isSet;
}

bool OAIMediaItem::is_custom_preview_url_Valid() const{
    return m_custom_preview_url_isValid;
}

QString OAIMediaItem::getCustomThumbnailUrl() const {
    return m_custom_thumbnail_url;
}
void OAIMediaItem::setCustomThumbnailUrl(const QString &custom_thumbnail_url) {
    m_custom_thumbnail_url = custom_thumbnail_url;
    m_custom_thumbnail_url_isSet = true;
}

bool OAIMediaItem::is_custom_thumbnail_url_Set() const{
    return m_custom_thumbnail_url_isSet;
}

bool OAIMediaItem::is_custom_thumbnail_url_Valid() const{
    return m_custom_thumbnail_url_isValid;
}

QDate OAIMediaItem::getDateContentAuthored() const {
    return m_date_content_authored;
}
void OAIMediaItem::setDateContentAuthored(const QDate &date_content_authored) {
    m_date_content_authored = date_content_authored;
    m_date_content_authored_isSet = true;
}

bool OAIMediaItem::is_date_content_authored_Set() const{
    return m_date_content_authored_isSet;
}

bool OAIMediaItem::is_date_content_authored_Valid() const{
    return m_date_content_authored_isValid;
}

QDate OAIMediaItem::getDateContentPublished() const {
    return m_date_content_published;
}
void OAIMediaItem::setDateContentPublished(const QDate &date_content_published) {
    m_date_content_published = date_content_published;
    m_date_content_published_isSet = true;
}

bool OAIMediaItem::is_date_content_published_Set() const{
    return m_date_content_published_isSet;
}

bool OAIMediaItem::is_date_content_published_Valid() const{
    return m_date_content_published_isValid;
}

QDate OAIMediaItem::getDateContentReviewed() const {
    return m_date_content_reviewed;
}
void OAIMediaItem::setDateContentReviewed(const QDate &date_content_reviewed) {
    m_date_content_reviewed = date_content_reviewed;
    m_date_content_reviewed_isSet = true;
}

bool OAIMediaItem::is_date_content_reviewed_Set() const{
    return m_date_content_reviewed_isSet;
}

bool OAIMediaItem::is_date_content_reviewed_Valid() const{
    return m_date_content_reviewed_isValid;
}

QDate OAIMediaItem::getDateContentUpdated() const {
    return m_date_content_updated;
}
void OAIMediaItem::setDateContentUpdated(const QDate &date_content_updated) {
    m_date_content_updated = date_content_updated;
    m_date_content_updated_isSet = true;
}

bool OAIMediaItem::is_date_content_updated_Set() const{
    return m_date_content_updated_isSet;
}

bool OAIMediaItem::is_date_content_updated_Valid() const{
    return m_date_content_updated_isValid;
}

QDate OAIMediaItem::getDateSyndicationCaptured() const {
    return m_date_syndication_captured;
}
void OAIMediaItem::setDateSyndicationCaptured(const QDate &date_syndication_captured) {
    m_date_syndication_captured = date_syndication_captured;
    m_date_syndication_captured_isSet = true;
}

bool OAIMediaItem::is_date_syndication_captured_Set() const{
    return m_date_syndication_captured_isSet;
}

bool OAIMediaItem::is_date_syndication_captured_Valid() const{
    return m_date_syndication_captured_isValid;
}

QDate OAIMediaItem::getDateSyndicationUpdated() const {
    return m_date_syndication_updated;
}
void OAIMediaItem::setDateSyndicationUpdated(const QDate &date_syndication_updated) {
    m_date_syndication_updated = date_syndication_updated;
    m_date_syndication_updated_isSet = true;
}

bool OAIMediaItem::is_date_syndication_updated_Set() const{
    return m_date_syndication_updated_isSet;
}

bool OAIMediaItem::is_date_syndication_updated_Valid() const{
    return m_date_syndication_updated_isValid;
}

QDate OAIMediaItem::getDateSyndicationVisible() const {
    return m_date_syndication_visible;
}
void OAIMediaItem::setDateSyndicationVisible(const QDate &date_syndication_visible) {
    m_date_syndication_visible = date_syndication_visible;
    m_date_syndication_visible_isSet = true;
}

bool OAIMediaItem::is_date_syndication_visible_Set() const{
    return m_date_syndication_visible_isSet;
}

bool OAIMediaItem::is_date_syndication_visible_Valid() const{
...
QList<OAIExtendedAttribute> OAIMediaItem::getExtendedAttributes() const {
    return m_extended_attributes;
}
void OAIMediaItem::setExtendedAttributes(const QList<OAIExtendedAttribute> &extended_attributes) {
    m_extended_attributes = extended_attributes;
    m_extended_attributes_isSet = true;
}

bool OAIMediaItem::is_extended_attributes_Set() const{
    return m_extended_attributes_isSet;
}

bool OAIMediaItem::is_extended_attributes_Valid() const{
    return m_extended_attributes_isValid;
}

QString OAIMediaItem::getExternalGuid() const {
    return m_external_guid;
}
void OAIMediaItem::setExternalGuid(const QString &external_guid) {
    m_external_guid = external_guid;
    m_external_guid_isSet = true;
}

bool OAIMediaItem::is_external_guid_Set() const{
    return m_external_guid_isSet;
}

bool OAIMediaItem::is_external_guid_Valid() const{
    return m_external_guid_isValid;
}

QString OAIMediaItem::getForeignSyndicationApiUrl() const {
    return m_foreign_syndication_api_url;
}
void OAIMediaItem::setForeignSyndicationApiUrl(const QString &foreign_syndication_api_url) {
    m_foreign_syndication_api_url = foreign_syndication_api_url;
    m_foreign_syndication_api_url_isSet = true;
}

bool OAIMediaItem::is_foreign_syndication_api_url_Set() const{
    return m_foreign_syndication_api_url_isSet;
}

bool OAIMediaItem::is_foreign_syndication_api_url_Valid() const{
    return m_foreign_syndication_api_url_isValid;
}

QString OAIMediaItem::getHash() const {
    return m_hash;
}
void OAIMediaItem::setHash(const QString &hash) {
    m_hash = hash;
    m_hash_isSet = true;
}

bool OAIMediaItem::is_hash_Set() const{
    return m_hash_isSet;
}

bool OAIMediaItem::is_hash_Valid() const{
    return m_hash_isValid;
}

qint64 OAIMediaItem::getId() const {
    return m_id;
}
void OAIMediaItem::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMediaItem::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMediaItem::is_id_Valid() const{
    return m_id_isValid;
}

OAILanguage OAIMediaItem::getLanguage() const {
    return m_language;
}
void OAIMediaItem::setLanguage(const OAILanguage &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIMediaItem::is_language_Set() const{
    return m_language_isSet;
}

bool OAIMediaItem::is_language_Valid() const{
    return m_language_isValid;
}

QString OAIMediaItem::getMediaType() const {
    return m_media_type;
}
void OAIMediaItem::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIMediaItem::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIMediaItem::is_media_type_Valid() const{
...
OAISource OAIMediaItem::getSource() const {
    return m_source;
}
void OAIMediaItem::setSource(const OAISource &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIMediaItem::is_source_Set() const{
    return m_source_isSet;
}

bool OAIMediaItem::is_source_Valid() const{
...
QString OAIMediaItem::getTargetUrl() const {
    return m_target_url;
}
void OAIMediaItem::setTargetUrl(const QString &target_url) {
    m_target_url = target_url;
    m_target_url_isSet = true;
}

bool OAIMediaItem::is_target_url_Set() const{
    return m_target_url_isSet;
}

bool OAIMediaItem::is_target_url_Valid() const{
