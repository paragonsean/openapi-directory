...
#include "OAICollectionWrapped.h"
...
OAICollectionWrapped::OAICollectionWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICollectionWrapped::OAICollectionWrapped() {
    this->initializeModel();
}

OAICollectionWrapped::~OAICollectionWrapped() {}

void OAICollectionWrapped::initializeModel() {
...
void OAICollectionWrapped::fromJson(QString jsonString) {
...
void OAICollectionWrapped::fromJsonObject(QJsonObject json) {
...
QString OAICollectionWrapped::asJson() const {
...
QJsonObject OAICollectionWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAICollectionWrapped::getCallback() const {
    return m_callback;
}
void OAICollectionWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAICollectionWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAICollectionWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAICollectionWrapped::getMeta() const {
    return m_meta;
}
void OAICollectionWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAICollectionWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAICollectionWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAICollection> OAICollectionWrapped::getResults() const {
    return m_results;
}
void OAICollectionWrapped::setResults(const QList<OAICollection> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAICollectionWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAICollectionWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAICollectionWrapped::isSet() const {
...
bool OAICollectionWrapped::isValid() const {
