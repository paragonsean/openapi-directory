...
OAITagMarshallerWrapped::OAITagMarshallerWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagMarshallerWrapped::OAITagMarshallerWrapped() {
    this->initializeModel();
}

OAITagMarshallerWrapped::~OAITagMarshallerWrapped() {}

void OAITagMarshallerWrapped::initializeModel() {
...
void OAITagMarshallerWrapped::fromJson(QString jsonString) {
...
void OAITagMarshallerWrapped::fromJsonObject(QJsonObject json) {
...
QString OAITagMarshallerWrapped::asJson() const {
...
QJsonObject OAITagMarshallerWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAITagMarshallerWrapped::getCallback() const {
    return m_callback;
}
void OAITagMarshallerWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAITagMarshallerWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAITagMarshallerWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAITagMarshallerWrapped::getMeta() const {
    return m_meta;
}
void OAITagMarshallerWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAITagMarshallerWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAITagMarshallerWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAITagMarshaller> OAITagMarshallerWrapped::getResults() const {
    return m_results;
}
void OAITagMarshallerWrapped::setResults(const QList<OAITagMarshaller> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAITagMarshallerWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAITagMarshallerWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAITagMarshallerWrapped::isSet() const {
...
bool OAITagMarshallerWrapped::isValid() const {
