...
#include "OAIYoutubeMetadataWrapped.h"
...
OAIYoutubeMetadataWrapped::OAIYoutubeMetadataWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIYoutubeMetadataWrapped::OAIYoutubeMetadataWrapped() {
    this->initializeModel();
}

OAIYoutubeMetadataWrapped::~OAIYoutubeMetadataWrapped() {}

void OAIYoutubeMetadataWrapped::initializeModel() {
...
void OAIYoutubeMetadataWrapped::fromJson(QString jsonString) {
...
void OAIYoutubeMetadataWrapped::fromJsonObject(QJsonObject json) {
...
QString OAIYoutubeMetadataWrapped::asJson() const {
...
QJsonObject OAIYoutubeMetadataWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAIYoutubeMetadataWrapped::getCallback() const {
    return m_callback;
}
void OAIYoutubeMetadataWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIYoutubeMetadataWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIYoutubeMetadataWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAIYoutubeMetadataWrapped::getMeta() const {
    return m_meta;
}
void OAIYoutubeMetadataWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIYoutubeMetadataWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIYoutubeMetadataWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIObject> OAIYoutubeMetadataWrapped::getResults() const {
    return m_results;
}
void OAIYoutubeMetadataWrapped::setResults(const QList<OAIObject> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIYoutubeMetadataWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAIYoutubeMetadataWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIYoutubeMetadataWrapped::isSet() const {
...
bool OAIYoutubeMetadataWrapped::isValid() const {
