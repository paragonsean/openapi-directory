...
OAITweetWrapped::OAITweetWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITweetWrapped::OAITweetWrapped() {
    this->initializeModel();
}

OAITweetWrapped::~OAITweetWrapped() {}

void OAITweetWrapped::initializeModel() {
...
void OAITweetWrapped::fromJson(QString jsonString) {
...
void OAITweetWrapped::fromJsonObject(QJsonObject json) {
...
QString OAITweetWrapped::asJson() const {
...
QJsonObject OAITweetWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAITweetWrapped::getCallback() const {
    return m_callback;
}
void OAITweetWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAITweetWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAITweetWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAITweetWrapped::getMeta() const {
    return m_meta;
}
void OAITweetWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAITweetWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAITweetWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAITweet> OAITweetWrapped::getResults() const {
    return m_results;
}
void OAITweetWrapped::setResults(const QList<OAITweet> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAITweetWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAITweetWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAITweetWrapped::isSet() const {
...
bool OAITweetWrapped::isValid() const {
