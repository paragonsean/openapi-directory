...
/*
 * OAIMediaTypeHolder.h
 *
 * 
 */

#ifndef OAIMediaTypeHolder_H
#define OAIMediaTypeHolder_H
...
class OAIMediaTypeHolder : public OAIObject {
public:
    OAIMediaTypeHolder();
    OAIMediaTypeHolder(QString json);
    ~OAIMediaTypeHolder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaTypeHolder)

#endif // OAIMediaTypeHolder_H
