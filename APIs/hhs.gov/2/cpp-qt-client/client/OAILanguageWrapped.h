...
/*
 * OAILanguageWrapped.h
 *
 * 
 */

#ifndef OAILanguageWrapped_H
#define OAILanguageWrapped_H
...
class OAILanguageWrapped : public OAIObject {
public:
    OAILanguageWrapped();
    OAILanguageWrapped(QString json);
    ~OAILanguageWrapped() override;
    ...
    QList<OAILanguage> getResults() const;
    void setResults(const QList<OAILanguage> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAILanguageWrapped)

#endif // OAILanguageWrapped_H
