...
OAISourceWrapped::OAISourceWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISourceWrapped::OAISourceWrapped() {
    this->initializeModel();
}

OAISourceWrapped::~OAISourceWrapped() {}

void OAISourceWrapped::initializeModel() {
...
void OAISourceWrapped::fromJson(QString jsonString) {
...
void OAISourceWrapped::fromJsonObject(QJsonObject json) {
...
QString OAISourceWrapped::asJson() const {
...
QJsonObject OAISourceWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAISourceWrapped::getCallback() const {
    return m_callback;
}
void OAISourceWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAISourceWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAISourceWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAISourceWrapped::getMeta() const {
    return m_meta;
}
void OAISourceWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAISourceWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAISourceWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAISource> OAISourceWrapped::getResults() const {
    return m_results;
}
void OAISourceWrapped::setResults(const QList<OAISource> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAISourceWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAISourceWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAISourceWrapped::isSet() const {
...
bool OAISourceWrapped::isValid() const {
