...
/*
 * OAIYoutubeMetadataWrapped.h
 *
 * 
 */

#ifndef OAIYoutubeMetadataWrapped_H
#define OAIYoutubeMetadataWrapped_H
...
class OAIYoutubeMetadataWrapped : public OAIObject {
public:
    OAIYoutubeMetadataWrapped();
    OAIYoutubeMetadataWrapped(QString json);
    ~OAIYoutubeMetadataWrapped() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIYoutubeMetadataWrapped)

#endif // OAIYoutubeMetadataWrapped_H
