...
OAIMetaWrapped::OAIMetaWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMetaWrapped::OAIMetaWrapped() {
    this->initializeModel();
}

OAIMetaWrapped::~OAIMetaWrapped() {}

void OAIMetaWrapped::initializeModel() {
...
void OAIMetaWrapped::fromJson(QString jsonString) {
...
void OAIMetaWrapped::fromJsonObject(QJsonObject json) {
...
QString OAIMetaWrapped::asJson() const {
...
QJsonObject OAIMetaWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAIMetaWrapped::getCallback() const {
    return m_callback;
}
void OAIMetaWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIMetaWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIMetaWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAIMetaWrapped::getMeta() const {
    return m_meta;
}
void OAIMetaWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIMetaWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIMetaWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIMeta> OAIMetaWrapped::getResults() const {
    return m_results;
}
void OAIMetaWrapped::setResults(const QList<OAIMeta> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIMetaWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAIMetaWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIMetaWrapped::isSet() const {
...
bool OAIMetaWrapped::isValid() const {
