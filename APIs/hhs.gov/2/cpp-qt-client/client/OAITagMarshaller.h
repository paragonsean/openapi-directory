...
#ifndef OAITagMarshaller_H
#define OAITagMarshaller_H
...
class OAITagTypeMarshaller;

class OAITagMarshaller : public OAIObject {
public:
    OAITagMarshaller();
    OAITagMarshaller(QString json);
    ~OAITagMarshaller() override;
    ...
    OAITagLanguageMarshaller getLanguage() const;
    void setLanguage(const OAITagLanguageMarshaller &language);
    ...
    OAITagTypeMarshaller getType() const;
    void setType(const OAITagTypeMarshaller &type);
...
private:
    ...
    OAITagLanguageMarshaller m_language;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagMarshaller)

#endif // OAITagMarshaller_H
