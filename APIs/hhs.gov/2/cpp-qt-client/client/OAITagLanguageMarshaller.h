...
/*
 * OAITagLanguageMarshaller.h
 *
 * 
 */

#ifndef OAITagLanguageMarshaller_H
#define OAITagLanguageMarshaller_H
...
class OAITagLanguageMarshaller : public OAIObject {
public:
    OAITagLanguageMarshaller();
    OAITagLanguageMarshaller(QString json);
    ~OAITagLanguageMarshaller() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagLanguageMarshaller)

#endif // OAITagLanguageMarshaller_H
