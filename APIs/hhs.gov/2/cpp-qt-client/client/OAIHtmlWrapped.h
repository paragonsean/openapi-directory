...
#ifndef OAIHtmlWrapped_H
#define OAIHtmlWrapped_H
...
class OAIHtmlWrapped : public OAIObject {
public:
    OAIHtmlWrapped();
    OAIHtmlWrapped(QString json);
    ~OAIHtmlWrapped() override;
    ...
    QList<OAIHtml> getResults() const;
    void setResults(const QList<OAIHtml> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIHtmlWrapped)

#endif // OAIHtmlWrapped_H
