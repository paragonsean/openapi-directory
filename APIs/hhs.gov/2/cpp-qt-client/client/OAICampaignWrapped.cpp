...
OAICampaignWrapped::OAICampaignWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICampaignWrapped::OAICampaignWrapped() {
    this->initializeModel();
}

OAICampaignWrapped::~OAICampaignWrapped() {}

void OAICampaignWrapped::initializeModel() {
...
void OAICampaignWrapped::fromJson(QString jsonString) {
...
void OAICampaignWrapped::fromJsonObject(QJsonObject json) {
...
QString OAICampaignWrapped::asJson() const {
...
QJsonObject OAICampaignWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAICampaignWrapped::getCallback() const {
    return m_callback;
}
void OAICampaignWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAICampaignWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAICampaignWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAICampaignWrapped::getMeta() const {
    return m_meta;
}
void OAICampaignWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAICampaignWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAICampaignWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAICampaign> OAICampaignWrapped::getResults() const {
    return m_results;
}
void OAICampaignWrapped::setResults(const QList<OAICampaign> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAICampaignWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAICampaignWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAICampaignWrapped::isSet() const {
...
bool OAICampaignWrapped::isValid() const {
