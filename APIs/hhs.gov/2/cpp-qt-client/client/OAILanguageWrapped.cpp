...
OAILanguageWrapped::OAILanguageWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILanguageWrapped::OAILanguageWrapped() {
    this->initializeModel();
}

OAILanguageWrapped::~OAILanguageWrapped() {}

void OAILanguageWrapped::initializeModel() {
...
void OAILanguageWrapped::fromJson(QString jsonString) {
...
void OAILanguageWrapped::fromJsonObject(QJsonObject json) {
...
QString OAILanguageWrapped::asJson() const {
...
QJsonObject OAILanguageWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAILanguageWrapped::getCallback() const {
    return m_callback;
}
void OAILanguageWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAILanguageWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAILanguageWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAILanguageWrapped::getMeta() const {
    return m_meta;
}
void OAILanguageWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAILanguageWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAILanguageWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAILanguage> OAILanguageWrapped::getResults() const {
    return m_results;
}
void OAILanguageWrapped::setResults(const QList<OAILanguage> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAILanguageWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAILanguageWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAILanguageWrapped::isSet() const {
...
bool OAILanguageWrapped::isValid() const {
