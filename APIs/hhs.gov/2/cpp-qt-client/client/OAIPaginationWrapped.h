...
/*
 * OAIPaginationWrapped.h
 *
 * 
 */

#ifndef OAIPaginationWrapped_H
#define OAIPaginationWrapped_H
...
class OAIPaginationWrapped : public OAIObject {
public:
    OAIPaginationWrapped();
    OAIPaginationWrapped(QString json);
    ~OAIPaginationWrapped() override;
    ...
    QList<OAIPagination> getResults() const;
    void setResults(const QList<OAIPagination> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaginationWrapped)

#endif // OAIPaginationWrapped_H
