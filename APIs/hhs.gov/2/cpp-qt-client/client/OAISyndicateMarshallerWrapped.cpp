...
OAISyndicateMarshallerWrapped::OAISyndicateMarshallerWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISyndicateMarshallerWrapped::OAISyndicateMarshallerWrapped() {
    this->initializeModel();
}

OAISyndicateMarshallerWrapped::~OAISyndicateMarshallerWrapped() {}

void OAISyndicateMarshallerWrapped::initializeModel() {
...
void OAISyndicateMarshallerWrapped::fromJson(QString jsonString) {
...
void OAISyndicateMarshallerWrapped::fromJsonObject(QJsonObject json) {
...
QString OAISyndicateMarshallerWrapped::asJson() const {
...
QJsonObject OAISyndicateMarshallerWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAISyndicateMarshallerWrapped::getCallback() const {
    return m_callback;
}
void OAISyndicateMarshallerWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAISyndicateMarshallerWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAISyndicateMarshallerWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAISyndicateMarshallerWrapped::getMeta() const {
    return m_meta;
}
void OAISyndicateMarshallerWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAISyndicateMarshallerWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAISyndicateMarshallerWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAISyndicateMarshaller> OAISyndicateMarshallerWrapped::getResults() const {
    return m_results;
}
void OAISyndicateMarshallerWrapped::setResults(const QList<OAISyndicateMarshaller> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAISyndicateMarshallerWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAISyndicateMarshallerWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAISyndicateMarshallerWrapped::isSet() const {
...
bool OAISyndicateMarshallerWrapped::isValid() const {
