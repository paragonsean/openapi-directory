...
OAIMediaTypeHolderWrapped::OAIMediaTypeHolderWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMediaTypeHolderWrapped::OAIMediaTypeHolderWrapped() {
    this->initializeModel();
}

OAIMediaTypeHolderWrapped::~OAIMediaTypeHolderWrapped() {}

void OAIMediaTypeHolderWrapped::initializeModel() {
...
void OAIMediaTypeHolderWrapped::fromJson(QString jsonString) {
...
void OAIMediaTypeHolderWrapped::fromJsonObject(QJsonObject json) {
...
QString OAIMediaTypeHolderWrapped::asJson() const {
...
QJsonObject OAIMediaTypeHolderWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAIMediaTypeHolderWrapped::getCallback() const {
    return m_callback;
}
void OAIMediaTypeHolderWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIMediaTypeHolderWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIMediaTypeHolderWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAIMediaTypeHolderWrapped::getMeta() const {
    return m_meta;
}
void OAIMediaTypeHolderWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIMediaTypeHolderWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIMediaTypeHolderWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIMediaTypeHolder> OAIMediaTypeHolderWrapped::getResults() const {
    return m_results;
}
void OAIMediaTypeHolderWrapped::setResults(const QList<OAIMediaTypeHolder> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIMediaTypeHolderWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAIMediaTypeHolderWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIMediaTypeHolderWrapped::isSet() const {
...
bool OAIMediaTypeHolderWrapped::isValid() const {
