...
#ifndef OAIVideoWrapped_H
#define OAIVideoWrapped_H
...
class OAIVideoWrapped : public OAIObject {
public:
    OAIVideoWrapped();
    OAIVideoWrapped(QString json);
    ~OAIVideoWrapped() override;
    ...
    QList<OAIVideo> getResults() const;
    void setResults(const QList<OAIVideo> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoWrapped)

#endif // OAIVideoWrapped_H
