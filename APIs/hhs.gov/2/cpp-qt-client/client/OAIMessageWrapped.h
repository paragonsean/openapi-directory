...
#ifndef OAIMessageWrapped_H
#define OAIMessageWrapped_H
...
class OAIMessageWrapped : public OAIObject {
public:
    OAIMessageWrapped();
    OAIMessageWrapped(QString json);
    ~OAIMessageWrapped() override;
    ...
    QList<OAIMessage> getResults() const;
    void setResults(const QList<OAIMessage> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageWrapped)

#endif // OAIMessageWrapped_H
