...
/*
 * OAISyndicateMarshallerWrapped.h
 *
 * 
 */

#ifndef OAISyndicateMarshallerWrapped_H
#define OAISyndicateMarshallerWrapped_H
...
namespace OpenAPI {
class OAIMeta;
class OAISyndicateMarshaller;

class OAISyndicateMarshallerWrapped : public OAIObject {
public:
    OAISyndicateMarshallerWrapped();
    OAISyndicateMarshallerWrapped(QString json);
    ~OAISyndicateMarshallerWrapped() override;
    ...
    QList<OAISyndicateMarshaller> getResults() const;
    void setResults(const QList<OAISyndicateMarshaller> &results);
...
private:
    ...
    QList<OAISyndicateMarshaller> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAISyndicateMarshallerWrapped)

#endif // OAISyndicateMarshallerWrapped_H
