...
/*
 * OAIMediaTypeHolderWrapped.h
 *
 * 
 */

#ifndef OAIMediaTypeHolderWrapped_H
#define OAIMediaTypeHolderWrapped_H
...
namespace OpenAPI {
class OAIMeta;
class OAIMediaTypeHolder;

class OAIMediaTypeHolderWrapped : public OAIObject {
public:
    OAIMediaTypeHolderWrapped();
    OAIMediaTypeHolderWrapped(QString json);
    ~OAIMediaTypeHolderWrapped() override;
    ...
    QList<OAIMediaTypeHolder> getResults() const;
    void setResults(const QList<OAIMediaTypeHolder> &results);
...
private:
    ...
    QList<OAIMediaTypeHolder> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMediaTypeHolderWrapped)

#endif // OAIMediaTypeHolderWrapped_H
