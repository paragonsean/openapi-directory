...
public:
    ...
    */
    virtual void resourcesJsonGet(const QString &q);
...
private:
    ...
    void resourcesJsonGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void resourcesJsonGetSignal(QList<QJsonValue> summary);


    void resourcesJsonGetSignalFull(OAIHttpRequestWorker *worker, QList<QJsonValue> summary);

    Q_DECL_DEPRECATED_X("Use resourcesJsonGetSignalError() instead")
    void resourcesJsonGetSignalE(QList<QJsonValue> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void resourcesJsonGetSignalError(QList<QJsonValue> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use resourcesJsonGetSignalErrorFull() instead")
    void resourcesJsonGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void resourcesJsonGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
