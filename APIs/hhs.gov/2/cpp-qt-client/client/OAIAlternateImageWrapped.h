...
/*
 * OAIAlternateImageWrapped.h
 *
 * 
 */

#ifndef OAIAlternateImageWrapped_H
#define OAIAlternateImageWrapped_H
...
namespace OpenAPI {
class OAIMeta;
class OAIAlternateImage;

class OAIAlternateImageWrapped : public OAIObject {
public:
    OAIAlternateImageWrapped();
    OAIAlternateImageWrapped(QString json);
    ~OAIAlternateImageWrapped() override;
    ...
    QList<OAIAlternateImage> getResults() const;
    void setResults(const QList<OAIAlternateImage> &results);
...
private:
    ...
    QList<OAIAlternateImage> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlternateImageWrapped)

#endif // OAIAlternateImageWrapped_H
