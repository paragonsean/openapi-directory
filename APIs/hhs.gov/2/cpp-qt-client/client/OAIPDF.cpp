...
void OAIPDF::fromJson(QString jsonString) {
...
void OAIPDF::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIPDF::asJsonObject() const {
    QJsonObject obj;
...
QList<OAICampaign> OAIPDF::getCampaigns() const {
    return m_campaigns;
}
void OAIPDF::setCampaigns(const QList<OAICampaign> &campaigns) {
    m_campaigns = campaigns;
    m_campaigns_isSet = true;
}

bool OAIPDF::is_campaigns_Set() const{
    return m_campaigns_isSet;
}

bool OAIPDF::is_campaigns_Valid() const{
    return m_campaigns_isValid;
}

QString OAIPDF::getCreatedBy() const {
    return m_created_by;
}
void OAIPDF::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIPDF::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIPDF::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QString OAIPDF::getCustomAttributionUrl() const {
    return m_custom_attribution_url;
}
void OAIPDF::setCustomAttributionUrl(const QString &custom_attribution_url) {
    m_custom_attribution_url = custom_attribution_url;
    m_custom_attribution_url_isSet = true;
}

bool OAIPDF::is_custom_attribution_url_Set() const{
    return m_custom_attribution_url_isSet;
}

bool OAIPDF::is_custom_attribution_url_Valid() const{
    return m_custom_attribution_url_isValid;
}

QString OAIPDF::getCustomPreviewUrl() const {
    return m_custom_preview_url;
}
void OAIPDF::setCustomPreviewUrl(const QString &custom_preview_url) {
    m_custom_preview_url = custom_preview_url;
    m_custom_preview_url_isSet = true;
}

bool OAIPDF::is_custom_preview_url_Set() const{
    return m_custom_preview_url_isSet;
}

bool OAIPDF::is_custom_preview_url_Valid() const{
    return m_custom_preview_url_isValid;
}

QString OAIPDF::getCustomThumbnailUrl() const {
    return m_custom_thumbnail_url;
}
void OAIPDF::setCustomThumbnailUrl(const QString &custom_thumbnail_url) {
    m_custom_thumbnail_url = custom_thumbnail_url;
    m_custom_thumbnail_url_isSet = true;
}

bool OAIPDF::is_custom_thumbnail_url_Set() const{
    return m_custom_thumbnail_url_isSet;
}

bool OAIPDF::is_custom_thumbnail_url_Valid() const{
    return m_custom_thumbnail_url_isValid;
}

QDate OAIPDF::getDateContentAuthored() const {
    return m_date_content_authored;
}
void OAIPDF::setDateContentAuthored(const QDate &date_content_authored) {
    m_date_content_authored = date_content_authored;
    m_date_content_authored_isSet = true;
}

bool OAIPDF::is_date_content_authored_Set() const{
    return m_date_content_authored_isSet;
}

bool OAIPDF::is_date_content_authored_Valid() const{
    return m_date_content_authored_isValid;
}

QDate OAIPDF::getDateContentPublished() const {
    return m_date_content_published;
}
void OAIPDF::setDateContentPublished(const QDate &date_content_published) {
    m_date_content_published = date_content_published;
    m_date_content_published_isSet = true;
}

bool OAIPDF::is_date_content_published_Set() const{
    return m_date_content_published_isSet;
}

bool OAIPDF::is_date_content_published_Valid() const{
    return m_date_content_published_isValid;
}

QDate OAIPDF::getDateContentReviewed() const {
    return m_date_content_reviewed;
}
void OAIPDF::setDateContentReviewed(const QDate &date_content_reviewed) {
    m_date_content_reviewed = date_content_reviewed;
    m_date_content_reviewed_isSet = true;
}

bool OAIPDF::is_date_content_reviewed_Set() const{
    return m_date_content_reviewed_isSet;
}

bool OAIPDF::is_date_content_reviewed_Valid() const{
    return m_date_content_reviewed_isValid;
}

QDate OAIPDF::getDateContentUpdated() const {
    return m_date_content_updated;
}
void OAIPDF::setDateContentUpdated(const QDate &date_content_updated) {
    m_date_content_updated = date_content_updated;
    m_date_content_updated_isSet = true;
}

bool OAIPDF::is_date_content_updated_Set() const{
    return m_date_content_updated_isSet;
}

bool OAIPDF::is_date_content_updated_Valid() const{
    return m_date_content_updated_isValid;
}

QDate OAIPDF::getDateSyndicationCaptured() const {
    return m_date_syndication_captured;
}
void OAIPDF::setDateSyndicationCaptured(const QDate &date_syndication_captured) {
    m_date_syndication_captured = date_syndication_captured;
    m_date_syndication_captured_isSet = true;
}

bool OAIPDF::is_date_syndication_captured_Set() const{
    return m_date_syndication_captured_isSet;
}

bool OAIPDF::is_date_syndication_captured_Valid() const{
    return m_date_syndication_captured_isValid;
}

QDate OAIPDF::getDateSyndicationUpdated() const {
    return m_date_syndication_updated;
}
void OAIPDF::setDateSyndicationUpdated(const QDate &date_syndication_updated) {
    m_date_syndication_updated = date_syndication_updated;
    m_date_syndication_updated_isSet = true;
}

bool OAIPDF::is_date_syndication_updated_Set() const{
    return m_date_syndication_updated_isSet;
}

bool OAIPDF::is_date_syndication_updated_Valid() const{
    return m_date_syndication_updated_isValid;
}

QDate OAIPDF::getDateSyndicationVisible() const {
    return m_date_syndication_visible;
}
void OAIPDF::setDateSyndicationVisible(const QDate &date_syndication_visible) {
    m_date_syndication_visible = date_syndication_visible;
    m_date_syndication_visible_isSet = true;
}

bool OAIPDF::is_date_syndication_visible_Set() const{
    return m_date_syndication_visible_isSet;
}

bool OAIPDF::is_date_syndication_visible_Valid() const{
    return m_date_syndication_visible_isValid;
}

QString OAIPDF::getDescription() const {
    return m_description;
}
void OAIPDF::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPDF::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPDF::is_description_Valid() const{
    return m_description_isValid;
}

QList<OAIExtendedAttribute> OAIPDF::getExtendedAttributes() const {
    return m_extended_attributes;
}
void OAIPDF::setExtendedAttributes(const QList<OAIExtendedAttribute> &extended_attributes) {
    m_extended_attributes = extended_attributes;
    m_extended_attributes_isSet = true;
}

bool OAIPDF::is_extended_attributes_Set() const{
    return m_extended_attributes_isSet;
}

bool OAIPDF::is_extended_attributes_Valid() const{
    return m_extended_attributes_isValid;
}

QString OAIPDF::getExternalGuid() const {
    return m_external_guid;
}
void OAIPDF::setExternalGuid(const QString &external_guid) {
    m_external_guid = external_guid;
    m_external_guid_isSet = true;
}

bool OAIPDF::is_external_guid_Set() const{
    return m_external_guid_isSet;
}

bool OAIPDF::is_external_guid_Valid() const{
    return m_external_guid_isValid;
}

QString OAIPDF::getForeignSyndicationApiUrl() const {
    return m_foreign_syndication_api_url;
}
void OAIPDF::setForeignSyndicationApiUrl(const QString &foreign_syndication_api_url) {
    m_foreign_syndication_api_url = foreign_syndication_api_url;
    m_foreign_syndication_api_url_isSet = true;
}

bool OAIPDF::is_foreign_syndication_api_url_Set() const{
    return m_foreign_syndication_api_url_isSet;
}

bool OAIPDF::is_foreign_syndication_api_url_Valid() const{
    return m_foreign_syndication_api_url_isValid;
}

QString OAIPDF::getHash() const {
    return m_hash;
}
void OAIPDF::setHash(const QString &hash) {
    m_hash = hash;
    m_hash_isSet = true;
}

bool OAIPDF::is_hash_Set() const{
    return m_hash_isSet;
}

bool OAIPDF::is_hash_Valid() const{
    return m_hash_isValid;
}

qint64 OAIPDF::getId() const {
    return m_id;
}
void OAIPDF::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPDF::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPDF::is_id_Valid() const{
    return m_id_isValid;
}

OAILanguage OAIPDF::getLanguage() const {
    return m_language;
}
void OAIPDF::setLanguage(const OAILanguage &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIPDF::is_language_Set() const{
    return m_language_isSet;
}

bool OAIPDF::is_language_Valid() const{
    return m_language_isValid;
}

QString OAIPDF::getMediaType() const {
    return m_media_type;
}
void OAIPDF::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIPDF::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIPDF::is_media_type_Valid() const{
    return m_media_type_isValid;
}

QString OAIPDF::getName() const {
    return m_name;
}
void OAIPDF::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPDF::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPDF::is_name_Valid() const{
    return m_name_isValid;
}

OAISource OAIPDF::getSource() const {
    return m_source;
}
void OAIPDF::setSource(const OAISource &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIPDF::is_source_Set() const{
    return m_source_isSet;
}

bool OAIPDF::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIPDF::getSourceUrl() const {
    return m_source_url;
}
void OAIPDF::setSourceUrl(const QString &source_url) {
    m_source_url = source_url;
    m_source_url_isSet = true;
}

bool OAIPDF::is_source_url_Set() const{
    return m_source_url_isSet;
}

bool OAIPDF::is_source_url_Valid() const{
    return m_source_url_isValid;
}

QString OAIPDF::getTargetUrl() const {
    return m_target_url;
}
void OAIPDF::setTargetUrl(const QString &target_url) {
    m_target_url = target_url;
    m_target_url_isSet = true;
}

bool OAIPDF::is_target_url_Set() const{
    return m_target_url_isSet;
}

bool OAIPDF::is_target_url_Valid() const{
    return m_target_url_isValid;
}

bool OAIPDF::isSet() const {
