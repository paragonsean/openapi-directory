...
/*
 * OAICollectionWrapped.h
 *
 * 
 */

#ifndef OAICollectionWrapped_H
#define OAICollectionWrapped_H
...
class OAICollectionWrapped : public OAIObject {
public:
    OAICollectionWrapped();
    OAICollectionWrapped(QString json);
    ~OAICollectionWrapped() override;
    ...
    QList<OAICollection> getResults() const;
    void setResults(const QList<OAICollection> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionWrapped)

#endif // OAICollectionWrapped_H
