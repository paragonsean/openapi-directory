...
/*
 * OAITagTypeMarshallerWrapped.h
 *
 * 
 */

#ifndef OAITagTypeMarshallerWrapped_H
#define OAITagTypeMarshallerWrapped_H
...
class OAITagTypeMarshallerWrapped : public OAIObject {
public:
    OAITagTypeMarshallerWrapped();
    OAITagTypeMarshallerWrapped(QString json);
    ~OAITagTypeMarshallerWrapped() override;
    ...
    QList<OAITagTypeMarshaller> getResults() const;
    void setResults(const QList<OAITagTypeMarshaller> &results);
...
private:
    ...
    QList<OAITagTypeMarshaller> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagTypeMarshallerWrapped)

#endif // OAITagTypeMarshallerWrapped_H
