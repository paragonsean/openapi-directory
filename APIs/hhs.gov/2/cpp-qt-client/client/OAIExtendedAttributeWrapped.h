...
/*
 * OAIExtendedAttributeWrapped.h
 *
 * 
 */

#ifndef OAIExtendedAttributeWrapped_H
#define OAIExtendedAttributeWrapped_H
...
class OAIExtendedAttributeWrapped : public OAIObject {
public:
    OAIExtendedAttributeWrapped();
    OAIExtendedAttributeWrapped(QString json);
    ~OAIExtendedAttributeWrapped() override;
    ...
    QList<OAIExtendedAttribute> getResults() const;
    void setResults(const QList<OAIExtendedAttribute> &results);
...
private:
    ...
    QList<OAIExtendedAttribute> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtendedAttributeWrapped)

#endif // OAIExtendedAttributeWrapped_H
