...
#include "OAIAlternateImageWrapped.h"
...
OAIAlternateImageWrapped::OAIAlternateImageWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAlternateImageWrapped::OAIAlternateImageWrapped() {
    this->initializeModel();
}

OAIAlternateImageWrapped::~OAIAlternateImageWrapped() {}

void OAIAlternateImageWrapped::initializeModel() {
...
void OAIAlternateImageWrapped::fromJson(QString jsonString) {
...
void OAIAlternateImageWrapped::fromJsonObject(QJsonObject json) {
...
QString OAIAlternateImageWrapped::asJson() const {
...
QJsonObject OAIAlternateImageWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAIAlternateImageWrapped::getCallback() const {
    return m_callback;
}
void OAIAlternateImageWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIAlternateImageWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIAlternateImageWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAIAlternateImageWrapped::getMeta() const {
    return m_meta;
}
void OAIAlternateImageWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIAlternateImageWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIAlternateImageWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIAlternateImage> OAIAlternateImageWrapped::getResults() const {
    return m_results;
}
void OAIAlternateImageWrapped::setResults(const QList<OAIAlternateImage> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIAlternateImageWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAIAlternateImageWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIAlternateImageWrapped::isSet() const {
...
bool OAIAlternateImageWrapped::isValid() const {
