...
OAIInfographic::OAIInfographic(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInfographic::OAIInfographic() {
    this->initializeModel();
}

OAIInfographic::~OAIInfographic() {}

void OAIInfographic::initializeModel() {
...
void OAIInfographic::fromJson(QString jsonString) {
...
void OAIInfographic::fromJsonObject(QJsonObject json) {
...
QString OAIInfographic::asJson() const {
...
QJsonObject OAIInfographic::asJsonObject() const {
    QJsonObject obj;
...
QList<OAICampaign> OAIInfographic::getCampaigns() const {
    return m_campaigns;
}
void OAIInfographic::setCampaigns(const QList<OAICampaign> &campaigns) {
    m_campaigns = campaigns;
    m_campaigns_isSet = true;
}

bool OAIInfographic::is_campaigns_Set() const{
    return m_campaigns_isSet;
}

bool OAIInfographic::is_campaigns_Valid() const{
    return m_campaigns_isValid;
}

QString OAIInfographic::getCreatedBy() const {
    return m_created_by;
}
void OAIInfographic::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIInfographic::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIInfographic::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QString OAIInfographic::getCustomAttributionUrl() const {
    return m_custom_attribution_url;
}
void OAIInfographic::setCustomAttributionUrl(const QString &custom_attribution_url) {
    m_custom_attribution_url = custom_attribution_url;
    m_custom_attribution_url_isSet = true;
}

bool OAIInfographic::is_custom_attribution_url_Set() const{
    return m_custom_attribution_url_isSet;
}

bool OAIInfographic::is_custom_attribution_url_Valid() const{
    return m_custom_attribution_url_isValid;
}

QString OAIInfographic::getCustomPreviewUrl() const {
    return m_custom_preview_url;
}
void OAIInfographic::setCustomPreviewUrl(const QString &custom_preview_url) {
    m_custom_preview_url = custom_preview_url;
    m_custom_preview_url_isSet = true;
}

bool OAIInfographic::is_custom_preview_url_Set() const{
    return m_custom_preview_url_isSet;
}

bool OAIInfographic::is_custom_preview_url_Valid() const{
    return m_custom_preview_url_isValid;
}

QString OAIInfographic::getCustomThumbnailUrl() const {
    return m_custom_thumbnail_url;
}
void OAIInfographic::setCustomThumbnailUrl(const QString &custom_thumbnail_url) {
    m_custom_thumbnail_url = custom_thumbnail_url;
    m_custom_thumbnail_url_isSet = true;
}

bool OAIInfographic::is_custom_thumbnail_url_Set() const{
    return m_custom_thumbnail_url_isSet;
}

bool OAIInfographic::is_custom_thumbnail_url_Valid() const{
    return m_custom_thumbnail_url_isValid;
}

QDate OAIInfographic::getDateContentAuthored() const {
    return m_date_content_authored;
}
void OAIInfographic::setDateContentAuthored(const QDate &date_content_authored) {
    m_date_content_authored = date_content_authored;
    m_date_content_authored_isSet = true;
}

bool OAIInfographic::is_date_content_authored_Set() const{
    return m_date_content_authored_isSet;
}

bool OAIInfographic::is_date_content_authored_Valid() const{
    return m_date_content_authored_isValid;
}

QDate OAIInfographic::getDateContentPublished() const {
    return m_date_content_published;
}
void OAIInfographic::setDateContentPublished(const QDate &date_content_published) {
    m_date_content_published = date_content_published;
    m_date_content_published_isSet = true;
}

bool OAIInfographic::is_date_content_published_Set() const{
    return m_date_content_published_isSet;
}

bool OAIInfographic::is_date_content_published_Valid() const{
    return m_date_content_published_isValid;
}

QDate OAIInfographic::getDateContentReviewed() const {
    return m_date_content_reviewed;
}
void OAIInfographic::setDateContentReviewed(const QDate &date_content_reviewed) {
    m_date_content_reviewed = date_content_reviewed;
    m_date_content_reviewed_isSet = true;
}

bool OAIInfographic::is_date_content_reviewed_Set() const{
    return m_date_content_reviewed_isSet;
}

bool OAIInfographic::is_date_content_reviewed_Valid() const{
    return m_date_content_reviewed_isValid;
}

QDate OAIInfographic::getDateContentUpdated() const {
    return m_date_content_updated;
}
void OAIInfographic::setDateContentUpdated(const QDate &date_content_updated) {
    m_date_content_updated = date_content_updated;
    m_date_content_updated_isSet = true;
}

bool OAIInfographic::is_date_content_updated_Set() const{
    return m_date_content_updated_isSet;
}

bool OAIInfographic::is_date_content_updated_Valid() const{
    return m_date_content_updated_isValid;
}

QDate OAIInfographic::getDateSyndicationCaptured() const {
    return m_date_syndication_captured;
}
void OAIInfographic::setDateSyndicationCaptured(const QDate &date_syndication_captured) {
    m_date_syndication_captured = date_syndication_captured;
    m_date_syndication_captured_isSet = true;
}

bool OAIInfographic::is_date_syndication_captured_Set() const{
    return m_date_syndication_captured_isSet;
}

bool OAIInfographic::is_date_syndication_captured_Valid() const{
    return m_date_syndication_captured_isValid;
}

QDate OAIInfographic::getDateSyndicationUpdated() const {
    return m_date_syndication_updated;
}
void OAIInfographic::setDateSyndicationUpdated(const QDate &date_syndication_updated) {
    m_date_syndication_updated = date_syndication_updated;
    m_date_syndication_updated_isSet = true;
}

bool OAIInfographic::is_date_syndication_updated_Set() const{
    return m_date_syndication_updated_isSet;
}

bool OAIInfographic::is_date_syndication_updated_Valid() const{
    return m_date_syndication_updated_isValid;
}

QDate OAIInfographic::getDateSyndicationVisible() const {
    return m_date_syndication_visible;
}
void OAIInfographic::setDateSyndicationVisible(const QDate &date_syndication_visible) {
    m_date_syndication_visible = date_syndication_visible;
    m_date_syndication_visible_isSet = true;
}

bool OAIInfographic::is_date_syndication_visible_Set() const{
    return m_date_syndication_visible_isSet;
}

bool OAIInfographic::is_date_syndication_visible_Valid() const{
    return m_date_syndication_visible_isValid;
}

QString OAIInfographic::getDescription() const {
    return m_description;
}
void OAIInfographic::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIInfographic::is_description_Set() const{
    return m_description_isSet;
}

bool OAIInfographic::is_description_Valid() const{
    return m_description_isValid;
}

QList<OAIExtendedAttribute> OAIInfographic::getExtendedAttributes() const {
    return m_extended_attributes;
}
void OAIInfographic::setExtendedAttributes(const QList<OAIExtendedAttribute> &extended_attributes) {
    m_extended_attributes = extended_attributes;
    m_extended_attributes_isSet = true;
}

bool OAIInfographic::is_extended_attributes_Set() const{
    return m_extended_attributes_isSet;
}

bool OAIInfographic::is_extended_attributes_Valid() const{
    return m_extended_attributes_isValid;
}

QString OAIInfographic::getExternalGuid() const {
    return m_external_guid;
}
void OAIInfographic::setExternalGuid(const QString &external_guid) {
    m_external_guid = external_guid;
    m_external_guid_isSet = true;
}

bool OAIInfographic::is_external_guid_Set() const{
    return m_external_guid_isSet;
}

bool OAIInfographic::is_external_guid_Valid() const{
    return m_external_guid_isValid;
}

QString OAIInfographic::getForeignSyndicationApiUrl() const {
    return m_foreign_syndication_api_url;
}
void OAIInfographic::setForeignSyndicationApiUrl(const QString &foreign_syndication_api_url) {
    m_foreign_syndication_api_url = foreign_syndication_api_url;
    m_foreign_syndication_api_url_isSet = true;
}

bool OAIInfographic::is_foreign_syndication_api_url_Set() const{
    return m_foreign_syndication_api_url_isSet;
}

bool OAIInfographic::is_foreign_syndication_api_url_Valid() const{
    return m_foreign_syndication_api_url_isValid;
}

QString OAIInfographic::getHash() const {
    return m_hash;
}
void OAIInfographic::setHash(const QString &hash) {
    m_hash = hash;
    m_hash_isSet = true;
}

bool OAIInfographic::is_hash_Set() const{
    return m_hash_isSet;
}

bool OAIInfographic::is_hash_Valid() const{
    return m_hash_isValid;
}

qint32 OAIInfographic::getHeight() const {
    return m_height;
}
void OAIInfographic::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIInfographic::is_height_Set() const{
    return m_height_isSet;
}

bool OAIInfographic::is_height_Valid() const{
    return m_height_isValid;
}

qint64 OAIInfographic::getId() const {
    return m_id;
}
void OAIInfographic::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInfographic::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInfographic::is_id_Valid() const{
    return m_id_isValid;
}

OAILanguage OAIInfographic::getLanguage() const {
    return m_language;
}
void OAIInfographic::setLanguage(const OAILanguage &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIInfographic::is_language_Set() const{
    return m_language_isSet;
}

bool OAIInfographic::is_language_Valid() const{
    return m_language_isValid;
}

QString OAIInfographic::getMediaType() const {
    return m_media_type;
}
void OAIInfographic::setMediaType(const QString &media_type) {
    m_media_type = media_type;
    m_media_type_isSet = true;
}

bool OAIInfographic::is_media_type_Set() const{
    return m_media_type_isSet;
}

bool OAIInfographic::is_media_type_Valid() const{
    return m_media_type_isValid;
}

QString OAIInfographic::getName() const {
    return m_name;
}
void OAIInfographic::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIInfographic::is_name_Set() const{
    return m_name_isSet;
}

bool OAIInfographic::is_name_Valid() const{
    return m_name_isValid;
}

OAISource OAIInfographic::getSource() const {
    return m_source;
}
void OAIInfographic::setSource(const OAISource &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIInfographic::is_source_Set() const{
    return m_source_isSet;
}

bool OAIInfographic::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIInfographic::getSourceUrl() const {
    return m_source_url;
}
void OAIInfographic::setSourceUrl(const QString &source_url) {
    m_source_url = source_url;
    m_source_url_isSet = true;
}

bool OAIInfographic::is_source_url_Set() const{
    return m_source_url_isSet;
}

bool OAIInfographic::is_source_url_Valid() const{
    return m_source_url_isValid;
}

QString OAIInfographic::getTargetUrl() const {
    return m_target_url;
}
void OAIInfographic::setTargetUrl(const QString &target_url) {
    m_target_url = target_url;
    m_target_url_isSet = true;
}

bool OAIInfographic::is_target_url_Set() const{
    return m_target_url_isSet;
}

bool OAIInfographic::is_target_url_Valid() const{
    return m_target_url_isValid;
}

qint32 OAIInfographic::getWidth() const {
    return m_width;
}
void OAIInfographic::setWidth(const qint32 &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIInfographic::is_width_Set() const{
    return m_width_isSet;
}

bool OAIInfographic::is_width_Valid() const{
    return m_width_isValid;
}

bool OAIInfographic::isSet() const {
...
bool OAIInfographic::isValid() const {
