...
#include "OAIPaginationWrapped.h"
...
OAIPaginationWrapped::OAIPaginationWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaginationWrapped::OAIPaginationWrapped() {
    this->initializeModel();
}

OAIPaginationWrapped::~OAIPaginationWrapped() {}

void OAIPaginationWrapped::initializeModel() {
...
void OAIPaginationWrapped::fromJson(QString jsonString) {
...
void OAIPaginationWrapped::fromJsonObject(QJsonObject json) {
...
QString OAIPaginationWrapped::asJson() const {
...
QJsonObject OAIPaginationWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAIPaginationWrapped::getCallback() const {
    return m_callback;
}
void OAIPaginationWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIPaginationWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIPaginationWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAIPaginationWrapped::getMeta() const {
    return m_meta;
}
void OAIPaginationWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIPaginationWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIPaginationWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIPagination> OAIPaginationWrapped::getResults() const {
    return m_results;
}
void OAIPaginationWrapped::setResults(const QList<OAIPagination> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIPaginationWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAIPaginationWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIPaginationWrapped::isSet() const {
...
bool OAIPaginationWrapped::isValid() const {
