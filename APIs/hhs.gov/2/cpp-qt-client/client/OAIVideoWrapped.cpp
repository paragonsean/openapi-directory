...
OAIVideoWrapped::OAIVideoWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVideoWrapped::OAIVideoWrapped() {
    this->initializeModel();
}

OAIVideoWrapped::~OAIVideoWrapped() {}

void OAIVideoWrapped::initializeModel() {
...
void OAIVideoWrapped::fromJson(QString jsonString) {
...
void OAIVideoWrapped::fromJsonObject(QJsonObject json) {
...
QString OAIVideoWrapped::asJson() const {
...
QJsonObject OAIVideoWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAIVideoWrapped::getCallback() const {
    return m_callback;
}
void OAIVideoWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIVideoWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIVideoWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAIVideoWrapped::getMeta() const {
    return m_meta;
}
void OAIVideoWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIVideoWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIVideoWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIVideo> OAIVideoWrapped::getResults() const {
    return m_results;
}
void OAIVideoWrapped::setResults(const QList<OAIVideo> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIVideoWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAIVideoWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIVideoWrapped::isSet() const {
...
bool OAIVideoWrapped::isValid() const {
