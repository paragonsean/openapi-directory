...
#ifndef OAITweetWrapped_H
#define OAITweetWrapped_H
...
class OAITweetWrapped : public OAIObject {
public:
    OAITweetWrapped();
    OAITweetWrapped(QString json);
    ~OAITweetWrapped() override;
    ...
    QList<OAITweet> getResults() const;
    void setResults(const QList<OAITweet> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAITweetWrapped)

#endif // OAITweetWrapped_H
