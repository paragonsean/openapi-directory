...
OAITagLanguageMarshallerWrapped::OAITagLanguageMarshallerWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITagLanguageMarshallerWrapped::OAITagLanguageMarshallerWrapped() {
    this->initializeModel();
}

OAITagLanguageMarshallerWrapped::~OAITagLanguageMarshallerWrapped() {}

void OAITagLanguageMarshallerWrapped::initializeModel() {
...
void OAITagLanguageMarshallerWrapped::fromJson(QString jsonString) {
...
void OAITagLanguageMarshallerWrapped::fromJsonObject(QJsonObject json) {
...
QString OAITagLanguageMarshallerWrapped::asJson() const {
...
QJsonObject OAITagLanguageMarshallerWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAITagLanguageMarshallerWrapped::getCallback() const {
    return m_callback;
}
void OAITagLanguageMarshallerWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAITagLanguageMarshallerWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAITagLanguageMarshallerWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAITagLanguageMarshallerWrapped::getMeta() const {
    return m_meta;
}
void OAITagLanguageMarshallerWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAITagLanguageMarshallerWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAITagLanguageMarshallerWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAITagLanguageMarshaller> OAITagLanguageMarshallerWrapped::getResults() const {
    return m_results;
}
void OAITagLanguageMarshallerWrapped::setResults(const QList<OAITagLanguageMarshaller> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAITagLanguageMarshallerWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAITagLanguageMarshallerWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAITagLanguageMarshallerWrapped::isSet() const {
...
bool OAITagLanguageMarshallerWrapped::isValid() const {
