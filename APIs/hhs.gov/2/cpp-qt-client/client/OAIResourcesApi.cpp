...
void OAIResourcesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("resourcesJsonGet", defaultConf);
    _serverIndices.insert("resourcesJsonGet", 0);
}
...
void OAIResourcesApi::resourcesJsonGet(const QString &q) {
    QString fullPath = QString(_serverConfigs["resourcesJsonGet"][_serverIndices.value("resourcesJsonGet")].URL()+"/resources.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIResourcesApi::resourcesJsonGetCallback);
...
void OAIResourcesApi::resourcesJsonGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT resourcesJsonGetSignal(output);
        Q_EMIT resourcesJsonGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT resourcesJsonGetSignalE(output, error_type, error_str);
        Q_EMIT resourcesJsonGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT resourcesJsonGetSignalError(output, error_type, error_str);
        Q_EMIT resourcesJsonGetSignalErrorFull(worker, error_type, error_str);
    }
}
