...
#ifndef OAIImageWrapped_H
#define OAIImageWrapped_H
...
class OAIImageWrapped : public OAIObject {
public:
    OAIImageWrapped();
    OAIImageWrapped(QString json);
    ~OAIImageWrapped() override;
    ...
    QList<OAIImage> getResults() const;
    void setResults(const QList<OAIImage> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageWrapped)

#endif // OAIImageWrapped_H
