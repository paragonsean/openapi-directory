...
OAIMediaItemWrapped::OAIMediaItemWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMediaItemWrapped::OAIMediaItemWrapped() {
    this->initializeModel();
}

OAIMediaItemWrapped::~OAIMediaItemWrapped() {}

void OAIMediaItemWrapped::initializeModel() {
...
void OAIMediaItemWrapped::fromJson(QString jsonString) {
...
void OAIMediaItemWrapped::fromJsonObject(QJsonObject json) {
...
QString OAIMediaItemWrapped::asJson() const {
...
QJsonObject OAIMediaItemWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAIMediaItemWrapped::getCallback() const {
    return m_callback;
}
void OAIMediaItemWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIMediaItemWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIMediaItemWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAIMediaItemWrapped::getMeta() const {
    return m_meta;
}
void OAIMediaItemWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIMediaItemWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIMediaItemWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIMediaItem> OAIMediaItemWrapped::getResults() const {
    return m_results;
}
void OAIMediaItemWrapped::setResults(const QList<OAIMediaItem> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIMediaItemWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAIMediaItemWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIMediaItemWrapped::isSet() const {
...
bool OAIMediaItemWrapped::isValid() const {
