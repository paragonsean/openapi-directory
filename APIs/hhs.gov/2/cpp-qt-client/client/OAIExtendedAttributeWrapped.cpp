...
#include "OAIExtendedAttributeWrapped.h"
...
OAIExtendedAttributeWrapped::OAIExtendedAttributeWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExtendedAttributeWrapped::OAIExtendedAttributeWrapped() {
    this->initializeModel();
}

OAIExtendedAttributeWrapped::~OAIExtendedAttributeWrapped() {}

void OAIExtendedAttributeWrapped::initializeModel() {
...
void OAIExtendedAttributeWrapped::fromJson(QString jsonString) {
...
void OAIExtendedAttributeWrapped::fromJsonObject(QJsonObject json) {
...
QString OAIExtendedAttributeWrapped::asJson() const {
...
QJsonObject OAIExtendedAttributeWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAIExtendedAttributeWrapped::getCallback() const {
    return m_callback;
}
void OAIExtendedAttributeWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIExtendedAttributeWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIExtendedAttributeWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAIExtendedAttributeWrapped::getMeta() const {
    return m_meta;
}
void OAIExtendedAttributeWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIExtendedAttributeWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIExtendedAttributeWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIExtendedAttribute> OAIExtendedAttributeWrapped::getResults() const {
    return m_results;
}
void OAIExtendedAttributeWrapped::setResults(const QList<OAIExtendedAttribute> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIExtendedAttributeWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAIExtendedAttributeWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIExtendedAttributeWrapped::isSet() const {
...
bool OAIExtendedAttributeWrapped::isValid() const {
