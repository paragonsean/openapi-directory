...
QList<OAICampaign> OAIVideo::getCampaigns() const {
    return m_campaigns;
}
void OAIVideo::setCampaigns(const QList<OAICampaign> &campaigns) {
    m_campaigns = campaigns;
    m_campaigns_isSet = true;
}

bool OAIVideo::is_campaigns_Set() const{
    return m_campaigns_isSet;
}

bool OAIVideo::is_campaigns_Valid() const{
    return m_campaigns_isValid;
}

QString OAIVideo::getCreatedBy() const {
    return m_created_by;
}
void OAIVideo::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIVideo::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIVideo::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QString OAIVideo::getCustomAttributionUrl() const {
    return m_custom_attribution_url;
}
void OAIVideo::setCustomAttributionUrl(const QString &custom_attribution_url) {
    m_custom_attribution_url = custom_attribution_url;
    m_custom_attribution_url_isSet = true;
}

bool OAIVideo::is_custom_attribution_url_Set() const{
    return m_custom_attribution_url_isSet;
}

bool OAIVideo::is_custom_attribution_url_Valid() const{
    return m_custom_attribution_url_isValid;
}

QString OAIVideo::getCustomPreviewUrl() const {
    return m_custom_preview_url;
}
void OAIVideo::setCustomPreviewUrl(const QString &custom_preview_url) {
    m_custom_preview_url = custom_preview_url;
    m_custom_preview_url_isSet = true;
}

bool OAIVideo::is_custom_preview_url_Set() const{
    return m_custom_preview_url_isSet;
}

bool OAIVideo::is_custom_preview_url_Valid() const{
    return m_custom_preview_url_isValid;
}

QString OAIVideo::getCustomThumbnailUrl() const {
    return m_custom_thumbnail_url;
}
void OAIVideo::setCustomThumbnailUrl(const QString &custom_thumbnail_url) {
    m_custom_thumbnail_url = custom_thumbnail_url;
    m_custom_thumbnail_url_isSet = true;
}

bool OAIVideo::is_custom_thumbnail_url_Set() const{
    return m_custom_thumbnail_url_isSet;
}

bool OAIVideo::is_custom_thumbnail_url_Valid() const{
    return m_custom_thumbnail_url_isValid;
}

QDate OAIVideo::getDateContentAuthored() const {
    return m_date_content_authored;
}
void OAIVideo::setDateContentAuthored(const QDate &date_content_authored) {
    m_date_content_authored = date_content_authored;
    m_date_content_authored_isSet = true;
}

bool OAIVideo::is_date_content_authored_Set() const{
    return m_date_content_authored_isSet;
}

bool OAIVideo::is_date_content_authored_Valid() const{
    return m_date_content_authored_isValid;
}

QDate OAIVideo::getDateContentPublished() const {
    return m_date_content_published;
}
void OAIVideo::setDateContentPublished(const QDate &date_content_published) {
    m_date_content_published = date_content_published;
    m_date_content_published_isSet = true;
}

bool OAIVideo::is_date_content_published_Set() const{
    return m_date_content_published_isSet;
}

bool OAIVideo::is_date_content_published_Valid() const{
    return m_date_content_published_isValid;
}

QDate OAIVideo::getDateContentReviewed() const {
    return m_date_content_reviewed;
}
void OAIVideo::setDateContentReviewed(const QDate &date_content_reviewed) {
    m_date_content_reviewed = date_content_reviewed;
    m_date_content_reviewed_isSet = true;
}

bool OAIVideo::is_date_content_reviewed_Set() const{
    return m_date_content_reviewed_isSet;
}

bool OAIVideo::is_date_content_reviewed_Valid() const{
    return m_date_content_reviewed_isValid;
}

QDate OAIVideo::getDateContentUpdated() const {
    return m_date_content_updated;
}
void OAIVideo::setDateContentUpdated(const QDate &date_content_updated) {
    m_date_content_updated = date_content_updated;
    m_date_content_updated_isSet = true;
}

bool OAIVideo::is_date_content_updated_Set() const{
    return m_date_content_updated_isSet;
}

bool OAIVideo::is_date_content_updated_Valid() const{
    return m_date_content_updated_isValid;
}

QDate OAIVideo::getDateSyndicationCaptured() const {
    return m_date_syndication_captured;
}
void OAIVideo::setDateSyndicationCaptured(const QDate &date_syndication_captured) {
    m_date_syndication_captured = date_syndication_captured;
    m_date_syndication_captured_isSet = true;
}

bool OAIVideo::is_date_syndication_captured_Set() const{
    return m_date_syndication_captured_isSet;
}

bool OAIVideo::is_date_syndication_captured_Valid() const{
    return m_date_syndication_captured_isValid;
}

QDate OAIVideo::getDateSyndicationUpdated() const {
    return m_date_syndication_updated;
}
void OAIVideo::setDateSyndicationUpdated(const QDate &date_syndication_updated) {
    m_date_syndication_updated = date_syndication_updated;
    m_date_syndication_updated_isSet = true;
}

bool OAIVideo::is_date_syndication_updated_Set() const{
    return m_date_syndication_updated_isSet;
}

bool OAIVideo::is_date_syndication_updated_Valid() const{
    return m_date_syndication_updated_isValid;
}

QDate OAIVideo::getDateSyndicationVisible() const {
    return m_date_syndication_visible;
}
void OAIVideo::setDateSyndicationVisible(const QDate &date_syndication_visible) {
    m_date_syndication_visible = date_syndication_visible;
    m_date_syndication_visible_isSet = true;
}

bool OAIVideo::is_date_syndication_visible_Set() const{
    return m_date_syndication_visible_isSet;
}

bool OAIVideo::is_date_syndication_visible_Valid() const{
...
QList<OAIExtendedAttribute> OAIVideo::getExtendedAttributes() const {
    return m_extended_attributes;
}
void OAIVideo::setExtendedAttributes(const QList<OAIExtendedAttribute> &extended_attributes) {
    m_extended_attributes = extended_attributes;
    m_extended_attributes_isSet = true;
}

bool OAIVideo::is_extended_attributes_Set() const{
    return m_extended_attributes_isSet;
}

bool OAIVideo::is_extended_attributes_Valid() const{
    return m_extended_attributes_isValid;
}

QString OAIVideo::getExternalGuid() const {
    return m_external_guid;
}
void OAIVideo::setExternalGuid(const QString &external_guid) {
    m_external_guid = external_guid;
    m_external_guid_isSet = true;
}

bool OAIVideo::is_external_guid_Set() const{
    return m_external_guid_isSet;
}

bool OAIVideo::is_external_guid_Valid() const{
    return m_external_guid_isValid;
}

QString OAIVideo::getForeignSyndicationApiUrl() const {
    return m_foreign_syndication_api_url;
}
void OAIVideo::setForeignSyndicationApiUrl(const QString &foreign_syndication_api_url) {
    m_foreign_syndication_api_url = foreign_syndication_api_url;
    m_foreign_syndication_api_url_isSet = true;
}

bool OAIVideo::is_foreign_syndication_api_url_Set() const{
    return m_foreign_syndication_api_url_isSet;
}

bool OAIVideo::is_foreign_syndication_api_url_Valid() const{
    return m_foreign_syndication_api_url_isValid;
}

QString OAIVideo::getHash() const {
    return m_hash;
}
void OAIVideo::setHash(const QString &hash) {
    m_hash = hash;
    m_hash_isSet = true;
}

bool OAIVideo::is_hash_Set() const{
    return m_hash_isSet;
}

bool OAIVideo::is_hash_Valid() const{
    return m_hash_isValid;
}

qint64 OAIVideo::getId() const {
    return m_id;
}
void OAIVideo::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
OAILanguage OAIVideo::getLanguage() const {
    return m_language;
}
void OAIVideo::setLanguage(const OAILanguage &language) {
    m_language = language;
...
QString OAIVideo::getSourceUrl() const {
    return m_source_url;
}
void OAIVideo::setSourceUrl(const QString &source_url) {
    m_source_url = source_url;
    m_source_url_isSet = true;
}

bool OAIVideo::is_source_url_Set() const{
    return m_source_url_isSet;
}

bool OAIVideo::is_source_url_Valid() const{
    return m_source_url_isValid;
}

QString OAIVideo::getTargetUrl() const {
    return m_target_url;
}
void OAIVideo::setTargetUrl(const QString &target_url) {
    m_target_url = target_url;
    m_target_url_isSet = true;
}

bool OAIVideo::is_target_url_Set() const{
    return m_target_url_isSet;
}

bool OAIVideo::is_target_url_Valid() const{
