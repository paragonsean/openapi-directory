...
#include "OAIInfographicWrapped.h"
...
OAIInfographicWrapped::OAIInfographicWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInfographicWrapped::OAIInfographicWrapped() {
    this->initializeModel();
}

OAIInfographicWrapped::~OAIInfographicWrapped() {}

void OAIInfographicWrapped::initializeModel() {
...
void OAIInfographicWrapped::fromJson(QString jsonString) {
...
void OAIInfographicWrapped::fromJsonObject(QJsonObject json) {
...
QString OAIInfographicWrapped::asJson() const {
...
QJsonObject OAIInfographicWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAIInfographicWrapped::getCallback() const {
    return m_callback;
}
void OAIInfographicWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIInfographicWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIInfographicWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAIInfographicWrapped::getMeta() const {
    return m_meta;
}
void OAIInfographicWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIInfographicWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIInfographicWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIInfographic> OAIInfographicWrapped::getResults() const {
    return m_results;
}
void OAIInfographicWrapped::setResults(const QList<OAIInfographic> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIInfographicWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAIInfographicWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIInfographicWrapped::isSet() const {
...
bool OAIInfographicWrapped::isValid() const {
