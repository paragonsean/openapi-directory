...
OAIImageWrapped::OAIImageWrapped(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImageWrapped::OAIImageWrapped() {
    this->initializeModel();
}

OAIImageWrapped::~OAIImageWrapped() {}

void OAIImageWrapped::initializeModel() {
...
void OAIImageWrapped::fromJson(QString jsonString) {
...
void OAIImageWrapped::fromJsonObject(QJsonObject json) {
...
QString OAIImageWrapped::asJson() const {
...
QJsonObject OAIImageWrapped::asJsonObject() const {
    QJsonObject obj;
    if (m_callback_isSet) {
...
QString OAIImageWrapped::getCallback() const {
    return m_callback;
}
void OAIImageWrapped::setCallback(const QString &callback) {
    m_callback = callback;
    m_callback_isSet = true;
}

bool OAIImageWrapped::is_callback_Set() const{
    return m_callback_isSet;
}

bool OAIImageWrapped::is_callback_Valid() const{
    return m_callback_isValid;
}

OAIMeta OAIImageWrapped::getMeta() const {
    return m_meta;
}
void OAIImageWrapped::setMeta(const OAIMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIImageWrapped::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIImageWrapped::is_meta_Valid() const{
    return m_meta_isValid;
}

QList<OAIImage> OAIImageWrapped::getResults() const {
    return m_results;
}
void OAIImageWrapped::setResults(const QList<OAIImage> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIImageWrapped::is_results_Set() const{
    return m_results_isSet;
}

bool OAIImageWrapped::is_results_Valid() const{
    return m_results_isValid;
}

bool OAIImageWrapped::isSet() const {
...
bool OAIImageWrapped::isValid() const {
