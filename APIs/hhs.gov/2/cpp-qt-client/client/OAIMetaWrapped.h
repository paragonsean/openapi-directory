...
#ifndef OAIMetaWrapped_H
#define OAIMetaWrapped_H
...
class OAIMetaWrapped : public OAIObject {
public:
    OAIMetaWrapped();
    OAIMetaWrapped(QString json);
    ~OAIMetaWrapped() override;
    ...
    QList<OAIMeta> getResults() const;
    void setResults(const QList<OAIMeta> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMetaWrapped)

#endif // OAIMetaWrapped_H
