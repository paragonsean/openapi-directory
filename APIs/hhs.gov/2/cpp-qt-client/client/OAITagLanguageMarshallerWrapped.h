...
/*
 * OAITagLanguageMarshallerWrapped.h
 *
 * 
 */

#ifndef OAITagLanguageMarshallerWrapped_H
#define OAITagLanguageMarshallerWrapped_H

#include <QJsonObject>

#include "OAIMeta.h"
#include "OAITagLanguageMarshaller.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIMeta;
class OAITagLanguageMarshaller;

class OAITagLanguageMarshallerWrapped : public OAIObject {
public:
    OAITagLanguageMarshallerWrapped();
    OAITagLanguageMarshallerWrapped(QString json);
    ~OAITagLanguageMarshallerWrapped() override;
    ...
    QList<OAITagLanguageMarshaller> getResults() const;
    void setResults(const QList<OAITagLanguageMarshaller> &results);
...
private:
    ...
    QList<OAITagLanguageMarshaller> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagLanguageMarshallerWrapped)

#endif // OAITagLanguageMarshallerWrapped_H
