...
/*
 * OAIInfographicWrapped.h
 *
 * 
 */

#ifndef OAIInfographicWrapped_H
#define OAIInfographicWrapped_H
...
namespace OpenAPI {
class OAIMeta;
class OAIInfographic;

class OAIInfographicWrapped : public OAIObject {
public:
    OAIInfographicWrapped();
    OAIInfographicWrapped(QString json);
    ~OAIInfographicWrapped() override;
    ...
    QList<OAIInfographic> getResults() const;
    void setResults(const QList<OAIInfographic> &results);
...
private:
    ...
    QList<OAIInfographic> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInfographicWrapped)

#endif // OAIInfographicWrapped_H
