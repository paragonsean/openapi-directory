...
/*
 * OAICampaignWrapped.h
 *
 * 
 */

#ifndef OAICampaignWrapped_H
#define OAICampaignWrapped_H
...
class OAICampaignWrapped : public OAIObject {
public:
    OAICampaignWrapped();
    OAICampaignWrapped(QString json);
    ~OAICampaignWrapped() override;
    ...
    QList<OAICampaign> getResults() const;
    void setResults(const QList<OAICampaign> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAICampaignWrapped)

#endif // OAICampaignWrapped_H
