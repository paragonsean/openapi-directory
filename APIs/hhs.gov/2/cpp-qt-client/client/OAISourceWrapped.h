...
#ifndef OAISourceWrapped_H
#define OAISourceWrapped_H
...
class OAISourceWrapped : public OAIObject {
public:
    OAISourceWrapped();
    OAISourceWrapped(QString json);
    ~OAISourceWrapped() override;
    ...
    QList<OAISource> getResults() const;
    void setResults(const QList<OAISource> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceWrapped)

#endif // OAISourceWrapped_H
