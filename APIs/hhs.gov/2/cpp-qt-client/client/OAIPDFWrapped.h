...
#ifndef OAIPDFWrapped_H
#define OAIPDFWrapped_H
...
class OAIPDFWrapped : public OAIObject {
public:
    OAIPDFWrapped();
    OAIPDFWrapped(QString json);
    ~OAIPDFWrapped() override;
    ...
    QList<OAIPDF> getResults() const;
    void setResults(const QList<OAIPDF> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPDFWrapped)

#endif // OAIPDFWrapped_H
