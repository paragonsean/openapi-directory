...
/*
 * OAITagMarshallerWrapped.h
 *
 * 
 */

#ifndef OAITagMarshallerWrapped_H
#define OAITagMarshallerWrapped_H
...
namespace OpenAPI {
class OAIMeta;
class OAITagMarshaller;

class OAITagMarshallerWrapped : public OAIObject {
public:
    OAITagMarshallerWrapped();
    OAITagMarshallerWrapped(QString json);
    ~OAITagMarshallerWrapped() override;
    ...
    QList<OAITagMarshaller> getResults() const;
    void setResults(const QList<OAITagMarshaller> &results);
...
private:
    ...
    QList<OAITagMarshaller> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagMarshallerWrapped)

#endif // OAITagMarshallerWrapped_H
