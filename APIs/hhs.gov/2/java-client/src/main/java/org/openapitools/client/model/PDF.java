...
public class PDF {
  ...
  public PDF campaigns(List<Campaign> campaigns) {
    this.campaigns = campaigns;
    return this;
  }

  public PDF addCampaignsItem(Campaign campaignsItem) {
  ...
  public PDF createdBy(String createdBy) {
  ...
  public PDF customAttributionUrl(String customAttributionUrl) {
  ...
  public PDF customPreviewUrl(String customPreviewUrl) {
  ...
  public PDF customThumbnailUrl(String customThumbnailUrl) {
  ...
  public PDF dateContentAuthored(LocalDate dateContentAuthored) {
  ...
  public PDF dateContentPublished(LocalDate dateContentPublished) {
  ...
  public PDF dateContentReviewed(LocalDate dateContentReviewed) {
  ...
  public PDF dateContentUpdated(LocalDate dateContentUpdated) {
  ...
  public PDF dateSyndicationCaptured(LocalDate dateSyndicationCaptured) {
  ...
  public PDF dateSyndicationUpdated(LocalDate dateSyndicationUpdated) {
  ...
  public PDF dateSyndicationVisible(LocalDate dateSyndicationVisible) {
  ...
  public PDF extendedAttributes(List<ExtendedAttribute> extendedAttributes) {
    this.extendedAttributes = extendedAttributes;
    return this;
  }

  public PDF addExtendedAttributesItem(ExtendedAttribute extendedAttributesItem) {
  ...
  public PDF externalGuid(String externalGuid) {
  ...
  public PDF foreignSyndicationAPIUrl(String foreignSyndicationAPIUrl) {
  ...
  public PDF language(Language language) {
  ...
  public PDF mediaType(String mediaType) {
  ...
  public PDF source(Source source) {
    this.source = source;
    return this;
  }
  ...
  public PDF sourceUrl(String sourceUrl) {
  ...
  public PDF targetUrl(String targetUrl) {
  ...
  public boolean equals(Object o) {
    ...
    PDF PDF = (PDF) o;
    return Objects.equals(this.campaigns, PDF.campaigns) &&
        Objects.equals(this.createdBy, PDF.createdBy) &&
        Objects.equals(this.customAttributionUrl, PDF.customAttributionUrl) &&
        Objects.equals(this.customPreviewUrl, PDF.customPreviewUrl) &&
        Objects.equals(this.customThumbnailUrl, PDF.customThumbnailUrl) &&
        Objects.equals(this.dateContentAuthored, PDF.dateContentAuthored) &&
        Objects.equals(this.dateContentPublished, PDF.dateContentPublished) &&
        Objects.equals(this.dateContentReviewed, PDF.dateContentReviewed) &&
        Objects.equals(this.dateContentUpdated, PDF.dateContentUpdated) &&
        Objects.equals(this.dateSyndicationCaptured, PDF.dateSyndicationCaptured) &&
        Objects.equals(this.dateSyndicationUpdated, PDF.dateSyndicationUpdated) &&
        Objects.equals(this.dateSyndicationVisible, PDF.dateSyndicationVisible) &&
        Objects.equals(this.description, PDF.description) &&
        Objects.equals(this.extendedAttributes, PDF.extendedAttributes) &&
        Objects.equals(this.externalGuid, PDF.externalGuid) &&
        Objects.equals(this.foreignSyndicationAPIUrl, PDF.foreignSyndicationAPIUrl) &&
        Objects.equals(this.hash, PDF.hash) &&
        Objects.equals(this.id, PDF.id) &&
        Objects.equals(this.language, PDF.language) &&
        Objects.equals(this.mediaType, PDF.mediaType) &&
        Objects.equals(this.name, PDF.name) &&
        Objects.equals(this.source, PDF.source) &&
        Objects.equals(this.sourceUrl, PDF.sourceUrl) &&
        Objects.equals(this.targetUrl, PDF.targetUrl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PDF
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PDF.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PDF is not found in the empty JSON string", PDF.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PDF.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PDF` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PDF.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PDF' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PDF> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PDF.class));

       return (TypeAdapter<T>) new TypeAdapter<PDF>() {
           @Override
           public void write(JsonWriter out, PDF value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PDF read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PDF given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PDF
   * @throws IOException if the JSON string is invalid with respect to PDF
   */
  public static PDF fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PDF.class);
  }

  /**
   * Convert an instance of PDF to an JSON string
   *
   * @return JSON string
   */
