...
public class Html {
  ...
  public Html campaigns(List<Campaign> campaigns) {
    this.campaigns = campaigns;
    return this;
  }

  public Html addCampaignsItem(Campaign campaignsItem) {
  ...
  public Html createdBy(String createdBy) {
  ...
  public Html customAttributionUrl(String customAttributionUrl) {
  ...
  public Html customPreviewUrl(String customPreviewUrl) {
  ...
  public Html customThumbnailUrl(String customThumbnailUrl) {
  ...
  public Html dateContentAuthored(LocalDate dateContentAuthored) {
  ...
  public Html dateContentPublished(LocalDate dateContentPublished) {
  ...
  public Html dateContentReviewed(LocalDate dateContentReviewed) {
  ...
  public Html dateContentUpdated(LocalDate dateContentUpdated) {
  ...
  public Html dateSyndicationCaptured(LocalDate dateSyndicationCaptured) {
  ...
  public Html dateSyndicationUpdated(LocalDate dateSyndicationUpdated) {
  ...
  public Html dateSyndicationVisible(LocalDate dateSyndicationVisible) {
  ...
  public Html description(String description) {
  ...
  public Html extendedAttributes(List<ExtendedAttribute> extendedAttributes) {
    this.extendedAttributes = extendedAttributes;
    return this;
  }

  public Html addExtendedAttributesItem(ExtendedAttribute extendedAttributesItem) {
  ...
  public Html externalGuid(String externalGuid) {
  ...
  public Html foreignSyndicationAPIUrl(String foreignSyndicationAPIUrl) {
  ...
  public Html language(Language language) {
  ...
  public Html mediaType(String mediaType) {
  ...
  public Html source(Source source) {
    this.source = source;
    return this;
  }
  ...
  public Html sourceUrl(String sourceUrl) {
  ...
  public Html targetUrl(String targetUrl) {
  ...
  public boolean equals(Object o) {
    ...
    Html html = (Html) o;
    return Objects.equals(this.campaigns, html.campaigns) &&
        Objects.equals(this.createdBy, html.createdBy) &&
        Objects.equals(this.customAttributionUrl, html.customAttributionUrl) &&
        Objects.equals(this.customPreviewUrl, html.customPreviewUrl) &&
        Objects.equals(this.customThumbnailUrl, html.customThumbnailUrl) &&
        Objects.equals(this.dateContentAuthored, html.dateContentAuthored) &&
        Objects.equals(this.dateContentPublished, html.dateContentPublished) &&
        Objects.equals(this.dateContentReviewed, html.dateContentReviewed) &&
        Objects.equals(this.dateContentUpdated, html.dateContentUpdated) &&
        Objects.equals(this.dateSyndicationCaptured, html.dateSyndicationCaptured) &&
        Objects.equals(this.dateSyndicationUpdated, html.dateSyndicationUpdated) &&
        Objects.equals(this.dateSyndicationVisible, html.dateSyndicationVisible) &&
        Objects.equals(this.description, html.description) &&
        Objects.equals(this.extendedAttributes, html.extendedAttributes) &&
        Objects.equals(this.externalGuid, html.externalGuid) &&
        Objects.equals(this.foreignSyndicationAPIUrl, html.foreignSyndicationAPIUrl) &&
        Objects.equals(this.hash, html.hash) &&
        Objects.equals(this.id, html.id) &&
        Objects.equals(this.language, html.language) &&
        Objects.equals(this.mediaType, html.mediaType) &&
        Objects.equals(this.name, html.name) &&
        Objects.equals(this.source, html.source) &&
        Objects.equals(this.sourceUrl, html.sourceUrl) &&
        Objects.equals(this.targetUrl, html.targetUrl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Html
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Html.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Html is not found in the empty JSON string", Html.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Html.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Html` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Html.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Html' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Html> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Html.class));

       return (TypeAdapter<T>) new TypeAdapter<Html>() {
           @Override
  ...
  /**
   * Create an instance of Html given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Html
   * @throws IOException if the JSON string is invalid with respect to Html
   */
  public static Html fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Html.class);
  }

  /**
   * Convert an instance of Html to an JSON string
   *
   * @return JSON string
   */
