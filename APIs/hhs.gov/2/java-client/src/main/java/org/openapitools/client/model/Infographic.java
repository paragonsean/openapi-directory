...
public class Infographic {
  ...
  public Infographic campaigns(List<Campaign> campaigns) {
    this.campaigns = campaigns;
    return this;
  }

  public Infographic addCampaignsItem(Campaign campaignsItem) {
  ...
  public Infographic createdBy(String createdBy) {
  ...
  public Infographic customAttributionUrl(String customAttributionUrl) {
  ...
  public Infographic customPreviewUrl(String customPreviewUrl) {
  ...
  public Infographic customThumbnailUrl(String customThumbnailUrl) {
  ...
  public Infographic dateContentAuthored(LocalDate dateContentAuthored) {
  ...
  public Infographic dateContentPublished(LocalDate dateContentPublished) {
  ...
  public Infographic dateContentReviewed(LocalDate dateContentReviewed) {
  ...
  public Infographic dateContentUpdated(LocalDate dateContentUpdated) {
  ...
  public Infographic dateSyndicationCaptured(LocalDate dateSyndicationCaptured) {
  ...
  public Infographic dateSyndicationUpdated(LocalDate dateSyndicationUpdated) {
  ...
  public Infographic dateSyndicationVisible(LocalDate dateSyndicationVisible) {
  ...
  public Infographic description(String description) {
  ...
  public Infographic extendedAttributes(List<ExtendedAttribute> extendedAttributes) {
    this.extendedAttributes = extendedAttributes;
    return this;
  }

  public Infographic addExtendedAttributesItem(ExtendedAttribute extendedAttributesItem) {
  ...
  public Infographic externalGuid(String externalGuid) {
  ...
  public Infographic foreignSyndicationAPIUrl(String foreignSyndicationAPIUrl) {
  ...
  public Infographic hash(String hash) {
    this.hash = hash;
    return this;
  }
  ...
  public Infographic height(Integer height) {
    this.height = height;
    return this;
  }
  ...
  public Infographic language(Language language) {
  ...
  public Infographic mediaType(String mediaType) {
  ...
  public Infographic name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Infographic source(Source source) {
    this.source = source;
    return this;
  }
  ...
  public Infographic sourceUrl(String sourceUrl) {
  ...
  public Infographic targetUrl(String targetUrl) {
  ...
  public Infographic width(Integer width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Infographic infographic = (Infographic) o;
    return Objects.equals(this.campaigns, infographic.campaigns) &&
        Objects.equals(this.createdBy, infographic.createdBy) &&
        Objects.equals(this.customAttributionUrl, infographic.customAttributionUrl) &&
        Objects.equals(this.customPreviewUrl, infographic.customPreviewUrl) &&
        Objects.equals(this.customThumbnailUrl, infographic.customThumbnailUrl) &&
        Objects.equals(this.dateContentAuthored, infographic.dateContentAuthored) &&
        Objects.equals(this.dateContentPublished, infographic.dateContentPublished) &&
        Objects.equals(this.dateContentReviewed, infographic.dateContentReviewed) &&
        Objects.equals(this.dateContentUpdated, infographic.dateContentUpdated) &&
        Objects.equals(this.dateSyndicationCaptured, infographic.dateSyndicationCaptured) &&
        Objects.equals(this.dateSyndicationUpdated, infographic.dateSyndicationUpdated) &&
        Objects.equals(this.dateSyndicationVisible, infographic.dateSyndicationVisible) &&
        Objects.equals(this.description, infographic.description) &&
        Objects.equals(this.extendedAttributes, infographic.extendedAttributes) &&
        Objects.equals(this.externalGuid, infographic.externalGuid) &&
        Objects.equals(this.foreignSyndicationAPIUrl, infographic.foreignSyndicationAPIUrl) &&
        Objects.equals(this.hash, infographic.hash) &&
        Objects.equals(this.height, infographic.height) &&
        Objects.equals(this.id, infographic.id) &&
        Objects.equals(this.language, infographic.language) &&
        Objects.equals(this.mediaType, infographic.mediaType) &&
        Objects.equals(this.name, infographic.name) &&
        Objects.equals(this.source, infographic.source) &&
        Objects.equals(this.sourceUrl, infographic.sourceUrl) &&
        Objects.equals(this.targetUrl, infographic.targetUrl) &&
        Objects.equals(this.width, infographic.width);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Infographic
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Infographic.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Infographic is not found in the empty JSON string", Infographic.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Infographic.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Infographic` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Infographic.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Infographic' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Infographic> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Infographic.class));

       return (TypeAdapter<T>) new TypeAdapter<Infographic>() {
           @Override
           public void write(JsonWriter out, Infographic value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Infographic read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Infographic given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Infographic
   * @throws IOException if the JSON string is invalid with respect to Infographic
   */
  public static Infographic fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Infographic.class);
  }

  /**
   * Convert an instance of Infographic to an JSON string
   *
   * @return JSON string
   */
