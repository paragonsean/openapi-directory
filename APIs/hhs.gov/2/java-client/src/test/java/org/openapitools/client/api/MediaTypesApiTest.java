...
/**
 * API tests for MediaTypesApi
 */
@Disabled
public class MediaTypesApiTest {

    private final MediaTypesApi api = new MediaTypesApi();
     ...
     */
    @Test
    public void resourcesMediaTypesFormatGetTest() throws ApiException {
        String format = null;
        List<MediaTypeHolderWrapped> response = api.resourcesMediaTypesFormatGet(format);
