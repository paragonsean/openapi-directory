...
public class SourcesApiTest {
     ...
     */
    @Test
    public void resourcesSourcesIdJsonGetTest() throws ApiException {
        Long id = null;
        List<SourceWrapped> response = api.resourcesSourcesIdJsonGet(id);
     ...
     */
    @Test
    public void resourcesSourcesIdSyndicateFormatGetTest() throws ApiException {
        Long id = null;
        String format = null;
        String displayMethod = null;
        List<MediaItemWrapped> response = api.resourcesSourcesIdSyndicateFormatGet(id, format, displayMethod);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void resourcesSourcesJsonGetTest() throws ApiException {
        Integer max = null;
        Integer offset = null;
        String sort = null;
        List<SourceWrapped> response = api.resourcesSourcesJsonGet(max, offset, sort);
        // TODO: test validations
    }
