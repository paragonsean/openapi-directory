...
/**
 * API tests for UserMediaListsApi
 */
@Disabled
public class UserMediaListsApiTest {

    private final UserMediaListsApi api = new UserMediaListsApi();
     ...
     */
    @Test
    public void resourcesUserMediaListsIdJsonGetTest() throws ApiException {
        Long id = null;
        String displayMethod = null;
        List<MediaItemWrapped> response = api.resourcesUserMediaListsIdJsonGet(id, displayMethod);
