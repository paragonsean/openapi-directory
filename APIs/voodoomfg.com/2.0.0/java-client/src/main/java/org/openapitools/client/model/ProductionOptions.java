...
public class ProductionOptions {
  ...
  public ProductionOptions orientation(Boolean orientation) {
  ...
  public boolean equals(Object o) {
    ...
    ProductionOptions productionOptions = (ProductionOptions) o;
    return Objects.equals(this.orientation, productionOptions.orientation);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductionOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProductionOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductionOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductionOptions is not found in the empty JSON string", ProductionOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductionOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductionOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductionOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductionOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductionOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductionOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductionOptions>() {
           @Override
           public void write(JsonWriter out, ProductionOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductionOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProductionOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProductionOptions
   * @throws IOException if the JSON string is invalid with respect to ProductionOptions
   */
  public static ProductionOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductionOptions.class);
  }

  /**
   * Convert an instance of ProductionOptions to an JSON string
   *
   * @return JSON string
   */
