...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("Voodoo Manufacturing API Key", new ApiKeyAuth("header", "api_key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g /api/2
