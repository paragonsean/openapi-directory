...
OAIShippingOptionsBody::OAIShippingOptionsBody(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIShippingOptionsBody::OAIShippingOptionsBody() {
    this->initializeModel();
}

OAIShippingOptionsBody::~OAIShippingOptionsBody() {}

void OAIShippingOptionsBody::initializeModel() {
...
void OAIShippingOptionsBody::fromJson(QString jsonString) {
...
void OAIShippingOptionsBody::fromJsonObject(QJsonObject json) {
...
QString OAIShippingOptionsBody::asJson() const {
...
QJsonObject OAIShippingOptionsBody::asJsonObject() const {
    QJsonObject obj;
    if (m_models.size() > 0) {
...
QList<OAIPrint> OAIShippingOptionsBody::getModels() const {
    return m_models;
}
void OAIShippingOptionsBody::setModels(const QList<OAIPrint> &models) {
    m_models = models;
    m_models_isSet = true;
}

bool OAIShippingOptionsBody::is_models_Set() const{
    return m_models_isSet;
}

bool OAIShippingOptionsBody::is_models_Valid() const{
    return m_models_isValid;
}

OAIShippingAddress OAIShippingOptionsBody::getShippingAddress() const {
    return m_shipping_address;
}
void OAIShippingOptionsBody::setShippingAddress(const OAIShippingAddress &shipping_address) {
    m_shipping_address = shipping_address;
    m_shipping_address_isSet = true;
}

bool OAIShippingOptionsBody::is_shipping_address_Set() const{
    return m_shipping_address_isSet;
}

bool OAIShippingOptionsBody::is_shipping_address_Valid() const{
    return m_shipping_address_isValid;
}

bool OAIShippingOptionsBody::isSet() const {
...
bool OAIShippingOptionsBody::isValid() const {
