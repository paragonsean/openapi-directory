...
#ifndef OAIProductionOptions_H
#define OAIProductionOptions_H
...
class OAIProductionOptions : public OAIObject {
public:
    OAIProductionOptions();
    OAIProductionOptions(QString json);
    ~OAIProductionOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductionOptions)

#endif // OAIProductionOptions_H
