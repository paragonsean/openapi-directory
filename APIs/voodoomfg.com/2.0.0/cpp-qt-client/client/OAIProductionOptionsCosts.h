...
/*
 * OAIProductionOptionsCosts.h
 *
 * Cost of any requested additional model services.
 */

#ifndef OAIProductionOptionsCosts_H
#define OAIProductionOptionsCosts_H
...
class OAIProductionOptionsCosts : public OAIObject {
public:
    OAIProductionOptionsCosts();
    OAIProductionOptionsCosts(QString json);
    ~OAIProductionOptionsCosts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductionOptionsCosts)

#endif // OAIProductionOptionsCosts_H
