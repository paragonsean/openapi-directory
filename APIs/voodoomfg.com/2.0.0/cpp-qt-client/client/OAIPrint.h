...
namespace OpenAPI {
class OAIProductionOptions;

class OAIPrint : public OAIObject {
public:
    OAIPrint();
    OAIPrint(QString json);
    ~OAIPrint() override;
    ...
    qint32 getMaterialId() const;
    void setMaterialId(const qint32 &material_id);
    bool is_material_id_Set() const;
    bool is_material_id_Valid() const;
    ...
    OAIProductionOptions getOptions() const;
    void setOptions(const OAIProductionOptions &options);
...
private:
    ...
    qint32 m_material_id;
    bool m_material_id_isSet;
    bool m_material_id_isValid;

    qint32 m_model_id;
    bool m_model_id_isSet;
    bool m_model_id_isValid;

    OAIProductionOptions m_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPrint)
