...
/*
 * OAIShippingOptionsBody.h
 *
 * 
 */

#ifndef OAIShippingOptionsBody_H
#define OAIShippingOptionsBody_H
...
class OAIShippingOptionsBody : public OAIObject {
public:
    OAIShippingOptionsBody();
    OAIShippingOptionsBody(QString json);
    ~OAIShippingOptionsBody() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShippingOptionsBody)

#endif // OAIShippingOptionsBody_H
