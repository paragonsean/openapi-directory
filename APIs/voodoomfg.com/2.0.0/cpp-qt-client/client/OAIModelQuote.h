...
#ifndef OAIModelQuote_H
#define OAIModelQuote_H
...
class OAIModelQuote : public OAIObject {
public:
    OAIModelQuote();
    OAIModelQuote(QString json);
    ~OAIModelQuote() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModelQuote)

#endif // OAIModelQuote_H
