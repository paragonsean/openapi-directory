...
/*
 * OAICreateModelBody.h
 *
 * 
 */

#ifndef OAICreateModelBody_H
#define OAICreateModelBody_H
...
class OAICreateModelBody : public OAIObject {
public:
    OAICreateModelBody();
    OAICreateModelBody(QString json);
    ~OAICreateModelBody() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModelBody)

#endif // OAICreateModelBody_H
