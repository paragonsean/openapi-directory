...
#ifndef OAI_OAIMaterialsApi_H
#define OAI_OAIMaterialsApi_H
...
class OAIMaterialsApi : public QObject {
    Q_OBJECT

public:
    OAIMaterialsApi(const int timeOut = 0);
    ~OAIMaterialsApi();
...
private:
    ...
    void materialsGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void materialsGetSignal(QList<OAIMaterial> summary);


    void materialsGetSignalFull(OAIHttpRequestWorker *worker, QList<OAIMaterial> summary);

    Q_DECL_DEPRECATED_X("Use materialsGetSignalError() instead")
    void materialsGetSignalE(QList<OAIMaterial> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void materialsGetSignalError(QList<OAIMaterial> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use materialsGetSignalErrorFull() instead")
    void materialsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void materialsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
