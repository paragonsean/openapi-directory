...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.CreateOrderBody();
  });
  ...
  describe('CreateOrderBody', function() {
    it('should create an instance of CreateOrderBody', function() {
      ...
      //var instance = new VoodooManufacturing3DPrintApi.CreateOrderBody();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.CreateOrderBody);
    });
