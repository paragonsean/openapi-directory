...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.ModelQuote();
  });
  ...
  describe('ModelQuote', function() {
    it('should create an instance of ModelQuote', function() {
      // uncomment below and update the code to test ModelQuote
      //var instance = new VoodooManufacturing3DPrintApi.ModelQuote();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.ModelQuote);
    });
