...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.OrderConfirmPost200Response();
  });
  ...
  describe('OrderConfirmPost200Response', function() {
    it('should create an instance of OrderConfirmPost200Response', function() {
      // uncomment below and update the code to test OrderConfirmPost200Response
      //var instance = new VoodooManufacturing3DPrintApi.OrderConfirmPost200Response();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.OrderConfirmPost200Response);
    });
    ...
    it('should have the property purchased (base name: "purchased")', function() {
      // uncomment below and update the code to test the property purchased
      //var instance = new VoodooManufacturing3DPrintApi.OrderConfirmPost200Response();
      //expect(instance).to.be();
    });
