...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.OrderPrint();
  });
  ...
  describe('OrderPrint', function() {
    it('should create an instance of OrderPrint', function() {
      // uncomment below and update the code to test OrderPrint
      //var instance = new VoodooManufacturing3DPrintApi.OrderPrint();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.OrderPrint);
    });
