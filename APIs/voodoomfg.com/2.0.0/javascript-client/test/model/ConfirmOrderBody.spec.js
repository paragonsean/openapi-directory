...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.ConfirmOrderBody();
  });
  ...
  describe('ConfirmOrderBody', function() {
    it('should create an instance of ConfirmOrderBody', function() {
      // uncomment below and update the code to test ConfirmOrderBody
      //var instance = new VoodooManufacturing3DPrintApi.ConfirmOrderBody();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.ConfirmOrderBody);
    });
