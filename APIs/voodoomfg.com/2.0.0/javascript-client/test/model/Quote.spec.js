...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.Quote();
  });
  ...
  describe('Quote', function() {
    it('should create an instance of Quote', function() {
      ...
      //var instance = new VoodooManufacturing3DPrintApi.Quote();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.Quote);
    });
