...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.ProductionOptionsCosts();
  });
  ...
  describe('ProductionOptionsCosts', function() {
    it('should create an instance of ProductionOptionsCosts', function() {
      // uncomment below and update the code to test ProductionOptionsCosts
      //var instance = new VoodooManufacturing3DPrintApi.ProductionOptionsCosts();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.ProductionOptionsCosts);
    });
