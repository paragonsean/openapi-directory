...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.Print();
  });
  ...
  describe('Print', function() {
    it('should create an instance of Print', function() {
      // uncomment below and update the code to test Print
      //var instance = new VoodooManufacturing3DPrintApi.Print();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.Print);
    });
