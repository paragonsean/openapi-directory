...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.ShippingOptionsBody();
  });
  ...
  describe('ShippingOptionsBody', function() {
    it('should create an instance of ShippingOptionsBody', function() {
      // uncomment below and update the code to test ShippingOptionsBody
      //var instance = new VoodooManufacturing3DPrintApi.ShippingOptionsBody();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.ShippingOptionsBody);
    });
