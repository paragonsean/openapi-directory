...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.OrderShippingPost200Response();
  });
  ...
  describe('OrderShippingPost200Response', function() {
    it('should create an instance of OrderShippingPost200Response', function() {
      // uncomment below and update the code to test OrderShippingPost200Response
      //var instance = new VoodooManufacturing3DPrintApi.OrderShippingPost200Response();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.OrderShippingPost200Response);
    });
