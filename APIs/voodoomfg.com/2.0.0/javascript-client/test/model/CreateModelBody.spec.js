...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.CreateModelBody();
  });
  ...
  describe('CreateModelBody', function() {
    it('should create an instance of CreateModelBody', function() {
      // uncomment below and update the code to test CreateModelBody
      //var instance = new VoodooManufacturing3DPrintApi.CreateModelBody();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.CreateModelBody);
    });
