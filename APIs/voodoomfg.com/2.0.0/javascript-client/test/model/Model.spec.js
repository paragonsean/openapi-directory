...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.Model();
  });
  ...
  describe('Model', function() {
    it('should create an instance of Model', function() {
      ...
      //var instance = new VoodooManufacturing3DPrintApi.Model();
      //expect(instance).to.be.a(VoodooManufacturing3DPrintApi.Model);
    });
    ...
    it('should have the property renderingUrl (base name: "rendering_url")', function() {
      // uncomment below and update the code to test the property renderingUrl
      //var instance = new VoodooManufacturing3DPrintApi.Model();
      //expect(instance).to.be();
    });

    it('should have the property surfaceArea (base name: "surface_area")', function() {
      // uncomment below and update the code to test the property surfaceArea
      //var instance = new VoodooManufacturing3DPrintApi.Model();
      //expect(instance).to.be();
    });
