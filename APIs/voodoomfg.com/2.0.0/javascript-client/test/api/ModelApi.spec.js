...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.ModelApi();
  });
  ...
  describe('ModelApi', function() {
    describe('modelGet', function() {
      it('should call modelGet successfully', function(done) {
        //uncomment below and update the code to test modelGet
        //instance.modelGet(function(error) {
    ...
    describe('modelModelIdGet', function() {
      it('should call modelModelIdGet successfully', function(done) {
        //uncomment below and update the code to test modelModelIdGet
        //instance.modelModelIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('modelPost', function() {
      it('should call modelPost successfully', function(done) {
        //uncomment below and update the code to test modelPost
        //instance.modelPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('modelQuoteAttrsGet', function() {
      it('should call modelQuoteAttrsGet successfully', function(done) {
        //uncomment below and update the code to test modelQuoteAttrsGet
        //instance.modelQuoteAttrsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('modelQuoteGet', function() {
      it('should call modelQuoteGet successfully', function(done) {
        //uncomment below and update the code to test modelQuoteGet
        //instance.modelQuoteGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
