...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VoodooManufacturing3DPrintApi.OrderApi();
  });
  ...
  describe('OrderApi', function() {
    describe('orderConfirmPost', function() {
      it('should call orderConfirmPost successfully', function(done) {
        //uncomment below and update the code to test orderConfirmPost
        //instance.orderConfirmPost(function(error) {
    ...
    describe('orderCreatePost', function() {
      it('should call orderCreatePost successfully', function(done) {
        //uncomment below and update the code to test orderCreatePost
        //instance.orderCreatePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('orderGet', function() {
      it('should call orderGet successfully', function(done) {
        ...
        //instance.orderGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('orderShippingPost', function() {
      it('should call orderShippingPost successfully', function(done) {
        //uncomment below and update the code to test orderShippingPost
        //instance.orderShippingPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
