...
/**
 * The ShippingOptionsBody model module.
 * @module model/ShippingOptionsBody
 * @version 2.0.0
 */
class ShippingOptionsBody {
    /**
     * Constructs a new <code>ShippingOptionsBody</code>.
     * @alias module:model/ShippingOptionsBody
     */
    constructor() { 
        
        ShippingOptionsBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ShippingOptionsBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShippingOptionsBody} obj Optional instance to populate.
     * @return {module:model/ShippingOptionsBody} The populated <code>ShippingOptionsBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShippingOptionsBody();
    ...
    /**
     * Validates the JSON data with respect to <code>ShippingOptionsBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShippingOptionsBody</code>.
     */
 ...
 */
ShippingOptionsBody.prototype['models'] = undefined;

/**
 * @member {module:model/ShippingAddress} shipping_address
 */
ShippingOptionsBody.prototype['shipping_address'] = undefined;
...
export default ShippingOptionsBody;
