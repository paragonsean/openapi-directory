...
/**
 * The OrderPrint model module.
 * @module model/OrderPrint
 * @version 2.0.0
 */
class OrderPrint {
    /**
     * Constructs a new <code>OrderPrint</code>.
     * @alias module:model/OrderPrint
     */
    constructor() { 
        
        OrderPrint.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderPrint</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderPrint} obj Optional instance to populate.
     * @return {module:model/OrderPrint} The populated <code>OrderPrint</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderPrint();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderPrint</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderPrint</code>.
     */
    static validateJSON(data) {
        // validate the optional field `material`
        if (data['material']) { // data not null
          Material.validateJSON(data['material']);
        }
 ...
 */
OrderPrint.prototype['material'] = undefined;

/**
 * @member {module:model/Model} model
 */
OrderPrint.prototype['model'] = undefined;

/**
 * The number of prints requested for this model and material pair.
 * @member {Number} quantity
 */
OrderPrint.prototype['quantity'] = undefined;

/**
 * Units for the requested print. One of \"mm\", \"cm\", or \"in\".
 * @member {String} units
 */
OrderPrint.prototype['units'] = undefined;
