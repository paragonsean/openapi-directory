...
/**
 * The CreateModelBody model module.
 * @module model/CreateModelBody
 * @version 2.0.0
 */
class CreateModelBody {
    /**
     * Constructs a new <code>CreateModelBody</code>.
     * @alias module:model/CreateModelBody
     */
    constructor() { 
        
        CreateModelBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateModelBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateModelBody} obj Optional instance to populate.
     * @return {module:model/CreateModelBody} The populated <code>CreateModelBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateModelBody();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateModelBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateModelBody</code>.
     */
 ...
 */
CreateModelBody.prototype['file_url'] = undefined;
...
export default CreateModelBody;
