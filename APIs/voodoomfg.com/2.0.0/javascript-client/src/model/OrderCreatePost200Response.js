...
/**
 * The OrderCreatePost200Response model module.
 * @module model/OrderCreatePost200Response
 * @version 2.0.0
 */
class OrderCreatePost200Response {
    /**
     * Constructs a new <code>OrderCreatePost200Response</code>.
     * @alias module:model/OrderCreatePost200Response
     */
    constructor() { 
        
        OrderCreatePost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderCreatePost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderCreatePost200Response} obj Optional instance to populate.
     * @return {module:model/OrderCreatePost200Response} The populated <code>OrderCreatePost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderCreatePost200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderCreatePost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderCreatePost200Response</code>.
     */
...
export default OrderCreatePost200Response;
