...
/**
 * The ConfirmOrderBody model module.
 * @module model/ConfirmOrderBody
 * @version 2.0.0
 */
class ConfirmOrderBody {
    /**
     * Constructs a new <code>ConfirmOrderBody</code>.
     * @alias module:model/ConfirmOrderBody
     */
    constructor() { 
        
        ConfirmOrderBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfirmOrderBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmOrderBody} obj Optional instance to populate.
     * @return {module:model/ConfirmOrderBody} The populated <code>ConfirmOrderBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmOrderBody();
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmOrderBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmOrderBody</code>.
     */
 ...
 */
ConfirmOrderBody.prototype['quote_id'] = undefined;
