...
#include <iostream>
#include "../client/OAIAccountAccessApi.h"
...
void Example::exampleFunction1(){
     OAIAccountAccessApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAccountAccessApi::accountAccessConsentsConsentIdDeleteSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAccountAccessApi::accountAccessConsentsConsentIdDeleteSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString consent_id = create(); // QString | ConsentId
      ...
      QString sandbox_id = create(); // QString | The unique id of the sandbox to be used
      ...
      QString x_fapi_auth_date = create(); // QString | The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC
      ...
      QString x_fapi_customer_ip_address = create(); // QString | The PSU's IP address if the PSU is currently logged in with the TPP.
      ...
      QString x_fapi_interaction_id = create(); // QString | An RFC4122 UID used as a correlation id.
      ...
      QString x_customer_user_agent = create(); // QString | Indicates the user-agent that the PSU is using.
      apiInstance.accountAccessConsentsConsentIdDelete(consent_idsandbox_idx_fapi_auth_datex_fapi_customer_ip_addressx_fapi_interaction_idx_customer_user_agent);
