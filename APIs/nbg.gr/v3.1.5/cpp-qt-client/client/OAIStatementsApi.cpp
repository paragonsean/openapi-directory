...
void OAIStatementsApi::initializeServerConfigs() {
    ...
    "Production Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("accountsAccountIdStatementsGet", defaultConf);
    _serverIndices.insert("accountsAccountIdStatementsGet", 0);
    _serverConfigs.insert("accountsAccountIdStatementsStatementIdFileGet", defaultConf);
    _serverIndices.insert("accountsAccountIdStatementsStatementIdFileGet", 0);
    _serverConfigs.insert("accountsAccountIdStatementsStatementIdGet", defaultConf);
    _serverIndices.insert("accountsAccountIdStatementsStatementIdGet", 0);
}
...
void OAIStatementsApi::accountsAccountIdStatementsGet(const QString &account_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QDateTime> &from_statement_date_time, const ::OpenAPI::OptionalParam<QDateTime> &to_statement_date_time, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["accountsAccountIdStatementsGet"][_serverIndices.value("accountsAccountIdStatementsGet")].URL()+"/accounts/{accountId}/statements");
    ...
    if (from_statement_date_time.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "fromStatementDateTime", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("fromStatementDateTime")).append(querySuffix).append(QUrl::toPercentEncoding(from_statement_date_time.stringValue()));
    }
    if (to_statement_date_time.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "toStatementDateTime", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("toStatementDateTime")).append(querySuffix).append(QUrl::toPercentEncoding(to_statement_date_time.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatementsApi::accountsAccountIdStatementsGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatementsApi::accountsAccountIdStatementsGetCallback);
    connect(this, &OAIStatementsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIStatementsApi::accountsAccountIdStatementsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOBReadStatement2 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdStatementsGetSignal(output);
        Q_EMIT accountsAccountIdStatementsGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdStatementsGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdStatementsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdStatementsGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdStatementsGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIStatementsApi::accountsAccountIdStatementsStatementIdFileGet(const QString &account_id, const QString &statement_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["accountsAccountIdStatementsStatementIdFileGet"][_serverIndices.value("accountsAccountIdStatementsStatementIdFileGet")].URL()+"/accounts/{accountId}/statements/{statementId}/file");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatementsApi::accountsAccountIdStatementsStatementIdFileGetCallback);
    connect(this, &OAIStatementsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatementsApi::accountsAccountIdStatementsStatementIdFileGetCallback);
    connect(this, &OAIStatementsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIStatementsApi::accountsAccountIdStatementsStatementIdFileGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdStatementsStatementIdFileGetSignal(output);
        Q_EMIT accountsAccountIdStatementsStatementIdFileGetSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("sandbox-uk-account-info-api-v1 offline_access");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdStatementsStatementIdFileGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdStatementsStatementIdFileGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdStatementsStatementIdFileGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdStatementsStatementIdFileGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIStatementsApi::accountsAccountIdStatementsStatementIdGet(const QString &account_id, const QString &statement_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["accountsAccountIdStatementsStatementIdGet"][_serverIndices.value("accountsAccountIdStatementsStatementIdGet")].URL()+"/accounts/{accountId}/statements/{statementId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatementsApi::accountsAccountIdStatementsStatementIdGetCallback);
    connect(this, &OAIStatementsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatementsApi::accountsAccountIdStatementsStatementIdGetCallback);
    connect(this, &OAIStatementsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIStatementsApi::accountsAccountIdStatementsStatementIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdStatementsStatementIdGetSignal(output);
        Q_EMIT accountsAccountIdStatementsStatementIdGetSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("sandbox-uk-account-info-api-v1 offline_access");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdStatementsStatementIdGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdStatementsStatementIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdStatementsStatementIdGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdStatementsStatementIdGetSignalErrorFull(worker, error_type, error_str);
    }
}
