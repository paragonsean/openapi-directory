...
#include "OAISandboxBankAccountInfo.h"
...
OAISandboxBankAccountInfo::OAISandboxBankAccountInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISandboxBankAccountInfo::OAISandboxBankAccountInfo() {
    this->initializeModel();
}

OAISandboxBankAccountInfo::~OAISandboxBankAccountInfo() {}

void OAISandboxBankAccountInfo::initializeModel() {

    m_account_sub_type_isSet = false;
    m_account_sub_type_isValid = false;
    ...
    m_overdraft_limit_isSet = false;
    m_overdraft_limit_isValid = false;
}

void OAISandboxBankAccountInfo::fromJson(QString jsonString) {
...
void OAISandboxBankAccountInfo::fromJsonObject(QJsonObject json) {

    m_account_sub_type_isValid = ::OpenAPI::fromJsonValue(m_account_sub_type, json[QString("accountSubType")]);
    m_account_sub_type_isSet = !json[QString("accountSubType")].isNull() && m_account_sub_type_isValid;
    ...
    m_overdraft_limit_isValid = ::OpenAPI::fromJsonValue(m_overdraft_limit, json[QString("overdraftLimit")]);
    m_overdraft_limit_isSet = !json[QString("overdraftLimit")].isNull() && m_overdraft_limit_isValid;
}

QString OAISandboxBankAccountInfo::asJson() const {
...
QJsonObject OAISandboxBankAccountInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_account_sub_type_isSet) {
        obj.insert(QString("accountSubType"), ::OpenAPI::toJsonValue(m_account_sub_type));
    }
    ...
    if (m_overdraft_limit_isSet) {
        obj.insert(QString("overdraftLimit"), ::OpenAPI::toJsonValue(m_overdraft_limit));
    }
    return obj;
}

QString OAISandboxBankAccountInfo::getAccountSubType() const {
    return m_account_sub_type;
}
void OAISandboxBankAccountInfo::setAccountSubType(const QString &account_sub_type) {
    m_account_sub_type = account_sub_type;
    m_account_sub_type_isSet = true;
}

bool OAISandboxBankAccountInfo::is_account_sub_type_Set() const{
    return m_account_sub_type_isSet;
}

bool OAISandboxBankAccountInfo::is_account_sub_type_Valid() const{
    return m_account_sub_type_isValid;
}

QString OAISandboxBankAccountInfo::getAccountType() const {
    return m_account_type;
}
void OAISandboxBankAccountInfo::setAccountType(const QString &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAISandboxBankAccountInfo::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAISandboxBankAccountInfo::is_account_type_Valid() const{
    return m_account_type_isValid;
}

QString OAISandboxBankAccountInfo::getAlias() const {
    return m_alias;
}
void OAISandboxBankAccountInfo::setAlias(const QString &alias) {
    m_alias = alias;
    m_alias_isSet = true;
}

bool OAISandboxBankAccountInfo::is_alias_Set() const{
    return m_alias_isSet;
}

bool OAISandboxBankAccountInfo::is_alias_Valid() const{
    return m_alias_isValid;
}

double OAISandboxBankAccountInfo::getAvailableBalance() const {
    return m_available_balance;
}
void OAISandboxBankAccountInfo::setAvailableBalance(const double &available_balance) {
    m_available_balance = available_balance;
    m_available_balance_isSet = true;
}

bool OAISandboxBankAccountInfo::is_available_balance_Set() const{
    return m_available_balance_isSet;
}

bool OAISandboxBankAccountInfo::is_available_balance_Valid() const{
    return m_available_balance_isValid;
}

QString OAISandboxBankAccountInfo::getCurrency() const {
    return m_currency;
}
void OAISandboxBankAccountInfo::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAISandboxBankAccountInfo::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAISandboxBankAccountInfo::is_currency_Valid() const{
    return m_currency_isValid;
}

QString OAISandboxBankAccountInfo::getDescription() const {
    return m_description;
}
void OAISandboxBankAccountInfo::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISandboxBankAccountInfo::is_description_Set() const{
    return m_description_isSet;
}

bool OAISandboxBankAccountInfo::is_description_Valid() const{
    return m_description_isValid;
}

QString OAISandboxBankAccountInfo::getIban() const {
    return m_iban;
}
void OAISandboxBankAccountInfo::setIban(const QString &iban) {
    m_iban = iban;
    m_iban_isSet = true;
}

bool OAISandboxBankAccountInfo::is_iban_Set() const{
    return m_iban_isSet;
}

bool OAISandboxBankAccountInfo::is_iban_Valid() const{
    return m_iban_isValid;
}

double OAISandboxBankAccountInfo::getLedgerBalance() const {
    return m_ledger_balance;
}
void OAISandboxBankAccountInfo::setLedgerBalance(const double &ledger_balance) {
    m_ledger_balance = ledger_balance;
    m_ledger_balance_isSet = true;
}

bool OAISandboxBankAccountInfo::is_ledger_balance_Set() const{
    return m_ledger_balance_isSet;
}

bool OAISandboxBankAccountInfo::is_ledger_balance_Valid() const{
    return m_ledger_balance_isValid;
}

QDateTime OAISandboxBankAccountInfo::getOpeningDate() const {
    return m_opening_date;
}
void OAISandboxBankAccountInfo::setOpeningDate(const QDateTime &opening_date) {
    m_opening_date = opening_date;
    m_opening_date_isSet = true;
}

bool OAISandboxBankAccountInfo::is_opening_date_Set() const{
    return m_opening_date_isSet;
}

bool OAISandboxBankAccountInfo::is_opening_date_Valid() const{
    return m_opening_date_isValid;
}

double OAISandboxBankAccountInfo::getOverdraftLimit() const {
    return m_overdraft_limit;
}
void OAISandboxBankAccountInfo::setOverdraftLimit(const double &overdraft_limit) {
    m_overdraft_limit = overdraft_limit;
    m_overdraft_limit_isSet = true;
}

bool OAISandboxBankAccountInfo::is_overdraft_limit_Set() const{
    return m_overdraft_limit_isSet;
}

bool OAISandboxBankAccountInfo::is_overdraft_limit_Valid() const{
    return m_overdraft_limit_isValid;
}

bool OAISandboxBankAccountInfo::isSet() const {
...
bool OAISandboxBankAccountInfo::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_account_sub_type_isValid && m_account_type_isValid && m_currency_isValid && m_iban_isValid && true;
}
