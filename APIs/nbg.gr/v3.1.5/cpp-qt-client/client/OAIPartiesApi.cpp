...
void OAIPartiesApi::initializeServerConfigs() {
    ...
    "Production Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("accountsAccountIdPartiesGet", defaultConf);
    _serverIndices.insert("accountsAccountIdPartiesGet", 0);
    _serverConfigs.insert("accountsAccountIdPartyGet", defaultConf);
    _serverIndices.insert("accountsAccountIdPartyGet", 0);
    _serverConfigs.insert("partyGet", defaultConf);
    _serverIndices.insert("partyGet", 0);
}
...
void OAIPartiesApi::accountsAccountIdPartiesGet(const QString &account_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPartiesApi::accountsAccountIdPartiesGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPartiesApi::accountsAccountIdPartiesGetCallback);
    connect(this, &OAIPartiesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIPartiesApi::accountsAccountIdPartiesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOBReadParty3 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdPartiesGetSignal(output);
        Q_EMIT accountsAccountIdPartiesGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdPartiesGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdPartiesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdPartiesGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdPartiesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPartiesApi::accountsAccountIdPartyGet(const QString &account_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["accountsAccountIdPartyGet"][_serverIndices.value("accountsAccountIdPartyGet")].URL()+"/accounts/{accountId}/party");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPartiesApi::accountsAccountIdPartyGetCallback);
    connect(this, &OAIPartiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPartiesApi::accountsAccountIdPartyGetCallback);
    connect(this, &OAIPartiesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPartiesApi::accountsAccountIdPartyGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIOBReadParty2 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdPartyGetSignal(output);
        Q_EMIT accountsAccountIdPartyGetSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("sandbox-uk-account-info-api-v1 offline_access");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdPartyGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdPartyGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdPartyGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdPartyGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPartiesApi::partyGet(const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["partyGet"][_serverIndices.value("partyGet")].URL()+"/party");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPartiesApi::partyGetCallback);
    connect(this, &OAIPartiesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPartiesApi::partyGetCallback);
    connect(this, &OAIPartiesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPartiesApi::partyGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT partyGetSignal(output);
        Q_EMIT partyGetSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("sandbox-uk-account-info-api-v1 offline_access");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT partyGetSignalE(output, error_type, error_str);
        Q_EMIT partyGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT partyGetSignalError(output, error_type, error_str);
        Q_EMIT partyGetSignalErrorFull(worker, error_type, error_str);
    }
}
