...
#include "OAISandboxTransaction.h"
...
OAISandboxTransaction::OAISandboxTransaction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISandboxTransaction::OAISandboxTransaction() {
    this->initializeModel();
}

OAISandboxTransaction::~OAISandboxTransaction() {}

void OAISandboxTransaction::initializeModel() {

    m_accounting_balance_isSet = false;
    m_accounting_balance_isValid = false;
    ...
    m_credit_debit_isSet = false;
    m_credit_debit_isValid = false;
    ...
    m_related_account_isSet = false;
    m_related_account_isValid = false;

    m_related_name_isSet = false;
    m_related_name_isValid = false;
...
void OAISandboxTransaction::fromJson(QString jsonString) {
...
void OAISandboxTransaction::fromJsonObject(QJsonObject json) {

    m_accounting_balance_isValid = ::OpenAPI::fromJsonValue(m_accounting_balance, json[QString("accountingBalance")]);
    m_accounting_balance_isSet = !json[QString("accountingBalance")].isNull() && m_accounting_balance_isValid;
    ...
    m_credit_debit_isValid = ::OpenAPI::fromJsonValue(m_credit_debit, json[QString("creditDebit")]);
    m_credit_debit_isSet = !json[QString("creditDebit")].isNull() && m_credit_debit_isValid;
    ...
    m_related_account_isValid = ::OpenAPI::fromJsonValue(m_related_account, json[QString("relatedAccount")]);
    m_related_account_isSet = !json[QString("relatedAccount")].isNull() && m_related_account_isValid;

    m_related_name_isValid = ::OpenAPI::fromJsonValue(m_related_name, json[QString("relatedName")]);
    m_related_name_isSet = !json[QString("relatedName")].isNull() && m_related_name_isValid;
...
QString OAISandboxTransaction::asJson() const {
...
QJsonObject OAISandboxTransaction::asJsonObject() const {
    QJsonObject obj;
    if (m_accounting_balance_isSet) {
        obj.insert(QString("accountingBalance"), ::OpenAPI::toJsonValue(m_accounting_balance));
    }
    if (m_amount_isSet) {
    ...
    if (m_credit_debit_isSet) {
        obj.insert(QString("creditDebit"), ::OpenAPI::toJsonValue(m_credit_debit));
    }
    if (m_currency_isSet) {
    ...
    if (m_related_account_isSet) {
        obj.insert(QString("relatedAccount"), ::OpenAPI::toJsonValue(m_related_account));
    }
    if (m_related_name_isSet) {
        obj.insert(QString("relatedName"), ::OpenAPI::toJsonValue(m_related_name));
    }
...
double OAISandboxTransaction::getAccountingBalance() const {
    return m_accounting_balance;
}
void OAISandboxTransaction::setAccountingBalance(const double &accounting_balance) {
    m_accounting_balance = accounting_balance;
    m_accounting_balance_isSet = true;
}

bool OAISandboxTransaction::is_accounting_balance_Set() const{
    return m_accounting_balance_isSet;
}

bool OAISandboxTransaction::is_accounting_balance_Valid() const{
    return m_accounting_balance_isValid;
}

double OAISandboxTransaction::getAmount() const {
    return m_amount;
}
void OAISandboxTransaction::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAISandboxTransaction::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAISandboxTransaction::is_amount_Valid() const{
    return m_amount_isValid;
}

QDateTime OAISandboxTransaction::getBookingDateTime() const {
    return m_booking_date_time;
}
void OAISandboxTransaction::setBookingDateTime(const QDateTime &booking_date_time) {
    m_booking_date_time = booking_date_time;
    m_booking_date_time_isSet = true;
}

bool OAISandboxTransaction::is_booking_date_time_Set() const{
    return m_booking_date_time_isSet;
}

bool OAISandboxTransaction::is_booking_date_time_Valid() const{
    return m_booking_date_time_isValid;
}

QString OAISandboxTransaction::getCreditDebit() const {
    return m_credit_debit;
}
void OAISandboxTransaction::setCreditDebit(const QString &credit_debit) {
    m_credit_debit = credit_debit;
    m_credit_debit_isSet = true;
}

bool OAISandboxTransaction::is_credit_debit_Set() const{
    return m_credit_debit_isSet;
}

bool OAISandboxTransaction::is_credit_debit_Valid() const{
    return m_credit_debit_isValid;
}

QString OAISandboxTransaction::getCurrency() const {
    return m_currency;
}
void OAISandboxTransaction::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAISandboxTransaction::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAISandboxTransaction::is_currency_Valid() const{
    return m_currency_isValid;
}

QString OAISandboxTransaction::getDescription() const {
    return m_description;
}
void OAISandboxTransaction::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISandboxTransaction::is_description_Set() const{
    return m_description_isSet;
}

bool OAISandboxTransaction::is_description_Valid() const{
    return m_description_isValid;
}

QString OAISandboxTransaction::getReference() const {
    return m_reference;
}
void OAISandboxTransaction::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAISandboxTransaction::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAISandboxTransaction::is_reference_Valid() const{
    return m_reference_isValid;
}

QString OAISandboxTransaction::getRelatedAccount() const {
    return m_related_account;
}
void OAISandboxTransaction::setRelatedAccount(const QString &related_account) {
    m_related_account = related_account;
    m_related_account_isSet = true;
}

bool OAISandboxTransaction::is_related_account_Set() const{
    return m_related_account_isSet;
}

bool OAISandboxTransaction::is_related_account_Valid() const{
    return m_related_account_isValid;
}

QString OAISandboxTransaction::getRelatedName() const {
    return m_related_name;
}
void OAISandboxTransaction::setRelatedName(const QString &related_name) {
    m_related_name = related_name;
    m_related_name_isSet = true;
}

bool OAISandboxTransaction::is_related_name_Set() const{
    return m_related_name_isSet;
}

bool OAISandboxTransaction::is_related_name_Valid() const{
    return m_related_name_isValid;
}

QString OAISandboxTransaction::getTransactionCode() const {
    return m_transaction_code;
}
void OAISandboxTransaction::setTransactionCode(const QString &transaction_code) {
    m_transaction_code = transaction_code;
    m_transaction_code_isSet = true;
}

bool OAISandboxTransaction::is_transaction_code_Set() const{
    return m_transaction_code_isSet;
}

bool OAISandboxTransaction::is_transaction_code_Valid() const{
    return m_transaction_code_isValid;
}

QDateTime OAISandboxTransaction::getValueDateTime() const {
    return m_value_date_time;
}
void OAISandboxTransaction::setValueDateTime(const QDateTime &value_date_time) {
    m_value_date_time = value_date_time;
    m_value_date_time_isSet = true;
}

bool OAISandboxTransaction::is_value_date_time_Set() const{
    return m_value_date_time_isSet;
}

bool OAISandboxTransaction::is_value_date_time_Valid() const{
    return m_value_date_time_isValid;
}

bool OAISandboxTransaction::isSet() const {
...
bool OAISandboxTransaction::isValid() const {
