...
#include "OAIScheduledPaymentsApi.h"
...
OAIScheduledPaymentsApi::OAIScheduledPaymentsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIScheduledPaymentsApi::~OAIScheduledPaymentsApi() {
}

void OAIScheduledPaymentsApi::initializeServerConfigs() {
    //Default server
    ...
    "Production Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("accountsAccountIdScheduledPaymentsGet", defaultConf);
    _serverIndices.insert("accountsAccountIdScheduledPaymentsGet", 0);
}
...
*/
int OAIScheduledPaymentsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIScheduledPaymentsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIScheduledPaymentsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIScheduledPaymentsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIScheduledPaymentsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIScheduledPaymentsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIScheduledPaymentsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIScheduledPaymentsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIScheduledPaymentsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIScheduledPaymentsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIScheduledPaymentsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIScheduledPaymentsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIScheduledPaymentsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIScheduledPaymentsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIScheduledPaymentsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIScheduledPaymentsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIScheduledPaymentsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIScheduledPaymentsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIScheduledPaymentsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIScheduledPaymentsApi::accountsAccountIdScheduledPaymentsGet(const QString &account_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScheduledPaymentsApi::accountsAccountIdScheduledPaymentsGetCallback);
    connect(this, &OAIScheduledPaymentsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScheduledPaymentsApi::accountsAccountIdScheduledPaymentsGetCallback);
    connect(this, &OAIScheduledPaymentsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIScheduledPaymentsApi::accountsAccountIdScheduledPaymentsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOBReadScheduledPayment3 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdScheduledPaymentsGetSignal(output);
        Q_EMIT accountsAccountIdScheduledPaymentsGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdScheduledPaymentsGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdScheduledPaymentsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdScheduledPaymentsGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdScheduledPaymentsGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScheduledPaymentsApi::tokenAvailable(){
