...
#include "OAIStandingOrdersApi.h"
...
OAIStandingOrdersApi::OAIStandingOrdersApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIStandingOrdersApi::~OAIStandingOrdersApi() {
}

void OAIStandingOrdersApi::initializeServerConfigs() {
    //Default server
    ...
    "Production Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("accountsAccountIdStandingOrdersGet", defaultConf);
    _serverIndices.insert("accountsAccountIdStandingOrdersGet", 0);
}
...
*/
int OAIStandingOrdersApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIStandingOrdersApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIStandingOrdersApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIStandingOrdersApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIStandingOrdersApi::setUsername(const QString &username) {
    _username = username;
}

void OAIStandingOrdersApi::setPassword(const QString &password) {
    _password = password;
}


void OAIStandingOrdersApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIStandingOrdersApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIStandingOrdersApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIStandingOrdersApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIStandingOrdersApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIStandingOrdersApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIStandingOrdersApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIStandingOrdersApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIStandingOrdersApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIStandingOrdersApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIStandingOrdersApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIStandingOrdersApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIStandingOrdersApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIStandingOrdersApi::accountsAccountIdStandingOrdersGet(const QString &account_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["accountsAccountIdStandingOrdersGet"][_serverIndices.value("accountsAccountIdStandingOrdersGet")].URL()+"/accounts/{accountId}/standing-orders");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStandingOrdersApi::accountsAccountIdStandingOrdersGetCallback);
    connect(this, &OAIStandingOrdersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStandingOrdersApi::accountsAccountIdStandingOrdersGetCallback);
    connect(this, &OAIStandingOrdersApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIStandingOrdersApi::accountsAccountIdStandingOrdersGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOBReadStandingOrder6 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdStandingOrdersGetSignal(output);
        Q_EMIT accountsAccountIdStandingOrdersGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdStandingOrdersGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdStandingOrdersGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdStandingOrdersGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdStandingOrdersGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIStandingOrdersApi::tokenAvailable(){
