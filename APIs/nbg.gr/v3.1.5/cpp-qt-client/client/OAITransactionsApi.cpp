...
void OAITransactionsApi::initializeServerConfigs() {
    ...
    "Production Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("accountsAccountIdStatementsStatementIdTransactionsGet", defaultConf);
    _serverIndices.insert("accountsAccountIdStatementsStatementIdTransactionsGet", 0);
...
void OAITransactionsApi::accountsAccountIdStatementsStatementIdTransactionsGet(const QString &account_id, const QString &statement_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["accountsAccountIdStatementsStatementIdTransactionsGet"][_serverIndices.value("accountsAccountIdStatementsStatementIdTransactionsGet")].URL()+"/accounts/{accountId}/statements/{statementId}/transactions");
    ...
    if (x_fapi_auth_date.hasValue())
    {
        if (!::OpenAPI::toStringValue(x_fapi_auth_date.value()).isEmpty()) {
            input.headers.insert("x-fapi-auth-date", ::OpenAPI::toStringValue(x_fapi_auth_date.value()));
        }
        }
    if (x_fapi_customer_ip_address.hasValue())
    {
        if (!::OpenAPI::toStringValue(x_fapi_customer_ip_address.value()).isEmpty()) {
            input.headers.insert("x-fapi-customer-ip-address", ::OpenAPI::toStringValue(x_fapi_customer_ip_address.value()));
        }
        }
    if (x_fapi_interaction_id.hasValue())
    {
        if (!::OpenAPI::toStringValue(x_fapi_interaction_id.value()).isEmpty()) {
            input.headers.insert("x-fapi-interaction-id", ::OpenAPI::toStringValue(x_fapi_interaction_id.value()));
        }
        }
    if (x_customer_user_agent.hasValue())
    {
        if (!::OpenAPI::toStringValue(x_customer_user_agent.value()).isEmpty()) {
            input.headers.insert("x-customer-user-agent", ::OpenAPI::toStringValue(x_customer_user_agent.value()));
        }
        }
    
    {
        if (!::OpenAPI::toStringValue(sandbox_id).isEmpty()) {
            input.headers.insert("sandbox-id", ::OpenAPI::toStringValue(sandbox_id));
        }
        }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITransactionsApi::accountsAccountIdStatementsStatementIdTransactionsGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITransactionsApi::accountsAccountIdStatementsStatementIdTransactionsGetCallback);
...
void OAITransactionsApi::accountsAccountIdStatementsStatementIdTransactionsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOBReadTransaction6 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdStatementsStatementIdTransactionsGetSignal(output);
        Q_EMIT accountsAccountIdStatementsStatementIdTransactionsGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdStatementsStatementIdTransactionsGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdStatementsStatementIdTransactionsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdStatementsStatementIdTransactionsGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdStatementsStatementIdTransactionsGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITransactionsApi::accountsAccountIdTransactionsGet(const QString &account_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QDateTime> &from_booking_date_time, const ::OpenAPI::OptionalParam<QDateTime> &to_booking_date_time, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    ...
    if (from_booking_date_time.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "fromBookingDateTime", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("fromBookingDateTime")).append(querySuffix).append(QUrl::toPercentEncoding(from_booking_date_time.stringValue()));
    }
    if (to_booking_date_time.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "toBookingDateTime", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("toBookingDateTime")).append(querySuffix).append(QUrl::toPercentEncoding(to_booking_date_time.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITransactionsApi::accountsAccountIdTransactionsGetCallback);
    connect(this, &OAITransactionsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
