...
void OAIAccountsApi::initializeServerConfigs() {
    ...
    "Production Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("accountsAccountIdGet", defaultConf);
    _serverIndices.insert("accountsAccountIdGet", 0);
...
void OAIAccountsApi::accountsAccountIdGet(const QString &account_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["accountsAccountIdGet"][_serverIndices.value("accountsAccountIdGet")].URL()+"/accounts/{accountId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::accountsAccountIdGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::accountsAccountIdGetCallback);
...
void OAIAccountsApi::accountsAccountIdGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOBReadAccount5 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdGetSignal(output);
        Q_EMIT accountsAccountIdGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAccountsApi::accountsGet(const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
