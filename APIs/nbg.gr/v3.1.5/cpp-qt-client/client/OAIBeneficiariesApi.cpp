...
OAIBeneficiariesApi::OAIBeneficiariesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIBeneficiariesApi::~OAIBeneficiariesApi() {
}

void OAIBeneficiariesApi::initializeServerConfigs() {
    //Default server
    ...
    "Production Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("accountsAccountIdBeneficiariesGet", defaultConf);
    _serverIndices.insert("accountsAccountIdBeneficiariesGet", 0);
}
...
*/
int OAIBeneficiariesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIBeneficiariesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIBeneficiariesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIBeneficiariesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIBeneficiariesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIBeneficiariesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIBeneficiariesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIBeneficiariesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIBeneficiariesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIBeneficiariesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBeneficiariesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBeneficiariesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIBeneficiariesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIBeneficiariesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIBeneficiariesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIBeneficiariesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIBeneficiariesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIBeneficiariesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIBeneficiariesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIBeneficiariesApi::accountsAccountIdBeneficiariesGet(const QString &account_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["accountsAccountIdBeneficiariesGet"][_serverIndices.value("accountsAccountIdBeneficiariesGet")].URL()+"/accounts/{accountId}/beneficiaries");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBeneficiariesApi::accountsAccountIdBeneficiariesGetCallback);
    connect(this, &OAIBeneficiariesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBeneficiariesApi::accountsAccountIdBeneficiariesGetCallback);
    connect(this, &OAIBeneficiariesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIBeneficiariesApi::accountsAccountIdBeneficiariesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOBReadBeneficiary5 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdBeneficiariesGetSignal(output);
        Q_EMIT accountsAccountIdBeneficiariesGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdBeneficiariesGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdBeneficiariesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdBeneficiariesGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdBeneficiariesGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBeneficiariesApi::tokenAvailable(){
