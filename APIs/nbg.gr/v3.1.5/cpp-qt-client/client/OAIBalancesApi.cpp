...
void OAIBalancesApi::initializeServerConfigs() {
    ...
    "Production Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("accountsAccountIdBalancesGet", defaultConf);
    _serverIndices.insert("accountsAccountIdBalancesGet", 0);
}
...
void OAIBalancesApi::accountsAccountIdBalancesGet(const QString &account_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBalancesApi::accountsAccountIdBalancesGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBalancesApi::accountsAccountIdBalancesGetCallback);
...
void OAIBalancesApi::accountsAccountIdBalancesGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOBReadBalance1 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountsAccountIdBalancesGetSignal(output);
        Q_EMIT accountsAccountIdBalancesGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountsAccountIdBalancesGetSignalE(output, error_type, error_str);
        Q_EMIT accountsAccountIdBalancesGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountsAccountIdBalancesGetSignalError(output, error_type, error_str);
        Q_EMIT accountsAccountIdBalancesGetSignalErrorFull(worker, error_type, error_str);
    }
}
