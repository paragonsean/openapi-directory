...
void OAISandboxApi::initializeServerConfigs() {
    ...
    QUrl("https://apis.nbg.gr/sandbox/uk.openbanking.accountinfo/oauth2/v3.1.5"),
    "Sandbox Server",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://services.nbg.gr/apis/open-banking/v3.1.5/aisp"),
    "Production Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("sandboxPost", defaultConf);
    _serverIndices.insert("sandboxPost", 0);
    _serverConfigs.insert("sandboxPut", defaultConf);
    _serverIndices.insert("sandboxPut", 0);
    _serverConfigs.insert("sandboxSandboxIdDelete", defaultConf);
    _serverIndices.insert("sandboxSandboxIdDelete", 0);
    _serverConfigs.insert("sandboxSandboxIdGet", defaultConf);
    _serverIndices.insert("sandboxSandboxIdGet", 0);
}
...
void OAISandboxApi::sandboxPost(const ::OpenAPI::OptionalParam<OAISandboxRequest> &oai_sandbox_request) {
    QString fullPath = QString(_serverConfigs["sandboxPost"][_serverIndices.value("sandboxPost")].URL()+"/sandbox");
    
    if (_apiKeys.contains("Client-Id")) {
        addHeaders("Client-Id",_apiKeys.find("Client-Id").value());
    }
    ...
    if (oai_sandbox_request.hasValue()){

        
        QByteArray output = oai_sandbox_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISandboxApi::sandboxPostCallback);
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("sandbox-uk-account-info-api-v1 offline_access");
    scope.append("accounts offline_access");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISandboxApi::sandboxPostCallback);
...
void OAISandboxApi::sandboxPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT sandboxPostSignal(output);
        Q_EMIT sandboxPostSignalFull(worker, output);
        ...
        QString authorizationUrl("https://my.nbg.gr/identity/connect/authorize");
        QString tokenUrl("https://my.nbg.gr/identity/connect/token");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT sandboxPostSignalE(output, error_type, error_str);
        Q_EMIT sandboxPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT sandboxPostSignalError(output, error_type, error_str);
        Q_EMIT sandboxPostSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISandboxApi::sandboxPut(const ::OpenAPI::OptionalParam<OAISandbox> &oai_sandbox) {
    QString fullPath = QString(_serverConfigs["sandboxPut"][_serverIndices.value("sandboxPut")].URL()+"/sandbox");
    ...
    if (oai_sandbox.hasValue()){

        
        QByteArray output = oai_sandbox.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISandboxApi::sandboxPutCallback);
    connect(this, &OAISandboxApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISandboxApi::sandboxPutCallback);
    connect(this, &OAISandboxApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISandboxApi::sandboxPutCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT sandboxPutSignal();
        Q_EMIT sandboxPutSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("sandbox-uk-account-info-api-v1 offline_access");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT sandboxPutSignalE(error_type, error_str);
        Q_EMIT sandboxPutSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT sandboxPutSignalError(error_type, error_str);
        Q_EMIT sandboxPutSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISandboxApi::sandboxSandboxIdDelete(const QString &sandbox_id) {
    QString fullPath = QString(_serverConfigs["sandboxSandboxIdDelete"][_serverIndices.value("sandboxSandboxIdDelete")].URL()+"/sandbox/{sandboxId}");
    ...
    {
        QString sandbox_idPathParam("{");
        sandbox_idPathParam.append("sandboxId").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "sandboxId", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"sandboxId"+pathSuffix : pathPrefix;
        fullPath.replace(sandbox_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(sandbox_id)));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISandboxApi::sandboxSandboxIdDeleteCallback);
    connect(this, &OAISandboxApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISandboxApi::sandboxSandboxIdDeleteCallback);
    connect(this, &OAISandboxApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISandboxApi::sandboxSandboxIdDeleteCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT sandboxSandboxIdDeleteSignal();
        Q_EMIT sandboxSandboxIdDeleteSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("sandbox-uk-account-info-api-v1 offline_access");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT sandboxSandboxIdDeleteSignalE(error_type, error_str);
        Q_EMIT sandboxSandboxIdDeleteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT sandboxSandboxIdDeleteSignalError(error_type, error_str);
        Q_EMIT sandboxSandboxIdDeleteSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISandboxApi::sandboxSandboxIdGet(const QString &sandbox_id) {
    QString fullPath = QString(_serverConfigs["sandboxSandboxIdGet"][_serverIndices.value("sandboxSandboxIdGet")].URL()+"/sandbox/{sandboxId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISandboxApi::sandboxSandboxIdGetCallback);
    connect(this, &OAISandboxApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISandboxApi::sandboxSandboxIdGetCallback);
    connect(this, &OAISandboxApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISandboxApi::sandboxSandboxIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT sandboxSandboxIdGetSignal(output);
        Q_EMIT sandboxSandboxIdGetSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("sandbox-uk-account-info-api-v1 offline_access");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT sandboxSandboxIdGetSignalE(output, error_type, error_str);
        Q_EMIT sandboxSandboxIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT sandboxSandboxIdGetSignalError(output, error_type, error_str);
        Q_EMIT sandboxSandboxIdGetSignalErrorFull(worker, error_type, error_str);
    }
}
