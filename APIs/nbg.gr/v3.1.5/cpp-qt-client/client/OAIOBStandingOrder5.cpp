...
OAIOBStandingOrder5::OAIOBStandingOrder5(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOBStandingOrder5::OAIOBStandingOrder5() {
    this->initializeModel();
}

OAIOBStandingOrder5::~OAIOBStandingOrder5() {}

void OAIOBStandingOrder5::initializeModel() {
    ...
    m_final_payment_amount_isSet = false;
    m_final_payment_amount_isValid = false;

    m_final_payment_date_time_isSet = false;
    m_final_payment_date_time_isValid = false;

    m_first_payment_amount_isSet = false;
    m_first_payment_amount_isValid = false;

    m_first_payment_date_time_isSet = false;
    m_first_payment_date_time_isValid = false;
    ...
    m_last_payment_date_time_isSet = false;
    m_last_payment_date_time_isValid = false;

    m_next_payment_amount_isSet = false;
    m_next_payment_amount_isValid = false;

    m_next_payment_date_time_isSet = false;
    m_next_payment_date_time_isValid = false;

    m_reference_isSet = false;
    m_reference_isValid = false;

    m_standing_order_id_isSet = false;
    m_standing_order_id_isValid = false;

    m_standing_order_status_code_isSet = false;
    m_standing_order_status_code_isValid = false;
}

void OAIOBStandingOrder5::fromJson(QString jsonString) {
...
void OAIOBStandingOrder5::fromJsonObject(QJsonObject json) {
    ...
    m_final_payment_amount_isValid = ::OpenAPI::fromJsonValue(m_final_payment_amount, json[QString("FinalPaymentAmount")]);
    m_final_payment_amount_isSet = !json[QString("FinalPaymentAmount")].isNull() && m_final_payment_amount_isValid;

    m_final_payment_date_time_isValid = ::OpenAPI::fromJsonValue(m_final_payment_date_time, json[QString("FinalPaymentDateTime")]);
    m_final_payment_date_time_isSet = !json[QString("FinalPaymentDateTime")].isNull() && m_final_payment_date_time_isValid;

    m_first_payment_amount_isValid = ::OpenAPI::fromJsonValue(m_first_payment_amount, json[QString("FirstPaymentAmount")]);
    m_first_payment_amount_isSet = !json[QString("FirstPaymentAmount")].isNull() && m_first_payment_amount_isValid;

    m_first_payment_date_time_isValid = ::OpenAPI::fromJsonValue(m_first_payment_date_time, json[QString("FirstPaymentDateTime")]);
    m_first_payment_date_time_isSet = !json[QString("FirstPaymentDateTime")].isNull() && m_first_payment_date_time_isValid;
    ...
    m_last_payment_date_time_isValid = ::OpenAPI::fromJsonValue(m_last_payment_date_time, json[QString("LastPaymentDateTime")]);
    m_last_payment_date_time_isSet = !json[QString("LastPaymentDateTime")].isNull() && m_last_payment_date_time_isValid;

    m_next_payment_amount_isValid = ::OpenAPI::fromJsonValue(m_next_payment_amount, json[QString("NextPaymentAmount")]);
    m_next_payment_amount_isSet = !json[QString("NextPaymentAmount")].isNull() && m_next_payment_amount_isValid;

    m_next_payment_date_time_isValid = ::OpenAPI::fromJsonValue(m_next_payment_date_time, json[QString("NextPaymentDateTime")]);
    m_next_payment_date_time_isSet = !json[QString("NextPaymentDateTime")].isNull() && m_next_payment_date_time_isValid;

    m_reference_isValid = ::OpenAPI::fromJsonValue(m_reference, json[QString("Reference")]);
    m_reference_isSet = !json[QString("Reference")].isNull() && m_reference_isValid;

    m_standing_order_id_isValid = ::OpenAPI::fromJsonValue(m_standing_order_id, json[QString("StandingOrderId")]);
    m_standing_order_id_isSet = !json[QString("StandingOrderId")].isNull() && m_standing_order_id_isValid;

    m_standing_order_status_code_isValid = ::OpenAPI::fromJsonValue(m_standing_order_status_code, json[QString("StandingOrderStatusCode")]);
    m_standing_order_status_code_isSet = !json[QString("StandingOrderStatusCode")].isNull() && m_standing_order_status_code_isValid;
}

QString OAIOBStandingOrder5::asJson() const {
...
QJsonObject OAIOBStandingOrder5::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_final_payment_amount.isSet()) {
        obj.insert(QString("FinalPaymentAmount"), ::OpenAPI::toJsonValue(m_final_payment_amount));
    }
    if (m_final_payment_date_time_isSet) {
        obj.insert(QString("FinalPaymentDateTime"), ::OpenAPI::toJsonValue(m_final_payment_date_time));
    }
    if (m_first_payment_amount.isSet()) {
        obj.insert(QString("FirstPaymentAmount"), ::OpenAPI::toJsonValue(m_first_payment_amount));
    }
    if (m_first_payment_date_time_isSet) {
        obj.insert(QString("FirstPaymentDateTime"), ::OpenAPI::toJsonValue(m_first_payment_date_time));
    }
    ...
    if (m_last_payment_date_time_isSet) {
        obj.insert(QString("LastPaymentDateTime"), ::OpenAPI::toJsonValue(m_last_payment_date_time));
    }
    if (m_next_payment_amount.isSet()) {
        obj.insert(QString("NextPaymentAmount"), ::OpenAPI::toJsonValue(m_next_payment_amount));
    }
    if (m_next_payment_date_time_isSet) {
        obj.insert(QString("NextPaymentDateTime"), ::OpenAPI::toJsonValue(m_next_payment_date_time));
    }
    if (m_reference_isSet) {
        obj.insert(QString("Reference"), ::OpenAPI::toJsonValue(m_reference));
    }
    if (m_standing_order_id_isSet) {
        obj.insert(QString("StandingOrderId"), ::OpenAPI::toJsonValue(m_standing_order_id));
    }
    if (m_standing_order_status_code.isSet()) {
        obj.insert(QString("StandingOrderStatusCode"), ::OpenAPI::toJsonValue(m_standing_order_status_code));
    }
    return obj;
}

QString OAIOBStandingOrder5::getAccountId() const {
    return m_account_id;
}
void OAIOBStandingOrder5::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIOBStandingOrder5::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIOBStandingOrder5::is_account_id_Valid() const{
    return m_account_id_isValid;
}

OAIOBCashAccount5 OAIOBStandingOrder5::getCreditorAccount() const {
    return m_creditor_account;
}
void OAIOBStandingOrder5::setCreditorAccount(const OAIOBCashAccount5 &creditor_account) {
    m_creditor_account = creditor_account;
    m_creditor_account_isSet = true;
}

bool OAIOBStandingOrder5::is_creditor_account_Set() const{
    return m_creditor_account_isSet;
}

bool OAIOBStandingOrder5::is_creditor_account_Valid() const{
    return m_creditor_account_isValid;
}

OAIOBActiveOrHistoricCurrencyAndAmount OAIOBStandingOrder5::getFinalPaymentAmount() const {
    return m_final_payment_amount;
}
void OAIOBStandingOrder5::setFinalPaymentAmount(const OAIOBActiveOrHistoricCurrencyAndAmount &final_payment_amount) {
    m_final_payment_amount = final_payment_amount;
    m_final_payment_amount_isSet = true;
}

bool OAIOBStandingOrder5::is_final_payment_amount_Set() const{
    return m_final_payment_amount_isSet;
}

bool OAIOBStandingOrder5::is_final_payment_amount_Valid() const{
    return m_final_payment_amount_isValid;
}

QDateTime OAIOBStandingOrder5::getFinalPaymentDateTime() const {
    return m_final_payment_date_time;
}
void OAIOBStandingOrder5::setFinalPaymentDateTime(const QDateTime &final_payment_date_time) {
    m_final_payment_date_time = final_payment_date_time;
    m_final_payment_date_time_isSet = true;
}

bool OAIOBStandingOrder5::is_final_payment_date_time_Set() const{
    return m_final_payment_date_time_isSet;
}

bool OAIOBStandingOrder5::is_final_payment_date_time_Valid() const{
    return m_final_payment_date_time_isValid;
}

OAIOBActiveOrHistoricCurrencyAndAmount OAIOBStandingOrder5::getFirstPaymentAmount() const {
    return m_first_payment_amount;
}
void OAIOBStandingOrder5::setFirstPaymentAmount(const OAIOBActiveOrHistoricCurrencyAndAmount &first_payment_amount) {
    m_first_payment_amount = first_payment_amount;
    m_first_payment_amount_isSet = true;
}

bool OAIOBStandingOrder5::is_first_payment_amount_Set() const{
    return m_first_payment_amount_isSet;
}

bool OAIOBStandingOrder5::is_first_payment_amount_Valid() const{
    return m_first_payment_amount_isValid;
}

QDateTime OAIOBStandingOrder5::getFirstPaymentDateTime() const {
    return m_first_payment_date_time;
}
void OAIOBStandingOrder5::setFirstPaymentDateTime(const QDateTime &first_payment_date_time) {
    m_first_payment_date_time = first_payment_date_time;
    m_first_payment_date_time_isSet = true;
}

bool OAIOBStandingOrder5::is_first_payment_date_time_Set() const{
    return m_first_payment_date_time_isSet;
}

bool OAIOBStandingOrder5::is_first_payment_date_time_Valid() const{
    return m_first_payment_date_time_isValid;
}

QString OAIOBStandingOrder5::getFrequency() const {
    return m_frequency;
}
void OAIOBStandingOrder5::setFrequency(const QString &frequency) {
    m_frequency = frequency;
    m_frequency_isSet = true;
}

bool OAIOBStandingOrder5::is_frequency_Set() const{
    return m_frequency_isSet;
}

bool OAIOBStandingOrder5::is_frequency_Valid() const{
    return m_frequency_isValid;
}

OAIOBActiveOrHistoricCurrencyAndAmount OAIOBStandingOrder5::getLastPaymentAmount() const {
    return m_last_payment_amount;
}
void OAIOBStandingOrder5::setLastPaymentAmount(const OAIOBActiveOrHistoricCurrencyAndAmount &last_payment_amount) {
    m_last_payment_amount = last_payment_amount;
    m_last_payment_amount_isSet = true;
}

bool OAIOBStandingOrder5::is_last_payment_amount_Set() const{
    return m_last_payment_amount_isSet;
}

bool OAIOBStandingOrder5::is_last_payment_amount_Valid() const{
    return m_last_payment_amount_isValid;
}

QDateTime OAIOBStandingOrder5::getLastPaymentDateTime() const {
    return m_last_payment_date_time;
}
void OAIOBStandingOrder5::setLastPaymentDateTime(const QDateTime &last_payment_date_time) {
    m_last_payment_date_time = last_payment_date_time;
    m_last_payment_date_time_isSet = true;
}

bool OAIOBStandingOrder5::is_last_payment_date_time_Set() const{
    return m_last_payment_date_time_isSet;
}

bool OAIOBStandingOrder5::is_last_payment_date_time_Valid() const{
    return m_last_payment_date_time_isValid;
}

OAIOBActiveOrHistoricCurrencyAndAmount OAIOBStandingOrder5::getNextPaymentAmount() const {
    return m_next_payment_amount;
}
void OAIOBStandingOrder5::setNextPaymentAmount(const OAIOBActiveOrHistoricCurrencyAndAmount &next_payment_amount) {
    m_next_payment_amount = next_payment_amount;
    m_next_payment_amount_isSet = true;
}

bool OAIOBStandingOrder5::is_next_payment_amount_Set() const{
    return m_next_payment_amount_isSet;
}

bool OAIOBStandingOrder5::is_next_payment_amount_Valid() const{
    return m_next_payment_amount_isValid;
}

QDateTime OAIOBStandingOrder5::getNextPaymentDateTime() const {
    return m_next_payment_date_time;
}
void OAIOBStandingOrder5::setNextPaymentDateTime(const QDateTime &next_payment_date_time) {
    m_next_payment_date_time = next_payment_date_time;
    m_next_payment_date_time_isSet = true;
}

bool OAIOBStandingOrder5::is_next_payment_date_time_Set() const{
    return m_next_payment_date_time_isSet;
}

bool OAIOBStandingOrder5::is_next_payment_date_time_Valid() const{
    return m_next_payment_date_time_isValid;
}

QString OAIOBStandingOrder5::getReference() const {
    return m_reference;
}
void OAIOBStandingOrder5::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAIOBStandingOrder5::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAIOBStandingOrder5::is_reference_Valid() const{
    return m_reference_isValid;
}

QString OAIOBStandingOrder5::getStandingOrderId() const {
    return m_standing_order_id;
}
void OAIOBStandingOrder5::setStandingOrderId(const QString &standing_order_id) {
    m_standing_order_id = standing_order_id;
    m_standing_order_id_isSet = true;
}

bool OAIOBStandingOrder5::is_standing_order_id_Set() const{
    return m_standing_order_id_isSet;
}

bool OAIOBStandingOrder5::is_standing_order_id_Valid() const{
    return m_standing_order_id_isValid;
}

OAIOBExternalStandingOrderStatus1Code OAIOBStandingOrder5::getStandingOrderStatusCode() const {
    return m_standing_order_status_code;
}
void OAIOBStandingOrder5::setStandingOrderStatusCode(const OAIOBExternalStandingOrderStatus1Code &standing_order_status_code) {
    m_standing_order_status_code = standing_order_status_code;
    m_standing_order_status_code_isSet = true;
}

bool OAIOBStandingOrder5::is_standing_order_status_code_Set() const{
    return m_standing_order_status_code_isSet;
}

bool OAIOBStandingOrder5::is_standing_order_status_code_Valid() const{
    return m_standing_order_status_code_isValid;
}

bool OAIOBStandingOrder5::isSet() const {
...
bool OAIOBStandingOrder5::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_account_id_isValid && m_frequency_isValid && true;
}
