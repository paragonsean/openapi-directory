...
OAIAccountAccessApi::OAIAccountAccessApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIAccountAccessApi::~OAIAccountAccessApi() {
}

void OAIAccountAccessApi::initializeServerConfigs() {
    //Default server
    ...
    "Production Server",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("accountAccessConsentsConsentIdDelete", defaultConf);
    _serverIndices.insert("accountAccessConsentsConsentIdDelete", 0);
    _serverConfigs.insert("accountAccessConsentsConsentIdGet", defaultConf);
    _serverIndices.insert("accountAccessConsentsConsentIdGet", 0);
    _serverConfigs.insert("accountAccessConsentsPost", defaultConf);
    _serverIndices.insert("accountAccessConsentsPost", 0);
}
...
*/
int OAIAccountAccessApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIAccountAccessApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIAccountAccessApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIAccountAccessApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIAccountAccessApi::setUsername(const QString &username) {
    _username = username;
}

void OAIAccountAccessApi::setPassword(const QString &password) {
    _password = password;
}


void OAIAccountAccessApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIAccountAccessApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIAccountAccessApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIAccountAccessApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAccountAccessApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAccountAccessApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIAccountAccessApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIAccountAccessApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIAccountAccessApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIAccountAccessApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIAccountAccessApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIAccountAccessApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIAccountAccessApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIAccountAccessApi::accountAccessConsentsConsentIdDelete(const QString &consent_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["accountAccessConsentsConsentIdDelete"][_serverIndices.value("accountAccessConsentsConsentIdDelete")].URL()+"/account-access-consents/{consentId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountAccessApi::accountAccessConsentsConsentIdDeleteCallback);
    connect(this, &OAIAccountAccessApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    QStringList scope;
    scope.append("sandbox-uk-account-info-api-v1");
    scope.append("accounts");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountAccessApi::accountAccessConsentsConsentIdDeleteCallback);
    connect(this, &OAIAccountAccessApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIAccountAccessApi::accountAccessConsentsConsentIdDeleteCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountAccessConsentsConsentIdDeleteSignal();
        Q_EMIT accountAccessConsentsConsentIdDeleteSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountAccessConsentsConsentIdDeleteSignalE(error_type, error_str);
        Q_EMIT accountAccessConsentsConsentIdDeleteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountAccessConsentsConsentIdDeleteSignalError(error_type, error_str);
        Q_EMIT accountAccessConsentsConsentIdDeleteSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAccountAccessApi::accountAccessConsentsConsentIdGet(const QString &consent_id, const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent) {
    QString fullPath = QString(_serverConfigs["accountAccessConsentsConsentIdGet"][_serverIndices.value("accountAccessConsentsConsentIdGet")].URL()+"/account-access-consents/{consentId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountAccessApi::accountAccessConsentsConsentIdGetCallback);
    connect(this, &OAIAccountAccessApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountAccessApi::accountAccessConsentsConsentIdGetCallback);
    connect(this, &OAIAccountAccessApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAccountAccessApi::accountAccessConsentsConsentIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIOBReadConsentResponse1 output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountAccessConsentsConsentIdGetSignal(output);
        Q_EMIT accountAccessConsentsConsentIdGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountAccessConsentsConsentIdGetSignalE(output, error_type, error_str);
        Q_EMIT accountAccessConsentsConsentIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountAccessConsentsConsentIdGetSignalError(output, error_type, error_str);
        Q_EMIT accountAccessConsentsConsentIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAccountAccessApi::accountAccessConsentsPost(const QString &sandbox_id, const ::OpenAPI::OptionalParam<QString> &x_fapi_auth_date, const ::OpenAPI::OptionalParam<QString> &x_fapi_customer_ip_address, const ::OpenAPI::OptionalParam<QString> &x_fapi_interaction_id, const ::OpenAPI::OptionalParam<QString> &x_customer_user_agent, const ::OpenAPI::OptionalParam<OAIOBReadConsent1> &oaiob_read_consent1) {
    QString fullPath = QString(_serverConfigs["accountAccessConsentsPost"][_serverIndices.value("accountAccessConsentsPost")].URL()+"/account-access-consents");
    ...
    if (oaiob_read_consent1.hasValue()){

        
        QByteArray output = oaiob_read_consent1.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountAccessApi::accountAccessConsentsPostCallback);
    connect(this, &OAIAccountAccessApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountAccessApi::accountAccessConsentsPostCallback);
    connect(this, &OAIAccountAccessApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAccountAccessApi::accountAccessConsentsPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountAccessConsentsPostSignal(output);
        Q_EMIT accountAccessConsentsPostSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountAccessConsentsPostSignalE(output, error_type, error_str);
        Q_EMIT accountAccessConsentsPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountAccessConsentsPostSignalError(output, error_type, error_str);
        Q_EMIT accountAccessConsentsPostSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAccountAccessApi::tokenAvailable(){
