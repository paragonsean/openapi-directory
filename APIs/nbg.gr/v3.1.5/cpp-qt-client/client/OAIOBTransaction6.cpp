...
OAIOBTransaction6::OAIOBTransaction6(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOBTransaction6::OAIOBTransaction6() {
    this->initializeModel();
}

OAIOBTransaction6::~OAIOBTransaction6() {}

void OAIOBTransaction6::initializeModel() {
    ...
    m_booking_date_time_isSet = false;
    m_booking_date_time_isValid = false;
    ...
    m_transaction_information_isSet = false;
    m_transaction_information_isValid = false;

    m_transaction_reference_isSet = false;
    m_transaction_reference_isValid = false;

    m_value_date_time_isSet = false;
    m_value_date_time_isValid = false;
}

void OAIOBTransaction6::fromJson(QString jsonString) {
...
void OAIOBTransaction6::fromJsonObject(QJsonObject json) {
    ...
    m_booking_date_time_isValid = ::OpenAPI::fromJsonValue(m_booking_date_time, json[QString("BookingDateTime")]);
    m_booking_date_time_isSet = !json[QString("BookingDateTime")].isNull() && m_booking_date_time_isValid;
    ...
    m_transaction_information_isValid = ::OpenAPI::fromJsonValue(m_transaction_information, json[QString("TransactionInformation")]);
    m_transaction_information_isSet = !json[QString("TransactionInformation")].isNull() && m_transaction_information_isValid;
    ...
    m_value_date_time_isValid = ::OpenAPI::fromJsonValue(m_value_date_time, json[QString("ValueDateTime")]);
    m_value_date_time_isSet = !json[QString("ValueDateTime")].isNull() && m_value_date_time_isValid;
}

QString OAIOBTransaction6::asJson() const {
...
QJsonObject OAIOBTransaction6::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_booking_date_time_isSet) {
        obj.insert(QString("BookingDateTime"), ::OpenAPI::toJsonValue(m_booking_date_time));
    }
    ...
    if (m_proprietary_bank_transaction_code.isSet()) {
        obj.insert(QString("ProprietaryBankTransactionCode"), ::OpenAPI::toJsonValue(m_proprietary_bank_transaction_code));
    }
    if (m_status.isSet()) {
        obj.insert(QString("Status"), ::OpenAPI::toJsonValue(m_status));
    }
    if (m_transaction_information_isSet) {
        obj.insert(QString("TransactionInformation"), ::OpenAPI::toJsonValue(m_transaction_information));
    }
    if (m_transaction_reference_isSet) {
        obj.insert(QString("TransactionReference"), ::OpenAPI::toJsonValue(m_transaction_reference));
    }
    if (m_value_date_time_isSet) {
        obj.insert(QString("ValueDateTime"), ::OpenAPI::toJsonValue(m_value_date_time));
    }
    return obj;
}

QString OAIOBTransaction6::getAccountId() const {
    return m_account_id;
}
void OAIOBTransaction6::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIOBTransaction6::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIOBTransaction6::is_account_id_Valid() const{
    return m_account_id_isValid;
}

OAIOBActiveOrHistoricCurrencyAndAmount OAIOBTransaction6::getAmount() const {
    return m_amount;
}
void OAIOBTransaction6::setAmount(const OAIOBActiveOrHistoricCurrencyAndAmount &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIOBTransaction6::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIOBTransaction6::is_amount_Valid() const{
    return m_amount_isValid;
}

OAIOBTransactionCashBalance OAIOBTransaction6::getBalance() const {
    return m_balance;
}
void OAIOBTransaction6::setBalance(const OAIOBTransactionCashBalance &balance) {
    m_balance = balance;
    m_balance_isSet = true;
}

bool OAIOBTransaction6::is_balance_Set() const{
    return m_balance_isSet;
}

bool OAIOBTransaction6::is_balance_Valid() const{
    return m_balance_isValid;
}

QDateTime OAIOBTransaction6::getBookingDateTime() const {
    return m_booking_date_time;
}
void OAIOBTransaction6::setBookingDateTime(const QDateTime &booking_date_time) {
    m_booking_date_time = booking_date_time;
    m_booking_date_time_isSet = true;
}

bool OAIOBTransaction6::is_booking_date_time_Set() const{
    return m_booking_date_time_isSet;
}

bool OAIOBTransaction6::is_booking_date_time_Valid() const{
    return m_booking_date_time_isValid;
}

OAIOBCreditDebitCode OAIOBTransaction6::getCreditDebitIndicator() const {
    return m_credit_debit_indicator;
}
void OAIOBTransaction6::setCreditDebitIndicator(const OAIOBCreditDebitCode &credit_debit_indicator) {
    m_credit_debit_indicator = credit_debit_indicator;
    m_credit_debit_indicator_isSet = true;
}

bool OAIOBTransaction6::is_credit_debit_indicator_Set() const{
    return m_credit_debit_indicator_isSet;
}

bool OAIOBTransaction6::is_credit_debit_indicator_Valid() const{
    return m_credit_debit_indicator_isValid;
}

OAIOBCashAccount6 OAIOBTransaction6::getCreditorAccount() const {
    return m_creditor_account;
}
void OAIOBTransaction6::setCreditorAccount(const OAIOBCashAccount6 &creditor_account) {
    m_creditor_account = creditor_account;
    m_creditor_account_isSet = true;
}

bool OAIOBTransaction6::is_creditor_account_Set() const{
    return m_creditor_account_isSet;
}

bool OAIOBTransaction6::is_creditor_account_Valid() const{
    return m_creditor_account_isValid;
}

OAIOBCashAccount6 OAIOBTransaction6::getDebtorAccount() const {
    return m_debtor_account;
}
void OAIOBTransaction6::setDebtorAccount(const OAIOBCashAccount6 &debtor_account) {
    m_debtor_account = debtor_account;
    m_debtor_account_isSet = true;
}

bool OAIOBTransaction6::is_debtor_account_Set() const{
    return m_debtor_account_isSet;
}

bool OAIOBTransaction6::is_debtor_account_Valid() const{
    return m_debtor_account_isValid;
}

OAIProprietaryBankTransactionCodeStructure1 OAIOBTransaction6::getProprietaryBankTransactionCode() const {
    return m_proprietary_bank_transaction_code;
}
void OAIOBTransaction6::setProprietaryBankTransactionCode(const OAIProprietaryBankTransactionCodeStructure1 &proprietary_bank_transaction_code) {
    m_proprietary_bank_transaction_code = proprietary_bank_transaction_code;
    m_proprietary_bank_transaction_code_isSet = true;
}

bool OAIOBTransaction6::is_proprietary_bank_transaction_code_Set() const{
    return m_proprietary_bank_transaction_code_isSet;
}

bool OAIOBTransaction6::is_proprietary_bank_transaction_code_Valid() const{
    return m_proprietary_bank_transaction_code_isValid;
}

OAIOBEntryStatus1Code OAIOBTransaction6::getStatus() const {
    return m_status;
}
void OAIOBTransaction6::setStatus(const OAIOBEntryStatus1Code &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIOBTransaction6::is_status_Set() const{
    return m_status_isSet;
}

bool OAIOBTransaction6::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIOBTransaction6::getTransactionInformation() const {
    return m_transaction_information;
}
void OAIOBTransaction6::setTransactionInformation(const QString &transaction_information) {
    m_transaction_information = transaction_information;
    m_transaction_information_isSet = true;
}

bool OAIOBTransaction6::is_transaction_information_Set() const{
    return m_transaction_information_isSet;
}

bool OAIOBTransaction6::is_transaction_information_Valid() const{
    return m_transaction_information_isValid;
}

QString OAIOBTransaction6::getTransactionReference() const {
    return m_transaction_reference;
}
void OAIOBTransaction6::setTransactionReference(const QString &transaction_reference) {
    m_transaction_reference = transaction_reference;
    m_transaction_reference_isSet = true;
}

bool OAIOBTransaction6::is_transaction_reference_Set() const{
    return m_transaction_reference_isSet;
}

bool OAIOBTransaction6::is_transaction_reference_Valid() const{
    return m_transaction_reference_isValid;
}

QDateTime OAIOBTransaction6::getValueDateTime() const {
    return m_value_date_time;
}
void OAIOBTransaction6::setValueDateTime(const QDateTime &value_date_time) {
    m_value_date_time = value_date_time;
    m_value_date_time_isSet = true;
}

bool OAIOBTransaction6::is_value_date_time_Set() const{
    return m_value_date_time_isSet;
}

bool OAIOBTransaction6::is_value_date_time_Valid() const{
    return m_value_date_time_isValid;
}

bool OAIOBTransaction6::isSet() const {
...
bool OAIOBTransaction6::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_account_id_isValid && m_amount_isValid && m_booking_date_time_isValid && m_credit_debit_indicator_isValid && m_status_isValid && true;
}
