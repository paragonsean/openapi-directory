# account_and_transaction_api_specification_uk

AccountAndTransactionApiSpecificationUk - JavaScript client for account_and_transaction_api_specification_uk
...
```shell
npm install account_and_transaction_api_specification_uk --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your account_and_transaction_api_specification_uk from, and run:
...
```javascript
var AccountAndTransactionApiSpecificationUk = require('account_and_transaction_api_specification_uk');

var defaultClient = AccountAndTransactionApiSpecificationUk.ApiClient.instance;
// Configure OAuth2 access token for authorization: Client-Credentials-Token
var Client-Credentials-Token = defaultClient.authentications['Client-Credentials-Token'];
Client-Credentials-Token.accessToken = "YOUR ACCESS TOKEN"
// Configure API key authorization: Client-Id
var Client-Id = defaultClient.authentications['Client-Id'];
Client-Id.apiKey = "YOUR API KEY"
// Uncomment the following line to set a prefix for the API key, e.g. "Token" (defaults to null)
//Client-Id.apiKeyPrefix['Client-Id'] = "Token"

var api = new AccountAndTransactionApiSpecificationUk.AccountAccessApi()
var consentId = "consentId_example"; // {String} ConsentId
var sandboxId = "sandboxId_example"; // {String} The unique id of the sandbox to be used
var opts = {
...
api.accountAccessConsentsConsentIdDelete(consentId, sandboxId, opts, callback);
...
------------ | ------------- | ------------- | -------------
*AccountAndTransactionApiSpecificationUk.AccountAccessApi* | [**accountAccessConsentsConsentIdDelete**](docs/AccountAccessApi.md#accountAccessConsentsConsentIdDelete) | **DELETE** /account-access-consents/{consentId} | Delete Account Access Consents
*AccountAndTransactionApiSpecificationUk.AccountAccessApi* | [**accountAccessConsentsConsentIdGet**](docs/AccountAccessApi.md#accountAccessConsentsConsentIdGet) | **GET** /account-access-consents/{consentId} | Get Account Access Consents
*AccountAndTransactionApiSpecificationUk.AccountAccessApi* | [**accountAccessConsentsPost**](docs/AccountAccessApi.md#accountAccessConsentsPost) | **POST** /account-access-consents | Create Account Access Consents
*AccountAndTransactionApiSpecificationUk.AccountsApi* | [**accountsAccountIdGet**](docs/AccountsApi.md#accountsAccountIdGet) | **GET** /accounts/{accountId} | Get Accounts
*AccountAndTransactionApiSpecificationUk.AccountsApi* | [**accountsGet**](docs/AccountsApi.md#accountsGet) | **GET** /accounts | Get Accounts
*AccountAndTransactionApiSpecificationUk.BalancesApi* | [**accountsAccountIdBalancesGet**](docs/BalancesApi.md#accountsAccountIdBalancesGet) | **GET** /accounts/{accountId}/balances | Get Balances
*AccountAndTransactionApiSpecificationUk.BeneficiariesApi* | [**accountsAccountIdBeneficiariesGet**](docs/BeneficiariesApi.md#accountsAccountIdBeneficiariesGet) | **GET** /accounts/{accountId}/beneficiaries | Get Beneficiaries
*AccountAndTransactionApiSpecificationUk.PartiesApi* | [**accountsAccountIdPartiesGet**](docs/PartiesApi.md#accountsAccountIdPartiesGet) | **GET** /accounts/{accountId}/parties | Get Parties
*AccountAndTransactionApiSpecificationUk.PartiesApi* | [**accountsAccountIdPartyGet**](docs/PartiesApi.md#accountsAccountIdPartyGet) | **GET** /accounts/{accountId}/party | Get Party
*AccountAndTransactionApiSpecificationUk.PartiesApi* | [**partyGet**](docs/PartiesApi.md#partyGet) | **GET** /party | Get Party
*AccountAndTransactionApiSpecificationUk.SandboxApi* | [**sandboxPost**](docs/SandboxApi.md#sandboxPost) | **POST** /sandbox | Create Sandbox
*AccountAndTransactionApiSpecificationUk.SandboxApi* | [**sandboxPut**](docs/SandboxApi.md#sandboxPut) | **PUT** /sandbox | Import Sandbox
*AccountAndTransactionApiSpecificationUk.SandboxApi* | [**sandboxSandboxIdDelete**](docs/SandboxApi.md#sandboxSandboxIdDelete) | **DELETE** /sandbox/{sandboxId} | Delete Sandbox
*AccountAndTransactionApiSpecificationUk.SandboxApi* | [**sandboxSandboxIdGet**](docs/SandboxApi.md#sandboxSandboxIdGet) | **GET** /sandbox/{sandboxId} | Export Sandbox
*AccountAndTransactionApiSpecificationUk.ScheduledPaymentsApi* | [**accountsAccountIdScheduledPaymentsGet**](docs/ScheduledPaymentsApi.md#accountsAccountIdScheduledPaymentsGet) | **GET** /accounts/{accountId}/scheduled-payments | Get Scheduled Payments
*AccountAndTransactionApiSpecificationUk.StandingOrdersApi* | [**accountsAccountIdStandingOrdersGet**](docs/StandingOrdersApi.md#accountsAccountIdStandingOrdersGet) | **GET** /accounts/{accountId}/standing-orders | Get Standing Orders
*AccountAndTransactionApiSpecificationUk.StatementsApi* | [**accountsAccountIdStatementsGet**](docs/StatementsApi.md#accountsAccountIdStatementsGet) | **GET** /accounts/{accountId}/statements | Get Statements
*AccountAndTransactionApiSpecificationUk.StatementsApi* | [**accountsAccountIdStatementsStatementIdFileGet**](docs/StatementsApi.md#accountsAccountIdStatementsStatementIdFileGet) | **GET** /accounts/{accountId}/statements/{statementId}/file | Get Statements
*AccountAndTransactionApiSpecificationUk.StatementsApi* | [**accountsAccountIdStatementsStatementIdGet**](docs/StatementsApi.md#accountsAccountIdStatementsStatementIdGet) | **GET** /accounts/{accountId}/statements/{statementId} | Get Statements
*AccountAndTransactionApiSpecificationUk.TransactionsApi* | [**accountsAccountIdStatementsStatementIdTransactionsGet**](docs/TransactionsApi.md#accountsAccountIdStatementsStatementIdTransactionsGet) | **GET** /accounts/{accountId}/statements/{statementId}/transactions | Get Transactions
*AccountAndTransactionApiSpecificationUk.TransactionsApi* | [**accountsAccountIdTransactionsGet**](docs/TransactionsApi.md#accountsAccountIdTransactionsGet) | **GET** /accounts/{accountId}/transactions | Get Transactions


## Documentation for Models

 - [AccountAndTransactionApiSpecificationUk.ErrorCode](docs/ErrorCode.md)
 - [AccountAndTransactionApiSpecificationUk.ErrorResponse](docs/ErrorResponse.md)
 - [AccountAndTransactionApiSpecificationUk.Links](docs/Links.md)
 - [AccountAndTransactionApiSpecificationUk.Meta](docs/Meta.md)
 - [AccountAndTransactionApiSpecificationUk.OBAccount6](docs/OBAccount6.md)
 - [AccountAndTransactionApiSpecificationUk.OBActiveOrHistoricCurrencyAndAmount](docs/OBActiveOrHistoricCurrencyAndAmount.md)
 - [AccountAndTransactionApiSpecificationUk.OBBalanceType1Code](docs/OBBalanceType1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBBeneficiary5](docs/OBBeneficiary5.md)
 - [AccountAndTransactionApiSpecificationUk.OBBeneficiaryType1Code](docs/OBBeneficiaryType1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBBranchAndFinancialInstitutionIdentification5](docs/OBBranchAndFinancialInstitutionIdentification5.md)
 - [AccountAndTransactionApiSpecificationUk.OBCashAccount5](docs/OBCashAccount5.md)
 - [AccountAndTransactionApiSpecificationUk.OBCashAccount6](docs/OBCashAccount6.md)
 - [AccountAndTransactionApiSpecificationUk.OBCashBalance1](docs/OBCashBalance1.md)
 - [AccountAndTransactionApiSpecificationUk.OBCreditDebitCode](docs/OBCreditDebitCode.md)
 - [AccountAndTransactionApiSpecificationUk.OBCreditLine1](docs/OBCreditLine1.md)
 - [AccountAndTransactionApiSpecificationUk.OBEntryStatus1Code](docs/OBEntryStatus1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBError1](docs/OBError1.md)
 - [AccountAndTransactionApiSpecificationUk.OBErrorResponse1](docs/OBErrorResponse1.md)
 - [AccountAndTransactionApiSpecificationUk.OBExternalAccountSubType1Code](docs/OBExternalAccountSubType1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBExternalAccountType1Code](docs/OBExternalAccountType1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBExternalLimitType1Code](docs/OBExternalLimitType1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBExternalPermissions1Code](docs/OBExternalPermissions1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBExternalRequestStatus1Code](docs/OBExternalRequestStatus1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBExternalScheduleType1Code](docs/OBExternalScheduleType1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBExternalStandingOrderStatus1Code](docs/OBExternalStandingOrderStatus1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBExternalStatementType1Code](docs/OBExternalStatementType1Code.md)
 - [AccountAndTransactionApiSpecificationUk.OBParty2](docs/OBParty2.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadAccount5](docs/OBReadAccount5.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadBalance1](docs/OBReadBalance1.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadBeneficiary5](docs/OBReadBeneficiary5.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadConsent1](docs/OBReadConsent1.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadConsentResponse1](docs/OBReadConsentResponse1.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadData1](docs/OBReadData1.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadDataAccount5](docs/OBReadDataAccount5.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadDataBalance1](docs/OBReadDataBalance1.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadDataBeneficiary5](docs/OBReadDataBeneficiary5.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadDataConsentResponse1](docs/OBReadDataConsentResponse1.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadDataParty2](docs/OBReadDataParty2.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadDataParty3](docs/OBReadDataParty3.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadDataScheduledPayment3](docs/OBReadDataScheduledPayment3.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadDataStandingOrder5](docs/OBReadDataStandingOrder5.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadDataStatement2](docs/OBReadDataStatement2.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadDataTransaction6](docs/OBReadDataTransaction6.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadParty2](docs/OBReadParty2.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadParty3](docs/OBReadParty3.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadScheduledPayment3](docs/OBReadScheduledPayment3.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadStandingOrder6](docs/OBReadStandingOrder6.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadStatement2](docs/OBReadStatement2.md)
 - [AccountAndTransactionApiSpecificationUk.OBReadTransaction6](docs/OBReadTransaction6.md)
 - [AccountAndTransactionApiSpecificationUk.OBScheduledPayment3](docs/OBScheduledPayment3.md)
 - [AccountAndTransactionApiSpecificationUk.OBStandingOrder5](docs/OBStandingOrder5.md)
 - [AccountAndTransactionApiSpecificationUk.OBStatement2](docs/OBStatement2.md)
 - [AccountAndTransactionApiSpecificationUk.OBTransaction6](docs/OBTransaction6.md)
 - [AccountAndTransactionApiSpecificationUk.OBTransactionCashBalance](docs/OBTransactionCashBalance.md)
 - [AccountAndTransactionApiSpecificationUk.ProprietaryBankTransactionCodeStructure1](docs/ProprietaryBankTransactionCodeStructure1.md)
 - [AccountAndTransactionApiSpecificationUk.Sandbox](docs/Sandbox.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxBankAccount](docs/SandboxBankAccount.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxBankAccountInfo](docs/SandboxBankAccountInfo.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxBeneficiary](docs/SandboxBeneficiary.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxCard](docs/SandboxCard.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxCardInfo](docs/SandboxCardInfo.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxParty](docs/SandboxParty.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxRequest](docs/SandboxRequest.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxRetryCacheEntry](docs/SandboxRetryCacheEntry.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxScheduledPayment](docs/SandboxScheduledPayment.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxStandingOrder](docs/SandboxStandingOrder.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxStatement](docs/SandboxStatement.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxTransaction](docs/SandboxTransaction.md)
 - [AccountAndTransactionApiSpecificationUk.SandboxUser](docs/SandboxUser.md)
