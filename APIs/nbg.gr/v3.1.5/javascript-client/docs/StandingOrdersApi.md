# AccountAndTransactionApiSpecificationUk.StandingOrdersApi

All URIs are relative to *https://apis.nbg.gr/sandbox/uk.openbanking.accountinfo/oauth2/v3.1.5*

Method | HTTP request | Description
------------- | ------------- | -------------
[**accountsAccountIdStandingOrdersGet**](StandingOrdersApi.md#accountsAccountIdStandingOrdersGet) | **GET** /accounts/{accountId}/standing-orders | Get Standing Orders



## accountsAccountIdStandingOrdersGet

> OBReadStandingOrder6 accountsAccountIdStandingOrdersGet(accountId, sandboxId, opts)
...
let apiInstance = new AccountAndTransactionApiSpecificationUk.StandingOrdersApi();
...
apiInstance.accountsAccountIdStandingOrdersGet(accountId, sandboxId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
[**OBReadStandingOrder6**](OBReadStandingOrder6.md)
