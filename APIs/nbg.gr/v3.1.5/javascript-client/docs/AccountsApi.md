# AccountAndTransactionApiSpecificationUk.AccountsApi
...
> OBReadAccount5 accountsAccountIdGet(accountId, sandboxId, opts)
...
let apiInstance = new AccountAndTransactionApiSpecificationUk.AccountsApi();
...
apiInstance.accountsAccountIdGet(accountId, sandboxId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> OBReadAccount5 accountsGet(sandboxId, opts)
...
apiInstance.accountsGet(sandboxId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
