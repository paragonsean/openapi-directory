# AccountAndTransactionApiSpecificationUk.PartiesApi
...
> OBReadParty3 accountsAccountIdPartiesGet(accountId, sandboxId, opts)
...
let apiInstance = new AccountAndTransactionApiSpecificationUk.PartiesApi();
...
apiInstance.accountsAccountIdPartiesGet(accountId, sandboxId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> OBReadParty2 accountsAccountIdPartyGet(accountId, sandboxId, opts)
...
apiInstance.accountsAccountIdPartyGet(accountId, sandboxId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> OBReadParty2 partyGet(sandboxId, opts)
...
apiInstance.partyGet(sandboxId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
