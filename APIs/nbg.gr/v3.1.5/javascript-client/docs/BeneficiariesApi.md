# AccountAndTransactionApiSpecificationUk.BeneficiariesApi

All URIs are relative to *https://apis.nbg.gr/sandbox/uk.openbanking.accountinfo/oauth2/v3.1.5*

Method | HTTP request | Description
------------- | ------------- | -------------
[**accountsAccountIdBeneficiariesGet**](BeneficiariesApi.md#accountsAccountIdBeneficiariesGet) | **GET** /accounts/{accountId}/beneficiaries | Get Beneficiaries



## accountsAccountIdBeneficiariesGet

> OBReadBeneficiary5 accountsAccountIdBeneficiariesGet(accountId, sandboxId, opts)
...
let apiInstance = new AccountAndTransactionApiSpecificationUk.BeneficiariesApi();
...
apiInstance.accountsAccountIdBeneficiariesGet(accountId, sandboxId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
