...
```
http://localhost:8080/sandbox/uk.openbanking.accountinfo/oauth2/v3.1.5/ui/
```

Your OpenAPI definition lives here:

```
http://localhost:8080/sandbox/uk.openbanking.accountinfo/oauth2/v3.1.5/openapi.json
```
