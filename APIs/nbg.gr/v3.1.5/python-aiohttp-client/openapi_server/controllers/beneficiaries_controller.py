...
async def accounts_account_id_beneficiaries_get(request: web.Request, account_id, sandbox_id, x_fapi_auth_date=None, x_fapi_customer_ip_address=None, x_fapi_interaction_id=None, x_customer_user_agent=None) -> web.Response:
    """Get Beneficiaries
