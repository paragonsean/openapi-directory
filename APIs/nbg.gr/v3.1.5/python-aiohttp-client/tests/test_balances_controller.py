...
async def test_accounts_account_id_balances_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/sandbox/uk.openbanking.accountinfo/oauth2/v3.1.5/accounts/{account_id}/balances'.format(account_id='account_id_example'),
        headers=headers,
        )
