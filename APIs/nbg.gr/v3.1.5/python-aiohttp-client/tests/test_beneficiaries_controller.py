...
async def test_accounts_account_id_beneficiaries_get(client):
    """Test case for accounts_account_id_beneficiaries_get
    ...
    response = await client.request(
        method='GET',
        path='/sandbox/uk.openbanking.accountinfo/oauth2/v3.1.5/accounts/{account_id}/beneficiaries'.format(account_id='account_id_example'),
        headers=headers,
        )
