...
import org.openapitools.client.model.OBActiveOrHistoricCurrencyAndAmount;
...
public class OBScheduledPayment3 {
  ...
  public OBScheduledPayment3 creditorAccount(OBCashAccount5 creditorAccount) {
  ...
  public OBScheduledPayment3 instructedAmount(OBActiveOrHistoricCurrencyAndAmount instructedAmount) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, creditorAccount, debtorReference, instructedAmount, reference, scheduledPaymentDateTime, scheduledPaymentId, scheduledType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OBScheduledPayment3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OBScheduledPayment3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OBScheduledPayment3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OBScheduledPayment3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("CreditorAccount") != null && !jsonObj.get("CreditorAccount").isJsonNull()) {
        OBCashAccount5.validateJsonElement(jsonObj.get("CreditorAccount"));
      }
      ...
      OBActiveOrHistoricCurrencyAndAmount.validateJsonElement(jsonObj.get("InstructedAmount"));
      ...
      // validate the required field `ScheduledType`
      OBExternalScheduleType1Code.validateJsonElement(jsonObj.get("ScheduledType"));
  }
