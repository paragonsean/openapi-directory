...
public class SandboxCardInfo {
  ...
  public SandboxCardInfo() {
  }

  public SandboxCardInfo availableBalance(Double availableBalance) {
  ...
  public SandboxCardInfo creditLimit(Double creditLimit) {
  ...
  public SandboxCardInfo description(String description) {
  ...
  public SandboxCardInfo expiration(String expiration) {
  ...
  public SandboxCardInfo holderName(String holderName) {
  ...
  public SandboxCardInfo ledgerBalance(Double ledgerBalance) {
  ...
  public SandboxCardInfo number(String number) {
    this.number = number;
    return this;
  }
  ...
  public SandboxCardInfo subType(String subType) {
  ...
  public SandboxCardInfo type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SandboxCardInfo sandboxCardInfo = (SandboxCardInfo) o;
    return Objects.equals(this.availableBalance, sandboxCardInfo.availableBalance) &&
        Objects.equals(this.creditLimit, sandboxCardInfo.creditLimit) &&
        Objects.equals(this.description, sandboxCardInfo.description) &&
        Objects.equals(this.expiration, sandboxCardInfo.expiration) &&
        Objects.equals(this.holderName, sandboxCardInfo.holderName) &&
        Objects.equals(this.ledgerBalance, sandboxCardInfo.ledgerBalance) &&
        Objects.equals(this.number, sandboxCardInfo.number) &&
        Objects.equals(this.subType, sandboxCardInfo.subType) &&
        Objects.equals(this.type, sandboxCardInfo.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(availableBalance, creditLimit, description, expiration, holderName, ledgerBalance, number, subType, type);
  }
  ...
  public String toString() {
    ...
    sb.append("class SandboxCardInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SandboxCardInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SandboxCardInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SandboxCardInfo is not found in the empty JSON string", SandboxCardInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SandboxCardInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SandboxCardInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SandboxCardInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SandboxCardInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SandboxCardInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SandboxCardInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SandboxCardInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SandboxCardInfo>() {
           @Override
           public void write(JsonWriter out, SandboxCardInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SandboxCardInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SandboxCardInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SandboxCardInfo
   * @throws IOException if the JSON string is invalid with respect to SandboxCardInfo
   */
  public static SandboxCardInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SandboxCardInfo.class);
  }

  /**
   * Convert an instance of SandboxCardInfo to an JSON string
   *
   * @return JSON string
   */
