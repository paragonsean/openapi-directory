...
import org.openapitools.client.model.OBBranchAndFinancialInstitutionIdentification5;
import org.openapitools.client.model.OBCashAccount5;
...
public class OBAccount6 {
  ...
  public OBAccount6 account(List<OBCashAccount5> account) {
    this.account = account;
    return this;
  }

  public OBAccount6 addAccountItem(OBCashAccount5 accountItem) {
  ...
  public OBAccount6 servicer(OBBranchAndFinancialInstitutionIdentification5 servicer) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(account, accountId, accountSubType, accountType, currency, description, nickname, openingDate, servicer);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OBAccount6
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OBAccount6.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OBAccount6.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OBAccount6` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Account") != null && !jsonObj.get("Account").isJsonNull()) {
        ...
        if (jsonArrayaccount != null) {
          ...
          for (int i = 0; i < jsonArrayaccount.size(); i++) {
            OBCashAccount5.validateJsonElement(jsonArrayaccount.get(i));
          };
        }
      }
      ...
      // validate the required field `AccountSubType`
      OBExternalAccountSubType1Code.validateJsonElement(jsonObj.get("AccountSubType"));
      // validate the required field `AccountType`
      OBExternalAccountType1Code.validateJsonElement(jsonObj.get("AccountType"));
      ...
      if (jsonObj.get("Servicer") != null && !jsonObj.get("Servicer").isJsonNull()) {
        OBBranchAndFinancialInstitutionIdentification5.validateJsonElement(jsonObj.get("Servicer"));
      }
  }
