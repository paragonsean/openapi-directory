...
import org.openapitools.client.model.OBCashAccount6;
import org.openapitools.client.model.OBCreditDebitCode;
...
public class OBTransaction6 {
  ...
  public OBTransaction6 amount(OBActiveOrHistoricCurrencyAndAmount amount) {
    this.amount = amount;
    return this;
  }
  ...
  public OBTransaction6 creditDebitIndicator(OBCreditDebitCode creditDebitIndicator) {
  ...
  public OBTransaction6 creditorAccount(OBCashAccount6 creditorAccount) {
  ...
  public OBTransaction6 debtorAccount(OBCashAccount6 debtorAccount) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, amount, balance, bookingDateTime, creditDebitIndicator, creditorAccount, debtorAccount, proprietaryBankTransactionCode, status, transactionInformation, transactionReference, valueDateTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OBTransaction6
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OBTransaction6.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OBTransaction6.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OBTransaction6` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      OBActiveOrHistoricCurrencyAndAmount.validateJsonElement(jsonObj.get("Amount"));
      // validate the optional field `Balance`
      if (jsonObj.get("Balance") != null && !jsonObj.get("Balance").isJsonNull()) {
        OBTransactionCashBalance.validateJsonElement(jsonObj.get("Balance"));
      }
      // validate the required field `CreditDebitIndicator`
      OBCreditDebitCode.validateJsonElement(jsonObj.get("CreditDebitIndicator"));
      // validate the optional field `CreditorAccount`
      if (jsonObj.get("CreditorAccount") != null && !jsonObj.get("CreditorAccount").isJsonNull()) {
        OBCashAccount6.validateJsonElement(jsonObj.get("CreditorAccount"));
      }
      // validate the optional field `DebtorAccount`
      if (jsonObj.get("DebtorAccount") != null && !jsonObj.get("DebtorAccount").isJsonNull()) {
        OBCashAccount6.validateJsonElement(jsonObj.get("DebtorAccount"));
      }
      ...
      if (jsonObj.get("ProprietaryBankTransactionCode") != null && !jsonObj.get("ProprietaryBankTransactionCode").isJsonNull()) {
        ProprietaryBankTransactionCodeStructure1.validateJsonElement(jsonObj.get("ProprietaryBankTransactionCode"));
      }
      // validate the required field `Status`
      OBEntryStatus1Code.validateJsonElement(jsonObj.get("Status"));
