...
public class SandboxStandingOrder {
  ...
  public static final String SERIALIZED_NAME_FINAL_PAYMENT_DATE = "finalPaymentDate";
  @SerializedName(SERIALIZED_NAME_FINAL_PAYMENT_DATE)
  ...
  public SandboxStandingOrder() {
  }

  public SandboxStandingOrder amount(Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  public SandboxStandingOrder description(String description) {
  ...
  public SandboxStandingOrder finalPaymentDate(OffsetDateTime finalPaymentDate) {
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getFinalPaymentDate() {
    return finalPaymentDate;
  }

  public void setFinalPaymentDate(OffsetDateTime finalPaymentDate) {
    this.finalPaymentDate = finalPaymentDate;
  }


  public SandboxStandingOrder firstPaymentDate(OffsetDateTime firstPaymentDate) {
  ...
  public SandboxStandingOrder frequency(String frequency) {
  ...
  public SandboxStandingOrder lastPaymentDate(OffsetDateTime lastPaymentDate) {
  ...
  public SandboxStandingOrder nextPaymentDate(OffsetDateTime nextPaymentDate) {
  ...
  public SandboxStandingOrder status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SandboxStandingOrder sandboxStandingOrder = (SandboxStandingOrder) o;
    return Objects.equals(this.amount, sandboxStandingOrder.amount) &&
        Objects.equals(this.description, sandboxStandingOrder.description) &&
        Objects.equals(this.finalPaymentDate, sandboxStandingOrder.finalPaymentDate) &&
        Objects.equals(this.firstPaymentDate, sandboxStandingOrder.firstPaymentDate) &&
        Objects.equals(this.frequency, sandboxStandingOrder.frequency) &&
        Objects.equals(this.lastPaymentDate, sandboxStandingOrder.lastPaymentDate) &&
        Objects.equals(this.nextPaymentDate, sandboxStandingOrder.nextPaymentDate) &&
        Objects.equals(this.status, sandboxStandingOrder.status);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, description, finalPaymentDate, firstPaymentDate, frequency, lastPaymentDate, nextPaymentDate, status);
  }
  ...
  public String toString() {
    ...
    sb.append("class SandboxStandingOrder {\n");
  ...
  static {
    ...
    openapiFields.add("finalPaymentDate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SandboxStandingOrder
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SandboxStandingOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SandboxStandingOrder is not found in the empty JSON string", SandboxStandingOrder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SandboxStandingOrder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SandboxStandingOrder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SandboxStandingOrder.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SandboxStandingOrder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SandboxStandingOrder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SandboxStandingOrder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SandboxStandingOrder.class));

       return (TypeAdapter<T>) new TypeAdapter<SandboxStandingOrder>() {
           @Override
           public void write(JsonWriter out, SandboxStandingOrder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SandboxStandingOrder read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SandboxStandingOrder given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SandboxStandingOrder
   * @throws IOException if the JSON string is invalid with respect to SandboxStandingOrder
   */
  public static SandboxStandingOrder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SandboxStandingOrder.class);
  }

  /**
   * Convert an instance of SandboxStandingOrder to an JSON string
   *
   * @return JSON string
   */
