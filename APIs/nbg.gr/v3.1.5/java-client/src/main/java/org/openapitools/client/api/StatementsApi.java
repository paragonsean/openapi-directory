...
import java.io.File;
import org.openapitools.client.model.OBErrorResponse1;
import org.openapitools.client.model.OBReadStatement2;
...
public class StatementsApi {
    ...
    /**
     * Build call for accountsAccountIdStatementsGet
     * @param accountId AccountId (required)
     * @param sandboxId The unique id of the sandbox to be used (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Bad request </td><td>  * x-fapi-interaction-id - An RFC4122 UID used as a correlation id <br>  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  * x-fapi-interaction-id - An RFC4122 UID used as a correlation id <br>  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  * x-fapi-interaction-id - An RFC4122 UID used as a correlation id <br>  </td></tr>
        ...
        <tr><td> 500 </td><td> Internal Server Error </td><td>  * x-fapi-interaction-id - An RFC4122 UID used as a correlation id <br>  </td></tr>
     </table>
     */
    public okhttp3.Call accountsAccountIdStatementsGetCall(String accountId, String sandboxId, OffsetDateTime fromStatementDateTime, OffsetDateTime toStatementDateTime, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        ...
        if (sandboxId != null) {
            localVarHeaderParams.put("sandbox-id", localVarApiClient.parameterToString(sandboxId));
        }
        ...
        String[] localVarAuthNames = new String[] { "Authorization-Code-Token", "Client-Id" };
        return localVarApiClient.buildCall(basePath, localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAuthNames, _callback);
    }

    @SuppressWarnings("rawtypes")
    private okhttp3.Call accountsAccountIdStatementsGetValidateBeforeCall(String accountId, String sandboxId, OffsetDateTime fromStatementDateTime, OffsetDateTime toStatementDateTime, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new ApiException("Missing the required parameter 'accountId' when calling accountsAccountIdStatementsGet(Async)");
        }

        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling accountsAccountIdStatementsGet(Async)");
        }

        return accountsAccountIdStatementsGetCall(accountId, sandboxId, fromStatementDateTime, toStatementDateTime, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
     ...
     */
    public OBReadStatement2 accountsAccountIdStatementsGet(String accountId, String sandboxId, OffsetDateTime fromStatementDateTime, OffsetDateTime toStatementDateTime, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        ApiResponse<OBReadStatement2> localVarResp = accountsAccountIdStatementsGetWithHttpInfo(accountId, sandboxId, fromStatementDateTime, toStatementDateTime, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
     ...
     */
    public ApiResponse<OBReadStatement2> accountsAccountIdStatementsGetWithHttpInfo(String accountId, String sandboxId, OffsetDateTime fromStatementDateTime, OffsetDateTime toStatementDateTime, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        okhttp3.Call localVarCall = accountsAccountIdStatementsGetValidateBeforeCall(accountId, sandboxId, fromStatementDateTime, toStatementDateTime, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, null);
     ...
     */
    public okhttp3.Call accountsAccountIdStatementsGetAsync(String accountId, String sandboxId, OffsetDateTime fromStatementDateTime, OffsetDateTime toStatementDateTime, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<OBReadStatement2> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountsAccountIdStatementsGetValidateBeforeCall(accountId, sandboxId, fromStatementDateTime, toStatementDateTime, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
        Type localVarReturnType = new TypeToken<OBReadStatement2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for accountsAccountIdStatementsStatementIdFileGet
     * @param accountId AccountId (required)
     ...
     */
    public okhttp3.Call accountsAccountIdStatementsStatementIdFileGetCall(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call accountsAccountIdStatementsStatementIdFileGetValidateBeforeCall(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new ApiException("Missing the required parameter 'accountId' when calling accountsAccountIdStatementsStatementIdFileGet(Async)");
        }

        // verify the required parameter 'statementId' is set
        if (statementId == null) {
            throw new ApiException("Missing the required parameter 'statementId' when calling accountsAccountIdStatementsStatementIdFileGet(Async)");
        }

        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling accountsAccountIdStatementsStatementIdFileGet(Async)");
        }

        return accountsAccountIdStatementsStatementIdFileGetCall(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
     ...
     */
    public File accountsAccountIdStatementsStatementIdFileGet(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        ApiResponse<File> localVarResp = accountsAccountIdStatementsStatementIdFileGetWithHttpInfo(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<File> accountsAccountIdStatementsStatementIdFileGetWithHttpInfo(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        okhttp3.Call localVarCall = accountsAccountIdStatementsStatementIdFileGetValidateBeforeCall(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, null);
     ...
     */
    public okhttp3.Call accountsAccountIdStatementsStatementIdFileGetAsync(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountsAccountIdStatementsStatementIdFileGetValidateBeforeCall(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for accountsAccountIdStatementsStatementIdGet
     * @param accountId AccountId (required)
     * @param statementId StatementId (required)
     * @param sandboxId The unique id of the sandbox to be used (required)
     * @param xFapiAuthDate The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC (optional)
     ...
     */
    public okhttp3.Call accountsAccountIdStatementsStatementIdGetCall(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call accountsAccountIdStatementsStatementIdGetValidateBeforeCall(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new ApiException("Missing the required parameter 'accountId' when calling accountsAccountIdStatementsStatementIdGet(Async)");
        }

        // verify the required parameter 'statementId' is set
        if (statementId == null) {
            throw new ApiException("Missing the required parameter 'statementId' when calling accountsAccountIdStatementsStatementIdGet(Async)");
        }

        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling accountsAccountIdStatementsStatementIdGet(Async)");
        }

        return accountsAccountIdStatementsStatementIdGetCall(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
     ...
     */
    public OBReadStatement2 accountsAccountIdStatementsStatementIdGet(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        ApiResponse<OBReadStatement2> localVarResp = accountsAccountIdStatementsStatementIdGetWithHttpInfo(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OBReadStatement2> accountsAccountIdStatementsStatementIdGetWithHttpInfo(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        okhttp3.Call localVarCall = accountsAccountIdStatementsStatementIdGetValidateBeforeCall(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, null);
        Type localVarReturnType = new TypeToken<OBReadStatement2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call accountsAccountIdStatementsStatementIdGetAsync(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<OBReadStatement2> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountsAccountIdStatementsStatementIdGetValidateBeforeCall(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
        Type localVarReturnType = new TypeToken<OBReadStatement2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
