...
import org.openapitools.client.model.OBReadConsent1;
import org.openapitools.client.model.OBReadConsentResponse1;
...
public class AccountAccessApi {
    ...
    /**
     * Build call for accountAccessConsentsConsentIdDelete
     ...
     */
    public okhttp3.Call accountAccessConsentsConsentIdDeleteCall(String consentId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        ...
        String[] localVarAuthNames = new String[] { "Client-Credentials-Token", "Client-Id" };
        return localVarApiClient.buildCall(basePath, localVarPath, "DELETE", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAuthNames, _callback);
    }

    @SuppressWarnings("rawtypes")
    private okhttp3.Call accountAccessConsentsConsentIdDeleteValidateBeforeCall(String consentId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'consentId' is set
        if (consentId == null) {
            throw new ApiException("Missing the required parameter 'consentId' when calling accountAccessConsentsConsentIdDelete(Async)");
        }

        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling accountAccessConsentsConsentIdDelete(Async)");
        }

        return accountAccessConsentsConsentIdDeleteCall(consentId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
     ...
     */
    public void accountAccessConsentsConsentIdDelete(String consentId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        accountAccessConsentsConsentIdDeleteWithHttpInfo(consentId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
    }
     ...
     */
    public ApiResponse<Void> accountAccessConsentsConsentIdDeleteWithHttpInfo(String consentId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        okhttp3.Call localVarCall = accountAccessConsentsConsentIdDeleteValidateBeforeCall(consentId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, null);
     ...
     */
    public okhttp3.Call accountAccessConsentsConsentIdDeleteAsync(String consentId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountAccessConsentsConsentIdDeleteValidateBeforeCall(consentId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for accountAccessConsentsConsentIdGet
     * @param consentId ConsentId (required)
     * @param sandboxId The unique id of the sandbox to be used (required)
     * @param xFapiAuthDate The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC (optional)
     * @param xFapiCustomerIpAddress The PSU&#39;s IP address if the PSU is currently logged in with the TPP. (optional)
     ...
     */
    public okhttp3.Call accountAccessConsentsConsentIdGetCall(String consentId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call accountAccessConsentsConsentIdGetValidateBeforeCall(String consentId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'consentId' is set
        if (consentId == null) {
            throw new ApiException("Missing the required parameter 'consentId' when calling accountAccessConsentsConsentIdGet(Async)");
        }

        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling accountAccessConsentsConsentIdGet(Async)");
        }

        return accountAccessConsentsConsentIdGetCall(consentId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
     ...
     */
    public OBReadConsentResponse1 accountAccessConsentsConsentIdGet(String consentId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        ApiResponse<OBReadConsentResponse1> localVarResp = accountAccessConsentsConsentIdGetWithHttpInfo(consentId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
     ...
     */
    public ApiResponse<OBReadConsentResponse1> accountAccessConsentsConsentIdGetWithHttpInfo(String consentId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        okhttp3.Call localVarCall = accountAccessConsentsConsentIdGetValidateBeforeCall(consentId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, null);
     ...
     */
    public okhttp3.Call accountAccessConsentsConsentIdGetAsync(String consentId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<OBReadConsentResponse1> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountAccessConsentsConsentIdGetValidateBeforeCall(consentId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
        Type localVarReturnType = new TypeToken<OBReadConsentResponse1>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for accountAccessConsentsPost
     * @param sandboxId The unique id of the sandbox to be used (required)
     * @param xFapiAuthDate The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC (optional)
     * @param xFapiCustomerIpAddress The PSU&#39;s IP address if the PSU is currently logged in with the TPP. (optional)
     * @param xFapiInteractionId An RFC4122 UID used as a correlation id. (optional)
     * @param xCustomerUserAgent Indicates the user-agent that the PSU is using. (optional)
     * @param obReadConsent1 Default (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call accountAccessConsentsPostCall(String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, OBReadConsent1 obReadConsent1, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call accountAccessConsentsPostValidateBeforeCall(String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, OBReadConsent1 obReadConsent1, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling accountAccessConsentsPost(Async)");
        }

        return accountAccessConsentsPostCall(sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, obReadConsent1, _callback);
     ...
     */
    public OBReadConsentResponse1 accountAccessConsentsPost(String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, OBReadConsent1 obReadConsent1) throws ApiException {
        ApiResponse<OBReadConsentResponse1> localVarResp = accountAccessConsentsPostWithHttpInfo(sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, obReadConsent1);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OBReadConsentResponse1> accountAccessConsentsPostWithHttpInfo(String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, OBReadConsent1 obReadConsent1) throws ApiException {
        okhttp3.Call localVarCall = accountAccessConsentsPostValidateBeforeCall(sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, obReadConsent1, null);
        Type localVarReturnType = new TypeToken<OBReadConsentResponse1>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call accountAccessConsentsPostAsync(String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, OBReadConsent1 obReadConsent1, final ApiCallback<OBReadConsentResponse1> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountAccessConsentsPostValidateBeforeCall(sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, obReadConsent1, _callback);
        Type localVarReturnType = new TypeToken<OBReadConsentResponse1>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
