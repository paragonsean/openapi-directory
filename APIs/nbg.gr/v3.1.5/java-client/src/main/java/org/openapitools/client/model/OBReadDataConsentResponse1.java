...
import org.openapitools.client.model.OBExternalPermissions1Code;
import org.openapitools.client.model.OBExternalRequestStatus1Code;
...
public class OBReadDataConsentResponse1 {
  ...
  public OBReadDataConsentResponse1 consentId(String consentId) {
  ...
  public OBReadDataConsentResponse1 creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public OBReadDataConsentResponse1 expirationDateTime(OffsetDateTime expirationDateTime) {
  ...
  public OBReadDataConsentResponse1 permissions(List<OBExternalPermissions1Code> permissions) {
    this.permissions = permissions;
    return this;
  }

  public OBReadDataConsentResponse1 addPermissionsItem(OBExternalPermissions1Code permissionsItem) {
  ...
  public OBReadDataConsentResponse1 status(OBExternalRequestStatus1Code status) {
    this.status = status;
    return this;
  }
  ...
  public OBReadDataConsentResponse1 statusUpdateDateTime(OffsetDateTime statusUpdateDateTime) {
  ...
  public OBReadDataConsentResponse1 transactionFromDateTime(OffsetDateTime transactionFromDateTime) {
  ...
  public OBReadDataConsentResponse1 transactionToDateTime(OffsetDateTime transactionToDateTime) {
  ...
  public boolean equals(Object o) {
    ...
    OBReadDataConsentResponse1 obReadDataConsentResponse1 = (OBReadDataConsentResponse1) o;
    return Objects.equals(this.consentId, obReadDataConsentResponse1.consentId) &&
        Objects.equals(this.creationDateTime, obReadDataConsentResponse1.creationDateTime) &&
        Objects.equals(this.expirationDateTime, obReadDataConsentResponse1.expirationDateTime) &&
        Objects.equals(this.permissions, obReadDataConsentResponse1.permissions) &&
        Objects.equals(this.status, obReadDataConsentResponse1.status) &&
        Objects.equals(this.statusUpdateDateTime, obReadDataConsentResponse1.statusUpdateDateTime) &&
        Objects.equals(this.transactionFromDateTime, obReadDataConsentResponse1.transactionFromDateTime) &&
        Objects.equals(this.transactionToDateTime, obReadDataConsentResponse1.transactionToDateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBReadDataConsentResponse1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OBReadDataConsentResponse1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OBReadDataConsentResponse1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBReadDataConsentResponse1 is not found in the empty JSON string", OBReadDataConsentResponse1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OBReadDataConsentResponse1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OBReadDataConsentResponse1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBReadDataConsentResponse1.openapiRequiredFields) {
      ...
      OBExternalRequestStatus1Code.validateJsonElement(jsonObj.get("Status"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBReadDataConsentResponse1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBReadDataConsentResponse1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBReadDataConsentResponse1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBReadDataConsentResponse1.class));

       return (TypeAdapter<T>) new TypeAdapter<OBReadDataConsentResponse1>() {
           @Override
           public void write(JsonWriter out, OBReadDataConsentResponse1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OBReadDataConsentResponse1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OBReadDataConsentResponse1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OBReadDataConsentResponse1
   * @throws IOException if the JSON string is invalid with respect to OBReadDataConsentResponse1
   */
  public static OBReadDataConsentResponse1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBReadDataConsentResponse1.class);
  }

  /**
   * Convert an instance of OBReadDataConsentResponse1 to an JSON string
   *
   * @return JSON string
   */
