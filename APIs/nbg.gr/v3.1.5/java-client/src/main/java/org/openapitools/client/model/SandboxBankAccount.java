...
import org.openapitools.client.model.SandboxBankAccountInfo;
import org.openapitools.client.model.SandboxBeneficiary;
import org.openapitools.client.model.SandboxParty;
import org.openapitools.client.model.SandboxScheduledPayment;
import org.openapitools.client.model.SandboxStandingOrder;
import org.openapitools.client.model.SandboxStatement;
import org.openapitools.client.model.SandboxTransaction;
 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T11:17:44.973176-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class SandboxBankAccount {
  ...
  private List<SandboxBeneficiary> beneficiaries;

  public static final String SERIALIZED_NAME_INFO = "info";
  @SerializedName(SERIALIZED_NAME_INFO)
  private SandboxBankAccountInfo info;

  public static final String SERIALIZED_NAME_PARTY = "party";
  @SerializedName(SERIALIZED_NAME_PARTY)
  private SandboxParty party;

  public static final String SERIALIZED_NAME_SCHEDULED_PAYMENTS = "scheduledPayments";
  @SerializedName(SERIALIZED_NAME_SCHEDULED_PAYMENTS)
  private List<SandboxScheduledPayment> scheduledPayments;

  public static final String SERIALIZED_NAME_STANDING_ORDERS = "standingOrders";
  @SerializedName(SERIALIZED_NAME_STANDING_ORDERS)
  private List<SandboxStandingOrder> standingOrders;

  public static final String SERIALIZED_NAME_STATEMENTS = "statements";
  @SerializedName(SERIALIZED_NAME_STATEMENTS)
  private List<SandboxStatement> statements;
  ...
  public SandboxBankAccount beneficiaries(List<SandboxBeneficiary> beneficiaries) {
    this.beneficiaries = beneficiaries;
    return this;
  }

  public SandboxBankAccount addBeneficiariesItem(SandboxBeneficiary beneficiariesItem) {
  ...
  public List<SandboxBeneficiary> getBeneficiaries() {
    return beneficiaries;
  }

  public void setBeneficiaries(List<SandboxBeneficiary> beneficiaries) {
    this.beneficiaries = beneficiaries;
  }


  public SandboxBankAccount info(SandboxBankAccountInfo info) {
    this.info = info;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SandboxBankAccountInfo getInfo() {
    return info;
  }

  public void setInfo(SandboxBankAccountInfo info) {
    this.info = info;
  }


  public SandboxBankAccount party(SandboxParty party) {
    this.party = party;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SandboxParty getParty() {
    return party;
  }

  public void setParty(SandboxParty party) {
    this.party = party;
  }


  public SandboxBankAccount scheduledPayments(List<SandboxScheduledPayment> scheduledPayments) {
    this.scheduledPayments = scheduledPayments;
    return this;
  }

  public SandboxBankAccount addScheduledPaymentsItem(SandboxScheduledPayment scheduledPaymentsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SandboxScheduledPayment> getScheduledPayments() {
    return scheduledPayments;
  }

  public void setScheduledPayments(List<SandboxScheduledPayment> scheduledPayments) {
    this.scheduledPayments = scheduledPayments;
  }


  public SandboxBankAccount standingOrders(List<SandboxStandingOrder> standingOrders) {
    this.standingOrders = standingOrders;
    return this;
  }

  public SandboxBankAccount addStandingOrdersItem(SandboxStandingOrder standingOrdersItem) {
    if (this.standingOrders == null) {
      this.standingOrders = new ArrayList<>();
    }
    this.standingOrders.add(standingOrdersItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<SandboxStandingOrder> getStandingOrders() {
    return standingOrders;
  }

  public void setStandingOrders(List<SandboxStandingOrder> standingOrders) {
    this.standingOrders = standingOrders;
  }


  public SandboxBankAccount statements(List<SandboxStatement> statements) {
    this.statements = statements;
    return this;
  }

  public SandboxBankAccount addStatementsItem(SandboxStatement statementsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SandboxStatement> getStatements() {
    return statements;
  }

  public void setStatements(List<SandboxStatement> statements) {
    this.statements = statements;
  }


  public SandboxBankAccount transactions(List<SandboxTransaction> transactions) {
    this.transactions = transactions;
    return this;
  }

  public SandboxBankAccount addTransactionsItem(SandboxTransaction transactionsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SandboxTransaction> getTransactions() {
    return transactions;
  }

  public void setTransactions(List<SandboxTransaction> transactions) {
    this.transactions = transactions;
  }
  ...
  public boolean equals(Object o) {
    ...
    SandboxBankAccount sandboxBankAccount = (SandboxBankAccount) o;
    return Objects.equals(this.beneficiaries, sandboxBankAccount.beneficiaries) &&
        Objects.equals(this.info, sandboxBankAccount.info) &&
        Objects.equals(this.party, sandboxBankAccount.party) &&
        Objects.equals(this.scheduledPayments, sandboxBankAccount.scheduledPayments) &&
        Objects.equals(this.standingOrders, sandboxBankAccount.standingOrders) &&
        Objects.equals(this.statements, sandboxBankAccount.statements) &&
        Objects.equals(this.transactions, sandboxBankAccount.transactions);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(beneficiaries, info, party, scheduledPayments, standingOrders, statements, transactions);
  }
  ...
  public String toString() {
    ...
    sb.append("class SandboxBankAccount {\n");
    ...
    sb.append("    standingOrders: ").append(toIndentedString(standingOrders)).append("\n");
  ...
  static {
    ...
    openapiFields.add("scheduledPayments");
    openapiFields.add("standingOrders");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SandboxBankAccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SandboxBankAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SandboxBankAccount is not found in the empty JSON string", SandboxBankAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SandboxBankAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SandboxBankAccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("beneficiaries") != null && !jsonObj.get("beneficiaries").isJsonNull()) {
        ...
        if (jsonArraybeneficiaries != null) {
          ...
          for (int i = 0; i < jsonArraybeneficiaries.size(); i++) {
            SandboxBeneficiary.validateJsonElement(jsonArraybeneficiaries.get(i));
          };
        }
      }
      // validate the optional field `info`
      if (jsonObj.get("info") != null && !jsonObj.get("info").isJsonNull()) {
        SandboxBankAccountInfo.validateJsonElement(jsonObj.get("info"));
      }
      // validate the optional field `party`
      if (jsonObj.get("party") != null && !jsonObj.get("party").isJsonNull()) {
        SandboxParty.validateJsonElement(jsonObj.get("party"));
      }
      if (jsonObj.get("scheduledPayments") != null && !jsonObj.get("scheduledPayments").isJsonNull()) {
        JsonArray jsonArrayscheduledPayments = jsonObj.getAsJsonArray("scheduledPayments");
        if (jsonArrayscheduledPayments != null) {
          // ensure the json data is an array
          if (!jsonObj.get("scheduledPayments").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `scheduledPayments` to be an array in the JSON string but got `%s`", jsonObj.get("scheduledPayments").toString()));
          }

          // validate the optional field `scheduledPayments` (array)
          for (int i = 0; i < jsonArrayscheduledPayments.size(); i++) {
            SandboxScheduledPayment.validateJsonElement(jsonArrayscheduledPayments.get(i));
          };
        }
      }
      if (jsonObj.get("standingOrders") != null && !jsonObj.get("standingOrders").isJsonNull()) {
        JsonArray jsonArraystandingOrders = jsonObj.getAsJsonArray("standingOrders");
        if (jsonArraystandingOrders != null) {
          // ensure the json data is an array
          if (!jsonObj.get("standingOrders").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `standingOrders` to be an array in the JSON string but got `%s`", jsonObj.get("standingOrders").toString()));
          }

          // validate the optional field `standingOrders` (array)
          for (int i = 0; i < jsonArraystandingOrders.size(); i++) {
            SandboxStandingOrder.validateJsonElement(jsonArraystandingOrders.get(i));
          };
        }
      }
      if (jsonObj.get("statements") != null && !jsonObj.get("statements").isJsonNull()) {
        ...
        if (jsonArraystatements != null) {
          ...
          for (int i = 0; i < jsonArraystatements.size(); i++) {
            SandboxStatement.validateJsonElement(jsonArraystatements.get(i));
          };
        }
      }
      if (jsonObj.get("transactions") != null && !jsonObj.get("transactions").isJsonNull()) {
        ...
        if (jsonArraytransactions != null) {
          ...
          for (int i = 0; i < jsonArraytransactions.size(); i++) {
            SandboxTransaction.validateJsonElement(jsonArraytransactions.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SandboxBankAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SandboxBankAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SandboxBankAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SandboxBankAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<SandboxBankAccount>() {
           @Override
           public void write(JsonWriter out, SandboxBankAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SandboxBankAccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SandboxBankAccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SandboxBankAccount
   * @throws IOException if the JSON string is invalid with respect to SandboxBankAccount
   */
  public static SandboxBankAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SandboxBankAccount.class);
  }

  /**
   * Convert an instance of SandboxBankAccount to an JSON string
   *
   * @return JSON string
   */
