...
public class SandboxBankAccountInfo {
  ...
  public SandboxBankAccountInfo() {
  }

  public SandboxBankAccountInfo accountSubType(String accountSubType) {
  ...
  public SandboxBankAccountInfo accountType(String accountType) {
  ...
  public SandboxBankAccountInfo alias(String alias) {
    this.alias = alias;
    return this;
  }
  ...
  public SandboxBankAccountInfo availableBalance(Double availableBalance) {
  ...
  public SandboxBankAccountInfo currency(String currency) {
  ...
  public SandboxBankAccountInfo description(String description) {
  ...
  public SandboxBankAccountInfo iban(String iban) {
    this.iban = iban;
    return this;
  }
  ...
  public SandboxBankAccountInfo ledgerBalance(Double ledgerBalance) {
  ...
  public SandboxBankAccountInfo openingDate(OffsetDateTime openingDate) {
  ...
  public SandboxBankAccountInfo overdraftLimit(Double overdraftLimit) {
  ...
  public boolean equals(Object o) {
    ...
    SandboxBankAccountInfo sandboxBankAccountInfo = (SandboxBankAccountInfo) o;
    return Objects.equals(this.accountSubType, sandboxBankAccountInfo.accountSubType) &&
        Objects.equals(this.accountType, sandboxBankAccountInfo.accountType) &&
        Objects.equals(this.alias, sandboxBankAccountInfo.alias) &&
        Objects.equals(this.availableBalance, sandboxBankAccountInfo.availableBalance) &&
        Objects.equals(this.currency, sandboxBankAccountInfo.currency) &&
        Objects.equals(this.description, sandboxBankAccountInfo.description) &&
        Objects.equals(this.iban, sandboxBankAccountInfo.iban) &&
        Objects.equals(this.ledgerBalance, sandboxBankAccountInfo.ledgerBalance) &&
        Objects.equals(this.openingDate, sandboxBankAccountInfo.openingDate) &&
        Objects.equals(this.overdraftLimit, sandboxBankAccountInfo.overdraftLimit);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountSubType, accountType, alias, availableBalance, currency, description, iban, ledgerBalance, openingDate, overdraftLimit);
  }
  ...
  public String toString() {
    ...
    sb.append("class SandboxBankAccountInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SandboxBankAccountInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SandboxBankAccountInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SandboxBankAccountInfo is not found in the empty JSON string", SandboxBankAccountInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SandboxBankAccountInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SandboxBankAccountInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SandboxBankAccountInfo.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("accountSubType").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SandboxBankAccountInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SandboxBankAccountInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SandboxBankAccountInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SandboxBankAccountInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<SandboxBankAccountInfo>() {
           @Override
           public void write(JsonWriter out, SandboxBankAccountInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SandboxBankAccountInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SandboxBankAccountInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SandboxBankAccountInfo
   * @throws IOException if the JSON string is invalid with respect to SandboxBankAccountInfo
   */
  public static SandboxBankAccountInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SandboxBankAccountInfo.class);
  }

  /**
   * Convert an instance of SandboxBankAccountInfo to an JSON string
   *
   * @return JSON string
   */
