...
import org.openapitools.client.model.OBReadTransaction6;
...
public class TransactionsApi {
    ...
    /**
     * Build call for accountsAccountIdStatementsStatementIdTransactionsGet
     ...
     */
    public okhttp3.Call accountsAccountIdStatementsStatementIdTransactionsGetCall(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call accountsAccountIdStatementsStatementIdTransactionsGetValidateBeforeCall(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new ApiException("Missing the required parameter 'accountId' when calling accountsAccountIdStatementsStatementIdTransactionsGet(Async)");
        }

        // verify the required parameter 'statementId' is set
        if (statementId == null) {
            throw new ApiException("Missing the required parameter 'statementId' when calling accountsAccountIdStatementsStatementIdTransactionsGet(Async)");
        }

        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling accountsAccountIdStatementsStatementIdTransactionsGet(Async)");
        }

        return accountsAccountIdStatementsStatementIdTransactionsGetCall(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
     ...
     */
    public OBReadTransaction6 accountsAccountIdStatementsStatementIdTransactionsGet(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        ApiResponse<OBReadTransaction6> localVarResp = accountsAccountIdStatementsStatementIdTransactionsGetWithHttpInfo(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
     ...
     */
    public ApiResponse<OBReadTransaction6> accountsAccountIdStatementsStatementIdTransactionsGetWithHttpInfo(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        okhttp3.Call localVarCall = accountsAccountIdStatementsStatementIdTransactionsGetValidateBeforeCall(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, null);
     ...
     */
    public okhttp3.Call accountsAccountIdStatementsStatementIdTransactionsGetAsync(String accountId, String statementId, String sandboxId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<OBReadTransaction6> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountsAccountIdStatementsStatementIdTransactionsGetValidateBeforeCall(accountId, statementId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
        Type localVarReturnType = new TypeToken<OBReadTransaction6>(){}.getType();
     ...
     */
    public okhttp3.Call accountsAccountIdTransactionsGetCall(String accountId, String sandboxId, OffsetDateTime fromBookingDateTime, OffsetDateTime toBookingDateTime, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call accountsAccountIdTransactionsGetValidateBeforeCall(String accountId, String sandboxId, OffsetDateTime fromBookingDateTime, OffsetDateTime toBookingDateTime, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
        ...
        // verify the required parameter 'sandboxId' is set
        if (sandboxId == null) {
            throw new ApiException("Missing the required parameter 'sandboxId' when calling accountsAccountIdTransactionsGet(Async)");
        }

        return accountsAccountIdTransactionsGetCall(accountId, sandboxId, fromBookingDateTime, toBookingDateTime, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
     ...
     */
    public OBReadTransaction6 accountsAccountIdTransactionsGet(String accountId, String sandboxId, OffsetDateTime fromBookingDateTime, OffsetDateTime toBookingDateTime, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        ApiResponse<OBReadTransaction6> localVarResp = accountsAccountIdTransactionsGetWithHttpInfo(accountId, sandboxId, fromBookingDateTime, toBookingDateTime, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OBReadTransaction6> accountsAccountIdTransactionsGetWithHttpInfo(String accountId, String sandboxId, OffsetDateTime fromBookingDateTime, OffsetDateTime toBookingDateTime, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        okhttp3.Call localVarCall = accountsAccountIdTransactionsGetValidateBeforeCall(accountId, sandboxId, fromBookingDateTime, toBookingDateTime, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, null);
        Type localVarReturnType = new TypeToken<OBReadTransaction6>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call accountsAccountIdTransactionsGetAsync(String accountId, String sandboxId, OffsetDateTime fromBookingDateTime, OffsetDateTime toBookingDateTime, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<OBReadTransaction6> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountsAccountIdTransactionsGetValidateBeforeCall(accountId, sandboxId, fromBookingDateTime, toBookingDateTime, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
        Type localVarReturnType = new TypeToken<OBReadTransaction6>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
