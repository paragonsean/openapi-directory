...
public class OBStandingOrder5 {
  ...
  private OBActiveOrHistoricCurrencyAndAmount lastPaymentAmount;
  ...
  public OBStandingOrder5 lastPaymentAmount(OBActiveOrHistoricCurrencyAndAmount lastPaymentAmount) {
   ...
   */
  @javax.annotation.Nullable
  public OBActiveOrHistoricCurrencyAndAmount getLastPaymentAmount() {
    return lastPaymentAmount;
  }

  public void setLastPaymentAmount(OBActiveOrHistoricCurrencyAndAmount lastPaymentAmount) {
    this.lastPaymentAmount = lastPaymentAmount;
  }


  public OBStandingOrder5 lastPaymentDateTime(OffsetDateTime lastPaymentDateTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, obStandingOrder5.accountId) &&
        ...
        Objects.equals(this.lastPaymentAmount, obStandingOrder5.lastPaymentAmount) &&
        Objects.equals(this.lastPaymentDateTime, obStandingOrder5.lastPaymentDateTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, creditorAccount, finalPaymentAmount, finalPaymentDateTime, firstPaymentAmount, firstPaymentDateTime, frequency, lastPaymentAmount, lastPaymentDateTime, nextPaymentAmount, nextPaymentDateTime, reference, standingOrderId, standingOrderStatusCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OBStandingOrder5
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OBStandingOrder5.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBStandingOrder5 is not found in the empty JSON string", OBStandingOrder5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OBStandingOrder5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OBStandingOrder5` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBStandingOrder5.openapiRequiredFields) {
      ...
      if (jsonObj.get("FinalPaymentAmount") != null && !jsonObj.get("FinalPaymentAmount").isJsonNull()) {
        OBActiveOrHistoricCurrencyAndAmount.validateJsonElement(jsonObj.get("FinalPaymentAmount"));
      }
      ...
      if (jsonObj.get("FirstPaymentAmount") != null && !jsonObj.get("FirstPaymentAmount").isJsonNull()) {
        OBActiveOrHistoricCurrencyAndAmount.validateJsonElement(jsonObj.get("FirstPaymentAmount"));
      }
      ...
      if (jsonObj.get("LastPaymentAmount") != null && !jsonObj.get("LastPaymentAmount").isJsonNull()) {
        OBActiveOrHistoricCurrencyAndAmount.validateJsonElement(jsonObj.get("LastPaymentAmount"));
      }
      ...
      if (jsonObj.get("NextPaymentAmount") != null && !jsonObj.get("NextPaymentAmount").isJsonNull()) {
        OBActiveOrHistoricCurrencyAndAmount.validateJsonElement(jsonObj.get("NextPaymentAmount"));
      }
      ...
      // validate the optional field `StandingOrderStatusCode`
      if (jsonObj.get("StandingOrderStatusCode") != null && !jsonObj.get("StandingOrderStatusCode").isJsonNull()) {
        OBExternalStandingOrderStatus1Code.validateJsonElement(jsonObj.get("StandingOrderStatusCode"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBStandingOrder5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBStandingOrder5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBStandingOrder5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBStandingOrder5.class));

       return (TypeAdapter<T>) new TypeAdapter<OBStandingOrder5>() {
           @Override
           public void write(JsonWriter out, OBStandingOrder5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OBStandingOrder5 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OBStandingOrder5 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OBStandingOrder5
   * @throws IOException if the JSON string is invalid with respect to OBStandingOrder5
   */
  public static OBStandingOrder5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBStandingOrder5.class);
  }

  /**
   * Convert an instance of OBStandingOrder5 to an JSON string
   *
   * @return JSON string
   */
