...
public class SandboxTransaction {
  public static final String SERIALIZED_NAME_ACCOUNTING_BALANCE = "accountingBalance";
  @SerializedName(SERIALIZED_NAME_ACCOUNTING_BALANCE)
  ...
  public static final String SERIALIZED_NAME_CREDIT_DEBIT = "creditDebit";
  @SerializedName(SERIALIZED_NAME_CREDIT_DEBIT)
  ...
  public static final String SERIALIZED_NAME_RELATED_ACCOUNT = "relatedAccount";
  @SerializedName(SERIALIZED_NAME_RELATED_ACCOUNT)
  ...
  public SandboxTransaction accountingBalance(Double accountingBalance) {
  ...
  public SandboxTransaction amount(Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  public SandboxTransaction bookingDateTime(OffsetDateTime bookingDateTime) {
  ...
  public SandboxTransaction creditDebit(String creditDebit) {
  ...
  public SandboxTransaction currency(String currency) {
  ...
  public SandboxTransaction description(String description) {
  ...
  public SandboxTransaction reference(String reference) {
  ...
  public SandboxTransaction relatedAccount(String relatedAccount) {
  ...
  public SandboxTransaction relatedName(String relatedName) {
  ...
  public SandboxTransaction transactionCode(String transactionCode) {
  ...
  public SandboxTransaction valueDateTime(OffsetDateTime valueDateTime) {
  ...
  public boolean equals(Object o) {
    ...
    SandboxTransaction sandboxTransaction = (SandboxTransaction) o;
    return Objects.equals(this.accountingBalance, sandboxTransaction.accountingBalance) &&
        Objects.equals(this.amount, sandboxTransaction.amount) &&
        Objects.equals(this.bookingDateTime, sandboxTransaction.bookingDateTime) &&
        Objects.equals(this.creditDebit, sandboxTransaction.creditDebit) &&
        Objects.equals(this.currency, sandboxTransaction.currency) &&
        Objects.equals(this.description, sandboxTransaction.description) &&
        Objects.equals(this.reference, sandboxTransaction.reference) &&
        Objects.equals(this.relatedAccount, sandboxTransaction.relatedAccount) &&
        Objects.equals(this.relatedName, sandboxTransaction.relatedName) &&
        Objects.equals(this.transactionCode, sandboxTransaction.transactionCode) &&
        Objects.equals(this.valueDateTime, sandboxTransaction.valueDateTime);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountingBalance, amount, bookingDateTime, creditDebit, currency, description, reference, relatedAccount, relatedName, transactionCode, valueDateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class SandboxTransaction {\n");
    ...
    sb.append("    relatedAccount: ").append(toIndentedString(relatedAccount)).append("\n");
  ...
  static {
    ...
    openapiFields.add("accountingBalance");
    openapiFields.add("amount");
    openapiFields.add("bookingDateTime");
    openapiFields.add("creditDebit");
    openapiFields.add("currency");
    openapiFields.add("description");
    openapiFields.add("reference");
    openapiFields.add("relatedAccount");
    openapiFields.add("relatedName");
    openapiFields.add("transactionCode");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SandboxTransaction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SandboxTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SandboxTransaction is not found in the empty JSON string", SandboxTransaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SandboxTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SandboxTransaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("creditDebit") != null && !jsonObj.get("creditDebit").isJsonNull()) && !jsonObj.get("creditDebit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `creditDebit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("creditDebit").toString()));
      }
      ...
      if ((jsonObj.get("relatedAccount") != null && !jsonObj.get("relatedAccount").isJsonNull()) && !jsonObj.get("relatedAccount").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `relatedAccount` to be a primitive type in the JSON string but got `%s`", jsonObj.get("relatedAccount").toString()));
      }
      ...
      if ((jsonObj.get("transactionCode") != null && !jsonObj.get("transactionCode").isJsonNull()) && !jsonObj.get("transactionCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `transactionCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("transactionCode").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SandboxTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SandboxTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SandboxTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SandboxTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<SandboxTransaction>() {
           @Override
           public void write(JsonWriter out, SandboxTransaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SandboxTransaction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SandboxTransaction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SandboxTransaction
   * @throws IOException if the JSON string is invalid with respect to SandboxTransaction
   */
  public static SandboxTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SandboxTransaction.class);
  }

  /**
   * Convert an instance of SandboxTransaction to an JSON string
   *
   * @return JSON string
   */
