...
- API version: v3.1.5
  - Build date: 2024-10-12T11:17:44.973176-04:00[America/New_York]
...
&lt;!-- ReDoc-Inject: &lt;security-definitions&gt; --&gt;
  ...
  For more information, please visit [https://developer.nbg.gr/](https://developer.nbg.gr/)
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:v3.1.5"
  }
```
...
* `target/openapi-java-client-v3.1.5.jar`
* `target/lib/*.jar`
...
------------ | ------------- | ------------- | -------------
*AccountAccessApi* | [**accountAccessConsentsConsentIdDelete**](docs/AccountAccessApi.md#accountAccessConsentsConsentIdDelete) | **DELETE** /account-access-consents/{consentId} | Delete Account Access Consents
*AccountAccessApi* | [**accountAccessConsentsConsentIdGet**](docs/AccountAccessApi.md#accountAccessConsentsConsentIdGet) | **GET** /account-access-consents/{consentId} | Get Account Access Consents
*AccountAccessApi* | [**accountAccessConsentsPost**](docs/AccountAccessApi.md#accountAccessConsentsPost) | **POST** /account-access-consents | Create Account Access Consents
*AccountsApi* | [**accountsAccountIdGet**](docs/AccountsApi.md#accountsAccountIdGet) | **GET** /accounts/{accountId} | Get Accounts
*AccountsApi* | [**accountsGet**](docs/AccountsApi.md#accountsGet) | **GET** /accounts | Get Accounts
*BalancesApi* | [**accountsAccountIdBalancesGet**](docs/BalancesApi.md#accountsAccountIdBalancesGet) | **GET** /accounts/{accountId}/balances | Get Balances
*BeneficiariesApi* | [**accountsAccountIdBeneficiariesGet**](docs/BeneficiariesApi.md#accountsAccountIdBeneficiariesGet) | **GET** /accounts/{accountId}/beneficiaries | Get Beneficiaries
*PartiesApi* | [**accountsAccountIdPartiesGet**](docs/PartiesApi.md#accountsAccountIdPartiesGet) | **GET** /accounts/{accountId}/parties | Get Parties
*PartiesApi* | [**accountsAccountIdPartyGet**](docs/PartiesApi.md#accountsAccountIdPartyGet) | **GET** /accounts/{accountId}/party | Get Party
*PartiesApi* | [**partyGet**](docs/PartiesApi.md#partyGet) | **GET** /party | Get Party
*SandboxApi* | [**sandboxPost**](docs/SandboxApi.md#sandboxPost) | **POST** /sandbox | Create Sandbox
*SandboxApi* | [**sandboxPut**](docs/SandboxApi.md#sandboxPut) | **PUT** /sandbox | Import Sandbox
*SandboxApi* | [**sandboxSandboxIdDelete**](docs/SandboxApi.md#sandboxSandboxIdDelete) | **DELETE** /sandbox/{sandboxId} | Delete Sandbox
*SandboxApi* | [**sandboxSandboxIdGet**](docs/SandboxApi.md#sandboxSandboxIdGet) | **GET** /sandbox/{sandboxId} | Export Sandbox
*ScheduledPaymentsApi* | [**accountsAccountIdScheduledPaymentsGet**](docs/ScheduledPaymentsApi.md#accountsAccountIdScheduledPaymentsGet) | **GET** /accounts/{accountId}/scheduled-payments | Get Scheduled Payments
*StandingOrdersApi* | [**accountsAccountIdStandingOrdersGet**](docs/StandingOrdersApi.md#accountsAccountIdStandingOrdersGet) | **GET** /accounts/{accountId}/standing-orders | Get Standing Orders
*StatementsApi* | [**accountsAccountIdStatementsGet**](docs/StatementsApi.md#accountsAccountIdStatementsGet) | **GET** /accounts/{accountId}/statements | Get Statements
*StatementsApi* | [**accountsAccountIdStatementsStatementIdFileGet**](docs/StatementsApi.md#accountsAccountIdStatementsStatementIdFileGet) | **GET** /accounts/{accountId}/statements/{statementId}/file | Get Statements
*StatementsApi* | [**accountsAccountIdStatementsStatementIdGet**](docs/StatementsApi.md#accountsAccountIdStatementsStatementIdGet) | **GET** /accounts/{accountId}/statements/{statementId} | Get Statements
*TransactionsApi* | [**accountsAccountIdStatementsStatementIdTransactionsGet**](docs/TransactionsApi.md#accountsAccountIdStatementsStatementIdTransactionsGet) | **GET** /accounts/{accountId}/statements/{statementId}/transactions | Get Transactions
*TransactionsApi* | [**accountsAccountIdTransactionsGet**](docs/TransactionsApi.md#accountsAccountIdTransactionsGet) | **GET** /accounts/{accountId}/transactions | Get Transactions
...
## Documentation for Models
 ...
 - [OBBranchAndFinancialInstitutionIdentification5](docs/OBBranchAndFinancialInstitutionIdentification5.md)
 - [OBCashAccount5](docs/OBCashAccount5.md)
 - [OBCashAccount6](docs/OBCashAccount6.md)
 - [OBCashBalance1](docs/OBCashBalance1.md)
 - [OBCreditDebitCode](docs/OBCreditDebitCode.md)
 - [OBCreditLine1](docs/OBCreditLine1.md)
 ...
 - [OBExternalLimitType1Code](docs/OBExternalLimitType1Code.md)
 - [OBExternalPermissions1Code](docs/OBExternalPermissions1Code.md)
 - [OBExternalRequestStatus1Code](docs/OBExternalRequestStatus1Code.md)
 ...
 - [OBReadAccount5](docs/OBReadAccount5.md)
 ...
 - [OBReadData1](docs/OBReadData1.md)
 - [OBReadDataAccount5](docs/OBReadDataAccount5.md)
 - [OBReadDataBalance1](docs/OBReadDataBalance1.md)
 - [OBReadDataBeneficiary5](docs/OBReadDataBeneficiary5.md)
 - [OBReadDataConsentResponse1](docs/OBReadDataConsentResponse1.md)
 - [OBReadDataParty2](docs/OBReadDataParty2.md)
 - [OBReadDataParty3](docs/OBReadDataParty3.md)
 - [OBReadDataScheduledPayment3](docs/OBReadDataScheduledPayment3.md)
 - [OBReadDataStandingOrder5](docs/OBReadDataStandingOrder5.md)
 ...
 - [OBStandingOrder5](docs/OBStandingOrder5.md)
 ...
 - [SandboxBankAccount](docs/SandboxBankAccount.md)
 - [SandboxBankAccountInfo](docs/SandboxBankAccountInfo.md)
 - [SandboxBeneficiary](docs/SandboxBeneficiary.md)
 - [SandboxCard](docs/SandboxCard.md)
 - [SandboxCardInfo](docs/SandboxCardInfo.md)
 - [SandboxParty](docs/SandboxParty.md)
 - [SandboxRequest](docs/SandboxRequest.md)
 - [SandboxRetryCacheEntry](docs/SandboxRetryCacheEntry.md)
 - [SandboxScheduledPayment](docs/SandboxScheduledPayment.md)
 - [SandboxStandingOrder](docs/SandboxStandingOrder.md)
 - [SandboxStatement](docs/SandboxStatement.md)
 - [SandboxTransaction](docs/SandboxTransaction.md)
 - [SandboxUser](docs/SandboxUser.md)
...
<a id="Authorization-Code-Token"></a>
...
- **Scopes**: 
  - accounts offline_access: Production Scope
  - sandbox-uk-account-info-api-v1 offline_access: Sandbox Scope

<a id="Client-Credentials-Token"></a>
...
- **Authorization URL**: 
- **Scopes**: 
  - accounts: Production Scope
  - sandbox-uk-account-info-api-v1: Sandbox Scope
