...
<a id="accountsAccountIdBeneficiariesGet"></a>
# **accountsAccountIdBeneficiariesGet**
> OBReadBeneficiary5 accountsAccountIdBeneficiariesGet(accountId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OBReadBeneficiary5 result = apiInstance.accountsAccountIdBeneficiariesGet(accountId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BeneficiariesApi#accountsAccountIdBeneficiariesGet");
