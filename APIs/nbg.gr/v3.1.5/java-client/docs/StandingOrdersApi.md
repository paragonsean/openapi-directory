...
<a id="accountsAccountIdStandingOrdersGet"></a>
# **accountsAccountIdStandingOrdersGet**
> OBReadStandingOrder6 accountsAccountIdStandingOrdersGet(accountId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent)
...
import org.openapitools.client.api.StandingOrdersApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    StandingOrdersApi apiInstance = new StandingOrdersApi(defaultClient);
    ...
    try {
      OBReadStandingOrder6 result = apiInstance.accountsAccountIdStandingOrdersGet(accountId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StandingOrdersApi#accountsAccountIdStandingOrdersGet");
