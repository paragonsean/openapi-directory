...
|------------- | ------------- | -------------|
| [**accountsAccountIdScheduledPaymentsGet**](ScheduledPaymentsApi.md#accountsAccountIdScheduledPaymentsGet) | **GET** /accounts/{accountId}/scheduled-payments | Get Scheduled Payments |


<a id="accountsAccountIdScheduledPaymentsGet"></a>
# **accountsAccountIdScheduledPaymentsGet**
> OBReadScheduledPayment3 accountsAccountIdScheduledPaymentsGet(accountId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OBReadScheduledPayment3 result = apiInstance.accountsAccountIdScheduledPaymentsGet(accountId, sandboxId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ScheduledPaymentsApi#accountsAccountIdScheduledPaymentsGet");
