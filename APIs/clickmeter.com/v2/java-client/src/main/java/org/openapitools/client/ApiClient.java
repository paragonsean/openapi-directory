...
public class ApiClient {
    ...
    private String basePath = "http://apiv2.clickmeter.com:80";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("header", "X-Clickmeter-AuthKey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://apiv2.clickmeter.com:80
