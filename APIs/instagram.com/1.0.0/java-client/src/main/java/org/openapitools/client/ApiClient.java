...
public class ApiClient {
    ...
    private String basePath = "https://api.instagram.com/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("query", "access_token"));
        authentications.put("instagram_auth", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.instagram.com/v1
