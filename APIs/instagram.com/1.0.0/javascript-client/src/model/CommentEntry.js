...
class CommentEntry {
    ...
    /**
     * Validates the JSON data with respect to <code>CommentEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommentEntry</code>.
     */
 ...
 */
CommentEntry.prototype['created_time'] = undefined;

/**
 * @member {module:model/UserShortInfo} from
 */
CommentEntry.prototype['from'] = undefined;

/**
 * ID of this comment
 * @member {String} id
 */
CommentEntry.prototype['id'] = undefined;

/**
 * Text of the comment
 * @member {String} text
 */
CommentEntry.prototype['text'] = undefined;
