...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InstagramApi.IdPaginationInfo();
  });
  ...
  describe('IdPaginationInfo', function() {
    it('should create an instance of IdPaginationInfo', function() {
      // uncomment below and update the code to test IdPaginationInfo
      //var instance = new InstagramApi.IdPaginationInfo();
      //expect(instance).to.be.a(InstagramApi.IdPaginationInfo);
    });
