...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InstagramApi.UserShortInfo();
  });
  ...
  describe('UserShortInfo', function() {
    it('should create an instance of UserShortInfo', function() {
      // uncomment below and update the code to test UserShortInfo
      //var instance = new InstagramApi.UserShortInfo();
      //expect(instance).to.be.a(InstagramApi.UserShortInfo);
    });
