...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InstagramApi.CursorPaginationInfo();
  });
  ...
  describe('CursorPaginationInfo', function() {
    it('should create an instance of CursorPaginationInfo', function() {
      // uncomment below and update the code to test CursorPaginationInfo
      //var instance = new InstagramApi.CursorPaginationInfo();
      //expect(instance).to.be.a(InstagramApi.CursorPaginationInfo);
    });
