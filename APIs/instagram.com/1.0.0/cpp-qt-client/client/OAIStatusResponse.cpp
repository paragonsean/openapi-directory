...
QString OAIStatusResponse::getData() const {
    return m_data;
}
void OAIStatusResponse::setData(const QString &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIStatusResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIStatusResponse::is_data_Valid() const{
    return m_data_isValid;
}

OAIMetaData OAIStatusResponse::getMeta() const {
    return m_meta;
}
void OAIStatusResponse::setMeta(const OAIMetaData &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIStatusResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIStatusResponse::is_meta_Valid() const{
