...
#ifndef OAIImagesData_H
#define OAIImagesData_H
...
class OAIImagesData : public OAIObject {
public:
    OAIImagesData();
    OAIImagesData(QString json);
    ~OAIImagesData() override;
    ...
    OAIImageInfo getThumbnail() const;
    void setThumbnail(const OAIImageInfo &thumbnail);
...
Q_DECLARE_METATYPE(OpenAPI::OAIImagesData)

#endif // OAIImagesData_H
