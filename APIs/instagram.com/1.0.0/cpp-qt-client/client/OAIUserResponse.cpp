...
OAIUserInfo OAIUserResponse::getData() const {
    return m_data;
}
void OAIUserResponse::setData(const OAIUserInfo &data) {
    m_data = data;
    m_data_isSet = true;
}
...
OAIMetaData OAIUserResponse::getMeta() const {
    return m_meta;
}
void OAIUserResponse::setMeta(const OAIMetaData &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIUserResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIUserResponse::is_meta_Valid() const{
