...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NamSorApiV2.NameMatchedOut();
  });
  ...
  describe('NameMatchedOut', function() {
    it('should create an instance of NameMatchedOut', function() {
      // uncomment below and update the code to test NameMatchedOut
      //var instance = new NamSorApiV2.NameMatchedOut();
      //expect(instance).to.be.a(NamSorApiV2.NameMatchedOut);
    });
