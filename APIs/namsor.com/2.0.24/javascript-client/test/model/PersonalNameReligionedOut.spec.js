...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NamSorApiV2.PersonalNameReligionedOut();
  });
  ...
  describe('PersonalNameReligionedOut', function() {
    it('should create an instance of PersonalNameReligionedOut', function() {
      // uncomment below and update the code to test PersonalNameReligionedOut
      //var instance = new NamSorApiV2.PersonalNameReligionedOut();
      //expect(instance).to.be.a(NamSorApiV2.PersonalNameReligionedOut);
    });
    ...
    it('should have the property religionAlt (base name: "religionAlt")', function() {
      // uncomment below and update the code to test the property religionAlt
      //var instance = new NamSorApiV2.PersonalNameReligionedOut();
      //expect(instance).to.be();
    });

    it('should have the property religionsTop (base name: "religionsTop")', function() {
      // uncomment below and update the code to test the property religionsTop
      //var instance = new NamSorApiV2.PersonalNameReligionedOut();
      //expect(instance).to.be();
    });
