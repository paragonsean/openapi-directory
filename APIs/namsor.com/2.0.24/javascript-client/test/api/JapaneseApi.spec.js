...
(function(root, factory) {
  ...
  describe('JapaneseApi', function() {
    ...
    describe('japaneseNameGenderKanjiCandidatesBatch', function() {
      it('should call japaneseNameGenderKanjiCandidatesBatch successfully', function(done) {
        //uncomment below and update the code to test japaneseNameGenderKanjiCandidatesBatch
        //instance.japaneseNameGenderKanjiCandidatesBatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('japaneseNameKanjiCandidates1', function() {
      it('should call japaneseNameKanjiCandidates1 successfully', function(done) {
        //uncomment below and update the code to test japaneseNameKanjiCandidates1
        //instance.japaneseNameKanjiCandidates1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
