...
let apiInstance = new NamSorApiV2.JapaneseApi();
let japaneseName = "japaneseName_example"; // String | 
apiInstance.genderJapaneseNameFull(japaneseName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.genderJapaneseNameFullBatch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new NamSorApiV2.JapaneseApi();
let japaneseSurname = "japaneseSurname_example"; // String | 
let japaneseGivenName = "japaneseGivenName_example"; // String | 
apiInstance.genderJapaneseNamePinyin(japaneseSurname, japaneseGivenName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.genderJapaneseNamePinyinBatch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.japaneseNameGenderKanjiCandidatesBatch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new NamSorApiV2.JapaneseApi();
let japaneseSurnameLatin = "japaneseSurnameLatin_example"; // String | 
let japaneseGivenNameLatin = "japaneseGivenNameLatin_example"; // String | 
let knownGender = "knownGender_example"; // String | 
apiInstance.japaneseNameKanjiCandidates(japaneseSurnameLatin, japaneseGivenNameLatin, knownGender, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let japaneseSurnameLatin = "japaneseSurnameLatin_example"; // String | 
let japaneseGivenNameLatin = "japaneseGivenNameLatin_example"; // String | 
apiInstance.japaneseNameKanjiCandidates1(japaneseSurnameLatin, japaneseGivenNameLatin, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.japaneseNameKanjiCandidatesBatch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new NamSorApiV2.JapaneseApi();
let japaneseSurnameKanji = "japaneseSurnameKanji_example"; // String | 
let japaneseGivenNameKanji = "japaneseGivenNameKanji_example"; // String | 
apiInstance.japaneseNameLatinCandidates(japaneseSurnameKanji, japaneseGivenNameKanji, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.japaneseNameLatinCandidatesBatch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let japaneseGivenNameLatin = "japaneseGivenNameLatin_example"; // String | 
let japaneseName = "japaneseName_example"; // String | 
apiInstance.japaneseNameMatch(japaneseSurnameLatin, japaneseGivenNameLatin, japaneseName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.japaneseNameMatchBatch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let japaneseGivenNameLatin = "japaneseGivenNameLatin_example"; // String | 
let japaneseName = "japaneseName_example"; // String | 
apiInstance.japaneseNameMatchFeedbackLoop(japaneseSurnameLatin, japaneseGivenNameLatin, japaneseName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new NamSorApiV2.JapaneseApi();
let japaneseName = "japaneseName_example"; // String | 
apiInstance.parseJapaneseName(japaneseName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.parseJapaneseNameBatch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
