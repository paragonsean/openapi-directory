...
class BatchPersonalNameParsedOut {
    ...
    constructor() { 
        ...
        BatchPersonalNameParsedOut.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchPersonalNameParsedOut();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchPersonalNameParsedOut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchPersonalNameParsedOut</code>.
     */
    static validateJSON(data) {
        if (data['personalNames']) { // data not null
            ...
            for (const item of data['personalNames']) {
                PersonalNameParsedOut.validateJSON(item);
            };
        }
 ...
 */
BatchPersonalNameParsedOut.prototype['personalNames'] = undefined;
...
export default BatchPersonalNameParsedOut;
