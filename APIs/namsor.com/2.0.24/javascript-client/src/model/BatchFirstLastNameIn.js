...
class BatchFirstLastNameIn {
    ...
    constructor() { 
        ...
        BatchFirstLastNameIn.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchFirstLastNameIn();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchFirstLastNameIn</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchFirstLastNameIn</code>.
     */
    static validateJSON(data) {
        ...
        if (data['personalNames']) { // data not null
            ...
            for (const item of data['personalNames']) {
                FirstLastNameIn.validateJSON(item);
            };
        }
 ...
 */
BatchFirstLastNameIn.prototype['facts'] = undefined;

/**
 * @member {Array.<module:model/FirstLastNameIn>} personalNames
 */
BatchFirstLastNameIn.prototype['personalNames'] = undefined;
...
export default BatchFirstLastNameIn;
