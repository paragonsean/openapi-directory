...
class BatchProperNounCategorizedOut {
    ...
    constructor() { 
        ...
        BatchProperNounCategorizedOut.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchProperNounCategorizedOut();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchProperNounCategorizedOut</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchProperNounCategorizedOut</code>.
     */
    static validateJSON(data) {
        if (data['properNouns']) { // data not null
            ...
            for (const item of data['properNouns']) {
                ProperNounCategorizedOut.validateJSON(item);
            };
        }
 ...
 */
BatchProperNounCategorizedOut.prototype['properNouns'] = undefined;
...
export default BatchProperNounCategorizedOut;
