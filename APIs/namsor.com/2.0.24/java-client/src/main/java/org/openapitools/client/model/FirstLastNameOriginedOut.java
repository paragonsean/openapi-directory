...
public class FirstLastNameOriginedOut {
  ...
  private List<String> countriesOriginTop = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.countriesOriginTop, firstLastNameOriginedOut.countriesOriginTop) &&
        ...
        Objects.equals(this.script, firstLastNameOriginedOut.script) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(countriesOriginTop, countryOrigin, countryOriginAlt, firstName, id, lastName, probabilityAltCalibrated, probabilityCalibrated, regionOrigin, score, script, subRegionOrigin, topRegionOrigin);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirstLastNameOriginedOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirstLastNameOriginedOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirstLastNameOriginedOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirstLastNameOriginedOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("countriesOriginTop") != null && !jsonObj.get("countriesOriginTop").isJsonNull() && !jsonObj.get("countriesOriginTop").isJsonArray()) {
