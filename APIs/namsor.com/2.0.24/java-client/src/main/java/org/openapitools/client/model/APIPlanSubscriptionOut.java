...
public class APIPlanSubscriptionOut {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiKey, currency, currencyFactor, planBaseFeesKey, planEnded, planName, planQuota, planStarted, planStatus, price, priceOverage, priceOverageUSD, priceUSD, priorPlanStarted, stripeCustomerId, stripeStatus, stripeSubscription, taxRate, userId);
  }
