...
public class RegionISO {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.countryFIPS, regionISO.countryFIPS) &&
        Objects.equals(this.countryISO2, regionISO.countryISO2) &&
        Objects.equals(this.countryISO3, regionISO.countryISO3) &&
        Objects.equals(this.countryName, regionISO.countryName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(countryFIPS, countryISO2, countryISO3, countryName, countryNumCode, region, subregion, topregion);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegionISO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegionISO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegionISO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegionISO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
