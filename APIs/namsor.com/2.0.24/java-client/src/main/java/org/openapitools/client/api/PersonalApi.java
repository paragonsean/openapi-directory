...
import org.openapitools.client.model.BatchCorridorIn;
import org.openapitools.client.model.BatchCorridorOut;
import org.openapitools.client.model.BatchFirstLastNameDiasporaedOut;
import org.openapitools.client.model.BatchFirstLastNameGenderedOut;
import org.openapitools.client.model.BatchFirstLastNameGeoIn;
import org.openapitools.client.model.BatchFirstLastNameGeoSubclassificationOut;
import org.openapitools.client.model.BatchFirstLastNameGeoZippedIn;
import org.openapitools.client.model.BatchFirstLastNameIn;
import org.openapitools.client.model.BatchFirstLastNameOriginedOut;
import org.openapitools.client.model.BatchFirstLastNameUSRaceEthnicityOut;
import org.openapitools.client.model.BatchPersonalNameGenderedOut;
import org.openapitools.client.model.BatchPersonalNameGeoIn;
import org.openapitools.client.model.BatchPersonalNameGeoOut;
import org.openapitools.client.model.BatchPersonalNameGeoSubclassificationOut;
import org.openapitools.client.model.BatchPersonalNameGeoSubdivisionIn;
import org.openapitools.client.model.BatchPersonalNameIn;
import org.openapitools.client.model.BatchPersonalNameParsedOut;
import org.openapitools.client.model.BatchPersonalNameReligionedOut;
import org.openapitools.client.model.CorridorOut;
...
import org.openapitools.client.model.FirstLastNameGeoSubclassificationOut;
import org.openapitools.client.model.FirstLastNameOriginedOut;
import org.openapitools.client.model.FirstLastNameUSRaceEthnicityOut;
import org.openapitools.client.model.PersonalNameGenderedOut;
import org.openapitools.client.model.PersonalNameGeoOut;
...
public class PersonalApi {
     ...
     */
    public okhttp3.Call genderCall(String firstName, String lastName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call genderValidateBeforeCall(String firstName, String lastName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'firstName' is set
        if (firstName == null) {
        ...
        return genderCall(firstName, lastName, _callback);
    ...
    public FirstLastNameGenderedOut gender(String firstName, String lastName) throws ApiException {
        ApiResponse<FirstLastNameGenderedOut> localVarResp = genderWithHttpInfo(firstName, lastName);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<FirstLastNameGenderedOut> genderWithHttpInfo(String firstName, String lastName) throws ApiException {
        okhttp3.Call localVarCall = genderValidateBeforeCall(firstName, lastName, null);
     ...
     */
    public okhttp3.Call genderAsync(String firstName, String lastName, final ApiCallback<FirstLastNameGenderedOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = genderValidateBeforeCall(firstName, lastName, _callback);
        Type localVarReturnType = new TypeToken<FirstLastNameGenderedOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call gender1Call(String firstName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call gender1ValidateBeforeCall(String firstName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'firstName' is set
        if (firstName == null) {
            throw new ApiException("Missing the required parameter 'firstName' when calling gender1(Async)");
        }

        return gender1Call(firstName, _callback);
     ...
     */
    public FirstLastNameGenderedOut gender1(String firstName) throws ApiException {
        ApiResponse<FirstLastNameGenderedOut> localVarResp = gender1WithHttpInfo(firstName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FirstLastNameGenderedOut> gender1WithHttpInfo(String firstName) throws ApiException {
        okhttp3.Call localVarCall = gender1ValidateBeforeCall(firstName, null);
        Type localVarReturnType = new TypeToken<FirstLastNameGenderedOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call gender1Async(String firstName, final ApiCallback<FirstLastNameGenderedOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = gender1ValidateBeforeCall(firstName, _callback);
        Type localVarReturnType = new TypeToken<FirstLastNameGenderedOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
