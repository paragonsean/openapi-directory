...
import org.openapitools.client.model.BatchFirstLastNameGenderIn;
import org.openapitools.client.model.BatchFirstLastNameGenderedOut;
import org.openapitools.client.model.BatchFirstLastNameIn;
import org.openapitools.client.model.BatchMatchPersonalFirstLastNameIn;
import org.openapitools.client.model.BatchNameMatchCandidatesOut;
import org.openapitools.client.model.BatchNameMatchedOut;
import org.openapitools.client.model.BatchPersonalNameGenderedOut;
import org.openapitools.client.model.BatchPersonalNameIn;
import org.openapitools.client.model.BatchPersonalNameParsedOut;
import org.openapitools.client.model.FeedbackLoopOut;
import org.openapitools.client.model.FirstLastNameGenderedOut;
import org.openapitools.client.model.NameMatchCandidatesOut;
import org.openapitools.client.model.NameMatchedOut;
import org.openapitools.client.model.PersonalNameGenderedOut;
...
public class JapaneseApi {
     ...
     */
    public okhttp3.Call japaneseNameKanjiCandidatesCall(String japaneseSurnameLatin, String japaneseGivenNameLatin, String knownGender, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call japaneseNameKanjiCandidatesValidateBeforeCall(String japaneseSurnameLatin, String japaneseGivenNameLatin, String knownGender, final ApiCallback _callback) throws ApiException {
        ...
        if (knownGender == null) {
            throw new ApiException("Missing the required parameter 'knownGender' when calling japaneseNameKanjiCandidates(Async)");
        }

        return japaneseNameKanjiCandidatesCall(japaneseSurnameLatin, japaneseGivenNameLatin, knownGender, _callback);
     ...
     */
    public NameMatchCandidatesOut japaneseNameKanjiCandidates(String japaneseSurnameLatin, String japaneseGivenNameLatin, String knownGender) throws ApiException {
        ApiResponse<NameMatchCandidatesOut> localVarResp = japaneseNameKanjiCandidatesWithHttpInfo(japaneseSurnameLatin, japaneseGivenNameLatin, knownGender);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NameMatchCandidatesOut> japaneseNameKanjiCandidatesWithHttpInfo(String japaneseSurnameLatin, String japaneseGivenNameLatin, String knownGender) throws ApiException {
        okhttp3.Call localVarCall = japaneseNameKanjiCandidatesValidateBeforeCall(japaneseSurnameLatin, japaneseGivenNameLatin, knownGender, null);
     ...
     */
    public okhttp3.Call japaneseNameKanjiCandidatesAsync(String japaneseSurnameLatin, String japaneseGivenNameLatin, String knownGender, final ApiCallback<NameMatchCandidatesOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = japaneseNameKanjiCandidatesValidateBeforeCall(japaneseSurnameLatin, japaneseGivenNameLatin, knownGender, _callback);
        Type localVarReturnType = new TypeToken<NameMatchCandidatesOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call japaneseNameKanjiCandidates1Call(String japaneseSurnameLatin, String japaneseGivenNameLatin, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call japaneseNameKanjiCandidates1ValidateBeforeCall(String japaneseSurnameLatin, String japaneseGivenNameLatin, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'japaneseSurnameLatin' is set
        if (japaneseSurnameLatin == null) {
        ...
        return japaneseNameKanjiCandidates1Call(japaneseSurnameLatin, japaneseGivenNameLatin, _callback);
     ...
     */
    public NameMatchCandidatesOut japaneseNameKanjiCandidates1(String japaneseSurnameLatin, String japaneseGivenNameLatin) throws ApiException {
        ApiResponse<NameMatchCandidatesOut> localVarResp = japaneseNameKanjiCandidates1WithHttpInfo(japaneseSurnameLatin, japaneseGivenNameLatin);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NameMatchCandidatesOut> japaneseNameKanjiCandidates1WithHttpInfo(String japaneseSurnameLatin, String japaneseGivenNameLatin) throws ApiException {
        okhttp3.Call localVarCall = japaneseNameKanjiCandidates1ValidateBeforeCall(japaneseSurnameLatin, japaneseGivenNameLatin, null);
        Type localVarReturnType = new TypeToken<NameMatchCandidatesOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call japaneseNameKanjiCandidates1Async(String japaneseSurnameLatin, String japaneseGivenNameLatin, final ApiCallback<NameMatchCandidatesOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = japaneseNameKanjiCandidates1ValidateBeforeCall(japaneseSurnameLatin, japaneseGivenNameLatin, _callback);
        Type localVarReturnType = new TypeToken<NameMatchCandidatesOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
