...
public class PersonalNameGenderedOut {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.genderScale, personalNameGenderedOut.genderScale) &&
        ...
        Objects.equals(this.script, personalNameGenderedOut.script);
  }

  @Override
  public int hashCode() {
    return Objects.hash(genderScale, id, likelyGender, name, probabilityCalibrated, score, script);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonalNameGenderedOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonalNameGenderedOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonalNameGenderedOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonalNameGenderedOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
