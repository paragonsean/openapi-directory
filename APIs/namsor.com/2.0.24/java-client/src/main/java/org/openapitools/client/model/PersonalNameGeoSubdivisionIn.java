...
public class PersonalNameGeoSubdivisionIn {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.countryIso2, personalNameGeoSubdivisionIn.countryIso2) &&
        Objects.equals(this.id, personalNameGeoSubdivisionIn.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(countryIso2, id, name, subdivisionIso);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonalNameGeoSubdivisionIn
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonalNameGeoSubdivisionIn.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonalNameGeoSubdivisionIn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonalNameGeoSubdivisionIn` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
