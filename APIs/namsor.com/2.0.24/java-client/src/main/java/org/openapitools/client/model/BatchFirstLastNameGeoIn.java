...
import org.openapitools.client.model.FirstLastNameGeoIn;
...
public class BatchFirstLastNameGeoIn {
  ...
  private List<FirstLastNameGeoIn> personalNames = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.facts, batchFirstLastNameGeoIn.facts) &&
        Objects.equals(this.personalNames, batchFirstLastNameGeoIn.personalNames);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchFirstLastNameGeoIn
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchFirstLastNameGeoIn.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchFirstLastNameGeoIn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchFirstLastNameGeoIn` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("personalNames") != null && !jsonObj.get("personalNames").isJsonNull()) {
        ...
        if (jsonArraypersonalNames != null) {
          ...
          for (int i = 0; i < jsonArraypersonalNames.size(); i++) {
            FirstLastNameGeoIn.validateJsonElement(jsonArraypersonalNames.get(i));
          };
        }
      }
  }
