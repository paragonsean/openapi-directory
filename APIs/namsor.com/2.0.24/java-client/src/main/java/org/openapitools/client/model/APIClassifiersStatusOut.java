...
import org.openapitools.client.model.APIClassifierOut;
import org.openapitools.client.model.SoftwareVersionOut;
...
public class APIClassifiersStatusOut {
  ...
  private List<APIClassifierOut> classifiers = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.classifiers, apIClassifiersStatusOut.classifiers) &&
        Objects.equals(this.softwareVersion, apIClassifiersStatusOut.softwareVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(classifiers, softwareVersion);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to APIClassifiersStatusOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APIClassifiersStatusOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APIClassifiersStatusOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `APIClassifiersStatusOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("classifiers") != null && !jsonObj.get("classifiers").isJsonNull()) {
        ...
        if (jsonArrayclassifiers != null) {
          ...
          for (int i = 0; i < jsonArrayclassifiers.size(); i++) {
            APIClassifierOut.validateJsonElement(jsonArrayclassifiers.get(i));
          };
        }
      }
      // validate the optional field `softwareVersion`
      if (jsonObj.get("softwareVersion") != null && !jsonObj.get("softwareVersion").isJsonNull()) {
        SoftwareVersionOut.validateJsonElement(jsonObj.get("softwareVersion"));
      }
  }
