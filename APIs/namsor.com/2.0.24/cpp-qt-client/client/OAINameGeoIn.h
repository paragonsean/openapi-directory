...
#ifndef OAINameGeoIn_H
#define OAINameGeoIn_H
...
class OAINameGeoIn : public OAIObject {
public:
    OAINameGeoIn();
    OAINameGeoIn(QString json);
    ~OAINameGeoIn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINameGeoIn)

#endif // OAINameGeoIn_H
