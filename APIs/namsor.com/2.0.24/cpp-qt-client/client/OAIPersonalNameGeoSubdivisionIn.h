...
/*
 * OAIPersonalNameGeoSubdivisionIn.h
 *
 * 
 */

#ifndef OAIPersonalNameGeoSubdivisionIn_H
#define OAIPersonalNameGeoSubdivisionIn_H
...
class OAIPersonalNameGeoSubdivisionIn : public OAIObject {
public:
    OAIPersonalNameGeoSubdivisionIn();
    OAIPersonalNameGeoSubdivisionIn(QString json);
    ~OAIPersonalNameGeoSubdivisionIn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonalNameGeoSubdivisionIn)

#endif // OAIPersonalNameGeoSubdivisionIn_H
