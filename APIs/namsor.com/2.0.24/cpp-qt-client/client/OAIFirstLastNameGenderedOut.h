...
/*
 * OAIFirstLastNameGenderedOut.h
 *
 * Represents the output of inferring the LIKELY gender from a personal name.
 */

#ifndef OAIFirstLastNameGenderedOut_H
#define OAIFirstLastNameGenderedOut_H
...
class OAIFirstLastNameGenderedOut : public OAIObject {
public:
    OAIFirstLastNameGenderedOut();
    OAIFirstLastNameGenderedOut(QString json);
    ~OAIFirstLastNameGenderedOut() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirstLastNameGenderedOut)

#endif // OAIFirstLastNameGenderedOut_H
