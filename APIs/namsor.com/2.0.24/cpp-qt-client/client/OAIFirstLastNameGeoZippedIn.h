...
/*
 * OAIFirstLastNameGeoZippedIn.h
 *
 * 
 */

#ifndef OAIFirstLastNameGeoZippedIn_H
#define OAIFirstLastNameGeoZippedIn_H
...
class OAIFirstLastNameGeoZippedIn : public OAIObject {
public:
    OAIFirstLastNameGeoZippedIn();
    OAIFirstLastNameGeoZippedIn(QString json);
    ~OAIFirstLastNameGeoZippedIn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFirstLastNameGeoZippedIn)

#endif // OAIFirstLastNameGeoZippedIn_H
