...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://airport-web.appspot.com/_ah/api"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("airportApiGetAirport", defaultConf);
    _serverIndices.insert("airportApiGetAirport", 0);
}
...
void OAIDefaultApi::airportApiGetAirport(const QString &icao_code) {
    QString fullPath = QString(_serverConfigs["airportApiGetAirport"][_serverIndices.value("airportApiGetAirport")].URL()+"/airportsapi/v1/airports/{icao_code}");
    
    
    {
        QString icao_codePathParam("{");
        icao_codePathParam.append("icao_code").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "icao_code", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"icao_code"+pathSuffix : pathPrefix;
        fullPath.replace(icao_codePathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(icao_code)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::airportApiGetAirportCallback);
...
void OAIDefaultApi::airportApiGetAirportCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIApiEndpointsAirportResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT airportApiGetAirportSignal(output);
        Q_EMIT airportApiGetAirportSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT airportApiGetAirportSignalE(output, error_type, error_str);
        Q_EMIT airportApiGetAirportSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT airportApiGetAirportSignalError(output, error_type, error_str);
        Q_EMIT airportApiGetAirportSignalErrorFull(worker, error_type, error_str);
    }
}
