...
|**beforeScripts** | **List&lt;String&gt;** | A list of pre-request scripts to run before this request. |  [optional] |
...
|**scripts** | **List&lt;String&gt;** | A list of post-response scripts to run after this request. |  [optional] |
