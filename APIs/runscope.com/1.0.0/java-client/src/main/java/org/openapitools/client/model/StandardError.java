...
public class StandardError {
  ...
  public StandardError data(Object data) {
    this.data = data;
    return this;
  }
  ...
  public StandardError error(Error400 error) {
    this.error = error;
    return this;
  }
  ...
  public void setError(Error400 error) {
    this.error = error;
  }


  public StandardError meta(Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, standardError.data) &&
        Objects.equals(this.error, standardError.error) &&
        Objects.equals(this.meta, standardError.meta);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, error, meta);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        Error400.validateJsonElement(jsonObj.get("error"));
      }
