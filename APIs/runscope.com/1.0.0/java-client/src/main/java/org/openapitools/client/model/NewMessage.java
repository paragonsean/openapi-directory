...
public class NewMessage {
  ...
  private NewMessageResponse response;

  public NewMessage() {
  }

  public NewMessage request(NewMessageRequest request) {
  ...
  public NewMessageRequest getRequest() {
    return request;
  }

  public void setRequest(NewMessageRequest request) {
    this.request = request;
  }


  public NewMessage response(NewMessageResponse response) {
   ...
   */
  @javax.annotation.Nullable
  public NewMessageResponse getResponse() {
    return response;
  }

  public void setResponse(NewMessageResponse response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.request, newMessage.request) &&
        Objects.equals(this.response, newMessage.response);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("request") != null && !jsonObj.get("request").isJsonNull()) {
        NewMessageRequest.validateJsonElement(jsonObj.get("request"));
      }
      // validate the optional field `response`
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        NewMessageResponse.validateJsonElement(jsonObj.get("response"));
      }
  }
