# RunscopeApi.NewMessageResponse
...
**responseTime** | **Number** | Length of time it took to receive the response, in seconds. | [optional] 
**status** | **Number** | HTTP status code returned in the response. | [optional] 
