...
public class ApiClient {
    ...
    private String basePath = "https://circleci.com/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("apikey", new ApiKeyAuth("query", "circle-token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://circleci.com/api/v1
