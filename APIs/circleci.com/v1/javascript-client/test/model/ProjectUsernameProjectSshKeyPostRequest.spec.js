...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CircleCiRestApi.ProjectUsernameProjectSshKeyPostRequest();
  });
  ...
  describe('ProjectUsernameProjectSshKeyPostRequest', function() {
    it('should create an instance of ProjectUsernameProjectSshKeyPostRequest', function() {
      // uncomment below and update the code to test ProjectUsernameProjectSshKeyPostRequest
      //var instance = new CircleCiRestApi.ProjectUsernameProjectSshKeyPostRequest();
      //expect(instance).to.be.a(CircleCiRestApi.ProjectUsernameProjectSshKeyPostRequest);
    });
