...
/*
 * OAI_project__username___project__post_request.h
 *
 * 
 */

#ifndef OAI_project__username___project__post_request_H
#define OAI_project__username___project__post_request_H
...
class OAI_project__username___project__post_request : public OAIObject {
public:
    OAI_project__username___project__post_request();
    OAI_project__username___project__post_request(QString json);
    ~OAI_project__username___project__post_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_project__username___project__post_request)

#endif // OAI_project__username___project__post_request_H
