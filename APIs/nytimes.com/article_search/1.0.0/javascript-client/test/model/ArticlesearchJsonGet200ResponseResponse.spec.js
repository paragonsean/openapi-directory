...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArticleSearchApi.ArticlesearchJsonGet200ResponseResponse();
  });
  ...
  describe('ArticlesearchJsonGet200ResponseResponse', function() {
    it('should create an instance of ArticlesearchJsonGet200ResponseResponse', function() {
      // uncomment below and update the code to test ArticlesearchJsonGet200ResponseResponse
      //var instance = new ArticleSearchApi.ArticlesearchJsonGet200ResponseResponse();
      //expect(instance).to.be.a(ArticleSearchApi.ArticlesearchJsonGet200ResponseResponse);
    });
