...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArticleSearchApi.DocMultimediaInner();
  });
  ...
  describe('DocMultimediaInner', function() {
    it('should create an instance of DocMultimediaInner', function() {
      ...
      //var instance = new ArticleSearchApi.DocMultimediaInner();
      //expect(instance).to.be.a(ArticleSearchApi.DocMultimediaInner);
    });
