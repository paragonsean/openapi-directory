...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArticleSearchApi.ArticlesearchJsonGet200Response();
  });
  ...
  describe('ArticlesearchJsonGet200Response', function() {
    it('should create an instance of ArticlesearchJsonGet200Response', function() {
      // uncomment below and update the code to test ArticlesearchJsonGet200Response
      //var instance = new ArticleSearchApi.ArticlesearchJsonGet200Response();
      //expect(instance).to.be.a(ArticleSearchApi.ArticlesearchJsonGet200Response);
    });
