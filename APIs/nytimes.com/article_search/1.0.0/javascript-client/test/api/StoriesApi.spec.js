...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArticleSearchApi.StoriesApi();
  });
  ...
  describe('StoriesApi', function() {
    describe('articlesearchJsonGet', function() {
      it('should call articlesearchJsonGet successfully', function(done) {
        //uncomment below and update the code to test articlesearchJsonGet
        //instance.articlesearchJsonGet(function(error) {
