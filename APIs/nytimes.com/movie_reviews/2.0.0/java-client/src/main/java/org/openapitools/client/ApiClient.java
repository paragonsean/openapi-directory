...
public class ApiClient {
    ...
    private String basePath = "http://api.nytimes.com/svc/movies/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("apikey", new ApiKeyAuth("query", "api-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.nytimes.com/svc/movies/v2
