...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommunityApi.GETUserContentByDateJson200ResponseResultsCommentsInner();
  });
  ...
  describe('GETUserContentByDateJson200ResponseResultsCommentsInner', function() {
    it('should create an instance of GETUserContentByDateJson200ResponseResultsCommentsInner', function() {
      // uncomment below and update the code to test GETUserContentByDateJson200ResponseResultsCommentsInner
      //var instance = new CommunityApi.GETUserContentByDateJson200ResponseResultsCommentsInner();
      //expect(instance).to.be.a(CommunityApi.GETUserContentByDateJson200ResponseResultsCommentsInner);
    });
    ...
    it('should have the property recommendationCount (base name: "recommendationCount")', function() {
    ...
    it('should have the property rgt (base name: "rgt")', function() {
      // uncomment below and update the code to test the property rgt
      //var instance = new CommunityApi.GETUserContentByDateJson200ResponseResultsCommentsInner();
      //expect(instance).to.be();
    });
