...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommunityApi.GETUserContentRecentJson200ResponseResultsCommentsInner();
  });
  ...
  describe('GETUserContentRecentJson200ResponseResultsCommentsInner', function() {
    it('should create an instance of GETUserContentRecentJson200ResponseResultsCommentsInner', function() {
      // uncomment below and update the code to test GETUserContentRecentJson200ResponseResultsCommentsInner
      //var instance = new CommunityApi.GETUserContentRecentJson200ResponseResultsCommentsInner();
      //expect(instance).to.be.a(CommunityApi.GETUserContentRecentJson200ResponseResultsCommentsInner);
    });
