...
class Article {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('blog_name')) {
                obj['blog_name'] = ApiClient.convertToType(data['blog_name'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['blog_name'] && !(typeof data['blog_name'] === 'string' || data['blog_name'] instanceof String)) {
            throw new Error("Expected the field `blog_name` to be a primitive type in the JSON string but got " + data['blog_name']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['org_facet'] && !(typeof data['org_facet'] === 'string' || data['org_facet'] instanceof String)) {
            throw new Error("Expected the field `org_facet` to be a primitive type in the JSON string but got " + data['org_facet']);
        }
        // ensure the json data is an array
...
/**
 * @member {String} blog_name
 */
Article.prototype['blog_name'] = undefined;
 ...
 */
Article.prototype['headline'] = undefined;
