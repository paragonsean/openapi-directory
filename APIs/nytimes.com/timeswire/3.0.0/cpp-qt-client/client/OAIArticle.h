...
public:
    ...
    void setBlogName(const QString &blog_name);
    bool is_blog_name_Set() const;
    bool is_blog_name_Valid() const;
    ...
    QString getOrgFacet() const;
    void setOrgFacet(const QString &org_facet);
...
private:
    ...
    QString m_blog_name;
    bool m_blog_name_isSet;
    bool m_blog_name_isValid;
