...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::contentJsonGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::contentJsonGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString url = create(); // QString | The complete URL of a specific news item, URL-encoded or backslash-escaped
      apiInstance.contentJsonGet(url);
