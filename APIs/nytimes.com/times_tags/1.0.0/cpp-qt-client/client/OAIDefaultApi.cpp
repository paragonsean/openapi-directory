...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://api.nytimes.com/svc/suggest/v1"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://api.nytimes.com/svc/suggest/v1"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("timestagsGet", defaultConf);
    _serverIndices.insert("timestagsGet", 0);
}
...
void OAIDefaultApi::timestagsGet(const QString &query, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &max) {
    QString fullPath = QString(_serverConfigs["timestagsGet"][_serverIndices.value("timestagsGet")].URL()+"/timestags");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::timestagsGetCallback);
...
void OAIDefaultApi::timestagsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT timestagsGetSignal(output);
        Q_EMIT timestagsGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT timestagsGetSignalE(output, error_type, error_str);
        Q_EMIT timestagsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT timestagsGetSignalError(output, error_type, error_str);
        Q_EMIT timestagsGetSignalErrorFull(worker, error_type, error_str);
    }
}
