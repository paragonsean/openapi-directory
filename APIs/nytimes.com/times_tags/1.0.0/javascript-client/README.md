...
TimesTagsApi - JavaScript client for times_tags_api
...
```shell
npm install times_tags_api --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your times_tags_api from, and run:
...
```javascript
var TimesTagsApi = require('times_tags_api');

var defaultClient = TimesTagsApi.ApiClient.instance;
...
var api = new TimesTagsApi.DefaultApi()
var query = "query_example"; // {String} Your search query
var opts = {
...
api.timestagsGet(query, opts, callback);
...
------------ | ------------- | ------------- | -------------
*TimesTagsApi.DefaultApi* | [**timestagsGet**](docs/DefaultApi.md#timestagsGet) | **GET** /timestags | 
