...
/*
 * OAI_search_json_get_200_response.h
 *
 * 
 */

#ifndef OAI_search_json_get_200_response_H
#define OAI_search_json_get_200_response_H
...
class OAI_search_json_get_200_response : public OAIObject {
public:
    OAI_search_json_get_200_response();
    OAI_search_json_get_200_response(QString json);
    ~OAI_search_json_get_200_response() override;
    ...
    QList<OAIConceptRelation> getResults() const;
    void setResults(const QList<OAIConceptRelation> &results);
...
private:
    ...
    QList<OAIConceptRelation> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_search_json_get_200_response)

#endif // OAI_search_json_get_200_response_H
