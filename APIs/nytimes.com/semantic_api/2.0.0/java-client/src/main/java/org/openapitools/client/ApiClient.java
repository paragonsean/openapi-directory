...
public class ApiClient {
    ...
    private String basePath = "http://api.nytimes.com/svc/semantic/v2/concept";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.nytimes.com/svc/semantic/v2/concept
