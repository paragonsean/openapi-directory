...
class Article(Model):
    ...
    def __init__(self, abstract: str=None, byline: str=None, created_date: str=None, des_facet: List[str]=None, geo_facet: List[str]=None, item_type: str=None, kicker: str=None, material_type_facet: str=None, multimedia: List[ArticleMultimediaInner]=None, org_facet: List[str]=None, per_facet: List[str]=None, published_date: str=None, related_urls: List[ArticleRelatedUrlsInner]=None, section: str=None, short_url: str=None, subsection: str=None, thumbnail_standard: str=None, title: str=None, updated_date: str=None, url: str=None):
