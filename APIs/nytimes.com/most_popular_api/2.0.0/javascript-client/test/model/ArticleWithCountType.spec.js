...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MostPopularApi.ArticleWithCountType();
  });
  ...
  describe('ArticleWithCountType', function() {
    it('should create an instance of ArticleWithCountType', function() {
      // uncomment below and update the code to test ArticleWithCountType
      //var instance = new MostPopularApi.ArticleWithCountType();
      //expect(instance).to.be.a(MostPopularApi.ArticleWithCountType);
    });
    ...
    it('should have the property countType (base name: "count_type")', function() {
