...
public class ApiClient {
    ...
    private String basePath = "http://superset.apache.local";
    ...
    public ApiClient() {
        ...
        authentications.put("jwt_refresh", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://superset.apache.local
