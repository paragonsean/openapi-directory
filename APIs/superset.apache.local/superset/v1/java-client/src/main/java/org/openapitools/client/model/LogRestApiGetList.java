...
import org.openapitools.client.model.Meta42;
...
public class LogRestApiGetList {
  ...
  public LogRestApiGetList user(Meta42 user) {
    this.user = user;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Meta42 getUser() {
    return user;
  }

  public void setUser(Meta42 user) {
    this.user = user;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogRestApiGetList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogRestApiGetList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LogRestApiGetList is not found in the empty JSON string", LogRestApiGetList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogRestApiGetList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogRestApiGetList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("user") != null && !jsonObj.get("user").isJsonNull()) {
        Meta42.validateJsonElement(jsonObj.get("user"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogRestApiGetList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogRestApiGetList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogRestApiGetList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogRestApiGetList.class));

       return (TypeAdapter<T>) new TypeAdapter<LogRestApiGetList>() {
           @Override
           public void write(JsonWriter out, LogRestApiGetList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogRestApiGetList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogRestApiGetList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogRestApiGetList
   * @throws IOException if the JSON string is invalid with respect to LogRestApiGetList
   */
  public static LogRestApiGetList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogRestApiGetList.class);
  }

  /**
   * Convert an instance of LogRestApiGetList to an JSON string
   *
   * @return JSON string
   */
