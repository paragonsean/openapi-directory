...
import org.openapitools.client.model.SavedQueryRestApiGet;
...
public class SavedQueryPkGet200Response {
  ...
  public SavedQueryPkGet200Response() {
  }

  public SavedQueryPkGet200Response descriptionColumns(AnnotationLayerGet200ResponseDescriptionColumns descriptionColumns) {
  ...
  public SavedQueryPkGet200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SavedQueryPkGet200Response labelColumns(AnnotationLayerGet200ResponseLabelColumns labelColumns) {
  ...
  public SavedQueryPkGet200Response result(SavedQueryRestApiGet result) {
    this.result = result;
    return this;
  }
  ...
  public SavedQueryPkGet200Response showColumns(List<String> showColumns) {
    this.showColumns = showColumns;
    return this;
  }

  public SavedQueryPkGet200Response addShowColumnsItem(String showColumnsItem) {
  ...
  public SavedQueryPkGet200Response showTitle(String showTitle) {
  ...
  public boolean equals(Object o) {
    ...
    SavedQueryPkGet200Response savedQueryPkGet200Response = (SavedQueryPkGet200Response) o;
    return Objects.equals(this.descriptionColumns, savedQueryPkGet200Response.descriptionColumns) &&
        Objects.equals(this.id, savedQueryPkGet200Response.id) &&
        Objects.equals(this.labelColumns, savedQueryPkGet200Response.labelColumns) &&
        Objects.equals(this.result, savedQueryPkGet200Response.result) &&
        Objects.equals(this.showColumns, savedQueryPkGet200Response.showColumns) &&
        Objects.equals(this.showTitle, savedQueryPkGet200Response.showTitle);
  }
  ...
  public String toString() {
    ...
    sb.append("class SavedQueryPkGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SavedQueryPkGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SavedQueryPkGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SavedQueryPkGet200Response is not found in the empty JSON string", SavedQueryPkGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SavedQueryPkGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SavedQueryPkGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        SavedQueryRestApiGet.validateJsonElement(jsonObj.get("result"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SavedQueryPkGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SavedQueryPkGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SavedQueryPkGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SavedQueryPkGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<SavedQueryPkGet200Response>() {
           @Override
           public void write(JsonWriter out, SavedQueryPkGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SavedQueryPkGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SavedQueryPkGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SavedQueryPkGet200Response
   * @throws IOException if the JSON string is invalid with respect to SavedQueryPkGet200Response
   */
  public static SavedQueryPkGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SavedQueryPkGet200Response.class);
  }

  /**
   * Convert an instance of SavedQueryPkGet200Response to an JSON string
   *
   * @return JSON string
   */
