...
OAIDatabaseRestApi_put::OAIDatabaseRestApi_put(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseRestApi_put::OAIDatabaseRestApi_put() {
    this->initializeModel();
}

OAIDatabaseRestApi_put::~OAIDatabaseRestApi_put() {}

void OAIDatabaseRestApi_put::initializeModel() {
...
void OAIDatabaseRestApi_put::fromJson(QString jsonString) {
...
void OAIDatabaseRestApi_put::fromJsonObject(QJsonObject json) {
...
QString OAIDatabaseRestApi_put::asJson() const {
...
QJsonObject OAIDatabaseRestApi_put::asJsonObject() const {
    QJsonObject obj;
...
bool OAIDatabaseRestApi_put::isAllowCsvUpload() const {
    return m_allow_csv_upload;
}
void OAIDatabaseRestApi_put::setAllowCsvUpload(const bool &allow_csv_upload) {
    m_allow_csv_upload = allow_csv_upload;
    m_allow_csv_upload_isSet = true;
}

bool OAIDatabaseRestApi_put::is_allow_csv_upload_Set() const{
    return m_allow_csv_upload_isSet;
}

bool OAIDatabaseRestApi_put::is_allow_csv_upload_Valid() const{
    return m_allow_csv_upload_isValid;
}

bool OAIDatabaseRestApi_put::isAllowCtas() const {
    return m_allow_ctas;
}
void OAIDatabaseRestApi_put::setAllowCtas(const bool &allow_ctas) {
    m_allow_ctas = allow_ctas;
    m_allow_ctas_isSet = true;
}

bool OAIDatabaseRestApi_put::is_allow_ctas_Set() const{
    return m_allow_ctas_isSet;
}

bool OAIDatabaseRestApi_put::is_allow_ctas_Valid() const{
    return m_allow_ctas_isValid;
}

bool OAIDatabaseRestApi_put::isAllowCvas() const {
    return m_allow_cvas;
}
void OAIDatabaseRestApi_put::setAllowCvas(const bool &allow_cvas) {
    m_allow_cvas = allow_cvas;
    m_allow_cvas_isSet = true;
}

bool OAIDatabaseRestApi_put::is_allow_cvas_Set() const{
    return m_allow_cvas_isSet;
}

bool OAIDatabaseRestApi_put::is_allow_cvas_Valid() const{
    return m_allow_cvas_isValid;
}

bool OAIDatabaseRestApi_put::isAllowDml() const {
    return m_allow_dml;
}
void OAIDatabaseRestApi_put::setAllowDml(const bool &allow_dml) {
    m_allow_dml = allow_dml;
    m_allow_dml_isSet = true;
}

bool OAIDatabaseRestApi_put::is_allow_dml_Set() const{
    return m_allow_dml_isSet;
}

bool OAIDatabaseRestApi_put::is_allow_dml_Valid() const{
    return m_allow_dml_isValid;
}

bool OAIDatabaseRestApi_put::isAllowMultiSchemaMetadataFetch() const {
    return m_allow_multi_schema_metadata_fetch;
}
void OAIDatabaseRestApi_put::setAllowMultiSchemaMetadataFetch(const bool &allow_multi_schema_metadata_fetch) {
    m_allow_multi_schema_metadata_fetch = allow_multi_schema_metadata_fetch;
    m_allow_multi_schema_metadata_fetch_isSet = true;
}

bool OAIDatabaseRestApi_put::is_allow_multi_schema_metadata_fetch_Set() const{
    return m_allow_multi_schema_metadata_fetch_isSet;
}

bool OAIDatabaseRestApi_put::is_allow_multi_schema_metadata_fetch_Valid() const{
    return m_allow_multi_schema_metadata_fetch_isValid;
}

bool OAIDatabaseRestApi_put::isAllowRunAsync() const {
    return m_allow_run_async;
}
void OAIDatabaseRestApi_put::setAllowRunAsync(const bool &allow_run_async) {
    m_allow_run_async = allow_run_async;
    m_allow_run_async_isSet = true;
}

bool OAIDatabaseRestApi_put::is_allow_run_async_Set() const{
    return m_allow_run_async_isSet;
}

bool OAIDatabaseRestApi_put::is_allow_run_async_Valid() const{
    return m_allow_run_async_isValid;
}

qint32 OAIDatabaseRestApi_put::getCacheTimeout() const {
    return m_cache_timeout;
}
void OAIDatabaseRestApi_put::setCacheTimeout(const qint32 &cache_timeout) {
    m_cache_timeout = cache_timeout;
    m_cache_timeout_isSet = true;
}

bool OAIDatabaseRestApi_put::is_cache_timeout_Set() const{
    return m_cache_timeout_isSet;
}

bool OAIDatabaseRestApi_put::is_cache_timeout_Valid() const{
    return m_cache_timeout_isValid;
}

QJsonValue OAIDatabaseRestApi_put::getConfigurationMethod() const {
    return m_configuration_method;
}
void OAIDatabaseRestApi_put::setConfigurationMethod(const QJsonValue &configuration_method) {
    m_configuration_method = configuration_method;
    m_configuration_method_isSet = true;
}

bool OAIDatabaseRestApi_put::is_configuration_method_Set() const{
    return m_configuration_method_isSet;
}

bool OAIDatabaseRestApi_put::is_configuration_method_Valid() const{
    return m_configuration_method_isValid;
}

QString OAIDatabaseRestApi_put::getDatabaseName() const {
    return m_database_name;
}
void OAIDatabaseRestApi_put::setDatabaseName(const QString &database_name) {
    m_database_name = database_name;
    m_database_name_isSet = true;
}

bool OAIDatabaseRestApi_put::is_database_name_Set() const{
    return m_database_name_isSet;
}

bool OAIDatabaseRestApi_put::is_database_name_Valid() const{
    return m_database_name_isValid;
}

QString OAIDatabaseRestApi_put::getEncryptedExtra() const {
    return m_encrypted_extra;
}
void OAIDatabaseRestApi_put::setEncryptedExtra(const QString &encrypted_extra) {
    m_encrypted_extra = encrypted_extra;
    m_encrypted_extra_isSet = true;
}

bool OAIDatabaseRestApi_put::is_encrypted_extra_Set() const{
    return m_encrypted_extra_isSet;
}

bool OAIDatabaseRestApi_put::is_encrypted_extra_Valid() const{
    return m_encrypted_extra_isValid;
}

QString OAIDatabaseRestApi_put::getEngine() const {
    return m_engine;
}
void OAIDatabaseRestApi_put::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIDatabaseRestApi_put::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIDatabaseRestApi_put::is_engine_Valid() const{
    return m_engine_isValid;
}

bool OAIDatabaseRestApi_put::isExposeInSqllab() const {
    return m_expose_in_sqllab;
}
void OAIDatabaseRestApi_put::setExposeInSqllab(const bool &expose_in_sqllab) {
    m_expose_in_sqllab = expose_in_sqllab;
    m_expose_in_sqllab_isSet = true;
}

bool OAIDatabaseRestApi_put::is_expose_in_sqllab_Set() const{
    return m_expose_in_sqllab_isSet;
}

bool OAIDatabaseRestApi_put::is_expose_in_sqllab_Valid() const{
    return m_expose_in_sqllab_isValid;
}

QString OAIDatabaseRestApi_put::getExtra() const {
    return m_extra;
}
void OAIDatabaseRestApi_put::setExtra(const QString &extra) {
    m_extra = extra;
    m_extra_isSet = true;
}

bool OAIDatabaseRestApi_put::is_extra_Set() const{
    return m_extra_isSet;
}

bool OAIDatabaseRestApi_put::is_extra_Valid() const{
    return m_extra_isValid;
}

QString OAIDatabaseRestApi_put::getForceCtasSchema() const {
    return m_force_ctas_schema;
}
void OAIDatabaseRestApi_put::setForceCtasSchema(const QString &force_ctas_schema) {
    m_force_ctas_schema = force_ctas_schema;
    m_force_ctas_schema_isSet = true;
}

bool OAIDatabaseRestApi_put::is_force_ctas_schema_Set() const{
    return m_force_ctas_schema_isSet;
}

bool OAIDatabaseRestApi_put::is_force_ctas_schema_Valid() const{
    return m_force_ctas_schema_isValid;
}

bool OAIDatabaseRestApi_put::isImpersonateUser() const {
    return m_impersonate_user;
}
void OAIDatabaseRestApi_put::setImpersonateUser(const bool &impersonate_user) {
    m_impersonate_user = impersonate_user;
    m_impersonate_user_isSet = true;
}

bool OAIDatabaseRestApi_put::is_impersonate_user_Set() const{
    return m_impersonate_user_isSet;
}

bool OAIDatabaseRestApi_put::is_impersonate_user_Valid() const{
    return m_impersonate_user_isValid;
}

QMap<QString, QJsonValue> OAIDatabaseRestApi_put::getParameters() const {
    return m_parameters;
}
void OAIDatabaseRestApi_put::setParameters(const QMap<QString, QJsonValue> &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIDatabaseRestApi_put::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIDatabaseRestApi_put::is_parameters_Valid() const{
    return m_parameters_isValid;
}

QString OAIDatabaseRestApi_put::getServerCert() const {
    return m_server_cert;
}
void OAIDatabaseRestApi_put::setServerCert(const QString &server_cert) {
    m_server_cert = server_cert;
    m_server_cert_isSet = true;
}

bool OAIDatabaseRestApi_put::is_server_cert_Set() const{
    return m_server_cert_isSet;
}

bool OAIDatabaseRestApi_put::is_server_cert_Valid() const{
    return m_server_cert_isValid;
}

QString OAIDatabaseRestApi_put::getSqlalchemyUri() const {
    return m_sqlalchemy_uri;
}
void OAIDatabaseRestApi_put::setSqlalchemyUri(const QString &sqlalchemy_uri) {
    m_sqlalchemy_uri = sqlalchemy_uri;
    m_sqlalchemy_uri_isSet = true;
}

bool OAIDatabaseRestApi_put::is_sqlalchemy_uri_Set() const{
    return m_sqlalchemy_uri_isSet;
}

bool OAIDatabaseRestApi_put::is_sqlalchemy_uri_Valid() const{
    return m_sqlalchemy_uri_isValid;
}

bool OAIDatabaseRestApi_put::isSet() const {
...
bool OAIDatabaseRestApi_put::isValid() const {
