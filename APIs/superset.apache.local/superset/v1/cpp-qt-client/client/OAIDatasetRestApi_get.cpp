...
#include "OAIDatasetRestApi_get.h"
...
OAIDatasetRestApi_get::OAIDatasetRestApi_get(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatasetRestApi_get::OAIDatasetRestApi_get() {
    this->initializeModel();
}

OAIDatasetRestApi_get::~OAIDatasetRestApi_get() {}

void OAIDatasetRestApi_get::initializeModel() {
...
void OAIDatasetRestApi_get::fromJson(QString jsonString) {
...
void OAIDatasetRestApi_get::fromJsonObject(QJsonObject json) {
...
QString OAIDatasetRestApi_get::asJson() const {
...
QJsonObject OAIDatasetRestApi_get::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIDatasetRestApi_get::getCacheTimeout() const {
    return m_cache_timeout;
}
void OAIDatasetRestApi_get::setCacheTimeout(const qint32 &cache_timeout) {
    m_cache_timeout = cache_timeout;
    m_cache_timeout_isSet = true;
}

bool OAIDatasetRestApi_get::is_cache_timeout_Set() const{
    return m_cache_timeout_isSet;
}

bool OAIDatasetRestApi_get::is_cache_timeout_Valid() const{
    return m_cache_timeout_isValid;
}

OAIMeta22 OAIDatasetRestApi_get::getColumns() const {
    return m_columns;
}
void OAIDatasetRestApi_get::setColumns(const OAIMeta22 &columns) {
    m_columns = columns;
    m_columns_isSet = true;
}

bool OAIDatasetRestApi_get::is_columns_Set() const{
    return m_columns_isSet;
}

bool OAIDatasetRestApi_get::is_columns_Valid() const{
    return m_columns_isValid;
}

OAIMeta23 OAIDatasetRestApi_get::getDatabase() const {
    return m_database;
}
void OAIDatasetRestApi_get::setDatabase(const OAIMeta23 &database) {
    m_database = database;
    m_database_isSet = true;
}

bool OAIDatasetRestApi_get::is_database_Set() const{
    return m_database_isSet;
}

bool OAIDatasetRestApi_get::is_database_Valid() const{
    return m_database_isValid;
}

QJsonValue OAIDatasetRestApi_get::getDatasourceType() const {
    return m_datasource_type;
}
void OAIDatasetRestApi_get::setDatasourceType(const QJsonValue &datasource_type) {
    m_datasource_type = datasource_type;
    m_datasource_type_isSet = true;
}

bool OAIDatasetRestApi_get::is_datasource_type_Set() const{
    return m_datasource_type_isSet;
}

bool OAIDatasetRestApi_get::is_datasource_type_Valid() const{
    return m_datasource_type_isValid;
}

QString OAIDatasetRestApi_get::getDefaultEndpoint() const {
    return m_default_endpoint;
}
void OAIDatasetRestApi_get::setDefaultEndpoint(const QString &default_endpoint) {
    m_default_endpoint = default_endpoint;
    m_default_endpoint_isSet = true;
}

bool OAIDatasetRestApi_get::is_default_endpoint_Set() const{
    return m_default_endpoint_isSet;
}

bool OAIDatasetRestApi_get::is_default_endpoint_Valid() const{
    return m_default_endpoint_isValid;
}

QString OAIDatasetRestApi_get::getDescription() const {
    return m_description;
}
void OAIDatasetRestApi_get::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDatasetRestApi_get::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDatasetRestApi_get::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIDatasetRestApi_get::getExtra() const {
    return m_extra;
}
void OAIDatasetRestApi_get::setExtra(const QString &extra) {
    m_extra = extra;
    m_extra_isSet = true;
}

bool OAIDatasetRestApi_get::is_extra_Set() const{
    return m_extra_isSet;
}

bool OAIDatasetRestApi_get::is_extra_Valid() const{
    return m_extra_isValid;
}

QString OAIDatasetRestApi_get::getFetchValuesPredicate() const {
    return m_fetch_values_predicate;
}
void OAIDatasetRestApi_get::setFetchValuesPredicate(const QString &fetch_values_predicate) {
    m_fetch_values_predicate = fetch_values_predicate;
    m_fetch_values_predicate_isSet = true;
}

bool OAIDatasetRestApi_get::is_fetch_values_predicate_Set() const{
    return m_fetch_values_predicate_isSet;
}

bool OAIDatasetRestApi_get::is_fetch_values_predicate_Valid() const{
    return m_fetch_values_predicate_isValid;
}

bool OAIDatasetRestApi_get::isFilterSelectEnabled() const {
    return m_filter_select_enabled;
}
void OAIDatasetRestApi_get::setFilterSelectEnabled(const bool &filter_select_enabled) {
    m_filter_select_enabled = filter_select_enabled;
    m_filter_select_enabled_isSet = true;
}

bool OAIDatasetRestApi_get::is_filter_select_enabled_Set() const{
    return m_filter_select_enabled_isSet;
}

bool OAIDatasetRestApi_get::is_filter_select_enabled_Valid() const{
    return m_filter_select_enabled_isValid;
}

qint32 OAIDatasetRestApi_get::getId() const {
    return m_id;
}
void OAIDatasetRestApi_get::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDatasetRestApi_get::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDatasetRestApi_get::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIDatasetRestApi_get::isIsSqllabView() const {
    return m_is_sqllab_view;
}
void OAIDatasetRestApi_get::setIsSqllabView(const bool &is_sqllab_view) {
    m_is_sqllab_view = is_sqllab_view;
    m_is_sqllab_view_isSet = true;
}

bool OAIDatasetRestApi_get::is_is_sqllab_view_Set() const{
    return m_is_sqllab_view_isSet;
}

bool OAIDatasetRestApi_get::is_is_sqllab_view_Valid() const{
    return m_is_sqllab_view_isValid;
}

QString OAIDatasetRestApi_get::getMainDttmCol() const {
    return m_main_dttm_col;
}
void OAIDatasetRestApi_get::setMainDttmCol(const QString &main_dttm_col) {
    m_main_dttm_col = main_dttm_col;
    m_main_dttm_col_isSet = true;
}

bool OAIDatasetRestApi_get::is_main_dttm_col_Set() const{
    return m_main_dttm_col_isSet;
}

bool OAIDatasetRestApi_get::is_main_dttm_col_Valid() const{
    return m_main_dttm_col_isValid;
}

OAIMeta25 OAIDatasetRestApi_get::getMetrics() const {
    return m_metrics;
}
void OAIDatasetRestApi_get::setMetrics(const OAIMeta25 &metrics) {
    m_metrics = metrics;
    m_metrics_isSet = true;
}

bool OAIDatasetRestApi_get::is_metrics_Set() const{
    return m_metrics_isSet;
}

bool OAIDatasetRestApi_get::is_metrics_Valid() const{
    return m_metrics_isValid;
}

qint32 OAIDatasetRestApi_get::getOffset() const {
    return m_offset;
}
void OAIDatasetRestApi_get::setOffset(const qint32 &offset) {
    m_offset = offset;
    m_offset_isSet = true;
}

bool OAIDatasetRestApi_get::is_offset_Set() const{
    return m_offset_isSet;
}

bool OAIDatasetRestApi_get::is_offset_Valid() const{
    return m_offset_isValid;
}

OAIMeta24 OAIDatasetRestApi_get::getOwners() const {
    return m_owners;
}
void OAIDatasetRestApi_get::setOwners(const OAIMeta24 &owners) {
    m_owners = owners;
    m_owners_isSet = true;
}

bool OAIDatasetRestApi_get::is_owners_Set() const{
    return m_owners_isSet;
}

bool OAIDatasetRestApi_get::is_owners_Valid() const{
    return m_owners_isValid;
}

QString OAIDatasetRestApi_get::getSchema() const {
    return m_schema;
}
void OAIDatasetRestApi_get::setSchema(const QString &schema) {
    m_schema = schema;
    m_schema_isSet = true;
}

bool OAIDatasetRestApi_get::is_schema_Set() const{
    return m_schema_isSet;
}

bool OAIDatasetRestApi_get::is_schema_Valid() const{
    return m_schema_isValid;
}

QString OAIDatasetRestApi_get::getSql() const {
    return m_sql;
}
void OAIDatasetRestApi_get::setSql(const QString &sql) {
    m_sql = sql;
    m_sql_isSet = true;
}

bool OAIDatasetRestApi_get::is_sql_Set() const{
    return m_sql_isSet;
}

bool OAIDatasetRestApi_get::is_sql_Valid() const{
    return m_sql_isValid;
}

QString OAIDatasetRestApi_get::getTableName() const {
    return m_table_name;
}
void OAIDatasetRestApi_get::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIDatasetRestApi_get::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIDatasetRestApi_get::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QString OAIDatasetRestApi_get::getTemplateParams() const {
    return m_template_params;
}
void OAIDatasetRestApi_get::setTemplateParams(const QString &template_params) {
    m_template_params = template_params;
    m_template_params_isSet = true;
}

bool OAIDatasetRestApi_get::is_template_params_Set() const{
    return m_template_params_isSet;
}

bool OAIDatasetRestApi_get::is_template_params_Valid() const{
    return m_template_params_isValid;
}

QJsonValue OAIDatasetRestApi_get::getUrl() const {
    return m_url;
}
void OAIDatasetRestApi_get::setUrl(const QJsonValue &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIDatasetRestApi_get::is_url_Set() const{
    return m_url_isSet;
}

bool OAIDatasetRestApi_get::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIDatasetRestApi_get::isSet() const {
...
bool OAIDatasetRestApi_get::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_columns_isValid && m_database_isValid && m_metrics_isValid && m_table_name_isValid && true;
}
