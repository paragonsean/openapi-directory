...
OAIChartRestApi_put::OAIChartRestApi_put(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChartRestApi_put::OAIChartRestApi_put() {
    this->initializeModel();
}

OAIChartRestApi_put::~OAIChartRestApi_put() {}

void OAIChartRestApi_put::initializeModel() {
...
void OAIChartRestApi_put::fromJson(QString jsonString) {
...
void OAIChartRestApi_put::fromJsonObject(QJsonObject json) {
...
QString OAIChartRestApi_put::asJson() const {
...
QJsonObject OAIChartRestApi_put::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIChartRestApi_put::getCacheTimeout() const {
    return m_cache_timeout;
}
void OAIChartRestApi_put::setCacheTimeout(const qint32 &cache_timeout) {
    m_cache_timeout = cache_timeout;
    m_cache_timeout_isSet = true;
}

bool OAIChartRestApi_put::is_cache_timeout_Set() const{
    return m_cache_timeout_isSet;
}

bool OAIChartRestApi_put::is_cache_timeout_Valid() const{
    return m_cache_timeout_isValid;
}

QList<qint32> OAIChartRestApi_put::getDashboards() const {
    return m_dashboards;
}
void OAIChartRestApi_put::setDashboards(const QList<qint32> &dashboards) {
    m_dashboards = dashboards;
    m_dashboards_isSet = true;
}

bool OAIChartRestApi_put::is_dashboards_Set() const{
    return m_dashboards_isSet;
}

bool OAIChartRestApi_put::is_dashboards_Valid() const{
    return m_dashboards_isValid;
}

qint32 OAIChartRestApi_put::getDatasourceId() const {
    return m_datasource_id;
}
void OAIChartRestApi_put::setDatasourceId(const qint32 &datasource_id) {
    m_datasource_id = datasource_id;
    m_datasource_id_isSet = true;
}

bool OAIChartRestApi_put::is_datasource_id_Set() const{
    return m_datasource_id_isSet;
}

bool OAIChartRestApi_put::is_datasource_id_Valid() const{
    return m_datasource_id_isValid;
}

QString OAIChartRestApi_put::getDatasourceType() const {
    return m_datasource_type;
}
void OAIChartRestApi_put::setDatasourceType(const QString &datasource_type) {
    m_datasource_type = datasource_type;
    m_datasource_type_isSet = true;
}

bool OAIChartRestApi_put::is_datasource_type_Set() const{
    return m_datasource_type_isSet;
}

bool OAIChartRestApi_put::is_datasource_type_Valid() const{
    return m_datasource_type_isValid;
}

QString OAIChartRestApi_put::getDescription() const {
    return m_description;
}
void OAIChartRestApi_put::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIChartRestApi_put::is_description_Set() const{
    return m_description_isSet;
}

bool OAIChartRestApi_put::is_description_Valid() const{
    return m_description_isValid;
}

QList<qint32> OAIChartRestApi_put::getOwners() const {
    return m_owners;
}
void OAIChartRestApi_put::setOwners(const QList<qint32> &owners) {
    m_owners = owners;
    m_owners_isSet = true;
}

bool OAIChartRestApi_put::is_owners_Set() const{
    return m_owners_isSet;
}

bool OAIChartRestApi_put::is_owners_Valid() const{
    return m_owners_isValid;
}

QString OAIChartRestApi_put::getParams() const {
    return m_params;
}
void OAIChartRestApi_put::setParams(const QString &params) {
    m_params = params;
    m_params_isSet = true;
}

bool OAIChartRestApi_put::is_params_Set() const{
    return m_params_isSet;
}

bool OAIChartRestApi_put::is_params_Valid() const{
    return m_params_isValid;
}

QString OAIChartRestApi_put::getQueryContext() const {
    return m_query_context;
}
void OAIChartRestApi_put::setQueryContext(const QString &query_context) {
    m_query_context = query_context;
    m_query_context_isSet = true;
}

bool OAIChartRestApi_put::is_query_context_Set() const{
    return m_query_context_isSet;
}

bool OAIChartRestApi_put::is_query_context_Valid() const{
    return m_query_context_isValid;
}

QString OAIChartRestApi_put::getSliceName() const {
    return m_slice_name;
}
void OAIChartRestApi_put::setSliceName(const QString &slice_name) {
    m_slice_name = slice_name;
    m_slice_name_isSet = true;
}

bool OAIChartRestApi_put::is_slice_name_Set() const{
    return m_slice_name_isSet;
}

bool OAIChartRestApi_put::is_slice_name_Valid() const{
    return m_slice_name_isValid;
}

QString OAIChartRestApi_put::getVizType() const {
    return m_viz_type;
}
void OAIChartRestApi_put::setVizType(const QString &viz_type) {
    m_viz_type = viz_type;
    m_viz_type_isSet = true;
}

bool OAIChartRestApi_put::is_viz_type_Set() const{
    return m_viz_type_isSet;
}

bool OAIChartRestApi_put::is_viz_type_Valid() const{
    return m_viz_type_isValid;
}

bool OAIChartRestApi_put::isSet() const {
...
bool OAIChartRestApi_put::isValid() const {
