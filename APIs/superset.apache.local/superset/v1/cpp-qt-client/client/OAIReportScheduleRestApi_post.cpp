...
OAIReportScheduleRestApi_post::OAIReportScheduleRestApi_post(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReportScheduleRestApi_post::OAIReportScheduleRestApi_post() {
    this->initializeModel();
}

OAIReportScheduleRestApi_post::~OAIReportScheduleRestApi_post() {}

void OAIReportScheduleRestApi_post::initializeModel() {
...
void OAIReportScheduleRestApi_post::fromJson(QString jsonString) {
...
void OAIReportScheduleRestApi_post::fromJsonObject(QJsonObject json) {
...
QString OAIReportScheduleRestApi_post::asJson() const {
...
QJsonObject OAIReportScheduleRestApi_post::asJsonObject() const {
    QJsonObject obj;
    if (m_active_isSet) {
...
bool OAIReportScheduleRestApi_post::isActive() const {
    return m_active;
}
void OAIReportScheduleRestApi_post::setActive(const bool &active) {
    m_active = active;
    m_active_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_active_Set() const{
    return m_active_isSet;
}

bool OAIReportScheduleRestApi_post::is_active_Valid() const{
    return m_active_isValid;
}

qint32 OAIReportScheduleRestApi_post::getChart() const {
    return m_chart;
}
void OAIReportScheduleRestApi_post::setChart(const qint32 &chart) {
    m_chart = chart;
    m_chart_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_chart_Set() const{
    return m_chart_isSet;
}

bool OAIReportScheduleRestApi_post::is_chart_Valid() const{
    return m_chart_isValid;
}

QString OAIReportScheduleRestApi_post::getContextMarkdown() const {
    return m_context_markdown;
}
void OAIReportScheduleRestApi_post::setContextMarkdown(const QString &context_markdown) {
    m_context_markdown = context_markdown;
    m_context_markdown_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_context_markdown_Set() const{
    return m_context_markdown_isSet;
}

bool OAIReportScheduleRestApi_post::is_context_markdown_Valid() const{
    return m_context_markdown_isValid;
}

QJsonValue OAIReportScheduleRestApi_post::getCreationMethod() const {
    return m_creation_method;
}
void OAIReportScheduleRestApi_post::setCreationMethod(const QJsonValue &creation_method) {
    m_creation_method = creation_method;
    m_creation_method_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_creation_method_Set() const{
    return m_creation_method_isSet;
}

bool OAIReportScheduleRestApi_post::is_creation_method_Valid() const{
    return m_creation_method_isValid;
}

QString OAIReportScheduleRestApi_post::getCrontab() const {
    return m_crontab;
}
void OAIReportScheduleRestApi_post::setCrontab(const QString &crontab) {
    m_crontab = crontab;
    m_crontab_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_crontab_Set() const{
    return m_crontab_isSet;
}

bool OAIReportScheduleRestApi_post::is_crontab_Valid() const{
    return m_crontab_isValid;
}

qint32 OAIReportScheduleRestApi_post::getDashboard() const {
    return m_dashboard;
}
void OAIReportScheduleRestApi_post::setDashboard(const qint32 &dashboard) {
    m_dashboard = dashboard;
    m_dashboard_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_dashboard_Set() const{
    return m_dashboard_isSet;
}

bool OAIReportScheduleRestApi_post::is_dashboard_Valid() const{
    return m_dashboard_isValid;
}

qint32 OAIReportScheduleRestApi_post::getDatabase() const {
    return m_database;
}
void OAIReportScheduleRestApi_post::setDatabase(const qint32 &database) {
    m_database = database;
    m_database_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_database_Set() const{
    return m_database_isSet;
}

bool OAIReportScheduleRestApi_post::is_database_Valid() const{
    return m_database_isValid;
}

QString OAIReportScheduleRestApi_post::getDescription() const {
    return m_description;
}
void OAIReportScheduleRestApi_post::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_description_Set() const{
    return m_description_isSet;
}

bool OAIReportScheduleRestApi_post::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAIReportScheduleRestApi_post::getGracePeriod() const {
    return m_grace_period;
}
void OAIReportScheduleRestApi_post::setGracePeriod(const qint32 &grace_period) {
    m_grace_period = grace_period;
    m_grace_period_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_grace_period_Set() const{
    return m_grace_period_isSet;
}

bool OAIReportScheduleRestApi_post::is_grace_period_Valid() const{
    return m_grace_period_isValid;
}

qint32 OAIReportScheduleRestApi_post::getLogRetention() const {
    return m_log_retention;
}
void OAIReportScheduleRestApi_post::setLogRetention(const qint32 &log_retention) {
    m_log_retention = log_retention;
    m_log_retention_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_log_retention_Set() const{
    return m_log_retention_isSet;
}

bool OAIReportScheduleRestApi_post::is_log_retention_Valid() const{
    return m_log_retention_isValid;
}

QString OAIReportScheduleRestApi_post::getName() const {
    return m_name;
}
void OAIReportScheduleRestApi_post::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_name_Set() const{
    return m_name_isSet;
}

bool OAIReportScheduleRestApi_post::is_name_Valid() const{
    return m_name_isValid;
}

QList<qint32> OAIReportScheduleRestApi_post::getOwners() const {
    return m_owners;
}
void OAIReportScheduleRestApi_post::setOwners(const QList<qint32> &owners) {
    m_owners = owners;
    m_owners_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_owners_Set() const{
    return m_owners_isSet;
}

bool OAIReportScheduleRestApi_post::is_owners_Valid() const{
    return m_owners_isValid;
}

QList<OAIReportRecipient> OAIReportScheduleRestApi_post::getRecipients() const {
    return m_recipients;
}
void OAIReportScheduleRestApi_post::setRecipients(const QList<OAIReportRecipient> &recipients) {
    m_recipients = recipients;
    m_recipients_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_recipients_Set() const{
    return m_recipients_isSet;
}

bool OAIReportScheduleRestApi_post::is_recipients_Valid() const{
    return m_recipients_isValid;
}

QString OAIReportScheduleRestApi_post::getReportFormat() const {
    return m_report_format;
}
void OAIReportScheduleRestApi_post::setReportFormat(const QString &report_format) {
    m_report_format = report_format;
    m_report_format_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_report_format_Set() const{
    return m_report_format_isSet;
}

bool OAIReportScheduleRestApi_post::is_report_format_Valid() const{
    return m_report_format_isValid;
}

QString OAIReportScheduleRestApi_post::getSql() const {
    return m_sql;
}
void OAIReportScheduleRestApi_post::setSql(const QString &sql) {
    m_sql = sql;
    m_sql_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_sql_Set() const{
    return m_sql_isSet;
}

bool OAIReportScheduleRestApi_post::is_sql_Valid() const{
    return m_sql_isValid;
}

QString OAIReportScheduleRestApi_post::getTimezone() const {
    return m_timezone;
}
void OAIReportScheduleRestApi_post::setTimezone(const QString &timezone) {
    m_timezone = timezone;
    m_timezone_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_timezone_Set() const{
    return m_timezone_isSet;
}

bool OAIReportScheduleRestApi_post::is_timezone_Valid() const{
    return m_timezone_isValid;
}

QString OAIReportScheduleRestApi_post::getType() const {
    return m_type;
}
void OAIReportScheduleRestApi_post::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_type_Set() const{
    return m_type_isSet;
}

bool OAIReportScheduleRestApi_post::is_type_Valid() const{
    return m_type_isValid;
}

OAIValidatorConfigJSON OAIReportScheduleRestApi_post::getValidatorConfigJson() const {
    return m_validator_config_json;
}
void OAIReportScheduleRestApi_post::setValidatorConfigJson(const OAIValidatorConfigJSON &validator_config_json) {
    m_validator_config_json = validator_config_json;
    m_validator_config_json_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_validator_config_json_Set() const{
    return m_validator_config_json_isSet;
}

bool OAIReportScheduleRestApi_post::is_validator_config_json_Valid() const{
    return m_validator_config_json_isValid;
}

QString OAIReportScheduleRestApi_post::getValidatorType() const {
    return m_validator_type;
}
void OAIReportScheduleRestApi_post::setValidatorType(const QString &validator_type) {
    m_validator_type = validator_type;
    m_validator_type_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_validator_type_Set() const{
    return m_validator_type_isSet;
}

bool OAIReportScheduleRestApi_post::is_validator_type_Valid() const{
    return m_validator_type_isValid;
}

qint32 OAIReportScheduleRestApi_post::getWorkingTimeout() const {
    return m_working_timeout;
}
void OAIReportScheduleRestApi_post::setWorkingTimeout(const qint32 &working_timeout) {
    m_working_timeout = working_timeout;
    m_working_timeout_isSet = true;
}

bool OAIReportScheduleRestApi_post::is_working_timeout_Set() const{
    return m_working_timeout_isSet;
}

bool OAIReportScheduleRestApi_post::is_working_timeout_Valid() const{
    return m_working_timeout_isValid;
}

bool OAIReportScheduleRestApi_post::isSet() const {
...
bool OAIReportScheduleRestApi_post::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_crontab_isValid && m_name_isValid && m_type_isValid && true;
}
