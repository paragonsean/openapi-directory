...
/*
 * OAIDatabaseRestApi_put.h
 *
 * 
 */

#ifndef OAIDatabaseRestApi_put_H
#define OAIDatabaseRestApi_put_H
...
class OAIDatabaseRestApi_put : public OAIObject {
public:
    OAIDatabaseRestApi_put();
    OAIDatabaseRestApi_put(QString json);
    ~OAIDatabaseRestApi_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseRestApi_put)

#endif // OAIDatabaseRestApi_put_H
