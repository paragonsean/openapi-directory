...
/*
 * OAIReportScheduleRestApi_put.h
 *
 * 
 */

#ifndef OAIReportScheduleRestApi_put_H
#define OAIReportScheduleRestApi_put_H
...
class OAIReportScheduleRestApi_put : public OAIObject {
public:
    OAIReportScheduleRestApi_put();
    OAIReportScheduleRestApi_put(QString json);
    ~OAIReportScheduleRestApi_put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportScheduleRestApi_put)

#endif // OAIReportScheduleRestApi_put_H
