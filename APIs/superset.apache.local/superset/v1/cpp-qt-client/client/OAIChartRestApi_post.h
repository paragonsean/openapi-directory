...
/*
 * OAIChartRestApi_post.h
 *
 * 
 */

#ifndef OAIChartRestApi_post_H
#define OAIChartRestApi_post_H
...
class OAIChartRestApi_post : public OAIObject {
public:
    OAIChartRestApi_post();
    OAIChartRestApi_post(QString json);
    ~OAIChartRestApi_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChartRestApi_post)

#endif // OAIChartRestApi_post_H
