...
/*
 * OAIDatabaseRestApi_post.h
 *
 * 
 */

#ifndef OAIDatabaseRestApi_post_H
#define OAIDatabaseRestApi_post_H
...
class OAIDatabaseRestApi_post : public OAIObject {
public:
    OAIDatabaseRestApi_post();
    OAIDatabaseRestApi_post(QString json);
    ~OAIDatabaseRestApi_post() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseRestApi_post)

#endif // OAIDatabaseRestApi_post_H
