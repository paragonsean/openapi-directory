...
class DatabaseTestConnectionSchema {
    ...
    constructor() { 
        ...
        DatabaseTestConnectionSchema.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseTestConnectionSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseTestConnectionSchema</code>.
     */
 ...
 */
DatabaseTestConnectionSchema.prototype['configuration_method'] = undefined;

/**
 * A database name to identify this connection.
 * @member {String} database_name
 */
DatabaseTestConnectionSchema.prototype['database_name'] = undefined;
 ...
 */
DatabaseTestConnectionSchema.prototype['encrypted_extra'] = undefined;
 ...
 */
DatabaseTestConnectionSchema.prototype['impersonate_user'] = undefined;
 ...
 */
DatabaseTestConnectionSchema.prototype['server_cert'] = undefined;
 ...
 */
DatabaseTestConnectionSchema.prototype['sqlalchemy_uri'] = undefined;
...
export default DatabaseTestConnectionSchema;
