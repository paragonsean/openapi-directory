...
class DatabaseRelatedDashboards {
    ...
    constructor() { 
        ...
        DatabaseRelatedDashboards.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseRelatedDashboards</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseRelatedDashboards</code>.
     */
    static validateJSON(data) {
        if (data['result']) { // data not null
            ...
            for (const item of data['result']) {
                DatabaseRelatedDashboard.validateJSON(item);
            };
        }
...
export default DatabaseRelatedDashboards;
