...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Superset.ReportScheduleRestApiPut();
  });
  ...
  describe('ReportScheduleRestApiPut', function() {
    it('should create an instance of ReportScheduleRestApiPut', function() {
      // uncomment below and update the code to test ReportScheduleRestApiPut
      //var instance = new Superset.ReportScheduleRestApiPut();
      //expect(instance).to.be.a(Superset.ReportScheduleRestApiPut);
    });
