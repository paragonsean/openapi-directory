...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Superset.DashboardRestApiPost();
  });
  ...
  describe('DashboardRestApiPost', function() {
    it('should create an instance of DashboardRestApiPost', function() {
      // uncomment below and update the code to test DashboardRestApiPost
      //var instance = new Superset.DashboardRestApiPost();
      //expect(instance).to.be.a(Superset.DashboardRestApiPost);
    });
