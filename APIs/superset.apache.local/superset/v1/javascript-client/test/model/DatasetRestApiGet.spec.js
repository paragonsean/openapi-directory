...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Superset.DatasetRestApiGet();
  });
  ...
  describe('DatasetRestApiGet', function() {
    it('should create an instance of DatasetRestApiGet', function() {
      // uncomment below and update the code to test DatasetRestApiGet
      //var instance = new Superset.DatasetRestApiGet();
      //expect(instance).to.be.a(Superset.DatasetRestApiGet);
    });
