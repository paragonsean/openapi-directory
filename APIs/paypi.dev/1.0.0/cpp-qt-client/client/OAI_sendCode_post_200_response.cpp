...
OAI_sendCode_post_200_response::OAI_sendCode_post_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_sendCode_post_200_response::OAI_sendCode_post_200_response() {
    this->initializeModel();
}

OAI_sendCode_post_200_response::~OAI_sendCode_post_200_response() {}

void OAI_sendCode_post_200_response::initializeModel() {
...
void OAI_sendCode_post_200_response::fromJson(QString jsonString) {
...
void OAI_sendCode_post_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_sendCode_post_200_response::asJson() const {
...
QJsonObject OAI_sendCode_post_200_response::asJsonObject() const {
    QJsonObject obj;
    if (m_message_isSet) {
...
bool OAI_sendCode_post_200_response::isMessage() const {
    return m_message;
}
void OAI_sendCode_post_200_response::setMessage(const bool &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAI_sendCode_post_200_response::is_message_Set() const{
    return m_message_isSet;
}

bool OAI_sendCode_post_200_response::is_message_Valid() const{
    return m_message_isValid;
}

bool OAI_sendCode_post_200_response::isSuccess() const {
    return m_success;
}
void OAI_sendCode_post_200_response::setSuccess(const bool &success) {
    m_success = success;
    m_success_isSet = true;
}

bool OAI_sendCode_post_200_response::is_success_Set() const{
    return m_success_isSet;
}

bool OAI_sendCode_post_200_response::is_success_Valid() const{
    return m_success_isValid;
}

bool OAI_sendCode_post_200_response::isSet() const {
...
bool OAI_sendCode_post_200_response::isValid() const {
