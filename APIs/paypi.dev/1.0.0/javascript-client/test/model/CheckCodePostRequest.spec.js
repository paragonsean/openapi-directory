...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmailVerify.CheckCodePostRequest();
  });
  ...
  describe('CheckCodePostRequest', function() {
    it('should create an instance of CheckCodePostRequest', function() {
      // uncomment below and update the code to test CheckCodePostRequest
      //var instance = new EmailVerify.CheckCodePostRequest();
      //expect(instance).to.be.a(EmailVerify.CheckCodePostRequest);
    });
