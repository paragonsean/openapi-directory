...
/*
 * OAIClientDetailsApiModel.h
 *
 * 
 */

#ifndef OAIClientDetailsApiModel_H
#define OAIClientDetailsApiModel_H
...
class OAIClientDetailsApiModel : public OAIObject {
public:
    OAIClientDetailsApiModel();
    OAIClientDetailsApiModel(QString json);
    ~OAIClientDetailsApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClientDetailsApiModel)

#endif // OAIClientDetailsApiModel_H
