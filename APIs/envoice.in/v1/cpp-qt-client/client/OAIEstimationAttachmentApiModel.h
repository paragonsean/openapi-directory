...
/*
 * OAIEstimationAttachmentApiModel.h
 *
 * 
 */

#ifndef OAIEstimationAttachmentApiModel_H
#define OAIEstimationAttachmentApiModel_H
...
class OAIEstimationAttachmentApiModel : public OAIObject {
public:
    OAIEstimationAttachmentApiModel();
    OAIEstimationAttachmentApiModel(QString json);
    ~OAIEstimationAttachmentApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimationAttachmentApiModel)

#endif // OAIEstimationAttachmentApiModel_H
