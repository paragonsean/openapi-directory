...
/*
 * OAIProductCouponApiModel.h
 *
 * 
 */

#ifndef OAIProductCouponApiModel_H
#define OAIProductCouponApiModel_H
...
class OAIProductCouponApiModel : public OAIObject {
public:
    OAIProductCouponApiModel();
    OAIProductCouponApiModel(QString json);
    ~OAIProductCouponApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductCouponApiModel)

#endif // OAIProductCouponApiModel_H
