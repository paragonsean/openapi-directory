...
QString OAISearchRequest::getOrder() const {
    return m_order;
}
void OAISearchRequest::setOrder(const QString &order) {
    m_order = order;
    m_order_isSet = true;
}

bool OAISearchRequest::is_order_Set() const{
    return m_order_isSet;
}

bool OAISearchRequest::is_order_Valid() const{
    return m_order_isValid;
}

QString OAISearchRequest::getOrderBy() const {
    return m_order_by;
}
void OAISearchRequest::setOrderBy(const QString &order_by) {
    m_order_by = order_by;
    m_order_by_isSet = true;
}

bool OAISearchRequest::is_order_by_Set() const{
    return m_order_by_isSet;
}

bool OAISearchRequest::is_order_by_Valid() const{
