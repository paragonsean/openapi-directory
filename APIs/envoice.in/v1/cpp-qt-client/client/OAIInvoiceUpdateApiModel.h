...
/*
 * OAIInvoiceUpdateApiModel.h
 *
 * 
 */

#ifndef OAIInvoiceUpdateApiModel_H
#define OAIInvoiceUpdateApiModel_H

#include <QJsonObject>

#include "OAIInvoiceGatewayApiModel.h"
#include "OAIInvoiceRecurringApiModel.h"
#include "OAIInvoiceUpdateAttachmentApiModel.h"
...
namespace OpenAPI {
class OAIInvoiceUpdateAttachmentApiModel;
class OAIInvoiceUpdateItemApiModel;
class OAIInvoiceGatewayApiModel;
class OAIInvoiceRecurringApiModel;

class OAIInvoiceUpdateApiModel : public OAIObject {
public:
    OAIInvoiceUpdateApiModel();
    OAIInvoiceUpdateApiModel(QString json);
    ~OAIInvoiceUpdateApiModel() override;
    ...
    QList<OAIInvoiceUpdateAttachmentApiModel> getAttachments() const;
    void setAttachments(const QList<OAIInvoiceUpdateAttachmentApiModel> &attachments);
    ...
    QList<OAIInvoiceUpdateItemApiModel> getItems() const;
    void setItems(const QList<OAIInvoiceUpdateItemApiModel> &items);
...
private:
    ...
    QList<OAIInvoiceUpdateAttachmentApiModel> m_attachments;
    ...
    QList<OAIInvoiceUpdateItemApiModel> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceUpdateApiModel)

#endif // OAIInvoiceUpdateApiModel_H
