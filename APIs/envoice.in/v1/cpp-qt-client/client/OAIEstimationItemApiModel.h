...
/*
 * OAIEstimationItemApiModel.h
 *
 * 
 */

#ifndef OAIEstimationItemApiModel_H
#define OAIEstimationItemApiModel_H
...
class OAIEstimationItemApiModel : public OAIObject {
public:
    OAIEstimationItemApiModel();
    OAIEstimationItemApiModel(QString json);
    ~OAIEstimationItemApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimationItemApiModel)

#endif // OAIEstimationItemApiModel_H
