...
/*
 * OAIRecurringProfile.h
 *
 * 
 */

#ifndef OAIRecurringProfile_H
#define OAIRecurringProfile_H
...
class OAIRecurringProfile : public OAIObject {
public:
    OAIRecurringProfile();
    OAIRecurringProfile(QString json);
    ~OAIRecurringProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecurringProfile)

#endif // OAIRecurringProfile_H
