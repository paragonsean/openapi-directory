...
/*
 * OAIOrderAttachmentApiModel.h
 *
 * 
 */

#ifndef OAIOrderAttachmentApiModel_H
#define OAIOrderAttachmentApiModel_H
...
class OAIOrderAttachmentApiModel : public OAIObject {
public:
    OAIOrderAttachmentApiModel();
    OAIOrderAttachmentApiModel(QString json);
    ~OAIOrderAttachmentApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderAttachmentApiModel)

#endif // OAIOrderAttachmentApiModel_H
