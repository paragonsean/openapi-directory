...
/*
 * OAIEstimationUpdateAttachmentApiModel.h
 *
 * 
 */

#ifndef OAIEstimationUpdateAttachmentApiModel_H
#define OAIEstimationUpdateAttachmentApiModel_H
...
class OAIEstimationUpdateAttachmentApiModel : public OAIObject {
public:
    OAIEstimationUpdateAttachmentApiModel();
    OAIEstimationUpdateAttachmentApiModel(QString json);
    ~OAIEstimationUpdateAttachmentApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimationUpdateAttachmentApiModel)

#endif // OAIEstimationUpdateAttachmentApiModel_H
