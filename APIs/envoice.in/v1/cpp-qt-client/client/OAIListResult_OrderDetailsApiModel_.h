...
/*
 * OAIListResult_OrderDetailsApiModel_.h
 *
 * 
 */

#ifndef OAIListResult_OrderDetailsApiModel__H
#define OAIListResult_OrderDetailsApiModel__H
...
namespace OpenAPI {
class OAIIErrorInfo;
class OAIOrderDetailsApiModel;

class OAIListResult_OrderDetailsApiModel_ : public OAIObject {
public:
    OAIListResult_OrderDetailsApiModel_();
    OAIListResult_OrderDetailsApiModel_(QString json);
    ~OAIListResult_OrderDetailsApiModel_() override;
    ...
    QList<OAIOrderDetailsApiModel> getResult() const;
    void setResult(const QList<OAIOrderDetailsApiModel> &result);
...
private:
    ...
    QList<OAIOrderDetailsApiModel> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResult_OrderDetailsApiModel_)

#endif // OAIListResult_OrderDetailsApiModel__H
