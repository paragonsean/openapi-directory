...
/*
 * OAIPaymentLinkItem.h
 *
 * 
 */

#ifndef OAIPaymentLinkItem_H
#define OAIPaymentLinkItem_H
...
class OAIPaymentLinkItem : public OAIObject {
public:
    OAIPaymentLinkItem();
    OAIPaymentLinkItem(QString json);
    ~OAIPaymentLinkItem() override;
    ...
    OAIWorkType getWorkType() const;
    void setWorkType(const OAIWorkType &work_type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentLinkItem)

#endif // OAIPaymentLinkItem_H
