...
/*
 * OAIInvoiceAttachmentApiModel.h
 *
 * 
 */

#ifndef OAIInvoiceAttachmentApiModel_H
#define OAIInvoiceAttachmentApiModel_H
...
class OAIInvoiceAttachmentApiModel : public OAIObject {
public:
    OAIInvoiceAttachmentApiModel();
    OAIInvoiceAttachmentApiModel(QString json);
    ~OAIInvoiceAttachmentApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceAttachmentApiModel)

#endif // OAIInvoiceAttachmentApiModel_H
