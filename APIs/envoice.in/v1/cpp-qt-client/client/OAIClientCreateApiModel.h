...
/*
 * OAIClientCreateApiModel.h
 *
 * 
 */

#ifndef OAIClientCreateApiModel_H
#define OAIClientCreateApiModel_H
...
class OAIClientCreateApiModel : public OAIObject {
public:
    OAIClientCreateApiModel();
    OAIClientCreateApiModel(QString json);
    ~OAIClientCreateApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClientCreateApiModel)

#endif // OAIClientCreateApiModel_H
