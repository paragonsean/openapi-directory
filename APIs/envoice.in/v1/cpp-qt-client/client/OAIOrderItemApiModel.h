...
/*
 * OAIOrderItemApiModel.h
 *
 * 
 */

#ifndef OAIOrderItemApiModel_H
#define OAIOrderItemApiModel_H
...
class OAIOrderItemApiModel : public OAIObject {
public:
    OAIOrderItemApiModel();
    OAIOrderItemApiModel(QString json);
    ~OAIOrderItemApiModel() override;
    ...
    qint32 getProductItemId() const;
    void setProductItemId(const qint32 &product_item_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderItemApiModel)

#endif // OAIOrderItemApiModel_H
