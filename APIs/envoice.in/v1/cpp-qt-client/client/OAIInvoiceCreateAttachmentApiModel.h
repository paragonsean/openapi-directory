...
/*
 * OAIInvoiceCreateAttachmentApiModel.h
 *
 * 
 */

#ifndef OAIInvoiceCreateAttachmentApiModel_H
#define OAIInvoiceCreateAttachmentApiModel_H
...
class OAIInvoiceCreateAttachmentApiModel : public OAIObject {
public:
    OAIInvoiceCreateAttachmentApiModel();
    OAIInvoiceCreateAttachmentApiModel(QString json);
    ~OAIInvoiceCreateAttachmentApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceCreateAttachmentApiModel)

#endif // OAIInvoiceCreateAttachmentApiModel_H
