...
/*
 * OAIInvoiceDetailsApiModel.h
 *
 * 
 */

#ifndef OAIInvoiceDetailsApiModel_H
#define OAIInvoiceDetailsApiModel_H
...
class OAIInvoiceDetailsApiModel : public OAIObject {
public:
    OAIInvoiceDetailsApiModel();
    OAIInvoiceDetailsApiModel(QString json);
    ~OAIInvoiceDetailsApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceDetailsApiModel)

#endif // OAIInvoiceDetailsApiModel_H
