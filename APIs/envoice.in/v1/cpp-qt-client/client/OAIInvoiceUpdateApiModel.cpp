...
OAIInvoiceUpdateApiModel::OAIInvoiceUpdateApiModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInvoiceUpdateApiModel::OAIInvoiceUpdateApiModel() {
    this->initializeModel();
}

OAIInvoiceUpdateApiModel::~OAIInvoiceUpdateApiModel() {}

void OAIInvoiceUpdateApiModel::initializeModel() {
...
void OAIInvoiceUpdateApiModel::fromJson(QString jsonString) {
...
void OAIInvoiceUpdateApiModel::fromJsonObject(QJsonObject json) {
...
QString OAIInvoiceUpdateApiModel::asJson() const {
...
QJsonObject OAIInvoiceUpdateApiModel::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIInvoiceUpdateAttachmentApiModel> OAIInvoiceUpdateApiModel::getAttachments() const {
    return m_attachments;
}
void OAIInvoiceUpdateApiModel::setAttachments(const QList<OAIInvoiceUpdateAttachmentApiModel> &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAIInvoiceUpdateApiModel::is_attachments_Valid() const{
    return m_attachments_isValid;
}

qint32 OAIInvoiceUpdateApiModel::getClientId() const {
    return m_client_id;
}
void OAIInvoiceUpdateApiModel::setClientId(const qint32 &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIInvoiceUpdateApiModel::is_client_id_Valid() const{
    return m_client_id_isValid;
}

qint32 OAIInvoiceUpdateApiModel::getClonedFromId() const {
    return m_cloned_from_id;
}
void OAIInvoiceUpdateApiModel::setClonedFromId(const qint32 &cloned_from_id) {
    m_cloned_from_id = cloned_from_id;
    m_cloned_from_id_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_cloned_from_id_Set() const{
    return m_cloned_from_id_isSet;
}

bool OAIInvoiceUpdateApiModel::is_cloned_from_id_Valid() const{
    return m_cloned_from_id_isValid;
}

qint32 OAIInvoiceUpdateApiModel::getCurrencyId() const {
    return m_currency_id;
}
void OAIInvoiceUpdateApiModel::setCurrencyId(const qint32 &currency_id) {
    m_currency_id = currency_id;
    m_currency_id_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_currency_id_Set() const{
    return m_currency_id_isSet;
}

bool OAIInvoiceUpdateApiModel::is_currency_id_Valid() const{
    return m_currency_id_isValid;
}

QDateTime OAIInvoiceUpdateApiModel::getDuedate() const {
    return m_duedate;
}
void OAIInvoiceUpdateApiModel::setDuedate(const QDateTime &duedate) {
    m_duedate = duedate;
    m_duedate_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_duedate_Set() const{
    return m_duedate_isSet;
}

bool OAIInvoiceUpdateApiModel::is_duedate_Valid() const{
    return m_duedate_isValid;
}

qint32 OAIInvoiceUpdateApiModel::getId() const {
    return m_id;
}
void OAIInvoiceUpdateApiModel::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInvoiceUpdateApiModel::is_id_Valid() const{
    return m_id_isValid;
}

qint32 OAIInvoiceUpdateApiModel::getInvoiceCategoryId() const {
    return m_invoice_category_id;
}
void OAIInvoiceUpdateApiModel::setInvoiceCategoryId(const qint32 &invoice_category_id) {
    m_invoice_category_id = invoice_category_id;
    m_invoice_category_id_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_invoice_category_id_Set() const{
    return m_invoice_category_id_isSet;
}

bool OAIInvoiceUpdateApiModel::is_invoice_category_id_Valid() const{
    return m_invoice_category_id_isValid;
}

QDateTime OAIInvoiceUpdateApiModel::getIssuedOn() const {
    return m_issued_on;
}
void OAIInvoiceUpdateApiModel::setIssuedOn(const QDateTime &issued_on) {
    m_issued_on = issued_on;
    m_issued_on_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_issued_on_Set() const{
    return m_issued_on_isSet;
}

bool OAIInvoiceUpdateApiModel::is_issued_on_Valid() const{
    return m_issued_on_isValid;
}

QList<OAIInvoiceUpdateItemApiModel> OAIInvoiceUpdateApiModel::getItems() const {
    return m_items;
}
void OAIInvoiceUpdateApiModel::setItems(const QList<OAIInvoiceUpdateItemApiModel> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_items_Set() const{
    return m_items_isSet;
}

bool OAIInvoiceUpdateApiModel::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIInvoiceUpdateApiModel::getNotes() const {
    return m_notes;
}
void OAIInvoiceUpdateApiModel::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIInvoiceUpdateApiModel::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIInvoiceUpdateApiModel::getNumber() const {
    return m_number;
}
void OAIInvoiceUpdateApiModel::setNumber(const QString &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_number_Set() const{
    return m_number_isSet;
}

bool OAIInvoiceUpdateApiModel::is_number_Valid() const{
    return m_number_isValid;
}

QList<OAIInvoiceGatewayApiModel> OAIInvoiceUpdateApiModel::getPaymentGateways() const {
    return m_payment_gateways;
}
void OAIInvoiceUpdateApiModel::setPaymentGateways(const QList<OAIInvoiceGatewayApiModel> &payment_gateways) {
    m_payment_gateways = payment_gateways;
    m_payment_gateways_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_payment_gateways_Set() const{
    return m_payment_gateways_isSet;
}

bool OAIInvoiceUpdateApiModel::is_payment_gateways_Valid() const{
    return m_payment_gateways_isValid;
}

QString OAIInvoiceUpdateApiModel::getPoNumber() const {
    return m_po_number;
}
void OAIInvoiceUpdateApiModel::setPoNumber(const QString &po_number) {
    m_po_number = po_number;
    m_po_number_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_po_number_Set() const{
    return m_po_number_isSet;
}

bool OAIInvoiceUpdateApiModel::is_po_number_Valid() const{
    return m_po_number_isValid;
}

OAIInvoiceRecurringApiModel OAIInvoiceUpdateApiModel::getRecurringProfile() const {
    return m_recurring_profile;
}
void OAIInvoiceUpdateApiModel::setRecurringProfile(const OAIInvoiceRecurringApiModel &recurring_profile) {
    m_recurring_profile = recurring_profile;
    m_recurring_profile_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_recurring_profile_Set() const{
    return m_recurring_profile_isSet;
}

bool OAIInvoiceUpdateApiModel::is_recurring_profile_Valid() const{
    return m_recurring_profile_isValid;
}

qint32 OAIInvoiceUpdateApiModel::getRecurringProfileId() const {
    return m_recurring_profile_id;
}
void OAIInvoiceUpdateApiModel::setRecurringProfileId(const qint32 &recurring_profile_id) {
    m_recurring_profile_id = recurring_profile_id;
    m_recurring_profile_id_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_recurring_profile_id_Set() const{
    return m_recurring_profile_id_isSet;
}

bool OAIInvoiceUpdateApiModel::is_recurring_profile_id_Valid() const{
    return m_recurring_profile_id_isValid;
}

bool OAIInvoiceUpdateApiModel::isShouldSendReminders() const {
    return m_should_send_reminders;
}
void OAIInvoiceUpdateApiModel::setShouldSendReminders(const bool &should_send_reminders) {
    m_should_send_reminders = should_send_reminders;
    m_should_send_reminders_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_should_send_reminders_Set() const{
    return m_should_send_reminders_isSet;
}

bool OAIInvoiceUpdateApiModel::is_should_send_reminders_Valid() const{
    return m_should_send_reminders_isValid;
}

QString OAIInvoiceUpdateApiModel::getStatus() const {
    return m_status;
}
void OAIInvoiceUpdateApiModel::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_status_Set() const{
    return m_status_isSet;
}

bool OAIInvoiceUpdateApiModel::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIInvoiceUpdateApiModel::getTerms() const {
    return m_terms;
}
void OAIInvoiceUpdateApiModel::setTerms(const QString &terms) {
    m_terms = terms;
    m_terms_isSet = true;
}

bool OAIInvoiceUpdateApiModel::is_terms_Set() const{
    return m_terms_isSet;
}

bool OAIInvoiceUpdateApiModel::is_terms_Valid() const{
    return m_terms_isValid;
}

bool OAIInvoiceUpdateApiModel::isSet() const {
...
bool OAIInvoiceUpdateApiModel::isValid() const {
