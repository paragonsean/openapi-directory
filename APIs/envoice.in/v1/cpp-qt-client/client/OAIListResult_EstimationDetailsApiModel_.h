...
/*
 * OAIListResult_EstimationDetailsApiModel_.h
 *
 * 
 */

#ifndef OAIListResult_EstimationDetailsApiModel__H
#define OAIListResult_EstimationDetailsApiModel__H
...
namespace OpenAPI {
class OAIIErrorInfo;
class OAIEstimationDetailsApiModel;

class OAIListResult_EstimationDetailsApiModel_ : public OAIObject {
public:
    OAIListResult_EstimationDetailsApiModel_();
    OAIListResult_EstimationDetailsApiModel_(QString json);
    ~OAIListResult_EstimationDetailsApiModel_() override;
    ...
    QList<OAIEstimationDetailsApiModel> getResult() const;
    void setResult(const QList<OAIEstimationDetailsApiModel> &result);
...
private:
    ...
    QList<OAIEstimationDetailsApiModel> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResult_EstimationDetailsApiModel_)

#endif // OAIListResult_EstimationDetailsApiModel__H
