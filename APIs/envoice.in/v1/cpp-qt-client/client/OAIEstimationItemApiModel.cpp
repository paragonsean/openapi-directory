...
OAIEstimationItemApiModel::OAIEstimationItemApiModel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEstimationItemApiModel::OAIEstimationItemApiModel() {
    this->initializeModel();
}

OAIEstimationItemApiModel::~OAIEstimationItemApiModel() {}

void OAIEstimationItemApiModel::initializeModel() {
...
void OAIEstimationItemApiModel::fromJson(QString jsonString) {
...
void OAIEstimationItemApiModel::fromJsonObject(QJsonObject json) {
...
QString OAIEstimationItemApiModel::asJson() const {
...
QJsonObject OAIEstimationItemApiModel::asJsonObject() const {
    QJsonObject obj;
    if (m_cost_isSet) {
...
double OAIEstimationItemApiModel::getCost() const {
    return m_cost;
}
void OAIEstimationItemApiModel::setCost(const double &cost) {
    m_cost = cost;
    m_cost_isSet = true;
}

bool OAIEstimationItemApiModel::is_cost_Set() const{
    return m_cost_isSet;
}

bool OAIEstimationItemApiModel::is_cost_Valid() const{
    return m_cost_isValid;
}

QString OAIEstimationItemApiModel::getDescription() const {
    return m_description;
}
void OAIEstimationItemApiModel::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIEstimationItemApiModel::is_description_Set() const{
    return m_description_isSet;
}

bool OAIEstimationItemApiModel::is_description_Valid() const{
    return m_description_isValid;
}

double OAIEstimationItemApiModel::getDiscountAmount() const {
    return m_discount_amount;
}
void OAIEstimationItemApiModel::setDiscountAmount(const double &discount_amount) {
    m_discount_amount = discount_amount;
    m_discount_amount_isSet = true;
}

bool OAIEstimationItemApiModel::is_discount_amount_Set() const{
    return m_discount_amount_isSet;
}

bool OAIEstimationItemApiModel::is_discount_amount_Valid() const{
    return m_discount_amount_isValid;
}

double OAIEstimationItemApiModel::getDiscountPercentage() const {
    return m_discount_percentage;
}
void OAIEstimationItemApiModel::setDiscountPercentage(const double &discount_percentage) {
    m_discount_percentage = discount_percentage;
    m_discount_percentage_isSet = true;
}

bool OAIEstimationItemApiModel::is_discount_percentage_Set() const{
    return m_discount_percentage_isSet;
}

bool OAIEstimationItemApiModel::is_discount_percentage_Valid() const{
    return m_discount_percentage_isValid;
}

qint32 OAIEstimationItemApiModel::getId() const {
    return m_id;
}
void OAIEstimationItemApiModel::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEstimationItemApiModel::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEstimationItemApiModel::is_id_Valid() const{
    return m_id_isValid;
}

double OAIEstimationItemApiModel::getQuantity() const {
    return m_quantity;
}
void OAIEstimationItemApiModel::setQuantity(const double &quantity) {
    m_quantity = quantity;
    m_quantity_isSet = true;
}

bool OAIEstimationItemApiModel::is_quantity_Set() const{
    return m_quantity_isSet;
}

bool OAIEstimationItemApiModel::is_quantity_Valid() const{
    return m_quantity_isValid;
}

double OAIEstimationItemApiModel::getSubTotalAmount() const {
    return m_sub_total_amount;
}
void OAIEstimationItemApiModel::setSubTotalAmount(const double &sub_total_amount) {
    m_sub_total_amount = sub_total_amount;
    m_sub_total_amount_isSet = true;
}

bool OAIEstimationItemApiModel::is_sub_total_amount_Set() const{
    return m_sub_total_amount_isSet;
}

bool OAIEstimationItemApiModel::is_sub_total_amount_Valid() const{
    return m_sub_total_amount_isValid;
}

double OAIEstimationItemApiModel::getTaxAmount() const {
    return m_tax_amount;
}
void OAIEstimationItemApiModel::setTaxAmount(const double &tax_amount) {
    m_tax_amount = tax_amount;
    m_tax_amount_isSet = true;
}

bool OAIEstimationItemApiModel::is_tax_amount_Set() const{
    return m_tax_amount_isSet;
}

bool OAIEstimationItemApiModel::is_tax_amount_Valid() const{
    return m_tax_amount_isValid;
}

qint32 OAIEstimationItemApiModel::getTaxId() const {
    return m_tax_id;
}
void OAIEstimationItemApiModel::setTaxId(const qint32 &tax_id) {
    m_tax_id = tax_id;
    m_tax_id_isSet = true;
}

bool OAIEstimationItemApiModel::is_tax_id_Set() const{
    return m_tax_id_isSet;
}

bool OAIEstimationItemApiModel::is_tax_id_Valid() const{
    return m_tax_id_isValid;
}

double OAIEstimationItemApiModel::getTaxPercentage() const {
    return m_tax_percentage;
}
void OAIEstimationItemApiModel::setTaxPercentage(const double &tax_percentage) {
    m_tax_percentage = tax_percentage;
    m_tax_percentage_isSet = true;
}

bool OAIEstimationItemApiModel::is_tax_percentage_Set() const{
    return m_tax_percentage_isSet;
}

bool OAIEstimationItemApiModel::is_tax_percentage_Valid() const{
    return m_tax_percentage_isValid;
}

double OAIEstimationItemApiModel::getTotalAmount() const {
    return m_total_amount;
}
void OAIEstimationItemApiModel::setTotalAmount(const double &total_amount) {
    m_total_amount = total_amount;
    m_total_amount_isSet = true;
}

bool OAIEstimationItemApiModel::is_total_amount_Set() const{
    return m_total_amount_isSet;
}

bool OAIEstimationItemApiModel::is_total_amount_Valid() const{
    return m_total_amount_isValid;
}

qint32 OAIEstimationItemApiModel::getWorkTypeId() const {
    return m_work_type_id;
}
void OAIEstimationItemApiModel::setWorkTypeId(const qint32 &work_type_id) {
    m_work_type_id = work_type_id;
    m_work_type_id_isSet = true;
}

bool OAIEstimationItemApiModel::is_work_type_id_Set() const{
    return m_work_type_id_isSet;
}

bool OAIEstimationItemApiModel::is_work_type_id_Valid() const{
    return m_work_type_id_isValid;
}

bool OAIEstimationItemApiModel::isSet() const {
...
bool OAIEstimationItemApiModel::isValid() const {
