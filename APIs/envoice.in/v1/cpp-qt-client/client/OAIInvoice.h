...
#include "OAIInvoiceAttachment.h"
#include "OAIInvoiceItem.h"
#include "OAIPayment.h"
#include "OAIPaymentGatewayForInvoice.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIActivity;
class OAIInvoiceAttachment;
class OAIInvoiceItem;
class OAIPaymentGatewayForInvoice;
class OAIPayment;
...
public:
    ...
    QList<OAIInvoiceAttachment> getAttachments() const;
    void setAttachments(const QList<OAIInvoiceAttachment> &attachments);
    ...
    qint32 getEstimationId() const;
    void setEstimationId(const qint32 &estimation_id);
    bool is_estimation_id_Set() const;
    bool is_estimation_id_Valid() const;
    ...
    bool isIsDigitallySigned() const;
    void setIsDigitallySigned(const bool &is_digitally_signed);
    bool is_is_digitally_signed_Set() const;
    bool is_is_digitally_signed_Valid() const;
    ...
    QList<OAIPaymentGatewayForInvoice> getPaymentGateways() const;
    void setPaymentGateways(const QList<OAIPaymentGatewayForInvoice> &payment_gateways);
    bool is_payment_gateways_Set() const;
    bool is_payment_gateways_Valid() const;

    qint32 getPaymentLinkId() const;
    void setPaymentLinkId(const qint32 &payment_link_id);
    bool is_payment_link_id_Set() const;
    bool is_payment_link_id_Valid() const;
...
private:
    ...
    QList<OAIInvoiceAttachment> m_attachments;
    ...
    qint32 m_estimation_id;
    bool m_estimation_id_isSet;
    bool m_estimation_id_isValid;
    ...
    bool m_is_digitally_signed;
    bool m_is_digitally_signed_isSet;
    bool m_is_digitally_signed_isValid;
    ...
    QList<OAIPaymentGatewayForInvoice> m_payment_gateways;
    bool m_payment_gateways_isSet;
    bool m_payment_gateways_isValid;

    qint32 m_payment_link_id;
    bool m_payment_link_id_isSet;
    bool m_payment_link_id_isValid;
