...
/*
 * OAIListResult_PaymentLink_.h
 *
 * 
 */

#ifndef OAIListResult_PaymentLink__H
#define OAIListResult_PaymentLink__H
...
namespace OpenAPI {
class OAIIErrorInfo;
class OAIPaymentLink;

class OAIListResult_PaymentLink_ : public OAIObject {
public:
    OAIListResult_PaymentLink_();
    OAIListResult_PaymentLink_(QString json);
    ~OAIListResult_PaymentLink_() override;
    ...
    QList<OAIPaymentLink> getResult() const;
    void setResult(const QList<OAIPaymentLink> &result);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResult_PaymentLink_)

#endif // OAIListResult_PaymentLink__H
