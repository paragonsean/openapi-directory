...
/*
 * OAIInvoiceCreateItemApiModel.h
 *
 * 
 */

#ifndef OAIInvoiceCreateItemApiModel_H
#define OAIInvoiceCreateItemApiModel_H
...
class OAIInvoiceCreateItemApiModel : public OAIObject {
public:
    OAIInvoiceCreateItemApiModel();
    OAIInvoiceCreateItemApiModel(QString json);
    ~OAIInvoiceCreateItemApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceCreateItemApiModel)

#endif // OAIInvoiceCreateItemApiModel_H
