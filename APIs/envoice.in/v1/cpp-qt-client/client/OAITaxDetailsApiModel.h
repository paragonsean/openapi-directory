...
/*
 * OAITaxDetailsApiModel.h
 *
 * 
 */

#ifndef OAITaxDetailsApiModel_H
#define OAITaxDetailsApiModel_H
...
class OAITaxDetailsApiModel : public OAIObject {
public:
    OAITaxDetailsApiModel();
    OAITaxDetailsApiModel(QString json);
    ~OAITaxDetailsApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaxDetailsApiModel)

#endif // OAITaxDetailsApiModel_H
