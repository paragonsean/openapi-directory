...
/*
 * OAIInvoiceUpdateAttachmentApiModel.h
 *
 * 
 */

#ifndef OAIInvoiceUpdateAttachmentApiModel_H
#define OAIInvoiceUpdateAttachmentApiModel_H
...
class OAIInvoiceUpdateAttachmentApiModel : public OAIObject {
public:
    OAIInvoiceUpdateAttachmentApiModel();
    OAIInvoiceUpdateAttachmentApiModel(QString json);
    ~OAIInvoiceUpdateAttachmentApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceUpdateAttachmentApiModel)

#endif // OAIInvoiceUpdateAttachmentApiModel_H
