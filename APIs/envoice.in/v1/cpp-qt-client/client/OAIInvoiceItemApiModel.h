...
/*
 * OAIInvoiceItemApiModel.h
 *
 * 
 */

#ifndef OAIInvoiceItemApiModel_H
#define OAIInvoiceItemApiModel_H
...
class OAIInvoiceItemApiModel : public OAIObject {
public:
    OAIInvoiceItemApiModel();
    OAIInvoiceItemApiModel(QString json);
    ~OAIInvoiceItemApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceItemApiModel)

#endif // OAIInvoiceItemApiModel_H
