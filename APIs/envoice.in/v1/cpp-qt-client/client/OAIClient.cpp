...
QString OAIClient::getAddress() const {
    return m_address;
}
void OAIClient::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIClient::is_address_Set() const{
    return m_address_isSet;
}

bool OAIClient::is_address_Valid() const{
    return m_address_isValid;
}

qint32 OAIClient::getClientCountryId() const {
    return m_client_country_id;
}
void OAIClient::setClientCountryId(const qint32 &client_country_id) {
    m_client_country_id = client_country_id;
    m_client_country_id_isSet = true;
}

bool OAIClient::is_client_country_id_Set() const{
    return m_client_country_id_isSet;
}

bool OAIClient::is_client_country_id_Valid() const{
    return m_client_country_id_isValid;
}

qint32 OAIClient::getClientCurrencyId() const {
    return m_client_currency_id;
}
void OAIClient::setClientCurrencyId(const qint32 &client_currency_id) {
    m_client_currency_id = client_currency_id;
    m_client_currency_id_isSet = true;
}

bool OAIClient::is_client_currency_id_Set() const{
    return m_client_currency_id_isSet;
}

bool OAIClient::is_client_currency_id_Valid() const{
    return m_client_currency_id_isValid;
}

QString OAIClient::getCompanyRegistrationNumber() const {
    return m_company_registration_number;
}
void OAIClient::setCompanyRegistrationNumber(const QString &company_registration_number) {
    m_company_registration_number = company_registration_number;
    m_company_registration_number_isSet = true;
}

bool OAIClient::is_company_registration_number_Set() const{
    return m_company_registration_number_isSet;
}

bool OAIClient::is_company_registration_number_Valid() const{
    return m_company_registration_number_isValid;
}

qint32 OAIClient::getDefaultDueDateInDays() const {
    return m_default_due_date_in_days;
}
void OAIClient::setDefaultDueDateInDays(const qint32 &default_due_date_in_days) {
    m_default_due_date_in_days = default_due_date_in_days;
    m_default_due_date_in_days_isSet = true;
}

bool OAIClient::is_default_due_date_in_days_Set() const{
    return m_default_due_date_in_days_isSet;
}

bool OAIClient::is_default_due_date_in_days_Valid() const{
...
qint32 OAIClient::getId() const {
    return m_id;
}
void OAIClient::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
QString OAIClient::getPhoneNumber() const {
    return m_phone_number;
}
void OAIClient::setPhoneNumber(const QString &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIClient::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIClient::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

qint32 OAIClient::getUiLanguageId() const {
    return m_ui_language_id;
}
void OAIClient::setUiLanguageId(const qint32 &ui_language_id) {
    m_ui_language_id = ui_language_id;
    m_ui_language_id_isSet = true;
}

bool OAIClient::is_ui_language_id_Set() const{
    return m_ui_language_id_isSet;
}

bool OAIClient::is_ui_language_id_Valid() const{
    return m_ui_language_id_isValid;
}

qint32 OAIClient::getUserId() const {
    return m_user_id;
}
void OAIClient::setUserId(const qint32 &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIClient::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIClient::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QString OAIClient::getVat() const {
    return m_vat;
}
void OAIClient::setVat(const QString &vat) {
    m_vat = vat;
    m_vat_isSet = true;
}

bool OAIClient::is_vat_Set() const{
    return m_vat_isSet;
}

bool OAIClient::is_vat_Valid() const{
