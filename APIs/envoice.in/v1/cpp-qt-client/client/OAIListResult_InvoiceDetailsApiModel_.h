...
/*
 * OAIListResult_InvoiceDetailsApiModel_.h
 *
 * 
 */

#ifndef OAIListResult_InvoiceDetailsApiModel__H
#define OAIListResult_InvoiceDetailsApiModel__H
...
namespace OpenAPI {
class OAIIErrorInfo;
class OAIInvoiceDetailsApiModel;

class OAIListResult_InvoiceDetailsApiModel_ : public OAIObject {
public:
    OAIListResult_InvoiceDetailsApiModel_();
    OAIListResult_InvoiceDetailsApiModel_(QString json);
    ~OAIListResult_InvoiceDetailsApiModel_() override;
    ...
    QList<OAIInvoiceDetailsApiModel> getResult() const;
    void setResult(const QList<OAIInvoiceDetailsApiModel> &result);
...
private:
    ...
    QList<OAIInvoiceDetailsApiModel> m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResult_InvoiceDetailsApiModel_)

#endif // OAIListResult_InvoiceDetailsApiModel__H
