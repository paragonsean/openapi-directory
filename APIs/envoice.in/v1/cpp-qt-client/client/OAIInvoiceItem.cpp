...
double OAIInvoiceItem::getCost() const {
    return m_cost;
}
void OAIInvoiceItem::setCost(const double &cost) {
    m_cost = cost;
    m_cost_isSet = true;
}

bool OAIInvoiceItem::is_cost_Set() const{
    return m_cost_isSet;
}

bool OAIInvoiceItem::is_cost_Valid() const{
...
double OAIInvoiceItem::getDiscountAmount() const {
    return m_discount_amount;
}
void OAIInvoiceItem::setDiscountAmount(const double &discount_amount) {
    m_discount_amount = discount_amount;
    m_discount_amount_isSet = true;
}

bool OAIInvoiceItem::is_discount_amount_Set() const{
    return m_discount_amount_isSet;
}

bool OAIInvoiceItem::is_discount_amount_Valid() const{
    return m_discount_amount_isValid;
}

double OAIInvoiceItem::getDiscountPercentage() const {
    return m_discount_percentage;
}
void OAIInvoiceItem::setDiscountPercentage(const double &discount_percentage) {
    m_discount_percentage = discount_percentage;
    m_discount_percentage_isSet = true;
}

bool OAIInvoiceItem::is_discount_percentage_Set() const{
    return m_discount_percentage_isSet;
}

bool OAIInvoiceItem::is_discount_percentage_Valid() const{
    return m_discount_percentage_isValid;
}

qint32 OAIInvoiceItem::getId() const {
    return m_id;
}
void OAIInvoiceItem::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
qint32 OAIInvoiceItem::getInvoiceId() const {
    return m_invoice_id;
}
void OAIInvoiceItem::setInvoiceId(const qint32 &invoice_id) {
    m_invoice_id = invoice_id;
    m_invoice_id_isSet = true;
}

bool OAIInvoiceItem::is_invoice_id_Set() const{
    return m_invoice_id_isSet;
}

bool OAIInvoiceItem::is_invoice_id_Valid() const{
...
double OAIInvoiceItem::getSubTotalAmount() const {
    return m_sub_total_amount;
}
void OAIInvoiceItem::setSubTotalAmount(const double &sub_total_amount) {
    m_sub_total_amount = sub_total_amount;
    m_sub_total_amount_isSet = true;
}

bool OAIInvoiceItem::is_sub_total_amount_Set() const{
    return m_sub_total_amount_isSet;
}

bool OAIInvoiceItem::is_sub_total_amount_Valid() const{
    return m_sub_total_amount_isValid;
}

double OAIInvoiceItem::getTaxAmount() const {
    return m_tax_amount;
}
void OAIInvoiceItem::setTaxAmount(const double &tax_amount) {
    m_tax_amount = tax_amount;
    m_tax_amount_isSet = true;
}

bool OAIInvoiceItem::is_tax_amount_Set() const{
    return m_tax_amount_isSet;
}

bool OAIInvoiceItem::is_tax_amount_Valid() const{
    return m_tax_amount_isValid;
}

qint32 OAIInvoiceItem::getTaxId() const {
    return m_tax_id;
}
void OAIInvoiceItem::setTaxId(const qint32 &tax_id) {
    m_tax_id = tax_id;
    m_tax_id_isSet = true;
}

bool OAIInvoiceItem::is_tax_id_Set() const{
    return m_tax_id_isSet;
}

bool OAIInvoiceItem::is_tax_id_Valid() const{
    return m_tax_id_isValid;
}

double OAIInvoiceItem::getTaxPercentage() const {
    return m_tax_percentage;
}
void OAIInvoiceItem::setTaxPercentage(const double &tax_percentage) {
    m_tax_percentage = tax_percentage;
    m_tax_percentage_isSet = true;
}

bool OAIInvoiceItem::is_tax_percentage_Set() const{
    return m_tax_percentage_isSet;
}

bool OAIInvoiceItem::is_tax_percentage_Valid() const{
    return m_tax_percentage_isValid;
}

double OAIInvoiceItem::getTotalAmount() const {
    return m_total_amount;
}
void OAIInvoiceItem::setTotalAmount(const double &total_amount) {
    m_total_amount = total_amount;
    m_total_amount_isSet = true;
}

bool OAIInvoiceItem::is_total_amount_Set() const{
    return m_total_amount_isSet;
}

bool OAIInvoiceItem::is_total_amount_Valid() const{
    return m_total_amount_isValid;
}

qint32 OAIInvoiceItem::getWorkTypeId() const {
    return m_work_type_id;
}
void OAIInvoiceItem::setWorkTypeId(const qint32 &work_type_id) {
    m_work_type_id = work_type_id;
    m_work_type_id_isSet = true;
}

bool OAIInvoiceItem::is_work_type_id_Set() const{
    return m_work_type_id_isSet;
}

bool OAIInvoiceItem::is_work_type_id_Valid() const{
