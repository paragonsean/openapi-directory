...
/*
 * OAIInvoiceAttachment.h
 *
 * 
 */

#ifndef OAIInvoiceAttachment_H
#define OAIInvoiceAttachment_H
...
class OAIInvoiceAttachment : public OAIObject {
public:
    OAIInvoiceAttachment();
    OAIInvoiceAttachment(QString json);
    ~OAIInvoiceAttachment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceAttachment)

#endif // OAIInvoiceAttachment_H
