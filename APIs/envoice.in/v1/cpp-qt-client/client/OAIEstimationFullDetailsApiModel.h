...
/*
 * OAIEstimationFullDetailsApiModel.h
 *
 * 
 */

#ifndef OAIEstimationFullDetailsApiModel_H
#define OAIEstimationFullDetailsApiModel_H
...
#include "OAIEstimationItemApiModel.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIEstimationActivityApiModel;
class OAIEstimationAttachmentApiModel;
class OAIClientDetailsApiModel;
class OAICurrencyDetailsApiModel;
class OAIEstimationItemApiModel;
class OAIEstimationGatewayApiModel;

class OAIEstimationFullDetailsApiModel : public OAIObject {
public:
    OAIEstimationFullDetailsApiModel();
    OAIEstimationFullDetailsApiModel(QString json);
    ~OAIEstimationFullDetailsApiModel() override;
    ...
    QList<OAIEstimationActivityApiModel> getActivities() const;
    void setActivities(const QList<OAIEstimationActivityApiModel> &activities);
    bool is_activities_Set() const;
    bool is_activities_Valid() const;

    QList<OAIEstimationAttachmentApiModel> getAttachments() const;
    void setAttachments(const QList<OAIEstimationAttachmentApiModel> &attachments);
    ...
    QList<OAIEstimationItemApiModel> getItems() const;
    void setItems(const QList<OAIEstimationItemApiModel> &items);
...
private:
    ...
    QList<OAIEstimationActivityApiModel> m_activities;
    bool m_activities_isSet;
    bool m_activities_isValid;

    QList<OAIEstimationAttachmentApiModel> m_attachments;
    ...
    QList<OAIEstimationItemApiModel> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimationFullDetailsApiModel)

#endif // OAIEstimationFullDetailsApiModel_H
