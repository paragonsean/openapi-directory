...
/*
 * OAIProductItemApiModel.h
 *
 * 
 */

#ifndef OAIProductItemApiModel_H
#define OAIProductItemApiModel_H
...
class OAIProductItemApiModel : public OAIObject {
public:
    OAIProductItemApiModel();
    OAIProductItemApiModel(QString json);
    ~OAIProductItemApiModel() override;
    ...
    void setMinimumQuantity(const double &minimum_quantity);
    bool is_minimum_quantity_Set() const;
    bool is_minimum_quantity_Valid() const;
...
private:
    ...
    double m_minimum_quantity;
    bool m_minimum_quantity_isSet;
    bool m_minimum_quantity_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductItemApiModel)

#endif // OAIProductItemApiModel_H
