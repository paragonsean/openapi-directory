...
/*
 * OAIEstimationDetailsApiModel.h
 *
 * 
 */

#ifndef OAIEstimationDetailsApiModel_H
#define OAIEstimationDetailsApiModel_H
...
class OAIEstimationDetailsApiModel : public OAIObject {
public:
    OAIEstimationDetailsApiModel();
    OAIEstimationDetailsApiModel(QString json);
    ~OAIEstimationDetailsApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimationDetailsApiModel)

#endif // OAIEstimationDetailsApiModel_H
