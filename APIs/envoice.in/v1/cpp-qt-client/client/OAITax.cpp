...
qint32 OAITax::getId() const {
    return m_id;
}
void OAITax::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
...
qint32 OAITax::getUserId() const {
    return m_user_id;
}
void OAITax::setUserId(const qint32 &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAITax::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAITax::is_user_id_Valid() const{
