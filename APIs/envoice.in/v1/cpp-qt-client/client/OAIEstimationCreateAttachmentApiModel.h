...
/*
 * OAIEstimationCreateAttachmentApiModel.h
 *
 * 
 */

#ifndef OAIEstimationCreateAttachmentApiModel_H
#define OAIEstimationCreateAttachmentApiModel_H
...
class OAIEstimationCreateAttachmentApiModel : public OAIObject {
public:
    OAIEstimationCreateAttachmentApiModel();
    OAIEstimationCreateAttachmentApiModel(QString json);
    ~OAIEstimationCreateAttachmentApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimationCreateAttachmentApiModel)

#endif // OAIEstimationCreateAttachmentApiModel_H
