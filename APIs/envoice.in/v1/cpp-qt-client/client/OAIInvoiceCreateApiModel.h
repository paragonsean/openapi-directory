...
/*
 * OAIInvoiceCreateApiModel.h
 *
 * 
 */

#ifndef OAIInvoiceCreateApiModel_H
#define OAIInvoiceCreateApiModel_H

#include <QJsonObject>

#include "OAIInvoiceCreateAttachmentApiModel.h"
...
namespace OpenAPI {
class OAIInvoiceCreateAttachmentApiModel;
class OAIInvoiceCreateItemApiModel;
class OAIInvoiceGatewayApiModel;
class OAIInvoiceRecurringApiModel;

class OAIInvoiceCreateApiModel : public OAIObject {
public:
    OAIInvoiceCreateApiModel();
    OAIInvoiceCreateApiModel(QString json);
    ~OAIInvoiceCreateApiModel() override;
    ...
    QList<OAIInvoiceCreateAttachmentApiModel> getAttachments() const;
    void setAttachments(const QList<OAIInvoiceCreateAttachmentApiModel> &attachments);
    ...
    QList<OAIInvoiceCreateItemApiModel> getItems() const;
    void setItems(const QList<OAIInvoiceCreateItemApiModel> &items);
...
private:
    ...
    QList<OAIInvoiceCreateAttachmentApiModel> m_attachments;
    ...
    QList<OAIInvoiceCreateItemApiModel> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceCreateApiModel)

#endif // OAIInvoiceCreateApiModel_H
