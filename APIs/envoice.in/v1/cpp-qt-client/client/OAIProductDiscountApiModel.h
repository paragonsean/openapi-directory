...
/*
 * OAIProductDiscountApiModel.h
 *
 * 
 */

#ifndef OAIProductDiscountApiModel_H
#define OAIProductDiscountApiModel_H
...
class OAIProductDiscountApiModel : public OAIObject {
public:
    OAIProductDiscountApiModel();
    OAIProductDiscountApiModel(QString json);
    ~OAIProductDiscountApiModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductDiscountApiModel)

#endif // OAIProductDiscountApiModel_H
