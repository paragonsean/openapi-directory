...
public:
    ...
    void setIsAutomatic(const bool &is_automatic);
    bool is_is_automatic_Set() const;
    bool is_is_automatic_Valid() const;
    ...
    QDateTime getPaidOn() const;
    void setPaidOn(const QDateTime &paid_on);
    bool is_paid_on_Set() const;
    bool is_paid_on_Valid() const;
...
private:
    ...
    bool m_is_automatic;
    bool m_is_automatic_isSet;
    bool m_is_automatic_isValid;
    ...
    QDateTime m_paid_on;
    bool m_paid_on_isSet;
    bool m_paid_on_isValid;
