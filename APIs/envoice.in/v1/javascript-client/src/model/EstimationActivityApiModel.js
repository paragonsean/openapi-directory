...
/**
 * The EstimationActivityApiModel model module.
 * @module model/EstimationActivityApiModel
 * @version v1
 */
class EstimationActivityApiModel {
    /**
     * Constructs a new <code>EstimationActivityApiModel</code>.
     * @alias module:model/EstimationActivityApiModel
     */
    constructor() { 
        
        EstimationActivityApiModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EstimationActivityApiModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EstimationActivityApiModel} obj Optional instance to populate.
     * @return {module:model/EstimationActivityApiModel} The populated <code>EstimationActivityApiModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EstimationActivityApiModel();
    ...
    /**
     * Validates the JSON data with respect to <code>EstimationActivityApiModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EstimationActivityApiModel</code>.
     */
 ...
 */
EstimationActivityApiModel.prototype['EstimationNumber'] = undefined;

/**
 * Id of estimation activity
 * @member {Number} Id
 */
EstimationActivityApiModel.prototype['Id'] = undefined;

/**
 * Url which point out to a certain activity action. Ex: Click to view the payment
 * @member {String} Link
 */
EstimationActivityApiModel.prototype['Link'] = undefined;

/**
 * Message associated with the activity
 * @member {String} Message
 */
EstimationActivityApiModel.prototype['Message'] = undefined;

/**
 * Type of the activity
 * @member {module:model/EstimationActivityApiModel.TypeEnum} Type
 */
EstimationActivityApiModel.prototype['Type'] = undefined;
 ...
 * @readonly
 */
EstimationActivityApiModel['TypeEnum'] = {
...
export default EstimationActivityApiModel;
