...
/**
 * The ClientCreateApiModel model module.
 * @module model/ClientCreateApiModel
 * @version v1
 */
class ClientCreateApiModel {
    /**
     * Constructs a new <code>ClientCreateApiModel</code>.
     * @alias module:model/ClientCreateApiModel
     */
    constructor() { 
        
        ClientCreateApiModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClientCreateApiModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClientCreateApiModel} obj Optional instance to populate.
     * @return {module:model/ClientCreateApiModel} The populated <code>ClientCreateApiModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientCreateApiModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ClientCreateApiModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientCreateApiModel</code>.
     */
 ...
 */
ClientCreateApiModel.prototype['AdditionalEmails'] = undefined;

/**
 * Client business address
 * @member {String} Address
 */
ClientCreateApiModel.prototype['Address'] = undefined;

/**
 * Indicates the country where the clients is from
 * @member {Number} ClientCountryId
 */
ClientCreateApiModel.prototype['ClientCountryId'] = undefined;

/**
 * Indicates the default system currency used by the user for the client
 * @member {Number} ClientCurrencyId
 */
ClientCreateApiModel.prototype['ClientCurrencyId'] = undefined;

/**
 * Client's Company Registration Number
 * @member {String} CompanyRegistrationNumber
 */
ClientCreateApiModel.prototype['CompanyRegistrationNumber'] = undefined;

/**
 * Client custom payment terms
 * @member {Number} DefaultDueDateInDays
 */
ClientCreateApiModel.prototype['DefaultDueDateInDays'] = undefined;

/**
 * Client email
 * @member {String} Email
 */
ClientCreateApiModel.prototype['Email'] = undefined;

/**
 * Name of the client
 * @member {String} Name
 */
ClientCreateApiModel.prototype['Name'] = undefined;

/**
 * Client phone numer
 * @member {String} PhoneNumber
 */
ClientCreateApiModel.prototype['PhoneNumber'] = undefined;

/**
 * Hold a value of the language in which the invoice will be sent
 * @member {Number} UiLanguageId
 */
ClientCreateApiModel.prototype['UiLanguageId'] = undefined;

/**
 * Client's VAT number
 * @member {String} Vat
 */
ClientCreateApiModel.prototype['Vat'] = undefined;
...
export default ClientCreateApiModel;
