...
/**
 * The ProductUpdateApiModel model module.
 * @module model/ProductUpdateApiModel
 * @version v1
 */
class ProductUpdateApiModel {
    /**
     * Constructs a new <code>ProductUpdateApiModel</code>.
     * @alias module:model/ProductUpdateApiModel
     */
    constructor() { 
        
        ProductUpdateApiModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProductUpdateApiModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProductUpdateApiModel} obj Optional instance to populate.
     * @return {module:model/ProductUpdateApiModel} The populated <code>ProductUpdateApiModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductUpdateApiModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ProductUpdateApiModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductUpdateApiModel</code>.
     */
 ...
 */
ProductUpdateApiModel.prototype['AfterPaymentDescription'] = undefined;

/**
 * List of product attachments
 * @member {Array.<module:model/ProductAttachmentApiModel>} Attachments
 */
ProductUpdateApiModel.prototype['Attachments'] = undefined;

/**
 * Default button call to action  Ex: Buy now, subscribe, ...
 * @member {String} ButtonCallToAction
 */
ProductUpdateApiModel.prototype['ButtonCallToAction'] = undefined;

/**
 * List of product coupons
 * @member {Array.<module:model/ProductCouponApiModel>} Coupons
 */
ProductUpdateApiModel.prototype['Coupons'] = undefined;

/**
 * Foreign key Currency
 * @member {Number} CurrencyId
 */
ProductUpdateApiModel.prototype['CurrencyId'] = undefined;

/**
 * Product description
 * @member {String} Description
 */
ProductUpdateApiModel.prototype['Description'] = undefined;

/**
 * List of product discounts
 * @member {Array.<module:model/ProductDiscountApiModel>} Discounts
 */
ProductUpdateApiModel.prototype['Discounts'] = undefined;

/**
 * Product id
 * @member {Number} Id
 */
ProductUpdateApiModel.prototype['Id'] = undefined;

/**
 * Indicate that the product is set as featured
 * @member {Boolean} IsFeatured
 */
ProductUpdateApiModel.prototype['IsFeatured'] = undefined;

/**
 * List of product items
 * @member {Array.<module:model/ProductItemApiModel>} Items
 */
ProductUpdateApiModel.prototype['Items'] = undefined;

/**
 * Product alias
 * @member {String} Name
 */
ProductUpdateApiModel.prototype['Name'] = undefined;

/**
 * List of enabled payment gateways for this product
 * @member {Array.<module:model/ProductGatewayApiModel>} PaymentGateways
 */
ProductUpdateApiModel.prototype['PaymentGateways'] = undefined;

/**
 * Cost for shipping the product
 * @member {Number} ShippingAmount
 */
ProductUpdateApiModel.prototype['ShippingAmount'] = undefined;

/**
 * Client instructions for shipping
 * @member {String} ShippingDescription
 */
ProductUpdateApiModel.prototype['ShippingDescription'] = undefined;

/**
 * Product availability status
 * @member {module:model/ProductUpdateApiModel.StatusEnum} Status
 */
ProductUpdateApiModel.prototype['Status'] = undefined;

/**
 * What happens next description
 * @member {String} WhatHappensNextDescription
 */
ProductUpdateApiModel.prototype['WhatHappensNextDescription'] = undefined;
 ...
 * @readonly
 */
ProductUpdateApiModel['StatusEnum'] = {
...
export default ProductUpdateApiModel;
