...
/**
 * The ProductCreateApiModel model module.
 * @module model/ProductCreateApiModel
 * @version v1
 */
class ProductCreateApiModel {
    /**
     * Constructs a new <code>ProductCreateApiModel</code>.
     * @alias module:model/ProductCreateApiModel
     */
    constructor() { 
        
        ProductCreateApiModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProductCreateApiModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProductCreateApiModel} obj Optional instance to populate.
     * @return {module:model/ProductCreateApiModel} The populated <code>ProductCreateApiModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductCreateApiModel();
    ...
    /**
     * Validates the JSON data with respect to <code>ProductCreateApiModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductCreateApiModel</code>.
     */
 ...
 */
ProductCreateApiModel.prototype['AfterPaymentDescription'] = undefined;

/**
 * List of product attachments
 * @member {Array.<module:model/ProductAttachmentApiModel>} Attachments
 */
ProductCreateApiModel.prototype['Attachments'] = undefined;

/**
 * Default button call to action  Ex: Buy now, subscribe, ...
 * @member {String} ButtonCallToAction
 */
ProductCreateApiModel.prototype['ButtonCallToAction'] = undefined;

/**
 * List of product coupons
 * @member {Array.<module:model/ProductCouponApiModel>} Coupons
 */
ProductCreateApiModel.prototype['Coupons'] = undefined;

/**
 * Foreign key Currency
 * @member {Number} CurrencyId
 */
ProductCreateApiModel.prototype['CurrencyId'] = undefined;

/**
 * Product description
 * @member {String} Description
 */
ProductCreateApiModel.prototype['Description'] = undefined;

/**
 * List of product discounts
 * @member {Array.<module:model/ProductDiscountApiModel>} Discounts
 */
ProductCreateApiModel.prototype['Discounts'] = undefined;

/**
 * Indicate that the product is set as featured
 * @member {Boolean} IsFeatured
 */
ProductCreateApiModel.prototype['IsFeatured'] = undefined;

/**
 * List of product items
 * @member {Array.<module:model/ProductItemApiModel>} Items
 */
ProductCreateApiModel.prototype['Items'] = undefined;

/**
 * Product alias
 * @member {String} Name
 */
ProductCreateApiModel.prototype['Name'] = undefined;

/**
 * List of enabled payment gateways for this product
 * @member {Array.<module:model/ProductGatewayApiModel>} PaymentGateways
 */
ProductCreateApiModel.prototype['PaymentGateways'] = undefined;

/**
 * Cost for shipping the product
 * @member {Number} ShippingAmount
 */
ProductCreateApiModel.prototype['ShippingAmount'] = undefined;

/**
 * Client instructions for shipping
 * @member {String} ShippingDescription
 */
ProductCreateApiModel.prototype['ShippingDescription'] = undefined;

/**
 * Product availability status
 * @member {module:model/ProductCreateApiModel.StatusEnum} Status
 */
ProductCreateApiModel.prototype['Status'] = undefined;

/**
 * What happens next description
 * @member {String} WhatHappensNextDescription
 */
ProductCreateApiModel.prototype['WhatHappensNextDescription'] = undefined;
 ...
 * @readonly
 */
ProductCreateApiModel['StatusEnum'] = {
...
export default ProductCreateApiModel;
