...
/**
 * The InvoiceUpdateApiModel model module.
 * @module model/InvoiceUpdateApiModel
 * @version v1
 */
class InvoiceUpdateApiModel {
    /**
     * Constructs a new <code>InvoiceUpdateApiModel</code>.
     * @alias module:model/InvoiceUpdateApiModel
     */
    constructor() { 
        
        InvoiceUpdateApiModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InvoiceUpdateApiModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InvoiceUpdateApiModel} obj Optional instance to populate.
     * @return {module:model/InvoiceUpdateApiModel} The populated <code>InvoiceUpdateApiModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InvoiceUpdateApiModel();

            if (data.hasOwnProperty('Attachments')) {
                obj['Attachments'] = ApiClient.convertToType(data['Attachments'], [InvoiceUpdateAttachmentApiModel]);
            }
            ...
            if (data.hasOwnProperty('Items')) {
                obj['Items'] = ApiClient.convertToType(data['Items'], [InvoiceUpdateItemApiModel]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InvoiceUpdateApiModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InvoiceUpdateApiModel</code>.
     */
    static validateJSON(data) {
        if (data['Attachments']) { // data not null
            ...
            for (const item of data['Attachments']) {
                InvoiceUpdateAttachmentApiModel.validateJSON(item);
            };
        }
        if (data['Items']) { // data not null
            ...
            for (const item of data['Items']) {
                InvoiceUpdateItemApiModel.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/InvoiceUpdateAttachmentApiModel>} Attachments
 */
InvoiceUpdateApiModel.prototype['Attachments'] = undefined;

/**
 * The client to whom this invoice is assigned
 * @member {Number} ClientId
 */
InvoiceUpdateApiModel.prototype['ClientId'] = undefined;

/**
 * Indicate from which invoice this invoice has been cloned from
 * @member {Number} ClonedFromId
 */
InvoiceUpdateApiModel.prototype['ClonedFromId'] = undefined;

/**
 * Id of the currency for the invoice amounts
 * @member {Number} CurrencyId
 */
InvoiceUpdateApiModel.prototype['CurrencyId'] = undefined;

/**
 * Indicates when the invoice will be proclamed as due
 * @member {Date} Duedate
 */
InvoiceUpdateApiModel.prototype['Duedate'] = undefined;

/**
 * Invoice id
 * @member {Number} Id
 */
InvoiceUpdateApiModel.prototype['Id'] = undefined;

/**
 * Hold the id of the invoice category
 * @member {Number} InvoiceCategoryId
 */
InvoiceUpdateApiModel.prototype['InvoiceCategoryId'] = undefined;

/**
 * Indicates when the invoice was issued
 * @member {Date} IssuedOn
 */
InvoiceUpdateApiModel.prototype['IssuedOn'] = undefined;

/**
 * List of invoice items
 * @member {Array.<module:model/InvoiceUpdateItemApiModel>} Items
 */
InvoiceUpdateApiModel.prototype['Items'] = undefined;

/**
 * Internal note regarding the invoice
 * @member {String} Notes
 */
InvoiceUpdateApiModel.prototype['Notes'] = undefined;

/**
 * Unique invoice number
 * @member {String} Number
 */
InvoiceUpdateApiModel.prototype['Number'] = undefined;

/**
 * List of enabled payment gateways for this invoice
 * @member {Array.<module:model/InvoiceGatewayApiModel>} PaymentGateways
 */
InvoiceUpdateApiModel.prototype['PaymentGateways'] = undefined;

/**
 * Unique number generated by the buyer
 * @member {String} PoNumber
 */
InvoiceUpdateApiModel.prototype['PoNumber'] = undefined;

/**
 * @member {module:model/InvoiceRecurringApiModel} RecurringProfile
 */
InvoiceUpdateApiModel.prototype['RecurringProfile'] = undefined;

/**
 * Hold the id of the recurring profile
 * @member {Number} RecurringProfileId
 */
InvoiceUpdateApiModel.prototype['RecurringProfileId'] = undefined;

/**
 * Should send email reminders to client?
 * @member {Boolean} ShouldSendReminders
 */
InvoiceUpdateApiModel.prototype['ShouldSendReminders'] = undefined;

/**
 * Indicate the status of the invoice (paid/unpaid/overdue)
 * @member {module:model/InvoiceUpdateApiModel.StatusEnum} Status
 */
InvoiceUpdateApiModel.prototype['Status'] = undefined;

/**
 * Terms of agreement
 * @member {String} Terms
 */
InvoiceUpdateApiModel.prototype['Terms'] = undefined;
 ...
 * @readonly
 */
InvoiceUpdateApiModel['StatusEnum'] = {
...
export default InvoiceUpdateApiModel;
