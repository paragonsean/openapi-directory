...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://www.envoice.in') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://www.envoice.in
         */
        ...
        this.authentications = {
            'x-auth-key': {type: 'apiKey', 'in': 'header', name: 'x-auth-key'},
            'x-auth-secret': {type: 'apiKey', 'in': 'header', name: 'x-auth-secret'}
        }
