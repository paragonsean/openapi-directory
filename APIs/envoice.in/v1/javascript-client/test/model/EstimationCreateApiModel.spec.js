...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.EstimationCreateApiModel();
  });
  ...
  describe('EstimationCreateApiModel', function() {
    it('should create an instance of EstimationCreateApiModel', function() {
      // uncomment below and update the code to test EstimationCreateApiModel
      //var instance = new ApiV100.EstimationCreateApiModel();
      //expect(instance).to.be.a(ApiV100.EstimationCreateApiModel);
    });
