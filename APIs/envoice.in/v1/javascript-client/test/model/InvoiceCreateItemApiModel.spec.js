...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.InvoiceCreateItemApiModel();
  });
  ...
  describe('InvoiceCreateItemApiModel', function() {
    it('should create an instance of InvoiceCreateItemApiModel', function() {
      // uncomment below and update the code to test InvoiceCreateItemApiModel
      //var instance = new ApiV100.InvoiceCreateItemApiModel();
      //expect(instance).to.be.a(ApiV100.InvoiceCreateItemApiModel);
    });
