...
(function(root, factory) {
  ...
  describe('Activity', function() {
    it('should create an instance of Activity', function() {
      ...
      //var instance = new ApiV100.Activity();
      //expect(instance).to.be.a(ApiV100.Activity);
    });
    ...
    it('should have the property estimationNumber (base name: "EstimationNumber")', function() {
      // uncomment below and update the code to test the property estimationNumber
      //var instance = new ApiV100.Activity();
      //expect(instance).to.be();
    });
