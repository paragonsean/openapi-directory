...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.SendInvoiceToClientApiModel();
  });
  ...
  describe('SendInvoiceToClientApiModel', function() {
    it('should create an instance of SendInvoiceToClientApiModel', function() {
      // uncomment below and update the code to test SendInvoiceToClientApiModel
      //var instance = new ApiV100.SendInvoiceToClientApiModel();
      //expect(instance).to.be.a(ApiV100.SendInvoiceToClientApiModel);
    });
