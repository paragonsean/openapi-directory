...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.InvoiceUpdateItemApiModel();
  });
  ...
  describe('InvoiceUpdateItemApiModel', function() {
    it('should create an instance of InvoiceUpdateItemApiModel', function() {
      // uncomment below and update the code to test InvoiceUpdateItemApiModel
      //var instance = new ApiV100.InvoiceUpdateItemApiModel();
      //expect(instance).to.be.a(ApiV100.InvoiceUpdateItemApiModel);
    });
