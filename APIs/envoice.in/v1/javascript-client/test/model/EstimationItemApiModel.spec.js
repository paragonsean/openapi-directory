...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.EstimationItemApiModel();
  });
  ...
  describe('EstimationItemApiModel', function() {
    it('should create an instance of EstimationItemApiModel', function() {
      // uncomment below and update the code to test EstimationItemApiModel
      //var instance = new ApiV100.EstimationItemApiModel();
      //expect(instance).to.be.a(ApiV100.EstimationItemApiModel);
    });
