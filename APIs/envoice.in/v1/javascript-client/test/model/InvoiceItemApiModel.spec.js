...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.InvoiceItemApiModel();
  });
  ...
  describe('InvoiceItemApiModel', function() {
    it('should create an instance of InvoiceItemApiModel', function() {
      // uncomment below and update the code to test InvoiceItemApiModel
      //var instance = new ApiV100.InvoiceItemApiModel();
      //expect(instance).to.be.a(ApiV100.InvoiceItemApiModel);
    });
