...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.OrderFullDetailsApiModel();
  });
  ...
  describe('OrderFullDetailsApiModel', function() {
    it('should create an instance of OrderFullDetailsApiModel', function() {
      // uncomment below and update the code to test OrderFullDetailsApiModel
      //var instance = new ApiV100.OrderFullDetailsApiModel();
      //expect(instance).to.be.a(ApiV100.OrderFullDetailsApiModel);
    });
