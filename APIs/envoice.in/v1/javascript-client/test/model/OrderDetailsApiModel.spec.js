...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.OrderDetailsApiModel();
  });
  ...
  describe('OrderDetailsApiModel', function() {
    it('should create an instance of OrderDetailsApiModel', function() {
      // uncomment below and update the code to test OrderDetailsApiModel
      //var instance = new ApiV100.OrderDetailsApiModel();
      //expect(instance).to.be.a(ApiV100.OrderDetailsApiModel);
    });
    ...
    it('should have the property orderBillingDetails (base name: "OrderBillingDetails")', function() {
      // uncomment below and update the code to test the property orderBillingDetails
      //var instance = new ApiV100.OrderDetailsApiModel();
      //expect(instance).to.be();
    });

    it('should have the property orderShippingDetails (base name: "OrderShippingDetails")', function() {
      // uncomment below and update the code to test the property orderShippingDetails
      //var instance = new ApiV100.OrderDetailsApiModel();
      //expect(instance).to.be();
    });
    ...
    it('should have the property totalWithShipping (base name: "TotalWithShipping")', function() {
      // uncomment below and update the code to test the property totalWithShipping
      //var instance = new ApiV100.OrderDetailsApiModel();
      //expect(instance).to.be();
    });
