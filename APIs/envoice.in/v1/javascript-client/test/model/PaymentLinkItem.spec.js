...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.PaymentLinkItem();
  });
  ...
  describe('PaymentLinkItem', function() {
    it('should create an instance of PaymentLinkItem', function() {
      // uncomment below and update the code to test PaymentLinkItem
      //var instance = new ApiV100.PaymentLinkItem();
      //expect(instance).to.be.a(ApiV100.PaymentLinkItem);
    });
