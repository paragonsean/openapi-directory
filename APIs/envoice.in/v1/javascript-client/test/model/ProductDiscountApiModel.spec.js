...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.ProductDiscountApiModel();
  });
  ...
  describe('ProductDiscountApiModel', function() {
    it('should create an instance of ProductDiscountApiModel', function() {
      // uncomment below and update the code to test ProductDiscountApiModel
      //var instance = new ApiV100.ProductDiscountApiModel();
      //expect(instance).to.be.a(ApiV100.ProductDiscountApiModel);
    });
