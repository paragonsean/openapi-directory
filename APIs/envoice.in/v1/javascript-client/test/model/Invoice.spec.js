...
(function(root, factory) {
  ...
  describe('Invoice', function() {
    it('should create an instance of Invoice', function() {
      ...
      //var instance = new ApiV100.Invoice();
      //expect(instance).to.be.a(ApiV100.Invoice);
    });
    ...
    it('should have the property isDigitallySigned (base name: "IsDigitallySigned")', function() {
      // uncomment below and update the code to test the property isDigitallySigned
      //var instance = new ApiV100.Invoice();
      //expect(instance).to.be();
    });
