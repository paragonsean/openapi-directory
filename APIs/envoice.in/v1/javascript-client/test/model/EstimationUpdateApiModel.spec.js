...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.EstimationUpdateApiModel();
  });
  ...
  describe('EstimationUpdateApiModel', function() {
    it('should create an instance of EstimationUpdateApiModel', function() {
      // uncomment below and update the code to test EstimationUpdateApiModel
      //var instance = new ApiV100.EstimationUpdateApiModel();
      //expect(instance).to.be.a(ApiV100.EstimationUpdateApiModel);
    });
