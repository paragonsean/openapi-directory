...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.EstimationDetailsApiModel();
  });
  ...
  describe('EstimationDetailsApiModel', function() {
    it('should create an instance of EstimationDetailsApiModel', function() {
      // uncomment below and update the code to test EstimationDetailsApiModel
      //var instance = new ApiV100.EstimationDetailsApiModel();
      //expect(instance).to.be.a(ApiV100.EstimationDetailsApiModel);
    });
