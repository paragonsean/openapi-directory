...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.ClientCreateApiModel();
  });
  ...
  describe('ClientCreateApiModel', function() {
    it('should create an instance of ClientCreateApiModel', function() {
      // uncomment below and update the code to test ClientCreateApiModel
      //var instance = new ApiV100.ClientCreateApiModel();
      //expect(instance).to.be.a(ApiV100.ClientCreateApiModel);
    });
