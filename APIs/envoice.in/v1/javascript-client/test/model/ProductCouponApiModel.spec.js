...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.ProductCouponApiModel();
  });
  ...
  describe('ProductCouponApiModel', function() {
    it('should create an instance of ProductCouponApiModel', function() {
      // uncomment below and update the code to test ProductCouponApiModel
      //var instance = new ApiV100.ProductCouponApiModel();
      //expect(instance).to.be.a(ApiV100.ProductCouponApiModel);
    });
