...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.ProductItemApiModel();
  });
  ...
  describe('ProductItemApiModel', function() {
    it('should create an instance of ProductItemApiModel', function() {
      // uncomment below and update the code to test ProductItemApiModel
      //var instance = new ApiV100.ProductItemApiModel();
      //expect(instance).to.be.a(ApiV100.ProductItemApiModel);
    });
