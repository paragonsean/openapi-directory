...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiV100.EstimationFullDetailsApiModel();
  });
  ...
  describe('EstimationFullDetailsApiModel', function() {
    it('should create an instance of EstimationFullDetailsApiModel', function() {
      // uncomment below and update the code to test EstimationFullDetailsApiModel
      //var instance = new ApiV100.EstimationFullDetailsApiModel();
      //expect(instance).to.be.a(ApiV100.EstimationFullDetailsApiModel);
    });
