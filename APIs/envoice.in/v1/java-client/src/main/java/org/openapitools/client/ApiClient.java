...
public class ApiClient {
    ...
    private String basePath = "https://www.envoice.in";
    ...
    public ApiClient() {
        ...
        authentications.put("x-auth-key", new ApiKeyAuth("header", "x-auth-key"));
        authentications.put("x-auth-secret", new ApiKeyAuth("header", "x-auth-secret"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.envoice.in
