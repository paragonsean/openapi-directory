...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TvApi.ScheduleApi();
  });
  ...
  describe('ScheduleApi', function() {
    describe('listSchedule', function() {
      it('should call listSchedule successfully', function(done) {
        //uncomment below and update the code to test listSchedule
        //instance.listSchedule(function(error) {
