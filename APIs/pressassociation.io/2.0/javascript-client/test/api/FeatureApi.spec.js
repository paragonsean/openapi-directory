...
(function(root, factory) {
  ...
  describe('FeatureApi', function() {
    ...
    describe('listFeatureTypes', function() {
      it('should call listFeatureTypes successfully', function(done) {
        //uncomment below and update the code to test listFeatureTypes
        //instance.listFeatureTypes(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
