...
/*
 * OAIOrganizationSource.h
 *
 * 
 */

#ifndef OAIOrganizationSource_H
#define OAIOrganizationSource_H
...
namespace OpenAPI {
class OAIOrganizationSourceData;
class OAIOrganizationSourceLinks;

class OAIOrganizationSource : public OAIObject {
public:
    OAIOrganizationSource();
    OAIOrganizationSource(QString json);
    ~OAIOrganizationSource() override;
    ...
    OAIOrganizationSourceData getData() const;
    void setData(const OAIOrganizationSourceData &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIOrganizationSourceLinks getLinks() const;
    void setLinks(const OAIOrganizationSourceLinks &links);
...
private:
    ...
    OAIOrganizationSourceData m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIOrganizationSourceLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationSource)

#endif // OAIOrganizationSource_H
