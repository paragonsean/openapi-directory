...
#include "OAIPaymentProviderRelationships.h"
...
OAIPaymentProviderRelationships::OAIPaymentProviderRelationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentProviderRelationships::OAIPaymentProviderRelationships() {
    this->initializeModel();
}

OAIPaymentProviderRelationships::~OAIPaymentProviderRelationships() {}

void OAIPaymentProviderRelationships::initializeModel() {
...
void OAIPaymentProviderRelationships::fromJson(QString jsonString) {
...
void OAIPaymentProviderRelationships::fromJsonObject(QJsonObject json) {

    m_organization_isValid = ::OpenAPI::fromJsonValue(m_organization, json[QString("organization")]);
    m_organization_isSet = !json[QString("organization")].isNull() && m_organization_isValid;

    m_payment_methods_isValid = ::OpenAPI::fromJsonValue(m_payment_methods, json[QString("payment-methods")]);
    m_payment_methods_isSet = !json[QString("payment-methods")].isNull() && m_payment_methods_isValid;
}

QString OAIPaymentProviderRelationships::asJson() const {
...
QJsonObject OAIPaymentProviderRelationships::asJsonObject() const {
    QJsonObject obj;
    if (m_organization.isSet()) {
        obj.insert(QString("organization"), ::OpenAPI::toJsonValue(m_organization));
    }
    if (m_payment_methods.isSet()) {
        obj.insert(QString("payment-methods"), ::OpenAPI::toJsonValue(m_payment_methods));
    }
    return obj;
}

OAIPaymentProviderOrganization OAIPaymentProviderRelationships::getOrganization() const {
    return m_organization;
}
void OAIPaymentProviderRelationships::setOrganization(const OAIPaymentProviderOrganization &organization) {
    m_organization = organization;
    m_organization_isSet = true;
}

bool OAIPaymentProviderRelationships::is_organization_Set() const{
    return m_organization_isSet;
}

bool OAIPaymentProviderRelationships::is_organization_Valid() const{
    return m_organization_isValid;
}

OAIPaymentProviderPaymentMethods OAIPaymentProviderRelationships::getPaymentMethods() const {
    return m_payment_methods;
}
void OAIPaymentProviderRelationships::setPaymentMethods(const OAIPaymentProviderPaymentMethods &payment_methods) {
    m_payment_methods = payment_methods;
    m_payment_methods_isSet = true;
}

bool OAIPaymentProviderRelationships::is_payment_methods_Set() const{
    return m_payment_methods_isSet;
}

bool OAIPaymentProviderRelationships::is_payment_methods_Valid() const{
    return m_payment_methods_isValid;
}

bool OAIPaymentProviderRelationships::isSet() const {
...
bool OAIPaymentProviderRelationships::isValid() const {
