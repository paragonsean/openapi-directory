...
#include "OAIDepositMethodRelationships.h"
...
OAIDepositMethodRelationships::OAIDepositMethodRelationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDepositMethodRelationships::OAIDepositMethodRelationships() {
    this->initializeModel();
}

OAIDepositMethodRelationships::~OAIDepositMethodRelationships() {}

void OAIDepositMethodRelationships::initializeModel() {

    m_actiove_in_countries_isSet = false;
    m_actiove_in_countries_isValid = false;
    ...
    m_supported_psps_isSet = false;
    m_supported_psps_isValid = false;
}

void OAIDepositMethodRelationships::fromJson(QString jsonString) {
...
void OAIDepositMethodRelationships::fromJsonObject(QJsonObject json) {

    m_actiove_in_countries_isValid = ::OpenAPI::fromJsonValue(m_actiove_in_countries, json[QString("actiove_in_countries")]);
    m_actiove_in_countries_isSet = !json[QString("actiove_in_countries")].isNull() && m_actiove_in_countries_isValid;
    ...
    m_supported_psps_isValid = ::OpenAPI::fromJsonValue(m_supported_psps, json[QString("supported_psps")]);
    m_supported_psps_isSet = !json[QString("supported_psps")].isNull() && m_supported_psps_isValid;
}

QString OAIDepositMethodRelationships::asJson() const {
...
QJsonObject OAIDepositMethodRelationships::asJsonObject() const {
    QJsonObject obj;
    if (m_actiove_in_countries.isSet()) {
        obj.insert(QString("actiove_in_countries"), ::OpenAPI::toJsonValue(m_actiove_in_countries));
    }
    if (m_currencies.isSet()) {
        obj.insert(QString("currencies"), ::OpenAPI::toJsonValue(m_currencies));
    }
    if (m_payment_processor.isSet()) {
        obj.insert(QString("payment_processor"), ::OpenAPI::toJsonValue(m_payment_processor));
    }
    if (m_supported_psps.isSet()) {
        obj.insert(QString("supported_psps"), ::OpenAPI::toJsonValue(m_supported_psps));
    }
    return obj;
}

OAIActiveInCountriesRelationship OAIDepositMethodRelationships::getActioveInCountries() const {
    return m_actiove_in_countries;
}
void OAIDepositMethodRelationships::setActioveInCountries(const OAIActiveInCountriesRelationship &actiove_in_countries) {
    m_actiove_in_countries = actiove_in_countries;
    m_actiove_in_countries_isSet = true;
}

bool OAIDepositMethodRelationships::is_actiove_in_countries_Set() const{
    return m_actiove_in_countries_isSet;
}

bool OAIDepositMethodRelationships::is_actiove_in_countries_Valid() const{
    return m_actiove_in_countries_isValid;
}

OAICurrencyParent OAIDepositMethodRelationships::getCurrencies() const {
    return m_currencies;
}
void OAIDepositMethodRelationships::setCurrencies(const OAICurrencyParent &currencies) {
    m_currencies = currencies;
    m_currencies_isSet = true;
}

bool OAIDepositMethodRelationships::is_currencies_Set() const{
    return m_currencies_isSet;
}

bool OAIDepositMethodRelationships::is_currencies_Valid() const{
    return m_currencies_isValid;
}

OAIDepositMethodProcessorData OAIDepositMethodRelationships::getPaymentProcessor() const {
    return m_payment_processor;
}
void OAIDepositMethodRelationships::setPaymentProcessor(const OAIDepositMethodProcessorData &payment_processor) {
    m_payment_processor = payment_processor;
    m_payment_processor_isSet = true;
}

bool OAIDepositMethodRelationships::is_payment_processor_Set() const{
    return m_payment_processor_isSet;
}

bool OAIDepositMethodRelationships::is_payment_processor_Valid() const{
    return m_payment_processor_isValid;
}

OAISupportedPspsRelationship OAIDepositMethodRelationships::getSupportedPsps() const {
    return m_supported_psps;
}
void OAIDepositMethodRelationships::setSupportedPsps(const OAISupportedPspsRelationship &supported_psps) {
    m_supported_psps = supported_psps;
    m_supported_psps_isSet = true;
}

bool OAIDepositMethodRelationships::is_supported_psps_Set() const{
    return m_supported_psps_isSet;
}

bool OAIDepositMethodRelationships::is_supported_psps_Valid() const{
    return m_supported_psps_isValid;
}

bool OAIDepositMethodRelationships::isSet() const {
...
bool OAIDepositMethodRelationships::isValid() const {
