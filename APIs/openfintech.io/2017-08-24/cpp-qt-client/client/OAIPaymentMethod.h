...
#include "OAIPaymentMethodAttributes.h"
...
namespace OpenAPI {
class OAIPaymentMethodAttributes;
class OAISelfLinks;
class OAIPaymentMethodRelationships;
...
public:
    ...
    OAIPaymentMethodAttributes getAttributes() const;
    void setAttributes(const OAIPaymentMethodAttributes &attributes);
    ...
    OAIPaymentMethodRelationships getRelationships() const;
    void setRelationships(const OAIPaymentMethodRelationships &relationships);
...
private:
    ...
    OAIPaymentMethodAttributes m_attributes;
    ...
    OAIPaymentMethodRelationships m_relationships;
