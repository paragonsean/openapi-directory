...
#include "OAICountryTranslationsLinks.h"
...
OAICountryTranslationsLinks::OAICountryTranslationsLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICountryTranslationsLinks::OAICountryTranslationsLinks() {
    this->initializeModel();
}

OAICountryTranslationsLinks::~OAICountryTranslationsLinks() {}

void OAICountryTranslationsLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAICountryTranslationsLinks::fromJson(QString jsonString) {
...
void OAICountryTranslationsLinks::fromJsonObject(QJsonObject json) {
...
QString OAICountryTranslationsLinks::asJson() const {
...
QJsonObject OAICountryTranslationsLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAICountryTranslationsLinks::getRelated() const {
    return m_related;
}
void OAICountryTranslationsLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAICountryTranslationsLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAICountryTranslationsLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAICountryTranslationsLinks::isSet() const {
...
bool OAICountryTranslationsLinks::isValid() const {
