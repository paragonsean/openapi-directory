...
#include "OAIExchangerResponse.h"
...
OAIExchangerResponse::OAIExchangerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExchangerResponse::OAIExchangerResponse() {
    this->initializeModel();
}

OAIExchangerResponse::~OAIExchangerResponse() {}

void OAIExchangerResponse::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIExchangerResponse::fromJson(QString jsonString) {
...
void OAIExchangerResponse::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIExchangerResponse::asJson() const {
...
QJsonObject OAIExchangerResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIExchanger OAIExchangerResponse::getData() const {
    return m_data;
}
void OAIExchangerResponse::setData(const OAIExchanger &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIExchangerResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIExchangerResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIExchangerResponse::isSet() const {
...
bool OAIExchangerResponse::isValid() const {
