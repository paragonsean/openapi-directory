...
void OAIBank::fromJson(QString jsonString) {
...
void OAIBank::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIBank::asJsonObject() const {
    QJsonObject obj;
...
OAIBankAttributes OAIBank::getAttributes() const {
    return m_attributes;
}
void OAIBank::setAttributes(const OAIBankAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIBank::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIBank::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIBank::getId() const {
    return m_id;
}
void OAIBank::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBank::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBank::is_id_Valid() const{
    return m_id_isValid;
}

OAISelfLinks OAIBank::getLinks() const {
    return m_links;
}
void OAIBank::setLinks(const OAISelfLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIBank::is_links_Set() const{
    return m_links_isSet;
}

bool OAIBank::is_links_Valid() const{
    return m_links_isValid;
}

OAIBankRelationships OAIBank::getRelationships() const {
    return m_relationships;
}
void OAIBank::setRelationships(const OAIBankRelationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIBank::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIBank::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAIBank::getType() const {
    return m_type;
}
void OAIBank::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIBank::is_type_Set() const{
    return m_type_isSet;
}

bool OAIBank::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIBank::isSet() const {
