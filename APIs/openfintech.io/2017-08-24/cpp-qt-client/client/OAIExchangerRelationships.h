...
/*
 * OAIExchangerRelationships.h
 *
 * 
 */

#ifndef OAIExchangerRelationships_H
#define OAIExchangerRelationships_H

#include <QJsonObject>

#include "OAIExchangerOrganization.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIExchangerOrganization;

class OAIExchangerRelationships : public OAIObject {
public:
    OAIExchangerRelationships();
    OAIExchangerRelationships(QString json);
    ~OAIExchangerRelationships() override;
    ...
    OAIExchangerOrganization getOrganization() const;
    void setOrganization(const OAIExchangerOrganization &organization);
...
private:
    ...
    OAIExchangerOrganization m_organization;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangerRelationships)

#endif // OAIExchangerRelationships_H
