...
/*
 * OAIPaymentProviderOrganization.h
 *
 * 
 */

#ifndef OAIPaymentProviderOrganization_H
#define OAIPaymentProviderOrganization_H

#include <QJsonObject>

#include "OAIPaymentProviderOrganizationData.h"
#include "OAIPaymentProviderOrganizationLinks.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPaymentProviderOrganizationData;
class OAIPaymentProviderOrganizationLinks;

class OAIPaymentProviderOrganization : public OAIObject {
public:
    OAIPaymentProviderOrganization();
    OAIPaymentProviderOrganization(QString json);
    ~OAIPaymentProviderOrganization() override;
    ...
    OAIPaymentProviderOrganizationData getData() const;
    void setData(const OAIPaymentProviderOrganizationData &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIPaymentProviderOrganizationLinks getLinks() const;
    void setLinks(const OAIPaymentProviderOrganizationLinks &links);
...
private:
    ...
    OAIPaymentProviderOrganizationData m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIPaymentProviderOrganizationLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentProviderOrganization)

#endif // OAIPaymentProviderOrganization_H
