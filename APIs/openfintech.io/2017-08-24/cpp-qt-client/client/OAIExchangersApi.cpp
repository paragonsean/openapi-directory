...
OAIExchangersApi::OAIExchangersApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIExchangersApi::~OAIExchangersApi() {
}

void OAIExchangersApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("exchangersGet", defaultConf);
    _serverIndices.insert("exchangersGet", 0);
    _serverConfigs.insert("exchangersIdGet", defaultConf);
    _serverIndices.insert("exchangersIdGet", 0);
}
...
*/
int OAIExchangersApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIExchangersApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIExchangersApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIExchangersApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIExchangersApi::setUsername(const QString &username) {
    _username = username;
}

void OAIExchangersApi::setPassword(const QString &password) {
    _password = password;
}


void OAIExchangersApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIExchangersApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIExchangersApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIExchangersApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIExchangersApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIExchangersApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIExchangersApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIExchangersApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIExchangersApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIExchangersApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIExchangersApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIExchangersApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIExchangersApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIExchangersApi::exchangersGet(const ::OpenAPI::OptionalParam<qint32> &page_number, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &filter_name, const ::OpenAPI::OptionalParam<QSet<QString>> &filter_status, const ::OpenAPI::OptionalParam<QSet<QString>> &sort) {
    QString fullPath = QString(_serverConfigs["exchangersGet"][_serverIndices.value("exchangersGet")].URL()+"/exchangers");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIExchangersApi::exchangersGetCallback);
    connect(this, &OAIExchangersApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIExchangersApi::exchangersGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIExchangersResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT exchangersGetSignal(output);
        Q_EMIT exchangersGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT exchangersGetSignalE(output, error_type, error_str);
        Q_EMIT exchangersGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT exchangersGetSignalError(output, error_type, error_str);
        Q_EMIT exchangersGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIExchangersApi::exchangersIdGet(const QString &id) {
    QString fullPath = QString(_serverConfigs["exchangersIdGet"][_serverIndices.value("exchangersIdGet")].URL()+"/exchangers/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIExchangersApi::exchangersIdGetCallback);
    connect(this, &OAIExchangersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIExchangersApi::exchangersIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIExchangerResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT exchangersIdGetSignal(output);
        Q_EMIT exchangersIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT exchangersIdGetSignalE(output, error_type, error_str);
        Q_EMIT exchangersIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT exchangersIdGetSignalError(output, error_type, error_str);
        Q_EMIT exchangersIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIExchangersApi::tokenAvailable(){
