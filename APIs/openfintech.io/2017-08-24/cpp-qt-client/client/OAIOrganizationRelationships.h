...
/*
 * OAIOrganizationRelationships.h
 *
 * 
 */

#ifndef OAIOrganizationRelationships_H
#define OAIOrganizationRelationships_H

#include <QJsonObject>

#include "OAIOrganizationActive.h"
#include "OAIOrganizationHq.h"
#include "OAIOrganizationSource.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIOrganizationActive;
class OAIOrganizationHq;
class OAIOrganizationSource;

class OAIOrganizationRelationships : public OAIObject {
public:
    OAIOrganizationRelationships();
    OAIOrganizationRelationships(QString json);
    ~OAIOrganizationRelationships() override;
    ...
    OAIOrganizationActive getActiveInCountries() const;
    void setActiveInCountries(const OAIOrganizationActive &active_in_countries);
    bool is_active_in_countries_Set() const;
    bool is_active_in_countries_Valid() const;

    OAIOrganizationHq getHqInCountry() const;
    void setHqInCountry(const OAIOrganizationHq &hq_in_country);
    bool is_hq_in_country_Set() const;
    bool is_hq_in_country_Valid() const;

    OAIOrganizationSource getSourceRegisterOrg() const;
    void setSourceRegisterOrg(const OAIOrganizationSource &source_register_org);
    bool is_source_register_org_Set() const;
    bool is_source_register_org_Valid() const;
...
private:
    ...
    OAIOrganizationActive m_active_in_countries;
    bool m_active_in_countries_isSet;
    bool m_active_in_countries_isValid;

    OAIOrganizationHq m_hq_in_country;
    bool m_hq_in_country_isSet;
    bool m_hq_in_country_isValid;

    OAIOrganizationSource m_source_register_org;
    bool m_source_register_org_isSet;
    bool m_source_register_org_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationRelationships)

#endif // OAIOrganizationRelationships_H
