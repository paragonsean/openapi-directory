...
OAIPaymentProviderOrganizationData::OAIPaymentProviderOrganizationData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentProviderOrganizationData::OAIPaymentProviderOrganizationData() {
    this->initializeModel();
}

OAIPaymentProviderOrganizationData::~OAIPaymentProviderOrganizationData() {}

void OAIPaymentProviderOrganizationData::initializeModel() {
...
void OAIPaymentProviderOrganizationData::fromJson(QString jsonString) {
...
void OAIPaymentProviderOrganizationData::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentProviderOrganizationData::asJson() const {
...
QJsonObject OAIPaymentProviderOrganizationData::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIPaymentProviderOrganizationData::getId() const {
    return m_id;
}
void OAIPaymentProviderOrganizationData::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPaymentProviderOrganizationData::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPaymentProviderOrganizationData::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPaymentProviderOrganizationData::getType() const {
    return m_type;
}
void OAIPaymentProviderOrganizationData::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPaymentProviderOrganizationData::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPaymentProviderOrganizationData::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPaymentProviderOrganizationData::isSet() const {
...
bool OAIPaymentProviderOrganizationData::isValid() const {
