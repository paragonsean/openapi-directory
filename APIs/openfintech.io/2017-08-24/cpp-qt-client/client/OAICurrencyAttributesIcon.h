...
/*
 * OAICurrencyAttributesIcon.h
 *
 * Links to currency icons
 */

#ifndef OAICurrencyAttributesIcon_H
#define OAICurrencyAttributesIcon_H
...
class OAICurrencyAttributesIcon : public OAIObject {
public:
    OAICurrencyAttributesIcon();
    OAICurrencyAttributesIcon(QString json);
    ~OAICurrencyAttributesIcon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyAttributesIcon)

#endif // OAICurrencyAttributesIcon_H
