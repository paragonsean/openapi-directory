...
OAIOrganizationSource::OAIOrganizationSource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationSource::OAIOrganizationSource() {
    this->initializeModel();
}

OAIOrganizationSource::~OAIOrganizationSource() {}

void OAIOrganizationSource::initializeModel() {
...
void OAIOrganizationSource::fromJson(QString jsonString) {
...
void OAIOrganizationSource::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationSource::asJson() const {
...
QJsonObject OAIOrganizationSource::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIOrganizationSourceData OAIOrganizationSource::getData() const {
    return m_data;
}
void OAIOrganizationSource::setData(const OAIOrganizationSourceData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIOrganizationSource::is_data_Set() const{
    return m_data_isSet;
}

bool OAIOrganizationSource::is_data_Valid() const{
    return m_data_isValid;
}

OAIOrganizationSourceLinks OAIOrganizationSource::getLinks() const {
    return m_links;
}
void OAIOrganizationSource::setLinks(const OAIOrganizationSourceLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIOrganizationSource::is_links_Set() const{
    return m_links_isSet;
}

bool OAIOrganizationSource::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIOrganizationSource::isSet() const {
...
bool OAIOrganizationSource::isValid() const {
