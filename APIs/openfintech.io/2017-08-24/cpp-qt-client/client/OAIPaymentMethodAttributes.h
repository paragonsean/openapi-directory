...
/*
 * OAIPaymentMethodAttributes.h
 *
 * Array of Payment-method attributes
 */

#ifndef OAIPaymentMethodAttributes_H
#define OAIPaymentMethodAttributes_H
...
class OAIPaymentMethodAttributes : public OAIObject {
public:
    OAIPaymentMethodAttributes();
    OAIPaymentMethodAttributes(QString json);
    ~OAIPaymentMethodAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodAttributes)

#endif // OAIPaymentMethodAttributes_H
