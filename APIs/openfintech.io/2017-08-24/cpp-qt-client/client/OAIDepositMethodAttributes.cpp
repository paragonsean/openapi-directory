...
#include "OAIDepositMethodAttributes.h"
...
OAIDepositMethodAttributes::OAIDepositMethodAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDepositMethodAttributes::OAIDepositMethodAttributes() {
    this->initializeModel();
}

OAIDepositMethodAttributes::~OAIDepositMethodAttributes() {}

void OAIDepositMethodAttributes::initializeModel() {
    ...
    m_processor_name_isSet = false;
    m_processor_name_isValid = false;
}

void OAIDepositMethodAttributes::fromJson(QString jsonString) {
...
void OAIDepositMethodAttributes::fromJsonObject(QJsonObject json) {
    ...
    m_processor_name_isValid = ::OpenAPI::fromJsonValue(m_processor_name, json[QString("processor_name")]);
    m_processor_name_isSet = !json[QString("processor_name")].isNull() && m_processor_name_isValid;
}

QString OAIDepositMethodAttributes::asJson() const {
...
QJsonObject OAIDepositMethodAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_category_isSet) {
    ...
    if (m_processor_name_isSet) {
        obj.insert(QString("processor_name"), ::OpenAPI::toJsonValue(m_processor_name));
    }
    return obj;
}

QString OAIDepositMethodAttributes::getCategory() const {
    return m_category;
}
void OAIDepositMethodAttributes::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIDepositMethodAttributes::is_category_Set() const{
    return m_category_isSet;
}

bool OAIDepositMethodAttributes::is_category_Valid() const{
    return m_category_isValid;
}

QString OAIDepositMethodAttributes::getCode() const {
    return m_code;
}
void OAIDepositMethodAttributes::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIDepositMethodAttributes::is_code_Set() const{
    return m_code_isSet;
}

bool OAIDepositMethodAttributes::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIDepositMethodAttributes::getName() const {
    return m_name;
}
void OAIDepositMethodAttributes::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDepositMethodAttributes::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDepositMethodAttributes::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIDepositMethodAttributes::getProcessorName() const {
    return m_processor_name;
}
void OAIDepositMethodAttributes::setProcessorName(const QString &processor_name) {
    m_processor_name = processor_name;
    m_processor_name_isSet = true;
}

bool OAIDepositMethodAttributes::is_processor_name_Set() const{
    return m_processor_name_isSet;
}

bool OAIDepositMethodAttributes::is_processor_name_Valid() const{
    return m_processor_name_isValid;
}

bool OAIDepositMethodAttributes::isSet() const {
...
bool OAIDepositMethodAttributes::isValid() const {
