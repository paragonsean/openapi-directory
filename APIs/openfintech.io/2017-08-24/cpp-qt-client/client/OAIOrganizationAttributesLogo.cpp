...
#include "OAIOrganizationAttributesLogo.h"
...
OAIOrganizationAttributesLogo::OAIOrganizationAttributesLogo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationAttributesLogo::OAIOrganizationAttributesLogo() {
    this->initializeModel();
}

OAIOrganizationAttributesLogo::~OAIOrganizationAttributesLogo() {}

void OAIOrganizationAttributesLogo::initializeModel() {

    m_r_50_isSet = false;
    m_r_50_isValid = false;

    m_r_100_isSet = false;
    m_r_100_isValid = false;

    m_r_150_isSet = false;
    m_r_150_isValid = false;
}

void OAIOrganizationAttributesLogo::fromJson(QString jsonString) {
...
void OAIOrganizationAttributesLogo::fromJsonObject(QJsonObject json) {

    m_r_50_isValid = ::OpenAPI::fromJsonValue(m_r_50, json[QString("50")]);
    m_r_50_isSet = !json[QString("50")].isNull() && m_r_50_isValid;

    m_r_100_isValid = ::OpenAPI::fromJsonValue(m_r_100, json[QString("100")]);
    m_r_100_isSet = !json[QString("100")].isNull() && m_r_100_isValid;

    m_r_150_isValid = ::OpenAPI::fromJsonValue(m_r_150, json[QString("150")]);
    m_r_150_isSet = !json[QString("150")].isNull() && m_r_150_isValid;
}

QString OAIOrganizationAttributesLogo::asJson() const {
...
QJsonObject OAIOrganizationAttributesLogo::asJsonObject() const {
    QJsonObject obj;
    if (m_r_50_isSet) {
        obj.insert(QString("50"), ::OpenAPI::toJsonValue(m_r_50));
    }
    if (m_r_100_isSet) {
        obj.insert(QString("100"), ::OpenAPI::toJsonValue(m_r_100));
    }
    if (m_r_150_isSet) {
        obj.insert(QString("150"), ::OpenAPI::toJsonValue(m_r_150));
    }
    return obj;
}

QString OAIOrganizationAttributesLogo::getR50() const {
    return m_r_50;
}
void OAIOrganizationAttributesLogo::setR50(const QString &r_50) {
    m_r_50 = r_50;
    m_r_50_isSet = true;
}

bool OAIOrganizationAttributesLogo::is_r_50_Set() const{
    return m_r_50_isSet;
}

bool OAIOrganizationAttributesLogo::is_r_50_Valid() const{
    return m_r_50_isValid;
}

QString OAIOrganizationAttributesLogo::getR100() const {
    return m_r_100;
}
void OAIOrganizationAttributesLogo::setR100(const QString &r_100) {
    m_r_100 = r_100;
    m_r_100_isSet = true;
}

bool OAIOrganizationAttributesLogo::is_r_100_Set() const{
    return m_r_100_isSet;
}

bool OAIOrganizationAttributesLogo::is_r_100_Valid() const{
    return m_r_100_isValid;
}

QString OAIOrganizationAttributesLogo::getR150() const {
    return m_r_150;
}
void OAIOrganizationAttributesLogo::setR150(const QString &r_150) {
    m_r_150 = r_150;
    m_r_150_isSet = true;
}

bool OAIOrganizationAttributesLogo::is_r_150_Set() const{
    return m_r_150_isSet;
}

bool OAIOrganizationAttributesLogo::is_r_150_Valid() const{
    return m_r_150_isValid;
}

bool OAIOrganizationAttributesLogo::isSet() const {
...
bool OAIOrganizationAttributesLogo::isValid() const {
