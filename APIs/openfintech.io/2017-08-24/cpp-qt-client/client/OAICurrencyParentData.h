...
/*
 * OAICurrencyParentData.h
 *
 * 
 */

#ifndef OAICurrencyParentData_H
#define OAICurrencyParentData_H
...
class OAICurrencyParentData : public OAIObject {
public:
    OAICurrencyParentData();
    OAICurrencyParentData(QString json);
    ~OAICurrencyParentData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyParentData)

#endif // OAICurrencyParentData_H
