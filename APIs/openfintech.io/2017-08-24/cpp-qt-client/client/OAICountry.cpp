...
OAICountryAttributes OAICountry::getAttributes() const {
    return m_attributes;
}
void OAICountry::setAttributes(const OAICountryAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICountry::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICountry::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAICountry::getId() const {
    return m_id;
}
void OAICountry::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}
...
OAISelfLinks OAICountry::getLinks() const {
    return m_links;
}
void OAICountry::setLinks(const OAISelfLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAICountry::is_links_Set() const{
    return m_links_isSet;
}

bool OAICountry::is_links_Valid() const{
    return m_links_isValid;
}

OAICountryRelationships OAICountry::getRelationships() const {
    return m_relationships;
}
void OAICountry::setRelationships(const OAICountryRelationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAICountry::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAICountry::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAICountry::getType() const {
    return m_type;
}
void OAICountry::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICountry::is_type_Set() const{
    return m_type_isSet;
}

bool OAICountry::is_type_Valid() const{
