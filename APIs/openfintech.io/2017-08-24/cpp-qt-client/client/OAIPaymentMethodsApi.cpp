...
#include "OAIPaymentMethodsApi.h"
...
OAIPaymentMethodsApi::OAIPaymentMethodsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIPaymentMethodsApi::~OAIPaymentMethodsApi() {
}

void OAIPaymentMethodsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("paymentMethodsIdGet", defaultConf);
    _serverIndices.insert("paymentMethodsIdGet", 0);
}
...
*/
int OAIPaymentMethodsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIPaymentMethodsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIPaymentMethodsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIPaymentMethodsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIPaymentMethodsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIPaymentMethodsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIPaymentMethodsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIPaymentMethodsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIPaymentMethodsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIPaymentMethodsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPaymentMethodsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPaymentMethodsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIPaymentMethodsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIPaymentMethodsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIPaymentMethodsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIPaymentMethodsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIPaymentMethodsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIPaymentMethodsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIPaymentMethodsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIPaymentMethodsApi::paymentMethodsGet(const ::OpenAPI::OptionalParam<qint32> &page_number, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &filter_search, const ::OpenAPI::OptionalParam<QString> &filter_name, const ::OpenAPI::OptionalParam<QString> &filter_code, const ::OpenAPI::OptionalParam<QString> &filter_processor_name, const ::OpenAPI::OptionalParam<QSet<QString>> &filter_category, const ::OpenAPI::OptionalParam<QSet<QString>> &sort) {
    QString fullPath = QString(_serverConfigs["paymentMethodsGet"][_serverIndices.value("paymentMethodsGet")].URL()+"/payment-methods");
    ...
    if (filter_processor_name.hasValue())
    {
        queryStyle = "";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[processor_name]", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("filter[processor_name]")).append(querySuffix).append(QUrl::toPercentEncoding(filter_processor_name.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPaymentMethodsApi::paymentMethodsGetCallback);
    connect(this, &OAIPaymentMethodsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIPaymentMethodsApi::paymentMethodsGetCallback(OAIHttpRequestWorker *worker) {
...
void OAIPaymentMethodsApi::paymentMethodsIdGet(const QString &id) {
    QString fullPath = QString(_serverConfigs["paymentMethodsIdGet"][_serverIndices.value("paymentMethodsIdGet")].URL()+"/payment-methods/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPaymentMethodsApi::paymentMethodsIdGetCallback);
    connect(this, &OAIPaymentMethodsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPaymentMethodsApi::paymentMethodsIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT paymentMethodsIdGetSignal(output);
        Q_EMIT paymentMethodsIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT paymentMethodsIdGetSignalE(output, error_type, error_str);
        Q_EMIT paymentMethodsIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT paymentMethodsIdGetSignalError(output, error_type, error_str);
        Q_EMIT paymentMethodsIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPaymentMethodsApi::tokenAvailable(){
