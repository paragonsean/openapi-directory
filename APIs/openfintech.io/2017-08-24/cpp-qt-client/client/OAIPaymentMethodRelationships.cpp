...
#include "OAIPaymentMethodRelationships.h"
...
OAIPaymentMethodRelationships::OAIPaymentMethodRelationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentMethodRelationships::OAIPaymentMethodRelationships() {
    this->initializeModel();
}

OAIPaymentMethodRelationships::~OAIPaymentMethodRelationships() {}

void OAIPaymentMethodRelationships::initializeModel() {
...
void OAIPaymentMethodRelationships::fromJson(QString jsonString) {
...
void OAIPaymentMethodRelationships::fromJsonObject(QJsonObject json) {
    ...
    m_payment_processor_isValid = ::OpenAPI::fromJsonValue(m_payment_processor, json[QString("payment-processor")]);
    m_payment_processor_isSet = !json[QString("payment-processor")].isNull() && m_payment_processor_isValid;
}

QString OAIPaymentMethodRelationships::asJson() const {
...
QJsonObject OAIPaymentMethodRelationships::asJsonObject() const {
    QJsonObject obj;
    if (m_currencies.isSet()) {
        obj.insert(QString("currencies"), ::OpenAPI::toJsonValue(m_currencies));
    }
    if (m_payment_processor.isSet()) {
        obj.insert(QString("payment-processor"), ::OpenAPI::toJsonValue(m_payment_processor));
    }
    return obj;
}

OAIPaymentMethodCurrencies OAIPaymentMethodRelationships::getCurrencies() const {
    return m_currencies;
}
void OAIPaymentMethodRelationships::setCurrencies(const OAIPaymentMethodCurrencies &currencies) {
    m_currencies = currencies;
    m_currencies_isSet = true;
}

bool OAIPaymentMethodRelationships::is_currencies_Set() const{
    return m_currencies_isSet;
}

bool OAIPaymentMethodRelationships::is_currencies_Valid() const{
    return m_currencies_isValid;
}

OAIPaymentMethodProcessor OAIPaymentMethodRelationships::getPaymentProcessor() const {
    return m_payment_processor;
}
void OAIPaymentMethodRelationships::setPaymentProcessor(const OAIPaymentMethodProcessor &payment_processor) {
    m_payment_processor = payment_processor;
    m_payment_processor_isSet = true;
}

bool OAIPaymentMethodRelationships::is_payment_processor_Set() const{
    return m_payment_processor_isSet;
}

bool OAIPaymentMethodRelationships::is_payment_processor_Valid() const{
    return m_payment_processor_isValid;
}

bool OAIPaymentMethodRelationships::isSet() const {
...
bool OAIPaymentMethodRelationships::isValid() const {
