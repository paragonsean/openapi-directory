...
OAICurrenciesResponse::OAICurrenciesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrenciesResponse::OAICurrenciesResponse() {
    this->initializeModel();
}

OAICurrenciesResponse::~OAICurrenciesResponse() {}

void OAICurrenciesResponse::initializeModel() {
...
void OAICurrenciesResponse::fromJson(QString jsonString) {
...
void OAICurrenciesResponse::fromJsonObject(QJsonObject json) {
...
QString OAICurrenciesResponse::asJson() const {
...
QJsonObject OAICurrenciesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAICurrency> OAICurrenciesResponse::getData() const {
    return m_data;
}
void OAICurrenciesResponse::setData(const QList<OAICurrency> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICurrenciesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAICurrenciesResponse::is_data_Valid() const{
    return m_data_isValid;
}

OAIResponseLinks OAICurrenciesResponse::getLinks() const {
    return m_links;
}
void OAICurrenciesResponse::setLinks(const OAIResponseLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAICurrenciesResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAICurrenciesResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIResponseMeta OAICurrenciesResponse::getMeta() const {
    return m_meta;
}
void OAICurrenciesResponse::setMeta(const OAIResponseMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAICurrenciesResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAICurrenciesResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAICurrenciesResponse::isSet() const {
...
bool OAICurrenciesResponse::isValid() const {
