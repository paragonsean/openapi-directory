...
QString OAIOrganizationAddress::getCountry() const {
    return m_country;
}
void OAIOrganizationAddress::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIOrganizationAddress::is_country_Set() const{
    return m_country_isSet;
}

bool OAIOrganizationAddress::is_country_Valid() const{
    return m_country_isValid;
}

qint32 OAIOrganizationAddress::getPostCode() const {
    return m_post_code;
}
void OAIOrganizationAddress::setPostCode(const qint32 &post_code) {
...
QString OAIOrganizationAddress::getRegion() const {
    return m_region;
}
void OAIOrganizationAddress::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIOrganizationAddress::is_region_Set() const{
    return m_region_isSet;
}

bool OAIOrganizationAddress::is_region_Valid() const{
