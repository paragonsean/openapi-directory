...
#include "OAIExchangerAttributes.h"
...
OAIExchangerAttributes::OAIExchangerAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExchangerAttributes::OAIExchangerAttributes() {
    this->initializeModel();
}

OAIExchangerAttributes::~OAIExchangerAttributes() {}

void OAIExchangerAttributes::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;

    m_rates_export_standard_isSet = false;
    m_rates_export_standard_isValid = false;

    m_rates_export_url_isSet = false;
    m_rates_export_url_isValid = false;

    m_status_isSet = false;
    m_status_isValid = false;

    m_wmid_isSet = false;
    m_wmid_isValid = false;
}

void OAIExchangerAttributes::fromJson(QString jsonString) {
...
void OAIExchangerAttributes::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;

    m_rates_export_standard_isValid = ::OpenAPI::fromJsonValue(m_rates_export_standard, json[QString("rates_export_standard")]);
    m_rates_export_standard_isSet = !json[QString("rates_export_standard")].isNull() && m_rates_export_standard_isValid;

    m_rates_export_url_isValid = ::OpenAPI::fromJsonValue(m_rates_export_url, json[QString("rates_export_url")]);
    m_rates_export_url_isSet = !json[QString("rates_export_url")].isNull() && m_rates_export_url_isValid;

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("status")]);
    m_status_isSet = !json[QString("status")].isNull() && m_status_isValid;

    m_wmid_isValid = ::OpenAPI::fromJsonValue(m_wmid, json[QString("wmid")]);
    m_wmid_isSet = !json[QString("wmid")].isNull() && m_wmid_isValid;
}

QString OAIExchangerAttributes::asJson() const {
...
QJsonObject OAIExchangerAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
        obj.insert(QString("name"), ::OpenAPI::toJsonValue(m_name));
    }
    if (m_rates_export_standard_isSet) {
        obj.insert(QString("rates_export_standard"), ::OpenAPI::toJsonValue(m_rates_export_standard));
    }
    if (m_rates_export_url_isSet) {
        obj.insert(QString("rates_export_url"), ::OpenAPI::toJsonValue(m_rates_export_url));
    }
    if (m_status_isSet) {
        obj.insert(QString("status"), ::OpenAPI::toJsonValue(m_status));
    }
    if (m_wmid_isSet) {
        obj.insert(QString("wmid"), ::OpenAPI::toJsonValue(m_wmid));
    }
    return obj;
}

QString OAIExchangerAttributes::getName() const {
    return m_name;
}
void OAIExchangerAttributes::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIExchangerAttributes::is_name_Set() const{
    return m_name_isSet;
}

bool OAIExchangerAttributes::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIExchangerAttributes::getRatesExportStandard() const {
    return m_rates_export_standard;
}
void OAIExchangerAttributes::setRatesExportStandard(const QString &rates_export_standard) {
    m_rates_export_standard = rates_export_standard;
    m_rates_export_standard_isSet = true;
}

bool OAIExchangerAttributes::is_rates_export_standard_Set() const{
    return m_rates_export_standard_isSet;
}

bool OAIExchangerAttributes::is_rates_export_standard_Valid() const{
    return m_rates_export_standard_isValid;
}

QString OAIExchangerAttributes::getRatesExportUrl() const {
    return m_rates_export_url;
}
void OAIExchangerAttributes::setRatesExportUrl(const QString &rates_export_url) {
    m_rates_export_url = rates_export_url;
    m_rates_export_url_isSet = true;
}

bool OAIExchangerAttributes::is_rates_export_url_Set() const{
    return m_rates_export_url_isSet;
}

bool OAIExchangerAttributes::is_rates_export_url_Valid() const{
    return m_rates_export_url_isValid;
}

QString OAIExchangerAttributes::getStatus() const {
    return m_status;
}
void OAIExchangerAttributes::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIExchangerAttributes::is_status_Set() const{
    return m_status_isSet;
}

bool OAIExchangerAttributes::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIExchangerAttributes::getWmid() const {
    return m_wmid;
}
void OAIExchangerAttributes::setWmid(const qint32 &wmid) {
    m_wmid = wmid;
    m_wmid_isSet = true;
}

bool OAIExchangerAttributes::is_wmid_Set() const{
    return m_wmid_isSet;
}

bool OAIExchangerAttributes::is_wmid_Valid() const{
    return m_wmid_isValid;
}

bool OAIExchangerAttributes::isSet() const {
...
bool OAIExchangerAttributes::isValid() const {
