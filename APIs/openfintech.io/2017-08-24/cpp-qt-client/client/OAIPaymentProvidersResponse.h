...
/*
 * OAIPaymentProvidersResponse.h
 *
 * 
 */

#ifndef OAIPaymentProvidersResponse_H
#define OAIPaymentProvidersResponse_H
...
class OAIPaymentProvidersResponse : public OAIObject {
public:
    OAIPaymentProvidersResponse();
    OAIPaymentProvidersResponse(QString json);
    ~OAIPaymentProvidersResponse() override;
    ...
    QList<OAIPaymentProvider> getData() const;
    void setData(const QList<OAIPaymentProvider> &data);
...
private:
    ...
    QList<OAIPaymentProvider> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentProvidersResponse)

#endif // OAIPaymentProvidersResponse_H
