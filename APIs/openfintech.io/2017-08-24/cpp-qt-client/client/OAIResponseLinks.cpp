...
OAIResponseLinks::OAIResponseLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResponseLinks::OAIResponseLinks() {
    this->initializeModel();
}

OAIResponseLinks::~OAIResponseLinks() {}

void OAIResponseLinks::initializeModel() {
...
void OAIResponseLinks::fromJson(QString jsonString) {
...
void OAIResponseLinks::fromJsonObject(QJsonObject json) {
...
QString OAIResponseLinks::asJson() const {
...
QJsonObject OAIResponseLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_first_isSet) {
...
QString OAIResponseLinks::getFirst() const {
    return m_first;
}
void OAIResponseLinks::setFirst(const QString &first) {
    m_first = first;
    m_first_isSet = true;
}

bool OAIResponseLinks::is_first_Set() const{
    return m_first_isSet;
}

bool OAIResponseLinks::is_first_Valid() const{
    return m_first_isValid;
}

QString OAIResponseLinks::getLast() const {
    return m_last;
}
void OAIResponseLinks::setLast(const QString &last) {
    m_last = last;
    m_last_isSet = true;
}

bool OAIResponseLinks::is_last_Set() const{
    return m_last_isSet;
}

bool OAIResponseLinks::is_last_Valid() const{
    return m_last_isValid;
}

QString OAIResponseLinks::getNext() const {
    return m_next;
}
void OAIResponseLinks::setNext(const QString &next) {
    m_next = next;
    m_next_isSet = true;
}

bool OAIResponseLinks::is_next_Set() const{
    return m_next_isSet;
}

bool OAIResponseLinks::is_next_Valid() const{
    return m_next_isValid;
}

QString OAIResponseLinks::getPrev() const {
    return m_prev;
}
void OAIResponseLinks::setPrev(const QString &prev) {
    m_prev = prev;
    m_prev_isSet = true;
}

bool OAIResponseLinks::is_prev_Set() const{
    return m_prev_isSet;
}

bool OAIResponseLinks::is_prev_Valid() const{
    return m_prev_isValid;
}

bool OAIResponseLinks::isSet() const {
...
bool OAIResponseLinks::isValid() const {
