...
/*
 * OAIPaymentProviderPaymentMethods.h
 *
 * 
 */

#ifndef OAIPaymentProviderPaymentMethods_H
#define OAIPaymentProviderPaymentMethods_H
...
namespace OpenAPI {
class OAIPaymentProviderPaymentMethodsLinks;

class OAIPaymentProviderPaymentMethods : public OAIObject {
public:
    OAIPaymentProviderPaymentMethods();
    OAIPaymentProviderPaymentMethods(QString json);
    ~OAIPaymentProviderPaymentMethods() override;
    ...
    OAIPaymentProviderPaymentMethodsLinks getLinks() const;
    void setLinks(const OAIPaymentProviderPaymentMethodsLinks &links);
...
private:
    ...
    OAIPaymentProviderPaymentMethodsLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentProviderPaymentMethods)

#endif // OAIPaymentProviderPaymentMethods_H
