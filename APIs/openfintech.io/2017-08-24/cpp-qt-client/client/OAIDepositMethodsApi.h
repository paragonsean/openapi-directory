...
#ifndef OAI_OAIDepositMethodsApi_H
#define OAI_OAIDepositMethodsApi_H
...
#include "OAIDepositMethodResponse.h"
#include "OAIDepositMethodsResponse.h"
#include <QSet>
#include <QString>
...
class OAIDepositMethodsApi : public QObject {
    Q_OBJECT

public:
    OAIDepositMethodsApi(const int timeOut = 0);
    ~OAIDepositMethodsApi();
...
private:
    ...
    void depositMethodsGetCallback(OAIHttpRequestWorker *worker);
    void depositMethodsIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void depositMethodsGetSignal(OAIDepositMethodsResponse summary);
    void depositMethodsIdGetSignal(OAIDepositMethodResponse summary);


    void depositMethodsGetSignalFull(OAIHttpRequestWorker *worker, OAIDepositMethodsResponse summary);
    void depositMethodsIdGetSignalFull(OAIHttpRequestWorker *worker, OAIDepositMethodResponse summary);

    Q_DECL_DEPRECATED_X("Use depositMethodsGetSignalError() instead")
    void depositMethodsGetSignalE(OAIDepositMethodsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void depositMethodsGetSignalError(OAIDepositMethodsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use depositMethodsIdGetSignalError() instead")
    void depositMethodsIdGetSignalE(OAIDepositMethodResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void depositMethodsIdGetSignalError(OAIDepositMethodResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use depositMethodsGetSignalErrorFull() instead")
    void depositMethodsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void depositMethodsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use depositMethodsIdGetSignalErrorFull() instead")
    void depositMethodsIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void depositMethodsIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
