...
/*
 * OAICurrencyCountryLinks.h
 *
 * 
 */

#ifndef OAICurrencyCountryLinks_H
#define OAICurrencyCountryLinks_H
...
class OAICurrencyCountryLinks : public OAIObject {
public:
    OAICurrencyCountryLinks();
    OAICurrencyCountryLinks(QString json);
    ~OAICurrencyCountryLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyCountryLinks)

#endif // OAICurrencyCountryLinks_H
