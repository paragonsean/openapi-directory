...
/*
 * OAIExchangerOrganizationLinks.h
 *
 * 
 */

#ifndef OAIExchangerOrganizationLinks_H
#define OAIExchangerOrganizationLinks_H
...
class OAIExchangerOrganizationLinks : public OAIObject {
public:
    OAIExchangerOrganizationLinks();
    OAIExchangerOrganizationLinks(QString json);
    ~OAIExchangerOrganizationLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangerOrganizationLinks)

#endif // OAIExchangerOrganizationLinks_H
