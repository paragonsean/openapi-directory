...
#include "OAIOrganizationRelationships.h"
...
OAIOrganizationRelationships::OAIOrganizationRelationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationRelationships::OAIOrganizationRelationships() {
    this->initializeModel();
}

OAIOrganizationRelationships::~OAIOrganizationRelationships() {}

void OAIOrganizationRelationships::initializeModel() {

    m_active_in_countries_isSet = false;
    m_active_in_countries_isValid = false;

    m_hq_in_country_isSet = false;
    m_hq_in_country_isValid = false;

    m_source_register_org_isSet = false;
    m_source_register_org_isValid = false;
}

void OAIOrganizationRelationships::fromJson(QString jsonString) {
...
void OAIOrganizationRelationships::fromJsonObject(QJsonObject json) {

    m_active_in_countries_isValid = ::OpenAPI::fromJsonValue(m_active_in_countries, json[QString("active_in_countries")]);
    m_active_in_countries_isSet = !json[QString("active_in_countries")].isNull() && m_active_in_countries_isValid;

    m_hq_in_country_isValid = ::OpenAPI::fromJsonValue(m_hq_in_country, json[QString("hq_in_country")]);
    m_hq_in_country_isSet = !json[QString("hq_in_country")].isNull() && m_hq_in_country_isValid;

    m_source_register_org_isValid = ::OpenAPI::fromJsonValue(m_source_register_org, json[QString("source_register_org")]);
    m_source_register_org_isSet = !json[QString("source_register_org")].isNull() && m_source_register_org_isValid;
}

QString OAIOrganizationRelationships::asJson() const {
...
QJsonObject OAIOrganizationRelationships::asJsonObject() const {
    QJsonObject obj;
    if (m_active_in_countries.isSet()) {
        obj.insert(QString("active_in_countries"), ::OpenAPI::toJsonValue(m_active_in_countries));
    }
    if (m_hq_in_country.isSet()) {
        obj.insert(QString("hq_in_country"), ::OpenAPI::toJsonValue(m_hq_in_country));
    }
    if (m_source_register_org.isSet()) {
        obj.insert(QString("source_register_org"), ::OpenAPI::toJsonValue(m_source_register_org));
    }
    return obj;
}

OAIOrganizationActive OAIOrganizationRelationships::getActiveInCountries() const {
    return m_active_in_countries;
}
void OAIOrganizationRelationships::setActiveInCountries(const OAIOrganizationActive &active_in_countries) {
    m_active_in_countries = active_in_countries;
    m_active_in_countries_isSet = true;
}

bool OAIOrganizationRelationships::is_active_in_countries_Set() const{
    return m_active_in_countries_isSet;
}

bool OAIOrganizationRelationships::is_active_in_countries_Valid() const{
    return m_active_in_countries_isValid;
}

OAIOrganizationHq OAIOrganizationRelationships::getHqInCountry() const {
    return m_hq_in_country;
}
void OAIOrganizationRelationships::setHqInCountry(const OAIOrganizationHq &hq_in_country) {
    m_hq_in_country = hq_in_country;
    m_hq_in_country_isSet = true;
}

bool OAIOrganizationRelationships::is_hq_in_country_Set() const{
    return m_hq_in_country_isSet;
}

bool OAIOrganizationRelationships::is_hq_in_country_Valid() const{
    return m_hq_in_country_isValid;
}

OAIOrganizationSource OAIOrganizationRelationships::getSourceRegisterOrg() const {
    return m_source_register_org;
}
void OAIOrganizationRelationships::setSourceRegisterOrg(const OAIOrganizationSource &source_register_org) {
    m_source_register_org = source_register_org;
    m_source_register_org_isSet = true;
}

bool OAIOrganizationRelationships::is_source_register_org_Set() const{
    return m_source_register_org_isSet;
}

bool OAIOrganizationRelationships::is_source_register_org_Valid() const{
    return m_source_register_org_isValid;
}

bool OAIOrganizationRelationships::isSet() const {
...
bool OAIOrganizationRelationships::isValid() const {
