...
#include "OAIBankOrganizationLinks.h"
...
OAIBankOrganizationLinks::OAIBankOrganizationLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBankOrganizationLinks::OAIBankOrganizationLinks() {
    this->initializeModel();
}

OAIBankOrganizationLinks::~OAIBankOrganizationLinks() {}

void OAIBankOrganizationLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIBankOrganizationLinks::fromJson(QString jsonString) {
...
void OAIBankOrganizationLinks::fromJsonObject(QJsonObject json) {
...
QString OAIBankOrganizationLinks::asJson() const {
...
QJsonObject OAIBankOrganizationLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIBankOrganizationLinks::getRelated() const {
    return m_related;
}
void OAIBankOrganizationLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIBankOrganizationLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAIBankOrganizationLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIBankOrganizationLinks::isSet() const {
...
bool OAIBankOrganizationLinks::isValid() const {
