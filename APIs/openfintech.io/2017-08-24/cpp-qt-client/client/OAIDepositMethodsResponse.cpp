...
OAIDepositMethodsResponse::OAIDepositMethodsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDepositMethodsResponse::OAIDepositMethodsResponse() {
    this->initializeModel();
}

OAIDepositMethodsResponse::~OAIDepositMethodsResponse() {}

void OAIDepositMethodsResponse::initializeModel() {
...
void OAIDepositMethodsResponse::fromJson(QString jsonString) {
...
void OAIDepositMethodsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDepositMethodsResponse::asJson() const {
...
QJsonObject OAIDepositMethodsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIDepositMethod> OAIDepositMethodsResponse::getData() const {
    return m_data;
}
void OAIDepositMethodsResponse::setData(const QList<OAIDepositMethod> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIDepositMethodsResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIDepositMethodsResponse::is_data_Valid() const{
    return m_data_isValid;
}

OAIResponseLinks OAIDepositMethodsResponse::getLinks() const {
    return m_links;
}
void OAIDepositMethodsResponse::setLinks(const OAIResponseLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIDepositMethodsResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAIDepositMethodsResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIResponseMeta OAIDepositMethodsResponse::getMeta() const {
    return m_meta;
}
void OAIDepositMethodsResponse::setMeta(const OAIResponseMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIDepositMethodsResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIDepositMethodsResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIDepositMethodsResponse::isSet() const {
...
bool OAIDepositMethodsResponse::isValid() const {
