...
/*
 * OAICountryAttributes.h
 *
 * 
 */

#ifndef OAICountryAttributes_H
#define OAICountryAttributes_H
...
class OAICountryAttributes : public OAIObject {
public:
    OAICountryAttributes();
    OAICountryAttributes(QString json);
    ~OAICountryAttributes() override;
    ...
    QList<qint32> getCallingCodes() const;
    void setCallingCodes(const QList<qint32> &calling_codes);
    bool is_calling_codes_Set() const;
    bool is_calling_codes_Valid() const;
    ...
    QString getCodeAlpha3() const;
    void setCodeAlpha3(const QString &code_alpha3);
    bool is_code_alpha3_Set() const;
    bool is_code_alpha3_Valid() const;
    ...
    QList<QString> getTimezones() const;
    void setTimezones(const QList<QString> &timezones);
    bool is_timezones_Set() const;
    bool is_timezones_Valid() const;

    QList<QString> getTopLevelDomains() const;
    void setTopLevelDomains(const QList<QString> &top_level_domains);
    bool is_top_level_domains_Set() const;
    bool is_top_level_domains_Valid() const;
...
private:
    ...
    QList<qint32> m_calling_codes;
    bool m_calling_codes_isSet;
    bool m_calling_codes_isValid;

    QString m_capital;
    bool m_capital_isSet;
    bool m_capital_isValid;

    QString m_code_alpha3;
    bool m_code_alpha3_isSet;
    bool m_code_alpha3_isValid;
    ...
    QList<QString> m_timezones;
    bool m_timezones_isSet;
    bool m_timezones_isValid;

    QList<QString> m_top_level_domains;
    bool m_top_level_domains_isSet;
    bool m_top_level_domains_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICountryAttributes)

#endif // OAICountryAttributes_H
