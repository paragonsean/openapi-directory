...
/*
 * OAIOrganizationAttributesLogo.h
 *
 * Links to organization logos
 */

#ifndef OAIOrganizationAttributesLogo_H
#define OAIOrganizationAttributesLogo_H
...
class OAIOrganizationAttributesLogo : public OAIObject {
public:
    OAIOrganizationAttributesLogo();
    OAIOrganizationAttributesLogo(QString json);
    ~OAIOrganizationAttributesLogo() override;
    ...
    QString getR50() const;
    void setR50(const QString &r_50);
    bool is_r_50_Set() const;
    bool is_r_50_Valid() const;

    QString getR100() const;
    void setR100(const QString &r_100);
    bool is_r_100_Set() const;
    bool is_r_100_Valid() const;

    QString getR150() const;
    void setR150(const QString &r_150);
    bool is_r_150_Set() const;
    bool is_r_150_Valid() const;
...
private:
    ...
    QString m_r_100;
    bool m_r_100_isSet;
    bool m_r_100_isValid;

    QString m_r_150;
    bool m_r_150_isSet;
    bool m_r_150_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationAttributesLogo)

#endif // OAIOrganizationAttributesLogo_H
