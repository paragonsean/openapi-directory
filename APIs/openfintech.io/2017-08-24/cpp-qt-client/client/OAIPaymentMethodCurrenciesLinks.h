...
/*
 * OAIPaymentMethodCurrenciesLinks.h
 *
 * 
 */

#ifndef OAIPaymentMethodCurrenciesLinks_H
#define OAIPaymentMethodCurrenciesLinks_H
...
class OAIPaymentMethodCurrenciesLinks : public OAIObject {
public:
    OAIPaymentMethodCurrenciesLinks();
    OAIPaymentMethodCurrenciesLinks(QString json);
    ~OAIPaymentMethodCurrenciesLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodCurrenciesLinks)

#endif // OAIPaymentMethodCurrenciesLinks_H
