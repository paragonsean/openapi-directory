...
#include "OAIPaymentMethodProcessor.h"
...
OAIPaymentMethodProcessor::OAIPaymentMethodProcessor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentMethodProcessor::OAIPaymentMethodProcessor() {
    this->initializeModel();
}

OAIPaymentMethodProcessor::~OAIPaymentMethodProcessor() {}

void OAIPaymentMethodProcessor::initializeModel() {
...
void OAIPaymentMethodProcessor::fromJson(QString jsonString) {
...
void OAIPaymentMethodProcessor::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentMethodProcessor::asJson() const {
...
QJsonObject OAIPaymentMethodProcessor::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIPaymentMethodProcessorData OAIPaymentMethodProcessor::getData() const {
    return m_data;
}
void OAIPaymentMethodProcessor::setData(const OAIPaymentMethodProcessorData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPaymentMethodProcessor::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPaymentMethodProcessor::is_data_Valid() const{
    return m_data_isValid;
}

OAIPaymentMethodProcessorLinks OAIPaymentMethodProcessor::getLinks() const {
    return m_links;
}
void OAIPaymentMethodProcessor::setLinks(const OAIPaymentMethodProcessorLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIPaymentMethodProcessor::is_links_Set() const{
    return m_links_isSet;
}

bool OAIPaymentMethodProcessor::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIPaymentMethodProcessor::isSet() const {
...
bool OAIPaymentMethodProcessor::isValid() const {
