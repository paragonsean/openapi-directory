...
OAIPaymentProvider::OAIPaymentProvider(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentProvider::OAIPaymentProvider() {
    this->initializeModel();
}

OAIPaymentProvider::~OAIPaymentProvider() {}

void OAIPaymentProvider::initializeModel() {
...
void OAIPaymentProvider::fromJson(QString jsonString) {
...
void OAIPaymentProvider::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentProvider::asJson() const {
...
QJsonObject OAIPaymentProvider::asJsonObject() const {
    QJsonObject obj;
...
OAIPaymentProviderAttributes OAIPaymentProvider::getAttributes() const {
    return m_attributes;
}
void OAIPaymentProvider::setAttributes(const OAIPaymentProviderAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIPaymentProvider::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIPaymentProvider::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIPaymentProvider::getId() const {
    return m_id;
}
void OAIPaymentProvider::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPaymentProvider::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPaymentProvider::is_id_Valid() const{
    return m_id_isValid;
}

OAISelfLinks OAIPaymentProvider::getLinks() const {
    return m_links;
}
void OAIPaymentProvider::setLinks(const OAISelfLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIPaymentProvider::is_links_Set() const{
    return m_links_isSet;
}

bool OAIPaymentProvider::is_links_Valid() const{
    return m_links_isValid;
}

OAIPaymentProviderRelationships OAIPaymentProvider::getRelationships() const {
    return m_relationships;
}
void OAIPaymentProvider::setRelationships(const OAIPaymentProviderRelationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIPaymentProvider::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIPaymentProvider::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAIPaymentProvider::getType() const {
    return m_type;
}
void OAIPaymentProvider::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPaymentProvider::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPaymentProvider::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPaymentProvider::isSet() const {
...
bool OAIPaymentProvider::isValid() const {
