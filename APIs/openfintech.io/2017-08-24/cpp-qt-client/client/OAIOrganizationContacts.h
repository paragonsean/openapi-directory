...
/*
 * OAIOrganizationContacts.h
 *
 * Organization&#x60;s contacts
 */

#ifndef OAIOrganizationContacts_H
#define OAIOrganizationContacts_H
...
class OAIOrganizationContacts : public OAIObject {
public:
    OAIOrganizationContacts();
    OAIOrganizationContacts(QString json);
    ~OAIOrganizationContacts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationContacts)

#endif // OAIOrganizationContacts_H
