...
/*
 * OAIExchangerAttributes.h
 *
 * 
 */

#ifndef OAIExchangerAttributes_H
#define OAIExchangerAttributes_H
...
class OAIExchangerAttributes : public OAIObject {
public:
    OAIExchangerAttributes();
    OAIExchangerAttributes(QString json);
    ~OAIExchangerAttributes() override;
    ...
    QString getRatesExportStandard() const;
    void setRatesExportStandard(const QString &rates_export_standard);
    bool is_rates_export_standard_Set() const;
    bool is_rates_export_standard_Valid() const;

    QString getRatesExportUrl() const;
    void setRatesExportUrl(const QString &rates_export_url);
    bool is_rates_export_url_Set() const;
    bool is_rates_export_url_Valid() const;
    ...
    qint32 getWmid() const;
    void setWmid(const qint32 &wmid);
    bool is_wmid_Set() const;
    bool is_wmid_Valid() const;
...
private:
    ...
    QString m_rates_export_standard;
    bool m_rates_export_standard_isSet;
    bool m_rates_export_standard_isValid;

    QString m_rates_export_url;
    bool m_rates_export_url_isSet;
    bool m_rates_export_url_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangerAttributes)

#endif // OAIExchangerAttributes_H
