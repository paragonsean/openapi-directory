...
namespace OpenAPI {
class OAIOrganizationAttributes;
class OAISelfLinks;
class OAIOrganizationRelationships;
...
public:
    ...
    OAIOrganizationAttributes getAttributes() const;
    void setAttributes(const OAIOrganizationAttributes &attributes);
    ...
    OAIOrganizationRelationships getRelationships() const;
    void setRelationships(const OAIOrganizationRelationships &relationships);
...
private:
    ...
    OAIOrganizationAttributes m_attributes;
    ...
    OAIOrganizationRelationships m_relationships;
