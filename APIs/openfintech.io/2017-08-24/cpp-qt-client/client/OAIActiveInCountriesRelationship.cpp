...
OAIActiveInCountriesRelationship::OAIActiveInCountriesRelationship(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActiveInCountriesRelationship::OAIActiveInCountriesRelationship() {
    this->initializeModel();
}

OAIActiveInCountriesRelationship::~OAIActiveInCountriesRelationship() {}

void OAIActiveInCountriesRelationship::initializeModel() {
...
void OAIActiveInCountriesRelationship::fromJson(QString jsonString) {
...
void OAIActiveInCountriesRelationship::fromJsonObject(QJsonObject json) {
...
QString OAIActiveInCountriesRelationship::asJson() const {
...
QJsonObject OAIActiveInCountriesRelationship::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIActiveInCountriesRelationship_data_inner> OAIActiveInCountriesRelationship::getData() const {
    return m_data;
}
void OAIActiveInCountriesRelationship::setData(const QList<OAIActiveInCountriesRelationship_data_inner> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIActiveInCountriesRelationship::is_data_Set() const{
    return m_data_isSet;
}

bool OAIActiveInCountriesRelationship::is_data_Valid() const{
    return m_data_isValid;
}

OAIActiveInCountriesRelationship_links OAIActiveInCountriesRelationship::getLinks() const {
    return m_links;
}
void OAIActiveInCountriesRelationship::setLinks(const OAIActiveInCountriesRelationship_links &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIActiveInCountriesRelationship::is_links_Set() const{
    return m_links_isSet;
}

bool OAIActiveInCountriesRelationship::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIActiveInCountriesRelationship::isSet() const {
...
bool OAIActiveInCountriesRelationship::isValid() const {
