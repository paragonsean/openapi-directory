...
/*
 * OAICurrencyAttributes.h
 *
 * Array of currencies attributes
 */

#ifndef OAICurrencyAttributes_H
#define OAICurrencyAttributes_H

#include <QJsonObject>

#include "OAICurrencyAttributesIcon.h"
#include <QString>
...
namespace OpenAPI {
class OAICurrencyAttributesIcon;

class OAICurrencyAttributes : public OAIObject {
public:
    OAICurrencyAttributes();
    OAICurrencyAttributes(QString json);
    ~OAICurrencyAttributes() override;
    ...
    QString getCodeEstandardsAlpha() const;
    void setCodeEstandardsAlpha(const QString &code_estandards_alpha);
    bool is_code_estandards_alpha_Set() const;
    bool is_code_estandards_alpha_Valid() const;

    QString getCodeIsoAlpha3() const;
    void setCodeIsoAlpha3(const QString &code_iso_alpha3);
    bool is_code_iso_alpha3_Set() const;
    bool is_code_iso_alpha3_Valid() const;

    qint32 getCodeIsoNumeric3() const;
    void setCodeIsoNumeric3(const qint32 &code_iso_numeric3);
    bool is_code_iso_numeric3_Set() const;
    bool is_code_iso_numeric3_Valid() const;

    QString getCodeJsonAlpha() const;
    void setCodeJsonAlpha(const QString &code_json_alpha);
    bool is_code_json_alpha_Set() const;
    bool is_code_json_alpha_Valid() const;
    ...
    QString getDecimalE() const;
    void setDecimalE(const QString &decimal_e);
    bool is_decimal_e_Set() const;
    bool is_decimal_e_Valid() const;

    OAICurrencyAttributesIcon getIcon() const;
    void setIcon(const OAICurrencyAttributesIcon &icon);
    ...
    QString getNativeSymbol() const;
    void setNativeSymbol(const QString &native_symbol);
    bool is_native_symbol_Set() const;
    bool is_native_symbol_Valid() const;
...
private:
    ...
    QString m_code_estandards_alpha;
    bool m_code_estandards_alpha_isSet;
    bool m_code_estandards_alpha_isValid;

    QString m_code_iso_alpha3;
    bool m_code_iso_alpha3_isSet;
    bool m_code_iso_alpha3_isValid;

    qint32 m_code_iso_numeric3;
    bool m_code_iso_numeric3_isSet;
    bool m_code_iso_numeric3_isValid;

    QString m_code_json_alpha;
    bool m_code_json_alpha_isSet;
    bool m_code_json_alpha_isValid;
    ...
    QString m_decimal_e;
    bool m_decimal_e_isSet;
    bool m_decimal_e_isValid;

    OAICurrencyAttributesIcon m_icon;
    bool m_icon_isSet;
    bool m_icon_isValid;
    ...
    QString m_native_symbol;
    bool m_native_symbol_isSet;
    bool m_native_symbol_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyAttributes)

#endif // OAICurrencyAttributes_H
