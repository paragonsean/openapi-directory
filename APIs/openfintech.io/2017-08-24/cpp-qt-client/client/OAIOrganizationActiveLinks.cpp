...
#include "OAIOrganizationActiveLinks.h"
...
OAIOrganizationActiveLinks::OAIOrganizationActiveLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationActiveLinks::OAIOrganizationActiveLinks() {
    this->initializeModel();
}

OAIOrganizationActiveLinks::~OAIOrganizationActiveLinks() {}

void OAIOrganizationActiveLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIOrganizationActiveLinks::fromJson(QString jsonString) {
...
void OAIOrganizationActiveLinks::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationActiveLinks::asJson() const {
...
QJsonObject OAIOrganizationActiveLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIOrganizationActiveLinks::getRelated() const {
    return m_related;
}
void OAIOrganizationActiveLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIOrganizationActiveLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAIOrganizationActiveLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIOrganizationActiveLinks::isSet() const {
...
bool OAIOrganizationActiveLinks::isValid() const {
