...
OAICurrencyAttributes OAICurrency::getAttributes() const {
    return m_attributes;
}
void OAICurrency::setAttributes(const OAICurrencyAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICurrency::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICurrency::is_attributes_Valid() const{
...
OAISelfLinks OAICurrency::getLinks() const {
    return m_links;
}
void OAICurrency::setLinks(const OAISelfLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAICurrency::is_links_Set() const{
    return m_links_isSet;
}

bool OAICurrency::is_links_Valid() const{
    return m_links_isValid;
}

OAICurrencyRelationships OAICurrency::getRelationships() const {
    return m_relationships;
}
void OAICurrency::setRelationships(const OAICurrencyRelationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAICurrency::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAICurrency::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAICurrency::getType() const {
    return m_type;
}
void OAICurrency::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICurrency::is_type_Set() const{
    return m_type_isSet;
}

bool OAICurrency::is_type_Valid() const{
