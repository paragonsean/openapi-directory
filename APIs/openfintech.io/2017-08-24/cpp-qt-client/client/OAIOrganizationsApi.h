...
public:
    ...
    * @param[in]  filter_industries QString [optional]
    * @param[in]  sort QSet<QString> [optional]
    */
    virtual void organizationsGet(const ::OpenAPI::OptionalParam<qint32> &page_number = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &filter_search = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter_code = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_status = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QString> &filter_industries = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QSet<QString>> &sort = ::OpenAPI::OptionalParam<QSet<QString>>());

    /**
    * @param[in]  id QString [required]
    */
    virtual void organizationsIdGet(const QString &id);
...
private:
    ...
    void organizationsIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void organizationsGetSignal(OAIOrganizationsResponse summary);
    void organizationsIdGetSignal(OAIOrganizationResponse summary);


    void organizationsGetSignalFull(OAIHttpRequestWorker *worker, OAIOrganizationsResponse summary);
    void organizationsIdGetSignalFull(OAIHttpRequestWorker *worker, OAIOrganizationResponse summary);

    Q_DECL_DEPRECATED_X("Use organizationsGetSignalError() instead")
    void organizationsGetSignalE(OAIOrganizationsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void organizationsGetSignalError(OAIOrganizationsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use organizationsIdGetSignalError() instead")
    void organizationsIdGetSignalE(OAIOrganizationResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void organizationsIdGetSignalError(OAIOrganizationResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use organizationsIdGetSignalErrorFull() instead")
    void organizationsIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void organizationsIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
