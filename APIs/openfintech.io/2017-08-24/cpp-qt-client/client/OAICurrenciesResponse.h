...
/*
 * OAICurrenciesResponse.h
 *
 * 
 */

#ifndef OAICurrenciesResponse_H
#define OAICurrenciesResponse_H
...
class OAICurrenciesResponse : public OAIObject {
public:
    OAICurrenciesResponse();
    OAICurrenciesResponse(QString json);
    ~OAICurrenciesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrenciesResponse)

#endif // OAICurrenciesResponse_H
