...
OAIPaymentProviderOrganizationLinks::OAIPaymentProviderOrganizationLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentProviderOrganizationLinks::OAIPaymentProviderOrganizationLinks() {
    this->initializeModel();
}

OAIPaymentProviderOrganizationLinks::~OAIPaymentProviderOrganizationLinks() {}

void OAIPaymentProviderOrganizationLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIPaymentProviderOrganizationLinks::fromJson(QString jsonString) {
...
void OAIPaymentProviderOrganizationLinks::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentProviderOrganizationLinks::asJson() const {
...
QJsonObject OAIPaymentProviderOrganizationLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIPaymentProviderOrganizationLinks::getRelated() const {
    return m_related;
}
void OAIPaymentProviderOrganizationLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIPaymentProviderOrganizationLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAIPaymentProviderOrganizationLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIPaymentProviderOrganizationLinks::isSet() const {
...
bool OAIPaymentProviderOrganizationLinks::isValid() const {
