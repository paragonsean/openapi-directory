...
/*
 * OAIOrganizationSocial.h
 *
 * Social profiles
 */

#ifndef OAIOrganizationSocial_H
#define OAIOrganizationSocial_H
...
class OAIOrganizationSocial : public OAIObject {
public:
    OAIOrganizationSocial();
    OAIOrganizationSocial(QString json);
    ~OAIOrganizationSocial() override;
    ...
    QString getVkontakte() const;
    void setVkontakte(const QString &vkontakte);
    bool is_vkontakte_Set() const;
    bool is_vkontakte_Valid() const;
...
private:
    ...
    QString m_vkontakte;
    bool m_vkontakte_isSet;
    bool m_vkontakte_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationSocial)

#endif // OAIOrganizationSocial_H
