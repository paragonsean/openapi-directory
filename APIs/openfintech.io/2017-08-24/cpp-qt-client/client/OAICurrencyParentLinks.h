...
/*
 * OAICurrencyParentLinks.h
 *
 * 
 */

#ifndef OAICurrencyParentLinks_H
#define OAICurrencyParentLinks_H
...
class OAICurrencyParentLinks : public OAIObject {
public:
    OAICurrencyParentLinks();
    OAICurrencyParentLinks(QString json);
    ~OAICurrencyParentLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyParentLinks)

#endif // OAICurrencyParentLinks_H
