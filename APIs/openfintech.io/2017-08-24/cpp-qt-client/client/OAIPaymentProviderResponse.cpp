...
OAIPaymentProviderResponse::OAIPaymentProviderResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentProviderResponse::OAIPaymentProviderResponse() {
    this->initializeModel();
}

OAIPaymentProviderResponse::~OAIPaymentProviderResponse() {}

void OAIPaymentProviderResponse::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIPaymentProviderResponse::fromJson(QString jsonString) {
...
void OAIPaymentProviderResponse::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIPaymentProviderResponse::asJson() const {
...
QJsonObject OAIPaymentProviderResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIPaymentProvider OAIPaymentProviderResponse::getData() const {
    return m_data;
}
void OAIPaymentProviderResponse::setData(const OAIPaymentProvider &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPaymentProviderResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPaymentProviderResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIPaymentProviderResponse::isSet() const {
...
bool OAIPaymentProviderResponse::isValid() const {
