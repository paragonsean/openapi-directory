...
/*
 * OAICountryTranslations.h
 *
 * 
 */

#ifndef OAICountryTranslations_H
#define OAICountryTranslations_H
...
namespace OpenAPI {
class OAICountryTranslationsLinks;

class OAICountryTranslations : public OAIObject {
public:
    OAICountryTranslations();
    OAICountryTranslations(QString json);
    ~OAICountryTranslations() override;
    ...
    OAICountryTranslationsLinks getLinks() const;
    void setLinks(const OAICountryTranslationsLinks &links);
...
private:
    ...
    OAICountryTranslationsLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICountryTranslations)

#endif // OAICountryTranslations_H
