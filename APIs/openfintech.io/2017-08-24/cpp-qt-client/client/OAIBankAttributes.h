...
#ifndef OAIBankAttributes_H
#define OAIBankAttributes_H
...
class OAIBankAttributes : public OAIObject {
public:
    OAIBankAttributes();
    OAIBankAttributes(QString json);
    ~OAIBankAttributes() override;
    ...
    QString getVatin() const;
    void setVatin(const QString &vatin);
    bool is_vatin_Set() const;
    bool is_vatin_Valid() const;
...
private:
    ...
    QString m_vatin;
    bool m_vatin_isSet;
    bool m_vatin_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBankAttributes)

#endif // OAIBankAttributes_H
