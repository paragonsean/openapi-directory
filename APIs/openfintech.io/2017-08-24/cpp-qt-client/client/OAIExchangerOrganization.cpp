...
OAIExchangerOrganization::OAIExchangerOrganization(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExchangerOrganization::OAIExchangerOrganization() {
    this->initializeModel();
}

OAIExchangerOrganization::~OAIExchangerOrganization() {}

void OAIExchangerOrganization::initializeModel() {
...
void OAIExchangerOrganization::fromJson(QString jsonString) {
...
void OAIExchangerOrganization::fromJsonObject(QJsonObject json) {
...
QString OAIExchangerOrganization::asJson() const {
...
QJsonObject OAIExchangerOrganization::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIExchangerOrganizationData OAIExchangerOrganization::getData() const {
    return m_data;
}
void OAIExchangerOrganization::setData(const OAIExchangerOrganizationData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIExchangerOrganization::is_data_Set() const{
    return m_data_isSet;
}

bool OAIExchangerOrganization::is_data_Valid() const{
    return m_data_isValid;
}

OAIExchangerOrganizationLinks OAIExchangerOrganization::getLinks() const {
    return m_links;
}
void OAIExchangerOrganization::setLinks(const OAIExchangerOrganizationLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIExchangerOrganization::is_links_Set() const{
    return m_links_isSet;
}

bool OAIExchangerOrganization::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIExchangerOrganization::isSet() const {
...
bool OAIExchangerOrganization::isValid() const {
