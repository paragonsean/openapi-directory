...
#include "OAIPaymentMethodProcessorData.h"
...
OAIPaymentMethodProcessorData::OAIPaymentMethodProcessorData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentMethodProcessorData::OAIPaymentMethodProcessorData() {
    this->initializeModel();
}

OAIPaymentMethodProcessorData::~OAIPaymentMethodProcessorData() {}

void OAIPaymentMethodProcessorData::initializeModel() {
...
void OAIPaymentMethodProcessorData::fromJson(QString jsonString) {
...
void OAIPaymentMethodProcessorData::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentMethodProcessorData::asJson() const {
...
QJsonObject OAIPaymentMethodProcessorData::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIPaymentMethodProcessorData::getId() const {
    return m_id;
}
void OAIPaymentMethodProcessorData::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPaymentMethodProcessorData::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPaymentMethodProcessorData::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPaymentMethodProcessorData::getType() const {
    return m_type;
}
void OAIPaymentMethodProcessorData::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPaymentMethodProcessorData::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPaymentMethodProcessorData::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPaymentMethodProcessorData::isSet() const {
...
bool OAIPaymentMethodProcessorData::isValid() const {
