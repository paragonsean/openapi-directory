...
OAICurrencyIssuerOrganization::OAICurrencyIssuerOrganization(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyIssuerOrganization::OAICurrencyIssuerOrganization() {
    this->initializeModel();
}

OAICurrencyIssuerOrganization::~OAICurrencyIssuerOrganization() {}

void OAICurrencyIssuerOrganization::initializeModel() {
...
void OAICurrencyIssuerOrganization::fromJson(QString jsonString) {
...
void OAICurrencyIssuerOrganization::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyIssuerOrganization::asJson() const {
...
QJsonObject OAICurrencyIssuerOrganization::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAICurrencyIssuerOrganizationData OAICurrencyIssuerOrganization::getData() const {
    return m_data;
}
void OAICurrencyIssuerOrganization::setData(const OAICurrencyIssuerOrganizationData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICurrencyIssuerOrganization::is_data_Set() const{
    return m_data_isSet;
}

bool OAICurrencyIssuerOrganization::is_data_Valid() const{
    return m_data_isValid;
}

OAICurrencyIssuerOrganizationLinks OAICurrencyIssuerOrganization::getLinks() const {
    return m_links;
}
void OAICurrencyIssuerOrganization::setLinks(const OAICurrencyIssuerOrganizationLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAICurrencyIssuerOrganization::is_links_Set() const{
    return m_links_isSet;
}

bool OAICurrencyIssuerOrganization::is_links_Valid() const{
    return m_links_isValid;
}

bool OAICurrencyIssuerOrganization::isSet() const {
...
bool OAICurrencyIssuerOrganization::isValid() const {
