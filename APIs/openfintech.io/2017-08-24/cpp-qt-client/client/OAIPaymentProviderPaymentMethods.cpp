...
#include "OAIPaymentProviderPaymentMethods.h"
...
OAIPaymentProviderPaymentMethods::OAIPaymentProviderPaymentMethods(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentProviderPaymentMethods::OAIPaymentProviderPaymentMethods() {
    this->initializeModel();
}

OAIPaymentProviderPaymentMethods::~OAIPaymentProviderPaymentMethods() {}

void OAIPaymentProviderPaymentMethods::initializeModel() {
...
void OAIPaymentProviderPaymentMethods::fromJson(QString jsonString) {
...
void OAIPaymentProviderPaymentMethods::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentProviderPaymentMethods::asJson() const {
...
QJsonObject OAIPaymentProviderPaymentMethods::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<QString> OAIPaymentProviderPaymentMethods::getData() const {
    return m_data;
}
void OAIPaymentProviderPaymentMethods::setData(const QList<QString> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPaymentProviderPaymentMethods::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPaymentProviderPaymentMethods::is_data_Valid() const{
    return m_data_isValid;
}

OAIPaymentProviderPaymentMethodsLinks OAIPaymentProviderPaymentMethods::getLinks() const {
    return m_links;
}
void OAIPaymentProviderPaymentMethods::setLinks(const OAIPaymentProviderPaymentMethodsLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIPaymentProviderPaymentMethods::is_links_Set() const{
    return m_links_isSet;
}

bool OAIPaymentProviderPaymentMethods::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIPaymentProviderPaymentMethods::isSet() const {
...
bool OAIPaymentProviderPaymentMethods::isValid() const {
