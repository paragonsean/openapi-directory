...
/*
 * OAIDepositMethodsResponse.h
 *
 * 
 */

#ifndef OAIDepositMethodsResponse_H
#define OAIDepositMethodsResponse_H
...
class OAIDepositMethodsResponse : public OAIObject {
public:
    OAIDepositMethodsResponse();
    OAIDepositMethodsResponse(QString json);
    ~OAIDepositMethodsResponse() override;
    ...
    QList<OAIDepositMethod> getData() const;
    void setData(const QList<OAIDepositMethod> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDepositMethodsResponse)

#endif // OAIDepositMethodsResponse_H
