...
/*
 * OAICurrencyIssuerOrganizationLinks.h
 *
 * 
 */

#ifndef OAICurrencyIssuerOrganizationLinks_H
#define OAICurrencyIssuerOrganizationLinks_H
...
class OAICurrencyIssuerOrganizationLinks : public OAIObject {
public:
    OAICurrencyIssuerOrganizationLinks();
    OAICurrencyIssuerOrganizationLinks(QString json);
    ~OAICurrencyIssuerOrganizationLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyIssuerOrganizationLinks)

#endif // OAICurrencyIssuerOrganizationLinks_H
