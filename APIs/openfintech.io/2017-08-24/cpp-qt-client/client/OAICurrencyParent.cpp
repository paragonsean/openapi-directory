...
OAICurrencyParent::OAICurrencyParent(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyParent::OAICurrencyParent() {
    this->initializeModel();
}

OAICurrencyParent::~OAICurrencyParent() {}

void OAICurrencyParent::initializeModel() {
...
void OAICurrencyParent::fromJson(QString jsonString) {
...
void OAICurrencyParent::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyParent::asJson() const {
...
QJsonObject OAICurrencyParent::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAICurrencyParentData OAICurrencyParent::getData() const {
    return m_data;
}
void OAICurrencyParent::setData(const OAICurrencyParentData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICurrencyParent::is_data_Set() const{
    return m_data_isSet;
}

bool OAICurrencyParent::is_data_Valid() const{
    return m_data_isValid;
}

OAICurrencyParentLinks OAICurrencyParent::getLinks() const {
    return m_links;
}
void OAICurrencyParent::setLinks(const OAICurrencyParentLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAICurrencyParent::is_links_Set() const{
    return m_links_isSet;
}

bool OAICurrencyParent::is_links_Valid() const{
    return m_links_isValid;
}

bool OAICurrencyParent::isSet() const {
...
bool OAICurrencyParent::isValid() const {
