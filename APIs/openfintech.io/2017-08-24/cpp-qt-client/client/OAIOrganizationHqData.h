...
/*
 * OAIOrganizationHqData.h
 *
 * 
 */

#ifndef OAIOrganizationHqData_H
#define OAIOrganizationHqData_H
...
class OAIOrganizationHqData : public OAIObject {
public:
    OAIOrganizationHqData();
    OAIOrganizationHqData(QString json);
    ~OAIOrganizationHqData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationHqData)

#endif // OAIOrganizationHqData_H
