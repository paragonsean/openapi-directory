...
/*
 * OAICurrencyRelationships.h
 *
 * 
 */

#ifndef OAICurrencyRelationships_H
#define OAICurrencyRelationships_H

#include <QJsonObject>

#include "OAICurrencyCountries.h"
#include "OAICurrencyIssuer.h"
#include "OAICurrencyIssuerOrganization.h"
...
namespace OpenAPI {
class OAICurrencyCountries;
class OAICurrencyIssuer;
class OAICurrencyIssuerOrganization;
class OAICurrencyParent;

class OAICurrencyRelationships : public OAIObject {
public:
    OAICurrencyRelationships();
    OAICurrencyRelationships(QString json);
    ~OAICurrencyRelationships() override;
    ...
    OAICurrencyCountries getCountries() const;
    void setCountries(const OAICurrencyCountries &countries);
    bool is_countries_Set() const;
    bool is_countries_Valid() const;

    OAICurrencyIssuer getIssuer() const;
    void setIssuer(const OAICurrencyIssuer &issuer);
    bool is_issuer_Set() const;
    bool is_issuer_Valid() const;

    OAICurrencyIssuerOrganization getIssuerOrganization() const;
    void setIssuerOrganization(const OAICurrencyIssuerOrganization &issuer_organization);
    bool is_issuer_organization_Set() const;
    bool is_issuer_organization_Valid() const;

    OAICurrencyParent getParent() const;
    void setParent(const OAICurrencyParent &parent);
...
private:
    ...
    OAICurrencyCountries m_countries;
    bool m_countries_isSet;
    bool m_countries_isValid;

    OAICurrencyIssuer m_issuer;
    bool m_issuer_isSet;
    bool m_issuer_isValid;

    OAICurrencyIssuerOrganization m_issuer_organization;
    bool m_issuer_organization_isSet;
    bool m_issuer_organization_isValid;

    OAICurrencyParent m_parent;
    bool m_parent_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyRelationships)

#endif // OAICurrencyRelationships_H
