...
OAIExchanger::OAIExchanger(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExchanger::OAIExchanger() {
    this->initializeModel();
}

OAIExchanger::~OAIExchanger() {}

void OAIExchanger::initializeModel() {
...
void OAIExchanger::fromJson(QString jsonString) {
...
void OAIExchanger::fromJsonObject(QJsonObject json) {
...
QString OAIExchanger::asJson() const {
...
QJsonObject OAIExchanger::asJsonObject() const {
    QJsonObject obj;
...
OAIExchangerAttributes OAIExchanger::getAttributes() const {
    return m_attributes;
}
void OAIExchanger::setAttributes(const OAIExchangerAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIExchanger::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIExchanger::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIExchanger::getId() const {
    return m_id;
}
void OAIExchanger::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIExchanger::is_id_Set() const{
    return m_id_isSet;
}

bool OAIExchanger::is_id_Valid() const{
    return m_id_isValid;
}

OAISelfLinks OAIExchanger::getLinks() const {
    return m_links;
}
void OAIExchanger::setLinks(const OAISelfLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIExchanger::is_links_Set() const{
    return m_links_isSet;
}

bool OAIExchanger::is_links_Valid() const{
    return m_links_isValid;
}

OAIExchangerRelationships OAIExchanger::getRelationships() const {
    return m_relationships;
}
void OAIExchanger::setRelationships(const OAIExchangerRelationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIExchanger::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIExchanger::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAIExchanger::getType() const {
    return m_type;
}
void OAIExchanger::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIExchanger::is_type_Set() const{
    return m_type_isSet;
}

bool OAIExchanger::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIExchanger::isSet() const {
...
bool OAIExchanger::isValid() const {
