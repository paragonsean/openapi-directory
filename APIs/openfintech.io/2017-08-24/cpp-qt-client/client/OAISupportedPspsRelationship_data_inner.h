...
/*
 * OAISupportedPspsRelationship_data_inner.h
 *
 * 
 */

#ifndef OAISupportedPspsRelationship_data_inner_H
#define OAISupportedPspsRelationship_data_inner_H
...
class OAISupportedPspsRelationship_data_inner : public OAIObject {
public:
    OAISupportedPspsRelationship_data_inner();
    OAISupportedPspsRelationship_data_inner(QString json);
    ~OAISupportedPspsRelationship_data_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupportedPspsRelationship_data_inner)

#endif // OAISupportedPspsRelationship_data_inner_H
