...
/*
 * OAIExchangerOrganizationData.h
 *
 * 
 */

#ifndef OAIExchangerOrganizationData_H
#define OAIExchangerOrganizationData_H
...
class OAIExchangerOrganizationData : public OAIObject {
public:
    OAIExchangerOrganizationData();
    OAIExchangerOrganizationData(QString json);
    ~OAIExchangerOrganizationData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangerOrganizationData)

#endif // OAIExchangerOrganizationData_H
