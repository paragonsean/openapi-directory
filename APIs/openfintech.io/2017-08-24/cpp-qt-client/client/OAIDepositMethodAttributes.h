...
/*
 * OAIDepositMethodAttributes.h
 *
 * Array of Deposit-method attributes
 */

#ifndef OAIDepositMethodAttributes_H
#define OAIDepositMethodAttributes_H
...
class OAIDepositMethodAttributes : public OAIObject {
public:
    OAIDepositMethodAttributes();
    OAIDepositMethodAttributes(QString json);
    ~OAIDepositMethodAttributes() override;
    ...
    void setProcessorName(const QString &processor_name);
    bool is_processor_name_Set() const;
    bool is_processor_name_Valid() const;
...
private:
    ...
    bool m_processor_name_isSet;
    bool m_processor_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDepositMethodAttributes)

#endif // OAIDepositMethodAttributes_H
