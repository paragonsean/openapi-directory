...
#include "OAIOrganizationHqLinks.h"
...
OAIOrganizationHqLinks::OAIOrganizationHqLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationHqLinks::OAIOrganizationHqLinks() {
    this->initializeModel();
}

OAIOrganizationHqLinks::~OAIOrganizationHqLinks() {}

void OAIOrganizationHqLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIOrganizationHqLinks::fromJson(QString jsonString) {
...
void OAIOrganizationHqLinks::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationHqLinks::asJson() const {
...
QJsonObject OAIOrganizationHqLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIOrganizationHqLinks::getRelated() const {
    return m_related;
}
void OAIOrganizationHqLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIOrganizationHqLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAIOrganizationHqLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIOrganizationHqLinks::isSet() const {
...
bool OAIOrganizationHqLinks::isValid() const {
