...
OAICurrencyResponse::OAICurrencyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyResponse::OAICurrencyResponse() {
    this->initializeModel();
}

OAICurrencyResponse::~OAICurrencyResponse() {}

void OAICurrencyResponse::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAICurrencyResponse::fromJson(QString jsonString) {
...
void OAICurrencyResponse::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAICurrencyResponse::asJson() const {
...
QJsonObject OAICurrencyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAICurrency OAICurrencyResponse::getData() const {
    return m_data;
}
void OAICurrencyResponse::setData(const OAICurrency &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICurrencyResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAICurrencyResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAICurrencyResponse::isSet() const {
...
bool OAICurrencyResponse::isValid() const {
