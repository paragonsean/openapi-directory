...
#ifndef OAIDepositMethod_H
#define OAIDepositMethod_H
...
namespace OpenAPI {
class OAIDepositMethodAttributes;
class OAISelfLinks;
class OAIDepositMethodRelationships;

class OAIDepositMethod : public OAIObject {
public:
    OAIDepositMethod();
    OAIDepositMethod(QString json);
    ~OAIDepositMethod() override;
    ...
    OAIDepositMethodAttributes getAttributes() const;
    void setAttributes(const OAIDepositMethodAttributes &attributes);
    ...
    OAIDepositMethodRelationships getRelationships() const;
    void setRelationships(const OAIDepositMethodRelationships &relationships);
...
private:
    ...
    OAIDepositMethodAttributes m_attributes;
    ...
    OAIDepositMethodRelationships m_relationships;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDepositMethod)

#endif // OAIDepositMethod_H
