...
#include "OAIPaymentProvidersApi.h"
...
OAIPaymentProvidersApi::OAIPaymentProvidersApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIPaymentProvidersApi::~OAIPaymentProvidersApi() {
}

void OAIPaymentProvidersApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("paymentProvidersGet", defaultConf);
    _serverIndices.insert("paymentProvidersGet", 0);
    _serverConfigs.insert("paymentProvidersIdGet", defaultConf);
    _serverIndices.insert("paymentProvidersIdGet", 0);
}
...
*/
int OAIPaymentProvidersApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIPaymentProvidersApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIPaymentProvidersApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIPaymentProvidersApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIPaymentProvidersApi::setUsername(const QString &username) {
    _username = username;
}

void OAIPaymentProvidersApi::setPassword(const QString &password) {
    _password = password;
}


void OAIPaymentProvidersApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIPaymentProvidersApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIPaymentProvidersApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIPaymentProvidersApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPaymentProvidersApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPaymentProvidersApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIPaymentProvidersApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIPaymentProvidersApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIPaymentProvidersApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIPaymentProvidersApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIPaymentProvidersApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIPaymentProvidersApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIPaymentProvidersApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIPaymentProvidersApi::paymentProvidersGet(const ::OpenAPI::OptionalParam<qint32> &page_number, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &filter_search, const ::OpenAPI::OptionalParam<QString> &filter_name, const ::OpenAPI::OptionalParam<QString> &filter_code, const ::OpenAPI::OptionalParam<QSet<QString>> &filter_types, const ::OpenAPI::OptionalParam<QSet<QString>> &filter_sales_channels, const ::OpenAPI::OptionalParam<QSet<QString>> &filter_features, const ::OpenAPI::OptionalParam<QSet<QString>> &sort) {
    QString fullPath = QString(_serverConfigs["paymentProvidersGet"][_serverIndices.value("paymentProvidersGet")].URL()+"/payment-providers");
    ...
    if (filter_search.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[search]", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("filter[search]")).append(querySuffix).append(QUrl::toPercentEncoding(filter_search.stringValue()));
    }
    ...
    if (filter_code.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[code]", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("filter[code]")).append(querySuffix).append(QUrl::toPercentEncoding(filter_code.stringValue()));
    }
    if (filter_types.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[types]", false);
        if (filter_types.value().size() > 0) {
            if (QString("csv").indexOf("multi") == 0) {
                for (QString t : filter_types.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("filter[types]=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("csv").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("filter[types]").append(querySuffix);
                qint32 count = 0;
                for (QString t : filter_types.value()) {
                    if (count > 0) {
    ...
    if (filter_sales_channels.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[sales_channels]", false);
        if (filter_sales_channels.value().size() > 0) {
            if (QString("csv").indexOf("multi") == 0) {
                for (QString t : filter_sales_channels.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("filter[sales_channels]=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("csv").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("filter[sales_channels]").append(querySuffix);
                qint32 count = 0;
                for (QString t : filter_sales_channels.value()) {
                    if (count > 0) {
                        fullPath.append((false)? queryDelimiter : QUrl::toPercentEncoding(queryDelimiter));
    ...
    if (filter_features.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[features]", false);
        if (filter_features.value().size() > 0) {
            if (QString("csv").indexOf("multi") == 0) {
                for (QString t : filter_features.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("filter[features]=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("csv").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("filter[features]").append(querySuffix);
                qint32 count = 0;
                for (QString t : filter_features.value()) {
                    if (count > 0) {
                        fullPath.append((false)? queryDelimiter : QUrl::toPercentEncoding(queryDelimiter));
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPaymentProvidersApi::paymentProvidersGetCallback);
    connect(this, &OAIPaymentProvidersApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIPaymentProvidersApi::paymentProvidersGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPaymentProvidersResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT paymentProvidersGetSignal(output);
        Q_EMIT paymentProvidersGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT paymentProvidersGetSignalE(output, error_type, error_str);
        Q_EMIT paymentProvidersGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT paymentProvidersGetSignalError(output, error_type, error_str);
        Q_EMIT paymentProvidersGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPaymentProvidersApi::paymentProvidersIdGet(const QString &id) {
    QString fullPath = QString(_serverConfigs["paymentProvidersIdGet"][_serverIndices.value("paymentProvidersIdGet")].URL()+"/payment-providers/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPaymentProvidersApi::paymentProvidersIdGetCallback);
    connect(this, &OAIPaymentProvidersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPaymentProvidersApi::paymentProvidersIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIPaymentProviderResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT paymentProvidersIdGetSignal(output);
        Q_EMIT paymentProvidersIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT paymentProvidersIdGetSignalE(output, error_type, error_str);
        Q_EMIT paymentProvidersIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT paymentProvidersIdGetSignalError(output, error_type, error_str);
        Q_EMIT paymentProvidersIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPaymentProvidersApi::tokenAvailable(){
