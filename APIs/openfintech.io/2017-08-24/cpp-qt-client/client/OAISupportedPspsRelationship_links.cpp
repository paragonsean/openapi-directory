...
#include "OAISupportedPspsRelationship_links.h"
...
OAISupportedPspsRelationship_links::OAISupportedPspsRelationship_links(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISupportedPspsRelationship_links::OAISupportedPspsRelationship_links() {
    this->initializeModel();
}

OAISupportedPspsRelationship_links::~OAISupportedPspsRelationship_links() {}

void OAISupportedPspsRelationship_links::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAISupportedPspsRelationship_links::fromJson(QString jsonString) {
...
void OAISupportedPspsRelationship_links::fromJsonObject(QJsonObject json) {
...
QString OAISupportedPspsRelationship_links::asJson() const {
...
QJsonObject OAISupportedPspsRelationship_links::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAISupportedPspsRelationship_links::getRelated() const {
    return m_related;
}
void OAISupportedPspsRelationship_links::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAISupportedPspsRelationship_links::is_related_Set() const{
    return m_related_isSet;
}

bool OAISupportedPspsRelationship_links::is_related_Valid() const{
    return m_related_isValid;
}

bool OAISupportedPspsRelationship_links::isSet() const {
...
bool OAISupportedPspsRelationship_links::isValid() const {
