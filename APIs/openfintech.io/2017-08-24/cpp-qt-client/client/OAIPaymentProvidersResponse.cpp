...
OAIPaymentProvidersResponse::OAIPaymentProvidersResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentProvidersResponse::OAIPaymentProvidersResponse() {
    this->initializeModel();
}

OAIPaymentProvidersResponse::~OAIPaymentProvidersResponse() {}

void OAIPaymentProvidersResponse::initializeModel() {
...
void OAIPaymentProvidersResponse::fromJson(QString jsonString) {
...
void OAIPaymentProvidersResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentProvidersResponse::asJson() const {
...
QJsonObject OAIPaymentProvidersResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIPaymentProvider> OAIPaymentProvidersResponse::getData() const {
    return m_data;
}
void OAIPaymentProvidersResponse::setData(const QList<OAIPaymentProvider> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPaymentProvidersResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPaymentProvidersResponse::is_data_Valid() const{
    return m_data_isValid;
}

OAIResponseLinks OAIPaymentProvidersResponse::getLinks() const {
    return m_links;
}
void OAIPaymentProvidersResponse::setLinks(const OAIResponseLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIPaymentProvidersResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAIPaymentProvidersResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIResponseMeta OAIPaymentProvidersResponse::getMeta() const {
    return m_meta;
}
void OAIPaymentProvidersResponse::setMeta(const OAIResponseMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIPaymentProvidersResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIPaymentProvidersResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIPaymentProvidersResponse::isSet() const {
...
bool OAIPaymentProvidersResponse::isValid() const {
