...
/*
 * OAIActiveInCountriesRelationship.h
 *
 * Active in countries
 */

#ifndef OAIActiveInCountriesRelationship_H
#define OAIActiveInCountriesRelationship_H
...
namespace OpenAPI {
class OAIActiveInCountriesRelationship_data_inner;
class OAIActiveInCountriesRelationship_links;

class OAIActiveInCountriesRelationship : public OAIObject {
public:
    OAIActiveInCountriesRelationship();
    OAIActiveInCountriesRelationship(QString json);
    ~OAIActiveInCountriesRelationship() override;
    ...
    QList<OAIActiveInCountriesRelationship_data_inner> getData() const;
    void setData(const QList<OAIActiveInCountriesRelationship_data_inner> &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIActiveInCountriesRelationship_links getLinks() const;
    void setLinks(const OAIActiveInCountriesRelationship_links &links);
...
private:
    ...
    QList<OAIActiveInCountriesRelationship_data_inner> m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIActiveInCountriesRelationship_links m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActiveInCountriesRelationship)

#endif // OAIActiveInCountriesRelationship_H
