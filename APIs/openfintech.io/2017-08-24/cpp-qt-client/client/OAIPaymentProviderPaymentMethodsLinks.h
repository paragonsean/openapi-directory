...
/*
 * OAIPaymentProviderPaymentMethodsLinks.h
 *
 * 
 */

#ifndef OAIPaymentProviderPaymentMethodsLinks_H
#define OAIPaymentProviderPaymentMethodsLinks_H
...
class OAIPaymentProviderPaymentMethodsLinks : public OAIObject {
public:
    OAIPaymentProviderPaymentMethodsLinks();
    OAIPaymentProviderPaymentMethodsLinks(QString json);
    ~OAIPaymentProviderPaymentMethodsLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentProviderPaymentMethodsLinks)

#endif // OAIPaymentProviderPaymentMethodsLinks_H
