...
#ifndef OAIBanksResponse_H
#define OAIBanksResponse_H
...
class OAIBanksResponse : public OAIObject {
public:
    OAIBanksResponse();
    OAIBanksResponse(QString json);
    ~OAIBanksResponse() override;
    ...
    QList<OAIBank> getData() const;
    void setData(const QList<OAIBank> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBanksResponse)

#endif // OAIBanksResponse_H
