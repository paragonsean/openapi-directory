...
OAIDepositMethodResponse::OAIDepositMethodResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDepositMethodResponse::OAIDepositMethodResponse() {
    this->initializeModel();
}

OAIDepositMethodResponse::~OAIDepositMethodResponse() {}

void OAIDepositMethodResponse::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIDepositMethodResponse::fromJson(QString jsonString) {
...
void OAIDepositMethodResponse::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIDepositMethodResponse::asJson() const {
...
QJsonObject OAIDepositMethodResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIDepositMethod OAIDepositMethodResponse::getData() const {
    return m_data;
}
void OAIDepositMethodResponse::setData(const OAIDepositMethod &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIDepositMethodResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIDepositMethodResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIDepositMethodResponse::isSet() const {
...
bool OAIDepositMethodResponse::isValid() const {
