...
/*
 * OAIPaymentMethodRelationships.h
 *
 * 
 */

#ifndef OAIPaymentMethodRelationships_H
#define OAIPaymentMethodRelationships_H
...
namespace OpenAPI {
class OAIPaymentMethodCurrencies;
class OAIPaymentMethodProcessor;

class OAIPaymentMethodRelationships : public OAIObject {
public:
    OAIPaymentMethodRelationships();
    OAIPaymentMethodRelationships(QString json);
    ~OAIPaymentMethodRelationships() override;
    ...
    OAIPaymentMethodCurrencies getCurrencies() const;
    void setCurrencies(const OAIPaymentMethodCurrencies &currencies);
    bool is_currencies_Set() const;
    bool is_currencies_Valid() const;

    OAIPaymentMethodProcessor getPaymentProcessor() const;
    void setPaymentProcessor(const OAIPaymentMethodProcessor &payment_processor);
...
private:
    ...
    OAIPaymentMethodCurrencies m_currencies;
    bool m_currencies_isSet;
    bool m_currencies_isValid;

    OAIPaymentMethodProcessor m_payment_processor;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodRelationships)

#endif // OAIPaymentMethodRelationships_H
