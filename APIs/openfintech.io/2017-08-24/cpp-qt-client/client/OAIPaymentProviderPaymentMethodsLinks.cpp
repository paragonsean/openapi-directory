...
#include "OAIPaymentProviderPaymentMethodsLinks.h"
...
OAIPaymentProviderPaymentMethodsLinks::OAIPaymentProviderPaymentMethodsLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentProviderPaymentMethodsLinks::OAIPaymentProviderPaymentMethodsLinks() {
    this->initializeModel();
}

OAIPaymentProviderPaymentMethodsLinks::~OAIPaymentProviderPaymentMethodsLinks() {}

void OAIPaymentProviderPaymentMethodsLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIPaymentProviderPaymentMethodsLinks::fromJson(QString jsonString) {
...
void OAIPaymentProviderPaymentMethodsLinks::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentProviderPaymentMethodsLinks::asJson() const {
...
QJsonObject OAIPaymentProviderPaymentMethodsLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIPaymentProviderPaymentMethodsLinks::getRelated() const {
    return m_related;
}
void OAIPaymentProviderPaymentMethodsLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIPaymentProviderPaymentMethodsLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAIPaymentProviderPaymentMethodsLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIPaymentProviderPaymentMethodsLinks::isSet() const {
...
bool OAIPaymentProviderPaymentMethodsLinks::isValid() const {
