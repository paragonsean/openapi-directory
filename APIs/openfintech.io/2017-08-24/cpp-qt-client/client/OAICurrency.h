...
#include "OAICurrencyRelationships.h"
...
namespace OpenAPI {
class OAICurrencyAttributes;
class OAISelfLinks;
class OAICurrencyRelationships;
...
public:
    ...
    OAICurrencyAttributes getAttributes() const;
    void setAttributes(const OAICurrencyAttributes &attributes);
    ...
    OAICurrencyRelationships getRelationships() const;
    void setRelationships(const OAICurrencyRelationships &relationships);
...
private:
    ...
    OAICurrencyAttributes m_attributes;
    ...
    OAICurrencyRelationships m_relationships;
