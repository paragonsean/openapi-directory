...
/*
 * OAIDepositMethodProcessorData.h
 *
 * Processor&#x60;s Data.
 */

#ifndef OAIDepositMethodProcessorData_H
#define OAIDepositMethodProcessorData_H

#include <QJsonObject>

#include "OAIDepositMethodProcessorData_data_inner.h"
#include "OAIDepositMethodProcessorData_links.h"
#include <QList>
...
namespace OpenAPI {
class OAIDepositMethodProcessorData_data_inner;
class OAIDepositMethodProcessorData_links;

class OAIDepositMethodProcessorData : public OAIObject {
public:
    OAIDepositMethodProcessorData();
    OAIDepositMethodProcessorData(QString json);
    ~OAIDepositMethodProcessorData() override;
    ...
    QList<OAIDepositMethodProcessorData_data_inner> getData() const;
    void setData(const QList<OAIDepositMethodProcessorData_data_inner> &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIDepositMethodProcessorData_links getLinks() const;
    void setLinks(const OAIDepositMethodProcessorData_links &links);
...
private:
    ...
    QList<OAIDepositMethodProcessorData_data_inner> m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIDepositMethodProcessorData_links m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDepositMethodProcessorData)

#endif // OAIDepositMethodProcessorData_H
