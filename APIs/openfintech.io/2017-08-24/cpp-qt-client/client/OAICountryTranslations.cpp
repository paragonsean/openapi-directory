...
OAICountryTranslations::OAICountryTranslations(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICountryTranslations::OAICountryTranslations() {
    this->initializeModel();
}

OAICountryTranslations::~OAICountryTranslations() {}

void OAICountryTranslations::initializeModel() {

    m_links_isSet = false;
    m_links_isValid = false;
}

void OAICountryTranslations::fromJson(QString jsonString) {
...
void OAICountryTranslations::fromJsonObject(QJsonObject json) {

    m_links_isValid = ::OpenAPI::fromJsonValue(m_links, json[QString("links")]);
    m_links_isSet = !json[QString("links")].isNull() && m_links_isValid;
}

QString OAICountryTranslations::asJson() const {
...
QJsonObject OAICountryTranslations::asJsonObject() const {
    QJsonObject obj;
    if (m_links.isSet()) {
...
OAICountryTranslationsLinks OAICountryTranslations::getLinks() const {
    return m_links;
}
void OAICountryTranslations::setLinks(const OAICountryTranslationsLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAICountryTranslations::is_links_Set() const{
    return m_links_isSet;
}

bool OAICountryTranslations::is_links_Valid() const{
    return m_links_isValid;
}

bool OAICountryTranslations::isSet() const {
...
bool OAICountryTranslations::isValid() const {
