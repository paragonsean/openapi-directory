...
OAICurrencyIssuerOrganizationData::OAICurrencyIssuerOrganizationData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyIssuerOrganizationData::OAICurrencyIssuerOrganizationData() {
    this->initializeModel();
}

OAICurrencyIssuerOrganizationData::~OAICurrencyIssuerOrganizationData() {}

void OAICurrencyIssuerOrganizationData::initializeModel() {
...
void OAICurrencyIssuerOrganizationData::fromJson(QString jsonString) {
...
void OAICurrencyIssuerOrganizationData::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyIssuerOrganizationData::asJson() const {
...
QJsonObject OAICurrencyIssuerOrganizationData::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAICurrencyIssuerOrganizationData::getId() const {
    return m_id;
}
void OAICurrencyIssuerOrganizationData::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICurrencyIssuerOrganizationData::is_id_Set() const{
    return m_id_isSet;
}

bool OAICurrencyIssuerOrganizationData::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICurrencyIssuerOrganizationData::getType() const {
    return m_type;
}
void OAICurrencyIssuerOrganizationData::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICurrencyIssuerOrganizationData::is_type_Set() const{
    return m_type_isSet;
}

bool OAICurrencyIssuerOrganizationData::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICurrencyIssuerOrganizationData::isSet() const {
...
bool OAICurrencyIssuerOrganizationData::isValid() const {
