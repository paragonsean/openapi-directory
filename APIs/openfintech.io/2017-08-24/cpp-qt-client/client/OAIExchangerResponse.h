...
/*
 * OAIExchangerResponse.h
 *
 * 
 */

#ifndef OAIExchangerResponse_H
#define OAIExchangerResponse_H

#include <QJsonObject>

#include "OAIExchanger.h"
...
class OAIExchangerResponse : public OAIObject {
public:
    OAIExchangerResponse();
    OAIExchangerResponse(QString json);
    ~OAIExchangerResponse() override;
    ...
    OAIExchanger getData() const;
    void setData(const OAIExchanger &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangerResponse)

#endif // OAIExchangerResponse_H
