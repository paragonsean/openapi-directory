...
/*
 * OAIPaymentProviderAttributes.h
 *
 * Array of Payment-provider attributes
 */

#ifndef OAIPaymentProviderAttributes_H
#define OAIPaymentProviderAttributes_H
...
class OAIPaymentProviderAttributes : public OAIObject {
public:
    OAIPaymentProviderAttributes();
    OAIPaymentProviderAttributes(QString json);
    ~OAIPaymentProviderAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentProviderAttributes)

#endif // OAIPaymentProviderAttributes_H
