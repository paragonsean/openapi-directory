...
OAIDepositMethodProcessorData::OAIDepositMethodProcessorData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDepositMethodProcessorData::OAIDepositMethodProcessorData() {
    this->initializeModel();
}

OAIDepositMethodProcessorData::~OAIDepositMethodProcessorData() {}

void OAIDepositMethodProcessorData::initializeModel() {
...
void OAIDepositMethodProcessorData::fromJson(QString jsonString) {
...
void OAIDepositMethodProcessorData::fromJsonObject(QJsonObject json) {
...
QString OAIDepositMethodProcessorData::asJson() const {
...
QJsonObject OAIDepositMethodProcessorData::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIDepositMethodProcessorData_data_inner> OAIDepositMethodProcessorData::getData() const {
    return m_data;
}
void OAIDepositMethodProcessorData::setData(const QList<OAIDepositMethodProcessorData_data_inner> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIDepositMethodProcessorData::is_data_Set() const{
    return m_data_isSet;
}

bool OAIDepositMethodProcessorData::is_data_Valid() const{
    return m_data_isValid;
}

OAIDepositMethodProcessorData_links OAIDepositMethodProcessorData::getLinks() const {
    return m_links;
}
void OAIDepositMethodProcessorData::setLinks(const OAIDepositMethodProcessorData_links &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIDepositMethodProcessorData::is_links_Set() const{
    return m_links_isSet;
}

bool OAIDepositMethodProcessorData::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIDepositMethodProcessorData::isSet() const {
...
bool OAIDepositMethodProcessorData::isValid() const {
