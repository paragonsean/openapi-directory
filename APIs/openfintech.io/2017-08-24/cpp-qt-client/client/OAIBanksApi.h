...
#ifndef OAI_OAIBanksApi_H
#define OAI_OAIBanksApi_H
...
class OAIBanksApi : public QObject {
    Q_OBJECT

public:
    OAIBanksApi(const int timeOut = 0);
    ~OAIBanksApi();
    ...
    * @param[in]  filter_sort_code QString [optional]
    * @param[in]  filter_code QString [optional]
    * @param[in]  filter_status QSet<QString> [optional]
    * @param[in]  sort QSet<QString> [optional]
    */
    virtual void banksGet(const ::OpenAPI::OptionalParam<qint32> &page_number = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &filter_sort_code = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter_code = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_status = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QSet<QString>> &sort = ::OpenAPI::OptionalParam<QSet<QString>>());

    /**
    * @param[in]  id QString [required]
    */
    virtual void banksIdGet(const QString &id);
...
private:
    ...
    void banksGetCallback(OAIHttpRequestWorker *worker);
    void banksIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void banksGetSignal(OAIBanksResponse summary);
    void banksIdGetSignal(OAIBankResponse summary);


    void banksGetSignalFull(OAIHttpRequestWorker *worker, OAIBanksResponse summary);
    void banksIdGetSignalFull(OAIHttpRequestWorker *worker, OAIBankResponse summary);

    Q_DECL_DEPRECATED_X("Use banksGetSignalError() instead")
    void banksGetSignalE(OAIBanksResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void banksGetSignalError(OAIBanksResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use banksIdGetSignalError() instead")
    void banksIdGetSignalE(OAIBankResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void banksIdGetSignalError(OAIBankResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use banksGetSignalErrorFull() instead")
    void banksGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void banksGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use banksIdGetSignalErrorFull() instead")
    void banksIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void banksIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
