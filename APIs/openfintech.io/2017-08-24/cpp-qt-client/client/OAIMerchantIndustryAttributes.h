...
/*
 * OAIMerchantIndustryAttributes.h
 *
 * Array of Merchant-industry attributes
 */

#ifndef OAIMerchantIndustryAttributes_H
#define OAIMerchantIndustryAttributes_H
...
class OAIMerchantIndustryAttributes : public OAIObject {
public:
    OAIMerchantIndustryAttributes();
    OAIMerchantIndustryAttributes(QString json);
    ~OAIMerchantIndustryAttributes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantIndustryAttributes)

#endif // OAIMerchantIndustryAttributes_H
