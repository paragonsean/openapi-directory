...
#include "OAIBankRelationships.h"
#include "OAISelfLinks.h"
#include <QString>
...
namespace OpenAPI {
class OAIBankAttributes;
class OAISelfLinks;
class OAIBankRelationships;

class OAIBank : public OAIObject {
public:
    OAIBank();
    OAIBank(QString json);
    ~OAIBank() override;
    ...
    OAIBankAttributes getAttributes() const;
    void setAttributes(const OAIBankAttributes &attributes);
    ...
    OAISelfLinks getLinks() const;
    void setLinks(const OAISelfLinks &links);
    bool is_links_Set() const;
    bool is_links_Valid() const;

    OAIBankRelationships getRelationships() const;
    void setRelationships(const OAIBankRelationships &relationships);
...
private:
    ...
    OAIBankAttributes m_attributes;
    ...
    OAISelfLinks m_links;
    bool m_links_isSet;
    bool m_links_isValid;

    OAIBankRelationships m_relationships;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBank)
