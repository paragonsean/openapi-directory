...
OAIBanksResponse::OAIBanksResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBanksResponse::OAIBanksResponse() {
    this->initializeModel();
}

OAIBanksResponse::~OAIBanksResponse() {}

void OAIBanksResponse::initializeModel() {
...
void OAIBanksResponse::fromJson(QString jsonString) {
...
void OAIBanksResponse::fromJsonObject(QJsonObject json) {
...
QString OAIBanksResponse::asJson() const {
...
QJsonObject OAIBanksResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIBank> OAIBanksResponse::getData() const {
    return m_data;
}
void OAIBanksResponse::setData(const QList<OAIBank> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIBanksResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIBanksResponse::is_data_Valid() const{
    return m_data_isValid;
}

OAIResponseLinks OAIBanksResponse::getLinks() const {
    return m_links;
}
void OAIBanksResponse::setLinks(const OAIResponseLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIBanksResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAIBanksResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIResponseMeta OAIBanksResponse::getMeta() const {
    return m_meta;
}
void OAIBanksResponse::setMeta(const OAIResponseMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIBanksResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIBanksResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIBanksResponse::isSet() const {
...
bool OAIBanksResponse::isValid() const {
