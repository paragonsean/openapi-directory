...
/*
 * OAISupportedPspsRelationship.h
 *
 * Supported psps
 */

#ifndef OAISupportedPspsRelationship_H
#define OAISupportedPspsRelationship_H
...
namespace OpenAPI {
class OAISupportedPspsRelationship_data_inner;
class OAISupportedPspsRelationship_links;

class OAISupportedPspsRelationship : public OAIObject {
public:
    OAISupportedPspsRelationship();
    OAISupportedPspsRelationship(QString json);
    ~OAISupportedPspsRelationship() override;
    ...
    QList<OAISupportedPspsRelationship_data_inner> getData() const;
    void setData(const QList<OAISupportedPspsRelationship_data_inner> &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAISupportedPspsRelationship_links getLinks() const;
    void setLinks(const OAISupportedPspsRelationship_links &links);
...
private:
    ...
    QList<OAISupportedPspsRelationship_data_inner> m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAISupportedPspsRelationship_links m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupportedPspsRelationship)

#endif // OAISupportedPspsRelationship_H
