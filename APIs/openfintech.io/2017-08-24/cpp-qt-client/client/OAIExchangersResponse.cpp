...
#include "OAIExchangersResponse.h"
...
OAIExchangersResponse::OAIExchangersResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExchangersResponse::OAIExchangersResponse() {
    this->initializeModel();
}

OAIExchangersResponse::~OAIExchangersResponse() {}

void OAIExchangersResponse::initializeModel() {
...
void OAIExchangersResponse::fromJson(QString jsonString) {
...
void OAIExchangersResponse::fromJsonObject(QJsonObject json) {
...
QString OAIExchangersResponse::asJson() const {
...
QJsonObject OAIExchangersResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIExchanger> OAIExchangersResponse::getData() const {
    return m_data;
}
void OAIExchangersResponse::setData(const QList<OAIExchanger> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIExchangersResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIExchangersResponse::is_data_Valid() const{
    return m_data_isValid;
}

OAIResponseLinks OAIExchangersResponse::getLinks() const {
    return m_links;
}
void OAIExchangersResponse::setLinks(const OAIResponseLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIExchangersResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAIExchangersResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIResponseMeta OAIExchangersResponse::getMeta() const {
    return m_meta;
}
void OAIExchangersResponse::setMeta(const OAIResponseMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIExchangersResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIExchangersResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIExchangersResponse::isSet() const {
...
bool OAIExchangersResponse::isValid() const {
