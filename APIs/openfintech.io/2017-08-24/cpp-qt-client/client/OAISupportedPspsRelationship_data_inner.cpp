...
#include "OAISupportedPspsRelationship_data_inner.h"
...
OAISupportedPspsRelationship_data_inner::OAISupportedPspsRelationship_data_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISupportedPspsRelationship_data_inner::OAISupportedPspsRelationship_data_inner() {
    this->initializeModel();
}

OAISupportedPspsRelationship_data_inner::~OAISupportedPspsRelationship_data_inner() {}

void OAISupportedPspsRelationship_data_inner::initializeModel() {
...
void OAISupportedPspsRelationship_data_inner::fromJson(QString jsonString) {
...
void OAISupportedPspsRelationship_data_inner::fromJsonObject(QJsonObject json) {
...
QString OAISupportedPspsRelationship_data_inner::asJson() const {
...
QJsonObject OAISupportedPspsRelationship_data_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAISupportedPspsRelationship_data_inner::getId() const {
    return m_id;
}
void OAISupportedPspsRelationship_data_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISupportedPspsRelationship_data_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAISupportedPspsRelationship_data_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISupportedPspsRelationship_data_inner::getType() const {
    return m_type;
}
void OAISupportedPspsRelationship_data_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISupportedPspsRelationship_data_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAISupportedPspsRelationship_data_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAISupportedPspsRelationship_data_inner::isSet() const {
...
bool OAISupportedPspsRelationship_data_inner::isValid() const {
