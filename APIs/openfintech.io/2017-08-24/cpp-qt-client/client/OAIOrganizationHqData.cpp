...
#include "OAIOrganizationHqData.h"
...
OAIOrganizationHqData::OAIOrganizationHqData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationHqData::OAIOrganizationHqData() {
    this->initializeModel();
}

OAIOrganizationHqData::~OAIOrganizationHqData() {}

void OAIOrganizationHqData::initializeModel() {
...
void OAIOrganizationHqData::fromJson(QString jsonString) {
...
void OAIOrganizationHqData::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationHqData::asJson() const {
...
QJsonObject OAIOrganizationHqData::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIOrganizationHqData::getId() const {
    return m_id;
}
void OAIOrganizationHqData::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOrganizationHqData::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOrganizationHqData::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIOrganizationHqData::getType() const {
    return m_type;
}
void OAIOrganizationHqData::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIOrganizationHqData::is_type_Set() const{
    return m_type_isSet;
}

bool OAIOrganizationHqData::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIOrganizationHqData::isSet() const {
...
bool OAIOrganizationHqData::isValid() const {
