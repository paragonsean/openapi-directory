...
OAISupportedPspsRelationship::OAISupportedPspsRelationship(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISupportedPspsRelationship::OAISupportedPspsRelationship() {
    this->initializeModel();
}

OAISupportedPspsRelationship::~OAISupportedPspsRelationship() {}

void OAISupportedPspsRelationship::initializeModel() {
...
void OAISupportedPspsRelationship::fromJson(QString jsonString) {
...
void OAISupportedPspsRelationship::fromJsonObject(QJsonObject json) {
...
QString OAISupportedPspsRelationship::asJson() const {
...
QJsonObject OAISupportedPspsRelationship::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAISupportedPspsRelationship_data_inner> OAISupportedPspsRelationship::getData() const {
    return m_data;
}
void OAISupportedPspsRelationship::setData(const QList<OAISupportedPspsRelationship_data_inner> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAISupportedPspsRelationship::is_data_Set() const{
    return m_data_isSet;
}

bool OAISupportedPspsRelationship::is_data_Valid() const{
    return m_data_isValid;
}

OAISupportedPspsRelationship_links OAISupportedPspsRelationship::getLinks() const {
    return m_links;
}
void OAISupportedPspsRelationship::setLinks(const OAISupportedPspsRelationship_links &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAISupportedPspsRelationship::is_links_Set() const{
    return m_links_isSet;
}

bool OAISupportedPspsRelationship::is_links_Valid() const{
    return m_links_isValid;
}

bool OAISupportedPspsRelationship::isSet() const {
...
bool OAISupportedPspsRelationship::isValid() const {
