...
OAIOrganizationActive::OAIOrganizationActive(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationActive::OAIOrganizationActive() {
    this->initializeModel();
}

OAIOrganizationActive::~OAIOrganizationActive() {}

void OAIOrganizationActive::initializeModel() {
...
void OAIOrganizationActive::fromJson(QString jsonString) {
...
void OAIOrganizationActive::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationActive::asJson() const {
...
QJsonObject OAIOrganizationActive::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<QString> OAIOrganizationActive::getData() const {
    return m_data;
}
void OAIOrganizationActive::setData(const QList<QString> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIOrganizationActive::is_data_Set() const{
    return m_data_isSet;
}

bool OAIOrganizationActive::is_data_Valid() const{
    return m_data_isValid;
}

OAIOrganizationActiveLinks OAIOrganizationActive::getLinks() const {
    return m_links;
}
void OAIOrganizationActive::setLinks(const OAIOrganizationActiveLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIOrganizationActive::is_links_Set() const{
    return m_links_isSet;
}

bool OAIOrganizationActive::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIOrganizationActive::isSet() const {
...
bool OAIOrganizationActive::isValid() const {
