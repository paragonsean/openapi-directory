...
void OAICurrenciesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("currenciesIdGet", defaultConf);
    _serverIndices.insert("currenciesIdGet", 0);
}
...
void OAICurrenciesApi::currenciesGet(const ::OpenAPI::OptionalParam<qint32> &page_number, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &filter_search, const ::OpenAPI::OptionalParam<QString> &filter_code_iso_alpha3, const ::OpenAPI::OptionalParam<qint32> &filter_code_iso_numeric3, const ::OpenAPI::OptionalParam<QString> &filter_code_estandards_alpha, const ::OpenAPI::OptionalParam<QSet<QString>> &filter_currency_type, const ::OpenAPI::OptionalParam<QSet<QString>> &filter_category, const ::OpenAPI::OptionalParam<QSet<QString>> &sort) {
    QString fullPath = QString(_serverConfigs["currenciesGet"][_serverIndices.value("currenciesGet")].URL()+"/currencies");
    ...
    if (filter_code_iso_alpha3.hasValue())
    {
        queryStyle = "";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[code_iso_alpha3]", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("filter[code_iso_alpha3]")).append(querySuffix).append(QUrl::toPercentEncoding(filter_code_iso_alpha3.stringValue()));
    }
    if (filter_code_iso_numeric3.hasValue())
    {
        queryStyle = "";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[code_iso_numeric3]", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("filter[code_iso_numeric3]")).append(querySuffix).append(QUrl::toPercentEncoding(filter_code_iso_numeric3.stringValue()));
    }
    if (filter_code_estandards_alpha.hasValue())
    {
        queryStyle = "";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[code_estandards_alpha]", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("filter[code_estandards_alpha]")).append(querySuffix).append(QUrl::toPercentEncoding(filter_code_estandards_alpha.stringValue()));
    }
    if (filter_currency_type.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[currency_type]", false);
        if (filter_currency_type.value().size() > 0) {
            if (QString("csv").indexOf("multi") == 0) {
                for (QString t : filter_currency_type.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("filter[currency_type]=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("csv").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("filter[currency_type]").append(querySuffix);
                qint32 count = 0;
                for (QString t : filter_currency_type.value()) {
                    if (count > 0) {
    ...
    if (filter_category.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[category]", false);
        if (filter_category.value().size() > 0) {
            if (QString("csv").indexOf("multi") == 0) {
                for (QString t : filter_category.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("filter[category]=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("csv").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("filter[category]").append(querySuffix);
                qint32 count = 0;
                for (QString t : filter_category.value()) {
                    if (count > 0) {
                        fullPath.append((false)? queryDelimiter : QUrl::toPercentEncoding(queryDelimiter));
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICurrenciesApi::currenciesGetCallback);
...
void OAICurrenciesApi::currenciesGetCallback(OAIHttpRequestWorker *worker) {
...
void OAICurrenciesApi::currenciesIdGet(const QString &id) {
    QString fullPath = QString(_serverConfigs["currenciesIdGet"][_serverIndices.value("currenciesIdGet")].URL()+"/currencies/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICurrenciesApi::currenciesIdGetCallback);
    connect(this, &OAICurrenciesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICurrenciesApi::currenciesIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICurrencyResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT currenciesIdGetSignal(output);
        Q_EMIT currenciesIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT currenciesIdGetSignalE(output, error_type, error_str);
        Q_EMIT currenciesIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT currenciesIdGetSignalError(output, error_type, error_str);
        Q_EMIT currenciesIdGetSignalErrorFull(worker, error_type, error_str);
    }
}
