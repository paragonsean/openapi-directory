...
#include "OAIActiveInCountriesRelationship_links.h"
...
OAIActiveInCountriesRelationship_links::OAIActiveInCountriesRelationship_links(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActiveInCountriesRelationship_links::OAIActiveInCountriesRelationship_links() {
    this->initializeModel();
}

OAIActiveInCountriesRelationship_links::~OAIActiveInCountriesRelationship_links() {}

void OAIActiveInCountriesRelationship_links::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIActiveInCountriesRelationship_links::fromJson(QString jsonString) {
...
void OAIActiveInCountriesRelationship_links::fromJsonObject(QJsonObject json) {
...
QString OAIActiveInCountriesRelationship_links::asJson() const {
...
QJsonObject OAIActiveInCountriesRelationship_links::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIActiveInCountriesRelationship_links::getRelated() const {
    return m_related;
}
void OAIActiveInCountriesRelationship_links::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIActiveInCountriesRelationship_links::is_related_Set() const{
    return m_related_isSet;
}

bool OAIActiveInCountriesRelationship_links::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIActiveInCountriesRelationship_links::isSet() const {
...
bool OAIActiveInCountriesRelationship_links::isValid() const {
