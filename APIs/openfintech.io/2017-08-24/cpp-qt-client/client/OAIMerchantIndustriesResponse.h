...
/*
 * OAIMerchantIndustriesResponse.h
 *
 * 
 */

#ifndef OAIMerchantIndustriesResponse_H
#define OAIMerchantIndustriesResponse_H
...
class OAIMerchantIndustriesResponse : public OAIObject {
public:
    OAIMerchantIndustriesResponse();
    OAIMerchantIndustriesResponse(QString json);
    ~OAIMerchantIndustriesResponse() override;
    ...
    QList<OAIMerchantIndustry> getData() const;
    void setData(const QList<OAIMerchantIndustry> &data);
...
private:
    ...
    QList<OAIMerchantIndustry> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantIndustriesResponse)

#endif // OAIMerchantIndustriesResponse_H
