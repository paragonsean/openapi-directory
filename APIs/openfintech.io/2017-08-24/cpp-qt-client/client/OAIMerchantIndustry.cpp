...
OAIMerchantIndustry::OAIMerchantIndustry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMerchantIndustry::OAIMerchantIndustry() {
    this->initializeModel();
}

OAIMerchantIndustry::~OAIMerchantIndustry() {}

void OAIMerchantIndustry::initializeModel() {
...
void OAIMerchantIndustry::fromJson(QString jsonString) {
...
void OAIMerchantIndustry::fromJsonObject(QJsonObject json) {
...
QString OAIMerchantIndustry::asJson() const {
...
QJsonObject OAIMerchantIndustry::asJsonObject() const {
    QJsonObject obj;
...
OAIMerchantIndustryAttributes OAIMerchantIndustry::getAttributes() const {
    return m_attributes;
}
void OAIMerchantIndustry::setAttributes(const OAIMerchantIndustryAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIMerchantIndustry::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIMerchantIndustry::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIMerchantIndustry::getId() const {
    return m_id;
}
void OAIMerchantIndustry::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMerchantIndustry::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMerchantIndustry::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIMerchantIndustry::getType() const {
    return m_type;
}
void OAIMerchantIndustry::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIMerchantIndustry::is_type_Set() const{
    return m_type_isSet;
}

bool OAIMerchantIndustry::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIMerchantIndustry::isSet() const {
...
bool OAIMerchantIndustry::isValid() const {
