...
#ifndef OAIExchanger_H
#define OAIExchanger_H

#include <QJsonObject>

#include "OAIExchangerAttributes.h"
#include "OAIExchangerRelationships.h"
...
namespace OpenAPI {
class OAIExchangerAttributes;
class OAISelfLinks;
class OAIExchangerRelationships;

class OAIExchanger : public OAIObject {
public:
    OAIExchanger();
    OAIExchanger(QString json);
    ~OAIExchanger() override;
    ...
    OAIExchangerAttributes getAttributes() const;
    void setAttributes(const OAIExchangerAttributes &attributes);
    ...
    OAIExchangerRelationships getRelationships() const;
    void setRelationships(const OAIExchangerRelationships &relationships);
...
private:
    ...
    OAIExchangerAttributes m_attributes;
    ...
    OAIExchangerRelationships m_relationships;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchanger)

#endif // OAIExchanger_H
