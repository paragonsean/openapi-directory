...
/*
 * OAIActiveInCountriesRelationship_links.h
 *
 * 
 */

#ifndef OAIActiveInCountriesRelationship_links_H
#define OAIActiveInCountriesRelationship_links_H
...
class OAIActiveInCountriesRelationship_links : public OAIObject {
public:
    OAIActiveInCountriesRelationship_links();
    OAIActiveInCountriesRelationship_links(QString json);
    ~OAIActiveInCountriesRelationship_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActiveInCountriesRelationship_links)

#endif // OAIActiveInCountriesRelationship_links_H
