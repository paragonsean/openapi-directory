...
#ifndef OAI_OAIPaymentProvidersApi_H
#define OAI_OAIPaymentProvidersApi_H
...
#include "OAIPaymentProviderResponse.h"
#include "OAIPaymentProvidersResponse.h"
#include <QSet>
#include <QString>
...
class OAIPaymentProvidersApi : public QObject {
    Q_OBJECT

public:
    OAIPaymentProvidersApi(const int timeOut = 0);
    ~OAIPaymentProvidersApi();
    ...
    * @param[in]  filter_search QString [optional]
    * @param[in]  filter_name QString [optional]
    * @param[in]  filter_code QString [optional]
    * @param[in]  filter_types QSet<QString> [optional]
    * @param[in]  filter_sales_channels QSet<QString> [optional]
    * @param[in]  filter_features QSet<QString> [optional]
    * @param[in]  sort QSet<QString> [optional]
    */
    virtual void paymentProvidersGet(const ::OpenAPI::OptionalParam<qint32> &page_number = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &filter_search = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter_code = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_types = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_sales_channels = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_features = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QSet<QString>> &sort = ::OpenAPI::OptionalParam<QSet<QString>>());

    /**
    * @param[in]  id QString [required]
    */
    virtual void paymentProvidersIdGet(const QString &id);
...
private:
    ...
    void paymentProvidersGetCallback(OAIHttpRequestWorker *worker);
    void paymentProvidersIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void paymentProvidersGetSignal(OAIPaymentProvidersResponse summary);
    void paymentProvidersIdGetSignal(OAIPaymentProviderResponse summary);


    void paymentProvidersGetSignalFull(OAIHttpRequestWorker *worker, OAIPaymentProvidersResponse summary);
    void paymentProvidersIdGetSignalFull(OAIHttpRequestWorker *worker, OAIPaymentProviderResponse summary);

    Q_DECL_DEPRECATED_X("Use paymentProvidersGetSignalError() instead")
    void paymentProvidersGetSignalE(OAIPaymentProvidersResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void paymentProvidersGetSignalError(OAIPaymentProvidersResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use paymentProvidersIdGetSignalError() instead")
    void paymentProvidersIdGetSignalE(OAIPaymentProviderResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void paymentProvidersIdGetSignalError(OAIPaymentProviderResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use paymentProvidersGetSignalErrorFull() instead")
    void paymentProvidersGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void paymentProvidersGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use paymentProvidersIdGetSignalErrorFull() instead")
    void paymentProvidersIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void paymentProvidersIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
