...
#include "OAIPaymentMethodCurrenciesLinks.h"
...
OAIPaymentMethodCurrenciesLinks::OAIPaymentMethodCurrenciesLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentMethodCurrenciesLinks::OAIPaymentMethodCurrenciesLinks() {
    this->initializeModel();
}

OAIPaymentMethodCurrenciesLinks::~OAIPaymentMethodCurrenciesLinks() {}

void OAIPaymentMethodCurrenciesLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIPaymentMethodCurrenciesLinks::fromJson(QString jsonString) {
...
void OAIPaymentMethodCurrenciesLinks::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentMethodCurrenciesLinks::asJson() const {
...
QJsonObject OAIPaymentMethodCurrenciesLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIPaymentMethodCurrenciesLinks::getRelated() const {
    return m_related;
}
void OAIPaymentMethodCurrenciesLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIPaymentMethodCurrenciesLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAIPaymentMethodCurrenciesLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIPaymentMethodCurrenciesLinks::isSet() const {
...
bool OAIPaymentMethodCurrenciesLinks::isValid() const {
