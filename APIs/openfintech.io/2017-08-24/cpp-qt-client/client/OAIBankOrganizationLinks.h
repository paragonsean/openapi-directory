...
/*
 * OAIBankOrganizationLinks.h
 *
 * 
 */

#ifndef OAIBankOrganizationLinks_H
#define OAIBankOrganizationLinks_H
...
class OAIBankOrganizationLinks : public OAIObject {
public:
    OAIBankOrganizationLinks();
    OAIBankOrganizationLinks(QString json);
    ~OAIBankOrganizationLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankOrganizationLinks)

#endif // OAIBankOrganizationLinks_H
