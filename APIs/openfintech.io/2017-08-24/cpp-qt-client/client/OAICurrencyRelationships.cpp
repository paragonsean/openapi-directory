...
OAICurrencyRelationships::OAICurrencyRelationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyRelationships::OAICurrencyRelationships() {
    this->initializeModel();
}

OAICurrencyRelationships::~OAICurrencyRelationships() {}

void OAICurrencyRelationships::initializeModel() {
    ...
    m_issuer_organization_isSet = false;
    m_issuer_organization_isValid = false;

    m_parent_isSet = false;
    m_parent_isValid = false;
}

void OAICurrencyRelationships::fromJson(QString jsonString) {
...
void OAICurrencyRelationships::fromJsonObject(QJsonObject json) {
    ...
    m_issuer_organization_isValid = ::OpenAPI::fromJsonValue(m_issuer_organization, json[QString("issuer_organization")]);
    m_issuer_organization_isSet = !json[QString("issuer_organization")].isNull() && m_issuer_organization_isValid;

    m_parent_isValid = ::OpenAPI::fromJsonValue(m_parent, json[QString("parent")]);
    m_parent_isSet = !json[QString("parent")].isNull() && m_parent_isValid;
}

QString OAICurrencyRelationships::asJson() const {
...
QJsonObject OAICurrencyRelationships::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_issuer_organization.isSet()) {
        obj.insert(QString("issuer_organization"), ::OpenAPI::toJsonValue(m_issuer_organization));
    }
    if (m_parent.isSet()) {
...
OAICurrencyCountries OAICurrencyRelationships::getCountries() const {
    return m_countries;
}
void OAICurrencyRelationships::setCountries(const OAICurrencyCountries &countries) {
    m_countries = countries;
    m_countries_isSet = true;
}

bool OAICurrencyRelationships::is_countries_Set() const{
    return m_countries_isSet;
}

bool OAICurrencyRelationships::is_countries_Valid() const{
    return m_countries_isValid;
}

OAICurrencyIssuer OAICurrencyRelationships::getIssuer() const {
    return m_issuer;
}
void OAICurrencyRelationships::setIssuer(const OAICurrencyIssuer &issuer) {
    m_issuer = issuer;
    m_issuer_isSet = true;
}

bool OAICurrencyRelationships::is_issuer_Set() const{
    return m_issuer_isSet;
}

bool OAICurrencyRelationships::is_issuer_Valid() const{
    return m_issuer_isValid;
}

OAICurrencyIssuerOrganization OAICurrencyRelationships::getIssuerOrganization() const {
    return m_issuer_organization;
}
void OAICurrencyRelationships::setIssuerOrganization(const OAICurrencyIssuerOrganization &issuer_organization) {
    m_issuer_organization = issuer_organization;
    m_issuer_organization_isSet = true;
}

bool OAICurrencyRelationships::is_issuer_organization_Set() const{
    return m_issuer_organization_isSet;
}

bool OAICurrencyRelationships::is_issuer_organization_Valid() const{
    return m_issuer_organization_isValid;
}

OAICurrencyParent OAICurrencyRelationships::getParent() const {
    return m_parent;
}
void OAICurrencyRelationships::setParent(const OAICurrencyParent &parent) {
    m_parent = parent;
    m_parent_isSet = true;
}

bool OAICurrencyRelationships::is_parent_Set() const{
    return m_parent_isSet;
}

bool OAICurrencyRelationships::is_parent_Valid() const{
    return m_parent_isValid;
}

bool OAICurrencyRelationships::isSet() const {
...
bool OAICurrencyRelationships::isValid() const {
