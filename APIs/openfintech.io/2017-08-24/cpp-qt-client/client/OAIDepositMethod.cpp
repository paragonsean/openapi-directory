...
OAIDepositMethod::OAIDepositMethod(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDepositMethod::OAIDepositMethod() {
    this->initializeModel();
}

OAIDepositMethod::~OAIDepositMethod() {}

void OAIDepositMethod::initializeModel() {
...
void OAIDepositMethod::fromJson(QString jsonString) {
...
void OAIDepositMethod::fromJsonObject(QJsonObject json) {
...
QString OAIDepositMethod::asJson() const {
...
QJsonObject OAIDepositMethod::asJsonObject() const {
    QJsonObject obj;
...
OAIDepositMethodAttributes OAIDepositMethod::getAttributes() const {
    return m_attributes;
}
void OAIDepositMethod::setAttributes(const OAIDepositMethodAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIDepositMethod::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIDepositMethod::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIDepositMethod::getId() const {
    return m_id;
}
void OAIDepositMethod::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDepositMethod::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDepositMethod::is_id_Valid() const{
    return m_id_isValid;
}

OAISelfLinks OAIDepositMethod::getLinks() const {
    return m_links;
}
void OAIDepositMethod::setLinks(const OAISelfLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIDepositMethod::is_links_Set() const{
    return m_links_isSet;
}

bool OAIDepositMethod::is_links_Valid() const{
    return m_links_isValid;
}

OAIDepositMethodRelationships OAIDepositMethod::getRelationships() const {
    return m_relationships;
}
void OAIDepositMethod::setRelationships(const OAIDepositMethodRelationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIDepositMethod::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIDepositMethod::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAIDepositMethod::getType() const {
    return m_type;
}
void OAIDepositMethod::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDepositMethod::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDepositMethod::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDepositMethod::isSet() const {
...
bool OAIDepositMethod::isValid() const {
