...
#ifndef OAISelfLinks_H
#define OAISelfLinks_H
...
class OAISelfLinks : public OAIObject {
public:
    OAISelfLinks();
    OAISelfLinks(QString json);
    ~OAISelfLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISelfLinks)

#endif // OAISelfLinks_H
