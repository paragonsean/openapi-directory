...
OAIBankOrganizationData::OAIBankOrganizationData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBankOrganizationData::OAIBankOrganizationData() {
    this->initializeModel();
}

OAIBankOrganizationData::~OAIBankOrganizationData() {}

void OAIBankOrganizationData::initializeModel() {
...
void OAIBankOrganizationData::fromJson(QString jsonString) {
...
void OAIBankOrganizationData::fromJsonObject(QJsonObject json) {
...
QString OAIBankOrganizationData::asJson() const {
...
QJsonObject OAIBankOrganizationData::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIBankOrganizationData::getId() const {
    return m_id;
}
void OAIBankOrganizationData::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBankOrganizationData::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBankOrganizationData::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIBankOrganizationData::getType() const {
    return m_type;
}
void OAIBankOrganizationData::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIBankOrganizationData::is_type_Set() const{
    return m_type_isSet;
}

bool OAIBankOrganizationData::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIBankOrganizationData::isSet() const {
...
bool OAIBankOrganizationData::isValid() const {
