...
OAICurrencyIssuertData::OAICurrencyIssuertData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyIssuertData::OAICurrencyIssuertData() {
    this->initializeModel();
}

OAICurrencyIssuertData::~OAICurrencyIssuertData() {}

void OAICurrencyIssuertData::initializeModel() {
...
void OAICurrencyIssuertData::fromJson(QString jsonString) {
...
void OAICurrencyIssuertData::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyIssuertData::asJson() const {
...
QJsonObject OAICurrencyIssuertData::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAICurrencyIssuertData::getId() const {
    return m_id;
}
void OAICurrencyIssuertData::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICurrencyIssuertData::is_id_Set() const{
    return m_id_isSet;
}

bool OAICurrencyIssuertData::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICurrencyIssuertData::getType() const {
    return m_type;
}
void OAICurrencyIssuertData::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICurrencyIssuertData::is_type_Set() const{
    return m_type_isSet;
}

bool OAICurrencyIssuertData::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICurrencyIssuertData::isSet() const {
...
bool OAICurrencyIssuertData::isValid() const {
