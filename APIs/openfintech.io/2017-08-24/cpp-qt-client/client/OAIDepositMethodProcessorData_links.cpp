...
OAIDepositMethodProcessorData_links::OAIDepositMethodProcessorData_links(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDepositMethodProcessorData_links::OAIDepositMethodProcessorData_links() {
    this->initializeModel();
}

OAIDepositMethodProcessorData_links::~OAIDepositMethodProcessorData_links() {}

void OAIDepositMethodProcessorData_links::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIDepositMethodProcessorData_links::fromJson(QString jsonString) {
...
void OAIDepositMethodProcessorData_links::fromJsonObject(QJsonObject json) {
...
QString OAIDepositMethodProcessorData_links::asJson() const {
...
QJsonObject OAIDepositMethodProcessorData_links::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIDepositMethodProcessorData_links::getRelated() const {
    return m_related;
}
void OAIDepositMethodProcessorData_links::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIDepositMethodProcessorData_links::is_related_Set() const{
    return m_related_isSet;
}

bool OAIDepositMethodProcessorData_links::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIDepositMethodProcessorData_links::isSet() const {
...
bool OAIDepositMethodProcessorData_links::isValid() const {
