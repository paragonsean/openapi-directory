...
/*
 * OAIOrganizationSourceData.h
 *
 * 
 */

#ifndef OAIOrganizationSourceData_H
#define OAIOrganizationSourceData_H
...
class OAIOrganizationSourceData : public OAIObject {
public:
    OAIOrganizationSourceData();
    OAIOrganizationSourceData(QString json);
    ~OAIOrganizationSourceData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationSourceData)

#endif // OAIOrganizationSourceData_H
