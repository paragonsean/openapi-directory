...
#include "OAICountryRelationships.h"
...
OAICountryRelationships::OAICountryRelationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICountryRelationships::OAICountryRelationships() {
    this->initializeModel();
}

OAICountryRelationships::~OAICountryRelationships() {}

void OAICountryRelationships::initializeModel() {

    m_translations_isSet = false;
    m_translations_isValid = false;
}

void OAICountryRelationships::fromJson(QString jsonString) {
...
void OAICountryRelationships::fromJsonObject(QJsonObject json) {
...
QString OAICountryRelationships::asJson() const {
...
QJsonObject OAICountryRelationships::asJsonObject() const {
    QJsonObject obj;
    if (m_translations.isSet()) {
        obj.insert(QString("translations"), ::OpenAPI::toJsonValue(m_translations));
    }
    return obj;
}

OAICountryTranslations OAICountryRelationships::getTranslations() const {
    return m_translations;
}
void OAICountryRelationships::setTranslations(const OAICountryTranslations &translations) {
    m_translations = translations;
    m_translations_isSet = true;
}

bool OAICountryRelationships::is_translations_Set() const{
    return m_translations_isSet;
}

bool OAICountryRelationships::is_translations_Valid() const{
    return m_translations_isValid;
}

bool OAICountryRelationships::isSet() const {
...
bool OAICountryRelationships::isValid() const {
