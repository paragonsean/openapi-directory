...
#include "OAIOrganizationSourceLinks.h"
...
OAIOrganizationSourceLinks::OAIOrganizationSourceLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationSourceLinks::OAIOrganizationSourceLinks() {
    this->initializeModel();
}

OAIOrganizationSourceLinks::~OAIOrganizationSourceLinks() {}

void OAIOrganizationSourceLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIOrganizationSourceLinks::fromJson(QString jsonString) {
...
void OAIOrganizationSourceLinks::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationSourceLinks::asJson() const {
...
QJsonObject OAIOrganizationSourceLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIOrganizationSourceLinks::getRelated() const {
    return m_related;
}
void OAIOrganizationSourceLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIOrganizationSourceLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAIOrganizationSourceLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIOrganizationSourceLinks::isSet() const {
...
bool OAIOrganizationSourceLinks::isValid() const {
