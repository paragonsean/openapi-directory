...
#include "OAIMerchantIndustriesResponse.h"
...
OAIMerchantIndustriesResponse::OAIMerchantIndustriesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMerchantIndustriesResponse::OAIMerchantIndustriesResponse() {
    this->initializeModel();
}

OAIMerchantIndustriesResponse::~OAIMerchantIndustriesResponse() {}

void OAIMerchantIndustriesResponse::initializeModel() {
...
void OAIMerchantIndustriesResponse::fromJson(QString jsonString) {
...
void OAIMerchantIndustriesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIMerchantIndustriesResponse::asJson() const {
...
QJsonObject OAIMerchantIndustriesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIMerchantIndustry> OAIMerchantIndustriesResponse::getData() const {
    return m_data;
}
void OAIMerchantIndustriesResponse::setData(const QList<OAIMerchantIndustry> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMerchantIndustriesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMerchantIndustriesResponse::is_data_Valid() const{
    return m_data_isValid;
}

OAIResponseLinks OAIMerchantIndustriesResponse::getLinks() const {
    return m_links;
}
void OAIMerchantIndustriesResponse::setLinks(const OAIResponseLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIMerchantIndustriesResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAIMerchantIndustriesResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIResponseMeta OAIMerchantIndustriesResponse::getMeta() const {
    return m_meta;
}
void OAIMerchantIndustriesResponse::setMeta(const OAIResponseMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIMerchantIndustriesResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIMerchantIndustriesResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIMerchantIndustriesResponse::isSet() const {
...
bool OAIMerchantIndustriesResponse::isValid() const {
