...
/*
 * OAISupportedPspsRelationship_links.h
 *
 * 
 */

#ifndef OAISupportedPspsRelationship_links_H
#define OAISupportedPspsRelationship_links_H
...
class OAISupportedPspsRelationship_links : public OAIObject {
public:
    OAISupportedPspsRelationship_links();
    OAISupportedPspsRelationship_links(QString json);
    ~OAISupportedPspsRelationship_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISupportedPspsRelationship_links)

#endif // OAISupportedPspsRelationship_links_H
