...
/*
 * OAIDepositMethodProcessorData_data_inner.h
 *
 * 
 */

#ifndef OAIDepositMethodProcessorData_data_inner_H
#define OAIDepositMethodProcessorData_data_inner_H
...
class OAIDepositMethodProcessorData_data_inner : public OAIObject {
public:
    OAIDepositMethodProcessorData_data_inner();
    OAIDepositMethodProcessorData_data_inner(QString json);
    ~OAIDepositMethodProcessorData_data_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDepositMethodProcessorData_data_inner)

#endif // OAIDepositMethodProcessorData_data_inner_H
