...
#ifndef OAIBankResponse_H
#define OAIBankResponse_H
...
class OAIBankResponse : public OAIObject {
public:
    OAIBankResponse();
    OAIBankResponse(QString json);
    ~OAIBankResponse() override;
    ...
    OAIBank getData() const;
    void setData(const OAIBank &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankResponse)

#endif // OAIBankResponse_H
