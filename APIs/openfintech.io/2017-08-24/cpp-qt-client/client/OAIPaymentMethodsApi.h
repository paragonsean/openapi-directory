...
public:
    ...
    * @param[in]  filter_processor_name QString [optional]
    * @param[in]  filter_category QSet<QString> [optional]
    * @param[in]  sort QSet<QString> [optional]
    */
    virtual void paymentMethodsGet(const ::OpenAPI::OptionalParam<qint32> &page_number = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &filter_search = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter_code = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter_processor_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_category = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QSet<QString>> &sort = ::OpenAPI::OptionalParam<QSet<QString>>());

    /**
    * @param[in]  id QString [required]
    */
    virtual void paymentMethodsIdGet(const QString &id);
...
private:
    ...
    void paymentMethodsIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void paymentMethodsGetSignal(OAIPaymentMethodsResponse summary);
    void paymentMethodsIdGetSignal(OAIPaymentMethodResponse summary);


    void paymentMethodsGetSignalFull(OAIHttpRequestWorker *worker, OAIPaymentMethodsResponse summary);
    void paymentMethodsIdGetSignalFull(OAIHttpRequestWorker *worker, OAIPaymentMethodResponse summary);

    Q_DECL_DEPRECATED_X("Use paymentMethodsGetSignalError() instead")
    void paymentMethodsGetSignalE(OAIPaymentMethodsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void paymentMethodsGetSignalError(OAIPaymentMethodsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use paymentMethodsIdGetSignalError() instead")
    void paymentMethodsIdGetSignalE(OAIPaymentMethodResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void paymentMethodsIdGetSignalError(OAIPaymentMethodResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use paymentMethodsIdGetSignalErrorFull() instead")
    void paymentMethodsIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void paymentMethodsIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
