...
/*
 * OAIMerchantIndustry.h
 *
 * 
 */

#ifndef OAIMerchantIndustry_H
#define OAIMerchantIndustry_H

#include <QJsonObject>

#include "OAIMerchantIndustryAttributes.h"
#include <QString>
...
namespace OpenAPI {
class OAIMerchantIndustryAttributes;

class OAIMerchantIndustry : public OAIObject {
public:
    OAIMerchantIndustry();
    OAIMerchantIndustry(QString json);
    ~OAIMerchantIndustry() override;
    ...
    OAIMerchantIndustryAttributes getAttributes() const;
    void setAttributes(const OAIMerchantIndustryAttributes &attributes);
...
private:
    ...
    OAIMerchantIndustryAttributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantIndustry)

#endif // OAIMerchantIndustry_H
