...
OAIPaymentMethodAttributes::OAIPaymentMethodAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentMethodAttributes::OAIPaymentMethodAttributes() {
    this->initializeModel();
}

OAIPaymentMethodAttributes::~OAIPaymentMethodAttributes() {}

void OAIPaymentMethodAttributes::initializeModel() {
...
void OAIPaymentMethodAttributes::fromJson(QString jsonString) {
...
void OAIPaymentMethodAttributes::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentMethodAttributes::asJson() const {
...
QJsonObject OAIPaymentMethodAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_category_isSet) {
...
QString OAIPaymentMethodAttributes::getCategory() const {
    return m_category;
}
void OAIPaymentMethodAttributes::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIPaymentMethodAttributes::is_category_Set() const{
    return m_category_isSet;
}

bool OAIPaymentMethodAttributes::is_category_Valid() const{
    return m_category_isValid;
}

QString OAIPaymentMethodAttributes::getCode() const {
    return m_code;
}
void OAIPaymentMethodAttributes::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIPaymentMethodAttributes::is_code_Set() const{
    return m_code_isSet;
}

bool OAIPaymentMethodAttributes::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIPaymentMethodAttributes::getName() const {
    return m_name;
}
void OAIPaymentMethodAttributes::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPaymentMethodAttributes::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPaymentMethodAttributes::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPaymentMethodAttributes::getProcessorName() const {
    return m_processor_name;
}
void OAIPaymentMethodAttributes::setProcessorName(const QString &processor_name) {
    m_processor_name = processor_name;
    m_processor_name_isSet = true;
}

bool OAIPaymentMethodAttributes::is_processor_name_Set() const{
    return m_processor_name_isSet;
}

bool OAIPaymentMethodAttributes::is_processor_name_Valid() const{
    return m_processor_name_isValid;
}

bool OAIPaymentMethodAttributes::isSet() const {
...
bool OAIPaymentMethodAttributes::isValid() const {
