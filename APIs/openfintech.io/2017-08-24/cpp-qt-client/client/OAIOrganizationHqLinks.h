...
/*
 * OAIOrganizationHqLinks.h
 *
 * 
 */

#ifndef OAIOrganizationHqLinks_H
#define OAIOrganizationHqLinks_H
...
class OAIOrganizationHqLinks : public OAIObject {
public:
    OAIOrganizationHqLinks();
    OAIOrganizationHqLinks(QString json);
    ~OAIOrganizationHqLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationHqLinks)

#endif // OAIOrganizationHqLinks_H
