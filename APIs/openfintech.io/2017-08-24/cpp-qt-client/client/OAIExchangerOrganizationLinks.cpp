...
#include "OAIExchangerOrganizationLinks.h"
...
OAIExchangerOrganizationLinks::OAIExchangerOrganizationLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExchangerOrganizationLinks::OAIExchangerOrganizationLinks() {
    this->initializeModel();
}

OAIExchangerOrganizationLinks::~OAIExchangerOrganizationLinks() {}

void OAIExchangerOrganizationLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIExchangerOrganizationLinks::fromJson(QString jsonString) {
...
void OAIExchangerOrganizationLinks::fromJsonObject(QJsonObject json) {
...
QString OAIExchangerOrganizationLinks::asJson() const {
...
QJsonObject OAIExchangerOrganizationLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIExchangerOrganizationLinks::getRelated() const {
    return m_related;
}
void OAIExchangerOrganizationLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIExchangerOrganizationLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAIExchangerOrganizationLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIExchangerOrganizationLinks::isSet() const {
...
bool OAIExchangerOrganizationLinks::isValid() const {
