...
/*
 * OAIPaymentProviderRelationships.h
 *
 * 
 */

#ifndef OAIPaymentProviderRelationships_H
#define OAIPaymentProviderRelationships_H
...
namespace OpenAPI {
class OAIPaymentProviderOrganization;
class OAIPaymentProviderPaymentMethods;

class OAIPaymentProviderRelationships : public OAIObject {
public:
    OAIPaymentProviderRelationships();
    OAIPaymentProviderRelationships(QString json);
    ~OAIPaymentProviderRelationships() override;
    ...
    OAIPaymentProviderOrganization getOrganization() const;
    void setOrganization(const OAIPaymentProviderOrganization &organization);
    bool is_organization_Set() const;
    bool is_organization_Valid() const;

    OAIPaymentProviderPaymentMethods getPaymentMethods() const;
    void setPaymentMethods(const OAIPaymentProviderPaymentMethods &payment_methods);
...
private:
    ...
    OAIPaymentProviderOrganization m_organization;
    bool m_organization_isSet;
    bool m_organization_isValid;

    OAIPaymentProviderPaymentMethods m_payment_methods;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentProviderRelationships)

#endif // OAIPaymentProviderRelationships_H
