...
#ifndef OAIResponseLinks_H
#define OAIResponseLinks_H
...
class OAIResponseLinks : public OAIObject {
public:
    OAIResponseLinks();
    OAIResponseLinks(QString json);
    ~OAIResponseLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseLinks)

#endif // OAIResponseLinks_H
