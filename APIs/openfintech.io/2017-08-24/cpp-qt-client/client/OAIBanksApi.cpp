...
OAIBanksApi::OAIBanksApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIBanksApi::~OAIBanksApi() {
}

void OAIBanksApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("banksGet", defaultConf);
    _serverIndices.insert("banksGet", 0);
    _serverConfigs.insert("banksIdGet", defaultConf);
    _serverIndices.insert("banksIdGet", 0);
}
...
*/
int OAIBanksApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIBanksApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIBanksApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIBanksApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIBanksApi::setUsername(const QString &username) {
    _username = username;
}

void OAIBanksApi::setPassword(const QString &password) {
    _password = password;
}


void OAIBanksApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIBanksApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIBanksApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIBanksApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBanksApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBanksApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIBanksApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIBanksApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIBanksApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIBanksApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIBanksApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIBanksApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIBanksApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIBanksApi::banksGet(const ::OpenAPI::OptionalParam<qint32> &page_number, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &filter_sort_code, const ::OpenAPI::OptionalParam<QString> &filter_code, const ::OpenAPI::OptionalParam<QSet<QString>> &filter_status, const ::OpenAPI::OptionalParam<QSet<QString>> &sort) {
    QString fullPath = QString(_serverConfigs["banksGet"][_serverIndices.value("banksGet")].URL()+"/banks");
    ...
    if (filter_sort_code.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[sort_code]", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("filter[sort_code]")).append(querySuffix).append(QUrl::toPercentEncoding(filter_sort_code.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBanksApi::banksGetCallback);
    connect(this, &OAIBanksApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIBanksApi::banksGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIBanksResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT banksGetSignal(output);
        Q_EMIT banksGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT banksGetSignalE(output, error_type, error_str);
        Q_EMIT banksGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT banksGetSignalError(output, error_type, error_str);
        Q_EMIT banksGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBanksApi::banksIdGet(const QString &id) {
    QString fullPath = QString(_serverConfigs["banksIdGet"][_serverIndices.value("banksIdGet")].URL()+"/banks/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBanksApi::banksIdGetCallback);
    connect(this, &OAIBanksApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBanksApi::banksIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBankResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT banksIdGetSignal(output);
        Q_EMIT banksIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT banksIdGetSignalE(output, error_type, error_str);
        Q_EMIT banksIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT banksIdGetSignalError(output, error_type, error_str);
        Q_EMIT banksIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBanksApi::tokenAvailable(){
