...
/*
 * OAICurrencyIssuerOrganizationData.h
 *
 * 
 */

#ifndef OAICurrencyIssuerOrganizationData_H
#define OAICurrencyIssuerOrganizationData_H
...
class OAICurrencyIssuerOrganizationData : public OAIObject {
public:
    OAICurrencyIssuerOrganizationData();
    OAICurrencyIssuerOrganizationData(QString json);
    ~OAICurrencyIssuerOrganizationData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyIssuerOrganizationData)

#endif // OAICurrencyIssuerOrganizationData_H
