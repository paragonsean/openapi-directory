...
#ifndef OAI_OAIExchangersApi_H
#define OAI_OAIExchangersApi_H
...
class OAIExchangersApi : public QObject {
    Q_OBJECT

public:
    OAIExchangersApi(const int timeOut = 0);
    ~OAIExchangersApi();
    ...
    * @param[in]  filter_status QSet<QString> [optional]
    * @param[in]  sort QSet<QString> [optional]
    */
    virtual void exchangersGet(const ::OpenAPI::OptionalParam<qint32> &page_number = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &filter_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_status = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QSet<QString>> &sort = ::OpenAPI::OptionalParam<QSet<QString>>());

    /**
    * @param[in]  id QString [required]
    */
    virtual void exchangersIdGet(const QString &id);
...
private:
    ...
    void exchangersGetCallback(OAIHttpRequestWorker *worker);
    void exchangersIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void exchangersGetSignal(OAIExchangersResponse summary);
    void exchangersIdGetSignal(OAIExchangerResponse summary);


    void exchangersGetSignalFull(OAIHttpRequestWorker *worker, OAIExchangersResponse summary);
    void exchangersIdGetSignalFull(OAIHttpRequestWorker *worker, OAIExchangerResponse summary);

    Q_DECL_DEPRECATED_X("Use exchangersGetSignalError() instead")
    void exchangersGetSignalE(OAIExchangersResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void exchangersGetSignalError(OAIExchangersResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use exchangersIdGetSignalError() instead")
    void exchangersIdGetSignalE(OAIExchangerResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void exchangersIdGetSignalError(OAIExchangerResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use exchangersGetSignalErrorFull() instead")
    void exchangersGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void exchangersGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use exchangersIdGetSignalErrorFull() instead")
    void exchangersIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void exchangersIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
