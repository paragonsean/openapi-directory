...
#ifndef OAIOrganizationHq_H
#define OAIOrganizationHq_H
...
namespace OpenAPI {
class OAIOrganizationHqData;
class OAIOrganizationHqLinks;

class OAIOrganizationHq : public OAIObject {
public:
    OAIOrganizationHq();
    OAIOrganizationHq(QString json);
    ~OAIOrganizationHq() override;
    ...
    OAIOrganizationHqData getData() const;
    void setData(const OAIOrganizationHqData &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIOrganizationHqLinks getLinks() const;
    void setLinks(const OAIOrganizationHqLinks &links);
...
private:
    ...
    OAIOrganizationHqData m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIOrganizationHqLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationHq)

#endif // OAIOrganizationHq_H
