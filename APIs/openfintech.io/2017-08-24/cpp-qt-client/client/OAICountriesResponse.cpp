...
QList<OAICountry> OAICountriesResponse::getData() const {
    return m_data;
}
void OAICountriesResponse::setData(const QList<OAICountry> &data) {
    m_data = data;
    m_data_isSet = true;
}
...
OAIResponseLinks OAICountriesResponse::getLinks() const {
    return m_links;
}
void OAICountriesResponse::setLinks(const OAIResponseLinks &links) {
    m_links = links;
    m_links_isSet = true;
}
...
OAIResponseMeta OAICountriesResponse::getMeta() const {
    return m_meta;
}
void OAICountriesResponse::setMeta(const OAIResponseMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAICountriesResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAICountriesResponse::is_meta_Valid() const{
