...
#ifndef OAICurrencyIssuer_H
#define OAICurrencyIssuer_H

#include <QJsonObject>

#include "OAICurrencyIssuerLinks.h"
#include "OAICurrencyIssuertData.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICurrencyIssuertData;
class OAICurrencyIssuerLinks;

class OAICurrencyIssuer : public OAIObject {
public:
    OAICurrencyIssuer();
    OAICurrencyIssuer(QString json);
    ~OAICurrencyIssuer() override;
    ...
    OAICurrencyIssuertData getData() const;
    void setData(const OAICurrencyIssuertData &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAICurrencyIssuerLinks getLinks() const;
    void setLinks(const OAICurrencyIssuerLinks &links);
...
private:
    ...
    OAICurrencyIssuertData m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAICurrencyIssuerLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyIssuer)

#endif // OAICurrencyIssuer_H
