...
/*
 * OAICountryTranslationsLinks.h
 *
 * 
 */

#ifndef OAICountryTranslationsLinks_H
#define OAICountryTranslationsLinks_H
...
class OAICountryTranslationsLinks : public OAIObject {
public:
    OAICountryTranslationsLinks();
    OAICountryTranslationsLinks(QString json);
    ~OAICountryTranslationsLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICountryTranslationsLinks)

#endif // OAICountryTranslationsLinks_H
