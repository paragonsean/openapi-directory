...
/*
 * OAIDepositMethodResponse.h
 *
 * 
 */

#ifndef OAIDepositMethodResponse_H
#define OAIDepositMethodResponse_H

#include <QJsonObject>

#include "OAIDepositMethod.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDepositMethod;

class OAIDepositMethodResponse : public OAIObject {
public:
    OAIDepositMethodResponse();
    OAIDepositMethodResponse(QString json);
    ~OAIDepositMethodResponse() override;
    ...
    OAIDepositMethod getData() const;
    void setData(const OAIDepositMethod &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDepositMethodResponse)

#endif // OAIDepositMethodResponse_H
