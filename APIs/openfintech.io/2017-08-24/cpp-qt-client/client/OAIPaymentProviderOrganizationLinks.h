...
/*
 * OAIPaymentProviderOrganizationLinks.h
 *
 * 
 */

#ifndef OAIPaymentProviderOrganizationLinks_H
#define OAIPaymentProviderOrganizationLinks_H
...
class OAIPaymentProviderOrganizationLinks : public OAIObject {
public:
    OAIPaymentProviderOrganizationLinks();
    OAIPaymentProviderOrganizationLinks(QString json);
    ~OAIPaymentProviderOrganizationLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentProviderOrganizationLinks)

#endif // OAIPaymentProviderOrganizationLinks_H
