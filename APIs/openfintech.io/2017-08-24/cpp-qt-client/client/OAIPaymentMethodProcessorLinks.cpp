...
#include "OAIPaymentMethodProcessorLinks.h"
...
OAIPaymentMethodProcessorLinks::OAIPaymentMethodProcessorLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentMethodProcessorLinks::OAIPaymentMethodProcessorLinks() {
    this->initializeModel();
}

OAIPaymentMethodProcessorLinks::~OAIPaymentMethodProcessorLinks() {}

void OAIPaymentMethodProcessorLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAIPaymentMethodProcessorLinks::fromJson(QString jsonString) {
...
void OAIPaymentMethodProcessorLinks::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentMethodProcessorLinks::asJson() const {
...
QJsonObject OAIPaymentMethodProcessorLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAIPaymentMethodProcessorLinks::getRelated() const {
    return m_related;
}
void OAIPaymentMethodProcessorLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAIPaymentMethodProcessorLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAIPaymentMethodProcessorLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAIPaymentMethodProcessorLinks::isSet() const {
...
bool OAIPaymentMethodProcessorLinks::isValid() const {
