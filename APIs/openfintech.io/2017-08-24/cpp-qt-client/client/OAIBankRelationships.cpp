...
OAIBankRelationships::OAIBankRelationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBankRelationships::OAIBankRelationships() {
    this->initializeModel();
}

OAIBankRelationships::~OAIBankRelationships() {}

void OAIBankRelationships::initializeModel() {

    m_organization_isSet = false;
    m_organization_isValid = false;
}

void OAIBankRelationships::fromJson(QString jsonString) {
...
void OAIBankRelationships::fromJsonObject(QJsonObject json) {

    m_organization_isValid = ::OpenAPI::fromJsonValue(m_organization, json[QString("organization")]);
    m_organization_isSet = !json[QString("organization")].isNull() && m_organization_isValid;
}

QString OAIBankRelationships::asJson() const {
...
QJsonObject OAIBankRelationships::asJsonObject() const {
    QJsonObject obj;
...
OAIBankOrganization OAIBankRelationships::getOrganization() const {
    return m_organization;
}
void OAIBankRelationships::setOrganization(const OAIBankOrganization &organization) {
    m_organization = organization;
    m_organization_isSet = true;
}

bool OAIBankRelationships::is_organization_Set() const{
    return m_organization_isSet;
}

bool OAIBankRelationships::is_organization_Valid() const{
    return m_organization_isValid;
}

bool OAIBankRelationships::isSet() const {
...
bool OAIBankRelationships::isValid() const {
