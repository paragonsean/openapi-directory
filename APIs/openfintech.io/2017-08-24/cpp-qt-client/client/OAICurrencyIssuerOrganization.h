...
/*
 * OAICurrencyIssuerOrganization.h
 *
 * Issuer. 
 */

#ifndef OAICurrencyIssuerOrganization_H
#define OAICurrencyIssuerOrganization_H

#include <QJsonObject>

#include "OAICurrencyIssuerOrganizationData.h"
...
namespace OpenAPI {
class OAICurrencyIssuerOrganizationData;
class OAICurrencyIssuerOrganizationLinks;

class OAICurrencyIssuerOrganization : public OAIObject {
public:
    OAICurrencyIssuerOrganization();
    OAICurrencyIssuerOrganization(QString json);
    ~OAICurrencyIssuerOrganization() override;
    ...
    OAICurrencyIssuerOrganizationData getData() const;
    void setData(const OAICurrencyIssuerOrganizationData &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAICurrencyIssuerOrganizationLinks getLinks() const;
    void setLinks(const OAICurrencyIssuerOrganizationLinks &links);
...
private:
    ...
    OAICurrencyIssuerOrganizationData m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAICurrencyIssuerOrganizationLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyIssuerOrganization)

#endif // OAICurrencyIssuerOrganization_H
