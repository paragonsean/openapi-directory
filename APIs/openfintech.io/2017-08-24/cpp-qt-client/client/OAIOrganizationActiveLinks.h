...
/*
 * OAIOrganizationActiveLinks.h
 *
 * 
 */

#ifndef OAIOrganizationActiveLinks_H
#define OAIOrganizationActiveLinks_H
...
class OAIOrganizationActiveLinks : public OAIObject {
public:
    OAIOrganizationActiveLinks();
    OAIOrganizationActiveLinks(QString json);
    ~OAIOrganizationActiveLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationActiveLinks)

#endif // OAIOrganizationActiveLinks_H
