...
qint32 OAIResponseMeta::getPages() const {
    return m_pages;
}
void OAIResponseMeta::setPages(const qint32 &pages) {
    m_pages = pages;
    m_pages_isSet = true;
}

bool OAIResponseMeta::is_pages_Set() const{
    return m_pages_isSet;
}

bool OAIResponseMeta::is_pages_Valid() const{
    return m_pages_isValid;
}

qint32 OAIResponseMeta::getTotal() const {
    return m_total;
}
void OAIResponseMeta::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIResponseMeta::is_total_Set() const{
    return m_total_isSet;
}

bool OAIResponseMeta::is_total_Valid() const{
