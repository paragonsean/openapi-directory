...
/*
 * OAIOrganizationActive.h
 *
 * 
 */

#ifndef OAIOrganizationActive_H
#define OAIOrganizationActive_H
...
namespace OpenAPI {
class OAIOrganizationActiveLinks;

class OAIOrganizationActive : public OAIObject {
public:
    OAIOrganizationActive();
    OAIOrganizationActive(QString json);
    ~OAIOrganizationActive() override;
    ...
    OAIOrganizationActiveLinks getLinks() const;
    void setLinks(const OAIOrganizationActiveLinks &links);
...
private:
    ...
    OAIOrganizationActiveLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationActive)

#endif // OAIOrganizationActive_H
