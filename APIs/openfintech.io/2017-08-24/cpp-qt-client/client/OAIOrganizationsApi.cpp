...
void OAIOrganizationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("organizationsIdGet", defaultConf);
    _serverIndices.insert("organizationsIdGet", 0);
}
...
void OAIOrganizationsApi::organizationsGet(const ::OpenAPI::OptionalParam<qint32> &page_number, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &filter_search, const ::OpenAPI::OptionalParam<QString> &filter_name, const ::OpenAPI::OptionalParam<QString> &filter_code, const ::OpenAPI::OptionalParam<QSet<QString>> &filter_status, const ::OpenAPI::OptionalParam<QString> &filter_industries, const ::OpenAPI::OptionalParam<QSet<QString>> &sort) {
    ...
    if (filter_industries.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filter[industries]", false);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("filter[industries]")).append(querySuffix).append(QUrl::toPercentEncoding(filter_industries.stringValue()));
    }
    if (sort.hasValue())
    {
        queryStyle = "form";
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::organizationsGetCallback);
...
void OAIOrganizationsApi::organizationsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOrganizationsResponse output(QString(worker->response));
    worker->deleteLater();
...
void OAIOrganizationsApi::organizationsIdGet(const QString &id) {
    QString fullPath = QString(_serverConfigs["organizationsIdGet"][_serverIndices.value("organizationsIdGet")].URL()+"/organizations/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::organizationsIdGetCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOrganizationsApi::organizationsIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIOrganizationResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT organizationsIdGetSignal(output);
        Q_EMIT organizationsIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT organizationsIdGetSignalE(output, error_type, error_str);
        Q_EMIT organizationsIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT organizationsIdGetSignalError(output, error_type, error_str);
        Q_EMIT organizationsIdGetSignalErrorFull(worker, error_type, error_str);
    }
}
