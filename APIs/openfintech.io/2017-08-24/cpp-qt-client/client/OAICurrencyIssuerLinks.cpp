...
OAICurrencyIssuerLinks::OAICurrencyIssuerLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyIssuerLinks::OAICurrencyIssuerLinks() {
    this->initializeModel();
}

OAICurrencyIssuerLinks::~OAICurrencyIssuerLinks() {}

void OAICurrencyIssuerLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAICurrencyIssuerLinks::fromJson(QString jsonString) {
...
void OAICurrencyIssuerLinks::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyIssuerLinks::asJson() const {
...
QJsonObject OAICurrencyIssuerLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAICurrencyIssuerLinks::getRelated() const {
    return m_related;
}
void OAICurrencyIssuerLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAICurrencyIssuerLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAICurrencyIssuerLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAICurrencyIssuerLinks::isSet() const {
...
bool OAICurrencyIssuerLinks::isValid() const {
