...
/*
 * OAIActiveInCountriesRelationship_data_inner.h
 *
 * 
 */

#ifndef OAIActiveInCountriesRelationship_data_inner_H
#define OAIActiveInCountriesRelationship_data_inner_H
...
class OAIActiveInCountriesRelationship_data_inner : public OAIObject {
public:
    OAIActiveInCountriesRelationship_data_inner();
    OAIActiveInCountriesRelationship_data_inner(QString json);
    ~OAIActiveInCountriesRelationship_data_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActiveInCountriesRelationship_data_inner)

#endif // OAIActiveInCountriesRelationship_data_inner_H
