...
/*
 * OAIOrganizationAttributes.h
 *
 * 
 */

#ifndef OAIOrganizationAttributes_H
#define OAIOrganizationAttributes_H
...
class OAIOrganizationContacts;
class OAIOrganizationAttributesIcon;
class OAIOrganizationAttributesLogo;
class OAIOrganizationSocial;

class OAIOrganizationAttributes : public OAIObject {
public:
    OAIOrganizationAttributes();
    OAIOrganizationAttributes(QString json);
    ~OAIOrganizationAttributes() override;
    ...
    OAIOrganizationAddress getAddress() const;
    void setAddress(const OAIOrganizationAddress &address);
    ...
    OAIOrganizationContacts getContacts() const;
    void setContacts(const OAIOrganizationContacts &contacts);
    ...
    OAIOrganizationAttributesIcon getIcon() const;
    void setIcon(const OAIOrganizationAttributesIcon &icon);
    ...
    OAIOrganizationAttributesLogo getLogo() const;
    void setLogo(const OAIOrganizationAttributesLogo &logo);
    ...
    OAIOrganizationSocial getSocialProfiles() const;
    void setSocialProfiles(const OAIOrganizationSocial &social_profiles);
    bool is_social_profiles_Set() const;
    bool is_social_profiles_Valid() const;
...
private:
    ...
    OAIOrganizationAddress m_address;
    ...
    OAIOrganizationContacts m_contacts;
    ...
    OAIOrganizationAttributesIcon m_icon;
    bool m_icon_isSet;
    bool m_icon_isValid;
    ...
    OAIOrganizationAttributesLogo m_logo;
    bool m_logo_isSet;
    bool m_logo_isValid;
    ...
    OAIOrganizationSocial m_social_profiles;
    bool m_social_profiles_isSet;
    bool m_social_profiles_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationAttributes)

#endif // OAIOrganizationAttributes_H
