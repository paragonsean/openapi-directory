...
/*
 * OAIDepositMethodProcessorData_links.h
 *
 * 
 */

#ifndef OAIDepositMethodProcessorData_links_H
#define OAIDepositMethodProcessorData_links_H
...
class OAIDepositMethodProcessorData_links : public OAIObject {
public:
    OAIDepositMethodProcessorData_links();
    OAIDepositMethodProcessorData_links(QString json);
    ~OAIDepositMethodProcessorData_links() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDepositMethodProcessorData_links)

#endif // OAIDepositMethodProcessorData_links_H
