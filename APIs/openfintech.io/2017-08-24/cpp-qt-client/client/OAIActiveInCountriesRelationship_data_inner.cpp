...
#include "OAIActiveInCountriesRelationship_data_inner.h"
...
OAIActiveInCountriesRelationship_data_inner::OAIActiveInCountriesRelationship_data_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActiveInCountriesRelationship_data_inner::OAIActiveInCountriesRelationship_data_inner() {
    this->initializeModel();
}

OAIActiveInCountriesRelationship_data_inner::~OAIActiveInCountriesRelationship_data_inner() {}

void OAIActiveInCountriesRelationship_data_inner::initializeModel() {
...
void OAIActiveInCountriesRelationship_data_inner::fromJson(QString jsonString) {
...
void OAIActiveInCountriesRelationship_data_inner::fromJsonObject(QJsonObject json) {
...
QString OAIActiveInCountriesRelationship_data_inner::asJson() const {
...
QJsonObject OAIActiveInCountriesRelationship_data_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIActiveInCountriesRelationship_data_inner::getId() const {
    return m_id;
}
void OAIActiveInCountriesRelationship_data_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIActiveInCountriesRelationship_data_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIActiveInCountriesRelationship_data_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIActiveInCountriesRelationship_data_inner::getType() const {
    return m_type;
}
void OAIActiveInCountriesRelationship_data_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIActiveInCountriesRelationship_data_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIActiveInCountriesRelationship_data_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIActiveInCountriesRelationship_data_inner::isSet() const {
...
bool OAIActiveInCountriesRelationship_data_inner::isValid() const {
