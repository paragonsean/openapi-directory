...
#include "OAIExchangerOrganizationData.h"
...
OAIExchangerOrganizationData::OAIExchangerOrganizationData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExchangerOrganizationData::OAIExchangerOrganizationData() {
    this->initializeModel();
}

OAIExchangerOrganizationData::~OAIExchangerOrganizationData() {}

void OAIExchangerOrganizationData::initializeModel() {
...
void OAIExchangerOrganizationData::fromJson(QString jsonString) {
...
void OAIExchangerOrganizationData::fromJsonObject(QJsonObject json) {
...
QString OAIExchangerOrganizationData::asJson() const {
...
QJsonObject OAIExchangerOrganizationData::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIExchangerOrganizationData::getId() const {
    return m_id;
}
void OAIExchangerOrganizationData::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIExchangerOrganizationData::is_id_Set() const{
    return m_id_isSet;
}

bool OAIExchangerOrganizationData::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIExchangerOrganizationData::getType() const {
    return m_type;
}
void OAIExchangerOrganizationData::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIExchangerOrganizationData::is_type_Set() const{
    return m_type_isSet;
}

bool OAIExchangerOrganizationData::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIExchangerOrganizationData::isSet() const {
...
bool OAIExchangerOrganizationData::isValid() const {
