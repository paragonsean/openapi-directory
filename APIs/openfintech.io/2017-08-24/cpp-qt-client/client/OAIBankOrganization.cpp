...
OAIBankOrganization::OAIBankOrganization(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBankOrganization::OAIBankOrganization() {
    this->initializeModel();
}

OAIBankOrganization::~OAIBankOrganization() {}

void OAIBankOrganization::initializeModel() {
...
void OAIBankOrganization::fromJson(QString jsonString) {
...
void OAIBankOrganization::fromJsonObject(QJsonObject json) {
...
QString OAIBankOrganization::asJson() const {
...
QJsonObject OAIBankOrganization::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIBankOrganizationData OAIBankOrganization::getData() const {
    return m_data;
}
void OAIBankOrganization::setData(const OAIBankOrganizationData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIBankOrganization::is_data_Set() const{
    return m_data_isSet;
}

bool OAIBankOrganization::is_data_Valid() const{
    return m_data_isValid;
}

OAIBankOrganizationLinks OAIBankOrganization::getLinks() const {
    return m_links;
}
void OAIBankOrganization::setLinks(const OAIBankOrganizationLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIBankOrganization::is_links_Set() const{
    return m_links_isSet;
}

bool OAIBankOrganization::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIBankOrganization::isSet() const {
...
bool OAIBankOrganization::isValid() const {
