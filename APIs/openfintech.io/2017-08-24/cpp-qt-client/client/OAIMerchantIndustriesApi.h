...
#ifndef OAI_OAIMerchantIndustriesApi_H
#define OAI_OAIMerchantIndustriesApi_H
...
#include "OAIMerchantIndustryResponse.h"
#include <QString>
...
class OAIMerchantIndustriesApi : public QObject {
    Q_OBJECT

public:
    OAIMerchantIndustriesApi(const int timeOut = 0);
    ~OAIMerchantIndustriesApi();
    ...
    */
    virtual void merchantIndustriesGet(const ::OpenAPI::OptionalParam<qint32> &page_number = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &filter_name = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  id QString [required]
    */
    virtual void merchantIndustriesIdGet(const QString &id);
...
private:
    ...
    void merchantIndustriesGetCallback(OAIHttpRequestWorker *worker);
    void merchantIndustriesIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void merchantIndustriesGetSignal(OAIMerchantIndustriesResponse summary);
    void merchantIndustriesIdGetSignal(OAIMerchantIndustryResponse summary);


    void merchantIndustriesGetSignalFull(OAIHttpRequestWorker *worker, OAIMerchantIndustriesResponse summary);
    void merchantIndustriesIdGetSignalFull(OAIHttpRequestWorker *worker, OAIMerchantIndustryResponse summary);

    Q_DECL_DEPRECATED_X("Use merchantIndustriesGetSignalError() instead")
    void merchantIndustriesGetSignalE(OAIMerchantIndustriesResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void merchantIndustriesGetSignalError(OAIMerchantIndustriesResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use merchantIndustriesIdGetSignalError() instead")
    void merchantIndustriesIdGetSignalE(OAIMerchantIndustryResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void merchantIndustriesIdGetSignalError(OAIMerchantIndustryResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use merchantIndustriesGetSignalErrorFull() instead")
    void merchantIndustriesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void merchantIndustriesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use merchantIndustriesIdGetSignalErrorFull() instead")
    void merchantIndustriesIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void merchantIndustriesIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
