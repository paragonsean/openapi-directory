...
OAIMerchantIndustryAttributes::OAIMerchantIndustryAttributes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMerchantIndustryAttributes::OAIMerchantIndustryAttributes() {
    this->initializeModel();
}

OAIMerchantIndustryAttributes::~OAIMerchantIndustryAttributes() {}

void OAIMerchantIndustryAttributes::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIMerchantIndustryAttributes::fromJson(QString jsonString) {
...
void OAIMerchantIndustryAttributes::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIMerchantIndustryAttributes::asJson() const {
...
QJsonObject OAIMerchantIndustryAttributes::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIMerchantIndustryAttributes::getName() const {
    return m_name;
}
void OAIMerchantIndustryAttributes::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMerchantIndustryAttributes::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMerchantIndustryAttributes::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIMerchantIndustryAttributes::isSet() const {
...
bool OAIMerchantIndustryAttributes::isValid() const {
