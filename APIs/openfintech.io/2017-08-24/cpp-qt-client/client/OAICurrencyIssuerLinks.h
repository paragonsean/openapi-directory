...
/*
 * OAICurrencyIssuerLinks.h
 *
 * 
 */

#ifndef OAICurrencyIssuerLinks_H
#define OAICurrencyIssuerLinks_H
...
class OAICurrencyIssuerLinks : public OAIObject {
public:
    OAICurrencyIssuerLinks();
    OAICurrencyIssuerLinks(QString json);
    ~OAICurrencyIssuerLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyIssuerLinks)

#endif // OAICurrencyIssuerLinks_H
