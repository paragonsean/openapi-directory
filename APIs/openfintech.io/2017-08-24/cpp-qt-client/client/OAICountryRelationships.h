...
/*
 * OAICountryRelationships.h
 *
 * 
 */

#ifndef OAICountryRelationships_H
#define OAICountryRelationships_H

#include <QJsonObject>

#include "OAICountryTranslations.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICountryTranslations;

class OAICountryRelationships : public OAIObject {
public:
    OAICountryRelationships();
    OAICountryRelationships(QString json);
    ~OAICountryRelationships() override;
    ...
    OAICountryTranslations getTranslations() const;
    void setTranslations(const OAICountryTranslations &translations);
...
private:
    ...
    OAICountryTranslations m_translations;
...
Q_DECLARE_METATYPE(OpenAPI::OAICountryRelationships)

#endif // OAICountryRelationships_H
