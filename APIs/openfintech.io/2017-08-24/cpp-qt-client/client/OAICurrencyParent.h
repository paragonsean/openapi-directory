...
#ifndef OAICurrencyParent_H
#define OAICurrencyParent_H

#include <QJsonObject>

#include "OAICurrencyParentData.h"
#include "OAICurrencyParentLinks.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICurrencyParentData;
class OAICurrencyParentLinks;

class OAICurrencyParent : public OAIObject {
public:
    OAICurrencyParent();
    OAICurrencyParent(QString json);
    ~OAICurrencyParent() override;
    ...
    OAICurrencyParentData getData() const;
    void setData(const OAICurrencyParentData &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAICurrencyParentLinks getLinks() const;
    void setLinks(const OAICurrencyParentLinks &links);
...
private:
    ...
    OAICurrencyParentData m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAICurrencyParentLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyParent)

#endif // OAICurrencyParent_H
