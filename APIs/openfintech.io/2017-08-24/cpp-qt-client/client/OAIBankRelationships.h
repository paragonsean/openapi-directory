...
/*
 * OAIBankRelationships.h
 *
 * 
 */

#ifndef OAIBankRelationships_H
#define OAIBankRelationships_H

#include <QJsonObject>

#include "OAIBankOrganization.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIBankOrganization;

class OAIBankRelationships : public OAIObject {
public:
    OAIBankRelationships();
    OAIBankRelationships(QString json);
    ~OAIBankRelationships() override;
    ...
    OAIBankOrganization getOrganization() const;
    void setOrganization(const OAIBankOrganization &organization);
...
private:
    ...
    OAIBankOrganization m_organization;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankRelationships)

#endif // OAIBankRelationships_H
