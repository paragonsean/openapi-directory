...
/*
 * OAIPaymentMethodProcessor.h
 *
 * Payment-method issuer.
 */

#ifndef OAIPaymentMethodProcessor_H
#define OAIPaymentMethodProcessor_H
...
namespace OpenAPI {
class OAIPaymentMethodProcessorData;
class OAIPaymentMethodProcessorLinks;

class OAIPaymentMethodProcessor : public OAIObject {
public:
    OAIPaymentMethodProcessor();
    OAIPaymentMethodProcessor(QString json);
    ~OAIPaymentMethodProcessor() override;
    ...
    OAIPaymentMethodProcessorData getData() const;
    void setData(const OAIPaymentMethodProcessorData &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIPaymentMethodProcessorLinks getLinks() const;
    void setLinks(const OAIPaymentMethodProcessorLinks &links);
...
private:
    ...
    OAIPaymentMethodProcessorData m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIPaymentMethodProcessorLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodProcessor)

#endif // OAIPaymentMethodProcessor_H
