...
/*
 * OAIPaymentProvider.h
 *
 * 
 */

#ifndef OAIPaymentProvider_H
#define OAIPaymentProvider_H
...
namespace OpenAPI {
class OAIPaymentProviderAttributes;
class OAISelfLinks;
class OAIPaymentProviderRelationships;

class OAIPaymentProvider : public OAIObject {
public:
    OAIPaymentProvider();
    OAIPaymentProvider(QString json);
    ~OAIPaymentProvider() override;
    ...
    OAIPaymentProviderAttributes getAttributes() const;
    void setAttributes(const OAIPaymentProviderAttributes &attributes);
    ...
    OAIPaymentProviderRelationships getRelationships() const;
    void setRelationships(const OAIPaymentProviderRelationships &relationships);
...
private:
    ...
    OAIPaymentProviderAttributes m_attributes;
    ...
    OAIPaymentProviderRelationships m_relationships;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentProvider)

#endif // OAIPaymentProvider_H
