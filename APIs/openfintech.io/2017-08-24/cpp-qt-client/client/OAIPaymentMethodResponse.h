...
/*
 * OAIPaymentMethodResponse.h
 *
 * 
 */

#ifndef OAIPaymentMethodResponse_H
#define OAIPaymentMethodResponse_H
...
class OAIPaymentMethodResponse : public OAIObject {
public:
    OAIPaymentMethodResponse();
    OAIPaymentMethodResponse(QString json);
    ~OAIPaymentMethodResponse() override;
    ...
    OAIPaymentMethod getData() const;
    void setData(const OAIPaymentMethod &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodResponse)

#endif // OAIPaymentMethodResponse_H
