...
/*
 * OAIMerchantIndustryResponse.h
 *
 * 
 */

#ifndef OAIMerchantIndustryResponse_H
#define OAIMerchantIndustryResponse_H

#include <QJsonObject>

#include "OAIMerchantIndustry.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIMerchantIndustry;

class OAIMerchantIndustryResponse : public OAIObject {
public:
    OAIMerchantIndustryResponse();
    OAIMerchantIndustryResponse(QString json);
    ~OAIMerchantIndustryResponse() override;
    ...
    OAIMerchantIndustry getData() const;
    void setData(const OAIMerchantIndustry &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMerchantIndustryResponse)

#endif // OAIMerchantIndustryResponse_H
