...
/*
 * OAIPaymentProviderOrganizationData.h
 *
 * 
 */

#ifndef OAIPaymentProviderOrganizationData_H
#define OAIPaymentProviderOrganizationData_H
...
class OAIPaymentProviderOrganizationData : public OAIObject {
public:
    OAIPaymentProviderOrganizationData();
    OAIPaymentProviderOrganizationData(QString json);
    ~OAIPaymentProviderOrganizationData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentProviderOrganizationData)

#endif // OAIPaymentProviderOrganizationData_H
