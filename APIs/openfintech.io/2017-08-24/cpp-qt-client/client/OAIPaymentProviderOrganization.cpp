...
#include "OAIPaymentProviderOrganization.h"
...
OAIPaymentProviderOrganization::OAIPaymentProviderOrganization(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentProviderOrganization::OAIPaymentProviderOrganization() {
    this->initializeModel();
}

OAIPaymentProviderOrganization::~OAIPaymentProviderOrganization() {}

void OAIPaymentProviderOrganization::initializeModel() {
...
void OAIPaymentProviderOrganization::fromJson(QString jsonString) {
...
void OAIPaymentProviderOrganization::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentProviderOrganization::asJson() const {
...
QJsonObject OAIPaymentProviderOrganization::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIPaymentProviderOrganizationData OAIPaymentProviderOrganization::getData() const {
    return m_data;
}
void OAIPaymentProviderOrganization::setData(const OAIPaymentProviderOrganizationData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPaymentProviderOrganization::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPaymentProviderOrganization::is_data_Valid() const{
    return m_data_isValid;
}

OAIPaymentProviderOrganizationLinks OAIPaymentProviderOrganization::getLinks() const {
    return m_links;
}
void OAIPaymentProviderOrganization::setLinks(const OAIPaymentProviderOrganizationLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIPaymentProviderOrganization::is_links_Set() const{
    return m_links_isSet;
}

bool OAIPaymentProviderOrganization::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIPaymentProviderOrganization::isSet() const {
...
bool OAIPaymentProviderOrganization::isValid() const {
