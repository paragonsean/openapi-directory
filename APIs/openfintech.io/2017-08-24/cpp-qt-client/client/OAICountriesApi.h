...
public:
    ...
    * @param[in]  filter_region QSet<QString> [optional]
    * @param[in]  filter_sub_region QSet<QString> [optional]
    * @param[in]  sort QSet<QString> [optional]
    */
    virtual void countriesGet(const ::OpenAPI::OptionalParam<qint32> &page_number = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_region = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_sub_region = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QSet<QString>> &sort = ::OpenAPI::OptionalParam<QSet<QString>>());

    /**
    * @param[in]  id QString [required]
    */
    virtual void countriesIdGet(const QString &id);
...
private:
    ...
    void countriesGetCallback(OAIHttpRequestWorker *worker);
    void countriesIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void countriesGetSignal(OAICountriesResponse summary);
    void countriesIdGetSignal(OAICountryResponse summary);


    void countriesGetSignalFull(OAIHttpRequestWorker *worker, OAICountriesResponse summary);
    void countriesIdGetSignalFull(OAIHttpRequestWorker *worker, OAICountryResponse summary);

    Q_DECL_DEPRECATED_X("Use countriesGetSignalError() instead")
    void countriesGetSignalE(OAICountriesResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void countriesGetSignalError(OAICountriesResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use countriesIdGetSignalError() instead")
    void countriesIdGetSignalE(OAICountryResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void countriesIdGetSignalError(OAICountryResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use countriesGetSignalErrorFull() instead")
    void countriesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void countriesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use countriesIdGetSignalErrorFull() instead")
    void countriesIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void countriesIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
