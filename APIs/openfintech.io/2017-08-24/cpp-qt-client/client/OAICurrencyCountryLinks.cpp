...
#include "OAICurrencyCountryLinks.h"
...
OAICurrencyCountryLinks::OAICurrencyCountryLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyCountryLinks::OAICurrencyCountryLinks() {
    this->initializeModel();
}

OAICurrencyCountryLinks::~OAICurrencyCountryLinks() {}

void OAICurrencyCountryLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAICurrencyCountryLinks::fromJson(QString jsonString) {
...
void OAICurrencyCountryLinks::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyCountryLinks::asJson() const {
...
QJsonObject OAICurrencyCountryLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAICurrencyCountryLinks::getRelated() const {
    return m_related;
}
void OAICurrencyCountryLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAICurrencyCountryLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAICurrencyCountryLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAICurrencyCountryLinks::isSet() const {
...
bool OAICurrencyCountryLinks::isValid() const {
