...
OAIMerchantIndustryResponse::OAIMerchantIndustryResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMerchantIndustryResponse::OAIMerchantIndustryResponse() {
    this->initializeModel();
}

OAIMerchantIndustryResponse::~OAIMerchantIndustryResponse() {}

void OAIMerchantIndustryResponse::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIMerchantIndustryResponse::fromJson(QString jsonString) {
...
void OAIMerchantIndustryResponse::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIMerchantIndustryResponse::asJson() const {
...
QJsonObject OAIMerchantIndustryResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIMerchantIndustry OAIMerchantIndustryResponse::getData() const {
    return m_data;
}
void OAIMerchantIndustryResponse::setData(const OAIMerchantIndustry &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMerchantIndustryResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMerchantIndustryResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIMerchantIndustryResponse::isSet() const {
...
bool OAIMerchantIndustryResponse::isValid() const {
