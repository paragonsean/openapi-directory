...
/*
 * OAIPaymentProviderResponse.h
 *
 * 
 */

#ifndef OAIPaymentProviderResponse_H
#define OAIPaymentProviderResponse_H

#include <QJsonObject>

#include "OAIPaymentProvider.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPaymentProvider;

class OAIPaymentProviderResponse : public OAIObject {
public:
    OAIPaymentProviderResponse();
    OAIPaymentProviderResponse(QString json);
    ~OAIPaymentProviderResponse() override;
    ...
    OAIPaymentProvider getData() const;
    void setData(const OAIPaymentProvider &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentProviderResponse)

#endif // OAIPaymentProviderResponse_H
