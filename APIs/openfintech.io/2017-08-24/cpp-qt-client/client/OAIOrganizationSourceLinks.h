...
/*
 * OAIOrganizationSourceLinks.h
 *
 * 
 */

#ifndef OAIOrganizationSourceLinks_H
#define OAIOrganizationSourceLinks_H
...
class OAIOrganizationSourceLinks : public OAIObject {
public:
    OAIOrganizationSourceLinks();
    OAIOrganizationSourceLinks(QString json);
    ~OAIOrganizationSourceLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationSourceLinks)

#endif // OAIOrganizationSourceLinks_H
