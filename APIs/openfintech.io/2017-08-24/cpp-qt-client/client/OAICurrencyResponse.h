...
/*
 * OAICurrencyResponse.h
 *
 * 
 */

#ifndef OAICurrencyResponse_H
#define OAICurrencyResponse_H
...
class OAICurrencyResponse : public OAIObject {
public:
    OAICurrencyResponse();
    OAICurrencyResponse(QString json);
    ~OAICurrencyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyResponse)

#endif // OAICurrencyResponse_H
