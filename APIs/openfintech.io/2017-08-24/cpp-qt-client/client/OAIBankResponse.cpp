...
OAIBankResponse::OAIBankResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBankResponse::OAIBankResponse() {
    this->initializeModel();
}

OAIBankResponse::~OAIBankResponse() {}

void OAIBankResponse::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIBankResponse::fromJson(QString jsonString) {
...
void OAIBankResponse::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIBankResponse::asJson() const {
...
QJsonObject OAIBankResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIBank OAIBankResponse::getData() const {
    return m_data;
}
void OAIBankResponse::setData(const OAIBank &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIBankResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIBankResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIBankResponse::isSet() const {
...
bool OAIBankResponse::isValid() const {
