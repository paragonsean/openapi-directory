...
/*
 * OAIBankOrganization.h
 *
 * 
 */

#ifndef OAIBankOrganization_H
#define OAIBankOrganization_H

#include <QJsonObject>

#include "OAIBankOrganizationData.h"
...
namespace OpenAPI {
class OAIBankOrganizationData;
class OAIBankOrganizationLinks;

class OAIBankOrganization : public OAIObject {
public:
    OAIBankOrganization();
    OAIBankOrganization(QString json);
    ~OAIBankOrganization() override;
    ...
    OAIBankOrganizationData getData() const;
    void setData(const OAIBankOrganizationData &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIBankOrganizationLinks getLinks() const;
    void setLinks(const OAIBankOrganizationLinks &links);
...
private:
    ...
    OAIBankOrganizationData m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIBankOrganizationLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankOrganization)

#endif // OAIBankOrganization_H
