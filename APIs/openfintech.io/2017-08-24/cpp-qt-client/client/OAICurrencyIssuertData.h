...
/*
 * OAICurrencyIssuertData.h
 *
 * 
 */

#ifndef OAICurrencyIssuertData_H
#define OAICurrencyIssuertData_H
...
class OAICurrencyIssuertData : public OAIObject {
public:
    OAICurrencyIssuertData();
    OAICurrencyIssuertData(QString json);
    ~OAICurrencyIssuertData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyIssuertData)

#endif // OAICurrencyIssuertData_H
