...
OAICurrencyParentLinks::OAICurrencyParentLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyParentLinks::OAICurrencyParentLinks() {
    this->initializeModel();
}

OAICurrencyParentLinks::~OAICurrencyParentLinks() {}

void OAICurrencyParentLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAICurrencyParentLinks::fromJson(QString jsonString) {
...
void OAICurrencyParentLinks::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyParentLinks::asJson() const {
...
QJsonObject OAICurrencyParentLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAICurrencyParentLinks::getRelated() const {
    return m_related;
}
void OAICurrencyParentLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAICurrencyParentLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAICurrencyParentLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAICurrencyParentLinks::isSet() const {
...
bool OAICurrencyParentLinks::isValid() const {
