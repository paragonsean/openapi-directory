...
OAICurrencyIssuer::OAICurrencyIssuer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyIssuer::OAICurrencyIssuer() {
    this->initializeModel();
}

OAICurrencyIssuer::~OAICurrencyIssuer() {}

void OAICurrencyIssuer::initializeModel() {
...
void OAICurrencyIssuer::fromJson(QString jsonString) {
...
void OAICurrencyIssuer::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyIssuer::asJson() const {
...
QJsonObject OAICurrencyIssuer::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAICurrencyIssuertData OAICurrencyIssuer::getData() const {
    return m_data;
}
void OAICurrencyIssuer::setData(const OAICurrencyIssuertData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICurrencyIssuer::is_data_Set() const{
    return m_data_isSet;
}

bool OAICurrencyIssuer::is_data_Valid() const{
    return m_data_isValid;
}

OAICurrencyIssuerLinks OAICurrencyIssuer::getLinks() const {
    return m_links;
}
void OAICurrencyIssuer::setLinks(const OAICurrencyIssuerLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAICurrencyIssuer::is_links_Set() const{
    return m_links_isSet;
}

bool OAICurrencyIssuer::is_links_Valid() const{
    return m_links_isValid;
}

bool OAICurrencyIssuer::isSet() const {
...
bool OAICurrencyIssuer::isValid() const {
