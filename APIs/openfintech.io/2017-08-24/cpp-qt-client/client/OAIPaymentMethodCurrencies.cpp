...
#include "OAIPaymentMethodCurrencies.h"
...
OAIPaymentMethodCurrencies::OAIPaymentMethodCurrencies(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentMethodCurrencies::OAIPaymentMethodCurrencies() {
    this->initializeModel();
}

OAIPaymentMethodCurrencies::~OAIPaymentMethodCurrencies() {}

void OAIPaymentMethodCurrencies::initializeModel() {
...
void OAIPaymentMethodCurrencies::fromJson(QString jsonString) {
...
void OAIPaymentMethodCurrencies::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentMethodCurrencies::asJson() const {
...
QJsonObject OAIPaymentMethodCurrencies::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<QString> OAIPaymentMethodCurrencies::getData() const {
    return m_data;
}
void OAIPaymentMethodCurrencies::setData(const QList<QString> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPaymentMethodCurrencies::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPaymentMethodCurrencies::is_data_Valid() const{
    return m_data_isValid;
}

OAIPaymentMethodCurrenciesLinks OAIPaymentMethodCurrencies::getLinks() const {
    return m_links;
}
void OAIPaymentMethodCurrencies::setLinks(const OAIPaymentMethodCurrenciesLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIPaymentMethodCurrencies::is_links_Set() const{
    return m_links_isSet;
}

bool OAIPaymentMethodCurrencies::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIPaymentMethodCurrencies::isSet() const {
...
bool OAIPaymentMethodCurrencies::isValid() const {
