...
OAIOrganizationHq::OAIOrganizationHq(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationHq::OAIOrganizationHq() {
    this->initializeModel();
}

OAIOrganizationHq::~OAIOrganizationHq() {}

void OAIOrganizationHq::initializeModel() {
...
void OAIOrganizationHq::fromJson(QString jsonString) {
...
void OAIOrganizationHq::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationHq::asJson() const {
...
QJsonObject OAIOrganizationHq::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIOrganizationHqData OAIOrganizationHq::getData() const {
    return m_data;
}
void OAIOrganizationHq::setData(const OAIOrganizationHqData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIOrganizationHq::is_data_Set() const{
    return m_data_isSet;
}

bool OAIOrganizationHq::is_data_Valid() const{
    return m_data_isValid;
}

OAIOrganizationHqLinks OAIOrganizationHq::getLinks() const {
    return m_links;
}
void OAIOrganizationHq::setLinks(const OAIOrganizationHqLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIOrganizationHq::is_links_Set() const{
    return m_links_isSet;
}

bool OAIOrganizationHq::is_links_Valid() const{
    return m_links_isValid;
}

bool OAIOrganizationHq::isSet() const {
...
bool OAIOrganizationHq::isValid() const {
