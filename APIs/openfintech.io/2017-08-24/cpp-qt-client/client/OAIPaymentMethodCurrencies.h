...
/*
 * OAIPaymentMethodCurrencies.h
 *
 * 
 */

#ifndef OAIPaymentMethodCurrencies_H
#define OAIPaymentMethodCurrencies_H
...
namespace OpenAPI {
class OAIPaymentMethodCurrenciesLinks;

class OAIPaymentMethodCurrencies : public OAIObject {
public:
    OAIPaymentMethodCurrencies();
    OAIPaymentMethodCurrencies(QString json);
    ~OAIPaymentMethodCurrencies() override;
    ...
    OAIPaymentMethodCurrenciesLinks getLinks() const;
    void setLinks(const OAIPaymentMethodCurrenciesLinks &links);
...
private:
    ...
    OAIPaymentMethodCurrenciesLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodCurrencies)

#endif // OAIPaymentMethodCurrencies_H
