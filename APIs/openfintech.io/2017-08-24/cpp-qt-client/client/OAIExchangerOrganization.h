...
/*
 * OAIExchangerOrganization.h
 *
 * 
 */

#ifndef OAIExchangerOrganization_H
#define OAIExchangerOrganization_H
...
namespace OpenAPI {
class OAIExchangerOrganizationData;
class OAIExchangerOrganizationLinks;

class OAIExchangerOrganization : public OAIObject {
public:
    OAIExchangerOrganization();
    OAIExchangerOrganization(QString json);
    ~OAIExchangerOrganization() override;
    ...
    OAIExchangerOrganizationData getData() const;
    void setData(const OAIExchangerOrganizationData &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIExchangerOrganizationLinks getLinks() const;
    void setLinks(const OAIExchangerOrganizationLinks &links);
...
private:
    ...
    OAIExchangerOrganizationData m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIExchangerOrganizationLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangerOrganization)

#endif // OAIExchangerOrganization_H
