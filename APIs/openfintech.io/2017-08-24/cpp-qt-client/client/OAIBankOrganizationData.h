...
/*
 * OAIBankOrganizationData.h
 *
 * 
 */

#ifndef OAIBankOrganizationData_H
#define OAIBankOrganizationData_H
...
class OAIBankOrganizationData : public OAIObject {
public:
    OAIBankOrganizationData();
    OAIBankOrganizationData(QString json);
    ~OAIBankOrganizationData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankOrganizationData)

#endif // OAIBankOrganizationData_H
