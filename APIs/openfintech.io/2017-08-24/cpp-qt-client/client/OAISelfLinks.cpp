...
OAISelfLinks::OAISelfLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISelfLinks::OAISelfLinks() {
    this->initializeModel();
}

OAISelfLinks::~OAISelfLinks() {}

void OAISelfLinks::initializeModel() {

    m_self_isSet = false;
    m_self_isValid = false;
}

void OAISelfLinks::fromJson(QString jsonString) {
...
void OAISelfLinks::fromJsonObject(QJsonObject json) {

    m_self_isValid = ::OpenAPI::fromJsonValue(m_self, json[QString("self")]);
    m_self_isSet = !json[QString("self")].isNull() && m_self_isValid;
}

QString OAISelfLinks::asJson() const {
...
QJsonObject OAISelfLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_self_isSet) {
...
QString OAISelfLinks::getSelf() const {
    return m_self;
}
void OAISelfLinks::setSelf(const QString &self) {
    m_self = self;
    m_self_isSet = true;
}

bool OAISelfLinks::is_self_Set() const{
    return m_self_isSet;
}

bool OAISelfLinks::is_self_Valid() const{
    return m_self_isValid;
}

bool OAISelfLinks::isSet() const {
...
bool OAISelfLinks::isValid() const {
