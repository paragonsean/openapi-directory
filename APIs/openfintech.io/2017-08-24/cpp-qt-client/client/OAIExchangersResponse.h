...
/*
 * OAIExchangersResponse.h
 *
 * 
 */

#ifndef OAIExchangersResponse_H
#define OAIExchangersResponse_H

#include <QJsonObject>

#include "OAIExchanger.h"
#include "OAIResponseLinks.h"
...
namespace OpenAPI {
class OAIExchanger;
class OAIResponseLinks;
class OAIResponseMeta;

class OAIExchangersResponse : public OAIObject {
public:
    OAIExchangersResponse();
    OAIExchangersResponse(QString json);
    ~OAIExchangersResponse() override;
    ...
    QList<OAIExchanger> getData() const;
    void setData(const QList<OAIExchanger> &data);
    bool is_data_Set() const;
    bool is_data_Valid() const;

    OAIResponseLinks getLinks() const;
    void setLinks(const OAIResponseLinks &links);
...
private:
    ...
    QList<OAIExchanger> m_data;
    bool m_data_isSet;
    bool m_data_isValid;

    OAIResponseLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExchangersResponse)

#endif // OAIExchangersResponse_H
