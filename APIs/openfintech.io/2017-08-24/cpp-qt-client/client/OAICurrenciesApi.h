...
public:
    ...
    * @param[in]  filter_code_iso_alpha3 QString [optional]
    * @param[in]  filter_code_iso_numeric3 qint32 [optional]
    * @param[in]  filter_code_estandards_alpha QString [optional]
    * @param[in]  filter_currency_type QSet<QString> [optional]
    * @param[in]  filter_category QSet<QString> [optional]
    * @param[in]  sort QSet<QString> [optional]
    */
    virtual void currenciesGet(const ::OpenAPI::OptionalParam<qint32> &page_number = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &filter_search = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &filter_code_iso_alpha3 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &filter_code_iso_numeric3 = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &filter_code_estandards_alpha = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_currency_type = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QSet<QString>> &filter_category = ::OpenAPI::OptionalParam<QSet<QString>>(), const ::OpenAPI::OptionalParam<QSet<QString>> &sort = ::OpenAPI::OptionalParam<QSet<QString>>());

    /**
    * @param[in]  id QString [required]
    */
    virtual void currenciesIdGet(const QString &id);
...
private:
    ...
    void currenciesIdGetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void currenciesGetSignal(OAICurrenciesResponse summary);
    void currenciesIdGetSignal(OAICurrencyResponse summary);


    void currenciesGetSignalFull(OAIHttpRequestWorker *worker, OAICurrenciesResponse summary);
    void currenciesIdGetSignalFull(OAIHttpRequestWorker *worker, OAICurrencyResponse summary);

    Q_DECL_DEPRECATED_X("Use currenciesGetSignalError() instead")
    void currenciesGetSignalE(OAICurrenciesResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void currenciesGetSignalError(OAICurrenciesResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use currenciesIdGetSignalError() instead")
    void currenciesIdGetSignalE(OAICurrencyResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void currenciesIdGetSignalError(OAICurrencyResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use currenciesIdGetSignalErrorFull() instead")
    void currenciesIdGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void currenciesIdGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
