...
/*
 * OAIPaymentMethodProcessorData.h
 *
 * Processor&#x60;s Data.
 */

#ifndef OAIPaymentMethodProcessorData_H
#define OAIPaymentMethodProcessorData_H
...
class OAIPaymentMethodProcessorData : public OAIObject {
public:
    OAIPaymentMethodProcessorData();
    OAIPaymentMethodProcessorData(QString json);
    ~OAIPaymentMethodProcessorData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodProcessorData)

#endif // OAIPaymentMethodProcessorData_H
