...
#include "OAICurrencyCountries.h"
...
OAICurrencyCountries::OAICurrencyCountries(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyCountries::OAICurrencyCountries() {
    this->initializeModel();
}

OAICurrencyCountries::~OAICurrencyCountries() {}

void OAICurrencyCountries::initializeModel() {

    m_links_isSet = false;
    m_links_isValid = false;
}

void OAICurrencyCountries::fromJson(QString jsonString) {
...
void OAICurrencyCountries::fromJsonObject(QJsonObject json) {

    m_links_isValid = ::OpenAPI::fromJsonValue(m_links, json[QString("links")]);
    m_links_isSet = !json[QString("links")].isNull() && m_links_isValid;
}

QString OAICurrencyCountries::asJson() const {
...
QJsonObject OAICurrencyCountries::asJsonObject() const {
    QJsonObject obj;
    if (m_links.isSet()) {
...
OAICurrencyCountryLinks OAICurrencyCountries::getLinks() const {
    return m_links;
}
void OAICurrencyCountries::setLinks(const OAICurrencyCountryLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAICurrencyCountries::is_links_Set() const{
    return m_links_isSet;
}

bool OAICurrencyCountries::is_links_Valid() const{
    return m_links_isValid;
}

bool OAICurrencyCountries::isSet() const {
...
bool OAICurrencyCountries::isValid() const {
