...
#include "OAICurrencyIssuerOrganizationLinks.h"
...
OAICurrencyIssuerOrganizationLinks::OAICurrencyIssuerOrganizationLinks(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyIssuerOrganizationLinks::OAICurrencyIssuerOrganizationLinks() {
    this->initializeModel();
}

OAICurrencyIssuerOrganizationLinks::~OAICurrencyIssuerOrganizationLinks() {}

void OAICurrencyIssuerOrganizationLinks::initializeModel() {

    m_related_isSet = false;
    m_related_isValid = false;
}

void OAICurrencyIssuerOrganizationLinks::fromJson(QString jsonString) {
...
void OAICurrencyIssuerOrganizationLinks::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyIssuerOrganizationLinks::asJson() const {
...
QJsonObject OAICurrencyIssuerOrganizationLinks::asJsonObject() const {
    QJsonObject obj;
    if (m_related_isSet) {
...
QString OAICurrencyIssuerOrganizationLinks::getRelated() const {
    return m_related;
}
void OAICurrencyIssuerOrganizationLinks::setRelated(const QString &related) {
    m_related = related;
    m_related_isSet = true;
}

bool OAICurrencyIssuerOrganizationLinks::is_related_Set() const{
    return m_related_isSet;
}

bool OAICurrencyIssuerOrganizationLinks::is_related_Valid() const{
    return m_related_isValid;
}

bool OAICurrencyIssuerOrganizationLinks::isSet() const {
...
bool OAICurrencyIssuerOrganizationLinks::isValid() const {
