...
/*
 * OAIDepositMethodRelationships.h
 *
 * 
 */

#ifndef OAIDepositMethodRelationships_H
#define OAIDepositMethodRelationships_H

#include <QJsonObject>

#include "OAIActiveInCountriesRelationship.h"
#include "OAICurrencyParent.h"
#include "OAIDepositMethodProcessorData.h"
#include "OAISupportedPspsRelationship.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIActiveInCountriesRelationship;
class OAICurrencyParent;
class OAIDepositMethodProcessorData;
class OAISupportedPspsRelationship;

class OAIDepositMethodRelationships : public OAIObject {
public:
    OAIDepositMethodRelationships();
    OAIDepositMethodRelationships(QString json);
    ~OAIDepositMethodRelationships() override;
    ...
    OAIActiveInCountriesRelationship getActioveInCountries() const;
    void setActioveInCountries(const OAIActiveInCountriesRelationship &actiove_in_countries);
    bool is_actiove_in_countries_Set() const;
    bool is_actiove_in_countries_Valid() const;

    OAICurrencyParent getCurrencies() const;
    void setCurrencies(const OAICurrencyParent &currencies);
    bool is_currencies_Set() const;
    bool is_currencies_Valid() const;

    OAIDepositMethodProcessorData getPaymentProcessor() const;
    void setPaymentProcessor(const OAIDepositMethodProcessorData &payment_processor);
    bool is_payment_processor_Set() const;
    bool is_payment_processor_Valid() const;

    OAISupportedPspsRelationship getSupportedPsps() const;
    void setSupportedPsps(const OAISupportedPspsRelationship &supported_psps);
    bool is_supported_psps_Set() const;
    bool is_supported_psps_Valid() const;
...
private:
    ...
    OAIActiveInCountriesRelationship m_actiove_in_countries;
    bool m_actiove_in_countries_isSet;
    bool m_actiove_in_countries_isValid;

    OAICurrencyParent m_currencies;
    bool m_currencies_isSet;
    bool m_currencies_isValid;

    OAIDepositMethodProcessorData m_payment_processor;
    bool m_payment_processor_isSet;
    bool m_payment_processor_isValid;

    OAISupportedPspsRelationship m_supported_psps;
    bool m_supported_psps_isSet;
    bool m_supported_psps_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDepositMethodRelationships)

#endif // OAIDepositMethodRelationships_H
