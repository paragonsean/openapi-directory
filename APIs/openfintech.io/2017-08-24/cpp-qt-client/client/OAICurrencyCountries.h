...
/*
 * OAICurrencyCountries.h
 *
 * 
 */

#ifndef OAICurrencyCountries_H
#define OAICurrencyCountries_H
...
namespace OpenAPI {
class OAICurrencyCountryLinks;

class OAICurrencyCountries : public OAIObject {
public:
    OAICurrencyCountries();
    OAICurrencyCountries(QString json);
    ~OAICurrencyCountries() override;
    ...
    OAICurrencyCountryLinks getLinks() const;
    void setLinks(const OAICurrencyCountryLinks &links);
...
private:
    ...
    OAICurrencyCountryLinks m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICurrencyCountries)

#endif // OAICurrencyCountries_H
