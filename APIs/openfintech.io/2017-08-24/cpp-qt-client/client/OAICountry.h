...
namespace OpenAPI {
class OAICountryAttributes;
class OAISelfLinks;
class OAICountryRelationships;
...
public:
    ...
    OAICountryAttributes getAttributes() const;
    void setAttributes(const OAICountryAttributes &attributes);
    ...
    OAICountryRelationships getRelationships() const;
    void setRelationships(const OAICountryRelationships &relationships);
...
private:
    ...
    OAICountryAttributes m_attributes;
    ...
    OAICountryRelationships m_relationships;
