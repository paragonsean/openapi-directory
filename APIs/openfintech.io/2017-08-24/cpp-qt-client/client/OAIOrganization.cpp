...
OAIOrganizationAttributes OAIOrganization::getAttributes() const {
    return m_attributes;
}
void OAIOrganization::setAttributes(const OAIOrganizationAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIOrganization::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIOrganization::is_attributes_Valid() const{
...
OAISelfLinks OAIOrganization::getLinks() const {
    return m_links;
}
void OAIOrganization::setLinks(const OAISelfLinks &links) {
    m_links = links;
    m_links_isSet = true;
}
...
OAIOrganizationRelationships OAIOrganization::getRelationships() const {
    return m_relationships;
}
void OAIOrganization::setRelationships(const OAIOrganizationRelationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIOrganization::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIOrganization::is_relationships_Valid() const{
