...
/*
 * OAIPaymentMethodProcessorLinks.h
 *
 * 
 */

#ifndef OAIPaymentMethodProcessorLinks_H
#define OAIPaymentMethodProcessorLinks_H
...
class OAIPaymentMethodProcessorLinks : public OAIObject {
public:
    OAIPaymentMethodProcessorLinks();
    OAIPaymentMethodProcessorLinks(QString json);
    ~OAIPaymentMethodProcessorLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentMethodProcessorLinks)

#endif // OAIPaymentMethodProcessorLinks_H
