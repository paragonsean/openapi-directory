...
OAIExchangerRelationships::OAIExchangerRelationships(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExchangerRelationships::OAIExchangerRelationships() {
    this->initializeModel();
}

OAIExchangerRelationships::~OAIExchangerRelationships() {}

void OAIExchangerRelationships::initializeModel() {

    m_organization_isSet = false;
    m_organization_isValid = false;
}

void OAIExchangerRelationships::fromJson(QString jsonString) {
...
void OAIExchangerRelationships::fromJsonObject(QJsonObject json) {

    m_organization_isValid = ::OpenAPI::fromJsonValue(m_organization, json[QString("organization")]);
    m_organization_isSet = !json[QString("organization")].isNull() && m_organization_isValid;
}

QString OAIExchangerRelationships::asJson() const {
...
QJsonObject OAIExchangerRelationships::asJsonObject() const {
    QJsonObject obj;
...
OAIExchangerOrganization OAIExchangerRelationships::getOrganization() const {
    return m_organization;
}
void OAIExchangerRelationships::setOrganization(const OAIExchangerOrganization &organization) {
    m_organization = organization;
    m_organization_isSet = true;
}

bool OAIExchangerRelationships::is_organization_Set() const{
    return m_organization_isSet;
}

bool OAIExchangerRelationships::is_organization_Valid() const{
    return m_organization_isValid;
}

bool OAIExchangerRelationships::isSet() const {
...
bool OAIExchangerRelationships::isValid() const {
