...
/*
 * OAIOrganizationAttributesIcon.h
 *
 * Links to organization icons
 */

#ifndef OAIOrganizationAttributesIcon_H
#define OAIOrganizationAttributesIcon_H
...
class OAIOrganizationAttributesIcon : public OAIObject {
public:
    OAIOrganizationAttributesIcon();
    OAIOrganizationAttributesIcon(QString json);
    ~OAIOrganizationAttributesIcon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationAttributesIcon)

#endif // OAIOrganizationAttributesIcon_H
