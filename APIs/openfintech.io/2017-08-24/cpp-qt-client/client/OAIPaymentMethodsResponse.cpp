...
QList<OAIPaymentMethod> OAIPaymentMethodsResponse::getData() const {
    return m_data;
}
void OAIPaymentMethodsResponse::setData(const QList<OAIPaymentMethod> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPaymentMethodsResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPaymentMethodsResponse::is_data_Valid() const{
    return m_data_isValid;
}

OAIResponseLinks OAIPaymentMethodsResponse::getLinks() const {
    return m_links;
}
void OAIPaymentMethodsResponse::setLinks(const OAIResponseLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIPaymentMethodsResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAIPaymentMethodsResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIResponseMeta OAIPaymentMethodsResponse::getMeta() const {
    return m_meta;
}
void OAIPaymentMethodsResponse::setMeta(const OAIResponseMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIPaymentMethodsResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIPaymentMethodsResponse::is_meta_Valid() const{
