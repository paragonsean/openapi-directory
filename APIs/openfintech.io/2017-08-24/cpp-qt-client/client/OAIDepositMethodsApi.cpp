...
#include "OAIDepositMethodsApi.h"
...
OAIDepositMethodsApi::OAIDepositMethodsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIDepositMethodsApi::~OAIDepositMethodsApi() {
}

void OAIDepositMethodsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("depositMethodsGet", defaultConf);
    _serverIndices.insert("depositMethodsGet", 0);
    _serverConfigs.insert("depositMethodsIdGet", defaultConf);
    _serverIndices.insert("depositMethodsIdGet", 0);
}
...
*/
int OAIDepositMethodsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIDepositMethodsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIDepositMethodsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIDepositMethodsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIDepositMethodsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIDepositMethodsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIDepositMethodsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIDepositMethodsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIDepositMethodsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIDepositMethodsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIDepositMethodsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIDepositMethodsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIDepositMethodsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIDepositMethodsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIDepositMethodsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIDepositMethodsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIDepositMethodsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIDepositMethodsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIDepositMethodsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIDepositMethodsApi::depositMethodsGet(const ::OpenAPI::OptionalParam<qint32> &page_number, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &filter_search, const ::OpenAPI::OptionalParam<QString> &filter_name, const ::OpenAPI::OptionalParam<QString> &filter_code, const ::OpenAPI::OptionalParam<QString> &filter_processor_name, const ::OpenAPI::OptionalParam<QSet<QString>> &filter_category, const ::OpenAPI::OptionalParam<QSet<QString>> &sort) {
    QString fullPath = QString(_serverConfigs["depositMethodsGet"][_serverIndices.value("depositMethodsGet")].URL()+"/deposit-methods");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDepositMethodsApi::depositMethodsGetCallback);
    connect(this, &OAIDepositMethodsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIDepositMethodsApi::depositMethodsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIDepositMethodsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT depositMethodsGetSignal(output);
        Q_EMIT depositMethodsGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT depositMethodsGetSignalE(output, error_type, error_str);
        Q_EMIT depositMethodsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT depositMethodsGetSignalError(output, error_type, error_str);
        Q_EMIT depositMethodsGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDepositMethodsApi::depositMethodsIdGet(const QString &id) {
    QString fullPath = QString(_serverConfigs["depositMethodsIdGet"][_serverIndices.value("depositMethodsIdGet")].URL()+"/deposit-methods/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDepositMethodsApi::depositMethodsIdGetCallback);
    connect(this, &OAIDepositMethodsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDepositMethodsApi::depositMethodsIdGetCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIDepositMethodResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT depositMethodsIdGetSignal(output);
        Q_EMIT depositMethodsIdGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT depositMethodsIdGetSignalE(output, error_type, error_str);
        Q_EMIT depositMethodsIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT depositMethodsIdGetSignalError(output, error_type, error_str);
        Q_EMIT depositMethodsIdGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDepositMethodsApi::tokenAvailable(){
