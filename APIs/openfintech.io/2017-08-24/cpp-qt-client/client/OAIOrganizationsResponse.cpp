...
#include "OAIOrganizationsResponse.h"
...
OAIOrganizationsResponse::OAIOrganizationsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationsResponse::OAIOrganizationsResponse() {
    this->initializeModel();
}

OAIOrganizationsResponse::~OAIOrganizationsResponse() {}

void OAIOrganizationsResponse::initializeModel() {
...
void OAIOrganizationsResponse::fromJson(QString jsonString) {
...
void OAIOrganizationsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationsResponse::asJson() const {
...
QJsonObject OAIOrganizationsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIOrganization> OAIOrganizationsResponse::getData() const {
    return m_data;
}
void OAIOrganizationsResponse::setData(const QList<OAIOrganization> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIOrganizationsResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIOrganizationsResponse::is_data_Valid() const{
    return m_data_isValid;
}

OAIResponseLinks OAIOrganizationsResponse::getLinks() const {
    return m_links;
}
void OAIOrganizationsResponse::setLinks(const OAIResponseLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIOrganizationsResponse::is_links_Set() const{
    return m_links_isSet;
}

bool OAIOrganizationsResponse::is_links_Valid() const{
    return m_links_isValid;
}

OAIResponseMeta OAIOrganizationsResponse::getMeta() const {
    return m_meta;
}
void OAIOrganizationsResponse::setMeta(const OAIResponseMeta &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}

bool OAIOrganizationsResponse::is_meta_Set() const{
    return m_meta_isSet;
}

bool OAIOrganizationsResponse::is_meta_Valid() const{
    return m_meta_isValid;
}

bool OAIOrganizationsResponse::isSet() const {
...
bool OAIOrganizationsResponse::isValid() const {
