...
#include "OAIOrganizationResponse.h"
...
OAIOrganizationResponse::OAIOrganizationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationResponse::OAIOrganizationResponse() {
    this->initializeModel();
}

OAIOrganizationResponse::~OAIOrganizationResponse() {}

void OAIOrganizationResponse::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIOrganizationResponse::fromJson(QString jsonString) {
...
void OAIOrganizationResponse::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIOrganizationResponse::asJson() const {
...
QJsonObject OAIOrganizationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIOrganization OAIOrganizationResponse::getData() const {
    return m_data;
}
void OAIOrganizationResponse::setData(const OAIOrganization &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIOrganizationResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIOrganizationResponse::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIOrganizationResponse::isSet() const {
...
bool OAIOrganizationResponse::isValid() const {
