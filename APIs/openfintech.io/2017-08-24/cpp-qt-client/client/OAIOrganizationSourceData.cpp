...
#include "OAIOrganizationSourceData.h"
...
OAIOrganizationSourceData::OAIOrganizationSourceData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOrganizationSourceData::OAIOrganizationSourceData() {
    this->initializeModel();
}

OAIOrganizationSourceData::~OAIOrganizationSourceData() {}

void OAIOrganizationSourceData::initializeModel() {
...
void OAIOrganizationSourceData::fromJson(QString jsonString) {
...
void OAIOrganizationSourceData::fromJsonObject(QJsonObject json) {
...
QString OAIOrganizationSourceData::asJson() const {
...
QJsonObject OAIOrganizationSourceData::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIOrganizationSourceData::getId() const {
    return m_id;
}
void OAIOrganizationSourceData::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIOrganizationSourceData::is_id_Set() const{
    return m_id_isSet;
}

bool OAIOrganizationSourceData::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIOrganizationSourceData::getType() const {
    return m_type;
}
void OAIOrganizationSourceData::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIOrganizationSourceData::is_type_Set() const{
    return m_type_isSet;
}

bool OAIOrganizationSourceData::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIOrganizationSourceData::isSet() const {
...
bool OAIOrganizationSourceData::isValid() const {
