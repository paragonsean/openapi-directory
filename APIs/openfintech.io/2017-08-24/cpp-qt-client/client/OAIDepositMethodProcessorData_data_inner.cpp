...
OAIDepositMethodProcessorData_data_inner::OAIDepositMethodProcessorData_data_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDepositMethodProcessorData_data_inner::OAIDepositMethodProcessorData_data_inner() {
    this->initializeModel();
}

OAIDepositMethodProcessorData_data_inner::~OAIDepositMethodProcessorData_data_inner() {}

void OAIDepositMethodProcessorData_data_inner::initializeModel() {
...
void OAIDepositMethodProcessorData_data_inner::fromJson(QString jsonString) {
...
void OAIDepositMethodProcessorData_data_inner::fromJsonObject(QJsonObject json) {
...
QString OAIDepositMethodProcessorData_data_inner::asJson() const {
...
QJsonObject OAIDepositMethodProcessorData_data_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIDepositMethodProcessorData_data_inner::getId() const {
    return m_id;
}
void OAIDepositMethodProcessorData_data_inner::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDepositMethodProcessorData_data_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDepositMethodProcessorData_data_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDepositMethodProcessorData_data_inner::getType() const {
    return m_type;
}
void OAIDepositMethodProcessorData_data_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIDepositMethodProcessorData_data_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIDepositMethodProcessorData_data_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIDepositMethodProcessorData_data_inner::isSet() const {
...
bool OAIDepositMethodProcessorData_data_inner::isValid() const {
