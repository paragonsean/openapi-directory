...
OAIPaymentMethodAttributes OAIPaymentMethod::getAttributes() const {
    return m_attributes;
}
void OAIPaymentMethod::setAttributes(const OAIPaymentMethodAttributes &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIPaymentMethod::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIPaymentMethod::is_attributes_Valid() const{
...
OAISelfLinks OAIPaymentMethod::getLinks() const {
    return m_links;
}
void OAIPaymentMethod::setLinks(const OAISelfLinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIPaymentMethod::is_links_Set() const{
    return m_links_isSet;
}

bool OAIPaymentMethod::is_links_Valid() const{
    return m_links_isValid;
}

OAIPaymentMethodRelationships OAIPaymentMethod::getRelationships() const {
    return m_relationships;
}
void OAIPaymentMethod::setRelationships(const OAIPaymentMethodRelationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIPaymentMethod::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIPaymentMethod::is_relationships_Valid() const{
