...
/*
 * OAIOrganizationsResponse.h
 *
 * 
 */

#ifndef OAIOrganizationsResponse_H
#define OAIOrganizationsResponse_H
...
class OAIOrganizationsResponse : public OAIObject {
public:
    OAIOrganizationsResponse();
    OAIOrganizationsResponse(QString json);
    ~OAIOrganizationsResponse() override;
    ...
    QList<OAIOrganization> getData() const;
    void setData(const QList<OAIOrganization> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrganizationsResponse)

#endif // OAIOrganizationsResponse_H
