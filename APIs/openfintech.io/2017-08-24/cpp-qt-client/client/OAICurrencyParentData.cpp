...
OAICurrencyParentData::OAICurrencyParentData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICurrencyParentData::OAICurrencyParentData() {
    this->initializeModel();
}

OAICurrencyParentData::~OAICurrencyParentData() {}

void OAICurrencyParentData::initializeModel() {
...
void OAICurrencyParentData::fromJson(QString jsonString) {
...
void OAICurrencyParentData::fromJsonObject(QJsonObject json) {
...
QString OAICurrencyParentData::asJson() const {
...
QJsonObject OAICurrencyParentData::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAICurrencyParentData::getId() const {
    return m_id;
}
void OAICurrencyParentData::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICurrencyParentData::is_id_Set() const{
    return m_id_isSet;
}

bool OAICurrencyParentData::is_id_Valid() const{
    return m_id_isValid;
}

QString OAICurrencyParentData::getType() const {
    return m_type;
}
void OAICurrencyParentData::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICurrencyParentData::is_type_Set() const{
    return m_type_isSet;
}

bool OAICurrencyParentData::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICurrencyParentData::isSet() const {
...
bool OAICurrencyParentData::isValid() const {
