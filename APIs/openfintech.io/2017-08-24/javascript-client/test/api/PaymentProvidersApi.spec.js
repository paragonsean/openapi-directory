...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentProvidersApi();
  });
  ...
  describe('PaymentProvidersApi', function() {
    describe('paymentProvidersGet', function() {
      it('should call paymentProvidersGet successfully', function(done) {
        //uncomment below and update the code to test paymentProvidersGet
        //instance.paymentProvidersGet(function(error) {
    ...
    describe('paymentProvidersIdGet', function() {
      it('should call paymentProvidersIdGet successfully', function(done) {
        //uncomment below and update the code to test paymentProvidersIdGet
        //instance.paymentProvidersIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
