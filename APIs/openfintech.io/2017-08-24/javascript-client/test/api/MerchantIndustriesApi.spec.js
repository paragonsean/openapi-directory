...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.MerchantIndustriesApi();
  });
  ...
  describe('MerchantIndustriesApi', function() {
    describe('merchantIndustriesGet', function() {
      it('should call merchantIndustriesGet successfully', function(done) {
        //uncomment below and update the code to test merchantIndustriesGet
        //instance.merchantIndustriesGet(function(error) {
    ...
    describe('merchantIndustriesIdGet', function() {
      it('should call merchantIndustriesIdGet successfully', function(done) {
        //uncomment below and update the code to test merchantIndustriesIdGet
        //instance.merchantIndustriesIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
