...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.BanksApi();
  });
  ...
  describe('BanksApi', function() {
    describe('banksGet', function() {
      it('should call banksGet successfully', function(done) {
        //uncomment below and update the code to test banksGet
        //instance.banksGet(function(error) {
    ...
    describe('banksIdGet', function() {
      it('should call banksIdGet successfully', function(done) {
        //uncomment below and update the code to test banksIdGet
        //instance.banksIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
