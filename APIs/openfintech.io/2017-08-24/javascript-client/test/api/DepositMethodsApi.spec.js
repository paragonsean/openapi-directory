...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.OpenFinTechIo);
  }
}(this, function(expect, OpenFinTechIo) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new OpenFinTechIo.DepositMethodsApi();
  });
  ...
  describe('DepositMethodsApi', function() {
    describe('depositMethodsGet', function() {
      it('should call depositMethodsGet successfully', function(done) {
        //uncomment below and update the code to test depositMethodsGet
        //instance.depositMethodsGet(function(error) {
    ...
    describe('depositMethodsIdGet', function() {
      it('should call depositMethodsIdGet successfully', function(done) {
        //uncomment below and update the code to test depositMethodsIdGet
        //instance.depositMethodsIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
