...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ExchangersApi();
  });
  ...
  describe('ExchangersApi', function() {
    describe('exchangersGet', function() {
      it('should call exchangersGet successfully', function(done) {
        //uncomment below and update the code to test exchangersGet
        //instance.exchangersGet(function(error) {
    ...
    describe('exchangersIdGet', function() {
      it('should call exchangersIdGet successfully', function(done) {
        //uncomment below and update the code to test exchangersIdGet
        //instance.exchangersIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
