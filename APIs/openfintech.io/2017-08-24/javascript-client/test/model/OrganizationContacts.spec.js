...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationContacts();
  });
  ...
  describe('OrganizationContacts', function() {
    it('should create an instance of OrganizationContacts', function() {
      // uncomment below and update the code to test OrganizationContacts
      //var instance = new OpenFinTechIo.OrganizationContacts();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationContacts);
    });
