...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.BankAttributes();
  });
  ...
  describe('BankAttributes', function() {
    it('should create an instance of BankAttributes', function() {
      // uncomment below and update the code to test BankAttributes
      //var instance = new OpenFinTechIo.BankAttributes();
      //expect(instance).to.be.a(OpenFinTechIo.BankAttributes);
    });
    ...
    it('should have the property vatin (base name: "vatin")', function() {
      // uncomment below and update the code to test the property vatin
      //var instance = new OpenFinTechIo.BankAttributes();
      //expect(instance).to.be();
    });
