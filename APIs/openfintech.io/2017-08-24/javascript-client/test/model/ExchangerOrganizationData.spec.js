...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ExchangerOrganizationData();
  });
  ...
  describe('ExchangerOrganizationData', function() {
    it('should create an instance of ExchangerOrganizationData', function() {
      // uncomment below and update the code to test ExchangerOrganizationData
      //var instance = new OpenFinTechIo.ExchangerOrganizationData();
      //expect(instance).to.be.a(OpenFinTechIo.ExchangerOrganizationData);
    });
