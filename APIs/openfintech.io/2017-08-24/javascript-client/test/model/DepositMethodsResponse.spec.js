...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.DepositMethodsResponse();
  });
  ...
  describe('DepositMethodsResponse', function() {
    it('should create an instance of DepositMethodsResponse', function() {
      // uncomment below and update the code to test DepositMethodsResponse
      //var instance = new OpenFinTechIo.DepositMethodsResponse();
      //expect(instance).to.be.a(OpenFinTechIo.DepositMethodsResponse);
    });
