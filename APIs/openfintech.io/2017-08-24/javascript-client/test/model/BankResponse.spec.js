...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.BankResponse();
  });
  ...
  describe('BankResponse', function() {
    it('should create an instance of BankResponse', function() {
      // uncomment below and update the code to test BankResponse
      //var instance = new OpenFinTechIo.BankResponse();
      //expect(instance).to.be.a(OpenFinTechIo.BankResponse);
    });
