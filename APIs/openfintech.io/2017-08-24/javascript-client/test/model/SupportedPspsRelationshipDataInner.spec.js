...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.SupportedPspsRelationshipDataInner();
  });
  ...
  describe('SupportedPspsRelationshipDataInner', function() {
    it('should create an instance of SupportedPspsRelationshipDataInner', function() {
      // uncomment below and update the code to test SupportedPspsRelationshipDataInner
      //var instance = new OpenFinTechIo.SupportedPspsRelationshipDataInner();
      //expect(instance).to.be.a(OpenFinTechIo.SupportedPspsRelationshipDataInner);
    });
