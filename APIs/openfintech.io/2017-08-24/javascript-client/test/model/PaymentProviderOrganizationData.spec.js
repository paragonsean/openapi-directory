...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentProviderOrganizationData();
  });
  ...
  describe('PaymentProviderOrganizationData', function() {
    it('should create an instance of PaymentProviderOrganizationData', function() {
      // uncomment below and update the code to test PaymentProviderOrganizationData
      //var instance = new OpenFinTechIo.PaymentProviderOrganizationData();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentProviderOrganizationData);
    });
