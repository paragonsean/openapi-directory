...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyAttributesIcon();
  });
  ...
  describe('CurrencyAttributesIcon', function() {
    it('should create an instance of CurrencyAttributesIcon', function() {
      // uncomment below and update the code to test CurrencyAttributesIcon
      //var instance = new OpenFinTechIo.CurrencyAttributesIcon();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyAttributesIcon);
    });
    ...
    it('should have the property _64 (base name: "64")', function() {
      // uncomment below and update the code to test the property _64
      //var instance = new OpenFinTechIo.CurrencyAttributesIcon();
      //expect(instance).to.be();
    });
