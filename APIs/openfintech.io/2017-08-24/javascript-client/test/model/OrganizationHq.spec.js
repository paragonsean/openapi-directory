...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationHq();
  });
  ...
  describe('OrganizationHq', function() {
    it('should create an instance of OrganizationHq', function() {
      // uncomment below and update the code to test OrganizationHq
      //var instance = new OpenFinTechIo.OrganizationHq();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationHq);
    });
