...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationSource();
  });
  ...
  describe('OrganizationSource', function() {
    it('should create an instance of OrganizationSource', function() {
      // uncomment below and update the code to test OrganizationSource
      //var instance = new OpenFinTechIo.OrganizationSource();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationSource);
    });
