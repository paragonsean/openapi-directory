...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyIssuerOrganization();
  });
  ...
  describe('CurrencyIssuerOrganization', function() {
    it('should create an instance of CurrencyIssuerOrganization', function() {
      // uncomment below and update the code to test CurrencyIssuerOrganization
      //var instance = new OpenFinTechIo.CurrencyIssuerOrganization();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyIssuerOrganization);
    });
