...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CountryTranslations();
  });
  ...
  describe('CountryTranslations', function() {
    it('should create an instance of CountryTranslations', function() {
      // uncomment below and update the code to test CountryTranslations
      //var instance = new OpenFinTechIo.CountryTranslations();
      //expect(instance).to.be.a(OpenFinTechIo.CountryTranslations);
    });
