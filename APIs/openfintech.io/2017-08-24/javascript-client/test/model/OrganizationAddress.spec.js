...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationAddress();
  });
  ...
  describe('OrganizationAddress', function() {
    it('should create an instance of OrganizationAddress', function() {
      ...
      //var instance = new OpenFinTechIo.OrganizationAddress();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationAddress);
    });
