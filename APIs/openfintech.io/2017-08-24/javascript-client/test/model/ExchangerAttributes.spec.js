...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ExchangerAttributes();
  });
  ...
  describe('ExchangerAttributes', function() {
    it('should create an instance of ExchangerAttributes', function() {
      // uncomment below and update the code to test ExchangerAttributes
      //var instance = new OpenFinTechIo.ExchangerAttributes();
      //expect(instance).to.be.a(OpenFinTechIo.ExchangerAttributes);
    });
    ...
    it('should have the property ratesExportStandard (base name: "rates_export_standard")', function() {
      // uncomment below and update the code to test the property ratesExportStandard
      //var instance = new OpenFinTechIo.ExchangerAttributes();
      //expect(instance).to.be();
    });

    it('should have the property ratesExportUrl (base name: "rates_export_url")', function() {
      // uncomment below and update the code to test the property ratesExportUrl
      //var instance = new OpenFinTechIo.ExchangerAttributes();
      //expect(instance).to.be();
    });
