...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.BankRelationships();
  });
  ...
  describe('BankRelationships', function() {
    it('should create an instance of BankRelationships', function() {
      // uncomment below and update the code to test BankRelationships
      //var instance = new OpenFinTechIo.BankRelationships();
      //expect(instance).to.be.a(OpenFinTechIo.BankRelationships);
    });
