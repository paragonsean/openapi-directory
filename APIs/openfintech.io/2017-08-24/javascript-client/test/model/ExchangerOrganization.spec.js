...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ExchangerOrganization();
  });
  ...
  describe('ExchangerOrganization', function() {
    it('should create an instance of ExchangerOrganization', function() {
      // uncomment below and update the code to test ExchangerOrganization
      //var instance = new OpenFinTechIo.ExchangerOrganization();
      //expect(instance).to.be.a(OpenFinTechIo.ExchangerOrganization);
    });
