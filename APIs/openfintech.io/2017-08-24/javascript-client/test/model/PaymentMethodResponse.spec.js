...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentMethodResponse();
  });
  ...
  describe('PaymentMethodResponse', function() {
    it('should create an instance of PaymentMethodResponse', function() {
      ...
      //var instance = new OpenFinTechIo.PaymentMethodResponse();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentMethodResponse);
    });
