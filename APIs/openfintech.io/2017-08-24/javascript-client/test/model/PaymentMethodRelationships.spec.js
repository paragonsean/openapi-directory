...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentMethodRelationships();
  });
  ...
  describe('PaymentMethodRelationships', function() {
    it('should create an instance of PaymentMethodRelationships', function() {
      // uncomment below and update the code to test PaymentMethodRelationships
      //var instance = new OpenFinTechIo.PaymentMethodRelationships();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentMethodRelationships);
    });
    ...
    it('should have the property paymentProcessor (base name: "payment-processor")', function() {
