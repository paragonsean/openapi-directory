...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.SupportedPspsRelationshipLinks();
  });
  ...
  describe('SupportedPspsRelationshipLinks', function() {
    it('should create an instance of SupportedPspsRelationshipLinks', function() {
      // uncomment below and update the code to test SupportedPspsRelationshipLinks
      //var instance = new OpenFinTechIo.SupportedPspsRelationshipLinks();
      //expect(instance).to.be.a(OpenFinTechIo.SupportedPspsRelationshipLinks);
    });
