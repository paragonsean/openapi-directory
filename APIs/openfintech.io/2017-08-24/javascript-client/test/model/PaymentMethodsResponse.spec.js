...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentMethodsResponse();
  });
  ...
  describe('PaymentMethodsResponse', function() {
    it('should create an instance of PaymentMethodsResponse', function() {
      // uncomment below and update the code to test PaymentMethodsResponse
      //var instance = new OpenFinTechIo.PaymentMethodsResponse();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentMethodsResponse);
    });
