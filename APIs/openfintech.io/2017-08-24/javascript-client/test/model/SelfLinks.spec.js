...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.SelfLinks();
  });
  ...
  describe('SelfLinks', function() {
    it('should create an instance of SelfLinks', function() {
      // uncomment below and update the code to test SelfLinks
      //var instance = new OpenFinTechIo.SelfLinks();
      //expect(instance).to.be.a(OpenFinTechIo.SelfLinks);
    });
