...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ActiveInCountriesRelationshipDataInner();
  });
  ...
  describe('ActiveInCountriesRelationshipDataInner', function() {
    it('should create an instance of ActiveInCountriesRelationshipDataInner', function() {
      // uncomment below and update the code to test ActiveInCountriesRelationshipDataInner
      //var instance = new OpenFinTechIo.ActiveInCountriesRelationshipDataInner();
      //expect(instance).to.be.a(OpenFinTechIo.ActiveInCountriesRelationshipDataInner);
    });
