...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyIssuerOrganizationLinks();
  });
  ...
  describe('CurrencyIssuerOrganizationLinks', function() {
    it('should create an instance of CurrencyIssuerOrganizationLinks', function() {
      // uncomment below and update the code to test CurrencyIssuerOrganizationLinks
      //var instance = new OpenFinTechIo.CurrencyIssuerOrganizationLinks();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyIssuerOrganizationLinks);
    });
