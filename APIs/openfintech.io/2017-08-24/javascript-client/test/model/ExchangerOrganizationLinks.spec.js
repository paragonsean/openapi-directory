...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ExchangerOrganizationLinks();
  });
  ...
  describe('ExchangerOrganizationLinks', function() {
    it('should create an instance of ExchangerOrganizationLinks', function() {
      // uncomment below and update the code to test ExchangerOrganizationLinks
      //var instance = new OpenFinTechIo.ExchangerOrganizationLinks();
      //expect(instance).to.be.a(OpenFinTechIo.ExchangerOrganizationLinks);
    });
