...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.DepositMethodResponse();
  });
  ...
  describe('DepositMethodResponse', function() {
    it('should create an instance of DepositMethodResponse', function() {
      // uncomment below and update the code to test DepositMethodResponse
      //var instance = new OpenFinTechIo.DepositMethodResponse();
      //expect(instance).to.be.a(OpenFinTechIo.DepositMethodResponse);
    });
