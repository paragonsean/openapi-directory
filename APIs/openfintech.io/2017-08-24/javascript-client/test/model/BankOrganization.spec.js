...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.BankOrganization();
  });
  ...
  describe('BankOrganization', function() {
    it('should create an instance of BankOrganization', function() {
      // uncomment below and update the code to test BankOrganization
      //var instance = new OpenFinTechIo.BankOrganization();
      //expect(instance).to.be.a(OpenFinTechIo.BankOrganization);
    });
