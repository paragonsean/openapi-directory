...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyIssuerOrganizationData();
  });
  ...
  describe('CurrencyIssuerOrganizationData', function() {
    it('should create an instance of CurrencyIssuerOrganizationData', function() {
      // uncomment below and update the code to test CurrencyIssuerOrganizationData
      //var instance = new OpenFinTechIo.CurrencyIssuerOrganizationData();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyIssuerOrganizationData);
    });
