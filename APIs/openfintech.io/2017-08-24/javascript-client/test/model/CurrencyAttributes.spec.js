...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyAttributes();
  });
  ...
  describe('CurrencyAttributes', function() {
    it('should create an instance of CurrencyAttributes', function() {
      // uncomment below and update the code to test CurrencyAttributes
      //var instance = new OpenFinTechIo.CurrencyAttributes();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyAttributes);
    });
    ...
    it('should have the property codeEstandardsAlpha (base name: "code_estandards_alpha")', function() {
      // uncomment below and update the code to test the property codeEstandardsAlpha
      //var instance = new OpenFinTechIo.CurrencyAttributes();
      //expect(instance).to.be();
    });

    it('should have the property codeIsoAlpha3 (base name: "code_iso_alpha3")', function() {
      // uncomment below and update the code to test the property codeIsoAlpha3
      //var instance = new OpenFinTechIo.CurrencyAttributes();
      //expect(instance).to.be();
    });

    it('should have the property codeIsoNumeric3 (base name: "code_iso_numeric3")', function() {
      // uncomment below and update the code to test the property codeIsoNumeric3
      //var instance = new OpenFinTechIo.CurrencyAttributes();
      //expect(instance).to.be();
    });

    it('should have the property codeJsonAlpha (base name: "code_json_alpha")', function() {
      // uncomment below and update the code to test the property codeJsonAlpha
      //var instance = new OpenFinTechIo.CurrencyAttributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property decimalE (base name: "decimal_e")', function() {
      // uncomment below and update the code to test the property decimalE
      //var instance = new OpenFinTechIo.CurrencyAttributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property nativeSymbol (base name: "native_symbol")', function() {
      // uncomment below and update the code to test the property nativeSymbol
      //var instance = new OpenFinTechIo.CurrencyAttributes();
      //expect(instance).to.be();
    });
