...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.MerchantIndustriesResponse();
  });
  ...
  describe('MerchantIndustriesResponse', function() {
    it('should create an instance of MerchantIndustriesResponse', function() {
      // uncomment below and update the code to test MerchantIndustriesResponse
      //var instance = new OpenFinTechIo.MerchantIndustriesResponse();
      //expect(instance).to.be.a(OpenFinTechIo.MerchantIndustriesResponse);
    });
