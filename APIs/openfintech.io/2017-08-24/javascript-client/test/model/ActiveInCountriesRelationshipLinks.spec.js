...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ActiveInCountriesRelationshipLinks();
  });
  ...
  describe('ActiveInCountriesRelationshipLinks', function() {
    it('should create an instance of ActiveInCountriesRelationshipLinks', function() {
      // uncomment below and update the code to test ActiveInCountriesRelationshipLinks
      //var instance = new OpenFinTechIo.ActiveInCountriesRelationshipLinks();
      //expect(instance).to.be.a(OpenFinTechIo.ActiveInCountriesRelationshipLinks);
    });
