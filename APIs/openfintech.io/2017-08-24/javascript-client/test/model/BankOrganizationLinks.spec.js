...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.BankOrganizationLinks();
  });
  ...
  describe('BankOrganizationLinks', function() {
    it('should create an instance of BankOrganizationLinks', function() {
      // uncomment below and update the code to test BankOrganizationLinks
      //var instance = new OpenFinTechIo.BankOrganizationLinks();
      //expect(instance).to.be.a(OpenFinTechIo.BankOrganizationLinks);
    });
