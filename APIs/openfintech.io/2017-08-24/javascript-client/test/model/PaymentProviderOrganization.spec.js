...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentProviderOrganization();
  });
  ...
  describe('PaymentProviderOrganization', function() {
    it('should create an instance of PaymentProviderOrganization', function() {
      // uncomment below and update the code to test PaymentProviderOrganization
      //var instance = new OpenFinTechIo.PaymentProviderOrganization();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentProviderOrganization);
    });
