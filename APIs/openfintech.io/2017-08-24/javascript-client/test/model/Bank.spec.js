...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.Bank();
  });
  ...
  describe('Bank', function() {
    it('should create an instance of Bank', function() {
      // uncomment below and update the code to test Bank
      //var instance = new OpenFinTechIo.Bank();
      //expect(instance).to.be.a(OpenFinTechIo.Bank);
    });
