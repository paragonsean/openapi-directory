...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyParent();
  });
  ...
  describe('CurrencyParent', function() {
    it('should create an instance of CurrencyParent', function() {
      // uncomment below and update the code to test CurrencyParent
      //var instance = new OpenFinTechIo.CurrencyParent();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyParent);
    });
