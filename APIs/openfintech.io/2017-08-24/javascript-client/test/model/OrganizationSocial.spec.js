...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationSocial();
  });
  ...
  describe('OrganizationSocial', function() {
    it('should create an instance of OrganizationSocial', function() {
      // uncomment below and update the code to test OrganizationSocial
      //var instance = new OpenFinTechIo.OrganizationSocial();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationSocial);
    });
    ...
    it('should have the property vkontakte (base name: "vkontakte")', function() {
      // uncomment below and update the code to test the property vkontakte
      //var instance = new OpenFinTechIo.OrganizationSocial();
      //expect(instance).to.be();
    });
