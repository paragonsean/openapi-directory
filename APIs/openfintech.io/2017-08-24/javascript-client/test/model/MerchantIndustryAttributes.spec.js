...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.MerchantIndustryAttributes();
  });
  ...
  describe('MerchantIndustryAttributes', function() {
    it('should create an instance of MerchantIndustryAttributes', function() {
      // uncomment below and update the code to test MerchantIndustryAttributes
      //var instance = new OpenFinTechIo.MerchantIndustryAttributes();
      //expect(instance).to.be.a(OpenFinTechIo.MerchantIndustryAttributes);
    });
