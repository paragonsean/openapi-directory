...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.DepositMethodProcessorDataDataInner();
  });
  ...
  describe('DepositMethodProcessorDataDataInner', function() {
    it('should create an instance of DepositMethodProcessorDataDataInner', function() {
      // uncomment below and update the code to test DepositMethodProcessorDataDataInner
      //var instance = new OpenFinTechIo.DepositMethodProcessorDataDataInner();
      //expect(instance).to.be.a(OpenFinTechIo.DepositMethodProcessorDataDataInner);
    });
