...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.DepositMethodRelationships();
  });
  ...
  describe('DepositMethodRelationships', function() {
    it('should create an instance of DepositMethodRelationships', function() {
      // uncomment below and update the code to test DepositMethodRelationships
      //var instance = new OpenFinTechIo.DepositMethodRelationships();
      //expect(instance).to.be.a(OpenFinTechIo.DepositMethodRelationships);
    });

    it('should have the property actioveInCountries (base name: "actiove_in_countries")', function() {
      // uncomment below and update the code to test the property actioveInCountries
      //var instance = new OpenFinTechIo.DepositMethodRelationships();
    ...
    it('should have the property supportedPsps (base name: "supported_psps")', function() {
      // uncomment below and update the code to test the property supportedPsps
      //var instance = new OpenFinTechIo.DepositMethodRelationships();
      //expect(instance).to.be();
    });
