...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentMethodProcessor();
  });
  ...
  describe('PaymentMethodProcessor', function() {
    it('should create an instance of PaymentMethodProcessor', function() {
      // uncomment below and update the code to test PaymentMethodProcessor
      //var instance = new OpenFinTechIo.PaymentMethodProcessor();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentMethodProcessor);
    });
