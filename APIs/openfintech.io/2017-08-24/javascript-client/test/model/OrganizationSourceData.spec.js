...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationSourceData();
  });
  ...
  describe('OrganizationSourceData', function() {
    it('should create an instance of OrganizationSourceData', function() {
      // uncomment below and update the code to test OrganizationSourceData
      //var instance = new OpenFinTechIo.OrganizationSourceData();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationSourceData);
    });
