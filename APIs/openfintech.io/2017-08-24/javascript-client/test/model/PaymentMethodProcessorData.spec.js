...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentMethodProcessorData();
  });
  ...
  describe('PaymentMethodProcessorData', function() {
    it('should create an instance of PaymentMethodProcessorData', function() {
      // uncomment below and update the code to test PaymentMethodProcessorData
      //var instance = new OpenFinTechIo.PaymentMethodProcessorData();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentMethodProcessorData);
    });
