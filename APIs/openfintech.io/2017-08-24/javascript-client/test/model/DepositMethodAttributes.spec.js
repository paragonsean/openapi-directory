...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.DepositMethodAttributes();
  });
  ...
  describe('DepositMethodAttributes', function() {
    it('should create an instance of DepositMethodAttributes', function() {
      // uncomment below and update the code to test DepositMethodAttributes
      //var instance = new OpenFinTechIo.DepositMethodAttributes();
      //expect(instance).to.be.a(OpenFinTechIo.DepositMethodAttributes);
    });
    ...
    it('should have the property processorName (base name: "processor_name")', function() {
