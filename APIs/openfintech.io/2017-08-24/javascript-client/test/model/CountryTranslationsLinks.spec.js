...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CountryTranslationsLinks();
  });
  ...
  describe('CountryTranslationsLinks', function() {
    it('should create an instance of CountryTranslationsLinks', function() {
      // uncomment below and update the code to test CountryTranslationsLinks
      //var instance = new OpenFinTechIo.CountryTranslationsLinks();
      //expect(instance).to.be.a(OpenFinTechIo.CountryTranslationsLinks);
    });
