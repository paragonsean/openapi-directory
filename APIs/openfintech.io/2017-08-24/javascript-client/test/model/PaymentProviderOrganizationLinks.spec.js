...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentProviderOrganizationLinks();
  });
  ...
  describe('PaymentProviderOrganizationLinks', function() {
    it('should create an instance of PaymentProviderOrganizationLinks', function() {
      // uncomment below and update the code to test PaymentProviderOrganizationLinks
      //var instance = new OpenFinTechIo.PaymentProviderOrganizationLinks();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentProviderOrganizationLinks);
    });
