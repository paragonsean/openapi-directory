...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyParentData();
  });
  ...
  describe('CurrencyParentData', function() {
    it('should create an instance of CurrencyParentData', function() {
      // uncomment below and update the code to test CurrencyParentData
      //var instance = new OpenFinTechIo.CurrencyParentData();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyParentData);
    });
