...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.DepositMethodProcessorDataLinks();
  });
  ...
  describe('DepositMethodProcessorDataLinks', function() {
    it('should create an instance of DepositMethodProcessorDataLinks', function() {
      // uncomment below and update the code to test DepositMethodProcessorDataLinks
      //var instance = new OpenFinTechIo.DepositMethodProcessorDataLinks();
      //expect(instance).to.be.a(OpenFinTechIo.DepositMethodProcessorDataLinks);
    });
