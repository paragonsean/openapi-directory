...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ExchangerResponse();
  });
  ...
  describe('ExchangerResponse', function() {
    it('should create an instance of ExchangerResponse', function() {
      // uncomment below and update the code to test ExchangerResponse
      //var instance = new OpenFinTechIo.ExchangerResponse();
      //expect(instance).to.be.a(OpenFinTechIo.ExchangerResponse);
    });
