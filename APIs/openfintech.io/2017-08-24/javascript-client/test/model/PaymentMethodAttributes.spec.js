...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentMethodAttributes();
  });
  ...
  describe('PaymentMethodAttributes', function() {
    it('should create an instance of PaymentMethodAttributes', function() {
      // uncomment below and update the code to test PaymentMethodAttributes
      //var instance = new OpenFinTechIo.PaymentMethodAttributes();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentMethodAttributes);
    });
