...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.BanksResponse();
  });
  ...
  describe('BanksResponse', function() {
    it('should create an instance of BanksResponse', function() {
      // uncomment below and update the code to test BanksResponse
      //var instance = new OpenFinTechIo.BanksResponse();
      //expect(instance).to.be.a(OpenFinTechIo.BanksResponse);
    });
