...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationsResponse();
  });
  ...
  describe('OrganizationsResponse', function() {
    it('should create an instance of OrganizationsResponse', function() {
      // uncomment below and update the code to test OrganizationsResponse
      //var instance = new OpenFinTechIo.OrganizationsResponse();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationsResponse);
    });
