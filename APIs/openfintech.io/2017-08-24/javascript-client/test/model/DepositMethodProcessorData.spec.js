...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.DepositMethodProcessorData();
  });
  ...
  describe('DepositMethodProcessorData', function() {
    it('should create an instance of DepositMethodProcessorData', function() {
      // uncomment below and update the code to test DepositMethodProcessorData
      //var instance = new OpenFinTechIo.DepositMethodProcessorData();
      //expect(instance).to.be.a(OpenFinTechIo.DepositMethodProcessorData);
    });
