...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyIssuertData();
  });
  ...
  describe('CurrencyIssuertData', function() {
    it('should create an instance of CurrencyIssuertData', function() {
      // uncomment below and update the code to test CurrencyIssuertData
      //var instance = new OpenFinTechIo.CurrencyIssuertData();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyIssuertData);
    });
