...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentProviderResponse();
  });
  ...
  describe('PaymentProviderResponse', function() {
    it('should create an instance of PaymentProviderResponse', function() {
      ...
      //var instance = new OpenFinTechIo.PaymentProviderResponse();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentProviderResponse);
    });
