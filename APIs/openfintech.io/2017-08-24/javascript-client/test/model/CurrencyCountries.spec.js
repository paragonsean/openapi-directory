...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyCountries();
  });
  ...
  describe('CurrencyCountries', function() {
    it('should create an instance of CurrencyCountries', function() {
      // uncomment below and update the code to test CurrencyCountries
      //var instance = new OpenFinTechIo.CurrencyCountries();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyCountries);
    });
