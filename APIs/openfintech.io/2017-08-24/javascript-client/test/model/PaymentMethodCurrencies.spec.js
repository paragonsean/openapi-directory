...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentMethodCurrencies();
  });
  ...
  describe('PaymentMethodCurrencies', function() {
    it('should create an instance of PaymentMethodCurrencies', function() {
      // uncomment below and update the code to test PaymentMethodCurrencies
      //var instance = new OpenFinTechIo.PaymentMethodCurrencies();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentMethodCurrencies);
    });
