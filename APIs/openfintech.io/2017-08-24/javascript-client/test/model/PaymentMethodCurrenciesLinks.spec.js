...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentMethodCurrenciesLinks();
  });
  ...
  describe('PaymentMethodCurrenciesLinks', function() {
    it('should create an instance of PaymentMethodCurrenciesLinks', function() {
      // uncomment below and update the code to test PaymentMethodCurrenciesLinks
      //var instance = new OpenFinTechIo.PaymentMethodCurrenciesLinks();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentMethodCurrenciesLinks);
    });
