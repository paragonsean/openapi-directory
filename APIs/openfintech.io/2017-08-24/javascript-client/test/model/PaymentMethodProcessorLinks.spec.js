...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentMethodProcessorLinks();
  });
  ...
  describe('PaymentMethodProcessorLinks', function() {
    it('should create an instance of PaymentMethodProcessorLinks', function() {
      // uncomment below and update the code to test PaymentMethodProcessorLinks
      //var instance = new OpenFinTechIo.PaymentMethodProcessorLinks();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentMethodProcessorLinks);
    });
