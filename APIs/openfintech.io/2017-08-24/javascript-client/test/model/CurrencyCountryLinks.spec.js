...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyCountryLinks();
  });
  ...
  describe('CurrencyCountryLinks', function() {
    it('should create an instance of CurrencyCountryLinks', function() {
      // uncomment below and update the code to test CurrencyCountryLinks
      //var instance = new OpenFinTechIo.CurrencyCountryLinks();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyCountryLinks);
    });
