...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.BankOrganizationData();
  });
  ...
  describe('BankOrganizationData', function() {
    it('should create an instance of BankOrganizationData', function() {
      // uncomment below and update the code to test BankOrganizationData
      //var instance = new OpenFinTechIo.BankOrganizationData();
      //expect(instance).to.be.a(OpenFinTechIo.BankOrganizationData);
    });
