...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.MerchantIndustry();
  });
  ...
  describe('MerchantIndustry', function() {
    it('should create an instance of MerchantIndustry', function() {
      // uncomment below and update the code to test MerchantIndustry
      //var instance = new OpenFinTechIo.MerchantIndustry();
      //expect(instance).to.be.a(OpenFinTechIo.MerchantIndustry);
    });
