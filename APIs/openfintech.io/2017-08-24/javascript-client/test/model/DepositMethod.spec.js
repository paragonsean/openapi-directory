...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.DepositMethod();
  });
  ...
  describe('DepositMethod', function() {
    it('should create an instance of DepositMethod', function() {
      // uncomment below and update the code to test DepositMethod
      //var instance = new OpenFinTechIo.DepositMethod();
      //expect(instance).to.be.a(OpenFinTechIo.DepositMethod);
    });
