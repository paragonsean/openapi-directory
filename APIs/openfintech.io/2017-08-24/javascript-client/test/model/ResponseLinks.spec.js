...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ResponseLinks();
  });
  ...
  describe('ResponseLinks', function() {
    it('should create an instance of ResponseLinks', function() {
      // uncomment below and update the code to test ResponseLinks
      //var instance = new OpenFinTechIo.ResponseLinks();
      //expect(instance).to.be.a(OpenFinTechIo.ResponseLinks);
    });
