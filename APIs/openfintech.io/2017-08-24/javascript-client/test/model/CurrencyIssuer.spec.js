...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyIssuer();
  });
  ...
  describe('CurrencyIssuer', function() {
    it('should create an instance of CurrencyIssuer', function() {
      // uncomment below and update the code to test CurrencyIssuer
      //var instance = new OpenFinTechIo.CurrencyIssuer();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyIssuer);
    });
