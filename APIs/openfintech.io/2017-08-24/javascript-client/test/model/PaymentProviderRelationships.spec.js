...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentProviderRelationships();
  });
  ...
  describe('PaymentProviderRelationships', function() {
    it('should create an instance of PaymentProviderRelationships', function() {
      // uncomment below and update the code to test PaymentProviderRelationships
      //var instance = new OpenFinTechIo.PaymentProviderRelationships();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentProviderRelationships);
    });
    ...
    it('should have the property paymentMethods (base name: "payment-methods")', function() {
