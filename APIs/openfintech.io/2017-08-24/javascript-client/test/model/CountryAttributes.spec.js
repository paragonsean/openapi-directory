...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CountryAttributes();
  });
  ...
  describe('CountryAttributes', function() {
    it('should create an instance of CountryAttributes', function() {
      // uncomment below and update the code to test CountryAttributes
      //var instance = new OpenFinTechIo.CountryAttributes();
      //expect(instance).to.be.a(OpenFinTechIo.CountryAttributes);
    });
    ...
    it('should have the property callingCodes (base name: "calling_codes")', function() {
      // uncomment below and update the code to test the property callingCodes
      //var instance = new OpenFinTechIo.CountryAttributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property codeAlpha3 (base name: "code_alpha3")', function() {
      // uncomment below and update the code to test the property codeAlpha3
      //var instance = new OpenFinTechIo.CountryAttributes();
      //expect(instance).to.be();
    });
    ...
    it('should have the property subRegion (base name: "sub_region")', function() {
    ...
    it('should have the property topLevelDomains (base name: "top_level_domains")', function() {
      // uncomment below and update the code to test the property topLevelDomains
      //var instance = new OpenFinTechIo.CountryAttributes();
      //expect(instance).to.be();
    });
