...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentProviderAttributes();
  });
  ...
  describe('PaymentProviderAttributes', function() {
    it('should create an instance of PaymentProviderAttributes', function() {
      // uncomment below and update the code to test PaymentProviderAttributes
      //var instance = new OpenFinTechIo.PaymentProviderAttributes();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentProviderAttributes);
    });
    ...
    it('should have the property salesChannels (base name: "sales_channels")', function() {
