...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyParentLinks();
  });
  ...
  describe('CurrencyParentLinks', function() {
    it('should create an instance of CurrencyParentLinks', function() {
      // uncomment below and update the code to test CurrencyParentLinks
      //var instance = new OpenFinTechIo.CurrencyParentLinks();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyParentLinks);
    });
