...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationResponse();
  });
  ...
  describe('OrganizationResponse', function() {
    it('should create an instance of OrganizationResponse', function() {
      ...
      //var instance = new OpenFinTechIo.OrganizationResponse();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationResponse);
    });
