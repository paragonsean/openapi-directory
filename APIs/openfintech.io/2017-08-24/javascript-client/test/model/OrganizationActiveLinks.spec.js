...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationActiveLinks();
  });
  ...
  describe('OrganizationActiveLinks', function() {
    it('should create an instance of OrganizationActiveLinks', function() {
      // uncomment below and update the code to test OrganizationActiveLinks
      //var instance = new OpenFinTechIo.OrganizationActiveLinks();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationActiveLinks);
    });
