...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ExchangersResponse();
  });
  ...
  describe('ExchangersResponse', function() {
    it('should create an instance of ExchangersResponse', function() {
      // uncomment below and update the code to test ExchangersResponse
      //var instance = new OpenFinTechIo.ExchangersResponse();
      //expect(instance).to.be.a(OpenFinTechIo.ExchangersResponse);
    });
