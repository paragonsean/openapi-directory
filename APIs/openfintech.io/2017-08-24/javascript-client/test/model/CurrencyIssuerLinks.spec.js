...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyIssuerLinks();
  });
  ...
  describe('CurrencyIssuerLinks', function() {
    it('should create an instance of CurrencyIssuerLinks', function() {
      // uncomment below and update the code to test CurrencyIssuerLinks
      //var instance = new OpenFinTechIo.CurrencyIssuerLinks();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyIssuerLinks);
    });
