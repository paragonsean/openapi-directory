...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrenciesResponse();
  });
  ...
  describe('CurrenciesResponse', function() {
    it('should create an instance of CurrenciesResponse', function() {
      // uncomment below and update the code to test CurrenciesResponse
      //var instance = new OpenFinTechIo.CurrenciesResponse();
      //expect(instance).to.be.a(OpenFinTechIo.CurrenciesResponse);
    });
