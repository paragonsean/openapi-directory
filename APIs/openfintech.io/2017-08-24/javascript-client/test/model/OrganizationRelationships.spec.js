...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationRelationships();
  });
  ...
  describe('OrganizationRelationships', function() {
    it('should create an instance of OrganizationRelationships', function() {
      // uncomment below and update the code to test OrganizationRelationships
      //var instance = new OpenFinTechIo.OrganizationRelationships();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationRelationships);
    });

    it('should have the property activeInCountries (base name: "active_in_countries")', function() {
      // uncomment below and update the code to test the property activeInCountries
      //var instance = new OpenFinTechIo.OrganizationRelationships();
      //expect(instance).to.be();
    });

    it('should have the property hqInCountry (base name: "hq_in_country")', function() {
      // uncomment below and update the code to test the property hqInCountry
      //var instance = new OpenFinTechIo.OrganizationRelationships();
      //expect(instance).to.be();
    });

    it('should have the property sourceRegisterOrg (base name: "source_register_org")', function() {
      // uncomment below and update the code to test the property sourceRegisterOrg
      //var instance = new OpenFinTechIo.OrganizationRelationships();
      //expect(instance).to.be();
    });
