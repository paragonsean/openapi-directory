...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ActiveInCountriesRelationship();
  });
  ...
  describe('ActiveInCountriesRelationship', function() {
    it('should create an instance of ActiveInCountriesRelationship', function() {
      // uncomment below and update the code to test ActiveInCountriesRelationship
      //var instance = new OpenFinTechIo.ActiveInCountriesRelationship();
      //expect(instance).to.be.a(OpenFinTechIo.ActiveInCountriesRelationship);
    });
