...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationAttributesLogo();
  });
  ...
  describe('OrganizationAttributesLogo', function() {
    it('should create an instance of OrganizationAttributesLogo', function() {
      // uncomment below and update the code to test OrganizationAttributesLogo
      //var instance = new OpenFinTechIo.OrganizationAttributesLogo();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationAttributesLogo);
    });
    ...
    it('should have the property _150 (base name: "150")', function() {
      // uncomment below and update the code to test the property _150
      //var instance = new OpenFinTechIo.OrganizationAttributesLogo();
      //expect(instance).to.be();
    });
