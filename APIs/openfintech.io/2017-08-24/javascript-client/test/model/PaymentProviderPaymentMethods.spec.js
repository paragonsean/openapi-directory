...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentProviderPaymentMethods();
  });
  ...
  describe('PaymentProviderPaymentMethods', function() {
    it('should create an instance of PaymentProviderPaymentMethods', function() {
      // uncomment below and update the code to test PaymentProviderPaymentMethods
      //var instance = new OpenFinTechIo.PaymentProviderPaymentMethods();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentProviderPaymentMethods);
    });
