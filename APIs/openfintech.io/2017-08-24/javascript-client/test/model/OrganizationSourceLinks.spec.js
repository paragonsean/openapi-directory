...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationSourceLinks();
  });
  ...
  describe('OrganizationSourceLinks', function() {
    it('should create an instance of OrganizationSourceLinks', function() {
      // uncomment below and update the code to test OrganizationSourceLinks
      //var instance = new OpenFinTechIo.OrganizationSourceLinks();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationSourceLinks);
    });
