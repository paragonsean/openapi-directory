...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationHqLinks();
  });
  ...
  describe('OrganizationHqLinks', function() {
    it('should create an instance of OrganizationHqLinks', function() {
      // uncomment below and update the code to test OrganizationHqLinks
      //var instance = new OpenFinTechIo.OrganizationHqLinks();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationHqLinks);
    });
