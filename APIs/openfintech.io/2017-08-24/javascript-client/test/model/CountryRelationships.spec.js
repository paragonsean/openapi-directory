...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CountryRelationships();
  });
  ...
  describe('CountryRelationships', function() {
    it('should create an instance of CountryRelationships', function() {
      // uncomment below and update the code to test CountryRelationships
      //var instance = new OpenFinTechIo.CountryRelationships();
      //expect(instance).to.be.a(OpenFinTechIo.CountryRelationships);
    });
