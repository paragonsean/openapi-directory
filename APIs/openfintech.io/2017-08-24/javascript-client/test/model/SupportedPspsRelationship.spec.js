...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.SupportedPspsRelationship();
  });
  ...
  describe('SupportedPspsRelationship', function() {
    it('should create an instance of SupportedPspsRelationship', function() {
      // uncomment below and update the code to test SupportedPspsRelationship
      //var instance = new OpenFinTechIo.SupportedPspsRelationship();
      //expect(instance).to.be.a(OpenFinTechIo.SupportedPspsRelationship);
    });
