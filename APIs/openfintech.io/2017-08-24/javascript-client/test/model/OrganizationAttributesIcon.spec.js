...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationAttributesIcon();
  });
  ...
  describe('OrganizationAttributesIcon', function() {
    it('should create an instance of OrganizationAttributesIcon', function() {
      // uncomment below and update the code to test OrganizationAttributesIcon
      //var instance = new OpenFinTechIo.OrganizationAttributesIcon();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationAttributesIcon);
    });
