...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.Exchanger();
  });
  ...
  describe('Exchanger', function() {
    it('should create an instance of Exchanger', function() {
      // uncomment below and update the code to test Exchanger
      //var instance = new OpenFinTechIo.Exchanger();
      //expect(instance).to.be.a(OpenFinTechIo.Exchanger);
    });
