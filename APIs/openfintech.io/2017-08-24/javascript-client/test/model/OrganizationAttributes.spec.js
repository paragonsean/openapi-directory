...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationAttributes();
  });
  ...
  describe('OrganizationAttributes', function() {
    it('should create an instance of OrganizationAttributes', function() {
      // uncomment below and update the code to test OrganizationAttributes
      //var instance = new OpenFinTechIo.OrganizationAttributes();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationAttributes);
    });
