...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.MerchantIndustryResponse();
  });
  ...
  describe('MerchantIndustryResponse', function() {
    it('should create an instance of MerchantIndustryResponse', function() {
      // uncomment below and update the code to test MerchantIndustryResponse
      //var instance = new OpenFinTechIo.MerchantIndustryResponse();
      //expect(instance).to.be.a(OpenFinTechIo.MerchantIndustryResponse);
    });
