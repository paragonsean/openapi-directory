...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentProviderPaymentMethodsLinks();
  });
  ...
  describe('PaymentProviderPaymentMethodsLinks', function() {
    it('should create an instance of PaymentProviderPaymentMethodsLinks', function() {
      // uncomment below and update the code to test PaymentProviderPaymentMethodsLinks
      //var instance = new OpenFinTechIo.PaymentProviderPaymentMethodsLinks();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentProviderPaymentMethodsLinks);
    });
