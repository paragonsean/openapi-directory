...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationHqData();
  });
  ...
  describe('OrganizationHqData', function() {
    it('should create an instance of OrganizationHqData', function() {
      // uncomment below and update the code to test OrganizationHqData
      //var instance = new OpenFinTechIo.OrganizationHqData();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationHqData);
    });
