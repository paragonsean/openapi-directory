...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.OrganizationActive();
  });
  ...
  describe('OrganizationActive', function() {
    it('should create an instance of OrganizationActive', function() {
      // uncomment below and update the code to test OrganizationActive
      //var instance = new OpenFinTechIo.OrganizationActive();
      //expect(instance).to.be.a(OpenFinTechIo.OrganizationActive);
    });
