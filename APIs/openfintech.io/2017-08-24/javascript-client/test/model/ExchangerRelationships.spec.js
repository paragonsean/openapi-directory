...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.ExchangerRelationships();
  });
  ...
  describe('ExchangerRelationships', function() {
    it('should create an instance of ExchangerRelationships', function() {
      // uncomment below and update the code to test ExchangerRelationships
      //var instance = new OpenFinTechIo.ExchangerRelationships();
      //expect(instance).to.be.a(OpenFinTechIo.ExchangerRelationships);
    });
