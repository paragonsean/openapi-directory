...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CurrencyRelationships();
  });
  ...
  describe('CurrencyRelationships', function() {
    it('should create an instance of CurrencyRelationships', function() {
      // uncomment below and update the code to test CurrencyRelationships
      //var instance = new OpenFinTechIo.CurrencyRelationships();
      //expect(instance).to.be.a(OpenFinTechIo.CurrencyRelationships);
    });
    ...
    it('should have the property issuerOrganization (base name: "issuer_organization")', function() {
      // uncomment below and update the code to test the property issuerOrganization
      //var instance = new OpenFinTechIo.CurrencyRelationships();
      //expect(instance).to.be();
    });
