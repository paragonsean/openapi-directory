...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.PaymentProvidersResponse();
  });
  ...
  describe('PaymentProvidersResponse', function() {
    it('should create an instance of PaymentProvidersResponse', function() {
      // uncomment below and update the code to test PaymentProvidersResponse
      //var instance = new OpenFinTechIo.PaymentProvidersResponse();
      //expect(instance).to.be.a(OpenFinTechIo.PaymentProvidersResponse);
    });
