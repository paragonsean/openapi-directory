...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFinTechIo.CountryResponse();
  });
  ...
  describe('CountryResponse', function() {
    it('should create an instance of CountryResponse', function() {
      // uncomment below and update the code to test CountryResponse
      //var instance = new OpenFinTechIo.CountryResponse();
      //expect(instance).to.be.a(OpenFinTechIo.CountryResponse);
    });
