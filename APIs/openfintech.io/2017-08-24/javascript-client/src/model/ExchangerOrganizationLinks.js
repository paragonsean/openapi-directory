...
/**
 * The ExchangerOrganizationLinks model module.
 * @module model/ExchangerOrganizationLinks
 * @version 2017-08-24
 */
class ExchangerOrganizationLinks {
    /**
     * Constructs a new <code>ExchangerOrganizationLinks</code>.
     * @alias module:model/ExchangerOrganizationLinks
     */
    constructor() { 
        
        ExchangerOrganizationLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExchangerOrganizationLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangerOrganizationLinks} obj Optional instance to populate.
     * @return {module:model/ExchangerOrganizationLinks} The populated <code>ExchangerOrganizationLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangerOrganizationLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangerOrganizationLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangerOrganizationLinks</code>.
     */
 ...
 */
ExchangerOrganizationLinks.prototype['related'] = undefined;
...
export default ExchangerOrganizationLinks;
