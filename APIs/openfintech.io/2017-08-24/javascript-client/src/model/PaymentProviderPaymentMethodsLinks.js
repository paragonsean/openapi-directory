...
/**
 * The PaymentProviderPaymentMethodsLinks model module.
 * @module model/PaymentProviderPaymentMethodsLinks
 * @version 2017-08-24
 */
class PaymentProviderPaymentMethodsLinks {
    /**
     * Constructs a new <code>PaymentProviderPaymentMethodsLinks</code>.
     * @alias module:model/PaymentProviderPaymentMethodsLinks
     */
    constructor() { 
        
        PaymentProviderPaymentMethodsLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentProviderPaymentMethodsLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentProviderPaymentMethodsLinks} obj Optional instance to populate.
     * @return {module:model/PaymentProviderPaymentMethodsLinks} The populated <code>PaymentProviderPaymentMethodsLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentProviderPaymentMethodsLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentProviderPaymentMethodsLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentProviderPaymentMethodsLinks</code>.
     */
 ...
 */
PaymentProviderPaymentMethodsLinks.prototype['related'] = undefined;
...
export default PaymentProviderPaymentMethodsLinks;
