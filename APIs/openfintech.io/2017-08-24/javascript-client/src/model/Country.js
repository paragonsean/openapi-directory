...
import CountryRelationships from './CountryRelationships';
...
class Country {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = CountryRelationships.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          CountryAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          CountryRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
 ...
 */
Country.prototype['links'] = undefined;

/**
 * @member {module:model/CountryRelationships} relationships
 */
Country.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
Country.prototype['type'] = undefined;
