...
import ExchangerAttributes from './ExchangerAttributes';
import ExchangerRelationships from './ExchangerRelationships';
import SelfLinks from './SelfLinks';

/**
 * The Exchanger model module.
 * @module model/Exchanger
 * @version 2017-08-24
 */
class Exchanger {
    /**
     * Constructs a new <code>Exchanger</code>.
     * @alias module:model/Exchanger
     */
    constructor() { 
        
        Exchanger.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Exchanger</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Exchanger} obj Optional instance to populate.
     * @return {module:model/Exchanger} The populated <code>Exchanger</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Exchanger();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = ExchangerAttributes.constructFromObject(data['attributes']);
            }
            ...
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = ExchangerRelationships.constructFromObject(data['relationships']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Exchanger</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Exchanger</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          ExchangerAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          ExchangerRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ExchangerAttributes} attributes
 */
Exchanger.prototype['attributes'] = undefined;

/**
 * Exchanger`s ID
 * @member {String} id
 */
Exchanger.prototype['id'] = undefined;

/**
 * @member {module:model/SelfLinks} links
 */
Exchanger.prototype['links'] = undefined;

/**
 * @member {module:model/ExchangerRelationships} relationships
 */
Exchanger.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
Exchanger.prototype['type'] = undefined;
