...
/**
 * The MerchantIndustriesResponse model module.
 * @module model/MerchantIndustriesResponse
 * @version 2017-08-24
 */
class MerchantIndustriesResponse {
    /**
     * Constructs a new <code>MerchantIndustriesResponse</code>.
     * @alias module:model/MerchantIndustriesResponse
     */
    constructor() { 
        
        MerchantIndustriesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MerchantIndustriesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MerchantIndustriesResponse} obj Optional instance to populate.
     * @return {module:model/MerchantIndustriesResponse} The populated <code>MerchantIndustriesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MerchantIndustriesResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [MerchantIndustry]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MerchantIndustriesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MerchantIndustriesResponse</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                MerchantIndustry.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/MerchantIndustry>} data
 */
MerchantIndustriesResponse.prototype['data'] = undefined;

/**
 * @member {module:model/ResponseLinks} links
 */
MerchantIndustriesResponse.prototype['links'] = undefined;

/**
 * @member {module:model/ResponseMeta} meta
 */
MerchantIndustriesResponse.prototype['meta'] = undefined;
...
export default MerchantIndustriesResponse;
