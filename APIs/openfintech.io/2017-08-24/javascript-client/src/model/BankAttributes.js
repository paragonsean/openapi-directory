...
/**
 * The BankAttributes model module.
 * @module model/BankAttributes
 * @version 2017-08-24
 */
class BankAttributes {
    /**
     * Constructs a new <code>BankAttributes</code>.
     * Array of bank attributes
     * @alias module:model/BankAttributes
     */
    constructor() { 
        
        BankAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BankAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BankAttributes} obj Optional instance to populate.
     * @return {module:model/BankAttributes} The populated <code>BankAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BankAttributes();
            ...
            if (data.hasOwnProperty('vatin')) {
                obj['vatin'] = ApiClient.convertToType(data['vatin'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BankAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BankAttributes</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['vatin'] && !(typeof data['vatin'] === 'string' || data['vatin'] instanceof String)) {
            throw new Error("Expected the field `vatin` to be a primitive type in the JSON string but got " + data['vatin']);
        }
 ...
 */
BankAttributes.prototype['account_number'] = undefined;

/**
 * @member {String} bank_code
 */
BankAttributes.prototype['bank_code'] = undefined;

/**
 * @member {String} bic
 */
BankAttributes.prototype['bic'] = undefined;

/**
 * Bank`s code
 * @member {String} code
 */
BankAttributes.prototype['code'] = undefined;

/**
 * @member {String} iban
 */
BankAttributes.prototype['iban'] = undefined;

/**
 * Bank`s name
 * @member {String} name
 */
BankAttributes.prototype['name'] = undefined;

/**
 * @member {String} sort_code
 */
BankAttributes.prototype['sort_code'] = undefined;

/**
 * Status [active, liquidated, problem, deleted]
 * @member {String} status
 */
BankAttributes.prototype['status'] = undefined;

/**
 * @member {String} vatin
 */
BankAttributes.prototype['vatin'] = undefined;
