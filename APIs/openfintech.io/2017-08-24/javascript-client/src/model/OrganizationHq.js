...
import OrganizationHqData from './OrganizationHqData';
import OrganizationHqLinks from './OrganizationHqLinks';

/**
 * The OrganizationHq model module.
 * @module model/OrganizationHq
 * @version 2017-08-24
 */
class OrganizationHq {
    /**
     * Constructs a new <code>OrganizationHq</code>.
     * @alias module:model/OrganizationHq
     */
    constructor() { 
        
        OrganizationHq.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationHq</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationHq} obj Optional instance to populate.
     * @return {module:model/OrganizationHq} The populated <code>OrganizationHq</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationHq();

            if (data.hasOwnProperty('data')) {
                obj['data'] = OrganizationHqData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = OrganizationHqLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationHq</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationHq</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          OrganizationHqData.validateJSON(data['data']);
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          OrganizationHqLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/OrganizationHqData} data
 */
OrganizationHq.prototype['data'] = undefined;

/**
 * @member {module:model/OrganizationHqLinks} links
 */
OrganizationHq.prototype['links'] = undefined;
