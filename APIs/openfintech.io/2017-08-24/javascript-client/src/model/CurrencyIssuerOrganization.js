...
import CurrencyIssuerOrganizationData from './CurrencyIssuerOrganizationData';
import CurrencyIssuerOrganizationLinks from './CurrencyIssuerOrganizationLinks';

/**
 * The CurrencyIssuerOrganization model module.
 * @module model/CurrencyIssuerOrganization
 * @version 2017-08-24
 */
class CurrencyIssuerOrganization {
    /**
     * Constructs a new <code>CurrencyIssuerOrganization</code>.
     * Issuer. 
     * @alias module:model/CurrencyIssuerOrganization
     */
    constructor() { 
        
        CurrencyIssuerOrganization.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyIssuerOrganization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyIssuerOrganization} obj Optional instance to populate.
     * @return {module:model/CurrencyIssuerOrganization} The populated <code>CurrencyIssuerOrganization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyIssuerOrganization();

            if (data.hasOwnProperty('data')) {
                obj['data'] = CurrencyIssuerOrganizationData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = CurrencyIssuerOrganizationLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyIssuerOrganization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyIssuerOrganization</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          CurrencyIssuerOrganizationData.validateJSON(data['data']);
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          CurrencyIssuerOrganizationLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/CurrencyIssuerOrganizationData} data
 */
CurrencyIssuerOrganization.prototype['data'] = undefined;

/**
 * @member {module:model/CurrencyIssuerOrganizationLinks} links
 */
CurrencyIssuerOrganization.prototype['links'] = undefined;
...
export default CurrencyIssuerOrganization;
