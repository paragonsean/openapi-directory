...
/**
 * The CurrencyIssuertData model module.
 * @module model/CurrencyIssuertData
 * @version 2017-08-24
 */
class CurrencyIssuertData {
    /**
     * Constructs a new <code>CurrencyIssuertData</code>.
     * @alias module:model/CurrencyIssuertData
     */
    constructor() { 
        
        CurrencyIssuertData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyIssuertData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyIssuertData} obj Optional instance to populate.
     * @return {module:model/CurrencyIssuertData} The populated <code>CurrencyIssuertData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyIssuertData();
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyIssuertData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyIssuertData</code>.
     */
 ...
 * @member {String} id
 */
CurrencyIssuertData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
CurrencyIssuertData.prototype['type'] = undefined;
...
export default CurrencyIssuertData;
