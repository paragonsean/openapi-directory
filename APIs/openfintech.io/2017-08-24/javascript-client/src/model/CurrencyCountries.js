...
import CurrencyCountryLinks from './CurrencyCountryLinks';

/**
 * The CurrencyCountries model module.
 * @module model/CurrencyCountries
 * @version 2017-08-24
 */
class CurrencyCountries {
    /**
     * Constructs a new <code>CurrencyCountries</code>.
     * @alias module:model/CurrencyCountries
     */
    constructor() { 
        
        CurrencyCountries.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyCountries</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyCountries} obj Optional instance to populate.
     * @return {module:model/CurrencyCountries} The populated <code>CurrencyCountries</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyCountries();

            if (data.hasOwnProperty('links')) {
                obj['links'] = CurrencyCountryLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyCountries</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyCountries</code>.
     */
    static validateJSON(data) {
        // validate the optional field `links`
        if (data['links']) { // data not null
          CurrencyCountryLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/CurrencyCountryLinks} links
 */
CurrencyCountries.prototype['links'] = undefined;
