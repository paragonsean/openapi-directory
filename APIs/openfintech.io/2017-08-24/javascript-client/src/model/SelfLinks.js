...
/**
 * The SelfLinks model module.
 * @module model/SelfLinks
 * @version 2017-08-24
 */
class SelfLinks {
    /**
     * Constructs a new <code>SelfLinks</code>.
     * @alias module:model/SelfLinks
     */
    constructor() { 
        
        SelfLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SelfLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SelfLinks} obj Optional instance to populate.
     * @return {module:model/SelfLinks} The populated <code>SelfLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SelfLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>SelfLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SelfLinks</code>.
     */
 ...
 * @member {String} self
 */
SelfLinks.prototype['self'] = undefined;
