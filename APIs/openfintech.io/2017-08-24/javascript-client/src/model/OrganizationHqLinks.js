...
/**
 * The OrganizationHqLinks model module.
 * @module model/OrganizationHqLinks
 * @version 2017-08-24
 */
class OrganizationHqLinks {
    /**
     * Constructs a new <code>OrganizationHqLinks</code>.
     * @alias module:model/OrganizationHqLinks
     */
    constructor() { 
        
        OrganizationHqLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationHqLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationHqLinks} obj Optional instance to populate.
     * @return {module:model/OrganizationHqLinks} The populated <code>OrganizationHqLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationHqLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationHqLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationHqLinks</code>.
     */
 ...
 */
OrganizationHqLinks.prototype['related'] = undefined;
...
export default OrganizationHqLinks;
