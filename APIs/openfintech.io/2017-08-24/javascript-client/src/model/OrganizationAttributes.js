...
import OrganizationAttributesIcon from './OrganizationAttributesIcon';
import OrganizationAttributesLogo from './OrganizationAttributesLogo';
import OrganizationContacts from './OrganizationContacts';
import OrganizationSocial from './OrganizationSocial';

/**
 * The OrganizationAttributes model module.
 * @module model/OrganizationAttributes
 * @version 2017-08-24
 */
class OrganizationAttributes {
    /**
     * Constructs a new <code>OrganizationAttributes</code>.
     * @alias module:model/OrganizationAttributes
     */
    constructor() { 
        
        OrganizationAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationAttributes} obj Optional instance to populate.
     * @return {module:model/OrganizationAttributes} The populated <code>OrganizationAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationAttributes();

            if (data.hasOwnProperty('address')) {
                obj['address'] = OrganizationAddress.constructFromObject(data['address']);
            }
            ...
            if (data.hasOwnProperty('contacts')) {
                obj['contacts'] = OrganizationContacts.constructFromObject(data['contacts']);
            }
            if (data.hasOwnProperty('description')) {
                obj['description'] = ApiClient.convertToType(data['description'], 'String');
            }
            if (data.hasOwnProperty('icon')) {
                obj['icon'] = OrganizationAttributesIcon.constructFromObject(data['icon']);
            }
            if (data.hasOwnProperty('industries')) {
                obj['industries'] = ApiClient.convertToType(data['industries'], ['String']);
            }
            if (data.hasOwnProperty('logo')) {
                obj['logo'] = OrganizationAttributesLogo.constructFromObject(data['logo']);
            }
            ...
            if (data.hasOwnProperty('social_profiles')) {
                obj['social_profiles'] = OrganizationSocial.constructFromObject(data['social_profiles']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationAttributes</code>.
     */
    static validateJSON(data) {
        // validate the optional field `address`
        if (data['address']) { // data not null
          OrganizationAddress.validateJSON(data['address']);
        }
        ...
        if (data['contacts']) { // data not null
          OrganizationContacts.validateJSON(data['contacts']);
        }
        // ensure the json data is a string
        ...
        if (data['icon']) { // data not null
          OrganizationAttributesIcon.validateJSON(data['icon']);
        }
        ...
        if (data['logo']) { // data not null
          OrganizationAttributesLogo.validateJSON(data['logo']);
        }
        // ensure the json data is a string
        ...
        if (data['social_profiles']) { // data not null
          OrganizationSocial.validateJSON(data['social_profiles']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/OrganizationAddress} address
 */
OrganizationAttributes.prototype['address'] = undefined;

/**
 * Organization`s blog
 * @member {String} blog
 */
OrganizationAttributes.prototype['blog'] = undefined;

/**
 * Organization`s code
 * @member {String} code
 */
OrganizationAttributes.prototype['code'] = undefined;

/**
 * @member {module:model/OrganizationContacts} contacts
 */
OrganizationAttributes.prototype['contacts'] = undefined;

/**
 * Description
 * @member {String} description
 */
OrganizationAttributes.prototype['description'] = undefined;

/**
 * @member {module:model/OrganizationAttributesIcon} icon
 */
OrganizationAttributes.prototype['icon'] = undefined;

/**
 * Industries
 * @member {Array.<String>} industries
 */
OrganizationAttributes.prototype['industries'] = undefined;

/**
 * @member {module:model/OrganizationAttributesLogo} logo
 */
OrganizationAttributes.prototype['logo'] = undefined;

/**
 * Organization`s name
 * @member {String} name
 */
OrganizationAttributes.prototype['name'] = undefined;

/**
 * Organization`s site
 * @member {String} site
 */
OrganizationAttributes.prototype['site'] = undefined;

/**
 * @member {module:model/OrganizationSocial} social_profiles
 */
OrganizationAttributes.prototype['social_profiles'] = undefined;

/**
 * Organization`s status [active, liquidated, deleted]
 * @member {String} status
 */
OrganizationAttributes.prototype['status'] = undefined;

/**
 * Organization`s wiki
 * @member {String} wiki
 */
OrganizationAttributes.prototype['wiki'] = undefined;
