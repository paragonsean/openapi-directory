...
import OrganizationActive from './OrganizationActive';
import OrganizationHq from './OrganizationHq';
import OrganizationSource from './OrganizationSource';

/**
 * The OrganizationRelationships model module.
 * @module model/OrganizationRelationships
 * @version 2017-08-24
 */
class OrganizationRelationships {
    /**
     * Constructs a new <code>OrganizationRelationships</code>.
     * @alias module:model/OrganizationRelationships
     */
    constructor() { 
        
        OrganizationRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationRelationships} obj Optional instance to populate.
     * @return {module:model/OrganizationRelationships} The populated <code>OrganizationRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationRelationships();

            if (data.hasOwnProperty('active_in_countries')) {
                obj['active_in_countries'] = OrganizationActive.constructFromObject(data['active_in_countries']);
            }
            if (data.hasOwnProperty('hq_in_country')) {
                obj['hq_in_country'] = OrganizationHq.constructFromObject(data['hq_in_country']);
            }
            if (data.hasOwnProperty('source_register_org')) {
                obj['source_register_org'] = OrganizationSource.constructFromObject(data['source_register_org']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `active_in_countries`
        if (data['active_in_countries']) { // data not null
          OrganizationActive.validateJSON(data['active_in_countries']);
        }
        // validate the optional field `hq_in_country`
        if (data['hq_in_country']) { // data not null
          OrganizationHq.validateJSON(data['hq_in_country']);
        }
        // validate the optional field `source_register_org`
        if (data['source_register_org']) { // data not null
          OrganizationSource.validateJSON(data['source_register_org']);
        }
...
/**
 * @member {module:model/OrganizationActive} active_in_countries
 */
OrganizationRelationships.prototype['active_in_countries'] = undefined;

/**
 * @member {module:model/OrganizationHq} hq_in_country
 */
OrganizationRelationships.prototype['hq_in_country'] = undefined;

/**
 * @member {module:model/OrganizationSource} source_register_org
 */
OrganizationRelationships.prototype['source_register_org'] = undefined;
