...
import SupportedPspsRelationshipDataInner from './SupportedPspsRelationshipDataInner';
import SupportedPspsRelationshipLinks from './SupportedPspsRelationshipLinks';

/**
 * The SupportedPspsRelationship model module.
 * @module model/SupportedPspsRelationship
 * @version 2017-08-24
 */
class SupportedPspsRelationship {
    /**
     * Constructs a new <code>SupportedPspsRelationship</code>.
     * Supported psps
     * @alias module:model/SupportedPspsRelationship
     */
    constructor() { 
        
        SupportedPspsRelationship.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SupportedPspsRelationship</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SupportedPspsRelationship} obj Optional instance to populate.
     * @return {module:model/SupportedPspsRelationship} The populated <code>SupportedPspsRelationship</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SupportedPspsRelationship();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [SupportedPspsRelationshipDataInner]);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = SupportedPspsRelationshipLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SupportedPspsRelationship</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SupportedPspsRelationship</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                SupportedPspsRelationshipDataInner.validateJSON(item);
            };
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          SupportedPspsRelationshipLinks.validateJSON(data['links']);
        }
...
/**
 * @member {Array.<module:model/SupportedPspsRelationshipDataInner>} data
 */
SupportedPspsRelationship.prototype['data'] = undefined;

/**
 * @member {module:model/SupportedPspsRelationshipLinks} links
 */
SupportedPspsRelationship.prototype['links'] = undefined;
...
export default SupportedPspsRelationship;
