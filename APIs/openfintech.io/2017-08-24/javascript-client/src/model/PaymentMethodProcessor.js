...
import PaymentMethodProcessorData from './PaymentMethodProcessorData';
import PaymentMethodProcessorLinks from './PaymentMethodProcessorLinks';

/**
 * The PaymentMethodProcessor model module.
 * @module model/PaymentMethodProcessor
 * @version 2017-08-24
 */
class PaymentMethodProcessor {
    /**
     * Constructs a new <code>PaymentMethodProcessor</code>.
     * Payment-method issuer.
     * @alias module:model/PaymentMethodProcessor
     */
    constructor() { 
        
        PaymentMethodProcessor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentMethodProcessor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentMethodProcessor} obj Optional instance to populate.
     * @return {module:model/PaymentMethodProcessor} The populated <code>PaymentMethodProcessor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentMethodProcessor();

            if (data.hasOwnProperty('data')) {
                obj['data'] = PaymentMethodProcessorData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = PaymentMethodProcessorLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentMethodProcessor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentMethodProcessor</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          PaymentMethodProcessorData.validateJSON(data['data']);
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          PaymentMethodProcessorLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/PaymentMethodProcessorData} data
 */
PaymentMethodProcessor.prototype['data'] = undefined;

/**
 * @member {module:model/PaymentMethodProcessorLinks} links
 */
PaymentMethodProcessor.prototype['links'] = undefined;
...
export default PaymentMethodProcessor;
