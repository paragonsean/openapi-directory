...
/**
 * The BanksResponse model module.
 * @module model/BanksResponse
 * @version 2017-08-24
 */
class BanksResponse {
    /**
     * Constructs a new <code>BanksResponse</code>.
     * @alias module:model/BanksResponse
     */
    constructor() { 
        
        BanksResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BanksResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BanksResponse} obj Optional instance to populate.
     * @return {module:model/BanksResponse} The populated <code>BanksResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BanksResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Bank]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BanksResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BanksResponse</code>.
     */
...
/**
 * @member {Array.<module:model/Bank>} data
 */
BanksResponse.prototype['data'] = undefined;

/**
 * @member {module:model/ResponseLinks} links
 */
BanksResponse.prototype['links'] = undefined;

/**
 * @member {module:model/ResponseMeta} meta
 */
BanksResponse.prototype['meta'] = undefined;
