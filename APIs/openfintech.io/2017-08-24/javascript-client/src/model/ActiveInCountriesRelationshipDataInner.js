...
/**
 * The ActiveInCountriesRelationshipDataInner model module.
 * @module model/ActiveInCountriesRelationshipDataInner
 * @version 2017-08-24
 */
class ActiveInCountriesRelationshipDataInner {
    /**
     * Constructs a new <code>ActiveInCountriesRelationshipDataInner</code>.
     * @alias module:model/ActiveInCountriesRelationshipDataInner
     */
    constructor() { 
        
        ActiveInCountriesRelationshipDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActiveInCountriesRelationshipDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActiveInCountriesRelationshipDataInner} obj Optional instance to populate.
     * @return {module:model/ActiveInCountriesRelationshipDataInner} The populated <code>ActiveInCountriesRelationshipDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActiveInCountriesRelationshipDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ActiveInCountriesRelationshipDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActiveInCountriesRelationshipDataInner</code>.
     */
 ...
 * @member {String} id
 */
ActiveInCountriesRelationshipDataInner.prototype['id'] = undefined;

/**
 * @member {String} type
 */
ActiveInCountriesRelationshipDataInner.prototype['type'] = undefined;
...
export default ActiveInCountriesRelationshipDataInner;
