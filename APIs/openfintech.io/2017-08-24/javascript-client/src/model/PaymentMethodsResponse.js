...
class PaymentMethodsResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('links')) {
                obj['links'] = ResponseLinks.constructFromObject(data['links']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['links']) { // data not null
          ResponseLinks.validateJSON(data['links']);
        }
 ...
 */
PaymentMethodsResponse.prototype['data'] = undefined;

/**
 * @member {module:model/ResponseLinks} links
 */
PaymentMethodsResponse.prototype['links'] = undefined;

/**
 * @member {module:model/ResponseMeta} meta
 */
PaymentMethodsResponse.prototype['meta'] = undefined;
