...
import PaymentMethodCurrenciesLinks from './PaymentMethodCurrenciesLinks';

/**
 * The PaymentMethodCurrencies model module.
 * @module model/PaymentMethodCurrencies
 * @version 2017-08-24
 */
class PaymentMethodCurrencies {
    /**
     * Constructs a new <code>PaymentMethodCurrencies</code>.
     * @alias module:model/PaymentMethodCurrencies
     */
    constructor() { 
        
        PaymentMethodCurrencies.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentMethodCurrencies</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentMethodCurrencies} obj Optional instance to populate.
     * @return {module:model/PaymentMethodCurrencies} The populated <code>PaymentMethodCurrencies</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentMethodCurrencies();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], ['String']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = PaymentMethodCurrenciesLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentMethodCurrencies</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentMethodCurrencies</code>.
     */
    static validateJSON(data) {
        ...
        if (data['links']) { // data not null
          PaymentMethodCurrenciesLinks.validateJSON(data['links']);
        }
 ...
 */
PaymentMethodCurrencies.prototype['data'] = undefined;

/**
 * @member {module:model/PaymentMethodCurrenciesLinks} links
 */
PaymentMethodCurrencies.prototype['links'] = undefined;
...
export default PaymentMethodCurrencies;
