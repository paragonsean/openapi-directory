...
/**
 * The MerchantIndustryAttributes model module.
 * @module model/MerchantIndustryAttributes
 * @version 2017-08-24
 */
class MerchantIndustryAttributes {
    /**
     * Constructs a new <code>MerchantIndustryAttributes</code>.
     * Array of Merchant-industry attributes
     * @alias module:model/MerchantIndustryAttributes
     */
    constructor() { 
        
        MerchantIndustryAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MerchantIndustryAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MerchantIndustryAttributes} obj Optional instance to populate.
     * @return {module:model/MerchantIndustryAttributes} The populated <code>MerchantIndustryAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MerchantIndustryAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>MerchantIndustryAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MerchantIndustryAttributes</code>.
     */
 ...
 * @member {String} name
 */
MerchantIndustryAttributes.prototype['name'] = undefined;
...
export default MerchantIndustryAttributes;
