...
/**
 * The BankOrganizationData model module.
 * @module model/BankOrganizationData
 * @version 2017-08-24
 */
class BankOrganizationData {
    /**
     * Constructs a new <code>BankOrganizationData</code>.
     * @alias module:model/BankOrganizationData
     */
    constructor() { 
        
        BankOrganizationData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BankOrganizationData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BankOrganizationData} obj Optional instance to populate.
     * @return {module:model/BankOrganizationData} The populated <code>BankOrganizationData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BankOrganizationData();
    ...
    /**
     * Validates the JSON data with respect to <code>BankOrganizationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BankOrganizationData</code>.
     */
 ...
 * @member {String} id
 */
BankOrganizationData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
BankOrganizationData.prototype['type'] = undefined;
...
export default BankOrganizationData;
