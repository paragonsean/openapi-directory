...
/**
 * The OrganizationSourceData model module.
 * @module model/OrganizationSourceData
 * @version 2017-08-24
 */
class OrganizationSourceData {
    /**
     * Constructs a new <code>OrganizationSourceData</code>.
     * @alias module:model/OrganizationSourceData
     */
    constructor() { 
        
        OrganizationSourceData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationSourceData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationSourceData} obj Optional instance to populate.
     * @return {module:model/OrganizationSourceData} The populated <code>OrganizationSourceData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationSourceData();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationSourceData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationSourceData</code>.
     */
 ...
 * @member {String} id
 */
OrganizationSourceData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
OrganizationSourceData.prototype['type'] = undefined;
...
export default OrganizationSourceData;
