...
/**
 * The CurrencyIssuerOrganizationLinks model module.
 * @module model/CurrencyIssuerOrganizationLinks
 * @version 2017-08-24
 */
class CurrencyIssuerOrganizationLinks {
    /**
     * Constructs a new <code>CurrencyIssuerOrganizationLinks</code>.
     * @alias module:model/CurrencyIssuerOrganizationLinks
     */
    constructor() { 
        
        CurrencyIssuerOrganizationLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyIssuerOrganizationLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyIssuerOrganizationLinks} obj Optional instance to populate.
     * @return {module:model/CurrencyIssuerOrganizationLinks} The populated <code>CurrencyIssuerOrganizationLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyIssuerOrganizationLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyIssuerOrganizationLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyIssuerOrganizationLinks</code>.
     */
 ...
 */
CurrencyIssuerOrganizationLinks.prototype['related'] = undefined;
...
export default CurrencyIssuerOrganizationLinks;
