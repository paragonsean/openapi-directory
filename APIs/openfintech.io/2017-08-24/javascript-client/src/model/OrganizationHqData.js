...
/**
 * The OrganizationHqData model module.
 * @module model/OrganizationHqData
 * @version 2017-08-24
 */
class OrganizationHqData {
    /**
     * Constructs a new <code>OrganizationHqData</code>.
     * @alias module:model/OrganizationHqData
     */
    constructor() { 
        
        OrganizationHqData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationHqData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationHqData} obj Optional instance to populate.
     * @return {module:model/OrganizationHqData} The populated <code>OrganizationHqData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationHqData();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationHqData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationHqData</code>.
     */
 ...
 * @member {String} id
 */
OrganizationHqData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
OrganizationHqData.prototype['type'] = undefined;
...
export default OrganizationHqData;
