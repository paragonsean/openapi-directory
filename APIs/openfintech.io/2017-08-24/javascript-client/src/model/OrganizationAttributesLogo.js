...
/**
 * The OrganizationAttributesLogo model module.
 * @module model/OrganizationAttributesLogo
 * @version 2017-08-24
 */
class OrganizationAttributesLogo {
    /**
     * Constructs a new <code>OrganizationAttributesLogo</code>.
     * Links to organization logos
     * @alias module:model/OrganizationAttributesLogo
     */
    constructor() { 
        
        OrganizationAttributesLogo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationAttributesLogo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationAttributesLogo} obj Optional instance to populate.
     * @return {module:model/OrganizationAttributesLogo} The populated <code>OrganizationAttributesLogo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationAttributesLogo();
            ...
            if (data.hasOwnProperty('150')) {
                obj['150'] = ApiClient.convertToType(data['150'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationAttributesLogo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationAttributesLogo</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['150'] && !(typeof data['150'] === 'string' || data['150'] instanceof String)) {
            throw new Error("Expected the field `150` to be a primitive type in the JSON string but got " + data['150']);
        }
 ...
 * @member {String} 50
 */
OrganizationAttributesLogo.prototype['50'] = undefined;

/**
 * 100x100 logo
 * @member {String} 100
 */
OrganizationAttributesLogo.prototype['100'] = undefined;

/**
 * 150x150 logo
 * @member {String} 150
 */
OrganizationAttributesLogo.prototype['150'] = undefined;
...
export default OrganizationAttributesLogo;
