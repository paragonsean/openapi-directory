...
/**
 * The OrganizationAttributesIcon model module.
 * @module model/OrganizationAttributesIcon
 * @version 2017-08-24
 */
class OrganizationAttributesIcon {
    /**
     * Constructs a new <code>OrganizationAttributesIcon</code>.
     * Links to organization icons
     * @alias module:model/OrganizationAttributesIcon
     */
    constructor() { 
        
        OrganizationAttributesIcon.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationAttributesIcon</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationAttributesIcon} obj Optional instance to populate.
     * @return {module:model/OrganizationAttributesIcon} The populated <code>OrganizationAttributesIcon</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationAttributesIcon();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationAttributesIcon</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationAttributesIcon</code>.
     */
 ...
 * @member {String} 16
 */
OrganizationAttributesIcon.prototype['16'] = undefined;

/**
 * 32x32 icon
 * @member {String} 32
 */
OrganizationAttributesIcon.prototype['32'] = undefined;

/**
 * 64x64 icon
 * @member {String} 64
 */
OrganizationAttributesIcon.prototype['64'] = undefined;
...
export default OrganizationAttributesIcon;
