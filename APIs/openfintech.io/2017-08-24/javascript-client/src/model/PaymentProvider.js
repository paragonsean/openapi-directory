...
import PaymentProviderRelationships from './PaymentProviderRelationships';
...
class PaymentProvider {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = PaymentProviderAttributes.constructFromObject(data['attributes']);
            }
            ...
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = PaymentProviderRelationships.constructFromObject(data['relationships']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentProvider</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentProvider</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          PaymentProviderAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          PaymentProviderRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/PaymentProviderAttributes} attributes
 */
PaymentProvider.prototype['attributes'] = undefined;
 ...
 */
PaymentProvider.prototype['links'] = undefined;

/**
 * @member {module:model/PaymentProviderRelationships} relationships
 */
PaymentProvider.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
PaymentProvider.prototype['type'] = undefined;
