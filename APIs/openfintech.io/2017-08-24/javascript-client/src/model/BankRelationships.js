...
import BankOrganization from './BankOrganization';

/**
 * The BankRelationships model module.
 * @module model/BankRelationships
 * @version 2017-08-24
 */
class BankRelationships {
    /**
     * Constructs a new <code>BankRelationships</code>.
     * @alias module:model/BankRelationships
     */
    constructor() { 
        
        BankRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BankRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BankRelationships} obj Optional instance to populate.
     * @return {module:model/BankRelationships} The populated <code>BankRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BankRelationships();

            if (data.hasOwnProperty('organization')) {
                obj['organization'] = BankOrganization.constructFromObject(data['organization']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BankRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BankRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `organization`
        if (data['organization']) { // data not null
          BankOrganization.validateJSON(data['organization']);
        }
...
/**
 * @member {module:model/BankOrganization} organization
 */
BankRelationships.prototype['organization'] = undefined;
...
export default BankRelationships;
