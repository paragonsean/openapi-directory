...
/**
 * The PaymentMethodProcessorLinks model module.
 * @module model/PaymentMethodProcessorLinks
 * @version 2017-08-24
 */
class PaymentMethodProcessorLinks {
    /**
     * Constructs a new <code>PaymentMethodProcessorLinks</code>.
     * @alias module:model/PaymentMethodProcessorLinks
     */
    constructor() { 
        
        PaymentMethodProcessorLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentMethodProcessorLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentMethodProcessorLinks} obj Optional instance to populate.
     * @return {module:model/PaymentMethodProcessorLinks} The populated <code>PaymentMethodProcessorLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentMethodProcessorLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentMethodProcessorLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentMethodProcessorLinks</code>.
     */
 ...
 */
PaymentMethodProcessorLinks.prototype['related'] = undefined;
...
export default PaymentMethodProcessorLinks;
