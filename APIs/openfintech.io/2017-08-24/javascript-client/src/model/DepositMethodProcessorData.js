...
import DepositMethodProcessorDataDataInner from './DepositMethodProcessorDataDataInner';
import DepositMethodProcessorDataLinks from './DepositMethodProcessorDataLinks';

/**
 * The DepositMethodProcessorData model module.
 * @module model/DepositMethodProcessorData
 * @version 2017-08-24
 */
class DepositMethodProcessorData {
    /**
     * Constructs a new <code>DepositMethodProcessorData</code>.
     * Processor&#x60;s Data.
     * @alias module:model/DepositMethodProcessorData
     */
    constructor() { 
        
        DepositMethodProcessorData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DepositMethodProcessorData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DepositMethodProcessorData} obj Optional instance to populate.
     * @return {module:model/DepositMethodProcessorData} The populated <code>DepositMethodProcessorData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DepositMethodProcessorData();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [DepositMethodProcessorDataDataInner]);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = DepositMethodProcessorDataLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DepositMethodProcessorData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DepositMethodProcessorData</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                DepositMethodProcessorDataDataInner.validateJSON(item);
            };
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          DepositMethodProcessorDataLinks.validateJSON(data['links']);
        }
...
/**
 * @member {Array.<module:model/DepositMethodProcessorDataDataInner>} data
 */
DepositMethodProcessorData.prototype['data'] = undefined;

/**
 * @member {module:model/DepositMethodProcessorDataLinks} links
 */
DepositMethodProcessorData.prototype['links'] = undefined;
...
export default DepositMethodProcessorData;
