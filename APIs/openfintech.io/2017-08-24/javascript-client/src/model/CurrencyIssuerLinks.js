...
/**
 * The CurrencyIssuerLinks model module.
 * @module model/CurrencyIssuerLinks
 * @version 2017-08-24
 */
class CurrencyIssuerLinks {
    /**
     * Constructs a new <code>CurrencyIssuerLinks</code>.
     * @alias module:model/CurrencyIssuerLinks
     */
    constructor() { 
        
        CurrencyIssuerLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyIssuerLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyIssuerLinks} obj Optional instance to populate.
     * @return {module:model/CurrencyIssuerLinks} The populated <code>CurrencyIssuerLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyIssuerLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyIssuerLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyIssuerLinks</code>.
     */
 ...
 */
CurrencyIssuerLinks.prototype['related'] = undefined;
...
export default CurrencyIssuerLinks;
