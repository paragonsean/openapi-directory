...
/**
 * The OrganizationActiveLinks model module.
 * @module model/OrganizationActiveLinks
 * @version 2017-08-24
 */
class OrganizationActiveLinks {
    /**
     * Constructs a new <code>OrganizationActiveLinks</code>.
     * @alias module:model/OrganizationActiveLinks
     */
    constructor() { 
        
        OrganizationActiveLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationActiveLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationActiveLinks} obj Optional instance to populate.
     * @return {module:model/OrganizationActiveLinks} The populated <code>OrganizationActiveLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationActiveLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationActiveLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationActiveLinks</code>.
     */
 ...
 */
OrganizationActiveLinks.prototype['related'] = undefined;
...
export default OrganizationActiveLinks;
