...
class OrganizationsResponse {
    ...
    constructor() { 
        ...
        OrganizationsResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Organization]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationsResponse</code>.
     */
...
/**
 * @member {Array.<module:model/Organization>} data
 */
OrganizationsResponse.prototype['data'] = undefined;

/**
 * @member {module:model/ResponseLinks} links
 */
OrganizationsResponse.prototype['links'] = undefined;

/**
 * @member {module:model/ResponseMeta} meta
 */
OrganizationsResponse.prototype['meta'] = undefined;
...
export default OrganizationsResponse;
