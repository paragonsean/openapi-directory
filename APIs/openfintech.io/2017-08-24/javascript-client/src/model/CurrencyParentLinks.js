...
/**
 * The CurrencyParentLinks model module.
 * @module model/CurrencyParentLinks
 * @version 2017-08-24
 */
class CurrencyParentLinks {
    /**
     * Constructs a new <code>CurrencyParentLinks</code>.
     * @alias module:model/CurrencyParentLinks
     */
    constructor() { 
        
        CurrencyParentLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyParentLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyParentLinks} obj Optional instance to populate.
     * @return {module:model/CurrencyParentLinks} The populated <code>CurrencyParentLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyParentLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyParentLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyParentLinks</code>.
     */
 ...
 */
CurrencyParentLinks.prototype['related'] = undefined;
...
export default CurrencyParentLinks;
