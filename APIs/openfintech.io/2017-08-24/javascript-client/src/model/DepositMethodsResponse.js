...
/**
 * The DepositMethodsResponse model module.
 * @module model/DepositMethodsResponse
 * @version 2017-08-24
 */
class DepositMethodsResponse {
    /**
     * Constructs a new <code>DepositMethodsResponse</code>.
     * @alias module:model/DepositMethodsResponse
     */
    constructor() { 
        
        DepositMethodsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DepositMethodsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DepositMethodsResponse} obj Optional instance to populate.
     * @return {module:model/DepositMethodsResponse} The populated <code>DepositMethodsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DepositMethodsResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [DepositMethod]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DepositMethodsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DepositMethodsResponse</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                DepositMethod.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/DepositMethod>} data
 */
DepositMethodsResponse.prototype['data'] = undefined;

/**
 * @member {module:model/ResponseLinks} links
 */
DepositMethodsResponse.prototype['links'] = undefined;

/**
 * @member {module:model/ResponseMeta} meta
 */
DepositMethodsResponse.prototype['meta'] = undefined;
...
export default DepositMethodsResponse;
