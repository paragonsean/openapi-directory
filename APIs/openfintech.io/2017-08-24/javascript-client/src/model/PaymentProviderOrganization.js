...
import PaymentProviderOrganizationData from './PaymentProviderOrganizationData';
import PaymentProviderOrganizationLinks from './PaymentProviderOrganizationLinks';

/**
 * The PaymentProviderOrganization model module.
 * @module model/PaymentProviderOrganization
 * @version 2017-08-24
 */
class PaymentProviderOrganization {
    /**
     * Constructs a new <code>PaymentProviderOrganization</code>.
     * @alias module:model/PaymentProviderOrganization
     */
    constructor() { 
        
        PaymentProviderOrganization.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentProviderOrganization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentProviderOrganization} obj Optional instance to populate.
     * @return {module:model/PaymentProviderOrganization} The populated <code>PaymentProviderOrganization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentProviderOrganization();

            if (data.hasOwnProperty('data')) {
                obj['data'] = PaymentProviderOrganizationData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = PaymentProviderOrganizationLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentProviderOrganization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentProviderOrganization</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          PaymentProviderOrganizationData.validateJSON(data['data']);
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          PaymentProviderOrganizationLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/PaymentProviderOrganizationData} data
 */
PaymentProviderOrganization.prototype['data'] = undefined;

/**
 * @member {module:model/PaymentProviderOrganizationLinks} links
 */
PaymentProviderOrganization.prototype['links'] = undefined;
...
export default PaymentProviderOrganization;
