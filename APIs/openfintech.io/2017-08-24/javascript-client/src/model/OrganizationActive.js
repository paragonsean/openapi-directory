...
import OrganizationActiveLinks from './OrganizationActiveLinks';

/**
 * The OrganizationActive model module.
 * @module model/OrganizationActive
 * @version 2017-08-24
 */
class OrganizationActive {
    /**
     * Constructs a new <code>OrganizationActive</code>.
     * @alias module:model/OrganizationActive
     */
    constructor() { 
        
        OrganizationActive.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationActive</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationActive} obj Optional instance to populate.
     * @return {module:model/OrganizationActive} The populated <code>OrganizationActive</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationActive();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], ['String']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = OrganizationActiveLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationActive</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationActive</code>.
     */
    static validateJSON(data) {
        ...
        if (data['links']) { // data not null
          OrganizationActiveLinks.validateJSON(data['links']);
        }
 ...
 */
OrganizationActive.prototype['data'] = undefined;

/**
 * @member {module:model/OrganizationActiveLinks} links
 */
OrganizationActive.prototype['links'] = undefined;
...
export default OrganizationActive;
