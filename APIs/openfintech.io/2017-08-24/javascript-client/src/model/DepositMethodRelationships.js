...
import ActiveInCountriesRelationship from './ActiveInCountriesRelationship';
import CurrencyParent from './CurrencyParent';
import DepositMethodProcessorData from './DepositMethodProcessorData';
import SupportedPspsRelationship from './SupportedPspsRelationship';

/**
 * The DepositMethodRelationships model module.
 * @module model/DepositMethodRelationships
 * @version 2017-08-24
 */
class DepositMethodRelationships {
    /**
     * Constructs a new <code>DepositMethodRelationships</code>.
     * @alias module:model/DepositMethodRelationships
     */
    constructor() { 
        
        DepositMethodRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DepositMethodRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DepositMethodRelationships} obj Optional instance to populate.
     * @return {module:model/DepositMethodRelationships} The populated <code>DepositMethodRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DepositMethodRelationships();

            if (data.hasOwnProperty('actiove_in_countries')) {
                obj['actiove_in_countries'] = ActiveInCountriesRelationship.constructFromObject(data['actiove_in_countries']);
            }
            if (data.hasOwnProperty('currencies')) {
                obj['currencies'] = CurrencyParent.constructFromObject(data['currencies']);
            }
            if (data.hasOwnProperty('payment_processor')) {
                obj['payment_processor'] = DepositMethodProcessorData.constructFromObject(data['payment_processor']);
            }
            if (data.hasOwnProperty('supported_psps')) {
                obj['supported_psps'] = SupportedPspsRelationship.constructFromObject(data['supported_psps']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DepositMethodRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DepositMethodRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `actiove_in_countries`
        if (data['actiove_in_countries']) { // data not null
          ActiveInCountriesRelationship.validateJSON(data['actiove_in_countries']);
        }
        // validate the optional field `currencies`
        if (data['currencies']) { // data not null
          CurrencyParent.validateJSON(data['currencies']);
        }
        // validate the optional field `payment_processor`
        if (data['payment_processor']) { // data not null
          DepositMethodProcessorData.validateJSON(data['payment_processor']);
        }
        // validate the optional field `supported_psps`
        if (data['supported_psps']) { // data not null
          SupportedPspsRelationship.validateJSON(data['supported_psps']);
        }
...
/**
 * @member {module:model/ActiveInCountriesRelationship} actiove_in_countries
 */
DepositMethodRelationships.prototype['actiove_in_countries'] = undefined;

/**
 * @member {module:model/CurrencyParent} currencies
 */
DepositMethodRelationships.prototype['currencies'] = undefined;

/**
 * @member {module:model/DepositMethodProcessorData} payment_processor
 */
DepositMethodRelationships.prototype['payment_processor'] = undefined;

/**
 * @member {module:model/SupportedPspsRelationship} supported_psps
 */
DepositMethodRelationships.prototype['supported_psps'] = undefined;
...
export default DepositMethodRelationships;
