...
/**
 * The PaymentProviderAttributes model module.
 * @module model/PaymentProviderAttributes
 * @version 2017-08-24
 */
class PaymentProviderAttributes {
    /**
     * Constructs a new <code>PaymentProviderAttributes</code>.
     * Array of Payment-provider attributes
     * @alias module:model/PaymentProviderAttributes
     */
    constructor() { 
        
        PaymentProviderAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentProviderAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentProviderAttributes} obj Optional instance to populate.
     * @return {module:model/PaymentProviderAttributes} The populated <code>PaymentProviderAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentProviderAttributes();
            ...
            if (data.hasOwnProperty('sales_channels')) {
                obj['sales_channels'] = ApiClient.convertToType(data['sales_channels'], ['String']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentProviderAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentProviderAttributes</code>.
     */
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['sales_channels'])) {
            throw new Error("Expected the field `sales_channels` to be an array in the JSON data but got " + data['sales_channels']);
        }
        // ensure the json data is an array
 ...
 * @member {String} code
 */
PaymentProviderAttributes.prototype['code'] = undefined;

/**
 * @member {Array.<String>} features
 */
PaymentProviderAttributes.prototype['features'] = undefined;

/**
 * Payment-provider`s name
 * @member {String} name
 */
PaymentProviderAttributes.prototype['name'] = undefined;

/**
 * @member {Array.<String>} sales_channels
 */
PaymentProviderAttributes.prototype['sales_channels'] = undefined;

/**
 * @member {Array.<String>} types
 */
PaymentProviderAttributes.prototype['types'] = undefined;
...
export default PaymentProviderAttributes;
