...
/**
 * The DepositMethodProcessorDataDataInner model module.
 * @module model/DepositMethodProcessorDataDataInner
 * @version 2017-08-24
 */
class DepositMethodProcessorDataDataInner {
    /**
     * Constructs a new <code>DepositMethodProcessorDataDataInner</code>.
     * @alias module:model/DepositMethodProcessorDataDataInner
     */
    constructor() { 
        
        DepositMethodProcessorDataDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DepositMethodProcessorDataDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DepositMethodProcessorDataDataInner} obj Optional instance to populate.
     * @return {module:model/DepositMethodProcessorDataDataInner} The populated <code>DepositMethodProcessorDataDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DepositMethodProcessorDataDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>DepositMethodProcessorDataDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DepositMethodProcessorDataDataInner</code>.
     */
 ...
 * @member {String} id
 */
DepositMethodProcessorDataDataInner.prototype['id'] = undefined;

/**
 * Processor`s type.
 * @member {String} type
 */
DepositMethodProcessorDataDataInner.prototype['type'] = undefined;
...
export default DepositMethodProcessorDataDataInner;
