...
/**
 * The PaymentMethodCurrenciesLinks model module.
 * @module model/PaymentMethodCurrenciesLinks
 * @version 2017-08-24
 */
class PaymentMethodCurrenciesLinks {
    /**
     * Constructs a new <code>PaymentMethodCurrenciesLinks</code>.
     * @alias module:model/PaymentMethodCurrenciesLinks
     */
    constructor() { 
        
        PaymentMethodCurrenciesLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentMethodCurrenciesLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentMethodCurrenciesLinks} obj Optional instance to populate.
     * @return {module:model/PaymentMethodCurrenciesLinks} The populated <code>PaymentMethodCurrenciesLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentMethodCurrenciesLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentMethodCurrenciesLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentMethodCurrenciesLinks</code>.
     */
 ...
 */
PaymentMethodCurrenciesLinks.prototype['related'] = undefined;
...
export default PaymentMethodCurrenciesLinks;
