...
/**
 * The PaymentProvidersResponse model module.
 * @module model/PaymentProvidersResponse
 * @version 2017-08-24
 */
class PaymentProvidersResponse {
    /**
     * Constructs a new <code>PaymentProvidersResponse</code>.
     * @alias module:model/PaymentProvidersResponse
     */
    constructor() { 
        
        PaymentProvidersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentProvidersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentProvidersResponse} obj Optional instance to populate.
     * @return {module:model/PaymentProvidersResponse} The populated <code>PaymentProvidersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentProvidersResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentProvidersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentProvidersResponse</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                PaymentProvider.validateJSON(item);
            };
        }
 ...
 */
PaymentProvidersResponse.prototype['data'] = undefined;

/**
 * @member {module:model/ResponseLinks} links
 */
PaymentProvidersResponse.prototype['links'] = undefined;

/**
 * @member {module:model/ResponseMeta} meta
 */
PaymentProvidersResponse.prototype['meta'] = undefined;
...
export default PaymentProvidersResponse;
