...
import CurrencyIssuerLinks from './CurrencyIssuerLinks';
import CurrencyIssuertData from './CurrencyIssuertData';

/**
 * The CurrencyIssuer model module.
 * @module model/CurrencyIssuer
 * @version 2017-08-24
 */
class CurrencyIssuer {
    /**
     * Constructs a new <code>CurrencyIssuer</code>.
     * Currency Issuer. &#39;Only for virtual currency&#39; 
     * @alias module:model/CurrencyIssuer
     */
    constructor() { 
        
        CurrencyIssuer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyIssuer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyIssuer} obj Optional instance to populate.
     * @return {module:model/CurrencyIssuer} The populated <code>CurrencyIssuer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyIssuer();

            if (data.hasOwnProperty('data')) {
                obj['data'] = CurrencyIssuertData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = CurrencyIssuerLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyIssuer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyIssuer</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          CurrencyIssuertData.validateJSON(data['data']);
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          CurrencyIssuerLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/CurrencyIssuertData} data
 */
CurrencyIssuer.prototype['data'] = undefined;

/**
 * @member {module:model/CurrencyIssuerLinks} links
 */
CurrencyIssuer.prototype['links'] = undefined;
