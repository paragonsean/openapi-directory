...
/**
 * The SupportedPspsRelationshipLinks model module.
 * @module model/SupportedPspsRelationshipLinks
 * @version 2017-08-24
 */
class SupportedPspsRelationshipLinks {
    /**
     * Constructs a new <code>SupportedPspsRelationshipLinks</code>.
     * @alias module:model/SupportedPspsRelationshipLinks
     */
    constructor() { 
        
        SupportedPspsRelationshipLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SupportedPspsRelationshipLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SupportedPspsRelationshipLinks} obj Optional instance to populate.
     * @return {module:model/SupportedPspsRelationshipLinks} The populated <code>SupportedPspsRelationshipLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SupportedPspsRelationshipLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>SupportedPspsRelationshipLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SupportedPspsRelationshipLinks</code>.
     */
 ...
 */
SupportedPspsRelationshipLinks.prototype['related'] = undefined;
...
export default SupportedPspsRelationshipLinks;
