...
import ExchangerOrganizationData from './ExchangerOrganizationData';
import ExchangerOrganizationLinks from './ExchangerOrganizationLinks';

/**
 * The ExchangerOrganization model module.
 * @module model/ExchangerOrganization
 * @version 2017-08-24
 */
class ExchangerOrganization {
    /**
     * Constructs a new <code>ExchangerOrganization</code>.
     * @alias module:model/ExchangerOrganization
     */
    constructor() { 
        
        ExchangerOrganization.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExchangerOrganization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangerOrganization} obj Optional instance to populate.
     * @return {module:model/ExchangerOrganization} The populated <code>ExchangerOrganization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangerOrganization();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ExchangerOrganizationData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = ExchangerOrganizationLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangerOrganization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangerOrganization</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ExchangerOrganizationData.validateJSON(data['data']);
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          ExchangerOrganizationLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/ExchangerOrganizationData} data
 */
ExchangerOrganization.prototype['data'] = undefined;

/**
 * @member {module:model/ExchangerOrganizationLinks} links
 */
ExchangerOrganization.prototype['links'] = undefined;
...
export default ExchangerOrganization;
