...
/**
 * The ExchangerResponse model module.
 * @module model/ExchangerResponse
 * @version 2017-08-24
 */
class ExchangerResponse {
    /**
     * Constructs a new <code>ExchangerResponse</code>.
     * @alias module:model/ExchangerResponse
     */
    constructor() { 
        
        ExchangerResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExchangerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangerResponse} obj Optional instance to populate.
     * @return {module:model/ExchangerResponse} The populated <code>ExchangerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangerResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = Exchanger.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangerResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          Exchanger.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/Exchanger} data
 */
ExchangerResponse.prototype['data'] = undefined;
...
export default ExchangerResponse;
