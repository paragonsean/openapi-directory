...
/**
 * The CurrencyIssuerOrganizationData model module.
 * @module model/CurrencyIssuerOrganizationData
 * @version 2017-08-24
 */
class CurrencyIssuerOrganizationData {
    /**
     * Constructs a new <code>CurrencyIssuerOrganizationData</code>.
     * @alias module:model/CurrencyIssuerOrganizationData
     */
    constructor() { 
        
        CurrencyIssuerOrganizationData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyIssuerOrganizationData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyIssuerOrganizationData} obj Optional instance to populate.
     * @return {module:model/CurrencyIssuerOrganizationData} The populated <code>CurrencyIssuerOrganizationData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyIssuerOrganizationData();
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyIssuerOrganizationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyIssuerOrganizationData</code>.
     */
 ...
 * @member {String} id
 */
CurrencyIssuerOrganizationData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
CurrencyIssuerOrganizationData.prototype['type'] = undefined;
...
export default CurrencyIssuerOrganizationData;
