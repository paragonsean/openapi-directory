...
/**
 * The ResponseLinks model module.
 * @module model/ResponseLinks
 * @version 2017-08-24
 */
class ResponseLinks {
    /**
     * Constructs a new <code>ResponseLinks</code>.
     * @alias module:model/ResponseLinks
     * @param first {String} first page of query
     * @param last {String} last page of query
     */
    constructor(first, last) { 
        
        ResponseLinks.initialize(this, first, last);
    }
    ...
    /**
     * Constructs a <code>ResponseLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseLinks} obj Optional instance to populate.
     * @return {module:model/ResponseLinks} The populated <code>ResponseLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseLinks</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ResponseLinks.RequiredProperties) {
...
ResponseLinks.RequiredProperties = ["first", "last"];

/**
 * first page of query
 * @member {String} first
 */
ResponseLinks.prototype['first'] = undefined;

/**
 * last page of query
 * @member {String} last
 */
ResponseLinks.prototype['last'] = undefined;

/**
 * next page in query
 * @member {String} next
 */
ResponseLinks.prototype['next'] = undefined;

/**
 * previous page in query
 * @member {String} prev
 */
ResponseLinks.prototype['prev'] = undefined;
