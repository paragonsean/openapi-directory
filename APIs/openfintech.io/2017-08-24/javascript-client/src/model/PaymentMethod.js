...
import PaymentMethodAttributes from './PaymentMethodAttributes';
import PaymentMethodRelationships from './PaymentMethodRelationships';
...
class PaymentMethod {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = PaymentMethodAttributes.constructFromObject(data['attributes']);
            }
            ...
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = PaymentMethodRelationships.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          PaymentMethodAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          PaymentMethodRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/PaymentMethodAttributes} attributes
 */
PaymentMethod.prototype['attributes'] = undefined;
 ...
 */
PaymentMethod.prototype['links'] = undefined;

/**
 * @member {module:model/PaymentMethodRelationships} relationships
 */
PaymentMethod.prototype['relationships'] = undefined;
