...
import BankAttributes from './BankAttributes';
import BankRelationships from './BankRelationships';
...
class Bank {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = BankAttributes.constructFromObject(data['attributes']);
            }
            ...
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = BankRelationships.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          BankAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          BankRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/BankAttributes} attributes
 */
Bank.prototype['attributes'] = undefined;

/**
 * Bank`s ID
 * @member {String} id
 */
Bank.prototype['id'] = undefined;

/**
 * @member {module:model/SelfLinks} links
 */
Bank.prototype['links'] = undefined;

/**
 * @member {module:model/BankRelationships} relationships
 */
Bank.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
Bank.prototype['type'] = undefined;
