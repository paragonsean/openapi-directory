...
import ExchangerOrganization from './ExchangerOrganization';

/**
 * The ExchangerRelationships model module.
 * @module model/ExchangerRelationships
 * @version 2017-08-24
 */
class ExchangerRelationships {
    /**
     * Constructs a new <code>ExchangerRelationships</code>.
     * @alias module:model/ExchangerRelationships
     */
    constructor() { 
        
        ExchangerRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExchangerRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangerRelationships} obj Optional instance to populate.
     * @return {module:model/ExchangerRelationships} The populated <code>ExchangerRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangerRelationships();

            if (data.hasOwnProperty('organization')) {
                obj['organization'] = ExchangerOrganization.constructFromObject(data['organization']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangerRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangerRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `organization`
        if (data['organization']) { // data not null
          ExchangerOrganization.validateJSON(data['organization']);
        }
...
/**
 * @member {module:model/ExchangerOrganization} organization
 */
ExchangerRelationships.prototype['organization'] = undefined;
...
export default ExchangerRelationships;
