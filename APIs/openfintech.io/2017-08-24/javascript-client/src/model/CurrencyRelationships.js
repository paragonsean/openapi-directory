...
import CurrencyIssuerOrganization from './CurrencyIssuerOrganization';
import CurrencyParent from './CurrencyParent';

/**
 * The CurrencyRelationships model module.
 * @module model/CurrencyRelationships
 * @version 2017-08-24
 */
class CurrencyRelationships {
    /**
     * Constructs a new <code>CurrencyRelationships</code>.
     * @alias module:model/CurrencyRelationships
     */
    constructor() { 
        
        CurrencyRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyRelationships} obj Optional instance to populate.
     * @return {module:model/CurrencyRelationships} The populated <code>CurrencyRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyRelationships();

            if (data.hasOwnProperty('countries')) {
                obj['countries'] = CurrencyCountries.constructFromObject(data['countries']);
            }
            if (data.hasOwnProperty('issuer')) {
                obj['issuer'] = CurrencyIssuer.constructFromObject(data['issuer']);
            }
            if (data.hasOwnProperty('issuer_organization')) {
                obj['issuer_organization'] = CurrencyIssuerOrganization.constructFromObject(data['issuer_organization']);
            }
            if (data.hasOwnProperty('parent')) {
                obj['parent'] = CurrencyParent.constructFromObject(data['parent']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `countries`
        if (data['countries']) { // data not null
          CurrencyCountries.validateJSON(data['countries']);
        }
        // validate the optional field `issuer`
        if (data['issuer']) { // data not null
          CurrencyIssuer.validateJSON(data['issuer']);
        }
        // validate the optional field `issuer_organization`
        if (data['issuer_organization']) { // data not null
          CurrencyIssuerOrganization.validateJSON(data['issuer_organization']);
        }
        // validate the optional field `parent`
        if (data['parent']) { // data not null
          CurrencyParent.validateJSON(data['parent']);
        }
...
/**
 * @member {module:model/CurrencyCountries} countries
 */
CurrencyRelationships.prototype['countries'] = undefined;

/**
 * @member {module:model/CurrencyIssuer} issuer
 */
CurrencyRelationships.prototype['issuer'] = undefined;

/**
 * @member {module:model/CurrencyIssuerOrganization} issuer_organization
 */
CurrencyRelationships.prototype['issuer_organization'] = undefined;

/**
 * @member {module:model/CurrencyParent} parent
 */
CurrencyRelationships.prototype['parent'] = undefined;
...
export default CurrencyRelationships;
