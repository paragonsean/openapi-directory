...
/**
 * The BankOrganizationLinks model module.
 * @module model/BankOrganizationLinks
 * @version 2017-08-24
 */
class BankOrganizationLinks {
    /**
     * Constructs a new <code>BankOrganizationLinks</code>.
     * @alias module:model/BankOrganizationLinks
     */
    constructor() { 
        
        BankOrganizationLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BankOrganizationLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BankOrganizationLinks} obj Optional instance to populate.
     * @return {module:model/BankOrganizationLinks} The populated <code>BankOrganizationLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BankOrganizationLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>BankOrganizationLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BankOrganizationLinks</code>.
     */
 ...
 */
BankOrganizationLinks.prototype['related'] = undefined;
...
export default BankOrganizationLinks;
