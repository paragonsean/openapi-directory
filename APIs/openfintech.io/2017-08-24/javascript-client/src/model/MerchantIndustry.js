...
import MerchantIndustryAttributes from './MerchantIndustryAttributes';

/**
 * The MerchantIndustry model module.
 * @module model/MerchantIndustry
 * @version 2017-08-24
 */
class MerchantIndustry {
    /**
     * Constructs a new <code>MerchantIndustry</code>.
     * @alias module:model/MerchantIndustry
     */
    constructor() { 
        
        MerchantIndustry.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MerchantIndustry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MerchantIndustry} obj Optional instance to populate.
     * @return {module:model/MerchantIndustry} The populated <code>MerchantIndustry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MerchantIndustry();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = MerchantIndustryAttributes.constructFromObject(data['attributes']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MerchantIndustry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MerchantIndustry</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          MerchantIndustryAttributes.validateJSON(data['attributes']);
        }
...
/**
 * @member {module:model/MerchantIndustryAttributes} attributes
 */
MerchantIndustry.prototype['attributes'] = undefined;

/**
 * Merchant-industry`s ID
 * @member {String} id
 */
MerchantIndustry.prototype['id'] = undefined;

/**
 * @member {String} type
 */
MerchantIndustry.prototype['type'] = undefined;
...
export default MerchantIndustry;
