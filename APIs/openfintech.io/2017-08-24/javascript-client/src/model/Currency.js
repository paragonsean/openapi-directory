...
import CurrencyRelationships from './CurrencyRelationships';
...
class Currency {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = CurrencyAttributes.constructFromObject(data['attributes']);
            }
            ...
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = CurrencyRelationships.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          CurrencyAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          CurrencyRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/CurrencyAttributes} attributes
 */
Currency.prototype['attributes'] = undefined;
 ...
 */
Currency.prototype['links'] = undefined;

/**
 * @member {module:model/CurrencyRelationships} relationships
 */
Currency.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
Currency.prototype['type'] = undefined;
