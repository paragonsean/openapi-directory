...
/**
 * The CurrencyParentData model module.
 * @module model/CurrencyParentData
 * @version 2017-08-24
 */
class CurrencyParentData {
    /**
     * Constructs a new <code>CurrencyParentData</code>.
     * @alias module:model/CurrencyParentData
     */
    constructor() { 
        
        CurrencyParentData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyParentData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyParentData} obj Optional instance to populate.
     * @return {module:model/CurrencyParentData} The populated <code>CurrencyParentData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyParentData();
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyParentData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyParentData</code>.
     */
 ...
 * @member {String} id
 */
CurrencyParentData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
CurrencyParentData.prototype['type'] = undefined;
...
export default CurrencyParentData;
