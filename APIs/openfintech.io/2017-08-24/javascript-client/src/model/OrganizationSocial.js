...
/**
 * The OrganizationSocial model module.
 * @module model/OrganizationSocial
 * @version 2017-08-24
 */
class OrganizationSocial {
    /**
     * Constructs a new <code>OrganizationSocial</code>.
     * Social profiles
     * @alias module:model/OrganizationSocial
     */
    constructor() { 
        
        OrganizationSocial.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationSocial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationSocial} obj Optional instance to populate.
     * @return {module:model/OrganizationSocial} The populated <code>OrganizationSocial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationSocial();
            ...
            if (data.hasOwnProperty('vkontakte')) {
                obj['vkontakte'] = ApiClient.convertToType(data['vkontakte'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationSocial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationSocial</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['vkontakte'] && !(typeof data['vkontakte'] === 'string' || data['vkontakte'] instanceof String)) {
            throw new Error("Expected the field `vkontakte` to be a primitive type in the JSON string but got " + data['vkontakte']);
        }
 ...
 */
OrganizationSocial.prototype['facebook'] = undefined;

/**
 * @member {String} google_plus
 */
OrganizationSocial.prototype['google_plus'] = undefined;

/**
 * @member {String} linked_in
 */
OrganizationSocial.prototype['linked_in'] = undefined;

/**
 * @member {String} twitter
 */
OrganizationSocial.prototype['twitter'] = undefined;

/**
 * @member {String} vkontakte
 */
OrganizationSocial.prototype['vkontakte'] = undefined;
