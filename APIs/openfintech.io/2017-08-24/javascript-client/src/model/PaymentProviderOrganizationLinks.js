...
/**
 * The PaymentProviderOrganizationLinks model module.
 * @module model/PaymentProviderOrganizationLinks
 * @version 2017-08-24
 */
class PaymentProviderOrganizationLinks {
    /**
     * Constructs a new <code>PaymentProviderOrganizationLinks</code>.
     * @alias module:model/PaymentProviderOrganizationLinks
     */
    constructor() { 
        
        PaymentProviderOrganizationLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentProviderOrganizationLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentProviderOrganizationLinks} obj Optional instance to populate.
     * @return {module:model/PaymentProviderOrganizationLinks} The populated <code>PaymentProviderOrganizationLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentProviderOrganizationLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentProviderOrganizationLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentProviderOrganizationLinks</code>.
     */
 ...
 */
PaymentProviderOrganizationLinks.prototype['related'] = undefined;
...
export default PaymentProviderOrganizationLinks;
