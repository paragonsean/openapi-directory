...
/**
 * The ExchangerAttributes model module.
 * @module model/ExchangerAttributes
 * @version 2017-08-24
 */
class ExchangerAttributes {
    /**
     * Constructs a new <code>ExchangerAttributes</code>.
     * @alias module:model/ExchangerAttributes
     */
    constructor() { 
        
        ExchangerAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExchangerAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangerAttributes} obj Optional instance to populate.
     * @return {module:model/ExchangerAttributes} The populated <code>ExchangerAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangerAttributes();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('rates_export_standard')) {
                obj['rates_export_standard'] = ApiClient.convertToType(data['rates_export_standard'], 'String');
            }
            if (data.hasOwnProperty('rates_export_url')) {
                obj['rates_export_url'] = ApiClient.convertToType(data['rates_export_url'], 'String');
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], 'String');
            }
            if (data.hasOwnProperty('wmid')) {
                obj['wmid'] = ApiClient.convertToType(data['wmid'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangerAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangerAttributes</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['rates_export_standard'] && !(typeof data['rates_export_standard'] === 'string' || data['rates_export_standard'] instanceof String)) {
            throw new Error("Expected the field `rates_export_standard` to be a primitive type in the JSON string but got " + data['rates_export_standard']);
        }
        // ensure the json data is a string
        if (data['rates_export_url'] && !(typeof data['rates_export_url'] === 'string' || data['rates_export_url'] instanceof String)) {
            throw new Error("Expected the field `rates_export_url` to be a primitive type in the JSON string but got " + data['rates_export_url']);
        }
        // ensure the json data is a string
 ...
 * @member {String} name
 */
ExchangerAttributes.prototype['name'] = undefined;

/**
 * @member {String} rates_export_standard
 */
ExchangerAttributes.prototype['rates_export_standard'] = undefined;

/**
 * @member {String} rates_export_url
 */
ExchangerAttributes.prototype['rates_export_url'] = undefined;

/**
 * Exchanger`s status [active, blocked, deleted]
 * @member {String} status
 */
ExchangerAttributes.prototype['status'] = undefined;

/**
 * Exchanger`s WebMoney ID
 * @member {Number} wmid
 */
ExchangerAttributes.prototype['wmid'] = undefined;
...
export default ExchangerAttributes;
