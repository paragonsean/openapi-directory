...
import CurrencyParentData from './CurrencyParentData';
import CurrencyParentLinks from './CurrencyParentLinks';

/**
 * The CurrencyParent model module.
 * @module model/CurrencyParent
 * @version 2017-08-24
 */
class CurrencyParent {
    /**
     * Constructs a new <code>CurrencyParent</code>.
     * Parent currency. &#39;Only for virtual currency&#39; 
     * @alias module:model/CurrencyParent
     */
    constructor() { 
        
        CurrencyParent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyParent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyParent} obj Optional instance to populate.
     * @return {module:model/CurrencyParent} The populated <code>CurrencyParent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyParent();

            if (data.hasOwnProperty('data')) {
                obj['data'] = CurrencyParentData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = CurrencyParentLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyParent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyParent</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          CurrencyParentData.validateJSON(data['data']);
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          CurrencyParentLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/CurrencyParentData} data
 */
CurrencyParent.prototype['data'] = undefined;

/**
 * @member {module:model/CurrencyParentLinks} links
 */
CurrencyParent.prototype['links'] = undefined;
