...
import CountryTranslationsLinks from './CountryTranslationsLinks';

/**
 * The CountryTranslations model module.
 * @module model/CountryTranslations
 * @version 2017-08-24
 */
class CountryTranslations {
    /**
     * Constructs a new <code>CountryTranslations</code>.
     * @alias module:model/CountryTranslations
     */
    constructor() { 
        
        CountryTranslations.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CountryTranslations</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CountryTranslations} obj Optional instance to populate.
     * @return {module:model/CountryTranslations} The populated <code>CountryTranslations</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CountryTranslations();

            if (data.hasOwnProperty('links')) {
                obj['links'] = CountryTranslationsLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CountryTranslations</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CountryTranslations</code>.
     */
    static validateJSON(data) {
        // validate the optional field `links`
        if (data['links']) { // data not null
          CountryTranslationsLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/CountryTranslationsLinks} links
 */
CountryTranslations.prototype['links'] = undefined;
