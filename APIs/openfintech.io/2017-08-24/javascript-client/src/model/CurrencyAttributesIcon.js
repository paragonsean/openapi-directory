...
/**
 * The CurrencyAttributesIcon model module.
 * @module model/CurrencyAttributesIcon
 * @version 2017-08-24
 */
class CurrencyAttributesIcon {
    /**
     * Constructs a new <code>CurrencyAttributesIcon</code>.
     * Links to currency icons
     * @alias module:model/CurrencyAttributesIcon
     */
    constructor() { 
        
        CurrencyAttributesIcon.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyAttributesIcon</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyAttributesIcon} obj Optional instance to populate.
     * @return {module:model/CurrencyAttributesIcon} The populated <code>CurrencyAttributesIcon</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyAttributesIcon();
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyAttributesIcon</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyAttributesIcon</code>.
     */
 ...
 * @member {String} 16
 */
CurrencyAttributesIcon.prototype['16'] = undefined;

/**
 * 32x32 icon
 * @member {String} 32
 */
CurrencyAttributesIcon.prototype['32'] = undefined;

/**
 * 64x64 icon
 * @member {String} 64
 */
CurrencyAttributesIcon.prototype['64'] = undefined;
...
export default CurrencyAttributesIcon;
