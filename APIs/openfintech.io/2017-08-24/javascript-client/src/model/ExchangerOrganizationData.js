...
/**
 * The ExchangerOrganizationData model module.
 * @module model/ExchangerOrganizationData
 * @version 2017-08-24
 */
class ExchangerOrganizationData {
    /**
     * Constructs a new <code>ExchangerOrganizationData</code>.
     * @alias module:model/ExchangerOrganizationData
     */
    constructor() { 
        
        ExchangerOrganizationData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExchangerOrganizationData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangerOrganizationData} obj Optional instance to populate.
     * @return {module:model/ExchangerOrganizationData} The populated <code>ExchangerOrganizationData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangerOrganizationData();
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangerOrganizationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangerOrganizationData</code>.
     */
 ...
 * @member {String} id
 */
ExchangerOrganizationData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
ExchangerOrganizationData.prototype['type'] = undefined;
...
export default ExchangerOrganizationData;
