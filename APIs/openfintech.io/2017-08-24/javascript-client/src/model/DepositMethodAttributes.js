...
/**
 * The DepositMethodAttributes model module.
 * @module model/DepositMethodAttributes
 * @version 2017-08-24
 */
class DepositMethodAttributes {
    /**
     * Constructs a new <code>DepositMethodAttributes</code>.
     * Array of Deposit-method attributes
     * @alias module:model/DepositMethodAttributes
     */
    constructor() { 
        
        DepositMethodAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DepositMethodAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DepositMethodAttributes} obj Optional instance to populate.
     * @return {module:model/DepositMethodAttributes} The populated <code>DepositMethodAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DepositMethodAttributes();
    ...
    /**
     * Validates the JSON data with respect to <code>DepositMethodAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DepositMethodAttributes</code>.
     */
 ...
 */
DepositMethodAttributes.prototype['category'] = undefined;

/**
 * Deposit-method`s code
 * @member {String} code
 */
DepositMethodAttributes.prototype['code'] = undefined;

/**
 * Deposit-method`s name
 * @member {String} name
 */
DepositMethodAttributes.prototype['name'] = undefined;

/**
 * Deposit-method`s processor
 * @member {String} processor_name
 */
DepositMethodAttributes.prototype['processor_name'] = undefined;
...
export default DepositMethodAttributes;
