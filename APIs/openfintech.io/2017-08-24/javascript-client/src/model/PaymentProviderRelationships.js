...
import PaymentProviderOrganization from './PaymentProviderOrganization';
import PaymentProviderPaymentMethods from './PaymentProviderPaymentMethods';

/**
 * The PaymentProviderRelationships model module.
 * @module model/PaymentProviderRelationships
 * @version 2017-08-24
 */
class PaymentProviderRelationships {
    /**
     * Constructs a new <code>PaymentProviderRelationships</code>.
     * @alias module:model/PaymentProviderRelationships
     */
    constructor() { 
        
        PaymentProviderRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentProviderRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentProviderRelationships} obj Optional instance to populate.
     * @return {module:model/PaymentProviderRelationships} The populated <code>PaymentProviderRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentProviderRelationships();

            if (data.hasOwnProperty('organization')) {
                obj['organization'] = PaymentProviderOrganization.constructFromObject(data['organization']);
            }
            if (data.hasOwnProperty('payment-methods')) {
                obj['payment-methods'] = PaymentProviderPaymentMethods.constructFromObject(data['payment-methods']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentProviderRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentProviderRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `organization`
        if (data['organization']) { // data not null
          PaymentProviderOrganization.validateJSON(data['organization']);
        }
        // validate the optional field `payment-methods`
        if (data['payment-methods']) { // data not null
          PaymentProviderPaymentMethods.validateJSON(data['payment-methods']);
        }
...
/**
 * @member {module:model/PaymentProviderOrganization} organization
 */
PaymentProviderRelationships.prototype['organization'] = undefined;

/**
 * @member {module:model/PaymentProviderPaymentMethods} payment-methods
 */
PaymentProviderRelationships.prototype['payment-methods'] = undefined;
...
export default PaymentProviderRelationships;
