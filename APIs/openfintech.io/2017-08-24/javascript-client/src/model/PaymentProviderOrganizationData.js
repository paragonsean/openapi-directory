...
/**
 * The PaymentProviderOrganizationData model module.
 * @module model/PaymentProviderOrganizationData
 * @version 2017-08-24
 */
class PaymentProviderOrganizationData {
    /**
     * Constructs a new <code>PaymentProviderOrganizationData</code>.
     * @alias module:model/PaymentProviderOrganizationData
     */
    constructor() { 
        
        PaymentProviderOrganizationData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentProviderOrganizationData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentProviderOrganizationData} obj Optional instance to populate.
     * @return {module:model/PaymentProviderOrganizationData} The populated <code>PaymentProviderOrganizationData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentProviderOrganizationData();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentProviderOrganizationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentProviderOrganizationData</code>.
     */
 ...
 * @member {String} id
 */
PaymentProviderOrganizationData.prototype['id'] = undefined;

/**
 * @member {String} type
 */
PaymentProviderOrganizationData.prototype['type'] = undefined;
...
export default PaymentProviderOrganizationData;
