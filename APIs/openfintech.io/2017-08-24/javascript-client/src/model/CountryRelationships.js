...
/**
 * The CountryRelationships model module.
 * @module model/CountryRelationships
 * @version 2017-08-24
 */
class CountryRelationships {
    /**
     * Constructs a new <code>CountryRelationships</code>.
     * @alias module:model/CountryRelationships
     */
    constructor() { 
        
        CountryRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CountryRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CountryRelationships} obj Optional instance to populate.
     * @return {module:model/CountryRelationships} The populated <code>CountryRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CountryRelationships();

            if (data.hasOwnProperty('translations')) {
                obj['translations'] = CountryTranslations.constructFromObject(data['translations']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CountryRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CountryRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `translations`
        if (data['translations']) { // data not null
          CountryTranslations.validateJSON(data['translations']);
        }
...
/**
 * @member {module:model/CountryTranslations} translations
 */
CountryRelationships.prototype['translations'] = undefined;
...
export default CountryRelationships;
