...
/**
 * The ActiveInCountriesRelationshipLinks model module.
 * @module model/ActiveInCountriesRelationshipLinks
 * @version 2017-08-24
 */
class ActiveInCountriesRelationshipLinks {
    /**
     * Constructs a new <code>ActiveInCountriesRelationshipLinks</code>.
     * @alias module:model/ActiveInCountriesRelationshipLinks
     */
    constructor() { 
        
        ActiveInCountriesRelationshipLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActiveInCountriesRelationshipLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActiveInCountriesRelationshipLinks} obj Optional instance to populate.
     * @return {module:model/ActiveInCountriesRelationshipLinks} The populated <code>ActiveInCountriesRelationshipLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActiveInCountriesRelationshipLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>ActiveInCountriesRelationshipLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActiveInCountriesRelationshipLinks</code>.
     */
 ...
 */
ActiveInCountriesRelationshipLinks.prototype['related'] = undefined;
...
export default ActiveInCountriesRelationshipLinks;
