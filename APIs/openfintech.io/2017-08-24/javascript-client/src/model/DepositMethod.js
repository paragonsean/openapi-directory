...
import DepositMethodAttributes from './DepositMethodAttributes';
import DepositMethodRelationships from './DepositMethodRelationships';
import SelfLinks from './SelfLinks';

/**
 * The DepositMethod model module.
 * @module model/DepositMethod
 * @version 2017-08-24
 */
class DepositMethod {
    /**
     * Constructs a new <code>DepositMethod</code>.
     * @alias module:model/DepositMethod
     */
    constructor() { 
        
        DepositMethod.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DepositMethod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DepositMethod} obj Optional instance to populate.
     * @return {module:model/DepositMethod} The populated <code>DepositMethod</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DepositMethod();

            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = DepositMethodAttributes.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = SelfLinks.constructFromObject(data['links']);
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = DepositMethodRelationships.constructFromObject(data['relationships']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DepositMethod</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DepositMethod</code>.
     */
    static validateJSON(data) {
        // validate the optional field `attributes`
        if (data['attributes']) { // data not null
          DepositMethodAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['links']) { // data not null
          SelfLinks.validateJSON(data['links']);
        }
        // validate the optional field `relationships`
        if (data['relationships']) { // data not null
          DepositMethodRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/DepositMethodAttributes} attributes
 */
DepositMethod.prototype['attributes'] = undefined;

/**
 * Deposit-methods`s ID
 * @member {String} id
 */
DepositMethod.prototype['id'] = undefined;

/**
 * @member {module:model/SelfLinks} links
 */
DepositMethod.prototype['links'] = undefined;

/**
 * @member {module:model/DepositMethodRelationships} relationships
 */
DepositMethod.prototype['relationships'] = undefined;

/**
 * @member {String} type
 */
DepositMethod.prototype['type'] = undefined;
