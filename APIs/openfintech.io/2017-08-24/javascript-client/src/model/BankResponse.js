...
/**
 * The BankResponse model module.
 * @module model/BankResponse
 * @version 2017-08-24
 */
class BankResponse {
    /**
     * Constructs a new <code>BankResponse</code>.
     * @alias module:model/BankResponse
     */
    constructor() { 
        
        BankResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BankResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BankResponse} obj Optional instance to populate.
     * @return {module:model/BankResponse} The populated <code>BankResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BankResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = Bank.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BankResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BankResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          Bank.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/Bank} data
 */
BankResponse.prototype['data'] = undefined;
