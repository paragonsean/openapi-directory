...
import BankOrganizationData from './BankOrganizationData';
import BankOrganizationLinks from './BankOrganizationLinks';

/**
 * The BankOrganization model module.
 * @module model/BankOrganization
 * @version 2017-08-24
 */
class BankOrganization {
    /**
     * Constructs a new <code>BankOrganization</code>.
     * @alias module:model/BankOrganization
     */
    constructor() { 
        
        BankOrganization.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BankOrganization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BankOrganization} obj Optional instance to populate.
     * @return {module:model/BankOrganization} The populated <code>BankOrganization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BankOrganization();

            if (data.hasOwnProperty('data')) {
                obj['data'] = BankOrganizationData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = BankOrganizationLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BankOrganization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BankOrganization</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          BankOrganizationData.validateJSON(data['data']);
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          BankOrganizationLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/BankOrganizationData} data
 */
BankOrganization.prototype['data'] = undefined;

/**
 * @member {module:model/BankOrganizationLinks} links
 */
BankOrganization.prototype['links'] = undefined;
...
export default BankOrganization;
