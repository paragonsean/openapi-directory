...
/**
 * The DepositMethodResponse model module.
 * @module model/DepositMethodResponse
 * @version 2017-08-24
 */
class DepositMethodResponse {
    /**
     * Constructs a new <code>DepositMethodResponse</code>.
     * @alias module:model/DepositMethodResponse
     */
    constructor() { 
        
        DepositMethodResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DepositMethodResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DepositMethodResponse} obj Optional instance to populate.
     * @return {module:model/DepositMethodResponse} The populated <code>DepositMethodResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DepositMethodResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = DepositMethod.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DepositMethodResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DepositMethodResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          DepositMethod.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/DepositMethod} data
 */
DepositMethodResponse.prototype['data'] = undefined;
...
export default DepositMethodResponse;
