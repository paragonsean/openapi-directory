...
import OrganizationRelationships from './OrganizationRelationships';
...
class Organization {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = OrganizationAttributes.constructFromObject(data['attributes']);
            }
            ...
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = OrganizationRelationships.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          OrganizationAttributes.validateJSON(data['attributes']);
        }
        ...
        if (data['relationships']) { // data not null
          OrganizationRelationships.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/OrganizationAttributes} attributes
 */
Organization.prototype['attributes'] = undefined;
...
/**
 * @member {module:model/OrganizationRelationships} relationships
 */
Organization.prototype['relationships'] = undefined;
