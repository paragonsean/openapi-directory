...
/**
 * The ExchangersResponse model module.
 * @module model/ExchangersResponse
 * @version 2017-08-24
 */
class ExchangersResponse {
    /**
     * Constructs a new <code>ExchangersResponse</code>.
     * @alias module:model/ExchangersResponse
     */
    constructor() { 
        
        ExchangersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExchangersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangersResponse} obj Optional instance to populate.
     * @return {module:model/ExchangersResponse} The populated <code>ExchangersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangersResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Exchanger]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangersResponse</code>.
     */
...
/**
 * @member {Array.<module:model/Exchanger>} data
 */
ExchangersResponse.prototype['data'] = undefined;

/**
 * @member {module:model/ResponseLinks} links
 */
ExchangersResponse.prototype['links'] = undefined;

/**
 * @member {module:model/ResponseMeta} meta
 */
ExchangersResponse.prototype['meta'] = undefined;
...
export default ExchangersResponse;
