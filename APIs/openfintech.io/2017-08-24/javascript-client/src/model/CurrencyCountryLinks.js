...
/**
 * The CurrencyCountryLinks model module.
 * @module model/CurrencyCountryLinks
 * @version 2017-08-24
 */
class CurrencyCountryLinks {
    /**
     * Constructs a new <code>CurrencyCountryLinks</code>.
     * @alias module:model/CurrencyCountryLinks
     */
    constructor() { 
        
        CurrencyCountryLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CurrencyCountryLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CurrencyCountryLinks} obj Optional instance to populate.
     * @return {module:model/CurrencyCountryLinks} The populated <code>CurrencyCountryLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CurrencyCountryLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>CurrencyCountryLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrencyCountryLinks</code>.
     */
 ...
 */
CurrencyCountryLinks.prototype['related'] = undefined;
...
export default CurrencyCountryLinks;
