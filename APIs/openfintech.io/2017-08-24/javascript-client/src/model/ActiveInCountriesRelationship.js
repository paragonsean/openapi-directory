...
import ActiveInCountriesRelationshipDataInner from './ActiveInCountriesRelationshipDataInner';
import ActiveInCountriesRelationshipLinks from './ActiveInCountriesRelationshipLinks';

/**
 * The ActiveInCountriesRelationship model module.
 * @module model/ActiveInCountriesRelationship
 * @version 2017-08-24
 */
class ActiveInCountriesRelationship {
    /**
     * Constructs a new <code>ActiveInCountriesRelationship</code>.
     * Active in countries
     * @alias module:model/ActiveInCountriesRelationship
     */
    constructor() { 
        
        ActiveInCountriesRelationship.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ActiveInCountriesRelationship</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActiveInCountriesRelationship} obj Optional instance to populate.
     * @return {module:model/ActiveInCountriesRelationship} The populated <code>ActiveInCountriesRelationship</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActiveInCountriesRelationship();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ActiveInCountriesRelationshipDataInner]);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = ActiveInCountriesRelationshipLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ActiveInCountriesRelationship</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActiveInCountriesRelationship</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ActiveInCountriesRelationshipDataInner.validateJSON(item);
            };
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          ActiveInCountriesRelationshipLinks.validateJSON(data['links']);
        }
...
/**
 * @member {Array.<module:model/ActiveInCountriesRelationshipDataInner>} data
 */
ActiveInCountriesRelationship.prototype['data'] = undefined;

/**
 * @member {module:model/ActiveInCountriesRelationshipLinks} links
 */
ActiveInCountriesRelationship.prototype['links'] = undefined;
...
export default ActiveInCountriesRelationship;
