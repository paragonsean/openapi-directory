...
/**
 * The CountryTranslationsLinks model module.
 * @module model/CountryTranslationsLinks
 * @version 2017-08-24
 */
class CountryTranslationsLinks {
    /**
     * Constructs a new <code>CountryTranslationsLinks</code>.
     * @alias module:model/CountryTranslationsLinks
     */
    constructor() { 
        
        CountryTranslationsLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CountryTranslationsLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CountryTranslationsLinks} obj Optional instance to populate.
     * @return {module:model/CountryTranslationsLinks} The populated <code>CountryTranslationsLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CountryTranslationsLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>CountryTranslationsLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CountryTranslationsLinks</code>.
     */
 ...
 */
CountryTranslationsLinks.prototype['related'] = undefined;
...
export default CountryTranslationsLinks;
