...
/**
 * The DepositMethodProcessorDataLinks model module.
 * @module model/DepositMethodProcessorDataLinks
 * @version 2017-08-24
 */
class DepositMethodProcessorDataLinks {
    /**
     * Constructs a new <code>DepositMethodProcessorDataLinks</code>.
     * @alias module:model/DepositMethodProcessorDataLinks
     */
    constructor() { 
        
        DepositMethodProcessorDataLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DepositMethodProcessorDataLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DepositMethodProcessorDataLinks} obj Optional instance to populate.
     * @return {module:model/DepositMethodProcessorDataLinks} The populated <code>DepositMethodProcessorDataLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DepositMethodProcessorDataLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>DepositMethodProcessorDataLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DepositMethodProcessorDataLinks</code>.
     */
 ...
 */
DepositMethodProcessorDataLinks.prototype['related'] = undefined;
...
export default DepositMethodProcessorDataLinks;
