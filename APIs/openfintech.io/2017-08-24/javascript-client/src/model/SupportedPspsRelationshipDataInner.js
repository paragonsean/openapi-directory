...
/**
 * The SupportedPspsRelationshipDataInner model module.
 * @module model/SupportedPspsRelationshipDataInner
 * @version 2017-08-24
 */
class SupportedPspsRelationshipDataInner {
    /**
     * Constructs a new <code>SupportedPspsRelationshipDataInner</code>.
     * @alias module:model/SupportedPspsRelationshipDataInner
     */
    constructor() { 
        
        SupportedPspsRelationshipDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SupportedPspsRelationshipDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SupportedPspsRelationshipDataInner} obj Optional instance to populate.
     * @return {module:model/SupportedPspsRelationshipDataInner} The populated <code>SupportedPspsRelationshipDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SupportedPspsRelationshipDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>SupportedPspsRelationshipDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SupportedPspsRelationshipDataInner</code>.
     */
 ...
 * @member {String} id
 */
SupportedPspsRelationshipDataInner.prototype['id'] = undefined;

/**
 * @member {String} type
 */
SupportedPspsRelationshipDataInner.prototype['type'] = undefined;
...
export default SupportedPspsRelationshipDataInner;
