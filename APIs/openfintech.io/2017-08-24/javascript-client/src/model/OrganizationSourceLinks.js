...
/**
 * The OrganizationSourceLinks model module.
 * @module model/OrganizationSourceLinks
 * @version 2017-08-24
 */
class OrganizationSourceLinks {
    /**
     * Constructs a new <code>OrganizationSourceLinks</code>.
     * @alias module:model/OrganizationSourceLinks
     */
    constructor() { 
        
        OrganizationSourceLinks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationSourceLinks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationSourceLinks} obj Optional instance to populate.
     * @return {module:model/OrganizationSourceLinks} The populated <code>OrganizationSourceLinks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationSourceLinks();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationSourceLinks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationSourceLinks</code>.
     */
 ...
 */
OrganizationSourceLinks.prototype['related'] = undefined;
...
export default OrganizationSourceLinks;
