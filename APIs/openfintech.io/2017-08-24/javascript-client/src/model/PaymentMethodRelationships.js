...
/**
 * The PaymentMethodRelationships model module.
 * @module model/PaymentMethodRelationships
 * @version 2017-08-24
 */
class PaymentMethodRelationships {
    /**
     * Constructs a new <code>PaymentMethodRelationships</code>.
     * @alias module:model/PaymentMethodRelationships
     */
    constructor() { 
        
        PaymentMethodRelationships.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentMethodRelationships</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentMethodRelationships} obj Optional instance to populate.
     * @return {module:model/PaymentMethodRelationships} The populated <code>PaymentMethodRelationships</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentMethodRelationships();

            if (data.hasOwnProperty('currencies')) {
                obj['currencies'] = PaymentMethodCurrencies.constructFromObject(data['currencies']);
            }
            if (data.hasOwnProperty('payment-processor')) {
                obj['payment-processor'] = PaymentMethodProcessor.constructFromObject(data['payment-processor']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentMethodRelationships</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentMethodRelationships</code>.
     */
    static validateJSON(data) {
        // validate the optional field `currencies`
        if (data['currencies']) { // data not null
          PaymentMethodCurrencies.validateJSON(data['currencies']);
        }
        // validate the optional field `payment-processor`
        if (data['payment-processor']) { // data not null
          PaymentMethodProcessor.validateJSON(data['payment-processor']);
        }
...
/**
 * @member {module:model/PaymentMethodCurrencies} currencies
 */
PaymentMethodRelationships.prototype['currencies'] = undefined;

/**
 * @member {module:model/PaymentMethodProcessor} payment-processor
 */
PaymentMethodRelationships.prototype['payment-processor'] = undefined;
...
export default PaymentMethodRelationships;
