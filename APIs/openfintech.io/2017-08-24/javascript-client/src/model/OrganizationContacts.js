...
/**
 * The OrganizationContacts model module.
 * @module model/OrganizationContacts
 * @version 2017-08-24
 */
class OrganizationContacts {
    /**
     * Constructs a new <code>OrganizationContacts</code>.
     * Organization&#x60;s contacts
     * @alias module:model/OrganizationContacts
     */
    constructor() { 
        
        OrganizationContacts.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationContacts</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationContacts} obj Optional instance to populate.
     * @return {module:model/OrganizationContacts} The populated <code>OrganizationContacts</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationContacts();
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationContacts</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationContacts</code>.
     */
 ...
 * @member {String} email
 */
OrganizationContacts.prototype['email'] = undefined;

/**
 * @member {String} fax
 */
OrganizationContacts.prototype['fax'] = undefined;

/**
 * @member {String} phone
 */
OrganizationContacts.prototype['phone'] = undefined;

/**
 * @member {String} skype
 */
OrganizationContacts.prototype['skype'] = undefined;
