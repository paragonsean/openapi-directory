...
import OrganizationSourceData from './OrganizationSourceData';
import OrganizationSourceLinks from './OrganizationSourceLinks';

/**
 * The OrganizationSource model module.
 * @module model/OrganizationSource
 * @version 2017-08-24
 */
class OrganizationSource {
    /**
     * Constructs a new <code>OrganizationSource</code>.
     * @alias module:model/OrganizationSource
     */
    constructor() { 
        
        OrganizationSource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationSource} obj Optional instance to populate.
     * @return {module:model/OrganizationSource} The populated <code>OrganizationSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationSource();

            if (data.hasOwnProperty('data')) {
                obj['data'] = OrganizationSourceData.constructFromObject(data['data']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = OrganizationSourceLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OrganizationSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrganizationSource</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          OrganizationSourceData.validateJSON(data['data']);
        }
        // validate the optional field `links`
        if (data['links']) { // data not null
          OrganizationSourceLinks.validateJSON(data['links']);
        }
...
/**
 * @member {module:model/OrganizationSourceData} data
 */
OrganizationSource.prototype['data'] = undefined;

/**
 * @member {module:model/OrganizationSourceLinks} links
 */
OrganizationSource.prototype['links'] = undefined;
...
export default OrganizationSource;
