...
class CurrenciesResponse {
    ...
    constructor() { 
        ...
        CurrenciesResponse.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CurrenciesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrenciesResponse</code>.
     */
 ...
 */
CurrenciesResponse.prototype['data'] = undefined;

/**
 * @member {module:model/ResponseLinks} links
 */
CurrenciesResponse.prototype['links'] = undefined;

/**
 * @member {module:model/ResponseMeta} meta
 */
CurrenciesResponse.prototype['meta'] = undefined;
...
export default CurrenciesResponse;
