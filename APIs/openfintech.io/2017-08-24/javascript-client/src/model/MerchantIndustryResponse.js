...
import MerchantIndustry from './MerchantIndustry';

/**
 * The MerchantIndustryResponse model module.
 * @module model/MerchantIndustryResponse
 * @version 2017-08-24
 */
class MerchantIndustryResponse {
    /**
     * Constructs a new <code>MerchantIndustryResponse</code>.
     * @alias module:model/MerchantIndustryResponse
     */
    constructor() { 
        
        MerchantIndustryResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MerchantIndustryResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MerchantIndustryResponse} obj Optional instance to populate.
     * @return {module:model/MerchantIndustryResponse} The populated <code>MerchantIndustryResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MerchantIndustryResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = MerchantIndustry.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MerchantIndustryResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MerchantIndustryResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          MerchantIndustry.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/MerchantIndustry} data
 */
MerchantIndustryResponse.prototype['data'] = undefined;
...
export default MerchantIndustryResponse;
