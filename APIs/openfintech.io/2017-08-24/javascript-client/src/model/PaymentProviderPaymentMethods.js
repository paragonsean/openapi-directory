...
import PaymentProviderPaymentMethodsLinks from './PaymentProviderPaymentMethodsLinks';

/**
 * The PaymentProviderPaymentMethods model module.
 * @module model/PaymentProviderPaymentMethods
 * @version 2017-08-24
 */
class PaymentProviderPaymentMethods {
    /**
     * Constructs a new <code>PaymentProviderPaymentMethods</code>.
     * @alias module:model/PaymentProviderPaymentMethods
     */
    constructor() { 
        
        PaymentProviderPaymentMethods.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentProviderPaymentMethods</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentProviderPaymentMethods} obj Optional instance to populate.
     * @return {module:model/PaymentProviderPaymentMethods} The populated <code>PaymentProviderPaymentMethods</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentProviderPaymentMethods();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], ['String']);
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = PaymentProviderPaymentMethodsLinks.constructFromObject(data['links']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentProviderPaymentMethods</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentProviderPaymentMethods</code>.
     */
    static validateJSON(data) {
        ...
        if (data['links']) { // data not null
          PaymentProviderPaymentMethodsLinks.validateJSON(data['links']);
        }
 ...
 */
PaymentProviderPaymentMethods.prototype['data'] = undefined;

/**
 * @member {module:model/PaymentProviderPaymentMethodsLinks} links
 */
PaymentProviderPaymentMethods.prototype['links'] = undefined;
...
export default PaymentProviderPaymentMethods;
