...
/**
 * The PaymentMethodProcessorData model module.
 * @module model/PaymentMethodProcessorData
 * @version 2017-08-24
 */
class PaymentMethodProcessorData {
    /**
     * Constructs a new <code>PaymentMethodProcessorData</code>.
     * Processor&#x60;s Data.
     * @alias module:model/PaymentMethodProcessorData
     */
    constructor() { 
        
        PaymentMethodProcessorData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentMethodProcessorData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentMethodProcessorData} obj Optional instance to populate.
     * @return {module:model/PaymentMethodProcessorData} The populated <code>PaymentMethodProcessorData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentMethodProcessorData();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentMethodProcessorData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentMethodProcessorData</code>.
     */
 ...
 * @member {String} id
 */
PaymentMethodProcessorData.prototype['id'] = undefined;

/**
 * Processor`s type.
 * @member {String} type
 */
PaymentMethodProcessorData.prototype['type'] = undefined;
...
export default PaymentMethodProcessorData;
