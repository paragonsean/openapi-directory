...
/**
 * The PaymentMethodAttributes model module.
 * @module model/PaymentMethodAttributes
 * @version 2017-08-24
 */
class PaymentMethodAttributes {
    /**
     * Constructs a new <code>PaymentMethodAttributes</code>.
     * Array of Payment-method attributes
     * @alias module:model/PaymentMethodAttributes
     */
    constructor() { 
        
        PaymentMethodAttributes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PaymentMethodAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentMethodAttributes} obj Optional instance to populate.
     * @return {module:model/PaymentMethodAttributes} The populated <code>PaymentMethodAttributes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentMethodAttributes();
            ...
            if (data.hasOwnProperty('processor_name')) {
                obj['processor_name'] = ApiClient.convertToType(data['processor_name'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentMethodAttributes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentMethodAttributes</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['processor_name'] && !(typeof data['processor_name'] === 'string' || data['processor_name'] instanceof String)) {
            throw new Error("Expected the field `processor_name` to be a primitive type in the JSON string but got " + data['processor_name']);
        }
 ...
 */
PaymentMethodAttributes.prototype['category'] = undefined;

/**
 * Payment-method`s code
 * @member {String} code
 */
PaymentMethodAttributes.prototype['code'] = undefined;

/**
 * Payment-method`s name
 * @member {String} name
 */
PaymentMethodAttributes.prototype['name'] = undefined;

/**
 * Payment-method`s processor
 * @member {String} processor_name
 */
PaymentMethodAttributes.prototype['processor_name'] = undefined;
...
export default PaymentMethodAttributes;
