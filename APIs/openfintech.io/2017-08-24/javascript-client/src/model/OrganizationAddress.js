...
class OrganizationAddress {
    ...
    constructor() { 
        ...
        OrganizationAddress.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('post_code')) {
                obj['post_code'] = ApiClient.convertToType(data['post_code'], 'Number');
            }
 ...
 */
OrganizationAddress.prototype['country'] = undefined;

/**
 * @member {Number} post_code
 */
OrganizationAddress.prototype['post_code'] = undefined;

/**
 * Countryâ€™s region:<br>    * Africa   * Americas   * Asia   * Europe   * Oceania   * Polar 
 * @member {String} region
 */
OrganizationAddress.prototype['region'] = undefined;
