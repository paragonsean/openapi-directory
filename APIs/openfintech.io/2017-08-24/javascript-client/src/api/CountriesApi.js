...
export default class CountriesApi {
    ...
    */
     ...
     * @param {Array.<module:model/String>} [filterRegion] Filtration by region.
     * @param {Array.<module:model/String>} [filterSubRegion] Filtration by sub region.
     * @param {Array.<module:model/String>} [sort] Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | area | -area | | population | -population | | region | -region | | sub_region | -sub_region | 
    ...
    countriesGet(opts, callback) {
      ...
      let queryParams = {
        ...
        'filter[region]': this.apiClient.buildCollectionParam(opts['filterRegion'], 'csv'),
        'filter[sub_region]': this.apiClient.buildCollectionParam(opts['filterSubRegion'], 'csv'),
     ...
     * @callback module:api/CountriesApi~countriesIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/CountriesApi~countriesIdGetCallback} callback The callback function, accepting three arguments: error, data, response
