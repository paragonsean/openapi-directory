...
export default class CurrenciesApi {
    ...
    */
     ...
     * @param {String} [filterSearch] Full text search with name, code, type, code_iso_alpha3, code_jsons_alpha, code_estandards_alpha, category.
     * @param {String} [filterCodeIsoAlpha3] Filtering by ISO code.
     * @param {Number} [filterCodeIsoNumeric3] Filtering by ISO number.
     * @param {String} [filterCodeEstandardsAlpha] Filtering by estandards code.
     * @param {Array.<module:model/String>} [filterCurrencyType] Filtration by currency type.
     * @param {Array.<module:model/String>} [filterCategory] Filtration by category.
     * @param {Array.<module:model/String>} [sort] Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | type | -type | | category | -category | | code | -code | | code_iso_alpha3 | -code_iso_alpha3 | | code_iso_numeric3 | -code_iso_numeric3 | | code_estandards_alpha | -code_estandards_alpha | 
    ...
    currenciesGet(opts, callback) {
      ...
      let queryParams = {
        ...
        'filter[code_iso_alpha3]': opts['filterCodeIsoAlpha3'],
        'filter[code_iso_numeric3]': opts['filterCodeIsoNumeric3'],
        'filter[code_estandards_alpha]': opts['filterCodeEstandardsAlpha'],
        'filter[currency_type]': this.apiClient.buildCollectionParam(opts['filterCurrencyType'], 'csv'),
