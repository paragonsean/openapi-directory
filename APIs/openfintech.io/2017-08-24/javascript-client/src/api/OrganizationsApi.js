...
export default class OrganizationsApi {
    ...
    */
     ...
     * @callback module:api/OrganizationsApi~organizationsGetCallback
     ...
     * @param {String} [filterSearch] Full text search with id, name, code.
     ...
     * @param {String} [filterIndustries] Filtering by industries.
     * @param {Array.<module:model/String>} [sort] Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | code | -code | | status | -status | | description | -description | 
    ...
    organizationsGet(opts, callback) {
      ...
      let queryParams = {
        ...
        'filter[industries]': opts['filterIndustries'],
      ...
      let returnType = OrganizationsResponse;
     ...
     * @callback module:api/OrganizationsApi~organizationsIdGetCallback
     * @param {String} error Error message, if any.
