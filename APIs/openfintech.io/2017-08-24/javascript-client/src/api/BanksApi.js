...
export default class BanksApi {
    ...
    */
     ...
     * @param {module:model/BanksResponse} data The data returned by the service call.
     ...
     * @param {String} [filterSortCode] Filtering by banks code.
     * @param {String} [filterCode] Filtering by code.
     * @param {Array.<module:model/String>} [filterStatus] Filtration by status.
     * @param {Array.<module:model/String>} [sort] Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | code | -code | | status | -status | | sort_code | -sort_code | 
     * @param {module:api/BanksApi~banksGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BanksResponse}
     */
    banksGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'filter[sort_code]': opts['filterSortCode'],
    ...
    /**
     * Callback function to receive the result of the banksIdGet operation.
     * @callback module:api/BanksApi~banksIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BankResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/BanksApi~banksIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BankResponse}
     */
    banksIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling banksIdGet");
      }
