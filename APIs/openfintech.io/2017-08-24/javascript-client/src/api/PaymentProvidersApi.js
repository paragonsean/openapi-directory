...
/**
* PaymentProviders service.
* @module api/PaymentProvidersApi
* @version 2017-08-24
*/
export default class PaymentProvidersApi {

    /**
    * Constructs a new PaymentProvidersApi. 
    * @alias module:api/PaymentProvidersApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the paymentProvidersGet operation.
     * @callback module:api/PaymentProvidersApi~paymentProvidersGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PaymentProvidersResponse} data The data returned by the service call.
     ...
     * @param {String} [filterSearch] Full text search with id, code, name.
     * @param {String} [filterName] Filtering by name.
     * @param {String} [filterCode] Filtering by code.
     * @param {Array.<module:model/String>} [filterTypes] Filtering by types.
     * @param {Array.<module:model/String>} [filterSalesChannels] Filtering by sales channels.
     * @param {Array.<module:model/String>} [filterFeatures] Filtering by features.
     * @param {Array.<module:model/String>} [sort] Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | code | -code | 
     * @param {module:api/PaymentProvidersApi~paymentProvidersGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PaymentProvidersResponse}
     */
    paymentProvidersGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'filter[types]': this.apiClient.buildCollectionParam(opts['filterTypes'], 'csv'),
        'filter[sales_channels]': this.apiClient.buildCollectionParam(opts['filterSalesChannels'], 'csv'),
        'filter[features]': this.apiClient.buildCollectionParam(opts['filterFeatures'], 'csv'),
      ...
      let returnType = PaymentProvidersResponse;
      return this.apiClient.callApi(
        '/payment-providers', 'GET',
    ...
    /**
     * Callback function to receive the result of the paymentProvidersIdGet operation.
     * @callback module:api/PaymentProvidersApi~paymentProvidersIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PaymentProviderResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/PaymentProvidersApi~paymentProvidersIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PaymentProviderResponse}
     */
    paymentProvidersIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling paymentProvidersIdGet");
      }
