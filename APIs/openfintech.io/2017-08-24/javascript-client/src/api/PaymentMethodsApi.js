...
export default class PaymentMethodsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the paymentMethodsIdGet operation.
     * @callback module:api/PaymentMethodsApi~paymentMethodsIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PaymentMethodsApi~paymentMethodsIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PaymentMethodResponse}
     */
    paymentMethodsIdGet(id, callback) {
      let postBody = null;
