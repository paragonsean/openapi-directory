...
/**
* Exchangers service.
* @module api/ExchangersApi
* @version 2017-08-24
*/
export default class ExchangersApi {

    /**
    * Constructs a new ExchangersApi. 
    * @alias module:api/ExchangersApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the exchangersGet operation.
     * @callback module:api/ExchangersApi~exchangersGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ExchangersResponse} data The data returned by the service call.
     ...
     * @param {Array.<module:model/String>} [filterStatus] Filtration by status.
     * @param {Array.<module:model/String>} [sort] Sort params:<br>  | ASC | DESC | |-----|------| | name | -name | | status | -status | | wmid | -wmid | | rate_type | -rate_type | | rates_export_standard | <nobr>-rates_export_standard</nobr> | 
     * @param {module:api/ExchangersApi~exchangersGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ExchangersResponse}
     */
    exchangersGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = ExchangersResponse;
    ...
    /**
     * Callback function to receive the result of the exchangersIdGet operation.
     * @callback module:api/ExchangersApi~exchangersIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ExchangerResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ExchangersApi~exchangersIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ExchangerResponse}
     */
    exchangersIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling exchangersIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/vnd.api+json'];
      let returnType = ExchangerResponse;
      return this.apiClient.callApi(
        '/exchangers/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
