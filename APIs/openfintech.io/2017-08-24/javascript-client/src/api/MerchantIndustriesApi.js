...
/**
* MerchantIndustries service.
* @module api/MerchantIndustriesApi
* @version 2017-08-24
*/
export default class MerchantIndustriesApi {

    /**
    * Constructs a new MerchantIndustriesApi. 
    * @alias module:api/MerchantIndustriesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the merchantIndustriesGet operation.
     * @callback module:api/MerchantIndustriesApi~merchantIndustriesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MerchantIndustriesResponse} data The data returned by the service call.
     ...
     * @param {module:api/MerchantIndustriesApi~merchantIndustriesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MerchantIndustriesResponse}
     */
    merchantIndustriesGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = MerchantIndustriesResponse;
      return this.apiClient.callApi(
        '/merchant-industries', 'GET',
    ...
    /**
     * Callback function to receive the result of the merchantIndustriesIdGet operation.
     * @callback module:api/MerchantIndustriesApi~merchantIndustriesIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MerchantIndustryResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MerchantIndustriesApi~merchantIndustriesIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MerchantIndustryResponse}
     */
    merchantIndustriesIdGet(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling merchantIndustriesIdGet");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/vnd.api+json'];
      let returnType = MerchantIndustryResponse;
      return this.apiClient.callApi(
        '/merchant-industries/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
