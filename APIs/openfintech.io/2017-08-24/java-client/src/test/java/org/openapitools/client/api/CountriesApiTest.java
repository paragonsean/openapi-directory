...
public class CountriesApiTest {
    ...
    public void countriesGetTest() throws ApiException {
        ...
        Set<String> filterRegion = null;
        Set<String> filterSubRegion = null;
        Set<String> sort = null;
        CountriesResponse response = api.countriesGet(pageNumber, pageSize, filterRegion, filterSubRegion, sort);
     ...
     */
    @Test
    public void countriesIdGetTest() throws ApiException {
        String id = null;
        CountryResponse response = api.countriesIdGet(id);
        // TODO: test validations
    }
