...
public class CurrenciesApiTest {
    ...
    public void currenciesGetTest() throws ApiException {
        ...
        String filterCodeIsoAlpha3 = null;
        Integer filterCodeIsoNumeric3 = null;
        String filterCodeEstandardsAlpha = null;
        Set<String> filterCurrencyType = null;
        Set<String> filterCategory = null;
        Set<String> sort = null;
        CurrenciesResponse response = api.currenciesGet(pageNumber, pageSize, filterSearch, filterCodeIsoAlpha3, filterCodeIsoNumeric3, filterCodeEstandardsAlpha, filterCurrencyType, filterCategory, sort);
    ...
    public void currenciesIdGetTest() throws ApiException {
        String id = null;
        CurrencyResponse response = api.currenciesIdGet(id);
        // TODO: test validations
    }
