...
/**
 * Model tests for OrganizationSource
 */
public class OrganizationSourceTest {
    private final OrganizationSource model = new OrganizationSource();
