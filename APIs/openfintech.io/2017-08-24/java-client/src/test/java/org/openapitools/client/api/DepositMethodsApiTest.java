...
/**
 * API tests for DepositMethodsApi
 */
@Disabled
public class DepositMethodsApiTest {

    private final DepositMethodsApi api = new DepositMethodsApi();
     ...
     */
    @Test
    public void depositMethodsGetTest() throws ApiException {
        Integer pageNumber = null;
        Integer pageSize = null;
        String filterSearch = null;
        String filterName = null;
        String filterCode = null;
        String filterProcessorName = null;
        Set<String> filterCategory = null;
        Set<String> sort = null;
        DepositMethodsResponse response = api.depositMethodsGet(pageNumber, pageSize, filterSearch, filterName, filterCode, filterProcessorName, filterCategory, sort);
     ...
     */
    @Test
    public void depositMethodsIdGetTest() throws ApiException {
        String id = null;
        DepositMethodResponse response = api.depositMethodsIdGet(id);
        // TODO: test validations
    }
