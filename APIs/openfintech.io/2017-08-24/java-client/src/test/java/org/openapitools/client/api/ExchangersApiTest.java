...
import org.openapitools.client.model.ExchangerResponse;
import org.openapitools.client.model.ExchangersResponse;
...
/**
 * API tests for ExchangersApi
 */
@Disabled
public class ExchangersApiTest {

    private final ExchangersApi api = new ExchangersApi();
     ...
     */
    @Test
    public void exchangersGetTest() throws ApiException {
        Integer pageNumber = null;
        Integer pageSize = null;
        String filterName = null;
        Set<String> filterStatus = null;
        Set<String> sort = null;
        ExchangersResponse response = api.exchangersGet(pageNumber, pageSize, filterName, filterStatus, sort);
     ...
     */
    @Test
    public void exchangersIdGetTest() throws ApiException {
        String id = null;
        ExchangerResponse response = api.exchangersIdGet(id);
        // TODO: test validations
    }
