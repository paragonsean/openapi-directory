...
public class PaymentMethodsApiTest {
    ...
    public void paymentMethodsGetTest() throws ApiException {
        ...
        PaymentMethodsResponse response = api.paymentMethodsGet(pageNumber, pageSize, filterSearch, filterName, filterCode, filterProcessorName, filterCategory, sort);
     ...
     */
    @Test
    public void paymentMethodsIdGetTest() throws ApiException {
        String id = null;
        PaymentMethodResponse response = api.paymentMethodsIdGet(id);
        // TODO: test validations
    }
