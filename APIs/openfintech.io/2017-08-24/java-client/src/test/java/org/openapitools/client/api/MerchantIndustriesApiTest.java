...
/**
 * API tests for MerchantIndustriesApi
 */
@Disabled
public class MerchantIndustriesApiTest {

    private final MerchantIndustriesApi api = new MerchantIndustriesApi();
     ...
     */
    @Test
    public void merchantIndustriesGetTest() throws ApiException {
        Integer pageNumber = null;
        Integer pageSize = null;
        String filterName = null;
        MerchantIndustriesResponse response = api.merchantIndustriesGet(pageNumber, pageSize, filterName);
     ...
     */
    @Test
    public void merchantIndustriesIdGetTest() throws ApiException {
        String id = null;
        MerchantIndustryResponse response = api.merchantIndustriesIdGet(id);
        // TODO: test validations
    }
