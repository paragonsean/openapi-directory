...
public class BanksApiTest {
    ...
    public void banksGetTest() throws ApiException {
        ...
        String filterSortCode = null;
        String filterCode = null;
        Set<String> filterStatus = null;
        Set<String> sort = null;
        BanksResponse response = api.banksGet(pageNumber, pageSize, filterSortCode, filterCode, filterStatus, sort);
     ...
     */
    @Test
    public void banksIdGetTest() throws ApiException {
        String id = null;
        BankResponse response = api.banksIdGet(id);
        // TODO: test validations
    }
