...
public class OrganizationsApiTest {
    ...
    public void organizationsGetTest() throws ApiException {
        ...
        String filterIndustries = null;
        Set<String> sort = null;
        OrganizationsResponse response = api.organizationsGet(pageNumber, pageSize, filterSearch, filterName, filterCode, filterStatus, filterIndustries, sort);
    ...
    public void organizationsIdGetTest() throws ApiException {
        String id = null;
        OrganizationResponse response = api.organizationsIdGet(id);
        // TODO: test validations
    }
