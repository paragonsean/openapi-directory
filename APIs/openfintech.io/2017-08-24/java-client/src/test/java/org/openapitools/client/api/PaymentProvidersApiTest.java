...
/**
 * API tests for PaymentProvidersApi
 */
@Disabled
public class PaymentProvidersApiTest {

    private final PaymentProvidersApi api = new PaymentProvidersApi();
    ...
    public void paymentProvidersGetTest() throws ApiException {
        ...
        Set<String> filterSalesChannels = null;
        Set<String> filterFeatures = null;
        Set<String> sort = null;
        PaymentProvidersResponse response = api.paymentProvidersGet(pageNumber, pageSize, filterSearch, filterName, filterCode, filterTypes, filterSalesChannels, filterFeatures, sort);
    ...
    public void paymentProvidersIdGetTest() throws ApiException {
        String id = null;
        PaymentProviderResponse response = api.paymentProvidersIdGet(id);
        // TODO: test validations
    }
