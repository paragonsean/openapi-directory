...
public class DepositMethod {
  ...
  private DepositMethodAttributes attributes;
  ...
  private DepositMethodRelationships relationships;
  ...
  public DepositMethod attributes(DepositMethodAttributes attributes) {
  ...
  public DepositMethodAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(DepositMethodAttributes attributes) {
    this.attributes = attributes;
  }


  public DepositMethod id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DepositMethod links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public DepositMethod relationships(DepositMethodRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public DepositMethodRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(DepositMethodRelationships relationships) {
    this.relationships = relationships;
  }


  public DepositMethod type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DepositMethod depositMethod = (DepositMethod) o;
    return Objects.equals(this.attributes, depositMethod.attributes) &&
        Objects.equals(this.id, depositMethod.id) &&
        Objects.equals(this.links, depositMethod.links) &&
        Objects.equals(this.relationships, depositMethod.relationships) &&
        Objects.equals(this.type, depositMethod.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DepositMethod
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DepositMethod.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepositMethod is not found in the empty JSON string", DepositMethod.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DepositMethod.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DepositMethod` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        DepositMethodAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        DepositMethodRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepositMethod.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepositMethod' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepositMethod> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepositMethod.class));

       return (TypeAdapter<T>) new TypeAdapter<DepositMethod>() {
           @Override
           public void write(JsonWriter out, DepositMethod value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DepositMethod read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DepositMethod given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DepositMethod
   * @throws IOException if the JSON string is invalid with respect to DepositMethod
   */
  public static DepositMethod fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepositMethod.class);
  }

  /**
   * Convert an instance of DepositMethod to an JSON string
   *
   * @return JSON string
   */
