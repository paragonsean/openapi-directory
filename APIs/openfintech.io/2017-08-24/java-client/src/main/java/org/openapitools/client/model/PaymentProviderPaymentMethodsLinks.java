...
public class PaymentProviderPaymentMethodsLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public PaymentProviderPaymentMethodsLinks() {
  }

  public PaymentProviderPaymentMethodsLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentProviderPaymentMethodsLinks paymentProviderPaymentMethodsLinks = (PaymentProviderPaymentMethodsLinks) o;
    return Objects.equals(this.related, paymentProviderPaymentMethodsLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentProviderPaymentMethodsLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentProviderPaymentMethodsLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentProviderPaymentMethodsLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentProviderPaymentMethodsLinks is not found in the empty JSON string", PaymentProviderPaymentMethodsLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentProviderPaymentMethodsLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentProviderPaymentMethodsLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentProviderPaymentMethodsLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentProviderPaymentMethodsLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentProviderPaymentMethodsLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentProviderPaymentMethodsLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentProviderPaymentMethodsLinks>() {
           @Override
           public void write(JsonWriter out, PaymentProviderPaymentMethodsLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentProviderPaymentMethodsLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentProviderPaymentMethodsLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentProviderPaymentMethodsLinks
   * @throws IOException if the JSON string is invalid with respect to PaymentProviderPaymentMethodsLinks
   */
  public static PaymentProviderPaymentMethodsLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentProviderPaymentMethodsLinks.class);
  }

  /**
   * Convert an instance of PaymentProviderPaymentMethodsLinks to an JSON string
   *
   * @return JSON string
   */
