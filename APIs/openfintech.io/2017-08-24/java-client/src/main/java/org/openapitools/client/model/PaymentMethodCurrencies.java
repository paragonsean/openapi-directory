...
public class PaymentMethodCurrencies {
  ...
  private PaymentMethodCurrenciesLinks links;

  public PaymentMethodCurrencies() {
  }

  public PaymentMethodCurrencies data(List<String> data) {
    this.data = data;
    return this;
  }

  public PaymentMethodCurrencies addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public PaymentMethodCurrencies links(PaymentMethodCurrenciesLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PaymentMethodCurrenciesLinks getLinks() {
    return links;
  }

  public void setLinks(PaymentMethodCurrenciesLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentMethodCurrencies paymentMethodCurrencies = (PaymentMethodCurrencies) o;
    return Objects.equals(this.data, paymentMethodCurrencies.data) &&
        Objects.equals(this.links, paymentMethodCurrencies.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentMethodCurrencies {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentMethodCurrencies
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentMethodCurrencies.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentMethodCurrencies is not found in the empty JSON string", PaymentMethodCurrencies.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentMethodCurrencies.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentMethodCurrencies` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        PaymentMethodCurrenciesLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentMethodCurrencies.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentMethodCurrencies' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentMethodCurrencies> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentMethodCurrencies.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentMethodCurrencies>() {
           @Override
           public void write(JsonWriter out, PaymentMethodCurrencies value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentMethodCurrencies read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentMethodCurrencies given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentMethodCurrencies
   * @throws IOException if the JSON string is invalid with respect to PaymentMethodCurrencies
   */
  public static PaymentMethodCurrencies fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentMethodCurrencies.class);
  }

  /**
   * Convert an instance of PaymentMethodCurrencies to an JSON string
   *
   * @return JSON string
   */
