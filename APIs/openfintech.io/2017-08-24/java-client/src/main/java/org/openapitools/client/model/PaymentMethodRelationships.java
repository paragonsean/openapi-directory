...
public class PaymentMethodRelationships {
  public static final String SERIALIZED_NAME_CURRENCIES = "currencies";
  @SerializedName(SERIALIZED_NAME_CURRENCIES)
  private PaymentMethodCurrencies currencies;

  public static final String SERIALIZED_NAME_PAYMENT_PROCESSOR = "payment-processor";
  @SerializedName(SERIALIZED_NAME_PAYMENT_PROCESSOR)
  private PaymentMethodProcessor paymentProcessor;

  public PaymentMethodRelationships() {
  }

  public PaymentMethodRelationships currencies(PaymentMethodCurrencies currencies) {
  ...
  public PaymentMethodCurrencies getCurrencies() {
    return currencies;
  }

  public void setCurrencies(PaymentMethodCurrencies currencies) {
    this.currencies = currencies;
  }


  public PaymentMethodRelationships paymentProcessor(PaymentMethodProcessor paymentProcessor) {
   ...
   */
  @javax.annotation.Nullable
  public PaymentMethodProcessor getPaymentProcessor() {
    return paymentProcessor;
  }

  public void setPaymentProcessor(PaymentMethodProcessor paymentProcessor) {
    this.paymentProcessor = paymentProcessor;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentMethodRelationships paymentMethodRelationships = (PaymentMethodRelationships) o;
    return Objects.equals(this.currencies, paymentMethodRelationships.currencies) &&
        Objects.equals(this.paymentProcessor, paymentMethodRelationships.paymentProcessor);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currencies, paymentProcessor);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentMethodRelationships {\n");
  ...
  static {
    ...
    openapiFields.add("payment-processor");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentMethodRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentMethodRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentMethodRelationships is not found in the empty JSON string", PaymentMethodRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentMethodRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentMethodRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `currencies`
      if (jsonObj.get("currencies") != null && !jsonObj.get("currencies").isJsonNull()) {
        PaymentMethodCurrencies.validateJsonElement(jsonObj.get("currencies"));
      }
      // validate the optional field `payment-processor`
      if (jsonObj.get("payment-processor") != null && !jsonObj.get("payment-processor").isJsonNull()) {
        PaymentMethodProcessor.validateJsonElement(jsonObj.get("payment-processor"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentMethodRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentMethodRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentMethodRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentMethodRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentMethodRelationships>() {
           @Override
           public void write(JsonWriter out, PaymentMethodRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentMethodRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentMethodRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentMethodRelationships
   * @throws IOException if the JSON string is invalid with respect to PaymentMethodRelationships
   */
  public static PaymentMethodRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentMethodRelationships.class);
  }

  /**
   * Convert an instance of PaymentMethodRelationships to an JSON string
   *
   * @return JSON string
   */
