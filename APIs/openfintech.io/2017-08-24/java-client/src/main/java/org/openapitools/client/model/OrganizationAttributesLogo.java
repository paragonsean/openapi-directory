...
public class OrganizationAttributesLogo {
  ...
  public static final String SERIALIZED_NAME_150 = "150";
  @SerializedName(SERIALIZED_NAME_150)
  private String _150;

  public OrganizationAttributesLogo() {
  }

  public OrganizationAttributesLogo _50(String _50) {
    this._50 = _50;
    return this;
  }
  ...
  public OrganizationAttributesLogo _100(String _100) {
    this._100 = _100;
    return this;
  }
  ...
  public OrganizationAttributesLogo _150(String _150) {
    this._150 = _150;
    return this;
  }
  ...
  public void set150(String _150) {
    this._150 = _150;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrganizationAttributesLogo organizationAttributesLogo = (OrganizationAttributesLogo) o;
    return Objects.equals(this._50, organizationAttributesLogo._50) &&
        Objects.equals(this._100, organizationAttributesLogo._100) &&
        Objects.equals(this._150, organizationAttributesLogo._150);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_50, _100, _150);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrganizationAttributesLogo {\n");
    sb.append("    _50: ").append(toIndentedString(_50)).append("\n");
    sb.append("    _100: ").append(toIndentedString(_100)).append("\n");
    sb.append("    _150: ").append(toIndentedString(_150)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("50");
    openapiFields.add("100");
    openapiFields.add("150");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationAttributesLogo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationAttributesLogo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationAttributesLogo is not found in the empty JSON string", OrganizationAttributesLogo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationAttributesLogo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationAttributesLogo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("50") != null && !jsonObj.get("50").isJsonNull()) && !jsonObj.get("50").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `50` to be a primitive type in the JSON string but got `%s`", jsonObj.get("50").toString()));
      }
      if ((jsonObj.get("100") != null && !jsonObj.get("100").isJsonNull()) && !jsonObj.get("100").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `100` to be a primitive type in the JSON string but got `%s`", jsonObj.get("100").toString()));
      }
      if ((jsonObj.get("150") != null && !jsonObj.get("150").isJsonNull()) && !jsonObj.get("150").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `150` to be a primitive type in the JSON string but got `%s`", jsonObj.get("150").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationAttributesLogo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationAttributesLogo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationAttributesLogo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationAttributesLogo.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationAttributesLogo>() {
           @Override
           public void write(JsonWriter out, OrganizationAttributesLogo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationAttributesLogo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationAttributesLogo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationAttributesLogo
   * @throws IOException if the JSON string is invalid with respect to OrganizationAttributesLogo
   */
  public static OrganizationAttributesLogo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationAttributesLogo.class);
  }

  /**
   * Convert an instance of OrganizationAttributesLogo to an JSON string
   *
   * @return JSON string
   */
