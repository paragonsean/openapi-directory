...
public class OrganizationHqData {
  ...
  public OrganizationHqData() {
  }

  public OrganizationHqData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public OrganizationHqData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrganizationHqData organizationHqData = (OrganizationHqData) o;
    return Objects.equals(this.id, organizationHqData.id) &&
        Objects.equals(this.type, organizationHqData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationHqData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationHqData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationHqData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationHqData is not found in the empty JSON string", OrganizationHqData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationHqData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationHqData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationHqData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationHqData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationHqData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationHqData.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationHqData>() {
           @Override
           public void write(JsonWriter out, OrganizationHqData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationHqData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationHqData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationHqData
   * @throws IOException if the JSON string is invalid with respect to OrganizationHqData
   */
  public static OrganizationHqData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationHqData.class);
  }

  /**
   * Convert an instance of OrganizationHqData to an JSON string
   *
   * @return JSON string
   */
