...
public class Exchanger {
  ...
  private ExchangerAttributes attributes;
  ...
  private ExchangerRelationships relationships;
  ...
  public Exchanger attributes(ExchangerAttributes attributes) {
  ...
  public ExchangerAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(ExchangerAttributes attributes) {
    this.attributes = attributes;
  }


  public Exchanger id(String id) {
    this.id = id;
    return this;
  }
  ...
  public Exchanger links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Exchanger relationships(ExchangerRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public ExchangerRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(ExchangerRelationships relationships) {
    this.relationships = relationships;
  }


  public Exchanger type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, exchanger.attributes) &&
        Objects.equals(this.id, exchanger.id) &&
        Objects.equals(this.links, exchanger.links) &&
        Objects.equals(this.relationships, exchanger.relationships) &&
        Objects.equals(this.type, exchanger.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Exchanger
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Exchanger.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Exchanger is not found in the empty JSON string", Exchanger.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Exchanger.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Exchanger` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        ExchangerAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        ExchangerRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Exchanger.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Exchanger' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Exchanger> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Exchanger.class));

       return (TypeAdapter<T>) new TypeAdapter<Exchanger>() {
           @Override
           public void write(JsonWriter out, Exchanger value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Exchanger read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Exchanger given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Exchanger
   * @throws IOException if the JSON string is invalid with respect to Exchanger
   */
  public static Exchanger fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Exchanger.class);
  }

  /**
   * Convert an instance of Exchanger to an JSON string
   *
   * @return JSON string
   */
