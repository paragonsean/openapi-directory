...
public class OrganizationActiveLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public OrganizationActiveLinks() {
  }

  public OrganizationActiveLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationActiveLinks organizationActiveLinks = (OrganizationActiveLinks) o;
    return Objects.equals(this.related, organizationActiveLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationActiveLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationActiveLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationActiveLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationActiveLinks is not found in the empty JSON string", OrganizationActiveLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationActiveLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationActiveLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationActiveLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationActiveLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationActiveLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationActiveLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationActiveLinks>() {
           @Override
           public void write(JsonWriter out, OrganizationActiveLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationActiveLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationActiveLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationActiveLinks
   * @throws IOException if the JSON string is invalid with respect to OrganizationActiveLinks
   */
  public static OrganizationActiveLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationActiveLinks.class);
  }

  /**
   * Convert an instance of OrganizationActiveLinks to an JSON string
   *
   * @return JSON string
   */
