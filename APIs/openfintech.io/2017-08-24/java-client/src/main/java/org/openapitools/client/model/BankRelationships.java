...
import org.openapitools.client.model.BankOrganization;
...
public class BankRelationships {
  ...
  public BankRelationships organization(BankOrganization organization) {
  ...
  public BankOrganization getOrganization() {
    return organization;
  }

  public void setOrganization(BankOrganization organization) {
    this.organization = organization;
  }
  ...
  public boolean equals(Object o) {
    ...
    BankRelationships bankRelationships = (BankRelationships) o;
    return Objects.equals(this.organization, bankRelationships.organization);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankRelationships {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BankRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BankRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankRelationships is not found in the empty JSON string", BankRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BankRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BankRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `organization`
      if (jsonObj.get("organization") != null && !jsonObj.get("organization").isJsonNull()) {
        BankOrganization.validateJsonElement(jsonObj.get("organization"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<BankRelationships>() {
           @Override
           public void write(JsonWriter out, BankRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BankRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BankRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BankRelationships
   * @throws IOException if the JSON string is invalid with respect to BankRelationships
   */
  public static BankRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankRelationships.class);
  }

  /**
   * Convert an instance of BankRelationships to an JSON string
   *
   * @return JSON string
   */
