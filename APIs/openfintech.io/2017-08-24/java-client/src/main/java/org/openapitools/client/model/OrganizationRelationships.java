...
import org.openapitools.client.model.OrganizationActive;
import org.openapitools.client.model.OrganizationHq;
import org.openapitools.client.model.OrganizationSource;
...
public class OrganizationRelationships {
  public static final String SERIALIZED_NAME_ACTIVE_IN_COUNTRIES = "active_in_countries";
  @SerializedName(SERIALIZED_NAME_ACTIVE_IN_COUNTRIES)
  private OrganizationActive activeInCountries;

  public static final String SERIALIZED_NAME_HQ_IN_COUNTRY = "hq_in_country";
  @SerializedName(SERIALIZED_NAME_HQ_IN_COUNTRY)
  private OrganizationHq hqInCountry;

  public static final String SERIALIZED_NAME_SOURCE_REGISTER_ORG = "source_register_org";
  @SerializedName(SERIALIZED_NAME_SOURCE_REGISTER_ORG)
  private OrganizationSource sourceRegisterOrg;

  public OrganizationRelationships() {
  }

  public OrganizationRelationships activeInCountries(OrganizationActive activeInCountries) {
    this.activeInCountries = activeInCountries;
    return this;
  }

  /**
   * Get activeInCountries
   * @return activeInCountries
   */
  @javax.annotation.Nullable
  public OrganizationActive getActiveInCountries() {
    return activeInCountries;
  }

  public void setActiveInCountries(OrganizationActive activeInCountries) {
    this.activeInCountries = activeInCountries;
  }


  public OrganizationRelationships hqInCountry(OrganizationHq hqInCountry) {
    this.hqInCountry = hqInCountry;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public OrganizationHq getHqInCountry() {
    return hqInCountry;
  }

  public void setHqInCountry(OrganizationHq hqInCountry) {
    this.hqInCountry = hqInCountry;
  }


  public OrganizationRelationships sourceRegisterOrg(OrganizationSource sourceRegisterOrg) {
    this.sourceRegisterOrg = sourceRegisterOrg;
    return this;
  }

  /**
   * Get sourceRegisterOrg
   * @return sourceRegisterOrg
   */
  @javax.annotation.Nullable
  public OrganizationSource getSourceRegisterOrg() {
    return sourceRegisterOrg;
  }

  public void setSourceRegisterOrg(OrganizationSource sourceRegisterOrg) {
    this.sourceRegisterOrg = sourceRegisterOrg;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrganizationRelationships organizationRelationships = (OrganizationRelationships) o;
    return Objects.equals(this.activeInCountries, organizationRelationships.activeInCountries) &&
        Objects.equals(this.hqInCountry, organizationRelationships.hqInCountry) &&
        Objects.equals(this.sourceRegisterOrg, organizationRelationships.sourceRegisterOrg);
  }

  @Override
  public int hashCode() {
    return Objects.hash(activeInCountries, hqInCountry, sourceRegisterOrg);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrganizationRelationships {\n");
    sb.append("    activeInCountries: ").append(toIndentedString(activeInCountries)).append("\n");
    sb.append("    hqInCountry: ").append(toIndentedString(hqInCountry)).append("\n");
    sb.append("    sourceRegisterOrg: ").append(toIndentedString(sourceRegisterOrg)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("active_in_countries");
    openapiFields.add("hq_in_country");
    openapiFields.add("source_register_org");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationRelationships is not found in the empty JSON string", OrganizationRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `active_in_countries`
      if (jsonObj.get("active_in_countries") != null && !jsonObj.get("active_in_countries").isJsonNull()) {
        OrganizationActive.validateJsonElement(jsonObj.get("active_in_countries"));
      }
      // validate the optional field `hq_in_country`
      if (jsonObj.get("hq_in_country") != null && !jsonObj.get("hq_in_country").isJsonNull()) {
        OrganizationHq.validateJsonElement(jsonObj.get("hq_in_country"));
      }
      // validate the optional field `source_register_org`
      if (jsonObj.get("source_register_org") != null && !jsonObj.get("source_register_org").isJsonNull()) {
        OrganizationSource.validateJsonElement(jsonObj.get("source_register_org"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationRelationships>() {
           @Override
           public void write(JsonWriter out, OrganizationRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationRelationships
   * @throws IOException if the JSON string is invalid with respect to OrganizationRelationships
   */
  public static OrganizationRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationRelationships.class);
  }

  /**
   * Convert an instance of OrganizationRelationships to an JSON string
   *
   * @return JSON string
   */
