...
public class OrganizationContacts {
  ...
  public OrganizationContacts email(String email) {
    this.email = email;
    return this;
  }
  ...
  public OrganizationContacts fax(String fax) {
    this.fax = fax;
    return this;
  }
  ...
  public OrganizationContacts phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public OrganizationContacts skype(String skype) {
    this.skype = skype;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrganizationContacts organizationContacts = (OrganizationContacts) o;
    return Objects.equals(this.email, organizationContacts.email) &&
        Objects.equals(this.fax, organizationContacts.fax) &&
        Objects.equals(this.phone, organizationContacts.phone) &&
        Objects.equals(this.skype, organizationContacts.skype);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, fax, phone, skype);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrganizationContacts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationContacts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationContacts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationContacts is not found in the empty JSON string", OrganizationContacts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationContacts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationContacts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationContacts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationContacts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationContacts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationContacts.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationContacts>() {
           @Override
           public void write(JsonWriter out, OrganizationContacts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationContacts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationContacts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationContacts
   * @throws IOException if the JSON string is invalid with respect to OrganizationContacts
   */
  public static OrganizationContacts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationContacts.class);
  }

  /**
   * Convert an instance of OrganizationContacts to an JSON string
   *
   * @return JSON string
   */
