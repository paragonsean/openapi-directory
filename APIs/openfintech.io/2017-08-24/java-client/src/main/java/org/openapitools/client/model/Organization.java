...
import org.openapitools.client.model.OrganizationAttributes;
import org.openapitools.client.model.OrganizationRelationships;
...
public class Organization {
  ...
  public Organization links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Organization relationships(OrganizationRelationships relationships) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, organization.attributes) &&
        ...
        Objects.equals(this.relationships, organization.relationships) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        OrganizationAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        OrganizationRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
