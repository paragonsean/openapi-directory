...
public class OrganizationHqLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public OrganizationHqLinks() {
  }

  public OrganizationHqLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationHqLinks organizationHqLinks = (OrganizationHqLinks) o;
    return Objects.equals(this.related, organizationHqLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationHqLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationHqLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationHqLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationHqLinks is not found in the empty JSON string", OrganizationHqLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationHqLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationHqLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationHqLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationHqLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationHqLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationHqLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationHqLinks>() {
           @Override
           public void write(JsonWriter out, OrganizationHqLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationHqLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationHqLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationHqLinks
   * @throws IOException if the JSON string is invalid with respect to OrganizationHqLinks
   */
  public static OrganizationHqLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationHqLinks.class);
  }

  /**
   * Convert an instance of OrganizationHqLinks to an JSON string
   *
   * @return JSON string
   */
