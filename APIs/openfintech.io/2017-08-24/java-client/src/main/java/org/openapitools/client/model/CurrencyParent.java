...
import org.openapitools.client.model.CurrencyParentData;
import org.openapitools.client.model.CurrencyParentLinks;
...
public class CurrencyParent {
  ...
  private CurrencyParentData data;

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private CurrencyParentLinks links;

  public CurrencyParent() {
  }

  public CurrencyParent data(CurrencyParentData data) {
    this.data = data;
    return this;
  }
  ...
  public CurrencyParentData getData() {
    return data;
  }

  public void setData(CurrencyParentData data) {
    this.data = data;
  }


  public CurrencyParent links(CurrencyParentLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CurrencyParentLinks getLinks() {
    return links;
  }

  public void setLinks(CurrencyParentLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    CurrencyParent currencyParent = (CurrencyParent) o;
    return Objects.equals(this.data, currencyParent.data) &&
        Objects.equals(this.links, currencyParent.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyParent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyParent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyParent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyParent is not found in the empty JSON string", CurrencyParent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyParent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyParent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        CurrencyParentData.validateJsonElement(jsonObj.get("data"));
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        CurrencyParentLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyParent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyParent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyParent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyParent.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyParent>() {
           @Override
           public void write(JsonWriter out, CurrencyParent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyParent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyParent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyParent
   * @throws IOException if the JSON string is invalid with respect to CurrencyParent
   */
  public static CurrencyParent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyParent.class);
  }

  /**
   * Convert an instance of CurrencyParent to an JSON string
   *
   * @return JSON string
   */
