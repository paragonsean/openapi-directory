...
public class DepositMethodResponse {
  ...
  private DepositMethod data;

  public DepositMethodResponse() {
  }

  public DepositMethodResponse data(DepositMethod data) {
    this.data = data;
    return this;
  }
  ...
  public DepositMethod getData() {
    return data;
  }

  public void setData(DepositMethod data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    DepositMethodResponse depositMethodResponse = (DepositMethodResponse) o;
    return Objects.equals(this.data, depositMethodResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepositMethodResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DepositMethodResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DepositMethodResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepositMethodResponse is not found in the empty JSON string", DepositMethodResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DepositMethodResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DepositMethodResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        DepositMethod.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepositMethodResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepositMethodResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepositMethodResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepositMethodResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DepositMethodResponse>() {
           @Override
           public void write(JsonWriter out, DepositMethodResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DepositMethodResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DepositMethodResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DepositMethodResponse
   * @throws IOException if the JSON string is invalid with respect to DepositMethodResponse
   */
  public static DepositMethodResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepositMethodResponse.class);
  }

  /**
   * Convert an instance of DepositMethodResponse to an JSON string
   *
   * @return JSON string
   */
