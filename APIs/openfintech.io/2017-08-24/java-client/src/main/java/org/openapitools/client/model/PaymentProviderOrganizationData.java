...
public class PaymentProviderOrganizationData {
  ...
  public PaymentProviderOrganizationData() {
  }

  public PaymentProviderOrganizationData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PaymentProviderOrganizationData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentProviderOrganizationData paymentProviderOrganizationData = (PaymentProviderOrganizationData) o;
    return Objects.equals(this.id, paymentProviderOrganizationData.id) &&
        Objects.equals(this.type, paymentProviderOrganizationData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentProviderOrganizationData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentProviderOrganizationData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentProviderOrganizationData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentProviderOrganizationData is not found in the empty JSON string", PaymentProviderOrganizationData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentProviderOrganizationData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentProviderOrganizationData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentProviderOrganizationData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentProviderOrganizationData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentProviderOrganizationData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentProviderOrganizationData.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentProviderOrganizationData>() {
           @Override
           public void write(JsonWriter out, PaymentProviderOrganizationData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentProviderOrganizationData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentProviderOrganizationData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentProviderOrganizationData
   * @throws IOException if the JSON string is invalid with respect to PaymentProviderOrganizationData
   */
  public static PaymentProviderOrganizationData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentProviderOrganizationData.class);
  }

  /**
   * Convert an instance of PaymentProviderOrganizationData to an JSON string
   *
   * @return JSON string
   */
