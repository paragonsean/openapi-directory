...
import org.openapitools.client.model.ActiveInCountriesRelationshipDataInner;
import org.openapitools.client.model.ActiveInCountriesRelationshipLinks;
...
public class ActiveInCountriesRelationship {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<ActiveInCountriesRelationshipDataInner> data = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private ActiveInCountriesRelationshipLinks links;

  public ActiveInCountriesRelationship() {
  }

  public ActiveInCountriesRelationship data(List<ActiveInCountriesRelationshipDataInner> data) {
    this.data = data;
    return this;
  }

  public ActiveInCountriesRelationship addDataItem(ActiveInCountriesRelationshipDataInner dataItem) {
    if (this.data == null) {
  ...
  public List<ActiveInCountriesRelationshipDataInner> getData() {
    return data;
  }

  public void setData(List<ActiveInCountriesRelationshipDataInner> data) {
    this.data = data;
  }


  public ActiveInCountriesRelationship links(ActiveInCountriesRelationshipLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ActiveInCountriesRelationshipLinks getLinks() {
    return links;
  }

  public void setLinks(ActiveInCountriesRelationshipLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    ActiveInCountriesRelationship activeInCountriesRelationship = (ActiveInCountriesRelationship) o;
    return Objects.equals(this.data, activeInCountriesRelationship.data) &&
        Objects.equals(this.links, activeInCountriesRelationship.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActiveInCountriesRelationship {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActiveInCountriesRelationship
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActiveInCountriesRelationship.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActiveInCountriesRelationship is not found in the empty JSON string", ActiveInCountriesRelationship.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActiveInCountriesRelationship.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActiveInCountriesRelationship` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ActiveInCountriesRelationshipDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        ActiveInCountriesRelationshipLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActiveInCountriesRelationship.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActiveInCountriesRelationship' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActiveInCountriesRelationship> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActiveInCountriesRelationship.class));

       return (TypeAdapter<T>) new TypeAdapter<ActiveInCountriesRelationship>() {
           @Override
           public void write(JsonWriter out, ActiveInCountriesRelationship value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActiveInCountriesRelationship read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActiveInCountriesRelationship given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActiveInCountriesRelationship
   * @throws IOException if the JSON string is invalid with respect to ActiveInCountriesRelationship
   */
  public static ActiveInCountriesRelationship fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActiveInCountriesRelationship.class);
  }

  /**
   * Convert an instance of ActiveInCountriesRelationship to an JSON string
   *
   * @return JSON string
   */
