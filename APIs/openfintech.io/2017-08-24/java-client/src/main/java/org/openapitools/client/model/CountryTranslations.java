...
import org.openapitools.client.model.CountryTranslationsLinks;
...
public class CountryTranslations {
  ...
  private CountryTranslationsLinks links;

  public CountryTranslations() {
  }

  public CountryTranslations links(CountryTranslationsLinks links) {
    this.links = links;
    return this;
  }
  ...
  public CountryTranslationsLinks getLinks() {
    return links;
  }

  public void setLinks(CountryTranslationsLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    CountryTranslations countryTranslations = (CountryTranslations) o;
    return Objects.equals(this.links, countryTranslations.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class CountryTranslations {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CountryTranslations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CountryTranslations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CountryTranslations is not found in the empty JSON string", CountryTranslations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CountryTranslations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CountryTranslations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        CountryTranslationsLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CountryTranslations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CountryTranslations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CountryTranslations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CountryTranslations.class));

       return (TypeAdapter<T>) new TypeAdapter<CountryTranslations>() {
           @Override
           public void write(JsonWriter out, CountryTranslations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CountryTranslations read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CountryTranslations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CountryTranslations
   * @throws IOException if the JSON string is invalid with respect to CountryTranslations
   */
  public static CountryTranslations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CountryTranslations.class);
  }

  /**
   * Convert an instance of CountryTranslations to an JSON string
   *
   * @return JSON string
   */
