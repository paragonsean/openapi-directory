...
public class SupportedPspsRelationshipDataInner {
  ...
  public SupportedPspsRelationshipDataInner() {
  }

  public SupportedPspsRelationshipDataInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public SupportedPspsRelationshipDataInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SupportedPspsRelationshipDataInner supportedPspsRelationshipDataInner = (SupportedPspsRelationshipDataInner) o;
    return Objects.equals(this.id, supportedPspsRelationshipDataInner.id) &&
        Objects.equals(this.type, supportedPspsRelationshipDataInner.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupportedPspsRelationshipDataInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupportedPspsRelationshipDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupportedPspsRelationshipDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupportedPspsRelationshipDataInner is not found in the empty JSON string", SupportedPspsRelationshipDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupportedPspsRelationshipDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupportedPspsRelationshipDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupportedPspsRelationshipDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupportedPspsRelationshipDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupportedPspsRelationshipDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupportedPspsRelationshipDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SupportedPspsRelationshipDataInner>() {
           @Override
           public void write(JsonWriter out, SupportedPspsRelationshipDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupportedPspsRelationshipDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupportedPspsRelationshipDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupportedPspsRelationshipDataInner
   * @throws IOException if the JSON string is invalid with respect to SupportedPspsRelationshipDataInner
   */
  public static SupportedPspsRelationshipDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupportedPspsRelationshipDataInner.class);
  }

  /**
   * Convert an instance of SupportedPspsRelationshipDataInner to an JSON string
   *
   * @return JSON string
   */
