...
public class OrganizationAttributesIcon {
  ...
  public OrganizationAttributesIcon() {
  }

  public OrganizationAttributesIcon _16(String _16) {
    this._16 = _16;
    return this;
  }
  ...
  public OrganizationAttributesIcon _32(String _32) {
    this._32 = _32;
    return this;
  }
  ...
  public OrganizationAttributesIcon _64(String _64) {
    this._64 = _64;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrganizationAttributesIcon organizationAttributesIcon = (OrganizationAttributesIcon) o;
    return Objects.equals(this._16, organizationAttributesIcon._16) &&
        Objects.equals(this._32, organizationAttributesIcon._32) &&
        Objects.equals(this._64, organizationAttributesIcon._64);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationAttributesIcon {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationAttributesIcon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationAttributesIcon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationAttributesIcon is not found in the empty JSON string", OrganizationAttributesIcon.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationAttributesIcon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationAttributesIcon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationAttributesIcon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationAttributesIcon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationAttributesIcon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationAttributesIcon.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationAttributesIcon>() {
           @Override
           public void write(JsonWriter out, OrganizationAttributesIcon value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationAttributesIcon read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationAttributesIcon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationAttributesIcon
   * @throws IOException if the JSON string is invalid with respect to OrganizationAttributesIcon
   */
  public static OrganizationAttributesIcon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationAttributesIcon.class);
  }

  /**
   * Convert an instance of OrganizationAttributesIcon to an JSON string
   *
   * @return JSON string
   */
