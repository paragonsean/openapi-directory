...
public class ExchangerOrganizationLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public ExchangerOrganizationLinks() {
  }

  public ExchangerOrganizationLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    ExchangerOrganizationLinks exchangerOrganizationLinks = (ExchangerOrganizationLinks) o;
    return Objects.equals(this.related, exchangerOrganizationLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangerOrganizationLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangerOrganizationLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangerOrganizationLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangerOrganizationLinks is not found in the empty JSON string", ExchangerOrganizationLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangerOrganizationLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangerOrganizationLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangerOrganizationLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangerOrganizationLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangerOrganizationLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangerOrganizationLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangerOrganizationLinks>() {
           @Override
           public void write(JsonWriter out, ExchangerOrganizationLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangerOrganizationLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangerOrganizationLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangerOrganizationLinks
   * @throws IOException if the JSON string is invalid with respect to ExchangerOrganizationLinks
   */
  public static ExchangerOrganizationLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangerOrganizationLinks.class);
  }

  /**
   * Convert an instance of ExchangerOrganizationLinks to an JSON string
   *
   * @return JSON string
   */
