...
public class BankOrganizationLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public BankOrganizationLinks() {
  }

  public BankOrganizationLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    BankOrganizationLinks bankOrganizationLinks = (BankOrganizationLinks) o;
    return Objects.equals(this.related, bankOrganizationLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankOrganizationLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BankOrganizationLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BankOrganizationLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankOrganizationLinks is not found in the empty JSON string", BankOrganizationLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BankOrganizationLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BankOrganizationLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankOrganizationLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankOrganizationLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankOrganizationLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankOrganizationLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<BankOrganizationLinks>() {
           @Override
           public void write(JsonWriter out, BankOrganizationLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BankOrganizationLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BankOrganizationLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BankOrganizationLinks
   * @throws IOException if the JSON string is invalid with respect to BankOrganizationLinks
   */
  public static BankOrganizationLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankOrganizationLinks.class);
  }

  /**
   * Convert an instance of BankOrganizationLinks to an JSON string
   *
   * @return JSON string
   */
