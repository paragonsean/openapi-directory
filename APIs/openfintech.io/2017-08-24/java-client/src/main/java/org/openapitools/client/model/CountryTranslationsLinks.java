...
public class CountryTranslationsLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public CountryTranslationsLinks() {
  }

  public CountryTranslationsLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    CountryTranslationsLinks countryTranslationsLinks = (CountryTranslationsLinks) o;
    return Objects.equals(this.related, countryTranslationsLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class CountryTranslationsLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CountryTranslationsLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CountryTranslationsLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CountryTranslationsLinks is not found in the empty JSON string", CountryTranslationsLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CountryTranslationsLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CountryTranslationsLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CountryTranslationsLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CountryTranslationsLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CountryTranslationsLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CountryTranslationsLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<CountryTranslationsLinks>() {
           @Override
           public void write(JsonWriter out, CountryTranslationsLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CountryTranslationsLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CountryTranslationsLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CountryTranslationsLinks
   * @throws IOException if the JSON string is invalid with respect to CountryTranslationsLinks
   */
  public static CountryTranslationsLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CountryTranslationsLinks.class);
  }

  /**
   * Convert an instance of CountryTranslationsLinks to an JSON string
   *
   * @return JSON string
   */
