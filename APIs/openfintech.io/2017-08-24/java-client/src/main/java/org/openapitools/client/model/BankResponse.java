...
public class BankResponse {
  ...
  public BankResponse data(Bank data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, bankResponse.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BankResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BankResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankResponse is not found in the empty JSON string", BankResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BankResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BankResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Bank.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BankResponse>() {
           @Override
           public void write(JsonWriter out, BankResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BankResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BankResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BankResponse
   * @throws IOException if the JSON string is invalid with respect to BankResponse
   */
  public static BankResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankResponse.class);
  }

  /**
   * Convert an instance of BankResponse to an JSON string
   *
   * @return JSON string
   */
