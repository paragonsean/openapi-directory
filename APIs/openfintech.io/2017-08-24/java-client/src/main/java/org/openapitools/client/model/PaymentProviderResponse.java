...
public class PaymentProviderResponse {
  ...
  private PaymentProvider data;

  public PaymentProviderResponse() {
  }

  public PaymentProviderResponse data(PaymentProvider data) {
    this.data = data;
    return this;
  }
  ...
  public PaymentProvider getData() {
    return data;
  }

  public void setData(PaymentProvider data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentProviderResponse paymentProviderResponse = (PaymentProviderResponse) o;
    return Objects.equals(this.data, paymentProviderResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentProviderResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentProviderResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentProviderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentProviderResponse is not found in the empty JSON string", PaymentProviderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentProviderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentProviderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        PaymentProvider.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentProviderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentProviderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentProviderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentProviderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentProviderResponse>() {
           @Override
           public void write(JsonWriter out, PaymentProviderResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentProviderResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentProviderResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentProviderResponse
   * @throws IOException if the JSON string is invalid with respect to PaymentProviderResponse
   */
  public static PaymentProviderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentProviderResponse.class);
  }

  /**
   * Convert an instance of PaymentProviderResponse to an JSON string
   *
   * @return JSON string
   */
