...
import org.openapitools.client.model.PaymentMethodProcessorData;
import org.openapitools.client.model.PaymentMethodProcessorLinks;
...
public class PaymentMethodProcessor {
  ...
  private PaymentMethodProcessorData data;

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private PaymentMethodProcessorLinks links;

  public PaymentMethodProcessor() {
  }

  public PaymentMethodProcessor data(PaymentMethodProcessorData data) {
    this.data = data;
    return this;
  }
  ...
  public PaymentMethodProcessorData getData() {
    return data;
  }

  public void setData(PaymentMethodProcessorData data) {
    this.data = data;
  }


  public PaymentMethodProcessor links(PaymentMethodProcessorLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PaymentMethodProcessorLinks getLinks() {
    return links;
  }

  public void setLinks(PaymentMethodProcessorLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentMethodProcessor paymentMethodProcessor = (PaymentMethodProcessor) o;
    return Objects.equals(this.data, paymentMethodProcessor.data) &&
        Objects.equals(this.links, paymentMethodProcessor.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentMethodProcessor {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentMethodProcessor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentMethodProcessor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentMethodProcessor is not found in the empty JSON string", PaymentMethodProcessor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentMethodProcessor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentMethodProcessor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        PaymentMethodProcessorData.validateJsonElement(jsonObj.get("data"));
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        PaymentMethodProcessorLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentMethodProcessor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentMethodProcessor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentMethodProcessor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentMethodProcessor.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentMethodProcessor>() {
           @Override
           public void write(JsonWriter out, PaymentMethodProcessor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentMethodProcessor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentMethodProcessor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentMethodProcessor
   * @throws IOException if the JSON string is invalid with respect to PaymentMethodProcessor
   */
  public static PaymentMethodProcessor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentMethodProcessor.class);
  }

  /**
   * Convert an instance of PaymentMethodProcessor to an JSON string
   *
   * @return JSON string
   */
