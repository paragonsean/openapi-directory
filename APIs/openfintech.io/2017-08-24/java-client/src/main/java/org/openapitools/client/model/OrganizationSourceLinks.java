...
public class OrganizationSourceLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public OrganizationSourceLinks() {
  }

  public OrganizationSourceLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    OrganizationSourceLinks organizationSourceLinks = (OrganizationSourceLinks) o;
    return Objects.equals(this.related, organizationSourceLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationSourceLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationSourceLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationSourceLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationSourceLinks is not found in the empty JSON string", OrganizationSourceLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationSourceLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationSourceLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationSourceLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationSourceLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationSourceLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationSourceLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationSourceLinks>() {
           @Override
           public void write(JsonWriter out, OrganizationSourceLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationSourceLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationSourceLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationSourceLinks
   * @throws IOException if the JSON string is invalid with respect to OrganizationSourceLinks
   */
  public static OrganizationSourceLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationSourceLinks.class);
  }

  /**
   * Convert an instance of OrganizationSourceLinks to an JSON string
   *
   * @return JSON string
   */
