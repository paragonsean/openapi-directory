...
public class ExchangerOrganizationData {
  ...
  public ExchangerOrganizationData() {
  }

  public ExchangerOrganizationData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ExchangerOrganizationData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExchangerOrganizationData exchangerOrganizationData = (ExchangerOrganizationData) o;
    return Objects.equals(this.id, exchangerOrganizationData.id) &&
        Objects.equals(this.type, exchangerOrganizationData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangerOrganizationData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangerOrganizationData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangerOrganizationData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangerOrganizationData is not found in the empty JSON string", ExchangerOrganizationData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangerOrganizationData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangerOrganizationData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangerOrganizationData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangerOrganizationData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangerOrganizationData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangerOrganizationData.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangerOrganizationData>() {
           @Override
           public void write(JsonWriter out, ExchangerOrganizationData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangerOrganizationData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangerOrganizationData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangerOrganizationData
   * @throws IOException if the JSON string is invalid with respect to ExchangerOrganizationData
   */
  public static ExchangerOrganizationData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangerOrganizationData.class);
  }

  /**
   * Convert an instance of ExchangerOrganizationData to an JSON string
   *
   * @return JSON string
   */
