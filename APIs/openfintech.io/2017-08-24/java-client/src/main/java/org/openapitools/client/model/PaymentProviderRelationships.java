...
import org.openapitools.client.model.PaymentProviderOrganization;
import org.openapitools.client.model.PaymentProviderPaymentMethods;
...
public class PaymentProviderRelationships {
  public static final String SERIALIZED_NAME_ORGANIZATION = "organization";
  @SerializedName(SERIALIZED_NAME_ORGANIZATION)
  private PaymentProviderOrganization organization;

  public static final String SERIALIZED_NAME_PAYMENT_METHODS = "payment-methods";
  @SerializedName(SERIALIZED_NAME_PAYMENT_METHODS)
  private PaymentProviderPaymentMethods paymentMethods;

  public PaymentProviderRelationships() {
  }

  public PaymentProviderRelationships organization(PaymentProviderOrganization organization) {
  ...
  public PaymentProviderOrganization getOrganization() {
    return organization;
  }

  public void setOrganization(PaymentProviderOrganization organization) {
    this.organization = organization;
  }


  public PaymentProviderRelationships paymentMethods(PaymentProviderPaymentMethods paymentMethods) {
   ...
   */
  @javax.annotation.Nullable
  public PaymentProviderPaymentMethods getPaymentMethods() {
    return paymentMethods;
  }

  public void setPaymentMethods(PaymentProviderPaymentMethods paymentMethods) {
    this.paymentMethods = paymentMethods;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentProviderRelationships paymentProviderRelationships = (PaymentProviderRelationships) o;
    return Objects.equals(this.organization, paymentProviderRelationships.organization) &&
        Objects.equals(this.paymentMethods, paymentProviderRelationships.paymentMethods);
  }

  @Override
  public int hashCode() {
    return Objects.hash(organization, paymentMethods);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentProviderRelationships {\n");
  ...
  static {
    ...
    openapiFields.add("payment-methods");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentProviderRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentProviderRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentProviderRelationships is not found in the empty JSON string", PaymentProviderRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentProviderRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentProviderRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `organization`
      if (jsonObj.get("organization") != null && !jsonObj.get("organization").isJsonNull()) {
        PaymentProviderOrganization.validateJsonElement(jsonObj.get("organization"));
      }
      // validate the optional field `payment-methods`
      if (jsonObj.get("payment-methods") != null && !jsonObj.get("payment-methods").isJsonNull()) {
        PaymentProviderPaymentMethods.validateJsonElement(jsonObj.get("payment-methods"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentProviderRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentProviderRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentProviderRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentProviderRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentProviderRelationships>() {
           @Override
           public void write(JsonWriter out, PaymentProviderRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentProviderRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentProviderRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentProviderRelationships
   * @throws IOException if the JSON string is invalid with respect to PaymentProviderRelationships
   */
  public static PaymentProviderRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentProviderRelationships.class);
  }

  /**
   * Convert an instance of PaymentProviderRelationships to an JSON string
   *
   * @return JSON string
   */
