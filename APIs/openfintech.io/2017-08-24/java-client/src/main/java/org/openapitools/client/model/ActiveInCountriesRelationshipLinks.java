...
public class ActiveInCountriesRelationshipLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public ActiveInCountriesRelationshipLinks() {
  }

  public ActiveInCountriesRelationshipLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    ActiveInCountriesRelationshipLinks activeInCountriesRelationshipLinks = (ActiveInCountriesRelationshipLinks) o;
    return Objects.equals(this.related, activeInCountriesRelationshipLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActiveInCountriesRelationshipLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActiveInCountriesRelationshipLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActiveInCountriesRelationshipLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActiveInCountriesRelationshipLinks is not found in the empty JSON string", ActiveInCountriesRelationshipLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActiveInCountriesRelationshipLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActiveInCountriesRelationshipLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActiveInCountriesRelationshipLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActiveInCountriesRelationshipLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActiveInCountriesRelationshipLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActiveInCountriesRelationshipLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<ActiveInCountriesRelationshipLinks>() {
           @Override
           public void write(JsonWriter out, ActiveInCountriesRelationshipLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActiveInCountriesRelationshipLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActiveInCountriesRelationshipLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActiveInCountriesRelationshipLinks
   * @throws IOException if the JSON string is invalid with respect to ActiveInCountriesRelationshipLinks
   */
  public static ActiveInCountriesRelationshipLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActiveInCountriesRelationshipLinks.class);
  }

  /**
   * Convert an instance of ActiveInCountriesRelationshipLinks to an JSON string
   *
   * @return JSON string
   */
