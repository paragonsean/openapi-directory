...
public class ExchangerAttributes {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public static final String SERIALIZED_NAME_RATES_EXPORT_STANDARD = "rates_export_standard";
  @SerializedName(SERIALIZED_NAME_RATES_EXPORT_STANDARD)
  private String ratesExportStandard;

  public static final String SERIALIZED_NAME_RATES_EXPORT_URL = "rates_export_url";
  @SerializedName(SERIALIZED_NAME_RATES_EXPORT_URL)
  private String ratesExportUrl;

  public static final String SERIALIZED_NAME_STATUS = "status";
  @SerializedName(SERIALIZED_NAME_STATUS)
  private String status;

  public static final String SERIALIZED_NAME_WMID = "wmid";
  @SerializedName(SERIALIZED_NAME_WMID)
  private Integer wmid;

  public ExchangerAttributes() {
  }

  public ExchangerAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ExchangerAttributes ratesExportStandard(String ratesExportStandard) {
    this.ratesExportStandard = ratesExportStandard;
    return this;
  }

  /**
   * Get ratesExportStandard
   * @return ratesExportStandard
   */
  @javax.annotation.Nullable
  public String getRatesExportStandard() {
    return ratesExportStandard;
  }

  public void setRatesExportStandard(String ratesExportStandard) {
    this.ratesExportStandard = ratesExportStandard;
  }


  public ExchangerAttributes ratesExportUrl(String ratesExportUrl) {
    this.ratesExportUrl = ratesExportUrl;
    return this;
  }

  /**
   * Get ratesExportUrl
   * @return ratesExportUrl
   */
  @javax.annotation.Nullable
  public String getRatesExportUrl() {
    return ratesExportUrl;
  }

  public void setRatesExportUrl(String ratesExportUrl) {
    this.ratesExportUrl = ratesExportUrl;
  }


  public ExchangerAttributes status(String status) {
    this.status = status;
    return this;
  }
  ...
  public ExchangerAttributes wmid(Integer wmid) {
    this.wmid = wmid;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExchangerAttributes exchangerAttributes = (ExchangerAttributes) o;
    return Objects.equals(this.name, exchangerAttributes.name) &&
        Objects.equals(this.ratesExportStandard, exchangerAttributes.ratesExportStandard) &&
        Objects.equals(this.ratesExportUrl, exchangerAttributes.ratesExportUrl) &&
        Objects.equals(this.status, exchangerAttributes.status) &&
        Objects.equals(this.wmid, exchangerAttributes.wmid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, ratesExportStandard, ratesExportUrl, status, wmid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExchangerAttributes {\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    ratesExportStandard: ").append(toIndentedString(ratesExportStandard)).append("\n");
    sb.append("    ratesExportUrl: ").append(toIndentedString(ratesExportUrl)).append("\n");
    sb.append("    status: ").append(toIndentedString(status)).append("\n");
    sb.append("    wmid: ").append(toIndentedString(wmid)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("rates_export_standard");
    openapiFields.add("rates_export_url");
    openapiFields.add("status");
    openapiFields.add("wmid");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangerAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangerAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangerAttributes is not found in the empty JSON string", ExchangerAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangerAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangerAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("rates_export_standard") != null && !jsonObj.get("rates_export_standard").isJsonNull()) && !jsonObj.get("rates_export_standard").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `rates_export_standard` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rates_export_standard").toString()));
      }
      if ((jsonObj.get("rates_export_url") != null && !jsonObj.get("rates_export_url").isJsonNull()) && !jsonObj.get("rates_export_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `rates_export_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rates_export_url").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangerAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangerAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangerAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangerAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangerAttributes>() {
           @Override
           public void write(JsonWriter out, ExchangerAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangerAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangerAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangerAttributes
   * @throws IOException if the JSON string is invalid with respect to ExchangerAttributes
   */
  public static ExchangerAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangerAttributes.class);
  }

  /**
   * Convert an instance of ExchangerAttributes to an JSON string
   *
   * @return JSON string
   */
