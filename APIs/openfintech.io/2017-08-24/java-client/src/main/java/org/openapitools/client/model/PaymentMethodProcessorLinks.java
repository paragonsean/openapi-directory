...
public class PaymentMethodProcessorLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public PaymentMethodProcessorLinks() {
  }

  public PaymentMethodProcessorLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentMethodProcessorLinks paymentMethodProcessorLinks = (PaymentMethodProcessorLinks) o;
    return Objects.equals(this.related, paymentMethodProcessorLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentMethodProcessorLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentMethodProcessorLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentMethodProcessorLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentMethodProcessorLinks is not found in the empty JSON string", PaymentMethodProcessorLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentMethodProcessorLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentMethodProcessorLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentMethodProcessorLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentMethodProcessorLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentMethodProcessorLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentMethodProcessorLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentMethodProcessorLinks>() {
           @Override
           public void write(JsonWriter out, PaymentMethodProcessorLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentMethodProcessorLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentMethodProcessorLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentMethodProcessorLinks
   * @throws IOException if the JSON string is invalid with respect to PaymentMethodProcessorLinks
   */
  public static PaymentMethodProcessorLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentMethodProcessorLinks.class);
  }

  /**
   * Convert an instance of PaymentMethodProcessorLinks to an JSON string
   *
   * @return JSON string
   */
