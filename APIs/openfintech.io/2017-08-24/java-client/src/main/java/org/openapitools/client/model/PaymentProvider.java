...
import org.openapitools.client.model.PaymentProviderAttributes;
import org.openapitools.client.model.PaymentProviderRelationships;
...
public class PaymentProvider {
  ...
  private PaymentProviderAttributes attributes;
  ...
  private PaymentProviderRelationships relationships;
  ...
  public PaymentProvider attributes(PaymentProviderAttributes attributes) {
  ...
  public PaymentProviderAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(PaymentProviderAttributes attributes) {
    this.attributes = attributes;
  }


  public PaymentProvider id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PaymentProvider links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public PaymentProvider relationships(PaymentProviderRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public PaymentProviderRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(PaymentProviderRelationships relationships) {
    this.relationships = relationships;
  }


  public PaymentProvider type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, paymentProvider.attributes) &&
        Objects.equals(this.id, paymentProvider.id) &&
        Objects.equals(this.links, paymentProvider.links) &&
        Objects.equals(this.relationships, paymentProvider.relationships) &&
        Objects.equals(this.type, paymentProvider.type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        PaymentProviderAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        PaymentProviderRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
