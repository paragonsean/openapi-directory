...
public class PaymentProviderOrganization {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private PaymentProviderOrganizationData data;

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private PaymentProviderOrganizationLinks links;

  public PaymentProviderOrganization() {
  }

  public PaymentProviderOrganization data(PaymentProviderOrganizationData data) {
    this.data = data;
    return this;
  }
  ...
  public PaymentProviderOrganizationData getData() {
    return data;
  }

  public void setData(PaymentProviderOrganizationData data) {
    this.data = data;
  }


  public PaymentProviderOrganization links(PaymentProviderOrganizationLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PaymentProviderOrganizationLinks getLinks() {
    return links;
  }

  public void setLinks(PaymentProviderOrganizationLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentProviderOrganization paymentProviderOrganization = (PaymentProviderOrganization) o;
    return Objects.equals(this.data, paymentProviderOrganization.data) &&
        Objects.equals(this.links, paymentProviderOrganization.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentProviderOrganization {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentProviderOrganization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentProviderOrganization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentProviderOrganization is not found in the empty JSON string", PaymentProviderOrganization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentProviderOrganization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentProviderOrganization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        PaymentProviderOrganizationData.validateJsonElement(jsonObj.get("data"));
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        PaymentProviderOrganizationLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentProviderOrganization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentProviderOrganization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentProviderOrganization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentProviderOrganization.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentProviderOrganization>() {
           @Override
           public void write(JsonWriter out, PaymentProviderOrganization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentProviderOrganization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentProviderOrganization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentProviderOrganization
   * @throws IOException if the JSON string is invalid with respect to PaymentProviderOrganization
   */
  public static PaymentProviderOrganization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentProviderOrganization.class);
  }

  /**
   * Convert an instance of PaymentProviderOrganization to an JSON string
   *
   * @return JSON string
   */
