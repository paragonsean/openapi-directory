...
import org.openapitools.client.model.ExchangerOrganization;
...
public class ExchangerRelationships {
  public static final String SERIALIZED_NAME_ORGANIZATION = "organization";
  @SerializedName(SERIALIZED_NAME_ORGANIZATION)
  private ExchangerOrganization organization;

  public ExchangerRelationships() {
  }

  public ExchangerRelationships organization(ExchangerOrganization organization) {
  ...
  public ExchangerOrganization getOrganization() {
    return organization;
  }

  public void setOrganization(ExchangerOrganization organization) {
    this.organization = organization;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExchangerRelationships exchangerRelationships = (ExchangerRelationships) o;
    return Objects.equals(this.organization, exchangerRelationships.organization);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangerRelationships {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangerRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangerRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangerRelationships is not found in the empty JSON string", ExchangerRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangerRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangerRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `organization`
      if (jsonObj.get("organization") != null && !jsonObj.get("organization").isJsonNull()) {
        ExchangerOrganization.validateJsonElement(jsonObj.get("organization"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangerRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangerRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangerRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangerRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangerRelationships>() {
           @Override
           public void write(JsonWriter out, ExchangerRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangerRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangerRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangerRelationships
   * @throws IOException if the JSON string is invalid with respect to ExchangerRelationships
   */
  public static ExchangerRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangerRelationships.class);
  }

  /**
   * Convert an instance of ExchangerRelationships to an JSON string
   *
   * @return JSON string
   */
