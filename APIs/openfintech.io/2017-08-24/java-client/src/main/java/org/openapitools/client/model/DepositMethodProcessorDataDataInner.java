...
public class DepositMethodProcessorDataDataInner {
  ...
  public DepositMethodProcessorDataDataInner() {
  }

  public DepositMethodProcessorDataDataInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DepositMethodProcessorDataDataInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DepositMethodProcessorDataDataInner depositMethodProcessorDataDataInner = (DepositMethodProcessorDataDataInner) o;
    return Objects.equals(this.id, depositMethodProcessorDataDataInner.id) &&
        Objects.equals(this.type, depositMethodProcessorDataDataInner.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepositMethodProcessorDataDataInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DepositMethodProcessorDataDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DepositMethodProcessorDataDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepositMethodProcessorDataDataInner is not found in the empty JSON string", DepositMethodProcessorDataDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DepositMethodProcessorDataDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DepositMethodProcessorDataDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepositMethodProcessorDataDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepositMethodProcessorDataDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepositMethodProcessorDataDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepositMethodProcessorDataDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<DepositMethodProcessorDataDataInner>() {
           @Override
           public void write(JsonWriter out, DepositMethodProcessorDataDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DepositMethodProcessorDataDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DepositMethodProcessorDataDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DepositMethodProcessorDataDataInner
   * @throws IOException if the JSON string is invalid with respect to DepositMethodProcessorDataDataInner
   */
  public static DepositMethodProcessorDataDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepositMethodProcessorDataDataInner.class);
  }

  /**
   * Convert an instance of DepositMethodProcessorDataDataInner to an JSON string
   *
   * @return JSON string
   */
