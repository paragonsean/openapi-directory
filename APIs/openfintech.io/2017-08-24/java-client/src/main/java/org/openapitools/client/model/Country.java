...
import org.openapitools.client.model.CountryAttributes;
import org.openapitools.client.model.CountryRelationships;
import org.openapitools.client.model.SelfLinks;
...
public class Country {
  ...
  private CountryAttributes attributes;
  ...
  private CountryRelationships relationships;
  ...
  public Country attributes(CountryAttributes attributes) {
  ...
  public CountryAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(CountryAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public Country links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Country relationships(CountryRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public CountryRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(CountryRelationships relationships) {
    this.relationships = relationships;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, country.attributes) &&
        Objects.equals(this.id, country.id) &&
        Objects.equals(this.links, country.links) &&
        Objects.equals(this.relationships, country.relationships) &&
        Objects.equals(this.type, country.type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        CountryAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        SelfLinks.validateJsonElement(jsonObj.get("links"));
      }
      // validate the optional field `relationships`
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        CountryRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
