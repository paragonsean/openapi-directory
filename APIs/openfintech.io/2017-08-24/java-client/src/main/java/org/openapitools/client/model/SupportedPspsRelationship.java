...
public class SupportedPspsRelationship {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<SupportedPspsRelationshipDataInner> data = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private SupportedPspsRelationshipLinks links;

  public SupportedPspsRelationship() {
  }

  public SupportedPspsRelationship data(List<SupportedPspsRelationshipDataInner> data) {
    this.data = data;
    return this;
  }

  public SupportedPspsRelationship addDataItem(SupportedPspsRelationshipDataInner dataItem) {
    if (this.data == null) {
  ...
  public List<SupportedPspsRelationshipDataInner> getData() {
    return data;
  }

  public void setData(List<SupportedPspsRelationshipDataInner> data) {
    this.data = data;
  }


  public SupportedPspsRelationship links(SupportedPspsRelationshipLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SupportedPspsRelationshipLinks getLinks() {
    return links;
  }

  public void setLinks(SupportedPspsRelationshipLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    SupportedPspsRelationship supportedPspsRelationship = (SupportedPspsRelationship) o;
    return Objects.equals(this.data, supportedPspsRelationship.data) &&
        Objects.equals(this.links, supportedPspsRelationship.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupportedPspsRelationship {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupportedPspsRelationship
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupportedPspsRelationship.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupportedPspsRelationship is not found in the empty JSON string", SupportedPspsRelationship.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupportedPspsRelationship.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupportedPspsRelationship` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            SupportedPspsRelationshipDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        SupportedPspsRelationshipLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupportedPspsRelationship.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupportedPspsRelationship' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupportedPspsRelationship> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupportedPspsRelationship.class));

       return (TypeAdapter<T>) new TypeAdapter<SupportedPspsRelationship>() {
           @Override
           public void write(JsonWriter out, SupportedPspsRelationship value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupportedPspsRelationship read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupportedPspsRelationship given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupportedPspsRelationship
   * @throws IOException if the JSON string is invalid with respect to SupportedPspsRelationship
   */
  public static SupportedPspsRelationship fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupportedPspsRelationship.class);
  }

  /**
   * Convert an instance of SupportedPspsRelationship to an JSON string
   *
   * @return JSON string
   */
