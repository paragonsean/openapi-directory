...
import org.openapitools.client.model.OrganizationHqData;
import org.openapitools.client.model.OrganizationHqLinks;
...
public class OrganizationHq {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private OrganizationHqData data;

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private OrganizationHqLinks links;

  public OrganizationHq() {
  }

  public OrganizationHq data(OrganizationHqData data) {
    this.data = data;
    return this;
  }
  ...
  public OrganizationHqData getData() {
    return data;
  }

  public void setData(OrganizationHqData data) {
    this.data = data;
  }


  public OrganizationHq links(OrganizationHqLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public OrganizationHqLinks getLinks() {
    return links;
  }

  public void setLinks(OrganizationHqLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrganizationHq organizationHq = (OrganizationHq) o;
    return Objects.equals(this.data, organizationHq.data) &&
        Objects.equals(this.links, organizationHq.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationHq {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationHq
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationHq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationHq is not found in the empty JSON string", OrganizationHq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationHq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationHq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        OrganizationHqData.validateJsonElement(jsonObj.get("data"));
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        OrganizationHqLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationHq.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationHq' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationHq> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationHq.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationHq>() {
           @Override
           public void write(JsonWriter out, OrganizationHq value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationHq read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationHq given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationHq
   * @throws IOException if the JSON string is invalid with respect to OrganizationHq
   */
  public static OrganizationHq fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationHq.class);
  }

  /**
   * Convert an instance of OrganizationHq to an JSON string
   *
   * @return JSON string
   */
