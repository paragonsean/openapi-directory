...
public class PaymentMethodsApi {
     ...
     */
    public okhttp3.Call paymentMethodsGetCall(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, String filterProcessorName, Set<String> filterCategory, Set<String> sort, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call paymentMethodsGetValidateBeforeCall(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, String filterProcessorName, Set<String> filterCategory, Set<String> sort, final ApiCallback _callback) throws ApiException {
        return paymentMethodsGetCall(pageNumber, pageSize, filterSearch, filterName, filterCode, filterProcessorName, filterCategory, sort, _callback);
     ...
     */
    public PaymentMethodsResponse paymentMethodsGet(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, String filterProcessorName, Set<String> filterCategory, Set<String> sort) throws ApiException {
        ApiResponse<PaymentMethodsResponse> localVarResp = paymentMethodsGetWithHttpInfo(pageNumber, pageSize, filterSearch, filterName, filterCode, filterProcessorName, filterCategory, sort);
     ...
     */
    public ApiResponse<PaymentMethodsResponse> paymentMethodsGetWithHttpInfo(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, String filterProcessorName, Set<String> filterCategory, Set<String> sort) throws ApiException {
        okhttp3.Call localVarCall = paymentMethodsGetValidateBeforeCall(pageNumber, pageSize, filterSearch, filterName, filterCode, filterProcessorName, filterCategory, sort, null);
        Type localVarReturnType = new TypeToken<PaymentMethodsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List of payment methods (asynchronously)
     * Returns list of payment methods. Each object contains information about payment method such as name and category, also related link to payment method issuer (which processing it). 
     * @param pageNumber Current page number. (optional)
     * @param pageSize Page size.&lt;br&gt;*Default value: 100*  (optional)
     * @param filterSearch Full text search with id, name, code, category. (optional)
     ...
     */
    public okhttp3.Call paymentMethodsGetAsync(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, String filterProcessorName, Set<String> filterCategory, Set<String> sort, final ApiCallback<PaymentMethodsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = paymentMethodsGetValidateBeforeCall(pageNumber, pageSize, filterSearch, filterName, filterCode, filterProcessorName, filterCategory, sort, _callback);
        Type localVarReturnType = new TypeToken<PaymentMethodsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for paymentMethodsIdGet
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Payment method information. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Payment method ID is not valid. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call paymentMethodsIdGetCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call paymentMethodsIdGetValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling paymentMethodsIdGet(Async)");
        }

        return paymentMethodsIdGetCall(id, _callback);
     ...
     */
    public PaymentMethodResponse paymentMethodsIdGet(String id) throws ApiException {
        ApiResponse<PaymentMethodResponse> localVarResp = paymentMethodsIdGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PaymentMethodResponse> paymentMethodsIdGetWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = paymentMethodsIdGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<PaymentMethodResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Payment method by ID (asynchronously)
     * Returns payment method with specific ID. 
     * @param id Unique ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call paymentMethodsIdGetAsync(String id, final ApiCallback<PaymentMethodResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = paymentMethodsIdGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<PaymentMethodResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
