...
public class CurrencyParentLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public CurrencyParentLinks() {
  }

  public CurrencyParentLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    CurrencyParentLinks currencyParentLinks = (CurrencyParentLinks) o;
    return Objects.equals(this.related, currencyParentLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyParentLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyParentLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyParentLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyParentLinks is not found in the empty JSON string", CurrencyParentLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyParentLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyParentLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyParentLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyParentLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyParentLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyParentLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyParentLinks>() {
           @Override
           public void write(JsonWriter out, CurrencyParentLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyParentLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyParentLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyParentLinks
   * @throws IOException if the JSON string is invalid with respect to CurrencyParentLinks
   */
  public static CurrencyParentLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyParentLinks.class);
  }

  /**
   * Convert an instance of CurrencyParentLinks to an JSON string
   *
   * @return JSON string
   */
