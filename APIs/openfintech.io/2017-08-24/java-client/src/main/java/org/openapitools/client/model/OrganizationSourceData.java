...
public class OrganizationSourceData {
  ...
  public OrganizationSourceData() {
  }

  public OrganizationSourceData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public OrganizationSourceData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrganizationSourceData organizationSourceData = (OrganizationSourceData) o;
    return Objects.equals(this.id, organizationSourceData.id) &&
        Objects.equals(this.type, organizationSourceData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationSourceData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationSourceData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationSourceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationSourceData is not found in the empty JSON string", OrganizationSourceData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationSourceData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationSourceData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationSourceData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationSourceData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationSourceData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationSourceData.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationSourceData>() {
           @Override
           public void write(JsonWriter out, OrganizationSourceData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationSourceData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationSourceData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationSourceData
   * @throws IOException if the JSON string is invalid with respect to OrganizationSourceData
   */
  public static OrganizationSourceData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationSourceData.class);
  }

  /**
   * Convert an instance of OrganizationSourceData to an JSON string
   *
   * @return JSON string
   */
