...
public class DepositMethodAttributes {
  ...
  public static final String SERIALIZED_NAME_PROCESSOR_NAME = "processor_name";
  @SerializedName(SERIALIZED_NAME_PROCESSOR_NAME)
  private String processorName;

  public DepositMethodAttributes() {
  }

  public DepositMethodAttributes category(String category) {
  ...
  public DepositMethodAttributes code(String code) {
    this.code = code;
    return this;
  }
  ...
  public DepositMethodAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DepositMethodAttributes processorName(String processorName) {
  ...
  public boolean equals(Object o) {
    ...
    DepositMethodAttributes depositMethodAttributes = (DepositMethodAttributes) o;
    return Objects.equals(this.category, depositMethodAttributes.category) &&
        Objects.equals(this.code, depositMethodAttributes.code) &&
        Objects.equals(this.name, depositMethodAttributes.name) &&
        Objects.equals(this.processorName, depositMethodAttributes.processorName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(category, code, name, processorName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DepositMethodAttributes {\n");
  ...
  static {
    ...
    openapiFields.add("processor_name");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DepositMethodAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DepositMethodAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepositMethodAttributes is not found in the empty JSON string", DepositMethodAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DepositMethodAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DepositMethodAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("processor_name") != null && !jsonObj.get("processor_name").isJsonNull()) && !jsonObj.get("processor_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `processor_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("processor_name").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepositMethodAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepositMethodAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepositMethodAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepositMethodAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<DepositMethodAttributes>() {
           @Override
           public void write(JsonWriter out, DepositMethodAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DepositMethodAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DepositMethodAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DepositMethodAttributes
   * @throws IOException if the JSON string is invalid with respect to DepositMethodAttributes
   */
  public static DepositMethodAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepositMethodAttributes.class);
  }

  /**
   * Convert an instance of DepositMethodAttributes to an JSON string
   *
   * @return JSON string
   */
