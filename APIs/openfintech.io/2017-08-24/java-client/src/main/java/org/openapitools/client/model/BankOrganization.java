...
public class BankOrganization {
  ...
  private BankOrganizationData data;

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private BankOrganizationLinks links;

  public BankOrganization() {
  }

  public BankOrganization data(BankOrganizationData data) {
    this.data = data;
    return this;
  }
  ...
  public BankOrganizationData getData() {
    return data;
  }

  public void setData(BankOrganizationData data) {
    this.data = data;
  }


  public BankOrganization links(BankOrganizationLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public BankOrganizationLinks getLinks() {
    return links;
  }

  public void setLinks(BankOrganizationLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    BankOrganization bankOrganization = (BankOrganization) o;
    return Objects.equals(this.data, bankOrganization.data) &&
        Objects.equals(this.links, bankOrganization.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankOrganization {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BankOrganization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BankOrganization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankOrganization is not found in the empty JSON string", BankOrganization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BankOrganization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BankOrganization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        BankOrganizationData.validateJsonElement(jsonObj.get("data"));
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        BankOrganizationLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankOrganization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankOrganization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankOrganization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankOrganization.class));

       return (TypeAdapter<T>) new TypeAdapter<BankOrganization>() {
           @Override
           public void write(JsonWriter out, BankOrganization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BankOrganization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BankOrganization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BankOrganization
   * @throws IOException if the JSON string is invalid with respect to BankOrganization
   */
  public static BankOrganization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankOrganization.class);
  }

  /**
   * Convert an instance of BankOrganization to an JSON string
   *
   * @return JSON string
   */
