...
import org.openapitools.client.model.DepositMethodResponse;
import org.openapitools.client.model.DepositMethodsResponse;
...
public class DepositMethodsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public DepositMethodsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public DepositMethodsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for depositMethodsGet
     * @param pageNumber Current page number. (optional)
     * @param pageSize Page size.&lt;br&gt;*Default value: 100*  (optional)
     * @param filterSearch Full text search with id, name, code, category. (optional)
     * @param filterName Filtering by name. (optional)
     * @param filterCode Filtering by code. (optional)
     * @param filterProcessorName Filtering by processor_name. (optional)
     * @param filterCategory Filtering by category. (optional)
     * @param sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | code | -code | | processor_name | -processor_name | | category | -category |  (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> List of deposit methods. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call depositMethodsGetCall(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, String filterProcessorName, Set<String> filterCategory, Set<String> sort, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/deposit-methods";
        ...
        if (filterProcessorName != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("filter[processor_name]", filterProcessorName));
        }
    ...
    private okhttp3.Call depositMethodsGetValidateBeforeCall(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, String filterProcessorName, Set<String> filterCategory, Set<String> sort, final ApiCallback _callback) throws ApiException {
        return depositMethodsGetCall(pageNumber, pageSize, filterSearch, filterName, filterCode, filterProcessorName, filterCategory, sort, _callback);
     ...
     */
    public DepositMethodsResponse depositMethodsGet(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, String filterProcessorName, Set<String> filterCategory, Set<String> sort) throws ApiException {
        ApiResponse<DepositMethodsResponse> localVarResp = depositMethodsGetWithHttpInfo(pageNumber, pageSize, filterSearch, filterName, filterCode, filterProcessorName, filterCategory, sort);
     ...
     * @param filterCategory Filtering by category. (optional)
     * @param sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | code | -code | | processor_name | -processor_name | | category | -category |  (optional)
     * @return ApiResponse&lt;DepositMethodsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<DepositMethodsResponse> depositMethodsGetWithHttpInfo(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, String filterProcessorName, Set<String> filterCategory, Set<String> sort) throws ApiException {
        okhttp3.Call localVarCall = depositMethodsGetValidateBeforeCall(pageNumber, pageSize, filterSearch, filterName, filterCode, filterProcessorName, filterCategory, sort, null);
        Type localVarReturnType = new TypeToken<DepositMethodsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List of deposit methods (asynchronously)
     * Returns list of deposit methods. Each object contains information about deposit method such as name and category, also related link to deposit method issuer (which processing it). 
     * @param pageNumber Current page number. (optional)
     * @param pageSize Page size.&lt;br&gt;*Default value: 100*  (optional)
     * @param filterSearch Full text search with id, name, code, category. (optional)
     ...
     */
    public okhttp3.Call depositMethodsGetAsync(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, String filterProcessorName, Set<String> filterCategory, Set<String> sort, final ApiCallback<DepositMethodsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = depositMethodsGetValidateBeforeCall(pageNumber, pageSize, filterSearch, filterName, filterCode, filterProcessorName, filterCategory, sort, _callback);
        Type localVarReturnType = new TypeToken<DepositMethodsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for depositMethodsIdGet
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Deposit method information. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> deposit method ID is not valid. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call depositMethodsIdGetCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/deposit-methods/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call depositMethodsIdGetValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling depositMethodsIdGet(Async)");
        }

        return depositMethodsIdGetCall(id, _callback);
     ...
     */
    public DepositMethodResponse depositMethodsIdGet(String id) throws ApiException {
        ApiResponse<DepositMethodResponse> localVarResp = depositMethodsIdGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Returns deposit method with specific ID. 
     * @param id Unique ID. (required)
     * @return ApiResponse&lt;DepositMethodResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<DepositMethodResponse> depositMethodsIdGetWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = depositMethodsIdGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<DepositMethodResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Deposit method by ID (asynchronously)
     * Returns deposit method with specific ID. 
     * @param id Unique ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call depositMethodsIdGetAsync(String id, final ApiCallback<DepositMethodResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = depositMethodsIdGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<DepositMethodResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
