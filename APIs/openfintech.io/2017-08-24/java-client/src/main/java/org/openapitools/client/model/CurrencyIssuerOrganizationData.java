...
public class CurrencyIssuerOrganizationData {
  ...
  public CurrencyIssuerOrganizationData() {
  }

  public CurrencyIssuerOrganizationData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CurrencyIssuerOrganizationData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CurrencyIssuerOrganizationData currencyIssuerOrganizationData = (CurrencyIssuerOrganizationData) o;
    return Objects.equals(this.id, currencyIssuerOrganizationData.id) &&
        Objects.equals(this.type, currencyIssuerOrganizationData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyIssuerOrganizationData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyIssuerOrganizationData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyIssuerOrganizationData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyIssuerOrganizationData is not found in the empty JSON string", CurrencyIssuerOrganizationData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyIssuerOrganizationData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyIssuerOrganizationData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyIssuerOrganizationData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyIssuerOrganizationData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyIssuerOrganizationData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyIssuerOrganizationData.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyIssuerOrganizationData>() {
           @Override
           public void write(JsonWriter out, CurrencyIssuerOrganizationData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyIssuerOrganizationData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyIssuerOrganizationData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyIssuerOrganizationData
   * @throws IOException if the JSON string is invalid with respect to CurrencyIssuerOrganizationData
   */
  public static CurrencyIssuerOrganizationData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyIssuerOrganizationData.class);
  }

  /**
   * Convert an instance of CurrencyIssuerOrganizationData to an JSON string
   *
   * @return JSON string
   */
