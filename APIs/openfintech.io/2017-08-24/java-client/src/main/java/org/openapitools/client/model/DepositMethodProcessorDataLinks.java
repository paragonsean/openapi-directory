...
public class DepositMethodProcessorDataLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public DepositMethodProcessorDataLinks() {
  }

  public DepositMethodProcessorDataLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    DepositMethodProcessorDataLinks depositMethodProcessorDataLinks = (DepositMethodProcessorDataLinks) o;
    return Objects.equals(this.related, depositMethodProcessorDataLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepositMethodProcessorDataLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DepositMethodProcessorDataLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DepositMethodProcessorDataLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepositMethodProcessorDataLinks is not found in the empty JSON string", DepositMethodProcessorDataLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DepositMethodProcessorDataLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DepositMethodProcessorDataLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepositMethodProcessorDataLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepositMethodProcessorDataLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepositMethodProcessorDataLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepositMethodProcessorDataLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<DepositMethodProcessorDataLinks>() {
           @Override
           public void write(JsonWriter out, DepositMethodProcessorDataLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DepositMethodProcessorDataLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DepositMethodProcessorDataLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DepositMethodProcessorDataLinks
   * @throws IOException if the JSON string is invalid with respect to DepositMethodProcessorDataLinks
   */
  public static DepositMethodProcessorDataLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepositMethodProcessorDataLinks.class);
  }

  /**
   * Convert an instance of DepositMethodProcessorDataLinks to an JSON string
   *
   * @return JSON string
   */
