...
public class PaymentProviderOrganizationLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public PaymentProviderOrganizationLinks() {
  }

  public PaymentProviderOrganizationLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentProviderOrganizationLinks paymentProviderOrganizationLinks = (PaymentProviderOrganizationLinks) o;
    return Objects.equals(this.related, paymentProviderOrganizationLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentProviderOrganizationLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentProviderOrganizationLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentProviderOrganizationLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentProviderOrganizationLinks is not found in the empty JSON string", PaymentProviderOrganizationLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentProviderOrganizationLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentProviderOrganizationLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentProviderOrganizationLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentProviderOrganizationLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentProviderOrganizationLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentProviderOrganizationLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentProviderOrganizationLinks>() {
           @Override
           public void write(JsonWriter out, PaymentProviderOrganizationLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentProviderOrganizationLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentProviderOrganizationLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentProviderOrganizationLinks
   * @throws IOException if the JSON string is invalid with respect to PaymentProviderOrganizationLinks
   */
  public static PaymentProviderOrganizationLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentProviderOrganizationLinks.class);
  }

  /**
   * Convert an instance of PaymentProviderOrganizationLinks to an JSON string
   *
   * @return JSON string
   */
