...
public class PaymentProviderAttributes {
  ...
  public PaymentProviderAttributes() {
  }

  public PaymentProviderAttributes code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PaymentProviderAttributes features(List<String> features) {
    this.features = features;
    return this;
  }

  public PaymentProviderAttributes addFeaturesItem(String featuresItem) {
  ...
  public PaymentProviderAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PaymentProviderAttributes salesChannels(List<String> salesChannels) {
    this.salesChannels = salesChannels;
    return this;
  }

  public PaymentProviderAttributes addSalesChannelsItem(String salesChannelsItem) {
  ...
  public PaymentProviderAttributes types(List<String> types) {
    this.types = types;
    return this;
  }

  public PaymentProviderAttributes addTypesItem(String typesItem) {
    if (this.types == null) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentProviderAttributes paymentProviderAttributes = (PaymentProviderAttributes) o;
    return Objects.equals(this.code, paymentProviderAttributes.code) &&
        Objects.equals(this.features, paymentProviderAttributes.features) &&
        Objects.equals(this.name, paymentProviderAttributes.name) &&
        Objects.equals(this.salesChannels, paymentProviderAttributes.salesChannels) &&
        Objects.equals(this.types, paymentProviderAttributes.types);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, features, name, salesChannels, types);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentProviderAttributes {\n");
  ...
  static {
    ...
    openapiFields.add("sales_channels");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentProviderAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentProviderAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentProviderAttributes is not found in the empty JSON string", PaymentProviderAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentProviderAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentProviderAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("sales_channels") != null && !jsonObj.get("sales_channels").isJsonNull() && !jsonObj.get("sales_channels").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `sales_channels` to be an array in the JSON string but got `%s`", jsonObj.get("sales_channels").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentProviderAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentProviderAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentProviderAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentProviderAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentProviderAttributes>() {
           @Override
           public void write(JsonWriter out, PaymentProviderAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentProviderAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentProviderAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentProviderAttributes
   * @throws IOException if the JSON string is invalid with respect to PaymentProviderAttributes
   */
  public static PaymentProviderAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentProviderAttributes.class);
  }

  /**
   * Convert an instance of PaymentProviderAttributes to an JSON string
   *
   * @return JSON string
   */
