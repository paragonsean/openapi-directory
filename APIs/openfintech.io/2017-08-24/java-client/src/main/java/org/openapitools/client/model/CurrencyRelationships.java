...
import org.openapitools.client.model.CurrencyCountries;
import org.openapitools.client.model.CurrencyIssuer;
import org.openapitools.client.model.CurrencyIssuerOrganization;
...
public class CurrencyRelationships {
  ...
  private CurrencyCountries countries;

  public static final String SERIALIZED_NAME_ISSUER = "issuer";
  @SerializedName(SERIALIZED_NAME_ISSUER)
  private CurrencyIssuer issuer;

  public static final String SERIALIZED_NAME_ISSUER_ORGANIZATION = "issuer_organization";
  @SerializedName(SERIALIZED_NAME_ISSUER_ORGANIZATION)
  private CurrencyIssuerOrganization issuerOrganization;

  public static final String SERIALIZED_NAME_PARENT = "parent";
  @SerializedName(SERIALIZED_NAME_PARENT)
  private CurrencyParent parent;

  public CurrencyRelationships() {
  }

  public CurrencyRelationships countries(CurrencyCountries countries) {
  ...
  public CurrencyCountries getCountries() {
    return countries;
  }

  public void setCountries(CurrencyCountries countries) {
    this.countries = countries;
  }


  public CurrencyRelationships issuer(CurrencyIssuer issuer) {
    this.issuer = issuer;
    return this;
  }
  ...
  public void setIssuer(CurrencyIssuer issuer) {
    this.issuer = issuer;
  }


  public CurrencyRelationships issuerOrganization(CurrencyIssuerOrganization issuerOrganization) {
   ...
   */
  @javax.annotation.Nullable
  public CurrencyIssuerOrganization getIssuerOrganization() {
    return issuerOrganization;
  }

  public void setIssuerOrganization(CurrencyIssuerOrganization issuerOrganization) {
    this.issuerOrganization = issuerOrganization;
  }


  public CurrencyRelationships parent(CurrencyParent parent) {
    this.parent = parent;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CurrencyParent getParent() {
    return parent;
  }

  public void setParent(CurrencyParent parent) {
    this.parent = parent;
  }
  ...
  public boolean equals(Object o) {
    ...
    CurrencyRelationships currencyRelationships = (CurrencyRelationships) o;
    return Objects.equals(this.countries, currencyRelationships.countries) &&
        Objects.equals(this.issuer, currencyRelationships.issuer) &&
        Objects.equals(this.issuerOrganization, currencyRelationships.issuerOrganization) &&
        Objects.equals(this.parent, currencyRelationships.parent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(countries, issuer, issuerOrganization, parent);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CurrencyRelationships {\n");
  ...
  static {
    ...
    openapiFields.add("issuer_organization");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyRelationships
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyRelationships.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyRelationships is not found in the empty JSON string", CurrencyRelationships.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyRelationships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyRelationships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `countries`
      if (jsonObj.get("countries") != null && !jsonObj.get("countries").isJsonNull()) {
        CurrencyCountries.validateJsonElement(jsonObj.get("countries"));
      }
      // validate the optional field `issuer`
      if (jsonObj.get("issuer") != null && !jsonObj.get("issuer").isJsonNull()) {
        CurrencyIssuer.validateJsonElement(jsonObj.get("issuer"));
      }
      // validate the optional field `issuer_organization`
      if (jsonObj.get("issuer_organization") != null && !jsonObj.get("issuer_organization").isJsonNull()) {
        CurrencyIssuerOrganization.validateJsonElement(jsonObj.get("issuer_organization"));
      }
      // validate the optional field `parent`
      if (jsonObj.get("parent") != null && !jsonObj.get("parent").isJsonNull()) {
        CurrencyParent.validateJsonElement(jsonObj.get("parent"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyRelationships.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyRelationships' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyRelationships> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyRelationships.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyRelationships>() {
           @Override
           public void write(JsonWriter out, CurrencyRelationships value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyRelationships read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyRelationships given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyRelationships
   * @throws IOException if the JSON string is invalid with respect to CurrencyRelationships
   */
  public static CurrencyRelationships fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyRelationships.class);
  }

  /**
   * Convert an instance of CurrencyRelationships to an JSON string
   *
   * @return JSON string
   */
