...
public class CurrenciesResponse {
  ...
  public CurrenciesResponse data(List<Currency> data) {
    this.data = data;
    return this;
  }

  public CurrenciesResponse addDataItem(Currency dataItem) {
    if (this.data == null) {
  ...
  public CurrenciesResponse links(ResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public CurrenciesResponse meta(ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CurrenciesResponse currenciesResponse = (CurrenciesResponse) o;
    return Objects.equals(this.data, currenciesResponse.data) &&
        Objects.equals(this.links, currenciesResponse.links) &&
        Objects.equals(this.meta, currenciesResponse.meta);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrenciesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrenciesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrenciesResponse is not found in the empty JSON string", CurrenciesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrenciesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrenciesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrenciesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrenciesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrenciesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrenciesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrenciesResponse>() {
           @Override
           public void write(JsonWriter out, CurrenciesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrenciesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrenciesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrenciesResponse
   * @throws IOException if the JSON string is invalid with respect to CurrenciesResponse
   */
  public static CurrenciesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrenciesResponse.class);
  }

  /**
   * Convert an instance of CurrenciesResponse to an JSON string
   *
   * @return JSON string
   */
