...
public class MerchantIndustryAttributes {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public MerchantIndustryAttributes() {
  }

  public MerchantIndustryAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MerchantIndustryAttributes merchantIndustryAttributes = (MerchantIndustryAttributes) o;
    return Objects.equals(this.name, merchantIndustryAttributes.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class MerchantIndustryAttributes {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MerchantIndustryAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantIndustryAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantIndustryAttributes is not found in the empty JSON string", MerchantIndustryAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantIndustryAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantIndustryAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantIndustryAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantIndustryAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantIndustryAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantIndustryAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantIndustryAttributes>() {
           @Override
           public void write(JsonWriter out, MerchantIndustryAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MerchantIndustryAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MerchantIndustryAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MerchantIndustryAttributes
   * @throws IOException if the JSON string is invalid with respect to MerchantIndustryAttributes
   */
  public static MerchantIndustryAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantIndustryAttributes.class);
  }

  /**
   * Convert an instance of MerchantIndustryAttributes to an JSON string
   *
   * @return JSON string
   */
