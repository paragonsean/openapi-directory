...
import org.openapitools.client.model.CurrencyIssuerOrganizationData;
import org.openapitools.client.model.CurrencyIssuerOrganizationLinks;
...
public class CurrencyIssuerOrganization {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private CurrencyIssuerOrganizationData data;

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private CurrencyIssuerOrganizationLinks links;

  public CurrencyIssuerOrganization() {
  }

  public CurrencyIssuerOrganization data(CurrencyIssuerOrganizationData data) {
    this.data = data;
    return this;
  }
  ...
  public CurrencyIssuerOrganizationData getData() {
    return data;
  }

  public void setData(CurrencyIssuerOrganizationData data) {
    this.data = data;
  }


  public CurrencyIssuerOrganization links(CurrencyIssuerOrganizationLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CurrencyIssuerOrganizationLinks getLinks() {
    return links;
  }

  public void setLinks(CurrencyIssuerOrganizationLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    CurrencyIssuerOrganization currencyIssuerOrganization = (CurrencyIssuerOrganization) o;
    return Objects.equals(this.data, currencyIssuerOrganization.data) &&
        Objects.equals(this.links, currencyIssuerOrganization.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyIssuerOrganization {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyIssuerOrganization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyIssuerOrganization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyIssuerOrganization is not found in the empty JSON string", CurrencyIssuerOrganization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyIssuerOrganization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyIssuerOrganization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        CurrencyIssuerOrganizationData.validateJsonElement(jsonObj.get("data"));
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        CurrencyIssuerOrganizationLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyIssuerOrganization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyIssuerOrganization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyIssuerOrganization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyIssuerOrganization.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyIssuerOrganization>() {
           @Override
           public void write(JsonWriter out, CurrencyIssuerOrganization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyIssuerOrganization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyIssuerOrganization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyIssuerOrganization
   * @throws IOException if the JSON string is invalid with respect to CurrencyIssuerOrganization
   */
  public static CurrencyIssuerOrganization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyIssuerOrganization.class);
  }

  /**
   * Convert an instance of CurrencyIssuerOrganization to an JSON string
   *
   * @return JSON string
   */
