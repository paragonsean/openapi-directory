...
public class ExchangersResponse {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<Exchanger> data = new ArrayList<>();
  ...
  public ExchangersResponse() {
  }

  public ExchangersResponse data(List<Exchanger> data) {
    this.data = data;
    return this;
  }

  public ExchangersResponse addDataItem(Exchanger dataItem) {
    if (this.data == null) {
  ...
  public List<Exchanger> getData() {
    return data;
  }

  public void setData(List<Exchanger> data) {
    this.data = data;
  }


  public ExchangersResponse links(ResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public ExchangersResponse meta(ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExchangersResponse exchangersResponse = (ExchangersResponse) o;
    return Objects.equals(this.data, exchangersResponse.data) &&
        Objects.equals(this.links, exchangersResponse.links) &&
        Objects.equals(this.meta, exchangersResponse.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangersResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangersResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangersResponse is not found in the empty JSON string", ExchangersResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangersResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangersResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Exchanger.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangersResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangersResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangersResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangersResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangersResponse>() {
           @Override
           public void write(JsonWriter out, ExchangersResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangersResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangersResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangersResponse
   * @throws IOException if the JSON string is invalid with respect to ExchangersResponse
   */
  public static ExchangersResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangersResponse.class);
  }

  /**
   * Convert an instance of ExchangersResponse to an JSON string
   *
   * @return JSON string
   */
