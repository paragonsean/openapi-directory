...
import org.openapitools.client.model.MerchantIndustriesResponse;
import org.openapitools.client.model.MerchantIndustryResponse;
...
public class MerchantIndustriesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MerchantIndustriesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MerchantIndustriesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for merchantIndustriesGet
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> List of Merchant industries. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call merchantIndustriesGetCall(Integer pageNumber, Integer pageSize, String filterName, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/merchant-industries";
    ...
    private okhttp3.Call merchantIndustriesGetValidateBeforeCall(Integer pageNumber, Integer pageSize, String filterName, final ApiCallback _callback) throws ApiException {
        return merchantIndustriesGetCall(pageNumber, pageSize, filterName, _callback);
     ...
     */
    public MerchantIndustriesResponse merchantIndustriesGet(Integer pageNumber, Integer pageSize, String filterName) throws ApiException {
        ApiResponse<MerchantIndustriesResponse> localVarResp = merchantIndustriesGetWithHttpInfo(pageNumber, pageSize, filterName);
     ...
     * @param pageSize Page size.&lt;br&gt;*Default value: 100*  (optional)
     * @param filterName Filtering by name. (optional)
     * @return ApiResponse&lt;MerchantIndustriesResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<MerchantIndustriesResponse> merchantIndustriesGetWithHttpInfo(Integer pageNumber, Integer pageSize, String filterName) throws ApiException {
        okhttp3.Call localVarCall = merchantIndustriesGetValidateBeforeCall(pageNumber, pageSize, filterName, null);
        Type localVarReturnType = new TypeToken<MerchantIndustriesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List of merchant industries (asynchronously)
     * Returns all available merchant fields of activity. 
     * @param pageNumber Current page number. (optional)
     * @param pageSize Page size.&lt;br&gt;*Default value: 100*  (optional)
     * @param filterName Filtering by name. (optional)
     ...
     */
    public okhttp3.Call merchantIndustriesGetAsync(Integer pageNumber, Integer pageSize, String filterName, final ApiCallback<MerchantIndustriesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = merchantIndustriesGetValidateBeforeCall(pageNumber, pageSize, filterName, _callback);
        Type localVarReturnType = new TypeToken<MerchantIndustriesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for merchantIndustriesIdGet
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Merchant industry. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Merchant industry ID is not valid. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call merchantIndustriesIdGetCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/merchant-industries/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call merchantIndustriesIdGetValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling merchantIndustriesIdGet(Async)");
        }

        return merchantIndustriesIdGetCall(id, _callback);
     ...
     */
    public MerchantIndustryResponse merchantIndustriesIdGet(String id) throws ApiException {
        ApiResponse<MerchantIndustryResponse> localVarResp = merchantIndustriesIdGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Returns merchant industry with specific ID. 
     * @param id Unique ID. (required)
     * @return ApiResponse&lt;MerchantIndustryResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<MerchantIndustryResponse> merchantIndustriesIdGetWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = merchantIndustriesIdGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<MerchantIndustryResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Merchant industry by ID (asynchronously)
     * Returns merchant industry with specific ID. 
     * @param id Unique ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call merchantIndustriesIdGetAsync(String id, final ApiCallback<MerchantIndustryResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = merchantIndustriesIdGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<MerchantIndustryResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
