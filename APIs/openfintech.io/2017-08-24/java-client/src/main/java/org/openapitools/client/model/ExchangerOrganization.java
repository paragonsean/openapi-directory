...
import org.openapitools.client.model.ExchangerOrganizationData;
import org.openapitools.client.model.ExchangerOrganizationLinks;
...
public class ExchangerOrganization {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private ExchangerOrganizationData data;

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private ExchangerOrganizationLinks links;

  public ExchangerOrganization() {
  }

  public ExchangerOrganization data(ExchangerOrganizationData data) {
    this.data = data;
    return this;
  }
  ...
  public ExchangerOrganizationData getData() {
    return data;
  }

  public void setData(ExchangerOrganizationData data) {
    this.data = data;
  }


  public ExchangerOrganization links(ExchangerOrganizationLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ExchangerOrganizationLinks getLinks() {
    return links;
  }

  public void setLinks(ExchangerOrganizationLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExchangerOrganization exchangerOrganization = (ExchangerOrganization) o;
    return Objects.equals(this.data, exchangerOrganization.data) &&
        Objects.equals(this.links, exchangerOrganization.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangerOrganization {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangerOrganization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangerOrganization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangerOrganization is not found in the empty JSON string", ExchangerOrganization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangerOrganization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangerOrganization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ExchangerOrganizationData.validateJsonElement(jsonObj.get("data"));
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        ExchangerOrganizationLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangerOrganization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangerOrganization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangerOrganization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangerOrganization.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangerOrganization>() {
           @Override
           public void write(JsonWriter out, ExchangerOrganization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangerOrganization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangerOrganization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangerOrganization
   * @throws IOException if the JSON string is invalid with respect to ExchangerOrganization
   */
  public static ExchangerOrganization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangerOrganization.class);
  }

  /**
   * Convert an instance of ExchangerOrganization to an JSON string
   *
   * @return JSON string
   */
