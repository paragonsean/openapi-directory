...
import org.openapitools.client.model.ResponseLinks;
...
public class PaymentProvidersResponse {
  ...
  private List<PaymentProvider> data = new ArrayList<>();
  ...
  public PaymentProvidersResponse data(List<PaymentProvider> data) {
    this.data = data;
    return this;
  }

  public PaymentProvidersResponse addDataItem(PaymentProvider dataItem) {
    if (this.data == null) {
  ...
  public List<PaymentProvider> getData() {
    return data;
  }

  public void setData(List<PaymentProvider> data) {
    this.data = data;
  }


  public PaymentProvidersResponse links(ResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public PaymentProvidersResponse meta(ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentProvidersResponse paymentProvidersResponse = (PaymentProvidersResponse) o;
    return Objects.equals(this.data, paymentProvidersResponse.data) &&
        Objects.equals(this.links, paymentProvidersResponse.links) &&
        Objects.equals(this.meta, paymentProvidersResponse.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentProvidersResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentProvidersResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentProvidersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentProvidersResponse is not found in the empty JSON string", PaymentProvidersResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentProvidersResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentProvidersResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            PaymentProvider.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        ResponseLinks.validateJsonElement(jsonObj.get("links"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentProvidersResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentProvidersResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentProvidersResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentProvidersResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentProvidersResponse>() {
           @Override
           public void write(JsonWriter out, PaymentProvidersResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentProvidersResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentProvidersResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentProvidersResponse
   * @throws IOException if the JSON string is invalid with respect to PaymentProvidersResponse
   */
  public static PaymentProvidersResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentProvidersResponse.class);
  }

  /**
   * Convert an instance of PaymentProvidersResponse to an JSON string
   *
   * @return JSON string
   */
