...
public class CurrencyAttributesIcon {
  ...
  public CurrencyAttributesIcon() {
  }

  public CurrencyAttributesIcon _16(String _16) {
    this._16 = _16;
    return this;
  }
  ...
  public CurrencyAttributesIcon _32(String _32) {
    this._32 = _32;
    return this;
  }
  ...
  public CurrencyAttributesIcon _64(String _64) {
    this._64 = _64;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CurrencyAttributesIcon currencyAttributesIcon = (CurrencyAttributesIcon) o;
    return Objects.equals(this._16, currencyAttributesIcon._16) &&
        Objects.equals(this._32, currencyAttributesIcon._32) &&
        Objects.equals(this._64, currencyAttributesIcon._64);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyAttributesIcon {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyAttributesIcon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyAttributesIcon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyAttributesIcon is not found in the empty JSON string", CurrencyAttributesIcon.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyAttributesIcon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyAttributesIcon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyAttributesIcon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyAttributesIcon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyAttributesIcon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyAttributesIcon.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyAttributesIcon>() {
           @Override
           public void write(JsonWriter out, CurrencyAttributesIcon value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyAttributesIcon read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyAttributesIcon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyAttributesIcon
   * @throws IOException if the JSON string is invalid with respect to CurrencyAttributesIcon
   */
  public static CurrencyAttributesIcon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyAttributesIcon.class);
  }

  /**
   * Convert an instance of CurrencyAttributesIcon to an JSON string
   *
   * @return JSON string
   */
