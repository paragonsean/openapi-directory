...
public class PaymentMethodAttributes {
  ...
  public PaymentMethodAttributes category(String category) {
  ...
  public PaymentMethodAttributes code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PaymentMethodAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PaymentMethodAttributes processorName(String processorName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.category, paymentMethodAttributes.category) &&
        Objects.equals(this.code, paymentMethodAttributes.code) &&
        Objects.equals(this.name, paymentMethodAttributes.name) &&
        Objects.equals(this.processorName, paymentMethodAttributes.processorName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentMethodAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentMethodAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentMethodAttributes is not found in the empty JSON string", PaymentMethodAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentMethodAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentMethodAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentMethodAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentMethodAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentMethodAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentMethodAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentMethodAttributes>() {
           @Override
           public void write(JsonWriter out, PaymentMethodAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentMethodAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentMethodAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentMethodAttributes
   * @throws IOException if the JSON string is invalid with respect to PaymentMethodAttributes
   */
  public static PaymentMethodAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentMethodAttributes.class);
  }

  /**
   * Convert an instance of PaymentMethodAttributes to an JSON string
   *
   * @return JSON string
   */
