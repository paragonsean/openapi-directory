...
import org.openapitools.client.model.MerchantIndustry;
...
public class MerchantIndustriesResponse {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<MerchantIndustry> data = new ArrayList<>();
  ...
  public MerchantIndustriesResponse() {
  }

  public MerchantIndustriesResponse data(List<MerchantIndustry> data) {
    this.data = data;
    return this;
  }

  public MerchantIndustriesResponse addDataItem(MerchantIndustry dataItem) {
    if (this.data == null) {
  ...
  public List<MerchantIndustry> getData() {
    return data;
  }

  public void setData(List<MerchantIndustry> data) {
    this.data = data;
  }


  public MerchantIndustriesResponse links(ResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public MerchantIndustriesResponse meta(ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MerchantIndustriesResponse merchantIndustriesResponse = (MerchantIndustriesResponse) o;
    return Objects.equals(this.data, merchantIndustriesResponse.data) &&
        Objects.equals(this.links, merchantIndustriesResponse.links) &&
        Objects.equals(this.meta, merchantIndustriesResponse.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class MerchantIndustriesResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MerchantIndustriesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantIndustriesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantIndustriesResponse is not found in the empty JSON string", MerchantIndustriesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantIndustriesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantIndustriesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            MerchantIndustry.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantIndustriesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantIndustriesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantIndustriesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantIndustriesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantIndustriesResponse>() {
           @Override
           public void write(JsonWriter out, MerchantIndustriesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MerchantIndustriesResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MerchantIndustriesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MerchantIndustriesResponse
   * @throws IOException if the JSON string is invalid with respect to MerchantIndustriesResponse
   */
  public static MerchantIndustriesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantIndustriesResponse.class);
  }

  /**
   * Convert an instance of MerchantIndustriesResponse to an JSON string
   *
   * @return JSON string
   */
