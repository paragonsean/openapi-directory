...
public class ApiClient {
    ...
    private String basePath = "https://api.openfintech.io/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2017-08-24/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.openfintech.io/v1
