...
import org.openapitools.client.model.CurrencyIssuerLinks;
import org.openapitools.client.model.CurrencyIssuertData;
...
public class CurrencyIssuer {
  ...
  private CurrencyIssuertData data;

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private CurrencyIssuerLinks links;

  public CurrencyIssuer() {
  }

  public CurrencyIssuer data(CurrencyIssuertData data) {
    this.data = data;
    return this;
  }
  ...
  public CurrencyIssuertData getData() {
    return data;
  }

  public void setData(CurrencyIssuertData data) {
    this.data = data;
  }


  public CurrencyIssuer links(CurrencyIssuerLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CurrencyIssuerLinks getLinks() {
    return links;
  }

  public void setLinks(CurrencyIssuerLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    CurrencyIssuer currencyIssuer = (CurrencyIssuer) o;
    return Objects.equals(this.data, currencyIssuer.data) &&
        Objects.equals(this.links, currencyIssuer.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyIssuer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyIssuer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyIssuer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyIssuer is not found in the empty JSON string", CurrencyIssuer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyIssuer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyIssuer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        CurrencyIssuertData.validateJsonElement(jsonObj.get("data"));
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        CurrencyIssuerLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyIssuer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyIssuer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyIssuer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyIssuer.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyIssuer>() {
           @Override
           public void write(JsonWriter out, CurrencyIssuer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyIssuer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyIssuer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyIssuer
   * @throws IOException if the JSON string is invalid with respect to CurrencyIssuer
   */
  public static CurrencyIssuer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyIssuer.class);
  }

  /**
   * Convert an instance of CurrencyIssuer to an JSON string
   *
   * @return JSON string
   */
