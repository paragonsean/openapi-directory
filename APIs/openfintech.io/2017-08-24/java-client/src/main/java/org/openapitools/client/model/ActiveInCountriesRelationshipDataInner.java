...
public class ActiveInCountriesRelationshipDataInner {
  ...
  public ActiveInCountriesRelationshipDataInner() {
  }

  public ActiveInCountriesRelationshipDataInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ActiveInCountriesRelationshipDataInner type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ActiveInCountriesRelationshipDataInner activeInCountriesRelationshipDataInner = (ActiveInCountriesRelationshipDataInner) o;
    return Objects.equals(this.id, activeInCountriesRelationshipDataInner.id) &&
        Objects.equals(this.type, activeInCountriesRelationshipDataInner.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActiveInCountriesRelationshipDataInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActiveInCountriesRelationshipDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActiveInCountriesRelationshipDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActiveInCountriesRelationshipDataInner is not found in the empty JSON string", ActiveInCountriesRelationshipDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActiveInCountriesRelationshipDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActiveInCountriesRelationshipDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActiveInCountriesRelationshipDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActiveInCountriesRelationshipDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActiveInCountriesRelationshipDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActiveInCountriesRelationshipDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ActiveInCountriesRelationshipDataInner>() {
           @Override
           public void write(JsonWriter out, ActiveInCountriesRelationshipDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActiveInCountriesRelationshipDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActiveInCountriesRelationshipDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActiveInCountriesRelationshipDataInner
   * @throws IOException if the JSON string is invalid with respect to ActiveInCountriesRelationshipDataInner
   */
  public static ActiveInCountriesRelationshipDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActiveInCountriesRelationshipDataInner.class);
  }

  /**
   * Convert an instance of ActiveInCountriesRelationshipDataInner to an JSON string
   *
   * @return JSON string
   */
