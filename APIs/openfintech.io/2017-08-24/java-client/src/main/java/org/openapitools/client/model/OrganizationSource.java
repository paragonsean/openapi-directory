...
import org.openapitools.client.model.OrganizationSourceData;
import org.openapitools.client.model.OrganizationSourceLinks;
...
public class OrganizationSource {
  ...
  private OrganizationSourceData data;

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private OrganizationSourceLinks links;

  public OrganizationSource() {
  }

  public OrganizationSource data(OrganizationSourceData data) {
    this.data = data;
    return this;
  }
  ...
  public OrganizationSourceData getData() {
    return data;
  }

  public void setData(OrganizationSourceData data) {
    this.data = data;
  }


  public OrganizationSource links(OrganizationSourceLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public OrganizationSourceLinks getLinks() {
    return links;
  }

  public void setLinks(OrganizationSourceLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrganizationSource organizationSource = (OrganizationSource) o;
    return Objects.equals(this.data, organizationSource.data) &&
        Objects.equals(this.links, organizationSource.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationSource is not found in the empty JSON string", OrganizationSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        OrganizationSourceData.validateJsonElement(jsonObj.get("data"));
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        OrganizationSourceLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationSource.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationSource>() {
           @Override
           public void write(JsonWriter out, OrganizationSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationSource
   * @throws IOException if the JSON string is invalid with respect to OrganizationSource
   */
  public static OrganizationSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationSource.class);
  }

  /**
   * Convert an instance of OrganizationSource to an JSON string
   *
   * @return JSON string
   */
