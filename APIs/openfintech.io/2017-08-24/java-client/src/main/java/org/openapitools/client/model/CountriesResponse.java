...
public class CountriesResponse {
  ...
  public CountriesResponse data(List<Country> data) {
    this.data = data;
    return this;
  }

  public CountriesResponse addDataItem(Country dataItem) {
    if (this.data == null) {
  ...
  public CountriesResponse links(ResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public CountriesResponse meta(ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, countriesResponse.data) &&
        Objects.equals(this.links, countriesResponse.links) &&
        Objects.equals(this.meta, countriesResponse.meta);
  }
