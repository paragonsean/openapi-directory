...
import org.openapitools.client.model.PaymentProviderPaymentMethodsLinks;
...
public class PaymentProviderPaymentMethods {
  ...
  private PaymentProviderPaymentMethodsLinks links;

  public PaymentProviderPaymentMethods() {
  }

  public PaymentProviderPaymentMethods data(List<String> data) {
    this.data = data;
    return this;
  }

  public PaymentProviderPaymentMethods addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public PaymentProviderPaymentMethods links(PaymentProviderPaymentMethodsLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PaymentProviderPaymentMethodsLinks getLinks() {
    return links;
  }

  public void setLinks(PaymentProviderPaymentMethodsLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentProviderPaymentMethods paymentProviderPaymentMethods = (PaymentProviderPaymentMethods) o;
    return Objects.equals(this.data, paymentProviderPaymentMethods.data) &&
        Objects.equals(this.links, paymentProviderPaymentMethods.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentProviderPaymentMethods {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentProviderPaymentMethods
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentProviderPaymentMethods.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentProviderPaymentMethods is not found in the empty JSON string", PaymentProviderPaymentMethods.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentProviderPaymentMethods.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentProviderPaymentMethods` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        PaymentProviderPaymentMethodsLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentProviderPaymentMethods.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentProviderPaymentMethods' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentProviderPaymentMethods> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentProviderPaymentMethods.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentProviderPaymentMethods>() {
           @Override
           public void write(JsonWriter out, PaymentProviderPaymentMethods value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentProviderPaymentMethods read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentProviderPaymentMethods given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentProviderPaymentMethods
   * @throws IOException if the JSON string is invalid with respect to PaymentProviderPaymentMethods
   */
  public static PaymentProviderPaymentMethods fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentProviderPaymentMethods.class);
  }

  /**
   * Convert an instance of PaymentProviderPaymentMethods to an JSON string
   *
   * @return JSON string
   */
