...
public class BanksResponse {
  ...
  public BanksResponse data(List<Bank> data) {
    this.data = data;
    return this;
  }

  public BanksResponse addDataItem(Bank dataItem) {
    if (this.data == null) {
  ...
  public BanksResponse links(ResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public BanksResponse meta(ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, banksResponse.data) &&
        Objects.equals(this.links, banksResponse.links) &&
        Objects.equals(this.meta, banksResponse.meta);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BanksResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BanksResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BanksResponse is not found in the empty JSON string", BanksResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BanksResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BanksResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Bank.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BanksResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BanksResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BanksResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BanksResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BanksResponse>() {
           @Override
           public void write(JsonWriter out, BanksResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BanksResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BanksResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BanksResponse
   * @throws IOException if the JSON string is invalid with respect to BanksResponse
   */
  public static BanksResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BanksResponse.class);
  }

  /**
   * Convert an instance of BanksResponse to an JSON string
   *
   * @return JSON string
   */
