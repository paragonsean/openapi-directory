...
import org.openapitools.client.model.BankResponse;
import org.openapitools.client.model.BanksResponse;
...
public class BanksApi {
     ...
     * @param filterSortCode Filtering by banks code. (optional)
     * @param filterCode Filtering by code. (optional)
     * @param filterStatus Filtration by status. (optional)
     * @param sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | code | -code | | status | -status | | sort_code | -sort_code |  (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> List of banks. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call banksGetCall(Integer pageNumber, Integer pageSize, String filterSortCode, String filterCode, Set<String> filterStatus, Set<String> sort, final ApiCallback _callback) throws ApiException {
        ...
        if (filterSortCode != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("filter[sort_code]", filterSortCode));
        }
    ...
    private okhttp3.Call banksGetValidateBeforeCall(Integer pageNumber, Integer pageSize, String filterSortCode, String filterCode, Set<String> filterStatus, Set<String> sort, final ApiCallback _callback) throws ApiException {
        return banksGetCall(pageNumber, pageSize, filterSortCode, filterCode, filterStatus, sort, _callback);
     ...
     */
    public BanksResponse banksGet(Integer pageNumber, Integer pageSize, String filterSortCode, String filterCode, Set<String> filterStatus, Set<String> sort) throws ApiException {
        ApiResponse<BanksResponse> localVarResp = banksGetWithHttpInfo(pageNumber, pageSize, filterSortCode, filterCode, filterStatus, sort);
     ...
     * @param filterStatus Filtration by status. (optional)
     * @param sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | code | -code | | status | -status | | sort_code | -sort_code |  (optional)
     * @return ApiResponse&lt;BanksResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BanksResponse> banksGetWithHttpInfo(Integer pageNumber, Integer pageSize, String filterSortCode, String filterCode, Set<String> filterStatus, Set<String> sort) throws ApiException {
        okhttp3.Call localVarCall = banksGetValidateBeforeCall(pageNumber, pageSize, filterSortCode, filterCode, filterStatus, sort, null);
        Type localVarReturnType = new TypeToken<BanksResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List of banks (asynchronously)
     * Returns list of banks. Each object contains general information about bank such as name and status, also information about bank details and related link to main organization. 
     * @param pageNumber Current page number. (optional)
     * @param pageSize Page size.&lt;br&gt;*Default value: 100*  (optional)
     * @param filterSortCode Filtering by banks code. (optional)
     ...
     */
    public okhttp3.Call banksGetAsync(Integer pageNumber, Integer pageSize, String filterSortCode, String filterCode, Set<String> filterStatus, Set<String> sort, final ApiCallback<BanksResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = banksGetValidateBeforeCall(pageNumber, pageSize, filterSortCode, filterCode, filterStatus, sort, _callback);
        Type localVarReturnType = new TypeToken<BanksResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for banksIdGet
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Bank information. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Bank ID is not valid. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call banksIdGetCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call banksIdGetValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling banksIdGet(Async)");
        }

        return banksIdGetCall(id, _callback);
     ...
     */
    public BankResponse banksIdGet(String id) throws ApiException {
        ApiResponse<BankResponse> localVarResp = banksIdGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<BankResponse> banksIdGetWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = banksIdGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<BankResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Bank by ID (asynchronously)
     * Returns bank with specific ID. 
     * @param id Unique ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call banksIdGetAsync(String id, final ApiCallback<BankResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = banksIdGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<BankResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
