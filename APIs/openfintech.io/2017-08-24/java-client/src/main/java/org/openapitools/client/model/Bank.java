...
public class Bank {
  ...
  private BankRelationships relationships;
  ...
  public Bank attributes(BankAttributes attributes) {
  ...
  public BankAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(BankAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public Bank links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Bank relationships(BankRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public BankRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(BankRelationships relationships) {
    this.relationships = relationships;
  }
  ...
  public boolean equals(Object o) {
    ...
    Bank bank = (Bank) o;
    return Objects.equals(this.attributes, bank.attributes) &&
        Objects.equals(this.id, bank.id) &&
        Objects.equals(this.links, bank.links) &&
        Objects.equals(this.relationships, bank.relationships) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        BankAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        BankRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
