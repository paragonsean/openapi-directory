...
import org.openapitools.client.model.Exchanger;
...
public class ExchangerResponse {
  ...
  private Exchanger data;

  public ExchangerResponse() {
  }

  public ExchangerResponse data(Exchanger data) {
    this.data = data;
    return this;
  }
  ...
  public Exchanger getData() {
    return data;
  }

  public void setData(Exchanger data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExchangerResponse exchangerResponse = (ExchangerResponse) o;
    return Objects.equals(this.data, exchangerResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExchangerResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExchangerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExchangerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExchangerResponse is not found in the empty JSON string", ExchangerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExchangerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExchangerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Exchanger.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExchangerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExchangerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExchangerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExchangerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ExchangerResponse>() {
           @Override
           public void write(JsonWriter out, ExchangerResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExchangerResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExchangerResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExchangerResponse
   * @throws IOException if the JSON string is invalid with respect to ExchangerResponse
   */
  public static ExchangerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExchangerResponse.class);
  }

  /**
   * Convert an instance of ExchangerResponse to an JSON string
   *
   * @return JSON string
   */
