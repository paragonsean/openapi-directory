...
public class CurrencyIssuertData {
  ...
  public CurrencyIssuertData() {
  }

  public CurrencyIssuertData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CurrencyIssuertData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CurrencyIssuertData currencyIssuertData = (CurrencyIssuertData) o;
    return Objects.equals(this.id, currencyIssuertData.id) &&
        Objects.equals(this.type, currencyIssuertData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyIssuertData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyIssuertData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyIssuertData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyIssuertData is not found in the empty JSON string", CurrencyIssuertData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyIssuertData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyIssuertData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyIssuertData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyIssuertData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyIssuertData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyIssuertData.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyIssuertData>() {
           @Override
           public void write(JsonWriter out, CurrencyIssuertData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyIssuertData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyIssuertData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyIssuertData
   * @throws IOException if the JSON string is invalid with respect to CurrencyIssuertData
   */
  public static CurrencyIssuertData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyIssuertData.class);
  }

  /**
   * Convert an instance of CurrencyIssuertData to an JSON string
   *
   * @return JSON string
   */
