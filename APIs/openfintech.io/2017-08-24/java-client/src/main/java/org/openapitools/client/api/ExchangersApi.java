...
public class ExchangersApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ExchangersApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ExchangersApi(ApiClient apiClient) {
     ...
     * @param sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | status | -status | | wmid | -wmid | | rate_type | -rate_type | | rates_export_standard | &lt;nobr&gt;-rates_export_standard&lt;/nobr&gt; |  (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> List of exchangers. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call exchangersGetCall(Integer pageNumber, Integer pageSize, String filterName, Set<String> filterStatus, Set<String> sort, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/exchangers";
    ...
    private okhttp3.Call exchangersGetValidateBeforeCall(Integer pageNumber, Integer pageSize, String filterName, Set<String> filterStatus, Set<String> sort, final ApiCallback _callback) throws ApiException {
        return exchangersGetCall(pageNumber, pageSize, filterName, filterStatus, sort, _callback);
     ...
     */
    public ExchangersResponse exchangersGet(Integer pageNumber, Integer pageSize, String filterName, Set<String> filterStatus, Set<String> sort) throws ApiException {
        ApiResponse<ExchangersResponse> localVarResp = exchangersGetWithHttpInfo(pageNumber, pageSize, filterName, filterStatus, sort);
     ...
     * @param filterStatus Filtration by status. (optional)
     * @param sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | status | -status | | wmid | -wmid | | rate_type | -rate_type | | rates_export_standard | &lt;nobr&gt;-rates_export_standard&lt;/nobr&gt; |  (optional)
     * @return ApiResponse&lt;ExchangersResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ExchangersResponse> exchangersGetWithHttpInfo(Integer pageNumber, Integer pageSize, String filterName, Set<String> filterStatus, Set<String> sort) throws ApiException {
        okhttp3.Call localVarCall = exchangersGetValidateBeforeCall(pageNumber, pageSize, filterName, filterStatus, sort, null);
        Type localVarReturnType = new TypeToken<ExchangersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List of exchangers (asynchronously)
     * Returns list of exchange markets. Each object contains general information about exchanger such as name and status, also information about rates export and related link to main organization.&lt;br&gt; Rates export standards is represented by: * [estandards](http://estandards.info) * [jsons](http://jsons.info) * ratex - our internal standard 
     * @param pageNumber Current page number. (optional)
     * @param pageSize Page size.&lt;br&gt;*Default value: 100*  (optional)
     * @param filterName Filtering by name. (optional)
     ...
     */
    public okhttp3.Call exchangersGetAsync(Integer pageNumber, Integer pageSize, String filterName, Set<String> filterStatus, Set<String> sort, final ApiCallback<ExchangersResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = exchangersGetValidateBeforeCall(pageNumber, pageSize, filterName, filterStatus, sort, _callback);
        Type localVarReturnType = new TypeToken<ExchangersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for exchangersIdGet
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Exchanger information. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Exchanger ID is not valid. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call exchangersIdGetCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/exchangers/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call exchangersIdGetValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling exchangersIdGet(Async)");
        }

        return exchangersIdGetCall(id, _callback);
     ...
     */
    public ExchangerResponse exchangersIdGet(String id) throws ApiException {
        ApiResponse<ExchangerResponse> localVarResp = exchangersIdGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Returns exchanger with specific ID. 
     * @param id Unique ID. (required)
     * @return ApiResponse&lt;ExchangerResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ExchangerResponse> exchangersIdGetWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = exchangersIdGetValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ExchangerResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Exchanger by ID (asynchronously)
     * Returns exchanger with specific ID. 
     * @param id Unique ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call exchangersIdGetAsync(String id, final ApiCallback<ExchangerResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = exchangersIdGetValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ExchangerResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
