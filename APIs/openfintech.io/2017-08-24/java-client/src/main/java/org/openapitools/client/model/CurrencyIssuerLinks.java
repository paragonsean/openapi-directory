...
public class CurrencyIssuerLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public CurrencyIssuerLinks() {
  }

  public CurrencyIssuerLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    CurrencyIssuerLinks currencyIssuerLinks = (CurrencyIssuerLinks) o;
    return Objects.equals(this.related, currencyIssuerLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyIssuerLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyIssuerLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyIssuerLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyIssuerLinks is not found in the empty JSON string", CurrencyIssuerLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyIssuerLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyIssuerLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyIssuerLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyIssuerLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyIssuerLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyIssuerLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyIssuerLinks>() {
           @Override
           public void write(JsonWriter out, CurrencyIssuerLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyIssuerLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyIssuerLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyIssuerLinks
   * @throws IOException if the JSON string is invalid with respect to CurrencyIssuerLinks
   */
  public static CurrencyIssuerLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyIssuerLinks.class);
  }

  /**
   * Convert an instance of CurrencyIssuerLinks to an JSON string
   *
   * @return JSON string
   */
