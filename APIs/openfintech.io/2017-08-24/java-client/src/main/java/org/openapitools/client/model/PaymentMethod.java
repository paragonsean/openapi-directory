...
import org.openapitools.client.model.PaymentMethodAttributes;
import org.openapitools.client.model.PaymentMethodRelationships;
...
public class PaymentMethod {
  ...
  private PaymentMethodRelationships relationships;
  ...
  public PaymentMethod attributes(PaymentMethodAttributes attributes) {
  ...
  public void setAttributes(PaymentMethodAttributes attributes) {
    this.attributes = attributes;
  }
  ...
  public PaymentMethod links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public PaymentMethod relationships(PaymentMethodRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public PaymentMethodRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(PaymentMethodRelationships relationships) {
    this.relationships = relationships;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, paymentMethod.attributes) &&
        Objects.equals(this.id, paymentMethod.id) &&
        Objects.equals(this.links, paymentMethod.links) &&
        Objects.equals(this.relationships, paymentMethod.relationships) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        PaymentMethodAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        PaymentMethodRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
