...
public class DepositMethodProcessorData {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<DepositMethodProcessorDataDataInner> data = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private DepositMethodProcessorDataLinks links;

  public DepositMethodProcessorData() {
  }

  public DepositMethodProcessorData data(List<DepositMethodProcessorDataDataInner> data) {
    this.data = data;
    return this;
  }

  public DepositMethodProcessorData addDataItem(DepositMethodProcessorDataDataInner dataItem) {
    if (this.data == null) {
  ...
  public List<DepositMethodProcessorDataDataInner> getData() {
    return data;
  }

  public void setData(List<DepositMethodProcessorDataDataInner> data) {
    this.data = data;
  }


  public DepositMethodProcessorData links(DepositMethodProcessorDataLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public DepositMethodProcessorDataLinks getLinks() {
    return links;
  }

  public void setLinks(DepositMethodProcessorDataLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    DepositMethodProcessorData depositMethodProcessorData = (DepositMethodProcessorData) o;
    return Objects.equals(this.data, depositMethodProcessorData.data) &&
        Objects.equals(this.links, depositMethodProcessorData.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepositMethodProcessorData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DepositMethodProcessorData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DepositMethodProcessorData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepositMethodProcessorData is not found in the empty JSON string", DepositMethodProcessorData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DepositMethodProcessorData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DepositMethodProcessorData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DepositMethodProcessorDataDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        DepositMethodProcessorDataLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepositMethodProcessorData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepositMethodProcessorData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepositMethodProcessorData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepositMethodProcessorData.class));

       return (TypeAdapter<T>) new TypeAdapter<DepositMethodProcessorData>() {
           @Override
           public void write(JsonWriter out, DepositMethodProcessorData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DepositMethodProcessorData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DepositMethodProcessorData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DepositMethodProcessorData
   * @throws IOException if the JSON string is invalid with respect to DepositMethodProcessorData
   */
  public static DepositMethodProcessorData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepositMethodProcessorData.class);
  }

  /**
   * Convert an instance of DepositMethodProcessorData to an JSON string
   *
   * @return JSON string
   */
