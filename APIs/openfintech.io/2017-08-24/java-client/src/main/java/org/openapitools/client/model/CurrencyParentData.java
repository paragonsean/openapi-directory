...
public class CurrencyParentData {
  ...
  public CurrencyParentData() {
  }

  public CurrencyParentData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CurrencyParentData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CurrencyParentData currencyParentData = (CurrencyParentData) o;
    return Objects.equals(this.id, currencyParentData.id) &&
        Objects.equals(this.type, currencyParentData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyParentData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyParentData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyParentData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyParentData is not found in the empty JSON string", CurrencyParentData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyParentData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyParentData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyParentData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyParentData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyParentData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyParentData.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyParentData>() {
           @Override
           public void write(JsonWriter out, CurrencyParentData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyParentData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyParentData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyParentData
   * @throws IOException if the JSON string is invalid with respect to CurrencyParentData
   */
  public static CurrencyParentData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyParentData.class);
  }

  /**
   * Convert an instance of CurrencyParentData to an JSON string
   *
   * @return JSON string
   */
