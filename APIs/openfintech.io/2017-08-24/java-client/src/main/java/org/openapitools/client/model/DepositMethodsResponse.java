...
import org.openapitools.client.model.DepositMethod;
...
public class DepositMethodsResponse {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<DepositMethod> data = new ArrayList<>();
  ...
  public DepositMethodsResponse() {
  }

  public DepositMethodsResponse data(List<DepositMethod> data) {
    this.data = data;
    return this;
  }

  public DepositMethodsResponse addDataItem(DepositMethod dataItem) {
    if (this.data == null) {
  ...
  public List<DepositMethod> getData() {
    return data;
  }

  public void setData(List<DepositMethod> data) {
    this.data = data;
  }


  public DepositMethodsResponse links(ResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public DepositMethodsResponse meta(ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DepositMethodsResponse depositMethodsResponse = (DepositMethodsResponse) o;
    return Objects.equals(this.data, depositMethodsResponse.data) &&
        Objects.equals(this.links, depositMethodsResponse.links) &&
        Objects.equals(this.meta, depositMethodsResponse.meta);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DepositMethodsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DepositMethodsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepositMethodsResponse is not found in the empty JSON string", DepositMethodsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DepositMethodsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DepositMethodsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DepositMethod.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepositMethodsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepositMethodsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepositMethodsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepositMethodsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DepositMethodsResponse>() {
           @Override
           public void write(JsonWriter out, DepositMethodsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DepositMethodsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DepositMethodsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DepositMethodsResponse
   * @throws IOException if the JSON string is invalid with respect to DepositMethodsResponse
   */
  public static DepositMethodsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepositMethodsResponse.class);
  }

  /**
   * Convert an instance of DepositMethodsResponse to an JSON string
   *
   * @return JSON string
   */
