...
public class ResponseLinks {
  ...
  public ResponseLinks first(String first) {
    this.first = first;
    return this;
  }
  ...
  public ResponseLinks last(String last) {
    this.last = last;
    return this;
  }
  ...
  public ResponseLinks next(String next) {
    this.next = next;
    return this;
  }
  ...
  public ResponseLinks prev(String prev) {
    this.prev = prev;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.first, responseLinks.first) &&
        Objects.equals(this.last, responseLinks.last) &&
        Objects.equals(this.next, responseLinks.next) &&
        Objects.equals(this.prev, responseLinks.prev);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponseLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ResponseLinks.openapiRequiredFields) {
