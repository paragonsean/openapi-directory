...
public class OrganizationsApi {
     ...
     * @param filterSearch Full text search with id, name, code. (optional)
     * @param filterName Filtering by name. (optional)
     * @param filterCode Filtering by code. (optional)
     * @param filterStatus Filtration by status. (optional)
     * @param filterIndustries Filtering by industries. (optional)
     * @param sort Sort params:&lt;br&gt;  | ASC | DESC | |-----|------| | name | -name | | code | -code | | status | -status | | description | -description |  (optional)
     ...
     */
    public okhttp3.Call organizationsGetCall(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, Set<String> filterStatus, String filterIndustries, Set<String> sort, final ApiCallback _callback) throws ApiException {
        ...
        if (filterIndustries != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("filter[industries]", filterIndustries));
        }
    ...
    private okhttp3.Call organizationsGetValidateBeforeCall(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, Set<String> filterStatus, String filterIndustries, Set<String> sort, final ApiCallback _callback) throws ApiException {
        return organizationsGetCall(pageNumber, pageSize, filterSearch, filterName, filterCode, filterStatus, filterIndustries, sort, _callback);
     ...
     */
    public OrganizationsResponse organizationsGet(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, Set<String> filterStatus, String filterIndustries, Set<String> sort) throws ApiException {
        ApiResponse<OrganizationsResponse> localVarResp = organizationsGetWithHttpInfo(pageNumber, pageSize, filterSearch, filterName, filterCode, filterStatus, filterIndustries, sort);
     ...
     */
    public ApiResponse<OrganizationsResponse> organizationsGetWithHttpInfo(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, Set<String> filterStatus, String filterIndustries, Set<String> sort) throws ApiException {
        okhttp3.Call localVarCall = organizationsGetValidateBeforeCall(pageNumber, pageSize, filterSearch, filterName, filterCode, filterStatus, filterIndustries, sort, null);
        Type localVarReturnType = new TypeToken<OrganizationsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List of organizations (asynchronously)
     * This endpoint retrievs the list of organizations present in the system. The data displays general, public information, without reference to the type of activity (for example - name, address, contacts, etc.). 
     * @param pageNumber Current page number. (optional)
     * @param pageSize Page size.&lt;br&gt;*Default value: 100*  (optional)
     * @param filterSearch Full text search with id, name, code. (optional)
     ...
     */
    public okhttp3.Call organizationsGetAsync(Integer pageNumber, Integer pageSize, String filterSearch, String filterName, String filterCode, Set<String> filterStatus, String filterIndustries, Set<String> sort, final ApiCallback<OrganizationsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = organizationsGetValidateBeforeCall(pageNumber, pageSize, filterSearch, filterName, filterCode, filterStatus, filterIndustries, sort, _callback);
        Type localVarReturnType = new TypeToken<OrganizationsResponse>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Organization information. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Organization ID is not valid. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call organizationsIdGetCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call organizationsIdGetValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
     ...
     */
    public OrganizationResponse organizationsIdGet(String id) throws ApiException {
        ApiResponse<OrganizationResponse> localVarResp = organizationsIdGetWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OrganizationResponse> organizationsIdGetWithHttpInfo(String id) throws ApiException {
    ...
    /**
     * Organization by ID (asynchronously)
     * Returns organization with specific ID. 
     * @param id Unique ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call organizationsIdGetAsync(String id, final ApiCallback<OrganizationResponse> _callback) throws ApiException {
