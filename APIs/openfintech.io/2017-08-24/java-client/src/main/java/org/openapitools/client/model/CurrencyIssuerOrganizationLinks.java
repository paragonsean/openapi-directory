...
public class CurrencyIssuerOrganizationLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public CurrencyIssuerOrganizationLinks() {
  }

  public CurrencyIssuerOrganizationLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    CurrencyIssuerOrganizationLinks currencyIssuerOrganizationLinks = (CurrencyIssuerOrganizationLinks) o;
    return Objects.equals(this.related, currencyIssuerOrganizationLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyIssuerOrganizationLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyIssuerOrganizationLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyIssuerOrganizationLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyIssuerOrganizationLinks is not found in the empty JSON string", CurrencyIssuerOrganizationLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyIssuerOrganizationLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyIssuerOrganizationLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyIssuerOrganizationLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyIssuerOrganizationLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyIssuerOrganizationLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyIssuerOrganizationLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyIssuerOrganizationLinks>() {
           @Override
           public void write(JsonWriter out, CurrencyIssuerOrganizationLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyIssuerOrganizationLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyIssuerOrganizationLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyIssuerOrganizationLinks
   * @throws IOException if the JSON string is invalid with respect to CurrencyIssuerOrganizationLinks
   */
  public static CurrencyIssuerOrganizationLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyIssuerOrganizationLinks.class);
  }

  /**
   * Convert an instance of CurrencyIssuerOrganizationLinks to an JSON string
   *
   * @return JSON string
   */
