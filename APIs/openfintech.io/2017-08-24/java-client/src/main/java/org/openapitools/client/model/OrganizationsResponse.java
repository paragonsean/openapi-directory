...
public class OrganizationsResponse {
  ...
  public OrganizationsResponse data(List<Organization> data) {
    this.data = data;
    return this;
  }

  public OrganizationsResponse addDataItem(Organization dataItem) {
    if (this.data == null) {
  ...
  public OrganizationsResponse links(ResponseLinks links) {
    this.links = links;
    return this;
  }
  ...
  public OrganizationsResponse meta(ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, organizationsResponse.data) &&
        Objects.equals(this.links, organizationsResponse.links) &&
        Objects.equals(this.meta, organizationsResponse.meta);
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Organization.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
