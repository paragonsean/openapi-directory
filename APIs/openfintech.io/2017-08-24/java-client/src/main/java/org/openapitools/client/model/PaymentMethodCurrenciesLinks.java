...
public class PaymentMethodCurrenciesLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public PaymentMethodCurrenciesLinks() {
  }

  public PaymentMethodCurrenciesLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentMethodCurrenciesLinks paymentMethodCurrenciesLinks = (PaymentMethodCurrenciesLinks) o;
    return Objects.equals(this.related, paymentMethodCurrenciesLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentMethodCurrenciesLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentMethodCurrenciesLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentMethodCurrenciesLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentMethodCurrenciesLinks is not found in the empty JSON string", PaymentMethodCurrenciesLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentMethodCurrenciesLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentMethodCurrenciesLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentMethodCurrenciesLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentMethodCurrenciesLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentMethodCurrenciesLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentMethodCurrenciesLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentMethodCurrenciesLinks>() {
           @Override
           public void write(JsonWriter out, PaymentMethodCurrenciesLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentMethodCurrenciesLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentMethodCurrenciesLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentMethodCurrenciesLinks
   * @throws IOException if the JSON string is invalid with respect to PaymentMethodCurrenciesLinks
   */
  public static PaymentMethodCurrenciesLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentMethodCurrenciesLinks.class);
  }

  /**
   * Convert an instance of PaymentMethodCurrenciesLinks to an JSON string
   *
   * @return JSON string
   */
