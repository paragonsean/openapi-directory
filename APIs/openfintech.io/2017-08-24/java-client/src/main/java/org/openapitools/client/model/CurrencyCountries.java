...
import org.openapitools.client.model.CurrencyCountryLinks;
...
public class CurrencyCountries {
  ...
  private CurrencyCountryLinks links;

  public CurrencyCountries() {
  }

  public CurrencyCountries links(CurrencyCountryLinks links) {
    this.links = links;
    return this;
  }
  ...
  public CurrencyCountryLinks getLinks() {
    return links;
  }

  public void setLinks(CurrencyCountryLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, currencyCountries.links);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrencyCountries
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrencyCountries.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrencyCountries is not found in the empty JSON string", CurrencyCountries.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyCountries.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyCountries` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `links`
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        CurrencyCountryLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrencyCountries.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrencyCountries' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrencyCountries> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrencyCountries.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrencyCountries>() {
           @Override
           public void write(JsonWriter out, CurrencyCountries value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrencyCountries read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrencyCountries given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrencyCountries
   * @throws IOException if the JSON string is invalid with respect to CurrencyCountries
   */
  public static CurrencyCountries fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrencyCountries.class);
  }

  /**
   * Convert an instance of CurrencyCountries to an JSON string
   *
   * @return JSON string
   */
