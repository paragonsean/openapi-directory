...
public class MerchantIndustryResponse {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private MerchantIndustry data;

  public MerchantIndustryResponse() {
  }

  public MerchantIndustryResponse data(MerchantIndustry data) {
    this.data = data;
    return this;
  }
  ...
  public MerchantIndustry getData() {
    return data;
  }

  public void setData(MerchantIndustry data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    MerchantIndustryResponse merchantIndustryResponse = (MerchantIndustryResponse) o;
    return Objects.equals(this.data, merchantIndustryResponse.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class MerchantIndustryResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MerchantIndustryResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantIndustryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantIndustryResponse is not found in the empty JSON string", MerchantIndustryResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantIndustryResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantIndustryResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        MerchantIndustry.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantIndustryResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantIndustryResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantIndustryResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantIndustryResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantIndustryResponse>() {
           @Override
           public void write(JsonWriter out, MerchantIndustryResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MerchantIndustryResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MerchantIndustryResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MerchantIndustryResponse
   * @throws IOException if the JSON string is invalid with respect to MerchantIndustryResponse
   */
  public static MerchantIndustryResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantIndustryResponse.class);
  }

  /**
   * Convert an instance of MerchantIndustryResponse to an JSON string
   *
   * @return JSON string
   */
