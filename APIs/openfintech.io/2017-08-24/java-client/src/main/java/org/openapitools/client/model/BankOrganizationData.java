...
public class BankOrganizationData {
  ...
  public BankOrganizationData() {
  }

  public BankOrganizationData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public BankOrganizationData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BankOrganizationData bankOrganizationData = (BankOrganizationData) o;
    return Objects.equals(this.id, bankOrganizationData.id) &&
        Objects.equals(this.type, bankOrganizationData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class BankOrganizationData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BankOrganizationData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BankOrganizationData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankOrganizationData is not found in the empty JSON string", BankOrganizationData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BankOrganizationData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BankOrganizationData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankOrganizationData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankOrganizationData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankOrganizationData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankOrganizationData.class));

       return (TypeAdapter<T>) new TypeAdapter<BankOrganizationData>() {
           @Override
           public void write(JsonWriter out, BankOrganizationData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BankOrganizationData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BankOrganizationData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BankOrganizationData
   * @throws IOException if the JSON string is invalid with respect to BankOrganizationData
   */
  public static BankOrganizationData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankOrganizationData.class);
  }

  /**
   * Convert an instance of BankOrganizationData to an JSON string
   *
   * @return JSON string
   */
