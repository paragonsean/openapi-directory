...
public class PaymentMethodProcessorData {
  ...
  public PaymentMethodProcessorData() {
  }

  public PaymentMethodProcessorData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public PaymentMethodProcessorData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentMethodProcessorData paymentMethodProcessorData = (PaymentMethodProcessorData) o;
    return Objects.equals(this.id, paymentMethodProcessorData.id) &&
        Objects.equals(this.type, paymentMethodProcessorData.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentMethodProcessorData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentMethodProcessorData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentMethodProcessorData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PaymentMethodProcessorData is not found in the empty JSON string", PaymentMethodProcessorData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentMethodProcessorData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymentMethodProcessorData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentMethodProcessorData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentMethodProcessorData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentMethodProcessorData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentMethodProcessorData.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentMethodProcessorData>() {
           @Override
           public void write(JsonWriter out, PaymentMethodProcessorData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentMethodProcessorData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentMethodProcessorData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentMethodProcessorData
   * @throws IOException if the JSON string is invalid with respect to PaymentMethodProcessorData
   */
  public static PaymentMethodProcessorData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentMethodProcessorData.class);
  }

  /**
   * Convert an instance of PaymentMethodProcessorData to an JSON string
   *
   * @return JSON string
   */
