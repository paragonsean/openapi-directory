...
import org.openapitools.client.model.OrganizationActiveLinks;
...
public class OrganizationActive {
  ...
  private OrganizationActiveLinks links;

  public OrganizationActive() {
  }

  public OrganizationActive data(List<String> data) {
    this.data = data;
    return this;
  }

  public OrganizationActive addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public OrganizationActive links(OrganizationActiveLinks links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public OrganizationActiveLinks getLinks() {
    return links;
  }

  public void setLinks(OrganizationActiveLinks links) {
    this.links = links;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrganizationActive organizationActive = (OrganizationActive) o;
    return Objects.equals(this.data, organizationActive.data) &&
        Objects.equals(this.links, organizationActive.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationActive {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrganizationActive
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationActive.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationActive is not found in the empty JSON string", OrganizationActive.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationActive.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationActive` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        OrganizationActiveLinks.validateJsonElement(jsonObj.get("links"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationActive.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationActive' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationActive> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationActive.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationActive>() {
           @Override
           public void write(JsonWriter out, OrganizationActive value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationActive read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrganizationActive given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrganizationActive
   * @throws IOException if the JSON string is invalid with respect to OrganizationActive
   */
  public static OrganizationActive fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationActive.class);
  }

  /**
   * Convert an instance of OrganizationActive to an JSON string
   *
   * @return JSON string
   */
