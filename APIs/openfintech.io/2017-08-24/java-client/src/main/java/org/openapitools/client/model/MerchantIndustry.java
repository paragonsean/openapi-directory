...
public class MerchantIndustry {
  ...
  private MerchantIndustryAttributes attributes;
  ...
  public MerchantIndustry attributes(MerchantIndustryAttributes attributes) {
  ...
  public MerchantIndustryAttributes getAttributes() {
    return attributes;
  }

  public void setAttributes(MerchantIndustryAttributes attributes) {
    this.attributes = attributes;
  }


  public MerchantIndustry id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MerchantIndustry type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MerchantIndustry merchantIndustry = (MerchantIndustry) o;
    return Objects.equals(this.attributes, merchantIndustry.attributes) &&
        Objects.equals(this.id, merchantIndustry.id) &&
        Objects.equals(this.type, merchantIndustry.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class MerchantIndustry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MerchantIndustry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MerchantIndustry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MerchantIndustry is not found in the empty JSON string", MerchantIndustry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MerchantIndustry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MerchantIndustry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `attributes`
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        MerchantIndustryAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MerchantIndustry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MerchantIndustry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MerchantIndustry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MerchantIndustry.class));

       return (TypeAdapter<T>) new TypeAdapter<MerchantIndustry>() {
           @Override
           public void write(JsonWriter out, MerchantIndustry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MerchantIndustry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MerchantIndustry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MerchantIndustry
   * @throws IOException if the JSON string is invalid with respect to MerchantIndustry
   */
  public static MerchantIndustry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MerchantIndustry.class);
  }

  /**
   * Convert an instance of MerchantIndustry to an JSON string
   *
   * @return JSON string
   */
