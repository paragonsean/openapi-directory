...
public class Currency {
  ...
  private CurrencyRelationships relationships;
  ...
  public Currency attributes(CurrencyAttributes attributes) {
  ...
  public Currency links(SelfLinks links) {
    this.links = links;
    return this;
  }
  ...
  public Currency relationships(CurrencyRelationships relationships) {
   ...
   */
  @javax.annotation.Nullable
  public CurrencyRelationships getRelationships() {
    return relationships;
  }

  public void setRelationships(CurrencyRelationships relationships) {
    this.relationships = relationships;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, currency.attributes) &&
        Objects.equals(this.id, currency.id) &&
        Objects.equals(this.links, currency.links) &&
        Objects.equals(this.relationships, currency.relationships) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        CurrencyAttributes.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        CurrencyRelationships.validateJsonElement(jsonObj.get("relationships"));
      }
