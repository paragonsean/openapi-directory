...
public class SupportedPspsRelationshipLinks {
  public static final String SERIALIZED_NAME_RELATED = "related";
  @SerializedName(SERIALIZED_NAME_RELATED)
  private String related;

  public SupportedPspsRelationshipLinks() {
  }

  public SupportedPspsRelationshipLinks related(String related) {
  ...
  public boolean equals(Object o) {
    ...
    SupportedPspsRelationshipLinks supportedPspsRelationshipLinks = (SupportedPspsRelationshipLinks) o;
    return Objects.equals(this.related, supportedPspsRelationshipLinks.related);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupportedPspsRelationshipLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupportedPspsRelationshipLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupportedPspsRelationshipLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupportedPspsRelationshipLinks is not found in the empty JSON string", SupportedPspsRelationshipLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupportedPspsRelationshipLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupportedPspsRelationshipLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupportedPspsRelationshipLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupportedPspsRelationshipLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupportedPspsRelationshipLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupportedPspsRelationshipLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<SupportedPspsRelationshipLinks>() {
           @Override
           public void write(JsonWriter out, SupportedPspsRelationshipLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupportedPspsRelationshipLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupportedPspsRelationshipLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupportedPspsRelationshipLinks
   * @throws IOException if the JSON string is invalid with respect to SupportedPspsRelationshipLinks
   */
  public static SupportedPspsRelationshipLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupportedPspsRelationshipLinks.class);
  }

  /**
   * Convert an instance of SupportedPspsRelationshipLinks to an JSON string
   *
   * @return JSON string
   */
