...
OAIRvcer_request::OAIRvcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRvcer_request::OAIRvcer_request() {
    this->initializeModel();
}

OAIRvcer_request::~OAIRvcer_request() {}

void OAIRvcer_request::initializeModel() {
...
void OAIRvcer_request::fromJson(QString jsonString) {
...
void OAIRvcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIRvcer_request::asJson() const {
...
QJsonObject OAIRvcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIRvcer_request_certificateParameters OAIRvcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIRvcer_request::setCertificateParameters(const OAIRvcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIRvcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIRvcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIRvcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIRvcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIRvcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIRvcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIRvcer_request::getFormat() const {
    return m_format;
}
void OAIRvcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIRvcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIRvcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIRvcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIRvcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIRvcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIRvcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIRvcer_request::isSet() const {
...
bool OAIRvcer_request::isValid() const {
