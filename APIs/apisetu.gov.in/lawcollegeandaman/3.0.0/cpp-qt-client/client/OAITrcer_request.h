...
#ifndef OAITrcer_request_H
#define OAITrcer_request_H
...
namespace OpenAPI {
class OAITrcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAITrcer_request : public OAIObject {
public:
    OAITrcer_request();
    OAITrcer_request(QString json);
    ~OAITrcer_request() override;
    ...
    OAITrcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAITrcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAITrcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrcer_request)

#endif // OAITrcer_request_H
