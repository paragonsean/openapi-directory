...
/*
 * OAITrcer_503_response.h
 *
 * 
 */

#ifndef OAITrcer_503_response_H
#define OAITrcer_503_response_H
...
class OAITrcer_503_response : public OAIObject {
public:
    OAITrcer_503_response();
    OAITrcer_503_response(QString json);
    ~OAITrcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrcer_503_response)

#endif // OAITrcer_503_response_H
