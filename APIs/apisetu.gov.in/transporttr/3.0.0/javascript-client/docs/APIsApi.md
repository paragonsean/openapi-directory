# TransportDepartmentTripura.APIsApi
...
```javascript
import TransportDepartmentTripura from 'transport_department_tripura';
let defaultClient = TransportDepartmentTripura.ApiClient.instance;
...
let apiInstance = new TransportDepartmentTripura.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentTripura.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentTripura.RvcerRequest() // RvcerRequest | Request format
};
