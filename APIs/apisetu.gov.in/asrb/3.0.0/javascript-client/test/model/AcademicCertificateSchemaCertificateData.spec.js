...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgriculturalScientistsRecruitmentBoard.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new AgriculturalScientistsRecruitmentBoard.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(AgriculturalScientistsRecruitmentBoard.AcademicCertificateSchemaCertificateData);
    });
