...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgriculturalScientistsRecruitmentBoard.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new AgriculturalScientistsRecruitmentBoard.ConsentArtifactSchema();
      //expect(instance).to.be.a(AgriculturalScientistsRecruitmentBoard.ConsentArtifactSchema);
    });
