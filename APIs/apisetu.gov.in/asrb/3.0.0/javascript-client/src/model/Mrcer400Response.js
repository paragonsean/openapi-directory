...
/**
 * The Mrcer400Response model module.
 * @module model/Mrcer400Response
 * @version 3.0.0
 */
class Mrcer400Response {
    /**
     * Constructs a new <code>Mrcer400Response</code>.
     * @alias module:model/Mrcer400Response
     */
    constructor() { 
        
        Mrcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Mrcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Mrcer400Response} obj Optional instance to populate.
     * @return {module:model/Mrcer400Response} The populated <code>Mrcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Mrcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Mrcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Mrcer400Response</code>.
     */
...
/**
 * @member {module:model/Mrcer400Response.ErrorEnum} error
 */
Mrcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Mrcer400Response.ErrorDescriptionEnum} errorDescription
 */
Mrcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Mrcer400Response['ErrorDescriptionEnum'] = {
...
export default Mrcer400Response;
