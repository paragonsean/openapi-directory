...
OAIMrcer_request::OAIMrcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMrcer_request::OAIMrcer_request() {
    this->initializeModel();
}

OAIMrcer_request::~OAIMrcer_request() {}

void OAIMrcer_request::initializeModel() {
...
void OAIMrcer_request::fromJson(QString jsonString) {
...
void OAIMrcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIMrcer_request::asJson() const {
...
QJsonObject OAIMrcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIMrcer_request_certificateParameters OAIMrcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIMrcer_request::setCertificateParameters(const OAIMrcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIMrcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIMrcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIMrcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIMrcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIMrcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIMrcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIMrcer_request::getFormat() const {
    return m_format;
}
void OAIMrcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIMrcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIMrcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIMrcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIMrcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIMrcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIMrcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIMrcer_request::isSet() const {
...
bool OAIMrcer_request::isValid() const {
