...
/*
 * OAIMrcer_503_response.h
 *
 * 
 */

#ifndef OAIMrcer_503_response_H
#define OAIMrcer_503_response_H
...
class OAIMrcer_503_response : public OAIObject {
public:
    OAIMrcer_503_response();
    OAIMrcer_503_response(QString json);
    ~OAIMrcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMrcer_503_response)

#endif // OAIMrcer_503_response_H
