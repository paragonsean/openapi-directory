...
/*
 * OAIMrcer_404_response.h
 *
 * 
 */

#ifndef OAIMrcer_404_response_H
#define OAIMrcer_404_response_H
...
class OAIMrcer_404_response : public OAIObject {
public:
    OAIMrcer_404_response();
    OAIMrcer_404_response(QString json);
    ~OAIMrcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMrcer_404_response)

#endif // OAIMrcer_404_response_H
