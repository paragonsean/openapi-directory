...
/*
 * OAIMrcer_400_response.h
 *
 * 
 */

#ifndef OAIMrcer_400_response_H
#define OAIMrcer_400_response_H
...
class OAIMrcer_400_response : public OAIObject {
public:
    OAIMrcer_400_response();
    OAIMrcer_400_response(QString json);
    ~OAIMrcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMrcer_400_response)

#endif // OAIMrcer_400_response_H
