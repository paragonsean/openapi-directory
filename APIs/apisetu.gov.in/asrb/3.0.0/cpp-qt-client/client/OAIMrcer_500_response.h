...
/*
 * OAIMrcer_500_response.h
 *
 * 
 */

#ifndef OAIMrcer_500_response_H
#define OAIMrcer_500_response_H
...
class OAIMrcer_500_response : public OAIObject {
public:
    OAIMrcer_500_response();
    OAIMrcer_500_response(QString json);
    ~OAIMrcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMrcer_500_response)

#endif // OAIMrcer_500_response_H
