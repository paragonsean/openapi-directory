...
/*
 * OAIMrcer_504_response.h
 *
 * 
 */

#ifndef OAIMrcer_504_response_H
#define OAIMrcer_504_response_H
...
class OAIMrcer_504_response : public OAIObject {
public:
    OAIMrcer_504_response();
    OAIMrcer_504_response(QString json);
    ~OAIMrcer_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMrcer_504_response)

#endif // OAIMrcer_504_response_H
