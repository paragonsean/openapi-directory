...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeerSurendraSaiUniversityOfTechnology.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new VeerSurendraSaiUniversityOfTechnology.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(VeerSurendraSaiUniversityOfTechnology.ConsentArtifactSchemaConsentPermission);
    });
