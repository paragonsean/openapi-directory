...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeerSurendraSaiUniversityOfTechnology.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new VeerSurendraSaiUniversityOfTechnology.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(VeerSurendraSaiUniversityOfTechnology.ConsentArtifactSchemaConsentUser);
    });
