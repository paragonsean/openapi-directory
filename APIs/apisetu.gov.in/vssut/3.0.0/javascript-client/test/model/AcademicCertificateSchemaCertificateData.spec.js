...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeerSurendraSaiUniversityOfTechnology.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new VeerSurendraSaiUniversityOfTechnology.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(VeerSurendraSaiUniversityOfTechnology.AcademicCertificateSchemaCertificateData);
    });
