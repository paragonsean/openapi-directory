...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeerSurendraSaiUniversityOfTechnology.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new VeerSurendraSaiUniversityOfTechnology.ConsentArtifactSchema();
      //expect(instance).to.be.a(VeerSurendraSaiUniversityOfTechnology.ConsentArtifactSchema);
    });
