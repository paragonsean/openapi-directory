...
OAITrcer_request::OAITrcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrcer_request::OAITrcer_request() {
    this->initializeModel();
}

OAITrcer_request::~OAITrcer_request() {}

void OAITrcer_request::initializeModel() {
...
void OAITrcer_request::fromJson(QString jsonString) {
...
void OAITrcer_request::fromJsonObject(QJsonObject json) {
...
QString OAITrcer_request::asJson() const {
...
QJsonObject OAITrcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAITrcer_request_certificateParameters OAITrcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAITrcer_request::setCertificateParameters(const OAITrcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAITrcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAITrcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAITrcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAITrcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAITrcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAITrcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAITrcer_request::getFormat() const {
    return m_format;
}
void OAITrcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAITrcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAITrcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAITrcer_request::getTxnId() const {
    return m_txn_id;
}
void OAITrcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAITrcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAITrcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAITrcer_request::isSet() const {
...
bool OAITrcer_request::isValid() const {
