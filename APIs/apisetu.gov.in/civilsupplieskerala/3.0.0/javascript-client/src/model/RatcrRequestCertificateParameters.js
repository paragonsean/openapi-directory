...
class RatcrRequestCertificateParameters {
     ...
     */
    constructor(fullName, UID) { 
        
        RatcrRequestCertificateParameters.initialize(this, fullName, UID);
    }
     ...
     */
    static initialize(obj, fullName, UID) { 
...
RatcrRequestCertificateParameters.RequiredProperties = ["FullName", "UID"];
